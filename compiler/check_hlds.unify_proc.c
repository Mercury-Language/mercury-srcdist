...
struct check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0_s {
  ...
  MR_Word check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__Var_42;
...
struct check_hlds__unify_proc__compare_args_2_9_p_0_env_0_s {
  ...
  MR_Word check_hlds__unify_proc__compare_args_2_9_p_0_env_0__Var_76;
...
struct check_hlds__unify_proc__request_proc_9_p_0_env_0_s {
  ...
  MR_Word check_hlds__unify_proc__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_33;
  MR_bool check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded;
  MR_Word check_hlds__unify_proc__request_proc_9_p_0_env_0__TypeCtorInfo_58_58;
  jmp_buf check_hlds__unify_proc__request_proc_9_p_0_env_0__commit_0;
  MR_Word check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgMode_28;
  MR_Box check_hlds__unify_proc__request_proc_9_p_0_env_0__conv2_ArgMode_28;
};
...
check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1846__1_1_f_0(
  MR_Word check_hlds__unify_proc__LambdaHeadVar__1_21);

static MR_bool MR_CALL 
check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__495__1_2_p_0(
  MR_Word check_hlds__unify_proc__ErrorProcs_25,
  MR_Word check_hlds__unify_proc__HeadVar__2_35);

static MR_Word MR_CALL 
check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__410__1_2_f_0(
...
static /* final */ const struct check_hlds__unify_proc__vector_common_type_7_0_s check_hlds__unify_proc_vector_common_7[10];
...
static /* final */ const struct check_hlds__unify_proc__vector_common_type_7_0_s check_hlds__unify_proc_vector_common_7[10] = {
  ...
  /* row 2 */   {     (MR_String) "builtin_unify_float" },
  /* row 3 */   {     (MR_String) "builtin_unify_character" },
  /* row 4 */   {     (MR_String) "builtin_unify_string" },
  /* row 5 */   {     (MR_String) "builtin_compare_int" },
  /* row 6 */   {     (MR_String) "builtin_compare_uint" },
  /* row 7 */   {     (MR_String) "builtin_compare_float" },
  /* row 8 */   {     (MR_String) "builtin_compare_character" },
  /* row 9 */   {     (MR_String) "builtin_compare_string" },
};
...
{
  {
    ...
    if (check_hlds__unify_proc__succeeded)
      *check_hlds__unify_proc__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word check_hlds__unify_proc__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 3)));
        MR_Word check_hlds__unify_proc__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 3)));
        MR_Word check_hlds__unify_proc__Var_12;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_1[4], &check_hlds__unify_proc__Var_12, ((MR_Box) (check_hlds__unify_proc__Var_4)), ((MR_Box) (check_hlds__unify_proc__Var_8)));
        }
        ...
        if (check_hlds__unify_proc__succeeded)
          *check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__Var_12;
        else
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_2[1], &check_hlds__unify_proc__Var_13, ((MR_Box) (check_hlds__unify_proc__Var_5)), ((MR_Box) (check_hlds__unify_proc__Var_9)));
            }
            ...
            if (check_hlds__unify_proc__succeeded)
              *check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__Var_13;
            else
              {
                ...
                {
                  hlds__hlds_rtti____Compare____rtti_varmaps_0_0(&check_hlds__unify_proc__Var_14, check_hlds__unify_proc__Var_6, check_hlds__unify_proc__Var_10);
                }
                ...
                if (check_hlds__unify_proc__succeeded)
                  *check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__Var_14;
                  ...
                  {
                    hlds__hlds_module____Compare____module_info_0_0(check_hlds__unify_proc__HeadVar__1_1, check_hlds__unify_proc__Var_7, check_hlds__unify_proc__Var_11);
                  }
              }
          }
      }
...
{
  {
    ...
    if (check_hlds__unify_proc__succeeded)
    ...
    else
      {
        ...
        MR_Word check_hlds__unify_proc__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 3)));
        MR_Word check_hlds__unify_proc__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 3)));

        {
          check_hlds__unify_proc__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_1[4], ((MR_Box) (check_hlds__unify_proc__Var_3)), ((MR_Box) (check_hlds__unify_proc__Var_7)));
        }
        if (check_hlds__unify_proc__succeeded)
          {
            check_hlds__unify_proc__TypeInfo_14_14 = (MR_Word) &check_hlds__unify_proc_scalar_common_2[1];
            {
              check_hlds__unify_proc__succeeded = mercury__builtin__unify_2_p_0(check_hlds__unify_proc__TypeInfo_14_14, ((MR_Box) (check_hlds__unify_proc__Var_4)), ((MR_Box) (check_hlds__unify_proc__Var_8)));
            }
            if (check_hlds__unify_proc__succeeded)
              {
                {
                  check_hlds__unify_proc__succeeded = hlds__hlds_rtti____Unify____rtti_varmaps_0_0(check_hlds__unify_proc__Var_5, check_hlds__unify_proc__Var_9);
                }
                if (check_hlds__unify_proc__succeeded)
                  {
                    check_hlds__unify_proc__succeeded = hlds__hlds_module____Unify____module_info_0_0(check_hlds__unify_proc__Var_6, check_hlds__unify_proc__Var_10);
                  }
              }
          }
      }
    ...
    if (check_hlds__unify_proc__succeeded)
      *check_hlds__unify_proc__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        MR_Word check_hlds__unify_proc__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_8;

        {
          parse_tree__prog_data____Compare____type_ctor_0_0(&check_hlds__unify_proc__Var_8, check_hlds__unify_proc__Var_4, check_hlds__unify_proc__Var_6);
        }
        check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Var_8 == (MR_Integer) 0);
        check_hlds__unify_proc__succeeded = !(check_hlds__unify_proc__succeeded);
        if (check_hlds__unify_proc__succeeded)
          *check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__Var_8;
        else
          {
            hlds__hlds_goal____Compare____unify_mode_0_0(check_hlds__unify_proc__HeadVar__1_1, check_hlds__unify_proc__Var_5, check_hlds__unify_proc__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (check_hlds__unify_proc__succeeded)
    ...
    else
      {
        MR_Word check_hlds__unify_proc__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__unify_proc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__2_2, (MR_Integer) 1)));

        {
          check_hlds__unify_proc__succeeded = parse_tree__prog_data____Unify____type_ctor_0_0(check_hlds__unify_proc__Var_3, check_hlds__unify_proc__Var_5);
        }
        if (check_hlds__unify_proc__succeeded)
          {
            check_hlds__unify_proc__succeeded = hlds__hlds_goal____Unify____unify_mode_0_0(check_hlds__unify_proc__Var_4, check_hlds__unify_proc__Var_6);
          }
      }
    return check_hlds__unify_proc__succeeded;
  }
    ...
    if (check_hlds__unify_proc__succeeded)
      *check_hlds__unify_proc__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_2[0], &check_hlds__unify_proc__Var_8, ((MR_Box) (check_hlds__unify_proc__Var_4)), ((MR_Box) (check_hlds__unify_proc__Var_6)));
        }
        check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Var_8 == (MR_Integer) 0);
        check_hlds__unify_proc__succeeded = !(check_hlds__unify_proc__succeeded);
        if (check_hlds__unify_proc__succeeded)
          *check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_1[3], check_hlds__unify_proc__HeadVar__1_1, ((MR_Box) (check_hlds__unify_proc__Var_5)), ((MR_Box) (check_hlds__unify_proc__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (check_hlds__unify_proc__succeeded)
    ...
    else
      {
        ...
        {
          check_hlds__unify_proc__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_2[0], ((MR_Box) (check_hlds__unify_proc__Var_3)), ((MR_Box) (check_hlds__unify_proc__Var_5)));
        }
        if (check_hlds__unify_proc__succeeded)
          {
            check_hlds__unify_proc__TypeInfo_10_10 = (MR_Word) &check_hlds__unify_proc_scalar_common_1[3];
            {
              check_hlds__unify_proc__succeeded = mercury__builtin__unify_2_p_0(check_hlds__unify_proc__TypeInfo_10_10, ((MR_Box) (check_hlds__unify_proc__Var_4)), ((MR_Box) (check_hlds__unify_proc__Var_6)));
            }
          }
      }
    return check_hlds__unify_proc__succeeded;
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_UPI_0_14, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_UPI_0_14, (MR_Integer) 3)));
    {
      ...
      *check_hlds__unify_proc__STATE_VARIABLE_UPI_15 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (check_hlds__unify_proc__Var_26));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_24;
    MR_Word check_hlds__unify_proc__Var_25;
    MR_Word check_hlds__unify_proc__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_UPI_0_12, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_UPI_0_12, (MR_Integer) 3)));
    {
      ...
      *check_hlds__unify_proc__STATE_VARIABLE_UPI_13 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (check_hlds__unify_proc__Var_24));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, (MR_Integer) 3)));
    ...
    check_hlds__unify_proc__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, (MR_Integer) 0)));
    check_hlds__unify_proc__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, (MR_Integer) 1)));
    check_hlds__unify_proc__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, (MR_Integer) 2)));
    check_hlds__unify_proc__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, (MR_Integer) 3)));
    check_hlds__unify_proc__Var_49 = check_hlds__unify_proc__Varset_17;
    check_hlds__unify_proc__Var_52 = check_hlds__unify_proc__Var_46;
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      *check_hlds__unify_proc__STATE_VARIABLE_Info_21 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (check_hlds__unify_proc__Var_49));
      ...
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (check_hlds__unify_proc__Var_52));
    }
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 2)));
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_64, (MR_Integer) 321, &check_hlds__unify_proc__ShouldPretestEq_16);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word check_hlds__unify_proc__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 0)));
          MR_Word check_hlds__unify_proc__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 1)));
          MR_Word check_hlds__unify_proc__Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_38, (MR_Integer) 2)));
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_72, (MR_Integer) 277, &check_hlds__unify_proc__CastPointers_73);
          }
...
{
  {
    ...
    {
      parse_tree__prog_type__type_contains_var_2_p_0((check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__Type_22, &(check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__Var_42, check_hlds__unify_proc__unify_var_lists_2_7_p_0_4, check_hlds__unify_proc__env_ptr);
    }
  }
}
            ...
            if ((check_hlds__unify_proc__env).check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__succeeded)
              {
                ...
                check_hlds__unify_proc__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_12, (MR_Integer) 0)));
                ...
                check_hlds__unify_proc__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_12, (MR_Integer) 2)));
                check_hlds__unify_proc__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_12, (MR_Integer) 3)));
                {
                  mercury__term__context_init_1_p_0(&check_hlds__unify_proc__Context_23);
                }
                check_hlds__unify_proc__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_6, (MR_Integer) 0)));
                check_hlds__unify_proc__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_6, (MR_Integer) 1)));
                check_hlds__unify_proc__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_6, (MR_Integer) 2)));
                ...
                {
                  check_hlds__unify_proc__Var_28 = check_hlds__type_util__check_dummy_type_2_f_0(check_hlds__unify_proc__ModuleInfo_24, (check_hlds__unify_proc__env).check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__Type_22);
                }
                (check_hlds__unify_proc__env).check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__succeeded = (check_hlds__unify_proc__Var_28 == (MR_Integer) 0);
                if ((check_hlds__unify_proc__env).check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__succeeded)
                  {
                    {
                    ...
                    if ((check_hlds__unify_proc__env).check_hlds__unify_proc__unify_var_lists_2_7_p_0_env_0__succeeded)
                      {
                        ...
                        {
                          check_hlds__unify_proc__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_32, 0) = ((MR_Box) (check_hlds__unify_proc__Y_17));
                          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        }
                        {
                          check_hlds__unify_proc__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_30, 0) = ((MR_Box) (check_hlds__unify_proc__X_15));
                          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_30, 1) = ((MR_Box) (check_hlds__unify_proc__Var_32));
                        }
                        {
                          check_hlds__unify_proc__build_call_6_p_0((MR_String) "typed_unify", check_hlds__unify_proc__Var_30, check_hlds__unify_proc__Context_23, &check_hlds__unify_proc__Goal_19, check_hlds__unify_proc__STATE_VARIABLE_Info_0_6, &check_hlds__unify_proc__STATE_VARIABLE_Info_31_31);
                        }
                      }
                    else
                      {
                        ...
                        {
                          check_hlds__unify_proc__Var_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_34, 0) = ((MR_Box) (check_hlds__unify_proc__Y_17));
                        }
                        {
                          hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(check_hlds__unify_proc__X_15, check_hlds__unify_proc__Var_34, check_hlds__unify_proc__Context_23, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &check_hlds__unify_proc__Goal_19);
                        }
                        check_hlds__unify_proc__STATE_VARIABLE_Info_31_31 = check_hlds__unify_proc__STATE_VARIABLE_Info_0_6;
                      }
                  }
...
{
  {
    ...
    {
      check_hlds__unify_proc__conv0_LambdaHeadVar__2_22 = check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1846__1_1_f_0(((MR_Word) check_hlds__unify_proc__wrapper_arg_1));
    }
...
{
  {
    ...
    if ((check_hlds__unify_proc__ExistQTVars_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word check_hlds__unify_proc__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 3)));
        MR_Word check_hlds__unify_proc__Var_39;
        MR_Word check_hlds__unify_proc__Var_40;
        ...
        check_hlds__unify_proc__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 0)));
        check_hlds__unify_proc__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 1)));
        check_hlds__unify_proc__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 2)));
        check_hlds__unify_proc__Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 3)));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          *check_hlds__unify_proc__STATE_VARIABLE_Info_18 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (check_hlds__unify_proc__Var_39));
          MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (check_hlds__unify_proc__Var_40));
          MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (check_hlds__unify_proc__Var_41));
        }
      }
  }
}
...
{
  {
    ...
    if ((check_hlds__unify_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word check_hlds__unify_proc__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_3, (MR_Integer) 2)));
        ...
        check_hlds__unify_proc__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_3, (MR_Integer) 3)));
        {
          ...
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_15_15, 2) = ((MR_Box) (check_hlds__unify_proc__Var_36));
...
{
  {
    ...
    if ((check_hlds__unify_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        check_hlds__unify_proc__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_5, (MR_Integer) 2)));
        ...
        check_hlds__unify_proc__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_5, (MR_Integer) 3)));
        {
          ...
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_21_21, 2) = ((MR_Box) (check_hlds__unify_proc__Var_55));
...
{
  {
    ...
    check_hlds__unify_proc__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_14, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_14, (MR_Integer) 3)));
    {
      ...
      *check_hlds__unify_proc__STATE_VARIABLE_Info_15 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (check_hlds__unify_proc__Var_37));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_26, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_26, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_26, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_24;
    MR_Word check_hlds__unify_proc__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_17, (MR_Integer) 0)));
    ...
    {
      hlds__goal_util__generate_simple_call_12_p_0(check_hlds__unify_proc__MercuryBuiltin_16, check_hlds__unify_proc__Name_7, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__unify_proc_scalar_common_3[2]), (MR_Integer) 6, (MR_Integer) 0, check_hlds__unify_proc__ArgVars_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__unify_proc__Var_24, check_hlds__unify_proc__ModuleInfo_12, check_hlds__unify_proc__Context_9, check_hlds__unify_proc__Goal_10);
    }
...
{
  {
    ...
    {
      parse_tree__prog_type__type_contains_var_2_p_0((check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__compare_args_2_9_p_0_env_0__Type_30, &(check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__compare_args_2_9_p_0_env_0__Var_76, check_hlds__unify_proc__compare_args_2_9_p_0_4, check_hlds__unify_proc__env_ptr);
    }
  }
}
        ...
        if ((check_hlds__unify_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            MR_Word check_hlds__unify_proc__Var_82;
            MR_String check_hlds__unify_proc__Var_83;
            MR_Word check_hlds__unify_proc__SymName_85;
            MR_Integer check_hlds__unify_proc__Var_86;
            ...
            MR_String check_hlds__unify_proc__Var_92;
            MR_Integer check_hlds__unify_proc__Var_93;
            ...
            if ((check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded)
              {
                ...
                if ((check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded)
                  {
                    check_hlds__unify_proc__Var_83 = (MR_String) "=";
                    check_hlds__unify_proc__Var_86 = (MR_Integer) 0;
                    {
                      check_hlds__unify_proc__Builtin_90 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
                    }
                    check_hlds__unify_proc__Var_92 = (MR_String) "comparison_result";
                    check_hlds__unify_proc__Var_93 = (MR_Integer) 0;
                    {
                      ...
                      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_91, 1) = ((MR_Box) (check_hlds__unify_proc__Var_92));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_87, 1) = ((MR_Box) (check_hlds__unify_proc__Var_93));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__SymName_85, 1) = ((MR_Box) (check_hlds__unify_proc__Var_83));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_82, 2) = ((MR_Box) (check_hlds__unify_proc__Var_86));
                      MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_82, 3) = ((MR_Box) (check_hlds__unify_proc__Var_87));
                    }
                    {
                      hlds__make_goal__make_const_construction_3_p_0(check_hlds__unify_proc__R_5, check_hlds__unify_proc__Var_82, &check_hlds__unify_proc__Goal0_81);
                    }
                    {
        ...
        else
          {
            ...
            MR_Word check_hlds__unify_proc__Var_95;
            MR_Word check_hlds__unify_proc__Var_96;
            MR_Word check_hlds__unify_proc__Var_97;
                ...
                if ((check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded)
                  {
                    ...
                    check_hlds__unify_proc__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_17, (MR_Integer) 0)));
                    ...
                    check_hlds__unify_proc__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_17, (MR_Integer) 2)));
                    check_hlds__unify_proc__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Arg_17, (MR_Integer) 3)));
                    {
                    ...
                    check_hlds__unify_proc__Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_8, (MR_Integer) 0)));
                    check_hlds__unify_proc__Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_8, (MR_Integer) 1)));
                    check_hlds__unify_proc__Var_97 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_8, (MR_Integer) 2)));
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          {
                            MR_Word check_hlds__unify_proc__next_value_of_HeadVar__1_1 = check_hlds__unify_proc__ArgTypes_18;
                            MR_Word check_hlds__unify_proc__next_value_of_HeadVar__3_3 = check_hlds__unify_proc__Xs_21;
                            MR_Word check_hlds__unify_proc__next_value_of_HeadVar__4_4 = check_hlds__unify_proc__Ys_23;
                            ...
                            check_hlds__unify_proc__HeadVar__1_1 = check_hlds__unify_proc__next_value_of_HeadVar__1_1;
                          }
                          continue;
                        }
                        break;
                          ...
                          if ((check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded)
                            {
...

                              {
                                ...
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_46, 0) = ((MR_Box) (check_hlds__unify_proc__X_20));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_46, 1) = ((MR_Box) (check_hlds__unify_proc__HeadVar__4_4));
                              }
                              {
                                check_hlds__unify_proc__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_44, 0) = ((MR_Box) (check_hlds__unify_proc__R_5));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_44, 1) = ((MR_Box) (check_hlds__unify_proc__Var_46));
                              }
                              {
                                check_hlds__unify_proc__build_call_6_p_0(check_hlds__unify_proc__ComparePred_32, check_hlds__unify_proc__Var_44, check_hlds__unify_proc__Context_6, check_hlds__unify_proc__HeadVar__7_7, check_hlds__unify_proc__STATE_VARIABLE_Info_0_8, check_hlds__unify_proc__STATE_VARIABLE_Info_9);
                              }
                              (check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded = MR_TRUE;
                            }
                          else
                            {
                              ...
                              MR_Word check_hlds__unify_proc__Var_69;

                              {
                                check_hlds__unify_proc__Var_49 = parse_tree__builtin_lib_types__comparison_result_type_0_f_0();
                              }
                              {
                                check_hlds__unify_proc__info_new_var_4_p_0(check_hlds__unify_proc__Var_49, &check_hlds__unify_proc__R1_35, check_hlds__unify_proc__STATE_VARIABLE_Info_0_8, &check_hlds__unify_proc__STATE_VARIABLE_Info_50_50);
                              }
                              {
                                check_hlds__unify_proc__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_54, 0) = ((MR_Box) (check_hlds__unify_proc__Y_22));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                              }
                              {
                                check_hlds__unify_proc__Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_53, 0) = ((MR_Box) (check_hlds__unify_proc__X_20));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_53, 1) = ((MR_Box) (check_hlds__unify_proc__Var_54));
                              }
                              {
                                check_hlds__unify_proc__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_51, 0) = ((MR_Box) (check_hlds__unify_proc__R1_35));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_51, 1) = ((MR_Box) (check_hlds__unify_proc__Var_53));
                              }
                              {
                                check_hlds__unify_proc__build_call_6_p_0(check_hlds__unify_proc__ComparePred_32, check_hlds__unify_proc__Var_51, check_hlds__unify_proc__Context_6, &check_hlds__unify_proc__Do_Comparison_36, check_hlds__unify_proc__STATE_VARIABLE_Info_50_50, &check_hlds__unify_proc__STATE_VARIABLE_Info_52_52);
                              }
                              {
                                check_hlds__unify_proc__Var_56 = check_hlds__unify_proc__compare_cons_id_1_f_0((MR_String) "=");
                              }
                              {
                                hlds__make_goal__make_const_construction_3_p_0(check_hlds__unify_proc__R1_35, check_hlds__unify_proc__Var_56, &check_hlds__unify_proc__Check_Equal_37);
                              }
                              check_hlds__unify_proc__Var_58 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) check_hlds__unify_proc__Check_Equal_37);
                              {
                                check_hlds__unify_proc__Check_Not_Equal_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Check_Not_Equal_38, 0) = ((MR_Box) (check_hlds__unify_proc__Var_58));
                                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Check_Not_Equal_38, 1) = ((MR_Box) (check_hlds__unify_proc__GoalInfo_29));
                              }
                              {
                                check_hlds__unify_proc__Var_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_59, 0) = ((MR_Box) (check_hlds__unify_proc__R1_35));
                              }
                              {
                                hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(check_hlds__unify_proc__R_5, check_hlds__unify_proc__Var_59, check_hlds__unify_proc__Context_6, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &check_hlds__unify_proc__Return_R1_39);
                              }
                              {
                                check_hlds__unify_proc__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_65, 0) = ((MR_Box) (check_hlds__unify_proc__Check_Not_Equal_38));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                              }
                              {
                                check_hlds__unify_proc__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 0) = ((MR_Box) (check_hlds__unify_proc__Do_Comparison_36));
                                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 1) = ((MR_Box) (check_hlds__unify_proc__Var_65));
                              }
                              {
                                check_hlds__unify_proc__Var_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_62, 1) = ((MR_Box) ((MR_Integer) 0));
                                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_62, 2) = ((MR_Box) (check_hlds__unify_proc__Var_64));
                              }
                              {
                                check_hlds__unify_proc__Condition_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Condition_40, 0) = ((MR_Box) (check_hlds__unify_proc__Var_62));
                              ...
                              if ((check_hlds__unify_proc__env).check_hlds__unify_proc__compare_args_2_9_p_0_env_0__succeeded)
                                {
                                  check_hlds__unify_proc__Var_69 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                  {
                                    check_hlds__unify_proc__Var_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                                    MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                                    MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_68, 1) = ((MR_Box) (check_hlds__unify_proc__Var_69));
                                    MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_68, 2) = ((MR_Box) (check_hlds__unify_proc__Condition_40));
                                    MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_68, 3) = ((MR_Box) (check_hlds__unify_proc__Return_R1_39));
                                    MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_68, 4) = ((MR_Box) (check_hlds__unify_proc__ElseCase_41));
                                  }
                                  {
                                    MR_Word base;
                                    base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                    *check_hlds__unify_proc__HeadVar__7_7 = base;
                                    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (check_hlds__unify_proc__Var_68));
    ...
    if ((check_hlds__unify_proc__ArgTypes_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        {
          check_hlds__unify_proc__Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_81, 0) = ((MR_Box) (check_hlds__unify_proc__Builtin_80));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_81, 1) = ((MR_Box) ((MR_String) "comparison_result"));
        }
        {
          check_hlds__unify_proc__Var_77 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_77, 0) = ((MR_Box) (check_hlds__unify_proc__Var_81));
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_77, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          check_hlds__unify_proc__Var_78 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
        }
        {
          ...
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__SymName_75, 0) = ((MR_Box) (check_hlds__unify_proc__Var_78));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__SymName_75, 1) = ((MR_Box) ((MR_String) "="));
        }
        {
          check_hlds__unify_proc__Var_72 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_72, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_72, 1) = ((MR_Box) (check_hlds__unify_proc__SymName_75));
          MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_72, 2) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_72, 3) = ((MR_Box) (check_hlds__unify_proc__Var_77));
        }
        {
          hlds__make_goal__make_const_construction_3_p_0(check_hlds__unify_proc__R_13, check_hlds__unify_proc__Var_72, &check_hlds__unify_proc__Goal0_71);
        }
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_30, 1) = ((MR_Box) (check_hlds__unify_proc__Var_64));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 0) = ((MR_Box) (check_hlds__unify_proc__EqualGoal_29));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                check_hlds__unify_proc__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_61, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyY_Goal_31));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_61, 1) = ((MR_Box) (check_hlds__unify_proc__Var_62));
              }
              {
                check_hlds__unify_proc__GoalList_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_30, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyX_Goal_28));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_30, 1) = ((MR_Box) (check_hlds__unify_proc__Var_61));
              }
            }
            break;
        }
    ...
    else
      {
        ...
        {
          check_hlds__unify_proc__Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_53, 0) = ((MR_Box) (check_hlds__unify_proc__CompareArgs_Goal_38));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_52, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyY_Goal_67));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_52, 1) = ((MR_Box) (check_hlds__unify_proc__Var_53));
        }
        {
          check_hlds__unify_proc__GoalList_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_30, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyX_Goal_66));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_30, 1) = ((MR_Box) (check_hlds__unify_proc__Var_52));
        }
      }
    {
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_30, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_30, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_30, (MR_Integer) 2)));
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_19, (MR_Integer) 279, &check_hlds__unify_proc__LexicalOrder_20);
    }
    ...
    if ((check_hlds__unify_proc__Ctors_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          libs__globals__lookup_int_option_3_p_0(check_hlds__unify_proc__Globals_19, (MR_Integer) 320, &check_hlds__unify_proc__CompareSpec_24);
        }
        {
...
{
  {
    ...
    if ((check_hlds__unify_proc__ExistQTVars_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word check_hlds__unify_proc__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 1)));
        MR_Word check_hlds__unify_proc__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 2)));
        MR_Word check_hlds__unify_proc__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 3)));
        MR_Word check_hlds__unify_proc__Var_78;
        ...
        check_hlds__unify_proc__Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 0)));
        check_hlds__unify_proc__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 1)));
        check_hlds__unify_proc__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 2)));
        check_hlds__unify_proc__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_34, (MR_Integer) 3)));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          *check_hlds__unify_proc__STATE_VARIABLE_Info_35 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (check_hlds__unify_proc__Var_78));
          MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (check_hlds__unify_proc__Var_79));
          MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (check_hlds__unify_proc__Var_80));
        }
      }
    {
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__TypeCtor_10, (MR_Integer) 0)));
    MR_String check_hlds__unify_proc__Var_46;
    ...
    check_hlds__unify_proc__succeeded = ((MR_tag((MR_Word) check_hlds__unify_proc__Var_45)) == (MR_mktag((MR_Integer) 0)));
    if (check_hlds__unify_proc__succeeded)
      {
        check_hlds__unify_proc__Var_46 = ((MR_String) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_45, (MR_Integer) 0)));
        check_hlds__unify_proc__succeeded = (strcmp(check_hlds__unify_proc__Var_46, (MR_String) "{}") == 0);
      }
    if (check_hlds__unify_proc__succeeded)
      {
    ...
    if (check_hlds__unify_proc__succeeded)
      {
        ...
        {
          check_hlds__unify_proc__Var_51 = parse_tree__builtin_lib_types__int_type_0_f_0();
        }
        {
          check_hlds__unify_proc__info_new_named_var_5_p_0(check_hlds__unify_proc__Var_51, (MR_String) "CastX", &check_hlds__unify_proc__CastX_28, check_hlds__unify_proc__STATE_VARIABLE_Info_0_43, &check_hlds__unify_proc__STATE_VARIABLE_Info_53_53);
        }
        {
          check_hlds__unify_proc__Var_54 = parse_tree__builtin_lib_types__int_type_0_f_0();
        }
        {
          check_hlds__unify_proc__info_new_named_var_5_p_0(check_hlds__unify_proc__Var_54, (MR_String) "CastY", &check_hlds__unify_proc__CastY_29, check_hlds__unify_proc__STATE_VARIABLE_Info_53_53, check_hlds__unify_proc__STATE_VARIABLE_Info_44);
        }
        {
        ...
        {
          check_hlds__unify_proc__Var_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_61, 0) = ((MR_Box) (check_hlds__unify_proc__CastX_28));
        }
        {
          hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(check_hlds__unify_proc__CastY_29, check_hlds__unify_proc__Var_61, check_hlds__unify_proc__Context_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &check_hlds__unify_proc__UnifyY_Goal_34);
        }
        {
          check_hlds__unify_proc__Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_66, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyY_Goal_34));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_65, 0) = ((MR_Box) (check_hlds__unify_proc__CastYGoal_33));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_65, 1) = ((MR_Box) (check_hlds__unify_proc__Var_66));
        }
        {
          check_hlds__unify_proc__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 0) = ((MR_Box) (check_hlds__unify_proc__CastXGoal_32));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 1) = ((MR_Box) (check_hlds__unify_proc__Var_65));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_35, 1) = ((MR_Box) (check_hlds__unify_proc__Var_64));
        }
      }
    else
      {
        ...
        {
          check_hlds__unify_proc__Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_77, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyY_Goal_79));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_77, 1) = ((MR_Box) (check_hlds__unify_proc__UnifyArgs_Goals_40));
        }
        {
          check_hlds__unify_proc__GoalList_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_35, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyX_Goal_78));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__GoalList_35, 1) = ((MR_Box) (check_hlds__unify_proc__Var_77));
        }
      }
    {
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, (MR_Integer) 2)));
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_43, (MR_Integer) 276, &check_hlds__unify_proc__CanCompareAsInt_16);
    }
    {
...
{
  {
    ...
    check_hlds__unify_proc__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_24, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_24, (MR_Integer) 3)));
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_28_28, 2) = ((MR_Box) (check_hlds__unify_proc__Var_79));
...
{
  {
    ...
    if (((MR_tag((MR_Word) check_hlds__unify_proc__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        MR_Word check_hlds__unify_proc__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__HeadVar__1_1, (MR_Integer) 0)));

        {
          check_hlds__unify_proc__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_40, 0) = ((MR_Box) (check_hlds__unify_proc__Y_4));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_39, 0) = ((MR_Box) (check_hlds__unify_proc__X_3));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_39, 1) = ((MR_Box) (check_hlds__unify_proc__Var_40));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__ArgVars_29, 1) = ((MR_Box) (check_hlds__unify_proc__Var_39));
        }
        if ((check_hlds__unify_proc__MaybeCompare_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(2), check_hlds__unify_proc__Call_33, 3) = ((MR_Box) ((MR_Integer) 1));
            ...
            {
              check_hlds__unify_proc__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_46, 0) = ((MR_Box) (check_hlds__unify_proc__Res_2));
            }
            {
              check_hlds__unify_proc__maybe_wrap_with_pretest_equality_8_p_0(check_hlds__unify_proc__Context_5, check_hlds__unify_proc__X_3, check_hlds__unify_proc__Y_4, check_hlds__unify_proc__Var_46, check_hlds__unify_proc__Goal0_35, &check_hlds__unify_proc__Goal_36, check_hlds__unify_proc__STATE_VARIABLE_Info_0_7, &check_hlds__unify_proc__STATE_VARIABLE_Info_47_47);
            }
          }
        {
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__unify_proc__CtorCat_9)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word check_hlds__unify_proc__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__CtorCat_9, (MR_Integer) 0)));

          check_hlds__unify_proc__Name_17 = ((&check_hlds__unify_proc_vector_common_7[5 + check_hlds__unify_proc__Var_37]))->check_hlds__unify_proc__vector_common_type_7_0__vct_7_f_0;
        }
        break;
      case (MR_Integer) 2:
        {
    ...
    {
      check_hlds__unify_proc__build_call_6_p_0(check_hlds__unify_proc__Name_17, check_hlds__unify_proc__ArgVars_16, check_hlds__unify_proc__Context_13, &check_hlds__unify_proc__CompareGoal_21, check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, &check_hlds__unify_proc__STATE_VARIABLE_Info_35_35);
    }
    {
      check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__ArgVars_16, check_hlds__unify_proc__CompareGoal_21, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_35_35, check_hlds__unify_proc__STATE_VARIABLE_Info_23);
    }
  }
}
...
{
  {
    ...
    check_hlds__unify_proc__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_23, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_23, (MR_Integer) 3)));
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_27_27, 2) = ((MR_Box) (check_hlds__unify_proc__Var_78));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, (MR_Integer) 2)));
    ...
    {
      check_hlds__unify_proc__Var_43 = parse_tree__prog_type__check_builtin_dummy_type_ctor_1_f_0(check_hlds__unify_proc__TypeCtor_19);
    }
    check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Var_43 == (MR_Integer) 0);
    if (check_hlds__unify_proc__succeeded)
      {
          ...
          switch (MR_tag((MR_Word) check_hlds__unify_proc__TypeBody_11)) {
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  check_hlds__unify_proc__Var_51 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
                }
                {
                  check_hlds__unify_proc__generate_eqv_compare_proc_body_8_p_0(check_hlds__unify_proc__Var_51, check_hlds__unify_proc__Res_12, check_hlds__unify_proc__X_13, check_hlds__unify_proc__Y_14, check_hlds__unify_proc__Context_15, check_hlds__unify_proc__Clause_16, check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, check_hlds__unify_proc__STATE_VARIABLE_Info_42);
                }
              }
              break;
            case (MR_Integer) 1:
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__unify_proc__TypeBody_11, (MR_Integer) 0)))) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word check_hlds__unify_proc__ArgVars_73;
                    MR_Word check_hlds__unify_proc__Goal_74;
                    MR_Word check_hlds__unify_proc__Var_75;
                    MR_Word check_hlds__unify_proc__Var_76;
                    MR_Word check_hlds__unify_proc__STATE_VARIABLE_Info_22_79;
                    ...
                    {
                      check_hlds__unify_proc__ArgVars_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__ArgVars_73, 0) = ((MR_Box) (check_hlds__unify_proc__Res_12));
                      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__ArgVars_73, 1) = ((MR_Box) (check_hlds__unify_proc__Var_75));
                    }
                    {
                      check_hlds__unify_proc__build_call_6_p_0((MR_String) "builtin_compare_solver_type", check_hlds__unify_proc__ArgVars_73, check_hlds__unify_proc__Context_15, &check_hlds__unify_proc__Goal_74, check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, &check_hlds__unify_proc__STATE_VARIABLE_Info_22_79);
                    }
                    {
                      check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__ArgVars_73, check_hlds__unify_proc__Goal_74, check_hlds__unify_proc__Context_15, check_hlds__unify_proc__Clause_16, check_hlds__unify_proc__STATE_VARIABLE_Info_22_79, check_hlds__unify_proc__STATE_VARIABLE_Info_42);
                    }
                  }
                  break;
                case (MR_Integer) 1:
                    ...
                    if (check_hlds__unify_proc__succeeded)
                      {
                        ...
                        {
                          check_hlds__unify_proc__generate_builtin_compare_8_p_0(check_hlds__unify_proc__TypeCategory_40, check_hlds__unify_proc__Res_12, check_hlds__unify_proc__X_13, check_hlds__unify_proc__Y_14, check_hlds__unify_proc__Context_15, check_hlds__unify_proc__Clause_16, check_hlds__unify_proc__STATE_VARIABLE_Info_0_41, check_hlds__unify_proc__STATE_VARIABLE_Info_42);
                        }
                      }
                    else
                      {
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_37, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_37, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_37, (MR_Integer) 2)));
    MR_Word check_hlds__unify_proc__Var_17;
...
{
  {
    ...
    check_hlds__unify_proc__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, (MR_Integer) 2)));
    ...
    check_hlds__unify_proc__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_22, (MR_Integer) 3)));
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_26_26, 2) = ((MR_Box) (check_hlds__unify_proc__Var_73));
...
{
  {
    ...
    if (((MR_tag((MR_Word) check_hlds__unify_proc__UserEqCompare_1)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        if ((check_hlds__unify_proc__MaybeUnify_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          if ((check_hlds__unify_proc__MaybeCompare_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              {
                check_hlds__unify_proc__info_new_var_4_p_0(check_hlds__unify_proc__Var_44, &check_hlds__unify_proc__ResultVar_35, check_hlds__unify_proc__STATE_VARIABLE_Info_0_6, &check_hlds__unify_proc__STATE_VARIABLE_Info_45_45);
              }
              {
              ...
              {
                check_hlds__unify_proc__Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_48, 0) = ((MR_Box) (check_hlds__unify_proc__Y_3));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                check_hlds__unify_proc__Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_47, 0) = ((MR_Box) (check_hlds__unify_proc__X_2));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_47, 1) = ((MR_Box) (check_hlds__unify_proc__Var_48));
              }
              {
                check_hlds__unify_proc__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_46, 0) = ((MR_Box) (check_hlds__unify_proc__ResultVar_35));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_46, 1) = ((MR_Box) (check_hlds__unify_proc__Var_47));
              }
              {
                ...
                MR_hl_field(MR_mktag(2), check_hlds__unify_proc__Call_74, 2) = ((MR_Box) (check_hlds__unify_proc__Var_46));
                MR_hl_field(MR_mktag(2), check_hlds__unify_proc__Call_74, 3) = ((MR_Box) ((MR_Integer) 1));
              ...
              {
                check_hlds__unify_proc__Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_95, 0) = ((MR_Box) (check_hlds__unify_proc__Builtin_94));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_95, 1) = ((MR_Box) ((MR_String) "comparison_result"));
              }
              {
                check_hlds__unify_proc__Var_91 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_91, 0) = ((MR_Box) (check_hlds__unify_proc__Var_95));
                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_91, 1) = ((MR_Box) ((MR_Integer) 0));
              }
              {
                check_hlds__unify_proc__Var_92 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
              }
              {
                ...
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__SymName_89, 0) = ((MR_Box) (check_hlds__unify_proc__Var_92));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__SymName_89, 1) = ((MR_Box) ((MR_String) "="));
              }
              {
                check_hlds__unify_proc__Var_85 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_85, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_85, 1) = ((MR_Box) (check_hlds__unify_proc__SymName_89));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_85, 2) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_85, 3) = ((MR_Box) (check_hlds__unify_proc__Var_91));
              }
              {
                check_hlds__unify_proc__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_52, 0) = ((MR_Box) (check_hlds__unify_proc__Var_85));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_52, 1) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_52, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(check_hlds__unify_proc__ResultVar_35, check_hlds__unify_proc__Var_52, check_hlds__unify_proc__Context_4, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &check_hlds__unify_proc__UnifyGoal_37);
              }
              {
                check_hlds__unify_proc__Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_59, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyGoal_37));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                check_hlds__unify_proc__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_58, 0) = ((MR_Box) (check_hlds__unify_proc__CallGoal_36));
                MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_58, 1) = ((MR_Box) (check_hlds__unify_proc__Var_59));
              }
              {
                check_hlds__unify_proc__Var_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_56, 1) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), check_hlds__unify_proc__Var_56, 2) = ((MR_Box) (check_hlds__unify_proc__Var_58));
              }
              {
                check_hlds__unify_proc__Goal0_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Goal0_33, 0) = ((MR_Box) (check_hlds__unify_proc__Var_56));
        ...
        else
          {
            ...
            {
              check_hlds__unify_proc__Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 0) = ((MR_Box) (check_hlds__unify_proc__Y_3));
              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              check_hlds__unify_proc__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_61, 0) = ((MR_Box) (check_hlds__unify_proc__X_2));
              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_61, 1) = ((MR_Box) (check_hlds__unify_proc__Var_62));
            }
            {
              ...
              MR_hl_field(MR_mktag(2), check_hlds__unify_proc__Call_31, 2) = ((MR_Box) (check_hlds__unify_proc__Var_61));
              MR_hl_field(MR_mktag(2), check_hlds__unify_proc__Call_31, 3) = ((MR_Box) ((MR_Integer) 1));
        ...
        {
          check_hlds__unify_proc__Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_70, 0) = ((MR_Box) (check_hlds__unify_proc__Y_3));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_68, 0) = ((MR_Box) (check_hlds__unify_proc__X_2));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_68, 1) = ((MR_Box) (check_hlds__unify_proc__Var_70));
        }
        {
          check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_68, check_hlds__unify_proc__Goal_38, check_hlds__unify_proc__Context_4, check_hlds__unify_proc__Clause_5, check_hlds__unify_proc__STATE_VARIABLE_Info_67_67, check_hlds__unify_proc__STATE_VARIABLE_Info_7);
        }
      }
  }
}
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_22;
    MR_Word check_hlds__unify_proc__STATE_VARIABLE_Info_32_32;
    ...
    switch (MR_tag((MR_Word) check_hlds__unify_proc__CtorCat_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word check_hlds__unify_proc__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__CtorCat_8, (MR_Integer) 0)));

          check_hlds__unify_proc__Name_15 = ((&check_hlds__unify_proc_vector_common_7[0 + check_hlds__unify_proc__Var_34]))->check_hlds__unify_proc__vector_common_type_7_0__vct_7_f_0;
        }
        break;
      case (MR_Integer) 2:
        {
    ...
    {
      check_hlds__unify_proc__build_call_6_p_0(check_hlds__unify_proc__Name_15, check_hlds__unify_proc__ArgVars_14, check_hlds__unify_proc__Context_11, &check_hlds__unify_proc__UnifyGoal_19, check_hlds__unify_proc__STATE_VARIABLE_Info_0_20, &check_hlds__unify_proc__STATE_VARIABLE_Info_32_32);
    }
    {
      check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__ArgVars_14, check_hlds__unify_proc__UnifyGoal_19, check_hlds__unify_proc__Context_11, check_hlds__unify_proc__Clause_12, check_hlds__unify_proc__STATE_VARIABLE_Info_32_32, check_hlds__unify_proc__STATE_VARIABLE_Info_21);
    }
  }
}
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc__Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, (MR_Integer) 2)));
    MR_Word check_hlds__unify_proc__Var_42;
    ...
    {
      check_hlds__unify_proc__Var_42 = parse_tree__prog_type__check_builtin_dummy_type_ctor_1_f_0(check_hlds__unify_proc__TypeCtor_17);
    }
    ...
    if (check_hlds__unify_proc__succeeded)
      {
        ...
        {
          check_hlds__unify_proc__Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_45, 0) = ((MR_Box) (check_hlds__unify_proc__Y_12));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_43, 0) = ((MR_Box) (check_hlds__unify_proc__X_11));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_43, 1) = ((MR_Box) (check_hlds__unify_proc__Var_45));
        }
        {
          check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_43, check_hlds__unify_proc__Goal_18, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
        }
      }
    else
      {
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  check_hlds__unify_proc__Var_52 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
                }
                {
                  check_hlds__unify_proc__generate_eqv_unify_proc_body_7_p_0(check_hlds__unify_proc__Var_52, check_hlds__unify_proc__X_11, check_hlds__unify_proc__Y_12, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
                }
              }
              break;
            case (MR_Integer) 1:
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          {
                            check_hlds__unify_proc__Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_74, 0) = ((MR_Box) (check_hlds__unify_proc__Y_12));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                          {
                            check_hlds__unify_proc__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_72, 0) = ((MR_Box) (check_hlds__unify_proc__X_11));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_72, 1) = ((MR_Box) (check_hlds__unify_proc__Var_74));
                          }
                          {
                            check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_72, check_hlds__unify_proc__Goal_76, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
                          }
                        }
                        break;
                      case (MR_Integer) 1:
                        {
                          ...
                          {
                            check_hlds__unify_proc__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_68, 0) = ((MR_Box) (check_hlds__unify_proc__Y_12));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                          {
                            check_hlds__unify_proc__Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_66, 0) = ((MR_Box) (check_hlds__unify_proc__X_11));
                            MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_66, 1) = ((MR_Box) (check_hlds__unify_proc__Var_68));
                          }
                          {
                            check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_66, check_hlds__unify_proc__Goal_77, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
                          }
                        }
                        break;
                      case (MR_Integer) 2:
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            {
                              check_hlds__unify_proc__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 0) = ((MR_Box) (check_hlds__unify_proc__Y_12));
                              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                            }
                            {
                              check_hlds__unify_proc__Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 0) = ((MR_Box) (check_hlds__unify_proc__X_11));
                              MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_62, 1) = ((MR_Box) (check_hlds__unify_proc__Var_64));
                            }
                            {
                              check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_62, check_hlds__unify_proc__Goal_78, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
                            }
                          }
                          break;
                        case (MR_Integer) 1:
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      {
                        check_hlds__unify_proc__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_58, 0) = ((MR_Box) (check_hlds__unify_proc__Y_12));
                        MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        check_hlds__unify_proc__Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_56, 0) = ((MR_Box) (check_hlds__unify_proc__X_11));
                        MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_56, 1) = ((MR_Box) (check_hlds__unify_proc__Var_58));
                      }
                      {
                        check_hlds__unify_proc__quantify_clause_body_6_p_0(check_hlds__unify_proc__Var_56, check_hlds__unify_proc__Goal_83, check_hlds__unify_proc__Context_13, check_hlds__unify_proc__Clause_14, check_hlds__unify_proc__STATE_VARIABLE_Info_0_40, check_hlds__unify_proc__STATE_VARIABLE_Info_41);
                      }
                    }
                    break;
                  case (MR_Integer) 1:
...
{
  {
    ...
    {
      check_hlds__unify_proc__succeeded = check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__495__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__closure, (MR_Integer) 4))));
    }
    return check_hlds__unify_proc__succeeded;
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_31, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_6[0]));
    ...
    {
      mercury__require__expect_4_p_0(check_hlds__unify_proc__Var_31, (MR_String) "check_hlds.unify_proc", (MR_String) "predicate \140check_hlds.unify_proc.add_lazily_generated_special_pred\'/11", (MR_String) "ErrorProcs != []");
    }
    {
...
{
  {
          ...
          if (check_hlds__unify_proc__succeeded)
            {
              ...
              if (check_hlds__unify_proc__succeeded)
                {
                  check_hlds__unify_proc__X_61 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_35, (MR_Integer) 0)));
                  ...
                  if (check_hlds__unify_proc__succeeded)
                    {
                      check_hlds__unify_proc__Y_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_36, (MR_Integer) 0)));
          ...
          if (check_hlds__unify_proc__succeeded)
            {
              ...
              check_hlds__unify_proc__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Args_17, (MR_Integer) 1)));
              check_hlds__unify_proc__succeeded = ((MR_tag((MR_Word) check_hlds__unify_proc__Var_42)) == (MR_mktag((MR_Integer) 1)));
              if (check_hlds__unify_proc__succeeded)
                {
                  check_hlds__unify_proc__Index_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_42, (MR_Integer) 0)));
                  check_hlds__unify_proc__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_42, (MR_Integer) 1)));
                  check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Var_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
            }
          if (check_hlds__unify_proc__succeeded)
            {
          ...
          if (check_hlds__unify_proc__succeeded)
            {
              ...
              check_hlds__unify_proc__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Args_17, (MR_Integer) 1)));
              check_hlds__unify_proc__succeeded = ((MR_tag((MR_Word) check_hlds__unify_proc__Var_48)) == (MR_mktag((MR_Integer) 1)));
              if (check_hlds__unify_proc__succeeded)
                {
                  check_hlds__unify_proc__Y_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_48, (MR_Integer) 0)));
                  check_hlds__unify_proc__Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_48, (MR_Integer) 1)));
                  check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Var_49 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
            }
          if (check_hlds__unify_proc__succeeded)
            {
    ...
    check_hlds__unify_proc__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_50_50, (MR_Integer) 2)));
    check_hlds__unify_proc__Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__STATE_VARIABLE_Info_50_50, (MR_Integer) 3)));
    {
    ...
    {
      check_hlds__unify_proc__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_55, 0) = ((MR_Box) (check_hlds__unify_proc__Clause_20));
      MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      hlds__hlds_clauses__set_clause_list_2_p_0(check_hlds__unify_proc__Var_55, &check_hlds__unify_proc__ClausesRep_27);
    }
    {
      hlds__hlds_rtti__rtti_varmaps_init_1_p_0(&check_hlds__unify_proc__RttiVarMaps_28);
    }
    {
      check_hlds__unify_proc__Var_58 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
    }
    {
      MR_Word base;
      ...
      *check_hlds__unify_proc__ClauseInfo_12 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (check_hlds__unify_proc__Var_58));
...
{
  {
    ...
    MR_Word check_hlds__unify_proc__InitInstX_20;
    MR_Word check_hlds__unify_proc__InitInstY_22;
    MR_Word check_hlds__unify_proc__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UniMode_8, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UniMode_8, (MR_Integer) 1)));
    MR_Word check_hlds__unify_proc___FinalInstX_21;
    MR_Word check_hlds__unify_proc___FinalInstY_23;

    check_hlds__unify_proc__InitInstX_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_26, (MR_Integer) 0)));
    check_hlds__unify_proc___FinalInstX_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_26, (MR_Integer) 1)));
    check_hlds__unify_proc__InitInstY_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_27, (MR_Integer) 0)));
    check_hlds__unify_proc___FinalInstY_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_27, (MR_Integer) 1)));
    check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Det_9 == (MR_Integer) 1);
    if (check_hlds__unify_proc__succeeded)
      {
        {
          check_hlds__unify_proc__succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(check_hlds__unify_proc__ModuleInfo_6, check_hlds__unify_proc__InitInstX_20);
        }
        if (check_hlds__unify_proc__succeeded)
          {
            check_hlds__unify_proc__succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(check_hlds__unify_proc__ModuleInfo_6, check_hlds__unify_proc__InitInstY_22);
          }
      }
    if (check_hlds__unify_proc__succeeded)
      {
      ...
      {
        check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__InitInstX_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
        if (check_hlds__unify_proc__succeeded)
          {
            {
              hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&check_hlds__unify_proc__Num1_11);
          ...
          {
            check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__InitInstY_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
            if (check_hlds__unify_proc__succeeded)
              {
                {
                  hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&check_hlds__unify_proc__Num1_11);
              ...
              {
                MR_Word check_hlds__unify_proc__Requests_24;
                MR_Word check_hlds__unify_proc__UnifyReqMap_25;
                MR_Word check_hlds__unify_proc__Var_28;
                MR_Word check_hlds__unify_proc__Var_32;
                MR_Box check_hlds__unify_proc__conv0_Num1_11;

                {
                  hlds__hlds_module__module_info_get_proc_requests_2_p_0(check_hlds__unify_proc__ModuleInfo_6, &check_hlds__unify_proc__Requests_24);
                }
                check_hlds__unify_proc__UnifyReqMap_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_24, (MR_Integer) 0)));
                check_hlds__unify_proc__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_24, (MR_Integer) 1)));
                {
                  check_hlds__unify_proc__Var_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_28, 0) = ((MR_Box) (check_hlds__unify_proc__TypeCtor_7));
                  MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_28, 1) = ((MR_Box) (check_hlds__unify_proc__UniMode_8));
                }
                {
                  check_hlds__unify_proc__succeeded = mercury__map__search_3_p_0((MR_Word) &check_hlds__unify_proc__check_hlds__unify_proc__type_ctor_info_unify_proc_id_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, check_hlds__unify_proc__UnifyReqMap_25, ((MR_Box) (check_hlds__unify_proc__Var_28)), &check_hlds__unify_proc__conv0_Num1_11);
                }
                if (check_hlds__unify_proc__succeeded)
                  {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_32, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_5[0]));
    ...
    {
      mercury__require__expect_4_p_0(check_hlds__unify_proc__Var_32, (MR_String) "check_hlds.unify_proc", (MR_String) "predicate \140check_hlds.unify_proc.collect_type_defn\'/6", (MR_String) "not generated lazily");
    }
    {
    ...
    {
      check_hlds__unify_proc__Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_55, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_55, 1) = ((MR_Box) (check_hlds__unify_proc__add_lazily_generated_compare_pred_decl_4_p_0_2));
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_55, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_55, 3) = ((MR_Box) (check_hlds__unify_proc__ErrorProcs_51));
      MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_55, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      mercury__require__expect_4_p_0(check_hlds__unify_proc__Var_55, (MR_String) "check_hlds.unify_proc", (MR_String) "predicate \140check_hlds.unify_proc.add_lazily_generated_special_pred\'/11", (MR_String) "ErrorProcs != []");
    }
    {
...
{
  {
    ...
    {
      check_hlds__unify_proc__conv0_LambdaHeadVar__2_38 = check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__410__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__closure, (MR_Integer) 3))), ((MR_Word) check_hlds__unify_proc__wrapper_arg_1));
    }
    ...
    if (check_hlds__unify_proc__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_74, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_5[0]));
        ...
        {
          mercury__require__expect_4_p_0(check_hlds__unify_proc__Var_74, (MR_String) "check_hlds.unify_proc", (MR_String) "predicate \140check_hlds.unify_proc.collect_type_defn\'/6", (MR_String) "not generated lazily");
        }
        {
...
{
  {
    ...
    (check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgMode_28 = ((MR_Word) (check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__conv2_ArgMode_28);
    {
...
{
  {
    ...
    {
      (check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded = check_hlds__mode_util__mode_is_fully_input_2_p_0((check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_33, (check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgMode_28);
    }
...
{
  {
    ...
    if (MR_builtin_setjmp((check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__commit_0) == 0)
      {
        {
          mercury__list__member_2_p_1((check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__TypeCtorInfo_58_58, &(check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__conv2_ArgMode_28, (check_hlds__unify_proc__env_ptr)->check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgModes_11, check_hlds__unify_proc__request_proc_9_p_0_3, check_hlds__unify_proc__env_ptr);
        }
...
check_hlds__unify_proc__request_proc_9_p_0(
  ...
  MR_Word check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_33,
  MR_Word * check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_34)
{
  {
    ...
    (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_33 = check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_33;
    {
      MR_Word check_hlds__unify_proc__TypeCtorInfo_56_56;
      MR_Word check_hlds__unify_proc__TypeCtorInfo_57_57;
      MR_Word check_hlds__unify_proc__TypeCtorInfo_60_60;
      MR_Integer check_hlds__unify_proc__Arity_24;
      MR_Word check_hlds__unify_proc__ClausesInfo_27;
      MR_Word check_hlds__unify_proc__Requests0_29;
      MR_Word check_hlds__unify_proc__ReqQueue0_30;
      MR_Word check_hlds__unify_proc__ReqQueue_31;
      MR_Word check_hlds__unify_proc__Requests_32;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_PredMap_35_35;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_PredInfo_36_36;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_PredInfo_39_39;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_ProcMap_40_40;
      ...
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_44_44;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_Goal_45_45;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_Goal_46_46;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_Goal_48_48;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_49_49;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_ProcMap_50_50;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_PredInfo_51_51;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_PredMap_52_52;
      MR_Word check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53_53;
      MR_Word check_hlds__unify_proc__Var_54;
      MR_Box check_hlds__unify_proc__conv0_STATE_VARIABLE_PredInfo_36_36;
      MR_Box check_hlds__unify_proc__conv1_STATE_VARIABLE_ProcInfo_41_41;
      MR_Word check_hlds__unify_proc__Var_47;
      ...
      {
        hlds__hlds_module__module_info_get_preds_2_p_0((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_33, &check_hlds__unify_proc__STATE_VARIABLE_PredMap_35_35);
      }
      check_hlds__unify_proc__TypeCtorInfo_56_56 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
      check_hlds__unify_proc__TypeCtorInfo_57_57 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
      {
        mercury__map__lookup_3_p_0(check_hlds__unify_proc__TypeCtorInfo_56_56, check_hlds__unify_proc__TypeCtorInfo_57_57, check_hlds__unify_proc__STATE_VARIABLE_PredMap_35_35, ((MR_Box) (check_hlds__unify_proc__PredId_10)), &check_hlds__unify_proc__conv0_STATE_VARIABLE_PredInfo_36_36);
      }
      check_hlds__unify_proc__STATE_VARIABLE_PredInfo_36_36 = ((MR_Word) check_hlds__unify_proc__conv0_STATE_VARIABLE_PredInfo_36_36);
      (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__TypeCtorInfo_58_58 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0;
      {
        mercury__list__length_2_p_0((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__TypeCtorInfo_58_58, (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgModes_11, &check_hlds__unify_proc__Arity_24);
      }
      {
        hlds__make_hlds__add_new_proc_14_p_0(check_hlds__unify_proc__Context_15, (MR_Integer) -1, check_hlds__unify_proc__Arity_24, check_hlds__unify_proc__InstVarSet_12, (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__ArgModes_11, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__unify_proc__ArgLives_13, (MR_Integer) 1, check_hlds__unify_proc__MaybeDet_14, (MR_Integer) 1, (MR_Integer) 1, check_hlds__unify_proc__STATE_VARIABLE_PredInfo_36_36, &check_hlds__unify_proc__STATE_VARIABLE_PredInfo_39_39, check_hlds__unify_proc__ProcId_16);
      }
      {
        hlds__hlds_pred__pred_info_get_proc_table_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_PredInfo_39_39, &check_hlds__unify_proc__STATE_VARIABLE_ProcMap_40_40);
      }
      {
        hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_PredInfo_39_39, &check_hlds__unify_proc__ClausesInfo_27);
      }
      check_hlds__unify_proc__TypeCtorInfo_60_60 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      {
        mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_p_0(check_hlds__unify_proc__TypeCtorInfo_60_60, check_hlds__unify_proc__STATE_VARIABLE_ProcMap_40_40, *check_hlds__unify_proc__ProcId_16, &check_hlds__unify_proc__conv1_STATE_VARIABLE_ProcInfo_41_41);
      }
      check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_41_41 = ((MR_Word) check_hlds__unify_proc__conv1_STATE_VARIABLE_ProcInfo_41_41);
      {
        hlds__hlds_pred__proc_info_set_can_process_3_p_0((MR_Integer) 0, check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_41_41, &check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_43_43);
      }
      {
        check_hlds__clause_to_proc__copy_clauses_to_proc_4_p_0(*check_hlds__unify_proc__ProcId_16, check_hlds__unify_proc__ClausesInfo_27, check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_43_43, &check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_44_44);
      }
      {
        hlds__hlds_pred__proc_info_get_goal_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_44_44, &check_hlds__unify_proc__STATE_VARIABLE_Goal_45_45);
      }
      {
        hlds__hlds_goal__set_goal_contexts_3_p_0(check_hlds__unify_proc__Context_15, check_hlds__unify_proc__STATE_VARIABLE_Goal_45_45, &check_hlds__unify_proc__STATE_VARIABLE_Goal_46_46);
      }
      {
      ...
      if ((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded)
        {
          ...
          if ((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded)
            {
              check_hlds__unify_proc__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__MaybeDet_14, (MR_Integer) 0)));
              (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded = (check_hlds__unify_proc__Var_47 == (MR_Integer) 7);
            }
          (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded = !((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded);
        }
      if ((check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__succeeded)
        check_hlds__unify_proc__STATE_VARIABLE_Goal_48_48 = check_hlds__unify_proc__STATE_VARIABLE_Goal_46_46;
      else
        {
          check_hlds__unify_proc__STATE_VARIABLE_Goal_48_48 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(check_hlds__unify_proc__STATE_VARIABLE_Goal_46_46);
        }
      {
        hlds__hlds_pred__proc_info_set_goal_3_p_0(check_hlds__unify_proc__STATE_VARIABLE_Goal_48_48, check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_44_44, &check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_49_49);
      }
      {
        mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_p_0(check_hlds__unify_proc__TypeCtorInfo_60_60, *check_hlds__unify_proc__ProcId_16, ((MR_Box) (check_hlds__unify_proc__STATE_VARIABLE_ProcInfo_49_49)), check_hlds__unify_proc__STATE_VARIABLE_ProcMap_40_40, &check_hlds__unify_proc__STATE_VARIABLE_ProcMap_50_50);
      }
      {
        hlds__hlds_pred__pred_info_set_proc_table_3_p_0(check_hlds__unify_proc__STATE_VARIABLE_ProcMap_50_50, check_hlds__unify_proc__STATE_VARIABLE_PredInfo_39_39, &check_hlds__unify_proc__STATE_VARIABLE_PredInfo_51_51);
      }
      {
        mercury__map__det_update_4_p_0(check_hlds__unify_proc__TypeCtorInfo_56_56, check_hlds__unify_proc__TypeCtorInfo_57_57, ((MR_Box) (check_hlds__unify_proc__PredId_10)), ((MR_Box) (check_hlds__unify_proc__STATE_VARIABLE_PredInfo_51_51)), check_hlds__unify_proc__STATE_VARIABLE_PredMap_35_35, &check_hlds__unify_proc__STATE_VARIABLE_PredMap_52_52);
      }
      {
        hlds__hlds_module__module_info_set_preds_3_p_0(check_hlds__unify_proc__STATE_VARIABLE_PredMap_52_52, (check_hlds__unify_proc__env).check_hlds__unify_proc__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_33, &check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53_53);
      }
      {
        hlds__hlds_module__module_info_get_proc_requests_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53_53, &check_hlds__unify_proc__Requests0_29);
      }
      check_hlds__unify_proc__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_29, (MR_Integer) 0)));
      check_hlds__unify_proc__ReqQueue0_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_29, (MR_Integer) 1)));
      {
        check_hlds__unify_proc__Var_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_54, 0) = ((MR_Box) (check_hlds__unify_proc__PredId_10));
        MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_54, 1) = ((MR_Box) (*check_hlds__unify_proc__ProcId_16));
      }
      {
        mercury__queue__put_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, ((MR_Box) (check_hlds__unify_proc__Var_54)), check_hlds__unify_proc__ReqQueue0_30, &check_hlds__unify_proc__ReqQueue_31);
      }
      check_hlds__unify_proc__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_29, (MR_Integer) 0)));
      check_hlds__unify_proc__Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_29, (MR_Integer) 1)));
      {
        check_hlds__unify_proc__Requests_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_32, 0) = ((MR_Box) (check_hlds__unify_proc__Var_66));
        MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_32, 1) = ((MR_Box) (check_hlds__unify_proc__ReqQueue_31));
      }
      {
        hlds__hlds_module__module_info_set_proc_requests_3_p_0(check_hlds__unify_proc__Requests_32, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53_53, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_34);
      }
    }
  }
}
...
check_hlds__unify_proc__request_unify_6_p_0(
  ...
  MR_Word check_hlds__unify_proc__Context_10,
  MR_Word check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_52,
  MR_Word * check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53)
{
  {
    MR_bool check_hlds__unify_proc__succeeded;
    ...
    MR_Word check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57;

    {
      hlds__hlds_module__module_info_get_maybe_recompilation_info_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_52, &check_hlds__unify_proc__MaybeRecompInfo0_14);
    }
    if ((check_hlds__unify_proc__MaybeRecompInfo0_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57 = check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_52;
    else
      {
        ...
        {
          check_hlds__unify_proc__Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_56, 0) = ((MR_Box) (check_hlds__unify_proc__RecompInfo_17));
        }
        {
          hlds__hlds_module__module_info_set_maybe_recompilation_info_3_p_0(check_hlds__unify_proc__Var_56, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_0_52, &check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57);
        }
      }
    {
      MR_Word check_hlds__unify_proc__InitInstX_77;
      MR_Word check_hlds__unify_proc__InitInstY_79;
      MR_Word check_hlds__unify_proc__Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UnifyMode_13, (MR_Integer) 0)));
      MR_Word check_hlds__unify_proc__Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UnifyMode_13, (MR_Integer) 1)));
      MR_Word check_hlds__unify_proc___FinalInstX_78;
      MR_Word check_hlds__unify_proc___FinalInstY_80;

      check_hlds__unify_proc__InitInstX_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_83, (MR_Integer) 0)));
      check_hlds__unify_proc___FinalInstX_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_83, (MR_Integer) 1)));
      check_hlds__unify_proc__InitInstY_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_84, (MR_Integer) 0)));
      check_hlds__unify_proc___FinalInstY_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Var_84, (MR_Integer) 1)));
      check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__Determinism_9 == (MR_Integer) 1);
      if (check_hlds__unify_proc__succeeded)
        {
          {
            check_hlds__unify_proc__succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, check_hlds__unify_proc__InitInstX_77);
          }
          if (check_hlds__unify_proc__succeeded)
            {
              check_hlds__unify_proc__succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, check_hlds__unify_proc__InitInstY_79);
            }
        }
      if (check_hlds__unify_proc__succeeded)
        {
          MR_Integer check_hlds__unify_proc__Var_18;

          {
            hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&check_hlds__unify_proc__Var_18);
          }
          check_hlds__unify_proc__succeeded = MR_TRUE;
        }
      else
        {
          check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__InitInstX_77 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          if (check_hlds__unify_proc__succeeded)
            {
              MR_Integer check_hlds__unify_proc__Var_96;

              {
                hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&check_hlds__unify_proc__Var_96);
              }
              check_hlds__unify_proc__succeeded = MR_TRUE;
            }
          else
            {
              check_hlds__unify_proc__succeeded = (check_hlds__unify_proc__InitInstY_79 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              if (check_hlds__unify_proc__succeeded)
                {
                  MR_Integer check_hlds__unify_proc__Var_97;

                  {
                    hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&check_hlds__unify_proc__Var_97);
                  }
                  check_hlds__unify_proc__succeeded = MR_TRUE;
                }
              else
                {
                  ...
                  MR_Word check_hlds__unify_proc__Var_89;
                  MR_Integer check_hlds__unify_proc__Var_98;
                  MR_Box check_hlds__unify_proc__conv0_Var_98;

                  {
                    hlds__hlds_module__module_info_get_proc_requests_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, &check_hlds__unify_proc__Requests_81);
                  }
                  check_hlds__unify_proc__UnifyReqMap_82 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_81, (MR_Integer) 0)));
                  check_hlds__unify_proc__Var_89 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_81, (MR_Integer) 1)));
                  {
                    check_hlds__unify_proc__succeeded = mercury__map__search_3_p_0((MR_Word) &check_hlds__unify_proc__check_hlds__unify_proc__type_ctor_info_unify_proc_id_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, check_hlds__unify_proc__UnifyReqMap_82, ((MR_Box) (check_hlds__unify_proc__UnifyId_7)), &check_hlds__unify_proc__conv0_Var_98);
                  }
                  if (check_hlds__unify_proc__succeeded)
                    {
                      check_hlds__unify_proc__Var_98 = ((MR_Integer) check_hlds__unify_proc__conv0_Var_98);
                      check_hlds__unify_proc__succeeded = MR_TRUE;
                    }
                }
            }
    ...
    if (!(check_hlds__unify_proc__succeeded))
      {
        ...
        {
          hlds__hlds_module__module_info_get_type_table_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, &check_hlds__unify_proc__TypeTable_19);
        }
        {
        ...
        if (check_hlds__unify_proc__succeeded)
          {
            ...
            }
            {
              ...
              MR_String check_hlds__unify_proc__Var_25;
              MR_Word check_hlds__unify_proc__Var_27;
              ...
              if (check_hlds__unify_proc__succeeded)
                {
                  ...
                  check_hlds__unify_proc__Var_25 = ((MR_String) (MR_hl_field(MR_mktag(1), check_hlds__unify_proc__TypeName_22, (MR_Integer) 1)));
                  {
                    hlds__hlds_module__module_info_get_name_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, &check_hlds__unify_proc__ModuleName_26);
                  }
                  {
                  ...
                  if (check_hlds__unify_proc__succeeded)
                    {
                      ...
                      if (check_hlds__unify_proc__succeeded)
                        check_hlds__unify_proc__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__unify_proc__TypeBody_21, (MR_Integer) 1)));
                    }
                }
            }
            if (!(check_hlds__unify_proc__succeeded))
    ...
    if (check_hlds__unify_proc__succeeded)
      *check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53 = check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57;
    else
      {
        ...
        MR_Word check_hlds__unify_proc__PredId_31;
        MR_Word check_hlds__unify_proc__LHSInsts_32;
        MR_Word check_hlds__unify_proc__RHSInsts_33;
        MR_Word check_hlds__unify_proc__LHSInit_34;
        MR_Word check_hlds__unify_proc__LHSFinal_35;
        MR_Word check_hlds__unify_proc__RHSInit_36;
        MR_Word check_hlds__unify_proc__RHSFinal_37;
        MR_Word check_hlds__unify_proc__LHSMode_38;
        MR_Word check_hlds__unify_proc__RHSMode_39;
        MR_Word check_hlds__unify_proc__ArgModes0_40;
        MR_Word check_hlds__unify_proc__InMode_41;
        MR_Integer check_hlds__unify_proc__TypeArity_43;
        MR_Word check_hlds__unify_proc__TypeInfoModes_44;
        MR_Word check_hlds__unify_proc__ArgModes_45;
        MR_Integer check_hlds__unify_proc__ProcId_47;
        MR_Word check_hlds__unify_proc__Requests0_48;
        MR_Word check_hlds__unify_proc__UnifyReqMap0_49;
        MR_Word check_hlds__unify_proc__UnifyReqMap_50;
        MR_Word check_hlds__unify_proc__Requests_51;
        MR_Word check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_58_58;
        MR_Word check_hlds__unify_proc__Var_59;
        MR_Word check_hlds__unify_proc__Var_61;
        ...
        MR_Word check_hlds__unify_proc__Var_91;
        MR_Word check_hlds__unify_proc__Var_95;
        MR_Word check_hlds__unify_proc__Var_94;

        {
          hlds__hlds_module__module_info_get_special_pred_maps_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, &check_hlds__unify_proc__SpecialPredMaps_28);
        }
        ...
        check_hlds__unify_proc__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__SpecialPredMaps_28, (MR_Integer) 1)));
        check_hlds__unify_proc__Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__SpecialPredMaps_28, (MR_Integer) 2)));
        {
        ...
        if (check_hlds__unify_proc__succeeded)
          {
            ...
            check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_58_58 = check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57;
          }
        else
          {
            check_hlds__unify_proc__add_lazily_generated_unify_pred_4_p_0(check_hlds__unify_proc__TypeCtor_12, &check_hlds__unify_proc__PredId_31, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_57_57, &check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_58_58);
          }
        check_hlds__unify_proc__LHSInsts_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UnifyMode_13, (MR_Integer) 0)));
        check_hlds__unify_proc__RHSInsts_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__UnifyMode_13, (MR_Integer) 1)));
        check_hlds__unify_proc__LHSInit_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__LHSInsts_32, (MR_Integer) 0)));
        check_hlds__unify_proc__LHSFinal_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__LHSInsts_32, (MR_Integer) 1)));
        check_hlds__unify_proc__RHSInit_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__RHSInsts_33, (MR_Integer) 0)));
        check_hlds__unify_proc__RHSFinal_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__RHSInsts_33, (MR_Integer) 1)));
        {
          check_hlds__unify_proc__LHSMode_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__LHSMode_38, 0) = ((MR_Box) (check_hlds__unify_proc__LHSInit_34));
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__LHSMode_38, 1) = ((MR_Box) (check_hlds__unify_proc__LHSFinal_35));
        }
        {
          check_hlds__unify_proc__RHSMode_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__RHSMode_39, 0) = ((MR_Box) (check_hlds__unify_proc__RHSInit_36));
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__RHSMode_39, 1) = ((MR_Box) (check_hlds__unify_proc__RHSFinal_37));
        }
        {
          check_hlds__unify_proc__Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_59, 0) = ((MR_Box) (check_hlds__unify_proc__RHSMode_39));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          check_hlds__unify_proc__ArgModes0_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__ArgModes0_40, 0) = ((MR_Box) (check_hlds__unify_proc__LHSMode_38));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__ArgModes0_40, 1) = ((MR_Box) (check_hlds__unify_proc__Var_59));
        }
        {
          parse_tree__prog_mode__in_mode_1_p_0(&check_hlds__unify_proc__InMode_41);
        }
        check_hlds__unify_proc__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__TypeCtor_12, (MR_Integer) 0)));
        check_hlds__unify_proc__TypeArity_43 = ((MR_Integer) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__TypeCtor_12, (MR_Integer) 1)));
        ...
        {
          mercury__list__duplicate_3_p_0(check_hlds__unify_proc__TypeCtorInfo_68_68, check_hlds__unify_proc__TypeArity_43, ((MR_Box) (check_hlds__unify_proc__InMode_41)), &check_hlds__unify_proc__TypeInfoModes_44);
        }
        {
          check_hlds__unify_proc__ArgModes_45 = mercury__list__f_43_43_2_f_0(check_hlds__unify_proc__TypeCtorInfo_68_68, check_hlds__unify_proc__TypeInfoModes_44, check_hlds__unify_proc__ArgModes0_40);
        }
        {
          check_hlds__unify_proc__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__unify_proc__Var_61, 0) = ((MR_Box) (check_hlds__unify_proc__Determinism_9));
        }
        {
          check_hlds__unify_proc__request_proc_9_p_0(check_hlds__unify_proc__PredId_31, check_hlds__unify_proc__ArgModes_45, check_hlds__unify_proc__InstVarSet_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__unify_proc__Var_61, check_hlds__unify_proc__Context_10, &check_hlds__unify_proc__ProcId_47, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_58_58, &check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_62_62);
        }
        {
          hlds__hlds_module__module_info_get_proc_requests_2_p_0(check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_62_62, &check_hlds__unify_proc__Requests0_48);
        }
        check_hlds__unify_proc__UnifyReqMap0_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_48, (MR_Integer) 0)));
        check_hlds__unify_proc__Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_48, (MR_Integer) 1)));
        {
          mercury__map__set_4_p_0((MR_Word) &check_hlds__unify_proc__check_hlds__unify_proc__type_ctor_info_unify_proc_id_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (check_hlds__unify_proc__UnifyId_7)), ((MR_Box) (check_hlds__unify_proc__ProcId_47)), check_hlds__unify_proc__UnifyReqMap0_49, &check_hlds__unify_proc__UnifyReqMap_50);
        }
        check_hlds__unify_proc__Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_48, (MR_Integer) 0)));
        check_hlds__unify_proc__Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests0_48, (MR_Integer) 1)));
        {
          check_hlds__unify_proc__Requests_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_51, 0) = ((MR_Box) (check_hlds__unify_proc__UnifyReqMap_50));
          MR_hl_field(MR_mktag(0), check_hlds__unify_proc__Requests_51, 1) = ((MR_Box) (check_hlds__unify_proc__Var_95));
        }
        {
          hlds__hlds_module__module_info_set_proc_requests_3_p_0(check_hlds__unify_proc__Requests_51, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_62_62, check_hlds__unify_proc__STATE_VARIABLE_ModuleInfo_53);
        }
      }
  }
}
  ...
  MR_Word * check_hlds__unify_proc__HeadVar__3_3)
{
  {
    MR_bool check_hlds__unify_proc__succeeded;
    MR_Word check_hlds__unify_proc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__PR_5, (MR_Integer) 0)));
    MR_Word check_hlds__unify_proc__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__PR_5, (MR_Integer) 1)));

    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *check_hlds__unify_proc__HeadVar__3_3 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (check_hlds__unify_proc__Var_6));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (check_hlds__unify_proc__ReqQueue_4));
    }
  }
}
  ...
  MR_Word * check_hlds__unify_proc__HeadVar__2_2)
{
  {
    MR_bool check_hlds__unify_proc__succeeded;
    MR_Word check_hlds__unify_proc__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__unify_proc__PR_3, (MR_Integer) 0)));
