...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 283, &LexicalOrder_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 280, &CanCompareAsInt_16);
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_72, (MR_Integer) 281, &CastPointers_73);
