  ...
  MR_Word Info_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 320, &CastPointers_7);
  ...
  MR_Word Info_3)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_6);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 319, &BoolCanCompareAsInt_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 320, &CastPointers_68);
