  ...
  MR_Word * STATE_VARIABLE_Info_47)
{
  ...
  else
  {
    ...
    succeeded = hlds__type_util__type_body_has_user_defined_equality_pred_3_p_0(ModuleInfo_14, TypeBody_15, &UserEqComp_25);
    if (succeeded)
              ...
              case (MR_Integer) 2:
                {
                  ...
                  ArgIsDummy_44 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_14, ArgType_42);
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              EqvIsDummy_30 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_14, EqvType_29);
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  CtorCat_28 = hlds__type_util__classify_type_ctor_2_f_0(ModuleInfo_14, TypeCtor_27);
  ...
  MR_Word * STATE_VARIABLE_Info_50)
{
  ...
  else
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 785, &CompareSpec_45);
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  else
  {
    ...
    succeeded = hlds__type_util__type_body_has_user_defined_equality_pred_3_p_0(ModuleInfo_12, TypeBody_13, &UserEqComp_24);
    if (succeeded)
    {
      MR_Word Clause_80;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  ArgIsDummy_43 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_12, ArgType_41);
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              EqvIsDummy_29 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_12, EqvType_28);
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  CtorCat_27 = hlds__type_util__classify_type_ctor_2_f_0(ModuleInfo_12, TypeCtor_26);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            parse_tree__prog_type_subst__apply_renaming_to_tvars_3_p_0(Renaming_36, TypeDefnTypeParams_21, &TypeParams_37);
            ...
            parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(Renaming_36, SuperType0_19, &Type1_39);
