...
MR_decl_static(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1875__1_1_0)
...
{
MR_COMMON(2,3),
MR_ENTRY_AP(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1875__1_1_0),
0
},
{
MR_COMMON(4,1),
...
MR_BEGIN_MODULE(check_hlds__unify_proc_module66)
	MR_init_entry1(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1875__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1875__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__make_fresh_vars__1875__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1875__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
