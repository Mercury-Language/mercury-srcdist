...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 316, &CastPointers_7);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 315, &BoolCanCompareAsInt_7);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 297, &BoolAllowPackedUC_9);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_70, (MR_Integer) 316, &CastPointers_71);
