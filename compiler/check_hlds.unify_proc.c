...
MR_decl_static(fn__check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__394__1_2_0)
MR_decl_static(check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__475__1_2_0)
MR_decl_static(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1871__1_1_0)
...
{
MR_COMMON(2,3),
MR_ENTRY_AP(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1871__1_1_0),
0
},
{
MR_COMMON(2,4),
...
MR_def_label(check_hlds__unify_proc__add_lazily_generated_special_pred_11_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__475__1_2_0);
...
MR_def_label(check_hlds__unify_proc__add_lazily_generated_unify_pred_4_0,17)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__394__1_2_0);
...
MR_BEGIN_MODULE(check_hlds__unify_proc_module65)
	MR_init_entry1(fn__check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__394__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__394__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__add_lazily_generated_unify_pred__394__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__unify_proc__IntroducedFrom__func__add_lazily_generated_unify_pred__394__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__unify_proc_module66)
	MR_init_entry1(check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__475__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__475__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__add_lazily_generated_special_pred__475__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__unify_proc__IntroducedFrom__pred__add_lazily_generated_special_pred__475__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__unify_proc_module67)
	MR_init_entry1(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1871__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1871__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__make_fresh_vars__1871__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1871__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__unify_proc_module68)
...
static void mercury__check_hlds__unify_proc_maybe_bunch_1(void)
{
	...
	check_hlds__unify_proc_module68();
}
