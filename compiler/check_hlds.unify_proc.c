...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 283, &LexicalOrder_18);
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 323, &CompareSpec_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_48, (MR_Integer) 280, &CanCompareAsInt_14);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_63, (MR_Integer) 324, &ShouldPretestEq_16);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_71, (MR_Integer) 281, &CastPointers_72);
