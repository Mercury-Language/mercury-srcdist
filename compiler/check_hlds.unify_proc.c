...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 287, &LexicalOrder_18);
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 327, &CompareSpec_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_48, (MR_Integer) 284, &CanCompareAsInt_14);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_63, (MR_Integer) 328, &ShouldPretestEq_16);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_71, (MR_Integer) 285, &CastPointers_72);
