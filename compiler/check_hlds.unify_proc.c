...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 292, &LexicalOrder_18);
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 332, &CompareSpec_22);
          ...
          if (succeeded)
            ...
            switch (MR_tag((MR_Word) TypeBody_16)) {
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_16, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_48, (MR_Integer) 289, &CanCompareAsInt_14);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_63, (MR_Integer) 333, &ShouldPretestEq_16);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_71, (MR_Integer) 290, &CastPointers_72);
