  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_120, (MR_Integer) 760, &CastPointers_121);
  ...
  MR_Word Info_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 759, &BoolCanCompareAsInt_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 760, &CastPointers_68);
