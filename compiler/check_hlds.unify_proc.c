      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_72, (MR_Integer) 275, &check_hlds__unify_proc__CastPointers_73);
          }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_19, (MR_Integer) 277, &check_hlds__unify_proc__LexicalOrder_20);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__unify_proc__Globals_43, (MR_Integer) 274, &check_hlds__unify_proc__CanCompareAsInt_16);
    }
    {
