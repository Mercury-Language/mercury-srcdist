...
check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1704__1_1_f_0(
...
{
  {
    ...
    conv0_LambdaHeadVar__2_22 = check_hlds__unify_proc__IntroducedFrom__func__make_fresh_vars__1704__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 285, &LexicalOrder_20);
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_19, (MR_Integer) 325, &CompareSpec_24);
...
{
  {
    ...
    switch (MR_tag((MR_Word) CtorCat_9)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_9, (MR_Integer) 0)));

          switch (MR_tag((MR_Word) Var_54)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(Var_54)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 0)));

                Name_17 = ((&check_hlds__unify_proc_vector_common_6[10 + Var_55]))->check_hlds__unify_proc__vector_common_type_6_0__vct_6_f_0;
              }
              break;
          }
        }
    ...
    check_hlds__unify_proc__build_call_6_p_0(Name_17, ArgVars_16, Context_13, &CompareGoal_21, STATE_VARIABLE_Info_0_22, &STATE_VARIABLE_Info_52_52);
    check_hlds__unify_proc__quantify_clause_body_6_p_0(ArgVars_16, CompareGoal_21, Context_13, Clause_14, STATE_VARIABLE_Info_52_52, STATE_VARIABLE_Info_23);
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 282, &CanCompareAsInt_16);
    {
...
{
  {
    ...
    switch (MR_tag((MR_Word) CtorCat_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_8, (MR_Integer) 0)));

          switch (MR_tag((MR_Word) Var_51)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(Var_51)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_51, (MR_Integer) 0)));

                Name_15 = ((&check_hlds__unify_proc_vector_common_6[0 + Var_52]))->check_hlds__unify_proc__vector_common_type_6_0__vct_6_f_0;
              }
              break;
          }
        }
    ...
    check_hlds__unify_proc__build_call_6_p_0(Name_15, ArgVars_14, Context_11, &UnifyGoal_19, STATE_VARIABLE_Info_0_20, &STATE_VARIABLE_Info_49_49);
    check_hlds__unify_proc__quantify_clause_body_6_p_0(ArgVars_14, UnifyGoal_19, Context_11, Clause_12, STATE_VARIABLE_Info_49_49, STATE_VARIABLE_Info_21);
  }
}
