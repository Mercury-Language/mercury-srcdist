...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 280, &LexicalOrder_20);
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_19, (MR_Integer) 321, &CompareSpec_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 277, &CanCompareAsInt_16);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_64, (MR_Integer) 322, &ShouldPretestEq_16);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_72, (MR_Integer) 278, &CastPointers_73);
