...
MR_decl_static(mlds_to_gcc__IntroducedFrom__pred__gen_defn_body__822__1_1_0)
MR_decl_static(mlds_to_gcc__IntroducedFrom__pred__build_rtti_type__1949__1_2_0)
...
MR_def_label(mlds_to_gcc__build_rtti_type_5_0,8)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(mlds_to_gcc__IntroducedFrom__pred__build_rtti_type__1949__1_2_0);
...
MR_def_label(mlds_to_gcc__gen_defn_body_8_0,5)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(mlds_to_gcc__IntroducedFrom__pred__gen_defn_body__822__1_1_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tempr2 = MR_r4;
...
MR_BEGIN_MODULE(mlds_to_gcc_module99)
	MR_init_entry1(mlds_to_gcc__IntroducedFrom__pred__gen_defn_body__822__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mlds_to_gcc__IntroducedFrom__pred__gen_defn_body__822__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__gen_defn_body__822__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mlds_to_gcc__IntroducedFrom__pred__gen_defn_body__822__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mlds_to_gcc_module100)
	MR_init_entry1(mlds_to_gcc__IntroducedFrom__pred__build_rtti_type__1949__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mlds_to_gcc__IntroducedFrom__pred__build_rtti_type__1949__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__build_rtti_type__1949__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mlds_to_gcc__IntroducedFrom__pred__build_rtti_type__1949__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
