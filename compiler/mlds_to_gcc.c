...
MR_def_label(fn__mlds_to_gcc__build_data_name_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,6)) {
		MR_GOTO_LAB(fn__mlds_to_gcc__build_data_name_1_0_i33);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(6, MR_r1, 1);
	MR_r2 = MR_tfield(6, MR_r1, 0);
...
MR_def_label(mlds_to_gcc__build_local_data_defn_8_0,3)
	...
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_sv(1) = MR_body((MR_Integer) MR_tempr2, (MR_Integer) 1);
...
MR_def_label(mlds_to_gcc__gen_func_9_0,52)
	...
	MR_sv(3) = MR_r3;
	MR_sv(4) = MR_r4;
	MR_sv(5) = MR_body((MR_Integer) MR_r5, (MR_Integer) 1);
	MR_sv(6) = MR_r6;
