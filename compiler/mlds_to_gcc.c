...
MR_def_label(mlds_to_gcc__build_tc_instance_type_3_0,13)
	...
	MR_sv(3) = MR_tfield(0, MR_tempr5, 0);
	MR_sv(4) = MR_tfield(0, MR_tempr5, 1);
	MR_sv(5) = MR_tfield(0, MR_tfield(1, MR_tempr4, 0), 0);
	MR_sv(6) = MR_tfield(0, MR_tfield(1, MR_tempr4, 0), 1);
	MR_sv(7) = MR_r1;
...
MR_def_label(mlds_to_gcc__build_local_defns_6_0,3)
	...
	MR_r6 = MR_tempr3;
	if (MR_PTAG_TEST(MR_tempr3,1)) {
		MR_GOTO_LAB(mlds_to_gcc__build_local_defns_6_0_i11);
	}
	if (MR_PTAG_TEST(MR_tempr3,0)) {
...
MR_def_label(mlds_to_gcc__gen_init_fn_defns_5_0,5)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_sv(2);
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,9,1);
	MR_np_call_localret_ent(string__append_list_2_0,
...
MR_def_label(mlds_to_gcc__gen_init_fn_defns_5_0,10)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,1);
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(string__append_list_2_0,
		mlds_to_gcc__gen_init_fn_defns_5_0_i15);
