  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_131)
{
  ...
  ClonePredName_119 = mercury__string__f_43_43_2_f_0((MR_String) "direct_arg_in_out_", Var_186);
  {
    ...
    MR_hl_field(MR_mktag(3), CloneOrigin_120, 0) = ((MR_Box) ((MR_Unsigned) 12U));
    MR_hl_field(MR_mktag(3), CloneOrigin_120, 1) = ((MR_Box) (Origin_76));
    MR_hl_field(MR_mktag(3), CloneOrigin_120, 2) = ((MR_Box) (PredId_16));
    MR_hl_field(MR_mktag(3), CloneOrigin_120, 3) = ((MR_Box) (ProcId_17));
  }
