                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "NYI: inst var in predicate mode in a module ", (MR_String) "that uses partially-instantiated direct_arg terms");
                              {
                                mercury__require__unexpected_2_p_0((MR_String) "function \140transform_hlds.direct_arg_in_out.mode_needs_direct_arg_in_out\'/4", Var_73);
                                return;
                              }
                            }
                            break;
