...
transform_hlds__direct_arg_in_out__IntroducedFrom__func__args_may_violate_prohibition_pieces__2189__1_1_f_0(
  MR_Integer LambdaHeadVar__1_15);

static MR_Word MR_CALL 
transform_hlds__direct_arg_in_out__IntroducedFrom__func__args_violate_prohibition_pieces__2170__1_1_f_0(
  MR_Integer LambdaHeadVar__1_15);

static MR_Word MR_CALL 
transform_hlds__direct_arg_in_out__IntroducedFrom__func__generate_problem_proc_error__2024__1_1_f_0(
...
transform_hlds__direct_arg_in_out__IntroducedFrom__pred__expand_daio_in_goal__1146__1_2_p_0(
  MR_Word RegTypes_51,
  MR_Word HeadVar__2_178);

static MR_bool MR_CALL 
transform_hlds__direct_arg_in_out__IntroducedFrom__pred__gather_direct_arg_functors__380__1_2_p_0(
  MR_Integer Arity_11,
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_18_18 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_16 = transform_hlds__direct_arg_in_out__IntroducedFrom__func__args_may_violate_prohibition_pieces__2189__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_16 = transform_hlds__direct_arg_in_out__IntroducedFrom__func__args_violate_prohibition_pieces__2170__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_16));
  return wrapper_arg_2;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 72, &VeryVerbose_21);
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_45, &VarSet0_23, &VarTypes0_24);
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_38, VarTypes_39, STATE_VARIABLE_ProcInfo_0_45, &STATE_VARIABLE_ProcInfo_69_69);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__direct_arg_in_out__IntroducedFrom__pred__expand_daio_in_goal__1146__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_41, OrigVar_16, &VarType_44);
      parse_tree__vartypes__add_var_type_4_p_0(MergeVar_18, VarType_44, VarTypes0_41, &VarTypes_45);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(1), UnifyModes_34, (MR_Integer) 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Var_97 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConsIdCtorRepn_61, (MR_Integer) 3))));
                      succeeded = ((((MR_tag((MR_Word) Var_97)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_97, (MR_Integer) 0)))) == (MR_Integer) 13)));
                      if (succeeded)
                      {
                      }
                    }
        ...
        if (succeeded)
        {
          ...
          Var_100 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), CopySymName_65, 0) = ((MR_Box) (Var_100));
          ...
          hlds__hlds_pred__proc_id_to_int_2_p_1(&CopyProcId_67, (MR_Integer) 0);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_107, 0) = ((MR_Box) (CloneX_63));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_106, 0) = ((MR_Box) (X_31));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), CopyGoalExpr_69, 2) = ((MR_Box) (Var_106));
          ...
          parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_106, &NonLocals_71);
          hlds__instmap__instmap_lookup_var_3_p_0(InstMap0_12, X_31, &InitInstOfX_72);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_116, 0) = ((MR_Box) (X_31));
            MR_hl_field(MR_mktag(0), Var_116, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__direct_arg_in_out_scalar_common_2[3])));
          }
          {
            Var_118 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_118, 0) = ((MR_Box) (CloneX_63));
            MR_hl_field(MR_mktag(0), Var_118, 1) = ((MR_Box) (InitInstOfX_72));
          }
          {
          ...
          InstMapDelta_74 = hlds__instmap__instmap_delta_from_assoc_list_1_f_0(Var_115);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_124, 0) = ((MR_Box) (CopyGoal_76));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_123, 0) = ((MR_Box) (Goal0_77));
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_9, OldVar_5, &VarType_12);
  parse_tree__vartypes__add_var_type_4_p_0(*NewVar_6, VarType_12, VarTypes0_9, &VarTypes_13);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_23 = transform_hlds__direct_arg_in_out__IntroducedFrom__func__generate_problem_proc_error__2024__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_VarTypes_45)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__vartypes__add_var_type_4_p_0(NewVar_34, HeadType_27, STATE_VARIABLE_VarTypes_0_44, &STATE_VARIABLE_VarTypes_49_49);
  ...
  MR_Word * IsDAIO_10)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_7, Var_8, &Type_12);
  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_44, &Type_51);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__direct_arg_in_out__IntroducedFrom__pred__gather_direct_arg_functors__380__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
