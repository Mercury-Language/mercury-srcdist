...
transform_hlds__direct_arg_in_out__make_direct_arg_in_out_clone_7_p_0(
  ...
  MR_Word STATE_VARIABLE_CloneInOutMap_0_125,
  MR_Word * STATE_VARIABLE_CloneInOutMap_126,
  MR_Word STATE_VARIABLE_ModuleInfo_0_127,
  MR_Word * STATE_VARIABLE_ModuleInfo_128);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_128)
{
  ...
  MR_Word CloneVarTable_106;
  MR_Word CloneDeclaredModes_107;
  MR_Word CloneProcInfo_115;
  MR_String ClonePredName_116;
  MR_Word CloneOrigin_117;
  MR_Word CloneProcTable_118;
  MR_Word ClonePredInfo_119;
  MR_Word PredicateTable0_120;
  MR_Word ClonePredId_121;
  MR_Word PredicateTable_122;
  MR_Word ClonePredProcId_123;
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_127, &Globals_13);
  ...
  switch (VeryVerbose_14) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      hlds__passes_aux__write_proc_progress_message_5_p_0(STATE_VARIABLE_ModuleInfo_0_127, (MR_String) "Cloning", PredProcId_8);
      break;
  }
  ...
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_127, PredId_16, &PredInfo0_18);
  ...
  if (succeeded)
    hlds__hlds_module__module_info_remove_predicate_3_p_0(PredId_16, STATE_VARIABLE_ModuleInfo_0_127, &STATE_VARIABLE_ModuleInfo_133_133);
  else
  {
    MR_Word PredInfo_22;

    hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_21, PredInfo0_18, &PredInfo_22);
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_16, PredInfo_22, STATE_VARIABLE_ModuleInfo_0_127, &STATE_VARIABLE_ModuleInfo_133_133);
  }
  ...
  transform_hlds__direct_arg_in_out__clone_daio_pred_proc_args_12_p_0(STATE_VARIABLE_ModuleInfo_133_133, (MR_Integer) 1, HeadArgPos_101, TailArgPosns_102, ArgTypes_78, HeadVars_23, Modes_29, &CloneArgTypes_103, &CloneHeadVars_104, &CloneModes_105, VarTable_25, &CloneVarTable_106);
  if ((DeclaredModes_28 == (MR_Word) ((MR_Unsigned) 0U)))
    CloneDeclaredModes_107 = (MR_Word) ((MR_Unsigned) 0U);
  else
    {
      CloneDeclaredModes_107 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), CloneDeclaredModes_107, 0) = ((MR_Box) (CloneModes_105));
    }
  hlds__hlds_pred__proc_create_49_p_0(CloneHeadVars_104, Goal_24, CloneVarTable_106, RttiVarMaps_26, InstVarSet_27, CloneDeclaredModes_107, CloneModes_105, (MR_Word) ((MR_Unsigned) 0U), MaybeDeclaredDetism_31, Detism_32, EvalMethod_33, (MR_Word) ((MR_Unsigned) 0U), MainContext_35, ItemNumber_36, CanProcess_37, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 2, (MR_Word) ((MR_Unsigned) 0U), MaybeUntupleInfo_41, VarNameRemap_42, (MR_Word) ((MR_Unsigned) 0U), DeletedCallees_44, IsAddressTaken_45, HasForeignProcExports_46, HasParallelConj_47, HasUserEvent_48, HasTailCallEvent_49, OisuKinds_50, MaybeRequireTailRecursion_51, RegR_HeadVars_52, MaybeArgPassInfo_53, MaybeSpecialReturn_54, InitialLiveness_55, StackSlots_56, NeedsMaxfrSlot_57, MaybeCallTableTip_58, MaybeTableIOInfo_59, MaybeTableAttrs_60, MaybeObsoleteInFavourOf_61, MaybeDeepProfProcInfo_62, MaybeArgSizes_63, MaybeTermInfo_64, Term2Info_65, MaybeExceptionInfo_66, MaybeTrailingInfo_67, MaybeMMTablingInfo_68, SharingInfo_69, ReuseInfo_70, &CloneProcInfo_115);
  Var_139 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_17);
  Var_175 = mercury__string__f_43_43_2_f_0((MR_String) "_", PredName_72);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__direct_arg_in_out_scalar_common_3[0]), Var_139, &Var_176);
  Var_183 = mercury__string__f_43_43_2_f_0(Var_176, Var_175);
  ClonePredName_116 = mercury__string__f_43_43_2_f_0((MR_String) "direct_arg_in_out_", Var_183);
  {
    CloneOrigin_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), CloneOrigin_117, 0) = ((MR_Box) ((MR_Unsigned) 12U));
    MR_hl_field(MR_mktag(3), CloneOrigin_117, 1) = ((MR_Box) (Origin_75));
    MR_hl_field(MR_mktag(3), CloneOrigin_117, 2) = ((MR_Box) (PredId_16));
    MR_hl_field(MR_mktag(3), CloneOrigin_117, 3) = ((MR_Box) (ProcId_17));
  }
  CloneProcTable_118 = mercury__map__singleton_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_17)), ((MR_Box) (CloneProcInfo_115)));
  hlds__hlds_pred__pred_create_31_p_0(ModuleName_71, ClonePredName_116, OrigArity_73, PredOrFunc_74, CloneOrigin_117, Status_76, Markers_77, CloneArgTypes_103, DeclTypeVarSet_79, TypeVarSet_80, ExistQVars_81, ClassContext_82, ClausesInfo_83, CloneProcTable_118, Context_85, CurUserDecl_86, GoalType_87, Kinds_88, ExistQVarBindings_89, HeadTypeParams_90, ClassProofs_91, ClassConstraintMap_92, UnprovenBodyConstraints_93, InstGraphInfo_94, ArgModesMaps_95, PredVarNameRemap_96, Assertions_97, ObsoleteInFavourOf_98, FormatCall_99, InstanceMethodArgTypes_100, &ClonePredInfo_119);
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_133_133, &PredicateTable0_120);
  hlds__pred_table__predicate_table_insert_4_p_0(ClonePredInfo_119, &ClonePredId_121, PredicateTable0_120, &PredicateTable_122);
  hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredicateTable_122, STATE_VARIABLE_ModuleInfo_133_133, STATE_VARIABLE_ModuleInfo_128);
  {
    ClonePredProcId_123 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ClonePredProcId_123, 0) = ((MR_Box) (ClonePredId_121));
    MR_hl_field(MR_mktag(0), ClonePredProcId_123, 1) = ((MR_Box) (ProcId_17));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *ProcInOut_10 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ClonePredProcId_123));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (OoMInOutArgs_9));
  }
  mercury__map__det_insert_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__direct_arg_in_out_scalar_common_1[2]), ((MR_Box) (ClonePredProcId_123)), ((MR_Box) (OoMInOutArgs_9)), STATE_VARIABLE_CloneInOutMap_0_125, STATE_VARIABLE_CloneInOutMap_126);
}
