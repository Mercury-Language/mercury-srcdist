...
static /* final */ const MR_Box parse_tree__parse_pragma_foreign_scalar_common_3[9][1] = {
  ...
  /* row 4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_foreign_scalar_common_3[3])))
  },
  /* row 5 */
  {
    ((MR_Box) ((MR_String) ""))
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        *MaybeAttribute_8 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_foreign_scalar_common_3[8]));
      else
      {
  ...
  MR_Word * HeadVar__3_3)
{
  if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
    *HeadVar__3_3 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_foreign_scalar_common_3[7]));
  else
  {
...
{
  {
    ...
    if ((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U)))
      *HeadVar__5_5 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_foreign_scalar_common_3[6]));
    else
    {
      ...
      else
      {
        ...
        if ((Var_136 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          else
          {
            ...
            Code_18 = (MR_Word) (&parse_tree__parse_pragma_foreign_scalar_common_3[5]);
      ...
      else
      {
        ...
        if ((Var_369 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          else
          {
            ...
            LiteralOrInclude_33 = (MR_Word) (&parse_tree__parse_pragma_foreign_scalar_common_3[5]);
        ...
        else
        {
          ...
          if ((Var_371 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            else
            {
              ...
              LiteralOrInclude_306 = (MR_Word) (&parse_tree__parse_pragma_foreign_scalar_common_3[5]);
          ...
          case (MR_Integer) 3:
            {
              succeeded = (strcmp(ForeignTypeName_11, (MR_String) "") == 0);
              if (succeeded)
                *MaybeForeignLangType_10 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_foreign_scalar_common_3[4]));
              else
              {
                MR_Word Var_24;
                MR_Word Var_25;
