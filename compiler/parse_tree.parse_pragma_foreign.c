  ...
  MR_Word * MaybeForeignLang_8)
{
  ...
  if (succeeded)
  {
    Var_76 = ((MR_Word) ((MR_hl_field(0, LangTerm_7, (MR_Integer) 0))));
    if (((MR_tag((MR_Word) Var_76)) == (MR_Integer) 0))
    {
      String_67 = ((MR_String) ((MR_hl_field(0, Var_76, (MR_Integer) 0))));
      succeeded = MR_TRUE;
    }
    else
    if (((MR_tag((MR_Word) Var_76)) == (MR_Integer) 2))
    {
      String_67 = ((MR_String) ((MR_hl_field(2, Var_76, (MR_Integer) 0))));
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
