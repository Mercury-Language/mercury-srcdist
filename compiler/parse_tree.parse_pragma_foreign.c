  ...
  MR_Word * MaybeIOM_12)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__parse_util__parse_list_elements_5_p_0((MR_Word) (&parse_tree__parse_pragma_foreign_scalar_common_2[0]), (MR_String) "list of mapping elements", (MR_Word) (&parse_tree__parse_pragma_foreign_scalar_common_2[6]), VarSet_7, OverridesTerm_117, &MaybeOverrides_25);
    }
