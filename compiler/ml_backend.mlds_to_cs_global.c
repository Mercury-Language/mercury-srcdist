  ...
  MR_Word CellGroup_12)
{
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "{\n");
  Var_41 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 2);
  ...
  MR_Box * wrapper_arg_8)
{
  ...
  ml_backend__mlds_to_cs_global__output_scalar_defns_for_csharp_11_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv1_STATE_VARIABLE_Graph_33, ((MR_Word) (wrapper_arg_5)), &conv0_STATE_VARIABLE_Map_35);
  ...
  MR_Word GlobalVarDefn_12)
{
  ...
  Var_37 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
