    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(0, Var_44, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_global_scalar_common_8[0]));
          MR_hl_field(0, Var_44, 1) = ((MR_Box) (ml_backend__mlds_to_cs_global__output_rtti_defn_assignments_for_csharp_6_p_0_1));
  ...
  MR_Word CellGroup_12)
{
  ...
  Var_29 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_8, Type_15);
  ...
  mercury__io__write_string_4_p_0(Stream_9, Var_29);
  ...
  MR_Word CellGroup_12)
{
  ...
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
  Var_28 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_8, Type_15);
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "[] MR_vector_common_");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_global_scalar_common_3[0]), TypeRawNum_14, &Var_38);
  mercury__io__write_string_4_p_0(Stream_9, Var_38);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ";\n");
}
  ...
  MR_Word * STATE_VARIABLE_Map_33)
{
  ...
  Var_41 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_12, Type_21);
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_global_scalar_common_3[0]), TypeRawNum_20, &Var_77);
  ...
  MR_Word GlobalVarDefn_12)
{
  ...
  ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_8, Stream_9, Type_17);
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_1, Stream_2, Type_22);
