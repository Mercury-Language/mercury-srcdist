    ...
    if ((parse_tree__parse_tree_out_pragma__MaybeMode_53 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &parse_tree__parse_tree_out_pragma_scalar_common_11[0], parse_tree__parse_tree_out_pragma__DeclaredArity_55, &parse_tree__parse_tree_out_pragma__Var_72);
        }
        {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_41, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_10[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((parse_tree__parse_tree_out_pragma__MaybeTypes_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              parse_tree__parse_tree_out_pragma__TypeVarSet_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_18, (MR_Integer) 1)));
              {
                ...
                MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_19, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_4[2]));
            ...
            }
          {
            ...
            MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_25, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_4[3]));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), parse_tree__parse_tree_out_pragma__Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_1[25])));
          }
          {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_61, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_4[1]));
    ...
    if ((parse_tree__parse_tree_out_pragma__HeadVars_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_62, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_6[1]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Var_52, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_6[0]));
