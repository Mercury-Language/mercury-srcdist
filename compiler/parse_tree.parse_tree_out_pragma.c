        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(Strictness_17)) {
            ...
            case (MR_Integer) 0:
              ...
              break;
            case (MR_Integer) 1:
              STATE_VARIABLE_Strs_46_46 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[26]));
              break;
          }
          break;
        case (MR_Integer) 1:
...
{
  {
    ...
    switch (Purity_10) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        PurityStrList_27 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[4]));
        break;
    }
    switch (Terminates_11) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        TerminatesStrList_28 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[6]));
        break;
    }
    ...
    switch (Exceptions_13) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        ExceptionsStrList_33 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[7]));
        break;
    }
    switch (OrdinaryDespiteDetism_14) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        OrdinaryDespiteDetismStrList_34 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[8]));
        break;
    }
    switch (MayModifyTrail_15) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        MayModifyTrailStrList_35 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[10]));
        break;
    }
    switch (MayCallMM_Tabled_16) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        MayCallMM_TabledStrList_36 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[12]));
        break;
    }
    switch (BoxPolicy_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        BoxPolicyStrList_37 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[13]));
        break;
      case (MR_Integer) 0:
    ...
    switch (AffectsLiveness_18) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 1:
        AffectsLivenessStrList_38 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[15]));
        break;
    }
    AllocatesMemoryStrList_39 = ((&parse_tree__parse_tree_out_pragma_vector_common_9[0 + AllocatesMemory_19]))->parse_tree__parse_tree_out_pragma__vector_common_type_9_0__vct_9_f_0;
    RegistersRootsStrList_40 = ((&parse_tree__parse_tree_out_pragma_vector_common_9[4 + RegistersRoots_20]))->parse_tree__parse_tree_out_pragma__vector_common_type_9_0__vct_9_f_0;
    ...
    else
    {
      ...
      switch (MayDuplicate_41) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          MayDuplicateStrList_42 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[23]));
          break;
      }
    }
    ...
    else
    {
      ...
      switch (MayExportBody_43) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          MayExportBodyStrList_44 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_tree_out_pragma_scalar_common_2[25]));
          break;
      }
    }
    {
    ...
    Var_107 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_pragma_foreign_proc_extra_attribute_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__parse_tree_out_pragma_scalar_common_1[8]), ExtraAttributes_23);
