  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__4_4 = parse_tree__mercury_to_mercury__mercury_type_to_string_3_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          TypeVarSet_12 = ((MR_Word) ((MR_hl_field(0, Var_18, (MR_Integer) 1))));
          {
            ...
            MR_hl_field(0, Var_19, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_8[0]));
        ...
        }
        {
          ...
          MR_hl_field(0, Var_25, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pragma_scalar_common_8[1]));
        ...
        SharingPairListStr_17 = mercury__string__join_list_2_f_0((MR_String) ", ", SharingPairStrs_16);
        {
          ...
          MR_hl_field(1, Var_32, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__parse_tree_out_pragma_scalar_common_2[25])));
        }
        {
