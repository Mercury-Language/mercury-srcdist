        ...
        case (MR_Integer) 13:
          {
            ...
            func_32 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), (MR_Word) (&parse_tree__parse_tree_out_pragma_scalar_common_1[0]), (MR_Integer) 0)), (MR_Integer) 26))));
  ...
  MR_Box * STATE_VARIABLE_U_26)
{
  ...
  func_25 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_51, (MR_Integer) 0)), (MR_Integer) 26))));
