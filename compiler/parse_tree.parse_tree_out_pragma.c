...
parse_tree__parse_tree_out_pragma__format_pred_name_arity_mpf_mmode_2_f_0(
  MR_Word parse_tree__parse_tree_out_pragma__Lang_4,
  MR_Word parse_tree__parse_tree_out_pragma__Proc_5);
  ...
  MR_Word parse_tree__parse_tree_out_pragma__Proc_5)
{
  {
    MR_bool parse_tree__parse_tree_out_pragma__succeeded;
    MR_String parse_tree__parse_tree_out_pragma__ProcSpecStr_6;
    MR_Word parse_tree__parse_tree_out_pragma__Pred_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Proc_5, (MR_Integer) 0)));
    MR_Integer parse_tree__parse_tree_out_pragma__Arity_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Proc_5, (MR_Integer) 1)));
    MR_Word parse_tree__parse_tree_out_pragma__MaybePredOrFunc_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Proc_5, (MR_Integer) 2)));
    MR_Word parse_tree__parse_tree_out_pragma__MaybeMode_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__Proc_5, (MR_Integer) 3)));
    MR_Word parse_tree__parse_tree_out_pragma__PredOrFunc_11;

    if ((parse_tree__parse_tree_out_pragma__MaybePredOrFunc_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      parse_tree__parse_tree_out_pragma__PredOrFunc_11 = (MR_Integer) 0;
    else
      parse_tree__parse_tree_out_pragma__PredOrFunc_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_tree_out_pragma__MaybePredOrFunc_9, (MR_Integer) 0)));
    if ((parse_tree__parse_tree_out_pragma__MaybeMode_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Integer parse_tree__parse_tree_out_pragma__DeclaredArity_12;
        MR_String parse_tree__parse_tree_out_pragma__V_23_23;
        MR_String parse_tree__parse_tree_out_pragma__V_29_29;
        MR_Word parse_tree__parse_tree_out_pragma__V_35_35;
        MR_String parse_tree__parse_tree_out_pragma__V_37_37;
        MR_String parse_tree__parse_tree_out_pragma__V_38_38;
        ...
        switch (parse_tree__parse_tree_out_pragma__PredOrFunc_11) {
          ...
          case (MR_Integer) 1:
            {
              parse_tree__parse_tree_out_pragma__DeclaredArity_12 = (parse_tree__parse_tree_out_pragma__Arity_8 - (MR_Integer) 1);
            }
            break;
          case (MR_Integer) 0:
            parse_tree__parse_tree_out_pragma__DeclaredArity_12 = parse_tree__parse_tree_out_pragma__Arity_8;
            break;
        }
        {
          parse_tree__parse_tree_out_pragma__V_23_23 = parse_tree__mercury_to_mercury__mercury_bracketed_sym_name_to_string_1_f_0(parse_tree__parse_tree_out_pragma__Pred_7);
        }
        parse_tree__parse_tree_out_pragma__V_35_35 = (MR_Word) &parse_tree__parse_tree_out_pragma_scalar_common_11[0];
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(parse_tree__parse_tree_out_pragma__V_35_35, parse_tree__parse_tree_out_pragma__DeclaredArity_12, &parse_tree__parse_tree_out_pragma__V_29_29);
        }
        {
          parse_tree__parse_tree_out_pragma__V_37_37 = mercury__string__f_43_43_2_f_0((MR_String) "/", parse_tree__parse_tree_out_pragma__V_29_29);
        }
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0(parse_tree__parse_tree_out_pragma__V_35_35, parse_tree__parse_tree_out_pragma__V_23_23, &parse_tree__parse_tree_out_pragma__V_38_38);
        }
        {
          parse_tree__parse_tree_out_pragma__ProcSpecStr_6 = mercury__string__f_43_43_2_f_0(parse_tree__parse_tree_out_pragma__V_38_38, parse_tree__parse_tree_out_pragma__V_37_37);
        }
      }
    else
      {
        MR_Word parse_tree__parse_tree_out_pragma__ModeList_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_tree_out_pragma__MaybeMode_10, (MR_Integer) 0)));
        MR_Word parse_tree__parse_tree_out_pragma__InitVarSet_14;

        {
          mercury__varset__init_1_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0, &parse_tree__parse_tree_out_pragma__InitVarSet_14);
        }
        switch (parse_tree__parse_tree_out_pragma__PredOrFunc_11) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              ...
              parse_tree__parse_tree_out_pragma__RetMode_16 = ((MR_Word) parse_tree__parse_tree_out_pragma__conv0_RetMode_16);
              {
                parse_tree__parse_tree_out_pragma__ProcSpecStr_6 = parse_tree__parse_tree_out_pred_decl__mercury_func_mode_subdecl_to_string_6_f_0(parse_tree__parse_tree_out_pragma__Lang_4, parse_tree__parse_tree_out_pragma__InitVarSet_14, parse_tree__parse_tree_out_pragma__Pred_7, parse_tree__parse_tree_out_pragma__FuncModeList_15, parse_tree__parse_tree_out_pragma__RetMode_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
              }
            }
            break;
          case (MR_Integer) 0:
            {
              {
                parse_tree__parse_tree_out_pragma__ProcSpecStr_6 = parse_tree__parse_tree_out_pred_decl__mercury_pred_mode_subdecl_to_string_5_f_0(parse_tree__parse_tree_out_pragma__Lang_4, parse_tree__parse_tree_out_pragma__InitVarSet_14, parse_tree__parse_tree_out_pragma__Pred_7, parse_tree__parse_tree_out_pragma__ModeList_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
              }
            }
            break;
        }
      }
    return parse_tree__parse_tree_out_pragma__ProcSpecStr_6;
  }
}
...
{
  {
    ...
    {
      parse_tree__parse_tree_out_pragma__ProcSpecStr_10 = parse_tree__parse_tree_out_pragma__format_pred_name_arity_mpf_mmode_2_f_0(parse_tree__parse_tree_out_pragma__Lang_5, parse_tree__parse_tree_out_pragma__Proc_8);
    }
    if (((MR_tag((MR_Word) parse_tree__parse_tree_out_pragma__Info_9)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String parse_tree__parse_tree_out_pragma__V_47_47;
        MR_Word parse_tree__parse_tree_out_pragma__V_53_53;
        MR_String parse_tree__parse_tree_out_pragma__V_57_57;
        MR_String parse_tree__parse_tree_out_pragma__V_67_67;
        ...
        {
          parse_tree__prog_data__require_tailrec_type_string_2_p_0(parse_tree__parse_tree_out_pragma__Type_13, &parse_tree__parse_tree_out_pragma__TypeStr_16);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) ":- pragma warn_tail_recursion(");
        }
        parse_tree__parse_tree_out_pragma__V_53_53 = (MR_Word) &parse_tree__parse_tree_out_pragma_scalar_common_11[0];
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0(parse_tree__parse_tree_out_pragma__V_53_53, parse_tree__parse_tree_out_pragma__ProcSpecStr_10, &parse_tree__parse_tree_out_pragma__V_47_47);
        }
        {
          mercury__io__write_string_3_p_0(parse_tree__parse_tree_out_pragma__V_47_47);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) ", [");
        }
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0(parse_tree__parse_tree_out_pragma__V_53_53, parse_tree__parse_tree_out_pragma__WarnOrErrorStr_15, &parse_tree__parse_tree_out_pragma__V_57_57);
        }
        {
          mercury__io__write_string_3_p_0(parse_tree__parse_tree_out_pragma__V_57_57);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) ", ");
        }
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0(parse_tree__parse_tree_out_pragma__V_53_53, parse_tree__parse_tree_out_pragma__TypeStr_16, &parse_tree__parse_tree_out_pragma__V_67_67);
        }
        {
          mercury__io__write_string_3_p_0(parse_tree__parse_tree_out_pragma__V_67_67);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) "]).\n");
        }
      ...
      {
        MR_String parse_tree__parse_tree_out_pragma__V_36_36;

        {
          mercury__io__write_string_3_p_0((MR_String) ":- pragma warn_tail_recursion(");
        }
        {
          mercury__string__format__format_string_component_nowidth_noprec_3_p_0((MR_Word) &parse_tree__parse_tree_out_pragma_scalar_common_11[0], parse_tree__parse_tree_out_pragma__ProcSpecStr_10, &parse_tree__parse_tree_out_pragma__V_36_36);
        }
        {
          mercury__io__write_string_3_p_0(parse_tree__parse_tree_out_pragma__V_36_36);
        }
        {
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_pragma_var_0, parse_tree__parse_tree_out_pragma__Vars0_11, &parse_tree__parse_tree_out_pragma__Vars_16, &parse_tree__parse_tree_out_pragma__conv2_Var_179);
          }
    ...
    parse_tree__parse_tree_out_pragma__func_25 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pragma__TypeClassInfo_for_output_50, (MR_Integer) 0)), (MR_Integer) 18)));
    {
