  ...
  MR_Word * STATE_VARIABLE_CLD_76)
{
  ...
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&ll_backend__middle_rec_scalar_common_1[0]), (MR_Word) (&hlds__pred_info_types__hlds__pred_info_types__type_ctor_info_arg_info_0), HeadVars_44, ArgModes_43, &Args_45);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(PredId_221, Var_23);
                  if (succeeded)
                  {
