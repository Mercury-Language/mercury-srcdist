...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 2)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_37, (MR_Integer) 1)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_42, (MR_Integer) 1)));
        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 6)));
        ...
        case (MR_Integer) 18:
          {
            ...
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 21:
          {
            ...
            MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 2)));
        ...
        case (MR_Integer) 27:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 3)));
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 9)));
  ...
  MR_Word * STATE_VARIABLE_Used_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_7, (MR_Integer) 2)));
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_7, (MR_Integer) 6)));
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_Used_0_2;
  ...
  MR_Word * STATE_VARIABLE_Used_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Used_19_19;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_7, (MR_Integer) 2)));
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_7, (MR_Integer) 6)));
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_Used_0_2;
  ...
  top_of_proc_1:;
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Lval_4, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_34, (MR_Integer) 5)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_18, (MR_Integer) 2)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_29, (MR_Integer) 5)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_13, (MR_Integer) 2)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_33, (MR_Integer) 5)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_17, (MR_Integer) 2)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_36, (MR_Integer) 5)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_20, (MR_Integer) 2)));
