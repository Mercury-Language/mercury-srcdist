...
MR_decl_label6(ll_backend__middle_rec__find_used_registers_components_3_0, 32,3,6,9,10,28)
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module13)
	...
	MR_init_label6(ll_backend__middle_rec__find_used_registers_components_3_0,32,3,6,9,10,28)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,3)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_components_3_0_i28));
