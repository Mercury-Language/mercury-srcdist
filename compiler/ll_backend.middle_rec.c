          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  GoalExpr_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal2_19, (MR_Integer) 0))));
                  succeeded = ((((MR_tag((MR_Word) GoalExpr_35)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_35, (MR_Integer) 0)))) == (MR_Integer) 2)));
                  if (succeeded)
                  {
                    Var_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_35, (MR_Integer) 1))) & (MR_Integer) 1);
                    Goals_37 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_35, (MR_Integer) 2))));
                    succeeded = (Var_38 == (MR_Integer) 0);
                    if (succeeded)
                      succeeded = ll_backend__middle_rec__contains_simple_recursive_call_conj_2_p_0(Goals_37, STATE_VARIABLE_CI_0_20);
                  }
                }
                if (succeeded)
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    GoalExpr_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_17, (MR_Integer) 0))));
                    succeeded = ((((MR_tag((MR_Word) GoalExpr_40)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_40, (MR_Integer) 0)))) == (MR_Integer) 2)));
                    if (succeeded)
                    {
                      Var_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_40, (MR_Integer) 1))) & (MR_Integer) 1);
                      Goals_42 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_40, (MR_Integer) 2))));
                      succeeded = (Var_43 == (MR_Integer) 0);
                      if (succeeded)
                      {
                        succeeded = ll_backend__middle_rec__contains_simple_recursive_call_conj_2_p_0(Goals_42, STATE_VARIABLE_CI_0_20);
                        if (succeeded)
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) Comp_7)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Out_18 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Comp_7, (MR_Integer) 0))));

            ll_backend__middle_rec__insert_foreign_proc_output_registers_3_p_0(Out_18, STATE_VARIABLE_Used_0_2, &STATE_VARIABLE_Used_12_12);
          }
          break;
        case (MR_Integer) 3:
          ...
          case (MR_Integer) 5:
            {
              ...
              switch (MR_tag((MR_Word) MemRef_17)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Rval1_37 = ((MR_Word) ((MR_hl_field(MR_mktag(2), MemRef_17, (MR_Integer) 0))));
                    MR_Word Rval2_39 = ((MR_Word) ((MR_hl_field(MR_mktag(2), MemRef_17, (MR_Integer) 2))));
                    MR_Word STATE_VARIABLE_Used_20_43;
                    MR_Word next_value_of_tscc_proc_2_input_1_Rval_4;
                    MR_Word next_value_of_tscc_proc_2_input_2_STATE_VARIABLE_Used_0_18;

                    ll_backend__middle_rec__find_used_registers_rval_3_p_0(Rval1_37, STATE_VARIABLE_Used_0_18, &STATE_VARIABLE_Used_20_43);
                    // direct tailcall eliminated
                    ;
                    next_value_of_tscc_proc_2_input_1_Rval_4 = Rval2_39;
                    next_value_of_tscc_proc_2_input_2_STATE_VARIABLE_Used_0_18 = STATE_VARIABLE_Used_20_43;
                    tscc_proc_2_input_1_Rval_4 = next_value_of_tscc_proc_2_input_1_Rval_4;
                    tscc_proc_2_input_2_STATE_VARIABLE_Used_0_18 = next_value_of_tscc_proc_2_input_2_STATE_VARIABLE_Used_0_18;
                    goto top_of_proc_2;
                  }
          ...
          case (MR_Integer) 6:
            {
              ...
              Var_67 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Cond_17);
              succeeded = (Var_67 == (MR_Integer) 1);
              if (succeeded)
              {
                Var_68 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Then_18);
                succeeded = (Var_68 == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_69 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Else_19);
            ...
            case (MR_Integer) 6:
              {
                ...
                Var_71 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Cond_21);
                succeeded = (Var_71 == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_72 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Then_22);
                  succeeded = (Var_72 == (MR_Integer) 1);
                  if (succeeded)
                  {
                    Var_73 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Else_23);
                    succeeded = (Var_73 == (MR_Integer) 1);
                  }
                }
                if (succeeded)
            ...
            case (MR_Integer) 6:
              {
                ...
                Var_74 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Cond_24);
                succeeded = (Var_74 == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_75 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Then_25);
                  succeeded = (Var_75 == (MR_Integer) 1);
                  if (succeeded)
                  {
                    Var_76 = ll_backend__middle_rec__contains_only_builtins_1_f_0(Else_26);
