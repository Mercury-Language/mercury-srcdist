...
MR_decl_label4(ll_backend__middle_rec__add_counter_to_livevals_3_0, 22,6,4,10)
...
MR_decl_label7(ll_backend__middle_rec__find_used_registers_components_3_0, 32,3,6,9,10,16,28)
MR_decl_label8(ll_backend__middle_rec__find_used_registers_instr_3_0, 103,46,79,104,7,15,106,25)
MR_decl_label8(ll_backend__middle_rec__find_used_registers_instr_3_0, 26,81,28,27,102,82,31,32)
MR_decl_label8(ll_backend__middle_rec__find_used_registers_instr_3_0, 105,42,107,59,60,62,66,72)
MR_decl_label1(ll_backend__middle_rec__find_used_registers_instr_3_0, 101)
...
MR_decl_label3(ll_backend__middle_rec__find_used_registers_mem_ref_3_0, 15,23,6)
MR_decl_label8(ll_backend__middle_rec__find_used_registers_rval_3_0, 7,15,11,20,3,4,6,13)
...
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 18,19,20,21,22,23,24,26)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 27,28,29,30,31,34,35,36)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 37,39,40,41,42,43,44,45)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 46,49,50,55,62,66,47,72)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 75,78,82,83,84,90,100,101)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 104,105,106,109,110,113,114,115)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 116,117,118,119,120,93,122,130)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 131,134,135,136,137,140,141,148)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 149,151,152,153,154,155,156,157)
MR_decl_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 158,159,160,161,162,163,164,165)
MR_decl_label5(ll_backend__middle_rec__middle_rec_generate_switch_8_0, 166,167,168,169,1)
...
MR_decl_label8(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0, 34,38,40,48,21,53,4,58)
MR_decl_label8(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0, 6,8,10,12,14,16,19,24)
MR_decl_label4(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0, 63,25,30,32)
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module0)
	...
	MR_init_label8(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,34,38,40,48,21,53,4,58)
	MR_init_label8(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,6,8,10,12,14,16,19,24)
	MR_init_label4(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,63,25,30,32)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i34) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i21) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i58) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i53));
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_ctfield(0, MR_r1, 3);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i38) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i63) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i63) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i48));
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_ctfield(0, MR_r2, 6);
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i40);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(1, MR_r3, 0);
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i58);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
	}
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,53)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i8) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i32) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i19) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i24) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i10) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i30));
...
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
...
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,25)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i58) MR_AND
		MR_LABEL_AP(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0_i53));
MR_def_label(fn__ll_backend__middle_rec__contains_only_builtins_expr_1_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("middle_rec.m", 12);
	MR_r2 = (MR_Word) MR_string_const("contains_only_builtins: shorthand", 33);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module6)
	...
	MR_init_label4(ll_backend__middle_rec__add_counter_to_livevals_3_0,22,6,4,10)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__add_counter_to_livevals_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__add_counter_to_livevals_3_0_i22);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__middle_rec__add_counter_to_livevals_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module9)
	...
	MR_init_label8(ll_backend__middle_rec__find_used_registers_rval_3_0,7,15,11,20,3,4,6,13)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_rval_3_0)
	...
	MR_sv(2) = (MR_Word) MR_succip;
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i7) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i15) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i11) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i20));
...
MR_def_label(ll_backend__middle_rec__find_used_registers_rval_3_0,11)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i11) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_rval_3_0_i20));
MR_def_label(ll_backend__middle_rec__find_used_registers_rval_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module10)
	...
	MR_init_label3(ll_backend__middle_rec__find_used_registers_mem_ref_3_0,15,23,6)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_mem_ref_3_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_mem_ref_3_0_i15);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_mem_ref_3_0_i23);
	}
	}
MR_def_label(ll_backend__middle_rec__find_used_registers_mem_ref_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_const_mask_field(MR_r1, 0);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_rval_3_0);
MR_def_label(ll_backend__middle_rec__find_used_registers_mem_ref_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module13)
	...
	MR_init_label7(ll_backend__middle_rec__find_used_registers_components_3_0,32,3,6,9,10,16,28)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_components_3_0)
	...
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,3)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_components_3_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_components_3_0_i6) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_components_3_0_i9) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_components_3_0_i16));
...
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,10)
	...
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(2);
	MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_components_3_0_i32);
	}
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(3, MR_r3, 0);
	}
MR_def_label(ll_backend__middle_rec__find_used_registers_components_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module16)
	...
	MR_init_label8(ll_backend__middle_rec__find_used_registers_instr_3_0,103,46,79,104,7,15,106,25)
	MR_init_label8(ll_backend__middle_rec__find_used_registers_instr_3_0,26,81,28,27,102,82,31,32)
	MR_init_label8(ll_backend__middle_rec__find_used_registers_instr_3_0,105,42,107,59,60,62,66,72)
	MR_init_label1(ll_backend__middle_rec__find_used_registers_instr_3_0,101)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_instr_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i103) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i79));
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i7) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i104) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i105) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i66) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i66) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i106) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i66) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i66) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i107) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i62) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i66) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i102) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i15) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i72));
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_lval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i42);
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_sv(3) = MR_ctfield(3, MR_tempr1, 8);
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	}
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_lval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i25);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,25)
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_rval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i26);
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_instr_3_0_i27);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,28)
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_rval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i81);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_instr_3_0_i31);
	}
	MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_instr_3_0_i82);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(4);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,31)
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_rval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i32);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(1),0,0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_instr_3_0_i101);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,105)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 2);
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_lval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i42);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_rval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i59);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_lval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i60);
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 3);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_rval_3_0);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,66)
	...
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_rval_3_0);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_lval_3_0);
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module20)
	...
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,18,19,20,21,22,23,24,26)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,27,28,29,30,31,34,35,36)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,37,39,40,41,42,43,44,45)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,46,49,50,55,62,66,47,72)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,75,78,82,83,84,90,100,101)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,104,105,106,109,110,113,114,115)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,116,117,118,119,120,93,122,130)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,131,134,135,136,137,140,141,148)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,149,151,152,153,154,155,156,157)
	MR_init_label8(ll_backend__middle_rec__middle_rec_generate_switch_8_0,158,159,160,161,162,163,164,165)
	MR_init_label5(ll_backend__middle_rec__middle_rec_generate_switch_8_0,166,167,168,169,1)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,30)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i31);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,45)
	...
	MR_np_call_localret_ent(ll_backend__middle_rec__generate_downloop_test_3_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i46);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(15),0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__middle_rec_generate_switch_8_0_i47);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,49)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i50);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i55);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_string_const("increment loop counter", 22);
	MR_sv(15) = MR_r1;
	MR_sv(16) = (MR_Word) MR_TAG_COMMON(3,2,1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i62);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	...
	MR_tfield(0, MR_tempr3, 1) = (MR_Word) MR_string_const("decrement loop counter", 22);
	MR_sv(16) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i66);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_r2 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = MR_tempr3;
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_string_const("test on upward loop", 19);
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i90);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,47)
	...
	MR_np_call_localret_ent(fn__ll_backend__proc_gen__push_msg_3_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i72);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 4);
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i75);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i78);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,83)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i84);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
	...
	MR_tag_alloc_heap(MR_tempr2, 3, (MR_Integer) 4);
	MR_tfield(3, MR_tempr2, 0) = (MR_Integer) 2;
	MR_tfield(3, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 22);
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i90);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(17) = MR_r1;
	if (MR_LTAGS_TESTR(MR_sv(11),0,0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__middle_rec_generate_switch_8_0_i93);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,100)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i101);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,105)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i106);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,109)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i110);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,110)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,119)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i120);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,120)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i169);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(ll_backend__middle_rec__find_labels_2_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i122);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,122)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__middle_rec__middle_rec_generate_switch_8_0_i1);
	}
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,130)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i131);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,131)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,136)
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i137);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,137)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,140)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i141);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,141)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_sv(1) = MR_r1;
	MR_sv(14) = (MR_Word) MR_TAG_COMMON(3,2,2);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,148)
	...
	MR_np_call_localret_ent(fn__cord__from_list_1_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i149);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,149)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(14) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,4,0);
...
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,168)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__middle_rec__middle_rec_generate_switch_8_0_i169);
MR_def_label(ll_backend__middle_rec__middle_rec_generate_switch_8_0,169)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r3 = MR_sv(18);
