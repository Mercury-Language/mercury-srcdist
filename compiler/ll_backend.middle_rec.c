  ...
  MR_Word * STATE_VARIABLE_CLD_76)
{
  ...
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&ll_backend__middle_rec_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_arg_info_0), HeadVars_44, ArgModes_43, &Args_45);
