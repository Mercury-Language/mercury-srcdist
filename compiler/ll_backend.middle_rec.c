...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 2)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_37, (MR_Integer) 1)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_42, (MR_Integer) 1)));
...
{
  {
    ...
    ll_backend__code_loc_dep__produce_variable_6_p_0(Var_11, &VarCode_26, &VarRval_27, STATE_VARIABLE_CI_0_72, STATE_VARIABLE_CLD_78_78, &STATE_VARIABLE_CLD_79_79);
    ...
    ll_backend__code_loc_dep__generate_branch_end_6_p_0(StoreMap_34, (MR_Word) ((MR_Unsigned) 0U), &MaybeEnd1_37, &BaseSaveCode_38, STATE_VARIABLE_CI_84_84, STATE_VARIABLE_CLD_85_85);
    ...
    ll_backend__code_loc_dep__generate_branch_end_6_p_0(StoreMap_34, MaybeEnd1_37, &MaybeEnd_40, &RecSaveCode_41, STATE_VARIABLE_CI_89_89, STATE_VARIABLE_CLD_90_90);
    ...
    ll_backend__code_loc_dep__setup_return_6_p_0(Args_44, &LiveArgs_45, &EpilogCode_46, STATE_VARIABLE_CI_89_89, STATE_VARIABLE_CLD_92_92, STATE_VARIABLE_CLD_75);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_104 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__middle_rec_scalar_common_1[1]));
        {
          ...
          MR_hl_field(MR_mktag(3), Var_103, 2) = ((MR_Box) (Var_104));
        }
        {
        ...
        Var_114 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__middle_rec_scalar_common_1[2]));
        {
        ...
        IncrAuxReg_65 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_108)));
        {
          ...
          MR_hl_field(MR_mktag(3), Var_120, 3) = ((MR_Box) (Var_114));
        }
        {
        ...
        DecrAuxReg_66 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_118)));
        {
          ...
          MR_hl_field(MR_mktag(3), Var_130, 3) = ((MR_Box) (Var_104));
        }
        {
      ...
      else
      {
        ...
        {
          Var_140 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          Var_153 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      ...
      if ((AfterInstrs_55 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          Var_225 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          Var_233 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_233, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), Var_233, 1) = ((MR_Box) (Loop1Label_57));
        }
        {
          Var_232 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          Var_242 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_242, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), Var_242, 1) = ((MR_Box) (BaseLabel_31));
        }
        {
          Var_241 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 6)));
        ...
        case (MR_Integer) 18:
          {
            ...
            MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 21:
          {
            ...
            MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 2)));
        ...
        case (MR_Integer) 27:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 3)));
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_4, (MR_Integer) 9)));
  ...
  MR_Word * STATE_VARIABLE_Used_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_7, (MR_Integer) 2)));
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_7, (MR_Integer) 6)));
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_Used_0_2;
  ...
  MR_Word * STATE_VARIABLE_Used_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Used_19_19;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_7, (MR_Integer) 2)));
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_7, (MR_Integer) 6)));
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_Used_0_2;
  ...
  top_of_proc_1:;
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Lval_4, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_34, (MR_Integer) 5)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_18, (MR_Integer) 2)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_29, (MR_Integer) 5)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_13, (MR_Integer) 2)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_33, (MR_Integer) 5)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_17, (MR_Integer) 2)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Uni_36, (MR_Integer) 5)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_20, (MR_Integer) 2)));
