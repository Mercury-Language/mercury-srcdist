...
MR_decl_label9(ll_backend__middle_rec__find_used_registers_rval_3_0, 46,4,3,6,7,9,11,13,14)
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module9)
	...
	MR_init_label9(ll_backend__middle_rec__find_used_registers_rval_3_0,46,4,3,6,7,9,11,13,14)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_rval_3_0)
	...
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
MR_def_label(ll_backend__middle_rec__find_used_registers_rval_3_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
...
MR_def_label(ll_backend__middle_rec__find_used_registers_rval_3_0,4)
	...
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(2);
	MR_GOTO_LAB(ll_backend__middle_rec__find_used_registers_rval_3_0_i46);
	}
...
void mercury__ll_backend__middle_rec__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__middle_rec);
