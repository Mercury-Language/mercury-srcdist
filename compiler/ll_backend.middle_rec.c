...
MR_decl_label8(ll_backend__middle_rec__find_used_registers_instr_3_0, 59,76,8,10,11,78,14,79)
MR_decl_label6(ll_backend__middle_rec__find_used_registers_instr_3_0, 30,31,47,52,57,75)
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module16)
	...
	MR_init_label8(ll_backend__middle_rec__find_used_registers_instr_3_0,59,76,8,10,11,78,14,79)
	MR_init_label6(ll_backend__middle_rec__find_used_registers_instr_3_0,30,31,47,52,57,75)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_instr_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i76) MR_AND
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,59)
	...
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,10)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i78) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i47) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i47) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i79) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i47) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i47) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57) MR_AND
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i52) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i57));
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_lval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i14);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,30)
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(ll_backend__middle_rec__find_used_registers_rval_3_0,
		ll_backend__middle_rec__find_used_registers_instr_3_0_i31);
