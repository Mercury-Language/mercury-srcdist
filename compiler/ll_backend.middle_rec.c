...
MR_decl_label8(ll_backend__middle_rec__find_used_registers_instr_3_0, 56,66,8,10,11,68,69,30)
MR_decl_label3(ll_backend__middle_rec__find_used_registers_instr_3_0, 44,49,54)
...
MR_BEGIN_MODULE(ll_backend__middle_rec_module16)
	...
	MR_init_label8(ll_backend__middle_rec__find_used_registers_instr_3_0,56,66,8,10,11,68,69,30)
	MR_init_label3(ll_backend__middle_rec__find_used_registers_instr_3_0,44,49,54)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__middle_rec__find_used_registers_instr_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_proceed();
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,10)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i44) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i44) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i54) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i54) MR_AND
		...
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i54) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__middle_rec__find_used_registers_instr_3_0_i54));
...
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,30)
	...
	MR_decr_sp(2);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_rval_3_0);
MR_def_label(ll_backend__middle_rec__find_used_registers_instr_3_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_tailcall_ent(ll_backend__middle_rec__find_used_registers_rval_3_0);
