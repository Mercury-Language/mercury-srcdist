...
static const MR_PseudoTypeInfo hlds__make_hlds__superhomogeneous_util__hlds__make_hlds__superhomogeneous_util__field_types_arg_context_0_1[1] = { (MR_PseudoTypeInfo) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_call_id_0) };
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_goal____Compare____call_id_0_0(HeadVar__1_1, ArgX1_9, ArgY1_10);
            }
            break;
          case (MR_Integer) 2:
            *HeadVar__1_1 = (MR_Integer) 1;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = hlds__hlds_goal____Unify____call_id_0_0(ArgX1_7, ArgY1_8);
          }
        }
        break;
      case (MR_Integer) 2:
  ...
  MR_Word * STATE_VARIABLE_UrInfo_13)
{
  ...
  if (succeeded)
  {
    ...
    *STATE_VARIABLE_UrInfo_13 = STATE_VARIABLE_UrInfo_0_12;
    ...
    hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(Var_7, STATE_VARIABLE_UrInfo_0_12, STATE_VARIABLE_UrInfo_13);
}
  ...
  MR_Word * STATE_VARIABLE_UrInfo_8)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Arg_34)) == (MR_Integer) 0))
      hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(&Var_20, STATE_VARIABLE_UrInfo_1_40, &STATE_VARIABLE_UrInfo_1_33);
    else
    {
