...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_62, (MR_Integer) 681, &Experiment_64);
...
{
  {
    ...
    if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_27, (MR_Integer) 681, &Experiment_29);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_51, (MR_Integer) 681, &Experiment_53);
