...
{
  {
    MR_Word CodeModel_26 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HashSearchInfo_15, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 3);
...
{
  {
    ...
    }
    {
      ...
      *HashSearchInfo_14 = base;
      MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (CodeModel_9))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (LoopPresent_11)))));
