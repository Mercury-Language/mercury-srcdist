  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_56, (MR_Integer) 686, &Experiment_58);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_44, (MR_Integer) 686, &Experiment_46);
