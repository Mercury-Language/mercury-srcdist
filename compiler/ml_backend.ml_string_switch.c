...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_43, Var_44);
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_64, (MR_Integer) 687, &Experiment_66);
...
{
  {
    ...
    if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_27, (MR_Integer) 687, &Experiment_29);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_52, (MR_Integer) 687, &Experiment_54);
