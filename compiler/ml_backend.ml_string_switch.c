...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(ml_backend__ml_string_switch__Globals_68, (MR_Integer) 672, &ml_backend__ml_string_switch__Experiment_70);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_string_option_3_p_0(ml_backend__ml_string_switch__Globals_55, (MR_Integer) 672, &ml_backend__ml_string_switch__Experiment_57);
          }
