...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_64, (MR_Integer) 697, &Experiment_66);
...
{
  {
    ...
    if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_27, (MR_Integer) 697, &Experiment_29);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_52, (MR_Integer) 697, &Experiment_54);
