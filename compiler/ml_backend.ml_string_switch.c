...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_62, (MR_Integer) 676, &Experiment_64);
...
{
  {
    ...
    if ((MaybeStopLoopVarLval_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_27, (MR_Integer) 676, &Experiment_29);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_51, (MR_Integer) 676, &Experiment_53);
