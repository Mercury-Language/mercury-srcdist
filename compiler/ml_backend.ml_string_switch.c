...
{
  {
    ...
    else
    {
      ...
      MR_Word InitStopLoopVarStmt_194;
      MR_Word StopLoopTest_196;
      MR_Word Var_197;
      MR_Word Var_202;
      MR_Word MaybeStopLoopVarLval_213;
      MR_Word STATE_VARIABLE_Info_74_218;
      ...
      {
        MaybeStopLoopVarLval_213 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeStopLoopVarLval_213, 0) = ((MR_Box) (StopLoopVarLval0_48));
      }
      {
      ...
      ml_backend__ml_string_switch__ml_wrap_loop_break_12_p_0(CodeModel_26, LoopPresent_27, Context_28, MaybeStopLoopVarLval_213, MatchDefns_22, MatchStmts_23, FailStmts_33, &SetupForFailStmts_49, &SuccessStmt_50, &AfterStmts_51, STATE_VARIABLE_Info_0_71, &STATE_VARIABLE_Info_74_218);
      {
        Var_197 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_197, 0) = ((MR_Box) (StopLoopVarLval0_48));
        MR_hl_field(MR_mktag(2), Var_197, 1) = ((MR_Box) (Var_116));
      }
      {
        InitStopLoopVarStmt_194 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), InitStopLoopVarStmt_194, 0) = ((MR_Box) ((MR_Unsigned) 8U));
        MR_hl_field(MR_mktag(3), InitStopLoopVarStmt_194, 1) = ((MR_Box) (Var_197));
        MR_hl_field(MR_mktag(3), InitStopLoopVarStmt_194, 2) = ((MR_Box) (Context_28));
      }
      {
        InitStopLoopVarStmts_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), InitStopLoopVarStmts_57, 0) = ((MR_Box) (InitStopLoopVarStmt_194));
      ...
      switch (CodeModel_26) {
        ...
        case (MR_Integer) 0:
          {
            InitSuccessStmts_58 = (MR_Word) ((MR_Unsigned) 0U);
            *STATE_VARIABLE_Info_72 = STATE_VARIABLE_Info_74_218;
          }
          break;
        case (MR_Integer) 2:
          {
        ...
        case (MR_Integer) 1:
          {
            ...
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_string_switch_scalar_common_1[24])), Context_28, &InitSuccessStmt_185, STATE_VARIABLE_Info_74_218, STATE_VARIABLE_Info_72);
            {
      ...
      {
        StopLoopTest_196 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), StopLoopTest_196, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        MR_hl_field(MR_mktag(3), StopLoopTest_196, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_string_switch_scalar_common_1[11])));
        MR_hl_field(MR_mktag(3), StopLoopTest_196, 2) = ((MR_Box) (Var_202));
        MR_hl_field(MR_mktag(3), StopLoopTest_196, 3) = ((MR_Box) (Var_116));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), LoopTest_59, 2) = ((MR_Box) (StopLoopTest_196));
          ...
          *SetupForFailStmts_20 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            else
            {
              ...
              MR_Word Globals_163;
              MR_Word SupportsBreakContinue_164;
              MR_String Experiment_165;

              ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_44, &ModuleInfo_162);
              hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_162, &Globals_163);
              SupportsBreakContinue_164 = ml_backend__ml_target_util__globals_target_supports_break_and_continue_1_f_0(Globals_163);
              libs__globals__lookup_string_option_3_p_0(Globals_163, (MR_Integer) 702, &Experiment_165);
              succeeded = (SupportsBreakContinue_164 == (MR_Integer) 1);
              if (succeeded)
              {
                succeeded = (strcmp(Experiment_165, (MR_String) "use_end_label") == 0);
                succeeded = !(succeeded);
              }
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), BreakCommentStmt_115, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_string_switch_scalar_common_4[5])));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_123, 0) = ((MR_Box) (BreakStmt_116));
                  MR_hl_field(MR_mktag(1), Var_123, 1) = ((MR_Box) (*SetupForFailStmts_20));
                }
                {
                  Var_122 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_122, 0) = ((MR_Box) (BreakCommentStmt_115));
                  MR_hl_field(MR_mktag(1), Var_122, 1) = ((MR_Box) (Var_123));
                }
                Var_121 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_122);
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  *BodyStmt_21 = base;
              ...
              {
                MR_String EndLabel_126;
                MR_Word GotoCommentStmt_127;
                MR_Word GotoEndStmt_128;
                MR_Word EndLabelStmt_129;
                MR_Word Var_132;
                MR_Word Var_134;
                MR_Word Var_135;
                MR_Word Var_136;
                ...
                ml_backend__ml_code_util__ml_gen_new_label_3_p_0(&EndLabel_126, STATE_VARIABLE_Info_0_44, STATE_VARIABLE_Info_45);
                {
                  GotoCommentStmt_127 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GotoCommentStmt_127, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                  MR_hl_field(MR_mktag(3), GotoCommentStmt_127, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_string_switch_scalar_common_4[6])));
                  MR_hl_field(MR_mktag(3), GotoCommentStmt_127, 2) = ((MR_Box) (Context_15));
                }
                {
                  Var_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_132, 0) = ((MR_Box) (EndLabel_126));
                }
                {
                  GotoEndStmt_128 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GotoEndStmt_128, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                  MR_hl_field(MR_mktag(3), GotoEndStmt_128, 1) = ((MR_Box) (Var_132));
                  MR_hl_field(MR_mktag(3), GotoEndStmt_128, 2) = ((MR_Box) (Context_15));
                }
                {
                  Var_136 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_136, 0) = ((MR_Box) (GotoEndStmt_128));
                  MR_hl_field(MR_mktag(1), Var_136, 1) = ((MR_Box) (*SetupForFailStmts_20));
                }
                {
                  Var_135 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_135, 0) = ((MR_Box) (GotoCommentStmt_127));
                  MR_hl_field(MR_mktag(1), Var_135, 1) = ((MR_Box) (Var_136));
                }
                Var_134 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_135);
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  *BodyStmt_21 = base;
                ...
                {
                  EndLabelStmt_129 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), EndLabelStmt_129, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), EndLabelStmt_129, 1) = ((MR_Box) (EndLabel_126));
                  MR_hl_field(MR_mktag(3), EndLabelStmt_129, 2) = ((MR_Box) (Context_15));
                }
                {
                  Var_137 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_137, 0) = ((MR_Box) (EndLabelStmt_129));
                  MR_hl_field(MR_mktag(1), Var_137, 1) = ((MR_Box) (*SetupForFailStmts_20));
                }
                *AfterStmts_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), (MR_Word) ((MR_Unsigned) 0U), Var_137);
              }
            }
          }
          else
          {
            MR_Word StopLoopVarLval_237 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeStopLoopVarLval_16, (MR_Integer) 0))));
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(2), Var_220, 0) = ((MR_Box) (StopLoopVarLval_237));
                MR_hl_field(MR_mktag(2), Var_220, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_string_switch_scalar_common_1[21])));
              }
              {
                SetStopLoopStmt_219 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), SetStopLoopStmt_219, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                MR_hl_field(MR_mktag(3), SetStopLoopStmt_219, 1) = ((MR_Box) (Var_220));
                MR_hl_field(MR_mktag(3), SetStopLoopStmt_219, 2) = ((MR_Box) (Context_15));
              }
              {
                Var_226 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_226, 0) = ((MR_Box) (SetStopLoopStmt_219));
                MR_hl_field(MR_mktag(1), Var_226, 1) = ((MR_Box) (*SetupForFailStmts_20));
              }
              Var_225 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_226);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                *BodyStmt_21 = base;
        ...
        if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          *SetupForFailStmts_20 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          else
          {
            ...
            MR_Word Globals_372;
            MR_Word SupportsBreakContinue_373;
            MR_String Experiment_374;

            ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_44, &ModuleInfo_371);
            hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_371, &Globals_372);
            SupportsBreakContinue_373 = ml_backend__ml_target_util__globals_target_supports_break_and_continue_1_f_0(Globals_372);
            libs__globals__lookup_string_option_3_p_0(Globals_372, (MR_Integer) 702, &Experiment_374);
            succeeded = (SupportsBreakContinue_373 == (MR_Integer) 1);
            if (succeeded)
            {
              succeeded = (FailStmts_19 == (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                succeeded = (strcmp(Experiment_374, (MR_String) "use_end_label") == 0);
                succeeded = !(succeeded);
              }
            }
            if (succeeded)
            {
              MR_Word BreakCommentStmt_325;
              MR_Word BreakStmt_326;
              MR_Word Var_331;
              MR_Word Var_332;
              MR_Word Var_333;

              {
                BreakCommentStmt_325 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), BreakCommentStmt_325, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                MR_hl_field(MR_mktag(3), BreakCommentStmt_325, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_string_switch_scalar_common_4[5])));
                MR_hl_field(MR_mktag(3), BreakCommentStmt_325, 2) = ((MR_Box) (Context_15));
              }
              {
                BreakStmt_326 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), BreakStmt_326, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                MR_hl_field(MR_mktag(3), BreakStmt_326, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(3), BreakStmt_326, 2) = ((MR_Box) (Context_15));
              }
              {
                Var_333 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_333, 0) = ((MR_Box) (BreakStmt_326));
                MR_hl_field(MR_mktag(1), Var_333, 1) = ((MR_Box) (FailStmts_19));
              }
              {
                Var_332 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_332, 0) = ((MR_Box) (BreakCommentStmt_325));
                MR_hl_field(MR_mktag(1), Var_332, 1) = ((MR_Box) (Var_333));
              }
              Var_331 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_332);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                *BodyStmt_21 = base;
            ...
            {
              MR_String EndLabel_335;
              MR_Word GotoCommentStmt_336;
              MR_Word GotoEndStmt_337;
              MR_Word EndLabelStmt_338;
              MR_Word Var_341;
              MR_Word Var_343;
              MR_Word Var_344;
              MR_Word Var_345;
              ...
              ml_backend__ml_code_util__ml_gen_new_label_3_p_0(&EndLabel_335, STATE_VARIABLE_Info_0_44, STATE_VARIABLE_Info_45);
              {
                GotoCommentStmt_336 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GotoCommentStmt_336, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                MR_hl_field(MR_mktag(3), GotoCommentStmt_336, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_string_switch_scalar_common_4[6])));
                MR_hl_field(MR_mktag(3), GotoCommentStmt_336, 2) = ((MR_Box) (Context_15));
              }
              {
                Var_341 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_341, 0) = ((MR_Box) (EndLabel_335));
              }
              {
                GotoEndStmt_337 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GotoEndStmt_337, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                MR_hl_field(MR_mktag(3), GotoEndStmt_337, 1) = ((MR_Box) (Var_341));
                MR_hl_field(MR_mktag(3), GotoEndStmt_337, 2) = ((MR_Box) (Context_15));
              }
              {
                Var_345 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_345, 0) = ((MR_Box) (GotoEndStmt_337));
                MR_hl_field(MR_mktag(1), Var_345, 1) = ((MR_Box) (*SetupForFailStmts_20));
              }
              {
                Var_344 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_344, 0) = ((MR_Box) (GotoCommentStmt_336));
                MR_hl_field(MR_mktag(1), Var_344, 1) = ((MR_Box) (Var_345));
              }
              Var_343 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_344);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                *BodyStmt_21 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (MatchDefns_17));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (*SetupForFailStmts_20));
                MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_343));
                MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Context_15));
              }
              {
                EndLabelStmt_338 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), EndLabelStmt_338, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(MR_mktag(3), EndLabelStmt_338, 1) = ((MR_Box) (EndLabel_335));
                MR_hl_field(MR_mktag(3), EndLabelStmt_338, 2) = ((MR_Box) (Context_15));
              }
              {
                Var_346 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_346, 0) = ((MR_Box) (EndLabelStmt_338));
                MR_hl_field(MR_mktag(1), Var_346, 1) = ((MR_Box) (*SetupForFailStmts_20));
              }
              *AfterStmts_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), FailStmts_19, Var_346);
            }
          }
        }
        else
        {
          MR_Word StopLoopVarLval_445;

          *SetupForFailStmts_20 = FailStmts_19;
          StopLoopVarLval_445 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeStopLoopVarLval_16, (MR_Integer) 0))));
          succeeded = (LoopPresent_14 == (MR_Integer) 0);
          if (succeeded)
          {
            {
          ...
          {
            MR_Word SetStopLoopStmt_427;
            MR_Word Var_428;
            MR_Word Var_433;
            MR_Word Var_434;

            {
              Var_428 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Var_428, 0) = ((MR_Box) (StopLoopVarLval_445));
              MR_hl_field(MR_mktag(2), Var_428, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_string_switch_scalar_common_1[21])));
            }
            {
              SetStopLoopStmt_427 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), SetStopLoopStmt_427, 0) = ((MR_Box) ((MR_Unsigned) 8U));
              MR_hl_field(MR_mktag(3), SetStopLoopStmt_427, 1) = ((MR_Box) (Var_428));
              MR_hl_field(MR_mktag(3), SetStopLoopStmt_427, 2) = ((MR_Box) (Context_15));
            }
            {
              Var_434 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_434, 0) = ((MR_Box) (SetStopLoopStmt_427));
              MR_hl_field(MR_mktag(1), Var_434, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            Var_433 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), MatchStmts_18, Var_434);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              *BodyStmt_21 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (MatchDefns_17));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_433));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Context_15));
            }
            *AfterStmts_22 = (MR_Word) ((MR_Unsigned) 0U);
          }
