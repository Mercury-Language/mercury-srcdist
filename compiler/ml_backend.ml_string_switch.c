...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_64, (MR_Integer) 706, &Experiment_66);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_52, (MR_Integer) 706, &Experiment_54);
