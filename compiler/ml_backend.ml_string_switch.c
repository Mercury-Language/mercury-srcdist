  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_56, (MR_Integer) 726, &Experiment_58);
  ...
  MR_Word * STATE_VARIABLE_Info_45)
{
  ...
  if ((MaybeStopLoopVarLval_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_27, (MR_Integer) 726, &Experiment_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_44, (MR_Integer) 726, &Experiment_46);
