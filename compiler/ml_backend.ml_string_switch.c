    ...
    if ((ml_backend__ml_string_switch__MaybeStopLoopVarLval_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if (ml_backend__ml_string_switch__succeeded)
        ...
        else
          {
            ...
            {
              libs__globals__lookup_string_option_3_p_0(ml_backend__ml_string_switch__Globals_27, (MR_Integer) 656, &ml_backend__ml_string_switch__Experiment_29);
            }
...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(ml_backend__ml_string_switch__Globals_68, (MR_Integer) 656, &ml_backend__ml_string_switch__Experiment_70);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_string_option_3_p_0(ml_backend__ml_string_switch__Globals_55, (MR_Integer) 656, &ml_backend__ml_string_switch__Experiment_57);
          }
