...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 12)));
    ...
    if (succeeded)
    {
      packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_18, (MR_Integer) 0)));
