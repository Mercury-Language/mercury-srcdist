...
MR_decl_label5(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0, 27,2,34,31,38)
...
MR_BEGIN_MODULE(backend_libs__proc_label_module0)
	...
	MR_init_label5(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,27,2,34,31,38)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0);
	...
	MR_tempr5 = MR_r1;
	MR_sv(7) = MR_tfield(0, MR_tempr5, 11);
	MR_sv(6) = MR_tfield(0, MR_tempr5, 7);
