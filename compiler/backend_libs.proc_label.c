...
MR_decl_label8(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0, 7,8,10,6,15,19,11,12)
MR_decl_label7(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0, 21,5,27,2,34,31,38)
...
MR_BEGIN_MODULE(backend_libs__proc_label_module0)
	...
	MR_init_label8(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,7,8,10,6,15,19,11,12)
	MR_init_label7(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,21,5,27,2,34,31,38)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0);
	...
	MR_tempr5 = MR_r1;
	MR_sv(7) = MR_ctfield(0, MR_tempr5, 11);
	MR_sv(6) = MR_ctfield(0, MR_tempr5, 7);
...
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,5)
	...
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const("make_proc_label:\n", 17);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	}
	MR_np_call_localret_ent(string__append_list_2_0,
		fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0_i27);
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,2)
	...
	MR_np_call_localret_ent(__Unify___mdbcomp__prim_data__sym_name_0_0,
		fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0_i34);
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0_i31);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_id_to_int_2_0,
		fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0_i38);
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,31)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_id_to_int_2_0,
		fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0_i38);
MR_def_label(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
void mercury__backend_libs__proc_label__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__backend_libs__proc_label);
