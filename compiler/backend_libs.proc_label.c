...
{
  {
    ...
    if (succeeded)
    {
      ...
      SpecialPred_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_17, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_17, (MR_Integer) 1))));
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_34);
          {
            ...
            MR_hl_field(MR_mktag(1), ProcLabel_8, 1) = (MR_Box) (packed_args_0);
...
{
  {
    ...
    MR_Word PredIsImported_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    MR_Word Origin_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 11))));
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 12)));
    MR_Word SpecialPred_30;
    MR_Word TypeCtor_31;
    MR_Unsigned packed_args_3;

    succeeded = ((MR_tag((MR_Word) Origin_18)) == (MR_Integer) 0);
    if (succeeded)
    {
      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_18, (MR_Integer) 0)));
      SpecialPred_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_18, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_18, (MR_Integer) 1))));
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_37);
          {
            ...
            MR_hl_field(MR_mktag(1), ProcLabel_4, 1) = (MR_Box) (packed_args_3);
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_55);
      {
        ...
        MR_hl_field(MR_mktag(0), ProcLabel_4, 1) = (MR_Box) (packed_args_0);
