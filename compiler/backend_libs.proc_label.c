...
MR_decl_label4(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0, 21,5,27,2)
...
MR_BEGIN_MODULE(backend_libs__proc_label_module1)
	...
	MR_init_label4(fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0,21,5,27,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__backend_libs__proc_label__make_proc_label_from_rtti_1_0);
	...
	MR_tempr5 = MR_r1;
	MR_r3 = MR_ctfield(0, MR_tempr5, 11);
	MR_sv(3) = MR_ctfield(0, MR_tempr5, 7);
	MR_r4 = MR_ctfield(0, MR_tempr5, 4);
	MR_sv(2) = MR_ctfield(0, MR_tempr5, 3);
	MR_r5 = MR_ctfield(0, MR_tempr5, 2);
	MR_r6 = MR_ctfield(0, MR_tempr5, 1);
