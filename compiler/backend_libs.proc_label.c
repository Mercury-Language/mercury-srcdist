  ...
  MR_Integer ProcId_7)
{
  ...
  if (succeeded)
  {
    SpecialPred_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_17, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_28 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_17, (MR_Integer) 1))));
    {
  ...
  MR_Word RttiProcLabel_3)
{
  ...
  if (succeeded)
  {
    SpecialPred_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_18, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_31 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_18, (MR_Integer) 1))));
    {
