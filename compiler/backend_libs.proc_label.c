  ...
  MR_Integer ProcId_7)
{
  ...
  if (succeeded)
  {
    Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_17, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_35)) == (MR_Integer) 1);
    if (succeeded)
    {
      SpecialPred_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
    ...
    else
    {
      ...
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.proc_label.do_make_proc_label\'/8", Var_37);
    }
  }
  else
  {
  ...
  MR_Word RttiProcLabel_3)
{
  ...
  if (succeeded)
  {
    Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_18, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_38)) == (MR_Integer) 1);
    if (succeeded)
    {
      SpecialPred_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_38, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_38, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
    ...
    else
    {
      ...
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.proc_label.do_make_proc_label\'/8", Var_40);
    }
  }
  else
  {
