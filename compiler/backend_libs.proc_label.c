  ...
  MR_Integer UniModeNum_7)
{
  ...
  Var_15 = ((MR_Word) ((MR_hl_field(0, TypeCtor_6, 0))));
  Arity_12 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_6, 1))));
  succeeded = ((MR_tag((MR_Word) Var_15)) == (MR_Integer) 1);
  if (succeeded)
  {
    TypeModule_10 = ((MR_Word) ((MR_hl_field(1, Var_15, 0))));
    TypeName_11 = ((MR_String) ((MR_hl_field(1, Var_15, 1))));
    {
      MR_Word Module_13;
      ...
      hlds__pred_proc_id__proc_id_to_int_2_p_0(UniModeNum_7, &UniModeNumInt_14);
      {
  ...
  MR_Integer ProcId_7)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      SpecialPred_18 = ((MR_Unsigned) ((MR_hl_field(0, Var_26, 0))) & (MR_Integer) 3);
      TypeCtor_19 = ((MR_Word) ((MR_hl_field(0, Var_26, 1))));
    }
  }
  if (succeeded)
  {
    MR_Integer TypeArity_21 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_19, 1))));
    MR_String TypeName_22;
    MR_Word TypeModule_23;
    MR_Word TypeCtorSymName_20 = ((MR_Word) ((MR_hl_field(0, TypeCtor_19, 0))));

    if (((MR_tag((MR_Word) TypeCtorSymName_20)) == (MR_Integer) 1))
    {
      TypeModule_23 = ((MR_Word) ((MR_hl_field(1, TypeCtorSymName_20, 0))));
      TypeName_22 = ((MR_String) ((MR_hl_field(1, TypeCtorSymName_20, 1))));
      succeeded = MR_TRUE;
    }
    else
    {
      TypeName_22 = ((MR_String) ((MR_hl_field(0, TypeCtorSymName_20, 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_32);
      ...
      hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_25);
      {
        ProcLabel_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_37);
    {
  ...
  MR_Word RttiProcLabel_3)
{
  MR_bool succeeded;
  MR_Word ProcLabel_4;
  MR_Word PredOrFunc_5 = ((MR_Unsigned) ((MR_hl_field(0, RttiProcLabel_3, 0))) & (MR_Integer) 1);
  MR_Word ThisModule_6 = ((MR_Word) ((MR_hl_field(0, RttiProcLabel_3, 1))));
  MR_Word PredModule_7 = ((MR_Word) ((MR_hl_field(0, RttiProcLabel_3, 2))));
  MR_String PredName_8 = ((MR_String) ((MR_hl_field(0, RttiProcLabel_3, 3))));
  MR_Word PredFormArity_9 = ((MR_Word) ((MR_hl_field(0, RttiProcLabel_3, 4))));
  MR_Integer ProcId_12 = ((MR_Integer) ((MR_hl_field(0, RttiProcLabel_3, 7))));
  MR_Word PredIsImported_16 = ((((MR_Unsigned) ((MR_hl_field(0, RttiProcLabel_3, 10))) >> 1)) & (MR_Integer) 1);
  MR_Word Origin_18 = ((MR_Word) ((MR_hl_field(0, RttiProcLabel_3, 11))));
  ...
  if (succeeded)
  {
    Var_29 = ((MR_Word) ((MR_hl_field(1, Origin_18, 0))));
    succeeded = ((MR_tag((MR_Word) Var_29)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialPred_21 = ((MR_Unsigned) ((MR_hl_field(0, Var_29, 0))) & (MR_Integer) 3);
      TypeCtor_22 = ((MR_Word) ((MR_hl_field(0, Var_29, 1))));
    }
  }
  if (succeeded)
  {
    MR_Integer TypeArity_24 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_22, 1))));
    MR_String TypeName_25;
    MR_Word TypeModule_26;
    MR_Word TypeCtorSymName_23 = ((MR_Word) ((MR_hl_field(0, TypeCtor_22, 0))));

    if (((MR_tag((MR_Word) TypeCtorSymName_23)) == (MR_Integer) 1))
    {
      TypeModule_26 = ((MR_Word) ((MR_hl_field(1, TypeCtorSymName_23, 0))));
      TypeName_25 = ((MR_String) ((MR_hl_field(1, TypeCtorSymName_23, 1))));
      succeeded = MR_TRUE;
    }
    else
    {
      TypeName_25 = ((MR_String) ((MR_hl_field(0, TypeCtorSymName_23, 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_35);
      ...
      hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_28);
      {
  ...
  else
  {
    ...
    hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_40);
    {
