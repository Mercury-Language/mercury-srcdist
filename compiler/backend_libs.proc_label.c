  ...
  MR_Integer ProcId_7)
{
  ...
  if (succeeded)
  {
    Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_17, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_26)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialPred_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_36);
    {
      ProcLabel_8 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ProcLabel_8, 0) = ((MR_Box) (DefiningModule_35));
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_8, 5) = ((MR_Box) (ProcIdInt_36));
    }
  }
  return ProcLabel_8;
}
  ...
  MR_Word RttiProcLabel_3)
{
  ...
  if (succeeded)
  {
    Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_18, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_29)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialPred_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_39);
    {
      ProcLabel_4 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ProcLabel_4, 0) = ((MR_Box) (DefiningModule_38));
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_4, 5) = ((MR_Box) (ProcIdInt_39));
    }
  }
  return ProcLabel_4;
}
