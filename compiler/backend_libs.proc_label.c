...
{
  {
    ...
    MR_Word PredIsImported_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10))) >> (MR_Integer) 3)) & (MR_Integer) 1);
    ...
    MR_Word _CodeModel_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10))) & (MR_Integer) 7);
    MR_Word _PredIsPseudoImported_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 10))) >> (MR_Integer) 4)) & (MR_Integer) 1);
    MR_Word _ProcIsExported_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 12))) & (MR_Integer) 1);
    MR_Word _ProcIsImported_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_3, (MR_Integer) 12))) >> (MR_Integer) 1)) & (MR_Integer) 1);
