  ...
  MR_Integer ProcId_7)
{
  ...
  if (succeeded)
  {
    SpecialPred_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_17, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_17, (MR_Integer) 1))));
    {
      MR_Integer TypeArity_21 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_19, (MR_Integer) 1))));
      MR_String TypeName_22;
      MR_Word TypeModule_23;
      MR_Word TypeCtorSymName_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_19, (MR_Integer) 0))));

      if (((MR_tag((MR_Word) TypeCtorSymName_20)) == (MR_Integer) 1))
      {
        TypeModule_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorSymName_20, (MR_Integer) 0))));
        TypeName_22 = ((MR_String) ((MR_hl_field(MR_mktag(1), TypeCtorSymName_20, (MR_Integer) 1))));
        succeeded = MR_TRUE;
      }
      else
      {
        TypeName_22 = ((MR_String) ((MR_hl_field(MR_mktag(0), TypeCtorSymName_20, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_31);
            succeeded = (ProcId_7 != Var_31);
          }
        }
        if (succeeded)
        ...
        {
          ProcLabel_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 0) = ((MR_Box) (DefiningModule_24));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 1) = (MR_Box) ((MR_Unsigned) (SpecialPred_18));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 2) = ((MR_Box) (TypeModule_23));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 3) = ((MR_Box) (TypeName_22));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 4) = ((MR_Box) (TypeArity_21));
          MR_hl_field(MR_mktag(1), ProcLabel_8, 5) = ((MR_Box) (ProcIdInt_25));
        }
      }
      else
      {
        ...
        Var_29 = mercury__string__f_43_43_2_f_0(PredName_14, (MR_String) "\'");
        Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "cannot make label for special pred \140", Var_29);
        mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.proc_label.do_make_proc_label\'/8", Var_27);
      }
    }
  }
  else
  {
    MR_Word DefiningModule_34;
    ...
    if (succeeded)
      DefiningModule_34 = ThisModule_9;
    else
      DefiningModule_34 = PredModule_13;
    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_35);
    {
      ProcLabel_8 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ProcLabel_8, 0) = ((MR_Box) (DefiningModule_34));
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_8, 5) = ((MR_Box) (ProcIdInt_35));
    }
  }
  return ProcLabel_8;
}
  ...
  MR_Word RttiProcLabel_3)
{
  ...
  if (succeeded)
  {
    SpecialPred_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_18, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_18, (MR_Integer) 1))));
    {
      MR_Integer TypeArity_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_22, (MR_Integer) 1))));
      MR_String TypeName_25;
      MR_Word TypeModule_26;
      MR_Word TypeCtorSymName_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_22, (MR_Integer) 0))));

      if (((MR_tag((MR_Word) TypeCtorSymName_23)) == (MR_Integer) 1))
      {
        TypeModule_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorSymName_23, (MR_Integer) 0))));
        TypeName_25 = ((MR_String) ((MR_hl_field(MR_mktag(1), TypeCtorSymName_23, (MR_Integer) 1))));
        succeeded = MR_TRUE;
      }
      else
      {
        TypeName_25 = ((MR_String) ((MR_hl_field(MR_mktag(0), TypeCtorSymName_23, (MR_Integer) 0))));
        succeeded = parse_tree__prog_type__type_ctor_is_tuple_1_p_0(TypeCtor_22);
        if (succeeded)
        {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_34);
            succeeded = (ProcId_12 != Var_34);
          }
        }
        if (succeeded)
        ...
        hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_28);
        {
          ...
          MR_hl_field(MR_mktag(1), ProcLabel_4, 0) = ((MR_Box) (DefiningModule_27));
          MR_hl_field(MR_mktag(1), ProcLabel_4, 1) = (MR_Box) ((MR_Unsigned) (SpecialPred_21));
          MR_hl_field(MR_mktag(1), ProcLabel_4, 2) = ((MR_Box) (TypeModule_26));
          MR_hl_field(MR_mktag(1), ProcLabel_4, 3) = ((MR_Box) (TypeName_25));
          MR_hl_field(MR_mktag(1), ProcLabel_4, 4) = ((MR_Box) (TypeArity_24));
          MR_hl_field(MR_mktag(1), ProcLabel_4, 5) = ((MR_Box) (ProcIdInt_28));
        }
      }
      else
      {
        ...
        Var_32 = mercury__string__f_43_43_2_f_0(PredName_8, (MR_String) "\'");
        Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "cannot make label for special pred \140", Var_32);
        mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.proc_label.do_make_proc_label\'/8", Var_30);
      }
    }
  }
  else
  {
    MR_Word DefiningModule_37;
    MR_Integer ProcIdInt_38;
    ...
    if (succeeded)
      succeeded = (PredIsImported_16 == (MR_Integer) 0);
    if (succeeded)
      DefiningModule_37 = ThisModule_6;
    else
      DefiningModule_37 = PredModule_7;
    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_12, &ProcIdInt_38);
    {
      ProcLabel_4 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ProcLabel_4, 0) = ((MR_Box) (DefiningModule_37));
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_4, 5) = ((MR_Box) (ProcIdInt_38));
    }
  }
  return ProcLabel_4;
}
