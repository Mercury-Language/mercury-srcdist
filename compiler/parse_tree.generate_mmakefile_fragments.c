  ...
  MR_Word * STATE_VARIABLE_MmakeFile_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 793, &MmcMakeDeps_48);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 430, &Intermod_49);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 433, &TransOpt_50);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_58)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 637, &UseInstallName_37);
