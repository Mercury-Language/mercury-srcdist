  ...
  MR_Word * STATE_VARIABLE_MmakeFile_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 312, &Intermod_49);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 313, &TransOpt_50);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 117, &HighLevelCode_24);
  ...
  MR_Word * STATE_VARIABLE_Cache_28)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 117, &HighLevelCode_18);
