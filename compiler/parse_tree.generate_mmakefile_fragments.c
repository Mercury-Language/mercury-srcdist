  ...
  MR_Word * STATE_VARIABLE_MmakeFile_44)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file\'/7", (MR_Word) (MR_mkword(2, &parse_tree__generate_mmakefile_fragments_scalar_common_4[6])), ModuleName_10, &InitFileName_19);
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file\'/7", (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[12])), ModuleName_10, &InitCFileName_20);
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file\'/7", (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[13])), ModuleName_10, &InitObjFileName_21);
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file\'/7", (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[14])), ModuleName_10, &InitPicObjFileName_22);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 174, &MmcMakeDeps_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 519, &Intermod_24);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 523, &TransOpt_25);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_67)
{
  ...
  (env).parse_tree__generate_mmakefile_fragments__generate_dep_file_install_targets_14_p_0_env_0__DepsMap_17 = DepsMap_17;
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (&parse_tree__generate_mmakefile_fragments_scalar_common_4[5]), ModuleName_16, &LibInstallIntsTargetName_33);
    ...
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (&parse_tree__generate_mmakefile_fragments_scalar_common_4[6]), ModuleName_16, &LibInstallGradeHdrsTargetName_36);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_35)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_12, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.generate_dep_file_init_targets\'/11", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[6])), ModuleName_13, DvFileName_18);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_66)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 674, &UseInstallName_43);
  ...
  MR_Word * STATE_VARIABLE_Cache_108)
{
  ...
  ModuleDepFileExtStr_81 = parse_tree__file_names__extension_to_string_2_f_0(Globals_10, (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[5])));
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 329, &HighLevelCode_83);
  ...
  MR_Word * STATE_VARIABLE_Cache_31)
{
  ...
  parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_14, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.construct_install_shadow_rules\'/13", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[7])), ModuleName_15, &IntFileName_25, STATE_VARIABLE_Cache_0_30, &STATE_VARIABLE_Cache_36_36);
  parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_14, (MR_String) "predicate \140parse_tree.generate_mmakefile_fragments.construct_install_shadow_rules\'/13", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[8])), ModuleName_15, &Int2FileName_26, STATE_VARIABLE_Cache_36_36, &STATE_VARIABLE_Cache_41_41);
      ...
      case (MR_Integer) 0:
        {
          ...
          ForeignImportExt_25 = (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[20]));
      ...
      case (MR_Integer) 2:
        {
          ...
          ForeignImportExt_49 = (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[23]));
  ...
  MR_Word * STATE_VARIABLE_Cache_31)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 329, &HighLevelCode_21);
  ...
  if (succeeded)
  {
    ...
    parse_tree__make_module_file_names__make_module_file_names_with_ext_8_p_0(Globals_12, (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[22])), Var_38, &AllDepsFileNames_24, STATE_VARIABLE_Cache_0_30, &STATE_VARIABLE_Cache_39_39);
    {
  ...
  MR_Word * STATE_VARIABLE_Cache_41)
{
  ...
  else
  {
    ...
    parse_tree__make_module_file_names__make_module_file_names_with_ext_8_p_0(Globals_13, (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[20])), Var_45, &AllDepsFileNames_26, STATE_VARIABLE_Cache_0_40, &STATE_VARIABLE_Cache_46_46);
    {
  ...
  else
  {
    ...
    parse_tree__make_module_file_names__make_module_file_names_with_ext_8_p_0(Globals_13, (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[21])), PlainOptDeps_29, &PlainOptDepsFileNames_33, STATE_VARIABLE_Cache_46_46, &STATE_VARIABLE_Cache_60_60);
    ...
    else
    {
      ...
      parse_tree__make_module_file_names__make_module_file_names_with_ext_8_p_0(Globals_13, (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[15])), TransOptDeps_36, &TransOptDepsOptFileNames_38, STATE_VARIABLE_Cache_65_65, STATE_VARIABLE_Cache_41);
      {
  ...
  MR_Word * STATE_VARIABLE_Cache_53)
{
  ...
  parse_tree__make_module_file_names__make_module_file_name_group_with_ext_9_p_0(Globals_21, (MR_String) "direct deps", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[7])), DirectDeps_25, &DirectDepsSourceGroups_44, STATE_VARIABLE_Cache_72_72, &STATE_VARIABLE_Cache_77_77);
  parse_tree__make_module_file_names__make_module_file_name_group_with_ext_9_p_0(Globals_21, (MR_String) "indirect deps", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[8])), IndirectDeps_26, &IndirectDepsSourceGroups_45, STATE_VARIABLE_Cache_77_77, &STATE_VARIABLE_Cache_82_82);
  ...
  parse_tree__make_module_file_names__make_module_file_name_group_with_ext_9_p_0(Globals_21, (MR_String) "type_repn self dep", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[7])), Var_87, &TypeRepnSelfDepGroups_46, STATE_VARIABLE_Cache_82_82, &STATE_VARIABLE_Cache_88_88);
  Var_93 = mdbcomp__sym_name__get_ancestors_set_1_f_0(ModuleName_22);
  parse_tree__make_module_file_names__make_module_file_name_group_with_ext_9_p_0(Globals_21, (MR_String) "type_repn ancestor dep", (MR_Word) (MR_mkword(1, &parse_tree__generate_mmakefile_fragments_scalar_common_4[7])), Var_93, &TypeRepnAncestorsDepGroups_47, STATE_VARIABLE_Cache_88_88, STATE_VARIABLE_Cache_53);
  ...
  MR_Word * STATE_VARIABLE_Cache_29)
{
  ...
  else
  {
    ...
    parse_tree__make_module_file_names__make_module_file_names_with_ext_8_p_0(Globals_10, (MR_Word) (MR_mkword(3, &parse_tree__generate_mmakefile_fragments_scalar_common_1[15])), Var_35, &TransOptDepsFileNames_26, STATE_VARIABLE_Cache_0_28, STATE_VARIABLE_Cache_29);
    {
