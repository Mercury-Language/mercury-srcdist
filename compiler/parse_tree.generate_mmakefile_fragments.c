  ...
  MR_Word * STATE_VARIABLE_MmakeFile_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 184, &MmcMakeDeps_48);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_63)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 684, &UseInstallName_39);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 339, &HighLevelCode_24);
  ...
  MR_Word * STATE_VARIABLE_Cache_28)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 339, &HighLevelCode_18);
