  ...
  MR_Word * STATE_VARIABLE_MmakeFile_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 529, &Intermod_49);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 533, &TransOpt_50);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_63)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 683, &UseInstallName_39);
