...
hlds__var_table_hlds__IntroducedFrom__pred__split_var_table__210__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_VarTable_5)
{
  ...
  else
  {
    ...
    IsDummy_19 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_1, Type_11);
    {
  ...
  MR_Word * STATE_VARIABLE_VarTable_15)
{
  ...
  IsDummy_12 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_7, Type_9);
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__var_table_hlds__IntroducedFrom__pred__split_var_table__210__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
