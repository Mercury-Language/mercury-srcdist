  ...
  MR_Word * STATE_VARIABLE_VarTable_5)
{
  ...
  else
  {
    ...
    MR_Word Var_13;
    MR_Word Vars_14;
    MR_Word STATE_VARIABLE_VarTable_18_18;
    MR_Word IsDummy_19;
    MR_Word Entry_20;
    ...
    parse_tree__var_table__add_var_entry_4_p_0(Entry_20, &Var_13, STATE_VARIABLE_VarTable_0_4, &STATE_VARIABLE_VarTable_18_18);
    hlds__var_table_hlds__create_fresh_vars_5_p_0(ModuleInfo_1, Types_12, &Vars_14, STATE_VARIABLE_VarTable_18_18, STATE_VARIABLE_VarTable_5);
    {
      MR_Word base;
