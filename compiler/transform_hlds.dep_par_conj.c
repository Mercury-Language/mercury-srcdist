  ...
  MR_Word * STATE_VARIABLE_SyncInfo_26)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 738, &ParLoopControl_21);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 234, &FullyStrict_27);
