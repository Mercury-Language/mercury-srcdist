...
{
  {
    ...
    Var_60 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_37);
    {
      ...
      MR_hl_field(MR_mktag(3), Transform_45, 0) = ((MR_Box) ((MR_Unsigned) 3U));
    ...
    parse_tree__pred_name__make_pred_name_4_p_0(PredModule_38, Name0_39, Transform_45, &SymName_46);
