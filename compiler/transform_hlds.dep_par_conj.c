...
{
  {
    ...
    mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), &EmptyConstraintMap_58);
    {
      ...
      MR_hl_field(MR_mktag(3), Origin_59, 0) = ((MR_Box) ((MR_Unsigned) 1U));
...
{
  {
    ...
    succeeded = transform_hlds__dep_par_conj__IntroducedFrom__pred__should_we_push_signal__2827__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
