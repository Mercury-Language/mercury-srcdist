...
transform_hlds__dep_par_conj__IntroducedFrom__pred__find_shared_variables_2__3449__1_3_p_0(
...
{
  {
    ...
    succeeded = transform_hlds__dep_par_conj__IntroducedFrom__pred__should_we_push_signal__2824__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = transform_hlds__dep_par_conj__IntroducedFrom__pred__find_shared_variables_2__3449__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 180, &FullyStrict_27);
