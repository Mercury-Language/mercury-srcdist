  ...
  MR_Word * STATE_VARIABLE_TSStringTable_61)
{
  ...
  AllowSomePathsOnly_43 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_42, (MR_Integer) 1))) >> 21)) & (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_TSStringTable_45)
{
  ...
  AllowSomePathsOnly_24 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_23, (MR_Integer) 1))) >> 21)) & (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_SyncInfo_26)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 721, &ParLoopControl_21);
