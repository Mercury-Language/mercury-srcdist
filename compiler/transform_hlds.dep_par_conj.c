  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  parse_tree__pred_name__make_transformed_pred_name_3_p_0(Name0_38, Transform_44, &TransformedName_45);
  ...
  {
    OriginTransform_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), OriginTransform_57, 0) = ((MR_Box) ((MR_Unsigned) 7U));
    MR_hl_field(MR_mktag(3), OriginTransform_57, 1) = ((MR_Box) (ProcId_36));
    MR_hl_field(MR_mktag(3), OriginTransform_57, 2) = ((MR_Box) (FutureArgs_7));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Origin_58, 1) = ((MR_Box) (OriginTransform_57));
    MR_hl_field(MR_mktag(3), Origin_58, 2) = ((MR_Box) (OrigOrigin_43));
    MR_hl_field(MR_mktag(3), Origin_58, 3) = ((MR_Box) (PredId_35));
  }
  ...
  MR_Word * STATE_VARIABLE_SyncInfo_26)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 713, &ParLoopControl_21);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 214, &FullyStrict_27);
