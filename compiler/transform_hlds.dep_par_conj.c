  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_0_13, &STATE_VARIABLE_ProcInfo_1_17);
  ...
  MR_Word * STATE_VARIABLE_RevProcMap_47)
{
  ...
  *STATE_VARIABLE_Pushability_45 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_SpecInfo_2_70, 7))));
  ...
  hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_2_75, &STATE_VARIABLE_ProcInfo_1_101);
