  ...
  MR_Word * STATE_VARIABLE_TSStringTable_61)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_NewProcInfo_62_62, &STATE_VARIABLE_VarTable_63_63);
  ...
  MR_Word * STATE_VARIABLE_RevProcMap_45)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_47_47, &VarTable_25);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  Var_54 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_30);
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_38, 2) = ((MR_Box) (Var_54));
  ...
  {
    ProcTransform_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), ProcTransform_51, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(MR_mktag(3), ProcTransform_51, 1) = ((MR_Box) (FutureArgs_7));
  }
  {
    Origin_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_52, 0) = ((MR_Box) (ProcTransform_51));
    MR_hl_field(MR_mktag(3), Origin_52, 1) = ((MR_Box) (OrigOrigin_37));
    MR_hl_field(MR_mktag(3), Origin_52, 2) = ((MR_Box) (PredId_29));
    MR_hl_field(MR_mktag(3), Origin_52, 3) = ((MR_Box) (ProcId_30));
  }
  ...
  MR_Word * STATE_VARIABLE_TSStringTable_45)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_47_47, &STATE_VARIABLE_VarTable_49_49);
