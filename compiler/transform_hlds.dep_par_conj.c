  ...
  MR_Word * STATE_VARIABLE_TSStringTable_28)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      next_value_of_STATE_VARIABLE_PendingParProcs_0_20 = STATE_VARIABLE_PendingParProcs_32_41;
      next_value_of_STATE_VARIABLE_Pushability_0_21 = STATE_VARIABLE_Pushability_33_42;
      next_value_of_STATE_VARIABLE_DoneParProcs_0_22 = STATE_VARIABLE_DoneParProcs_31_40;
