  ...
  MR_Word * STATE_VARIABLE_TSStringTable_63)
{
  ...
  else
  {
    ...
    hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 14, Markers0_50, &Markers_51);
  ...
  MR_Word * STATE_VARIABLE_SyncInfo_26)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 766, &ParLoopControl_21);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 247, &FullyStrict_27);
