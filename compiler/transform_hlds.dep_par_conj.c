  ...
  MR_Word * STATE_VARIABLE_VarTable_10)
{
  ...
  else
  {
    ...
    Var_50 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(Goal0_26);
    succeeded = parse_tree__set_of_var__member_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_50, ConsumedVar_4);
    if (succeeded)
    {
  ...
  MR_Word * STATE_VARIABLE_VarTable_31)
{
  ...
  else
  {
    ...
    InstMapDelta0_21 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo0_20);
    {
      ...
      MR_hl_field(MR_mktag(0), IsProducedVar_61, 1) = ((MR_Box) (transform_hlds__dep_par_conj__sync_dep_par_conjunct_10_p_0_1));
      MR_hl_field(MR_mktag(0), IsProducedVar_61, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), IsProducedVar_61, 3) = ((MR_Box) (ModuleInfo_11));
      MR_hl_field(MR_mktag(0), IsProducedVar_61, 4) = ((MR_Box) (STATE_VARIABLE_InstMap_0_28));
      MR_hl_field(MR_mktag(0), IsProducedVar_61, 5) = ((MR_Box) (InstMapDelta0_21));
    }
    parse_tree__set_of_var__divide_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), IsProducedVar_61, NonlocalSharedVars_19, &ProducedVars_62, &ConsumedVars_63);
    ConsumedVarsList_22 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ConsumedVars_63);
    ProducedVarsList_23 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ProducedVars_62);
    {
