                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(3), GoalExpr_25, 1) = (MR_Box) (packed_args_0);
                  ...
                  case (MR_Integer) 4:
                    {
                      ...
                      MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 2)));
                      ...
                      else
                      {
                        ...
                        transform_hlds__dep_par_conj__insert_signal_in_cases_9_p_0(ModuleInfo_10, FutureMap_11, ProducedVar_12, Cases0_28, &Cases_29, STATE_VARIABLE_VarSet_0_73, STATE_VARIABLE_VarSet_74, STATE_VARIABLE_VarTypes_0_75, STATE_VARIABLE_VarTypes_76);
                        {
                          ...
                          MR_hl_field(MR_mktag(3), GoalExpr_112, 2) = (MR_Box) (packed_args_2);
                  ...
                  case (MR_Integer) 5:
                    {
                      ...
                      if (succeeded)
                      {
                        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_37, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExprA_40, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_45, (MR_Integer) 1)));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word Goals_27;
                MR_Word GoalExpr_29;
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 1)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      {
                        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), WaitedInConjunct_28, (MR_Integer) 0)));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_29, 1) = (MR_Box) (packed_args_0);
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 2)));
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), GoalExpr_143, 2) = (MR_Box) (packed_args_3);
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExprA_48, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_SpecInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_18, (MR_Integer) 3)));
        Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_13, (MR_Integer) 0))));
        succeeded = ((MR_tag((MR_Word) Var_45)) == (MR_Integer) 2);
        if (succeeded)
        {
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_45, (MR_Integer) 3)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_58, (MR_Integer) 3)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    transform_hlds__dep_par_conj__specialize_sequences_in_goals_4_p_0(Goals0_11, &Goals_68, STATE_VARIABLE_SpecInfo_0_54, STATE_VARIABLE_SpecInfo_55);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), GoalExpr_14, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              transform_hlds__dep_par_conj__specialize_sequences_in_cases_4_p_0(Cases0_17, &Cases_18, STATE_VARIABLE_SpecInfo_0_54, STATE_VARIABLE_SpecInfo_55);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_72, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_28, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_16, (MR_Integer) 3)));
    MR_Word Var_43;
    MR_Word Var_44;
    MR_Word Var_98;
...
{
  {
    ...
    MR_Word Var_37;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_12, (MR_Integer) 3)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_22, (MR_Integer) 3)));
                ...
                case (MR_Integer) 4:
                  {
                    ...
                    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 2)));
                ...
                case (MR_Integer) 5:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_50, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 2)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SyncInfo_55_55, (MR_Integer) 2)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_22;
              MR_Word GoalExpr_80;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 2)));
              ...
              transform_hlds__dep_par_conj__sync_dep_par_conjs_in_cases_5_p_0(Cases0_21, &Cases_22, InstMap0_9, STATE_VARIABLE_SyncInfo_0_64, STATE_VARIABLE_SyncInfo_65);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_80, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_36, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Var_49;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SyncInfo_0_27, (MR_Integer) 2)));
