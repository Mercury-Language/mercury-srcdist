  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  Var_59 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_36);
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_44, 2) = ((MR_Box) (Var_59));
  ...
  {
    Origin_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_57, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), Origin_57, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Origin_57, 2) = ((MR_Box) (OrigOrigin_43));
    MR_hl_field(MR_mktag(3), Origin_57, 3) = ((MR_Box) (PredId_35));
  }
  hlds__hlds_pred__pred_info_init_19_p_0(PredOrFunc_39, PredModule_37, TransformedName_45, PredFormArity_46, Context_49, Origin_57, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), (MR_Word) ((MR_Unsigned) 0U), GoalType_52, Markers_51, ArgTypes_48, Tvars_40, ExistQVars_41, ClassContext_53, EmptyProofs_55, EmptyConstraintMap_56, ClausesInfo_50, VarNameRemap_54, &STATE_VARIABLE_PredInfo_39_62);
