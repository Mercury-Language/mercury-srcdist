...
static /* final */ const MR_Box transform_hlds__dep_par_conj_scalar_common_2[11][3];
  ...
  MR_Word * STATE_VARIABLE_TSStringTable_28)
{
  ...
  Ground_18 = (MR_Word) (MR_mkword(1, &transform_hlds__dep_par_conj_scalar_common_1[8]));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 220, &FullyStrict_27);
