  ...
  MR_Word * STATE_VARIABLE_TSStringTable_28)
{
  ...
  }
  {
    ...
    MR_hl_field(1, GoalExpr_22, 2) = ((MR_Box) (&transform_hlds__dep_par_conj_scalar_common_12[1]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__dep_par_conj__IntroducedFrom__pred__find_shared_variables_2__3435__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
