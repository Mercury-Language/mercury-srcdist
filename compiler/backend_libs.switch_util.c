...
{
  {
    ...
    *SwitchCategory_7 = backend_libs__switch_util__type_ctor_cat_to_switch_cat_1_f_0(SwitchTypeCtorCat_9);
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_10);
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 441, &SmartIndexing_11);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 454, &SmartIndexingForCategory_12);
        ...
        case (MR_Integer) 3:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 457, &SmartIndexingForCategory_34);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 455, &SmartIndexingForCategory_35);
        ...
        case (MR_Integer) 2:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 456, &SmartIndexingForCategory_36);
