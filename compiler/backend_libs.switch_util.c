...
MR_decl_label8(backend_libs__switch_util__get_ptag_counts_2_5_0, 134,6,8,10,24,49,50,52)
MR_decl_label8(backend_libs__switch_util__get_ptag_counts_2_5_0, 54,51,58,59,61,63,65,67)
MR_decl_label8(backend_libs__switch_util__get_ptag_counts_2_5_0, 68,60,72,73,75,77,79,81)
MR_decl_label7(backend_libs__switch_util__get_ptag_counts_2_5_0, 82,74,84,89,90,136,3)
MR_decl_label8(backend_libs__switch_util__group_cases_by_ptag_3_0, 122,6,9,8,13,14,25,50)
MR_decl_label8(backend_libs__switch_util__group_cases_by_ptag_3_0, 52,54,51,56,57,60,62,64)
MR_decl_label8(backend_libs__switch_util__group_cases_by_ptag_3_0, 65,66,61,68,69,72,74,76)
MR_decl_label8(backend_libs__switch_util__group_cases_by_ptag_3_0, 77,78,73,80,81,82,87,88)
MR_decl_label2(backend_libs__switch_util__group_cases_by_ptag_3_0, 124,3)
...
MR_decl_static(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__446__1_2_0)
MR_decl_static(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__431__1_2_0)
...
MR_BEGIN_MODULE(backend_libs__switch_util_module11)
	...
	MR_init_label8(backend_libs__switch_util__group_cases_by_ptag_3_0,122,6,9,8,13,14,25,50)
	MR_init_label8(backend_libs__switch_util__group_cases_by_ptag_3_0,52,54,51,56,57,60,62,64)
	MR_init_label8(backend_libs__switch_util__group_cases_by_ptag_3_0,65,66,61,68,69,72,74,76)
	MR_init_label8(backend_libs__switch_util__group_cases_by_ptag_3_0,77,78,73,80,81,82,87,88)
	MR_init_label2(backend_libs__switch_util__group_cases_by_ptag_3_0,124,3)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__switch_util__group_cases_by_ptag_3_0,54)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		backend_libs__switch_util__group_cases_by_ptag_3_0_i124);
...
MR_def_label(backend_libs__switch_util__group_cases_by_ptag_3_0,62)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__431__1_2_0);
...
MR_def_label(backend_libs__switch_util__group_cases_by_ptag_3_0,74)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__446__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_def_label(backend_libs__switch_util__group_cases_by_ptag_3_0,88)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		backend_libs__switch_util__group_cases_by_ptag_3_0_i124);
MR_def_label(backend_libs__switch_util__group_cases_by_ptag_3_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(backend_libs__switch_util__group_cases_by_ptag_3_0_i122);
...
MR_BEGIN_MODULE(backend_libs__switch_util_module15)
	...
	MR_init_label8(backend_libs__switch_util__get_ptag_counts_2_5_0,134,6,8,10,24,49,50,52)
	MR_init_label8(backend_libs__switch_util__get_ptag_counts_2_5_0,54,51,58,59,61,63,65,67)
	MR_init_label8(backend_libs__switch_util__get_ptag_counts_2_5_0,68,60,72,73,75,77,79,81)
	MR_init_label7(backend_libs__switch_util__get_ptag_counts_2_5_0,82,74,84,89,90,136,3)
MR_BEGIN_CODE
...
MR_def_static(backend_libs__switch_util__get_ptag_counts_2_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r4),
		...
		MR_LABEL_AP(backend_libs__switch_util__get_ptag_counts_2_5_0_i89) MR_AND
		MR_LABEL_AP(backend_libs__switch_util__get_ptag_counts_2_5_0_i89) MR_AND
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r4),0)) {
		MR_GOTO_LAB(backend_libs__switch_util__get_ptag_counts_2_5_0_i89);
	}
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_ctfield(1, MR_r1, 1);
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,24)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r4, 0),
		...
		MR_LABEL_AP(backend_libs__switch_util__get_ptag_counts_2_5_0_i72) MR_AND
		MR_LABEL_AP(backend_libs__switch_util__get_ptag_counts_2_5_0_i89) MR_AND
		MR_LABEL_AP(backend_libs__switch_util__get_ptag_counts_2_5_0_i89));
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,61)
	...
	if (MR_INT_NE(MR_tempr1,2)) {
		MR_GOTO_LAB(backend_libs__switch_util__get_ptag_counts_2_5_0_i63);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_r3;
	}
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,65)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i67);
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(int__max_3_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i68);
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,72)
	...
	MR_np_call_localret_ent(int__max_3_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i73);
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_sv(7) = (MR_Word) MR_TAG_COMMON(0,2,0);
	MR_r1 = MR_sv(7);
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,75)
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(backend_libs__switch_util__get_ptag_counts_2_5_0_i77);
	}
	MR_r2 = MR_r3;
	MR_r1 = MR_sv(6);
	}
	MR_np_call_localret_ent(int__max_3_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i82);
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,81)
	...
	MR_np_call_localret_ent(int__max_3_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i82);
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,84)
	...
	MR_r2 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(backend_libs__switch_util__get_ptag_counts_2_5_0_i134);
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_ctfield(1, MR_r1, 1);
	MR_np_call_localret_ent(fn__backend_libs__switch_util__this_file_0_0,
		backend_libs__switch_util__get_ptag_counts_2_5_0_i90);
MR_def_label(backend_libs__switch_util__get_ptag_counts_2_5_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(backend_libs__switch_util_module41)
	MR_init_entry1(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__446__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__446__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(backend_libs__switch_util_module42)
	MR_init_entry1(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__431__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(backend_libs__switch_util__IntroducedFrom__pred__group_cases_by_ptag__431__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
