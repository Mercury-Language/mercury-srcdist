...
backend_libs__switch_util__IntroducedFrom__pred__build_ptag_case_rev_map__1437__1_3_p_0(
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_17, (MR_Integer) 1)));
...
{
  {
    ...
    succeeded = backend_libs__switch_util__IntroducedFrom__pred__build_ptag_case_rev_map__1437__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))));
    return succeeded;
  }
}
