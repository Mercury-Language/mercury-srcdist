  ...
  MR_Word * STATE_VARIABLE_SwitchCanFail_12)
{
  switch (CodeModel_6) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RevTaggedCases_18;

        backend_libs__switch_util__filter_out_failing_cases_loop_5_p_0(STATE_VARIABLE_TaggedCases_0_9, (MR_Word) ((MR_Unsigned) 0U), &RevTaggedCases_18, STATE_VARIABLE_SwitchCanFail_0_11, STATE_VARIABLE_SwitchCanFail_12);
        mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), RevTaggedCases_18, STATE_VARIABLE_TaggedCases_10);
      }
      break;
  }
}
