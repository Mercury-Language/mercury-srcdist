...
static const MR_FA_PseudoTypeInfo_Struct2 transform_hlds__ctgc__structure_reuse__direct__tree234__pti_tree234_2__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0__plain_transform_hlds__ctgc__structure_sharing__domain__type_ctor_info_sharing_as_and_status_0;
...
static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__direct_scalar_common_2[2][10] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct__tree234__pti_tree234_2__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0__plain_transform_hlds__ctgc__structure_sharing__domain__type_ctor_info_sharing_as_and_status_0)),
    ((MR_Box) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0)),
    ((MR_Box) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0)),
    ((MR_Box) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0)),
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_25)
{
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(ProcInfo0_16, &Goal0_29);
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_32, ProcInfo0_16, &ProcInfo_17);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_23)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      ProcIds_19 = hlds__hlds_pred__pred_info_all_proc_ids_1_f_0(PredInfo0_13);
    ...
    else
    {
      ...
      ProcIds_33 = hlds__hlds_pred__pred_info_will_codegen_proc_ids_1_f_0(PredInfo0_13);
      {
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_16)
{
  ...
  mercury__list__foldl2_6_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_table_0), Var_17, PPIds_10, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_13)), &conv3_STATE_VARIABLE_ModuleInfo_14, ((MR_Box) (STATE_VARIABLE_ReuseTable_0_15)), &conv2_STATE_VARIABLE_ReuseTable_16);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_16)
{
  ...
  mercury__list__filter_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), Var_17, AllPredIds_11, &ToBeAnalysedPredIds_12);
  {
