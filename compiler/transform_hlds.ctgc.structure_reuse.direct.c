...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__Globals_16, (MR_Integer) 55, &transform_hlds__ctgc__structure_reuse__direct__VeryVerbose_17);
    }
    {
