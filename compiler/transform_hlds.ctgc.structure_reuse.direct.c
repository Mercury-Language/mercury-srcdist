  ...
  MR_Word * STATE_VARIABLE_ReuseTable_23)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_8_p_0(SharingTable_8, PredId_9, ProcId_10, STATE_VARIABLE_ModuleInfo_0_20, PredInfo0_13, ProcInfo0_14, &ProcInfo_15, &ReuseAs_16);
  {
    ...
    MR_hl_field(MR_mktag(0), AsAndStatus_18, 0) = ((MR_Box) (ReuseAs_16));
    MR_hl_field(MR_mktag(0), AsAndStatus_18, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 2));
  }
  {
    Var_24 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (PredId_9));
    MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (ProcId_10));
  }
  ...
  MR_Word * ReuseAs_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 72, &VeryVerbose_17);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct__dead_cell_entry_dump_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__write_string_4_p_0(Stream_6, (MR_String) "\t\t|--------|\n");
        {
          ...
          MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_5_p_0_1));
          MR_hl_field(MR_mktag(0), Var_14, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_14, 3) = ((MR_Box) (Stream_6));
        }
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_STATE_VARIABLE_ModuleInfo_21, ((MR_Word) (wrapper_arg_4)), &conv2_STATE_VARIABLE_ReuseTable_23);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_21)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_25 = transform_hlds__ctgc__structure_reuse__domain__reuse_as_init_0_f_0();
      {
    ...
    else
    {
      ...
      ProcIds_30 = hlds__hlds_pred__pred_info_valid_non_imported_procids_1_f_0(PredInfo0_11);
      {
        Var_27 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_6_p_0_2));
        MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (SharingTable_7));
        MR_hl_field(MR_mktag(0), Var_27, 4) = ((MR_Box) (PredId_8));
      }
      mercury__list__foldl2_6_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_table_0), Var_27, ProcIds_30, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_18)), &conv5_STATE_VARIABLE_ModuleInfo_19, ((MR_Box) (STATE_VARIABLE_ReuseTable_0_20)), &conv4_STATE_VARIABLE_ReuseTable_21);
