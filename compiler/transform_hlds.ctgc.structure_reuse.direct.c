...
static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__direct_scalar_common_5[1][8];

static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__direct_scalar_common_6[1][7];
...
static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__direct_scalar_common_1[2][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_6[0])),
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_23)
{
  ...
  MR_Word ProcInfo_15;
  MR_Word ReuseAs_16;
  MR_Word AsAndStatus_18;
  MR_Word PredInfo_19;
  MR_Word Var_24;

  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_20, PredId_9, &PredInfo0_13);
  hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo0_13, ProcId_10, &ProcInfo0_14);
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_8_p_0(SharingTable_8, PredId_9, ProcId_10, STATE_VARIABLE_ModuleInfo_0_20, PredInfo0_13, ProcInfo0_14, &ProcInfo_15, &ReuseAs_16);
  {
    AsAndStatus_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, AsAndStatus_18, 0) = ((MR_Box) (ReuseAs_16));
    MR_hl_field(0, AsAndStatus_18, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 2));
  }
  {
    Var_24 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_24, 0) = ((MR_Box) (PredId_9));
    MR_hl_field(0, Var_24, 1) = ((MR_Box) (ProcId_10));
  }
  transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_set_4_p_0(Var_24, AsAndStatus_18, STATE_VARIABLE_ReuseTable_0_22, STATE_VARIABLE_ReuseTable_23);
  hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_10, ProcInfo_15, PredInfo0_13, &PredInfo_19);
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_9, PredInfo_19, STATE_VARIABLE_ModuleInfo_0_20, STATE_VARIABLE_ModuleInfo_21);
}
  ...
  MR_Word * ReuseAs_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 73, &VeryVerbose_17);
  {
    ...
    MR_hl_field(0, Var_29, 0) = ((MR_Box) (PredId_10));
    MR_hl_field(0, Var_29, 1) = ((MR_Box) (ProcId_11));
  }
  hlds__passes_aux__maybe_write_proc_progress_message_5_p_0(ModuleInfo_12, (MR_String) "Direct reuse analysis of", Var_29);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_24, &Goal0_19);
  transform_hlds__ctgc__structure_reuse__direct__detect_garbage__determine_dead_deconstructions_6_p_0(ModuleInfo_12, PredInfo_13, STATE_VARIABLE_ProcInfo_0_24, SharingTable_9, Goal0_19, &DeadCellTable_20);
  hlds__passes_aux__get_debug_output_stream_4_p_0(ModuleInfo_12, &DebugStream_21);
  transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_5_p_0(DebugStream_21, VeryVerbose_17, DeadCellTable_20);
  transform_hlds__ctgc__structure_reuse__direct__choose_reuse__determine_reuse_6_p_0(ModuleInfo_12, STATE_VARIABLE_ProcInfo_0_24, DeadCellTable_20, Goal0_19, &Goal_22, ReuseAs_15);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_22, STATE_VARIABLE_ProcInfo_0_24, STATE_VARIABLE_ProcInfo_25);
  hlds__passes_aux__get_progress_output_stream_4_p_0(ModuleInfo_12, &ProgressStream_23);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_23, VeryVerbose_17, (MR_String) "% reuse analysis done.\n");
}
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__write_string_4_p_0(Stream_6, (MR_String) "\t\t|--------|\n");
        {
          ...
          MR_hl_field(0, Var_14, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_5[0]));
...
{
  MR_Box closure = closure_arg;
  MR_Word conv3_STATE_VARIABLE_ModuleInfo_21;
  MR_Word conv2_STATE_VARIABLE_ReuseTable_23;

  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_STATE_VARIABLE_ModuleInfo_21, ((MR_Word) (wrapper_arg_4)), &conv2_STATE_VARIABLE_ReuseTable_23);
  *wrapper_arg_3 = ((MR_Box) (conv3_STATE_VARIABLE_ModuleInfo_21));
  *wrapper_arg_5 = ((MR_Box) (conv2_STATE_VARIABLE_ReuseTable_23));
}
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_21)
{
  ...
  if (succeeded)
  {
    Var_22 = ((MR_Word) ((MR_hl_field(1, Origin_12, (MR_Integer) 0))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      ProcIds_17 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo0_11);
    ...
    else
    {
      ...
      ProcIds_31 = hlds__hlds_pred__pred_info_all_non_imported_procids_1_f_0(PredInfo0_11);
      {
        Var_28 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_28, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_4[0]));
        MR_hl_field(0, Var_28, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_6_p_0_2));
        MR_hl_field(0, Var_28, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(0, Var_28, 3) = ((MR_Box) (SharingTable_7));
        MR_hl_field(0, Var_28, 4) = ((MR_Box) (PredId_8));
      }
      mercury__list__foldl2_6_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_table_0), Var_28, ProcIds_31, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_18)), &conv5_STATE_VARIABLE_ModuleInfo_19, ((MR_Box) (STATE_VARIABLE_ReuseTable_0_20)), &conv4_STATE_VARIABLE_ReuseTable_21);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_ppid_6_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_13, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_ReuseTable_15);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_14)
{
...

  {
    ...
    MR_hl_field(0, Var_15, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_3[1]));
    MR_hl_field(0, Var_15, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_6_p_0_1));
    MR_hl_field(0, Var_15, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_15, 3) = ((MR_Box) (SharingTable_7));
  }
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_6_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_19, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_ReuseTable_21);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_14)
{
  ...
  {
    Var_15 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_15, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_2[0]));
    MR_hl_field(0, Var_15, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_5_p_0_1));
    MR_hl_field(0, Var_15, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_15, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_11));
  }
  mercury__list__filter_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), Var_15, AllPredIds_9, &ToBeAnalysedPredIds_10);
  {
    ...
    MR_hl_field(0, Var_16, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_3[0]));
    MR_hl_field(0, Var_16, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_5_p_0_2));
    MR_hl_field(0, Var_16, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_16, 3) = ((MR_Box) (SharingTable_6));
  }
