...
#line 51 "transform_hlds.ctgc.structure_reuse.direct.c"
...
#endif
#line 60 "transform_hlds.ctgc.structure_reuse.direct.c"
...
MR_decl_label3(transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0, 4,6,15)
...
MR_decl_label3(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_7_0, 2,3,5)
MR_decl_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0, 2,4,3,7,9,11,12,6)
MR_decl_label1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0, 13)
MR_decl_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0, 2,3,4,5,6,9,10,11)
MR_decl_label2(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0, 12,13)
MR_decl_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0, 2,3,4,5,6,7,8,9)
MR_decl_label1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0, 2)
MR_decl_label6(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0, 2,3,7,5,13,14)
...
MR_def_extern_entry(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0)
...
MR_def_extern_entry(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0)
MR_def_extern_entry(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0)
MR_def_extern_entry(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_ppid_9_0)
...
static const MR_UserClosureId
mercury_data__closure_layout__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0_1;
extern const MR_TypeCtorInfo_Struct mercury_data_hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
...
{
{
(MR_Word *) &mercury_data__closure_layout__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0_1,
(MR_Word *) (MR_Integer) 0
},
9,
{
...
static const MR_UserClosureId
mercury_data__closure_layout__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_2;
static const struct mercury_type_6 mercury_common_6[1] =
{
{
{
(MR_Word *) &mercury_data__closure_layout__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_2,
(MR_Word *) (MR_Integer) 0
},
10,
{
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module0)
	...
	MR_init_label6(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0,2,3,7,5,13,14)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'get_strategy'/5 mode 0 */
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0,5)
	...
	MR_np_call_localret_ent(parse_tree__error_util__write_error_pieces_plain_3_0,
		transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0_i13);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_incr_errors_2_0,
		transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0_i14);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module1)
	...
	MR_init_label3(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_7_0,2,3,5)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_pass'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_7_0,3)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_7_0_i5);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_7_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module2)
	MR_init_entry1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0);
	MR_init_label1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0,2)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_process_specific_procs'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	...
	MR_r1 = MR_r3;
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__get_strategy_5_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0_i2);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_ppid_9_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module3)
	...
	MR_init_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,2,4,3,7,9,11,12,6)
	MR_init_label1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,13)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_process_pred'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,2)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_origin_2_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i4);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i3);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,3)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_import_status_2_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i7);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i6);
	}
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__structure_reuse__domain__reuse_as_init_0_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i9);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_pred__pred_info_procids_1_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i11);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i12);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__hlds__hlds_pred__pred_info_non_imported_procids_1_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0_i13);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_9_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module5)
	...
	MR_init_label3(transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0,4,6,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0);
	...
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0_i15);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module6)
	MR_init_entry1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0);
	MR_init_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,2,3,4,5,6,7,8,9)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_process_proc_2'/11 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	...
	MR_np_call_localret_ent(libs__globals__io_lookup_bool_option_4_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i2);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
	...
	MR_np_call_localret_ent(hlds__passes_aux__write_proc_progress_message_6_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i3);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_goal_2_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i4);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__detect_garbage__determine_dead_deconstructions_6_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i5);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_maybe_dump_4_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i6);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(7);
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__determine_reuse_9_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i7);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_set_goal_3_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i8);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Word) MR_string_const("% reuse analysis done.\n", 23);
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0_i9);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module7)
	...
	MR_init_label8(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,2,3,4,5,6,9,10,11)
	MR_init_label2(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,12,13)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_process_proc'/10 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,5)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_2_11_0,
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,11)
	...
	MR_np_call_localret_ent(map__det_update_4_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0_i12);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_set_preds_3_0,
		transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0_i13);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct_module8)
	MR_init_entry1(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_ppid_9_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'direct_reuse_process_ppid'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_ppid_9_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r3;
	...
	MR_r5 = MR_tempr2;
	MR_r6 = MR_tempr1;
	MR_np_tailcall_ent(transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_proc_10_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
void mercury__transform_hlds__ctgc__structure_reuse__direct__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__transform_hlds__ctgc__structure_reuse__direct);
