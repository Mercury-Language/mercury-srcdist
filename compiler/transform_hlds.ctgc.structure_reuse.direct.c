  ...
  MR_Word * STATE_VARIABLE_ReuseTable_21)
{
  ...
  if (succeeded)
  {
    Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_12, (MR_Integer) 0))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_26 = transform_hlds__ctgc__structure_reuse__domain__reuse_as_init_0_f_0();
      {
        ...
        MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct_scalar_common_3[2]));
        MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_pred_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_24, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_24, 3) = ((MR_Box) (PredId_8));
