...
make.util.optdate make.util.trans_opt_date make.util.err make.util.c_date make.util.s_date make.util.pic_s_date make.util.il_date make.util.java_date : make.util.m \
	make.int0 \
	analysis.int \
	assoc_list.int \
	backend_libs.int \
...
ifeq ($(TARGET_ASM),yes)
make.util.mh make.util.mih : make.util.s
else
make.util.mh make.util.mih : make.util.c
endif

ifeq ($(TARGET_ASM),yes)
make.util.module_dep : make.util.s
else
 ifeq ($(findstring il,$(GRADE)),il)
make.util.module_dep : make.util.il
 else
