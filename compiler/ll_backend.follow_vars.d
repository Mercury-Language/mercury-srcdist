...
ll_backend.follow_vars.optdate ll_backend.follow_vars.trans_opt_date follow_vars.err ll_backend.follow_vars.c_date ll_backend.follow_vars.java_date : follow_vars.m \
	ll_backend.int0 \
	assoc_list.int \
	bool.int \
	builtin.int \
...
#   long deps
#   short deps
ll_backend.follow_vars.optdate ll_backend.follow_vars.trans_opt_date follow_vars.err ll_backend.follow_vars.c_date ll_backend.follow_vars.java_date : \
		follow_vars.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.follow_vars.pic_o ll_backend.follow_vars.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ll_backend.follow_vars.mh ll_backend.follow_vars.mih : ll_backend.follow_vars.c
...
ll_backend.follow_vars.module_dep : jmercury/ll_backend__follow_vars.java
else
ll_backend.follow_vars.module_dep : ll_backend.follow_vars.c
endif
...
ll_backend.follow_vars.date ll_backend.follow_vars.date0 \
	ll_backend.date : follow_vars.m \
	ll_backend.int0 \
	assoc_list.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.follow_vars.date ll_backend.follow_vars.date0 ll_backend.date : \
		follow_vars.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.follow_vars.date0 \
	ll_backend.date0 : follow_vars.m \
	assoc_list.int3 \
	bool.int3 \
	builtin.int3 \
	hlds.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.follow_vars.date0 ll_backend.date0 : \
		follow_vars.m \
	\
		assoc_list.int3 \
		bool.int3 \
...
ll_backend.follow_vars.int0 : ll_backend.follow_vars.date0
	@:
ll_backend.follow_vars.int : ll_backend.follow_vars.date
	@:
ll_backend.follow_vars.int2 : ll_backend.follow_vars.date
	@:
ll_backend.follow_vars.int3 : ll_backend.follow_vars.date3
	@:
ll_backend.follow_vars.opt : ll_backend.follow_vars.optdate
	@:
ll_backend.follow_vars.trans_opt : ll_backend.follow_vars.trans_opt_date
	@:
...
ll_backend.follow_vars.date0 : follow_vars.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ll_backend.follow_vars
ll_backend.follow_vars.date : follow_vars.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ll_backend.follow_vars
ll_backend.follow_vars.date3 : follow_vars.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ll_backend.follow_vars
ll_backend.follow_vars.optdate : follow_vars.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ll_backend.follow_vars
ll_backend.follow_vars.trans_opt_date : follow_vars.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ll_backend.follow_vars
ll_backend.follow_vars.c_date : follow_vars.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ll_backend.follow_vars $(ERR_REDIRECT)
ll_backend.follow_vars.java_date : follow_vars.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ll_backend.follow_vars $(ERR_REDIRECT)
