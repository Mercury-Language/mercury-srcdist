...
hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__725__1_2_p_0(
  MR_Word WithInst_22,
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word ArgModes_52;
        MR_Word Var_86;
        MR_Word Succeeded_99;
        MR_Word STATE_VARIABLE_ModuleInfo_88_100;
        MR_Word STATE_VARIABLE_Specs_89_101;
        ...
        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 1, Purity_27, Markers_50, &Succeeded_99, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_88_100, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_101);
        switch (Succeeded_99) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
              *STATE_VARIABLE_ModuleInfo_57 = STATE_VARIABLE_ModuleInfo_88_100;
              *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_89_101;
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              hlds__add_pred__module_add_mode_decl_10_p_0((MR_Integer) 1, IsClassMethod_53, ItemMercuryStatus_10, PredStatus_11, ItemModeDecl_54, &PredProcId_55, STATE_VARIABLE_ModuleInfo_88_100, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_89_101, STATE_VARIABLE_Specs_59);
              {
                MR_Word base;
      ...
      {
        MR_Word STATE_VARIABLE_Specs_89_141;
        MR_Word Succeeded_139;

        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 0, Purity_27, Markers_50, &Succeeded_139, STATE_VARIABLE_ModuleInfo_0_56, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_141);
        *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
        hlds__add_pred__check_for_modeless_predmode_decl_8_p_0(PredStatus_11, PredOrFunc_18, PredSymName_17, ArgTypes_37, MaybeDetism_22, Context_29, STATE_VARIABLE_Specs_89_141, STATE_VARIABLE_Specs_59);
      }
      else
      {
        MR_Word ArgModes_116;
        MR_Word Succeeded_143;
        MR_Word STATE_VARIABLE_ModuleInfo_88_144;
        MR_Word STATE_VARIABLE_Specs_89_145;

        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 1, Purity_27, Markers_50, &Succeeded_143, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_88_144, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_145);
        ArgModes_116 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeArgModes0_38, (MR_Integer) 0))));
        switch (Succeeded_143) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
              *STATE_VARIABLE_ModuleInfo_57 = STATE_VARIABLE_ModuleInfo_88_144;
              *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_89_145;
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word IsClassMethod_104;
              MR_Word ItemModeDecl_105;
              MR_Word PredProcId_106;
              MR_Word Var_108;

              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_50, (MR_Integer) 10);
              if (succeeded)
                IsClassMethod_104 = (MR_Integer) 1;
              else
                IsClassMethod_104 = (MR_Integer) 0;
              {
                Var_108 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_108, 0) = ((MR_Box) (PredOrFunc_18));
              }
              {
                ItemModeDecl_105 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 0) = ((MR_Box) (PredSymName_17));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 1) = ((MR_Box) (Var_108));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 2) = ((MR_Box) (ArgModes_116));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 3) = ((MR_Box) (WithInst_21));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 4) = ((MR_Box) (MaybeDetism_22));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 5) = ((MR_Box) (InstVarSet_25));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 6) = ((MR_Box) (Context_29));
                MR_hl_field(MR_mktag(0), ItemModeDecl_105, 7) = ((MR_Box) (SeqNum_30));
              }
              hlds__add_pred__module_add_mode_decl_10_p_0((MR_Integer) 1, IsClassMethod_104, ItemMercuryStatus_10, PredStatus_11, ItemModeDecl_105, &PredProcId_106, STATE_VARIABLE_ModuleInfo_88_144, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_89_145, STATE_VARIABLE_Specs_59);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *MaybePredProcId_14 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (PredProcId_106));
              }
            }
            break;
        }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__725__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
