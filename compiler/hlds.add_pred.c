...
{
  {
    ...
    if (((MR_tag((MR_Word) PredSymName_26)) == (MR_Integer) 1))
    {
      ...
      hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_38, PredOrFunc_25, PredSymName_26, PredArity_39, Context_21, PredOrigin_20, PredStatus_37, MaybeCurUserDecl_46, (MR_Word) (&hlds__add_pred_scalar_common_2[0]), Markers_53, Types_29, TVarSet_27, ExistQVars_28, Constraints_30, Proofs_50, ConstraintMap_51, ClausesInfo_49, VarNameRemap_54, &PredInfo0_55);
