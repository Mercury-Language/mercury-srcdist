...
{
  {
    ...
    parse_tree__prog_util__make_n_fresh_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), (MR_String) "T", Arity_14, &TypeVars_42, TVarSet0_41, &TVarSet_43);
    ...
    hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredicateTable0_54, (MR_Integer) 0, PredOrFunc_15, PredName_13, Arity_14, &PredIds_55);
...
{
  {
    ...
    if (((MR_tag((MR_Word) PredName_27)) == (MR_Integer) 1))
    {
      ...
      succeeded = (MaybeItemMercuryStatus_23 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
...
{
  {
    ...
    hlds__make_hlds_error__maybe_report_undefined_pred_error_10_p_0(STATE_VARIABLE_ModuleInfo_0_29, PredName_17, Arity_18, PredOrFunc_19, Status_20, IsClassMethod_21, Context_22, DescPieces_24, STATE_VARIABLE_Specs_0_31, &STATE_VARIABLE_Specs_33_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__prog_util__adjust_func_arity_3_p_1((MR_Integer) 1, &FuncArity_27, Arity_18);
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_19, Arity_18, Var_36, &ClausesInfo_28);
    hlds__add_pred__preds_do_add_implicit_11_p_0(ModuleName_16, PredName_17, Arity_18, PredOrFunc_19, Status_20, Context_22, Origin_23, ClausesInfo_28, PredId_25, STATE_VARIABLE_ModuleInfo_0_29, STATE_VARIABLE_ModuleInfo_30);
  }
}
...
{
  {
    ...
    parse_tree__prog_util__make_n_fresh_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), (MR_String) "T", Arity_14, &TypeVars_25, TVarSet0_24, &TVarSet_26);
    ...
    hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredicateTable0_37, (MR_Integer) 0, PredOrFunc_15, PredName_13, Arity_14, &PredIds_38);
