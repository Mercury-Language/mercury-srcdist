  ...
  MR_Word * Markers_12)
{
  ...
  if ((Origin_10 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_25, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_7));
      MR_hl_field(MR_mktag(0), Var_25, 1) = ((MR_Box) (PredSymName_8));
      MR_hl_field(MR_mktag(0), Var_25, 2) = ((MR_Box) (UserArity_9));
    }
    {
      MR_Word base;
    ...
    switch (MR_tag((MR_Word) CompilerOrigin_15)) {
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_26, 0) = ((MR_Box) (ClassId_16));
            MR_hl_field(MR_mktag(2), Var_26, 1) = ((MR_Box) (MethodId_17));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_28, 1) = ((MR_Box) (TypeCtor_18));
            MR_hl_field(MR_mktag(3), Var_28, 2) = (MR_Box) ((MR_Unsigned) (SolverPredKind_19));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ModuleName_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 1))));
              MR_String MutableName_23 = ((MR_String) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 2))));
              MR_Word MutablePredKind_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 3))) & (MR_Integer) 15);
              MR_Word Var_30;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_30, 1) = ((MR_Box) (ModuleName_22));
                MR_hl_field(MR_mktag(3), Var_30, 2) = ((MR_Box) (MutableName_23));
                MR_hl_field(MR_mktag(3), Var_30, 3) = (MR_Box) ((MR_Unsigned) (MutablePredKind_24));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              MR_Word PFSymNameArity_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 1))));
              MR_Word TablingPredKind_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word Var_29;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_29, 1) = ((MR_Box) (PFSymNameArity_20));
                MR_hl_field(MR_mktag(3), Var_29, 2) = (MR_Box) ((MR_Unsigned) (TablingPredKind_21));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
