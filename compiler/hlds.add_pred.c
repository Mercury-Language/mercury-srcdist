...
{
  {
    ...
    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Types_30, &PredArity_39);
    if (((MR_tag((MR_Word) PredName_27)) == (MR_Integer) 1))
    {
      ...
      hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_26, PredArity_39, Var_81, &ClausesInfo_50);
      ...
      hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_38, PredName_27, PredArity_39, PredOrFunc_26, Context_21, Origin_20, PredStatus_37, CurUserDecl_48, (MR_Word) ((MR_Unsigned) 12U), Markers_54, Types_30, TVarSet_28, ExistQVars_29, Constraints_31, Proofs_51, ConstraintMap_52, ClausesInfo_50, VarNameRemap_55, &PredInfo0_56);
      hlds__pred_table__predicate_table_lookup_pf_m_n_a_7_p_0(PredTable0_49, (MR_Integer) 0, PredOrFunc_26, MNameOfPred_41, PName_42, PredArity_39, &PredIds_57);
      ...
      else
      {
        ...
        parse_tree__prog_util__adjust_func_arity_3_p_1(PredOrFunc_26, &PorFArity_63, PredArity_39);
        ...
        {
          hlds__make_hlds_error__report_multiple_def_error_8_p_0(PredName_27, PorFArity_63, DeclString_62, Context_21, OrigContext_61, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_75, STATE_VARIABLE_Specs_76);
        }
    ...
    else
    {
      ...
      hlds__add_pred__unqualified_pred_error_5_p_0(PredName_27, PredArity_39, Context_21, STATE_VARIABLE_Specs_0_75, STATE_VARIABLE_Specs_76);
    }
  }
}
