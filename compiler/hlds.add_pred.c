...
static MR_bool MR_CALL 
hlds__add_pred__IntroducedFrom__pred__module_add_pred_decl__135__1_2_p_0(
  MR_Word WithType_16,
  MR_Word HeadVar__2_45);

static MR_bool MR_CALL 
hlds__add_pred__module_add_pred_decl_7_p_0_2(
  MR_Box closure_arg);

static MR_bool MR_CALL 
hlds__add_pred__module_add_pred_decl_7_p_0_1(
  MR_Box closure_arg);
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__add_pred_scalar_common_1[1]), ((MR_Box) (WithInst_17)), ((MR_Box) (HeadVar__2_49)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__add_pred_scalar_common_1[0]), ((MR_Box) (WithType_16)), ((MR_Box) (HeadVar__2_45)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_pred_decl__135__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}

void MR_CALL 
hlds__add_pred__module_add_pred_decl_7_p_0(
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&hlds__add_pred_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (hlds__add_pred__module_add_pred_decl_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_42, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_42, 3) = ((MR_Box) (WithType_16));
      MR_hl_field(MR_mktag(0), Var_42, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    mercury__require__expect_3_p_0(Var_42, (MR_String) "predicate \140hlds.add_pred.module_add_pred_decl\'/7", (MR_String) "WithType != no");
    {
      Var_46 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&hlds__add_pred_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (hlds__add_pred__module_add_pred_decl_7_p_0_2));
      MR_hl_field(MR_mktag(0), Var_46, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_46, 3) = ((MR_Box) (WithInst_17));
      MR_hl_field(MR_mktag(0), Var_46, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    mercury__require__expect_3_p_0(Var_46, (MR_String) "predicate \140hlds.add_pred.module_add_pred_decl\'/7", (MR_String) "WithInst != no");
    hlds__hlds_pred__init_markers_1_p_0(&Markers0_27);
    if ((Origin_19 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
        PredOrigin_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), PredOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        MR_hl_field(MR_mktag(3), PredOrigin_34, 1) = ((MR_Box) (PredSymName_13));
      }
      Markers_35 = Markers0_27;
    }
    else
    {
      MR_Word CompilerAttrs_28 = (MR_Word) (MR_body((MR_Word) (Origin_19), (MR_Integer) 1));
      MR_Word IsMutable_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CompilerAttrs_28, (MR_Integer) 1))));

      if ((IsMutable_30 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        {
          PredOrigin_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), PredOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      ...
      {
        MR_Word ModuleName_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), IsMutable_30, (MR_Integer) 0))));
        MR_String MutableName_32 = ((MR_String) ((MR_hl_field(MR_mktag(1), IsMutable_30, (MR_Integer) 1))));
        MR_Word MutablePredKind_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), IsMutable_30, (MR_Integer) 2))) & (MR_Integer) 15);

        {
          PredOrigin_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), PredOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), PredOrigin_34, 1) = ((MR_Box) (ModuleName_31));
          MR_hl_field(MR_mktag(3), PredOrigin_34, 2) = ((MR_Box) (MutableName_32));
          MR_hl_field(MR_mktag(3), PredOrigin_34, 3) = (MR_Box) ((MR_Unsigned) (MutablePredKind_33));
        }
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 24, Markers0_27, &Markers_35);
      }
    }
    hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_8, &PredStatus_36);
    {
      Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (ItemMercuryStatus_8));
    }
    hlds__add_pred__module_add_pred_or_func_21_p_0(PredOrigin_34, Context_25, SeqNum_26, Var_51, PredStatus_36, NeedQual_9, PredOrFunc_14, PredSymName_13, TypeVarSet_20, InstVarSet_21, ExistQVars_22, TypesAndModes_15, ClassContext_24, MaybeDetism_18, Purity_23, Markers_35, &Var_37, STATE_VARIABLE_ModuleInfo_0_38, STATE_VARIABLE_ModuleInfo_39, STATE_VARIABLE_Specs_0_40, STATE_VARIABLE_Specs_41);
  }
}
        ...
        *MaybePredProcId_38 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_125, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__add_pred_scalar_common_1[9])));
          }
          {
            DetPieces_120 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DetPieces_120, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_pred_scalar_common_1[71])));
...
{
  {
    ...
    if (((MR_tag((MR_Word) PredName_28)) == (MR_Integer) 1))
    {
      ...
      mercury__map__init_1_p_0((MR_Word) (&hlds__add_pred_scalar_common_1[2]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &VarNameRemap_57);
...
{
  {
    ...
    else
    {
      ...
      hlds__add_pred__preds_add_implicit_report_error_14_p_0(STATE_VARIABLE_ModuleInfo_0_43, &STATE_VARIABLE_ModuleInfo_49_49, ModuleName_30, PredName_21, Arity_31, PredOrFunc_20, PredStatus_19, IsClassMethod_25, Context_16, Var_50, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__add_pred_scalar_common_1[13])), &PredId_35, STATE_VARIABLE_Specs_0_45, &STATE_VARIABLE_Specs_52_52);
    }
