...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_33, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_11, 2) = ((MR_Box) ((MR_Unsigned) 24U));
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) PredSymName_6)) == (MR_Integer) 1))
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_19, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), DetSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            Var_71 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_71, 0) = ((MR_Box) ((MR_Unsigned) 23U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), SectionSpec_46, 2) = ((MR_Box) ((MR_Unsigned) 24U));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_104, 0) = ((MR_Box) ((MR_Unsigned) 23U));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), PredModeSpec_49, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Spec_11, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 210) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
      MR_hl_field(MR_mktag(2), Spec_11, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(2), Spec_11, 3) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_56, 2) = ((MR_Box) ((MR_Unsigned) 24U));
