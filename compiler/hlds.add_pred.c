...
hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__718__1_2_p_0(
  MR_Word WithInst_22,
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_28)
{
  ...
  hlds__pred_table__predicate_table_lookup_pf_m_n_a_7_p_0(PredicateTable0_59, (MR_Integer) 0, PredOrFunc_12, PredModuleName_13, PredName_14, PredFormArity_15, &PredIds_60);
  ...
  MR_Word * STATE_VARIABLE_Specs_76)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_80, 0) = (MR_Box) (((((MR_Unsigned) (DeclSection_44) << 1)) | (MR_Unsigned) (PredmodeDecl_33)));
      MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (SeqNum_23));
    }
    {
      MaybeCurUserDecl_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MaybeCurUserDecl_45, 0) = ((MR_Box) (Var_80));
    }
  }
  else
    MaybeCurUserDecl_45 = (MR_Word) ((MR_Unsigned) 0U);
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_73, &PredTable0_47);
  Var_82 = hlds__hlds_clauses__init_clause_item_numbers_user_0_f_0();
  hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_26, PredFormArity_40, Var_82, &ClausesInfo_48);
  ...
  if ((PredIds_55 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *Succeeded_36 = (MR_Integer) 1;
    ...
    hlds__pred_table__predicate_table_insert_qual_6_p_0(PredInfo0_54, NeedQual_25, PQInfo_63, &PredId_64, PredTable0_47, &PredTable1_65);
    ...
    if (succeeded)
    {
      ...
      MR_Word PredInfo_68;
      MR_Word PredIdTable1_69;
      MR_Word PredIdTable_70;
      ...
      hlds__add_pred__add_builtin_5_p_0(PredId_64, Types_31, CompilationTarget_67, PredInfo0_54, &PredInfo_68);
      hlds__pred_table__predicate_table_get_pred_id_table_2_p_0(PredTable1_65, &PredIdTable1_69);
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), ((MR_Box) (PredId_64)), ((MR_Box) (PredInfo_68)), PredIdTable1_69, &PredIdTable_70);
      hlds__pred_table__predicate_table_set_pred_id_table_3_p_0(PredIdTable_70, PredTable1_65, &PredTable_71);
    }
    else
    ...
    STATE_VARIABLE_Specs_87_87 = STATE_VARIABLE_Specs_0_75;
  }
  else
  {
    ...
    MR_String DeclString_60;
    MR_Word Var_85;

    *Succeeded_36 = (MR_Integer) 0;
    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_73, OrigPred_56, &OrigPredInfo_58);
    hlds__hlds_pred__pred_info_get_context_2_p_0(OrigPredInfo_58, &OrigContext_59);
    DeclString_60 = parse_tree__prog_out__pred_or_func_to_str_1_f_0(PredOrFunc_26);
    ...
    else
    {
      ...
      UserArityInt_62 = (MR_Integer) (UserArity_61);
      hlds__make_hlds_error__report_multiple_def_error_8_p_0(PredSymName_41, UserArityInt_62, DeclString_60, Context_22, OrigContext_59, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_75, &STATE_VARIABLE_Specs_87_87);
    }
    *STATE_VARIABLE_ModuleInfo_74 = STATE_VARIABLE_ModuleInfo_0_73;
  }
  DefnThisModule_72 = hlds__status__pred_status_defined_in_this_module_1_f_0(PredStatus0_24);
  switch (DefnThisModule_72) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      hlds__add_pred__report_any_unqualified_types_5_p_0(PredSymName_41, Context_22, Types_31, STATE_VARIABLE_Specs_87_87, STATE_VARIABLE_Specs_76);
      break;
    case (MR_Integer) 1:
      *STATE_VARIABLE_Specs_76 = STATE_VARIABLE_Specs_87_87;
      break;
  }
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__718__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
