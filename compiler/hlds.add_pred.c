...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_33, 2) = ((MR_Box) ((MR_Unsigned) 36U));
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) PredSymName_6)) == (MR_Integer) 1))
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_19, 2) = ((MR_Box) ((MR_Unsigned) 36U));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), DetSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 36U));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), SectionSpec_46, 2) = ((MR_Box) ((MR_Unsigned) 36U));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), PredModeSpec_49, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Spec_11, 3) = ((MR_Box) ((MR_Unsigned) 36U));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_56, 2) = ((MR_Box) ((MR_Unsigned) 36U));
