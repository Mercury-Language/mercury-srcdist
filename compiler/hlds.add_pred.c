...
static /* final */ const MR_Box hlds__add_pred_scalar_common_1[90][2] = {
  ...
  /* row  29 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[28]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[7])))
  },
  /* row  30 */
  {
  ...
  /* row  31 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[30]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[29])))
  },
  /* row  32 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  33 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[32]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[31])))
  },
  /* row  34 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  35 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[34]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[33])))
  },
  /* row  36 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  37 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[36]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[35])))
  },
  /* row  38 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  39 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[38]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[37])))
  },
  /* row  40 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  50 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[49]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[7])))
  },
  /* row  51 */
  {
  ...
  /* row  54 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[53]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[7])))
  },
  /* row  55 */
  {
  ...
  /* row  56 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[55]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[54])))
  },
  /* row  57 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[14]))),
    ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[56])))
  },
  /* row  58 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
...
static /* final */ const MR_Box hlds__add_pred_scalar_common_3[2][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[40]))),
    (MR_Box) ((MR_Unsigned) 0U),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  MR_Word TypesAndModes_12 = ((MR_Word) ((MR_hl_field(0, ItemPredDecl_8, (MR_Integer) 2))));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              FieldDefn_35 = ((MR_Word) ((MR_hl_field(1, Var_43, (MR_Integer) 0))));
              Var_51 = ((MR_Word) ((MR_hl_field(1, Var_43, (MR_Integer) 1))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  DefnStatus_37 = ((MR_Word) ((MR_hl_field(0, FieldDefn_35, (MR_Integer) 1))));
          ...
          if (succeeded)
          {
            ...
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_25, &PredFormArity_41);
            {
              ...
              MR_hl_field(0, PFSymNameArity_42, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
              MR_hl_field(0, PFSymNameArity_42, 1) = ((MR_Box) (SymName_10));
              MR_hl_field(0, PFSymNameArity_42, 2) = ((MR_Box) (PredFormArity_41));
            }
            {
              Var_58 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_58, 0) = ((MR_Box) ((MR_Unsigned) 13U));
              MR_hl_field(3, Var_58, 1) = ((MR_Box) (PFSymNameArity_42));
            }
            {
              Var_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_57, 0) = ((MR_Box) (Var_58));
              MR_hl_field(1, Var_57, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[87])));
            }
            {
              Pieces_53 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Pieces_53, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[80])));
              MR_hl_field(1, Pieces_53, 1) = ((MR_Box) (Var_57));
            }
            {
              Spec_54 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Spec_54, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.add_pred.report_field_status_mismatch\'/4"));
              MR_hl_field(1, Spec_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(1, Spec_54, 2) = ((MR_Box) ((MR_Unsigned) 40U));
              MR_hl_field(1, Spec_54, 3) = ((MR_Box) (Context_22));
              MR_hl_field(1, Spec_54, 4) = ((MR_Box) (Pieces_53));
            }
            {
              MR_Word base;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_pred_decl__143__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_pred_decl__142__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_60)
{
  ...
  MR_Word ArgTypesAndModes_19 = ((MR_Word) ((MR_hl_field(0, ItemPredDecl_13, (MR_Integer) 2))));
    ...
    }
  {
    ...
    MR_hl_field(0, Var_63, 0) = ((MR_Box) (&hlds__add_pred_scalar_common_4[1]));
    MR_hl_field(0, Var_63, 1) = ((MR_Box) (hlds__add_pred__module_add_pred_decl_9_p_0_1));
    MR_hl_field(0, Var_63, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_63, 3) = ((MR_Box) (WithType_20));
  ...
  mercury__require__expect_3_p_0(Var_63, (MR_String) "predicate \140hlds.add_pred.module_add_pred_decl\'/9", (MR_String) "WithType != no");
  {
    ...
    MR_hl_field(0, Var_67, 0) = ((MR_Box) (&hlds__add_pred_scalar_common_4[0]));
    MR_hl_field(0, Var_67, 1) = ((MR_Box) (hlds__add_pred__module_add_pred_decl_9_p_0_2));
    MR_hl_field(0, Var_67, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_67, 3) = ((MR_Box) (WithInst_21));
  ...
  if (succeeded)
  {
    ...
    PredOrFuncStr_34 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_18);
    {
      ...
      MR_hl_field(3, Var_74, 1) = ((MR_Box) (PredOrFuncStr_34));
    }
    {
      Var_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_73, 0) = ((MR_Box) (Var_74));
      MR_hl_field(1, Var_73, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[9])));
    }
    {
      ...
      MR_hl_field(1, Pieces_35, 1) = ((MR_Box) (Var_73));
    }
    {
      ...
      MR_hl_field(1, Spec_36, 2) = ((MR_Box) ((MR_Unsigned) 40U));
    ...
    }
    {
      ...
      *STATE_VARIABLE_Specs_60 = base;
      ...
      MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_59));
    }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ArgModes0_40 = ((MR_Word) ((MR_hl_field(1, MaybeArgModes0_38, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__prog_mode__out_mode_1_p_0(&OutMode_46);
        {
          ...
          MR_hl_field(1, Var_87, 0) = ((MR_Box) (OutMode_46));
        ...
        {
          MaybeArgModes_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeArgModes_41, 0) = ((MR_Box) (Var_86));
        }
    ...
    {
      MR_Word ArgModes_53 = ((MR_Word) ((MR_hl_field(1, MaybeArgModes_41, (MR_Integer) 0))));
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(0, ItemModeDecl_55, 0) = ((MR_Box) (PredSymName_17));
              MR_hl_field(0, ItemModeDecl_55, 1) = ((MR_Box) (Var_93));
              MR_hl_field(0, ItemModeDecl_55, 2) = ((MR_Box) (ArgModes_53));
              MR_hl_field(0, ItemModeDecl_55, 3) = ((MR_Box) (WithInst_21));
              MR_hl_field(0, ItemModeDecl_55, 4) = ((MR_Box) (MaybeDetism_22));
              MR_hl_field(0, ItemModeDecl_55, 5) = ((MR_Box) (InstVarSet_25));
              MR_hl_field(0, ItemModeDecl_55, 6) = ((MR_Box) (Context_29));
              MR_hl_field(0, ItemModeDecl_55, 7) = ((MR_Box) (SeqNum_30));
            }
            hlds__add_pred__module_add_mode_decl_10_p_0((MR_Integer) 1, IsClassMethod_54, ItemMercuryStatus_10, PredStatus_11, ItemModeDecl_55, &PredProcId_56, STATE_VARIABLE_ModuleInfo_90_90, STATE_VARIABLE_ModuleInfo_58, STATE_VARIABLE_Specs_91_91, STATE_VARIABLE_Specs_60);
            {
              ...
              *MaybePredProcId_14 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (PredProcId_56));
            }
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_75)
{
  ...
  if (succeeded)
    PredStatus_39 = (MR_Word) (((MR_Box) (MR_mkword(2, &hlds__add_pred_scalar_common_2[2]))));
  else
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Unification_34, 1) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[40])));
      ...
      }
      {
        ...
        MR_hl_field(1, AssignExpr_36, 4) = ((MR_Box) (&hlds__add_pred_scalar_common_1[41]));
      }
      ...
      }
      {
        ...
        MR_hl_field(3, CastExpr_39, 1) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_2[2])));
      ...
      }
      {
        ...
        MR_hl_field(3, GoalExpr_23, 1) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[42])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          GoalExpr_23 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, GoalExpr_23, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(3, GoalExpr_23, 1) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[43])));
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) PredSymName_6)) == (MR_Integer) 1))
            {
              ...
              }
              {
                ...
                MR_hl_field(3, Var_46, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(3, Var_46, 1) = ((MR_Box) (PredModuleName_16));
              }
              {
                Var_45 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_45, 0) = ((MR_Box) (Var_46));
                MR_hl_field(1, Var_45, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[39])));
              }
              {
                Var_42 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_42, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[27])));
                MR_hl_field(1, Var_42, 1) = ((MR_Box) (Var_45));
              }
              {
                Var_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_39, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[26])));
                MR_hl_field(1, Var_39, 1) = ((MR_Box) (Var_42));
              }
              {
                Var_36 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_36, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[25])));
              ...
              }
              {
                ...
                MR_hl_field(1, Pieces_18, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[24])));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_32, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[23])));
      }
      {
        DetPieces_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, DetPieces_22, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[19])));
      ...
      }
      {
        ...
        MR_hl_field(1, DetSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 40U));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__736__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_57)
{
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          Var_85 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_85, 0) = ((MR_Box) (Var_86));
          MR_hl_field(1, Var_85, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[50])));
        }
        {
          Var_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_82, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[48])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_74, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[47])));
          MR_hl_field(1, Var_74, 1) = ((MR_Box) (Var_77));
        }
        {
          Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_71, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[46])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_66, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[45])));
        ...
        }
        {
          ...
          MR_hl_field(1, SectionPieces_47, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[44])));
        ...
        }
        {
          ...
          MR_hl_field(1, SectionSpec_48, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(0, PFSNA2_49, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
              MR_hl_field(0, PFSNA2_49, 1) = ((MR_Box) (Var_97));
              MR_hl_field(0, PFSNA2_49, 2) = ((MR_Box) (PredFormArity_29));
            }
            {
              Var_101 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_101, 0) = ((MR_Box) ((MR_Unsigned) 13U));
              MR_hl_field(3, Var_101, 1) = ((MR_Box) (PFSNA2_49));
            }
            {
              Var_106 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_106, 0) = ((MR_Box) ((MR_Unsigned) 27U));
              MR_hl_field(3, Var_106, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
            }
            {
              Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_105, 0) = ((MR_Box) (Var_106));
              MR_hl_field(1, Var_105, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[57])));
            }
            {
              Var_102 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_102, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[52])));
            ...
            {
              PredModePieces_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, PredModePieces_50, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[51])));
              MR_hl_field(1, PredModePieces_50, 1) = ((MR_Box) (Var_100));
            }
            {
              PredModeSpec_51 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, PredModeSpec_51, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.add_pred.module_do_add_mode\'/10"));
              MR_hl_field(1, PredModeSpec_51, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(1, PredModeSpec_51, 2) = ((MR_Box) ((MR_Unsigned) 40U));
              MR_hl_field(1, PredModeSpec_51, 3) = ((MR_Box) (Context_27));
              MR_hl_field(1, PredModeSpec_51, 4) = ((MR_Box) (PredModePieces_50));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_123, 0) = ((MR_Box) (Modes_23));
  }
  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
...

  {
    ...
    MR_hl_field(3, Var_17, 0) = ((MR_Box) ((MR_Unsigned) 13U));
    MR_hl_field(3, Var_17, 1) = ((MR_Box) (PFSymNameArity_5));
  }
  {
    Var_16 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_16, 0) = ((MR_Box) (Var_17));
    MR_hl_field(1, Var_16, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[50])));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Spec_11, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 221) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
    MR_hl_field(3, Spec_11, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(3, Spec_11, 3) = ((MR_Box) ((MR_Unsigned) 40U));
  ...
  MR_Word * STATE_VARIABLE_Specs_11)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_14, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[50])));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_11)
{
...

  {
    ...
    MR_hl_field(3, Var_18, 0) = ((MR_Box) ((MR_Unsigned) 12U));
    MR_hl_field(3, Var_18, 1) = ((MR_Box) (PFSymNameArity_5));
  }
  {
    Var_17 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_17, 0) = ((MR_Box) (Var_18));
    MR_hl_field(1, Var_17, 1) = ((MR_Box) (MR_mkword(1, &hlds__add_pred_scalar_common_1[50])));
  }
  {
    Var_14 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_14, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[59])));
    MR_hl_field(1, Var_14, 1) = ((MR_Box) (Var_17));
  }
  {
    Pieces_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Pieces_8, 0) = ((MR_Box) (MR_mkword(3, &hlds__add_pred_scalar_common_1[58])));
    MR_hl_field(1, Pieces_8, 1) = ((MR_Box) (Var_14));
  }
  {
    Spec_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Spec_9, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.add_pred.unspecified_det_for_method\'/4"));
    MR_hl_field(1, Spec_9, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(1, Spec_9, 2) = ((MR_Box) ((MR_Unsigned) 40U));
    MR_hl_field(1, Spec_9, 3) = ((MR_Box) (Context_6));
    MR_hl_field(1, Spec_9, 4) = ((MR_Box) (Pieces_8));
