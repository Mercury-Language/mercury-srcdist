    ...
    if (((MR_tag((MR_Word) PredName_27)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
          ...
          PredmodeDecl_46 = (MR_Integer) 1;
        {
          ...
          MR_hl_field(MR_mktag(0), Var_80, 0) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (DeclSection_45))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (PredmodeDecl_46)))));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      ExtraVars_23 = (MR_Word) ((MR_Unsigned) 0U);
      ExtraTypes_24 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &LHS_29, VarSet0_14, &VarSet_25);
        {
          ...
          MR_hl_field(MR_mktag(1), ExtraVars_23, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        Var_66 = parse_tree__builtin_lib_types__int_type_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(1), ExtraTypes_24, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          GoalInfo_22 = GoalInfo1_19;
          {
            ...
            MR_hl_field(MR_mktag(0), ConjGoal_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_pred_scalar_common_3[0])));
    ...
    Var_116 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ExtraTypes_24, Types_7);
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_clauses__set_clause_list_2_p_0((MR_Word) ((MR_Unsigned) 0U), &ClausesRep_145);
          {
            ...
            MR_hl_field(MR_mktag(0), ClausesInfo_146, 8) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), ClausesInfo_146, 9) = ((MR_Box) ((MR_Integer) 0));
          }
          ...
          hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 8, Markers0_147, &Markers1_148);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_66, 0) = (MR_Box) (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 189))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) ((MR_Integer) 0)))));
