...
static /* final */ const MR_Box hlds__add_pred_scalar_common_4[2][1];
...
{
  {
    ...
    if (succeeded)
      PredStatus_37 = (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_pred_scalar_common_4[1]))));
    else
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), CastExpr_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_pred_scalar_common_4[0])));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          GoalInfo_22 = GoalInfo1_19;
          {
            ...
            MR_hl_field(MR_mktag(0), ConjGoal_116, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_pred_scalar_common_3[0])));
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_clauses__set_clause_list_2_p_0(Var_106, &ClausesRep_49);
          {
            ...
            MR_hl_field(MR_mktag(0), ClausesInfo_55, 8) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), ClausesInfo_55, 9) = ((MR_Box) ((MR_Integer) 0));
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ClausesInfo_136 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 10 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), ClausesInfo_136, 8) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), ClausesInfo_136, 9) = ((MR_Box) ((MR_Integer) 0));
          }
