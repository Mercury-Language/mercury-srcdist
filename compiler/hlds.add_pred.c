...
{
  {
    ...
    mercury__map__init_1_p_0(TypeCtorInfo_60_76, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &Proofs_50);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, TypeCtorInfo_60_76, &ConstraintMap_51);
...
{
  {
    ...
    if (((MR_tag((MR_Word) PredName_27)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__map__init_1_p_0(TypeCtorInfo_91_91, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &Proofs_51);
      mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, TypeCtorInfo_91_91, &ConstraintMap_52);
...
{
  {
    ...
    mercury__map__init_1_p_0(TypeCtorInfo_60_60, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &Proofs_32);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, TypeCtorInfo_60_60, &ConstraintMap_33);
