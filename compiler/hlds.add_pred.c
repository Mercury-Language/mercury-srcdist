...
static /* final */ const MR_Box hlds__add_pred_scalar_common_2[3][3] = {
  /* row 0 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 190) << 1)) | (MR_Unsigned) ((MR_Integer) 0))),
    ((MR_Box) ((MR_Unsigned) 0U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 1 */
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_66, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 190) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
