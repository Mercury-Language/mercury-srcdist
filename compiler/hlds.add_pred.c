...
hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__733__1_2_p_0(
  MR_Word WithInst_22,
...
static void MR_CALL 
hlds__add_pred__record_pred_origin_6_p_0(
  MR_Word PredOrFunc_7,
  MR_Word PredSymName_8,
  MR_Word UserArity_9,
  MR_Word Origin_10,
  MR_Word * PredOrigin_11,
  MR_Word * Markers_12);
...
static /* final */ const MR_Box hlds__add_pred_scalar_common_2[6][1];
...
static /* final */ const MR_Box hlds__add_pred_scalar_common_1[90][2] = {
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
    ((MR_Box) (&hlds__add_pred_scalar_common_2[5]))
  },
  /* row  41 */
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
  ...
  MR_Word * STATE_VARIABLE_Specs_60)
{
  ...
  else
  {
    ...
    hlds__add_pred__record_pred_origin_6_p_0(PredOrFunc_18, PredSymName_17, UserArity_49, Origin_23, &PredOrigin_50, &Markers_51);
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_51, (MR_Integer) 10);
            if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Specs_75)
{
  ...
  if (succeeded)
    PredStatus_39 = (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_pred_scalar_common_2[4]))));
  else
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), CastExpr_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_pred_scalar_common_2[4])));
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 7, Markers0_57, &Markers_60);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_28 = (MR_Word) (&hlds__add_pred_scalar_common_2[3]);
  ...
  MR_Word * Markers_12)
{
  ...
  hlds__hlds_pred__init_markers_1_p_0(&Markers0_13);
  if ((Origin_10 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Var_33;

    {
      Var_33 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_33, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_7));
      MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (PredSymName_8));
      MR_hl_field(MR_mktag(0), Var_33, 2) = ((MR_Box) (UserArity_9));
    }
    {
      MR_Word base;
    ...
    *Markers_12 = Markers0_13;
  }
  else
  {
    MR_Word CompilerAttrs_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_10, (MR_Integer) 0))));
    MR_Word CompilerOrigin_15 = (MR_Word) (CompilerAttrs_14);

    switch (MR_tag((MR_Word) CompilerOrigin_15)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        switch (MR_unmkbody(CompilerOrigin_15)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *PredOrigin_11 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__add_pred_scalar_common_2[2]));
              *Markers_12 = Markers0_13;
            }
            break;
          case (MR_Integer) 1:
            {
              *PredOrigin_11 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__add_pred_scalar_common_2[1]));
              *Markers_12 = Markers0_13;
            }
            break;
        }
      ...
      case (MR_Integer) 1:
        {
          MR_Word ClassId_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CompilerOrigin_15, (MR_Integer) 0))));
          MR_Word MethodId_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CompilerOrigin_15, (MR_Integer) 1))));
          MR_Word Var_27;

          {
            Var_27 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_27, 0) = ((MR_Box) (ClassId_16));
            MR_hl_field(MR_mktag(2), Var_27, 1) = ((MR_Box) (MethodId_17));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          ...
          hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 10, Markers0_13, Markers_12);
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word TypeCtor_18 = ((MR_Word) ((MR_hl_field(MR_mktag(2), CompilerOrigin_15, (MR_Integer) 0))));
          MR_Word SolverPredKind_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CompilerOrigin_15, (MR_Integer) 1))) & (MR_Integer) 3);
          MR_Word Var_29;

          {
            ...
            MR_hl_field(MR_mktag(3), Var_29, 1) = ((MR_Box) (TypeCtor_18));
            MR_hl_field(MR_mktag(3), Var_29, 2) = (MR_Box) ((MR_Unsigned) (SolverPredKind_19));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word ModuleName_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 1))));
              MR_String MutableName_21 = ((MR_String) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 2))));
              MR_Word MutablePredKind_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 3))) & (MR_Integer) 15);
              MR_Word Var_30;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_30, 1) = ((MR_Box) (ModuleName_20));
                MR_hl_field(MR_mktag(3), Var_30, 2) = ((MR_Box) (MutableName_21));
                MR_hl_field(MR_mktag(3), Var_30, 3) = (MR_Box) ((MR_Unsigned) (MutablePredKind_22));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              ...
              hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 23, Markers0_13, Markers_12);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word PFSymNameArity_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 1))));
              MR_Word TablingPredKind_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_15, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word Var_32;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_32, 1) = ((MR_Box) (PFSymNameArity_23));
                MR_hl_field(MR_mktag(3), Var_32, 2) = (MR_Box) ((MR_Unsigned) (TablingPredKind_24));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__733__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_50)
{
  ...
  else
  {
    ...
    hlds__add_pred__module_do_add_mode_9_p_0(PartOfPredmode_11, IsClassMethod_12, ItemMercuryStatus_13, ItemModeDecl_15, PredInfo0_42, &PredInfo_43, &ProcId_44, STATE_VARIABLE_Specs_78_78, STATE_VARIABLE_Specs_50);
  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_8, FuncSymName_9, &Var_19, &AccessType_15, &FieldName_16);
  if (succeeded)
    succeeded = (UserArityInt_14 == Var_19);
  if (succeeded)
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&hlds__add_pred_scalar_common_1[5]), CtorFieldTable_30, ((MR_Box) (FieldName_16)), &conv0_Var_39);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_38_48 = (MR_Word) (&hlds__add_pred_scalar_common_1[5]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_38_48, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_47)));
        if (succeeded)
        {
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_10, &PredFormArity_37);
      {
        PFSymNameArity_38 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), PFSymNameArity_38, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), PFSymNameArity_38, 1) = ((MR_Box) (FuncSymName_9));
        MR_hl_field(MR_mktag(0), PFSymNameArity_38, 2) = ((MR_Box) (PredFormArity_37));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_59, 1) = ((MR_Box) (PFSymNameArity_38));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_55, 3) = ((MR_Box) (Context_12));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_52)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrigin_19, (MR_Integer) 0))));
      succeeded = ((((MR_tag((MR_Word) Var_62)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_62, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
      }
    }
    if (succeeded)
    {
      ...
      Var_88 = mercury__string__f_43_43_2_f_0(NameString_49, (MR_String) ").\n");
      Var_90 = mercury__string__f_43_43_2_f_0((MR_String) " (", Var_88);
      Var_91 = mercury__string__f_43_43_2_f_0((MR_String) "an existing predicate", Var_90);
      Var_93 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_91);
      Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "with a name that is identical to the name of", Var_93);
      Var_96 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_94);
      UnexpectedMsg_50 = mercury__string__f_43_43_2_f_0((MR_String) "Attempted to introduce a predicate for a promise", Var_96);
      {
