  ...
  MR_Word * STATE_VARIABLE_Specs_59)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__init_markers_1_p_0(&Markers0_97);
    if ((Origin_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Markers_50 = Markers0_97;
    }
    else
    {
      MR_Word CompilerAttrs_98 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_23, (MR_Integer) 0))));
      MR_Word CompilerOrigin_99 = (MR_Word) (CompilerAttrs_98);

      switch (MR_tag((MR_Word) CompilerOrigin_99)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          switch (MR_unmkbody(CompilerOrigin_99)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
        ...
        case (MR_Integer) 1:
          {
            MR_Word ClassId_100 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CompilerOrigin_99, (MR_Integer) 0))));
            MR_Word MethodId_101 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CompilerOrigin_99, (MR_Integer) 1))));

            {
              ...
              MR_hl_field(MR_mktag(3), PredOrigin_49, 1) = ((MR_Box) (ClassId_100));
              MR_hl_field(MR_mktag(3), PredOrigin_49, 2) = ((MR_Box) (MethodId_101));
            }
            hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 10, Markers0_97, &Markers_50);
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word TypeCtorName_102 = ((MR_Word) ((MR_hl_field(MR_mktag(2), CompilerOrigin_99, (MR_Integer) 0))));
            MR_Integer TypeCtorArity_103 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), CompilerOrigin_99, (MR_Integer) 1))));
            MR_Word SolverPredKind_104 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CompilerOrigin_99, (MR_Integer) 2))) & (MR_Integer) 3);

            {
              ...
              MR_hl_field(MR_mktag(3), PredOrigin_49, 1) = ((MR_Box) (TypeCtorName_102));
              MR_hl_field(MR_mktag(3), PredOrigin_49, 2) = ((MR_Box) (TypeCtorArity_103));
              MR_hl_field(MR_mktag(3), PredOrigin_49, 3) = (MR_Box) ((MR_Unsigned) (SolverPredKind_104));
            }
            Markers_50 = Markers0_97;
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word ModuleName_105 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 1))));
                MR_String MutableName_106 = ((MR_String) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 2))));
                MR_Word MutablePredKind_107 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 3))) & (MR_Integer) 15);

                {
                  PredOrigin_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 1) = ((MR_Box) (ModuleName_105));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 2) = ((MR_Box) (MutableName_106));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 3) = (MR_Box) ((MR_Unsigned) (MutablePredKind_107));
                }
                hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 23, Markers0_97, &Markers_50);
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word PFSymNameArity_108 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 1))));
                MR_Word TablingPredKind_109 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompilerOrigin_99, (MR_Integer) 2))) & (MR_Integer) 1);

                {
                  PredOrigin_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 1) = ((MR_Box) (PFSymNameArity_108));
                  MR_hl_field(MR_mktag(3), PredOrigin_49, 2) = (MR_Box) ((MR_Unsigned) (TablingPredKind_109));
                }
                Markers_50 = Markers0_97;
              }
              break;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word ArgModes_52;
        MR_Word Var_86;
        MR_Word Succeeded_114;
        MR_Word STATE_VARIABLE_ModuleInfo_88_115;
        MR_Word STATE_VARIABLE_Specs_89_116;
        ...
        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 1, Purity_27, Markers_50, &Succeeded_114, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_88_115, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_116);
        switch (Succeeded_114) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
              *STATE_VARIABLE_ModuleInfo_57 = STATE_VARIABLE_ModuleInfo_88_115;
              *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_89_116;
            }
            break;
          case (MR_Integer) 1:
            {
                ...
                IsClassMethod_53 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (PredOrFunc_18));
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ItemModeDecl_54, 1) = ((MR_Box) (Var_91));
              ...
              hlds__add_pred__module_add_mode_decl_10_p_0((MR_Integer) 1, IsClassMethod_53, ItemMercuryStatus_10, PredStatus_11, ItemModeDecl_54, &PredProcId_55, STATE_VARIABLE_ModuleInfo_88_115, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_89_116, STATE_VARIABLE_Specs_59);
              {
                MR_Word base;
      ...
      {
        MR_Word STATE_VARIABLE_Specs_89_156;
        MR_Word Succeeded_154;

        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 0, Purity_27, Markers_50, &Succeeded_154, STATE_VARIABLE_ModuleInfo_0_56, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_156);
        *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
        hlds__add_pred__check_for_modeless_predmode_decl_8_p_0(PredStatus_11, PredOrFunc_18, PredSymName_17, ArgTypes_37, MaybeDetism_22, Context_29, STATE_VARIABLE_Specs_89_156, STATE_VARIABLE_Specs_59);
      }
      else
      {
        MR_Word ArgModes_131;
        MR_Word Succeeded_158;
        MR_Word STATE_VARIABLE_ModuleInfo_88_159;
        MR_Word STATE_VARIABLE_Specs_89_160;

        hlds__add_pred__add_new_pred_20_p_0(PredOrigin_49, Context_29, SeqNum_30, PredStatus_11, NeedQual_12, PredOrFunc_18, PredModuleName_32, PredName_33, TypeVarSet_24, ExistQVars_26, ArgTypes_37, Constraints_28, (MR_Integer) 1, Purity_27, Markers_50, &Succeeded_158, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_88_159, STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_89_160);
        ArgModes_131 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeArgModes0_38, (MR_Integer) 0))));
        switch (Succeeded_158) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *MaybePredProcId_14 = (MR_Word) ((MR_Unsigned) 0U);
              *STATE_VARIABLE_ModuleInfo_57 = STATE_VARIABLE_ModuleInfo_88_159;
              *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_89_160;
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word IsClassMethod_119;
              MR_Word ItemModeDecl_120;
              MR_Word PredProcId_121;
              MR_Word Var_123;

              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_50, (MR_Integer) 10);
              if (succeeded)
                IsClassMethod_119 = (MR_Integer) 1;
              else
                IsClassMethod_119 = (MR_Integer) 0;
              {
                Var_123 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_123, 0) = ((MR_Box) (PredOrFunc_18));
              }
              {
                ItemModeDecl_120 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 0) = ((MR_Box) (PredSymName_17));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 1) = ((MR_Box) (Var_123));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 2) = ((MR_Box) (ArgModes_131));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 3) = ((MR_Box) (WithInst_21));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 4) = ((MR_Box) (MaybeDetism_22));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 5) = ((MR_Box) (InstVarSet_25));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 6) = ((MR_Box) (Context_29));
                MR_hl_field(MR_mktag(0), ItemModeDecl_120, 7) = ((MR_Box) (SeqNum_30));
              }
              hlds__add_pred__module_add_mode_decl_10_p_0((MR_Integer) 1, IsClassMethod_119, ItemMercuryStatus_10, PredStatus_11, ItemModeDecl_120, &PredProcId_121, STATE_VARIABLE_ModuleInfo_88_159, STATE_VARIABLE_ModuleInfo_57, STATE_VARIABLE_Specs_89_160, STATE_VARIABLE_Specs_59);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *MaybePredProcId_14 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (PredProcId_121));
              }
            }
            break;
        }
  ...
  MR_Word * STATE_VARIABLE_Specs_75)
{
  ...
  if ((PredIds_55 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *Succeeded_36 = (MR_Integer) 1;
    ...
    STATE_VARIABLE_Specs_85_85 = STATE_VARIABLE_Specs_0_74;
  }
  else
  {
    ...
    *Succeeded_36 = (MR_Integer) 0;
    ...
    else
    {
      ...
      hlds__make_hlds_error__report_multiply_defined_8_p_0(PredOrFuncStr_60, PredSymName_41, UserArity_61, Context_22, OrigContext_59, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_74, &STATE_VARIABLE_Specs_85_85);
    }
  ...
  switch (DefnThisModule_71) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      hlds__add_pred__report_any_unqualified_types_5_p_0(PredSymName_41, Context_22, Types_31, STATE_VARIABLE_Specs_85_85, STATE_VARIABLE_Specs_75);
      break;
    case (MR_Integer) 1:
      *STATE_VARIABLE_Specs_75 = STATE_VARIABLE_Specs_85_85;
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_PredInfo_59)
{
  ...
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Module_10, Var_121);
  if (succeeded)
  {
  ...
  {
    {
      ...
      succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Module_10, Var_122);
      if (succeeded)
    ...
    if (!(succeeded))
    {
      ...
      Var_123 = mdbcomp__builtin_modules__mercury_io_module_0_f_0();
  ...
  switch (Stub_26) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Markers2_56;
        MR_Word ClausesRep_131;
        MR_Word ClausesInfo_132;
        MR_Word Markers0_133;
        MR_Word Markers1_134;

        hlds__hlds_clauses__set_clause_list_2_p_0((MR_Word) ((MR_Unsigned) 0U), &ClausesRep_131);
        {
          ClausesInfo_132 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 0) = ((MR_Box) (VarSet_25));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 1) = ((MR_Box) (TVarNameMap_51));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 2) = ((MR_Box) (VarTypes_50));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 3) = ((MR_Box) (VarTypes_50));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 4) = ((MR_Box) (ProcArgVector_15));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 5) = ((MR_Box) (ClausesRep_131));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 6) = ((MR_Box) (Var_106));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 7) = ((MR_Box) (RttiVarMaps_52));
          MR_hl_field(MR_mktag(0), ClausesInfo_132, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        }
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_132, STATE_VARIABLE_PredInfo_0_58, &STATE_VARIABLE_PredInfo_109_109);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_109_109, &Markers0_133);
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 7, Markers0_133, &Markers1_134);
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 0, Markers1_134, &Markers2_56);
  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  if ((MaybeDetism_23 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    switch (IsClassMethod_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        hlds__add_pred__unspecified_det_for_method_4_p_0(PFSymNameArity_32, Context_25, STATE_VARIABLE_Specs_0_55, &STATE_VARIABLE_Specs_57_57);
        break;
      case (MR_Integer) 0:
        {
          ...
          switch (IsExported_33) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              hlds__add_pred__unspecified_det_for_local_4_p_0(PFSymNameArity_32, Context_25, STATE_VARIABLE_Specs_0_55, &STATE_VARIABLE_Specs_57_57);
              break;
            case (MR_Integer) 1:
              hlds__add_pred__unspecified_det_for_exported_4_p_0(PFSymNameArity_32, Context_25, STATE_VARIABLE_Specs_0_55, &STATE_VARIABLE_Specs_57_57);
              break;
          }
        }
        break;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        STATE_VARIABLE_Specs_95_95 = STATE_VARIABLE_Specs_57_57;
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_95_95, 1) = ((MR_Box) (STATE_VARIABLE_Specs_57_57));
        }
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Spec_11, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 219) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_38_62 = (MR_Word) (&hlds__add_pred_scalar_common_1[5]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_38_62, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_61)));
              if (succeeded)
              {
