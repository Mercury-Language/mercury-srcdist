        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo__39_53 = (MR_Word) (&hlds__add_pred_scalar_common_1[5]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__39_53, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_52)));
              if (succeeded)
              {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo__39_62 = (MR_Word) (&hlds__add_pred_scalar_common_1[5]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__39_62, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_61)));
              if (succeeded)
              {
