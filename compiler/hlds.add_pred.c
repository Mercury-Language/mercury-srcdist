            ...
            case (MR_Integer) 2:
              {
                ...
                hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 11, Markers0_29, &Markers_33);
              }
              break;
          }
          break;
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 24, Markers0_29, &Markers_33);
          }
          break;
        case (MR_Integer) 3:
          {
      ...
      if ((MaybeModes_218 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        *MaybePredProcId_12 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        if (succeeded)
        {
          ...
          {
            DetMsg_134 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DetMsg_134, 0) = ((MR_Box) (Context_27));
            MR_hl_field(MR_mktag(0), DetMsg_134, 1) = ((MR_Box) (Var_142));
          }
          {
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_33, (MR_Integer) 11);
              if (succeeded)
