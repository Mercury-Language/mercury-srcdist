...
parse_tree.prog_event.optdate parse_tree.prog_event.trans_opt_date prog_event.err parse_tree.prog_event.c_date parse_tree.prog_event.s_date parse_tree.prog_event.pic_s_date parse_tree.prog_event.il_date parse_tree.prog_event.java_date : prog_event.m \
	parse_tree.int0 \
	assoc_list.int \
	bimap.int \
	bool.int \
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_event.mh parse_tree.prog_event.mih : parse_tree.prog_event.s
else
parse_tree.prog_event.mh parse_tree.prog_event.mih : parse_tree.prog_event.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.prog_event.module_dep : parse_tree.prog_event.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.prog_event.module_dep : parse_tree.prog_event.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.prog_event.module_dep : mercury/parse_tree_/prog_event.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_event.s_date : prog_event.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.prog_event $(ERR_REDIRECT)
parse_tree.prog_event.pic_s_date : prog_event.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.prog_event $(ERR_REDIRECT)
endif # TARGET_ASM
parse_tree.prog_event.il_date : prog_event.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only parse_tree.prog_event $(ERR_REDIRECT)
