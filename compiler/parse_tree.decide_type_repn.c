...
static /* final */ const MR_Box parse_tree__decide_type_repn_scalar_common_2[6][3];

static /* final */ const MR_Box parse_tree__decide_type_repn_scalar_common_3[1][13];

static /* final */ const MR_Box parse_tree__decide_type_repn_scalar_common_4[1][7];

static /* final */ const MR_Box parse_tree__decide_type_repn_scalar_common_5[1][6];
...
{
  {
    ...
    MR_Word TypeCtor_12;
    MR_Word RepnItem_13;
    MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DefnItem_4, (MR_Integer) 2))));
    MR_Integer Var_17;
    MR_Word Var_18;

    EqvType_8 = (MR_Word) (Var_16);
    Var_17 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__decide_type_repn_scalar_common_1[2]), TypeParams_7);
    {
      TypeCtor_12 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeCtor_12, 0) = ((MR_Box) (TypeCtorSymName_6));
      MR_hl_field(MR_mktag(0), TypeCtor_12, 1) = ((MR_Box) (Var_17));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_18, 1) = ((MR_Box) (EqvType_8));
    }
    {
      RepnItem_13 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), RepnItem_13, 0) = ((MR_Box) (TypeCtorSymName_6));
      MR_hl_field(MR_mktag(0), RepnItem_13, 1) = ((MR_Box) (TypeParams_7));
      MR_hl_field(MR_mktag(0), RepnItem_13, 2) = ((MR_Box) (Var_18));
      MR_hl_field(MR_mktag(0), RepnItem_13, 3) = ((MR_Box) (TVarSet_9));
      MR_hl_field(MR_mktag(0), RepnItem_13, 4) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(0), RepnItem_13, 5) = ((MR_Box) (SeqNum_11));
    }
    mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), ((MR_Box) (TypeCtor_12)), ((MR_Box) (RepnItem_13)), STATE_VARIABLE_RepnMap_0_14, STATE_VARIABLE_RepnMap_15);
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), ((MR_Box) (TypeCtor_5)), ((MR_Box) (Item_13)), STATE_VARIABLE_RepnMap_0_14, STATE_VARIABLE_RepnMap_15);
      }
      break;
    case (MR_Integer) 0:
...
{
  {
    ...
    MR_Word conv10_STATE_VARIABLE_RepnMap_15;

    parse_tree__decide_type_repn__add_eqv_repn_item_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv10_STATE_VARIABLE_RepnMap_15);
    *wrapper_arg_3 = ((MR_Box) (conv10_STATE_VARIABLE_RepnMap_15));
  }
}
  ...
  MR_Box * wrapper_arg_4)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv8_STATE_VARIABLE_RepnMap_15;

    parse_tree__decide_type_repn__maybe_add_word_aligned_repn_item_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv8_STATE_VARIABLE_RepnMap_15);
    *wrapper_arg_4 = ((MR_Box) (conv8_STATE_VARIABLE_RepnMap_15));
  }
}
...
{
  {
    ...
    MR_Word IntWordAlignedMap_16;
    MR_Word STATE_VARIABLE_IntRepnMap_19_19;
    MR_Word STATE_VARIABLE_IntRepnMap_21_21;
    MR_Box conv7_RepnMap_11;
    MR_Box conv6_EqvMap_12;
    MR_Box conv5_WordAlignedMap_13;
    MR_Box conv4_ExportedTypesSet_14;
    MR_Box conv9_STATE_VARIABLE_IntRepnMap_21_21;
    MR_Box conv11_STATE_VARIABLE_IntRepnMap_17;
    ...
    mercury__map__select_sorted_list_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), RepnMap_11, ExportedTypes_15, &STATE_VARIABLE_IntRepnMap_19_19);
    mercury__map__select_sorted_list_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_maybe_word_alignment_0), WordAlignedMap_13, ExportedTypes_15, &IntWordAlignedMap_16);
    mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_maybe_word_alignment_0), (MR_Word) (&parse_tree__decide_type_repn_scalar_common_2[0]), (MR_Word) (&parse_tree__decide_type_repn_scalar_common_2[4]), IntWordAlignedMap_16, ((MR_Box) (STATE_VARIABLE_IntRepnMap_19_19)), &conv9_STATE_VARIABLE_IntRepnMap_21_21);
    STATE_VARIABLE_IntRepnMap_21_21 = ((MR_Word) (conv9_STATE_VARIABLE_IntRepnMap_21_21));
    mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__decide_type_repn_scalar_common_1[0]), (MR_Word) (&parse_tree__decide_type_repn_scalar_common_2[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__decide_type_repn_scalar_common_2[5]), EqvMap_12, ((MR_Box) (STATE_VARIABLE_IntRepnMap_21_21)), &conv11_STATE_VARIABLE_IntRepnMap_17);
    *STATE_VARIABLE_IntRepnMap_17 = ((MR_Word) (conv11_STATE_VARIABLE_IntRepnMap_17));
  }
}
