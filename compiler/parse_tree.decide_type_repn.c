...
parse_tree__decide_type_repn__IntroducedFrom__pred__build_foreign_langs_name_map__440__1_3_p_0(
...
{
  {
    ...
    succeeded = parse_tree__decide_type_repn__IntroducedFrom__pred__build_foreign_langs_name_map__440__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)), &conv1_HeadVar__3_41);
    if (succeeded)
    {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word TypeRepn_66;
              MR_Word EqvItem_67;
              MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_24, (MR_Integer) 1))));
              MR_Word Var_84;
