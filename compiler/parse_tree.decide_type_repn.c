          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                TypeCtorInfo_26_108 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_foreign_type_assertion_0);
                succeeded = mercury__set__member_2_p_0(TypeCtorInfo_26_108, ((MR_Box) (Var_100)), Assertions_97);
              }
              if (succeeded)
