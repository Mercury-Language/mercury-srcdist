...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 285, &PackEverything_6);
    switch (PackEverything_6) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 290, &AllowPackingInts_7);
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 291, &AllowPackingChars_8);
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 289, &AllowPackingDummies_9);
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 292, &AllowPackingLocalSegtags_10);
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 293, &AllowPackingRemoteSegtags_11);
        }
        break;
      case (MR_Integer) 1:
        {
