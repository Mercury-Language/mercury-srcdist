  ...
  MR_Word * BaseParams_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 289, &PackEverything_6);
  switch (PackEverything_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 294, &AllowPackingInts_7);
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 295, &AllowPackingChars_8);
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 293, &AllowPackingDummies_9);
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 296, &AllowPackingLocalSegtags_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 297, &AllowPackingRemoteSegtags_11);
      }
      break;
    case (MR_Integer) 1:
      {
