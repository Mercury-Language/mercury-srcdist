...
static const MR_DuFunctorDescPtr check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_stag_ordered_actual_expected_types_0_0[1] = {
  &check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_functor_desc_actual_expected_types_0_0
};
...
static const MR_DuFunctorDescPtr check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_stag_ordered_arg_type_stuff_0_0[1] = {
  &check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_functor_desc_arg_type_stuff_0_0
};
...
static const MR_DuFunctorDescPtr check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_stag_ordered_type_stuff_0_0[1] = {
  &check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__du_functor_desc_type_stuff_0_0
};
  ...
  MR_Word ArgTypeStuff_7)
{
  ...
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(VarType_9, &StrippedVarType_14);
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(ExpectedType_11, &StrippedExpectedType_15);
  ...
  if (succeeded)
  {
    ...
    ExpectedPieces_19 = parse_tree__error_type_util__type_to_pieces_6_f_0(TVarSet_12, InstVarSet_6, (MR_Integer) 1, AddQuotes_5, ExistQTVars_13, ExpectedType_11);
    {
      ...
      MR_hl_field(1, Var_24, 0) = ((MR_Box) (Source_10));
    }
    {
      ...
      MR_hl_field(0, ActualExpected_8, 5) = ((MR_Box) (Var_24));
    }
  }
  else
  {
...

    {
      ...
      MR_hl_field(1, Var_25, 0) = ((MR_Box) (Source_10));
    }
    {
      ActualExpected_8 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(0, ActualExpected_8, 3) = ((MR_Box) (ExpectedType_11));
      MR_hl_field(0, ActualExpected_8, 4) = ((MR_Box) (ExistQTVars_13));
      MR_hl_field(0, ActualExpected_8, 5) = ((MR_Box) (Var_25));
    }
  }
  ...
  MR_Word VarTypeStuff_9)
{
  ...
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(VarType_11, &StrippedVarType_15);
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(ExpectedType_8, &StrippedExpectedType_16);
  parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBinding_13, StrippedVarType_15, &Type_28);
  ActualPieces0_17 = parse_tree__error_type_util__type_to_pieces_6_f_0(TVarSet_12, InstVarSet_7, (MR_Integer) 0, AddQuotes_6, ExistQTVars_14, Type_28);
  parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBinding_13, StrippedExpectedType_16, &Type_29);
  ExpectedPieces0_18 = parse_tree__error_type_util__type_to_pieces_6_f_0(TVarSet_12, InstVarSet_7, (MR_Integer) 0, AddQuotes_6, ExistQTVars_14, Type_29);
  ...
  if (succeeded)
  {
    ...
    parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBinding_13, VarType_11, &Type_30);
    ActualPieces_19 = parse_tree__error_type_util__type_to_pieces_6_f_0(TVarSet_12, InstVarSet_7, (MR_Integer) 1, AddQuotes_6, ExistQTVars_14, Type_30);
    parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBinding_13, ExpectedType_8, &Type_31);
    ExpectedPieces_20 = parse_tree__error_type_util__type_to_pieces_6_f_0(TVarSet_12, InstVarSet_7, (MR_Integer) 1, AddQuotes_6, ExistQTVars_14, Type_31);
    {
  ...
  MR_Word TypeStuff_7)
{
  ...
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(Type1_19, &Type_9);
  ...
  MR_Word TypeStuff_3)
{
  ...
  parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(Type1_9, &Type_4);
  return Type_4;
}

void MR_CALL 
check_hlds__typecheck_error_type_assign__get_arg_type_stuffs_3_p_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word * HeadVar__3_3)
{
  ...
  {
    MR_Word ArgTypeAssign_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
    MR_Word ArgTypeAssigns_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
    MR_Word TailArgTypeStuffs_9;
    ...
    MR_Word RecSubstVarType_19;
    MR_Word RecSubstArgType_20;
    MR_Word TVarSet_21;
    MR_Word ExistQTVars_22;
    MR_Word ArgTypeStuff_23;
    MR_Word VarType0_15;
    MR_Box conv0_ArgType_17;

    check_hlds__typecheck_error_type_assign__get_arg_type_stuffs_3_p_0(HeadVar__1_1, ArgTypeAssigns_7, &TailArgTypeStuffs_9);
    TypeAssign_10 = ((MR_Word) ((MR_hl_field(0, ArgTypeAssign_6, (MR_Integer) 0))));
    ArgTypes_11 = ((MR_Word) ((MR_hl_field(0, ArgTypeAssign_6, (MR_Integer) 1))));
    Source_13 = ((MR_Word) ((MR_hl_field(0, ArgTypeAssign_6, (MR_Integer) 3))));
    check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_10, &VarTypes_14);
    succeeded = parse_tree__vartypes__search_var_type_3_p_0(VarTypes_14, HeadVar__1_1, &VarType0_15);
    if (succeeded)
      VarType_16 = VarType0_15;
    else
      VarType_16 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_error_type_assign_scalar_common_2[1]));
    mercury__list__det_index0_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_11, (MR_Integer) 0, &conv0_ArgType_17);
    ArgType_17 = ((MR_Word) (conv0_ArgType_17));
    check_hlds__type_assign__type_assign_get_type_bindings_2_p_0(TypeAssign_10, &TypeBindings_18);
    parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_18, VarType_16, &RecSubstVarType_19);
    parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_18, ArgType_17, &RecSubstArgType_20);
    check_hlds__type_assign__type_assign_get_typevarset_2_p_0(TypeAssign_10, &TVarSet_21);
    check_hlds__type_assign__type_assign_get_existq_tvars_2_p_0(TypeAssign_10, &ExistQTVars_22);
    {
      ArgTypeStuff_23 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, ArgTypeStuff_23, 0) = ((MR_Box) (RecSubstVarType_19));
      MR_hl_field(0, ArgTypeStuff_23, 1) = ((MR_Box) (Source_13));
      MR_hl_field(0, ArgTypeStuff_23, 2) = ((MR_Box) (RecSubstArgType_20));
      MR_hl_field(0, ArgTypeStuff_23, 3) = ((MR_Box) (TVarSet_21));
      MR_hl_field(0, ArgTypeStuff_23, 4) = ((MR_Box) (ExistQTVars_22));
    }
    succeeded = mercury__list__member_2_p_0((MR_Word) (&check_hlds__typecheck_error_type_assign__check_hlds__typecheck_error_type_assign__type_ctor_info_arg_type_stuff_0), ((MR_Box) (ArgTypeStuff_23)), TailArgTypeStuffs_9);
    if (succeeded)
      *HeadVar__3_3 = TailArgTypeStuffs_9;
    else
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__3_3 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (ArgTypeStuff_23));
        MR_hl_field(1, base, 1) = ((MR_Box) (TailArgTypeStuffs_9));
      }
  }
}
  ...
  MR_Word FoundOne_5)
{
  ...
  else
  {
    ...
    Var_27 = parse_tree__mercury_to_mercury__mercury_constraint_to_string_3_f_0(TypeVarSet_4, (MR_Integer) 0, ProgConstraint_21);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(Type1_45, &Type_46);
        TypeStr_28 = parse_tree__mercury_to_mercury__mercury_type_to_string_3_f_0(TypeVarSet_3, (MR_Integer) 0, Type_46);
        {
