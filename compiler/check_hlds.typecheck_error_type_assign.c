...
void MR_CALL 
check_hlds__typecheck_error_type_assign__acc_transformed_type_stuffs_5_p_0(
  MR_Word TypeInfo_for_Acc_20,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3,
  ...
  MR_Box * STATE_VARIABLE_Acc_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Box next_value_of_STATE_VARIABLE_Acc_0_4;

      check_hlds__type_assign__type_assign_get_existq_tvars_2_p_0(TypeAssign_12, &ExistQTVars_21);
      check_hlds__type_assign__type_assign_get_type_bindings_2_p_0(TypeAssign_12, &TypeBindings_22);
      check_hlds__type_assign__type_assign_get_typevarset_2_p_0(TypeAssign_12, &TVarSet_23);
      check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_12, &VarTypes_24);
      succeeded = parse_tree__vartypes__search_var_type_3_p_0(VarTypes_24, HeadVar__3_3, &Type0_25);
      if (succeeded)
        Type_26 = Type0_25;
      else
        Type_26 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_error_type_assign_scalar_common_2[1]));
      {
        TypeStuff_16 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, TypeStuff_16, 0) = ((MR_Box) (Type_26));
        MR_hl_field(0, TypeStuff_16, 1) = ((MR_Box) (TVarSet_23));
        MR_hl_field(0, TypeStuff_16, 2) = ((MR_Box) (TypeBindings_22));
        MR_hl_field(0, TypeStuff_16, 3) = ((MR_Box) (ExistQTVars_21));
      }
      func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, HeadVar__1_1, 1))));
      func_0(((MR_Box) (HeadVar__1_1)), ((MR_Box) (TypeStuff_16)), STATE_VARIABLE_Acc_0_4, &STATE_VARIABLE_Acc_1_19);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = TypeAssigns_13;
      next_value_of_STATE_VARIABLE_Acc_0_4 = STATE_VARIABLE_Acc_1_19;
  ...
  MR_Word * VerboseComponent_8)
{
  ...
  }
  {
    ...
    *VerboseComponent_8 = base;
    ...
    MR_hl_field(1, base, 1) = ((MR_Box) (VerbosePieces_10));
  }
}
  ...
  MR_Word MaybeSeq_11)
{
  ...
  MR_Word Pieces1_81;
  MR_Word Pieces2_82;
  MR_Word UnprovenConstraints_83;
  ...
  check_hlds__type_assign__type_assign_get_constraint_db_2_p_0(TypeAssign_9, &Constraints_23);
  ...
  UnprovenConstraints_83 = ((MR_Word) ((MR_hl_field(0, Constraints_23, 0))));
  ...
  PiecesList2_88 = check_hlds__typecheck_error_type_assign__type_assign_constraints_to_pieces_list_5_f_0((MR_String) "<=", UnprovenConstraints_83, TypeBindings_24, TypeVarSet_25, (MR_Integer) 0);
  ...
  MR_Word FoundOne_5)
{
  ...
  else
  {
    ...
    hlds__type_rename__apply_rec_subst_to_constraint_3_p_0(TypeBindings_3, Constraint_12, &BoundConstraint_20);
