          ...
          case (MR_Integer) 0:
            {
              ...
              if (!(succeeded))
              {
                ...
                else
                {
                  ...
                  mercury__io__write_string_3_p_0((MR_String) "{\n");
                  packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 7)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 7)));
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__io__write_string_3_p_0((MR_String) ")\n\t\tcontinue;\n");
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 7)));
    ...
    if (!((HeadVar__2_2 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      if (succeeded)
      {
        Label_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr_19, (MR_Integer) 1))));
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 7)));
          MR_Box conv0_Var_23;
          ...
          case (MR_Integer) 5:
            {
              ...
              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
          ...
          case (MR_Integer) 24:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
          ...
          case (MR_Integer) 27:
            {
              ...
              else
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
  ...
  MR_Word MaybeRegionRval_19)
{
  if ((MaybeRegionRval_19 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_12, (MR_Integer) 7)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7)));
