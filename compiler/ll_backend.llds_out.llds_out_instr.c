  ...
  MR_Word Instr_8)
{
  ...
  Var_22 = hlds__pred_proc_id__initial_proc_id_0_f_0();
  hlds__pred_proc_id__proc_id_to_int_2_p_0(Var_22, &InitialProcIdInt_12);
  {
  ...
  MR_String Comment_10)
{
  ...
  Var_24 = hlds__pred_proc_id__initial_proc_id_0_f_0();
  hlds__pred_proc_id__proc_id_to_int_2_p_0(Var_24, &InitialProcIdInt_14);
  {
