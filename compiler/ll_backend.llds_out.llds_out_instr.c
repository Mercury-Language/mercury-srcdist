                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      succeeded = (ActualType_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                      if (succeeded)
                      {
                    ...
                    case (MR_Integer) 8:
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) ActualType_106)) == (MR_mktag((MR_Integer) 2)));
                        if (succeeded)
                        {
                          Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(2), ActualType_106, (MR_Integer) 0)));
                    ...
                    case (MR_Integer) 9:
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) ActualType_107)) == (MR_mktag((MR_Integer) 2)));
                        if (succeeded)
                        {
                          Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(2), ActualType_107, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) " = ");
          ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_5, Rval_12, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
        }
        break;
      case (MR_Integer) 0:
            ...
            switch (MR_tag((MR_Word) BuiltinType_18)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(BuiltinType_18)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_5, Rval_12, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)));
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      ll_backend__llds_out__llds_out_data__output_llds_type_cast_3_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)));
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_5, Rval_12, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
                    }
                    break;
                  case (MR_Integer) 2:
          ...
          case (MR_Integer) 7:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_491, (MR_Word) MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_instr_scalar_common_4[0]));
              mercury__io__write_string_3_p_0((MR_String) ",\n\t\t");
          ...
          case (MR_Integer) 14:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_502, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
              mercury__io__write_string_3_p_0((MR_String) ");\n");
            }
            break;
          case (MR_Integer) 15:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_503, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)));
              mercury__io__write_string_3_p_0((MR_String) ");\n");
            }
            break;
          case (MR_Integer) 16:
          ...
          case (MR_Integer) 21:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_509, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
              mercury__io__write_string_3_p_0((MR_String) ", ");
          ...
          case (MR_Integer) 23:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_511, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
              mercury__io__write_string_3_p_0((MR_String) ");\n");
            }
            break;
          case (MR_Integer) 24:
...
{
  {
    ...
    ll_backend__llds_out__llds_out_data__output_lval_for_assign_5_p_0(Info_6, Lval_7, &Type_10);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
    }
    ...
    mercury__io__write_string_3_p_0((MR_String) ") = ");
    ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_6, Rval_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)));
    mercury__io__write_string_3_p_0((MR_String) ";\n");
        ...
        case (MR_Integer) 0:
          {
            ...
            ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_12, Rval_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)));
            mercury__io__write_string_3_p_0((MR_String) ")");
          }
          break;
        case (MR_Integer) 1:
...
{
  {
    ...
    ll_backend__llds_out__llds_out_data__output_rval_as_type_5_p_0(Info_5, FrameStartRval_11, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)));
  }
}
