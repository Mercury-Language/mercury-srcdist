      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          *Rval_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), RvalA_9, (MR_Integer) 2)));
          succeeded = (Var_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 13))));
          if (succeeded)
          {
            succeeded = ((((MR_tag((MR_Word) RvalB_11)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), RvalB_11, (MR_Integer) 0)))) == (MR_Integer) 2)));
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                succeeded = (Var_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 14))));
                if (succeeded)
                {
