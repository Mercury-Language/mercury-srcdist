  ...
  MR_String Comment_10)
{
  ...
  AutoComments_38 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 7))) >> 16)) & (MR_Integer) 1);
  switch (AutoComments_38) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
  ...
  MR_Word MaybeAllocId_8)
{
  ...
  else
  {
    ...
    MR_String MangledModuleName_21 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1))));
    MR_Word AllocSiteMap_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 6))));
    MR_Word AllocSiteSlotName_23;
    MR_Box conv0_AllocSiteSlotName_23;

    mercury__map__lookup_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_alloc_site_id_0), (MR_Word) (&ll_backend__layout__ll_backend__layout__type_ctor_info_layout_slot_name_0), AllocSiteMap_22, ((MR_Box) (AllocId_10)), &conv0_AllocSiteSlotName_23);
    AllocSiteSlotName_23 = ((MR_Word) (conv0_AllocSiteSlotName_23));
    ll_backend__layout_out__output_layout_slot_addr_6_p_0(Stream_7, (MR_Integer) 1, MangledModuleName_21, AllocSiteSlotName_23);
  }
}
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      {
        MR_Word Lval_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Locn_16, (MR_Integer) 0))));

        ll_backend__llds_out__llds_out_data__output_lval_5_p_0(Info_1, Stream_2, Lval_41);
      }
      else
      {
        MR_Integer Offset_42 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Locn_16, (MR_Integer) 1))));
        MR_Word Lval_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Locn_16, (MR_Integer) 0))));

        mercury__io__write_string_4_p_0(Stream_2, (MR_String) "offset ");
        mercury__io__write_int_4_p_0(Stream_2, Offset_42);
        mercury__io__write_string_4_p_0(Stream_2, (MR_String) " from ");
        ll_backend__llds_out__llds_out_data__output_lval_5_p_0(Info_1, Stream_2, Lval_50);
      }
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "\t");
