              ...
              case (MR_Integer) 1:
                {
                  ...
                  switch (Var_92) {
                    ...
                    case (MR_Integer) 6:
                      ...
                      break;
                    case (MR_Integer) 8:
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, Rval_14, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_instr_scalar_common_2[3])), Stream_7);
                      break;
                    case (MR_Integer) 2:
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, Rval_14, (MR_Word) ((MR_Unsigned) 20U), Stream_7);
                      break;
                    ...
                    case (MR_Integer) 7:
                      ...
                      break;
                    case (MR_Integer) 9:
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, Rval_14, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_instr_scalar_common_2[4])), Stream_7);
                      break;
                    case (MR_Integer) 3:
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, Rval_14, (MR_Word) ((MR_Unsigned) 20U), Stream_7);
                      break;
...
{
  {
    ...
    hlds__hlds_pred__proc_id_to_int_2_p_0(Var_22, &InitialProcIdInt_12);
    {
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_13, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), ProcLabel_13, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), ProcLabel_13, 2) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_2[0]));
...
{
  {
    ...
    hlds__hlds_pred__proc_id_to_int_2_p_0(Var_24, &InitialProcIdInt_14);
    {
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_15, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), ProcLabel_15, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), ProcLabel_15, 2) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_2[0]));
          ...
          case (MR_Integer) 7:
            {
              ...
              ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_7, Rval_491, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_instr_scalar_common_2[1])), Stream_8);
              mercury__io__write_string_4_p_0(Stream_8, (MR_String) ",\n\t\t");
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_168, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_3[0]));
        ...
        case (MR_Integer) 27:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_117, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_instr_scalar_common_3[1]));
