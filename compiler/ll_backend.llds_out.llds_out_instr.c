...
MR_decl_label10(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0, 45,7,9,11,23,6,13,14,5,47)
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_instr_module35)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0,45,7,9,11,23,6,13,14,5,47)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0_i47);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(1, MR_r2, 0);
...
MR_def_label(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0,23)
	...
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0_i45);
...
MR_def_label(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0,5)
	...
	MR_np_call_localret_ent(ll_backend__llds_out__llds_out_instr__output_foreign_proc_input_4_0,
		ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0_i23);
MR_def_label(ll_backend__llds_out__llds_out_instr__output_foreign_proc_inputs_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
