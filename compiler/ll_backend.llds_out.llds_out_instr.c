  ...
  MR_Word MaybeAllocId_8)
{
  ...
  else
  {
    ...
    MR_String MangledModuleName_15 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1))));
    MR_Word AllocSiteMap_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 6))));
