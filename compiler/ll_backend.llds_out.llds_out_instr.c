...
MR_decl_label10(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0, 34,4,6,8,9,10,11,12,13,14)
MR_decl_label4(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0, 17,18,19,36)
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_instr_module11)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0,34,4,6,8,9,10,11,12,13,14)
	MR_init_label4(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0,17,18,19,36)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0_i36);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tfield(1, MR_r2, 1);
	{
...
MR_def_label(ll_backend__llds_out__llds_out_instr__output_gc_livevals_2_4_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
