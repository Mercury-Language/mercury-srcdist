      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word STATE_VARIABLE_IntermodInfo_22_60;
            MR_Word STATE_VARIABLE_IntermodInfo_23_61;
            ...
            switch (Target_56) {
              ...
              case (MR_Integer) 0:
                if ((MaybeC0_52 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  STATE_VARIABLE_IntermodInfo_22_60 = STATE_VARIABLE_IntermodInfo_33_33;
                }
                else
                {
                  MR_Word Body_65;
                  MR_Word MaybeUserEqComp0_66;
                  MR_Word Assertions_67;
                  MR_Word MaybeUserEqComp_68;
                  MR_Word Var_69 = ((MR_Word) ((MR_hl_field(1, MaybeC0_52, (MR_Integer) 0))));
                  MR_Word Var_70;

                  Body_65 = ((MR_Word) ((MR_hl_field(0, Var_69, (MR_Integer) 0))));
                  MaybeUserEqComp0_66 = ((MR_Word) ((MR_hl_field(0, Var_69, (MR_Integer) 1))));
                  Assertions_67 = ((MR_Word) ((MR_hl_field(0, Var_69, (MR_Integer) 2))));
                  transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_8, TypeCtor_5, MaybeUserEqComp0_66, &MaybeUserEqComp_68, STATE_VARIABLE_IntermodInfo_33_33, &STATE_VARIABLE_IntermodInfo_22_60);
                  {
                    Var_70 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_70, 0) = ((MR_Box) (Body_65));
                    MR_hl_field(0, Var_70, 1) = ((MR_Box) (MaybeUserEqComp_68));
                    MR_hl_field(0, Var_70, 2) = ((MR_Box) (Assertions_67));
                  }
                  {
                    MaybeC_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, MaybeC_57, 0) = ((MR_Box) (Var_70));
                  }
                }
                break;
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 2:
                {
                  ...
                  STATE_VARIABLE_IntermodInfo_23_61 = STATE_VARIABLE_IntermodInfo_22_60;
                }
                break;
              case (MR_Integer) 1:
                ...
                {
                  MR_Word Body_71;
                  MR_Word MaybeUserEqComp0_72;
                  MR_Word Assertions_73;
                  MR_Word MaybeUserEqComp_74;
                  MR_Word Var_75 = ((MR_Word) ((MR_hl_field(1, MaybeCSharp0_54, (MR_Integer) 0))));
                  MR_Word Var_76;

                  Body_71 = ((MR_Word) ((MR_hl_field(0, Var_75, (MR_Integer) 0))));
                  MaybeUserEqComp0_72 = ((MR_Word) ((MR_hl_field(0, Var_75, (MR_Integer) 1))));
                  Assertions_73 = ((MR_Word) ((MR_hl_field(0, Var_75, (MR_Integer) 2))));
                  transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_8, TypeCtor_5, MaybeUserEqComp0_72, &MaybeUserEqComp_74, STATE_VARIABLE_IntermodInfo_22_60, &STATE_VARIABLE_IntermodInfo_23_61);
                  {
                    Var_76 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_76, 0) = ((MR_Box) (Body_71));
                    MR_hl_field(0, Var_76, 1) = ((MR_Box) (MaybeUserEqComp_74));
                    MR_hl_field(0, Var_76, 2) = ((MR_Box) (Assertions_73));
                  }
                  {
                    MaybeCSharp_58 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, MaybeCSharp_58, 0) = ((MR_Box) (Var_76));
                  }
                }
                break;
            }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  STATE_VARIABLE_IntermodInfo_34_34 = STATE_VARIABLE_IntermodInfo_23_61;
                }
                break;
              case (MR_Integer) 2:
                ...
                {
                  MR_Word Body_77;
                  MR_Word MaybeUserEqComp0_78;
                  MR_Word Assertions_79;
                  MR_Word MaybeUserEqComp_80;
                  MR_Word Var_81 = ((MR_Word) ((MR_hl_field(1, MaybeJava0_53, (MR_Integer) 0))));
                  MR_Word Var_82;

                  Body_77 = ((MR_Word) ((MR_hl_field(0, Var_81, (MR_Integer) 0))));
                  MaybeUserEqComp0_78 = ((MR_Word) ((MR_hl_field(0, Var_81, (MR_Integer) 1))));
                  Assertions_79 = ((MR_Word) ((MR_hl_field(0, Var_81, (MR_Integer) 2))));
                  transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_8, TypeCtor_5, MaybeUserEqComp0_78, &MaybeUserEqComp_80, STATE_VARIABLE_IntermodInfo_23_61, &STATE_VARIABLE_IntermodInfo_34_34);
                  {
                    Var_82 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_82, 0) = ((MR_Box) (Body_77));
                    MR_hl_field(0, Var_82, 1) = ((MR_Box) (MaybeUserEqComp_80));
                    MR_hl_field(0, Var_82, 2) = ((MR_Box) (Assertions_79));
                  }
                  {
                    MaybeJava_59 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, MaybeJava_59, 0) = ((MR_Box) (Var_82));
                  }
                }
                break;
            }
  ...
  MR_Word * STATE_VARIABLE_IntermodInfo_21)
{
  ...
  switch (Target_16) {
    ...
    case (MR_Integer) 0:
      ...
      {
        MR_Word Body_27;
        MR_Word MaybeUserEqComp0_28;
        MR_Word Assertions_29;
        MR_Word MaybeUserEqComp_30;
        MR_Word Var_31 = ((MR_Word) ((MR_hl_field(1, MaybeC0_12, (MR_Integer) 0))));
        MR_Word Var_32;

        Body_27 = ((MR_Word) ((MR_hl_field(0, Var_31, (MR_Integer) 0))));
        MaybeUserEqComp0_28 = ((MR_Word) ((MR_hl_field(0, Var_31, (MR_Integer) 1))));
        Assertions_29 = ((MR_Word) ((MR_hl_field(0, Var_31, (MR_Integer) 2))));
        transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_7, TypeCtor_8, MaybeUserEqComp0_28, &MaybeUserEqComp_30, STATE_VARIABLE_IntermodInfo_0_20, &STATE_VARIABLE_IntermodInfo_22_22);
        {
          Var_32 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_32, 0) = ((MR_Box) (Body_27));
          MR_hl_field(0, Var_32, 1) = ((MR_Box) (MaybeUserEqComp_30));
          MR_hl_field(0, Var_32, 2) = ((MR_Box) (Assertions_29));
        }
        {
          MaybeC_17 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeC_17, 0) = ((MR_Box) (Var_32));
        }
      }
      break;
    case (MR_Integer) 1:
  ...
  switch (Target_16) {
    ...
    case (MR_Integer) 1:
      ...
      {
        MR_Word Body_33;
        MR_Word MaybeUserEqComp0_34;
        MR_Word Assertions_35;
        MR_Word MaybeUserEqComp_36;
        MR_Word Var_37 = ((MR_Word) ((MR_hl_field(1, MaybeCSharp0_14, (MR_Integer) 0))));
        MR_Word Var_38;

        Body_33 = ((MR_Word) ((MR_hl_field(0, Var_37, (MR_Integer) 0))));
        MaybeUserEqComp0_34 = ((MR_Word) ((MR_hl_field(0, Var_37, (MR_Integer) 1))));
        Assertions_35 = ((MR_Word) ((MR_hl_field(0, Var_37, (MR_Integer) 2))));
        transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_7, TypeCtor_8, MaybeUserEqComp0_34, &MaybeUserEqComp_36, STATE_VARIABLE_IntermodInfo_22_22, &STATE_VARIABLE_IntermodInfo_23_23);
        {
          Var_38 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_38, 0) = ((MR_Box) (Body_33));
          MR_hl_field(0, Var_38, 1) = ((MR_Box) (MaybeUserEqComp_36));
          MR_hl_field(0, Var_38, 2) = ((MR_Box) (Assertions_35));
        }
        {
          MaybeCSharp_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeCSharp_18, 0) = ((MR_Box) (Var_38));
        }
      }
      break;
  }
  switch (Target_16) {
    ...
    case (MR_Integer) 2:
      ...
      {
        MR_Word Body_39;
        MR_Word MaybeUserEqComp0_40;
        MR_Word Assertions_41;
        MR_Word MaybeUserEqComp_42;
        MR_Word Var_43 = ((MR_Word) ((MR_hl_field(1, MaybeJava0_13, (MR_Integer) 0))));
        MR_Word Var_44;

        Body_39 = ((MR_Word) ((MR_hl_field(0, Var_43, (MR_Integer) 0))));
        MaybeUserEqComp0_40 = ((MR_Word) ((MR_hl_field(0, Var_43, (MR_Integer) 1))));
        Assertions_41 = ((MR_Word) ((MR_hl_field(0, Var_43, (MR_Integer) 2))));
        transform_hlds__intermod_decide__resolve_unify_compare_overloading_6_p_0(ModuleInfo_7, TypeCtor_8, MaybeUserEqComp0_40, &MaybeUserEqComp_42, STATE_VARIABLE_IntermodInfo_23_23, STATE_VARIABLE_IntermodInfo_21);
        {
          Var_44 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_44, 0) = ((MR_Box) (Body_39));
          MR_hl_field(0, Var_44, 1) = ((MR_Box) (MaybeUserEqComp_42));
          MR_hl_field(0, Var_44, 2) = ((MR_Box) (Assertions_41));
        }
        {
          MaybeJava_19 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeJava_19, 0) = ((MR_Box) (Var_44));
        }
      }
      break;
  }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word TypeCtorInfo_76_75;
          MR_Word TypeInfo_77_76;
          ...
          succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_7, Var_40, &Var_82, &Var_43, &FieldName_44);
          if (succeeded)
          {
            succeeded = (MethodUserArityInt_42 == Var_82);
            if (succeeded)
            {
              TypeCtorInfo_76_75 = (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0);
              TypeInfo_77_76 = (MR_Word) (&transform_hlds__intermod_decide_scalar_common_1[2]);
              succeeded = mercury__map__search_3_p_0(TypeCtorInfo_76_75, TypeInfo_77_76, CtorFieldTable_41, ((MR_Box) (FieldName_44)), &conv1_FieldDefns_45);
              if (succeeded)
              {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  Var_72 = mercury__string__f_43_43_2_f_0((MR_String) "unqualified type_ctor in ", (MR_String) "hlds_cons_defn or hlds_ctor_field_defn");
                  {
                    mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.intermod_decide.find_func_matching_instance_method\'/10", Var_72);
                    return;
                  }
                }
                succeeded = MR_TRUE;
