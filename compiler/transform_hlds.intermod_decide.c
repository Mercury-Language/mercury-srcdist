      ...
      case (MR_Integer) 1:
        {
          ...
          Var_66 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
          {
            ...
            MR_hl_field(3, ConsId_48, 0) = ((MR_Box) ((MR_Unsigned) 3U));
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = ((MR_tag((MR_Word) Functor_16)) == (MR_Integer) 1);
          if (succeeded)
          {
            ShroudedPredProcId_19 = (MR_Word) (MR_body((MR_Word) (Functor_16), (MR_Integer) 1));
            {
              MR_Word PredId_20;
              MR_Word Var_25;
