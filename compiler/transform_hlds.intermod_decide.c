...
transform_hlds__intermod_decide__IntroducedFrom__func__find_func_matching_instance_method__980__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv3_LambdaHeadVar__2_59 = transform_hlds__intermod_decide__IntroducedFrom__func__find_func_matching_instance_method__980__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_IntermodInfo_9)
{
...

  {
    ...
    else
    {
      ...
      {
        (env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_15, (MR_Integer) 3);
        if (!((env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded))
        ...
        else
        {
          ...
          if ((env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded)
          {
            ...
            (env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_15, Var_31);
          ...
          else
          {
            ...
            else
            {
              ...
              if ((env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded)
              {
                ...
                (env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_15, Var_35);
              }
              if ((env).transform_hlds__intermod_decide__intermod_add_pred_4_p_0_env_0__succeeded)
              {
                *MayOptExportPred_6 = (MR_Integer) 1;
  ...
  (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__PredId_7 = PredId_7;
  {
    ...
    if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
    {
      ...
      if (!((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded))
      {
        ...
        (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_21, (MR_Integer) 11);
        ...
        if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
        {
          ...
          (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_21, Var_25);
          (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = !((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded);
          if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
          {
            Var_26 = (MR_Integer) 0;
            (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_21, Var_26);
            (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = !((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded);
            if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
            {
              ...
              if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
              {
                ...
                if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
                {
                  ...
                  {
                    Var_27 = (MR_Integer) 8;
                    (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_21, Var_27);
                    (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = !((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded);
                    if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
                    {
                      Var_28 = (MR_Integer) 9;
                      (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_21, Var_28);
                      (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = !((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded);
                      if ((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded)
                      {
                            ...
                            {
                              {
                                ...
                                (env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_38, (MR_Integer) 24);
                              }
                              if (!((env).transform_hlds__intermod_decide__should_opt_export_pred_5_p_0_env_0__succeeded))
                              {
                                {
