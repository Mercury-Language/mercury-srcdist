  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_55 = transform_hlds__intermod_decide__IntroducedFrom__func__find_func_matching_instance_method__971__1_1_f_0(((MR_Word) (wrapper_arg_1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word TypeCtorInfo_77_74;
          MR_Word TypeInfo_78_75;
          ...
          succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_7, Var_40, &Var_81, &Var_43, &FieldName_44);
          if (succeeded)
          {
            succeeded = (MethodUserArityInt_42 == Var_81);
            if (succeeded)
            {
              TypeCtorInfo_77_74 = (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0);
              TypeInfo_78_75 = (MR_Word) (&transform_hlds__intermod_decide_scalar_common_1[2]);
              succeeded = mercury__map__search_3_p_0(TypeCtorInfo_77_74, TypeInfo_78_75, CtorFieldTable_41, ((MR_Box) (FieldName_44)), &conv1_FieldDefns_45);
              if (succeeded)
              {
          ...
          Var_66 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
          {
            ...
            MR_hl_field(0, DuCtor_48, 1) = ((MR_Box) (MethodUserArityInt_42));
