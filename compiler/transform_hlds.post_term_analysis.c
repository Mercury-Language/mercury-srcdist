...
MR_decl_label9(transform_hlds__post_term_analysis__run_post_term_analysis_3_0, 2,3,4,5,6,11,14,15,18)
...
MR_BEGIN_MODULE(transform_hlds__post_term_analysis_module0)
	...
	MR_init_label9(transform_hlds__post_term_analysis__run_post_term_analysis_3_0,2,3,4,5,6,11,14,15,18)
MR_BEGIN_CODE
...
void mercury__transform_hlds__post_term_analysis__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__post_term_analysis);
