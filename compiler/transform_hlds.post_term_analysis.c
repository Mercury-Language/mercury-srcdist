      ...
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) TypeBody_29)) {
            ...
            case (MR_Integer) 0:
              {
                ...
                MaybeCanonical_30 = ((MR_Word) ((MR_hl_field(0, Var_57, 2))));
              }
              break;
            case (MR_Integer) 1:
              {
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, TypeBody_29, 0))))) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word DetailsSolver_51 = ((MR_Word) ((MR_hl_field(3, TypeBody_29, 1))));

                    MaybeCanonical_30 = ((MR_Word) ((MR_hl_field(0, DetailsSolver_51, 1))));
                  }
                  break;
                case (MR_Integer) 1:
                  MaybeCanonical_30 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          else
          {
            ...
            MR_Word NeedsTermCheck_129;

            switch (MR_tag((MR_Word) NonCanonical_31)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                NeedsTermCheck_129 = (MR_Integer) 0;
                break;
              case (MR_Integer) 1:
                switch (SpecialPredId_10) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 2:
                    NeedsTermCheck_129 = (MR_Integer) 1;
                    break;
                  case (MR_Integer) 1:
                    NeedsTermCheck_129 = (MR_Integer) 0;
                    break;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    hlds__type_util__type_ctor_module_name_arity_4_p_0(TypeCtor_11, &TypeModule_58, &TypeName_59, &TypeArity_60);
                    switch (SpecialPredId_10) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 2:
                    ...
                    }
                    {
                      ...
                      MR_hl_field(1, Var_68, 0) = ((MR_Box) (TypeModule_58));
                      MR_hl_field(1, Var_68, 1) = ((MR_Box) (TypeName_59));
                    }
                    {
                      SNA_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(0, SNA_62, 0) = ((MR_Box) (Var_68));
                      MR_hl_field(0, SNA_62, 1) = ((MR_Box) (TypeArity_60));
                    }
                    Var_74 = mercury__string__f_43_43_2_f_0(SpecialPredStr_61, (MR_String) " predicate");
                    {
                      Var_73 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(2, Var_73, 0) = ((MR_Box) (Var_74));
                    }
                    {
                      Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_72, 0) = ((MR_Box) (Var_73));
                      MR_hl_field(1, Var_72, 1) = ((MR_Box) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[3])));
                    }
                    {
                      Var_69 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_69, 0) = ((MR_Box) (MR_mkword(3, &transform_hlds__post_term_analysis_scalar_common_1[1])));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(3, Var_83, 1) = ((MR_Box) (SNA_62));
                    }
                    {
                    ...
                    Var_86 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[5])));
                    Var_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_86, (MR_Word) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[6])));
                    ...
                    Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_69, Var_80);
                    {
                      Spec_65 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(0, Spec_65, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
                      MR_hl_field(0, Spec_65, 1) = ((MR_Box) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_2[0])));
                      MR_hl_field(0, Spec_65, 2) = ((MR_Box) ((MR_Unsigned) 92U));
                      MR_hl_field(0, Spec_65, 3) = ((MR_Box) (Context_27));
