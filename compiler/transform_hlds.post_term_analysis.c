...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 513, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 45, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 497, &TransIntermodOpt_12);
