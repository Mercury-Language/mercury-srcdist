...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Msg_16, 1) = ((MR_Box) (Var_40));
    }
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 439, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 42, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 352, &TransIntermodOpt_12);
