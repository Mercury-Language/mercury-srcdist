    ...
    switch (DefinedThisModule_17) {
      ...
      case (MR_Integer) 0:
        *STATE_VARIABLE_Specs_19 = STATE_VARIABLE_Specs_0_18;
        break;
      case (MR_Integer) 1:
        transform_hlds__post_term_analysis__process_special_pred_for_type_7_p_0(ModuleInfo_8, SpecialPredId_10, TypeCtor_11, TypeDefn_15, PredId_12, STATE_VARIABLE_Specs_0_18, STATE_VARIABLE_Specs_19);
        break;
    }
  }
}
...
{
  MR_bool succeeded;
  MR_Word NeedsTermCheck_14;
  MR_Word TypeBody_28;
  MR_Word MaybeCanonical_29;

  hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_11, &TypeBody_28);
  switch (MR_tag((MR_Word) TypeBody_28)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word Var_59 = (MR_Word) ((MR_Word) (TypeBody_28));

        MaybeCanonical_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_59, (MR_Integer) 2))));
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word ForeignTypeBody_55 = (MR_Word) (MR_body((MR_Word) (TypeBody_28), (MR_Integer) 1));
        MR_Word NonCanonical_56;

        succeeded = backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_3_p_0(ModuleInfo_8, ForeignTypeBody_55, &NonCanonical_56);
        if (succeeded)
          {
            MaybeCanonical_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeCanonical_29, 0) = ((MR_Box) (NonCanonical_56));
          }
        else
          MaybeCanonical_29 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
    case (MR_Integer) 2:
      MaybeCanonical_29 = (MR_Word) ((MR_Unsigned) 0U);
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_28, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word DetailsSolver_53 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeBody_28, (MR_Integer) 1))));

            MaybeCanonical_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsSolver_53, (MR_Integer) 1))));
          }
          break;
        case (MR_Integer) 1:
          MaybeCanonical_29 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  if ((MaybeCanonical_29 == (MR_Word) ((MR_Unsigned) 0U)))
    NeedsTermCheck_14 = (MR_Integer) 0;
  else
  {
    MR_Word NonCanonical_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCanonical_29, (MR_Integer) 0))));

    switch (MR_tag((MR_Word) NonCanonical_30)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        NeedsTermCheck_14 = (MR_Integer) 0;
        break;
      ...
      case (MR_Integer) 2:
        switch (SpecialPredId_9) {
          ...
          case (MR_Integer) 2:
            switch (MR_tag((MR_Word) NonCanonical_30)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                NeedsTermCheck_14 = (MR_Integer) 1;
                break;
              case (MR_Integer) 2:
                NeedsTermCheck_14 = (MR_Integer) 0;
                break;
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), NonCanonical_30, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            switch (SpecialPredId_9) {
              default: /*NOTREACHED*/ MR_assert(0);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_id_to_int_2_p_1(&ProcId_15, (MR_Integer) 0);
        hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_8, PredId_12, ProcId_15, &Var_16, &ProcInfo_17);
        hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_17, &BodyGoal0_18);
        BodyGoal_19 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(BodyGoal0_18);
        succeeded = hlds__goal_form__goal_cannot_loop_term_info_2_p_0(ModuleInfo_8, BodyGoal_19);
        if (succeeded)
          *STATE_VARIABLE_Specs_22 = STATE_VARIABLE_Specs_0_21;
        else
        {
          MR_Word Context_20;
          MR_Word TypeModule_66;
          MR_String TypeName_67;
          MR_Integer TypeArity_68;
          MR_String SpecialPredStr_69;
          MR_Word SNA_70;
          MR_Word Pieces_71;
          MR_Word Spec_72;
          MR_Word Var_75;
          ...
          hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_11, &Context_20);
          check_hlds__type_util__type_ctor_module_name_arity_4_p_0(TypeCtor_10, &TypeModule_66, &TypeName_67, &TypeArity_68);
          switch (SpecialPredId_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
              SpecialPredStr_69 = (MR_String) "comparison";
              break;
            case (MR_Integer) 1:
              {
              ...
              break;
            case (MR_Integer) 0:
              SpecialPredStr_69 = (MR_String) "equality";
              break;
          }
          {
            Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (TypeModule_66));
            MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (TypeName_67));
          }
          {
            SNA_70 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), SNA_70, 0) = ((MR_Box) (Var_75));
            MR_hl_field(MR_mktag(0), SNA_70, 1) = ((MR_Box) (TypeArity_68));
          }
          Var_80 = mercury__string__f_43_43_2_f_0(SpecialPredStr_69, (MR_String) " predicate");
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (SNA_70));
          }
          {
            Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (Var_86));
            MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[5])));
          }
          {
            Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[2])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_71, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[1])));
            MR_hl_field(MR_mktag(1), Pieces_71, 1) = ((MR_Box) (Var_78));
          }
          {
            Spec_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_72, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
            MR_hl_field(MR_mktag(1), Spec_72, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(1), Spec_72, 2) = ((MR_Box) ((MR_Unsigned) 88U));
            MR_hl_field(MR_mktag(1), Spec_72, 3) = ((MR_Box) (Context_20));
  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 514, &Termination_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 45, &WarnSpecialPreds_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 498, &TransIntermodOpt_12);
  ...
  if (succeeded)
  {
    ...
    mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_24, UnifyMap_15, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_STATE_VARIABLE_Specs_23_25);
    ...
    mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_27, CompareMap_17, ((MR_Box) (STATE_VARIABLE_Specs_23_25)), &conv3_Specs_4);
