          ...
          *transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_21 = transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_0_20;
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Spec_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 13))));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__post_term_analysis__Globals_8, (MR_Integer) 34, &transform_hlds__post_term_analysis__WarnSpecialPreds_11);
    }
    {
