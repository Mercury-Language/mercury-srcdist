      ...
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) TypeBody_29)) {
            ...
            case (MR_Integer) 0:
              {
                ...
                MaybeCanonical_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 2))));
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  {
                    ...
                    MR_hl_field(MR_mktag(1), MaybeCanonical_30, 0) = ((MR_Box) (NonCanonical_54));
                  }
                else
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_29, (MR_Integer) 0))))) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word DetailsSolver_51 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeBody_29, (MR_Integer) 1))));

                    MaybeCanonical_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsSolver_51, (MR_Integer) 1))));
                  }
                  break;
                case (MR_Integer) 1:
                  MaybeCanonical_30 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          if ((MaybeCanonical_30 == (MR_Word) ((MR_Unsigned) 0U)))
            NeedsTermCheck_21 = (MR_Integer) 0;
          else
          {
            ...
            switch (MR_tag((MR_Word) NonCanonical_31)) {
              ...
              case (MR_Integer) 2:
                switch (SpecialPredId_10) {
                  ...
                  case (MR_Integer) 2:
                    switch (MR_tag((MR_Word) NonCanonical_31)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 1:
                        NeedsTermCheck_21 = (MR_Integer) 1;
                        break;
                      case (MR_Integer) 2:
                        NeedsTermCheck_21 = (MR_Integer) 0;
                        break;
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), NonCanonical_31, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    switch (SpecialPredId_10) {
                      default: /*NOTREACHED*/ MR_assert(0);
            ...
            case (MR_Integer) 1:
              {
                ...
                succeeded = hlds__goal_form__goal_cannot_loop_2_p_0(ModuleInfo_8, BodyGoal_26);
                if (succeeded)
                  *STATE_VARIABLE_Specs_19 = STATE_VARIABLE_Specs_0_18;
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (TypeModule_58));
                    MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (TypeName_59));
                  }
                  {
                    SNA_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), SNA_62, 0) = ((MR_Box) (Var_67));
                    MR_hl_field(MR_mktag(0), SNA_62, 1) = ((MR_Box) (TypeArity_60));
                  }
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[5])));
                  }
                  {
                    Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[2])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[1])));
                    MR_hl_field(MR_mktag(1), Pieces_63, 1) = ((MR_Box) (Var_70));
                  }
                  {
                    Spec_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
                    MR_hl_field(MR_mktag(1), Spec_64, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(1), Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 88U));
                    MR_hl_field(MR_mktag(1), Spec_64, 3) = ((MR_Box) (Context_27));
