...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_16, 2) = ((MR_Box) ((MR_Unsigned) 84U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 509, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 43, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 493, &TransIntermodOpt_12);
