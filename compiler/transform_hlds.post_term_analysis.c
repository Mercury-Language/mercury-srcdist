      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            MR_Word NeedsTermCheck_128;

            switch (MR_tag((MR_Word) NonCanonical_31)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                NeedsTermCheck_128 = (MR_Integer) 0;
                break;
              case (MR_Integer) 1:
                switch (SpecialPredId_10) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 2:
                    NeedsTermCheck_128 = (MR_Integer) 1;
                    break;
                  case (MR_Integer) 1:
                    NeedsTermCheck_128 = (MR_Integer) 0;
                    break;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    Var_73 = mercury__string__f_43_43_2_f_0(SpecialPredStr_61, (MR_String) " predicate");
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(1, Var_71, 1) = ((MR_Box) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[3])));
                    }
                    {
                      Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_68, 0) = ((MR_Box) (MR_mkword(3, &transform_hlds__post_term_analysis_scalar_common_1[1])));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(3, Var_82, 1) = ((MR_Box) (SNA_62));
                    }
                    {
                    ...
                    Var_85 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[5])));
                    Var_84 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_85, (MR_Word) (MR_mkword(1, &transform_hlds__post_term_analysis_scalar_common_1[6])));
                    ...
                    Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_68, Var_79);
                    {
                      Spec_64 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(0, Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
                      MR_hl_field(0, Spec_64, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                      MR_hl_field(0, Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 92U));
                      MR_hl_field(0, Spec_64, 3) = ((MR_Box) (Context_27));
  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 413, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 172, &WarnSpecialPreds_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 405, &TransIntermodOpt_9);
