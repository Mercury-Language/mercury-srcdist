        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeBody_43)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word ForeignTypeBody_70 = (MR_Word) ((MR_Word) (TypeBody_43));
                ...
                break;
              case (MR_Integer) 1:
                MaybeCanonical_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 2))));
                break;
              case (MR_Integer) 2:
                MaybeCanonical_44 = (MR_Word) ((MR_Unsigned) 0U);
                break;
                        ...
                        case (MR_Integer) 2:
                          {
                            ...
                            MR_Word BodyGoal0_116;
                            MR_Word BodyGoal_117;
                            MR_Word Var_110;

                            hlds__hlds_pred__proc_id_to_int_2_p_1(&ProcId_113, (MR_Integer) 0);
                            hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_8, PredId_12, ProcId_113, &Var_110, &ProcInfo_115);
                            hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_115, &BodyGoal0_116);
                            BodyGoal_117 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(BodyGoal0_116);
                            succeeded = hlds__goal_form__goal_cannot_loop_2_p_0(ModuleInfo_8, BodyGoal_117);
                            if (succeeded)
                              *STATE_VARIABLE_Specs_19 = STATE_VARIABLE_Specs_0_18;
                            else
                            {
                              ...
                              hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_15, &Context_111);
                              transform_hlds__post_term_analysis__generate_non_term_user_special_warning_5_p_0(Context_111, SpecialPredId_10, TypeCtor_11, STATE_VARIABLE_Specs_0_18, STATE_VARIABLE_Specs_19);
                            }
                          }
                          break;
                        case (MR_Integer) 3:
