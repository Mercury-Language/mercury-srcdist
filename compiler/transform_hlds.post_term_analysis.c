...
MR_decl_label8(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0, 3,15,12,9,7,20,18,4)
MR_decl_label8(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0, 25,26,27,32,34,35,37,38)
MR_decl_label2(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0, 39,42)
MR_decl_label8(transform_hlds__post_term_analysis__run_post_term_analysis_3_0, 2,3,4,5,10,13,14,16)
...
MR_BEGIN_MODULE(transform_hlds__post_term_analysis_module0)
	...
	MR_init_label8(transform_hlds__post_term_analysis__run_post_term_analysis_3_0,2,3,4,5,10,13,14,16)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__post_term_analysis__run_post_term_analysis_3_0,5)
	...
	if (MR_INT_NE(MR_sv(2),1)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__run_post_term_analysis_3_0_i16);
	}
...
MR_def_label(transform_hlds__post_term_analysis__run_post_term_analysis_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_decl_entry(fn__backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_2_0);
...
MR_BEGIN_MODULE(transform_hlds__post_term_analysis_module1)
	...
	MR_init_label8(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,3,15,12,9,7,20,18,4)
	MR_init_label8(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,25,26,27,32,34,35,37,38)
	MR_init_label2(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,39,42)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,3)
	...
	if (MR_PTAG_TEST(MR_r1,3)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i9);
	}
	if (MR_PTAG_TEST(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i12);
	}
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i42);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_2_0,
		transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i15);
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i42);
	}
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,7)
	...
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i20);
	}
	...
	MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i4);
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,26)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_goal_2_0,
		transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i27);
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(hlds__goal_form__goal_cannot_loop_2_0,
		transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i32);
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i42);
	}
...
MR_def_label(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(2),2)) {
		MR_GOTO_LAB(transform_hlds__post_term_analysis__process_special_pred_for_type_7_0_i38);
	}
	MR_sv(2) = MR_r1;
...
void mercury__transform_hlds__post_term_analysis__write_out_proc_statics(FILE *fp);
#endif
