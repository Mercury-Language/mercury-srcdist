...
transform_hlds__post_term_analysis__process_special_pred_for_type_7_p_0(
  ...
  MR_Word transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_0_21,
  MR_Word * transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_22);
...
{
  {
    ...
    MR_Word transform_hlds__post_term_analysis__NeedsTermCheck_14;
    MR_Word transform_hlds__post_term_analysis__TypeBody_29;
    MR_Word transform_hlds__post_term_analysis__MaybeUnifyCompare_30;

    {
      hlds__hlds_data__get_type_defn_body_2_p_0(transform_hlds__post_term_analysis__TypeDefn_11, &transform_hlds__post_term_analysis__TypeBody_29);
    }
    switch (MR_tag((MR_Word) transform_hlds__post_term_analysis__TypeBody_29)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word transform_hlds__post_term_analysis__ForeignTypeBody_51 = (MR_Word) MR_body(((MR_Word) transform_hlds__post_term_analysis__TypeBody_29), (MR_Integer) 0);
          MR_Word transform_hlds__post_term_analysis__UnifyCompare_52;

          {
            transform_hlds__post_term_analysis__succeeded = backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_3_p_0(transform_hlds__post_term_analysis__ModuleInfo_8, transform_hlds__post_term_analysis__ForeignTypeBody_51, &transform_hlds__post_term_analysis__UnifyCompare_52);
          }
          if (transform_hlds__post_term_analysis__succeeded)
            {
              transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__MaybeUnifyCompare_30, 0) = ((MR_Box) (transform_hlds__post_term_analysis__UnifyCompare_52));
            }
          else
            transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word transform_hlds__post_term_analysis__V_42_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 0)));
          MR_Word transform_hlds__post_term_analysis__V_43_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 1)));
          MR_Word transform_hlds__post_term_analysis__V_44_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 2)));
          MR_Word transform_hlds__post_term_analysis__V_45_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 3)));
          MR_Word transform_hlds__post_term_analysis__V_46_46;
          MR_Word transform_hlds__post_term_analysis__V_47_47;
          MR_Word transform_hlds__post_term_analysis__V_48_48;
          MR_Word transform_hlds__post_term_analysis__V_49_49;

          transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 4)));
          transform_hlds__post_term_analysis__V_46_46 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 5)));
          transform_hlds__post_term_analysis__V_47_47 = ((((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 6)))) & (MR_Integer) 1);
          transform_hlds__post_term_analysis__V_48_48 = ((((((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 6)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          transform_hlds__post_term_analysis__V_49_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 7)));
        }
        break;
      case (MR_Integer) 2:
        transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word transform_hlds__post_term_analysis__V_50_50 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 1)));

              transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__TypeBody_29, (MR_Integer) 2)));
            }
            break;
          case (MR_Integer) 1:
            transform_hlds__post_term_analysis__MaybeUnifyCompare_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    ...
    if ((transform_hlds__post_term_analysis__MaybeUnifyCompare_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 0;
    else
      {
        MR_Word transform_hlds__post_term_analysis__UnifyCompare_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__MaybeUnifyCompare_30, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) transform_hlds__post_term_analysis__UnifyCompare_31)) == (MR_mktag((MR_Integer) 1))))
          {
            {
          ...
          {
            MR_Word transform_hlds__post_term_analysis__MaybeUnify_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__UnifyCompare_31, (MR_Integer) 0)));
            MR_Word transform_hlds__post_term_analysis__MaybeCompare_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__UnifyCompare_31, (MR_Integer) 1)));

            switch (transform_hlds__post_term_analysis__SpecialPredId_9) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 2:
                if ((transform_hlds__post_term_analysis__MaybeCompare_33 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 0;
                else
                  transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 1;
                break;
              case (MR_Integer) 1:
                transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 0;
                break;
              case (MR_Integer) 0:
                if ((transform_hlds__post_term_analysis__MaybeUnify_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 0;
                else
                  transform_hlds__post_term_analysis__NeedsTermCheck_14 = (MR_Integer) 1;
                break;
    ...
    switch (transform_hlds__post_term_analysis__NeedsTermCheck_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_22 = transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_0_21;
        break;
      case (MR_Integer) 1:
        {
          MR_Integer transform_hlds__post_term_analysis__ProcId_15;
          MR_Word transform_hlds__post_term_analysis__ProcInfo_17;
          MR_Word transform_hlds__post_term_analysis__BodyGoal0_18;
          MR_Word transform_hlds__post_term_analysis__BodyGoal_19;
          MR_Word transform_hlds__post_term_analysis__V_16_16;

          {
            hlds__hlds_pred__proc_id_to_int_2_p_1(&transform_hlds__post_term_analysis__ProcId_15, (MR_Integer) 0);
          }
          {
            hlds__hlds_module__module_info_pred_proc_info_5_p_0(transform_hlds__post_term_analysis__ModuleInfo_8, transform_hlds__post_term_analysis__PredId_12, transform_hlds__post_term_analysis__ProcId_15, &transform_hlds__post_term_analysis__V_16_16, &transform_hlds__post_term_analysis__ProcInfo_17);
          }
          {
            hlds__hlds_pred__proc_info_get_goal_2_p_0(transform_hlds__post_term_analysis__ProcInfo_17, &transform_hlds__post_term_analysis__BodyGoal0_18);
          }
          {
            transform_hlds__post_term_analysis__BodyGoal_19 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(transform_hlds__post_term_analysis__BodyGoal0_18);
          }
          {
            transform_hlds__post_term_analysis__succeeded = hlds__goal_form__goal_cannot_loop_2_p_0(transform_hlds__post_term_analysis__ModuleInfo_8, transform_hlds__post_term_analysis__BodyGoal_19);
          }
          if (transform_hlds__post_term_analysis__succeeded)
            *transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_22 = transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_0_21;
          else
            {
              MR_Word transform_hlds__post_term_analysis__Context_20;
              MR_Word transform_hlds__post_term_analysis__TypeModule_61;
              MR_String transform_hlds__post_term_analysis__TypeName_62;
              MR_Integer transform_hlds__post_term_analysis__TypeArity_63;
              MR_String transform_hlds__post_term_analysis__SpecialPredStr_64;
              MR_Word transform_hlds__post_term_analysis__SNA_65;
              MR_Word transform_hlds__post_term_analysis__Pieces_66;
              MR_Word transform_hlds__post_term_analysis__Msg_67;
              MR_Word transform_hlds__post_term_analysis__Spec_68;
              MR_Word transform_hlds__post_term_analysis__V_72_72;
              MR_Word transform_hlds__post_term_analysis__V_75_75;
              MR_Word transform_hlds__post_term_analysis__V_76_76;
              MR_String transform_hlds__post_term_analysis__V_77_77;
              MR_Word transform_hlds__post_term_analysis__V_79_79;
              MR_Word transform_hlds__post_term_analysis__V_82_82;
              MR_Word transform_hlds__post_term_analysis__V_83_83;
              MR_Word transform_hlds__post_term_analysis__V_88_88;
              MR_Word transform_hlds__post_term_analysis__V_89_89;
              MR_Word transform_hlds__post_term_analysis__V_93_93;

              {
                hlds__hlds_data__get_type_defn_context_2_p_0(transform_hlds__post_term_analysis__TypeDefn_11, &transform_hlds__post_term_analysis__Context_20);
              }
              {
                check_hlds__type_util__type_ctor_module_name_arity_4_p_0(transform_hlds__post_term_analysis__TypeCtor_10, &transform_hlds__post_term_analysis__TypeModule_61, &transform_hlds__post_term_analysis__TypeName_62, &transform_hlds__post_term_analysis__TypeArity_63);
              }
              switch (transform_hlds__post_term_analysis__SpecialPredId_9) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 2:
                  transform_hlds__post_term_analysis__SpecialPredStr_64 = (MR_String) "comparison";
                  break;
                case (MR_Integer) 1:
                  {
                    {
                  ...
                  break;
                case (MR_Integer) 0:
                  transform_hlds__post_term_analysis__SpecialPredStr_64 = (MR_String) "equality";
                  break;
              }
              {
                transform_hlds__post_term_analysis__V_72_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_72_72, 0) = ((MR_Box) (transform_hlds__post_term_analysis__TypeModule_61));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_72_72, 1) = ((MR_Box) (transform_hlds__post_term_analysis__TypeName_62));
              }
              {
                transform_hlds__post_term_analysis__SNA_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__SNA_65, 0) = ((MR_Box) (transform_hlds__post_term_analysis__V_72_72));
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__SNA_65, 1) = ((MR_Box) (transform_hlds__post_term_analysis__TypeArity_63));
              }
              {
                transform_hlds__post_term_analysis__V_77_77 = mercury__string__f_43_43_2_f_0(transform_hlds__post_term_analysis__SpecialPredStr_64, (MR_String) " predicate");
              }
              {
                transform_hlds__post_term_analysis__V_76_76 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), transform_hlds__post_term_analysis__V_76_76, 0) = ((MR_Box) (transform_hlds__post_term_analysis__V_77_77));
              }
              {
                transform_hlds__post_term_analysis__V_83_83 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__V_83_83, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
                MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__V_83_83, 1) = ((MR_Box) (transform_hlds__post_term_analysis__SNA_65));
              }
              {
                transform_hlds__post_term_analysis__V_82_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_82_82, 0) = ((MR_Box) (transform_hlds__post_term_analysis__V_83_83));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_82_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[4])));
              }
              {
                transform_hlds__post_term_analysis__V_79_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_79_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[2])));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_79_79, 1) = ((MR_Box) (transform_hlds__post_term_analysis__V_82_82));
              }
              {
                transform_hlds__post_term_analysis__V_75_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_75_75, 0) = ((MR_Box) (transform_hlds__post_term_analysis__V_76_76));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_75_75, 1) = ((MR_Box) (transform_hlds__post_term_analysis__V_79_79));
              }
              {
                transform_hlds__post_term_analysis__Pieces_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__Pieces_66, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[1])));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__Pieces_66, 1) = ((MR_Box) (transform_hlds__post_term_analysis__V_75_75));
              }
              {
                transform_hlds__post_term_analysis__V_89_89 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__V_89_89, 0) = ((MR_Box) (transform_hlds__post_term_analysis__Pieces_66));
              }
              {
                transform_hlds__post_term_analysis__V_88_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_88_88, 0) = ((MR_Box) (transform_hlds__post_term_analysis__V_89_89));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_88_88, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                transform_hlds__post_term_analysis__Msg_67 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Msg_67, 0) = ((MR_Box) (transform_hlds__post_term_analysis__Context_20));
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Msg_67, 1) = ((MR_Box) (transform_hlds__post_term_analysis__V_88_88));
              }
              {
                transform_hlds__post_term_analysis__V_93_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_93_93, 0) = ((MR_Box) (transform_hlds__post_term_analysis__Msg_67));
                MR_hl_field(MR_mktag(1), transform_hlds__post_term_analysis__V_93_93, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                transform_hlds__post_term_analysis__Spec_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Spec_68, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Spec_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 14))));
                MR_hl_field(MR_mktag(0), transform_hlds__post_term_analysis__Spec_68, 2) = ((MR_Box) (transform_hlds__post_term_analysis__V_93_93));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_22 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (transform_hlds__post_term_analysis__Spec_68));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (transform_hlds__post_term_analysis__STATE_VARIABLE_Specs_0_21));
              }
            }
        }
        break;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__post_term_analysis__Globals_8, (MR_Integer) 416, &transform_hlds__post_term_analysis__Termination_10);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__post_term_analysis__Globals_8, (MR_Integer) 38, &transform_hlds__post_term_analysis__WarnSpecialPreds_11);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__post_term_analysis__Globals_8, (MR_Integer) 332, &transform_hlds__post_term_analysis__TransIntermodOpt_12);
    }
            ...
            if (transform_hlds__post_term_analysis__succeeded)
              {
                ...
                if (transform_hlds__post_term_analysis__succeeded)
                  {
                    transform_hlds__post_term_analysis__V_22_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__post_term_analysis__OpMode_9, (MR_Integer) 0)));
