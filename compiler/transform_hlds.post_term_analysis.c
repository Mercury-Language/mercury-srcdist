        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeBody_43)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word ForeignTypeBody_66 = (MR_Word) MR_body(((MR_Word) TypeBody_43), (MR_Integer) 0);
                  MR_Word UnifyCompare_67;

                  succeeded = backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_3_p_0(ModuleInfo_8, ForeignTypeBody_66, &UnifyCompare_67);
                  if (succeeded)
                    {
                      MaybeUnifyCompare_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), MaybeUnifyCompare_44, 0) = ((MR_Box) (UnifyCompare_67));
                    }
                  else
                    MaybeUnifyCompare_44 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 0)));
                  MR_Word Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 1)));
                  MR_Word Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 2)));
                  MR_Word Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 3)));
                  MR_Word Var_60;
                  MR_Word Var_61;
                  MR_Word Var_62;
                  MR_Word Var_63;

                  MaybeUnifyCompare_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 4)));
                  Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 5)));
                  Var_61 = ((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 6)))) & (MR_Integer) 1);
                  Var_62 = ((((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 6)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
                  Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 7)));
                }
                break;
              case (MR_Integer) 2:
                MaybeUnifyCompare_44 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_43, (MR_Integer) 0)))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word DetailsSolver_64 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_43, (MR_Integer) 1)));
                      MR_Word Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver_64, (MR_Integer) 0)));

                      MaybeUnifyCompare_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver_64, (MR_Integer) 1)));
                    }
                    break;
                  case (MR_Integer) 1:
                    MaybeUnifyCompare_44 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            ...
            if ((MaybeUnifyCompare_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              NeedsTermCheck_30 = (MR_Integer) 0;
            else
            {
              MR_Word UnifyCompare_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeUnifyCompare_44, (MR_Integer) 0)));

              if (((MR_tag((MR_Word) UnifyCompare_45)) == (MR_mktag((MR_Integer) 1))))
              {
                {
              ...
              {
                MR_Word MaybeUnify_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnifyCompare_45, (MR_Integer) 0)));
                MR_Word MaybeCompare_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnifyCompare_45, (MR_Integer) 1)));

                switch (SpecialPredId_10) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 2:
                    if ((MaybeCompare_47 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      NeedsTermCheck_30 = (MR_Integer) 0;
                    else
                  ...
                  case (MR_Integer) 1:
                    ...
                    break;
                  case (MR_Integer) 0:
                    if ((MaybeUnify_46 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      NeedsTermCheck_30 = (MR_Integer) 0;
                    else
                      NeedsTermCheck_30 = (MR_Integer) 1;
                    break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 423, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 40, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 336, &TransIntermodOpt_12);
