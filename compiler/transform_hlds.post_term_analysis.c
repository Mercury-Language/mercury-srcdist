        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeBody_43)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word Var_74 = (MR_Word) ((MR_Word) (TypeBody_43));

                  MaybeCanonical_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_74, (MR_Integer) 2))));
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word ForeignTypeBody_70 = (MR_Word) (MR_body((MR_Word) (TypeBody_43), (MR_Integer) 1));
                  MR_Word NonCanonical_71;

                  succeeded = backend_libs__foreign__foreign_type_body_has_user_defined_eq_comp_pred_3_p_0(ModuleInfo_8, ForeignTypeBody_70, &NonCanonical_71);
                  if (succeeded)
                    {
                      MaybeCanonical_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), MaybeCanonical_44, 0) = ((MR_Box) (NonCanonical_71));
                    }
                  else
                    MaybeCanonical_44 = (MR_Word) ((MR_Unsigned) 0U);
                }
                break;
              case (MR_Integer) 2:
                MaybeCanonical_44 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_43, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      MR_Word DetailsSolver_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeBody_43, (MR_Integer) 1))));

                      MaybeCanonical_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsSolver_68, (MR_Integer) 1))));
                    }
                    break;
                  case (MR_Integer) 1:
                    MaybeCanonical_44 = (MR_Word) ((MR_Unsigned) 0U);
            ...
            else
            {
              ...
              switch (MR_tag((MR_Word) NonCanonical_45)) {
                ...
                case (MR_Integer) 2:
                  switch (SpecialPredId_10) {
                    ...
                    case (MR_Integer) 0:
                      switch (MR_tag((MR_Word) NonCanonical_45)) {
                        ...
                        case (MR_Integer) 2:
                          {
                            MR_Integer ProcId_114;
                            MR_Word ProcInfo_116;
                            MR_Word BodyGoal0_117;
                            MR_Word BodyGoal_118;
                            MR_Word Var_111;

                            hlds__hlds_pred__proc_id_to_int_2_p_1(&ProcId_114, (MR_Integer) 0);
                            hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_8, PredId_12, ProcId_114, &Var_111, &ProcInfo_116);
                            hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_116, &BodyGoal0_117);
                            BodyGoal_118 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(BodyGoal0_117);
                            succeeded = hlds__goal_form__goal_cannot_loop_2_p_0(ModuleInfo_8, BodyGoal_118);
                            if (succeeded)
                              *STATE_VARIABLE_Specs_19 = STATE_VARIABLE_Specs_0_18;
                            else
                            {
                              ...
                              hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_15, &Context_112);
                              transform_hlds__post_term_analysis__generate_non_term_user_special_warning_5_p_0(Context_112, SpecialPredId_10, TypeCtor_11, STATE_VARIABLE_Specs_0_18, STATE_VARIABLE_Specs_19);
                            }
                          }
                          break;
                        case (MR_Integer) 3:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), NonCanonical_45, (MR_Integer) 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      switch (SpecialPredId_10) {
                        default: /*NOTREACHED*/ MR_assert(0);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (TypeModule_10));
      MR_hl_field(MR_mktag(1), Var_21, 1) = ((MR_Box) (TypeName_11));
    }
    {
      SNA_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SNA_14, 0) = ((MR_Box) (Var_21));
      MR_hl_field(MR_mktag(0), SNA_14, 1) = ((MR_Box) (TypeArity_12));
    }
    Var_26 = mercury__string__f_43_43_2_f_0(SpecialPredStr_13, (MR_String) " predicate");
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_32, 1) = ((MR_Box) (SNA_14));
    }
    {
      Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Var_32));
      MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[5])));
    }
    {
      Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[2])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_15, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[1])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_16, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
      MR_hl_field(MR_mktag(1), Spec_16, 1) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(1), Spec_16, 2) = ((MR_Box) ((MR_Unsigned) 88U));
      MR_hl_field(MR_mktag(1), Spec_16, 3) = ((MR_Box) (Context_6));
