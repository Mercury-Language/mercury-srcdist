...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_24, UnifyMap_15, ((MR_Box) (STATE_VARIABLE_Specs_19_21)), &conv1_STATE_VARIABLE_Specs_23_25);
