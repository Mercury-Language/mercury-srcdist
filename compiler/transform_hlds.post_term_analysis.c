...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__post_term_analysis__Globals_8, (MR_Integer) 409, &transform_hlds__post_term_analysis__Termination_10);
    }
    {
