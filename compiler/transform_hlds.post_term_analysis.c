        ...
        case (MR_Integer) 1:
          {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                    ...
                    MaybeCanonical_44 = (MR_Word) ((MR_Integer) 0);
                }
                break;
              case (MR_Integer) 1:
            ...
            if ((MaybeCanonical_44 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_17, 0) = ((MR_Box) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(0), Spec_17, 1) = ((MR_Box) ((MR_Integer) 56));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 428, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 41, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 341, &TransIntermodOpt_12);
    ...
    if (succeeded)
    {
      ...
      mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_24, UnifyMap_15, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_Specs_23_25);
