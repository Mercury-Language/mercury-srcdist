        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeBody_43)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word ForeignTypeBody_69 = (MR_Word) ((MR_Word) (TypeBody_43));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (TypeModule_10));
      MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (TypeName_11));
    }
    {
      SNA_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SNA_14, 0) = ((MR_Box) (Var_22));
      MR_hl_field(MR_mktag(0), SNA_14, 1) = ((MR_Box) (TypeArity_12));
    }
    Var_27 = mercury__string__f_43_43_2_f_0(SpecialPredStr_13, (MR_String) " predicate");
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_33, 1) = ((MR_Box) (SNA_14));
    }
    {
      Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (Var_33));
      MR_hl_field(MR_mktag(1), Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[3])));
    }
    {
      Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[5])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_16, 0) = ((MR_Box) (Context_6));
      MR_hl_field(MR_mktag(1), Msg_16, 1) = ((MR_Box) (Var_40));
    }
    {
      Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (Msg_16));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_17, 1) = ((MR_Box) ((MR_Unsigned) 56U));
      MR_hl_field(MR_mktag(0), Spec_17, 2) = ((MR_Box) (Var_45));
    }
    {
      MR_Word base;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 443, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 43, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 356, &TransIntermodOpt_12);
