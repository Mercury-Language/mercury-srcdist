  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 541, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 46, &WarnSpecialPreds_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 525, &TransIntermodOpt_9);
