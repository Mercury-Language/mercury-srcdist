            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 88U));
  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 518, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 45, &WarnSpecialPreds_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 502, &TransIntermodOpt_9);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_19 = ((MR_Word) ((MR_hl_field(3, OpMode_6, (MR_Integer) 0))));
          succeeded = ((MR_tag((MR_Word) Var_19)) == (MR_Integer) 2);
          if (succeeded)
          {
            Var_20 = ((MR_Word) ((MR_hl_field(2, Var_19, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    UnifyMap_12 = ((MR_Word) ((MR_hl_field(0, SpecialPredMaps_11, (MR_Integer) 0))));
    CompareMap_14 = ((MR_Word) ((MR_hl_field(0, SpecialPredMaps_11, (MR_Integer) 2))));
    {
      Var_21 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_21, 0) = ((MR_Box) (&transform_hlds__post_term_analysis_scalar_common_2[0]));
      MR_hl_field(0, Var_21, 1) = ((MR_Box) (transform_hlds__post_term_analysis__run_post_term_analysis_2_p_0_1));
      MR_hl_field(0, Var_21, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(0, Var_21, 3) = ((MR_Box) (ModuleInfo_3));
      MR_hl_field(0, Var_21, 4) = ((MR_Box) (TypeTable_10));
      MR_hl_field(0, Var_21, 5) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    STATE_VARIABLE_Specs_23_22 = ((MR_Word) (conv1_STATE_VARIABLE_Specs_23_22));
    {
      ...
      MR_hl_field(0, Var_24, 0) = ((MR_Box) (&transform_hlds__post_term_analysis_scalar_common_2[0]));
      MR_hl_field(0, Var_24, 1) = ((MR_Box) (transform_hlds__post_term_analysis__run_post_term_analysis_2_p_0_2));
      MR_hl_field(0, Var_24, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(0, Var_24, 3) = ((MR_Box) (ModuleInfo_3));
      MR_hl_field(0, Var_24, 4) = ((MR_Box) (TypeTable_10));
      MR_hl_field(0, Var_24, 5) = ((MR_Box) ((MR_Integer) 2));
    }
