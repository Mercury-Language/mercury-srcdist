...
static /* final */ const MR_Box transform_hlds__post_term_analysis_scalar_common_1[6][2] = {
  ...
  /* row   5 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[4]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[3])))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  else
  {
    ...
    switch (DefinedThisModule_17) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word NeedsTermCheck_22;
          MR_Word TypeBody_30;
          MR_Word MaybeCanonical_31;

          hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_15, &TypeBody_30);
          switch (MR_tag((MR_Word) TypeBody_30)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word Var_58 = (MR_Word) ((MR_Word) (TypeBody_30));

                MaybeCanonical_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_58, (MR_Integer) 2))));
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ForeignTypeBody_54 = (MR_Word) (MR_body((MR_Word) (TypeBody_30), (MR_Integer) 1));
                ...
                if (succeeded)
                  {
                    MaybeCanonical_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), MaybeCanonical_31, 0) = ((MR_Box) (NonCanonical_55));
                  }
                else
                  MaybeCanonical_31 = (MR_Word) ((MR_Unsigned) 0U);
              }
              break;
            case (MR_Integer) 2:
              MaybeCanonical_31 = (MR_Word) ((MR_Unsigned) 0U);
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_30, (MR_Integer) 0))))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Word DetailsSolver_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeBody_30, (MR_Integer) 1))));

                    MaybeCanonical_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsSolver_52, (MR_Integer) 1))));
                  }
                  break;
                case (MR_Integer) 1:
                  MaybeCanonical_31 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          if ((MaybeCanonical_31 == (MR_Word) ((MR_Unsigned) 0U)))
            NeedsTermCheck_22 = (MR_Integer) 0;
          else
          {
            MR_Word NonCanonical_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCanonical_31, (MR_Integer) 0))));

            switch (MR_tag((MR_Word) NonCanonical_32)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                NeedsTermCheck_22 = (MR_Integer) 0;
                break;
              ...
              case (MR_Integer) 2:
                switch (SpecialPredId_10) {
                  ...
                  case (MR_Integer) 2:
                    switch (MR_tag((MR_Word) NonCanonical_32)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 1:
                        NeedsTermCheck_22 = (MR_Integer) 1;
                        break;
                      case (MR_Integer) 2:
                        NeedsTermCheck_22 = (MR_Integer) 0;
                        break;
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), NonCanonical_32, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    switch (SpecialPredId_10) {
                      default: /*NOTREACHED*/ MR_assert(0);
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word ProcInfo_25;
                MR_Word BodyGoal0_26;
                MR_Word BodyGoal_27;
                MR_Word Var_24;

                hlds__hlds_pred__proc_id_to_int_2_p_1(&ProcId_23, (MR_Integer) 0);
                hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_8, PredId_12, ProcId_23, &Var_24, &ProcInfo_25);
                hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_25, &BodyGoal0_26);
                BodyGoal_27 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(BodyGoal0_26);
                succeeded = hlds__goal_form__goal_cannot_loop_2_p_0(ModuleInfo_8, BodyGoal_27);
                if (succeeded)
                  *STATE_VARIABLE_Specs_19 = STATE_VARIABLE_Specs_0_18;
                else
                {
                  ...
                  hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_15, &Context_28);
                  check_hlds__type_util__type_ctor_module_name_arity_4_p_0(TypeCtor_11, &TypeModule_59, &TypeName_60, &TypeArity_61);
                  switch (SpecialPredId_10) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 2:
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (TypeModule_59));
                    MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (TypeName_60));
                  }
                  {
                    SNA_63 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), SNA_63, 0) = ((MR_Box) (Var_68));
                    MR_hl_field(MR_mktag(0), SNA_63, 1) = ((MR_Box) (TypeArity_61));
                  }
                  Var_73 = mercury__string__f_43_43_2_f_0(SpecialPredStr_62, (MR_String) " predicate");
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__post_term_analysis_scalar_common_1[5])));
                  }
                  {
                    Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[2])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__post_term_analysis_scalar_common_1[1])));
                    MR_hl_field(MR_mktag(1), Pieces_64, 1) = ((MR_Box) (Var_71));
                  }
                  {
                    Spec_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Spec_65, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.post_term_analysis.generate_non_term_user_special_warning\'/5"));
                    MR_hl_field(MR_mktag(1), Spec_65, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(1), Spec_65, 2) = ((MR_Box) ((MR_Unsigned) 88U));
                    MR_hl_field(MR_mktag(1), Spec_65, 3) = ((MR_Box) (Context_28));
  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 512, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 45, &WarnSpecialPreds_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 496, &TransIntermodOpt_9);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), OpMode_6, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    MR_Word SpecialPredMaps_11;
    MR_Word UnifyMap_12;
    MR_Word CompareMap_14;
    MR_Word Var_21;
    MR_Word STATE_VARIABLE_Specs_23_22;
    MR_Word Var_24;
    MR_Box conv1_STATE_VARIABLE_Specs_23_22;
    MR_Box conv3_Specs_4;

    hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_3, &TypeTable_10);
    hlds__hlds_module__module_info_get_special_pred_maps_2_p_0(ModuleInfo_3, &SpecialPredMaps_11);
    UnifyMap_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps_11, (MR_Integer) 0))));
    CompareMap_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps_11, (MR_Integer) 2))));
    {
      Var_21 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&transform_hlds__post_term_analysis_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (transform_hlds__post_term_analysis__run_post_term_analysis_2_p_0_1));
      MR_hl_field(MR_mktag(0), Var_21, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_21, 3) = ((MR_Box) (ModuleInfo_3));
      MR_hl_field(MR_mktag(0), Var_21, 4) = ((MR_Box) (TypeTable_10));
      MR_hl_field(MR_mktag(0), Var_21, 5) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_21, UnifyMap_12, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_STATE_VARIABLE_Specs_23_22);
    STATE_VARIABLE_Specs_23_22 = ((MR_Word) (conv1_STATE_VARIABLE_Specs_23_22));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (transform_hlds__post_term_analysis__run_post_term_analysis_2_p_0_2));
      MR_hl_field(MR_mktag(0), Var_24, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_24, 3) = ((MR_Box) (ModuleInfo_3));
      MR_hl_field(MR_mktag(0), Var_24, 4) = ((MR_Box) (TypeTable_10));
      MR_hl_field(MR_mktag(0), Var_24, 5) = ((MR_Box) ((MR_Integer) 2));
    }
    mercury__map__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__post_term_analysis_scalar_common_1[0]), Var_24, CompareMap_14, ((MR_Box) (STATE_VARIABLE_Specs_23_22)), &conv3_Specs_4);
