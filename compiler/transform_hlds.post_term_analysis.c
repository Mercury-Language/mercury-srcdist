      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_71, 2) = ((MR_Box) ((MR_Unsigned) 60U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 446, &Termination_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 44, &WarnSpecialPreds_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 359, &TransIntermodOpt_12);
