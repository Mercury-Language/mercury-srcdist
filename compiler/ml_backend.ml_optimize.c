        ...
        if (ml_backend__ml_optimize__succeeded)
          {
            ...
            ml_backend__ml_optimize__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_optimize__V_54_54)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__V_54_54, (MR_Integer) 0)))) == (MR_Integer) 8)));
            if (ml_backend__ml_optimize__succeeded)
              {
