                            ...
                            if (!(ml_backend__ml_optimize__succeeded))
                              {
                                ...
                                {
                                  ml_backend__ml_optimize__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_optimize__Globals_22, (MR_Integer) 166, (MR_Integer) 1);
                                }
                                if (ml_backend__ml_optimize__succeeded)
                                  {
                                    ml_backend__ml_optimize__V_33_33 = (MR_Integer) 167;
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_60, (MR_Integer) 452, &ml_backend__ml_optimize__OptInit_61);
          }
