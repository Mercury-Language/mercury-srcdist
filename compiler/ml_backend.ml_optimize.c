...
struct ml_backend__ml_optimize__optimize_func_3_p_0_env_0_s {
  ...
  MR_Word ml_backend__ml_optimize__optimize_func_3_p_0_env_0__CalleeCodeAddr_74;
  MR_Word ml_backend__ml_optimize__optimize_func_3_p_0_env_0__V_75_75;
};
...
static MR_bool MR_CALL 
ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__928__1_5_p_0(
...
static MR_bool MR_CALL 
ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__926__1_2_p_0(
...
static MR_bool MR_CALL 
ml_backend__ml_optimize__rval_is_cheap_enough_to_duplicate_1_p_0(
  MR_Word ml_backend__ml_optimize__Rval_2);
...
{
  {
    ...
    if ((ml_backend__ml_optimize__Body0_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        *ml_backend__ml_optimize__Body_6 = ml_backend__ml_optimize__Body0_5;
        *ml_backend__ml_optimize__STATE_VARIABLE_VarElimInfo_11 = ml_backend__ml_optimize__STATE_VARIABLE_VarElimInfo_0_10;
      }
    else
      {
        MR_Word ml_backend__ml_optimize__Stmt0_8 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_optimize__Body0_5), (MR_Integer) 1);
        MR_Word ml_backend__ml_optimize__Stmt_9;

        {
          ml_backend__ml_optimize__eliminate_var_in_statement_4_p_0(ml_backend__ml_optimize__Stmt0_8, &ml_backend__ml_optimize__Stmt_9, ml_backend__ml_optimize__STATE_VARIABLE_VarElimInfo_0_10, ml_backend__ml_optimize__STATE_VARIABLE_VarElimInfo_11);
        }
        *ml_backend__ml_optimize__Body_6 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_optimize__Stmt_9);
      }
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) ml_backend__ml_optimize__Rval_2)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ml_backend__ml_optimize__Lval_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_optimize__Rval_2, (MR_Integer) 0)));
          MR_Word ml_backend__ml_optimize__V_27_27;
          MR_Word ml_backend__ml_optimize__V_28_28;

          ml_backend__ml_optimize__succeeded = ((MR_tag((MR_Word) ml_backend__ml_optimize__Lval_9)) == (MR_mktag((MR_Integer) 3)));
          if (ml_backend__ml_optimize__succeeded)
            {
              ml_backend__ml_optimize__V_27_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__Lval_9, (MR_Integer) 0)));
              ml_backend__ml_optimize__V_28_28 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__Lval_9, (MR_Integer) 1)));
            }
        }
        break;
      case (MR_Integer) 3:
                            ...
                            if (!(ml_backend__ml_optimize__succeeded))
                              {
                                ...
                                {
                                  ml_backend__ml_optimize__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_optimize__Globals_22, (MR_Integer) 172, (MR_Integer) 1);
                                }
                                if (ml_backend__ml_optimize__succeeded)
                                  {
                                    ml_backend__ml_optimize__V_33_33 = (MR_Integer) 173;
                                ...
                                if (ml_backend__ml_optimize__succeeded)
                                  {
                                    ...
                                    if (!(ml_backend__ml_optimize__succeeded))
                                      {
                                        ml_backend__ml_optimize__succeeded = ml_backend__ml_optimize__rval_is_cheap_enough_to_duplicate_1_p_0(ml_backend__ml_optimize__Rval_21);
                                      }
                                  }
                              }
                          }
...
{
  {
    ...
    {
      ml_backend__ml_optimize__succeeded = ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__926__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_optimize__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_optimize__wrapper_arg_1));
    }
    return ml_backend__ml_optimize__succeeded;
  }
}
                ...
                if ((ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded)
                  {
                    ...
                    if ((ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded)
                      {
                        (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__V_75_75 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__CalleeRval_68, (MR_Integer) 1)));
                        {
                          (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded = ((((MR_tag((MR_Word) (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__V_75_75)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__V_75_75, (MR_Integer) 0)))) == (MR_Integer) 8)));
                          if ((ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded)
                            {
                              (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__CalleeCodeAddr_74 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__V_75_75, (MR_Integer) 1)));
                              {
                                {
                                  (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded = ml_backend__ml_util__code_address_is_for_this_function_3_p_0((ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__CalleeCodeAddr_74, (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__ModuleName_15, (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__EntityName_16);
                                }
                                if ((ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded)
                                  {
    ...
    if ((ml_backend__ml_optimize__Body0_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *ml_backend__ml_optimize__Body_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        {
          (ml_backend__ml_optimize__env).ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_optimize__Globals_14, (MR_Integer) 457, (MR_Integer) 1);
        }
...
{
  {
    ...
    MR_Word ml_backend__ml_optimize__CalleeCodeAddr_95;
    MR_Word ml_backend__ml_optimize__V_96_96;
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_14, (MR_Integer) 457, &ml_backend__ml_optimize__OptTailCalls_15);
    }
                ...
                if (ml_backend__ml_optimize__succeeded)
                  {
                    ...
                    if (ml_backend__ml_optimize__succeeded)
                      {
                        ml_backend__ml_optimize__V_96_96 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__CalleeRval_89, (MR_Integer) 1)));
                        ml_backend__ml_optimize__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_optimize__V_96_96)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__V_96_96, (MR_Integer) 0)))) == (MR_Integer) 8)));
                        if (ml_backend__ml_optimize__succeeded)
                          {
                            ml_backend__ml_optimize__CalleeCodeAddr_95 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__V_96_96, (MR_Integer) 1)));
                            {
                              ml_backend__ml_optimize__succeeded = ml_backend__ml_util__code_address_is_for_this_function_3_p_0(ml_backend__ml_optimize__CalleeCodeAddr_95, ml_backend__ml_optimize__ModuleName_16, ml_backend__ml_optimize__EntityName_17);
                            }
                          }
                      }
                  }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_61, (MR_Integer) 458, &ml_backend__ml_optimize__OptInit_62);
          }
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__V_78_78, (MR_Integer) 459, &ml_backend__ml_optimize__EliminateLocalVars_77);
          }
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_optimize__V_46_46, 0) = ((MR_Box) (&ml_backend__ml_optimize_scalar_common_3[1]));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_6, (MR_Integer) 464, &ml_backend__ml_optimize__OptPeep_7);
    }
