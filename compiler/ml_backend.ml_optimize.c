...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Var_19, (MR_Integer) 484, &EliminateLocalVars_12);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_52, (MR_Integer) 187, (MR_Integer) 1);
            if (succeeded)
            {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 482, &OptInit_10);
    switch (OptInit_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 489, &OptPeep_7);
    switch (OptPeep_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
