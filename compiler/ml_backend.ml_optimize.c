      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_52, (MR_Integer) 212, (MR_Integer) 1);
            if (succeeded)
            {
              Var_58 = (MR_Integer) 213;
              Var_59 = (MR_Integer) 1;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (!(succeeded))
              {
                ...
                Var_63 = ml_backend__ml_optimize__rval_is_cheap_enough_to_duplicate_1_f_0(Rval_48);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_87 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), (MR_Word) (&ml_backend__ml_optimize_scalar_common_1[0]), (MR_Word) (&ml_backend__ml_optimize_scalar_common_4[1]), ElseBlockStmts0_26);
        ElseBlockStmts_27 = mercury__list__condense_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), Var_87);
        {
