    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word SubStmts_82;
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt0_5, (MR_Integer) 0)));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 5)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 3)));
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 8)));
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1)));
        ...
        case (MR_Integer) 7:
          {
            ...
            MR_Word Lvals_32;
            MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1)));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Rval_12;
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op0_5, (MR_Integer) 1)));
        ...
        ml_backend__ml_optimize__eliminate_var_in_rval_4_p_0(Rval0_10, &Rval_12, STATE_VARIABLE_VarElimInfo_0_13, STATE_VARIABLE_VarElimInfo_14);
        {
          ...
          *Op_6 = base;
          ...
          MR_hl_field(MR_mktag(2), base, 1) = (MR_Box) (packed_args_0);
        }
      }
      break;
    case (MR_Integer) 3:
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 3)));
          MR_Word Var_70;
          ...
          if (succeeded)
          {
            ...
            *Rval_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 1))));
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_6, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_6, (MR_Integer) 3)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), BinOp_59, (MR_Integer) 1)));
                      }
                    }
                    if (succeeded)
                    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_20, (MR_Integer) 0)));
            ...
            packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_20, (MR_Integer) 4)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Var_19, (MR_Integer) 478, &EliminateLocalVars_12);
...
{
  {
    ...
    *Count_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), VarElimInfo_21, (MR_Integer) 2))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarElimInfo_21, (MR_Integer) 3)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 476, &OptInit_10);
    switch (OptInit_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 483, &OptPeep_7);
    switch (OptPeep_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                if ((MaybeStmtElse0_22 == (MR_Word) ((MR_Unsigned) 0U)))
                  succeeded = MR_TRUE;
                else
                {
                ...
                if (succeeded)
                {
                  ...
                  if ((MaybeStmtElse0_22 == (MR_Word) ((MR_Unsigned) 0U)))
                    if ((MaybeStmtElse1_25 == (MR_Word) ((MR_Unsigned) 0U)))
                      MaybeElse_33 = (MR_Word) ((MR_Unsigned) 0U);
                    else
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      ElseBlockStmts_38 = mercury__list__condense_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), Var_71);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Else_39, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                        MR_hl_field(MR_mktag(0), Else_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_5, (MR_Integer) 0)));
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_51, (MR_Integer) 3)));
                        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_51, (MR_Integer) 8)));
