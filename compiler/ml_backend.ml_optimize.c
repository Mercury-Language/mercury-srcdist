...
MR_decl_label10(ml_backend__ml_optimize__optimize_func_3_0, 101,8,10,12,6,14,19,24,20,18)
...
MR_decl_label7(ml_backend__ml_optimize__try_to_eliminate_defn_6_0, 24,25,28,30,32,33,1)
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module14)
	...
	MR_init_label7(ml_backend__ml_optimize__try_to_eliminate_defn_6_0,24,25,28,30,32,33,1)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_optimize__try_to_eliminate_defn_6_0)
	...
	MR_sv(5) = MR_body((MR_Integer) MR_tempr2, (MR_Integer) 1);
	MR_sv(6) = MR_r4;
	}
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module20)
	...
	MR_init_label10(ml_backend__ml_optimize__optimize_func_3_0,101,8,10,12,6,14,19,24,20,18)
...
MR_def_static(ml_backend__ml_optimize__optimize_func_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_func_3_0_i101);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,3,3);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr4 = MR_sv(5);
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(3,3,2);
