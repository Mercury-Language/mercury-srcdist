...
MR_decl_label4(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0, 7,9,4,1)
...
MR_decl_label10(ml_backend__ml_optimize__optimize_func_3_0, 103,8,10,12,6,14,19,24,20,18)
MR_decl_label1(ml_backend__ml_optimize__optimize_func_3_0, 5)
MR_decl_label10(ml_backend__ml_optimize__optimize_in_call_stmt_3_0, 2,7,12,15,4,33,38,39,40,23)
...
MR_decl_label4(fn__ml_backend__ml_optimize__tailcall_loop_top_1_0, 3,8,4,2)
...
MR_decl_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__629__1_2_0)
MR_decl_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0)
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ml_backend__ml_optimize__tailcall_loop_top_1_0);
	MR_init_label4(fn__ml_backend__ml_optimize__tailcall_loop_top_1_0,3,8,4,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'tailcall_loop_top'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__ml_backend__ml_optimize__tailcall_loop_top_1_0,3)
	...
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(fn__ml_backend__ml_optimize__tailcall_loop_top_1_0_i8);
	}
	MR_r1 = (MR_Word) MR_string_const("ml_backend.ml_optimize", 22);
	MR_r2 = (MR_Word) MR_string_const("function \140ml_backend.ml_optimize.target_supports_break_and_continue_2\'/1", 72);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module4)
	...
	MR_init_label10(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,2,7,12,15,4,33,38,39,40,23)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,12)
	...
	MR_np_call_localret_ent(ml_backend__ml_optimize__generate_assign_args_5_0,
		ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i15);
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,4)
	...
	if (MR_PTAG_TESTR(MR_sv(3),2)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i23);
	}
	...
	if ((strcmp((char *) (MR_Word *) MR_r2, MR_string_const("mark_hp", 7)) != 0)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i33);
	}
	...
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
		ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i38);
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__ml_backend__mlds__mercury_module_name_to_mlds_1_0,
		ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i39);
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(__Unify___ml_backend__mlds__mlds_module_name_0_0,
		ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i40);
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_call_stmt_3_0_i23);
	}
	...
	MR_decr_sp_and_return(6);
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(ml_backend__ml_optimize__convert_assignments_into_initializers_5_0,12)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__629__1_2_0);
...
MR_def_label(ml_backend__ml_optimize__convert_assignments_into_initializers_5_0,16)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module20)
	...
	MR_init_label10(ml_backend__ml_optimize__optimize_func_3_0,103,8,10,12,6,14,19,24,20,18)
...
MR_def_static(ml_backend__ml_optimize__optimize_func_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_func_3_0_i103);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,19)
	...
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_func_3_0_i24);
	}
	MR_r1 = (MR_Word) MR_string_const("ml_backend.ml_optimize", 22);
	MR_r2 = (MR_Word) MR_string_const("function \140ml_backend.ml_optimize.target_supports_break_and_continue_2\'/1", 72);
	MR_r3 = (MR_Word) MR_string_const("target erlang", 13);
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,5)) {
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,3,2);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr4 = MR_sv(5);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module45)
	MR_init_entry1(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__629__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__629__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_assignments_into_initializers__629__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__629__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module46)
	MR_init_entry1(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0);
	MR_init_label4(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0,7,9,4,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_assignments_into_initializers__631__1'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr4 = MR_r5;
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0_i1);
	}
	...
	MR_np_call_localret_ent(fn__ml_backend__ml_util__rval_contains_var_2_0,
		ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0_i7);
MR_def_label(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,1)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0_i4);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(fn__ml_backend__ml_util__initializer_contains_var_2_0,
		ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0_i9);
MR_def_label(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_r1 == (MR_Integer) 1);
	MR_decr_sp_and_return(3);
MR_def_label(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(3);
MR_def_label(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__631__1_5_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
