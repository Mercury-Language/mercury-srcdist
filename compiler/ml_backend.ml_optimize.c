        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Integer Ptag_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 2)));
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Integer Var_59 = ((MR_Integer) (MR_hl_field(MR_mktag(3), AtomicStmt_50, (MR_Integer) 2)));
