...
MR_def_label(ml_backend__ml_optimize__generate_assign_args_5_0,3)
	...
	MR_r4 = MR_tempr4;
	MR_tempr7 = MR_r1;
	MR_tfield(0, MR_tempr4, 0) = MR_tfield(0, MR_tempr7, 1);
	...
	MR_tempr5 = MR_tfield(1, MR_tempr8, 0);
	MR_sv(2) = MR_tempr5;
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,4)
	...
	MR_tfield(3, MR_tempr4, 1) = MR_tfield(3, MR_tempr1, 1);
...
MR_def_label(ml_backend__ml_optimize__convert_assignments_into_initializers_5_0,12)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__630__1_2_0);
...
MR_def_label(ml_backend__ml_optimize__find_initial_val_in_statements_4_0,3)
	...
	MR_tempr2 = MR_sv(2);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr3, 0) = MR_tfield(0, MR_tempr1, 2);
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 3);
	MR_r2 = MR_tempr4;
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,20)
	...
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_TAG_COMMON(2,9,0);
...
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_rval_4_0,12)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_tempr2, 0);
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(0, MR_tempr2, 1);
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_tfield(0, MR_tempr2, 2) + (MR_Integer) 1);
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_tempr2, 3);
	MR_r1 = MR_tfield(0, MR_tempr1, 1);
