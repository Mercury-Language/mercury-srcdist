...
ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__679__1_3_p_0(
  MR_Word RHS_18,
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            *Rval_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_28, (MR_Integer) 1)));
            ...
            Var_37 = (MR_Integer) ((MR_Unsigned) Count0_11 + (MR_Unsigned) (MR_Integer) 1);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Var_19, (MR_Integer) 472, &EliminateLocalVars_12);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (!(succeeded))
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_24, (MR_Integer) 181, (MR_Integer) 1);
          if (succeeded)
          {
            Var_34 = (MR_Integer) 182;
            Var_35 = (MR_Integer) 1;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 471, &OptInit_10);
    switch (OptInit_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    succeeded = ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__679__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 477, &OptPeep_7);
    switch (OptPeep_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
