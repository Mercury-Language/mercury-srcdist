        ...
        {
          {
            ...
            (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__MaybeObject_76 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 3)));
            ml_backend__ml_optimize___CallArgs_77 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 4)));
            ml_backend__ml_optimize___Results_78 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 5)));
            (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__CallKind_79 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 6)));
            ml_backend__ml_optimize___Markers_80 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 7)));
            ml_backend__ml_optimize___Context_81 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_optimize__env_ptr)->ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__SubStmt_61, (MR_Integer) 8)));
          }
          {
          ...
          if ((ml_backend__ml_optimize__env).ml_backend__ml_optimize__optimize_in_function_defn_4_p_0_env_0__succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_optimize__CommentStmt_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_optimize_scalar_common_4[2])));
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_75, (MR_Integer) 465, &ml_backend__ml_optimize__OptInit_76);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Var_19, (MR_Integer) 466, &ml_backend__ml_optimize__EliminateLocalVars_12);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_15, (MR_Integer) 464, &ml_backend__ml_optimize__OptTailCalls_16);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_6, (MR_Integer) 471, &ml_backend__ml_optimize__OptPeep_7);
    }
