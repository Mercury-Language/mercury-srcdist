...
MR_decl_label8(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0, 52,4,5,53,7,8,9,12)
MR_decl_label8(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0, 13,15,17,19,20,22,23,25)
MR_decl_label7(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0, 27,28,30,31,33,34,51)
...
MR_decl_label3(ml_backend__ml_optimize__mlds_optimize_4_0, 2,3,5)
MR_decl_label8(ml_backend__ml_optimize__optimize_func_3_0, 67,8,10,12,6,14,19,22)
MR_decl_label4(ml_backend__ml_optimize__optimize_func_3_0, 25,20,18,5)
MR_decl_label8(ml_backend__ml_optimize__optimize_in_call_stmt_3_0, 2,7,13,15,17,19,21,14)
MR_decl_label8(ml_backend__ml_optimize__optimize_in_call_stmt_3_0, 12,30,4,48,53,54,55,38)
...
MR_decl_label8(ml_backend__ml_optimize__optimize_in_defn_4_0, 39,45,5,6,44,13,15,19)
MR_decl_label1(ml_backend__ml_optimize__optimize_in_statement_3_0, 3)
MR_decl_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0, 65,6,8,5,10,12,13,14)
MR_decl_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0, 15,66,37,67,20,22,24,42)
MR_decl_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0, 3,69,68,29,30,70,33,34)
...
MR_def_extern_entry(ml_backend__ml_optimize__mlds_optimize_4_0)
...
MR_decl_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__624__1_2_0)

static const MR_UserClosureId
mercury_data__closure_layout__ml_backend__ml_optimize__mlds_optimize_4_0_1;
...
{
{
(MR_Word *) &mercury_data__closure_layout__ml_backend__ml_optimize__mlds_optimize_4_0_1,
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module0)
	MR_init_entry1(ml_backend__ml_optimize__mlds_optimize_4_0);
	MR_init_label3(ml_backend__ml_optimize__mlds_optimize_4_0,2,3,5)
MR_BEGIN_CODE
...
#endif
MR_define_entry(mercury__ml_backend__ml_optimize__mlds_optimize_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	MR_np_call_localret_ent(libs__globals__io_get_globals_3_0,
		ml_backend__ml_optimize__mlds_optimize_4_0_i2);
MR_def_label(ml_backend__ml_optimize__mlds_optimize_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(fn__ml_backend__mlds__mercury_module_name_to_mlds_1_0,
		ml_backend__ml_optimize__mlds_optimize_4_0_i3);
MR_def_label(ml_backend__ml_optimize__mlds_optimize_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__map_3_0,
		ml_backend__ml_optimize__mlds_optimize_4_0_i5);
MR_def_label(ml_backend__ml_optimize__mlds_optimize_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(ml_backend__ml_optimize__generate_assign_args_5_0,3)
	...
	MR_sv(8) = MR_ctfield(1, MR_tempr6, 1);
...
MR_def_label(ml_backend__ml_optimize__generate_assign_args_5_0,20)
	...
	MR_sv(6) = MR_ctfield(0, MR_sv(1), 4);
	MR_r2 = MR_sv(4);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module3)
	...
	MR_init_label8(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,2,7,13,15,17,19,21,14)
	MR_init_label8(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,12,30,4,48,53,54,55,38)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,7)
	...
	MR_tfield(0, MR_tempr1, 1) = MR_ctfield(0, MR_sv(1), 4);
...
MR_def_label(ml_backend__ml_optimize__convert_assignments_into_initializers_5_0,10)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__624__1_2_0);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module17)
	...
	MR_init_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0,65,6,8,5,10,12,13,14)
	MR_init_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0,15,66,37,67,20,22,24,42)
	MR_init_label8(ml_backend__ml_optimize__optimize_in_stmt_3_0,3,69,68,29,30,70,33,34)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module19)
	...
	MR_init_label8(ml_backend__ml_optimize__optimize_func_3_0,67,8,10,12,6,14,19,22)
	MR_init_label4(ml_backend__ml_optimize__optimize_func_3_0,25,20,18,5)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,20)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,3,4);
	MR_tempr5 = MR_sv(5);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module20)
	...
	MR_init_label8(ml_backend__ml_optimize__optimize_in_defn_4_0,39,45,5,6,44,13,15,19)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__optimize_in_defn_4_0,39)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_defn_4_0_i45);
	}
	MR_r1 = MR_tempr2;
	MR_proceed();
	}
MR_def_label(ml_backend__ml_optimize__optimize_in_defn_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_LABEL_AP(ml_backend__ml_optimize__optimize_in_defn_4_0_i39);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module30)
	...
	MR_init_label8(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0,52,4,5,53,7,8,9,12)
	MR_init_label8(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0,13,15,17,19,20,22,23,25)
	MR_init_label7(ml_backend__ml_optimize__eliminate_var_in_atomic_stmt_4_0,27,28,30,31,33,34,51)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module45)
	MR_init_entry1(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__624__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_optimize__IntroducedFrom__pred__convert_assignments_into_initializers__624__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
