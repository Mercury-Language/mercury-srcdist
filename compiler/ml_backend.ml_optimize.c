...
MR_decl_label7(ml_backend__ml_optimize__eliminate_var_in_lval_4_0, 4,3,8,7,11,10,46)
...
MR_decl_label6(ml_backend__ml_optimize__eliminate_var_in_rval_4_0, 21,20,24,23,27,91)
...
MR_decl_label10(ml_backend__ml_optimize__optimize_in_stmt_3_0, 5,7,4,9,11,13,10,15,16,17)
MR_decl_label10(ml_backend__ml_optimize__optimize_in_stmt_3_0, 3,20,21,19,24,23,26,30,31,28)
MR_decl_label3(ml_backend__ml_optimize__optimize_in_stmt_3_0, 34,35,33)
...
MR_decl_label6(__Compare___ml_backend__ml_optimize__var_elim_info_0_0, 3,2,5,9,13,49)
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,12)
	...
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,4,1);
	MR_tfield(0, MR_tempr1, 1) = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_r3 = MR_sv(1);
	MR_sv(4) = MR_tempr1;
...
MR_def_label(ml_backend__ml_optimize__optimize_in_call_stmt_3_0,14)
	...
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,4,2);
	MR_tfield(0, MR_tempr1, 1) = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_r3 = MR_sv(1);
	MR_sv(4) = MR_tempr1;
...
MR_def_label(ml_backend__ml_optimize__find_initial_val_in_statement_4_0,7)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_r3 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,0,3);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module23)
	...
	MR_init_label10(ml_backend__ml_optimize__optimize_in_stmt_3_0,5,7,4,9,11,13,10,15,16,17)
	MR_init_label10(ml_backend__ml_optimize__optimize_in_stmt_3_0,3,20,21,19,24,23,26,30,31,28)
	MR_init_label3(ml_backend__ml_optimize__optimize_in_stmt_3_0,34,35,33)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__optimize_in_stmt_3_0,15)
	...
	MR_np_call_localret_ent(fn__list__condense_1_0,
		ml_backend__ml_optimize__optimize_in_stmt_3_0_i16);
...
MR_def_label(ml_backend__ml_optimize__optimize_in_stmt_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_stmt_3_0_i23);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_optimize__optimize_in_stmt_3_0,23)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,4)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_stmt_3_0_i26);
	}
...
MR_def_label(ml_backend__ml_optimize__optimize_in_stmt_3_0,28)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,6)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__optimize_in_stmt_3_0_i33);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,14)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(6) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,4,3);
	MR_tfield(0, MR_tempr1, 1) = MR_sv(4);
	MR_r1 = MR_sv(5);
	}
	MR_np_call_localret_ent(fn__ml_backend__ml_target_util__globals_target_supports_break_and_continue_1_0,
...
MR_def_label(ml_backend__ml_optimize__optimize_func_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,4,5);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr4 = MR_sv(4);
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(3,4,4);
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module31)
	...
	MR_init_label6(ml_backend__ml_optimize__eliminate_var_in_rval_4_0,21,20,24,23,27,91)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_rval_4_0,23)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__eliminate_var_in_rval_4_0_i91);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
...
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_rval_4_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module32)
	...
	MR_init_label7(ml_backend__ml_optimize__eliminate_var_in_lval_4_0,4,3,8,7,11,10,46)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_lval_4_0,3)
	...
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(ml_backend__ml_optimize__eliminate_var_in_lval_4_0_i46);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	if (MR_PTAG_TESTR(MR_r1,1)) {
...
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_lval_4_0,10)
	...
	MR_r2 = MR_sv(4);
	MR_decr_sp_and_return(5);
MR_def_label(ml_backend__ml_optimize__eliminate_var_in_lval_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ml_optimize_module49)
	...
	MR_init_label6(__Compare___ml_backend__ml_optimize__var_elim_info_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ml_optimize__var_elim_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ml_optimize__var_elim_info_0_0_i49);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
...
MR_def_label(__Compare___ml_backend__ml_optimize__var_elim_info_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ml_backend__ml_optimize__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_optimize);
