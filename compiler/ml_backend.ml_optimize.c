...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Var_14, (MR_Integer) 465, &ml_backend__ml_optimize__EliminateLocalVars_9);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_9, (MR_Integer) 464, &ml_backend__ml_optimize__OptInit_10);
    }
    ...
    if ((ml_backend__ml_optimize__Body0_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *ml_backend__ml_optimize__Body_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        {
          (ml_backend__ml_optimize__env).ml_backend__ml_optimize__optimize_func_3_p_0_env_0__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_optimize__Globals_14, (MR_Integer) 463, (MR_Integer) 1);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_14, (MR_Integer) 463, &ml_backend__ml_optimize__OptTailCalls_15);
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Globals_61, (MR_Integer) 464, &ml_backend__ml_optimize__OptInit_62);
          }
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_optimize__Var_78, (MR_Integer) 465, &ml_backend__ml_optimize__EliminateLocalVars_77);
          }
