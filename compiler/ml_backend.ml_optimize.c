...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Var_19, (MR_Integer) 480, &EliminateLocalVars_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 478, &OptInit_10);
    switch (OptInit_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 485, &OptPeep_7);
    switch (OptPeep_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
