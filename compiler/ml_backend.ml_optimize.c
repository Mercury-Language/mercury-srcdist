        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (ml_backend__ml_optimize__optimize_in_stmt_3_p_0_1));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_48, (MR_Integer) 210, (MR_Integer) 1);
            if (succeeded)
            {
              Var_54 = (MR_Integer) 211;
              Var_55 = (MR_Integer) 1;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (!(succeeded))
              {
                ...
                Var_58 = ml_backend__ml_optimize__rval_is_cheap_enough_to_duplicate_1_f_0(Rval_44);
