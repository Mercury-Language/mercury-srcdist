    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word SubStmts_82;
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt0_5, (MR_Integer) 0)));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 5)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 3)));
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 8)));
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1)));
        ...
        case (MR_Integer) 7:
          {
            ...
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1)));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Rval_12;
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op0_5, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 3)));
          MR_Word Var_70;
          ...
          if (succeeded)
          {
            ...
            *Rval_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 1))));
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_29, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_6, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarElimInfo_0_6, (MR_Integer) 3)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), BinOp_59, (MR_Integer) 1)));
                      }
                    }
                    if (succeeded)
                    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_20, (MR_Integer) 0)));
            ...
            packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_20, (MR_Integer) 4)));
...
{
  {
    ...
    *Count_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), VarElimInfo_21, (MR_Integer) 2))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarElimInfo_21, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    ThenBlockStmts0_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    Then_32 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      {
                        ElseBlockStmts0_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      {
                        Else_39 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      ...
                      {
                        MaybeElse_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), MaybeElse_33, 0) = ((MR_Box) (Else_39));
                      }
                    }
                  }
                  {
                    Stmt_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_5, (MR_Integer) 0)));
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_51, (MR_Integer) 3)));
                        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_51, (MR_Integer) 8)));
