      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 220, &WarnCanFailFunction_23);
  ...
  MR_Word InferredDetism_13)
{
  ...
  Pieces_31 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__det_check_proc_scalar_common_1[112])), Var_48);
  {
    ...
    MR_hl_field(0, Spec_14, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__det_check_proc_scalar_common_2[3])));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 171, &WarnDetDeclTooLax_18);
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 172, &WarnInferredErroneous_19);
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(2, ReportSpec_23, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__det_check_proc_scalar_common_2[0])));
