      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_pred__proc_info_get_cse_nopull_contexts_2_p_0(ProcInfo_12, &CseNoPullContexts_96);
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo_8, &Detism_12);
