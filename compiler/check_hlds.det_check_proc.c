      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_45, (MR_Integer) 15, &ShouldIssueWarning_46);
          libs__globals__lookup_bool_option_3_p_0(Globals_45, (MR_Integer) 16, &WarnAboutInferredErroneous_47);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 82, &WarnCanFailFunction_23);
