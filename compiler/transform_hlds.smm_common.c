...
#line 62 "transform_hlds.smm_common.c"
...
MR_decl_label10(transform_hlds__smm_common__dump_goal_path_step_3_0, 3,5,7,9,11,13,15,17,20,23)
MR_decl_label2(transform_hlds__smm_common__dump_goal_path_step_3_0, 106,28)
...
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,4)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__119__1_2_0);
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__smm_common__dump_goal_path_step_3_0);
	MR_init_label10(transform_hlds__smm_common__dump_goal_path_step_3_0,3,5,7,9,11,13,15,17,20,23)
	MR_init_label2(transform_hlds__smm_common__dump_goal_path_step_3_0,106,28)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__smm_common__dump_goal_path_step_3_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,4)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i3);
	}
	MR_r1 = (MR_Integer) 97;
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,3)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,5)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i5);
	}
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i7);
	}
	MR_r1 = (MR_Integer) 99;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,7)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,2)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i9);
	}
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,9)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i11);
	}
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,11)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,6)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i13);
	}
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,13)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,3)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i15);
	}
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,15)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i17);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(io__write_char_3_0,
		transform_hlds__smm_common__dump_goal_path_step_3_0_i28);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i20);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i23);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,23)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i106);
	}
	MR_r1 = (MR_Integer) 113;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(io__write_char_3_0,
		transform_hlds__smm_common__dump_goal_path_step_3_0_i28);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__119__1_2_0);
MR_BEGIN_CODE
