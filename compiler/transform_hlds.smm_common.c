...
MR_decl_label6(transform_hlds__smm_common__some_are_special_preds_2_0, 2,3,7,10,4,1)
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module1)
	...
	MR_init_label6(transform_hlds__smm_common__some_are_special_preds_2_0,2,3,7,10,4,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,3)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__smm_common__some_are_special_preds_2_0_i7);
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__smm_common__some_are_special_preds_2_0_i10);
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__transform_hlds__smm_common__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__smm_common);
