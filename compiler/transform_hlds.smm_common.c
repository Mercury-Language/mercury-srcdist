...
transform_hlds__smm_common__dump_program_point_4_p_0(
  ...
  MR_Word HeadVar__2_2)
{
  MR_Word Context_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
  MR_Word RevGoalPath_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))));
  MR_String Var_16;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__smm_common__IntroducedFrom__pred__some_special_preds_are_in_list__135__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
...

  {
    ...
    CompareMap_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps_5, (MR_Integer) 2))));
    {
      ...
      mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), UnifyMap_6, &SpecialPredIds_15);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&transform_hlds__smm_common_scalar_common_1[0]));
        MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (transform_hlds__smm_common__some_are_special_preds_2_p_0_1));
        MR_hl_field(MR_mktag(0), Var_19, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (SpecialPredIds_15));
      }
    ...
    {
      {
        ...
        mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), IndexMap_7, &SpecialPredIds_23);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&transform_hlds__smm_common_scalar_common_1[0]));
          MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (transform_hlds__smm_common__some_are_special_preds_2_p_0_2));
          MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (SpecialPredIds_23));
        }
      ...
      if (!(succeeded))
      {
        ...
        mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), CompareMap_8, &SpecialPredIds_31);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&transform_hlds__smm_common_scalar_common_1[0]));
          MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (transform_hlds__smm_common__some_are_special_preds_2_p_0_3));
          MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (SpecialPredIds_31));
        }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Sel_7)) == (MR_Integer) 0))
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo__12_13 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          succeeded = mercury__list__index1_3_p_0(TypeCtorInfo__12_13, ArgTypes_12, Choice_10, &conv0_SubType_11);
          if (succeeded)
          {
