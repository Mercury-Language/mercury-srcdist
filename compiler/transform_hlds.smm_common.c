...
static MR_bool MR_CALL 
transform_hlds__smm_common__IntroducedFrom__pred__some_special_preds_are_in_list__132__1_2_p_0(
...
{
  {
    ...
    {
      transform_hlds__smm_common__succeeded = transform_hlds__smm_common__IntroducedFrom__pred__some_special_preds_are_in_list__132__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__closure, (MR_Integer) 3))), ((MR_Word) transform_hlds__smm_common__wrapper_arg_1));
    }
    return transform_hlds__smm_common__succeeded;
  }
}
