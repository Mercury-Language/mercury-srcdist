...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__smm_common__list__pti_list_1__plain_hlds__pred_proc_id__type_ctor_info_pred_id_0;
...
transform_hlds__smm_common__IntroducedFrom__pred__some_special_preds_are_in_list__152__1_2_p_0(
...
static /* final */ const MR_Box transform_hlds__smm_common_scalar_common_1[2][5] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&transform_hlds__smm_common__list__pti_list_1__plain_hlds__pred_proc_id__type_ctor_info_pred_id_0)),
  ...
  MR_Word LambdaHeadVar__1_13)
{
  ...
  succeeded = mercury__list__member_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ((MR_Box) (PredId_7)), SpecialPredIds_5);
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__smm_common__IntroducedFrom__pred__some_special_preds_are_in_list__152__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word ModuleInfo_4)
{
...

  {
    ...
    CompareMap_8 = ((MR_Word) ((MR_hl_field(0, SpecialPredMaps_5, 2))));
    {
      ...
      mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), UnifyMap_6, &SpecialPredIds_15);
      {
      ...
      mercury__list__filter_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Var_19, PPIds_3, &SpecialPPIds_16);
    ...
    {
      {
        ...
        mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), IndexMap_7, &SpecialPredIds_23);
        {
        ...
        mercury__list__filter_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Var_27, PPIds_3, &SpecialPPIds_24);
      ...
      if (!(succeeded))
      {
        ...
        mercury__map__values_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), CompareMap_8, &SpecialPredIds_31);
        {
        ...
        mercury__list__filter_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Var_35, PPIds_3, &SpecialPPIds_32);
  ...
  if (!(succeeded))
  {
    ...
    mercury__list__filter_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Var_12, PPIds_3, &FilteredPPIds_9);
