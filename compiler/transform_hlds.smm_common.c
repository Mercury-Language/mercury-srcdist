...
{
  {
    ...
    if (transform_hlds__smm_common__succeeded)
      *transform_hlds__smm_common__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__smm_common__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__smm_common__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word transform_hlds__smm_common__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word transform_hlds__smm_common__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word transform_hlds__smm_common__Var_8;

        {
          mercury__term____Compare____context_0_0(&transform_hlds__smm_common__Var_8, transform_hlds__smm_common__Var_4, transform_hlds__smm_common__Var_6);
        }
        ...
        if (transform_hlds__smm_common__succeeded)
          *transform_hlds__smm_common__HeadVar__1_1 = transform_hlds__smm_common__Var_8;
          ...
          {
            mdbcomp__goal_path____Compare____reverse_goal_path_0_0(transform_hlds__smm_common__HeadVar__1_1, transform_hlds__smm_common__Var_5, transform_hlds__smm_common__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (transform_hlds__smm_common__succeeded)
      ...
      {
        MR_Word transform_hlds__smm_common__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word transform_hlds__smm_common__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word transform_hlds__smm_common__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__smm_common__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__smm_common__HeadVar__2_2, (MR_Integer) 1)));

        {
          transform_hlds__smm_common__succeeded = mercury__term____Unify____context_0_0(transform_hlds__smm_common__Var_3, transform_hlds__smm_common__Var_5);
        }
        if (transform_hlds__smm_common__succeeded)
          {
            transform_hlds__smm_common__succeeded = mdbcomp__goal_path____Unify____reverse_goal_path_0_0(transform_hlds__smm_common__Var_4, transform_hlds__smm_common__Var_6);
          }
      }
    return transform_hlds__smm_common__succeeded;
  }
