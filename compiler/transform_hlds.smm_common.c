...
#line 59 "transform_hlds.smm_common.c"
...
#line 65 "transform_hlds.smm_common.c"

#endif
#line 68 "transform_hlds.smm_common.c"
...
MR_decl_label8(transform_hlds__smm_common__dump_goal_path_step_3_0, 4,5,7,9,11,13,15,43)
MR_decl_label4(transform_hlds__smm_common__dump_goal_path_step_3_0, 44,23,25,24)
MR_decl_label2(transform_hlds__smm_common__dump_program_point_3_0, 2,3)
MR_decl_label4(transform_hlds__smm_common__proc_not_defined_in_module_2_0, 2,3,4,1)
MR_decl_label6(transform_hlds__smm_common__some_are_special_preds_2_0, 2,3,6,8,4,1)
...
MR_decl_static(transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__118__1_2_0)
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module1)
	...
	MR_init_label6(transform_hlds__smm_common__some_are_special_preds_2_0,2,3,6,8,4,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,2)
	...
	MR_np_call_localret_ent(map__values_2_0,
		transform_hlds__smm_common__some_are_special_preds_2_0_i3);
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__118__1_2_0);
	...
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__smm_common__some_are_special_preds_2_0_i6);
MR_def_label(transform_hlds__smm_common__some_are_special_preds_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__smm_common__some_are_special_preds_2_0_i4);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module3)
	...
	MR_init_label2(transform_hlds__smm_common__dump_program_point_3_0,2,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module5)
	...
	MR_init_label8(transform_hlds__smm_common__dump_goal_path_step_3_0,4,5,7,9,11,13,15,43)
	MR_init_label4(transform_hlds__smm_common__dump_goal_path_step_3_0,44,23,25,24)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__smm_common__dump_goal_path_step_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i4) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i43) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i44) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i23));
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i5) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i7) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i9) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i11) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i13) MR_AND
		MR_LABEL_AP(transform_hlds__smm_common__dump_goal_path_step_3_0_i15));
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 99;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 116;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 101;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 110;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 102;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 108;
	MR_np_tailcall_ent(io__write_char_3_0);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(io__write_char_3_0,
		transform_hlds__smm_common__dump_goal_path_step_3_0_i25);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(io__write_char_3_0,
		transform_hlds__smm_common__dump_goal_path_step_3_0_i25);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(transform_hlds__smm_common__dump_goal_path_step_3_0_i24);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(io__write_char_3_0,
		transform_hlds__smm_common__dump_goal_path_step_3_0_i25);
MR_def_label(transform_hlds__smm_common__dump_goal_path_step_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_BEGIN_MODULE(transform_hlds__smm_common_module8)
	MR_init_entry1(transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__118__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__smm_common__IntroducedFrom__pred__some_are_special_preds__118__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
