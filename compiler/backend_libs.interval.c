  ...
  MR_Word HeadVar__2_2)
{
  ...
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) " =>\n");
  IntStrs_56 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&backend_libs__interval_scalar_common_2[20]), VarNums_11);
  Var_28 = mercury__string__join_list_2_f_0((MR_String) ", ", IntStrs_56);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "vars [");
  mercury__io__write_string_4_p_0(Stream_5, Var_28);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "]\n");
  IntStrs_63 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&backend_libs__interval_scalar_common_2[21]), IntervalIntList_13);
  Var_34 = mercury__string__join_list_2_f_0((MR_String) ", ", IntStrs_63);
  ...
  MR_Word Vars_6)
{
  ...
  IntStrs_31 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&backend_libs__interval_scalar_common_2[17]), VarNums_8);
  Var_17 = mercury__string__join_list_2_f_0((MR_String) ", ", IntStrs_31);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) " [");
  ...
  MR_Word * STATE_VARIABLE_VarRename_28)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_anchor_0), (MR_Word) (&backend_libs__interval_scalar_common_1[4]), InsertMap_11, ((MR_Box) (Anchor_23)), &conv0_InsertsPrime_36);
    if (succeeded)
    {
    ...
    if (succeeded)
      backend_libs__interval__make_inserted_goals_7_p_0(MaybeFeature_10, InsertsPrime_36, &InsertGoals_47, STATE_VARIABLE_VarTable_0_25, STATE_VARIABLE_VarTable_26, Var_51, STATE_VARIABLE_VarRename_28);
    else
    {
      InsertGoals_47 = (MR_Word) ((MR_Unsigned) 0U);
      *STATE_VARIABLE_VarRename_28 = Var_51;
    ...
    hlds__hlds_goal__conj_list_to_goal_3_p_0(Var_52, BranchesGoalInfo_49, Goal_14);
  }
  else
  {
  ...
  MR_Word * STATE_VARIABLE_VoidRename_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_0_3, Arg_19, &ArgEntry_45);
      parse_tree__var_table__add_var_entry_4_p_0(ArgEntry_45, &Shadow_46, STATE_VARIABLE_VarTable_0_3, &STATE_VARIABLE_VarTable_31_31);
      ...
      if (succeeded)
      {
        mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[0]), (MR_Word) (&backend_libs__interval_scalar_common_1[0]), ((MR_Box) (Arg_19)), ((MR_Box) (Shadow_46)), STATE_VARIABLE_VarRename_0_5, &STATE_VARIABLE_VarRename_32_32);
        STATE_VARIABLE_VoidRename_33_33 = STATE_VARIABLE_VoidRename_0_7;
      }
      else
      {
        mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[0]), (MR_Word) (&backend_libs__interval_scalar_common_1[0]), ((MR_Box) (Arg_19)), ((MR_Box) (Shadow_46)), STATE_VARIABLE_VoidRename_0_7, &STATE_VARIABLE_VoidRename_33_33);
  ...
  MR_Word * STATE_VARIABLE_IntervalInfo_16)
{
  ...
  MR_Word EndMap0_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 12))));
  MR_Word EndMap_26;
  MR_Word Var_43;
  MR_Word Var_42;
  MR_Word Var_44;
  ...
  mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_interval_id_0), (MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_anchor_0), ((MR_Box) (BeforeId_10)), ((MR_Box) (StartArchor_9)), EndMap0_25, &EndMap_26);
  Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 0))));
  Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 1))));
  Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 2))));
  Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 3))));
  Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 4))));
  Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 5))));
  Var_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 6))));
  Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 7))));
  Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 8))));
  Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 9))));
  Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 10))));
  Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 11))));
  Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 13))));
  Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 14))));
  Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_15, (MR_Integer) 15))));
  {
    STATE_VARIABLE_IntervalInfo_17_17 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 0) = ((MR_Box) (Var_42));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 1) = ((MR_Box) (Var_43));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 2) = ((MR_Box) (Var_44));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 3) = ((MR_Box) (Var_45));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 4) = ((MR_Box) (Var_46));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 5) = ((MR_Box) (Var_47));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 6) = ((MR_Box) (Var_48));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 7) = ((MR_Box) (Var_49));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 8) = ((MR_Box) (Var_50));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 9) = ((MR_Box) (Var_51));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 10) = ((MR_Box) (Var_52));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 11) = ((MR_Box) (Var_53));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 12) = ((MR_Box) (EndMap_26));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 13) = ((MR_Box) (Var_55));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 14) = ((MR_Box) (Var_56));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, 15) = ((MR_Box) (Var_57));
  }
  ...
  else
  {
    ...
    FlushedLater_65 = parse_tree__set_of_var__union_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_43, ResumeVars_14);
    Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 0))));
    Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 2))));
    Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 3))));
    Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 4))));
    Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 5))));
    Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 6))));
    Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 7))));
    Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 8))));
    Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 9))));
    Var_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 10))));
    Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 11))));
    Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 12))));
    Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 13))));
    Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 14))));
    Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_17_17, (MR_Integer) 15))));
    {
      STATE_VARIABLE_IntervalInfo_18_18 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 0) = ((MR_Box) (Var_81));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 1) = ((MR_Box) (FlushedLater_65));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 2) = ((MR_Box) (Var_83));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 3) = ((MR_Box) (Var_84));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 4) = ((MR_Box) (Var_85));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 5) = ((MR_Box) (Var_86));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 6) = ((MR_Box) (Var_87));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 7) = ((MR_Box) (Var_88));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 8) = ((MR_Box) (Var_89));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 9) = ((MR_Box) (Var_90));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 10) = ((MR_Box) (Var_91));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 11) = ((MR_Box) (Var_92));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 12) = ((MR_Box) (Var_93));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 13) = ((MR_Box) (Var_94));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 14) = ((MR_Box) (Var_95));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_18_18, 15) = ((MR_Box) (Var_96));
    }
  }
  backend_libs__interval__set_cur_interval_3_p_0(BeforeId_10, STATE_VARIABLE_IntervalInfo_18_18, &STATE_VARIABLE_IntervalInfo_19_19);
  ...
  MR_Box * STATE_VARIABLE_Acc_37)
{
  ...
  MR_Word BranchResumeMap0_57;
  MR_Word BranchResumeMap_58;
  ...
  BranchResumeMap0_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 3))));
  mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_resume_save_status_0), ((MR_Box) (GoalId_23)), ((MR_Box) (HasResumeSave_29)), BranchResumeMap0_57, &BranchResumeMap_58);
  Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 0))));
  Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 1))));
  Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 2))));
  Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 4))));
  Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 5))));
  Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 6))));
  Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 7))));
  Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 8))));
  Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 9))));
  Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 10))));
  Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 11))));
  Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 12))));
  Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 13))));
  Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 14))));
  Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_38_38, (MR_Integer) 15))));
  {
    STATE_VARIABLE_IntervalInfo_40_40 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 0) = ((MR_Box) (Var_74));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 1) = ((MR_Box) (Var_75));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 2) = ((MR_Box) (Var_76));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 3) = ((MR_Box) (BranchResumeMap_58));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 4) = ((MR_Box) (Var_78));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 5) = ((MR_Box) (Var_79));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 6) = ((MR_Box) (Var_80));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 7) = ((MR_Box) (Var_81));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 8) = ((MR_Box) (Var_82));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 9) = ((MR_Box) (Var_83));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 10) = ((MR_Box) (Var_84));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 11) = ((MR_Box) (Var_85));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 12) = ((MR_Box) (Var_86));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 13) = ((MR_Box) (Var_87));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 14) = ((MR_Box) (Var_88));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_40_40, 15) = ((MR_Box) (Var_89));
  }
  ...
  MR_Box * STATE_VARIABLE_Acc_29)
{
  ...
  else
  {
    ...
    backend_libs__interval__set_cur_interval_3_p_0(BeforeCallId_21, STATE_VARIABLE_IntervalInfo_38_38, &STATE_VARIABLE_IntervalInfo_40_40);
  ...
  MR_Word * STATE_VARIABLE_IntervalInfo_13)
{
  ...
  MR_Word STATE_VARIABLE_IntervalInfo_18_18;
  MR_Word STATE_VARIABLE_IntervalInfo_19_19;
  MR_Word CurInterval_25;
  MR_Word CondEndMap0_26;
  MR_Word CondEndMap_27;
  MR_Word Var_58;
  MR_Word Var_59;
  MR_Word Var_60;
  MR_Word Var_61;
  ...
  CondEndMap0_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 5))));
  CurInterval_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 6))));
  mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_interval_id_0), ((MR_Box) (GoalId_6)), ((MR_Box) (CurInterval_25)), CondEndMap0_26, &CondEndMap_27);
  Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 0))));
  Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 1))));
  Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 2))));
  Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 3))));
  Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 4))));
  ThenStartId_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 6))));
  Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 7))));
  Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 8))));
  Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 9))));
  Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 10))));
  Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 11))));
  Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 12))));
  Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 13))));
  Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 14))));
  Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_12, (MR_Integer) 15))));
  {
    STATE_VARIABLE_IntervalInfo_14_14 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 0) = ((MR_Box) (Var_58));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 1) = ((MR_Box) (Var_59));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 2) = ((MR_Box) (Var_60));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 3) = ((MR_Box) (Var_61));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 4) = ((MR_Box) (Var_62));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 5) = ((MR_Box) (CondEndMap_27));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 6) = ((MR_Box) (ThenStartId_7));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 7) = ((MR_Box) (Var_65));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 8) = ((MR_Box) (Var_66));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 9) = ((MR_Box) (Var_67));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 10) = ((MR_Box) (Var_68));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 11) = ((MR_Box) (Var_69));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 12) = ((MR_Box) (Var_70));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 13) = ((MR_Box) (Var_71));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 14) = ((MR_Box) (Var_72));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_14_14, 15) = ((MR_Box) (Var_73));
  }
  {
  ...
  MR_Box * STATE_VARIABLE_Acc_19)
{
  ...
  MR_Word StartMap0_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 11))));
  MR_Word StartMap_45;
  MR_Word Var_61;
  MR_Word Var_62;
  MR_Word Var_63;
  ...
  mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_interval_id_0), (MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_anchor_0), ((MR_Box) (BranchStartId_15)), ((MR_Box) (StartAnchor_10)), StartMap0_44, &StartMap_45);
  Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 0))));
  Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 1))));
  Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 2))));
  Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 3))));
  Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 4))));
  Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 5))));
  Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 6))));
  Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 7))));
  Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 8))));
  Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 9))));
  Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 10))));
  Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 12))));
  Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 13))));
  Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 14))));
  Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_16, (MR_Integer) 15))));
  {
    STATE_VARIABLE_IntervalInfo_20_20 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 0) = ((MR_Box) (Var_61));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 1) = ((MR_Box) (Var_62));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 2) = ((MR_Box) (Var_63));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 3) = ((MR_Box) (Var_64));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 4) = ((MR_Box) (Var_65));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 5) = ((MR_Box) (Var_66));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 6) = ((MR_Box) (Var_67));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 7) = ((MR_Box) (Var_68));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 8) = ((MR_Box) (Var_69));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 9) = ((MR_Box) (Var_70));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 10) = ((MR_Box) (Var_71));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 11) = ((MR_Box) (StartMap_45));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 12) = ((MR_Box) (Var_73));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 13) = ((MR_Box) (Var_74));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 14) = ((MR_Box) (Var_75));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_20_20, 15) = ((MR_Box) (Var_76));
  }
  ...
  MR_Word * STATE_VARIABLE_IntervalInfo_10)
{
  ...
  MR_Word STATE_VARIABLE_IntervalInfo_14_14;
  MR_Word Counter0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 7))));
  MR_Word IntervalVars0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 14))));
  MR_Integer Num_21;
  MR_Word Counter_22;
  MR_Word IntervalVars_23;
  MR_Word Var_24;
  MR_Word Var_56;
  MR_Word Var_57;
  MR_Word Var_58;
  ...
  mercury__counter__allocate_3_p_0(&Num_21, Counter0_19, &Counter_22);
  BranchTailId_8 = (MR_Word) (Num_21);
  ...
  mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_interval_id_0), (MR_Word) (&backend_libs__interval_scalar_common_1[1]), ((MR_Box) (BranchTailId_8)), ((MR_Box) (Var_24)), IntervalVars0_20, &IntervalVars_23);
  Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 0))));
  Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 1))));
  Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 2))));
  Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 3))));
  Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 4))));
  Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 5))));
  Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 6))));
  Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 8))));
  Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 9))));
  Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 10))));
  Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 11))));
  Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 12))));
  Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 13))));
  Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_0_9, (MR_Integer) 15))));
  {
    STATE_VARIABLE_IntervalInfo_11_11 = (MR_Word) MR_new_object(MR_Word, (16 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 0) = ((MR_Box) (Var_56));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 1) = ((MR_Box) (Var_57));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 2) = ((MR_Box) (Var_58));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 3) = ((MR_Box) (Var_59));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 4) = ((MR_Box) (Var_60));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 5) = ((MR_Box) (Var_61));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 6) = ((MR_Box) (Var_62));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 7) = ((MR_Box) (Counter_22));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 8) = ((MR_Box) (Var_64));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 9) = ((MR_Box) (Var_65));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 10) = ((MR_Box) (Var_66));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 11) = ((MR_Box) (Var_67));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 12) = ((MR_Box) (Var_68));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 13) = ((MR_Box) (Var_69));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 14) = ((MR_Box) (IntervalVars_23));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntervalInfo_11_11, 15) = ((MR_Box) (Var_71));
  }
