...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[6]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) (&backend_libs__interval_scalar_common_1[6]);
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[6]), &SubResult9_30, ((MR_Box) (ArgX9_28)), ((MR_Box) (ArgY9_29)));
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[7]), &SubResult11_36, ((MR_Box) (ArgX11_34)), ((MR_Box) (ArgY11_35)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_43_43 = (MR_Word) (&backend_libs__interval_scalar_common_1[6]);
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeInfo_45_45 = (MR_Word) (&backend_libs__interval_scalar_common_1[7]);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[5]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[5]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
