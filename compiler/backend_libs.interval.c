  ...
  MR_Word * STATE_VARIABLE_VoidRename_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__vartypes__lookup_var_type_3_p_0(STATE_VARIABLE_VarTypes_0_5, Arg_24, &Type_59);
      hlds__vartypes__add_var_type_4_p_0(Shadow_58, Type_59, STATE_VARIABLE_VarTypes_0_5, &STATE_VARIABLE_VarTypes_40_40);
