  ...
  MR_Word * STATE_VARIABLE_VoidRename_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_0_3, Arg_19, &ArgEntry_48);
      parse_tree__var_table__add_var_entry_4_p_0(ArgEntry_48, &Shadow_49, STATE_VARIABLE_VarTable_0_3, &STATE_VARIABLE_VarTable_31_31);
      ...
      if (succeeded)
      {
        mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[0]), (MR_Word) (&backend_libs__interval_scalar_common_1[0]), ((MR_Box) (Arg_19)), ((MR_Box) (Shadow_49)), STATE_VARIABLE_VarRename_0_5, &STATE_VARIABLE_VarRename_32_32);
        STATE_VARIABLE_VoidRename_33_33 = STATE_VARIABLE_VoidRename_0_7;
      }
      else
      {
        mercury__map__det_insert_4_p_0((MR_Word) (&backend_libs__interval_scalar_common_1[0]), (MR_Word) (&backend_libs__interval_scalar_common_1[0]), ((MR_Box) (Arg_19)), ((MR_Box) (Shadow_49)), STATE_VARIABLE_VoidRename_0_7, &STATE_VARIABLE_VoidRename_33_33);
      ...
      case (MR_Integer) 0:
        {
          ...
          backend_libs__interval__build_interval_info_in_goal_5_p_0(TypeClassInfo_for_build_interval_info_acc_357, SubGoal_24, STATE_VARIABLE_IntervalInfo_146_146, &STATE_VARIABLE_IntervalInfo_147_147, STATE_VARIABLE_Acc_145_145, &STATE_VARIABLE_Acc_148_148);
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  backend_libs__interval__use_cell_8_p_0(TypeClassInfo_for_build_interval_info_acc_357, CellVar_274, ArgVars_270, ConsId_100, HeadVar__1_1, STATE_VARIABLE_IntervalInfo_0_112, &STATE_VARIABLE_IntervalInfo_204_204, STATE_VARIABLE_Acc_0_114, &STATE_VARIABLE_Acc_115);
                else
                {
                  STATE_VARIABLE_Acc_115 = STATE_VARIABLE_Acc_0_114;
          ...
          case (MR_Integer) 3:
            {
              ...
              else
              {
                ...
                backend_libs__interval__build_interval_info_in_disj_11_p_0(TypeClassInfo_for_build_interval_info_acc_357, Goals_230, (MR_Integer) 1, StartAnchor_14, EndAnchor_15, BeforeId_16, AfterId_17, &OpenIntervals_19, STATE_VARIABLE_IntervalInfo_120_120, &STATE_VARIABLE_IntervalInfo_123_123, STATE_VARIABLE_Acc_121_121, &STATE_VARIABLE_Acc_115);
          ...
          case (MR_Integer) 6:
            {
              ...
              backend_libs__interval__build_interval_info_in_goal_5_p_0(TypeClassInfo_for_build_interval_info_acc_357, Then_27, STATE_VARIABLE_IntervalInfo_158_158, &STATE_VARIABLE_IntervalInfo_159_159, STATE_VARIABLE_Acc_157_157, &STATE_VARIABLE_Acc_160_160);
              ...
              backend_libs__interval__build_interval_info_in_goal_5_p_0(TypeClassInfo_for_build_interval_info_acc_357, Cond_26, STATE_VARIABLE_IntervalInfo_161_161, &STATE_VARIABLE_IntervalInfo_162_162, STATE_VARIABLE_Acc_160_160, &STATE_VARIABLE_Acc_163_163);
              ...
              backend_libs__interval__build_interval_info_in_goal_5_p_0(TypeClassInfo_for_build_interval_info_acc_357, Else_28, STATE_VARIABLE_IntervalInfo_167_167, &STATE_VARIABLE_IntervalInfo_168_168, STATE_VARIABLE_Acc_166_166, &STATE_VARIABLE_Acc_169_169);
