...
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 283,4,7,9,10,11,12,14,13,18)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 3,21,25,28,29,23,32,34,35,36)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 37,40,39,42,43,44,45,46,47,31)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 51,52,53,54,55,56,57,58,59,49)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 63,64,65,66,61,69,70,72,75,74)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 77,68,80,79,88,89,90,91,93,87)
MR_decl_label10(backend_libs__interval__build_interval_info_in_goal_5_0, 99,97,105,106,107,104,110,103,116,118)
MR_decl_label8(backend_libs__interval__build_interval_info_in_goal_5_0, 114,122,124,113,128,129,125,95)
...
MR_BEGIN_MODULE(backend_libs__interval_module22)
	...
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,283,4,7,9,10,11,12,14,13,18)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,3,21,25,28,29,23,32,34,35,36)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,37,40,39,42,43,44,45,46,47,31)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,51,52,53,54,55,56,57,58,59,49)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,63,64,65,66,61,69,70,72,75,74)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,77,68,80,79,88,89,90,91,93,87)
	MR_init_label10(backend_libs__interval__build_interval_info_in_goal_5_0,99,97,105,106,107,104,110,103,116,118)
	MR_init_label8(backend_libs__interval__build_interval_info_in_goal_5_0,114,122,124,113,128,129,125,95)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,283)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,37)
	...
	if (MR_PTAG_TESTR(MR_sv(2),3)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i39);
	}
	MR_sv(7) = MR_r1;
	MR_r2 = MR_sv(9);
	MR_np_call_localret_ent(backend_libs__interval__require_in_regs_3_0,
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,49)
	...
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i61);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,72)
	...
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i74);
	}
	MR_sv(2) = MR_r1;
	MR_r2 = MR_sv(9);
	MR_np_call_localret_ent(backend_libs__interval__require_in_regs_3_0,
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,80)
	...
	MR_r2 = MR_r6;
	MR_succip_word = MR_sv(12);
	MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i283);
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i87);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r5;
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,87)
	...
	if (MR_PTAG_TESTR(MR_tempr1,2)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i97);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,105)
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i106);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r6;
...
MR_def_label(backend_libs__interval__build_interval_info_in_goal_5_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(backend_libs__interval__build_interval_info_in_goal_5_0_i107);
	}
	MR_r1 = (MR_Word) MR_string_const("backend_libs.interval", 21);
