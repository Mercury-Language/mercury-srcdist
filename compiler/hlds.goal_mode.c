  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__13_13 = (MR_Word) (&hlds__goal_mode_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__13_13, ((MR_Box) (ArgX1_5)), ((MR_Box) (ArgY1_6)));
      if (succeeded)
      {
        TypeInfo__14_14 = (MR_Word) (&hlds__goal_mode_scalar_common_1[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__14_14, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        if (succeeded)
        {
          TypeInfo__15_15 = (MR_Word) (&hlds__goal_mode_scalar_common_1[1]);
  ...
  MR_Word * STATE_VARIABLE_BoundNonGroundedVars_28)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_13, Var_16, &Type_22);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  succeeded = hlds__hlds_pred__proc_info_is_valid_mode_1_p_0(STATE_VARIABLE_ProcInfo_0_12);
  if (succeeded)
  {
    MR_Word VarTypes_7;
    MR_Word InstMap0_8;
    ...
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_12, &_VarSet_6, &VarTypes_7);
    hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(ModuleInfo_4, STATE_VARIABLE_ProcInfo_0_12, &InstMap0_8);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &Goal0_9);
    hlds__goal_mode__compute_goal_modes_in_goal_6_p_0(ModuleInfo_4, VarTypes_7, InstMap0_8, &_InstMap_10, Goal0_9, &Goal_11);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_11, STATE_VARIABLE_ProcInfo_0_12, STATE_VARIABLE_ProcInfo_13);
  }
  else
    *STATE_VARIABLE_ProcInfo_13 = STATE_VARIABLE_ProcInfo_0_12;
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_ProcInfo_13;

  hlds__goal_mode__compute_goal_modes_in_proc_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_ProcInfo_13);
  *wrapper_arg_2 = ((MR_Box) (conv0_STATE_VARIABLE_ProcInfo_13));
}
