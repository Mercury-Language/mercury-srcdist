  ...
  MR_Word GoalMode_7)
{
  ...
  if ((GoalMode_7 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      STATE_VARIABLE_DumpStrs_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 0) = ((MR_Box) (Var_24));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        STATE_VARIABLE_DumpStrs_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 0) = ((MR_Box) (Var_28));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    else
    {
      ...
      else
      {
        ...
        {
          STATE_VARIABLE_DumpStrs_31_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_31_31, 0) = ((MR_Box) (NonGroundedStr_17));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_31_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      }
      ...
      else
      {
        ...
        {
          STATE_VARIABLE_DumpStrs_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 0) = ((MR_Box) (GroundedStr_21));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_22, 1) = ((MR_Box) (STATE_VARIABLE_DumpStrs_31_31));
        }
      }
    }
  }
