  ...
  MR_Word GoalMode_7)
{
  ...
  if ((GoalMode_7 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_44 = mercury__string__f_43_43_2_f_0(PrefixStr_5, (MR_String) "gm_unreachable\n");
    {
      STATE_VARIABLE_DumpStrs_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_20, 0) = ((MR_Box) (Var_44));
  ...
  else
  {
    ...
    {
      MR_Word STATE_VARIABLE_DumpStrs_34_34;

      if ((BoundNonGroundedVars_13 == (MR_Word) ((MR_Unsigned) 0U)))
        STATE_VARIABLE_DumpStrs_34_34 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (VarTable_6));
        }
        Var_28 = parse_tree__parse_tree_out_term__mercury_vars_to_string_src_3_f_0(Var_29, (MR_Integer) 1, BoundNonGroundedVars_13);
        ...
        {
          STATE_VARIABLE_DumpStrs_34_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_34_34, 0) = ((MR_Box) (NonGroundedStr_16));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_34_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      }
      if ((BoundGroundedVars_12 == (MR_Word) ((MR_Unsigned) 0U)))
        STATE_VARIABLE_DumpStrs_20 = STATE_VARIABLE_DumpStrs_34_34;
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (VarTable_6));
        }
        Var_38 = parse_tree__parse_tree_out_term__mercury_vars_to_string_src_3_f_0(Var_39, (MR_Integer) 1, BoundGroundedVars_12);
        Var_37 = mercury__string__f_43_43_2_f_0(Var_38, (MR_String) "\n");
        Var_35 = mercury__string__f_43_43_2_f_0((MR_String) "bound and grounded: ", Var_37);
        GroundedStr_19 = mercury__string__f_43_43_2_f_0(PrefixStr_5, Var_35);
        {
          STATE_VARIABLE_DumpStrs_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_20, 0) = ((MR_Box) (GroundedStr_19));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_20, 1) = ((MR_Box) (STATE_VARIABLE_DumpStrs_34_34));
        }
      }
    }
  }
