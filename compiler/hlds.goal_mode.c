          ...
          case (MR_Integer) 2:
            {
              ...
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 1) = (MR_Box) ((MR_Unsigned) (ConjType_40));
          ...
          case (MR_Integer) 3:
            {
              ...
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word CanFail_46 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word Cases0_47 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 3))));
              MR_Word Cases_48;
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 2)));

              hlds__goal_mode__compute_goal_modes_in_switch_5_p_0(ModuleInfo_7, VarTypes_8, InstMap0_9, Cases0_47, &Cases_48);
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 1) = ((MR_Box) (Var_45));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 2) = (MR_Box) ((MR_Unsigned) (CanFail_46));
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 6U));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) Shorthand0_64)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word AtomicGoalType_71 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_64, (MR_Integer) 0))) & (MR_Integer) 3);
                    ...
                    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_64, (MR_Integer) 0)));
                    MR_Word Var_78;
                    ...
                    {
                      Shorthand_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Shorthand_70, 0) = (MR_Box) ((MR_Unsigned) (AtomicGoalType_71));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    {
                      Shorthand_70 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              ...
              {
                GoalExpr_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_39, 0) = ((MR_Box) ((MR_Unsigned) 7U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        GoalMode_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((GoalMode_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        STATE_VARIABLE_DumpStrs_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            STATE_VARIABLE_DumpStrs_33_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
