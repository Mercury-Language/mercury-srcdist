...
{
  {
    ...
    if ((GoalMode_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_42 = mercury__string__f_43_43_2_f_0(PrefixStr_5, (MR_String) "gm_unreachable\n");
      {
        ...
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    else
    {
      ...
      else
      {
        ...
        if ((BoundNonGroundedVars_13 == (MR_Word) ((MR_Unsigned) 0U)))
          STATE_VARIABLE_DumpStrs_33_33 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          ...
          NonGroundedStr_16 = mercury__string__f_43_43_2_f_0(PrefixStr_5, Var_25);
          {
            ...
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_DumpStrs_33_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
