                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  TypeInfo_42_42 = (MR_Word) (&parse_tree__prog_data_foreign_scalar_common_1[3]);
                                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_42_42, ((MR_Box) (ArgX16_33)), ((MR_Box) (ArgY16_34)));
                                  if (succeeded)
                                  {
                                    TypeInfo_43_43 = (MR_Word) (&parse_tree__prog_data_foreign_scalar_common_1[4]);
                                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_43_43, ((MR_Box) (ArgX17_35)), ((MR_Box) (ArgY17_36)));
                                    if (succeeded)
                                    {
                                      TypeInfo_44_44 = (MR_Word) (&parse_tree__prog_data_foreign_scalar_common_1[5]);
