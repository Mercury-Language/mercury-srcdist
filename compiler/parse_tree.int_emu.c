...
static const MR_PseudoTypeInfo parse_tree__int_emu__parse_tree__int_emu__field_types_op_type_0_0[1] = {
  (MR_PseudoTypeInfo) (&parse_tree__int_emu__parse_tree__int_emu__type_ctor_info_op_num_bits_0)
};
  ...
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 0))
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 0))
    {
      ...
      parse_tree__int_emu____Compare____op_num_bits_0_0(HeadVar__1_1, Var_16, ArgY1_5);
    }
    else
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__int_emu____Compare____op_num_bits_0_0(HeadVar__1_1, Var_17, ArgY1_11);
    }
  }
}
