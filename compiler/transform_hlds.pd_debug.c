    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_23, Stream_14, ModuleInfo_10, Var_42, (MR_Integer) 1, TVarSet_25, InstVarSet_26, (MR_Unsigned) 1U, (MR_String) "\n", Goal_8);
