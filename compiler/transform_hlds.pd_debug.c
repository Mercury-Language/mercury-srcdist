...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 85, &DebugPD_10);
    switch (DebugPD_10) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 85, &DebugPD_11);
    switch (DebugPD_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 85, &DebugPD_12);
    switch (DebugPD_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
transform_hlds__pd_debug__pd_debug_search_version_result_2_4_p_0(
  ...
  MR_Word MaybeVersion_6)
{
  if ((MaybeVersion_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
  ...
  else
  {
    ...
    MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 0)));
    MR_Word Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 4)));
    MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_75;
    MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Version_9, (MR_Integer) 1)));
    MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), Version_9, (MR_Integer) 3)));
    MR_Word Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), Version_9, (MR_Integer) 8)));
    MR_Word _GoalExpr_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_12, (MR_Integer) 0)));
    MR_Word Var_29;
    ...
    TypeCtorInfo_86_86 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_86_86, Parents_19, &ParentsList_35);
    {
    ...
    mercury__io__write_list_5_p_0(TypeCtorInfo_86_86, ParentsList_35, (MR_String) ", ", Var_75);
    mercury__io__nl_2_p_0();
