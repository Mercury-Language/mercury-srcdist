  ...
  MR_Word Goal_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 101, &DebugPD_12);
  switch (DebugPD_12) {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_10, ProcInfo_17, &VarTable_18);
        ...
        OutInfo_22 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_11, (MR_Integer) 1);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (VarTable_18));
        }
        InstmapStr_23 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(Var_30, (MR_Integer) 1, (MR_Integer) 1, VarsInstMap_21);
        ...
        hlds__hlds_out__hlds_out_goal__write_goal_nl_10_p_0(OutInfo_22, Stream_14, ModuleInfo_10, Var_30, (MR_Integer) 1, (MR_Integer) 1, (MR_String) "\n", Goal_8);
  ...
  MR_Word PredProcIds_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 101, &DebugPD_10);
  switch (DebugPD_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word PDInfo_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 101, &DebugPD_8);
  switch (DebugPD_8) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_6, ProcInfo_11, &VarTable_12);
        transform_hlds__pd_info__pd_info_get_instmap_2_p_0(PDInfo_4, &InstMap_13);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (VarTable_12));
        }
        InstMapStr_14 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(Var_19, (MR_Integer) 1, (MR_Integer) 1, InstMap_13);
  ...
  MR_Word WriteUnfoldedGoal_12)
{
  ...
  MR_Word ProcInfo_32;
  MR_Word VarTable_33;
  MR_Word VarNameSrc_34;
  MR_Word InstMap1_35;
  MR_String ArgsStr_36;
  MR_String InstMap1Str_37;
  MR_Word Globals_38;
  MR_Word OutInfo_39;
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), PredInt_28, &Var_101);
  mercury__io__write_string_4_p_0(Stream_8, Var_101);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "-");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), ProcInt_29, &Var_111);
  mercury__io__write_string_4_p_0(Stream_8, Var_111);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")\n");
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " initial cost: ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), InitialCost_19, &Var_122);
  mercury__io__write_string_4_p_0(Stream_8, Var_122);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " cost delta: ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), CostDelta_20, &Var_133);
  mercury__io__write_string_4_p_0(Stream_8, Var_133);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_9, ProcInfo_32, &VarTable_33);
  {
    VarNameSrc_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), VarNameSrc_34, 0) = ((MR_Box) (VarTable_33));
  }
  hlds__instmap__instmap_restrict_3_p_0(NonLocals_30, InstMap_18, &InstMap1_35);
  ArgsStr_36 = parse_tree__parse_tree_out_term__mercury_vars_to_string_src_3_f_0(VarNameSrc_34, (MR_Integer) 1, Args_16);
  InstMap1Str_37 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(VarNameSrc_34, (MR_Integer) 1, (MR_Integer) 1, InstMap1_35);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " args: ");
  mercury__io__write_string_4_p_0(Stream_8, ArgsStr_36);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  mercury__io__write_string_4_p_0(Stream_8, InstMap1Str_37);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_9, &Globals_38);
  OutInfo_39 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_38, (MR_Integer) 1);
  hlds__hlds_out__hlds_out_goal__write_goal_nl_10_p_0(OutInfo_39, Stream_8, ModuleInfo_9, VarNameSrc_34, (MR_Integer) 1, (MR_Integer) 1, (MR_String) "\n", Goal_14);
  ...
  MR_Word Args_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 101, &DebugPD_14);
  switch (DebugPD_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
