    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (VarTable_18));
        }
  ...
  MR_Word WriteUnfoldedGoal_12)
{
  ...
  {
    VarNameSrc_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), VarNameSrc_39, 0) = ((MR_Box) (VarTable_33));
  }
