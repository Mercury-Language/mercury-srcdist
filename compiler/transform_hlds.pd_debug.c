...
MR_decl_entry(fn__hlds__hlds_out__init_hlds_out_info_1_0);
MR_decl_entry(hlds__hlds_out__write_goal_9_0);
...
MR_def_label(transform_hlds__pd_debug__pd_debug_output_version_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__hlds__hlds_out__init_hlds_out_info_1_0,
...
MR_def_label(transform_hlds__pd_debug__pd_debug_output_version_6_0,28)
	...
	MR_np_call_localret_ent(hlds__hlds_out__write_goal_9_0,
