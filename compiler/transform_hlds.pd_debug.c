...
MR_decl_label4(transform_hlds__pd_debug__pd_debug_output_goal_2_5_0, 12,13,14,15)
...
MR_def_static(transform_hlds__pd_debug__pd_debug_output_version_6_0)
	...
	MR_sv(4) = MR_tfield(0, MR_sv(11), 1);
...
MR_BEGIN_MODULE(transform_hlds__pd_debug_module11)
	...
	MR_init_label4(transform_hlds__pd_debug__pd_debug_output_goal_2_5_0,12,13,14,15)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_debug__pd_debug_output_goal_2_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__nl_2_0,
		transform_hlds__pd_debug__pd_debug_output_goal_2_5_0_i15);
MR_def_label(transform_hlds__pd_debug__pd_debug_output_goal_2_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
