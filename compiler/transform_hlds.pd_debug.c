  ...
  MR_Word Goal_10)
{
  ...
  if (!((MaybeDebugStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) "\n");
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_18, &VarTable_19);
    ...
    hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo_18, &InstVarSet_27);
    {
  ...
  MR_Word Goals_10)
{
  ...
  if (!((MaybeDebugStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(DebugStream_13, Msg_9);
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) "\n");
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_22, &VarTable_23);
    ...
    hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo_22, &InstVarSet_31);
    {
  ...
  MR_Word PredProcIds_8)
{
  ...
  if (!((MaybeDebugStream_10 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    ProcStrs_13 = mercury__list__map_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_17, PredProcIds_8);
  ...
  MR_String IdStr_6)
{
  ...
  if (!((MaybeDebugStream_8 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_10, &VarTable_11);
  ...
  MR_Word WriteUnfoldedGoal_12)
{
  ...
  hlds__pred_proc_id__pred_id_to_int_2_p_0(PredId_26, &PredInt_28);
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_27, &ProcInt_29);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_32, &VarTable_33);
  ...
  hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo_32, &InstVarSet_41);
  ...
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Parents_21, &ParentsList_42);
  {
  ...
  ParentStrs_43 = mercury__list__map_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_82, ParentsList_42);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_proc__proc_info_get_goal_2_p_0(ProcInfo_32, &ProcGoal_45);
