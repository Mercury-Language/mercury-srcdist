  ...
  MR_Word Goal_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 103, &DebugPD_12);
  switch (DebugPD_12) {
    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__pd_info__pd_info_get_pred_info_2_p_0(PDInfo_6, &PredInfo_17);
        transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(PDInfo_6, &ProcInfo_18);
        ...
        InstmapStr_24 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(VarTable_19, (MR_Integer) 1, (MR_Integer) 1, VarsInstMap_22);
        mercury__io__write_string_4_p_0(Stream_14, InstmapStr_24);
        mercury__io__write_string_4_p_0(Stream_14, Msg_7);
        mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_17, &TVarSet_25);
        hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_18, &InstVarSet_26);
        {
          Var_42 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_42, 0) = ((MR_Box) (VarTable_19));
        }
        hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_23, Stream_14, ModuleInfo_10, Var_42, (MR_Integer) 1, TVarSet_25, InstVarSet_26, (MR_Integer) 1, (MR_String) "\n", Goal_8);
  ...
  MR_Word PredProcIds_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 103, &DebugPD_10);
  switch (DebugPD_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word PDInfo_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 103, &DebugPD_8);
  switch (DebugPD_8) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word WriteUnfoldedGoal_12)
{
  ...
  hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_38, Stream_8, ModuleInfo_9, VarNameSrc_39, (MR_Integer) 1, TVarSet_40, InstVarSet_41, (MR_Integer) 1, (MR_String) "\n", Goal_14);
  ...
  MR_Word Args_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 103, &DebugPD_14);
  switch (DebugPD_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__parse_tree_out_misc__write_context_4_p_0(Stream_16, Context_8);
