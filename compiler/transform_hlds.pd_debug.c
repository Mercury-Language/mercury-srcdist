...
MR_decl_label8(transform_hlds__pd_debug__pd_debug_output_version_6_0, 26,27,28,29,30,32,33,36)
MR_decl_label3(transform_hlds__pd_debug__pd_debug_output_version_6_0, 37,38,34)
...
MR_decl_label4(transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_0, 2,3,7,4)
...
/*-------------------------------------------------------------------------*/
/* code for 'pd_debug_do_io'/3 mode 0 */
...
/*-------------------------------------------------------------------------*/
/* code for 'pd_debug_message'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'pd_debug_write'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__pd_debug_module8)
	...
	MR_init_label4(transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_0,2,3,7,4)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_0,3)
	...
	MR_np_call_localret_ent(io__write_list_5_0,
		transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_0_i7);
MR_def_label(transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(io__flush_output_2_0);
...
MR_BEGIN_MODULE(transform_hlds__pd_debug_module9)
	...
	MR_init_label8(transform_hlds__pd_debug__pd_debug_output_version_6_0,26,27,28,29,30,32,33,36)
	MR_init_label3(transform_hlds__pd_debug__pd_debug_output_version_6_0,37,38,34)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_debug__pd_debug_output_version_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__nl_2_0,
		transform_hlds__pd_debug__pd_debug_output_version_6_0_i33);
MR_def_label(transform_hlds__pd_debug__pd_debug_output_version_6_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_sv(2),0)) {
		MR_GOTO_LAB(transform_hlds__pd_debug__pd_debug_output_version_6_0_i34);
	}
	MR_r1 = MR_sv(6);
