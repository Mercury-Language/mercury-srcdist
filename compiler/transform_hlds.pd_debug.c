...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__pd_debug__Globals_9, (MR_Integer) 83, &transform_hlds__pd_debug__DebugPD_10);
    }
    switch (transform_hlds__pd_debug__DebugPD_10) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word transform_hlds__pd_debug__Var_31;

          {
            transform_hlds__pd_debug__Var_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_31, 0) = ((MR_Box) (&transform_hlds__pd_debug_scalar_common_1[0]));
            MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_31, 1) = ((MR_Box) (transform_hlds__pd_debug__pd_debug_write_pred_proc_id_list_4_p_0_1));
            MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_31, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_31, 3) = ((MR_Box) (transform_hlds__pd_debug__ModuleInfo_8));
          }
          {
            mercury__io__write_list_5_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, transform_hlds__pd_debug__PredProcIds_6, (MR_String) ", ", transform_hlds__pd_debug__Var_31);
          }
          {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__pd_debug__Globals_10, (MR_Integer) 83, &transform_hlds__pd_debug__DebugPD_11);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__pd_debug__Globals_11, (MR_Integer) 83, &transform_hlds__pd_debug__DebugPD_12);
    }
...
{
  {
    ...
    if ((transform_hlds__pd_debug__MaybeVersion_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word transform_hlds__pd_debug__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_debug__MaybeVersion_6, (MR_Integer) 2)));
        MR_Word transform_hlds__pd_debug__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_debug__MaybeVersion_6, (MR_Integer) 1)));
        MR_Word transform_hlds__pd_debug__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_debug__MaybeVersion_6, (MR_Integer) 0)));
        MR_Word transform_hlds__pd_debug__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_debug__MaybeVersion_6, (MR_Integer) 4)));
        MR_Word transform_hlds__pd_debug__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_debug__MaybeVersion_6, (MR_Integer) 3)));

        switch (transform_hlds__pd_debug__Var_32) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              {
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                transform_hlds__pd_debug__pd_debug_output_version_6_p_0(transform_hlds__pd_debug__ModuleInfo_5, transform_hlds__pd_debug__Var_31, transform_hlds__pd_debug__Var_30, (MR_Integer) 0);
              }
            }
            break;
        }
...
{
  {
    ...
    MR_Word transform_hlds__pd_debug__Var_75;
    MR_Word transform_hlds__pd_debug__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Version_9, (MR_Integer) 1)));
    MR_Word transform_hlds__pd_debug__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Version_9, (MR_Integer) 3)));
    MR_Word transform_hlds__pd_debug__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Version_9, (MR_Integer) 8)));
    ...
    MR_Word transform_hlds__pd_debug__Var_29;
    ...
    {
      hlds__hlds_module__module_info_pred_proc_info_5_p_0(transform_hlds__pd_debug__ModuleInfo_7, transform_hlds__pd_debug__PredId_24, transform_hlds__pd_debug__ProcId_25, &transform_hlds__pd_debug__Var_29, &transform_hlds__pd_debug__ProcInfo_30);
    }
    {
    ...
    {
      transform_hlds__pd_debug__Var_75 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_75, 0) = ((MR_Box) (&transform_hlds__pd_debug_scalar_common_1[0]));
      MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_75, 1) = ((MR_Box) (transform_hlds__pd_debug__pd_debug_output_version_6_p_0_1));
      MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_75, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), transform_hlds__pd_debug__Var_75, 3) = ((MR_Box) (transform_hlds__pd_debug__ModuleInfo_7));
    }
    {
      mercury__io__write_list_5_p_0(transform_hlds__pd_debug__TypeCtorInfo_86_86, transform_hlds__pd_debug__ParentsList_35, (MR_String) ", ", transform_hlds__pd_debug__Var_75);
    }
    {
      mercury__io__nl_2_p_0();
    }
