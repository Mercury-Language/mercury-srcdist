  ...
  MR_Word Goal_10)
{
  ...
  if (!((MaybeDebugStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    transform_hlds__pd_info__pd_info_get_pred_info_2_p_0(PDInfo_7, &PredInfo_16);
    transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(PDInfo_7, &ProcInfo_17);
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_17, &VarTable_18);
    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_16, &TVarSet_19);
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_17, &InstVarSet_20);
    hlds__goal_util__goal_vars_2_p_0(Goal_10, &Vars_21);
    transform_hlds__pd_info__pd_info_get_instmap_2_p_0(PDInfo_7, &InstMap_22);
    hlds__instmap__instmap_restrict_3_p_0(Vars_21, InstMap_22, &VarsInstMap_23);
    transform_hlds__pd_info__pd_info_get_module_info_2_p_0(PDInfo_7, &ModuleInfo_24);
    ...
    InstmapStr_27 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(VarTable_18, (MR_Integer) 1, (MR_Unsigned) 1U, VarsInstMap_23);
    ...
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) "\n");
    {
      ...
      MR_hl_field(1, Var_40, 0) = ((MR_Box) (VarTable_18));
    }
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_26, DebugStream_13, ModuleInfo_24, Var_40, (MR_Integer) 1, TVarSet_19, InstVarSet_20, (MR_Unsigned) 1U, (MR_String) "\n", Goal_10);
  ...
  MR_Word Goals_10)
{
  ...
  if (!((MaybeDebugStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    MR_Word Vars_25;
    MR_Word InstMap_26;
    MR_Word VarsInstMap_27;
    MR_Word ModuleInfo_28;
    MR_Word Globals_29;
    MR_Word OutInfo_30;
    MR_String InstmapStr_31;
    MR_Word Var_44;
    ...
    transform_hlds__pd_info__pd_info_get_pred_info_2_p_0(PDInfo_7, &PredInfo_20);
    transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(PDInfo_7, &ProcInfo_21);
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_21, &VarTable_22);
    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_20, &TVarSet_23);
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_21, &InstVarSet_24);
    hlds__goal_util__goal_vars_2_p_0(Goal_16, &Vars_25);
    transform_hlds__pd_info__pd_info_get_instmap_2_p_0(PDInfo_7, &InstMap_26);
    hlds__instmap__instmap_restrict_3_p_0(Vars_25, InstMap_26, &VarsInstMap_27);
    transform_hlds__pd_info__pd_info_get_module_info_2_p_0(PDInfo_7, &ModuleInfo_28);
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_28, &Globals_29);
    OutInfo_30 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_29, (MR_Integer) 1);
    InstmapStr_31 = hlds__hlds_out__hlds_out_mode__instmap_to_string_4_f_0(VarTable_22, (MR_Integer) 1, (MR_Unsigned) 1U, VarsInstMap_27);
    mercury__io__write_string_4_p_0(DebugStream_13, IdStr_8);
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) ": ");
    mercury__io__write_string_4_p_0(DebugStream_13, Msg_9);
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) "\n");
    mercury__io__write_string_4_p_0(DebugStream_13, InstmapStr_31);
    mercury__io__write_string_4_p_0(DebugStream_13, (MR_String) "\n");
    {
      Var_44 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_44, 0) = ((MR_Box) (VarTable_22));
    }
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_30, DebugStream_13, ModuleInfo_28, Var_44, (MR_Integer) 1, TVarSet_23, InstVarSet_24, (MR_Unsigned) 1U, (MR_String) "\n", Goal_16);
    mercury__io__flush_output_3_p_0(DebugStream_13);
  }
}
