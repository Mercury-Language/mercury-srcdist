  ...
  MR_Word Goal_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 99, &DebugPD_12);
  switch (DebugPD_12) {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_17, &VarSet_18, &_VarTypes_19);
        transform_hlds__pd_info__pd_info_get_instmap_2_p_0(PDInfo_6, &InstMap_20);
        hlds__goal_util__goal_vars_2_p_0(Goal_8, &Vars_21);
        hlds__instmap__instmap_restrict_3_p_0(Vars_21, InstMap_20, &VarsInstMap_22);
        OutInfo_23 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_11, (MR_Integer) 1);
        mercury__io__write_string_4_p_0(Stream_14, Msg_7);
        hlds__hlds_out__hlds_out_mode__write_instmap_7_p_0(Stream_14, VarSet_18, (MR_Integer) 1, (MR_Integer) 1, VarsInstMap_22);
        mercury__io__nl_3_p_0(Stream_14);
        {
          Var_35 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (VarSet_18));
        }
        hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_23, Stream_14, ModuleInfo_10, Var_35, (MR_Integer) 1, (MR_Integer) 1, (MR_String) "\n", Goal_8);
        mercury__io__nl_3_p_0(Stream_14);
  ...
  MR_Word PredProcIds_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 99, &DebugPD_10);
  switch (DebugPD_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word PDInfo_4)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_8, &VarSet_9, &_VarTypes_10);
  transform_hlds__pd_info__pd_info_get_module_info_2_p_0(PDInfo_4, &ModuleInfo_11);
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_Word Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 2))));
          MR_Word Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 1))));
          MR_Word Var_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeVersion_6, (MR_Integer) 0))) & (MR_Integer) 1);
  ...
  MR_Word WriteUnfoldedGoal_12)
{
  ...
  MR_Word Globals_36;
  MR_Word OutInfo_37;
  MR_Word ParentsList_38;
  MR_Word ParentStrs_39;
  MR_String ParentsStr_40;
  MR_String Var_67;
  MR_Word Var_75;
  MR_Word Var_81;
  MR_String Var_104;
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), PredInt_28, &Var_104);
  mercury__io__write_string_4_p_0(Stream_8, Var_104);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "-");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), ProcInt_29, &Var_114);
  mercury__io__write_string_4_p_0(Stream_8, Var_114);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")\n");
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " initial cost: ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), InitialCost_19, &Var_125);
  mercury__io__write_string_4_p_0(Stream_8, Var_125);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " cost delta: ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__pd_debug_scalar_common_1[0]), CostDelta_20, &Var_136);
  mercury__io__write_string_4_p_0(Stream_8, Var_136);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_32, &VarSet_33, &_VarTypes_34);
  hlds__instmap__instmap_restrict_3_p_0(NonLocals_30, InstMap_18, &InstMap1_35);
  Var_67 = parse_tree__parse_tree_out_term__mercury_vars_to_string_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_33, (MR_Integer) 1, Args_16);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " args: ");
  mercury__io__write_string_4_p_0(Stream_8, Var_67);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
  hlds__hlds_out__hlds_out_mode__write_instmap_7_p_0(Stream_8, VarSet_33, (MR_Integer) 1, (MR_Integer) 1, InstMap1_35);
  mercury__io__nl_3_p_0(Stream_8);
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_9, &Globals_36);
  OutInfo_37 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_36, (MR_Integer) 1);
  {
    Var_75 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (VarSet_33));
  }
  hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_37, Stream_8, ModuleInfo_9, Var_75, (MR_Integer) 1, (MR_Integer) 1, (MR_String) "\n", Goal_14);
  mercury__io__nl_3_p_0(Stream_8);
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), Parents_21, &ParentsList_38);
  {
    Var_81 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&transform_hlds__pd_debug_scalar_common_2[0]));
    MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (transform_hlds__pd_debug__pd_debug_output_version_7_p_0_1));
    MR_hl_field(MR_mktag(0), Var_81, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_81, 3) = ((MR_Box) (ModuleInfo_9));
  }
  ParentStrs_39 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_81, ParentsList_38);
  ParentsStr_40 = mercury__string__join_list_2_f_0((MR_String) ", ", ParentStrs_39);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "Parents: ");
  mercury__io__write_string_4_p_0(Stream_8, ParentsStr_40);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_32, &ProcGoal_41);
  ...
  MR_Box Thing_6)
{
  switch (DebugPD_5) {
    ...
    case (MR_Integer) 1:
      {
        mercury__io__write_3_p_0(TypeInfo_for_T_11, Thing_6);
        mercury__io__flush_output_2_p_0();
      }
      break;
  }
