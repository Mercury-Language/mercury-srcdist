    ...
    case (MR_Integer) 1:
      {
        ...
        Var_115 = hlds__hlds_pred__pred_id_to_int_1_f_0(PredId_4);
  ...
  MR_Word * PDInfo_8)
{
  ...
  libs__globals__lookup_maybe_int_option_3_p_0(Globals_9, (MR_Integer) 717, &MaybeDebugPDPredId_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 716, &DebugPD_11);
  ...
  mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__pd_info__transform_hlds__pd_info__type_ctor_info_version_info_0), &Versions_17);
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &ParentVersions_18);
  transform_hlds__pd_term__global_term_info_init_1_p_0(&GlobalTermInfo_19);
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &CreatedVersions_21);
