  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_32_59 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
        parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_32_59, OldNonLocals0_54, &OldNonLocalsList_55);
        Var_58 = (MR_Integer) 0;
