...
{
  {
    ...
    MR_Word MaybeUnfoldInfo_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_0_39, (MR_Integer) 1))));
    MR_Word _ExtraArgs_37;

    if ((MaybeUnfoldInfo_61 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
      ...
      UnfoldInfo_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_61, (MR_Integer) 0))));
    ...
    transform_hlds__pd_info__pd_info_set_counter_3_p_0(Counter_19, STATE_VARIABLE_PDInfo_0_39, &STATE_VARIABLE_PDInfo_41_41);
...
{
  {
    ...
    MR_Word InstMap_13;
    MR_Word VarTypes_14;
    MR_Word UnfoldInfo_57;
    MR_Word MaybeUnfoldInfo_70;
    ...
    MaybeUnfoldInfo_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PDInfo_4, (MR_Integer) 1))));
    ...
    if ((MaybeUnfoldInfo_70 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.pd_info.pd_info_get_unfold_info\'/2", (MR_String) "unfold_info not set");
        return;
      ...
      UnfoldInfo_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_70, (MR_Integer) 0))));
    ProcInfo_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnfoldInfo_57, (MR_Integer) 0))));
...
{
  {
    ...
    MR_Word MaybeUnfoldInfo_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_0_17, (MR_Integer) 1))));
    ...
    transform_hlds__pd_info__pd_info_set_module_info_3_p_0(ModuleInfo_16, STATE_VARIABLE_PDInfo_19_19, STATE_VARIABLE_PDInfo_18);
  }
}
