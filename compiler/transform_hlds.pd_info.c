...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Calls_9)) == (MR_Integer) 1);
    if (succeeded)
    {
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(1), MaybeVersion1_31, 0) = (MR_Box) ((MR_Unsigned) (Exact_67));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__6_6, (MR_Integer) 0)));
...
{
  {
    ...
    if ((MaybeUnfoldInfo_24 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo0_6, (MR_Integer) 8)));
    Var_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), UnfoldInfo0_6, (MR_Integer) 9))));
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo0_6, (MR_Integer) 10)));
    {
      ...
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 8) = (MR_Box) (packed_args_0);
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 9) = ((MR_Box) (Var_20));
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 10) = (MR_Box) ((MR_Unsigned) (Rerun_4));
    }
    {
...
{
  {
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo0_6, (MR_Integer) 10)));
    {
      ...
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 10) = (MR_Box) (packed_args_1);
    }
    {
      Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (UnfoldInfo_7));
...
{
  {
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo0_6, (MR_Integer) 10)));
    {
      ...
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 6) = ((MR_Box) (Var_17));
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 7) = ((MR_Box) (Var_18));
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 8) = (MR_Box) ((MR_Unsigned) (Changed_4));
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 9) = ((MR_Box) (Var_20));
      MR_hl_field(MR_mktag(0), UnfoldInfo_7, 10) = (MR_Box) (packed_args_1);
    }
    {
...
{
  {
    ...
    if ((MaybeUnfoldInfo_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
        mercury__require__unexpected_3_p_0((MR_String) "transform_hlds.pd_info", (MR_String) "predicate \140transform_hlds.pd_info.pd_info_get_unfold_info\'/2", (MR_String) "unfold_info not set");
        return;
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 8)));
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 10)));
    *HeadVar__2_2 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 10))) & (MR_Integer) 1);
  }
}
...
{
  {
    ...
    if ((MaybeUnfoldInfo_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      UnfoldInfo_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_17, (MR_Integer) 0))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 8)));
    *HeadVar__2_2 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 8))) & (MR_Integer) 1);
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnfoldInfo_4, (MR_Integer) 10)));
  }
}
...
{
  {
    ...
    Parents_16 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), ((MR_Box) (PredProcId_6)));
    {
      ...
      MR_hl_field(MR_mktag(0), UnfoldInfo_17, 8) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), UnfoldInfo_17, 9) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), UnfoldInfo_17, 10) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    }
    {
