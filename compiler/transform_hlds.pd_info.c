  ...
  MR_Word * STATE_VARIABLE_PDInfo_39)
{
  ...
  MR_Word MaybeUnfoldInfo_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_0_38, (MR_Integer) 1))));
  ...
  InstMap_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnfoldInfo_47, (MR_Integer) 2))));
  ...
  transform_hlds__pd_info__pd_info_set_counter_3_p_0(Counter_17, STATE_VARIABLE_PDInfo_0_38, &STATE_VARIABLE_PDInfo_40_40);
  ...
  {
    Var_41 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Var_41, 0) = ((MR_Box) (LineNum_22));
    MR_hl_field(MR_mktag(2), Var_41, 1) = ((MR_Box) (SeqNum_16));
  }
  {
