...
{
  {
    ...
    {
      Transform_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Transform_26, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), Transform_26, 1) = ((MR_Box) (Var_44));
    }
    parse_tree__pred_name__make_pred_name_4_p_0(PredModule_21, PredName_22, Transform_26, &NewPredSymName_27);
    ...
    hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo_28, &VarSet_32);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_28, &VarTypes_33);
...
{
  {
    ...
    if (succeeded)
      succeeded = transform_hlds__pd_info__pd_info_get_matching_version_7_p_0(ModuleInfo_11, Goal_5, InstMap_13, VarTypes_14, VersionIds_15, Versions_9, &MaybeVersion0_16);
    if (succeeded)
