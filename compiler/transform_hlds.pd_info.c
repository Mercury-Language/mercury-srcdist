  ...
  MR_Word * STATE_VARIABLE_PDInfo_9)
{
  ...
  if ((MaybeUnfoldInfo_24 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    UnfoldInfo_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_24, (MR_Integer) 0))));
  Delta0_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), UnfoldInfo_11, (MR_Integer) 8))));
  ...
  MR_Word * STATE_VARIABLE_PDInfo_9)
{
  ...
  if ((MaybeUnfoldInfo_24 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    UnfoldInfo_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_24, (MR_Integer) 0))));
  Delta0_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), UnfoldInfo_11, (MR_Integer) 3))));
  Delta_7 = (MR_Integer) ((MR_Unsigned) Delta0_6 + (MR_Unsigned) Delta1_4);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_19)
{
  ...
  MR_Word UnfoldInfo_22;
  MR_Word UnfoldInfo_60;
  MR_Word MaybeUnfoldInfo_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_0_18, (MR_Integer) 1))));
  MR_Word _VarSet_13;

  if ((MaybeUnfoldInfo_73 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.pd_info.pd_info_get_unfold_info\'/2", (MR_String) "unfold_info not set");
      return;
    }
  else
    UnfoldInfo_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_73, (MR_Integer) 0))));
  InstMap0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnfoldInfo_22, (MR_Integer) 2))));
  UnfoldInfo_60 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_73, (MR_Integer) 0))));
  ProcInfo_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnfoldInfo_60, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_PDInfo_11)
{
  ...
  MR_Word Delta_8;
  MR_Word InstMap_9;
  MR_Word UnfoldInfo_13;
  MR_Word MaybeUnfoldInfo_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_0_10, (MR_Integer) 1))));

  if ((MaybeUnfoldInfo_26 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.pd_info.pd_info_get_unfold_info\'/2", (MR_String) "unfold_info not set");
      return;
    }
  else
    UnfoldInfo_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeUnfoldInfo_26, (MR_Integer) 0))));
  InstMap0_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnfoldInfo_13, (MR_Integer) 2))));
