  ...
  MR_Word * STATE_VARIABLE_PDInfo_40)
{
  ...
  ModuleInfo0_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PDInfo_41_41, (MR_Integer) 0))));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (Line_24));
    MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (Count_18));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_26, 2) = ((MR_Box) (Var_43));
  }
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_21, PredName_22, Transform_26, &NewPredSymName_27);
  transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(STATE_VARIABLE_PDInfo_41_41, &ProcInfo_28);
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo0_25, ProcInfo_28, &VarTable_32);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_28, &RttiVarMaps_33);
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_28, &InstVarSet_34);
  ...
  hlds__hlds_pred__define_new_pred_19_p_0(NewPredSymName_27, Origin_7, TVarSet_29, InstVarSet_34, VarTable_32, RttiVarMaps_33, ClassContext_31, InstMap_12, VarNameRemap_36, Markers_30, (MR_Integer) 1, HasParallelConj_35, PredProcId_9, Args_16, &_ExtraArgs_37, Goal_8, CallGoal_10, ModuleInfo0_25, &ModuleInfo_38);
  ...
  MR_Word * MaybeVersion_6)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_11, ProcInfo_12, &VarTable_14);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      OldInstMap_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Version_21, (MR_Integer) 4))));
      {
        ...
        MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (VarTable_4));
      }
      succeeded = transform_hlds__pd_util__goals_match_8_p_0(ModuleInfo_1, OldGoal_22, OldArgs_24, OldArgTypes_25, ThisGoal_2, Var_68, &OldNewRenaming_61, &TypeRenaming_62);
      if (succeeded)
      {
        ...
        TypeCtorInfo_32_70 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
        parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_32_70, OldNonLocals0_65, &OldNonLocalsList_66);
        Var_69 = (MR_Integer) 0;
        succeeded = transform_hlds__pd_info__pd_info_check_insts_8_p_0(ModuleInfo_1, OldNonLocalsList_66, OldNewRenaming_61, OldInstMap_26, ThisInstMap_3, VarTable_4, Var_69, &Exact_67);
        if (succeeded)
        {
          {
  ...
  MR_Word * STATE_VARIABLE_PDInfo_18)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo0_11, ProcInfo_12, &VarTable_13);
