...
void MR_CALL 
make__file_names__get_file_name_9_p_0(
  MR_Word Globals_10,
  MR_String From_11,
  MR_Word Search_12,
  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  if (succeeded)
  {
    ...
    make__module_dep_file__get_maybe_module_dep_info_8_p_0(ProgressStream_19, Globals_10, ModuleName_17, &MaybeModuleDepInfo_20, STATE_VARIABLE_Info_0_28, STATE_VARIABLE_Info_29);
    ...
    else
    {
      ...
      parse_tree__module_dep_info__module_dep_info_get_source_file_name_2_p_0(ModuleDepInfo_21, FileName_14);
    }
  }
  else
  {
    MR_Word TargetExt_22;
    ...
    switch (MR_tag((MR_Word) TargetType_18)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_18)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            TargetExt_22 = (MR_Word) ((MR_Unsigned) 0U);
            break;
          case (MR_Integer) 1:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[12]));
            break;
          case (MR_Integer) 2:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[13]));
            break;
          case (MR_Integer) 3:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[14]));
            break;
          case (MR_Integer) 4:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[16]));
            break;
          case (MR_Integer) 5:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[18]));
            break;
          case (MR_Integer) 6:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[21]));
            break;
          case (MR_Integer) 7:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[6]));
            break;
          case (MR_Integer) 8:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[22]));
            break;
          case (MR_Integer) 9:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[7]));
            break;
          case (MR_Integer) 10:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[10]));
            break;
          case (MR_Integer) 11:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[20]));
            break;
          case (MR_Integer) 12:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[19]));
            break;
          case (MR_Integer) 13:
            TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[24]));
            break;
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word Var_75 = ((MR_Unsigned) ((MR_hl_field(1, TargetType_18, (MR_Integer) 0))) & (MR_Integer) 1);

          switch (Var_75) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[8]));
              break;
            case (MR_Integer) 1:
              TargetExt_22 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[9]));
              break;
          }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word PIC_35 = ((MR_Unsigned) ((MR_hl_field(2, TargetType_18, (MR_Integer) 0))) & (MR_Integer) 1);
          MR_Word ObjExt_36;
          MR_Word Var_70;
          MR_Word Var_37;
          ...
          {
            TargetExt_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, TargetExt_22, 0) = ((MR_Box) (Var_70));
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                TargetExt_22 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(2, TargetExt_22, 0) = (MR_Box) (packed_word_2);
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_String FactFile_39 = ((MR_String) ((MR_hl_field(3, TargetType_18, (MR_Integer) 2))));
              MR_Word PIC_74 = ((MR_Unsigned) ((MR_hl_field(3, TargetType_18, (MR_Integer) 1))) & (MR_Integer) 1);

              {
                TargetExt_22 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, TargetExt_22, 0) = (MR_Box) ((MR_Unsigned) (PIC_74));
                MR_hl_field(3, TargetExt_22, 1) = ((MR_Box) (FactFile_39));
              }
            }
            break;
        }
    ...
    switch (MR_tag((MR_Word) TargetExt_22)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        parse_tree__file_names__module_name_to_source_file_name_4_p_0(ModuleName_17, FileName_14);
        break;
      case (MR_Integer) 1:
        {
          MR_Word Ext_23 = ((MR_Word) ((MR_hl_field(1, TargetExt_22, (MR_Integer) 0))));

          switch (Search_12) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_10, From_11, Ext_23, ModuleName_17, FileName_14);
              break;
            case (MR_Integer) 0:
              parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, From_11, Ext_23, ModuleName_17, FileName_14);
              break;
          }
        }
        break;
      ...
      case (MR_Integer) 3:
        switch (Search_12) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            make__file_names__module_target_to_search_file_name_7_p_0(Globals_10, From_11, TargetType_18, ModuleName_17, FileName_14);
            break;
          case (MR_Integer) 0:
            make__file_names__module_target_to_file_name_7_p_0(Globals_10, From_11, TargetType_18, ModuleName_17, FileName_14);
            break;
        }
        break;
    }
      ...
      case (MR_Integer) 3:
        {
          ...
          parse_tree__file_names__fact_table_file_name_return_dirs_6_p_0(Globals_8, (MR_String) "predicate \140make.file_names.module_target_to_search_file_name\'/7", Var_29, FactFile_19, &_FactDirs_22, FileName_12);
        }
        break;
    }
    break;
      ...
      case (MR_Integer) 3:
        {
          ...
          parse_tree__file_names__fact_table_file_name_return_dirs_6_p_0(Globals_8, (MR_String) "predicate \140make.file_names.module_target_to_file_name\'/7", Var_29, FactFile_19, &_FactDirs_22, FileName_12);
        }
        break;
    }
    break;
