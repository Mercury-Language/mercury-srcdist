  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (succeeded)
  {
    ...
    make__module_dep_file__get_maybe_module_dep_info_8_p_0(ProgressStream_11, Globals_12, ModuleName_19, &MaybeModuleDepInfo_21, STATE_VARIABLE_Info_0_29, STATE_VARIABLE_Info_30);
