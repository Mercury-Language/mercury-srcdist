...
static /* final */ const MR_Box make__file_names_scalar_common_1[23][1];

static /* final */ const MR_Box make__file_names_scalar_common_2[14][2];
...
static /* final */ const MR_Box make__file_names_scalar_common_1[23][1] = {
  ...
  /* row   7 */
  { ((MR_Box) (&make__file_names_scalar_common_1[2])) },
  /* row   8 */
  ...
  /* row  11 */
  { ((MR_Box) (&make__file_names_scalar_common_1[10])) },
  /* row  12 */
  ...
  /* row  15 */
  { ((MR_Box) (MR_mkword(1, &make__file_names_scalar_common_1[14]))) },
  /* row  16 */
  { (MR_Box) ((MR_Unsigned) 3U) },
  /* row  17 */
  { ((MR_Box) (MR_mkword(1, &make__file_names_scalar_common_1[16]))) },
  /* row  18 */
  { ((MR_Box) (MR_mkword(3, &make__file_names_scalar_common_2[10]))) },
  /* row  19 */
  { ((MR_Box) (MR_mkword(3, &make__file_names_scalar_common_2[11]))) },
  /* row  20 */
  { ((MR_Box) (MR_mkword(2, &make__file_names_scalar_common_1[0]))) },
  /* row  21 */
  ...
  switch (MR_tag((MR_Word) ModuleTargetType_3)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(ModuleTargetType_3)) {
        ...
        case (MR_Integer) 6:
          {
            *Ext_4 = (MR_Word) (MR_mkword(3, &make__file_names_scalar_common_2[5]));
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 7:
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_18)) {
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[13]));
            break;
          case (MR_Integer) 4:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[15]));
            break;
          case (MR_Integer) 5:
          ...
          case (MR_Integer) 12:
            ...
            break;
          case (MR_Integer) 13:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[22]));
            break;
        }
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_10)) {
          ...
          case (MR_Integer) 3:
            ...
            break;
          case (MR_Integer) 4:
            TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[15]));
            break;
          case (MR_Integer) 5:
