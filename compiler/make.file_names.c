...
static /* final */ const MR_Box make__file_names_scalar_common_1[22][1];

static /* final */ const MR_Box make__file_names_scalar_common_2[15][2];
...
static /* final */ const MR_Box make__file_names_scalar_common_1[22][1] = {
  ...
  /* row  12 */
  { ((MR_Box) (&make__file_names_scalar_common_1[1])) },
  /* row  13 */
  { (MR_Box) ((MR_Unsigned) 2U) },
  /* row  14 */
  { ((MR_Box) (&make__file_names_scalar_common_1[13])) },
  /* row  15 */
  { (MR_Box) ((MR_Unsigned) 3U) },
  /* row  16 */
  { ((MR_Box) (&make__file_names_scalar_common_1[15])) },
  /* row  17 */
  ...
  /* row  20 */
  { ((MR_Box) (MR_mkword(3, &make__file_names_scalar_common_2[13]))) },
  /* row  21 */
  { ((MR_Box) (MR_mkword(3, &make__file_names_scalar_common_2[14]))) },
};
  ...
  switch (MR_tag((MR_Word) ModuleTargetType_3)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(ModuleTargetType_3)) {
        ...
        case (MR_Integer) 2:
          {
            *Ext_4 = (MR_Word) (&make__file_names_scalar_common_1[2]);
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 3:
          {
            *Ext_4 = (MR_Word) (&make__file_names_scalar_common_1[3]);
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 4:
        ...
        case (MR_Integer) 5:
          {
            *Ext_4 = (MR_Word) (&make__file_names_scalar_common_1[4]);
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 6:
          {
            *Ext_4 = (MR_Word) (MR_mkword(2, &make__file_names_scalar_common_1[0]));
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 7:
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_18)) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[10]));
            break;
          case (MR_Integer) 2:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[11]));
            break;
          case (MR_Integer) 3:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[12]));
            break;
          case (MR_Integer) 4:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[14]));
            break;
          case (MR_Integer) 5:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[16]));
            break;
          case (MR_Integer) 6:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[19]));
            break;
          case (MR_Integer) 7:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[5]));
            break;
          case (MR_Integer) 8:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[20]));
            break;
          case (MR_Integer) 9:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[6]));
            break;
          case (MR_Integer) 10:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[9]));
            break;
          case (MR_Integer) 11:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[18]));
            break;
          case (MR_Integer) 12:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[17]));
            break;
          case (MR_Integer) 13:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[21]));
            break;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          switch (Var_73) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[7]));
              break;
            case (MR_Integer) 1:
              TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[8]));
              break;
          }
        }
        break;
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_10)) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 2:
            TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[11]));
            break;
          case (MR_Integer) 3:
          ...
          case (MR_Integer) 6:
            ...
            break;
          case (MR_Integer) 7:
            TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[5]));
            break;
          case (MR_Integer) 8:
          ...
          case (MR_Integer) 11:
            ...
            break;
          case (MR_Integer) 12:
            TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[17]));
            break;
          case (MR_Integer) 13:
