...
void MR_CALL 
make__file_names__get_file_name_for_target_file_10_p_0(
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_20)) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[11]));
            break;
          case (MR_Integer) 2:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[12]));
            break;
          case (MR_Integer) 3:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[14]));
            break;
          case (MR_Integer) 4:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[16]));
            break;
          case (MR_Integer) 5:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[18]));
            break;
          case (MR_Integer) 6:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[21]));
            break;
          case (MR_Integer) 7:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[4]));
            break;
          case (MR_Integer) 8:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[22]));
            break;
          case (MR_Integer) 9:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[5]));
            break;
          case (MR_Integer) 10:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[9]));
            break;
          case (MR_Integer) 11:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[20]));
            break;
          case (MR_Integer) 12:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[19]));
            break;
          case (MR_Integer) 13:
            TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[24]));
            break;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          switch (Var_75) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[7]));
              break;
            case (MR_Integer) 1:
              TargetExt_23 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[8]));
              break;
          }
        }
        break;
