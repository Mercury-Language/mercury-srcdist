...
static /* final */ const MR_Box make__file_names_scalar_common_1[25][1] = {
  ...
  /* row   8 */
  { ((MR_Box) (&make__file_names_scalar_common_1[3])) },
  /* row   9 */
  ...
  /* row  24 */
  { ((MR_Box) (MR_mkword(1, &make__file_names_scalar_common_1[23]))) },
};
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_18)) {
          ...
          case (MR_Integer) 12:
            ...
            break;
          case (MR_Integer) 13:
            TargetExt_21 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_1[24]));
            break;
        }
        break;
      case (MR_Integer) 1:
