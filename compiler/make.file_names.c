    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(TargetType_10)) {
        ...
        case (MR_Integer) 1:
          ...
          break;
        case (MR_Integer) 2:
          TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[10]));
          break;
        case (MR_Integer) 3:
        ...
        case (MR_Integer) 6:
          ...
          break;
        case (MR_Integer) 7:
          TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[3]));
          break;
        case (MR_Integer) 8:
        ...
        case (MR_Integer) 11:
          ...
          break;
        case (MR_Integer) 12:
          TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[17]));
          break;
        case (MR_Integer) 13:
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (Var_63) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            TargetExt_14 = (MR_Word) (MR_mkword(1, &make__file_names_scalar_common_2[6]));
            break;
        }
      }
      break;
