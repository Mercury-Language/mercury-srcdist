  ...
  MR_Word * STATE_VARIABLE_PredTargetNames_27)
{
  ...
  if ((SeqNum_11 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    SeqNumInt_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), SeqNum_11, (MR_Integer) 0))));
    ...
    *TargetName_14 = mercury__string__f_43_43_2_f_0(ModuleNameStr_20, Var_88);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (SymName_12));
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (UserArityInt_17));
    }
    {
      PredTargetName_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), PredTargetName_23, 0) = ((MR_Box) (Var_41));
      MR_hl_field(MR_mktag(0), PredTargetName_23, 1) = ((MR_Box) (*TargetName_14));
    }
    {
      Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (PredTargetName_23));
    ...
    *TargetName_14 = mercury__string__f_43_43_2_f_0(ModuleNameStr_20, Var_110);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (SymName_12));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (UserArityInt_17));
    }
    {
      PredTargetName_59 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), PredTargetName_59, 0) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(0), PredTargetName_59, 1) = ((MR_Box) (*TargetName_14));
    }
    {
      Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (PredTargetName_59));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    MangledPlainName_8 = parse_tree__prog_foreign__name_mangle_1_f_0(PlainName_5);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (MangledPlainName_8));
      MR_hl_field(MR_mktag(1), Var_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) ((MR_String) "__"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_9, 0) = ((MR_Box) (MangledModuleName_7));
  ...
  MR_Word CurrentModule_5)
{
  ...
  MR_Word Lang_10 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleFIMSpec_4, (MR_Integer) 0))) & (MR_Integer) 3);
  MR_Word ForeignImportModule_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleFIMSpec_4, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        ImportedForeignCodeModuleName1_14 = parse_tree__prog_foreign__foreign_language_module_name_2_f_0(ForeignImportModule_11, Lang_10);
  ...
  MR_Word Lang_5)
{
  ...
  if (((MR_tag((MR_Word) ModuleName_4)) == (MR_Integer) 1))
  {
    ...
    Var_16 = mercury__string__f_43_43_2_f_0(Name_17, Ending_8);
    {
      ...
      MR_hl_field(MR_mktag(1), FullyQualifiedModuleName_6, 1) = ((MR_Box) (Var_16));
    }
  }
  else
  {
    ...
    Var_15 = mercury__string__f_43_43_2_f_0(Name_9, Ending_8);
    {
      ...
      MR_hl_field(MR_mktag(0), FullyQualifiedModuleName_6, 0) = ((MR_Box) (Var_15));
    }
  }
