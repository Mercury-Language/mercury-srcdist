            ...
            if (parse_tree__prog_foreign__succeeded)
              *parse_tree__prog_foreign__HeadVar__1_1 = parse_tree__prog_foreign__V_13_13;
            else
              {
                ...
                {
                  parse_tree__prog_data_foreign____Compare____foreign_literal_or_include_0_0(&parse_tree__prog_foreign__V_14_14, parse_tree__prog_foreign__V_6_6, parse_tree__prog_foreign__V_10_10);
                }
                parse_tree__prog_foreign__succeeded = (parse_tree__prog_foreign__V_14_14 == (MR_Integer) 0);
                parse_tree__prog_foreign__succeeded = !(parse_tree__prog_foreign__succeeded);
                if (parse_tree__prog_foreign__succeeded)
        ...
        if (parse_tree__prog_foreign__succeeded)
          {
            ...
            if (parse_tree__prog_foreign__succeeded)
              {
                {
                  parse_tree__prog_foreign__succeeded = parse_tree__prog_data_foreign____Unify____foreign_literal_or_include_0_0(parse_tree__prog_foreign__V_5_5, parse_tree__prog_foreign__V_9_9);
                }
                if (parse_tree__prog_foreign__succeeded)
                  {
        ...
        if (parse_tree__prog_foreign__succeeded)
          *parse_tree__prog_foreign__HeadVar__1_1 = parse_tree__prog_foreign__V_10_10;
        else
          {
            ...
            {
              parse_tree__prog_data_foreign____Compare____foreign_literal_or_include_0_0(&parse_tree__prog_foreign__V_11_11, parse_tree__prog_foreign__V_5_5, parse_tree__prog_foreign__V_8_8);
            }
    ...
    if (parse_tree__prog_foreign__succeeded)
    ...
    else
      {
        ...
        if (parse_tree__prog_foreign__succeeded)
          {
            {
              parse_tree__prog_foreign__succeeded = parse_tree__prog_data_foreign____Unify____foreign_literal_or_include_0_0(parse_tree__prog_foreign__V_4_4, parse_tree__prog_foreign__V_7_7);
            }
            if (parse_tree__prog_foreign__succeeded)
              {
