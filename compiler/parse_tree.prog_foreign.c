...
static /* final */ const MR_Box parse_tree__prog_foreign_scalar_common_2[7][2];
  ...
  MR_Word * STATE_VARIABLE_PredTargetNames_27)
{
  ...
  if ((SeqNum_11 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    SeqNumInt_16 = ((MR_Integer) ((MR_hl_field(1, SeqNum_11, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Word ModuleName_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    MR_String PlainName_5 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
...
void MR_CALL 
parse_tree__prog_foreign__foreign_language_file_extension_3_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * HeadVar__2_2,
  MR_Word * HeadVar__3_3)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        *HeadVar__3_3 = (MR_Word) (MR_mkword(3, &parse_tree__prog_foreign_scalar_common_2[4]));
      }
      break;
    case (MR_Integer) 1:
      {
        *HeadVar__2_2 = (MR_Word) (((MR_Box) ((MR_String) ".cs")));
        *HeadVar__3_3 = (MR_Word) (MR_mkword(3, &parse_tree__prog_foreign_scalar_common_2[5]));
      }
      break;
    case (MR_Integer) 2:
      {
        *HeadVar__2_2 = (MR_Word) (((MR_Box) ((MR_String) ".java")));
        *HeadVar__3_3 = (MR_Word) (MR_mkword(3, &parse_tree__prog_foreign_scalar_common_2[6]));
      }
      break;
  }
}
  ...
  MR_Word CurrentModule_5)
{
  ...
  MR_Word Lang_10 = ((MR_Unsigned) ((MR_hl_field(0, ModuleFIMSpec_4, (MR_Integer) 0))) & (MR_Integer) 3);
  MR_Word ForeignImportModule_11 = ((MR_Word) ((MR_hl_field(0, ModuleFIMSpec_4, (MR_Integer) 1))));
  ...
  MR_Word FIMSpec_3)
{
  ...
  MR_Word ForeignImportModule_6 = ((MR_Word) ((MR_hl_field(0, FIMSpec_3, (MR_Integer) 1))));
  ...
  MR_Word * FullyQualifiedModuleName_6)
{
  ...
  Var_14 = libs__globals__simple_foreign_language_string_1_f_0(Lang_5);
  Var_13 = mercury__string__f_43_43_2_f_0(Var_14, (MR_String) "_code");
  Ending_9 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_13);
  if (((MR_tag((MR_Word) ModuleName_4)) == (MR_Integer) 1))
  {
    MR_Word Module_11 = ((MR_Word) ((MR_hl_field(1, ModuleName_4, (MR_Integer) 0))));
    MR_String Var_17;
    MR_String Name_18 = ((MR_String) ((MR_hl_field(1, ModuleName_4, (MR_Integer) 1))));

    Var_17 = mercury__string__f_43_43_2_f_0(Name_18, Ending_9);
    {
      MR_Word base;
  ...
  {
    MR_String Name_10 = ((MR_String) ((MR_hl_field(0, ModuleName_4, (MR_Integer) 0))));
    MR_String Var_16;

    Var_16 = mercury__string__f_43_43_2_f_0(Name_10, Ending_9);
    {
      MR_Word base;
...
{
  MR_bool succeeded;
  MR_Word Var_7 = ((MR_Unsigned) ((MR_hl_field(0, BodyCode_4, (MR_Integer) 0))) & (MR_Integer) 3);
...
{
  MR_bool succeeded;
  MR_Word Var_8 = ((((MR_Unsigned) ((MR_hl_field(0, DeclCode_4, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
