...
MR_decl_label3(fn__parse_tree__prog_foreign__sym_name_mangle_1_0, 16,5,6)
...
MR_BEGIN_MODULE(parse_tree__prog_foreign_module14)
	...
	MR_init_label3(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,16,5,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__parse_tree__prog_foreign__sym_name_mangle_1_0);
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__parse_tree__prog_foreign__sym_name_mangle_1_0_i16);
	}
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_np_tailcall_ent(fn__parse_tree__prog_foreign__name_mangle_1_0);
MR_def_label(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
