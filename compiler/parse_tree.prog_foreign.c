...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) ModuleName_4)) == (MR_mktag((MR_Integer) 1))))
      {
...
{
  {
    ...
    MR_Word Lang_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleForeignImported_4, (MR_Integer) 0)));
  ...
  MR_Word ImportModule_3)
{
  {
    MR_Word ModuleName_4;
    MR_Word Lang_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ImportModule_3, (MR_Integer) 0)));
  ...
  MR_Word BodyCode_4)
{
  {
    MR_bool succeeded;
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), BodyCode_4, (MR_Integer) 0)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), BodyCode_4, (MR_Integer) 1)));
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), BodyCode_4, (MR_Integer) 2)));
  ...
  MR_Word DeclCode_4)
{
  {
    MR_bool succeeded;
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeclCode_4, (MR_Integer) 0)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeclCode_4, (MR_Integer) 1)));
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeclCode_4, (MR_Integer) 2)));
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeclCode_4, (MR_Integer) 3)));
