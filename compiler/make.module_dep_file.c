...
{
  {
    ...
    make__util__redirect_output_6_p_0(ModuleName_8, &MaybeErrorStream_11, STATE_VARIABLE_Info_0_42, &STATE_VARIABLE_Info_46_46);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        make__util__unredirect_output_7_p_0(UnredirectGlobals_24, ModuleName_8, ErrorStream_12, STATE_VARIABLE_Info_46_46, &STATE_VARIABLE_Info_107_107);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          make__util__unredirect_output_7_p_0(UnredirectGlobals_273, ModuleName_8, ErrorStream_12, STATE_VARIABLE_Info_46_46, &STATE_VARIABLE_Info_107_285);
        ...
        else
        {
          ...
          make__util__unredirect_output_7_p_0(Globals_7, ModuleName_8, ErrorStream_12, STATE_VARIABLE_Info_89_89, STATE_VARIABLE_Info_43);
        }
      }
    }
  }
