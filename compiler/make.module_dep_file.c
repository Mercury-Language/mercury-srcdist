      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              SourceFileModuleNameTerm_12 = ((MR_Word) ((MR_hl_field(1, Var_44, 0))));
  ...
  MR_Word BurdenedModule0_8)
{
  ...
  MR_Word SourceFileModuleName_14 = ((MR_Word) ((MR_hl_field(0, Baggage0_10, 2))));
  ...
  MR_Word ParseTreeModuleSrc_10)
{
  ...
  MR_Word SourceFileModuleName_15 = ((MR_Word) ((MR_hl_field(0, Baggage_9, 2))));
