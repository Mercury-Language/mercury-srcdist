  ...
  MR_Word ParseTreeModuleSrc_10)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&make__module_dep_file_scalar_common_2[0]), (MR_Integer) 2, &Var_220);
  mercury__io__write_string_4_p_0(Stream_7, Var_220);
