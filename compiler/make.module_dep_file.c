...
make__module_dep_file__IntroducedFrom__pred__sym_names_term__401__1_2_p_0(
  MR_Word HeadVar__1_6,
  MR_Word * HeadVar__2_7);

static MR_bool MR_CALL 
make__module_dep_file__IntroducedFrom__pred__parse_module_dep_file_term__362__1_2_p_0(
  MR_Word ParentsSet_39,
  MR_Word AncestorsSet_40);

static MR_bool MR_CALL 
make__module_dep_file__IntroducedFrom__pred__parse_module_dep_file_term__357__1_2_p_0(
...
static /* final */ const MR_Box make__module_dep_file_scalar_common_1[3][2];

static /* final */ const MR_Box make__module_dep_file_scalar_common_2[4][1];
  ...
  MR_Word * ForeignInclude_4)
{
  ...
  if (succeeded)
  {
    ...
    Var_10 = ((MR_Word) ((MR_hl_field(0, Term_3, 1))));
    succeeded = ((MR_tag((MR_Word) Var_17)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_13 = ((MR_String) ((MR_hl_field(0, Var_17, 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          LanguageTerm_5 = ((MR_Word) ((MR_hl_field(1, Var_10, 0))));
          Var_11 = ((MR_Word) ((MR_hl_field(1, Var_10, 1))));
          succeeded = (Var_11 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            FileNameTerm_6 = ((MR_Word) ((MR_hl_field(1, Var_11, 0))));
            Var_14 = ((MR_Word) ((MR_hl_field(1, Var_11, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_20 = ((MR_Word) ((MR_hl_field(0, LanguageTerm_5, 0))));
                Var_21 = ((MR_Word) ((MR_hl_field(0, LanguageTerm_5, 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    String_18 = ((MR_String) ((MR_hl_field(2, Var_20, 0))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Var_23 = ((MR_Word) ((MR_hl_field(0, FileNameTerm_6, 0))));
                        Var_24 = ((MR_Word) ((MR_hl_field(0, FileNameTerm_6, 1))));
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            FileName_8 = ((MR_String) ((MR_hl_field(2, Var_23, 0))));
                            {
                              MR_Word base;
  ...
  MR_Word * FIMSpec_4)
{
  ...
  if (succeeded)
  {
    Var_18 = ((MR_Word) ((MR_hl_field(0, Term_3, 0))));
    Var_10 = ((MR_Word) ((MR_hl_field(0, Term_3, 1))));
    succeeded = ((MR_tag((MR_Word) Var_18)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_14 = ((MR_String) ((MR_hl_field(0, Var_18, 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ImportedModuleTerm_6 = ((MR_Word) ((MR_hl_field(1, Var_11, 0))));
            Var_15 = ((MR_Word) ((MR_hl_field(1, Var_11, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_21 = ((MR_Word) ((MR_hl_field(0, LanguageTerm_5, 0))));
                Var_22 = ((MR_Word) ((MR_hl_field(0, LanguageTerm_5, 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    String_19 = ((MR_String) ((MR_hl_field(2, Var_21, 0))));
  ...
  MR_Word * Lang_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      String_5 = ((MR_String) ((MR_hl_field(2, Var_7, 0))));
...
{
  MR_String Str_4;
  MR_Word Lang_5 = ((MR_Unsigned) ((MR_hl_field(0, ForeignInclude_3, 0))) & (MR_Integer) 3);
  MR_String FileName_6 = ((MR_String) ((MR_hl_field(0, ForeignInclude_3, 1))));
  MR_String LangStr_7;
  MR_String Var_8;
  MR_String Var_10;
  ...
  MR_Word FIMSpec_3)
{
  ...
  MR_Word ForeignImport_6 = ((MR_Word) ((MR_hl_field(0, FIMSpec_3, 1))));
  MR_String LangStr_7;
  ...
  MR_Word * Result_10)
{
  ...
  switch (MR_tag((MR_Word) TermResult_13)) {
    ...
    case (MR_Integer) 1:
      {
        MR_String Error_17 = ((MR_String) ((MR_hl_field(1, TermResult_13, 0))));
        MR_String Var_21;
    ...
    case (MR_Integer) 2:
      {
        MR_Word Term_15 = ((MR_Word) ((MR_hl_field(2, TermResult_13, 1))));
        ...
        if (succeeded)
          ...
          *Result_10 = (MR_Word) (&make__module_dep_file_scalar_common_2[2]);
      }
      break;
  }
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__module_dep_file__IntroducedFrom__pred__parse_module_dep_file_term__362__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__module_dep_file__IntroducedFrom__pred__parse_module_dep_file_term__357__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = make__module_dep_file__IntroducedFrom__pred__sym_names_term__401__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_7);
  if (succeeded)
  {
  ...
  MR_Word * ModuleSummary_8)
{
  ...
  MR_Word SourceFileTopModuleNameTerm_12;
  ...
  MR_Word SourceFileTopModuleName_26;
  MR_Word Parents_27;
  MR_Word IntDeps_28;
  MR_Word ImpDeps_29;
  MR_Word Children_30;
  ...
  if (succeeded)
  {
    Var_96 = ((MR_Word) ((MR_hl_field(0, Term_7, 0))));
    ModuleArgs_9 = ((MR_Word) ((MR_hl_field(0, Term_7, 1))));
    succeeded = ((MR_tag((MR_Word) Var_96)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_93 = ((MR_String) ((MR_hl_field(0, Var_96, 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          VersionNumberTerm_10 = ((MR_Word) ((MR_hl_field(1, ModuleArgs_9, 0))));
          Var_43 = ((MR_Word) ((MR_hl_field(1, ModuleArgs_9, 1))));
          succeeded = (Var_43 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            SourceFileTerm_11 = ((MR_Word) ((MR_hl_field(1, Var_43, 0))));
            Var_44 = ((MR_Word) ((MR_hl_field(1, Var_43, 1))));
            succeeded = (Var_44 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              SourceFileTopModuleNameTerm_12 = ((MR_Word) ((MR_hl_field(1, Var_44, 0))));
              Var_45 = ((MR_Word) ((MR_hl_field(1, Var_44, 1))));
              succeeded = (Var_45 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                ParentsTerm_13 = ((MR_Word) ((MR_hl_field(1, Var_45, 0))));
                Var_46 = ((MR_Word) ((MR_hl_field(1, Var_45, 1))));
                succeeded = (Var_46 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  IntDepsTerm_14 = ((MR_Word) ((MR_hl_field(1, Var_46, 0))));
                  Var_47 = ((MR_Word) ((MR_hl_field(1, Var_46, 1))));
                  succeeded = (Var_47 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    ImpDepsTerm_15 = ((MR_Word) ((MR_hl_field(1, Var_47, 0))));
                    Var_48 = ((MR_Word) ((MR_hl_field(1, Var_47, 1))));
                    succeeded = (Var_48 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      ChildrenTerm_16 = ((MR_Word) ((MR_hl_field(1, Var_48, 0))));
                      Var_49 = ((MR_Word) ((MR_hl_field(1, Var_48, 1))));
                      succeeded = (Var_49 != (MR_Word) ((MR_Unsigned) 0U));
                      if (succeeded)
                      {
                        NestedSubModulesTerm_17 = ((MR_Word) ((MR_hl_field(1, Var_49, 0))));
                        Var_50 = ((MR_Word) ((MR_hl_field(1, Var_49, 1))));
                        succeeded = (Var_50 != (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          FactDepsTerm_18 = ((MR_Word) ((MR_hl_field(1, Var_50, 0))));
                          Var_51 = ((MR_Word) ((MR_hl_field(1, Var_50, 1))));
                          succeeded = (Var_51 != (MR_Word) ((MR_Unsigned) 0U));
                          if (succeeded)
                          {
                            ForeignLanguagesTerm_19 = ((MR_Word) ((MR_hl_field(1, Var_51, 0))));
                            Var_52 = ((MR_Word) ((MR_hl_field(1, Var_51, 1))));
                            succeeded = (Var_52 != (MR_Word) ((MR_Unsigned) 0U));
                            if (succeeded)
                            {
                              ForeignImportsTerm_20 = ((MR_Word) ((MR_hl_field(1, Var_52, 0))));
                              Var_53 = ((MR_Word) ((MR_hl_field(1, Var_52, 1))));
                              succeeded = (Var_53 != (MR_Word) ((MR_Unsigned) 0U));
                              if (succeeded)
                              {
                                ContainsForeignExportTerm_21 = ((MR_Word) ((MR_hl_field(1, Var_53, 0))));
                                Var_54 = ((MR_Word) ((MR_hl_field(1, Var_53, 1))));
                                succeeded = (Var_54 != (MR_Word) ((MR_Unsigned) 0U));
                                if (succeeded)
                                {
                                  ModuleArgsTail_23 = ((MR_Word) ((MR_hl_field(1, Var_54, 1))));
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        Var_100 = ((MR_Word) ((MR_hl_field(0, SourceFileTerm_11, 0))));
                                        Var_101 = ((MR_Word) ((MR_hl_field(0, SourceFileTerm_11, 1))));
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          if (succeeded)
                                          {
                                            SourceFileName_25 = ((MR_String) ((MR_hl_field(2, Var_100, 0))));
                                            TypeCtorInfo_75_75 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                                            succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(TypeCtorInfo_75_75, SourceFileTopModuleNameTerm_12, &SourceFileTopModuleName_26);
                                            if (succeeded)
                                            {
                                              ...
                                              if (succeeded)
                                              {
                                                Var_111 = ((MR_Word) ((MR_hl_field(0, ParentsTerm_13, 0))));
                                                ArgTerms_105 = ((MR_Word) ((MR_hl_field(0, ParentsTerm_13, 1))));
                                                succeeded = ((MR_tag((MR_Word) Var_111)) == (MR_Integer) 0);
                                                if (succeeded)
                                                {
                                                  Var_109 = ((MR_String) ((MR_hl_field(0, Var_111, 0))));
                                                                  ...
                                                                  if (succeeded)
                                                                  {
                                                                    ...
                                                                    if (succeeded)
                                                                    {
                                                                      ...
                                                                      else
                                                                      {
                                                                        ...
                                                                        if (succeeded)
                                                                        {
                                                                          ForeignIncludesTerm_37 = ((MR_Word) ((MR_hl_field(1, ModuleArgsTail_23, 0))));
                                                                          Var_58 = ((MR_Word) ((MR_hl_field(1, ModuleArgsTail_23, 1))));
                                                                      ...
                                                                      if (succeeded)
                                                                      {
                                                                        succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_5, SourceFileTopModuleName_26);
                                                                        if (succeeded)
                                                                        {
                                                                          MR_Word Var_60;
                                                                        ...
                                                                        Var_74 = mercury__set__list_to_set_1_f_0(TypeCtorInfo_92_92, ForeignIncludes_36);
                                                                        {
                                                                          ...
                                                                          *ModuleSummary_8 = base;
                                                                          ...
                                                                          MR_hl_field(0, base, 2) = ((MR_Box) (SourceFileTopModuleName_26));
  ...
  MR_Word * Args_6)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_11 = ((MR_String) ((MR_hl_field(0, Var_13, 0))));
  ...
  MR_Word * ContainsForeignExport_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Atom_5 = ((MR_String) ((MR_hl_field(0, Var_10, 0))));
  ...
  MR_Word * SymNames_4)
{
  ...
  {
    Var_17 = ((MR_Word) ((MR_hl_field(0, Term_3, 0))));
    ArgTerms_11 = ((MR_Word) ((MR_hl_field(0, Term_3, 1))));
    succeeded = ((MR_tag((MR_Word) Var_17)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_15 = ((MR_String) ((MR_hl_field(0, Var_17, 0))));
...
{
  MR_Word Baggage0_10 = ((MR_Word) ((MR_hl_field(0, BurdenedModule0_8, 0))));
  MR_Word ParseTreeModuleSrc_11 = ((MR_Word) ((MR_hl_field(0, BurdenedModule0_8, 1))));
  MR_String SourceFileName_12 = ((MR_String) ((MR_hl_field(0, Baggage0_10, 0))));
  MR_Word SourceFileTopModuleName_14 = ((MR_Word) ((MR_hl_field(0, Baggage0_10, 2))));
  MR_Word MaybeTopModule_15 = ((MR_Word) ((MR_hl_field(0, Baggage0_10, 3))));
  MR_Word ModuleName_22 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_11, 0))));
  ...
  Var_30 = mercury__dir__this_directory_0_f_0();
  {
    ...
    MR_hl_field(0, Baggage_25, 2) = ((MR_Box) (SourceFileTopModuleName_14));
...
{
  MR_Word Baggage_10 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_8, 0))));
  MR_Word ParseTreeModuleSrc_11 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_8, 1))));
  MR_Word ModuleName_12 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_11, 0))));
  MR_String ProgDepFile_13;
  MR_Word ProgDepResult_15;
  MR_String _ProgDepFileProposed_14;

  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_7, (MR_String) "predicate \140make.module_dep_file.do_write_module_dep_file\'/5", (MR_Word) (MR_mkword(1, &make__module_dep_file_scalar_common_2[0])), ModuleName_12, &ProgDepFile_13, &_ProgDepFileProposed_14);
  mercury__io__open_output_4_p_0(ProgDepFile_13, &ProgDepResult_15);
  if (((MR_tag((MR_Word) ProgDepResult_15)) == (MR_Integer) 1))
  {
    MR_Word Error_17 = ((MR_Word) ((MR_hl_field(1, ProgDepResult_15, 0))));
    MR_String Msg_18;
    ...
    mercury__io__write_string_4_p_0(ProgressStream_6, Msg_18);
    mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "\n");
    mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
  }
  else
  {
    MR_Word ProgDepStream_16 = ((MR_Word) ((MR_hl_field(0, ProgDepResult_15, 0))));

    make__module_dep_file__do_write_module_dep_file_to_stream_6_p_0(ProgDepStream_16, Globals_7, Baggage_10, ParseTreeModuleSrc_11);
    mercury__io__close_output_3_p_0(ProgDepStream_16);
  }
}
  ...
  MR_Word ParseTreeModuleSrc_10)
{
  ...
  MR_String SourceFileTopModuleNameStr_16;
  ...
  MR_String Var_44 = ((MR_String) ((MR_hl_field(0, Baggage_9, 0))));
  MR_Word Var_45;
  MR_Word Var_47;
  MR_Word Var_49;
  MR_Word Var_51;
  ...
  SourceFileName_14 = mercury__term_io__escaped_string_1_f_0(Var_44);
  SourceFileTopModuleName_15 = ((MR_Word) ((MR_hl_field(0, Baggage_9, 2))));
  SourceFileTopModuleNameStr_16 = parse_tree__parse_tree_out_sym_name__mercury_bracketed_sym_name_to_string_1_f_0(SourceFileTopModuleName_15);
  ModuleName_17 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_10, 0))));
  Var_45 = mdbcomp__sym_name__get_ancestors_set_1_f_0(ModuleName_17);
  Ancestors_18 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_45);
  IncludeMap_19 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_10, 2))));
  Children_20 = mercury__map__keys_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_include_module_info_0), IncludeMap_19);
  ...
  MaybeTopModule_25 = ((MR_Word) ((MR_hl_field(0, Baggage_9, 3))));
  ...
  Var_47 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), FactTableFilesSet_27);
  FactTableFilesStrs_28 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__module_dep_file_scalar_common_4[1]), Var_47);
  ...
  Var_49 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), BackendCodeLangs_33);
  CodeLangStrs_35 = mercury__list__map_2_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__module_dep_file_scalar_common_4[2]), Var_49);
  ...
  Var_51 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), FIMSpecs_37);
  FIMSpecStrs_39 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__module_dep_file_scalar_common_4[3]), Var_51);
  Var_53 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_foreign_include_file_info_0), ForeignIncludeFiles_38);
  FIFOStrs_40 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_foreign_include_file_info_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__module_dep_file_scalar_common_4[4]), Var_53);
  ...
  Var_90 = make__module_dep_file__bracketed_sym_names_to_comma_list_string_1_f_0(Ancestors_18);
  Var_93 = make__module_dep_file__bracketed_sym_names_to_comma_list_string_1_f_0(IntDeps_23);
  Var_96 = make__module_dep_file__bracketed_sym_names_to_comma_list_string_1_f_0(ImpDeps_24);
  Var_99 = make__module_dep_file__bracketed_sym_names_to_comma_list_string_1_f_0(Children_20);
  Var_102 = make__module_dep_file__bracketed_sym_names_to_comma_list_string_1_f_0(NestedSubModules_26);
  Var_105 = mercury__string__join_list_2_f_0((MR_String) ", ", FactTableFilesStrs_28);
  Var_109 = mercury__string__join_list_2_f_0((MR_String) ", ", CodeLangStrs_35);
  Var_113 = mercury__string__join_list_2_f_0((MR_String) ", ", FIMSpecStrs_39);
  Var_119 = mercury__string__join_list_2_f_0((MR_String) ", ", FIFOStrs_40);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "module(");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&make__module_dep_file_scalar_common_2[3]), (MR_Integer) 2, &Var_230);
  mercury__io__write_string_4_p_0(Stream_7, Var_230);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) ", \"");
  mercury__io__write_string_4_p_0(Stream_7, SourceFileName_14);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\",\n\t");
  mercury__io__write_string_4_p_0(Stream_7, SourceFileTopModuleNameStr_16);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) ",\n\t{");
