...
make__module_dep_file__IntroducedFrom__func__make_module_dependencies__887__1_1_f_0(
  MR_Word LambdaHeadVar__1_72);

static MR_bool MR_CALL 
make__module_dep_file__IntroducedFrom__pred__sym_names_term__707__1_2_p_0(
  MR_Word HeadVar__1_6,
  MR_Word * HeadVar__2_7);

static MR_bool MR_CALL 
make__module_dep_file__IntroducedFrom__pred__parse_module_summary_file__668__1_2_p_0(
  MR_Word ParentsSet_39,
  MR_Word AncestorsSet_40);

static MR_bool MR_CALL 
make__module_dep_file__IntroducedFrom__pred__parse_module_summary_file__663__1_2_p_0(
  MR_Word NestedSubModules0_31,
  MR_Word HeadVar__2_64);

static MR_String MR_CALL 
make__module_dep_file__IntroducedFrom__func__do_get_module_dependencies__291__1_1_f_0(
...
{
  {
    ...
    conv0_LambdaHeadVar__2_60 = make__module_dep_file__IntroducedFrom__func__do_get_module_dependencies__291__1_1_f_0(((MR_String) (wrapper_arg_1)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_73 = make__module_dep_file__IntroducedFrom__func__make_module_dependencies__887__1_1_f_0(((MR_Word) (wrapper_arg_1)));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__io__remove_file_4_p_0(ErrFileName_356, &Var_290);
...
{
  {
    ...
    succeeded = make__module_dep_file__IntroducedFrom__pred__parse_module_summary_file__668__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = make__module_dep_file__IntroducedFrom__pred__parse_module_summary_file__663__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = make__module_dep_file__IntroducedFrom__pred__sym_names_term__707__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_7);
    if (succeeded)
    {
