...
{
  {
    make__util__make_remove_target_file_by_name_8_p_0(Globals_7, (MR_Integer) 60, LambdaHeadVar__1_19, (MR_Word) ((MR_Integer) 20), LambdaHeadVar__2_20, LambdaHeadVar__3_21);
  }
}
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_15_15, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_14)));
              if (succeeded)
              {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_16_16, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_15)));
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) LanguageTerm_5)) == (MR_mktag((MR_Integer) 0)));
                if (succeeded)
    ...
    case (MR_Integer) 0:
      {
        ...
        if ((MaybeModuleAndImports_29 == (MR_Word) ((MR_Integer) 0)))
    ...
    case (MR_Integer) 1:
      {
        ...
        *HeadVar__5_5 = (MR_Integer) 1;
        ...
        Var_22 = mercury__map__f_101_108_101_109_32_58_61_3_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__module_dep_file_scalar_common_1[0]), ((MR_Box) (ModuleName_3)), Var_21, ((MR_Box) ((MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      ForeignLanguages_10 = (MR_Word) ((MR_Integer) 0);
          ...
          case (MR_Integer) 1:
            {
              ...
              *MaybeModuleAndImports_10 = (MR_Word) ((MR_Integer) 0);
...
{
  {
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__map__set_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__module_dep_file_scalar_common_1[0]), ((MR_Box) (ModuleName_11)), ((MR_Box) ((MR_Integer) 0)), ModuleDepMap0_31, &ModuleDepMap1_32);
    ...
    else
    {
      ...
      *STATE_VARIABLE_MaybeModuleAndImports_36 = (MR_Word) ((MR_Integer) 0);
      mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__module_dep_file_scalar_common_1[0]), ((MR_Box) (ModuleName_11)), ((MR_Box) ((MR_Integer) 0)), ModuleDepMap2_33, &ModuleDepMap_35);
        ...
        case (MR_Integer) 2:
          {
            ...
            if ((Result_96 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((MaybeErrorStream_11 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      parse_tree__read_modules__read_module_src_14_p_0(Globals_7, (MR_String) "Getting dependencies for module", (MR_Integer) 1, (MR_Integer) 1, ModuleName_8, (MR_Word) ((MR_Integer) 0), &SourceFileName_14, (MR_Word) (&make__module_dep_file_scalar_common_6[2]), &Var_15, &ParseTreeSrc_16, &Specs0_17, &Errors_18);
      ...
      if (succeeded)
      {
        ...
        mercury__map__set_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__module_dep_file_scalar_common_1[0]), ((MR_Box) (ModuleName_8)), ((MR_Box) ((MR_Integer) 0)), ModuleDepMap0_27, &ModuleDepMap_28);
      ...
      else
      {
        ...
        Var_94 = mercury__set__list_to_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), SubModuleNames_33);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_93, 7) = ((MR_Box) ((MR_Integer) 0));
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Target_41, 1) = ((MR_Box) ((MR_Integer) 20));
          }
        ...
        STATE_VARIABLE_Info_115_115 = ((MR_Word) (conv13_STATE_VARIABLE_Info_115_115));
        {
          ...
          MR_hl_field(MR_mktag(0), MadeTarget_46, 1) = ((MR_Box) ((MR_Integer) 20));
        }
...
{
  {
                                                    ...
                                                    if (succeeded)
                                                    {
                                                      ...
                                                      if (succeeded)
                                                      {
                                                        ...
                                                        if (succeeded)
                                                        {
                                                          ...
                                                          if (succeeded)
                                                          {
                                                            if ((ModuleArgsTail_35 == (MR_Word) ((MR_Integer) 0)))
                                                            {
                                                              succeeded = (Version_36 == (MR_Integer) 0);
                                                              if (succeeded)
                                                              {
                                                                ForeignIncludes_49 = (MR_Word) ((MR_Integer) 0);
                                                                succeeded = MR_TRUE;
                                                              }
                                                            }
                                                            else
                                                            {
                                                              ...
                                                              if (succeeded)
                                                              {
                                                                ...
                                                                succeeded = (Var_97 == (MR_Word) ((MR_Integer) 0));
                                                                if (succeeded)
    ...
    if (succeeded)
    {
      ...
      Var_111 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_foreign_include_file_info_0), ForeignIncludes_49);
      {
        ...
        MR_hl_field(MR_mktag(0), ModuleAndImports_70, 16) = ((MR_Box) ((MR_Integer) 0));
        ...
        MR_hl_field(MR_mktag(0), ModuleAndImports_70, 22) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), ModuleAndImports_70, 23) = ((MR_Box) (Errors_68));
        MR_hl_field(MR_mktag(0), ModuleAndImports_70, 24) = ((MR_Box) ((MR_Integer) 0));
      ...
      if (succeeded)
      {
        ...
        if ((SourceFileExists_71 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          *STATE_VARIABLE_Info_78 = ((MR_Word) (conv5_STATE_VARIABLE_Info_78));
          ...
          if (succeeded)
            ...
            *Result_18 = (MR_Word) ((MR_Integer) 0);
        }
        else
        {
          MR_Word Var_73;
...
{
  {
    ...
    else
    {
      ...
      switch (FileType_10) {
        ...
        case (MR_Integer) 0:
        case (MR_Integer) 10:
          *FileExists_6 = (MR_Word) ((MR_Integer) 0);
          break;
      }
    }
  }
...
{
  {
...

    {
      ...
      (env_ptr)->make__module_dep_file__some_bad_module_dependency_2_p_0_env_0__Var_7 = (MR_Word) ((MR_Integer) 0);
