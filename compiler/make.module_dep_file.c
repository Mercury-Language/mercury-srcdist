...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_122, 1) = ((MR_Box) (make__module_dep_file__IntroducedFrom__pred__make_module_dependencies__901__1_7_p_0_1));
...
{
  {
    ...
    make__module_dep_file__IntroducedFrom__pred__make_module_dependencies__901__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), &conv11_LambdaHeadVar__1_117, ((MR_Word) wrapper_arg_2), &conv10_LambdaHeadVar__3_119);
...
{
  {
    ...
    make__module_dep_file__IntroducedFrom__pred__make_module_dependencies__870__1_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv2_LambdaHeadVar__3_100);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        SubModuleNames_33 = mercury__list__map_2_f_0(TypeCtorInfo_266_266, TypeCtorInfo_267_267, (MR_Word) &make__module_dep_file_scalar_common_3[6], RawCompUnits_30);
        ...
        mercury__list__foldl_4_p_0(TypeCtorInfo_272_272, TypeCtorInfo_275_275, (MR_Word) &make__module_dep_file_scalar_common_3[7], ModuleAndImportList_34, ((MR_Box) (STATE_VARIABLE_Info_51_51)), &conv3_STATE_VARIABLE_Info_97_97);
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_105, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &make__module_dep_file_scalar_common_1[6])));
