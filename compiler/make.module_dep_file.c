...
{
  MR_bool succeeded;
  MR_String SourceFileName_14 = ((MR_String) ((MR_hl_field(0, Baggage_9, 0))));
  MR_Word SourceFileTopModuleName_15 = ((MR_Word) ((MR_hl_field(0, Baggage_9, 2))));
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&make__module_dep_file_scalar_common_2[3]), (MR_Integer) 2, &Var_229);
