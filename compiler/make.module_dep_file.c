  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_12, (MR_String) "predicate \140make.module_dep_file.make_module_dependencies_fatal_error\'/11", (MR_Word) (&make__module_dep_file_scalar_common_2[5]), ModuleName_16, &ErrFileName_24);
