...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 654, &SearchDirs_18);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 654, &SearchDirs_13);
