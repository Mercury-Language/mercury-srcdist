...
make__module_dep_file__IntroducedFrom__func__make_module_dependencies_no_fatal_error__961__1_1_f_0(
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_7(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_6(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_5(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_4(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static MR_Box MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static MR_Box MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static void MR_CALL 
make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0(
  MR_Word Globals_13,
...
static void MR_CALL 
make__module_dep_file__make_module_dependencies_fatal_error_12_p_0(
  MR_Word Globals_13,
  MR_Word ProgressStream_14,
  MR_Word MESI_15,
  MR_Word ErrorStream_16,
...
static /* final */ const MR_Box make__module_dep_file_scalar_common_4[15][3] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   7 */
  {
    ((MR_Box) (&make__module_dep_file_scalar_common_3[8])),
    ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   8 */
  {
    ((MR_Box) (&make__module_dep_file_scalar_common_5[0])),
    ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_3)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   9 */
  {
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  else
  {
    ...
    parse_tree__read_modules__read_module_src_11_p_0(ProgressStream_8, Globals_9, (MR_Integer) 3, (MR_Integer) 1, (MR_Integer) 0, ModuleName_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&make__module_dep_file_scalar_common_2[5]), &HaveReadSrc_16);
    if (((MR_tag((MR_Word) HaveReadSrc_16)) == (MR_Integer) 1))
    {
      ...
      make__module_dep_file__make_module_dependencies_fatal_error_12_p_0(Globals_9, ProgressStream_8, MESI_14, ErrorStream_15, SourceFileName_54, ModuleName_10, ReadModuleErrors_55, (MR_Integer) 1, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_27);
    }
    else
    {
      ...
      if (succeeded)
        make__module_dep_file__make_module_dependencies_fatal_error_12_p_0(Globals_9, ProgressStream_8, MESI_14, ErrorStream_15, SourceFileName_17, ModuleName_10, ReadModuleErrors_20, (MR_Integer) 1, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_27);
      else
      {
        ...
        if (succeeded)
          make__module_dep_file__make_module_dependencies_fatal_error_12_p_0(Globals_9, ProgressStream_8, MESI_14, ErrorStream_15, SourceFileName_17, ModuleName_10, ReadModuleErrors_20, (MR_Integer) 0, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_27);
        else
          make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0(Globals_9, ProgressStream_8, MESI_14, ErrorStream_15, SourceFileName_17, ModuleName_10, ParseTreeSrc_19, ReadModuleErrors_20, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_27);
      }
    }
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_56 = make__module_dep_file__IntroducedFrom__func__make_module_dependencies_no_fatal_error__961__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_51)
{
  ...
  ParseTreeModuleSrcs_25 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), (MR_Word) (&make__module_dep_file_scalar_common_4[6]), BurdenedModules_24);
  SubModuleNames_28 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__module_dep_file_scalar_common_4[7]), ParseTreeModuleSrcs_25);
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), (MR_Word) (&make__module_dep_file_scalar_common_4[8]), BurdenedModules_24, ((MR_Box) (STATE_VARIABLE_Info_0_50)), &conv3_STATE_VARIABLE_Info_62_62);
  ...
  make__file_names__get_make_target_file_name_6_p_0(Globals_13, (MR_String) "predicate \140make.module_dep_file.make_module_dependencies_no_fatal_error\'/12", MadeTarget_29, &MadeTargetFileName_30);
  ...
  if (succeeded)
  {
    ...
    make__build__setup_for_build_with_module_options_11_p_0(ProgressStream_14, DefaultOptionTable_35, (MR_Integer) 1, ModuleName_18, DetectedGradeFlags_36, OptionVariables_37, OptionArgs_38, (MR_Word) (MR_mkword(1, &make__module_dep_file_scalar_common_1[4])), &MayBuild_40);
    if (((MR_tag((MR_Word) MayBuild_40)) == (MR_Integer) 1))
    {
...

      {
        ...
        MR_hl_field(0, Var_116, 0) = ((MR_Box) (&make__module_dep_file_scalar_common_6[0]));
        MR_hl_field(0, Var_116, 1) = ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_4));
    ...
    }
    {
      ...
      MR_hl_field(0, CleanupMSI_45, 0) = ((MR_Box) (&make__module_dep_file_scalar_common_6[1]));
      MR_hl_field(0, CleanupMSI_45, 1) = ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_5));
  ...
  libs__process_util__setup_checking_for_interrupt_3_p_0(&CookieWMDF_47);
  {
    ...
    MR_hl_field(0, Var_79, 0) = ((MR_Box) (&make__module_dep_file_scalar_common_7[0]));
    MR_hl_field(0, Var_79, 1) = ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_6));
  ...
  mercury__list__foldl_4_p_2((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_79, BurdenedModules_24, ((MR_Box) ((MR_Integer) 0)), &conv8_STATE_VARIABLE_IO_80_80);
  {
    ...
    MR_hl_field(0, CleanupWMDF_48, 0) = ((MR_Box) (&make__module_dep_file_scalar_common_6[1]));
    MR_hl_field(0, CleanupWMDF_48, 1) = ((MR_Box) (make__module_dep_file__make_module_dependencies_no_fatal_error_12_p_0_7));
  ...
  make__module_target__record_made_target_10_p_0(ProgressStream_14, Globals_13, MadeTarget_29, MadeTargetFileName_30, (MR_Word) (&make__module_dep_file_scalar_common_2[7]), Succeeded_46, STATE_VARIABLE_Info_82_82, &STATE_VARIABLE_Info_85_85);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 79, (MR_Word) (MR_mkword(3, &make__module_dep_file_scalar_common_1[3])), Globals_13, &UnredirectGlobals_24);
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_13, (MR_String) "predicate \140make.module_dep_file.make_module_dependencies_fatal_error\'/12", (MR_Word) (&make__module_dep_file_scalar_common_2[6]), ModuleName_18, &ErrFileName_25);
