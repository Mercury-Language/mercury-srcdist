  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 77, (MR_Word) (MR_mkword(MR_mktag(2), &make__module_dep_file_scalar_common_2[6])), Globals_7, &UnredirectGlobals_355);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 71, &VeryVerbose_36);
