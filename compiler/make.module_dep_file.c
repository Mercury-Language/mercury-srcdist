...
{
  {
    ...
    make__util__make_remove_module_file_8_p_0(Globals_7, (MR_Integer) 67, ModuleName_8, Var_16, STATE_VARIABLE_Info_0_11, STATE_VARIABLE_Info_12);
  }
}
...
make__module_dep_file__cleanup_int3_file_6_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  make__util__make_remove_target_file_by_name_8_p_0(Globals_7, (MR_Integer) 63, ModuleName_8, (MR_Word) ((MR_Unsigned) 20U), STATE_VARIABLE_Info_0_11, STATE_VARIABLE_Info_12);
}
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 672, &SearchDirs_18);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 672, &SearchDirs_13);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 69, (MR_Word) (MR_mkword(MR_mktag(2), &make__module_dep_file_scalar_common_5[3])), Globals_7, &UnredirectGlobals_22);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 63, &VeryVerbose_38);
