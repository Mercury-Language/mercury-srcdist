...
{
  {
    ...
    make__util__make_remove_module_file_8_p_0(Globals_7, (MR_Integer) 61, LambdaHeadVar__1_19, Var_29, LambdaHeadVar__2_20, LambdaHeadVar__3_21);
  }
}
...
{
  {
    make__util__make_remove_target_file_by_name_8_p_0(Globals_7, (MR_Integer) 57, LambdaHeadVar__1_19, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5)), LambdaHeadVar__2_20, LambdaHeadVar__3_21);
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 63, (MR_Word) MR_mkword(MR_mktag(2), &make__module_dep_file_scalar_common_6[3]), Globals_7, &UnredirectGlobals_24);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 57, &VeryVerbose_40);
