...
{
  {
    ...
    {
      ModuleDepInfo_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ModuleDepInfo_9, 0) = ((MR_Box) (BurdenedAugCompUnit_4));
    }
    {
