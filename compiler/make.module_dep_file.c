  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) MaybeSourceFileTimestamp_16)) == (MR_Integer) 1))
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 685, &SearchDirs_132);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_56 = make__module_dep_file__IntroducedFrom__func__make_module_dependencies_no_fatal_error__934__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_51)
{
  ...
  if (succeeded)
  {
    ...
    make__build__setup_for_build_with_module_options_10_p_0(DefaultOptionTable_34, (MR_Integer) 1, ModuleName_16, DetectedGradeFlags_35, OptionVariables_36, OptionArgs_37, (MR_Word) (MR_mkword(1, &make__module_dep_file_scalar_common_1[5])), &MayBuild_39);
  ...
  make__module_target__record_made_target_9_p_0(Globals_12, MadeTarget_28, MadeTargetFileName_29, (MR_Word) (&make__module_dep_file_scalar_common_2[6]), Succeeded_46, STATE_VARIABLE_Info_84_84, &STATE_VARIABLE_Info_87_87);
