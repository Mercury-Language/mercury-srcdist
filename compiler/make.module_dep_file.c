  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 682, &SearchDirs_18);
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 682, &SearchDirs_13);
