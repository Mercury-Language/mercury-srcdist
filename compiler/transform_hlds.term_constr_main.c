  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 566, &ArgSizeOnly_26);
  ...
  MR_Word * Specs_5)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 567, &Fail_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 566, &ArgSizeOnly_10);
  BuildOptions_11 = transform_hlds__term_constr_build__term_build_options_init_3_f_0(FunctorInfo_8, Fail_9, ArgSizeOnly_10);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 568, &MaxSize_12);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 565, &CutOff_13);
