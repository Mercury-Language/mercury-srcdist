...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_main__Globals_6, (MR_Integer) 427, &transform_hlds__term_constr_main__Fail_9);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_main__Globals_6, (MR_Integer) 426, &transform_hlds__term_constr_main__ArgSizeOnly_10);
    }
    {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(transform_hlds__term_constr_main__Globals_6, (MR_Integer) 428, &transform_hlds__term_constr_main__MaxSize_12);
    }
    {
      libs__globals__lookup_int_option_3_p_0(transform_hlds__term_constr_main__Globals_6, (MR_Integer) 425, &transform_hlds__term_constr_main__CutOff_13);
    }
