...
transform_hlds__term_constr_main__IntroducedFrom__pred__term2_analyse_scc__256__1_2_p_0(
  MR_Word HeadVar__1_44,
  MR_Word HeadVar__2_56);

static MR_bool MR_CALL 
transform_hlds__term_constr_main__IntroducedFrom__pred__term2_analyse_scc__238__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_main__IntroducedFrom__pred__term2_analyse_scc__256__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_main__IntroducedFrom__pred__term2_analyse_scc__238__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 560, &ArgSizeOnly_26);
  ...
  MR_Word * Specs_5)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 561, &Fail_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 560, &ArgSizeOnly_10);
  BuildOptions_11 = transform_hlds__term_constr_build__term_build_options_init_3_f_0(FunctorInfo_8, Fail_9, ArgSizeOnly_10);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 562, &MaxSize_12);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 559, &CutOff_13);
