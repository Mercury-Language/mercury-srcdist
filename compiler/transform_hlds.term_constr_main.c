...
{
  {
    ...
    if (succeeded)
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_9, (MR_Integer) 0)));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), SCCEntryPoints_12, (MR_Integer) 1)));
    MR_Word Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), SCCEntryPoints_12, (MR_Integer) 2)));
    MR_Word Var_50;
    MR_Word Var_51;
    MR_Word Var_49;
    ...
    mercury__set__filter_3_p_0(TypeCtorInfo_53_53, Var_35, SCC_15, &NeedsAR_16);
    Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), SCCEntryPoints_12, (MR_Integer) 0)));
    ...
    {
      NeedsAREntryPoints_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    mercury__set__filter_3_p_0(TypeCtorInfo_53_53, Var_37, NeedsAR_16, &NeedsArgSize_19);
    ...
    if ((Pass1Errors_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      MaybeEarlyPass2Result_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word Var_41;
      ...
      {
        MaybeEarlyPass2Result_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 435, &ArgSizeOnly_26);
    switch (ArgSizeOnly_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word TypeCtorInfo_15_71;
          MR_Word TypeCtorInfo_16_72;
          ...
          mercury__set__filter_3_p_0(TypeCtorInfo_53_53, Var_43, NeedsAR_16, &NeedsTerm_27);
          TypeCtorInfo_15_71 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
          TypeCtorInfo_16_72 = (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0;
          if ((MaybeEarlyPass2Result_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            mercury__set__foldl_4_p_0(TypeCtorInfo_15_71, TypeCtorInfo_16_72, Var_66, NeedsTerm_27, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_40)), &conv1_STATE_VARIABLE_ModuleInfo_32);
            *STATE_VARIABLE_ModuleInfo_32 = ((MR_Word) conv1_STATE_VARIABLE_ModuleInfo_32);
            if (((MR_tag((MR_Word) Pass2Result_28)) == (MR_mktag((MR_Integer) 1))))
            {
          ...
          else
          {
            ...
            mercury__set__foldl_4_p_0(TypeCtorInfo_15_71, TypeCtorInfo_16_72, Var_75, NeedsTerm_27, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_40)), &conv3_STATE_VARIABLE_ModuleInfo_32);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 436, &Fail_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 435, &ArgSizeOnly_10);
    BuildOptions_11 = transform_hlds__term_constr_build__term_build_options_init_3_f_0(FunctorInfo_8, Fail_9, ArgSizeOnly_10);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 437, &MaxSize_12);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 434, &CutOff_13);
