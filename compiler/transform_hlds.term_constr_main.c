...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_termination2_info_2_p_0(ProcInfo_6, &TermInfo_7);
    {
      ...
      succeeded = (Var_9 == (MR_Word) ((MR_Integer) 0));
    }
    if (!(succeeded))
    {
      MR_Word Var_8;
...
{
  {
    ...
    if ((Pass1Errors_21 == (MR_Word) ((MR_Integer) 0)))
      MaybeEarlyPass2Result_22 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Word Var_41;
      ...
      case (MR_Integer) 0:
        {
          ...
          if ((MaybeEarlyPass2Result_22 == (MR_Word) ((MR_Integer) 0)))
          {
