    ...
    case (MR_Integer) 0:
      {
        ...
        if ((MaybeEarlyPass2Result_22 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          transform_hlds__term_constr_pass2__prove_termination_in_scc_4_p_0(Pass2Opts_11, NeedsTerm_27, STATE_VARIABLE_ModuleInfo_40_40, &Pass2Result_28);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&transform_hlds__term_constr_main_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (transform_hlds__term_constr_main__term2_analyse_scc_8_p_0_6));
            MR_hl_field(MR_mktag(0), Var_63, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_63, 3) = ((MR_Box) (Pass2Result_28));
          }
          mercury__set__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_63, NeedsTerm_27, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_40)), &conv1_STATE_VARIABLE_ModuleInfo_32);
        ...
        {
          MR_Word Pass2Result_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeEarlyPass2Result_22, (MR_Integer) 0))));
          MR_Word Errors_71;
          MR_Word Var_72;
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (&transform_hlds__term_constr_main_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_72, 1) = ((MR_Box) (transform_hlds__term_constr_main__term2_analyse_scc_8_p_0_7));
            MR_hl_field(MR_mktag(0), Var_72, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_72, 3) = ((MR_Box) (Pass2Result_70));
          }
          mercury__set__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_72, NeedsTerm_27, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_40)), &conv3_STATE_VARIABLE_ModuleInfo_32);
          *STATE_VARIABLE_ModuleInfo_32 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_32));
          Errors_71 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Pass2Result_70, (MR_Integer) 0))));
          transform_hlds__term_constr_errors__maybe_report_term2_errors_5_p_0(*STATE_VARIABLE_ModuleInfo_32, NeedsTerm_27, Errors_71, STATE_VARIABLE_Specs_0_33, STATE_VARIABLE_Specs_34);
        }
      }
      break;
    case (MR_Integer) 1:
