...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 455, &ArgSizeOnly_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 456, &Fail_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 455, &ArgSizeOnly_10);
    BuildOptions_11 = transform_hlds__term_constr_build__term_build_options_init_3_f_0(FunctorInfo_8, Fail_9, ArgSizeOnly_10);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 457, &MaxSize_12);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 454, &CutOff_13);
