        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&make__dependencies_scalar_common_13[0]));
                MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (make__dependencies__check_dependency_timestamps__ho17_10_p_0_3));
                MR_hl_field(MR_mktag(0), Var_46, 2) = ((MR_Box) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(0), Var_46, 3) = ((MR_Box) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0));
                MR_hl_field(MR_mktag(0), Var_46, 4) = ((MR_Box) (TargetFileName_12));
                MR_hl_field(MR_mktag(0), Var_46, 5) = ((MR_Box) (MaybeTimestamp_13));
                MR_hl_field(MR_mktag(0), Var_46, 6) = ((MR_Box) (DepFiles_15));
                MR_hl_field(MR_mktag(0), Var_46, 7) = ((MR_Box) (DepTimestamps_17));
              }
              make__util__debug_make_msg_4_p_0(Globals_11, Var_46);
              *DepsResult_18 = (MR_Integer) 1;
            }
            else
              *DepsResult_18 = (MR_Integer) 0;
