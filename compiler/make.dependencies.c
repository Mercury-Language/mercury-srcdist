...
{
  {
    ...
    if (make__dependencies__succeeded)
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(make__dependencies__Globals_11, (MR_Integer) 611, &make__dependencies__KeepGoing_22);
        }
        {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(make__dependencies__Globals_3, (MR_Integer) 613, &make__dependencies__TrackFlags_7);
    }
    {
