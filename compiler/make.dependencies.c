      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 350, &Transitive_16);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 646, &Rebuild_23);
        switch (Rebuild_23) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 349, &IntermodOpt_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 354, &IntermodAnalysis_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 649, &TrackFlags_7);
