      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 490, &Transitive_16);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 297, &HighLevelCode_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 489, &IntermodOpt_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &IntermodAnalysis_9);
