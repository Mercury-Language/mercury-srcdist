  ...
  MR_Box * wrapper_arg_3)
{
  ...
  make__dependencies__IntroducedFrom__pred__find_direct_prereqs_of_target_file__231__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
