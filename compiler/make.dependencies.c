  ...
  MR_Word * STATE_VARIABLE_Info_49)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 725, &DebugMake_37);
  switch (DebugMake_37) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        case (MR_Integer) 11:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 467, &TrackFlags_119);
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 427, &IntermodOpt_122);
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 434, &IntermodAnalysis_123);
