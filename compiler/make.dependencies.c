      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 354, &Transitive_16);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 353, &IntermodOpt_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 358, &IntermodAnalysis_9);
