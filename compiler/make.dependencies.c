  ...
  MR_Word * STATE_VARIABLE_Info_49)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 134, &DebugMake_37);
  switch (DebugMake_37) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        case (MR_Integer) 11:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 696, &TrackFlags_119);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 339, &HighLevelCode_28);
