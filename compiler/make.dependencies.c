      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 341, &Transitive_16);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 637, &Rebuild_23);
        switch (Rebuild_23) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_1, (MR_Integer) 273, &HighLevelCode_48);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 340, &IntermodOpt_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 345, &IntermodAnalysis_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 640, &TrackFlags_7);
