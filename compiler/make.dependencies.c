      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 491, &Transitive_16);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 298, &HighLevelCode_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &IntermodOpt_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 495, &IntermodAnalysis_9);
