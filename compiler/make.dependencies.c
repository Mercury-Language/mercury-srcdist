    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 497, &Transitive_16);
  ...
  MR_Word * DepsResult_18)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 660, &Rebuild_23);
      switch (Rebuild_23) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
    ...
    *STATE_VARIABLE_Info_28 = ((MR_Word) (conv7_STATE_VARIABLE_Info_28));
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 660, &Rebuild_74);
        switch (Rebuild_74) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 306, &HighLevelCode_13);
  ...
  MR_Word Globals_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 663, &TrackFlags_5);
  switch (TrackFlags_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &IntermodOpt_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &IntermodAnalysis_9);
