  ...
  MR_Word * STATE_VARIABLE_Info_47)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 106, &DebugMake_37);
  switch (DebugMake_37) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        case (MR_Integer) 11:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 669, &TrackFlags_113);
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 502, &IntermodOpt_116);
            libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 507, &IntermodAnalysis_117);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 312, &HighLevelCode_28);
