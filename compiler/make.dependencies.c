...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), DepsRoot_19, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (DependenciesType_12))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (ModuleLocn_13)))));
    }
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), DepsRoot_23, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (DependenciesType_14))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (ModuleLocn_15)))));
      }
