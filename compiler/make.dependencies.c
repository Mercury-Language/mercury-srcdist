  ...
  MR_Word * DepsResult_18)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 664, &Rebuild_23);
      switch (Rebuild_23) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
    ...
    *STATE_VARIABLE_Info_28 = ((MR_Word) (conv7_STATE_VARIABLE_Info_28));
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 664, &Rebuild_76);
        switch (Rebuild_76) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
