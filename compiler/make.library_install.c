...
make__library_install__IntroducedFrom__pred__install_subdir_file__595__1_2_p_0(
  MR_String InstallDir_14,
  MR_String CurDir_23);

static MR_bool MR_CALL 
make__library_install__IntroducedFrom__pred__install_subdir_file__603__1_2_p_0(
  MR_String NgsDir_24,
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  else
  {
    ...
    Var_74 = mercury__dir__f_slash_2_f_0(LibDir_27, (MR_String) "ints");
    {
      ...
      MR_hl_field(0, Var_71, 1) = ((MR_Box) (make__library_install__install_ints_and_headers_for_module_10_p_0_1));
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_12, (MR_String) "predicate \140make.library_install.install_ints_and_headers_for_module\'/10", (MR_Word) (MR_mkword(3, &make__library_install_scalar_common_4[8])), ModuleName_14, &FileName_30, &_FileNameProposed_31);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__install_subdir_file__595__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__install_subdir_file__603__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  make__library_install__install_ints_and_headers_for_module_10_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Succeeded_33, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Info_35);
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              parse_tree__file_names__module_name_to_lib_file_name_create_dirs_9_p_0(Globals_14, (MR_String) "predicate \140make.library_install.install_library_grade_files\'/12", (MR_String) "lib", (MR_Word) (MR_mkword(3, &make__library_install_scalar_common_4[11])), MainModuleName_17, &StaticLibFileName_34, &_StaticLibFileNameProposed_35);
              parse_tree__file_names__module_name_to_lib_file_name_create_dirs_9_p_0(Globals_14, (MR_String) "predicate \140make.library_install.install_library_grade_files\'/12", (MR_String) "lib", (MR_Word) (MR_mkword(3, &make__library_install_scalar_common_4[12])), MainModuleName_17, &SharedLibFileName_36, &_SharedLibFileNameProposed_37);
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_14, (MR_String) "predicate \140make.library_install.install_library_grade_files\'/12", (MR_Word) (MR_mkword(3, &make__library_install_scalar_common_4[13])), MainModuleName_17, &DllFileName_27, &_DllFileNameProposed_28);
          ...
          case (MR_Integer) 2:
            {
              ...
              parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_14, (MR_String) "predicate \140make.library_install.install_library_grade_files\'/12", (MR_Word) (MR_mkword(2, &make__library_install_scalar_common_3[1])), MainModuleName_17, &JarFileName_30, &_JarFileNameProposed_31);
        ...
        }
        {
          ...
          MR_hl_field(0, Var_71, 1) = ((MR_Box) (make__library_install__install_library_grade_files_12_p_0_1));
          MR_hl_field(0, Var_71, 2) = ((MR_Box) ((MR_Integer) 5));
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  OptionArgs0_24 = make__make_info__make_info_get_option_args_1_f_0(STATE_VARIABLE_Info_0_45);
  {
    ...
    MR_hl_field(1, Var_51, 1) = ((MR_Box) (MR_mkword(1, &make__library_install_scalar_common_4[10])));
  }
  {
  ...
  if ((OptionsSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_69 = make__timestamp__init_target_file_timestamp_map_0_f_0();
    make__make_info__make_info_set_target_file_timestamp_map_3_p_0(Var_69, STATE_VARIABLE_Info_68_68, &STATE_VARIABLE_Info_70_70);
