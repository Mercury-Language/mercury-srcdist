  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 589, &Prefix_24);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 117, &HighLevelCode_27);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 317, &IntermodAnalysis_34);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 691, &InstallProposed_38);
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 589, &Prefix_26);
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 597, &ExtraHdrs_46);
              libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 589, &Prefix_47);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 691, &InstallProposed_31);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 691, &InstallProposed_69);
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 590, &LibGrades_61);
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if ((ModulesWithoutDepInfo_52 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 589, &Prefix0_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 317, &IntermodAnalysis_26);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 117, &HighLevelCode_20);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 616, &TargetArch_32);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 623, &RanLibCommand_81);
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 624, &RanLibFlags_82);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_23)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 623, &RanLibCommand_35);
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 624, &RanLibFlags_36);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 623, &RanLibCommand_97);
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 624, &RanLibFlags_98);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_20)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 589, &Prefix_15);
  ...
  MR_Word * STATE_VARIABLE_GsLibDirMap_21)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 589, &Prefix_14);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 660, &UseSymLinks_19);
  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  if ((OptionsSpecs_37 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(LibGlobals_38, (MR_Integer) 131, &VeryVerbose_44);
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  if ((ModulesWithoutDepInfo_55 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 589, &Prefix0_17);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 597, &ExtraHdrFileNames_95);
  ...
  MR_Word * STATE_VARIABLE_NgsLibDirMap_18)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 589, &Prefix_12);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 660, &UseSymLinks_16);
