    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 750, &InstallProposed_38);
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 729, &ExtraHdrs_46);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 750, &InstallProposed_31);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 750, &InstallProposed_69);
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if ((ModulesWithoutDepInfo_52 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 690, &Prefix0_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 525, &IntermodAnalysis_26);
  ...
  MR_Word * STATE_VARIABLE_Info_43)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 740, &TargetArch_35);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_14, (MR_Integer) 701, &LibLinkages_72);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 639, &RanLibCommand_87);
            libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 640, &RanLibFlags_88);
  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  if ((OptionsSpecs_37 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(LibGlobals_38, (MR_Integer) 77, &VeryVerbose_44);
