  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 574, &Prefix_24);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 436, &IntermodAnalysis_34);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 676, &InstallProposed_38);
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 574, &Prefix_26);
  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 582, &ExtraHdrs_42);
        libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 574, &Prefix_43);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 676, &InstallProposed_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 676, &InstallProposed_65);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 575, &LibGrades_57);
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if ((ModulesWithoutDepInfo_52 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 574, &Prefix0_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 436, &IntermodAnalysis_26);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_38)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 601, &TargetArch_32);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 608, &RanLibCommand_81);
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 609, &RanLibFlags_82);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_23)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 608, &RanLibCommand_35);
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 609, &RanLibFlags_36);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 608, &RanLibCommand_97);
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 609, &RanLibFlags_98);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_20)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 574, &Prefix_15);
  ...
  MR_Word * STATE_VARIABLE_GsLibDirMap_21)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 574, &Prefix_14);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 645, &UseSymLinks_19);
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  if ((ModulesWithoutDepInfo_55 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 574, &Prefix0_17);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 582, &ExtraHdrFileNames_95);
  ...
  MR_Word * STATE_VARIABLE_NgsLibDirMap_18)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 574, &Prefix_12);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 645, &UseSymLinks_16);
