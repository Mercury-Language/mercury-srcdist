  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 547, &Prefix_24);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 649, &InstallProposed_38);
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 547, &Prefix_26);
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 555, &ExtraHdrs_46);
              libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 547, &Prefix_47);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 649, &InstallProposed_31);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 649, &InstallProposed_69);
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 548, &LibGrades_61);
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if ((ModulesWithoutDepInfo_52 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 547, &Prefix0_21);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_38)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 574, &TargetArch_32);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 581, &RanLibCommand_81);
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 582, &RanLibFlags_82);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_23)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 581, &RanLibCommand_35);
      libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 582, &RanLibFlags_36);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 581, &RanLibCommand_97);
                  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 582, &RanLibFlags_98);
  ...
  MR_Word * STATE_VARIABLE_Succeeded_20)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 547, &Prefix_15);
  ...
  MR_Word * STATE_VARIABLE_GsLibDirMap_21)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 547, &Prefix_14);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 618, &UseSymLinks_19);
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  if ((ModulesWithoutDepInfo_55 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 547, &Prefix0_17);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 555, &ExtraHdrFileNames_95);
  ...
  MR_Word * STATE_VARIABLE_NgsLibDirMap_18)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 547, &Prefix_12);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 618, &UseSymLinks_16);
