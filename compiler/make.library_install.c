  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  else
  {
    ...
    MaybeStdLibGrades_32 = make__make_info__make_info_get_maybe_stdlib_grades_1_f_0(STATE_VARIABLE_Info_0_51);
    ...
    AllFlags_33 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MCFlags_30, Var_63);
    make__options_file__lookup_mercury_stdlib_dir_2_p_0(EnvOptFileVariables_28, &MaybeEnvOptFileStdLibDirs_34);
    libs__handle_options__handle_given_options_11_p_0(ProgressStream_13, DefaultOptionTable_31, MaybeStdLibGrades_32, MaybeEnvOptFileStdLibDirs_34, AllFlags_33, &Var_35, &Var_36, &OptionsSpecs_37, &LibGlobals_38);
  }
  if ((OptionsSpecs_37 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    make__make_info__make_info_set_dep_file_status_map_3_p_0(StatusMap_43, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_72_72);
    ...
    libs__process_util__setup_checking_for_interrupt_3_p_0(&Cookie_45);
    {
      ...
      MR_hl_field(0, Var_78, 4) = ((MR_Box) (LibGlobals_38));
    ...
    libs__process_util__call_in_forked_process_4_p_0(Var_78, &Succeeded0_46);
    {
    ...
    libs__process_util__teardown_checking_for_interrupt_9_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), VeryVerbose_44, Cookie_45, CleanupPred_47, Succeeded0_46, &Succeeded1_48, ((MR_Box) (STATE_VARIABLE_Info_75_75)), &conv4_STATE_VARIABLE_Info_52);
