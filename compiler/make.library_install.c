  ...
  MR_Word * STATE_VARIABLE_Succeeded_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 338, &HighLevelCode_20);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 647, &RanLibCommand_82);
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 648, &RanLibFlags_83);
