...
make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1224__1_2_p_0(
  MR_String InstallDir_14,
  MR_String CurDir_23);

static MR_bool MR_CALL 
make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1232__1_2_p_0(
  MR_String NgsDir_24,
  MR_String HeadVar__2_43);

static MR_bool MR_CALL 
make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1229__1_2_p_0(
  MR_String InstallDir_14,
  MR_String CurDir_48);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 740, &InstallProposed_38);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1224__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1232__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__legacy_install_subdir_file__1229__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 719, &ExtraHdrs_46);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 740, &InstallProposed_31);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 740, &InstallProposed_69);
  ...
  MR_Word * STATE_VARIABLE_Info_43)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_14, (MR_Integer) 730, &TargetArch_35);
