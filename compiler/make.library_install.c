...
make__library_install__IntroducedFrom__pred__install_subdir_file__586__1_2_p_0(
  MR_String InstallDir_14,
  MR_String CurDir_22);

static MR_bool MR_CALL 
make__library_install__IntroducedFrom__pred__install_subdir_file__594__1_2_p_0(
  MR_String NgsDir_23,
  MR_String HeadVar__2_42);

static MR_bool MR_CALL 
make__library_install__IntroducedFrom__pred__install_subdir_file__591__1_2_p_0(
  MR_String InstallDir_14,
  MR_String CurDir_47);
...
static /* final */ const MR_Box make__library_install_scalar_common_4[25][2];
...
static /* final */ const MR_Box make__library_install_scalar_common_4[25][2] = {
  ...
  /* row  12 */
  {
    ((MR_Box) (MR_mkword(3, &make__library_install_scalar_common_4[11]))),
  ...
  /* row  14 */
  {
    ((MR_Box) (MR_mkword(3, &make__library_install_scalar_common_4[13]))),
  ...
  {
    ((MR_Box) ((MR_String) "mihs")),
    ((MR_Box) (MR_mkword(1, &make__library_install_scalar_common_4[15])))
  },
  /* row  17 */
  {
    ((MR_Box) ((MR_String) "mhs")),
  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      make__library_install__install_subdir_file_10_p_0(ProgressStream_13, Globals_14, GsLibDirMap_16, GradeIncDir_28, ModuleName_18, (MR_Tuple) (&make__library_install_scalar_common_4[12]), STATE_VARIABLE_Succeeded_0_36, &STATE_VARIABLE_Succeeded_55_55);
      IntsDir_30 = mercury__dir__f_slash_2_f_0(LibDir_25, (MR_String) "ints");
      make__library_install__install_subdir_file_10_p_0(ProgressStream_13, Globals_14, NgsLibDirMap_15, IntsDir_30, ModuleName_18, (MR_Tuple) (&make__library_install_scalar_common_4[12]), STATE_VARIABLE_Succeeded_55_55, &STATE_VARIABLE_Succeeded_60_60);
    }
    else
    ...
    switch (IntermodAnalysis_34) {
      ...
      case (MR_Integer) 0:
        *STATE_VARIABLE_Succeeded_37 = STATE_VARIABLE_Succeeded_67_67;
        break;
      case (MR_Integer) 1:
        make__library_install__install_subdir_file_10_p_0(ProgressStream_13, Globals_14, GsLibDirMap_16, GradeIntsDir_31, ModuleName_18, (MR_Tuple) (&make__library_install_scalar_common_4[14]), STATE_VARIABLE_Succeeded_67_67, STATE_VARIABLE_Succeeded_37);
        break;
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_34)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_61, 0) = ((MR_Box) (&make__library_install_scalar_common_4[7]));
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_12, (MR_String) "predicate \140make.library_install.install_ints_and_headers_for_module\'/10", (MR_Word) (MR_mkword(3, &make__library_install_scalar_common_4[8])), ModuleName_14, &FileName_30);
          ...
          make__library_install__install_subdir_file_10_p_0(ProgressStream_11, Globals_12, NgsLibDirMap_13, Var_81, ModuleName_14, (MR_Tuple) (&make__library_install_scalar_common_4[9]), STATE_VARIABLE_Succeeded_78_78, STATE_VARIABLE_Succeeded_32);
        }
        break;
      case (MR_Integer) 1:
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__install_subdir_file__586__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__install_subdir_file__594__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__library_install__IntroducedFrom__pred__install_subdir_file__591__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_NgsLibDirMap_18)
{
  ...
  SubDirs_15 = (MR_Word) (MR_mkword(1, &make__library_install_scalar_common_4[22]));
