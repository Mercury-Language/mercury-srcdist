...
static /* final */ const MR_Box make__library_install_scalar_common_4[26][2];
  ...
  MR_Word * STATE_VARIABLE_NgsLibDirMap_18)
{
  ...
  SubDirs_15 = (MR_Word) (MR_mkword(1, &make__library_install_scalar_common_4[23]));
