...
static void MR_CALL 
transform_hlds__lco__IntroducedFrom__pred__lco_transform_variant_plain_call__1878__1_2_p_0(
  MR_Word HeadVar__1_74,
  MR_Word * HeadVar__2_75);

static MR_bool MR_CALL 
transform_hlds__lco__IntroducedFrom__pred__make_addr_vars__1505__1_2_p_0(
  MR_Word HeadVar__5_5,
  MR_Word HeadVar__2_25);

static MR_bool MR_CALL 
transform_hlds__lco__IntroducedFrom__pred__update_construct__1300__1_2_p_0(
  MR_Word ConsId_23,
...
{
  {
    ...
    transform_hlds__lco__IntroducedFrom__pred__lco_transform_variant_plain_call__1878__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_75);
...
{
  {
    ...
    succeeded = transform_hlds__lco__IntroducedFrom__pred__make_addr_vars__1505__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(ModuleInfo_7, Mode0_60, HeadVarType_72, &TopFunctorMode_73);
...
{
  {
    ...
    succeeded = transform_hlds__lco__IntroducedFrom__pred__update_construct__1300__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 281, &UnboxedFloat_35);
