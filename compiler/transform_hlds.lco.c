...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ConstInfo_34, 6) = (MR_Box) (((((MR_Unsigned) (CurProcDetism_29) << (MR_Integer) 2)) | (((((MR_Unsigned) (AllowFloatAddr_33) << (MR_Integer) 1)) | (MR_Unsigned) (HighLevelData_31)))));
    }
    {
