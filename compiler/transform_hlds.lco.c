      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_78_78 = (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&transform_hlds__lco_scalar_common_7[6]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 276, &UnboxedFloat_33);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        mercury__assoc_list__values_2_p_0(TypeCtorInfo_154_154, TypeInfo_149_149, Mismatches_29, &MismatchedCallArgs_36);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&transform_hlds__lco_scalar_common_7[5]));
        ...
        if (succeeded)
        {
          TypeCtorInfo_162_162 = (MR_Word) (&transform_hlds__lco__transform_hlds__lco__type_ctor_info_field_id_0);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&transform_hlds__lco_scalar_common_10[0]));
