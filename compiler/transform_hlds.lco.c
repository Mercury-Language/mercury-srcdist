  ...
  MR_Word * STATE_VARIABLE_Info_43)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        ProcTransform_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ProcTransform_31, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        MR_hl_field(MR_mktag(3), ProcTransform_31, 1) = ((MR_Box) (VariantNumber_20));
        MR_hl_field(MR_mktag(3), ProcTransform_31, 2) = ((MR_Box) (AddrOutArgNums_30));
      }
      {
        Origin_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Origin_32, 0) = ((MR_Box) (ProcTransform_31));
        MR_hl_field(MR_mktag(3), Origin_32, 1) = ((MR_Box) (Origin0_29));
        MR_hl_field(MR_mktag(3), Origin_32, 2) = ((MR_Box) (PredId_8));
        MR_hl_field(MR_mktag(3), Origin_32, 3) = ((MR_Box) (ProcId_9));
      }
