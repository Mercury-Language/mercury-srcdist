...
{
  {
    ...
    mercury__pair__fst_2_p_0((MR_Word) &transform_hlds__lco_scalar_common_1[4], (MR_Word) &transform_hlds__lco__transform_hlds__lco__type_ctor_info_store_target_0, HeadVar__1_69, &conv0_HeadVar__2_70);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__lco_scalar_common_1[4], &Var_8, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes__hlds__vartypes__type_ctor_info_vartypes_0, &Var_19, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
...
{
  {
    ...
    else
    {
      ...
      TypeInfo_65_65 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_71_71 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 267, &HighLevelData_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 256, &UnboxedFloat_32);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_32 = (MR_Word) &transform_hlds__lco_scalar_common_2[12];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        TypeInfo_81_81 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_75_75 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 267, &HighLevelData_76);
    switch (HighLevelData_76) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__lco__lco_transform_variant_goal_9_p_0_env_0__TypeInfo_115_115 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 267, &HighLevelData_48);
        switch (HighLevelData_48) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word TypeInfo_73_73 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
              ...
              mercury__list__map_3_p_0(TypeInfo_65_65, TypeInfo_73_73, (MR_Word) &transform_hlds__lco_scalar_common_2[9], GroundingVarToAddr_23, &GroundVars_49);
...
{
  {
    ...
    {
      MR_Word TypeInfo_21_21 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word TypeInfo_24_24 = (MR_Word) &transform_hlds__lco_scalar_common_1[4];
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) &transform_hlds__lco_scalar_common_2[2], TypeCtorInfo_55_55, (MR_Word) &transform_hlds__lco_scalar_common_2[8], CurSCCUpdates_14, ((MR_Box) (STATE_VARIABLE_ModuleInfo_26_26)), &conv9_STATE_VARIABLE_ModuleInfo_39_39);
