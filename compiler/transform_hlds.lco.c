          ...
          case (MR_Integer) 3:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_85, 1) = ((MR_Box) (transform_hlds__lco__lco_transform_variant_goal_10_p_0_3));
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) (transform_hlds__lco__lco_transform_variant_goal_10_p_0_10));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_41, (MR_Integer) 284, &UnboxedFloat_44);
