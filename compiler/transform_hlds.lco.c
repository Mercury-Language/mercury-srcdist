...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 272, &HighLevelData_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 272, &HighLevelData_76);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 272, &HighLevelData_48);
