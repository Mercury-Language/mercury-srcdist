...
{
  {
    ...
    if ((MaybeFieldId_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_7, Var_49, (MR_String) "store_at_ref_impure", (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, Var_55, (MR_Word) ((MR_Unsigned) 0U), Var_57, Var_58, Goal_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 278, &HighLevelData_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 278, &HighLevelData_76);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 278, &HighLevelData_48);
