...
MR_def_static(transform_hlds__lco__update_call_args_6_0)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__lco__IntroducedFrom__pred__update_call_args__539__1_2_0);
...
MR_def_label(transform_hlds__lco__update_construct_3_0,14)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__lco__IntroducedFrom__pred__update_construct__742__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
