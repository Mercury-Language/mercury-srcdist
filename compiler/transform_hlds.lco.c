          ...
          case (MR_Integer) 0:
            {
              ...
              hlds__goal_util__update_instmap_goal_info_3_p_0(GoalInfo0_21, InstMap0_15, &InstMap1_133);
  ...
  MR_Word * STATE_VARIABLE_Info_63)
{
  ...
  if (succeeded)
  {
    ...
    packed_word_4 = (MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_0_62, (MR_Integer) 3)));
    {
      MR_Word base;
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_41, (MR_Integer) 311, &UnboxedFloat_44);
