  ...
  MR_Word * RevBeforeGoals_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      GoalExpr_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RevGoal_16, (MR_Integer) 0))));
      GoalInfo_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RevGoal_16, (MR_Integer) 1))));
      succeeded = ((MR_tag((MR_Word) GoalExpr_24)) == (MR_Integer) 2);
      if (succeeded)
      {
        PredId_26 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_24, (MR_Integer) 0))));
        ProcId_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GoalExpr_24, (MR_Integer) 1))));
        Args_28 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_24, (MR_Integer) 2))));
        Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstInfo_10, (MR_Integer) 1))));
        TypeCtorInfo_73_87 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (PredId_26));
          MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (ProcId_27));
        }
        ...
        if (succeeded)
        {
          ...
          ProcInfo_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstInfo_10, (MR_Integer) 4))));
          Var_90 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ConstInfo_10, (MR_Integer) 6))) >> 2)) & (MR_Integer) 7);
          succeeded = (Var_45 == Var_90);
          if (succeeded)
          {
            ModuleInfo_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_9, (MR_Integer) 0))));
            hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_32, ProcInfo_33, &VarTable_34);
            ...
            if (succeeded)
            {
              ...
              CurrProcOutArgs_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstInfo_10, (MR_Integer) 5))));
