  ...
  MR_Word * STATE_VARIABLE_CLD_33)
{
  ...
  else
  {
    ...
    MR_Word Var_44;
    MR_Word CondRval_56;
    MR_Word SuccessLabel_57;
    MR_Word BeforeFailure_58;
    MR_Word FailCode_59;
    MR_Word CondCode_60;
    MR_Word SuccessLabelCode_61;
    MR_Word STATE_VARIABLE_CI_21_62;
    MR_Word STATE_VARIABLE_CI_22_63;
    MR_Word Var_66;
    MR_Word Var_67;
    MR_Word Var_68;
    MR_Word Var_70;
    ...
    ll_backend__pragma_c_gen__generate_runtime_cond_code_4_p_0(TraceRuntimeCond_29, &CondRval_56, STATE_VARIABLE_CI_0_30, &STATE_VARIABLE_CI_21_62);
    ll_backend__code_info__get_next_label_3_p_0(&SuccessLabel_57, STATE_VARIABLE_CI_21_62, &STATE_VARIABLE_CI_22_63);
    ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_0_32, &BeforeFailure_58);
    ll_backend__code_loc_dep__generate_failure_4_p_0(&FailCode_59, STATE_VARIABLE_CI_22_63, STATE_VARIABLE_CI_31, STATE_VARIABLE_CLD_0_32);
    ll_backend__code_loc_dep__reset_to_position_3_p_0(BeforeFailure_58, *STATE_VARIABLE_CI_31, STATE_VARIABLE_CLD_33);
    {
      Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (SuccessLabel_57));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (CondRval_56));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) ((MR_String) "environment variable tests"));
    }
    CondCode_60 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_66)));
    {
      ...
      MR_hl_field(MR_mktag(3), Var_71, 1) = ((MR_Box) (SuccessLabel_57));
    }
    {
      Var_70 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (Var_71));
      MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) ((MR_String) "environment variable tests successful"));
    }
    SuccessLabelCode_61 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_70)));
    Var_73 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FailCode_59, SuccessLabelCode_61);
    *Code_24 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CondCode_60, Var_73);
  }
}
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_42, &TypeTable_58);
        succeeded = parse_tree__prog_type__type_to_ctor_2_p_0(OrigType_39, &TypeCtor_59);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeBody_61)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_69 = (MR_Word) (MR_body((MR_Word) (TypeBody_61), (MR_Integer) 1));
              MaybeC_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          if ((MaybeC_62 == (MR_Word) ((MR_Unsigned) 0U)))
            {
          ...
          {
            MR_Word Data_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_62, (MR_Integer) 0))));
            MR_String Name_66;
            MR_Word Assertions_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_65, (MR_Integer) 2))));
            MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_65, (MR_Integer) 0))));
            MR_Word Var_71;

            Name_66 = (MR_String) (Var_70);
            {
              Var_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (Name_66));
              MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (Assertions_68));
            }
            {
              MaybeForeign_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_43, 0) = ((MR_Box) (Var_71));
            }
          }
        else
        ...
        if (succeeded)
        {
          Name_76 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeArgName_38, (MR_Integer) 0))));
          Var_78 = (MR_Char) 95;
          succeeded = mercury__string__first_char_3_p_2(Name_76, Var_78, &Var_77);
          succeeded = !(succeeded);
        }
        if (succeeded)
        {
          ...
          IsDummy_47 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_42, VarType_46);
          {
            ...
            MR_hl_field(MR_mktag(0), PragmaCOutput_48, 4) = ((MR_Box) (Name_76));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_29 = parse_tree__builtin_lib_types__float_type_0_f_0();
          succeeded = parse_tree__prog_data____Unify____mer_type_0_0(VarType_18, Var_29);
          if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_CLD_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Name_43 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeArgName_18, (MR_Integer) 0))));
        Var_45 = (MR_Char) 95;
        succeeded = mercury__string__first_char_3_p_2(Name_43, Var_45, &Var_44);
        succeeded = !(succeeded);
      }
      if (succeeded)
      {
        ...
        hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_24, &TypeTable_49);
        succeeded = parse_tree__prog_type__type_to_ctor_2_p_0(OrigType_19, &TypeCtor_50);
        if (succeeded)
        {
          succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_49, TypeCtor_50, &TypeDefn_51);
          if (succeeded)
          {
            hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_51, &TypeBody_52);
            succeeded = ((MR_tag((MR_Word) TypeBody_52)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_60 = (MR_Word) (MR_body((MR_Word) (TypeBody_52), (MR_Integer) 1));
              MaybeC_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_60, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          ...
          {
            MR_Word Data_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_53, (MR_Integer) 0))));
            MR_String Name_57;
            MR_Word Assertions_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_56, (MR_Integer) 2))));
            MR_Word Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_56, (MR_Integer) 0))));
            MR_Word Var_62;

            Name_57 = (MR_String) (Var_61);
            {
              Var_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (Name_57));
              MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (Assertions_59));
            }
            {
              MaybeForeign_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_29, 0) = ((MR_Box) (Var_62));
            }
          }
        else
          MaybeForeign_29 = (MR_Word) ((MR_Unsigned) 0U);
        {
          ...
          MR_hl_field(MR_mktag(0), HeadInput_30, 0) = ((MR_Box) (Name_43));
  ...
  MR_Word * ProcLabelHashUndef_10)
{
  ...
  if (succeeded)
  {
    ...
    ProcLabelStr_11 = backend_libs__name_mangle__proc_label_to_c_string_2_f_0((MR_Integer) 1, ProcLabel_22);
  }
  else
  {
    MR_Word Label_23;
    ...
    if (succeeded)
    {
      ...
      ProcLabelStr_11 = ll_backend__llds_out__llds_out_code_addr__label_to_c_string_2_f_0((MR_Integer) 1, Label_23);
    }
    else
      {
