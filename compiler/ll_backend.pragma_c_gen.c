...
{
  {
    ...
    ll_backend__pragma_c_gen__get_foreign_proc_input_vars_7_p_0(InCArgs_34, CanOptAwayUnnamedArgs_25, &InputDescs_44, &InputVarsCode_45, STATE_VARIABLE_CI_100_100, STATE_VARIABLE_CLD_101_101, &STATE_VARIABLE_CLD_102_102);
