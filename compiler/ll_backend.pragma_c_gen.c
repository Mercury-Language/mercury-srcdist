      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            IsDummy_32 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_27, VarType_31);
            {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  IsDummy_98 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_27, VarType_97);
                  {
          ...
          case (MR_Integer) 0:
            {
              ...
              IsDummy_128 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_126, VarType_123);
              {
