      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeBody_62)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_70 = (MR_Word) (MR_body((MR_Word) (TypeBody_62), (MR_Integer) 1));
              MaybeC_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_70, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          ...
          {
            MR_Word Data_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_63, (MR_Integer) 0))));
            MR_String Name_67;
            MR_Word Assertions_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_66, (MR_Integer) 2))));
            MR_Word Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_66, (MR_Integer) 0))));
            MR_Word Var_72;

            Name_67 = (MR_String) (Var_71);
            {
              Var_72 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (Name_67));
              MR_hl_field(MR_mktag(0), Var_72, 1) = ((MR_Box) (Assertions_69));
            }
            {
              MaybeForeign_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_43, 0) = ((MR_Box) (Var_72));
            }
          }
        else
        ...
        if (succeeded)
        {
          Name_77 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeArgName_38, (MR_Integer) 0))));
          Var_79 = (MR_Char) 95;
          succeeded = mercury__string__first_char_3_p_2(Name_77, Var_79, &Var_78);
          succeeded = !(succeeded);
        }
        if (succeeded)
        {
          ...
          IsDummy_47 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_42, VarType_46);
          {
            ...
            MR_hl_field(MR_mktag(0), PragmaCOutput_48, 4) = ((MR_Box) (Name_77));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeBody_54)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_62 = (MR_Word) (MR_body((MR_Word) (TypeBody_54), (MR_Integer) 1));
              MaybeC_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_62, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          ...
          {
            MR_Word Data_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_55, (MR_Integer) 0))));
            MR_String Name_59;
            MR_Word Assertions_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_58, (MR_Integer) 2))));
            MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_58, (MR_Integer) 0))));
            MR_Word Var_64;

            Name_59 = (MR_String) (Var_63);
            {
              Var_64 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (Name_59));
              MR_hl_field(MR_mktag(0), Var_64, 1) = ((MR_Box) (Assertions_61));
            }
            {
              MaybeForeign_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_29, 0) = ((MR_Box) (Var_64));
            }
          }
        else
