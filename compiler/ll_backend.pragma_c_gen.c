  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word TypeBody_64;
        MR_Word Var_73;
        MR_Word _MaybeJava_66;
        MR_Word _MaybeCSharp_67;
        MR_Word _MaybeErlang_68;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeBody_64)) == (MR_mktag((MR_Integer) 0)));
            if (succeeded)
            {
              Var_73 = (MR_Word) MR_body(((MR_Word) TypeBody_64), (MR_Integer) 0);
              MaybeC_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 0)));
              _MaybeJava_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 1)));
              _MaybeCSharp_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 2)));
              _MaybeErlang_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 3)));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          if ((MaybeC_65 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            {
              mercury__require__unexpected_2_p_0((MR_String) "function \140ll_backend.pragma_c_gen.get_maybe_foreign_type_info\'/2", (MR_String) "no c foreign type");
              return;
          ...
          else
          {
            ...
            MR_Word Var_77;
            MR_Word Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), Data_69, (MR_Integer) 1)));
            ...
            {
              MaybeForeign_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_32, 0) = ((MR_Box) (Var_77));
            }
          }
        else
          MaybeForeign_32 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        {
          ...
          MR_hl_field(MR_mktag(0), Input_33, 2) = ((MR_Box) (IsDummy_29));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word TypeBody_89;
              MR_Word Var_93;
              MR_Word _MaybeJava_84;
              MR_Word _MaybeCSharp_85;
              MR_Word _MaybeErlang_86;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) TypeBody_89)) == (MR_mktag((MR_Integer) 0)));
                  if (succeeded)
                  {
                    Var_93 = (MR_Word) MR_body(((MR_Word) TypeBody_89), (MR_Integer) 0);
                    MaybeC_114 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_93, (MR_Integer) 0)));
                    _MaybeJava_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_93, (MR_Integer) 1)));
                    _MaybeCSharp_85 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_93, (MR_Integer) 2)));
                    _MaybeErlang_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_93, (MR_Integer) 3)));
                    succeeded = MR_TRUE;
                  }
                }
              }
              if (succeeded)
                if ((MaybeC_114 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                {
                  {
                    mercury__require__unexpected_2_p_0((MR_String) "function \140ll_backend.pragma_c_gen.get_maybe_foreign_type_info\'/2", (MR_String) "no c foreign type");
                    return;
                ...
                else
                {
                  ...
                  MR_Word Var_102;
                  MR_Word Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), Data_97, (MR_Integer) 1)));
                  ...
                  {
                    MaybeForeign_133 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), MaybeForeign_133, 0) = ((MR_Box) (Var_102));
                  }
                }
              else
                MaybeForeign_133 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              {
                Input_134 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Input_134, 0) = ((MR_Box) (Name_127));
                MR_hl_field(MR_mktag(0), Input_134, 1) = ((MR_Box) (VarType_129));
                MR_hl_field(MR_mktag(0), Input_134, 2) = ((MR_Box) (IsDummy_130));
                ...
                MR_hl_field(MR_mktag(0), Input_134, 6) = ((MR_Box) (BoxPolicy_23));
              }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                Decl_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    NextReg_21 = (MR_Integer) ((MR_Unsigned) LastReg_3 + (MR_Unsigned) (MR_Integer) 1);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 210, &ProfileMemory_13);
