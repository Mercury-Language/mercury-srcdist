...
MR_decl_static(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__361__1_2_0)
MR_decl_static(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__363__1_2_0)
...
MR_def_label(ll_backend__pragma_c_gen__generate_foreign_proc_code_12_0,33)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__361__1_2_0);
	...
	MR_sv(4) = MR_r10;
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Word) MR_string_const("pragma_c_gen.m", 14);
...
MR_def_label(ll_backend__pragma_c_gen__generate_foreign_proc_code_12_0,6)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__363__1_2_0);
...
MR_def_label(ll_backend__pragma_c_gen__generate_foreign_proc_code_12_0,8)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__365__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(ll_backend__pragma_c_gen_module21)
	MR_init_entry1(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__361__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__361__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_foreign_proc_code__361__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__361__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__pragma_c_gen_module22)
	MR_init_entry1(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__363__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__363__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_foreign_proc_code__363__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_foreign_proc_code__363__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
