  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__16_16 = (MR_Word) (&ll_backend__pragma_c_gen_scalar_common_1[2]);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_42, &TypeTable_56);
        succeeded = parse_tree__prog_type__type_to_ctor_2_p_0(OrigType_39, &TypeCtor_57);
        if (succeeded)
        {
          succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_56, TypeCtor_57, &TypeDefn_58);
          if (succeeded)
          {
            hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_58, &TypeBody_59);
            succeeded = ((MR_tag((MR_Word) TypeBody_59)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_67 = (MR_Word) (MR_body((MR_Word) (TypeBody_59), (MR_Integer) 1));
              MaybeC_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          if ((MaybeC_60 == (MR_Word) ((MR_Unsigned) 0U)))
            {
          ...
          {
            MR_Word Data_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_60, (MR_Integer) 0))));
            MR_String Name_64;
            MR_Word Assertions_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_63, (MR_Integer) 2))));
            MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_63, (MR_Integer) 0))));
            MR_Word Var_71;

            Name_64 = (MR_String) (Var_70);
            {
              Var_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (Name_64));
              MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (Assertions_66));
            }
            {
        ...
        if (succeeded)
        {
          Name_72 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeArgName_38, (MR_Integer) 0))));
          Var_74 = (MR_Char) 95;
          succeeded = mercury__string__first_char_3_p_2(Name_72, Var_74, &Var_73);
          succeeded = !(succeeded);
        }
        if (succeeded)
        {
          ...
          IsDummy_47 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_42, VarType_46);
          {
            ...
            MR_hl_field(MR_mktag(0), PragmaCOutput_48, 4) = ((MR_Box) (Name_72));
