  ...
  MR_Word * STATE_VARIABLE_CLD_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Name_42 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeArgName_18, (MR_Integer) 0))));
        Var_44 = (MR_Char) 95;
        succeeded = mercury__string__first_char_3_p_2(Name_42, Var_44, &Var_43);
        succeeded = !(succeeded);
      }
      if (succeeded)
      {
        ...
        hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_24, &TypeTable_45);
        succeeded = parse_tree__prog_type__type_to_ctor_2_p_0(OrigType_19, &TypeCtor_46);
        if (succeeded)
        {
          succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_45, TypeCtor_46, &TypeDefn_47);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_56 = (MR_Word) (MR_body((MR_Word) (TypeBody_48), (MR_Integer) 1));
              MaybeC_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
          }
        }
        if (succeeded)
          if ((MaybeC_49 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              mercury__require__unexpected_2_p_0((MR_String) "function \140ll_backend.pragma_c_gen.get_maybe_foreign_type_info\'/2", (MR_String) "no c foreign type");
              return;
            }
          ...
          {
            MR_Word Data_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_49, (MR_Integer) 0))));
            MR_String Name_53;
            MR_Word Assertions_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_52, (MR_Integer) 2))));
            MR_Word Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_52, (MR_Integer) 0))));
            MR_Word Var_60;

            Name_53 = (MR_String) (Var_59);
            {
              Var_60 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (Name_53));
              MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (Assertions_55));
            }
            {
              MaybeForeign_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeForeign_29, 0) = ((MR_Box) (Var_60));
            }
          }
        else
          MaybeForeign_29 = (MR_Word) ((MR_Unsigned) 0U);
        {
          ...
          MR_hl_field(MR_mktag(0), HeadInput_30, 0) = ((MR_Box) (Name_42));
