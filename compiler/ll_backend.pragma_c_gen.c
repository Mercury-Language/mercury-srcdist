    ...
    if ((ll_backend__pragma_c_gen__MaybeTraceRuntimeCond_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__pragma_c_gen__Var_35, 0) = ((MR_Box) (&ll_backend__pragma_c_gen_scalar_common_2[0]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__pragma_c_gen__Var_40, 0) = ((MR_Box) (&ll_backend__pragma_c_gen_scalar_common_2[0]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__pragma_c_gen__Var_45, 0) = ((MR_Box) (&ll_backend__pragma_c_gen_scalar_common_2[1]));
