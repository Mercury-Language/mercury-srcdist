        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_70 = (MR_Word) ((MR_Word) (TypeBody_62));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_62 = (MR_Word) ((MR_Word) (TypeBody_54));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 230, &ProfileMemory_13);
