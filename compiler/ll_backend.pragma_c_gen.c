  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__pragma_c_gen__IntroducedFrom__pred__generate_code_for_foreign_proc__384__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CI_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 267, &ProfileMemory_13);
