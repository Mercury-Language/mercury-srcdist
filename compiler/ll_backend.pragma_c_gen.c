  ...
  MR_Word * STATE_VARIABLE_CI_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 265, &ProfileMemory_13);
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word ExprA_34 = ((MR_Word) ((MR_hl_field(2, Expr_5, (MR_Integer) 1))));
        MR_Word RvalA_35;

        ll_backend__pragma_c_gen__generate_runtime_cond_code_4_p_0(ExprA_34, &RvalA_35, STATE_VARIABLE_CI_0_19, &STATE_VARIABLE_CI_32_32);
        ll_backend__pragma_c_gen__generate_runtime_cond_code_4_p_0(ExprB_16, &RvalB_17, STATE_VARIABLE_CI_32_32, STATE_VARIABLE_CI_20);
        switch (TraceOp_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
