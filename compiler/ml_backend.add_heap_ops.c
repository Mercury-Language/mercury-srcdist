          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                Var_107 = ((MR_Unsigned) ((MR_hl_field(3, Reason_42, 2))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    MR_Word GoalExpr0_61 = ((MR_Word) ((MR_hl_field(0, Goal0_14, 0))));
    MR_Word GoalInfo_62 = ((MR_Word) ((MR_hl_field(0, Goal0_14, 1))));
    ...
    if (succeeded)
    {
      ...
      ModuleInfo_69 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_43_43, 0))));
    ...
    if (succeeded)
    {
      ...
      VarTable0_79 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_44_44, 1))));
      {
      ...
      Var_83 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_44_44, 0))));
      {
      ...
      ModuleInfo_91 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_49_49, 0))));
  ...
  MR_Word * STATE_VARIABLE_Info_11)
{
  ...
  ModuleInfo_18 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_10, 0))));
