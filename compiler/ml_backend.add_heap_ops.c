...
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 127,3,6,7,9,10,13,103)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 15,17,18,22,24,26,27,29)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 20,36,42,43,44,45,48,50)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 51,52,53,46,67,68,69,70)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 71,72,74,79,80,83,84,86)
MR_decl_label1(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 87)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module7)
	...
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,127,3,6,7,9,10,13,103)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,15,17,18,22,24,26,27,29)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,20,36,42,43,44,45,48,50)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,51,52,53,46,67,68,69,70)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,71,72,74,79,80,83,84,86)
	MR_init_label1(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,87)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,127)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i103);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i86) MR_AND
		...
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i83));
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,74)
	...
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i127);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__cases_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i87);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
