  ...
  MR_Word * STATE_VARIABLE_ProcInfo_14)
{
  ...
  GoalExpr0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 0))));
  GoalInfo_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 1))));
  ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_p_0(GoalExpr0_24, GoalInfo_25, &Goal_9, TrailOpsInfo0_8, &TrailOpsInfo_10);
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      VarTable0_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_44_44, (MR_Integer) 1))));
      {
        Entry_86 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Entry_86, 0) = ((MR_Box) ((MR_String) "HeapPointer"));
        MR_hl_field(MR_mktag(0), Entry_86, 1) = ((MR_Box) (Var_75));
        MR_hl_field(MR_mktag(0), Entry_86, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
      }
      parse_tree__var_table__add_var_entry_4_p_0(Entry_86, &SavedHeapPointerVar_30, VarTable0_85, &VarTable_87);
      Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_44_44, (MR_Integer) 0))));
      {
        STATE_VARIABLE_Info_48_48 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_48_48, 0) = ((MR_Box) (Var_90));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_48_48, 1) = ((MR_Box) (VarTable_87));
      }
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  VarTable0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_6, (MR_Integer) 1))));
  {
    Entry_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_20, 0) = ((MR_Box) ((MR_String) "HeapPointer"));
  ...
  Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_6, (MR_Integer) 0))));
  {
    ...
    *STATE_VARIABLE_Info_7 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (VarTable_21));
  }
}
