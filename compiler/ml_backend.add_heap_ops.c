          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2)));
              ...
              ml_backend__add_heap_ops__cases_add_heap_ops_4_p_0(Cases0_29, &Cases_30, STATE_VARIABLE_Info_0_84, STATE_VARIABLE_Info_85);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_130, 2) = (MR_Box) ((MR_Unsigned) (CanFail_28));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2)));
          ...
          case (MR_Integer) 6:
            {
              ...
              if (succeeded)
              {
                ...
                {
                  ConjGoalExpr_136 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                ...
                {
                  ConjGoal_137 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              ...
              {
                {
                  GoalExpr_145 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
