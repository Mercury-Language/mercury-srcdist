...
{
  {
    ...
    {
      MR_Word ml_backend__add_heap_ops__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word ml_backend__add_heap_ops__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word ml_backend__add_heap_ops__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word ml_backend__add_heap_ops__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word ml_backend__add_heap_ops__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word ml_backend__add_heap_ops__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__3_3, (MR_Integer) 2)));
      MR_Word ml_backend__add_heap_ops__Var_10;

      mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__add_heap_ops_scalar_common_1[0], &ml_backend__add_heap_ops__Var_10, ((MR_Box) (ml_backend__add_heap_ops__ArgX1_4)), ((MR_Box) (ml_backend__add_heap_ops__ArgY1_5)));
      ml_backend__add_heap_ops__succeeded = (ml_backend__add_heap_ops__Var_10 == (MR_Integer) 0);
      ml_backend__add_heap_ops__succeeded = !(ml_backend__add_heap_ops__succeeded);
      if (ml_backend__add_heap_ops__succeeded)
        *ml_backend__add_heap_ops__HeadVar__1_1 = ml_backend__add_heap_ops__Var_10;
      else
      {
        MR_Word ml_backend__add_heap_ops__Var_11;

        mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__add_heap_ops_scalar_common_2[0], &ml_backend__add_heap_ops__Var_11, ((MR_Box) (ml_backend__add_heap_ops__ArgX2_6)), ((MR_Box) (ml_backend__add_heap_ops__ArgY2_7)));
        ml_backend__add_heap_ops__succeeded = (ml_backend__add_heap_ops__Var_11 == (MR_Integer) 0);
        ml_backend__add_heap_ops__succeeded = !(ml_backend__add_heap_ops__succeeded);
        if (ml_backend__add_heap_ops__succeeded)
          *ml_backend__add_heap_ops__HeadVar__1_1 = ml_backend__add_heap_ops__Var_11;
        else
          hlds__hlds_module____Compare____module_info_0_0(ml_backend__add_heap_ops__HeadVar__1_1, ml_backend__add_heap_ops__ArgX3_8, ml_backend__add_heap_ops__ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word ml_backend__add_heap_ops__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word ml_backend__add_heap_ops__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word ml_backend__add_heap_ops__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word ml_backend__add_heap_ops__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word ml_backend__add_heap_ops__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__1_1, (MR_Integer) 2)));
      MR_Word ml_backend__add_heap_ops__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__HeadVar__2_2, (MR_Integer) 2)));

      ml_backend__add_heap_ops__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &ml_backend__add_heap_ops_scalar_common_1[0], ((MR_Box) (ml_backend__add_heap_ops__ArgX1_3)), ((MR_Box) (ml_backend__add_heap_ops__ArgY1_4)));
      if (ml_backend__add_heap_ops__succeeded)
      {
        ml_backend__add_heap_ops__TypeInfo_12_12 = (MR_Word) &ml_backend__add_heap_ops_scalar_common_2[0];
        ml_backend__add_heap_ops__succeeded = mercury__builtin__unify_2_p_0(ml_backend__add_heap_ops__TypeInfo_12_12, ((MR_Box) (ml_backend__add_heap_ops__ArgX2_5)), ((MR_Box) (ml_backend__add_heap_ops__ArgY2_6)));
        if (ml_backend__add_heap_ops__succeeded)
          ml_backend__add_heap_ops__succeeded = hlds__hlds_module____Unify____module_info_0_0(ml_backend__add_heap_ops__ArgX3_7, ml_backend__add_heap_ops__ArgY3_8);
      }
    }
...
{
  {
    ...
    MR_Word ml_backend__add_heap_ops__Var_14;
    ...
    ml_backend__add_heap_ops__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__TrailOpsInfo_11, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word ml_backend__add_heap_ops__Var_22;
      MR_Word ml_backend__add_heap_ops__SavedHeapPointerVar0_25;
      MR_Word ml_backend__add_heap_ops__Var_28;
      MR_Word ml_backend__add_heap_ops__Var_29;
      ...
      ml_backend__add_heap_ops__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__Goal1_21, (MR_Integer) 0)));
      ...
      if (ml_backend__add_heap_ops__succeeded)
      {
        ...
        MR_Word ml_backend__add_heap_ops__Var_45;
        MR_Word ml_backend__add_heap_ops__Var_46;
        ...
        {
          ml_backend__add_heap_ops__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_46, 0) = ((MR_Box) (ml_backend__add_heap_ops__Goal1_21));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ml_backend__add_heap_ops__Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_45, 0) = ((MR_Box) (ml_backend__add_heap_ops__RestoreHeapPointerGoal_26));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_45, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_46));
        }
        hlds__hlds_goal__conj_list_to_goal_3_p_0(ml_backend__add_heap_ops__Var_45, ml_backend__add_heap_ops__GoalInfo_23, &ml_backend__add_heap_ops__Goal_27);
      }
      else
      {
      ...
      if (ml_backend__add_heap_ops__succeeded)
      {
        ...
        if (ml_backend__add_heap_ops__succeeded)
        {
          ...
          if (ml_backend__add_heap_ops__succeeded)
          {
            ml_backend__add_heap_ops__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Goals0_15, (MR_Integer) 0)));
            ml_backend__add_heap_ops__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Goals0_15, (MR_Integer) 1)));
          }
        }
      }
      if (ml_backend__add_heap_ops__succeeded)
      {
        ...
        MR_Word ml_backend__add_heap_ops__Var_51;
        MR_Word ml_backend__add_heap_ops__Var_53;
        MR_Word ml_backend__add_heap_ops__Var_55;
        MR_Word ml_backend__add_heap_ops__Var_56;
        MR_Word ml_backend__add_heap_ops__Var_58;
        ...
        {
          ml_backend__add_heap_ops__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_51, 0) = ((MR_Box) (ml_backend__add_heap_ops__SavedHeapPointerVar_30));
        }
        ml_backend__add_heap_ops__disj_add_heap_ops_7_p_0(ml_backend__add_heap_ops__Goals0_15, &ml_backend__add_heap_ops__Goals1_32, (MR_Integer) 1, ml_backend__add_heap_ops__Var_51, ml_backend__add_heap_ops__DisjGoalInfo_5, ml_backend__add_heap_ops__STATE_VARIABLE_Info_49_49, ml_backend__add_heap_ops__STATE_VARIABLE_Info_7);
        {
          ml_backend__add_heap_ops__Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_53, 0) = ((MR_Box) (ml_backend__add_heap_ops__Goal_27));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_53, 1) = ((MR_Box) (ml_backend__add_heap_ops__Goals1_32));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__InnerDisjGoalExpr_33, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_53));
        }
        {
        ...
        {
          ml_backend__add_heap_ops__Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_56, 0) = ((MR_Box) (ml_backend__add_heap_ops__InnerDisjGoal_34));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_56, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ml_backend__add_heap_ops__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_55, 0) = ((MR_Box) (ml_backend__add_heap_ops__MarkHeapPointerGoal_31));
          MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_55, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_56));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__ConjGoalExpr_35, 2) = ((MR_Box) (ml_backend__add_heap_ops__Var_55));
        }
        {
        ...
        {
          ml_backend__add_heap_ops__Var_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_58, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_58, 1) = ((MR_Box) (ml_backend__add_heap_ops__Purity_37));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__ScopeGoalExpr_38, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_58));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ml_backend__add_heap_ops__Var_33;
            MR_Word ml_backend__add_heap_ops___CanFail_36;
            MR_Word ml_backend__add_heap_ops__Var_153;
            MR_Word ml_backend__add_heap_ops__Var_154;

            ml_backend__add_heap_ops__Context_131 = hlds__hlds_goal__goal_info_get_context_1_f_0(ml_backend__add_heap_ops__GoalInfo0_7);
            ml_backend__add_heap_ops__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__InnerGoal_31, (MR_Integer) 0)));
            ...
            ml_backend__add_heap_ops__Var_153 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_84, (MR_Integer) 0)));
            ml_backend__add_heap_ops__Var_154 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_84, (MR_Integer) 1)));
            ...
            switch (ml_backend__add_heap_ops__NumSolns_37) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word ml_backend__add_heap_ops__Var_110;

                  ml_backend__add_heap_ops__Var_110 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
                  ml_backend__add_heap_ops__heap_generate_call_8_p_0((MR_String) "unused", (MR_Integer) 0, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__add_heap_ops__Var_110, ml_backend__add_heap_ops__ModuleInfo_40, ml_backend__add_heap_ops__Context_131, &ml_backend__add_heap_ops__ThenGoal_41);
                }
                break;
            }
            {
            ...
            {
              MR_Word ml_backend__add_heap_ops__next_value_of_GoalExpr0_6 = ml_backend__add_heap_ops__NewOuterGoal_42;

              ml_backend__add_heap_ops__GoalExpr0_6 = ml_backend__add_heap_ops__next_value_of_GoalExpr0_6;
            }
            continue;
          }
          break;
            ...
            case (MR_Integer) 3:
              {
                ...
                else
                {
                  ...
                  MR_Word ml_backend__add_heap_ops__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Disjuncts0_14, (MR_Integer) 1)));
                  ...
                  if (ml_backend__add_heap_ops__succeeded)
                  {
                    ...
                    MR_Word ml_backend__add_heap_ops__Var_117;
                    MR_Word ml_backend__add_heap_ops__Var_120;
                    MR_Word ml_backend__add_heap_ops__Var_121;
                    MR_Word ml_backend__add_heap_ops__Var_123;
                    ...
                    {
                      ml_backend__add_heap_ops__Var_117 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_117, 0) = ((MR_Box) (ml_backend__add_heap_ops__SavedHeapPointerVar_19));
                    }
                    ml_backend__add_heap_ops__disj_add_heap_ops_7_p_0(ml_backend__add_heap_ops__Disjuncts0_14, &ml_backend__add_heap_ops__Disjuncts_21, (MR_Integer) 0, ml_backend__add_heap_ops__Var_117, ml_backend__add_heap_ops__GoalInfo0_7, ml_backend__add_heap_ops__STATE_VARIABLE_Info_115_115, ml_backend__add_heap_ops__STATE_VARIABLE_Info_85);
                    {
                    ...
                    {
                      ml_backend__add_heap_ops__Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_121, 0) = ((MR_Box) (ml_backend__add_heap_ops__DisjGoal_23));
                      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_121, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    }
                    {
                      ml_backend__add_heap_ops__Var_120 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_120, 0) = ((MR_Box) (ml_backend__add_heap_ops__MarkHeapPointerGoal_20));
                      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_120, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_121));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__ConjGoalExpr_24, 2) = ((MR_Box) (ml_backend__add_heap_ops__Var_120));
                    }
                    {
                    ...
                    {
                      ml_backend__add_heap_ops__Var_123 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_123, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_123, 1) = ((MR_Box) (ml_backend__add_heap_ops__Purity0_26));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__GoalExpr_129, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_123));
            ...
            case (MR_Integer) 5:
              {
                ...
                MR_Word ml_backend__add_heap_ops__Var_104;
                MR_Word ml_backend__add_heap_ops__Var_45;
                ...
                if (ml_backend__add_heap_ops__succeeded)
                {
                  ml_backend__add_heap_ops__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Reason_43, (MR_Integer) 1)));
                  ml_backend__add_heap_ops__Var_104 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Reason_43, (MR_Integer) 2)));
                  ml_backend__add_heap_ops__succeeded = (ml_backend__add_heap_ops__Var_104 == (MR_Integer) 1);
                }
                if (ml_backend__add_heap_ops__succeeded)
                {
            ...
            case (MR_Integer) 6:
              {
                ...
                if (ml_backend__add_heap_ops__succeeded)
                {
                  ...
                  MR_Word ml_backend__add_heap_ops__Var_96;
                  MR_Word ml_backend__add_heap_ops__Var_97;
                  MR_Word ml_backend__add_heap_ops__Var_100;
                  MR_Word ml_backend__add_heap_ops__Var_101;
                  MR_Word ml_backend__add_heap_ops__Var_103;
                  ...
                  MR_Word ml_backend__add_heap_ops__Var_54;
                  ...
                  ml_backend__add_heap_ops__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__ElseGoal1_52, (MR_Integer) 0)));
                  ...
                  {
                    ml_backend__add_heap_ops__Var_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_97, 0) = ((MR_Box) (ml_backend__add_heap_ops__ElseGoal1_52));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_97, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    ml_backend__add_heap_ops__Var_96 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_96, 0) = ((MR_Box) (ml_backend__add_heap_ops__RestoreHeapPointerGoal_53));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_96, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_97));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__ElseGoalExpr_56, 2) = ((MR_Box) (ml_backend__add_heap_ops__Var_96));
                  }
                  {
                  ...
                  {
                    ml_backend__add_heap_ops__Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_101, 0) = ((MR_Box) (ml_backend__add_heap_ops__ITEGoal_59));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    ml_backend__add_heap_ops__Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_100, 0) = ((MR_Box) (ml_backend__add_heap_ops__MarkHeapPointerGoal_135));
                    MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_100, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_101));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__ConjGoalExpr_136, 2) = ((MR_Box) (ml_backend__add_heap_ops__Var_100));
                  }
                  {
                  ...
                  {
                    ml_backend__add_heap_ops__Var_103 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_103, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__Var_103, 1) = ((MR_Box) (ml_backend__add_heap_ops__Purity0_138));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__add_heap_ops__GoalExpr_145, 1) = ((MR_Box) (ml_backend__add_heap_ops__Var_103));
...
{
  {
    MR_Word ml_backend__add_heap_ops__Var_17;

    ml_backend__add_heap_ops__Var_17 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
    hlds__goal_util__generate_simple_call_12_p_0(ml_backend__add_heap_ops__Var_17, ml_backend__add_heap_ops__PredName_9, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__add_heap_ops__Detism_10, ml_backend__add_heap_ops__Purity_11, ml_backend__add_heap_ops__Args_12, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__add_heap_ops__InstMapDelta_13, ml_backend__add_heap_ops__ModuleInfo_14, ml_backend__add_heap_ops__Context_15, ml_backend__add_heap_ops__CallGoal_16);
  }
}
...
{
  {
    MR_Word ml_backend__add_heap_ops__Var_9;
    ...
    MR_Word ml_backend__add_heap_ops__Var_29;
    MR_Word ml_backend__add_heap_ops__Var_24;
    MR_Word ml_backend__add_heap_ops__Var_27;
    MR_Word ml_backend__add_heap_ops__Var_28;

    ml_backend__add_heap_ops__Var_9 = parse_tree__builtin_lib_types__heap_pointer_type_0_f_0();
    ...
    ml_backend__add_heap_ops__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_6, (MR_Integer) 2)));
    ...
    hlds__vartypes__add_var_type_4_p_0(*ml_backend__add_heap_ops__Var_4, ml_backend__add_heap_ops__Var_9, ml_backend__add_heap_ops__VarTypes0_18, &ml_backend__add_heap_ops__VarTypes_20);
    ml_backend__add_heap_ops__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_6, (MR_Integer) 0)));
    ml_backend__add_heap_ops__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_6, (MR_Integer) 1)));
    ml_backend__add_heap_ops__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_6, (MR_Integer) 2)));
    {
      MR_Word base;
      ...
      *ml_backend__add_heap_ops__STATE_VARIABLE_Info_7 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (ml_backend__add_heap_ops__Var_29));
    }
  }
}
...
{
  {
    MR_Word ml_backend__add_heap_ops__Var_15;
    MR_Word ml_backend__add_heap_ops__Var_16;
    MR_Word ml_backend__add_heap_ops__Var_17;
    MR_Word ml_backend__add_heap_ops__Var_29;
    MR_Word ml_backend__add_heap_ops__Var_19;
    MR_Word ml_backend__add_heap_ops__Var_20;

    {
      ml_backend__add_heap_ops__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_15, 0) = ((MR_Box) (ml_backend__add_heap_ops__SavedHeapPointerVar_6));
      MR_hl_field(MR_mktag(1), ml_backend__add_heap_ops__Var_15, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ml_backend__add_heap_ops__Var_16 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
    ml_backend__add_heap_ops__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 0)));
    ml_backend__add_heap_ops__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 1)));
    ml_backend__add_heap_ops__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 2)));
    ml_backend__add_heap_ops__Var_29 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
    hlds__goal_util__generate_simple_call_12_p_0(ml_backend__add_heap_ops__Var_29, (MR_String) "restore_hp", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, (MR_Integer) 2, ml_backend__add_heap_ops__Var_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__add_heap_ops__Var_16, ml_backend__add_heap_ops__Var_17, ml_backend__add_heap_ops__Context_7, ml_backend__add_heap_ops__RestoreHeapPointerGoal_8);
...
{
  {
    ...
    ml_backend__add_heap_ops__Var_16 = hlds__instmap__instmap_delta_bind_var_1_f_0(ml_backend__add_heap_ops__SavedHeapPointerVar_6);
    ml_backend__add_heap_ops__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 0)));
    ml_backend__add_heap_ops__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 1)));
    ml_backend__add_heap_ops__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10, (MR_Integer) 2)));
    ml_backend__add_heap_ops__Var_29 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
    hlds__goal_util__generate_simple_call_12_p_0(ml_backend__add_heap_ops__Var_29, (MR_String) "mark_hp", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, (MR_Integer) 2, ml_backend__add_heap_ops__Var_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__add_heap_ops__Var_16, ml_backend__add_heap_ops__Var_17, ml_backend__add_heap_ops__Context_7, ml_backend__add_heap_ops__MarkHeapPointerGoal_8);
    *ml_backend__add_heap_ops__STATE_VARIABLE_Info_11 = ml_backend__add_heap_ops__STATE_VARIABLE_Info_0_10;
  }
}
