          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_43)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) MaybeSavedHeapPointerVar_4)) == (MR_Integer) 1);
        if (succeeded)
