              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  Purity0_26 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo0_7);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_123, 1) = (MR_Box) ((MR_Unsigned) (Purity0_26));
                  }
                  {
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2)));
              ...
              ml_backend__add_heap_ops__cases_add_heap_ops_4_p_0(Cases0_29, &Cases_30, STATE_VARIABLE_Info_0_84, STATE_VARIABLE_Info_85);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_130, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2)));
                Var_104 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2))) & (MR_Integer) 3);
          ...
          case (MR_Integer) 6:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), ConjGoalExpr_136, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                  MR_hl_field(MR_mktag(3), ConjGoalExpr_136, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                ...
                Purity0_138 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo0_7);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_103, 1) = (MR_Box) ((MR_Unsigned) (Purity0_138));
                }
                {
              ...
              {
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_145, 0) = ((MR_Box) ((MR_Unsigned) 6U));
