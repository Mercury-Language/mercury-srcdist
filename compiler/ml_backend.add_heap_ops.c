  ...
  MR_Word * STATE_VARIABLE_ProcInfo_14)
{
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &Goal0_6);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &VarTable0_7);
  {
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_9, STATE_VARIABLE_ProcInfo_0_13, &STATE_VARIABLE_ProcInfo_1_15);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_12, STATE_VARIABLE_ProcInfo_1_15, &STATE_VARIABLE_ProcInfo_2_16);
  hlds__quantification__requantify_proc_general_3_p_1((MR_Integer) 1, STATE_VARIABLE_ProcInfo_2_16, STATE_VARIABLE_ProcInfo_14);
}
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_44, GoalInfo_23, &Goal_27);
    }
    else
      Goal_27 = Goal1_21;
    succeeded = (MaybeSavedHeapPointerVar_4 == (MR_Word) ((MR_Unsigned) 0U));
