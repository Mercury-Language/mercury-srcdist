...
MR_decl_label8(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 57,4,5,10,11,12,6,16)
MR_decl_label7(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 20,22,23,25,17,18,34)
...
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 146,3,8,9,10,12,13,16)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 18,20,21,25,27,29,30,32)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 23,39,45,46,47,48,51,53)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 54,55,56,49,70,71,72,73)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 74,75,78,77,83,120,84,88)
MR_decl_label4(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 92,93,95,96)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module7)
	...
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,146,3,8,9,10,12,13,16)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,18,20,21,25,27,29,30,32)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,23,39,45,46,47,48,51,53)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,54,55,56,49,70,71,72,73)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,74,75,78,77,83,120,84,88)
	MR_init_label4(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,92,93,95,96)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,146)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i120);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i3) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i12) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i16) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i95) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i70) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i83) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i45) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i92));
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,3)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i8);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__hlds__instmap__instmap_delta_bind_no_var_0_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i9);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,20)
	...
	MR_np_call_localret_ent(fn__hlds__code_model__goal_info_get_code_model_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i21);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i25);
	}
	MR_r1 = MR_sv(5);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i23);
	}
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(ml_backend__add_heap_ops__new_saved_hp_var_3_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i29);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,45)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__goal_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i46);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i49);
	}
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(ml_backend__add_heap_ops__new_saved_hp_var_3_0,
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,54)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__gen_mark_hp_5_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i55);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(6);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,75)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i77);
	}
	MR_sv(3) = MR_ctfield(0, MR_sv(5), 2);
	MR_np_call_localret_ent(fn__hlds__instmap__instmap_delta_bind_no_var_0_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i78);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,78)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__heap_generate_call_8_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i77);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 5);
	...
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i146);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,120)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,84)
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(ml_backend__add_heap_ops__goal_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i88);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,92)
	...
	MR_np_call_localret_ent(fn__ml_backend__add_heap_ops__this_file_0_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i93);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__cases_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i96);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module8)
	...
	MR_init_label8(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,57,4,5,10,11,12,6,16)
	MR_init_label7(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,20,22,23,25,17,18,34)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__disj_add_heap_ops_7_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i57);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_proceed();
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_sv(10) = MR_ctfield(0, MR_sv(7), 2);
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,16)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i18);
	}
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(hlds__goal_form__goal_may_allocate_heap_1_0,
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,23)
	...
	MR_np_localcall_lab(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i25);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,18)
	...
	MR_r5 = MR_sv(6);
	MR_np_localcall_lab(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i34);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
