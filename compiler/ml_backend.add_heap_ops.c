...
MR_decl_label10(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 57,4,5,10,11,12,6,16,20,22)
MR_decl_label5(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 23,25,17,18,34)
...
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 146,3,8,9,10,12,13,16,18,20)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 21,25,27,29,30,32,23,39,45,46)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 47,48,51,53,54,55,56,49,70,71)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 72,73,74,75,78,77,83,120,84,88)
...
MR_def_label(ml_backend__add_heap_ops__new_saved_hp_var_3_0,5)
	...
	MR_tfield(0, MR_tempr1, 2) = MR_tfield(0, MR_sv(2), 2);
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ml_backend__add_heap_ops__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module7)
	...
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,146,3,8,9,10,12,13,16,18,20)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,21,25,27,29,30,32,23,39,45,46)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,47,48,51,53,54,55,56,49,70,71)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,72,73,74,75,78,77,83,120,84,88)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module8)
	...
	MR_init_label10(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,57,4,5,10,11,12,6,16,20,22)
	MR_init_label5(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,23,25,17,18,34)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_sv(10) = MR_tfield(0, MR_sv(7), 2);
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
