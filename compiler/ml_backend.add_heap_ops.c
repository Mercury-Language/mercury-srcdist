...
MR_decl_label3(ml_backend__add_heap_ops__cases_add_heap_ops_4_0, 15,4,6)
MR_decl_label8(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 56,4,5,10,11,6,15,19)
MR_decl_label6(ml_backend__add_heap_ops__disj_add_heap_ops_7_0, 21,22,24,16,17,33)
MR_decl_label2(ml_backend__add_heap_ops__gen_mark_hp_5_0, 6,7)
MR_decl_label2(ml_backend__add_heap_ops__gen_restore_hp_5_0, 3,4)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 142,3,6,7,9,10,13,15)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 17,18,22,24,26,27,29,20)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 36,42,43,44,45,48,50,51)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 52,53,46,67,68,69,70,71)
MR_decl_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 72,74,79,116,80,84,88,89)
MR_decl_label2(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 91,92)
...
MR_decl_label5(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0, 3,2,5,10,30)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module2)
	...
	MR_init_label2(ml_backend__add_heap_ops__gen_mark_hp_5_0,6,7)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__gen_mark_hp_5_0)
	...
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
		ml_backend__add_heap_ops__gen_mark_hp_5_0_i6);
MR_def_label(ml_backend__add_heap_ops__gen_mark_hp_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(hlds__goal_util__generate_simple_call_12_0,
		ml_backend__add_heap_ops__gen_mark_hp_5_0_i7);
MR_def_label(ml_backend__add_heap_ops__gen_mark_hp_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module3)
	...
	MR_init_label2(ml_backend__add_heap_ops__gen_restore_hp_5_0,3,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module7)
	...
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,142,3,6,7,9,10,13,15)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,17,18,22,24,26,27,29,20)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,36,42,43,44,45,48,50,51)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,52,53,46,67,68,69,70,71)
	MR_init_label8(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,72,74,79,116,80,84,88,89)
	MR_init_label2(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,91,92)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,142)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i116);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i3) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i9) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i13) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i91) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i67) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i79) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i42) MR_AND
		MR_LABEL_AP(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i88));
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,6)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__heap_generate_call_8_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i7);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,9)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__conj_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i10);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,13)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i15);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,15)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i17);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__code_model__goal_info_get_code_model_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i18);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,22)
	...
	MR_np_call_localret_ent(hlds__goal_form__goal_may_allocate_heap_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i24);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i20);
	}
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(ml_backend__add_heap_ops__new_saved_hp_var_3_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i26);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,26)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__gen_mark_hp_5_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i27);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i68);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_ctfield(0, MR_sv(2), 1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_determinism_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i69);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__prog_data__determinism_components_3_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i70);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r2;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__true_goal_with_context_1_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i71);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,72)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i74);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,74)
	...
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i142);
	}
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,79)
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i80);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,80)
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(ml_backend__add_heap_ops__goal_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i84);
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__cases_add_heap_ops_4_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i92);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module8)
	...
	MR_init_label8(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,56,4,5,10,11,6,15,19)
	MR_init_label6(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,21,22,24,16,17,33)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__disj_add_heap_ops_7_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i56);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_proceed();
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,10)
	...
	MR_r11 = MR_sv(1);
	MR_np_call_localret_ent(hlds__goal_util__generate_simple_call_12_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i11);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(hlds__hlds_goal__conj_list_to_goal_3_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i15);
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,15)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i17);
	}
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(hlds__goal_form__goal_may_allocate_heap_1_0,
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i16);
	}
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(ml_backend__add_heap_ops__new_saved_hp_var_3_0,
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,21)
	...
	MR_np_call_localret_ent(ml_backend__add_heap_ops__gen_mark_hp_5_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i22);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r3, 1, (MR_Integer) 1);
	...
	MR_np_localcall_lab(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i24);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,17)
	...
	MR_r5 = MR_sv(6);
	MR_np_localcall_lab(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,
		ml_backend__add_heap_ops__disj_add_heap_ops_7_0_i33);
MR_def_label(ml_backend__add_heap_ops__disj_add_heap_ops_7_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module9)
	...
	MR_init_label3(ml_backend__add_heap_ops__cases_add_heap_ops_4_0,15,4,6)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__cases_add_heap_ops_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__add_heap_ops__cases_add_heap_ops_4_0_i15);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__add_heap_ops__cases_add_heap_ops_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module12)
	...
	MR_init_label5(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,3,2,5,10,30)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0_i30);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,3,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
