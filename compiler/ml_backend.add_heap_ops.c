...
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 190,3,6,5,11,13,14,18,20,22)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 23,25,16,36,9,40,43,44,45,48)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 50,51,52,53,64,46,42,72,73,74)
MR_decl_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 75,76,79,78,71,85,89,84,94,93)
MR_decl_label1(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0, 97)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module7)
	...
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,190,3,6,5,11,13,14,18,20,22)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,23,25,16,36,9,40,43,44,45,48)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,50,51,52,53,64,46,42,72,73,74)
	MR_init_label10(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,75,76,79,78,71,85,89,84,94,93)
	MR_init_label1(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,97)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,190)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,78)
	...
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i190);
	}
...
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,93)
	...
	MR_np_call_localret_ent(fn__ml_backend__add_heap_ops__this_file_0_0,
		ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0_i97);
MR_def_label(ml_backend__add_heap_ops__goal_expr_add_heap_ops_5_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
