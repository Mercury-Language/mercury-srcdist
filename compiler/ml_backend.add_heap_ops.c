...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__add_heap_ops_scalar_common_1[0], &Var_10, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__add_heap_ops_scalar_common_2[0], &Var_11, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_12_12 = (MR_Word) &ml_backend__add_heap_ops_scalar_common_2[0];
...
{
  {
    ...
    {
      TrailOpsInfo0_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), TrailOpsInfo_11, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal1_21, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) MaybeSavedHeapPointerVar_4)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
      ...
      succeeded = (MaybeSavedHeapPointerVar_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        {
          InnerDisjGoalExpr_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), InnerDisjGoalExpr_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(3), InnerDisjGoalExpr_33, 1) = ((MR_Box) (Var_53));
        }
        {
          InnerDisjGoal_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          ConjGoalExpr_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ConjGoalExpr_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(3), ConjGoalExpr_35, 1) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), ConjGoalExpr_35, 2) = ((MR_Box) (Var_55));
        }
        {
          ConjGoal_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        Purity_37 = hlds__hlds_goal__goal_info_get_purity_1_f_0(DisjGoalInfo_5);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_58, 1) = ((MR_Box) (Purity_37));
        }
        {
          ScopeGoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ScopeGoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(3), ScopeGoalExpr_38, 1) = ((MR_Box) (Var_58));
          MR_hl_field(MR_mktag(3), ScopeGoalExpr_38, 2) = ((MR_Box) (ConjGoal_36));
        }
        {
          ScopeGoal_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      switch (MR_tag((MR_Word) GoalExpr0_6)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word InnerGoal_31 = (MR_Word) MR_body(((MR_Word) GoalExpr0_6), (MR_Integer) 0);
            ...
            Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), InnerGoal_31, (MR_Integer) 0)));
            ...
            True_38 = hlds__make_goal__true_goal_with_context_1_f_0(Context_131);
            Fail_39 = hlds__make_goal__fail_goal_with_context_1_f_0(Context_131);
            Var_153 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_84, (MR_Integer) 0)));
            Var_154 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_84, (MR_Integer) 1)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  Var_110 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
                  ml_backend__add_heap_ops__heap_generate_call_8_p_0((MR_String) "unused", (MR_Integer) 0, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_110, ModuleInfo_40, Context_131, &ThenGoal_41);
                }
                break;
            }
            {
              NewOuterGoal_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), NewOuterGoal_42, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
              MR_hl_field(MR_mktag(3), NewOuterGoal_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            ...
            {
              MR_Word next_value_of_GoalExpr0_6 = NewOuterGoal_42;
            ...
            case (MR_Integer) 3:
              {
                ...
                else
                {
                  ...
                  MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), Disjuncts0_14, (MR_Integer) 1)));
                  ...
                  if (succeeded)
                  {
                    ...
                    ml_backend__add_heap_ops__new_saved_hp_var_3_p_0(&SavedHeapPointerVar_19, STATE_VARIABLE_Info_0_84, &STATE_VARIABLE_Info_114_114);
                    ml_backend__add_heap_ops__gen_mark_hp_5_p_0(SavedHeapPointerVar_19, Context_17, &MarkHeapPointerGoal_20, STATE_VARIABLE_Info_114_114, &STATE_VARIABLE_Info_115_115);
                    {
                      Var_117 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_117, 0) = ((MR_Box) (SavedHeapPointerVar_19));
                    }
                    ml_backend__add_heap_ops__disj_add_heap_ops_7_p_0(Disjuncts0_14, &Disjuncts_21, (MR_Integer) 0, Var_117, GoalInfo0_7, STATE_VARIABLE_Info_115_115, STATE_VARIABLE_Info_85);
                    {
                      DisjGoalExpr_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), DisjGoalExpr_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                      MR_hl_field(MR_mktag(3), DisjGoalExpr_22, 1) = ((MR_Box) (Disjuncts_21));
                    }
                    {
                      DisjGoal_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (DisjGoal_23));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_120, 0) = ((MR_Box) (MarkHeapPointerGoal_20));
                      MR_hl_field(MR_mktag(1), Var_120, 1) = ((MR_Box) (Var_121));
                    }
                    {
                      ConjGoalExpr_24 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ConjGoalExpr_24, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), ConjGoalExpr_24, 1) = ((MR_Box) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(3), ConjGoalExpr_24, 2) = ((MR_Box) (Var_120));
                    }
                    {
                      ConjGoal_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    Purity0_26 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo0_7);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_123, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(3), Var_123, 1) = ((MR_Box) (Purity0_26));
                    }
                    {
                      GoalExpr_129 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), GoalExpr_129, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                      MR_hl_field(MR_mktag(3), GoalExpr_129, 1) = ((MR_Box) (Var_123));
                      MR_hl_field(MR_mktag(3), GoalExpr_129, 2) = ((MR_Box) (ConjGoal_25));
                    }
                  }
                  else
                  {
                    MR_Word Disjuncts_128;

                    ml_backend__add_heap_ops__disj_add_heap_ops_7_p_0(Disjuncts0_14, &Disjuncts_128, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), GoalInfo0_7, STATE_VARIABLE_Info_0_84, STATE_VARIABLE_Info_85);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), GoalExpr_129, 1) = ((MR_Box) (Disjuncts_128));
                    }
                  }
                }
                {
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Word CanFail_28 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2)));
                ...
                {
                  GoalExpr_130 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_130, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                  MR_hl_field(MR_mktag(3), GoalExpr_130, 1) = ((MR_Box) (Var_27));
                  MR_hl_field(MR_mktag(3), GoalExpr_130, 2) = ((MR_Box) (CanFail_28));
                  MR_hl_field(MR_mktag(3), GoalExpr_130, 3) = ((MR_Box) (Cases_30));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 5:
              {
                ...
                succeeded = ((((MR_tag((MR_Word) Reason_43)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 0)))) == (MR_Integer) 6)));
                if (succeeded)
                {
                  Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 1)));
                  Var_104 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2)));
                ...
                {
                  GoalExpr_132 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_132, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(3), GoalExpr_132, 1) = ((MR_Box) (Reason_43));
                  MR_hl_field(MR_mktag(3), GoalExpr_132, 2) = ((MR_Box) (SubGoal_46));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 6:
              {
                ...
                MR_Word ThenGoal_152;

                ml_backend__add_heap_ops__goal_add_heap_ops_4_p_0(CondGoal0_48, &CondGoal_51, STATE_VARIABLE_Info_0_84, &STATE_VARIABLE_Info_89_89);
                ml_backend__add_heap_ops__goal_add_heap_ops_4_p_0(ThenGoal0_49, &ThenGoal_152, STATE_VARIABLE_Info_89_89, &STATE_VARIABLE_Info_90_90);
                ml_backend__add_heap_ops__goal_add_heap_ops_4_p_0(ElseGoal0_50, &ElseGoal1_52, STATE_VARIABLE_Info_90_90, &STATE_VARIABLE_Info_91_91);
                ...
                if (succeeded)
                {
                  ...
                  MR_Word Var_103;
                  MR_Word Context_133;
                  MR_Word SavedHeapPointerVar_134;
                  MR_Word MarkHeapPointerGoal_135;
                  MR_Word ConjGoalExpr_136;
                  MR_Word ConjGoal_137;
                  MR_Word Purity0_138;
                  MR_Word Var_54;

                  ml_backend__add_heap_ops__new_saved_hp_var_3_p_0(&SavedHeapPointerVar_134, STATE_VARIABLE_Info_91_91, &STATE_VARIABLE_Info_92_92);
                  Context_133 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_7);
                  ml_backend__add_heap_ops__gen_mark_hp_5_p_0(SavedHeapPointerVar_134, Context_133, &MarkHeapPointerGoal_135, STATE_VARIABLE_Info_92_92, &STATE_VARIABLE_Info_93_93);
                  ml_backend__add_heap_ops__gen_restore_hp_5_p_0(SavedHeapPointerVar_134, Context_133, &RestoreHeapPointerGoal_53, STATE_VARIABLE_Info_93_93, STATE_VARIABLE_Info_85);
                  Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), ElseGoal1_52, (MR_Integer) 0)));
                  ElseGoal1Info_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), ElseGoal1_52, (MR_Integer) 1)));
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (ElseGoal1_52));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_96, 0) = ((MR_Box) (RestoreHeapPointerGoal_53));
                    MR_hl_field(MR_mktag(1), Var_96, 1) = ((MR_Box) (Var_97));
                  }
                  {
                    ElseGoalExpr_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ElseGoalExpr_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                    MR_hl_field(MR_mktag(3), ElseGoalExpr_56, 1) = ((MR_Box) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), ElseGoalExpr_56, 2) = ((MR_Box) (Var_96));
                  }
                  {
                    ElseGoal_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ElseGoal_57, 0) = ((MR_Box) (ElseGoalExpr_56));
                    MR_hl_field(MR_mktag(0), ElseGoal_57, 1) = ((MR_Box) (ElseGoal1Info_55));
                  }
                  {
                    ITEGoalExpr_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ITEGoalExpr_58, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                    MR_hl_field(MR_mktag(3), ITEGoalExpr_58, 1) = ((MR_Box) (Vars_47));
                    MR_hl_field(MR_mktag(3), ITEGoalExpr_58, 2) = ((MR_Box) (CondGoal_51));
                    MR_hl_field(MR_mktag(3), ITEGoalExpr_58, 3) = ((MR_Box) (ThenGoal_152));
                    MR_hl_field(MR_mktag(3), ITEGoalExpr_58, 4) = ((MR_Box) (ElseGoal_57));
                  }
                  {
                    ITEGoal_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_101, 0) = ((MR_Box) (ITEGoal_59));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (MarkHeapPointerGoal_135));
                    MR_hl_field(MR_mktag(1), Var_100, 1) = ((MR_Box) (Var_101));
                  }
                  {
                    ConjGoalExpr_136 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ConjGoalExpr_136, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                    MR_hl_field(MR_mktag(3), ConjGoalExpr_136, 1) = ((MR_Box) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), ConjGoalExpr_136, 2) = ((MR_Box) (Var_100));
                  }
                  {
                    ConjGoal_137 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ConjGoal_137, 0) = ((MR_Box) (ConjGoalExpr_136));
                    MR_hl_field(MR_mktag(0), ConjGoal_137, 1) = ((MR_Box) (GoalInfo0_7));
                  }
                  Purity0_138 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo0_7);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_103, 1) = ((MR_Box) (Purity0_138));
                  }
                  {
                    GoalExpr_145 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 1) = ((MR_Box) (Var_103));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 2) = ((MR_Box) (ConjGoal_137));
                  }
                }
                else
                {
                  {
                    GoalExpr_145 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 1) = ((MR_Box) (Vars_47));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 2) = ((MR_Box) (CondGoal_51));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 3) = ((MR_Box) (ThenGoal_152));
                    MR_hl_field(MR_mktag(3), GoalExpr_145, 4) = ((MR_Box) (ElseGoal1_52));
                  }
...
{
  {
    ...
    Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_6, (MR_Integer) 0)));
    Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_6, (MR_Integer) 1)));
...
{
  {
    ...
    Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_10, (MR_Integer) 1)));
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_29, (MR_String) "restore_hp", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, (MR_Integer) 2, Var_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_16, Var_17, Context_7, RestoreHeapPointerGoal_8);
...
{
  {
    ...
    Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_10, (MR_Integer) 2)));
    Var_29 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
    hlds__goal_util__generate_simple_call_12_p_0(Var_29, (MR_String) "mark_hp", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, (MR_Integer) 2, Var_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_16, Var_17, Context_7, MarkHeapPointerGoal_8);
    *STATE_VARIABLE_Info_11 = STATE_VARIABLE_Info_0_10;
  }
}
...
{
  {
    ...
    mercury__list__map_foldl_5_p_0(TypeCtorInfo_16_16, TypeCtorInfo_16_16, (MR_Word) &ml_backend__add_heap_ops__ml_backend__add_heap_ops__type_ctor_info_heap_ops_info_0, (MR_Word) &ml_backend__add_heap_ops_scalar_common_2[1], Goals0_5, Goals_6, ((MR_Box) (STATE_VARIABLE_Info_0_8)), &conv2_STATE_VARIABLE_Info_9);
