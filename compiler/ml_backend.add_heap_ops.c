...
MR_decl_label3(__Unify___ml_backend__add_heap_ops__heap_ops_info_0_0, 2,4,1)
MR_decl_label3(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0, 3,7,12)
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module11)
	...
	MR_init_label3(__Unify___ml_backend__add_heap_ops__heap_ops_info_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___ml_backend__add_heap_ops__heap_ops_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___varset__varset_1_0,
		__Unify___ml_backend__add_heap_ops__heap_ops_info_0_0_i2);
MR_def_label(__Unify___ml_backend__add_heap_ops__heap_ops_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(ml_backend__add_heap_ops_module12)
	...
	MR_init_label3(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_def_static(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0_i3);
MR_def_label(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0_i12);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,3,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0_i7);
MR_def_label(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0_i12);
	}
...
MR_def_label(__Compare___ml_backend__add_heap_ops__heap_ops_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ml_backend__add_heap_ops__write_out_proc_statics(FILE *fp);
#endif
