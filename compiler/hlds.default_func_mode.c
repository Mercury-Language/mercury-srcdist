  ...
  MR_Word * STATE_VARIABLE_PredTable_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), STATE_VARIABLE_PredTable_0_3, ((MR_Box) (PredId_10)), &conv0_PredInfo0_13);
      ...
      if ((MaybeNewProcId_15 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), ((MR_Box) (PredId_10)), ((MR_Box) (PredInfo_14)), STATE_VARIABLE_PredTable_0_3, &STATE_VARIABLE_PredTable_1_19);
  ...
  MR_Word * MaybeProcId_8)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo_31_31 = (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0);
    TypeCtorInfo_32_32 = (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0);
