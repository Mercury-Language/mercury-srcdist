  ...
  MR_Word * STATE_VARIABLE_PredTable_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeNewProcId_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__add_pred__add_new_proc_14_p_0(Context_18, (MR_Integer) -1, PredArity_10, InstVarSet_20, PredArgModes_16, Var_26, (MR_Word) ((MR_Integer) 0), (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__default_func_mode_scalar_common_1[0])), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_4, PredInfo_5, &ProcId_22);
      {
        MR_Word base;
    ...
    else
    {
      ...
      *MaybeProcId_6 = (MR_Word) ((MR_Integer) 0);
    }
  }
}
