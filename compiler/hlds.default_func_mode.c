  ...
  MR_Word * MaybeProcId_8)
{
  ...
  if (succeeded)
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), FuncArity_13, ((MR_Box) (InMode_14)), &FuncArgModes_16);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (FuncRetMode_17));
    ...
    mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), &InstVarSet_22);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (PredArgModes_18));
    }
    hlds__add_pred__add_new_proc_14_p_0(ModuleInfo_5, Context_20, (MR_Word) ((MR_Unsigned) 0U), InstVarSet_22, PredArgModes_18, Var_28, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__default_func_mode_scalar_common_1[0])), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_6, PredInfo_7, &ProcId_24);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *MaybeProcId_8 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ProcId_24));
    }
  }
  else
  {
