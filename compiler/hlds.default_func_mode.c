  ...
  MR_Word * MaybeProcId_6)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__30_30 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0);
    TypeCtorInfo__31_31 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0);
    succeeded = mercury__map__is_empty_1_p_0(TypeCtorInfo__30_30, TypeCtorInfo__31_31, Procs0_7);
  }
  if (succeeded)
  {
    ...
    hlds__add_pred__add_new_proc_14_p_0(Context_18, (MR_Word) ((MR_Unsigned) 0U), PredArity_10, InstVarSet_20, PredArgModes_16, Var_26, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__default_func_mode_scalar_common_1[0])), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_4, PredInfo_5, &ProcId_22);
    {
      MR_Word base;
