...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__make_hlds__add_new_proc_14_p_0(Context_18, (MR_Integer) -1, PredArity_10, InstVarSet_20, PredArgModes_16, Var_26, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 1, (MR_Word) MR_mkword(MR_mktag(1), &hlds__default_func_mode_scalar_common_1[0]), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_4, PredInfo_5, &ProcId_22);
      {
        MR_Word base;
