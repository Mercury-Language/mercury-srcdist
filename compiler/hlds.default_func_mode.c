  ...
  MR_Word * MaybeProcId_8)
{
  ...
  if (succeeded)
  {
    ...
    hlds__add_pred__add_new_proc_14_p_0(ModuleInfo_5, Context_19, (MR_Word) ((MR_Unsigned) 0U), InstVarSet_21, PredArgModes_17, Var_27, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (MR_mkword(1, &hlds__default_func_mode_scalar_common_1[0])), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_6, PredInfo_7, &ProcId_23);
    {
      MR_Word base;
