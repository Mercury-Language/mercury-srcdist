  ...
  MR_Word * STATE_VARIABLE_PredTable_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypeCtorInfo_18_18 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
      MR_Word TypeCtorInfo_19_19 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
      ...
      mercury__map__lookup_3_p_0(TypeCtorInfo_18_18, TypeCtorInfo_19_19, STATE_VARIABLE_PredTable_0_2, ((MR_Box) (PredId_7)), &conv0_PredInfo0_10);
      ...
      if ((MaybeNewProcId_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        STATE_VARIABLE_PredTable_16_16 = STATE_VARIABLE_PredTable_0_2;
      else
        mercury__map__det_update_4_p_0(TypeCtorInfo_18_18, TypeCtorInfo_19_19, ((MR_Box) (PredId_7)), ((MR_Box) (PredInfo_11)), STATE_VARIABLE_PredTable_0_2, &STATE_VARIABLE_PredTable_16_16);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      FuncArity_11 = (MR_Integer) ((MR_Unsigned) PredArity_10 - (MR_Unsigned) (MR_Integer) 1);
      ...
      hlds__add_pred__add_new_proc_14_p_0(Context_18, (MR_Integer) -1, PredArity_10, InstVarSet_20, PredArgModes_16, Var_26, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 1, (MR_Word) MR_mkword(MR_mktag(1), &hlds__default_func_mode_scalar_common_1[0]), (MR_Integer) 1, (MR_Integer) 1, PredInfo0_4, PredInfo_5, &ProcId_22);
      {
        MR_Word base;
