  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0(TypeInfo_52_52, (MR_Word) (&parse_tree__check_type_inst_mode_defns_scalar_common_1[2]), (MR_Word) (Var_33), (MR_Word) (TailTypeDefns_24), ((MR_Box) (STATE_VARIABLE_Specs_0_25)), &conv5_STATE_VARIABLE_Specs_26);
