  ...
  MR_Word ProcLabel_5)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (TypeModule_17));
      MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) (TypeName_18));
    }
    {
      TypeCtor_21 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeCtor_21, 0) = ((MR_Box) (Var_36));
