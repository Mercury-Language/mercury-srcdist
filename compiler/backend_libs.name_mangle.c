...
{
  {
    ...
    {
      ClassSym_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_4)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      MR_Word PredOrFunc_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ProcLabel_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            OrigArity_14 = (MR_Integer) ((MR_Unsigned) Arity_11 - (MR_Unsigned) (MR_Integer) 1);
          }
          break;
        case (MR_Integer) 0:
          {
    ...
    else
    {
      ...
      MR_Word SpecialPredId_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), ProcLabel_4, (MR_Integer) 1)));
      ...
      Var_31 = (MR_Word) &backend_libs__name_mangle_scalar_common_1[0];
      LabelName_58 = backend_libs__name_mangle__make_pred_or_func_name_6_f_0(Var_31, (MR_Integer) 0, Var_31, PredName_56, (MR_Integer) -1, AddPrefix_5);
