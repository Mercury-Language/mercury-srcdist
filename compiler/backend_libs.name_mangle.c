...
static const MR_EnumFunctorDescPtr backend_libs__name_mangle__backend_libs__name_mangle__enum_value_ordered_maybe_add_label_prefix_0[2];
...
backend_libs__name_mangle__maybe_qualify_name_2_f_0(
  MR_String Module0_4,
  MR_String Name0_5);
...
const MR_TypeCtorInfo_Struct backend_libs__name_mangle__backend_libs__name_mangle__type_ctor_info_maybe_add_label_prefix_0 = {
  ...
  {     backend_libs__name_mangle__backend_libs__name_mangle__enum_value_ordered_maybe_add_label_prefix_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    ...
    {
      MR_Word DefiningModule_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 0))));
      MR_Word PredOrFunc_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 1))) & (MR_Integer) 1);
      MR_Word PredModule_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 2))));
      MR_String PredName_10 = ((MR_String) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 3))));
      MR_Integer Arity_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 4))));
      MR_Integer ModeNum_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 5))));
    ...
    {
      MR_Word Module_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 0))));
      MR_Word SpecialPredId_16 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 1))) & (MR_Integer) 3);
      MR_Word TypeModule_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 2))));
      MR_String TypeName_18 = ((MR_String) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 3))));
      MR_Integer TypeArity_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 4))));
      MR_Word TypeCtor_21;
      ...
      MR_Integer ModeNum_53 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 5))));
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (TypeModule_17));
        MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (TypeName_18));
      }
      {
        TypeCtor_21 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeCtor_21, 0) = ((MR_Box) (Var_27));
        MR_hl_field(MR_mktag(0), TypeCtor_21, 1) = ((MR_Box) (TypeArity_19));
      }
      PredName_52 = hlds__special_pred__special_pred_name_2_f_0(SpecialPredId_16, TypeCtor_21);
      ...
      FullyQualifiedMangledTypeName_26 = backend_libs__name_mangle__maybe_qualify_name_2_f_0(MangledModule_22, QualifiedMangledTypeName_25);
...
{
  {
    MR_bool succeeded;
    MR_String Name_6;
    MR_String UnderscoresModule_7;
    MR_String Var_8;

    mercury__string__append_3_p_2(Module0_4, (MR_String) "__", &UnderscoresModule_7);
    succeeded = mercury__string__append_3_p_1(UnderscoresModule_7, &Var_8, Name0_5);
    if (succeeded)
      Name_6 = Name0_5;
    else
      mercury__string__append_3_p_2(UnderscoresModule_7, Name0_5, &Name_6);
    return Name_6;
  }
}
