...
#line 28 "backend_libs.name_mangle.c"
#line 536 "../library/io.int"
#include "time.mh"

#line 32 "backend_libs.name_mangle.c"
#line 537 "../library/io.int"
#include "string.mh"

#line 36 "backend_libs.name_mangle.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 40 "backend_libs.name_mangle.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 44 "backend_libs.name_mangle.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 48 "backend_libs.name_mangle.c"
#line 49 "backend_libs.name_mangle.c"
#include "backend_libs.name_mangle.mh"

#line 52 "backend_libs.name_mangle.c"
#line 53 "backend_libs.name_mangle.c"
#ifndef BACKEND_LIBS__NAME_MANGLE_DECL_GUARD
#define BACKEND_LIBS__NAME_MANGLE_DECL_GUARD

#line 57 "backend_libs.name_mangle.c"
#line 58 "backend_libs.name_mangle.c"
...
MR_decl_label2(backend_libs__name_mangle__output_base_typeclass_info_name_4_0, 2,3)
...
MR_decl_label7(backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0, 4,6,9,3,11,14,1)
MR_decl_label3(fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0, 3,4,5)
MR_decl_label10(fn__backend_libs__name_mangle__make_pred_or_func_name_6_0, 2,3,7,10,6,4,12,18,20,15)
MR_decl_label4(fn__backend_libs__name_mangle__make_pred_or_func_name_6_0, 22,23,24,27)
MR_decl_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0, 4,5,9,12,8,6,14,20,22,17)
MR_decl_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0, 24,25,28,27,26,30,31,32,33,3)
MR_decl_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0, 42,44,45,46,47,48,49,50,51,54)
MR_decl_label2(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0, 52,63)
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_label_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_label_prefix'/1 mode 0 */
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__make_pred_or_func_name_6_0);
	MR_init_label10(fn__backend_libs__name_mangle__make_pred_or_func_name_6_0,2,3,7,10,6,4,12,18,20,15)
	MR_init_label4(fn__backend_libs__name_mangle__make_pred_or_func_name_6_0,22,23,24,27)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_pred_or_func_name'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__proc_label_to_c_string_2_0);
	MR_init_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,4,5,9,12,8,6,14,20,22,17)
	MR_init_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,24,25,28,27,26,30,31,32,33,3)
	MR_init_label10(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,42,44,45,46,47,48,49,50,51,54)
	MR_init_label2(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,52,63)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'proc_label_to_c_string'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_sv(6), MR_string_const("main", 4)) != 0)) {
...
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,42)
	...
	MR_np_call_localret_ent(fn__backend_libs__name_mangle__make_pred_or_func_name_6_0,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i44);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,44)
	...
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(string__int_to_string_2_0,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i45);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(string__int_to_string_2_0,
...
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,46)
	...
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i47);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,48)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__name_mangle_1_0,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i49);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__qualify_name_2_0,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i50);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(5);
	...
	MR_np_call_localret_ent(string__append_3_2,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i51);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(string__append_3_1,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i54);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i52);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(string__append_3_2,
		fn__backend_libs__name_mangle__proc_label_to_c_string_2_0_i63);
MR_def_label(fn__backend_libs__name_mangle__proc_label_to_c_string_2_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(7);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 0);
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__output_proc_label_maybe_prefix_4_0);
	MR_init_label1(backend_libs__name_mangle__output_proc_label_maybe_prefix_4_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'output_proc_label_maybe_prefix'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__output_proc_label_3_0);
	MR_init_label1(backend_libs__name_mangle__output_proc_label_3_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'output_proc_label'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__output_proc_label_no_prefix_3_0);
	MR_init_label1(backend_libs__name_mangle__output_proc_label_no_prefix_3_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'output_proc_label_no_prefix'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__name_doesnt_need_mangling_1_0);
	MR_init_label3(backend_libs__name_mangle__name_doesnt_need_mangling_1_0,2,5,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'name_doesnt_need_mangling'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0);
	MR_init_label7(backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0,4,6,9,3,11,14,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'sym_name_doesnt_need_mangling'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0,4)
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(string__is_all_alnum_or_underscore_1_0,
		backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0_i6);
MR_def_label(backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__name_mangle__sym_name_doesnt_need_mangling_1_0_i1);
	}
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0);
	MR_init_label3(fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0,3,4,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_base_typeclass_info_name'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0,4)
	...
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__name_mangle_1_0,
		fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0_i5);
MR_def_label(fn__backend_libs__name_mangle__make_base_typeclass_info_name_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 0);
	...
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("base_typeclass_info_", 20);
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_data_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_data_prefix'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__output_base_typeclass_info_name_4_0);
	MR_init_label2(backend_libs__name_mangle__output_base_typeclass_info_name_4_0,2,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'output_base_typeclass_info_name'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__name_mangle__output_init_name_3_0);
	MR_init_label1(backend_libs__name_mangle__output_init_name_3_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'output_init_name'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_var_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_var_prefix'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_scalar_common_array_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_scalar_common_array_prefix'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_vector_common_array_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_vector_common_array_prefix'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(backend_libs__name_mangle_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__name_mangle__mercury_common_type_prefix_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mercury_common_type_prefix'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
void mercury__backend_libs__name_mangle__init_threadscope_string_table(void);
#endif
...
void mercury__backend_libs__name_mangle__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__backend_libs__name_mangle);
