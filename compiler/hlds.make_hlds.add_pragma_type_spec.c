...
static const MR_FA_PseudoTypeInfo_Struct1 hlds__make_hlds__add_pragma_type_spec__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_err_spec_0;
...
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__func__report_variables__644__1_2_f_0(
  MR_Word VarSet_6,
  MR_Word HeadVar__2_23);

static void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__record_type_specialization__522__1_3_p_0(
  MR_Word PredId_9,
  MR_Integer LambdaHeadVar__1_30,
  MR_Word * LambdaHeadVar__2_31);

static MR_Word MR_CALL 
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__func__check_pragma_type_spec_subst__276__1_1_f_0(
  MR_Word LambdaHeadVar__1_66);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__258__1_2_p_0(
  MR_Word ExistQVars_38,
  MR_Word LambdaHeadVar__1_65);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__230__1_3_p_0(
  MR_Word TVarSet0_7,
  MR_Word NameVarIndex0_23,
  MR_Word LambdaHeadVar__1_63);

static void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__217__1_3_p_0(
...
hlds__make_hlds__add_pragma_type_spec__maybe_record_type_spec_in_qual_info_7_p_0(
  ...
  MR_Word ExpandedItems_12,
  MR_Word STATE_VARIABLE_QualInfo_0_19,
  MR_Word * STATE_VARIABLE_QualInfo_20);

static void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__record_type_specialization_7_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__record_type_specialization_7_p_0(
  MR_Word TypeSpecInfo_8,
  MR_Word PredId_9,
  MR_Word ForcingPredId_10,
  MR_Word SpecPredStatus_11,
  MR_Word SpecProcIds_12,
...
static void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__add_pragma_type_spec_9_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3,
...
static /* final */ const MR_Box hlds__make_hlds__add_pragma_type_spec_scalar_common_4[1][11] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0)),
    ((MR_Box) (&hlds__make_hlds__add_pragma_type_spec__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_err_spec_0)),
    ((MR_Box) (&hlds__make_hlds__add_pragma_type_spec__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_err_spec_0))
  },
};
...
{
  {
    ...
    *LambdaHeadVar__2_31 = base;
    ...
    MR_hl_field(0, base, 1) = ((MR_Box) (LambdaHeadVar__1_30));
  }
}
...
hlds__make_hlds__add_pragma_type_spec__reset_imported_structure_sharing_reuse_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_8)
{
  MR_Word SharingReuseInfo0_4;
  MR_Word SharingReuseInfo_6;
  MR_Word Var_11;
  MR_Word Var_12;

  hlds__hlds_proc__proc_info_get_sharing_reuse_info_2_p_0(STATE_VARIABLE_ProcInfo_0_7, &SharingReuseInfo0_4);
  Var_11 = ((MR_Word) ((MR_hl_field(0, SharingReuseInfo0_4, 0))));
  Var_12 = ((MR_Word) ((MR_hl_field(0, SharingReuseInfo0_4, 1))));
  {
    SharingReuseInfo_6 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, SharingReuseInfo_6, 0) = ((MR_Box) (Var_11));
    MR_hl_field(0, SharingReuseInfo_6, 1) = ((MR_Box) (Var_12));
    MR_hl_field(0, SharingReuseInfo_6, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, SharingReuseInfo_6, 3) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  hlds__hlds_proc__proc_info_set_sharing_reuse_info_3_p_0(SharingReuseInfo_6, STATE_VARIABLE_ProcInfo_0_7, STATE_VARIABLE_ProcInfo_8);
}
...
{
  MR_bool succeeded;
  MR_Word PFUMM0_14 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 0))));
  MR_Word SymName_15 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 1))));
  MR_Word SpecModuleName_16 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 2))));
  MR_Word Subst_17 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 3))));
  MR_Word TVarSet0_18 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 4))));
  MR_Word ExpandedItems_19 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 5))));
  MR_Word Context_20 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 6))));
  MR_Word SeqNum_21 = ((MR_Word) ((MR_hl_field(0, TypeSpecInfo0_9, 7))));
  MR_Word PredInfo0_22;
  MR_Word MaybeSubstResult_23;

  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_46, PredId_10, &PredInfo0_22);
  ...
  {
    MR_Word SubstSpecs_45 = ((MR_Word) ((MR_hl_field(0, MaybeSubstResult_23, 0))));
    MR_Word Var_59;

    Var_59 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), SubstSpecs_45);
    *STATE_VARIABLE_Specs_51 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), Var_59, STATE_VARIABLE_Specs_0_50);
  ...
  else
  {
    ...
    hlds__make_hlds__add_pragma_type_spec__find_pred_procs_to_type_spec_8_p_0(STATE_VARIABLE_ModuleInfo_0_46, PredId_10, PredInfo0_22, ProcTable0_29, TVarSet0_18, Context_20, PFUMM0_14, &MaybeSpecProcs_30);
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_46, &Globals_31);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 656, &Smart_34);
    ...
    if (succeeded)
    {
      ...
      hlds__make_hlds__add_pragma_type_spec__add_forcing_caller_of_pred_14_p_0(PredId_10, PredInfo0_22, PredFormArity_39, TypeSpecInfo0_9, TVarSet_24, Types_25, ExistQVars_26, ClassContext_27, ForcingProcTable0_35, ApplicableModes_36, &ForcingPredId_41, &ForcingPredStatus_42, STATE_VARIABLE_ModuleInfo_0_46, &STATE_VARIABLE_ModuleInfo_1_53);
      {
        TypeSpecInfo_43 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, TypeSpecInfo_43, 0) = ((MR_Box) (PFUMM_40));
        MR_hl_field(0, TypeSpecInfo_43, 1) = ((MR_Box) (SymName_15));
        MR_hl_field(0, TypeSpecInfo_43, 2) = ((MR_Box) (SpecModuleName_16));
        MR_hl_field(0, TypeSpecInfo_43, 3) = ((MR_Box) (RenamedSubst_28));
        MR_hl_field(0, TypeSpecInfo_43, 4) = ((MR_Box) (TVarSet_24));
        MR_hl_field(0, TypeSpecInfo_43, 5) = ((MR_Box) (ExpandedItems_19));
        MR_hl_field(0, TypeSpecInfo_43, 6) = ((MR_Box) (Context_20));
        MR_hl_field(0, TypeSpecInfo_43, 7) = ((MR_Box) (SeqNum_21));
      }
      hlds__make_hlds__add_pragma_type_spec__record_type_specialization_7_p_0(TypeSpecInfo_43, PredId_10, ForcingPredId_41, ForcingPredStatus_42, ForcingProcIds_37, STATE_VARIABLE_ModuleInfo_1_53, STATE_VARIABLE_ModuleInfo_47);
      PredOrFunc_44 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_22);
      hlds__make_hlds__add_pragma_type_spec__maybe_record_type_spec_in_qual_info_7_p_0(PredOrFunc_44, SymName_15, UserArity_38, ForcingPredStatus_42, ExpandedItems_19, STATE_VARIABLE_QualInfo_0_48, STATE_VARIABLE_QualInfo_49);
    ...
    else
    {
      ...
      Var_57 = parse_tree__maybe_error__get_any_errors6_1_f_0((MR_Word) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_2[0]), (MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_applicable_modes_0), (MR_Word) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_user_arity_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_pred_form_arity_0), (MR_Word) (&parse_tree__prog_item_pred_proc_id__parse_tree__prog_item_pred_proc_id__type_ctor_info_pred_func_or_unknown_maybe_modes_0), MaybeSpecProcs_30);
      *STATE_VARIABLE_Specs_51 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), Var_57, STATE_VARIABLE_Specs_0_50);
      *STATE_VARIABLE_QualInfo_49 = STATE_VARIABLE_QualInfo_0_48;
      *STATE_VARIABLE_ModuleInfo_47 = STATE_VARIABLE_ModuleInfo_0_46;
    }
  }
  ...
  MR_Word * STATE_VARIABLE_QualInfo_20)
{
  ...
  switch (IsImported_14) {
    ...
    case (MR_Integer) 0:
      *STATE_VARIABLE_QualInfo_20 = STATE_VARIABLE_QualInfo_0_19;
      break;
    case (MR_Integer) 1:
      {
        MR_Word ItemType_15;
        ...
        }
        {
          ...
          MR_hl_field(0, Var_21, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_7[0]));
          MR_hl_field(0, Var_21, 1) = ((MR_Box) (hlds__make_hlds__add_pragma_type_spec__maybe_record_type_spec_in_qual_info_7_p_0_1));
          MR_hl_field(0, Var_21, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_21, 3) = ((MR_Box) (ItemId_18));
          MR_hl_field(0, Var_21, 4) = ((MR_Box) (ExpandedItems_12));
        }
        hlds__make_hlds__qual_info__apply_to_recompilation_info_3_p_0(Var_21, STATE_VARIABLE_QualInfo_0_19, STATE_VARIABLE_QualInfo_20);
      }
      break;
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__record_type_specialization__522__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_31);
...
{
  MR_bool succeeded;
  MR_Word TypeSpecTables0_14;
  MR_Word ProcsToSpec0_15;
  MR_Word ForcingPredIds0_16;
  MR_Word BaseToForcingMap0_17;
  MR_Word PragmaMap0_18;
  MR_Word SpecPredProcIds_21;
  MR_Word ProcsToSpec_22;
  MR_Word ForcingPredIds_23;
  MR_Word BaseToForcingMap_24;
  MR_Word PragmaMap_25;
  MR_Word TypeSpecTables_26;
  MR_Word Var_29;
  MR_Word Var_32;

  hlds__hlds_module__module_info_get_type_spec_tables_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &TypeSpecTables0_14);
  ProcsToSpec0_15 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables0_14, 0))));
  ForcingPredIds0_16 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables0_14, 1))));
  BaseToForcingMap0_17 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables0_14, 2))));
  PragmaMap0_18 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables0_14, 3))));
  {
    Var_29 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_29, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_5[3]));
    MR_hl_field(0, Var_29, 1) = ((MR_Box) (hlds__make_hlds__add_pragma_type_spec__record_type_specialization_7_p_0_1));
    MR_hl_field(0, Var_29, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_29, 3) = ((MR_Box) (PredId_9));
  }
  mercury__list__map_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), Var_29, SpecProcIds_12, &SpecPredProcIds_21);
  mercury__set__insert_list_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SpecPredProcIds_21, ProcsToSpec0_15, &ProcsToSpec_22);
  mercury__set__insert_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ((MR_Box) (ForcingPredId_10)), ForcingPredIds0_16, &ForcingPredIds_23);
  Var_32 = (MR_Word) (SpecPredStatus_11);
  succeeded = (Var_32 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    mercury__multi_map__set_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ((MR_Box) (PredId_9)), ((MR_Box) (ForcingPredId_10)), BaseToForcingMap0_17, &BaseToForcingMap_24);
  else
    BaseToForcingMap_24 = BaseToForcingMap0_17;
  mercury__one_or_more_map__add_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_decl_pragma_type_spec_info_0), ((MR_Box) (PredId_9)), ((MR_Box) (TypeSpecInfo_8)), PragmaMap0_18, &PragmaMap_25);
  {
    TypeSpecTables_26 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeSpecTables_26, 0) = ((MR_Box) (ProcsToSpec_22));
    MR_hl_field(0, TypeSpecTables_26, 1) = ((MR_Box) (ForcingPredIds_23));
    MR_hl_field(0, TypeSpecTables_26, 2) = ((MR_Box) (BaseToForcingMap_24));
    MR_hl_field(0, TypeSpecTables_26, 3) = ((MR_Box) (PragmaMap_25));
  }
  hlds__hlds_module__module_info_set_type_spec_tables_3_p_0(TypeSpecTables_26, STATE_VARIABLE_ModuleInfo_0_27, STATE_VARIABLE_ModuleInfo_28);
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_ProcInfo_8;

  hlds__make_hlds__add_pragma_type_spec__reset_imported_structure_sharing_reuse_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_ProcInfo_8);
  *wrapper_arg_2 = ((MR_Box) (conv0_STATE_VARIABLE_ProcInfo_8));
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_79)
{
  ...
  mercury__map__map_values_only_3_p_0((MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_2[5]), ForcingProcTable0_23, &ForcingProcTable_36);
  ...
  parse_tree__prog_item_pred_proc_id__pfumm_to_maybe_pf_arity_maybe_modes_4_p_0(PFUMM0_28, &MaybePredOrFunc0_61, &_Arity_62, &_MaybeModes_63);
  ...
  MR_Word * MaybeSpecProcs_16)
{
  ...
  switch (MR_tag((MR_Word) PFUMM0_15)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ModesOrArity_143 = ((MR_Word) ((MR_hl_field(0, PFUMM0_15, 0))));

        if (((MR_tag((MR_Word) ModesOrArity_143)) == (MR_Integer) 1))
        {
          MR_Word ProcIds_63;
          MR_Word PredFormArity_65;
          MR_Word UserArity_66 = ((MR_Word) ((MR_hl_field(1, ModesOrArity_143, 0))));

          mercury__map__keys_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_12, &ProcIds_63);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_66, &PredFormArity_65);
          {
            MR_Word base;
            ...
            *MaybeSpecProcs_16 = base;
            ...
            MR_hl_field(1, base, 2) = ((MR_Box) (ProcIds_63));
            MR_hl_field(1, base, 3) = ((MR_Box) (UserArity_66));
            MR_hl_field(1, base, 4) = ((MR_Box) (PredFormArity_65));
            MR_hl_field(1, base, 5) = ((MR_Box) (PFUMM0_15));
          }
        }
        else
        {
          MR_Word ArgModes_99 = ((MR_Word) ((MR_hl_field(0, ModesOrArity_143, 0))));
          MR_Word PredFormArity_100;
          MR_Integer ProcId_83;
          MR_Word ProcInfo_84;

          PredFormArity_100 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes_99);
          succeeded = hlds__hlds_code_util__get_procedure_matching_argmodes_5_p_0(ModuleInfo_9, ProcTable_12, ArgModes_99, &ProcId_83, &ProcInfo_84);
          if (succeeded)
          {
            MR_Word SpecProcTable_69;
            MR_Word UserArity_70;
            MR_Word Var_71;
            MR_Word Var_72;

            SpecProcTable_69 = mercury__map__singleton_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_83)), ((MR_Box) (ProcInfo_84)));
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 0, &UserArity_70, PredFormArity_100);
            {
              Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_72, 0) = ((MR_Box) (ProcId_83));
            ...
            }
            {
              ...
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
              *MaybeSpecProcs_16 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (SpecProcTable_69));
              MR_hl_field(1, base, 1) = ((MR_Box) (Var_71));
              MR_hl_field(1, base, 2) = ((MR_Box) (Var_72));
              MR_hl_field(1, base, 3) = ((MR_Box) (UserArity_70));
              MR_hl_field(1, base, 4) = ((MR_Box) (PredFormArity_100));
              MR_hl_field(1, base, 5) = ((MR_Box) (PFUMM0_15));
            }
          }
          else
          {
            ...
            mercury__varset__coerce_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), TVarSet_13, &VarSet_76);
            hlds__make_hlds_error__report_undeclared_mode_error_8_p_0(ModuleInfo_9, PredId_10, PredInfo_11, VarSet_76, ArgModes_99, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_type_spec_scalar_common_1[7])), Context_14, &Spec_78);
            {
              Var_79 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_79, 0) = ((MR_Box) (Spec_78));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) ModesOrArity_17)) == (MR_Integer) 1))
        {
          ...
          MR_Word UserArity_48 = ((MR_Word) ((MR_hl_field(1, ModesOrArity_17, 0))));

          mercury__map__keys_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_12, &ProcIds_29);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_48, &PredFormArity_47);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
            *MaybeSpecProcs_16 = base;
            ...
            MR_hl_field(1, base, 3) = ((MR_Box) (UserArity_48));
            MR_hl_field(1, base, 4) = ((MR_Box) (PredFormArity_47));
            MR_hl_field(1, base, 5) = ((MR_Box) (PFUMM0_15));
          }
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            SpecProcTable_24 = mercury__map__singleton_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_22)), ((MR_Box) (ProcInfo_23)));
          ...
          else
          {
            ...
            hlds__make_hlds_error__report_undeclared_mode_error_8_p_0(ModuleInfo_9, PredId_10, PredInfo_11, VarSet_26, ArgModes_20, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_type_spec_scalar_common_1[7])), Context_14, &Spec_28);
            {
              Var_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_41, 0) = ((MR_Box) (Spec_28));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word UserArity_52 = ((MR_Word) ((MR_hl_field(2, PFUMM0_15, 0))));
        MR_Word ProcIds_53;

        mercury__map__keys_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_12, &ProcIds_53);
        PredOrFunc_49 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_11);
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(1, Var_45, 0) = ((MR_Box) (UserArity_52));
              }
              {
                PFUMM_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, PFUMM_50, 0) = ((MR_Box) (Var_45));
              }
            }
            break;
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(1, Var_44, 0) = ((MR_Box) (UserArity_52));
              }
              {
                PFUMM_50 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, PFUMM_50, 0) = ((MR_Box) (Var_44));
              }
            }
            break;
        }
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_49, UserArity_52, &PredFormArity_51);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          *MaybeSpecProcs_16 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (ProcTable_12));
          MR_hl_field(1, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(1, base, 2) = ((MR_Box) (ProcIds_53));
          MR_hl_field(1, base, 3) = ((MR_Box) (UserArity_52));
          MR_hl_field(1, base, 4) = ((MR_Box) (PredFormArity_51));
          MR_hl_field(1, base, 5) = ((MR_Box) (PFUMM_50));
        }
      }
      break;
  }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_67 = hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__func__check_pragma_type_spec_subst__276__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__258__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__230__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__pred__check_pragma_type_spec_subst__217__1_3_p_0(((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_58, &conv0_LambdaHeadVar__3_59);
  ...
  MR_Word * MaybeSubstResult_10)
{
  ...
  if ((MultiSubstVars0_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if ((UnknownVarsToSub_26 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((RecSubstTVars_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          hlds__make_hlds__add_pragma_type_spec__report_subst_existq_tvars_4_p_0(PredInfo0_6, Context_9, SubExistQVars_40, &Spec_80);
          {
            ...
            MR_hl_field(0, Var_68, 0) = ((MR_Box) (Spec_80));
      ...
      else
      {
        ...
        hlds__make_hlds__add_pragma_type_spec__report_recursive_subst_5_p_0(PredInfo0_6, Context_9, TVarSet0_7, RecSubstTVars_31, &Spec_83);
        {
          ...
          MR_hl_field(0, Var_70, 0) = ((MR_Box) (Spec_83));
    ...
    else
    {
      ...
      hlds__make_hlds__add_pragma_type_spec__report_unknown_vars_to_subst_5_p_0(PredInfo0_6, Context_9, TVarSet0_7, UnknownVarsToSub_26, &Spec_86);
      {
        ...
        MR_hl_field(0, Var_72, 0) = ((MR_Box) (Spec_86));
  ...
  else
  {
    ...
    hlds__make_hlds__add_pragma_type_spec__report_multiple_subst_vars_5_p_0(PredInfo0_6, Context_9, TVarSet0_7, MultiSubstVars_20, &Spec_21);
    {
      ...
      MR_hl_field(0, Var_60, 0) = ((MR_Box) (Spec_21));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_24 = hlds__make_hlds__add_pragma_type_spec__IntroducedFrom__func__report_variables__644__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
...
{
  MR_Box closure = closure_arg;
  MR_Word conv2_STATE_VARIABLE_ModuleInfo_47;
  MR_Word conv1_STATE_VARIABLE_QualInfo_49;
  MR_Word conv0_STATE_VARIABLE_Specs_51;

  hlds__make_hlds__add_pragma_type_spec__add_pragma_type_spec_for_pred_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ModuleInfo_47, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_QualInfo_49, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_51);
  *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_ModuleInfo_47));
  *wrapper_arg_5 = ((MR_Box) (conv1_STATE_VARIABLE_QualInfo_49));
  *wrapper_arg_7 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_51));
}

void MR_CALL 
hlds__make_hlds__add_pragma_type_spec__add_pragma_type_spec_9_p_0(
  MR_Word TypeSpec_10,
  ...
  MR_Word STATE_VARIABLE_WarnSpecs_0_44,
  MR_Word * STATE_VARIABLE_WarnSpecs_45)
{
  MR_Word PFUMM_15 = ((MR_Word) ((MR_hl_field(0, TypeSpec_10, 0))));
  MR_Word SymName_16 = ((MR_Word) ((MR_hl_field(0, TypeSpec_10, 1))));
  MR_Word Context_21 = ((MR_Word) ((MR_hl_field(0, TypeSpec_10, 6))));
  ...
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_38, &PredTable_23);
  switch (MR_tag((MR_Word) PFUMM_15)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word ModesOrArity_78 = ((MR_Word) ((MR_hl_field(0, PFUMM_15, 0))));
        MR_Word PredFormArity_81;

        MaybePredOrFunc_26 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_type_spec_scalar_common_3[2]));
        if (((MR_tag((MR_Word) ModesOrArity_78)) == (MR_Integer) 1))
        {
          UserArity_29 = ((MR_Word) ((MR_hl_field(1, ModesOrArity_78, 0))));
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_29, &PredFormArity_81);
        }
        else
        {
          MR_Word Modes_74 = ((MR_Word) ((MR_hl_field(0, ModesOrArity_78, 0))));
          ...
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 0, &UserArity_29, PredFormArity_81);
        }
        hlds__pred_table__predicate_table_lookup_pf_sym_name_name_pfa_6_p_0(PredTable_23, (MR_Integer) 0, (MR_Integer) 0, SymName_16, PredFormArity_81, &PredIds_30);
        hlds__pred_table__predicate_table_lookup_pf_sym_name_5_p_0(PredTable_23, (MR_Integer) 0, (MR_Integer) 0, SymName_16, &AllArityPredIds_31);
        *STATE_VARIABLE_WarnSpecs_45 = STATE_VARIABLE_WarnSpecs_0_44;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word ModesOrArity_24 = ((MR_Word) ((MR_hl_field(1, PFUMM_15, 0))));
        MR_Word PredFormArity_28;

        MaybePredOrFunc_26 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_type_spec_scalar_common_3[1]));
        if (((MR_tag((MR_Word) ModesOrArity_24)) == (MR_Integer) 1))
        {
          UserArity_29 = ((MR_Word) ((MR_hl_field(1, ModesOrArity_24, 0))));
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_29, &PredFormArity_28);
        }
        else
        {
          MR_Word Modes_27 = ((MR_Word) ((MR_hl_field(0, ModesOrArity_24, 0))));

          PredFormArity_28 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_27);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 1, &UserArity_29, PredFormArity_28);
        }
        hlds__pred_table__predicate_table_lookup_pf_sym_name_name_pfa_6_p_0(PredTable_23, (MR_Integer) 0, (MR_Integer) 1, SymName_16, PredFormArity_28, &PredIds_30);
        hlds__pred_table__predicate_table_lookup_pf_sym_name_5_p_0(PredTable_23, (MR_Integer) 0, (MR_Integer) 1, SymName_16, &AllArityPredIds_31);
        *STATE_VARIABLE_WarnSpecs_45 = STATE_VARIABLE_WarnSpecs_0_44;
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word UnknownWarnSpecs_32;

        UserArity_29 = ((MR_Word) ((MR_hl_field(2, PFUMM_15, 0))));
        hlds__make_hlds_error__maybe_warn_about_pfumm_unknown_6_p_0(STATE_VARIABLE_ModuleInfo_0_38, (MR_String) "type_spec", PFUMM_15, SymName_16, Context_21, &UnknownWarnSpecs_32);
        *STATE_VARIABLE_WarnSpecs_45 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), UnknownWarnSpecs_32, STATE_VARIABLE_WarnSpecs_0_44);
        MaybePredOrFunc_26 = (MR_Word) ((MR_Unsigned) 0U);
        hlds__pred_table__predicate_table_lookup_sym_name_arity_5_p_0(PredTable_23, (MR_Integer) 0, SymName_16, UserArity_29, &PredIds_30);
        hlds__pred_table__predicate_table_lookup_sym_name_4_p_0(PredTable_23, (MR_Integer) 0, SymName_16, &AllArityPredIds_31);
      }
      break;
  }
  if ((PredIds_30 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word PredIdTable_33;
    MR_Word OtherUserArities_34;
    MR_Word UndefSpec_35;

    hlds__hlds_module__module_info_get_pred_id_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_38, &PredIdTable_33);
    hlds__hlds_error_util__find_user_arities_other_than_4_p_0(PredIdTable_33, AllArityPredIds_31, UserArity_29, &OtherUserArities_34);
    hlds__make_hlds_error__report_undefined_pred_or_func_error_7_p_0(MaybePredOrFunc_26, SymName_16, UserArity_29, OtherUserArities_34, Context_21, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_type_spec_scalar_common_1[7])), &UndefSpec_35);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_ErrSpecs_43 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (UndefSpec_35));
  ...
  {
    MR_Word Var_60;
    MR_Box conv5_STATE_VARIABLE_ModuleInfo_39;
    MR_Box conv4_STATE_VARIABLE_QualInfo_41;
    MR_Box conv3_STATE_VARIABLE_ErrSpecs_43;

    {
      Var_60 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_60, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_4[0]));
      MR_hl_field(0, Var_60, 1) = ((MR_Box) (hlds__make_hlds__add_pragma_type_spec__add_pragma_type_spec_9_p_0_1));
      MR_hl_field(0, Var_60, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_60, 3) = ((MR_Box) (TypeSpec_10));
    }
    mercury__list__foldl3_8_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__add_pragma_type_spec_scalar_common_1[0]), Var_60, PredIds_30, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_38)), &conv5_STATE_VARIABLE_ModuleInfo_39, ((MR_Box) (STATE_VARIABLE_QualInfo_0_40)), &conv4_STATE_VARIABLE_QualInfo_41, ((MR_Box) (STATE_VARIABLE_ErrSpecs_0_42)), &conv3_STATE_VARIABLE_ErrSpecs_43);
    *STATE_VARIABLE_ModuleInfo_39 = ((MR_Word) (conv5_STATE_VARIABLE_ModuleInfo_39));
    *STATE_VARIABLE_QualInfo_41 = ((MR_Word) (conv4_STATE_VARIABLE_QualInfo_41));
    *STATE_VARIABLE_ErrSpecs_43 = ((MR_Word) (conv3_STATE_VARIABLE_ErrSpecs_43));
  }
}
