...
void MR_CALL 
make__hash__target_id_module_index_hash_2_p_0(
  MR_Word TargetId_3,
  MR_Integer * Hash_4)
{
  if (((MR_tag((MR_Word) TargetId_3)) == (MR_Integer) 0))
  {
    MR_Word ModuleIndex_5 = ((MR_Word) ((MR_hl_field(0, TargetId_3, 0))));
    MR_Word Type_6 = ((MR_Word) ((MR_hl_field(0, TargetId_3, 1))));
    MR_Integer Hash0_7;
    MR_Integer Hash1_8;
    MR_Unsigned Var_10;
    MR_Integer H1_23;
    MR_Integer Var_24;
    MR_Box MR_CALL (* func_0)(MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&make__hash_scalar_common_1[0]), 0)), 5))));
    MR_Box conv1_Var_10;
    ...
    switch (MR_tag((MR_Word) Type_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_19 = ((MR_Unsigned) ((MR_hl_field(1, Type_6, 0))) & (MR_Integer) 1);
      ...
      case (MR_Integer) 2:
        {
          MR_Word PIC_12 = ((MR_Unsigned) ((MR_hl_field(2, Type_6, 0))) & (MR_Integer) 1);
          MR_Integer Var_18;
          MR_Integer H1_20;
          ...
          H1_20 = ((MR_Integer) 16 ^ (((MR_Integer) 16 << 5)));
          Hash1_8 = (H1_20 ^ Var_18);
        }
        break;
      case (MR_Integer) 3:
    ...
    Var_24 = (Hash0_7 << 5);
    H1_23 = (Hash0_7 ^ Var_24);
    *Hash_4 = (H1_23 ^ Hash1_8);
  }
  else
  {
    MR_String FileName_9 = ((MR_String) ((MR_hl_field(1, TargetId_3, 0))));
...
void MR_CALL 
make__hash__target_id_hash_2_p_0(
  MR_Word TargetId_3,
  MR_Integer * Hash_4)
{
  if (((MR_tag((MR_Word) TargetId_3)) == (MR_Integer) 0))
  {
    MR_Word TargetFile_5 = (MR_Word) ((MR_Word) (TargetId_3));

    make__hash__target_file_hash_2_p_0(TargetFile_5, Hash_4);
  }
  else
  {
    MR_String FileName_6 = ((MR_String) ((MR_hl_field(1, TargetId_3, 0))));
...
make__hash__target_file_hash_2_p_0(
  ...
  MR_Integer * Hash_4)
{
  MR_Word ModuleName_5 = ((MR_Word) ((MR_hl_field(0, TargetFile_3, 0))));
  MR_Word Type_6 = ((MR_Word) ((MR_hl_field(0, TargetFile_3, 1))));
  MR_Integer Hash0_7;
  MR_Integer Hash1_8;
  MR_Integer H1_23;
  MR_Integer Var_24;
  ...
  {
    MR_String Name_11 = ((MR_String) ((MR_hl_field(1, ModuleName_5, 1))));

    Hash0_7 = mercury__string__hash_1_f_0(Name_11);
  }
  else
  {
    MR_String Name_9 = ((MR_String) ((MR_hl_field(0, ModuleName_5, 0))));
  ...
  MR_Integer * Hash_4)
{
  ...
  {
    MR_String Name_7 = ((MR_String) ((MR_hl_field(1, SymName_3, 1))));

    *Hash_4 = mercury__string__hash_1_f_0(Name_7);
  }
  else
  {
    MR_String Name_5 = ((MR_String) ((MR_hl_field(0, SymName_3, 0))));
