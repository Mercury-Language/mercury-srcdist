  ...
  MR_Integer * Hash_4)
{
  ...
  {
    MR_String FileName_9 = ((MR_String) ((MR_hl_field(1, DepFile_3, 0))));

    *Hash_4 = mercury__string__hash_1_f_0(FileName_9);
  }
  else
  {
    MR_Word ModuleIndex_5 = ((MR_Word) ((MR_hl_field(0, DepFile_3, 0))));
    MR_Word Type_6 = ((MR_Word) ((MR_hl_field(0, DepFile_3, 1))));
    MR_Integer Hash0_7;
    MR_Integer Hash1_8;
    MR_Unsigned Var_10;
    MR_Integer H1_23;
  ...
  MR_Integer * Hash_4)
{
  if (((MR_tag((MR_Word) DepFile_3)) == (MR_Integer) 1))
  {
    MR_String FileName_6 = ((MR_String) ((MR_hl_field(1, DepFile_3, 0))));
