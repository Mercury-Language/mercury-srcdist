    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if ((MaybeArgInsts_5 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(ModuleInfo_1, Type_10, InstB_14, InstA_12);
          if (succeeded)
            B_mi_A_28 = (MR_Integer) 1;
          else
            B_mi_A_28 = (MR_Integer) 0;
          succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(ModuleInfo_1, Type_10, InstA_12, InstB_14);
          if (succeeded)
            switch (B_mi_A_28) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = check_hlds__inst_match__inst_matches_initial_no_implied_modes_4_p_0(ModuleInfo_1, Type_10, InstB_14, InstA_12);
                  if (succeeded)
                    B_mf_A_34 = (MR_Integer) 1;
                  else
                    B_mf_A_34 = (MR_Integer) 0;
                  succeeded = check_hlds__inst_match__inst_matches_initial_no_implied_modes_4_p_0(ModuleInfo_1, Type_10, InstA_12, InstB_14);
                  if (succeeded)
                    switch (B_mf_A_34) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    succeeded = check_hlds__inst_match__inst_matches_initial_no_implied_modes_4_p_0(ModuleInfo_1, Type_10, ArgInst_38, InstB_14);
                    if (succeeded)
                      Arg_mf_B_40 = (MR_Integer) 1;
                    else
                      Arg_mf_B_40 = (MR_Integer) 0;
                    succeeded = check_hlds__inst_match__inst_matches_initial_no_implied_modes_4_p_0(ModuleInfo_1, Type_10, ArgInst_38, InstA_12);
                    if (succeeded)
                      switch (Arg_mf_B_40) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 0:
