...
MR_decl_label8(ml_backend__mlds_to_ilasm__output_foreign_file_4_0, 2,4,6,9,11,13,15,17)
MR_decl_label3(ml_backend__mlds_to_ilasm__output_foreign_file_4_0, 8,19,3)
MR_decl_label5(ml_backend__mlds_to_ilasm__output_mlds_3_0, 2,3,6,10,7)
...
MR_decl_static(ml_backend__mlds_to_ilasm__IntroducedFrom__pred__output_foreign_file__89__1_4_0)
...
MR_decl_entry(ml_backend__mlds_to_managed__output_csharp_code_3_0);
static const struct mercury_type_3 mercury_common_3[1] =
{
{
MR_COMMON(2,0),
MR_ENTRY_AP(ml_backend__mlds_to_managed__output_csharp_code_3_0),
0
},
};
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module0)
	...
	MR_init_label5(ml_backend__mlds_to_ilasm__output_mlds_3_0,2,3,6,10,7)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_3_0,3)
	...
	MR_np_call_localret_ent(libs__file_util__output_to_file_return_result_5_0,
		ml_backend__mlds_to_ilasm__output_mlds_3_0_i6);
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__mlds_to_ilasm__output_mlds_3_0_i7);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
	...
	MR_np_call_localret_ent(fn__set__to_sorted_list_1_0,
		ml_backend__mlds_to_ilasm__output_mlds_3_0_i10);
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module1)
	...
	MR_init_label8(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,2,4,6,9,11,13,15,17)
	MR_init_label3(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,8,19,3)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,6)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(2),
		...
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i17) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i15) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i13));
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,11)
	...
	MR_r3 = (MR_Integer) 0;
	MR_np_call_localret_ent(parse_tree__file_names__module_name_to_file_name_6_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i19);
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,8)
	...
	MR_np_call_localret_ent(parse_tree__file_names__module_name_to_file_name_6_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i19);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_COMMON(1,2);
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__mlds_to_ilasm__IntroducedFrom__pred__output_foreign_file__89__1_4_0);
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module3)
	MR_init_entry1(ml_backend__mlds_to_ilasm__IntroducedFrom__pred__output_foreign_file__89__1_4_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__mlds_to_ilasm__IntroducedFrom__pred__output_foreign_file__89__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_r2;
	MR_r2 = MR_tempr1;
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(ml_backend__mlds_to_ilasm__IntroducedFrom__pred__output_foreign_file__89__1_4_0));
