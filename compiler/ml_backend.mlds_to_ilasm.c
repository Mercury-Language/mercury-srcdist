...
MR_decl_label4(ml_backend__mlds_to_ilasm__output_foreign_file_4_0, 17,8,19,3)
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module1)
	...
	MR_init_label4(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,17,8,19,3)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,6)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(2),
		...
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i17));
