...
MR_decl_label8(ml_backend__mlds_to_ilasm__output_assembler_5_0, 2,3,4,5,6,7,10,14)
MR_decl_label2(ml_backend__mlds_to_ilasm__output_assembler_5_0, 15,16)
MR_decl_label8(ml_backend__mlds_to_ilasm__output_foreign_file_5_0, 2,4,6,9,11,12,15,17)
MR_decl_label2(ml_backend__mlds_to_ilasm__output_foreign_file_5_0, 19,3)
MR_decl_label5(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0, 2,3,6,10,7)
...
MR_decl_entry(libs__file_util__output_to_file_return_result_5_0);
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module0)
	...
	MR_init_label5(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0,2,3,6,10,7)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0,3)
	...
	MR_np_call_localret_ent(libs__file_util__output_to_file_return_result_5_0,
		ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0_i6);
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0_i7);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
	...
	MR_np_call_localret_ent(fn__set__to_sorted_list_1_0,
		ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0_i10);
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__mlds_to_ilasm__output_mlds_via_ilasm_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module1)
	...
	MR_init_label8(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,2,4,6,9,11,12,15,17)
	MR_init_label2(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,19,3)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,6)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(3),
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i9) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i19) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i17) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i15));
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r3 = (MR_Integer) 0;
	MR_np_call_localret_ent(parse_tree__file_names__module_name_to_file_name_6_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_5_0_i12);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mlds_to_ilasm.m", 15);
	MR_r2 = (MR_Word) MR_string_const("language Erlang foreign code not supported", 42);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(libs__compiler_util__sorry_2_0);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,17)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(libs__compiler_util__sorry_2_0);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mlds_to_ilasm.m", 15);
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module2)
	...
	MR_init_label8(ml_backend__mlds_to_ilasm__output_assembler_5_0,2,3,4,5,6,7,10,14)
	MR_init_label2(ml_backend__mlds_to_ilasm__output_assembler_5_0,15,16)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_assembler_5_0,6)
	...
	MR_np_call_localret_ent(ml_backend__il_peephole__il_peephole_optimize_3_0,
		ml_backend__mlds_to_ilasm__output_assembler_5_0_i14);
...
MR_def_label(ml_backend__mlds_to_ilasm__output_assembler_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
MR_def_label(ml_backend__mlds_to_ilasm__output_assembler_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
