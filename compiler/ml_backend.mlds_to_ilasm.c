...
MR_decl_label8(ml_backend__mlds_to_ilasm__output_foreign_file_4_0, 2,4,6,9,11,12,14,16)
MR_decl_label3(ml_backend__mlds_to_ilasm__output_foreign_file_4_0, 8,18,3)
...
MR_BEGIN_MODULE(ml_backend__mlds_to_ilasm_module1)
	...
	MR_init_label8(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,2,4,6,9,11,12,14,16)
	MR_init_label3(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,8,18,3)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,6)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(2),
		...
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i14) MR_AND
		MR_LABEL_AP(ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i16));
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,11)
	...
	MR_r3 = (MR_Integer) 1;
	MR_np_call_localret_ent(parse_tree__modules__module_name_to_file_name_6_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i18);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,12)
	...
	MR_np_call_localret_ent(libs__compiler_util__sorry_2_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i8);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mlds_to_ilasm.m", 15);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(libs__compiler_util__sorry_2_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i8);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mlds_to_ilasm.m", 15);
	{
	MR_Word MR_tempr1;
...
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,8)
	...
	MR_np_call_localret_ent(parse_tree__modules__module_name_to_file_name_6_0,
		ml_backend__mlds_to_ilasm__output_foreign_file_4_0_i18);
MR_def_label(ml_backend__mlds_to_ilasm__output_foreign_file_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
