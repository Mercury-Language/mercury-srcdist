...
{
  {
    ...
    if (((((MR_tag((MR_Word) TypeCat_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 0))) == (MR_Integer) 1))))
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_10, (MR_Integer) 0)));
    succeeded = !(succeeded);
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_8, (MR_Integer) 0)));
    return succeeded;
  }
}
