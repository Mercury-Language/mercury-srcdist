  ...
  MR_Word * STATE_VARIABLE_Acc_13)
{
  ...
  parse_tree__prog_type_subst__apply_renaming_to_tvar_3_p_0(RevSubst_6, K0_7, &K_10);
  parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(RevSubst_6, V0_8, &V_11);
  ...
  MR_Word Type_4)
{
  ...
  TypeCat_5 = hlds__type_classify__classify_type_2_f_0(ModuleInfo_3, Type_4);
  if ((TypeCat_5 == (MR_Word) ((MR_Unsigned) 16U)))
    succeeded = MR_TRUE;
  else
  if (((((MR_tag((MR_Word) TypeCat_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeCat_5, 0)))) == (MR_Integer) 1))))
  {
    MR_Word Var_15 = ((MR_Unsigned) ((MR_hl_field(3, TypeCat_5, 1))) & (MR_Integer) 7);
  ...
  MR_Word Type_4)
{
  ...
  switch (MR_tag((MR_Word) TypeCat_5)) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, TypeCat_5, 0))))) {
        default:
          succeeded = MR_FALSE;
          break;
        case (MR_Integer) 1:
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__ctgc__util__reverse_renaming_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_STATE_VARIABLE_Acc_13);
...
{
  MR_Word TypeSubn_12;
  MR_Word PredId_13 = ((MR_Word) ((MR_hl_field(0, PPId_8, 0))));
  ...
  parse_tree__prog_type_subst__apply_renaming_to_types_3_p_0(CalleeTypeVarRenaming_20, CalleeArgTypes0_17, &CalleeArgTypes_21);
  parse_tree__prog_type_unify__compute_caller_callee_type_substitution_5_p_0(CalleeArgTypes_21, CallerArgTypes_9, CallerExternalTypeParams_11, CalleeExistQVars_18, &TypeSubn1_22);
  ...
  MR_Word ActualArgs_7)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo_10, &FormalVars_11);
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__PredId_5 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_7, 0))));
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__commit_0) == 0)
    {
      mercury__set__member_2_p_1((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), &(env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__conv0_Var_7, (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__PPIds_4, transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_3, env_ptr);
  ...
  MR_Word * STATE_VARIABLE_GoalInfo_11)
{
  ...
  if ((MaybeCTGC0_6 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    CTGC0_7 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC0_6, 0))));
  Var_12 = ((MR_Word) ((MR_hl_field(0, CTGC0_7, 0))));
  Var_13 = ((MR_Word) ((MR_hl_field(0, CTGC0_7, 1))));
  {
  ...
  MR_Word * STATE_VARIABLE_GoalInfo_11)
{
  ...
  if ((MaybeCTGC0_6 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    CTGC0_7 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC0_6, 0))));
  Var_12 = ((MR_Word) ((MR_hl_field(0, CTGC0_7, 0))));
  Var_14 = ((MR_Word) ((MR_hl_field(0, CTGC0_7, 2))));
  {
    CTGC_8 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, CTGC_8, 0) = ((MR_Box) (Var_12));
  ...
  MR_Word GoalInfo_3)
{
  ...
  {
    MR_Word CTGC_9 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC_8, 0))));

    Reuse_4 = ((MR_Word) ((MR_hl_field(0, CTGC_9, 2))));
  }
  return Reuse_4;
}
  ...
  MR_Word GoalInfo_3)
{
  ...
  else
  {
    ...
    LBU_4 = ((MR_Word) ((MR_hl_field(0, CTGC_9, 1))));
  }
  return LBU_4;
}
  ...
  MR_Word GoalInfo_3)
{
  ...
  else
  {
    ...
    LFU_4 = ((MR_Word) ((MR_hl_field(0, CTGC_9, 0))));
  }
  return LFU_4;
}
  ...
  MR_Word GoalInfo_3)
{
  ...
  {
    MR_Word CTGC_6 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC_5, 0))));
    MR_Word Var_7 = ((MR_Word) ((MR_hl_field(0, CTGC_6, 2))));
  ...
  MR_Word GoalInfo_3)
{
  ...
  {
    MR_Word CTGC_6 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC_5, 0))));
    MR_Word Var_7 = ((MR_Word) ((MR_hl_field(0, CTGC_6, 1))));
  ...
  MR_Word GoalInfo_3)
{
  ...
  {
    MR_Word CTGC_6 = ((MR_Word) ((MR_hl_field(1, MaybeCTGC_5, 0))));
    MR_Word Var_7 = ((MR_Word) ((MR_hl_field(0, CTGC_6, 0))));
