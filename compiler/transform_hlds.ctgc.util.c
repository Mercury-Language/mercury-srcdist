...
MR_decl_label7(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0, 2,25,28,15,43,17,44)
MR_decl_label6(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0, 2,23,26,37,15,40)
MR_decl_label2(transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0, 2,4)
MR_decl_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0, 2,3,4,5,6,7,12,11)
MR_decl_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0, 16,9,20,21,18,8,25,26)
MR_decl_label2(fn__transform_hlds__ctgc__util__get_type_substitution_5_0, 27,29)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module4)
	...
	MR_init_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,2,3,4,5,6,7,12,11)
	MR_init_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,16,9,20,21,18,8,25,26)
	MR_init_label2(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,27,29)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ctgc.util.m", 11);
	MR_r2 = (MR_Word) MR_string_const("ctgc.util.get_type_substitution: type unification failed", 56);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module5)
	...
	MR_init_label6(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,2,23,26,37,15,40)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,2)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i23) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i37) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i37) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i26));
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i37) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i40) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i37) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i40) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i37));
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i15);
	}
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(3, MR_r1, 1);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i40);
	}
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
	}
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module7)
	...
	MR_init_label7(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,2,25,28,15,43,17,44)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i25) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i44) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i44) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i28));
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_unmkbody(MR_r1),1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i43);
	}
	MR_GOTO_LAB(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i44);
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i15);
	}
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_ctfield(3, MR_r1, 1);
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i17);
	}
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r2,2)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0_i43);
	}
MR_def_label(transform_hlds__ctgc__util__top_cell_may_be_reusable_2_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
#ifdef MR_maybe_local_thread_engine_base
