...
{
  {
...

    {
      ...
      if ((env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__succeeded)
      {
        ...
        Var_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_14, (MR_Integer) 0))) & (MR_Integer) 3);
