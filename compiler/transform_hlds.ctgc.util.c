...
{
  {
    ...
    if (((((MR_tag((MR_Word) TypeCat_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 0))) == (MR_Integer) 1))))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_10, (MR_Integer) 0)));
    succeeded = !(succeeded);
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_8, (MR_Integer) 0)));
    return succeeded;
  }
}
...
{
  {
...

    {
      ...
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_14, (MR_Integer) 0)));
