...
{
  {
    ...
    if ((TypeCat_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
      succeeded = MR_TRUE;
    else
    if (((((MR_tag((MR_Word) TypeCat_5)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 0)))) == (MR_Integer) 1))))
    {
      MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_33;
    MR_Word Var_34;
    MR_Integer Var_14 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PPId_8, (MR_Integer) 1)));
    ...
    if ((CalleeExistQVars_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    TypeInfo_41_41 = (MR_Word) &transform_hlds__ctgc__util_scalar_common_1[1];
    mercury__map__keys_2_p_0(TypeInfo_41_41, TypeInfo_41_41, CalleeTypeVarRenaming_20, &CalleeTypeVarRenamingKeys_27);
    mercury__map__values_2_p_0(TypeInfo_41_41, TypeInfo_41_41, CalleeTypeVarRenaming_20, &CalleeTypeVarRenamingValues_28);
    mercury__map__from_corresponding_lists_3_p_0(TypeInfo_41_41, TypeInfo_41_41, CalleeTypeVarRenamingValues_28, CalleeTypeVarRenamingKeys_27, &RevCalleeTypeVarRenaming_29);
    {
    ...
    Var_34 = mercury__map__init_0_f_0(TypeInfo_41_41, TypeCtorInfo_46_46);
    mercury__map__foldl_4_p_0(TypeInfo_41_41, TypeCtorInfo_46_46, (MR_Word) &transform_hlds__ctgc__util_scalar_common_2[0], Var_33, TypeSubst1_23, ((MR_Box) (Var_34)), &conv1_TypeSubst_12);
...
{
  {
    ...
    TypeInfo_12_12 = (MR_Word) &transform_hlds__ctgc__util_scalar_common_1[0];
    mercury__map__from_corresponding_lists_3_p_0(TypeInfo_12_12, TypeInfo_12_12, FormalVars_11, ActualArgs_7, &VariableRenaming_8);
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Var_10)) == (MR_mktag((MR_Integer) 2)));
    if (succeeded)
      Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_10, (MR_Integer) 0)));
    succeeded = !(succeeded);
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
      Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_8, (MR_Integer) 0)));
    return succeeded;
  }
}
...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_14)) == (MR_mktag((MR_Integer) 2)));
