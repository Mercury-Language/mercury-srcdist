...
{
  {
    ...
    if (((((MR_tag((MR_Word) TypeCat_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 0)))) == (MR_Integer) 1))))
    {
      MR_Word Var_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 1))) & (MR_Integer) 7);
...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeCat_5)) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 0))))) {
          default:
            succeeded = MR_FALSE;
            break;
          case (MR_Integer) 1:
...
{
  {
    ...
    else
    {
      ...
      succeeded = parse_tree__prog_type__type_unify_list_5_p_0(CalleeArgTypes_21, ActualTypes_9, CallerExternalTypeParams_11, TypeSubstPrime_26, &TypeSubst0_34);
      if (succeeded)
        TypeSubst1_23 = TypeSubst0_34;
      else
        mercury__require__unexpected_2_p_0((MR_String) "function \140transform_hlds.ctgc.util.get_type_substitution\'/5", (MR_String) "type unification failed");
    }
    ...
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), (MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), CalleeTypeVarRenamingValues_28, CalleeTypeVarRenamingKeys_27, &RevCalleeTypeVarRenaming_29);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&transform_hlds__ctgc__util_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (transform_hlds__ctgc__util__get_type_substitution_5_f_0_1));
      MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (RevCalleeTypeVarRenaming_29));
    }
    Var_33 = mercury__map__init_0_f_0((MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0));
    mercury__map__foldl_4_p_0((MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&transform_hlds__ctgc__util_scalar_common_2[0]), Var_32, TypeSubst1_23, ((MR_Box) (Var_33)), &conv1_TypeSubst_12);
...
{
  {
...

    {
      ...
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_14, (MR_Integer) 0)));
        Var_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_14, (MR_Integer) 0))) & (MR_Integer) 7);
