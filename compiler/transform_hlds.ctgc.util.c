...
MR_decl_label4(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0, 2,11,18,1)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module5)
	...
	MR_init_label4(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,2,11,18,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,2)
	...
	if ((MR_r2 != MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i11);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_tempr1),
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i1) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i1) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i1));
	}
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (MR_INT_EQ(MR_tempr1,2)) {
		MR_GOTO_LAB(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0_i18);
	}
	MR_r1 = ((MR_Integer) MR_tempr1 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
	}
MR_def_label(transform_hlds__ctgc__util__type_needs_sharing_analysis_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
