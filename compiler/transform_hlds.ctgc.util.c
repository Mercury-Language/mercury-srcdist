  ...
  MR_Word Type_4)
{
  ...
  {
    MR_Word Var_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCat_5, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  MR_Word Var_6)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_5, &_VarSet_7, &VarTypes_8);
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_8, Var_6, &Type_9);
  succeeded = transform_hlds__ctgc__util__type_needs_sharing_analysis_2_p_0(ModuleInfo_4, Type_9);
  return succeeded;
}
  ...
  MR_Word CallerExternalTypeParams_11)
{
  ...
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), (MR_Word) (&transform_hlds__ctgc__util_scalar_common_1[1]), CalleeTypeVarRenamingValues_24, CalleeTypeVarRenamingKeys_23, &RevCalleeTypeVarRenaming_25);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&transform_hlds__ctgc__util_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (transform_hlds__ctgc__util__get_type_substitution_5_f_0_1));
    MR_hl_field(MR_mktag(0), Var_26, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_26, 3) = ((MR_Box) (RevCalleeTypeVarRenaming_25));
  }
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_12, (MR_Integer) 0)));
      Var_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__Var_12, (MR_Integer) 0))) & (MR_Integer) 7);
