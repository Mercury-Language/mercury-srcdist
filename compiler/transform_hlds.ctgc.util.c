...
MR_decl_label2(transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0, 2,3)
MR_decl_label10(fn__transform_hlds__ctgc__util__get_type_substitution_5_0, 2,3,4,5,6,7,12,11,14,9)
MR_decl_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0, 17,18,16,8,22,23,24,26)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module4)
	...
	MR_init_label10(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,2,3,4,5,6,7,12,11,14,9)
	MR_init_label8(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,17,18,16,8,22,23,24,26)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,11)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i14);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(5);
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
...
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,9)
	...
	MR_np_call_localret_ent(map__init_1_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i17);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_unify_list_5_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i18);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i16);
	}
	MR_r3 = MR_sv(5);
	MR_sv(2) = MR_r2;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
...
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,8)
	...
	MR_np_call_localret_ent(map__keys_2_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i22);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = MR_r1;
	...
	MR_np_call_localret_ent(map__values_2_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i23);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(map__from_corresponding_lists_3_0,
		fn__transform_hlds__ctgc__util__get_type_substitution_5_0_i24);
MR_def_label(fn__transform_hlds__ctgc__util__get_type_substitution_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__util_module6)
	...
	MR_init_label2(transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0,2,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0,2)
	...
	MR_np_call_localret_ent(parse_tree__prog_data__lookup_var_type_3_0,
		transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0_i3);
MR_def_label(transform_hlds__ctgc__util__var_needs_sharing_analysis_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__transform_hlds__ctgc__util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__ctgc__util);
