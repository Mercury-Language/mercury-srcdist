...
struct transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0_s {
  ...
  MR_Word transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_7_7;
  ...
  MR_Word transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_14_14;
  MR_Box transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__conv0_V_7_7;
};
...
{
  {
    ...
    (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_7_7 = ((MR_Word) (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__conv0_V_7_7);
    {
...
{
  {
...

    {
      ...
      (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__PredId_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_7_7, (MR_Integer) 0)));
      transform_hlds__ctgc__util__V_6_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_7_7, (MR_Integer) 1)));
      {
      ...
      (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_14_14 = (MR_Word) (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__PredStatus_12;
      (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__succeeded = ((MR_tag((MR_Word) (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_14_14)) == (MR_mktag((MR_Integer) 2)));
      if ((transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__succeeded)
        {
          transform_hlds__ctgc__util__V_13_13 = ((MR_Word) (MR_hl_field(MR_mktag(2), (transform_hlds__ctgc__util__env_ptr)->transform_hlds__ctgc__util__some_preds_require_no_analysis_2_p_0_env_0__V_14_14, (MR_Integer) 0)));
          {
