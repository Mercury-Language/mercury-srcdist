...
MR_decl_label8(backend_libs__bytecode_data__int_to_byte_list_3_0, 2,5,6,12,3,4,14,16)
MR_decl_label5(backend_libs__bytecode_data__int_to_byte_list_3_0, 15,17,18,19,20)
...
MR_BEGIN_MODULE(backend_libs__bytecode_data_module5)
	...
	MR_init_label8(backend_libs__bytecode_data__int_to_byte_list_3_0,2,5,6,12,3,4,14,16)
	MR_init_label5(backend_libs__bytecode_data__int_to_byte_list_3_0,15,17,18,19,20)
MR_BEGIN_CODE
...
;}
#line 821 "backend_libs.bytecode_data.c"
...
;}
#line 902 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_r1 = B0;
	MR_r3 = B1;
	MR_r4 = B2;
...
;}
#line 1097 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_tempr1 = B0;
	MR_tempr2 = B1;
	MR_tempr3 = B2;
