  ...
  MR_Integer IntVal_6)
{
  ...
  backend_libs__bytecode_data__output_padding_zeros__ho3_4_p_0(ZeroPadBytes_26);
  ...
  backend_libs__bytecode_data__output_int_bytes__ho2_5_p_0(FirstByteToDump_28, IntVal_6);
}
  ...
  MR_String Val_4)
{
  ...
  mercury__string__to_char_list_2_p_0(Val_4, &Chars_20);
  mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&backend_libs__bytecode_data_scalar_common_3[0]), Chars_20, &List0_24);
  mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), List0_24, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__bytecode_data_scalar_common_1[0])), &List_6);
