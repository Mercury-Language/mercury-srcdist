...
MR_decl_label8(backend_libs__bytecode_data__int_to_byte_list_3_0, 2,5,7,6,8,9,10,11)
MR_decl_label8(backend_libs__bytecode_data__int_to_byte_list_3_0, 12,13,3,4,15,17,16,18)
MR_decl_label3(backend_libs__bytecode_data__int_to_byte_list_3_0, 19,20,21)
...
MR_decl_label8(backend_libs__bytecode_data__output_int_4_0, 2,5,6,12,3,4,14,15)
MR_decl_label3(backend_libs__bytecode_data__output_int_4_0, 17,18,19)
...
MR_BEGIN_MODULE(backend_libs__bytecode_data_module3)
	...
	MR_init_label8(backend_libs__bytecode_data__output_int_4_0,2,5,6,12,3,4,14,15)
	MR_init_label3(backend_libs__bytecode_data__output_int_4_0,17,18,19)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(backend_libs__bytecode_data_module5)
	...
	MR_init_label8(backend_libs__bytecode_data__int_to_byte_list_3_0,2,5,7,6,8,9,10,11)
	MR_init_label8(backend_libs__bytecode_data__int_to_byte_list_3_0,12,13,3,4,15,17,16,18)
	MR_init_label3(backend_libs__bytecode_data__int_to_byte_list_3_0,19,20,21)
MR_BEGIN_CODE
...
;}
#line 973 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_r1 = B0;
	MR_r3 = B1;
	MR_r4 = B2;
...
;}
#line 1171 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_tempr1 = B0;
	MR_tempr2 = B1;
	MR_tempr3 = B2;
