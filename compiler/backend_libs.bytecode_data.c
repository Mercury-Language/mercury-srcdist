...
static /* final */ const MR_Box backend_libs__bytecode_data_scalar_common_2[1][1];

static /* final */ const MR_Box backend_libs__bytecode_data_scalar_common_3[1][5];

static /* final */ const MR_Box backend_libs__bytecode_data_scalar_common_4[2][3];

static /* final */ const MR_Box backend_libs__bytecode_data_scalar_common_5[1][6];
...
static /* final */ const MR_Box backend_libs__bytecode_data_scalar_common_4[2][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (&backend_libs__bytecode_data_scalar_common_5[0])),
  ...
  MR_Word * Bytes_4)
{
  ...
  succeeded = (IntBits_5 > ((MR_Integer) ((MR_Unsigned) 8 * (MR_Unsigned) 8)));
  if (succeeded)
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.bytecode_data.int_to_byte_list\'/2", (MR_String) "size of int is larger than size of bytecode integer.");
      return;
    }
  else
    backend_libs__bytecode_data__int_to_byte_list_3_p_0((MR_Integer) ((MR_Unsigned) 8 * (MR_Unsigned) 8), IntVal_3, Bytes_4);
}
  ...
  MR_Word * Bytes_6)
{
  ...
  MR_Word STATE_VARIABLE_IO_31_42;
  MR_Integer Var_44;
  ...
  if (succeeded)
  {
    ...
    if (!(succeeded))
    {
      MR_Integer Var_32 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) MaxVal_24);
  ...
  if (succeeded)
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__bytecode_data_scalar_common_2[0]), Bits_4, &Var_49);
    Var_56 = mercury__string__f_43_43_2_f_0(Var_49, (MR_String) " bits");
    Var_58 = mercury__string__f_43_43_2_f_0((MR_String) " does not fit in ", Var_56);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__bytecode_data_scalar_common_2[0]), IntVal_5, &Var_59);
    Msg_25 = mercury__string__f_43_43_2_f_0(Var_59, Var_58);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.bytecode_data.output_int\'/5", Msg_25);
      return;
    }
  }
  succeeded = (Bits_4 > IntBits_23);
  if (succeeded)
  {
    MR_Integer Var_40 = (MR_Integer) ((MR_Unsigned) Bits_4 - (MR_Unsigned) IntBits_23);

    ZeroPadBytes_26 = mercury__int__f_47_47_2_f_0(Var_40, (MR_Integer) 8);
  }
  else
    ZeroPadBytes_26 = (MR_Integer) 0;
  backend_libs__bytecode_data__output_padding_zeros__ho6_4_p_0(ZeroPadBytes_26, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_IO_31_42);
  BytesToDump_27 = mercury__int__f_47_47_2_f_0(Bits_4, (MR_Integer) 8);
  Var_44 = (MR_Integer) ((MR_Unsigned) BytesToDump_27 - (MR_Unsigned) ZeroPadBytes_26);
  FirstByteToDump_28 = (MR_Integer) ((MR_Unsigned) Var_44 - (MR_Unsigned) 1);
  backend_libs__bytecode_data__output_int_bytes__ho5_5_p_0(FirstByteToDump_28, IntVal_5, STATE_VARIABLE_IO_31_42, &RevBytes_7);
  ...
  MR_Integer IntVal_6)
{
  ...
  if (succeeded)
  {
    MR_Integer Var_40 = (MR_Integer) ((MR_Unsigned) Bits_5 - (MR_Unsigned) IntBits_23);
  ...
  MR_String Val_4)
{
  ...
  mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), (MR_Word) (&backend_libs__bytecode_data_scalar_common_4[1]), List_6, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_10_10);
  mercury__io__write_byte_3_p_0((MR_Integer) 0);
}
  ...
  MR_Word * List_4)
{
  ...
  mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&backend_libs__bytecode_data_scalar_common_4[0]), Chars_5, &List0_9);
  mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), List0_9, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__bytecode_data_scalar_common_1[0])), List_4);
}
