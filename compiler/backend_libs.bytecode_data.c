...
{
  MR_bool succeeded;
  MR_Integer IntBits_16;
  MR_Integer ZeroPadBytes_19;
  MR_Integer BytesToDump_20;
  MR_Integer FirstByteToDump_21;
  MR_Integer Var_37;
  MR_Integer MaxVal_17;
  MR_Integer Var_22;
  MR_Integer Var_23;
  MR_Integer Var_24;

  mercury__int__bits_per_int_1_p_0(&IntBits_16);
  succeeded = (Bits_5 < IntBits_16);
  if (succeeded)
  {
    Var_22 = (MR_Integer) 2;
    Var_24 = (MR_Integer) 1;
    Var_23 = (MR_Integer) ((MR_Unsigned) Bits_5 - (MR_Unsigned) Var_24);
    mercury__int__pow_3_p_0(Var_22, Var_23, &MaxVal_17);
    succeeded = (IntVal_6 >= MaxVal_17);
    if (!(succeeded))
    {
      MR_Integer Var_25 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) MaxVal_17);

      succeeded = (IntVal_6 < Var_25);
    }
  }
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (IntVal_6));
    }
    {
      Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (Bits_5));
    }
    {
    ...
    mercury__string__format_3_p_0((MR_String) "%d does not fit in %d bits", Var_27, &Msg_18);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.bytecode_data.output_int\'/5", Msg_18);
      return;
    }
  }
  succeeded = (Bits_5 > IntBits_16);
  if (succeeded)
  {
    MR_Integer Var_33 = (MR_Integer) ((MR_Unsigned) Bits_5 - (MR_Unsigned) IntBits_16);

    ZeroPadBytes_19 = mercury__int__f_47_47_2_f_0(Var_33, (MR_Integer) 8);
  }
  else
    ZeroPadBytes_19 = (MR_Integer) 0;
  backend_libs__bytecode_data__output_padding_zeros__ho3_4_p_0(ZeroPadBytes_19);
  BytesToDump_20 = mercury__int__f_47_47_2_f_0(Bits_5, (MR_Integer) 8);
  Var_37 = (MR_Integer) ((MR_Unsigned) BytesToDump_20 - (MR_Unsigned) ZeroPadBytes_19);
  FirstByteToDump_21 = (MR_Integer) ((MR_Unsigned) Var_37 - (MR_Unsigned) 1);
  backend_libs__bytecode_data__output_int_bytes__ho2_5_p_0(FirstByteToDump_21, IntVal_6);
}
  ...
  MR_String Val_4)
{
  ...
  mercury__string__to_char_list_2_p_0(Val_4, &Chars_17);
  mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&backend_libs__bytecode_data_scalar_common_3[0]), Chars_17, &List0_19);
  mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), List0_19, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__bytecode_data_scalar_common_1[0])), &List_6);
