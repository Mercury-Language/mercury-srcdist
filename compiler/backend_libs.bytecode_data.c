...
MR_decl_label10(backend_libs__bytecode_data__int_to_byte_list_3_0, 2,5,7,6,8,9,10,11,12,13)
MR_decl_label9(backend_libs__bytecode_data__int_to_byte_list_3_0, 3,4,15,17,16,18,19,20,21)
MR_decl_label1(backend_libs__bytecode_data__output_byte_3_0, 2)
MR_decl_label10(backend_libs__bytecode_data__output_float_3_0, 3,2,5,7,6,9,11,10,13,15)
MR_decl_label10(backend_libs__bytecode_data__output_float_3_0, 14,17,19,18,21,23,22,25,27,26)
MR_decl_label1(backend_libs__bytecode_data__output_float_3_0, 29)
...
MR_BEGIN_MODULE(backend_libs__bytecode_data_module5)
	...
	MR_init_label10(backend_libs__bytecode_data__int_to_byte_list_3_0,2,5,7,6,8,9,10,11,12,13)
	MR_init_label9(backend_libs__bytecode_data__int_to_byte_list_3_0,3,4,15,17,16,18,19,20,21)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__bytecode_data__int_to_byte_list_3_0,12)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("error: bytecode_data.output_int: ", 33);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		backend_libs__bytecode_data__int_to_byte_list_3_0_i13);
...
MR_def_label(backend_libs__bytecode_data__int_to_byte_list_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(1) <= (MR_Integer) MR_sv(3))) {
		MR_GOTO_LAB(backend_libs__bytecode_data__int_to_byte_list_3_0_i16);
	}
	MR_r1 = ((MR_Integer) MR_sv(1) - (MR_Integer) MR_sv(3));
	MR_r2 = (MR_Integer) 8;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		backend_libs__bytecode_data__int_to_byte_list_3_0_i17);
MR_def_label(backend_libs__bytecode_data__int_to_byte_list_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_GOTO_LAB(backend_libs__bytecode_data__int_to_byte_list_3_0_i18);
...
MR_def_label(backend_libs__bytecode_data__int_to_byte_list_3_0,20)
	...
	MR_np_call_localret_ent(backend_libs__bytecode_data__output_int_bytes__ho5_5_0,
		backend_libs__bytecode_data__int_to_byte_list_3_0_i21);
MR_def_label(backend_libs__bytecode_data__int_to_byte_list_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
;}
#line 886 "backend_libs.bytecode_data.c"
...
MR_BEGIN_MODULE(backend_libs__bytecode_data_module12)
	...
	MR_init_label10(backend_libs__bytecode_data__output_float_3_0,3,2,5,7,6,9,11,10,13,15)
	MR_init_label10(backend_libs__bytecode_data__output_float_3_0,14,17,19,18,21,23,22,25,27,26)
	MR_init_label1(backend_libs__bytecode_data__output_float_3_0,29)
MR_BEGIN_CODE
...
;}
#line 970 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_r1 = B0;
	MR_r3 = B1;
	MR_r4 = B2;
...
MR_def_label(backend_libs__bytecode_data__output_float_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_GOTO_LAB(backend_libs__bytecode_data__output_float_3_0_i25);
...
MR_def_label(backend_libs__bytecode_data__output_float_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_GE(MR_r1,256)) {
		MR_GOTO_LAB(backend_libs__bytecode_data__output_float_3_0_i26);
	}
	MR_np_call_localret_ent(io__write_byte_3_0,
		backend_libs__bytecode_data__output_float_3_0_i27);
MR_def_label(backend_libs__bytecode_data__output_float_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
...
MR_def_label(backend_libs__bytecode_data__output_float_3_0,26)
	...
	MR_r2 = (MR_Word) MR_string_const("output_byte: byte does not fit in eight bits", 44);
	MR_np_call_localret_ent(require__unexpected_2_0,
		backend_libs__bytecode_data__output_float_3_0_i29);
MR_def_label(backend_libs__bytecode_data__output_float_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(backend_libs__bytecode_data__output_byte_3_0);
...
;}
#line 1181 "backend_libs.bytecode_data.c"
	MR_RELEASE_GLOBAL_LOCK("float_to_float64_bytes");
	MR_r2 = B0;
	MR_tempr1 = B1;
	MR_tempr2 = B2;
...
void mercury__backend_libs__bytecode_data__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__backend_libs__bytecode_data);
