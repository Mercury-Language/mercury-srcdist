...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__bytecode_data_scalar_common_5[0]), Bits_4, &Var_49);
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__bytecode_data_scalar_common_5[0]), IntVal_5, &Var_59);
