  ...
  MR_Word * STATE_VARIABLE_IO_10)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Integer next_value_of_NumBytes_6 = NumBytes1_8;
        MR_Word next_value_of_STATE_VARIABLE_IO_0_9 = STATE_VARIABLE_IO_13_13;
  ...
  MR_Word * STATE_VARIABLE_IO_14)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_ByteNum_7 = ByteNum1_12;
        MR_Word next_value_of_STATE_VARIABLE_IO_0_13 = STATE_VARIABLE_IO_22_22;
