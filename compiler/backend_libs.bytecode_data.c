  ...
  MR_String Val_4)
{
  ...
  mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), List0_19, (MR_Word) (MR_mkword(1, &backend_libs__bytecode_data_scalar_common_1[0])), &List_6);
