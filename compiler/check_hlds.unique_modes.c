...
check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__946__1_2_p_0(
...
{
  {
    ...
    succeeded = check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__946__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_21);
    if (succeeded)
    {
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) GenericCall0_21)) {
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GenericCall0_21, (MR_Integer) 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      ArgOffset_179 = (MR_Integer) 0;
                      break;
