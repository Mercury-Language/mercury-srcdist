...
MR_decl_label8(check_hlds__unique_modes__unique_modes_check_call_7_0, 44,45,40,47,48,49,50,54)
MR_decl_label7(check_hlds__unique_modes__unique_modes_check_call_7_0, 55,52,56,57,58,60,59)
...
MR_BEGIN_MODULE(check_hlds__unique_modes_module7)
	...
	MR_init_label8(check_hlds__unique_modes__unique_modes_check_call_7_0,44,45,40,47,48,49,50,54)
	MR_init_label7(check_hlds__unique_modes__unique_modes_check_call_7_0,55,52,56,57,58,60,59)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__unique_modes__unique_modes_check_call_7_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(8),0,0)) {
		MR_GOTO_LAB(check_hlds__unique_modes__unique_modes_check_call_7_0_i50);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(9);
...
MR_def_label(check_hlds__unique_modes__unique_modes_check_call_7_0,50)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__unique_modes__unique_modes_check_call_7_0_i52);
	}
	MR_sv(1) = MR_sv(2);
...
MR_def_label(check_hlds__unique_modes__unique_modes_check_call_7_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__unique_modes__unique_modes_check_call_7_0_i59);
	}
