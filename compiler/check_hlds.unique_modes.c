...
check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__543__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__543__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_22);
  if (succeeded)
  {
...
{
  MR_bool succeeded;
  MR_Word GenericCall_8 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_5, 1))));
  MR_Word ArgVars_9 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_5, 2))));
  MR_Word ArgModes_10 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_5, 3))));
  MR_Word Detism_12 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_5, 5))) & (MR_Integer) 7);
  MR_Word CallId_13;
  MR_Word ArgOffset_21;
  ...
  MR_Word FinalInsts0_46;
  MR_Word FinalInsts_47;
  MR_Word NewArgVars_48;
  MR_Word ExtraGoals_49;
  MR_Word STATE_VARIABLE_ModeInfo_28_52;
  MR_Word STATE_VARIABLE_ModeInfo_29_53;
  MR_Word _BadInstVars_45;
  MR_Word Var_41;
  MR_Word Var_14;
  ...
  {
    CallId_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, CallId_13, 0) = ((MR_Box) (GenericCall_8));
  }
  {
    Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_33, 0) = ((MR_Box) (CallId_13));
  }
  ...
  switch (MR_tag((MR_Word) GenericCall_8)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ArgOffset_21 = check_hlds__modecheck_util__higher_order_modecheck_arg_offset_0_f_0();
      break;
    case (MR_Integer) 1:
      ArgOffset_21 = check_hlds__modecheck_util__unify_method_event_cast_modecheck_arg_offset_0_f_0();
      break;
    case (MR_Integer) 2:
      ArgOffset_21 = check_hlds__modecheck_util__unify_method_event_cast_modecheck_arg_offset_0_f_0();
      break;
  ...
  }
  {
    ...
    MR_hl_field(2, Var_36, 0) = ((MR_Box) (GenericCall_8));
  }
  ...
  check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_8_p_0(Var_36, ArgOffset_21, ArgVars_9, InitialInsts_43, &InstVarSub_44, &_BadInstVars_45, STATE_VARIABLE_ModeInfo_34_34, &STATE_VARIABLE_ModeInfo_28_52);
  check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_42, ArgModes_10, &FinalInsts0_46);
  parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_44, FinalInsts0_46, &FinalInsts_47);
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgOffset_21, ArgVars_9, InitialInsts_43, FinalInsts_47, &NewArgVars_48, &ExtraGoals_49, STATE_VARIABLE_ModeInfo_28_52, &STATE_VARIABLE_ModeInfo_29_53);
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__unique_modes_scalar_common_1[1]), ((MR_Box) (NewArgVars_48)), ((MR_Box) (ArgVars_9)));
  if (succeeded)
    succeeded = (ExtraGoals_49 == (MR_Word) ((MR_Unsigned) 0U));
  if (!(succeeded))
    {
  ...
  parse_tree__prog_data__determinism_components_3_p_0(Detism_12, &Var_14, &Var_41);
  succeeded = ((MR_Integer) 0 == Var_41);
  if (succeeded)
  {
    MR_Word InstMap_50;

    hlds__instmap__init_unreachable_1_p_0(&InstMap_50);
    check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_50, STATE_VARIABLE_ModeInfo_29_53, &STATE_VARIABLE_ModeInfo_37_37);
  }
  else
  {
    MR_Word Var_57;
    ...
    parse_tree__prog_data__determinism_components_3_p_0(Detism_12, &Var_51, &Var_57);
    succeeded = ((MR_Integer) 3 == Var_57);
    if (succeeded)
    {
      MR_Word FullInstMap0_59;

      check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_29_53, &FullInstMap0_59);
      succeeded = hlds__instmap__instmap_is_reachable_1_p_0(FullInstMap0_59);
      if (succeeded)
      {
        MR_Word AllVars_60;
        MR_Word NondetLiveVars_61;

        hlds__instmap__instmap_vars_list_2_p_0(FullInstMap0_59, &AllVars_60);
        check_hlds__unique_modes__select_nondet_live_vars_3_p_0(AllVars_60, STATE_VARIABLE_ModeInfo_29_53, &NondetLiveVars_61);
        check_hlds__unique_modes__make_vars_mostly_uniq_3_p_0(NondetLiveVars_61, STATE_VARIABLE_ModeInfo_29_53, &STATE_VARIABLE_ModeInfo_37_37);
      }
      else
        STATE_VARIABLE_ModeInfo_37_37 = STATE_VARIABLE_ModeInfo_29_53;
    }
    else
      STATE_VARIABLE_ModeInfo_37_37 = STATE_VARIABLE_ModeInfo_29_53;
  }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_39)
{
  ...
  else
  {
    ...
    hlds__instmap__instmap_lookup_vars_3_p_0(InstMap_27, ArgVars_10, &ArgInsts_28);
    {
      ...
      MR_hl_field(3, ModeError_29, 0) = ((MR_Box) ((MR_Unsigned) 15U));
