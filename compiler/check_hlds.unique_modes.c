  ...
  MR_Word * STATE_VARIABLE_ModeInfo_59)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr0_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word LHS0_387 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr0_6, (MR_Integer) 0))));
        MR_Word RHS0_388 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr0_6, (MR_Integer) 1))));
        MR_Word Unification0_390 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr0_6, (MR_Integer) 3))));
        MR_Word UnifyContext_391 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr0_6, (MR_Integer) 4))));
        ...
        check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "unify", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_19_394);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_395, 0) = ((MR_Box) (UnifyContext_391));
        }
    ...
    case (MR_Integer) 2:
      {
        MR_Word PredId_256 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 0))));
        MR_Integer ProcId0_257 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 1))));
        MR_Word ArgVars_258 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 2))));
        MR_Word Builtin_259 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 3))) & (MR_Integer) 1);
        MR_Word MaybeUnifyContext_260 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 4))));
        MR_Word PredSymName_261 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr0_6, (MR_Integer) 5))));
        ...
        check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, CallString_263, STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_23_267);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_270, 0) = ((MR_Box) (PredId_256));
        }
        {
          Var_268 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_268, 0) = ((MR_Box) (Var_270));
        }
        ...
        check_hlds__unique_modes__unique_modes_check_call_7_p_0(PredId_256, ProcId0_257, ArgVars_258, GoalInfo0_7, &ProcId_264, STATE_VARIABLE_ModeInfo_25_269, &STATE_VARIABLE_ModeInfo_27_271);
        {
          ...
          *GoalExpr_8 = base;
          MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (PredId_256));
          MR_hl_field(MR_mktag(2), base, 1) = ((MR_Box) (ProcId_264));
          MR_hl_field(MR_mktag(2), base, 2) = ((MR_Box) (ArgVars_258));
          MR_hl_field(MR_mktag(2), base, 3) = (MR_Box) ((MR_Unsigned) (Builtin_259));
          MR_hl_field(MR_mktag(2), base, 4) = ((MR_Box) (MaybeUnifyContext_260));
          MR_hl_field(MR_mktag(2), base, 5) = ((MR_Box) (PredSymName_261));
        }
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word GenericCall_137 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 1))));
            MR_Word ArgVars_138 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2))));
            MR_Word ArgModes_139 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 3))));
            MR_Word Detism_141 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 5))) & (MR_Integer) 7);
            ...
            {
              CallId_143 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CallId_143, 0) = ((MR_Box) (GenericCallId_142));
            }
            {
              Var_160 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_160, 0) = ((MR_Box) (CallId_143));
            }
        ...
        case (MR_Integer) 1:
          {
            MR_Word Attributes_83 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 1))));
            MR_Word PredId_84 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2))));
            MR_Integer ProcId0_85 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 3))));
            MR_Word Args_86 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 4))));
            MR_Word ExtraArgs_87 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 5))));
            MR_Word MaybeTraceRuntimeCond_88 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 6))));
            MR_Word PragmaCode_89 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 7))));
            MR_Word ArgVars_90;
            ...
            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "foreign_proc", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_23_94);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_97, 0) = ((MR_Box) (PredId_84));
            }
            {
              Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Var_97));
            }
            ...
            check_hlds__unique_modes__unique_modes_check_call_7_p_0(PredId_84, ProcId0_85, ArgVars_90, GoalInfo0_7, &ProcId_91, STATE_VARIABLE_ModeInfo_25_96, &STATE_VARIABLE_ModeInfo_28_99);
            {
              ...
              *GoalExpr_8 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Attributes_83));
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (PredId_84));
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (ProcId_91));
              MR_hl_field(MR_mktag(3), base, 4) = ((MR_Box) (Args_86));
              MR_hl_field(MR_mktag(3), base, 5) = ((MR_Box) (ExtraArgs_87));
              MR_hl_field(MR_mktag(3), base, 6) = ((MR_Box) (MaybeTraceRuntimeCond_88));
              MR_hl_field(MR_mktag(3), base, 7) = ((MR_Box) (PragmaCode_89));
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            }
            {
              ...
              *GoalExpr_8 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Goals_105));
            }
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word STATE_VARIABLE_ModeInfo_31_133;
            ...
            if ((Goals0_80 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_116, STATE_VARIABLE_ModeInfo_23_126, &STATE_VARIABLE_ModeInfo_31_133);
            }
            else
            {
              ...
              if (succeeded)
              {
                MR_Word STATE_VARIABLE_ModeInfo_25_128;
                MR_Word STATE_VARIABLE_ModeInfo_26_129;

                check_hlds__mode_info__mode_info_add_live_vars_3_p_0(NonLocals_119, STATE_VARIABLE_ModeInfo_23_126, &STATE_VARIABLE_ModeInfo_25_128);
                check_hlds__unique_modes__make_all_nondet_live_vars_mostly_uniq_2_p_0(STATE_VARIABLE_ModeInfo_25_128, &STATE_VARIABLE_ModeInfo_26_129);
                check_hlds__mode_info__mode_info_remove_live_vars_3_p_0(NonLocals_119, STATE_VARIABLE_ModeInfo_26_129, &STATE_VARIABLE_ModeInfo_27_130);
              }
              else
                STATE_VARIABLE_ModeInfo_27_130 = STATE_VARIABLE_ModeInfo_23_126;
              check_hlds__unique_modes__unique_modes_check_disj_7_p_0(Goals0_80, Determinism_120, NonLocals_119, &Goals_115, &InstMaps_122, STATE_VARIABLE_ModeInfo_27_130, &STATE_VARIABLE_ModeInfo_28_131);
              hlds__instmap__make_arm_instmaps_for_goals_3_p_0(Goals_115, InstMaps_122, &ArmInstMaps_123);
              hlds__instmap__instmap_merge_5_p_0(NonLocals_119, ArmInstMaps_123, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_28_131, &STATE_VARIABLE_ModeInfo_31_133);
            }
            {
              MR_Word base;
              ...
              *GoalExpr_8 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Goals_115));
            }
            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "disj", STATE_VARIABLE_ModeInfo_31_133, STATE_VARIABLE_ModeInfo_59);
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            MR_Word STATE_VARIABLE_ModeInfo_29_384;
            ...
            if ((Cases0_37 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_373, STATE_VARIABLE_ModeInfo_25_381, &STATE_VARIABLE_ModeInfo_29_384);
            }
            else
            {
              ...
              check_hlds__unique_modes__unique_modes_check_case_list_6_p_0(Cases0_37, Var0_35, &Cases_372, &InstMaps_377, STATE_VARIABLE_ModeInfo_25_381, &STATE_VARIABLE_ModeInfo_26_382);
              hlds__instmap__make_arm_instmaps_for_cases_3_p_0(Cases_372, InstMaps_377, &ArmInstMaps_378);
              hlds__instmap__instmap_merge_5_p_0(NonLocals_376, ArmInstMaps_378, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_26_382, &STATE_VARIABLE_ModeInfo_29_384);
            }
            {
              MR_Word base;
              ...
              *GoalExpr_8 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Cases_372));
            }
            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "switch", STATE_VARIABLE_ModeInfo_29_384, STATE_VARIABLE_ModeInfo_59);
          }
          break;
        case (MR_Integer) 5:
          {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word STATE_VARIABLE_ModeInfo_48_309;
                  MR_Word SubGoal_344;

                  check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_47_308);
                  check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_344, STATE_VARIABLE_ModeInfo_47_308, &STATE_VARIABLE_ModeInfo_48_309);
                  check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", STATE_VARIABLE_ModeInfo_48_309, STATE_VARIABLE_ModeInfo_59);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    *GoalExpr_8 = base;
                    ...
                    MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubGoal_344));
                  }
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Reason0_43, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 6:
                    {
                      MR_Word TermVar_283 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason0_43, (MR_Integer) 1))));
                      MR_Word FGT_284 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_43, (MR_Integer) 2))) & (MR_Integer) 3);
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            MR_Word STATE_VARIABLE_ModeInfo_63_322;
                            MR_Word STATE_VARIABLE_ModeInfo_66_325;

                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "from_ground_term_construct scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_63_322);
                            check_hlds__mode_info__mode_info_var_is_live_3_p_0(STATE_VARIABLE_ModeInfo_63_322, TermVar_283, &LiveTermVar_285);
                            switch (LiveTermVar_285) {
                              default: /*NOTREACHED*/ MR_assert(0);
                              case (MR_Integer) 1:
                                {
                                  *GoalExpr_8 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__unique_modes_scalar_common_2[1]));
                                  STATE_VARIABLE_ModeInfo_66_325 = STATE_VARIABLE_ModeInfo_63_322;
                                }
                                break;
                              case (MR_Integer) 0:
                                {
                                  MR_Word SubGoalInfo_287 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubGoal0_81, (MR_Integer) 1))));
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_63_322, &InstMap0_341);
                                    hlds__instmap__instmap_set_var_4_p_0(TermVar_283, TermVarInst_289, InstMap0_341, &InstMap_290);
                                    check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_290, STATE_VARIABLE_ModeInfo_63_322, &STATE_VARIABLE_ModeInfo_66_325);
                                  }
                                  else
                                    {
                            ...
                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "from_ground_term_construct scope", STATE_VARIABLE_ModeInfo_66_325, STATE_VARIABLE_ModeInfo_59);
                          }
                          break;
                        case (MR_Integer) 2:
                        case (MR_Integer) 3:
                          {
                            MR_Word STATE_VARIABLE_ModeInfo_56_316;
                            MR_Word STATE_VARIABLE_ModeInfo_57_317;
                            MR_Word SubGoal_343;

                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_56_316);
                            check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_343, STATE_VARIABLE_ModeInfo_56_316, &STATE_VARIABLE_ModeInfo_57_317);
                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", STATE_VARIABLE_ModeInfo_57_317, STATE_VARIABLE_ModeInfo_59);
                            {
                              MR_Word base;
                              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                              *GoalExpr_8 = base;
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      MR_Word SubGoal_282;
                      MR_Word STATE_VARIABLE_ModeInfo_74_332;
                      MR_Word STATE_VARIABLE_ModeInfo_76_334;
                      MR_Word STATE_VARIABLE_ModeInfo_77_335;
                      MR_Word STATE_VARIABLE_ModeInfo_79_337;
                      MR_Word STATE_VARIABLE_ModeInfo_80_338;

                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "trace scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_74_332);
                      check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_74_332, &InstMap0_280);
                      NonLocals_281 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_7);
                      check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) ((MR_Unsigned) 8U), NonLocals_281, STATE_VARIABLE_ModeInfo_74_332, &STATE_VARIABLE_ModeInfo_76_334);
                      check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_282, STATE_VARIABLE_ModeInfo_76_334, &STATE_VARIABLE_ModeInfo_77_335);
                      check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) ((MR_Unsigned) 8U), NonLocals_281, STATE_VARIABLE_ModeInfo_77_335, &STATE_VARIABLE_ModeInfo_79_337);
                      check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap0_280, STATE_VARIABLE_ModeInfo_79_337, &STATE_VARIABLE_ModeInfo_80_338);
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "trace scope", STATE_VARIABLE_ModeInfo_80_338, STATE_VARIABLE_ModeInfo_59);
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                        *GoalExpr_8 = base;
                        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Reason0_43));
                        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubGoal_282));
                      }
                    }
                    break;
                }
        ...
        case (MR_Integer) 6:
          {
            ...
            CondInfo0_195 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_39, (MR_Integer) 1))));
            ...
            check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap0_191, STATE_VARIABLE_ModeInfo_51_220, &STATE_VARIABLE_ModeInfo_52_221);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_224, 0) = ((MR_Box) (Else_202));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_222, 0) = ((MR_Box) (Then_200));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_226, 0) = ((MR_Box) (InstMapElse_203));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_223, 0) = ((MR_Box) (InstMapThen_201));
            ...
            hlds__instmap__instmap_merge_5_p_0(NonLocals_187, ArmInstMaps_204, (MR_Integer) 1, STATE_VARIABLE_ModeInfo_52_221, &STATE_VARIABLE_ModeInfo_60_229);
            {
              ...
              *GoalExpr_8 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Cond_198));
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Then_200));
              MR_hl_field(MR_mktag(3), base, 4) = ((MR_Box) (Else_202));
            }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word STATE_VARIABLE_ModeInfo_48_368;
                  ...
                  {
                    check_hlds__unique_modes__unique_modes_check_goal_4_p_0(MainGoal0_49, &MainGoal_345, STATE_VARIABLE_ModeInfo_38_359, &STATE_VARIABLE_ModeInfo_48_368);
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      MR_Word STATE_VARIABLE_ModeInfo_40_361;
                      MR_Word STATE_VARIABLE_ModeInfo_41_362;

                      check_hlds__mode_info__mode_info_add_live_vars_3_p_0(NonLocals_349, STATE_VARIABLE_ModeInfo_38_359, &STATE_VARIABLE_ModeInfo_40_361);
                      check_hlds__unique_modes__make_all_nondet_live_vars_mostly_uniq_2_p_0(STATE_VARIABLE_ModeInfo_40_361, &STATE_VARIABLE_ModeInfo_41_362);
                      check_hlds__mode_info__mode_info_remove_live_vars_3_p_0(NonLocals_349, STATE_VARIABLE_ModeInfo_41_362, &STATE_VARIABLE_ModeInfo_42_363);
                    }
                    else
                      STATE_VARIABLE_ModeInfo_42_363 = STATE_VARIABLE_ModeInfo_38_359;
                    {
                      Goals0_352 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Goals0_352, 0) = ((MR_Box) (MainGoal0_49));
                      MR_hl_field(MR_mktag(1), Goals0_352, 1) = ((MR_Box) (OrElseGoals0_50));
                    }
                    check_hlds__unique_modes__unique_modes_check_disj_7_p_0(Goals0_352, Determinism_350, NonLocals_349, &Goals_353, &InstMaps_354, STATE_VARIABLE_ModeInfo_42_363, &STATE_VARIABLE_ModeInfo_43_364);
                    ...
                    {
                      MainGoal_345 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_353, (MR_Integer) 0))));
                      OrElseGoals_346 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_353, (MR_Integer) 1))));
                    }
                    hlds__instmap__make_arm_instmaps_for_goals_3_p_0(Goals_353, InstMaps_354, &ArmInstMaps_355);
                    hlds__instmap__instmap_merge_5_p_0(NonLocals_349, ArmInstMaps_355, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_43_364, &STATE_VARIABLE_ModeInfo_48_368);
                  }
                  {
                    ShortHand_356 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 0) = (MR_Box) ((MR_Unsigned) (GoalType_45));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 1) = ((MR_Box) (Outer_46));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 2) = ((MR_Box) (Inner_47));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 3) = ((MR_Box) (MaybeOutputVars_48));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 4) = ((MR_Box) (MainGoal_345));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 5) = ((MR_Box) (OrElseGoals_346));
                    MR_hl_field(MR_mktag(1), ShortHand_356, 6) = ((MR_Box) (OrElseInners0_51));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *GoalExpr_8 = base;
                    ...
                    MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (ShortHand_356));
                  }
                  check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "atomic_goal", STATE_VARIABLE_ModeInfo_48_368, STATE_VARIABLE_ModeInfo_59);
                }
                break;
              case (MR_Integer) 2:
                {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_38)
{
  ...
  MR_Word InitialInsts_54;
  MR_Word InstVarSub_55;
  MR_Word FinalInsts0_56;
  MR_Word FinalInsts_57;
  MR_Word NewArgVars_58;
  MR_Word ExtraGoals_59;
  MR_Word STATE_VARIABLE_ModeInfo_25_62;
  MR_Word STATE_VARIABLE_ModeInfo_26_63;
  ...
  check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_40_40, &ModuleInfo_53);
  check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_53, ProcArgModes0_20, &InitialInsts_54);
  check_hlds__modecheck_util__modecheck_var_has_inst_list_no_exact_match_6_p_0(ArgVars_10, InitialInsts_54, ArgOffset_19, &InstVarSub_55, STATE_VARIABLE_ModeInfo_40_40, &STATE_VARIABLE_ModeInfo_25_62);
  check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_53, ProcArgModes0_20, &FinalInsts0_56);
  parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_55, FinalInsts0_56, &FinalInsts_57);
  check_hlds__modecheck_util__modecheck_set_var_inst_list_8_p_0(ArgVars_10, InitialInsts_54, FinalInsts_57, ArgOffset_19, &NewArgVars_58, &ExtraGoals_59, STATE_VARIABLE_ModeInfo_25_62, &STATE_VARIABLE_ModeInfo_26_63);
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__unique_modes_scalar_common_1[1]), ((MR_Box) (NewArgVars_58)), ((MR_Box) (ArgVars_10)));
  if (succeeded)
    succeeded = (ExtraGoals_59 == (MR_Word) ((MR_Unsigned) 0U));
  if (!(succeeded))
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.unique_modes.unique_modes_check_call_modes\'/7", (MR_String) "call to implied mode\?");
      return;
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__prog_data__determinism_components_3_p_0(InterfaceDeterminism_21, &Var_61, &Var_67);
        succeeded = ((MR_Integer) 3 == Var_67);
        if (succeeded)
        {
          MR_Word FullInstMap0_69;

          check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_26_63, &FullInstMap0_69);
          succeeded = hlds__instmap__instmap_is_reachable_1_p_0(FullInstMap0_69);
          if (succeeded)
          {
            MR_Word AllVars_70;
            MR_Word NondetLiveVars_71;

            hlds__instmap__instmap_vars_list_2_p_0(FullInstMap0_69, &AllVars_70);
            check_hlds__unique_modes__select_nondet_live_vars_3_p_0(AllVars_70, STATE_VARIABLE_ModeInfo_26_63, &NondetLiveVars_71);
            check_hlds__unique_modes__make_var_list_mostly_uniq_3_p_0(NondetLiveVars_71, STATE_VARIABLE_ModeInfo_26_63, &STATE_VARIABLE_ModeInfo_41_41);
          }
          else
            STATE_VARIABLE_ModeInfo_41_41 = STATE_VARIABLE_ModeInfo_26_63;
        }
        else
          STATE_VARIABLE_ModeInfo_41_41 = STATE_VARIABLE_ModeInfo_26_63;
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__instmap__init_unreachable_1_p_0(&InstMap_60);
        check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_60, STATE_VARIABLE_ModeInfo_26_63, &STATE_VARIABLE_ModeInfo_41_41);
      }
      break;
  }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          switch (MR_tag((MR_Word) Inst1_17)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Var_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst1_17, (MR_Integer) 0))) & (MR_Integer) 7);

                succeeded = (Var_25 == (MR_Integer) 1);
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst1_17, (MR_Integer) 0))))) {
                default:
                  succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
                  {
                    MR_Word Var_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_17, (MR_Integer) 1))) & (MR_Integer) 7);
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_17, (MR_Integer) 1))) & (MR_Integer) 7);
