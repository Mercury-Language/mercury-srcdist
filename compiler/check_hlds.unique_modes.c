...
check_hlds__unique_modes__unique_modes_check_goal_scope_6_p_0(
  ...
  MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_0_43,
  MR_Word * check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_44);
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__unique_modes__Reason_7)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_47_47;
          MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_48_48;
          MR_Word check_hlds__unique_modes__SubGoal_99;

          {
            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_0_43, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_47_47);
          }
          {
            check_hlds__unique_modes__unique_modes_check_goal_4_p_0(check_hlds__unique_modes__SubGoal0_8, &check_hlds__unique_modes__SubGoal_99, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_47_47, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_48_48);
          }
          {
            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_48_48, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_44);
          }
          {
            MR_Word base;
            ...
            *check_hlds__unique_modes__GoalExpr_10 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (check_hlds__unique_modes__SubGoal_99));
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 6:
            {
              ...
              switch (check_hlds__unique_modes__FGT_21) {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64;
                    MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_67_67;

                    {
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "from_ground_term_construct scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_0_43, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64);
                    }
                    {
                      check_hlds__mode_info__mode_info_var_is_live_3_p_0(check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64, check_hlds__unique_modes__TermVar_20, &check_hlds__unique_modes__LiveTermVar_22);
                    }
                      ...
                      case (MR_Integer) 1:
                        {
                          *check_hlds__unique_modes__GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__unique_modes_scalar_common_3[1]);
                          check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_67_67 = check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64;
                        }
                        break;
                      case (MR_Integer) 0:
                        {
                          ...
                          if (check_hlds__unique_modes__succeeded)
                            {
                              MR_Word check_hlds__unique_modes__InstMap_27;
                              MR_Word check_hlds__unique_modes__InstMap0_86;

                              {
                                check_hlds__mode_info__mode_info_get_instmap_2_p_0(check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64, &check_hlds__unique_modes__InstMap0_86);
                              }
                              {
                                hlds__instmap__instmap_set_var_4_p_0(check_hlds__unique_modes__TermVar_20, check_hlds__unique_modes__TermVarInst_26, check_hlds__unique_modes__InstMap0_86, &check_hlds__unique_modes__InstMap_27);
                              }
                              {
                                check_hlds__mode_info__mode_info_set_instmap_3_p_0(check_hlds__unique_modes__InstMap_27, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_64_64, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_67_67);
                              }
                            }
                          else
                            {
                    ...
                    {
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "from_ground_term_construct scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_67_67, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_44);
                    }
                  }
                  break;
                case (MR_Integer) 2:
                case (MR_Integer) 3:
                  {
                    MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_57_57;
                    MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_58_58;
                    MR_Word check_hlds__unique_modes__SubGoal_94;

                    {
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_0_43, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_57_57);
                    }
                    {
                      check_hlds__unique_modes__unique_modes_check_goal_4_p_0(check_hlds__unique_modes__SubGoal0_8, &check_hlds__unique_modes__SubGoal_94, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_57_57, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_58_58);
                    }
                    {
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_58_58, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_44);
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      *check_hlds__unique_modes__GoalExpr_10 = base;
                      MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (check_hlds__unique_modes__Reason_7));
                      MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (check_hlds__unique_modes__SubGoal_94));
                    }
                  }
                  break;
                case (MR_Integer) 0:
          ...
          case (MR_Integer) 7:
            {
              ...
              MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_81_81;
              MR_Word check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_82_82;

              {
                check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "trace scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_0_43, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_76_76);
              }
              {
                check_hlds__mode_info__mode_info_get_instmap_2_p_0(check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_76_76, &check_hlds__unique_modes__InstMap0_17);
              }
              {
              ...
              {
                check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), check_hlds__unique_modes__NonLocals_18, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_76_76, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_78_78);
              }
              {
                check_hlds__unique_modes__unique_modes_check_goal_4_p_0(check_hlds__unique_modes__SubGoal0_8, &check_hlds__unique_modes__SubGoal_19, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_78_78, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_79_79);
              }
              {
                check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), check_hlds__unique_modes__NonLocals_18, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_79_79, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_81_81);
              }
              {
                check_hlds__mode_info__mode_info_set_instmap_3_p_0(check_hlds__unique_modes__InstMap0_17, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_81_81, &check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_82_82);
              }
              {
                check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "trace scope", check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_82_82, check_hlds__unique_modes__STATE_VARIABLE_ModeInfo_44);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
