  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__633__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_22);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_7)
{
  ...
  else
  {
    ...
    check_hlds__unique_modes__prepare_for_disjunct_5_p_0(Goal0_15, DisjDetism_1, DisjNonLocals_2, STATE_VARIABLE_ModeInfo_0_6, &STATE_VARIABLE_ModeInfo_25_25);
    ...
    check_hlds__unique_modes__unique_modes_check_disj_7_p_0(DisjDetism_1, DisjNonLocals_2, Goals0_16, &Goals_18, &InstMaps_20, STATE_VARIABLE_ModeInfo_27_27, STATE_VARIABLE_ModeInfo_7);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__4_4 = base;
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Integer ProcId_263;
        MR_Word STATE_VARIABLE_ModeInfo_21_266;
        MR_Word Var_267;
        MR_Word STATE_VARIABLE_ModeInfo_23_268;
        MR_Word Var_269;
        MR_Word STATE_VARIABLE_ModeInfo_25_270;
        MR_Word STATE_VARIABLE_ModeInfo_26_271;

        check_hlds__mode_debug__mode_checkpoint_sn_5_p_0((MR_Integer) 0, (MR_String) "call", PredSymName_262, STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_21_266);
        {
          Var_269 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_269, 0) = ((MR_Box) (PredId_257));
        }
        {
          Var_267 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_267, 0) = ((MR_Box) (Var_269));
        }
        check_hlds__mode_info__mode_info_set_call_context_3_p_0(Var_267, STATE_VARIABLE_ModeInfo_21_266, &STATE_VARIABLE_ModeInfo_23_268);
        check_hlds__unique_modes__unique_modes_check_call_7_p_0(PredId_257, ProcId0_258, ArgVars_259, GoalInfo0_7, &ProcId_263, STATE_VARIABLE_ModeInfo_23_268, &STATE_VARIABLE_ModeInfo_25_270);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          *GoalExpr_8 = base;
          MR_hl_field(2, base, 0) = ((MR_Box) (PredId_257));
          MR_hl_field(2, base, 1) = ((MR_Box) (ProcId_263));
        ...
        check_hlds__mode_info__mode_info_unset_call_context_2_p_0(STATE_VARIABLE_ModeInfo_25_270, &STATE_VARIABLE_ModeInfo_26_271);
        check_hlds__mode_debug__mode_checkpoint_sn_5_p_0((MR_Integer) 1, (MR_String) "call", PredSymName_262, STATE_VARIABLE_ModeInfo_26_271, STATE_VARIABLE_ModeInfo_59);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 3:
          {
            ...
            else
            {
              ...
              check_hlds__unique_modes__unique_modes_check_disj_7_p_0(Determinism_120, NonLocals_119, Goals0_80, &Goals_115, &InstMaps_122, STATE_VARIABLE_ModeInfo_28_131, &STATE_VARIABLE_ModeInfo_29_132);
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (MR_tag((MR_Word) Reason0_43)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word STATE_VARIABLE_ModeInfo_80_337;
                  MR_Word STATE_VARIABLE_ModeInfo_81_338;
                  MR_Word SubGoal_344;

                  check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_80_337);
                  check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_344, STATE_VARIABLE_ModeInfo_80_337, &STATE_VARIABLE_ModeInfo_81_338);
                  check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", STATE_VARIABLE_ModeInfo_81_338, STATE_VARIABLE_ModeInfo_59);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    *GoalExpr_8 = base;
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, Reason0_43, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 6:
                    {
                      MR_Word TermVar_282 = ((MR_Word) ((MR_hl_field(3, Reason0_43, (MR_Integer) 1))));
                      MR_Word FGT_283 = ((MR_Unsigned) ((MR_hl_field(3, Reason0_43, (MR_Integer) 2))) & (MR_Integer) 3);

                      switch (FGT_283) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          {
                            MR_Word LiveTermVar_284;
                            MR_Word STATE_VARIABLE_ModeInfo_60_319;
                            MR_Word STATE_VARIABLE_ModeInfo_61_320;

                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "from_ground_term_construct scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_60_319);
                            check_hlds__mode_info__mode_info_var_is_live_3_p_0(STATE_VARIABLE_ModeInfo_60_319, TermVar_282, &LiveTermVar_284);
                            switch (LiveTermVar_284) {
                              default: /*NOTREACHED*/ MR_assert(0);
                              case (MR_Integer) 1:
                                {
                                  *GoalExpr_8 = (MR_Word) (MR_mkword(3, &check_hlds__unique_modes_scalar_common_2[1]));
                                  STATE_VARIABLE_ModeInfo_61_320 = STATE_VARIABLE_ModeInfo_60_319;
                                }
                                break;
                              case (MR_Integer) 0:
                                {
                                  MR_Word SubGoalInfo_286 = ((MR_Word) ((MR_hl_field(0, SubGoal0_81, (MR_Integer) 1))));
                                  MR_Word InstMapDelta_287;
                                  MR_Word TermVarInst_288;

                                  InstMapDelta_287 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(SubGoalInfo_286);
                                  succeeded = hlds__instmap__instmap_delta_search_var_3_p_0(InstMapDelta_287, TermVar_282, &TermVarInst_288);
                                  if (succeeded)
                                  {
                                    MR_Word InstMap_289;
                                    MR_Word InstMap0_341;

                                    check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_60_319, &InstMap0_341);
                                    hlds__instmap__instmap_set_var_4_p_0(TermVar_282, TermVarInst_288, InstMap0_341, &InstMap_289);
                                    check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_289, STATE_VARIABLE_ModeInfo_60_319, &STATE_VARIABLE_ModeInfo_61_320);
                                  }
                                  else
                                    {
                            ...
                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "from_ground_term_construct scope", STATE_VARIABLE_ModeInfo_61_320, STATE_VARIABLE_ModeInfo_59);
                          }
                          break;
                        case (MR_Integer) 2:
                        case (MR_Integer) 3:
                          {
                            MR_Word STATE_VARIABLE_ModeInfo_71_329;
                            MR_Word STATE_VARIABLE_ModeInfo_72_330;
                            MR_Word SubGoal_343;

                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_71_329);
                            check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_343, STATE_VARIABLE_ModeInfo_71_329, &STATE_VARIABLE_ModeInfo_72_330);
                            check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "scope", STATE_VARIABLE_ModeInfo_72_330, STATE_VARIABLE_ModeInfo_59);
                            {
                              MR_Word base;
                              base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                              *GoalExpr_8 = base;
                  ...
                  case (MR_Integer) 7:
                    {
                      MR_Word InstMap0_279;
                      MR_Word NonLocals_280;
                      MR_Word SubGoal_281;
                      MR_Word STATE_VARIABLE_ModeInfo_48_308;
                      MR_Word STATE_VARIABLE_ModeInfo_50_310;
                      MR_Word STATE_VARIABLE_ModeInfo_51_311;
                      MR_Word STATE_VARIABLE_ModeInfo_53_313;
                      MR_Word STATE_VARIABLE_ModeInfo_54_314;

                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "trace scope", STATE_VARIABLE_ModeInfo_0_58, &STATE_VARIABLE_ModeInfo_48_308);
                      check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_48_308, &InstMap0_279);
                      NonLocals_280 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_7);
                      check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) ((MR_Unsigned) 8U), NonLocals_280, STATE_VARIABLE_ModeInfo_48_308, &STATE_VARIABLE_ModeInfo_50_310);
                      check_hlds__unique_modes__unique_modes_check_goal_4_p_0(SubGoal0_81, &SubGoal_281, STATE_VARIABLE_ModeInfo_50_310, &STATE_VARIABLE_ModeInfo_51_311);
                      check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) ((MR_Unsigned) 8U), NonLocals_280, STATE_VARIABLE_ModeInfo_51_311, &STATE_VARIABLE_ModeInfo_53_313);
                      check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap0_279, STATE_VARIABLE_ModeInfo_53_313, &STATE_VARIABLE_ModeInfo_54_314);
                      check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "trace scope", STATE_VARIABLE_ModeInfo_54_314, STATE_VARIABLE_ModeInfo_59);
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                        *GoalExpr_8 = base;
                        MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                        MR_hl_field(3, base, 1) = ((MR_Box) (Reason0_43));
                        MR_hl_field(3, base, 2) = ((MR_Box) (SubGoal_281));
                      }
                    }
                    break;
                }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    check_hlds__unique_modes__unique_modes_check_disj_7_p_0(Determinism_350, NonLocals_349, Goals0_352, &Goals_353, &InstMaps_354, STATE_VARIABLE_ModeInfo_43_364, &STATE_VARIABLE_ModeInfo_44_365);
