...
check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__944__1_2_p_0(
...
{
  {
    ...
    succeeded = check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__944__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_21);
    if (succeeded)
    {
          ...
          case (MR_Integer) 1:
            {
              ...
              ArgVars_97 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&check_hlds__unique_modes_scalar_common_1[0]), (MR_Word) (&check_hlds__unique_modes_scalar_common_2[2]), Args0_26);
