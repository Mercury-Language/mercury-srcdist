...
MR_decl_label3(check_hlds__unique_modes__unique_modes_check_proc_7_0, 2,6,3)
...
MR_BEGIN_MODULE(check_hlds__unique_modes_module1)
	...
	MR_init_label3(check_hlds__unique_modes__unique_modes_check_proc_7_0,2,6,3)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__unique_modes__unique_modes_check_proc_7_0,2)
	...
	if (MR_INT_EQ(MR_r2,0)) {
		MR_GOTO_LAB(check_hlds__unique_modes__unique_modes_check_proc_7_0_i3);
	}
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(io__set_exit_status_3_0,
		check_hlds__unique_modes__unique_modes_check_proc_7_0_i6);
MR_def_label(check_hlds__unique_modes__unique_modes_check_proc_7_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(2);
