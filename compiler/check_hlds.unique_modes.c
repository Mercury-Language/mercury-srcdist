  ...
  MR_Word * STATE_VARIABLE_ModeInfo_35)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "atomic_goal", GoalInfo0_19, STATE_VARIABLE_ModeInfo_0_34, &STATE_VARIABLE_ModeInfo_38_38);
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "atomic_goal", GoalInfo0_19, STATE_VARIABLE_ModeInfo_39_39, STATE_VARIABLE_ModeInfo_35);
}
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_0_44, &STATE_VARIABLE_ModeInfo_80_80);
        ...
        check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_81_81, STATE_VARIABLE_ModeInfo_45);
        {
          MR_Word base;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "fgt_construct scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_0_44, &STATE_VARIABLE_ModeInfo_60_60);
                  ...
                  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "fgt_construct scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_61_61, STATE_VARIABLE_ModeInfo_45);
                }
                break;
              case (MR_Integer) 2:
              case (MR_Integer) 3:
                {
                  ...
                  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "fgt_non_construct scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_0_44, &STATE_VARIABLE_ModeInfo_71_71);
                  ...
                  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "fgt_non_construct scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_72_72, STATE_VARIABLE_ModeInfo_45);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    *GoalExpr_10 = base;
        ...
        case (MR_Integer) 7:
          {
            ...
            check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "trace scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_0_44, &STATE_VARIABLE_ModeInfo_48_48);
            ...
            check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "trace scope", GoalInfo0_9, STATE_VARIABLE_ModeInfo_54_54, STATE_VARIABLE_ModeInfo_45);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              *GoalExpr_10 = base;
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_17)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "not", GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_16, &STATE_VARIABLE_ModeInfo_20_20);
  ...
  *GoalExpr_8 = (MR_Word) ((MR_Word) (SubGoal_15));
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "not", GoalInfo0_7, STATE_VARIABLE_ModeInfo_30_30, STATE_VARIABLE_ModeInfo_17);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_35)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "if-then-else", GoalInfo0_13, STATE_VARIABLE_ModeInfo_0_34, &STATE_VARIABLE_ModeInfo_38_38);
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "if-then-else", GoalInfo0_13, STATE_VARIABLE_ModeInfo_60_60, STATE_VARIABLE_ModeInfo_35);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_6)
{
  ...
  else
  {
    ...
    check_hlds__modecheck_util__modecheck_record_functors_test_5_p_0(HeadVar__2_2, MainConsId_19, OtherConsIds_20, STATE_VARIABLE_ModeInfo_0_5, &STATE_VARIABLE_ModeInfo_28_28);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_22)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "switch", GoalInfo0_11, STATE_VARIABLE_ModeInfo_0_21, &STATE_VARIABLE_ModeInfo_25_25);
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "switch", GoalInfo0_11, STATE_VARIABLE_ModeInfo_26_26, STATE_VARIABLE_ModeInfo_22);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "disj", GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_19, &STATE_VARIABLE_ModeInfo_23_23);
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "disj", GoalInfo0_7, STATE_VARIABLE_ModeInfo_24_24, STATE_VARIABLE_ModeInfo_20);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_16)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "conj", GoalInfo0_9, STATE_VARIABLE_ModeInfo_0_15, &STATE_VARIABLE_ModeInfo_19_19);
  if ((Goals0_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    Goals_12 = (MR_Word) ((MR_Unsigned) 0U);
    STATE_VARIABLE_ModeInfo_21_21 = STATE_VARIABLE_ModeInfo_19_19;
  }
  else
  {
    MR_Word STATE_VARIABLE_ModeInfo_20_20;

    check_hlds__modecheck_util__mode_info_add_goals_live_vars_4_p_0(ConjType_7, Goals0_8, STATE_VARIABLE_ModeInfo_19_19, &STATE_VARIABLE_ModeInfo_20_20);
    check_hlds__unique_modes__unique_modes_flatten_and_check_conj_5_p_0(ConjType_7, Goals0_8, &Goals_12, STATE_VARIABLE_ModeInfo_20_20, &STATE_VARIABLE_ModeInfo_21_21);
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "conj", GoalInfo0_9, STATE_VARIABLE_ModeInfo_21_21, STATE_VARIABLE_ModeInfo_16);
}
    ...
    switch (MR_tag((MR_Word) GoalExpr0_8)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr0_8, 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            check_hlds__unique_modes__unique_modes_check_goal_generic_call_5_p_0(GoalExpr0_8, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_26_26, &STATE_VARIABLE_ModeInfo_27_27);
            break;
          case (MR_Integer) 1:
            check_hlds__unique_modes__unique_modes_check_goal_foreign_call_5_p_0(GoalExpr0_8, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_26_26, &STATE_VARIABLE_ModeInfo_27_27);
            break;
          case (MR_Integer) 2:
            {
              ...
              check_hlds__unique_modes__unique_modes_check_goal_conj_6_p_0(GoalType0_56, Goals0_57, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_26_26, &STATE_VARIABLE_ModeInfo_27_27);
            }
            break;
          case (MR_Integer) 3:
            {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "try", GoalInfo0_9, STATE_VARIABLE_ModeInfo_26_26, &STATE_VARIABLE_ModeInfo_73_83);
                    ...
                    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "try", GoalInfo0_9, STATE_VARIABLE_ModeInfo_74_84, &STATE_VARIABLE_ModeInfo_27_27);
                  }
                  break;
              }
            }
    ...
    switch (MR_tag((MR_Word) GoalExpr0_8)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr0_8, 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            check_hlds__unique_modes__unique_modes_check_goal_generic_call_5_p_0(GoalExpr0_8, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_23_23, &STATE_VARIABLE_ModeInfo_28_28);
            break;
          case (MR_Integer) 1:
            check_hlds__unique_modes__unique_modes_check_goal_foreign_call_5_p_0(GoalExpr0_8, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_23_23, &STATE_VARIABLE_ModeInfo_28_28);
            break;
          case (MR_Integer) 2:
            {
              ...
              check_hlds__unique_modes__unique_modes_check_goal_conj_6_p_0(GoalType0_115, Goals0_116, GoalInfo0_9, &GoalExpr_16, STATE_VARIABLE_ModeInfo_23_23, &STATE_VARIABLE_ModeInfo_28_28);
            }
            break;
          case (MR_Integer) 3:
            {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "try", GoalInfo0_9, STATE_VARIABLE_ModeInfo_23_23, &STATE_VARIABLE_ModeInfo_73_142);
                    ...
                    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "try", GoalInfo0_9, STATE_VARIABLE_ModeInfo_74_143, &STATE_VARIABLE_ModeInfo_28_28);
                  }
                  break;
              }
            }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_31)
{
  ...
  MR_Word STATE_VARIABLE_ModeInfo_28_54;
  MR_Word STATE_VARIABLE_ModeInfo_29_55;
  MR_Word _BadInstVars_47;
  MR_Word Var_43;
  MR_Word Var_16;

  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "generic_call", GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_30, &STATE_VARIABLE_ModeInfo_34_34);
  {
  ...
  check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_36_36, &ModuleInfo_44);
  check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_44, ArgModes_12, &InitialInsts_45);
  check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_8_p_0(Var_38, ArgOffset_23, ArgVars_11, InitialInsts_45, &InstVarSub_46, &_BadInstVars_47, STATE_VARIABLE_ModeInfo_36_36, &STATE_VARIABLE_ModeInfo_28_54);
  check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_44, ArgModes_12, &FinalInsts0_48);
  parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_46, FinalInsts0_48, &FinalInsts_49);
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgOffset_23, ArgVars_11, InitialInsts_45, FinalInsts_49, &NewArgVars_50, &ExtraGoals_51, STATE_VARIABLE_ModeInfo_28_54, &STATE_VARIABLE_ModeInfo_29_55);
  ...
  if (succeeded)
  {
    ...
    check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_52, STATE_VARIABLE_ModeInfo_29_55, &STATE_VARIABLE_ModeInfo_39_39);
  }
  else
  {
    MR_Word Var_59;
    ...
    if (succeeded)
    {
      ...
      check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_29_55, &FullInstMap0_61);
      ...
      if (succeeded)
      {
        ...
        check_hlds__unique_modes__select_nondet_live_vars_3_p_0(AllVars_62, STATE_VARIABLE_ModeInfo_29_55, &NondetLiveVars_63);
        check_hlds__unique_modes__make_vars_mostly_uniq_3_p_0(NondetLiveVars_63, STATE_VARIABLE_ModeInfo_29_55, &STATE_VARIABLE_ModeInfo_39_39);
      }
      else
        STATE_VARIABLE_ModeInfo_39_39 = STATE_VARIABLE_ModeInfo_29_55;
    }
    else
      STATE_VARIABLE_ModeInfo_39_39 = STATE_VARIABLE_ModeInfo_29_55;
  }
  *GoalExpr_8 = GoalExpr0_6;
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "generic_call", GoalInfo0_7, STATE_VARIABLE_ModeInfo_40_40, STATE_VARIABLE_ModeInfo_31);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "foreign_proc", GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_19, &STATE_VARIABLE_ModeInfo_23_23);
  {
  ...
  check_hlds__unique_modes__unique_modes_check_plain_or_foreign_call_7_p_0(PredId_11, ProcId0_12, ArgVars_17, GoalInfo0_7, &ProcId_18, STATE_VARIABLE_ModeInfo_25_25, &STATE_VARIABLE_ModeInfo_28_28);
  {
    MR_Word base;
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "foreign_proc", GoalInfo0_7, STATE_VARIABLE_ModeInfo_29_29, STATE_VARIABLE_ModeInfo_20);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_18)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_sn_6_p_0((MR_Integer) 0, (MR_String) "call", PredSymName_15, GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_17, &STATE_VARIABLE_ModeInfo_21_21);
  {
  ...
  check_hlds__unique_modes__unique_modes_check_plain_or_foreign_call_7_p_0(PredId_10, ProcId0_11, ArgVars_12, GoalInfo0_7, &ProcId_16, STATE_VARIABLE_ModeInfo_23_23, &STATE_VARIABLE_ModeInfo_25_25);
  {
    MR_Word base;
  ...
  check_hlds__mode_debug__mode_checkpoint_sn_6_p_0((MR_Integer) 1, (MR_String) "call", PredSymName_15, GoalInfo0_7, STATE_VARIABLE_ModeInfo_26_26, STATE_VARIABLE_ModeInfo_18);
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_39)
{
  ...
  MR_Word STATE_VARIABLE_ModeInfo_29_66;
  ...
  check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModeInfo_0_38, &STATE_VARIABLE_ModeInfo_41_41);
  check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_41_41, &ModuleInfo_16);
  ...
  check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_41_41, &ModuleInfo_55);
  check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_55, ProcArgModes0_20, &InitialInsts_56);
  check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_8_p_0(Var_42, ArgOffset_19, ArgVars_10, InitialInsts_56, &InstVarSub_57, &_BadInstVars_58, STATE_VARIABLE_ModeInfo_41_41, &STATE_VARIABLE_ModeInfo_28_65);
  check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_55, ProcArgModes0_20, &FinalInsts0_59);
  parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_57, FinalInsts0_59, &FinalInsts_60);
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgOffset_19, ArgVars_10, InitialInsts_56, FinalInsts_60, &NewArgVars_61, &ExtraGoals_62, STATE_VARIABLE_ModeInfo_28_65, &STATE_VARIABLE_ModeInfo_29_66);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_29_66, &FullInstMap0_72);
          ...
          if (succeeded)
          {
            ...
            check_hlds__unique_modes__select_nondet_live_vars_3_p_0(AllVars_73, STATE_VARIABLE_ModeInfo_29_66, &NondetLiveVars_74);
            check_hlds__unique_modes__make_vars_mostly_uniq_3_p_0(NondetLiveVars_74, STATE_VARIABLE_ModeInfo_29_66, &STATE_VARIABLE_ModeInfo_43_43);
          }
          else
            STATE_VARIABLE_ModeInfo_43_43 = STATE_VARIABLE_ModeInfo_29_66;
        }
        else
          STATE_VARIABLE_ModeInfo_43_43 = STATE_VARIABLE_ModeInfo_29_66;
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap_63, STATE_VARIABLE_ModeInfo_29_66, &STATE_VARIABLE_ModeInfo_43_43);
      }
      break;
  }
  check_hlds__mode_info__look_up_proc_mode_errors_4_p_0(STATE_VARIABLE_ModeInfo_43_43, PredId_8, ProcId0_9, &CalleeModeErrors_23);
  if ((CalleeModeErrors_23 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_ModeInfo_44_44 = STATE_VARIABLE_ModeInfo_43_43;
  else
  {
    ...
    check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_43_43, &InstMap_27);
    ...
    check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_26, ModeError_29, STATE_VARIABLE_ModeInfo_43_43, &STATE_VARIABLE_ModeInfo_44_44);
  }
  check_hlds__mode_info__mode_info_get_errors_2_p_0(STATE_VARIABLE_ModeInfo_44_44, &Errors_30);
  ...
  check_hlds__mode_info__mode_info_get_may_change_called_proc_2_p_0(STATE_VARIABLE_ModeInfo_45_45, &MayChangeCalledProc_31);
  if ((Errors_30 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *ProcId_12 = ProcId0_9;
    *STATE_VARIABLE_ModeInfo_39 = STATE_VARIABLE_ModeInfo_45_45;
  }
  else
      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__modecheck_call__modecheck_plain_or_foreign_call_10_p_0(PredId_8, Var_48, ProcId0_9, ProcId_12, ArgVars_10, &NewArgVars_36, GoalInfo_11, &ExtraGoals_37, STATE_VARIABLE_ModeInfo_47_47, STATE_VARIABLE_ModeInfo_39);
      ...
      case (MR_Integer) 1:
        {
          ...
          *ProcId_12 = ProcId0_9;
          ...
          check_hlds__mode_info__mode_info_set_errors_3_p_0(AllErrors_34, STATE_VARIABLE_ModeInfo_45_45, STATE_VARIABLE_ModeInfo_39);
        }
        break;
    }
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_16)
{
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "unify", GoalInfo0_7, STATE_VARIABLE_ModeInfo_0_15, &STATE_VARIABLE_ModeInfo_19_19);
  {
  ...
  check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "unify", GoalInfo0_7, STATE_VARIABLE_ModeInfo_23_23, STATE_VARIABLE_ModeInfo_16);
}
