  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word InstMap_28;
        MR_Word STATE_VARIABLE_ModeInfo_17_29;
        MR_Word STATE_VARIABLE_ModeInfo_18_30;

        NonLocals_27 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(Goal0_11);
        check_hlds__mode_info__mode_info_remove_live_vars_3_p_0(NonLocals_27, STATE_VARIABLE_ModeInfo_0_4, &STATE_VARIABLE_ModeInfo_17_29);
        check_hlds__unique_modes__unique_modes_check_goal_4_p_0(Goal0_11, &Goal_25, STATE_VARIABLE_ModeInfo_17_29, &STATE_VARIABLE_ModeInfo_18_30);
        check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_18_30, &InstMap_28);
        succeeded = hlds__instmap__instmap_is_unreachable_1_p_0(InstMap_28);
        if (succeeded)
        {
          check_hlds__modecheck_util__mode_info_remove_goals_live_vars_3_p_0(Goals0_12, STATE_VARIABLE_ModeInfo_18_30, STATE_VARIABLE_ModeInfo_5);
          Goals_26 = (MR_Word) ((MR_Unsigned) 0U);
        }
        else
          check_hlds__unique_modes__unique_modes_check_conj_5_p_0(HeadVar__1_1, Goals0_12, &Goals_26, STATE_VARIABLE_ModeInfo_18_30, STATE_VARIABLE_ModeInfo_5);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo__25_29 = (MR_Word) (&check_hlds__unique_modes_scalar_common_1[0]);
        succeeded = mercury__list__member_2_p_0(TypeInfo__25_29, ((MR_Box) (Var_7)), Vars_15);
        if (succeeded)
        {
