      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), NonLocals_293, STATE_VARIABLE_ModeInfo_23_303, &STATE_VARIABLE_ModeInfo_25_305);
          ...
          check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), NonLocals_293, STATE_VARIABLE_ModeInfo_26_306, &STATE_VARIABLE_ModeInfo_28_308);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
                succeeded = (ExtraGoals_213 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              if (!(succeeded))
              {
                {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                Goals_122 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          case (MR_Integer) 3:
            {
              ...
              if ((Goals0_80 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                MR_Word InstMap_140;

                Goals_139 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          case (MR_Integer) 4:
            {
              ...
              if ((Cases0_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                Cases_482 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                ...
                                case (MR_Integer) 0:
                                  {
                                    ...
                                    MR_Word Var_360 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_81, (MR_Integer) 0)));
                    ...
                    case (MR_Integer) 7:
                      {
                        ...
                        check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), NonLocals_355, STATE_VARIABLE_ModeInfo_74_409, &STATE_VARIABLE_ModeInfo_76_411);
                        ...
                        check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), NonLocals_355, STATE_VARIABLE_ModeInfo_77_412, &STATE_VARIABLE_ModeInfo_79_414);
          ...
          case (MR_Integer) 6:
            {
              ...
              check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)), NonLocals_239, STATE_VARIABLE_ModeInfo_38_259, &STATE_VARIABLE_ModeInfo_40_261);
              ...
              Var_246 = ((MR_Word) (MR_hl_field(MR_mktag(0), Cond0_36, (MR_Integer) 0)));
              ...
              check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)), NonLocals_239, STATE_VARIABLE_ModeInfo_46_267, &STATE_VARIABLE_ModeInfo_48_269);
              ...
              check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap0_243, STATE_VARIABLE_ModeInfo_51_272, &STATE_VARIABLE_ModeInfo_52_273);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_276, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if ((OrElseGoals0_47 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      ...
                      OrElseGoals_446 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                    }
                    else
                    {
                      ...
                      if ((Goals_453 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      {
                        {
...
{
  {
    ...
    if (succeeded)
      succeeded = (ExtraGoals_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    if (!(succeeded))
    {
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.unique_modes.unique_modes_check_call_modes\'/7", (MR_String) "call to implied mode\?");
