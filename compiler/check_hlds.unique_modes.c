...
check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__551__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = check_hlds__unique_modes__IntroducedFrom__pred__unique_modes_check_par_conj_0__551__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_22);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_39)
{
  ...
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_18, &ProcArgModes0_20);
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(ProcInfo_18, &Determinism_35);
          {
