      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          switch (MR_tag((MR_Word) Inst1_17)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Var_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst1_17, (MR_Integer) 0))) & (MR_Integer) 7);
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst1_17, (MR_Integer) 0))))) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_17, (MR_Integer) 1))) & (MR_Integer) 7);
