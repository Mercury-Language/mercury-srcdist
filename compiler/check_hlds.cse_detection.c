  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  while (MR_TRUE)
  {
    ...
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_7, PredInfo1_16, STATE_VARIABLE_ModuleInfo_0_32, &STATE_VARIABLE_ModuleInfo_1_35);
    ...
    {
      MR_Word ProgressStream_76 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
    ...
    switch (Redo_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_ModuleInfo_33 = STATE_VARIABLE_ModuleInfo_1_35;
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_Word STATE_VARIABLE_ModuleInfo_3_65;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              ProgressStream_79 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
          }
          if (succeeded)
          {
            MR_String Var_44;

            Var_44 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_1_35, PredId_7);
          ...
          check_hlds__modes__modecheck_proc_8_p_0(PredId_7, ProcId_8, STATE_VARIABLE_ModuleInfo_1_35, &STATE_VARIABLE_ModuleInfo_2_46, ProcModeErrorMap0_20, &_ProcModeErrorMap_21, &_Changed_22, &ModeSpecs_23);
          if (!((MaybeProgressStream_6 == (MR_Word) ((MR_Unsigned) 0U))))
          {
            MR_Word ProgressStream_81 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
            ...
            case (MR_Integer) 1:
              {
                ...
                if (!((MaybeProgressStream_6 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  MR_Word ProgressStream_84 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
                  MR_Word _DumpInfo_25;

                  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_84, STATE_VARIABLE_ModuleInfo_2_46, (MR_Integer) 46, (MR_String) "cse_repeat_modecheck", (MR_Word) ((MR_Unsigned) 0U), &_DumpInfo_25);
                }
                hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_2_46, &DebugStream_26);
          ...
          if (succeeded)
          {
            succeeded = (MaybeProgressStream_6 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              ProgressStream_87 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
          }
          if (succeeded)
          {
            MR_String Var_63;

            Var_63 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_2_46, PredId_7);
          ...
          hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_2_46, PredId_7, &PredInfo2_27);
          hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo2_27, ProcId_8, &ProcInfo2_28);
          SwitchDetectInfo_29 = check_hlds__switch_detection__init_switch_detect_info_1_f_0(STATE_VARIABLE_ModuleInfo_2_46);
          ...
          hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_7, PredInfo3_31, STATE_VARIABLE_ModuleInfo_2_46, &STATE_VARIABLE_ModuleInfo_3_65);
          if (!((MaybeProgressStream_6 == (MR_Word) ((MR_Unsigned) 0U))))
          {
            MR_Word ProgressStream_89 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
          ...
          if (succeeded)
          {
            succeeded = (MaybeProgressStream_6 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              ProgressStream_92 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, 0))));
          }
          if (succeeded)
          {
            MR_String Var_73;

            Var_73 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_3_65, PredId_7);
          ...
          // direct tailcall eliminated
          ;
          next_value_of_STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_3_65;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          check_hlds__switch_detection__find_bind_var_9_p_0(TypeCtorInfo_42_135, TypeCtorInfo_43_136, Var_25, Var_131, Goal0_123, &Goal_125, ((MR_Box) (STATE_VARIABLE_CseState_1_109)), &conv9_CseState_76, ((MR_Box) (STATE_VARIABLE_CseInfo_1_110)), &conv8_STATE_VARIABLE_CseInfo_1_51, &Var_137);
