  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__cse_detection__Globals_8, (MR_Integer) 49, &check_hlds__cse_detection__VeryVerbose_9);
        }
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__cse_detection__Globals_8, (MR_Integer) 59, &check_hlds__cse_detection__Statistics_20);
        }
        {
