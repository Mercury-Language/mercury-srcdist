              ...
              if (check_hlds__cse_detection__succeeded)
                {
                  ...
                  {
                    hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 24, check_hlds__cse_detection__GoalInfo0_46, &check_hlds__cse_detection__GoalInfo1_73);
                  }
                  {
          ...
          case (MR_Integer) 5:
            {
              ...
              check_hlds__cse_detection__succeeded = ((((MR_tag((MR_Word) check_hlds__cse_detection__Reason0_56)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__cse_detection__Reason0_56, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (check_hlds__cse_detection__succeeded)
                {
              ...
              if (check_hlds__cse_detection__succeeded)
              ...
              else
                {
                  ...
                  check_hlds__cse_detection__succeeded = ((((MR_tag((MR_Word) check_hlds__cse_detection__Reason0_56)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__cse_detection__Reason0_56, (MR_Integer) 0)))) == (MR_Integer) 3)));
                  if (check_hlds__cse_detection__succeeded)
                    {
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__cse_detection__Globals_8, (MR_Integer) 55, &check_hlds__cse_detection__VeryVerbose_9);
        }
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__cse_detection__Globals_8, (MR_Integer) 65, &check_hlds__cse_detection__Statistics_20);
        }
        {
