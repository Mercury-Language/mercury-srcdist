  ...
  MR_Word * GoalExpr_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      ModuleInfo_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_0_8, (MR_Integer) 0))));
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(ModuleInfo_81, VarInst0_35);
      if (succeeded)
      {
        succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_p_0(ModuleInfo_81, VarInst0_35);
        if (succeeded)
        {
          Var_48 = (MR_Word) ((MR_Unsigned) 0U);
          {
            Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (Else0_5));
            MR_hl_field(MR_mktag(1), Var_47, 1) = ((MR_Box) (Var_48));
          }
          {
            Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (Then0_4));
            MR_hl_field(MR_mktag(1), Var_45, 1) = ((MR_Box) (Var_47));
          }
          succeeded = check_hlds__cse_detection__common_deconstruct_8_p_0(Var_45, Var_25, STATE_VARIABLE_CseInfo_0_8, &STATE_VARIABLE_CseInfo_46_46, &UnifyGoal_36, &FirstOldNew_37, &LaterOldNew_38, &Goals_39);
          if (succeeded)
          {
            succeeded = (Goals_39 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Then_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_39, (MR_Integer) 0))));
              Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_39, (MR_Integer) 1))));
              succeeded = (Var_49 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                Else_41 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_49, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = check_hlds__cse_detection__common_deconstruct_cases_2_7_p_0(Cases0_4, Var_21, Var_72, &Var_73, STATE_VARIABLE_CseInfo_0_7, &STATE_VARIABLE_CseInfo_38_38, &Cases_34);
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) Var_73)) == (MR_Integer) 1);
              if (succeeded)
              {
                UnifyGoal_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 0))));
                FirstOldNew_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 1))));
                LaterOldNew_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 2))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = check_hlds__cse_detection__common_deconstruct_2_7_p_0(Goals0_2, Var_17, Var_65, &Var_66, STATE_VARIABLE_CseInfo_0_5, &STATE_VARIABLE_CseInfo_31_31, &Goals_28);
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) Var_66)) == (MR_Integer) 1);
            if (succeeded)
            {
              UnifyGoal_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_66, (MR_Integer) 0))));
              FirstOldNew_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_66, (MR_Integer) 1))));
              LaterOldNew_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_66, (MR_Integer) 2))));
