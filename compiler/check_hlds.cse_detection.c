  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    MR_Word Var_73;
    MR_Word Var_74;
    MR_String OldName_43;
    MR_Word TypeCtorInfo_63_81;
    ...
    VarSet0_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 1))));
    VarTypes0_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 2))));
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_38, HeadOldArgVar_13, &Type_39);
    ModuleInfo_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 0))));
    TypeCat_41 = check_hlds__type_util__classify_type_2_f_0(ModuleInfo_40, Type_39);
    succeeded = ((((MR_tag((MR_Word) TypeCat_41)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeCat_41, (MR_Integer) 0)))) == (MR_Integer) 0)));
    if (succeeded)
    {
      TypeCtorInfo_63_81 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_63_81, VarSet0_37, HeadOldArgVar_13, &OldName_43);
    }
    if (succeeded)
      mercury__varset__new_named_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), OldName_43, &NewArgVar_44, VarSet0_37, &VarSet_45);
    else
      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewArgVar_44, VarSet0_37, &VarSet_45);
    parse_tree__vartypes__add_var_type_4_p_0(NewArgVar_44, Type_39, VarTypes0_38, &VarTypes_46);
    {
      Var_50 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (HeadOldArgVar_13));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (NewArgVar_44));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    MainCtxt_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyContext_3, (MR_Integer) 0))));
    SubCtxt_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyContext_3, (MR_Integer) 1))));
    {
      Var_51 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (NewArgVar_44));
    }
    hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(HeadOldArgVar_13, Var_51, Context_2, MainCtxt_47, SubCtxt_48, &HeadReplacementGoal_21);
    Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 0))));
    Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 3))));
    Var_73 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 4))) & (MR_Integer) 1);
    Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CseInfo_25_25, (MR_Integer) 5))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      *STATE_VARIABLE_CseInfo_5 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_69));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (VarSet_45));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (VarTypes_46));
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_37)
{
  ...
  check_hlds__cse_detection__detect_cse_in_goal_update_instmap_6_p_0(Goal0_8, &Goal1_15, CseInfo0_14, &CseInfo_16, InstMap0_9, &_InstMap_51);
  ...
  MR_Word * STATE_VARIABLE_CseInfo_21)
{
  ...
  parse_tree__vartypes__apply_variable_renaming_to_vartypes_3_p_0(Renaming_15, VarTypes0_12, &VarTypes_19);
