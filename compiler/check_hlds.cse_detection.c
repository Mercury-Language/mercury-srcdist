  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 63, &VeryVerbose_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 73, &Statistics_20);
