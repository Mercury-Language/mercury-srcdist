...
MR_decl_label10(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 6,7,3,11,10,149,17,19,148,22)
MR_decl_label10(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 24,21,27,26,64,30,33,29,39,40)
MR_decl_label9(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 42,38,45,44,48,36,51,53,54)
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module7)
	...
	MR_init_label10(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,6,7,3,11,10,149,17,19,148,22)
	MR_init_label10(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,24,21,27,26,64,30,33,29,39,40)
	MR_init_label9(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,42,38,45,44,48,36,51,53,54)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0)
	...
	MR_np_call_localret_ent(hlds__instmap__pre_lambda_update_5_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i6);
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__cse_detection__detect_cse_in_goal_6_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i7);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i10);
	}
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i148);
	}
	MR_r5 = MR_tfield(3, MR_r1, 1);
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i149);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(3,7,0);
	MR_r3 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,149)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i17);
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,148)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i21);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i22);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,26)
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i30);
	}
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,29)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i36);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(3, MR_r1, 1);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,39)
	...
	MR_np_call_localret_ent(check_hlds__cse_detection__detect_cse_in_independent_goals_6_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i40);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,38)
	...
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i44);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r5;
	...
	MR_np_call_localret_ent(check_hlds__cse_detection__detect_cse_in_goal_6_0,
		check_hlds__cse_detection__detect_cse_in_goal_expr_7_0_i45);
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
