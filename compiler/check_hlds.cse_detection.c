...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,3)
	...
	MR_sv(5) = ((MR_Integer) MR_tfield(2, MR_tempr1, 0) & (MR_Integer) 3);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,9)
	...
	MR_tfield(2, MR_tempr1, 0) = ((MR_Integer) MR_sv(5) | (((MR_Integer) MR_sv(6) << (MR_Integer) 2) | ((MR_Integer) MR_sv(7) << (MR_Integer) 3)));
