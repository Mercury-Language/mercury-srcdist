          ...
          case (MR_Integer) 1:
            {
              ...
              *STATE_VARIABLE_CseState_23 = (MR_Word) ((MR_Integer) 4);
          ...
          case (MR_Integer) 3:
            {
              ...
              if ((Goals0_155 == (MR_Word) ((MR_Integer) 0)))
              {
...
{
  {
    ...
    succeeded = check_hlds__cse_detection__common_deconstruct_2_7_p_0(Goals0_9, Var_10, (MR_Word) ((MR_Integer) 0), &Var_21, STATE_VARIABLE_CseInfo_0_18, STATE_VARIABLE_CseInfo_19, Goals_15);
    if (succeeded)
    {
