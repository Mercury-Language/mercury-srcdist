        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 27, GoalInfo0_11, &GoalInfo1_64);
            Context_65 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo1_64);
            check_hlds__cse_detection__create_new_arg_vars_7_p_0(ArgVars_46, Context_65, UnifyContext_44, STATE_VARIABLE_CseInfo_0_24, STATE_VARIABLE_CseInfo_25, &OldNewVars_16, Goals_12);
            mercury__map__from_assoc_list_2_p_0((MR_Word) (&check_hlds__cse_detection_scalar_common_1[1]), (MR_Word) (&check_hlds__cse_detection_scalar_common_1[1]), OldNewVars_16, &Subn_66);
            {
              Var_70 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_70, 0) = ((MR_Box) (GoalExpr1_54));
              MR_hl_field(0, Var_70, 1) = ((MR_Box) (GoalInfo1_64));
            }
            hlds__hlds_goal__rename_some_vars_in_goal_3_p_0(Subn_66, Var_70, &HoistedGoal_17);
            {
              MR_Word base;
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word OC_76;
        MR_Word HoistedFunctor_79;
        MR_Word HoistedVars_80;
        MR_Word HoistedUnifyInfo_75;
        MR_Word Var_98 = ((MR_Word) ((MR_hl_field(0, HoistedGoal_39, (MR_Integer) 0))));

        succeeded = ((MR_tag((MR_Word) Var_98)) == (MR_Integer) 1);
        if (succeeded)
        {
          HoistedUnifyInfo_75 = ((MR_Word) ((MR_hl_field(1, Var_98, (MR_Integer) 3))));
          OC_76 = ((MR_Word) ((MR_hl_field(1, Var_98, (MR_Integer) 4))));
          succeeded = ((MR_tag((MR_Word) HoistedUnifyInfo_75)) == (MR_Integer) 1);
          if (succeeded)
          {
            HoistedFunctor_79 = ((MR_Word) ((MR_hl_field(1, HoistedUnifyInfo_75, (MR_Integer) 1))));
            HoistedVars_80 = ((MR_Word) ((MR_hl_field(1, HoistedUnifyInfo_75, (MR_Integer) 2))));
          }
        }
        if (succeeded)
        {
          MR_Word TypeInfo_40_101;
          MR_Word OldUnification_87 = ((MR_Word) ((MR_hl_field(1, GoalExpr0_10, (MR_Integer) 3))));
          MR_Word OldFunctor_90 = ((MR_Word) ((MR_hl_field(1, OldUnification_87, (MR_Integer) 1))));
          MR_Word OldVars_91 = ((MR_Word) ((MR_hl_field(1, OldUnification_87, (MR_Integer) 2))));
          MR_Integer HoistedVarsCount_95;
          MR_Integer OldVarsCount_96;
          MR_Word Context_97;

          succeeded = parse_tree__prog_data____Unify____cons_id_0_0(HoistedFunctor_79, OldFunctor_90);
          if (succeeded)
          {
            TypeInfo_40_101 = (MR_Word) (&check_hlds__cse_detection_scalar_common_1[1]);
            mercury__list__length_2_p_0(TypeInfo_40_101, HoistedVars_80, &HoistedVarsCount_95);
            mercury__list__length_2_p_0(TypeInfo_40_101, OldVars_91, &OldVarsCount_96);
            succeeded = (HoistedVarsCount_95 == OldVarsCount_96);
            if (succeeded)
            {
              mercury__assoc_list__from_corresponding_lists_3_p_0(TypeInfo_40_101, TypeInfo_40_101, OldVars_91, HoistedVars_80, &OldNewVars_36);
              Context_97 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_11);
              check_hlds__cse_detection__pair_subterms_4_p_0(OldNewVars_36, Context_97, OC_76, &Goals0_20);
              succeeded = MR_TRUE;
            }
          }
        }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 74, &VeryVerbose_18);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 74, &VeryVerbose_11);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 84, &Statistics_17);
