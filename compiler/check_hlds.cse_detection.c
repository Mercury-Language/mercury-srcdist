  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_63_69 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_63_69, VarSet0_27, HeadOldArgVar_13, &OldName_33);
    }
    if (succeeded)
  ...
  MR_Word * GoalExpr_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtorInfo_43_124;
      MR_Word TypeCtorInfo_44_125;
      MR_Word CseState_79;
      MR_Word Goals0_91;
      MR_Word Goal_92;
      MR_Word Goals_93;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_43_124 = (MR_Word) (&check_hlds__cse_detection__check_hlds__cse_detection__type_ctor_info_cse_state_0);
          TypeCtorInfo_44_125 = (MR_Word) (&check_hlds__cse_detection__check_hlds__cse_detection__type_ctor_info_cse_info_0);
          check_hlds__switch_detection__find_bind_var_9_p_0(TypeCtorInfo_43_124, TypeCtorInfo_44_125, Var_25, Var_120, Goal0_112, &Goal_114, ((MR_Box) (STATE_VARIABLE_CseState_31_99)), &conv9_CseState_79, ((MR_Box) (STATE_VARIABLE_CseInfo_32_100)), &conv8_STATE_VARIABLE_CseInfo_51_51, &Var_126);
