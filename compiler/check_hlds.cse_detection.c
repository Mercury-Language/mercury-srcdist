  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes0_38, HeadOldArgVar_13, &Type_39);
    ...
    hlds__vartypes__add_var_type_4_p_0(NewArgVar_44, Type_39, VarTypes0_38, &VarTypes_46);
    {
