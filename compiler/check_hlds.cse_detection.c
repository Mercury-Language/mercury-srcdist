      ...
      case (MR_Integer) 1:
        {
          ...
          switch (VeryVerbose_9) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ModeSpecs_88;
                MR_Word ContainsErrors_90;
                MR_Word _Changed_79;
                ...
                mercury__io__write_string_3_p_0((MR_String) "\n");
                check_hlds__modes__modecheck_proc_6_p_0(ProcId_6, PredId_5, STATE_VARIABLE_ModuleInfo_42_42, &STATE_VARIABLE_ModuleInfo_52_52, &ModeSpecs_88, &_Changed_79);
                libs__file_util__maybe_report_stats_3_p_0(Statistics_20);
                ContainsErrors_90 = parse_tree__error_util__contains_errors_2_f_0(Globals_8, ModeSpecs_88);
                switch (ContainsErrors_90) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                    }
          ...
          hlds__hlds_module__module_info_set_preds_3_p_0(PredTable3_32, STATE_VARIABLE_ModuleInfo_52_52, &STATE_VARIABLE_ModuleInfo_63_63);
          libs__file_util__maybe_report_stats_3_p_0(Statistics_20);
          switch (VeryVerbose_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                ...
                hlds__hlds_out__hlds_out_util__write_pred_id_4_p_0(STATE_VARIABLE_ModuleInfo_63_63, PredId_5);
                mercury__io__write_string_3_p_0((MR_String) "\n");
              }
              break;
          }
          // direct tailcall eliminated
          ;
          next_value_of_STATE_VARIABLE_ModuleInfo_0_33 = STATE_VARIABLE_ModuleInfo_63_63;
