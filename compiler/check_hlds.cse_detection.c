...
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0, 53,2,3,5,6,7,8,9)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0, 10,15,16,17,14,19,20,21)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0, 22,23,24,25,26,27,28,29)
MR_decl_label5(check_hlds__cse_detection__detect_cse_in_proc_6_0, 30,13,32,54,12)
...
MR_decl_label4(__Unify___check_hlds__cse_detection__cse_info_0_0, 2,4,6,1)
MR_decl_label4(__Unify___check_hlds__cse_detection__cse_state_0_0, 43,7,9,1)
MR_decl_label4(__Compare___check_hlds__cse_detection__cse_info_0_0, 3,7,11,17)
MR_decl_label8(__Compare___check_hlds__cse_detection__cse_state_0_0, 32,5,4,36,17,73,19,23)
MR_decl_label1(__Compare___check_hlds__cse_detection__cse_state_0_0, 70)
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module16)
	...
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0,53,2,3,5,6,7,8,9)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0,10,15,16,17,14,19,20,21)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_6_0,22,23,24,25,26,27,28,29)
	MR_init_label5(check_hlds__cse_detection__detect_cse_in_proc_6_0,30,13,32,54,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury__check_hlds__cse_detection__detect_cse_in_proc_6_0);
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,20)
	...
	MR_r1 = (MR_Word) MR_string_const("\n", 1);
	MR_np_call_localret_ent(io__write_string_3_0,
		check_hlds__cse_detection__detect_cse_in_proc_6_0_i21);
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(6);
...
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,13)
	...
	if (MR_INT_LE(MR_sv(3),0)) {
		MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_proc_6_0_i32);
	}
	MR_r1 = (MR_Word) MR_string_const("cse_detection.m", 15);
	MR_r2 = (MR_Word) MR_string_const("mode check fails when repeated", 30);
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__cse_detection__detect_cse_in_proc_6_0_i54);
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(4);
MR_def_label(check_hlds__cse_detection__detect_cse_in_proc_6_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__cse_detection__detect_cse_in_proc_6_0_i53);
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module27)
	...
	MR_init_label4(__Unify___check_hlds__cse_detection__cse_info_0_0,2,4,6,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__cse_detection__cse_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___varset__varset_1_0,
		__Unify___check_hlds__cse_detection__cse_info_0_0_i2);
MR_def_label(__Unify___check_hlds__cse_detection__cse_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module28)
	...
	MR_init_label4(__Compare___check_hlds__cse_detection__cse_info_0_0,3,7,11,17)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__cse_detection__cse_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___check_hlds__cse_detection__cse_info_0_0_i3);
MR_def_label(__Compare___check_hlds__cse_detection__cse_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_info_0_0_i17);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__cse_detection__cse_info_0_0_i7);
MR_def_label(__Compare___check_hlds__cse_detection__cse_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_info_0_0_i17);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_rtti__rtti_varmaps_0_0,
		__Compare___check_hlds__cse_detection__cse_info_0_0_i11);
MR_def_label(__Compare___check_hlds__cse_detection__cse_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_info_0_0_i17);
	}
...
MR_def_label(__Compare___check_hlds__cse_detection__cse_info_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module29)
	...
	MR_init_label4(__Unify___check_hlds__cse_detection__cse_state_0_0,43,7,9,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__cse_detection__cse_state_0_0)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___check_hlds__cse_detection__cse_state_0_0_i43);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___check_hlds__cse_detection__cse_state_0_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	if (MR_PTAG_TESTR(MR_r2,1)) {
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_goal__hlds_goal_0_0,
		__Unify___check_hlds__cse_detection__cse_state_0_0_i7);
MR_def_label(__Unify___check_hlds__cse_detection__cse_state_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__cse_detection__cse_state_0_0_i1);
	}
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module30)
	...
	MR_init_label8(__Compare___check_hlds__cse_detection__cse_state_0_0,32,5,4,36,17,73,19,23)
	MR_init_label1(__Compare___check_hlds__cse_detection__cse_state_0_0,70)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__cse_detection__cse_state_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i4);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r1),0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i5);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i17);
	}
...
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,5)
	...
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i73);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i17);
	}
...
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,17)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_goal__hlds_goal_0_0,
		__Compare___check_hlds__cse_detection__cse_state_0_0_i19);
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__cse_detection__cse_state_0_0_i70);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,3,0);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__cse_detection__cse_state_0_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
