  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_31)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_30, &Globals_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 73, &VeryVerbose_11);
    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_30, PredId_7, &PredInfo0_12);
    hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo0_12, ProcId_8, &ProcInfo0_13);
    check_hlds__cse_detection__detect_cse_in_proc_pass_4_p_0(STATE_VARIABLE_ModuleInfo_0_30, &Redo_14, ProcInfo0_13, &ProcInfo1_15);
    hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_8, ProcInfo1_15, PredInfo0_12, &PredInfo1_16);
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_7, PredInfo1_16, STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_33_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 83, &Statistics_17);
    hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_33_33, &ProgressStream_77);
    libs__file_util__maybe_report_stats_4_p_0(ProgressStream_77, Statistics_17);
    switch (Redo_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_ModuleInfo_31 = STATE_VARIABLE_ModuleInfo_33_33;
        break;
      case (MR_Integer) 1:
        {
          MR_Word ModeSpecs_21;
          MR_Word ContainsErrors_22;
          MR_Word PredInfo2_25;
          MR_Word ProcInfo2_26;
          MR_Word SwitchDetectInfo_27;
          MR_Word ProcInfo_28;
          MR_Word PredInfo3_29;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              ProgressStream_78 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, (MR_Integer) 0))));
          }
          if (succeeded)
          {
            MR_String Var_43;

            Var_43 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_33_33, PredId_7);
            mercury__io__write_string_4_p_0(ProgressStream_78, (MR_String) "% Repeating mode check for ");
            mercury__io__write_string_4_p_0(ProgressStream_78, Var_43);
            mercury__io__write_string_4_p_0(ProgressStream_78, (MR_String) "\n");
          }
          check_hlds__modes__modecheck_proc_6_p_0(PredId_7, ProcId_8, STATE_VARIABLE_ModuleInfo_33_33, &STATE_VARIABLE_ModuleInfo_45_45, &_Changed_20, &ModeSpecs_21);
          hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_45_45, &ProgressStream_80);
          libs__file_util__maybe_report_stats_4_p_0(ProgressStream_80, Statistics_17);
          ContainsErrors_22 = parse_tree__error_util__contains_errors_2_f_0(Globals_10, ModeSpecs_21);
          switch (ContainsErrors_22) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
              }
            ...
            case (MR_Integer) 1:
              {
                ...
                if (!((MaybeProgressStream_6 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  MR_Word _DumpInfo_23;

                  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_81, STATE_VARIABLE_ModuleInfo_45_45, (MR_Integer) 46, (MR_String) "cse_repeat_modecheck", (MR_Word) ((MR_Unsigned) 0U), &_DumpInfo_23);
                }
                hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_45_45, &DebugStream_24);
                parse_tree__write_error_spec__write_error_specs_5_p_0(DebugStream_24, Globals_10, ModeSpecs_21);
                {
          ...
          if (succeeded)
          {
            succeeded = (MaybeProgressStream_6 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              ProgressStream_84 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_6, (MR_Integer) 0))));
          }
          if (succeeded)
          {
            MR_String Var_63;

            Var_63 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_45_45, PredId_7);
            mercury__io__write_string_4_p_0(ProgressStream_84, (MR_String) "% Repeating switch detection for ");
            mercury__io__write_string_4_p_0(ProgressStream_84, Var_63);
            mercury__io__write_string_4_p_0(ProgressStream_84, (MR_String) "\n");
          }
          hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_45_45, PredId_7, &PredInfo2_25);
          hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo2_25, ProcId_8, &ProcInfo2_26);
          SwitchDetectInfo_27 = check_hlds__switch_detection__init_switch_detect_info_1_f_0(STATE_VARIABLE_ModuleInfo_45_45);
          check_hlds__switch_detection__detect_switches_in_proc_3_p_0(SwitchDetectInfo_27, ProcInfo2_26, &ProcInfo_28);
          hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_8, ProcInfo_28, PredInfo2_25, &PredInfo3_29);
          hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_7, PredInfo3_29, STATE_VARIABLE_ModuleInfo_45_45, &STATE_VARIABLE_ModuleInfo_65_65);
          hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_65_65, &ProgressStream_86);
          libs__file_util__maybe_report_stats_4_p_0(ProgressStream_86, Statistics_17);
          succeeded = (VeryVerbose_11 == (MR_Integer) 1);
          if (succeeded)
          {
            succeeded = (MaybeProgressStream_6 != (MR_Word) ((MR_Unsigned) 0U));
          ...
          if (succeeded)
          {
            ...
            Var_74 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_ModuleInfo_65_65, PredId_7);
            mercury__io__write_string_4_p_0(ProgressStream_87, (MR_String) "% Repeating common deconstruction detection for ");
            mercury__io__write_string_4_p_0(ProgressStream_87, Var_74);
            mercury__io__write_string_4_p_0(ProgressStream_87, (MR_String) "\n");
          }
          // direct tailcall eliminated
          ;
          next_value_of_STATE_VARIABLE_ModuleInfo_0_30 = STATE_VARIABLE_ModuleInfo_65_65;
