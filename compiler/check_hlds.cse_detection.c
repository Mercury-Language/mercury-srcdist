  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 687, &Statistics_20);
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__write_error_spec__write_error_specs_5_p_0(DebugStream_28, Globals_12, ModeSpecs_24);
                {
