  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 689, &Statistics_20);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__map__init_1_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__cse_detection_scalar_common_2[0]), &ProcModeErrorMap0_21);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_33)
{
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &Goal0_8);
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_32, &InstMap0_9);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &VarTable0_10);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &RttiVarMaps0_11);
  {
  ...
  *Redo_6 = ((MR_Unsigned) ((MR_hl_field(0, CseInfo_15, 3))) & (MR_Integer) 1);
  ...
  hlds__hlds_proc__proc_info_get_cse_nopull_contexts_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &NoPullContexts0_20);
  ...
  hlds__hlds_proc__proc_info_set_cse_nopull_contexts_3_p_0(NoPullContexts_21, STATE_VARIABLE_ProcInfo_0_32, &STATE_VARIABLE_ProcInfo_1_35);
  switch (*Redo_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_1_35, &HeadVars_27);
        ...
        hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_29, STATE_VARIABLE_ProcInfo_1_35, &STATE_VARIABLE_ProcInfo_2_37);
        hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_30, STATE_VARIABLE_ProcInfo_2_37, &STATE_VARIABLE_ProcInfo_3_38);
        hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_31, STATE_VARIABLE_ProcInfo_3_38, STATE_VARIABLE_ProcInfo_33);
      }
      break;
  }
}
