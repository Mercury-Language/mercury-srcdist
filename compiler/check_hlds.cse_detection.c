...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__cse_detection_scalar_common_1[4]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__cse_detection_scalar_common_1[2]), &SubResult2_15, ((MR_Box) (Var_30)), ((MR_Box) (ArgY2_14)));
                    succeeded = (SubResult2_15 != (MR_Integer) 0);
                    if (succeeded)
                      *HeadVar__1_1 = SubResult2_15;
                    else
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__cse_detection_scalar_common_1[3]), HeadVar__1_1, ((MR_Box) (Var_29)), ((MR_Box) (ArgY3_17)));
                    }
                  }
                }
                break;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_17_17 = (MR_Word) (&check_hlds__cse_detection_scalar_common_1[3]);
