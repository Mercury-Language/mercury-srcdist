  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 82, &VeryVerbose_18);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 82, &VeryVerbose_11);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 92, &Statistics_17);
