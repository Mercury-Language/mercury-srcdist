...
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 104,56,57,64,106,5,7,112)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 11,13,110,16,18,108,21,109)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 105,74,24,27,111,42,38,39)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0, 32,33,34,36,107,48,50,51)
...
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0, 52,2,3,5,6,7,8,4)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0, 9,10,11,13,14,15,16,18)
MR_decl_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0, 17,20,21,41,23,24,25,26)
MR_decl_label5(check_hlds__cse_detection__detect_cse_in_proc_4_0, 27,28,29,30,31)
...
MR_decl_label8(check_hlds__cse_detection__find_bind_var_for_cse_in_deconstruct_7_0, 11,8,14,15,17,19,4,33)
MR_decl_label4(check_hlds__cse_detection__find_bind_var_for_cse_in_deconstruct_7_0, 68,24,27,26)
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module7)
	...
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,104,56,57,64,106,5,7,112)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,11,13,110,16,18,108,21,109)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,105,74,24,27,111,42,38,39)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_goal_expr_7_0,32,33,34,36,107,48,50,51)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module16)
	...
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0,52,2,3,5,6,7,8,4)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0,9,10,11,13,14,15,16,18)
	MR_init_label8(check_hlds__cse_detection__detect_cse_in_proc_4_0,17,20,21,41,23,24,25,26)
	MR_init_label5(check_hlds__cse_detection__detect_cse_in_proc_4_0,27,28,29,30,31)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__cse_detection_module23)
	...
	MR_init_label8(check_hlds__cse_detection__find_bind_var_for_cse_in_deconstruct_7_0,11,8,14,15,17,19,4,33)
	MR_init_label4(check_hlds__cse_detection__find_bind_var_for_cse_in_deconstruct_7_0,68,24,27,26)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__cse_detection__find_bind_var_for_cse_in_deconstruct_7_0)
	...
	MR_tempr8 = MR_r5;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(1, MR_tempr8, 1);
	MR_tfield(1, MR_tempr2, 2) = MR_ctfield(1, MR_tempr8, 2);
	MR_tfield(1, MR_tempr2, 3) = MR_ctfield(1, MR_tempr8, 3);
	MR_tfield(1, MR_tempr2, 4) = MR_ctfield(1, MR_tempr8, 4);
	MR_tfield(1, MR_tempr2, 5) = MR_ctfield(1, MR_tempr8, 5);
	MR_tempr9 = MR_r3;
	MR_tempr3 = MR_ctfield(0, MR_tempr9, 1);
	MR_r5 = MR_tempr3;
	...
	MR_tfield(0, MR_tempr5, 2) = MR_ctfield(0, MR_tempr9, 2);
	MR_tfield(0, MR_tempr5, 3) = MR_tempr2;
	MR_tfield(0, MR_tempr5, 4) = MR_ctfield(0, MR_tempr9, 4);
	MR_sv(4) = MR_r4;
	MR_r1 = MR_ctfield(0, MR_r2, 1);
	MR_sv(1) = MR_ctfield(0, MR_tempr5, 4);
