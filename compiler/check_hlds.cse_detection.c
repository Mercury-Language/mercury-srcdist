  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  while (MR_TRUE)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_40 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(STATE_VARIABLE_ModuleInfo_0_34, PredId_5);
    ...
    hlds__hlds_module__module_info_set_preds_3_p_0(PredTable1_19, STATE_VARIABLE_ModuleInfo_0_34, &STATE_VARIABLE_ModuleInfo_44_44);
    ...
    switch (Redo_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_ModuleInfo_35 = STATE_VARIABLE_ModuleInfo_44_44;
        break;
      case (MR_Integer) 1:
        {
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_51 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(STATE_VARIABLE_ModuleInfo_44_44, PredId_5);
                mercury__io__write_string_3_p_0(Var_51);
                mercury__io__write_string_3_p_0((MR_String) "\n");
              }
              break;
          }
          check_hlds__modes__modecheck_proc_6_p_0(PredId_5, ProcId_6, STATE_VARIABLE_ModuleInfo_44_44, &STATE_VARIABLE_ModuleInfo_55_55, &_Changed_21, &ModeSpecs_22);
          libs__file_util__maybe_report_stats_3_p_0(Statistics_20);
            ...
            case (MR_Integer) 1:
              {
                ...
                hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_ModuleInfo_55_55, (MR_Integer) 46, (MR_String) "cse_repeat_modecheck", (MR_Word) ((MR_Unsigned) 0U), &_DumpInfo_24);
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_69 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(STATE_VARIABLE_ModuleInfo_55_55, PredId_5);
                mercury__io__write_string_3_p_0(Var_69);
                mercury__io__write_string_3_p_0((MR_String) "\n");
              }
              break;
          }
          hlds__hlds_module__module_info_get_preds_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, &PredTable2_25);
          ...
          SwitchDetectInfo_29 = check_hlds__switch_detection__init_switch_detect_info_1_f_0(STATE_VARIABLE_ModuleInfo_55_55);
          ...
          hlds__hlds_module__module_info_set_preds_3_p_0(PredTable3_33, STATE_VARIABLE_ModuleInfo_55_55, &STATE_VARIABLE_ModuleInfo_73_73);
          libs__file_util__maybe_report_stats_3_p_0(Statistics_20);
          switch (VeryVerbose_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_77 = mercury__string__f_43_43_2_f_0((MR_String) "% Repeating common ", (MR_String) "deconstruction detection for ");
                mercury__io__write_string_3_p_0(Var_77);
                Var_81 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(STATE_VARIABLE_ModuleInfo_73_73, PredId_5);
          ...
          // direct tailcall eliminated
          ;
          next_value_of_STATE_VARIABLE_ModuleInfo_0_34 = STATE_VARIABLE_ModuleInfo_73_73;
