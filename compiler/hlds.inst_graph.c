    ...
    if (hlds__inst_graph__succeeded)
    {
      ...
      if (hlds__inst_graph__succeeded)
      {
        ...
        *hlds__inst_graph__B_4 = hlds__inst_graph__Var_20;
        hlds__inst_graph__cont(hlds__inst_graph__cont_env_ptr);
        hlds__inst_graph__corresponding_members_4_p_0(hlds__inst_graph__TypeInfo_for_T_15, hlds__inst_graph__TypeInfo_for_U_16, hlds__inst_graph__Var_17, hlds__inst_graph__Var_19, hlds__inst_graph__A_3, hlds__inst_graph__B_4, hlds__inst_graph__cont, hlds__inst_graph__cont_env_ptr);
      }
    }
  }
}
