...
{
  {
    MR_Word TypeInfo_19_19 = (MR_Word) &hlds__inst_graph_scalar_common_1[0];
    MR_Word TypeCtorInfo_20_20 = (MR_Word) &hlds__inst_graph__hlds__inst_graph__type_ctor_info_node_0;
    MR_Word Functors_8;
    MR_Word MaybeParent0_9;
    MR_Word Var_13;
    MR_Box conv0_Var_13;

    mercury__map__lookup_3_p_0(TypeInfo_19_19, TypeCtorInfo_20_20, STATE_VARIABLE_InstGraph_0_11, ((MR_Box) (Child_6)), &conv0_Var_13);
    ...
    if ((MaybeParent0_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      mercury__map__det_update_4_p_0(TypeInfo_19_19, TypeCtorInfo_20_20, ((MR_Box) (Child_6)), ((MR_Box) (Var_16)), STATE_VARIABLE_InstGraph_0_11, STATE_VARIABLE_InstGraph_12);
    }
    else
    {
      {
