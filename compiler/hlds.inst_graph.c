...
MR_decl_label2(hlds__inst_graph__IntroducedFrom__pred__merge__373__1_5_0, 3,5)
MR_decl_label2(hlds__inst_graph__corresponding_members_4_0, 6,4)
MR_decl_label10(hlds__inst_graph__corresponding_nodes_2_8_0, 2,4,6,3,8,9,10,11,13,15)
MR_decl_label8(hlds__inst_graph__corresponding_nodes_2_8_0, 17,14,19,21,12,24,25,1)
...
MR_decl_label5(hlds__inst_graph__dump_functor_5_0, 2,3,6,8,4)
MR_decl_label5(hlds__inst_graph__dump_node_5_0, 2,3,4,5,8)
MR_decl_label3(hlds__inst_graph__foldl_reachable_5_0, 2,3,4)
MR_decl_label3(hlds__inst_graph__foldl_reachable2_7_0, 2,3,4)
...
MR_decl_label5(hlds__inst_graph__merge_7_0, 2,5,3,9,10)
...
MR_decl_label3(hlds__inst_graph__top_level_node_3_0, 13,2,4)
...
MR_decl_label6(__Compare___hlds__inst_graph__inst_graph_info_0_0, 3,2,5,9,13,49)
MR_decl_label4(__Compare___hlds__inst_graph__maybe_parent_0_0, 18,7,5,9)
MR_decl_label4(__Compare___hlds__inst_graph__node_0_0, 3,2,5,27)
...
static const MR_UserClosureId
mercury_data__closure_layout__hlds__inst_graph__foldl_reachable2_7_0_1;
...
{
{
(MR_Word *) &mercury_data__closure_layout__hlds__inst_graph__foldl_reachable2_7_0_1,
MR_COMMON(9,0)
},
11,
{
...
MR_define_entry(mercury__hlds__inst_graph__set_parent_4_0);
	...
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(hlds__inst_graph, node);
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(5);
	MR_r4 = MR_sv(2);
...
MR_BEGIN_MODULE(hlds__inst_graph_module2)
	...
	MR_init_label3(hlds__inst_graph__top_level_node_3_0,13,2,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__inst_graph__top_level_node_3_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(hlds__inst_graph__top_level_node_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(hlds__inst_graph__top_level_node_3_0,4)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(hlds__inst_graph__top_level_node_3_0_i13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_static(hlds__inst_graph__descendant_2_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred hlds.inst_graph.descendant_2/4-0", 6,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_fv(2) = MR_r2;
...
MR_define_entry(mercury__hlds__inst_graph__reachable_from_list_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred hlds.inst_graph.reachable_from_list/3-0", 4,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(list__member_2_1,
...
MR_BEGIN_MODULE(hlds__inst_graph_module11)
	...
	MR_init_label3(hlds__inst_graph__foldl_reachable2_7_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_label(hlds__inst_graph__foldl_reachable2_7_0,2)
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(hlds__inst_graph__foldl_reachable2_7_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__hlds__inst_graph__foldl_reachable2_7_0_i3);
MR_def_label(hlds__inst_graph__foldl_reachable2_7_0,3)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		hlds__inst_graph__foldl_reachable2_7_0_i4);
MR_def_label(hlds__inst_graph__foldl_reachable2_7_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 8);
...
MR_BEGIN_MODULE(hlds__inst_graph_module14)
	...
	MR_init_label10(hlds__inst_graph__corresponding_nodes_2_8_0,2,4,6,3,8,9,10,11,13,15)
	MR_init_label8(hlds__inst_graph__corresponding_nodes_2_8_0,17,14,19,21,12,24,25,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__inst_graph__corresponding_nodes_2_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred hlds.inst_graph.corresponding_nodes_2/8-0", 9,
...
MR_def_label(hlds__inst_graph__corresponding_nodes_2_8_0,3)
	...
	MR_fv(9) = (MR_Word) MR_CTOR0_ADDR(hlds__inst_graph, node);
	MR_r1 = MR_fv(8);
	MR_r2 = MR_fv(9);
	MR_r3 = MR_fv(1);
	MR_r4 = MR_fv(6);
...
MR_define_entry(mercury__hlds__inst_graph__corresponding_nodes_from_lists_6_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred hlds.inst_graph.corresponding_nodes_from_lists/6-0", 5,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_fv(2) = MR_r2;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_BEGIN_MODULE(hlds__inst_graph_module18)
	...
	MR_init_label5(hlds__inst_graph__merge_7_0,2,5,3,9,10)
MR_BEGIN_CODE
...
MR_def_label(hlds__inst_graph__merge_7_0,2)
	...
	MR_np_call_localret_ent(map__map_values_only_3_1,
		hlds__inst_graph__merge_7_0_i5);
MR_def_label(hlds__inst_graph__merge_7_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_np_call_localret_ent(map__foldl_4_0,
		hlds__inst_graph__merge_7_0_i10);
...
MR_def_label(hlds__inst_graph__merge_7_0,9)
	...
	MR_np_call_localret_ent(map__foldl_4_0,
		hlds__inst_graph__merge_7_0_i10);
MR_def_label(hlds__inst_graph__merge_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__inst_graph_module31)
	...
	MR_init_label5(hlds__inst_graph__dump_functor_5_0,2,3,6,8,4)
MR_BEGIN_CODE
...
MR_def_label(hlds__inst_graph__dump_functor_5_0,6)
	...
	MR_np_call_localret_ent(io__write_list_5_0,
		hlds__inst_graph__dump_functor_5_0_i8);
MR_def_label(hlds__inst_graph__dump_functor_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 41;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_BEGIN_MODULE(hlds__inst_graph_module36)
	...
	MR_init_label6(__Compare___hlds__inst_graph__inst_graph_info_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__inst_graph__inst_graph_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__inst_graph__inst_graph_info_0_0_i49);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(__Compare___hlds__inst_graph__inst_graph_info_0_0,13)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___hlds__inst_graph__inst_graph_info_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__inst_graph_module40)
	...
	MR_init_label4(__Compare___hlds__inst_graph__node_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__inst_graph__node_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__inst_graph__node_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___hlds__inst_graph__node_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__inst_graph_module43)
	...
	MR_init_label2(hlds__inst_graph__IntroducedFrom__pred__merge__373__1_5_0,3,5)
MR_BEGIN_CODE
...
void mercury__hlds__inst_graph__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__inst_graph);
