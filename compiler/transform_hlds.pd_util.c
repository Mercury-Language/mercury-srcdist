...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_vars__585__1_7_p_0(
...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__546__1_2_p_0(
  MR_Word LambdaHeadVar__1_37,
  MR_Word * LambdaHeadVar__2_38);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__554__1_2_p_0(
  MR_Word LambdaHeadVar__1_35,
  MR_Word * LambdaHeadVar__2_36);

static MR_bool MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__rerun_det_analysis__386__1_2_p_0(
...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__790__1_3_p_0(
  MR_Word Args_5,
  MR_Integer HeadVar__2_27,
  MR_Word * HeadVar__3_28);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__786__1_3_p_0(
  MR_Word Args_5,
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__pd_util__IntroducedFrom__pred__goals_match__1011__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_31);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  succeeded = transform_hlds__pd_util__IntroducedFrom__pred__goals_match_2__1104__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_100);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__546__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_38);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__554__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_36);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__790__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv1_HeadVar__3_28);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__786__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_25);
...
transform_hlds__pd_util__unique_modecheck_goal_live_vars_6_p_0(
  ...
  MR_Word * Goal_9,
  MR_Word * Errors_10,
  MR_Word STATE_VARIABLE_PDInfo_0_34,
  MR_Word * STATE_VARIABLE_PDInfo_35)
{
  ...
  transform_hlds__pd_info__pd_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_PDInfo_0_34, &PredProcId_12);
  ...
  transform_hlds__pd_info__pd_info_get_module_info_2_p_0(STATE_VARIABLE_PDInfo_0_34, &ModuleInfo0_15);
  transform_hlds__pd_info__pd_info_get_instmap_2_p_0(STATE_VARIABLE_PDInfo_0_34, &InstMap0_16);
  mercury__term__context_init_1_p_0(&Context_17);
  transform_hlds__pd_info__pd_info_get_pred_info_2_p_0(STATE_VARIABLE_PDInfo_0_34, &PredInfo0_18);
  transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(STATE_VARIABLE_PDInfo_0_34, &ProcInfo0_19);
  transform_hlds__pd_info__pd_info_get_head_inst_vars_2_p_0(STATE_VARIABLE_PDInfo_0_34, &HeadInstVars_20);
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&transform_hlds__pd_util_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (transform_hlds__pd_util__unique_modecheck_goal_live_vars_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_39, 3) = ((MR_Box) (ModeInfo_24));
        }
        ErrorSpecs_29 = mercury__list__map_2_f_0((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_mode_error_info_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_39, *Errors_10);
        parse_tree__error_util__write_error_specs_4_p_0(Globals_26, ErrorSpecs_29);
      }
      break;
  }
  transform_hlds__pd_info__pd_info_set_module_info_3_p_0(ModuleInfo_25, STATE_VARIABLE_PDInfo_0_34, &STATE_VARIABLE_PDInfo_41_41);
  hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_25, PredId_13, ProcId_14, &PredInfo_30, &ProcInfo1_31);
  transform_hlds__pd_info__pd_info_set_pred_info_3_p_0(PredInfo_30, STATE_VARIABLE_PDInfo_41_41, &STATE_VARIABLE_PDInfo_42_42);
  check_hlds__mode_info__mode_info_get_var_table_2_p_0(ModeInfo_24, &VarTable_32);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_32, ProcInfo1_31, &ProcInfo_33);
  transform_hlds__pd_info__pd_info_set_proc_info_3_p_0(ProcInfo_33, STATE_VARIABLE_PDInfo_42_42, STATE_VARIABLE_PDInfo_35);
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__pd_util__IntroducedFrom__pred__rerun_det_analysis__386__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
