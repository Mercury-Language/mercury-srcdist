  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word TypeInfo_38_38 = (MR_Word) &transform_hlds__pd_util_scalar_common_1[0];
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_HeadVar__2_2;
        MR_Word next_value_of_STATE_VARIABLE_MatchingTypes_0_4;

        succeeded = mercury__map__contains_2_p_0(TypeInfo_38_38, TypeInfo_38_38, Renaming_3, ((MR_Box) (Var_40)));
        if (succeeded)
          {
            STATE_VARIABLE_MatchingTypes_35_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Integer * STATE_VARIABLE_Size_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_Size_21_21 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Size_20_20 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_Vars_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextBranch_26 = (MR_Integer) ((MR_Unsigned) BranchNo_3 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextBranch_37 = (MR_Integer) ((MR_Unsigned) BranchNo_2 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_ExtraVars_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextBranch_40 = (MR_Integer) ((MR_Unsigned) BranchNo_5 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * HeadVar__8_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextArgNo_26 = (MR_Integer) ((MR_Unsigned) ArgNo_2 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_OpaqueArgs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextArg_19 = (MR_Integer) ((MR_Unsigned) ArgNo_2 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 86, &Debug_27);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 362, &ConstraintProp_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 86, &DebugPD_10);
