  ...
  MR_Word * STATE_VARIABLE_PDInfo_30)
{
  ...
  ContainsErrors_28 = parse_tree__error_util__contains_errors_2_f_0(GlobalsToUse_27, Specs_24);
  {
    ...
    MR_hl_field(0, Var_36, 0) = ((MR_Box) (&transform_hlds__pd_util_scalar_common_3[1]));
    MR_hl_field(0, Var_36, 1) = ((MR_Box) (transform_hlds__pd_util__rerun_det_analysis_4_p_0_1));
    MR_hl_field(0, Var_36, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_36, 3) = ((MR_Box) (ContainsErrors_28));
