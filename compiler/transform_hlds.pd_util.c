...
transform_hlds__pd_util__IntroducedFrom__pred__goals_match_2__1124__1_3_p_0(
  MR_Word LambdaHeadVar__1_98,
  MR_Word LambdaHeadVar__2_99,
  MR_Word * LambdaHeadVar__3_100);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_vars__596__1_7_p_0(
...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__557__1_2_p_0(
  MR_Word LambdaHeadVar__1_37,
  MR_Word * LambdaHeadVar__2_38);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__565__1_2_p_0(
...
static MR_bool MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__goals_match__1027__1_3_p_0(
  MR_Word OldNewRenaming_15,
  MR_Word LambdaHeadVar__1_30,
  MR_Word * LambdaHeadVar__2_31);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__805__1_3_p_0(
  MR_Word Args_5,
  MR_Integer HeadVar__2_27,
  MR_Word * HeadVar__3_28);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__801__1_3_p_0(
  MR_Word Args_5,
...
{
  {
    ...
    succeeded = transform_hlds__pd_util__IntroducedFrom__pred__goals_match__1027__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_31);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = transform_hlds__pd_util__IntroducedFrom__pred__goals_match_2__1124__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_100);
    if (succeeded)
    {
...
{
  {
    ...
    transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__557__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_38);
...
{
  {
    ...
    transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__565__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_36);
...
{
  {
    ...
    transform_hlds__pd_util__IntroducedFrom__pred__get_branch_vars__596__1_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_45);
...
{
  {
    ...
    transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__805__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv1_HeadVar__3_28);
...
{
  {
    ...
    transform_hlds__pd_util__IntroducedFrom__pred__convert_branch_info__801__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_25);
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__error_util__write_error_specs_ignore_4_p_0(Globals_26, ErrorSpecs_29);
        }
        break;
    }
...
transform_hlds__pd_util__propagate_constraints_4_p_0(
  ...
  MR_Word STATE_VARIABLE_PDInfo_0_32,
  MR_Word * STATE_VARIABLE_PDInfo_33)
{
  {
    ...
    transform_hlds__pd_info__pd_info_get_module_info_2_p_0(STATE_VARIABLE_PDInfo_0_32, &ModuleInfo0_7);
      ...
      case (MR_Integer) 1:
        {
          ...
          *STATE_VARIABLE_PDInfo_33 = STATE_VARIABLE_PDInfo_0_32;
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          transform_hlds__pd_debug__pd_debug_output_goal_5_p_0(STATE_VARIABLE_PDInfo_0_32, (MR_String) "before constraints\n", STATE_VARIABLE_Goal_0_30);
          transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(STATE_VARIABLE_PDInfo_0_32, &ProcInfo0_14);
          transform_hlds__pd_info__pd_info_get_instmap_2_p_0(STATE_VARIABLE_PDInfo_0_32, &InstMap_15);
          hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo0_14, &VarTypes0_16);
          hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo0_14, &VarSet0_17);
          transform_hlds__constraint__constraint_info_init_5_p_0(ModuleInfo0_7, VarTypes0_16, VarSet0_17, InstMap_15, &CInfo0_18);
          GoalInfo0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Goal_0_30, (MR_Integer) 1))));
          NonLocals_21 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_20);
          transform_hlds__constraint__propagate_constraints_in_goal_4_p_0(STATE_VARIABLE_Goal_0_30, &STATE_VARIABLE_Goal_41_41, CInfo0_18, &CInfo_22);
          transform_hlds__constraint__constraint_info_deconstruct_5_p_0(CInfo_22, &ModuleInfo_23, &VarTypes_24, &VarSet_25, &Changed_26);
          transform_hlds__pd_info__pd_info_set_module_info_3_p_0(ModuleInfo_23, STATE_VARIABLE_PDInfo_0_32, &STATE_VARIABLE_PDInfo_42_42);
          hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes_24, ProcInfo0_14, &ProcInfo1_27);
          hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet_25, ProcInfo1_27, &ProcInfo_28);
          transform_hlds__pd_info__pd_info_set_proc_info_3_p_0(ProcInfo_28, STATE_VARIABLE_PDInfo_42_42, &STATE_VARIABLE_PDInfo_43_43);
          switch (Changed_26) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                *STATE_VARIABLE_Goal_31 = STATE_VARIABLE_Goal_0_30;
                *STATE_VARIABLE_PDInfo_33 = STATE_VARIABLE_PDInfo_43_43;
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                transform_hlds__pd_util__pd_requantify_goal_5_p_0(NonLocals_21, STATE_VARIABLE_Goal_41_41, &STATE_VARIABLE_Goal_48_48, STATE_VARIABLE_PDInfo_43_43, &STATE_VARIABLE_PDInfo_49_49);
                ...
                transform_hlds__pd_util__rerun_det_analysis_4_p_0(STATE_VARIABLE_Goal_50_50, &STATE_VARIABLE_Goal_52_52, STATE_VARIABLE_PDInfo_51_51, &STATE_VARIABLE_PDInfo_53_53);
                check_hlds__simplify__simplify_tasks__find_simplify_tasks_3_p_0(Globals_8, (MR_Integer) 0, &SimplifyTasks_29);
                transform_hlds__pd_util__pd_simplify_goal_5_p_0(SimplifyTasks_29, STATE_VARIABLE_Goal_52_52, STATE_VARIABLE_Goal_31, STATE_VARIABLE_PDInfo_53_53, STATE_VARIABLE_PDInfo_33);
              }
              break;
          }
        }
...
{
  {
    ...
    succeeded = transform_hlds__pd_util__IntroducedFrom__pred__rerun_det_analysis__392__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo_14, &VarSet_17);
...
{
  {
    ...
    check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, Goal0_5, Goal_6, VarTypes_11, InstVarSet_12, InstMap_9, ModuleInfo0_8, &ModuleInfo_13);
