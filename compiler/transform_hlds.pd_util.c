                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            Var_95 = (MR_Word) ((MR_Integer) 0);
                            Var_97 = (MR_Word) ((MR_Integer) 0);
                            {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (InstB2_18 == (MR_Word) ((MR_Integer) 4));
        if (succeeded)
        {
          *Inst_8 = InstA2_17;
          succeeded = MR_TRUE;
          ...
          switch (MR_tag((MR_Word) InstA2_17)) {
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(InstA2_17)) {
                ...
                case (MR_Integer) 0:
                  {
                    succeeded = (InstB2_18 == (MR_Word) ((MR_Integer) 0));
                    if (succeeded)
                    {
                      *Inst_8 = (MR_Word) ((MR_Integer) 0);
                      succeeded = MR_TRUE;
                    }
                  }
                  break;
...
{
  {
    MR_bool succeeded = (Xs_8 == (MR_Word) ((MR_Integer) 0));

    if (succeeded)
      succeeded = (Ys_9 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    {
      {
        MR_Word base;
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), NewInst_27, 2) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), NewInst_40, 2) = ((MR_Box) ((MR_Integer) 0));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (InstB2_23 == (MR_Word) ((MR_Integer) 4));
            if (succeeded)
            {
              Arg_14 = InstA2_22;
              succeeded = MR_TRUE;
              ...
              switch (MR_tag((MR_Word) InstA2_22)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(InstA2_22)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        succeeded = (InstB2_23 == (MR_Word) ((MR_Integer) 0));
                        if (succeeded)
                        {
                          Arg_14 = (MR_Word) ((MR_Integer) 0);
                          succeeded = MR_TRUE;
                        }
                      }
                      break;
...
{
  {
    ...
    {
      *MaybeBranchInfo_6 = (MR_Word) ((MR_Integer) 0);
            ...
            case (MR_Integer) 1:
              {
                ...
                check_hlds__det_util__det_info_init_7_p_0(ModuleInfo1_70, PredProcId_66, VarSet_71, VarTypes_72, (MR_Integer) 1, (MR_Word) ((MR_Integer) 0), &DetInfo0_73);
                transform_hlds__pd_info__pd_info_get_instmap_2_p_0(STATE_VARIABLE_PDInfo_51_51, &InstMap_74);
                check_hlds__det_analysis__det_infer_goal_10_p_0(STATE_VARIABLE_Goal_50_50, &STATE_VARIABLE_Goal_52_52, InstMap_74, SolnContext_65, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), &Var_75, &Var_76, DetInfo0_73, &DetInfo_77);
