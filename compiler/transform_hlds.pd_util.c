...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_vars__587__1_7_p_0(
...
static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__548__1_2_p_0(
  MR_Word LambdaHeadVar__1_38,
  MR_Word * LambdaHeadVar__2_39);

static void MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__556__1_2_p_0(
  ...
  MR_Word * Inst_8)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (InstA_6));
      MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (InstB_7));
    }
    succeeded = mercury__set__member_2_p_0((MR_Word) (&transform_hlds__pd_util_scalar_common_2[0]), ((MR_Box) (Var_19)), Expansions_9);
    succeeded = !(succeeded);
    if (succeeded)
    {
      check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_5, InstA_6, &InstA2_17);
      check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_5, InstB_7, &InstB2_18);
      TypeInfo_18_23 = (MR_Word) (&transform_hlds__pd_util_scalar_common_2[0]);
      {
        Var_20 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (InstA_6));
        MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (InstB_7));
      }
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (((((MR_tag((MR_Word) InstB2_18)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), InstB2_18, (MR_Integer) 0)))) == (MR_Integer) 0))))
                  {
                    ...
                    succeeded = transform_hlds__pd_util__bound_inst_list_MSG_7_p_0(ModuleInfo_5, STATE_VARIABLE_Expansions_16_21, UniqB_47, Var_60, BoundInstsB_49, BoundInstsB_49, Inst_8);
                  }
                  else
              ...
              case (MR_Integer) 5:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = transform_hlds__pd_util__inst_list_MSG_5_p_0(ModuleInfo_5, STATE_VARIABLE_Expansions_16_21, ArgsA_55, ArgsB_56, &Args_57);
                      if (succeeded)
                      {
                        {
                          MR_Word base;
    ...
    if (succeeded)
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (ArgA_10));
          MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (ArgB_12));
        }
        succeeded = mercury__set__member_2_p_0((MR_Word) (&transform_hlds__pd_util_scalar_common_2[0]), ((MR_Box) (Var_24)), Expansions_2);
        succeeded = !(succeeded);
        if (succeeded)
        {
          check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_1, ArgA_10, &InstA2_22);
          check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_1, ArgB_12, &InstB2_23);
          TypeInfo_18_28 = (MR_Word) (&transform_hlds__pd_util_scalar_common_2[0]);
          {
            Var_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (ArgA_10));
            MR_hl_field(MR_mktag(0), Var_25, 1) = ((MR_Box) (ArgB_12));
          }
          mercury__set__insert_3_p_0(TypeInfo_18_28, ((MR_Box) (Var_25)), Expansions_2, &STATE_VARIABLE_Expansions_16_26);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if (((((MR_tag((MR_Word) InstB2_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), InstB2_23, (MR_Integer) 0)))) == (MR_Integer) 0))))
                      {
                        ...
                        succeeded = transform_hlds__pd_util__bound_inst_list_MSG_7_p_0(ModuleInfo_1, STATE_VARIABLE_Expansions_16_26, UniqB_52, Var_65, BoundInstsB_54, BoundInstsB_54, &Arg_14);
                      }
                      else
                  ...
                  case (MR_Integer) 5:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          succeeded = transform_hlds__pd_util__inst_list_MSG_5_p_0(ModuleInfo_1, STATE_VARIABLE_Expansions_16_26, ArgsA_60, ArgsB_61, &Args_62);
                          if (succeeded)
                          {
                            {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__548__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_39);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__pd_util__IntroducedFrom__pred__get_branch_instmap_deltas__556__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_42);
  ...
  MR_Word * STATE_VARIABLE_Vars_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      GoalExpr_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_23, (MR_Integer) 0))));
            ...
            case (MR_Integer) 6:
              {
                ...
                ElseDelta_60 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(ElseInfo_57);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (ElseDelta_60));
                  MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                {
                  Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (ThenDelta_59));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), InstMapDeltas_31, 1) = ((MR_Box) (Var_76));
                }
                succeeded = MR_TRUE;
              }
              break;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            transform_hlds__pd_util__get_left_vars_3_p_0(Goal_23, STATE_VARIABLE_LeftVars_0_6, &STATE_VARIABLE_LeftVars_41_41);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_12)
{
  ...
  transform_hlds__pd_util__get_goal_live_vars_2_6_p_0(ModuleInfo_18, InstMap_20, InstMapDelta_19, NonLocalsList_22, STATE_VARIABLE_Vars_14_23, &LiveVars_10);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 101, &Debug_27);
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo0_7, ProcInfo0_13, &VarTable0_15);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_15)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo0_8, ProcInfo_10, &VarTable_11);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_18)
{
  ...
  transform_hlds__pd_info__pd_info_get_module_info_2_p_0(STATE_VARIABLE_PDInfo_0_17, &ModuleInfo_11);
  transform_hlds__pd_info__pd_info_get_proc_info_2_p_0(STATE_VARIABLE_PDInfo_0_17, &STATE_VARIABLE_ProcInfo_19_19);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_11, STATE_VARIABLE_ProcInfo_19_19, &VarTable0_12);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_19_19, &RttiVarMaps0_13);
  hlds__quantification__implicitly_quantify_goal_general_vt_9_p_0((MR_Integer) 1, NonLocals_6, &Var_14, Goal0_7, Goal_8, VarTable0_12, &VarTable_15, RttiVarMaps0_13, &RttiVarMaps_16);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_15, STATE_VARIABLE_ProcInfo_19_19, &STATE_VARIABLE_ProcInfo_21_21);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_16, STATE_VARIABLE_ProcInfo_21_21, &STATE_VARIABLE_ProcInfo_22_22);
  transform_hlds__pd_info__pd_info_set_proc_info_3_p_0(STATE_VARIABLE_ProcInfo_22_22, STATE_VARIABLE_PDInfo_0_17, STATE_VARIABLE_PDInfo_18);
}
