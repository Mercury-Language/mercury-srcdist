...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__pd_util__Globals_26, (MR_Integer) 75, &transform_hlds__pd_util__Debug_27);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__pd_util__Globals_8, (MR_Integer) 75, &transform_hlds__pd_util__DebugPD_10);
    }
