...
{
  {
    ...
    MR_Word transform_hlds__pd_util__Var_78;
    MR_Word transform_hlds__pd_util__Var_79;
    MR_Word transform_hlds__pd_util__Var_80;
    MR_Word transform_hlds__pd_util__Var_28;
    ...
    MR_Word transform_hlds__pd_util__Var_88;
        ...
        if (transform_hlds__pd_util__succeeded)
          {
            ...
            if (transform_hlds__pd_util__succeeded)
              {
                transform_hlds__pd_util__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_71, (MR_Integer) 0)));
                transform_hlds__pd_util__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_71, (MR_Integer) 1)));
                (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_46, (MR_Integer) 0)) = ((MR_Box) (transform_hlds__pd_util__Var_79));
                transform_hlds__pd_util__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_46, (MR_Integer) 1)));
                {
                  transform_hlds__pd_util__succeeded = mercury__list____Unify____list_1_0(transform_hlds__pd_util__TypeCtorInfo_73_73, transform_hlds__pd_util__Var_78, transform_hlds__pd_util__Var_80);
                }
                if (transform_hlds__pd_util__succeeded)
                  {
                    ...
                    if (transform_hlds__pd_util__succeeded)
                      {
                        ...
                        if (transform_hlds__pd_util__succeeded)
                          {
                            transform_hlds__pd_util__Var_89 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_72, (MR_Integer) 0)));
                            transform_hlds__pd_util__Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_72, (MR_Integer) 1)));
                            (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_48, (MR_Integer) 0)) = ((MR_Box) (transform_hlds__pd_util__Var_89));
                            transform_hlds__pd_util__Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__pd_util__Var_48, (MR_Integer) 1)));
                            {
                              transform_hlds__pd_util__succeeded = mercury__list____Unify____list_1_0(transform_hlds__pd_util__TypeCtorInfo_74_74, transform_hlds__pd_util__Var_88, transform_hlds__pd_util__Var_90);
                            }
                          }
                      }
