...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 85, &Debug_27);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 359, &ConstraintProp_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 85, &DebugPD_10);
