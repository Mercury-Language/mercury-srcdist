  ...
  MR_Word * STATE_VARIABLE_Vars_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      GoalExpr_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_23, (MR_Integer) 0))));
            ...
            case (MR_Integer) 6:
              {
                ...
                ElseDelta_62 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(ElseInfo_59);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (ElseDelta_62));
                  MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                {
                  Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (ThenDelta_61));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), InstMapDeltas_31, 1) = ((MR_Box) (Var_78));
                }
                succeeded = MR_TRUE;
              }
              break;
  ...
  MR_Word * STATE_VARIABLE_PDInfo_12)
{
  ...
  transform_hlds__pd_util__get_goal_live_vars_2_6_p_0(ModuleInfo_19, InstMap_21, InstMapDelta_20, NonLocalsList_23, STATE_VARIABLE_Vars_14_24, &LiveVars_10);
