...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 379, &ConstraintProp_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 92, &DebugPD_10);
