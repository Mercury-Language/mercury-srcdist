  ...
  MR_Word * LambdaHeadVar__3_44)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ArgX1_77 = ((MR_Word) ((MR_hl_field(1, Var_71, (MR_Integer) 0))));
        ArgY2_80 = ((MR_Word) ((MR_hl_field(1, Var_71, (MR_Integer) 1))));
        (MR_hl_field(1, Var_45, (MR_Integer) 0)) = ((MR_Box) (ArgX1_77));
        ArgX2_79 = ((MR_Word) ((MR_hl_field(1, Var_45, (MR_Integer) 1))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ArgX1_87 = ((MR_Word) ((MR_hl_field(1, Var_72, (MR_Integer) 0))));
              ArgY2_90 = ((MR_Word) ((MR_hl_field(1, Var_72, (MR_Integer) 1))));
              (MR_hl_field(1, Var_47, (MR_Integer) 0)) = ((MR_Box) (ArgX1_87));
              ArgX2_89 = ((MR_Word) ((MR_hl_field(1, Var_47, (MR_Integer) 1))));
