...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 87, &Debug_27);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 368, &ConstraintProp_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 87, &DebugPD_10);
