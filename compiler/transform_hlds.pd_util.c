...
static MR_bool MR_CALL 
transform_hlds__pd_util__IntroducedFrom__pred__goal_get_calls__194__1_2_p_0(
...
{
  {
    ...
    if (((MR_tag((MR_Word) GenericCallA_3)) == (MR_Integer) 2))
    {
      MR_Integer MethodNum_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GenericCallA_3, (MR_Integer) 1))));
      MR_Word ClassId_12 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCallA_3, (MR_Integer) 2))));
      MR_Word CallId_13 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCallA_3, (MR_Integer) 3))));
      MR_Integer Var_18;
      MR_Word Var_19;
      MR_Word Var_20;

      succeeded = ((MR_tag((MR_Word) GenericCallB_4)) == (MR_Integer) 2);
      if (succeeded)
      {
        Var_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GenericCallB_4, (MR_Integer) 1))));
        Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCallB_4, (MR_Integer) 2))));
        Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCallB_4, (MR_Integer) 3))));
    ...
    {
      MR_Word Purity_6 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), GenericCallA_3, (MR_Integer) 1))) >> 1)) & (MR_Integer) 3);
      MR_Word PredOrFunc_7 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), GenericCallA_3, (MR_Integer) 1))) & (MR_Integer) 1);
      MR_Integer Arity_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), GenericCallA_3, (MR_Integer) 2))));
      MR_Word Var_15;
      MR_Word Var_16;
      MR_Integer Var_17;
      ...
      if (succeeded)
      {
        Var_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), GenericCallB_4, (MR_Integer) 1))) >> 1)) & (MR_Integer) 3);
        Var_16 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), GenericCallB_4, (MR_Integer) 1))) & (MR_Integer) 1);
        Var_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), GenericCallB_4, (MR_Integer) 2))));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 92, &Debug_27);
...
{
  {
    ...
    ConstraintProp_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_9, (MR_Integer) 0))) >> 23)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 92, &DebugPD_11);
            ...
            case (MR_Integer) 1:
              {
                ...
                check_hlds__simplify__simplify_tasks__find_simplify_tasks_3_p_0((MR_Integer) 0, Globals_8, &SimplifyTasks_29);
...
{
  {
    ...
    succeeded = transform_hlds__pd_util__IntroducedFrom__pred__goal_get_calls__194__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
    if (succeeded)
    {
