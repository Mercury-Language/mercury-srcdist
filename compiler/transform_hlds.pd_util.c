  ...
  MR_Word * STATE_VARIABLE_PDInfo_15)
{
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 0, VarTable_11, InstVarSet_12, InstMap_9, Goal0_5, Goal_6, ModuleInfo0_8, &ModuleInfo_13);
