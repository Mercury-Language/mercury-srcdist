  ...
  MR_Word * Inst_16)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__inst_util__get_cons_id_arg_types_for_bound_inst_4_p_0(ModuleInfo_9, Type_12, X_17, &ArgTypes_24);
    ...
    else
    {
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(2, NewInst_43, 2) = ((MR_Box) (BoundInsts_15));
            }
      ...
      if (succeeded)
      {
        ...
        Var_41 = (MR_Word) ((MR_Unsigned) 0U);
        {
          ...
          MR_hl_field(2, Var_39, 2) = ((MR_Box) (BoundInsts_15));
        }
