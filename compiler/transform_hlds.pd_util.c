  ...
  MR_Word * STATE_VARIABLE_PDInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 98, &Debug_27);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 98, &DebugPD_11);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_16)
{
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, Goal0_5, Goal_6, VarTypes_12, InstVarSet_13, InstMap_9, ModuleInfo0_8, &ModuleInfo_14);
