  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo_15_95 = (MR_Word) (&hlds__make_hlds__superhomogeneous_scalar_common_1[0]);
      succeeded = mercury__list__member_2_p_0(TypeInfo_15_95, ((MR_Box) (ArgVar_93)), HeadVar__6_6);
      succeeded = !(succeeded);
    }
    if (succeeded)
    {
