  ...
  MR_Word * STATE_VARIABLE_UrInfo_27)
{
  ...
  if (((MR_tag((MR_Word) XTerm_28)) == (MR_Integer) 0))
  {
    ...
    if (((MR_tag((MR_Word) YTerm_29)) == (MR_Integer) 0))
    {
      ...
      hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(&TmpVar_50, STATE_VARIABLE_UrInfo_2_33, &STATE_VARIABLE_UrInfo_3_60);
  ...
  MR_Word * STATE_VARIABLE_UrInfo_23)
{
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(Goal0_11, &BaseGoals_29);
  {
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_33, GoalInfo0_19, Goal_12);
}
  ...
  MR_Word * STATE_VARIABLE_UrInfo_25)
{
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(Goal0_13, &BaseGoals_32);
  {
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_36, GoalInfo0_21, Goal_14);
}
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (((MR_tag((MR_Word) MaybeVarsCond_501)) == (MR_Integer) 0))
                                        {
                                          ...
                                          hlds__make_hlds__unravel_info__add_unravel_oom_errs_3_p_0(OoMVarsCondErrSpecs_532, STATE_VARIABLE_UrInfo_1_534, &STATE_VARIABLE_UrInfo_10_550);
                                          hlds__make_hlds__unravel_info__add_unravel_warns_3_p_0(VarsConsWarnSpecs_533, STATE_VARIABLE_UrInfo_10_550, STATE_VARIABLE_UrInfo_77);
                                        ...
                                        else
                                        {
                                          ...
                                          hlds__make_hlds__unravel_info__add_unravel_warns_3_p_0(CondWarningSpecs_506, STATE_VARIABLE_UrInfo_1_534, &STATE_VARIABLE_UrInfo_2_535);
      ...
      case (MR_Integer) 7:
        {
          ...
          ;
          {
            ...
            else
            {
              ...
              hlds__make_hlds__unravel_info__add_unravel_err_3_p_0(Spec_67, STATE_VARIABLE_UrInfo_0_76, &STATE_VARIABLE_UrInfo_9_168);
              hlds__make_hlds__unravel_info__record_unravel_found_syntax_error_2_p_0(STATE_VARIABLE_UrInfo_9_168, STATE_VARIABLE_UrInfo_77);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (((MR_tag((MR_Word) DeclTypeResult_335)) == (MR_Integer) 0))
                  {
                    ...
                    hlds__make_hlds__unravel_info__add_unravel_oom_errs_3_p_0(DeclTypeSpecs_341, STATE_VARIABLE_UrInfo_0_76, &STATE_VARIABLE_UrInfo_2_348);
                  }
                  else
                  {
                    ...
                    hlds__make_hlds__unravel_info__add_unravel_errs_3_p_0(TypeQualSpecs_340, STATE_VARIABLE_UrInfo_1_347, &STATE_VARIABLE_UrInfo_2_348);
                  }
      ...
      case (MR_Integer) 13:
        {
          ...
          ;
          {
            ...
            else
            {
              ...
              hlds__make_hlds__unravel_info__add_unravel_err_3_p_0(Spec_224, STATE_VARIABLE_UrInfo_0_76, &STATE_VARIABLE_UrInfo_9_243);
              hlds__make_hlds__unravel_info__record_unravel_found_syntax_error_2_p_0(STATE_VARIABLE_UrInfo_9_243, STATE_VARIABLE_UrInfo_77);
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (((MR_tag((MR_Word) MaybeVarsCond_425)) == (MR_Integer) 0))
                              {
                                ...
                                hlds__make_hlds__unravel_info__add_unravel_oom_errs_3_p_0(OoMVarsCondErrSpecs_456, STATE_VARIABLE_UrInfo_1_458, &STATE_VARIABLE_UrInfo_10_474);
                                hlds__make_hlds__unravel_info__add_unravel_warns_3_p_0(VarsConsWarnSpecs_457, STATE_VARIABLE_UrInfo_10_474, STATE_VARIABLE_UrInfo_77);
                              ...
                              else
                              {
                                ...
                                hlds__make_hlds__unravel_info__add_unravel_warns_3_p_0(CondWarningSpecs_430, STATE_VARIABLE_UrInfo_1_458, &STATE_VARIABLE_UrInfo_2_459);
        ...
        case (MR_Integer) 1:
          {
            ...
            hlds__make_hlds__unravel_info__add_unravel_warn_3_p_0(Spec_55, STATE_VARIABLE_UrInfo_0_33, STATE_VARIABLE_UrInfo_34);
          }
          break;
      }
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__unravel_info__add_unravel_warn_3_p_0(Spec_56, STATE_VARIABLE_UrInfo_0_34, &STATE_VARIABLE_UrInfo_1_36);
        }
        break;
    }
  }
  ...
  MR_Word * Goal_10)
{
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(BaseGoal_9, &BaseGoals_11);
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_14, GoalInfo_7, Goal_10);
}
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__unravel_info__add_unravel_warn_3_p_0(Spec_16, STATE_VARIABLE_UrInfo_0_17, STATE_VARIABLE_UrInfo_18);
        }
        break;
    }
  }
  ...
  MR_Word * Goal_10)
{
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_15, GoalInfo_7, Goal_10);
}
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) MaybeConsId_19)) == (MR_Integer) 0))
        {
          ...
          hlds__make_hlds__unravel_info__add_unravel_oom_errs_3_p_0(ConsIdSpecs_20, STATE_VARIABLE_UrInfo_0_29, STATE_VARIABLE_UrInfo_30);
        ...
        case (MR_Integer) 1:
          ...
          label_0:;
            ...
            else
            {
              ...
              hlds__make_hlds__unravel_info__add_unravel_err_3_p_0(Spec_28, STATE_VARIABLE_UrInfo_0_29, STATE_VARIABLE_UrInfo_30);
