...
MR_decl_label10(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0, 2,3,4,10,12,13,17,14,5,24)
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module14)
	...
	MR_init_label10(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,2,3,4,10,12,13,17,14,5,24)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,4)
	...
	if (MR_LTAGS_TEST(MR_sv(7),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0_i24);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,10)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__make_singleton_1_0,
		hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0_i12);
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_nonlocals_3_0,
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,13)
	...
	if (MR_RTAGS_TESTR(MR_sv(4),3,2)) {
		MR_GOTO_LAB(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0_i14);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_call_localret_ent(hlds__make_hlds__superhomogeneous__mark_nonlocals_in_ground_term_construct_2_0,
		hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0_i17);
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,5)
	...
	MR_r7 = MR_sv(11);
	MR_r8 = MR_sv(1);
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_21_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
