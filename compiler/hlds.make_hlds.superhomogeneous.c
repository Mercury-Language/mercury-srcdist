...
MR_decl_label8(hlds__make_hlds__superhomogeneous__build_lambda_expression_24_0, 40,39,42,43,44,48,49,50)
MR_decl_label2(hlds__make_hlds__superhomogeneous__build_lambda_expression_24_0, 51,53)
...
MR_decl_label8(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0, 2,3,4,10,13,14,18,15)
MR_decl_label2(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0, 5,26)
...
MR_decl_label8(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0, 162,164,165,176,148,179,182,183)
MR_decl_label8(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0, 178,186,187,188,192,193,190,195)
MR_decl_label4(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0, 197,199,202,204)
MR_decl_label6(__Unify___hlds__make_hlds__superhomogeneous__arg_context_0_0, 11,13,17,5,21,1)
MR_decl_label8(__Compare___hlds__make_hlds__superhomogeneous__arg_context_0_0, 3,2,18,22,31,35,37,5)
MR_decl_label4(__Compare___hlds__make_hlds__superhomogeneous__arg_context_0_0, 70,10,7,113)
...
MR_def_label(hlds__make_hlds__superhomogeneous__mark_nonlocals_in_ground_term_construct_2_0,29)
	...
	MR_tfield(1, MR_tempr4, 1) = MR_ctfield(1, MR_tempr3, 2);
	MR_sv(2) = MR_tempr2;
...
MR_decl_entry(fn__libs__handle_options__get_from_ground_term_threshold_0_0);
...
MR_define_entry(mercury__hlds__make_hlds__superhomogeneous__insert_arg_unifications_17_0);
	...
	MR_sv(9) = MR_r9;
	MR_sv(10) = MR_r10;
	MR_np_call_localret_ent(fn__libs__handle_options__get_from_ground_term_threshold_0_0,
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module16)
	...
	MR_init_label8(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,2,3,4,10,13,14,18,15)
	MR_init_label2(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,5,26)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,4)
	...
	if (MR_LTAGS_TEST(MR_sv(6),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0_i26);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("superhomogeneous.m", 18);
	MR_r2 = (MR_Word) MR_string_const("do_unravel_unification: from_ground_term not conj", 49);
...
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,5)
	...
	MR_r6 = MR_sv(8);
	MR_r7 = MR_sv(9);
MR_def_label(hlds__make_hlds__superhomogeneous__do_unravel_unification_19_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module18)
	...
	MR_init_label8(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0,162,164,165,176,148,179,182,183)
	MR_init_label8(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0,178,186,187,188,192,193,190,195)
	MR_init_label4(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0,197,199,202,204)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module19)
	...
	MR_init_label8(hlds__make_hlds__superhomogeneous__build_lambda_expression_24_0,40,39,42,43,44,48,49,50)
	MR_init_label2(hlds__make_hlds__superhomogeneous__build_lambda_expression_24_0,51,53)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module24)
	...
	MR_init_label8(__Compare___hlds__make_hlds__superhomogeneous__arg_context_0_0,3,2,18,22,31,35,37,5)
	MR_init_label4(__Compare___hlds__make_hlds__superhomogeneous__arg_context_0_0,70,10,7,113)
MR_BEGIN_CODE
