            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_205 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_534_534, GoalCordL_53, GoalCordR_55);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    *Expansion_32 = base;
          ...
          ;
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_234 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_536_536, RValGoalCord_64, CoerceGoalCord_73);
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  *Expansion_32 = base;
      ...
      case (MR_Integer) 5:
        {
          ...
          ;
          {
            ...
            MR_Word STATE_VARIABLE_VarSet_254_809;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ElseTerm0_923 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_235, (MR_Integer) 0))));
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    CondTerm0_924 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_243, (MR_Integer) 0))));
                                    Var_244 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_243, (MR_Integer) 1))));
                                    succeeded = (Var_244 != (MR_Word) ((MR_Unsigned) 0U));
                                    if (succeeded)
                                    {
                                      ThenTerm0_925 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_244, (MR_Integer) 0))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        parse_tree__parse_goal__parse_some_vars_goal_5_p_0(CondTerm_775, ContextPieces_839, &MaybeVarsCond_776, STATE_VARIABLE_VarSet_0_166, &STATE_VARIABLE_VarSet_254_809);
                                        if (((MR_tag((MR_Word) MaybeVarsCond_776)) == (MR_Integer) 0))
                                        {
                                          ...
                                          *STATE_VARIABLE_SVarState_163 = STATE_VARIABLE_SVarState_0_162;
                                          *STATE_VARIABLE_SVarStore_165 = STATE_VARIABLE_SVarStore_0_164;
                                          *STATE_VARIABLE_VarSet_167 = STATE_VARIABLE_VarSet_254_809;
                                          *STATE_VARIABLE_ModuleInfo_169 = STATE_VARIABLE_ModuleInfo_0_168;
                                          *STATE_VARIABLE_QualInfo_171 = STATE_VARIABLE_QualInfo_0_170;
                                        }
                                        else
                                        {
                                          ...
                                          MR_Word Goal_677;
                                          MR_Word STATE_VARIABLE_Specs_255_678;
                                          MR_Word STATE_VARIABLE_Specs_256_679;
                                          MR_Word STATE_VARIABLE_SVarStore_258_681;
                                          MR_Word STATE_VARIABLE_VarSet_259_682;
                                          MR_Word STATE_VARIABLE_ModuleInfo_260_683;
                                          MR_Word STATE_VARIABLE_QualInfo_261_684;
                                          MR_Word STATE_VARIABLE_Specs_262_685;
                                          MR_Word STATE_VARIABLE_VarSet_263_686;
                                          MR_Word STATE_VARIABLE_Specs_264_687;
                                          MR_Word STATE_VARIABLE_SVarStore_265_688;
                                          MR_Word STATE_VARIABLE_VarSet_266_689;
                                          MR_Word STATE_VARIABLE_ModuleInfo_267_690;
                                          MR_Word STATE_VARIABLE_QualInfo_268_691;
                                          MR_Word STATE_VARIABLE_Specs_269_692;
                                          MR_Word Var_693;
                                          MR_Word STATE_VARIABLE_VarSet_271_694;
                                          MR_Word STATE_VARIABLE_Specs_272_695;
                                          MR_Word STATE_VARIABLE_SVarStore_273_696;
                                          MR_Word STATE_VARIABLE_VarSet_274_697;
                                          MR_Word STATE_VARIABLE_Specs_277_698;
                                          MR_Word Var_699;
                                          MR_Word Var_701;
                                          MR_Word Var_703;

                                          STATE_VARIABLE_Specs_255_678 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), CondWarningSpecs_650, STATE_VARIABLE_Specs_0_172);
                                          hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_27, STATE_VARIABLE_VarSet_254_809, StateVars_648, STATE_VARIABLE_SVarState_0_162, &BeforeInsideSVarState_652, STATE_VARIABLE_Specs_255_678, &STATE_VARIABLE_Specs_256_679);
                                          ...
                                          hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0((MR_Integer) 1, CondParseTree_649, EmptySubst_653, &CondGoal_654, BeforeInsideSVarState_652, &AfterCondInsideSVarState_655, STATE_VARIABLE_SVarStore_0_164, &STATE_VARIABLE_SVarStore_258_681, STATE_VARIABLE_VarSet_254_809, &STATE_VARIABLE_VarSet_259_682, STATE_VARIABLE_ModuleInfo_0_168, &STATE_VARIABLE_ModuleInfo_260_683, STATE_VARIABLE_QualInfo_0_170, &STATE_VARIABLE_QualInfo_261_684, STATE_VARIABLE_Specs_256_679, &STATE_VARIABLE_Specs_262_685);
                                          hlds__make_hlds__state_var__substitute_state_var_mapping_8_p_0(ThenTerm0_925, &ThenTerm_656, STATE_VARIABLE_VarSet_259_682, &STATE_VARIABLE_VarSet_263_686, AfterCondInsideSVarState_655, &AfterThenInsideSVarState0_657, STATE_VARIABLE_Specs_262_685, &STATE_VARIABLE_Specs_264_687);
                                          ...
                                          hlds__make_hlds__superhomogeneous__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_108_97_115_115_105_102_121_95_117_110_114_97_118_101_108_95_118_97_114_95_117_110_105_102_105_99_97_116_105_111_110_95_95_91_55_93_95_48_21_p_0(XVar_23, ThenTerm_656, Context_27, MainContext_28, SubContext_29, Purity_30, AncestorVarMap_658, &ThenExpansion_659, AfterThenInsideSVarState0_657, &AfterThenInsideSVarState_660, STATE_VARIABLE_SVarStore_258_681, &STATE_VARIABLE_SVarStore_265_688, STATE_VARIABLE_VarSet_263_686, &STATE_VARIABLE_VarSet_266_689, STATE_VARIABLE_ModuleInfo_260_683, &STATE_VARIABLE_ModuleInfo_267_690, STATE_VARIABLE_QualInfo_261_684, &STATE_VARIABLE_QualInfo_268_691, STATE_VARIABLE_Specs_264_687, &STATE_VARIABLE_Specs_269_692);
                                          ...
                                          hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_267_690, &Globals_663);
                                          hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_267_690, &ModuleName_664);
                                          ...
                                          hlds__make_hlds__state_var__substitute_state_var_mapping_8_p_0(ElseTerm0_923, &ElseTerm_666, STATE_VARIABLE_VarSet_266_689, &STATE_VARIABLE_VarSet_271_694, STATE_VARIABLE_SVarState_0_162, &AfterElseSVarState0_667, STATE_VARIABLE_Specs_269_692, &STATE_VARIABLE_Specs_272_695);
                                          hlds__make_hlds__superhomogeneous__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_108_97_115_115_105_102_121_95_117_110_114_97_118_101_108_95_118_97_114_95_117_110_105_102_105_99_97_116_105_111_110_95_95_91_55_93_95_48_21_p_0(XVar_23, ElseTerm_666, Context_27, MainContext_28, SubContext_29, Purity_30, AncestorVarMap_658, &ElseExpansion_668, AfterElseSVarState0_667, &AfterElseSVarState_669, STATE_VARIABLE_SVarStore_265_688, &STATE_VARIABLE_SVarStore_273_696, STATE_VARIABLE_VarSet_271_694, &STATE_VARIABLE_VarSet_274_697, STATE_VARIABLE_ModuleInfo_267_690, STATE_VARIABLE_ModuleInfo_169, STATE_VARIABLE_QualInfo_268_691, STATE_VARIABLE_QualInfo_171, STATE_VARIABLE_Specs_272_695, &STATE_VARIABLE_Specs_277_698);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  ContextPieces_42 = mercury__cord__singleton_1_f_0(TypeCtorInfo_531_531, ((MR_Box) (Var_176)));
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              else
                              {
                                ...
                                Var_270 = mercury__term__get_term_context_1_f_0(TypeCtorInfo_537_537, ThenTerm_92);
                                ...
                                Var_278 = mercury__term__get_term_context_1_f_0(TypeCtorInfo_537_537, ElseTerm_102);
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                Var_381 = mercury__cord__singleton_1_f_0(TypeCtorInfo_551_551, ((MR_Box) (Goal_464)));
                                {
                                  MR_Word base;
                                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                                  *Expansion_32 = base;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_327 = mercury__cord__singleton_1_f_0(TypeCtorInfo_548_548, ((MR_Box) (Goal_443)));
                    {
                      MR_Word base;
                      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      *Expansion_32 = base;
