  ...
  MR_Word * hlds__make_hlds__superhomogeneous__STATE_VARIABLE_Specs_153)
{
  {
    MR_bool hlds__make_hlds__superhomogeneous__succeeded;
    MR_Integer hlds__make_hlds__superhomogeneous__slot_0 = ((MR_hash_string5(hlds__make_hlds__superhomogeneous__YAtom_24)) & (MR_Integer) 31);
    MR_String hlds__make_hlds__superhomogeneous__str_1 = ((&hlds__make_hlds__superhomogeneous_vector_common_7[0 + hlds__make_hlds__superhomogeneous__slot_0]))->hlds__make_hlds__superhomogeneous__vector_common_type_7_0__vct_7_f_0;
