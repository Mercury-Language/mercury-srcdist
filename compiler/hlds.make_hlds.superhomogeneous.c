  ...
  MR_Word * STATE_VARIABLE_Specs_60)
{
  ...
  else
  {
    ...
    ContextPieces_39 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ((MR_Box) (MR_mkword(3, &hlds__make_hlds__superhomogeneous_scalar_common_1[55]))));
  ...
  MR_Word * STATE_VARIABLE_Specs_102)
{
  ...
  else
  {
    ...
    InconsistentVarPieces_49 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_107, (MR_Word) (MR_mkword(1, &hlds__make_hlds__superhomogeneous_scalar_common_1[112])));
    {
