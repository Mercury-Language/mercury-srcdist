...
MR_decl_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0, 4,6,2,10,12,13,8,14,16,17)
MR_decl_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0, 20,18,24,25,27,28,29,30,31,35)
MR_decl_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0, 38,37,36,39,40,41,45,46,47,48)
MR_decl_label1(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0, 50)
...
MR_decl_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 30,6,36,37,38,39,40,41,42,34)
MR_decl_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 44,46,47,43,59,61,63,64,75,52)
MR_decl_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 77,78,79,81,82,85,88,89,87,95)
MR_decl_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 96,97,76,111,114,117,118,116,119,121)
MR_decl_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 122,124,125,126,127,128,130,99,133,136)
MR_decl_label7(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0, 137,140,139,142,143,145,1)
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module17)
	...
	MR_init_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,30,6,36,37,38,39,40,41,42,34)
	MR_init_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,44,46,47,43,59,61,63,64,75,52)
	MR_init_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,77,78,79,81,82,85,88,89,87,95)
	MR_init_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,96,97,76,111,114,117,118,116,119,121)
	MR_init_label10(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,122,124,125,126,127,128,130,99,133,136)
	MR_init_label7(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,137,140,139,142,143,145,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (((MR_Integer) MR_sv(1) + (MR_Integer) MR_sv(11)) + (MR_Integer) MR_sv(4));
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_sv(6) = MR_r3;
	{
...
MR_def_label(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,75)
	...
	MR_r2 = MR_r1;
	MR_tempr2 = MR_r3;
	MR_r3 = ((MR_Integer) MR_sv(1) + (MR_Integer) MR_tempr1);
	MR_tempr1 = MR_r4;
	MR_r4 = MR_tempr2;
	MR_tempr3 = MR_r5;
	MR_r5 = MR_tempr1;
...
MR_def_label(hlds__make_hlds__superhomogeneous__maybe_unravel_special_var_functor_unification_22_0,127)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (((MR_Integer) MR_sv(1) + (MR_Integer) MR_sv(13)) + (MR_Integer) MR_sv(4));
	MR_sv(6) = MR_r3;
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(7);
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module18)
	...
	MR_init_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0,4,6,2,10,12,13,8,14,16,17)
	MR_init_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0,20,18,24,25,27,28,29,30,31,35)
	MR_init_label10(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0,38,37,36,39,40,41,45,46,47,48)
	MR_init_label1(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0,50)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__superhomogeneous__build_lambda_expression_26_0,31)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tempr2 = MR_sv(6);
	MR_sv(6) = (((MR_Integer) MR_sv(15) + (MR_Integer) MR_sv(19)) + (MR_Integer) MR_r2);
	MR_sv(15) = MR_r5;
	MR_sv(17) = MR_r6;
	MR_sv(18) = MR_r8;
	MR_sv(19) = MR_r7;
