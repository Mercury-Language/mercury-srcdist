...
#line 55 "hlds.make_hlds.superhomogeneous.c"
...
#endif
#line 64 "hlds.make_hlds.superhomogeneous.c"
...
MR_decl_label3(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_2_9_0, 10,3,4)
...
MR_BEGIN_MODULE(hlds__make_hlds__superhomogeneous_module1)
	...
	MR_init_label3(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_2_9_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_2_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_2_9_0,4)
	...
	MR_GOTO_LAB(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_2_9_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(hlds__make_hlds__superhomogeneous__unravel_var_functor_unification_20_0,143)
	...
	MR_tempr7 = MR_r2;
	MR_tfield(2, MR_tempr2, 0) = MR_ctfield(0, MR_tempr7, 0);
	MR_tfield(2, MR_tempr2, 1) = MR_tempr6;
	MR_tfield(2, MR_tempr2, 2) = MR_ctfield(0, MR_tempr7, 1);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__superhomogeneous__build_lambda_expression_23_0,15)
	...
	MR_sv(21) = MR_r3;
	MR_sv(23) = MR_r4;
	MR_sv(24) = (MR_Word) MR_TAG_COMMON(0,0,6);
	MR_r1 = MR_sv(24);
	MR_r2 = MR_sv(12);
	MR_np_call_localret_ent(list__length_2_0,
