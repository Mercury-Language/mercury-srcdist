...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_35, Var_36);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_57, Var_58);
                  succeeded = (SubResult1_6 != (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = SubResult1_6;
                  else
                    mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_55, ArgY2_8);
                }
                break;
              case (MR_Integer) 1:
                *HeadVar__1_1 = (MR_Integer) 1;
