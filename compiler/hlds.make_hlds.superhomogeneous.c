                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (((MR_tag((MR_Word) MaybeVarsCond_492)) == (MR_Integer) 0))
                                        {
                                          ...
                                          hlds__make_hlds__state_var__add_unravel_oom_specs_3_p_0(VarsCondSpecs_523, STATE_VARIABLE_UrInfo_1_524, STATE_VARIABLE_UrInfo_77);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (((MR_tag((MR_Word) DeclTypeResult_335)) == (MR_Integer) 0))
                  {
                    ...
                    hlds__make_hlds__state_var__add_unravel_oom_specs_3_p_0(DeclTypeSpecs_341, STATE_VARIABLE_UrInfo_0_76, &STATE_VARIABLE_UrInfo_2_348);
                  }
                  else
                  {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (((MR_tag((MR_Word) MaybeVarsCond_421)) == (MR_Integer) 0))
                              {
                                ...
                                hlds__make_hlds__state_var__add_unravel_oom_specs_3_p_0(VarsCondSpecs_452, STATE_VARIABLE_UrInfo_1_453, STATE_VARIABLE_UrInfo_77);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) MaybeConsId_19)) == (MR_Integer) 0))
        {
          ...
          hlds__make_hlds__state_var__add_unravel_oom_specs_3_p_0(ConsIdSpecs_20, STATE_VARIABLE_UrInfo_0_29, STATE_VARIABLE_UrInfo_30);
