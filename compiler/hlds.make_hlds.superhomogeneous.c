        ...
        case (MR_Integer) 7:
          {
            ...
            ;
            {
              ...
              else
              {
                ...
                {
                  Msg_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Msg_134, 0) = ((MR_Box) (YFunctorContext_26));
                  MR_hl_field(MR_mktag(1), Msg_134, 1) = ((MR_Box) (Var_196));
                }
                {
        ...
        case (MR_Integer) 13:
          {
            ...
            ;
            {
              ...
              else
              {
                ...
                {
                  Msg_497 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Msg_497, 0) = ((MR_Box) (YFunctorContext_26));
                  MR_hl_field(MR_mktag(1), Msg_497, 1) = ((MR_Box) (Var_504));
                }
                {
  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_128 = (MR_Integer) ((MR_Unsigned) HeadVar__6_6 + (MR_Unsigned) 1);
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), InconsistentVarMsg_50, 1) = ((MR_Box) (Var_121));
      }
      {
