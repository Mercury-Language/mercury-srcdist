...
{
  {
    ...
    switch (MR_tag((MR_Word) Unification_8)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word VarType_83;
          MR_Word IsDummy_84;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_8, (MR_Integer) 5)));
      ...
      case (MR_Integer) 1:
        {
          MR_Word CanFail_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_8, (MR_Integer) 4))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_8, (MR_Integer) 4)));
