      ...
      case (MR_Integer) 0:
        {
          ...
          if (!((SubInfo_31 == (MR_Word) ((MR_Integer) 0))))
          {
...
{
  {
    ...
    succeeded = erl_backend__erl_unify_gen__cons_id_to_term_6_p_0(ConsId_11, Args_12, (MR_Word) ((MR_Integer) 0), &Pattern0_18, STATE_VARIABLE_Info_0_22, &STATE_VARIABLE_Info_25_25);
    if (succeeded)
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FailCase_21, 0) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
    ...
    erl_backend__erl_unify_gen__cons_id_to_expr_6_p_0(ConsId_10, Args_11, (MR_Word) ((MR_Integer) 0), &LHS_16, STATE_VARIABLE_Info_0_17, STATE_VARIABLE_Info_18);
...
{
  {
    ...
    if ((AssignFreeVars_21 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_68 = erl_backend__elds__exprs_from_vars_1_f_0(Args_8);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
          ...
          case (MR_Integer) 19:
            {
              ...
              {
                RttiId_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 20:
            {
              ...
              {
                TCName_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
              ...
              {
                RttiId_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
