    ...
    switch (MR_tag((MR_Word) ConsId_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 7:
            {
              int8_t Int8_21 = ((int8_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 8:
            {
              uint8_t UInt8_22 = ((uint8_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 9:
            {
              int16_t Int16_23 = ((int16_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 10:
            {
              uint16_t UInt16_24 = ((uint16_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 11:
            {
              int32_t Int32_25 = ((int32_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 12:
            {
              uint32_t UInt32_26 = ((uint32_t) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));
