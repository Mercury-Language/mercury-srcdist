    ...
    switch (MR_tag((MR_Word) ConsId_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 13:
            {
              MR_Integer Int64_27 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              {
                ...
                *Term_10 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Int64_27));
              }
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 14:
            {
              MR_Integer UInt64_28 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              {
                ...
                *Term_10 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (UInt64_28));
              }
              succeeded = MR_TRUE;
            }
            break;
          ...
          case (MR_Integer) 20:
            {
              ...
              MR_Integer Arity_79;
              MR_Word RttiId_80;
              MR_Integer _Instance_39 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 3)));
