...
static MR_bool MR_CALL 
erl_backend__erl_unify_gen__IntroducedFrom__pred__erl_gen_unification__158__1_2_p_0(
  MR_Word MaybeSizeProfInfo_33,
  MR_Word HeadVar__2_59);

static MR_bool MR_CALL 
erl_backend__erl_unify_gen__IntroducedFrom__pred__erl_gen_unification__152__1_2_p_0(
  MR_Word CodeModel_9,
...
{
  {
    ...
    succeeded = erl_backend__erl_unify_gen__IntroducedFrom__pred__erl_gen_unification__158__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = erl_backend__erl_unify_gen__IntroducedFrom__pred__erl_gen_unification__152__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
          ...
          case (MR_Integer) 19:
            {
              ...
              Var_73 = mercury__uint16__det_from_int_1_f_0(Arity_34);
              {
                ...
                MR_hl_field(MR_mktag(0), RttiTypeCtor_35, 2) = ((MR_Box) (MR_Word) (Var_73));
              }
              {
          ...
          case (MR_Integer) 20:
            {
              ...
              Arity_80 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 1))));
              ...
              ClassNameStr_43 = mdbcomp__sym_name__unqualify_name_1_f_0(ClassName_38);
              {
                ...
                MR_hl_field(MR_mktag(0), TCName_44, 2) = ((MR_Box) (Arity_80));
              }
              {
                RttiId_81 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), RttiId_81, 0) = ((MR_Box) (TCName_44));
                MR_hl_field(MR_mktag(3), RttiId_81, 1) = ((MR_Box) (InstanceModule_37));
                MR_hl_field(MR_mktag(3), RttiId_81, 2) = ((MR_Box) (InstanceStr_40));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *Expr_10 = base;
                MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (RttiId_81));
              }
              *STATE_VARIABLE_Info_54 = STATE_VARIABLE_Info_0_53;
            }
            break;
