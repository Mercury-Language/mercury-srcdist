    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 304, &HighLevelCode_52);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_67 = mercury__string__f_43_43_2_f_0(*TargetMutableName_18, (MR_String) ";\n");
        Var_69 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_67);
        Var_70 = mercury__string__f_43_43_2_f_0(TypeStr_55, Var_69);
        DefnBodyStr_56 = mercury__string__f_43_43_2_f_0((MR_String) "static ", Var_70);
        {
          Var_64 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (DefnBodyStr_56));
        }
        {
