...
{
  {
    ...
    {
      MainArgTypesAndModes_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_20, 0) = ((MR_Box) (Var_29));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    switch (PredKind_12) {
    ...
    {
      SetPredDecl_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 14 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 0) = ((MR_Box) (SymName_21));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 2) = ((MR_Box) (ArgTypesAndModes_22));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      ...
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 9) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 10) = ((MR_Box) (Purity_23));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 11) = ((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[1]));
...
{
  {
    ...
    {
      SymName_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      MainArgTypesAndModes_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_21, 0) = ((MR_Box) (Var_29));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    switch (PredKind_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
    ...
    {
      GetPredDecl_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 14 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 0) = ((MR_Box) (SymName_20));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 2) = ((MR_Box) (ArgTypesAndModes_22));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      ...
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 9) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 10) = ((MR_Box) (Purity_23));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 11) = ((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[1]));
...
{
  {
    ...
    {
      QualifiedCVarName0_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
