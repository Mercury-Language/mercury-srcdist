    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 301, &HighLevelCode_52);
  ...
  MR_Word * STATE_VARIABLE_PredTargetNames_43)
{
  ...
  Var_66 = mercury__string__f_43_43_2_f_0((MR_String) "initialise_mutable_", MutableName_18);
  {
    ...
    MR_hl_field(MR_mktag(1), InitPredName_36, 1) = ((MR_Box) (Var_66));
  }
  {
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 301, &HighLevelCode_19);
