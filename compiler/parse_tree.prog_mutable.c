...
MR_def_label(fn__parse_tree__prog_mutable__unsafe_get_pred_decl_5_0,3)
	...
	MR_sv(8) = (MR_Word) MR_TAG_COMMON(1,1,0);
	MR_r1 = (MR_Word) MR_string_const("unsafe_get_", 11);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
...
MR_def_label(fn__parse_tree__prog_mutable__lock_pred_decl_3_0,6)
	...
	MR_tfield(0, MR_tempr2, 9) = (MR_Word) MR_TAG_COMMON(1,1,1);
	MR_tfield(0, MR_tempr2, 10) = (MR_Word) MR_tbmkword(0, 0);
	MR_tfield(0, MR_tempr2, 11) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr2, 12) = MR_sv(5);
