...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 6) = ((MR_Box) (((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[0]))));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 6) = ((MR_Box) (((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[0]))));
