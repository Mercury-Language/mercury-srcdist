...
{
  {
    ...
    {
      Origin_20 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Origin_20, 0) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(2), Origin_20, 1) = ((MR_Box) (Name_9));
      MR_hl_field(MR_mktag(2), Origin_20, 2) = (MR_Box) ((MR_Unsigned) (Kind_13));
    }
