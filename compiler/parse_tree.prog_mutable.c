...
{
  {
    ...
    MR_Word MainArgTypesAndModes_18;
    MR_Word PredKind_19;
    MR_Word SymName_20;
    MR_Word ArgTypesAndModes_21;
    MR_Word Purity_22;
    MR_Word Attrs_23;
    MR_Word Origin_24;
    MR_Word Var_28;
    ...
    TypeVarSet_15 = mercury__varset__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0));
    InstVarSet_16 = mercury__varset__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0));
    Var_29 = parse_tree__prog_mode__in_mode_1_f_0(Inst_11);
    {
      Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (Type_10));
      MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) (Var_29));
    }
    {
      MainArgTypesAndModes_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_18, 0) = ((MR_Box) (Var_28));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    switch (GetSetPredKind_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_String Var_45;

          PredKind_19 = (MR_Integer) 7;
          Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "secret_initialization_only_set_", Name_9);
          {
            ...
            MR_hl_field(MR_mktag(1), SymName_20, 1) = ((MR_Box) (Var_45));
          }
          ArgTypesAndModes_21 = MainArgTypesAndModes_18;
          Purity_22 = (MR_Integer) 2;
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          PredKind_19 = (MR_Integer) 3;
          Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "set_", Name_9);
          {
            SymName_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SymName_20, 0) = ((MR_Box) (ModuleName_8));
            MR_hl_field(MR_mktag(1), SymName_20, 1) = ((MR_Box) (Var_49));
          }
          Var_52 = parse_tree__builtin_lib_types__io_state_type_0_f_0();
          ...
          Var_57 = parse_tree__prog_mode__uo_mode_0_f_0();
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Var_51));
            MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (Var_54));
          }
          ArgTypesAndModes_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0), MainArgTypesAndModes_18, Var_31);
          Purity_22 = (MR_Integer) 0;
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          PredKind_19 = (MR_Integer) 1;
          Var_61 = mercury__string__f_43_43_2_f_0((MR_String) "set_", Name_9);
          {
            SymName_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SymName_20, 0) = ((MR_Box) (ModuleName_8));
            MR_hl_field(MR_mktag(1), SymName_20, 1) = ((MR_Box) (Var_61));
          }
          ArgTypesAndModes_21 = MainArgTypesAndModes_18;
          Purity_22 = (MR_Integer) 2;
        }
    ...
    {
      Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) (Name_9));
      MR_hl_field(MR_mktag(1), Var_33, 2) = (MR_Box) ((MR_Unsigned) (PredKind_19));
    }
    {
      Attrs_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Attrs_23, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Attrs_23, 1) = ((MR_Box) (Var_33));
    }
    Origin_24 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Attrs_23)));
    {
      SetPredDecl_14 = (MR_Word) MR_new_object(MR_Word, (14 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 0) = ((MR_Box) (SymName_20));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 2) = ((MR_Box) (ArgTypesAndModes_21));
      ...
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_2[0])));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 6) = ((MR_Box) (Origin_24));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 7) = ((MR_Box) (TypeVarSet_15));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 8) = ((MR_Box) (InstVarSet_16));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 9) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 10) = (MR_Box) ((MR_Unsigned) (Purity_22));
      MR_hl_field(MR_mktag(0), SetPredDecl_14, 11) = ((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[0]));
...
{
  {
    ...
    MR_Word InstVarSet_16;
    MR_Word SymName_18;
    MR_Word MainArgTypesAndModes_19;
    MR_Word PredKind_20;
    MR_Word ArgTypesAndModes_21;
    MR_Word Purity_22;
    MR_Word Attrs_23;
    ...
    TypeVarSet_15 = mercury__varset__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0));
    InstVarSet_16 = mercury__varset__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0));
    Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "get_", Name_9);
    {
      SymName_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SymName_18, 0) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(1), SymName_18, 1) = ((MR_Box) (Var_45));
    }
    ...
    {
      MainArgTypesAndModes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_19, 0) = ((MR_Box) (Var_28));
      MR_hl_field(MR_mktag(1), MainArgTypesAndModes_19, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    switch (GetSetPredKind_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          PredKind_20 = (MR_Integer) 6;
          ArgTypesAndModes_21 = MainArgTypesAndModes_19;
          Purity_22 = (MR_Integer) 0;
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          PredKind_20 = (MR_Integer) 2;
          Var_48 = parse_tree__builtin_lib_types__io_state_type_0_f_0();
          ...
          {
            Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Var_47));
            MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (Var_50));
          }
          ArgTypesAndModes_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0), MainArgTypesAndModes_19, Var_31);
          Purity_22 = (MR_Integer) 0;
        }
        break;
      case (MR_Integer) 0:
        {
          PredKind_20 = (MR_Integer) 0;
          ArgTypesAndModes_21 = MainArgTypesAndModes_19;
          Purity_22 = (MR_Integer) 1;
        }
        break;
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) (Name_9));
      MR_hl_field(MR_mktag(1), Var_33, 2) = (MR_Box) ((MR_Unsigned) (PredKind_20));
    }
    {
      Attrs_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Attrs_23, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    ...
    Origin_24 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Attrs_23)));
    {
      ...
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 0) = ((MR_Box) (SymName_18));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 2) = ((MR_Box) (ArgTypesAndModes_21));
      ...
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_2[0])));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 6) = ((MR_Box) (Origin_24));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 7) = ((MR_Box) (TypeVarSet_15));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 8) = ((MR_Box) (InstVarSet_16));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 9) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 10) = (MR_Box) ((MR_Unsigned) (Purity_22));
      MR_hl_field(MR_mktag(0), GetPredDecl_14, 11) = ((MR_Box) (&parse_tree__prog_mutable_scalar_common_1[0]));
