      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 296, &HighLevelCode_52);
...
{
  {
    ...
    switch (Lang_30) {
      ...
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        parse_tree__prog_data_foreign__set_may_export_body_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_3[1])), Attrs0_32, &Attrs_34);
        break;
    }
      ...
      case (MR_Integer) 0:
        ...
        else
        {
          ...
          Var_33 = mercury__string__f_43_43_2_f_0(TargetMutableName_15, (MR_String) "_lock");
          {
            ...
            MR_hl_field(MR_mktag(1), Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_1[3])));
          }
          {
...
{
  {
    ...
    mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), &InstVarSet_23);
    {
      ...
      *PredDecl_16 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_3[0])));
      ...
      case (MR_Integer) 1:
        {
            ...
            TypeStr_34 = (MR_String) "java.lang.Object";
          {
            ...
            MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_mutable_scalar_common_1[4])));
          }
          {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 296, &HighLevelCode_19);
