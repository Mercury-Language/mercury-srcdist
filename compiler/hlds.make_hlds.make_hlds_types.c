...
static const MR_DuFunctorDescPtr hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_stag_ordered_ims_sub_list_1_0[1] = {
  &hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_functor_desc_ims_sub_list_1_0
};
...
static const MR_DuFunctorDescPtr hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_stag_ordered_sec_info_0_0[1] = {
  &hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_functor_desc_sec_info_0_0
};
...
static const MR_DuFunctorDescPtr hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_stag_ordered_sec_sub_list_1_0[1] = {
  &hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__du_functor_desc_sec_sub_list_1_0
};
  ...
  MR_Word HeadVar__3_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_sec_sub_list_1));
  ...
  MR_Word HeadVar__2_2)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__7_7, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_sec_sub_list_1));
  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    TypeInfo__8_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_ims_sub_list_1));
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 1) = ((MR_Box) (TypeInfo_for_T_6));
  }
  mercury__list____Compare____list_1_0(TypeInfo__8_8, HeadVar__1_1, (MR_Word) (Cast_HeadVar1_4), (MR_Word) (Cast_HeadVar2_5));
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  {
    TypeInfo__7_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), TypeInfo__7_7, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_ims_sub_list_1));
    MR_hl_field(MR_mktag(0), TypeInfo__7_7, 1) = ((MR_Box) (TypeInfo_for_T_5));
  }
  succeeded = mercury__list____Unify____list_1_0(TypeInfo__7_7, (MR_Word) (Cast_HeadVar1_3), (MR_Word) (Cast_HeadVar2_4));
  return succeeded;
