...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_12, (MR_Integer) 654, &Jobs_17);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 652, (MR_Word) (MR_mkword(MR_mktag(1), &make__build_scalar_common_3[1])), Globals_12, &NoRebuildGlobals_19);
