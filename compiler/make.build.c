  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  else
  {
    ...
    parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140make.build.unredirect_output\'/7", (MR_Word) (&make__build_scalar_common_2[0]), ModuleName_9, &ErrorFileName_16);
