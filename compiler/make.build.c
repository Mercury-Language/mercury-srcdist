  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 669, &Jobs_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 667, (MR_Word) (MR_mkword(1, &make__build_scalar_common_2[1])), Globals_14, &NoRebuildGlobals_22);
