  ...
  MR_Word * Succeeded_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 75, &VeryVerbose_20);
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 680, &Jobs_19);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 75, &VeryVerbose_47);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 678, (MR_Word) (MR_mkword(1, &make__build_scalar_common_2[1])), Globals_14, &NoRebuildGlobals_22);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (((MR_tag((MR_Word) MESI_13)) == (MR_Integer) 1))
  {
    ...
    else
    {
      ...
      libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 81, &MaybeLinesToWrite_63);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 81, &MaybeLinesToWrite_24);
        {
