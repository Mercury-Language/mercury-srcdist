  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 686, &Jobs_19);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 77, &VeryVerbose_47);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 684, (MR_Word) (MR_mkword(1, &make__build_scalar_common_2[0])), Globals_14, &NoRebuildGlobals_22);
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      make__library_install__install_library_grade_11_p_0(Var_47, Var_48, Var_49, HeadVar__3_3, HeadVar__4_4, Target_29, &NewSucceeded_34, STATE_VARIABLE_Info_0_8, &STATE_VARIABLE_Info_41_41);
      succeeded = (NewSucceeded_34 == (MR_Integer) 1);
      if (!(succeeded))
        succeeded = (HeadVar__1_1 == (MR_Integer) 1);
      if (succeeded)
