  ...
  MR_Word * Succeeded_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 79, &VeryVerbose_20);
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 688, &NumJobs_37);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 79, &VeryVerbose_50);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 686, (MR_Word) (MR_mkword(1, &make__build_scalar_common_2[0])), Globals_14, &NoRebuildGlobals_24);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (((MR_tag((MR_Word) MESI_13)) == (MR_Integer) 1))
  {
    ...
    else
    {
      ...
      libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 85, &MaybeLinesToWrite_63);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 85, &MaybeLinesToWrite_24);
        {
