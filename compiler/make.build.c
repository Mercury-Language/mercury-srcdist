  ...
  MR_Word * STATE_VARIABLE_Info_16)
{
  ...
  if (((MR_tag((MR_Word) ErrorFileResult_11)) == (MR_Integer) 1))
  {
    ...
    MR_Word MaybeLock_28;

    *MaybeErrorStream_8 = (MR_Word) ((MR_Unsigned) 0U);
    MaybeLock_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_15, (MR_Integer) 18))));
    if ((MaybeLock_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_String Var_58;

      Var_58 = mercury__string__f_43_43_2_f_0(ErrorMessage_14, (MR_String) "\n");
      mercury__io__write_string_3_p_0(Var_58);
    }
    else
    {
      MR_Box Lock_29 = ((MR_Box) ((MR_hl_field(MR_mktag(1), MaybeLock_28, (MR_Integer) 0))));
      MR_String Var_65;

      make__build__lock_stdout_3_p_0(Lock_29);
      Var_65 = mercury__string__f_43_43_2_f_0(ErrorMessage_14, (MR_String) "\n");
      mercury__io__write_string_3_p_0(Var_65);
      make__build__unlock_stdout_3_p_0(Lock_29);
    }
  }
  else
  {
