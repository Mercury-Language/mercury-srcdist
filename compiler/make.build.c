  ...
  MR_Word * Succeeded_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 131, &VeryVerbose_20);
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 484, &MaxNumJobs_37);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 131, &VeryVerbose_50);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (((MR_tag((MR_Word) MESI_13)) == (MR_Integer) 1))
  {
    ...
    else
    {
      ...
      libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 137, &MaybeLinesToWrite_63);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_maybe_int_option_3_p_0(Globals_11, (MR_Integer) 137, &MaybeLinesToWrite_24);
        {
