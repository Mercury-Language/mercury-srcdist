  ...
  MR_Word * HeadVar__4_105)
{
  ...
  Var_111 = libs__process_util__sigint_0_f_0();
  {
    ...
    MR_hl_field(0, Var_110, 1) = ((MR_Box) (make__build__IntroducedFrom__pred__foldl2_maybe_stop_at_error_parallel_processes__422__1_6_p_0_1));
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 660, (MR_Word) (MR_mkword(1, &make__build_scalar_common_2[1])), Globals_12, &NoRebuildGlobals_19);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  make__build__IntroducedFrom__pred__foldl2_maybe_stop_at_error_parallel_processes__422__1_6_p_0(((MR_Box) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__4_105);
    ...
    if ((OptionSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        *MayBuild_16 = base;
        ...
        MR_hl_field(1, base, 1) = ((MR_Box) (BuildGlobals_27));
      }
    else
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        *MayBuild_16 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (OptionSpecs_26));
      }
  }
}
