...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 70, &VeryVerbose_18);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 663, (MR_Word) (MR_mkword(MR_mktag(1), &make__build_scalar_common_2[1])), Globals_12, &NoRebuildGlobals_19);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 70, &VeryVerbose_23);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 76, &LinesToWrite_19);
