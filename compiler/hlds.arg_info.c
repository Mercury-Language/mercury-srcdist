    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 312, &UseFloatRegs_16);
  ...
  MR_Word * ArgInfos_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 312, &FloatRegs_12);
  switch (FloatRegs_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 312, &UseFloatRegs_11);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 312, &UseFloatRegs_5);
