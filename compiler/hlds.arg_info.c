...
#line 27 "hlds.arg_info.c"
#line 134 "../library/io.int2"
#include "io.mh"

#line 31 "hlds.arg_info.c"
#line 142 "../library/io.int2"
#include "string.mh"

#line 35 "hlds.arg_info.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 39 "hlds.arg_info.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "hlds.arg_info.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 47 "hlds.arg_info.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 51 "hlds.arg_info.c"
#line 52 "hlds.arg_info.c"
#include "hlds.arg_info.mh"

#line 55 "hlds.arg_info.c"
#line 56 "hlds.arg_info.c"
#ifndef HLDS__ARG_INFO_DECL_GUARD
#define HLDS__ARG_INFO_DECL_GUARD

#line 60 "hlds.arg_info.c"
#line 61 "hlds.arg_info.c"

#endif
#line 64 "hlds.arg_info.c"
...
MR_decl_label6(hlds__arg_info__compute_in_and_out_vars_2_6_0, 41,8,10,11,42,1)
MR_decl_label2(hlds__arg_info__generate_arg_info_2_0, 2,3)
MR_decl_label6(hlds__arg_info__generate_pred_arg_info_3_0, 14,4,5,6,7,3)
MR_decl_label4(hlds__arg_info__generate_proc_arg_info_4_0, 2,3,4,7)
MR_decl_label8(hlds__arg_info__generate_proc_list_arg_info_4_0, 20,4,5,6,7,8,9,10)
MR_decl_label4(hlds__arg_info__generate_proc_list_arg_info_4_0, 11,12,13,3)
MR_decl_label1(hlds__arg_info__make_arg_infos_5_0, 2)
MR_decl_label5(hlds__arg_info__make_arg_infos_list_6_0, 3,9,10,13,8)
MR_decl_label2(hlds__arg_info__partition_args_3_0, 2,3)
MR_decl_label6(hlds__arg_info__partition_args_4_0, 7,8,5,6,4,2)
MR_decl_label5(hlds__arg_info__partition_generic_call_args_7_0, 3,4,5,6,2)
MR_decl_label8(hlds__arg_info__partition_proc_args_5_0, 2,3,4,5,7,8,9,10)
MR_decl_label1(hlds__arg_info__partition_proc_args_5_0, 6)
MR_decl_label8(hlds__arg_info__partition_proc_args_2_10_0, 47,3,8,11,10,13,12,14)
MR_decl_label1(hlds__arg_info__partition_proc_args_2_10_0, 1)
...
MR_BEGIN_MODULE(hlds__arg_info_module0)
	...
	MR_init_label5(hlds__arg_info__make_arg_infos_list_6_0,3,9,10,13,8)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__make_arg_infos_list_6_0,9)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_6_0_i10);
	}
	{
	MR_Word MR_tempr1;
	...
	MR_r2 = MR_sv(4);
	MR_sv(1) = MR_tempr1;
	MR_r3 = ((MR_Integer) MR_ctfield(0, MR_tempr1, 0) + (MR_Integer) 1);
	MR_r4 = MR_sv(2);
	MR_r1 = MR_sv(5);
	}
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_6_0,
		hlds__arg_info__make_arg_infos_list_6_0_i13);
MR_def_label(hlds__arg_info__make_arg_infos_list_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_6_0,
		hlds__arg_info__make_arg_infos_list_6_0_i13);
MR_def_label(hlds__arg_info__make_arg_infos_list_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__arg_info__make_arg_infos_list_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("arg_info.m", 10);
	MR_r2 = (MR_Word) MR_string_const("make_arg_infos_list: length mismatch", 36);
...
MR_BEGIN_MODULE(hlds__arg_info_module1)
	...
	MR_init_label1(hlds__arg_info__make_arg_infos_5_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__arg_info__make_arg_infos_5_0);
	...
	if (MR_INT_NE(MR_r3,1)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_5_0_i2);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__arg_info__make_arg_infos_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__arg_info_module2)
	...
	MR_init_label4(hlds__arg_info__generate_proc_arg_info_4_0,2,3,4,7)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__generate_proc_arg_info_4_0,3)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_4_0_i4);
	}
	MR_r2 = MR_sv(1);
	MR_r5 = MR_sv(2);
	MR_r1 = MR_sv(3);
	...
	MR_np_call_localret_ent(hlds__arg_info__make_arg_infos_list_6_0,
		hlds__arg_info__generate_proc_arg_info_4_0_i7);
MR_def_label(hlds__arg_info__generate_proc_arg_info_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r5 = MR_sv(2);
	MR_r1 = MR_sv(3);
	...
	MR_np_call_localret_ent(hlds__arg_info__make_arg_infos_list_6_0,
		hlds__arg_info__generate_proc_arg_info_4_0_i7);
MR_def_label(hlds__arg_info__generate_proc_arg_info_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
...
MR_BEGIN_MODULE(hlds__arg_info_module3)
	...
	MR_init_label8(hlds__arg_info__generate_proc_list_arg_info_4_0,20,4,5,6,7,8,9,10)
	MR_init_label4(hlds__arg_info__generate_proc_list_arg_info_4_0,11,12,13,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__arg_info_module4)
	...
	MR_init_label6(hlds__arg_info__generate_pred_arg_info_3_0,14,4,5,6,7,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__generate_pred_arg_info_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__arg_info__generate_pred_arg_info_3_0,7)
	...
	MR_GOTO_LAB(hlds__arg_info__generate_pred_arg_info_3_0_i14);
...
MR_BEGIN_MODULE(hlds__arg_info_module6)
	...
	MR_init_label6(hlds__arg_info__compute_in_and_out_vars_2_6_0,41,8,10,11,42,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__arg_info__compute_in_and_out_vars_2_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__compute_in_and_out_vars_2_6_0_i41);
	}
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__compute_in_and_out_vars_2_6_0_i42);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__arg_info__compute_in_and_out_vars_2_6_0_i11);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(hlds__arg_info__compute_in_and_out_vars_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("arg_info.m", 10);
	MR_r2 = (MR_Word) MR_string_const("compute_in_and_out_vars: length mismatch", 40);
...
MR_def_label(hlds__arg_info__unify_arg_info_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("arg_info.m", 10);
	MR_r2 = (MR_Word) MR_string_const("unify_arg_info: nondet unify!", 29);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(hlds__arg_info_module9)
	...
	MR_init_label6(hlds__arg_info__partition_args_4_0,7,8,5,6,4,2)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__partition_args_4_0,7)
	...
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	break; } /* end while */
MR_def_label(hlds__arg_info__partition_args_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__arg_info__partition_args_4_0,5)
	...
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(hlds__arg_info__partition_args_4_0_i6);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__arg_info__partition_args_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__arg_info__partition_args_4_0,4)
	...
	if (((MR_Integer) MR_sp > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(hlds__arg_info__partition_args_4_0_i8);
	}
	MR_proceed();
...
MR_BEGIN_MODULE(hlds__arg_info_module11)
	...
	MR_init_label8(hlds__arg_info__partition_proc_args_2_10_0,47,3,8,11,10,13,12,14)
	MR_init_label1(hlds__arg_info__partition_proc_args_2_10_0,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__arg_info__partition_proc_args_2_10_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__arg_info__partition_proc_args_2_10_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__arg_info__partition_proc_args_2_10_0,11)
	...
	MR_r7 = MR_sv(4);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__arg_info__partition_proc_args_2_10_0_i47);
...
MR_BEGIN_MODULE(hlds__arg_info_module12)
	...
	MR_init_label8(hlds__arg_info__partition_proc_args_5_0,2,3,4,5,7,8,9,10)
	MR_init_label1(hlds__arg_info__partition_proc_args_5_0,6)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__partition_proc_args_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("arg_info.m", 10);
	MR_r2 = (MR_Word) MR_string_const("do_partition_proc_args: list length mismatch", 44);
...
void mercury__hlds__arg_info__write_out_proc_statics(FILE *fp);
#endif
