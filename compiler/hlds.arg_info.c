    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(HeadVar__1_1, Mode_14, Type_16, &TopFunctorMode_24);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(HeadVar__1_1, Mode_19, Type_21, &TopFunctorMode_25);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 301, &UseFloatRegs_18);
