  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  {
    MR_Integer FirstOutRegR_42;

    switch (CodeModel_24) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        FirstOutRegR_42 = (MR_Integer) 1;
        break;
      case (MR_Integer) 1:
        FirstOutRegR_42 = (MR_Integer) 2;
        break;
    }
    hlds__arg_info__make_reg_r_arg_infos_loop_6_p_0(ModuleInfo_6, ArgTypes_8, ArgModes_23, (MR_Integer) 1, FirstOutRegR_42, &ArgInfos_27);
  }
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    {
      MR_Integer FirstOutRegR_49;

      switch (CodeModel_31) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        case (MR_Integer) 2:
          FirstOutRegR_49 = (MR_Integer) 1;
          break;
        case (MR_Integer) 1:
          FirstOutRegR_49 = (MR_Integer) 2;
          break;
      }
      hlds__arg_info__make_reg_r_arg_infos_loop_6_p_0(ModuleInfo_1, ArgTypes_4, ArgModes_30, (MR_Integer) 1, FirstOutRegR_49, &ArgInfos_34);
    }
