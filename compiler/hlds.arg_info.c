  ...
  MR_Word * Unuseds_10)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_14, Vars_11, &Types_15);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          hlds__var_table__lookup_var_entry_3_p_0(VarTable_2, Var_14, &Entry_24);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          hlds__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_14, &Type_24);
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__var_table__lookup_var_entry_3_p_0(VarTable_2, Var_45, &Entry_33);
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_42, &Type_33);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 300, &UseFloatRegs_16);
  ...
  MR_Word * ArgInfos_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 300, &FloatRegs_12);
  switch (FloatRegs_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 300, &UseFloatRegs_11);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &HeadVars_23);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &ArgModes_24);
  CodeModel_25 = hlds__code_model__proc_info_interface_code_model_1_f_0(STATE_VARIABLE_ProcInfo_0_12);
  succeeded = (UseFloatRegs_11 == (MR_Integer) 1);
  if (succeeded)
  {
    Var_29 = (MR_Integer) 11;
    succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_7, Var_29);
    succeeded = !(succeeded);
  }
  if (succeeded)
  {
    MR_Word RegR_HeadVars_26;
    MR_Word ArgRegTypes_27;
    MR_Word Var_30;

    hlds__hlds_pred__proc_info_get_reg_r_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &RegR_HeadVars_26);
    {
      Var_30 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&hlds__arg_info_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_30, 1) = ((MR_Box) (hlds__arg_info__generate_proc_arg_info_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_30, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_30, 3) = ((MR_Box) (RegR_HeadVars_26));
    }
    mercury__list__map_corresponding_4_p_0((MR_Word) (&hlds__arg_info_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_reg_type_0), Var_30, HeadVars_23, ArgTypes_8, &ArgRegTypes_27);
    hlds__arg_info__make_arg_infos_6_p_0(ModuleInfo_6, CodeModel_25, ArgTypes_8, ArgModes_24, ArgRegTypes_27, &ArgInfos_28);
  }
  else
  {
    MR_Integer FirstOutRegR_44;

    switch (CodeModel_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        FirstOutRegR_44 = (MR_Integer) 1;
        break;
      case (MR_Integer) 1:
        FirstOutRegR_44 = (MR_Integer) 2;
        break;
    }
    hlds__arg_info__make_reg_r_arg_infos_loop_6_p_0(ModuleInfo_6, ArgTypes_8, ArgModes_24, (MR_Integer) 1, FirstOutRegR_44, &ArgInfos_28);
  }
  hlds__hlds_pred__proc_info_set_arg_info_3_p_0(ArgInfos_28, STATE_VARIABLE_ProcInfo_0_12, STATE_VARIABLE_ProcInfo_13);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 300, &UseFloatRegs_5);
