...
{
  {
    ...
    succeeded = hlds__arg_info__compute_in_and_out_vars_2_8_p_0(ModuleInfo_7, Vars_8, Modes_9, Types_10, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_InVars_16_16, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_OutVars_18_18);
    if (succeeded)
    {
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (UseFloatRegs_18) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            if ((MaybeArgRegs_11 == (MR_Word) ((MR_Integer) 0)))
            {
              {
