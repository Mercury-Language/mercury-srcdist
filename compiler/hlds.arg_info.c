      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__arg_info__Globals_17, (MR_Integer) 257, &hlds__arg_info__UseFloatRegs_18);
          }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__arg_info__Globals_11, (MR_Integer) 257, &hlds__arg_info__FloatRegs_12);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__arg_info__Globals_10, (MR_Integer) 257, &hlds__arg_info__UseFloatRegs_11);
    }
    {
