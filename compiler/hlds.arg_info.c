...
MR_decl_label10(hlds__arg_info__generate_proc_arg_info_5_0, 2,3,4,8,7,6,12,13,15,16)
...
MR_decl_label1(hlds__arg_info__make_arg_infos_6_0, 3)
MR_decl_label10(hlds__arg_info__make_arg_infos_list_9_0, 3,9,11,12,10,14,18,16,24,29)
MR_decl_label1(hlds__arg_info__make_arg_infos_list_9_0, 8)
...
MR_decl_static(hlds__arg_info__make_arg_infos_list_9_0)
...
MR_BEGIN_MODULE(hlds__arg_info_module0)
	MR_init_entry1(hlds__arg_info__make_arg_infos_list_9_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__arg_info__make_arg_infos_list_9_0);
	MR_init_label10(hlds__arg_info__make_arg_infos_list_9_0,3,9,11,12,10,14,18,16,24,29)
	MR_init_label1(hlds__arg_info__make_arg_infos_list_9_0,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_arg_infos_list'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__arg_info__make_arg_infos_list_9_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i8);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(check_hlds__mode_util__mode_to_arg_mode_4_0,
		hlds__arg_info__make_arg_infos_list_9_0_i9);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_np_call_localret_ent(fn__parse_tree__builtin_lib_types__float_type_0_0,
		hlds__arg_info__make_arg_infos_list_9_0_i11);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		hlds__arg_info__make_arg_infos_list_9_0_i12);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i10);
	}
	MR_r3 = MR_sv(8);
	MR_r5 = MR_sv(2);
	MR_r6 = MR_sv(3);
	...
	MR_r4 = MR_r8;
	MR_r1 = MR_sv(10);
	MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i14);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(8);
	MR_r5 = MR_sv(2);
	MR_r6 = MR_sv(3);
	...
	MR_r4 = (MR_Integer) 0;
	MR_r1 = MR_sv(10);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(9),0)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i16);
	}
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i18);
	}
	{
	...
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_9_0,
		hlds__arg_info__make_arg_infos_list_9_0_i29);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_9_0,
		hlds__arg_info__make_arg_infos_list_9_0_i29);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_list_9_0_i24);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_9_0,
		hlds__arg_info__make_arg_infos_list_9_0_i29);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_localcall_lab(hlds__arg_info__make_arg_infos_list_9_0,
		hlds__arg_info__make_arg_infos_list_9_0_i29);
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__arg_info__make_arg_infos_list_9_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("hlds.arg_info", 13);
	MR_r2 = (MR_Word) MR_string_const("predicate \140hlds.arg_info.make_arg_infos_list\'/9", 47);
...
MR_BEGIN_MODULE(hlds__arg_info_module1)
	...
	MR_init_label1(hlds__arg_info__make_arg_infos_6_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__arg_info__make_arg_infos_6_0);
	...
	MR_r4 = (MR_Integer) 1;
	MR_r6 = (MR_Integer) 1;
	MR_np_tailcall_ent(hlds__arg_info__make_arg_infos_list_9_0);
	}
...
MR_BEGIN_MODULE(hlds__arg_info_module2)
	...
	MR_init_label10(hlds__arg_info__generate_proc_arg_info_5_0,2,3,4,8,7,6,12,13,15,16)
...
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(5),0,8)) {
		MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_5_0_i8);
	}
	MR_r2 = MR_sv(1);
	MR_r7 = MR_sv(2);
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_5_0_i7);
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(3);
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = (MR_Integer) 0;
	MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_5_0_i16);
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		hlds__arg_info__generate_proc_arg_info_5_0_i12);
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 243;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		hlds__arg_info__generate_proc_arg_info_5_0_i13);
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_5_0_i15);
	}
	MR_r2 = MR_sv(1);
	MR_r7 = MR_sv(2);
	MR_r1 = MR_sv(3);
...
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,15)
	...
	MR_r1 = MR_sv(3);
	MR_r8 = (MR_Integer) 1;
MR_def_label(hlds__arg_info__generate_proc_arg_info_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(5),1)) {
		MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_5_0_i18);
	}
	MR_r5 = (MR_Integer) 2;
	MR_r3 = (MR_Integer) 1;
	MR_r4 = (MR_Integer) 1;
	MR_r6 = (MR_Integer) 1;
	MR_np_call_localret_ent(hlds__arg_info__make_arg_infos_list_9_0,
