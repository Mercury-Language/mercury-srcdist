  ...
  MR_Word * ArgInfo_10)
{
  ...
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_reg_type_0), Var_16, ArgTypes_8, &RegTypes_14);
  hlds__arg_info__make_arg_infos_6_p_0(ModuleInfo_6, CodeModel_7, ArgTypes_8, ArgModes_9, RegTypes_14, ArgInfo_10);
}
  ...
  MR_Word * ModuleInfo_4)
{
  ...
  hlds__hlds_module__module_info_get_pred_id_table_2_p_0(ModuleInfo0_3, &PredIdTable_5);
  mercury__map__keys_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_5, &PredIds_6);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_2, PredId_7, &PredInfo_10);
      Var_13 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo_10);
      hlds__arg_info__generate_proc_list_arg_info_4_p_0(PredId_7, Var_13, STATE_VARIABLE_ModuleInfo_0_2, &STATE_VARIABLE_ModuleInfo_14_14);
      // direct tailcall eliminated
      ;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_3, HeadVar__1_1, &PredInfo0_13);
      hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_13, &Markers_14);
      hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_13, &ArgTypes_15);
      hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo0_13, ProcId_10, &ProcInfo0_16);
      hlds__arg_info__generate_proc_arg_info_5_p_0(Markers_14, ArgTypes_15, STATE_VARIABLE_ModuleInfo_0_3, ProcInfo0_16, &ProcInfo_17);
      hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_10, ProcInfo_17, PredInfo0_13, &PredInfo_18);
      hlds__hlds_module__module_info_set_pred_info_4_p_0(HeadVar__1_1, PredInfo_18, STATE_VARIABLE_ModuleInfo_0_3, &STATE_VARIABLE_ModuleInfo_21_21);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = ProcIds_11;
      next_value_of_STATE_VARIABLE_ModuleInfo_0_3 = STATE_VARIABLE_ModuleInfo_21_21;
      HeadVar__2_2 = next_value_of_HeadVar__2_2;
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_19)
{
  ...
  hlds__arg_info__make_arg_infos_6_p_0(ModuleInfo_8, CodeModel_16, ArgTypes_7, ArgModes_15, ArgRegTypes_14, &ArgInfo_17);
  ...
  MR_Word * ArgInfo_12)
{
  ...
  succeeded = hlds__arg_info__make_arg_infos_loop_9_p_0(ModuleInfo_7, ArgModes_10, ArgTypes_9, ArgRegTypes_11, (MR_Integer) 1, (MR_Integer) 1, FirstOutRegR_13, (MR_Integer) 1, &ArgInfoPrime_17);
  if (succeeded)
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      Type_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
      Types_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
      succeeded = (HeadVar__4_4 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ...
        check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(ModuleInfo_1, Mode_16, Type_18, &TopFunctorMode_28);
        ...
        succeeded = hlds__arg_info__make_arg_infos_loop_9_p_0(ModuleInfo_1, Modes_17, Types_19, RegTypes_21, STATE_VARIABLE_InRegR_36_36, STATE_VARIABLE_InRegF_37_37, STATE_VARIABLE_OutRegR_34_34, STATE_VARIABLE_OutRegF_35_35, &ArgInfos_27);
        if (succeeded)
        {
          {
            MR_Word base;
