...
MR_decl_label6(hlds__arg_info__compute_in_and_out_vars_2_6_0, 49,8,10,12,50,1)
...
MR_decl_label5(hlds__arg_info__generate_proc_arg_info_4_0, 2,3,9,5,7)
MR_decl_label8(hlds__arg_info__generate_proc_list_arg_info_4_0, 19,3,4,5,6,7,8,9)
MR_decl_label4(hlds__arg_info__generate_proc_list_arg_info_4_0, 10,11,12,13)
MR_decl_label2(hlds__arg_info__make_arg_infos_5_0, 8,3)
MR_decl_label5(hlds__arg_info__make_arg_infos_list_6_0, 3,9,11,13,8)
...
MR_BEGIN_MODULE(hlds__arg_info_module0)
	...
	MR_init_label5(hlds__arg_info__make_arg_infos_list_6_0,3,9,11,13,8)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__arg_info_module1)
	...
	MR_init_label2(hlds__arg_info__make_arg_infos_5_0,8,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__make_arg_infos_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__arg_info__make_arg_infos_5_0,3)
	...
	if (MR_INT_NE(MR_r3,1)) {
		MR_GOTO_LAB(hlds__arg_info__make_arg_infos_5_0_i8);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__arg_info_module2)
	...
	MR_init_label5(hlds__arg_info__generate_proc_arg_info_4_0,2,3,9,5,7)
MR_BEGIN_CODE
...
MR_def_label(hlds__arg_info__generate_proc_arg_info_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r5 = MR_sv(2);
	MR_r1 = MR_sv(3);
...
MR_def_label(hlds__arg_info__generate_proc_arg_info_4_0,5)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__arg_info__generate_proc_arg_info_4_0_i9);
	}
	MR_r2 = MR_sv(1);
	MR_r5 = MR_sv(2);
	MR_r1 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__arg_info_module3)
	...
	MR_init_label8(hlds__arg_info__generate_proc_list_arg_info_4_0,19,3,4,5,6,7,8,9)
	MR_init_label4(hlds__arg_info__generate_proc_list_arg_info_4_0,10,11,12,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__arg_info_module6)
	...
	MR_init_label6(hlds__arg_info__compute_in_and_out_vars_2_6_0,49,8,10,12,50,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__arg_info__compute_in_and_out_vars_2_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__compute_in_and_out_vars_2_6_0_i49);
	}
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__arg_info__compute_in_and_out_vars_2_6_0_i50);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(hlds__arg_info__compute_in_and_out_vars_2_6_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
