  ...
  MR_Word * Unuseds_14)
{
  ...
  succeeded = hlds__arg_info__partition_proc_args_2_10_p_0(ModuleInfo_8, Vars_9, Types_10, Modes_11, Var_25, &STATE_VARIABLE_Inputs_19_26, Var_27, &STATE_VARIABLE_Outputs_21_28, Var_29, &STATE_VARIABLE_Unuseds_23_30);
  if (succeeded)
  {
  ...
  MR_Word * Unuseds_14)
{
  ...
  succeeded = hlds__arg_info__partition_proc_args_2_10_p_0(ModuleInfo_8, Vars_11, Types_16, Modes_15, Var_27, &STATE_VARIABLE_Inputs_19_28, Var_29, &STATE_VARIABLE_Outputs_21_30, Var_31, &STATE_VARIABLE_Unuseds_23_32);
  if (succeeded)
  {
  ...
  MR_Word * Unuseds_10)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_6, ProcInfo_7, &VarTable_13);
  parse_tree__var_table__lookup_var_types_3_p_0(VarTable_13, Vars_11, &Types_14);
  Var_25 = mercury__set__init_0_f_0((MR_Word) (&hlds__arg_info_scalar_common_1[0]));
  Var_27 = mercury__set__init_0_f_0((MR_Word) (&hlds__arg_info_scalar_common_1[0]));
  Var_29 = mercury__set__init_0_f_0((MR_Word) (&hlds__arg_info_scalar_common_1[0]));
  succeeded = hlds__arg_info__partition_proc_args_2_10_p_0(ModuleInfo_6, Vars_11, Types_14, Modes_12, Var_25, &STATE_VARIABLE_Inputs_19_26, Var_27, &STATE_VARIABLE_Outputs_21_28, Var_29, &STATE_VARIABLE_Unuseds_23_30);
  if (succeeded)
  {
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__arg_info__compute_in_and_out_vars_6_p_0(ModuleInfo_1, VarTable_2, Var_44, Modes_30, &STATE_VARIABLE_InVars_38_38, &STATE_VARIABLE_OutVars_39_39);
