          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), hlds__hhf__Var_76, 0) = ((MR_Box) (&hlds__hhf_scalar_common_4[2]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), hlds__hhf__Var_29, 0) = ((MR_Box) (&hlds__hhf_scalar_common_4[0]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), hlds__hhf__Var_45, 0) = ((MR_Box) (&hlds__hhf_scalar_common_4[1]));
    ...
    if (hlds__hhf__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__hhf__Var_39, 0) = ((MR_Box) (&hlds__hhf_scalar_common_3[0]));
