  ...
  MR_Word * STATE_VARIABLE_HI_16)
{
  ...
  GoalExpr0_23 = ((MR_Word) ((MR_hl_field(0, Goal0_10, 0))));
  GoalInfo_24 = ((MR_Word) ((MR_hl_field(0, Goal0_10, 1))));
  hlds__hhf__convert_goal_expr_to_hhf_6_p_0(NonLocals_13, GoalInfo_24, GoalExpr0_23, &GoalExpr_25, STATE_VARIABLE_HI_0_15, STATE_VARIABLE_HI_16);
  {
    Goal_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Goal_14, 0) = ((MR_Box) (GoalExpr_25));
    MR_hl_field(0, Goal_14, 1) = ((MR_Box) (GoalInfo_24));
  }
