...
MR_def_label(hlds__hhf__process_pred_6_0,25)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(hlds__hhf__IntroducedFrom__pred__process_pred__99__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_def_label(hlds__hhf__make_unifications_7_0,3)
	...
	MR_tempr7 = MR_r6;
	MR_tfield(0, MR_tempr2, 4) = MR_tempr7;
	MR_tempr8 = MR_r3;
	MR_sv(1) = MR_tempr8;
	MR_sv(2) = MR_tempr5;
	MR_sv(3) = MR_tempr6;
...
MR_def_static(hlds__hhf__process_unify_10_0)
	...
	MR_sv(9) = MR_tfield(2, MR_tempr2, 5);
	MR_sv(10) = MR_tfield(2, MR_tempr2, 6);
	MR_sv(11) = MR_tfield(2, MR_tempr2, 7);
	MR_tempr1 = MR_tempr2;
	MR_r1 = MR_r2;
