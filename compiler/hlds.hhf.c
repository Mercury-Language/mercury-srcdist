        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (&hlds__hhf_scalar_common_3[2]));
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          InstGraph1_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HI_55_55, (MR_Integer) 0))));
          ...
          Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HI_55_55, (MR_Integer) 1))));
