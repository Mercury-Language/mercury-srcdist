  ...
  void * cont_env_ptr)
{
  ...
  (env).hlds__hhf__convert_pred_to_hhf_7_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    hlds__hhf__IntroducedFrom__pred__convert_pred_to_hhf__99__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), &(env).hlds__hhf__convert_pred_to_hhf_7_p_0_2_env_0__conv0_LambdaHeadVar__1_42, hlds__hhf__convert_pred_to_hhf_7_p_0_1, &env);
  }
}
