      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            Var_41 = ((MR_Word) ((MR_hl_field(1, B_21, 0))));
            ArgsB_29 = ((MR_Word) ((MR_hl_field(1, B_21, 1))));
            succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Name_26, Var_41);
            if (succeeded)
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            Var_42 = ((MR_Word) ((MR_hl_field(2, B_21, 0))));
            succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_31, Var_42);
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_43 = ((MR_Unsigned) ((MR_hl_field(3, B_21, 1))) & (MR_Integer) 1);
                ArgsB_36 = ((MR_Word) ((MR_hl_field(3, B_21, 2))));
                Var_44 = ((MR_Word) ((MR_hl_field(3, B_21, 3))));
                Var_45 = ((MR_Unsigned) ((MR_hl_field(3, B_21, 4))) & (MR_Integer) 3);
                succeeded = (PorF_32 == Var_43);
                if (succeeded)
                {
                  succeeded = parse_tree__prog_data____Unify____ho_inst_info_0_0(HOInstInfo_34, Var_44);
                  if (succeeded)
                  {
                    succeeded = (Purity_35 == Var_45);
                    if (succeeded)
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_28 = ((MR_Word) ((MR_hl_field(1, B_8, 0))));
                ArgsB_16 = ((MR_Word) ((MR_hl_field(1, B_8, 1))));
                succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Name_13, Var_28);
                if (succeeded)
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                Var_29 = ((MR_Word) ((MR_hl_field(2, B_8, 0))));
                succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_18, Var_29);
              }
            }
            break;
          case (MR_Integer) 3:
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    Var_30 = ((MR_Unsigned) ((MR_hl_field(3, B_8, 1))) & (MR_Integer) 1);
                    ArgsB_23 = ((MR_Word) ((MR_hl_field(3, B_8, 2))));
                    Var_31 = ((MR_Word) ((MR_hl_field(3, B_8, 3))));
                    Var_32 = ((MR_Unsigned) ((MR_hl_field(3, B_8, 4))) & (MR_Integer) 3);
                    succeeded = (PorF_19 == Var_30);
                    if (succeeded)
                    {
                      succeeded = parse_tree__prog_data____Unify____ho_inst_info_0_0(HOInstInfo_21, Var_31);
                      if (succeeded)
                      {
                        succeeded = (Purity_22 == Var_32);
                        if (succeeded)
