      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word IsExistConstruct_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS0_11, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          {
            RHS_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), RHS_63, 0) = ((MR_Box) (ConsId_36));
            MR_hl_field(MR_mktag(1), RHS_63, 1) = (MR_Box) ((MR_Unsigned) (IsExistConstruct_33));
            MR_hl_field(MR_mktag(1), RHS_63, 2) = ((MR_Box) (Args_42));
          }
          {
            UnifyGoalExpr_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word H_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_11, (MR_Integer) 5))) & (MR_Integer) 7);
          ...
          {
            LambdaGoal_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), LambdaGoal_29, 0) = ((MR_Box) (GoalExpr_90));
            MR_hl_field(MR_mktag(0), LambdaGoal_29, 1) = ((MR_Box) (GoalInfo_89));
          }
          {
            RHS_30 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), RHS_30, 0) = (MR_Box) (packed_word_1);
            ...
            MR_hl_field(MR_mktag(2), RHS_30, 5) = (MR_Box) ((MR_Unsigned) (H_27));
