  ...
  MR_Word * InstGraph_9)
{
  ...
  InstGraph0_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info1_19, (MR_Integer) 0))));
  mercury__map__keys_2_p_0((MR_Word) (&hlds__hhf_scalar_common_1[0]), (MR_Word) (&hlds__inst_graph__hlds__inst_graph__type_ctor_info_node_0), InstGraph0_38, &Vars_39);
  {
    Var_40 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&hlds__hhf_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (hlds__hhf__convert_clauses_info_to_hhf_5_p_0_2));
    MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (ModuleInfo_7));
    MR_hl_field(MR_mktag(0), Var_40, 4) = ((MR_Box) (Vars_39));
  }
  mercury__list__foldl_4_p_0((MR_Word) (&hlds__hhf_scalar_common_1[0]), (MR_Word) (&hlds__hhf__hlds__hhf__type_ctor_info_hhf_info_0), Var_40, Vars_39, ((MR_Box) (Info1_19)), &conv4_Info_21);
