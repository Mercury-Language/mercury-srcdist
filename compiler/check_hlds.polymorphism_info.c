...
#line 818 "polymorphism_info.m"
void 
check_hlds__polymorphism_info__user_init_pred_160_0(void)
#line 818 "polymorphism_info.m"
{
#line 818 "polymorphism_info.m"
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo_16_16 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo_43_43 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  *Specs_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 16))));
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_13, VarTypes_14, STATE_VARIABLE_ProcInfo_0_31, &STATE_VARIABLE_ProcInfo_36_36);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_15, STATE_VARIABLE_ProcInfo_36_36, STATE_VARIABLE_ProcInfo_32);
  hlds__hlds_pred__pred_info_set_typevarset_3_p_0(TypeVarSet_16, STATE_VARIABLE_PredInfo_0_29, &STATE_VARIABLE_PredInfo_38_38);
  hlds__hlds_pred__pred_info_set_tvar_kind_map_3_p_0(TypeVarKinds_17, STATE_VARIABLE_PredInfo_38_38, STATE_VARIABLE_PredInfo_30);
}
  ...
  MR_Word * PolyInfo_8)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_7, &VarSet_13, &VarTypes_14);
...
{
	check_hlds__polymorphism_info__user_init_pred_160_0();
