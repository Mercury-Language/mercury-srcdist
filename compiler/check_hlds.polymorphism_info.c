  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  *Specs_9 = ((MR_Word) ((MR_hl_field(0, Info_8, 15))));
  ...
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_13, STATE_VARIABLE_ProcInfo_0_30, &STATE_VARIABLE_ProcInfo_1_35);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_14, STATE_VARIABLE_ProcInfo_1_35, STATE_VARIABLE_ProcInfo_31);
