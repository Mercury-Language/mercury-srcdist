        ...
        else
        {
              ...
              if (succeeded)
              {
                ...
                if (((((MR_tag((MR_Word) MLDS_Type_20)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_20, (MR_Integer) 0)))) == (MR_Integer) 3))))
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ml_backend__ml_type_gen__ml_gen_class_name_3_p_0(TypeCtor_63, &QualTypeName_58, &TypeArity_59);
                      succeeded = MR_TRUE;
                    }
                  }
                }
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              ml_backend__ml_type_gen__ml_gen_class_name_3_p_0(TypeCtor_93, &ClassName_75, &ClassArity_76);
              {
