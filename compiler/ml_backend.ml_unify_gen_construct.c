    ...
    case (MR_Integer) 0:
      {
        ...
        succeeded = ((((MR_tag((MR_Word) ConsId_14)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId_14, (MR_Integer) 0)))) == (MR_Integer) 3)));
        if (succeeded)
        {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((((MR_tag((MR_Word) ConsId_54)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId_54, (MR_Integer) 0)))) == (MR_Integer) 3)));
              if (succeeded)
              {
