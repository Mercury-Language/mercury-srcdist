  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__14_14 = (MR_Word) (&recompilation_scalar_common_2[4]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__14_14, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__15_15 = (MR_Word) (&recompilation_scalar_common_2[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__22_22 = (MR_Word) (&recompilation_scalar_common_2[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__22_22, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__23_23 = (MR_Word) (&recompilation_scalar_common_2[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__23_23, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__24_24 = (MR_Word) (&recompilation_scalar_common_2[1]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__24_24, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__25_25 = (MR_Word) (&recompilation_scalar_common_2[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__25_25, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__26_26 = (MR_Word) (&recompilation_scalar_common_2[2]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__26_26, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo__27_27 = (MR_Word) (&recompilation_scalar_common_2[1]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__27_27, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
                  TypeInfo__28_28 = (MR_Word) (&recompilation_scalar_common_2[1]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__28_28, ((MR_Box) (ArgX8_17)), ((MR_Box) (ArgY8_18)));
                }
              }
            }
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__12_12 = (MR_Word) (&recompilation_scalar_common_1[0]);
  ...
  MR_Word * Timestamp_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Str_6 = ((MR_String) ((MR_hl_field(MR_mktag(2), Var_8, (MR_Integer) 0))));
