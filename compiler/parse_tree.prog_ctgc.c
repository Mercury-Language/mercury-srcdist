        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeTypes_11)) == (MR_Integer) 1);
            if (succeeded)
            {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Var_30)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_30, (MR_Integer) 0))) == (MR_Integer) 0)));
              if (succeeded)
