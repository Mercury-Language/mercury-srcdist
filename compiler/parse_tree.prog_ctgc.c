                    ...
                    if (parse_tree__prog_ctgc__succeeded)
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), parse_tree__prog_ctgc__ConsId_60, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                        ...
                        if (parse_tree__prog_ctgc__succeeded)
                          {
...

                            {
                              ...
                              MR_hl_field(MR_mktag(3), parse_tree__prog_ctgc__ConsId_61, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
