...
{
  {
    ...
    mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ProgVarSet_8, Var_15, &VarName_12);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_ctgc_scalar_common_1[6])));
    }
    {
...
{
  {
    ...
    else
    {
      ...
      Var_24 = mercury__string__join_list_2_f_0((MR_String) ",", SelectorStrings_19);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_ctgc_scalar_common_1[5])));
      }
      {
