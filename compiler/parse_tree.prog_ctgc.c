  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_ctgc__rename_datastruct_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_Data_13);
