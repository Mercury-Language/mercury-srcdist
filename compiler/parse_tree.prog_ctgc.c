                                                            ...
                                                            if (parse_tree__prog_ctgc__succeeded)
                                                              {
                                                                ...
                                                                parse_tree__prog_ctgc__TypeCtorInfo_26_38 = (MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_unit_selector_0;
                                                                {
                                                                                                ...
                                                                                                if (parse_tree__prog_ctgc__succeeded)
                                                                                                  {
                                                                                                    ...
                                                                                                    parse_tree__prog_ctgc__TypeCtorInfo_26_62 = (MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_unit_selector_0;
                                                                                                    {
...
{
  {
    ...
    {
      parse_tree__prog_ctgc__IntroducedFrom__pred__do_print_structure_sharing_domain__611__1_3_p_0(((MR_Word) parse_tree__prog_ctgc__wrapper_arg_1));
    }
  }
}
              ...
              if ((strcmp(parse_tree__prog_ctgc__V_71_71, (MR_String) "unknown_sharing") == 0))
                {
                  ...
                  {
                    parse_tree__prog_ctgc__V_45_45 = mercury__set__make_singleton_set_1_f_0((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0, ((MR_Box) (parse_tree__prog_ctgc__Reason_11)));
                  }
                  {
            ...
            if ((strcmp(parse_tree__prog_ctgc__Cons_5, (MR_String) "top") == 0))
              {
                ...
                {
                  parse_tree__prog_ctgc__V_10_10 = mercury__set__make_singleton_set_1_f_0((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0, ((MR_Box) (MR_mkword(MR_mktag(2), &parse_tree__prog_ctgc_scalar_common_3[0]))));
                }
                {
