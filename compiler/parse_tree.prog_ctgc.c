  ...
  MR_Word * STATE_VARIABLE_Data_13)
{
  ...
  Var_10 = ((MR_Word) (conv0_Var_10));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&parse_tree__prog_ctgc_scalar_common_5[1]));
    MR_hl_field(MR_mktag(0), Var_15, 1) = ((MR_Box) (parse_tree__prog_ctgc__rename_datastruct_4_p_0_1));
    MR_hl_field(MR_mktag(0), Var_15, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_15, 3) = ((MR_Box) (Subst_6));
  }
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_26 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0), Msgs_19);
        {
          Var_27 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&parse_tree__prog_ctgc_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (parse_tree__prog_ctgc__dump_structure_sharing_domain_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (Stream_7));
        }
        mercury__io__write_list_6_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0), Stream_7, Var_26, (MR_String) "\n%\t", Var_27);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "])");
      }
      break;
  }
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_28 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0), Msgs_21);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&parse_tree__prog_ctgc_scalar_common_7[0]));
                MR_hl_field(MR_mktag(0), Var_29, 1) = ((MR_Box) (parse_tree__prog_ctgc__print_structure_sharing_domain_8_p_0_1));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_58, (MR_Integer) 1))));
          succeeded = (Var_41 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            UserSharingTerm_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_41, (MR_Integer) 0))));
                  ...
                  if ((strcmp(Var_64, (MR_String) "yes") == 0))
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Var_50 = mercury__varset__coerce_1_f_0(TypeCtorInfo_54_54, TypeCtorInfo_56_56, STATE_VARIABLE_Varset_48_48);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (Types_17));
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(1), MaybeUserTypes_19, 0) = ((MR_Box) (Var_49));
                      }
                      succeeded = MR_TRUE;
                    }
                  }
    ...
    if (succeeded)
    {
      ...
      if ((strcmp(Cons_5, (MR_String) "[|]") == 0))
      {
        ...
        Var_10 = parse_tree__prog_ctgc__parse_structure_sharing_1_f_0(TypeInfo_for_T_16, Term_3);
        {
          ...
          MR_hl_field(MR_mktag(1), SharingAs0_8, 0) = ((MR_Box) (Var_10));
        }
        succeeded = MR_TRUE;
      }
      else
      if ((strcmp(Cons_5, (MR_String) "top") == 0))
      {
        ...
        Var_11 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0), ((MR_Box) (MR_mkword(MR_mktag(2), &parse_tree__prog_ctgc_scalar_common_3[1]))));
        {
          SharingAs0_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), SharingAs0_8, 0) = ((MR_Box) (Var_11));
        }
        succeeded = MR_TRUE;
      }
      else
  ...
  MR_Word Term_3)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeInfo_for_T_50, ArityTerm_9, &Arity_12);
        if (succeeded)
          succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeInfo_for_T_50, PosTerm_10, &Pos_13);
      }
      if (succeeded)
      {
        MR_Word ConsId_14;
      ...
      else
      {
        ...
        succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeInfo_for_T_50, ConsTerm_8, &Int_15);
        if (succeeded)
        {
          MR_Word Var_29;
          MR_Word ConsId_47;
