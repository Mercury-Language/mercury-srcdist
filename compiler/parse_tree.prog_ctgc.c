...
parse_tree__prog_ctgc__IntroducedFrom__pred__do_print_structure_sharing_domain__638__1_4_p_0(
  ...
  MR_Word HeadVar__2_42)
{
  mercury__io__write_4_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_top_feedback_0), Stream_12, ((MR_Box) (HeadVar__2_42)));
}
