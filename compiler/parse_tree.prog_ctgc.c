...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) ", ");
    parse_tree__prog_ctgc__print_structure_sharing_domain_7_p_0(ProgVarSet_6, TypeVarSet_7, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), Sharing_12);
    mercury__io__write_string_3_p_0((MR_String) ")");
  }
}
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_14 == (MR_Word) ((MR_Integer) 0));
              if (succeeded)
              {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = (Var_30 == (MR_Word) ((MR_Integer) 0));
                          if (succeeded)
                          {
      ...
      switch (MR_unmkbody(HeadVar__3_3)) {
        ...
        case (MR_Integer) 0:
          *HeadVar__4_4 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 1:
          *HeadVar__4_4 = (MR_Word) ((MR_Integer) 4);
          break;
      }
      break;
    case (MR_Integer) 1:
...
{
  {
    ...
    if ((STATE_VARIABLE_UserSharing_0_20 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "yes(");
    parse_tree__prog_ctgc__print_structure_sharing_domain_7_p_0(ProgVarSet_1, TypeVarSet_2, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), SharingAs_15);
    mercury__io__write_string_3_p_0((MR_String) ")");
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__prog_ctgc__print_structure_sharing_9_p_0(ProgVarSet_6, TypeVarSet_7, (MR_Word) ((MR_Integer) 0), (MR_String) "[", (MR_String) "\n%\t", (MR_String) "]", SharingPairs_30);
        }
        break;
      case (MR_Integer) 2:
        {
...
{
  {
    parse_tree__prog_ctgc__print_structure_sharing_9_p_0(ProgVarSet_6, TypeVarSet_7, (MR_Word) ((MR_Integer) 0), (MR_String) "[", (MR_String) ",", (MR_String) "]", SharingPairs_8);
  }
}
...
{
  {
    ...
    if ((MaybeLimit_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((Selector_6 == (MR_Word) ((MR_Integer) 0)))
      Var_10 = (MR_String) "[]";
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if ((Var_58 == (MR_Word) ((MR_Integer) 0)))
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_28 == (MR_Word) ((MR_Integer) 0));
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      MaybeUserTypes_19 = (MR_Word) ((MR_Integer) 0);
                      succeeded = MR_TRUE;
                    }
                    else
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        if ((SharingPairTerms_68 == (MR_Word) ((MR_Integer) 0)))
                        {
                          Sharing_22 = (MR_Word) ((MR_Integer) 0);
                          succeeded = MR_TRUE;
                        }
                        else
                        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          *ArgumentTerms_4 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
        else
        if ((strcmp(Cons_5, (MR_String) "[|]") == 0))
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_12, (MR_Integer) 1))));
              succeeded = (Var_13 == (MR_Word) ((MR_Integer) 0));
              if (succeeded)
              {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        ReuseDomain_4 = (MR_Word) ((MR_Integer) 0);
      else
      {
        succeeded = (strcmp(Cons_5, (MR_String) "has_only_unconditional_reuse") == 0);
        if (succeeded)
          ReuseDomain_4 = (MR_Word) ((MR_Integer) 4);
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_10 == (MR_Word) ((MR_Integer) 0));
            }
          }
          if (succeeded)
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (Var_12 == (MR_Word) ((MR_Integer) 0));
          }
        }
      }
      if (succeeded)
      ...
      else
      {
        succeeded = (strcmp(Cons_5, (MR_String) "[]") == 0);
        if (succeeded)
          ReuseConditions_4 = (MR_Word) ((MR_Integer) 0);
        else
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        succeeded = (strcmp(Cons_5, (MR_String) "[]") == 0);
        if (succeeded)
          Datastructs_4 = (MR_Word) ((MR_Integer) 0);
        else
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          SharingAs0_8 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
        else
          succeeded = MR_FALSE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if ((strcmp(Cons_5, (MR_String) "[]") == 0))
        {
          SharingPairs0_10 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
        else
        if ((strcmp(Cons_5, (MR_String) "[|]") == 0))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Selector_4 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_27 == (MR_Word) ((MR_Integer) 0));
            }
          }
        }
      }
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (Var_36 == (MR_Word) ((MR_Integer) 0));
          }
        }
        if (succeeded)
        {
