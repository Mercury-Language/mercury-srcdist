...
{
  {
    ...
    parse_tree__prog_ctgc__IntroducedFrom__pred__do_print_structure_sharing_domain__615__1_3_p_0(((MR_Word) wrapper_arg_1));
  }
}
          ...
          else
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ConsId_51, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
            ...
            else
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), ConsId_52, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
