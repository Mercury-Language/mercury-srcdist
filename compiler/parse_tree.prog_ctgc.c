  ...
  MR_Word * STATE_VARIABLE_UserSharing_21)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_SharingDomain_22_22 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_UserSharing_0_20, 0))));
    ...
    switch (MR_tag((MR_Word) STATE_VARIABLE_SharingDomain_22_22)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word SharingPairs_14 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_SharingDomain_22_22, 0))));
