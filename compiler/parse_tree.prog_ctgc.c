                                                    ...
                                                    if (parse_tree__prog_ctgc__succeeded)
                                                      {
                                                        ...
                                                        if (parse_tree__prog_ctgc__succeeded)
                                                          {
                                                            {
                                                              parse_tree__prog_ctgc__succeeded = parse_tree__prog_io_type_name__maybe_parse_types_2_p_0(parse_tree__prog_ctgc__TypeTermsList_23, &parse_tree__prog_ctgc__Types_24);
                                                            }
                                                            if (parse_tree__prog_ctgc__succeeded)
                                                              {
                                                                                        ...
                                                                                        if (parse_tree__prog_ctgc__succeeded)
                                                                                          {
                                                                                            ...
                                                                                            if (parse_tree__prog_ctgc__succeeded)
                                                                                              {
                                                                                                {
                                                                                                  parse_tree__prog_ctgc__succeeded = parse_tree__prog_io_type_name__maybe_parse_types_2_p_0(parse_tree__prog_ctgc__TypeTermsList_46, &parse_tree__prog_ctgc__Types_47);
                                                                                                }
                                                                                                if (parse_tree__prog_ctgc__succeeded)
                                                                                                  {
                                    ...
                                    if ((strcmp(parse_tree__prog_ctgc__V_69_69, (MR_String) "yes") == 0))
                                      {
                                        ...
                                        {
                                          parse_tree__prog_ctgc__succeeded = parse_tree__prog_io_type_name__maybe_parse_types_2_p_0(parse_tree__prog_ctgc__V_66_66, &parse_tree__prog_ctgc__Types_17);
                                        }
                                        if (parse_tree__prog_ctgc__succeeded)
                                          {
            ...
            if (parse_tree__prog_ctgc__succeeded)
              {
                ...
                {
                  parse_tree__prog_ctgc__succeeded = parse_tree__prog_io_type_name__maybe_parse_type_2_p_0(parse_tree__prog_ctgc__V_47_47, &parse_tree__prog_ctgc__TypeSelector_29);
                }
                if (parse_tree__prog_ctgc__succeeded)
                  {
