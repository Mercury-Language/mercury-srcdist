...
{
  MR_bool succeeded = ((((MR_tag((MR_Word) ConstType0_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConstType0_11, (MR_Integer) 0)))) == (MR_Integer) 7)));
  ...
  {
    {
      ...
      MR_hl_field(3, ConstType_16, 0) = ((MR_Box) ((MR_Unsigned) 8U));
