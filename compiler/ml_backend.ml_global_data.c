  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_18_48 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0);
        TypeCtorInfo_19_49 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0);
        mercury__list__map2_4_p_0(TypeCtorInfo_18_48, TypeCtorInfo_18_48, TypeCtorInfo_19_49, Var_46, Inits0_42, &Inits_43, &Types_44);
        Var_47 = (MR_Word) ((MR_Unsigned) 4U);
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo_19_49, ((MR_Box) (Var_47)), Types_44);
      }
    }
  }
  if (succeeded)
