        ...
        if (ml_backend__ml_global_data__succeeded)
          *ml_backend__ml_global_data__HeadVar__1_1 = ml_backend__ml_global_data__Var_14;
        else
          {
            ...
            {
              ml_backend__mlds____Compare____mlds_defn_0_0(&ml_backend__ml_global_data__Var_15, ml_backend__ml_global_data__ArgX2_6, ml_backend__ml_global_data__ArgY2_7);
            }
    ...
    if (ml_backend__ml_global_data__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_global_data__succeeded)
          {
            {
              ml_backend__ml_global_data__succeeded = ml_backend__mlds____Unify____mlds_defn_0_0(ml_backend__ml_global_data__ArgX2_5, ml_backend__ml_global_data__ArgY2_6);
            }
            if (ml_backend__ml_global_data__succeeded)
              {
