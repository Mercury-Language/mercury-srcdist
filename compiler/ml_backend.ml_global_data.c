        ...
        case (MR_Integer) 2:
          {
            ...
            CtorDefn_177 = ml_backend__ml_type_gen__ml_gen_constructor_function_8_f_0(Target_12, StructClassId_36, StructClassId_36, MLDS_ModuleName_10, StructClassId_36, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), FieldInfos_33, Context_11);
            {
              CtorDefns_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CtorDefns_39, 0) = ((MR_Box) (CtorDefn_177));
              MR_hl_field(MR_mktag(1), CtorDefns_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
          }
          break;
