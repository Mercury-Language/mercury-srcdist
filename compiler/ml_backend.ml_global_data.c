...
{
  {
    ...
    if (succeeded)
    {
      ...
      *Type_6 = (MR_Word) ((MR_Integer) 16);
    }
    else
    {
      *Init_5 = Init0_4;
      *Type_6 = (MR_Word) ((MR_Integer) 24);
    }
  }
}
          ...
          case (MR_Integer) 2:
            {
              ...
              if ((Type_5 == (MR_Word) ((MR_Integer) 16)))
              {
          ...
          case (MR_Integer) 3:
            {
              ...
              if ((Type_62 == (MR_Word) ((MR_Integer) 16)))
              {
          ...
          case (MR_Integer) 4:
            {
              ...
              if ((Type_39 == (MR_Word) ((MR_Integer) 16)))
              {
...
{
  {
    ...
    if ((MaybeConsId_9 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      *TypeNum_14 = (MR_Word) (TypeRawNum_26);
        ...
        case (MR_Integer) 0:
          {
            ...
            CtorDefns_39 = (MR_Word) ((MR_Integer) 0);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            ClassKind_38 = (MR_Integer) 2;
            CtorDefn_40 = ml_backend__ml_type_gen__ml_gen_constructor_function_8_f_0(Target_12, StructClassId_36, StructClassId_36, MLDS_ModuleName_10, StructClassId_36, (MR_Word) ((MR_Integer) 0), FieldInfos_33, Context_11);
            {
              ...
              MR_hl_field(MR_mktag(1), CtorDefns_39, 1) = ((MR_Box) ((MR_Integer) 0));
            }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            CtorDefn_191 = ml_backend__ml_type_gen__ml_gen_constructor_function_8_f_0(Target_12, StructClassId_36, StructClassId_36, MLDS_ModuleName_10, StructClassId_36, (MR_Word) ((MR_Integer) 0), FieldInfos_33, Context_11);
            {
              CtorDefns_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 5) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 6) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 7) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 8) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 9) = ((MR_Box) (FieldDefns_32));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 10) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 11) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FieldDataDefn_21, 4) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), FieldDataDefn_21, 5) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FieldInfo_23, 2) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_48 == (MR_Word) ((MR_Integer) 24));
      if (succeeded)
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_49 == (MR_Word) ((MR_Integer) 24));
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Initializer0_12)) == (MR_mktag((MR_Integer) 3)));
        if (succeeded)
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), DataDefn_19, 5) = ((MR_Box) ((MR_Integer) 0));
    }
...
{
  {
    ...
    if ((MaybeOldCommon_28 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Rows0_31;
      MR_Word Rows_32;
