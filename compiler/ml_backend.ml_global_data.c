            ...
            case (MR_Integer) 1:
              {
                ...
                ml_backend__ml_global_data__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_global_data__Var_22)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_global_data__Var_22, (MR_Integer) 0)))) == (MR_Integer) 9)));
                if (ml_backend__ml_global_data__succeeded)
                {
