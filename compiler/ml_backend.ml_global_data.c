...
{
  {
    ...
    else
    {
      ...
      *TypeNum_14 = (MR_Word) (TypeRawNum_26);
      ...
      ml_backend__ml_global_data__ml_gen_vector_cell_field_types_8_p_0(Context_11, (MR_Word) (&ml_backend__ml_global_data_scalar_common_3[1]), TypeRawNum_26, (MR_Integer) 0, ArgTypes_13, &FieldNames_31, &FieldDefns_32, &FieldInfos_33);
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), StructClassDefn_41, 3) = ((MR_Box) (&ml_backend__ml_global_data_scalar_common_3[2]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), DataDefn_19, 2) = ((MR_Box) (&ml_backend__ml_global_data_scalar_common_3[0]));
