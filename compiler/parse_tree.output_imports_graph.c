  ...
  MR_Word ImpDepsGraph_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 292, &ShowImportsGraph_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 133, &Verbose_16);
        switch (Verbose_16) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
