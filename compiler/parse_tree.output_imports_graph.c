  ...
  MR_Word ImpDepsGraph_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 289, &ShowImportsGraph_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 130, &Verbose_16);
        switch (Verbose_16) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        if (((MR_tag((MR_Word) ImportsGraphOpenResult_17)) == (MR_Integer) 1))
        {
          ...
          Var_68 = mercury__string__f_43_43_2_f_0(IOErrorMessage_23, (MR_String) "\n");
          Var_70 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_68);
          Var_71 = mercury__string__f_43_43_2_f_0(ImportsGraphFileName_15, Var_70);
          ImpMessage_24 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_71);
          libs__file_util__report_error_4_p_0(ProgressStream_8, ImpMessage_24);
        }
        else
        {
          ...
          MR_Box conv4_STATE_VARIABLE_IO_4_87;

          mercury__digraph__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &DepsGraph0_19);
          Var_37 = mercury__digraph__to_assoc_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_11);
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__output_imports_graph_scalar_common_1[0]), (MR_Word) (&parse_tree__output_imports_graph_scalar_common_2[0]), (MR_Word) (&parse_tree__output_imports_graph_scalar_common_1[1]), Var_37, ((MR_Box) (DepsGraph0_19)), &conv1_DepsGraph1_20);
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__output_imports_graph_scalar_common_1[0]), (MR_Word) (&parse_tree__output_imports_graph_scalar_common_2[0]), (MR_Word) (&parse_tree__output_imports_graph_scalar_common_1[2]), Var_39, ((MR_Box) (DepsGraph1_20)), &conv3_DepsGraph_21);
          ...
          mercury__digraph__traverse_5_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), DepsGraph_21, Var_85, Var_86, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_4_87);
