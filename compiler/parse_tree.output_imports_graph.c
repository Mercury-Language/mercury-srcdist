  ...
  MR_Word ImpDepsGraph_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 218, &ImportsGraph_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 82, &Verbose_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_Word IOError_21 = ((MR_Word) ((MR_hl_field(1, ImportsGraphOpenResult_17, 0))));
        ...
        else
        {
          ...
          mercury__digraph__traverse_5_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Deps_20, Var_85, Var_86, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_4_87);
