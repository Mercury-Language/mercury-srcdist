  ...
  MR_Word ImpDepsGraph_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 219, &ImportsGraph_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 83, &Verbose_15);
