    ...
    if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word parse_tree__maybe_error__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__maybe_error_scalar_common_1[0], parse_tree__maybe_error__HeadVar__1_1, ((MR_Box) (parse_tree__maybe_error__Var_34)), ((MR_Box) (parse_tree__maybe_error__ArgY1_5)));
            }
          }
        else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Box parse_tree__maybe_error__ArgY1_17 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 0));
            MR_Box parse_tree__maybe_error__ArgY2_19 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 1));
            MR_Box parse_tree__maybe_error__ArgY3_21 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 2));
            MR_Box parse_tree__maybe_error__ArgY4_23 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 3));
            MR_Word parse_tree__maybe_error__Var_24;

            {
              mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T1_29, &parse_tree__maybe_error__Var_24, parse_tree__maybe_error__Var_38, parse_tree__maybe_error__ArgY1_17);
            }
            ...
            if (parse_tree__maybe_error__succeeded)
              *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_24;
            else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T2_30, &parse_tree__maybe_error__Var_25, parse_tree__maybe_error__Var_37, parse_tree__maybe_error__ArgY2_19);
                }
                ...
                if (parse_tree__maybe_error__succeeded)
                  *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_25;
                else
                  {
                    ...
                    {
                      mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T3_31, &parse_tree__maybe_error__Var_26, parse_tree__maybe_error__Var_36, parse_tree__maybe_error__ArgY3_21);
                    }
                    ...
                    if (parse_tree__maybe_error__succeeded)
                      *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_26;
                      ...
                      {
                        mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T4_32, parse_tree__maybe_error__HeadVar__1_1, parse_tree__maybe_error__Var_35, parse_tree__maybe_error__ArgY4_23);
                      }
                  }
              }
          }
    ...
    if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        MR_Word parse_tree__maybe_error__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__maybe_error__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word parse_tree__maybe_error__ArgY1_4;

        parse_tree__maybe_error__succeeded = ((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__maybe_error__succeeded)
          {
            parse_tree__maybe_error__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 0)));
            parse_tree__maybe_error__TypeInfo_19_19 = (MR_Word) &parse_tree__maybe_error_scalar_common_1[0];
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_19_19, ((MR_Box) (parse_tree__maybe_error__ArgX1_3)), ((MR_Box) (parse_tree__maybe_error__ArgY1_4)));
            }
          }
      }
    else
      {
        MR_Box parse_tree__maybe_error__ArgX1_5 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__1_1, (MR_Integer) 0));
        MR_Box parse_tree__maybe_error__ArgY1_6;
        MR_Box parse_tree__maybe_error__ArgX2_7 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__1_1, (MR_Integer) 1));
        MR_Box parse_tree__maybe_error__ArgY2_8;
        MR_Box parse_tree__maybe_error__ArgX3_9 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__1_1, (MR_Integer) 2));
        MR_Box parse_tree__maybe_error__ArgY3_10;
        MR_Box parse_tree__maybe_error__ArgX4_11 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__1_1, (MR_Integer) 3));
        MR_Box parse_tree__maybe_error__ArgY4_12;

        parse_tree__maybe_error__succeeded = ((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (parse_tree__maybe_error__succeeded)
          {
            parse_tree__maybe_error__ArgY1_6 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 0));
            parse_tree__maybe_error__ArgY2_8 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 1));
            parse_tree__maybe_error__ArgY3_10 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 2));
            parse_tree__maybe_error__ArgY4_12 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 3));
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T1_15, parse_tree__maybe_error__ArgX1_5, parse_tree__maybe_error__ArgY1_6);
            }
            if (parse_tree__maybe_error__succeeded)
              {
                {
                  parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T2_16, parse_tree__maybe_error__ArgX2_7, parse_tree__maybe_error__ArgY2_8);
                }
                if (parse_tree__maybe_error__succeeded)
                  {
                    {
                      parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T3_17, parse_tree__maybe_error__ArgX3_9, parse_tree__maybe_error__ArgY3_10);
                    }
                    if (parse_tree__maybe_error__succeeded)
                      {
                        parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T4_18, parse_tree__maybe_error__ArgX4_11, parse_tree__maybe_error__ArgY4_12);
                      }
                  }
              }
          }
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__maybe_error_scalar_common_1[0], parse_tree__maybe_error__HeadVar__1_1, ((MR_Box) (parse_tree__maybe_error__Var_28)), ((MR_Box) (parse_tree__maybe_error__ArgY1_5)));
            }
          }
        else
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 1;
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Box parse_tree__maybe_error__ArgY1_15 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 0));
            MR_Box parse_tree__maybe_error__ArgY2_17 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 1));
            MR_Box parse_tree__maybe_error__ArgY3_19 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 2));
            MR_Word parse_tree__maybe_error__Var_20;

            {
              mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T1_24, &parse_tree__maybe_error__Var_20, parse_tree__maybe_error__Var_31, parse_tree__maybe_error__ArgY1_15);
            }
            ...
            if (parse_tree__maybe_error__succeeded)
              *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_20;
            else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T2_25, &parse_tree__maybe_error__Var_21, parse_tree__maybe_error__Var_30, parse_tree__maybe_error__ArgY2_17);
                }
                ...
                if (parse_tree__maybe_error__succeeded)
                  *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_21;
                  ...
                  {
                    mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T3_26, parse_tree__maybe_error__HeadVar__1_1, parse_tree__maybe_error__Var_29, parse_tree__maybe_error__ArgY3_19);
                  }
              }
          }
      }
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            ...
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_16_16, ((MR_Box) (parse_tree__maybe_error__ArgX1_3)), ((MR_Box) (parse_tree__maybe_error__ArgY1_4)));
            }
          }
      }
    else
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            ...
            parse_tree__maybe_error__ArgY3_10 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 2));
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T1_13, parse_tree__maybe_error__ArgX1_5, parse_tree__maybe_error__ArgY1_6);
            }
            if (parse_tree__maybe_error__succeeded)
              {
                {
                  parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T2_14, parse_tree__maybe_error__ArgX2_7, parse_tree__maybe_error__ArgY2_8);
                }
                if (parse_tree__maybe_error__succeeded)
                  {
                    parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T3_15, parse_tree__maybe_error__ArgX3_9, parse_tree__maybe_error__ArgY3_10);
                  }
              }
          }
      }
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__maybe_error_scalar_common_1[0], parse_tree__maybe_error__HeadVar__1_1, ((MR_Box) (parse_tree__maybe_error__Var_22)), ((MR_Box) (parse_tree__maybe_error__ArgY1_5)));
            }
          }
        else
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 1;
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Box parse_tree__maybe_error__ArgY1_13 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 0));
            MR_Box parse_tree__maybe_error__ArgY2_15 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 1));
            MR_Word parse_tree__maybe_error__Var_16;

            {
              mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T1_19, &parse_tree__maybe_error__Var_16, parse_tree__maybe_error__Var_24, parse_tree__maybe_error__ArgY1_13);
            }
            ...
            if (parse_tree__maybe_error__succeeded)
              *parse_tree__maybe_error__HeadVar__1_1 = parse_tree__maybe_error__Var_16;
              ...
              {
                mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T2_20, parse_tree__maybe_error__HeadVar__1_1, parse_tree__maybe_error__Var_23, parse_tree__maybe_error__ArgY2_15);
              }
          }
      }
  }
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            ...
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_13_13, ((MR_Box) (parse_tree__maybe_error__ArgX1_3)), ((MR_Box) (parse_tree__maybe_error__ArgY1_4)));
            }
          }
      }
    else
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            ...
            parse_tree__maybe_error__ArgY2_8 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 1));
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T1_11, parse_tree__maybe_error__ArgX1_5, parse_tree__maybe_error__ArgY1_6);
            }
            if (parse_tree__maybe_error__succeeded)
              {
                parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T2_12, parse_tree__maybe_error__ArgX2_7, parse_tree__maybe_error__ArgY2_8);
              }
          }
      }
    return parse_tree__maybe_error__succeeded;
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__maybe_error_scalar_common_1[0], parse_tree__maybe_error__HeadVar__1_1, ((MR_Box) (parse_tree__maybe_error__Var_16)), ((MR_Box) (parse_tree__maybe_error__ArgY1_5)));
            }
          }
        else
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 1;
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__maybe_error__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *parse_tree__maybe_error__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Box parse_tree__maybe_error__ArgY1_11 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__3_3, (MR_Integer) 0));

            {
              mercury__builtin__compare_3_p_0(parse_tree__maybe_error__TypeInfo_for_T1_14, parse_tree__maybe_error__HeadVar__1_1, parse_tree__maybe_error__Var_17, parse_tree__maybe_error__ArgY1_11);
            }
          }
      }
  }
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            ...
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_10_10, ((MR_Box) (parse_tree__maybe_error__ArgX1_3)), ((MR_Box) (parse_tree__maybe_error__ArgY1_4)));
            }
          }
      }
    else
        ...
        if (parse_tree__maybe_error__succeeded)
          {
            parse_tree__maybe_error__ArgY1_6 = (MR_hl_field(MR_mktag(1), parse_tree__maybe_error__HeadVar__2_2, (MR_Integer) 0));
            {
              parse_tree__maybe_error__succeeded = mercury__builtin__unify_2_p_0(parse_tree__maybe_error__TypeInfo_for_T1_9, parse_tree__maybe_error__ArgX1_5, parse_tree__maybe_error__ArgY1_6);
            }
          }
      }
    return parse_tree__maybe_error__succeeded;
