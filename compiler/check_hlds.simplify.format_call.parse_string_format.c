                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                else
                                {
                                  ...
                                  succeeded = (Var_422 < Var_423);
                                  if (succeeded)
                                  {
                                    SubResult5_278 = (MR_Integer) 1;
                                    succeeded = MR_TRUE;
                                  }
                                  else
                                  {
                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                else
                                {
                                  ...
                                  succeeded = (Var_420 < Var_421);
                                  if (succeeded)
                                  {
                                    SubResult5_359 = (MR_Integer) 1;
                                    succeeded = MR_TRUE;
                                  }
                                  else
                                  {
