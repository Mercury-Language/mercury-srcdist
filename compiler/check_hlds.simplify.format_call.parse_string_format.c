        ...
        case (MR_Char) 112:
          {
            ...
            MR_Word Var_152 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__6_6, (MR_Integer) 0)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
            MR_Word Var_153 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__6_6, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
            MR_Word Var_154 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__6_6, (MR_Integer) 0)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
            MR_Word Var_155 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__6_6, (MR_Integer) 0)))) >> (MR_Integer) 4)) & (MR_Integer) 1);
            MR_Word Var_151 = ((((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__6_6, (MR_Integer) 0)))) & (MR_Integer) 1);

            {
              STATE_VARIABLE_Flags_74_435 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_74_435, 0) = ((MR_Box) (((MR_Integer) 1 | ((((Var_152 << (MR_Integer) 1)) | ((((Var_153 << (MR_Integer) 2)) | ((((Var_154 << (MR_Integer) 3)) | ((Var_155 << (MR_Integer) 4)))))))))));
            }
            if ((STATE_VARIABLE_PolyTypes_0_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              MR_Word Error_406;
