        ...
        case (MR_Char) 112:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_Flags_74_435, 0) = (MR_Box) (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 4)) | (((((MR_Unsigned) (((MR_Box) (Var_152))) << (MR_Integer) 3)) | (((((MR_Unsigned) (((MR_Box) (Var_153))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (Var_154))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (Var_155)))))))))));
            }
            if ((STATE_VARIABLE_PolyTypes_0_3 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word Error_406;
