    ...
    if (ml_backend__ml_commit_gen__succeeded)
      {
        ...
        MR_Integer ml_backend__ml_commit_gen__SuccessFuncLabel_23;
        ...
        {
          ml_backend__ml_code_util__ml_gen_set_success_4_p_0(ml_backend__ml_commit_gen__STATE_VARIABLE_Info_55_55, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[1]), ml_backend__ml_commit_gen__Context_11, &ml_backend__ml_commit_gen__SetSuccessFalse_36);
        }
        {
          ml_backend__ml_code_util__ml_gen_set_success_4_p_0(ml_backend__ml_commit_gen__STATE_VARIABLE_Info_55_55, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[2]), ml_backend__ml_commit_gen__Context_11, &ml_backend__ml_commit_gen__SetSuccessTrue_37);
        }
        {
          ml_backend__ml_commit_gen__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_64, 0) = ((MR_Box) (ml_backend__ml_commit_gen__SetSuccessFalse_36));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_63, 0) = ((MR_Box) (ml_backend__ml_commit_gen__GoalStmt_35));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_63, 1) = ((MR_Box) (ml_backend__ml_commit_gen__Var_64));
        }
        {
          ml_backend__ml_commit_gen__Var_60 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_commit_gen__Var_63, ml_backend__ml_commit_gen__Context_11);
        }
        {
          ml_backend__ml_commit_gen__Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_70, 0) = ((MR_Box) (ml_backend__ml_commit_gen__SetSuccessTrue_37));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ml_backend__ml_commit_gen__Var_69 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0, ml_backend__ml_commit_gen__CopyLocalsToOutputArgs_21, ml_backend__ml_commit_gen__Var_70);
        }
        {
          ml_backend__ml_commit_gen__Var_66 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_commit_gen__Var_69, ml_backend__ml_commit_gen__Context_11);
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_38, 2) = ((MR_Box) (ml_backend__ml_commit_gen__Var_60));
          MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_38, 3) = ((MR_Box) (ml_backend__ml_commit_gen__Var_66));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_72, 0) = ((MR_Box) (ml_backend__ml_commit_gen__TryCommitStmt_38));
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ml_backend__ml_commit_gen__maybe_put_commit_in_own_func_9_p_0(ml_backend__ml_commit_gen__CommitRefDefn_27, ml_backend__ml_commit_gen__SuccessFuncDefn_29, ml_backend__ml_commit_gen__Var_72, ml_backend__ml_commit_gen__Context_11, &ml_backend__ml_commit_gen__CommitFuncLocalVarDefns_39, ml_backend__ml_commit_gen__FuncDefns_13, ml_backend__ml_commit_gen__Stmts_14, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_55_55, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_73_73);
        }
        {
        ...
        {
          ml_backend__ml_gen_info__ml_gen_info_set_var_lvals_3_p_0(ml_backend__ml_commit_gen__OrigVarLvalMap_22, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_73_73, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_42);
        }
      }
    else
      {
        ...
        if (ml_backend__ml_commit_gen__succeeded)
          {
            ...
            MR_Word ml_backend__ml_commit_gen__Var_82;
            ...
            MR_Word ml_backend__ml_commit_gen__Var_89;
            MR_Word ml_backend__ml_commit_gen__Var_92;
            MR_Word ml_backend__ml_commit_gen__STATE_VARIABLE_Info_93_93;
            MR_Word ml_backend__ml_commit_gen__OutputArgLocalVarDefns_97;
            MR_Word ml_backend__ml_commit_gen__CopyLocalsToOutputArgs_98;
            MR_Word ml_backend__ml_commit_gen__OrigVarLvalMap_99;
            MR_Integer ml_backend__ml_commit_gen__SuccessFuncLabel_100;
            MR_Word ml_backend__ml_commit_gen__SuccessFuncLabelRval_101;
            MR_Word ml_backend__ml_commit_gen__CommitRef_102;
            MR_Word ml_backend__ml_commit_gen__CommitRefLval_103;
            MR_Word ml_backend__ml_commit_gen__CommitRefDefn_104;
            MR_Word ml_backend__ml_commit_gen__DoCommitStmt_105;
            MR_Word ml_backend__ml_commit_gen__SuccessFuncDefn_106;
            MR_Word ml_backend__ml_commit_gen__EnvPtrRval_107;
            MR_Word ml_backend__ml_commit_gen__SuccessCont_108;
            MR_Word ml_backend__ml_commit_gen__GoalLocalVarDefns_109;
            MR_Word ml_backend__ml_commit_gen__GoalFuncDefns_110;
            MR_Word ml_backend__ml_commit_gen__GoalStmts_111;
            MR_Word ml_backend__ml_commit_gen__GoalStmt_112;
            MR_Word ml_backend__ml_commit_gen__TryCommitStmt_113;
            MR_Word ml_backend__ml_commit_gen__CommitFuncLocalVarDefns_114;

            {
              ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_p_0(ml_backend__ml_commit_gen__GoalInfo_17, &ml_backend__ml_commit_gen__OutputArgLocalVarDefns_97, &ml_backend__ml_commit_gen__CopyLocalsToOutputArgs_98, &ml_backend__ml_commit_gen__OrigVarLvalMap_99, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_0_41, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_76_76);
            }
            {
              ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ml_backend__ml_commit_gen__SuccessFuncLabel_100, &ml_backend__ml_commit_gen__SuccessFuncLabelRval_101, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_76_76, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_78_78);
            }
            {
              ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 0, &ml_backend__ml_commit_gen__CommitRef_102, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_78_78, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80);
            }
            {
              ml_backend__ml_code_util__ml_gen_local_var_lval_4_p_0(ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80, ml_backend__ml_commit_gen__CommitRef_102, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ml_backend__ml_commit_gen__CommitRefLval_103);
            }
            {
              ml_backend__ml_commit_gen__CommitRefDefn_104 = ml_backend__ml_commit_gen__ml_gen_commit_var_decl_2_f_0(ml_backend__ml_commit_gen__Context_11, ml_backend__ml_commit_gen__CommitRef_102);
            }
            {
              ml_backend__ml_commit_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), ml_backend__ml_commit_gen__Var_82, 0) = ((MR_Box) (ml_backend__ml_commit_gen__CommitRefLval_103));
            }
            {
              ml_backend__ml_commit_gen__DoCommitStmt_105 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__DoCommitStmt_105, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__DoCommitStmt_105, 1) = ((MR_Box) (ml_backend__ml_commit_gen__Var_82));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__DoCommitStmt_105, 2) = ((MR_Box) (ml_backend__ml_commit_gen__Context_11));
            }
            {
              ml_backend__ml_code_util__ml_gen_nondet_label_func_5_p_0(ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80, ml_backend__ml_commit_gen__SuccessFuncLabel_100, ml_backend__ml_commit_gen__Context_11, ml_backend__ml_commit_gen__DoCommitStmt_105, &ml_backend__ml_commit_gen__SuccessFuncDefn_106);
            }
            {
              ml_backend__ml_code_util__ml_get_env_ptr_2_p_0(ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80, &ml_backend__ml_commit_gen__EnvPtrRval_107);
            }
            {
              ml_backend__ml_commit_gen__SuccessCont_108 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ml_backend__ml_commit_gen__SuccessCont_108, 0) = ((MR_Box) (ml_backend__ml_commit_gen__SuccessFuncLabelRval_101));
              MR_hl_field(MR_mktag(0), ml_backend__ml_commit_gen__SuccessCont_108, 1) = ((MR_Box) (ml_backend__ml_commit_gen__EnvPtrRval_107));
              MR_hl_field(MR_mktag(0), ml_backend__ml_commit_gen__SuccessCont_108, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              MR_hl_field(MR_mktag(0), ml_backend__ml_commit_gen__SuccessCont_108, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              ml_backend__ml_gen_info__ml_gen_info_push_success_cont_3_p_0(ml_backend__ml_commit_gen__SuccessCont_108, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_85_85);
            }
            {
              ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 2, ml_backend__ml_commit_gen__Goal_9, &ml_backend__ml_commit_gen__GoalLocalVarDefns_109, &ml_backend__ml_commit_gen__GoalFuncDefns_110, &ml_backend__ml_commit_gen__GoalStmts_111, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_85_85, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_87_87);
            }
            {
              ml_backend__ml_commit_gen__GoalStmt_112 = ml_backend__ml_code_util__ml_gen_block_4_f_0(ml_backend__ml_commit_gen__GoalLocalVarDefns_109, ml_backend__ml_commit_gen__GoalFuncDefns_110, ml_backend__ml_commit_gen__GoalStmts_111, ml_backend__ml_commit_gen__GoalContext_19);
            }
            {
            ...
            {
              ml_backend__ml_commit_gen__Var_89 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_commit_gen__CopyLocalsToOutputArgs_98, ml_backend__ml_commit_gen__Context_11);
            }
            {
              ml_backend__ml_commit_gen__TryCommitStmt_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_113, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_113, 1) = ((MR_Box) (ml_backend__ml_commit_gen__CommitRefLval_103));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_113, 2) = ((MR_Box) (ml_backend__ml_commit_gen__GoalStmt_112));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_113, 3) = ((MR_Box) (ml_backend__ml_commit_gen__Var_89));
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_113, 4) = ((MR_Box) (ml_backend__ml_commit_gen__Context_11));
            }
            {
              ml_backend__ml_commit_gen__Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_92, 0) = ((MR_Box) (ml_backend__ml_commit_gen__TryCommitStmt_113));
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_92, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              ml_backend__ml_commit_gen__maybe_put_commit_in_own_func_9_p_0(ml_backend__ml_commit_gen__CommitRefDefn_104, ml_backend__ml_commit_gen__SuccessFuncDefn_106, ml_backend__ml_commit_gen__Var_92, ml_backend__ml_commit_gen__Context_11, &ml_backend__ml_commit_gen__CommitFuncLocalVarDefns_114, ml_backend__ml_commit_gen__FuncDefns_13, ml_backend__ml_commit_gen__Stmts_14, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_88_88, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_93_93);
            }
            {
              *ml_backend__ml_commit_gen__LocalVarDefns_12 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0, ml_backend__ml_commit_gen__OutputArgLocalVarDefns_97, ml_backend__ml_commit_gen__CommitFuncLocalVarDefns_114);
            }
            {
              ml_backend__ml_gen_info__ml_gen_info_set_var_lvals_3_p_0(ml_backend__ml_commit_gen__OrigVarLvalMap_99, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_93_93, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_42);
            }
          }
        else
          {
...
{
  {
    ...
    switch (ml_backend__ml_commit_gen__PutCommitInOwnFunc_18) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer ml_backend__ml_commit_gen__CommitFuncLabel_19;
          ...
          {
            ml_backend__ml_commit_gen__CallStmt_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL));
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 4) = ((MR_Box) (ml_backend__ml_commit_gen__ArgRvals_24));
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 5) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 6) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 7) = ((MR_Box) (ml_backend__ml_commit_gen__Markers_30));
            MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__CallStmt_31, 8) = ((MR_Box) (ml_backend__ml_commit_gen__Context_13));
          }
