...
static /* final */ const MR_Box ml_backend__ml_commit_gen_scalar_common_1[6][2] = {
  ...
  /* row 3 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_commit_gen_scalar_common_1[2]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 4 */
  {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[4])), Context_11, &SetSuccessFalse_36, STATE_VARIABLE_Info_60_60, &STATE_VARIABLE_Info_62_62);
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[5])), Context_11, &SetSuccessTrue_37, STATE_VARIABLE_Info_62_62, &STATE_VARIABLE_Info_65_65);
      {
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), CallStmt_29, 1) = ((MR_Box) (&ml_backend__ml_commit_gen_scalar_common_1[3]));
