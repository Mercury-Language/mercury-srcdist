    ...
    if (ml_backend__ml_commit_gen__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_70, 0) = ((MR_Box) (ml_backend__ml_commit_gen__SuccessFunc_29));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__CommitFuncLocalDecls_39, 1) = ((MR_Box) (ml_backend__ml_commit_gen__Var_70));
        }
        {
        ...
        if (ml_backend__ml_commit_gen__succeeded)
          {
            ...
            {
              ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 0, &ml_backend__ml_commit_gen__CommitRef_104, ml_backend__ml_commit_gen__STATE_VARIABLE_Info_78_78, &ml_backend__ml_commit_gen__STATE_VARIABLE_Info_80_80);
            }
            {
            ...
            {
              ml_backend__ml_commit_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_82, 0) = ((MR_Box) (ml_backend__ml_commit_gen__CommitRefLval_105));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__DoCommitStmt_107, 1) = ((MR_Box) (ml_backend__ml_commit_gen__Var_82));
            }
            {
            ...
            {
              ml_backend__ml_commit_gen__Var_89 = ml_backend__ml_code_util__ml_gen_block_3_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_commit_gen__CopyLocalsToOutputArgs_99, ml_backend__ml_commit_gen__Context_10);
            }
            {
              ...
              MR_hl_field(MR_mktag(3), ml_backend__ml_commit_gen__TryCommitStmt_115, 3) = ((MR_Box) (ml_backend__ml_commit_gen__Var_89));
            }
            {
            ...
            {
              ml_backend__ml_commit_gen__Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_91, 0) = ((MR_Box) (ml_backend__ml_commit_gen__SuccessFunc_109));
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__Var_91, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), ml_backend__ml_commit_gen__CommitFuncLocalDecls_117, 1) = ((MR_Box) (ml_backend__ml_commit_gen__Var_91));
            }
            {
