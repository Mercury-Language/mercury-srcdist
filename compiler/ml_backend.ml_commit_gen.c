...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_commit_gen__Globals_12, (MR_Integer) 264, &ml_backend__ml_commit_gen__NondetCopyOut_13);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ml_backend__ml_commit_gen__V_38_38;
          ...
          {
            ml_backend__ml_commit_gen__V_38_38 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_commit_gen__Context_10);
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_commit_gen__CallStatement_28, 1) = ((MR_Box) (ml_backend__ml_commit_gen__V_38_38));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
