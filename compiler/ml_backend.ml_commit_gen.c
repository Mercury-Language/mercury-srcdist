      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word OutputVarName_30;
          MR_String OutputVarNameStr_31;
          MR_Integer MaybeNum_32;
          MR_Word LocalVarName_33;
          MR_Word Type_34;
          MR_Word MLDS_Type_35;
          MR_Word GCStmt_36;
          MR_Word OutputVarLval_37;
          MR_Word LocalVarLval_38;
          MR_Word STATE_VARIABLE_Info_25_39;
          MR_Word Var_40;

          OutputVarName_30 = ml_backend__ml_code_util__ml_gen_local_var_name_2_f_0(Var_11, Entry_20);
          OutputVarNameStr_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), OutputVarName_30, (MR_Integer) 0))));
          MaybeNum_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OutputVarName_30, (MR_Integer) 1))));
          {
            LocalVarName_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarName_33, 0) = ((MR_Box) ((MR_Unsigned) 3U));
            MR_hl_field(MR_mktag(3), LocalVarName_33, 1) = ((MR_Box) (OutputVarNameStr_31));
            MR_hl_field(MR_mktag(3), LocalVarName_33, 2) = ((MR_Box) (MaybeNum_32));
          }
          Type_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_20, (MR_Integer) 1))));
          ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(STATE_VARIABLE_Info_26_26, Type_34, &MLDS_Type_35);
          ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(LocalVarName_33, Type_34, Context_2, &GCStmt_36, STATE_VARIABLE_Info_26_26, &STATE_VARIABLE_Info_25_39);
          HeadLocalDefn_22 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(LocalVarName_33, MLDS_Type_35, GCStmt_36, Context_2);
          ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_25_39, Var_11, Entry_20, &OutputVarLval_37);
          {
            LocalVarLval_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarLval_38, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), LocalVarLval_38, 1) = ((MR_Box) (LocalVarName_33));
            MR_hl_field(MR_mktag(3), LocalVarLval_38, 2) = ((MR_Box) (MLDS_Type_35));
          }
          {
            Var_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_40, 0) = ((MR_Box) (LocalVarLval_38));
          }
          HeadAssign_23 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(OutputVarLval_37, Var_40, Context_2);
          ml_backend__ml_gen_info__ml_gen_info_set_var_lval_4_p_0(Var_11, LocalVarLval_38, STATE_VARIABLE_Info_25_39, STATE_VARIABLE_Info_6);
          {
            MR_Word base;
