...
MR_decl_label10(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0, 43,4,5,6,7,9,10,11,12,14)
...
MR_BEGIN_MODULE(ml_backend__ml_commit_gen_module1)
	...
	MR_init_label10(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,43,4,5,6,7,9,10,11,12,14)
...
MR_def_static(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0_i43);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
