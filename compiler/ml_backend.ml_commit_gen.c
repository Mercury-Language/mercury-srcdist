...
static /* final */ const MR_Box ml_backend__ml_commit_gen_scalar_common_1[6][2] = {
  ...
  /* row 5 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_commit_gen_scalar_common_1[4]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
};
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        CommitRefLval_26 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        DoCommitStmt_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      ...
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[2])), Context_11, &SetSuccessFalse_36, STATE_VARIABLE_Info_60_60, &STATE_VARIABLE_Info_62_62);
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[3])), Context_11, &SetSuccessTrue_37, STATE_VARIABLE_Info_62_62, &STATE_VARIABLE_Info_65_65);
      {
      ...
      {
        TryCommitStmt_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          CommitRefLval_111 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          DoCommitStmt_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          TryCommitStmt_121 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            LocalVarName_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            LocalVarLval_44 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ArgRvals_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ArgRvals_24, 0) = ((MR_Box) (EnvPtrRval_23));
            MR_hl_field(MR_mktag(1), ArgRvals_24, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            CallStmt_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), CallStmt_29, 0) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(3), CallStmt_29, 1) = ((MR_Box) (&ml_backend__ml_commit_gen_scalar_common_1[5]));
          ...
          *LocalVarDefns_14 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            *FuncDefns_15 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (*LocalVarDefns_14));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
