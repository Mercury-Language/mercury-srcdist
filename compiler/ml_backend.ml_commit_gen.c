...
static /* final */ const MR_Box ml_backend__ml_commit_gen_scalar_common_1[5][2];
...
static /* final */ const MR_Box ml_backend__ml_commit_gen_scalar_common_1[5][2] = {
  ...
  /* row 2 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_commit_gen_scalar_common_1[1]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 3 */
  {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_52 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_commit_gen_scalar_common_1[0]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
      ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_52, STATE_VARIABLE_Info_51_51, &STATE_VARIABLE_Info_53_53);
      ...
      Var_58 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_commit_gen_scalar_common_1[0]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
      ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_58, STATE_VARIABLE_Info_57_57, &STATE_VARIABLE_Info_59_59);
      ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(STATE_VARIABLE_Info_59_59, &STATE_VARIABLE_Info_60_60);
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[3])), Context_11, &SetSuccessFalse_36, STATE_VARIABLE_Info_60_60, &STATE_VARIABLE_Info_62_62);
      ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_commit_gen_scalar_common_1[4])), Context_11, &SetSuccessTrue_37, STATE_VARIABLE_Info_62_62, &STATE_VARIABLE_Info_65_65);
      {
        Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (SetSuccessFalse_36));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (GoalStmt_35));
      ...
      Var_67 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), Var_70, Context_11);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (SetSuccessTrue_37));
      ...
      Var_73 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), Var_76, Context_11);
      {
        ...
        MR_hl_field(MR_mktag(3), TryCommitStmt_38, 2) = ((MR_Box) (Var_67));
        MR_hl_field(MR_mktag(3), TryCommitStmt_38, 3) = ((MR_Box) (Var_73));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (TryCommitStmt_38));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &SuccessFuncLabel_108, &SuccessFuncLabelRval_109, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_85_85);
        ...
        {
          CommitRefLval_111 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), CommitRefLval_111, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), CommitRefLval_111, 1) = ((MR_Box) (CommitRef_110));
          MR_hl_field(MR_mktag(3), CommitRefLval_111, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        CommitRefDefn_112 = ml_backend__ml_commit_gen__ml_gen_commit_var_decl_2_f_0(Context_11, CommitRef_110);
        {
          ...
          MR_hl_field(MR_mktag(2), Var_89, 0) = ((MR_Box) (CommitRefLval_111));
        }
        {
          DoCommitStmt_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), DoCommitStmt_113, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
          MR_hl_field(MR_mktag(3), DoCommitStmt_113, 1) = ((MR_Box) (Var_89));
          MR_hl_field(MR_mktag(3), DoCommitStmt_113, 2) = ((MR_Box) (Context_11));
        }
        ...
        {
          SuccessCont_116 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SuccessCont_116, 0) = ((MR_Box) (SuccessFuncLabelRval_109));
          MR_hl_field(MR_mktag(0), SuccessCont_116, 1) = ((MR_Box) (EnvPtrRval_115));
          MR_hl_field(MR_mktag(0), SuccessCont_116, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        ...
        Var_97 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), CopyLocalsToOutputArgs_107, Context_11);
        {
          TryCommitStmt_121 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TryCommitStmt_121, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
          MR_hl_field(MR_mktag(3), TryCommitStmt_121, 1) = ((MR_Box) (CommitRefLval_111));
          MR_hl_field(MR_mktag(3), TryCommitStmt_121, 2) = ((MR_Box) (GoalStmt_120));
          MR_hl_field(MR_mktag(3), TryCommitStmt_121, 3) = ((MR_Box) (Var_97));
          MR_hl_field(MR_mktag(3), TryCommitStmt_121, 4) = ((MR_Box) (Context_11));
        }
        {
          Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (TryCommitStmt_121));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), CallStmt_29, 1) = ((MR_Box) (&ml_backend__ml_commit_gen_scalar_common_1[2]));
