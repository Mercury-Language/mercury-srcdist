      ...
      case (MR_Integer) 1:
        {
          ...
          OutputVarNameStr_30 = ((MR_String) ((MR_hl_field(MR_mktag(1), OutputVarName_29, (MR_Integer) 0))));
          MaybeNum_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OutputVarName_29, (MR_Integer) 1))));
          {
            LocalVarName_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarName_32, 0) = ((MR_Box) ((MR_Unsigned) 3U));
            MR_hl_field(MR_mktag(3), LocalVarName_32, 1) = ((MR_Box) (OutputVarNameStr_30));
            MR_hl_field(MR_mktag(3), LocalVarName_32, 2) = ((MR_Box) (MaybeNum_31));
          }
          Type_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_20, (MR_Integer) 1))));
          ...
          {
            LocalVarLval_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarLval_37, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), LocalVarLval_37, 1) = ((MR_Box) (LocalVarName_32));
            MR_hl_field(MR_mktag(3), LocalVarLval_37, 2) = ((MR_Box) (MLDS_Type_34));
          }
          {
            Var_39 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_39, 0) = ((MR_Box) (LocalVarLval_37));
          }
