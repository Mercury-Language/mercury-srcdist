...
MR_decl_label10(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0, 42,4,5,6,7,9,10,11,12,14)
MR_decl_label7(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0, 15,16,17,18,19,21,22)
MR_decl_label10(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0, 2,3,4,6,7,8,9,10,11,12)
MR_decl_label1(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0, 13)
...
MR_BEGIN_MODULE(ml_backend__ml_commit_gen_module1)
	...
	MR_init_label10(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,42,4,5,6,7,9,10,11,12,14)
	MR_init_label7(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,15,16,17,18,19,21,22)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0_i42);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
...
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,15)
	...
	MR_sv(5) = MR_r1;
	MR_sv(8) = MR_r2;
	MR_sv(9) = (MR_Word) MR_tmkword(1, (MR_Word *) MR_sv(4));
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(fn__ml_backend__mlds__mlds_make_context_1_0,
		ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0_i16);
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,19)
	...
	MR_np_call_localret_ent(fn__ml_backend__ml_code_util__ml_gen_assign_3_0,
		ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0_i21);
MR_def_label(ml_backend__ml_commit_gen__ml_gen_make_locals_for_output_args_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(7);
...
MR_BEGIN_MODULE(ml_backend__ml_commit_gen_module2)
	...
	MR_init_label10(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0,2,3,4,6,7,8,9,10,11,12)
	MR_init_label1(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0,13)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0,9)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__list_to_set_1_0,
		ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0_i10);
MR_def_label(ml_backend__ml_commit_gen__ml_gen_maybe_make_locals_for_output_args_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__ml_backend__ml_commit_gen__init_threadscope_string_table(void);
#endif
...
void mercury__ml_backend__ml_commit_gen__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_commit_gen);
