  ...
  MR_Word * STATE_VARIABLE_Info_6)
{
  ...
  else
  {
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_19, Var_11, &Entry_20);
    IsDummy_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_20, (MR_Integer) 2))) & (MR_Integer) 1);
    switch (IsDummy_21) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word OutputVarName_38;
          MR_String OutputVarNameStr_39;
          MR_Integer MaybeNum_40;
          MR_Word LocalVarName_41;
          MR_Word Type_42;
          MR_Word MLDS_Type_43;
          MR_Word GCStmt_44;
          MR_Word OutputVarLval_45;
          MR_Word LocalVarLval_46;
          MR_Word STATE_VARIABLE_Info_25_47;
          MR_Word Var_48;

          OutputVarName_38 = ml_backend__ml_code_util__ml_gen_local_var_name_2_f_0(Var_11, Entry_20);
          OutputVarNameStr_39 = ((MR_String) ((MR_hl_field(MR_mktag(1), OutputVarName_38, (MR_Integer) 0))));
          MaybeNum_40 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OutputVarName_38, (MR_Integer) 1))));
          {
            LocalVarName_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarName_41, 0) = ((MR_Box) ((MR_Unsigned) 3U));
            MR_hl_field(MR_mktag(3), LocalVarName_41, 1) = ((MR_Box) (OutputVarNameStr_39));
            MR_hl_field(MR_mktag(3), LocalVarName_41, 2) = ((MR_Box) (MaybeNum_40));
          }
          Type_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_20, (MR_Integer) 1))));
          ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(STATE_VARIABLE_Info_26_26, Type_42, &MLDS_Type_43);
          ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(LocalVarName_41, Type_42, Context_2, &GCStmt_44, STATE_VARIABLE_Info_26_26, &STATE_VARIABLE_Info_25_47);
          HeadLocalDefn_22 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(LocalVarName_41, MLDS_Type_43, GCStmt_44, Context_2);
          ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_25_47, Var_11, Entry_20, &OutputVarLval_45);
          {
            LocalVarLval_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), LocalVarLval_46, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), LocalVarLval_46, 1) = ((MR_Box) (LocalVarName_41));
            MR_hl_field(MR_mktag(3), LocalVarLval_46, 2) = ((MR_Box) (MLDS_Type_43));
          }
          {
            Var_48 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_48, 0) = ((MR_Box) (LocalVarLval_46));
          }
          HeadAssign_23 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(OutputVarLval_45, Var_48, Context_2);
          ml_backend__ml_gen_info__ml_gen_info_set_var_lval_4_p_0(Var_11, LocalVarLval_46, STATE_VARIABLE_Info_25_47, STATE_VARIABLE_Info_6);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__3_3 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (HeadLocalDefn_22));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (LocalDefnsTail_17));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__4_4 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (HeadAssign_23));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (AssignsTail_18));
          }
        }
        break;
    }
