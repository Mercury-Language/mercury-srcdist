...
static /* final */ const MR_Box ll_backend__unify_gen_util_scalar_common_1[4][2];

static /* final */ const MR_Box ll_backend__unify_gen_util_scalar_common_2[8][1];
...
static /* final */ const MR_Box ll_backend__unify_gen_util_scalar_common_1[4][2] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 1U)),
    ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__unify_gen_util_scalar_common_2[0])))
  },
  /* row 2 */
  {
...
{
  {
    MR_Word LeftInitInst_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgMode_6, (MR_Integer) 0))));
    MR_Word LeftFinalInst_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgMode_6, (MR_Integer) 1))));
    MR_Word RightInitInst_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgMode_6, (MR_Integer) 2))));
    MR_Word RightFinalInst_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgMode_6, (MR_Integer) 3))));
    MR_Word LeftTopMode_13;
    MR_Word RightTopMode_14;

    check_hlds__mode_util__init_final_insts_to_top_functor_mode_5_p_0(ModuleInfo_5, LeftInitInst_9, LeftFinalInst_10, ArgType_7, &LeftTopMode_13);
    check_hlds__mode_util__init_final_insts_to_top_functor_mode_5_p_0(ModuleInfo_5, RightInitInst_11, RightFinalInst_12, ArgType_7, &RightTopMode_14);
    ...
    case (MR_Integer) 2:
      {
        ...
        *MaskedRval_6 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[5])));
    ...
    case (MR_Integer) 3:
      {
        ...
        *MaskedRval_6 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[6])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedRval0_5));
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        *MaskedRval_6 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[7])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedRval0_5));
      }
      break;
    case (MR_Integer) 5:
      {
        ...
        *MaskedRval_6 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[1])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedRval0_5));
      }
      break;
    case (MR_Integer) 6:
      {
        ...
        *MaskedRval_6 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[2])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedRval0_5));
      }
      break;
    case (MR_Integer) 4:
      {
        ...
        *MaskedRval_6 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[3])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedRval0_5));
      }
      break;
  }
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (ShiftInt_7));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ShiftedRval_6, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(3), ShiftedRval_6, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_util_scalar_common_1[3])));
      MR_hl_field(MR_mktag(3), ShiftedRval_6, 2) = ((MR_Box) (Rval_4));
      MR_hl_field(MR_mktag(3), ShiftedRval_6, 3) = ((MR_Box) (Var_11));
    }
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (ShiftInt_9));
      }
      {
      ...
      {
        ShiftedUnsignedRval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ShiftedUnsignedRval_8, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(3), ShiftedUnsignedRval_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_util_scalar_common_1[2])));
        MR_hl_field(MR_mktag(3), ShiftedUnsignedRval_8, 2) = ((MR_Box) (UnsignedRval_10));
        MR_hl_field(MR_mktag(3), ShiftedUnsignedRval_8, 3) = ((MR_Box) (Var_16));
      }
    }
...
{
  {
    ...
    switch (Fill_4) {
      ...
      case (MR_Integer) 2:
        {
          Rval1_7 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Rval1_7, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          MR_hl_field(MR_mktag(3), Rval1_7, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[1])));
      ...
      case (MR_Integer) 3:
        {
          Rval1_7 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Rval1_7, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          MR_hl_field(MR_mktag(3), Rval1_7, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[2])));
          MR_hl_field(MR_mktag(3), Rval1_7, 2) = ((MR_Box) (Rval0_5));
        }
        break;
      case (MR_Integer) 1:
        {
          Rval1_7 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Rval1_7, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          MR_hl_field(MR_mktag(3), Rval1_7, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[3])));
          MR_hl_field(MR_mktag(3), Rval1_7, 2) = ((MR_Box) (Rval0_5));
        }
        break;
    }
    {
      ...
      *Rval_6 = base;
      MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_util_scalar_common_2[4])));
...
{
  {
    ...
    if ((Rvals_3 == (MR_Word) ((MR_Unsigned) 0U)))
      OrAllRval_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_util_scalar_common_1[1]));
    else
    {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) RvalA_4)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), RvalA_4, (MR_Integer) 0)))) == (MR_Integer) 1)));
    MR_Word OrRval_6;
    MR_Word Var_17;
    ...
    else
    {
      ...
      if (succeeded)
        ...
        {
          OrRval_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), OrRval_6, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), OrRval_6, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_util_scalar_common_1[0])));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) ConsTag_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 0)))) == (MR_Integer) 11)));
          if (succeeded)
          {
            RemoteArgsTagInfo_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 1))));
            succeeded = ((MR_tag((MR_Word) RemoteArgsTagInfo_17)) == (MR_Integer) 2);
            if (succeeded)
            {
              RemoteSecTag_19 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RemoteArgsTagInfo_17, (MR_Integer) 1))));
              SectagSize_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RemoteSecTag_19, (MR_Integer) 1))));
          ...
          ll_backend__unify_gen_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_122_105_112_95_97_114_103_115_95_119_105_100_116_104_115_95_95_91_49_93_95_48_3_p_0(ConsArgs_16, ConsArgRepns_10, &ConsArgsPosWidths_24);
          {
            ...
            MR_hl_field(MR_mktag(0), TypeInfo_44_44, 0) = ((MR_Box) (&ll_backend__unify_gen_util__ll_backend__unify_gen_util__type_ctor_info_arg_and_width_1));
            MR_hl_field(MR_mktag(0), TypeInfo_44_44, 1) = ((MR_Box) (TypeInfo_for_Arg_41));
          }
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    {
      PosWidth_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * Type_6)
{
  switch (MR_tag((MR_Word) IntTag_4)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), IntTag_4, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
