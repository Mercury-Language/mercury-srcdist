...
ll_backend__unify_gen_util__IntroducedFrom__pred__associate_cons_id_args_with_widths__157__1_2_p_0(
  MR_Word AddedBy_20,
...
static /* final */ const MR_Box ll_backend__unify_gen_util_scalar_common_3[7][1];
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ShiftedRval_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_util_scalar_common_2[2])));
...
{
  {
    ...
    succeeded = ll_backend__unify_gen_util__IntroducedFrom__pred__associate_cons_id_args_with_widths__157__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
