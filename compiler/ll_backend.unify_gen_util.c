  ...
  MR_Word * Dir_12)
{
  ...
  hlds__mode_top_functor__init_final_insts_to_top_functor_mode_5_p_0(ModuleInfo_7, LeftInitInst_13, LeftFinalInst_14, ArgType_10, &LeftTopMode_17);
  hlds__mode_top_functor__init_final_insts_to_top_functor_mode_5_p_0(ModuleInfo_7, RightInitInst_15, RightFinalInst_16, ArgType_10, &RightTopMode_18);
