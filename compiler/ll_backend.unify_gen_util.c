...
{
  MR_bool succeeded;
  MR_Word LeftInitInst_13 = ((MR_Word) ((MR_hl_field(0, ArgMode_11, (MR_Integer) 0))));
  MR_Word LeftFinalInst_14 = ((MR_Word) ((MR_hl_field(0, ArgMode_11, (MR_Integer) 1))));
  MR_Word RightInitInst_15 = ((MR_Word) ((MR_hl_field(0, ArgMode_11, (MR_Integer) 2))));
  MR_Word RightFinalInst_16 = ((MR_Word) ((MR_hl_field(0, ArgMode_11, (MR_Integer) 3))));
  ...
  MR_Word * AllArgsPosWidths_8)
{
  ...
  if (succeeded)
  {
    MR_Word ConsArgRepns_11 = ((MR_Word) ((MR_hl_field(0, ConsRepnDefn_10, (MR_Integer) 4))));
    MR_Word ConsTag_12 = ((MR_Word) ((MR_hl_field(0, ConsRepnDefn_10, (MR_Integer) 3))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) ConsTag_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsTag_12, (MR_Integer) 0)))) == (MR_Integer) 11)));
        if (succeeded)
        {
          RemoteArgsTagInfo_18 = ((MR_Word) ((MR_hl_field(3, ConsTag_12, (MR_Integer) 1))));
          succeeded = ((MR_tag((MR_Word) RemoteArgsTagInfo_18)) == (MR_Integer) 2);
          if (succeeded)
          {
            RemoteSecTag_20 = ((MR_Word) ((MR_hl_field(2, RemoteArgsTagInfo_18, (MR_Integer) 1))));
            SectagSize_22 = ((MR_Word) ((MR_hl_field(0, RemoteSecTag_20, (MR_Integer) 1))));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Box Var_27 = (MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0));
    ...
    else
    {
      ...
      MR_Word Var_20 = ((MR_Word) ((MR_hl_field(0, ConsArgRepn_16, (MR_Integer) 3))));
