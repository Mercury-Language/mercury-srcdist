...
MR_decl_label6(__Unify___check_hlds__mcsolver__solver_cstrts_0_0, 4,6,8,10,14,1)
...
MR_decl_label7(__Compare___check_hlds__mcsolver__solver_cstrts_0_0, 3,2,5,9,13,17,60)
...
MR_BEGIN_MODULE(check_hlds__mcsolver_module49)
	...
	MR_init_label6(__Unify___check_hlds__mcsolver__solver_cstrts_0_0,4,6,8,10,14,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__mcsolver__solver_cstrts_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__mcsolver__solver_cstrts_0_0_i14);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(__Unify___check_hlds__mcsolver__solver_cstrts_0_0,8)
	...
	MR_np_call_localret_ent(__Unify___check_hlds__mcsolver__prop_graph_0_0,
		__Unify___check_hlds__mcsolver__solver_cstrts_0_0_i10);
MR_def_label(__Unify___check_hlds__mcsolver__solver_cstrts_0_0,10)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___check_hlds__mcsolver__solver_cstrts_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__mcsolver_module50)
	...
	MR_init_label7(__Compare___check_hlds__mcsolver__solver_cstrts_0_0,3,2,5,9,13,17,60)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__mcsolver__solver_cstrts_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__mcsolver__solver_cstrts_0_0_i60);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
...
MR_def_label(__Compare___check_hlds__mcsolver__solver_cstrts_0_0,13)
	...
	MR_np_call_localret_ent(__Compare___check_hlds__mcsolver__prop_graph_0_0,
		__Compare___check_hlds__mcsolver__solver_cstrts_0_0_i17);
MR_def_label(__Compare___check_hlds__mcsolver__solver_cstrts_0_0,17)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___check_hlds__mcsolver__solver_cstrts_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
