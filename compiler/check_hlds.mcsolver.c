...
{
  {
    ...
    check_hlds__mcsolver__Val_11 = ((MR_Word) check_hlds__mcsolver__conv0_Val_11);
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_41_41, 1) = ((MR_Box) (check_hlds__mcsolver__IntroducedFrom__pred__bind_equivalent_vars__535__1_4_p_0_1));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_64_64, 1) = ((MR_Box) (check_hlds__mcsolver__IntroducedFrom__func__make_solver_cstrts__422__1_2_f_0_1));
...
{
  {
    ...
    if (check_hlds__mcsolver__succeeded)
    ...
    else
      {
        ...
        MR_Word check_hlds__mcsolver__V_73_73;
        ...
        if (check_hlds__mcsolver__succeeded)
          {
            ...
            {
              check_hlds__mcsolver__V_73_73 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 0) = ((MR_Box) (&check_hlds__mcsolver_scalar_common_7[0]));
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 1) = ((MR_Box) (check_hlds__mcsolver__solve_assgt_4_p_0_2));
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 3) = ((MR_Box) (check_hlds__mcsolver__SCs_5));
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 4) = ((MR_Box) (check_hlds__mcsolver__X_6));
              MR_hl_field(MR_mktag(0), check_hlds__mcsolver__V_73_73, 5) = ((MR_Box) (check_hlds__mcsolver__V_7));
            }
            {
              check_hlds__mcsolver__succeeded = mercury__list__foldl_4_p_3(check_hlds__mcsolver__TypeCtorInfo_17_77, check_hlds__mcsolver__TypeInfo_18_78, check_hlds__mcsolver__V_73_73, check_hlds__mcsolver__ComplexCstrts_15, ((MR_Box) (check_hlds__mcsolver__Bs2_14)), &check_hlds__mcsolver__conv7_Bs_9);
            }
            if (check_hlds__mcsolver__succeeded)
              {
