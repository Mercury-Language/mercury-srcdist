...
MR_define_entry(mercury__check_hlds__mcsolver__implies_4_0);
	...
	MR_tempr9 = MR_r3;
	MR_tfield(1, MR_tempr5, 1) = MR_ctfield(0, MR_tempr9, 2);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tempr3;
	MR_tfield(1, MR_tempr1, 1) = MR_tempr5;
	MR_tag_alloc_heap(MR_tempr6, 0, (MR_Integer) 4);
	MR_r1 = MR_tempr6;
	MR_tfield(0, MR_tempr6, 0) = MR_ctfield(0, MR_tempr9, 0);
	MR_tfield(0, MR_tempr6, 1) = MR_ctfield(0, MR_tempr9, 1);
	MR_tfield(0, MR_tempr6, 2) = MR_tempr1;
	MR_tfield(0, MR_tempr6, 3) = MR_ctfield(0, MR_tempr9, 3);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__mcsolver__different_4_0);
	...
	MR_tempr11 = MR_r3;
	MR_tfield(1, MR_tempr1, 1) = MR_ctfield(0, MR_tempr11, 2);
	...
	MR_r1 = MR_tempr8;
	MR_tfield(0, MR_tempr8, 0) = MR_ctfield(0, MR_tempr11, 0);
	MR_tfield(0, MR_tempr8, 1) = MR_ctfield(0, MR_tempr11, 1);
	MR_tfield(0, MR_tempr8, 2) = MR_tempr6;
	MR_tfield(0, MR_tempr8, 3) = MR_ctfield(0, MR_tempr11, 3);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(check_hlds__mcsolver__equivalent_to_disjunction_4_0,5)
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr4 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr4, 3);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 4);
	MR_r1 = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = MR_ctfield(0, MR_tempr4, 0);
...
MR_def_label(check_hlds__mcsolver__at_most_one_3_0,5)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Integer) 1;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_ctfield(1, MR_tempr6, 0);
	MR_tfield(0, MR_tempr2, 1) = (MR_Integer) 0;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr3, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr3, 1) = MR_tempr2;
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr7 = MR_r2;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr7, 2);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tempr3;
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr5, 0, (MR_Integer) 4);
	MR_r1 = MR_tempr5;
	MR_tfield(0, MR_tempr5, 0) = MR_ctfield(0, MR_tempr7, 0);
	MR_tfield(0, MR_tempr5, 1) = MR_ctfield(0, MR_tempr7, 1);
	MR_tfield(0, MR_tempr5, 2) = MR_tempr1;
	MR_tfield(0, MR_tempr5, 3) = MR_ctfield(0, MR_tempr7, 3);
	MR_proceed();
	}
...
MR_def_label(check_hlds__mcsolver__exactly_one_3_0,3)
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr5 = MR_r2;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr5, 1);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 4);
	MR_r1 = MR_tempr3;
...
MR_def_label(check_hlds__mcsolver__prepare_var_constraint_3_0,7)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tempr6 = MR_r1;
	MR_tfield(0, MR_tempr1, 0) = MR_ctfield(2, MR_tempr6, 0);
	MR_tfield(0, MR_tempr1, 1) = (MR_Integer) 1;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_ctfield(2, MR_tempr6, 1);
	MR_tfield(0, MR_tempr2, 1) = (MR_Integer) 1;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr3, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr3, 1) = MR_tempr2;
...
MR_def_static(fn__check_hlds__mcsolver__IntroducedFrom__func__make_solver_cstrts__445__1_2_0)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tempr3 = MR_r1;
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(0, MR_ctfield(0, MR_tempr3, 1), 0);
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_ctfield(0, MR_ctfield(0, MR_tempr3, 0), 0);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_r1 = MR_tempr2;
	MR_proceed();
	}
