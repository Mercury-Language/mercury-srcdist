    ...
    case (MR_Integer) 2:
      {
        ...
        {
          Var_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (Var1_15));
          MR_hl_field(MR_mktag(0), Var_75, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        {
          Var_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (Var2_16));
          MR_hl_field(MR_mktag(0), Var_77, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        {
          Var_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (Var_75));
          MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (Var_77));
        }
        {
          Var_81 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (Var2_16));
          MR_hl_field(MR_mktag(0), Var_81, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
          Var_83 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (Var1_15));
          MR_hl_field(MR_mktag(0), Var_83, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
        ...
        Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PCs_0_2, (MR_Integer) 0))));
        Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PCs_0_2, (MR_Integer) 1))));
        Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PCs_0_2, (MR_Integer) 2))));
        Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PCs_0_2, (MR_Integer) 3))));
        {
