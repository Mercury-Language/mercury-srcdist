...
MR_decl_label4(transform_hlds__term_constr_build__build_abstract_goal_2_5_0, 57,64,185,69)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_build_module27)
	...
	MR_init_label4(transform_hlds__term_constr_build__build_abstract_goal_2_5_0,57,64,185,69)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_build__build_abstract_goal_2_5_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_build__build_abstract_goal_2_5_0_i185);
	}
	MR_r1 = MR_tfield(0, MR_r1, 3);
	MR_r2 = MR_r3;
	MR_np_tailcall_ent(transform_hlds__term_constr_build__build_abstract_unification_4_0);
MR_def_label(transform_hlds__term_constr_build__build_abstract_goal_2_5_0,185)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_build__this_file_0_0,
		transform_hlds__term_constr_build__build_abstract_goal_2_5_0_i69);
MR_def_label(transform_hlds__term_constr_build__build_abstract_goal_2_5_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
