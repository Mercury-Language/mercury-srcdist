  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  else
  {
    ...
    MR_Word Var_42;
    MR_Word Var_44;
    MR_Word STATE_VARIABLE_Args_1_129;
    MR_Word STATE_VARIABLE_Modes_1_130;
    MR_Word Var_24;
    MR_Box conv1_Terms_29;

    succeeded = transform_hlds__term_constr_build__strip_typeinfos_from_args_and_modes_2_5_p_0(VarTable_14, ArgVars_10, &STATE_VARIABLE_Args_1_129, Modes_11, &STATE_VARIABLE_Modes_1_130);
    if (succeeded)
    {
      FixedModes_18 = STATE_VARIABLE_Modes_1_130;
      FixedArgVars_17 = STATE_VARIABLE_Args_1_129;
    }
    else
      {
