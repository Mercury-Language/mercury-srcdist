...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[10]), HeadVar__1_1, ((MR_Box) (Var_22)), ((MR_Box) (ArgY1_16)));
      }
      else
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[11]), HeadVar__1_1, ((MR_Box) (Var_23)), ((MR_Box) (ArgY2_8)));
        }
      }
    }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_11_11 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[10]);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_13_13 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[11]);
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[9]), HeadVar__1_1, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
              }
            }
          }
        }
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_21_21 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[9]);
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[6]), &SubResult11_36, ((MR_Box) (ArgX11_34)), ((MR_Box) (ArgY11_35)));
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[7]), &SubResult13_42, ((MR_Box) (ArgX13_40)), ((MR_Box) (ArgY13_41)));
                              ...
                              else
                              {
                                ...
                                {
                                  mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[8]), HeadVar__1_1, ((MR_Box) (ArgX15_46)), ((MR_Box) (ArgY15_47)));
                                }
                              }
                            }
                          }
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeInfo_41_41 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[6]);
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              TypeInfo_43_43 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[7]);
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  TypeInfo_44_44 = (MR_Word) (&transform_hlds__term_constr_build_scalar_common_1[8]);
