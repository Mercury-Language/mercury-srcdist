...
MR_decl_label4(check_hlds__det_util__det_lookup_var_type_4_0, 2,3,4,5)
MR_decl_label8(check_hlds__det_util__interpret_unify_4_0, 4,5,7,3,39,12,14,1)
MR_decl_label5(__Unify___check_hlds__det_util__det_info_0_0, 4,6,8,12,1)
MR_decl_label10(__Compare___check_hlds__det_util__det_info_0_0, 3,2,5,9,13,17,21,25,29,33)
MR_decl_label3(__Compare___check_hlds__det_util__det_info_0_0, 37,41,126)
...
MR_BEGIN_MODULE(check_hlds__det_util_module8)
	...
	MR_init_label4(check_hlds__det_util__det_lookup_var_type_4_0,2,3,4,5)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_util__det_info_init_7_0,5)
	...
	MR_tfield(0, MR_r2, 4) = ((MR_Integer) MR_sv(7) | (((MR_Integer) MR_sv(8) << (MR_Integer) 1) | (((MR_Integer) MR_r1 << (MR_Integer) 2) | (((MR_Integer) MR_sv(5) << (MR_Integer) 3) | (((MR_Integer) 0 << (MR_Integer) 4) | ((MR_Integer) 0 << (MR_Integer) 5))))));
...
MR_BEGIN_MODULE(check_hlds__det_util_module28)
	...
	MR_init_label5(__Unify___check_hlds__det_util__det_info_0_0,4,6,8,12,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__det_util__det_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__det_util__det_info_0_0_i12);
	}
	MR_incr_sp(21);
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,6)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_pred__pred_id_0_0,
		__Unify___check_hlds__det_util__det_info_0_0_i8);
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__det_util_module29)
	...
	MR_init_label10(__Compare___check_hlds__det_util__det_info_0_0,3,2,5,9,13,17,21,25,29,33)
	MR_init_label3(__Compare___check_hlds__det_util__det_info_0_0,37,41,126)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i126);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, vartypes);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(11);
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,25)
	...
	MR_r2 = MR_sv(16);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i29);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i126);
	}
	...
	MR_r2 = MR_sv(17);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i33);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i126);
	}
	...
	MR_r2 = MR_sv(18);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i37);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i126);
	}
	...
	MR_r2 = MR_sv(19);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i41);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i126);
	}
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(21);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__det_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__check_hlds__det_util);
