...
MR_decl_label8(check_hlds__det_util__interpret_unify_4_0, 42,13,15,41,4,5,7,1)
MR_decl_label5(__Unify___check_hlds__det_util__det_info_0_0, 4,7,9,11,1)
MR_decl_label10(__Compare___check_hlds__det_util__det_info_0_0, 3,2,5,10,14,18,22,26,30,34)
MR_decl_label2(__Compare___check_hlds__det_util__det_info_0_0, 38,86)
...
MR_def_extern_entry(check_hlds__det_util__det_info_set_has_format_call_3_0)
...
MR_decl_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0)
MR_decl_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0)
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,5)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0);
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,4)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	MR_r3 = MR_sv(5);
...
MR_BEGIN_MODULE(check_hlds__det_util_module2)
	...
	MR_init_label8(check_hlds__det_util__interpret_unify_4_0,42,13,15,41,4,5,7,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__check_hlds__det_util__interpret_unify_4_0);
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(check_hlds__det_util__interpret_unify_4_0_i42);
	}
	MR_r2 = MR_r3;
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
MR_def_label(check_hlds__det_util__interpret_unify_4_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_BEGIN_MODULE(check_hlds__det_util_module21)
	MR_init_entry1(check_hlds__det_util__det_info_set_has_format_call_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_util__det_info_set_has_format_call_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'det_info_set_has_format_call'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__det_util__det_info_set_has_format_call_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 10);
...
MR_BEGIN_MODULE(check_hlds__det_util_module22)
	...
	MR_init_label5(__Unify___check_hlds__det_util__det_info_0_0,4,7,9,11,1)
MR_BEGIN_CODE
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,7)
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___check_hlds__det_util__det_info_0_0_i9);
...
MR_BEGIN_MODULE(check_hlds__det_util_module23)
	...
	MR_init_label2(__Compare___check_hlds__det_util__det_info_0_0,38,86)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i86);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(19);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__det_util_module28)
	MR_init_entry1(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__delete_unreachable_cases_2__147__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__det_util_module29)
	MR_init_entry1(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__delete_unreachable_cases_2__152__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
