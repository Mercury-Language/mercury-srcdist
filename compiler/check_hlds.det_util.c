...
{
  {
    ...
    check_hlds__det_util__delete_unreachable_cases_acc_6_p_0(Cases0_5, PossibleConsIdSet_9, (MR_Word) ((MR_Integer) 0), &RevReachableCases_10, (MR_Word) ((MR_Integer) 0), &RevUnreachableGoals_11);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((OtherConsIds1_24 == (MR_Word) ((MR_Integer) 0)))
        {
          {
