...
static MR_bool MR_CALL 
check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_acc__171__1_2_p_0(
  MR_Word HeadVar__2_2,
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__25_25 = (MR_Word) (&check_hlds__det_util_scalar_common_1[0]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__25_25, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeCtorInfo__26_26 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
          succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo__26_26, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo__27_27 = (MR_Word) (&check_hlds__det_util_scalar_common_1[1]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__27_27, ((MR_Box) (ArgX9_19)), ((MR_Box) (ArgY9_20)));
                  }
                }
              }
            }
  ...
  MR_Word * STATE_VARIABLE_DetInfo_9)
{
  ...
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DetInfo_0_8, (MR_Integer) 3))));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_acc__171__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
