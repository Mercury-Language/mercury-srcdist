...
MR_decl_label2(__Compare___check_hlds__det_util__det_info_0_0, 38,116)
...
MR_BEGIN_MODULE(check_hlds__det_util_module23)
	...
	MR_init_label2(__Compare___check_hlds__det_util__det_info_0_0,38,116)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i116);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(19);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
