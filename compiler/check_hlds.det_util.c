  ...
  MR_Word * STATE_VARIABLE_DetInfo_9)
{
  ...
  MR_Word Specs_7;
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DetInfo_0_8, (MR_Integer) 0))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DetInfo_0_8, (MR_Integer) 1))));
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DetInfo_0_8, (MR_Integer) 2))));
