    ...
    else
    {
...

      {
        ...
        *STATE_VARIABLE_DetInfo_6 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (((((MR_Unsigned) (Var_20) << (MR_Integer) 3)) | (((((MR_Unsigned) (Var_21) << (MR_Integer) 2)) | (((((MR_Unsigned) (Var_22) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)))))));
    ...
    else
    {
...

      {
        ...
        *STATE_VARIABLE_DetInfo_6 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_18));
        MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_19));
        MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (((((MR_Unsigned) (Var_20) << (MR_Integer) 3)) | (((((MR_Unsigned) (Var_21) << (MR_Integer) 2)) | (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 1)) | (MR_Unsigned) (Var_23)))))));
        MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_24));
      }
    }
  }
    ...
    else
    {
...

      {
        ...
        *STATE_VARIABLE_DetInfo_6 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_18));
        MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_19));
        MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (((((MR_Unsigned) (Var_20) << (MR_Integer) 3)) | (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 2)) | (((((MR_Unsigned) (Var_22) << (MR_Integer) 1)) | (MR_Unsigned) (Var_23)))))));
        MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_24));
      }
    }
  }
  ...
  {
    {
      ...
      *DetInfo_14 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (((((MR_Unsigned) (PessExtraVars_12) << (MR_Integer) 3)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)))))));
