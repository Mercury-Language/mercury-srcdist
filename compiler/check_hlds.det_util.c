...
MR_decl_label8(check_hlds__det_util__delete_unreachable_cases_3_0, 34,3,5,8,10,6,12,11)
...
MR_BEGIN_MODULE(check_hlds__det_util_module0)
	...
	MR_init_label8(check_hlds__det_util__delete_unreachable_cases_3_0,34,3,5,8,10,6,12,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,3)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i5);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,12)
	...
	MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i34);
