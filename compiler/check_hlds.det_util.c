    ...
    case (MR_Integer) 0:
      {
        ...
        Var_30 = mercury__term__context_init_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (LHSVar_5));
          MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (Var_30));
        }
        Var_31 = mercury__term__context_init_0_f_0();
        {
          Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (RHSVar_8));
          MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) (Var_31));
        }
        succeeded = mercury__term__unify_term_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_27, Var_28, STATE_VARIABLE_Subst_0_22, STATE_VARIABLE_Subst_23);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = mercury__term__unify_term_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_24, RHSTerm_13, STATE_VARIABLE_Subst_0_22, STATE_VARIABLE_Subst_23);
        }
      }
      break;
    case (MR_Integer) 2:
