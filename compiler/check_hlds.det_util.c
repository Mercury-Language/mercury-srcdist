      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes__hlds__vartypes__type_ctor_info_vartypes_0, &Var_25, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__det_util_scalar_common_1[1], HeadVar__1_1, ((MR_Box) (ArgX9_20)), ((MR_Box) (ArgY9_21)));
                    }
                  }
                }
              }
