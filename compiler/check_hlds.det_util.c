...
MR_decl_label4(check_hlds__det_util__det_info_init_6_0, 2,3,4,5)
MR_decl_label4(check_hlds__det_util__det_lookup_detism_4_0, 2,3,4,5)
MR_decl_label6(check_hlds__det_util__det_lookup_var_type_4_0, 2,4,6,8,14,5)
MR_decl_label8(check_hlds__det_util__interpret_unify_4_0, 13,15,11,41,4,5,7,1)
MR_decl_label4(__Unify___check_hlds__det_util__det_info_0_0, 4,7,9,1)
MR_decl_label8(__Compare___check_hlds__det_util__det_info_0_0, 3,2,5,10,14,18,22,26)
MR_decl_label2(__Compare___check_hlds__det_util__det_info_0_0, 30,70)
...
MR_def_extern_entry(check_hlds__det_util__det_info_init_6_0)
...
MR_decl_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__138__1_2_0)
MR_decl_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__143__1_2_0)
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,5)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__138__1_2_0);
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,4)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__143__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	MR_r3 = MR_sv(5);
...
MR_BEGIN_MODULE(check_hlds__det_util_module2)
	...
	MR_init_label8(check_hlds__det_util__interpret_unify_4_0,13,15,11,41,4,5,7,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__check_hlds__det_util__interpret_unify_4_0);
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__det_util__interpret_unify_4_0_i41);
	}
...
MR_def_label(check_hlds__det_util__interpret_unify_4_0,13)
	...
	MR_np_call_localret_ent(fn__term__context_init_0_0,
		check_hlds__det_util__interpret_unify_4_0_i15);
MR_def_label(check_hlds__det_util__interpret_unify_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(check_hlds__det_util__interpret_unify_4_0,11)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__det_util__interpret_unify_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__det_util_module8)
	...
	MR_init_label6(check_hlds__det_util__det_lookup_var_type_4_0,2,4,6,8,14,5)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__det_util__det_lookup_var_type_4_0_i5);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_type_table_2_0,
		check_hlds__det_util__det_lookup_var_type_4_0_i8);
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_r1 = MR_TRUE;
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,5)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__det_util__det_lookup_var_type_4_0_i14);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__det_util_module10)
	MR_init_entry1(check_hlds__det_util__det_info_init_6_0);
	MR_init_label4(check_hlds__det_util__det_info_init_6_0,2,3,4,5)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__det_util__det_info_init_6_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		check_hlds__det_util__det_info_init_6_0_i2);
MR_def_label(check_hlds__det_util__det_info_init_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r2 = (MR_Integer) 133;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_6_0_i3);
MR_def_label(check_hlds__det_util__det_info_init_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r2 = (MR_Integer) 134;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_6_0_i4);
MR_def_label(check_hlds__det_util__det_info_init_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_6_0_i5);
MR_def_label(check_hlds__det_util__det_info_init_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__det_util_module18)
	...
	MR_init_label4(__Unify___check_hlds__det_util__det_info_0_0,4,7,9,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__det_util__det_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__det_util__det_info_0_0_i9);
	}
	MR_incr_sp(15);
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__det_util_module19)
	...
	MR_init_label8(__Compare___check_hlds__det_util__det_info_0_0,3,2,5,10,14,18,22,26)
	MR_init_label2(__Compare___check_hlds__det_util__det_info_0_0,30,70)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i70);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__det_util_module24)
	MR_init_entry1(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__138__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__138__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__det_util_module25)
	MR_init_entry1(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__143__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__143__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
