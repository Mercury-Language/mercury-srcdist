...
MR_decl_label8(check_hlds__det_util__delete_unreachable_cases_3_0, 35,21,3,8,10,6,12,11)
MR_decl_label3(check_hlds__det_util__det_get_proc_info_2_0, 2,3,4)
MR_decl_label4(check_hlds__det_util__det_info_init_5_0, 2,3,4,5)
MR_decl_label4(check_hlds__det_util__det_lookup_detism_4_0, 2,3,4,5)
MR_decl_label6(check_hlds__det_util__det_lookup_var_type_4_0, 2,3,5,7,13,4)
MR_decl_label8(check_hlds__det_util__interpret_unify_4_0, 12,13,11,36,5,6,8,1)
MR_decl_label4(__Unify___check_hlds__det_util__det_info_0_0, 4,6,8,1)
MR_decl_label8(__Compare___check_hlds__det_util__det_info_0_0, 3,2,5,9,13,17,21,25)
MR_decl_label1(__Compare___check_hlds__det_util__det_info_0_0, 61)
...
MR_def_extern_entry(check_hlds__det_util__det_lookup_detism_4_0)
...
MR_def_extern_entry(check_hlds__det_util__det_info_init_5_0)
...
MR_BEGIN_MODULE(check_hlds__det_util_module0)
	...
	MR_init_label8(check_hlds__det_util__delete_unreachable_cases_3_0,35,21,3,8,10,6,12,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i3);
	}
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,3)
	...
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i21);
	}
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__cons_id_0_0,
		check_hlds__det_util__delete_unreachable_cases_3_0_i8);
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i6);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(4);
	MR_np_localcall_lab(check_hlds__det_util__delete_unreachable_cases_3_0,
		check_hlds__det_util__delete_unreachable_cases_3_0_i10);
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(__Compare___parse_tree__prog_data__cons_id_0_0,
		check_hlds__det_util__delete_unreachable_cases_3_0_i12);
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) 1 != (MR_Integer) MR_r1)) {
		MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i11);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__det_util__delete_unreachable_cases_3_0_i35);
MR_def_label(check_hlds__det_util__delete_unreachable_cases_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_succip_word = MR_sv(8);
...
MR_BEGIN_MODULE(check_hlds__det_util_module1)
	...
	MR_init_label8(check_hlds__det_util__interpret_unify_4_0,12,13,11,36,5,6,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__check_hlds__det_util__interpret_unify_4_0);
	...
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__det_util__interpret_unify_4_0_i36);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(check_hlds__det_util__interpret_unify_4_0_i11);
	}
	MR_incr_sp(4);
...
MR_def_label(check_hlds__det_util__interpret_unify_4_0,12)
	...
	MR_np_call_localret_ent(fn__term__context_init_0_0,
		check_hlds__det_util__interpret_unify_4_0_i13);
MR_def_label(check_hlds__det_util__interpret_unify_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(check_hlds__det_util__interpret_unify_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r3;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__det_util__interpret_unify_4_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(check_hlds__det_util__interpret_unify_4_0,5)
	...
	MR_np_call_localret_ent(parse_tree__prog_util__cons_id_and_args_to_term_3_0,
		check_hlds__det_util__interpret_unify_4_0_i6);
MR_def_label(check_hlds__det_util__interpret_unify_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_sv(3) = MR_r2;
	MR_np_call_localret_ent(fn__term__context_init_0_0,
		check_hlds__det_util__interpret_unify_4_0_i8);
MR_def_label(check_hlds__det_util__interpret_unify_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(check_hlds__det_util_module3)
	MR_init_entry1(check_hlds__det_util__det_lookup_detism_4_0);
	MR_init_label4(check_hlds__det_util__det_lookup_detism_4_0,2,3,4,5)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__det_util__det_lookup_detism_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_preds_2_0,
		check_hlds__det_util__det_lookup_detism_4_0_i2);
MR_def_label(check_hlds__det_util__det_lookup_detism_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		check_hlds__det_util__det_lookup_detism_4_0_i3);
MR_def_label(check_hlds__det_util__det_lookup_detism_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_procedures_2_0,
		check_hlds__det_util__det_lookup_detism_4_0_i4);
MR_def_label(check_hlds__det_util__det_lookup_detism_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	...
	MR_r4 = MR_sv(2);
	MR_np_call_localret_ent(map__lookup_3_0,
		check_hlds__det_util__det_lookup_detism_4_0_i5);
MR_def_label(check_hlds__det_util__det_lookup_detism_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(hlds__hlds_pred__proc_info_interface_determinism_2_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__det_util_module7)
	...
	MR_init_label6(check_hlds__det_util__det_lookup_var_type_4_0,2,3,5,7,13,4)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,2)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		check_hlds__det_util__det_lookup_var_type_4_0_i3);
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__det_util__det_lookup_var_type_4_0_i4);
	}
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_type_table_2_0,
		check_hlds__det_util__det_lookup_var_type_4_0_i7);
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_r1 = MR_TRUE;
...
MR_def_label(check_hlds__det_util__det_lookup_var_type_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("det_util.m", 10);
	MR_r2 = (MR_Word) MR_string_const("det_lookup_var_type", 19);
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__det_util__det_lookup_var_type_4_0_i13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_decl_entry(hlds__instmap__no_output_vars_5_0);
...
MR_define_entry(mercury__check_hlds__det_util__det_no_output_vars_4_0);
	...
	MR_np_tailcall_ent(hlds__instmap__no_output_vars_5_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__det_util_module9)
	MR_init_entry1(check_hlds__det_util__det_info_init_5_0);
	MR_init_label4(check_hlds__det_util__det_info_init_5_0,2,3,4,5)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__det_util__det_info_init_5_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		check_hlds__det_util__det_info_init_5_0_i2);
MR_def_label(check_hlds__det_util__det_info_init_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r2 = (MR_Integer) 128;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_5_0_i3);
MR_def_label(check_hlds__det_util__det_info_init_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Integer) 129;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_5_0_i4);
MR_def_label(check_hlds__det_util__det_info_init_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__det_util__det_info_init_5_0_i5);
MR_def_label(check_hlds__det_util__det_info_init_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__det_util_module16)
	...
	MR_init_label4(__Unify___check_hlds__det_util__det_info_0_0,4,6,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__det_util__det_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__det_util__det_info_0_0_i8);
	}
	MR_incr_sp(13);
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,4)
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___check_hlds__det_util__det_info_0_0_i6);
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__det_util__det_info_0_0_i1);
	}
...
MR_def_label(__Unify___check_hlds__det_util__det_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__det_util_module17)
	...
	MR_init_label8(__Compare___check_hlds__det_util__det_info_0_0,3,2,5,9,13,17,21,25)
	MR_init_label1(__Compare___check_hlds__det_util__det_info_0_0,61)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__det_util__det_info_0_0_i9);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i13);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
	...
	MR_r2 = MR_sv(9);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i17);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
	...
	MR_r2 = MR_sv(10);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i21);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
	...
	MR_r2 = MR_sv(11);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__det_util__det_info_0_0_i25);
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_util__det_info_0_0_i61);
	}
...
MR_def_label(__Compare___check_hlds__det_util__det_info_0_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__det_util__write_out_proc_statics(FILE *fp);
#endif
