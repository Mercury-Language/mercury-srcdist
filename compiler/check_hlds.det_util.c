...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,5)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__147__1_2_0);
...
MR_def_label(check_hlds__det_util__delete_unreachable_cases_2_4_0,4)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_util__IntroducedFrom__pred__delete_unreachable_cases_2__152__1_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r2, 3) = MR_sv(1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	MR_r3 = MR_sv(5);
