...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeDirName_15)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      *LibPath_10 = (MR_String) "";
      ...
      parse_tree__error_util__write_error_pieces_maybe_with_context_6_p_0(Globals_7, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, Var_30);
    }
    else
    {
...
{
  {
    ...
    mercury__dir__recursive_foldl2_7_p_0((MR_Word) (&parse_tree__module_cmds_scalar_common_1[0]), Var_32, SearchDir_17, (MR_Integer) 1, ((MR_Box) ((MR_Integer) 0)), &Result_19);
...
{
  {
    ...
    if ((MaybeStage2Base_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((MaybeStdlibDir_5 == (MR_Word) ((MR_Integer) 0)))
      *STATE_VARIABLE_StdLibs_9 = (MR_Word) ((MR_Integer) 0);
    else
    {
      ...
      switch (SourceDebug_8) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          STATE_VARIABLE_StdLibs_26_26 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 1:
          {
            MR_String Var_13;
            ...
            mercury__list__cons_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_13)), (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_StdLibs_14_14);
...
{
  {
    parse_tree__module_cmds__invoke_system_command_maybe_filter_output_8_p_0(Globals_8, ErrorStream_9, Verbosity_10, Command_11, (MR_Word) ((MR_Integer) 0), Succeeded_12);
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__module_cmds__invoke_system_command_maybe_filter_output_8_p_0(Globals_7, OutputStream_62, (MR_Integer) 0, Command_61, (MR_Word) ((MR_Integer) 0), Succeeded_10);
          switch (*Succeeded_10) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
...
{
  {
    ...
    if ((Result_15 == (MR_Word) ((MR_Integer) 0)))
      *Succeeded_10 = (MR_Integer) 1;
    else
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = (LinkResult_14 == (MR_Word) ((MR_Integer) 0));
          if (succeeded)
...
{
  {
    ...
    if ((MoveRes_15 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    parse_tree__module_cmds__invoke_system_command_maybe_filter_output_8_p_0(Globals_7, OutputStream_13, (MR_Integer) 0, Command_12, (MR_Word) ((MR_Integer) 0), &Succeeded_14);
    switch (Succeeded_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    *Succeeded_14 = mercury__bool__and_2_f_0(CommandSucceeded_24, ProcessOutputSucceeded_35);
    ...
    else
    {
      ...
      if (!((Res_41 == (MR_Word) ((MR_Integer) 0))))
      {
