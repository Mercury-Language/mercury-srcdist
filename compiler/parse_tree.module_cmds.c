...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__502__1_1_f_0(
  ...
  MR_Word * Succeeded_12)
{
  ...
  {
    MR_Word Message_20 = ((MR_Word) ((MR_hl_field(1, OpenResult_18, (MR_Integer) 0))));
    MR_String Var_38;
  ...
  {
    MR_Word Stream_19 = ((MR_Word) ((MR_hl_field(0, OpenResult_18, (MR_Integer) 0))));
    ...
    func_0(((MR_Box) (Pred_11)), ((MR_Box) (Stream_19)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_35_35);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 76, &Verbose_17);
  ...
  {
    MR_String Var_49;
    MR_Word Message_50 = ((MR_Word) ((MR_hl_field(1, OpenResult_19, (MR_Integer) 0))));
  ...
  {
    MR_Word Stream_20 = ((MR_Word) ((MR_hl_field(0, OpenResult_19, (MR_Integer) 0))));
    MR_Word ChmodResult_21;
    MR_String Var_39;
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, Pred_11, (MR_Integer) 1))));
    MR_Box conv1_STATE_VARIABLE_IO_37_37;

    func_0(((MR_Box) (Pred_11)), ((MR_Box) (Stream_20)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_37_37);
    ...
    {
      MR_Word Message_23 = ((MR_Word) ((MR_hl_field(1, ChmodResult_21, (MR_Integer) 0))));
      MR_String Var_47;
    ...
    {
      MR_Integer Status_22 = ((MR_Integer) ((MR_hl_field(0, ChmodResult_21, (MR_Integer) 0))));
  ...
  MR_Word * ListClassFiles_10)
{
  ...
  *ClassSubDir_9 = mercury__dir__relative_path_name_from_components_1_f_0(ClassSubDirPath_12);
  ...
  {
    MR_Word Error_27;
    MR_Word Var_42 = ((MR_Word) ((MR_hl_field(1, RelevantErrors_21, (MR_Integer) 0))));
    MR_String Var_44;

    Error_27 = ((MR_Word) ((MR_hl_field(0, Var_42, (MR_Integer) 2))));
  ...
  MR_Word * Succeeded_10)
{
  ...
  switch (TargetEnvType_14) {
    ...
    case (MR_Integer) 0:
      {
        MR_String LauncherFileName_26;
        MR_Word Verbose_28;
        MR_Word OpenResult_30;
        MR_String Var_39;
        MR_String Var_42;
        MR_String _LauncherFileNameProposed_27;
        MR_Word Var_29;

        parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[2])), MainModuleName_9, &LauncherFileName_26, &_LauncherFileNameProposed_27);
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 76, &Verbose_28);
        Var_42 = mercury__string__f_43_43_2_f_0(LauncherFileName_26, (MR_String) "\'...\n");
        Var_39 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_42);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_7, Verbose_28, Var_39);
        mercury__io__file__remove_file_4_p_0(LauncherFileName_26, &Var_29);
        mercury__io__open_output_4_p_0(LauncherFileName_26, &OpenResult_30);
        if (((MR_tag((MR_Word) OpenResult_30)) == (MR_Integer) 1))
        {
          MR_String Var_57;
          MR_Word Message_58 = ((MR_Word) ((MR_hl_field(1, OpenResult_30, (MR_Integer) 0))));

          Var_57 = mercury__io__error_message_1_f_0(Message_58);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", Var_57);
            return;
          }
        }
        else
        {
          MR_Word Stream_31 = ((MR_Word) ((MR_hl_field(0, OpenResult_30, (MR_Integer) 0))));
          MR_Word ChmodResult_32;
          MR_String Var_48;

          parse_tree__module_cmds__write_java_shell_script_6_p_0(Globals_8, MainModuleName_9, JarFileName_12, Stream_31);
          mercury__io__close_output_3_p_0(Stream_31);
          Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", LauncherFileName_26);
          mercury__io__call_system__call_system_4_p_0(Var_48, &ChmodResult_32);
          if (((MR_tag((MR_Word) ChmodResult_32)) == (MR_Integer) 1))
          {
            MR_Word Message_34 = ((MR_Word) ((MR_hl_field(1, ChmodResult_32, (MR_Integer) 0))));
            MR_String Var_55;

            Var_55 = mercury__io__error_message_1_f_0(Message_34);
            {
          ...
          {
            MR_Integer Status_33 = ((MR_Integer) ((MR_hl_field(0, ChmodResult_32, (MR_Integer) 0))));

            succeeded = (Status_33 == (MR_Integer) 0);
            if (succeeded)
            {
              *Succeeded_10 = (MR_Integer) 1;
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_7, Verbose_28, (MR_String) "% done.\n");
            }
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", (MR_String) "chmod exit status != 0");
    ...
    case (MR_Integer) 2:
      {
        MR_String LauncherFileName_60;
        MR_Word Verbose_62;
        MR_Word OpenResult_64;
        MR_String Var_73;
        MR_String Var_76;
        MR_String _LauncherFileNameProposed_61;
        MR_Word Var_63;

        parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[2])), MainModuleName_9, &LauncherFileName_60, &_LauncherFileNameProposed_61);
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 76, &Verbose_62);
        Var_76 = mercury__string__f_43_43_2_f_0(LauncherFileName_60, (MR_String) "\'...\n");
        Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_76);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_7, Verbose_62, Var_73);
        mercury__io__file__remove_file_4_p_0(LauncherFileName_60, &Var_63);
        mercury__io__open_output_4_p_0(LauncherFileName_60, &OpenResult_64);
        if (((MR_tag((MR_Word) OpenResult_64)) == (MR_Integer) 1))
        {
          MR_String Var_91;
          MR_Word Message_92 = ((MR_Word) ((MR_hl_field(1, OpenResult_64, (MR_Integer) 0))));

          Var_91 = mercury__io__error_message_1_f_0(Message_92);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", Var_91);
            return;
          }
        }
        else
        {
          ...
          parse_tree__module_cmds__write_java_msys_shell_script_6_p_0(Globals_8, MainModuleName_9, JarFileName_12, Stream_65);
          mercury__io__close_output_3_p_0(Stream_65);
          Var_82 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", LauncherFileName_60);
          mercury__io__call_system__call_system_4_p_0(Var_82, &ChmodResult_66);
          if (((MR_tag((MR_Word) ChmodResult_66)) == (MR_Integer) 1))
          {
            MR_Word Message_68 = ((MR_Word) ((MR_hl_field(1, ChmodResult_66, (MR_Integer) 0))));
            MR_String Var_89;

            Var_89 = mercury__io__error_message_1_f_0(Message_68);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", Var_89);
              return;
            }
          }
          else
          {
            ...
            {
              *Succeeded_10 = (MR_Integer) 1;
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_7, Verbose_62, (MR_String) "% done.\n");
            }
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/7", (MR_String) "chmod exit status != 0");
  ...
  MR_Word * Succeeded_12)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__write_java_batch_file_6_p_0(Var_39, Var_40, Var_41, Stream_19);
    mercury__io__close_output_3_p_0(Stream_19);
    *Succeeded_12 = (MR_Integer) 1;
  }
}
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 588, &UserClasspath_13);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 589, &RuntimeFlags_16);
  RuntimeOpts_17 = mercury__string__join_list_2_f_0((MR_String) " ", RuntimeFlags_16);
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 585, &Java_18);
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_19);
  {
    ...
    MR_hl_field(1, Var_58, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_1[5])));
  }
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_37 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__502__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 589, &RuntimeFlags_18);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 585, &Java_21);
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_22);
  {
    ...
    MR_hl_field(1, Var_72, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_1[4])));
  }
  {
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 588, &UserClasspath_15);
  ...
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_22);
  {
    ...
    MR_hl_field(1, Var_83, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_1[4])));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 611, &MaybeStdlibDir_5);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 305, &SourceDebug_8);
  ...
  MR_Word * Succeeded_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 76, &Verbose_12);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 691, &UseSymLinks_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 82, &PrintCommand_15);
  ...
  MR_Word * Result_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 691, &UseSymLinks_12);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_14)) == (MR_Integer) 1))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 76, &Verbose_57);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 76, &Verbose_76);
