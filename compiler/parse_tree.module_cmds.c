...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__529__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_37 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__529__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 72, &Verbose_76);
