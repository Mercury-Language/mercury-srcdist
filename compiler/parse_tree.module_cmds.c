...
static /* final */ const MR_Box parse_tree__module_cmds_scalar_common_1[9][2];
...
static /* final */ const MR_Box parse_tree__module_cmds_scalar_common_4[7][1];
...
static /* final */ const MR_Box parse_tree__module_cmds_scalar_common_1[9][2] = {
  ...
  /* row 8 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__module_cmds_scalar_common_1[7]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
};
...
{
  {
    ...
    Var_47 = mercury__dir__f_slash_2_f_0(LambdaHeadVar__1_45, (MR_String) "lib");
    LambdaHeadVar__2_46 = mercury__dir__f_slash_2_f_0(Var_47, GradeDir_14);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 675, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[6])), Globals_7, &NoSubdirsGlobals_13);
    parse_tree__file_names__module_name_to_lib_file_name_9_p_0(NoSubdirsGlobals_13, (MR_String) "predicate \140parse_tree.module_cmds.find_erlang_library_path\'/6", (MR_Integer) 1, (MR_String) "lib", (MR_Word) (((MR_Box) ((MR_String) ".beams"))), LibModuleName_12, &LibFileName_14);
      ...
      *LibPath_10 = (MR_String) "";
      {
        ...
        MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (Error_17));
      }
      {
        Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[8])));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Var_35, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_18, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.module_cmds.find_erlang_library_path\'/6"));
        MR_hl_field(MR_mktag(0), Spec_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Spec_18, 2) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(0), Spec_18, 3) = ((MR_Box) (Var_34));
      }
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[3])), MainModuleName_8, &FileName_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 65, &Verbose_13);
    Var_30 = mercury__string__f_43_43_2_f_0(FileName_12, (MR_String) "\'...\n");
    Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating batch file \140", Var_30);
    libs__file_util__maybe_write_string_4_p_0(Verbose_13, Var_27);
    mercury__io__remove_file_4_p_0(FileName_12, &Var_14);
    mercury__io__open_output_4_p_0(FileName_12, &OpenResult_15);
    if (((MR_tag((MR_Word) OpenResult_15)) == (MR_Integer) 1))
    {
      MR_Word Message_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_15, (MR_Integer) 0))));
      MR_String Var_35;

      Var_35 = mercury__io__error_message_1_f_0(Message_17);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", Var_35);
        return;
      }
    }
    else
    {
      ...
      func_0(((MR_Box) (Pred_9)), ((MR_Box) (Stream_16)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_36_36);
      mercury__io__close_output_3_p_0(Stream_16);
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[4])), MainModuleName_8, &FileName_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 65, &Verbose_13);
    ...
    libs__file_util__maybe_write_string_4_p_0(Verbose_13, Var_29);
    mercury__io__remove_file_4_p_0(FileName_12, &Var_14);
    mercury__io__open_output_4_p_0(FileName_12, &OpenResult_15);
    if (((MR_tag((MR_Word) OpenResult_15)) == (MR_Integer) 1))
    {
      MR_String Var_37;
      MR_Word Message_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_15, (MR_Integer) 0))));

      Var_37 = mercury__io__error_message_1_f_0(Message_49);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_37);
        return;
      }
    }
    else
    {
      MR_Word Stream_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_15, (MR_Integer) 0))));
      MR_Word ChmodResult_17;
      MR_String Var_40;
      void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Pred_9, (MR_Integer) 1))));
      MR_Box conv1_STATE_VARIABLE_IO_38_38;

      func_0(((MR_Box) (Pred_9)), ((MR_Box) (Stream_16)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_38_38);
      mercury__io__close_output_3_p_0(Stream_16);
      Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_12);
      mercury__io__call_system_4_p_0(Var_40, &ChmodResult_17);
      if (((MR_tag((MR_Word) ChmodResult_17)) == (MR_Integer) 1))
      {
        MR_Word Message_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ChmodResult_17, (MR_Integer) 0))));
        MR_String Var_44;

        Var_44 = mercury__io__error_message_1_f_0(Message_19);
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_44);
          return;
        }
      }
      else
      {
        MR_Integer Status_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ChmodResult_17, (MR_Integer) 0))));

        succeeded = (Status_18 == (MR_Integer) 0);
        if (succeeded)
        {
          *Succeeded_10 = (MR_Integer) 1;
...
{
  {
    ...
    switch (TargetEnvType_10) {
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[4])), MainModuleName_7, &FileName_30);
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 65, &Verbose_31);
          Var_48 = mercury__string__f_43_43_2_f_0(FileName_30, (MR_String) "\'...\n");
          Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_48);
          libs__file_util__maybe_write_string_4_p_0(Verbose_31, Var_45);
          mercury__io__remove_file_4_p_0(FileName_30, &Var_32);
          mercury__io__open_output_4_p_0(FileName_30, &OpenResult_33);
          if (((MR_tag((MR_Word) OpenResult_33)) == (MR_Integer) 1))
          {
            MR_String Var_53;
            MR_Word Message_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_33, (MR_Integer) 0))));

            Var_53 = mercury__io__error_message_1_f_0(Message_65);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_53);
              return;
            }
          }
          else
          {
            ...
            MR_Word ChmodResult_35;
            MR_String Var_56;

            parse_tree__module_cmds__write_erlang_shell_script_5_p_0(Globals_6, MainModuleName_7, Stream_34);
            mercury__io__close_output_3_p_0(Stream_34);
            Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_30);
            mercury__io__call_system_4_p_0(Var_56, &ChmodResult_35);
            if (((MR_tag((MR_Word) ChmodResult_35)) == (MR_Integer) 1))
            {
              MR_Word Message_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ChmodResult_35, (MR_Integer) 0))));
              MR_String Var_60;

              Var_60 = mercury__io__error_message_1_f_0(Message_37);
              {
            ...
            {
              MR_Integer Status_36 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ChmodResult_35, (MR_Integer) 0))));
      ...
      case (MR_Integer) 4:
      case (MR_Integer) 3:
        parse_tree__module_cmds__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_114_101_97_116_101_95_108_97_117_110_99_104_101_114_95_98_97_116_99_104_95_102_105_108_101_95_95_104_111_49_95_95_91_53_93_95_48_6_p_0(Globals_6, MainModuleName_7, Globals_6, MainModuleName_7, Succeeded_8);
        break;
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      parse_tree__module_cmds__write_erlang_batch_file_5_p_0(Var_38, Var_39, Stream_16);
      mercury__io__close_output_3_p_0(Stream_16);
      *Succeeded_10 = (MR_Integer) 1;
    }
  }
...
{
  {
    MR_Box wrapper_arg_2;
    MR_Box closure = closure_arg;
    MR_String conv0_LambdaHeadVar__2_46;

    conv0_LambdaHeadVar__2_46 = parse_tree__module_cmds__IntroducedFrom__func__write_erlang_batch_file__1169__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 561, &BeamExtStr_10);
    Var_35 = (MR_Word) (BeamExtStr_10);
    {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.write_erlang_batch_file\'/5", (MR_Integer) 1, Var_33, MainModuleName_7, &BeamFileName_11);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 580, &MaybeStdLibDir_15);
    ...
    else
    {
      ...
      Var_38 = mercury__dir__f_slash_2_f_0(StdLibDir_16, (MR_String) "lib");
      Var_37 = mercury__dir__f_slash_2_f_0(Var_38, GradeDir_14);
      StdLibBeamsPath_17 = mercury__dir__f_slash_2_f_0(Var_37, (MR_String) "libmer_std.beams");
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 574, &MercuryLibDirs0_20);
    {
      Var_44 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_8[0]));
      MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (parse_tree__module_cmds__write_erlang_batch_file_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_44, 3) = ((MR_Box) (GradeDir_14));
    }
    MercuryLibDirs_21 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_44, MercuryLibDirs0_20);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 572, &LinkLibrariesList0_23);
    {
      Var_50 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (parse_tree__module_cmds__write_erlang_batch_file_5_p_0_2));
      MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (Globals_6));
      MR_hl_field(MR_mktag(0), Var_50, 4) = ((MR_Box) (MercuryLibDirs_21));
    }
    mercury__list__map_foldl_5_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_50, LinkLibrariesList0_23, &LinkLibrariesList_24, ((MR_Box) ((MR_Integer) 0)), &conv2_STATE_VARIABLE_IO_51_51);
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 557, &Erlang_25);
    Var_57 = mercury__list__sort_and_remove_dups_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), LinkLibrariesList_24);
    Var_53 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__module_cmds_scalar_common_5[2]), Var_57);
    SearchLibs_26 = mercury__string__append_list_1_f_0(Var_53);
    Var_62 = libs__options__quote_arg_1_f_0(BeamDirName_12);
    Var_60 = mercury__string__f_43_43_2_f_0((MR_String) "%DIR%\\", Var_62);
    SearchProg_27 = parse_tree__module_cmds__pa_option_3_f_0((MR_Integer) 0, (MR_Integer) 0, Var_60);
    {
      Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (MainFunc_19));
      MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[6])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (BeamBaseNameNoExt_13));
      MR_hl_field(MR_mktag(1), Var_80, 1) = ((MR_Box) (Var_81));
    }
    {
      Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) ((MR_String) " -s "));
      MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) (Var_80));
    }
    {
      Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (SearchProg_27));
      MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) (Var_78));
    }
    {
      Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (SearchLibs_26));
      MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (Var_77));
    }
    {
      Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (SearchStdLib_18));
      MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (Var_76));
    }
    {
      Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) ((MR_String) " -noshell "));
      MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_75));
    }
    {
      Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Erlang_25));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (Var_73));
    }
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) ((MR_String) "set DIR=%~dp0\n"));
      MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_72));
    }
    {
      Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) ((MR_String) "setlocal\n"));
      MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (Var_70));
    }
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) ((MR_String) "rem Generated by the Mercury compiler.\n"));
      MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Var_68));
    }
    {
      Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) ((MR_String) "\100echo off\n"));
      MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (Var_66));
    }
    mercury__io__write_strings_4_p_0(Stream_8, Var_63);
  }
}
...
{
  {
    ...
    conv0_LambdaHeadVar__2_46 = parse_tree__module_cmds__IntroducedFrom__func__write_erlang_shell_script__1106__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
    wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_46));
    return wrapper_arg_2;
  }
}
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.write_erlang_shell_script\'/5", (MR_Integer) 1, Var_33, MainModuleName_7, &BeamFileName_11);
    BeamDirName_12 = mercury__dir__dirname_1_f_0(BeamFileName_11);
    parse_tree__file_names__module_name_to_file_name_stem_2_p_0(MainModuleName_7, &BeamBaseNameNoExt_13);
    libs__compute_grade__grade_directory_component_2_p_0(Globals_6, &GradeDir_14);
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 580, &MaybeStdLibDir_15);
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 574, &MercuryLibDirs0_20);
    {
      Var_44 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_8[0]));
      MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (parse_tree__module_cmds__write_erlang_shell_script_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_44, 3) = ((MR_Box) (GradeDir_14));
    }
    MercuryLibDirs_21 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_44, MercuryLibDirs0_20);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 572, &LinkLibrariesList0_23);
    {
      Var_50 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (parse_tree__module_cmds__write_erlang_shell_script_5_p_0_2));
      MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (Globals_6));
      MR_hl_field(MR_mktag(0), Var_50, 4) = ((MR_Box) (MercuryLibDirs_21));
    }
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 557, &Erlang_25);
    Var_57 = mercury__list__sort_and_remove_dups_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), LinkLibrariesList_24);
    Var_53 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__module_cmds_scalar_common_5[1]), Var_57);
    SearchLibs_26 = mercury__string__append_list_1_f_0(Var_53);
    Var_62 = libs__options__quote_arg_1_f_0(BeamDirName_12);
    Var_60 = mercury__string__f_43_43_2_f_0((MR_String) "\"\044DIR\"/", Var_62);
    SearchProg_27 = parse_tree__module_cmds__pa_option_3_f_0((MR_Integer) 1, (MR_Integer) 0, Var_60);
    {
      Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (MainFunc_19));
      MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[5])));
    }
    {
      Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) ((MR_String) " "));
    ...
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) ((MR_String) "exec "));
      MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_72));
    }
    {
      Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) ((MR_String) "DIR=\140dirname \"\0440\"\140\n"));
      MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (Var_70));
    }
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) ((MR_String) "# Generated by the Mercury compiler.\n"));
      MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Var_68));
    }
    {
      Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) ((MR_String) "#!/bin/sh\n"));
      MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (Var_66));
    }
    mercury__io__write_strings_4_p_0(Stream_8, Var_63);
  }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 674, &UseSubdirs_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 675, &UseGradeSubdirs_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 674, &UseSubdirs_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 675, &UseGradeSubdirs_13);
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_java_shell_script\'/5", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[5])), MainModuleName_7, &JarFileName_11);
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word Verbose_43;
          MR_Word OpenResult_45;
          MR_String Var_57;
          MR_String Var_60;
          MR_Word Var_44;

          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[4])), MainModuleName_7, &FileName_42);
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 65, &Verbose_43);
          Var_60 = mercury__string__f_43_43_2_f_0(FileName_42, (MR_String) "\'...\n");
          Var_57 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_60);
          libs__file_util__maybe_write_string_4_p_0(Verbose_43, Var_57);
          mercury__io__remove_file_4_p_0(FileName_42, &Var_44);
          mercury__io__open_output_4_p_0(FileName_42, &OpenResult_45);
          if (((MR_tag((MR_Word) OpenResult_45)) == (MR_Integer) 1))
          {
            MR_String Var_65;
            MR_Word Message_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_45, (MR_Integer) 0))));

            Var_65 = mercury__io__error_message_1_f_0(Message_77);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_65);
              return;
            }
          }
          else
          {
            MR_Word Stream_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_45, (MR_Integer) 0))));
            MR_Word ChmodResult_47;
            MR_String Var_68;

            parse_tree__module_cmds__write_java_shell_script_6_p_0(Globals_6, MainModuleName_7, JarFileName_11, Stream_46);
            mercury__io__close_output_3_p_0(Stream_46);
            Var_68 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_42);
            mercury__io__call_system_4_p_0(Var_68, &ChmodResult_47);
            if (((MR_tag((MR_Word) ChmodResult_47)) == (MR_Integer) 1))
            {
              MR_Word Message_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ChmodResult_47, (MR_Integer) 0))));
              MR_String Var_72;

              Var_72 = mercury__io__error_message_1_f_0(Message_49);
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_72);
                return;
              }
            }
            else
            {
              MR_Integer Status_48 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ChmodResult_47, (MR_Integer) 0))));

              succeeded = (Status_48 == (MR_Integer) 0);
              if (succeeded)
              {
                *Succeeded_8 = (MR_Integer) 1;
                libs__file_util__maybe_write_string_4_p_0(Verbose_43, (MR_String) "% done.\n");
              }
              else
                {
                  mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_String) "chmod exit status != 0");
...
{
  {
    ...
    else
    {
      ...
      parse_tree__module_cmds__write_java_msys_shell_script_6_p_0(Var_50, Var_51, Var_52, Stream_16);
      mercury__io__close_output_3_p_0(Stream_16);
      Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_12);
      mercury__io__call_system_4_p_0(Var_40, &ChmodResult_17);
      if (((MR_tag((MR_Word) ChmodResult_17)) == (MR_Integer) 1))
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 550, &UserClasspath_13);
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 547, &Java_18);
...
{
  {
    ...
    else
    {
      ...
      parse_tree__module_cmds__write_java_batch_file_6_p_0(Var_38, Var_39, Var_40, Stream_16);
      mercury__io__close_output_3_p_0(Stream_16);
      *Succeeded_10 = (MR_Integer) 1;
    }
  }
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 547, &Java_16);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 550, &UserClasspath_15);
...
{
  {
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 580, &MaybeStdlibDir_5);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 266, &SourceDebug_8);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_15, 0) = ((MR_Box) (OtherExt_8));
    }
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.touch_interface_datestamp\'/5", (MR_Integer) 0, Var_15, ModuleName_7, &OutputFileName_10);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 660, &UseSymLinks_12);
