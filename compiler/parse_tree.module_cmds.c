...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_14);
    }
    {
...
{
  {
    ...
    {
      libs__globals__set_option_4_p_0((MR_Integer) 643, (MR_Word) MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_8[0]), parse_tree__module_cmds__Globals_7, &parse_tree__module_cmds__NoSubdirsGlobals_13);
    }
    {
    ...
    if (((MR_tag((MR_Word) parse_tree__module_cmds__MaybeDirName_15)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        *parse_tree__module_cmds__LibPath_10 = (MR_String) "";
        {
          parse_tree__module_cmds__V_32_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), parse_tree__module_cmds__V_32_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(3), parse_tree__module_cmds__V_32_32, 1) = ((MR_Box) (parse_tree__module_cmds__Error_17));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_30_30, 0) = ((MR_Box) (parse_tree__module_cmds__V_32_32));
          MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_30_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__error_util__write_error_pieces_maybe_with_context_6_p_0(parse_tree__module_cmds__Globals_7, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, parse_tree__module_cmds__V_30_30);
        }
      }
    else
      {
...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 530, &parse_tree__module_cmds__BeamExt_10);
    }
    {
    ...
    {
      libs__globals__lookup_maybe_string_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 549, &parse_tree__module_cmds__MaybeStdLibDir_15);
    }
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 543, &parse_tree__module_cmds__MercuryLibDirs0_20);
    }
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 541, &parse_tree__module_cmds__LinkLibrariesList0_23);
    }
    {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 526, &parse_tree__module_cmds__Erlang_25);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 519, &parse_tree__module_cmds__UserClasspath_13);
    }
    ...
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 516, &parse_tree__module_cmds__Java_16);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 516, &parse_tree__module_cmds__Java_18);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_8, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_14);
    }
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_32);
          }
          {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_4, (MR_Integer) 642, &parse_tree__module_cmds__UseSubdirs_7);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_4, (MR_Integer) 643, &parse_tree__module_cmds__UseGradeSubdirs_8);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 642, &parse_tree__module_cmds__UseSubdirs_12);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 643, &parse_tree__module_cmds__UseGradeSubdirs_13);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_maybe_string_option_3_p_0(parse_tree__module_cmds__Globals_3, (MR_Integer) 549, &parse_tree__module_cmds__MaybeStdlibDir_5);
    }
    if ((parse_tree__module_cmds__MaybeStdlibDir_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *parse_tree__module_cmds__STATE_VARIABLE_StdLibs_9 = parse_tree__module_cmds__STATE_VARIABLE_StdLibs_10_10;
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_3, (MR_Integer) 242, &parse_tree__module_cmds__SourceDebug_8);
        }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_41);
          }
          {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_9, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_17);
    }
    switch (parse_tree__module_cmds__Verbosity_11) {
      ...
      case (MR_Integer) 1:
        {
          {
            libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_9, (MR_Integer) 60, &parse_tree__module_cmds__PrintCommand_18);
          }
        }
        break;
    }
    ...
    if (((MR_tag((MR_Word) parse_tree__module_cmds__TmpFileResult_19)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          parse_tree__module_cmds__V_60_60 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__Error_152);
        }
        {
          parse_tree__module_cmds__V_57_57 = mercury__string__f_43_43_2_f_0((MR_String) "Could not create temporary file: ", parse_tree__module_cmds__V_60_60);
        }
        {
          libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_57_57);
        }
    ...
    else
      {
        ...
        if (parse_tree__module_cmds__succeeded)
        ...
        else
          {
            ...
            if (parse_tree__module_cmds__succeeded)
              {
                MR_String parse_tree__module_cmds__V_61_61;

                {
                  parse_tree__module_cmds__V_61_61 = mercury__string__f_43_43_2_f_0((MR_String) " > ", parse_tree__module_cmds__TmpFile_20);
                }
                {
                  parse_tree__module_cmds__CommandRedirected_21 = mercury__string__f_43_43_2_f_0(parse_tree__module_cmds__Command_12, parse_tree__module_cmds__V_61_61);
                }
              }
            else
              {
                MR_Word parse_tree__module_cmds__V_63_63;
                MR_Word parse_tree__module_cmds__V_64_64;
                MR_Word parse_tree__module_cmds__V_66_66;

                {
                  parse_tree__module_cmds__V_66_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_66_66, 0) = ((MR_Box) (parse_tree__module_cmds__TmpFile_20));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_66_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[2])));
                }
                {
                  parse_tree__module_cmds__V_64_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_64_64, 0) = ((MR_Box) ((MR_String) " > "));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_64_64, 1) = ((MR_Box) (parse_tree__module_cmds__V_66_66));
                }
                {
                  parse_tree__module_cmds__V_63_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_63_63, 0) = ((MR_Box) (parse_tree__module_cmds__Command_12));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_63_63, 1) = ((MR_Box) (parse_tree__module_cmds__V_64_64));
                }
                {
                  parse_tree__module_cmds__CommandRedirected_21 = mercury__string__append_list_1_f_0(parse_tree__module_cmds__V_63_63);
                }
              }
          }
        {
        ...
        if (((MR_tag((MR_Word) parse_tree__module_cmds__Result_22)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            {
              parse_tree__module_cmds__V_71_71 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__Error_26);
            }
            {
              libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_71_71);
            }
            parse_tree__module_cmds__CommandSucceeded_24 = (MR_Integer) 0;
          }
        else
          {
            MR_Word parse_tree__module_cmds__V_156_156 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__module_cmds__Result_22, (MR_Integer) 0)));

            if (((MR_tag((MR_Word) parse_tree__module_cmds__V_156_156)) == (MR_mktag((MR_Integer) 0))))
              {
                MR_Integer parse_tree__module_cmds__Status_23 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_156_156, (MR_Integer) 0)));
              ...
              {
                MR_Integer parse_tree__module_cmds__Signal_25 = ((MR_Integer) (MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_156_156, (MR_Integer) 0)));
                MR_String parse_tree__module_cmds__V_74_74;
                MR_String parse_tree__module_cmds__V_77_77;
                MR_String parse_tree__module_cmds__V_78_78;
                MR_String parse_tree__module_cmds__V_80_80;
                MR_String parse_tree__module_cmds__V_83_83;
                MR_String parse_tree__module_cmds__V_84_84;

                {
                  parse_tree__module_cmds__V_78_78 = mercury__string__int_to_string_1_f_0(parse_tree__module_cmds__Signal_25);
                }
                {
                  parse_tree__module_cmds__V_77_77 = mercury__string__f_43_43_2_f_0(parse_tree__module_cmds__V_78_78, (MR_String) ".");
                }
                {
                  parse_tree__module_cmds__V_74_74 = mercury__string__f_43_43_2_f_0((MR_String) "system command received signal ", parse_tree__module_cmds__V_77_77);
                }
                {
                  libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_74_74);
                }
                {
                  parse_tree__module_cmds__V_84_84 = mercury__string__int_to_string_1_f_0(parse_tree__module_cmds__Signal_25);
                }
                {
                  parse_tree__module_cmds__V_83_83 = mercury__string__f_43_43_2_f_0(parse_tree__module_cmds__V_84_84, (MR_String) ".");
                }
                {
                  parse_tree__module_cmds__V_80_80 = mercury__string__f_43_43_2_f_0((MR_String) "system command received signal ", parse_tree__module_cmds__V_83_83);
                }
                {
                  libs__file_util__report_error_3_p_0(parse_tree__module_cmds__V_80_80);
                }
                {
        ...
        if (((MR_tag((MR_Word) parse_tree__module_cmds__ProcessedTmpFileResult_28)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            {
              parse_tree__module_cmds__V_91_91 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__ProcessTmpError_38);
            }
            {
              libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_91_91);
            }
        ...
        else
          {
                ...
                if (parse_tree__module_cmds__succeeded)
                  {
                    ...
                    MR_Word parse_tree__module_cmds__V_95_95;
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_101_101, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessedTmpFile_29));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_101_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[2])));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_98_98, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessOutput_27));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_96_96, 0) = ((MR_Box) ((MR_String) " | "));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_96_96, 1) = ((MR_Box) (parse_tree__module_cmds__V_98_98));
                    }
                    {
                      parse_tree__module_cmds__V_95_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_95_95, 0) = ((MR_Box) (parse_tree__module_cmds__TmpFile_20));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_95_95, 1) = ((MR_Box) (parse_tree__module_cmds__V_96_96));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_93_93, 0) = ((MR_Box) ((MR_String) "Get-Content "));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_93_93, 1) = ((MR_Box) (parse_tree__module_cmds__V_95_95));
                    }
                    {
                      parse_tree__module_cmds__ProcessOutputRedirected_31 = mercury__string__append_list_1_f_0(parse_tree__module_cmds__V_93_93);
                    }
                  }
                else
                  {
                    ...
                    MR_Word parse_tree__module_cmds__V_109_109;
                    MR_Word parse_tree__module_cmds__V_111_111;

                    {
                      parse_tree__module_cmds__V_111_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_111_111, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessedTmpFile_29));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_111_111, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    }
                    {
                      parse_tree__module_cmds__V_109_109 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_109_109, 0) = ((MR_Box) ((MR_String) " > "));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_109_109, 1) = ((MR_Box) (parse_tree__module_cmds__V_111_111));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_108_108, 0) = ((MR_Box) (parse_tree__module_cmds__TmpFile_20));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_108_108, 1) = ((MR_Box) (parse_tree__module_cmds__V_109_109));
                    }
                    {
                      parse_tree__module_cmds__V_106_106 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_106_106, 0) = ((MR_Box) ((MR_String) " < "));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_106_106, 1) = ((MR_Box) (parse_tree__module_cmds__V_108_108));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_105_105, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessOutput_27));
                      MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_105_105, 1) = ((MR_Box) (parse_tree__module_cmds__V_106_106));
                    }
                    {
                      parse_tree__module_cmds__ProcessOutputRedirected_31 = mercury__string__append_list_1_f_0(parse_tree__module_cmds__V_105_105);
                    }
                  }
              }
            else
              {
                MR_Word parse_tree__module_cmds__V_113_113;
                MR_Word parse_tree__module_cmds__V_114_114;
                MR_Word parse_tree__module_cmds__V_116_116;
                MR_Word parse_tree__module_cmds__V_117_117;
                MR_Word parse_tree__module_cmds__V_119_119;

                {
                  parse_tree__module_cmds__V_119_119 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_119_119, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessedTmpFile_29));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_119_119, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[2])));
                }
                {
                  parse_tree__module_cmds__V_117_117 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_117_117, 0) = ((MR_Box) ((MR_String) " > "));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_117_117, 1) = ((MR_Box) (parse_tree__module_cmds__V_119_119));
                }
                {
                  parse_tree__module_cmds__V_116_116 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_116_116, 0) = ((MR_Box) (parse_tree__module_cmds__TmpFile_20));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_116_116, 1) = ((MR_Box) (parse_tree__module_cmds__V_117_117));
                }
                {
                  parse_tree__module_cmds__V_114_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_114_114, 0) = ((MR_Box) ((MR_String) " < "));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_114_114, 1) = ((MR_Box) (parse_tree__module_cmds__V_116_116));
                }
                {
                  parse_tree__module_cmds__V_113_113 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_113_113, 0) = ((MR_Box) (parse_tree__module_cmds__ProcessOutput_27));
                  MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_113_113, 1) = ((MR_Box) (parse_tree__module_cmds__V_114_114));
                }
                {
                  parse_tree__module_cmds__ProcessOutputRedirected_31 = mercury__string__append_list_1_f_0(parse_tree__module_cmds__V_113_113);
                }
              }
            {
            ...
            {
              mercury__io__remove_file_4_p_0(parse_tree__module_cmds__TmpFile_20, &parse_tree__module_cmds__V_33_33);
            }
            if (((MR_tag((MR_Word) parse_tree__module_cmds__ProcessOutputResult_32)) == (MR_mktag((MR_Integer) 1))))
              {
                ...
                MR_String parse_tree__module_cmds__V_125_125;

                {
                  parse_tree__module_cmds__V_125_125 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__ProcessOutputError_37);
                }
                {
                  libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_125_125);
                }
                parse_tree__module_cmds__ProcessOutputSucceeded_35 = (MR_Integer) 0;
              }
            else
              {
                MR_Word parse_tree__module_cmds__V_157_157 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__module_cmds__ProcessOutputResult_32, (MR_Integer) 0)));

                if (((MR_tag((MR_Word) parse_tree__module_cmds__V_157_157)) == (MR_mktag((MR_Integer) 0))))
                  {
                    MR_Integer parse_tree__module_cmds__ProcessOutputStatus_34 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_157_157, (MR_Integer) 0)));
                  ...
                  {
                    MR_Integer parse_tree__module_cmds__ProcessOutputSignal_36 = ((MR_Integer) (MR_hl_field(MR_mktag(1), parse_tree__module_cmds__V_157_157, (MR_Integer) 0)));
                    MR_String parse_tree__module_cmds__V_129_129;
                    MR_String parse_tree__module_cmds__V_132_132;
                    ...
                    {
                      parse_tree__module_cmds__V_133_133 = mercury__string__int_to_string_1_f_0(parse_tree__module_cmds__ProcessOutputSignal_36);
                    }
                    {
                      parse_tree__module_cmds__V_132_132 = mercury__string__f_43_43_2_f_0(parse_tree__module_cmds__V_133_133, (MR_String) ".");
                    }
                    {
                      parse_tree__module_cmds__V_129_129 = mercury__string__f_43_43_2_f_0((MR_String) "system command received signal ", parse_tree__module_cmds__V_132_132);
                    }
                    {
                      libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_129_129);
                    }
                    parse_tree__module_cmds__ProcessOutputSucceeded_35 = (MR_Integer) 0;
                  }
              }
    ...
    if (((MR_tag((MR_Word) parse_tree__module_cmds__TmpFileRes_39)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String parse_tree__module_cmds__V_142_142;

        {
          parse_tree__module_cmds__V_142_142 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__TmpFileError_43);
        }
        {
          parse_tree__module_cmds__V_139_139 = mercury__string__f_43_43_2_f_0((MR_String) "error opening command output: ", parse_tree__module_cmds__V_142_142);
        }
        {
          libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_139_139);
        }
      }
    else
      {
        ...
        MR_Word parse_tree__module_cmds__V_143_143;

        {
          parse_tree__module_cmds__V_143_143 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_143_143, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_2[1]));
          MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_143_143, 1) = ((MR_Box) (parse_tree__module_cmds__invoke_system_command_maybe_filter_output_8_p_0_1));
          MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_143_143, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), parse_tree__module_cmds__V_143_143, 3) = ((MR_Box) (parse_tree__module_cmds__ErrorStream_10));
        }
        {
          mercury__io__input_stream_foldl_io_5_p_0(parse_tree__module_cmds__TmpFileStream_40, parse_tree__module_cmds__V_143_143, &parse_tree__module_cmds__Res_41);
        }
        if ((parse_tree__module_cmds__Res_41 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_String parse_tree__module_cmds__V_145_145;
            MR_String parse_tree__module_cmds__V_148_148;

            {
              parse_tree__module_cmds__V_148_148 = mercury__io__error_message_1_f_0(parse_tree__module_cmds__TmpFileReadError_42);
            }
            {
              parse_tree__module_cmds__V_145_145 = mercury__string__f_43_43_2_f_0((MR_String) "error reading command output: ", parse_tree__module_cmds__V_148_148);
            }
            {
              libs__file_util__report_error_to_stream_4_p_0(parse_tree__module_cmds__ErrorStream_10, parse_tree__module_cmds__V_145_145);
            }
          }
        {
    ...
    {
      mercury__io__remove_file_4_p_0(parse_tree__module_cmds__ProcessedTmpFile_29, &parse_tree__module_cmds__V_44_44);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_5, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_8);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 628, &parse_tree__module_cmds__UseSymLinks_12);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_7, (MR_Integer) 60, &parse_tree__module_cmds__PrintCommand_13);
    }
    switch (parse_tree__module_cmds__UseSymLinks_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_cmds__Globals_6, (MR_Integer) 54, &parse_tree__module_cmds__Verbose_10);
    }
    {
