    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 595, &UserClasspath_31);
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 596, &RuntimeFlags_34);
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 592, &Java_37);
  ...
  MR_String * ContentStr_8)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 595, &UserClasspath_10);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 596, &RuntimeFlags_13);
  RuntimeOpts_14 = mercury__string__join_list_2_f_0((MR_String) " ", RuntimeFlags_13);
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 592, &Java_15);
  ...
  MR_String * ContentStr_8)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 596, &RuntimeFlags_15);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 592, &Java_18);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 81, &Verbose_17);
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 618, &MaybeStdLibDir_5);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 312, &SourceDebug_8);
  ...
  MR_Word * Succeeded_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 81, &Verbose_12);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 698, &UseSymLinks_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 87, &PrintCommand_15);
  ...
  MR_Word * Result_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 698, &UseSymLinks_12);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_14)) == (MR_Integer) 1))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 81, &Verbose_57);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 81, &Verbose_76);
