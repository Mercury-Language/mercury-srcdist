...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__950__1_1_f_0(
  ...
  MR_Word FileError_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo__15_17 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
      succeeded = mercury__set__contains_2_p_0(TypeCtorInfo__15_17, NestedClassPrefixes_3, ((MR_Box) (Var_16)));
    }
  }
  else
    succeeded = MR_TRUE;
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__15_30 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
          succeeded = mercury__set__contains_2_p_0(TypeCtorInfo__15_30, NestedClassPrefixes_10, ((MR_Box) (Var_29)));
        }
        if (succeeded)
        {
          MR_String Var_23;
  ...
  MR_Word * Succeeded_10)
{
  ...
  else
  {
    ...
    mercury__io__call_system__call_system_4_p_0(Var_42, &ChmodResult_18);
  ...
  if ((RelevantErrors_22 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      ClassSubDirSep_25 = mercury__dir__f_slash_2_f_0(*ClassSubDir_9, (MR_String) "");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&parse_tree__module_cmds_scalar_common_6[0]));
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 71, &Verbose_27);
        ...
        if (((MR_tag((MR_Word) OpenResult_29)) == (MR_Integer) 1))
        {
          ...
          Var_50 = mercury__io__error_message_1_f_0(Message_61);
          {
        ...
        else
        {
          ...
          Var_53 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_25);
          mercury__io__call_system__call_system_4_p_0(Var_53, &ChmodResult_31);
          if (((MR_tag((MR_Word) ChmodResult_31)) == (MR_Integer) 1))
          {
            ...
            Var_57 = mercury__io__error_message_1_f_0(Message_33);
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 71, &Verbose_64);
        ...
        if (((MR_tag((MR_Word) OpenResult_66)) == (MR_Integer) 1))
        {
          ...
          Var_87 = mercury__io__error_message_1_f_0(Message_98);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_87);
            return;
          }
        }
        else
        {
          ...
          Var_90 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_62);
          mercury__io__call_system__call_system_4_p_0(Var_90, &ChmodResult_68);
          if (((MR_tag((MR_Word) ChmodResult_68)) == (MR_Integer) 1))
          {
            ...
            Var_94 = mercury__io__error_message_1_f_0(Message_70);
            {
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 560, &UserClasspath_13);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 557, &Java_16);
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_17);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[3])));
  }
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_34 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__950__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 557, &Java_18);
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_19);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[2])));
  }
  {
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 560, &UserClasspath_15);
  ...
  parse_tree__java_names__mangle_sym_name_for_java_4_p_0(MainModuleName_8, (MR_Integer) 0, (MR_String) ".", &ClassName_19);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_1[2])));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 277, &SourceDebug_8);
  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 662, &UseSymLinks_16);
  switch (UseSymLinks_16) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_String Command_74;

        Command_74 = libs__file_util__make_install_dir_command_3_f_0(Globals_9, SourceDirName_12, DestinationDirName_13);
        parse_tree__module_cmds__invoke_system_command_maybe_filter_output_10_p_0(Globals_9, ProgressStream_10, ErrorStream_11, ErrorStream_11, (MR_Integer) 0, Command_74, (MR_Word) ((MR_Unsigned) 0U), Succeeded_14);
        switch (*Succeeded_14) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_16)) == (MR_Integer) 1))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 71, &Verbose_62);
    Var_85 = mercury__string__f_43_43_2_f_0((MR_String) "been CREATED", (MR_String) ".\n");
    Var_87 = mercury__string__f_43_43_2_f_0((MR_String) "\' has ", Var_85);
    Var_88 = mercury__string__f_43_43_2_f_0(OutputFileName_9, Var_87);
    ChangedMsg_63 = mercury__string__f_43_43_2_f_0((MR_String) "% \140", Var_88);
    libs__file_util__maybe_write_string_5_p_0(ProgressStream_13, Verbose_62, ChangedMsg_63);
    parse_tree__module_cmds__copy_file_8_p_0(Globals_7, ProgressStream_13, ErrorStream_14, TmpOutputFileName_15, OutputFileName_9, &MoveRes_64);
    if ((MoveRes_64 == (MR_Word) ((MR_Unsigned) 0U)))
      *Result_10 = (MR_Integer) 0;
    else
    {
      MR_Word MoveError_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoveRes_64, (MR_Integer) 0))));
      MR_String Var_82;

      *Result_10 = (MR_Integer) 2;
      Var_82 = mercury__io__error_message_1_f_0(MoveError_65);
      ...
      mercury__io__write_string_4_p_0(ErrorStream_14, Var_82);
      mercury__io__write_string_4_p_0(ErrorStream_14, (MR_String) "\n");
    }
    mercury__io__file__remove_file_4_p_0(TmpOutputFileName_15, &Var_66);
  }
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        *Result_10 = (MR_Integer) 1;
        Var_53 = mercury__string__f_43_43_2_f_0(OutputFileName_9, (MR_String) "\' has not changed.\n");
        NoChangeMsg_20 = mercury__string__f_43_43_2_f_0((MR_String) "% \140", Var_53);
  ...
  MR_Word * Succeeded_18)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_143 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CmdResult_26, (MR_Integer) 0))));
