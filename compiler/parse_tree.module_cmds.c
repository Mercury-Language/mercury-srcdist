  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[4])), MainModuleName_8, &FileName_12);
  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[3])), MainModuleName_8, &FileName_12);
  libs__globals__get_progress_output_stream_5_p_0(Globals_7, MainModuleName_8, &ProgressStream_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 72, &Verbose_14);
  ...
  MR_Word * ListClassFiles_10)
{
  ...
  mercury__dir__general_foldl2_8_p_0((MR_Word) (&parse_tree__module_cmds_scalar_common_1[0]), (MR_Word) (&parse_tree__module_cmds_scalar_common_1[1]), Var_34, SearchDir_15, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_NestedClassFiles_18, &Errors_19);
  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_java_shell_script\'/5", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[1])), MainModuleName_7, &JarFileName_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[3])), MainModuleName_7, &FileName_22);
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[3])), MainModuleName_7, &FileName_57);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_16)) == (MR_Integer) 1))
  {
    ...
    Var_87 = mercury__string__f_43_43_2_f_0(OutputFileName_9, (MR_String) "\' has been CREATED.\n");
