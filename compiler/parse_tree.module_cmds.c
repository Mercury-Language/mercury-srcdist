  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 644, &UseSymLinks_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 138, &PrintCommand_15);
