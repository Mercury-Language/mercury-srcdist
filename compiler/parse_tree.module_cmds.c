  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 491, &MaybeStdLibDir_5);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &SourceDebug_8);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 619, &UseSymLinks_14);
  ...
  MR_Word * Result_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 619, &UseSymLinks_12);
