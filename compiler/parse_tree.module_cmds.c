...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__480__1_1_f_0(
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 571, &UserClasspath_13);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 572, &RuntimeFlags_16);
  RuntimeOpts_17 = mercury__string__join_list_2_f_0((MR_String) " ", RuntimeFlags_16);
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 568, &Java_18);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_37 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__480__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 572, &RuntimeFlags_18);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 568, &Java_21);
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 571, &UserClasspath_15);
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 288, &SourceDebug_8);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 674, &UseSymLinks_14);
