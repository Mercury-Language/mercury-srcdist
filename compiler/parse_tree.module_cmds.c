  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", (MR_Word) (MR_mkword(2, &parse_tree__module_cmds_scalar_common_2[2])), MainModuleName_8, &FileName_12);
