...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 668, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[3])), Globals_7, &NoSubdirsGlobals_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 61, &Verbose_14);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 61, &Verbose_32);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 61, &Verbose_72);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 555, &BeamExt_10);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 574, &MaybeStdLibDir_15);
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 568, &MercuryLibDirs0_20);
    {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 566, &LinkLibrariesList0_23);
    {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 551, &Erlang_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 667, &UseSubdirs_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 668, &UseGradeSubdirs_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 667, &UseSubdirs_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 668, &UseGradeSubdirs_13);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 61, &Verbose_41);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 544, &UserClasspath_13);
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 541, &Java_18);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 541, &Java_16);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 544, &UserClasspath_15);
...
{
  {
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 574, &MaybeStdlibDir_5);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 257, &SourceDebug_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 653, &UseSymLinks_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 653, &UseSymLinks_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 67, &PrintCommand_13);
    switch (UseSymLinks_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 61, &Verbose_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 61, &Verbose_17);
    switch (Verbosity_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 67, &PrintCommand_18);
        }
        break;
    }
