  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_java_shell_script\'/5", (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[1])), MainModuleName_7, &JarFileName_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[3])), MainModuleName_7, &FileName_23);
        libs__globals__get_progress_output_stream_5_p_0(Globals_6, MainModuleName_7, &ProgressStream_24);
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 72, &Verbose_25);
        Var_41 = mercury__string__f_43_43_2_f_0(FileName_23, (MR_String) "\'...\n");
        Var_38 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_41);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_24, Verbose_25, Var_38);
        mercury__io__file__remove_file_4_p_0(FileName_23, &Var_26);
        mercury__io__open_output_4_p_0(FileName_23, &OpenResult_27);
        if (((MR_tag((MR_Word) OpenResult_27)) == (MR_Integer) 1))
        {
          MR_String Var_56;
          MR_Word Message_57 = ((MR_Word) ((MR_hl_field(1, OpenResult_27, (MR_Integer) 0))));

          Var_56 = mercury__io__error_message_1_f_0(Message_57);
          {
        ...
        else
        {
          ...
          parse_tree__module_cmds__write_java_shell_script_6_p_0(Globals_6, MainModuleName_7, JarFileName_10, Stream_28);
          mercury__io__close_output_3_p_0(Stream_28);
          Var_47 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_23);
          mercury__io__call_system__call_system_4_p_0(Var_47, &ChmodResult_29);
          if (((MR_tag((MR_Word) ChmodResult_29)) == (MR_Integer) 1))
          {
            MR_Word Message_31 = ((MR_Word) ((MR_hl_field(1, ChmodResult_29, (MR_Integer) 0))));
            MR_String Var_54;

            Var_54 = mercury__io__error_message_1_f_0(Message_31);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_54);
              return;
            }
          }
          else
          {
            ...
            if (succeeded)
            {
              *Succeeded_8 = (MR_Integer) 1;
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_24, Verbose_25, (MR_String) "% done.\n");
            }
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_String) "chmod exit status != 0");
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Verbose_60;
        MR_Word OpenResult_62;
        MR_String Var_73;
        MR_String Var_76;
        MR_Word Var_61;

        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[3])), MainModuleName_7, &FileName_58);
        libs__globals__get_progress_output_stream_5_p_0(Globals_6, MainModuleName_7, &ProgressStream_59);
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 72, &Verbose_60);
        Var_76 = mercury__string__f_43_43_2_f_0(FileName_58, (MR_String) "\'...\n");
        Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_76);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_59, Verbose_60, Var_73);
        mercury__io__file__remove_file_4_p_0(FileName_58, &Var_61);
        mercury__io__open_output_4_p_0(FileName_58, &OpenResult_62);
        if (((MR_tag((MR_Word) OpenResult_62)) == (MR_Integer) 1))
        {
          MR_String Var_91;
          MR_Word Message_92 = ((MR_Word) ((MR_hl_field(1, OpenResult_62, (MR_Integer) 0))));

          Var_91 = mercury__io__error_message_1_f_0(Message_92);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_91);
            return;
          }
        }
        else
        {
          MR_Word Stream_63 = ((MR_Word) ((MR_hl_field(0, OpenResult_62, (MR_Integer) 0))));
          MR_Word ChmodResult_64;
          MR_String Var_82;

          parse_tree__module_cmds__write_java_msys_shell_script_6_p_0(Globals_6, MainModuleName_7, JarFileName_10, Stream_63);
          mercury__io__close_output_3_p_0(Stream_63);
          Var_82 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_58);
          mercury__io__call_system__call_system_4_p_0(Var_82, &ChmodResult_64);
          if (((MR_tag((MR_Word) ChmodResult_64)) == (MR_Integer) 1))
          {
            MR_Word Message_66 = ((MR_Word) ((MR_hl_field(1, ChmodResult_64, (MR_Integer) 0))));
            MR_String Var_89;

            Var_89 = mercury__io__error_message_1_f_0(Message_66);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_89);
              return;
            }
          }
          else
          {
            MR_Integer Status_65 = ((MR_Integer) ((MR_hl_field(0, ChmodResult_64, (MR_Integer) 0))));

            succeeded = (Status_65 == (MR_Integer) 0);
            if (succeeded)
            {
              *Succeeded_8 = (MR_Integer) 1;
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_59, Verbose_60, (MR_String) "% done.\n");
            }
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_String) "chmod exit status != 0");
