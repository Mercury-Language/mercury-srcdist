...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 557, &UserClasspath_13);
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 554, &Java_18);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 554, &Java_16);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 557, &UserClasspath_15);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 272, &SourceDebug_8);
