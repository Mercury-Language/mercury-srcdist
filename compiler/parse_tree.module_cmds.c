...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__520__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_37 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__520__1_1_f_0(((MR_String) (wrapper_arg_1)));
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__system_cmds__invoke_system_command_8_p_0(Globals_8, ProgressStream_9, ProgressStream_9, (MR_Integer) 0, Command_70, Succeeded_12);
        switch (*Succeeded_12) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__copy_util__copy_file_7_p_0(Globals_8, ProgressStream_9, SourceFileName_10, DestinationFileName_11, &Result_17);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_14)) == (MR_Integer) 1))
  {
    ...
    libs__copy_util__copy_file_7_p_0(Globals_8, ProgressStream_7, TmpOutputFileName_13, OutputFileName_9, &MoveRes_59);
  ...
  MR_Word * Result_14)
{
  ...
  libs__copy_util__copy_file_7_p_0(Globals_9, ProgressStream_10, TmpOutputFileName_13, OutputFileName_12, &MoveRes_18);
