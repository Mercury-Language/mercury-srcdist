...
parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__959__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_34 = parse_tree__module_cmds__IntroducedFrom__func__write_java_msys_shell_script__959__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 559, &Java_16);
  ...
  MR_Word * Res_14)
{
  ...
  switch (Succeeded_17) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word SourceRes_42;

        mercury__io__open_binary_input_4_p_0(Source_12, &SourceRes_42);
        if (((MR_tag((MR_Word) SourceRes_42)) == (MR_Integer) 1))
        {
          MR_Word Error_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SourceRes_42, (MR_Integer) 0))));
        ...
        {
          MR_Word SourceStream_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SourceRes_42, (MR_Integer) 0))));
          MR_Word DestRes_44;

          mercury__io__open_binary_output_4_p_0(Destination_13, &DestRes_44);
          if (((MR_tag((MR_Word) DestRes_44)) == (MR_Integer) 1))
          {
            MR_Word Error_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DestRes_44, (MR_Integer) 0))));
          ...
          {
            MR_Word DestStream_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DestRes_44, (MR_Integer) 0))));
            MR_Word ShouldReduce_59;
...
#define MR_PROC_LABEL parse_tree__module_cmds__copy_file_8_p_0
    ...
    ShouldReduce = MR_NO;
		...
		;}
#undef MR_PROC_LABEL
	ShouldReduce_59  = ShouldReduce;
}
            switch (ShouldReduce_59) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                parse_tree__module_cmds__copy_bytes_plain_5_p_0(SourceStream_43, DestStream_45, Res_14);
                break;
              case (MR_Integer) 1:
                parse_tree__module_cmds__copy_bytes_chunk_5_p_0(SourceStream_43, DestStream_45, Res_14);
                break;
            }
            mercury__io__close_binary_input_3_p_0(SourceStream_43);
            mercury__io__close_binary_output_3_p_0(DestStream_45);
          }
        }
      }
      break;
