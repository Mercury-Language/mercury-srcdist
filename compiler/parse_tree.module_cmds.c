...
{
  {
    ...
    {
      libs__globals__set_option_4_p_0((MR_Integer) 635, (MR_Word) MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_3[1]), parse_tree__module_cmds__Globals_7, &parse_tree__module_cmds__NoSubdirsGlobals_13);
    }
    {
