    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 476, &UserClasspath_31);
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 477, &RuntimeFlags_34);
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 473, &Java_37);
  ...
  MR_String * ContentStr_8)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 476, &UserClasspath_10);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 477, &RuntimeFlags_13);
  RuntimeOpts_14 = mercury__string__join_list_2_f_0((MR_String) " ", RuntimeFlags_13);
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 473, &Java_15);
  ...
  MR_String * ContentStr_8)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 477, &RuntimeFlags_15);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 473, &Java_18);
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 492, &MaybeStdLibDir_5);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 495, &SourceDebug_8);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 620, &UseSymLinks_14);
  ...
  MR_Word * Result_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 620, &UseSymLinks_12);
