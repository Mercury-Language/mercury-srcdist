    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 70, &Verbose_44);
        ...
        mercury__io__file__remove_file_4_p_0(FileName_42, &Var_45);
        ...
        else
        {
          ...
          mercury__io__call_system__call_system_4_p_0(Var_70, &ChmodResult_48);
  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 662, &UseSymLinks_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 76, &PrintCommand_17);
  switch (UseSymLinks_16) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * Succeeded_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 70, &Verbose_21);
  switch (Verbosity_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 76, &PrintCommand_22);
      break;
  }
