  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_2[4])), (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[4])), MainModuleName_8, &FileName_12);
  ...
  Var_31 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating batch file \140", Var_34);
  ...
  if (((MR_tag((MR_Word) OpenResult_16)) == (MR_Integer) 1))
  {
    ...
    Var_41 = mercury__io__error_message_1_f_0(Message_18);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", Var_41);
      return;
    }
  }
  else
  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_7, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_2[3])), (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[3])), MainModuleName_8, &FileName_12);
  libs__globals__get_progress_output_stream_5_p_0(Globals_7, MainModuleName_8, &ProgressStream_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 72, &Verbose_14);
  Var_36 = mercury__string__f_43_43_2_f_0(FileName_12, (MR_String) "\'...\n");
  Var_33 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_36);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_13, Verbose_14, Var_33);
  mercury__io__file__remove_file_4_p_0(FileName_12, &Var_15);
  mercury__io__open_output_4_p_0(FileName_12, &OpenResult_16);
  if (((MR_tag((MR_Word) OpenResult_16)) == (MR_Integer) 1))
  {
    MR_String Var_52;
    MR_Word Message_53 = ((MR_Word) ((MR_hl_field(1, OpenResult_16, (MR_Integer) 0))));

    Var_52 = mercury__io__error_message_1_f_0(Message_53);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_52);
      return;
    }
  }
  else
  {
    ...
    if (((MR_tag((MR_Word) ChmodResult_18)) == (MR_Integer) 1))
    {
      ...
      Var_50 = mercury__io__error_message_1_f_0(Message_20);
      {
  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_java_shell_script\'/5", (MR_Integer) 1, (MR_Word) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_2[1])), (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[1])), MainModuleName_7, &JarFileName_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_2[3])), (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[3])), MainModuleName_7, &FileName_27);
        libs__globals__get_progress_output_stream_5_p_0(Globals_6, MainModuleName_7, &ProgressStream_28);
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 72, &Verbose_29);
        Var_49 = mercury__string__f_43_43_2_f_0(FileName_27, (MR_String) "\'...\n");
        Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating shell script \140", Var_49);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_28, Verbose_29, Var_46);
        mercury__io__file__remove_file_4_p_0(FileName_27, &Var_30);
        mercury__io__open_output_4_p_0(FileName_27, &OpenResult_31);
        if (((MR_tag((MR_Word) OpenResult_31)) == (MR_Integer) 1))
        {
          MR_String Var_64;
          MR_Word Message_65 = ((MR_Word) ((MR_hl_field(1, OpenResult_31, (MR_Integer) 0))));

          Var_64 = mercury__io__error_message_1_f_0(Message_65);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_64);
            return;
          }
        }
        else
        {
          MR_Word Stream_32 = ((MR_Word) ((MR_hl_field(0, OpenResult_31, (MR_Integer) 0))));
          MR_Word ChmodResult_33;
          MR_String Var_55;

          parse_tree__module_cmds__write_java_shell_script_6_p_0(Globals_6, MainModuleName_7, JarFileName_10, Stream_32);
          mercury__io__close_output_3_p_0(Stream_32);
          Var_55 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_27);
          mercury__io__call_system__call_system_4_p_0(Var_55, &ChmodResult_33);
          if (((MR_tag((MR_Word) ChmodResult_33)) == (MR_Integer) 1))
          {
            MR_Word Message_35 = ((MR_Word) ((MR_hl_field(1, ChmodResult_33, (MR_Integer) 0))));
            MR_String Var_62;

            Var_62 = mercury__io__error_message_1_f_0(Message_35);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", Var_62);
              return;
            }
          }
          else
          {
            MR_Integer Status_34 = ((MR_Integer) ((MR_hl_field(0, ChmodResult_33, (MR_Integer) 0))));

            succeeded = (Status_34 == (MR_Integer) 0);
            if (succeeded)
            {
              *Succeeded_8 = (MR_Integer) 1;
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_28, Verbose_29, (MR_String) "% done.\n");
            }
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_String) "chmod exit status != 0");
    ...
    case (MR_Integer) 3:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &parse_tree__module_cmds_scalar_common_2[4])), (MR_Word) (MR_mkword(3, &parse_tree__module_cmds_scalar_common_1[4])), MainModuleName_7, &FileName_66);
        libs__globals__get_progress_output_stream_5_p_0(Globals_6, MainModuleName_7, &ProgressStream_67);
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 72, &Verbose_68);
        Var_86 = mercury__string__f_43_43_2_f_0(FileName_66, (MR_String) "\'...\n");
        Var_83 = mercury__string__f_43_43_2_f_0((MR_String) "% Generating batch file \140", Var_86);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_67, Verbose_68, Var_83);
        mercury__io__file__remove_file_4_p_0(FileName_66, &Var_69);
        mercury__io__open_output_4_p_0(FileName_66, &OpenResult_70);
        if (((MR_tag((MR_Word) OpenResult_70)) == (MR_Integer) 1))
        {
          MR_Word Message_72 = ((MR_Word) ((MR_hl_field(1, OpenResult_70, (MR_Integer) 0))));
          MR_String Var_92;

          Var_92 = mercury__io__error_message_1_f_0(Message_72);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.module_cmds.create_launcher_batch_file\'/6", Var_92);
            return;
          }
        }
        else
        {
          ...
          parse_tree__module_cmds__write_java_batch_file_6_p_0(Globals_6, MainModuleName_7, JarFileName_10, Stream_71);
          mercury__io__close_output_3_p_0(Stream_71);
          *Succeeded_8 = (MR_Integer) 1;
        }
      }
      break;
  ...
  MR_Word * Succeeded_10)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__write_java_msys_shell_script_6_p_0(Var_54, Var_55, Var_56, Stream_17);
    mercury__io__close_output_3_p_0(Stream_17);
    Var_42 = mercury__string__f_43_43_2_f_0((MR_String) "chmod a+x ", FileName_12);
    mercury__io__call_system__call_system_4_p_0(Var_42, &ChmodResult_18);
    if (((MR_tag((MR_Word) ChmodResult_18)) == (MR_Integer) 1))
...
void MR_CALL 
parse_tree__module_cmds__touch_interface_datestamp_9_p_0(
  MR_Word Globals_10,
  MR_Word ProgressStream_11,
  MR_Word ErrorStream_12,
  ...
  MR_Word * Succeeded_16)
{
...

  {
    ...
    MR_hl_field(1, Var_23, 0) = ((MR_Box) (OtherExt_14));
  }
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140parse_tree.module_cmds.touch_interface_datestamp\'/9", (MR_Integer) 0, Var_23, NewExt_15, ModuleName_13, &OutputFileName_18);
  parse_tree__module_cmds__touch_datestamp_7_p_0(Globals_10, ProgressStream_11, ErrorStream_12, OutputFileName_18, Succeeded_16);
}
