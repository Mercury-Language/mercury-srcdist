...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 68, &Verbose_14);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 68, &Verbose_44);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 275, &SourceDebug_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 670, &UseSymLinks_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 74, &PrintCommand_17);
    switch (UseSymLinks_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 68, &Verbose_21);
    switch (Verbosity_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 74, &PrintCommand_22);
        break;
    }
