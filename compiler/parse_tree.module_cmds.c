    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_2[3])), MainModuleName_7, &FileName_25);
        ...
        {
          MR_String Var_60;
          MR_Word Message_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_29, (MR_Integer) 0))));
        ...
        {
          MR_Word Stream_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_29, (MR_Integer) 0))));
          ...
          {
            MR_Word Message_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ChmodResult_31, (MR_Integer) 0))));
            MR_String Var_58;
          ...
          {
            MR_Integer Status_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ChmodResult_31, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.module_cmds.create_launcher_shell_script\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_2[3])), MainModuleName_7, &FileName_62);
        ...
        {
          MR_String Var_97;
          MR_Word Message_98 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_66, (MR_Integer) 0))));
        ...
        {
          MR_Word Stream_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_66, (MR_Integer) 0))));
          ...
          {
            MR_Word Message_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ChmodResult_68, (MR_Integer) 0))));
            MR_String Var_95;
          ...
          {
            MR_Integer Status_69 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ChmodResult_68, (MR_Integer) 0))));
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) OutputFileRes_16)) == (MR_Integer) 1))
  {
    ...
    {
      MR_Word MoveError_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoveRes_63, (MR_Integer) 0))));
      MR_String Var_81;
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          MR_Word Error_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SourceRes_24, (MR_Integer) 0))));
        ...
        {
          MR_Word SourceStream_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SourceRes_24, (MR_Integer) 0))));
          MR_Word DestRes_26;

          mercury__io__open_binary_output_4_p_0(Destination_13, &DestRes_26);
          if (((MR_tag((MR_Word) DestRes_26)) == (MR_Integer) 1))
          {
            MR_Word Error_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DestRes_26, (MR_Integer) 0))));
          ...
          {
            MR_Word DestStream_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DestRes_26, (MR_Integer) 0))));
