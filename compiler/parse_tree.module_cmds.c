...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 674, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__module_cmds_scalar_common_4[3])), Globals_7, &NoSubdirsGlobals_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 63, &Verbose_14);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 63, &Verbose_32);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 63, &Verbose_72);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 560, &BeamExt_10);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 579, &MaybeStdLibDir_15);
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 573, &MercuryLibDirs0_20);
    {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 571, &LinkLibrariesList0_23);
    {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 556, &Erlang_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 673, &UseSubdirs_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 674, &UseGradeSubdirs_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 673, &UseSubdirs_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 674, &UseGradeSubdirs_13);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 63, &Verbose_41);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 549, &UserClasspath_13);
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 546, &Java_18);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 546, &Java_16);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 549, &UserClasspath_15);
...
{
  {
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 579, &MaybeStdlibDir_5);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 259, &SourceDebug_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 659, &UseSymLinks_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 659, &UseSymLinks_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 69, &PrintCommand_13);
    switch (UseSymLinks_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 63, &Verbose_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 63, &Verbose_17);
    switch (Verbosity_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 69, &PrintCommand_18);
        break;
    }
