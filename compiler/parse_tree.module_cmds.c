  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 579, &UserClasspath_13);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 580, &RuntimeFlags_16);
  RuntimeOpts_17 = mercury__string__join_list_2_f_0((MR_String) " ", RuntimeFlags_16);
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 576, &Java_18);
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 580, &RuntimeFlags_18);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 576, &Java_21);
  ...
  MR_Word Stream_10)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 579, &UserClasspath_15);
  ...
  MR_Word * STATE_VARIABLE_StdLibs_9)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_3, (MR_Integer) 602, &MaybeStdlibDir_5);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 296, &SourceDebug_8);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 682, &UseSymLinks_14);
  ...
  MR_Word * Result_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 682, &UseSymLinks_12);
