            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  Var_47 = (MR_Integer) 0;
                  succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstB_10, &Var_165, STATE_VARIABLE_Info_0_43, &STATE_VARIABLE_Info_44);
                  if (succeeded)
                  {
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    Var_58 = (MR_Integer) 0;
                    succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstA_9, &Var_166, STATE_VARIABLE_Info_0_43, &STATE_VARIABLE_Info_44);
                    if (succeeded)
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  succeeded = check_hlds__inst_match__ho_inst_info_matches_initial_6_p_1(CalcSub_7, Type_8, HOInstInfoA_97, HOInstInfoB_81, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                      succeeded = check_hlds__inst_match__ground_matches_initial_bound_functor_list_6_p_1(CalcSub_7, UniqA_96, Type_8, BoundFunctorsB_85, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                  }
                }
              }
              break;
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                      succeeded = check_hlds__inst_match__ho_inst_info_matches_initial_6_p_1(CalcSub_7, Type_8, HOInstInfoA_97, HOInstInfoB_87, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                  }
                  break;
              }
              break;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_53 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_1(CalcSub_7, Type_8, InstA_9, &Var_179, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                        if (succeeded)
            ...
            case (MR_Integer) 2:
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                    succeeded = check_hlds__inst_match__bound_functor_list_matches_initial_mt_6_p_1(CalcSub_7, Type_8, BoundFunctorsA_26, BoundFunctorsB_28, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                }
              }
              break;
            case (MR_Integer) 3:
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        {
                          Var_61 = (MR_Integer) 0;
                          succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_1(CalcSub_7, Type_8, InstA_9, &Var_180, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                          if (succeeded)
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                            succeeded = check_hlds__inst_match__ho_inst_info_matches_initial_6_p_1(CalcSub_7, Type_8, HOInstInfoA_13, HOInstInfoB_21, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                        }
                      }
                      break;
                  }
            ...
            case (MR_Integer) 1:
              {
                ...
                succeeded = check_hlds__inst_match__ho_inst_info_matches_final_6_p_1(CalcSub_7, Type_8, HOInstInfoA_23, HOInstInfoB_25, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                if (succeeded)
            ...
            case (MR_Integer) 2:
              {
                ...
                succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_1_5_p_1(CalcSub_7, Type_8, HOInstInfoA_23, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_2_56);
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_57 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_1(CalcSub_7, Type_8, InstB_10, &Var_144, STATE_VARIABLE_Info_2_56, &STATE_VARIABLE_Info_54);
                        if (succeeded)
                        {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    succeeded = check_hlds__inst_match__ho_inst_info_matches_final_6_p_1(CalcSub_7, Type_8, HOInstInfoA_23, HOInstInfoB_81, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                    if (succeeded)
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_64 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_1(CalcSub_7, Type_8, InstA_9, &Var_145, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                        if (succeeded)
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                  succeeded = check_hlds__inst_match__bound_functor_list_matches_final_6_p_1(CalcSub_7, Type_8, BoundFunctorsA_34, BoundFunctorsB_84, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, InstB_10, 0))))) {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            Var_70 = (MR_Integer) 0;
                            succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_1(CalcSub_7, Type_8, InstA_9, &Var_146, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                            if (succeeded)
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        succeeded = check_hlds__inst_match__ho_inst_info_matches_final_6_p_1(CalcSub_7, Type_8, HOInstInfoA_101, HOInstInfoB_95, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                        if (succeeded)
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_53 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstA_9, &Var_179, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                        if (succeeded)
                          succeeded = (Var_53 == Var_179);
                      }
                    }
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        {
                          Var_61 = (MR_Integer) 0;
                          succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstA_9, &Var_180, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_40);
                          if (succeeded)
                            succeeded = (Var_61 == Var_180);
                        }
                      }
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_57 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstB_10, &Var_144, STATE_VARIABLE_Info_2_56, &STATE_VARIABLE_Info_54);
                        if (succeeded)
                        {
                          succeeded = (Var_57 == Var_144);
                          if (succeeded)
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_64 = (MR_Integer) 0;
                        succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstA_9, &Var_145, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                        if (succeeded)
                          succeeded = (Var_64 == Var_145);
                      }
                    }
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            Var_70 = (MR_Integer) 0;
                            succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_1_6_p_0(CalcSub_7, Type_8, InstA_9, &Var_146, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
                            if (succeeded)
                              succeeded = (Var_70 == Var_146);
                          }
                        }
