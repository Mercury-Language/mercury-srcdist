            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word BoundInstsB_17 = ((MR_Word) ((MR_hl_field(2, InstB_10, (MR_Integer) 2))));
                ...
                succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_46, Type_8, InstResultsB_16, BoundInstsB_17);
                if (succeeded)
                {
                  Var_47 = (MR_Integer) 0;
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = check_hlds__inst_match__bound_inst_list_is_complete_for_type_4_p_0(Var_49, Var_50, Type_8, BoundInstsB_17);
                  }
                }
              }
              break;
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word BoundInstsA_24 = ((MR_Word) ((MR_hl_field(2, InstA_9, (MR_Integer) 2))));
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_57, Type_8, InstResultsA_23, BoundInstsA_24);
                  if (succeeded)
                  {
                    Var_58 = (MR_Integer) 0;
            ...
            case (MR_Integer) 2:
              {
                ...
                succeeded = check_hlds__inst_match__bound_inst_list_matches_binding_6_p_0(CalcSub_7, Type_8, BoundInstsA_24, BoundInstsB_77, STATE_VARIABLE_Info_0_43, &STATE_VARIABLE_Info_44);
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, InstB_10, (MR_Integer) 0))))) {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = check_hlds__inst_match__inst_matches_binding_2_6_p_0(CalcSub_1, Type_12, ExpandedInstA_25, ExpandedInstB_26, STATE_VARIABLE_Info_19_27, &STATE_VARIABLE_Info_21_21);
          }
          else
          {
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_50, Type_8, InstResultsA_25, BoundInstsA_26);
                    if (succeeded)
                    {
                      ...
                      succeeded = check_hlds__inst_match__compare_bound_inst_list_uniq_4_p_0(Var_51, Var_130, BoundInstsA_26, UniqB_73);
                      if (succeeded)
                      {
                        Var_53 = (MR_Integer) 0;
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(ModuleInfo_28, Type_8, InstResultsB_26, BoundInstsB_27);
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_match__uniq_matches_bound_inst_list_3_p_0(ModuleInfo_28, UniqA_22, BoundInstsB_27);
                      if (succeeded)
                      {
                        Var_57 = (MR_Integer) 0;
                        ...
                        {
                          {
                            ...
                            succeeded = check_hlds__inst_match__bound_inst_list_is_complete_for_type_4_p_0(ModuleInfo_28, Var_59, Type_8, BoundInstsB_27);
                          }
                          if (!(succeeded))
                          {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word BoundInstsA_34 = ((MR_Word) ((MR_hl_field(2, InstA_9, (MR_Integer) 2))));
          ...
          switch (MR_tag((MR_Word) InstB_10)) {
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_62, Type_8, InstResultsA_33, BoundInstsA_34);
                    if (succeeded)
                    {
                      Var_63 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_53, (MR_Integer) 0))));
                      succeeded = check_hlds__inst_match__bound_inst_list_matches_uniq_3_p_0(Var_63, UniqB_82, BoundInstsA_34);
                      if (succeeded)
                      {
                        Var_64 = (MR_Integer) 0;
            ...
            case (MR_Integer) 2:
              {
                MR_Word UniqB_83 = ((MR_Unsigned) ((MR_hl_field(2, InstB_10, (MR_Integer) 0))) & (MR_Integer) 7);
                MR_Word BoundInstsB_84 = ((MR_Word) ((MR_hl_field(2, InstB_10, (MR_Integer) 2))));

                succeeded = check_hlds__inst_match__unique_matches_final_2_p_0(UniqA_90, UniqB_83);
                if (succeeded)
                  succeeded = check_hlds__inst_match__bound_inst_list_matches_final_6_p_0(CalcSub_7, Type_8, BoundInstsA_34, BoundInstsB_84, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_54);
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, InstB_10, (MR_Integer) 0))))) {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = check_hlds__inst_match__bound_inst_list_matches_uniq_3_p_0(Var_68, UniqB_85, BoundInstsA_34);
                        if (succeeded)
                        {
                          Var_69 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_53, (MR_Integer) 0))));
                          succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_or_any_3_p_0(Var_69, InstResultsA_33, BoundInstsA_34);
                          if (succeeded)
                          {
                            Var_70 = (MR_Integer) 0;
