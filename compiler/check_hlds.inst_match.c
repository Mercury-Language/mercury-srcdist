...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = check_hlds__inst_merge__inst_merge_6_p_0(InstA_6, InstB_11, MaybeType_7, &Inst_13, ModuleInfo0_12, &ModuleInfo_14);
        if (succeeded)
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__inst_lookup__inst_expand_and_remove_constrained_inst_vars_3_p_0(Var_46, InstA_7, &ExpandedInstA_34);
      Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_17_36, (MR_Integer) 0))));
      check_hlds__inst_lookup__inst_expand_and_remove_constrained_inst_vars_3_p_0(Var_38, InstB_8, &ExpandedInstB_35);
