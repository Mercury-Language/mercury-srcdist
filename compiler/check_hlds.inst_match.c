                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        Var_51 = (MR_Integer) 0;
                        check_hlds__inst_match__inst_contains_nondefault_func_mode_1_4_p_0(InstA_7, &Var_181, STATE_VARIABLE_Info_0_29, &STATE_VARIABLE_Info_30);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        {
                          Var_42 = (MR_Integer) 0;
                          check_hlds__inst_match__inst_contains_nondefault_func_mode_1_4_p_0(InstA_7, &Var_180, STATE_VARIABLE_Info_0_29, &STATE_VARIABLE_Info_30);
