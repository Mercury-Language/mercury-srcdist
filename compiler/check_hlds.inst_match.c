    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          succeeded = ((((MR_tag((MR_Word) ConsIdX_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsIdX_17, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
            QNameA_36 = ((MR_Word) ((MR_hl_field(3, ConsIdX_17, (MR_Integer) 1))));
            ArityA_37 = ((MR_Integer) ((MR_hl_field(3, ConsIdX_17, (MR_Integer) 2))));
            succeeded = ((((MR_tag((MR_Word) ConsIdY_19)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsIdY_19, (MR_Integer) 0)))) == (MR_Integer) 3)));
            if (succeeded)
            {
