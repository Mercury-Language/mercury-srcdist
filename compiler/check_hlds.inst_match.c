      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = check_hlds__inst_match__pred_inst_matches_2_5_p_0(Var_5, PredInst_29, DefaultFunc_41, Info_9, &Var_10);
        }
        break;
      case (MR_Integer) 0:
        succeeded = MR_TRUE;
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            Var_58 = mercury__set__init_0_f_0(TypeCtorInfo_160_160);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_60 = mercury__list__length_1_f_0(TypeCtorInfo_161_161, ArgsA_32);
                  ...
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_162_162, Var_60, ((MR_Box) (Var_61)), &Types_34);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Expansions0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_4, (MR_Integer) 1))));
          {
            ...
            MR_hl_field(MR_mktag(0), ThisExpansion_26, 0) = ((MR_Box) (ArgA_11));
            MR_hl_field(MR_mktag(0), ThisExpansion_26, 1) = ((MR_Box) (ArgB_13));
            MR_hl_field(MR_mktag(0), ThisExpansion_26, 2) = ((MR_Box) (Type_9));
          }
          ...
          if (succeeded)
          {
            ...
            check_hlds__inst_lookup__inst_expand_and_remove_constrained_inst_vars_3_p_0(Var_41, ArgA_11, &ExpandedInstA_29);
            Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_17_31, (MR_Integer) 0))));
            check_hlds__inst_lookup__inst_expand_and_remove_constrained_inst_vars_3_p_0(Var_33, ArgB_13, &ExpandedInstB_30);
            succeeded = check_hlds__inst_match__inst_matches_binding_3_5_p_0(Type_9, ExpandedInstA_29, ExpandedInstB_30, STATE_VARIABLE_Info_17_31, &STATE_VARIABLE_Info_18_18);
          }
          else
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = check_hlds__inst_match__pred_inst_matches_2_5_p_0(Type_6, PredInst_27, DefaultFunc_39, Info_7, &Var_8);
        }
        break;
      case (MR_Integer) 0:
        succeeded = MR_TRUE;
  ...
  MR_Word * STATE_VARIABLE_Sub_17)
{
  ...
  Var_58 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__inst_match__check_hlds__inst_match__type_ctor_info_inst_match_inputs_0));
  {
    ...
    MR_hl_field(MR_mktag(0), Info0_32, 1) = ((MR_Box) (Var_58));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = check_hlds__inst_match__compare_uniqueness_3_p_0(Var_44, Var_229, UniqB_78);
                      if (succeeded)
                      {
                        ...
                        succeeded = check_hlds__inst_match__compare_bound_inst_list_uniq_4_p_0(Var_45, Var_139, Var_227, UniqB_78);
                        if (succeeded)
                        {
                          Var_47 = (MR_Integer) 0;
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        else
                        {
                          ...
                          succeeded = check_hlds__inst_match__compare_uniqueness_3_p_0(Var_49, Var_229, UniqB_82);
                          if (succeeded)
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = check_hlds__inst_match__compare_uniqueness_3_p_0(Var_52, Var_229, UniqB_83);
                          if (succeeded)
                          {
                            Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_34, (MR_Integer) 0))));
                            succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_53, Type_6, Var_228, Var_227);
                            if (succeeded)
                            {
                              ...
                              succeeded = check_hlds__inst_match__compare_bound_inst_list_uniq_4_p_0(Var_54, Var_169, Var_227, UniqB_83);
                              if (succeeded)
                              {
                                Var_56 = (MR_Integer) 0;
                    ...
                    case (MR_Integer) 5:
                      {
                        ...
                        succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_4_p_0(Var_58, Type_6, Var_228, Var_227);
                        if (succeeded)
                        {
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            Var_66 = mercury__set__init_0_f_0(TypeCtorInfo_220_220);
                    ...
                    case (MR_Integer) 5:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          Var_74 = mercury__list__length_1_f_0(TypeCtorInfo_221_221, ArgsA_31);
                          ...
                          mercury__list__duplicate_3_p_0(TypeCtorInfo_222_222, Var_74, ((MR_Box) (Var_75)), &Types_33);
        ...
        if (succeeded)
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&check_hlds__inst_match_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (check_hlds__inst_match__handle_inst_var_subs_2__ho6_7_p_0_1));
              MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (UnifyInst_17));
              MR_hl_field(MR_mktag(0), Var_56, 4) = ((MR_Box) (Type_10));
            }
            succeeded = mercury__set__fold_4_p_3((MR_Word) (&check_hlds__inst_match_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_match__check_hlds__inst_match__type_ctor_info_inst_match_info_0), Var_56, InstVarsB_14, ((MR_Box) (STATE_VARIABLE_Info_27_27)), &conv1_STATE_VARIABLE_Info_28_28);
            if (succeeded)
            {
      ...
      if (succeeded)
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&check_hlds__inst_match_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (check_hlds__inst_match__handle_inst_var_subs_2__ho5_7_p_0_1));
            MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (UnifyInst_17));
            MR_hl_field(MR_mktag(0), Var_58, 4) = ((MR_Box) (Type_10));
          }
          succeeded = mercury__set__fold_4_p_3((MR_Word) (&check_hlds__inst_match_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_match__check_hlds__inst_match__type_ctor_info_inst_match_info_0), Var_58, InstVarsB_14, ((MR_Box) (STATE_VARIABLE_Info_27_27)), &conv1_STATE_VARIABLE_Info_28_28);
          if (succeeded)
          {
            STATE_VARIABLE_Info_28_28 = ((MR_Word) (conv1_STATE_VARIABLE_Info_28_28));
            succeeded = MR_TRUE;
  ...
  MR_Word * STATE_VARIABLE_Info_17)
{
  ...
  if ((HOInstInfoB_8 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    else
    {
      ...
      MR_Word PredOrFunc_72 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInst_65, (MR_Integer) 0))) & (MR_Integer) 1);
      MR_Word ArgModes_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredInst_65, (MR_Integer) 1))));

      switch (PredOrFunc_72) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          {
            MR_Integer Arity_76;
            MR_Word DefaultFunc_77;

            Arity_76 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes_73);
            DefaultFunc_77 = check_hlds__inst_util__pred_inst_info_default_func_mode_1_f_0(Arity_76);
            succeeded = check_hlds__inst_match__pred_inst_matches_2_5_p_0(Type_6, PredInst_65, DefaultFunc_77, STATE_VARIABLE_Info_0_16, STATE_VARIABLE_Info_17);
          }
          break;
        case (MR_Integer) 0:
          {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              {
                                Var_57 = (MR_Integer) 0;
                                check_hlds__inst_match__inst_contains_nondefault_func_mode_1_4_p_0(InstB_8, &Var_143, STATE_VARIABLE_Info_56_56, &STATE_VARIABLE_Info_38);
                                succeeded = (Var_57 == Var_143);
                                if (succeeded)
                                {
                                  {
                                    MR_Word Var_59;
          ...
          case (MR_Integer) 5:
            {
              ...
              if (((((MR_tag((MR_Word) InstB_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), InstB_8, (MR_Integer) 0)))) == (MR_Integer) 5))))
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_63 = mercury__list__length_1_f_0(TypeCtorInfo_138_138, ArgsA_30);
                  ...
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_139_139, Var_63, ((MR_Box) (Var_64)), &Types_32);
        ...
        if (succeeded)
        {
          ...
          else
          {
...

            {
              Var_56 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&check_hlds__inst_match_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (check_hlds__inst_match__handle_inst_var_subs_2__ho8_7_p_0_1));
              MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (UnifyInst_17));
              MR_hl_field(MR_mktag(0), Var_56, 4) = ((MR_Box) (Type_10));
            }
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = check_hlds__inst_match__pred_inst_matches_2_5_p_0(Type_5, PredInst_8, DefaultFunc_22, STATE_VARIABLE_Info_0_9, STATE_VARIABLE_Info_10);
        }
        break;
      case (MR_Integer) 0:
        {
      ...
      if (succeeded)
      {
        ...
        else
        {
...

          {
            Var_58 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&check_hlds__inst_match_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (check_hlds__inst_match__handle_inst_var_subs_2__ho7_7_p_0_1));
            MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (UnifyInst_17));
            MR_hl_field(MR_mktag(0), Var_58, 4) = ((MR_Box) (Type_10));
          }
