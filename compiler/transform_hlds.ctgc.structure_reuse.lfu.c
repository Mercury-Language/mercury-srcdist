...
MR_decl_label10(transform_hlds__ctgc__structure_reuse__lfu__forward_use_in_composite_goal_7_0, 20,19,24,23,28,27,31,2,34,35)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__lfu_module4)
	...
	MR_init_label10(transform_hlds__ctgc__structure_reuse__lfu__forward_use_in_composite_goal_7_0,20,19,24,23,28,27,31,2,34,35)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__lfu__forward_use_in_composite_goal_7_0,34)
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_lfu_3_0,
		transform_hlds__ctgc__structure_reuse__lfu__forward_use_in_composite_goal_7_0_i35);
MR_def_label(transform_hlds__ctgc__structure_reuse__lfu__forward_use_in_composite_goal_7_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
