    ...
    case (MR_Integer) 1:
      {
        ...
        Var_48 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_2_f_0(VarTable_8, PreBirths_42);
        Var_50 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_2_f_0(VarTable_8, PostBirths_43);
        {
