...
{
  {
    ...
    TypeInfo_31_31 = (MR_Word) &transform_hlds__ctgc__structure_reuse__lfu_scalar_common_1[1];
...
{
  {
    ...
    TypeInfo_29_29 = (MR_Word) &transform_hlds__ctgc__structure_reuse__lfu_scalar_common_1[1];
