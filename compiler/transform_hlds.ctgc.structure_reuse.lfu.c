...
{
  {
    ...
    hlds__hlds_goal__goal_info_set_reuse_3_p_0((MR_Word) ((MR_Integer) 0), GoalInfo1_19, &GoalInfo_20);
    {
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__hlds_goal__goal_info_set_reuse_3_p_0((MR_Word) ((MR_Integer) 0), GoalInfo1_22, &GoalInfo_23);
    {
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__hlds_goal__goal_info_set_reuse_3_p_0((MR_Word) ((MR_Integer) 0), GoalInfo1_18, &GoalInfo_19);
    {
...
{
  {
    ...
    hlds__hlds_goal__goal_info_set_reuse_3_p_0((MR_Word) ((MR_Integer) 0), GoalInfo1_12, &GoalInfo_13);
    {
      MR_Word base;
