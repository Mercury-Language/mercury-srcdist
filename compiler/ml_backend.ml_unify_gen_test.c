...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) TypeBody_32)) == (MR_Integer) 1);
      if (succeeded)
      {
        MaybeRepn_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeBody_32, (MR_Integer) 3))));
...
{
  {
    ...
    MR_Word CheapConsTag_44;
    MR_Word ExpensiveConsTag_42;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MaybeRepn_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeBody_24, (MR_Integer) 3))));
    ...
    if (succeeded)
    {
      ExpensiveConsTag_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_14, (MR_Integer) 1))));
      CheapConsTag_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_14, (MR_Integer) 3))));
      succeeded = hlds__hlds_data____Unify____cons_tag_0_0(ConsTag_13, ExpensiveConsTag_42);
    }
    if (succeeded)
    {
      MR_Word CheapConsTagTestRval_45;
      MR_Word IntType_46;
      MR_Word SubRvalA_47;
      MR_Word SubRvalB_48;
      MR_Word Var_49;

      ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(STATE_VARIABLE_Info_0_15, VarRval_11, VarType_12, CheapConsTag_44, &CheapConsTagTestRval_45);
      succeeded = ((((MR_tag((MR_Word) CheapConsTagTestRval_45)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_45, (MR_Integer) 0)))) == (MR_Integer) 6)));
      if (succeeded)
      {
        Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_45, (MR_Integer) 1))));
        SubRvalA_47 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_45, (MR_Integer) 2))));
        SubRvalB_48 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_45, (MR_Integer) 3))));
        succeeded = ((((MR_tag((MR_Word) Var_49)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_49, (MR_Integer) 0)))) == (MR_Integer) 8)));
        if (succeeded)
          IntType_46 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_49, (MR_Integer) 1))) & (MR_Integer) 15);
      }
      if (succeeded)
      {
        MR_Word Var_50;

        {
          ...
          MR_hl_field(MR_mktag(3), Var_50, 1) = (MR_Box) ((MR_Unsigned) (IntType_46));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          *TestRval_8 = base;
          ...
          MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRvalA_47));
          MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (SubRvalB_48));
        }
      }
      else
        {
          ...
          *TestRval_8 = base;
          MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (CheapConsTagTestRval_45));
        }
    }
    else
