  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_tagged_cons_id_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), &conv0_TestRval_12);
  ...
  MR_Word * STATE_VARIABLE_Info_21)
{
  ...
  VarType_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarEntry_13, (MR_Integer) 1))));
  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_20, Var_7, VarEntry_13, &VarLval_15);
  {
    VarRval_16 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), VarRval_16, 0) = ((MR_Box) (VarLval_15));
  }
  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_20, &ModuleInfo_32);
  parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_14, &TypeCtor_33);
  hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_32, &TypeTable_34);
  succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_34, TypeCtor_33, &TypeDefn_35);
  if (succeeded)
  {
    hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_35, &TypeBody_36);
    succeeded = ((MR_tag((MR_Word) TypeBody_36)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_43 = (MR_Word) ((MR_Word) (TypeBody_36));
      MaybeRepn_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 3))));
      succeeded = (MaybeRepn_40 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        Repn_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRepn_40, (MR_Integer) 0))));
    }
  }
  if (succeeded)
    CheaperTagTest_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_42, (MR_Integer) 2))));
  else
  ...
  ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_tagged_cons_id_6_p_0(STATE_VARIABLE_Info_0_20, VarRval_16, VarType_14, CheaperTagTest_17, MainTaggedConsId_8, &MainTestRval_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_test_scalar_common_2[0]));
    MR_hl_field(MR_mktag(0), Var_22, 1) = ((MR_Box) (ml_backend__ml_unify_gen_test__ml_generate_test_var_has_one_tagged_cons_id_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_22, 2) = ((MR_Box) ((MR_Integer) 4));
    MR_hl_field(MR_mktag(0), Var_22, 3) = ((MR_Box) (STATE_VARIABLE_Info_0_20));
    MR_hl_field(MR_mktag(0), Var_22, 4) = ((MR_Box) (VarRval_16));
    MR_hl_field(MR_mktag(0), Var_22, 5) = ((MR_Box) (VarType_14));
    MR_hl_field(MR_mktag(0), Var_22, 6) = ((MR_Box) (CheaperTagTest_17));
  }
  ...
  MR_Word * TestRval_12)
{
  ...
  MR_Word ConsTag_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedConsId_11, (MR_Integer) 1))));
  MR_Word CheapConsTag_24;
  MR_Word ExpensiveConsTag_22;

  if (succeeded)
  {
    ExpensiveConsTag_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_10, (MR_Integer) 1))));
    CheapConsTag_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_10, (MR_Integer) 3))));
    succeeded = hlds__hlds_data____Unify____cons_tag_0_0(ConsTag_14, ExpensiveConsTag_22);
  }
  if (succeeded)
  {
    MR_Word CheapConsTagTestRval_25;
    MR_Word IntType_26;
    MR_Word SubRvalA_27;
    MR_Word SubRvalB_28;
    MR_Word Var_29;

    ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(Info_7, Rval_8, Type_9, CheapConsTag_24, &CheapConsTagTestRval_25);
    succeeded = ((((MR_tag((MR_Word) CheapConsTagTestRval_25)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_25, (MR_Integer) 0)))) == (MR_Integer) 6)));
    if (succeeded)
    {
      Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_25, (MR_Integer) 1))));
      SubRvalA_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_25, (MR_Integer) 2))));
      SubRvalB_28 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_25, (MR_Integer) 3))));
      succeeded = ((((MR_tag((MR_Word) Var_29)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 0)))) == (MR_Integer) 8)));
      if (succeeded)
        IntType_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 1))) & (MR_Integer) 15);
    }
    if (succeeded)
    {
      MR_Word Var_30;

      {
        ...
        MR_hl_field(MR_mktag(3), Var_30, 1) = (MR_Box) ((MR_Unsigned) (IntType_26));
      }
      {
        MR_Word base;
    ...
    else
      {
        ...
        *TestRval_12 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (CheapConsTagTestRval_25));
      }
  }
  else
  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  MR_Word Var_35;
  MR_Word CheapConsTag_49;
  MR_Word ExpensiveConsTag_47;
  ...
  VarType_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarEntry_11, (MR_Integer) 1))));
  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_17, Var_6, VarEntry_11, &VarLval_13);
  {
    VarRval_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), VarRval_14, 0) = ((MR_Box) (VarLval_13));
  }
  ml_backend__ml_unify_gen_util__ml_cons_id_to_tag_3_p_0(STATE_VARIABLE_Info_0_17, ConsId_7, &ConsTag_15);
  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_17, &ModuleInfo_24);
  parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_12, &TypeCtor_25);
  hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_24, &TypeTable_26);
  succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_26, TypeCtor_25, &TypeDefn_27);
  if (succeeded)
  {
    hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_27, &TypeBody_28);
    succeeded = ((MR_tag((MR_Word) TypeBody_28)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_35 = (MR_Word) ((MR_Word) (TypeBody_28));
      MaybeRepn_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_35, (MR_Integer) 3))));
      succeeded = (MaybeRepn_32 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        Repn_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRepn_32, (MR_Integer) 0))));
    }
  }
  if (succeeded)
    CheaperTagTest_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_34, (MR_Integer) 2))));
  else
    CheaperTagTest_16 = (MR_Word) ((MR_Unsigned) 0U);
  succeeded = (CheaperTagTest_16 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    ExpensiveConsTag_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_16, (MR_Integer) 1))));
    CheapConsTag_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_16, (MR_Integer) 3))));
    succeeded = hlds__hlds_data____Unify____cons_tag_0_0(ConsTag_15, ExpensiveConsTag_47);
  }
  if (succeeded)
  {
    MR_Word CheapConsTagTestRval_50;
    MR_Word IntType_51;
    MR_Word SubRvalA_52;
    MR_Word SubRvalB_53;
    MR_Word Var_54;

    ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(STATE_VARIABLE_Info_0_17, VarRval_14, VarType_12, CheapConsTag_49, &CheapConsTagTestRval_50);
    succeeded = ((((MR_tag((MR_Word) CheapConsTagTestRval_50)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_50, (MR_Integer) 0)))) == (MR_Integer) 6)));
    if (succeeded)
    {
      Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_50, (MR_Integer) 1))));
      SubRvalA_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_50, (MR_Integer) 2))));
      SubRvalB_53 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_50, (MR_Integer) 3))));
      succeeded = ((((MR_tag((MR_Word) Var_54)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_54, (MR_Integer) 0)))) == (MR_Integer) 8)));
      if (succeeded)
        IntType_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_54, (MR_Integer) 1))) & (MR_Integer) 15);
    }
    if (succeeded)
    {
      MR_Word Var_55;

      {
        ...
        MR_hl_field(MR_mktag(3), Var_55, 1) = (MR_Box) ((MR_Unsigned) (IntType_51));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        *TestRval_8 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRvalA_52));
        MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (SubRvalB_53));
      }
    }
    else
      {
        ...
        *TestRval_8 = base;
        MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) ((MR_Unsigned) 16U));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (CheapConsTagTestRval_50));
      }
  }
  else
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_70, 1) = MR_box_float(Float_13);
        }
        {
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsTag_9, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_73, 0) = ((MR_Box) ((MR_Unsigned) 12U));
              MR_hl_field(MR_mktag(3), Var_73, 1) = ((MR_Box) (String_14));
            }
            {
        ...
        case (MR_Integer) 1:
          {
            ...
            MLDS_Type_17 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ModuleInfo_137, Type_8);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_77, 0) = ((MR_Box) ((MR_Unsigned) 14U));
              MR_hl_field(MR_mktag(3), Var_77, 1) = (MR_Box) ((MR_Unsigned) (ForeignLang_15));
              MR_hl_field(MR_mktag(3), Var_77, 2) = ((MR_Box) (ForeignVal_16));
              MR_hl_field(MR_mktag(3), Var_77, 3) = ((MR_Box) (MLDS_Type_17));
            }
            {
            ...
            }
            {
              ...
              *TestRval_10 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (VarRval_7));
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Var_76));
            }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            SectagBits_180 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalSectag_182, (MR_Integer) 2))));
            {
              ...
              MR_hl_field(MR_mktag(3), Var_121, 1) = ((MR_Box) (PrimSec_184));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), ConstPrimSecRval_185, 1) = ((MR_Box) (Var_121));
            }
            switch (MustMask_48) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  MLDS_Type_162 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ModuleInfo_161, Type_8);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_124, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(3), Var_124, 1) = ((MR_Box) (MLDS_Type_162));
                    MR_hl_field(MR_mktag(3), Var_124, 2) = ((MR_Box) (ConstPrimSecRval_185));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  PrimSecMask_168 = (Var_126 - (MR_Unsigned) 1U);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_132, 1) = ((MR_Box) (PrimSecMask_168));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), MaskedVarRval_169, 3) = ((MR_Box) (Var_131));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), PtagConstRval_141, 1) = ((MR_Box) (Var_86));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ConstPtagRval_24, 1) = ((MR_Box) (Var_91));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), PtagTestRval_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_test_scalar_common_1[0])));
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_98, 1) = ((MR_Box) (SectagMask_32));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), VarSectagRval_29, 3) = ((MR_Box) (Var_97));
                    }
                  }
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ConstSectagRval_33, 1) = ((MR_Box) (Var_99));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), SectagTestRval_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_test_scalar_common_1[0])));
              ...
              case (MR_Integer) 3:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ConstSectagRval_147, 1) = ((MR_Box) (Var_105));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 12:
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_110, 1) = ((MR_Box) (PrimSec_40));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ConstPrimSecRval_41, 1) = ((MR_Box) (Var_110));
              }
              ...
              PrimSecMask_46 = (Var_112 - (MR_Unsigned) 1U);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_118, 1) = ((MR_Box) (PrimSecMask_46));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), MaskedVarRval_47, 3) = ((MR_Box) (Var_117));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 13:
          {
            ...
            Var_81 = mercury__uint8__cast_to_int_1_f_0(PtagUint8_20);
            {
              ...
              MR_hl_field(MR_mktag(2), Var_80, 0) = ((MR_Box) (Var_81));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), PtagConstRval_21, 1) = ((MR_Box) (Var_80));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * TestRval_10)
{
  ...
  switch (MR_tag((MR_Word) IntTag_9)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), IntTag_9, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
