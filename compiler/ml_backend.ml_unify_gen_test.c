...
{
  {
    ...
    MR_Word MainTestRval_16;
    MR_Word OtherTestRvals_17;
    MR_Word Var_20;
    ...
    ml_backend__ml_code_util__ml_gen_var_3_p_0(STATE_VARIABLE_Info_0_18, Var_7, &VarLval_12);
    {
    ...
    ml_backend__ml_code_util__ml_variable_type_3_p_0(STATE_VARIABLE_Info_0_18, Var_7, &VarType_14);
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_18, &ModuleInfo_28);
    parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_14, &TypeCtor_29);
    hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_28, &TypeTable_30);
    succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_30, TypeCtor_29, &TypeDefn_31);
    if (succeeded)
    {
      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_31, &TypeBody_32);
      succeeded = ((MR_tag((MR_Word) TypeBody_32)) == (MR_Integer) 0);
      if (succeeded)
      {
        Var_39 = (MR_Word) ((MR_Word) (TypeBody_32));
        MaybeRepn_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_39, (MR_Integer) 3))));
        succeeded = (MaybeRepn_36 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          Repn_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRepn_36, (MR_Integer) 0))));
      }
    }
    if (succeeded)
      CheaperTagTest_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_38, (MR_Integer) 2))));
    else
      CheaperTagTest_15 = (MR_Word) ((MR_Unsigned) 0U);
    ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_tagged_cons_id_6_p_0(STATE_VARIABLE_Info_0_18, VarRval_13, VarType_14, CheaperTagTest_15, MainTaggedConsId_8, &MainTestRval_16);
    {
      Var_20 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_test_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (ml_backend__ml_unify_gen_test__ml_generate_test_var_has_one_tagged_cons_id_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (STATE_VARIABLE_Info_0_18));
      MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (VarRval_13));
      MR_hl_field(MR_mktag(0), Var_20, 5) = ((MR_Box) (VarType_14));
      MR_hl_field(MR_mktag(0), Var_20, 6) = ((MR_Box) (CheaperTagTest_15));
    }
    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), Var_20, OtherTaggedConsIds_9, &OtherTestRvals_17);
    ml_backend__ml_unify_gen_test__ml_logical_or_rvals_3_p_0(MainTestRval_16, OtherTestRvals_17, TestRval_10);
...
{
  {
    ...
    MR_Word TypeDefn_23;
    MR_Word TypeBody_24;
    MR_Word MaybeRepn_28;
    MR_Word Var_31;
    MR_Word CheapConsTag_45;
    MR_Word ExpensiveConsTag_43;
    ...
    ml_backend__ml_code_util__ml_variable_type_3_p_0(STATE_VARIABLE_Info_0_15, Var_6, &VarType_12);
    ml_backend__ml_unify_gen_util__ml_cons_id_to_tag_3_p_0(STATE_VARIABLE_Info_0_15, ConsId_7, &ConsTag_13);
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_15, &ModuleInfo_20);
    parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_12, &TypeCtor_21);
    hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_20, &TypeTable_22);
    succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_22, TypeCtor_21, &TypeDefn_23);
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_31 = (MR_Word) ((MR_Word) (TypeBody_24));
        MaybeRepn_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 3))));
        succeeded = (MaybeRepn_28 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          Repn_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRepn_28, (MR_Integer) 0))));
      }
    }
    if (succeeded)
      CheaperTagTest_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_30, (MR_Integer) 2))));
    else
      CheaperTagTest_14 = (MR_Word) ((MR_Unsigned) 0U);
    succeeded = (CheaperTagTest_14 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      ExpensiveConsTag_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_14, (MR_Integer) 1))));
      CheapConsTag_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_14, (MR_Integer) 3))));
      succeeded = hlds__hlds_data____Unify____cons_tag_0_0(ConsTag_13, ExpensiveConsTag_43);
    }
    if (succeeded)
    {
      MR_Word CheapConsTagTestRval_46;
      MR_Word IntType_47;
      MR_Word SubRvalA_48;
      MR_Word SubRvalB_49;
      MR_Word Var_50;

      ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(STATE_VARIABLE_Info_0_15, VarRval_11, VarType_12, CheapConsTag_45, &CheapConsTagTestRval_46);
      succeeded = ((((MR_tag((MR_Word) CheapConsTagTestRval_46)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_46, (MR_Integer) 0)))) == (MR_Integer) 6)));
      if (succeeded)
      {
        Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_46, (MR_Integer) 1))));
        SubRvalA_48 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_46, (MR_Integer) 2))));
        SubRvalB_49 = ((MR_Word) ((MR_hl_field(MR_mktag(3), CheapConsTagTestRval_46, (MR_Integer) 3))));
        succeeded = ((((MR_tag((MR_Word) Var_50)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_50, (MR_Integer) 0)))) == (MR_Integer) 8)));
        if (succeeded)
          IntType_47 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_50, (MR_Integer) 1))) & (MR_Integer) 15);
      }
      if (succeeded)
      {
        MR_Word Var_51;

        {
          ...
          MR_hl_field(MR_mktag(3), Var_51, 1) = (MR_Box) ((MR_Unsigned) (IntType_47));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          *TestRval_8 = base;
          ...
          MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRvalA_48));
          MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (SubRvalB_49));
        }
      }
      else
        {
          ...
          *TestRval_8 = base;
          MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (CheapConsTagTestRval_46));
        }
    }
    else
      ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(STATE_VARIABLE_Info_0_15, VarRval_11, VarType_12, ConsTag_13, TestRval_8);
