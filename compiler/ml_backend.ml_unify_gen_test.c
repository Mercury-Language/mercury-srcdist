  ...
  MR_Word * TestRval_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_37 = (MR_Word) ((MR_Word) (TypeBody_30));
      MaybeRepn_34 = ((MR_Word) ((MR_hl_field(0, Var_37, 3))));
      succeeded = (MaybeRepn_34 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        Repn_36 = ((MR_Word) ((MR_hl_field(1, MaybeRepn_34, 0))));
    }
  }
  if (succeeded)
    CheaperTagTest_16 = ((MR_Word) ((MR_hl_field(0, Repn_36, 2))));
  else
  ...
  MR_Word * TestRval_8)
{
  ...
  MR_Word Var_29;
  MR_Word CheapConsTag_37;
  MR_Word ExpensiveConsTag_35;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_29 = (MR_Word) ((MR_Word) (TypeBody_22));
      MaybeRepn_26 = ((MR_Word) ((MR_hl_field(0, Var_29, 3))));
      succeeded = (MaybeRepn_26 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        Repn_28 = ((MR_Word) ((MR_hl_field(1, MaybeRepn_26, 0))));
    }
  }
  if (succeeded)
    CheaperTagTest_15 = ((MR_Word) ((MR_hl_field(0, Repn_28, 2))));
  else
    CheaperTagTest_15 = (MR_Word) ((MR_Unsigned) 0U);
  succeeded = (CheaperTagTest_15 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    ExpensiveConsTag_35 = ((MR_Word) ((MR_hl_field(1, CheaperTagTest_15, 1))));
    CheapConsTag_37 = ((MR_Word) ((MR_hl_field(1, CheaperTagTest_15, 3))));
    succeeded = hlds__hlds_data____Unify____cons_tag_0_0(ConsTag_14, ExpensiveConsTag_35);
  }
  if (succeeded)
  {
    MR_Word CheapConsTagTestRval_38;
    MR_Word IntType_39;
    MR_Word SubRvalA_40;
    MR_Word SubRvalB_41;
    MR_Word Var_42;
    ...
    ml_backend__ml_unify_gen_test__ml_generate_test_rval_has_cons_tag_direct_5_p_0(Info_5, VarRval_13, VarType_11, CheapConsTag_37, &CheapConsTagTestRval_38);
    succeeded = ((((MR_tag((MR_Word) CheapConsTagTestRval_38)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, CheapConsTagTestRval_38, 0)))) == (MR_Integer) 6)));
    if (succeeded)
    {
      Var_42 = ((MR_Word) ((MR_hl_field(3, CheapConsTagTestRval_38, 1))));
      SubRvalA_40 = ((MR_Word) ((MR_hl_field(3, CheapConsTagTestRval_38, 2))));
      SubRvalB_41 = ((MR_Word) ((MR_hl_field(3, CheapConsTagTestRval_38, 3))));
      succeeded = ((((MR_tag((MR_Word) Var_42)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_42, 0)))) == (MR_Integer) 4)));
      if (succeeded)
      {
        IntType_39 = ((((MR_Unsigned) ((MR_hl_field(3, Var_42, 1))) >> 3)) & (MR_Integer) 15);
        Var_43 = ((MR_Unsigned) ((MR_hl_field(3, Var_42, 1))) & (MR_Integer) 7);
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(3, Var_44, 1) = (MR_Box) (((((MR_Unsigned) (IntType_39) << 3)) | (MR_Unsigned) ((MR_Integer) 1)));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        *TestRval_8 = base;
        ...
        MR_hl_field(3, base, 3) = ((MR_Box) (SubRvalB_41));
      }
    }
    else
      {
        ...
        *TestRval_8 = base;
        MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
        MR_hl_field(3, base, 1) = ((MR_Box) ((MR_Unsigned) 16U));
        MR_hl_field(3, base, 2) = ((MR_Box) (CheapConsTagTestRval_38));
      }
  }
  else
