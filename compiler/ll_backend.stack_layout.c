  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = ll_backend__stack_layout__IntroducedFrom__pred__label_layout_var_number_map__2607__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv14_LambdaHeadVar__2_27);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = ll_backend__stack_layout__IntroducedFrom__pred__label_layout_var_number_map__2607__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv9_LambdaHeadVar__2_27);
  if (succeeded)
  {
  ...
  MR_Integer * STATE_VARIABLE_Flags_13)
{
  ...
  succeeded = hlds__hlds_pred__proc_info_has_io_state_pair_from_details_6_p_0(ModuleInfo_6, VarTable_7, HeadVars_8, ArgModes_9, &Var_11, &Var_12);
  if (succeeded)
    ...
    STATE_VARIABLE_Flags_15_15 = (MR_Integer) 0;
  {
    ...
    MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (VarTable_7));
  }
  succeeded = hlds__hlds_pred__proc_info_has_higher_order_arg_from_details_3_p_0(ModuleInfo_6, Var_17, HeadVars_8);
  if (succeeded)
