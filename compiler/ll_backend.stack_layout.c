...
{
  {
    ...
    Var_85 = (NumLongLocns_32 + NumShortLocns_31);
    {
    ...
    EncodedLength_33 = (Var_86 + NumShortLocns_31);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_91 = (NextPTISlot0_36 - OldPTIOffset_39);

        PTISlot_40 = (Var_91 - NumPTIs_29);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_98 = (NextHLDSVarNumSlot0_44 - OldHLDSVarNumsOffset_46);

        HLDSVarNumSlot_47 = (Var_98 - NumHLDSVarNums_30);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_104 = (NextShortLocnSlot0_51 - OldShortLocnsOffset_53);

        ShortLocnSlot_54 = (Var_104 - NumShortLocns_31);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_110 = (NextLongLocnSlot0_58 - OldLongLocnsOffset_60);

        LongLocnSlot_61 = (Var_110 - NumLongLocns_32);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_49 = (BytesSoFar_4 + (MR_Integer) 1);
    ...
    case (MR_Integer) 0:
      {
        ...
        ll_backend__stack_layout__represent_locn_as_int_2_p_0(Var_41, &Word_67);
        {
        ...
        case (MR_Integer) 1:
          {
            ...
            LLDSType_17 = ll_backend__global_data__rval_type_as_arg_4_f_0(UnboxedFloats_14, UnboxedInt64s_15, (MR_Integer) 0, LvalOrConst_8);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (LLDSType_17));
            }
            {
            ...
            ll_backend__global_data__add_scalar_static_cell_4_p_0(Var_35, &DataId_18, STATE_VARIABLE_StaticCellInfo_0_30, STATE_VARIABLE_StaticCellInfo_31);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_39, 1) = ((MR_Box) (DataId_18));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_134 = (Var_210 - OldHeadVarNumOffset_86);

        HeadVarNumSlot_87 = (Var_134 - NumHeadVars_84);
        STATE_VARIABLE_ExecTraceInfo_136_136 = STATE_VARIABLE_ExecTraceInfo_130_130;
      }
      else
      {
        ...
        NextHeadVarNum_89 = (Var_210 + NumHeadVars_84);
        {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_140 = (NextVarName0_95 - OldVarNameOffset_98);

        VarNameSlot_99 = (Var_140 - NumVarNames_97);
        STATE_VARIABLE_ExecTraceInfo_142_142 = STATE_VARIABLE_ExecTraceInfo_136_136;
      }
      else
      {
...
{
  {
    ...
    else
    {
      ...
      BaseAndOffset_9 = (Var_16 + Offset_6);
