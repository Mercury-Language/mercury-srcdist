  ...
  MR_Word * STATE_VARIABLE_Counter_17)
{
  ...
  else
  {
    ...
    parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_7, Var_13, &VarEntry_28);
    VarName_29 = ((MR_String) ((MR_hl_field(MR_mktag(0), VarEntry_28, (MR_Integer) 0))));
    {
      Var_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (Var_13));
      MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (VarName_29));
    }
    ll_backend__stack_layout__add_named_var_to_var_number_map_5_p_0(Var_32, STATE_VARIABLE_VarNumMap_0_14, STATE_VARIABLE_VarNumMap_15, STATE_VARIABLE_Counter_0_16, STATE_VARIABLE_Counter_17);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Counter_32)
{
  ...
  else
  {
    ...
    mercury__list__filter_map_3_p_0((MR_Word) (&ll_backend__continuation_info__ll_backend__continuation_info__type_ctor_info_layout_var_info_0), (MR_Word) (&ll_backend__stack_layout_scalar_common_1[10]), (MR_Word) (&ll_backend__stack_layout_scalar_common_1[46]), VarInfos_59, &VarsNames_69);
    mercury__list__foldl2_6_p_0((MR_Word) (&ll_backend__stack_layout_scalar_common_1[10]), (MR_Word) (&ll_backend__stack_layout_scalar_common_1[5]), (MR_Word) (&mercury__counter__counter__type_ctor_info_counter_0), (MR_Word) (&ll_backend__stack_layout_scalar_common_1[47]), VarsNames_69, ((MR_Box) (STATE_VARIABLE_VarNumMap_0_29)), &conv4_STATE_VARIABLE_VarNumMap_33_33, ((MR_Box) (STATE_VARIABLE_Counter_0_31)), &conv3_STATE_VARIABLE_Counter_34_34);
  ...
  MR_Word * STATE_VARIABLE_StaticCellInfo_18)
{
  ...
  else
  {
    ...
    {
      LengthRval_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LengthRval_57, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__stack_layout_scalar_common_3[3])));
    }
    {
      Vector_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
