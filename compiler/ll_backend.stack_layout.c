...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 475, &CommonLayoutData_12);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 493, &CompressLimit_16);
