...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 235, &DeepProfiling_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 308, &AgcLayout_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 310, &TraceLayout_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 309, &ProcIdLayout_14);
    StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_6, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 280, &UnboxedFloatOpt_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 281, &UnboxedInt64sOpt_17);
