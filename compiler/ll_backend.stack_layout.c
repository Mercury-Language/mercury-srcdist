    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_items_0, &Var_28, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_29_29 = (MR_Word) &libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_items_0;
          succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_29_29, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
          if (succeeded)
          {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 207, &DeepProfiling_8);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 472, &CommonLayoutData_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 460, &StaticCodeAddr_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 255, &UnboxedFloatOpt_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 289, &RttiLineNumbers_15);
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 490, &CompressLimit_16);
