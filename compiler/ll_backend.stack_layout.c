        ...
        case (MR_Integer) 1:
          {
            ...
            LLDSType_17 = ll_backend__global_data__rval_type_as_arg_4_f_0(UnboxedFloats_14, UnboxedInt64s_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), LvalOrConst_8);
            {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 276, &AgcLayout_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 278, &TraceLayout_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 277, &ProcIdLayout_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 472, &CommonLayoutData_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 462, &StaticCodeAddr_13);
