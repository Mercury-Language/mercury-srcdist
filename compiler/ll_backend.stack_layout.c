...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 311, &AgcLayout_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 313, &TraceLayout_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 312, &ProcIdLayout_14);
    StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_6, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 283, &UnboxedFloatOpt_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 284, &UnboxedInt64sOpt_17);
