  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 244, &DeepProfiling_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 317, &AgcLayout_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 319, &TraceLayout_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 318, &ProcIdLayout_14);
  StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_6, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 288, &UnboxedFloatOpt_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 289, &UnboxedInt64sOpt_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 329, &RttiLineNumbers_18);
