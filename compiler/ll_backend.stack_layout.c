...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 474, &CommonLayoutData_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 464, &StaticCodeAddr_13);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 492, &CompressLimit_16);
