...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 226, &DeepProfiling_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 299, &AgcLayout_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 301, &TraceLayout_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 300, &ProcIdLayout_14);
    StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_6, (MR_Integer) 1))) >> 11)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 271, &UnboxedFloatOpt_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 272, &UnboxedInt64sOpt_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 313, &RttiLineNumbers_18);
