...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 233, &DeepProfiling_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 306, &AgcLayout_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 308, &TraceLayout_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 307, &ProcIdLayout_14);
    StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_6, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 278, &UnboxedFloatOpt_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 279, &UnboxedInt64sOpt_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 319, &RttiLineNumbers_18);
