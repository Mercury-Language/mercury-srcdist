  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 274, &DeepProfiling_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 346, &AgcLayout_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 348, &TraceLayout_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 347, &ProcIdLayout_14);
  StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_6, 1))) >> 9)) & (MR_Integer) 1);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 318, &UnboxedFloatOpt_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 319, &UnboxedInt64sOpt_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 358, &RttiLineNumbers_18);
