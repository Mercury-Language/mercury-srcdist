  ...
  MR_Word * STATE_VARIABLE_ProcLayoutInfo_109)
{
  ...
  else
  {
    ...
    MR_Word TypeCtorInfo_320_320;
    MR_Word TypeCtorInfo_321_321;

    succeeded = (TraceStackLayout_60 == (MR_Integer) 1);
    if (succeeded)
    {
      TypeCtorInfo_320_320 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
      TypeCtorInfo_321_321 = (MR_Word) (&ll_backend__continuation_info__ll_backend__continuation_info__type_ctor_info_internal_layout_info_0);
      succeeded = mercury__map__is_empty_1_p_0(TypeCtorInfo_320_320, TypeCtorInfo_321_321, InternalMap_46);
      succeeded = !(succeeded);
      if (succeeded)
