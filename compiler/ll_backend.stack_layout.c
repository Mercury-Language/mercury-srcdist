...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 208, &DeepProfiling_8);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 290, &RttiLineNumbers_15);
