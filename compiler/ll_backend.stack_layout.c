...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 488, &CommonLayoutData_6);
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 506, &CompressLimit_7);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 477, &StaticCodeAddr_14);
