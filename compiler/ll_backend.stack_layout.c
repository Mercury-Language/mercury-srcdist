  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 266, &DeepProfiling_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 338, &AgcLayout_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 340, &TraceLayout_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 339, &ProcIdLayout_14);
  StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_6, (MR_Integer) 1))) >> 9)) & (MR_Integer) 1);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 310, &UnboxedFloatOpt_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 311, &UnboxedInt64sOpt_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 350, &RttiLineNumbers_18);
