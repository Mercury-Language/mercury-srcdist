  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 237, &DeepProfiling_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 309, &AgcLayout_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 311, &TraceLayout_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 310, &ProcIdLayout_14);
  StaticCodeAddr_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_6, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 281, &UnboxedFloatOpt_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 282, &UnboxedInt64sOpt_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 321, &RttiLineNumbers_18);
