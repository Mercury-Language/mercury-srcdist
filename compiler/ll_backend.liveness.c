  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 121, &DebugLiveness_9);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_69, (MR_Integer) 316, &AllowPackingDummies_70);
  {
