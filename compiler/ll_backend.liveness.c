  ...
  MR_Word * CompletedNonLocalUnion_10)
{
  ...
  if ((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *HeadVar__4_4 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    Var_56 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_1, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LiveInfo_1, (MR_Integer) 2))));
    Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LiveInfo_1, (MR_Integer) 3))));
    hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(Var_52, Var_58, Var_56, Var_21, &CompletedSwitchVar_18);
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), DeadnessGoal_38, HeadVar__5_5, &FilteredDeadnessGoal_73);
      parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_Union_0_8, FilteredDeadnessGoal_73, &STATE_VARIABLE_Union_46_46);
    }
  ...
  MR_Word * CompletedNonLocalUnion_9)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), DeadnessGoal_29, HeadVar__4_4, &FilteredDeadnessGoal_45);
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Union1_94, FilteredDeadnessGoal_204, &STATE_VARIABLE_Deadness_112_112);
              }
  ...
  MR_Word * STATE_VARIABLE_Liveness_21)
{
  ...
  Var_40 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
  Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 2))));
  Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 3))));
  hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(Var_36, Var_42, Var_40, Var_17, &CompletedNonLocals_18);
  ...
  MR_Word * STATE_VARIABLE_Union_7)
{
  ...
  else
  {
    ...
    hlds__hlds_llds__goal_info_set_post_births_3_p_0(PostBirths_37, GoalInfo0_35, &GoalInfo_38);
    {
      ...
      MR_hl_field(MR_mktag(0), Goal_19, 0) = ((MR_Box) (GoalExpr_34));
      MR_hl_field(MR_mktag(0), Goal_19, 1) = ((MR_Box) (GoalInfo_38));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
