...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 89, &DebugLiveness_9);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 269, &AllowPackingDummies_14);
    {
      MR_Word base;
