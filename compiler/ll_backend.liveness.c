...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 95, &DebugLiveness_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 286, &AllowPackingDummies_80);
    {
