...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__liveness__Globals_8, (MR_Integer) 75, &ll_backend__liveness__DebugLiveness_9);
    }
    {
        ...
        if (ll_backend__liveness__succeeded)
          {
            ...
            if (ll_backend__liveness__succeeded)
              {
                ll_backend__liveness__V_58_58 = (MR_Integer) 135;
                {
