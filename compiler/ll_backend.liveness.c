  ...
  MR_Word * STATE_VARIABLE_ProcInfo_40)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 298, &AllowPackingDummies_68);
  {
  ...
  MR_Word Goal_16)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_21, Stream_19, ModuleInfo_10, Var_32, (MR_Integer) 1, TVarSet_23, InstVarSet_24, (MR_Integer) 0, (MR_String) "\n", Goal_16);
  }
}
