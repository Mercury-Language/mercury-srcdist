...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 94, &DebugLiveness_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 285, &AllowPackingDummies_80);
    {
