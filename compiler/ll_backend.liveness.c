      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_32, (MR_Integer) 0)));
            succeeded = !(succeeded);
          }
        }
      }
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1)));
    ...
    else
    {
      ...
      else
      {
        ...
        if (!(succeeded))
        {
          ...
          MR_String Var_49;
          MR_String Var_51;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      MR_String Var_26;
      MR_String Var_28;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_8, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Goals_40;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_72, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_72, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_68, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_101, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_4, (MR_Integer) 1)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_51, (MR_Integer) 2)));
              ...
              if (succeeded)
              {
                ...
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_11, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_82, (MR_Integer) 2)));
...
{
  {
    ...
    *NonLocals_7 = hlds__hlds_goal__goal_info_get_code_gen_nonlocals_1_f_0(GoalInfo_6);
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_ValueVars_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_2, (MR_Integer) 1)));
      MR_Word Inst_18;
      ...
      if (succeeded)
      {
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_2, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_10, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_18, (MR_Integer) 5)));
