...
static void MR_CALL 
ll_backend__liveness__live_info_init_5_p_0(
  MR_Word ModuleInfo_6,
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_41)
{
  ...
  if (succeeded)
  {
    ...
    mercury__io__output_stream_3_p_0(&Stream_77);
    mercury__io__write_string_4_p_0(Stream_77, (MR_String) "\nbefore requantify");
    mercury__io__write_string_4_p_0(Stream_77, (MR_String) ":\n");
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_78);
    OutInfo_79 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_78, (MR_Integer) 1);
    {
      Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (VarTableBeforeQuant_12));
    }
    hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_79, Stream_77, ModuleInfo_5, Var_85, (MR_Integer) 1, (MR_Integer) 0, (MR_String) "\n", GoalBeforeQuant_11);
  }
  ...
  ll_backend__liveness__live_info_init_5_p_0(ModuleInfo_5, TypeInfoLiveness_18, VarTable_15, RttiVarMaps_16, &LiveInfo_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_32, (MR_Integer) 0))));
...
{
  MR_Word Globals_11;
  MR_Word AllowPackingDummies_12;

  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_6, &Globals_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 292, &AllowPackingDummies_12);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *LiveInfo_10 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleInfo_6));
    MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_7) << 1)) | (MR_Unsigned) (AllowPackingDummies_12)));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (VarTable_8));
    MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (RttiVarMaps_9));
  }
}
