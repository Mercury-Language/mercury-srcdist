  ...
  MR_Word * STATE_VARIABLE_ProcInfo_41)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_40, &VarTableBeforeQuant_12);
  ...
  if (succeeded)
  {
    ...
    OutInfo_70 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_69, (MR_Integer) 1);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (VarTableBeforeQuant_12));
    }
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_47_47, &VarTable_15);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_80, (MR_Integer) 290, &AllowPackingDummies_81);
  {
    ...
    MR_hl_field(MR_mktag(0), LiveInfo_19, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_18) << 1)) | (MR_Unsigned) (AllowPackingDummies_81)));
  ...
  if (succeeded)
  {
    ...
    OutInfo_85 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_84, (MR_Integer) 1);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (VarTable_15));
    }
  ...
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_38, STATE_VARIABLE_ProcInfo_47_47, &STATE_VARIABLE_ProcInfo_65_65);
  hlds__hlds_pred__proc_info_set_liveness_info_3_p_0(Liveness0_20, STATE_VARIABLE_ProcInfo_65_65, STATE_VARIABLE_ProcInfo_41);
}
