  ...
  MR_Word * STATE_VARIABLE_ProcInfo_41)
{
  ...
  {
    LiveInfo_20 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), LiveInfo_20, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(MR_mktag(0), LiveInfo_20, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_19) << 1)) | (MR_Unsigned) (AllowPackingDummies_80)));
    MR_hl_field(MR_mktag(0), LiveInfo_20, 2) = ((MR_Box) (VarSet_15));
    MR_hl_field(MR_mktag(0), LiveInfo_20, 3) = ((MR_Box) (VarTypes_16));
    MR_hl_field(MR_mktag(0), LiveInfo_20, 4) = ((MR_Box) (RttiVarMaps_17));
  }
  ...
  {
    MR_Word Goal1_86;
    MR_Word DelayedDead_88;
    MR_Word GoalExpr_89;
    MR_Word GoalInfo1_90;
    MR_Word PostDeaths1_91;
    MR_Word PostDeaths_92;
    MR_Word GoalInfo_93;
    MR_Word Var_94;
    MR_Word Var_87;
    ...
    ll_backend__liveness__delay_death_goal_7_p_0(GoalAfterDeadness_25, &Goal1_86, Liveness0_21, &Var_87, Var_94, &DelayedDead_88, VarSet_15);
    GoalExpr_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_86, (MR_Integer) 0))));
    GoalInfo1_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_86, (MR_Integer) 1))));
    hlds__hlds_llds__goal_info_get_post_deaths_2_p_0(GoalInfo1_90, &PostDeaths1_91);
    parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PostDeaths1_91, DelayedDead_88, &PostDeaths_92);
    hlds__hlds_llds__goal_info_set_post_deaths_3_p_0(PostDeaths_92, GoalInfo1_90, &GoalInfo_93);
    {
      GoalAfterDelayDeath_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), GoalAfterDelayDeath_35, 0) = ((MR_Box) (GoalExpr_89));
      MR_hl_field(MR_mktag(0), GoalAfterDelayDeath_35, 1) = ((MR_Box) (GoalInfo_93));
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_21 = (MR_Integer) 0;
          check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(HeadVar__1_1, Mode_16, Type_14, &Var_25);
