  ...
  MR_Word * STATE_VARIABLE_ProcInfo_40)
{
  ...
  MR_Word GoalBeforeQuant_10;
  MR_Word VarTableBeforeQuant_11;
  MR_Word GoalAfterQuant_13;
  MR_Word VarTable_14;
  MR_Word RttiVarMaps_15;
  MR_Word PredInfo_16;
  MR_Word TypeInfoLiveness_17;
  MR_Word LiveInfo_18;
  MR_Word Liveness0_19;
  MR_Word GoalAfterLiveness_20;
  MR_Word Deadness0_22;
  MR_Word GoalAfterDeadness_23;
  ...
  MR_Word Globals_67;
  MR_Word AllowPackingDummies_68;
  MR_Word Deadness0_71;
  MR_Word VarTable_73;
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 104, &DebugLiveness_9);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_39, &GoalBeforeQuant_10);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_39, &VarTableBeforeQuant_11);
  ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nbefore requantify", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_0_39, VarTableBeforeQuant_11, GoalBeforeQuant_10);
  ...
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &GoalAfterQuant_13);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &VarTable_14);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &RttiVarMaps_15);
  hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_5, PredId_6, &PredInfo_16);
  hlds__hlds_pred__body_should_use_typeinfo_liveness_3_p_0(PredInfo_16, Globals_8, &TypeInfoLiveness_17);
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_67);
  libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 300, &AllowPackingDummies_68);
  {
    LiveInfo_18 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, LiveInfo_18, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(0, LiveInfo_18, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_17) << 1)) | (MR_Unsigned) (AllowPackingDummies_68)));
    MR_hl_field(0, LiveInfo_18, 2) = ((MR_Box) (VarTable_14));
    MR_hl_field(0, LiveInfo_18, 3) = ((MR_Box) (RttiVarMaps_15));
  }
  ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nbefore liveness", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_46_46, VarTable_14, GoalAfterQuant_13);
  ll_backend__liveness__initial_liveness_4_p_0(ModuleInfo_5, PredInfo_16, STATE_VARIABLE_ProcInfo_46_46, &Liveness0_19);
  ll_backend__liveness__detect_liveness_in_goal_5_p_0(LiveInfo_18, GoalAfterQuant_13, &GoalAfterLiveness_20, Liveness0_19, &Var_21);
  ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nafter liveness", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_46_46, VarTable_14, GoalAfterLiveness_20);
  hlds__arg_info__partition_proc_args_5_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_46_46, &Var_70, &Deadness0_71, &Var_72);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &VarTable_73);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &RttiVarMaps_74);
  Var_75 = ((((MR_Unsigned) ((MR_hl_field(0, LiveInfo_18, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
  Var_76 = parse_tree__set_of_var__set_to_bitset_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Deadness0_71);
  hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(VarTable_73, RttiVarMaps_74, Var_75, Var_76, &Deadness0_22);
  ll_backend__liveness__detect_deadness_in_goal_6_p_0(LiveInfo_18, Liveness0_19, GoalAfterLiveness_20, &GoalAfterDeadness_23, Deadness0_22, &Var_24);
  ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nafter deadness", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_46_46, VarTable_14, GoalAfterDeadness_23);
  libs__globals__get_trace_level_2_p_0(Globals_8, &TraceLevel_25);
  EffTraceLevel_26 = libs__trace_params__eff_trace_level_for_proc_4_f_0(ModuleInfo_5, PredInfo_16, STATE_VARIABLE_ProcInfo_46_46, TraceLevel_25);
  AllowDelayDeath_27 = libs__trace_params__eff_trace_level_allows_delay_death_1_f_0(EffTraceLevel_26);
  succeeded = (AllowDelayDeath_27 == (MR_Integer) 1);
  if (succeeded)
  {
    Var_56 = (MR_Integer) 170;
    libs__globals__lookup_bool_option_3_p_0(Globals_8, Var_56, &DelayDeath_28);
    succeeded = (DelayDeath_28 == (MR_Integer) 1);
    if (succeeded)
    {
      Var_57 = (MR_Integer) 171;
      libs__globals__lookup_int_option_3_p_0(Globals_8, Var_57, &DelayDeathMaxVars_29);
      parse_tree__var_table__var_table_count_2_p_0(VarTable_14, &NumVars_30);
      succeeded = (NumVars_30 <= DelayDeathMaxVars_29);
      if (succeeded)
      {
        hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo_16, &Origin_31);
        succeeded = ((MR_tag((MR_Word) Origin_31)) == (MR_Integer) 1);
        if (succeeded)
        {
          Var_58 = ((MR_Word) ((MR_hl_field(1, Origin_31, (MR_Integer) 0))));
  ...
  {
    MR_Word Goal1_82;
    MR_Word DelayedDead_84;
    MR_Word GoalExpr_85;
    MR_Word GoalInfo1_86;
    MR_Word PostDeaths1_87;
    MR_Word PostDeaths_88;
    MR_Word GoalInfo_89;
    MR_Word Var_90;
    MR_Word Var_83;

    Var_90 = parse_tree__set_of_var__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0));
    ll_backend__liveness__delay_death_goal_7_p_0(VarTable_14, GoalAfterDeadness_23, &Goal1_82, Liveness0_19, &Var_83, Var_90, &DelayedDead_84);
    GoalExpr_85 = ((MR_Word) ((MR_hl_field(0, Goal1_82, (MR_Integer) 0))));
    GoalInfo1_86 = ((MR_Word) ((MR_hl_field(0, Goal1_82, (MR_Integer) 1))));
    hlds__hlds_llds__goal_info_get_post_deaths_2_p_0(GoalInfo1_86, &PostDeaths1_87);
    parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PostDeaths1_87, DelayedDead_84, &PostDeaths_88);
    hlds__hlds_llds__goal_info_set_post_deaths_3_p_0(PostDeaths_88, GoalInfo1_86, &GoalInfo_89);
    {
      GoalAfterDelayDeath_34 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, GoalAfterDelayDeath_34, 0) = ((MR_Box) (GoalExpr_85));
      MR_hl_field(0, GoalAfterDelayDeath_34, 1) = ((MR_Box) (GoalInfo_89));
    }
    ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nafter delay death", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_46_46, VarTable_14, GoalAfterDelayDeath_34);
  }
  else
    GoalAfterDelayDeath_34 = GoalAfterDeadness_23;
  NeedsFailVars_35 = libs__trace_params__eff_trace_level_needs_fail_vars_1_f_0(EffTraceLevel_26);
  ...
  ll_backend__liveness__detect_resume_points_in_goal_6_p_0(LiveInfo_18, ResumeVars0_36, GoalAfterDelayDeath_34, &Goal_37, Liveness0_19, &Var_38);
  ll_backend__liveness__maybe_debug_liveness_9_p_0(ModuleInfo_5, (MR_String) "\nafter resume point", DebugLiveness_9, PredId_6, STATE_VARIABLE_ProcInfo_46_46, VarTable_14, Goal_37);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_37, STATE_VARIABLE_ProcInfo_46_46, &STATE_VARIABLE_ProcInfo_65_65);
  hlds__hlds_pred__proc_info_set_liveness_info_3_p_0(Liveness0_19, STATE_VARIABLE_ProcInfo_65_65, STATE_VARIABLE_ProcInfo_40);
}
...
{
  MR_bool succeeded;
  MR_Integer PredIdInt_18;

  hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_13, &PredIdInt_18);
  succeeded = (DebugLiveness_12 == PredIdInt_18);
  if (succeeded)
  {
    MR_Word Stream_19;
    MR_Word Globals_20;
    ...
    mercury__io__output_stream_3_p_0(&Stream_19);
    mercury__io__write_string_4_p_0(Stream_19, Message_11);
    mercury__io__write_string_4_p_0(Stream_19, (MR_String) ":\n");
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_10, &Globals_20);
    OutInfo_21 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_20, (MR_Integer) 1);
    hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_10, PredId_13, &PredInfo_22);
    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_22, &TVarSet_23);
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_14, &InstVarSet_24);
    {
      Var_32 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_32, 0) = ((MR_Box) (VarTable_15));
    }
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_21, Stream_19, ModuleInfo_10, Var_32, (MR_Integer) 1, TVarSet_23, InstVarSet_24, (MR_Unsigned) 0U, (MR_String) "\n", Goal_16);
  }
}
