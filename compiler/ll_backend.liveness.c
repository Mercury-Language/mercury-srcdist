  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  ll_backend__liveness__maybe_debug_liveness_8_p_0(ModuleInfo_5, (MR_String) "\nbefore requantify", DebugLiveness_9, PredIdInt_10, VarSetBeforeQuant_12, GoalBeforeQuant_11);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_80, (MR_Integer) 290, &AllowPackingDummies_81);
  {
    ...
    MR_hl_field(MR_mktag(0), LiveInfo_21, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_20) << 1)) | (MR_Unsigned) (AllowPackingDummies_81)));
  ...
  ll_backend__liveness__initial_deadness_4_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_48_48, LiveInfo_21, &Deadness0_25);
  ...
  {
    MR_Word Goal1_87;
    MR_Word DelayedDead_89;
    MR_Word GoalExpr_90;
    MR_Word GoalInfo1_91;
    MR_Word PostDeaths1_92;
    MR_Word PostDeaths_93;
    MR_Word GoalInfo_94;
    MR_Word Var_95;
    MR_Word Var_88;

    Var_95 = parse_tree__set_of_var__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0));
    ll_backend__liveness__delay_death_goal_7_p_0(GoalAfterDeadness_26, &Goal1_87, Liveness0_22, &Var_88, Var_95, &DelayedDead_89, VarSet_16);
    GoalExpr_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_87, (MR_Integer) 0))));
    GoalInfo1_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_87, (MR_Integer) 1))));
    hlds__hlds_llds__goal_info_get_post_deaths_2_p_0(GoalInfo1_91, &PostDeaths1_92);
    parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PostDeaths1_92, DelayedDead_89, &PostDeaths_93);
    hlds__hlds_llds__goal_info_set_post_deaths_3_p_0(PostDeaths_93, GoalInfo1_91, &GoalInfo_94);
    {
      GoalAfterDelayDeath_36 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), GoalAfterDelayDeath_36, 0) = ((MR_Box) (GoalExpr_90));
      MR_hl_field(MR_mktag(0), GoalAfterDelayDeath_36, 1) = ((MR_Box) (GoalInfo_94));
    }
  ...
  MR_Word * Deadness_8)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_6, &_VarSet_12, &VarTypes_13);
  ...
  Var_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
  hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(Var_15, Var_16, VarTypes_13, RttiVarMaps_14, Deadness_8);
}
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              ...
              {
                MR_Word FilteredDeadnessGoal_203;

                ElseInstmapReachable_93 = (MR_Integer) 0;
                parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), DeadnessElse_76, STATE_VARIABLE_Deadness_109_109, &FilteredDeadnessGoal_203);
                parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Union1_94, FilteredDeadnessGoal_203, &STATE_VARIABLE_Deadness_124_124);
              }
