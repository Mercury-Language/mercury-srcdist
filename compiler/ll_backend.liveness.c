...
extern const MR_TypeCtorInfo_Struct
	...
	mercury_data_ll_backend__liveness__type_ctor_info_set_of_var_0;
...
MR_decl_label10(ll_backend__liveness__delay_death_goal_expr_9_0, 25,27,28,30,32,22,35,34,39,42)
MR_decl_label7(ll_backend__liveness__delay_death_goal_expr_9_0, 38,46,53,48,45,155,154)
...
MR_decl_label10(ll_backend__liveness__detect_deadness_in_goal_6_0, 74,80,81,82,83,84,85,86,62,89)
MR_decl_label10(ll_backend__liveness__detect_deadness_in_goal_6_0, 90,91,92,54,97,96,104,105,106,101)
MR_decl_label9(ll_backend__liveness__detect_deadness_in_goal_6_0, 107,100,112,113,114,111,11,118,119)
...
MR_decl_label6(ll_backend__liveness__detect_liveness_in_goal_5_0, 103,104,105,97,19,107)
...
MR_decl_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0, 2,3,4,5,7,8,102,10,14,13)
MR_decl_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0, 17,11,21,24,23,27,20,31,32,33)
MR_decl_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0, 34,35,36,37,39,41,38,47,46,52)
MR_decl_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0, 51,59,60,30,64,65,66,67,70,68)
MR_decl_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0, 75,73,81,63,88,89,85,91,84,96)
MR_decl_label4(ll_backend__liveness__detect_resume_points_in_goal_6_0, 95,9,100,101)
...
MR_decl_static(__Unify___ll_backend__liveness__set_of_var_0_0)
MR_decl_static(__Compare___ll_backend__liveness__set_of_var_0_0)
...
const MR_TypeCtorInfo_Struct mercury_data_ll_backend__liveness__type_ctor_info_set_of_var_0 = {
	0,
	14,
	-1,
	MR_TYPECTOR_REP_EQUIV_GROUND,
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Unify___ll_backend__liveness__set_of_var_0_0)),
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Compare___ll_backend__liveness__set_of_var_0_0)),
	"ll_backend.liveness",
	"set_of_var",
	{ 0 },
...
MR_BEGIN_MODULE(ll_backend__liveness_module9)
	...
	MR_init_label6(ll_backend__liveness__detect_liveness_in_goal_5_0,103,104,105,97,19,107)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__liveness_module21)
	...
	MR_init_label10(ll_backend__liveness__detect_deadness_in_goal_6_0,74,80,81,82,83,84,85,86,62,89)
	MR_init_label10(ll_backend__liveness__detect_deadness_in_goal_6_0,90,91,92,54,97,96,104,105,106,101)
	MR_init_label9(ll_backend__liveness__detect_deadness_in_goal_6_0,107,100,112,113,114,111,11,118,119)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__liveness_module28)
	...
	MR_init_label10(ll_backend__liveness__delay_death_goal_expr_9_0,25,27,28,30,32,22,35,34,39,42)
	MR_init_label7(ll_backend__liveness__delay_death_goal_expr_9_0,38,46,53,48,45,155,154)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__liveness__delay_death_goal_expr_9_0,34)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(ll_backend__liveness__delay_death_goal_expr_9_0_i154);
	}
	}
...
MR_def_label(ll_backend__liveness__delay_death_goal_expr_9_0,155)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(ll_backend__liveness__delay_death_goal_expr_9_0,154)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__liveness_module35)
	...
	MR_init_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0,2,3,4,5,7,8,102,10,14,13)
	MR_init_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0,17,11,21,24,23,27,20,31,32,33)
	MR_init_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0,34,35,36,37,39,41,38,47,46,52)
	MR_init_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0,51,59,60,30,64,65,66,67,70,68)
	MR_init_label10(ll_backend__liveness__detect_resume_points_in_goal_6_0,75,73,81,63,88,89,85,91,84,96)
	MR_init_label4(ll_backend__liveness__detect_resume_points_in_goal_6_0,95,9,100,101)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__liveness__detect_resume_points_in_goal_6_0,10)
	...
	MR_np_call_localret_ent(ll_backend__liveness__detect_resume_points_in_par_conj_6_0,
		ll_backend__liveness__detect_resume_points_in_goal_6_0_i14);
MR_def_label(ll_backend__liveness__detect_resume_points_in_goal_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__liveness__detect_resume_points_in_goal_6_0,21)
	...
	MR_np_call_localret_ent(ll_backend__liveness__detect_resume_points_in_non_disj_7_0,
		ll_backend__liveness__detect_resume_points_in_goal_6_0_i24);
MR_def_label(ll_backend__liveness__detect_resume_points_in_goal_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_BEGIN_MODULE(ll_backend__liveness_module54)
	MR_init_entry1(__Unify___ll_backend__liveness__set_of_var_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___ll_backend__liveness__set_of_var_0_0);
MR_BEGIN_CODE
...
/* code for '__Unify__'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(__Unify___ll_backend__liveness__set_of_var_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__liveness_module55)
	MR_init_entry1(__Compare___ll_backend__liveness__set_of_var_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___ll_backend__liveness__set_of_var_0_0);
MR_BEGIN_CODE
...
/* code for '__Compare__'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(__Compare___ll_backend__liveness__set_of_var_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
void mercury__ll_backend__liveness__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_ll_backend__liveness__type_ctor_info_set_of_var_0,
		ll_backend__liveness__set_of_var_0_0);
