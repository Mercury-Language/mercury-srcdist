  ...
  MR_Word * STATE_VARIABLE_ProcInfo_40)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 105, &DebugLiveness_9);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 301, &AllowPackingDummies_68);
  {
