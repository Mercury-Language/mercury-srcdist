      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_32, (MR_Integer) 0)));
            succeeded = !(succeeded);
          }
        }
      }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 264, &AllowPackingDummies_14);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      *LiveInfo_12 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleInfo_7));
      MR_hl_field(MR_mktag(0), base, 1) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_8) << (MR_Integer) 1)) | (MR_Unsigned) (AllowPackingDummies_14)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1)));
    Var_15 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      else
      {
        ...
        if (!(succeeded))
        {
          ...
          MR_String Var_49;
          MR_String Var_51;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Goals0_15)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_21, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              ll_backend__liveness__detect_resume_points_in_cases_6_p_0(Cases0_27, &Cases_28, STATE_VARIABLE_Liveness_86_86, &STATE_VARIABLE_Liveness_100_100, LiveInfo_10, ResumeVars0_11);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_21, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_56)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
                TermVar_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 1))));
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      MR_String Var_26;
      MR_String Var_28;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_8, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Goals_40;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_72, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_72, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_68)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_68, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_68, (MR_Integer) 2)));
...
{
  {
    ...
    if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1)));
      Var_52 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_7, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_45, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              ll_backend__liveness__detect_deadness_in_cases_10_p_0(Var_63, Cases0_65, &Cases_67, STATE_VARIABLE_Deadness_109_109, STATE_VARIABLE_Liveness_111_111, CompletedNonLocals_141, LiveInfo_11, Union0_142, &STATE_VARIABLE_Deadness_124_124, &Var_68);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_45, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_101)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_101, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
                TermVar_102 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_101, (MR_Integer) 1))));
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_101, (MR_Integer) 2)));
...
{
  {
    MR_Word Var_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_4, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_4, (MR_Integer) 1)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_51, (MR_Integer) 2)));
              ...
              if (succeeded)
              {
                ...
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
                Var_78 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1)));
    Var_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_6, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_50, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_11, (MR_Integer) 2)));
              ...
              ll_backend__liveness__detect_liveness_in_cases_7_p_0(Cases0_59, &Cases_60, Liveness0_8, CompletedNonLocals_14, LiveInfo_10, Liveness0_8, &Liveness_118);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_50, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_82)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_82, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
                TermVar_83 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_82, (MR_Integer) 1))));
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_82, (MR_Integer) 2)));
...
{
  {
    ...
    *NonLocals_7 = hlds__hlds_goal__goal_info_get_code_gen_nonlocals_1_f_0(GoalInfo_6);
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1)));
    Var_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_5, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_ValueVars_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_2, (MR_Integer) 1)));
      MR_Word Inst_18;
      ...
      if (succeeded)
      {
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_2, (MR_Integer) 1)));
...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) GoalExpr0_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 0))) == (MR_Integer) 2)));
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_10, (MR_Integer) 1)));
        Var_42 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LiveInfo_10, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_18, (MR_Integer) 5)));
