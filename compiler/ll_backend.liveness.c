...
MR_decl_label10(ll_backend__liveness__detect_liveness_proc_2_4_0, 14,15,16,17,18,13,19,20,21,22)
MR_decl_label10(ll_backend__liveness__detect_liveness_proc_2_4_0, 23,24,25,26,28,29,31,33,35,27)
MR_decl_label6(ll_backend__liveness__detect_liveness_proc_2_4_0, 39,38,43,45,46,47)
...
MR_decl_label3(ll_backend__liveness__initial_deadness_4_0, 2,3,4)
...
MR_decl_static(ll_backend__liveness__initial_deadness_4_0)
...
MR_BEGIN_MODULE(ll_backend__liveness_module44)
	MR_init_entry1(ll_backend__liveness__initial_deadness_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__liveness__initial_deadness_4_0);
	MR_init_label3(ll_backend__liveness__initial_deadness_4_0,2,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'initial_deadness'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__liveness__initial_deadness_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__arg_info__partition_proc_args_5_0,
		ll_backend__liveness__initial_deadness_4_0_i2);
MR_def_label(ll_backend__liveness__initial_deadness_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r2;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_vartypes_2_0,
		ll_backend__liveness__initial_deadness_4_0_i3);
MR_def_label(ll_backend__liveness__initial_deadness_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_sv(1) = MR_r1;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_rtti_varmaps_2_0,
		ll_backend__liveness__initial_deadness_4_0_i4);
MR_def_label(ll_backend__liveness__initial_deadness_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__liveness_module45)
	...
	MR_init_label10(ll_backend__liveness__detect_liveness_proc_2_4_0,14,15,16,17,18,13,19,20,21,22)
	MR_init_label10(ll_backend__liveness__detect_liveness_proc_2_4_0,23,24,25,26,28,29,31,33,35,27)
	MR_init_label6(ll_backend__liveness__detect_liveness_proc_2_4_0,39,38,43,45,46,47)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(6) != MR_r1)) {
		MR_GOTO_LAB(ll_backend__liveness__detect_liveness_proc_2_4_0_i13);
	}
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("\nbefore liveness", 16);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,18)
	...
	MR_r2 = MR_sv(2);
	MR_r1 = MR_sv(11);
	MR_GOTO_LAB(ll_backend__liveness__detect_liveness_proc_2_4_0_i19);
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,22)
	...
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(ll_backend__liveness__initial_deadness_4_0,
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,26)
	...
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(libs__globals__get_trace_level_2_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i28);
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__liveness__detect_liveness_proc_2_4_0_i27);
	}
	MR_r1 = MR_sv(10);
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,33)
	...
	MR_np_call_localret_ent(ll_backend__liveness__delay_death_proc_body_4_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i35);
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(ll_backend__liveness__detect_liveness_proc_2_4_0_i38);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(11);
	MR_np_call_localret_ent(ll_backend__trace_gen__trace_fail_vars_3_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i43);
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(set__init_1_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i43);
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(5);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(ll_backend__liveness__detect_resume_points_in_goal_6_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i45);
...
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,46)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_set_goal_3_0,
		ll_backend__liveness__detect_liveness_proc_2_4_0_i47);
MR_def_label(ll_backend__liveness__detect_liveness_proc_2_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
