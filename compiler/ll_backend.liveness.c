    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (!(succeeded))
        {
          ...
          hlds__vartypes__vartypes_count_2_p_0(VarTypes_17, &NumVars_32);
  ...
  MR_Word Goal_14)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_18, Stream_16, ModuleInfo_9, VarSet_13, (MR_Integer) 1, (MR_Integer) 0, (MR_String) "\n", Goal_14);
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_46, &Type_37);
