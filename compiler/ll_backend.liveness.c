    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__liveness_scalar_common_1[2], &Var_16, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__liveness_scalar_common_2[2], &Var_17, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_16_16 = (MR_Word) &ll_backend__liveness_scalar_common_1[2];
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_16_16, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
          if (succeeded)
          {
            TypeInfo_17_17 = (MR_Word) &ll_backend__liveness_scalar_common_2[2];
...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0, Var_9, ProcIds_8, ((MR_Box) (PredInfo0_7)), &conv1_PredInfo_6);
  ...
  MR_Word * STATE_VARIABLE_HLDS_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_corresponding_5_p_0(TypeCtorInfo_16_28, TypeCtorInfo_17_29, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, (MR_Word) &ll_backend__liveness_scalar_common_2[4], HeadPredIds_8, PredInfos_22, ((MR_Box) (STATE_VARIABLE_HLDS_0_10)), &conv2_STATE_VARIABLE_HLDS_13_13);
      STATE_VARIABLE_HLDS_13_13 = ((MR_Word) conv2_STATE_VARIABLE_HLDS_13_13);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_PredIds_5 = TailPredIds_9;
        MR_Word next_value_of_STATE_VARIABLE_HLDS_0_10 = STATE_VARIABLE_HLDS_13_13;
    ...
    else
    {
      ...
      mercury__list__foldl_corresponding_5_p_0(TypeCtorInfo_16_46, TypeCtorInfo_17_47, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, (MR_Word) &ll_backend__liveness_scalar_common_2[5], PredIds_5, PredInfos_40, ((MR_Box) (STATE_VARIABLE_HLDS_0_10)), &conv5_STATE_VARIABLE_HLDS_11);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 84, &DebugLiveness_9);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_STATE_VARIABLE_Liveness_0_3 = STATE_VARIABLE_Liveness_15_15;
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  GoalExpr_50 = (MR_Word) MR_mkword(MR_mktag(3), &ll_backend__liveness_scalar_common_2[3]);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_STATE_VARIABLE_ValueVars_0_4 = STATE_VARIABLE_ValueVars_25_25;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_40_40 = (MR_Word) &ll_backend__liveness_scalar_common_1[0];
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = Vars_13;
            MR_Word next_value_of_HeadVar__3_3 = Types_15;
            MR_Word next_value_of_HeadVar__4_4 = Modes_17;
            MR_Word next_value_of_STATE_VARIABLE_Liveness_0_5 = STATE_VARIABLE_Liveness_22_22;
