...
MR_decl_label3(__Unify___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0, 4,8,1)
MR_decl_label2(__Unify___transform_hlds__ctgc__fixpoint_table__fp_entry_1_0, 6,1)
MR_decl_label6(__Compare___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0, 3,2,5,9,13,37)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__fixpoint_table_module11)
	...
	MR_init_label3(__Unify___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0,4,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 == MR_r4)) {
		MR_GOTO_LAB(__Unify___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0_i8);
	}
	MR_incr_sp(9);
...
MR_def_label(__Unify___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__ctgc__fixpoint_table_module12)
	...
	MR_init_label6(__Compare___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0,3,2,5,9,13,37)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0_i37);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
...
MR_def_label(__Compare___transform_hlds__ctgc__fixpoint_table__fixpoint_table_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
