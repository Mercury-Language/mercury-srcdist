  ...
  MR_Word T_5)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_16_19, 0) = ((MR_Box) (&transform_hlds__ctgc__fixpoint_table__transform_hlds__ctgc__fixpoint_table__type_ctor_info_fp_entry_1));
    MR_hl_field(MR_mktag(0), TypeInfo_16_19, 1) = ((MR_Box) (TypeInfo_for_E_11));
  }
  ...
  MR_Word * STATE_VARIABLE_T_17)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_29_29, 1) = ((MR_Box) (TypeInfo_for_E_26));
  }
  ...
  Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 0))));
  Var_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 1))));
  Var_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 2))) & (MR_Integer) 1);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_T_17 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_22));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_23));
    MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (Var_24));
