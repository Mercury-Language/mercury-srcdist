...
MR_decl_label1(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0, 2)
...
MR_decl_static(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0)
...
"transform_hlds.ctgc.fixpoint_table",
"transform_hlds.ctgc.fixpoint_table",
"lambda_ctgc_fixpoint_table_m_131",
6,
0
},
"transform_hlds.ctgc.fixpoint_table",
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__fixpoint_table__init_fixpoint_table_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__fixpoint_table_module19)
	MR_init_entry1(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0);
	MR_init_label1(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__init_fixpoint_table__131__1'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	{
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_1),
		mercury__transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0_i2);
MR_def_label(transform_hlds__ctgc__fixpoint_table__IntroducedFrom__pred__init_fixpoint_table__131__1_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
