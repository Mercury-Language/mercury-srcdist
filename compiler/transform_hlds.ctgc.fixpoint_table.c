...
{
  {
    ...
    E_10 = func_0(((MR_Box) InitFunction_4), LambdaHeadVar__1_12);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) ((MR_Integer) 1));
    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_for_E_11, HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__list____Compare____list_1_0(TypeInfo_for_K_17, &Var_12, ArgX1_4, ArgY1_5);
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&Var_14, Var_27, Var_28);
          ...
          else
          {
            ...
            mercury__tree234____Compare____tree234_2_0(TypeInfo_for_K_17, TypeInfo_24_24, HeadVar__1_1, (MR_Word) ArgX4_10, (MR_Word) ArgY4_11);
          }
        }
      }
    }
    ...
    case (MR_Integer) 0:
      {
        ...
        *S_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_6, (MR_Integer) 0)));
        Var_9 = (MR_hl_field(MR_mktag(0), Entry_6, (MR_Integer) 1));
      }
      break;
    case (MR_Integer) 1:
      *S_8 = (MR_Integer) 1;
...
{
  {
    ...
    MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 0)));
    MR_Integer Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 1)));
    MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 2)));
    ...
    if (succeeded)
    {
      Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_7, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Entry_16;
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 3)));
    MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 0)));
    MR_Integer Var_19 = ((MR_Integer) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 1)));
    MR_Word Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 2)));
    MR_Box conv0_Entry_16;
    MR_Word Var_21;

    {
      TypeInfo_16_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeInfo_16_23, 0) = ((MR_Box) (&transform_hlds__ctgc__fixpoint_table__transform_hlds__ctgc__fixpoint_table__type_ctor_info_fp_entry_1));
      MR_hl_field(MR_mktag(0), TypeInfo_16_23, 1) = ((MR_Box) (TypeInfo_for_E_12));
    }
    succeeded = mercury__map__search_3_p_0(TypeInfo_for_K_11, TypeInfo_16_23, (MR_Word) Var_17, Index_4, &conv0_Entry_16);
    if (succeeded)
    {
      Entry_16 = ((MR_Word) conv0_Entry_16);
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_16, (MR_Integer) 0)));
      TabledElem_7 = (MR_hl_field(MR_mktag(0), Entry_16, (MR_Integer) 1));
      succeeded = MR_TRUE;
    }
    if (succeeded)
      Elem_6 = TabledElem_7;
...
{
  {
    ...
    MR_Word Entry_10;
    MR_Word Var_14;
    MR_Integer Var_15 = ((MR_Integer) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 1)));
    MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 3)));
    MR_Word Var_18;
    MR_Integer Var_19;
    MR_Word Var_20;
    ...
    if (succeeded)
    {
      Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 0)));
      Var_19 = ((MR_Integer) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 1)));
      Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
      ...
      Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 0)));
      *Elem_6 = (MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 1));
      ...
      Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Map_15;
    MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 0)));
    MR_Integer Var_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 1)));
    MR_Word Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 2)));
    ...
    Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), Entry_11, (MR_Integer) 0)));
    ...
    {
      FinalTabledElem_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FinalTabledElem_14, 0) = ((MR_Box) (IsStable_13));
    ...
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 2)));
    Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 3)));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word T_2)
{
  {
    MR_bool succeeded;
    MR_Word Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 2)));
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 0)));
    MR_Integer Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 1)));
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 3)));
  ...
  MR_Word T_2)
{
  {
    MR_bool succeeded;
    MR_Word IsRecursive_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 2)));
    MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 3)));
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 0)));
    MR_Integer Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), T0_3, (MR_Integer) 0)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), T0_3, (MR_Integer) 2)));
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), T0_3, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), T0_3, (MR_Integer) 2)));
...
{
  {
    ...
    {
      InsertElement_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), InsertElement_7, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
    ...
    {
      FT_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FT_6, 0) = ((MR_Box) (Ks_5));
      MR_hl_field(MR_mktag(0), FT_6, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), FT_6, 2) = ((MR_Box) ((MR_Integer) 1));
