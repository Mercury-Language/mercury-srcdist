  ...
  MR_Word * S_8)
{
  switch (S0_7) {
    ...
    case (MR_Integer) 0:
      {
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_6, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), T_5, (MR_Integer) 2)));
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_7, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_16, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Entry_10;
    MR_Word Var_14;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
    MR_Unsigned packed_args_1;
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
      ...
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 0)));
      *Elem_6 = (MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 1));
      ...
      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_11, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Map_15;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 2)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_11, (MR_Integer) 0)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_T_0_16, (MR_Integer) 2)));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), T_2, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), T0_3, (MR_Integer) 2)));
