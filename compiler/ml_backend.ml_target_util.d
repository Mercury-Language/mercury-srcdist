...
ml_backend.ml_target_util.optdate ml_backend.ml_target_util.trans_opt_date ml_target_util.err ml_backend.ml_target_util.c_date ml_backend.ml_target_util.s_date ml_backend.ml_target_util.pic_s_date ml_backend.ml_target_util.il_date ml_backend.ml_target_util.java_date : ml_target_util.m \
	ml_backend.int0 \
	backend_libs.int \
	bool.int \
	builtin.int \
...
ifeq ($(TARGET_ASM),yes)
ml_backend.ml_target_util.mh ml_backend.ml_target_util.mih : ml_backend.ml_target_util.s
else
ml_backend.ml_target_util.mh ml_backend.ml_target_util.mih : ml_backend.ml_target_util.c
endif

ifeq ($(TARGET_ASM),yes)
ml_backend.ml_target_util.module_dep : ml_backend.ml_target_util.s
else
 ifeq ($(findstring il,$(GRADE)),il)
ml_backend.ml_target_util.module_dep : ml_backend.ml_target_util.il
 else
...
ifeq ($(TARGET_ASM),yes)
ml_backend.ml_target_util.s_date : ml_target_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only ml_backend.ml_target_util $(ERR_REDIRECT)
ml_backend.ml_target_util.pic_s_date : ml_target_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" ml_backend.ml_target_util $(ERR_REDIRECT)
endif # TARGET_ASM
ml_backend.ml_target_util.il_date : ml_target_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only ml_backend.ml_target_util $(ERR_REDIRECT)
