...
MR_decl_label8(mode_robdd__implications__normalise_pairs_6_0, 2,6,3,12,14,15,9,20)
MR_decl_label3(mode_robdd__implications__normalise_pairs_6_0, 21,22,23)
MR_decl_label1(mode_robdd__implications__normalise_true_false_imp_map_8_0, 8)
MR_decl_label8(mode_robdd__implications__normalise_true_false_implication_vars_7_0, 4,6,2,8,9,10,11,12)
MR_decl_label8(mode_robdd__implications__normalise_true_false_implication_vars_7_0, 13,14,15,17,18,19,20,21)
MR_decl_label4(mode_robdd__implications__normalise_true_false_implication_vars_7_0, 22,23,26,24)
...
MR_decl_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0, 3,5,8,11,13,2,15,17)
MR_decl_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0, 20,24,14,27,30,36,32,37)
MR_decl_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0, 38,42,43,46,25,49,52,55)
MR_decl_label5(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0, 58,56,64,47,68)
...
MR_decl_label8(fn__mode_robdd__implications__IntroducedFrom__func__propagate_implications_into_equivalences__317__1_4_0, 5,7,10,14,15,16,17,18)
MR_decl_label2(fn__mode_robdd__implications__IntroducedFrom__func__propagate_implications_into_equivalences__317__1_4_0, 2,20)
...
MR_decl_label8(fn__mode_robdd__implications__get_literals_2_0, 10,11,9,12,13,14,15,16)
MR_decl_label1(fn__mode_robdd__implications__get_literals_2_0, 17)
...
MR_BEGIN_MODULE(mode_robdd__implications_module12)
	...
	MR_init_label8(mode_robdd__implications__normalise_true_false_implication_vars_7_0,4,6,2,8,9,10,11,12)
	MR_init_label8(mode_robdd__implications__normalise_true_false_implication_vars_7_0,13,14,15,17,18,19,20,21)
	MR_init_label4(mode_robdd__implications__normalise_true_false_implication_vars_7_0,22,23,26,24)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mode_robdd__implications_module20)
	...
	MR_init_label8(mode_robdd__implications__normalise_pairs_6_0,2,6,3,12,14,15,9,20)
	MR_init_label3(mode_robdd__implications__normalise_pairs_6_0,21,22,23)
MR_BEGIN_CODE
...
MR_def_label(mode_robdd__implications__normalise_pairs_6_0,9)
	...
	MR_tfield(0, MR_r2, 1) = MR_r4;
	MR_tag_alloc_heap(MR_r5, 0, (MR_Integer) 4);
	MR_tfield(0, MR_r5, 0) = (MR_Word) MR_COMMON(5,5);
	MR_tfield(0, MR_r5, 1) = (MR_Word) MR_ENTRY_AP(fn__mode_robdd__implications__IntroducedFrom__func__normalise_pairs__261__1_3_0);
	MR_tfield(0, MR_r5, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r5, 3) = MR_sv(4);
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_CTOR1_ADDR(term, var);
	MR_tfield(0, MR_r1, 1) = MR_sv(4);
	MR_sv(1) = (MR_Integer) 1;
...
MR_def_label(mode_robdd__implications__normalise_pairs_6_0,22)
	...
	MR_r3 = MR_r4;
	MR_np_call_localret_ent(fn__sparse_bitset__union_2_0,
		mode_robdd__implications__normalise_pairs_6_0_i23);
MR_def_label(mode_robdd__implications__normalise_pairs_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_r3;
...
MR_BEGIN_MODULE(mode_robdd__implications_module40)
	...
	MR_init_label8(fn__mode_robdd__implications__get_literals_2_0,10,11,9,12,13,14,15,16)
	MR_init_label1(fn__mode_robdd__implications__get_literals_2_0,17)
MR_BEGIN_CODE
...
MR_def_static(fn__mode_robdd__implications__get_literals_2_0)
	...
	MR_tfield(0, MR_sv(9), 2) = MR_sv(7);
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(fn__mode_robdd__implications__get_literals_2_0_i9);
	}
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_ctfield(1, MR_r2, 0);
	MR_sv(5) = MR_r1;
...
MR_BEGIN_MODULE(mode_robdd__implications_module49)
	...
	MR_init_label8(fn__mode_robdd__implications__IntroducedFrom__func__propagate_implications_into_equivalences__317__1_4_0,5,7,10,14,15,16,17,18)
	MR_init_label2(fn__mode_robdd__implications__IntroducedFrom__func__propagate_implications_into_equivalences__317__1_4_0,2,20)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mode_robdd__implications_module52)
	...
	MR_init_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0,3,5,8,11,13,2,15,17)
	MR_init_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0,20,24,14,27,30,36,32,37)
	MR_init_label8(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0,38,42,43,46,25,49,52,55)
	MR_init_label5(fn__mode_robdd__implications__IntroducedFrom__func__normalise_true_false_imp_map__198__1_5_0,58,56,64,47,68)
MR_BEGIN_CODE
