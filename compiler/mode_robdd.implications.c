      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = mercury__sparse_bitset__is_empty_1_p_0(TypeInfo_90_90, (MR_Word) (UTVs_29));
            if (succeeded)
            {
...
{
  {
    ...
    {
      ImpVars_6 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      ImpVars_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
