...
static const MR_FA_PseudoTypeInfo_Struct1 hlds__make_hlds__check_field_access_functions__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static /* final */ const MR_Box hlds__make_hlds__check_field_access_functions_scalar_common_2[1][8] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&hlds__make_hlds__check_field_access_functions__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0)),
    ((MR_Box) (&hlds__make_hlds__check_field_access_functions__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0))
  },
};
