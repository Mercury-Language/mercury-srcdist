...
static /* final */ const MR_Box hlds__make_hlds__check_field_access_functions_scalar_common_1[13][2];
...
static /* final */ const MR_Box hlds__make_hlds__check_field_access_functions_scalar_common_1[13][2] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__check_field_access_functions_scalar_common_1[3]))),
  ...
  /* row   7 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__check_field_access_functions_scalar_common_1[6]))),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__check_field_access_functions_scalar_common_1[5])))
  },
  /* row   8 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row   9 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__check_field_access_functions_scalar_common_1[8]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  10 */
  {
  ...
  /* row  11 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__check_field_access_functions_scalar_common_1[10]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  12 */
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_module__module_info_get_ctor_field_table_2_p_0(ModuleInfo_8, &CtorFieldTable_20);
    succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&hlds__make_hlds__check_field_access_functions_scalar_common_1[1]), CtorFieldTable_20, ((MR_Box) (FieldName_16)), &conv0_Var_29);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        FieldDefn_21 = ((MR_Word) ((MR_hl_field(1, Var_29, 0))));
        Var_37 = ((MR_Word) ((MR_hl_field(1, Var_29, 1))));
        TypeInfo_38_38 = (MR_Word) (&hlds__make_hlds__check_field_access_functions_scalar_common_1[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_38_38, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_37)));
        if (succeeded)
        {
          Var_32 = (MR_Word) (FuncStatus_11);
          succeeded = (Var_32 != (MR_Word) ((MR_Unsigned) 12U));
          if (succeeded)
          {
            DefnStatus_23 = ((MR_Word) ((MR_hl_field(0, FieldDefn_21, 1))));
            Var_31 = (MR_Word) (DefnStatus_23);
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(3, Var_45, 1) = ((MR_Box) (PFSymNameArity_28));
      }
      {
        Var_44 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_44, 0) = ((MR_Box) (Var_45));
        MR_hl_field(1, Var_44, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__check_field_access_functions_scalar_common_1[7])));
      }
      {
        Var_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_41, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__check_field_access_functions_scalar_common_1[2])));
        MR_hl_field(1, Var_41, 1) = ((MR_Box) (Var_44));
      }
      Var_48 = parse_tree__error_spec__color_as_subject_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__check_field_access_functions_scalar_common_1[9])));
      Var_54 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__check_field_access_functions_scalar_common_1[11])));
      Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_54, (MR_Word) (MR_mkword(1, &hlds__make_hlds__check_field_access_functions_scalar_common_1[12])));
      ...
      Pieces_39 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_41, Var_47);
      {
        Spec_40 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Spec_40, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.check_field_access_functions.report_field_status_mismatch\'/4"));
        MR_hl_field(0, Spec_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_40, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        MR_hl_field(0, Spec_40, 3) = ((MR_Box) (Context_12));
