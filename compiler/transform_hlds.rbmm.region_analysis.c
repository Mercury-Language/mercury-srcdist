  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_47)
{
  ...
  Var_48 = mercury__map__init_0_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_analysis_scalar_common_2[0]));
