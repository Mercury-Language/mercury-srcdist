...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        switch (MR_tag((MR_Word) TypeBody_23)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word MaybeCanonical_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeBody_23, (MR_Integer) 2))));
              MR_Word MaybeRepn_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeBody_23, (MR_Integer) 3))));
              MR_Word CtorRepns_51;
              MR_Word DuTypeKind_54;
              MR_Word EqualityAxioms_57;

              if ((MaybeRepn_48 == (MR_Word) ((MR_Unsigned) 0U)))
                {
              ...
              {
                MR_Word Repn_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRepn_48, (MR_Integer) 0))));

                CtorRepns_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 0))));
                DuTypeKind_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 3))));
              }
              if ((MaybeCanonical_47 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              switch (MR_tag((MR_Word) DuTypeKind_54)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(DuTypeKind_54)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      backend_libs__type_ctor_info__make_mercury_enum_details_4_p_0(CtorRepns_51, (MR_Integer) 0, EqualityAxioms_57, &Details_28);
                      break;
                    case (MR_Integer) 1:
                      backend_libs__type_ctor_info__make_mercury_enum_details_4_p_0(CtorRepns_51, (MR_Integer) 1, EqualityAxioms_57, &Details_28);
                      break;
                    case (MR_Integer) 2:
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Lang_58 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), DuTypeKind_54, (MR_Integer) 0))) & (MR_Integer) 3);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word MaybePseudoTypeInfo_87;

              backend_libs__pseudo_type_info__construct_maybe_pseudo_type_info_4_p_0(Type_44, TypeArity_10, (MR_Word) ((MR_Unsigned) 0U), &MaybePseudoTypeInfo_87);
              {
                Details_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Details_28, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(MR_mktag(3), Details_28, 1) = ((MR_Box) (MaybePseudoTypeInfo_87));
              }
            }
            break;
          case (MR_Integer) 3:
    ...
    TypeCtorInfo_92_92 = (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_type_ctor_flag_0);
    STATE_VARIABLE_Flags_81_81 = mercury__set__init_0_f_0(TypeCtorInfo_92_92);
    switch (MR_tag((MR_Word) TypeBody_23)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        mercury__set__insert_3_p_0(TypeCtorInfo_92_92, ((MR_Box) ((MR_Integer) 1)), STATE_VARIABLE_Flags_81_81, &STATE_VARIABLE_Flags_83_83);
        break;
      case (MR_Integer) 2:
        STATE_VARIABLE_Flags_83_83 = STATE_VARIABLE_Flags_81_81;
        break;
...
{
  {
    ...
    Var_17 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ptag_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_sectag_table_0));
