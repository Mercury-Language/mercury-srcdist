  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = ArgTypes_10;
          MR_Integer next_value_of_ArgNum_2 = Var_19;
          MR_Integer next_value_of_STATE_VARIABLE_Vector_0_3 = STATE_VARIABLE_Vector_18_18;
  ...
  MR_Word * STATE_VARIABLE_Static_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = TypeCtorGenInfos_15;
        MR_Word next_value_of_STATE_VARIABLE_Dynamic_0_3 = STATE_VARIABLE_Dynamic_24_24;
