...
{
  {
    ...
    MR_Word TypeBody_23;
    MR_Word Details_28;
    MR_Word TypeCtorData_71;
    MR_Word STATE_VARIABLE_Flags_80_80;
    MR_Word STATE_VARIABLE_Flags_82_82;
    ...
    TypeCtorInfo_89_89 = (MR_Word) &hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_proc_label_0;
    mercury__univ__type_to_univ_2_p_1(TypeCtorInfo_89_89, ((MR_Box) (UnifyProcLabel_17)), &UnifyUniv_21);
    mercury__univ__type_to_univ_2_p_1(TypeCtorInfo_89_89, ((MR_Box) (CompareProcLabel_20)), &CompareUniv_22);
          ...
          case (MR_Integer) 1:
            {
              ...
              if ((MaybeCanonical_46 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                EqualityAxioms_57 = (MR_Integer) 0;
              else
                EqualityAxioms_57 = (MR_Integer) 1;
              switch (MR_tag((MR_Word) DuTypeKind_54)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(DuTypeKind_54)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      backend_libs__type_ctor_info__make_mercury_enum_details_3_p_0(CtorRepns_51, EqualityAxioms_57, &Details_28);
                      break;
                    case (MR_Integer) 1:
                      backend_libs__type_ctor_info__make_mercury_enum_details_3_p_0(CtorRepns_51, EqualityAxioms_57, &Details_28);
                      break;
                    case (MR_Integer) 2:
                      backend_libs__type_ctor_info__make_du_details_5_p_0(ModuleInfo_5, CtorRepns_51, TypeArity_10, EqualityAxioms_57, &Details_28);
                      break;
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word Lang_58 = ((MR_Word) (MR_hl_field(MR_mktag(1), DuTypeKind_54, (MR_Integer) 0)));

                    backend_libs__type_ctor_info__make_foreign_enum_details_4_p_0(Lang_58, CtorRepns_51, EqualityAxioms_57, &Details_28);
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    MR_Word FunctorName_59 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_54, (MR_Integer) 0)));
                    MR_Word ArgType_60 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_54, (MR_Integer) 1)));
                    MR_Word MaybeArgName_61 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_54, (MR_Integer) 2)));

                    backend_libs__type_ctor_info__make_notag_details_6_p_0(TypeArity_10, FunctorName_59, ArgType_60, MaybeArgName_61, EqualityAxioms_57, &Details_28);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 2:
            {
              ...
              backend_libs__pseudo_type_info__construct_maybe_pseudo_type_info_4_p_0(Type_44, TypeArity_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &MaybePseudoTypeInfo_85);
              {
                Details_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word Var_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_33, (MR_Integer) 1)));
                  MR_Word Var_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_33, (MR_Integer) 2)));
                  MR_Word Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_33, (MR_Integer) 3)));
    ...
    STATE_VARIABLE_Flags_80_80 = mercury__set__init_0_f_0(TypeCtorInfo_90_90);
    switch (MR_tag((MR_Word) TypeBody_23)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_Flags_82_82 = STATE_VARIABLE_Flags_80_80;
        break;
      case (MR_Integer) 1:
        {
          mercury__set__insert_3_p_0(TypeCtorInfo_90_90, ((MR_Box) ((MR_Integer) 1)), STATE_VARIABLE_Flags_80_80, &STATE_VARIABLE_Flags_82_82);
        }
        break;
      case (MR_Integer) 2:
        STATE_VARIABLE_Flags_82_82 = STATE_VARIABLE_Flags_80_80;
    ...
    {
      TypeCtorData_71 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 0) = ((MR_Box) ((MR_Integer) 17));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 1) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 2) = ((MR_Box) (TypeName_9));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 3) = ((MR_Box) (TypeArity_10));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 4) = ((MR_Box) (UnifyUniv_21));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 5) = ((MR_Box) (CompareUniv_22));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 6) = ((MR_Box) (STATE_VARIABLE_Flags_82_82));
      MR_hl_field(MR_mktag(0), TypeCtorData_71, 7) = ((MR_Box) (Details_28));
    }
    *RttiData_6 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) TypeCtorData_71);
  }
}
