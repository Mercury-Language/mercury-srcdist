...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) SymName_13)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 283, &SpecialPreds_53);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 283, &SpecialPreds_18);
