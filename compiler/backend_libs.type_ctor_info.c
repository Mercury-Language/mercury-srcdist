...
static void MR_CALL 
backend_libs__type_ctor_info__IntroducedFrom__pred__generate_exist_info__877__1_3_p_0(
  MR_Word LocnMap_22,
  MR_Word LambdaHeadVar__1_37,
  MR_Word * LambdaHeadVar__2_38);

static void MR_CALL 
backend_libs__type_ctor_info__IntroducedFrom__pred__generate_exist_info__866__1_5_p_0(
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DuFunctor_4, (MR_Integer) 6)));
    MR_Word NameMap0_8;
...
{
  {
    ...
    succeeded = backend_libs__type_ctor_info__IntroducedFrom__pred__make_du_ptag_ordered_table__966__1_2_p_0(((int8_t) (MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((int8_t) (MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) SectagAndLocn_8)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SectagAndLocn_8, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  SectagLocn_9 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned NumSharers0_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SectagTable0_15, (MR_Integer) 2))));
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (&backend_libs__type_ctor_info_scalar_common_5[8]));
      ...
      Var_28 = (NumSharers0_18 + (MR_Unsigned) 1U);
      {
        SectagTable_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        ...
        MR_hl_field(MR_mktag(0), SectagTable_21, 2) = ((MR_Box) (Var_28));
    ...
    else
    {
      ...
      {
        SectagTable_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        ...
        MR_hl_field(MR_mktag(0), SectagTable_36, 2) = ((MR_Box) ((MR_Unsigned) 1U));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgType_13, (MR_Integer) 1)));
      Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgType_13, (MR_Integer) 3))));
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgType_13, (MR_Integer) 4)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), DuTypeKind_53, (MR_Integer) 0)));
...
{
  {
    ...
    backend_libs__type_ctor_info__IntroducedFrom__pred__generate_exist_info__877__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv7_LambdaHeadVar__2_38);
...
{
  {
    ...
    backend_libs__type_ctor_info__IntroducedFrom__pred__generate_exist_info__866__1_5_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv1_LambdaHeadVar__3_30, ((MR_Word) (wrapper_arg_4)), &conv0_LambdaHeadVar__5_32);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsTag_3, (MR_Integer) 3)));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  if ((SectagSize_19 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      SectagAndLocn_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  else
                  {
                    ...
                    {
                      SectagAndLocn_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 12:
          {
            ...
            {
              SectagAndLocn_69 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    mercury__map__apply_to_list_3_p_0((MR_Word) (&backend_libs__type_ctor_info_scalar_common_3[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), OrdinalCtorNames_29, LexicographicCtorNameToSeqNumMap_32, &FunctorNumberMap_14);
    {
      ...
      *Details_8 = base;
      MR_hl_field(MR_mktag(1), base, 0) = (MR_Box) (((((MR_Unsigned) (Lang_5) << (MR_Integer) 1)) | (MR_Unsigned) (EqualityAxioms_7)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word Var_65;
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsTag_16, (MR_Integer) 1)));
...
{
  {
    ...
    mercury__map__apply_to_list_3_p_0((MR_Word) (&backend_libs__type_ctor_info_scalar_common_3[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), OrdinalCtorNames_49, LexicographicCtorNameToSeqNumMap_52, &FunctorNumberMap_18);
    {
      ...
      *Details_8 = base;
      MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((MR_Unsigned) (EqualityAxioms_7));
      ...
      MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) ((MR_Unsigned) (IsDummy_6));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgType_9, (MR_Integer) 1)));
      Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgType_9, (MR_Integer) 3))));
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgType_9, (MR_Integer) 4)));
