    ...
    else
    {
      ...
      if (backend_libs__type_ctor_info__succeeded)
      {
        ...
        if (backend_libs__type_ctor_info__succeeded)
        {
          ...
          {
            MR_Integer backend_libs__type_ctor_info__slot_1 = ((MR_hash_string6(backend_libs__type_ctor_info__TypeName_9)) & (MR_Integer) 31);
            MR_String backend_libs__type_ctor_info__str_2 = ((&backend_libs__type_ctor_info_vector_common_10[0 + backend_libs__type_ctor_info__slot_1]))->backend_libs__type_ctor_info__vector_common_type_10_0__vct_10_f_0;
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) backend_libs__type_ctor_info__SymName_13)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(backend_libs__type_ctor_info__Globals_51, (MR_Integer) 284, &backend_libs__type_ctor_info__SpecialPreds_53);
              ...
              if (backend_libs__type_ctor_info__succeeded)
              {
                ...
                if (!(backend_libs__type_ctor_info__succeeded))
                {
                  ...
                  if (backend_libs__type_ctor_info__succeeded)
                  {
                    ...
                    if ((strcmp(backend_libs__type_ctor_info__ModuleNameString_36, (MR_String) "private_builtin") == 0))
                    {
                      MR_Integer backend_libs__type_ctor_info__slot_1 = ((MR_hash_string6(backend_libs__type_ctor_info__TypeName_18)) & (MR_Integer) 31);
                      MR_String backend_libs__type_ctor_info__str_2 = ((&backend_libs__type_ctor_info_vector_common_3[0 + backend_libs__type_ctor_info__slot_1]))->backend_libs__type_ctor_info__vector_common_type_3_0__vct_3_f_0;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(backend_libs__type_ctor_info__Globals_16, (MR_Integer) 284, &backend_libs__type_ctor_info__SpecialPreds_18);
