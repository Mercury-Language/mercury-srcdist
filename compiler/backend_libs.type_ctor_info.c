  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) SymName_13)) == (MR_Integer) 1))
    {
      ...
      hlds__hlds_data__create_hlds_type_defn_10_p_0(TVarSet_25, (MR_Word) ((MR_Unsigned) 0U), Kinds_27, (MR_Word) (MR_mkword(MR_mktag(3), &backend_libs__type_ctor_info_scalar_common_1[3])), (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), (MR_Integer) 1, (MR_Integer) 0, Context_31, &Var_20);
