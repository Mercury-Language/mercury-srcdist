...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(backend_libs__type_ctor_info__Globals_16, (MR_Integer) 274, &backend_libs__type_ctor_info__SpecialPreds_18);
    }
        ...
        if (((MR_tag((MR_Word) backend_libs__type_ctor_info__SymName_13)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(backend_libs__type_ctor_info__Globals_51, (MR_Integer) 274, &backend_libs__type_ctor_info__SpecialPreds_53);
            }
