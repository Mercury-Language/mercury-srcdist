...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 303, &HighLevelCode_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 303, &HighLevelCode_14);
      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_61_61, &STATE_VARIABLE_ProcInfo_63_63, STATE_VARIABLE_ModuleInfo_0_49, &STATE_VARIABLE_ModuleInfo_64_64);
        }
        break;
    }
