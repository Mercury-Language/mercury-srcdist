  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_22)
{
  ...
  libs__globals__lookup_maybe_int_option_3_p_0(Globals_6, (MR_Integer) 715, &MaybeDebugPredId_7);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__list__filter_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), Var_50, SCCProcs_27, &ShouldInlineSCCProcs_49);
          {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__inlining_scalar_common_1[0]), Var_51, ShouldInlineSCCProcs_49, ((MR_Box) (HeadVar__4_4)), &conv1_STATE_VARIABLE_ShouldInlineProcs_1_22);
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_52, SCCProcs_27, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_5)), &conv3_STATE_VARIABLE_ModuleInfo_1_23);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_48)
{
  ...
  if (succeeded)
  {
    ...
    Var_136 = hlds__hlds_pred__pred_id_to_int_1_f_0(PredId_16);
  ...
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_1_51, &Goal0_24);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_1_51, &VarTypes0_25);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_1_51, &RttiVarMaps0_26);
  {
  ...
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTypes_37, STATE_VARIABLE_ProcInfo_1_51, &STATE_VARIABLE_ProcInfo_2_61);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_38, STATE_VARIABLE_ProcInfo_2_61, &STATE_VARIABLE_ProcInfo_3_62);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_28, STATE_VARIABLE_ProcInfo_3_62, &STATE_VARIABLE_ProcInfo_4_63);
  ...
  switch (InlinedParallel_40) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      hlds__hlds_pred__proc_info_set_has_parallel_conj_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_4_63, &STATE_VARIABLE_ProcInfo_5_69);
      break;
    case (MR_Integer) 0:
  ...
  MR_Word ProcInfo_14)
{
  if (!((MaybeDebugStream_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    else
    {
      ...
      Var_37 = hlds__hlds_pred__pred_id_to_int_1_f_0(PredId_17);
      mercury__io__write_string_4_p_0(DebugStream_16, (MR_String) "\n");
      mercury__io__write_string_4_p_0(DebugStream_16, Desc_10);
    ...
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_14, &VarTable_20);
    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_13, &TVarSet_21);
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_14, &InstVarSet_22);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_14, &Goal_23);
    {
