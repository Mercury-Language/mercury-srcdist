...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__inlining__Globals_13, (MR_Integer) 260, &transform_hlds__inlining__HighLevelCode_14);
    }
          ...
          case (MR_Integer) 5:
            {
              ...
              transform_hlds__inlining__succeeded = ((((MR_tag((MR_Word) transform_hlds__inlining__Reason_51)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__inlining__Reason_51, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (transform_hlds__inlining__succeeded)
                {
...
transform_hlds__inlining__inlining_2_p_0(
  MR_Word transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_0_19,
  MR_Word * transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_20)
{
  {
    MR_bool transform_hlds__inlining__succeeded;
    MR_Word transform_hlds__inlining__TypeCtorInfo_35_35;
    ...
    MR_Word transform_hlds__inlining__PredProcs_17;
    MR_Word transform_hlds__inlining__InlinedProcs0_18;
    MR_Word transform_hlds__inlining__V_28_28;
    MR_Word transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_30_30;
    MR_Word transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_31_31;

    {
      hlds__hlds_module__module_info_get_globals_2_p_0(transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_0_19, &transform_hlds__inlining__Globals_4);
    }
    {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__inlining__Globals_4, (MR_Integer) 260, &transform_hlds__inlining__HighLevelCode_11);
    }
    {
      libs__globals__get_trace_level_2_p_0(transform_hlds__inlining__Globals_4, &transform_hlds__inlining__TraceLevel_12);
    }
    {
      transform_hlds__inlining__V_28_28 = libs__trace_params__given_trace_level_is_none_1_f_0(transform_hlds__inlining__TraceLevel_12);
    }
    {
      transform_hlds__inlining__AnyTracing_13 = mercury__bool__not_1_f_0(transform_hlds__inlining__V_28_28);
    }
    {
    ...
    if (transform_hlds__inlining__succeeded)
      {
        transform_hlds__dead_proc_elim__dead_proc_analyze_2_p_0(transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_0_19, &transform_hlds__inlining__NeededMap_15);
      }
    else
      {
        {
    ...
    {
      hlds__hlds_dependency_graph__module_info_ensure_dependency_info_3_p_0(transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_0_19, &transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_30_30, &transform_hlds__inlining__DepInfo_16);
    }
    transform_hlds__inlining__TypeCtorInfo_35_35 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
    {
      transform_hlds__inlining__PredProcs_17 = libs__dependency_graph__dependency_info_get_condensed_bottom_up_sccs_1_f_0(transform_hlds__inlining__TypeCtorInfo_35_35, transform_hlds__inlining__DepInfo_16);
    }
    {
      mercury__set__init_1_p_0(transform_hlds__inlining__TypeCtorInfo_35_35, &transform_hlds__inlining__InlinedProcs0_18);
    }
    {
      transform_hlds__inlining__do_inlining_6_p_0(transform_hlds__inlining__PredProcs_17, transform_hlds__inlining__NeededMap_15, transform_hlds__inlining__Params_14, transform_hlds__inlining__InlinedProcs0_18, transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_30_30, &transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_31_31);
    }
    {
      hlds__hlds_module__module_info_clobber_dependency_info_2_p_0(transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_31_31, transform_hlds__inlining__STATE_VARIABLE_ModuleInfo_20);
    }
  }
}
