...
struct transform_hlds__inlining__inlining_in_call_5_p_0_env_0_s {
  ...
  MR_Word transform_hlds__inlining__inlining_in_call_5_p_0_env_0__TypeInfo__13_67;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo__25_25 = (MR_Word) (&transform_hlds__inlining_scalar_common_2[1]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__25_25, ((MR_Box) (ArgX10_21)), ((MR_Box) (ArgY10_22)));
                    }
                  }
                }
              }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__32_32 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__32_32, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__33_33 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[2]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__33_33, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__34_34 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[2]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__34_34, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo__35_35 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[5]);
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_45 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          transform_hlds__inlining__inline_in_proc_if_allowed_6_p_0(HeadVar__1_1, HeadVar__3_3, Var_32, Var_46, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_20_20);
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&transform_hlds__inlining_scalar_common_3[0]));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word TypeCtorInfo__44_83;
                MR_Word TypeInfo__45_84;
                MR_Word TSCCArcs_66;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeCtorInfo__44_83 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
                    TSCCArcs_66 = libs__dependency_graph__dependency_info_get_arcs_1_f_0(TypeCtorInfo__44_83, TSCCDepInfo_62);
                    TypeInfo__45_84 = (MR_Word) (&transform_hlds__inlining_scalar_common_2[0]);
                    mercury__list__length_2_p_0(TypeInfo__45_84, TSCCArcs_66, &NumTSCCArcs_67);
                    mercury__list__length_2_p_0(TypeCtorInfo__44_83, SCCProcs_24, &NumSCCProcs_68);
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_88, 0) = ((MR_Box) (&transform_hlds__inlining_scalar_common_3[0]));
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_17, STATE_VARIABLE_ProcInfo_42_45, &VarTypes0_26);
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    {
      Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (env_ptr)->transform_hlds__inlining__inlining_in_call_5_p_0_env_0__HeadVarsForArgVar_63, (MR_Integer) 0))));
      Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (env_ptr)->transform_hlds__inlining__inlining_in_call_5_p_0_env_0__HeadVarsForArgVar_63, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_56)
{
...

  {
    ...
    if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
    {
      ...
      if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
      {
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_30, &(env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__RttiVarMaps_60);
        hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_30, &HeadVars_61);
        (env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__TypeInfo__13_67 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[0]);
        mercury__multi_map__from_corresponding_lists_3_p_0((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__TypeInfo__13_67, (env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__TypeInfo__13_67, (env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__ArgVars_25, HeadVars_61, &(env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__MultiMap_62);
  ...
  MR_Word * Goal_24)
{
  ...
  MR_Word Renaming0_42;
  MR_Word CalleeListOfVars_43;
  ...
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__inlining_scalar_common_1[0]), (MR_Word) (&transform_hlds__inlining_scalar_common_1[0]), HeadVars_27, ArgVars_15, &Renaming0_42);
  parse_tree__var_table__var_table_vars_2_p_0(CalleeVarTable_36, &CalleeListOfVars_43);
  hlds__goal_util__clone_variables_var_table_6_p_0(CalleeListOfVars_43, CalleeVarTable_36, VarTable1_37, VarTable_21, Renaming0_42, &Subn_40);
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__95_95 = (MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_entity_0);
        TypeCtorInfo__96_96 = (MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_maybe_needed_0);
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo__95_95, TypeCtorInfo__96_96, NeededMap_27, ((MR_Box) (Entity_12)), &conv1_Needed_28);
        if (succeeded)
        {
