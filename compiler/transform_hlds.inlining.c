  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  switch (InvolvesDAIO_16) {
    ...
    case (MR_Integer) 0:
      {
        MR_Integer VarThresh_29 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Params_7, (MR_Integer) 5))));
        MR_Word HighLevelCode_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_7, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word PredId_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredProcId_10, (MR_Integer) 0))));
        MR_Integer ProcId_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PredProcId_10, (MR_Integer) 1))));
        MR_Word UnivQTVars_33;
        MR_Word TypeVarSet0_34;
        MR_Word Goal0_35;
        MR_Word VarSet0_36;
        MR_Word VarTypes0_37;
        MR_Word RttiVarMaps0_38;
        MR_Word InlineInfo0_39;
        MR_Word Goal_40;
        MR_Word InlineInfo_41;
        MR_Word VarSet_48;
        MR_Word VarTypes_49;
        MR_Word TypeVarSet_50;
        MR_Word RttiVarMaps_51;
        MR_Word DidInlining_52;
        MR_Word InlinedParallel_53;
        MR_Word DetChanged_54;
        MR_Word PurityChanged_55;
        MR_Word STATE_VARIABLE_PredInfo_43_56;
        MR_Word STATE_VARIABLE_ProcInfo_44_57;
        MR_Word STATE_VARIABLE_PredInfo_49_62;
        MR_Word STATE_VARIABLE_ProcInfo_50_63;
        MR_Word STATE_VARIABLE_ProcInfo_51_64;
        MR_Word STATE_VARIABLE_ProcInfo_52_65;
        MR_Word STATE_VARIABLE_ProcInfo_54_67;
        MR_Word STATE_VARIABLE_ProcInfo_58_71;
        MR_Word STATE_VARIABLE_ModuleInfo_59_72;
        MR_Word STATE_VARIABLE_PredInfo_60_73;
        MR_Word STATE_VARIABLE_PredInfo_61_74;
        MR_Word STATE_VARIABLE_ModuleInfo_62_75;

        hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_17, PredId_31, &STATE_VARIABLE_PredInfo_43_56);
        hlds__hlds_pred__pred_info_proc_info_3_p_0(STATE_VARIABLE_PredInfo_43_56, ProcId_32, &STATE_VARIABLE_ProcInfo_44_57);
        hlds__hlds_pred__pred_info_get_univ_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_43_56, &UnivQTVars_33);
        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_43_56, &TypeVarSet0_34);
        hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_44_57, &Goal0_35);
        hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_44_57, &VarSet0_36, &VarTypes0_37);
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_44_57, &RttiVarMaps0_38);
        {
          InlineInfo0_39 = (MR_Word) MR_new_object(MR_Word, (11 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_17));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 1) = ((MR_Box) (VarThresh_29));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 2) = (MR_Box) ((MR_Unsigned) (HighLevelCode_30));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 3) = ((MR_Box) (UnivQTVars_33));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 4) = ((MR_Box) (ShouldInlineTailProcs_9));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 5) = ((MR_Box) (ShouldInlineProcs_8));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 6) = ((MR_Box) (VarSet0_36));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 7) = ((MR_Box) (VarTypes0_37));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 8) = ((MR_Box) (TypeVarSet0_34));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 9) = ((MR_Box) (RttiVarMaps0_38));
          MR_hl_field(MR_mktag(0), InlineInfo0_39, 10) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 3)) | (((((MR_Unsigned) ((MR_Integer) 0) << 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)))))));
        }
        transform_hlds__inlining__inlining_in_goal_4_p_0(Goal0_35, &Goal_40, InlineInfo0_39, &InlineInfo_41);
        VarSet_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 6))));
        VarTypes_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 7))));
        TypeVarSet_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 8))));
        RttiVarMaps_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 9))));
        DidInlining_52 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 10))) >> 3)) & (MR_Integer) 1);
        InlinedParallel_53 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 10))) >> 2)) & (MR_Integer) 1);
        DetChanged_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 10))) >> 1)) & (MR_Integer) 1);
        PurityChanged_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_41, (MR_Integer) 10))) & (MR_Integer) 1);
        hlds__hlds_pred__pred_info_set_typevarset_3_p_0(TypeVarSet_50, STATE_VARIABLE_PredInfo_43_56, &STATE_VARIABLE_PredInfo_49_62);
        hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_48, VarTypes_49, STATE_VARIABLE_ProcInfo_44_57, &STATE_VARIABLE_ProcInfo_50_63);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_51, STATE_VARIABLE_ProcInfo_50_63, &STATE_VARIABLE_ProcInfo_51_64);
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_40, STATE_VARIABLE_ProcInfo_51_64, &STATE_VARIABLE_ProcInfo_52_65);
        switch (InlinedParallel_53) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            hlds__hlds_pred__proc_info_set_has_parallel_conj_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_52_65, &STATE_VARIABLE_ProcInfo_54_67);
            break;
          case (MR_Integer) 0:
            STATE_VARIABLE_ProcInfo_54_67 = STATE_VARIABLE_ProcInfo_52_65;
            break;
        }
        switch (DidInlining_52) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              MR_Word STATE_VARIABLE_ProcInfo_56_69;

              hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_54_67, &STATE_VARIABLE_ProcInfo_56_69);
              check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_56_69, &STATE_VARIABLE_ProcInfo_58_71, STATE_VARIABLE_ModuleInfo_0_17, &STATE_VARIABLE_ModuleInfo_59_72);
            }
            break;
          case (MR_Integer) 0:
            {
              STATE_VARIABLE_ModuleInfo_59_72 = STATE_VARIABLE_ModuleInfo_0_17;
              STATE_VARIABLE_ProcInfo_58_71 = STATE_VARIABLE_ProcInfo_54_67;
            }
            break;
        }
        hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_32, STATE_VARIABLE_ProcInfo_58_71, STATE_VARIABLE_PredInfo_49_62, &STATE_VARIABLE_PredInfo_60_73);
        switch (PurityChanged_55) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            check_hlds__purity__repuritycheck_proc_4_p_0(STATE_VARIABLE_ModuleInfo_59_72, PredProcId_10, STATE_VARIABLE_PredInfo_60_73, &STATE_VARIABLE_PredInfo_61_74);
            break;
          case (MR_Integer) 0:
            STATE_VARIABLE_PredInfo_61_74 = STATE_VARIABLE_PredInfo_60_73;
            break;
        }
        hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_31, STATE_VARIABLE_PredInfo_61_74, STATE_VARIABLE_ModuleInfo_59_72, &STATE_VARIABLE_ModuleInfo_62_75);
        switch (DetChanged_54) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            check_hlds__det_analysis__det_infer_proc_ignore_msgs_4_p_0(PredId_31, ProcId_32, STATE_VARIABLE_ModuleInfo_62_75, STATE_VARIABLE_ModuleInfo_18);
            break;
          case (MR_Integer) 0:
            *STATE_VARIABLE_ModuleInfo_18 = STATE_VARIABLE_ModuleInfo_62_75;
            break;
        }
      }
      break;
  ...
  MR_Word * STATE_VARIABLE_Info_59)
{
  ...
  {
    MR_Word ModuleInfo_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 0))));
    MR_Integer VarThresh_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 1))));
    MR_Word HighLevelCode_12 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 2))) & (MR_Integer) 1);
    MR_Word ExternalTypeParams_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 3))));
    MR_Word ShouldInlineTailProcs_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 4))));
    MR_Word ShouldInlineProcs_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 5))));
    MR_Word VarSet0_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 6))));
    MR_Word VarTypes0_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 7))));
    MR_Word TypeVarSet0_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 8))));
    MR_Word RttiVarMaps0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 9))));
    MR_Word InlinedParallel0_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 10))) >> 2)) & (MR_Integer) 1);
    MR_Word DetChanged0_22 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 10))) >> 1)) & (MR_Integer) 1);
    MR_Word PurityChanged0_23 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 10))) & (MR_Integer) 1);
    ...
    MR_Word _DidInlining0_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 10))) >> 3)) & (MR_Integer) 1);
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_58, (MR_Integer) 2)));
    ...
    transform_hlds__inlining__should_inline_at_call_site_4_p_0(STATE_VARIABLE_Info_0_58, GoalExpr0_6, GoalInfo0_7, &ShouldInline_32);
    ...
    if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
    {
      ...
      if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
      {
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_31, &(env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__RttiVarMaps_66);
        hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_31, &HeadVars_67);
        (env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__TypeInfo_13_74 = (MR_Word) (&transform_hlds__inlining_scalar_common_1[0]);
    ...
    if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
    {
      ...
      if ((env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded)
        PurityChanged_57 = PurityChanged0_23;
      else
        PurityChanged_57 = (MR_Integer) 1;
      {
        STATE_VARIABLE_Info_60_60 = (MR_Word) MR_new_object(MR_Word, (11 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 0) = ((MR_Box) (ModuleInfo_10));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 1) = ((MR_Box) (VarThresh_11));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 2) = (MR_Box) ((MR_Unsigned) (HighLevelCode_12));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 3) = ((MR_Box) (ExternalTypeParams_13));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 4) = ((MR_Box) (ShouldInlineTailProcs_14));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_60_60, 5) = ((MR_Box) (ShouldInlineProcs_15));
