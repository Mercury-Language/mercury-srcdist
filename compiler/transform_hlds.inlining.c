...
{
  {
    ...
    MR_Word TraceLevel_15;
    MR_Word AnyTracing_16;
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_22, &Globals_4);
    ...
    libs__globals__get_trace_level_2_p_0(Globals_4, &TraceLevel_15);
    Var_25 = libs__trace_params__given_trace_level_is_none_1_f_0(TraceLevel_15);
    AnyTracing_16 = mercury__bool__not_1_f_0(Var_25);
      ...
      mercury__map__init_1_p_0((MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_entity_0), (MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_maybe_needed_0), &NeededMap_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Params_18, 0) = (MR_Box) (((((MR_Unsigned) (Simple_6) << 4)) | (((((MR_Unsigned) (SingleUse_7) << 3)) | (((((MR_Unsigned) (LinearTailRec_8) << 2)) | (((((MR_Unsigned) (HighLevelCode_14) << 1)) | (MR_Unsigned) (AnyTracing_16)))))))));
      MR_hl_field(MR_mktag(0), Params_18, 1) = ((MR_Box) (LinearTailRecMaxExtra_9));
      MR_hl_field(MR_mktag(0), Params_18, 2) = ((MR_Box) (CallCost_10));
      MR_hl_field(MR_mktag(0), Params_18, 3) = ((MR_Box) (CompoundThreshold_11));
      MR_hl_field(MR_mktag(0), Params_18, 4) = ((MR_Box) (SimpleThreshold_12));
      MR_hl_field(MR_mktag(0), Params_18, 5) = ((MR_Box) (VarThreshold_13));
      MR_hl_field(MR_mktag(0), Params_18, 6) = ((MR_Box) (NeededMap_17));
    }
    switch (LinearTailRec_8) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        hlds__hlds_dependency_graph__module_info_ensure_dependency_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_22, &STATE_VARIABLE_ModuleInfo_29_29, &DepInfo_19);
        break;
      case (MR_Integer) 0:
        {
          ...
          hlds__mark_tail_calls__mark_self_and_mutual_tail_rec_calls_in_module_3_p_0(DepInfo_19, STATE_VARIABLE_ModuleInfo_27_27, &STATE_VARIABLE_ModuleInfo_29_29);
        }
        break;
    }
    hlds__hlds_dependency_graph__get_bottom_up_sccs_with_entry_points_3_p_0(STATE_VARIABLE_ModuleInfo_29_29, DepInfo_19, &BottomUpSCCsEntryPoints_20);
    mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &ShouldInlineProcs0_21);
    transform_hlds__inlining__inline_in_sccs_5_p_0(Params_18, BottomUpSCCsEntryPoints_20, ShouldInlineProcs0_21, STATE_VARIABLE_ModuleInfo_29_29, &STATE_VARIABLE_ModuleInfo_30_30);
    hlds__hlds_module__module_info_clobber_dependency_info_2_p_0(STATE_VARIABLE_ModuleInfo_30_30, STATE_VARIABLE_ModuleInfo_23);
  }
}
    ...
    {
      {
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_entity_0), (MR_Word) (&transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_maybe_needed_0), Var_102, ((MR_Box) (Entity_12)), &conv0_Needed_16);
        if (succeeded)
        {
