...
{
  {
    ...
    else
    {
      ...
      MR_Word ArgX9_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 6))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      MR_Word ArgY9_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 6))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      MR_Word ArgX10_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 6))) & (MR_Integer) 1);
      MR_Word ArgY10_23 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 6))) & (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      MR_Word ArgX9_19 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 6))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      MR_Word ArgY9_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 6))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 273, &HighLevelCode_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 350, &Simple_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 352, &SingleUse_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 358, &LinearTailRec_7);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 359, &LinearTailRecMaxExtra_8);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 353, &CallCost_9);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 354, &CompoundThreshold_10);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 355, &SimpleThreshold_11);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 356, &VarThreshold_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 273, &HighLevelCode_13);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Params_17, 0) = (MR_Box) (((((MR_Unsigned) (Simple_5) << (MR_Integer) 2)) | (((((MR_Unsigned) (SingleUse_6) << (MR_Integer) 1)) | (MR_Unsigned) (LinearTailRec_7)))));
      ...
      MR_hl_field(MR_mktag(0), Params_17, 6) = (MR_Box) (((((MR_Unsigned) (HighLevelCode_13) << (MR_Integer) 1)) | (MR_Unsigned) (AnyTracing_15)));
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Word LinearTailRec_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_7, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_7, (MR_Integer) 0)));
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_7, (MR_Integer) 6)));
...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_56_56, &RttiVarMaps0_26);
    {
      ...
      MR_hl_field(MR_mktag(0), InlineInfo0_32, 1) = (MR_Box) (packed_args_1);
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_34, (MR_Integer) 1)));
    ...
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_34, (MR_Integer) 10)));
...
{
  {
    ...
    Var_112 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    Var_111 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 6)));
    ...
    }
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 6)));
    ...
    {
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 0)));
            ...
            packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 6)));
      ...
      if (!(succeeded))
      {
        ...
        if (succeeded)
        {
          packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 0)));
          packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_4, (MR_Integer) 6)));
...
{
  {
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_8, (MR_Integer) 6)));
