...
MR_decl_label10(transform_hlds__inlining__inlining_in_goal_4_0, 24,23,27,26,30,33,29,38,37,114)
MR_decl_label1(transform_hlds__inlining__inlining_in_goal_4_0, 113)
...
MR_decl_label6(transform_hlds__inlining__is_flat_simple_goal_1_0, 3,6,9,14,30,1)
...
MR_BEGIN_MODULE(transform_hlds__inlining_module0)
	...
	MR_init_label6(transform_hlds__inlining__is_flat_simple_goal_1_0,3,6,9,14,30,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__inlining_module9)
	...
	MR_init_label10(transform_hlds__inlining__inlining_in_goal_4_0,24,23,27,26,30,33,29,38,37,114)
	MR_init_label1(transform_hlds__inlining__inlining_in_goal_4_0,113)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__inlining__inlining_in_goal_4_0)
	...
	if (((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)))) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goal_4_0_i114);
	}
...
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,26)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goal_4_0_i113);
	}
	}
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,30)
	...
	MR_r1 = MR_r9;
	MR_np_localcall_lab(transform_hlds__inlining__inlining_in_goal_4_0,
		transform_hlds__inlining__inlining_in_goal_4_0_i33);
...
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,29)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,4)) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goal_4_0_i37);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__inlining__inlining_in_cases_4_0,
		transform_hlds__inlining__inlining_in_goal_4_0_i38);
...
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,37)
	...
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,113)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
