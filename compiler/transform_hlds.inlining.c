...
#line 55 "transform_hlds.inlining.c"
...
#endif
#line 64 "transform_hlds.inlining.c"
...
MR_decl_label3(transform_hlds__inlining__inlining_in_cases_4_0, 13,4,5)
...
MR_decl_label3(transform_hlds__inlining__inlining_in_goals_4_0, 13,4,5)
...
MR_BEGIN_MODULE(transform_hlds__inlining_module10)
	...
	MR_init_label3(transform_hlds__inlining__inlining_in_goals_4_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__inlining__inlining_in_goals_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goals_4_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__inlining__inlining_in_goals_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
...
MR_BEGIN_MODULE(transform_hlds__inlining_module11)
	...
	MR_init_label3(transform_hlds__inlining__inlining_in_cases_4_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__inlining__inlining_in_cases_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_cases_4_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__inlining__inlining_in_cases_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
