...
MR_decl_label10(transform_hlds__inlining__inlining_in_goal_4_0, 6,10,4,14,13,18,19,20,17,24)
MR_decl_label10(transform_hlds__inlining__inlining_in_goal_4_0, 23,28,27,31,34,30,39,38,104,103)
...
MR_BEGIN_MODULE(transform_hlds__inlining_module10)
	...
	MR_init_label10(transform_hlds__inlining__inlining_in_goal_4_0,6,10,4,14,13,18,19,20,17,24)
	MR_init_label10(transform_hlds__inlining__inlining_in_goal_4_0,23,28,27,31,34,30,39,38,104,103)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__inlining__inlining_in_goal_4_0)
	...
	if (((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goal_4_0_i104);
	}
...
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,27)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__inlining__inlining_in_goal_4_0_i103);
	}
	}
...
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,38)
	...
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__inlining__inlining_in_goal_4_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
