...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded = ((env_ptr)->transform_hlds__inlining__inlining_in_call_5_p_0_env_0__HeadVarsForArgVar_75 != (MR_Word) ((MR_Unsigned) 0U));
...
{
  {
...

    {
      ...
      (env).transform_hlds__inlining__inlining_in_call_5_p_0_env_0__succeeded = (ShouldInline_34 != (MR_Word) ((MR_Unsigned) 0U));
