            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TSCCArcs_66 = libs__dependency_graph__dependency_info_get_arcs_1_f_0(TypeCtorInfo_44_83, TSCCDepInfo_62);
                    TypeInfo_45_84 = (MR_Word) (&transform_hlds__inlining_scalar_common_2[0]);
                    mercury__list__length_2_p_0(TypeInfo_45_84, TSCCArcs_66, &NumTSCCArcs_67);
                    mercury__list__length_2_p_0(TypeCtorInfo_44_83, SCCProcs_24, &NumSCCProcs_68);
