  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_42)
{
  ...
  MR_Word InlineInfo0_24;
  MR_Word Goal_25;
  MR_Word InlineInfo_26;
  MR_Word VarSet_33;
  MR_Word VarTypes_34;
  MR_Word TypeVarSet_35;
  MR_Word RttiVarMaps_36;
  MR_Word DidInlining_37;
  MR_Word InlinedParallel_38;
  MR_Word DetChanged_39;
  MR_Word PurityChanged_40;
  ...
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_41, PredId_16, &STATE_VARIABLE_PredInfo_43_43);
  hlds__hlds_pred__pred_info_proc_info_3_p_0(STATE_VARIABLE_PredInfo_43_43, ProcId_17, &STATE_VARIABLE_ProcInfo_44_44);
  hlds__hlds_pred__pred_info_get_univ_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_43_43, &UnivQTVars_18);
  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_43_43, &TypeVarSet0_19);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_44_44, &Goal0_20);
  hlds__hlds_pred__proc_info_get_varset_2_p_0(STATE_VARIABLE_ProcInfo_44_44, &VarSet0_21);
  hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_44_44, &VarTypes0_22);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_44_44, &RttiVarMaps0_23);
  {
    InlineInfo0_24 = (MR_Word) MR_new_object(MR_Word, (11 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_41));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 1) = ((MR_Box) (VarThresh_14));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 2) = (MR_Box) ((MR_Unsigned) (HighLevelCode_15));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 3) = ((MR_Box) (UnivQTVars_18));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 4) = ((MR_Box) (ShouldInlineTailProcs_9));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 5) = ((MR_Box) (ShouldInlineProcs_8));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 6) = ((MR_Box) (VarSet0_21));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 7) = ((MR_Box) (VarTypes0_22));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 8) = ((MR_Box) (TypeVarSet0_19));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 9) = ((MR_Box) (RttiVarMaps0_23));
    MR_hl_field(MR_mktag(0), InlineInfo0_24, 10) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 3)) | (((((MR_Unsigned) ((MR_Integer) 0) << 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)))))));
  }
  transform_hlds__inlining__inlining_in_goal_4_p_0(Goal0_20, &Goal_25, InlineInfo0_24, &InlineInfo_26);
  VarSet_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 6))));
  VarTypes_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 7))));
  TypeVarSet_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 8))));
  RttiVarMaps_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 9))));
  DidInlining_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 10))) >> 3)) & (MR_Integer) 1);
  InlinedParallel_38 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 10))) >> 2)) & (MR_Integer) 1);
  DetChanged_39 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 10))) >> 1)) & (MR_Integer) 1);
  PurityChanged_40 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InlineInfo_26, (MR_Integer) 10))) & (MR_Integer) 1);
  hlds__hlds_pred__pred_info_set_typevarset_3_p_0(TypeVarSet_35, STATE_VARIABLE_PredInfo_43_43, &STATE_VARIABLE_PredInfo_49_49);
  hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet_33, STATE_VARIABLE_ProcInfo_44_44, &STATE_VARIABLE_ProcInfo_50_50);
  hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes_34, STATE_VARIABLE_ProcInfo_50_50, &STATE_VARIABLE_ProcInfo_51_51);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_36, STATE_VARIABLE_ProcInfo_51_51, &STATE_VARIABLE_ProcInfo_52_52);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_25, STATE_VARIABLE_ProcInfo_52_52, &STATE_VARIABLE_ProcInfo_53_53);
  switch (InlinedParallel_38) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      hlds__hlds_pred__proc_info_set_has_parallel_conj_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_53_53, &STATE_VARIABLE_ProcInfo_55_55);
      break;
    case (MR_Integer) 0:
      STATE_VARIABLE_ProcInfo_55_55 = STATE_VARIABLE_ProcInfo_53_53;
      break;
  }
  switch (DidInlining_37) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
        MR_Word STATE_VARIABLE_ProcInfo_57_57;

        hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_55_55, &STATE_VARIABLE_ProcInfo_57_57);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_57_57, &STATE_VARIABLE_ProcInfo_59_59, STATE_VARIABLE_ModuleInfo_0_41, &STATE_VARIABLE_ModuleInfo_60_60);
      }
      break;
    case (MR_Integer) 0:
      {
        STATE_VARIABLE_ModuleInfo_60_60 = STATE_VARIABLE_ModuleInfo_0_41;
        STATE_VARIABLE_ProcInfo_59_59 = STATE_VARIABLE_ProcInfo_55_55;
      }
      break;
  }
  hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_17, STATE_VARIABLE_ProcInfo_59_59, STATE_VARIABLE_PredInfo_49_49, &STATE_VARIABLE_PredInfo_61_61);
  switch (PurityChanged_40) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      check_hlds__purity__repuritycheck_proc_4_p_0(STATE_VARIABLE_ModuleInfo_60_60, PredProcId_10, STATE_VARIABLE_PredInfo_61_61, &STATE_VARIABLE_PredInfo_62_62);
      break;
    case (MR_Integer) 0:
      STATE_VARIABLE_PredInfo_62_62 = STATE_VARIABLE_PredInfo_61_61;
      break;
  }
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_16, STATE_VARIABLE_PredInfo_62_62, STATE_VARIABLE_ModuleInfo_60_60, &STATE_VARIABLE_ModuleInfo_63_63);
  switch (DetChanged_39) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      check_hlds__det_analysis__det_infer_proc_ignore_msgs_4_p_0(PredId_16, ProcId_17, STATE_VARIABLE_ModuleInfo_63_63, STATE_VARIABLE_ModuleInfo_42);
      break;
    case (MR_Integer) 0:
      *STATE_VARIABLE_ModuleInfo_42 = STATE_VARIABLE_ModuleInfo_63_63;
      break;
  }
}
