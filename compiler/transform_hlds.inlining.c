  ...
  MR_Word MayInlinePromisedPure_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 312, &HighLevelCode_12);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 312, &HighLevelCode_16);
