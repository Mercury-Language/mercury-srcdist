...
static const MR_PseudoTypeInfo transform_hlds__inlining__transform_hlds__inlining__field_types_inline_params_0_0[11] = {
  ...
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_inline_tr_sccs_0),
  (MR_PseudoTypeInfo) (&mercury__bool__bool__type_ctor_info_bool_0),
  (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_int_0),
  (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_int_0),
  (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_int_0),
  ...
  MR_Word MayInlinePromisedPure_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 120, &HighLevelCode_12);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 120, &HighLevelCode_16);
  ...
  switch (LinearTailRec_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      hlds__hlds_dependency_graph__module_info_ensure_dependency_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_22, &STATE_VARIABLE_ModuleInfo_1_26, &DepInfo_19);
      break;
    case (MR_Integer) 0:
      {
        MR_Word STATE_VARIABLE_ModuleInfo_2_27;

        hlds__hlds_dependency_graph__module_info_rebuild_dependency_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_22, &STATE_VARIABLE_ModuleInfo_2_27, &DepInfo_19);
        hlds__mark_tail_calls__mark_self_and_mutual_tail_rec_calls_in_module_3_p_0(DepInfo_19, STATE_VARIABLE_ModuleInfo_2_27, &STATE_VARIABLE_ModuleInfo_1_26);
      }
      break;
  }
  hlds__hlds_dependency_graph__get_bottom_up_sccs_with_entry_points_3_p_0(STATE_VARIABLE_ModuleInfo_1_26, DepInfo_19, &BottomUpSCCsEntryPoints_20);
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &ShouldInlineProcs0_21);
  transform_hlds__inlining__inline_in_sccs_6_p_0(ProgressStream_4, Params_18, BottomUpSCCsEntryPoints_20, ShouldInlineProcs0_21, STATE_VARIABLE_ModuleInfo_1_26, &STATE_VARIABLE_ModuleInfo_4_29);
  hlds__hlds_module__module_info_clobber_dependency_info_2_p_0(STATE_VARIABLE_ModuleInfo_4_29, STATE_VARIABLE_ModuleInfo_23);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      transform_hlds__inlining__inline_in_scc_7_p_0(HeadVar__1_1, HeadVar__2_2, SCCEntryPoints_15, HeadVar__4_4, &STATE_VARIABLE_ShouldInlineProcs_1_22, STATE_VARIABLE_ModuleInfo_0_5, &STATE_VARIABLE_ModuleInfo_1_23);
