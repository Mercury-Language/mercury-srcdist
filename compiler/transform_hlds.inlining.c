  ...
  switch (MR_tag((MR_Word) Origin_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 8:
          {
            MR_Word Transform_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_3, (MR_Integer) 1))));
            MR_Word SubOrigin_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_3, (MR_Integer) 2))));

            switch (MR_tag((MR_Word) Transform_23)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(Transform_23)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 1:
                  case (MR_Integer) 2:
            ...
            if (!(succeeded))
            {
              ...
              transform_hlds__inlining__origin_involves_daio_2_p_0(SubOrigin_24, &Var_34);
