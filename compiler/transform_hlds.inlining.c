...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 276, &HighLevelCode_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 353, &Simple_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 355, &SingleUse_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 361, &LinearTailRec_7);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 362, &LinearTailRecMaxExtra_8);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 356, &CallCost_9);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 357, &CompoundThreshold_10);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 358, &SimpleThreshold_11);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 359, &VarThreshold_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 276, &HighLevelCode_13);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = ((((MR_tag((MR_Word) CalledGoalExpr_55)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), CalledGoalExpr_55, (MR_Integer) 0)))) == (MR_Integer) 1)));
                if (succeeded)
                {
