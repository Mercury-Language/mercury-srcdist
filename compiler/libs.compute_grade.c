  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->libs__compute_grade__IntroducedFrom__pred__compute_grade_components__485__1_2_p_0_env_0__Var_18 = (MR_Integer) 223;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) ((MR_Integer) 223));
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 236, &ProfileTime_14);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 237, &ProfileMemory_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 261, &UseTrail_18);
  switch (UseTrail_18) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 270, &StackSegments_20);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 302, &HighLevelCode_21);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 266, &SinglePrecFloat_23);
