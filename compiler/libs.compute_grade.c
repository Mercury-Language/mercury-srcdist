...
{
  {
...

    {
      ...
      (env_ptr)->libs__compute_grade__IntroducedFrom__pred__compute_grade_components__487__1_2_p_0_env_0__Var_18 = (MR_Integer) 189;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) ((MR_Integer) 189));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 204, &ProfileTime_14);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 205, &ProfileMemory_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 229, &UseTrail_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 230, &TrailSegments_19);
    ...
    if (succeeded)
      ...
      STATE_VARIABLE_Specs_121_121 = STATE_VARIABLE_Specs_104_104;
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 239, &StackSegments_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 264, &HighLevelCode_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 235, &SinglePrecFloat_24);
