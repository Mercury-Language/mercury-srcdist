...
{
  {
...

    {
      ...
      (env_ptr)->libs__compute_grade__IntroducedFrom__pred__compute_grade_components__487__1_2_p_0_env_0__Var_18 = (MR_Integer) 190;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) ((MR_Integer) 190));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 205, &ProfileTime_14);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 206, &ProfileMemory_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 230, &UseTrail_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 231, &TrailSegments_19);
    ...
    if (succeeded)
      ...
      STATE_VARIABLE_Specs_121_121 = STATE_VARIABLE_Specs_104_104;
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 240, &StackSegments_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 265, &HighLevelCode_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 236, &SinglePrecFloat_24);
