...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 261, &TrailSegments_19);
    ...
    if (succeeded)
      ...
      STATE_VARIABLE_Specs_121_121 = STATE_VARIABLE_Specs_104_104;
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 270, &StackSegments_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 302, &HighLevelCode_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 266, &SinglePrecFloat_24);
