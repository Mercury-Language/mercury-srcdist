...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), GradeSpec_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[198])));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), GradeSpec_59, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[198])));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[197])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), GradeCompSpec_15, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[196])));
            ...
            case (MR_Integer) 108:
              switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
                case (MR_Integer) 0:
                  ...
                  break;
                case (MR_Integer) 95:
                  if (MR_offset_streq(3, HeadVar__1_1, (MR_String) "hl_nest"))
                ...
                case (MR_Integer) 99:
                  switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                    case (MR_Integer) 0:
                      ...
                      break;
                    case (MR_Integer) 95:
                      if (MR_offset_streq(4, HeadVar__1_1, (MR_String) "hlc_nest"))
...
{
  {
    ...
    libs__compute_grade__IntroducedFrom__pred__reset_grade_options__763__1_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv1_LambdaHeadVar__3_14);
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), AGCSpec_13, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[187])));
          ...
          case (MR_Integer) 3:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), BoehmSpec_11, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[189])));
          ...
          case (MR_Integer) 4:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), HGCSpec_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[190])));
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), TimeProfpec_15, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[191])));
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), MemProfpec_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[192])));
        ...
        case (MR_Integer) 2:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_109, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Trailpec_20, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[193])));
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), StackSegmentpec_165, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[194])));
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_152, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[188])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), SPFSpec_25, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__compute_grade_scalar_common_1[195])));
