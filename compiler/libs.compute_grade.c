...
{
  {
...

    {
      ...
      (libs__compute_grade__env_ptr)->libs__compute_grade__IntroducedFrom__pred__compute_grade_components__487__1_2_p_0_env_0__Var_18 = (MR_Integer) 187;
            ...
            if (libs__compute_grade__succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), libs__compute_grade__Var_31, 0) = ((MR_Box) ((MR_Integer) 187));
...
{
  {
    ...
    *libs__compute_grade__STATE_VARIABLE_Specs_15 = ((MR_Word) libs__compute_grade__conv14_STATE_VARIABLE_Specs_15);
    ...
    {
      libs__globals__set_option_4_p_0((MR_Integer) 639, libs__compute_grade__Var_39, libs__compute_grade__STATE_VARIABLE_Globals_0_12, libs__compute_grade__STATE_VARIABLE_Globals_13);
    }
  }
}
