...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_ite_scalar_common_1[15][2];
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_ite_scalar_common_1[15][2] = {
  ...
  /* row   2 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[1]))),
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[3]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row   5 */
  {
  ...
  /* row   8 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[7]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[6])))
  },
  /* row   9 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  11 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[10]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  12 */
  {
  ...
  /* row  13 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[12]))),
  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (Context_24));
            MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[2])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Spec_31, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_neg\'/10"));
            MR_hl_field(MR_mktag(3), Spec_31, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            MR_hl_field(MR_mktag(3), Spec_31, 2) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(3), Spec_31, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
            MR_hl_field(MR_mktag(3), Spec_31, 4) = ((MR_Box) (Var_49));
          }
        ...
        else
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (Context_24));
              MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[4])));
            }
            {
            ...
            {
              Spec_77 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Spec_77, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_neg\'/10"));
              MR_hl_field(MR_mktag(3), Spec_77, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
              MR_hl_field(MR_mktag(3), Spec_77, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Spec_77, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
              MR_hl_field(MR_mktag(3), Spec_77, 4) = ((MR_Box) (Var_62));
            }
  ...
  Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubGoal1_21, (MR_Integer) 0))));
  succeeded = ((((MR_tag((MR_Word) Var_66)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_66, (MR_Integer) 0)))) == (MR_Integer) 2)));
  if (succeeded)
  {
    Var_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_66, (MR_Integer) 1))) & (MR_Integer) 1);
    Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_66, (MR_Integer) 2))));
  ...
  if (succeeded)
  {
    ...
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 1))));
    *STATE_VARIABLE_Info_38 = STATE_VARIABLE_Info_52_52;
  }
  else
  {
    MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubGoal1_21, (MR_Integer) 0))));
    MR_Word Var_71;

    succeeded = ((((MR_tag((MR_Word) Var_70)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_70, (MR_Integer) 0)))) == (MR_Integer) 3)));
    if (succeeded)
    {
      Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_70, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 0))));
      *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 1))));
      *STATE_VARIABLE_Info_38 = STATE_VARIABLE_Info_52_52;
    }
    else
    {
      ...
      MR_Word Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubGoal1_21, (MR_Integer) 0))));
      MR_Word Var_74;
      ...
      if (succeeded)
      {
        ...
        SubSubGoal_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_74, (MR_Integer) 0))));
        SubSubGoalInfo_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_74, (MR_Integer) 1))));
  ...
  switch (CondCanFail0_27) {
    ...
    case (MR_Integer) 0:
      switch (CondSolns0_28) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else0_23, (MR_Integer) 0))));
            MR_Word Var_71;
            ...
            if (succeeded)
            {
              ...
              Goals_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), CondGoals_83, ThenGoals_84);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_75, 2) = ((MR_Box) (Goals_85));
              }
              {
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_21, (MR_Integer) 0))));
            ...
            else
            {
              ...
              Var_61 = (MR_Word) ((MR_Word) (Cond0_21));
              {
                ...
                MR_hl_field(MR_mktag(0), Cond_38, 0) = ((MR_Box) (Var_61));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_65, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), Var_65, 2) = ((MR_Box) (List_46));
            }
            {
              Var_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (Var_65));
              MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (GoalInfo0_13));
            }
            ...
            *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_63, (MR_Integer) 0))));
            *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_63, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Goals_31 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), CondGoals_29, ThenGoals_30);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_53, 2) = ((MR_Box) (Goals_31));
        }
        {
          Var_50 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (Var_53));
          MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (GoalInfo0_13));
        }
  ...
  MR_Word * STATE_VARIABLE_Info_68)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_71_71, &VarTable_45);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (VarTable_45));
  }
  {
    Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (ElseDelta_42));
    MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (CondThenDelta_39));
    MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (Var_77));
  }
  hlds__instmap__merge_instmap_deltas_7_p_0(Var_74, NonLocals_43, InstMap0_22, Var_75, &NewDelta_46, STATE_VARIABLE_ModuleInfo_73_73, &STATE_VARIABLE_ModuleInfo_76_76);
  check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_76_76, STATE_VARIABLE_Info_71_71, &STATE_VARIABLE_Info_79_79);
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      MR_Word Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_31, (MR_Integer) 0))));
      MR_Word Var_81;

      succeeded = ((((MR_tag((MR_Word) Var_80)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_80, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if (succeeded)
      {
        Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_80, (MR_Integer) 1))));
        succeeded = (Var_81 == (MR_Word) ((MR_Unsigned) 0U));
      }
    }
  }
  if (succeeded)
    check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(IfThenElseExpr_48, GoalExpr_18, GoalInfo1_47, GoalInfo_20, NestedContext0_21, InstMap0_22, Common0_23, Common_24, STATE_VARIABLE_Info_79_79, STATE_VARIABLE_Info_68);
  else
  {
    ...
    *Common_24 = Common0_23;
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_79_79, &ModuleInfo_44);
    ...
    switch (MR_tag((MR_Word) CanSwitch_56)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CanSwitch_56)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *STATE_VARIABLE_Info_68 = STATE_VARIABLE_Info_79_79;
            break;
          case (MR_Integer) 1:
            *STATE_VARIABLE_Info_68 = STATE_VARIABLE_Info_79_79;
            break;
      ...
      case (MR_Integer) 1:
        {
          ...
          SwitchVarName_60 = ((MR_String) ((MR_hl_field(MR_mktag(0), SwitchVarEntry_59, (MR_Integer) 0))));
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_87, 1) = ((MR_Box) (SwitchVarName_60));
            }
            {
            ...
            {
              OnPieces_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), OnPieces_61, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[9])));
              MR_hl_field(MR_mktag(1), OnPieces_61, 1) = ((MR_Box) (Var_86));
            }
          }
          Var_95 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), OnPieces_61, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
          Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[13])), Var_95);
          {
            Var_109 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_109, 0) = ((MR_Box) (Context_58));
            MR_hl_field(MR_mktag(0), Var_109, 1) = ((MR_Box) (Pieces_63));
          }
          {
          ...
          {
            Spec_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_ordinary_ite\'/13"));
            MR_hl_field(MR_mktag(3), Spec_64, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 54) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            MR_hl_field(MR_mktag(3), Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 8U));
            MR_hl_field(MR_mktag(3), Spec_64, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[1])));
            MR_hl_field(MR_mktag(3), Spec_64, 4) = ((MR_Box) (Var_108));
          }
          check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_64, STATE_VARIABLE_Info_79_79, STATE_VARIABLE_Info_68);
        }
        break;
    }
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_set_determinism_3_p_0(InnerDetism_65, GoalInfo1_47, &InnerInfo_66);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_115, 0) = ((MR_Box) (IfThenElseExpr_48));
        MR_hl_field(MR_mktag(0), Var_115, 1) = ((MR_Box) (InnerInfo_66));
      }
      {
        MR_Word base;
        ...
        *GoalExpr_18 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[14])));
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Var_115));
      }
    }
    else
                ...
                if (succeeded)
                  switch (MR_tag((MR_Word) TypeBody_35)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Word Ctors_111 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_110, (MR_Integer) 0))));
                        MR_Word Var_123 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Ctors_111, (MR_Integer) 1))));
                    ...
                    case (MR_Integer) 2:
                      ...
                      break;
                    case (MR_Integer) 3:
                      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_35, (MR_Integer) 0))))) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 0:
                          {
          ...
          case (MR_Integer) 3:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_95, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_ite_scalar_common_3[0]));
                ...
                MR_hl_field(MR_mktag(0), Var_95, 4) = ((MR_Box) (VarTable_7));
              }
    ...
    case (MR_Integer) 0:
      {
        ...
        Context_11 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_6);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_19, 1) = ((MR_Box) (Problem_8));
        }
        {
          Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_18, 0) = ((MR_Box) (Var_19));
          MR_hl_field(MR_mktag(1), Var_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
        }
        {
          Pieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[5])));
          MR_hl_field(MR_mktag(1), Pieces_12, 1) = ((MR_Box) (Var_18));
        }
        {
          Var_33 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (Context_11));
          MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (Pieces_12));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Spec_13, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.maybe_warn_about_condition\'/5"));
          ...
          MR_hl_field(MR_mktag(3), Spec_13, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
          MR_hl_field(MR_mktag(3), Spec_13, 4) = ((MR_Box) (Var_32));
        }
        check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_13, STATE_VARIABLE_Info_0_14, &STATE_VARIABLE_Info_35_35);
      }
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_Info_35_35 = STATE_VARIABLE_Info_0_14;
      break;
  }
  check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_36_36);
  check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_36_36, STATE_VARIABLE_Info_15);
}
