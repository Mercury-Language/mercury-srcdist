          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = (Var_51 == (MR_Word) ((MR_Integer) 0));
              }
              if (succeeded)
              {
                MR_Word Var_52;
...
{
  {
    ...
    else
    {
      ...
      *Common_24 = Common0_23;
      ...
      check_hlds__simplify__simplify_goal_ite__warn_switch_for_ite_cond_5_p_0(ModuleInfo_44, VarTypes_45, Cond_26, (MR_Word) ((MR_Integer) 0), &CanSwitch_56);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              OnPieces_62 = (MR_Word) ((MR_Integer) 0);
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (MR_tag((MR_Word) STATE_VARIABLE_CondCanSwitch_0_86)) {
            ...
            case (MR_Integer) 0:
              ...
              break;
            case (MR_Integer) 1:
              *STATE_VARIABLE_CondCanSwitch_87 = (MR_Word) ((MR_Integer) 4);
              break;
          }
        }
        break;
