...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_ite_scalar_common_2[2][3] = {
  ...
  /* row 1 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 49) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                Msg_93 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    if (succeeded)
    {
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_104, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 49) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_15, (MR_Integer) 4)));
                MR_Word TypeBody_35;
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_7, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_29, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 24) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
