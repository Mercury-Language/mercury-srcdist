  ...
  MR_Word * STATE_VARIABLE_Info_68)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_71_71, &VarTable_45);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (ElseDelta_42));
    MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (CondThenDelta_39));
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      MR_Word Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_31, (MR_Integer) 0))));
      MR_Word Var_80;
    ...
    *Common_24 = Common0_23;
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (SwitchVarName_60));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), OnPieces_61, 1) = ((MR_Box) (Var_85));
            }
          }
          Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), OnPieces_61, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
          Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[13])), Var_94);
          {
            Var_108 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_108, 0) = ((MR_Box) (Context_58));
            MR_hl_field(MR_mktag(0), Var_108, 1) = ((MR_Box) (Pieces_63));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Spec_64, 4) = ((MR_Box) (Var_107));
          }
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_set_determinism_3_p_0(InnerDetism_65, GoalInfo1_47, &InnerInfo_66);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_114, 0) = ((MR_Box) (IfThenElseExpr_48));
        MR_hl_field(MR_mktag(0), Var_114, 1) = ((MR_Box) (InnerInfo_66));
      }
      {
        MR_Word base;
        ...
        *GoalExpr_18 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Var_114));
      }
    }
    else
