  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_31, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 28) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_31, STATE_VARIABLE_Info_39_39, &STATE_VARIABLE_Info_62_62);
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(3, Spec_97, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 28) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            ...
            check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_97, STATE_VARIABLE_Info_39_39, &STATE_VARIABLE_Info_62_62);
          }
          else
            STATE_VARIABLE_Info_62_62 = STATE_VARIABLE_Info_39_39;
        }
      }
      break;
    case (MR_Integer) 1:
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
        check_hlds__simplify__simplify_goal__simplify_maybe_wrap_goal_7_p_0(GoalInfo0_13, SubSubGoalInfo_35, SubSubGoal_34, GoalExpr_12, GoalInfo_14, STATE_VARIABLE_Info_62_62, STATE_VARIABLE_Info_38);
      else
      {
  ...
  MR_Word * STATE_VARIABLE_Info_67)
{
  ...
  check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Cond0_15, &Cond_26, NestedContext0_21, InstMap0_22, Common0_23, &AfterCondCommon_27, STATE_VARIABLE_Info_0_66, &STATE_VARIABLE_Info_68_68);
  hlds__goal_util__apply_goal_instmap_delta_3_p_0(Cond_26, InstMap0_22, &AfterCondInstMap0_28);
  check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Then0_16, &Then_29, NestedContext0_21, AfterCondInstMap0_28, AfterCondCommon_27, &_AfterThenCommon_30, STATE_VARIABLE_Info_68_68, &STATE_VARIABLE_Info_69_69);
  check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Else0_17, &Else_31, NestedContext0_21, InstMap0_22, Common0_23, &_AfterElseCommon_32, STATE_VARIABLE_Info_69_69, &STATE_VARIABLE_Info_70_70);
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_70_70, &STATE_VARIABLE_ModuleInfo_72_72);
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_70_70, &VarTable_45);
  {
  ...
  hlds__instmap__merge_instmap_deltas_7_p_0(VarTable_45, NonLocals_43, InstMap0_22, Var_73, &NewDelta_46, STATE_VARIABLE_ModuleInfo_72_72, &STATE_VARIABLE_ModuleInfo_74_74);
  check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_74_74, STATE_VARIABLE_Info_70_70, &STATE_VARIABLE_Info_77_77);
  ...
  if (succeeded)
    check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(IfThenElseExpr_48, GoalExpr_18, GoalInfo1_47, GoalInfo_20, NestedContext0_21, InstMap0_22, Common0_23, Common_24, STATE_VARIABLE_Info_77_77, STATE_VARIABLE_Info_67);
  else
  {
    ...
    *Common_24 = Common0_23;
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo_44);
    ...
    switch (MR_tag((MR_Word) CanSwitch_56)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CanSwitch_56)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *STATE_VARIABLE_Info_67 = STATE_VARIABLE_Info_77_77;
            break;
          case (MR_Integer) 1:
            *STATE_VARIABLE_Info_67 = STATE_VARIABLE_Info_77_77;
            break;
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_63, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 55) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_63, STATE_VARIABLE_Info_77_77, STATE_VARIABLE_Info_67);
        }
        break;
    }
    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_13, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 28) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
