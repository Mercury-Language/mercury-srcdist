      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word _MaybeUserEq_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_3, (MR_Integer) 1)));
          MR_Word _MaybeRepn_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_3, (MR_Integer) 2)));
          MR_Word _MaybeForeignType_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_3, (MR_Integer) 3)));
          MR_Word Var_24;
          MR_Word Var_9;
          MR_Word Var_10;
          MR_Word Var_11;
          ...
          if (succeeded)
          {
            Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), Ctors_5, (MR_Integer) 0)));
            Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), Ctors_5, (MR_Integer) 1)));
            succeeded = ((MR_tag((MR_Word) Var_24)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
              Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 0)));
              Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 1)));
            }
          }
          if (succeeded)
