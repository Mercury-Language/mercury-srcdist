...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Var_82)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 0))) == (MR_Integer) 2)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_86)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_86, (MR_Integer) 0))) == (MR_Integer) 3)));
      if (succeeded)
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Var_50)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_50, (MR_Integer) 0))) == (MR_Integer) 3)));
              if (succeeded)
              {
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                succeeded = ((MR_tag((MR_Word) MaybeNegDetism_35)) == (MR_Integer) 1);
                if (succeeded)
                {
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      if (!(succeeded))
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Var_81)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_81, (MR_Integer) 0))) == (MR_Integer) 3)));
        if (succeeded)
        {
