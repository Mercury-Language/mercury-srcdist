            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  switch (MR_tag((MR_Word) TypeBody_35)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        MR_Word TypeBodyDu_105 = (MR_Word) ((MR_Word) (TypeBody_35));
                        MR_Word Ctors_106 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_105, (MR_Integer) 0))));
                        MR_Word Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Ctors_106, (MR_Integer) 1))));
