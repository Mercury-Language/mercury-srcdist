...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_ite_scalar_common_1[15][2] = {
  ...
  /* row  10 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[9]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  11 */
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__11_11 = (MR_Word) (&check_hlds__simplify__simplify_goal_ite_scalar_common_1[0]);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_53, (MR_Integer) 1))));
              check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_54_54, &STATE_VARIABLE_Info_57_57);
              check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_57_57, STATE_VARIABLE_Info_49);
            }
            else
  ...
  MR_Word * STATE_VARIABLE_Info_68)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_71_71, &VarTypes_45);
  {
    Var_74 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (VarTypes_45));
  }
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_79_79, &VarSet_59);
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_93, 1) = ((MR_Box) (SwitchVarName_61));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), OnPieces_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[13])));
              MR_hl_field(MR_mktag(1), OnPieces_62, 1) = ((MR_Box) (Var_92));
            }
          }
          else
            OnPieces_62 = (MR_Word) ((MR_Unsigned) 0U);
          Var_95 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), OnPieces_62, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
          Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[12])), Var_95);
          {
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_7, LHSVar_28, &LHSVarType_34);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Word Var_131 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Ctors_111, (MR_Integer) 1))));
