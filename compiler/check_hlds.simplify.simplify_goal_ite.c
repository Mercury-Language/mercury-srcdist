...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_ite_scalar_common_1[15][2] = {
  ...
  /* row   8 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[6])))
  },
  /* row   9 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  13 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[12]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[11])))
  },
  /* row  14 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 4U)),
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_31, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(3, Spec_77, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(1, OnPieces_61, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[9])));
              MR_hl_field(1, OnPieces_61, 1) = ((MR_Box) (Var_85));
            }
          }
          Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), OnPieces_61, (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
          Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[13])), Var_94);
          {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_64, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[1])));
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        *GoalExpr_18 = base;
        ...
        MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[14])));
    ...
    case (MR_Integer) 0:
      {
        ...
        Context_11 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_6);
        {
          ...
          MR_hl_field(3, Var_19, 1) = ((MR_Box) (Problem_8));
        }
        {
          Var_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_18, 0) = ((MR_Box) (Var_19));
          MR_hl_field(1, Var_18, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
        }
        {
          Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_12, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[5])));
        ...
        }
        {
          ...
          MR_hl_field(0, Var_33, 1) = ((MR_Box) (Pieces_12));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_13, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
          MR_hl_field(3, Spec_13, 4) = ((MR_Box) (Var_32));
        }
