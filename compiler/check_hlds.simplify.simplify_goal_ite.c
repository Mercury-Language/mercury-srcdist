          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_ite__V_104_104, 0) = ((MR_Box) (((MR_Integer) 40 | (((MR_Integer) 1 << (MR_Integer) 10)))));
          ...
          case (MR_Integer) 0:
            {
              ...
              *check_hlds__simplify__simplify_goal_ite__GoalInfo_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_ite__V_66_66, (MR_Integer) 1)));
              ...
              {
                check_hlds__simplify__simplify_goal_ite__SubGoalCalledProcs_82 = hlds__goal_util__goal_callees_1_f_0(check_hlds__simplify__simplify_goal_ite__Then0_22);
              }
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          *check_hlds__simplify__simplify_goal_ite__GoalInfo_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_ite__V_74_74, (MR_Integer) 1)));
          ...
          {
            check_hlds__simplify__simplify_goal_ite__SubGoalCalledProcs_33 = hlds__goal_util__goal_callees_1_f_0(check_hlds__simplify__simplify_goal_ite__Else0_23);
          }
          {
