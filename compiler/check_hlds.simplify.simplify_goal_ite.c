      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(2), Spec_31, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_neg\'/10"));
              MR_hl_field(MR_mktag(2), Spec_31, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 26) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
              MR_hl_field(MR_mktag(2), Spec_31, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(2), Spec_31, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
              MR_hl_field(MR_mktag(2), Spec_31, 4) = ((MR_Box) (Var_49));
            }
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                Spec_77 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Spec_77, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_neg\'/10"));
                MR_hl_field(MR_mktag(2), Spec_77, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 26) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
                MR_hl_field(MR_mktag(2), Spec_77, 2) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(2), Spec_77, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
                MR_hl_field(MR_mktag(2), Spec_77, 4) = ((MR_Box) (Var_62));
              }
...
{
  {
    ...
    hlds__instmap__merge_instmap_deltas_7_p_0(InstMap0_22, NonLocals_43, VarTypes_45, Var_74, &NewDelta_46, STATE_VARIABLE_ModuleInfo_73_73, &STATE_VARIABLE_ModuleInfo_75_75);
        ...
        case (MR_Integer) 1:
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_78_78, &VarSet_59);
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_92, 1) = ((MR_Box) (SwitchVarName_61));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), OnPieces_62, 1) = ((MR_Box) (Var_91));
              }
            }
            else
              OnPieces_62 = (MR_Word) ((MR_Unsigned) 0U);
            Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), OnPieces_62, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[8])));
            Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_ite_scalar_common_1[12])), Var_94);
            {
            ...
            {
              Spec_64 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.simplify_goal_ordinary_ite\'/13"));
              MR_hl_field(MR_mktag(2), Spec_64, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 52) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
              MR_hl_field(MR_mktag(2), Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 8U));
              MR_hl_field(MR_mktag(2), Spec_64, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[1])));
              MR_hl_field(MR_mktag(2), Spec_64, 4) = ((MR_Box) (Var_107));
            }
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_13, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_ite.maybe_warn_about_condition\'/5"));
            ...
            MR_hl_field(MR_mktag(2), Spec_13, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
            MR_hl_field(MR_mktag(2), Spec_13, 4) = ((MR_Box) (Var_32));
          }
