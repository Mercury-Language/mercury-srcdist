  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      Pieces_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[2])), Var_44);
      {
        ...
        MR_hl_field(0, Spec_31, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Pieces_88 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[2])), Var_63);
        {
          ...
          MR_hl_field(0, Spec_89, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              hlds__goal_list_util__goal_to_conj_list_2_p_0(Cond0_21, &CondGoals_83);
              hlds__goal_list_util__goal_to_conj_list_2_p_0(Then0_22, &ThenGoals_84);
        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__goal_list_util__goal_to_conj_list_2_p_0(Else0_23, &ElseList_45);
            {
            ...
            *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, Var_63, 1))));
            ...
            mercury__set__union_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_81, DeletedCallCallees0_80, &DeletedCallCallees_82);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__goal_list_util__goal_to_conj_list_2_p_0(Cond0_21, &CondGoals_29);
        hlds__goal_list_util__goal_to_conj_list_2_p_0(Then0_22, &ThenGoals_30);
        ...
        *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, Var_51, 1))));
        ...
        mercury__set__union_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_33, DeletedCallCallees0_32, &DeletedCallCallees_34);
      ...
      case (MR_Integer) 1:
        {
          ...
          Pieces_62 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[14])), Var_92);
          {
            ...
            MR_hl_field(0, Spec_64, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[2])));
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  ...
  if (succeeded)
  {
    ...
    Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_1[9])), Var_20);
    {
      ...
      MR_hl_field(0, Spec_13, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_ite_scalar_common_2[0])));
