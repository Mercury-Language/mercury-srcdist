        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) check_hlds__simplify__simplify_goal_ite__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word check_hlds__simplify__simplify_goal_ite__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_ite__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__simplify_goal_ite_scalar_common_1[0], check_hlds__simplify__simplify_goal_ite__HeadVar__1_1, ((MR_Box) (check_hlds__simplify__simplify_goal_ite__Var_13)), ((MR_Box) (check_hlds__simplify__simplify_goal_ite__Var_7)));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word check_hlds__simplify__simplify_goal_ite__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_ite__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word check_hlds__simplify__simplify_goal_ite__Var_6;
            ...
            if (check_hlds__simplify__simplify_goal_ite__succeeded)
              {
                check_hlds__simplify__simplify_goal_ite__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_ite__HeadVar__2_2, (MR_Integer) 0)));
                ...
                {
                  check_hlds__simplify__simplify_goal_ite__succeeded = mercury__builtin__unify_2_p_0(check_hlds__simplify__simplify_goal_ite__TypeInfo_11_11, ((MR_Box) (check_hlds__simplify__simplify_goal_ite__Var_5)), ((MR_Box) (check_hlds__simplify__simplify_goal_ite__Var_6)));
                }
              }
          }
          break;
