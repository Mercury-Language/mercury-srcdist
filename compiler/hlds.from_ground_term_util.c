...
MR_decl_label6(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0, 5,4,7,9,14,1)
...
MR_decl_label9(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0, 3,2,9,12,14,13,19,4,5)
...
MR_BEGIN_MODULE(hlds__from_ground_term_util_module6)
	...
	MR_init_label6(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,5,4,7,9,14,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__from_ground_term_util__fgt_build_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i14);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	{
	...
	if ((MR_tempr3 == MR_sv(3))) {
		MR_GOTO_LAB(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i5);
	}
	MR_sv(1) = MR_tempr3;
	MR_sv(2) = MR_r2;
	MR_sv(4) = MR_r3;
	MR_GOTO_LAB(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i4);
	}
MR_def_label(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,4)
	...
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i7);
	}
	if ((MR_sv(3) != MR_sv(1))) {
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_goal__hlds_goal_info_0_0,
		__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i9);
MR_def_label(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0_i1);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___hlds__from_ground_term_util__fgt_build_info_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(hlds__from_ground_term_util_module7)
	...
	MR_init_label9(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,3,2,9,12,14,13,19,4,5)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,2)
	...
	if ((MR_tempr2 == MR_tempr1)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i5);
	}
	MR_sv(3) = MR_tempr2;
	MR_sv(1) = MR_r2;
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i9);
	}
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i4);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
	}
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i12);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i14);
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i13);
	}
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i4);
	}
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___hlds__hlds_goal__hlds_goal_info_0_0,
		__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i19);
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0_i4);
	}
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___hlds__from_ground_term_util__fgt_build_info_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
...
void mercury__hlds__from_ground_term_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__from_ground_term_util);
