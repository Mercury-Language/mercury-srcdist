  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__18_18 = (MR_Word) (&hlds__from_ground_term_util_scalar_common_1[0]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__18_18, ((MR_Box) (ArgX2_11)), ((MR_Box) (ArgY2_12)));
        if (succeeded)
        {
          TypeInfo__19_19 = (MR_Word) (&hlds__from_ground_term_util_scalar_common_1[2]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__19_19, ((MR_Box) (ArgX3_13)), ((MR_Box) (ArgY3_14)));
        }
      }
    }
  }
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__21_21 = (MR_Word) (&hlds__from_ground_term_util_scalar_common_1[0]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__21_21, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
        if (succeeded)
        {
          TypeInfo__22_22 = (MR_Word) (&hlds__from_ground_term_util_scalar_common_1[2]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&hlds__from_ground_term_util_scalar_common_1[1]);
