  ...
  MR_Word * SubGoal_10)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_33_33 = (MR_Word) &hlds__from_ground_term_util_scalar_common_1[0];
    MR_Word TypeCtorInfo_34_34 = (MR_Word) &hlds__from_ground_term_util__hlds__from_ground_term_util__type_ctor_info_fgt_build_info_0;
    ...
    Var_21 = mercury__map__init_0_f_0(TypeInfo_33_33, TypeCtorInfo_34_34);
    hlds__from_ground_term_util__introduce_partial_fgt_scopes_loop_4_p_0(RevMarkedSubGoals_8, Order_9, Var_21, &BuildInfoMap_11);
    mercury__map__values_2_p_0(TypeInfo_33_33, TypeCtorInfo_34_34, BuildInfoMap_11, &BuildInfos_12);
    mercury__list__map_3_p_0(TypeCtorInfo_34_34, (MR_Word) &hlds__from_ground_term_util_scalar_common_1[1], (MR_Word) &hlds__from_ground_term_util_scalar_common_2[1], BuildInfos_12, &BuildGoalCords_13);
    TypeCtorInfo_38_38 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
    BuildGoalCord_14 = mercury__cord__cord_list_to_cord_1_f_0(TypeCtorInfo_38_38, BuildGoalCords_13);
    BuildGoals_15 = mercury__cord__list_1_f_0(TypeCtorInfo_38_38, BuildGoalCord_14);
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            VarGoals0_27 = mercury__cord__list_1_f_0(TypeCtorInfo_51_51, VarGoalCord0_21);
            {
            ...
            VarGoalCord_34 = mercury__cord__singleton_1_f_0(TypeCtorInfo_51_51, ((MR_Box) (ScopeGoal_33)));
          }
          else
            VarGoalCord_34 = VarGoalCord0_21;
        }
