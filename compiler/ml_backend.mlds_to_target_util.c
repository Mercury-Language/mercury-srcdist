...
ml_backend__mlds_to_target_util__record_scalar_inits_build_dep_graph_10_p_0(
  ...
  MR_Unsigned STATE_VARIABLE_RowNum_0_5,
  MR_Unsigned * STATE_VARIABLE_RowNum_6,
  ...
  MR_Word * STATE_VARIABLE_DepGraph_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned STATE_VARIABLE_RowNum_1_42;
      MR_Word _Key_32;
      MR_Word next_value_of_HeadVar__4_4;
      MR_Unsigned next_value_of_STATE_VARIABLE_RowNum_0_5;
      ...
      STATE_VARIABLE_RowNum_1_42 = (STATE_VARIABLE_RowNum_0_5 + (MR_Unsigned) 1U);
      // direct tailcall eliminated
      ;
  ...
  MR_Word * STATE_VARIABLE_DepGraph_22)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Rval_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ToScalar_37 = (MR_Word) (MR_body((MR_Word) (Rval_6), (MR_Integer) 1));

          mercury__digraph__add_vertices_and_edge_4_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_scalar_common_0), ((MR_Box) (FromScalar_5)), ((MR_Box) (ToScalar_37)), STATE_VARIABLE_DepGraph_0_21, STATE_VARIABLE_DepGraph_22);
        }
        break;
      case (MR_Integer) 2:
        {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Rval_6, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubRvalA_34 = ((MR_Word) ((MR_hl_field(3, Rval_6, 2))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word SubRvalA_35 = ((MR_Word) ((MR_hl_field(3, Rval_6, 2))));
          ...
          case (MR_Integer) 1:
            {
              ...
              PredIdNum_28 = hlds__pred_proc_id__pred_id_to_int_1_f_0(PredId_26);
              ProcIdNum_29 = hlds__pred_proc_id__proc_id_to_int_1_f_0(ProcId_27);
              mercury__io__write_string_4_p_0(Stream_9, IndentStr_11);
              mercury__io__write_string_4_p_0(Stream_9, SC_12);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "pred_id: ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), PredIdNum_28, &Var_123);
              mercury__io__write_string_4_p_0(Stream_9, Var_123);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", proc_id: ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), ProcIdNum_29, &Var_133);
              ...
              else
              {
                ...
                if (((MR_tag((MR_Word) PredLabel_35)) == (MR_Integer) 1))
                {
                  ...
                  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "/");
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), TypeArity_46, &Var_169);
                  mercury__io__write_string_4_p_0(Stream_9, Var_169);
                  mercury__io__write_string_4_p_0(Stream_9, EC_13);
                  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "\n");
                }
                else
                {
                  ...
                  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "/");
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), Arity_44, &Var_151);
                  mercury__io__write_string_4_p_0(Stream_9, Var_151);
                  mercury__io__write_string_4_p_0(Stream_9, EC_13);
                  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "\n");
                }
              }
