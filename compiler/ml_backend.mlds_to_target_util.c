  ...
  MR_Word * STATE_VARIABLE_Graph_19)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Rval_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ToScalar_29 = (MR_Word) MR_body(((MR_Word) Rval_6), (MR_Integer) 1);

          mercury__digraph__add_vertices_and_edge_4_p_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_scalar_common_0, ((MR_Box) (FromScalar_5)), ((MR_Box) (ToScalar_29)), STATE_VARIABLE_Graph_0_18, STATE_VARIABLE_Graph_19);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word next_value_of_Rval_6 = SubRvalA_31;
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word STATE_VARIABLE_Graph_23_23;
              MR_Word SubRvalA_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), Rval_6, (MR_Integer) 2)));
              ...
              ml_backend__mlds_to_target_util__add_scalar_deps_rval_4_p_0(FromScalar_5, SubRvalA_26, STATE_VARIABLE_Graph_0_18, &STATE_VARIABLE_Graph_23_23);
              // direct tailcall eliminated
              next_value_of_Rval_6 = SubRvalB_13;
              next_value_of_STATE_VARIABLE_Graph_0_18 = STATE_VARIABLE_Graph_23_23;
              Rval_6 = next_value_of_Rval_6;
