...
void MR_CALL 
ml_backend__mlds_to_target_util__maybe_output_pred_proc_id_comment_6_p_0(
  MR_Word Stream_7,
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Integer PredIdNum_14;
        MR_Integer ProcIdNum_15;
        MR_String Var_31;
        MR_String Var_41;

        hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_12, &PredIdNum_14);
        hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_13, &ProcIdNum_15);
        mercury__io__write_string_4_p_0(Stream_7, IndentStr_9);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "// pred_id: ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), PredIdNum_14, &Var_31);
        mercury__io__write_string_4_p_0(Stream_7, Var_31);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) ", proc_id: ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_3[0]), ProcIdNum_15, &Var_41);
