  ...
  top_of_proc_1:;
    {
      ...
      MR_Word * STATE_VARIABLE_CodeAddrsInConsts_45 = tscc_output_1_STATE_VARIABLE_CodeAddrsInConsts_45;
      MR_bool succeeded;
  ...
  top_of_proc_2:;
    {
      ...
      MR_Word * STATE_VARIABLE_CodeAddrsInConsts_8 = tscc_output_1_STATE_VARIABLE_CodeAddrsInConsts_45;
