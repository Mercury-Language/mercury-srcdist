  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&ml_backend__mlds_to_target_util_scalar_common_1[3]);
              ...
              switch (MR_tag((MR_Word) Default_21)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(Default_21)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      *STATE_VARIABLE_CodeAddrsInConsts_45 = STATE_VARIABLE_CodeAddrsInConsts_61_61;
                      break;
                    case (MR_Integer) 1:
                      *STATE_VARIABLE_CodeAddrsInConsts_45 = STATE_VARIABLE_CodeAddrsInConsts_61_61;
                      break;
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word next_value_of_STATE_VARIABLE_CodeAddrsInConsts_0_44 = STATE_VARIABLE_CodeAddrsInConsts_61_61;
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&ml_backend__mlds_to_target_util_scalar_common_6[1]));
    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&ml_backend__mlds_to_target_util_scalar_common_6[1]));
