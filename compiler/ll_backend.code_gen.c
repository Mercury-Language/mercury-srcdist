...
{
  {
    ...
    MR_Box ll_backend__code_gen__Var_6;

    if (ll_backend__code_gen__succeeded)
      {
        ll_backend__code_gen__Var_6 = (MR_hl_field(MR_mktag(1), ll_backend__code_gen__HeadVar__2_2, (MR_Integer) 0));
        (MR_hl_field(MR_mktag(1), ll_backend__code_gen__HeadVar__1_1, (MR_Integer) 0)) = ll_backend__code_gen__Var_6;
