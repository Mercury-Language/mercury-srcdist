...
{
  {
    ...
    ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_0_37, &ForwardLiveVarsBeforeGoal_17);
    ...
    ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_19, HasSubGoals_20, STATE_VARIABLE_CLD_0_37, &STATE_VARIABLE_CLD_46_46);
    ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_46_46, &InstMap_21);
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_18, GoalInfo_19, CodeModel_22, ForwardLiveVarsBeforeGoal_17, &GoalCode_23, STATE_VARIABLE_CI_0_35, STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_46_46, &STATE_VARIABLE_CLD_52_52);
      Features_24 = hlds__hlds_goal__goal_info_get_features_1_f_0(GoalInfo_19);
      ll_backend__code_info__get_proc_info_2_p_0(*STATE_VARIABLE_CI_36, &ProcInfo_25);
      ...
      if (succeeded)
      {
        ll_backend__code_info__get_proc_info_2_p_0(*STATE_VARIABLE_CI_36, &Var_85);
        succeeded = hlds__hlds_pred____Unify____proc_info_0_0(ProcInfo_25, Var_85);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_36, &Var_86);
            TypeCtorInfo_96_96 = (MR_Word) (&ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0);
            succeeded = ll_backend__code_gen____Unify______maybemaybe_1_1(TypeCtorInfo_96_96, Var_54, Var_86);
          }
        }
      }
      if (succeeded)
      {
        ...
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_55, &TipSaveCode_29, *STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_52_52, &STATE_VARIABLE_CLD_56_56);
      ...
      if (succeeded)
      {
        ...
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_31, &DeepSaveCode_32, *STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_56_56, &STATE_VARIABLE_CLD_59_59);
      ...
      ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_19, *STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_60_60, STATE_VARIABLE_CLD_38);
    }
    else
    {
      *Code_10 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
      *STATE_VARIABLE_CLD_38 = STATE_VARIABLE_CLD_46_46;
