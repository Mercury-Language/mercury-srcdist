...
MR_decl_label10(ll_backend__code_gen__generate_goal_2_7_0, 40,23,25,17,45,91,4,6,9,92)
MR_decl_label10(ll_backend__code_gen__generate_goal_2_7_0, 13,15,19,21,28,32,33,29,36,38)
...
MR_def_label(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0,2)
	...
	MR_tempr2 = MR_sv(1);
	MR_tempr3 = MR_tfield(0, MR_tfield(1, MR_tempr1, 0), 1);
...
MR_BEGIN_MODULE(ll_backend__code_gen_module2)
	...
	MR_init_label10(ll_backend__code_gen__generate_goal_2_7_0,40,23,25,17,45,91,4,6,9,92)
	MR_init_label10(ll_backend__code_gen__generate_goal_2_7_0,13,15,19,21,28,32,33,29,36,38)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__code_gen_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__code_gen__generate_goals_5_0);
