...
{
  {
    ...
    ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_19, HasSubGoals_20, STATE_VARIABLE_CLD_0_36, &STATE_VARIABLE_CLD_45_45);
    ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_45_45, &InstMap_21);
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_18, GoalInfo_19, CodeModel_22, ForwardLiveVarsBeforeGoal_17, &GoalCode_23, STATE_VARIABLE_CI_0_34, STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_45_45, &STATE_VARIABLE_CLD_51_51);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            CallTableVar_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallTableVar_26, (MR_Integer) 0))));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_53, 0) = NULL;
            }
            ...
            succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_94_94, Var_53, Var_84);
          }
        }
      }
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (CallTableVar_27));
          MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_54, &TipSaveCode_29, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_51_51, &STATE_VARIABLE_CLD_55_55);
      ...
      else
      {
        ...
        STATE_VARIABLE_CLD_55_55 = STATE_VARIABLE_CLD_51_51;
      }
      ...
      if (succeeded)
      {
        ...
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_31, &DeepSaveCode_32, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_55_55, &STATE_VARIABLE_CLD_58_58);
      ...
      else
      {
        *Code_10 = CodeUptoTip_30;
        STATE_VARIABLE_CLD_58_58 = STATE_VARIABLE_CLD_55_55;
      }
      ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_21, STATE_VARIABLE_CLD_58_58, &STATE_VARIABLE_CLD_59_59);
      ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_19, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_59_59, STATE_VARIABLE_CLD_37);
    }
    else
    {
      *Code_10 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
      *STATE_VARIABLE_CLD_37 = STATE_VARIABLE_CLD_45_45;
