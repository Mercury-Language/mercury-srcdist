...
MR_decl_label10(ll_backend__code_gen__generate_goal_2_7_0, 4,6,3,119,13,9,15,17,19,21)
MR_decl_label8(ll_backend__code_gen__generate_goal_2_7_0, 25,23,32,33,29,28,36,38)
MR_decl_label7(ll_backend__code_gen__generate_goals_6_0, 20,3,4,5,6,9,8)
...
MR_decl_static(ll_backend__code_gen__generate_goals_6_0)
...
MR_BEGIN_MODULE(ll_backend__code_gen_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__code_gen__generate_goal_2_7_0);
	MR_init_label10(ll_backend__code_gen__generate_goal_2_7_0,4,6,3,119,13,9,15,17,19,21)
	MR_init_label8(ll_backend__code_gen__generate_goal_2_7_0,25,23,32,33,29,28,36,38)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'generate_goal_2'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__code_gen__generate_goal_2_7_0)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i3);
	}
	MR_incr_sp(11);
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ll_backend.code_gen", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140ll_backend.code_gen.generate_goal_2\'/7", 49);
	MR_r3 = (MR_Word) MR_string_const("foreign code other than C", 25);
	MR_succip_word = MR_sv(11);
	MR_decr_sp(11);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i9);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(3, MR_r1, 1);
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i119);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ll_backend__par_conj_gen__generate_par_conj_6_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(2) = MR_r3;
	...
	MR_np_call_localret_ent(fn__cord__init_0_0,
		ll_backend__code_gen__generate_goal_2_7_0_i13);
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,13)
	...
	MR_succip_word = MR_sv(11);
	MR_decr_sp(11);
	MR_np_tailcall_ent(ll_backend__code_gen__generate_goals_6_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i15);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,15)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i17);
	}
	{
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,17)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i19);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i21);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i23);
	}
	MR_r6 = MR_tfield(1, MR_r1, 3);
	if (MR_INT_NE(MR_r6,2)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i25);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i28);
	}
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i29);
	}
	...
	MR_np_call_localret_ent(ll_backend__unify_gen__generate_ground_term_4_0,
		ll_backend__code_gen__generate_goal_2_7_0_i32);
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
		ll_backend__code_gen__generate_goal_2_7_0_i33);
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i36);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,36)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i38);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__code_gen_module3)
	MR_init_entry1(ll_backend__code_gen__generate_goals_6_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__code_gen__generate_goals_6_0);
	MR_init_label7(ll_backend__code_gen__generate_goals_6_0,20,3,4,5,6,9,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'generate_goals'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__code_gen__generate_goals_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(ll_backend__code_gen__generate_goals_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goals_6_0_i3);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_decr_sp_and_return(5);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	...
	MR_np_call_localret_ent(ll_backend__code_gen__generate_goal_5_0,
		ll_backend__code_gen__generate_goals_6_0_i4);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__code_gen__generate_goals_6_0_i5);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(ll_backend__code_info__get_instmap_2_0,
		ll_backend__code_gen__generate_goals_6_0_i6);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__instmap__instmap_is_unreachable_1_0,
		ll_backend__code_gen__generate_goals_6_0_i9);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goals_6_0_i8);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(2);
	MR_decr_sp_and_return(5);
MR_def_label(ll_backend__code_gen__generate_goals_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
	...
	MR_GOTO_LAB(ll_backend__code_gen__generate_goals_6_0_i20);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
