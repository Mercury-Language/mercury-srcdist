...
MR_decl_label10(ll_backend__code_gen__generate_goal_2_7_0, 4,6,3,133,13,9,15,17,19,21)
MR_decl_label8(ll_backend__code_gen__generate_goal_2_7_0, 25,23,32,33,29,28,36,38)
MR_decl_label6(ll_backend__code_gen__generate_goals_5_0, 31,4,5,8,7,11)
...
MR_BEGIN_MODULE(ll_backend__code_gen_module2)
	...
	MR_init_label10(ll_backend__code_gen__generate_goal_2_7_0,4,6,3,133,13,9,15,17,19,21)
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,3)
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i133);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ll_backend__par_conj_gen__generate_par_conj_6_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,133)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_r1 = MR_tfield(3, MR_r1, 2);
...
MR_BEGIN_MODULE(ll_backend__code_gen_module3)
	...
	MR_init_label6(ll_backend__code_gen__generate_goals_5_0,31,4,5,8,7,11)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__code_gen__generate_goals_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goals_5_0_i31);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ll_backend__code_gen__generate_goals_5_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
