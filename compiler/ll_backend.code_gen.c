...
MR_decl_label10(ll_backend__code_gen__generate_goal_expr_7_0, 4,6,3,128,13,9,15,17,19,21)
MR_decl_label9(ll_backend__code_gen__generate_goal_expr_7_0, 25,23,32,33,29,34,28,40,42)
MR_decl_label8(ll_backend__code_gen__generate_goals_8_0, 34,3,5,6,7,10,9,4)
MR_decl_label6(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0, 2,6,8,11,7,3)
...
MR_BEGIN_MODULE(ll_backend__code_gen_module0)
	...
	MR_init_label6(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0,2,6,8,11,7,3)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0,6)
	...
	MR_np_call_localret_ent(map__search_3_0,
		fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0_i8);
MR_def_label(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0_i7);
	}
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0_i11);
	}
...
MR_def_label(fn__ll_backend__code_gen__compute_deep_save_excp_vars_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_decl_entry(ll_backend__call_gen__generate_generic_call_10_0);
...
MR_decl_entry(ll_backend__par_conj_gen__generate_lc_spawn_off_7_0);
...
MR_BEGIN_MODULE(ll_backend__code_gen_module2)
	...
	MR_init_label10(ll_backend__code_gen__generate_goal_expr_7_0,4,6,3,128,13,9,15,17,19,21)
	MR_init_label9(ll_backend__code_gen__generate_goal_expr_7_0,25,23,32,33,29,34,28,40,42)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,3)
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_expr_7_0_i128);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ll_backend__par_conj_gen__generate_par_conj_6_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,128)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,15)
	...
	MR_r7 = MR_tempr2;
	MR_r8 = MR_tempr3;
	MR_np_tailcall_ent(ll_backend__call_gen__generate_generic_call_10_0);
	}
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,29)
	...
	if (MR_RTAGS_TESTR(MR_r7,3,6)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_expr_7_0_i34);
	}
	MR_r1 = MR_r6;
	{
	MR_Word MR_tempr1;
	...
	MR_r3 = MR_tfield(3, MR_tempr1, 2);
	MR_r4 = MR_tfield(3, MR_tempr1, 3);
	MR_np_tailcall_ent(ll_backend__par_conj_gen__generate_lc_spawn_off_7_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r7;
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,28)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_expr_7_0_i40);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_expr_7_0_i42);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__code_gen__generate_goal_expr_7_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ll_backend.code_gen", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140ll_backend.code_gen.generate_goal_expr\'/7", 52);
...
void mercury__ll_backend__code_gen__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__code_gen);
