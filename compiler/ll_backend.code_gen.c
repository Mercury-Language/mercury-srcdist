    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (ll_backend__code_gen__succeeded)
        {
          ...
          {
            MR_Integer ll_backend__code_gen__Var_42 = (ll_backend__code_gen__N_2 - (MR_Integer) 1);

            /* direct tailcall eliminated */
            {
              MR_Word ll_backend__code_gen__next_value_of_HeadVar__1_1 = ll_backend__code_gen__Goals_23;
              MR_Integer ll_backend__code_gen__next_value_of_N_2 = ll_backend__code_gen__Var_42;
              MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_Code_0_5 = ll_backend__code_gen__STATE_VARIABLE_Code_41_41;
              MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_CI_0_7 = ll_backend__code_gen__STATE_VARIABLE_CI_39_39;
              MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_CLD_0_9 = ll_backend__code_gen__STATE_VARIABLE_CLD_40_40;

              ll_backend__code_gen__HeadVar__1_1 = ll_backend__code_gen__next_value_of_HeadVar__1_1;
              ll_backend__code_gen__N_2 = ll_backend__code_gen__next_value_of_N_2;
              ll_backend__code_gen__STATE_VARIABLE_Code_0_5 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_Code_0_5;
              ll_backend__code_gen__STATE_VARIABLE_CI_0_7 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_CI_0_7;
              ll_backend__code_gen__STATE_VARIABLE_CLD_0_9 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_CLD_0_9;
            }
            continue;
          }
        }
  ...
  MR_Word * ll_backend__code_gen__STATE_VARIABLE_CLD_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word ll_backend__code_gen__next_value_of_HeadVar__1_1 = ll_backend__code_gen__LeftOverGoals_26;
        MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_Code_0_3 = ll_backend__code_gen__STATE_VARIABLE_Code_34_34;
        MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_CI_0_5 = ll_backend__code_gen__STATE_VARIABLE_CI_35_35;
        MR_Word ll_backend__code_gen__next_value_of_STATE_VARIABLE_CLD_0_7 = ll_backend__code_gen__STATE_VARIABLE_CLD_36_36;

        ll_backend__code_gen__HeadVar__1_1 = ll_backend__code_gen__next_value_of_HeadVar__1_1;
        ll_backend__code_gen__STATE_VARIABLE_Code_0_3 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_Code_0_3;
        ll_backend__code_gen__STATE_VARIABLE_CI_0_5 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_CI_0_5;
        ll_backend__code_gen__STATE_VARIABLE_CLD_0_7 = ll_backend__code_gen__next_value_of_STATE_VARIABLE_CLD_0_7;
      }
      continue;
    }
    break;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ll_backend__code_gen__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 0)));
          MR_Word ll_backend__code_gen__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 1)));
          MR_Word ll_backend__code_gen__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 2)));
          MR_Word ll_backend__code_gen__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 4)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ll_backend__code_gen__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(2), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 4)));
          MR_Word ll_backend__code_gen__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(2), ll_backend__code_gen__GoalExpr_10, (MR_Integer) 5)));
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ll_backend__code_gen__ConjType_22) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word ll_backend__code_gen__Var_89;

                    ll_backend__code_gen__Var_89 = mercury__cord__init_0_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                    ll_backend__code_gen__generate_conj_8_p_0(ll_backend__code_gen__Goals_23, ll_backend__code_gen__CodeModel_12, ll_backend__code_gen__Var_89, ll_backend__code_gen__Code_14, ll_backend__code_gen__STATE_VARIABLE_CI_0_54, ll_backend__code_gen__STATE_VARIABLE_CI_55, ll_backend__code_gen__STATE_VARIABLE_CLD_0_56, ll_backend__code_gen__STATE_VARIABLE_CLD_57);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word ll_backend__code_gen__Var_72;
              ...
              if (ll_backend__code_gen__succeeded)
              {
                ...
                ll_backend__code_gen__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_gen__Reason_32, (MR_Integer) 2)));
                ll_backend__code_gen__succeeded = (ll_backend__code_gen__Var_72 == (MR_Integer) 1);
              }
              if (ll_backend__code_gen__succeeded)
              {
...
{
  {
    ...
    if (ll_backend__code_gen__succeeded)
    {
      ...
      MR_Word ll_backend__code_gen__Var_54;
      MR_Word ll_backend__code_gen__Var_83;
      MR_Word ll_backend__code_gen__Var_84;
      MR_Word ll_backend__code_gen__Var_28;
      ...
      if (ll_backend__code_gen__succeeded)
      {
        ll_backend__code_info__get_proc_info_2_p_0(*ll_backend__code_gen__STATE_VARIABLE_CI_35, &ll_backend__code_gen__Var_83);
        ll_backend__code_gen__succeeded = hlds__hlds_pred____Unify____proc_info_0_0(ll_backend__code_gen__ProcInfo_25, ll_backend__code_gen__Var_83);
        if (ll_backend__code_gen__succeeded)
        {
          ...
          if (ll_backend__code_gen__succeeded)
          {
            ...
            {
              ll_backend__code_gen__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_54, 0) = NULL;
            }
            ll_backend__code_info__get_maybe_trace_info_2_p_0(*ll_backend__code_gen__STATE_VARIABLE_CI_35, &ll_backend__code_gen__Var_84);
            ...
            ll_backend__code_gen__succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(ll_backend__code_gen__TypeCtorInfo_94_94, ll_backend__code_gen__Var_54, ll_backend__code_gen__Var_84);
          }
        }
      }
      if (ll_backend__code_gen__succeeded)
      {
        ...
        MR_Word ll_backend__code_gen__Var_55;

        {
          ll_backend__code_gen__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_55, 0) = ((MR_Box) (ll_backend__code_gen__CallTableVar_27));
          MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(ll_backend__code_gen__Var_55, &ll_backend__code_gen__TipSaveCode_29, *ll_backend__code_gen__STATE_VARIABLE_CI_35, ll_backend__code_gen__STATE_VARIABLE_CLD_52_52, &ll_backend__code_gen__STATE_VARIABLE_CLD_56_56);
...
{
  {
    ...
    MR_Box ll_backend__code_gen__ArgX1_5;

    if (ll_backend__code_gen__succeeded)
    {
      ll_backend__code_gen__ArgX1_5 = (MR_hl_field(MR_mktag(1), ll_backend__code_gen__HeadVar__2_2, (MR_Integer) 0));
      (MR_hl_field(MR_mktag(1), ll_backend__code_gen__HeadVar__1_1, (MR_Integer) 0)) = ll_backend__code_gen__ArgX1_5;
...
{
  {
    ...
    MR_Word ll_backend__code_gen__Var_24;
    MR_Word ll_backend__code_gen__Var_25;
    ...
    if (ll_backend__code_gen__succeeded)
    {
      ...
      ll_backend__code_gen__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__code_gen__DeepProfInfo_6, (MR_Integer) 0)));
      ll_backend__code_gen__MaybeDeepLayout_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__code_gen__DeepProfInfo_6, (MR_Integer) 1)));
      ll_backend__code_gen__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__code_gen__DeepProfInfo_6, (MR_Integer) 2)));
    ...
    if (ll_backend__code_gen__succeeded)
    {
      ...
      MR_Word ll_backend__code_gen__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__code_gen__DeepLayout_8, (MR_Integer) 0)));
      MR_Word ll_backend__code_gen__Var_14;
      MR_Box ll_backend__code_gen__conv0_Var_14;

      hlds__hlds_pred__proc_info_get_stack_slots_2_p_0(ll_backend__code_gen__ProcInfo_3, &ll_backend__code_gen__StackSlots_13);
      ll_backend__code_gen__succeeded = mercury__map__search_3_p_0((MR_Word) &ll_backend__code_gen_scalar_common_1[0], (MR_Word) &hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_stack_slot_0, ll_backend__code_gen__StackSlots_13, ((MR_Box) (ll_backend__code_gen__TopCSDVar_10)), &ll_backend__code_gen__conv0_Var_14);
      if (ll_backend__code_gen__succeeded)
      {
        ll_backend__code_gen__Var_14 = ((MR_Word) ll_backend__code_gen__conv0_Var_14);
        ll_backend__code_gen__succeeded = MR_TRUE;
      }
      if (ll_backend__code_gen__succeeded)
        if ((ll_backend__code_gen__MaybeOldOutermostVar_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word ll_backend__code_gen__Var_16;

          {
            ll_backend__code_gen__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_16, 0) = ((MR_Box) (ll_backend__code_gen__MiddleCSDVar_11));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_16, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__DeepSaveVars_4, 1) = ((MR_Box) (ll_backend__code_gen__Var_16));
          }
        }
        else
        {
          ...
          MR_Word ll_backend__code_gen__Var_18;
          MR_Word ll_backend__code_gen__Var_19;

          {
            ll_backend__code_gen__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_19, 0) = ((MR_Box) (ll_backend__code_gen__OldOutermostVar_15));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ll_backend__code_gen__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_18, 0) = ((MR_Box) (ll_backend__code_gen__MiddleCSDVar_11));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__Var_18, 1) = ((MR_Box) (ll_backend__code_gen__Var_19));
          }
          {
            ll_backend__code_gen__DeepSaveVars_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__DeepSaveVars_4, 0) = ((MR_Box) (ll_backend__code_gen__TopCSDVar_10));
            MR_hl_field(MR_mktag(1), ll_backend__code_gen__DeepSaveVars_4, 1) = ((MR_Box) (ll_backend__code_gen__Var_18));
          }
        }
      else
