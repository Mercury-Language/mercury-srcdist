...
MR_decl_label8(ll_backend__code_gen__generate_goal_5_0, 27,28,30,32,35,36,24,37)
MR_decl_label8(ll_backend__code_gen__generate_goal_5_0, 39,41,42,43,38,45,46,7)
MR_decl_label1(ll_backend__code_gen__generate_goal_5_0, 47)
MR_decl_label8(ll_backend__code_gen__generate_goal_2_7_0, 40,23,25,17,45,91,4,6)
MR_decl_label8(ll_backend__code_gen__generate_goal_2_7_0, 9,92,13,15,19,21,28,32)
MR_decl_label4(ll_backend__code_gen__generate_goal_2_7_0, 33,29,36,38)
MR_decl_label6(ll_backend__code_gen__generate_goals_5_0, 25,4,5,8,7,11)
...
MR_BEGIN_MODULE(ll_backend__code_gen_module1)
	...
	MR_init_label8(ll_backend__code_gen__generate_goal_5_0,27,28,30,32,35,36,24,37)
	MR_init_label8(ll_backend__code_gen__generate_goal_5_0,39,41,42,43,38,45,46,7)
	MR_init_label1(ll_backend__code_gen__generate_goal_5_0,47)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__code_gen_module2)
	...
	MR_init_label8(ll_backend__code_gen__generate_goal_2_7_0,40,23,25,17,45,91,4,6)
	MR_init_label8(ll_backend__code_gen__generate_goal_2_7_0,9,92,13,15,19,21,28,32)
	MR_init_label4(ll_backend__code_gen__generate_goal_2_7_0,33,29,36,38)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__code_gen__generate_goal_2_7_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i23) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i17) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i45));
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i91) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i9) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i15) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i38) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i21) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i19) MR_AND
		MR_LABEL_AP(ll_backend__code_gen__generate_goal_2_7_0_i36));
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,9)
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goal_2_7_0_i92);
	}
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ll_backend__par_conj_gen__generate_par_conj_6_0);
	}
MR_def_label(ll_backend__code_gen__generate_goal_2_7_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_r2 = MR_r3;
	MR_r3 = MR_r5;
	MR_np_call_localret_ent(ll_backend__code_gen__generate_goals_5_0,
...
MR_BEGIN_MODULE(ll_backend__code_gen_module3)
	...
	MR_init_label6(ll_backend__code_gen__generate_goals_5_0,25,4,5,8,7,11)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'generate_goals'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__code_gen__generate_goals_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__code_gen__generate_goals_5_0_i25);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ll_backend__code_gen__generate_goals_5_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_def_label(ll_backend__code_gen__generate_goals_5_0,7)
	...
	MR_np_localcall_lab(ll_backend__code_gen__generate_goals_5_0,
		ll_backend__code_gen__generate_goals_5_0_i11);
MR_def_label(ll_backend__code_gen__generate_goals_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
