    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        CallTableVar_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallTableVar_28, (MR_Integer) 0))));
        {
          ...
          MR_hl_field(MR_mktag(1), Var_56, 0) = NULL;
        }
        ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_37, &Var_105);
        TypeCtorInfo_114_114 = (MR_Word) (&ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0);
        succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_114_114, Var_56, Var_105);
      }
    }
    if (succeeded)
    {
