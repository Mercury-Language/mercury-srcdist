      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 5)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2)));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 3)));
