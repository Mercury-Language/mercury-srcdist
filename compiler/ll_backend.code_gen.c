          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_32)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
              ...
              else
              {
                ...
                succeeded = ((((MR_tag((MR_Word) Reason_32)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 0))) == (MR_Integer) 8)));
                if (succeeded)
                {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeCallTableVar_26)) == (MR_Integer) 1);
          if (succeeded)
          {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_53, 1) = ((MR_Box) ((MR_Integer) 0));
        }
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeDeepProfInfo_5)) == (MR_Integer) 1);
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeDeepLayout_7)) == (MR_Integer) 1);
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        succeeded = MR_TRUE;
      if (succeeded)
        if ((MaybeOldOutermostVar_12 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Var_16;
        ...
        DeepSaveVars_4 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
