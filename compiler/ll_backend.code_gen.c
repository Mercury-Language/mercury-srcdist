...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr_10)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Goal_24 = (MR_Word) MR_body(((MR_Word) GoalExpr_10), (MR_Integer) 0);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_10, (MR_Integer) 0)));
          MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_10, (MR_Integer) 1)));
          MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_10, (MR_Integer) 2)));
          MR_Word Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_10, (MR_Integer) 4)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word BuiltinState_45 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 3)));
          MR_Word Args_95 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 2)));
          MR_Word Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 4)));
          MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 5)));

          switch (BuiltinState_45) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              ll_backend__call_gen__generate_builtin_9_p_0(CodeModel_12, PredId_43, ProcId_44, Args_95, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
              break;
            case (MR_Integer) 1:
              ll_backend__call_gen__generate_call_10_p_0(CodeModel_12, PredId_43, ProcId_44, Args_95, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
              break;
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Det_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 5)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Lang_52;
              MR_Word Args_96 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 4)));
              MR_Word PredId_97 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
              MR_Integer ProcId_98 = ((MR_Integer) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 3)));

              Lang_52 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attributes_48);
              switch (Lang_52) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  ll_backend__pragma_c_gen__generate_foreign_proc_code_14_p_0(CodeModel_12, Attributes_48, PredId_97, ProcId_98, Args_96, ExtraArgs_49, MaybeTraceRuntimeCond_50, PragmaCode_51, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
                  break;
                case (MR_Integer) 1:
                case (MR_Integer) 3:
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    Var_89 = mercury__cord__init_0_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                    ll_backend__code_gen__generate_conj_8_p_0(Goals_23, CodeModel_12, Var_89, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_94 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));

              ll_backend__disj_gen__generate_disj_8_p_0(CodeModel_12, Goals_94, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
            }
            break;
          case (MR_Integer) 4:
            {
              MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
              MR_Word CanFail_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2)));
                succeeded = (Var_72 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                ll_backend__unify_gen__generate_ground_term_6_p_0(TermVar_34, SubGoal_33, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
              ...
              else
              {
                ...
                succeeded = ((((MR_tag((MR_Word) Reason_32)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 0)))) == (MR_Integer) 8)));
                if (succeeded)
                {
                  ...
                  UseParentStack_37 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 3)));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word _Vars_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer Var_42 = (N_2 - (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_CLD_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = LeftOverGoals_26;
        MR_Word next_value_of_STATE_VARIABLE_Code_0_3 = STATE_VARIABLE_Code_34_34;
        MR_Word next_value_of_STATE_VARIABLE_CI_0_5 = STATE_VARIABLE_CI_35_35;
        MR_Word next_value_of_STATE_VARIABLE_CLD_0_7 = STATE_VARIABLE_CLD_36_36;
  ...
  MR_Word * STATE_VARIABLE_CLD_37)
{
  {
    MR_bool succeeded;
    MR_Word ForwardLiveVarsBeforeGoal_17;
    MR_Word GoalExpr_18;
    MR_Word GoalInfo_19;
    MR_Word HasSubGoals_20;
    MR_Word InstMap_21;
    MR_Word STATE_VARIABLE_CLD_44_44;

    ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_0_36, &ForwardLiveVarsBeforeGoal_17);
    GoalExpr_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 0)));
    GoalInfo_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 1)));
    HasSubGoals_20 = hlds__goal_form__goal_expr_has_subgoals_1_f_0(GoalExpr_18);
    ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_19, HasSubGoals_20, STATE_VARIABLE_CLD_0_36, &STATE_VARIABLE_CLD_44_44);
    ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_44_44, &InstMap_21);
    succeeded = hlds__instmap__instmap_is_reachable_1_p_0(InstMap_21);
    if (succeeded)
    {
      ...
      MR_Word CallTableVar_27;
      MR_Word TypeCtorInfo_94_94;
      MR_Word MaybeCallTableVar_26;
      MR_Word Var_54;
      MR_Word Var_83;
      MR_Word Var_84;
      MR_Word Var_28;

      CodeModel_22 = hlds__code_model__goal_info_get_code_model_1_f_0(GoalInfo_19);
      switch (CodeModel_22) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
      ...
      ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_18, GoalInfo_19, CodeModel_22, ForwardLiveVarsBeforeGoal_17, &GoalCode_23, STATE_VARIABLE_CI_0_34, STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_44_44, &STATE_VARIABLE_CLD_52_52);
      Features_24 = hlds__hlds_goal__goal_info_get_features_1_f_0(GoalInfo_19);
      ll_backend__code_info__get_proc_info_2_p_0(*STATE_VARIABLE_CI_35, &ProcInfo_25);
      succeeded = mercury__set__member_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_goal_feature_0, ((MR_Box) ((MR_Integer) 5)), Features_24);
      if (succeeded)
      {
        ll_backend__code_info__get_proc_info_2_p_0(*STATE_VARIABLE_CI_35, &Var_83);
        succeeded = hlds__hlds_pred____Unify____proc_info_0_0(ProcInfo_25, Var_83);
        if (succeeded)
        {
          hlds__hlds_pred__proc_info_get_call_table_tip_2_p_0(ProcInfo_25, &MaybeCallTableVar_26);
          succeeded = ((MR_tag((MR_Word) MaybeCallTableVar_26)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            CallTableVar_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeCallTableVar_26, (MR_Integer) 0)));
            {
              Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_54, 0) = NULL;
            }
            ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_35, &Var_84);
            TypeCtorInfo_94_94 = (MR_Word) &ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0;
            succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_94_94, Var_54, Var_84);
          }
        }
      }
      if (succeeded)
      {
        MR_Word TipSaveCode_29;
        MR_Word Var_55;

        {
          Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (CallTableVar_27));
          MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_55, &TipSaveCode_29, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_52_52, &STATE_VARIABLE_CLD_56_56);
        CodeUptoTip_30 = mercury__cord__f_43_43_2_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, GoalCode_23, TipSaveCode_29);
      }
      else
      {
        CodeUptoTip_30 = GoalCode_23;
        STATE_VARIABLE_CLD_56_56 = STATE_VARIABLE_CLD_52_52;
      }
      succeeded = mercury__set__member_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_goal_feature_0, ((MR_Box) ((MR_Integer) 7)), Features_24);
      if (succeeded)
      {
        MR_Word DeepSaveVars_31;
        MR_Word DeepSaveCode_32;

        DeepSaveVars_31 = ll_backend__code_gen__compute_deep_save_excp_vars_1_f_0(ProcInfo_25);
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_31, &DeepSaveCode_32, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_56_56, &STATE_VARIABLE_CLD_59_59);
        *Code_10 = mercury__cord__f_43_43_2_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, CodeUptoTip_30, DeepSaveCode_32);
      }
      else
      {
        *Code_10 = CodeUptoTip_30;
        STATE_VARIABLE_CLD_59_59 = STATE_VARIABLE_CLD_56_56;
      }
      ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_21, STATE_VARIABLE_CLD_59_59, &STATE_VARIABLE_CLD_60_60);
      ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_19, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_60_60, STATE_VARIABLE_CLD_37);
    }
    else
    {
      *Code_10 = mercury__cord__empty_0_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
      *STATE_VARIABLE_CLD_37 = STATE_VARIABLE_CLD_44_44;
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeDeepProfInfo_5)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      DeepProfInfo_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeDeepProfInfo_5, (MR_Integer) 0)));
      Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 0)));
      MaybeDeepLayout_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 1)));
      Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 2)));
      succeeded = ((MR_tag((MR_Word) MaybeDeepLayout_7)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), DeepLayout_8, (MR_Integer) 0)));
      MR_Word Var_14;
      MR_Box conv0_Var_14;
      ...
      if (succeeded)
        if ((MaybeOldOutermostVar_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word Var_16;
          ...
          {
            DeepSaveVars_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        DeepSaveVars_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    }
    else
    {
