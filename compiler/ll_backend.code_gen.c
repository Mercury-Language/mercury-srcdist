  ...
  switch (MR_tag((MR_Word) GoalExpr_10)) {
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BuiltinState_45 = ((MR_Unsigned) ((MR_hl_field(2, GoalExpr_10, (MR_Integer) 3))) & (MR_Integer) 1);
        MR_Word Args_93 = ((MR_Word) ((MR_hl_field(2, GoalExpr_10, (MR_Integer) 2))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Attributes_48 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 1))));
            MR_Word ExtraArgs_49 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 5))));
            MR_Word MaybeTraceRuntimeCond_50 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 6))));
            MR_Word PragmaCode_51 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 7))));
            MR_Word Lang_52;
            ...
            switch (Lang_52) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                ll_backend__pragma_c_gen__generate_code_for_foreign_proc_14_p_0(CodeModel_12, Attributes_48, PredId_95, ProcId_96, Args_94, ExtraArgs_49, MaybeTraceRuntimeCond_50, PragmaCode_51, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
                break;
              case (MR_Integer) 1:
              case (MR_Integer) 2:
                {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  ll_backend__code_gen__generate_conj_8_p_0(Goals_23, CodeModel_12, Var_60, Code_14, STATE_VARIABLE_CI_0_54, STATE_VARIABLE_CI_55, STATE_VARIABLE_CLD_0_56, STATE_VARIABLE_CLD_57);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 3:
          {
            MR_Word Goals_92 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, (MR_Integer) 1))));
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              Var_73 = ((MR_Unsigned) ((MR_hl_field(3, Reason_32, (MR_Integer) 2))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_CLD_38)
{
  MR_bool succeeded;
  MR_Word ProcInfo_13;
  MR_Word ForwardLiveVarsBeforeGoal_19;
  MR_Word GoalExpr_20;
  MR_Word GoalInfo_21;
  MR_Word HasSubGoals_22;
  MR_Word InstMap_23;
  MR_Word STATE_VARIABLE_CLD_47_47;

  ll_backend__code_info__get_proc_info_2_p_0(STATE_VARIABLE_CI_0_35, &ProcInfo_13);
  ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_0_37, &ForwardLiveVarsBeforeGoal_19);
  GoalExpr_20 = ((MR_Word) ((MR_hl_field(0, Goal_9, (MR_Integer) 0))));
  GoalInfo_21 = ((MR_Word) ((MR_hl_field(0, Goal_9, (MR_Integer) 1))));
  HasSubGoals_22 = hlds__goal_form__goal_expr_has_subgoals_1_f_0(GoalExpr_20);
  ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_21, HasSubGoals_22, STATE_VARIABLE_CLD_0_37, &STATE_VARIABLE_CLD_47_47);
  ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_47_47, &InstMap_23);
  succeeded = hlds__instmap__instmap_is_reachable_1_p_0(InstMap_23);
  if (succeeded)
  {
    ...
    CodeModel_24 = hlds__code_model__goal_info_get_code_model_1_f_0(GoalInfo_21);
    switch (CodeModel_24) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_20, GoalInfo_21, CodeModel_24, ForwardLiveVarsBeforeGoal_19, &GoalCode_25, STATE_VARIABLE_CI_0_35, STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_47_47, &STATE_VARIABLE_CLD_53_53);
    Features_26 = hlds__hlds_goal__goal_info_get_features_1_f_0(GoalInfo_21);
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 5)), Features_26);
    if (succeeded)
    {
      hlds__hlds_pred__proc_info_get_call_table_tip_2_p_0(ProcInfo_13, &MaybeCallTableVar_27);
      succeeded = (MaybeCallTableVar_27 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        CallTableVar_28 = ((MR_Word) ((MR_hl_field(1, MaybeCallTableVar_27, (MR_Integer) 0))));
        ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_36, &Var_91);
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(1, Var_56, 0) = ((MR_Box) (CallTableVar_28));
      ...
      CodeUptoTip_31 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), GoalCode_25, TipSaveCode_30);
    }
    else
    {
      CodeUptoTip_31 = GoalCode_25;
      STATE_VARIABLE_CLD_57_57 = STATE_VARIABLE_CLD_53_53;
    }
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 7)), Features_26);
    if (succeeded)
    {
      MR_Word DeepSaveVars_32;
      MR_Word DeepSaveCode_33;

      DeepSaveVars_32 = ll_backend__code_gen__compute_deep_save_excp_vars_1_f_0(ProcInfo_13);
    ...
    ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_23, STATE_VARIABLE_CLD_60_60, &STATE_VARIABLE_CLD_61_61);
    ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_21, *STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_61_61, STATE_VARIABLE_CLD_38);
  }
  else
  {
