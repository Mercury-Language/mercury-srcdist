  ...
  MR_Word * STATE_VARIABLE_CLD_58)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr_10)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Uni_20 = ((MR_Word) ((MR_hl_field(1, GoalExpr_10, 3))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word PredId_43 = ((MR_Word) ((MR_hl_field(2, GoalExpr_10, 0))));
        MR_Integer ProcId_44 = ((MR_Integer) ((MR_hl_field(2, GoalExpr_10, 1))));
        MR_Word ArgVars_45 = ((MR_Word) ((MR_hl_field(2, GoalExpr_10, 2))));
        MR_Word BuiltinState_46 = ((MR_Unsigned) ((MR_hl_field(2, GoalExpr_10, 3))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_10, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word GenericCall_38 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
            MR_Word Args_39 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 2))));
            MR_Word Modes_40 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 3))));
            MR_Word MaybeRegTypes_41 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 4))));
            MR_Word Det_42 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr_10, 5))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 1:
          {
            MR_Word Attributes_49 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
            MR_Word ExtraArgs_50 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 5))));
            MR_Word MaybeTraceRuntimeCond_51 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 6))));
            MR_Word PragmaCode_52 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 7))));
            MR_Word Lang_53;
            MR_Word Args_94 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 4))));
            MR_Word PredId_95 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 2))));
            MR_Integer ProcId_96 = ((MR_Integer) ((MR_hl_field(3, GoalExpr_10, 3))));

            Lang_53 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attributes_49);
            switch (Lang_53) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                ll_backend__foreign_proc_gen__generate_code_for_foreign_proc_14_p_0(CodeModel_12, Attributes_49, PredId_95, ProcId_96, Args_94, ExtraArgs_50, MaybeTraceRuntimeCond_51, PragmaCode_52, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_55, STATE_VARIABLE_CI_56, STATE_VARIABLE_CLD_0_57, STATE_VARIABLE_CLD_58);
                break;
              case (MR_Integer) 1:
              case (MR_Integer) 2:
                {
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_22 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr_10, 1))) & (MR_Integer) 1);
            MR_Word Goals_23 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 2))));
        ...
        case (MR_Integer) 3:
          {
            MR_Word Goals_93 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
        ...
        case (MR_Integer) 4:
          {
            MR_Word Var_29 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
            MR_Word CanFail_30 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr_10, 2))) & (MR_Integer) 1);
            MR_Word CaseList_31 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 3))));
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_32 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
            MR_Word SubGoal_33 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 2))));
            MR_Word TermVar_34;
            MR_Word Var_74;
            ...
            if (succeeded)
            {
              ...
              Var_74 = ((MR_Unsigned) ((MR_hl_field(3, Reason_32, 2))) & (MR_Integer) 3);
            ...
            else
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_32)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason_32, 0)))) == (MR_Integer) 8)));
              if (succeeded)
              {
                LCVar_35 = ((MR_Word) ((MR_hl_field(3, Reason_32, 1))));
                LCSVar_36 = ((MR_Word) ((MR_hl_field(3, Reason_32, 2))));
                UseParentStack_37 = ((MR_Unsigned) ((MR_hl_field(3, Reason_32, 3))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 6:
          {
            MR_Word Cond_26 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 2))));
            MR_Word Then_27 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 3))));
            MR_Word Else_28 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 4))));
  ...
  MR_Word * STATE_VARIABLE_CLD_10)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Goal_22 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Goals_23 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      ...
      if (succeeded)
      {
        MR_Word GoalCode_30;
        MR_Word Instmap_31;
        MR_Word STATE_VARIABLE_CI_1_39;
        MR_Word STATE_VARIABLE_CLD_1_40;
        MR_Word STATE_VARIABLE_Code_1_41;

        ll_backend__code_gen__generate_goal_7_p_0(CodeModel_3, Goal_22, &GoalCode_30, STATE_VARIABLE_CI_0_7, &STATE_VARIABLE_CI_1_39, STATE_VARIABLE_CLD_0_9, &STATE_VARIABLE_CLD_1_40);
        STATE_VARIABLE_Code_1_41 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), STATE_VARIABLE_Code_0_5, GoalCode_30);
        ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_1_40, &Instmap_31);
        succeeded = hlds__instmap__instmap_is_unreachable_1_p_0(Instmap_31);
        if (succeeded)
        {
          *HeadVar__4_4 = (MR_Word) ((MR_Unsigned) 0U);
          *STATE_VARIABLE_CLD_10 = STATE_VARIABLE_CLD_1_40;
          *STATE_VARIABLE_CI_8 = STATE_VARIABLE_CI_1_39;
          *STATE_VARIABLE_Code_6 = STATE_VARIABLE_Code_1_41;
        }
        else
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_Code_0_5 = STATE_VARIABLE_Code_1_41;
          MR_Word next_value_of_STATE_VARIABLE_CI_0_7 = STATE_VARIABLE_CI_1_39;
          MR_Word next_value_of_STATE_VARIABLE_CLD_0_9 = STATE_VARIABLE_CLD_1_40;
  ...
  MR_Word * STATE_VARIABLE_CLD_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Code_1_34;
      ...
      ll_backend__code_gen__generate_conj_inner_10_p_0(HeadVar__1_1, (MR_Integer) 1000, CodeModel_2, &LeftOverGoals_26, STATE_VARIABLE_Code_0_3, &STATE_VARIABLE_Code_1_34, STATE_VARIABLE_CI_0_5, &STATE_VARIABLE_CI_1_35, STATE_VARIABLE_CLD_0_7, &STATE_VARIABLE_CLD_1_36);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = LeftOverGoals_26;
      next_value_of_STATE_VARIABLE_Code_0_3 = STATE_VARIABLE_Code_1_34;
      next_value_of_STATE_VARIABLE_CI_0_5 = STATE_VARIABLE_CI_1_35;
      next_value_of_STATE_VARIABLE_CLD_0_7 = STATE_VARIABLE_CLD_1_36;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
  ...
  MR_Word * STATE_VARIABLE_CLD_39)
{
  ...
  MR_Word InstMap_24;
  MR_Word STATE_VARIABLE_CLD_1_47;
  ...
  GoalExpr_21 = ((MR_Word) ((MR_hl_field(0, Goal_9, 0))));
  GoalInfo_22 = ((MR_Word) ((MR_hl_field(0, Goal_9, 1))));
  HasSubGoals_23 = hlds__goal_form__goal_expr_has_subgoals_1_f_0(GoalExpr_21);
  ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_22, HasSubGoals_23, STATE_VARIABLE_CLD_0_38, &STATE_VARIABLE_CLD_1_47);
  ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_1_47, &InstMap_24);
  ...
  if (succeeded)
  {
    ...
    MR_Word STATE_VARIABLE_CLD_3_57;
    MR_Word STATE_VARIABLE_CLD_4_60;
    MR_Word STATE_VARIABLE_CLD_5_61;
    ...
    ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_21, GoalInfo_22, CodeModel_25, ForwardLiveVarsBeforeGoal_20, &GoalCode_26, STATE_VARIABLE_CI_0_36, STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_1_47, &STATE_VARIABLE_CLD_2_53);
    Features_27 = hlds__hlds_goal__goal_info_get_features_1_f_0(GoalInfo_22);
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 6)), Features_27);
    if (succeeded)
    {
      hlds__hlds_proc__proc_info_get_call_table_tip_2_p_0(ProcInfo_13, &MaybeCallTableVar_28);
      succeeded = (MaybeCallTableVar_28 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        CallTableVar_29 = ((MR_Word) ((MR_hl_field(1, MaybeCallTableVar_28, 0))));
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_56, &TipSaveCode_31, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_2_53, &STATE_VARIABLE_CLD_3_57);
    ...
    else
    {
      ...
      STATE_VARIABLE_CLD_3_57 = STATE_VARIABLE_CLD_2_53;
    }
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 8)), Features_27);
    if (succeeded)
    {
      ...
      ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_33, &DeepSaveCode_34, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_3_57, &STATE_VARIABLE_CLD_4_60);
    ...
    else
    {
      *Code_10 = CodeUptoTip_32;
      STATE_VARIABLE_CLD_4_60 = STATE_VARIABLE_CLD_3_57;
    }
    ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_24, STATE_VARIABLE_CLD_4_60, &STATE_VARIABLE_CLD_5_61);
    ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_22, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_5_61, STATE_VARIABLE_CLD_39);
  }
  else
  {
    *Code_10 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
    *STATE_VARIABLE_CLD_39 = STATE_VARIABLE_CLD_1_47;
  ...
  MR_Word ProcInfo_3)
{
  ...
  hlds__hlds_proc__proc_info_get_maybe_deep_profile_info_2_p_0(ProcInfo_3, &MaybeDeepProfInfo_5);
  succeeded = (MaybeDeepProfInfo_5 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    DeepProfInfo_6 = ((MR_Word) ((MR_hl_field(1, MaybeDeepProfInfo_5, 0))));
    MaybeDeepLayout_7 = ((MR_Word) ((MR_hl_field(0, DeepProfInfo_6, 1))));
    succeeded = (MaybeDeepLayout_7 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      DeepLayout_8 = ((MR_Word) ((MR_hl_field(1, MaybeDeepLayout_7, 0))));
  }
  if (succeeded)
  {
    MR_Word ExcpVars_9 = ((MR_Word) ((MR_hl_field(0, DeepLayout_8, 1))));
    MR_Word TopCSDVar_10 = ((MR_Word) ((MR_hl_field(0, ExcpVars_9, 0))));
    MR_Word MiddleCSDVar_11 = ((MR_Word) ((MR_hl_field(0, ExcpVars_9, 1))));
    MR_Word MaybeOldOutermostVar_12 = ((MR_Word) ((MR_hl_field(0, ExcpVars_9, 2))));
    MR_Word StackSlots_13;
    MR_Box conv0_Var_14;

    hlds__hlds_proc__proc_info_get_stack_slots_2_p_0(ProcInfo_3, &StackSlots_13);
    ...
    if (succeeded)
      ...
      {
        MR_Word OldOutermostVar_15 = ((MR_Word) ((MR_hl_field(1, MaybeOldOutermostVar_12, 0))));
        MR_Word Var_16;
        MR_Word Var_17;
