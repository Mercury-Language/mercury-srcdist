        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              Var_73 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_CLD_38)
{
  ...
  GoalExpr_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 0))));
  GoalInfo_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_100_100 = (MR_Word) (&ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0);
        succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_100_100, Var_55, Var_91);
      }
    }
    if (succeeded)
    {
    ...
    if (succeeded)
      if ((MaybeOldOutermostVar_12 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (MiddleCSDVar_11));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), DeepSaveVars_4, 1) = ((MR_Box) (Var_19));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (OldOutermostVar_15));
