  ...
  MR_Word * STATE_VARIABLE_CLD_39)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 5)), Features_27);
    if (succeeded)
    {
    ...
    succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 7)), Features_27);
    if (succeeded)
    {
