  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_36, &Var_96);
        TypeCtorInfo_105_105 = (MR_Word) (&ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0);
        succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_105_105, Var_55, Var_96);
      }
    }
    if (succeeded)
    {
