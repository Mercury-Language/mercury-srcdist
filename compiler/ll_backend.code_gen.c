    ...
    switch (MR_tag((MR_Word) GoalExpr_10)) {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ArgVars_45 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 2))));
          MR_Word BuiltinState_46 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 3))) & (MR_Integer) 1);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Attributes_49 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1))));
              MR_Word ExtraArgs_50 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 5))));
              MR_Word MaybeTraceRuntimeCond_51 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 6))));
              MR_Word PragmaCode_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 7))));
              MR_Word Lang_53;
              ...
              switch (Lang_53) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  ll_backend__pragma_c_gen__generate_foreign_proc_code_14_p_0(CodeModel_12, Attributes_49, PredId_95, ProcId_96, Args_94, ExtraArgs_50, MaybeTraceRuntimeCond_51, PragmaCode_52, GoalInfo_11, Code_14, STATE_VARIABLE_CI_0_55, STATE_VARIABLE_CI_56, STATE_VARIABLE_CLD_0_57, STATE_VARIABLE_CLD_58);
                  break;
                case (MR_Integer) 1:
                case (MR_Integer) 2:
                  {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    Var_88 = mercury__cord__init_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
                    ll_backend__code_gen__generate_conj_8_p_0(Goals_23, CodeModel_12, Var_88, Code_14, STATE_VARIABLE_CI_0_55, STATE_VARIABLE_CI_56, STATE_VARIABLE_CLD_0_57, STATE_VARIABLE_CLD_58);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_93 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1))));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_71 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2))) & (MR_Integer) 3);
