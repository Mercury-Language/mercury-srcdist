          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2))));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer Var_42 = (MR_Integer) ((MR_Unsigned) N_2 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_18, GoalInfo_19, CodeModel_22, ForwardLiveVarsBeforeGoal_17, &GoalCode_23, STATE_VARIABLE_CI_0_34, STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_44_44, &STATE_VARIABLE_CLD_50_50);
      ...
      if (succeeded)
      {
        ll_backend__code_info__get_proc_info_2_p_0(*STATE_VARIABLE_CI_35, &Var_81);
        succeeded = hlds__hlds_pred____Unify____proc_info_0_0(ProcInfo_25, Var_81);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            CallTableVar_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallTableVar_26, (MR_Integer) 0))));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_52, 0) = NULL;
            }
            ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_35, &Var_82);
            TypeCtorInfo_92_92 = (MR_Word) (&ll_backend__trace_gen__ll_backend__trace_gen__type_ctor_info_trace_info_0);
            succeeded = ll_backend__code_gen____Unify____maybe__maybe_1_1(TypeCtorInfo_92_92, Var_52, Var_82);
          }
        }
      }
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (CallTableVar_27));
          MR_hl_field(MR_mktag(1), Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_53, &TipSaveCode_29, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_50_50, &STATE_VARIABLE_CLD_54_54);
      ...
      else
      {
        ...
        STATE_VARIABLE_CLD_54_54 = STATE_VARIABLE_CLD_50_50;
      }
      ...
      if (succeeded)
      {
        ...
        ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_31, &DeepSaveCode_32, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_54_54, &STATE_VARIABLE_CLD_57_57);
      ...
      else
      {
        *Code_10 = CodeUptoTip_30;
        STATE_VARIABLE_CLD_57_57 = STATE_VARIABLE_CLD_54_54;
      }
      ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_21, STATE_VARIABLE_CLD_57_57, &STATE_VARIABLE_CLD_58_58);
      ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_19, *STATE_VARIABLE_CI_35, STATE_VARIABLE_CLD_58_58, STATE_VARIABLE_CLD_37);
    }
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 0))));
      MaybeDeepLayout_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 1))));
      Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_6, (MR_Integer) 2))));
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepLayout_8, (MR_Integer) 0))));
      MR_Word Var_14;
      MR_Box conv0_Var_14;
