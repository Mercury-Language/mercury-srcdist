  ...
  MR_Word * STATE_VARIABLE_CLD_39)
{
  ...
  GoalExpr_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 0))));
  GoalInfo_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 1))));
  HasSubGoals_23 = hlds__goal_form__goal_expr_has_subgoals_1_f_0(GoalExpr_21);
  ll_backend__code_loc_dep__pre_goal_update_4_p_0(GoalInfo_22, HasSubGoals_23, STATE_VARIABLE_CLD_0_38, &STATE_VARIABLE_CLD_48_48);
  ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_48_48, &InstMap_24);
  ...
  if (succeeded)
  {
    ...
    ll_backend__code_gen__generate_goal_expr_9_p_0(GoalExpr_21, GoalInfo_22, CodeModel_25, ForwardLiveVarsBeforeGoal_20, &GoalCode_26, STATE_VARIABLE_CI_0_36, STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_48_48, &STATE_VARIABLE_CLD_54_54);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        CallTableVar_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallTableVar_28, (MR_Integer) 0))));
        ll_backend__code_info__get_maybe_trace_info_2_p_0(*STATE_VARIABLE_CI_37, &Var_99);
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (CallTableVar_29));
        MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(Var_57, &TipSaveCode_31, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_54_54, &STATE_VARIABLE_CLD_58_58);
    ...
    else
    {
      ...
      STATE_VARIABLE_CLD_58_58 = STATE_VARIABLE_CLD_54_54;
    }
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_loc_dep__save_variables_on_stack_5_p_0(DeepSaveVars_33, &DeepSaveCode_34, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_58_58, &STATE_VARIABLE_CLD_61_61);
    ...
    else
    {
      *Code_10 = CodeUptoTip_32;
      STATE_VARIABLE_CLD_61_61 = STATE_VARIABLE_CLD_58_58;
    }
    ll_backend__code_loc_dep__set_instmap_3_p_0(InstMap_24, STATE_VARIABLE_CLD_61_61, &STATE_VARIABLE_CLD_62_62);
    ll_backend__code_loc_dep__post_goal_update_4_p_0(GoalInfo_22, *STATE_VARIABLE_CI_37, STATE_VARIABLE_CLD_62_62, STATE_VARIABLE_CLD_39);
  }
  else
  {
    *Code_10 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
    *STATE_VARIABLE_CLD_39 = STATE_VARIABLE_CLD_48_48;
