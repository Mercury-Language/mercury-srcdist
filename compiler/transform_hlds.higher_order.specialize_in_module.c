  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 127, &DebugSpec_24);
  switch (DebugSpec_24) {
  ...
  else
  {
    ...
    MR_Word Var_685 = ((((MR_Unsigned) ((MR_hl_field(0, Params0_16, 0))) >> 2)) & (MR_Integer) 1);
    MR_Word Var_686 = ((((MR_Unsigned) ((MR_hl_field(0, Params0_16, 0))) >> 1)) & (MR_Integer) 1);
    MR_Integer Var_688 = ((MR_Integer) ((MR_hl_field(0, Params0_16, 1))));
    MR_Integer Var_689 = ((MR_Integer) ((MR_hl_field(0, Params0_16, 2))));
...

    {
      ...
      MR_hl_field(0, Params_31, 0) = (MR_Box) (((((MR_Unsigned) (Var_685) << 2)) | (((((MR_Unsigned) (Var_686) << 1)) | (MR_Unsigned) ((MR_Integer) 0)))));
      MR_hl_field(0, Params_31, 1) = ((MR_Box) (Var_688));
      MR_hl_field(0, Params_31, 2) = ((MR_Box) (Var_689));
    }
