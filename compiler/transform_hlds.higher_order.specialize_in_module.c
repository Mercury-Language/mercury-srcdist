  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 116, &DebugSpec_24);
  switch (DebugSpec_24) {
  ...
  else
  {
...

    {
      ...
      MR_hl_field(0, Params_31, 0) = (MR_Box) ((((packed_word_3 & (~((MR_Unsigned) 1U)))) | (MR_Unsigned) ((MR_Integer) 0)));
