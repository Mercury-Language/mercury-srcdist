  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 713, &DebugSpec_24);
  switch (DebugSpec_24) {
  ...
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ForcingPredIdSet_21, &ForcingPredIds_26);
  ...
  else
  {
    ...
    mercury__set__difference_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ValidPredIdSet_33, ForcingPredIdSet_21, &NonForcingPredIdSet_34);
    mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), NonForcingPredIdSet_34, &NonForcingPredIds_27);
  }
