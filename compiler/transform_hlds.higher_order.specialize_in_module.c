  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_37)
{
  ...
  MR_Word ForcingPredIdSet_21;
  MR_Word DebugSpec_24;
  MR_Word MaybeProgressStream_25;
  MR_Word ForcingPredIds_26;
  MR_Word NonForcingPredIds_27;
  ...
  HigherOrder_11 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_10, 0))) >> 4)) & (MR_Integer) 1);
  TypeSpec_12 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_10, 0))) >> 2)) & (MR_Integer) 1);
  UserTypeSpec_13 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_10, 0))) >> 1)) & (MR_Integer) 1);
  SizeLimit_14 = ((MR_Integer) ((MR_hl_field(0, OptTuple_10, 16))));
  ArgLimit_15 = ((MR_Integer) ((MR_hl_field(0, OptTuple_10, 17))));
  {
  ...
  ForcingPredIdSet_21 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables_19, 1))));
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 715, &DebugSpec_24);
  switch (DebugSpec_24) {
  ...
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ForcingPredIdSet_21, &ForcingPredIds_26);
  if ((ForcingPredIds_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    NonForcingPredIds_27 = ValidPredIds_18;
  ...
  else
  {
    ...
    MR_Word NonForcingPredIdSet_34;
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__higher_order__specialize_in_module_scalar_common_1[0]), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_global_info_0), (MR_Word) (&transform_hlds__higher_order__specialize_in_module_scalar_common_3[0]), ForcingPredIds_26, ((MR_Box) (Var_45)), &conv3_RequestsFromUserSpec_32, ((MR_Box) (STATE_VARIABLE_GlobalInfo_2_43)), &conv2_STATE_VARIABLE_GlobalInfo_3_46);
    ...
    mercury__set__list_to_set_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ValidPredIds_18, &ValidPredIdSet_33);
    mercury__set__difference_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ValidPredIdSet_33, ForcingPredIdSet_21, &NonForcingPredIdSet_34);
    mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), NonForcingPredIdSet_34, &NonForcingPredIds_27);
  }
  ...
  if (succeeded)
  {
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__higher_order__specialize_in_module_scalar_common_1[0]), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_global_info_0), (MR_Word) (&transform_hlds__higher_order__specialize_in_module_scalar_common_3[1]), NonForcingPredIds_27, ((MR_Box) (GeneralRequests_28)), &conv7_Requests_35, ((MR_Box) (STATE_VARIABLE_GlobalInfo_1_41)), &conv6_STATE_VARIABLE_GlobalInfo_5_50);
