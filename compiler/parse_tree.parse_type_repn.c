  ...
  MR_Box closure_arg)
{
  ...
  succeeded = parse_tree__parse_type_repn__IntroducedFrom__pred__parse_one_or_more_strings__2133__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = parse_tree__parse_type_repn__IntroducedFrom__pred__parse_one_or_more_strings__2120__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * MaybeRepn_10)
{
  if ((RepnArgs_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      Spec_21 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Spec_21, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_repn.parse_type_repn_eqv_to\'/5"));
      MR_hl_field(0, Spec_21, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_21, 2) = ((MR_Box) ((MR_Unsigned) 24U));
      MR_hl_field(0, Spec_21, 3) = ((MR_Box) (RepnContext_9));
      MR_hl_field(0, Spec_21, 4) = ((MR_Box) (Pieces_20));
    }
    {
      Var_49 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Spec_53, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_repn.parse_type_repn_eqv_to\'/5"));
        MR_hl_field(0, Spec_53, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_53, 2) = ((MR_Box) ((MR_Unsigned) 24U));
        MR_hl_field(0, Spec_53, 3) = ((MR_Box) (RepnContext_9));
