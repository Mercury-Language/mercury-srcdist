  ...
  MR_Word * MaybeRepn_10)
{
  ...
  {
    MR_Word Var_75 = ((MR_Word) ((MR_hl_field(1, RepnArgs_8, (MR_Integer) 1))));
    MR_Word Var_76 = ((MR_Word) ((MR_hl_field(1, RepnArgs_8, (MR_Integer) 0))));
    ...
    if ((Var_75 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        MR_Word EqvType_14 = ((MR_Word) ((MR_hl_field(1, MaybeEqvType_13, (MR_Integer) 0))));
        MR_Word Var_33;
