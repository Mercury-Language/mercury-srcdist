      ...
      case (MR_Integer) 2:
        {
          ...
          *GoalExpr_16 = GoalExpr0_15;
          ...
          if ((env).ll_backend__live_vars__build_live_sets_in_goal_expr_14_p_0_env_0__succeeded)
          {
            ...
            if ((MaybeNeedLC_107 == (MR_Word) ((MR_Integer) 0)))
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    NonLocals_28 = hlds__hlds_goal__goal_info_get_code_gen_nonlocals_1_f_0(GoalInfo0_17);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_220, 1) = ((MR_Box) ((MR_Integer) 0));
                    }
                    {
          ...
          case (MR_Integer) 3:
            {
              ...
              if (((env).ll_backend__live_vars__build_live_sets_in_goal_expr_14_p_0_env_0__Goals_236 == (MR_Word) ((MR_Integer) 0)))
              ...
              else
              {
                ...
                if ((ResumePoint_39 == (MR_Word) ((MR_Integer) 0)))
                  *STATE_VARIABLE_NondetLiveness_147 = STATE_VARIABLE_NondetLiveness_213_213;
                else
                {
...
{
  {
    ...
    if ((ResumePoint_28 == (MR_Word) ((MR_Integer) 0)))
    {
  ...
  MR_Word * STATE_VARIABLE_ParStackVars_18)
{
  switch (MR_tag((MR_Word) STATE_VARIABLE_ParStackVars_0_17)) {
    ...
    case (MR_Integer) 0:
      {
        *MaybeNeedLC_5 = (MR_Word) ((MR_Integer) 0);
    ...
    case (MR_Integer) 3:
      {
        ...
        *STATE_VARIABLE_ParStackVars_18 = (MR_Word) ((MR_Integer) 0);
      }
      break;
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) OuterParStackVars_6)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *ParStackVars_8 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    ll_backend__live_vars__set_dummy_array_elements_6_p_0(ModuleInfo_5, VarsTypes_9, DummyTypeArray0_11, DummyTypeArray_7, (MR_Word) ((MR_Integer) 0), DummyVars_8);
  }
}
