...
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_disj_13_0, 87,4,5,7,11,12,16,17,18,19)
MR_decl_label2(ll_backend__live_vars__build_live_sets_in_disj_13_0, 13,9)
...
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 4,5,8,9,10,15,12,17,3,22)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 27,28,29,31,32,33,34,35,36,37)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 38,21,41,19,44,46,48,50,53,56)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 57,59,55,60,62,52,43,306,69,71)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 72,73,66,75,76,77,79,74,82,81)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 85,86,87,89,90,84,96,92,97,98)
MR_decl_label9(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 100,91,105,104,109,110,111,316,107)
...
MR_BEGIN_MODULE(ll_backend__live_vars_module7)
	...
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,4,5,8,9,10,15,12,17,3,22)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,27,28,29,31,32,33,34,35,36,37)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,38,21,41,19,44,46,48,50,53,56)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,57,59,55,60,62,52,43,306,69,71)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,72,73,66,75,76,77,79,74,82,81)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,85,86,87,89,90,84,96,92,97,98)
	MR_init_label9(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,100,91,105,104,109,110,111,316,107)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,43)
	...
	if (MR_PTAG_TESTR(MR_tempr1,3)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i306);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_r3 = MR_r6;
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,306)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(20);
	MR_sv(20) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,111)
	...
	if (MR_RTAGS_TESTR(MR_r10,3,0)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i316);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_r3 = MR_r6;
	...
	MR_r6 = MR_r9;
	MR_proceed();
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,316)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ll_backend__live_vars_module10)
	...
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_disj_13_0,87,4,5,7,11,12,16,17,18,19)
	MR_init_label2(ll_backend__live_vars__build_live_sets_in_disj_13_0,13,9)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__live_vars__build_live_sets_in_disj_13_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_disj_13_0_i87);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r6;
	MR_r3 = MR_r7;
	...
	MR_r5 = MR_r9;
	MR_proceed();
MR_def_label(ll_backend__live_vars__build_live_sets_in_disj_13_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_disj_13_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_disj_13_0_i13);
	}
	MR_r5 = MR_tfield(1, MR_r1, 1);
	if (MR_INT_NE(MR_r5,2)) {
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_disj_13_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
