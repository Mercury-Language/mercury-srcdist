    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word TypeInfoVarsLive_68;
        MR_Word TypeInfoVarsOut_69;
        MR_Word STATE_VARIABLE_LiveVars_17_70;
        MR_Word _VarSet_65;

        hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(Var_33, &_VarSet_65, &VarTypes_66);
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(Var_33, &RttiVarMaps_67);
        hlds__hlds_rtti__get_typeinfo_vars_4_p_0(ForwardVars0_22, VarTypes_66, RttiVarMaps_67, &TypeInfoVarsLive_68);
        hlds__hlds_rtti__get_typeinfo_vars_4_p_0(OutVars_13, VarTypes_66, RttiVarMaps_67, &TypeInfoVarsOut_69);
        parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ForwardVars0_22, TypeInfoVarsOut_69, &STATE_VARIABLE_LiveVars_17_70);
        parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_LiveVars_17_70, TypeInfoVarsLive_68, &ForwardVars_23);
      }
      break;
  }
