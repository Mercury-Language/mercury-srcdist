...
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 23,24,28,29,30,32,33,34,35,36)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 37,38,39,22,42,20,45,47,49,51)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 54,57,58,60,56,61,62,53,44,305)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 69,71,72,73,74,66,76,77,78,79)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 75,82,81,84,85,86,88,89,90,83)
MR_decl_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 95,92,96,97,99,91,104,103,108,109)
MR_decl_label3(ll_backend__live_vars__build_live_sets_in_goal_2_14_0, 110,315,106)
...
MR_BEGIN_MODULE(ll_backend__live_vars_module9)
	...
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,23,24,28,29,30,32,33,34,35,36)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,37,38,39,22,42,20,45,47,49,51)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,54,57,58,60,56,61,62,53,44,305)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,69,71,72,73,74,66,76,77,78,79)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,75,82,81,84,85,86,88,89,90,83)
	MR_init_label10(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,95,92,96,97,99,91,104,103,108,109)
	MR_init_label3(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,110,315,106)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,23)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__set_to_bitset_1_0,
		ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i24);
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,22)
	...
	MR_np_call_localret_ent(ll_backend__live_vars__build_live_sets_in_conj_12_0,
		ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i42);
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i44);
	}
	MR_incr_sp(19);
	MR_sv(19) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i51);
	}
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i53);
	}
	MR_sv(16) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(17) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_save_maxfr(MR_sv(18));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i56);
...
MR_def_label(ll_backend__live_vars__build_live_sets_in_goal_2_14_0,66)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,6)) {
		MR_GOTO_LAB(ll_backend__live_vars__build_live_sets_in_goal_2_14_0_i75);
	}
	MR_incr_sp(19);
	MR_sv(19) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
