...
{
  {
    ...
    hlds__hlds_rtti__rtti_lookup_type_info_locn_3_p_0(RttiVarMaps_5, TVar_6, &TypeInfoLocn_8);
    {
      ...
      MR_hl_field(MR_mktag(0), Type_9, 1) = ((MR_Box) ((MR_Integer) 0));
    }
...
{
  {
    ...
    SimplifyTasks_12 = check_hlds__simplify__simplify_tasks__list_to_simplify_tasks_1_f_0((MR_Word) ((MR_Integer) 0));
...
{
  {
    ...
    if ((Later0_17 == (MR_Word) ((MR_Integer) 0)))
    {
      *Later_18 = (MR_Word) ((MR_Integer) 0);
          ...
          case (MR_Integer) 3:
            {
              ...
              if ((Disjuncts0_72 == (MR_Word) ((MR_Integer) 0)))
              {
                ...
                Disjuncts_73 = (MR_Word) ((MR_Integer) 0);
              }
              else
              {
          ...
          case (MR_Integer) 4:
            {
              ...
              if ((Cases0_63 == (MR_Word) ((MR_Integer) 0)))
              {
                {
...
{
  {
    ...
    transform_hlds__size_prof__size_prof_process_args_9_p_0(DefinedArgs_14, (MR_Integer) 0, &KnownSize_19, (MR_Word) ((MR_Integer) 0), &MaybeDynamicSizeVar_20, Context_18, &ArgGoals_21, STATE_VARIABLE_Info_0_28, &STATE_VARIABLE_Info_32_32);
    if ((MaybeDynamicSizeVar_20 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_52;
    ...
    else
    {
      ...
      hlds__goal_util__generate_simple_call_12_p_0(TermSizeProfBuiltin_25, (MR_String) "increment_size", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 2, Var_39, (MR_Word) ((MR_Integer) 0), Var_41, Var_42, Context_18, &UpdateGoal_26);
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Unification_39, 6) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        MR_Word base;
    ...
    else
    {
      ...
      else
      {
        ...
        transform_hlds__size_prof__record_known_size_4_p_0(Var_19, (MR_Integer) 0, STATE_VARIABLE_Info_0_45, STATE_VARIABLE_Info_46);
        {
          ...
          MR_hl_field(MR_mktag(0), Unification_67, 6) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    transform_hlds__size_prof__size_prof_process_args_9_p_0(DefinedArgs_31, FunctorSize_30, &KnownSize_34, (MR_Word) ((MR_Integer) 0), &MaybeDynamicSizeVar_35, Context_33, &ArgGoals_36, STATE_VARIABLE_Info_0_49, &STATE_VARIABLE_Info_52_52);
    if ((MaybeDynamicSizeVar_35 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Unification_39;
      MR_Word Var_65;
      MR_Word Var_70;
      ...
      if ((NonDefinedArgs_32 == (MR_Word) ((MR_Integer) 0)))
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if ((Args_6 == (MR_Word) ((MR_Integer) 0)))
      if ((Modes_7 == (MR_Word) ((MR_Integer) 0)))
      {
        *DefinedArgs_8 = (MR_Word) ((MR_Integer) 0);
        *NonDefinedArgs_9 = (MR_Word) ((MR_Integer) 0);
      }
      else
      {
        {
...
{
  {
    ...
    else
    {
      ...
      hlds__goal_util__generate_simple_call_12_p_0(TermSizeProfModule_20, (MR_String) "term_size_plus", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__size_prof_scalar_common_5[3])), (MR_Integer) 0, (MR_Integer) 0, Var_36, (MR_Word) ((MR_Integer) 0), Var_38, Var_39, Context_10, &AddGoal_21);
      {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ArgGoals_29 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    if ((MaybeSizeVar0_13 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_26;
      MR_Word Var_27;
    ...
    hlds__goal_util__generate_simple_call_12_p_0(TermSizeProfBuiltin_20, Pred_18, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 0, Args_19, (MR_Word) ((MR_Integer) 0), Var_38, Var_39, Context_11, SizeGoal_12);
    {
      MR_Word base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *TypeInfoGoals_10 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
          if ((ArgTypes_72 == (MR_Word) ((MR_Integer) 0)))
          {
            transform_hlds__size_prof__make_type_ctor_info_6_p_0(TypeCtor_71, (MR_Word) ((MR_Integer) 0), TypeInfoVar_9, TypeInfoGoals_10, STATE_VARIABLE_Info_0_38, STATE_VARIABLE_Info_39);
          }
          else
          {
          ...
          if (succeeded)
          {
            TVar_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_8, (MR_Integer) 0))));
            {
              ...
              else
              {
                ...
                hlds__goal_util__generate_simple_call_12_p_0(PrivateBuiltin_36, (MR_String) "type_info_from_typeclass_info", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 0, Var_59, (MR_Word) ((MR_Integer) 0), Var_61, Var_62, Context_7, &ExtractGoal_37);
...
{
  {
    ...
    if (succeeded)
      ...
      MaybePreferredVar_37 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *TypeCtorGoals_10 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      {
        parse_tree__prog_type__construct_type_3_p_0(TypeCtor_7, (MR_Word) ((MR_Integer) 0), &Type_16);
      }
