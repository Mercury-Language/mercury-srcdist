...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_42_42, STATE_VARIABLE_ProcInfo_43_43, &InstMap0_16);
...
{
  {
    ...
    succeeded = transform_hlds__size_prof__IntroducedFrom__pred__record_known_type_info__1105__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_46);
    if (succeeded)
    {
