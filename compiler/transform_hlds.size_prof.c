...
{
  {
    ...
    else
    {
      ...
      hlds__goal_util__generate_simple_call_12_p_0(Var_31, TermSizeProfModule_20, (MR_String) "term_size_plus", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__size_prof_scalar_common_3[1])), (MR_Integer) 0, (MR_Integer) 0, Var_37, (MR_Word) ((MR_Unsigned) 0U), Var_39, Context_10, &AddGoal_21);
      {
