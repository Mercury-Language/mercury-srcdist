  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        next_value_of_HeadVar__2_2 = ActualArgs_46;
        next_value_of_STATE_VARIABLE_ActualInputs_0_5 = ActualInputs1_51;
        next_value_of_STATE_VARIABLE_ActualOutputs_0_7 = ActualOutputs1_52;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
...
{
  {
    ...
    mercury__list__foldl3_8_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, TypeInfo_36_36, TypeInfo_36_36, TypeInfo_36_36, Var_24, ProcIds_17, ((MR_Box) (STATE_VARIABLE_LVBeforeTable_0_18)), &conv5_STATE_VARIABLE_LVBeforeTable_19, ((MR_Box) (STATE_VARIABLE_LVAfterTable_0_20)), &conv4_STATE_VARIABLE_LVAfterTable_21, ((MR_Box) (STATE_VARIABLE_VoidVarTable_0_22)), &conv3_STATE_VARIABLE_VoidVarTable_23);
