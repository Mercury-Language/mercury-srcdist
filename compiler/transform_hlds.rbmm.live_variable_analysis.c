...
MR_decl_label10(transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_0, 2,9,10,11,12,6,23,26,17,36)
MR_decl_label7(transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_0, 14,40,39,38,49,50,51)
...
MR_decl_label10(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0, 72,3,11,8,14,16,17,18,19,20)
MR_decl_label10(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0, 7,21,22,24,25,26,5,32,29,35)
MR_decl_label7(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0, 37,38,39,41,42,43,44)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__live_variable_analysis_module4)
	...
	MR_init_label10(transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_0,2,9,10,11,12,6,23,26,17,36)
	MR_init_label7(transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_0,14,40,39,38,49,50,51)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__live_variable_analysis_module6)
	...
	MR_init_label10(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0,72,3,11,8,14,16,17,18,19,20)
	MR_init_label10(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0,7,21,22,24,25,26,5,32,29,35)
	MR_init_label7(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0,37,38,39,41,42,43,44)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_path_13_0,5)
	...
	MR_tempr2 = MR_tfield(0, MR_tempr1, 0);
	MR_sv(9) = MR_tfield(0, MR_tempr1, 1);
	MR_sv(12) = MR_tfield(1, MR_tempr3, 1);
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
