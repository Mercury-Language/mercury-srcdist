...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 2)));
      {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Expr_15, (MR_Integer) 3)));
        {
          MR_Word Var_31;
      ...
      else
      {
            ...
            case (MR_Integer) 0:
              {
                ...
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_26, (MR_Integer) 5)));
                {
            ...
            case (MR_Integer) 1:
              {
                ...
                packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_26, (MR_Integer) 4)));
                {
                  Useds_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          if (((((MR_tag((MR_Word) Expr_15)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Expr_15, (MR_Integer) 0))) == (MR_Integer) 2))))
          {
            ...
            MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_15, (MR_Integer) 1)));
