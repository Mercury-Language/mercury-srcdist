  ...
  MR_Word * STATE_VARIABLE_VoidVars_10)
{
  ...
  succeeded = mercury__string__index_3_p_0(Var_11, (MR_Integer) 0, &Var_18);
  if (succeeded)
    succeeded = ((MR_Char) 95 == Var_18);
  if (succeeded)
      ...
      switch (HeadVar__6_6) {
        ...
        case (MR_Integer) 0:
          if ((Var_131 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_136, ProducedSet_105, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, STATE_VARIABLE_ProcVoidVar_13);
          }
          else
          {
            MR_Word UsedSet_72;
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_136, ProducedSet_73, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_86_86);
            // direct tailcall eliminated
            ;
        ...
        case (MR_Integer) 1:
          {
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_136, ProducedSet_43, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_55_55);
            // direct tailcall eliminated
            ;
            next_value_of_HeadVar__1_1 = Var_131;
