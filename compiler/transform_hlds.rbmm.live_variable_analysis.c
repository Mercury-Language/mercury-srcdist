  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((transform_hlds__rbmm__live_variable_analysis__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word transform_hlds__rbmm__live_variable_analysis__V_131_131 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__rbmm__live_variable_analysis__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word transform_hlds__rbmm__live_variable_analysis__V_132_132 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__rbmm__live_variable_analysis__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word transform_hlds__rbmm__live_variable_analysis__V_135_135 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__live_variable_analysis__V_132_132, (MR_Integer) 1)));
            MR_Word transform_hlds__rbmm__live_variable_analysis__V_136_136 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__live_variable_analysis__V_132_132, (MR_Integer) 0)));

            switch (transform_hlds__rbmm__live_variable_analysis__HeadVar__6_6) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                if ((transform_hlds__rbmm__live_variable_analysis__V_131_131 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                ...
                else
                  {
                    ...
                    {
                      transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_p_0(transform_hlds__rbmm__live_variable_analysis__ModuleInfo_4, transform_hlds__rbmm__live_variable_analysis__V_135_135, &transform_hlds__rbmm__live_variable_analysis__UsedSet_72, &transform_hlds__rbmm__live_variable_analysis__ProducedSet_73);
                    }
                    ...
                    {
                      transform_hlds__rbmm__live_variable_analysis__record_live_vars_at_prog_point_4_p_0(transform_hlds__rbmm__live_variable_analysis__V_136_136, transform_hlds__rbmm__live_variable_analysis__LVBeforeInThisExecPath_74, transform_hlds__rbmm__live_variable_analysis__STATE_VARIABLE_ProcLVBefore_0_8, &transform_hlds__rbmm__live_variable_analysis__STATE_VARIABLE_ProcLVBefore_85_85);
                    }
                    {
                      transform_hlds__rbmm__live_variable_analysis__collect_void_vars_5_p_0(transform_hlds__rbmm__live_variable_analysis__V_136_136, transform_hlds__rbmm__live_variable_analysis__ProducedSet_73, transform_hlds__rbmm__live_variable_analysis__ProcInfo_5, transform_hlds__rbmm__live_variable_analysis__STATE_VARIABLE_ProcVoidVar_0_12, &transform_hlds__rbmm__live_variable_analysis__STATE_VARIABLE_ProcVoidVar_86_86);
                    }
                    /* direct tailcall eliminated */
                    {
                      MR_Word transform_hlds__rbmm__live_variable_analysis__HeadVar__1__tmp_copy_1 = transform_hlds__rbmm__live_variable_analysis__V_131_131;
