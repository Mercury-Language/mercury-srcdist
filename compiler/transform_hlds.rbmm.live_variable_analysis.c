  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (HeadVar__6_6) {
        ...
        case (MR_Integer) 0:
          if ((Var_131 == (MR_Word) ((MR_Integer) 0)))
          {
...
{
  {
    ...
    if (succeeded)
    {
      Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(1), Useds_13, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      Produceds_14 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        Args_19 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Expr_15, (MR_Integer) 2))));
        {
          ...
          transform_hlds__rbmm__live_variable_analysis__get_inputs_outputs_proc_call_2_8_p_0(FormalArgs_46, Args_19, Inputs_44, Outputs_45, (MR_Word) ((MR_Integer) 0), &Useds_13, (MR_Word) ((MR_Integer) 0), &Produceds_14);
        }
      }
      else
      {
            ...
            case (MR_Integer) 0:
              {
                ...
                Useds_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification_26, (MR_Integer) 2))));
                {
                  ...
                  MR_hl_field(MR_mktag(1), Produceds_14, 1) = ((MR_Box) ((MR_Integer) 0));
                }
              }
              break;
            case (MR_Integer) 1:
