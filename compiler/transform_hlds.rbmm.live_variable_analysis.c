  ...
  MR_Word * STATE_VARIABLE_ProcVoidVar_11)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word Var_64;
      MR_Word Var_65;
      MR_Word _VarTypes_62;
      MR_Box conv2_VoidVars_63;

      hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_5, &VarSet_61, &_VarTypes_62);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_64, 3) = ((MR_Box) (VarSet_61));
      }
