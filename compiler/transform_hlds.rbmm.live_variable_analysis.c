        ...
        else
        {
          ...
          else
          {
            ...
            hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_5, &VarTable_83);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_85, 0) = ((MR_Box) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_85, 1) = ((MR_Box) (transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_paths_11_p_0_1));
              MR_hl_field(MR_mktag(0), Var_85, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_85, 3) = ((MR_Box) (VarTable_83));
            }
  ...
  MR_Word * STATE_VARIABLE_ProcVoidVar_14)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_8, &VarTable_11);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_15, 3) = ((MR_Box) (VarTable_11));
    }
