...
static void MR_CALL 
transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(
  MR_Word ModuleInfo_7,
  MR_Word ProgPoint_8,
  MR_Word ProducedSet_9,
  MR_Word ProcInfo_10,
  MR_Word STATE_VARIABLE_ProcVoidVar_0_15,
  MR_Word * STATE_VARIABLE_ProcVoidVar_16);
  ...
  MR_Word * STATE_VARIABLE_VoidVars_10)
{
  ...
  Var_11 = ((MR_String) ((MR_hl_field(MR_mktag(0), VarEntry_8, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_ProcVoidVar_11)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_4, ProcInfo_5, &VarTable_62);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_64, 3) = ((MR_Box) (VarTable_62));
      }
      Var_65 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]));
      mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), Var_64, ProducedSet_25, ((MR_Box) (Var_65)), &conv2_VoidVars_63);
      VoidVars_63 = ((MR_Word) (conv2_VoidVars_63));
      mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_12)), ((MR_Box) (VoidVars_63)), STATE_VARIABLE_ProcVoidVar_0_10, STATE_VARIABLE_ProcVoidVar_11);
    }
  }
}
      ...
      switch (HeadVar__6_6) {
        ...
        case (MR_Integer) 0:
          if ((Var_128 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_133, ProducedSet_105, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, STATE_VARIABLE_ProcVoidVar_13);
          }
          else
          {
            MR_Word UsedSet_72;
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_133, ProducedSet_73, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_86_86);
            // direct tailcall eliminated
            ;
        ...
        case (MR_Integer) 1:
          {
            ...
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0(ModuleInfo_4, Var_133, ProducedSet_43, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_55_55);
            // direct tailcall eliminated
            ;
            next_value_of_HeadVar__1_1 = Var_128;
...
{
  MR_bool succeeded;
  MR_Box conv0__DeadVars_12;

  succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), STATE_VARIABLE_ProcVoidVar_0_15, ((MR_Box) (ProgPoint_8)), &conv0__DeadVars_12);
  if (succeeded)
    succeeded = MR_TRUE;
  if (succeeded)
    *STATE_VARIABLE_ProcVoidVar_16 = STATE_VARIABLE_ProcVoidVar_0_15;
  else
  {
    MR_Word VarTable_13;
    MR_Word VoidVars_14;
    MR_Word Var_17;
    MR_Word Var_18;
    MR_Box conv2_VoidVars_14;

    hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_10, &VarTable_13);
    {
      Var_17 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_17, 1) = ((MR_Box) (transform_hlds__rbmm__live_variable_analysis__collect_void_vars_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_17, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_17, 3) = ((MR_Box) (VarTable_13));
    }
    Var_18 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]));
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), Var_17, ProducedSet_9, ((MR_Box) (Var_18)), &conv2_VoidVars_14);
    VoidVars_14 = ((MR_Word) (conv2_VoidVars_14));
    mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_8)), ((MR_Box) (VoidVars_14)), STATE_VARIABLE_ProcVoidVar_0_15, STATE_VARIABLE_ProcVoidVar_16);
  }
}
