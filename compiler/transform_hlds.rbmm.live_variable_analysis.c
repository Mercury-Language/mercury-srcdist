  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        {
          MR_Word ProgPoint_55;
          MR_Word Goal_56;
          MR_Word LVBefore_62;
          MR_Word LVAfter_63;
          MR_Word ProducedSet_65;
          MR_Word Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ExecPath_34, (MR_Integer) 0))));
          MR_Word _UsedSet_64;
          MR_Box conv0__DeadVars_88;

          ProgPoint_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 0))));
          Goal_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 1))));
          LVBefore_62 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), Inputs_2);
          mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_55)), ((MR_Box) (LVBefore_62)), STATE_VARIABLE_ProcLVBefore_0_6, &STATE_VARIABLE_ProcLVBefore_42_42);
          LVAfter_63 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), Outputs_3);
          mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_55)), ((MR_Box) (LVAfter_63)), STATE_VARIABLE_ProcLVAfter_0_8, &STATE_VARIABLE_ProcLVAfter_43_43);
          transform_hlds__rbmm__live_variable_analysis__compute_useds_produceds_4_p_0(ModuleInfo_4, Goal_56, &_UsedSet_64, &ProducedSet_65);
          succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), STATE_VARIABLE_ProcVoidVar_0_10, ((MR_Box) (ProgPoint_55)), &conv0__DeadVars_88);
          if (succeeded)
            succeeded = MR_TRUE;
          if (succeeded)
          ...
          else
          {
            ...
            MR_Word Var_92;
            MR_Word Var_93;
            MR_Word _VarTypes_90;
            MR_Box conv2_VoidVars_91;

            hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_5, &VarSet_89, &_VarTypes_90);
            {
              Var_92 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_92, 0) = ((MR_Box) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_92, 1) = ((MR_Box) (transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_paths_11_p_0_1));
              MR_hl_field(MR_mktag(0), Var_92, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_92, 3) = ((MR_Box) (VarSet_89));
            }
            Var_93 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]));
            mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), Var_92, ProducedSet_65, ((MR_Box) (Var_93)), &conv2_VoidVars_91);
            VoidVars_91 = ((MR_Word) (conv2_VoidVars_91));
            mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_55)), ((MR_Box) (VoidVars_91)), STATE_VARIABLE_ProcVoidVar_0_10, &STATE_VARIABLE_ProcVoidVar_44_44);
          }
        }
      else
      {
