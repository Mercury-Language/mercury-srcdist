...
transform_hlds__rbmm__live_variable_analysis__collect_void_vars_5_p_0(
  ...
  MR_Word ProcInfo_8,
  MR_Word STATE_VARIABLE_ProcVoidVar_0_14,
  MR_Word * STATE_VARIABLE_ProcVoidVar_15);
  ...
  MR_Word * STATE_VARIABLE_VoidVars_10)
{
  ...
  succeeded = mercury__string__index_3_p_0(VarName_8, (MR_Integer) 0, &Var_15);
  if (succeeded)
    succeeded = ((MR_Char) 95 == Var_15);
  if (succeeded)
    ...
    else
    {
      ...
      if (succeeded)
        ...
        else
        {
          ...
          MR_Word Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ExecPath_34, (MR_Integer) 0))));
          MR_Word _UsedSet_58;
          MR_Box conv0__DeadVars_82;

          ProgPoint_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 0))));
          Goal_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 1))));
          ...
          mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_49)), ((MR_Box) (LVBefore_56)), STATE_VARIABLE_ProcLVBefore_0_6, &STATE_VARIABLE_ProcLVBefore_42_42);
          ...
          mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_49)), ((MR_Box) (LVAfter_57)), STATE_VARIABLE_ProcLVAfter_0_8, &STATE_VARIABLE_ProcLVAfter_43_43);
          ...
          if (succeeded)
            succeeded = MR_TRUE;
          if (succeeded)
            STATE_VARIABLE_ProcVoidVar_44_44 = STATE_VARIABLE_ProcVoidVar_0_10;
          else
          {
            MR_Word VarSet_83;
            MR_Word VoidVars_85;
            MR_Word Var_86;
            MR_Word Var_87;
            MR_Word _VarTypes_84;
            MR_Box conv2_VoidVars_85;

            hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_5, &VarSet_83, &_VarTypes_84);
            {
              Var_86 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_86, 1) = ((MR_Box) (transform_hlds__rbmm__live_variable_analysis__live_variable_analysis_exec_paths_11_p_0_1));
              MR_hl_field(MR_mktag(0), Var_86, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_86, 3) = ((MR_Box) (VarSet_83));
            }
            Var_87 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]));
            mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), Var_86, ProducedSet_59, ((MR_Box) (Var_87)), &conv2_VoidVars_85);
            VoidVars_85 = ((MR_Word) (conv2_VoidVars_85));
            mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_49)), ((MR_Box) (VoidVars_85)), STATE_VARIABLE_ProcVoidVar_0_10, &STATE_VARIABLE_ProcVoidVar_44_44);
          }
        }
      else
      {
  ...
  MR_Word * STATE_VARIABLE_ProcVoidVar_13)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_132 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_129, (MR_Integer) 1))));
      MR_Word Var_133 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_129, (MR_Integer) 0))));
      ...
      switch (HeadVar__6_6) {
        ...
        case (MR_Integer) 0:
          ...
          else
          {
            ...
            transform_hlds__rbmm__live_variable_analysis__record_live_vars_at_prog_point_4_p_0(Var_133, HeadVar__7_7, STATE_VARIABLE_ProcLVAfter_0_10, &STATE_VARIABLE_ProcLVAfter_83_83);
            ...
            transform_hlds__rbmm__live_variable_analysis__record_live_vars_at_prog_point_4_p_0(Var_133, LVBeforeInThisExecPath_74, STATE_VARIABLE_ProcLVBefore_0_8, &STATE_VARIABLE_ProcLVBefore_85_85);
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_5_p_0(Var_133, ProducedSet_73, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_86_86);
            // direct tailcall eliminated
            ;
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (Var_133)), ((MR_Box) (LVAfterLast_41)), STATE_VARIABLE_ProcLVAfter_0_10, &STATE_VARIABLE_ProcLVAfter_52_52);
            }
            ...
            transform_hlds__rbmm__live_variable_analysis__record_live_vars_at_prog_point_4_p_0(Var_133, LVBeforeLastInThisExecPath_44, STATE_VARIABLE_ProcLVBefore_0_8, &STATE_VARIABLE_ProcLVBefore_54_54);
            transform_hlds__rbmm__live_variable_analysis__collect_void_vars_5_p_0(Var_133, ProducedSet_43, ProcInfo_5, STATE_VARIABLE_ProcVoidVar_0_12, &STATE_VARIABLE_ProcVoidVar_55_55);
            // direct tailcall eliminated
            ;
            next_value_of_HeadVar__1_1 = Var_128;
  ...
  MR_Word * STATE_VARIABLE_ProcVoidVar_15)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), STATE_VARIABLE_ProcVoidVar_0_14, ((MR_Box) (ProgPoint_6)), &conv0__DeadVars_10);
  if (succeeded)
    succeeded = MR_TRUE;
  if (succeeded)
    *STATE_VARIABLE_ProcVoidVar_15 = STATE_VARIABLE_ProcVoidVar_0_14;
  else
  {
    MR_Word VarSet_11;
    MR_Word VoidVars_13;
    MR_Word Var_16;
    MR_Word Var_17;
    MR_Word _VarTypes_12;
    MR_Box conv2_VoidVars_13;

    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_8, &VarSet_11, &_VarTypes_12);
    {
      Var_16 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_16, 1) = ((MR_Box) (transform_hlds__rbmm__live_variable_analysis__collect_void_vars_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_16, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_16, 3) = ((MR_Box) (VarSet_11));
    }
    Var_17 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]));
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[0]), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), Var_16, ProducedSet_7, ((MR_Box) (Var_17)), &conv2_VoidVars_13);
    VoidVars_13 = ((MR_Word) (conv2_VoidVars_13));
    mercury__map__set_4_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__live_variable_analysis_scalar_common_1[1]), ((MR_Box) (ProgPoint_6)), ((MR_Box) (VoidVars_13)), STATE_VARIABLE_ProcVoidVar_0_14, STATE_VARIABLE_ProcVoidVar_15);
  }
}
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        switch (MR_tag((MR_Word) Unification_26)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word LVar_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification_26, (MR_Integer) 0))));
              ...
              Useds_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification_26, (MR_Integer) 2))));
              {
                ...
                MR_hl_field(MR_mktag(1), Produceds_14, 0) = ((MR_Box) (LVar_44));
          ...
          case (MR_Integer) 1:
            {
              MR_Word LVar_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_26, (MR_Integer) 0))));

              Produceds_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_26, (MR_Integer) 2))));
              {
                Useds_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Useds_13, 0) = ((MR_Box) (LVar_52));
                MR_hl_field(MR_mktag(1), Useds_13, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word LVar_59 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification_26, (MR_Integer) 0))));
              MR_Word RVar_60 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification_26, (MR_Integer) 1))));

              {
                Useds_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Useds_13, 0) = ((MR_Box) (RVar_60));
                MR_hl_field(MR_mktag(1), Useds_13, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Produceds_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Produceds_14, 0) = ((MR_Box) (LVar_59));
                MR_hl_field(MR_mktag(1), Produceds_14, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Unification_26, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word LVar_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Unification_26, (MR_Integer) 1))));
                  MR_Word RVar_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Unification_26, (MR_Integer) 2))));
                  MR_Word Var_65;

                  {
                    Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (RVar_64));
                    MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Useds_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Useds_13, 0) = ((MR_Box) (LVar_63));
                    MR_hl_field(MR_mktag(1), Useds_13, 1) = ((MR_Box) (Var_65));
                  }
                  Produceds_14 = (MR_Word) ((MR_Unsigned) 0U);
                }
                break;
      ...
      else
      {
        ...
        {
          MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr_15, (MR_Integer) 2))));
        ...
        {
          MR_Word Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr_15, (MR_Integer) 1))));
