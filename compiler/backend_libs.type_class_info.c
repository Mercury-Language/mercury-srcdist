...
{
  {
    ...
    MR_Word Var_15;
    MR_Word Var_16;
    MR_Word SymName_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassId_6, (MR_Integer) 0))));
    MR_Integer Arity_55 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ClassId_6, (MR_Integer) 1))));
    MR_Word ModuleName_56;
    MR_String ClassName_57;

    if (((MR_tag((MR_Word) SymName_54)) == (MR_Integer) 1))
    {
      ModuleName_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName_54, (MR_Integer) 0))));
      ClassName_57 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName_54, (MR_Integer) 1))));
    }
    else
    {
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.type_class_info.generate_class_name\'/1", (MR_String) "unqualified sym_name");
    ...
    {
      TCName_9 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TCName_9, 0) = ((MR_Box) (ModuleName_56));
      MR_hl_field(MR_mktag(0), TCName_9, 1) = ((MR_Box) (ClassName_57));
      MR_hl_field(MR_mktag(0), TCName_9, 2) = ((MR_Box) (Arity_55));
    }
