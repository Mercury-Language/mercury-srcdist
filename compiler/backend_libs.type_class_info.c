  ...
  MR_Word Instance_7)
{
  ...
  else
  {
    ...
    MethodProcLabels_22 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_proc_label_0), Var_32, MethodPredProcIds_21);
  }
  {
