...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&backend_libs__type_class_info_scalar_common_1[0]), (MR_Word) (&backend_libs__type_class_info_scalar_common_2[0]), Var_12, Classes_8, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_STATE_VARIABLE_RttiDatas_14_14);
