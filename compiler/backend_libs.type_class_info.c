    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Var_19;
        MR_Word TCName_43;
        MR_Word ClassVars_44;
        MR_Word ClassVarSet_45;
        MR_Word VarNames_46;
        MR_Word MethodPredProcIds_47;
        MR_Word MethodIds_48;
        MR_Word Var_49;
        MR_Word Var_50;
        MR_Word SymName_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassId_6, (MR_Integer) 0))));
        MR_Integer Arity_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ClassId_6, (MR_Integer) 1))));
        MR_Word ModuleName_76;
        MR_String ClassName_77;

        if (((MR_tag((MR_Word) SymName_74)) == (MR_Integer) 1))
        {
          ModuleName_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName_74, (MR_Integer) 0))));
          ClassName_77 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName_74, (MR_Integer) 1))));
        }
        else
          {
            mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.type_class_info.generate_class_name\'/1", (MR_String) "unqualified sym_name");
        ...
        {
          TCName_43 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TCName_43, 0) = ((MR_Box) (ModuleName_76));
          MR_hl_field(MR_mktag(0), TCName_43, 1) = ((MR_Box) (ClassName_77));
          MR_hl_field(MR_mktag(0), TCName_43, 2) = ((MR_Box) (Arity_75));
        }
        ClassVars_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_7, (MR_Integer) 4))));
        ClassVarSet_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_7, (MR_Integer) 8))));
        {
          Var_49 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&backend_libs__type_class_info_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (backend_libs__type_class_info__generate_class_decl_4_p_0_1));
          MR_hl_field(MR_mktag(0), Var_49, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_49, 3) = ((MR_Box) (ClassVarSet_45));
        }
        mercury__list__map_3_p_0((MR_Word) (&backend_libs__type_class_info_scalar_common_2[2]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_49, ClassVars_44, &VarNames_46);
        MethodPredProcIds_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_7, (MR_Integer) 7))));
        {
          Var_50 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&backend_libs__type_class_info_scalar_common_5[1]));
          MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (backend_libs__type_class_info__generate_class_decl_4_p_0_2));
        ...
        MethodIds_48 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_tc_method_id_0), Var_50, MethodPredProcIds_47);
        {
          ...
          MR_hl_field(MR_mktag(0), TCId_11, 0) = ((MR_Box) (TCName_43));
          MR_hl_field(MR_mktag(0), TCId_11, 1) = ((MR_Box) (VarNames_46));
          MR_hl_field(MR_mktag(0), TCId_11, 2) = ((MR_Box) (MethodIds_48));
        }
