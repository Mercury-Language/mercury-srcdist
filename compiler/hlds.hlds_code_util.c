...
MR_decl_label10(fn__hlds__hlds_code_util__cons_id_to_tag_2_0, 34,38,39,87,41,37,46,48,50,52)
...
MR_BEGIN_MODULE(hlds__hlds_code_util_module0)
	...
	MR_init_label10(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,34,38,39,87,41,37,46,48,50,52)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,41)
	...
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(fn__hlds__hlds_code_util__cons_id_to_tag_2_0_i87);
	}
