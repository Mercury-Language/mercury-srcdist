  ...
  MR_Integer * ProcId_8)
{
  ...
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&hlds__hlds_code_util_scalar_common_2[1]), Modes0_6, &Modes_9);
  ...
  MR_Integer * OurProcId_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      ProcId_10 = ((MR_Integer) ((MR_hl_field(0, P_5, (MR_Integer) 0))));
      ProcInfo_11 = ((MR_Word) ((MR_hl_field(0, P_5, (MR_Integer) 1))));
  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Mode1_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word Modes1_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word Mode2_7;
      MR_Word Modes2_8;
      MR_Word Inst1_10;
      MR_Word Inst2_11;
      ...
      if (succeeded)
      {
        Mode2_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
        Modes2_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
