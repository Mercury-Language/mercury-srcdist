...
static /* final */ const MR_Box hlds__hlds_code_util_scalar_common_3[2][1];
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    if (succeeded)
                      ...
                      ConsTag_6 = (MR_Word) ((MR_Unsigned) 4U);
                  }
                  break;
                case (MR_Integer) 1:
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 4:
            {
              ...
              ProcId_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_51, (MR_Integer) 1))));
              {
                ...
                MR_hl_field(MR_mktag(3), ConsTag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
          ...
          case (MR_Integer) 12:
            {
              ...
              {
                ConsTag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ConsTag_6, 0) = ((MR_Box) (Var_57));
              }
            }
            break;
          case (MR_Integer) 13:
            {
              ...
              {
                ConsTag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ConsTag_6, 0) = ((MR_Box) (Var_56));
              }
            }
            break;
          case (MR_Integer) 14:
            {
              ...
              {
                ConsTag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ConsTag_6, 0) = ((MR_Box) (Var_55));
              }
            }
            break;
          case (MR_Integer) 15:
          ...
          case (MR_Integer) 16:
            {
              ...
              {
                ConsTag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ConsTag_6, 0) = ((MR_Box) (Var_54));
              }
            }
            break;
          case (MR_Integer) 17:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ConsTag_6, 1) = ((MR_Box) (String_20));
              }
            }
            break;
          case (MR_Integer) 18:
