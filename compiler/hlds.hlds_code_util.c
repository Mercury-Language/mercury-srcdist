...
static /* final */ const MR_Box hlds__hlds_code_util_scalar_common_3[1][1];
  ...
  MR_Word * Result_6)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_11_11 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];

    succeeded = mercury__map__union_4_p_0(TypeInfo_11_11, TypeInfo_11_11, (MR_Word) &hlds__hlds_code_util_scalar_common_2[9], RenamingA_4, RenamingB_5, Result_6);
    return succeeded;
  }
}
  ...
  MR_Integer * ProcId_8)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_13_13 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0;
    MR_Word Modes_9;

    mercury__list__map_3_p_0(TypeCtorInfo_13_13, TypeCtorInfo_13_13, (MR_Word) &hlds__hlds_code_util_scalar_common_2[8], Modes0_6, &Modes_9);
    succeeded = hlds__hlds_code_util__get_procedure_matching_declmodes_with_renaming_2_4_p_0(Procs_5, Modes_9, ModuleInfo_7, ProcId_8);
    return succeeded;
  }
}
  ...
  MR_Integer * OurProcId_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__hlds_code_util__mode_list_matches_with_renaming_2_5_p_0(Modes_7, ArgModes_12, Var_22, &Renamings_21, ModuleInfo_8);
      if (succeeded)
      {
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstA_6)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = (InstB_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              if (succeeded)
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = ((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), InstB_7, (MR_Integer) 0)));
            succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_9, Var_54);
            if (succeeded)
            {
              TypeInfo_49_49 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
              mercury__map__init_1_p_0(TypeInfo_49_49, TypeInfo_49_49, Renaming_8);
              succeeded = MR_TRUE;
            }
          }
        }
      ...
      case (MR_Integer) 2:
        {
          MR_Word Uniq_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), InstA_6, (MR_Integer) 0)));
          MR_Word HOInstInfoA_11 = ((MR_Word) (MR_hl_field(MR_mktag(2), InstA_6, (MR_Integer) 1)));
          MR_Word HOInstInfoB_12;
          MR_Word Var_55;

          succeeded = ((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 2)));
          if (succeeded)
          {
            Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(2), InstB_7, (MR_Integer) 0)));
            HOInstInfoB_12 = ((MR_Word) (MR_hl_field(MR_mktag(2), InstB_7, (MR_Integer) 1)));
            succeeded = (Uniq_10 == Var_55);
            if (succeeded)
            {
              if ((HOInstInfoA_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                MR_Word TypeInfo_17_74;

                succeeded = (HOInstInfoB_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (succeeded)
                {
                  TypeInfo_17_74 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
                  *Renaming_8 = mercury__map__init_0_f_0(TypeInfo_17_74, TypeInfo_17_74);
                  succeeded = MR_TRUE;
                }
              }
              else
              {
                MR_Word PredInstInfoA_66 = (MR_Word) MR_body(((MR_Word) HOInstInfoA_11), (MR_Integer) 1);
                MR_Word PredInstInfoB_67;
                ...
                succeeded = ((MR_tag((MR_Word) HOInstInfoB_12)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                  PredInstInfoB_67 = (MR_Word) MR_body(((MR_Word) HOInstInfoB_12), (MR_Integer) 1);
                  PredOrFunc_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_66, (MR_Integer) 0)));
                  ModesA_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_66, (MR_Integer) 1)));
                  Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_66, (MR_Integer) 2)));
                  Detism_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_66, (MR_Integer) 3)));
                  Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_67, (MR_Integer) 0)));
                  ModesB_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_67, (MR_Integer) 1)));
                  Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_67, (MR_Integer) 2)));
                  Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_67, (MR_Integer) 3)));
                  succeeded = (PredOrFunc_68 == Var_75);
                  if (succeeded)
                  {
                    succeeded = (Detism_71 == Var_76);
                    if (succeeded)
                      succeeded = hlds__hlds_code_util__mode_list_matches_with_renaming_4_p_0(ModesA_69, ModesB_72, Renaming_8, ModuleInfo_5);
                  }
                }
              }
            }
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_40;
              MR_Word Uniq_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 1)));
              MR_Word Var_57;
              MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 2)));
              MR_Word Var_15;

              succeeded = ((((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
                Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 2)));
                BoundInstsB_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 3)));
                succeeded = (Uniq_44 == Var_57);
                if (succeeded)
                {
                  TypeInfo_50_50 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
                  Var_40 = mercury__map__init_0_f_0(TypeInfo_50_50, TypeInfo_50_50);
                  succeeded = hlds__hlds_code_util__match_corresponding_bound_inst_lists_with_renaming_5_p_0(ModuleInfo_5, BoundInstsA_14, BoundInstsB_16, Var_40, Renaming_8);
                }
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word Uniq_41 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 1)));
              MR_Word HOInstInfoA_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 2)));
              MR_Word HOInstInfoB_43;
              MR_Word Var_56;

              succeeded = ((((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
                HOInstInfoB_43 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 2)));
                succeeded = (Uniq_41 == Var_56);
                if (succeeded)
                {
                  if ((HOInstInfoA_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    MR_Word TypeInfo_17_89;

                    succeeded = (HOInstInfoB_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    if (succeeded)
                    {
                      TypeInfo_17_89 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
                      *Renaming_8 = mercury__map__init_0_f_0(TypeInfo_17_89, TypeInfo_17_89);
                      succeeded = MR_TRUE;
                    }
                  }
                  else
                  {
                    MR_Word PredInstInfoA_81 = (MR_Word) MR_body(((MR_Word) HOInstInfoA_42), (MR_Integer) 1);
                    MR_Word PredInstInfoB_82;
                    ...
                    succeeded = ((MR_tag((MR_Word) HOInstInfoB_43)) == (MR_mktag((MR_Integer) 1)));
                    if (succeeded)
                    {
                      PredInstInfoB_82 = (MR_Word) MR_body(((MR_Word) HOInstInfoB_43), (MR_Integer) 1);
                      PredOrFunc_83 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_81, (MR_Integer) 0)));
                      ModesA_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_81, (MR_Integer) 1)));
                      Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_81, (MR_Integer) 2)));
                      Detism_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoA_81, (MR_Integer) 3)));
                      Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_82, (MR_Integer) 0)));
                      ModesB_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_82, (MR_Integer) 1)));
                      Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_82, (MR_Integer) 2)));
                      Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredInstInfoB_82, (MR_Integer) 3)));
                      succeeded = (PredOrFunc_83 == Var_90);
                      if (succeeded)
                      {
                        succeeded = (Detism_86 == Var_91);
                        if (succeeded)
                          succeeded = hlds__hlds_code_util__mode_list_matches_with_renaming_4_p_0(ModesA_84, ModesB_87, Renaming_8, ModuleInfo_5);
                      }
                    }
                  }
                }
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 0)))) == (MR_Integer) 2)));
              if (succeeded)
              {
                VarB_18 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
                TypeInfo_51_51 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
                *Renaming_8 = mercury__map__singleton_2_f_0(TypeInfo_51_51, TypeInfo_51_51, ((MR_Box) (VarA_17)), ((MR_Box) (VarB_18)));
                succeeded = MR_TRUE;
              }
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  ListVarA_24 = mercury__set__to_sorted_list_1_f_0(TypeInfo_52_52, InstVarSetA_19);
                  ListVarB_25 = mercury__set__to_sorted_list_1_f_0(TypeInfo_52_52, InstVarSetB_21);
                  succeeded = ((MR_tag((MR_Word) ListVarA_24)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = ((MR_tag((MR_Word) ListVarB_25)) == (MR_mktag((MR_Integer) 1)));
                      if (succeeded)
                      {
                  ...
                  succeeded = mercury__map__search_3_p_0(TypeInfo_52_52, TypeInfo_52_52, Renaming0_23, ((MR_Box) (VarA_45)), &conv0_SpecVarB_28);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__hlds_code_util_scalar_common_1[1], ((MR_Box) (VarB_46)), ((MR_Box) (SpecVarB_28)));
                    if (succeeded)
                    {
                  ...
                  {
                    mercury__map__det_insert_4_p_0(TypeInfo_52_52, TypeInfo_52_52, ((MR_Box) (VarA_45)), ((MR_Box) (VarB_46)), Renaming0_23, Renaming_8);
                    succeeded = MR_TRUE;
                  }
                }
              }
          ...
          case (MR_Integer) 4:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) InstB_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 0)))) == (MR_Integer) 4)));
              if (succeeded)
              {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
                ArgsB_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 2)));
                succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Name_31, Var_58);
                if (succeeded)
                {
                  TypeInfo_53_53 = (MR_Word) &hlds__hlds_code_util_scalar_common_1[1];
                  Var_34 = mercury__map__init_0_f_0(TypeInfo_53_53, TypeInfo_53_53);
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstNameA_6)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = ((MR_tag((MR_Word) InstNameB_7)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstNameA_6, (MR_Integer) 0)))) {
          default:
            succeeded = MR_FALSE;
            break;
          case (MR_Integer) 0:
...
{
  {
    ...
    succeeded = hlds__hlds_code_util__mode_list_matches_with_renaming_2_5_p_0(ModesA_5, ModesB_6, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Renamings_9, ModuleInfo_8);
    if (succeeded)
    {
...
{
  {
    ...
    mercury__list__map_3_p_0(TypeCtorInfo_13_13, TypeCtorInfo_13_13, (MR_Word) &hlds__hlds_code_util_scalar_common_2[3], Modes0_6, &Modes_9);
...
{
  {
    ...
    hlds__hlds_code_util__type_to_string_2_p_0(((MR_Word) wrapper_arg_1), &conv2_String_4);
...
{
  {
    ...
    {
      ClassId_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    mercury__list__det_index1_3_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_instance_defn_0, InstanceList_14, InstanceNum_8, &conv1_InstanceDefn_15);
    ...
    Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 1)));
    Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 2)));
    Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 3)));
    Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 4)));
    Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 5)));
    Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 6)));
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 7)));
    Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 8)));
    Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstanceDefn_15, (MR_Integer) 9)));
    ...
    {
      ConsId_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ConsId_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 20));
...
{
  {
    ...
    {
      ConsId_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ConsId_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 19));
...
{
  {
    ...
    hlds__hlds_code_util__type_to_string_2_p_0(((MR_Word) wrapper_arg_1), &conv0_String_4);
...
{
  {
    ...
    switch (MR_tag((MR_Word) ConsId_5)) {
      ...
      case (MR_Integer) 0:
        {
          Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__hlds_code_util_scalar_common_1[4]);
        }
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_71;
          MR_Word ShroudedPredProcId_89 = ((MR_Word) (MR_hl_field(MR_mktag(2), ConsId_5, (MR_Integer) 0)));
          MR_Word PredId_90;
          MR_Integer ProcId_91;

          Var_71 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_89);
          PredId_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 0)));
          ProcId_91 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 1)));
          {
            Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
            MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_90));
            MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_91));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_69;
              MR_Word ShroudedPredProcId_95 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_96;
              MR_Integer ProcId_97;

              Var_69 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_95);
              PredId_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 0)));
              ProcId_97 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 1)));
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_96));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_97));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word Var_70;
              MR_Word ShroudedPredProcId_92 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_93;
              MR_Integer ProcId_94;

              Var_70 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_92);
              PredId_93 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_70, (MR_Integer) 0)));
              ProcId_94 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_70, (MR_Integer) 1)));
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_93));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_94));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word TypeCtor_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));
              MR_Word TypeTable_43;
              MR_Word TypeDefn_44;
              MR_Word TypeBody_45;
              MR_Word _Name_40 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer _Arity_41 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));

              hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_4, &TypeTable_43);
              hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_43, TypeCtor_42, &TypeDefn_44);
              hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_44, &TypeBody_45);
              switch (MR_tag((MR_Word) TypeBody_45)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word MaybeRepn_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_45, (MR_Integer) 2)));
                    MR_Word Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_45, (MR_Integer) 0)));
                    MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_45, (MR_Integer) 1)));
                    MR_Word Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_45, (MR_Integer) 3)));

                    if ((MaybeRepn_48 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      mercury__require__unexpected_2_p_0((MR_String) "function \140hlds.hlds_code_util.cons_id_to_tag\'/2", (MR_String) "MaybeRepn = no");
                    }
                    else
                    {
                      MR_Word Repn_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeRepn_48, (MR_Integer) 0)));
                      MR_Word ConsTagTable_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 0)));
                      MR_Word Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 1)));
                      MR_Word Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 2)));
                      MR_Word Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 3)));
                      MR_Word Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 4)));
                      MR_Word Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 5)));
                      MR_Word Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_50, (MR_Integer) 6)));
                      MR_Box conv0_Tag_6;

                      mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ConsTagTable_51, ((MR_Box) (ConsId_5)), &conv0_Tag_6);
                      Tag_6 = ((MR_Word) conv0_Tag_6);
                    }
                  }
                  break;
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Integer Arity_98 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              ...
              switch (TargetLang_39) {
                ...
                case (MR_Integer) 3:
                  {
                    succeeded = (Arity_98 == (MR_Integer) 0);
                    if (succeeded)
                    {
                      Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__hlds_code_util_scalar_common_1[3]);
                    }
                    else
                      Tag_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                  }
                  break;
                case (MR_Integer) 1:
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 4:
            {
              MR_Word ShroudedPredProcId_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_24;
              MR_Integer ProcId_25;
              MR_Word Var_73;

              Var_73 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_22);
              PredId_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 0)));
              ProcId_25 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 1)));
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_24));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_25));
                MR_hl_field(MR_mktag(3), Tag_6, 3) = NULL;
              }
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Integer Int_7 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_87;

              {
                Var_87 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (Int_7));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_87));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Unsigned UInt_8 = ((MR_Unsigned) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_86;

              {
                Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (UInt_8));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_86));
              }
            }
            break;
          case (MR_Integer) 7:
            {
              int8_t Int8_9 = ((int8_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_85;

              {
                Var_85 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Var_85, 0) = ((MR_Box) (MR_Word) (Int8_9));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_85));
              }
            }
            break;
          case (MR_Integer) 8:
            {
              uint8_t UInt8_10 = ((uint8_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_84;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_84, 1) = ((MR_Box) (MR_Word) (UInt8_10));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_84));
              }
            }
            break;
          case (MR_Integer) 9:
            {
              int16_t Int16_11 = ((int16_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_83;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (MR_Word) (Int16_11));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_83));
              }
            }
            break;
          case (MR_Integer) 10:
            {
              uint16_t UInt16_12 = ((uint16_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_82;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_82, 1) = ((MR_Box) (MR_Word) (UInt16_12));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_82));
              }
            }
            break;
          case (MR_Integer) 11:
            {
              int32_t Int32_13 = ((int32_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_81;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_81, 1) = ((MR_Box) (MR_Word) (Int32_13));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_81));
              }
            }
            break;
          case (MR_Integer) 12:
            {
              uint32_t UInt32_14 = ((uint32_t) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_80;

              {
                Var_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_80, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (MR_Word) (UInt32_14));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_80));
              }
            }
            break;
          case (MR_Integer) 13:
            {
              int64_t Int64_15 = MR_unbox_int64((MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_79;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_79, 1) = MR_box_int64(Int64_15);
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_79));
              }
            }
            break;
          case (MR_Integer) 14:
            {
              uint64_t UInt64_16 = MR_unbox_uint64((MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_78;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_78, 1) = MR_box_uint64(UInt64_16);
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_78));
              }
            }
            break;
          case (MR_Integer) 15:
            {
              MR_Float Float_17 = MR_unbox_float((MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Tag_6, 0) = MR_box_float(Float_17);
              }
            }
            break;
          case (MR_Integer) 16:
            {
              MR_Char Char_18 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer CharCode_19;
              MR_Word Var_77;

              mercury__char__to_int_2_p_0(Char_18, &CharCode_19);
              {
                Var_77 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (CharCode_19));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_77));
              }
            }
            break;
          case (MR_Integer) 17:
            {
              MR_String String_20 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Tag_6, 0) = ((MR_Box) (String_20));
              }
            }
            break;
          case (MR_Integer) 18:
          ...
          case (MR_Integer) 19:
            {
              MR_Word ModuleName_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_String TypeName_27 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_Integer Arity_28 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ModuleName_26));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (TypeName_27));
                MR_hl_field(MR_mktag(3), Tag_6, 3) = ((MR_Box) (Arity_28));
              }
            }
            break;
          case (MR_Integer) 20:
            {
              MR_Word ClassName_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_String EncodedArgs_31 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 4)));
              MR_Word ModuleName_88 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer _Instance_30 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ModuleName_88));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ClassName_29));
                MR_hl_field(MR_mktag(3), Tag_6, 3) = ((MR_Box) (EncodedArgs_31));
              }
            }
            break;
          case (MR_Integer) 21:
            {
              MR_Integer TIConstNum_33 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (TIConstNum_33));
              }
            }
            break;
          case (MR_Integer) 22:
            {
              MR_Integer TCIConstNum_34 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (TCIConstNum_34));
              }
            }
            break;
          case (MR_Integer) 23:
            {
              MR_Integer ConstNum_35 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word SubConsId_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_Word SubConsTag_37;

              SubConsTag_37 = hlds__hlds_code_util__cons_id_to_tag_2_f_0(ModuleInfo_4, SubConsId_36);
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ConstNum_35));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (SubConsTag_37));
              }
            }
            break;
        }
