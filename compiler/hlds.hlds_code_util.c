      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_54;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), InstA_6, (MR_Integer) 0)));
          MR_Unsigned packed_word_1;

          succeeded = ((MR_tag((MR_Word) InstB_7)) == (MR_Integer) 2);
          if (succeeded)
          {
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), InstB_7, (MR_Integer) 0)));
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_65, (MR_Integer) 0)));
                  ...
                  packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_65, (MR_Integer) 3)));
                  Detism_70 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_65, (MR_Integer) 3))) & (MR_Integer) 7);
                  packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoB_66, (MR_Integer) 0)));
                  ...
                  packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoB_66, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_56;
              MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_55;
              MR_Unsigned packed_word_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstA_6, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                packed_word_9 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstB_7, (MR_Integer) 1)));
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      packed_word_10 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_80, (MR_Integer) 0)));
                      ...
                      packed_word_11 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_80, (MR_Integer) 3)));
                      Detism_85 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoA_80, (MR_Integer) 3))) & (MR_Integer) 7);
                      packed_word_12 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoB_81, (MR_Integer) 0)));
                      ...
                      packed_word_13 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfoB_81, (MR_Integer) 3)));
