...
MR_decl_label7(fn__hlds__hlds_code_util__cons_id_to_tag_2_0, 34,38,37,42,44,46,48)
...
MR_BEGIN_MODULE(hlds__hlds_code_util_module0)
	...
	MR_init_label7(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,34,38,37,42,44,46,48)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,34)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__hlds__hlds_code_util__cons_id_to_tag_2_0_i38);
	}
...
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,37)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,10)) {
		MR_GOTO_LAB(fn__hlds__hlds_code_util__cons_id_to_tag_2_0_i42);
	}
	MR_tag_alloc_heap(MR_r1, 3, (MR_Integer) 4);
...
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,42)
	...
	if (!(((MR_tag(MR_r2) == MR_mktag((MR_Integer) 1)) || ((MR_Integer) MR_r2 == (MR_Integer) MR_tbmkword(0, 0))))) {
		MR_GOTO_LAB(fn__hlds__hlds_code_util__cons_id_to_tag_2_0_i44);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(3,1,1);
	MR_proceed();
MR_def_label(fn__hlds__hlds_code_util__cons_id_to_tag_2_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
