  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo__16_18 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
        Var_17 = mercury__map__init_0_f_0(TypeInfo__16_18, TypeInfo__16_18);
        TypeInfo__17_19 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[0]);
        succeeded = mercury__list__foldl_4_p_3(TypeInfo__17_19, TypeInfo__17_19, Var_16, Renamings_14, ((MR_Box) (Var_17)), &conv1_Var_13);
        if (succeeded)
          succeeded = MR_TRUE;
      }
      if (succeeded)
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              TypeInfo__47_47 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
              mercury__map__init_1_p_0(TypeInfo__47_47, TypeInfo__47_47, Renaming_8);
              succeeded = MR_TRUE;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              TypeInfo__46_46 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
              mercury__map__init_1_p_0(TypeInfo__46_46, TypeInfo__46_46, Renaming_8);
              succeeded = MR_TRUE;
            }
          }
          break;
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo__48_48 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
            mercury__map__init_1_p_0(TypeInfo__48_48, TypeInfo__48_48, Renaming_8);
            succeeded = MR_TRUE;
          }
        }
      }
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word TypeInfo__17_69;

              succeeded = (HOInstInfoB_12 == (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                TypeInfo__17_69 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                *Renaming_8 = mercury__map__init_0_f_0(TypeInfo__17_69, TypeInfo__17_69);
                succeeded = MR_TRUE;
              }
            }
            else
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__49_49 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                Var_39 = mercury__map__init_0_f_0(TypeInfo__49_49, TypeInfo__49_49);
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo__50_50 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
              *Renaming_8 = mercury__map__singleton_2_f_0(TypeInfo__50_50, TypeInfo__50_50, ((MR_Box) (VarA_17)), ((MR_Box) (VarB_18)));
              succeeded = MR_TRUE;
            }
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__51_51 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                ListVarA_24 = mercury__set__to_sorted_list_1_f_0(TypeInfo__51_51, InstVarSetA_19);
                ListVarB_25 = mercury__set__to_sorted_list_1_f_0(TypeInfo__51_51, InstVarSetB_21);
                ...
                succeeded = mercury__map__search_3_p_0(TypeInfo__51_51, TypeInfo__51_51, Renaming0_23, ((MR_Box) (VarA_44)), &conv0_SpecVarB_28);
                if (succeeded)
                {
                ...
                {
                  mercury__map__det_insert_4_p_0(TypeInfo__51_51, TypeInfo__51_51, ((MR_Box) (VarA_44)), ((MR_Box) (VarB_45)), Renaming0_23, Renaming_8);
                  succeeded = MR_TRUE;
                }
              }
            }
        ...
        case (MR_Integer) 4:
          {
            ...
            if (succeeded)
            {
              ...
              switch (MR_tag((MR_Word) InstNameA_29)) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        TypeInfo__29_92 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                        Var_91 = mercury__map__init_0_f_0(TypeInfo__29_92, TypeInfo__29_92);
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word TypeInfo__30_93;

                    succeeded = parse_tree__prog_data____Unify____inst_name_0_0(InstNameB_30, InstNameA_29);
                    if (succeeded)
                    {
                      TypeInfo__30_93 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                      *Renaming_8 = mercury__map__init_0_f_0(TypeInfo__30_93, TypeInfo__30_93);
                      succeeded = MR_TRUE;
                    }
                  }
                  break;
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__52_52 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
                Var_34 = mercury__map__init_0_f_0(TypeInfo__52_52, TypeInfo__52_52);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__25_25 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
          Var_22 = mercury__map__init_0_f_0(TypeInfo__25_25, TypeInfo__25_25);
          ...
          if (succeeded)
          {
            Var_28 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[5]);
            TypeInfo__11_29 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
            succeeded = mercury__map__union_4_p_0(TypeInfo__11_29, TypeInfo__11_29, Var_28, Renaming0_19, STATE_VARIABLE_Renaming_0_4, &STATE_VARIABLE_Renaming_23_23);
            if (succeeded)
            {
              // direct tailcall eliminated
              ;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo__11_21 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
          succeeded = mercury__map__union_4_p_0(TypeInfo__11_21, TypeInfo__11_21, Var_20, Renaming0_16, STATE_VARIABLE_Renaming_0_4, &STATE_VARIABLE_Renaming_19_19);
          if (succeeded)
          {
            // direct tailcall eliminated
            ;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo__29_29 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[0]);
                {
                ...
                mercury__list__append_3_p_1(TypeInfo__29_29, Var_24, HeadVar__3_3, &STATE_VARIABLE_Substs_25_25);
                // direct tailcall eliminated
                ;
  ...
  MR_Word * Renaming_8)
{
  ...
  if ((HOInstInfoA_6 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      TypeInfo__17_17 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
      *Renaming_8 = mercury__map__init_0_f_0(TypeInfo__17_17, TypeInfo__17_17);
      succeeded = MR_TRUE;
    }
  }
  else
  {
    MR_Word TypeInfo__16_24;
    MR_Word TypeInfo__17_25;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__16_24 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
            Var_23 = mercury__map__init_0_f_0(TypeInfo__16_24, TypeInfo__16_24);
            TypeInfo__17_25 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[0]);
            succeeded = mercury__list__foldl_4_p_3(TypeInfo__17_25, TypeInfo__17_25, Var_22, Renamings_20, ((MR_Box) (Var_23)), &conv1_Renaming_8);
            if (succeeded)
            {
  ...
  MR_Word ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    TypeInfo__16_16 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
    Var_12 = mercury__map__init_0_f_0(TypeInfo__16_16, TypeInfo__16_16);
    TypeInfo__17_17 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[0]);
    succeeded = mercury__list__foldl_4_p_3(TypeInfo__17_17, TypeInfo__17_17, Var_11, Renamings_9, ((MR_Box) (Var_12)), &conv1_Renaming_7);
    if (succeeded)
    {
