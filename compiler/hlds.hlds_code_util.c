      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_11_29 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
            succeeded = mercury__map__union_4_p_0(TypeInfo_11_29, TypeInfo_11_29, Var_28, Renaming0_19, STATE_VARIABLE_Renaming_0_4, &STATE_VARIABLE_Renaming_23_23);
            if (succeeded)
            {
              // direct tailcall eliminated
              ;
