  ...
  MR_Word * MatchingProcInfo_10)
{
  ...
  mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_7, &ProcPairs_12);
  ...
  MR_Word * MatchingProcInfo_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_13, &ArgModes_14);
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_55 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_23);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_59 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_67);
        ...
        case (MR_Integer) 2:
          {
            ...
            Var_61 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_73);
        ...
        case (MR_Integer) 3:
          {
            ...
            Var_60 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_70);
