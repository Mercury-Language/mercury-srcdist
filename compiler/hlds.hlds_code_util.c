        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__2_2 = As_12;
                MR_Word next_value_of_HeadVar__3_3 = Bs_14;
                MR_Word next_value_of_STATE_VARIABLE_Renaming_0_4 = STATE_VARIABLE_Renaming_23_23;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__2_2 = As_12;
              MR_Word next_value_of_HeadVar__3_3 = Bs_14;
              MR_Word next_value_of_STATE_VARIABLE_Renaming_0_4 = STATE_VARIABLE_Renaming_19_19;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_HeadVar__1_1 = ModesA_11;
                  MR_Word next_value_of_HeadVar__2_2 = ModesB_13;
                  MR_Word next_value_of_HeadVar__3_3 = STATE_VARIABLE_Substs_25_25;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_HeadVar__1_1 = Modes1_6;
                  MR_Word next_value_of_HeadVar__2_2 = Modes2_8;
...
{
  {
    ...
    mercury__string__append_list_2_p_0(InstanceStrings_34, &InstanceString_17);
    {
      ...
      MR_hl_field(MR_mktag(3), ConsId_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 18));
...
{
  {
    ...
    check_hlds__type_util__type_ctor_module_name_arity_4_p_0(TypeCtor_3, &ModuleName_5, &Name_6, &Arity_7);
    {
      ...
      MR_hl_field(MR_mktag(3), ConsId_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
...
{
  {
    ...
    switch (MR_tag((MR_Word) ConsId_5)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_64;
          MR_Word ShroudedPredProcId_80 = ((MR_Word) (MR_hl_field(MR_mktag(2), ConsId_5, (MR_Integer) 0)));
          MR_Word PredId_81;
          MR_Integer ProcId_82;

          Var_64 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_80);
          PredId_81 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 0)));
          ProcId_82 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 1)));
          {
            ...
            MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_81));
            MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_82));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_62;
              MR_Word ShroudedPredProcId_86 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_87;
              MR_Integer ProcId_88;

              Var_62 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_86);
              PredId_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_62, (MR_Integer) 0)));
              ProcId_88 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_62, (MR_Integer) 1)));
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_87));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_88));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word Var_63;
              MR_Word ShroudedPredProcId_83 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_84;
              MR_Integer ProcId_85;

              Var_63 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_83);
              PredId_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_63, (MR_Integer) 0)));
              ProcId_85 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_63, (MR_Integer) 1)));
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_84));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_85));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word TypeCtor_40 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));
              MR_Word TypeTable_41;
              MR_Word TypeDefn_42;
              MR_Word TypeBody_43;
              MR_Word _Name_38 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer _Arity_39 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));

              hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_4, &TypeTable_41);
              hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_41, TypeCtor_40, &TypeDefn_42);
              hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_42, &TypeBody_43);
              switch (MR_tag((MR_Word) TypeBody_43)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word ConsTagTable_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 1)));
                    MR_Word Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 0)));
                    MR_Word Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 2)));
                    MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 3)));
                    MR_Word Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 4)));
                    MR_Word Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 5)));
                    MR_Word Var_50 = ((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 6)))) & (MR_Integer) 1);
                    MR_Word Var_51 = ((((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 6)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
                    MR_Word Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_43, (MR_Integer) 7)));
                    MR_Box conv0_Tag_6;

                    mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ConsTagTable_45, ((MR_Box) (ConsId_5)), &conv0_Tag_6);
          ...
          case (MR_Integer) 3:
            {
              MR_Word Globals_36;
              MR_Word TargetLang_37;
              MR_Integer Arity_89 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_4, &Globals_36);
              libs__globals__get_target_2_p_0(Globals_36, &TargetLang_37);
              switch (TargetLang_37) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                case (MR_Integer) 3:
                  {
                    succeeded = (Arity_89 == (MR_Integer) 0);
                    if (succeeded)
                    {
          ...
          case (MR_Integer) 4:
            {
              MR_Word ShroudedPredProcId_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word PredId_22;
              MR_Integer ProcId_23;
              MR_Word Var_66;

              Var_66 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_20);
              PredId_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 0)));
              ProcId_23 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 1)));
              {
                ...
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (PredId_22));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ProcId_23));
          ...
          case (MR_Integer) 5:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (Int_7));
              }
              {
          ...
          case (MR_Integer) 6:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (UInt_8));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 7:
            {
              MR_Integer Int8_9 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_76;

              {
                Var_76 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Var_76, 0) = ((MR_Box) (Int8_9));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_76));
              }
            }
            break;
          case (MR_Integer) 8:
            {
              MR_Integer UInt8_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_75;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (UInt8_10));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_75));
              }
            }
            break;
          case (MR_Integer) 9:
            {
              MR_Integer Int16_11 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_74;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_74, 1) = ((MR_Box) (Int16_11));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_74));
              }
            }
            break;
          case (MR_Integer) 10:
            {
              MR_Integer UInt16_12 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_73;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_73, 1) = ((MR_Box) (UInt16_12));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_73));
              }
            }
            break;
          case (MR_Integer) 11:
            {
              MR_Integer Int32_13 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_72;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_72, 1) = ((MR_Box) (Int32_13));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_72));
              }
            }
            break;
          case (MR_Integer) 12:
            {
              MR_Integer UInt32_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word Var_71;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_71, 1) = ((MR_Box) (UInt32_14));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_71));
              }
            }
            break;
          case (MR_Integer) 13:
            {
              MR_Float Float_15 = MR_unbox_float((MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Tag_6, 0) = MR_box_float(Float_15);
              }
            }
            break;
          case (MR_Integer) 14:
            {
              MR_Char Char_16 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer CharCode_17;
              MR_Word Var_70;

              mercury__char__to_int_2_p_0(Char_16, &CharCode_17);
              {
                Var_70 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (CharCode_17));
              }
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (Var_70));
              }
            }
            break;
          case (MR_Integer) 15:
            {
              MR_String String_18 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Tag_6, 0) = ((MR_Box) (String_18));
              }
            }
            break;
          case (MR_Integer) 16:
          ...
          case (MR_Integer) 17:
            {
              MR_Word ModuleName_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_String TypeName_25 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_Integer Arity_26 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ModuleName_24));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (TypeName_25));
                MR_hl_field(MR_mktag(3), Tag_6, 3) = ((MR_Box) (Arity_26));
              }
            }
            break;
          case (MR_Integer) 18:
            {
              MR_Word ClassName_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_String EncodedArgs_29 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 4)));
              MR_Word ModuleName_79 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Integer _Instance_28 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 3)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ModuleName_79));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (ClassName_27));
                MR_hl_field(MR_mktag(3), Tag_6, 3) = ((MR_Box) (EncodedArgs_29));
              }
            }
            break;
          case (MR_Integer) 19:
            {
              MR_Integer TIConstNum_31 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (TIConstNum_31));
              }
            }
            break;
          case (MR_Integer) 20:
            {
              MR_Integer TCIConstNum_32 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));

              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (TCIConstNum_32));
              }
            }
            break;
          case (MR_Integer) 21:
            {
              MR_Integer ConstNum_33 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 1)));
              MR_Word SubConsId_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_5, (MR_Integer) 2)));
              MR_Word SubConsTag_35;

              SubConsTag_35 = hlds__hlds_code_util__cons_id_to_tag_2_f_0(ModuleInfo_4, SubConsId_34);
              {
                Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Tag_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                MR_hl_field(MR_mktag(3), Tag_6, 1) = ((MR_Box) (ConstNum_33));
                MR_hl_field(MR_mktag(3), Tag_6, 2) = ((MR_Box) (SubConsTag_35));
              }
            }
            break;
        }
