  ...
  MR_Integer * MatchingProcId_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_23 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[5]);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_30 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[4]);
            TypeInfo_11_34 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
            succeeded = mercury__map__union_4_p_0(TypeInfo_11_34, TypeInfo_11_34, Var_30, Renaming0_19, STATE_VARIABLE_Renaming_0_4, &STATE_VARIABLE_Renaming_23_23);
            if (succeeded)
            {
              // direct tailcall eliminated
              ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_23 = (MR_Word) (&hlds__hlds_code_util_scalar_common_2[3]);
          TypeInfo_11_27 = (MR_Word) (&hlds__hlds_code_util_scalar_common_1[1]);
          succeeded = mercury__map__union_4_p_0(TypeInfo_11_27, TypeInfo_11_27, Var_23, Renaming0_16, STATE_VARIABLE_Renaming_0_4, &STATE_VARIABLE_Renaming_19_19);
          if (succeeded)
          {
            // direct tailcall eliminated
            ;
