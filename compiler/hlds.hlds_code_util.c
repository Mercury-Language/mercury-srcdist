  ...
  MR_Word * HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ModeA_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      MR_Word ModesA_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
      MR_Word ModeB_13;
      MR_Word ModesB_14;
      ...
      if (succeeded)
      {
        ...
        ModesB_14 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
        succeeded = check_hlds__mode_util__mode_get_insts_semidet_4_p_0(ModuleInfo_1, ModeA_11, &InstAInitial_16, &InstAFinal_17);
        if (succeeded)
        {
          succeeded = check_hlds__mode_util__mode_get_insts_semidet_4_p_0(ModuleInfo_1, ModeB_13, &InstBInitial_18, &InstBFinal_19);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                mercury__list__append_3_p_1(TypeInfo_28_28, Var_24, HeadVar__4_4, &STATE_VARIABLE_Substs_25_25);
                // direct tailcall eliminated
                ;
                next_value_of_HeadVar__2_2 = ModesA_12;
                next_value_of_HeadVar__3_3 = ModesB_14;
                next_value_of_HeadVar__4_4 = STATE_VARIABLE_Substs_25_25;
                HeadVar__2_2 = next_value_of_HeadVar__2_2;
                HeadVar__3_3 = next_value_of_HeadVar__3_3;
