      ...
      case (MR_Integer) 2:
        {
          ...
          {
            hlds__hlds_code_util__Var_57 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(hlds__hlds_code_util__ShroudedPredProcId_64);
          }
          hlds__hlds_code_util__PredId_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_57, (MR_Integer) 0)));
          hlds__hlds_code_util__ProcId_66 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_57, (MR_Integer) 1)));
          {
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                hlds__hlds_code_util__Var_55 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(hlds__hlds_code_util__ShroudedPredProcId_70);
              }
              hlds__hlds_code_util__PredId_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_55, (MR_Integer) 0)));
              hlds__hlds_code_util__ProcId_72 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_55, (MR_Integer) 1)));
              {
                hlds__hlds_code_util__Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                hlds__hlds_code_util__Var_56 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(hlds__hlds_code_util__ShroudedPredProcId_67);
              }
              hlds__hlds_code_util__PredId_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_56, (MR_Integer) 0)));
              hlds__hlds_code_util__ProcId_69 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_56, (MR_Integer) 1)));
              {
                hlds__hlds_code_util__Tag_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word hlds__hlds_code_util__Var_59;

              {
                hlds__hlds_code_util__Var_59 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(hlds__hlds_code_util__ShroudedPredProcId_14);
              }
              hlds__hlds_code_util__PredId_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_59, (MR_Integer) 0)));
              hlds__hlds_code_util__ProcId_17 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_code_util__Var_59, (MR_Integer) 1)));
              {
