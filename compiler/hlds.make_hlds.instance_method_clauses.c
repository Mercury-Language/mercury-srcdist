  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  if (((MR_tag((MR_Word) InstanceProcDefn_16)) == (MR_Integer) 1))
  {
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_17, PredFormArity_27, Var_55, &ClausesInfo0_46);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&hlds__make_hlds__instance_method_clauses_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (hlds__make_hlds__instance_method_clauses__produce_instance_method_clauses_15_p_0_1));
