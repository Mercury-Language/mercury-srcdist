  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__135__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_55)
{
  ...
  {
    MR_Word InstanceClauses_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InstanceProcDefn_16, (MR_Integer) 0))));
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (PredFormArity_27));
    }
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_17, Var_69, Var_70, &ClausesInfo0_47);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&hlds__make_hlds__instance_method_clauses_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (hlds__make_hlds__instance_method_clauses__produce_instance_method_clauses_15_p_0_1));
      MR_hl_field(MR_mktag(0), Var_71, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_71, 3) = ((MR_Box) (PredOrFunc_17));
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) (Context_20));
      MR_hl_field(MR_mktag(0), Var_71, 5) = ((MR_Box) (InstanceStatus_21));
    }
  ...
  else
  {
    ...
    HeadVarVec_44 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[1]), PredOrFunc_17, HeadVars_31);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (IntroducedClause_39));
    ...
    Var_66 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
    {
      ...
      *ClausesInfo_22 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ExplicitVarTypes_40));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (VarTable_41));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (RttiVarMaps_42));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (TVarNameMap_43));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (HeadVarVec_44));
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (ClausesRep_45));
