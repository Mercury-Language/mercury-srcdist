...
static const MR_FA_PseudoTypeInfo_Struct1 hlds__make_hlds__instance_method_clauses__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0;

static MR_bool MR_CALL 
hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__138__1_2_p_0(
...
hlds__make_hlds__instance_method_clauses__produce_instance_method_clause_14_p_0(
  ...
  MR_Word STATE_VARIABLE_ClausesInfo_0_46,
  MR_Word * STATE_VARIABLE_ClausesInfo_47,
...
static /* final */ const MR_Box hlds__make_hlds__instance_method_clauses_scalar_common_2[1][17] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clauses_info_0)),
    ((MR_Box) (&hlds__make_hlds__instance_method_clauses__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0)),
    ((MR_Box) (&hlds__make_hlds__instance_method_clauses__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0))
  },
};
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__138__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
...
{
  MR_bool succeeded;
  MR_Word ClausePredOrFunc_25 = ((MR_Unsigned) ((MR_hl_field(0, InstanceClause_18, 0))) & (MR_Integer) 1);
  MR_Word PredSymName_26 = ((MR_Word) ((MR_hl_field(0, InstanceClause_18, 1))));
  MR_Word HeadTerms0_27 = ((MR_Word) ((MR_hl_field(0, InstanceClause_18, 2))));
  MR_Word ClauseVarSet_28 = ((MR_Word) ((MR_hl_field(0, InstanceClause_18, 3))));
  MR_Word MaybeBodyGoal_29 = ((MR_Word) ((MR_hl_field(0, InstanceClause_18, 4))));
  MR_Word Var_50;
  MR_Word StateVar_32;
...

  {
    ...
    MR_hl_field(0, Var_50, 0) = ((MR_Box) (&hlds__make_hlds__instance_method_clauses_scalar_common_3[0]));
    MR_hl_field(0, Var_50, 1) = ((MR_Box) (hlds__make_hlds__instance_method_clauses__produce_instance_method_clause_14_p_0_1));
    MR_hl_field(0, Var_50, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_50, 3) = ((MR_Box) (PredOrFunc_15));
    MR_hl_field(0, Var_50, 4) = ((MR_Box) (ClausePredOrFunc_25));
  }
  mercury__require__expect_3_p_0(Var_50, (MR_String) "predicate \140hlds.make_hlds.instance_method_clauses.produce_instance_method_clause\'/14", (MR_String) "PredOrFunc mismatch");
  ...
  if (succeeded)
  {
    MR_Word ResultSpec_34;
    MR_Word Var_54;
    MR_Word Var_55;

    *TVarSet_20 = TVarSet0_19;
    ResultSpec_34 = hlds__make_hlds__state_var__report_illegal_func_svar_result_raw_3_f_0(StateVarContext_33, ClauseVarSet_28, StateVar_32);
    Var_55 = parse_tree__maybe_error__get_any_errors_warnings2_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), MaybeBodyGoal_29);
    {
      Var_54 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_54, 0) = ((MR_Box) (ResultSpec_34));
      MR_hl_field(1, Var_54, 1) = ((MR_Box) (Var_55));
    }
    *STATE_VARIABLE_Specs_49 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Var_54, STATE_VARIABLE_Specs_0_48);
    *STATE_VARIABLE_ClausesInfo_47 = STATE_VARIABLE_ClausesInfo_0_46;
  ...
  {
    MR_Word BodyGoalSpecs_35 = ((MR_Word) ((MR_hl_field(0, MaybeBodyGoal_29, 0))));
    MR_Word Var_57;

    *TVarSet_20 = TVarSet0_19;
    Var_57 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), BodyGoalSpecs_35);
    *STATE_VARIABLE_Specs_49 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Var_57, STATE_VARIABLE_Specs_0_48);
    *STATE_VARIABLE_ModuleInfo_43 = STATE_VARIABLE_ModuleInfo_0_42;
    *STATE_VARIABLE_QualInfo_45 = STATE_VARIABLE_QualInfo_0_44;
    *STATE_VARIABLE_ClausesInfo_47 = STATE_VARIABLE_ClausesInfo_0_46;
  }
  ...
  {
    MR_Word BodyGoal_36 = ((MR_Word) ((MR_hl_field(1, MaybeBodyGoal_29, 0))));
    MR_Word BodyGoalWarningSpecs_37 = ((MR_Word) ((MR_hl_field(1, MaybeBodyGoal_29, 1))));
    MR_Word HeadTerms_38;
    MR_Word OldImportStatus_40;
    MR_Word PredStatus_41;
    MR_Word STATE_VARIABLE_Specs_3_58;

    STATE_VARIABLE_Specs_3_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), BodyGoalWarningSpecs_37, STATE_VARIABLE_Specs_0_48);
    hlds__make_hlds__state_var__expand_bang_state_pairs_in_terms_2_p_0(HeadTerms0_27, &HeadTerms_38);
    OldImportStatus_40 = (MR_Word) (InstanceStatus_17);
    PredStatus_41 = (MR_Word) (OldImportStatus_40);
    hlds__make_hlds__add_clause__add_clause_to_clauses_info_21_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), PredStatus_41, (MR_Word) ((MR_Unsigned) 0U), PredOrFunc_15, PredSymName_26, HeadTerms_38, Context_16, (MR_Word) ((MR_Unsigned) 0U), BodyGoal_36, ClauseVarSet_28, TVarSet0_19, TVarSet_20, STATE_VARIABLE_ClausesInfo_0_46, STATE_VARIABLE_ClausesInfo_47, STATE_VARIABLE_ModuleInfo_0_42, STATE_VARIABLE_ModuleInfo_43, STATE_VARIABLE_QualInfo_0_44, STATE_VARIABLE_QualInfo_45, STATE_VARIABLE_Specs_3_58, STATE_VARIABLE_Specs_49);
  }
}
  ...
  MR_Box * wrapper_arg_11)
{
  ...
  MR_Word conv1_STATE_VARIABLE_ClausesInfo_47;
  MR_Word conv0_STATE_VARIABLE_Specs_49;

  hlds__make_hlds__instance_method_clauses__produce_instance_method_clause_14_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_TVarSet_20, ((MR_Word) (wrapper_arg_4)), &conv3_STATE_VARIABLE_ModuleInfo_43, ((MR_Word) (wrapper_arg_6)), &conv2_STATE_VARIABLE_QualInfo_45, ((MR_Word) (wrapper_arg_8)), &conv1_STATE_VARIABLE_ClausesInfo_47, ((MR_Word) (wrapper_arg_10)), &conv0_STATE_VARIABLE_Specs_49);
  *wrapper_arg_3 = ((MR_Box) (conv4_TVarSet_20));
  *wrapper_arg_5 = ((MR_Box) (conv3_STATE_VARIABLE_ModuleInfo_43));
  *wrapper_arg_7 = ((MR_Box) (conv2_STATE_VARIABLE_QualInfo_45));
  *wrapper_arg_9 = ((MR_Box) (conv1_STATE_VARIABLE_ClausesInfo_47));
  *wrapper_arg_11 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_49));
}
  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  {
    MR_Word InstanceClausesCord_46 = ((MR_Word) ((MR_hl_field(1, InstanceProcDefn_16, 0))));
  ...
  {
    MR_Word InstancePredName_28 = ((MR_Word) ((MR_hl_field(0, InstanceProcDefn_16, 0))));
    ...
    succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_19, (MR_Integer) 15);
    if (succeeded)
      Purity_34 = (MR_Integer) 2;
    else
    {
      succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_19, (MR_Integer) 16);
      if (succeeded)
    ...
    Var_65 = hlds__hlds_clauses__init_unused_statevar_arg_map_0_f_0();
    {
      IntroducedClause_39 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(0, IntroducedClause_39, 5) = ((MR_Box) (Var_65));
      MR_hl_field(0, IntroducedClause_39, 6) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    }
    ...
    HeadVarVec_44 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[1]), PredOrFunc_17, HeadVars_31);
    {
      ...
      MR_hl_field(1, Var_67, 0) = ((MR_Box) (IntroducedClause_39));
      MR_hl_field(1, Var_67, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    hlds__hlds_clauses__set_clause_list_2_p_0(Var_67, &ClausesRep_45);
