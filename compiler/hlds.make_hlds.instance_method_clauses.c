...
hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__131__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__131__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  if (((MR_tag((MR_Word) InstanceProcDefn_16)) == (MR_Integer) 1))
  {
    ...
    MR_Word Var_69 = (MR_Word) (PredFormArity_27);
    MR_Word Var_70;
    MR_Word Var_71;
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_17, Var_69, Var_70, &ClausesInfo0_46);
    {
