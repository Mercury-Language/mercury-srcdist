  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  else
  {
    ...
    succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_19, (MR_Integer) 14);
    if (succeeded)
      Purity_34 = (MR_Integer) 2;
    else
    {
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_19, (MR_Integer) 15);
      if (succeeded)
