...
hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__140__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__140__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_56)
{
  ...
  else
  {
    ...
    OldImportStatus_45 = (MR_Word) (InstanceStatus_19);
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_61)
{
  ...
  else
  {
    ...
    Var_65 = hlds__hlds_pred__invalid_pred_id_0_f_0();
