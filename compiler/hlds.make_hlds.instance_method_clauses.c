  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  else
  {
    ...
    {
      IntroducedClause_39 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    ...
    HeadVarVec_44 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[1]), PredOrFunc_17, HeadVars_31);
    {
      ...
      MR_hl_field(1, Var_66, 0) = ((MR_Box) (IntroducedClause_39));
      MR_hl_field(1, Var_66, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    hlds__hlds_clauses__set_clause_list_2_p_0(Var_66, &ClausesRep_45);
    Var_68 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
    {
      MR_Word base;
      ...
      *ClausesInfo_22 = base;
      ...
      MR_hl_field(0, base, 7) = ((MR_Box) (Var_68));
