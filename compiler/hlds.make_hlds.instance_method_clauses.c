  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_56)
{
  ...
  succeeded = hlds__make_hlds__unravel_info__illegal_state_var_func_result_4_p_0(PredOrFunc_17, HeadTerms0_30, &StateVar_35, &StateVarContext_36);
  if (succeeded)
  {
    ...
    *TVarSet_22 = TVarSet0_21;
    ResultSpec_37 = hlds__make_hlds__unravel_info__report_illegal_func_svar_result_raw_3_f_0(StateVarContext_36, ClauseVarSet_31, StateVar_35);
