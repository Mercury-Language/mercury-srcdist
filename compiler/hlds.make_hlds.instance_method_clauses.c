...
hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__135__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__instance_method_clauses__IntroducedFrom__pred__produce_instance_method_clause__135__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
...

  {
    ...
    MR_hl_field(0, Var_54, 0) = ((MR_Box) (&hlds__make_hlds__instance_method_clauses_scalar_common_3[0]));
    MR_hl_field(0, Var_54, 1) = ((MR_Box) (hlds__make_hlds__instance_method_clauses__produce_instance_method_clause_14_p_0_1));
    MR_hl_field(0, Var_54, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_54, 3) = ((MR_Box) (PredOrFunc_15));
    MR_hl_field(0, Var_54, 4) = ((MR_Box) (ClausePredOrFunc_25));
  }
  ...
  if (succeeded)
  {
    ...
    *STATE_VARIABLE_Specs_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_59, STATE_VARIABLE_Specs_57_57);
  ...
  if (((MR_tag((MR_Word) MaybeBodyGoal_29)) == (MR_Integer) 0))
  {
    ...
    *TVarSet_20 = TVarSet0_19;
    *STATE_VARIABLE_Specs_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), BodyGoalSpecs_34, STATE_VARIABLE_Specs_0_52);
    *STATE_VARIABLE_ModuleInfo_47 = STATE_VARIABLE_ModuleInfo_0_46;
    *STATE_VARIABLE_QualInfo_49 = STATE_VARIABLE_QualInfo_0_48;
    *STATE_VARIABLE_ClausesInfo_51 = STATE_VARIABLE_ClausesInfo_0_50;
  }
  else
  {
    ...
    STATE_VARIABLE_Specs_61_61 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), BodyGoalWarningSpecs_36, STATE_VARIABLE_Specs_0_52);
    ...
    PredFormArity_44 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[4]), HeadTerms_37);
    {
      ...
      MR_hl_field(0, PFSymNameArity_45, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_15));
      MR_hl_field(0, PFSymNameArity_45, 1) = ((MR_Box) (PredSymName_26));
      MR_hl_field(0, PFSymNameArity_45, 2) = ((MR_Box) (PredFormArity_44));
    }
...
hlds__make_hlds__instance_method_clauses__produce_instance_method_clauses_15_p_0(
  ...
  MR_Word STATE_VARIABLE_TVarSet_0_48,
  MR_Word * STATE_VARIABLE_TVarSet_49,
  ...
  MR_Word * STATE_VARIABLE_Specs_55)
{
  ...
  {
    MR_Word InstanceClauses_46 = ((MR_Word) ((MR_hl_field(1, InstanceProcDefn_16, (MR_Integer) 0))));
    MR_Word ClausesInfo0_47;
    MR_Word Var_69;
    MR_Word Var_70;
    MR_Word Var_71;
    MR_Box conv9_STATE_VARIABLE_TVarSet_49;
    MR_Box conv8_STATE_VARIABLE_ModuleInfo_51;
    MR_Box conv7_STATE_VARIABLE_QualInfo_53;
    MR_Box conv6_ClausesInfo_22;
    MR_Box conv5_STATE_VARIABLE_Specs_55;

    {
      Var_69 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_69, 0) = ((MR_Box) (PredFormArity_27));
    }
    Var_70 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
    hlds__hlds_clauses__clauses_info_init_4_p_0(PredOrFunc_17, Var_69, Var_70, &ClausesInfo0_47);
    {
      Var_71 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_71, 0) = ((MR_Box) (&hlds__make_hlds__instance_method_clauses_scalar_common_2[0]));
      MR_hl_field(0, Var_71, 1) = ((MR_Box) (hlds__make_hlds__instance_method_clauses__produce_instance_method_clauses_15_p_0_1));
      MR_hl_field(0, Var_71, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(0, Var_71, 3) = ((MR_Box) (PredOrFunc_17));
      MR_hl_field(0, Var_71, 4) = ((MR_Box) (Context_20));
      MR_hl_field(0, Var_71, 5) = ((MR_Box) (InstanceStatus_21));
    }
    mercury__list__foldl5_12_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_clause_info_0), (MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[2]), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clauses_info_0), (MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[3]), Var_71, InstanceClauses_46, ((MR_Box) (STATE_VARIABLE_TVarSet_0_48)), &conv9_STATE_VARIABLE_TVarSet_49, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_50)), &conv8_STATE_VARIABLE_ModuleInfo_51, ((MR_Box) (STATE_VARIABLE_QualInfo_0_52)), &conv7_STATE_VARIABLE_QualInfo_53, ((MR_Box) (ClausesInfo0_47)), &conv6_ClausesInfo_22, ((MR_Box) (STATE_VARIABLE_Specs_0_54)), &conv5_STATE_VARIABLE_Specs_55);
    *STATE_VARIABLE_TVarSet_49 = ((MR_Word) (conv9_STATE_VARIABLE_TVarSet_49));
    *STATE_VARIABLE_ModuleInfo_51 = ((MR_Word) (conv8_STATE_VARIABLE_ModuleInfo_51));
    *STATE_VARIABLE_QualInfo_53 = ((MR_Word) (conv7_STATE_VARIABLE_QualInfo_53));
    *ClausesInfo_22 = ((MR_Word) (conv6_ClausesInfo_22));
    *STATE_VARIABLE_Specs_55 = ((MR_Word) (conv5_STATE_VARIABLE_Specs_55));
  }
  else
  {
    ...
    hlds__make_hlds__qual_info__construct_and_record_pred_or_func_call_8_p_0(Var_59, PredOrFunc_17, InstancePredName_28, HeadVars_31, GoalInfo_37, &IntroducedGoal_38, STATE_VARIABLE_QualInfo_0_52, STATE_VARIABLE_QualInfo_53);
    {
    ...
    HeadVarVec_44 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__instance_method_clauses_scalar_common_1[1]), PredOrFunc_17, HeadVars_31);
    {
      ...
      MR_hl_field(1, Var_64, 0) = ((MR_Box) (IntroducedClause_39));
      MR_hl_field(1, Var_64, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    hlds__hlds_clauses__set_clause_list_2_p_0(Var_64, &ClausesRep_45);
    ...
    *STATE_VARIABLE_TVarSet_49 = STATE_VARIABLE_TVarSet_0_48;
