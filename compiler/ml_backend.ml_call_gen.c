...
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__384__1_2_p_0(
  MR_Word ConvOutputStmts_30,
  MR_Word HeadVar__2_77);

static MR_bool MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__383__1_2_p_0(
  MR_Word ConvOutputDefns_29,
  MR_Word HeadVar__2_73);

static MR_bool MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__382__1_2_p_0(
  MR_Word OutputLvalsTypes_28,
  MR_Word HeadVar__2_69);

static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__264__1_8_p_0(
  MR_Word Context_15,
...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__676__2_8_p_0(
...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__676__1_8_p_0(
  MR_Word CodeModel_13,
  MR_Word Context_14,
  MR_Word ConvOutputStmts_36,
  MR_Word * LambdaHeadVar__1_67,
  ...
  MR_Word * STATE_VARIABLE_Info_47)
{
  ...
  ml_backend__ml_code_util__ml_gen_var_direct_list_3_p_0(STATE_VARIABLE_Info_0_46, ArgVars_13, &ArgLvals_20);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_48 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_21, ProgDataType_29);
              ...
              if (succeeded)
              {
                ValueType_36 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ValueLval_34, (MR_Integer) 2))));
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_51, 0) = ((MR_Box) (AddrLval_33));
                  }
                  {
                    Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (Var_51));
                    MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) (ValueType_36));
                  }
                  {
                    Var_52 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_52, 0) = ((MR_Box) (ValueLval_34));
                  }
                  Stmt_64 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(Var_50, Var_52, Context_15);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *Stmts_18 = base;
  ...
  MR_Word * STATE_VARIABLE_Info_62)
{
  ...
  ProcId_115 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CalleePredProcId_12, (MR_Integer) 1))));
  {
    _FuncProcLabel_26 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), _FuncProcLabel_26, 0) = ((MR_Box) (PredLabel_107));
    MR_hl_field(MR_mktag(0), _FuncProcLabel_26, 1) = ((MR_Box) (ProcId_115));
  }
  {
    FuncLabel_116 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), FuncLabel_116, 0) = ((MR_Box) (_FuncProcLabel_26));
    MR_hl_field(MR_mktag(0), FuncLabel_116, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    QualFuncLabel_117 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), QualFuncLabel_117, 0) = ((MR_Box) (PredModule_108));
    MR_hl_field(MR_mktag(0), QualFuncLabel_117, 1) = ((MR_Box) (FuncLabel_116));
  }
  {
    Var_120 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_120, 0) = ((MR_Box) (QualFuncLabel_117));
    MR_hl_field(MR_mktag(0), Var_120, 1) = ((MR_Box) (Signature_113));
  }
  Var_119 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Var_120)));
  {
    FuncRval_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), FuncRval_27, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), FuncRval_27, 1) = ((MR_Box) (Var_119));
  }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__384__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__383__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__382__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
            ...
            if (succeeded)
            {
              ...
              *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
                      ...
                      case (MR_Integer) 1:
                        {
...

                          {
                            ...
                            MR_hl_field(MR_mktag(2), Var_84, 0) = ((MR_Box) (TsccProcNum_50));
                          }
                          {
                          ...
                          {
                            Var_82 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(2), Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_call_gen_scalar_common_2[2])));
                            MR_hl_field(MR_mktag(2), Var_82, 1) = ((MR_Box) (Var_83));
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(3), SetSelectorStmt_54, 1) = ((MR_Box) (Var_82));
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(1), SetSelectorStmts_49, 1) = ((MR_Box) (*FuncDefns_17));
                          }
                        }
                        break;
                      case (MR_Integer) 0:
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (CommentStmt_42));
                MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) (*FuncDefns_17));
              }
              {
                Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (GotoStmt_57));
                MR_hl_field(MR_mktag(1), Var_91, 1) = ((MR_Box) (*FuncDefns_17));
              }
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      MR_Word Var_114 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 0))));
                      MR_Word Var_116 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1))) & (MR_Integer) 1);
                      MR_Word Var_117 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 2))));
                      MR_Unsigned packed_word_4;

                      {
                        InSccInfo_59 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), InSccInfo_59, 0) = ((MR_Box) (Var_114));
                        MR_hl_field(MR_mktag(0), InSccInfo_59, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (MR_Unsigned) (Var_116)));
                        MR_hl_field(MR_mktag(0), InSccInfo_59, 2) = ((MR_Box) (Var_117));
                      }
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      MR_Word Var_121 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 0))));
                      MR_Word Var_122 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
                      MR_Word Var_124 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 2))));
                      MR_Unsigned packed_word_6;

                      {
                        InSccInfo_105 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), InSccInfo_105, 0) = ((MR_Box) (Var_121));
                        MR_hl_field(MR_mktag(0), InSccInfo_105, 1) = (MR_Box) (((((MR_Unsigned) (Var_122) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
                        MR_hl_field(MR_mktag(0), InSccInfo_105, 2) = ((MR_Box) (Var_124));
                      }
    ...
    switch (MR_tag((MR_Word) Rval_3)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Rval_3, (MR_Integer) 0))))) {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word QualFuncLabel_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CodeAddr_27, (MR_Integer) 0))));
                    MR_Word FuncLabel_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncLabel_57, (MR_Integer) 1))));
                    MR_Word MaybeAux_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_60, (MR_Integer) 1))));
          ...
          case (MR_Integer) 4:
            {
              MR_Word SubRval_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_3, (MR_Integer) 2))));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) Lval_14)) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word Rval_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Lval_14, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  switch (MR_tag((MR_Word) GenericCall_11)) {
    ...
    case (MR_Integer) 3:
      ...
      {
        MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 1))));
        MR_Word Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 0))));
        ...
        else
        {
          ...
          if ((Var_72 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            SrcType_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcVarEntry_35, (MR_Integer) 1))));
            DstType_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DstVarEntry_36, (MR_Integer) 1))));
            DstIsDummy_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DstVarEntry_36, (MR_Integer) 2))) & (MR_Integer) 1);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_45);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_57, 0) = ((MR_Box) (SrcLval_37));
                  }
                  ...
                  Assign_47 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(DstLval_38, CastRval_46, Context_15);
                  {
                    ...
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *Stmts_18 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Assign_47));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
                break;
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__264__1_8_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), &conv7_LambdaHeadVar__1_120, &conv6_LambdaHeadVar__2_121, &conv5_LambdaHeadVar__3_122, ((MR_Word) (wrapper_arg_4)), &conv4_LambdaHeadVar__5_124);
  ...
  MR_Word * STATE_VARIABLE_Info_82)
{
  ...
  if (((MR_tag((MR_Word) GenericCall_11)) == (MR_Integer) 1))
  {
    ...
    ml_backend__ml_code_util__ml_gen_var_direct_3_p_0(STATE_VARIABLE_Info_0_81, TypeClassInfoVar_45, &ClosureLval_40);
    {
      ...
      MR_hl_field(MR_mktag(2), Var_101, 0) = ((MR_Box) (ClosureLval_40));
    }
    {
      BaseTypeclassInfoLval_51 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), BaseTypeclassInfoLval_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_3[2])));
      MR_hl_field(MR_mktag(0), BaseTypeclassInfoLval_51, 1) = ((MR_Box) (Var_101));
    ...
    MethodFieldNum_53 = (MR_Integer) ((MR_Unsigned) MethodNum_46 + (MR_Unsigned) Offset_52);
    {
      ...
      MR_hl_field(MR_mktag(2), Var_104, 0) = ((MR_Box) (MethodFieldNum_53));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), MethodFieldId_54, 0) = ((MR_Box) (Var_103));
    }
    {
      Var_108 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Var_108, 0) = ((MR_Box) (BaseTypeclassInfoLval_51));
    }
    {
      FuncLval_126 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FuncLval_126, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_3[2])));
      MR_hl_field(MR_mktag(0), FuncLval_126, 1) = ((MR_Box) (Var_108));
    ...
    FuncType_43 = (MR_Word) (MR_mkword(MR_mktag(2), (MR_Word) (Params_34)));
    {
      ...
      MR_hl_field(MR_mktag(2), Var_111, 0) = ((MR_Box) (FuncLval_126));
    }
    {
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FuncLval_42, 1) = ((MR_Box) (Var_92));
    ...
    FuncType_43 = (MR_Word) (MR_mkword(MR_mktag(2), (MR_Word) (Params_34)));
    {
      ...
      MR_hl_field(MR_mktag(2), Var_94, 0) = ((MR_Box) (FuncLval_42));
    }
    {
      FuncRval_44 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), FuncRval_44, 0) = ((MR_Box) ((MR_Unsigned) 3U));
      MR_hl_field(MR_mktag(3), FuncRval_44, 1) = ((MR_Box) (FuncType_43));
      MR_hl_field(MR_mktag(3), FuncRval_44, 2) = ((MR_Box) (Var_94));
    }
  }
    ...
    case (MR_Integer) 2:
      {
        ...
        CurrentContArgLvalsTypes_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CurrentCont_49, (MR_Integer) 2))));
        ...
        else
        {
          ...
          MR_Word Var_67;
          MR_Word Args0_72;
          MR_Word EnvPtrArg_73;
          MR_Word Args_74;
          MR_Word Var_76;

          ml_backend__ml_call_gen__ml_gen_cont_params_loop_3_p_0(RetLvalsTypes0_15, (MR_Integer) 1, &Args0_72);
          ml_backend__ml_code_util__ml_declare_env_ptr_arg_1_p_0(&EnvPtrArg_73);
          {
            Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (EnvPtrArg_73));
            MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          Args_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Args0_72, Var_76);
          {
            Params_53 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Params_53, 0) = ((MR_Box) (Args_74));
            MR_hl_field(MR_mktag(0), Params_53, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Params_53));
          }
          ...
          ml_backend__ml_code_util__ml_gen_call_current_success_cont_4_p_0(Context_17, &CallContStmt_57, STATE_VARIABLE_Info_28_63, STATE_VARIABLE_Info_35);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (CallContStmt_57));
          ...
          ml_backend__ml_code_util__ml_gen_label_func_6_p_0(*STATE_VARIABLE_Info_35, ContFuncLabel_54, Params_53, Context_17, CopyStmt_58, &ContFuncDefn_59);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *FuncDefns_19 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ContFuncDefn_59));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          ml_backend__ml_code_util__ml_get_env_ptr_1_p_0(&EnvPtrRval_60);
          {
            ...
            MR_hl_field(MR_mktag(0), Cont_23, 0) = ((MR_Box) (ContFuncLabelRval_55));
            MR_hl_field(MR_mktag(0), Cont_23, 1) = ((MR_Box) (EnvPtrRval_60));
            MR_hl_field(MR_mktag(0), Cont_23, 2) = ((MR_Box) (RetLvalsTypes0_15));
          }
        }
        ...
        EnvPtrRval_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cont_23, (MR_Integer) 1))));
        {
          ...
          MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (EnvPtrRval_25));
          MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (FuncPtrRval_24));
