...
{
  {
    ...
    MR_Word QualFuncLabel_20;
    MR_Word Var_25;
    MR_Word Var_26;
    MR_Word _ByRefOutputVars_14;
    MR_Word _CopiedOutputVars_15;
    MR_Word _PredId_17;

    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo_10);
    ml_backend__ml_code_util__ml_gen_pred_label_4_p_0(ModuleInfo_10, PredProcId_6, &PredLabel_11, &PredModule_12);
    ml_backend__ml_args_util__ml_gen_info_proc_params_6_p_0(PredProcId_6, &Params_13, &_ByRefOutputVars_14, &_CopiedOutputVars_15, STATE_VARIABLE_Info_0_21, STATE_VARIABLE_Info_22);
    Signature_16 = ml_backend__mlds__mlds_get_func_signature_1_f_0(Params_13);
    _PredId_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredProcId_6, (MR_Integer) 0)));
    ProcId_18 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PredProcId_6, (MR_Integer) 1)));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *ProcLabel_7 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (PredLabel_11));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ProcId_18));
    }
    {
      FuncLabel_19 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FuncLabel_19, 0) = ((MR_Box) (*ProcLabel_7));
      MR_hl_field(MR_mktag(0), FuncLabel_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      QualFuncLabel_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), QualFuncLabel_20, 0) = ((MR_Box) (PredModule_12));
      MR_hl_field(MR_mktag(0), QualFuncLabel_20, 1) = ((MR_Box) (FuncLabel_19));
    }
    {
      Var_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (QualFuncLabel_20));
      MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (Signature_16));
    }
    Var_25 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) Var_26);
    {
      MR_Word base;
...
{
  {
    ...
    ml_backend__ml_args_util__ml_gen_params_no_gc_stmts_8_p_0(ModuleInfo_22, PredOrFunc_25, CodeModel_26, ArgVars_12, ArgNames_24, BoxedArgTypes_21, ArgModes_13, &Params0_27);
