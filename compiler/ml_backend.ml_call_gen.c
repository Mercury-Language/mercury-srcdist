  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  switch (MR_tag((MR_Word) GenericCall_11)) {
    ...
    case (MR_Integer) 3:
      ...
      {
        MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 1))));
        MR_Word Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 0))));
        ...
        {
          MR_Word Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 1))));
          MR_Word Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0))));

          if ((Var_84 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word VarTable_45;
            MR_Word SrcVarEntry_46;
            MR_Word DstVarEntry_47;
            MR_Word SrcLval_48;
            MR_Word DstLval_49;
            MR_Word SrcType_51;
            MR_Word DstType_54;
            MR_Word DstIsDummy_55;
            MR_Word GroundTerm_59;

            ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_30, &VarTable_45);
            parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_45, Var_83, &SrcVarEntry_46);
            parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_45, Var_85, &DstVarEntry_47);
            ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_30, Var_83, SrcVarEntry_46, &SrcLval_48);
            ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_30, Var_85, DstVarEntry_47, &DstLval_49);
            SrcType_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcVarEntry_46, (MR_Integer) 1))));
            DstType_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DstVarEntry_47, (MR_Integer) 1))));
            DstIsDummy_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DstVarEntry_47, (MR_Integer) 2))) & (MR_Integer) 1);
            switch (DstIsDummy_55) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *Stmts_18 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_56);
                  {
                    Var_68 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_68, 0) = ((MR_Box) (SrcLval_48));
                  }
                  ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_56, SrcType_51, DstType_54, (MR_Integer) 0, Var_68, &CastRval_57);
                  Assign_58 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(DstLval_49, CastRval_57, Context_15);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *Stmts_18 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Assign_58));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
                break;
            ...
            *LocalVarDefns_16 = (MR_Word) ((MR_Unsigned) 0U);
            *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
            succeeded = ml_backend__ml_gen_info__ml_gen_info_search_const_var_3_p_0(STATE_VARIABLE_Info_0_30, Var_83, &GroundTerm_59);
            if (succeeded)
              ml_backend__ml_gen_info__ml_gen_info_set_const_var_4_p_0(Var_85, GroundTerm_59, STATE_VARIABLE_Info_0_30, STATE_VARIABLE_Info_31);
            else
              *STATE_VARIABLE_Info_31 = STATE_VARIABLE_Info_0_30;
          }
          else
