          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = ((((MR_tag((MR_Word) VarType_28)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, VarType_28, (MR_Integer) 0)))) == (MR_Integer) 1)));
                if (succeeded)
                {
  ...
  MR_Word * STATE_VARIABLE_Info_82)
{
  ...
  if (((MR_tag((MR_Word) GenericCall_11)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(3, FuncType_43, 0) = ((MR_Box) ((MR_Unsigned) 0U));
