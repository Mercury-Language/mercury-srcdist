            ...
            if (succeeded)
            {
              ...
              *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) (*FuncDefns_17));
              }
              {
                Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (GotoStmt_57));
                MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (*FuncDefns_17));
              }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_45);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_62, 0) = ((MR_Box) (SrcLval_37));
                  }
                  ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_45, SrcType_40, DstType_43, (MR_Integer) 0, Var_62, &CastRval_46);
