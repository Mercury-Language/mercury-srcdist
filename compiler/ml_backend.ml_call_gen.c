    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(Var_62, &ContFuncLabel_54, &ContFuncLabelRval_55, STATE_VARIABLE_Info_0_34, &STATE_VARIABLE_Info_2_63);
          ml_backend__ml_call_gen__ml_gen_copy_args_to_locals_loop_4_p_0(RetLvalsTypes0_15, (MR_Integer) 1, Context_17, &CopyStmts_56);
          ml_backend__ml_code_util__ml_gen_call_current_success_cont_4_p_0(Context_17, &CallContStmt_57, STATE_VARIABLE_Info_2_63, STATE_VARIABLE_Info_35);
          {
