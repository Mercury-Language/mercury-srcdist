          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word SimpleExpr_26 = ((MR_Word) ((MR_hl_field(0, SimpleCode_24, (MR_Integer) 1))));
              MR_Word VarType_28;
              ...
              if (succeeded)
              {
                ...
                succeeded = ((((MR_tag((MR_Word) VarType_28)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, VarType_28, (MR_Integer) 0)))) == (MR_Integer) 0)));
                if (succeeded)
                {
              ...
              if (succeeded)
              {
                ValueType_36 = ((MR_Word) ((MR_hl_field(3, ValueLval_34, (MR_Integer) 2))));
                {
...

                  {
                    ...
                    MR_hl_field(2, Var_51, 0) = ((MR_Box) (AddrLval_33));
                  }
                  {
                    Var_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_50, 0) = ((MR_Box) (Var_51));
                    MR_hl_field(1, Var_50, 1) = ((MR_Box) (ValueType_36));
                  }
                  {
                    Var_52 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(2, Var_52, 0) = ((MR_Box) (ValueLval_34));
                  }
                  Stmt_64 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(Var_50, Var_52, Context_15);
                  {
                    ...
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *Stmts_18 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) (Stmt_64));
                    MR_hl_field(1, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
              }
        ...
        case (MR_Integer) 2:
          {
            ...
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0(TestRval_40, Context_15, &Stmt_67, STATE_VARIABLE_Info_0_46, STATE_VARIABLE_Info_47);
            {
              ...
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *Stmts_18 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (Stmt_67));
              MR_hl_field(1, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          break;
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(2, HeadVar__2_2, 0) = ((MR_Box) (Lval_3));
        }
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Integer Int_4 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
        MR_Word Var_5;

        {
          Var_5 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Var_5, 0) = ((MR_Box) (Int_4));
        }
        {
          ...
          MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_5));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Unsigned UInt_6 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))));
        MR_Word Var_7;

        {
          Var_7 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, Var_7, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, Var_7, 1) = ((MR_Box) (UInt_6));
        }
        {
          HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_7));
        }
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            int8_t Int8_8 = ((int8_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_9;

            {
              Var_9 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_9, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, Var_9, 1) = ((MR_Box) (MR_Word) (Int8_8));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_9));
            }
          }
          break;
        case (MR_Integer) 1:
          {
            uint8_t UInt8_10 = ((uint8_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_11;

            {
              Var_11 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_11, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(3, Var_11, 1) = ((MR_Box) (MR_Word) (UInt8_10));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_11));
            }
          }
          break;
        case (MR_Integer) 2:
          {
            int16_t Int16_12 = ((int16_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_13;

            {
              Var_13 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_13, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(3, Var_13, 1) = ((MR_Box) (MR_Word) (Int16_12));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_13));
            }
          }
          break;
        case (MR_Integer) 3:
          {
            uint16_t UInt16_14 = ((uint16_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_15;

            {
              Var_15 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_15, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(3, Var_15, 1) = ((MR_Box) (MR_Word) (UInt16_14));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_15));
            }
          }
          break;
        case (MR_Integer) 4:
          {
            int32_t Int32_16 = ((int32_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_17;

            {
              Var_17 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_17, 0) = ((MR_Box) ((MR_Unsigned) 5U));
              MR_hl_field(3, Var_17, 1) = ((MR_Box) (MR_Word) (Int32_16));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_17));
            }
          }
          break;
        case (MR_Integer) 5:
          {
            uint32_t UInt32_18 = ((uint32_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_19;

            {
              Var_19 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_19, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(3, Var_19, 1) = ((MR_Box) (MR_Word) (UInt32_18));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_19));
            }
          }
          break;
        case (MR_Integer) 6:
          {
            int64_t Int64_20 = MR_unbox_int64((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_21;

            {
              Var_21 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_21, 0) = ((MR_Box) ((MR_Unsigned) 7U));
              MR_hl_field(3, Var_21, 1) = MR_box_int64(Int64_20);
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_21));
            }
          }
          break;
        case (MR_Integer) 7:
          {
            uint64_t UInt64_22 = MR_unbox_uint64((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_23;

            {
              Var_23 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_23, 0) = ((MR_Box) ((MR_Unsigned) 8U));
              MR_hl_field(3, Var_23, 1) = MR_box_uint64(UInt64_22);
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_23));
            }
          }
          break;
        case (MR_Integer) 8:
          {
            MR_Float Float_24 = MR_unbox_float((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Word Var_25;

            {
              Var_25 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_25, 0) = ((MR_Box) ((MR_Unsigned) 11U));
              MR_hl_field(3, Var_25, 1) = MR_box_float(Float_24);
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, HeadVar__2_2, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Var_25));
            }
          }
          break;
        case (MR_Integer) 9:
          {
            MR_Word Op_26 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Expr_27 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Var_28;
            ...
            Var_28 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(Expr_27);
            {
              ...
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Op_26));
              MR_hl_field(3, HeadVar__2_2, 2) = ((MR_Box) (Var_28));
            }
          }
          break;
        case (MR_Integer) 10:
          {
            MR_Word Op_29 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ExprA_30 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word ExprB_31 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Word Var_32;
            MR_Word Var_33;
            ...
            Var_33 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ExprB_31);
            {
              ...
              MR_hl_field(3, HeadVar__2_2, 1) = ((MR_Box) (Op_29));
              MR_hl_field(3, HeadVar__2_2, 2) = ((MR_Box) (Var_32));
              MR_hl_field(3, HeadVar__2_2, 3) = ((MR_Box) (Var_33));
            }
          }
          break;
      }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__384__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__383__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__382__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__264__1_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), &conv7_LambdaHeadVar__1_120, &conv6_LambdaHeadVar__2_121, &conv5_LambdaHeadVar__3_122, ((MR_Word) (wrapper_arg_4)), &conv4_LambdaHeadVar__5_124);
  ...
  MR_Word * STATE_VARIABLE_Info_82)
{
  ...
  if (((MR_tag((MR_Word) GenericCall_11)) == (MR_Integer) 1))
  {
    ...
    MR_Integer MethodNum_46 = ((MR_Integer) ((MR_hl_field(1, GenericCall_11, (MR_Integer) 1))));
    ...
    ml_backend__ml_code_util__ml_gen_var_direct_3_p_0(STATE_VARIABLE_Info_0_81, TypeClassInfoVar_45, &ClosureLval_40);
    {
      ...
      MR_hl_field(2, Var_101, 0) = ((MR_Box) (ClosureLval_40));
    }
    {
      ...
      MR_hl_field(0, BaseTypeclassInfoLval_51, 1) = ((MR_Box) (Var_101));
    ...
    MethodFieldNum_53 = (MR_Integer) ((MR_Unsigned) MethodNum_46 + (MR_Unsigned) Offset_52);
    {
      ...
      MR_hl_field(2, Var_104, 0) = ((MR_Box) (MethodFieldNum_53));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(0, MethodFieldId_54, 0) = ((MR_Box) (Var_103));
    }
    {
      Var_108 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(2, Var_108, 0) = ((MR_Box) (BaseTypeclassInfoLval_51));
    }
    {
      FuncLval_126 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, FuncLval_126, 0) = ((MR_Box) (MR_mkword(1, &ml_backend__ml_call_gen_scalar_common_3[2])));
      MR_hl_field(0, FuncLval_126, 1) = ((MR_Box) (Var_108));
      MR_hl_field(0, FuncLval_126, 2) = ((MR_Box) ((MR_Unsigned) 20U));
      MR_hl_field(0, FuncLval_126, 3) = ((MR_Box) (MethodFieldId_54));
      MR_hl_field(0, FuncLval_126, 4) = ((MR_Box) ((MR_Unsigned) 20U));
    }
    FuncType_43 = (MR_Word) (MR_mkword(2, (MR_Word) (Params_34)));
    {
      Var_111 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(2, Var_111, 0) = ((MR_Box) (FuncLval_126));
    }
    {
      ...
      MR_hl_field(3, FuncRval_44, 2) = ((MR_Box) (Var_111));
    }
  }
  else
  {
  ...
  ConvVarNum_56 = (MR_Integer) (ConvVarSeq_55);
  {
    ...
    MR_hl_field(3, Var_113, 0) = ((MR_Box) ((MR_Unsigned) 3U));
    MR_hl_field(3, Var_113, 1) = ((MR_Box) (ConvVarNum_56));
  }
  {
    ...
    MR_hl_field(3, FuncVarName_57, 1) = ((MR_Box) (Var_113));
  }
  ...
  ml_backend__ml_args_util__ml_gen_args_13_p_0(PredOrFunc_25, CodeModel_26, Context_15, (MR_Integer) 1, BoxedArgTypes_21, ArgModes_13, CallerArgs_62, &InputRvals_63, &OutputLvalsTypes_64, &ConvArgLocalVarDefns_65, &ConvOutputStmts_66, STATE_VARIABLE_Info_112_112, &STATE_VARIABLE_Info_115_115);
  {
    ...
    MR_hl_field(2, Var_116, 0) = ((MR_Box) (ClosureLval_40));
  }
  {
    ...
    MR_hl_field(3, ClosureRval_67, 2) = ((MR_Box) (Var_116));
  }
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(1, Var_117, 0) = ((MR_Box) (ClosureRval_67));
      MR_hl_field(1, Var_117, 1) = ((MR_Box) (InputRvals_63));
    }
  ...
  else
  {
...

    {
      ...
      MR_hl_field(1, Var_119, 0) = ((MR_Box) (ClosureRval_67));
      MR_hl_field(1, Var_119, 1) = ((MR_Box) (InputRvals_63));
    }
    {
      ...
      MR_hl_field(0, DoGenCall_71, 5) = ((MR_Box) (Var_119));
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          ml_backend__ml_code_util__ml_declare_env_ptr_arg_1_p_0(&EnvPtrArg_73);
          {
            ...
            MR_hl_field(1, Var_76, 0) = ((MR_Box) (EnvPtrArg_73));
          ...
          Args_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Args0_72, Var_76);
          {
            ...
            MR_hl_field(0, Params_53, 0) = ((MR_Box) (Args_74));
