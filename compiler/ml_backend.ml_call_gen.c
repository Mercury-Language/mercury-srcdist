                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word QualFuncLabel_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CodeAddr_28, (MR_Integer) 0))));
                    MR_Word FuncLabel_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncLabel_58, (MR_Integer) 1))));
                    MR_Word MaybeAux_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_61, (MR_Integer) 1))));

                    switch (MR_tag((MR_Word) MaybeAux_63)) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(MaybeAux_63)) {
                          default:
                            succeeded = MR_FALSE;
                            break;
                          case (MR_Integer) 1:
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) Lval_14)) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word Rval_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Lval_14, (MR_Integer) 1))));
                    MR_Word next_value_of_Rval_3 = Rval_69;
