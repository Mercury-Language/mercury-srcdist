...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__267__1_7_p_0(
  ...
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__1_120,
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__2_121,
  MR_Word ml_backend__ml_call_gen__LambdaHeadVar__3_122,
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__4_123);

static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_call__400__1_7_p_0(
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_2[1][15];

static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_3[2][10];

static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_4[1][3];

static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_5[5][1];
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_1[6][2] = {
  ...
  /* row 4 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_call_gen_scalar_common_5[0])))
  },
  /* row 5 */
  {
    ((MR_Box) (MR_Word) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_call_gen_scalar_common_5[2])))
  },
};
...
{
  {
    ...
    *ml_backend__ml_call_gen__LambdaHeadVar__1_120 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      ml_backend__ml_code_util__ml_gen_success_5_p_0(ml_backend__ml_call_gen__CodeModel_24, ml_backend__ml_call_gen__Context_14, &ml_backend__ml_call_gen__SucceedStmts_75, ml_backend__ml_call_gen__LambdaHeadVar__3_122, ml_backend__ml_call_gen__LambdaHeadVar__4_123);
    }
    {
      *ml_backend__ml_call_gen__LambdaHeadVar__2_121 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_statement_0, ml_backend__ml_call_gen__ConvOutputStatements_65, ml_backend__ml_call_gen__SucceedStmts_75);
    }
  }
}
    ...
    switch (MR_tag((MR_Word) ml_backend__ml_call_gen__HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Float ml_backend__ml_call_gen__Float_8 = MR_unbox_float((MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 1)));
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_9, 1) = MR_box_float(ml_backend__ml_call_gen__Float_8);
              }
              {
                ml_backend__ml_call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 1:
            {
              MR_Word ml_backend__ml_call_gen__Op_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ml_backend__ml_call_gen__Expr_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ml_backend__ml_call_gen__Var_12;
              MR_Word ml_backend__ml_call_gen__Var_13;

              {
                ml_backend__ml_call_gen__Var_12 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_12, 0) = ((MR_Box) (ml_backend__ml_call_gen__Op_10));
              }
              {
                ml_backend__ml_call_gen__Var_13 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__Expr_11);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_12));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 2) = ((MR_Box) (ml_backend__ml_call_gen__Var_13));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word ml_backend__ml_call_gen__Op_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ml_backend__ml_call_gen__ExprA_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ml_backend__ml_call_gen__ExprB_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 3)));
              MR_Word ml_backend__ml_call_gen__Var_17;
              MR_Word ml_backend__ml_call_gen__Var_18;

              {
                ml_backend__ml_call_gen__Var_17 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__ExprA_15);
              }
              {
                ml_backend__ml_call_gen__Var_18 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__ExprB_16);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 1) = ((MR_Box) (ml_backend__ml_call_gen__Op_14));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 2) = ((MR_Box) (ml_backend__ml_call_gen__Var_17));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 3) = ((MR_Box) (ml_backend__ml_call_gen__Var_18));
              }
            }
            break;
        }
                          ...
                          if (ml_backend__ml_call_gen__succeeded)
                            {
                              ...
                              ml_backend__ml_call_gen__Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__ArgLval_50, (MR_Integer) 1)));
                              ml_backend__ml_call_gen__Var_84 = ml_backend__ml_call_gen__Rval_95;
                            }
                          else
                            {
                              ml_backend__ml_call_gen__Var_84 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_84, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
...
{
  {
    ...
    if ((ml_backend__ml_call_gen__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word ml_backend__ml_call_gen__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word ml_backend__ml_call_gen__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__HeadVar__2_2, (MR_Integer) 0)));
        ...
        if ((ml_backend__ml_call_gen__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              ml_backend__ml_call_gen__Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_22, 0) = ((MR_Box) (ml_backend__ml_call_gen__ArgLval_20));
            }
            {
              ml_backend__ml_call_gen__Statement_17 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ml_backend__ml_call_gen__Var_44, ml_backend__ml_call_gen__Var_22, ml_backend__ml_call_gen__Context_5);
            }
            ml_backend__ml_call_gen__Var_23 = (ml_backend__ml_call_gen__ArgNum_4 + (MR_Integer) 1);
            {
              ml_backend__ml_call_gen__ml_gen_copy_args_to_locals_2_6_p_0(ml_backend__ml_call_gen__HeadVar__1_1, ml_backend__ml_call_gen__Var_43, ml_backend__ml_call_gen__Types_14, ml_backend__ml_call_gen__Var_23, ml_backend__ml_call_gen__Context_5, &ml_backend__ml_call_gen__Statements_18);
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((ml_backend__ml_call_gen__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *ml_backend__ml_call_gen__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        {
          ml_backend__ml_call_gen__ml_gen_cont_params_2_3_p_0(ml_backend__ml_call_gen__Types_6, ml_backend__ml_call_gen__Var_13, &ml_backend__ml_call_gen__Arguments_9);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (ml_backend__ml_call_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(ml_backend__ml_call_gen__Var_32, &ml_backend__ml_call_gen__ContFuncLabel_20, &ml_backend__ml_call_gen__ContFuncLabelRval_21, ml_backend__ml_call_gen__STATE_VARIABLE_Info_31_31, &ml_backend__ml_call_gen__STATE_VARIABLE_Info_33_33);
        }
        {
        ...
        {
          ml_backend__ml_call_gen__Var_35 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_statement_0, ml_backend__ml_call_gen__CopyStatements_23, ml_backend__ml_call_gen__Var_36);
        }
        {
          ml_backend__ml_call_gen__CopyStatement_25 = ml_backend__ml_code_util__ml_gen_block_3_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_call_gen__Var_35, ml_backend__ml_call_gen__Context_10);
        }
        {
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__Statement_41;
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            ml_backend__ml_call_gen__ml_gen_success_cont_7_p_0(ml_backend__ml_call_gen__RetTypes0_18, ml_backend__ml_call_gen__RetLvals0_17, ml_backend__ml_call_gen__Context_20, &ml_backend__ml_call_gen__Cont_25, ml_backend__ml_call_gen__Decls_21, ml_backend__ml_call_gen__STATE_VARIABLE_Info_0_42, ml_backend__ml_call_gen__STATE_VARIABLE_Info_43);
          }
          ...
          {
            ml_backend__ml_gen_info__ml_gen_info_use_gcc_nested_functions_2_p_0(*ml_backend__ml_call_gen__STATE_VARIABLE_Info_43, &ml_backend__ml_call_gen__UseNestedFuncs_31);
          }
            ...
            case (MR_Integer) 0:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_48, 0) = ((MR_Box) (ml_backend__ml_call_gen__EnvPtrRval_28));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_47, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncPtrRval_27));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_47, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_48));
                }
                {
                  ml_backend__ml_call_gen__ArgRvals_32 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, ml_backend__ml_call_gen__ArgRvals0_16, ml_backend__ml_call_gen__Var_47);
                }
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ml_backend__ml_call_gen__Var_50;

                {
                  ml_backend__ml_call_gen__Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_50, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncPtrRval_27));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_50, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ml_backend__ml_call_gen__ArgRvals_32 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, ml_backend__ml_call_gen__ArgRvals0_16, ml_backend__ml_call_gen__Var_50);
                }
              }
              break;
          }
          {
            ml_backend__ml_gen_info__ml_gen_info_get_globals_2_p_0(*ml_backend__ml_call_gen__STATE_VARIABLE_Info_43, &ml_backend__ml_call_gen__Globals_33);
          }
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_call_gen__Globals_33, (MR_Integer) 266, &ml_backend__ml_call_gen__NondetCopyOut_34);
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ml_backend__ml_code_util__ml_success_lval_2_p_0(ml_backend__ml_call_gen__STATE_VARIABLE_Info_0_42, &ml_backend__ml_call_gen__Success_36);
          }
          ml_backend__ml_call_gen__ArgRvals_32 = ml_backend__ml_call_gen__ArgRvals0_16;
          {
            ml_backend__ml_call_gen__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_44, 0) = ((MR_Box) (ml_backend__ml_call_gen__Success_36));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ml_backend__ml_call_gen__RetLvals_35 = mercury__list__append_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0, ml_backend__ml_call_gen__Var_44, ml_backend__ml_call_gen__RetLvals0_17);
          }
          *ml_backend__ml_call_gen__Decls_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          *ml_backend__ml_call_gen__STATE_VARIABLE_Info_43 = ml_backend__ml_call_gen__STATE_VARIABLE_Info_0_42;
        }
    ...
    {
      ml_backend__ml_gen_info__ml_gen_info_get_disabled_warnings_2_p_0(*ml_backend__ml_call_gen__STATE_VARIABLE_Info_43, &ml_backend__ml_call_gen__Warnings_38);
    }
    {
    ...
    {
      ml_backend__ml_call_gen__Stmt_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      ml_backend__ml_call_gen__Var_55 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_call_gen__Context_20);
    }
    {
      ml_backend__ml_call_gen__Statement_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Statement_41, 0) = ((MR_Box) (ml_backend__ml_call_gen__Stmt_40));
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Statement_41, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_55));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_call_gen__Statements_22 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_call_gen__Statement_41));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_120;
    MR_Word ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_121;
    MR_Word ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_123;

    {
      ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__267__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 5))), &ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_120, &ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_121, ((MR_Word) ml_backend__ml_call_gen__wrapper_arg_3), &ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_123);
    }
    *ml_backend__ml_call_gen__wrapper_arg_1 = ((MR_Box) (ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_120));
    *ml_backend__ml_call_gen__wrapper_arg_2 = ((MR_Box) (ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_121));
    *ml_backend__ml_call_gen__wrapper_arg_4 = ((MR_Box) (ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_123));
  }
}
...
{
  {
    ...
    *ml_backend__ml_call_gen__wrapper_arg_4 = ((MR_Box) (ml_backend__ml_call_gen__conv0_STATE_VARIABLE_Info_43));
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__STATE_VARIABLE_Info_114_114;
    ...
    ml_backend__ml_call_gen__RetParam_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Params0_25, (MR_Integer) 1)));
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_82, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_4[0]));
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_call_gen__GenericCall_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_Word ml_backend__ml_call_gen__FuncLval_125;
        ...
        ml_backend__ml_call_gen__Var_86 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_5[0]);
        {
          ml_backend__ml_call_gen__Var_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_88, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureLval_37));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__BaseTypeclassInfoLval_48, 2) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_5[1]));
        ...
        {
          ml_backend__ml_call_gen__Var_91 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ml_backend__ml_call_gen__Var_91, 0) = ((MR_Box) (ml_backend__ml_call_gen__MethodFieldNum_50));
        }
        {
          ml_backend__ml_call_gen__Var_90 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_90, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
        ...
        {
          ml_backend__ml_call_gen__Var_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_94, 0) = ((MR_Box) (ml_backend__ml_call_gen__BaseTypeclassInfoLval_48));
        }
        {
          ml_backend__ml_call_gen__FuncLval_125 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_125, 0) = ((MR_Box) (ml_backend__ml_call_gen__Var_86));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_125, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_94));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_125, 2) = ((MR_Box) (ml_backend__ml_call_gen__MethodFieldId_51));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_125, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_125, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
        }
        ...
        {
          ml_backend__ml_call_gen__Var_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_98, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncLval_125));
        }
        {
    ...
    else
      {
        ...
        {
          ml_backend__ml_call_gen__Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_104, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureLval_37));
        }
        {
          ml_backend__ml_call_gen__FuncLval_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_5[0])));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_104));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 2) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_5[3]));
        ...
        {
          ml_backend__ml_call_gen__Var_107 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_107, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncLval_39));
        }
        {
          ml_backend__ml_call_gen__FuncRval_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
    ...
    {
      ml_backend__ml_call_gen__Var_110 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_110, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_110, 1) = ((MR_Box) (ml_backend__ml_call_gen__FuncVarName_54));
    }
    {
      ml_backend__ml_call_gen__Var_111 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_call_gen__Context_14);
    }
    {
      ml_backend__ml_call_gen__FuncVarDecl_55 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(ml_backend__ml_call_gen__Var_110, ml_backend__ml_call_gen__FuncType_40, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_call_gen__Var_111);
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ClosureRval_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_5[4])));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ClosureRval_66, 2) = ((MR_Box) (ml_backend__ml_call_gen__Var_116));
    }
    ...
    if (ml_backend__ml_call_gen__succeeded)
      {
        ...
        {
          ml_backend__ml_call_gen__Var_117 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_117, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureRval_66));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_117, 1) = ((MR_Box) (ml_backend__ml_call_gen__InputRvals_61));
        }
        {
          ml_backend__ml_call_gen__ml_gen_mlds_call_12_p_0(ml_backend__ml_call_gen__Signature_32, ml_backend__ml_call_gen__ObjectRval_67, ml_backend__ml_call_gen__FuncVarRval_58, ml_backend__ml_call_gen__Var_117, ml_backend__ml_call_gen__OutputLvals_62, ml_backend__ml_call_gen__OutputTypes_63, ml_backend__ml_call_gen__Determinism_13, ml_backend__ml_call_gen__Context_14, &ml_backend__ml_call_gen__Decls0_68, &ml_backend__ml_call_gen__Statements0_69, ml_backend__ml_call_gen__STATE_VARIABLE_Info_114_114, ml_backend__ml_call_gen__STATE_VARIABLE_Info_79);
        }
      }
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_119, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureRval_66));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_119, 1) = ((MR_Box) (ml_backend__ml_call_gen__InputRvals_61));
        }
        {
          ml_backend__ml_call_gen__DoGenCall_70 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 11 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenCall_70, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_2[0]));
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenCall_70, 6) = ((MR_Box) (ml_backend__ml_call_gen__Var_119));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenConvOutputAndSucceed_71, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_3[1]));
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            ml_backend__ml_call_gen__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_15, 0) = ((MR_Box) (ml_backend__ml_call_gen__EnvPtrArg_11));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_15, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ml_backend__ml_call_gen__Args_10 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0, ml_backend__ml_call_gen__Args0_8, ml_backend__ml_call_gen__Var_15);
          }
        }
        break;
      case (MR_Integer) 1:
...
{
  {
    ...
    {
      ml_backend__ml_call_gen__Var_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Var_22, 0) = ((MR_Box) (ml_backend__ml_call_gen__QualifiedProcLabel_16));
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Var_22, 1) = ((MR_Box) (ml_backend__ml_call_gen__Signature_14));
    }
    {
      ml_backend__ml_call_gen__Var_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_21, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_22));
    }
    {
      MR_Word base;
      ...
      *ml_backend__ml_call_gen__CodeAddrRval_8 = base;
      ...
      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_21));
    }
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__Var_27;
    ...
    if (ml_backend__ml_call_gen__succeeded)
      {
        ...
        ml_backend__ml_call_gen__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__ArgVars_8, (MR_Integer) 1)));
        ml_backend__ml_call_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_call_gen__Var_27)) == (MR_mktag((MR_Integer) 1)));
        if (ml_backend__ml_call_gen__succeeded)
          {
            ml_backend__ml_call_gen__DestVar_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_27, (MR_Integer) 0)));
            ml_backend__ml_call_gen__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_27, (MR_Integer) 1)));
            ml_backend__ml_call_gen__succeeded = (ml_backend__ml_call_gen__Var_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            if (ml_backend__ml_call_gen__succeeded)
              {
                ...
                if (ml_backend__ml_call_gen__succeeded)
                  {
                    ...
                    ml_backend__ml_call_gen__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__ArgLvals_12, (MR_Integer) 1)));
                    ml_backend__ml_call_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_call_gen__Var_29)) == (MR_mktag((MR_Integer) 1)));
                    if (ml_backend__ml_call_gen__succeeded)
                      {
                        ml_backend__ml_call_gen__DestLval_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_29, (MR_Integer) 0)));
                        ml_backend__ml_call_gen__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_29, (MR_Integer) 1)));
                        ml_backend__ml_call_gen__succeeded = (ml_backend__ml_call_gen__Var_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        if (ml_backend__ml_call_gen__succeeded)
                          {
                            ...
                            if (ml_backend__ml_call_gen__succeeded)
                              {
                                ...
                                ml_backend__ml_call_gen__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__ArgTypes_13, (MR_Integer) 1)));
                                ml_backend__ml_call_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_call_gen__Var_31)) == (MR_mktag((MR_Integer) 1)));
                                if (ml_backend__ml_call_gen__succeeded)
                                  {
                                    ml_backend__ml_call_gen__DestType_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_31, (MR_Integer) 0)));
                                    ml_backend__ml_call_gen__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_31, (MR_Integer) 1)));
                                    ml_backend__ml_call_gen__succeeded = (ml_backend__ml_call_gen__Var_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                  }
                              }
                          }
                      }
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word ml_backend__ml_call_gen__Var_34;

              {
                ml_backend__ml_call_gen__Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_34, 0) = ((MR_Box) (ml_backend__ml_call_gen__SrcLval_16));
              }
              {
                ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ml_backend__ml_call_gen__ModuleInfo_20, ml_backend__ml_call_gen__SrcType_18, ml_backend__ml_call_gen__DestType_19, (MR_Integer) 0, ml_backend__ml_call_gen__Var_34, &ml_backend__ml_call_gen__CastRval_22);
              }
              {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word ml_backend__ml_call_gen__Var_70;
                  ...
                  if (ml_backend__ml_call_gen__succeeded)
                    {
                      ...
                      {
                        ml_backend__ml_call_gen__Var_70 = check_hlds__type_util__check_dummy_type_2_f_0(ml_backend__ml_call_gen__ModuleInfo_19, ml_backend__ml_call_gen__ProgDataType_27);
                      }
                      ml_backend__ml_call_gen__succeeded = (ml_backend__ml_call_gen__Var_70 == (MR_Integer) 0);
                    }
                }
              if (ml_backend__ml_call_gen__succeeded)
              ...
              if (ml_backend__ml_call_gen__succeeded)
                {
                  ...
                  ml_backend__ml_call_gen__ValueType_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ValueLval_33, (MR_Integer) 1)));
                  {
                    ...
                    MR_Word ml_backend__ml_call_gen__Var_65;
                    MR_Word ml_backend__ml_call_gen__Statement_72;

                    {
                      ml_backend__ml_call_gen__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_64, 0) = ((MR_Box) (ml_backend__ml_call_gen__AddrLval_32));
                    }
                    {
                      ml_backend__ml_call_gen__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_63, 0) = ((MR_Box) (ml_backend__ml_call_gen__Var_64));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_63, 1) = ((MR_Box) (ml_backend__ml_call_gen__ValueType_35));
                    }
                    {
                      ml_backend__ml_call_gen__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_65, 0) = ((MR_Box) (ml_backend__ml_call_gen__ValueLval_33));
                    }
                    {
                      ml_backend__ml_call_gen__Statement_72 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ml_backend__ml_call_gen__Var_63, ml_backend__ml_call_gen__Var_65, ml_backend__ml_call_gen__Context_14);
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_call__400__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 5))), &ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_54, &ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_55, ((MR_Word) ml_backend__ml_call_gen__wrapper_arg_3), &ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_57);
    }
    ...
    if (ml_backend__ml_call_gen__succeeded)
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenCall_40, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_2[0]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenConvOutputAndSucceed_41, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_3[0]));
