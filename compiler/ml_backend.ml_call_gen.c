              ...
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_53);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_70, 0) = ((MR_Box) (SrcLval_45));
                  }
                  ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_53, SrcType_48, DstType_51, (MR_Integer) 0, Var_70, &CastRval_54);
