...
MR_decl_label7(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0, 43,36,31,52,53,55,50)
...
MR_BEGIN_MODULE(ml_backend__ml_call_gen_module0)
	...
	MR_init_label7(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,43,36,31,52,53,55,50)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,36)
	...
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_gen_type_3_0,
		ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0_i55);
MR_def_label(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_np_call_localret_ent(fn__map__init_0_0,
		ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0_i52);
MR_def_label(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_unify_5_0,
		ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0_i53);
MR_def_label(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0_i50);
	}
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_gen_type_3_0,
		ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0_i55);
MR_def_label(ml_backend__ml_call_gen__ml_gen_box_or_unbox_rval_7_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
void mercury__ml_backend__ml_call_gen__write_out_proc_statics(FILE *fp);
#endif
