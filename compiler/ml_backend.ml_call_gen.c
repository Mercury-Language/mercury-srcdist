...
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__374__1_2_p_0(
  MR_Word ConvOutputStmts_30,
  MR_Word HeadVar__2_77);

static MR_bool MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__373__1_2_p_0(
  MR_Word ConvOutputDefns_29,
  MR_Word HeadVar__2_73);

static MR_bool MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__372__1_2_p_0(
  MR_Word OutputLvalsTypes_28,
  MR_Word HeadVar__2_69);

static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__259__1_8_p_0(
  MR_Word Context_15,
...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__666__2_8_p_0(
...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__666__1_8_p_0(
  MR_Word CodeModel_13,
  MR_Word Context_14,
  MR_Word ConvOutputStmts_36,
  MR_Word * LambdaHeadVar__1_67,
...
{
  {
    ...
    succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__374__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__373__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_tail_call__372__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__666__1_8_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), &conv7_LambdaHeadVar__1_67, &conv6_LambdaHeadVar__2_68, &conv5_LambdaHeadVar__3_69, ((MR_Word) (wrapper_arg_4)), &conv4_LambdaHeadVar__5_71);
    *wrapper_arg_1 = ((MR_Box) (conv7_LambdaHeadVar__1_67));
    *wrapper_arg_2 = ((MR_Box) (conv6_LambdaHeadVar__2_68));
    *wrapper_arg_3 = ((MR_Box) (conv5_LambdaHeadVar__3_69));
    *wrapper_arg_5 = ((MR_Box) (conv4_LambdaHeadVar__5_71));
...
{
  {
    ...
    switch (MR_tag((MR_Word) GenericCall_11)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140ml_backend.ml_call_gen.ml_gen_generic_call\'/10", (MR_String) "coerce");
          return;
        }
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GenericCall_11, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *LocalVarDefns_16 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__ml_code_util__ml_gen_var_list_3_p_0(STATE_VARIABLE_Info_0_30, ArgVars_12, &ArgLvals_45);
              ml_backend__ml_code_util__ml_variable_types_3_p_0(STATE_VARIABLE_Info_0_30, ArgVars_12, &ArgTypes_46);
              succeeded = (ArgVars_12 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                SrcVar_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 0))));
                Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_12, (MR_Integer) 1))));
                succeeded = (Var_58 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  DestVar_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_58, (MR_Integer) 0))));
                  Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_58, (MR_Integer) 1))));
                  succeeded = (Var_59 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    succeeded = (ArgLvals_45 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      SrcLval_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgLvals_45, (MR_Integer) 0))));
                      Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgLvals_45, (MR_Integer) 1))));
                      succeeded = (Var_60 != (MR_Word) ((MR_Unsigned) 0U));
                      if (succeeded)
                      {
                        DestLval_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_60, (MR_Integer) 0))));
                        Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_60, (MR_Integer) 1))));
                        succeeded = (Var_61 == (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          succeeded = (ArgTypes_46 != (MR_Word) ((MR_Unsigned) 0U));
                          if (succeeded)
                          {
                            SrcType_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_46, (MR_Integer) 0))));
                            Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_46, (MR_Integer) 1))));
                            succeeded = (Var_62 != (MR_Word) ((MR_Unsigned) 0U));
                            if (succeeded)
                            {
                              DestType_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 0))));
              ...
              if (succeeded)
              {
                ...
                IsDummy_54 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_53, DestType_52);
                switch (IsDummy_54) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    *Stmts_18 = (MR_Word) ((MR_Unsigned) 0U);
                  ...
                  case (MR_Integer) 1:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(2), Var_65, 0) = ((MR_Box) (SrcLval_49));
                      }
                      ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_53, SrcType_51, DestType_52, (MR_Integer) 0, Var_65, &CastRval_55);
                      Assign_56 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(DestLval_50, CastRval_55, Context_15);
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        *Stmts_18 = base;
                        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Assign_56));
                        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      }
                    }
                    break;
                ...
                *LocalVarDefns_16 = (MR_Word) ((MR_Unsigned) 0U);
                *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
                succeeded = ml_backend__ml_gen_info__ml_gen_info_search_const_var_3_p_0(STATE_VARIABLE_Info_0_30, SrcVar_47, &GroundTerm_57);
                if (succeeded)
                  ml_backend__ml_gen_info__ml_gen_info_set_const_var_4_p_0(DestVar_48, GroundTerm_57, STATE_VARIABLE_Info_0_30, STATE_VARIABLE_Info_31);
                else
                  *STATE_VARIABLE_Info_31 = STATE_VARIABLE_Info_0_30;
              }
              else
...
{
  {
    ...
    if (((MR_tag((MR_Word) GenericCall_11)) == (MR_Integer) 2))
    {
      MR_Word TypeClassInfoVar_45 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCall_11, (MR_Integer) 0))));
      MR_Integer MethodNum_46 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GenericCall_11, (MR_Integer) 1))));
    ...
    {
      MR_Word ClosureVar_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GenericCall_11, (MR_Integer) 0))));
      MR_Word FuncLval_42;
      MR_Word Var_109;
      MR_Word Var_111;
