      ...
      else
      {
        ...
        else
        {
          ...
          if ((Var_84 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            hlds__var_table__lookup_var_entry_3_p_0(VarTable_45, Var_83, &SrcVarEntry_46);
            hlds__var_table__lookup_var_entry_3_p_0(VarTable_45, Var_85, &DstVarEntry_47);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_56);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_73, 0) = ((MR_Box) (SrcLval_48));
                  }
                  ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_56, SrcType_51, DstType_54, (MR_Integer) 0, Var_73, &CastRval_57);
