...
{
  {
    ...
    if (succeeded)
    {
        ...
        Obviousness_54 = (MR_Integer) 0;
      {
        ...
        MR_hl_field(MR_mktag(0), NonTailRecCall_55, 3) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (NonTailCallReason_16))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (Obviousness_54))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (Status_53)))))));
      }
