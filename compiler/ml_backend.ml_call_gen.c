...
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__267__1_7_p_0(
  ...
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__1_126,
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__2_127,
  MR_Word ml_backend__ml_call_gen__LambdaHeadVar__3_128,
  MR_Word * ml_backend__ml_call_gen__LambdaHeadVar__4_129);
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_5[6][1];
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_4[1][3] = {
  /* row 0 */
  {
    ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_1[3])),
...
{
  {
    ...
    *ml_backend__ml_call_gen__LambdaHeadVar__1_126 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      ml_backend__ml_code_util__ml_gen_success_5_p_0(ml_backend__ml_call_gen__CodeModel_24, ml_backend__ml_call_gen__Context_14, &ml_backend__ml_call_gen__SucceedStmts_75, ml_backend__ml_call_gen__LambdaHeadVar__3_128, ml_backend__ml_call_gen__LambdaHeadVar__4_129);
    }
    {
      *ml_backend__ml_call_gen__LambdaHeadVar__2_127 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_statement_0, ml_backend__ml_call_gen__ConvOutputStatements_65, ml_backend__ml_call_gen__SucceedStmts_75);
    }
  }
}
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_7_7, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_7_7, 1) = ((MR_Box) (ml_backend__ml_call_gen__UInt_6));
          }
          {
            ml_backend__ml_call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word ml_backend__ml_call_gen__V_9_9;

              {
                ml_backend__ml_call_gen__V_9_9 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_9_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_9_9, 1) = MR_box_float(ml_backend__ml_call_gen__Float_8);
              }
              {
                ml_backend__ml_call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_9_9));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              {
                ml_backend__ml_call_gen__V_12_12 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_12_12, 0) = ((MR_Box) (ml_backend__ml_call_gen__Op_10));
              }
              {
                ml_backend__ml_call_gen__V_13_13 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__Expr_11);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_12_12));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 2) = ((MR_Box) (ml_backend__ml_call_gen__V_13_13));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              MR_Word ml_backend__ml_call_gen__V_17_17;
              MR_Word ml_backend__ml_call_gen__V_18_18;

              {
                ml_backend__ml_call_gen__V_17_17 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__ExprA_15);
              }
              {
                ml_backend__ml_call_gen__V_18_18 = ml_backend__ml_call_gen__ml_gen_simple_expr_1_f_0(ml_backend__ml_call_gen__ExprB_16);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 2) = ((MR_Box) (ml_backend__ml_call_gen__V_17_17));
                MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__HeadVar__2_2, 3) = ((MR_Box) (ml_backend__ml_call_gen__V_18_18));
              }
            }
            break;
        }
    ...
    else
      {
        ...
        if ((ml_backend__ml_call_gen__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ml_backend__ml_call_gen_scalar_common_5[4], ml_backend__ml_call_gen__ArgNum_4, &ml_backend__ml_call_gen__V_51_51);
            }
            {
    ...
    if ((ml_backend__ml_call_gen__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *ml_backend__ml_call_gen__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        MR_Integer ml_backend__ml_call_gen__V_12_12;
        MR_String ml_backend__ml_call_gen__ArgName_15;
        MR_String ml_backend__ml_call_gen__V_21_21;

        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ml_backend__ml_call_gen_scalar_common_5[4], ml_backend__ml_call_gen__ArgNum_2, &ml_backend__ml_call_gen__V_21_21);
        }
        {
          ml_backend__ml_call_gen__ArgName_15 = mercury__string__f_43_43_2_f_0((MR_String) "arg", ml_backend__ml_call_gen__V_21_21);
        }
        {
          ml_backend__ml_call_gen__ArgName_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__ArgName_10, 0) = ((MR_Box) (ml_backend__ml_call_gen__ArgName_15));
        ...
        ml_backend__ml_call_gen__V_12_12 = (ml_backend__ml_call_gen__ArgNum_2 + (MR_Integer) 1);
        {
          ml_backend__ml_call_gen__ml_gen_cont_params_2_3_p_0(ml_backend__ml_call_gen__Types_6, ml_backend__ml_call_gen__V_12_12, &ml_backend__ml_call_gen__Arguments_9);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__V_55_55;
      ...
      case (MR_Integer) 2:
        {
          ...
          switch (ml_backend__ml_call_gen__UseNestedFuncs_31) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word ml_backend__ml_call_gen__V_47_47;
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_48_48, 0) = ((MR_Box) (ml_backend__ml_call_gen__EnvPtrRval_28));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_48_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ml_backend__ml_call_gen__V_47_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_47_47, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncPtrRval_27));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_47_47, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_48_48));
                }
                {
                  ml_backend__ml_call_gen__ArgRvals_32 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, ml_backend__ml_call_gen__ArgRvals0_16, ml_backend__ml_call_gen__V_47_47);
                }
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ml_backend__ml_call_gen__V_50_50;

                {
                  ml_backend__ml_call_gen__V_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_50_50, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncPtrRval_27));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_50_50, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ml_backend__ml_call_gen__ArgRvals_32 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, ml_backend__ml_call_gen__ArgRvals0_16, ml_backend__ml_call_gen__V_50_50);
                }
              }
              break;
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ml_backend__ml_call_gen__V_44_44;
          ...
          ml_backend__ml_call_gen__ArgRvals_32 = ml_backend__ml_call_gen__ArgRvals0_16;
          {
            ml_backend__ml_call_gen__V_44_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_44_44, 0) = ((MR_Box) (ml_backend__ml_call_gen__Success_36));
            MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_44_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ml_backend__ml_call_gen__RetLvals_35 = mercury__list__append_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0, ml_backend__ml_call_gen__V_44_44, ml_backend__ml_call_gen__RetLvals0_17);
          }
          *ml_backend__ml_call_gen__Decls_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          *ml_backend__ml_call_gen__STATE_VARIABLE_Info_43 = ml_backend__ml_call_gen__STATE_VARIABLE_Info_0_42;
        }
    ...
    {
      ml_backend__ml_call_gen__V_55_55 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_call_gen__Context_20);
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Statement_41, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_55_55));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_126;
    MR_Word ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_127;
    MR_Word ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_129;

    {
      ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__267__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 5))), &ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_126, &ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_127, ((MR_Word) ml_backend__ml_call_gen__wrapper_arg_3), &ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_129);
    }
    *ml_backend__ml_call_gen__wrapper_arg_1 = ((MR_Box) (ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_126));
    *ml_backend__ml_call_gen__wrapper_arg_2 = ((MR_Box) (ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_127));
    *ml_backend__ml_call_gen__wrapper_arg_4 = ((MR_Box) (ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_129));
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__V_83_83;
    MR_Word ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109;
    MR_String ml_backend__ml_call_gen__V_110_110;
    MR_Word ml_backend__ml_call_gen__V_116_116;
    MR_Word ml_backend__ml_call_gen__V_117_117;
    MR_Word ml_backend__ml_call_gen__STATE_VARIABLE_Info_120_120;
    MR_Word ml_backend__ml_call_gen__V_122_122;
    MR_String ml_backend__ml_call_gen__V_143_143;
    ...
    {
      ml_backend__ml_call_gen__V_83_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_83_83, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_4[0]));
      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_83_83, 1) = ((MR_Box) (ml_backend__ml_call_gen__ArgParams0_29));
    }
    {
      ml_backend__ml_call_gen__Params_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Params_31, 0) = ((MR_Box) (ml_backend__ml_call_gen__V_83_83));
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_call_gen__GenericCall_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_Word ml_backend__ml_call_gen__V_87_87;
        MR_Word ml_backend__ml_call_gen__V_89_89;
        MR_Word ml_backend__ml_call_gen__V_91_91;
        MR_Word ml_backend__ml_call_gen__V_92_92;
        MR_Word ml_backend__ml_call_gen__V_95_95;
        MR_Word ml_backend__ml_call_gen__V_98_98;
        MR_Word ml_backend__ml_call_gen__V_99_99;
        MR_Word ml_backend__ml_call_gen__FuncLval_131;
        ...
        ml_backend__ml_call_gen__V_87_87 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_5[0]);
        {
          ml_backend__ml_call_gen__V_89_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_89_89, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureLval_37));
        }
        {
          ml_backend__ml_call_gen__BaseTypeclassInfoLval_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__BaseTypeclassInfoLval_48, 0) = ((MR_Box) (ml_backend__ml_call_gen__V_87_87));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__BaseTypeclassInfoLval_48, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_89_89));
        ...
        {
          ml_backend__ml_call_gen__V_92_92 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ml_backend__ml_call_gen__V_92_92, 0) = ((MR_Box) (ml_backend__ml_call_gen__MethodFieldNum_50));
        }
        {
          ml_backend__ml_call_gen__V_91_91 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_91_91, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_91_91, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_92_92));
        }
        {
          ml_backend__ml_call_gen__MethodFieldId_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__MethodFieldId_51, 0) = ((MR_Box) (ml_backend__ml_call_gen__V_91_91));
        }
        {
          ml_backend__ml_call_gen__V_95_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_95_95, 0) = ((MR_Box) (ml_backend__ml_call_gen__BaseTypeclassInfoLval_48));
        }
        {
          ml_backend__ml_call_gen__FuncLval_131 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_131, 0) = ((MR_Box) (ml_backend__ml_call_gen__V_87_87));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_131, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_95_95));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_131, 2) = ((MR_Box) (ml_backend__ml_call_gen__MethodFieldId_51));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_131, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_131, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
        }
        ml_backend__ml_call_gen__FuncType_40 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_call_gen__Params_31);
        {
          ml_backend__ml_call_gen__V_98_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_98_98, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncType_40));
        }
        {
          ml_backend__ml_call_gen__V_99_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_99_99, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncLval_131));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_98_98));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 2) = ((MR_Box) (ml_backend__ml_call_gen__V_99_99));
        }
      }
    else
      {
        ...
        MR_Word ml_backend__ml_call_gen__V_105_105;
        MR_Word ml_backend__ml_call_gen__V_107_107;
        MR_Word ml_backend__ml_call_gen__V_108_108;
        ...
        {
          ml_backend__ml_call_gen__V_105_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_105_105, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureLval_37));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_105_105));
        ...
        ml_backend__ml_call_gen__FuncType_40 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_call_gen__Params_31);
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_107_107, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncType_40));
        }
        {
          ml_backend__ml_call_gen__V_108_108 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_108_108, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncLval_39));
        }
        {
          ml_backend__ml_call_gen__FuncRval_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 1) = ((MR_Box) (ml_backend__ml_call_gen__V_107_107));
          MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_41, 2) = ((MR_Box) (ml_backend__ml_call_gen__V_108_108));
        }
      }
    {
      ml_backend__ml_gen_info__ml_gen_info_new_conv_var_3_p_0(&ml_backend__ml_call_gen__ConvVarSeq_52, ml_backend__ml_call_gen__STATE_VARIABLE_Info_0_78, &ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109);
    }
    ml_backend__ml_call_gen__ConvVarNum_53 = (MR_Integer) ml_backend__ml_call_gen__ConvVarSeq_52;
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ml_backend__ml_call_gen_scalar_common_5[4], ml_backend__ml_call_gen__ConvVarNum_53, &ml_backend__ml_call_gen__V_143_143);
    }
    {
      ml_backend__ml_call_gen__V_110_110 = mercury__string__f_43_43_2_f_0((MR_String) "func_", ml_backend__ml_call_gen__V_143_143);
    }
    {
      ml_backend__ml_call_gen__FuncVarName_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncVarName_54, 0) = ((MR_Box) (ml_backend__ml_call_gen__V_110_110));
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncVarName_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ml_backend__ml_call_gen__V_116_116 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_call_gen__FuncVarName_54);
    {
      ml_backend__ml_call_gen__V_117_117 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_call_gen__Context_14);
    }
    {
      ml_backend__ml_call_gen__FuncVarDecl_55 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(ml_backend__ml_call_gen__V_116_116, ml_backend__ml_call_gen__FuncType_40, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_call_gen__V_117_117);
    }
    {
      ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109, ml_backend__ml_call_gen__FuncVarName_54, ml_backend__ml_call_gen__FuncType_40, &ml_backend__ml_call_gen__FuncVarLval_56);
    }
    {
    ...
    {
      ml_backend__ml_code_util__ml_gen_var_list_3_p_0(ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109, ml_backend__ml_call_gen__ArgVars_11, &ml_backend__ml_call_gen__ArgLvals_59);
    }
    {
      ml_backend__ml_code_util__ml_variable_types_3_p_0(ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109, ml_backend__ml_call_gen__ArgVars_11, &ml_backend__ml_call_gen__ActualArgTypes_60);
    }
    {
      ml_backend__ml_call_gen__ml_gen_arg_list_17_p_0(ml_backend__ml_call_gen__ArgNames_22, ml_backend__ml_call_gen__ArgLvals_59, ml_backend__ml_call_gen__ActualArgTypes_60, ml_backend__ml_call_gen__BoxedArgTypes_19, ml_backend__ml_call_gen__ArgModes_12, ml_backend__ml_call_gen__PredOrFunc_23, ml_backend__ml_call_gen__CodeModel_24, ml_backend__ml_call_gen__Context_14, (MR_Integer) 0, (MR_Integer) 1, &ml_backend__ml_call_gen__InputRvals_61, &ml_backend__ml_call_gen__OutputLvals_62, &ml_backend__ml_call_gen__OutputTypes_63, &ml_backend__ml_call_gen__ConvArgDecls_64, &ml_backend__ml_call_gen__ConvOutputStatements_65, ml_backend__ml_call_gen__STATE_VARIABLE_Info_109_109, &ml_backend__ml_call_gen__STATE_VARIABLE_Info_120_120);
    }
    {
      ml_backend__ml_call_gen__V_122_122 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_122_122, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureLval_37));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ClosureRval_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_5[5])));
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ClosureRval_66, 2) = ((MR_Box) (ml_backend__ml_call_gen__V_122_122));
    }
    ...
    if (ml_backend__ml_call_gen__succeeded)
      {
        MR_Word ml_backend__ml_call_gen__V_123_123;

        {
          ml_backend__ml_call_gen__V_123_123 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_123_123, 0) = ((MR_Box) (ml_backend__ml_call_gen__ClosureRval_66));
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__V_123_123, 1) = ((MR_Box) (ml_backend__ml_call_gen__InputRvals_61));
        }
        {
          ml_backend__ml_call_gen__ml_gen_mlds_call_12_p_0(ml_backend__ml_call_gen__Signature_32, ml_backend__ml_call_gen__ObjectRval_67, ml_backend__ml_call_gen__FuncVarRval_58, ml_backend__ml_call_gen__V_123_123, ml_backend__ml_call_gen__OutputLvals_62, ml_backend__ml_call_gen__OutputTypes_63, ml_backend__ml_call_gen__Determinism_13, ml_backend__ml_call_gen__Context_14, &ml_backend__ml_call_gen__Decls0_68, &ml_backend__ml_call_gen__Statements0_69, ml_backend__ml_call_gen__STATE_VARIABLE_Info_120_120, ml_backend__ml_call_gen__STATE_VARIABLE_Info_79);
        }
      }
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__DoGenCall_70, 6) = ((MR_Box) (ml_backend__ml_call_gen__V_125_125));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__V_21_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
