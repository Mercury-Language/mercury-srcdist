...
{
  {
    ...
    switch (MR_tag((MR_Word) ml_backend__ml_call_gen__HeadVar__1_1)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Integer ml_backend__ml_call_gen__UInt_6 = ((MR_Integer) (MR_hl_field(MR_mktag(2), ml_backend__ml_call_gen__HeadVar__1_1, (MR_Integer) 0)));
...
{
  {
    ...
    {
      ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__267__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 5))), &ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_128, &ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_129, ((MR_Word) ml_backend__ml_call_gen__wrapper_arg_3), &ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_131);
    }
