...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_4[2][5];

static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_5[4][3];

static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_6[5][1];
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_1[6][2] = {
  ...
  /* row 4 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_call_gen_scalar_common_6[0])))
  },
  /* row 5 */
  {
    ((MR_Box) (MR_Word) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_call_gen_scalar_common_6[2])))
  },
};
...
static /* final */ const MR_Box ml_backend__ml_call_gen_scalar_common_5[4][3] = {
  /* row 0 */
  {
    ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_4[0])),
  ...
  /* row 3 */
  {
    ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_4[1])),
    ...
    if ((ml_backend__ml_call_gen__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      if ((ml_backend__ml_call_gen__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *ml_backend__ml_call_gen__HeadVar__6_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        ...
        {
          {
            mercury__require__unexpected_3_p_0((MR_String) "ml_backend.ml_call_gen", (MR_String) "predicate \140ml_backend.ml_call_gen.ml_gen_copy_args_to_locals_loop\'/6", (MR_String) "length mismatch");
            return;
          }
        }
    else
      {
        ...
        if ((ml_backend__ml_call_gen__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              ml_backend__ml_call_gen__ml_gen_copy_args_to_locals_loop_6_p_0(ml_backend__ml_call_gen__HeadVar__1_1, ml_backend__ml_call_gen__Var_43, ml_backend__ml_call_gen__Types_14, ml_backend__ml_call_gen__Var_23, ml_backend__ml_call_gen__Context_5, &ml_backend__ml_call_gen__Statements_18);
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (ml_backend__ml_call_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_call_gen__ml_gen_copy_args_to_locals_loop_6_p_0(ml_backend__ml_call_gen__STATE_VARIABLE_Info_33_33, ml_backend__ml_call_gen__OutputArgLvals_9, ml_backend__ml_call_gen__OutputArgTypes_8, (MR_Integer) 1, ml_backend__ml_call_gen__Context_10, &ml_backend__ml_call_gen__CopyStatements_23);
        }
        {
...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            *ml_backend__ml_call_gen__Decls_21 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0, (MR_Word) &ml_backend__ml_call_gen_scalar_common_5[3], ml_backend__ml_call_gen__ContDecls_26);
          }
        }
        break;
      case (MR_Integer) 1:
    ...
    {
      ml_backend__ml_call_gen__Var_56 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_call_gen__Context_20);
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Statement_41, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_56));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_main_generic_call__245__1_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__closure, (MR_Integer) 5))), &ml_backend__ml_call_gen__conv5_LambdaHeadVar__1_120, &ml_backend__ml_call_gen__conv4_LambdaHeadVar__2_121, ((MR_Word) ml_backend__ml_call_gen__wrapper_arg_3), &ml_backend__ml_call_gen__conv3_LambdaHeadVar__4_123);
    }
...
{
  {
    ...
    MR_Word ml_backend__ml_call_gen__Var_127;
    ...
    ml_backend__ml_call_gen__RetParam_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__Params0_25, (MR_Integer) 1)));
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_82, 0) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_5[1]));
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_call_gen__GenericCall_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        ml_backend__ml_call_gen__Var_86 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_6[0]);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__BaseTypeclassInfoLval_48, 2) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_6[1]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_128, 0) = ((MR_Box) (ml_backend__ml_call_gen__Var_86));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_128, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_94));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_128, 2) = ((MR_Box) (ml_backend__ml_call_gen__MethodFieldId_51));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_98, 0) = ((MR_Box) (ml_backend__ml_call_gen__FuncLval_128));
        }
        {
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_6[0])));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 1) = ((MR_Box) (ml_backend__ml_call_gen__Var_104));
          MR_hl_field(MR_mktag(0), ml_backend__ml_call_gen__FuncLval_39, 2) = ((MR_Box) (&ml_backend__ml_call_gen_scalar_common_6[3]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__ClosureRval_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_call_gen_scalar_common_6[4])));
    ...
    if (ml_backend__ml_call_gen__succeeded)
      ...
      {
        MR_Word ml_backend__ml_call_gen__TypeCtorInfo_139_139;
        ...
        MR_Word ml_backend__ml_call_gen__Var_125;
        ...
        ml_backend__ml_call_gen__TypeCtorInfo_139_139 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0;
        {
          ml_backend__ml_call_gen__Var_125 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, ml_backend__ml_call_gen__TypeCtorInfo_139_139, (MR_Word) &ml_backend__ml_call_gen_scalar_common_5[2], ml_backend__ml_call_gen__ConvArgDecls_64);
        }
        {
          ml_backend__ml_call_gen__Decls0_68 = mercury__list__f_43_43_2_f_0(ml_backend__ml_call_gen__TypeCtorInfo_139_139, ml_backend__ml_call_gen__Var_125, ml_backend__ml_call_gen__CallAndConvOutputDecls_76);
        }
      }
    ml_backend__ml_call_gen__Var_127 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_call_gen__FuncVarDecl_55);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_call_gen__Decls_15 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_call_gen__Var_127));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__Var_89, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_call_gen__FuncRval_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    if (ml_backend__ml_call_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_call_gen__Var_59 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, ml_backend__ml_call_gen__TypeCtorInfo_70_70, (MR_Word) &ml_backend__ml_call_gen_scalar_common_5[0], ml_backend__ml_call_gen__ConvArgDecls_36);
        }
        {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      ml_backend__ml_call_gen__Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_call_gen__Var_60, 0) = ((MR_Box) (ml_backend__ml_call_gen__SrcLval_44));
                    }
                    {
