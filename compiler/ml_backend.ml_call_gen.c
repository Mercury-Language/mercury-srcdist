...
MR_def_label(ml_backend__ml_call_gen__ml_gen_main_generic_call_9_0,20)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Word) MR_TAG_COMMON(0,1,3);
...
MR_def_label(ml_backend__ml_call_gen__ml_gen_main_generic_call_9_0,27)
	...
	MR_tfield(1, MR_r2, 0) = ((MR_Integer) MR_sv(12) + (MR_Integer) MR_r1);
	{
...
MR_def_label(ml_backend__ml_call_gen__ml_gen_builtin_9_0,26)
	...
	MR_tfield(0, MR_tempr2, 0) = MR_tfield(1, MR_r2, 0);
