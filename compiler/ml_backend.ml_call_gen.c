...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo0_48, (MR_Integer) 1)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo0_31, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo0_31, (MR_Integer) 1)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      {
                        GotoTarget_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            {
                              SelectorLval_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                            ...
                            {
                              SetSelectorStmt_53 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                ...
                {
                  GotoStmt_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1)));
                        MR_Unsigned packed_word_4;

                        {
                          InSccInfo_58 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), InSccInfo_58, 0) = ((MR_Box) (Var_116));
                          MR_hl_field(MR_mktag(0), InSccInfo_58, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (MR_Unsigned) (Var_118)));
                        ...
                        packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo0_31, (MR_Integer) 1)));
                        {
                          TailRecInfo_60 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), TailRecInfo_60, 0) = ((MR_Box) (InSccMap_59));
                          MR_hl_field(MR_mktag(0), TailRecInfo_60, 1) = (MR_Box) (packed_word_4);
                        }
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Word Var_124 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
                        MR_Word Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 2))));
                        MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InSccInfo0_33, (MR_Integer) 1)));
                        MR_Unsigned packed_word_6;

                        {
                          InSccInfo_104 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), InSccInfo_104, 0) = ((MR_Box) (Var_123));
                          MR_hl_field(MR_mktag(0), InSccInfo_104, 1) = (MR_Box) (((((MR_Unsigned) (Var_124) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
                        ...
                        {
                          TailRecInfo_106 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), TailRecInfo_106, 0) = ((MR_Box) (InSccMap_105));
                          MR_hl_field(MR_mktag(0), TailRecInfo_106, 1) = (MR_Box) (packed_word_6);
                        }
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_109;
      MR_Word Var_111;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GenericCall_11, (MR_Integer) 1)));
