...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__563__2_8_p_0(
...
static void MR_CALL 
ml_backend__ml_call_gen__IntroducedFrom__pred__ml_gen_plain_non_tail_call__563__1_8_p_0(
  MR_Word CodeModel_13,
  MR_Word Context_14,
  MR_Word ConvOutputStmts_36,
  MR_Word * LambdaHeadVar__1_67,
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        DanglingStackRef_40 = ml_backend__ml_tailcall__may_rvals_yield_dangling_stack_ref_1_f_0(InputRvals_27);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      GotoTarget_54 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
                    }
                    break;
                }
                {
