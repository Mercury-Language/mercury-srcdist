...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_6[2][7];

static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_7[1][8];
...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_8[2][4] = {
  /* row   0 */
  {
    ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_6[1])),
  ...
  MR_Word * STATE_VARIABLE_Specs_70)
{
  ...
  parse_tree__deps_map__generate_deps_map_12_p_0(ProgressStream_11, Globals_12, Search_14, ModuleName_15, &ReadModules_20, &UnreadModules_21, DepsMap0_16, DepsMap_17, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_Specs_74_74);
  parse_tree__generate_dep_d_files__warn_about_any_unread_modules_with_read_ancestors_4_p_0(ReadModules_20, UnreadModules_21, STATE_VARIABLE_Specs_74_74, &STATE_VARIABLE_Specs_76_76);
  ...
  if (succeeded)
  {
    ...
    {
      MR_String UnexpectedMsg_31;
      MR_String Var_80;
      MR_String Var_177;

      Var_80 = mercury__string__string_1_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[0]), ((MR_Box) (FatalErrors_29)));
      Var_177 = mercury__string__f_43_43_2_f_0(Var_80, (MR_String) "\n");
      UnexpectedMsg_31 = mercury__string__f_43_43_2_f_0((MR_String) "FatalErrorSpecs = [], with FatalErrors = ", Var_177);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.generate_dep_d_files.generate_dot_dx_files\'/10", UnexpectedMsg_31);
        return;
      }
    }
    else
      *STATE_VARIABLE_Specs_70 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_30, STATE_VARIABLE_Specs_76_76);
  }
  else
  {
    MR_Word IntDepsGraph0_49;
    MR_Word ImpDepsGraph0_50;
    MR_Word DepsList_51;
    MR_Word BurdenedModules_52;
    MR_Word IntDepsGraph_53;
    MR_Word ImpDepsGraph_54;
    MR_Word IndirectOptDepsGraph_62;
    MR_Word TransOptDepsGraph_63;
    MR_Word TransOptDepsOrdering_64;
    MR_Word TransImpDepsGraph_65;
    MR_Word IndirectDepsGraph_66;
    MR_Word IntermodDirs_67;
    MR_Word TransOptOrder_68;
    MR_Word DFilesToWrite_69;

    switch (Mode_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_String SourceFileName_34 = ((MR_String) ((MR_hl_field(0, Baggage_26, (MR_Integer) 0))));
          MR_Word Cache0_35;
          MR_Word MmakeFileDv_36;
          MR_Word MmakeFileDep_38;
          MR_String MmakeFileStrDv_39;
          MR_String MmakeFileStrDep_40;
          MR_String FileNameDv_41;
          MR_String FileNameDep_43;
          MR_Word Target_47;
          MR_Word _Cache_37;
          MR_String _FileNameDvProposed_42;
          MR_String _FileNameDepProposed_44;
          MR_Word _SucceededDv_45;
          MR_Word _SucceededDep_46;

          mercury__map__init_1_p_0((MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[1]), &Cache0_35);
          parse_tree__generate_mmakefile_fragments__generate_dv_file_9_p_0(Globals_12, SourceFileName_34, ModuleName_15, *DepsMap_17, &MmakeFileDv_36, Cache0_35, &_Cache_37);
          parse_tree__generate_mmakefile_fragments__generate_dep_file_7_p_0(Globals_12, SourceFileName_34, ModuleName_15, *DepsMap_17, &MmakeFileDep_38);
          MmakeFileStrDv_39 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileDv_36);
          MmakeFileStrDep_40 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileDep_38);
          parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.generate_dep_d_files.generate_dot_dx_files\'/10", (MR_Word) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_3[1])), ModuleName_15, &FileNameDv_41, &_FileNameDvProposed_42);
          parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.generate_dep_d_files.generate_dot_dx_files\'/10", (MR_Word) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_3[2])), ModuleName_15, &FileNameDep_43, &_FileNameDepProposed_44);
          libs__file_util__write_string_to_file_8_p_0(ProgressStream_11, Globals_12, (MR_String) "Writing auto-dependency file", FileNameDv_41, MmakeFileStrDv_39, &_SucceededDv_45);
          libs__file_util__write_string_to_file_8_p_0(ProgressStream_11, Globals_12, (MR_String) "Writing auto-dependency file", FileNameDep_43, MmakeFileStrDep_40, &_SucceededDep_46);
          libs__globals__get_target_2_p_0(Globals_12, &Target_47);
          switch (Target_47) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 2:
              {
                ...
                parse_tree__module_cmds__create_java_shell_script_6_p_0(ProgressStream_11, Globals_12, ModuleName_15, &_Succeeded_48);
              }
              break;
          }
        }
    ...
    mercury__digraph__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &IntDepsGraph0_49);
    mercury__digraph__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ImpDepsGraph0_50);
    mercury__map__values_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), *DepsMap_17, &DepsList_51);
    parse_tree__generate_dep_d_files__deps_list_to_deps_graph_7_p_0(*DepsMap_17, DepsList_51, &BurdenedModules_52, IntDepsGraph0_49, &IntDepsGraph_53, ImpDepsGraph0_50, &ImpDepsGraph_54);
    parse_tree__generate_dep_d_files__maybe_output_imports_graph_7_p_0(ProgressStream_11, Globals_12, ModuleName_15, IntDepsGraph_53, ImpDepsGraph_54);
    parse_tree__opt_deps_spec__compute_opt_trans_opt_deps_graph_11_p_0(ProgressStream_11, Globals_12, ModuleName_15, ImpDepsGraph_54, &IndirectOptDepsGraph_62, &TransOptDepsGraph_63, &TransOptDepsOrdering_64, STATE_VARIABLE_Specs_76_76, STATE_VARIABLE_Specs_70);
    mercury__digraph__tc_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_54, &TransImpDepsGraph_65);
    mercury__digraph__compose_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_54, TransImpDepsGraph_65, &IndirectDepsGraph_66);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 711, &IntermodDirs_67);
    parse_tree__write_deps_file__get_ext_opt_deps_8_p_0(Globals_12, (MR_Integer) 1, IntermodDirs_67, (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[2])), TransOptDepsOrdering_64, &TransOptOrder_68);
    switch (Mode_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        DFilesToWrite_69 = BurdenedModules_52;
        break;
      case (MR_Integer) 0:
        {
          DFilesToWrite_69 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, DFilesToWrite_69, 0) = ((MR_Box) (BurdenedModule_25));
          MR_hl_field(1, DFilesToWrite_69, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        break;
    }
    parse_tree__write_deps_file__generate_dependencies_write_d_files_11_p_0(ProgressStream_11, Globals_12, DFilesToWrite_69, IntDepsGraph_53, ImpDepsGraph_54, IndirectDepsGraph_66, IndirectOptDepsGraph_62, TransOptDepsGraph_63, TransOptOrder_68);
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          conv1_Deps0_19 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[6]), Var_36, ((MR_Box) (Var_37)));
          ...
          conv3_Deps_20 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[7]), Var_39, ((MR_Box) (Deps0_19)));
          ...
          mercury__io__write_string_4_p_0(ImportsGraphStream_18, (MR_String) "center=true;\n");
          {
            ...
            MR_hl_field(0, Var_85, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_6[0]));
          ...
          }
          {
            ...
            MR_hl_field(0, Var_86, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_7[0]));
  ...
  MR_Word * STATE_VARIABLE_Specs_44)
{
  ...
  else
  {
    ...
    BadUnreadModulePieces_16 = mercury__list__map_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[3]), BadUnreadList_13);
    ...
    ParentModulePieces_22 = mercury__list__map_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[4]), ParentList_20);
    AncestorModulePieces_23 = mercury__list__map_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[5]), AncestorList_21);
