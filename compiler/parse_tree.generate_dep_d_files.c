...
{
  {
    mercury__set__to_sorted_list_2_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, HeadVar__1_107, HeadVar__2_108);
  }
}
...
{
  {
    ...
    Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_8, (MR_Integer) 0)));
...
{
  {
    ...
    parse_tree__deps_map__insert_into_deps_map_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv2_HeadVar__3_3);
...
{
  {
    MR_Word TypeCtorInfo_42_51;
    MR_Word TypeCtorInfo_43_52;
    MR_Word TypeCtorInfo_48_57;
    MR_Word ModuleName_8;
    MR_Word DepsMap_9;
    MR_Word ParseTreeSrc_24;
    MR_Word Specs0_25;
    MR_Word Error_26;
    MR_Word RawCompUnits_27;
    MR_Word Specs_28;
    MR_Word NestedModuleNames_33;
    MR_String SourceFileName_34;
    MR_Word ModuleAndImportsList_35;
    MR_Word DepsMap0_36;
    MR_Word Var_45;
    MR_Word Var_48;
    MR_Word Var_23;
    ...
    MR_Box conv3_DepsMap_9;

    parse_tree__read_modules__read_module_src_from_file_11_p_0(Globals_5, FileName_6, (MR_String) "Reading file", (MR_Integer) 1, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_8[0], &Var_23, &ParseTreeSrc_24, &Specs0_25, &Error_26);
    parse_tree__split_parse_tree_src__split_into_compilation_units_perform_checks_4_p_0(ParseTreeSrc_24, &RawCompUnits_27, Specs0_25, &Specs_28);
    ModuleName_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ParseTreeSrc_24, (MR_Integer) 0)));
    Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), ParseTreeSrc_24, (MR_Integer) 1)));
    Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), ParseTreeSrc_24, (MR_Integer) 2)));
    parse_tree__error_util__write_error_specs_8_p_0(Specs_28, Globals_5, (MR_Integer) 0, &_NumWarnings_31, (MR_Integer) 0, &_NumErrors_32);
    TypeCtorInfo_42_51 = (MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0;
    TypeCtorInfo_43_52 = (MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_raw_compilation_unit_0;
    Var_45 = mercury__list__map_2_f_0(TypeCtorInfo_43_52, TypeCtorInfo_42_51, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[8], RawCompUnits_27);
    NestedModuleNames_33 = mercury__set__list_to_set_1_f_0(TypeCtorInfo_42_51, Var_45);
    SourceFileName_34 = mercury__string__f_43_43_2_f_0(FileName_6, (MR_String) ".m");
    {
      Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__generate_d_file_for_file_4_p_0_2));
      MR_hl_field(MR_mktag(0), Var_48, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(0), Var_48, 3) = ((MR_Box) (Globals_5));
      MR_hl_field(MR_mktag(0), Var_48, 4) = ((MR_Box) (SourceFileName_34));
      MR_hl_field(MR_mktag(0), Var_48, 5) = ((MR_Box) (ModuleName_8));
      MR_hl_field(MR_mktag(0), Var_48, 6) = ((MR_Box) (NestedModuleNames_33));
      MR_hl_field(MR_mktag(0), Var_48, 7) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), Var_48, 8) = ((MR_Box) (Error_26));
    }
    TypeCtorInfo_48_57 = (MR_Word) &parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_module_and_imports_0;
    mercury__list__map_3_p_0(TypeCtorInfo_43_52, TypeCtorInfo_48_57, Var_48, RawCompUnits_27, &ModuleAndImportsList_35);
    mercury__map__init_1_p_0(TypeCtorInfo_42_51, (MR_Word) &parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0, &DepsMap0_36);
    mercury__list__foldl_4_p_0(TypeCtorInfo_48_57, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[0], (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[9], ModuleAndImportsList_35, ((MR_Box) (DepsMap0_36)), &conv3_DepsMap_9);
    DepsMap_9 = ((MR_Word) conv3_DepsMap_9);
...
{
  {
    ...
    TypeCtorInfo_42_51 = (MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0;
    TypeCtorInfo_43_52 = (MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_raw_compilation_unit_0;
    Var_45 = mercury__list__map_2_f_0(TypeCtorInfo_43_52, TypeCtorInfo_42_51, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[6], RawCompUnits_27);
    NestedModuleNames_33 = mercury__set__list_to_set_1_f_0(TypeCtorInfo_42_51, Var_45);
    SourceFileName_34 = mercury__string__f_43_43_2_f_0(FileName_6, (MR_String) ".m");
    {
      Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__generate_dep_file_for_file_4_p_0_2));
      MR_hl_field(MR_mktag(0), Var_48, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(0), Var_48, 3) = ((MR_Box) (Globals_5));
      MR_hl_field(MR_mktag(0), Var_48, 4) = ((MR_Box) (SourceFileName_34));
      MR_hl_field(MR_mktag(0), Var_48, 5) = ((MR_Box) (ModuleName_8));
    ...
    mercury__list__map_3_p_0(TypeCtorInfo_43_52, TypeCtorInfo_48_57, Var_48, RawCompUnits_27, &ModuleAndImportsList_35);
    mercury__map__init_1_p_0(TypeCtorInfo_42_51, (MR_Word) &parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0, &DepsMap0_36);
    mercury__list__foldl_4_p_0(TypeCtorInfo_48_57, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[0], (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[7], ModuleAndImportsList_35, ((MR_Box) (DepsMap0_36)), &conv3_DepsMap_9);
    DepsMap_9 = ((MR_Word) conv3_DepsMap_9);
...
{
  {
    ...
    parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__198__1_2_p_0(((MR_Word) wrapper_arg_1), &conv1_HeadVar__2_108);
...
{
  {
    ...
    TypeCtorInfo_105_105 = (MR_Word) &parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0;
    mercury__map__lookup_3_p_0(TypeCtorInfo_104_104, TypeCtorInfo_105_105, DepsMap_14, ((MR_Box) (ModuleName_11)), &conv0_ModuleDep_15);
    ModuleDep_15 = ((MR_Word) conv0_ModuleDep_15);
    Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleDep_15, (MR_Integer) 0)));
    ModuleAndImports_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleDep_15, (MR_Integer) 1)));
    Var_78 = ((MR_String) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 0)));
    Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 1)));
    Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 2)));
    Var_81 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 3)));
    Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 4)));
    Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 5)));
    Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 6)));
    Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 7)));
    Var_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 8)));
    Var_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 9)));
    Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 10)));
    Var_89 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 11)));
    Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 12)));
    Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 13)));
    Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 14)));
    Var_93 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 15)));
    Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 16)));
    Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 17)));
    Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 18)));
    Var_97 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 19)));
    Var_98 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 20)));
    Var_99 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 21)));
    Var_100 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 22)));
    Errors_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 23)));
    Var_101 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 24)));
    Var_102 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 25)));
    Var_103 = ((MR_String) (MR_hl_field(MR_mktag(0), ModuleAndImports_17, (MR_Integer) 26)));
    Var_44 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
    TypeCtorInfo_106_106 = (MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0;
    mercury__set__intersect_3_p_0(TypeCtorInfo_106_106, Errors_18, Var_44, &FatalErrors_19);
    succeeded = mercury__set__is_non_empty_1_p_0(TypeCtorInfo_106_106, FatalErrors_19);
    if (succeeded)
    {
      ...
      succeeded = mercury__set__contains_2_p_0(TypeCtorInfo_106_106, FatalErrors_19, ((MR_Box) ((MR_Integer) 0)));
      if (succeeded)
      {
        MR_Word Var_46;
        MR_Word Var_48;
    ...
    else
    {
      ...
      mercury__digraph__init_1_p_0(TypeCtorInfo_104_104, &IntDepsGraph0_23);
      mercury__digraph__init_1_p_0(TypeCtorInfo_104_104, &ImpDepsGraph0_24);
      mercury__map__values_2_p_0(TypeCtorInfo_104_104, TypeCtorInfo_105_105, DepsMap_14, &DepsList_25);
      ...
      mercury__digraph__atsort_2_p_0(TypeCtorInfo_104_104, ImpDepsGraph_27, &ImpDepsOrdering0_28);
      ...
      mercury__list__condense_2_p_0(TypeCtorInfo_104_104, ImpDepsOrdering_29, &TransOptDepsOrdering0_30);
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 653, &IntermodDirs_31);
      mercury__digraph__tc_2_p_0(TypeCtorInfo_104_104, ImpDepsGraph_27, &TransImpDepsGraph_35);
      mercury__digraph__compose_3_p_0(TypeCtorInfo_104_104, ImpDepsGraph_27, TransImpDepsGraph_35, &IndirectDepsGraph_36);
      mercury__digraph__tc_2_p_0(TypeCtorInfo_104_104, ImpDepsGraph_27, &IndirectOptDepsGraph_37);
      switch (Mode_9) {
        ...
        case (MR_Integer) 0:
          {
            {
              DFilesToWrite_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), DFilesToWrite_38, 0) = ((MR_Box) (ModuleDep_15));
              MR_hl_field(MR_mktag(1), DFilesToWrite_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
          }
          break;
      }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 157, &ImportsGraph_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 56, &Verbose_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) ImpResult_15)) == (MR_mktag((MR_Integer) 1))))
          {
          ...
          {
            MR_Word TypeInfo_57_57 = (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[1];
            MR_Word TypeInfo_58_58 = (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_2[2];
            MR_Word TypeCtorInfo_62_62 = (MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0;
            ...
            Var_47 = mercury__digraph__to_assoc_list_1_f_0(TypeCtorInfo_62_62, IntDepsGraph_9);
            Var_48 = mercury__digraph__init_0_f_0(TypeCtorInfo_62_62);
            conv1_Deps0_17 = mercury__list__foldl_3_f_0(TypeInfo_57_57, TypeInfo_58_58, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[3], Var_47, ((MR_Box) (Var_48)));
            Deps0_17 = ((MR_Word) conv1_Deps0_17);
            Var_50 = mercury__digraph__to_assoc_list_1_f_0(TypeCtorInfo_62_62, ImpDepsGraph_10);
            conv3_Deps_18 = mercury__list__foldl_3_f_0(TypeInfo_57_57, TypeInfo_58_58, (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[4], Var_50, ((MR_Box) (Deps0_17)));
...
{
  {
    MR_Word TypeInfo_for_T_31 = (MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0;
    MR_Word GenNodeName_9 = (MR_Word) &parse_tree__generate_dep_d_files_scalar_common_1[2];
    MR_String Var_14;
    MR_String Var_17;
    MR_String Var_19;
    MR_String Var_22;
    ...
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "center=true;\n");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_26, 5) = ((MR_Box) (GenNodeName_9));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_27, 5) = ((MR_Box) (GenNodeName_9));
    }
    mercury__digraph__traverse_5_p_0(TypeInfo_for_T_31, (MR_Word) &mercury__io__io__type_ctor_info_state_0, Graph_10, Var_26, Var_27, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_28_28);
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "}\n");
  }
}
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word ModuleErrors_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 23)));
        MR_Word FatalModuleErrors_22;
        MR_Word Var_27;
        MR_Word STATE_VARIABLE_IntDepsGraph_29_29;
        MR_Word STATE_VARIABLE_ImplDepsGraph_30_30;
        MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deps_14, (MR_Integer) 0)));
        MR_String Var_33 = ((MR_String) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 0)));
        MR_Word Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 1)));
        MR_Word Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 2)));
        MR_Word Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 3)));
        MR_Word Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 4)));
        MR_Word Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 5)));
        MR_Word Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 6)));
        MR_Word Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 7)));
        MR_Word Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 8)));
        MR_Word Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 9)));
        MR_Word Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 10)));
        MR_Word Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 11)));
        MR_Word Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 12)));
        MR_Word Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 13)));
        MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 14)));
        MR_Word Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 15)));
        MR_Word Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 16)));
        MR_Word Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 17)));
        MR_Word Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 18)));
        MR_Word Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 19)));
        MR_Word Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 20)));
        MR_Word Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 21)));
        MR_Word Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 22)));
        MR_Word Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 24)));
        MR_Word Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 25)));
        MR_String Var_58 = ((MR_String) (MR_hl_field(MR_mktag(0), ModuleAndImports_20, (MR_Integer) 26)));
        ...
        mercury__set__intersect_3_p_0(TypeCtorInfo_59_59, ModuleErrors_21, Var_27, &FatalModuleErrors_22);
        succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_59_59, FatalModuleErrors_22);
        if (succeeded)
        {
          MR_Word Var_28;
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = DepsList_15;
          MR_Word next_value_of_STATE_VARIABLE_IntDepsGraph_0_3 = STATE_VARIABLE_IntDepsGraph_29_29;
          MR_Word next_value_of_STATE_VARIABLE_ImplDepsGraph_0_5 = STATE_VARIABLE_ImplDepsGraph_30_30;
