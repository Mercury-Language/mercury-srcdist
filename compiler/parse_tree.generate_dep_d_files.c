...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__generate_dep_d_files__Globals_8, (MR_Integer) 653, &parse_tree__generate_dep_d_files__IntermodDirs_31);
