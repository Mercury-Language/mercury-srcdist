...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 147, &parse_tree__generate_dep_d_files__ImportsGraph_12);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 47, &parse_tree__generate_dep_d_files__Verbose_13);
    }
