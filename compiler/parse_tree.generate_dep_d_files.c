  ...
  else
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__write_deps_file__output_module_order_6_p_0(Globals_9, ModuleName_12, (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_3[1]), ImpDepsOrdering_34);
        }
        break;
    }
    ...
    switch (OutputOrder_33) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        parse_tree__write_deps_file__output_module_order_6_p_0(Globals_9, ModuleName_12, (MR_Word) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_3[2])), TransOptDepsOrdering0_49);
        break;
    }
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140parse_tree.generate_dep_d_files.maybe_output_imports_graph\'/6", (MR_Word) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_3[3])), ModuleName_8, &FileName_14);
        switch (Verbose_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
        ...
        else
        {
          ...
          Var_89 = mercury__string__f_43_43_2_f_0((MR_String) "imports", (MR_String) " {\n");
          Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "digraph ", Var_89);
          mercury__io__write_string_4_p_0(ImpStream_18, Var_86);
          Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "imports", (MR_String) "\";\n");
          Var_91 = mercury__string__f_43_43_2_f_0((MR_String) "label=\"", Var_94);
          mercury__io__write_string_4_p_0(ImpStream_18, Var_91);
