  ...
  MR_Word * STATE_VARIABLE_Specs_44)
{
  ...
  else
  {
    ...
    mercury__list__intersperse_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ((MR_Box) ((MR_Unsigned) 12U)), BadUnreadModulePieces_16, &BadUnreadModuleListPieces_17);
    ...
    else
    {
      ...
      mercury__list__intersperse_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ((MR_Box) ((MR_Unsigned) 12U)), ParentModulePieces_22, &ParentModuleListPieces_30);
      {
    ...
    else
    {
      ...
      mercury__list__intersperse_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ((MR_Box) ((MR_Unsigned) 12U)), AncestorModulePieces_23, &AncestorModuleListPieces_37);
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  parse_tree__opt_deps_spec__compute_opt_trans_opt_deps_graph_11_p_0(ProgressStream_16, Globals_17, ModuleName_18, *ImpDepsGraph_21, IndirectOptDepsGraph_23, TransOptDepsGraph_24, &TransOptDepsOrdering_35, STATE_VARIABLE_Specs_0_38, STATE_VARIABLE_Specs_39);
  ...
  parse_tree__write_deps_file__get_ext_opt_deps_7_p_0(Globals_17, (MR_Integer) 1, (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[2])), TransOptDepsOrdering_35, TransOptOrder_25);
}
