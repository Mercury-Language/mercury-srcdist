...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_2[43][2];
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_19, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[37])));
    }
    {
      Pieces_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Pieces_13, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[35])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_48, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[42])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_43, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[40])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_38, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[39])));
          ...
          }
          {
            ...
            MR_hl_field(1, Pieces_25, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[38])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_69, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[37])));
        }
        {
          Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_66, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[39])));
        ...
        }
        {
          ...
          MR_hl_field(1, Pieces_84, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[38])));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__317__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_133);
  ...
  MR_Word * STATE_VARIABLE_Specs_57)
{
  ...
  else
  {
    ...
    parse_tree__write_deps_file__get_opt_deps_9_p_0(Globals_9, (MR_Integer) 1, IntermodDirs_52, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt"))), (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[10])), TransOptDepsOrdering_51, &TransOptOrder_53);
  ...
  MR_Word * Result_6)
{
  ...
  if (((MR_tag((MR_Word) ReadResult_8)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_60, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
    }
    {
      Var_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_57, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[13])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_26, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[12])));
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_42, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[20])));
      }
      {
        Var_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_39, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[18])));
        MR_hl_field(1, Var_39, 1) = ((MR_Box) (Var_42));
      }
      {
        IgnorePieces_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, IgnorePieces_22, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[17])));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_33, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
          }
          {
            Pieces_19 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Pieces_19, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[21])));
  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
    ...
    if ((EntrySpecs_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Pieces1_27, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[22])));
        ...
        }
        {
          ...
          MR_hl_field(0, Msg2_30, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[24])));
        }
        {
  ...
  else
  {
    ...
    Var_84 = (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[26]));
    Var_90 = (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[28]));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_110, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
    }
    {
      Var_107 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_107, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[32])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_101, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[31])));
      MR_hl_field(1, Var_101, 1) = ((MR_Box) (Var_104));
    }
    {
      Var_98 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_98, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[30])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_92, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[29])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_86, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[27])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_35, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[25])));
  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_23, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
    }
    {
      Pieces_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_32, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
        }
        {
          Pieces_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_21, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[34])));
