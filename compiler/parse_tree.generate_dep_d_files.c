  ...
  MR_Word ModuleName_5)
{
  ...
  BurdenedModule_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_9, (MR_Integer) 1))));
  {
    ModuleDepInfo_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), ModuleDepInfo_6, 0) = ((MR_Box) (BurdenedModule_8));
  }
  ...
  MR_String FileName_6)
{
  ...
  parse_tree__read_modules__read_module_src_from_file_12_p_0(Globals_5, FileName_6, FileNameDotM_15, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_3[0]), &Var_16, &ParseTreeSrc_17, &Specs0_18, &ReadModuleErrors_19);
  ModuleName_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeSrc_17, (MR_Integer) 0))));
  parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_7_p_0(Globals_5, FileNameDotM_15, ParseTreeSrc_17, ReadModuleErrors_19, Specs0_18, &Specs_22, &BurdenedModules_23);
  libs__globals__get_error_output_stream_5_p_0(Globals_5, ModuleName_8, &ErrorStream_24);
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_24, Globals_5, Specs_22);
  mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), &DepsMap0_25);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[0]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[7]), BurdenedModules_23, ((MR_Box) (DepsMap0_25)), &conv1_DepsMap_9);
  ...
  MR_String FileName_6)
{
  ...
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_24, Globals_5, Specs_22);
  mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), &DepsMap0_25);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[0]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[6]), BurdenedModules_23, ((MR_Box) (DepsMap0_25)), &conv1_DepsMap_9);
  DepsMap_9 = ((MR_Word) (conv1_DepsMap_9));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__196__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_100);
  ...
  MR_Word DepsMap0_12)
{
  ...
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_16, Globals_8, DepsMapSpecs_15);
  ...
  BurdenedModule_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleDep_17, (MR_Integer) 1))));
  Baggage_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedModule_19, (MR_Integer) 0))));
  Errors_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage_20, (MR_Integer) 7))));
  Var_52 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
  mercury__set__intersect_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), Errors_22, Var_52, &FatalErrors_23);
  succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), FatalErrors_23);
  if (succeeded)
  {
    ...
    succeeded = mercury__set__contains_2_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), FatalErrors_23, ((MR_Box) ((MR_Integer) 0)));
    if (succeeded)
    {
      MR_String Var_111;
  ...
  else
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 679, &IntermodDirs_35);
    ...
    switch (Mode_9) {
      ...
      case (MR_Integer) 1:
        {
          MR_String SourceFileName_26 = ((MR_String) ((MR_hl_field(MR_mktag(0), Baggage_20, (MR_Integer) 0))));
      ...
      case (MR_Integer) 0:
        {
          DFilesToWrite_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), DFilesToWrite_43, 0) = ((MR_Box) (ModuleDep_17));
          MR_hl_field(MR_mktag(1), DFilesToWrite_43, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        break;
    }
  ...
  MR_Word ImpDepsGraph_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 184, &ImportsGraph_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 71, &Verbose_13);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140parse_tree.generate_dep_d_files.maybe_output_imports_graph\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__generate_dep_d_files_scalar_common_3[1])), ModuleName_8, &FileName_14);
        switch (Verbose_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                MaybeProgressStream_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), MaybeProgressStream_15, 0) = ((MR_Box) (ProgressStream0_16));
              }
            }
            break;
        }
        ...
        {
          MR_Word IOError_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ImpResult_17, (MR_Integer) 0))));
          ...
          {
            MR_Word ProgressStream_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeProgressStream_15, (MR_Integer) 0))));
        ...
        {
          MR_Word ImpStream_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ImpResult_17, (MR_Integer) 0))));
          MR_Word Deps0_19;
          MR_Word Deps_20;
          MR_Word Var_55;
          MR_Word Var_56;
          ...
          Var_55 = mercury__digraph__to_assoc_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_9);
          Var_56 = mercury__digraph__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
          conv1_Deps0_19 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[2]), Var_55, ((MR_Box) (Var_56)));
          Deps0_19 = ((MR_Word) (conv1_Deps0_19));
          Var_58 = mercury__digraph__to_assoc_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_10);
          conv3_Deps_20 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[3]), Var_58, ((MR_Box) (Deps0_19)));
          ...
          mercury__io__write_string_4_p_0(ImpStream_18, (MR_String) "center=true;\n");
          {
            ...
            MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_7[0]));
            MR_hl_field(MR_mktag(0), Var_102, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_4));
            MR_hl_field(MR_mktag(0), Var_102, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_102, 3) = ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
            MR_hl_field(MR_mktag(0), Var_102, 4) = ((MR_Box) (ImpStream_18));
            MR_hl_field(MR_mktag(0), Var_102, 5) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_1[4]));
          }
          {
            Var_103 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_103, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_8[0]));
            MR_hl_field(MR_mktag(0), Var_103, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_5));
            MR_hl_field(MR_mktag(0), Var_103, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_103, 3) = ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
            MR_hl_field(MR_mktag(0), Var_103, 4) = ((MR_Box) (ImpStream_18));
            MR_hl_field(MR_mktag(0), Var_103, 5) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_1[4]));
          }
          ...
          if (!((MaybeProgressStream_15 == (MR_Word) ((MR_Unsigned) 0U))))
          {
            MR_Word ProgressStream_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeProgressStream_15, (MR_Integer) 0))));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_ModuleDepInfo_6 = parse_tree__generate_dep_d_files__lookup_module_and_imports_in_deps_map_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_ImplDepsGraph_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word BurdenedModule_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deps_14, (MR_Integer) 1))));
      MR_Word Baggage_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedModule_20, (MR_Integer) 0))));
      MR_Word ModuleErrors_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage_21, (MR_Integer) 7))));
      MR_Word FatalModuleErrors_23;
      MR_Word Var_29;
      MR_Word STATE_VARIABLE_IntDepsGraph_31_31;
      MR_Word STATE_VARIABLE_ImplDepsGraph_32_32;
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_IntDepsGraph_0_3;
      MR_Word next_value_of_STATE_VARIABLE_ImplDepsGraph_0_5;

      Var_29 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
      mercury__set__intersect_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), ModuleErrors_22, Var_29, &FatalModuleErrors_23);
      succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), FatalModuleErrors_23);
      if (succeeded)
      {
        ...
        {
          ModuleDepInfo_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ModuleDepInfo_24, 0) = ((MR_Box) (BurdenedModule_20));
        }
        {
          Var_30 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_30, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__deps_list_to_deps_graph_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_30, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_30, 3) = ((MR_Box) (DepsMap_2));
        }
        parse_tree__module_deps_graph__add_module_dep_info_to_deps_graph_6_p_0(ModuleDepInfo_24, Var_30, STATE_VARIABLE_IntDepsGraph_0_3, &STATE_VARIABLE_IntDepsGraph_31_31, STATE_VARIABLE_ImplDepsGraph_0_5, &STATE_VARIABLE_ImplDepsGraph_32_32);
      }
      else
      {
        STATE_VARIABLE_ImplDepsGraph_32_32 = STATE_VARIABLE_ImplDepsGraph_0_5;
        STATE_VARIABLE_IntDepsGraph_31_31 = STATE_VARIABLE_IntDepsGraph_0_3;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = DepsList_15;
      next_value_of_STATE_VARIABLE_IntDepsGraph_0_3 = STATE_VARIABLE_IntDepsGraph_31_31;
      next_value_of_STATE_VARIABLE_ImplDepsGraph_0_5 = STATE_VARIABLE_ImplDepsGraph_32_32;
