...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 654, &IntermodDirs_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 159, &ImportsGraph_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 58, &Verbose_13);
