  ...
  MR_Word * STATE_VARIABLE_Specs_78)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 144, &OutputOrder_52);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_12, (MR_Integer) 211, &MaybeSpecFileName_64);
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 711, &IntermodDirs_75);
