...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 152, &parse_tree__generate_dep_d_files__ImportsGraph_12);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 52, &parse_tree__generate_dep_d_files__Verbose_13);
    }
...
{
  {
    ...
    if (parse_tree__generate_dep_d_files__succeeded)
    ...
    else
      {
        ...
        {
          libs__globals__lookup_accumulating_option_3_p_0(parse_tree__generate_dep_d_files__Globals_8, (MR_Integer) 643, &parse_tree__generate_dep_d_files__IntermodDirs_31);
        }
        {
