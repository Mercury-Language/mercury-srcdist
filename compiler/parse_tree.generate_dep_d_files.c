...
{
  {
    ...
    ModuleDepInfo_6 = (MR_Word) ((MR_Word) (ModuleAndImports_8));
...
{
  {
    ...
    parse_tree__module_imports__parse_tree_src_to_module_imports_and_baggage_list_7_p_0(Globals_5, FileNameDotM_23, ParseTreeSrc_25, ReadModuleErrors_27, Specs0_26, &Specs_30, &ModuleAndImportsList_31);
    libs__globals__get_error_output_stream_5_p_0(Globals_5, ModuleName_8, &ErrorStream_32);
    parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_32, Globals_5, Specs_30);
...
{
  {
    ...
    MR_Word ModuleImportsAndBaggage_19;
    MR_Word Baggage_20;
    MR_Word Errors_22;
    ...
    parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_16, Globals_8, DepsMapSpecs_15);
    ...
    ModuleImportsAndBaggage_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleDep_17, (MR_Integer) 1))));
    Baggage_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleImportsAndBaggage_19, (MR_Integer) 0))));
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 685, &IntermodDirs_35);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 177, &ImportsGraph_12);
  ...
  MR_Word * STATE_VARIABLE_ImplDepsGraph_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ModuleImportsAndBaggage_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deps_14, (MR_Integer) 1))));
      MR_Word Baggage_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleImportsAndBaggage_20, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        MR_Word ModuleDepInfo_24 = (MR_Word) ((MR_Word) (ModuleImportsAndBaggage_20));
        MR_Word Var_30;
