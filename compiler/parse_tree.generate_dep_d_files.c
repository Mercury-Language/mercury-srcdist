...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 673, &IntermodDirs_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 166, &ImportsGraph_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 62, &Verbose_13);
