  ...
  MR_String FileName_6)
{
  ...
  parse_tree__read_modules__read_module_src_from_file_9_p_0(Globals_5, FileName_6, FileNameDotM_22, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_3[0]), &HaveReadModuleSrc_23);
  if (((MR_tag((MR_Word) HaveReadModuleSrc_23)) == (MR_Integer) 1))
  {
    MR_Word ReadModuleErrors_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_23, (MR_Integer) 1))));

    parse_tree__read_modules__get_default_module_name_for_file_5_p_0(FileName_6, FileNameDotM_22, &ModuleName_8);
    Specs_30 = parse_tree__parse_error__get_read_module_specs_1_f_0(ReadModuleErrors_45);
    BurdenedModules_31 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    MR_Word ParseTreeSrc_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_23, (MR_Integer) 2))));
    MR_Word ReadModuleErrors_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_23, (MR_Integer) 3))));

    ModuleName_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeSrc_26, (MR_Integer) 0))));
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_6_p_0(Globals_5, FileNameDotM_22, ParseTreeSrc_26, ReadModuleErrors_27, &Specs_30, &BurdenedModules_31);
  }
  libs__globals__get_error_output_stream_5_p_0(Globals_5, ModuleName_8, &ErrorStream_33);
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_33, Globals_5, Specs_30);
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[0]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[7]), BurdenedModules_31, ((MR_Box) (DepsMap0_34)), &conv1_DepsMap0_9);
  ...
  MR_String FileName_6)
{
  ...
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_33, Globals_5, Specs_30);
  mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), &DepsMap0_34);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[0]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[6]), BurdenedModules_31, ((MR_Box) (DepsMap0_34)), &conv1_DepsMap0_9);
  DepsMap0_9 = ((MR_Word) (conv1_DepsMap0_9));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__209__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_100);
