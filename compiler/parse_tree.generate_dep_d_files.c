...
static void MR_CALL 
parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__209__1_2_p_0(
  ...
  MR_String FileName_6)
{
  ...
  {
    MR_Word ReadModuleErrors_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_16, (MR_Integer) 1))));
  ...
  {
    MR_Word ParseTreeSrc_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_16, (MR_Integer) 2))));
    MR_Word ReadModuleErrors_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_16, (MR_Integer) 3))));

    ModuleName_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeSrc_19, (MR_Integer) 0))));
  ...
  parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_26, Globals_5, Specs_23);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__209__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_102);
