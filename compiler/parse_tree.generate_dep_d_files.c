...
static void MR_CALL 
parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__316__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__316__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_127);
  ...
  else
  {
    ...
    switch (OutputOrder_33) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        parse_tree__write_deps_file__output_module_order_6_p_0(Globals_9, ModuleName_12, (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_3[2]), TransOptDepsOrdering0_49);
        break;
    }
