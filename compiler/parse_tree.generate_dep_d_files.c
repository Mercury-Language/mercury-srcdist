...
static void MR_CALL 
parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__197__1_2_p_0(
...
{
  {
    ...
    ModuleAndImports_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_9, (MR_Integer) 1))));
    {
      ModuleDepInfo_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ModuleDepInfo_6, 0) = ((MR_Box) (ModuleAndImports_8));
    }
...
{
  {
    ...
    parse_tree__module_imports__parse_tree_src_to_burdened_aug_comp_unit_list_7_p_0(Globals_5, FileNameDotM_23, ParseTreeSrc_25, ReadModuleErrors_27, Specs0_26, &Specs_30, &ModuleAndImportsList_31);
...
{
  {
    ...
    parse_tree__error_util__write_error_specs_5_p_0(ErrorStream_32, Globals_5, Specs_30);
    mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), &DepsMap0_33);
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_burdened_aug_comp_unit_0), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[0]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[6]), ModuleAndImportsList_31, ((MR_Box) (DepsMap0_33)), &conv1_DepsMap_9);
    DepsMap_9 = ((MR_Word) (conv1_DepsMap_9));
...
{
  {
    ...
    parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dependencies__197__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_100);
...
{
  {
    ...
    MR_Word BurdenedAugCompUnit_19;
    MR_Word Baggage_20;
    MR_Word Errors_22;
    ...
    BurdenedAugCompUnit_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleDep_17, (MR_Integer) 1))));
    Baggage_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_19, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_ImplDepsGraph_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word BurdenedAugCompUnit_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deps_14, (MR_Integer) 1))));
      MR_Word Baggage_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_20, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), ModuleDepInfo_24, 0) = ((MR_Box) (BurdenedAugCompUnit_20));
        }
        {
