...
static void MR_CALL 
parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dot_dx_files__327__1_2_p_0(
...
static void MR_CALL 
parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0(
...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_1[13][3] = {
  ...
  /* row   9 */
  {
    ...
    ((MR_Box) (parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row  10 */
  {
  ...
  MR_Word * Specs_10)
{
  ...
  parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0(ProgressStream_7, Globals_8, (MR_Integer) 0, (MR_Integer) 1, ModuleName_12, DepsMap0_13, Specs_10);
}
  ...
  MR_Word * Specs_10)
{
  ...
  parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0(ProgressStream_7, Globals_8, (MR_Integer) 0, (MR_Integer) 1, ModuleName_9, DepsMap_12, Specs_10);
}
  ...
  MR_Word * Specs_10)
{
  ...
  DepsMap0_13 = ((MR_Word) (conv1_DepsMap0_13));
  parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0(ProgressStream_7, Globals_8, (MR_Integer) 1, (MR_Integer) 0, ModuleName_12, DepsMap0_13, Specs_10);
}
  ...
  MR_Word * Specs_10)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), &DepsMap_12);
  parse_tree__generate_dep_d_files__generate_dot_dx_files_9_p_0(ProgressStream_7, Globals_8, (MR_Integer) 1, (MR_Integer) 0, ModuleName_9, DepsMap_12, Specs_10);
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__generate_dep_d_files__IntroducedFrom__pred__generate_dot_dx_files__327__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_127);
  ...
  MR_Word * STATE_VARIABLE_Specs_58)
{
  ...
  if (succeeded)
  {
    ...
    if ((FatalErrorSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.generate_dep_d_files.generate_dot_dx_files\'/9", (MR_String) "FatalErrorSpecs = []");
        return;
      }
    else
  ...
  else
  {
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_11, (MR_Integer) 192, &MaybeSpecFileName_42);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 689, &IntermodDirs_53);
    switch (Mode_12) {
  ...
  MR_Word ImpDepsGraph_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 191, &ImportsGraph_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 72, &Verbose_15);
