    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140parse_tree.generate_dep_d_files.maybe_output_imports_graph\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[10])), ModuleName_8, &FileName_14);
        switch (Verbose_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
        ...
        if (((MR_tag((MR_Word) ImpResult_17)) == (MR_Integer) 1))
        {
          ...
          {
            MR_Word ProgressStream_64 = ((MR_Word) ((MR_hl_field(1, MaybeProgressStream_15, (MR_Integer) 0))));

            mercury__io__write_string_4_p_0(ProgressStream_64, (MR_String) " failed.\n");
            mercury__io__flush_output_3_p_0(ProgressStream_64);
          }
          ...
          Var_81 = mercury__string__f_43_43_2_f_0(IOErrorMessage_24, (MR_String) "\n");
          Var_83 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_81);
          Var_84 = mercury__string__f_43_43_2_f_0(FileName_14, Var_83);
          ImpMessage_25 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_84);
        ...
        else
        {
          ...
          MR_Box conv5_STATE_VARIABLE_IO_28_101;

          Var_43 = mercury__digraph__to_assoc_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_9);
          Var_44 = mercury__digraph__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
          conv1_Deps0_19 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[4]), Var_43, ((MR_Box) (Var_44)));
          Deps0_19 = ((MR_Word) (conv1_Deps0_19));
          Var_46 = mercury__digraph__to_assoc_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_10);
          conv3_Deps_20 = mercury__list__foldl_3_f_0((MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[1]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_2[2]), (MR_Word) (&parse_tree__generate_dep_d_files_scalar_common_1[5]), Var_46, ((MR_Box) (Deps0_19)));
          Deps_20 = ((MR_Word) (conv3_Deps_20));
          Var_90 = mercury__string__f_43_43_2_f_0((MR_String) "imports", (MR_String) " {\n");
          Var_87 = mercury__string__f_43_43_2_f_0((MR_String) "digraph ", Var_90);
          mercury__io__write_string_4_p_0(ImpStream_18, Var_87);
          Var_95 = mercury__string__f_43_43_2_f_0((MR_String) "imports", (MR_String) "\";\n");
          Var_92 = mercury__string__f_43_43_2_f_0((MR_String) "label=\"", Var_95);
          mercury__io__write_string_4_p_0(ImpStream_18, Var_92);
          mercury__io__write_string_4_p_0(ImpStream_18, (MR_String) "center=true;\n");
          {
            ...
            MR_hl_field(0, Var_99, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_7[0]));
            MR_hl_field(0, Var_99, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_4));
          ...
          }
          {
            ...
            MR_hl_field(0, Var_100, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_8[0]));
            MR_hl_field(0, Var_100, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_5));
          ...
          mercury__digraph__traverse_5_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Deps_20, Var_99, Var_100, ((MR_Box) ((MR_Integer) 0)), &conv5_STATE_VARIABLE_IO_28_101);
