...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 659, &IntermodDirs_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 160, &ImportsGraph_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 59, &Verbose_13);
