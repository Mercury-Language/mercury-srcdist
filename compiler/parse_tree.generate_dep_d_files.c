...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 148, &parse_tree__generate_dep_d_files__ImportsGraph_12);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__generate_dep_d_files__Globals_7, (MR_Integer) 48, &parse_tree__generate_dep_d_files__Verbose_13);
    }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__generate_dep_d_files__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              parse_tree__generate_dep_d_files__V_27_27 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
            }
...
{
  {
    ...
    {
      parse_tree__generate_dep_d_files__V_44_44 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
    }
    ...
    if (parse_tree__generate_dep_d_files__succeeded)
    ...
    else
      {
        ...
        {
          libs__globals__lookup_accumulating_option_3_p_0(parse_tree__generate_dep_d_files__Globals_8, (MR_Integer) 639, &parse_tree__generate_dep_d_files__IntermodDirs_31);
        }
        {
