    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          mercury__io__write_string_4_p_0(ImpStream_18, (MR_String) "center=true;\n");
          {
            ...
            MR_hl_field(MR_mktag(0), Var_100, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_7[0]));
            MR_hl_field(MR_mktag(0), Var_100, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_4));
            MR_hl_field(MR_mktag(0), Var_100, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_100, 3) = ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
            MR_hl_field(MR_mktag(0), Var_100, 4) = ((MR_Box) (ImpStream_18));
            MR_hl_field(MR_mktag(0), Var_100, 5) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_1[4]));
          }
          {
            Var_101 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_101, 0) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_8[0]));
            MR_hl_field(MR_mktag(0), Var_101, 1) = ((MR_Box) (parse_tree__generate_dep_d_files__maybe_output_imports_graph_6_p_0_5));
            MR_hl_field(MR_mktag(0), Var_101, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_101, 3) = ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
            MR_hl_field(MR_mktag(0), Var_101, 4) = ((MR_Box) (ImpStream_18));
            MR_hl_field(MR_mktag(0), Var_101, 5) = ((MR_Box) (&parse_tree__generate_dep_d_files_scalar_common_1[4]));
          }
