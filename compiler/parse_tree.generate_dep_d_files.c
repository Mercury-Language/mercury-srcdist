...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_2[41][2];
...
static /* final */ const MR_Box parse_tree__generate_dep_d_files_scalar_common_2[41][2] = {
  ...
  /* row  14 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[12])))
  },
  /* row  15 */
  {
  ...
  /* row  40 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[39]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[12])))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_19, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[35])));
    }
    {
      Pieces_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Pieces_13, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[33])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_48, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[40])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_43, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[38])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_38, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[37])));
          ...
          }
          {
            ...
            MR_hl_field(1, Pieces_25, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[36])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_69, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[35])));
        }
        {
          Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_66, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[37])));
        ...
        }
        {
          ...
          MR_hl_field(1, Pieces_84, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[36])));
  ...
  else
  {
    ...
    switch (OutputOrder_33) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        parse_tree__write_deps_file__output_module_order_6_p_0(Globals_9, ModuleName_12, (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[8])), TransOptDepsOrdering0_49);
        break;
    }
    ...
    parse_tree__write_deps_file__get_opt_deps_8_p_0(Globals_9, (MR_Integer) 1, IntermodDirs_52, (MR_Word) (MR_mkword(2, &parse_tree__generate_dep_d_files_scalar_common_3[0])), TransOptDepsOrdering_51, &TransOptOrder_53);
  ...
  MR_Word * Result_6)
{
  ...
  if (((MR_tag((MR_Word) ReadResult_8)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_60, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[14])));
    }
    {
      Var_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_57, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[11])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_26, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[10])));
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_42, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[18])));
      }
      {
        Var_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_39, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[16])));
        MR_hl_field(1, Var_39, 1) = ((MR_Box) (Var_42));
      }
      {
        IgnorePieces_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, IgnorePieces_22, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[15])));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_33, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[14])));
          }
          {
            Pieces_19 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Pieces_19, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[19])));
  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
    ...
    if ((EntrySpecs_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Pieces1_27, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[20])));
        ...
        }
        {
          ...
          MR_hl_field(0, Msg2_30, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[22])));
        }
        {
  ...
  else
  {
    ...
    Var_84 = (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[24]));
    Var_90 = (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[26]));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_110, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[14])));
    }
    {
      Var_107 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_107, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[30])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_101, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[29])));
      MR_hl_field(1, Var_101, 1) = ((MR_Box) (Var_104));
    }
    {
      Var_98 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_98, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[28])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_92, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[27])));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_86, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[25])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_35, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[23])));
  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_23, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[14])));
    }
    {
      Pieces_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_32, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__generate_dep_d_files_scalar_common_2[14])));
        }
        {
          Pieces_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_21, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[32])));
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140parse_tree.generate_dep_d_files.maybe_output_imports_graph\'/6", (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[9])), ModuleName_8, &FileName_14);
        switch (Verbose_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
