  ...
  MR_Word * STATE_VARIABLE_Specs_68)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 143, &OutputOrder_42);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_12, (MR_Integer) 210, &MaybeSpecFileName_54);
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 710, &IntermodDirs_65);
    parse_tree__write_deps_file__get_ext_opt_deps_8_p_0(Globals_12, (MR_Integer) 1, IntermodDirs_65, (MR_Word) (MR_mkword(3, &parse_tree__generate_dep_d_files_scalar_common_2[8])), TransOptDepsOrdering_64, &TransOptOrder_66);
    switch (Mode_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
