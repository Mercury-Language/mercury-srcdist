...
#undef MR_PROC_LABEL
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__open_append_4_p_0((MR_String) "/tmp/WRITE_DEPS_FILE_CACHE_STATS", &Result_8);
    if (!(((MR_tag((MR_Word) Result_8)) == (MR_Integer) 1)))
    {
      ...
      mercury__io__write_string_4_p_0(OutStream_10, (MR_String) "\n");
      {
        ...
        MR_hl_field(0, Var_27, 1) = ((MR_Box) (parse_tree__make_module_file_names__record_write_deps_file_cache_stats_2_p_0_1));
