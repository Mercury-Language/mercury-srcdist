...
static void MR_CALL 
check_hlds__simplify__mark_trace_goals__IntroducedFrom__pred__rejoin_last_nontrace_maps__302__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_124)
{
  ...
  switch (*ContainsTrace_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 21, GoalInfo0_14, &GoalInfo_120);
      break;
    case (MR_Integer) 0:
      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 21, GoalInfo0_14, &GoalInfo_120);
      break;
  }
  {
    MR_Word base;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__mark_trace_goals__IntroducedFrom__pred__rejoin_last_nontrace_maps__302__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_17);
