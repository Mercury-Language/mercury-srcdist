...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) BackendForeignLanguages_48)) == (MR_Integer) 1);
    if (succeeded)
    {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) MaybeSuccessExprForFirst_75)) == (MR_Integer) 1);
                    if (succeeded)
                    {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) MaybeSuccessExpr0_10)) == (MR_Integer) 1);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_82 = (MR_Word) (MR_mkword(MR_mktag(0), (MR_Word) (Clause_61)));
                    {
