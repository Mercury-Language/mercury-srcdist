    ...
    if (erl_backend__erl_code_gen__succeeded)
      {
        ...
        erl_backend__erl_code_gen__TypeInfo_38_38 = (MR_Word) &erl_backend__erl_code_gen_scalar_common_1[0];
        {
          ...
          MR_hl_field(MR_mktag(0), erl_backend__erl_code_gen__Var_34, 0) = ((MR_Box) (&erl_backend__erl_code_gen_scalar_common_5[1]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_code_gen__Var_26, 0) = ((MR_Box) (&erl_backend__erl_code_gen_scalar_common_4[1]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_code_gen__Var_31, 0) = ((MR_Box) (&erl_backend__erl_code_gen_scalar_common_4[1]));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), erl_backend__erl_code_gen__Var_99, 0) = ((MR_Box) (&erl_backend__erl_code_gen_scalar_common_4[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_code_gen__Var_72, 0) = ((MR_Box) (&erl_backend__erl_code_gen_scalar_common_2[0]));
