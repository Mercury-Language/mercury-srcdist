...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PragmaExport_5, (MR_Integer) 0)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_15, &PredStatus_16);
      {
        ...
        if (succeeded)
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_26, (MR_Integer) 0)));
      }
      if (!(succeeded))
      {
        MR_Word Var_24;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      CompareXY_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    {
                      TrueCase_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    {
                      FalseCase_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    {
                      ClauseExpr_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    {
                      Clause_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
