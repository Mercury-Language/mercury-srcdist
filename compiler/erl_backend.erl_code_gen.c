...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PragmaExport_5, (MR_Integer) 0)));
...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) MainConsId_16)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MainConsId_16, (MR_Integer) 0))) == (MR_Integer) 17)));
    if (succeeded)
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_15, &PredStatus_16);
      {
        ...
        if (succeeded)
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_26, (MR_Integer) 0)));
      }
      if (!(succeeded))
      {
        MR_Word Var_24;
