...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        UnconstrainedTVars_60 = mercury__list__delete_elems_2_f_0(TypeInfo_41_82, ExistTVars_55, ConstrainedTVars_59);
        mercury__list__length_2_p_0(TypeInfo_41_82, UnconstrainedTVars_60, &NumUnconstrainedTVars_61);
        mercury__list__length_2_p_0(TypeInfo_41_82, UnconstrainedTVarsEC_57, &NumUnconstrainedTVarsEC_62);
