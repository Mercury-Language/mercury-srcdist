                      ...
                      if (erl_backend__erl_code_gen__succeeded)
                        {
                          ...
                          if (erl_backend__erl_code_gen__succeeded)
                            {
                              erl_backend__erl_code_gen__Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), erl_backend__erl_code_gen__Var_44, (MR_Integer) 0)));
                              erl_backend__erl_code_gen__Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), erl_backend__erl_code_gen__Var_44, (MR_Integer) 1)));
                              {
