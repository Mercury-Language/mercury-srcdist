...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 246, &UseAllocRegions_58);
            ...
            case (MR_Integer) 3:
              {
                ...
                {
                  Var_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  MR_hl_field(MR_mktag(0), Var_84, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            ...
            case (MR_Integer) 4:
              {
                ...
                {
                  Var_75 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 246, &UseAllocRegions_25);
