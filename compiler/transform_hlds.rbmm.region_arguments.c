    ...
    else
      {
        ...
        if (transform_hlds__rbmm__region_arguments__succeeded)
        ...
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(transform_hlds__rbmm__region_arguments__Globals_57, (MR_Integer) 241, &transform_hlds__rbmm__region_arguments__UseAllocRegions_58);
            }
    ...
    if (transform_hlds__rbmm__region_arguments__succeeded)
      *transform_hlds__rbmm__region_arguments__STATE_VARIABLE_FormalRegionArgTable_31 = transform_hlds__rbmm__region_arguments__STATE_VARIABLE_FormalRegionArgTable_0_30;
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(transform_hlds__rbmm__region_arguments__Globals_24, (MR_Integer) 241, &transform_hlds__rbmm__region_arguments__UseAllocRegions_25);
        }
