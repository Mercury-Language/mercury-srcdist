...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 251, &UseAllocRegions_58);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 251, &UseAllocRegions_25);
