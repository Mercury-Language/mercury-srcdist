  ...
  MR_Word * STATE_VARIABLE_ActualRegionArgTable_29)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 272, &UseAllocRegions_58);
    ...
    Expr_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Body_24, (MR_Integer) 0))));
    Info_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Body_24, (MR_Integer) 1))));
    transform_hlds__rbmm__region_arguments__record_actual_region_arguments_expr_12_p_0(ModuleInfo_12, Expr_87, Info_88, PPId_21, RptaInfoTable_14, ConstantRTable_15, DeadRTable_16, BornRTable_17, STATE_VARIABLE_FormalRegionArgTable_32_32, STATE_VARIABLE_FormalRegionArgTable_27, Var_34, &ActualRegionArgProc_25);
  ...
  MR_Word * STATE_VARIABLE_FormalRegionArgTable_31)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 272, &UseAllocRegions_25);
