  ...
  MR_Word * STATE_VARIABLE_ActualRegionArgTable_29)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_56, (MR_Integer) 275, &UseAllocRegions_57);
  ...
  MR_Word * STATE_VARIABLE_FormalRegionArgTable_31)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 275, &UseAllocRegions_25);
