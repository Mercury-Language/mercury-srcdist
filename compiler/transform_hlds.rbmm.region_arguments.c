  ...
  MR_Word * STATE_VARIABLE_ActualRegionArgProc_37)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldr_4_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), (MR_Word) (&transform_hlds__rbmm__region_arguments_scalar_common_2[1]), Var_38, FormalConstants_24, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv4_ActualConstants_31);
      ActualConstants_31 = ((MR_Word) (conv4_ActualConstants_31));
      mercury__list__foldr_4_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), (MR_Word) (&transform_hlds__rbmm__region_arguments_scalar_common_2[1]), Var_38, FormalDeads_25, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv5_ActualDeads_32);
      ActualDeads_32 = ((MR_Word) (conv5_ActualDeads_32));
      mercury__list__foldr_4_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), (MR_Word) (&transform_hlds__rbmm__region_arguments_scalar_common_2[1]), Var_38, FormalBorns_26, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv6_ActualBorns_33);
