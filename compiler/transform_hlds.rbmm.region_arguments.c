  ...
  MR_Word * STATE_VARIABLE_ActualRegionArgTable_29)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 275, &UseAllocRegions_48);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_73, (MR_Integer) 275, &UseAllocRegions_74);
