...
{
  {
    ...
    check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_0_36, &STATE_VARIABLE_ModeInfo_39_39);
    ...
    check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_6, Goals0_7, Var_64, &GoalsCord_63, (MR_Word) ((MR_Integer) 0), &RevImpurityErrors0_15, STATE_VARIABLE_ModeInfo_41_41, &STATE_VARIABLE_ModeInfo_43_43);
    ...
    *Goals_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Goals1_14, Goals2_20);
    ...
    if ((DelayedGoals_19 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      if ((MoreDelayedGoals_28 == (MR_Word) ((MR_Integer) 0)))
      {
      ...
      else
      {
        ...
        check_hlds__modecheck_conj__get_all_waiting_vars_2_3_p_0(Rest_76, Vars2_79, &Vars_34);
        {
          ...
          MR_hl_field(MR_mktag(3), ModeError_35, 2) = ((MR_Box) ((MR_Integer) 4));
        }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Errors_35 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word SubGoals_47;
          MR_Word Var_73;
          MR_Word Var_105;
        ...
        else
        {
          ...
          check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_72_72, &STATE_VARIABLE_ModeInfo_78_78);
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), ImpureError_43, 2) = ((MR_Box) ((MR_Integer) 0));
                }
        ...
        if ((WokenGoals_49 == (MR_Word) ((MR_Integer) 0)))
        ...
        else
        {
          ...
          if ((Var_106 == (MR_Word) ((MR_Integer) 0)))
          {
...
{
  {
    ...
    if ((NonHeadVarUnificationGoals_21 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((DelayedGoals0_10 == (MR_Word) ((MR_Integer) 0)))
    {
      *DelayedGoals_11 = (MR_Word) ((MR_Integer) 0);
      *Goals_12 = (MR_Word) ((MR_Integer) 0);
