...
MR_decl_label3(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0, 2,5,1)
MR_decl_label3(check_hlds__modecheck_conj__get_all_waiting_vars_2_3_0, 10,3,4)
MR_decl_label3(check_hlds__modecheck_conj__is_headvar_unification_goal_2_0, 5,3,1)
...
MR_decl_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0, 143,3,8,4,10,13,12,11,14,15)
MR_decl_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0, 16,17,18,19,22,21,23,24,25,26)
MR_decl_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0, 28,32,33,36,37,39,41,43,44,45)
MR_decl_label9(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0, 48,50,47,51,52,57,55,54,62)
...
MR_decl_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0, 66,6,7,8,9,10,11,14,13,15)
MR_decl_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0, 16,17,18,23,25,26,22,29,31,32)
MR_decl_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0, 33,34,35,36,37,38,39,40,41,4)
...
MR_decl_static(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0)
...
MR_decl_static(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0)
...
MR_decl_static(check_hlds__modecheck_conj__IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1_2_0)
...
MR_BEGIN_MODULE(check_hlds__modecheck_conj_module4)
	MR_init_entry1(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0);
	MR_init_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,143,3,8,4,10,13,12,11,14,15)
	MR_init_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,16,17,18,19,22,21,23,24,25,26)
	MR_init_label10(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,28,32,33,36,37,39,41,43,44,45)
	MR_init_label9(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,48,50,47,51,52,57,55,54,62)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'modecheck_conj_list_flatten_and_schedule'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(13);
	MR_sv(13) = (MR_Word) MR_succip;
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,143)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i3);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_r3 = MR_r4;
	MR_decr_sp_and_return(13);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_tfield(1, MR_r2, 1);
	MR_sv(12) = MR_tfield(1, MR_r2, 0);
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i4);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i8);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i143);
	}
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_sv(11) = MR_r3;
	MR_sv(4) = MR_r4;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_get_purity_1_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i10);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i12);
	}
	MR_r1 = MR_sv(12);
	MR_r2 = MR_sv(11);
	MR_r3 = MR_sv(4);
	MR_np_call_localret_ent(check_hlds__modecheck_conj__check_for_impurity_error_6_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i13);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = (MR_Integer) 1;
	MR_sv(4) = MR_r1;
	MR_sv(1) = MR_r2;
	MR_r1 = MR_r3;
	MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i11);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_sv(11);
	...
	MR_r1 = MR_r2;
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_instmap_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i14);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_delay_info_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i15);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = MR_r1;
	MR_r1 = MR_sv(12);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_get_nonlocals_1_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i16);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(5);
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_remove_live_vars_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i17);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__modecheck_goal__modecheck_goal_4_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i18);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(8) = MR_r2;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_errors_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i19);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i21);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_delay_info_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i22);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_sv(8);
	MR_sv(9) = MR_sv(1);
	MR_np_call_localret_ent(check_hlds__delay_info__delay_info_wakeup_goals_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i36);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_errors_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i23);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_instmap_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i24);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_add_live_vars_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i25);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(12);
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(check_hlds__delay_info__delay_info_delay_goal_4_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i26);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(11),0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i28);
	}
	MR_sv(9) = MR_sv(1);
	MR_np_call_localret_ent(check_hlds__delay_info__delay_info_wakeup_goals_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i36);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_context_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i32);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_mode_context_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i33);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(check_hlds__delay_info__delay_info_wakeup_goals_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i36);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = MR_r1;
	MR_sv(12) = MR_r2;
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i37);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(11),0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i39);
	}
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(12);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_delay_info_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i44);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_sv(11), 1);
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i41);
	}
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	...
	MR_np_call_localret_ent(check_hlds__mode_debug__mode_checkpoint_4_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i43);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	...
	MR_np_call_localret_ent(check_hlds__mode_debug__mode_checkpoint_4_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i43);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_delay_info_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i44);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = MR_r1;
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_instmap_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i45);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__instmap__instmap_is_unreachable_1_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i48);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i47);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(11);
	MR_np_call_localret_ent(check_hlds__modecheck_util__mode_info_remove_goals_live_vars_3_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i50);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_sv(11) = MR_r1;
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_sv(10);
	MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i52);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(9);
	MR_r4 = MR_sv(11);
	MR_np_localcall_lab(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i51);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = MR_r3;
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(10);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(7),0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i54);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(0, MR_sv(6), 0);
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i55);
	}
	MR_tempr2 = MR_tfield(3, MR_tempr1, 1);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i57);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i62);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i62);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0_i62);
MR_def_label(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(11);
	MR_decr_sp_and_return(13);
...
MR_BEGIN_MODULE(check_hlds__modecheck_conj_module5)
	...
	MR_init_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,66,6,7,8,9,10,11,14,13,15)
	MR_init_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,16,17,18,23,25,26,22,29,31,32)
	MR_init_label10(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,33,34,35,36,37,38,39,40,41,4)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0_i66);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,11)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0_i13);
	MR_tempr2 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = MR_r2;
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,14)
	...
	MR_GOTO_LAB(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0_i15);
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(9);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(10);
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,16)
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_module_info_2_0,
		check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0_i17);
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,18)
	...
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0_i22);
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(6);
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_try_det_8_0,37)
	...
	MR_np_call_localret_ent(check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_7_0,
...
MR_def_label(check_hlds__modecheck_conj__modecheck_delayed_goals_eager_8_0,9)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__modecheck_conj__IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1_2_0);
...
MR_def_label(check_hlds__modecheck_conj__candidate_init_vars_3_6_0,59)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0);
...
MR_decl_entry(check_hlds__type_util__type_is_or_may_contain_solver_type_2_0);

MR_BEGIN_MODULE(check_hlds__modecheck_conj_module11)
	MR_init_entry1(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__modecheck_conj__does_not_contain_solver_type_3_0);
	MR_init_label3(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0,2,5,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'does_not_contain_solver_type'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(parse_tree__prog_data__lookup_var_type_3_0,
		check_hlds__modecheck_conj__does_not_contain_solver_type_3_0_i2);
MR_def_label(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_is_or_may_contain_solver_type_2_0,
		check_hlds__modecheck_conj__does_not_contain_solver_type_3_0_i5);
MR_def_label(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0_i1);
	}
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__modecheck_conj__does_not_contain_solver_type_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(check_hlds__modecheck_conj_module13)
	...
	MR_init_label3(check_hlds__modecheck_conj__is_headvar_unification_goal_2_0,5,3,1)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__modecheck_conj__is_headvar_unification_goal_2_0)
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__modecheck_conj__is_headvar_unification_goal_2_0_i5);
MR_def_label(check_hlds__modecheck_conj__is_headvar_unification_goal_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_BEGIN_MODULE(check_hlds__modecheck_conj_module16)
	MR_init_entry1(check_hlds__modecheck_conj__IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__modecheck_conj__IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__modecheck_conj__IntroducedFrom__pred__modecheck_delayed_goals_eager__632__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__modecheck_conj__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__check_hlds__modecheck_conj);
