  ...
  MR_Word * STATE_VARIABLE_ModeInfo_28)
{
  ...
  else
  {
    ...
    Var_50 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
    check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_9, Goals0_17, Var_50, &GoalsCord_49, STATE_VARIABLE_ImpurityErrors_0_25, &STATE_VARIABLE_ImpurityErrors_31_31, STATE_VARIABLE_ModeInfo_30_30, &STATE_VARIABLE_ModeInfo_32_32);
    Goals1_20 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalsCord_49);
