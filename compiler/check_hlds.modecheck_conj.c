    ...
    else
    {
      ...
      else
      {
        ...
        if ((Errors_35 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_34, (MR_Integer) 0))));
          succeeded = ((((MR_tag((MR_Word) Var_82)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 0)))) == (MR_Integer) 2)));
          if (succeeded)
          {
            Var_105 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 1))) & (MR_Integer) 1);
            SubGoals_48 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 2))));
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (DelayedError_43));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), ImpureError_44, 1) = ((MR_Box) (Var_78));
                ...
                {
                  STATE_VARIABLE_ImpurityErrors_81_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_ImpurityErrors_81_81, 0) = ((MR_Box) (ImpureErrorInfo_47));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_ImpurityErrors_81_81, 1) = ((MR_Box) (STATE_VARIABLE_ImpurityErrors_68_68));
                }
              }
              break;
          }
