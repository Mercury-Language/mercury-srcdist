...
{
  {
    ...
    check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModeInfo_0_36, &STATE_VARIABLE_ModeInfo_39_39);
    ...
    check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_6, Goals0_7, Var_64, &GoalsCord_63, (MR_Word) ((MR_Unsigned) 0U), &RevImpurityErrors0_15, STATE_VARIABLE_ModeInfo_41_41, &STATE_VARIABLE_ModeInfo_43_43);
    ...
    *Goals_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Goals1_14, Goals2_20);
    ...
    else
    {
      ...
      if ((MoreDelayedGoals_28 == (MR_Word) ((MR_Unsigned) 0U)))
      {
      ...
      else
      {
        ...
        {
          ModeError_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ModeError_35, 0) = ((MR_Box) ((MR_Unsigned) 14U));
          MR_hl_field(MR_mktag(3), ModeError_35, 1) = ((MR_Box) (DelayedGoals_19));
          MR_hl_field(MR_mktag(3), ModeError_35, 2) = ((MR_Box) ((MR_Unsigned) 4U));
        }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Var_62)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_62, (MR_Integer) 0))) == (MR_Integer) 2)));
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_62, (MR_Integer) 1)));
          Var_63 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_62, (MR_Integer) 1))) & (MR_Integer) 1);
      ...
      else
      {
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_70 = mercury__cord__from_list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), ScheduledSolverGoals_30);
              STATE_VARIABLE_Goals_69_69 = mercury__cord__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_Goals_0_3, Var_70);
            }
            break;
          case (MR_Integer) 0:
          case (MR_Integer) 1:
        ...
        if ((Errors_35 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_73)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_73, (MR_Integer) 0))) == (MR_Integer) 2)));
          if (succeeded)
          {
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_73, (MR_Integer) 1)));
            Var_105 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_73, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          if (succeeded)
          {
            ...
            Var_75 = mercury__cord__from_list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), SubGoals_47);
            STATE_VARIABLE_Goals_74_74 = mercury__cord__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_Goals_69_69, Var_75);
          }
          else
          {
        ...
        else
        {
          ...
          check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModeInfo_72_72, &STATE_VARIABLE_ModeInfo_78_78);
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  ImpureError_43 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ImpureError_43, 0) = ((MR_Box) ((MR_Unsigned) 14U));
                  MR_hl_field(MR_mktag(3), ImpureError_43, 1) = ((MR_Box) (Var_81));
                  MR_hl_field(MR_mktag(3), ImpureError_43, 2) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                ...
                {
                  ImpureErrorInfo_46 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        ...
        if ((WokenGoals_49 == (MR_Word) ((MR_Unsigned) 0U)))
...
{
  {
    ...
    else
    {
      ...
      {
        ModeError_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ModeError_28, 0) = ((MR_Box) ((MR_Unsigned) 14U));
      ...
      {
        ImpurityError_31 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
