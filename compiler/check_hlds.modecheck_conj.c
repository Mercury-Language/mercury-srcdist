  ...
  MR_Word * STATE_VARIABLE_ModeInfo_38)
{
  ...
  Var_64 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
  check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_6, Goals0_7, Var_64, &GoalsCord_63, (MR_Word) ((MR_Unsigned) 0U), &RevImpurityErrors0_15, STATE_VARIABLE_ModeInfo_42_42, &STATE_VARIABLE_ModeInfo_44_44);
  Goals1_14 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalsCord_63);
  ...
  *Goals_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Goals1_14, Goals2_20);
  ...
  else
  {
    ...
    else
    {
      ...
      Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DelayedGoals_19, (MR_Integer) 0))));
      Rest_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DelayedGoals_19, (MR_Integer) 1))));
      Vars1_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_78, (MR_Integer) 0))));
      parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_68, Vars1_71, &Vars2_77);
      check_hlds__modecheck_conj__get_all_waiting_vars_2_3_p_0(Rest_74, Vars2_77, &Vars_34);
      {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_28)
{
  ...
  else
  {
    ...
    Var_48 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
    check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_9, Goals0_17, Var_48, &GoalsCord_47, STATE_VARIABLE_ImpurityErrors_0_25, &STATE_VARIABLE_ImpurityErrors_31_31, STATE_VARIABLE_ModeInfo_30_30, &STATE_VARIABLE_ModeInfo_32_32);
    Goals1_20 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalsCord_47);
