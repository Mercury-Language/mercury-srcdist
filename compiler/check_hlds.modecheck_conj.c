  ...
  MR_Word * STATE_VARIABLE_ModeInfo_38)
{
  ...
  Var_53 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
  check_hlds__modecheck_conj__modecheck_conj_list_flatten_and_schedule_acc_8_p_0(ConjType_6, Goals0_7, Var_53, &GoalsCord_52, (MR_Word) ((MR_Unsigned) 0U), &RevImpurityErrors0_15, STATE_VARIABLE_ModeInfo_42_42, &STATE_VARIABLE_ModeInfo_44_44);
  Goals1_14 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalsCord_52);
  ...
  *Goals_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Goals1_14, Goals2_20);
  ...
  else
  {
    ...
    else
    {
      ...
      Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DelayedGoals_19, (MR_Integer) 0))));
      Rest_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DelayedGoals_19, (MR_Integer) 1))));
      Vars1_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0))));
      parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_55, Vars1_58, &Vars2_64);
      check_hlds__modecheck_conj__get_all_waiting_vars_2_3_p_0(Rest_61, Vars2_64, &Vars_34);
      {
