    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ModeError_36, 0) = ((MR_Box) ((MR_Unsigned) 9U));
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), ImpureError_44, 0) = ((MR_Box) ((MR_Unsigned) 9U));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), ModeError_29, 0) = ((MR_Box) ((MR_Unsigned) 9U));
