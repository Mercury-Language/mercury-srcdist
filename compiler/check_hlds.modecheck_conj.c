  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Var_62)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_62, (MR_Integer) 0)))) == (MR_Integer) 2)));
        if (succeeded)
        {
      ...
      else
      {
        ...
        if ((Errors_35 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_73)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_73, (MR_Integer) 0)))) == (MR_Integer) 2)));
          if (succeeded)
          {
