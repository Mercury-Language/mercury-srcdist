  ...
  MR_Word * STATE_VARIABLE_ModeInfo_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_63 = ((MR_Word) ((MR_hl_field(0, Goal0_20, 0))));
        succeeded = ((((MR_tag((MR_Word) Var_63)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_63, 0)))) == (MR_Integer) 2)));
        if (succeeded)
        {
          Var_64 = ((MR_Unsigned) ((MR_hl_field(3, Var_63, 1))) & (MR_Integer) 1);
          ConjGoals_25 = ((MR_Word) ((MR_hl_field(3, Var_63, 2))));
      ...
      else
      {
        ...
        if ((Errors_35 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_82 = ((MR_Word) ((MR_hl_field(0, Goal_34, 0))));
          succeeded = ((((MR_tag((MR_Word) Var_82)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_82, 0)))) == (MR_Integer) 2)));
          if (succeeded)
          {
            Var_105 = ((MR_Unsigned) ((MR_hl_field(3, Var_82, 1))) & (MR_Integer) 1);
            SubGoals_48 = ((MR_Word) ((MR_hl_field(3, Var_82, 2))));
        ...
        {
          MR_Word Var_106 = ((MR_Word) ((MR_hl_field(1, WokenGoals_50, 1))));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_36)
{
  ...
  else
  {
    ...
    Var_55 = ((MR_Word) ((MR_hl_field(1, NonHeadVarUnificationGoals_21, 0))));
    Rest_51 = ((MR_Word) ((MR_hl_field(1, NonHeadVarUnificationGoals_21, 1))));
    Vars1_48 = ((MR_Word) ((MR_hl_field(0, Var_55, 0))));
