...
transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__440__1_2_p_0(
...
{
  {
    ...
    else
    {
      ...
      ProcIds_26 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_12);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      ProcIds_36 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_14);
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialPredId0_84, Name_82, &Var_85, &Var_92);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          SpecialPredId_87 = SpecialPredId0_84;
          succeeded = MR_TRUE;
        }
        else
        {
          ...
          succeeded = ((MR_tag((MR_Word) PredOrigin_88)) == (MR_Integer) 1);
          if (succeeded)
            SpecialPredId_87 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), PredOrigin_88, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_33, (MR_Integer) 18);
          if (succeeded)
          {
            ...
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_36, (MR_Integer) 1, (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[0]), STATE_VARIABLE_ProcTable_21_41, &STATE_VARIABLE_ProcTable_27_47);
        ...
        else
        {
          ...
          if (succeeded)
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_36, (MR_Integer) 1, (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[0]), STATE_VARIABLE_ProcTable_21_41, &STATE_VARIABLE_ProcTable_35_55);
          else
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_36, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[1])), STATE_VARIABLE_ProcTable_21_41, &STATE_VARIABLE_ProcTable_35_55);
      ...
      if (succeeded)
      {
        ...
        {
          TerminationInfo_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    succeeded = transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__440__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
