...
static MR_bool MR_CALL 
transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);
  ...
  MR_Word HeadVar__2_48)
{
  ...
  succeeded = mercury__std_util__isnt_2_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]), HeadVar__1_36, ((MR_Box) (HeadVar__2_48)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ProcTable_12)
{
  ...
  else
  {
    ...
    MR_Word HeadVars_18;
    MR_Word SizeVarMap_20;
    MR_Integer NumHeadVars_21;
    MR_Word HeadVarIds_22;
    MR_Word IdsToProgVars_23;
    MR_Word SubstMap_24;
    MR_Word MaybeSuccessPoly_25;
    MR_Word MaybeFailurePoly_26;
    MR_Word SizeVars_27;
    MR_Integer Var_29;
    MR_Word Var_31;
    MR_Word Var_32;
    MR_Word STATE_VARIABLE_Term2Info_23_33;
    MR_Word STATE_VARIABLE_Term2Info_24_34;
    MR_Word STATE_VARIABLE_Term2Info_25_35;
    MR_Word STATE_VARIABLE_Term2Info_26_36;
    MR_Word STATE_VARIABLE_Term2Info_28_38;
    MR_Word Var_42;
    MR_Word Var_43;
    MR_Word _SizeVarset_19;
    MR_Box conv2_SubstMap_24;

    hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_13_13, &HeadVars_18);
    transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadVars_18, &_SizeVarset_19, &SizeVarMap_20);
    mercury__list__length_2_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVars_18, &NumHeadVars_21);
    Var_29 = (MR_Integer) ((MR_Unsigned) NumHeadVars_21 - (MR_Unsigned) 1);
    HeadVarIds_22 = mercury__list__f_46_46_2_f_0((MR_Integer) 0, Var_29);
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVarIds_22, HeadVars_18, &IdsToProgVars_23);
    {
      Var_42 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_42, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_42, 3) = ((MR_Box) (IdsToProgVars_23));
      MR_hl_field(MR_mktag(0), Var_42, 4) = ((MR_Box) (SizeVarMap_20));
    }
    Var_43 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]));
    mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[1]), Var_42, HeadVarIds_22, ((MR_Box) (Var_43)), &conv2_SubstMap_24);
    SubstMap_24 = ((MR_Word) (conv2_SubstMap_24));
    Var_31 = transform_hlds__term_constr_main_types__term2_info_get_import_success_1_f_0(Term2Info0_7);
    if ((Var_31 == (MR_Word) ((MR_Unsigned) 0U)))
      MaybeSuccessPoly_25 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word PragmaArgSizeInfo_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_31, (MR_Integer) 0))));
      MR_Word Polyhedron_48;
      MR_Word Constraints_49;
      MR_Word Var_50;

      {
        Var_50 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[2]));
        MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_2));
        MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (SubstMap_24));
      }
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_arg_size_constr_0), (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0), Var_50, PragmaArgSizeInfo_47, &Constraints_49);
      Polyhedron_48 = libs__polyhedron__from_constraints_1_f_0(Constraints_49);
      {
        MaybeSuccessPoly_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeSuccessPoly_25, 0) = ((MR_Box) (Polyhedron_48));
      }
    }
    Var_32 = transform_hlds__term_constr_main_types__term2_info_get_import_failure_1_f_0(Term2Info0_7);
    if ((Var_32 == (MR_Word) ((MR_Unsigned) 0U)))
      MaybeFailurePoly_26 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word PragmaArgSizeInfo_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_32, (MR_Integer) 0))));
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[2]));
        MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_3));
        MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (SubstMap_24));
      }
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_arg_size_constr_0), (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0), Var_56, PragmaArgSizeInfo_53, &Constraints_55);
      Polyhedron_54 = libs__polyhedron__from_constraints_1_f_0(Constraints_55);
      {
        MaybeFailurePoly_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeFailurePoly_26, 0) = ((MR_Box) (Polyhedron_54));
      }
    }
    SizeVars_27 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(SizeVarMap_20, HeadVars_18);
    transform_hlds__term_constr_main_types__term2_info_set_size_var_map_3_p_0(SizeVarMap_20, Term2Info0_7, &STATE_VARIABLE_Term2Info_23_33);
    transform_hlds__term_constr_main_types__term2_info_set_head_vars_3_p_0(SizeVars_27, STATE_VARIABLE_Term2Info_23_33, &STATE_VARIABLE_Term2Info_24_34);
    transform_hlds__term_constr_main_types__term2_info_set_success_constrs_3_p_0(MaybeSuccessPoly_25, STATE_VARIABLE_Term2Info_24_34, &STATE_VARIABLE_Term2Info_25_35);
    transform_hlds__term_constr_main_types__term2_info_set_failure_constrs_3_p_0(MaybeFailurePoly_26, STATE_VARIABLE_Term2Info_25_35, &STATE_VARIABLE_Term2Info_26_36);
    transform_hlds__term_constr_main_types__term2_info_set_import_success_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Term2Info_26_36, &STATE_VARIABLE_Term2Info_28_38);
    transform_hlds__term_constr_main_types__term2_info_set_import_failure_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Term2Info_28_38, &Term2Info_10);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  else
  {
    ...
    MR_Word PredInfo_12;
    MR_Word ProcIds_17;
    MR_Word STATE_VARIABLE_ProcTable_8_18;
    MR_Word STATE_VARIABLE_ProcTable_10_20;
    MR_Box conv1_STATE_VARIABLE_ProcTable_10_20;

    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_13, PredId_4, &PredInfo0_11);
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_11, &STATE_VARIABLE_ProcTable_8_18);
    ProcIds_17 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_11);
    mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[4]), ProcIds_17, ((MR_Box) (STATE_VARIABLE_ProcTable_8_18)), &conv1_STATE_VARIABLE_ProcTable_10_20);
    STATE_VARIABLE_ProcTable_10_20 = ((MR_Word) (conv1_STATE_VARIABLE_ProcTable_10_20));
    hlds__hlds_pred__pred_info_set_proc_table_3_p_0(STATE_VARIABLE_ProcTable_10_20, PredInfo0_11, &PredInfo_12);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialPredId0_59, Name_57, &Var_60, &Var_65);
        if (succeeded)
        {
        ...
        else
        {
          ...
          if (succeeded)
            SpecialPredId_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), PredOrigin_63, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
          transform_hlds__term_constr_initial__set_generated_terminates_5_p_0(ProcIds_21, SpecialPredId_62, STATE_VARIABLE_ModuleInfo_0_3, STATE_VARIABLE_ProcTable_21_26, &STATE_VARIABLE_ProcTable_22_27);
          succeeded = MR_TRUE;
        }
      }
      if (succeeded)
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_36 = (MR_Integer) 20;
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_19, Var_36);
            }
          }
          if (succeeded)
            ...
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_21, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[1])), STATE_VARIABLE_ProcTable_21_26, &STATE_VARIABLE_ProcTable_35_40);
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(2), Var_49, 0) = ((MR_Box) (PredId_10));
        }
        {
          Var_48 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (Context_20));
        ...
        {
          TerminationInfo_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TerminationInfo_24, 0) = ((MR_Box) (Var_47));
        }
              ...
              case (MR_Integer) 53:
                {
                  ...
                  ;
                  {
                    ...
                    Var_136 = libs__lp_rational__make_vars_eq_constraint_2_f_0(SizeVar1_12, SizeVar2_13);
                    {
                      Constraints_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Constraints_8, 0) = ((MR_Box) (Var_136));
  ...
  MR_Word * STATE_VARIABLE_ProcTable_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word VarMap_22;
      MR_Word HeadSizeVars_23;
      MR_Word TermStatus_25;
      MR_Word ProcInfo_27;
      MR_Word STATE_VARIABLE_Term2Info_30_30;
      MR_Word Var_31;
      MR_Word STATE_VARIABLE_Term2Info_32_32;
      MR_Word STATE_VARIABLE_Term2Info_33_33;
      MR_Word STATE_VARIABLE_Term2Info_35_35;
      MR_Word STATE_VARIABLE_Term2Info_36_36;
      MR_Word STATE_VARIABLE_Term2Info_37_37;
      MR_Word STATE_VARIABLE_ProcTable_38_38;
      ...
      hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo0_16, &_VarSet_18, &VarTypes_19);
      switch (SpecialPredId_2) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 2:
          {
            MR_Word Zeros_67;
            MR_Word Constraints_68;
            MR_Word _SizeVarset_66;

            transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadVars_17, &_SizeVarset_66, &VarMap_22);
            Zeros_67 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_3, VarMap_22, VarTypes_19);
            Constraints_68 = transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0(VarMap_22, Zeros_67);
            ArgSize_20 = libs__polyhedron__from_constraints_1_f_0(Constraints_68);
            Termination_21 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
            HeadSizeVars_23 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(VarMap_22, HeadVars_17);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Integer NumToDrop_46;
            MR_Integer Var_48;
            MR_Word _ZeroSizeHeadVars_47;

            Var_48 = mercury__list__length_1_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVars_17);
            NumToDrop_46 = (MR_Integer) ((MR_Unsigned) Var_48 - (MR_Unsigned) 2);
            succeeded = mercury__list__drop_3_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), NumToDrop_46, HeadVars_17, &_ZeroSizeHeadVars_47);
            if (succeeded)
            {
              MR_Word Zeros_72;
              MR_Word Constraints_73;
              MR_Word _SizeVarset_71;

              transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadVars_17, &_SizeVarset_71, &VarMap_22);
              Zeros_72 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_3, VarMap_22, VarTypes_19);
              Constraints_73 = transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0(VarMap_22, Zeros_72);
              ArgSize_20 = libs__polyhedron__from_constraints_1_f_0(Constraints_73);
              Termination_21 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
              HeadSizeVars_23 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(VarMap_22, HeadVars_17);
            }
            else
        ...
        case (MR_Integer) 0:
          {
            MR_Word Zeros_43;
            MR_Word NonZeroHeadSizeVars_44;
            MR_Word Constrs_45;
            MR_Word Var_52;
            MR_Word Var_53;
            MR_Word _SizeVarset_42;

            transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadVars_17, &_SizeVarset_42, &VarMap_22);
            HeadSizeVars_23 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(VarMap_22, HeadVars_17);
            Zeros_43 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_3, VarMap_22, VarTypes_19);
            {
              Var_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_1));
              MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (Zeros_43));
            }
            {
              Var_52 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[1]));
              MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_2));
              MR_hl_field(MR_mktag(0), Var_52, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_52, 3) = ((MR_Box) (Var_53));
            }
            NonZeroHeadSizeVars_44 = mercury__list__filter_2_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]), Var_52, HeadSizeVars_23);
            if ((NonZeroHeadSizeVars_44 == (MR_Word) ((MR_Unsigned) 0U)))
              Constrs_45 = (MR_Word) ((MR_Unsigned) 0U);
            else
            {
              MR_Word Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonZeroHeadSizeVars_44, (MR_Integer) 1))));
              MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonZeroHeadSizeVars_44, (MR_Integer) 0))));
              ...
              {
                MR_Word Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 1))));
                MR_Word Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 0))));

                if ((Var_64 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  MR_Word Var_56;

                  Var_56 = libs__lp_rational__make_vars_eq_constraint_2_f_0(Var_63, Var_65);
                  {
                    Constrs_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Constrs_45, 0) = ((MR_Box) (Var_56));
                    MR_hl_field(MR_mktag(1), Constrs_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
                else
                  {
            ...
            ArgSize_20 = libs__polyhedron__from_constraints_1_f_0(Constrs_45);
            Termination_21 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
          }
          break;
      }
      hlds__hlds_pred__proc_info_get_termination2_info_2_p_0(ProcInfo0_16, &STATE_VARIABLE_Term2Info_30_30);
      {
        Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (ArgSize_20));
      }
      transform_hlds__term_constr_main_types__term2_info_set_success_constrs_3_p_0(Var_31, STATE_VARIABLE_Term2Info_30_30, &STATE_VARIABLE_Term2Info_32_32);
      {
        TermStatus_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), TermStatus_25, 0) = ((MR_Box) (Termination_21));
      }
      transform_hlds__term_constr_main_types__term2_info_set_term_status_3_p_0(TermStatus_25, STATE_VARIABLE_Term2Info_32_32, &STATE_VARIABLE_Term2Info_33_33);
      transform_hlds__term_constr_main_types__term2_info_set_intermod_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[2])), STATE_VARIABLE_Term2Info_33_33, &STATE_VARIABLE_Term2Info_35_35);
      transform_hlds__term_constr_main_types__term2_info_set_size_var_map_3_p_0(VarMap_22, STATE_VARIABLE_Term2Info_35_35, &STATE_VARIABLE_Term2Info_36_36);
      transform_hlds__term_constr_main_types__term2_info_set_head_vars_3_p_0(HeadSizeVars_23, STATE_VARIABLE_Term2Info_36_36, &STATE_VARIABLE_Term2Info_37_37);
      hlds__hlds_pred__proc_info_set_termination2_info_3_p_0(STATE_VARIABLE_Term2Info_37_37, ProcInfo0_16, &ProcInfo_27);
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_11)), ((MR_Box) (ProcInfo_27)), STATE_VARIABLE_ProcTable_0_4, &STATE_VARIABLE_ProcTable_38_38);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = ProcIds_12;
      next_value_of_STATE_VARIABLE_ProcTable_0_4 = STATE_VARIABLE_ProcTable_38_38;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
