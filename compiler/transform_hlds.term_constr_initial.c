  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__term_constr_initial__IntroducedFrom__pred__create_substitution_map__217__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_LambdaHeadVar__3_17);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  TypeSpecPredIds_8 = ((MR_Word) ((MR_hl_field(0, TypeSpecTables_6, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        transform_hlds__term_constr_initial__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_115_101_116_95_98_117_105_108_116_105_110_95_116_101_114_109_105_110_97_116_101_115_95_95_91_51_93_95_48_6_p_0(STATE_VARIABLE_ModuleInfo_0_3, PredInfo0_16, ProcIds_21, STATE_VARIABLE_ProcTable_21_26, &STATE_VARIABLE_ProcTable_22_27);
        succeeded = MR_TRUE;
      }
      else
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_19, (MR_Integer) 19);
          if (succeeded)
          {
  ...
  MR_Word * STATE_VARIABLE_ProcTable_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_16)), ((MR_Box) (ProcInfo_33)), STATE_VARIABLE_ProcTable_0_5, &STATE_VARIABLE_ProcTable_48_48);
      // direct tailcall eliminated
      ;
  ...
  MR_Word SizeVarMap_7)
{
  ...
  {
    MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, HeadVars_6, (MR_Integer) 1))));
    MR_Word Var_157 = ((MR_Word) ((MR_hl_field(1, HeadVars_6, (MR_Integer) 0))));
    ...
    else
    {
      ...
      {
        MR_Word Var_160 = ((MR_Word) ((MR_hl_field(1, Var_158, (MR_Integer) 1))));
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    MR_Word Var_172 = ((MR_Word) ((MR_hl_field(1, Var_170, (MR_Integer) 1))));
