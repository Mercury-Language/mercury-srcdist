      ...
      case (MR_Integer) 2:
        {
          ...
          *Termination_6 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
      ...
      case (MR_Integer) 1:
        {
          ...
          NumToDrop_54 = (MR_Integer) ((MR_Unsigned) Var_56 - (MR_Unsigned) 2);
      ...
      case (MR_Integer) 0:
        {
          ...
          *HeadSizeVars_8 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(*SizeVarMap_7, HeadProgVars_2);
          ...
          if ((NonZeroHeadSizeVars_25 == (MR_Word) ((MR_Unsigned) 0U)))
            Constrs_26 = (MR_Word) ((MR_Unsigned) 0U);
          else
          {
            ...
            else
            {
              ...
              if ((Var_69 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                {
                  Constrs_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Constrs_26, 0) = ((MR_Box) (Var_44));
                  MR_hl_field(MR_mktag(1), Constrs_26, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
              }
              else
                {
...
{
  {
    ...
    *Termination_12 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
