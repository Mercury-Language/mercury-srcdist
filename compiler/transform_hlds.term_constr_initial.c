        ...
        if ((transform_hlds__term_constr_initial__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *transform_hlds__term_constr_initial__STATE_VARIABLE_ProcTable_6 = transform_hlds__term_constr_initial__STATE_VARIABLE_ProcTable_0_5;
        else
          {
            ...
            transform_hlds__term_constr_initial__Var_41 = (MR_Word) &transform_hlds__term_constr_initial_scalar_common_5[3];
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_36, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[0]));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_35, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[1]));
    ...
    if (((MR_tag((MR_Word) transform_hlds__term_constr_initial__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_16, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_3[3]));
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_9, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_3[3]));
      ...
      *transform_hlds__term_constr_initial__STATE_VARIABLE_ProcTable_12 = transform_hlds__term_constr_initial__STATE_VARIABLE_ProcTable_0_11;
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_57, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[0]));
        ...
        if ((transform_hlds__term_constr_initial__Var_37 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_79, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_3[2]));
        ...
        if ((transform_hlds__term_constr_initial__Var_38 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__Var_89, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_3[2]));
