  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          transform_hlds__term_constr_initial__set_generated_terminates_5_p_0(ProcIds_33, SpecialPredId_84, STATE_VARIABLE_ModuleInfo_0_3, STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_22_39);
          succeeded = MR_TRUE;
        }
      }
      if (succeeded)
