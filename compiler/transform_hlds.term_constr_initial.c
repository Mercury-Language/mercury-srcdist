  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_19, (MR_Integer) 19);
          if (succeeded)
          {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_19, Var_37);
            }
          }
          if (succeeded)
      ...
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_19, (MR_Integer) 20);
      if (succeeded)
      {
