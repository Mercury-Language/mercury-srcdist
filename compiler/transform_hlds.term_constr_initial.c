  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          transform_hlds__term_constr_initial__set_generated_terminates_5_p_0(STATE_VARIABLE_ModuleInfo_0_3, SpecialPredId_86, ProcIds_35, STATE_VARIABLE_ProcTable_21_40, &STATE_VARIABLE_ProcTable_22_41);
          succeeded = MR_TRUE;
        }
      }
      if (succeeded)
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_51 = (MR_Integer) 20;
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_32, Var_51);
            }
          }
          if (succeeded)
