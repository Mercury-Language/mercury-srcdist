  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              SpecialPredId_84 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_88, (MR_Integer) 0))) & (MR_Integer) 3);
          }
        }
        if (succeeded)
        {
      ...
      succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_30, (MR_Integer) 20);
      if (succeeded)
      {
