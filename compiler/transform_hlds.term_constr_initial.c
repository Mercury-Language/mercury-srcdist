  ...
  MR_Word * STATE_VARIABLE_ProcTable_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypeCtorInfo_49_49 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
      MR_Word TypeCtorInfo_50_50 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      ...
      conv0_ProcInfo0_19 = mercury__map__det_elem_2_f_0(TypeCtorInfo_49_49, TypeCtorInfo_50_50, ((MR_Box) (ProcId_13)), STATE_VARIABLE_ProcTable_0_5);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_62 = libs__lp_rational__make_vars_eq_constraint_2_f_0(SizeVar1_57, SizeVar2_58);
                {
                  ...
                  MR_hl_field(MR_mktag(1), ConstraintsPrime_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                succeeded = MR_TRUE;
              }
              else
              ...
              label_0:;
                if (succeeded)
                {
                  ConstraintsPrime_59 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                  succeeded = MR_TRUE;
                }
              }
            }
      ...
      Var_41 = (MR_Integer) 0;
      Var_40 = (MR_Word) &transform_hlds__term_constr_initial_scalar_common_3[0];
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_49_49, TypeCtorInfo_50_50, ((MR_Box) (ProcId_13)), ((MR_Box) (ProcInfo_33)), STATE_VARIABLE_ProcTable_0_5, &STATE_VARIABLE_ProcTable_47_47);
      // direct tailcall eliminated
...
{
  {
    ...
    switch (HeadVar__1_1) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word TypeInfo_64_64 = (MR_Word) &transform_hlds__term_constr_initial_scalar_common_2[0];
          MR_Integer NumToDrop_54;
          MR_Integer Var_56;
          MR_Word _ZeroSizeHeadVars_55;

          Var_56 = mercury__list__length_1_f_0(TypeInfo_64_64, HeadProgVars_2);
          NumToDrop_54 = (Var_56 - (MR_Integer) 2);
          succeeded = mercury__list__drop_3_p_0(TypeInfo_64_64, NumToDrop_54, HeadProgVars_2, &_ZeroSizeHeadVars_55);
          if (succeeded)
