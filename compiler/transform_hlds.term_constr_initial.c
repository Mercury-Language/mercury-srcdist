  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialPredId0_59, Name_57, &Var_60, &Var_66);
        if (succeeded)
        {
          succeeded = (Arity_58 == Var_66);
          if (succeeded)
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredOrigin_63, (MR_Integer) 0))));
            succeeded = ((MR_tag((MR_Word) Var_65)) == (MR_Integer) 0);
            if (succeeded)
              SpecialPredId_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0))) & (MR_Integer) 3);
          }
        }
        if (succeeded)
        {
