    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_65 = ((MR_Word) ((MR_hl_field(1, PredOrigin_63, (MR_Integer) 0))));
            succeeded = ((MR_tag((MR_Word) Var_65)) == (MR_Integer) 0);
            if (succeeded)
              SpecialPredId_62 = ((MR_Unsigned) ((MR_hl_field(0, Var_65, (MR_Integer) 0))) & (MR_Integer) 3);
          }
        }
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_ProcTable_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      transform_hlds__term_constr_main_types__term2_info_set_term_status_3_p_0((MR_Word) (MR_mkword(1, &transform_hlds__term_constr_initial_scalar_common_3[4])), STATE_VARIABLE_Term2Info_39_39, &STATE_VARIABLE_Term2Info_42_42);
      transform_hlds__term_constr_main_types__term2_info_set_intermod_status_3_p_0((MR_Word) (MR_mkword(1, &transform_hlds__term_constr_initial_scalar_common_3[2])), STATE_VARIABLE_Term2Info_42_42, &STATE_VARIABLE_Term2Info_44_44);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__437__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
        ...
        case (MR_Integer) 0:
          {
            ...
            Zeros_41 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_1, VarTable_18, VarMap_21);
            {
              ...
              MR_hl_field(0, Var_47, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[0]));
              MR_hl_field(0, Var_47, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_1));
              MR_hl_field(0, Var_47, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(0, Var_47, 3) = ((MR_Box) (Zeros_41));
            }
            {
              Var_46 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_46, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[1]));
              MR_hl_field(0, Var_46, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_2));
              MR_hl_field(0, Var_46, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(0, Var_46, 3) = ((MR_Box) (Var_47));
            }
            ...
            {
              MR_Word Var_60 = ((MR_Word) ((MR_hl_field(1, NonZeroHeadSizeVars_42, (MR_Integer) 1))));
              MR_Word Var_61 = ((MR_Word) ((MR_hl_field(1, NonZeroHeadSizeVars_42, (MR_Integer) 0))));
              ...
              {
                MR_Word Var_62 = ((MR_Word) ((MR_hl_field(1, Var_60, (MR_Integer) 1))));
                MR_Word Var_63 = ((MR_Word) ((MR_hl_field(1, Var_60, (MR_Integer) 0))));
                ...
                if ((Var_62 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  Var_48 = libs__lp_rational__make_vars_eq_constraint_2_f_0(Var_61, Var_63);
                  {
                    ...
                    MR_hl_field(1, Constrs_43, 0) = ((MR_Box) (Var_48));
