...
static /* final */ const MR_Box transform_hlds__term_constr_initial_scalar_common_5[4][6];

static /* final */ const MR_Box transform_hlds__term_constr_initial_scalar_common_6[1][8];
...
static /* final */ const MR_Box transform_hlds__term_constr_initial_scalar_common_1[5][3] = {
  ...
  /* row 3 */
  {
    ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[0])),
    ((MR_Box) (transform_hlds__term_constr_initial__term2_preprocess_module_2_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 4 */
  {
    ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[1])),
  ...
  MR_Word * Constraint_3)
{
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[3]));
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_9, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[3]));
...
{
  {
    ...
    else
    {
      ...
      mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVarIds_26, HeadVars_22, &IdsToProgVars_27);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[0]));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[2]));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_5[2]));
  ...
  MR_Word * STATE_VARIABLE_ProcTable_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                {
                  ConstraintsPrime_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ConstraintsPrime_59, 0) = ((MR_Box) (Var_62));
                  MR_hl_field(MR_mktag(1), ConstraintsPrime_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                if ((strcmp(PredName_22, (MR_String) "builtin_compound_eq") == 0))
                  succeeded = MR_TRUE;
                else
                if ((strcmp(PredName_22, (MR_String) "builtin_compound_lt") == 0))
                  succeeded = MR_TRUE;
                else
                if ((strcmp(PredName_22, (MR_String) "store_at_ref_impure") == 0))
                  succeeded = MR_TRUE;
                else
                  succeeded = MR_FALSE;
                if (succeeded)
                {
                  ConstraintsPrime_59 = (MR_Word) ((MR_Unsigned) 0U);
                  succeeded = MR_TRUE;
                }
              }
            }
      ...
      transform_hlds__term_constr_main_types__term2_info_set_term_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[2])), STATE_VARIABLE_Term2Info_39_39, &STATE_VARIABLE_Term2Info_42_42);
      transform_hlds__term_constr_main_types__term2_info_set_intermod_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[1])), STATE_VARIABLE_Term2Info_42_42, &STATE_VARIABLE_Term2Info_44_44);
