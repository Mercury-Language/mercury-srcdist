  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialPredId0_81, Name_79, &Var_82, &Var_89);
        if (succeeded)
        {
          succeeded = (Arity_80 == Var_89);
          if (succeeded)
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredOrigin_85, (MR_Integer) 0))));
            succeeded = ((MR_tag((MR_Word) Var_88)) == (MR_Integer) 1);
            if (succeeded)
              SpecialPredId_84 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_88, (MR_Integer) 0))) & (MR_Integer) 3);
          }
        }
        if (succeeded)
        {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__437__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
