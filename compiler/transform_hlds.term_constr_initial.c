...
transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__432__1_2_p_0(
  MR_Word HeadVar__1_32,
  MR_Word HeadVar__2_48);

static void MR_CALL 
transform_hlds__term_constr_initial__IntroducedFrom__pred__create_substitution_map__215__1_5_p_0(
...
transform_hlds__term_constr_initial__special_pred_id_to_termination_8_p_0(
  ...
  MR_Word HeadProgVars_10,
  MR_Word ModuleInfo_11,
  MR_Word VarTable_12,
  MR_Word * ArgSizeInfo_13,
  MR_Word * Termination_14,
  MR_Word * SizeVarMap_15,
  MR_Word * HeadSizeVars_16);
  ...
  MR_Word HeadVar__2_48)
{
  ...
  succeeded = mercury__std_util__isnt_2_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]), HeadVar__1_32, ((MR_Box) (HeadVar__2_48)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__term_constr_initial__IntroducedFrom__pred__create_substitution_map__215__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_LambdaHeadVar__3_17);
  ...
  MR_Word * STATE_VARIABLE_ProcTable_12)
{
  ...
  else
  {
    ...
    MR_Word HeadVars_21;
    MR_Word SizeVarMap_23;
    MR_Integer NumHeadVars_24;
    MR_Word HeadVarIds_25;
    MR_Word IdsToProgVars_26;
    MR_Word SubstMap_27;
    MR_Word MaybeSuccessPoly_28;
    MR_Word MaybeFailurePoly_29;
    MR_Word SizeVars_30;
    MR_Integer Var_32;
    MR_Word Var_34;
    MR_Word Var_35;
    MR_Word STATE_VARIABLE_Term2Info_23_36;
    MR_Word STATE_VARIABLE_Term2Info_24_37;
    MR_Word STATE_VARIABLE_Term2Info_25_38;
    MR_Word STATE_VARIABLE_Term2Info_26_39;
    MR_Word STATE_VARIABLE_Term2Info_28_41;
    MR_Word Var_53;
    MR_Word Var_54;
    MR_Word _SizeVarset_22;
    MR_Box conv2_SubstMap_27;

    hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_13_13, &HeadVars_21);
    transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadVars_21, &_SizeVarset_22, &SizeVarMap_23);
    mercury__list__length_2_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVars_21, &NumHeadVars_24);
    Var_32 = (MR_Integer) ((MR_Unsigned) NumHeadVars_24 - (MR_Unsigned) 1);
    HeadVarIds_25 = mercury__list__f_46_46_2_f_0((MR_Integer) 0, Var_32);
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVarIds_25, HeadVars_21, &IdsToProgVars_26);
    {
      Var_53 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (IdsToProgVars_26));
      MR_hl_field(MR_mktag(0), Var_53, 4) = ((MR_Box) (SizeVarMap_23));
    }
    Var_54 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]));
    mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[1]), Var_53, HeadVarIds_25, ((MR_Box) (Var_54)), &conv2_SubstMap_27);
    SubstMap_27 = ((MR_Word) (conv2_SubstMap_27));
    Var_34 = transform_hlds__term_constr_main_types__term2_info_get_import_success_1_f_0(Term2Info0_7);
    if ((Var_34 == (MR_Word) ((MR_Unsigned) 0U)))
      MaybeSuccessPoly_28 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word PragmaArgSizeInfo_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_34, (MR_Integer) 0))));
      MR_Word Polyhedron_73;
      MR_Word Constraints_74;
      MR_Word Var_75;

      {
        Var_75 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[2]));
        MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_2));
        MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_75, 3) = ((MR_Box) (SubstMap_27));
      }
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_arg_size_constr_0), (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0), Var_75, PragmaArgSizeInfo_72, &Constraints_74);
      Polyhedron_73 = libs__polyhedron__from_constraints_1_f_0(Constraints_74);
      {
        MaybeSuccessPoly_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeSuccessPoly_28, 0) = ((MR_Box) (Polyhedron_73));
      }
    }
    Var_35 = transform_hlds__term_constr_main_types__term2_info_get_import_failure_1_f_0(Term2Info0_7);
    if ((Var_35 == (MR_Word) ((MR_Unsigned) 0U)))
      MaybeFailurePoly_29 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word PragmaArgSizeInfo_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 0))));
      MR_Word Polyhedron_83;
      MR_Word Constraints_84;
      MR_Word Var_85;

      {
        Var_85 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_85, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_6[2]));
        MR_hl_field(MR_mktag(0), Var_85, 1) = ((MR_Box) (transform_hlds__term_constr_initial__process_imported_proc_3_p_0_3));
        MR_hl_field(MR_mktag(0), Var_85, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_85, 3) = ((MR_Box) (SubstMap_27));
      }
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_arg_size_constr_0), (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0), Var_85, PragmaArgSizeInfo_82, &Constraints_84);
      Polyhedron_83 = libs__polyhedron__from_constraints_1_f_0(Constraints_84);
      {
        MaybeFailurePoly_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeFailurePoly_29, 0) = ((MR_Box) (Polyhedron_83));
      }
    }
    SizeVars_30 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(SizeVarMap_23, HeadVars_21);
    transform_hlds__term_constr_main_types__term2_info_set_size_var_map_3_p_0(SizeVarMap_23, Term2Info0_7, &STATE_VARIABLE_Term2Info_23_36);
    transform_hlds__term_constr_main_types__term2_info_set_head_vars_3_p_0(SizeVars_30, STATE_VARIABLE_Term2Info_23_36, &STATE_VARIABLE_Term2Info_24_37);
    transform_hlds__term_constr_main_types__term2_info_set_success_constrs_3_p_0(MaybeSuccessPoly_28, STATE_VARIABLE_Term2Info_24_37, &STATE_VARIABLE_Term2Info_25_38);
    transform_hlds__term_constr_main_types__term2_info_set_failure_constrs_3_p_0(MaybeFailurePoly_29, STATE_VARIABLE_Term2Info_25_38, &STATE_VARIABLE_Term2Info_26_39);
    transform_hlds__term_constr_main_types__term2_info_set_import_success_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Term2Info_26_39, &STATE_VARIABLE_Term2Info_28_41);
    transform_hlds__term_constr_main_types__term2_info_set_import_failure_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Term2Info_28_41, &Term2Info_10);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  TypeSpecPredIds_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo_6, (MR_Integer) 1))));
  ...
  else
  {
    ...
    MR_Box conv1_STATE_VARIABLE_ProcTable_10_23;

    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_13, PredId_4, &PredInfo0_11);
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_11, &STATE_VARIABLE_ProcTable_8_21);
    ProcIds_20 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_11);
    mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_1[4]), ProcIds_20, ((MR_Box) (STATE_VARIABLE_ProcTable_8_21)), &conv1_STATE_VARIABLE_ProcTable_10_23);
    STATE_VARIABLE_ProcTable_10_23 = ((MR_Word) (conv1_STATE_VARIABLE_ProcTable_10_23));
    hlds__hlds_pred__pred_info_set_proc_table_3_p_0(STATE_VARIABLE_ProcTable_10_23, PredInfo0_11, &PredInfo_12);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Context_31;
      MR_Word ProcIds_33;
      MR_Word STATE_VARIABLE_ProcTable_21_38;
      MR_Word STATE_VARIABLE_ProcTable_30_47;
      MR_Word STATE_VARIABLE_ProcTable_52_69;
      MR_Word STATE_VARIABLE_ProcTable_22_39;
      ...
      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_21, &PredStatus_29);
      hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_21, &Markers_30);
      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_21, &Context_31);
      hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_21, &STATE_VARIABLE_ProcTable_21_38);
      ProcIds_33 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_21);
      succeeded = hlds__hlds_pred__pred_info_is_builtin_1_p_0(PredInfo0_21);
      if (succeeded)
      {
        transform_hlds__term_constr_initial__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_115_101_116_95_98_117_105_108_116_105_110_95_116_101_114_109_105_110_97_116_101_115_95_95_91_50_93_95_48_6_p_0(ProcIds_33, PredInfo0_21, STATE_VARIABLE_ModuleInfo_0_3, STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_22_39);
        succeeded = MR_TRUE;
      }
      else
      {
        MR_Word SpecialPredId_84;
        MR_Word SpecialPredId0_81;
        MR_String Name_79;
        MR_Integer Arity_80;
        ...
        Name_79 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo0_21);
        Arity_80 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(PredInfo0_21);
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialPredId0_81, Name_79, &Var_82, &Var_87);
        if (succeeded)
        {
          succeeded = (Arity_80 == Var_87);
          if (succeeded)
          {
            ModuleName_83 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo0_21);
            succeeded = mdbcomp__builtin_modules__any_mercury_builtin_module_1_p_0(ModuleName_83);
          }
        }
        if (succeeded)
        {
          SpecialPredId_84 = SpecialPredId0_81;
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word PredOrigin_85;

          hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_21, &PredOrigin_85);
          succeeded = ((MR_tag((MR_Word) PredOrigin_85)) == (MR_Integer) 1);
          if (succeeded)
            SpecialPredId_84 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), PredOrigin_85, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
          transform_hlds__term_constr_initial__set_generated_terminates_5_p_0(STATE_VARIABLE_ModuleInfo_0_3, SpecialPredId_84, ProcIds_33, STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_22_39);
          succeeded = MR_TRUE;
        }
      }
      if (succeeded)
        STATE_VARIABLE_ProcTable_30_47 = STATE_VARIABLE_ProcTable_22_39;
      else
      {
        MR_Word Var_40;

        Var_40 = hlds__status__pred_status_defined_in_this_module_1_f_0(PredStatus_29);
        succeeded = (Var_40 == (MR_Integer) 1);
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_30, (MR_Integer) 18);
          if (succeeded)
          {
            MR_Word ArgSizeInfo_35;
            MR_Word STATE_VARIABLE_ProcTable_27_44;
            MR_Word STATE_VARIABLE_ProcTable_29_46;

            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_33, (MR_Integer) 1, (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[0]), STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_27_44);
            ArgSizeInfo_35 = libs__polyhedron__universe_0_f_0();
            transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_p_0(ProcIds_33, (MR_Integer) 1, ArgSizeInfo_35, STATE_VARIABLE_ProcTable_27_44, &STATE_VARIABLE_ProcTable_29_46);
            transform_hlds__term_constr_initial__initialise_size_var_maps_3_p_0(ProcIds_33, STATE_VARIABLE_ProcTable_29_46, &STATE_VARIABLE_ProcTable_30_47);
          }
          else
            STATE_VARIABLE_ProcTable_30_47 = STATE_VARIABLE_ProcTable_21_38;
        }
        else
        {
          MR_Word STATE_VARIABLE_ProcTable_35_52;
          MR_Word ArgSizeInfo_71;
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_49 = (MR_Integer) 20;
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_30, Var_49);
            }
          }
          if (succeeded)
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_33, (MR_Integer) 1, (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[0]), STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_35_52);
          else
            transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_33, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[1])), STATE_VARIABLE_ProcTable_21_38, &STATE_VARIABLE_ProcTable_35_52);
          ArgSizeInfo_71 = libs__polyhedron__universe_0_f_0();
          transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_p_0(ProcIds_33, (MR_Integer) 1, ArgSizeInfo_71, STATE_VARIABLE_ProcTable_35_52, &STATE_VARIABLE_ProcTable_30_47);
        }
      }
      succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_30, (MR_Integer) 19);
      if (succeeded)
      {
        MR_Word TerminationInfo_36;
        MR_Word NonTermArgSizeInfo_37;
        MR_Word Var_61;
        MR_Word Var_62;
        MR_Word Var_63;
        MR_Word STATE_VARIABLE_ProcTable_49_66;
        MR_Word STATE_VARIABLE_ProcTable_51_68;

        {
          Var_63 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_63, 0) = ((MR_Box) (PredId_10));
        }
        {
          Var_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (Context_31));
        ...
        {
          TerminationInfo_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TerminationInfo_36, 0) = ((MR_Box) (Var_61));
        }
        NonTermArgSizeInfo_37 = libs__polyhedron__universe_0_f_0();
        transform_hlds__term_constr_util__change_procs_constr_termination_info_5_p_0(ProcIds_33, (MR_Integer) 1, TerminationInfo_36, STATE_VARIABLE_ProcTable_30_47, &STATE_VARIABLE_ProcTable_49_66);
        transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_p_0(ProcIds_33, (MR_Integer) 1, NonTermArgSizeInfo_37, STATE_VARIABLE_ProcTable_49_66, &STATE_VARIABLE_ProcTable_51_68);
        transform_hlds__term_constr_initial__initialise_size_var_maps_3_p_0(ProcIds_33, STATE_VARIABLE_ProcTable_51_68, &STATE_VARIABLE_ProcTable_52_69);
      }
      else
        STATE_VARIABLE_ProcTable_52_69 = STATE_VARIABLE_ProcTable_30_47;
      hlds__hlds_pred__pred_info_set_proc_table_3_p_0(STATE_VARIABLE_ProcTable_52_69, PredInfo0_21, &PredInfo_22);
      hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_10, PredInfo_22, STATE_VARIABLE_ModuleInfo_0_3, &STATE_VARIABLE_ModuleInfo_15_15);
  ...
  MR_Word * STATE_VARIABLE_ProcTable_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        ArgSizeInfo_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      transform_hlds__term_constr_main_types__term2_info_set_term_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[4])), STATE_VARIABLE_Term2Info_39_39, &STATE_VARIABLE_Term2Info_42_42);
      transform_hlds__term_constr_main_types__term2_info_set_intermod_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[2])), STATE_VARIABLE_Term2Info_42_42, &STATE_VARIABLE_Term2Info_44_44);
  ...
  MR_Word SizeVarMap_7)
{
  ...
  {
    MR_Word Var_145 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVars_6, (MR_Integer) 1))));
    MR_Word Var_146 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVars_6, (MR_Integer) 0))));
    ...
    else
    {
              ...
              case (MR_Integer) 53:
                {
                  ...
                  ;
                  {
                    ...
                    {
                      Constraints_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Constraints_8, 0) = ((MR_Box) (Var_74));
                      MR_hl_field(MR_mktag(1), Constraints_8, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                  }
                }
                break;
      ...
      else
      {
        ...
        {
          MR_Word Var_151 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_149, (MR_Integer) 1))));
          ...
          else
          {
            ...
            else
            {
              ...
              {
                MR_Word Var_157 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_155, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_ProcTable_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_1, ProcInfo0_16, &VarTable_18);
      transform_hlds__term_constr_initial__special_pred_id_to_termination_8_p_0(SpecialPredId_2, HeadVars_17, ModuleInfo_1, VarTable_18, &ArgSize_19, &Termination_20, &VarMap_21, &HeadSizeVars_22);
      ...
      {
        TermStatus_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      transform_hlds__term_constr_main_types__term2_info_set_intermod_status_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_initial_scalar_common_3[2])), STATE_VARIABLE_Term2Info_32_32, &STATE_VARIABLE_Term2Info_34_34);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__432__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * HeadSizeVars_16)
{
  ...
  switch (SpecialPredId_9) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Zeros_66;
        MR_Word Constraints_67;
        MR_Word _SizeVarset_65;

        transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadProgVars_10, &_SizeVarset_65, SizeVarMap_15);
        Zeros_66 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_11, VarTable_12, *SizeVarMap_15);
        Constraints_67 = transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0(*SizeVarMap_15, Zeros_66);
        *ArgSizeInfo_13 = libs__polyhedron__from_constraints_1_f_0(Constraints_67);
        *Termination_14 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
        *HeadSizeVars_16 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(*SizeVarMap_15, HeadProgVars_10);
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Integer NumToDrop_29;
        MR_Integer Var_43;
        MR_Word _ZeroSizeHeadVars_30;

        Var_43 = mercury__list__length_1_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadProgVars_10);
        NumToDrop_29 = (MR_Integer) ((MR_Unsigned) Var_43 - (MR_Unsigned) 2);
        succeeded = mercury__list__drop_3_p_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), NumToDrop_29, HeadProgVars_10, &_ZeroSizeHeadVars_30);
        if (succeeded)
        {
          MR_Word Zeros_78;
          MR_Word Constraints_79;
          MR_Word _SizeVarset_77;

          transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadProgVars_10, &_SizeVarset_77, SizeVarMap_15);
          Zeros_78 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_11, VarTable_12, *SizeVarMap_15);
          Constraints_79 = transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0(*SizeVarMap_15, Zeros_78);
          *ArgSizeInfo_13 = libs__polyhedron__from_constraints_1_f_0(Constraints_79);
          *Termination_14 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
          *HeadSizeVars_16 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(*SizeVarMap_15, HeadProgVars_10);
        }
        else
    ...
    case (MR_Integer) 0:
      {
        MR_Word Zeros_18;
        MR_Word NonZeroHeadSizeVars_19;
        MR_Word Constrs_20;
        MR_Word Var_31;
        MR_Word Var_32;
        MR_Word _SizeVarset_17;

        transform_hlds__term_constr_util__make_size_var_map_3_p_0(HeadProgVars_10, &_SizeVarset_17, SizeVarMap_15);
        *HeadSizeVars_16 = transform_hlds__term_constr_util__prog_vars_to_size_vars_2_f_0(*SizeVarMap_15, HeadProgVars_10);
        Zeros_18 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_11, VarTable_12, *SizeVarMap_15);
        {
          Var_32 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (transform_hlds__term_constr_initial__special_pred_id_to_termination_8_p_0_1));
          MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (Zeros_18));
        }
        {
          Var_31 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[1]));
          MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (transform_hlds__term_constr_initial__special_pred_id_to_termination_8_p_0_2));
          MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (Var_32));
        }
        NonZeroHeadSizeVars_19 = mercury__list__filter_2_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]), Var_31, *HeadSizeVars_16);
        if ((NonZeroHeadSizeVars_19 == (MR_Word) ((MR_Unsigned) 0U)))
          Constrs_20 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonZeroHeadSizeVars_19, (MR_Integer) 1))));
          MR_Word Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonZeroHeadSizeVars_19, (MR_Integer) 0))));
          ...
          {
            MR_Word Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 1))));
            MR_Word Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 0))));

            if ((Var_56 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word Var_35;

              Var_35 = libs__lp_rational__make_vars_eq_constraint_2_f_0(Var_55, Var_57);
              {
                Constrs_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Constrs_20, 0) = ((MR_Box) (Var_35));
                MR_hl_field(MR_mktag(1), Constrs_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            else
              {
        ...
        *ArgSizeInfo_13 = libs__polyhedron__from_constraints_1_f_0(Constrs_20);
        *Termination_14 = (MR_Word) (&transform_hlds__term_constr_initial_scalar_common_3[3]);
      }
      break;
  }
