...
{
  {
    ...
    {
      transform_hlds__term_constr_initial__succeeded = transform_hlds__term_constr_initial__IntroducedFrom__pred__special_pred_id_to_termination__433__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_constr_initial__closure, (MR_Integer) 3))), ((MR_Word) transform_hlds__term_constr_initial__wrapper_arg_1));
    }
    return transform_hlds__term_constr_initial__succeeded;
  }
}
        ...
        if ((transform_hlds__term_constr_initial__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *transform_hlds__term_constr_initial__STATE_VARIABLE_ModuleInfo_3 = transform_hlds__term_constr_initial__STATE_VARIABLE_ModuleInfo_0_2;
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_initial__Globals_10, (MR_Integer) 88, &transform_hlds__term_constr_initial__MakeOptInt_11);
            }
            {
                    ...
                    if (!(transform_hlds__term_constr_initial__succeeded))
                      {
                        ...
                        if (transform_hlds__term_constr_initial__succeeded)
                          {
                            transform_hlds__term_constr_initial__V_49_49 = (MR_Integer) 20;
                            {
            ...
            {
              transform_hlds__term_constr_initial__succeeded = hlds__hlds_pred__check_marker_2_p_0(transform_hlds__term_constr_initial__Markers_31, (MR_Integer) 19);
            }
            if (transform_hlds__term_constr_initial__succeeded)
              {
