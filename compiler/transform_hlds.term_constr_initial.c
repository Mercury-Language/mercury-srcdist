        ...
        case (MR_Integer) 1:
          {
            ...
            Var_52 = mercury__list__length_1_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[0]), HeadVars_17);
            NumToDrop_44 = (MR_Integer) ((MR_Unsigned) Var_52 - (MR_Unsigned) 2);
        ...
        case (MR_Integer) 0:
          {
            ...
            Zeros_41 = transform_hlds__term_constr_util__find_zero_size_vars_3_f_0(ModuleInfo_1, VarTable_18, VarMap_21);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), Var_47, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_1));
              MR_hl_field(MR_mktag(0), Var_47, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_47, 3) = ((MR_Box) (Zeros_41));
            }
            {
              Var_46 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&transform_hlds__term_constr_initial_scalar_common_4[1]));
              MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (transform_hlds__term_constr_initial__set_generated_terminates_5_p_0_2));
              MR_hl_field(MR_mktag(0), Var_46, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_46, 3) = ((MR_Box) (Var_47));
            }
            NonZeroHeadSizeVars_42 = mercury__list__filter_2_f_0((MR_Word) (&transform_hlds__term_constr_initial_scalar_common_2[1]), Var_46, HeadSizeVars_22);
            ...
            else
            {
              ...
              else
              {
                ...
                if ((Var_62 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  Var_48 = libs__lp_rational__make_vars_eq_constraint_2_f_0(Var_61, Var_63);
                  {
                    Constrs_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Constrs_43, 0) = ((MR_Box) (Var_48));
