  ...
  MR_Word * STATE_VARIABLE_UsedModuleNames_10)
{
  while (MR_TRUE)
  {
    ...
    ;
    mercury__set__insert_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_4)), STATE_VARIABLE_UsedModuleNames_0_9, &STATE_VARIABLE_UsedModuleNames_1_11);
