  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[0]);
...
{
  MR_Word ImpUsedModules0_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_7, (MR_Integer) 1))));
  ...
  mercury__set__insert_list_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), FormatModules_5, ImpUsedModules0_4, &ImpUsedModules_6);
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_7, (MR_Integer) 0))));
  {
    ...
    *STATE_VARIABLE_UsedModules_8 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ImpUsedModules_6));
  }
}
...
{
  MR_Word Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 1))));
  MR_Word Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__prog_data_used_modules__add_module_and_ancestors_3_p_0(ModuleName_6, Var_22, &ImpUsedModules_11);
        Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 0))));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_UsedModules_13 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_20));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ImpUsedModules_11));
        }
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        parse_tree__prog_data_used_modules__add_module_and_ancestors_3_p_0(ModuleName_6, Var_23, &IntUsedModules_9);
        Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 1))));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_UsedModules_13 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (IntUsedModules_9));
  ...
  MR_Word * STATE_VARIABLE_UsedModuleNames_10)
{
  while (MR_TRUE)
  {
    MR_Word STATE_VARIABLE_UsedModuleNames_11_11;

    // setup for model_det tailcalls optimized into a loop
    ;
    mercury__set__insert_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_4)), STATE_VARIABLE_UsedModuleNames_0_9, &STATE_VARIABLE_UsedModuleNames_11_11);
    if (((MR_tag((MR_Word) ModuleName_4)) == (MR_Integer) 1))
    {
      MR_Word ParentModuleName_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleName_4, (MR_Integer) 0))));
      MR_Word next_value_of_ModuleName_4 = ParentModuleName_7;
      MR_Word next_value_of_STATE_VARIABLE_UsedModuleNames_0_9 = STATE_VARIABLE_UsedModuleNames_11_11;
      ...
      *STATE_VARIABLE_UsedModuleNames_10 = STATE_VARIABLE_UsedModuleNames_11_11;
    break;
  }
}
