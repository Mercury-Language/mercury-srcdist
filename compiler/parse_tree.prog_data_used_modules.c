  ...
  MR_Word * STATE_VARIABLE_UsedModules_8)
{
  ...
  Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_7, (MR_Integer) 0))));
  {
    MR_Word base;
...
{
  MR_Word Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 1))));
  MR_Word Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 0))));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_UsedModules_0_12, (MR_Integer) 1))));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_UsedModules_13 = base;
