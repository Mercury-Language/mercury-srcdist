...
{
  {
    ...
    if (parse_tree__prog_data_used_modules__succeeded)
      *parse_tree__prog_data_used_modules__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word parse_tree__prog_data_used_modules__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word parse_tree__prog_data_used_modules__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word parse_tree__prog_data_used_modules__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word parse_tree__prog_data_used_modules__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word parse_tree__prog_data_used_modules__Var_8;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_data_used_modules_scalar_common_1[0], &parse_tree__prog_data_used_modules__Var_8, ((MR_Box) (parse_tree__prog_data_used_modules__Var_4)), ((MR_Box) (parse_tree__prog_data_used_modules__Var_6)));
        }
        ...
        if (parse_tree__prog_data_used_modules__succeeded)
          *parse_tree__prog_data_used_modules__HeadVar__1_1 = parse_tree__prog_data_used_modules__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_data_used_modules_scalar_common_1[0], parse_tree__prog_data_used_modules__HeadVar__1_1, ((MR_Box) (parse_tree__prog_data_used_modules__Var_5)), ((MR_Box) (parse_tree__prog_data_used_modules__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (parse_tree__prog_data_used_modules__succeeded)
    ...
    else
      {
        ...
        MR_Word parse_tree__prog_data_used_modules__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word parse_tree__prog_data_used_modules__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word parse_tree__prog_data_used_modules__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word parse_tree__prog_data_used_modules__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_data_used_modules__HeadVar__2_2, (MR_Integer) 1)));

        {
          parse_tree__prog_data_used_modules__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &parse_tree__prog_data_used_modules_scalar_common_1[0], ((MR_Box) (parse_tree__prog_data_used_modules__Var_3)), ((MR_Box) (parse_tree__prog_data_used_modules__Var_5)));
        }
        if (parse_tree__prog_data_used_modules__succeeded)
          {
            parse_tree__prog_data_used_modules__TypeInfo_10_10 = (MR_Word) &parse_tree__prog_data_used_modules_scalar_common_1[0];
            {
              parse_tree__prog_data_used_modules__succeeded = mercury__builtin__unify_2_p_0(parse_tree__prog_data_used_modules__TypeInfo_10_10, ((MR_Box) (parse_tree__prog_data_used_modules__Var_4)), ((MR_Box) (parse_tree__prog_data_used_modules__Var_6)));
            }
          }
      }
    return parse_tree__prog_data_used_modules__succeeded;
