...
static const MR_FA_TypeInfo_Struct1 parse_tree__prog_data_used_modules__set_tree234__ti_set_tree234_1parse_tree__prog_data__type_ctor_info_type_ctor_0;

static const MR_PseudoTypeInfo parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_types_used_eqv_modules_0_0[3];

static const MR_ConstString parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_names_used_eqv_modules_0_0[3];

static const MR_DuFunctorDesc parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_functor_desc_used_eqv_modules_0_0;

static const MR_DuFunctorDescPtr parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_stag_ordered_used_eqv_modules_0_0[1];

static const MR_DuPtagLayout parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_ptag_ordered_used_eqv_modules_0[1];

static const MR_DuFunctorDescPtr parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_name_ordered_used_eqv_modules_0[1];

static const MR_Integer parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__functor_number_map_used_eqv_modules_0[1];
...
static MR_bool MR_CALL 
parse_tree__prog_data_used_modules____Unify____used_eqv_modules_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__prog_data_used_modules____Compare____used_eqv_modules_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static /* final */ const MR_Box parse_tree__prog_data_used_modules_scalar_common_1[2][2];
...
static const MR_PseudoTypeInfo parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_types_used_eqv_modules_0_0[3] = {
  (MR_PseudoTypeInfo) (&parse_tree__prog_data_used_modules__set_tree234__ti_set_tree234_1parse_tree__prog_data__type_ctor_info_type_ctor_0),
  (MR_PseudoTypeInfo) (&parse_tree__prog_data_used_modules__set_tree234__ti_set_tree234_1parse_tree__prog_data__type_ctor_info_type_ctor_0),
  (MR_PseudoTypeInfo) (&parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__type_ctor_info_used_modules_0)
};

static const MR_ConstString parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_names_used_eqv_modules_0_0[3] = {
  (MR_String) "int_eqv_type_ctors",
  (MR_String) "imp_eqv_type_ctors",
  (MR_String) "all_used_modules"
};

static const MR_DuFunctorDesc parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_functor_desc_used_eqv_modules_0_0 = {
  (MR_String) "used_eqv_modules",
  INT16_C(3),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(0),
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_types_used_eqv_modules_0_0,
  parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__field_names_used_eqv_modules_0_0,
  NULL,
  NULL,
...
static const MR_DuFunctorDescPtr parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_stag_ordered_used_eqv_modules_0_0[1] = { &parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_functor_desc_used_eqv_modules_0_0 };

static const MR_DuPtagLayout parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_ptag_ordered_used_eqv_modules_0[1] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_stag_ordered_used_eqv_modules_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_name_ordered_used_eqv_modules_0[1] = { &parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_functor_desc_used_eqv_modules_0_0 };

static const MR_Integer parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__functor_number_map_used_eqv_modules_0[1] = { (MR_Integer) 0 };

const MR_TypeCtorInfo_Struct parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__type_ctor_info_used_eqv_modules_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(1),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__prog_data_used_modules____Unify____used_eqv_modules_0_0_10001)),
  ((MR_Box) (parse_tree__prog_data_used_modules____Compare____used_eqv_modules_0_0_10001)),
  (MR_String) "parse_tree.prog_data_used_modules",
  (MR_String) "used_eqv_modules",
  { parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_name_ordered_used_eqv_modules_0 },
  { parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__du_ptag_ordered_used_eqv_modules_0 },
  (MR_Integer) 1,
  UINT16_C(12),
  parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__functor_number_map_used_eqv_modules_0,
...
void MR_CALL 
parse_tree__prog_data_used_modules____Compare____used_eqv_modules_0_0(
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[0]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      succeeded = (SubResult2_9 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult2_9;
      else
        parse_tree__prog_data_used_modules____Compare____used_modules_0_0(HeadVar__1_1, ArgX3_10, ArgY3_11);
    }
  }
}
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[1]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
  }
}

MR_bool MR_CALL 
parse_tree__prog_data_used_modules____Unify____used_eqv_modules_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo_12_12 = (MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[0]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
        succeeded = parse_tree__prog_data_used_modules____Unify____used_modules_0_0(ArgX3_7, ArgY3_8);
    }
  }
  return succeeded;
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[1]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    if (succeeded)
    {
      TypeInfo_10_10 = (MR_Word) (&parse_tree__prog_data_used_modules_scalar_common_1[1]);
...
void MR_CALL 
parse_tree__prog_data_used_modules__record_expanded_eqv_type_ctor_4_p_0(
  MR_Word Visibility_5,
  MR_Word TypeCtor_6,
  MR_Word STATE_VARIABLE_UsedEqvModules_0_16,
  MR_Word * STATE_VARIABLE_UsedEqvModules_17)
{
  MR_Word SymName_12;
  MR_Word UsedModules0_14;
  MR_Word UsedModules_15;
  MR_Word STATE_VARIABLE_UsedEqvModules_1_18;
  MR_Word Var_29;
  MR_Word Var_30;
  MR_Word Var_37 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 1))));
  MR_Word Var_38 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 0))));

  switch (Visibility_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
        MR_Word ImpEqvTypeCtors_11;
        MR_Word Var_26;
        MR_Word Var_28;

        mercury__set_tree234__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ((MR_Box) (TypeCtor_6)), Var_37, &ImpEqvTypeCtors_11);
        Var_26 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 0))));
        Var_28 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 2))));
        {
          STATE_VARIABLE_UsedEqvModules_1_18 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 0) = ((MR_Box) (Var_26));
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 1) = ((MR_Box) (ImpEqvTypeCtors_11));
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 2) = ((MR_Box) (Var_28));
        }
      }
      break;
    case (MR_Integer) 0:
      {
        MR_Word IntEqvTypeCtors_9;
        MR_Word Var_22;
        MR_Word Var_23;

        mercury__set_tree234__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ((MR_Box) (TypeCtor_6)), Var_38, &IntEqvTypeCtors_9);
        Var_22 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 1))));
        Var_23 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_0_16, 2))));
        {
          STATE_VARIABLE_UsedEqvModules_1_18 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 0) = ((MR_Box) (IntEqvTypeCtors_9));
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 1) = ((MR_Box) (Var_22));
          MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 2) = ((MR_Box) (Var_23));
        }
      }
      break;
  }
  SymName_12 = ((MR_Word) ((MR_hl_field(0, TypeCtor_6, 0))));
  Var_29 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 0))));
  Var_30 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 1))));
  UsedModules0_14 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UsedEqvModules_1_18, 2))));
  if (((MR_tag((MR_Word) SymName_12)) == (MR_Integer) 1))
  {
    MR_Word ModuleName_40 = ((MR_Word) ((MR_hl_field(1, SymName_12, 0))));

    parse_tree__prog_data_used_modules__record_module_and_ancestors_as_used_4_p_0(Visibility_5, ModuleName_40, UsedModules0_14, &UsedModules_15);
  }
  else
    UsedModules_15 = UsedModules0_14;
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_UsedEqvModules_17 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (Var_29));
    MR_hl_field(0, base, 1) = ((MR_Box) (Var_30));
    MR_hl_field(0, base, 2) = ((MR_Box) (UsedModules_15));
  }
}
...
MR_Word MR_CALL 
parse_tree__prog_data_used_modules__used_eqv_modules_init_0_f_0(void)
{
  MR_Word UsedEqvModules_2;
  MR_Word UsedModules_3;
  MR_Word Var_4;
  MR_Word Var_5;
  MR_Word Var_6;
  MR_Word Var_7;

  Var_4 = mercury__set_tree234__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
  Var_5 = mercury__set_tree234__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
  {
    UsedModules_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, UsedModules_3, 0) = ((MR_Box) (Var_4));
    MR_hl_field(0, UsedModules_3, 1) = ((MR_Box) (Var_5));
  }
  Var_6 = mercury__set_tree234__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0));
  Var_7 = mercury__set_tree234__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0));
  {
    UsedEqvModules_2 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, UsedEqvModules_2, 0) = ((MR_Box) (Var_6));
    MR_hl_field(0, UsedEqvModules_2, 1) = ((MR_Box) (Var_7));
    MR_hl_field(0, UsedEqvModules_2, 2) = ((MR_Box) (UsedModules_3));
  }
  return UsedEqvModules_2;
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__prog_data_used_modules____Unify____used_eqv_modules_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__prog_data_used_modules____Compare____used_eqv_modules_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__parse_tree__prog_data_used_modules__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__type_ctor_info_used_eqv_modules_0);
