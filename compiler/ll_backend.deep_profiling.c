  ...
  MR_Word * Goal_18)
{
  ...
  if ((MaybeActivationPtr_14 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (Var_48));
    }
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (Var_29));
    }
    ...
    hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 7, CallPortCode0_20, &CallPortCode_21);
    ll_backend__deep_profiling__generate_deep_call_7_p_0(ModuleInfo_10, (MR_String) "det_exit_port_code_sr", (MR_Integer) 3, Var_29, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__deep_profiling_scalar_common_3[3])), (MR_Integer) 0, &ExitPortCode_22);
  }
