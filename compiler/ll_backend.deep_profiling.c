  ...
  MR_Word * STATE_VARIABLE_ProcInfo_29)
{
  ...
  {
    MR_Word DeepProfInfo_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDeepProfInfo_19, (MR_Integer) 0))));

    MaybeRecInfo_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_74, (MR_Integer) 0))));
  }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo0_21, &VarSet_90, &VarTypes_91);
      hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo0_21, &MaybeDetism_92);
      if ((MaybeDetism_92 == (MR_Word) ((MR_Unsigned) 0U)))
        hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo0_21, &Detism_93);
      else
        Detism_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_92, (MR_Integer) 0))));
      {
        ...
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 3) = ((MR_Box) (VarSet_90));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 4) = ((MR_Box) (VarTypes_91));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 5) = (MR_Box) ((MR_Unsigned) (Detism_93));
      }
      {
