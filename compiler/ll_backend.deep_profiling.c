...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 230, &DoCoverageProfiling_29);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 227, &UseActivationCounts_35);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 240, &UseZeroing_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 227, &UseActivationCounts_14);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(ProcInfo0_22, STATE_VARIABLE_ModuleInfo_0_7, &Instmap_93);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 242, &TailRecursion_5);
