...
static /* final */ const MR_Box ll_backend__deep_profiling_scalar_common_2[12][2] = {
  ...
  /* row 2 */
  {
    ...
    ((MR_Box) (&ll_backend__deep_profiling_scalar_common_1[3]))
  },
  /* row 3 */
  {
    ((MR_Box) (&mercury__list__list__type_ctor_info_list_1)),
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_1[4]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[4]), &SubResult6_21, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[5]), HeadVar__1_1, ((MR_Box) (ArgX9_28)), ((MR_Box) (ArgY9_29)));
                    }
                  }
                }
              }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_25_25 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_1[4]);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_28_28 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_2[4]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_30_30 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_2[5]);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[2]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
        {
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[3]), HeadVar__1_1, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_2[2]);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_15_15 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_2[3]);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_59 = (MR_Word) ((MR_Word) (PredProcId_4));
      {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_134_134 = (MR_Word) (&ll_backend__deep_profiling_scalar_common_2[3]);
