  ...
  MR_Word * STATE_VARIABLE_ProcTable_20)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 76, &VeryVerbose_16);
  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 269, &DoCoverageProfiling_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 266, &UseActivationCounts_33);
    ...
    case (MR_Integer) 0:
      {
        ...
        ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_112);
        ...
        case (MR_Integer) 2:
          {
            ...
            ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_51);
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_108);
            {
        ...
        case (MR_Integer) 4:
          {
            ...
            ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_110);
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                hlds__goal_util__transform_all_goals_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_1[8]), SubGoal0_117, &SubGoal_118);
                *AddedImpurity_8 = (MR_Integer) 0;
                *STATE_VARIABLE_DeepInfo_83 = STATE_VARIABLE_DeepInfo_0_82;
              }
              else
              ...
              ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_116);
              {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                ll_backend__deep_profiling__deep_prof_transform_goal_5_p_0(SubGoal0_117, &SubGoal_143, AddedImpurity_8, STATE_VARIABLE_DeepInfo_0_82, STATE_VARIABLE_DeepInfo_83);
                ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_142);
                {
                  ...
                  MR_hl_field(3, Var_134, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__deep_profiling_scalar_common_2[8])));
                  MR_hl_field(3, Var_134, 2) = ((MR_Box) (SubGoal_143));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  *Goal_7 = base;
                  ...
                  MR_hl_field(0, base, 1) = ((MR_Box) (GoalInfo_142));
                }
              }
              else
              {
                ...
                if (succeeded)
                {
                  FGT_147 = ((MR_Unsigned) ((MR_hl_field(3, Reason0_69, (MR_Integer) 2))) & (MR_Integer) 3);
                  switch (FGT_147) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                ...
                if (succeeded)
                {
                  hlds__goal_util__transform_all_goals_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_1[9]), SubGoal0_117, &SubGoal_158);
                  *AddedImpurity_8 = (MR_Integer) 0;
                  *STATE_VARIABLE_DeepInfo_83 = STATE_VARIABLE_DeepInfo_0_82;
                }
                else
                  ll_backend__deep_profiling__deep_prof_transform_goal_5_p_0(SubGoal0_117, &SubGoal_158, AddedImpurity_8, STATE_VARIABLE_DeepInfo_0_82, STATE_VARIABLE_DeepInfo_83);
                ll_backend__deep_profiling__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_157);
                ll_backend__deep_profiling__goal_info_set_mdprof_inst_3_p_0((MR_Integer) 0, GoalInfo_157, &InnerGoalInfo_79);
                {
                  ...
                  MR_hl_field(3, Var_100, 2) = ((MR_Box) (SubGoal_158));
                }
                {
                ...
                }
                {
                  ...
                  MR_hl_field(3, Var_101, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__deep_profiling_scalar_common_2[8])));
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              ...
              *AddedImpurity_8 = (MR_Integer) 1;
              Purity_123 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo1_12);
              switch (Purity_123) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 2:
                  GoalInfo_114 = GoalInfo1_12;
                  break;
                case (MR_Integer) 0:
                case (MR_Integer) 1:
                  {
                    MR_Word STATE_VARIABLE_GoalInfo_8_125;

                    hlds__hlds_goal__goal_info_set_purity_3_p_0((MR_Integer) 2, GoalInfo1_12, &STATE_VARIABLE_GoalInfo_8_125);
                    hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 2, STATE_VARIABLE_GoalInfo_8_125, &GoalInfo_114);
                  }
                  break;
              }
            }
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 279, &UseZeroing_69);
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 266, &UseActivationCounts_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 281, &TailRecursion_9);
