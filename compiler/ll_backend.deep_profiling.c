  ...
  MR_Word * STATE_VARIABLE_ProcTable_19)
{
  ...
  else
  {
    ...
    if ((MaybeDeepInfo_37 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo_6, ProcInfo0_10, &Instmap_54);
  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 251, &DoCoverageProfiling_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 248, &UseActivationCounts_33);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 261, &UseZeroing_69);
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 248, &UseActivationCounts_14);
  ...
  MR_Word * STATE_VARIABLE_PredMap_14)
{
  ...
  ProcIds_9 = hlds__hlds_pred__pred_info_all_non_imported_procids_1_f_0(PredInfo0_8);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 263, &TailRecursion_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[0]), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&ll_backend__deep_profiling_scalar_common_1[5]), SCCs_24, ((MR_Box) (STATE_VARIABLE_ModuleInfo_8_25)), &conv1_STATE_VARIABLE_ModuleInfo_16_16);
