  ...
  MR_Word * STATE_VARIABLE_ProcTable_20)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 84, &VeryVerbose_16);
  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 279, &DoCoverageProfiling_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 276, &UseActivationCounts_33);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 289, &UseZeroing_69);
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 276, &UseActivationCounts_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 291, &TailRecursion_9);
