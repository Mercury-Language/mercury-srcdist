  ...
  MR_Word * STATE_VARIABLE_ProcTable_20)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 74, &VeryVerbose_16);
  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 261, &DoCoverageProfiling_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 258, &UseActivationCounts_33);
  ...
  ShroudedPredProcId_36 = hlds__hlds_pred__shroud_pred_proc_id_1_f_0(Var_68);
  {
    ...
    MR_hl_field(3, ProcStaticConsId_37, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 271, &UseZeroing_69);
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_21)
{
  ...
  }
  {
    ...
    MR_hl_field(1, GoalExpr_62, 4) = ((MR_Box) (&ll_backend__deep_profiling_scalar_common_2[7]));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 258, &UseActivationCounts_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 273, &TailRecursion_9);
