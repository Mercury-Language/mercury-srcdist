    ...
    if (ll_backend__deep_profiling__succeeded)
      *ll_backend__deep_profiling__STATE_VARIABLE_ProcTable_18 = ll_backend__deep_profiling__STATE_VARIABLE_ProcTable_0_17;
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_13, (MR_Integer) 48, &ll_backend__deep_profiling__VeryVerbose_14);
        }
        {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_4, (MR_Integer) 211, &ll_backend__deep_profiling__TailRecursion_5);
    }
