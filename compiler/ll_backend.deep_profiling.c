  ...
  MR_Word * STATE_VARIABLE_DeepInfo_12)
{
  ...
  {
    Entry_48 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_48, 0) = ((MR_Box) (VarName_9));
    MR_hl_field(MR_mktag(0), Entry_48, 1) = ((MR_Box) (Var_49));
    MR_hl_field(MR_mktag(0), Entry_48, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
  }
  parse_tree__var_table__add_var_entry_4_p_0(Entry_48, DepthVar_6, VarTable0_8, &VarTable_10);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_19)
{
  ...
  if ((MaybeDeepInfo_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    ll_backend__deep_profiling__deep_prof_transform_normal_proc_5_p_0(ModuleInfo_5, PredProcId_6, STATE_VARIABLE_ProcInfo_0_18, &STATE_VARIABLE_ProcInfo_22_22, &DeepLayoutInfo_26);
    {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RecInfo_13, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      {
        Entry_79 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Entry_79, 0) = ((MR_Box) ((MR_String) "MiddleCSD"));
        MR_hl_field(MR_mktag(0), Entry_79, 1) = ((MR_Box) (Var_80));
        MR_hl_field(MR_mktag(0), Entry_79, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
      }
      parse_tree__var_table__add_var_entry_4_p_0(Entry_79, &MiddleCSD_47, VarTable0_46, &VarTable1_48);
      ...
      {
        MR_Word DeepProfInfo_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDeepProfInfo_51, (MR_Integer) 0))));

        MaybeRecInfo_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_84, (MR_Integer) 0))));
      }
      ...
      hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_54, STATE_VARIABLE_ProcInfo_31_63, &STATE_VARIABLE_ProcInfo_22_22);
    ...
    else
    {
      ...
      ll_backend__deep_profiling__deep_prof_transform_normal_proc_5_p_0(ModuleInfo_5, PredProcId_6, STATE_VARIABLE_ProcInfo_0_18, &STATE_VARIABLE_ProcInfo_22_22, &DeepLayoutInfo_16);
      {
        MaybeDeepLayoutInfo_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  hlds__hlds_pred__proc_info_set_maybe_deep_profile_info_3_p_0(Var_24, STATE_VARIABLE_ProcInfo_22_22, STATE_VARIABLE_ProcInfo_19);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ll_backend__deep_profiling__find_list_of_output_args_2_5_p_0(STATE_VARIABLE_ModuleInfo_0_7, HeadVars_26, Types_18, Modes_27, &STATE_VARIABLE_Outputs_12_80);
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo0_21, &Body_86);
      hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo0_21, &HeadVars_87);
      hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_7, ProcInfo0_21, &Instmap_88);
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_7, ProcInfo0_21, &VarTable_89);
      hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo0_21, &MaybeDetism_90);
      if ((MaybeDetism_90 == (MR_Word) ((MR_Unsigned) 0U)))
        hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo0_21, &Detism_91);
      else
        Detism_91 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_90, (MR_Integer) 0))));
      {
        DeepOriginalBody_41 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 0) = ((MR_Box) (Body_86));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 1) = ((MR_Box) (HeadVars_87));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 2) = ((MR_Box) (Instmap_88));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 3) = ((MR_Box) (VarTable_89));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 4) = (MR_Box) ((MR_Unsigned) (Detism_91));
      }
      {
