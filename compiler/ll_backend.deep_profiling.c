...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 64, &VeryVerbose_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 223, &DoCoverageProfiling_29);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 220, &UseActivationCounts_35);
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  hlds__hlds_goal__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_136);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_128, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[8])));
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_91, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[8])));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 233, &UseZeroing_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 220, &UseActivationCounts_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 235, &TailRecursion_5);
