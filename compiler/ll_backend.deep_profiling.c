            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                hlds__hlds_goal__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_134);
                {
                  ...
                  MR_hl_field(3, Var_126, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__deep_profiling_scalar_common_2[8])));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  hlds__goal_util__transform_all_goals_3_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_1[9]), SubGoal0_117, &SubGoal_150);
                  *AddedImpurity_8 = (MR_Integer) 0;
                  *STATE_VARIABLE_DeepInfo_83 = STATE_VARIABLE_DeepInfo_0_82;
                }
                else
