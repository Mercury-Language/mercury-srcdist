  ...
  MR_Word * STATE_VARIABLE_ProcTable_19)
{
  ...
  else
  {
    ...
    if ((MaybeDeepInfo_43 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo0_10, &VarSet_67, &VarTypes_68);
      hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo0_10, &MaybeDetism_69);
      if ((MaybeDetism_69 == (MR_Word) ((MR_Unsigned) 0U)))
        hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo0_10, &Detism_70);
      else
        Detism_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_69, (MR_Integer) 0))));
      {
        ...
        MR_hl_field(MR_mktag(0), OrigBody_47, 3) = ((MR_Box) (VarSet_67));
        MR_hl_field(MR_mktag(0), OrigBody_47, 4) = ((MR_Box) (VarTypes_68));
        MR_hl_field(MR_mktag(0), OrigBody_47, 5) = (MR_Box) ((MR_Unsigned) (Detism_70));
      }
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_29)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_30_30, &VarSet0_12, &VarTypes0_13);
  {
  ...
  STATE_VARIABLE_VarSet_14_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarInfo0_14, (MR_Integer) 0))));
  STATE_VARIABLE_VarTypes_15_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarInfo0_14, (MR_Integer) 1))));
  mercury__varset__new_named_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "MiddleCSD", &MiddleCSD_15, STATE_VARIABLE_VarSet_14_55, &STATE_VARIABLE_VarSet_16_57);
  hlds__vartypes__add_var_type_4_p_0(MiddleCSD_15, Var_32, STATE_VARIABLE_VarTypes_15_56, &STATE_VARIABLE_VarTypes_17_58);
  {
    VarInfo1_16 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), VarInfo1_16, 0) = ((MR_Box) (STATE_VARIABLE_VarSet_16_57));
    MR_hl_field(MR_mktag(0), VarInfo1_16, 1) = ((MR_Box) (STATE_VARIABLE_VarTypes_17_58));
  }
  ...
  {
    MR_Word DeepProfInfo_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDeepProfInfo_19, (MR_Integer) 0))));

    MaybeRecInfo_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_73, (MR_Integer) 0))));
  }
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_26, VarTypes_27, STATE_VARIABLE_ProcInfo_30_30, &STATE_VARIABLE_ProcInfo_36_36);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_22, STATE_VARIABLE_ProcInfo_36_36, STATE_VARIABLE_ProcInfo_29);
}
  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_50_50, &VarSet0_12, &VarTypes0_13);
  ...
  Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DeepInfo_67_67, (MR_Integer) 5))));
  STATE_VARIABLE_VarInfo_68_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DeepInfo_67_67, (MR_Integer) 6))));
  CallSites_28 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_call_site_static_data_0), Var_90);
  ...
  switch (CodeModel_41) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word MaybeActivationPtr_84;

        ll_backend__deep_profiling__maybe_generate_activation_ptr_7_p_0(UseActivationCounts_35, TopCSD_19, MiddleCSD_20, &MaybeActivationPtr_84, &ExcpVars_43, STATE_VARIABLE_VarInfo_72_72, &STATE_VARIABLE_VarInfo_80_80);
        ll_backend__deep_profiling__build_semi_proc_body_9_p_0(ModuleInfo_6, TopCSD_19, MiddleCSD_20, ProcStaticVar_21, MaybeActivationPtr_84, GoalInfo0_18, BindProcStaticVarGoal_40, STATE_VARIABLE_Goal_71_71, &STATE_VARIABLE_Goal_81_81);
      }
      break;
  }
  VarSet_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_80_80, (MR_Integer) 0))));
  VarTypes_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_80_80, (MR_Integer) 1))));
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_46, VarTypes_47, STATE_VARIABLE_ProcInfo_50_50, &STATE_VARIABLE_ProcInfo_82_82);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_81_81, STATE_VARIABLE_ProcInfo_82_82, STATE_VARIABLE_ProcInfo_49);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_VarInfo_18)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_20;
        MR_Word STATE_VARIABLE_VarSet_14_32;
        MR_Word STATE_VARIABLE_VarTypes_15_33;
        MR_Word STATE_VARIABLE_VarSet_16_34;
        MR_Word STATE_VARIABLE_VarTypes_17_35;

        Var_20 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
        STATE_VARIABLE_VarSet_14_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_0_17, (MR_Integer) 0))));
        STATE_VARIABLE_VarTypes_15_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_0_17, (MR_Integer) 1))));
        mercury__varset__new_named_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "OldOutermost", &OldOutermostProcDyn0_16, STATE_VARIABLE_VarSet_14_32, &STATE_VARIABLE_VarSet_16_34);
        hlds__vartypes__add_var_type_4_p_0(OldOutermostProcDyn0_16, Var_20, STATE_VARIABLE_VarTypes_15_33, &STATE_VARIABLE_VarTypes_17_35);
        {
          STATE_VARIABLE_VarInfo_21_21 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_21_21, 0) = ((MR_Box) (STATE_VARIABLE_VarSet_16_34));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_21_21, 1) = ((MR_Box) (STATE_VARIABLE_VarTypes_17_35));
        }
        {
          MR_Word base;
  ...
  STATE_VARIABLE_VarSet_14_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_21_21, (MR_Integer) 0))));
  STATE_VARIABLE_VarTypes_15_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_21_21, (MR_Integer) 1))));
  mercury__varset__new_named_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "NewOutermost", NewOutermostProcDyn_13, STATE_VARIABLE_VarSet_14_56, &STATE_VARIABLE_VarSet_16_58);
  hlds__vartypes__add_var_type_4_p_0(*NewOutermostProcDyn_13, Var_23, STATE_VARIABLE_VarTypes_15_57, &STATE_VARIABLE_VarTypes_17_59);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_VarInfo_18 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_VarSet_16_58));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (STATE_VARIABLE_VarTypes_17_59));
  }
}
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_18;
        MR_Word STATE_VARIABLE_VarSet_14_27;
        MR_Word STATE_VARIABLE_VarTypes_15_28;
        MR_Word STATE_VARIABLE_VarSet_16_29;
        MR_Word STATE_VARIABLE_VarTypes_17_30;

        Var_18 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
        STATE_VARIABLE_VarSet_14_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_0_15, (MR_Integer) 0))));
        STATE_VARIABLE_VarTypes_15_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarInfo_0_15, (MR_Integer) 1))));
        mercury__varset__new_named_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "ActivationPtr", &ActivationPtr0_14, STATE_VARIABLE_VarSet_14_27, &STATE_VARIABLE_VarSet_16_29);
        hlds__vartypes__add_var_type_4_p_0(ActivationPtr0_14, Var_18, STATE_VARIABLE_VarTypes_15_28, &STATE_VARIABLE_VarTypes_17_30);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_VarInfo_16 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_VarSet_16_29));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (STATE_VARIABLE_VarTypes_17_30));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo0_21, &VarSet_89, &VarTypes_90);
        ...
        Detism_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_91, (MR_Integer) 0))));
      {
        ...
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 3) = ((MR_Box) (VarSet_89));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 4) = ((MR_Box) (VarTypes_90));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 5) = (MR_Box) ((MR_Unsigned) (Detism_92));
      }
      {
