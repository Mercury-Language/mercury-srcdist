  ...
  MR_Word * STATE_VARIABLE_FoundTailCall_5)
{
  ...
  else
  {
    ...
    {
      MR_Word Goals_22;
      MR_Word Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_29, (MR_Integer) 1))));
      MR_Word Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_29, (MR_Integer) 0))));
      ...
      if ((Var_50 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        ll_backend__deep_profiling__apply_deep_prof_tail_rec_to_goal_6_p_0(Var_51, &Goal_35, TailRecInfo_3, STATE_VARIABLE_FoundTailCall_0_4, STATE_VARIABLE_FoundTailCall_5, &Var_37);
        {
          ...
          MR_hl_field(MR_mktag(1), Goals_22, 0) = ((MR_Box) (Goal_35));
      ...
      else
      {
        ...
        {
          Goals_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Goals_22, 0) = ((MR_Box) (Var_51));
          MR_hl_field(MR_mktag(1), Goals_22, 1) = ((MR_Box) (Goals_44));
        }
      }
      {
        MR_Word base;
