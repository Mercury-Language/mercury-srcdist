...
MR_decl_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 2,3,56,114,58,22,25,113,6,8)
MR_decl_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 10,7,12,13,14,17,18,19,31,32)
MR_decl_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 33,34,35,36,37,41,43,40,39,46)
MR_decl_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 47,50,51,52,53,60,61,62,65,70)
MR_decl_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 66,71,72,63,77,81,82,78,89,85)
MR_decl_label9(ll_backend__deep_profiling__deep_prof_transform_goal_6_0, 90,91,92,93,101,102,104,105,106)
...
MR_BEGIN_MODULE(ll_backend__deep_profiling_module33)
	...
	MR_init_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,2,3,56,114,58,22,25,113,6,8)
	MR_init_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,10,7,12,13,14,17,18,19,31,32)
	MR_init_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,33,34,35,36,37,41,43,40,39,46)
	MR_init_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,47,50,51,52,53,60,61,62,65,70)
	MR_init_label10(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,66,71,72,63,77,81,82,78,89,85)
	MR_init_label9(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,90,91,92,93,101,102,104,105,106)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,3)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_tempr2),
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i114) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i56) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i22) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i113));
	}
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,56)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i58);
	}
	}
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,22)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r5),
		...
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i25) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i114) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i114));
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,113)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tfield(3, MR_sv(2), 0),
		...
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i104) MR_AND
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i50) MR_AND
		...
		MR_LABEL_AP(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i101));
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,72)
	...
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(hlds__hlds_goal__add_impurity_if_needed_3_0,
		ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i82);
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_TAG_COMMON(3,11,1);
	MR_np_call_localret_ent(fn__mdbcomp__program_representation__goal_path_add_at_end_2_0,
		ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i77);
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,0)) {
		MR_GOTO_LAB(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i78);
	}
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(3,11,2);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(7);
	MR_np_localcall_lab(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,2)) {
		MR_GOTO_LAB(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i85);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(3, MR_sv(3), 2);
	...
	MR_np_call_localret_ent(hlds__goal_util__transform_all_goals_3_0,
		ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i89);
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(2);
	MR_GOTO_LAB(ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i91);
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,93)
	...
	MR_tfield(3, MR_tempr3, 1) = (MR_Word) MR_TAG_COMMON(3,11,2);
	MR_tfield(3, MR_tempr3, 2) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_r1 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = MR_tempr3;
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,102)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(ll_backend__deep_profiling__deep_prof_transform_switch_8_0,
		ll_backend__deep_profiling__deep_prof_transform_goal_6_0_i105);
...
MR_decl_entry(ll_backend__coverage_profiling__coverage_prof_transform_goal_8_0);
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_normal_proc_5_0,26)
	...
	MR_r4 = MR_sv(4);
	MR_r5 = MR_sv(13);
	MR_np_call_localret_ent(ll_backend__coverage_profiling__coverage_prof_transform_goal_8_0,
