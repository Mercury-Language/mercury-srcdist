  ...
  MR_Word * DeepLayoutInfo_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 248, &DoCoverageProfiling_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 245, &UseActivationCounts_33);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 258, &UseZeroing_69);
  ...
  MR_Word * STATE_VARIABLE_DeepInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 245, &UseActivationCounts_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 260, &TailRecursion_7);
