...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_21, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_10, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 5)));
          ...
          case (MR_Integer) 2:
            {
              ...
              hlds__hlds_goal__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_50);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_51, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
              ...
              hlds__hlds_goal__add_impurity_if_needed_3_p_0(*AddedImpurity_8, GoalInfo1_12, &GoalInfo_111);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_112, 2) = (MR_Box) (packed_args_6);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_68, (MR_Integer) 2)));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_68, (MR_Integer) 1)));
                  {
                    MR_Word Var_129;
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_68, (MR_Integer) 2)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word Var_128;
                MR_Word Var_130;
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Generic_48, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Expr_5, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_5, (MR_Integer) 5)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_11, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Features_25;
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_9, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_46, (MR_Integer) 2)));
  ...
  MR_Word * HeadVar__6_6)
{
  if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *HeadVar__2_2 = (MR_Word) ((MR_Unsigned) 0U);
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_3, (MR_Integer) 2)));
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_3, (MR_Integer) 2)));

      {
        ...
        MR_hl_field(MR_mktag(0), HeadTailRecInfo_21, 2) = (MR_Box) (packed_args_1);
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_args_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_12, (MR_Integer) 3)));
          ...
          MR_Word Var_132;
          MR_Word Var_133;
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
          ...
          if (succeeded)
          {
            ...
            packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
            ...
            packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
            ...
            if (succeeded)
            {
              ...
              packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
              ll_backend__deep_profiling__find_list_of_output_args_5_p_0(Args_23, Modes_33, Types_32, Var_101, &CallOutputs_34);
              packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TailRecInfo_9, (MR_Integer) 2)));
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(2), GoalExpr_37, 3) = (MR_Box) (packed_args_1);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    ll_backend__deep_profiling__apply_deep_prof_tail_rec_to_conj_6_p_0(Goals0_70, &Goals_71, TailRecInfo_9, STATE_VARIABLE_FoundTailCall_0_88, STATE_VARIABLE_FoundTailCall_89, Continue_11);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), GoalExpr_105, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 2)));
              ...
              ll_backend__deep_profiling__apply_deep_prof_tail_rec_to_cases_5_p_0(Cases0_74, &Cases_75, TailRecInfo_9, STATE_VARIABLE_FoundTailCall_0_88, STATE_VARIABLE_FoundTailCall_89);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_111, 2) = (MR_Box) (packed_args_7);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_5, (MR_Integer) 2)));
