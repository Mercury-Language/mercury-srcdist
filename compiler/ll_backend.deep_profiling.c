  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word Var_52;
    MR_Word _CanFail_23;
    MR_Word STATE_VARIABLE_Outputs_12_79;
    ...
    if (succeeded)
    {
      ...
      succeeded = ll_backend__deep_profiling__find_list_of_output_args_2_5_p_0(STATE_VARIABLE_ModuleInfo_0_7, HeadVars_25, Types_17, Modes_26, &STATE_VARIABLE_Outputs_12_79);
      if (succeeded)
        Outputs_27 = STATE_VARIABLE_Outputs_12_79;
      else
        {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_18, (MR_Integer) 0))));
          succeeded = ((MR_tag((MR_Word) Var_53)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_54 = ll_backend__deep_profiling__goal_contains_builtin_unify_or_compare_1_f_0(Goal_31);
    ...
    if (succeeded)
    {
      ...
      Var_58 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClonePredProcId_29)));
      {
        Var_60 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (PredProcId_6));
        MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (ClonePredProcId_29));
        MR_hl_field(MR_mktag(0), Var_60, 2) = ((MR_Box) (TailCallSites_38));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), OrigDeepRecInfo_39, 0) = ((MR_Box) (Var_57));
      }
      hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo0_20, &Body_85);
      hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo0_20, &HeadVars_86);
      hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_7, ProcInfo0_20, &Instmap_87);
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_7, ProcInfo0_20, &VarTable_88);
      hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo0_20, &MaybeDetism_89);
      if ((MaybeDetism_89 == (MR_Word) ((MR_Unsigned) 0U)))
        hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo0_20, &Detism_90);
      else
        Detism_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_89, (MR_Integer) 0))));
      {
        ...
        MR_hl_field(MR_mktag(0), DeepOriginalBody_40, 0) = ((MR_Box) (Body_85));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_40, 1) = ((MR_Box) (HeadVars_86));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_40, 2) = ((MR_Box) (Instmap_87));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_40, 3) = ((MR_Box) (VarTable_88));
        MR_hl_field(MR_mktag(0), DeepOriginalBody_40, 4) = (MR_Box) ((MR_Unsigned) (Detism_90));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), CloneDeepRecInfo_42, 0) = ((MR_Box) (Var_63));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (OrigDeepProfileInfo_41));
      }
      hlds__hlds_pred__proc_info_set_maybe_deep_profile_info_3_p_0(Var_69, ProcInfo1_36, &ProcInfo_44);
      {
        Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (CloneDeepProfileInfo_43));
      }
      hlds__hlds_pred__proc_info_set_maybe_deep_profile_info_3_p_0(Var_70, ProcInfo1_36, &CloneProcInfo_45);
