...
#line 62 "ll_backend.deep_profiling.c"

#endif
#line 65 "ll_backend.deep_profiling.c"
...
MR_def_label(ll_backend__deep_profiling__generate_deep_const_unify_3_0,7)
	...
	MR_tfield(0, MR_tempr2, 2) = (MR_Word) MR_TAG_COMMON(0,0,5);
	MR_tfield(0, MR_tempr2, 3) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 4) = (MR_Word) MR_TAG_COMMON(0,0,6);
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
...
MR_def_label(ll_backend__deep_profiling__apply_deep_prof_tail_rec_transform_to_proc_3_0,41)
	...
	MR_tfield(0, MR_r2, 2) = MR_sv(19);
	MR_tfield(0, MR_r2, 3) = MR_sv(20);
	MR_tfield(0, MR_r2, 4) = MR_tfield(1, MR_r1, 0);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(ll_backend__deep_profiling__deep_prof_transform_goal_6_0,31)
	...
	MR_sv(5) = MR_tfield(3, MR_tfield(0, MR_r2, 0), 3);
	MR_sv(6) = MR_tfield(3, MR_tfield(0, MR_r2, 0), 4);
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
