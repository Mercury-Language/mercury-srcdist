...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_11, (MR_Integer) 210, &ll_backend__deep_profiling__DoCoverageProfiling_29);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_11, (MR_Integer) 207, &ll_backend__deep_profiling__UseActivationCounts_35);
    }
    {
              ...
              if (ll_backend__deep_profiling__succeeded)
                {
                  ...
                  if (ll_backend__deep_profiling__succeeded)
                    {
                      {
                        hlds__goal_util__transform_all_goals_3_p_0((MR_Word) &ll_backend__deep_profiling_scalar_common_1[9], ll_backend__deep_profiling__SubGoal0_118, &ll_backend__deep_profiling__SubGoal_119);
                      }
                      *ll_backend__deep_profiling__AddedImpurity_8 = (MR_Integer) 0;
                      *ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_82 = ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_0_81;
                    }
                  ...
                  if (ll_backend__deep_profiling__succeeded)
                    {
                      ll_backend__deep_profiling__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__deep_profiling__Reason0_68, (MR_Integer) 1)));
                      {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(3), ll_backend__deep_profiling__Var_129, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[11])));
                  ...
                  else
                    {
                      ...
                      if (ll_backend__deep_profiling__succeeded)
                        {
                          {
                            hlds__goal_util__transform_all_goals_3_p_0((MR_Word) &ll_backend__deep_profiling_scalar_common_1[10], ll_backend__deep_profiling__SubGoal0_118, &ll_backend__deep_profiling__SubGoal_153);
                          }
                          *ll_backend__deep_profiling__AddedImpurity_8 = (MR_Integer) 0;
                          *ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_82 = ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_0_81;
                        }
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(3), ll_backend__deep_profiling__Var_92, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[11])));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_68, (MR_Integer) 220, &ll_backend__deep_profiling__UseZeroing_69);
          }
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ll_backend__deep_profiling__FailGoal_92, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[10])));
  ...
  MR_Word * ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_8)
{
  if ((ll_backend__deep_profiling__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  ...
  else
    {
      ...
      {
        mercury__list__map_foldl_5_p_0(ll_backend__deep_profiling__TypeCtorInfo_97_97, ll_backend__deep_profiling__TypeInfo_98_98, (MR_Word) &ll_backend__deep_profiling__ll_backend__deep_profiling__type_ctor_info_deep_info_0, (MR_Word) &ll_backend__deep_profiling_scalar_common_1[8], ll_backend__deep_profiling__Chunk_13, &ll_backend__deep_profiling__DepthVars_21, ((MR_Box) (ll_backend__deep_profiling__STATE_VARIABLE_DeepInfo_0_7)), &ll_backend__deep_profiling__conv2_STATE_VARIABLE_DeepInfo_47_47);
      }
    ...
    if (ll_backend__deep_profiling__succeeded)
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__deep_profiling__Var_28, 0) = ((MR_Box) (&ll_backend__deep_profiling_scalar_common_7[0]));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_7, (MR_Integer) 207, &ll_backend__deep_profiling__UseActivationCounts_14);
    }
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__deep_profiling__FailGoal_28, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__deep_profiling_scalar_common_2[10])));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__deep_profiling__Globals_4, (MR_Integer) 222, &ll_backend__deep_profiling__TailRecursion_5);
    }
