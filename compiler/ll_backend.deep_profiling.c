...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 242, &DoCoverageProfiling_29);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 239, &UseActivationCounts_35);
