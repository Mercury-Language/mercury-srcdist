  ...
  MR_Word * STATE_VARIABLE_ProcInfo_19)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word DeepProfInfo_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDeepProfInfo_51, (MR_Integer) 0))));

        MaybeRecInfo_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeepProfInfo_85, (MR_Integer) 0))));
      }
  ...
  MR_Word * STATE_VARIABLE_VarTable_18)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_29 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
        {
          Entry_28 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Entry_28, 0) = ((MR_Box) ((MR_String) "OldOutermost"));
          MR_hl_field(MR_mktag(0), Entry_28, 1) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(0), Entry_28, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        parse_tree__var_table__add_var_entry_4_p_0(Entry_28, &OldOutermostProcDyn0_16, STATE_VARIABLE_VarTable_0_17, &STATE_VARIABLE_VarTable_20_20);
        {
          MR_Word base;
  ...
  Var_38 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
  {
    Entry_37 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_37, 0) = ((MR_Box) ((MR_String) "NewOutermost"));
    MR_hl_field(MR_mktag(0), Entry_37, 1) = ((MR_Box) (Var_38));
    MR_hl_field(MR_mktag(0), Entry_37, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
  }
  parse_tree__var_table__add_var_entry_4_p_0(Entry_37, NewOutermostProcDyn_13, STATE_VARIABLE_VarTable_20_20, STATE_VARIABLE_VarTable_18);
}
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_25 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(0), Entry_24, 0) = ((MR_Box) ((MR_String) "ActivationPtr"));
          MR_hl_field(MR_mktag(0), Entry_24, 1) = ((MR_Box) (Var_25));
          MR_hl_field(MR_mktag(0), Entry_24, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        parse_tree__var_table__add_var_entry_4_p_0(Entry_24, &ActivationPtr0_14, STATE_VARIABLE_VarTable_0_15, STATE_VARIABLE_VarTable_16);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_7, ProcInfo0_21, &VarTable_90);
        ...
        Detism_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism_91, (MR_Integer) 0))));
      {
        ...
        MR_hl_field(MR_mktag(0), DeepOriginalBody_41, 3) = ((MR_Box) (VarTable_90));
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__deep_profiling_scalar_common_2[0]), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&ll_backend__deep_profiling_scalar_common_1[6]), SCCs_28, ((MR_Box) (STATE_VARIABLE_ModuleInfo_8_29)), &conv1_STATE_VARIABLE_ModuleInfo_16_16);
