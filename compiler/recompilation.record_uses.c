...
static const MR_DuFunctorDesc recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_0;
...
static const MR_PseudoTypeInfo recompilation__record_uses__recompilation__record_uses__field_types_item_recomp_deps_0_1[2];

static const MR_DuFunctorDesc recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_1;

static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_0[1];

static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_1[1];

static const MR_DuPtagLayout recompilation__record_uses__recompilation__record_uses__du_ptag_ordered_item_recomp_deps_0[2];

static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_name_ordered_item_recomp_deps_0[2];

static const MR_Integer recompilation__record_uses__recompilation__record_uses__functor_number_map_item_recomp_deps_0[2];
...
static MR_bool MR_CALL 
recompilation__record_uses____Unify____item_recomp_deps_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
recompilation__record_uses____Compare____item_recomp_deps_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static const MR_DuFunctorDesc recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_1 = {
  ...
  (MR_Integer) -1,
  INT32_C(1),
  recompilation__record_uses__recompilation__record_uses__field_types_item_recomp_deps_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_0[1] = { &recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_0 };

static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_1[1] = { &recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_1 };

static const MR_DuPtagLayout recompilation__record_uses__recompilation__record_uses__du_ptag_ordered_item_recomp_deps_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    recompilation__record_uses__recompilation__record_uses__du_stag_ordered_item_recomp_deps_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr recompilation__record_uses__recompilation__record_uses__du_name_ordered_item_recomp_deps_0[2] = {
  &recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_1,
  &recompilation__record_uses__recompilation__record_uses__du_functor_desc_item_recomp_deps_0_0
};
...
const MR_TypeCtorInfo_Struct recompilation__record_uses__recompilation__record_uses__type_ctor_info_item_recomp_deps_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (recompilation__record_uses____Unify____item_recomp_deps_0_0_10001)),
  ((MR_Box) (recompilation__record_uses____Compare____item_recomp_deps_0_0_10001)),
  (MR_String) "recompilation.record_uses",
  (MR_String) "item_recomp_deps",
  { recompilation__record_uses__recompilation__record_uses__du_name_ordered_item_recomp_deps_0 },
  { recompilation__record_uses__recompilation__record_uses__du_ptag_ordered_item_recomp_deps_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  recompilation__record_uses__recompilation__record_uses__functor_number_map_item_recomp_deps_0,
...
void MR_CALL 
recompilation__record_uses____Compare____item_recomp_deps_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
recompilation__record_uses____Unify____item_recomp_deps_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
...
void MR_CALL 
recompilation__record_uses__finish_gathering_item_recomp_deps_4_p_0(
  MR_Word ItemId_5,
  MR_Word MaybeGatheredItemDeps_6,
  MR_Word MaybeRecomp0_7,
  MR_Word * MaybeRecomp_8)
{
  if ((MaybeGatheredItemDeps_6 == (MR_Word) ((MR_Unsigned) 0U)))
    *MaybeRecomp_8 = MaybeRecomp0_7;
  else
  {
    MR_Word GatheredDeps_10 = ((MR_Word) ((MR_hl_field(1, MaybeGatheredItemDeps_6, 1))));

    if ((MaybeRecomp0_7 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140recompilation.record_uses.finish_gathering_item_recomp_deps\'/4", (MR_String) "gathered deps but no recomp info");
        return;
      }
    else
    {
      ...
      recompilation__record_uses__record_gathered_item_deps_4_p_0(ItemId_5, GatheredDeps_10, Recomp0_11, &Recomp_12);
      {
        MR_Word base;
...
void MR_CALL 
recompilation__record_uses__record_gathered_item_deps_4_p_0(
  MR_Word ItemId_5,
  MR_Word GatheredItemDeps_6,
  MR_Word STATE_VARIABLE_Info_0_12,
  MR_Word * STATE_VARIABLE_Info_13)
{
  MR_bool succeeded;

  succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), GatheredItemDeps_6);
  if (succeeded)
  ...
  else
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), (MR_Word) (&recompilation__record_uses_scalar_common_1[0]), DepsMap0_8, ((MR_Box) (ItemId_5)), &conv0_Deps0_9);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      mercury__set__union_3_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), GatheredItemDeps_6, Deps0_9, &Deps_10);
      mercury__map__det_update_4_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), (MR_Word) (&recompilation__record_uses_scalar_common_1[0]), ((MR_Box) (ItemId_5)), ((MR_Box) (Deps_10)), DepsMap0_8, &DepsMap_11);
    }
    else
      mercury__map__det_insert_4_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), (MR_Word) (&recompilation__record_uses_scalar_common_1[0]), ((MR_Box) (ItemId_5)), ((MR_Box) (GatheredItemDeps_6)), DepsMap0_8, &DepsMap_11);
...
void MR_CALL 
recompilation__record_uses__gather_item_recomp_dep_3_p_0(
  MR_Word DepItemId_4,
  MR_Word STATE_VARIABLE_MaybeGatheredItemDeps_0_13,
  MR_Word * STATE_VARIABLE_MaybeGatheredItemDeps_14)
{
  MR_bool succeeded;

  if ((STATE_VARIABLE_MaybeGatheredItemDeps_0_13 == (MR_Word) ((MR_Unsigned) 0U)))
    *STATE_VARIABLE_MaybeGatheredItemDeps_14 = STATE_VARIABLE_MaybeGatheredItemDeps_0_13;
  else
  {
    MR_Word ModuleName_6 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeGatheredItemDeps_0_13, 0))));
    MR_Word GatheredDeps0_7 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeGatheredItemDeps_0_13, 1))));
    MR_Word DepItemName_9 = ((MR_Word) ((MR_hl_field(0, DepItemId_4, 1))));
    MR_Word Var_15 = ((MR_Word) ((MR_hl_field(0, DepItemName_9, 0))));
    MR_Word Var_17;
    ...
    {
      MR_Word GatheredDeps_12;

      mercury__set__insert_3_p_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0), ((MR_Box) (DepItemId_4)), GatheredDeps0_7, &GatheredDeps_12);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_MaybeGatheredItemDeps_14 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (ModuleName_6));
        MR_hl_field(1, base, 1) = ((MR_Box) (GatheredDeps_12));
      }
    }
  }
}
...
void MR_CALL 
recompilation__record_uses__maybe_start_gathering_item_recomp_deps_sym_name_4_p_0(
  MR_Word ModuleName_5,
  MR_Word ItemSymName_6,
  MR_Word MaybeRecompInfo_7,
  MR_Word * MaybeGatheredItemDeps_8)
{
  MR_bool succeeded;

  if ((MaybeRecompInfo_7 == (MR_Word) ((MR_Unsigned) 0U)))
    *MaybeGatheredItemDeps_8 = (MR_Word) ((MR_Unsigned) 0U);
  else
  {
    MR_Word Var_13;

    succeeded = ((MR_tag((MR_Word) ItemSymName_6)) == (MR_Integer) 1);
    if (succeeded)
    {
      Var_13 = ((MR_Word) ((MR_hl_field(1, ItemSymName_6, 0))));
...
void MR_CALL 
recompilation__record_uses__maybe_start_gathering_item_recomp_deps_4_p_0(
  MR_Word ModuleName_5,
  MR_Word ItemId_6,
  MR_Word MaybeRecompInfo_7,
  MR_Word * MaybeGatheredItemDeps_8)
{
  ...
  {
    MR_Word ItemName_11 = ((MR_Word) ((MR_hl_field(0, ItemId_6, 1))));
    MR_Word ItemSymName_12 = ((MR_Word) ((MR_hl_field(0, ItemName_11, 0))));
    MR_Word Var_17;

    succeeded = ((MR_tag((MR_Word) ItemSymName_12)) == (MR_Integer) 1);
    if (succeeded)
    {
      Var_17 = ((MR_Word) ((MR_hl_field(1, ItemSymName_12, 0))));
      succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_5, Var_17);
    }
    if (succeeded)
      *MaybeGatheredItemDeps_8 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      ...
      Var_15 = mercury__set__init_0_f_0((MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_recomp_item_id_0));
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *MaybeGatheredItemDeps_8 = base;
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = recompilation__record_uses____Unify____item_recomp_deps_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  recompilation__record_uses____Compare____item_recomp_deps_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
...
void mercury__recompilation__record_uses__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&recompilation__record_uses__recompilation__record_uses__type_ctor_info_item_recomp_deps_0);
