  ...
  MR_Word ClassDefn_13)
{
  ...
  Access_61 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_19, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
  Overridability_62 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_19, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  Constness_63 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_19, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_64 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_64) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word FieldVarDefn_14)
{
  ...
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Indent_11);
  Var_59 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  Constness_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_54) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
