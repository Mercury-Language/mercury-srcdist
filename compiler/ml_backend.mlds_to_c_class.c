...
ml_backend__mlds_to_c_class__IntroducedFrom__pred__mlds_output_struct_defn__229__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_class__IntroducedFrom__pred__mlds_output_struct_defn__229__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word StructDefn_12)
{
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_s");
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) " {\n");
  Indent1_23 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
  {
  ...
  MR_Word ClassDefn_12)
{
  ...
  if ((Inherits_20 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  else
  {
    ...
    Var_47 = ml_backend__ml_code_util__ml_gen_public_field_decl_flags_0_f_0();
    {
      ...
      MR_hl_field(0, Var_46, 0) = ((MR_Box) (MR_mkword(3, &ml_backend__mlds_to_c_class_scalar_common_1[1])));
  ...
  Indent1_40 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
  {
    ...
    MR_hl_field(0, Var_60, 5) = ((MR_Box) (Indent1_40));
    MR_hl_field(0, Var_60, 6) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(0, Var_60, 7) = ((MR_Box) (ClassModuleName_28));
  }
  mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_60, BaseFieldVarDefns_35, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_61_61);
  {
    Var_63 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_63, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_6[0]));
    MR_hl_field(0, Var_63, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_4));
    MR_hl_field(0, Var_63, 2) = ((MR_Box) ((MR_Integer) 4));
    MR_hl_field(0, Var_63, 3) = ((MR_Box) (Opts_8));
    MR_hl_field(0, Var_63, 4) = ((MR_Box) (Stream_9));
    MR_hl_field(0, Var_63, 5) = ((MR_Box) (Indent1_40));
    MR_hl_field(0, Var_63, 6) = ((MR_Box) (ClassModuleName_28));
  }
  mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_63, StructCtors_33, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_64_64);
  mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_60, StructMemberFields_34, ((MR_Box) ((MR_Integer) 0)), &conv2_STATE_VARIABLE_IO_66_66);
  Var_68 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_68, Context_16);
  mercury__io__write_string_4_p_0(Stream_9, IndentStr_27);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "};\n");
