    ...
    switch (MR_tag((MR_Word) Inherits_18)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Inherits_18)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            BaseFieldVarDefns_32 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 1:
            {
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_49 = ml_backend__ml_code_util__ml_gen_public_field_decl_flags_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_48, 5) = ((MR_Box) ((MR_Integer) 0));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), BaseFieldVarDefns_32, 1) = ((MR_Box) ((MR_Integer) 0));
          }
        }
        break;
    }
      ...
      case (MR_Integer) 3:
        {
          ...
          StaticCtors_26 = (MR_Word) ((MR_Integer) 0);
          StaticMemberFields_28 = (MR_Word) ((MR_Integer) 0);
