...
static void MR_CALL 
ml_backend__mlds_to_c_class__mlds_output_class_decl_7_p_0(
  MR_Word Opts_8,
  MR_Word Stream_9,
  MR_Integer Indent_10,
  MR_Word ModuleName_11,
  ...
  MR_Word ClassDefn_12)
{
  ...
  if (!(succeeded))
  {
    MR_String ClassName_31 = ((MR_String) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 0))));
    MR_Integer ClassArity_32 = ((MR_Integer) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 1))));
    MR_Word Context_33 = ((MR_Word) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 2))));
    MR_Word Flags_34 = ((MR_Word) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 3))));
    MR_Word ClassKind_35 = ((MR_Unsigned) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 4))) & (MR_Integer) 3);
    MR_String IndentStr_44;
    MR_String FlagsPrefix_45;
    MR_String Qualifier_46;
    MR_String ClassNameStr_47;
    MR_Word Var_48 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);

    ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_48, Context_33);
    IndentStr_44 = libs__indent__indent2_string_1_f_0(Indent_10);
    FlagsPrefix_45 = ml_backend__mlds_to_c_class__class_decl_flags_to_prefix_for_c_2_f_0(Opts_8, Flags_34);
    Qualifier_46 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_11);
    ClassNameStr_47 = ml_backend__mlds_to_c_name__class_name_arity_to_string_for_c_2_f_0(ClassName_31, ClassArity_32);
    switch (ClassKind_35) {
      ...
      case (MR_Integer) 2:
        {
          mercury__io__write_string_4_p_0(Stream_9, IndentStr_44);
  ...
  MR_Word ClassDefn_12)
{
  ...
  ml_backend__mlds_to_c_class__mlds_output_class_decl_7_p_0(Opts_8, Stream_9, Indent_10, ModuleName_11, ClassDefn_12);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_47 = ml_backend__ml_code_util__ml_gen_public_field_decl_flags_0_f_0();
        {
          ...
          MR_hl_field(0, Var_46, 3) = ((MR_Box) (Type_37));
        ...
        }
        {
          ...
          MR_hl_field(1, BaseFieldVarDefns_34, 0) = ((MR_Box) (Var_46));
    ...
    case (MR_Integer) 2:
      {
        ...
        {
          MR_Word Var_60;
          MR_Integer Var_62 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          MR_Word Var_65;
          MR_Integer Var_67;
          MR_Word Var_69;
          MR_Integer Var_71;
...

          {
            ...
            MR_hl_field(0, Var_60, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_5[0]));
            MR_hl_field(0, Var_60, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_3));
            MR_hl_field(0, Var_60, 2) = ((MR_Box) ((MR_Integer) 5));
            MR_hl_field(0, Var_60, 3) = ((MR_Box) (Opts_8));
            MR_hl_field(0, Var_60, 4) = ((MR_Box) (Stream_9));
            MR_hl_field(0, Var_60, 5) = ((MR_Box) (Var_62));
            MR_hl_field(0, Var_60, 6) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(0, Var_60, 7) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_60, BaseFieldVarDefns_34, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_61_61);
          Var_67 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          {
            Var_65 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_65, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_4[1]));
            ...
            MR_hl_field(0, Var_65, 5) = ((MR_Box) (Var_67));
            MR_hl_field(0, Var_65, 6) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_65, StructCtors_29, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_66_66);
          Var_71 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          {
            Var_69 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_69, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_5[0]));
            MR_hl_field(0, Var_69, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_5));
            MR_hl_field(0, Var_69, 2) = ((MR_Box) ((MR_Integer) 5));
            MR_hl_field(0, Var_69, 3) = ((MR_Box) (Opts_8));
            MR_hl_field(0, Var_69, 4) = ((MR_Box) (Stream_9));
            MR_hl_field(0, Var_69, 5) = ((MR_Box) (Var_71));
            MR_hl_field(0, Var_69, 6) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(0, Var_69, 7) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_69, StructMemberFields_31, ((MR_Box) ((MR_Integer) 0)), &conv2_STATE_VARIABLE_IO_58_58);
        }
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        ml_backend__mlds_to_c_class__mlds_output_enum_constants_7_p_0(Opts_8, Stream_9, Var_54, ClassModuleName_27, BaseFieldVarDefns_34);
        Var_57 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        ml_backend__mlds_to_c_class__mlds_output_enum_constants_7_p_0(Opts_8, Stream_9, Var_57, ClassModuleName_27, MemberFields_23);
      }
      break;
  }
  Var_74 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_74, Context_16);
  ...
  MR_Word ClassDefn_12)
{
  ...
  MR_String FlagsPrefix_28;
  MR_String Qualifier_29;
  MR_String ClassNameStr_30;
  MR_Word Var_33 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);

  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_33, Context_16);
  IndentStr_27 = libs__indent__indent2_string_1_f_0(Indent_10);
  FlagsPrefix_28 = ml_backend__mlds_to_c_class__class_decl_flags_to_prefix_for_c_2_f_0(Opts_8, Flags_17);
  Qualifier_29 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_11);
  ClassNameStr_30 = ml_backend__mlds_to_c_name__class_name_arity_to_string_for_c_2_f_0(ClassName_14, ClassArity_15);
  switch (ClassKind_18) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    case (MR_Integer) 1:
    case (MR_Integer) 2:
      {
        ...
        mercury__io__write_string_4_p_0(Stream_9, FlagsPrefix_28);
        mercury__io__write_string_4_p_0(Stream_9, (MR_String) "struct ");
        mercury__io__write_string_4_p_0(Stream_9, Qualifier_29);
        mercury__io__write_string_4_p_0(Stream_9, (MR_String) "__");
        mercury__io__write_string_4_p_0(Stream_9, ClassNameStr_30);
        mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_s");
      }
      break;
    case (MR_Integer) 3:
