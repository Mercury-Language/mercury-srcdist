...
ml_backend__mlds_to_c_class__mlds_output_enum_constant_7_p_0(
  ...
  MR_Word Stream_12)
{
  MR_Word FieldVarName_14 = ((MR_Word) ((MR_hl_field(0, FieldVarDefn_11, (MR_Integer) 0))));
  MR_Word Context_15 = ((MR_Word) ((MR_hl_field(0, FieldVarDefn_11, (MR_Integer) 1))));
  MR_Word Type_17 = ((MR_Word) ((MR_hl_field(0, FieldVarDefn_11, (MR_Integer) 3))));
  MR_Word Initializer_18 = ((MR_Word) ((MR_hl_field(0, FieldVarDefn_11, (MR_Integer) 4))));
  MR_Word QualFieldVarName_20;
  MR_Word Var_23 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  ...
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_12, Indent_9);
  {
    ...
    MR_hl_field(0, QualFieldVarName_20, 0) = ((MR_Box) (EnumModuleName_10));
    MR_hl_field(0, QualFieldVarName_20, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    MR_hl_field(0, QualFieldVarName_20, 2) = ((MR_Box) (FieldVarName_14));
  }
...
{
  MR_bool succeeded;
  MR_Word Var_16 = ((MR_Unsigned) ((MR_hl_field(0, ClassDefn_12, (MR_Integer) 4))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_48 = ml_backend__ml_code_util__ml_gen_public_field_decl_flags_0_f_0();
        {
          Var_47 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_47, 0) = ((MR_Box) (MR_mkword(3, &ml_backend__mlds_to_c_class_scalar_common_1[0])));
          MR_hl_field(0, Var_47, 1) = ((MR_Box) (Context_16));
          MR_hl_field(0, Var_47, 2) = ((MR_Box) (Var_48));
          MR_hl_field(0, Var_47, 3) = ((MR_Box) (Type_37));
          MR_hl_field(0, Var_47, 4) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Var_47, 5) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          BaseFieldVarDefns_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, BaseFieldVarDefns_34, 0) = ((MR_Box) (Var_47));
    ...
    case (MR_Integer) 2:
      {
        ...
        {
          MR_Word Var_61;
          MR_Integer Var_63 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          MR_Word Var_66;
          MR_Integer Var_68;
          MR_Word Var_70;
          MR_Integer Var_72;
...

          {
            ...
            MR_hl_field(0, Var_61, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_5[0]));
            MR_hl_field(0, Var_61, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_3));
            MR_hl_field(0, Var_61, 2) = ((MR_Box) ((MR_Integer) 5));
            MR_hl_field(0, Var_61, 3) = ((MR_Box) (Opts_8));
            MR_hl_field(0, Var_61, 4) = ((MR_Box) (Stream_9));
            MR_hl_field(0, Var_61, 5) = ((MR_Box) (Var_63));
            MR_hl_field(0, Var_61, 6) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(0, Var_61, 7) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_61, BaseFieldVarDefns_34, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_62_62);
          Var_68 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          {
            Var_66 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_66, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_4[1]));
            MR_hl_field(0, Var_66, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_4));
            ...
            MR_hl_field(0, Var_66, 6) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_66, StructCtors_29, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_67_67);
          Var_72 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
          {
            Var_70 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_70, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_5[0]));
            MR_hl_field(0, Var_70, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0_5));
            MR_hl_field(0, Var_70, 2) = ((MR_Box) ((MR_Integer) 5));
            MR_hl_field(0, Var_70, 3) = ((MR_Box) (Opts_8));
            MR_hl_field(0, Var_70, 4) = ((MR_Box) (Stream_9));
            MR_hl_field(0, Var_70, 5) = ((MR_Box) (Var_72));
            MR_hl_field(0, Var_70, 6) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(0, Var_70, 7) = ((MR_Box) (ClassModuleName_27));
          }
          mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_70, StructMemberFields_31, ((MR_Box) ((MR_Integer) 0)), &conv2_STATE_VARIABLE_IO_59_59);
        }
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        Var_55 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        ml_backend__mlds_to_c_class__mlds_output_enum_constants_7_p_0(Opts_8, Stream_9, Var_55, ClassModuleName_27, BaseFieldVarDefns_34);
        Var_58 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        ml_backend__mlds_to_c_class__mlds_output_enum_constants_7_p_0(Opts_8, Stream_9, Var_58, ClassModuleName_27, MemberFields_23);
      }
      break;
  }
  Var_75 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
...
ml_backend__mlds_to_c_class__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_100_115_95_111_117_116_112_117_116_95_99_108_97_115_115_95_100_101_99_108_95_95_91_54_93_95_48_8_p_0(
  ...
  MR_Word ClassDefn_13)
{
  MR_String ClassName_16 = ((MR_String) ((MR_hl_field(0, ClassDefn_13, (MR_Integer) 0))));
  MR_Integer ClassArity_17 = ((MR_Integer) ((MR_hl_field(0, ClassDefn_13, (MR_Integer) 1))));
  MR_Word Context_18 = ((MR_Word) ((MR_hl_field(0, ClassDefn_13, (MR_Integer) 2))));
  MR_Word Flags_19 = ((MR_Word) ((MR_hl_field(0, ClassDefn_13, (MR_Integer) 3))));
  MR_Word ClassKind_20 = ((MR_Unsigned) ((MR_hl_field(0, ClassDefn_13, (MR_Integer) 4))) & (MR_Integer) 3);
  MR_Word Var_31 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_9, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  MR_Word Access_60;
  MR_Word Overridability_61;
  ...
  Access_60 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_19, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
  Overridability_61 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_19, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  Constness_62 = ((MR_Unsigned) ((MR_hl_field(0, Flags_19, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_63 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_9, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_63) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        switch (Access_60) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) "/* private: */ ");
            break;
          case (MR_Integer) 0:
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) "/* public: */ ");
            break;
        }
        mercury__io__write_string_4_p_0(Stream_10, (MR_String) "/* one_copy */ ");
        switch (Overridability_61) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
            }
            break;
          case (MR_Integer) 1:
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) "/* sealed */ ");
            break;
        }
      }
      break;
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  ml_backend__mlds_to_c_class__mlds_output_enum_constant_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
  ...
  MR_Word MemberFields_12)
{
  ...
  mercury__list__filter_3_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&ml_backend__mlds_to_c_class_scalar_common_3[0]), MemberFields_12, &EnumConstMemberFields_14);
  {
    ...
    MR_hl_field(0, Var_18, 0) = ((MR_Box) (&ml_backend__mlds_to_c_class_scalar_common_4[0]));
    MR_hl_field(0, Var_18, 1) = ((MR_Box) (ml_backend__mlds_to_c_class__mlds_output_enum_constants_7_p_0_2));
    MR_hl_field(0, Var_18, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(0, Var_18, 3) = ((MR_Box) (Opts_8));
    MR_hl_field(0, Var_18, 4) = ((MR_Box) (Indent_10));
    MR_hl_field(0, Var_18, 5) = ((MR_Box) (EnumModuleName_11));
  }
  ...
  MR_Word FieldVarDefn_14)
{
  ...
  Var_26 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_9, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_10, Var_26, Context_17);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Indent_11);
  Var_59 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_18, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  Constness_52 = ((MR_Unsigned) ((MR_hl_field(0, Flags_18, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_53 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_9, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_53) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  }
  {
    ...
    MR_hl_field(0, QualFieldVarName_22, 0) = ((MR_Box) (ModuleName_13));
    MR_hl_field(0, QualFieldVarName_22, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(0, QualFieldVarName_22, 2) = ((MR_Box) (FieldVarName_16));
  }
