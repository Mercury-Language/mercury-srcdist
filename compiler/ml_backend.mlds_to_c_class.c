...
{
  {
    ...
    MR_Word Var_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn_10, (MR_Integer) 4)));

    succeeded = (Kind_16 == (MR_Integer) 3);
    if (!(succeeded))
    {
      MR_Word Var_27 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
      MR_Word Access_55;
      MR_Word Overridability_56;
      MR_Word Constness_57;
      MR_Word Comments_58;
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2)));
      MR_Unsigned packed_args_2;
      MR_Unsigned packed_args_3;

      ml_backend__mlds_to_c_util__c_output_context_4_p_0(Var_27, Context_14);
      ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_15, (MR_Integer) 0)));
      Access_55 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_15, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
      ...
      Comments_58 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 14)) & (MR_Integer) 1);
      switch (Comments_58) {
...
{
  {
    ...
    Var_28 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
    ml_backend__mlds_to_c_util__c_output_context_4_p_0(Var_28, Context_14);
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_15, (MR_Integer) 0)));
    Access_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_15, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    ...
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2)));
    Comments_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 14)) & (MR_Integer) 1);
    switch (Comments_57) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2)));
    Var_75 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn_12, (MR_Integer) 4)));
...
{
  {
    ...
    Var_24 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0)));
    Var_64 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    Constness_57 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2)));
    Comments_58 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> (MR_Integer) 14)) & (MR_Integer) 1);
    switch (Comments_58) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
