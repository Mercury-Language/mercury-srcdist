  ...
  MR_Word * DFileDeps_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 404, &Intermod_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 405, &UsePlainOpt_24);
