...
static void MR_CALL 
parse_tree__d_file_deps__IntroducedFrom__pred__get_dependencies_from_graph__399__1_4_p_0(
  MR_Word DepsGraph_4,
  ...
  MR_Word * STATE_VARIABLE_FIMSpecs_10)
{
  ...
  MR_Word IntFIMS_11 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_6, 5))));
  MR_Word ImpFIMS_12 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_6, 6))));
  MR_Word Var_13;
  MR_Word Var_14;
  MR_Word Var_15;

  {
    ...
    MR_hl_field(1, Var_15, 0) = ((MR_Box) (STATE_VARIABLE_FIMSpecs_0_9));
    MR_hl_field(1, Var_15, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_14 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_14, 0) = ((MR_Box) (ImpFIMS_12));
    MR_hl_field(1, Var_14, 1) = ((MR_Box) (Var_15));
  }
  {
    Var_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_13, 0) = ((MR_Box) (IntFIMS_11));
    MR_hl_field(1, Var_13, 1) = ((MR_Box) (Var_14));
  }
  *STATE_VARIABLE_FIMSpecs_10 = mercury__set__union_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_13);
}
  ...
  MR_Word * STATE_VARIABLE_Cache_28)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 430, &Intermod_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 431, &UsePlainOpt_16);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 434, &UseTransOpt_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 433, &TransOpt_18);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv2_STATE_VARIABLE_FIMSpecs_10;

  parse_tree__d_file_deps__gather_fim_specs_in_direct_int1_spec_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_FIMSpecs_10);
  *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_FIMSpecs_10));
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__d_file_deps__IntroducedFrom__pred__get_dependencies_from_graph__399__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_17);
  ...
  MR_Word * DFileDeps_10)
{
  ...
  MR_Word Var_42;
  MR_Word BackendLangs_98;
  MR_Word Var_99;
  MR_Word ModuleKey_88;

  succeeded = mercury__digraph__search_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_11, ((MR_Box) (ModuleName_18)), &ModuleKey_88);
  if (succeeded)
  {
    MR_Word DepsKeysSet_89;
    MR_Word AddKeyDep_90;
    MR_Word DependenciesList_91;
    MR_Box conv1_DependenciesList_91;

    mercury__digraph__lookup_key_set_from_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_11, ModuleKey_88, &DepsKeysSet_89);
    {
      AddKeyDep_90 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, AddKeyDep_90, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_4[0]));
      MR_hl_field(0, AddKeyDep_90, 1) = ((MR_Box) (parse_tree__d_file_deps__construct_d_file_deps_gendep_5_p_0_1));
      MR_hl_field(0, AddKeyDep_90, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, AddKeyDep_90, 3) = ((MR_Box) (IntDepsGraph_11));
    }
    mercury__sparse_bitset__foldr_4_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_2[2]), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), AddKeyDep_90, DepsKeysSet_89, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_DependenciesList_91);
    DependenciesList_91 = ((MR_Word) (conv1_DependenciesList_91));
    mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), DependenciesList_91, &IntDeps_19);
  }
  else
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 430, &Intermod_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 431, &UsePlainOpt_24);
  ...
  libs__globals__get_backend_foreign_languages_2_p_0(Globals_6, &BackendLangs_98);
  {
    Var_99 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_99, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_4[1]));
    MR_hl_field(0, Var_99, 1) = ((MR_Box) (parse_tree__d_file_deps__construct_d_file_deps_gendep_5_p_0_2));
    MR_hl_field(0, Var_99, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_99, 3) = ((MR_Box) (BackendLangs_98));
    MR_hl_field(0, Var_99, 4) = ((MR_Box) (SourceFileTopModuleName_27));
  }
  mercury__set__filter_map_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_99, OwnFIMSpecs_28, &OwnFIMImports_29);
...
{
  MR_Word DepsList_20;
  MR_Word IntDepsGraph0_21;
  MR_Word ImpDepsGraph0_22;
  MR_Word IntDepsGraph_23;
  MR_Word ImpDepsGraph_24;
  MR_Word IndirectOptDepsGraph_28;
  MR_Word TransOptDepsGraph_29;
  MR_Word TransOptDepsOrdering_30;
  MR_Word TransImpDepsGraph_31;
  MR_Word IndirectDepsGraph_32;
  MR_Word TransOptOrder_34;
  MR_Word IntDepsGraphEdges_35;
  MR_Word ImpDepsGraphEdges_36;
  MR_Word IndirectDepsGraphEdges_37;
  MR_Word IndirectOptDepsGraphEdges_38;
  MR_Word TransOptDepsGraphEdges_39;
  MR_Word AllDepsGraphsEdges_40;
  MR_Word AllDepsGraph_41;
  MR_Word Var_64;
  MR_Word Var_65;
  MR_Word Var_66;

  mercury__map__values_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), DepsMap_14, &DepsList_20);
  mercury__digraph__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &IntDepsGraph0_21);
  mercury__digraph__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ImpDepsGraph0_22);
  parse_tree__d_file_deps__deps_list_to_deps_graph_7_p_0(DepsMap_14, DepsList_20, BurdenedModules_16, IntDepsGraph0_21, &IntDepsGraph_23, ImpDepsGraph0_22, &ImpDepsGraph_24);
  parse_tree__output_imports_graph__maybe_output_imports_graph_7_p_0(ProgressStream_11, Globals_12, ModuleName_13, IntDepsGraph_23, ImpDepsGraph_24);
  parse_tree__opt_deps_spec__compute_opt_trans_opt_deps_graph_11_p_0(ProgressStream_11, Globals_12, ModuleName_13, ImpDepsGraph_24, &IndirectOptDepsGraph_28, &TransOptDepsGraph_29, &TransOptDepsOrdering_30, ErrSpecs_17, WarnSpecs_18);
  mercury__digraph__tc_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_24, &TransImpDepsGraph_31);
  mercury__digraph__compose_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_24, TransImpDepsGraph_31, &IndirectDepsGraph_32);
  parse_tree__d_file_deps__get_ext_opt_deps_7_p_0(Globals_12, (MR_Integer) 1, (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_2[5])), TransOptDepsOrdering_30, &TransOptOrder_34);
  mercury__digraph__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_23, &IntDepsGraphEdges_35);
  mercury__digraph__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_24, &ImpDepsGraphEdges_36);
  mercury__digraph__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectDepsGraph_32, &IndirectDepsGraphEdges_37);
  mercury__digraph__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectOptDepsGraph_28, &IndirectOptDepsGraphEdges_38);
  mercury__digraph__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), TransOptDepsGraph_29, &TransOptDepsGraphEdges_39);
  Var_66 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), IndirectOptDepsGraphEdges_38, TransOptDepsGraphEdges_39);
  Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), IndirectDepsGraphEdges_37, Var_66);
  Var_64 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), ImpDepsGraphEdges_36, Var_65);
  AllDepsGraphsEdges_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), IntDepsGraphEdges_35, Var_64);
  mercury__digraph__from_assoc_list_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), AllDepsGraphsEdges_40, &AllDepsGraph_41);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
    *DepGraphs_15 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (IntDepsGraph_23));
    MR_hl_field(0, base, 1) = ((MR_Box) (ImpDepsGraph_24));
    MR_hl_field(0, base, 2) = ((MR_Box) (IndirectDepsGraph_32));
    MR_hl_field(0, base, 3) = ((MR_Box) (IndirectOptDepsGraph_28));
    MR_hl_field(0, base, 4) = ((MR_Box) (TransOptDepsGraph_29));
    MR_hl_field(0, base, 5) = ((MR_Box) (TransOptOrder_34));
    MR_hl_field(0, base, 6) = ((MR_Box) (AllDepsGraph_41));
  }
}
