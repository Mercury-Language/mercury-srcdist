...
static void MR_CALL 
parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(
  MR_Word Digraph_4,
  MR_Word HeadVar__2_12,
  MR_Word * HeadVar__3_13);

static void MR_CALL 
parse_tree__d_file_deps__IntroducedFrom__pred__get_dependencies_from_graph__382__1_4_p_0(
  MR_Word DepsGraph_4,
...
static void MR_CALL 
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_5(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_4(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
static /* final */ const MR_Box parse_tree__d_file_deps_scalar_common_2[6][3] = {
  ...
  /* row   5 */
  {
    ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[6])),
  ...
  MR_Word * HeadVar__3_13)
{
  ...
  mercury__digraph__lookup_vertex_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Digraph_4, HeadVar__2_12, &conv0_HeadVar__3_13);
  ...
  MR_Word * STATE_VARIABLE_Cache_28)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 404, &Intermod_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 405, &UsePlainOpt_16);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 408, &UseTransOpt_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 407, &TransOpt_18);
    ...
    {
      parse_tree__d_file_deps__get_ext_opt_deps_7_p_0(Globals_9, LookForSrc_19, (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_1[6])), BaseDeps_22, &PlainOptDeps_23);
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__make_module_file_names__convert_module_name_to_file_name_7_p_0(Globals_1, (MR_String) "predicate \140parse_tree.d_file_deps.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_1[6])), ModuleName_20, &OptName_33, STATE_VARIABLE_Cache_1_54, &STATE_VARIABLE_Cache_2_62);
          ...
          parse_tree__make_module_file_names__convert_module_name_to_file_name_7_p_0(Globals_1, (MR_String) "predicate \140parse_tree.d_file_deps.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_1[5])), ModuleName_20, &TransOptName_40, STATE_VARIABLE_Cache_2_62, STATE_VARIABLE_Cache_7);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) MaybeFileName_28)) == (MR_Integer) 1))
          {
            ...
            parse_tree__make_module_file_names__convert_module_name_to_file_name_7_p_0(Globals_1, (MR_String) "predicate \140parse_tree.d_file_deps.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_1[6])), ModuleName_20, &OptName_73, STATE_VARIABLE_Cache_1_54, &STATE_VARIABLE_Cache_2_83);
            ...
            parse_tree__make_module_file_names__convert_module_name_to_file_name_7_p_0(Globals_1, (MR_String) "predicate \140parse_tree.d_file_deps.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__d_file_deps_scalar_common_1[5])), ModuleName_20, &TransOptName_78, STATE_VARIABLE_Cache_2_83, STATE_VARIABLE_Cache_7);
  ...
  MR_Word * DFileDeps_10)
{
  ...
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_ancestor_int_spec_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[1]), AncestorIntSpecs_15, ((MR_Box) (STATE_VARIABLE_IntermodFIMSpecs_1_40)), &conv1_STATE_VARIABLE_IntermodFIMSpecs_2_42);
  STATE_VARIABLE_IntermodFIMSpecs_2_42 = ((MR_Word) (conv1_STATE_VARIABLE_IntermodFIMSpecs_2_42));
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_direct_int1_spec_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[2]), DirectInt1Specs_16, ((MR_Box) (STATE_VARIABLE_IntermodFIMSpecs_2_42)), &conv3_STATE_VARIABLE_IntermodFIMSpecs_3_44);
  STATE_VARIABLE_IntermodFIMSpecs_3_44 = ((MR_Word) (conv3_STATE_VARIABLE_IntermodFIMSpecs_3_44));
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_indirect_int2_spec_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[3]), IndirectInt2Specs_17, ((MR_Box) (STATE_VARIABLE_IntermodFIMSpecs_3_44)), &conv5_STATE_VARIABLE_IntermodFIMSpecs_4_46);
  STATE_VARIABLE_IntermodFIMSpecs_4_46 = ((MR_Word) (conv5_STATE_VARIABLE_IntermodFIMSpecs_4_46));
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_parse_tree_plain_opt_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[4]), PlainOpts_18, ((MR_Box) (STATE_VARIABLE_IntermodFIMSpecs_4_46)), &conv7_STATE_VARIABLE_IntermodFIMSpecs_5_48);
  STATE_VARIABLE_IntermodFIMSpecs_5_48 = ((MR_Word) (conv7_STATE_VARIABLE_IntermodFIMSpecs_5_48));
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_int_for_opt_spec_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_1[0]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[5]), IntForOptSpecs_20, ((MR_Box) (STATE_VARIABLE_IntermodFIMSpecs_5_48)), &conv9_IntermodFIMSpecs_27);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__d_file_deps__IntroducedFrom__pred__get_dependencies_from_graph__382__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_17);
  ...
  MR_Word * DFileDeps_10)
{
  ...
  MR_Word ModuleName_17 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_9, 0))));
  MR_Word IntDeps_18;
  MR_Word ImpDeps_19;
  MR_Word DirectDeps_20;
  MR_Word IndirectOptDeps_21;
  MR_Word Intermod_22;
  MR_Word UsePlainOpt_23;
  MR_Word StdDirectDeps_24;
  MR_Word StdIndirectDeps_25;
  MR_Word SourceFileTopModuleName_26;
  MR_Word OwnFIMSpecs_27;
  MR_Word OwnFIMImports_28;
  MR_Word OwnFIMDeps_29;
  MR_Word TransOptDeps0_30;
  MR_Word TransOptDeps_31;
  MR_Word ReachableModules_32;
  MR_Word IntermodFIMDeps_33;
  MR_Word AllMihDeps_34;
  MR_Word TransOptOrder_35;
  MR_Word TransOptOrderSet_36;
  MR_Word TransOptRuleInfo_37;
  MR_Word MaybeInclTransOptRule_38;
  MR_Word Var_41;
  MR_Word BackendLangs_95;
  MR_Word Var_96;
  MR_Word ModuleKey_85;

  succeeded = mercury__digraph__search_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_11, ((MR_Box) (ModuleName_17)), &ModuleKey_85);
  if (succeeded)
  {
    MR_Word DepsKeysSet_86;
    MR_Word AddKeyDep_87;
    MR_Word DependenciesList_88;
    MR_Box conv1_DependenciesList_88;

    mercury__digraph__lookup_key_set_from_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_11, ModuleKey_85, &DepsKeysSet_86);
    {
      AddKeyDep_87 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, AddKeyDep_87, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_4[0]));
      MR_hl_field(0, AddKeyDep_87, 1) = ((MR_Box) (parse_tree__d_file_deps__construct_d_file_deps_gendep_5_p_0_1));
      MR_hl_field(0, AddKeyDep_87, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, AddKeyDep_87, 3) = ((MR_Box) (IntDepsGraph_11));
    }
    mercury__sparse_bitset__foldr_4_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[2]), (MR_Word) (&parse_tree__d_file_deps_scalar_common_2[0]), AddKeyDep_87, DepsKeysSet_86, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_DependenciesList_88);
    DependenciesList_88 = ((MR_Word) (conv1_DependenciesList_88));
    mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), DependenciesList_88, &IntDeps_18);
  }
  else
    mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &IntDeps_18);
  parse_tree__d_file_deps__get_dependencies_from_graph_3_p_0(ImpDepsGraph_12, ModuleName_17, &ImpDeps_19);
  mercury__set__union_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDeps_18, ImpDeps_19, &DirectDeps_20);
  parse_tree__d_file_deps__get_dependencies_from_graph_3_p_0(IndirectOptDepsGraph_14, ModuleName_17, &IndirectOptDeps_21);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 404, &Intermod_22);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 405, &UsePlainOpt_23);
  succeeded = (Intermod_22 == (MR_Integer) 1);
  if (!(succeeded))
    succeeded = (UsePlainOpt_23 == (MR_Integer) 1);
  if (succeeded)
  {
    StdDirectDeps_24 = IndirectOptDeps_21;
    StdIndirectDeps_25 = IndirectOptDeps_21;
  }
  else
  {
    StdDirectDeps_24 = DirectDeps_20;
    parse_tree__d_file_deps__get_dependencies_from_graph_3_p_0(IndirectDepsGraph_13, ModuleName_17, &StdIndirectDeps_25);
  }
  SourceFileTopModuleName_26 = ((MR_Word) ((MR_hl_field(0, Baggage_8, 2))));
  parse_tree__get_dependencies__get_fim_specs_2_p_0(ParseTreeModuleSrc_9, &OwnFIMSpecs_27);
  libs__globals__get_backend_foreign_languages_2_p_0(Globals_6, &BackendLangs_95);
  {
    Var_96 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_96, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_4[1]));
    MR_hl_field(0, Var_96, 1) = ((MR_Box) (parse_tree__d_file_deps__construct_d_file_deps_gendep_5_p_0_2));
    MR_hl_field(0, Var_96, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_96, 3) = ((MR_Box) (BackendLangs_95));
    MR_hl_field(0, Var_96, 4) = ((MR_Box) (SourceFileTopModuleName_26));
  }
  mercury__set__filter_map_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_96, OwnFIMSpecs_27, &OwnFIMImports_28);
  OwnFIMDeps_29 = (MR_Word) (OwnFIMImports_28);
  parse_tree__d_file_deps__get_dependencies_from_graph_3_p_0(TransOptDepsGraph_15, ModuleName_17, &TransOptDeps0_30);
  mercury__set__delete_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_17)), TransOptDeps0_30, &TransOptDeps_31);
  parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0(DepGraphs_7, ModuleName_17, &ReachableModules_32);
  IntermodFIMDeps_33 = (MR_Word) (ReachableModules_32);
  AllMihDeps_34 = (MR_Word) (ReachableModules_32);
  parse_tree__d_file_deps__compute_allowable_trans_opt_deps_3_p_0(ModuleName_17, FullTransOptOrder_16, &TransOptOrder_35);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), TransOptOrder_35, &TransOptOrderSet_36);
  {
    TransOptRuleInfo_37 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TransOptRuleInfo_37, 0) = ((MR_Box) (TransOptOrderSet_36));
  }
  {
    MaybeInclTransOptRule_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, MaybeInclTransOptRule_38, 0) = ((MR_Box) (TransOptRuleInfo_37));
  }
  {
    Var_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_41, 0) = ((MR_Box) (TransOptDeps_31));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
    *DFileDeps_10 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (StdDirectDeps_24));
    MR_hl_field(0, base, 1) = ((MR_Box) (StdIndirectDeps_25));
    MR_hl_field(0, base, 2) = ((MR_Box) (OwnFIMDeps_29));
    MR_hl_field(0, base, 3) = ((MR_Box) (IntermodFIMDeps_33));
    MR_hl_field(0, base, 4) = ((MR_Box) (AllMihDeps_34));
    MR_hl_field(0, base, 5) = ((MR_Box) (MaybeInclTransOptRule_38));
...
{
  MR_Box closure = closure_arg;
  MR_Word conv4_HeadVar__3_13;

  parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_13);
  *wrapper_arg_2 = ((MR_Box) (conv4_HeadVar__3_13));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv3_HeadVar__3_13;

  parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv3_HeadVar__3_13);
  *wrapper_arg_2 = ((MR_Box) (conv3_HeadVar__3_13));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv2_HeadVar__3_13;

  parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__3_13);
  *wrapper_arg_2 = ((MR_Box) (conv2_HeadVar__3_13));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv1_HeadVar__3_13;

  parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_13);
  *wrapper_arg_2 = ((MR_Box) (conv1_HeadVar__3_13));
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__d_file_deps__IntroducedFrom__pred__compute_reachable_modules_from_digraph__425__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_13);
...
parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0(
  ...
  MR_Word * ReachableModules_6)
{
  MR_Word IntDepsGraph_7 = ((MR_Word) ((MR_hl_field(0, DepGraphs_4, 0))));
  MR_Word ImpDepsGraph_8 = ((MR_Word) ((MR_hl_field(0, DepGraphs_4, 1))));
  MR_Word IndirectDepsGraph_9 = ((MR_Word) ((MR_hl_field(0, DepGraphs_4, 2))));
  MR_Word IndirectOptDepsGraph_10 = ((MR_Word) ((MR_hl_field(0, DepGraphs_4, 3))));
  MR_Word TransOptDepsGraph_11 = ((MR_Word) ((MR_hl_field(0, DepGraphs_4, 4))));
  MR_Word IntReachableModules_13;
  MR_Word ImpReachableModules_14;
  MR_Word IndirectReachableModules_15;
  MR_Word IndirectOptReachableModules_16;
  MR_Word TransOptReachableModules_17;
  MR_Word Var_18;
  MR_Word Var_19;
  MR_Word Var_20;
  MR_Word Var_21;
  MR_Word Var_22;
  MR_Word ModuleNameKey_25;
  MR_Word ReachableKeys_26;
  MR_Word ReachableModules_27;
  MR_Word Var_28;
  MR_Word ModuleNameKey_31;
  MR_Word ReachableKeys_32;
  MR_Word ReachableModules_33;
  MR_Word Var_34;
  MR_Word ModuleNameKey_37;
  MR_Word ReachableKeys_38;
  MR_Word ReachableModules_39;
  MR_Word Var_40;
  MR_Word ModuleNameKey_43;
  MR_Word ReachableKeys_44;
  MR_Word ReachableModules_45;
  MR_Word Var_46;
  MR_Word ModuleNameKey_49;
  MR_Word ReachableKeys_50;
  MR_Word ReachableModules_51;
  MR_Word Var_52;

  mercury__digraph__lookup_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_7, ((MR_Box) (ModuleName_5)), &ModuleNameKey_25);
  mercury__digraph__dfs_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntDepsGraph_7, ModuleNameKey_25, &ReachableKeys_26);
  {
    Var_28 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_28, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[1]));
    MR_hl_field(0, Var_28, 1) = ((MR_Box) (parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_1));
    MR_hl_field(0, Var_28, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_28, 3) = ((MR_Box) (IntDepsGraph_7));
  }
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_28, ReachableKeys_26, &ReachableModules_27);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ReachableModules_27, &IntReachableModules_13);
  mercury__digraph__lookup_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_8, ((MR_Box) (ModuleName_5)), &ModuleNameKey_31);
  mercury__digraph__dfs_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_8, ModuleNameKey_31, &ReachableKeys_32);
  {
    Var_34 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_34, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[1]));
    MR_hl_field(0, Var_34, 1) = ((MR_Box) (parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_2));
    MR_hl_field(0, Var_34, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_34, 3) = ((MR_Box) (ImpDepsGraph_8));
  }
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_34, ReachableKeys_32, &ReachableModules_33);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ReachableModules_33, &ImpReachableModules_14);
  mercury__digraph__lookup_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectDepsGraph_9, ((MR_Box) (ModuleName_5)), &ModuleNameKey_37);
  mercury__digraph__dfs_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectDepsGraph_9, ModuleNameKey_37, &ReachableKeys_38);
  {
    Var_40 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_40, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[1]));
    MR_hl_field(0, Var_40, 1) = ((MR_Box) (parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_3));
    MR_hl_field(0, Var_40, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_40, 3) = ((MR_Box) (IndirectDepsGraph_9));
  }
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_40, ReachableKeys_38, &ReachableModules_39);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ReachableModules_39, &IndirectReachableModules_15);
  mercury__digraph__lookup_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectOptDepsGraph_10, ((MR_Box) (ModuleName_5)), &ModuleNameKey_43);
  mercury__digraph__dfs_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IndirectOptDepsGraph_10, ModuleNameKey_43, &ReachableKeys_44);
  {
    Var_46 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_46, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[1]));
    MR_hl_field(0, Var_46, 1) = ((MR_Box) (parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_4));
    MR_hl_field(0, Var_46, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_46, 3) = ((MR_Box) (IndirectOptDepsGraph_10));
  }
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_46, ReachableKeys_44, &ReachableModules_45);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ReachableModules_45, &IndirectOptReachableModules_16);
  mercury__digraph__lookup_key_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), TransOptDepsGraph_11, ((MR_Box) (ModuleName_5)), &ModuleNameKey_49);
  mercury__digraph__dfs_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), TransOptDepsGraph_11, ModuleNameKey_49, &ReachableKeys_50);
  {
    Var_52 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_52, 0) = ((MR_Box) (&parse_tree__d_file_deps_scalar_common_3[1]));
    MR_hl_field(0, Var_52, 1) = ((MR_Box) (parse_tree__d_file_deps__compute_reachable_modules_from_dep_graphs_3_p_0_5));
    MR_hl_field(0, Var_52, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_52, 3) = ((MR_Box) (TransOptDepsGraph_11));
  }
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__d_file_deps_scalar_common_1[1]), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_52, ReachableKeys_50, &ReachableModules_51);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ReachableModules_51, &TransOptReachableModules_17);
  {
    Var_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_22, 0) = ((MR_Box) (TransOptReachableModules_17));
    MR_hl_field(1, Var_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_21, 0) = ((MR_Box) (IndirectOptReachableModules_16));
    MR_hl_field(1, Var_21, 1) = ((MR_Box) (Var_22));
  }
  {
    Var_20 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_20, 0) = ((MR_Box) (IndirectReachableModules_15));
    MR_hl_field(1, Var_20, 1) = ((MR_Box) (Var_21));
  }
  {
    Var_19 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_19, 0) = ((MR_Box) (ImpReachableModules_14));
    MR_hl_field(1, Var_19, 1) = ((MR_Box) (Var_20));
  }
  {
    Var_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_18, 0) = ((MR_Box) (IntReachableModules_13));
    MR_hl_field(1, Var_18, 1) = ((MR_Box) (Var_19));
  }
  *ReachableModules_6 = mercury__set__union_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_18);
}
