...
static /* final */ const MR_Box check_hlds__det_infer_goal_scalar_common_3[1][3] = {
  /* row   0 */
  {
    (MR_Box) (((((MR_Unsigned) 32U << 1)) | (MR_Unsigned) 1U)),
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(3, NestedSpec_36, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 32) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                MR_Word Var_201 = ((MR_Word) ((MR_hl_field(1, MaybePromiseEqvSolutionSets0_15, 0))));
                MR_Word Var_202;
                MR_Word Var_203;

                OldVars_40 = ((MR_Word) ((MR_hl_field(0, Var_201, 0))));
                PromiseContext_41 = ((MR_Word) ((MR_hl_field(0, Var_201, 1))));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__det_infer_goal__IntroducedFrom__pred__det_infer_atomic_goal__1685__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
