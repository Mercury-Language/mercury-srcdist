...
{
  {
    ...
    if ((parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_inst_3_p_0_env_0__succeeded)
    ...
    else
      {
        ...
        {
          (parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_inst_3_p_0_env_0__succeeded = parse_tree__prog_io_inst_mode_name__convert_inst_3_p_0((MR_Integer) 1, (parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_inst_3_p_0_env_0__InstTerm_5, &parse_tree__prog_io_mutable__Inst_11);
        }
        if ((parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_inst_3_p_0_env_0__succeeded)
          {
            MR_Word base;
...
{
  {
    ...
    if ((parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_type_3_p_0_env_0__succeeded)
    ...
    else
      {
        ...
        {
          parse_tree__prog_io_type_name__parse_type_4_p_0((parse_tree__prog_io_mutable__env).parse_tree__prog_io_mutable__parse_mutable_type_3_p_0_env_0__TypeTerm_5, parse_tree__prog_io_mutable__VarSet_4, parse_tree__prog_io_mutable__ContextPieces_11, parse_tree__prog_io_mutable__MaybeType_6);
        }
      }
  }
}
