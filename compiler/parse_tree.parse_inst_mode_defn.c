      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(1, NameSpec_80, 2) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(1, NameSpec_60, 2) = ((MR_Box) ((MR_Unsigned) 24U));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(1, NameSpec_81, 2) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      Var_67 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ForTypeTerm_17);
      {
        ...
        MR_hl_field(1, ForTypeSpec_26, 2) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(1, NameSpec_100, 2) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  MR_Word * MaybeArgVars_12)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      RepeatPieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_52, Var_58);
      {
        ...
        MR_hl_field(1, RepeatSpec_26, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    if (succeeded)
    {
      ...
      Var_103 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), BodyTerm_27);
      {
        ...
        MR_hl_field(1, FreeSpec_39, 2) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  else
  {
...

    {
      ...
      MR_hl_field(1, VarSpec_44, 2) = ((MR_Box) ((MR_Unsigned) 24U));
