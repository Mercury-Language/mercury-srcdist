  ...
  MR_Word * NameSpecs_6)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), NamePieces_8, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[47])));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[46])));
      }
      {
        NamePieces_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NamePieces_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[47])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), NameSpec_65, 2) = ((MR_Box) ((MR_Unsigned) 20U));
