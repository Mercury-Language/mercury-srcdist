...
{
  {
    ...
    if ((HeadTerms_9 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (Context_10));
        MR_hl_field(MR_mktag(0), Var_47, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[53])));
      }
      {
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (Context_10));
          MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[53])));
        }
        {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (HeadTermContext_20));
...
{
  {
    ...
    if ((HeadTerms_9 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (Context_10));
        MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[53])));
      }
      {
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (Context_10));
          MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[53])));
        }
        {
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          Var_63 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), InstDefnTerm_13);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[51])));
          }
          {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_90, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[52])));
      }
      {
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_124, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[44])));
      }
      {
