...
{
  {
    ...
    ContextPieces_15 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[47]))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          NamePieces_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          NameSpec_64 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), NameSpec_64, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), NameSpec_64, 1) = ((MR_Box) ((MR_Unsigned) 12U));
      ...
      else
      {
        ...
        Var_47 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_48, Var_49);
        Specs_50 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), NameSpecs_21, Var_47);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *MaybeIOM_14 = base;
...
{
  {
    ...
    parse_tree__parse_sym_name__parse_implicitly_qualified_sym_name_and_args_5_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ModuleName_7, HeadTerm_9, VarSet_8, ContextPieces_13, &MaybeNameAndArgs_14);
    if (((MR_tag((MR_Word) MaybeNameAndArgs_14)) == (MR_Integer) 0))
    {
    ...
    else
    {
      ...
      HeadTermContext_18 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), HeadTerm_9);
      ...
      if (succeeded)
      {
        ...
        {
          NamePieces_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          NameSpec_46 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), NameSpec_46, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), NameSpec_46, 1) = ((MR_Box) ((MR_Unsigned) 12U));
          MR_hl_field(MR_mktag(0), NameSpec_46, 2) = ((MR_Box) (Var_59));
        }
        {
          NameSpecs_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), NameSpecs_19, 0) = ((MR_Box) (NameSpec_46));
          MR_hl_field(MR_mktag(1), NameSpecs_19, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      }
      else
        NameSpecs_19 = (MR_Word) ((MR_Unsigned) 0U);
      parse_tree__parse_inst_mode_defn__check_inst_mode_defn_args_6_p_0((MR_String) "inst definition", VarSet_8, HeadTermContext_18, ArgTerms_17, (MR_Word) ((MR_Unsigned) 0U), &MaybeInstArgVars_20);
      succeeded = (NameSpecs_19 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) MaybeInstArgVars_20)) == (MR_Integer) 1);
        if (succeeded)
      ...
      if (succeeded)
      {
        ...
        mercury__varset__coerce_2_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), VarSet_8, &InstVarSet_22);
        {
          ...
          MR_hl_field(MR_mktag(0), ItemInstDefn_25, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), ItemInstDefn_25, 3) = ((MR_Box) ((MR_Unsigned) 0U));
...
{
  {
    ...
    ContextPieces_15 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[39]))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          InstDefn_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        Var_88 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ForTypeSpecs_23, Var_89);
        Specs_92 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), NameSpecs_33, Var_88);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *MaybeIOM_14 = base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) ArgVars_13)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) DupArgVars_19)) == (MR_Integer) 1);
          if (succeeded)
          {
          }
        }
      ...
      succeeded = ((MR_tag((MR_Word) MaybeBodyTerm_11)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) BodyVars_28)) == (MR_Integer) 1);
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) FreeVars_34)) == (MR_Integer) 1);
          if (succeeded)
          {
          }
        }
