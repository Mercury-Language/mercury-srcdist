  ...
  else
  {
    ...
    if ((Var_76 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        succeeded = parse_tree__parse_inst_mode_name__is_known_mode_name_1_p_0(Name_81);
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), NamePieces_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[47])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), NameSpec_83, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_inst_mode_defn.check_user_mode_name\'/3"));
  ...
  MR_Word * MaybeIOM_14)
{
  ...
  else
  {
    ...
    Name_61 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_18);
    succeeded = parse_tree__parse_inst_mode_name__is_known_mode_name_1_p_0(Name_61);
    if (succeeded)
    {
      MR_Word NamePieces_62;
      MR_Word NameSpec_63;
      MR_Word Var_66;
      MR_Word Var_67;

      {
        ...
        MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (Name_61));
      }
      {
        Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (Var_67));
        MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[46])));
      }
      {
        NamePieces_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NamePieces_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[47])));
        MR_hl_field(MR_mktag(1), NamePieces_62, 1) = ((MR_Box) (Var_66));
      }
      {
        NameSpec_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NameSpec_63, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_inst_mode_defn.check_user_mode_name\'/3"));
        MR_hl_field(MR_mktag(1), NameSpec_63, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), NameSpec_63, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), NameSpec_63, 3) = ((MR_Box) (HeadTermContext_20));
        MR_hl_field(MR_mktag(1), NameSpec_63, 4) = ((MR_Box) (NamePieces_62));
      }
      {
        NameSpecs_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NameSpecs_21, 0) = ((MR_Box) (NameSpec_63));
  ...
  MR_Word * NameSpecs_6)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_12, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_inst_mode_defn_scalar_common_1[46])));
    }
    {
      NamePieces_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), NamePieces_8, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_inst_mode_defn_scalar_common_1[44])));
