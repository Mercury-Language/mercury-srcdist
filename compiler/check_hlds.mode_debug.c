  ...
  MR_Word * STATE_VARIABLE_ModeInfo_30)
{
  ...
  else
  {
    ...
    UniquePrefix_15 = ((MR_String) ((MR_hl_field(0, DebugFlags_9, (MR_Integer) 0))));
    Verbose_16 = ((((MR_Unsigned) ((MR_hl_field(0, DebugFlags_9, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);
    Minimal_17 = ((((MR_Unsigned) ((MR_hl_field(0, DebugFlags_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    Statistics_18 = ((MR_Unsigned) ((MR_hl_field(0, DebugFlags_9, (MR_Integer) 1))) & (MR_Integer) 1);
    switch (Detail_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      else
      {
        ...
        switch (Minimal_6) {
          ...
          case (MR_Integer) 0:
            {
              mercury__io__write_string_4_p_0(Stream_1, (MR_String) " ::\n");
              hlds__hlds_out__hlds_out_mode__mercury_output_structured_inst_8_p_0(Stream_1, (MR_Integer) 1, InstVarSet_3, (MR_Integer) 0, (MR_Integer) 2, Inst_26);
            }
            break;
          case (MR_Integer) 1:
