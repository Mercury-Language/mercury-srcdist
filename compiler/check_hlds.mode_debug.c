...
MR_decl_label8(check_hlds__mode_debug__mode_checkpoint_6_0, 7,29,30,31,32,33,34,37)
MR_decl_label8(check_hlds__mode_debug__mode_checkpoint_6_0, 39,40,41,42,35,44,46,28)
MR_decl_label5(check_hlds__mode_debug__mode_checkpoint_6_0, 26,49,50,51,52)
...
MR_BEGIN_MODULE(check_hlds__mode_debug_module2)
	...
	MR_init_label8(check_hlds__mode_debug__mode_checkpoint_6_0,7,29,30,31,32,33,34,37)
	MR_init_label8(check_hlds__mode_debug__mode_checkpoint_6_0,39,40,41,42,35,44,46,28)
	MR_init_label5(check_hlds__mode_debug__mode_checkpoint_6_0,26,49,50,51,52)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,5)
	...
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(check_hlds__mode_debug__mode_checkpoint_6_0_i7);
	}
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,23)
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_last_checkpoint_insts_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i46);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),1)) {
		MR_GOTO_LAB(check_hlds__mode_debug__mode_checkpoint_6_0_i26);
	}
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__mode_debug__mode_checkpoint_6_0_i28);
	}
	MR_r1 = (MR_Word) MR_string_const("Exit ", 5);
	MR_np_call_localret_ent(io__write_string_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i29);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__write_string_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i30);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const(":\n", 2);
	MR_np_call_localret_ent(io__write_string_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i31);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(libs__file_util__maybe_report_stats_3_0,
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__mode_debug__mode_checkpoint_6_0_i35);
	}
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(hlds__instmap__instmap_to_assoc_list_2_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i39);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_last_checkpoint_insts_2_0,
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,40)
	...
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_varset_2_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i41);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_get_instvarset_2_0,
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,44)
	...
	MR_np_call_localret_ent(check_hlds__mode_info__mode_info_set_last_checkpoint_insts_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i46);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("\n", 1);
	MR_np_call_localret_ent(io__write_string_3_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i51);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,51)
	...
	MR_np_call_localret_ent(io__flush_output_2_0,
		check_hlds__mode_debug__mode_checkpoint_6_0_i52);
MR_def_label(check_hlds__mode_debug__mode_checkpoint_6_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
