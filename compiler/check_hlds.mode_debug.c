      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &ModuleInfo_68);
          hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_68, &Globals_69);
          hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_68, &ModuleName_70);
          libs__globals__get_debug_output_stream_5_p_0(Globals_69, ModuleName_70, &DebugStream_71);
          mercury__io__write_string_4_p_0(DebugStream_71, PortStr_10);
          mercury__io__write_string_4_p_0(DebugStream_71, UniquePrefix_15);
          mercury__io__write_string_4_p_0(DebugStream_71, Msg_6);
          mercury__io__write_string_4_p_0(DebugStream_71, (MR_String) ":\n");
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word DebugStream_67;

          check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &InstMap_19);
          check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &ModuleInfo_64);
          hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_64, &Globals_65);
          hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_64, &ModuleName_66);
          libs__globals__get_debug_output_stream_5_p_0(Globals_65, ModuleName_66, &DebugStream_67);
          mercury__io__write_string_4_p_0(DebugStream_67, PortStr_10);
          mercury__io__write_string_4_p_0(DebugStream_67, UniquePrefix_15);
          mercury__io__write_string_4_p_0(DebugStream_67, Msg_6);
          mercury__io__write_string_4_p_0(DebugStream_67, (MR_String) ":\n");
          libs__file_util__maybe_report_stats_4_p_0(DebugStream_67, Statistics_18);
          libs__file_util__maybe_flush_output_4_p_0(DebugStream_67, Statistics_18);
          ...
          if (succeeded)
          {
            ...
            check_hlds__mode_info__mode_info_get_instvarset_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &InstVarSet_28);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (VarTable_27));
            }
            check_hlds__mode_debug__write_var_insts_9_p_0(DebugStream_67, NewInsts_25, OldInstMap_26, Var_44, InstVarSet_28, Verbose_16, Minimal_17);
          }
          else
            mercury__io__write_string_4_p_0(DebugStream_67, (MR_String) "\tUnreachable\n");
          mercury__io__write_string_4_p_0(DebugStream_67, (MR_String) "\n");
          mercury__io__flush_output_3_p_0(DebugStream_67);
  ...
  MR_Word Minimal_7)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word Var_20;
      MR_Word Inst_21;
      MR_Word VarInsts_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
      MR_Word OldInst_29;
      MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word next_value_of_HeadVar__2_2;

      Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_32, (MR_Integer) 0))));
      Inst_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_32, (MR_Integer) 1))));
      hlds__instmap__instmap_lookup_var_3_p_0(OldInstMap_3, Var_20, &OldInst_29);
{
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (!(succeeded))
        succeeded = parse_tree__prog_data____Unify____mer_inst_0_0(Inst_21, OldInst_29);
      if (succeeded)
        switch (Verbose_6) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__parse_tree_out_term__mercury_output_var_src_6_p_0(VarNameSrc_4, (MR_Integer) 0, Var_20, Stream_1);
      ...
      else
      {
        ...
        switch (Minimal_7) {
          ...
          case (MR_Integer) 0:
            {
              mercury__io__write_string_4_p_0(Stream_1, (MR_String) " ::\n");
              hlds__hlds_out__hlds_out_mode__mercury_output_structured_inst_8_p_0(Stream_1, Inst_21, (MR_Integer) 2, (MR_Integer) 1, (MR_Integer) 0, InstVarSet_5);
            }
            break;
          case (MR_Integer) 1:
      ...
      ;
      next_value_of_HeadVar__2_2 = VarInsts_22;
