  ...
  MR_Word * STATE_VARIABLE_ModeInfo_13)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_ModeInfo_16_16;

    check_hlds__mode_debug__do_mode_checkpoint_6_p_0((MR_Integer) 2, (MR_String) "first goal", HeadWokenGoalInfo_11, DebugFlags_9, STATE_VARIABLE_ModeInfo_0_12, &STATE_VARIABLE_ModeInfo_16_16);
    check_hlds__mode_debug__mode_checkpoint_tail_wakeups_4_p_0(TailWokenGoals_6, DebugFlags_9, STATE_VARIABLE_ModeInfo_16_16, STATE_VARIABLE_ModeInfo_13);
  }
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__mode_debug__do_mode_checkpoint_6_p_0((MR_Integer) 2, (MR_String) "later goal", WokenGoalInfo_14, DebugFlags_2, STATE_VARIABLE_ModeInfo_0_3, &STATE_VARIABLE_ModeInfo_19_19);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = WokenGoals_10;
      next_value_of_STATE_VARIABLE_ModeInfo_0_3 = STATE_VARIABLE_ModeInfo_19_19;
