...
MR_decl_entry(hlds__hlds_out__hlds_out_mode__mercury_output_structured_inst_7_0);
...
MR_def_label(check_hlds__mode_debug__write_var_insts_8_0,25)
	...
	MR_r4 = (MR_Integer) 0;
	MR_r5 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_out__hlds_out_mode__mercury_output_structured_inst_7_0,
		check_hlds__mode_debug__write_var_insts_8_0_i26);
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_4_0,4)
	...
	MR_sv(1) = ((MR_Integer) MR_tfield(0, MR_r2, 0) & (MR_Integer) 1);
	MR_sv(2) = (((MR_Integer) MR_tfield(0, MR_r2, 0) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(6) = (((MR_Integer) MR_tfield(0, MR_r2, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_r1 = MR_sv(8);
...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_4_0,5)
	...
	MR_sv(4) = (MR_Word) MR_string_const("Enter ", 6);
...
void mercury__check_hlds__mode_debug__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__check_hlds__mode_debug);
