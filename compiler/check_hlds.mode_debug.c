        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              check_hlds__mode_info__mode_info_get_varset_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &VarSet_27);
              check_hlds__mode_info__mode_info_get_instvarset_2_p_0(STATE_VARIABLE_ModeInfo_0_29, &InstVarSet_28);
              check_hlds__mode_debug__write_var_insts_9_p_0(DebugStream_66, NewInsts_25, OldInstMap_26, VarSet_27, InstVarSet_28, Verbose_16, Minimal_17);
            }
            else
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__parse_tree_out_term__mercury_output_var_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_4, (MR_Integer) 0, Var_20, Stream_1);
