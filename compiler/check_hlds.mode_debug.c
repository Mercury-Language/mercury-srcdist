...
MR_def_label(check_hlds__mode_debug__mode_checkpoint_4_0,4)
	...
	MR_sv(3) = ((MR_Integer) MR_tfield(0, MR_r2, 0) & (MR_Integer) 1);
	MR_sv(4) = (((MR_Integer) MR_tfield(0, MR_r2, 0) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(5) = (((MR_Integer) MR_tfield(0, MR_r2, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_r1 = MR_sv(8);
