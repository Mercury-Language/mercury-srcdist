...
{
  {
    ...
    if ((DebugModes_8 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 0)));

      Verbose_9 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 0))) & (MR_Integer) 1);
      Minimal_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      Statistics_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
      ...
      switch (Port_5) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          if ((Errors_12 == (MR_Word) ((MR_Integer) 0)))
          {
