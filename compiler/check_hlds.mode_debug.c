  ...
  MR_Word * STATE_VARIABLE_ModeInfo_30)
{
  ...
  UniquePrefix_15 = ((MR_String) ((MR_hl_field(0, DebugFlags_8, 0))));
  Verbose_16 = ((((MR_Unsigned) ((MR_hl_field(0, DebugFlags_8, 1))) >> 2)) & (MR_Integer) 1);
  Minimal_17 = ((((MR_Unsigned) ((MR_hl_field(0, DebugFlags_8, 1))) >> 1)) & (MR_Integer) 1);
  Statistics_18 = ((MR_Unsigned) ((MR_hl_field(0, DebugFlags_8, 1))) & (MR_Integer) 1);
  switch (Detail_11) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
