      ...
      case (MR_Integer) 2:
        {
          ...
          *STATE_VARIABLE_UrInfo_97 = ((MR_Word) (conv3_STATE_VARIABLE_UrInfo_97));
          ...
          hlds__hlds_goal__conj_list_to_goal_3_p_0(HLDSConjuncts_354, GoalInfo_355, HLDSGoal_12);
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 2:
            {
              ...
              hlds__hlds_goal__disj_list_to_goal_3_p_0(Disjuncts_428, GoalInfo_429, HLDSGoal_12);
            }
            break;
          case (MR_Integer) 3:
            {
          ...
          case (MR_Integer) 5:
            {
              ...
              *STATE_VARIABLE_UrInfo_97 = ((MR_Word) (conv13_STATE_VARIABLE_UrInfo_97));
              ...
              hlds__hlds_goal__par_conj_list_to_goal_3_p_0(HLDSConjuncts_525, GoalInfo_526, HLDSGoal_12);
            }
            break;
          case (MR_Integer) 6:
            {
