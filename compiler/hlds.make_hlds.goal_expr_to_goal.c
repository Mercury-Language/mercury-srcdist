          ...
          case (MR_Integer) 14:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals0_635, (MR_Integer) 58, &WarnOccursCheck0_636);
                libs__globals__set_option_4_p_0((MR_Integer) 58, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_3[5])), Globals0_635, &Globals1_637);
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 58, Var_656, Globals2_639, &Globals3_640);
