            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    GenericCall_478 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), GenericCall_478, 0) = ((MR_Box) (PredVar_473));
                    MR_hl_field(MR_mktag(1), GenericCall_478, 1) = (MR_Box) (((((MR_Unsigned) (Purity_451) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
                    MR_hl_field(MR_mktag(1), GenericCall_478, 2) = ((MR_Box) (Arity_472));
                  }
                  {
          ...
          case (MR_Integer) 20:
            {
              ...
              {
                Details_787 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Details_787, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), Details_787, 1) = ((MR_Box) (EventName_779));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_799, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), Var_799, 1) = ((MR_Box) (EventName_779));
              }
              {
