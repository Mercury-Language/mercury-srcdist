  ...
  MR_Word * STATE_VARIABLE_Specs_116)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Goal_18)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Context_1195 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 0))));
          MR_Word TermA0_1196 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 1))));
          MR_Word TermB0_1197 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 2))));
          MR_Word Purity_1198 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 3))) & (MR_Integer) 3);
          MR_Word TermA_1199;
          MR_Word TermB_1200;
          MR_Word StateVarA_1201;
          MR_Word Var_1211;
          MR_String Var_1212;
          MR_Word Var_1213;
          MR_Word Var_1214;
          ...
          parse_tree__prog_rename__rename_vars_in_term_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, TermA0_1196, &TermA_1199);
          parse_tree__prog_rename__rename_vars_in_term_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, TermB0_1197, &TermB_1200);
          succeeded = ((MR_tag((MR_Word) TermA_1199)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_1211 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermA_1199, (MR_Integer) 0))));
            Var_1213 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermA_1199, (MR_Integer) 1))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                      StateVarA_1201 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1214, (MR_Integer) 0))));
                  }
                }
              }
            }
          ...
          if (succeeded)
          {
            MR_Word STATE_VARIABLE_VarSet_60_1216;
            MR_Word STATE_VARIABLE_SVarState_61_1217;
            MR_Word STATE_VARIABLE_Specs_62_1218;
            MR_Word StateVarB_1204;
            MR_Word Var_1219;
            MR_String Var_1220;
            MR_Word Var_1221;
            MR_Word Var_1222;
            ...
            hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1195, StateVarA_1201, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_60_1216, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_61_1217, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_62_1218);
            succeeded = ((MR_tag((MR_Word) TermB_1200)) == (MR_Integer) 0);
            if (succeeded)
            {
              Var_1219 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1200, (MR_Integer) 0))));
              Var_1221 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1200, (MR_Integer) 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                        StateVarB_1204 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1222, (MR_Integer) 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
              hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1195, StateVarB_1204, STATE_VARIABLE_VarSet_60_1216, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_61_1217, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_Specs_62_1218, STATE_VARIABLE_Specs_116);
            else
            {
              *STATE_VARIABLE_Specs_116 = STATE_VARIABLE_Specs_62_1218;
              *STATE_VARIABLE_VarSet_110 = STATE_VARIABLE_VarSet_60_1216;
              *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_61_1217;
            }
            *HLDSGoal_20 = hlds__make_goal__true_goal_with_context_1_f_0(Context_1195);
          ...
          else
          {
            ...
            if (succeeded)
            {
              Var_1227 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1200, (MR_Integer) 0))));
              Var_1229 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1200, (MR_Integer) 1))));
              succeeded = ((MR_tag((MR_Word) Var_1227)) == (MR_Integer) 0);
              if (succeeded)
              {
                Var_1228 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_1227, (MR_Integer) 0))));
                succeeded = (strcmp(Var_1228, (MR_String) "!") == 0);
                if (succeeded)
                {
                  succeeded = (Var_1229 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    Var_1230 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1229, (MR_Integer) 0))));
                    Var_1231 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1229, (MR_Integer) 1))));
                    succeeded = (Var_1231 == (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      succeeded = ((MR_tag((MR_Word) Var_1230)) == (MR_Integer) 1);
                      if (succeeded)
                        StateVarB_1244 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1230, (MR_Integer) 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
            {
              hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1195, StateVarB_1244, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
            ...
            {
              MR_Word STATE_VARIABLE_SVarState_81_1237;

              hlds__make_hlds__superhomogeneous__unravel_unification_19_p_0(TermA_1199, TermB_1200, Context_1195, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Purity_1198, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_81_1237, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              hlds__make_hlds__state_var__svar_finish_atomic_goal_3_p_0(LocKind_17, STATE_VARIABLE_SVarState_81_1237, STATE_VARIABLE_SVarState_106);
            }
          }
        }
        break;
          ...
          else
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), LHSTerm_556, 0) = ((MR_Box) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_3[0]));
                MR_hl_field(MR_mktag(0), LHSTerm_556, 1) = ((MR_Box) (StateVarNameTerms_460));
                MR_hl_field(MR_mktag(0), LHSTerm_556, 2) = ((MR_Box) (StateVarContext_461));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), RHSTerm_557, 0) = ((MR_Box) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_3[2]));
                MR_hl_field(MR_mktag(0), RHSTerm_557, 1) = ((MR_Box) (Var_521));
                MR_hl_field(MR_mktag(0), RHSTerm_557, 2) = ((MR_Box) (Context_447));
              }
              {
                TransformedGoal_558 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TransformedGoal_558, 0) = ((MR_Box) (Context_447));
                ...
                MR_hl_field(MR_mktag(0), TransformedGoal_558, 3) = (MR_Box) ((MR_Unsigned) (Purity_450));
              }
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, TransformedGoal_558, Renaming_19, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_84_492, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
            }
            else
            {
              ...
              else
              {
                ...
                MR_Integer PredFormArityInt_472;
                ...
                MR_Word STATE_VARIABLE_QualInfo_139_547;
                MR_Word Var_548;
                ...
                parse_tree__prog_rename__rename_vars_in_term_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, ArgTerms1_451, &ArgTerms_559);
                hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_9_p_0(ArgTerms_559, &HeadVars_469, &HeadVarsArgTerms_470, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_130_538, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_131_539, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_132_540);
                PredFormArity_471 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_1[0]), ArgTerms_559);
                PredFormArityInt_472 = (MR_Integer) (PredFormArity_471);
                succeeded = ((MR_tag((MR_Word) SymName_448)) == (MR_Integer) 0);
                if (succeeded)
                {
                  Var_566 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName_448, (MR_Integer) 0))));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      PredVar_473 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVars_469, (MR_Integer) 0))));
                      RealHeadVars_474 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVars_469, (MR_Integer) 1))));
                    }
                  }
                }
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), GenericCall_478, 1) = (MR_Box) (((((MR_Unsigned) (Purity_450) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
                    MR_hl_field(MR_mktag(0), GenericCall_478, 2) = ((MR_Box) (PredFormArityInt_472));
                  }
                  {
                ...
                else
                {
                  ...
                  ModeId_483 = hlds__hlds_pred__invalid_proc_id_0_f_0();
                  {
                    ...
                    MR_hl_field(MR_mktag(2), GoalExpr_479, 2) = ((MR_Box) (HeadVars_469));
                    ...
                    MR_hl_field(MR_mktag(2), GoalExpr_479, 5) = ((MR_Box) (SymName_448));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), PFSymNameArity_485, 1) = ((MR_Box) (SymName_448));
                    MR_hl_field(MR_mktag(0), PFSymNameArity_485, 2) = ((MR_Box) (PredFormArity_471));
                  }
                  {
                ...
                hlds__hlds_goal__goal_info_init_context_purity_3_p_0(Context_447, Purity_450, &GoalInfo_486);
                {
                ...
                hlds__make_hlds__qual_info__record_called_pred_or_func_5_p_0((MR_Integer) 0, SymName_448, PredFormArityInt_472, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_139_547);
                {
                ...
                hlds__make_hlds__superhomogeneous__insert_arg_unifications_17_p_0(HeadVarsArgTerms_470, Context_447, Var_548, HLDSGoal0_487, HLDSGoal_20, STATE_VARIABLE_SVarState_131_539, &STATE_VARIABLE_SVarState_84_492, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_130_538, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_139_547, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_132_540, STATE_VARIABLE_Specs_116);
              }
            }
          }
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Globals_847;
              MR_Word ModuleName_848;
              MR_Word AfterThenSVarState_849;
              MR_Word HLDSElse0_850;
              MR_Word AfterElseSVarState_851;
              MR_Word HLDSThen_852;
              MR_Word HLDSElse_853;
              MR_Word GoalExpr_854;
              MR_Word GoalInfo_855;
              MR_Word STATE_VARIABLE_Specs_64_858;
              MR_Word STATE_VARIABLE_SVarStore_65_859;
              MR_Word STATE_VARIABLE_VarSet_66_860;
              MR_Word STATE_VARIABLE_ModuleInfo_67_861;
              MR_Word STATE_VARIABLE_QualInfo_68_862;
              MR_Word STATE_VARIABLE_Specs_69_863;
              MR_Word STATE_VARIABLE_SVarStore_70_864;
              MR_Word STATE_VARIABLE_VarSet_71_865;
              MR_Word STATE_VARIABLE_ModuleInfo_72_866;
              MR_Word STATE_VARIABLE_QualInfo_73_867;
              MR_Word STATE_VARIABLE_Specs_74_868;
              MR_Word STATE_VARIABLE_SVarStore_75_869;
              MR_Word STATE_VARIABLE_VarSet_76_870;
              MR_Word STATE_VARIABLE_Specs_79_873;
              ...
              hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_833, STATE_VARIABLE_VarSet_0_109, StateVars_841, STATE_VARIABLE_SVarState_0_105, &BeforeCondSVarState_842, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_64_858);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Cond_836, Renaming_19, &HLDSCond_843, BeforeCondSVarState_842, &AfterCondSVarState_844, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_65_859, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_66_860, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_67_861, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_68_862, STATE_VARIABLE_Specs_64_858, &STATE_VARIABLE_Specs_69_863);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Then_837, Renaming_19, &HLDSThen0_845, AfterCondSVarState_844, &AfterThenSVarState0_846, STATE_VARIABLE_SVarStore_65_859, &STATE_VARIABLE_SVarStore_70_864, STATE_VARIABLE_VarSet_66_860, &STATE_VARIABLE_VarSet_71_865, STATE_VARIABLE_ModuleInfo_67_861, &STATE_VARIABLE_ModuleInfo_72_866, STATE_VARIABLE_QualInfo_68_862, &STATE_VARIABLE_QualInfo_73_867, STATE_VARIABLE_Specs_69_863, &STATE_VARIABLE_Specs_74_868);
              hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_72_866, &Globals_847);
              hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_72_866, &ModuleName_848);
              hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_847, ModuleName_848, StateVars_841, STATE_VARIABLE_SVarState_0_105, AfterThenSVarState0_846, &AfterThenSVarState_849);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Else_838, Renaming_19, &HLDSElse0_850, STATE_VARIABLE_SVarState_0_105, &AfterElseSVarState_851, STATE_VARIABLE_SVarStore_70_864, &STATE_VARIABLE_SVarStore_75_869, STATE_VARIABLE_VarSet_71_865, &STATE_VARIABLE_VarSet_76_870, STATE_VARIABLE_ModuleInfo_72_866, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_73_867, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_74_868, &STATE_VARIABLE_Specs_79_873);
              hlds__make_hlds__state_var__svar_finish_if_then_else_20_p_0(Globals_847, ModuleName_848, LocKind_17, Context_833, StateVars_841, HLDSThen0_845, &HLDSThen_852, HLDSElse0_850, &HLDSElse_853, STATE_VARIABLE_SVarState_0_105, AfterCondSVarState_844, AfterThenSVarState_849, AfterElseSVarState_851, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_VarSet_76_870, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarStore_75_869, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_Specs_79_873, STATE_VARIABLE_Specs_116);
              {
                GoalExpr_854 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_854, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                MR_hl_field(MR_mktag(3), GoalExpr_854, 1) = ((MR_Box) (Vars_840));
                MR_hl_field(MR_mktag(3), GoalExpr_854, 2) = ((MR_Box) (HLDSCond_843));
                MR_hl_field(MR_mktag(3), GoalExpr_854, 3) = ((MR_Box) (HLDSThen_852));
                MR_hl_field(MR_mktag(3), GoalExpr_854, 4) = ((MR_Box) (HLDSElse_853));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_833, &GoalInfo_855);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_854));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_855));
              }
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            {
              MR_Word Context_901 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word SubGoal_902 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word HLDSSubGoal_904;
              MR_Word GoalExpr_906;
              MR_Word GoalInfo_907;
              MR_Word Var_905;

              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_902, Renaming_19, &HLDSSubGoal_904, STATE_VARIABLE_SVarState_0_105, &Var_905, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_0_105;
              GoalExpr_906 = (MR_Word) ((MR_Word) (HLDSSubGoal_904));
              hlds__hlds_goal__goal_info_init_2_p_0(Context_901, &GoalInfo_907);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_906));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_907));
              }
            }
            break;
          case (MR_Integer) 4:
          ...
          case (MR_Integer) 5:
            {
              MR_Word Context_936 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word SubGoalA_937 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word SubGoalB_938 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word HLDSConjunctsCordA_939;
              MR_Word HLDSConjunctsCordAB_940;
              MR_Word HLDSConjuncts_941;
              MR_Word GoalInfo_942;
              MR_Word Var_943;
              MR_Word STATE_VARIABLE_SVarState_47_944;
              MR_Word STATE_VARIABLE_SVarStore_48_945;
              MR_Word STATE_VARIABLE_VarSet_49_946;
              MR_Word STATE_VARIABLE_ModuleInfo_50_947;
              MR_Word STATE_VARIABLE_QualInfo_51_948;
              MR_Word STATE_VARIABLE_Specs_52_949;

              Var_943 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
              hlds__make_hlds__goal_expr_to_goal__accumulate_par_conjuncts_17_p_0(LocKind_17, SubGoalA_937, Renaming_19, Var_943, &HLDSConjunctsCordA_939, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_47_944, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_48_945, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_49_946, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_50_947, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_51_948, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_52_949);
              hlds__make_hlds__goal_expr_to_goal__accumulate_par_conjuncts_17_p_0(LocKind_17, SubGoalB_938, Renaming_19, HLDSConjunctsCordA_939, &HLDSConjunctsCordAB_940, STATE_VARIABLE_SVarState_47_944, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_48_945, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_49_946, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_50_947, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_51_948, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_52_949, STATE_VARIABLE_Specs_116);
              HLDSConjuncts_941 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), HLDSConjunctsCordAB_940);
              hlds__hlds_goal__goal_info_init_2_p_0(Context_936, &GoalInfo_942);
              hlds__hlds_goal__par_conj_list_to_goal_3_p_0(HLDSConjuncts_941, GoalInfo_942, HLDSGoal_20);
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Word QuantType_979 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              MR_Word VarsKind_980 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))) & (MR_Integer) 1);
              MR_Word Context_981 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word Vars0_982 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word SubGoal_983 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));

              switch (QuantType_979) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_Word TransformedGoal_984;
                    MR_Word Var_1012;
                    MR_Word Var_1014;
                    MR_Word next_value_of_Goal_18;

                    {
                      Var_1014 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_1014, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                      MR_hl_field(MR_mktag(3), Var_1014, 1) = ((MR_Box) (Context_981));
                      MR_hl_field(MR_mktag(3), Var_1014, 2) = ((MR_Box) (SubGoal_983));
                    }
                    {
                      Var_1012 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_1012, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                      MR_hl_field(MR_mktag(3), Var_1012, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (VarsKind_980)));
                      MR_hl_field(MR_mktag(3), Var_1012, 2) = ((MR_Box) (Context_981));
                      MR_hl_field(MR_mktag(3), Var_1012, 3) = ((MR_Box) (Vars0_982));
                      MR_hl_field(MR_mktag(3), Var_1012, 4) = ((MR_Box) (Var_1014));
                    }
                    {
                      TransformedGoal_984 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), TransformedGoal_984, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                      MR_hl_field(MR_mktag(3), TransformedGoal_984, 1) = ((MR_Box) (Context_981));
                      MR_hl_field(MR_mktag(3), TransformedGoal_984, 2) = ((MR_Box) (Var_1012));
                    }
                    // direct tailcall eliminated
                    ;
                    next_value_of_Goal_18 = TransformedGoal_984;
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word Vars_985;
                    MR_Word HLDSSubGoal_986;
                    MR_Word Reason_987;
                    MR_Word GoalExpr_995;
                    MR_Word GoalInfo_996;

                    parse_tree__prog_rename__rename_var_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, Vars0_982, &Vars_985);
                    switch (VarsKind_980) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        {
                          hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_983, Renaming_19, &HLDSSubGoal_986, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
                          {
                            Reason_987 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Reason_987, 0) = ((MR_Box) (Vars_985));
                          }
                        }
                        break;
                      case (MR_Integer) 1:
                        {
                          MR_Word BeforeInsideSVarState_990;
                          MR_Word AfterInsideSVarState_991;
                          MR_Word Globals_992;
                          MR_Word ModuleName_993;
                          MR_Word STATE_VARIABLE_Specs_58_998;

                          hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_981, STATE_VARIABLE_VarSet_0_109, Vars_985, STATE_VARIABLE_SVarState_0_105, &BeforeInsideSVarState_990, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_58_998);
                          hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_983, Renaming_19, &HLDSSubGoal_986, BeforeInsideSVarState_990, &AfterInsideSVarState_991, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_58_998, STATE_VARIABLE_Specs_116);
                          hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &Globals_992);
                          hlds__hlds_module__module_info_get_name_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &ModuleName_993);
                          hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_992, ModuleName_993, Vars_985, STATE_VARIABLE_SVarState_0_105, AfterInsideSVarState_991, STATE_VARIABLE_SVarState_106);
                          Reason_987 = (MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_3[3]);
                        }
                        break;
                    }
                    {
                      GoalExpr_995 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), GoalExpr_995, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                      MR_hl_field(MR_mktag(3), GoalExpr_995, 1) = ((MR_Box) (Reason_987));
                      MR_hl_field(MR_mktag(3), GoalExpr_995, 2) = ((MR_Box) (HLDSSubGoal_986));
                    }
                    hlds__hlds_goal__goal_info_init_2_p_0(Context_981, &GoalInfo_996);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      *HLDSGoal_20 = base;
                      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_995));
                      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_996));
                    }
                  }
                  break;
              }
          ...
          case (MR_Integer) 14:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals0_636, (MR_Integer) 61, &WarnOccursCheck0_637);
                libs__globals__set_option_4_p_0((MR_Integer) 61, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_3[5])), Globals0_636, &Globals1_638);
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 61, Var_657, Globals2_640, &Globals3_641);
          ...
          case (MR_Integer) 15:
            {
              MR_Word Context_1044 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word MaybeCompileTime_1045 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word MaybeRunTime_1046 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word MaybeIO0_1047 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));
              MR_Word Mutables0_1048 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 5))));
              MR_Word SubGoal0_1049 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 6))));
              MR_Word MutableHLDSs_1050;
              MR_Word MutableStateVars_1051;
              MR_Word MutableGetGoals_1052;
              MR_Word MutableSetGoals_1053;
              MR_Word MaybeIOHLDS_1059;
              MR_Word StateVars_1060;
              MR_Word GetGoals_1061;
              MR_Word SetGoals_1062;
              MR_Word SubGoal1_1063;
              MR_Word BeforeInsideSVarState_1065;
              MR_Word HLDSSubGoal_1066;
              MR_Word AfterInsideSVarState_1067;
              MR_Word Globals_1068;
              MR_Word ModuleName_1069;
              MR_Word Reason_1071;
              MR_Word GoalExpr_1072;
              MR_Word GoalInfo_1073;
              MR_Word Var_1074;
              MR_Word Var_1075;
              MR_Word Var_1076;
              MR_Word Var_1077;
              MR_Word STATE_VARIABLE_Specs_74_1079;
              MR_Word STATE_VARIABLE_QualInfo_78_1083;

              {
                Var_1074 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_1074, 0) = ((MR_Box) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_5[0]));
                MR_hl_field(MR_mktag(0), Var_1074, 1) = ((MR_Box) (hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0_1));
                MR_hl_field(MR_mktag(0), Var_1074, 2) = ((MR_Box) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(0), Var_1074, 3) = ((MR_Box) (Context_1044));
                MR_hl_field(MR_mktag(0), Var_1074, 4) = ((MR_Box) (STATE_VARIABLE_VarSet_0_109));
                MR_hl_field(MR_mktag(0), Var_1074, 5) = ((MR_Box) (Renaming_19));
              }
              mercury__list__map4_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trace_mutable_var_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_trace_mutable_var_hlds_0), (MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), Var_1074, Mutables0_1048, &MutableHLDSs_1050, &MutableStateVars_1051, &MutableGetGoals_1052, &MutableSetGoals_1053);
              if ((MaybeIO0_1047 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                MaybeIOHLDS_1059 = (MR_Word) ((MR_Unsigned) 0U);
                StateVars_1060 = MutableStateVars_1051;
                GetGoals_1061 = MutableGetGoals_1052;
                SetGoals_1062 = MutableSetGoals_1053;
              }
              else
              {
                MR_Word IOStateVar0_1054 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIO0_1047, (MR_Integer) 0))));
                MR_Word IOStateVar_1055;
                MR_String IOStateVarName_1056;
                MR_Word IOGetGoal_1057;
                MR_Word IOSetGoal_1058;

                hlds__make_hlds__goal_expr_to_goal__extract_trace_io_var_8_p_0(Context_1044, STATE_VARIABLE_VarSet_0_109, Renaming_19, IOStateVar0_1054, &IOStateVar_1055, &IOStateVarName_1056, &IOGetGoal_1057, &IOSetGoal_1058);
                {
                  MaybeIOHLDS_1059 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybeIOHLDS_1059, 0) = ((MR_Box) (IOStateVarName_1056));
                }
                {
                  StateVars_1060 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), StateVars_1060, 0) = ((MR_Box) (IOStateVar_1055));
                  MR_hl_field(MR_mktag(1), StateVars_1060, 1) = ((MR_Box) (MutableStateVars_1051));
                }
                {
                  GetGoals_1061 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), GetGoals_1061, 0) = ((MR_Box) (IOGetGoal_1057));
                  MR_hl_field(MR_mktag(1), GetGoals_1061, 1) = ((MR_Box) (MutableGetGoals_1052));
                }
                {
                  SetGoals_1062 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), SetGoals_1062, 0) = ((MR_Box) (IOSetGoal_1058));
                  MR_hl_field(MR_mktag(1), SetGoals_1062, 1) = ((MR_Box) (MutableSetGoals_1053));
                }
              }
              {
                Var_1077 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_1077, 0) = ((MR_Box) (SubGoal0_1049));
                MR_hl_field(MR_mktag(1), Var_1077, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              Var_1076 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), Var_1077, SetGoals_1062);
              Var_1075 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), GetGoals_1061, Var_1076);
              SubGoal1_1063 = parse_tree__prog_util__goal_list_to_conj_2_f_0(Context_1044, Var_1075);
              hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_1044, STATE_VARIABLE_VarSet_0_109, StateVars_1060, STATE_VARIABLE_SVarState_0_105, &BeforeInsideSVarState_1065, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_74_1079);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal1_1063, Renaming_19, &HLDSSubGoal_1066, BeforeInsideSVarState_1065, &AfterInsideSVarState_1067, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_78_1083, STATE_VARIABLE_Specs_74_1079, STATE_VARIABLE_Specs_116);
              hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &Globals_1068);
              hlds__hlds_module__module_info_get_name_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &ModuleName_1069);
              hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_1068, ModuleName_1069, StateVars_1060, STATE_VARIABLE_SVarState_0_105, AfterInsideSVarState_1067, STATE_VARIABLE_SVarState_106);
              hlds__make_hlds__qual_info__qual_info_set_found_trace_goal_3_p_0((MR_Integer) 1, STATE_VARIABLE_QualInfo_78_1083, STATE_VARIABLE_QualInfo_114);
              {
                Reason_1071 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Reason_1071, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(MR_mktag(3), Reason_1071, 1) = ((MR_Box) (MaybeCompileTime_1045));
                MR_hl_field(MR_mktag(3), Reason_1071, 2) = ((MR_Box) (MaybeRunTime_1046));
                MR_hl_field(MR_mktag(3), Reason_1071, 3) = ((MR_Box) (MaybeIOHLDS_1059));
                MR_hl_field(MR_mktag(3), Reason_1071, 4) = ((MR_Box) (MutableHLDSs_1050));
                MR_hl_field(MR_mktag(3), Reason_1071, 5) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                GoalExpr_1072 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_1072, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                MR_hl_field(MR_mktag(3), GoalExpr_1072, 1) = ((MR_Box) (Reason_1071));
                MR_hl_field(MR_mktag(3), GoalExpr_1072, 2) = ((MR_Box) (HLDSSubGoal_1066));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_1044, &GoalInfo_1073);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_1072));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_1073));
              }
            }
            break;
          case (MR_Integer) 16:
            {
              ...
              if (((MR_tag((MR_Word) Outer0_324)) == (MR_Integer) 0))
              {
                ...
                else
                {
                  ...
                  MR_Word InnerDI_418;
                  MR_Word InnerUO_419;
                  MR_Word HLDSMainGoal0_1330;
                  MR_Word AfterMainSVarState_1331;
                  MR_Word MainDisjState_1332;
                  MR_Word OrElseDisjStates_1333;
                  MR_Word AllDisjStates_1334;
                  MR_Word STATE_VARIABLE_SVarStore_98_1337;
                  MR_Word STATE_VARIABLE_VarSet_99_1338;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1339;
                  MR_Word STATE_VARIABLE_QualInfo_101_1340;
                  MR_Word STATE_VARIABLE_Specs_102_1341;
                  MR_Word STATE_VARIABLE_SVarStore_103_1342;
                  MR_Word STATE_VARIABLE_VarSet_104_1343;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1330, STATE_VARIABLE_SVarState_91_375, &AfterMainSVarState_1331, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1337, STATE_VARIABLE_VarSet_92_376, &STATE_VARIABLE_VarSet_99_1338, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1339, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1340, STATE_VARIABLE_Specs_93_377, &STATE_VARIABLE_Specs_102_1341);
                  {
                    MainDisjState_1332 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1332, 0) = ((MR_Box) (HLDSMainGoal0_1330));
                    MR_hl_field(MR_mktag(0), MainDisjState_1332, 1) = ((MR_Box) (AfterMainSVarState_1331));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1333, STATE_VARIABLE_SVarState_91_375, STATE_VARIABLE_SVarStore_98_1337, &STATE_VARIABLE_SVarStore_103_1342, STATE_VARIABLE_VarSet_99_1338, &STATE_VARIABLE_VarSet_104_1343, STATE_VARIABLE_ModuleInfo_100_1339, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1340, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1341, STATE_VARIABLE_Specs_116);
                  {
                    AllDisjStates_1334 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1334, 0) = ((MR_Box) (MainDisjState_1332));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1334, 1) = ((MR_Box) (OrElseDisjStates_1333));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1334, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1343, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_91_375, &STATE_VARIABLE_SVarState_117_401, STATE_VARIABLE_SVarStore_103_1342, STATE_VARIABLE_SVarStore_108);
              ...
              else
              {
                ...
                if (((MR_tag((MR_Word) Inner0_325)) == (MR_Integer) 0))
                {
                  MR_Word InnerStateVar0_1247 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Inner0_325, (MR_Integer) 0))));
                  MR_Word InnerStateVar_1248;
                  MR_Word InnerScopeInfo2_1259;
                  MR_Word InnerDI_1260;
                  MR_Word InnerUO_1261;
                  MR_Word BeforeDisjSVarState_1291;
                  MR_Word HLDSMainGoal0_1292;
                  MR_Word AfterMainSVarState_1293;
                  MR_Word MainDisjState_1294;
                  MR_Word OrElseDisjStates_1295;
                  MR_Word AllDisjStates_1296;
                  MR_Word STATE_VARIABLE_VarSet_96_1306;
                  MR_Word STATE_VARIABLE_Specs_97_1307;
                  MR_Word STATE_VARIABLE_SVarStore_98_1308;
                  MR_Word STATE_VARIABLE_VarSet_99_1309;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1310;
                  MR_Word STATE_VARIABLE_QualInfo_101_1311;
                  MR_Word STATE_VARIABLE_Specs_102_1312;
                  MR_Word STATE_VARIABLE_SVarStore_103_1313;
                  MR_Word STATE_VARIABLE_VarSet_104_1314;
                  MR_Word STATE_VARIABLE_Specs_107_1315;
                  MR_Word STATE_VARIABLE_VarSet_108_1316;
                  MR_Word STATE_VARIABLE_SVarState_109_1317;

                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerStateVar0_1247, &InnerStateVar_1248);
                  hlds__make_hlds__state_var__svar_start_inner_atomic_scope_9_p_0(Context_323, InnerStateVar_1248, &InnerScopeInfo2_1259, STATE_VARIABLE_SVarState_0_105, &BeforeDisjSVarState_1291, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_96_1306, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_97_1307);
                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1292, BeforeDisjSVarState_1291, &AfterMainSVarState_1293, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1308, STATE_VARIABLE_VarSet_96_1306, &STATE_VARIABLE_VarSet_99_1309, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1310, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1311, STATE_VARIABLE_Specs_97_1307, &STATE_VARIABLE_Specs_102_1312);
                  {
                    MainDisjState_1294 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1294, 0) = ((MR_Box) (HLDSMainGoal0_1292));
                    MR_hl_field(MR_mktag(0), MainDisjState_1294, 1) = ((MR_Box) (AfterMainSVarState_1293));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1295, BeforeDisjSVarState_1291, STATE_VARIABLE_SVarStore_98_1308, &STATE_VARIABLE_SVarStore_103_1313, STATE_VARIABLE_VarSet_99_1309, &STATE_VARIABLE_VarSet_104_1314, STATE_VARIABLE_ModuleInfo_100_1310, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1311, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1312, &STATE_VARIABLE_Specs_107_1315);
                  {
                    AllDisjStates_1296 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1296, 0) = ((MR_Box) (MainDisjState_1294));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1296, 1) = ((MR_Box) (OrElseDisjStates_1295));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1296, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1314, &STATE_VARIABLE_VarSet_108_1316, BeforeDisjSVarState_1291, &STATE_VARIABLE_SVarState_109_1317, STATE_VARIABLE_SVarStore_103_1313, STATE_VARIABLE_SVarStore_108);
                  hlds__make_hlds__state_var__svar_finish_inner_atomic_scope_10_p_0(Context_323, InnerScopeInfo2_1259, &InnerDI_1260, &InnerUO_1261, STATE_VARIABLE_SVarState_109_1317, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_VarSet_108_1316, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_Specs_107_1315, STATE_VARIABLE_Specs_116);
                  {
                    Inner_360 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                ...
                {
                  MR_Word InnerDI0_1267;
                  MR_Word InnerUO0_1268;
                  MR_Word InnerDI_1271;
                  MR_Word InnerUO_1272;
                  MR_Word HLDSMainGoal0_1350;
                  MR_Word AfterMainSVarState_1351;
                  MR_Word MainDisjState_1352;
                  MR_Word OrElseDisjStates_1353;
                  MR_Word AllDisjStates_1354;
                  MR_Word STATE_VARIABLE_SVarStore_98_1357;
                  MR_Word STATE_VARIABLE_VarSet_99_1358;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1359;
                  MR_Word STATE_VARIABLE_QualInfo_101_1360;
                  MR_Word STATE_VARIABLE_Specs_102_1361;
                  MR_Word STATE_VARIABLE_SVarStore_103_1362;
                  MR_Word STATE_VARIABLE_VarSet_104_1363;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1350, STATE_VARIABLE_SVarState_0_105, &AfterMainSVarState_1351, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1357, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_99_1358, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1359, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1360, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_102_1361);
                  {
                    MainDisjState_1352 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1352, 0) = ((MR_Box) (HLDSMainGoal0_1350));
                    MR_hl_field(MR_mktag(0), MainDisjState_1352, 1) = ((MR_Box) (AfterMainSVarState_1351));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1353, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarStore_98_1357, &STATE_VARIABLE_SVarStore_103_1362, STATE_VARIABLE_VarSet_99_1358, &STATE_VARIABLE_VarSet_104_1363, STATE_VARIABLE_ModuleInfo_100_1359, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1360, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1361, STATE_VARIABLE_Specs_116);
                  {
                    AllDisjStates_1354 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1354, 0) = ((MR_Box) (MainDisjState_1352));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1354, 1) = ((MR_Box) (OrElseDisjStates_1353));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1354, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1363, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_103_1362, STATE_VARIABLE_SVarStore_108);
                  InnerDI0_1267 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Inner0_325, (MR_Integer) 0))));
                  InnerUO0_1268 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Inner0_325, (MR_Integer) 1))));
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerDI0_1267, &InnerDI_1271);
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerUO0_1268, &InnerUO_1272);
                  {
                    Inner_360 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Inner_360, 0) = ((MR_Box) (InnerDI_1271));
                    MR_hl_field(MR_mktag(0), Inner_360, 1) = ((MR_Box) (InnerUO_1272));
                  }
                }
              }
          ...
          case (MR_Integer) 17:
            {
              MR_Word Context_1120 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word MaybeIO0_1121 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word SubGoal0_1122 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word Then0_1123 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));
              MR_Word MaybeElse0_1124 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 5))));
              MR_Word Catches0_1125 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 6))));
              MR_Word MaybeCatchAny0_1126 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 7))));

              if ((MaybeIO0_1121 == (MR_Word) ((MR_Unsigned) 0U)))
                hlds__make_hlds__goal_expr_to_goal__transform_try_expr_without_io_21_p_0(LocKind_17, SubGoal0_1122, Then0_1123, MaybeElse0_1124, Catches0_1125, MaybeCatchAny0_1126, Context_1120, Renaming_19, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              else
              {
                MR_Word IOStateVar0_1127 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIO0_1121, (MR_Integer) 0))));

                if ((MaybeElse0_1124 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  MR_Word IOStateVar_1128;

                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, IOStateVar0_1127, &IOStateVar_1128);
                  hlds__make_hlds__goal_expr_to_goal__transform_try_expr_with_io_22_p_0(LocKind_17, IOStateVar0_1127, IOStateVar_1128, SubGoal0_1122, Then0_1123, Catches0_1125, MaybeCatchAny0_1126, Context_1120, Renaming_19, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
                }
                else
                {
                  MR_Word Spec_1131;
                  ...
                  {
                    Spec_1131 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Spec_1131, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.goal_expr_to_goal.transform_parse_tree_goal_to_hlds_try\'/16"));
                    MR_hl_field(MR_mktag(1), Spec_1131, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(MR_mktag(1), Spec_1131, 2) = ((MR_Box) ((MR_Unsigned) 40U));
                    MR_hl_field(MR_mktag(1), Spec_1131, 3) = ((MR_Box) (Context_1120));
                    MR_hl_field(MR_mktag(1), Spec_1131, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_1[33])));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_Specs_116 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Spec_1131));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_115));
                  }
                  *HLDSGoal_20 = hlds__make_goal__true_goal_with_context_1_f_0(Context_1120);
                  *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_0_105;
                  *STATE_VARIABLE_SVarStore_108 = STATE_VARIABLE_SVarStore_0_107;
                  *STATE_VARIABLE_VarSet_110 = STATE_VARIABLE_VarSet_0_109;
                  *STATE_VARIABLE_ModuleInfo_112 = STATE_VARIABLE_ModuleInfo_0_111;
