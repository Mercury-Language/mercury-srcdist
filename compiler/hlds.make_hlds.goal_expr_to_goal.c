  ...
  MR_Word * STATE_VARIABLE_Specs_116)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Goal_18)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Context_1184 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 0))));
          MR_Word TermA0_1185 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 1))));
          MR_Word TermB0_1186 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 2))));
          MR_Word Purity_1187 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 3))) & (MR_Integer) 3);
          MR_Word TermA_1188;
          MR_Word TermB_1189;
          MR_Word StateVarA_1190;
          MR_Word Var_1200;
          MR_String Var_1201;
          MR_Word Var_1202;
          MR_Word Var_1203;
          ...
          parse_tree__prog_rename__rename_vars_in_term_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, TermA0_1185, &TermA_1188);
          parse_tree__prog_rename__rename_vars_in_term_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, TermB0_1186, &TermB_1189);
          succeeded = ((MR_tag((MR_Word) TermA_1188)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_1200 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermA_1188, (MR_Integer) 0))));
            Var_1202 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermA_1188, (MR_Integer) 1))));
            succeeded = ((MR_tag((MR_Word) Var_1200)) == (MR_Integer) 0);
            if (succeeded)
            {
              Var_1201 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_1200, (MR_Integer) 0))));
              succeeded = (strcmp(Var_1201, (MR_String) "!") == 0);
              if (succeeded)
              {
                succeeded = (Var_1202 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Var_1203 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1202, (MR_Integer) 0))));
                  Var_1204 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1202, (MR_Integer) 1))));
                  succeeded = (Var_1204 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    succeeded = ((MR_tag((MR_Word) Var_1203)) == (MR_Integer) 1);
                    if (succeeded)
                      StateVarA_1190 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1203, (MR_Integer) 0))));
                  }
                }
              }
            }
          ...
          if (succeeded)
          {
            MR_Word STATE_VARIABLE_VarSet_60_1205;
            MR_Word STATE_VARIABLE_SVarState_61_1206;
            MR_Word STATE_VARIABLE_Specs_62_1207;
            MR_Word StateVarB_1193;
            MR_Word Var_1208;
            MR_String Var_1209;
            MR_Word Var_1210;
            MR_Word Var_1211;
            ...
            hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1184, StateVarA_1190, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_60_1205, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_61_1206, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_62_1207);
            succeeded = ((MR_tag((MR_Word) TermB_1189)) == (MR_Integer) 0);
            if (succeeded)
            {
              Var_1208 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1189, (MR_Integer) 0))));
              Var_1210 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1189, (MR_Integer) 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                        StateVarB_1193 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1211, (MR_Integer) 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
              hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1184, StateVarB_1193, STATE_VARIABLE_VarSet_60_1205, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_61_1206, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_Specs_62_1207, STATE_VARIABLE_Specs_116);
            else
            {
              *STATE_VARIABLE_Specs_116 = STATE_VARIABLE_Specs_62_1207;
              *STATE_VARIABLE_VarSet_110 = STATE_VARIABLE_VarSet_60_1205;
              *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_61_1206;
            }
            *HLDSGoal_20 = hlds__make_goal__true_goal_with_context_1_f_0(Context_1184);
          ...
          else
          {
            ...
            if (succeeded)
            {
              Var_1216 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1189, (MR_Integer) 0))));
              Var_1218 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TermB_1189, (MR_Integer) 1))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                        StateVarB_1233 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_1219, (MR_Integer) 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
            {
              hlds__make_hlds__state_var__report_svar_unify_error_8_p_0(Context_1184, StateVarB_1233, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
            ...
            {
              MR_Word STATE_VARIABLE_SVarState_81_1226;

              hlds__make_hlds__superhomogeneous__unravel_unification_19_p_0(TermA_1188, TermB_1189, Context_1184, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Purity_1187, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_81_1226, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              hlds__make_hlds__state_var__svar_finish_atomic_goal_3_p_0(LocKind_17, STATE_VARIABLE_SVarState_81_1226, STATE_VARIABLE_SVarState_106);
            }
          }
        }
        break;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Context_828 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word Vars0_829 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word StateVars0_830 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word Cond_831 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));
              MR_Word Then_832 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 5))));
              MR_Word Else_833 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 6))));
              MR_Word Vars_835;
              MR_Word StateVars_836;
              MR_Word BeforeCondSVarState_837;
              MR_Word HLDSCond_838;
              MR_Word AfterCondSVarState_839;
              MR_Word HLDSThen0_840;
              MR_Word AfterThenSVarState0_841;
              MR_Word Globals_842;
              MR_Word ModuleName_843;
              MR_Word AfterThenSVarState_844;
              MR_Word HLDSElse0_845;
              MR_Word AfterElseSVarState_846;
              MR_Word HLDSThen_847;
              MR_Word HLDSElse_848;
              MR_Word GoalExpr_849;
              MR_Word GoalInfo_850;
              MR_Word STATE_VARIABLE_Specs_64_853;
              MR_Word STATE_VARIABLE_SVarStore_65_854;
              MR_Word STATE_VARIABLE_VarSet_66_855;
              MR_Word STATE_VARIABLE_ModuleInfo_67_856;
              MR_Word STATE_VARIABLE_QualInfo_68_857;
              MR_Word STATE_VARIABLE_Specs_69_858;
              MR_Word STATE_VARIABLE_SVarStore_70_859;
              MR_Word STATE_VARIABLE_VarSet_71_860;
              MR_Word STATE_VARIABLE_ModuleInfo_72_861;
              MR_Word STATE_VARIABLE_QualInfo_73_862;
              MR_Word STATE_VARIABLE_Specs_74_863;
              MR_Word STATE_VARIABLE_SVarStore_75_864;
              MR_Word STATE_VARIABLE_VarSet_76_865;
              MR_Word STATE_VARIABLE_Specs_79_868;

              parse_tree__prog_rename__rename_var_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, Vars0_829, &Vars_835);
              parse_tree__prog_rename__rename_var_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, StateVars0_830, &StateVars_836);
              hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_828, STATE_VARIABLE_VarSet_0_109, StateVars_836, STATE_VARIABLE_SVarState_0_105, &BeforeCondSVarState_837, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_64_853);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Cond_831, Renaming_19, &HLDSCond_838, BeforeCondSVarState_837, &AfterCondSVarState_839, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_65_854, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_66_855, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_67_856, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_68_857, STATE_VARIABLE_Specs_64_853, &STATE_VARIABLE_Specs_69_858);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Then_832, Renaming_19, &HLDSThen0_840, AfterCondSVarState_839, &AfterThenSVarState0_841, STATE_VARIABLE_SVarStore_65_854, &STATE_VARIABLE_SVarStore_70_859, STATE_VARIABLE_VarSet_66_855, &STATE_VARIABLE_VarSet_71_860, STATE_VARIABLE_ModuleInfo_67_856, &STATE_VARIABLE_ModuleInfo_72_861, STATE_VARIABLE_QualInfo_68_857, &STATE_VARIABLE_QualInfo_73_862, STATE_VARIABLE_Specs_69_858, &STATE_VARIABLE_Specs_74_863);
              hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_72_861, &Globals_842);
              hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_72_861, &ModuleName_843);
              hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_842, ModuleName_843, StateVars_836, STATE_VARIABLE_SVarState_0_105, AfterThenSVarState0_841, &AfterThenSVarState_844);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, Else_833, Renaming_19, &HLDSElse0_845, STATE_VARIABLE_SVarState_0_105, &AfterElseSVarState_846, STATE_VARIABLE_SVarStore_70_859, &STATE_VARIABLE_SVarStore_75_864, STATE_VARIABLE_VarSet_71_860, &STATE_VARIABLE_VarSet_76_865, STATE_VARIABLE_ModuleInfo_72_861, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_73_862, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_74_863, &STATE_VARIABLE_Specs_79_868);
              hlds__make_hlds__state_var__svar_finish_if_then_else_20_p_0(Globals_842, ModuleName_843, LocKind_17, Context_828, StateVars_836, HLDSThen0_840, &HLDSThen_847, HLDSElse0_845, &HLDSElse_848, STATE_VARIABLE_SVarState_0_105, AfterCondSVarState_839, AfterThenSVarState_844, AfterElseSVarState_846, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_VarSet_76_865, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarStore_75_864, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_Specs_79_868, STATE_VARIABLE_Specs_116);
              {
                GoalExpr_849 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_849, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                MR_hl_field(MR_mktag(3), GoalExpr_849, 1) = ((MR_Box) (Vars_835));
                MR_hl_field(MR_mktag(3), GoalExpr_849, 2) = ((MR_Box) (HLDSCond_838));
                MR_hl_field(MR_mktag(3), GoalExpr_849, 3) = ((MR_Box) (HLDSThen_847));
                MR_hl_field(MR_mktag(3), GoalExpr_849, 4) = ((MR_Box) (HLDSElse_848));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_828, &GoalInfo_850);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_849));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_850));
              }
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            {
              MR_Word Context_896 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word SubGoal_897 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word HLDSSubGoal_899;
              MR_Word GoalExpr_901;
              MR_Word GoalInfo_902;
              MR_Word Var_900;

              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_897, Renaming_19, &HLDSSubGoal_899, STATE_VARIABLE_SVarState_0_105, &Var_900, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_0_105;
              GoalExpr_901 = (MR_Word) ((MR_Word) (HLDSSubGoal_899));
              hlds__hlds_goal__goal_info_init_2_p_0(Context_896, &GoalInfo_902);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_901));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_902));
              }
            }
            break;
          case (MR_Integer) 4:
          ...
          case (MR_Integer) 5:
            {
              MR_Word Context_925 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word SubGoalA_926 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word SubGoalB_927 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word HLDSConjunctsCordA_928;
              MR_Word HLDSConjunctsCordAB_929;
              MR_Word HLDSConjuncts_930;
              MR_Word GoalInfo_931;
              MR_Word Var_932;
              MR_Word STATE_VARIABLE_SVarState_47_933;
              MR_Word STATE_VARIABLE_SVarStore_48_934;
              MR_Word STATE_VARIABLE_VarSet_49_935;
              MR_Word STATE_VARIABLE_ModuleInfo_50_936;
              MR_Word STATE_VARIABLE_QualInfo_51_937;
              MR_Word STATE_VARIABLE_Specs_52_938;

              Var_932 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
              hlds__make_hlds__goal_expr_to_goal__accumulate_par_conjuncts_17_p_0(LocKind_17, SubGoalA_926, Renaming_19, Var_932, &HLDSConjunctsCordA_928, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_47_933, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_48_934, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_49_935, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_50_936, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_51_937, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_52_938);
              hlds__make_hlds__goal_expr_to_goal__accumulate_par_conjuncts_17_p_0(LocKind_17, SubGoalB_927, Renaming_19, HLDSConjunctsCordA_928, &HLDSConjunctsCordAB_929, STATE_VARIABLE_SVarState_47_933, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_48_934, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_49_935, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_50_936, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_51_937, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_52_938, STATE_VARIABLE_Specs_116);
              HLDSConjuncts_930 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), HLDSConjunctsCordAB_929);
              hlds__hlds_goal__goal_info_init_2_p_0(Context_925, &GoalInfo_931);
              hlds__hlds_goal__par_conj_list_to_goal_3_p_0(HLDSConjuncts_930, GoalInfo_931, HLDSGoal_20);
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Word QuantType_968 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              MR_Word VarsKind_969 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))) & (MR_Integer) 1);
              MR_Word Context_970 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word Vars0_971 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word SubGoal_972 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));

              switch (QuantType_968) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_Word TransformedGoal_973;
                    MR_Word Var_1001;
                    MR_Word Var_1003;
                    MR_Word next_value_of_Goal_18;

                    {
                      Var_1003 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_1003, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                      MR_hl_field(MR_mktag(3), Var_1003, 1) = ((MR_Box) (Context_970));
                      MR_hl_field(MR_mktag(3), Var_1003, 2) = ((MR_Box) (SubGoal_972));
                    }
                    {
                      Var_1001 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_1001, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                      MR_hl_field(MR_mktag(3), Var_1001, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (VarsKind_969)));
                      MR_hl_field(MR_mktag(3), Var_1001, 2) = ((MR_Box) (Context_970));
                      MR_hl_field(MR_mktag(3), Var_1001, 3) = ((MR_Box) (Vars0_971));
                      MR_hl_field(MR_mktag(3), Var_1001, 4) = ((MR_Box) (Var_1003));
                    }
                    {
                      TransformedGoal_973 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), TransformedGoal_973, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                      MR_hl_field(MR_mktag(3), TransformedGoal_973, 1) = ((MR_Box) (Context_970));
                      MR_hl_field(MR_mktag(3), TransformedGoal_973, 2) = ((MR_Box) (Var_1001));
                    }
                    // direct tailcall eliminated
                    ;
                    next_value_of_Goal_18 = TransformedGoal_973;
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word Vars_974;
                    MR_Word HLDSSubGoal_975;
                    MR_Word Reason_976;
                    MR_Word GoalExpr_984;
                    MR_Word GoalInfo_985;

                    parse_tree__prog_rename__rename_var_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, Vars0_971, &Vars_974);
                    switch (VarsKind_969) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        {
                          hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_972, Renaming_19, &HLDSSubGoal_975, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
                          {
                            Reason_976 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Reason_976, 0) = ((MR_Box) (Vars_974));
                          }
                        }
                        break;
                      case (MR_Integer) 1:
                        {
                          MR_Word BeforeInsideSVarState_979;
                          MR_Word AfterInsideSVarState_980;
                          MR_Word Globals_981;
                          MR_Word ModuleName_982;
                          MR_Word STATE_VARIABLE_Specs_58_987;

                          hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_970, STATE_VARIABLE_VarSet_0_109, Vars_974, STATE_VARIABLE_SVarState_0_105, &BeforeInsideSVarState_979, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_58_987);
                          hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal_972, Renaming_19, &HLDSSubGoal_975, BeforeInsideSVarState_979, &AfterInsideSVarState_980, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_58_987, STATE_VARIABLE_Specs_116);
                          hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &Globals_981);
                          hlds__hlds_module__module_info_get_name_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &ModuleName_982);
                          hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_981, ModuleName_982, Vars_974, STATE_VARIABLE_SVarState_0_105, AfterInsideSVarState_980, STATE_VARIABLE_SVarState_106);
                          Reason_976 = (MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_3[3]);
                        }
                        break;
                    }
                    {
                      GoalExpr_984 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), GoalExpr_984, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                      MR_hl_field(MR_mktag(3), GoalExpr_984, 1) = ((MR_Box) (Reason_976));
                      MR_hl_field(MR_mktag(3), GoalExpr_984, 2) = ((MR_Box) (HLDSSubGoal_975));
                    }
                    hlds__hlds_goal__goal_info_init_2_p_0(Context_970, &GoalInfo_985);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      *HLDSGoal_20 = base;
                      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_984));
                      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_985));
                    }
                  }
                  break;
              }
          ...
          case (MR_Integer) 15:
            {
              MR_Word Context_1033 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word MaybeCompileTime_1034 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word MaybeRunTime_1035 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word MaybeIO0_1036 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));
              MR_Word Mutables0_1037 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 5))));
              MR_Word SubGoal0_1038 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 6))));
              MR_Word MutableHLDSs_1039;
              MR_Word MutableStateVars_1040;
              MR_Word MutableGetGoals_1041;
              MR_Word MutableSetGoals_1042;
              MR_Word MaybeIOHLDS_1048;
              MR_Word StateVars_1049;
              MR_Word GetGoals_1050;
              MR_Word SetGoals_1051;
              MR_Word SubGoal1_1052;
              MR_Word BeforeInsideSVarState_1054;
              MR_Word HLDSSubGoal_1055;
              MR_Word AfterInsideSVarState_1056;
              MR_Word Globals_1057;
              MR_Word ModuleName_1058;
              MR_Word Reason_1060;
              MR_Word GoalExpr_1061;
              MR_Word GoalInfo_1062;
              MR_Word Var_1063;
              MR_Word Var_1064;
              MR_Word Var_1065;
              MR_Word Var_1066;
              MR_Word STATE_VARIABLE_Specs_74_1068;
              MR_Word STATE_VARIABLE_QualInfo_78_1072;

              {
                Var_1063 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_1063, 0) = ((MR_Box) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_5[0]));
                MR_hl_field(MR_mktag(0), Var_1063, 1) = ((MR_Box) (hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0_1));
                MR_hl_field(MR_mktag(0), Var_1063, 2) = ((MR_Box) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(0), Var_1063, 3) = ((MR_Box) (Context_1033));
                MR_hl_field(MR_mktag(0), Var_1063, 4) = ((MR_Box) (STATE_VARIABLE_VarSet_0_109));
                MR_hl_field(MR_mktag(0), Var_1063, 5) = ((MR_Box) (Renaming_19));
              }
              mercury__list__map4_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trace_mutable_var_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_trace_mutable_var_hlds_0), (MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), Var_1063, Mutables0_1037, &MutableHLDSs_1039, &MutableStateVars_1040, &MutableGetGoals_1041, &MutableSetGoals_1042);
              if ((MaybeIO0_1036 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                MaybeIOHLDS_1048 = (MR_Word) ((MR_Unsigned) 0U);
                StateVars_1049 = MutableStateVars_1040;
                GetGoals_1050 = MutableGetGoals_1041;
                SetGoals_1051 = MutableSetGoals_1042;
              }
              else
              {
                MR_Word IOStateVar0_1043 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIO0_1036, (MR_Integer) 0))));
                MR_Word IOStateVar_1044;
                MR_String IOStateVarName_1045;
                MR_Word IOGetGoal_1046;
                MR_Word IOSetGoal_1047;

                hlds__make_hlds__goal_expr_to_goal__extract_trace_io_var_8_p_0(Context_1033, STATE_VARIABLE_VarSet_0_109, Renaming_19, IOStateVar0_1043, &IOStateVar_1044, &IOStateVarName_1045, &IOGetGoal_1046, &IOSetGoal_1047);
                {
                  MaybeIOHLDS_1048 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybeIOHLDS_1048, 0) = ((MR_Box) (IOStateVarName_1045));
                }
                {
                  StateVars_1049 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), StateVars_1049, 0) = ((MR_Box) (IOStateVar_1044));
                  MR_hl_field(MR_mktag(1), StateVars_1049, 1) = ((MR_Box) (MutableStateVars_1040));
                }
                {
                  GetGoals_1050 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), GetGoals_1050, 0) = ((MR_Box) (IOGetGoal_1046));
                  MR_hl_field(MR_mktag(1), GetGoals_1050, 1) = ((MR_Box) (MutableGetGoals_1041));
                }
                {
                  SetGoals_1051 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), SetGoals_1051, 0) = ((MR_Box) (IOSetGoal_1047));
                  MR_hl_field(MR_mktag(1), SetGoals_1051, 1) = ((MR_Box) (MutableSetGoals_1042));
                }
              }
              {
                Var_1066 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_1066, 0) = ((MR_Box) (SubGoal0_1038));
                MR_hl_field(MR_mktag(1), Var_1066, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              Var_1065 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), Var_1066, SetGoals_1051);
              Var_1064 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), GetGoals_1050, Var_1065);
              SubGoal1_1052 = parse_tree__prog_util__goal_list_to_conj_2_f_0(Context_1033, Var_1064);
              hlds__make_hlds__state_var__svar_prepare_for_local_state_vars_7_p_0(Context_1033, STATE_VARIABLE_VarSet_0_109, StateVars_1049, STATE_VARIABLE_SVarState_0_105, &BeforeInsideSVarState_1054, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_74_1068);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoal1_1052, Renaming_19, &HLDSSubGoal_1055, BeforeInsideSVarState_1054, &AfterInsideSVarState_1056, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_78_1072, STATE_VARIABLE_Specs_74_1068, STATE_VARIABLE_Specs_116);
              hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &Globals_1057);
              hlds__hlds_module__module_info_get_name_2_p_0(*STATE_VARIABLE_ModuleInfo_112, &ModuleName_1058);
              hlds__make_hlds__state_var__svar_finish_local_state_vars_6_p_0(Globals_1057, ModuleName_1058, StateVars_1049, STATE_VARIABLE_SVarState_0_105, AfterInsideSVarState_1056, STATE_VARIABLE_SVarState_106);
              hlds__make_hlds__qual_info__qual_info_set_found_trace_goal_3_p_0((MR_Integer) 1, STATE_VARIABLE_QualInfo_78_1072, STATE_VARIABLE_QualInfo_114);
              {
                Reason_1060 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Reason_1060, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(MR_mktag(3), Reason_1060, 1) = ((MR_Box) (MaybeCompileTime_1034));
                MR_hl_field(MR_mktag(3), Reason_1060, 2) = ((MR_Box) (MaybeRunTime_1035));
                MR_hl_field(MR_mktag(3), Reason_1060, 3) = ((MR_Box) (MaybeIOHLDS_1048));
                MR_hl_field(MR_mktag(3), Reason_1060, 4) = ((MR_Box) (MutableHLDSs_1039));
                MR_hl_field(MR_mktag(3), Reason_1060, 5) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                GoalExpr_1061 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_1061, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                MR_hl_field(MR_mktag(3), GoalExpr_1061, 1) = ((MR_Box) (Reason_1060));
                MR_hl_field(MR_mktag(3), GoalExpr_1061, 2) = ((MR_Box) (HLDSSubGoal_1055));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_1033, &GoalInfo_1062);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_1061));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_1062));
              }
            }
            break;
          case (MR_Integer) 16:
            {
              ...
              if (((MR_tag((MR_Word) Outer0_324)) == (MR_Integer) 0))
              {
                ...
                else
                {
                  ...
                  MR_Word InnerDI_418;
                  MR_Word InnerUO_419;
                  MR_Word HLDSMainGoal0_1319;
                  MR_Word AfterMainSVarState_1320;
                  MR_Word MainDisjState_1321;
                  MR_Word OrElseDisjStates_1322;
                  MR_Word AllDisjStates_1323;
                  MR_Word STATE_VARIABLE_SVarStore_98_1326;
                  MR_Word STATE_VARIABLE_VarSet_99_1327;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1328;
                  MR_Word STATE_VARIABLE_QualInfo_101_1329;
                  MR_Word STATE_VARIABLE_Specs_102_1330;
                  MR_Word STATE_VARIABLE_SVarStore_103_1331;
                  MR_Word STATE_VARIABLE_VarSet_104_1332;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1319, STATE_VARIABLE_SVarState_91_375, &AfterMainSVarState_1320, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1326, STATE_VARIABLE_VarSet_92_376, &STATE_VARIABLE_VarSet_99_1327, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1328, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1329, STATE_VARIABLE_Specs_93_377, &STATE_VARIABLE_Specs_102_1330);
                  {
                    MainDisjState_1321 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1321, 0) = ((MR_Box) (HLDSMainGoal0_1319));
                    MR_hl_field(MR_mktag(0), MainDisjState_1321, 1) = ((MR_Box) (AfterMainSVarState_1320));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1322, STATE_VARIABLE_SVarState_91_375, STATE_VARIABLE_SVarStore_98_1326, &STATE_VARIABLE_SVarStore_103_1331, STATE_VARIABLE_VarSet_99_1327, &STATE_VARIABLE_VarSet_104_1332, STATE_VARIABLE_ModuleInfo_100_1328, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1329, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1330, STATE_VARIABLE_Specs_116);
                  {
                    AllDisjStates_1323 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1323, 0) = ((MR_Box) (MainDisjState_1321));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1323, 1) = ((MR_Box) (OrElseDisjStates_1322));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1323, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1332, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_91_375, &STATE_VARIABLE_SVarState_117_401, STATE_VARIABLE_SVarStore_103_1331, STATE_VARIABLE_SVarStore_108);
              ...
              else
              {
                ...
                if (((MR_tag((MR_Word) Inner0_325)) == (MR_Integer) 0))
                {
                  MR_Word InnerStateVar0_1236 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Inner0_325, (MR_Integer) 0))));
                  MR_Word InnerStateVar_1237;
                  MR_Word InnerScopeInfo2_1248;
                  MR_Word InnerDI_1249;
                  MR_Word InnerUO_1250;
                  MR_Word BeforeDisjSVarState_1280;
                  MR_Word HLDSMainGoal0_1281;
                  MR_Word AfterMainSVarState_1282;
                  MR_Word MainDisjState_1283;
                  MR_Word OrElseDisjStates_1284;
                  MR_Word AllDisjStates_1285;
                  MR_Word STATE_VARIABLE_VarSet_96_1295;
                  MR_Word STATE_VARIABLE_Specs_97_1296;
                  MR_Word STATE_VARIABLE_SVarStore_98_1297;
                  MR_Word STATE_VARIABLE_VarSet_99_1298;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1299;
                  MR_Word STATE_VARIABLE_QualInfo_101_1300;
                  MR_Word STATE_VARIABLE_Specs_102_1301;
                  MR_Word STATE_VARIABLE_SVarStore_103_1302;
                  MR_Word STATE_VARIABLE_VarSet_104_1303;
                  MR_Word STATE_VARIABLE_Specs_107_1304;
                  MR_Word STATE_VARIABLE_VarSet_108_1305;
                  MR_Word STATE_VARIABLE_SVarState_109_1306;

                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerStateVar0_1236, &InnerStateVar_1237);
                  hlds__make_hlds__state_var__svar_start_inner_atomic_scope_9_p_0(Context_323, InnerStateVar_1237, &InnerScopeInfo2_1248, STATE_VARIABLE_SVarState_0_105, &BeforeDisjSVarState_1280, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_96_1295, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_97_1296);
                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1281, BeforeDisjSVarState_1280, &AfterMainSVarState_1282, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1297, STATE_VARIABLE_VarSet_96_1295, &STATE_VARIABLE_VarSet_99_1298, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1299, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1300, STATE_VARIABLE_Specs_97_1296, &STATE_VARIABLE_Specs_102_1301);
                  {
                    MainDisjState_1283 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1283, 0) = ((MR_Box) (HLDSMainGoal0_1281));
                    MR_hl_field(MR_mktag(0), MainDisjState_1283, 1) = ((MR_Box) (AfterMainSVarState_1282));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1284, BeforeDisjSVarState_1280, STATE_VARIABLE_SVarStore_98_1297, &STATE_VARIABLE_SVarStore_103_1302, STATE_VARIABLE_VarSet_99_1298, &STATE_VARIABLE_VarSet_104_1303, STATE_VARIABLE_ModuleInfo_100_1299, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1300, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1301, &STATE_VARIABLE_Specs_107_1304);
                  {
                    AllDisjStates_1285 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1285, 0) = ((MR_Box) (MainDisjState_1283));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1285, 1) = ((MR_Box) (OrElseDisjStates_1284));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1285, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1303, &STATE_VARIABLE_VarSet_108_1305, BeforeDisjSVarState_1280, &STATE_VARIABLE_SVarState_109_1306, STATE_VARIABLE_SVarStore_103_1302, STATE_VARIABLE_SVarStore_108);
                  hlds__make_hlds__state_var__svar_finish_inner_atomic_scope_10_p_0(Context_323, InnerScopeInfo2_1248, &InnerDI_1249, &InnerUO_1250, STATE_VARIABLE_SVarState_109_1306, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_VarSet_108_1305, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_Specs_107_1304, STATE_VARIABLE_Specs_116);
                  {
                    Inner_360 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Inner_360, 0) = ((MR_Box) (InnerDI_1249));
                    MR_hl_field(MR_mktag(0), Inner_360, 1) = ((MR_Box) (InnerUO_1250));
                  }
                }
                else
                {
                  MR_Word InnerDI0_1256;
                  MR_Word InnerUO0_1257;
                  MR_Word InnerDI_1260;
                  MR_Word InnerUO_1261;
                  MR_Word HLDSMainGoal0_1339;
                  MR_Word AfterMainSVarState_1340;
                  MR_Word MainDisjState_1341;
                  MR_Word OrElseDisjStates_1342;
                  MR_Word AllDisjStates_1343;
                  MR_Word STATE_VARIABLE_SVarStore_98_1346;
                  MR_Word STATE_VARIABLE_VarSet_99_1347;
                  MR_Word STATE_VARIABLE_ModuleInfo_100_1348;
                  MR_Word STATE_VARIABLE_QualInfo_101_1349;
                  MR_Word STATE_VARIABLE_Specs_102_1350;
                  MR_Word STATE_VARIABLE_SVarStore_103_1351;
                  MR_Word STATE_VARIABLE_VarSet_104_1352;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, MainGoal_327, Renaming_19, &HLDSMainGoal0_1339, STATE_VARIABLE_SVarState_0_105, &AfterMainSVarState_1340, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_98_1346, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_99_1347, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_100_1348, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_101_1349, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_102_1350);
                  {
                    MainDisjState_1341 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MainDisjState_1341, 0) = ((MR_Box) (HLDSMainGoal0_1339));
                    MR_hl_field(MR_mktag(0), MainDisjState_1341, 1) = ((MR_Box) (AfterMainSVarState_1340));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_15_p_0(LocKind_17, OrElseGoals_328, Renaming_19, &OrElseDisjStates_1342, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarStore_98_1346, &STATE_VARIABLE_SVarStore_103_1351, STATE_VARIABLE_VarSet_99_1347, &STATE_VARIABLE_VarSet_104_1352, STATE_VARIABLE_ModuleInfo_100_1348, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_101_1349, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_102_1350, STATE_VARIABLE_Specs_116);
                  {
                    AllDisjStates_1343 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1343, 0) = ((MR_Box) (MainDisjState_1341));
                    MR_hl_field(MR_mktag(1), AllDisjStates_1343, 1) = ((MR_Box) (OrElseDisjStates_1342));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_9_p_0(Context_323, AllDisjStates_1343, &HLDSGoals_353, STATE_VARIABLE_VarSet_104_1352, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_103_1351, STATE_VARIABLE_SVarStore_108);
                  InnerDI0_1256 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Inner0_325, (MR_Integer) 0))));
                  InnerUO0_1257 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Inner0_325, (MR_Integer) 1))));
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerDI0_1256, &InnerDI_1260);
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, InnerUO0_1257, &InnerUO_1261);
                  {
                    Inner_360 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Inner_360, 0) = ((MR_Box) (InnerDI_1260));
                    MR_hl_field(MR_mktag(0), Inner_360, 1) = ((MR_Box) (InnerUO_1261));
                  }
                }
              }
          ...
          case (MR_Integer) 17:
            {
              MR_Word Context_1109 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_Word MaybeIO0_1110 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word SubGoal0_1111 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word Then0_1112 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 4))));
              MR_Word MaybeElse0_1113 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 5))));
              MR_Word Catches0_1114 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 6))));
              MR_Word MaybeCatchAny0_1115 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 7))));

              if ((MaybeIO0_1110 == (MR_Word) ((MR_Unsigned) 0U)))
                hlds__make_hlds__goal_expr_to_goal__transform_try_expr_without_io_21_p_0(LocKind_17, SubGoal0_1111, Then0_1112, MaybeElse0_1113, Catches0_1114, MaybeCatchAny0_1115, Context_1109, Renaming_19, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
              else
              {
                MR_Word IOStateVar0_1116 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIO0_1110, (MR_Integer) 0))));

                if ((MaybeElse0_1113 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  MR_Word IOStateVar_1117;

                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, IOStateVar0_1116, &IOStateVar_1117);
                  hlds__make_hlds__goal_expr_to_goal__transform_try_expr_with_io_22_p_0(LocKind_17, IOStateVar0_1116, IOStateVar_1117, SubGoal0_1111, Then0_1112, Catches0_1114, MaybeCatchAny0_1115, Context_1109, Renaming_19, HLDSGoal_20, STATE_VARIABLE_SVarState_0_105, STATE_VARIABLE_SVarState_106, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_0_109, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_0_115, STATE_VARIABLE_Specs_116);
                }
                else
                {
                  MR_Word Spec_1120;
                  ...
                  {
                    Spec_1120 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Spec_1120, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.goal_expr_to_goal.transform_parse_tree_goal_to_hlds_try\'/16"));
                    MR_hl_field(MR_mktag(1), Spec_1120, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(MR_mktag(1), Spec_1120, 2) = ((MR_Box) ((MR_Unsigned) 40U));
                    MR_hl_field(MR_mktag(1), Spec_1120, 3) = ((MR_Box) (Context_1109));
                    MR_hl_field(MR_mktag(1), Spec_1120, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_1[33])));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_Specs_116 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Spec_1120));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_115));
                  }
                  *HLDSGoal_20 = hlds__make_goal__true_goal_with_context_1_f_0(Context_1109);
                  *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_0_105;
                  *STATE_VARIABLE_SVarStore_108 = STATE_VARIABLE_SVarStore_0_107;
                  *STATE_VARIABLE_VarSet_110 = STATE_VARIABLE_VarSet_0_109;
                  *STATE_VARIABLE_ModuleInfo_112 = STATE_VARIABLE_ModuleInfo_0_111;
          ...
          case (MR_Integer) 19:
            {
              MR_Word Context_729 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              ...
              MR_Word HLDSSubGoalA_733;
              MR_Word HLDSSubGoalB_734;
              MR_Word GoalExpr_736;
              MR_Word GoalInfo_737;
              MR_Word STATE_VARIABLE_SVarState_48_738;
              MR_Word STATE_VARIABLE_SVarStore_49_739;
              MR_Word STATE_VARIABLE_VarSet_50_740;
              MR_Word STATE_VARIABLE_ModuleInfo_51_741;
              MR_Word STATE_VARIABLE_QualInfo_52_742;
              MR_Word STATE_VARIABLE_Specs_53_743;
              MR_Word Var_750;
              MR_Word Var_735;

              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoalA_730, Renaming_19, &HLDSSubGoalA_733, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_48_738, STATE_VARIABLE_SVarStore_0_107, &STATE_VARIABLE_SVarStore_49_739, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_50_740, STATE_VARIABLE_ModuleInfo_0_111, &STATE_VARIABLE_ModuleInfo_51_741, STATE_VARIABLE_QualInfo_0_113, &STATE_VARIABLE_QualInfo_52_742, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_53_743);
              hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0(LocKind_17, SubGoalB_731, Renaming_19, &HLDSSubGoalB_734, STATE_VARIABLE_SVarState_48_738, &Var_735, STATE_VARIABLE_SVarStore_49_739, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_50_740, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_51_741, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_52_742, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_53_743, STATE_VARIABLE_Specs_116);
              *STATE_VARIABLE_SVarState_106 = STATE_VARIABLE_SVarState_0_105;
              {
                Var_750 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_750, 0) = ((MR_Box) (HLDSSubGoalA_733));
                MR_hl_field(MR_mktag(0), Var_750, 1) = ((MR_Box) (HLDSSubGoalB_734));
              }
              {
                GoalExpr_736 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_736, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(MR_mktag(3), GoalExpr_736, 1) = ((MR_Box) (Var_750));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_729, &GoalInfo_737);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                *HLDSGoal_20 = base;
                MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_736));
                MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_737));
              }
            }
            break;
          case (MR_Integer) 20:
            {
              MR_Word Context_773 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 1))));
              MR_String EventName_774 = ((MR_String) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 2))));
              MR_Word ArgTerms0_775 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_18, (MR_Integer) 3))));
              MR_Word ArgTerms1_776;
              MR_Word ArgTerms_777;
              MR_Word HeadVars_778;
              MR_Word HeadVarsArgTerms_779;
              MR_Integer Arity_780;
              MR_Word Modes_781;
              MR_Word Details_782;
              MR_Word GoalExpr0_783;
              MR_Word GoalInfo_784;
              MR_Word HLDSGoal0_785;
              MR_Word CallId_786;
              MR_Word STATE_VARIABLE_VarSet_54_788;
              MR_Word STATE_VARIABLE_SVarState_55_789;
              MR_Word STATE_VARIABLE_Specs_56_790;
              MR_Word Var_791;
              MR_Word Var_794;
              MR_Word Var_795;
              MR_Word STATE_VARIABLE_SVarState_62_796;

              hlds__make_hlds__state_var__expand_bang_state_pairs_in_terms_2_p_0(ArgTerms0_775, &ArgTerms1_776);
              parse_tree__prog_rename__rename_vars_in_term_list_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_19, ArgTerms1_776, &ArgTerms_777);
              hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_9_p_0(ArgTerms_777, &HeadVars_778, &HeadVarsArgTerms_779, STATE_VARIABLE_VarSet_0_109, &STATE_VARIABLE_VarSet_54_788, STATE_VARIABLE_SVarState_0_105, &STATE_VARIABLE_SVarState_55_789, STATE_VARIABLE_Specs_0_115, &STATE_VARIABLE_Specs_56_790);
              mercury__list__length_2_p_0((MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_1[1]), HeadVars_778, &Arity_780);
              Var_791 = parse_tree__prog_mode__in_mode_0_f_0();
              mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Arity_780, ((MR_Box) (Var_791)), &Modes_781);
              {
                Details_782 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Details_782, 0) = ((MR_Box) (EventName_774));
              }
              {
                GoalExpr0_783 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 1) = ((MR_Box) (Details_782));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 2) = ((MR_Box) (HeadVars_778));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 3) = ((MR_Box) (Modes_781));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), GoalExpr0_783, 5) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              }
              hlds__hlds_goal__goal_info_init_2_p_0(Context_773, &GoalInfo_784);
              {
                HLDSGoal0_785 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), HLDSGoal0_785, 0) = ((MR_Box) (GoalExpr0_783));
                MR_hl_field(MR_mktag(0), HLDSGoal0_785, 1) = ((MR_Box) (GoalInfo_784));
              }
              {
                Var_794 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Var_794, 0) = ((MR_Box) (EventName_774));
              }
              {
                CallId_786 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), CallId_786, 0) = ((MR_Box) (Var_794));
              }
              {
                Var_795 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_795, 0) = ((MR_Box) (CallId_786));
              }
              hlds__make_hlds__superhomogeneous__insert_arg_unifications_17_p_0(HeadVarsArgTerms_779, Context_773, Var_795, HLDSGoal0_785, HLDSGoal_20, STATE_VARIABLE_SVarState_55_789, &STATE_VARIABLE_SVarState_62_796, STATE_VARIABLE_SVarStore_0_107, STATE_VARIABLE_SVarStore_108, STATE_VARIABLE_VarSet_54_788, STATE_VARIABLE_VarSet_110, STATE_VARIABLE_ModuleInfo_0_111, STATE_VARIABLE_ModuleInfo_112, STATE_VARIABLE_QualInfo_0_113, STATE_VARIABLE_QualInfo_114, STATE_VARIABLE_Specs_56_790, STATE_VARIABLE_Specs_116);
              hlds__make_hlds__state_var__svar_finish_atomic_goal_3_p_0(LocKind_17, STATE_VARIABLE_SVarState_62_796, STATE_VARIABLE_SVarState_106);
            }
            break;
        }
        break;
