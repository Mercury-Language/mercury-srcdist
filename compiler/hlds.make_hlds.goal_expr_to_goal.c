              ...
              else
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(0, Spec_774, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__goal_expr_to_goal_scalar_common_1[40])));
                  }
                  {
                    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  else
  {
    ...
    hlds__make_hlds__qual_info__qual_info_set_found_syntax_error_3_p_0((MR_Integer) 1, STATE_VARIABLE_QualInfo_0_53, STATE_VARIABLE_QualInfo_54);
    {
      ...
      MR_hl_field(0, Spec_44, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.goal_expr_to_goal.transform_dcg_record_syntax\'/17"));
      MR_hl_field(0, Spec_44, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_44, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      MR_hl_field(0, Spec_44, 3) = ((MR_Box) (Context_21));
      MR_hl_field(0, Spec_44, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__goal_expr_to_goal_scalar_common_1[17])));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
