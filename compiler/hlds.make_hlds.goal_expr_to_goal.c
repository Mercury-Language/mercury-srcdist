      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            MR_Word STATE_VARIABLE_SVarState_1_676;
            MR_Word STATE_VARIABLE_UrInfo_1_677;
            ...
            hlds__make_hlds__state_var__report_svar_unify_error_6_p_0(Context_655, StateVarA_661, STATE_VARIABLE_SVarState_0_94, &STATE_VARIABLE_SVarState_1_676, STATE_VARIABLE_UrInfo_0_96, &STATE_VARIABLE_UrInfo_1_677);
            succeeded = ((MR_tag((MR_Word) TermB_660)) == (MR_Integer) 0);
            if (succeeded)
            {
              Var_678 = ((MR_Word) ((MR_hl_field(0, TermB_660, 0))));
              Var_680 = ((MR_Word) ((MR_hl_field(0, TermB_660, 1))));
              succeeded = ((MR_tag((MR_Word) Var_678)) == (MR_Integer) 0);
              if (succeeded)
              {
                Var_679 = ((MR_String) ((MR_hl_field(0, Var_678, 0))));
                succeeded = (strcmp(Var_679, (MR_String) "!") == 0);
                if (succeeded)
                {
                  succeeded = (Var_680 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    Var_681 = ((MR_Word) ((MR_hl_field(1, Var_680, 0))));
                    Var_682 = ((MR_Word) ((MR_hl_field(1, Var_680, 1))));
                    succeeded = (Var_682 == (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      succeeded = ((MR_tag((MR_Word) Var_681)) == (MR_Integer) 1);
                      if (succeeded)
                        StateVarB_664 = ((MR_Word) ((MR_hl_field(1, Var_681, 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
              hlds__make_hlds__state_var__report_svar_unify_error_6_p_0(Context_655, StateVarB_664, STATE_VARIABLE_SVarState_1_676, STATE_VARIABLE_SVarState_95, STATE_VARIABLE_UrInfo_1_677, STATE_VARIABLE_UrInfo_97);
            else
            {
              *STATE_VARIABLE_UrInfo_97 = STATE_VARIABLE_UrInfo_1_677;
              *STATE_VARIABLE_SVarState_95 = STATE_VARIABLE_SVarState_1_676;
            }
            *HLDSGoal_12 = hlds__make_goal__true_goal_with_context_1_f_0(Context_655);
          }
          else
          {
            MR_Word StateVarB_691;
            MR_Word Var_683;
            MR_String Var_684;
            MR_Word Var_685;
            MR_Word Var_686;
            ...
            if (succeeded)
            {
              Var_683 = ((MR_Word) ((MR_hl_field(0, TermB_660, 0))));
              Var_685 = ((MR_Word) ((MR_hl_field(0, TermB_660, 1))));
              succeeded = ((MR_tag((MR_Word) Var_683)) == (MR_Integer) 0);
              if (succeeded)
              {
                Var_684 = ((MR_String) ((MR_hl_field(0, Var_683, 0))));
                succeeded = (strcmp(Var_684, (MR_String) "!") == 0);
                if (succeeded)
                {
                  succeeded = (Var_685 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    Var_686 = ((MR_Word) ((MR_hl_field(1, Var_685, 0))));
                    Var_687 = ((MR_Word) ((MR_hl_field(1, Var_685, 1))));
                    succeeded = (Var_687 == (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      succeeded = ((MR_tag((MR_Word) Var_686)) == (MR_Integer) 1);
                      if (succeeded)
                        StateVarB_691 = ((MR_Word) ((MR_hl_field(1, Var_686, 0))));
                    }
                  }
                }
              }
            ...
            if (succeeded)
            {
              hlds__make_hlds__state_var__report_svar_unify_error_6_p_0(Context_655, StateVarB_691, STATE_VARIABLE_SVarState_0_94, STATE_VARIABLE_SVarState_95, STATE_VARIABLE_UrInfo_0_96, STATE_VARIABLE_UrInfo_97);
              *HLDSGoal_12 = hlds__make_goal__true_goal_with_context_1_f_0(Context_655);
            }
            else
            {
              MR_Word STATE_VARIABLE_SVarState_4_690;

              hlds__make_hlds__superhomogeneous__unravel_unification_11_p_0(TermA_659, TermB_660, Context_655, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Purity_658, HLDSGoal_12, STATE_VARIABLE_SVarState_0_94, &STATE_VARIABLE_SVarState_4_690, STATE_VARIABLE_UrInfo_0_96, STATE_VARIABLE_UrInfo_97);
              hlds__make_hlds__state_var__svar_finish_atomic_goal_3_p_0(LocKind_9, STATE_VARIABLE_SVarState_4_690, STATE_VARIABLE_SVarState_95);
            }
          }
        }
        break;
          ...
          case (MR_Integer) 16:
            {
              ...
              if (((MR_tag((MR_Word) Outer0_210)) == (MR_Integer) 0))
              {
                ...
                else
                {
                  ...
                  MR_Word InnerDI_293;
                  MR_Word InnerUO_294;
                  MR_Word HLDSMainGoal0_768;
                  MR_Word AfterMainSVarState_769;
                  MR_Word MainDisjState_770;
                  MR_Word OrElseDisjStates_771;
                  MR_Word AllDisjStates_772;
                  MR_Word STATE_VARIABLE_UrInfo_3_774;
                  MR_Word STATE_VARIABLE_UrInfo_4_775;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_8_p_0(LocKind_9, Renaming_10, MainGoal_213, &HLDSMainGoal0_768, STATE_VARIABLE_SVarState_1_262, &AfterMainSVarState_769, STATE_VARIABLE_UrInfo_1_263, &STATE_VARIABLE_UrInfo_3_774);
                  {
                    MainDisjState_770 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, MainDisjState_770, 0) = ((MR_Box) (HLDSMainGoal0_768));
                    MR_hl_field(0, MainDisjState_770, 1) = ((MR_Box) (AfterMainSVarState_769));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_7_p_0(LocKind_9, Renaming_10, OrElseGoals_214, &OrElseDisjStates_771, STATE_VARIABLE_SVarState_1_262, STATE_VARIABLE_UrInfo_3_774, &STATE_VARIABLE_UrInfo_4_775);
                  {
                    AllDisjStates_772 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, AllDisjStates_772, 0) = ((MR_Box) (MainDisjState_770));
                    MR_hl_field(1, AllDisjStates_772, 1) = ((MR_Box) (OrElseDisjStates_771));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_6_p_0(AllDisjStates_772, &HLDSGoals_239, STATE_VARIABLE_SVarState_1_262, &STATE_VARIABLE_SVarState_4_274, STATE_VARIABLE_UrInfo_4_775, STATE_VARIABLE_UrInfo_97);
              ...
              else
              {
                ...
                if (((MR_tag((MR_Word) Inner0_211)) == (MR_Integer) 0))
                {
                  MR_Word InnerStateVar0_694 = ((MR_Word) ((MR_hl_field(0, Inner0_211, 0))));
                  MR_Word InnerStateVar_695;
                  MR_Word InnerScopeInfo2_706;
                  MR_Word InnerDI_707;
                  MR_Word InnerUO_708;
                  MR_Word BeforeDisjSVarState_738;
                  MR_Word HLDSMainGoal0_739;
                  MR_Word AfterMainSVarState_740;
                  MR_Word MainDisjState_741;
                  MR_Word OrElseDisjStates_742;
                  MR_Word AllDisjStates_743;
                  MR_Word STATE_VARIABLE_UrInfo_2_752;
                  MR_Word STATE_VARIABLE_UrInfo_3_753;
                  MR_Word STATE_VARIABLE_UrInfo_4_754;
                  MR_Word STATE_VARIABLE_SVarState_3_755;

                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_10, InnerStateVar0_694, &InnerStateVar_695);
                  hlds__make_hlds__state_var__svar_start_inner_atomic_scope_7_p_0(Context_209, InnerStateVar_695, &InnerScopeInfo2_706, STATE_VARIABLE_SVarState_0_94, &BeforeDisjSVarState_738, STATE_VARIABLE_UrInfo_0_96, &STATE_VARIABLE_UrInfo_2_752);
                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_8_p_0(LocKind_9, Renaming_10, MainGoal_213, &HLDSMainGoal0_739, BeforeDisjSVarState_738, &AfterMainSVarState_740, STATE_VARIABLE_UrInfo_2_752, &STATE_VARIABLE_UrInfo_3_753);
                  {
                    MainDisjState_741 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, MainDisjState_741, 0) = ((MR_Box) (HLDSMainGoal0_739));
                    MR_hl_field(0, MainDisjState_741, 1) = ((MR_Box) (AfterMainSVarState_740));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_7_p_0(LocKind_9, Renaming_10, OrElseGoals_214, &OrElseDisjStates_742, BeforeDisjSVarState_738, STATE_VARIABLE_UrInfo_3_753, &STATE_VARIABLE_UrInfo_4_754);
                  {
                    AllDisjStates_743 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, AllDisjStates_743, 0) = ((MR_Box) (MainDisjState_741));
                    MR_hl_field(1, AllDisjStates_743, 1) = ((MR_Box) (OrElseDisjStates_742));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_6_p_0(AllDisjStates_743, &HLDSGoals_239, BeforeDisjSVarState_738, &STATE_VARIABLE_SVarState_3_755, STATE_VARIABLE_UrInfo_4_754, STATE_VARIABLE_UrInfo_97);
                  hlds__make_hlds__state_var__svar_finish_inner_atomic_scope_6_p_0(Context_209, InnerScopeInfo2_706, &InnerDI_707, &InnerUO_708, STATE_VARIABLE_SVarState_3_755, STATE_VARIABLE_SVarState_95);
                  {
                    Inner_246 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Inner_246, 0) = ((MR_Box) (InnerDI_707));
                    MR_hl_field(0, Inner_246, 1) = ((MR_Box) (InnerUO_708));
                  }
                }
                else
                {
                  MR_Word InnerDI0_714;
                  MR_Word InnerUO0_715;
                  MR_Word InnerDI_718;
                  MR_Word InnerUO_719;
                  MR_Word HLDSMainGoal0_780;
                  MR_Word AfterMainSVarState_781;
                  MR_Word MainDisjState_782;
                  MR_Word OrElseDisjStates_783;
                  MR_Word AllDisjStates_784;
                  MR_Word STATE_VARIABLE_UrInfo_3_786;
                  MR_Word STATE_VARIABLE_UrInfo_4_787;

                  hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_8_p_0(LocKind_9, Renaming_10, MainGoal_213, &HLDSMainGoal0_780, STATE_VARIABLE_SVarState_0_94, &AfterMainSVarState_781, STATE_VARIABLE_UrInfo_0_96, &STATE_VARIABLE_UrInfo_3_786);
                  {
                    MainDisjState_782 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, MainDisjState_782, 0) = ((MR_Box) (HLDSMainGoal0_780));
                    MR_hl_field(0, MainDisjState_782, 1) = ((MR_Box) (AfterMainSVarState_781));
                  }
                  hlds__make_hlds__goal_expr_to_goal__transform_orelse_goals_7_p_0(LocKind_9, Renaming_10, OrElseGoals_214, &OrElseDisjStates_783, STATE_VARIABLE_SVarState_0_94, STATE_VARIABLE_UrInfo_3_786, &STATE_VARIABLE_UrInfo_4_787);
                  {
                    AllDisjStates_784 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, AllDisjStates_784, 0) = ((MR_Box) (MainDisjState_782));
                    MR_hl_field(1, AllDisjStates_784, 1) = ((MR_Box) (OrElseDisjStates_783));
                  }
                  hlds__make_hlds__state_var__svar_finish_disjunction_6_p_0(AllDisjStates_784, &HLDSGoals_239, STATE_VARIABLE_SVarState_0_94, STATE_VARIABLE_SVarState_95, STATE_VARIABLE_UrInfo_4_787, STATE_VARIABLE_UrInfo_97);
                  InnerDI0_714 = ((MR_Word) ((MR_hl_field(1, Inner0_211, 0))));
                  InnerUO0_715 = ((MR_Word) ((MR_hl_field(1, Inner0_211, 1))));
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_10, InnerDI0_714, &InnerDI_718);
                  parse_tree__prog_rename__rename_var_4_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 1, Renaming_10, InnerUO0_715, &InnerUO_719);
                  {
                    Inner_246 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Inner_246, 0) = ((MR_Box) (InnerDI_718));
                    MR_hl_field(0, Inner_246, 1) = ((MR_Box) (InnerUO_719));
                  }
                }
              }
          ...
          case (MR_Integer) 17:
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  hlds__make_hlds__state_var__add_unravel_err_3_p_0(Spec_635, STATE_VARIABLE_UrInfo_0_96, STATE_VARIABLE_UrInfo_97);
  ...
  MR_Word * STATE_VARIABLE_UrInfo_47)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) MaybeFieldNames_31)) == (MR_Integer) 0))
    {
      ...
      hlds__make_hlds__state_var__add_unravel_oom_errs_3_p_0(OoMFieldNamesSpecs_34, STATE_VARIABLE_UrInfo_0_46, &STATE_VARIABLE_UrInfo_2_63);
  ...
  else
  {
    ...
    hlds__make_hlds__state_var__add_unravel_err_3_p_0(Spec_43, STATE_VARIABLE_UrInfo_6_71, STATE_VARIABLE_UrInfo_47);
  }
}
