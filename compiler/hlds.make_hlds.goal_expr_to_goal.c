          ...
          case (MR_Integer) 14:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals0_637, (MR_Integer) 62, &WarnOccursCheck0_638);
                libs__globals__set_option_4_p_0((MR_Integer) 62, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_3[5])), Globals0_637, &Globals1_639);
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 62, Var_658, Globals2_641, &Globals3_642);
