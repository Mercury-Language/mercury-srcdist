...
static /* final */ const MR_Box hlds__make_hlds__goal_expr_to_goal_scalar_common_2[6][1];
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), RHSTerm_555, 0) = ((MR_Box) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_2[3]));
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          Reason_983 = (MR_Word) (&hlds__make_hlds__goal_expr_to_goal_scalar_common_2[5]);
                        }
                        break;
                    }
                    {
          ...
          case (MR_Integer) 14:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 59, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__goal_expr_to_goal_scalar_common_2[4])), Globals0_634, &Globals1_636);
