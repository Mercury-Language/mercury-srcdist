...
static void MR_CALL 
parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0_4(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_Type_6);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv3_Type_6);
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(0, Var_35, 1) = ((MR_Box) (parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0_2));
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(0, Var_39, 1) = ((MR_Box) (parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0_4));
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(0, Var_37, 1) = ((MR_Box) (parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0_3));
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(0, Var_31, 1) = ((MR_Box) (parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0_1));
