...
MR_decl_label10(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0, 102,3,5,4,9,12,13,11,106,8)
MR_decl_label10(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0, 7,20,22,24,21,19,29,31,33,28)
MR_decl_label3(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0, 37,36,39)
...
MR_decl_label10(parse_tree__prog_type_subst__apply_subst_to_type_3_0, 107,5,4,9,12,13,53,11,7,19)
MR_decl_label10(parse_tree__prog_type_subst__apply_subst_to_type_3_0, 21,20,18,27,29,31,26,35,34,37)
...
MR_decl_label1(parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_3_0, 3)
MR_decl_label2(parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_2_5_0, 3,2)
MR_decl_label10(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0, 100,5,4,9,8,7,14,16,15,13)
MR_decl_label7(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0, 22,24,26,21,30,29,32)
...
MR_BEGIN_MODULE(parse_tree__prog_type_subst_module0)
	...
	MR_init_label1(parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_3_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_3_0);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_3_0_i3);
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_tvar_kind_map_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_type_subst_module5)
	...
	MR_init_label10(parse_tree__prog_type_subst__apply_subst_to_type_3_0,107,5,4,9,12,13,53,11,7,19)
	MR_init_label10(parse_tree__prog_type_subst__apply_subst_to_type_3_0,21,20,18,27,29,31,26,35,34,37)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_type_subst__apply_subst_to_type_3_0);
	...
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i107);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i53);
	}
	MR_sv(3) = MR_r2;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_data__get_type_kind_1_0,
		parse_tree__prog_type_subst__apply_subst_to_type_3_0_i12);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i11);
	}
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("parse_tree.prog_type_subst", 26);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,7)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i18);
	}
	MR_sv(3) = MR_r1;
	...
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_subst_to_type_list_3_0,
		parse_tree__prog_type_subst__apply_subst_to_type_3_0_i19);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i20);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(4);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,20)
	...
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,27)
	...
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i29);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,29)
	...
	MR_np_localcall_lab(parse_tree__prog_type_subst__apply_subst_to_type_3_0,
		parse_tree__prog_type_subst__apply_subst_to_type_3_0_i31);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,26)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_subst_to_type_3_0_i34);
	}
	MR_sv(3) = MR_tfield(3, MR_r2, 2);
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_localcall_lab(parse_tree__prog_type_subst__apply_subst_to_type_3_0,
		parse_tree__prog_type_subst__apply_subst_to_type_3_0_i35);
...
MR_def_label(parse_tree__prog_type_subst__apply_subst_to_type_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_tfield(3, MR_r2, 2);
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_subst_to_type_list_3_0,
...
MR_BEGIN_MODULE(parse_tree__prog_type_subst_module8)
	...
	MR_init_label10(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,102,3,5,4,9,12,13,11,106,8)
	MR_init_label10(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,7,20,22,24,21,19,29,31,33,28)
	MR_init_label3(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,37,36,39)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0);
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,9)
	...
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_data__get_type_kind_1_0,
		parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i12);
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i11);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i102);
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("parse_tree.prog_type_subst", 26);
	MR_r2 = (MR_Word) MR_string_const("predicate \140parse_tree.prog_type_subst.ensure_type_has_kind\'/3", 61);
	MR_r3 = (MR_Word) MR_string_const("substitution not kind preserving", 32);
	MR_np_call_localret_ent(require__unexpected_3_0,
		parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i106);
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i102);
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i19);
	}
	MR_sv(4) = MR_r1;
	MR_sv(1) = MR_tfield(3, MR_r2, 1);
	MR_sv(2) = MR_tfield(3, MR_r2, 3);
	MR_r2 = MR_tfield(3, MR_r2, 2);
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_rec_subst_to_type_list_3_0,
		parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i20);
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i21);
	}
	MR_r1 = MR_sv(4);
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i31);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 5);
...
MR_def_label(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,31)
	...
	MR_np_localcall_lab(parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0,
		parse_tree__prog_type_subst__apply_rec_subst_to_type_3_0_i33);
...
MR_BEGIN_MODULE(parse_tree__prog_type_subst_module14)
	...
	MR_init_label10(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,100,5,4,9,8,7,14,16,15,13)
	MR_init_label7(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,22,24,26,21,30,29,32)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i100);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	if (MR_PTAG_TESTR(MR_r2,1)) {
...
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,4)
	...
	MR_np_call_localret_ent(map__search_3_0,
		parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i9);
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i21);
	}
	MR_sv(3) = MR_r1;
	MR_sv(1) = MR_tfield(3, MR_r2, 2);
	MR_sv(2) = MR_tfield(3, MR_r2, 3);
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_0,
		parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i22);
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i24);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 5);
...
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i29);
	}
	MR_sv(3) = MR_tfield(3, MR_r2, 2);
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_localcall_lab(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,
		parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0_i30);
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_tfield(3, MR_r2, 2);
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_0,
...
MR_decl_entry(parse_tree__prog_data__transform_var_types_3_0);
...
MR_define_entry(mercury__parse_tree__prog_type_subst__apply_variable_renaming_to_vartypes_3_0);
	...
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_r1 = MR_tempr1;
	MR_np_tailcall_ent(parse_tree__prog_data__transform_var_types_3_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
void mercury__parse_tree__prog_type_subst__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parse_tree__prog_type_subst);
