              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    parse_tree__prog_type_subst__apply_rec_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_27, &parse_tree__prog_type_subst__Args_28);
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    parse_tree__prog_type_subst__apply_rec_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_24, &parse_tree__prog_type_subst__Args_25);
                  }
                  {
                    MR_Word base;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Box parse_tree__prog_type_subst__conv0_AppliedType0_19;

                  {
                    parse_tree__prog_type_subst__apply_rec_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_31, &parse_tree__prog_type_subst__Args_32);
                  }
                  {
                    parse_tree__prog_type_subst__succeeded = mercury__map__search_3_p_0((MR_Word) &parse_tree__prog_type_subst_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, parse_tree__prog_type_subst__Subst_4, ((MR_Box) (parse_tree__prog_type_subst__TVar_29)), &parse_tree__prog_type_subst__conv0_AppliedType0_19);
                  }
                  if (parse_tree__prog_type_subst__succeeded)
                    {
                      parse_tree__prog_type_subst__AppliedType0_19 = ((MR_Word) parse_tree__prog_type_subst__conv0_AppliedType0_19);
                      parse_tree__prog_type_subst__succeeded = MR_TRUE;
                    }
                  if (parse_tree__prog_type_subst__succeeded)
                    {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (parse_tree__prog_type_subst__succeeded)
            {
              MR_Word parse_tree__prog_type_subst__V_42_42;

              {
                parse_tree__prog_type_subst__V_42_42 = parse_tree__prog_data__get_type_kind_1_f_0(parse_tree__prog_type_subst__Type1_9);
              }
              {
                parse_tree__prog_type_subst__succeeded = parse_tree__prog_data____Unify____kind_0_0(parse_tree__prog_type_subst__Kind_8, parse_tree__prog_type_subst__V_42_42);
              }
              if (parse_tree__prog_type_subst__succeeded)
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                parse_tree__prog_type_subst__apply_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_25, &parse_tree__prog_type_subst__Args_26);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                parse_tree__prog_type_subst__apply_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_22, &parse_tree__prog_type_subst__Args_23);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Box parse_tree__prog_type_subst__conv0_AppliedType_18;

              {
                parse_tree__prog_type_subst__apply_subst_to_type_list_3_p_0(parse_tree__prog_type_subst__Subst_4, parse_tree__prog_type_subst__Args0_29, &parse_tree__prog_type_subst__Args_30);
              }
              {
                parse_tree__prog_type_subst__succeeded = mercury__map__search_3_p_0((MR_Word) &parse_tree__prog_type_subst_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, parse_tree__prog_type_subst__Subst_4, ((MR_Box) (parse_tree__prog_type_subst__TVar_27)), &parse_tree__prog_type_subst__conv0_AppliedType_18);
              }
              if (parse_tree__prog_type_subst__succeeded)
                {
                  parse_tree__prog_type_subst__AppliedType_18 = ((MR_Word) parse_tree__prog_type_subst__conv0_AppliedType_18);
                  parse_tree__prog_type_subst__succeeded = MR_TRUE;
                }
              if (parse_tree__prog_type_subst__succeeded)
                {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word parse_tree__prog_type_subst__TVar1_40;
          MR_Word parse_tree__prog_type_subst__TypeInfo_8_41 = (MR_Word) &parse_tree__prog_type_subst_scalar_common_1[0];
          MR_Box parse_tree__prog_type_subst__conv1_TVar1_40;

          {
            parse_tree__prog_type_subst__succeeded = mercury__map__search_3_p_0(parse_tree__prog_type_subst__TypeInfo_8_41, parse_tree__prog_type_subst__TypeInfo_8_41, parse_tree__prog_type_subst__Renaming_4, ((MR_Box) (parse_tree__prog_type_subst__TVar0_7)), &parse_tree__prog_type_subst__conv1_TVar1_40);
          }
          if (parse_tree__prog_type_subst__succeeded)
            {
              parse_tree__prog_type_subst__TVar1_40 = ((MR_Word) parse_tree__prog_type_subst__conv1_TVar1_40);
              parse_tree__prog_type_subst__succeeded = MR_TRUE;
            }
          if (parse_tree__prog_type_subst__succeeded)
            parse_tree__prog_type_subst__TVar_9 = parse_tree__prog_type_subst__TVar1_40;
          else
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_p_0(parse_tree__prog_type_subst__Renaming_4, parse_tree__prog_type_subst__Args0_24, &parse_tree__prog_type_subst__Args_25);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_p_0(parse_tree__prog_type_subst__Renaming_4, parse_tree__prog_type_subst__Args0_21, &parse_tree__prog_type_subst__Args_22);
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word parse_tree__prog_type_subst__Args0_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), parse_tree__prog_type_subst__Type0_5, (MR_Integer) 2)));
              MR_Word parse_tree__prog_type_subst__Args_30;
              MR_Word parse_tree__prog_type_subst__TVar1_35;
              MR_Word parse_tree__prog_type_subst__TypeInfo_8_36;
              MR_Box parse_tree__prog_type_subst__conv0_TVar1_35;

              {
                parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_p_0(parse_tree__prog_type_subst__Renaming_4, parse_tree__prog_type_subst__Args0_29, &parse_tree__prog_type_subst__Args_30);
              }
              parse_tree__prog_type_subst__TypeInfo_8_36 = (MR_Word) &parse_tree__prog_type_subst_scalar_common_1[0];
              {
                parse_tree__prog_type_subst__succeeded = mercury__map__search_3_p_0(parse_tree__prog_type_subst__TypeInfo_8_36, parse_tree__prog_type_subst__TypeInfo_8_36, parse_tree__prog_type_subst__Renaming_4, ((MR_Box) (parse_tree__prog_type_subst__TVar0_26)), &parse_tree__prog_type_subst__conv0_TVar1_35);
              }
              if (parse_tree__prog_type_subst__succeeded)
                {
                  parse_tree__prog_type_subst__TVar1_35 = ((MR_Word) parse_tree__prog_type_subst__conv0_TVar1_35);
                  parse_tree__prog_type_subst__succeeded = MR_TRUE;
                }
              if (parse_tree__prog_type_subst__succeeded)
                parse_tree__prog_type_subst__TVar_28 = parse_tree__prog_type_subst__TVar1_35;
              else
