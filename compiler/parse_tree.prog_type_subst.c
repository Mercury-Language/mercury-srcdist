          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Args_22;
              MR_Word Var_54;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type0_5, (MR_Integer) 1)));
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type0_5, (MR_Integer) 4)));
