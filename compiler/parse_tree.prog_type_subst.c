  ...
  MR_Word * STATE_VARIABLE_KindMap_12)
{
  ...
  MR_Word TVar_10;
  MR_Word TVar1_16;
  MR_Box conv0_TVar1_16;

  succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_type_subst_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_type_subst_scalar_common_1[0]), Renaming_6, ((MR_Box) (TVar0_7)), &conv0_TVar1_16);
  if (succeeded)
  {
    TVar1_16 = ((MR_Word) (conv0_TVar1_16));
    succeeded = MR_TRUE;
  }
  if (succeeded)
    TVar_10 = TVar1_16;
