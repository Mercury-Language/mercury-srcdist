  ...
  MR_Word * STATE_VARIABLE_PDInfo_41)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word InstMap0_60;
    MR_Word VersionInsts_61;
    MR_Integer VersionInstSizes_62;
    MR_Word ConjNonLocalsList_63;
    MR_Word STATE_VARIABLE_PDInfo_50_78;
    MR_Word InstMap_64;
    MR_Word ArgInsts_65;
    MR_Integer NewInstSizes_66;

    transform_hlds__pd_info__pd_info_get_module_info_2_p_0(STATE_VARIABLE_PDInfo_0_40, &ModuleInfo_59);
    transform_hlds__pd_debug__pd_debug_message_5_p_0(STATE_VARIABLE_PDInfo_0_40, (MR_String) "goals match, trying MSG\n", (MR_Word) ((MR_Unsigned) 0U));
    transform_hlds__pd_info__pd_info_get_instmap_2_p_0(STATE_VARIABLE_PDInfo_0_40, &InstMap0_60);
    hlds__instmap__instmap_lookup_vars_3_p_0(VersionInstMap_30, VersionArgVars_28, &VersionInsts_61);
    transform_hlds__pd_util__inst_list_size_3_p_0(ModuleInfo_59, VersionInsts_61, &VersionInstSizes_62);
    parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ConjNonLocals_16, &ConjNonLocalsList_63);
    succeeded = transform_hlds__deforest__try_MSG_6_p_0(ModuleInfo_59, VersionInstMap_30, Renaming_38, VersionArgVars_28, InstMap0_60, &InstMap_64);
    if (succeeded)
    {
      hlds__instmap__instmap_lookup_vars_3_p_0(InstMap_64, ConjNonLocalsList_63, &ArgInsts_65);
      transform_hlds__pd_util__inst_list_size_3_p_0(ModuleInfo_59, ArgInsts_65, &NewInstSizes_66);
      succeeded = (NewInstSizes_66 < VersionInstSizes_62);
    }
    if (succeeded)
    {
      MR_Word STATE_VARIABLE_PDInfo_47_75;
      MR_Word Var_77;
      ...
      transform_hlds__pd_info__pd_info_set_instmap_3_p_0(InstMap_64, STATE_VARIABLE_PDInfo_0_40, &STATE_VARIABLE_PDInfo_47_75);
      {
        Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (CoveringPredProcId_19));
      }
      transform_hlds__deforest__create_deforest_goal_12_p_0(EarlierGoal_12, BetweenGoals_13, MaybeLaterGoal_14, FoldGoal_15, ConjNonLocals_16, (MR_Integer) 1, ProcPair_17, Size_18, Var_77, MaybeGoal_20, STATE_VARIABLE_PDInfo_47_75, &STATE_VARIABLE_PDInfo_50_78);
    }
    else
    {
      ...
      *MaybeGoal_20 = (MR_Word) ((MR_Unsigned) 0U);
      STATE_VARIABLE_PDInfo_50_78 = STATE_VARIABLE_PDInfo_0_40;
    }
    transform_hlds__pd_info__pd_info_set_instmap_3_p_0(InstMap0_60, STATE_VARIABLE_PDInfo_50_78, STATE_VARIABLE_PDInfo_41);
  }
  else
  {
    MR_Word Renaming_56;

    succeeded = transform_hlds__deforest__match_generalised_version_11_p_0(ModuleInfo_22, VersionGoal_26, VersionArgVars_28, VersionArgTypes_29, EarlierGoal_12, BetweenGoals_13, MaybeLaterGoal_14, ConjNonLocals_16, VarTable_37, Versions_35, &Renaming_56);
    if (succeeded)
    {
      transform_hlds__pd_debug__pd_debug_message_5_p_0(STATE_VARIABLE_PDInfo_0_40, (MR_String) "matched with generalised version\n", (MR_Word) ((MR_Unsigned) 0U));
      transform_hlds__deforest__do_generalisation_14_p_0(VersionArgVars_28, Renaming_56, VersionInstMap_30, EarlierGoal_12, BetweenGoals_13, MaybeLaterGoal_14, FoldGoal_15, ConjNonLocals_16, ProcPair_17, Size_18, CoveringPredProcId_19, MaybeGoal_20, STATE_VARIABLE_PDInfo_0_40, STATE_VARIABLE_PDInfo_41);
    }
    else
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_83, (MR_Integer) 0))));
            Var_93 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_83, (MR_Integer) 1))));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Var_86 = (MR_Word) (&transform_hlds__deforest_scalar_common_4[0]);
                      {
                        ...
                        MR_hl_field(MR_mktag(2), NonGeneralFirstGoalExpr_75, 3) = (MR_Box) ((MR_Unsigned) (Var_84));
                        MR_hl_field(MR_mktag(2), NonGeneralFirstGoalExpr_75, 4) = ((MR_Box) (Var_85));
                        MR_hl_field(MR_mktag(2), NonGeneralFirstGoalExpr_75, 5) = ((MR_Box) (Var_86));
                      }
                      {
