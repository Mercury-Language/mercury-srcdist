...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 94, &DebugPD_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 94, &DebugPD_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 94, &DebugPD_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 94, &DebugPD_28);
...
{
  {
    ...
    (env).transform_hlds__deforest__deforest_call_9_p_0_env_0__BuiltinState_14 = BuiltinState_14;
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 94, &DebugPD_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 94, &DebugPD_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 94, &DebugPD_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 94, &DebugPD_13);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 205, &FullyStrict_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 94, &DebugPD_19);
...
{
  {
...

    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 94, &DebugPD_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 94, &DebugPD_37);
        {
...
{
  {
    ...
    (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 94, &DebugPD_17);
      ...
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 205, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_20);
