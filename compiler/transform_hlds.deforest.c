      ...
      case (MR_Integer) 1:
        {
          ...
          transform_hlds__pd_debug__pd_debug_message_5_p_0(STATE_VARIABLE_PDInfo_0_47, (MR_String) "global termination check succeeded - creating new version\n", (MR_Word) ((MR_Unsigned) 0U));
  ...
  MR_Word * STATE_VARIABLE_PDInfo_75)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      transform_hlds__pd_debug__pd_debug_message_5_p_0(STATE_VARIABLE_PDInfo_90_90, (MR_String) "not enough improvement - not inlining: cost(%i) size(%i)\n", Var_107);
