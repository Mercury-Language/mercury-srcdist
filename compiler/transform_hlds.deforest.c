  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        transform_hlds__deforest__get_sub_conj_nonlocals_9_p_0(NonLocals_2, HeadVar__3_3, (MR_Word) ((MR_Unsigned) 0U), Goal0_13, Constraints_32, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Goals1_33, &ConjNonLocals_38);
