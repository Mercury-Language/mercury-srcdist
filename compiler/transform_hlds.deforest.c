...
struct transform_hlds__deforest__deforest_call_9_p_0_env_0_s {
  ...
  MR_Word transform_hlds__deforest__deforest_call_9_p_0_env_0__TypeCtorInfo_212_212;
  ...
  MR_Word transform_hlds__deforest__deforest_call_9_p_0_env_0__Var_211;
...
static void MR_CALL 
transform_hlds__deforest__IntroducedFrom__pred__get_sub_conj_nonlocals__1662__1_3_p_0(
...
static MR_bool MR_CALL 
transform_hlds__deforest____Unify______listlist_1_1(
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 92, &DebugPD_19);
    ...
    if (succeeded)
    {
      ...
      TypeRenaming_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeVersion_15, (MR_Integer) 4))));
      {
        ...
        FoldPredName_28 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo0_27, VersionPredId_25);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_52, 1) = ((MR_Box) (FoldPredName_28));
        }
        {
        ...
        SizeDelta_32 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) NegSizeDelta_31);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_71 = mercury__string__f_43_43_2_f_0((MR_String) "global termination check succeeded - ", (MR_String) "creating new version\n");
            transform_hlds__pd_debug__pd_debug_message_5_p_0(DebugPD_19, Var_71, (MR_Word) ((MR_Unsigned) 0U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 92, &DebugPD_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 92, &DebugPD_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 92, &DebugPD_28);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        transform_hlds__pd_info__define_new_pred_6_p_0((MR_Word) (MR_mkword(MR_mktag(3), &transform_hlds__deforest_scalar_common_1[10])), DeforestGoal_54, &PredProcId_59, &CallGoal_60, STATE_VARIABLE_PDInfo_102_102, &STATE_VARIABLE_PDInfo_104_104);
        ...
        transform_hlds__pd_info__register_version_4_p_0(PredProcId_59, VersionInfo_78, STATE_VARIABLE_PDInfo_123_123, &STATE_VARIABLE_PDInfo_124_124);
        ...
        hlds__passes_aux__write_proc_progress_message_6_p_0((MR_String) "% Back in ", CurrPredId_85, CurrProcId_86, ModuleInfo_63);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__succeeded = check_hlds__inst_test__inst_is_bound_to_functors_3_p_0((env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__ModuleInfo_19, (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__ArgInst_37, &(env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__Var_211);
      if ((env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__succeeded)
      {
        (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__TypeCtorInfo_212_212 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0);
        (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__succeeded = transform_hlds__deforest____Unify______listlist_1_1((env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__TypeCtorInfo_212_212, (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__Var_51, (env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__Var_211);
        if ((env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__succeeded)
        {
      ...
      {
        {
          ...
          if ((env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__succeeded)
          {
            ...
            TypeCtorInfo_210_210 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
            mercury__set__member_2_p_1(TypeCtorInfo_210_210, &(env_ptr)->transform_hlds__deforest__deforest_call_9_p_0_env_0__conv1_LeftArg_35, LeftArgs_33, transform_hlds__deforest__deforest_call_9_p_0_3, env_ptr);
          }
        }
...
{
  {
    ...
    (env).transform_hlds__deforest__deforest_call_9_p_0_env_0__BuiltinState_14 = BuiltinState_14;
    {
      ...
      Var_148 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 21)) & (MR_Integer) 1);
      Var_149 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 20)) & (MR_Integer) 1);
      Var_150 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 19)) & (MR_Integer) 1);
      Var_151 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 18)) & (MR_Integer) 1);
      Var_152 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 17)) & (MR_Integer) 1);
      Var_153 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
      Var_154 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
      Var_155 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
      Var_156 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 13)) & (MR_Integer) 1);
      Var_157 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 12)) & (MR_Integer) 1);
      Var_158 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 11)) & (MR_Integer) 1);
      Var_159 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 10)) & (MR_Integer) 1);
      Var_160 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 9)) & (MR_Integer) 1);
      Var_161 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 8)) & (MR_Integer) 1);
      Var_162 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 7)) & (MR_Integer) 1);
      Var_163 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 6)) & (MR_Integer) 1);
      Var_164 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 5)) & (MR_Integer) 1);
      Var_165 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 4)) & (MR_Integer) 1);
      Var_166 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 3)) & (MR_Integer) 1);
      Var_167 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 2)) & (MR_Integer) 1);
      Var_168 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
      Var_169 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 2))) & (MR_Integer) 1);
      Var_170 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 3))));
      Var_171 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 4))));
      Var_172 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 5))));
      Var_173 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 6))));
      Var_174 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 7))));
      Var_175 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 8))));
      Var_176 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 9))));
      Var_177 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 10))));
      Var_178 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 11))));
      Var_179 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 12))));
      Var_180 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 13))));
      Var_181 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 14))));
      Var_182 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 15))));
      Var_183 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 16))));
      Var_184 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 17))));
      Var_185 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 18))));
      Var_186 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 19))));
      Var_187 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 20))));
      Var_188 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 21))));
      Var_189 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 22))));
      ...
      Var_190 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 24))));
      Var_191 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 25))));
      Var_192 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 26))));
      Var_193 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 27))));
      Var_194 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 28))));
      Var_195 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 29))));
      Var_196 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 30))));
      Var_197 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 31))));
      Var_198 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 32))));
      Var_199 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 33))));
      Var_200 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 34))));
      Var_201 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 35))));
      Var_202 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 36))));
      Var_203 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 37))));
      Var_204 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 38))));
      Var_205 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 39))));
      Var_206 = ((MR_String) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 40))));
      libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 92, &DebugPD_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 92, &DebugPD_18);
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    PropConstraints_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_18, (MR_Integer) 0))) >> 24)) & (MR_Integer) 1);
                    Deforest_19 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_18, (MR_Integer) 1))) >> 28)) & (MR_Integer) 1);
                    switch (Deforest_19) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 92, &DebugPD_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 92, &DebugPD_13);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 203, &FullyStrict_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 92, &DebugPD_19);
...
{
  {
...

    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 92, &DebugPD_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 92, &DebugPD_37);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_53, 1) = ((MR_Box) (SymNameString_35));
        }
        {
          Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
    {
      ...
      Var_161 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 21)) & (MR_Integer) 1);
      Var_162 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 20)) & (MR_Integer) 1);
      Var_163 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 19)) & (MR_Integer) 1);
      Var_164 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 18)) & (MR_Integer) 1);
      Var_165 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 17)) & (MR_Integer) 1);
      Var_166 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
      Var_167 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
      Var_168 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
      Var_169 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 13)) & (MR_Integer) 1);
      Var_170 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 12)) & (MR_Integer) 1);
      Var_171 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 11)) & (MR_Integer) 1);
      Var_172 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 10)) & (MR_Integer) 1);
      Var_173 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 9)) & (MR_Integer) 1);
      Var_174 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 8)) & (MR_Integer) 1);
      Var_175 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 7)) & (MR_Integer) 1);
      Var_176 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 6)) & (MR_Integer) 1);
      Var_177 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 5)) & (MR_Integer) 1);
      Var_178 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 4)) & (MR_Integer) 1);
      Var_179 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 3)) & (MR_Integer) 1);
      Var_180 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 2)) & (MR_Integer) 1);
      Var_181 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
      Var_182 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 2))) & (MR_Integer) 1);
      Var_183 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 3))));
      Var_184 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 4))));
      Var_185 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 5))));
      Var_186 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 6))));
      Var_187 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 7))));
      Var_188 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 8))));
      Var_189 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 9))));
      Var_190 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 10))));
      Var_191 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 11))));
      Var_192 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 12))));
      Var_193 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 13))));
      Var_194 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 14))));
      Var_195 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 15))));
      Var_196 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 16))));
      Var_197 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 17))));
      Var_198 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 18))));
      Var_199 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 19))));
      MaxDepth_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 20))));
      Var_200 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 21))));
      Var_201 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 22))));
      Var_202 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 23))));
      Var_203 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 24))));
      Var_204 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 25))));
      Var_205 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 26))));
      Var_206 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 27))));
      Var_207 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 28))));
      Var_208 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 29))));
      Var_209 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 30))));
      Var_210 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 31))));
      Var_211 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 32))));
      Var_212 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 33))));
      Var_213 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 34))));
      Var_214 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 35))));
      Var_215 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 36))));
      Var_216 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 37))));
      Var_217 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 38))));
      Var_218 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 39))));
      Var_219 = ((MR_String) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 40))));
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 92, &DebugPD_17);
      ...
      Var_220 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 31)) & (MR_Integer) 1);
      Var_221 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 30)) & (MR_Integer) 1);
      Var_222 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 29)) & (MR_Integer) 1);
      Var_223 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 28)) & (MR_Integer) 1);
      Var_224 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 27)) & (MR_Integer) 1);
      Var_225 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 26)) & (MR_Integer) 1);
      Var_226 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 25)) & (MR_Integer) 1);
      Var_227 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 24)) & (MR_Integer) 1);
      Var_228 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 23)) & (MR_Integer) 1);
      Var_229 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 22)) & (MR_Integer) 1);
      Var_230 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 21)) & (MR_Integer) 1);
      Var_231 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 20)) & (MR_Integer) 1);
      Var_232 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 19)) & (MR_Integer) 1);
      Var_233 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 18)) & (MR_Integer) 1);
      Var_234 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 17)) & (MR_Integer) 1);
      Var_235 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 16)) & (MR_Integer) 1);
      Var_236 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 15)) & (MR_Integer) 1);
      Var_237 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 14)) & (MR_Integer) 1);
      Var_238 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 13)) & (MR_Integer) 1);
      Var_239 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 12)) & (MR_Integer) 1);
      Var_240 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 11)) & (MR_Integer) 1);
      Var_241 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 10)) & (MR_Integer) 1);
      Var_242 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 9)) & (MR_Integer) 1);
      Var_243 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 8)) & (MR_Integer) 1);
      Var_244 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 7)) & (MR_Integer) 1);
      Var_245 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 6)) & (MR_Integer) 1);
      Var_246 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 5)) & (MR_Integer) 1);
      Var_247 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 4)) & (MR_Integer) 1);
      Var_248 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 3)) & (MR_Integer) 1);
      Var_249 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      Var_250 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
      Var_251 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 0))) & (MR_Integer) 1);
      packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1)));
      Var_252 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 31)) & (MR_Integer) 1);
      Var_253 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 30)) & (MR_Integer) 1);
      Var_254 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 29)) & (MR_Integer) 1);
      Var_255 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 28)) & (MR_Integer) 1);
      Var_256 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 27)) & (MR_Integer) 1);
      Var_257 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 26)) & (MR_Integer) 1);
      Var_258 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 25)) & (MR_Integer) 1);
      Var_259 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 24)) & (MR_Integer) 1);
      Var_260 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 23)) & (MR_Integer) 1);
      Var_261 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 22)) & (MR_Integer) 1);
      Var_262 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 21)) & (MR_Integer) 1);
      Var_263 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 20)) & (MR_Integer) 1);
      Var_264 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 19)) & (MR_Integer) 1);
      Var_265 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 18)) & (MR_Integer) 1);
      Var_266 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 17)) & (MR_Integer) 1);
      Var_267 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 16)) & (MR_Integer) 1);
      Var_268 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 15)) & (MR_Integer) 1);
      Var_269 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 14)) & (MR_Integer) 1);
      Var_270 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
      Var_271 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 12)) & (MR_Integer) 1);
      Var_272 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 11)) & (MR_Integer) 1);
      Var_273 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
      Var_274 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 9)) & (MR_Integer) 1);
      Var_275 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 8)) & (MR_Integer) 1);
      Var_276 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 7)) & (MR_Integer) 1);
      Var_277 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 6)) & (MR_Integer) 1);
      Var_278 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 5)) & (MR_Integer) 1);
      Var_279 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 4)) & (MR_Integer) 1);
      Var_280 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 3)) & (MR_Integer) 1);
      Var_281 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);
      Var_282 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
      Var_283 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_15, (MR_Integer) 1))) & (MR_Integer) 1);
      ...
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 203, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_20);
...
{
  {
    ...
    transform_hlds__deforest__IntroducedFrom__pred__get_sub_conj_nonlocals__1662__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_31);
...
{
  {
    ...
    PropConstraints_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_19, (MR_Integer) 0))) >> 24)) & (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      FoundErrors_26 = parse_tree__error_util__contains_errors_2_f_0(Globals_18, Specs_25);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&transform_hlds__deforest_scalar_common_5[0]));
