  ...
  MR_Word PDInfo_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 240, &FullyStrict_20);
  ...
  MR_Word * STATE_VARIABLE_PDInfo_55)
{
  ...
  (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
  {
    ...
    libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 240, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_19);
