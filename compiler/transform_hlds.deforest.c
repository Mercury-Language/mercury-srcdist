...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeVersion_15, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_84, (MR_Integer) 3)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_89, (MR_Integer) 3)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), EarlierGoalExpr_28, (MR_Integer) 3)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), LaterGoalExpr_64, (MR_Integer) 3)));
          }
        }
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_PDInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_25, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_23;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), EarlierGoalExpr_17, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_98, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_99, (MR_Integer) 3)));
            }
          }
          if (succeeded)
          {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_111, (MR_Integer) 3)));
                {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_67;
          MR_Word Var_68;
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_7, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_30;
              MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_33, (MR_Integer) 2)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_44, (MR_Integer) 3)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_24, (MR_Integer) 3)));
