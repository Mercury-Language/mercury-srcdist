...
MR_decl_label8(transform_hlds__deforest__deforest_goal_expr_6_0, 41,45,48,44,52,51,151,150)
...
MR_def_label(transform_hlds__deforest__propagate_conj_constraints_6_0,5)
	...
	MR_sv(6) = MR_r1;
	MR_sv(7) = MR_tfield(2, MR_tempr1, 5);
	MR_r2 = MR_tfield(2, MR_tempr1, 0);
	}
...
MR_BEGIN_MODULE(transform_hlds__deforest_module16)
	...
	MR_init_label8(transform_hlds__deforest__deforest_goal_expr_6_0,41,45,48,44,52,51,151,150)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,41)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__deforest__deforest_goal_expr_6_0_i150);
	}
	}
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,45)
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(transform_hlds__deforest__deforest_goal_4_0,
		transform_hlds__deforest__deforest_goal_expr_6_0_i48);
...
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,44)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(transform_hlds__deforest__deforest_goal_expr_6_0_i51);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__deforest__deforest_cases_5_0,
		transform_hlds__deforest__deforest_goal_expr_6_0_i52);
...
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,151)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__deforest__deforest_goal_expr_6_0,150)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(transform_hlds__deforest__handle_deforestation_9_0,21)
	...
	MR_sv(9) = MR_tfield(2, MR_tempr2, 0);
	MR_sv(20) = MR_r2;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_tfield(2, MR_tempr1, 0);
	}
