...
MR_decl_static(transform_hlds__deforest__IntroducedFrom__pred__propagate_conj_constraints__493__1_1_0)
...
{
MR_COMMON(6,0),
MR_ENTRY_AP(transform_hlds__deforest__IntroducedFrom__pred__propagate_conj_constraints__493__1_1_0),
0
},
{
MR_COMMON(4,7),
...
MR_BEGIN_MODULE(transform_hlds__deforest_module37)
	MR_init_entry1(transform_hlds__deforest__IntroducedFrom__pred__propagate_conj_constraints__493__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__deforest__IntroducedFrom__pred__propagate_conj_constraints__493__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__propagate_conj_constraints__493__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__deforest__IntroducedFrom__pred__propagate_conj_constraints__493__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_r2 = (MR_Integer) 0;
