...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 88, &DebugPD_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 88, &DebugPD_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 88, &DebugPD_30);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 416, &VarsOpt_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 88, &DebugPD_27);
...
{
  {
    ...
    (env).transform_hlds__deforest__deforest_call_9_p_0_env_0__BuiltinState_14 = BuiltinState_14;
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 417, &(env).transform_hlds__deforest__deforest_call_9_p_0_env_0__SizeThreshold_28);
      libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 88, &DebugPD_29);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 88, &DebugPD_18);
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_16, &Globals_17);
                    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 413, &Deforestation_18);
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 372, &Constraints_19);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 416, &VarsOpt_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 88, &DebugPD_27);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 415, &Factor_72);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 88, &DebugPD_13);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 189, &FullyStrict_21);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 415, &Factor_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 88, &DebugPD_18);
...
{
  {
...

    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 88, &DebugPD_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 88, &DebugPD_37);
        {
...
{
  {
    ...
    (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
    {
      ...
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 414, &DepthLimitOpt_15);
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 88, &DebugPD_16);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 417, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__SizeLimit_18);
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 189, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 372, &Constraints_19);
