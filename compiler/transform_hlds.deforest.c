...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 210, &FullyStrict_21);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 98, &DebugPD_37);
        {
...
{
  {
    ...
    (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
    {
      ...
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 210, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_20);
