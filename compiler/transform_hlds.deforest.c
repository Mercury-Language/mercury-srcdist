...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MaybeVersion_15, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_84, (MR_Integer) 3)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_89, (MR_Integer) 3)));
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 410, &VarsOpt_26);
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), EarlierGoalExpr_28, (MR_Integer) 3)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), LaterGoalExpr_64, (MR_Integer) 3)));
          }
        }
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_PDInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_25, (MR_Integer) 1)));
...
{
  {
    ...
    (env).transform_hlds__deforest__deforest_call_9_p_0_env_0__BuiltinState_14 = BuiltinState_14;
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 411, &(env).transform_hlds__deforest__deforest_call_9_p_0_env_0__SizeThreshold_28);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_23;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), EarlierGoalExpr_17, (MR_Integer) 2)));
              ...
              transform_hlds__deforest__append_goal_to_cases_10_p_0(Var1_19, BetweenGoals_12, LaterGoal_13, CaseNonLocals_22, (MR_Integer) 1, DeforestInfo_10, Cases1_21, &Cases_23, STATE_VARIABLE_PDInfo_0_87, &STATE_VARIABLE_PDInfo_101_101);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_24, 2) = (MR_Box) (packed_args_0);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_98, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_99, (MR_Integer) 3)));
            }
          }
          if (succeeded)
          {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_111, (MR_Integer) 3)));
                {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_67;
          MR_Word Var_68;
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_7, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_16, &Globals_17);
                    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 407, &Deforestation_18);
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 366, &Constraints_19);
              ...
              }
              {
                ...
                *GoalExpr_8 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_30;
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2)));
              ...
              transform_hlds__deforest__deforest_cases_5_p_0(Var_27, Cases0_29, &Cases_30, STATE_VARIABLE_PDInfo_0_62, STATE_VARIABLE_PDInfo_63);
              {
                ...
                *GoalExpr_8 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 2) = (MR_Box) (packed_args_3);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_33, (MR_Integer) 2)));
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 410, &VarsOpt_22);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 409, &Factor_72);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 409, &Factor_17);
...
{
  {
...

    {
      ...
      if ((env).transform_hlds__deforest__should_try_deforestation_4_p_0_env_0__succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_50, (MR_Integer) 3)));
        ...
        if ((env).transform_hlds__deforest__should_try_deforestation_4_p_0_env_0__succeeded)
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_51, (MR_Integer) 3)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_44, (MR_Integer) 3)));
        ...
        {
          {
            ...
            if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
            {
              ...
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_69, (MR_Integer) 3)));
          ...
          }
          {
            ...
            if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
            {
              ...
              if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_68, (MR_Integer) 3)));
      ...
      {
        {
          ...
          if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
          {
            ...
            packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), EarlierGoalExpr_38, (MR_Integer) 3)));
        ...
        }
        {
          ...
          if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
            {
              ...
              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), LaterGoalExpr_44, (MR_Integer) 3)));
      ...
      {
        {
          ...
          if ((env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__succeeded)
          {
            packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__FullyStrictOp_19, (MR_Integer) 0)));
...
{
  {
    ...
    (env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__MaybeLaterGoal_9 = MaybeLaterGoal_9;
    {
      ...
      libs__globals__lookup_option_3_p_0(Globals_14, (MR_Integer) 408, &DepthLimitOpt_15);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_14, (MR_Integer) 411, &(env).transform_hlds__deforest__can_optimize_conj_6_p_0_env_0__SizeLimit_18);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_24, (MR_Integer) 3)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 366, &Constraints_19);
