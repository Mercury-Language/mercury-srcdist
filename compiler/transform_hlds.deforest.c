...
{
  MR_bool succeeded;
  MR_Word GoalInfo0_27 = ((MR_Word) ((MR_hl_field(0, Goal0_23, (MR_Integer) 1))));
  ...
  GoalInfo1_49 = ((MR_Word) ((MR_hl_field(0, Goal1_35, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_PDInfo_41)
{
  ...
  if (succeeded)
    switch (CheckImprovement_16) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word GoalExpr_78 = ((MR_Word) ((MR_hl_field(0, OptGoal_27, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    *Goal_28 = OptGoal_27;
    ...
    GoalInfo_38 = ((MR_Word) ((MR_hl_field(0, *Goal_28, (MR_Integer) 1))));
