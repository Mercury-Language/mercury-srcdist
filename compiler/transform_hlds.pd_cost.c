...
MR_decl_label10(transform_hlds__pd_cost__goal_expr_cost_3_0, 78,41,24,80,28,29,79,16,17,46)
MR_decl_label10(transform_hlds__pd_cost__goal_expr_cost_3_0, 82,5,4,8,9,10,83,13,84,19)
MR_decl_label7(transform_hlds__pd_cost__goal_expr_cost_3_0, 20,21,22,30,31,36,38)
MR_decl_label10(transform_hlds__pd_cost__unify_cost_3_0, 46,8,10,47,14,13,19,20,48,3)
MR_decl_label2(transform_hlds__pd_cost__unify_cost_3_0, 25,4)
...
MR_decl_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__158__1_2_0)
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module8)
	...
	MR_init_label10(transform_hlds__pd_cost__unify_cost_3_0,46,8,10,47,14,13,19,20,48,3)
	MR_init_label2(transform_hlds__pd_cost__unify_cost_3_0,25,4)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,47)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__158__1_2_0);
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module10)
	...
	MR_init_label10(transform_hlds__pd_cost__goal_expr_cost_3_0,78,41,24,80,28,29,79,16,17,46)
	MR_init_label10(transform_hlds__pd_cost__goal_expr_cost_3_0,82,5,4,8,9,10,83,13,84,19)
	MR_init_label7(transform_hlds__pd_cost__goal_expr_cost_3_0,20,21,22,30,31,36,38)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__goal_expr_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i24) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i79) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i46));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,78)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i41);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,24)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i80);
	}
	MR_r1 = (MR_Integer) 3;
	MR_proceed();
	}
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,17)
	...
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tfield(3, MR_r1, 0),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i82) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i10) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i83) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i38) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i22) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i30) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i84) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i36));
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (((MR_Integer) MR_sv(1) + (MR_Integer) 3) + ((MR_Integer) 1 * (MR_Integer) MR_r1));
	MR_decr_sp_and_return(3);
...
MR_def_label(transform_hlds__pd_cost__cases_cost_3_0,3)
	...
	MR_sv(2) = MR_tfield(1, MR_tempr3, 1);
	MR_tempr1 = MR_tempr3;
	MR_tempr2 = MR_tfield(0, MR_tfield(1, MR_tempr3, 0), 2);
	MR_r1 = MR_tfield(0, MR_tempr2, 0);
	MR_r2 = MR_tfield(0, MR_tempr2, 1);
	}
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_expr_cost_3_0,
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module16)
	MR_init_entry1(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__158__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__158__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__unify_cost__158__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__158__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
