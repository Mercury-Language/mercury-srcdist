            ...
            case (MR_Integer) 1:
              {
                ...
                Var_70 = (Var_71 * InputArgs_30);
                *Cost_4 = (Var_67 + Var_70);
              }
              break;
          }
        }
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_55 = (Cost1_82 + Var_56);
              Var_58 = transform_hlds__pd_cost__cost_of_reg_assign_0_f_0();
              Var_57 = (Var_58 * InputArgs_85);
              *Cost_4 = (Var_55 + Var_57);
            }
            break;
          case (MR_Integer) 2:
            {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_32, (MR_Integer) 2)));
          ...
          case (MR_Integer) 6:
            {
              ...
              Var_72 = (Cost1_20 + Cost2_21);
              *Cost_4 = (Var_72 + Cost3_22);
            }
            break;
          case (MR_Integer) 7:
            {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  Var_78 = (Var_79 * InputArgs_38);
                  Cost1_9 = (Var_75 + Var_78);
                }
                break;
            }
          }
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_63 = (Cost1_90 + Var_64);
                Var_66 = transform_hlds__pd_cost__cost_of_reg_assign_0_f_0();
                Var_65 = (Var_66 * InputArgs_93);
                Cost1_9 = (Var_63 + Var_65);
              }
              break;
            case (MR_Integer) 2:
              {
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_40, (MR_Integer) 2)));
            ...
            case (MR_Integer) 6:
              {
                ...
                Var_80 = (Cost1_28 + Cost2_29);
                Cost1_9 = (Var_80 + Cost3_30);
              }
              break;
            case (MR_Integer) 7:
              {
