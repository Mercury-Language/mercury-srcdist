...
#line 27 "transform_hlds.pd_cost.c"
#line 142 "../library/io.int2"
#include "string.mh"

#line 31 "transform_hlds.pd_cost.c"
#line 87 "../library/table_builtin.int2"
#include "table_builtin.mh"

#line 35 "transform_hlds.pd_cost.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 39 "transform_hlds.pd_cost.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "transform_hlds.pd_cost.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 47 "transform_hlds.pd_cost.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 51 "transform_hlds.pd_cost.c"
#line 52 "transform_hlds.pd_cost.c"
#include "transform_hlds.pd_cost.mh"

#line 55 "transform_hlds.pd_cost.c"
#line 56 "transform_hlds.pd_cost.c"
#ifndef TRANSFORM_HLDS__PD_COST_DECL_GUARD
#define TRANSFORM_HLDS__PD_COST_DECL_GUARD

#line 60 "transform_hlds.pd_cost.c"
#line 61 "transform_hlds.pd_cost.c"

#endif
#line 64 "transform_hlds.pd_cost.c"
...
MR_decl_label3(transform_hlds__pd_cost__cases_cost_3_0, 11,4,3)
MR_decl_label3(transform_hlds__pd_cost__goal_costs_3_0, 11,4,3)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 74,5,7,76,11,12,13,14)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 15,75,18,19,20,21,23,78)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 26,25,28,30,31,32,33,34)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 79,37,38,80,40,42,44,81)
MR_decl_label5(transform_hlds__pd_cost__goal_expr_cost_3_0, 47,48,49,82,51)
MR_decl_label8(transform_hlds__pd_cost__unify_cost_3_0, 37,6,8,38,12,11,13,14)
MR_decl_label4(transform_hlds__pd_cost__unify_cost_3_0, 39,15,16,17)
...
MR_decl_static(fn__transform_hlds__pd_cost__this_file_0_0)
...
MR_decl_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__138__1_2_0)
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module8)
	...
	MR_init_label8(transform_hlds__pd_cost__unify_cost_3_0,37,6,8,38,12,11,13,14)
	MR_init_label4(transform_hlds__pd_cost__unify_cost_3_0,39,15,16,17)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__unify_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i37) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i38) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i39) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i16));
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__unify_cost_3_0_i15);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__unify_cost_3_0_i8);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) 3 + ((MR_Integer) MR_r1 * (MR_Integer) 2));
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r2;
	MR_r4 = MR_ctfield(1, MR_tempr2, 4);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__138__1_2_0);
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,11)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__pd_cost__unify_cost_3_0_i13);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__unify_cost_3_0_i14);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (((MR_Integer) MR_sv(1) + (MR_Integer) 3) + ((MR_Integer) MR_r1 * (MR_Integer) 2));
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__unify_cost_3_0_i17);
	}
	MR_r1 = (MR_Integer) 3;
	MR_proceed();
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 5;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module9)
	MR_init_entry1(fn__transform_hlds__pd_cost__this_file_0_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__pd_cost__this_file_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("pd_cost.m", 9);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module11)
	...
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,74,5,7,76,11,12,13,14)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,15,75,18,19,20,21,23,78)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,26,25,28,30,31,32,33,34)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,79,37,38,80,40,42,44,81)
	MR_init_label5(transform_hlds__pd_cost__goal_expr_cost_3_0,47,48,49,82,51)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__goal_expr_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i74) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i7) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i75) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i23));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i76);
	}
	MR_np_tailcall_ent(fn__transform_hlds__pd_cost__cost_of_builtin_call_0_0);
	}
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i11);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 2;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i12);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_stack_flush_0_0,
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,13)
	...
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_call_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i14);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = ((MR_Integer) MR_sv(2) + (MR_Integer) MR_r1);
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_reg_assign_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i15);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(2) + ((MR_Integer) MR_r1 * (MR_Integer) MR_sv(1)));
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i18);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,21)
	...
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_higher_order_call_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i38);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i78) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i34) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i79) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i80) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i42) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i44) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i81) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i82));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_data__get_may_call_mercury_1_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i26);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i25);
	}
	MR_r2 = MR_sv(1);
	MR_sv(1) = (MR_Integer) 0;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, foreign_arg);
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i30);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_stack_flush_0_0,
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,30)
	...
	MR_r2 = (MR_Integer) 2;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i31);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_call_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i32);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = ((MR_Integer) MR_sv(1) + (MR_Integer) MR_r1);
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_reg_assign_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i33);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(1) + ((MR_Integer) MR_r1 * (MR_Integer) MR_sv(2)));
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_r2 = (MR_Integer) 0;
	MR_np_tailcall_ent(transform_hlds__pd_cost__goal_costs_3_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_costs_3_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i37);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_stack_flush_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i38);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,38)
	...
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_simple_test_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i40);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_tailcall_ent(transform_hlds__pd_cost__goal_cost_2_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_tailcall_ent(transform_hlds__pd_cost__goal_cost_2_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i47);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i48);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i49);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (((MR_Integer) MR_sv(1) + (MR_Integer) MR_sv(2)) + (MR_Integer) MR_r1);
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__this_file_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i51);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("goal_cost: unexpected shorthand", 31);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module12)
	...
	MR_init_label3(transform_hlds__pd_cost__goal_costs_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__goal_costs_3_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__pd_cost__goal_costs_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__pd_cost__goal_costs_3_0,4)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__pd_cost__goal_costs_3_0_i11);
	}
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module13)
	...
	MR_init_label3(transform_hlds__pd_cost__cases_cost_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__cases_cost_3_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__pd_cost__cases_cost_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__pd_cost__cases_cost_3_0,4)
	...
	MR_r2 = ((MR_Integer) MR_sv(1) + (MR_Integer) MR_tempr1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__pd_cost__cases_cost_3_0_i11);
	}
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module17)
	MR_init_entry1(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__138__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__138__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r3 = MR_r2;
...
static void mercury__transform_hlds__pd_cost_maybe_bunch_0(void)
{
	...
	transform_hlds__pd_cost_module17();
}
...
void mercury__transform_hlds__pd_cost__write_out_proc_statics(FILE *fp);
#endif
