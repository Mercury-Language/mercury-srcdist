...
MR_decl_label10(transform_hlds__pd_cost__goal_expr_cost_3_0, 5,4,8,9,3,10,13,12,15,16)
MR_decl_label10(transform_hlds__pd_cost__goal_expr_cost_3_0, 14,18,19,20,17,21,145,26,27,23)
MR_decl_label5(transform_hlds__pd_cost__goal_expr_cost_3_0, 29,28,34,37,36)
MR_decl_label10(transform_hlds__pd_cost__unify_cost_3_0, 18,3,6,8,4,12,11,15,16,10)
MR_decl_label1(transform_hlds__pd_cost__unify_cost_3_0, 17)
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module8)
	...
	MR_init_label10(transform_hlds__pd_cost__unify_cost_3_0,18,3,6,8,4,12,11,15,16,10)
	MR_init_label1(transform_hlds__pd_cost__unify_cost_3_0,17)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__unify_cost_3_0_i18);
	}
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,4)
	...
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__unify_cost_3_0_i10);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,11)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__pd_cost__unify_cost_3_0_i15);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,15)
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__unify_cost_3_0_i16);
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module10)
	...
	MR_init_label10(transform_hlds__pd_cost__goal_expr_cost_3_0,5,4,8,9,3,10,13,12,15,16)
	MR_init_label10(transform_hlds__pd_cost__goal_expr_cost_3_0,14,18,19,20,17,21,145,26,27,23)
	MR_init_label5(transform_hlds__pd_cost__goal_expr_cost_3_0,29,28,34,37,36)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,14)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i17);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,17)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i21);
	}
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,21)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i23);
	}
	MR_r2 = MR_tfield(2, MR_r1, 3);
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i145);
	}
	MR_r1 = (MR_Integer) 3;
	MR_proceed();
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,23)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i28);
	}
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i29);
	}
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,28)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i34);
	}
...
void mercury__transform_hlds__pd_cost__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__pd_cost);
