...
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 86,5,7,88,12,11,17,18)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 19,20,21,87,23,24,25,26)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 28,90,31,30,33,35,36,37)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 38,39,91,42,43,92,45,47)
MR_decl_label7(transform_hlds__pd_cost__goal_expr_cost_3_0, 49,93,52,53,54,94,56)
...
MR_decl_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__142__1_2_0)
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,38)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__142__1_2_0);
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module11)
	...
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,86,5,7,88,12,11,17,18)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,19,20,21,87,23,24,25,26)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,28,90,31,30,33,35,36,37)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,38,39,91,42,43,92,45,47)
	MR_init_label7(transform_hlds__pd_cost__goal_expr_cost_3_0,49,93,52,53,54,94,56)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__goal_expr_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i86) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i7) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i87) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i28));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,7)
	...
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i88);
	}
	MR_np_tailcall_ent(fn__transform_hlds__pd_cost__cost_of_builtin_call_0_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i11);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,21)
	...
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,26)
	...
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_higher_order_call_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i43);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i90) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i39) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i91) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i92) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i47) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i49) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i93) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i94));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,31)
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i35);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,33)
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i35);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 2;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i36);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_costs_3_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i42);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_stack_flush_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i43);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(1) + (MR_Integer) MR_r1);
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_simple_test_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i45);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,49)
	...
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_tailcall_ent(transform_hlds__pd_cost__goal_cost_2_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i52);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i53);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i54);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (((MR_Integer) MR_sv(1) + (MR_Integer) MR_sv(2)) + (MR_Integer) MR_r1);
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__this_file_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i56);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module17)
	MR_init_entry1(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__142__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__pd_cost__IntroducedFrom__pred__unify_cost__142__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r3 = MR_r2;
