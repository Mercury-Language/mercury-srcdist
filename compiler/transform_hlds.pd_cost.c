          ...
          case (MR_Integer) 5:
            {
              ...
              transform_hlds__pd_cost__succeeded = ((((MR_tag((MR_Word) transform_hlds__pd_cost__Reason_29)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__pd_cost__Reason_29, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (transform_hlds__pd_cost__succeeded)
                {
