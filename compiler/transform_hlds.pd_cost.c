...
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 77,50,31,79,36,37,38,39)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 40,78,20,21,22,23,55,81)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 5,4,7,9,10,11,12,13)
MR_decl_label8(transform_hlds__pd_cost__goal_expr_cost_3_0, 82,16,17,84,26,27,28,29)
MR_decl_label5(transform_hlds__pd_cost__goal_expr_cost_3_0, 41,85,44,83,47)
MR_decl_label8(transform_hlds__pd_cost__unify_cost_3_0, 46,8,10,47,14,13,19,20)
MR_decl_label4(transform_hlds__pd_cost__unify_cost_3_0, 48,3,25,4)
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module8)
	...
	MR_init_label8(transform_hlds__pd_cost__unify_cost_3_0,46,8,10,47,14,13,19,20)
	MR_init_label4(transform_hlds__pd_cost__unify_cost_3_0,48,3,25,4)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__unify_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i46) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i47) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i48) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__unify_cost_3_0_i25));
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,8)
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__unify_cost_3_0_i10);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) 3 + ((MR_Integer) MR_r1 * (MR_Integer) 2));
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	if (MR_INT_NE(MR_r4,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__unify_cost_3_0_i14);
	}
...
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,19)
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__pd_cost__unify_cost_3_0_i20);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,20)
	...
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,3)
	...
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__unify_cost_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__pd_cost_module11)
	...
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,77,50,31,79,36,37,38,39)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,40,78,20,21,22,23,55,81)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,5,4,7,9,10,11,12,13)
	MR_init_label8(transform_hlds__pd_cost__goal_expr_cost_3_0,82,16,17,84,26,27,28,29)
	MR_init_label5(transform_hlds__pd_cost__goal_expr_cost_3_0,41,85,44,83,47)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__pd_cost__goal_expr_cost_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i77) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i31) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i78) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i55));
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i50);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,31)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__pd_cost__goal_expr_cost_3_0_i79);
	}
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,21)
	...
	MR_r2 = (MR_Integer) 2;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i22);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i81) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i13) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i82) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i83) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i29) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i41) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i84) MR_AND
		MR_LABEL_AP(transform_hlds__pd_cost__goal_expr_cost_3_0_i85));
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__cost_of_stack_flush_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i7);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,9)
	...
	MR_r2 = (MR_Integer) 2;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i10);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,17)
	...
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,26)
	...
	MR_np_call_localret_ent(transform_hlds__pd_cost__goal_cost_2_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i27);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_tailcall_ent(transform_hlds__pd_cost__goal_cost_2_0);
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__pd_cost__this_file_0_0,
		transform_hlds__pd_cost__goal_expr_cost_3_0_i44);
...
MR_def_label(transform_hlds__pd_cost__goal_expr_cost_3_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
