  ...
  MR_Word ProcLabel_5)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_8, &ModeNum_10);
  ...
  MR_Word PredLabel_3)
{
  ...
  {
    MR_String PredName_15 = ((MR_String) ((MR_hl_field(1, PredLabel_3, 0))));
    MR_Word MaybeTypeModule_16 = ((MR_Word) ((MR_hl_field(1, PredLabel_3, 1))));
    MR_String TypeName_17 = ((MR_String) ((MR_hl_field(1, PredLabel_3, 2))));
    MR_Integer TypeArity_18 = ((MR_Integer) ((MR_hl_field(1, PredLabel_3, 3))));
    ...
    {
      MR_Word TypeModule_21 = ((MR_Word) ((MR_hl_field(1, MaybeTypeModule_16, 0))));
  ...
  MR_Integer Arity_5)
{
  MR_bool succeeded;
  MR_String QualClassNameStr_6;
  MR_Word ModuleName_7 = ((MR_Word) ((MR_hl_field(0, QualName_4, 0))));
  MR_Word QualKind_8 = ((MR_Unsigned) ((MR_hl_field(0, QualName_4, 1))) & (MR_Integer) 1);
  MR_String ClassName_9 = ((MR_String) ((MR_hl_field(0, QualName_4, 2))));
  MR_Word SymName_10;
  MR_Word Var_23;
  ...
  MR_Word FieldVarName_3)
{
  ...
  MangledString_7 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(RawString_6);
  ...
  MR_Word FieldVarName_3)
{
  ...
  MangledString_6 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(RawString_5);
  ...
  MR_Word GlobalVarName_3)
{
  ...
  switch (MR_tag((MR_Word) GlobalVarName_3)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RttiId_7 = ((MR_Word) ((MR_hl_field(1, GlobalVarName_3, 0))));
