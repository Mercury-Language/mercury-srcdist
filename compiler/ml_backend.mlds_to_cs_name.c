  ...
  MR_Word VarName_6)
{
  ...
  MR_String RawString_13;
  MR_String MangledString_14;

  RawString_13 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(VarName_6);
  MangledString_14 = parse_tree__prog_foreign__name_mangle_1_f_0(RawString_13);
  VarNameStr_8 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(MangledString_14);
  ...
  MR_Word VarName_6)
{
  ...
  RawString_13 = ml_backend__mlds__ml_field_var_name_to_string_1_f_0(VarName_6);
  MangledString_14 = parse_tree__prog_foreign__name_mangle_1_f_0(RawString_13);
  VarNameStr_8 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(MangledString_14);
  ml_backend__mlds_to_cs_name__write_identifier_string_for_csharp_4_p_0(Stream_5, VarNameStr_8);
}
...
{
  MR_String Str_10;
  MR_String MangledName_19;
  MR_String UppercaseMangledName_20;
  MR_String Var_21;
  MR_String Var_23;

  MangledName_19 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(ClassName_7);
  UppercaseMangledName_20 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_19);
  Var_23 = mercury__string__from_int_1_f_0(ClassArity_8);
  Var_21 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_23);
  Str_10 = mercury__string__f_43_43_2_f_0(UppercaseMangledName_20, Var_21);
  ...
  MR_Word FunctionName_6)
{
  ...
  {
    MR_Word PlainFuncName_13 = (MR_Word) ((MR_Word) (FunctionName_6));
    MR_Word FuncLabel_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PlainFuncName_13, (MR_Integer) 0))));
    MR_Word ProcLabel_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_14, (MR_Integer) 0))));
    MR_Word MaybeAux_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_14, (MR_Integer) 1))));
    MR_Word PredLabel_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_16, (MR_Integer) 0))));
    MR_Integer ProcId_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_16, (MR_Integer) 1))));
    ...
    ml_backend__mlds_to_cs_name__pred_label_to_string_for_csharp_2_p_0(PredLabel_18, &PredLabelStr_20);
    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_19, &ModeNum_21);
    MaybeAuxSuffix_22 = ml_backend__ml_util__mlds_maybe_aux_func_id_to_suffix_1_f_0(MaybeAux_17);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_name_scalar_common_1[0]), ModeNum_21, &Var_32);
    Var_39 = mercury__string__f_43_43_2_f_0(Var_32, MaybeAuxSuffix_22);
    Var_41 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_39);
    FunctionNameStr_8 = mercury__string__f_43_43_2_f_0(PredLabelStr_20, Var_41);
  }
  ...
  MR_Word QualGlobalVarName_8)
{
  ...
  MR_Word CurrentModuleName_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 2))));
  MR_String DataNameStr_32;

  succeeded = ml_backend__mlds____Unify____mlds_module_name_0_0(ModuleName_10, CurrentModuleName_12);
  if (!(succeeded))
    ml_backend__mlds_to_cs_name__output_qual_name_prefix_cs_5_p_0(Stream_7, ModuleName_10, (MR_Integer) 0);
  ml_backend__mlds_to_cs_name__global_var_name_to_string_for_csharp_2_p_0(GlobalVarName_11, &DataNameStr_32);
  ml_backend__mlds_to_cs_name__write_identifier_string_for_csharp_4_p_0(Stream_7, DataNameStr_32);
}
