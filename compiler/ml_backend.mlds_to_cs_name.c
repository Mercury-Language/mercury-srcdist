  ...
  MR_Word FunctionName_6)
{
  ...
  else
  {
    ...
    MR_Word FuncLabel_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PlainFuncName_11, (MR_Integer) 0))));
    MR_Word ProcLabel_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_12, (MR_Integer) 0))));
    MR_Word MaybeAux_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_12, (MR_Integer) 1))));
    MR_Word PredLabel_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_14, (MR_Integer) 0))));
    MR_Integer ProcId_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_14, (MR_Integer) 1))));
  ...
  MR_Word QualGlobalVarName_8)
{
  ...
  MR_Word CurrentModuleName_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 2))));
  MR_String DataNameStr_28;

  succeeded = ml_backend__mlds____Unify____mlds_module_name_0_0(ModuleName_10, CurrentModuleName_12);
  if (!(succeeded))
    ml_backend__mlds_to_cs_name__output_qual_name_prefix_cs_5_p_0(Stream_7, ModuleName_10, (MR_Integer) 0);
  ml_backend__mlds_to_cs_name__global_var_name_to_string_for_csharp_2_p_0(GlobalVarName_11, &DataNameStr_28);
  ml_backend__mlds_to_cs_name__write_identifier_string_for_csharp_4_p_0(Stream_7, DataNameStr_28);
}
