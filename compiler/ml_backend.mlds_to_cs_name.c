...
{
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_name_scalar_common_1[0]), ModeNum_10, &Var_23);
...
{
  {
    ...
    else
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_name_scalar_common_1[0]), ModeNum_20, &Var_31);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Middle_8 = backend_libs__c_util__hex_hash32_1_f_0(String_4);
      Right_9 = mercury__string__right_2_f_0(String_4, (MR_Integer) 250);
      mercury__io__write_string_3_p_0(Left_7);
      mercury__io__write_string_3_p_0((MR_String) "_");
      mercury__io__write_string_3_p_0(Middle_8);
      mercury__io__write_string_3_p_0((MR_String) "_");
      mercury__io__write_string_3_p_0(Right_9);
    }
    else
