...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualName_4, (MR_Integer) 1)));
    MR_Word SymName_10;
    MR_Word Var_16;
  ...
  MR_String * String_4)
{
  ...
  else
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_3, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_3, (MR_Integer) 4)));
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GlobalVarName_3, (MR_Integer) 0)));
