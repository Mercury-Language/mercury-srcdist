...
void MR_CALL 
ml_backend__mlds_to_cs_name__output_proc_label_for_csharp_5_p_0(
  MR_Word Stream_6,
  MR_String Suffix_7,
  MR_Word ProcLabel_8)
{
  MR_String ProcLabelStr_10;
  MR_String ProcLabelStr0_13;

  ProcLabelStr0_13 = ml_backend__mlds_to_cs_name__proc_label_to_nll_string_for_csharp_2_f_0(Suffix_7, ProcLabel_8);
  ProcLabelStr_10 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(ProcLabelStr0_13);
  mercury__io__write_string_4_p_0(Stream_6, ProcLabelStr_10);
}
  ...
  MR_Word PredLabel_3)
{
  ...
  if (((MR_tag((MR_Word) PredLabel_3)) == (MR_Integer) 1))
  {
    ...
    if ((MaybeTypeModule_18 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      PredLabelStr_4 = mercury__string__f_43_43_2_f_0(MangledPredName_21, Var_115);
    }
    else
    {
      ...
      PredLabelStr_4 = mercury__string__f_43_43_2_f_0(TypeModuleStr_24, Var_103);
    }
  }
  else
  {
  ...
  MR_Integer Arity_5)
{
  ...
  else
  {
    ...
    QualStr_11 = ml_backend__mlds_to_cs_name__qualifier_to_nll_string_for_csharp_2_f_0(MLDS_ModuleName_7, QualKind_8);
...
ml_backend__mlds_to_cs_name__output_unqual_class_name_for_csharp_5_p_0(
  ...
  MR_Integer Arity_8)
{
  MR_String ClassNameStr0_10;
  MR_String ClassNameStr_11;
  MR_String MangledName_14;
  MR_String UppercaseMangledName_15;
  MR_String Var_22;
  MR_String Var_30;

  MangledName_14 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(Name_7);
  UppercaseMangledName_15 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_14);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_name_scalar_common_1[0]), Arity_8, &Var_22);
  Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_22);
  ClassNameStr0_10 = mercury__string__f_43_43_2_f_0(UppercaseMangledName_15, Var_30);
  ClassNameStr_11 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(ClassNameStr0_10);
  mercury__io__write_string_4_p_0(Stream_6, ClassNameStr_11);
}
...
{
  MR_String FieldVarNameStr_8;
  MR_String FieldVarNameStr0_11;
  MR_String RawString_12;
  MR_String MangledString_13;

  RawString_12 = ml_backend__mlds__ml_field_var_name_to_string_1_f_0(FieldVarName_6);
  MangledString_13 = parse_tree__prog_foreign__name_mangle_1_f_0(RawString_12);
  FieldVarNameStr0_11 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(MangledString_13);
  FieldVarNameStr_8 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(FieldVarNameStr0_11);
  mercury__io__write_string_4_p_0(Stream_5, FieldVarNameStr_8);
}
  ...
  MR_Word LocalVarName_6)
{
  ...
  MR_String LocalVarNameStr0_11;
  MR_String RawString_12;
  MR_String MangledString_13;

  RawString_12 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_6);
  MangledString_13 = parse_tree__prog_foreign__name_mangle_1_f_0(RawString_12);
  LocalVarNameStr0_11 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(MangledString_13);
  LocalVarNameStr_8 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(LocalVarNameStr0_11);
...
void MR_CALL 
ml_backend__mlds_to_cs_name__xoutput_maybe_qualified_global_var_name_for_csharp_5_p_0(
  MR_Word Info_6,
  MR_Word Stream_7,
  MR_Word QualGlobalVarName_8)
{
  ...
  MaybeQualGlobalVarNameStr_10 = ml_backend__mlds_to_cs_name__maybe_qualified_global_var_name_to_string_for_csharp_2_f_0(Info_6, QualGlobalVarName_8);
  mercury__io__write_string_4_p_0(Stream_7, MaybeQualGlobalVarNameStr_10);
}
...
void MR_CALL 
ml_backend__mlds_to_cs_name__xoutput_global_var_name_for_csharp_4_p_0(
  MR_Word Stream_5,
  MR_Word GlobalVarName_6)
{
  MR_String GlobalVarNameStr_8;
  MR_String GlobalVarNameStr0_11;

  GlobalVarNameStr0_11 = ml_backend__mlds_to_cs_name__global_var_name_to_nll_string_for_csharp_1_f_0(GlobalVarName_6);
  GlobalVarNameStr_8 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(GlobalVarNameStr0_11);
  mercury__io__write_string_4_p_0(Stream_5, GlobalVarNameStr_8);
}
  ...
  MR_String Str0_6)
{
  ...
  Var_10 = ml_backend__mlds_to_cs_name__limit_identifier_length_1_f_0(Str0_6);
