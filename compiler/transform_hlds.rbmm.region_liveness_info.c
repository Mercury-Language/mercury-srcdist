...
static const MR_FA_TypeInfo_Struct2 transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0list__ti_list_1list__ti_list_1pair__ti_pair_2transform_hlds__smm_common__type_ctor_info_program_point_0hlds__hlds_goal__type_ctor_info_hlds_goal_0;
...
static const MR_FA_TypeInfo_Struct2 transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2transform_hlds__smm_common__type_ctor_info_program_point_0set_ordlist__ti_set_ordlist_1transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0;

static const MR_FA_TypeInfo_Struct2 transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2transform_hlds__smm_common__type_ctor_info_program_point_0set_ordlist__ti_set_ordlist_1term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0;

static const MR_FA_TypeInfo_Struct2 transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0set_ordlist__ti_set_ordlist_1transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0;
...
const MR_TypeCtorInfo_Struct transform_hlds__rbmm__region_liveness_info__transform_hlds__rbmm__region_liveness_info__type_ctor_info_execution_path_table_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0list__ti_list_1list__ti_list_1pair__ti_pair_2transform_hlds__smm_common__type_ctor_info_program_point_0hlds__hlds_goal__type_ctor_info_hlds_goal_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
const MR_TypeCtorInfo_Struct transform_hlds__rbmm__region_liveness_info__transform_hlds__rbmm__region_liveness_info__type_ctor_info_proc_pp_region_set_table_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2transform_hlds__smm_common__type_ctor_info_program_point_0set_ordlist__ti_set_ordlist_1transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
const MR_TypeCtorInfo_Struct transform_hlds__rbmm__region_liveness_info__transform_hlds__rbmm__region_liveness_info__type_ctor_info_proc_pp_varset_table_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2transform_hlds__smm_common__type_ctor_info_program_point_0set_ordlist__ti_set_ordlist_1term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
const MR_TypeCtorInfo_Struct transform_hlds__rbmm__region_liveness_info__transform_hlds__rbmm__region_liveness_info__type_ctor_info_proc_region_set_table_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__rbmm__region_liveness_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0set_ordlist__ti_set_ordlist_1transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
  ...
  MR_Word ProcRegionSetTable2_4)
{
  ...
  mercury__map__count_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_liveness_info_scalar_common_1[0]), ProcRegionSetTable1_3, &C1_5);
  mercury__map__count_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_liveness_info_scalar_common_1[0]), ProcRegionSetTable2_4, &C2_6);
  succeeded = (C1_5 == C2_6);
  if (succeeded)
  {
    mercury__map__keys_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_liveness_info_scalar_common_1[0]), ProcRegionSetTable1_3, &PredProcIds1_7);
  ...
  MR_Word PRST2_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_liveness_info_scalar_common_1[0]), PRST2_3, ((MR_Box) (PPId_6)), &conv0_RS2_10);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__region_liveness_info_scalar_common_1[0]), PRST1_2, ((MR_Box) (PPId_6)), &conv1_RS1_11);
  ...
  MR_Word * Outputs_8)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(CalleeProcInfo_6, &ArgVars_9);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(CalleeProcInfo_6, &VarTable_10);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(CalleeProcInfo_6, &ArgModes_11);
  hlds__arg_info__compute_in_and_out_vars_6_p_0(ModuleInfo_5, VarTable_10, ArgVars_9, ArgModes_11, Inputs_7, Outputs_8);
}
