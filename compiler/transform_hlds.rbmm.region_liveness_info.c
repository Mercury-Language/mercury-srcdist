...
{
  {
    ...
    MR_Word TypeInfo_9_9 = (MR_Word) &transform_hlds__rbmm__region_liveness_info_scalar_common_1[0];
    MR_Integer C1_5;
    MR_Integer C2_6;
    MR_Word PredProcIds1_7;

    mercury__map__count_2_p_0(TypeCtorInfo_8_8, TypeInfo_9_9, ProcRegionSetTable1_3, &C1_5);
    mercury__map__count_2_p_0(TypeCtorInfo_8_8, TypeInfo_9_9, ProcRegionSetTable2_4, &C2_6);
    succeeded = (C1_5 == C2_6);
    if (succeeded)
    {
      mercury__map__keys_2_p_0(TypeCtorInfo_8_8, TypeInfo_9_9, ProcRegionSetTable1_3, &PredProcIds1_7);
  ...
  MR_Word PRST2_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word TypeInfo_13_13 = (MR_Word) &transform_hlds__rbmm__region_liveness_info_scalar_common_1[0];
      ...
      succeeded = mercury__map__search_3_p_0(TypeCtorInfo_12_12, TypeInfo_13_13, PRST2_3, ((MR_Box) (PPId_6)), &conv0_RS2_10);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        mercury__map__lookup_3_p_0(TypeCtorInfo_12_12, TypeInfo_13_13, PRST1_2, ((MR_Box) (PPId_6)), &conv1_RS1_11);
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word next_value_of_HeadVar__1_1 = PPIds_7;
