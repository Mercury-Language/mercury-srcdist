                ...
                if (transform_hlds__rbmm__region_liveness_info__succeeded)
                  {
                    ...
                    {
                      MR_Word transform_hlds__rbmm__region_liveness_info__next_value_of_HeadVar__1_1 = transform_hlds__rbmm__region_liveness_info__PPIds_7;

                      transform_hlds__rbmm__region_liveness_info__HeadVar__1_1 = transform_hlds__rbmm__region_liveness_info__next_value_of_HeadVar__1_1;
                    }
                    continue;
                  }
              }
