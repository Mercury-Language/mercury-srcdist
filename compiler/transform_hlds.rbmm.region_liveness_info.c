...
MR_decl_label6(transform_hlds__rbmm__region_liveness_info__prst_equal_2_3_0, 25,5,7,8,2,1)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__region_liveness_info_module2)
	...
	MR_init_label6(transform_hlds__rbmm__region_liveness_info__prst_equal_2_3_0,25,5,7,8,2,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__region_liveness_info__prst_equal_2_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__region_liveness_info__prst_equal_2_3_0,8)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__region_liveness_info__prst_equal_2_3_0_i25);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__region_liveness_info_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__region_liveness_info__IntroducedFrom__pred__find_input_output_args__120__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__find_input_output_args__120__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
