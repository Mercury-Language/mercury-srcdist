  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__14_14 = (MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0);
        succeeded = mercury__set__equal_2_p_0(TypeCtorInfo__14_14, RS1_11, RS2_10);
        if (succeeded)
        {
  ...
  MR_Word * Outputs_8)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(CalleeProcInfo_6, &_VarSet_10, &VarTypes_11);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(CalleeProcInfo_6, &ArgModes_12);
  hlds__arg_info__compute_in_and_out_vars_6_p_0(ModuleInfo_5, VarTypes_11, ArgVars_9, ArgModes_12, Inputs_7, Outputs_8);
}
