  ...
  MR_Word * Outputs_8)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, CalleeProcInfo_6, &VarTable_10);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(CalleeProcInfo_6, &ArgModes_11);
