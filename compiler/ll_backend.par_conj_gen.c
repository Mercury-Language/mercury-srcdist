...
MR_decl_label10(ll_backend__par_conj_gen__generate_par_conj_6_0, 3,4,2,7,8,9,10,12,13,14)
MR_decl_label10(ll_backend__par_conj_gen__generate_par_conj_6_0, 15,19,28,32,33,34,35,36,38,37)
MR_decl_label10(ll_backend__par_conj_gen__generate_par_conj_6_0, 44,45,46,47,48,49,50,51,16,53)
MR_decl_label10(ll_backend__par_conj_gen__generate_par_conj_6_0, 54,55,56,57,58,60,59,66,67,68)
MR_decl_label10(ll_backend__par_conj_gen__generate_par_conj_6_0, 69,70,71,72,73,78,79,80,83,86)
MR_decl_label8(ll_backend__par_conj_gen__generate_par_conj_6_0, 90,91,92,93,94,95,96,97)
...
MR_BEGIN_MODULE(ll_backend__par_conj_gen_module4)
	...
	MR_init_label10(ll_backend__par_conj_gen__generate_par_conj_6_0,3,4,2,7,8,9,10,12,13,14)
	MR_init_label10(ll_backend__par_conj_gen__generate_par_conj_6_0,15,19,28,32,33,34,35,36,38,37)
	MR_init_label10(ll_backend__par_conj_gen__generate_par_conj_6_0,44,45,46,47,48,49,50,51,16,53)
	MR_init_label10(ll_backend__par_conj_gen__generate_par_conj_6_0,54,55,56,57,58,60,59,66,67,68)
	MR_init_label10(ll_backend__par_conj_gen__generate_par_conj_6_0,69,70,71,72,73,78,79,80,83,86)
	MR_init_label8(ll_backend__par_conj_gen__generate_par_conj_6_0,90,91,92,93,94,95,96,97)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__par_conj_gen__generate_par_conj_6_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__par_conj_gen__generate_par_conj_6_0_i37);
	}
...
MR_def_label(ll_backend__par_conj_gen__generate_par_conj_6_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__par_conj_gen__generate_par_conj_6_0_i59);
	}
	if (MR_INT_NE(MR_sv(11),0)) {
		MR_GOTO_LAB(ll_backend__par_conj_gen__generate_par_conj_6_0_i59);
	}
...
MR_def_label(ll_backend__par_conj_gen__generate_par_conj_6_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(ll_backend__par_conj_gen__generate_par_conj_6_0_i73);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__par_conj_gen__generate_par_conj_6_0,80)
	...
	MR_tfield(3, MR_tempr1, 3) = MR_sv(14);
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__par_conj_gen__generate_par_conj_6_0_i83);
MR_def_label(ll_backend__par_conj_gen__generate_par_conj_6_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
