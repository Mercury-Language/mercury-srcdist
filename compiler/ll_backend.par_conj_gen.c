...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 259, &STSize_16);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_CLD_0_3 = STATE_VARIABLE_CLD_18_18;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_Outputs_0_5 = STATE_VARIABLE_Outputs_24_24;
