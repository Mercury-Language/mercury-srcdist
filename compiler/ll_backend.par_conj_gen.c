  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ll_backend__code_info__get_variable_slot_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__3_3);
  ...
  MR_Word * STATE_VARIABLE_CLD_50)
{
  ...
  if ((RegLocns_84 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((AllLocns_83 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      LCVarLocn_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), AllLocns_83, (MR_Integer) 0))));
  else
    LCVarLocn_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RegLocns_84, (MR_Integer) 0))));
  ...
  if ((RegLocns_96 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((AllLocns_95 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      LCSVarLocn_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), AllLocns_95, (MR_Integer) 0))));
  else
    LCSVarLocn_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RegLocns_96, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_6[1]));
          MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) (ll_backend__par_conj_gen__generate_lc_spawn_off_9_p_0_3));
  ...
  MR_Word * STATE_VARIABLE_CLD_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo__22_22 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0);
        succeeded = mercury__set__member_2_p_0(TypeCtorInfo__22_22, ((MR_Box) (Slot_14)), Locations_15);
      }
      if (succeeded)
