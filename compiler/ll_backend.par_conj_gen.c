...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((((MR_tag((MR_Word) SyncTermBaseSlotPrime_141)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SyncTermBaseSlotPrime_141, (MR_Integer) 0))) == (MR_Integer) 0)));
          if (succeeded)
