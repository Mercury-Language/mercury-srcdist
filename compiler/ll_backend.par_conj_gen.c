    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_6[1]));
          MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (ll_backend__par_conj_gen__generate_lc_spawn_off_9_p_0_3));
