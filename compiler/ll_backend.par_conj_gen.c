    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_7[1]));
          MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (ll_backend__par_conj_gen__generate_lc_spawn_off_9_p_0_2));
          MR_hl_field(MR_mktag(0), Var_67, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_67, 3) = ((MR_Box) (STATE_VARIABLE_CI_63_63));
        }
        ...
        ll_backend__par_conj_gen__copy_slots_to_child_stack_5_p_0(FrameSize_41, LCVarLocn_23, LCSVarLocn_24, InputStackSlots_39, &CopyStr_42);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (LCSVarLocn_24));
          MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (InputStackSlots_39));
        }
        {
          Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (LCVarLocn_23));
        ...
        Var_68 = mercury__set__list_to_set_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), Var_69);
        {
          ...
          MR_hl_field(MR_mktag(1), LiveLvalsInfo_44, 0) = ((MR_Box) (Var_68));
        }
        {
  ...
  MR_Word * STATE_VARIABLE_CLD_54)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 299, &STSize_16);
  ...
  if (succeeded)
  {
    ...
    ll_backend__code_loc_dep__acquire_temp_slot_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__par_conj_gen_scalar_common_2[0])), (MR_Integer) 1, &ParentSpSlot1_50, STATE_VARIABLE_CI_0_51, &STATE_VARIABLE_CI_62_62, STATE_VARIABLE_CLD_0_53, &STATE_VARIABLE_CLD_63_63);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_67, 2) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_2[0]));
    }
    {
  ...
  else
  {
    ...
    if ((Conjuncts_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      ForkCode_41 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
      {
        ...
        MR_hl_field(MR_mktag(3), Var_66, 0) = ((MR_Box) ((MR_Unsigned) 30U));
        MR_hl_field(MR_mktag(3), Var_66, 1) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(3), Var_66, 2) = ((MR_Box) (HeadVar__3_3));
      }
      {
        Var_65 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (Var_66));
        MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) ((MR_String) "finish"));
      }
    ...
    else
    {
      ...
      ll_backend__code_info__get_next_label_3_p_0(&NextConjunct_40, STATE_VARIABLE_CI_49_49, &STATE_VARIABLE_CI_52_52);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_54, 1) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(3), Var_54, 2) = ((MR_Box) (NextConjunct_40));
      }
      {
        Var_53 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (Var_54));
        MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) ((MR_String) "fork off a child"));
      }
      ForkCode_41 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_53)));
      {
        ...
        MR_hl_field(MR_mktag(3), Var_58, 0) = ((MR_Box) ((MR_Unsigned) 30U));
        MR_hl_field(MR_mktag(3), Var_58, 1) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(3), Var_58, 2) = ((MR_Box) (HeadVar__3_3));
      }
      {
        Var_57 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Var_58));
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) ((MR_String) "finish"));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_62, 1) = ((MR_Box) (NextConjunct_40));
      }
      {
        Var_61 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (Var_62));
        MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) ((MR_String) "start of the next conjunct"));
      }
      {
        Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
