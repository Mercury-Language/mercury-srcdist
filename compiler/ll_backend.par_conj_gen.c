...
ll_backend__par_conj_gen__IntroducedFrom__func__instr_list_max_stack_ref__617__1_1_f_0(
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) LVal_4)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), LVal_4, (MR_Integer) 0)))) == (MR_Integer) 0)));
    MR_Integer N_7;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) StackSlot_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), StackSlot_7, (MR_Integer) 0)))) == (MR_Integer) 0)));
      if (succeeded)
      {
...
{
  {
    ...
    conv1_HeadVar__2_24 = ll_backend__par_conj_gen__IntroducedFrom__func__instr_list_max_stack_ref__617__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 281, &STSize_16);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((((MR_tag((MR_Word) SyncTermBaseSlotPrime_36)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SyncTermBaseSlotPrime_36, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((((MR_tag((MR_Word) SyncTermBaseSlotPrime_141)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SyncTermBaseSlotPrime_141, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
      ...
      Var_167 = (MR_Integer) ((MR_Unsigned) Depth_17 + (MR_Unsigned) 1);
...
{
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__par_conj_gen_scalar_common_2[1]), SyncTermBaseSlot_4, &Var_30);
    ...
    Var_14 = mercury__string__f_43_43_2_f_0((MR_String) "#ifdef MR_THREADSCOPE\nMR_threadscope_post_end_par_conj(&MR_sv(", Var_37);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_9, 3) = ((MR_Box) (Var_14));
    }
    {
