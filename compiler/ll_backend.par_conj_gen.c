  ...
  MR_Word * STATE_VARIABLE_CLD_54)
{
  ...
  MR_Word MaybeReleaseParentSpSlot_21;
  MR_Word Vars_22;
  MR_Word SaveCode_23;
  ...
  if (succeeded)
  {
    ...
    ll_backend__code_loc_dep__acquire_temp_slot_7_p_0((MR_Word) (MR_mkword(1, &ll_backend__par_conj_gen_scalar_common_2[0])), (MR_Integer) 1, &ParentSpSlot_18, STATE_VARIABLE_CI_0_51, &STATE_VARIABLE_CI_1_62, STATE_VARIABLE_CLD_0_53, &STATE_VARIABLE_CLD_1_63);
    {
      Var_67 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Var_67, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(3, Var_67, 1) = ((MR_Box) (ParentSpSlot_18));
    ...
    MaybeSetParentSpCode_19 = mercury__cord__from_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_65);
    {
      ...
      MR_hl_field(0, Var_82, 0) = ((MR_Box) (ParentSpSlot_18));
    }
    {
    ...
    {
      MaybeReleaseParentSpSlot_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeReleaseParentSpSlot_21, 0) = ((MR_Box) (ParentSpSlot_18));
    }
  }
  else
  {
    ...
    MaybeReleaseParentSpSlot_21 = (MR_Word) ((MR_Unsigned) 0U);
    STATE_VARIABLE_CLD_1_63 = STATE_VARIABLE_CLD_0_53;
  ...
  *Code_12 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), MaybeSetParentSpCode_19, Var_114);
  ...
  {
    STATE_VARIABLE_CLD_5_121 = STATE_VARIABLE_CLD_4_118;
    STATE_VARIABLE_CI_6_120 = STATE_VARIABLE_CI_5_104;
  }
  if ((MaybeReleaseParentSpSlot_21 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *STATE_VARIABLE_CI_52 = STATE_VARIABLE_CI_6_120;
    STATE_VARIABLE_CLD_6_124 = STATE_VARIABLE_CLD_5_121;
  }
  else
  {
    MR_Word ParentSpSlot1_50 = ((MR_Word) ((MR_hl_field(1, MaybeReleaseParentSpSlot_21, 0))));
  ...
  MR_Word * STATE_VARIABLE_Outputs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = hlds__mode_test__mode_is_output_2_p_0(HeadVar__4_4, Var_23);
      if (succeeded)
        {
