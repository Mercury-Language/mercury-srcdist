...
{
  {
    ...
    if ((ll_backend__par_conj_gen__HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          mercury__cord__map_pred_3_p_0(ll_backend__par_conj_gen__TypeCtorInfo_10_87, ll_backend__par_conj_gen__TypeCtorInfo_10_87, (MR_Word) &ll_backend__par_conj_gen_scalar_common_3[9], ll_backend__par_conj_gen__ThisConjunctCode0_28, &ll_backend__par_conj_gen__ThisConjunctCode_29);
        }
        {
...
{
  {
    ...
    {
      ll_backend__exprn_aux__transform_lval_in_instr_5_p_0((MR_Word) &mercury__unit__unit__type_ctor_info_unit_0, (MR_Word) &ll_backend__par_conj_gen_scalar_common_3[4], ll_backend__par_conj_gen__STATE_VARIABLE_Instr_0_5, ll_backend__par_conj_gen__STATE_VARIABLE_Instr_6, ((MR_Box) ((MR_Integer) 0)), &ll_backend__par_conj_gen__conv1_Var_4);
    }
  }
}
        ...
        if (ll_backend__par_conj_gen__succeeded)
          {
            ll_backend__par_conj_gen__N_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__par_conj_gen__StackSlot_7, (MR_Integer) 1)));
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ll_backend__par_conj_gen_scalar_common_2[2], ll_backend__par_conj_gen__N_10, &ll_backend__par_conj_gen__Var_31);
              }
              {
...
{
  {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ll_backend__par_conj_gen_scalar_common_2[2], ll_backend__par_conj_gen__FrameSize_6, &ll_backend__par_conj_gen__Var_39);
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__par_conj_gen__Var_31, 0) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_6[0]));
...
{
  {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ll_backend__par_conj_gen_scalar_common_2[2], ll_backend__par_conj_gen__SyncTermBaseSlot_4, &ll_backend__par_conj_gen__Var_32);
    }
    {
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), ll_backend__par_conj_gen__Var_65, 0) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_5[0]));
    ...
    if (ll_backend__par_conj_gen__succeeded)
      {
        ...
        ll_backend__par_conj_gen__TypeCtorInfo_131_131 = (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0;
        {
          ...
          MR_hl_field(MR_mktag(3), ll_backend__par_conj_gen__Var_69, 2) = ((MR_Box) (&ll_backend__par_conj_gen_scalar_common_2[1]));
        }
        {
