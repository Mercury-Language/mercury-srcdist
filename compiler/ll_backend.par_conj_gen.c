  ...
  MR_Word * STATE_VARIABLE_CLD_54)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = ((((MR_tag((MR_Word) SyncTermBaseSlotPrime_140)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SyncTermBaseSlotPrime_140, (MR_Integer) 0)))) == (MR_Integer) 0)));
        if (succeeded)
          SlotNumPrime_141 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), SyncTermBaseSlotPrime_140, (MR_Integer) 1))));
      }
    }
    if (succeeded)
    {
      ...
      {
        ParentSyncTermBaseSlot_155 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ParentSyncTermBaseSlot_155, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(MR_mktag(3), ParentSyncTermBaseSlot_155, 1) = ((MR_Box) (SlotNum_38));
      }
    }
    else
      {
