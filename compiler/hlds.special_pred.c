        ...
        if (!(succeeded))
        {
          ...
          if (succeeded)
          {
            ...
            if (!(succeeded))
            {
              ...
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_18, (MR_Integer) 283, (MR_Integer) 0);
            }
            if (succeeded)
            {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_16, (MR_Integer) 283, (MR_Integer) 0);
          }
          if (succeeded)
          {
