...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) NonCanonical_9)) == (MR_Integer) 3);
          if (succeeded)
          {
          }
        }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_26 = hlds__status__type_status_defined_in_this_module_1_f_0(TypeStatus_8);
              ...
              if (succeeded)
              {
                ...
                {
                  Var_27 = (MR_Integer) 0;
                  succeeded = hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0(ModuleInfo_5, Var_27, TypeBody_7);
                  succeeded = !(succeeded);
                }
              }
            }
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              Var_21 = (MR_Integer) 0;
              succeeded = hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0(ModuleInfo_5, Var_21, TypeBody_7);
              succeeded = !(succeeded);
            }
          }
        }
...
{
  {
      ...
      if (!(succeeded))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_32 = hlds__status__type_status_defined_in_this_module_1_f_0(TypeStatus_17);
            ...
            if (succeeded)
            {
              ...
              {
                Var_33 = (MR_Integer) 0;
                succeeded = hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0(ModuleInfo_3, Var_33, TypeBody_16);
                succeeded = !(succeeded);
              }
            }
          }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_26 = hlds__status__type_status_defined_in_this_module_1_f_0(TypeStatus_11);
        succeeded = (Var_26 == (MR_Integer) 0);
        if (succeeded)
        {
          ...
          {
            Var_27 = (MR_Integer) 0;
            succeeded = hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0(ModuleInfo_3, Var_27, TypeBody_10);
            succeeded = !(succeeded);
          }
        }
      }
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            if (((MR_tag((MR_Word) NonCanonical_29)) == (MR_Integer) 2))
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
            else
            if (((MR_tag((MR_Word) NonCanonical_29)) == (MR_Integer) 0))
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
            else
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_FALSE;
          }
