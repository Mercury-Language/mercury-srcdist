  ...
  MR_Integer * ProcId_12)
{
  ...
  switch (MR_tag((MR_Word) TypeCategory_13)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCategory_13, (MR_Integer) 0))));
        ...
        switch (MR_tag((MR_Word) Var_81)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_82 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_81, (MR_Integer) 0))) & (MR_Integer) 15);

              MaybeCategoryName_14 = ((&hlds__special_pred_vector_common_4[0 + Var_82]))->hlds__special_pred__vector_common_type_4_0__vct_4_f_0;
            }
            break;
        }
      }
  ...
  else
  {
    ...
    Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "_", CategoryName_20);
    ...
    Var_32 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
    {
      ...
      *PredName_10 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Name_33));
    }
    succeeded = MR_TRUE;
  }
  return succeeded;
