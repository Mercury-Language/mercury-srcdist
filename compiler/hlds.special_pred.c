...
{
  {
    ...
    {
      uint32_t Var_20 = ((uint32_t) (MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_28, (MR_Integer) 0)));
      MR_Word Var_22;
      MR_Word Var_23;
      MR_Integer Var_24;
      MR_Word Var_25;
      ...
      (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = ((env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__MaybeExistConstraints_21 != (MR_Word) ((MR_Unsigned) 0U));
