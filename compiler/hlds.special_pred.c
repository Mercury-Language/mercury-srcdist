...
static /* final */ const struct hlds__special_pred__vector_common_type_3_0_s hlds__special_pred_vector_common_3[10];
...
static /* final */ const struct hlds__special_pred__vector_common_type_3_0_s hlds__special_pred_vector_common_3[10] = {
  ...
  /* row 7 */   {     (MR_String) "int" },
  /* row 8 */   {     (MR_String) "pred" },
  /* row 9 */   {     (MR_String) "string" },
};
                ...
                do
                  {
                    ...
                    hlds__special_pred__result_3 = MR_strcmp(*hlds__special_pred__TypeName_4, ((&hlds__special_pred_vector_common_3[5 + hlds__special_pred__mid_2]))->hlds__special_pred__vector_common_type_3_0__vct_3_f_0);
                    ...
                    if (!(hlds__special_pred__succeeded))
                      {
                        ...
                        {
                          hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_19, (MR_Integer) 274, (MR_Integer) 0);
                        }
                      }
                    if (hlds__special_pred__succeeded)
                      {
                ...
                if (!(hlds__special_pred__succeeded))
                  {
                    ...
                    {
                      hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_16, (MR_Integer) 274, (MR_Integer) 0);
                    }
                  }
                if (hlds__special_pred__succeeded)
                  {
