...
static const MR_FA_TypeInfo_Struct2 hlds__special_pred__tree234__ti_tree234_2parse_tree__prog_data__type_ctor_info_type_ctor_0hlds__pred_proc_id__type_ctor_info_pred_id_0;
...
static const MR_PseudoTypeInfo hlds__special_pred__hlds__special_pred__field_types_special_pred_maps_0_0[3] = {
  (MR_PseudoTypeInfo) (&hlds__special_pred__tree234__ti_tree234_2parse_tree__prog_data__type_ctor_info_type_ctor_0hlds__pred_proc_id__type_ctor_info_pred_id_0),
  (MR_PseudoTypeInfo) (&hlds__special_pred__tree234__ti_tree234_2parse_tree__prog_data__type_ctor_info_type_ctor_0hlds__pred_proc_id__type_ctor_info_pred_id_0),
  (MR_PseudoTypeInfo) (&hlds__special_pred__tree234__ti_tree234_2parse_tree__prog_data__type_ctor_info_type_ctor_0hlds__pred_proc_id__type_ctor_info_pred_id_0)
};
...
static const MR_DuFunctorDescPtr hlds__special_pred__hlds__special_pred__du_stag_ordered_special_pred_maps_0_0[1] = { &hlds__special_pred__hlds__special_pred__du_functor_desc_special_pred_maps_0_0 };
...
static const MR_DuFunctorDescPtr hlds__special_pred__hlds__special_pred__du_name_ordered_special_pred_maps_0[1] = { &hlds__special_pred__hlds__special_pred__du_functor_desc_special_pred_maps_0_0 };

static const MR_Integer hlds__special_pred__hlds__special_pred__functor_number_map_special_pred_maps_0[1] = { (MR_Integer) 0 };
  ...
  MR_Integer * ProcId_12)
{
  ...
  TypeCategory_13 = hlds__type_classify__classify_type_ctor_2_f_0(ModuleInfo_7, TypeCtor_8);
  switch (MR_tag((MR_Word) TypeCategory_13)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_79 = ((MR_Word) ((MR_hl_field(1, TypeCategory_13, 0))));
        ...
        switch (MR_tag((MR_Word) Var_79)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_80 = ((MR_Unsigned) ((MR_hl_field(1, Var_79, 0))) & (MR_Integer) 15);
  ...
  if ((MaybeBuiltinTypeName_14 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      ...
      hlds__pred_proc_id__proc_id_to_int_2_p_1(ProcId_12, ProcInt_19);
      succeeded = MR_TRUE;
    }
  }
  else
  {
    MR_String BuiltinTypeName_20 = ((MR_String) ((MR_hl_field(1, MaybeBuiltinTypeName_14, 0))));
...
hlds__special_pred__can_generate_special_pred_clauses_for_type_3_p_0(
  ...
  MR_Word TypeBody_6)
{
  MR_bool succeeded = ((((MR_tag((MR_Word) TypeBody_6)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeBody_6, 0)))) == (MR_Integer) 1)));
  ...
  if (succeeded)
  {
    succeeded = hlds__type_util__type_ctor_has_hand_defined_rtti_2_p_0(TypeCtor_5, TypeBody_6);
    succeeded = !(succeeded);
    if (succeeded)
    {
      succeeded = hlds__type_util__type_body_has_user_defined_equality_pred_3_p_0(ModuleInfo_4, TypeBody_6, &NonCanonical_9);
      if (succeeded)
        succeeded = ((((MR_tag((MR_Word) NonCanonical_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, NonCanonical_9, 0)))) == (MR_Integer) 1)));
      succeeded = !(succeeded);
    }
  }
  return succeeded;
  ...
  MR_String * TypeName_4)
{
  ...
  Var_7 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_3, 1))));
  succeeded = ((MR_tag((MR_Word) Var_6)) == (MR_Integer) 1);
  if (succeeded)
  {
    Var_8 = ((MR_Word) ((MR_hl_field(1, Var_6, 0))));
    *TypeName_4 = ((MR_String) ((MR_hl_field(1, Var_6, 1))));
...
{
  MR_bool succeeded = ((((MR_tag((MR_Word) TypeBody_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeBody_7, 0)))) == (MR_Integer) 0)));
  MR_Word Var_13;
  MR_Word CtorCat0_10;
  ...
  if (succeeded)
  {
    succeeded = ((((MR_tag((MR_Word) TypeBody_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeBody_7, 0)))) == (MR_Integer) 1)));
    if (succeeded)
    {
      Var_13 = ((MR_Word) ((MR_hl_field(3, TypeBody_7, 1))));
      succeeded = (Var_13 == (MR_Word) ((MR_Unsigned) 12U));
    }
    succeeded = !(succeeded);
    if (succeeded)
    {
      succeeded = hlds__type_classify__classify_type_ctor_if_special_2_p_0(TypeCtor_6, &CtorCat0_10);
      if (succeeded)
      {
        succeeded = (CtorCat0_10 == (MR_Word) ((MR_Unsigned) 16U));
        if (!(succeeded))
        {
          MR_Word Var_15;
          MR_Word Var_21;
  ...
  MR_Word TypeCtor_4)
{
  ...
  succeeded = hlds__type_classify__classify_type_ctor_if_special_2_p_0(TypeCtor_4, &CtorCat0_5);
  if (succeeded)
  {
    succeeded = (CtorCat0_5 == (MR_Word) ((MR_Unsigned) 16U));
    if (!(succeeded))
    {
      MR_Word Var_13;
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__MaybeExistConstraints_23 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, 1))));
  ...
  MR_Word TypeBody_6)
{
    ...
    case (MR_Integer) 2:
      {
        ...
        (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = hlds__type_util__type_body_has_user_defined_equality_pred_3_p_0(ModuleInfo_4, TypeBody_6, &NonCanonical_30);
        if ((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded)
        {
          ...
          if (((((MR_tag((MR_Word) NonCanonical_30)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, NonCanonical_30, 0)))) == (MR_Integer) 0))))
            (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
          else
            (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_FALSE;
        }
    ...
    case (MR_Integer) 0:
      {
        ...
        (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = hlds__type_util__type_body_has_user_defined_equality_pred_3_p_0(ModuleInfo_4, TypeBody_6, &NonCanonical_7);
        if ((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded)
          switch (MR_tag((MR_Word) NonCanonical_7)) {
            ...
            case (MR_Integer) 2:
              ...
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, NonCanonical_7, 0))))) {
                default:
                  (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
  ...
  if (!((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded))
  {
    ...
    if ((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded)
    {
      ...
      Var_29 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_18, 0))));
      (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__HeadCtor_19 = ((MR_Word) ((MR_hl_field(0, Var_29, 0))));
      (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__TailCtors_20 = ((MR_Word) ((MR_hl_field(0, Var_29, 1))));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
          *T_3 = ((MR_Word) ((MR_hl_field(1, Var_17, 0))));
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            *T_3 = ((MR_Word) ((MR_hl_field(1, Var_13, 0))));
        }
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
          *T_3 = ((MR_Word) ((MR_hl_field(1, Var_7, 0))));
      }
      break;
  }
  return succeeded;
...
{
  MR_Word SpecMap_9;
  MR_Word Var_18 = ((MR_Word) ((MR_hl_field(0, SpecMaps_5, 2))));
  MR_Word Var_19 = ((MR_Word) ((MR_hl_field(0, SpecMaps_5, 1))));
  MR_Word Var_20 = ((MR_Word) ((MR_hl_field(0, SpecMaps_5, 0))));
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), SpecMap_9, ((MR_Box) (TypeCtor_7)), &conv0_PredId_8);
  ...
  MR_Word * PredId_8)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), SpecMap_9, ((MR_Box) (TypeCtor_7)), &conv0_PredId_8);
  if (succeeded)
  {
    *PredId_8 = ((MR_Word) (conv0_PredId_8));
    succeeded = MR_TRUE;
