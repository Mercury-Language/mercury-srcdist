            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_80, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), NonCanonical_9, (MR_Integer) 0)));
        }
        succeeded = !(succeeded);
      }
    }
