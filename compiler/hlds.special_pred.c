...
static /* final */ const struct hlds__special_pred__vector_common_type_3_0_s hlds__special_pred_vector_common_3[12];
...
static /* final */ const struct hlds__special_pred__vector_common_type_3_0_s hlds__special_pred_vector_common_3[12] = {
  ...
  /* row 2 */   {     (MR_String) "int" },
  /* row 3 */   {     (MR_String) "pred" },
  /* row 4 */   {     (MR_String) "string" },
  /* row 5 */   {     (MR_String) "uint" },
  /* row 6 */   {     (MR_String) "character" },
  /* row 7 */   {     (MR_String) "float" },
  /* row 8 */   {     (MR_String) "int" },
  /* row 9 */   {     (MR_String) "pred" },
            ...
            if (hlds__special_pred__succeeded)
              {
                ...
                hlds__special_pred__hi_1 = (MR_Integer) 5;
                do
                  {
                    hlds__special_pred__mid_2 = (((hlds__special_pred__lo_0 + hlds__special_pred__hi_1)) / (MR_Integer) 2);
                    hlds__special_pred__result_3 = MR_strcmp(*hlds__special_pred__TypeName_4, ((&hlds__special_pred_vector_common_3[6 + hlds__special_pred__mid_2]))->hlds__special_pred__vector_common_type_3_0__vct_3_f_0);
                    ...
                    if (hlds__special_pred__succeeded)
                      {
                        ...
                        do
                          {
                            hlds__special_pred__mid_2 = (((hlds__special_pred__lo_0 + hlds__special_pred__hi_1)) / (MR_Integer) 2);
                            hlds__special_pred__result_3 = MR_strcmp(hlds__special_pred__V_8_8, ((&hlds__special_pred_vector_common_3[0 + hlds__special_pred__mid_2]))->hlds__special_pred__vector_common_type_3_0__vct_3_f_0);
                            if ((hlds__special_pred__result_3 == (MR_Integer) 0))
                              {
                                hlds__special_pred__succeeded = MR_TRUE;
                                /* jump out of search loop */
                    ...
                    if (!(hlds__special_pred__succeeded))
                      {
                        ...
                        {
                          hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_19, (MR_Integer) 278, (MR_Integer) 0);
                        }
                      }
                    if (hlds__special_pred__succeeded)
                      {
                ...
                if (!(hlds__special_pred__succeeded))
                  {
                    ...
                    {
                      hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_16, (MR_Integer) 278, (MR_Integer) 0);
                    }
                  }
                if (hlds__special_pred__succeeded)
                  {
