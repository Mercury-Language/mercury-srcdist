...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) TypeBody_6)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_6, (MR_Integer) 0))) == (MR_Integer) 1)));
...
{
  {
...

    {
      ...
      (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__MaybeExistConstraints_21)) == (MR_mktag((MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            if (((MR_tag((MR_Word) NonCanonical_27)) == (MR_mktag((MR_Integer) 2))))
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
            else
            if (((MR_tag((MR_Word) NonCanonical_27)) == (MR_mktag((MR_Integer) 0))))
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
            else
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_FALSE;
          }
