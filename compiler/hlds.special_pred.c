...
{
  {
    ...
    {
      uint32_t Var_22 = ((uint32_t) (MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 0)));
      MR_Word Var_24;
      MR_Word Var_25;
      MR_Integer Var_26;
      MR_Word Var_27;
      ...
      (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__MaybeExistConstraints_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 1))));
      Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 2))));
      Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 3))));
      Var_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 4))));
      Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__Ctor_31, (MR_Integer) 5))));
...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded)
          {
            ...
            if (((((MR_tag((MR_Word) NonCanonical_30)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), NonCanonical_30, (MR_Integer) 0)))) == (MR_Integer) 0))))
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_TRUE;
            else
              (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded = MR_FALSE;
          }
    ...
    if (!((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded))
    {
      ...
      if ((env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__succeeded)
      {
        ...
        Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_18, (MR_Integer) 0))));
        Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_18, (MR_Integer) 1))));
        Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_18, (MR_Integer) 2))));
        Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_18, (MR_Integer) 3))));
        Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeBodyDu_18, (MR_Integer) 4))));
        (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__HeadCtor_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 0))));
        (env).hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0_env_0__TailCtors_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 1))));
