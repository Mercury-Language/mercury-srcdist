  ...
  MR_Integer * ProcId_12)
{
  ...
  switch (MR_tag((MR_Word) TypeCategory_13)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(TypeCategory_13)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          MaybeBuiltinTypeName_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__special_pred_scalar_common_3[13]));
          break;
        case (MR_Integer) 1:
          MaybeBuiltinTypeName_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__special_pred_scalar_common_3[14]));
          break;
        case (MR_Integer) 2:
        ...
        switch (MR_tag((MR_Word) Var_81)) {
          ...
          case (MR_Integer) 0:
            switch (MR_unmkbody(Var_81)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                MaybeBuiltinTypeName_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__special_pred_scalar_common_3[1]));
                break;
              case (MR_Integer) 1:
                MaybeBuiltinTypeName_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__special_pred_scalar_common_3[0]));
                break;
              case (MR_Integer) 2:
                MaybeBuiltinTypeName_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__special_pred_scalar_common_3[12]));
                break;
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MaybeBuiltinTypeName_14 = ((&hlds__special_pred_vector_common_4[0 + Var_82]))->hlds__special_pred__vector_common_type_4_0__vct_4_f_0;
            }
            break;
        }
      }
  ...
  {
    MR_String BuiltinTypeName_20 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeBuiltinTypeName_14, (MR_Integer) 0))));
