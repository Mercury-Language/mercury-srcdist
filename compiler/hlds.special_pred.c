    ...
    if (hlds__special_pred__succeeded)
      {
        ...
        hlds__special_pred__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__special_pred__TypeBody_7, (MR_Integer) 2)));
      }
    hlds__special_pred__succeeded = !(hlds__special_pred__succeeded);
    if (hlds__special_pred__succeeded)
      {
        ...
        if (hlds__special_pred__succeeded)
          {
            hlds__special_pred__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__special_pred__TypeBody_7, (MR_Integer) 1)));
            hlds__special_pred__succeeded = (hlds__special_pred__Var_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          }
        hlds__special_pred__succeeded = !(hlds__special_pred__succeeded);
        if (hlds__special_pred__succeeded)
          {
                ...
                if (!(hlds__special_pred__succeeded))
                  {
                    ...
                    {
                      hlds__special_pred__Var_15 = parse_tree__prog_type__is_introduced_type_info_type_category_1_f_0(hlds__special_pred__CtorCat_11);
                    }
                    hlds__special_pred__succeeded = (hlds__special_pred__Var_15 == (MR_Integer) 1);
                  }
                if (hlds__special_pred__succeeded)
                  {
                    {
                      ...
                      {
                        hlds__special_pred__Var_23 = hlds__status__type_status_defined_in_this_module_1_f_0(hlds__special_pred__TypeStatus_8);
                      }
                      hlds__special_pred__succeeded = (hlds__special_pred__Var_23 == (MR_Integer) 0);
                    }
                    if (!(hlds__special_pred__succeeded))
                      {
                    ...
                    if (hlds__special_pred__succeeded)
                      {
                        ...
                        if (hlds__special_pred__succeeded)
                          hlds__special_pred__Var_20 = (MR_Word) MR_body(((MR_Word) hlds__special_pred__TypeBody_7), (MR_Integer) 0);
                        hlds__special_pred__succeeded = !(hlds__special_pred__succeeded);
                        if (hlds__special_pred__succeeded)
                          {
                            hlds__special_pred__Var_24 = (MR_Integer) 0;
                            {
                              hlds__special_pred__succeeded = hlds__special_pred__special_pred_for_type_needs_typecheck_3_p_0(hlds__special_pred__ModuleInfo_5, hlds__special_pred__Var_24, hlds__special_pred__TypeBody_7);
                            }
                            hlds__special_pred__succeeded = !(hlds__special_pred__succeeded);
                          }
                      }
