...
MR_decl_label8(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0, 3,6,7,8,11,13,17,18)
MR_decl_label7(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0, 19,20,2,24,27,26,1)
...
MR_decl_label8(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0, 7,6,11,43,10,16,3,4)
MR_decl_label2(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0, 22,18)
MR_decl_label8(hlds__special_pred__special_pred_get_type_3_0, 3,4,6,7,10,11,13,14)
MR_decl_label1(hlds__special_pred__special_pred_get_type_3_0, 1)
MR_decl_label2(hlds__special_pred__special_pred_get_type_det_3_0, 3,2)
MR_decl_label8(hlds__special_pred__special_pred_interface_5_0, 3,4,5,6,7,8,9,10)
MR_decl_label4(hlds__special_pred__special_pred_interface_5_0, 11,12,13,14)
MR_decl_label8(hlds__special_pred__special_pred_is_generated_lazily_2_0, 2,9,7,11,6,13,14,16)
MR_decl_label8(hlds__special_pred__special_pred_is_generated_lazily_2_0, 17,20,19,22,23,18,28,3)
MR_decl_label1(hlds__special_pred__special_pred_is_generated_lazily_2_0, 1)
MR_decl_label8(hlds__special_pred__special_pred_is_generated_lazily_4_0, 4,7,14,12,16,20,19,22)
MR_decl_label5(hlds__special_pred__special_pred_is_generated_lazily_4_0, 23,18,28,8,1)
...
MR_BEGIN_MODULE(hlds__special_pred_module1)
	...
	MR_init_label8(hlds__special_pred__special_pred_interface_5_0,3,4,5,6,7,8,9,10)
	MR_init_label4(hlds__special_pred__special_pred_interface_5_0,11,12,13,14)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__special_pred__special_pred_interface_5_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		...
		MR_LABEL_AP(hlds__special_pred__special_pred_interface_5_0_i5) MR_AND
		MR_LABEL_AP(hlds__special_pred__special_pred_interface_5_0_i9) MR_AND
		MR_LABEL_AP(hlds__special_pred__special_pred_interface_5_0_i13));
...
MR_def_label(hlds__special_pred__special_pred_interface_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_type__int_type_0_0,
		hlds__special_pred__special_pred_interface_5_0_i6);
MR_def_label(hlds__special_pred__special_pred_interface_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(parse_tree__prog_mode__in_mode_1_0,
		hlds__special_pred__special_pred_interface_5_0_i7);
MR_def_label(hlds__special_pred__special_pred_interface_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
...
MR_def_label(hlds__special_pred__special_pred_interface_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_type__comparison_result_type_0_0,
		hlds__special_pred__special_pred_interface_5_0_i10);
MR_def_label(hlds__special_pred__special_pred_interface_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(hlds__special_pred__special_pred_interface_5_0,11)
	...
	MR_np_call_localret_ent(parse_tree__prog_mode__uo_mode_1_0,
		hlds__special_pred__special_pred_interface_5_0_i12);
MR_def_label(hlds__special_pred__special_pred_interface_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(hlds__special_pred_module4)
	...
	MR_init_label8(hlds__special_pred__special_pred_get_type_3_0,3,4,6,7,10,11,13,14)
	MR_init_label1(hlds__special_pred__special_pred_get_type_3_0,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__special_pred__special_pred_get_type_3_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		...
		MR_LABEL_AP(hlds__special_pred__special_pred_get_type_3_0_i6) MR_AND
		MR_LABEL_AP(hlds__special_pred__special_pred_get_type_3_0_i10) MR_AND
		MR_LABEL_AP(hlds__special_pred__special_pred_get_type_3_0_i13));
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
		hlds__special_pred__special_pred_get_type_3_0_i4);
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
		hlds__special_pred__special_pred_get_type_3_0_i7);
...
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
		hlds__special_pred__special_pred_get_type_3_0_i11);
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_get_type_3_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
...
MR_BEGIN_MODULE(hlds__special_pred_module7)
	...
	MR_init_label8(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,7,6,11,43,10,16,3,4)
	MR_init_label2(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,22,18)
MR_BEGIN_CODE
...
MR_def_label(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,6)
	...
	if (MR_INT_NE(MR_r2,2)) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0_i10);
	}
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_body_has_user_defined_equality_pred_3_0,
		hlds__special_pred__special_pred_for_type_needs_typecheck_3_0_i11);
...
MR_def_label(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_body_is_solver_type_2_0,
		hlds__special_pred__special_pred_for_type_needs_typecheck_3_0_i16);
MR_def_label(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_for_type_needs_typecheck_3_0_i43);
	}
...
MR_BEGIN_MODULE(hlds__special_pred_module8)
	...
	MR_init_label8(hlds__special_pred__special_pred_is_generated_lazily_2_0,2,9,7,11,6,13,14,16)
	MR_init_label8(hlds__special_pred__special_pred_is_generated_lazily_2_0,17,20,19,22,23,18,28,3)
	MR_init_label1(hlds__special_pred__special_pred_is_generated_lazily_2_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__special_pred_module9)
	...
	MR_init_label8(hlds__special_pred__special_pred_is_generated_lazily_4_0,4,7,14,12,16,20,19,22)
	MR_init_label5(hlds__special_pred__special_pred_is_generated_lazily_4_0,23,18,28,8,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0,4)
	...
	if ((strcmp((char *)MR_sv(1), (char *)(MR_Word) MR_string_const("character", 9)) != 0)) {
...
MR_def_label(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(1), (char *)(MR_Word) MR_string_const("float", 5)) != 0)) {
...
MR_def_label(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(1), (char *)(MR_Word) MR_string_const("int", 3)) != 0)) {
...
MR_def_label(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(1), (char *)(MR_Word) MR_string_const("pred", 4)) != 0)) {
...
MR_def_label(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(1), (char *)(MR_Word) MR_string_const("string", 6)) != 0)) {
		MR_GOTO_LAB(hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_0_i1);
	}
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__special_pred_module12)
	...
	MR_init_label8(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,3,6,7,8,11,13,17,18)
	MR_init_label7(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,19,20,2,24,27,26,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_public_builtin_module_0_0,
		hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i11);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(2);
	...
	MR_np_call_localret_ent(__Unify___mdbcomp__prim_data__sym_name_0_0,
		hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i13);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i1);
	}
	...
	if ((strcmp((char *)MR_sv(4), (char *)(MR_Word) MR_string_const("character", 9)) != 0)) {
		MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i17);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i2);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(4), (char *)(MR_Word) MR_string_const("float", 5)) != 0)) {
...
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(4), (char *)(MR_Word) MR_string_const("int", 3)) != 0)) {
...
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(4), (char *)(MR_Word) MR_string_const("pred", 4)) != 0)) {
...
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *)MR_sv(4), (char *)(MR_Word) MR_string_const("string", 6)) != 0)) {
		MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i1);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,2)
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_ctor_has_hand_defined_rtti_2_0,
		hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i24);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i1);
	}
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(check_hlds__type_util__type_body_has_user_defined_equality_pred_3_0,
		hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i27);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0_i26);
	}
	MR_r1 = (MR_tag(MR_r2) != MR_mktag((MR_Integer) 1));
	MR_decr_sp_and_return(6);
MR_def_label(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_r1 = MR_TRUE;
...
void mercury__hlds__special_pred__write_out_proc_statics(FILE *fp);
#endif
