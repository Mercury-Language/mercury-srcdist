                    ...
                    if (!(hlds__special_pred__succeeded))
                      {
                        ...
                        {
                          hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_19, (MR_Integer) 273, (MR_Integer) 0);
                        }
                      }
                    if (hlds__special_pred__succeeded)
                      {
                ...
                if (!(hlds__special_pred__succeeded))
                  {
                    ...
                    {
                      hlds__special_pred__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__special_pred__Globals_16, (MR_Integer) 273, (MR_Integer) 0);
                    }
                  }
                if (hlds__special_pred__succeeded)
                  {
