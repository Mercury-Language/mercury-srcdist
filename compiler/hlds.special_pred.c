...
MR_decl_label8(hlds__special_pred__special_pred_get_type_3_0, 5,3,9,7,14,12,17,1)
...
MR_BEGIN_MODULE(hlds__special_pred_module4)
	...
	MR_init_label8(hlds__special_pred__special_pred_get_type_3_0,5,3,9,7,14,12,17,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_get_type_3_0_i7);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
...
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_get_type_3_0_i12);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
...
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_np_call_localret_ent(list__reverse_2_0,
		hlds__special_pred__special_pred_get_type_3_0_i17);
MR_def_label(hlds__special_pred__special_pred_get_type_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__special_pred__special_pred_get_type_3_0_i1);
	}
