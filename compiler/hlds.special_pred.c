  ...
  MR_Integer * ProcId_12)
{
  ...
  TypeCategory_13 = hlds__type_util__classify_type_ctor_2_f_0(ModuleInfo_7, TypeCtor_8);
  ...
  MR_Word TypeStatus_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      succeeded = hlds__type_util__classify_type_ctor_if_special_2_p_0(TypeCtor_6, &CtorCat0_10);
      if (succeeded)
      {
  ...
  MR_Word TypeCtor_4)
{
  ...
  succeeded = hlds__type_util__classify_type_ctor_if_special_2_p_0(TypeCtor_4, &CtorCat0_5);
  if (succeeded)
  {
