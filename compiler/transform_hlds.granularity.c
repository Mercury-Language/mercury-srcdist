              ...
              case (MR_Integer) 1:
                {
                  ...
                  transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Var_132, &Goals_15, STATE_VARIABLE_Changed_0_69, &STATE_VARIABLE_Changed_72_72, SCC_10, ModuleInfo_11);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        else
                        {
                          ...
                          hlds__goal_util__generate_call_foreign_proc_17_p_0(ModuleInfo_11, (MR_Integer) 0, ModuleName_18, (MR_String) "evaluate_parallelism_condition", (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Var_92, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Integer) 2, (MR_Word) ((MR_Unsigned) 0U), Attributes_27, (MR_Word) ((MR_Unsigned) 0U), Var_96, Context_26, &Cond_28);
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_97, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                            MR_hl_field(MR_mktag(3), Var_97, 2) = ((MR_Box) (Goals_15));
                          }
                          {
                            Then_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Then_29, 0) = ((MR_Box) (Var_97));
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_99, 2) = ((MR_Box) (Goals_15));
                          }
                          {
                            Else_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Else_30, 0) = ((MR_Box) (Var_99));
                            MR_hl_field(MR_mktag(0), Else_30, 1) = ((MR_Box) (GoalInfo_13));
                          }
                          {
                            Var_101 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(3), Var_101, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                            MR_hl_field(MR_mktag(3), Var_101, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                            MR_hl_field(MR_mktag(3), Var_101, 2) = ((MR_Box) (Cond_28));
                            MR_hl_field(MR_mktag(3), Var_101, 3) = ((MR_Box) (Then_29));
                            MR_hl_field(MR_mktag(3), Var_101, 4) = ((MR_Box) (Else_30));
                          }
                          {
                            IfThenElse_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), IfThenElse_31, 0) = ((MR_Box) (Var_101));
