...
MR_decl_label10(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 22,23,24,25,26,27,28,29,11,39)
MR_decl_label10(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 6,41,4,45,44,49,50,51,48,55)
MR_decl_label9(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 54,59,62,58,67,66,70,151,150)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__granularity__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__granularity_module4)
	...
	MR_init_label10(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,22,23,24,25,26,27,28,29,11,39)
	MR_init_label10(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,6,41,4,45,44,49,50,51,48,55)
	MR_init_label9(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,54,59,62,58,67,66,70,151,150)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i151);
	}
	MR_incr_sp(8);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,11)
	...
	MR_np_call_localret_ent(fn__transform_hlds__granularity__this_file_0_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i39);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,4)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,2)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i44);
	}
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
	MR_r1 = MR_tfield(3, MR_r5, 1);
	MR_np_call_localret_ent(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i45);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,48)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i54);
	}
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
	MR_r1 = MR_tfield(3, MR_r5, 1);
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,54)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,5)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i58);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r5;
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i59);
	}
	MR_tempr2 = MR_tfield(3, MR_tempr1, 2);
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i150);
	}
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,58)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,3)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i66);
	}
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i67);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__granularity__this_file_0_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i70);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("runtime_granularity_test_in_goal: shorthand", 43);
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(require__unexpected_2_0);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,151)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,150)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__granularity_module7)
...
static void mercury__transform_hlds__granularity_maybe_bunch_0(void)
{
	...
	transform_hlds__granularity_module7();
}
