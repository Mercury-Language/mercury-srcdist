...
MR_decl_label3(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0, 4,5,3)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 99,12,11,13,14,15,18,19)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 21,22,23,24,25,26,27,28)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 29,30,31,32,33,34,35,45)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 46,100,49,101,51,102,53,103)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 55,104,57,58,59,105,61,98)
MR_decl_label3(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0, 4,5,3)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,99,12,11,13,14,15,18,19)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,21,22,23,24,25,26,27,28)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,29,30,31,32,33,34,35,45)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,46,100,49,101,51,102,53,103)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,55,104,57,58,59,105,61,98)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i98);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i98) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i99) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i100) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i101) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i102) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i103) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i104) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i105));
	}
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,13)
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i14);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(libs__globals__get_target_2_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i15);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i45);
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,19)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i21);
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,31)
	...
	MR_np_call_localret_ent(parse_tree__prog_data__set_may_throw_exception_3_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i32);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(parse_tree__prog_data__set_may_call_mm_tabled_3_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i33);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(parse_tree__prog_data__set_may_modify_trail_3_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i34);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_r1;
	MR_r1 = MR_sv(1);
	...
	MR_np_call_localret_ent(hlds__goal_util__generate_foreign_proc_16_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i35);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__granularity__this_file_0_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i46);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("runtime_granularity_test_in_goal: unsupported target language", 61);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i55);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,57)
	...
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i58);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r4 = MR_sv(2);
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i59);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,105)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__granularity__this_file_0_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i61);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,61)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,98)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__granularity_module4)
	...
	MR_init_label3(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0_i3);
	}
	MR_incr_sp(4);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__granularity_module5)
	...
	MR_init_label3(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0_i3);
	}
	MR_incr_sp(5);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,4)
	...
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_cases_6_0_i5);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__granularity__write_out_proc_statics(FILE *fp);
#endif
