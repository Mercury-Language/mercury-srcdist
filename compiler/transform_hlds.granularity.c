  ...
  switch (MR_tag((MR_Word) GoalExpr0_12)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Var_132 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 2))));
            MR_Word Var_133 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1))) & (MR_Integer) 1);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Var_132, &Goals_15, STATE_VARIABLE_Changed_0_69, &STATE_VARIABLE_Changed_84_84, SCC_10, ModuleInfo_11);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        else
                        {
                          ...
                          hlds__goal_util__generate_call_foreign_proc_17_p_0(ModuleInfo_11, (MR_Integer) 0, ModuleName_18, (MR_String) "evaluate_parallelism_condition", (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Var_106, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Integer) 2, (MR_Word) ((MR_Unsigned) 0U), Attributes_27, (MR_Word) ((MR_Unsigned) 0U), Var_110, Context_26, &Cond_28);
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_111, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                            MR_hl_field(MR_mktag(3), Var_111, 2) = ((MR_Box) (Goals_15));
                          }
                          {
                            Then_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Then_29, 0) = ((MR_Box) (Var_111));
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_113, 2) = ((MR_Box) (Goals_15));
                          }
                          {
                            Else_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), Else_30, 0) = ((MR_Box) (Var_113));
                            MR_hl_field(MR_mktag(0), Else_30, 1) = ((MR_Box) (GoalInfo_13));
                          }
                          {
                            Var_115 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(3), Var_115, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                            MR_hl_field(MR_mktag(3), Var_115, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                            MR_hl_field(MR_mktag(3), Var_115, 2) = ((MR_Box) (Cond_28));
                            MR_hl_field(MR_mktag(3), Var_115, 3) = ((MR_Box) (Then_29));
                            MR_hl_field(MR_mktag(3), Var_115, 4) = ((MR_Box) (Else_30));
                          }
                          {
                            IfThenElse_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), IfThenElse_31, 0) = ((MR_Box) (Var_115));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Var_132, &Goals_120, STATE_VARIABLE_Changed_0_69, STATE_VARIABLE_Changed_70, SCC_10, ModuleInfo_11);
                  {
                    GoalExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_20, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                    MR_hl_field(MR_mktag(3), GoalExpr_20, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), GoalExpr_20, 2) = ((MR_Box) (Goals_120));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 3:
          {
            MR_Word Goals0_121 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1))));
            MR_Word Goals_122;
            ...
            transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Goals0_121, &Goals_122, STATE_VARIABLE_Changed_0_69, STATE_VARIABLE_Changed_70, SCC_10, ModuleInfo_11);
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_20, 1) = ((MR_Box) (Goals_122));
            }
          }
          break;
        case (MR_Integer) 4:
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_128 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 1))));
            MR_Word SubGoal0_129 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 2))));
            MR_Word FGT_44;

            succeeded = ((((MR_tag((MR_Word) Reason_128)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Reason_128, (MR_Integer) 0)))) == (MR_Integer) 6)));
            if (succeeded)
            {
              FGT_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_128, (MR_Integer) 2))) & (MR_Integer) 3);
              switch (FGT_44) {
                default:
                  succeeded = MR_FALSE;
                  break;
            ...
            else
            {
              ...
              transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(SubGoal0_129, &SubGoal_126, STATE_VARIABLE_Changed_0_69, STATE_VARIABLE_Changed_70, SCC_10, ModuleInfo_11);
              {
                GoalExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_20, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                MR_hl_field(MR_mktag(3), GoalExpr_20, 1) = ((MR_Box) (Reason_128));
                MR_hl_field(MR_mktag(3), GoalExpr_20, 2) = ((MR_Box) (SubGoal_126));
              }
            }
          }
          break;
        case (MR_Integer) 6:
          {
            ...
            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Cond0_38, &Cond_123, STATE_VARIABLE_Changed_0_69, &STATE_VARIABLE_Changed_75_75, SCC_10, ModuleInfo_11);
            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Then0_39, &Then_124, STATE_VARIABLE_Changed_75_75, &STATE_VARIABLE_Changed_76_76, SCC_10, ModuleInfo_11);
            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Else0_40, &Else_125, STATE_VARIABLE_Changed_76_76, STATE_VARIABLE_Changed_70, SCC_10, ModuleInfo_11);
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_20, 2) = ((MR_Box) (Cond_123));
              MR_hl_field(MR_mktag(3), GoalExpr_20, 3) = ((MR_Box) (Then_124));
              MR_hl_field(MR_mktag(3), GoalExpr_20, 4) = ((MR_Box) (Else_125));
            }
          }
          break;
        case (MR_Integer) 7:
