...
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 102,12,11,13,14,15,18,19)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 21,22,23,24,25,26,27,28)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 29,30,31,32,33,34,35,48)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 49,103,52,104,54,105,56,106)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 58,107,60,61,62,108,64,101)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,102,12,11,13,14,15,18,19)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,21,22,23,24,25,26,27,28)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,29,30,31,32,33,34,35,48)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,49,103,52,104,54,105,56,106)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,58,107,60,61,62,108,64,101)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i101);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		...
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i105) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i106) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i107) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i108));
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,15)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i48);
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,105)
	...
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i56);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,61)
	...
	MR_r4 = MR_sv(2);
	MR_np_localcall_lab(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i62);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,108)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__granularity__this_file_0_0,
