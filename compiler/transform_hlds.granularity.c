...
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 104,7,8,9,12,13,15,18)
...
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 43,105,47,109,51,52,53,107)
MR_decl_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 57,108,61,110,65,106,68,103)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,104,7,8,9,12,13,15,18)
	...
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,43,105,47,109,51,52,53,107)
	MR_init_label8(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,57,108,61,110,65,106,68,103)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i103);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		...
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i108) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i109) MR_AND
		MR_LABEL_AP(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i110));
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,106)
	...
	MR_np_call_localret_ent(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i68);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
