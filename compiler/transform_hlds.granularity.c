...
MR_decl_label3(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0, 13,4,5)
...
MR_decl_label3(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0, 13,4,5)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module4)
	...
	MR_init_label3(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goals_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(transform_hlds__granularity_module5)
	...
	MR_init_label3(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
