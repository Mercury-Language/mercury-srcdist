...
MR_decl_label7(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 60,57,62,56,67,66,164)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_init_label7(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,60,57,62,56,67,66,164)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)))) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i164);
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,53)
	...
	if (MR_INT_NE(MR_r5,1)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i60);
	}
	MR_tempr2 = MR_tempr1;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,66)
	...
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,164)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__granularity__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__granularity);
