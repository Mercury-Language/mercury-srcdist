    ...
    switch (MR_tag((MR_Word) transform_hlds__granularity__GoalExpr0_12)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__granularity__GoalExpr0_12, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word transform_hlds__granularity__Var_133 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__granularity__GoalExpr0_12, (MR_Integer) 2)));
              MR_Word transform_hlds__granularity__Var_134 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__granularity__GoalExpr0_12, (MR_Integer) 1)));

              switch (transform_hlds__granularity__Var_134) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_Word transform_hlds__granularity__Goals_15;
                    ...
                    transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(transform_hlds__granularity__Var_133, &transform_hlds__granularity__Goals_15, transform_hlds__granularity__STATE_VARIABLE_Changed_0_69, &transform_hlds__granularity__STATE_VARIABLE_Changed_85_85, transform_hlds__granularity__SCC_10, transform_hlds__granularity__ModuleInfo_11);
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          else
                          {
                            ...
                            MR_String transform_hlds__granularity__Var_110;
                            MR_Word transform_hlds__granularity__Var_111;
                            MR_Word transform_hlds__granularity__Var_112;
                            MR_Word transform_hlds__granularity__Var_114;
                            MR_Word transform_hlds__granularity__Var_116;
                            ...
                            transform_hlds__granularity__Var_110 = transform_hlds__granularity__runtime_test_code_0_f_0();
                            transform_hlds__granularity__Var_111 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
                            hlds__goal_util__generate_foreign_proc_16_p_0(transform_hlds__granularity__ModuleName_18, (MR_String) "evaluate_parallelism_condition", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 1, (MR_Integer) 2, transform_hlds__granularity__Attributes_27, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), transform_hlds__granularity__Var_110, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), transform_hlds__granularity__Var_111, transform_hlds__granularity__ModuleInfo_11, transform_hlds__granularity__Context_26, &transform_hlds__granularity__Cond_28);
                            {
                              transform_hlds__granularity__Var_112 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_112, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_112, 1) = ((MR_Box) ((MR_Integer) 1));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_112, 2) = ((MR_Box) (transform_hlds__granularity__Goals_15));
                            }
                            {
                              transform_hlds__granularity__Then_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(MR_mktag(0), transform_hlds__granularity__Then_29, 0) = ((MR_Box) (transform_hlds__granularity__Var_112));
                              MR_hl_field(MR_mktag(0), transform_hlds__granularity__Then_29, 1) = ((MR_Box) (transform_hlds__granularity__GoalInfo_13));
                            }
                            {
                              transform_hlds__granularity__Var_114 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_114, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_114, 1) = ((MR_Box) ((MR_Integer) 0));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_114, 2) = ((MR_Box) (transform_hlds__granularity__Goals_15));
                            }
                            {
                              transform_hlds__granularity__Else_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(MR_mktag(0), transform_hlds__granularity__Else_30, 0) = ((MR_Box) (transform_hlds__granularity__Var_114));
                              MR_hl_field(MR_mktag(0), transform_hlds__granularity__Else_30, 1) = ((MR_Box) (transform_hlds__granularity__GoalInfo_13));
                            }
                            {
                              transform_hlds__granularity__Var_116 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_116, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_116, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_116, 2) = ((MR_Box) (transform_hlds__granularity__Cond_28));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_116, 3) = ((MR_Box) (transform_hlds__granularity__Then_29));
                              MR_hl_field(MR_mktag(3), transform_hlds__granularity__Var_116, 4) = ((MR_Box) (transform_hlds__granularity__Else_30));
                            }
                            {
                              transform_hlds__granularity__IfThenElse_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(MR_mktag(0), transform_hlds__granularity__IfThenElse_31, 0) = ((MR_Box) (transform_hlds__granularity__Var_116));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(transform_hlds__granularity__Var_133, &transform_hlds__granularity__Goals_121, transform_hlds__granularity__STATE_VARIABLE_Changed_0_69, transform_hlds__granularity__STATE_VARIABLE_Changed_70, transform_hlds__granularity__SCC_10, transform_hlds__granularity__ModuleInfo_11);
                    {
                      transform_hlds__granularity__GoalExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), transform_hlds__granularity__GoalExpr_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word transform_hlds__granularity__Var_43;
              ...
              if (transform_hlds__granularity__succeeded)
              {
                transform_hlds__granularity__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__granularity__Reason_129, (MR_Integer) 1)));
...
{
  {
    MR_Word transform_hlds__granularity__Var_8;
    MR_Box transform_hlds__granularity__conv1_STATE_VARIABLE_ModuleInfo_7;

    {
      transform_hlds__granularity__Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), transform_hlds__granularity__Var_8, 0) = ((MR_Box) (&transform_hlds__granularity_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), transform_hlds__granularity__Var_8, 1) = ((MR_Box) (transform_hlds__granularity__runtime_granularity_test_in_scc_3_p_0_1));
      MR_hl_field(MR_mktag(0), transform_hlds__granularity__Var_8, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), transform_hlds__granularity__Var_8, 3) = ((MR_Box) (transform_hlds__granularity__SCC_4));
    }
    mercury__set__foldl_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, transform_hlds__granularity__Var_8, transform_hlds__granularity__SCC_4, ((MR_Box) (transform_hlds__granularity__STATE_VARIABLE_ModuleInfo_0_6)), &transform_hlds__granularity__conv1_STATE_VARIABLE_ModuleInfo_7);
