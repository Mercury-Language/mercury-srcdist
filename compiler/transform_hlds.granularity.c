...
MR_decl_label7(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0, 58,61,57,66,65,149,148)
...
MR_BEGIN_MODULE(transform_hlds__granularity_module3)
	...
	MR_init_label7(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,58,61,57,66,65,149,148)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i149);
	}
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,57)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,3)) {
		MR_GOTO_LAB(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i65);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__granularity__runtime_granularity_test_in_cases_6_0,
		transform_hlds__granularity__runtime_granularity_test_in_goal_6_0_i66);
...
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,65)
	...
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__granularity__runtime_granularity_test_in_goal_6_0,149)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
