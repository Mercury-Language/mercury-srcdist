...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__granularity__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
static /* final */ const MR_Box transform_hlds__granularity_scalar_common_2[1][6] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 3)),
    ((MR_Box) (&transform_hlds__granularity__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0)),
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_19)
{
  ...
  hlds__hlds_proc__proc_info_get_has_parallel_conj_2_p_0(ProcInfo0_10, &HasParallelConj_11);
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_proc__proc_info_get_goal_2_p_0(ProcInfo0_10, &Goal0_12);
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_13, ProcInfo0_10, &ProcInfo1_15);
              hlds__quantification__requantify_proc_general_3_p_1((MR_Integer) 1, ProcInfo1_15, &ProcInfo_16);
  ...
  MR_Word ModuleInfo_6)
{
  ...
  else
  {
    ...
    transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Goal0_21, &Goal_22, STATE_VARIABLE_Changed_0_3, &STATE_VARIABLE_Changed_1_25, SCC_5, ModuleInfo_6);
    {
    ...
    transform_hlds__granularity__runtime_granularity_test_in_cases_6_p_0(Cases0_13, &Cases_15, STATE_VARIABLE_Changed_1_25, STATE_VARIABLE_Changed_4, SCC_5, ModuleInfo_6);
    {
      MR_Word base;
  ...
  MR_Word ModuleInfo_6)
{
  ...
  else
  {
    ...
    MR_Word Goal_14;
    MR_Word Goals_15;
    MR_Word STATE_VARIABLE_Changed_1_21;

    transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Goal0_12, &Goal_14, STATE_VARIABLE_Changed_0_3, &STATE_VARIABLE_Changed_1_21, SCC_5, ModuleInfo_6);
    transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Goals0_13, &Goals_15, STATE_VARIABLE_Changed_1_21, STATE_VARIABLE_Changed_4, SCC_5, ModuleInfo_6);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__2_2 = base;
  ...
  switch (MR_tag((MR_Word) GoalExpr0_12)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr0_12, 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Var_131 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 2))));
            MR_Word Var_132 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_12, 1))) & (MR_Integer) 1);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word Globals_16;
                  MR_Word Target_17;
                  MR_Word STATE_VARIABLE_Changed_1_72;

                  transform_hlds__granularity__runtime_granularity_test_in_goals_6_p_0(Var_131, &Goals_15, STATE_VARIABLE_Changed_0_69, &STATE_VARIABLE_Changed_1_72, SCC_10, ModuleInfo_11);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        CalledSCCPredProcIds_19 = hlds__goal_refs__goal_list_calls_proc_in_set_2_f_0(Goals_15, SCC_10);
                        succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), CalledSCCPredProcIds_19);
                        if (succeeded)
                        {
                          {
                          ...
                          *STATE_VARIABLE_Changed_70 = STATE_VARIABLE_Changed_1_72;
                        }
                        else
                        {
                          MR_Word Context_26;
                          ...
                          MR_Word STATE_VARIABLE_Attributes_1_74;
                          MR_Word STATE_VARIABLE_Attributes_2_77;
                          MR_Word STATE_VARIABLE_Attributes_3_79;
                          MR_Word STATE_VARIABLE_Attributes_4_81;
                          MR_Word STATE_VARIABLE_Attributes_5_83;
                          MR_Word STATE_VARIABLE_Attributes_6_85;
                          MR_Word STATE_VARIABLE_Attributes_7_87;
                          MR_Word Var_92;
                          MR_String Var_96;
                          MR_Word Var_97;
                          MR_Word Var_99;
                          ...
                          STATE_VARIABLE_Attributes_1_74 = parse_tree__prog_data_foreign__default_attributes_1_f_0((MR_Integer) 0);
                          parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 1, STATE_VARIABLE_Attributes_1_74, &STATE_VARIABLE_Attributes_2_77);
                          parse_tree__prog_data_foreign__set_purity_3_p_0((MR_Integer) 2, STATE_VARIABLE_Attributes_2_77, &STATE_VARIABLE_Attributes_3_79);
                          parse_tree__prog_data_foreign__set_may_call_mercury_3_p_0((MR_Integer) 1, STATE_VARIABLE_Attributes_3_79, &STATE_VARIABLE_Attributes_4_81);
                          parse_tree__prog_data_foreign__set_terminates_3_p_0((MR_Integer) 0, STATE_VARIABLE_Attributes_4_81, &STATE_VARIABLE_Attributes_5_83);
                          parse_tree__prog_data_foreign__set_may_throw_exception_3_p_0((MR_Integer) 0, STATE_VARIABLE_Attributes_5_83, &STATE_VARIABLE_Attributes_6_85);
                          parse_tree__prog_data_foreign__set_may_call_mm_tabled_3_p_0((MR_Integer) 1, STATE_VARIABLE_Attributes_6_85, &STATE_VARIABLE_Attributes_7_87);
                          parse_tree__prog_data_foreign__set_may_modify_trail_3_p_0((MR_Integer) 1, STATE_VARIABLE_Attributes_7_87, &Attributes_27);
        ...
        case (MR_Integer) 3:
          {
            MR_Word Goals0_121 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 1))));
            MR_Word Goals_122;
        ...
        case (MR_Integer) 4:
          {
            MR_Word Var_33 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 1))));
            MR_Word CanFail_34 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_12, 2))) & (MR_Integer) 1);
            MR_Word Cases0_35 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 3))));
            MR_Word Cases_36;
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_128 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 1))));
            MR_Word SubGoal0_129 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 2))));
            MR_Word FGT_44;

            succeeded = ((((MR_tag((MR_Word) Reason_128)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason_128, 0)))) == (MR_Integer) 6)));
            if (succeeded)
            {
              FGT_44 = ((MR_Unsigned) ((MR_hl_field(3, Reason_128, 2))) & (MR_Integer) 3);
              switch (FGT_44) {
                default:
                  succeeded = MR_FALSE;
                  break;
        ...
        case (MR_Integer) 6:
          {
            MR_Word Vars_37 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 1))));
            MR_Word Cond0_38 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 2))));
            MR_Word Then0_39 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 3))));
            MR_Word Else0_40 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, 4))));
            MR_Word STATE_VARIABLE_Changed_6_112;
            MR_Word STATE_VARIABLE_Changed_7_113;
            MR_Word Cond_123;
            MR_Word Then_124;
            MR_Word Else_125;

            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Cond0_38, &Cond_123, STATE_VARIABLE_Changed_0_69, &STATE_VARIABLE_Changed_6_112, SCC_10, ModuleInfo_11);
            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Then0_39, &Then_124, STATE_VARIABLE_Changed_6_112, &STATE_VARIABLE_Changed_7_113, SCC_10, ModuleInfo_11);
            transform_hlds__granularity__runtime_granularity_test_in_goal_6_p_0(Else0_40, &Else_125, STATE_VARIABLE_Changed_7_113, STATE_VARIABLE_Changed_70, SCC_10, ModuleInfo_11);
            {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__granularity__runtime_granularity_test_in_proc_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ModuleInfo_19);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_7)
{
  ...
  mercury__set__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_8, SCC_4, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_6)), &conv1_STATE_VARIABLE_ModuleInfo_7);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_7)
{
  ...
  hlds__hlds_dependency_graph__module_info_rebuild_dependency_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_6, &STATE_VARIABLE_ModuleInfo_1_8, &DepInfo_4);
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__granularity_scalar_common_1[0]), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__granularity_scalar_common_3[0]), SCCs_5, ((MR_Box) (STATE_VARIABLE_ModuleInfo_1_8)), &conv1_STATE_VARIABLE_ModuleInfo_7);
  *STATE_VARIABLE_ModuleInfo_7 = ((MR_Word) (conv1_STATE_VARIABLE_ModuleInfo_7));
}
