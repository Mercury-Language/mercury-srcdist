        ...
        case (MR_Integer) 0:
          {
            ...
            ForeignImportedModuleNames_48 = parse_tree__prog_data_foreign__get_all_foreign_import_modules_1_f_0(ForeignImportedModules_45);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&parse_tree__deps_map_scalar_common_7[0]));
            ...
            parse_tree__module_imports__module_and_imports_get_int_deps_2_p_0(ModuleImports_43, &IntDepsMap_49);
            parse_tree__module_imports__module_and_imports_get_imp_deps_2_p_0(ModuleImports_43, &ImpDepsMap_50);
            parse_tree__module_imports__module_and_imports_get_public_children_2_p_0(ModuleImports_43, &PublicChildren_51);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__deps_map_scalar_common_2[1]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[0]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[5]), IntDepsModuleNamesContexts_52, ((MR_Box) (STATE_VARIABLE_Modules_45_62)), &conv6_STATE_VARIABLE_Modules_47_64);
            STATE_VARIABLE_Modules_47_64 = ((MR_Word) (conv6_STATE_VARIABLE_Modules_47_64));
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__deps_map_scalar_common_2[1]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[0]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[6]), ImpDepsModuleNamesContexts_53, ((MR_Box) (STATE_VARIABLE_Modules_47_64)), &conv8_STATE_VARIABLE_Modules_49_66);
            STATE_VARIABLE_Modules_49_66 = ((MR_Word) (conv8_STATE_VARIABLE_Modules_49_66));
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__deps_map_scalar_common_2[1]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[0]), (MR_Word) (&parse_tree__deps_map_scalar_common_2[7]), ChildrenModuleNamesContexts_54, ((MR_Box) (STATE_VARIABLE_Modules_49_66)), &conv10_STATE_VARIABLE_Modules_21_21);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_66_66 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      mercury__set__intersect_3_p_0(TypeCtorInfo_66_66, Errors_18, Var_50, &FatalErrors_22);
      succeeded = mercury__set__is_non_empty_1_p_0(TypeCtorInfo_66_66, FatalErrors_22);
    }
    if (succeeded)
    {
      ...
      parse_tree__prog_item__int_imp_items_to_item_blocks_11_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_section_0), ModuleName_9, ModuleContext_30, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_Integer) 1)), IntIncl_32, ImpIncls_33, IntAvails_34, ImpAvails_35, IntItems_36, ImpItems_37, &RawItemBlocks_38);
      {
        Var_59 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (ModuleName_9));
        MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (ModuleContext_30));
        MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) (RawItemBlocks_38));
      }
      {
        RawCompUnits_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), RawCompUnits_39, 0) = ((MR_Box) (Var_59));
    ...
    else
    {
      ...
      parse_tree__error_util__write_error_specs_ignore_4_p_0(Specs_40, Globals_8);
    }
    RawCompUnitModuleNames_41 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_raw_compilation_unit_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map_scalar_common_2[3]), RawCompUnits_39);
    RawCompUnitModuleNamesSet_42 = mercury__set__list_to_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), RawCompUnitModuleNames_41);
    {
      Var_63 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&parse_tree__deps_map_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (parse_tree__deps_map__read_dependencies_7_p_0_2));
      MR_hl_field(MR_mktag(0), Var_63, 2) = ((MR_Box) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(0), Var_63, 3) = ((MR_Box) (Globals_8));
      MR_hl_field(MR_mktag(0), Var_63, 4) = ((MR_Box) (FileName_23));
      MR_hl_field(MR_mktag(0), Var_63, 5) = ((MR_Box) (ModuleName_9));
      MR_hl_field(MR_mktag(0), Var_63, 6) = ((MR_Box) (RawCompUnitModuleNamesSet_42));
      MR_hl_field(MR_mktag(0), Var_63, 7) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(0), Var_63, 8) = ((MR_Box) (Errors_18));
    }
    mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_raw_compilation_unit_0), (MR_Word) (&parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_module_and_imports_0), Var_63, RawCompUnits_39, ModuleAndImportsList_12);
  }
}
