...
MR_decl_label10(parse_tree__deps_map__lookup_dependencies_9_0, 3,2,5,9,6,12,13,14,15,17)
MR_decl_label2(parse_tree__deps_map__lookup_dependencies_9_0, 19,20)
...
MR_BEGIN_MODULE(parse_tree__deps_map_module1)
	...
	MR_init_label10(parse_tree__deps_map__lookup_dependencies_9_0,3,2,5,9,6,12,13,14,15,17)
	MR_init_label2(parse_tree__deps_map__lookup_dependencies_9_0,19,20)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,9)
	...
	MR_GOTO_LAB(parse_tree__deps_map__lookup_dependencies_9_0_i14);
	}
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,6)
	...
	MR_np_call_localret_ent(parse_tree__modules__split_into_submodules_5_0,
		parse_tree__deps_map__lookup_dependencies_9_0_i12);
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(3);
...
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,14)
	...
	MR_np_call_localret_ent(assoc_list__keys_2_0,
		parse_tree__deps_map__lookup_dependencies_9_0_i15);
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,17)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		parse_tree__deps_map__lookup_dependencies_9_0_i19);
MR_def_label(parse_tree__deps_map__lookup_dependencies_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__prim_data, sym_name);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__deps_map, deps);
...
MR_BEGIN_MODULE(parse_tree__deps_map_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__153__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__generate_deps_map_step__153__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
void mercury__parse_tree__deps_map__init_threadscope_string_table(void);
#endif
...
void mercury__parse_tree__deps_map__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parse_tree__deps_map);
