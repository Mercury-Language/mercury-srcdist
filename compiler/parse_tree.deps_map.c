  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
    ...
    {
      Var_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_52, 0) = ((MR_Box) (ModuleName_14));
    }
    parse_tree__read_modules__read_module_src_10_p_0(Globals_12, Var_52, (MR_Integer) 0, Search_13, ModuleName_14, ExpectationContexts_15, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &HaveReadModuleSrc_47);
    if (((MR_tag((MR_Word) HaveReadModuleSrc_47)) == (MR_Integer) 1))
    {
      MR_Word Var_56;
      MR_Word Var_57;

      SourceFileName_48 = ((MR_String) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_47, (MR_Integer) 0))));
      ReadModuleErrors_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_47, (MR_Integer) 1))));
      ...
      Var_57 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_component_0));
      {
        ...
        MR_hl_field(MR_mktag(0), ParseTreeSrc_50, 0) = ((MR_Box) (ModuleName_14));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_50, 1) = ((MR_Box) (Var_56));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_50, 2) = ((MR_Box) (Var_57));
      }
    }
    else
    {
      SourceFileName_48 = ((MR_String) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_47, (MR_Integer) 0))));
      ParseTreeSrc_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_47, (MR_Integer) 2))));
      ReadModuleErrors_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_47, (MR_Integer) 3))));
    }
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_6_p_0(Globals_12, SourceFileName_48, ParseTreeSrc_50, ReadModuleErrors_51, &Specs_46, &BurdenedModuleList_21);
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Specs_46, STATE_VARIABLE_Specs_0_26);
