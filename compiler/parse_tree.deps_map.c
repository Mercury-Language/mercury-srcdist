...
{
  {
    ...
    MR_Word parse_tree__deps_map__V_47_47 = (MR_Word) &parse_tree__deps_map_scalar_common_3[0];
    ...
    if (parse_tree__deps_map__succeeded)
      {
        {
          parse_tree__deps_map__V_50_50 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
        }
        ...
        {
          mercury__set__intersect_3_p_0(parse_tree__deps_map__TypeCtorInfo_68_68, parse_tree__deps_map__Errors_16, parse_tree__deps_map__V_50_50, &parse_tree__deps_map__FatalErrors_20);
        }
        {
    ...
    if (parse_tree__deps_map__succeeded)
      {
        ...
        {
          parse_tree__read_modules__read_module_int_14_p_0(parse_tree__deps_map__Globals_7, (MR_String) "Getting dependencies for module interface", (MR_Integer) 0, parse_tree__deps_map__Search_9, parse_tree__deps_map__ModuleName_8, (MR_Integer) 3, &parse_tree__deps_map__FileName_21, parse_tree__deps_map__V_47_47, &parse_tree__deps_map__V_22_22, &parse_tree__deps_map__ParseTreeInt_23, &parse_tree__deps_map___IntSpecs_24, &parse_tree__deps_map___Errors_25);
        }
        ...
        {
          parse_tree__deps_map__V_59_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_59_59, 0) = ((MR_Box) (parse_tree__deps_map__ModuleName_8));
          MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_59_59, 1) = ((MR_Box) (parse_tree__deps_map__ModuleContext_28));
          MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_59_59, 2) = ((MR_Box) (parse_tree__deps_map__RawItemBlocks_36));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__deps_map__RawCompUnits_37, 0) = ((MR_Box) (parse_tree__deps_map__V_59_59));
    ...
    {
      parse_tree__deps_map__RawCompUnitModuleNames_41 = mercury__list__map_2_f_0(parse_tree__deps_map__TypeCtorInfo_70_70, parse_tree__deps_map__TypeCtorInfo_71_71, (MR_Word) &parse_tree__deps_map_scalar_common_1[2], parse_tree__deps_map__RawCompUnits_37);
    }
    {
    ...
    {
      parse_tree__deps_map__V_65_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 0) = ((MR_Box) (&parse_tree__deps_map_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 1) = ((MR_Box) (parse_tree__deps_map__read_dependencies_6_p_0_2));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 3) = ((MR_Box) (parse_tree__deps_map__Globals_7));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 4) = ((MR_Box) (parse_tree__deps_map__FileName_21));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 5) = ((MR_Box) (parse_tree__deps_map__ModuleName_8));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 6) = ((MR_Box) (parse_tree__deps_map__RawCompUnitModuleNamesSet_42));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 7) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__V_65_65, 8) = ((MR_Box) (parse_tree__deps_map__Errors_16));
    }
    {
      mercury__list__map_3_p_0(parse_tree__deps_map__TypeCtorInfo_70_70, (MR_Word) &parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_module_and_imports_0, parse_tree__deps_map__V_65_65, parse_tree__deps_map__RawCompUnits_37, parse_tree__deps_map__ModuleAndImportsList_10);
    }
  }
}
