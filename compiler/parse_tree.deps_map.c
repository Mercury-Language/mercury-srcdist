    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
        ...
        parse_tree__module_imports____Compare____module_imports_and_baggage_0_0(HeadVar__1_1, ArgX2_7, ArgY2_8);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        succeeded = parse_tree__module_imports____Unify____module_imports_and_baggage_0_0(ArgX2_5, ArgY2_6);
    }
    return succeeded;
  }
}
...
{
  {
    ...
    parse_tree__module_imports__module_and_imports_get_module_name_2_p_0(ModuleAndImports_6, &ModuleName_7);
    {
      ...
      MR_hl_field(MR_mktag(0), Deps_8, 1) = ((MR_Box) (ModuleImportsAndBaggage_4));
    }
...
{
  {
    MR_Word Deps0_21;
    MR_Word Done0_22;
    MR_Word ModuleImportsAndBaggage_23;
    ...
    ModuleImportsAndBaggage_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deps0_21, (MR_Integer) 1))));
    switch (Done0_22) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Deps_24, 1) = ((MR_Box) (ModuleImportsAndBaggage_23));
          }
          ...
          ModuleAndImports_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleImportsAndBaggage_23, (MR_Integer) 1))));
          parse_tree__module_imports__module_and_imports_get_parse_tree_module_src_2_p_0(ModuleAndImports_25, &ParseTreeModuleSrc_26);
...
{
  {
    ...
    else
    {
      ...
      parse_tree__module_imports__parse_tree_src_to_module_imports_and_baggage_list_7_p_0(Globals_12, SourceFileName_52, ParseTreeSrc_54, SrcReadModuleErrors_56, SrcSpecs_55, &Specs_50, &ModuleImportsList_21);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      ModuleImportsAndBaggage_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 1))));
      ...
      ModuleBaggage_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModuleImportsAndBaggage_10, (MR_Integer) 0))));
