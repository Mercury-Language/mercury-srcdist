  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  else
  {
    ...
    MR_Word MaybeTimestamp_50;
    MR_Word ParseTreeSrc_51;
    MR_Word ReadModuleErrors_52;
    ...
    if (((MR_tag((MR_Word) HaveReadModuleSrc_48)) == (MR_Integer) 1))
    {
      MR_Word Var_57;
      MR_Word Var_58;

      SourceFileName_49 = ((MR_String) ((MR_hl_field(1, HaveReadModuleSrc_48, (MR_Integer) 0))));
      ReadModuleErrors_52 = ((MR_Word) ((MR_hl_field(1, HaveReadModuleSrc_48, (MR_Integer) 1))));
      MaybeTimestamp_50 = (MR_Word) ((MR_Unsigned) 0U);
      Var_57 = mercury__term_context__dummy_context_0_f_0();
      Var_58 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_component_0));
      {
        ParseTreeSrc_51 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ParseTreeSrc_51, 0) = ((MR_Box) (ModuleName_16));
        MR_hl_field(0, ParseTreeSrc_51, 1) = ((MR_Box) (Var_57));
        MR_hl_field(0, ParseTreeSrc_51, 2) = ((MR_Box) (Var_58));
      }
    ...
    else
    {
      ...
      MaybeTimestamp_50 = ((MR_Word) ((MR_hl_field(0, HaveReadModuleSrc_48, (MR_Integer) 1))));
      ParseTreeSrc_51 = ((MR_Word) ((MR_hl_field(0, HaveReadModuleSrc_48, (MR_Integer) 2))));
      ReadModuleErrors_52 = ((MR_Word) ((MR_hl_field(0, HaveReadModuleSrc_48, (MR_Integer) 3))));
      MaybeDummy_23 = (MR_Integer) 0;
    }
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_7_p_0(Globals_14, SourceFileName_49, ReadModuleErrors_52, MaybeTimestamp_50, ParseTreeSrc_51, &Specs_47, &BurdenedModules_24);
