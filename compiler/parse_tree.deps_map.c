    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
        ...
        parse_tree__module_imports____Compare____burdened_aug_comp_unit_0_0(HeadVar__1_1, ArgX2_7, ArgY2_8);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        succeeded = parse_tree__module_imports____Unify____burdened_aug_comp_unit_0_0(ArgX2_5, ArgY2_6);
    }
    return succeeded;
  }
}
...
parse_tree__deps_map__insert_into_deps_map_3_p_0(
  ...
  MR_Word STATE_VARIABLE_DepsMap_0_10,
  MR_Word * STATE_VARIABLE_DepsMap_11)
{
  {
    ...
    {
      Deps_9 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Deps_9, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Deps_9, 1) = ((MR_Box) (BurdenedAugCompUnit_4));
    }
    mercury__map__set_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), ((MR_Box) (ModuleName_8)), ((MR_Box) (Deps_9)), STATE_VARIABLE_DepsMap_0_10, STATE_VARIABLE_DepsMap_11);
  }
}
...
{
  {
    MR_Word Deps0_21;
    MR_Word Done0_22;
    MR_Word BurdenedAugCompUnit_23;
    MR_Word STATE_VARIABLE_DepsMap_42_42;

    parse_tree__deps_map__lookup_or_find_dependencies_11_p_0(Globals_13, Search_14, Module_15, ExpectationContexts_16, &Deps0_21, STATE_VARIABLE_DepsMap_0_36, &STATE_VARIABLE_DepsMap_42_42, STATE_VARIABLE_Specs_0_38, STATE_VARIABLE_Specs_39);
    Done0_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Deps0_21, (MR_Integer) 0))) & (MR_Integer) 1);
    BurdenedAugCompUnit_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deps0_21, (MR_Integer) 1))));
    switch (Done0_22) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Deps_24, 1) = ((MR_Box) (BurdenedAugCompUnit_23));
          }
          mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), ((MR_Box) (Module_15)), ((MR_Box) (Deps_24)), STATE_VARIABLE_DepsMap_42_42, STATE_VARIABLE_DepsMap_37);
          AugCompUnit_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_23, (MR_Integer) 1))));
          ParseTreeModuleSrc_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_25, (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv1_STATE_VARIABLE_DepsMap_11;

    parse_tree__deps_map__insert_into_deps_map_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_DepsMap_11);
    *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_DepsMap_11));
  }
}
...
{
  {
    ...
    else
    {
      ...
      parse_tree__read_modules__read_module_src_14_p_0(Globals_12, (MR_String) "Getting dependencies for module", (MR_Integer) 0, Search_13, ModuleName_14, ExpectationContexts_15, &SourceFileName_52, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &Var_53, &ParseTreeSrc_54, &SrcSpecs_55, &SrcReadModuleErrors_56);
      parse_tree__module_imports__parse_tree_src_to_burdened_aug_comp_unit_list_7_p_0(Globals_12, SourceFileName_52, ParseTreeSrc_54, SrcReadModuleErrors_56, SrcSpecs_55, &Specs_50, &ModuleImportsList_21);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word ParentImportsAndBaggage_12;
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), DepsMap_5, ((MR_Box) (ModuleName_4)), &conv1_Var_17);
      Var_17 = ((MR_Word) (conv1_Var_17));
      BurdenedAugCompUnit_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 1))));
      mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), DepsMap_5, ((MR_Box) (Parent_8)), &conv2_Var_18);
      Var_18 = ((MR_Word) (conv2_Var_18));
      ParentImportsAndBaggage_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_18, (MR_Integer) 1))));
      ModuleBaggage_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_10, (MR_Integer) 0))));
      ParentBaggage_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParentImportsAndBaggage_12, (MR_Integer) 0))));
