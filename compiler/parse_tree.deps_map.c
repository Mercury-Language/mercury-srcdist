  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
    ...
    MR_Word Specs_44;
    MR_Word HaveReadModuleSrc_45;
    MR_String SourceFileName_46;
    MR_Word ParseTreeSrc_48;
    MR_Word ReadModuleErrors_49;
    MR_Word Var_50;

    {
      Var_50 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Var_50, 0) = ((MR_Box) (ModuleName_14));
    }
    parse_tree__read_modules__read_module_src_10_p_0(Globals_12, Var_50, (MR_Integer) 0, Search_13, ModuleName_14, ExpectationContexts_15, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &HaveReadModuleSrc_45);
    if (((MR_tag((MR_Word) HaveReadModuleSrc_45)) == (MR_Integer) 1))
    {
      MR_Word Var_54;
      MR_Word Var_55;

      SourceFileName_46 = ((MR_String) ((MR_hl_field(1, HaveReadModuleSrc_45, (MR_Integer) 0))));
      ReadModuleErrors_49 = ((MR_Word) ((MR_hl_field(1, HaveReadModuleSrc_45, (MR_Integer) 1))));
      ...
      {
        ParseTreeSrc_48 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ParseTreeSrc_48, 0) = ((MR_Box) (ModuleName_14));
        MR_hl_field(0, ParseTreeSrc_48, 1) = ((MR_Box) (Var_54));
        MR_hl_field(0, ParseTreeSrc_48, 2) = ((MR_Box) (Var_55));
      }
    }
    else
    {
      SourceFileName_46 = ((MR_String) ((MR_hl_field(0, HaveReadModuleSrc_45, (MR_Integer) 0))));
      ParseTreeSrc_48 = ((MR_Word) ((MR_hl_field(0, HaveReadModuleSrc_45, (MR_Integer) 2))));
      ReadModuleErrors_49 = ((MR_Word) ((MR_hl_field(0, HaveReadModuleSrc_45, (MR_Integer) 3))));
    }
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_6_p_0(Globals_12, SourceFileName_46, ParseTreeSrc_48, ReadModuleErrors_49, &Specs_44, &BurdenedModuleList_21);
