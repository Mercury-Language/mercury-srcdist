  ...
  MR_Word * STATE_VARIABLE_Modules_12)
{
  if (((MR_tag((MR_Word) MaybeImplicit_6)) == (MR_Integer) 0))
  {
    ...
    switch (MR_tag((MR_Word) SectionImportUse_8)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Context_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SectionImportUse_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Context_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SectionImportUse_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Context_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word STATE_VARIABLE_Modules_13_26;

              parse_tree__deps_map__add_module_name_and_context_4_p_0(IntContext_24, ModuleName_5, STATE_VARIABLE_Modules_0_11, &STATE_VARIABLE_Modules_13_26);
              parse_tree__deps_map__add_module_name_and_context_4_p_0(ImpContext_25, ModuleName_5, STATE_VARIABLE_Modules_13_26, STATE_VARIABLE_Modules_12);
            }
            break;
        }
        break;
  ...
  else
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) SectionImportUse_17)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Context_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SectionImportUse_17, (MR_Integer) 0))));

            parse_tree__deps_map__add_module_name_and_context_4_p_0(Context_44, ModuleName_5, STATE_VARIABLE_Modules_0_11, STATE_VARIABLE_Modules_12);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word Context_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SectionImportUse_17, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word Context_37 = ((MR_Word) ((MR_hl_field(MR_mktag(2), SectionImportUse_17, (MR_Integer) 0))));

            parse_tree__deps_map__add_module_name_and_context_4_p_0(Context_37, ModuleName_5, STATE_VARIABLE_Modules_0_11, STATE_VARIABLE_Modules_12);
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word Context_43 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 1))));
            ...
            case (MR_Integer) 1:
              {
                MR_Word IntContext_38 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 1))));
                MR_Word ImpContext_39 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 2))));
                MR_Word STATE_VARIABLE_Modules_13_40;

                parse_tree__deps_map__add_module_name_and_context_4_p_0(IntContext_38, ModuleName_5, STATE_VARIABLE_Modules_0_11, &STATE_VARIABLE_Modules_13_40);
                parse_tree__deps_map__add_module_name_and_context_4_p_0(ImpContext_39, ModuleName_5, STATE_VARIABLE_Modules_13_40, STATE_VARIABLE_Modules_12);
              }
              break;
          }
          break;
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  else
  {
    ...
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_7_p_0(Globals_12, SourceFileName_52, ParseTreeSrc_54, SrcReadModuleErrors_56, SrcSpecs_55, &Specs_50, &BurdenedModuleList_21);
