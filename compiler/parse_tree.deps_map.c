...
MR_decl_static(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__154__1_1_0)
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__154__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(parse_tree__deps_map_module14)
	MR_init_entry1(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__154__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__154__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__generate_deps_map_step__154__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__154__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
