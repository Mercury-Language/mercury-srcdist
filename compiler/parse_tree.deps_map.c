  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word next_value_of_STATE_VARIABLE_Modules_0_14 = STATE_VARIABLE_Modules_20_20;
          MR_Word next_value_of_STATE_VARIABLE_DepsMap_0_15 = STATE_VARIABLE_DepsMap_21_21;
