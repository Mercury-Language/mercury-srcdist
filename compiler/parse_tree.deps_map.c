  ...
  MR_Word * STATE_VARIABLE_Specs_32)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) HaveReadModuleSrc_50)) == (MR_Integer) 0))
    {
      ...
      *STATE_VARIABLE_Specs_32 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Specs_49, STATE_VARIABLE_Specs_0_31);
    }
    else
    {
      ...
      *NewBurdenedModules_22 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      if (succeeded)
      {
        ...
        *STATE_VARIABLE_Specs_32 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Specs_60, STATE_VARIABLE_Specs_0_31);
      }
      else
        *STATE_VARIABLE_Specs_32 = STATE_VARIABLE_Specs_0_31;
    }
