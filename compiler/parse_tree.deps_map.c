...
#line 27 "parse_tree.deps_map.c"
#line 542 "../library/io.int"
#include "string.mh"

#line 31 "parse_tree.deps_map.c"
#line 56 "../library/dir.int"
#include "dir.mh"

#line 35 "parse_tree.deps_map.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 39 "parse_tree.deps_map.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 43 "parse_tree.deps_map.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 47 "parse_tree.deps_map.c"
#line 33 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 51 "parse_tree.deps_map.c"
#line 52 "parse_tree.deps_map.c"
#include "parse_tree.deps_map.mh"

#line 55 "parse_tree.deps_map.c"
#line 56 "parse_tree.deps_map.c"
#ifndef PARSE_TREE__DEPS_MAP_DECL_GUARD
#define PARSE_TREE__DEPS_MAP_DECL_GUARD

#line 60 "parse_tree.deps_map.c"
#line 61 "parse_tree.deps_map.c"

#endif
#line 64 "parse_tree.deps_map.c"
...
MR_decl_label1(parse_tree__deps_map__generate_deps_map_6_0, 2)
MR_decl_label4(parse_tree__deps_map__generate_deps_map_loop_6_0, 13,3,5,2)
MR_decl_label7(parse_tree__deps_map__generate_deps_map_step_8_0, 2,4,6,8,14,15,16)
MR_decl_label1(parse_tree__deps_map__insert_into_deps_map_3_0, 2)
MR_decl_label8(parse_tree__deps_map__lookup_dependencies_8_0, 3,2,5,6,10,7,14,15)
MR_decl_label5(parse_tree__deps_map__lookup_dependencies_8_0, 17,18,21,24,25)
...
MR_decl_static(parse_tree__deps_map__lookup_dependencies_8_0)
MR_decl_static(parse_tree__deps_map__generate_deps_map_step_8_0)
MR_decl_static(parse_tree__deps_map__generate_deps_map_loop_6_0)
MR_def_extern_entry(parse_tree__deps_map__generate_deps_map_6_0)
...
MR_decl_static(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__153__1_1_0)
...
mercury_data__closure_layout__parse_tree__deps_map__lookup_dependencies_8_0_1;
...
{
{
(MR_Word *) &mercury_data__closure_layout__parse_tree__deps_map__lookup_dependencies_8_0_1,
...
static const MR_UserClosureId
mercury_data__closure_layout__parse_tree__deps_map__lookup_dependencies_8_0_2;
static const struct mercury_type_3 mercury_common_3[1] =
{
{
{
(MR_Word *) &mercury_data__closure_layout__parse_tree__deps_map__lookup_dependencies_8_0_2,
(MR_Word *) (MR_Integer) 0
},
3,
{
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__153__1_1_0),
0
},
};

static const MR_UserClosureId
mercury_data__closure_layout__parse_tree__deps_map__generate_deps_map_step_8_0_1;
...
{
{
(MR_Word *) &mercury_data__closure_layout__parse_tree__deps_map__generate_deps_map_step_8_0_1,
(MR_Word *) (MR_Integer) 0,
2,
...
const MR_PseudoTypeInfo mercury_data_parse_tree__deps_map__field_types_deps_0_0[] = {
	...
	(MR_PseudoTypeInfo) &mercury_data_parse_tree__module_imports__type_ctor_info_module_imports_0
};
...
MR_decl_entry(parse_tree__read_modules__read_module_ignore_errors_11_0);
...
MR_BEGIN_MODULE(parse_tree__deps_map_module1)
	MR_init_entry1(parse_tree__deps_map__lookup_dependencies_8_0);
	MR_init_label8(parse_tree__deps_map__lookup_dependencies_8_0,3,2,5,6,10,7,14,15)
	MR_init_label5(parse_tree__deps_map__lookup_dependencies_8_0,17,18,21,24,25)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__deps_map__lookup_dependencies_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	...
	MR_np_call_localret_ent(map__search_3_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i3);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__deps_map__lookup_dependencies_8_0_i2);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	...
	MR_r4 = MR_sv(2);
	MR_r5 = (MR_Integer) 1;
	MR_np_call_localret_ent(parse_tree__read_modules__read_module_ignore_errors_11_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i5);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_sv(6) = MR_r3;
	MR_np_call_localret_ent(libs__globals__io_get_globals_3_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i6);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(parse_tree__deps_map__lookup_dependencies_8_0_i7);
	}
	...
	MR_r3 = (MR_Word) MR_string_const("Getting dependencies for module interface", 41);
	MR_r4 = MR_tempr1;
	MR_r5 = (MR_Integer) 1;
	}
	MR_np_call_localret_ent(parse_tree__read_modules__read_module_ignore_errors_11_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i10);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__prim_data, sym_name);
	MR_GOTO_LAB(parse_tree__deps_map__lookup_dependencies_8_0_i17);
	}
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(parse_tree__modules__split_into_submodules_5_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i14);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(2);
	...
	MR_np_call_localret_ent(parse_tree__error_util__write_error_specs_8_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i15);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(6);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__prim_data, sym_name);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r3;
	MR_sv(7) = MR_r2;
	MR_np_call_localret_ent(assoc_list__keys_2_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i18);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(list__map_3_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i21);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__foldl_4_1,
		parse_tree__deps_map__lookup_dependencies_8_0_i24);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		parse_tree__deps_map__lookup_dependencies_8_0_i25);
MR_def_label(parse_tree__deps_map__lookup_dependencies_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__deps_map_module2)
	MR_init_entry1(parse_tree__deps_map__generate_deps_map_step_8_0);
	MR_init_label7(parse_tree__deps_map__generate_deps_map_step_8_0,2,4,6,8,14,15,16)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__deps_map__generate_deps_map_step_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	...
	MR_r2 = MR_r3;
	MR_r3 = MR_r4;
	MR_np_call_localret_ent(parse_tree__deps_map__lookup_dependencies_8_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i2);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(parse_tree__deps_map__generate_deps_map_step_8_0_i4);
	}
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i6);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	...
	MR_r4 = MR_ctfield(0, MR_sv(1), 12);
	MR_np_call_localret_ent(fn__list__map_2_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i8);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tempr4 = MR_sv(1);
	MR_tfield(1, MR_tempr2, 0) = MR_ctfield(0, MR_tempr4, 8);
	...
	MR_np_call_localret_ent(list__condense_2_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i14);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(set__list_to_set_2_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i15);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(set__union_3_0,
		parse_tree__deps_map__generate_deps_map_step_8_0_i16);
MR_def_label(parse_tree__deps_map__generate_deps_map_step_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__deps_map_module3)
	MR_init_entry1(parse_tree__deps_map__generate_deps_map_loop_6_0);
	MR_init_label4(parse_tree__deps_map__generate_deps_map_loop_6_0,13,3,5,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__deps_map__generate_deps_map_loop_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(parse_tree__deps_map__generate_deps_map_loop_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	{
	...
	MR_np_call_localret_ent(set__remove_least_3_0,
		parse_tree__deps_map__generate_deps_map_loop_6_0_i3);
MR_def_label(parse_tree__deps_map__generate_deps_map_loop_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__deps_map__generate_deps_map_loop_6_0_i2);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(2);
	MR_np_call_localret_ent(parse_tree__deps_map__generate_deps_map_step_8_0,
		parse_tree__deps_map__generate_deps_map_loop_6_0_i5);
MR_def_label(parse_tree__deps_map__generate_deps_map_loop_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
	...
	MR_GOTO_LAB(parse_tree__deps_map__generate_deps_map_loop_6_0_i13);
	}
MR_def_label(parse_tree__deps_map__generate_deps_map_loop_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__deps_map_module4)
	MR_init_entry1(parse_tree__deps_map__generate_deps_map_6_0);
	MR_init_label1(parse_tree__deps_map__generate_deps_map_6_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__parse_tree__deps_map__generate_deps_map_6_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		parse_tree__deps_map__generate_deps_map_6_0_i2);
MR_def_label(parse_tree__deps_map__generate_deps_map_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(parse_tree__deps_map__generate_deps_map_loop_6_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_decl_entry(parse_tree__module_imports__module_imports_get_module_name_2_0);
...
MR_define_entry(mercury__parse_tree__deps_map__insert_into_deps_map_3_0);
	...
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_np_call_localret_ent(parse_tree__module_imports__module_imports_get_module_name_2_0,
...
MR_decl_entry(__Unify___parse_tree__module_imports__module_imports_0_0);
...
MR_define_entry(mercury____Unify___parse_tree__deps_map__deps_0_0);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___parse_tree__module_imports__module_imports_0_0);
	}
...
MR_decl_entry(__Compare___parse_tree__module_imports__module_imports_0_0);
...
MR_def_label(__Compare___parse_tree__deps_map__deps_0_0,5)
	...
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___parse_tree__module_imports__module_imports_0_0);
...
MR_BEGIN_MODULE(parse_tree__deps_map_module14)
	MR_init_entry1(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__153__1_1_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__parse_tree__deps_map__IntroducedFrom__func__generate_deps_map_step__153__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
