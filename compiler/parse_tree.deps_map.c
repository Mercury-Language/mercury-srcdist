...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_item__int_imp_items_to_item_blocks_10_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_section_0), ModuleName_9, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_Integer) 1)), IntIncl_32, ImpIncls_33, IntAvails_34, ImpAvails_35, IntItems_36, ImpItems_37, &RawItemBlocks_38);
      {
