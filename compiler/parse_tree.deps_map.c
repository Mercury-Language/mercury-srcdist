          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word STATE_VARIABLE_Modules_14_29;

              parse_tree__deps_map__add_module_name_and_context_4_p_0(IntContext_26, ModuleName_5, STATE_VARIABLE_Modules_0_11, &STATE_VARIABLE_Modules_14_29);
              parse_tree__deps_map__add_module_name_and_context_4_p_0(ImpContext_27, ModuleName_5, STATE_VARIABLE_Modules_14_29, STATE_VARIABLE_Modules_12);
            }
            break;
        }
        break;
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word STATE_VARIABLE_Modules_14_43;

                parse_tree__deps_map__add_module_name_and_context_4_p_0(IntContext_40, ModuleName_5, STATE_VARIABLE_Modules_0_11, &STATE_VARIABLE_Modules_14_43);
                parse_tree__deps_map__add_module_name_and_context_4_p_0(ImpContext_41, ModuleName_5, STATE_VARIABLE_Modules_14_43, STATE_VARIABLE_Modules_12);
              }
              break;
          }
          break;
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_62, 0) = ((MR_Box) (ModuleName_14));
    }
    parse_tree__read_modules__read_module_src_10_p_0(Globals_12, Var_62, (MR_Integer) 0, Search_13, ModuleName_14, ExpectationContexts_15, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &HaveReadModuleSrc_57);
    if (((MR_tag((MR_Word) HaveReadModuleSrc_57)) == (MR_Integer) 1))
    {
      MR_Word Var_67;
      MR_Word Var_68;

      SourceFileName_58 = ((MR_String) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_57, (MR_Integer) 0))));
      ReadModuleErrors_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_57, (MR_Integer) 1))));
      Var_67 = mercury__term__dummy_context_init_0_f_0();
      Var_68 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_component_0));
      {
        ParseTreeSrc_60 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ParseTreeSrc_60, 0) = ((MR_Box) (ModuleName_14));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_60, 1) = ((MR_Box) (Var_67));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_60, 2) = ((MR_Box) (Var_68));
      }
    }
    else
    {
      SourceFileName_58 = ((MR_String) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_57, (MR_Integer) 0))));
      ParseTreeSrc_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_57, (MR_Integer) 2))));
      ReadModuleErrors_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_57, (MR_Integer) 3))));
    }
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_6_p_0(Globals_12, SourceFileName_58, ParseTreeSrc_60, ReadModuleErrors_61, &Specs_55, &BurdenedModuleList_21);
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Specs_55, STATE_VARIABLE_Specs_0_26);
