  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  else
  {
    ...
    MR_Word SrcReadModuleErrors_45;
    MR_Word Var_46;
    MR_Word Var_43;
    ...
    {
      Var_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_46, 0) = ((MR_Box) (ModuleName_14));
    }
    parse_tree__read_modules__read_module_src_13_p_0(Globals_12, Var_46, (MR_Integer) 0, Search_13, ModuleName_14, ExpectationContexts_15, &SourceFileName_42, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &Var_43, &ParseTreeSrc_44, &SrcReadModuleErrors_45);
    parse_tree__module_baggage__parse_tree_src_to_burdened_module_list_6_p_0(Globals_12, SourceFileName_42, ParseTreeSrc_44, SrcReadModuleErrors_45, &Specs_41, &BurdenedModuleList_21);
