  ...
  MR_Word * STATE_VARIABLE_Modules_12)
{
  if (((MR_tag((MR_Word) MaybeImplicit_6)) == (MR_Integer) 0))
  {
    ...
    switch (MR_tag((MR_Word) SectionImportUse_8)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Context_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SectionImportUse_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Context_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SectionImportUse_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Context_18 = ((MR_Word) ((MR_hl_field(MR_mktag(2), SectionImportUse_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Context_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              MR_Word IntContext_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 1))));
              MR_Word ImpContext_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_8, (MR_Integer) 2))));
  ...
  else
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) SectionImportUse_17)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Context_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SectionImportUse_17, (MR_Integer) 0))));
        ...
        case (MR_Integer) 1:
          {
            MR_Word Context_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SectionImportUse_17, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word Context_25 = ((MR_Word) ((MR_hl_field(MR_mktag(2), SectionImportUse_17, (MR_Integer) 0))));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word Context_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 1))));
            ...
            case (MR_Integer) 1:
              {
                MR_Word IntContext_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 1))));
                MR_Word ImpContext_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SectionImportUse_17, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_50, 0) = ((MR_Box) (ModuleName_14));
    }
    ...
    if (((MR_tag((MR_Word) HaveReadModuleSrc_45)) == (MR_Integer) 1))
    {
      ...
      SourceFileName_46 = ((MR_String) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_45, (MR_Integer) 0))));
      ReadModuleErrors_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HaveReadModuleSrc_45, (MR_Integer) 1))));
      ...
      Var_55 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_component_0));
      {
        ...
        MR_hl_field(MR_mktag(0), ParseTreeSrc_48, 0) = ((MR_Box) (ModuleName_14));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_48, 1) = ((MR_Box) (Var_54));
        MR_hl_field(MR_mktag(0), ParseTreeSrc_48, 2) = ((MR_Box) (Var_55));
      }
    }
    else
    {
      SourceFileName_46 = ((MR_String) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_45, (MR_Integer) 0))));
      ParseTreeSrc_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_45, (MR_Integer) 2))));
      ReadModuleErrors_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModuleSrc_45, (MR_Integer) 3))));
    }
