          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word STATE_VARIABLE_Modules_13_21;

              parse_tree__deps_map__add_module_name_and_context_4_p_0(IntContext_19, ModuleName_5, STATE_VARIABLE_Modules_0_11, &STATE_VARIABLE_Modules_13_21);
              parse_tree__deps_map__add_module_name_and_context_4_p_0(ImpContext_20, ModuleName_5, STATE_VARIABLE_Modules_13_21, STATE_VARIABLE_Modules_12);
            }
            break;
        }
        break;
