...
static /* final */ const MR_Box parse_tree__deps_map_scalar_common_2[3][3] = {
  ...
  /* row   2 */
  {
    ...
    ((MR_Box) (parse_tree__deps_map__lookup_or_find_dependency_info_for_module_12_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_43)
{
  ...
  parse_tree__deps_map__lookup_or_find_dependency_info_for_module_12_p_0(ProgressStream_15, Globals_16, Search_17, Module_18, ExpectationContexts_19, &MaybeDeps0_25, STATE_VARIABLE_DepsMap_0_40, &STATE_VARIABLE_DepsMap_46_46, STATE_VARIABLE_Specs_0_42, STATE_VARIABLE_Specs_43);
