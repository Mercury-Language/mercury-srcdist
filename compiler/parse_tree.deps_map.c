...
{
  {
    ...
    if (parse_tree__deps_map__succeeded)
      *parse_tree__deps_map__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word parse_tree__deps_map__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word parse_tree__deps_map__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word parse_tree__deps_map__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word parse_tree__deps_map__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word parse_tree__deps_map__Var_8;
        MR_Integer parse_tree__deps_map__Var_13 = (MR_Integer) parse_tree__deps_map__Var_4;
        MR_Integer parse_tree__deps_map__Var_14 = (MR_Integer) parse_tree__deps_map__Var_6;
        ...
        if (parse_tree__deps_map__succeeded)
          *parse_tree__deps_map__HeadVar__1_1 = parse_tree__deps_map__Var_8;
          ...
          {
            parse_tree__module_imports____Compare____module_and_imports_0_0(parse_tree__deps_map__HeadVar__1_1, parse_tree__deps_map__Var_5, parse_tree__deps_map__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (parse_tree__deps_map__succeeded)
      ...
      {
        MR_Word parse_tree__deps_map__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word parse_tree__deps_map__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word parse_tree__deps_map__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word parse_tree__deps_map__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__deps_map__HeadVar__2_2, (MR_Integer) 1)));

        parse_tree__deps_map__succeeded = (parse_tree__deps_map__Var_3 == parse_tree__deps_map__Var_5);
        if (parse_tree__deps_map__succeeded)
          {
            parse_tree__deps_map__succeeded = parse_tree__module_imports____Unify____module_and_imports_0_0(parse_tree__deps_map__Var_4, parse_tree__deps_map__Var_6);
          }
      }
    return parse_tree__deps_map__succeeded;
  }
...
{
  {
    ...
    MR_Word parse_tree__deps_map__Var_47 = (MR_Word) &parse_tree__deps_map_scalar_common_3[0];
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__deps_map__Var_65, 0) = ((MR_Box) (&parse_tree__deps_map_scalar_common_5[0]));
