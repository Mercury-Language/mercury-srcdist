...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__read_modules__read_module_int_14_p_0(Globals_10, (MR_String) "Getting dependencies for module interface", (MR_Integer) 0, Search_13, ModuleName_11, (MR_Integer) 3, &IntFileName_52, (MR_Word) (&parse_tree__deps_map_scalar_common_3[0]), &Var_53, &ParseTreeInt_54, &_IntSpecs_55, &_IntReadModuleErrors_56);
