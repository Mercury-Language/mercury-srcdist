...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Deps0_18, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 15)));
          packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 25)));
          ...
          packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 15)));
          packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 25)));
          ...
          packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 15)));
          packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 25)));
          ...
          packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 15)));
          packed_args_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_20, (MR_Integer) 25)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ParseTreeInt_25, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_15, (MR_Integer) 0)));
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 0)));
      ...
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_10, (MR_Integer) 15)));
      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_10, (MR_Integer) 25)));
      ParentFileName_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), ParentImports_12, (MR_Integer) 0))));
      packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ParentImports_12, (MR_Integer) 15)));
      packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ParentImports_12, (MR_Integer) 25)));
