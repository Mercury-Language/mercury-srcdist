  ...
  MR_Word * DiffPieces_12)
{
  ...
  {
    MR_Word AE_41 = ((MR_Word) ((MR_hl_field(1, ActualExpectedList_9, (MR_Integer) 0))));
    MR_Word AEs_42 = ((MR_Word) ((MR_hl_field(1, ActualExpectedList_9, (MR_Integer) 1))));
    MR_Word ActualPieces_45 = ((MR_Word) ((MR_hl_field(0, AE_41, (MR_Integer) 0))));
    MR_Word ExpectedPieces_47 = ((MR_Word) ((MR_hl_field(0, AE_41, (MR_Integer) 2))));
    MR_Word Var_51;
    MR_Word Var_52;
  ...
  {
    MR_Word SingleActualPieces_53 = ((MR_Word) ((MR_hl_field(1, MaybeSingleActual_15, (MR_Integer) 0))));
  ...
  if ((MaybeSingleExpected_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      MR_Word ModuleInfo_78 = ((MR_Word) ((MR_hl_field(0, ClauseContext_7, (MR_Integer) 0))));
      MR_Word Var_79;
  ...
  {
    MR_Word SingleExpectedPieces_73 = ((MR_Word) ((MR_hl_field(1, MaybeSingleExpected_16, (MR_Integer) 0))));
