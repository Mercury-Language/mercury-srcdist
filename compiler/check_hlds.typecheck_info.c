...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 703, &AmbiguityWarnLimit_22);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 704, &AmbiguityErrorLimit_32);
    {
