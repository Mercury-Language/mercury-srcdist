...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck_info__Globals_20, (MR_Integer) 655, &check_hlds__typecheck_info__WarnLimit_21);
    }
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck_info__Globals_20, (MR_Integer) 656, &check_hlds__typecheck_info__ErrorLimit_22);
    }
    {
