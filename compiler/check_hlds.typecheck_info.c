  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  ...
  Var_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_8, (MR_Integer) 3))));
  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 0)));
  Var_38 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 1))));
  Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 2))));
  Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 3))));
  Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 4))));
  Var_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 6))) & (MR_Integer) 1);
  Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 7))));
  {
    Var_32 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_32, 0) = (MR_Box) (packed_word_2);
    MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (Var_38));
    MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) (Var_39));
    MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (Var_40));
    MR_hl_field(MR_mktag(0), Var_32, 4) = ((MR_Box) (Var_41));
    MR_hl_field(MR_mktag(0), Var_32, 5) = ((MR_Box) (NoSuffixIntegerMap_7));
    MR_hl_field(MR_mktag(0), Var_32, 6) = (MR_Box) ((MR_Unsigned) (Var_43));
    MR_hl_field(MR_mktag(0), Var_32, 7) = ((MR_Box) (Var_44));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
