  ...
  MR_Word * Info_18)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 705, &AmbiguityWarnLimit_24);
  NoSuffixIntegerMap_25 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[0]));
  libs__globals__lookup_accumulating_option_3_p_0(Globals_22, (MR_Integer) 89, &DebugTypesPredNames_26);
  if ((DebugTypesPredNames_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word DebugTypes_32;

    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 88, &DebugTypes_32);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 706, &AmbiguityErrorLimit_34);
  {
