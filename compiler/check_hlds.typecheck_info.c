...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 702, &AmbiguityWarnLimit_22);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 703, &AmbiguityErrorLimit_32);
    {
