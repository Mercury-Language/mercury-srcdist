...
static const MR_DuFunctorDesc check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_0;

static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__one_or_more__ti_one_or_more_1hlds__hlds_cons__type_ctor_info_hlds_ctor_field_defn_0;

static const MR_PseudoTypeInfo check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_maybe_in_field_access_func_0_1[4];

static const MR_DuArgLocn check_hlds__typecheck_info__check_hlds__typecheck_info__field_locns_maybe_in_field_access_func_0_1[4];

static const MR_DuFunctorDesc check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_1;

static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_0[1];

static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_1[1];

static const MR_DuPtagLayout check_hlds__typecheck_info__check_hlds__typecheck_info__du_ptag_ordered_maybe_in_field_access_func_0[2];

static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_name_ordered_maybe_in_field_access_func_0[2];

static const MR_Integer check_hlds__typecheck_info__check_hlds__typecheck_info__functor_number_map_maybe_in_field_access_func_0[2];
...
static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__list__ti_list_1hlds__pred_proc_id__type_ctor_info_pred_id_0;
...
static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__one_or_more__ti_one_or_more_1term_context__type_ctor_info_term_context_0;

static const MR_FA_TypeInfo_Struct2 check_hlds__typecheck_info__tree234__ti_tree234_2check_hlds__typecheck_info__type_ctor_info_overloaded_symbol_0one_or_more__ti_one_or_more_1term_context__type_ctor_info_term_context_0;

static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__set_ordlist__ti_set_ordlist_1hlds__hlds_markers__type_ctor_info_pred_marker_0;
...
static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0;

static const MR_FA_TypeInfo_Struct1 check_hlds__typecheck_info__maybe__ti_maybe_1parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static MR_bool MR_CALL 
check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static const MR_DuFunctorDesc check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_0 = {
  (MR_String) "not_in_field_access_func",
  INT16_C(0),
  UINT16_C(0),
...
static const MR_PseudoTypeInfo check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_maybe_in_field_access_func_0_1[4] = {
  ...
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__one_or_more__ti_one_or_more_1hlds__hlds_cons__type_ctor_info_hlds_ctor_field_defn_0)
};
...
static const MR_DuFunctorDesc check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_1 = {
  (MR_String) "in_field_access_func",
  INT16_C(4),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(1),
  (MR_Integer) -1,
  INT32_C(1),
  check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_maybe_in_field_access_func_0_1,
  NULL,
  check_hlds__typecheck_info__check_hlds__typecheck_info__field_locns_maybe_in_field_access_func_0_1,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
  UINT8_C(0)
};

static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_0[1] = { &check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_0 };

static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_1[1] = { &check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_1 };

static const MR_DuPtagLayout check_hlds__typecheck_info__check_hlds__typecheck_info__du_ptag_ordered_maybe_in_field_access_func_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    check_hlds__typecheck_info__check_hlds__typecheck_info__du_stag_ordered_maybe_in_field_access_func_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr check_hlds__typecheck_info__check_hlds__typecheck_info__du_name_ordered_maybe_in_field_access_func_0[2] = {
  &check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_1,
  &check_hlds__typecheck_info__check_hlds__typecheck_info__du_functor_desc_maybe_in_field_access_func_0_0
};
...
const MR_TypeCtorInfo_Struct check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_maybe_in_field_access_func_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0_10001)),
  ((MR_Box) (check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0_10001)),
  (MR_String) "check_hlds.typecheck_info",
  (MR_String) "maybe_in_field_access_func",
  { check_hlds__typecheck_info__check_hlds__typecheck_info__du_name_ordered_maybe_in_field_access_func_0 },
  { check_hlds__typecheck_info__check_hlds__typecheck_info__du_ptag_ordered_maybe_in_field_access_func_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  check_hlds__typecheck_info__check_hlds__typecheck_info__functor_number_map_maybe_in_field_access_func_0,
...
static const MR_PseudoTypeInfo check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_overloaded_symbol_0_0[2] = {
  ...
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__list__ti_list_1hlds__pred_proc_id__type_ctor_info_pred_id_0)
};
...
static const MR_FA_TypeInfo_Struct2 check_hlds__typecheck_info__tree234__ti_tree234_2check_hlds__typecheck_info__type_ctor_info_overloaded_symbol_0one_or_more__ti_one_or_more_1term_context__type_ctor_info_term_context_0 = {
  &mercury__tree234__tree234__type_ctor_info_tree234_2,
  {
    ...
    (MR_TypeInfo) (&check_hlds__typecheck_info__one_or_more__ti_one_or_more_1term_context__type_ctor_info_term_context_0)
  }
};
...
const MR_TypeCtorInfo_Struct check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_overloaded_symbol_map_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__tree234__ti_tree234_2check_hlds__typecheck_info__type_ctor_info_overloaded_symbol_0one_or_more__ti_one_or_more_1term_context__type_ctor_info_term_context_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
static const MR_PseudoTypeInfo check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_type_error_clause_context_0_0[6] = {
  ...
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__set_ordlist__ti_set_ordlist_1hlds__hlds_markers__type_ctor_info_pred_marker_0),
...
static const MR_PseudoTypeInfo check_hlds__typecheck_info__check_hlds__typecheck_info__field_types_typecheck_sub_info_0_0[9] = {
  ...
  (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_int_0),
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_maybe_in_field_access_func_0),
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  (MR_PseudoTypeInfo) (&check_hlds__typecheck_info__maybe__ti_maybe_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
...
static const MR_ConstString check_hlds__typecheck_info__check_hlds__typecheck_info__field_names_typecheck_sub_info_0_0[9] = {
  ...
  (MR_String) "tcsi_in_field_access_function",
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0(&SubResult4_15, ArgX4_13, ArgY4_14);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0(ArgX4_9, ArgY4_10);
          if (succeeded)
          {
            TypeInfo_23_23 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[7]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_23_23, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo_24_24 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[8]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_24_24, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo_25_25 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[9]);
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    {
      MR_Word ArgX1_21 = ((((MR_Unsigned) ((MR_hl_field(0, ArgX1_4, 0))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgY1_22 = ((((MR_Unsigned) ((MR_hl_field(0, ArgY1_5, 0))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgX2_24 = ((MR_Unsigned) ((MR_hl_field(0, ArgX1_4, 0))) & (MR_Integer) 1);
      MR_Word ArgY2_25 = ((MR_Unsigned) ((MR_hl_field(0, ArgY1_5, 0))) & (MR_Integer) 1);
      MR_Integer ArgX3_27 = ((MR_Integer) ((MR_hl_field(0, ArgX1_4, 1))));
      MR_Integer ArgY3_28 = ((MR_Integer) ((MR_hl_field(0, ArgY1_5, 1))));
      MR_Word ArgX4_30 = ((MR_Word) ((MR_hl_field(0, ArgX1_4, 2))));
      MR_Word ArgY4_31 = ((MR_Word) ((MR_hl_field(0, ArgY1_5, 2))));
      MR_Word ArgX5_33 = ((MR_Word) ((MR_hl_field(0, ArgX1_4, 3))));
      MR_Word ArgY5_34 = ((MR_Word) ((MR_hl_field(0, ArgY1_5, 3))));
      MR_Word ArgX6_36 = ((MR_Word) ((MR_hl_field(0, ArgX1_4, 4))));
      MR_Word ArgY6_37 = ((MR_Word) ((MR_hl_field(0, ArgY1_5, 4))));
      MR_Word ArgX7_39 = ((MR_Word) ((MR_hl_field(0, ArgX1_4, 5))));
      MR_Word ArgY7_40 = ((MR_Word) ((MR_hl_field(0, ArgY1_5, 5))));
      MR_Word ArgX8_42 = ((MR_Unsigned) ((MR_hl_field(0, ArgX1_4, 6))) & (MR_Integer) 1);
      MR_Word ArgY8_43 = ((MR_Unsigned) ((MR_hl_field(0, ArgY1_5, 6))) & (MR_Integer) 1);
      MR_Word ArgX9_45 = ((MR_Word) ((MR_hl_field(0, ArgX1_4, 7))));
      MR_Word ArgY9_46 = ((MR_Word) ((MR_hl_field(0, ArgY1_5, 7))));
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0(&SubResult4_32, ArgX4_30, ArgY4_31);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word ArgX1_14 = ((((MR_Unsigned) ((MR_hl_field(0, ArgX1_3, 0))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgY1_15 = ((((MR_Unsigned) ((MR_hl_field(0, ArgY1_4, 0))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgX2_16 = ((MR_Unsigned) ((MR_hl_field(0, ArgX1_3, 0))) & (MR_Integer) 1);
      MR_Word ArgY2_17 = ((MR_Unsigned) ((MR_hl_field(0, ArgY1_4, 0))) & (MR_Integer) 1);
      MR_Integer ArgX3_18 = ((MR_Integer) ((MR_hl_field(0, ArgX1_3, 1))));
      MR_Integer ArgY3_19 = ((MR_Integer) ((MR_hl_field(0, ArgY1_4, 1))));
      MR_Word ArgX4_20 = ((MR_Word) ((MR_hl_field(0, ArgX1_3, 2))));
      MR_Word ArgY4_21 = ((MR_Word) ((MR_hl_field(0, ArgY1_4, 2))));
      MR_Word ArgX5_22 = ((MR_Word) ((MR_hl_field(0, ArgX1_3, 3))));
      MR_Word ArgY5_23 = ((MR_Word) ((MR_hl_field(0, ArgY1_4, 3))));
      MR_Word ArgX6_24 = ((MR_Word) ((MR_hl_field(0, ArgX1_3, 4))));
      MR_Word ArgY6_25 = ((MR_Word) ((MR_hl_field(0, ArgY1_4, 4))));
      MR_Word ArgX7_26 = ((MR_Word) ((MR_hl_field(0, ArgX1_3, 5))));
      MR_Word ArgY7_27 = ((MR_Word) ((MR_hl_field(0, ArgY1_4, 5))));
      MR_Word ArgX8_28 = ((MR_Unsigned) ((MR_hl_field(0, ArgX1_3, 6))) & (MR_Integer) 1);
      MR_Word ArgY8_29 = ((MR_Unsigned) ((MR_hl_field(0, ArgY1_4, 6))) & (MR_Integer) 1);
      MR_Word ArgX9_30 = ((MR_Word) ((MR_hl_field(0, ArgX1_3, 7))));
      MR_Word ArgY9_31 = ((MR_Word) ((MR_hl_field(0, ArgY1_4, 7))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0(ArgX4_20, ArgY4_21);
            if (succeeded)
            {
              TypeInfo_23_34 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[7]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_23_34, ((MR_Box) (ArgX5_22)), ((MR_Box) (ArgY5_23)));
              if (succeeded)
              {
                TypeInfo_24_35 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[8]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_24_35, ((MR_Box) (ArgX6_24)), ((MR_Box) (ArgY6_25)));
                if (succeeded)
                {
                  TypeInfo_25_36 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[9]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_25_36, ((MR_Box) (ArgX7_26)), ((MR_Box) (ArgY7_27)));
                  if (succeeded)
                  {
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[5]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        succeeded = (SubResult3_12 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult3_12;
        else
          ...
          else
          {
            ...
            if (succeeded)
              *HeadVar__1_1 = SubResult5_18;
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[6]), HeadVar__1_1, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
          }
        }
      }
    }
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_19_19 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[5]);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_21_21 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[6]);
  ...
  MR_Word HeadVar__3_3)
{
    ...
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = SubResult1_11;
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[3]), HeadVar__1_1, ((MR_Box) (ArgX2_12)), ((MR_Box) (ArgY2_13)));
    }
    else
      *HeadVar__1_1 = (MR_Integer) 2;
  else
  ...
  else
  {
    ...
    parse_tree__prog_data____Compare____sym_name_pred_form_arity_0_0(&SubResult1_6, ArgX1_4, ArgY1_5);
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
      mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[3]);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_16_16 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[4]);
...
void MR_CALL 
check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__status____Compare____pred_status_0_0(&SubResult1_6, ArgX1_4, ArgY1_5);
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = SubResult3_12;
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
      }
    }
  }
}
...
MR_bool MR_CALL 
check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__status____Unify____pred_status_0_0(ArgX1_3, ArgY1_4);
      if (succeeded)
      {
        succeeded = (ArgX2_5 == ArgY2_6);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_17_17 = (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[2]);
  ...
  MR_Word * Errors_4)
{
  ...
  MR_Word Var_8 = ((MR_Word) ((MR_hl_field(0, Info_3, 0))));

  Errors0_5 = ((MR_Word) ((MR_hl_field(0, Var_8, 3))));
  MaybeOverloadError_6 = ((MR_Word) ((MR_hl_field(0, Var_8, 4))));
  if ((MaybeOverloadError_6 == (MR_Word) ((MR_Unsigned) 0U)))
    *Errors_4 = Errors0_5;
  else
  {
    MR_Word OverloadError_7 = ((MR_Word) ((MR_hl_field(1, MaybeOverloadError_6, 0))));
...
void MR_CALL 
check_hlds__typecheck_info__typecheck_info_add_errors_3_p_0(
  MR_Word NewErrors_4,
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  MR_Word Errors0_6;
  MR_Word Errors_7;
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 0))));
  MR_Word Var_23;
  MR_Word Var_24;
  MR_Word Var_25;
  MR_Word Var_26;
  ...
  Errors0_6 = ((MR_Word) ((MR_hl_field(0, Var_11, 3))));
  Errors_7 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), NewErrors_4, Errors0_6);
  Var_23 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 0))));
  Var_25 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 1))));
  Var_26 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 2))));
  Var_27 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 3))));
  packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_23, 0)));
  Var_30 = ((MR_Integer) ((MR_hl_field(0, Var_23, 1))));
  Var_31 = ((MR_Word) ((MR_hl_field(0, Var_23, 2))));
  Var_33 = ((MR_Word) ((MR_hl_field(0, Var_23, 4))));
  Var_34 = ((MR_Word) ((MR_hl_field(0, Var_23, 5))));
  Var_35 = ((MR_Unsigned) ((MR_hl_field(0, Var_23, 6))) & (MR_Integer) 1);
  Var_36 = ((MR_Word) ((MR_hl_field(0, Var_23, 7))));
  {
    Var_24 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_24, 0) = (MR_Box) (packed_word_0);
    MR_hl_field(0, Var_24, 1) = ((MR_Box) (Var_30));
    MR_hl_field(0, Var_24, 2) = ((MR_Box) (Var_31));
    MR_hl_field(0, Var_24, 3) = ((MR_Box) (Errors_7));
    MR_hl_field(0, Var_24, 4) = ((MR_Box) (Var_33));
    MR_hl_field(0, Var_24, 5) = ((MR_Box) (Var_34));
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  ...
  MR_Integer Var_13 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, 3))));
  MR_Integer Var_16 = ((MR_Integer) ((MR_hl_field(0, Var_10, 1))));
  MR_Word Var_17 = ((MR_Word) ((MR_hl_field(0, Var_10, 2))));
  MR_Word Var_18;
  MR_Word Var_19;
  MR_Word Var_20;
  MR_Word Var_21;
  MR_Word Var_23;
  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_10, 0)));

  Errors0_6 = ((MR_Word) ((MR_hl_field(0, Var_10, 3))));
  Var_18 = ((MR_Word) ((MR_hl_field(0, Var_10, 4))));
  Var_19 = ((MR_Word) ((MR_hl_field(0, Var_10, 5))));
  Var_20 = ((MR_Unsigned) ((MR_hl_field(0, Var_10, 6))) & (MR_Integer) 1);
  Var_21 = ((MR_Word) ((MR_hl_field(0, Var_10, 7))));
  {
    Errors_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Errors_7, 0) = ((MR_Box) (NewError_4));
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  ...
  NoSuffixIntegerMap0_6 = ((MR_Word) ((MR_hl_field(0, Var_11, 5))));
  ...
  Var_30 = ((MR_Integer) ((MR_hl_field(0, Var_23, 1))));
  Var_31 = ((MR_Word) ((MR_hl_field(0, Var_23, 2))));
  Var_32 = ((MR_Word) ((MR_hl_field(0, Var_23, 3))));
  Var_33 = ((MR_Word) ((MR_hl_field(0, Var_23, 4))));
  Var_35 = ((MR_Unsigned) ((MR_hl_field(0, Var_23, 6))) & (MR_Integer) 1);
  Var_36 = ((MR_Word) ((MR_hl_field(0, Var_23, 7))));
  {
...
{
  MR_bool succeeded;
  MR_Word OverloadedSymbolMap0_8 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 2))));
  ...
  if (succeeded)
  {
    ...
    mercury__one_or_more__cons_3_p_0((MR_Word) (&mercury__term_context__term_context__type_ctor_info_term_context_0), ((MR_Box) (Context_6)), OldContexts_9, &Contexts_10);
  ...
  else
  {
    ...
    {
      Contexts_16 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Contexts_16, 0) = ((MR_Box) (Context_6));
      MR_hl_field(0, Contexts_16, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  ...
  Var_28 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 1))));
  Var_30 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 3))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * Ctors_4)
{
  ...
  MR_Word Var_6 = ((MR_Word) ((MR_hl_field(0, Info_3, 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  MR_Integer Var_13 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_6, 3))));
  MR_Integer Var_16 = ((MR_Integer) ((MR_hl_field(0, Var_9, 1))));
  MR_Word Var_17 = ((MR_Word) ((MR_hl_field(0, Var_9, 2))));
  MR_Word Var_18 = ((MR_Word) ((MR_hl_field(0, Var_9, 3))));
  MR_Word Var_19 = ((MR_Word) ((MR_hl_field(0, Var_9, 4))));
  MR_Word Var_20 = ((MR_Word) ((MR_hl_field(0, Var_9, 5))));
  MR_Word Var_22 = ((MR_Word) ((MR_hl_field(0, Var_9, 7))));
  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_9, 0)));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  MR_Word Var_18 = ((MR_Word) ((MR_hl_field(0, Var_9, 3))));
  MR_Word Var_20 = ((MR_Word) ((MR_hl_field(0, Var_9, 5))));
  MR_Word Var_21 = ((MR_Unsigned) ((MR_hl_field(0, Var_9, 6))) & (MR_Integer) 1);
  MR_Word Var_22 = ((MR_Word) ((MR_hl_field(0, Var_9, 7))));
  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_9, 0)));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  MR_Integer Var_11 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_6, 3))));
  ...
  MR_Word * X_4)
{
  ...
  *X_4 = ((MR_Unsigned) ((MR_hl_field(0, Var_5, 6))) & (MR_Integer) 1);
}
...
void MR_CALL 
check_hlds__typecheck_info__typecheck_info_get_in_field_access_function_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
  MR_Word Var_5 = ((MR_Word) ((MR_hl_field(0, Info_3, 0))));
  ...
  MR_Integer * X_4)
{
  ...
  *X_4 = ((MR_Integer) ((MR_hl_field(0, Var_5, 1))));
}
  ...
  MR_Word * X_4)
{
  ...
  *X_4 = ((MR_Unsigned) ((MR_hl_field(0, Var_5, 0))) & (MR_Integer) 1);
}
  ...
  MR_Word * X_4)
{
  ...
  *X_4 = ((((MR_Unsigned) ((MR_hl_field(0, Var_5, 0))) >> 1)) & (MR_Integer) 1);
}
...
check_hlds__typecheck_info__typecheck_info_get_pred_id_2_p_0(
  ...
  MR_Word * X_4)
{
  MR_Word Var_5 = ((MR_Word) ((MR_hl_field(0, Info_3, 1))));
...
check_hlds__typecheck_info__typecheck_info_get_ambiguity_warn_limit_2_p_0(
  ...
  MR_Integer * X_4)
{
  *X_4 = ((MR_Integer) ((MR_hl_field(0, Info_3, 3))));
}
  ...
  MR_Word * Info_18)
{
  ...
  MR_Word MaybeInFieldAccessFunc_23;
  MR_Word Globals_25;
  MR_Word Verbose_26;
  MR_Integer AmbiguityWarnLimit_27;
  MR_Word NoSuffixIntegerMap_28;
  MR_Word DebugTypesPredNames_29;
  MR_Word DebugInfo_34;
  MR_Word SubInfo_36;
  MR_Integer AmbiguityErrorLimit_37;
  MR_Word ClauseContext_39;
  MR_Word OverloadedSymbolMap_40;
  MR_Word Var_48;
  MR_Word AccessType_20;
  MR_Word FieldName_21;
  MR_Word OoMFieldDefns_22;

  CallsAreFullyQualified_19 = hlds__hlds_pred__calls_are_fully_qualified_1_f_0(PredMarkers_16);
  succeeded = hlds__hlds_pred_tests__pred_info_is_field_access_function_5_p_0(ModuleInfo_11, PredInfo_13, &AccessType_20, &FieldName_21, &OoMFieldDefns_22);
  if (succeeded)
    {
      MaybeInFieldAccessFunc_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeInFieldAccessFunc_23, 0) = ((MR_Box) (Status_15));
      MR_hl_field(1, MaybeInFieldAccessFunc_23, 1) = (MR_Box) ((MR_Unsigned) (AccessType_20));
      MR_hl_field(1, MaybeInFieldAccessFunc_23, 2) = ((MR_Box) (FieldName_21));
      MR_hl_field(1, MaybeInFieldAccessFunc_23, 3) = ((MR_Box) (OoMFieldDefns_22));
    }
  else
    MaybeInFieldAccessFunc_23 = (MR_Word) ((MR_Unsigned) 0U);
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_11, &Globals_25);
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 140, &Verbose_26);
  libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 146, &AmbiguityWarnLimit_27);
  NoSuffixIntegerMap_28 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[0]));
  libs__globals__lookup_accumulating_option_3_p_0(Globals_25, (MR_Integer) 700, &DebugTypesPredNames_29);
  if ((DebugTypesPredNames_29 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word DebugTypes_35;

    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 699, &DebugTypes_35);
    switch (DebugTypes_35) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        DebugInfo_34 = (MR_Word) ((MR_Unsigned) 0U);
        break;
      case (MR_Integer) 1:
        {
          MR_Word Stats_50;

          libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 689, &Stats_50);
          {
            DebugInfo_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, DebugInfo_34, 0) = (MR_Box) ((MR_Unsigned) (Stats_50));
            MR_hl_field(1, DebugInfo_34, 1) = ((MR_Box) (ProgressStream_10));
          }
        }
        break;
    }
  ...
  else
  {
    ...
    Name_32 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo_13);
    succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Name_32)), DebugTypesPredNames_29);
    if (succeeded)
    {
      MR_Word Stats_33;

      libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 689, &Stats_33);
      {
        DebugInfo_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, DebugInfo_34, 0) = (MR_Box) ((MR_Unsigned) (Stats_33));
        MR_hl_field(1, DebugInfo_34, 1) = ((MR_Box) (ProgressStream_10));
      }
    }
    else
  ...
  Var_48 = mercury__term_context__dummy_context_0_f_0();
  {
    ClauseContext_39 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ClauseContext_39, 0) = ((MR_Box) (ModuleInfo_11));
    MR_hl_field(0, ClauseContext_39, 1) = ((MR_Box) (PredId_12));
    MR_hl_field(0, ClauseContext_39, 2) = ((MR_Box) (PredMarkers_16));
    MR_hl_field(0, ClauseContext_39, 3) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(0, ClauseContext_39, 4) = ((MR_Box) (Var_48));
    MR_hl_field(0, ClauseContext_39, 5) = ((MR_Box) (ClauseVarSet_14));
  }
  mercury__map__init_1_p_0((MR_Word) (&check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_overloaded_symbol_0), (MR_Word) (&check_hlds__typecheck_info_scalar_common_1[1]), &OverloadedSymbolMap_40);
  libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 147, &AmbiguityErrorLimit_37);
  {
    SubInfo_36 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, SubInfo_36, 0) = (MR_Box) (((((MR_Unsigned) (Verbose_26) << 1)) | (MR_Unsigned) (CallsAreFullyQualified_19)));
    MR_hl_field(0, SubInfo_36, 1) = ((MR_Box) (AmbiguityErrorLimit_37));
    MR_hl_field(0, SubInfo_36, 2) = ((MR_Box) (MaybeInFieldAccessFunc_23));
    MR_hl_field(0, SubInfo_36, 3) = ((MR_Box) (NonOverloadErrors_17));
    MR_hl_field(0, SubInfo_36, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, SubInfo_36, 5) = ((MR_Box) (NoSuffixIntegerMap_28));
    MR_hl_field(0, SubInfo_36, 6) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(0, SubInfo_36, 7) = ((MR_Box) (DebugInfo_34));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *Info_18 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (SubInfo_36));
    MR_hl_field(0, base, 1) = ((MR_Box) (ClauseContext_39));
    MR_hl_field(0, base, 2) = ((MR_Box) (OverloadedSymbolMap_40));
    MR_hl_field(0, base, 3) = ((MR_Box) (AmbiguityWarnLimit_27));
  }
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = check_hlds__typecheck_info____Unify____maybe_in_field_access_func_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  check_hlds__typecheck_info____Compare____maybe_in_field_access_func_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
...
void mercury__check_hlds__typecheck_info__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_maybe_in_field_access_func_0);
