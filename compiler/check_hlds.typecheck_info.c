...
MR_decl_label7(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 55,56,57,58,59,3,61)
...
MR_decl_label9(fn__check_hlds__typecheck_info__type_assign_constraints_to_pieces_list_5_0, 27,7,6,5,8,9,10,11,15)
...
MR_decl_label10(fn__check_hlds__typecheck_info__type_assign_types_to_pieces_6_0, 47,5,3,10,13,12,15,16,17,18)
...
MR_decl_label10(__Compare___check_hlds__typecheck_info__cons_type_info_source_0_0, 3,80,92,93,20,23,32,33,35,39)
MR_decl_label9(__Compare___check_hlds__typecheck_info__cons_type_info_source_0_0, 47,155,98,99,18,50,63,116,55)
MR_decl_label8(__Compare___check_hlds__typecheck_info__overloaded_symbol_0_0, 3,2,9,7,5,15,17,54)
MR_decl_label9(__Compare___check_hlds__typecheck_info__type_assign_0_0, 3,2,6,10,15,20,24,28,64)
...
MR_decl_label1(__Compare___check_hlds__typecheck_info__typecheck_sub_info_0_0, 78)
...
MR_def_label(check_hlds__typecheck_info__typecheck_info_init_12_0,11)
	...
	MR_tfield(0, MR_tempr3, 2) = MR_sv(12);
	MR_tfield(0, MR_tempr3, 3) = (MR_Integer) 0;
	MR_tfield(0, MR_tempr3, 4) = MR_sv(13);
	MR_tfield(0, MR_tempr3, 5) = (MR_Word) MR_TAG_COMMON(0,3,2);
	MR_tfield(0, MR_tempr3, 6) = MR_tempr2;
	MR_tfield(0, MR_tempr3, 7) = MR_sv(18);
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__typecheck_info__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module10)
	...
	MR_init_label7(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,55,56,57,58,59,3,61)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typecheck_info__typecheck_info_add_overloaded_symbol_4_0,10)
	...
	MR_tempr2 = MR_tfield(0, MR_tempr11, 7);
	MR_tempr3 = MR_tfield(0, MR_tempr11, 6);
	MR_tempr4 = MR_tfield(0, MR_tempr11, 5);
	MR_tempr5 = MR_tfield(0, MR_tempr11, 4);
	MR_tempr6 = MR_tfield(0, MR_tempr11, 3);
	MR_tempr7 = MR_tfield(0, MR_tempr11, 2);
	MR_tempr8 = MR_tfield(0, MR_tempr11, 1);
	MR_tag_alloc_heap(MR_tempr9, 0, (MR_Integer) 9);
	MR_tfield(0, MR_tempr9, 0) = MR_tfield(0, MR_tempr1, 0);
	MR_tfield(0, MR_tempr9, 1) = MR_tfield(0, MR_tempr1, 1);
	MR_tfield(0, MR_tempr9, 2) = MR_tfield(0, MR_tempr1, 2);
	MR_tfield(0, MR_tempr9, 3) = MR_tfield(0, MR_tempr1, 3);
	MR_tfield(0, MR_tempr9, 4) = MR_tfield(0, MR_tempr1, 4);
	MR_tfield(0, MR_tempr9, 5) = MR_tfield(0, MR_tempr1, 5);
	MR_tfield(0, MR_tempr9, 6) = MR_tfield(0, MR_tempr1, 6);
	MR_tfield(0, MR_tempr9, 7) = MR_r1;
	MR_tfield(0, MR_tempr9, 8) = MR_tfield(0, MR_tempr1, 8);
...
MR_def_label(check_hlds__typecheck_info__typecheck_info_get_all_errors_2_0,3)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tfield(0, MR_r3, 5);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module49)
	...
	MR_init_label10(fn__check_hlds__typecheck_info__type_assign_types_to_pieces_6_0,47,5,3,10,13,12,15,16,17,18)
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module50)
	...
	MR_init_label9(fn__check_hlds__typecheck_info__type_assign_constraints_to_pieces_list_5_0,27,7,6,5,8,9,10,11,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module68)
	...
	MR_init_label10(__Compare___check_hlds__typecheck_info__cons_type_info_source_0_0,3,80,92,93,20,23,32,33,35,39)
	MR_init_label9(__Compare___check_hlds__typecheck_info__cons_type_info_source_0_0,47,155,98,99,18,50,63,116,55)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module74)
	...
	MR_init_label9(__Compare___check_hlds__typecheck_info__type_assign_0_0,3,2,6,10,15,20,24,28,64)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module80)
	...
	MR_init_label1(__Compare___check_hlds__typecheck_info__typecheck_sub_info_0_0,78)
MR_BEGIN_CODE
