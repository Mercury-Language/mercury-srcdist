  ...
  MR_Word * Info_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 181, &Verbose_23);
  libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 187, &AmbiguityWarnLimit_24);
  NoSuffixIntegerMap_25 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[0]));
  libs__globals__lookup_accumulating_option_3_p_0(Globals_22, (MR_Integer) 150, &DebugTypesPredNames_26);
  if ((DebugTypesPredNames_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word DebugTypes_32;

    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 149, &DebugTypes_32);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 134, &Stats_47);
          {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 134, &Stats_30);
      {
        DebugInfo_31 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 188, &AmbiguityErrorLimit_34);
  {
