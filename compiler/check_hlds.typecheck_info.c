...
MR_def_label(check_hlds__typecheck_info__typecheck_info_add_overloaded_symbol_4_0,10)
	...
	MR_tempr1 = MR_tfield(0, MR_tempr9, 7);
	MR_tempr2 = MR_tfield(0, MR_tempr9, 6);
	MR_tempr3 = MR_tfield(0, MR_tempr9, 5);
	MR_tempr4 = MR_tfield(0, MR_tempr9, 4);
	MR_tempr5 = MR_tfield(0, MR_tempr9, 3);
	MR_tempr6 = MR_tfield(0, MR_tempr9, 2);
	MR_tempr7 = MR_tfield(0, MR_tempr9, 1);
