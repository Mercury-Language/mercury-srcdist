...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 669, &WarnLimit_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 670, &ErrorLimit_22);
    {
