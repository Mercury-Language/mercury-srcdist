...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__prog_data____Compare____pf_sym_name_arity_0_0(&SubResult1_6, Var_31, ArgY1_5);
        succeeded = (SubResult1_6 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult1_6;
        else
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = parse_tree__prog_data____Unify____pf_sym_name_arity_0_0(ArgX1_3, ArgY1_4);
        if (succeeded)
        {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 691, &AmbiguityErrorLimit_23);
    NoSuffixIntegerMap_24 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[0]));
    {
      ...
      MR_hl_field(MR_mktag(0), SubInfo_25, 2) = ((MR_Box) (MaybeFieldAccessFunction_18));
