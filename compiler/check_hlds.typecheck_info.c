...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck_info__Globals_20, (MR_Integer) 651, &check_hlds__typecheck_info__WarnLimit_21);
    }
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck_info__Globals_20, (MR_Integer) 652, &check_hlds__typecheck_info__ErrorLimit_22);
    }
    {
