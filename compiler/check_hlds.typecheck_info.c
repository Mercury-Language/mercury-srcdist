...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_20, (MR_Integer) 85, &DebugTypesPredNames_24);
    if ((DebugTypesPredNames_24 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word DebugTypes_30;

      libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 84, &DebugTypes_30);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 81, &Stats_45);
            {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 81, &Stats_28);
        {
          DebugInfo_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
