...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgX1_4, (MR_Integer) 0)));
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgY1_5, (MR_Integer) 0)));
        MR_Word Var_31;
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 676, &WarnLimit_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 677, &ErrorLimit_22);
    {
