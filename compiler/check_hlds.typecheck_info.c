  ...
  if (succeeded)
    *HeadVar__1_1 = (MR_Integer) 0;
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Var_89 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          MR_String Var_85 = ((MR_String) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_86 = ((MR_Word) ((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_88 = ((MR_Word) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 0:
                      {
                        MR_Word ArgY1_47 = ((MR_Word) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              MR_String Var_84 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_String ArgY1_61 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              MR_Word Var_87 = ((MR_Word) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
  ...
  MR_Word * Info_16)
{
  ...
  if (succeeded)
    {
      MaybeFieldAccessFunctionStatus_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeFieldAccessFunctionStatus_18, 0) = ((MR_Box) (Status_13));
    }
  else
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            DebugInfo_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, DebugInfo_29, 0) = (MR_Box) ((MR_Unsigned) (Stats_45));
          }
        }
        break;
    }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        DebugInfo_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, DebugInfo_29, 0) = (MR_Box) ((MR_Unsigned) (Stats_28));
      }
    }
    else
      DebugInfo_29 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  Var_43 = mercury__term_context__dummy_context_0_f_0();
  {
    ...
    MR_hl_field(0, ClauseContext_34, 0) = ((MR_Box) (ModuleInfo_9));
    MR_hl_field(0, ClauseContext_34, 1) = ((MR_Box) (PredId_10));
    MR_hl_field(0, ClauseContext_34, 2) = ((MR_Box) (PredMarkers_14));
    MR_hl_field(0, ClauseContext_34, 3) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(0, ClauseContext_34, 4) = ((MR_Box) (Var_43));
    MR_hl_field(0, ClauseContext_34, 5) = ((MR_Box) (ClauseVarSet_12));
  }
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 698, &AmbiguityErrorLimit_32);
  {
    ...
    MR_hl_field(0, SubInfo_31, 0) = (MR_Box) (((((MR_Unsigned) (Verbose_21) << 1)) | (MR_Unsigned) (CallsAreFullyQualified_17)));
    MR_hl_field(0, SubInfo_31, 1) = ((MR_Box) (AmbiguityErrorLimit_32));
    MR_hl_field(0, SubInfo_31, 2) = ((MR_Box) (MaybeFieldAccessFunctionStatus_18));
    MR_hl_field(0, SubInfo_31, 3) = ((MR_Box) (NonOverloadErrors_15));
    MR_hl_field(0, SubInfo_31, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, SubInfo_31, 5) = ((MR_Box) (NoSuffixIntegerMap_23));
    MR_hl_field(0, SubInfo_31, 6) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(0, SubInfo_31, 7) = ((MR_Box) (DebugInfo_29));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *Info_16 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (SubInfo_31));
    MR_hl_field(0, base, 1) = ((MR_Box) (ClauseContext_34));
    MR_hl_field(0, base, 2) = ((MR_Box) (OverloadedSymbolMap_35));
    MR_hl_field(0, base, 3) = ((MR_Box) (AmbiguityWarnLimit_22));
  }
}
