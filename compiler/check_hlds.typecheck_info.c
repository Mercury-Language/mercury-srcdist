  ...
  MR_Word * Info_16)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_20, (MR_Integer) 88, &DebugTypesPredNames_24);
  if ((DebugTypesPredNames_24 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word DebugTypes_30;

    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 87, &DebugTypes_30);
