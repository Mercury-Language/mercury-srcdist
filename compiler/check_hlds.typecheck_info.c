...
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 4,5,6,7,8,9,10,13)
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 16,17,11,22,25,26,27,28)
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 31,32,34,35,37,38,40,41)
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 46,47,48,49,52,50,55,56)
MR_decl_label5(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 57,58,59,3,61)
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module10)
	...
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,4,5,6,7,8,9,10,13)
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,16,17,11,22,25,26,27,28)
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,31,32,34,35,37,38,40,41)
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,46,47,48,49,52,50,55,56)
	MR_init_label5(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,57,58,59,3,61)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,3)
	...
	MR_np_call_localret_ent(fn__check_hlds__typecheck_info__this_file_0_0,
		check_hlds__typecheck_info__typecheck_info_get_final_info_12_0_i61);
MR_def_label(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
