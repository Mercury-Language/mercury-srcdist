...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 68, &Verbose_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 697, &AmbiguityWarnLimit_22);
    NoSuffixIntegerMap_23 = mercury__set_tree234__init_0_f_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[0]));
    libs__globals__lookup_accumulating_option_3_p_0(Globals_20, (MR_Integer) 81, &DebugTypesPredNames_24);
    if ((DebugTypesPredNames_24 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word DebugTypes_30;

      libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 80, &DebugTypes_30);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 77, &Stats_44);
            {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 77, &Stats_28);
        {
          DebugInfo_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 698, &AmbiguityErrorLimit_32);
    {
