...
{
  {
    ...
    if ((MaybeOverloadError_6 == (MR_Word) ((MR_Integer) 0)))
      *Errors_4 = Errors0_5;
    else
    {
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Contexts_16, 1) = ((MR_Box) ((MR_Integer) 0));
      }
...
{
  {
    ...
    switch (IsFieldAccessFunction_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeFieldAccessFunction_18 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 672, &WarnLimit_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 673, &ErrorLimit_22);
    {
      ...
      MR_hl_field(MR_mktag(0), SubInfo_23, 3) = ((MR_Box) ((MR_Integer) 0));
