  ...
  MR_Word * STATE_VARIABLE_Info_13)
{
  ...
  Var_26 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 0))));
  Var_27 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 1))));
  Var_29 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_Info_0_12, 3))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
