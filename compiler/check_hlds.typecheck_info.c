  ...
  MR_Word * Info_18)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_25, (MR_Integer) 699, &DebugTypesPredNames_29);
  if ((DebugTypesPredNames_29 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word DebugTypes_35;

    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 698, &DebugTypes_35);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 688, &Stats_50);
          {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 688, &Stats_33);
      {
        DebugInfo_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
