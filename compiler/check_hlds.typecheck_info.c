...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[8], &Var_15, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[9], &Var_16, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[10], &Var_17, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_15_15 = (MR_Word) &check_hlds__typecheck_info_scalar_common_1[8];
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_15_15, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
        if (succeeded)
        {
          TypeInfo_16_16 = (MR_Word) &check_hlds__typecheck_info_scalar_common_1[9];
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[8], &Var_32, ((MR_Box) (ArgX2_23)), ((MR_Box) (ArgY2_24)));
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[9], &Var_33, ((MR_Box) (ArgX3_25)), ((MR_Box) (ArgY3_26)));
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[10], &Var_34, ((MR_Box) (ArgX4_27)), ((MR_Box) (ArgY4_28)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeInfo_15_26 = (MR_Word) &check_hlds__typecheck_info_scalar_common_1[8];
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_15_26, ((MR_Box) (ArgX2_16)), ((MR_Box) (ArgY2_17)));
          if (succeeded)
          {
            TypeInfo_16_27 = (MR_Word) &check_hlds__typecheck_info_scalar_common_1[9];
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_markers_0, &Var_18, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            else
            {
              ...
              {
                mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__typecheck_info_scalar_common_1[7], HeadVar__1_1, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
              }
            }
          }
        }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_19_19 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_markers_0;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_21_21 = (MR_Word) &check_hlds__typecheck_info_scalar_common_1[7];
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              hlds__hlds_data____Compare____hlds_constraints_0_0(&Var_20, ArgX5_12, ArgY5_13);
              succeeded = (Var_20 == (MR_Integer) 0);
              succeeded = !(succeeded);
              if (succeeded)
                *HeadVar__1_1 = Var_20;
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 666, &WarnLimit_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 667, &ErrorLimit_22);
    {
