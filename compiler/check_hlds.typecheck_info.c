...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[9]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_23, Var_42, Var_43);
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[9]), &SubResult2_26, ((MR_Box) (ArgX2_24)), ((MR_Box) (ArgY2_25)));
          ...
          else
          {
            ...
            else
            {
              ...
              {
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, ArgX5_33, ArgY5_34);
                succeeded = (SubResult1_6 != (MR_Integer) 0);
              }
            }
          }
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[7]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          succeeded = (SubResult3_12 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
          else
          {
            ...
            else
            {
              ...
              {
                mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[8]), HeadVar__1_1, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
              }
            }
          }
        }
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (Var_28)), ((MR_Box) (ArgY2_21)));
        }
      }
      else
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[6]), HeadVar__1_1, ((MR_Box) (Var_30)), ((MR_Box) (ArgY2_8)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[1]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[3]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__typecheck_info_scalar_common_1[4]), &SubResult4_15, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
            succeeded = (SubResult4_15 != (MR_Integer) 0);
            if (succeeded)
              *HeadVar__1_1 = SubResult4_15;
            else
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 678, &WarnLimit_21);
    libs__globals__lookup_int_option_3_p_0(Globals_20, (MR_Integer) 679, &ErrorLimit_22);
    {
