...
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 13,14,15,18,20,21,22,23)
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 24,25,27,28,33,34,35,36)
MR_decl_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0, 37,38,39,40,41,42,3,43)
...
MR_BEGIN_MODULE(check_hlds__typecheck_info_module12)
	...
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,13,14,15,18,20,21,22,23)
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,24,25,27,28,33,34,35,36)
	MR_init_label8(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,37,38,39,40,41,42,3,43)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,38)
	...
	MR_np_call_localret_ent(hlds__hlds_data__retrieve_prog_constraints_2_0,
		check_hlds__typecheck_info__typecheck_info_get_final_info_12_0_i39);
MR_def_label(check_hlds__typecheck_info__typecheck_info_get_final_info_12_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
