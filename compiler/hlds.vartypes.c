  ...
  MR_Word * STATE_VARIABLE_VarTypes_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Type_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
        MR_Word Types_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
        MR_Word STATE_VARIABLE_VarTypes_31_31;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_HeadVar__2_2;
        MR_Word next_value_of_STATE_VARIABLE_VarTypes_0_3;

        mercury__map__set_4_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_36)), ((MR_Box) (Type_26)), STATE_VARIABLE_VarTypes_0_3, &STATE_VARIABLE_VarTypes_31_31);
        // direct tailcall eliminated
        next_value_of_HeadVar__1_1 = Var_35;
        next_value_of_HeadVar__2_2 = Types_27;
        next_value_of_STATE_VARIABLE_VarTypes_0_3 = STATE_VARIABLE_VarTypes_31_31;
...
{
  {
    mercury__map__to_assoc_list_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, AssocList_4);
  }
}
