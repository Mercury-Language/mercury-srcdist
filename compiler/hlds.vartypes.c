...
void MR_CALL 
hlds__vartypes__vartypes_from_rev_sorted_assoc_list_2_p_0(
  MR_Word RevAssocList_3,
  MR_Word * VarTypes_4)
{
  mercury__map__from_rev_sorted_assoc_list_2_p_0((MR_Word) (&hlds__vartypes_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), RevAssocList_3, VarTypes_4);
}
