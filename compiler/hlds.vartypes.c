...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes_scalar_common_2[0], HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__vartypes_scalar_common_2[0], ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[2], &Var_8, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes_scalar_common_2[0], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[2], ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) &hlds__vartypes_scalar_common_2[0];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[1], &Var_8, ((MR_Box) (Var_18)), ((MR_Box) (ArgY1_5)));
        succeeded = (Var_8 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
          *HeadVar__1_1 = Var_8;
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes_scalar_common_2[0], HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY2_7)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_11_11 = (MR_Word) &hlds__vartypes_scalar_common_1[1];
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_11_11, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
        if (succeeded)
        {
          TypeInfo_12_12 = (MR_Word) &hlds__vartypes_scalar_common_2[0];
...
void MR_CALL 
hlds__vartypes__foldl_var_types_4_p_0(
...
{
  {
    mercury__map__foldl_values_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, TypeInfo_for_T_11, (MR_Word) &hlds__vartypes_scalar_common_1[0], Pred_5, VarTypes_6, STATE_VARIABLE_Acc_0_8, STATE_VARIABLE_Acc_9);
  }
}
...
{
  {
    MR_Word TypeCtorInfo_16_16 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;

    mercury__map__map_values_foldl_5_p_1(TypeCtorInfo_16_16, TypeCtorInfo_16_16, TypeInfo_for_T_15, (MR_Word) &hlds__vartypes_scalar_common_1[0], Transform_6, STATE_VARIABLE_VarTypes_0_9, STATE_VARIABLE_VarTypes_10, STATE_VARIABLE_Acc_0_11, STATE_VARIABLE_Acc_12);
  }
}
...
{
  {
    MR_Word TypeCtorInfo_9_17;
    MR_Word Var_8;

    {
      Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&hlds__vartypes_scalar_common_3[1]));
      MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (hlds__vartypes__apply_rec_subst_to_vartypes_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_8, 3) = ((MR_Box) (Subst_4));
    }
    TypeCtorInfo_9_17 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
    mercury__map__map_values_only_3_p_0(TypeCtorInfo_9_17, TypeCtorInfo_9_17, (MR_Word) &hlds__vartypes_scalar_common_1[0], Var_8, STATE_VARIABLE_VarTypes_0_6, STATE_VARIABLE_VarTypes_7);
  }
}
...
{
  {
...

    {
      Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&hlds__vartypes_scalar_common_3[1]));
      MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (hlds__vartypes__apply_subst_to_vartypes_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_8, 3) = ((MR_Box) (Subst_4));
    }
    TypeCtorInfo_9_17 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
...
{
  {
    ...
    {
      Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&hlds__vartypes_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (hlds__vartypes__apply_variable_renaming_to_vartypes_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
...
{
  {
    mercury__map__delete_sorted_list_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, SortedVars_4, STATE_VARIABLE_VarTypes_0_6, STATE_VARIABLE_VarTypes_7);
  }
}
...
{
  {
    mercury__map__delete_list_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, Vars_4, STATE_VARIABLE_VarTypes_0_6, STATE_VARIABLE_VarTypes_7);
  }
}
...
{
  {
    mercury__map__delete_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_4)), STATE_VARIABLE_VarTypes_0_6, STATE_VARIABLE_VarTypes_7);
  }
}
...
hlds__vartypes__vartypes_overlay_corresponding_lists_4_p_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word STATE_VARIABLE_VarTypes_0_3,
  MR_Word * STATE_VARIABLE_VarTypes_4)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      if ((HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *STATE_VARIABLE_VarTypes_4 = STATE_VARIABLE_VarTypes_0_3;
      else
      {
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.vartypes.vartypes_overlay_corresponding_lists\'/4", (MR_String) "mismatched list lengths");
          return;
        }
      }
    else
    {
      ...
      else
      {
        ...
        MR_Word STATE_VARIABLE_VarTypes_29_29;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_HeadVar__2_2;
        MR_Word next_value_of_STATE_VARIABLE_VarTypes_0_3;

        mercury__map__set_4_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_34)), ((MR_Box) (Type_24)), STATE_VARIABLE_VarTypes_0_3, &STATE_VARIABLE_VarTypes_29_29);
        // direct tailcall eliminated
        next_value_of_HeadVar__1_1 = Var_33;
        next_value_of_HeadVar__2_2 = Types_25;
        next_value_of_STATE_VARIABLE_VarTypes_0_3 = STATE_VARIABLE_VarTypes_29_29;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
        HeadVar__2_2 = next_value_of_HeadVar__2_2;
        STATE_VARIABLE_VarTypes_0_3 = next_value_of_STATE_VARIABLE_VarTypes_0_3;
        continue;
      }
    }
    break;
...
{
  {
    mercury__map__det_insert_from_corresponding_lists_4_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, Vars_5, Types_6, STATE_VARIABLE_VarTypes_0_8, STATE_VARIABLE_VarTypes_9);
  }
}
...
{
  {
    mercury__map__from_sorted_assoc_list_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, AssocList_3, VarTypes_4);
  }
}
...
{
  {
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, Vars_4, Types_5, VarTypes_6);
  }
}

void MR_CALL 
hlds__vartypes__vartypes_to_sorted_assoc_list_2_p_0(
  MR_Word VarTypes_3,
  MR_Word * AssocList_4)
{
  {
    mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, AssocList_4);
  }
}
...
{
  {
    mercury__map__values_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, Types_4);
  }
}
...
{
  {
    mercury__map__keys_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, Vars_4);
  }
}
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, HeadVar__1_1, ((MR_Box) (Var_6)), &conv0_Type_8);
    Type_8 = ((MR_Word) conv0_Type_8);
    hlds__vartypes__lookup_var_types_3_p_0(HeadVar__1_1, Vars_7, &Types_9);
    {
      MR_Word base;
...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_4, ((MR_Box) (Var_5)), &conv0_Type_6);
    *Type_6 = ((MR_Word) conv0_Type_6);
  }
}

MR_Word MR_CALL 
hlds__vartypes__lookup_var_type_func_2_f_0(
  MR_Word VarTypes_4,
  MR_Word Var_5)
{
  {
...
{
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_4, ((MR_Box) (Var_5)), &conv0_Type_6);
    if (succeeded)
    {
      *Type_6 = ((MR_Word) conv0_Type_6);
      succeeded = MR_TRUE;
...
{
  {
    ...
    succeeded = mercury__map__contains_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, ((MR_Box) (Var_4)));
    return succeeded;
  }
}
...
{
  {
    mercury__map__search_insert_5_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_6)), ((MR_Box) (NewType_7)), MaybeOldType_8, STATE_VARIABLE_VarTypes_0_10, STATE_VARIABLE_VarTypes_11);
  }
}
...
{
  {
    mercury__map__det_update_4_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_5)), ((MR_Box) (Type_6)), STATE_VARIABLE_VarTypes_0_8, STATE_VARIABLE_VarTypes_9);
  }
}
...
{
  {
    mercury__map__det_insert_4_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (Var_5)), ((MR_Box) (Type_6)), STATE_VARIABLE_VarTypes_0_8, STATE_VARIABLE_VarTypes_9);
  }
}
...
{
  {
    mercury__map__optimize_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, STATE_VARIABLE_VarTypes_0_4, STATE_VARIABLE_VarTypes_5);
  }
}
...
{
  {
    mercury__map__select_3_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, STATE_VARIABLE_VarTypes_0_6, SelectedVars_4, STATE_VARIABLE_VarTypes_7);
  }
}
...
{
  {
    mercury__map__count_2_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_3, Count_4);
  }
}
...
{
  {
    ...
    succeeded = mercury__map__is_empty_1_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_2);
    return succeeded;
  }
}
...
{
  {
    mercury__map__init_1_p_0((MR_Word) &hlds__vartypes_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, VarTypes_2);
  }
}
...
{
  {
    ...
    succeeded = hlds__vartypes____Unify____maybe_vartypes_0_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__vartypes____Compare____maybe_vartypes_0_0(&conv0_HeadVar__1_1, ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3));
...
{
  {
    ...
    succeeded = hlds__vartypes____Unify____prog_var_set_types_0_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__vartypes____Compare____prog_var_set_types_0_0(&conv0_HeadVar__1_1, ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3));
    *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
  }
}
...
{
  {
    ...
    succeeded = hlds__vartypes____Unify____vartypes_0_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__vartypes____Compare____vartypes_0_0(&conv0_HeadVar__1_1, ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3));
    *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
  }
}
