...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mdbcomp__sym_name____Compare____sym_name_0_0(&Var_19, ArgX2_6, ArgY2_7);
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_string_3_p_0(&Var_20, ArgX3_8, ArgY3_9);
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__erlang_rtti_scalar_common_1[2], &Var_22, ((MR_Box) (ArgX5_12)), ((MR_Box) (ArgY5_13)));
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__erlang_rtti_scalar_common_1[2], &Var_23, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
                succeeded = (Var_23 == (MR_Integer) 0);
                succeeded = !(succeeded);
                if (succeeded)
                  *HeadVar__1_1 = Var_23;
                else
                  backend_libs__erlang_rtti____Compare____erlang_type_ctor_details_0_0(HeadVar__1_1, ArgX7_16, ArgY7_17);
              }
            }
          }
        }
      ...
      switch (MR_tag((MR_Word) HeadVar__2_2)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_string_3_p_0(&Var_20, ArgX1_4, ArgY1_5);
      succeeded = (Var_20 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_20;
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              MR_Word Var_24;
              MR_String Var_37 = (MR_String) ArgX5_12;
              MR_String Var_38 = (MR_String) ArgY5_13;

              mercury__private_builtin__builtin_compare_string_3_p_0(&Var_24, Var_37, Var_38);
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__erlang_rtti_scalar_common_1[0], &Var_25, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
                ...
                else
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__erlang_rtti_scalar_common_1[1], &Var_26, ((MR_Box) (ArgX7_16)), ((MR_Box) (ArgY7_17)));
                  ...
                  {
                    MR_Integer Var_39 = (MR_Integer) ArgX8_18;
                    MR_Integer Var_40 = (MR_Integer) ArgY8_19;
