            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[3]), &SubResult7_24, ((MR_Box) (ArgX7_22)), ((MR_Box) (ArgY7_23)));
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[1]), &SubResult5_18, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[1]), &SubResult6_21, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
                succeeded = (SubResult6_21 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult6_21;
                else
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_20_20 = (MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[1]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_20_20, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
              if (succeeded)
              {
                TypeInfo_21_21 = (MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[1]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_21_21, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
                if (succeeded)
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (Var_92)), ((MR_Box) (ArgY1_5)));
                }
                break;
              case (MR_Integer) 2:
                *HeadVar__1_1 = (MR_Integer) 1;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_22_22 = (MR_Word) (&backend_libs__erlang_rtti_scalar_common_1[0]);
