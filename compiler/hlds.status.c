  ...
  MR_Word * HeadVar__3_3)
{
  ...
  if (succeeded)
    ...
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.status.instance_combine_status\'/3", (MR_String) "unexpected status for instance definition");
      return;
    }
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  if (succeeded)
    ...
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.status.typeclass_combine_status\'/3", (MR_String) "unexpected status for typeclass definition");
      return;
    }
  *HeadVar__3_3 = (MR_Word) (Status_6);
}
  ...
  MR_Word * Status_6)
{
  ...
  switch (MR_tag((MR_Word) StatusA_4)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word ImportLocn_7 = ((MR_Unsigned) ((MR_hl_field(2, StatusA_4, 0))) & (MR_Integer) 7);

        switch (ImportLocn_7) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 4:
            {
              *Status_6 = (MR_Word) (MR_mkword(2, &hlds__status_scalar_common_1[0]));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 3:
