              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_54, Var_55);
                }
                break;
            }
          }
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        hlds__status____Compare____instmode_import_0_0(HeadVar__1_1, Var_16, ArgY1_11);
      }
      else
        *HeadVar__1_1 = (MR_Integer) 2;
    }
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      {
        ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
        succeeded = hlds__status____Unify____instmode_import_0_0(ArgX1_5, ArgY1_6);
      }
    }
    else
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) ItemMercuryStatus_3)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      switch (MR_tag((MR_Word) ItemImport_9)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(ItemImport_9)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
              break;
            case (MR_Integer) 1:
              OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              break;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ImportLocn_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), ItemImport_9, (MR_Integer) 0)));

            {
              OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), OldImportStatus_5, 0) = ((MR_Box) (ImportLocn_10));
            }
          }
          break;
      }
    ...
    {
      MR_Word ItemExport_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemMercuryStatus_3, (MR_Integer) 0)));

      switch (ItemExport_8) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 2:
          OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
          break;
        case (MR_Integer) 0:
          OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
          break;
        case (MR_Integer) 1:
          OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
          break;
      }
    }
      ...
      switch (MR_tag((MR_Word) ItemImport_10)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(ItemImport_10)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              InstImport_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              break;
            case (MR_Integer) 1:
              InstImport_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
              break;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ImportLocn_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), ItemImport_10, (MR_Integer) 0)));
            MR_Word InstImportLocn_12;

            switch (ImportLocn_11) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 3:
                InstImportLocn_12 = (MR_Integer) 2;
                break;
              case (MR_Integer) 0:
                InstImportLocn_12 = (MR_Integer) 0;
                break;
              case (MR_Integer) 2:
                {
                  {
                    mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.status.item_mercury_status_to_instmode_status\'/2", (MR_String) "import_locn_import_by_ancestor");
                    return;
                  }
                }
                break;
              case (MR_Integer) 1:
                InstImportLocn_12 = (MR_Integer) 1;
                break;
            }
            {
              InstImport_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), InstImport_13, 0) = ((MR_Box) (InstImportLocn_12));
            }
          }
          break;
      }
      {
        InstModeStatus_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), InstModeStatus_5, 0) = ((MR_Box) (InstImport_13));
      }
    }
    else
    {
      ...
      {
        InstModeStatus_5 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), InstModeStatus_5, 0) = ((MR_Box) (InstExport_9));
      }
    }
    ...
    switch (MR_tag((MR_Word) StatusA_4)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(StatusA_4)) {
          ...
          case (MR_Integer) 0:
            {
              CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              succeeded = ((MR_tag((MR_Word) StatusB_5)) == (MR_mktag((MR_Integer) 2)));
              if (succeeded)
              {
                Section_29 = ((MR_Word) (MR_hl_field(MR_mktag(2), StatusB_5, (MR_Integer) 0)));
                CombinedStatus_7 = StatusB_5;
              }
              else
                CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 3:
            {
              CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 5:
            {
              succeeded = (StatusB_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
              if (succeeded)
                CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
              else
                CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) StatusB_5)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StatusB_5)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        Status3_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 3:
                      {
                        Status3_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 5:
                      {
                        Status3_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 7:
                      {
                        Status3_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
              ...
              if (succeeded)
              {
                succeeded = (Status3_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8))));
                if (succeeded)
                  CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
                else
                  CombinedStatus_7 = Status3_19;
                succeeded = MR_TRUE;
              }
            }
            break;
            ...
            switch (MR_tag((MR_Word) StatusB_5)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(StatusB_5)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      CombinedStatus_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        {
          MR_Word ImportLocn_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), StatusA_4, (MR_Integer) 0)));
...
{
  {
    ...
    succeeded = (Status_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
    if (succeeded)
      AbstractStatus_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
    else
    {
      MR_Word Var_7;

      succeeded = ((MR_tag((MR_Word) Status_3)) == (MR_mktag((MR_Integer) 2)));
      if (succeeded)
      {
        Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), Status_3, (MR_Integer) 0)));
        AbstractStatus_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
      }
      else
...
{
  {
    ...
    if (((MR_tag((MR_Word) InstModeStatus_5)) == (MR_mktag((MR_Integer) 1))))
      IsDefnImplSection_4 = (MR_Integer) 0;
    else
    {
      MR_Word InstModeExport_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), InstModeStatus_5, (MR_Integer) 0)));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word ImportLocn_4 = ((MR_Word) (MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = (Status_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7))));
      succeeded = !(succeeded);
    }
    if (succeeded)
      HeadVar__2_2 = (MR_Integer) 1;
...
{
  {
    ...
    succeeded = hlds__status____Unify____instmode_import_plain_locn_0_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__status____Compare____instmode_import_plain_locn_0_0(&conv0_HeadVar__1_1, ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3));
    *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
  }
}
