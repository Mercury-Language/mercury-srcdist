...
static const MR_DuArgLocn hlds__status__hlds__status__field_locns_instmode_import_0_0[1];
...
static const MR_DuFunctorDesc hlds__status__hlds__status__du_functor_desc_instmode_import_0_0 = {
  ...
  NULL,
  hlds__status__hlds__status__field_locns_instmode_import_0_0,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
  UINT8_C(0)
};
    ...
    if (succeeded)
      *HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) HeadVar__2_2)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Var_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 3);
    ...
    if (succeeded)
      *HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) HeadVar__2_2)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Var_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 3);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word ArgY1_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 3);
...
{
  {
    ...
    if (((MR_tag((MR_Word) ItemMercuryStatus_3)) == (MR_Integer) 1))
    {
      ...
      switch (MR_tag((MR_Word) ItemImport_9)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_9, (MR_Integer) 0)));

            {
              OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), OldImportStatus_5, 0) = (MR_Box) (packed_args_0);
            }
          }
          break;
      }
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_3, (MR_Integer) 0)));
      ...
      switch (MR_tag((MR_Word) ItemImport_10)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(ItemImport_10)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              InstImport_13 = (MR_Word) ((MR_Unsigned) 0U);
              break;
            case (MR_Integer) 1:
              InstImport_13 = (MR_Word) ((MR_Unsigned) 4U);
              break;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ImportLocn_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_10, (MR_Integer) 0))) & (MR_Integer) 3);
            MR_Word InstImportLocn_12;
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_10, (MR_Integer) 0)));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), InstImport_13, 0) = (MR_Box) ((MR_Unsigned) (InstImportLocn_12));
            }
          }
          break;
      }
...
{
  {
    ...
    switch (MR_tag((MR_Word) StatusA_4)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), StatusB_5, (MR_Integer) 0)));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) StatusB_5)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StatusB_5)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        Status3_19 = (MR_Word) ((MR_Unsigned) 32U);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 3:
                      {
                        Status3_19 = (MR_Word) ((MR_Unsigned) 12U);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 5:
                      {
                        Status3_19 = (MR_Word) ((MR_Unsigned) 20U);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 7:
                      {
                        Status3_19 = (MR_Word) ((MR_Unsigned) 28U);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
              ...
              if (succeeded)
              {
                succeeded = (Status3_19 == (MR_Word) ((MR_Unsigned) 32U));
                if (succeeded)
      ...
      case (MR_Integer) 2:
        {
          MR_Word ImportLocn_10 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), StatusA_4, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), StatusA_4, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Status_3, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InstModeStatus_5, (MR_Integer) 0)));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word ImportLocn_4 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0)));
