...
{
  {
    ...
    if (((MR_tag((MR_Word) ItemMercuryStatus_3)) == (MR_Integer) 1))
    {
      ...
      switch (MR_tag((MR_Word) ItemImport_9)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word ImportLocn_10 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_9, (MR_Integer) 0))) & (MR_Integer) 3);
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_9, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_3, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_10, (MR_Integer) 0)));
            ...
            {
              InstImport_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), StatusB_5, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), StatusA_4, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Status_3, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InstModeStatus_5, (MR_Integer) 0)));
