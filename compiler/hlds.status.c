...
{
  {
      ...
      switch (MR_tag((MR_Word) ItemImport_9)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(ItemImport_9)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              OldImportStatus_5 = (MR_Word) ((MR_Integer) 4);
              break;
            case (MR_Integer) 1:
              OldImportStatus_5 = (MR_Word) ((MR_Integer) 0);
              break;
          }
          break;
        case (MR_Integer) 1:
    ...
    else
    {
      ...
      switch (ItemExport_8) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 2:
          OldImportStatus_5 = (MR_Word) ((MR_Integer) 12);
          break;
        case (MR_Integer) 0:
          OldImportStatus_5 = (MR_Word) ((MR_Integer) 32);
          break;
        case (MR_Integer) 1:
          OldImportStatus_5 = (MR_Word) ((MR_Integer) 28);
          break;
      }
    }
      ...
      switch (MR_tag((MR_Word) ItemImport_10)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(ItemImport_10)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              InstImport_13 = (MR_Word) ((MR_Integer) 0);
              break;
            case (MR_Integer) 1:
              InstImport_13 = (MR_Word) ((MR_Integer) 4);
              break;
          }
          break;
        case (MR_Integer) 1:
    ...
    switch (MR_tag((MR_Word) StatusA_4)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(StatusA_4)) {
          ...
          case (MR_Integer) 0:
            {
              CombinedStatus_7 = (MR_Word) ((MR_Integer) 0);
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                CombinedStatus_7 = (MR_Word) ((MR_Integer) 4);
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 3:
            {
              CombinedStatus_7 = (MR_Word) ((MR_Integer) 12);
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 5:
            {
              succeeded = (StatusB_5 == (MR_Word) ((MR_Integer) 12));
              if (succeeded)
                CombinedStatus_7 = (MR_Word) ((MR_Integer) 12);
              else
                CombinedStatus_7 = (MR_Word) ((MR_Integer) 20);
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) StatusB_5)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StatusB_5)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        Status3_19 = (MR_Word) ((MR_Integer) 32);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 3:
                      {
                        Status3_19 = (MR_Word) ((MR_Integer) 12);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 5:
                      {
                        Status3_19 = (MR_Word) ((MR_Integer) 20);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 7:
                      {
                        Status3_19 = (MR_Word) ((MR_Integer) 28);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
              ...
              if (succeeded)
              {
                succeeded = (Status3_19 == (MR_Word) ((MR_Integer) 32));
                if (succeeded)
                  CombinedStatus_7 = (MR_Word) ((MR_Integer) 28);
                else
            ...
            switch (MR_tag((MR_Word) StatusB_5)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(StatusB_5)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      CombinedStatus_7 = (MR_Word) ((MR_Integer) 32);
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 1:
...
{
  {
    ...
    succeeded = (Status_3 == (MR_Word) ((MR_Integer) 12));
    if (succeeded)
      AbstractStatus_4 = (MR_Word) ((MR_Integer) 20);
    else
    {
      succeeded = ((MR_tag((MR_Word) Status_3)) == (MR_mktag((MR_Integer) 2)));
      if (succeeded)
      {
        AbstractStatus_4 = (MR_Word) ((MR_Integer) 4);
      }
      else
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = (Status_3 == (MR_Word) ((MR_Integer) 28));
      succeeded = !(succeeded);
    }
    if (succeeded)
      HeadVar__2_2 = (MR_Integer) 1;
