...
/* sealed */ struct hlds__status__vector_common_type_2_0_s {
  const MR_Word hlds__status__vector_common_type_2_0__vct_2_f_0;
};

static /* final */ const struct hlds__status__vector_common_type_2_0_s hlds__status_vector_common_2[5];
      ...
      case (MR_Integer) 2:
        {
          ...
          HeadVar__2_2 = ((&hlds__status_vector_common_2[0 + ImportLocn_4]))->hlds__status__vector_common_type_2_0__vct_2_f_0;
        }
        break;
    }
    return HeadVar__2_2;
