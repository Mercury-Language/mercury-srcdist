    ...
    if (hlds__status__succeeded)
      *hlds__status__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        {
          hlds__status____Compare____new_instmode_status_0_0(hlds__status__HeadVar__1_1, hlds__status__V_4_4, hlds__status__V_5_5);
        }
      }
  }
}
...
{
  {
    ...
    if (hlds__status__succeeded)
    ...
    else
      {
        ...
        {
          hlds__status__succeeded = hlds__status____Unify____new_instmode_status_0_0(hlds__status__V_3_3, hlds__status__V_4_4);
        }
      }
    return hlds__status__succeeded;
  }
