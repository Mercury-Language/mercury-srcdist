        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__1_1 = ArgX1_3;
                MR_Word next_value_of_HeadVar__2_2 = ArgY1_4;
...
{
  {
    ...
    switch (MR_tag((MR_Word) StatusA_4)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Section_30 = ((MR_Word) (MR_hl_field(MR_mktag(2), StatusB_5, (MR_Integer) 0)));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) StatusB_5)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StatusB_5)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        Status3_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 3:
                      {
                        Status3_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 5:
                      {
                        Status3_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 7:
                      {
                        Status3_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
              ...
              if (succeeded)
              {
                succeeded = (Status3_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8))));
                if (succeeded)
      ...
      case (MR_Integer) 2:
        {
          MR_Word ImportLocn_11 = ((MR_Word) (MR_hl_field(MR_mktag(2), StatusA_4, (MR_Integer) 0)));
