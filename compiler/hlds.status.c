  ...
  MR_Word * PredStatus_4)
{
  ...
  {
    MR_Word ItemImport_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ItemMercuryStatus_3, (MR_Integer) 0))));
    ...
    switch (MR_tag((MR_Word) ItemImport_7)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ImportLocn_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ItemImport_7, (MR_Integer) 0))) & (MR_Integer) 7);

          {
            OldImportStatus_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), OldImportStatus_5, 0) = (MR_Box) ((MR_Unsigned) (ImportLocn_8));
          }
        }
        break;
    }
  ...
  {
    MR_Word ItemExport_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_3, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  MR_Word * ModeStatus_4)
{
  ...
  if (((MR_tag((MR_Word) ItemMercuryStatus_3)) == (MR_Integer) 1))
  {
    MR_Word ItemImport_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ItemMercuryStatus_3, (MR_Integer) 0))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), InstModeStatus_5, 0) = (MR_Box) ((MR_Unsigned) (InstImport_10));
    }
  }
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), InstModeStatus_5, 0) = (MR_Box) ((MR_Unsigned) (InstExport_7));
    }
  }
    ...
    case (MR_Integer) 2:
      {
        ...
        switch (ImportLocn_10) {
          ...
          case (MR_Integer) 4:
            {
              CombinedStatus_7 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__status_scalar_common_1[0]));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 3:
            {
              CombinedStatus_7 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__status_scalar_common_1[1]));
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 0:
            ...
            switch (MR_tag((MR_Word) StatusB_5)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(StatusB_5)) {
                  ...
                  case (MR_Integer) 1:
                    {
                      CombinedStatus_7 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__status_scalar_common_1[2]));
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 3:
                  ...
                  case (MR_Integer) 8:
                    {
                      CombinedStatus_7 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__status_scalar_common_1[3]));
                      succeeded = MR_TRUE;
                    }
                    break;
                }
  ...
  MR_Word ModeStatus_3)
{
  ...
  {
    MR_Word InstModeExport_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InstModeStatus_5, (MR_Integer) 0))) & (MR_Integer) 3);
