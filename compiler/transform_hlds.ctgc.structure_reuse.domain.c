        ...
        if ((Result0_16 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_8[0]));
              MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__domain__reuse_as_satisfied_7_p_0_3));
              MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) ((MR_Integer) 5));
              MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (ModuleInfo_8));
              MR_hl_field(MR_mktag(0), Var_32, 4) = ((MR_Box) (ProcInfo_9));
              MR_hl_field(MR_mktag(0), Var_32, 5) = ((MR_Box) (SharingAs_11));
              MR_hl_field(MR_mktag(0), Var_32, 6) = ((MR_Box) (Node_26));
              MR_hl_field(MR_mktag(0), Var_32, 7) = ((MR_Box) (Rest_27));
            }
            Var_34 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[0]));
            mercury__solutions__aggregate_4_p_3((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_2[0]), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[3]), Var_32, (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_2[5]), ((MR_Box) (Var_34)), &conv3_AliasedVarsSet_28);
      ...
      else
      {
        ...
        else
        {
          ...
          Vars_65 = transform_hlds__ctgc__datastruct__datastructs_vars_1_f_0(StaticDeadNodes_51);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Vars_65));
          }
          {
            Result0_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Result0_21, 0) = ((MR_Box) (Var_62));
          }
        }
      }
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      Var_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[0]), Vars0_22, Vars1_24);
                      Vars_25 = mercury__list__sort_and_remove_dups_1_f_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[0]), Var_40);
                      {
                        Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (Vars_25));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_7[0]));
        ...
        {
          Var_18 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_5[1]));
