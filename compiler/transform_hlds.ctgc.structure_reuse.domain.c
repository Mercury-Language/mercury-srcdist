      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__13_13 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[6]);
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__14_14 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[6]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__13_13 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[2]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__13_13, ((MR_Box) (ArgX1_5)), ((MR_Box) (ArgY1_6)));
      if (succeeded)
      {
        TypeInfo__14_14 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_2[2]);
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ArgY1_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
            TypeInfo__11_11 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[5]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_1[4]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__10_10, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
    }
  }
  return succeeded;
    ...
    else
    {
      ...
      else
      {
        ...
        if ((StaticDeadNodes_51 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          transform_hlds__ctgc__livedata__nodes_are_not_live_5_p_0(ModuleInfo_1, ProcInfo_2, DeadNodes_50, UpdatedLiveData_53, &NotLiveResult_54);
          if ((NotLiveResult_54 == (MR_Word) ((MR_Unsigned) 0U)))
            Result0_21 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__ctgc__structure_reuse__domain_scalar_common_3[1]));
          else
          {
            MR_Word StillLive_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NotLiveResult_54, (MR_Integer) 0))));

            if ((StillLive_55 == (MR_Word) ((MR_Unsigned) 0U)))
              Result0_21 = (MR_Word) ((MR_Unsigned) 0U);
            else
            {
              MR_Word Vars_58;
              ...
              Vars_58 = transform_hlds__ctgc__datastruct__datastructs_vars_1_f_0(StillLive_55);
              {
                Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Vars_58));
              }
              {
        ...
        else
        {
          ...
          Vars_64 = transform_hlds__ctgc__datastruct__datastructs_vars_1_f_0(StaticDeadNodes_51);
          {
            Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (Vars_64));
          }
          {
            Result0_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Result0_21, 0) = ((MR_Box) (Var_61));
          }
        }
      }
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word TypeCtorInfo__15_16;
        MR_Word Nodes1_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond_7, (MR_Integer) 0))));
        MR_Word LocalUse1_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond_7, (MR_Integer) 1))));
        MR_Word LocalSharing1_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond_7, (MR_Integer) 2))));
        MR_Word Nodes2_13;
        MR_Word LocalUse2_14;
        MR_Word LocalSharing2_15;

        succeeded = (Cond1_8 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Nodes2_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond1_8, (MR_Integer) 0))));
          LocalUse2_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond1_8, (MR_Integer) 1))));
          LocalSharing2_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cond1_8, (MR_Integer) 2))));
          TypeCtorInfo__15_16 = (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0);
          succeeded = mercury__set__subset_2_p_0(TypeCtorInfo__15_16, Nodes1_10, Nodes2_13);
          if (succeeded)
          {
            succeeded = transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_p_0(ModuleInfo_5, ProcInfo_6, LocalUse1_11, LocalUse2_14);
            if (succeeded)
              succeeded = transform_hlds__ctgc__structure_sharing__domain__sharing_as_is_subsumed_by_4_p_0(ModuleInfo_5, ProcInfo_6, LocalSharing1_12, LocalSharing2_15);
          }
        }
      }
      if (!(succeeded))
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__15_15 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_condition_0);
          {
          ...
          mercury__list__drop_while_3_p_0(TypeCtorInfo__15_15, Var_13, ReuseConditionsFirst_10, &NotSubsumed_12);
  ...
  MR_Word Cond2_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo__15_15 = (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0);
      succeeded = mercury__set__subset_2_p_0(TypeCtorInfo__15_15, Nodes1_9, Nodes2_12);
      if (succeeded)
      {
