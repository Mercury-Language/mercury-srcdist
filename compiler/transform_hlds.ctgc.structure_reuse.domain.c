    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_15_16 = (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0);
          succeeded = mercury__set__subset_2_p_0(TypeCtorInfo_15_16, Nodes1_10, Nodes2_13);
          if (succeeded)
          {
