...
{
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_18, (MR_Integer) 1)));
      {
      ...
      PrivateReuse_15 = transform_hlds__ctgc__structure_reuse__domain__from_structure_reuse_domain_1_f_0(PublicReuse_12);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_19, 1) = (MR_Box) (packed_args_0);
      }
...
{
  {
    ...
    MR_String Var_18;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReuseAs_Status1_7, (MR_Integer) 1)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReuseAs_Status2_8, (MR_Integer) 1)));
