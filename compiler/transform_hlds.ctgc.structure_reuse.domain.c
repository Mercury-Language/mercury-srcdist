  ...
  MR_Word * STATE_VARIABLE_ReuseTable_17)
{
  ...
  else
  {
    ...
    Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ReuseTable_0_16, (MR_Integer) 1))));
    {
      MR_Word base;
    ...
    else
    {
      ...
      else
      {
          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Result0_21, 0) = ((MR_Box) (Var_69));
              }
            }
          }
        }
        else
        {
          ...
          {
            Result0_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Result0_21, 0) = ((MR_Box) (Var_68));
          }
        }
      }
