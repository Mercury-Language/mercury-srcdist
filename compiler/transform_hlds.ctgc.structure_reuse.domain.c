...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Condition_3)) == (MR_Integer) 1);
    MR_Word DeadNodes_5;
    MR_Word LiveNodes_6;
    MR_Word SharingAs_7;
    MR_Word Var_8;
...
{
  {
    ...
    }
    {
      ...
      (env_ptr)->transform_hlds__ctgc__structure_reuse__domain__aliases_between_reuse_nodes_2_6_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->transform_hlds__ctgc__structure_reuse__domain__aliases_between_reuse_nodes_2_6_p_0_env_0__OtherNodes_11)) == (MR_Integer) 1);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) Cond1_8)) == (MR_Integer) 1);
        if (succeeded)
        {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ReuseCondition_3)) == (MR_Integer) 1);
    MR_Word ReuseAs_4;
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) Cond2_8)) == (MR_Integer) 1);
      if (succeeded)
      {
