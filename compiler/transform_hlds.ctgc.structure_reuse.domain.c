  ...
  MR_Word Table_10)
{
  ...
  switch (DoDump_8) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ReuseInfoMap_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Table_10, (MR_Integer) 0))));

        succeeded = mercury__map__is_empty_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_and_status_0), ReuseInfoMap_21);
        if (succeeded)
        ...
        else
        {
          ...
          mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% ReuseTable: PPId --> Reuse\n");
          {
            ...
            MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__domain_scalar_common_8[1]));
            MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_maybe_dump_6_p_0_1));
