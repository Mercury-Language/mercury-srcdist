...
{
  {
    ...
    MR_String PPIdStr_11;
    MR_String Var_20;

    PPIdStr_11 = hlds__hlds_out__hlds_out_util__pred_proc_id_to_string_2_f_0(ModuleInfo_6, PPId_7);
    Var_20 = transform_hlds__ctgc__structure_reuse__domain__reuse_as_short_description_1_f_0(ReuseAs_8);
    mercury__io__write_string_3_p_0((MR_String) "% ");
    mercury__io__write_string_3_p_0(PPIdStr_11);
    mercury__io__write_string_3_p_0((MR_String) "\t--> ");
