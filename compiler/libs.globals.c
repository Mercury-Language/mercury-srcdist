...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 237, &SinglePrecFloat_6);
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 1:
              {
                libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 229, ThreadsSupported_4);
              }
              break;
          }
        }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 266, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 229, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 231, &UseTrail_8);
