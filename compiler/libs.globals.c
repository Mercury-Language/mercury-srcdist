                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      mercury__builtin__compare_3_p_0((MR_Word) &libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_items_0, &Var_52, ((MR_Box) (ArgX9_20)), ((MR_Box) (ArgY9_21)));
                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                else
                                {
                                  ...
                                  mercury__builtin__compare_3_p_0((MR_Word) &libs__globals_scalar_common_1[3], &Var_58, ((MR_Box) (ArgX15_32)), ((MR_Box) (ArgY15_33)));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_48_48, ((MR_Box) (ArgX9_19)), ((MR_Box) (ArgY9_20)));
                      if (succeeded)
                      {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 354, &FromGroundTermThreshold_6);
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 267, &HighLevelCode_6);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 267, &HighLevel_5);
    switch (HighLevel_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 273, &LangStrs_5);
