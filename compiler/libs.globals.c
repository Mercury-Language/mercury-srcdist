          ...
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 0:
              *ThreadsSupported_4 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 260, ThreadsSupported_4);
              break;
          }
        }
        break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 304, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 260, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 262, &UseTrail_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 260, &Parallel_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 262, &UseTrail_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 236, &ProfileCalls_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 239, &ProfileDeep_12);
