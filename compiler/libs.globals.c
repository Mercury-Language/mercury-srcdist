  ...
  MR_Word Globals_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 678, &Allow_6);
{
  ...
  MR_Word * AnyIntermod_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 429, &IntermodOpt_5);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 436, &IntermodAnalysis_6);
  ...
  MR_Word * ForeignLangs_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 756, &LangStrs_5);
