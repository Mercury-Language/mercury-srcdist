...
MR_define_entry(mercury__libs__globals__globals_init_17_0);
	...
	MR_tfield(0, MR_tempr1, 13) = MR_r14;
	MR_tfield(0, MR_tempr1, 14) = MR_r15;
	MR_tfield(0, MR_tempr1, 15) = MR_r16;
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
