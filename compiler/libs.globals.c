...
#line 81 "libs.globals.c"
#line 82 "libs.globals.c"

#endif
#line 85 "libs.globals.c"
...
MR_decl_label8(libs__globals__convert_c_compiler_type_2_0, 4,5,7,155,10,18,24,26)
MR_decl_label8(libs__globals__convert_c_compiler_type_2_0, 31,33,39,38,30,23,11,1)
...
MR_decl_label2(libs__globals__globals_io_init_14_0, 3,4)
MR_decl_label1(libs__globals__initialise_mutable_globals_0_0, 2)
MR_decl_label3(libs__globals__io_get_any_intermod_3_0, 2,3,4)
MR_decl_label2(libs__globals__io_get_backend_foreign_languages_3_0, 2,3)
MR_decl_label1(libs__globals__io_get_c_compiler_type_3_0, 2)
...
MR_decl_label2(libs__globals__io_printing_usage_3_0, 2,4)
MR_decl_label2(libs__globals__io_set_gc_method_3_0, 2,4)
MR_decl_label1(libs__globals__io_set_globals_3_0, 2)
MR_decl_label3(libs__globals__io_set_option_4_0, 2,3,5)
MR_decl_label2(libs__globals__io_set_tags_method_3_0, 2,4)
MR_decl_label2(libs__globals__io_set_trace_level_3_0, 2,4)
...
MR_decl_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0, 3,2)
MR_decl_label5(__Unify___libs__globals__c_compiler_type_0_0, 6,8,10,19,1)
MR_decl_label8(__Unify___libs__globals__globals_0_0, 4,6,8,11,13,15,19,1)
MR_decl_label2(__Unify___libs__globals__il_version_number_0_0, 4,1)
MR_decl_label8(__Compare___libs__globals__c_compiler_type_0_0, 41,53,12,65,43,50,85,14)
MR_decl_label5(__Compare___libs__globals__c_compiler_type_0_0, 102,17,19,23,55)
MR_decl_label8(__Compare___libs__globals__globals_0_0, 3,2,5,9,13,17,21,25)
MR_decl_label8(__Compare___libs__globals__globals_0_0, 29,33,38,42,46,50,54,118)
...
MR_def_extern_entry(libs__globals__globals_init_13_0)
...
MR_def_extern_entry(libs__globals__get_feedback_info_2_0)
...
MR_def_extern_entry(libs__globals__set_feedback_info_3_0)
...
MR_def_extern_entry(libs__globals__io_set_solver_auto_init_supported_3_0)
MR_def_extern_entry(libs__globals__globals_io_init_14_0)
...
MR_def_extern_entry(libs__globals__io_get_c_compiler_type_3_0)
...
MR_def_extern_entry(libs__globals__io_get_any_intermod_3_0)
...
MR_decl_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0)
MR_decl_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__396__1_1_0)
...
{
MR_COMMON(3,0),
MR_ENTRY_AP(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__396__1_1_0),
0
},
{
MR_COMMON(5,0),
MR_ENTRY_AP(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0),
0
},
{
MR_COMMON(5,1),
...
const MR_PseudoTypeInfo mercury_data_libs__globals__field_types_globals_0_0[] = {
	...
	(MR_PseudoTypeInfo) &mercury_data_mdbcomp__feedback__type_ctor_info_feedback_info_0
};
...
MR_BEGIN_MODULE(libs__globals_module10)
	...
	MR_init_label8(libs__globals__convert_c_compiler_type_2_0,4,5,7,155,10,18,24,26)
	MR_init_label8(libs__globals__convert_c_compiler_type_2_0,31,33,39,38,30,23,11,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__globals_module11)
	MR_init_entry1(libs__globals__globals_init_13_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'globals_init'/13 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__globals_init_13_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_tfield(0, MR_tempr1, 11) = MR_r10;
	MR_tfield(0, MR_tempr1, 12) = MR_r11;
	MR_tfield(0, MR_tempr1, 13) = MR_r12;
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
/*-------------------------------------------------------------------------*/
/* code for 'get_source_file_map'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module27)
	MR_init_entry1(libs__globals__get_feedback_info_2_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'get_feedback_info'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__get_feedback_info_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
/*-------------------------------------------------------------------------*/
/* code for 'set_source_file_map'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module35)
	MR_init_entry1(libs__globals__set_feedback_info_3_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'set_feedback_info'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__set_feedback_info_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 14);
...
/*-------------------------------------------------------------------------*/
/* code for 'lock_globals'/0 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'unlock_globals'/0 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'unsafe_set_globals'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module52)
	MR_init_entry1(libs__globals__io_set_solver_auto_init_supported_3_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_set_solver_auto_init_supported'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__io_set_solver_auto_init_supported_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__libs__globals__io_set_solver_auto_init_supported_3_0
#undef	MR_PROC_LABEL
	}
	{
	MR_Word	X;
...
MR_BEGIN_MODULE(libs__globals_module53)
	MR_init_entry1(libs__globals__globals_io_init_14_0);
	MR_init_label2(libs__globals__globals_io_init_14_0,3,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'globals_io_init'/14 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__globals_io_init_14_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__globals_io_init_14_0_i3);
MR_def_label(libs__globals__globals_io_init_14_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__libs__globals__globals_io_init_14_0
#undef	MR_PROC_LABEL
	}
	{
	MR_Word	X;
...
#undef	MR_PROC_LABEL
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_r2 = MR_sv(1);
	MR_r3 = (MR_Integer) 264;
	MR_np_call_localret_ent(getopt_io__lookup_bool_option_3_0,
		libs__globals__globals_io_init_14_0_i4);
MR_def_label(libs__globals__globals_io_init_14_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__libs__globals__globals_io_init_14_0
#undef	MR_PROC_LABEL
...
/*-------------------------------------------------------------------------*/
/* code for 'unsafe_get_globals'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_target'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_backend_foreign_languages'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_foreign_language_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_gc_method'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_tags_method'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_termination_norm'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_termination2_norm'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_trace_level'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_trace_suppress'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_get_maybe_thread_safe'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module67)
	MR_init_entry1(libs__globals__io_get_c_compiler_type_3_0);
	MR_init_label1(libs__globals__io_get_c_compiler_type_3_0,2)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_get_c_compiler_type'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__io_get_c_compiler_type_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__io_get_globals_3_0,
		libs__globals__io_get_c_compiler_type_3_0_i2);
MR_def_label(libs__globals__io_get_c_compiler_type_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(0, MR_r1, 11);
	MR_decr_sp_and_return(1);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__globals_module72)
	MR_init_entry1(libs__globals__io_get_any_intermod_3_0);
	MR_init_label3(libs__globals__io_get_any_intermod_3_0,2,3,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_get_any_intermod'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__io_get_any_intermod_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__io_get_globals_3_0,
		libs__globals__io_get_any_intermod_3_0_i2);
MR_def_label(libs__globals__io_get_any_intermod_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r2 = (MR_Integer) 295;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		libs__globals__io_get_any_intermod_3_0_i3);
MR_def_label(libs__globals__io_get_any_intermod_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		libs__globals__io_get_any_intermod_3_0_i4);
MR_def_label(libs__globals__io_get_any_intermod_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(libs__globals_module75)
	...
	MR_init_label3(libs__globals__io_set_option_4_0,2,3,5)
MR_BEGIN_CODE
...
MR_def_label(libs__globals__io_set_option_4_0,3)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__io_set_option_4_0_i5);
MR_def_label(libs__globals__io_set_option_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(libs__globals_module76)
	...
	MR_init_label2(libs__globals__io_set_gc_method_3_0,2,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_set_gc_method'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__globals__io_set_gc_method_3_0,2)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__io_set_gc_method_3_0_i4);
MR_def_label(libs__globals__io_set_gc_method_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(libs__globals_module77)
	...
	MR_init_label2(libs__globals__io_set_tags_method_3_0,2,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_set_tags_method'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__globals__io_set_tags_method_3_0,2)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__io_set_tags_method_3_0_i4);
MR_def_label(libs__globals__io_set_tags_method_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(libs__globals_module78)
	...
	MR_init_label2(libs__globals__io_set_trace_level_3_0,2,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_set_trace_level'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__globals__io_set_trace_level_3_0,2)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__io_set_trace_level_3_0_i4);
MR_def_label(libs__globals__io_set_trace_level_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
/*-------------------------------------------------------------------------*/
/* code for 'io_set_trace_level_none'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_maybe_string_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module87)
	...
	MR_init_label2(libs__globals__io_printing_usage_3_0,2,4)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'io_printing_usage'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__globals__io_printing_usage_3_0,2)
	...
	MR_tfield(0, MR_tempr1, 12) = MR_ctfield(0, MR_tempr2, 12);
	MR_tfield(0, MR_tempr1, 13) = MR_ctfield(0, MR_tempr2, 13);
	MR_sv(1) = MR_ctfield(0, MR_tempr2, 9);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__globals, globals);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		libs__globals__io_printing_usage_3_0_i4);
MR_def_label(libs__globals__io_printing_usage_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
/*-------------------------------------------------------------------------*/
/* code for 'pre_initialise_mutable_globals'/0 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'initialise_mutable_globals'/0 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__globals_module95)
	...
	MR_init_label8(__Compare___libs__globals__c_compiler_type_0_0,41,53,12,65,43,50,85,14)
	MR_init_label5(__Compare___libs__globals__c_compiler_type_0_0,102,17,19,23,55)
MR_BEGIN_CODE
...
MR_decl_entry(__Unify___mdbcomp__feedback__feedback_info_0_0);

MR_BEGIN_MODULE(libs__globals_module102)
	MR_init_entry1(__Unify___libs__globals__globals_0_0);
	MR_init_label8(__Unify___libs__globals__globals_0_0,4,6,8,11,13,15,19,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___libs__globals__globals_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___libs__globals__globals_0_0_i19);
	}
	MR_incr_sp(27);
	...
	MR_sv(15) = MR_ctfield(0, MR_tempr2, 2);
	MR_sv(16) = MR_ctfield(0, MR_tempr2, 3);
	MR_sv(17) = MR_ctfield(0, MR_tempr2, 4);
	MR_sv(18) = MR_ctfield(0, MR_tempr2, 5);
	MR_sv(19) = MR_ctfield(0, MR_tempr2, 6);
	MR_sv(20) = MR_ctfield(0, MR_tempr2, 7);
	MR_sv(21) = MR_ctfield(0, MR_tempr2, 8);
	MR_sv(22) = MR_ctfield(0, MR_tempr2, 9);
	MR_sv(23) = MR_ctfield(0, MR_tempr2, 10);
	MR_sv(24) = MR_ctfield(0, MR_tempr2, 11);
	MR_sv(25) = MR_ctfield(0, MR_tempr2, 12);
	MR_sv(26) = MR_ctfield(0, MR_tempr2, 13);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt_io, option_data);
	MR_r3 = MR_ctfield(0, MR_tempr1, 0);
...
MR_def_label(__Unify___libs__globals__globals_0_0,8)
	...
	MR_r3 = MR_sv(21);
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
		__Unify___libs__globals__globals_0_0_i11);
MR_def_label(__Unify___libs__globals__globals_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___libs__globals__globals_0_0_i1);
	}
	...
	MR_np_call_localret_ent(__Unify___libs__globals__c_compiler_type_0_0,
		__Unify___libs__globals__globals_0_0_i13);
MR_def_label(__Unify___libs__globals__globals_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___libs__globals__globals_0_0_i1);
	}
	...
	MR_r3 = MR_sv(25);
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
		__Unify___libs__globals__globals_0_0_i15);
MR_def_label(__Unify___libs__globals__globals_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___libs__globals__globals_0_0_i1);
	}
	...
	MR_decr_sp(27);
	MR_np_tailcall_ent(__Unify___mdbcomp__feedback__feedback_info_0_0);
MR_def_label(__Unify___libs__globals__globals_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_decl_entry(__Compare___mdbcomp__feedback__feedback_info_0_0);
...
MR_BEGIN_MODULE(libs__globals_module103)
	...
	MR_init_label8(__Compare___libs__globals__globals_0_0,29,33,38,42,46,50,54,118)
MR_BEGIN_CODE
...
MR_def_label(__Compare___libs__globals__globals_0_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6;
	MR_tempr5 = MR_sv(2);
	MR_sv(26) = MR_ctfield(0, MR_tempr5, 13);
	MR_sv(25) = MR_ctfield(0, MR_tempr5, 12);
	MR_sv(24) = MR_ctfield(0, MR_tempr5, 11);
	MR_sv(23) = MR_ctfield(0, MR_tempr5, 10);
	MR_sv(22) = MR_ctfield(0, MR_tempr5, 9);
	MR_sv(21) = MR_ctfield(0, MR_tempr5, 8);
	MR_sv(20) = MR_ctfield(0, MR_tempr5, 7);
	MR_sv(19) = MR_ctfield(0, MR_tempr5, 6);
	MR_sv(18) = MR_ctfield(0, MR_tempr5, 5);
...
MR_def_label(__Compare___libs__globals__globals_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(14);
...
MR_def_label(__Compare___libs__globals__globals_0_0,33)
	...
	MR_r3 = MR_sv(21);
	MR_np_call_localret_ent(__Compare___maybe__maybe_1_0,
		__Compare___libs__globals__globals_0_0_i38);
MR_def_label(__Compare___libs__globals__globals_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	...
	MR_r2 = MR_sv(22);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___libs__globals__globals_0_0_i42);
MR_def_label(__Compare___libs__globals__globals_0_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	...
	MR_r2 = MR_sv(23);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___libs__globals__globals_0_0_i46);
MR_def_label(__Compare___libs__globals__globals_0_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	...
	MR_np_call_localret_ent(__Compare___libs__globals__c_compiler_type_0_0,
		__Compare___libs__globals__globals_0_0_i50);
MR_def_label(__Compare___libs__globals__globals_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	...
	MR_r3 = MR_sv(25);
	MR_np_call_localret_ent(__Compare___maybe__maybe_1_0,
		__Compare___libs__globals__globals_0_0_i54);
MR_def_label(__Compare___libs__globals__globals_0_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i118);
	}
	...
	MR_succip_word = MR_sv(27);
	MR_decr_sp(27);
	MR_np_tailcall_ent(__Compare___mdbcomp__feedback__feedback_info_0_0);
MR_def_label(__Compare___libs__globals__globals_0_0,118)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(27);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__globals_module114)
	MR_init_entry1(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0);
	MR_init_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0,3,2)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__get_backend_foreign_languages__555__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__convert_foreign_language_2_0,
		fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0_i3);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__555__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("globals.m", 9);
...
MR_BEGIN_MODULE(libs__globals_module115)
	MR_init_entry1(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__396__1_1_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_c_compiler_type_with_version__396__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__396__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
