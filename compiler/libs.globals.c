...
MR_decl_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0, 3,2)
...
MR_decl_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0)
MR_decl_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1_1_0)
...
{
MR_COMMON(2,0),
MR_ENTRY_AP(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1_1_0),
0
},
{
MR_COMMON(4,0),
MR_ENTRY_AP(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(libs__globals_module122)
	MR_init_entry1(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0);
	MR_init_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__get_backend_foreign_languages__595__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__convert_foreign_language_2_0,
		fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0_i3);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__595__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("libs.globals", 12);
...
MR_BEGIN_MODULE(libs__globals_module123)
	MR_init_entry1(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__407__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
