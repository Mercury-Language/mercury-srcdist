...
libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__540__1_2_p_0(
...
{
  {
    ...
    succeeded = libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__540__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
