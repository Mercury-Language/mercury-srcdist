...
MR_decl_label6(libs__globals__current_grade_supports_concurrency_2_0, 19,4,20,13,6,11)
...
MR_decl_label2(libs__globals__globals_io_init_11_0, 10,11)
...
MR_decl_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0, 3,2)
...
MR_decl_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0)
...
{
MR_COMMON(2,0),
MR_ENTRY_AP(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0),
0
},
{
MR_COMMON(2,1),
...
MR_BEGIN_MODULE(libs__globals_module41)
	...
	MR_init_label6(libs__globals__current_grade_supports_concurrency_2_0,19,4,20,13,6,11)
MR_BEGIN_CODE
...
MR_define_entry(mercury__libs__globals__current_grade_supports_concurrency_2_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r2,
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i19) MR_AND
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i20) MR_AND
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i11) MR_AND
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i11) MR_AND
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i11) MR_AND
		MR_LABEL_AP(libs__globals__current_grade_supports_concurrency_2_0_i20));
MR_def_label(libs__globals__current_grade_supports_concurrency_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(libs__globals__current_grade_supports_concurrency_2_0,4)
	...
	MR_GOTO_LAB(libs__globals__current_grade_supports_concurrency_2_0_i13);
MR_def_label(libs__globals__current_grade_supports_concurrency_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
MR_def_label(libs__globals__current_grade_supports_concurrency_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(2);
...
MR_def_label(libs__globals__current_grade_supports_concurrency_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__globals_module50)
	...
	MR_init_label2(libs__globals__globals_io_init_11_0,10,11)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_r2 = MR_sv(1);
	MR_r3 = (MR_Integer) 242;
	MR_np_call_localret_ent(getopt_io__lookup_bool_option_3_0,
		libs__globals__globals_io_init_11_0_i11);
MR_def_label(libs__globals__globals_io_init_11_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
#define	MR_PROC_LABEL	mercury__libs__globals__globals_io_init_11_0
#undef	MR_PROC_LABEL
...
MR_BEGIN_MODULE(libs__globals_module105)
	MR_init_entry1(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0);
	MR_init_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0,3,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__convert_foreign_language_2_0,
		fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0_i3);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__433__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("globals.m", 9);
