    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 624, &Suffix_18);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 623, &Suffix_18);
        succeeded = (strcmp(Suffix_18, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
  ...
  MR_Word Globals_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 652, &Allow_6);
{
  ...
  MR_Word * AnyIntermod_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 403, &IntermodOpt_5);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 410, &IntermodAnalysis_6);
