  ...
  MR_Word * ForeignLang_4)
{
  ...
  do
  {
    ...
    result_3 = MR_strcmp(Var_10, ((&libs__globals_vector_common_5[5 + mid_2]))->libs__globals__vector_common_type_5_0__vct_5_f_0);
...
#undef MR_PROC_LABEL
  ...
  switch (MR_tag((MR_Word) ErrorStream_4)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Stream_40 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ErrorStream_4, (MR_Integer) 0))));

        mercury__io__close_output_3_p_0(Stream_40);
      }
      break;
  }
  switch (MR_tag((MR_Word) ProgresStream_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Stream_46 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ProgresStream_5, (MR_Integer) 0))));
  ...
  switch (MR_tag((MR_Word) InferenceStream_6)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Stream_52 = ((MR_Word) ((MR_hl_field(MR_mktag(2), InferenceStream_6, (MR_Integer) 0))));
  ...
  switch (MR_tag((MR_Word) DebugStream_7)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Stream_58 = ((MR_Word) ((MR_hl_field(MR_mktag(2), DebugStream_7, (MR_Integer) 0))));

        mercury__io__close_output_3_p_0(Stream_58);
      }
      break;
  }
  switch (MR_tag((MR_Word) RecompileStream_8)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Stream_64 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RecompileStream_8, (MR_Integer) 0))));

        mercury__io__close_output_3_p_0(Stream_64);
      }
      break;
  }
}
...
#undef MR_PROC_LABEL
  ...
  switch (MR_tag((MR_Word) CompilerStream0_26)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_String Suffix_27;
        MR_Word CompilerStream_29;

        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 150, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
          {
            CompilerStream_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CompilerStream_29, 0) = ((MR_Box) (*Stream_8));
          }
        }
        else
        {
          ...
          Var_36 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_7);
          Var_37 = mercury__string__f_43_43_2_f_0((MR_String) ".", Suffix_27);
          FileName_30 = mercury__string__f_43_43_2_f_0(Var_36, Var_37);
          mercury__io__open_output_4_p_0(FileName_30, &OpenResult_31);
          if (((MR_tag((MR_Word) OpenResult_31)) == (MR_Integer) 1))
          {
            MR_Word Error_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_31, (MR_Integer) 0))));
            ...
            mercury__io__write_string_4_p_0(*Stream_8, FileName_30);
            mercury__io__write_string_4_p_0(*Stream_8, (MR_String) "\' for output: ");
            mercury__io__write_string_4_p_0(*Stream_8, ErrorMsg_33);
          ...
          {
            *Stream_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_31, (MR_Integer) 0))));
            {
              CompilerStream_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), CompilerStream_29, 0) = ((MR_Box) (*Stream_8));
            }
          }
        }
{
...
#undef MR_PROC_LABEL
      ...
      break;
    case (MR_Integer) 1:
      *Stream_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CompilerStream0_26, (MR_Integer) 0))));
      break;
    case (MR_Integer) 2:
      *Stream_8 = ((MR_Word) ((MR_hl_field(MR_mktag(2), CompilerStream0_26, (MR_Integer) 0))));
      break;
  }
}
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 149, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 148, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 147, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 146, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
  ...
  MR_Word * STATE_VARIABLE_Globals_11)
{
  ...
  Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 1))));
  Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 2))));
  Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 3))));
  Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 4))));
  Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 5))));
  Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 6))));
  Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 7))));
  Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_10, (MR_Integer) 8))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = mercury__string__to_int_2_p_0(Major_14, &Major_40);
        if (succeeded)
        {
          Var_46 = (MR_Integer) 2;
          succeeded = (Major_40 >= Var_46);
        }
        if (succeeded)
        {
          succeeded = (strcmp(Minor_15, (MR_String) "u") == 0);
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (Major_40));
            }
            {
              MR_Word base;
          ...
          else
          {
            ...
            succeeded = mercury__string__to_int_2_p_0(Minor_15, &Minor_41);
            if (succeeded)
            {
              Var_50 = (MR_Integer) 0;
              succeeded = (Minor_41 >= Var_50);
            }
            if (succeeded)
            {
              succeeded = (strcmp(Patch_16, (MR_String) "u") == 0);
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (Major_40));
                }
                {
                  Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (Minor_41));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
                ...
                succeeded = mercury__string__to_int_2_p_0(Patch_16, &Patch_42);
                if (succeeded)
                {
                  Var_54 = (MR_Integer) 0;
                  succeeded = (Patch_42 >= Var_54);
                }
                if (succeeded)
                {
                  MR_Word Var_55;
                  ...
                  }
                  {
                    ...
                    *C_CompilerType_4 = base;
                    ...
                    MR_hl_field(MR_mktag(1), base, 2) = ((MR_Box) (Var_57));
                  }
                  succeeded = MR_TRUE;
                }
                else
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__string__to_int_2_p_0(Major_33, &Major_62);
        if (succeeded)
        {
          succeeded = mercury__string__to_int_2_p_0(Minor_34, &Minor_63);
          if (succeeded)
          {
            succeeded = mercury__string__to_int_2_p_0(Patch_35, &Patch_64);
            if (succeeded)
            {
              Var_66 = (MR_Integer) 0;
                  ...
                  {
                    {
                      ...
                      MR_hl_field(MR_mktag(0), ClangVersion_65, 0) = ((MR_Box) (Major_62));
                      MR_hl_field(MR_mktag(0), ClangVersion_65, 1) = ((MR_Box) (Minor_63));
                      MR_hl_field(MR_mktag(0), ClangVersion_65, 2) = ((MR_Box) (Patch_64));
                    }
                    {
                      Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (ClangVersion_65));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      *C_CompilerType_4 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Var_69));
                    }
                    succeeded = MR_TRUE;
                  }
                }
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer Version_72;
          MR_Integer Var_73;
          MR_Word Var_74;

          succeeded = mercury__string__to_int_2_p_0(Version_17, &Version_72);
          if (succeeded)
          {
            Var_73 = (MR_Integer) 0;
            succeeded = (Version_72 > Var_73);
            if (succeeded)
            {
              {
                Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (Version_72));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *C_CompilerType_4 = base;
                MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (Var_74));
              }
              succeeded = MR_TRUE;
            }
          }
