...
static const MR_PseudoTypeInfo libs__globals__libs__globals__field_types_c_compiler_type_0_4[1];

static const MR_DuFunctorDesc libs__globals__libs__globals__du_functor_desc_c_compiler_type_0_4;

static const MR_DuFunctorDesc libs__globals__libs__globals__du_functor_desc_c_compiler_type_0_5;
...
static const MR_DuFunctorDescPtr libs__globals__libs__globals__du_stag_ordered_c_compiler_type_0_3[3];

static const MR_DuPtagLayout libs__globals__libs__globals__du_ptag_ordered_c_compiler_type_0[4];

static const MR_DuFunctorDescPtr libs__globals__libs__globals__du_name_ordered_c_compiler_type_0[6];

static const MR_Integer libs__globals__libs__globals__functor_number_map_c_compiler_type_0[6];
...
libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__693__1_2_p_0(
  MR_Char HeadVar__1_11,
  MR_Char HeadVar__2_45);
...
static /* final */ const MR_Box libs__globals_scalar_common_1[16][2];
...
static /* final */ const struct libs__globals__vector_common_type_8_0_s libs__globals_vector_common_8[7] = {
  ...
  /* row   3 */
  {
    (MR_String) "msvc_arm64",
    (MR_Word) (MR_mkword(3, &libs__globals_scalar_common_1[14]))
  },
  /* row   4 */
  {
    (MR_String) "msvc_x64",
    (MR_Word) (MR_mkword(3, &libs__globals_scalar_common_1[15]))
  },
  /* row   5 */
  {
    (MR_String) "msvc_x86",
...
static const MR_PseudoTypeInfo libs__globals__libs__globals__field_types_c_compiler_type_0_4[1] = { (MR_PseudoTypeInfo) (&libs__globals__maybe__ti_maybe_1builtin__type_ctor_info_int_0) };

static const MR_DuFunctorDesc libs__globals__libs__globals__du_functor_desc_c_compiler_type_0_4 = {
  (MR_String) "cc_cl_arm64",
  INT16_C(1),
  UINT16_C(0),
  MR_SECTAG_REMOTE_FULL_WORD,
  UINT8_C(3),
  (MR_Integer) 2,
  INT32_C(4),
  libs__globals__libs__globals__field_types_c_compiler_type_0_4,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr libs__globals__libs__globals__du_stag_ordered_c_compiler_type_0_0[1] = { &libs__globals__libs__globals__du_functor_desc_c_compiler_type_0_5 };
...
static const MR_DuFunctorDescPtr libs__globals__libs__globals__du_name_ordered_c_compiler_type_0[6] = {
  ...
  &libs__globals__libs__globals__du_functor_desc_c_compiler_type_0_5
};
...
libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__693__1_2_p_0(
  ...
  MR_Char HeadVar__2_45)
{
  MR_bool succeeded = (HeadVar__1_11 == HeadVar__2_45);
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      mercury__builtin__compare_3_p_0((MR_Word) (&libs__globals_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (ArgX1_18)), ((MR_Box) (ArgY1_19)));
                    }
                    break;
                }
                break;
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_24_24 = (MR_Word) (&libs__globals_scalar_common_1[3]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_24_24, ((MR_Box) (ArgX1_9)), ((MR_Box) (ArgY1_10)));
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_23_23, ((MR_Box) (ArgX1_11)), ((MR_Box) (ArgY1_12)));
              }
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 651, &Suffix_18);
        ...
        else
        {
          ...
          Var_26 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_7);
          Var_27 = mercury__string__f_43_43_2_f_0((MR_String) ".", Suffix_18);
          FileName_21 = mercury__string__f_43_43_2_f_0(Var_26, Var_27);
          mercury__io__open_output_4_p_0(FileName_21, &OpenResult_22);
          if (((MR_tag((MR_Word) OpenResult_22)) == (MR_Integer) 1))
          {
            MR_Word IOError_23 = ((MR_Word) ((MR_hl_field(1, OpenResult_22, 0))));

            mercury__io__stderr_stream_3_p_0(Stream_8);
            libs__file_util__report_cannot_open_file_for_input_6_p_0(*Stream_8, Globals_6, FileName_21, IOError_23);
            {
              CompilerStream_20 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, CompilerStream_20, 0) = ((MR_Box) (*Stream_8));
            }
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 650, &Suffix_18);
        succeeded = (strcmp(Suffix_18, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 649, &Suffix_18);
        succeeded = (strcmp(Suffix_18, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
  ...
  MR_Word Globals_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 679, &Allow_6);
{
  ...
  MR_Word * AnyIntermod_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 430, &IntermodOpt_5);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 437, &IntermodAnalysis_6);
  ...
  MR_Word * ForeignLangs_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 757, &LangStrs_5);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__693__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
...
label_0:;
  ...
  else
  {
    ...
    Tokens_14 = mercury__string__words_separator_2_f_0((MR_Word) (&libs__globals_scalar_common_10[0]), CC_Str_3);
    succeeded = (Tokens_14 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Var_21 = ((MR_String) ((MR_hl_field(1, Tokens_14, 0))));
      Var_22 = ((MR_Word) ((MR_hl_field(1, Tokens_14, 1))));
      succeeded = (strcmp(Var_21, (MR_String) "gcc") == 0);
      if (succeeded)
      {
        succeeded = (Var_22 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Major_15 = ((MR_String) ((MR_hl_field(1, Var_22, 0))));
          Var_23 = ((MR_Word) ((MR_hl_field(1, Var_22, 1))));
          succeeded = (Var_23 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Minor_16 = ((MR_String) ((MR_hl_field(1, Var_23, 0))));
            Var_24 = ((MR_Word) ((MR_hl_field(1, Var_23, 1))));
            succeeded = (Var_24 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Patch_17 = ((MR_String) ((MR_hl_field(1, Var_24, 0))));
    ...
    if (succeeded)
    {
      succeeded = (strcmp(Major_15, (MR_String) "u") == 0);
      if (succeeded)
      {
        succeeded = (strcmp(Minor_16, (MR_String) "u") == 0);
        if (succeeded)
          succeeded = (strcmp(Patch_17, (MR_String) "u") == 0);
      }
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = mercury__string__to_int_2_p_0(Major_15, &Major_51);
        if (succeeded)
        {
          Var_57 = (MR_Integer) 2;
          succeeded = (Major_51 >= Var_57);
        }
        if (succeeded)
        {
          succeeded = (strcmp(Minor_16, (MR_String) "u") == 0);
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(1, Var_58, 0) = ((MR_Box) (Major_51));
            }
            {
              MR_Word base;
          ...
          else
          {
            ...
            succeeded = mercury__string__to_int_2_p_0(Minor_16, &Minor_52);
            if (succeeded)
            {
              Var_61 = (MR_Integer) 0;
              succeeded = (Minor_52 >= Var_61);
            }
            if (succeeded)
            {
              succeeded = (strcmp(Patch_17, (MR_String) "u") == 0);
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(1, Var_62, 0) = ((MR_Box) (Major_51));
                }
                {
                  Var_63 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_63, 0) = ((MR_Box) (Minor_52));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
                ...
                succeeded = mercury__string__to_int_2_p_0(Patch_17, &Patch_53);
                if (succeeded)
                {
                  Var_65 = (MR_Integer) 0;
                  succeeded = (Patch_53 >= Var_65);
                }
                if (succeeded)
                {
                  MR_Word Var_66;
                  ...
                  }
                  {
                    ...
                    *C_CompilerType_4 = base;
                    ...
                    MR_hl_field(1, base, 2) = ((MR_Box) (Var_68));
                  }
                  succeeded = MR_TRUE;
                }
                else
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_26 = ((MR_String) ((MR_hl_field(1, Tokens_14, 0))));
        Var_27 = ((MR_Word) ((MR_hl_field(1, Tokens_14, 1))));
        succeeded = (strcmp(Var_26, (MR_String) "clang") == 0);
        if (succeeded)
        {
          succeeded = (Var_27 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Major_44 = ((MR_String) ((MR_hl_field(1, Var_27, 0))));
            Var_28 = ((MR_Word) ((MR_hl_field(1, Var_27, 1))));
            succeeded = (Var_28 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Minor_45 = ((MR_String) ((MR_hl_field(1, Var_28, 0))));
              Var_29 = ((MR_Word) ((MR_hl_field(1, Var_28, 1))));
              succeeded = (Var_29 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                Patch_46 = ((MR_String) ((MR_hl_field(1, Var_29, 0))));
      ...
      if (succeeded)
      {
        ...
        MR_Integer Minor_70;
        MR_Integer Patch_71;
        MR_Word ClangVersion_72;
        MR_Integer Var_73;
        MR_Integer Var_74;
        MR_Integer Var_75;
        MR_Word Var_76;

        succeeded = mercury__string__to_int_2_p_0(Major_44, &Major_69);
        if (succeeded)
        {
          succeeded = mercury__string__to_int_2_p_0(Minor_45, &Minor_70);
          if (succeeded)
          {
            succeeded = mercury__string__to_int_2_p_0(Patch_46, &Patch_71);
            if (succeeded)
            {
              Var_73 = (MR_Integer) 0;
              succeeded = (Major_69 >= Var_73);
              if (succeeded)
              {
                Var_74 = (MR_Integer) 0;
                succeeded = (Minor_70 >= Var_74);
                if (succeeded)
                {
                  Var_75 = (MR_Integer) 0;
                  succeeded = (Patch_71 >= Var_75);
                  if (succeeded)
                  {
                    {
                      ClangVersion_72 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(0, ClangVersion_72, 0) = ((MR_Box) (Major_69));
                      MR_hl_field(0, ClangVersion_72, 1) = ((MR_Box) (Minor_70));
                      MR_hl_field(0, ClangVersion_72, 2) = ((MR_Box) (Patch_71));
                    }
                    {
                      Var_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_76, 0) = ((MR_Box) (ClangVersion_72));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      *C_CompilerType_4 = base;
                      MR_hl_field(2, base, 0) = ((MR_Box) (Var_76));
                    }
                    succeeded = MR_TRUE;
                  }
                }
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_48 = ((MR_String) ((MR_hl_field(1, Tokens_14, 0))));
          Var_47 = ((MR_Word) ((MR_hl_field(1, Tokens_14, 1))));
          succeeded = (strcmp(Var_48, (MR_String) "msvc") == 0);
          if (succeeded)
          {
            succeeded = (Var_47 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_50 = ((MR_String) ((MR_hl_field(1, Var_47, 0))));
              Var_49 = ((MR_Word) ((MR_hl_field(1, Var_47, 1))));
              ...
              else
              {
                ...
                succeeded = (strcmp(Var_50, (MR_String) "x86") == 0);
                if (succeeded)
                {
                  Version_18 = ((MR_String) ((MR_hl_field(1, Var_49, 0))));
                  Var_31 = ((MR_Word) ((MR_hl_field(1, Var_49, 1))));
        ...
        if (succeeded)
        {
          MR_Integer Version_77;
          MR_Integer Var_78;
          MR_Word Var_79;

          succeeded = mercury__string__to_int_2_p_0(Version_18, &Version_77);
          if (succeeded)
          {
            Var_78 = (MR_Integer) 0;
            succeeded = (Version_77 > Var_78);
            if (succeeded)
            {
              {
                Var_79 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_79, 0) = ((MR_Box) (Version_77));
              }
              {
                MR_Word base;
                ...
                *C_CompilerType_4 = base;
                ...
                MR_hl_field(3, base, 1) = ((MR_Box) (Var_79));
              }
              succeeded = MR_TRUE;
            }
          }
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_32 = ((MR_String) ((MR_hl_field(1, Tokens_14, 0))));
            Var_33 = ((MR_Word) ((MR_hl_field(1, Tokens_14, 1))));
            succeeded = (strcmp(Var_32, (MR_String) "msvc") == 0);
            if (succeeded)
            {
              succeeded = (Var_33 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                Var_34 = ((MR_String) ((MR_hl_field(1, Var_33, 0))));
                Var_35 = ((MR_Word) ((MR_hl_field(1, Var_33, 1))));
                succeeded = (strcmp(Var_34, (MR_String) "x64") == 0);
                if (succeeded)
                {
                  succeeded = (Var_35 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    Version_43 = ((MR_String) ((MR_hl_field(1, Var_35, 0))));
          ...
          if (succeeded)
          {
            MR_Integer Version_80;
            MR_Integer Var_81;
            MR_Word Var_82;

            succeeded = mercury__string__to_int_2_p_0(Version_43, &Version_80);
            if (succeeded)
            {
              Var_81 = (MR_Integer) 0;
              succeeded = (Version_80 > Var_81);
              if (succeeded)
              {
                {
                  Var_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_82, 0) = ((MR_Box) (Version_80));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if (succeeded)
            {
              Var_37 = ((MR_String) ((MR_hl_field(1, Tokens_14, 0))));
              Var_38 = ((MR_Word) ((MR_hl_field(1, Tokens_14, 1))));
              succeeded = (strcmp(Var_37, (MR_String) "msvc") == 0);
              if (succeeded)
              {
                succeeded = (Var_38 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Var_39 = ((MR_String) ((MR_hl_field(1, Var_38, 0))));
                  Var_40 = ((MR_Word) ((MR_hl_field(1, Var_38, 1))));
                  succeeded = (strcmp(Var_39, (MR_String) "arm64") == 0);
                  if (succeeded)
                  {
                    succeeded = (Var_40 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      Version_42 = ((MR_String) ((MR_hl_field(1, Var_40, 0))));
            ...
            if (succeeded)
            {
              MR_Integer Version_83;
              MR_Integer Var_84;
              MR_Word Var_85;

              succeeded = mercury__string__to_int_2_p_0(Version_42, &Version_83);
              if (succeeded)
              {
                Var_84 = (MR_Integer) 0;
                succeeded = (Version_83 > Var_84);
                if (succeeded)
                {
                  {
                    Var_85 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_85, 0) = ((MR_Box) (Version_83));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *C_CompilerType_4 = base;
                    ...
                    MR_hl_field(3, base, 1) = ((MR_Box) (Var_85));
                  }
                  succeeded = MR_TRUE;
                }
              }
