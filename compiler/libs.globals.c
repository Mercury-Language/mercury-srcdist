...
static MR_bool MR_CALL 
libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__457__1_2_p_0(
...
{
  {
    ...
    {
      libs__globals__succeeded = libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__457__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(0), libs__globals__closure, (MR_Integer) 3))), ((MR_Char) (MR_Word) libs__globals__wrapper_arg_1));
    }
    return libs__globals__succeeded;
  }
}
