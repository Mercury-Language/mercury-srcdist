      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 141, &Suffix_34);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 140, &Suffix_34);
          succeeded = (strcmp(Suffix_34, (MR_String) "") == 0);
          if (succeeded)
          {
            mercury__io__stderr_stream_3_p_0(Stream_8);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 275, &TargetWordBits_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 262, &SinglePrecFloat_6);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &IntermodOpt_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 495, &IntermodAnalysis_6);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 298, &HighLevelCode_6);
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 0:
              *ThreadsSupported_4 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 254, ThreadsSupported_4);
              break;
          }
        }
        break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 298, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 254, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 256, &UseTrail_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 254, &Parallel_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 256, &UseTrail_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 230, &ProfileCalls_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 233, &ProfileDeep_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 298, &HighLevel_5);
    switch (HighLevel_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 303, &LangStrs_5);
