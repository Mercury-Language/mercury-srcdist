...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 372, &FromGroundTermThreshold_6);
    {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 262, &TargetWordBits_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 248, &SinglePrecFloat_6);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 284, &HighLevelCode_6);
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 0:
              *ThreadsSupported_4 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 240, ThreadsSupported_4);
              break;
          }
        }
        break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 284, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 240, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 242, &UseTrail_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 284, &HighLevel_5);
    switch (HighLevel_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 290, &LangStrs_5);
