    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 145, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 144, &Suffix_27);
        succeeded = (strcmp(Suffix_27, (MR_String) "") == 0);
        if (succeeded)
        {
          mercury__io__stderr_stream_3_p_0(Stream_8);
