...
MR_decl_label8(__Compare___libs__globals__globals_0_0, 37,41,45,49,53,57,61,133)
...
MR_BEGIN_MODULE(libs__globals_module113)
	...
	MR_init_label8(__Compare___libs__globals__globals_0_0,37,41,45,49,53,57,61,133)
MR_BEGIN_CODE
...
MR_def_label(__Compare___libs__globals__globals_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i133);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(16);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___libs__globals__globals_0_0,61)
	...
	MR_decr_sp(31);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___libs__globals__globals_0_0,133)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(31);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
