    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 625, &Suffix_18);
  ...
  MR_Word Globals_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 653, &Allow_6);
{
  ...
  MR_Word * AnyIntermod_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 404, &IntermodOpt_5);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 411, &IntermodAnalysis_6);
  ...
  MR_Word * ForeignLangs_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 728, &LangStrs_5);
