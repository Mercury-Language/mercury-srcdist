      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 147, &Suffix_34);
          ...
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 0:
              *ThreadsSupported_4 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 258, ThreadsSupported_4);
              break;
          }
        }
        break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 302, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 258, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 260, &UseTrail_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 258, &Parallel_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 260, &UseTrail_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 234, &ProfileCalls_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 237, &ProfileDeep_12);
