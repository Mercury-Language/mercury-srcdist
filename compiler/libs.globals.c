  ...
  MR_Word * FloatDwords_4)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 95, &TargetWordBits_5);
  ...
  MR_Word * AnyIntermod_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 312, &IntermodOpt_5);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 317, &IntermodAnalysis_6);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 117, &HighLevelCode_6);
  ...
  MR_Word Globals_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 117, &HighLevel_5);
  switch (HighLevel_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
