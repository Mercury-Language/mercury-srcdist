...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 371, &FromGroundTermThreshold_6);
    {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 261, &TargetWordBits_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 247, &SinglePrecFloat_6);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 283, &HighLevelCode_6);
          switch (HighLevelCode_6) {
            ...
            case (MR_Integer) 0:
              *ThreadsSupported_4 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 239, ThreadsSupported_4);
              break;
          }
        }
        break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 283, &HighLevelCode_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 239, &Parallel_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 241, &UseTrail_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 283, &HighLevel_5);
    switch (HighLevel_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 289, &LangStrs_5);
