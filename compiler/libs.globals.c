  ...
  MR_Word * STATE_VARIABLE_Map_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = Options_13;
        MR_Word next_value_of_STATE_VARIABLE_RevBadOptions_0_2 = STATE_VARIABLE_RevBadOptions_32_32;
        MR_Word next_value_of_STATE_VARIABLE_Map_0_4 = STATE_VARIABLE_Map_31_31;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = RevChars_9;
          MR_Word next_value_of_STATE_VARIABLE_LineRangeChars_0_2 = STATE_VARIABLE_LineRangeChars_14_14;
