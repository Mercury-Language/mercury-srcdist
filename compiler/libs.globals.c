...
MR_decl_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0, 3,2)
...
MR_decl_label8(__Compare___libs__globals__globals_0_0, 37,41,45,49,53,57,61,181)
...
MR_def_extern_entry(libs__globals__globals_init_17_0)
...
MR_decl_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0)
MR_decl_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1_1_0)
...
{
MR_COMMON(3,0),
MR_ENTRY_AP(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1_1_0),
0
},
{
MR_COMMON(5,0),
MR_ENTRY_AP(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(libs__globals_module14)
	MR_init_entry1(libs__globals__globals_init_17_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__globals__globals_init_17_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'globals_init'/17 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__globals__globals_init_17_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_tfield(0, MR_tempr1, 8) = MR_r14;
	MR_tfield(0, MR_tempr1, 9) = ((MR_Integer) MR_r15 | ((MR_Integer) MR_r16 << (MR_Integer) 2));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__libs__globals__set_options_3_0);
	...
	MR_tfield(0, MR_tempr9, 8) = MR_tfield(0, MR_r2, 8);
	MR_tfield(0, MR_tempr9, 9) = ((MR_Integer) MR_tempr3 | ((MR_Integer) MR_tempr2 << (MR_Integer) 2));
	MR_r1 = MR_tempr9;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__globals__set_option_4_0,2)
	...
	MR_tempr1 = (((MR_Integer) MR_tfield(0, MR_tempr9, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_tempr2 = ((MR_Integer) MR_tfield(0, MR_tempr9, 9) & (MR_Integer) 3);
	...
	MR_tag_alloc_heap(MR_tempr8, 0, (MR_Integer) 10);
	...
	MR_tfield(0, MR_tempr8, 9) = ((MR_Integer) MR_tempr2 | ((MR_Integer) MR_tempr1 << (MR_Integer) 2));
	MR_r1 = MR_tempr8;
...
MR_define_entry(mercury__libs__globals__set_gc_method_3_0);
	...
	MR_tfield(0, MR_tempr8, 9) = ((MR_Integer) MR_tempr3 | ((MR_Integer) MR_tempr2 << (MR_Integer) 2));
	MR_r1 = MR_tempr8;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__libs__globals__set_trace_level_3_0);
	...
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6, MR_tempr7, MR_tempr8;
	MR_tempr1 = (((MR_Integer) MR_tfield(0, MR_r2, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_tempr2 = ((MR_Integer) MR_tfield(0, MR_r2, 9) & (MR_Integer) 3);
...
MR_def_label(libs__globals__set_trace_level_none_2_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6, MR_tempr7, MR_tempr8;
	MR_tempr8 = MR_sv(1);
	MR_r2 = (((MR_Integer) MR_tfield(0, MR_tempr8, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_tempr1 = ((MR_Integer) MR_tfield(0, MR_tempr8, 9) & (MR_Integer) 3);
	...
	MR_tag_alloc_heap(MR_tempr7, 0, (MR_Integer) 10);
	...
	MR_tfield(0, MR_tempr7, 9) = ((MR_Integer) MR_tempr1 | ((MR_Integer) MR_r2 << (MR_Integer) 2));
	MR_r1 = MR_tempr7;
	MR_decr_sp_and_return(2);
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury____Unify___libs__globals__globals_0_0);
	...
	MR_sv(14) = ((MR_Integer) MR_tfield(0, MR_tempr1, 9) & (MR_Integer) 3);
	MR_sv(15) = (((MR_Integer) MR_tfield(0, MR_tempr1, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_sv(16) = ((MR_Integer) MR_tfield(0, MR_tempr2, 1) & (MR_Integer) 7);
	MR_sv(17) = (((MR_Integer) MR_tfield(0, MR_tempr2, 1) >> (MR_Integer) 3) & (MR_Integer) 7);
	MR_sv(18) = (((MR_Integer) MR_tfield(0, MR_tempr2, 1) >> (MR_Integer) 6) & (MR_Integer) 3);
	MR_sv(19) = (((MR_Integer) MR_tfield(0, MR_tempr2, 1) >> (MR_Integer) 8) & (MR_Integer) 3);
	MR_sv(20) = (((MR_Integer) MR_tfield(0, MR_tempr2, 1) >> (MR_Integer) 10) & (MR_Integer) 3);
	MR_sv(21) = (((MR_Integer) MR_tfield(0, MR_tempr2, 1) >> (MR_Integer) 12) & (MR_Integer) 7);
	MR_sv(22) = MR_tfield(0, MR_tempr2, 2);
	MR_sv(23) = MR_tfield(0, MR_tempr2, 3);
	MR_sv(24) = MR_tfield(0, MR_tempr2, 4);
	MR_sv(25) = MR_tfield(0, MR_tempr2, 5);
	MR_sv(26) = MR_tfield(0, MR_tempr2, 6);
	MR_sv(27) = MR_tfield(0, MR_tempr2, 7);
	MR_sv(28) = MR_tfield(0, MR_tempr2, 8);
	MR_sv(29) = ((MR_Integer) MR_tfield(0, MR_tempr2, 9) & (MR_Integer) 3);
	MR_sv(30) = (((MR_Integer) MR_tfield(0, MR_tempr2, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
...
MR_BEGIN_MODULE(libs__globals_module113)
	...
	MR_init_label8(__Compare___libs__globals__globals_0_0,37,41,45,49,53,57,61,181)
MR_BEGIN_CODE
...
MR_def_label(__Compare___libs__globals__globals_0_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6;
	MR_tempr5 = MR_sv(2);
	MR_sv(30) = (((MR_Integer) MR_tfield(0, MR_tempr5, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_sv(29) = ((MR_Integer) MR_tfield(0, MR_tempr5, 9) & (MR_Integer) 3);
	MR_sv(28) = MR_tfield(0, MR_tempr5, 8);
	MR_sv(27) = MR_tfield(0, MR_tempr5, 7);
	MR_sv(26) = MR_tfield(0, MR_tempr5, 6);
	MR_sv(25) = MR_tfield(0, MR_tempr5, 5);
	MR_sv(24) = MR_tfield(0, MR_tempr5, 4);
	MR_sv(23) = MR_tfield(0, MR_tempr5, 3);
	MR_sv(22) = MR_tfield(0, MR_tempr5, 2);
	MR_sv(21) = (((MR_Integer) MR_tfield(0, MR_tempr5, 1) >> (MR_Integer) 12) & (MR_Integer) 7);
	MR_sv(20) = (((MR_Integer) MR_tfield(0, MR_tempr5, 1) >> (MR_Integer) 10) & (MR_Integer) 3);
	MR_sv(19) = (((MR_Integer) MR_tfield(0, MR_tempr5, 1) >> (MR_Integer) 8) & (MR_Integer) 3);
	MR_sv(18) = (((MR_Integer) MR_tfield(0, MR_tempr5, 1) >> (MR_Integer) 6) & (MR_Integer) 3);
	MR_sv(17) = (((MR_Integer) MR_tfield(0, MR_tempr5, 1) >> (MR_Integer) 3) & (MR_Integer) 7);
	MR_sv(16) = ((MR_Integer) MR_tfield(0, MR_tempr5, 1) & (MR_Integer) 7);
	MR_tempr6 = MR_sv(1);
	MR_sv(15) = (((MR_Integer) MR_tfield(0, MR_tempr6, 9) >> (MR_Integer) 2) & (MR_Integer) 3);
	MR_sv(14) = ((MR_Integer) MR_tfield(0, MR_tempr6, 9) & (MR_Integer) 3);
	MR_sv(13) = MR_tfield(0, MR_tempr6, 8);
...
MR_def_label(__Compare___libs__globals__globals_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__globals__globals_0_0_i181);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(16);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___libs__globals__globals_0_0,61)
	...
	MR_decr_sp(31);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___libs__globals__globals_0_0,181)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(31);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__globals_module126)
	MR_init_entry1(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0);
	MR_init_label2(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__get_backend_foreign_languages__615__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(libs__globals__convert_foreign_language_2_0,
		fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0_i3);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__libs__globals__IntroducedFrom__func__get_backend_foreign_languages__615__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("libs.globals", 12);
...
MR_BEGIN_MODULE(libs__globals_module127)
	MR_init_entry1(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__419__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
