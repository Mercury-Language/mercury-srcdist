...
libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__670__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_OptionTable_48)
{
  ...
  else
  {
    ...
    MR_String Hint_17;
    MR_Integer slot_0 = ((MR_hash_string4(SchemeName_9)) & (MR_Integer) 15);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = libs__globals__IntroducedFrom__pred__convert_c_compiler_type_with_version__670__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, (MR_Integer) 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
