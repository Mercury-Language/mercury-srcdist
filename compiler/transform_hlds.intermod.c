...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Item_22, 0) = ((MR_Box) ((MR_Unsigned) 8U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Item_31, 0) = ((MR_Box) ((MR_Unsigned) 7U));
    ...
    if (succeeded)
    {
      ...
      if (!((ForeignEnumVals_79 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ForeignItem_84, 0) = ((MR_Box) ((MR_Unsigned) 3U));
