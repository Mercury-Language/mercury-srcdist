            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_138 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_137, (MR_Integer) 0))) & (MR_Integer) 3);
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_20, (MR_Integer) 0))) & (MR_Integer) 3);
            ...
            case (MR_Integer) 8:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_112 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_111, (MR_Integer) 0))) & (MR_Integer) 3);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      Var_68 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_67, (MR_Integer) 0))) & (MR_Integer) 3);
