  ...
  MR_Word * InstanceMethodName_20)
{
  ...
  hlds__pred_table__predicate_table_lookup_func_sym_arity_5_p_0(PredicateTable_39, (MR_Integer) 1, InstanceMethodName0_12, MethodUserArityInt_22, &PredIds_40);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_46 = transform_hlds__intermod__IntroducedFrom__func__write_promise__2106__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
