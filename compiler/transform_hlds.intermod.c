...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_data__set_type_defn_status_3_p_0(((MR_Box) ((MR_Unsigned) 12U)), TypeDefn0_7, TypeDefn_8);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_6, (MR_Integer) 5)));
      ...
      case (MR_Integer) 1:
        {
          ...
          (env).transform_hlds__intermod__should_opt_export_pred_8_p_0_env_0__succeeded = hlds__status____Unify____pred_status_0_0(((MR_Box) ((MR_Unsigned) 32U)), Var_20);
        }
        break;
    }
    if ((env).transform_hlds__intermod__should_opt_export_pred_8_p_0_env_0__succeeded)
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
              PredStatus_15 = ((MR_Box) ((MR_Unsigned) 24U));
            else
            {
              ...
              if (succeeded)
              {
                PredStatus_15 = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__intermod_scalar_common_9[0])));
              }
              else
                PredStatus_15 = ((MR_Box) ((MR_Unsigned) 16U));
            }
