            ...
            switch (MR_tag((MR_Word) ConsId_28)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_28, (MR_Integer) 0)))) {
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Word TypeCtorInfo_101_101 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
                      ...
                      mercury__term__var_list_to_term_list_2_p_0(TypeCtorInfo_101_101, Args_30, &ArgTerms_47);
                      parse_tree__prog_util__construct_qualified_term_3_p_0(TypeCtorInfo_101_101, SymName_44, ArgTerms_47, &RHSTerm_27);
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 5:
