...
static MR_Word MR_CALL 
transform_hlds__intermod__IntroducedFrom__func__intermod_gather_type__1573__1_1_f_0(
...
static MR_Word MR_CALL 
transform_hlds__intermod__IntroducedFrom__func__intermod_gather_type__1575__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_TypeDefnsCord_23)
{
  ...
  else
  {
    ...
    Var_24 = transform_hlds__intermod__IntroducedFrom__func__intermod_gather_type__1573__1_1_f_0(LangForeignType_17);
    {
      DetailsForeign_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), DetailsForeign_20, 0) = ((MR_Box) (Var_24));
      MR_hl_field(MR_mktag(0), DetailsForeign_20, 1) = ((MR_Box) (MaybeUserEqComp_18));
  ...
  MR_Word * STATE_VARIABLE_TypeDefnsCord_23)
{
  ...
  else
  {
    ...
    Var_24 = transform_hlds__intermod__IntroducedFrom__func__intermod_gather_type__1575__1_1_f_0(LangForeignType_17);
    {
      DetailsForeign_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), DetailsForeign_20, 0) = ((MR_Box) (Var_24));
      MR_hl_field(MR_mktag(0), DetailsForeign_20, 1) = ((MR_Box) (MaybeUserEqComp_18));
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 22, Markers0_79, &Markers_80);
  ...
  MR_Word * STATE_VARIABLE_IntermodInfo_27)
{
  ...
  hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 22, Markers0_21, &Markers_22);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_63, (MR_Integer) 11);
            succeeded = !(succeeded);
            if (succeeded)
            {
              Var_67 = (MR_Integer) 12;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeCtorInfo_16_72 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0);
                      succeeded = mercury__set__member_2_p_0(TypeCtorInfo_16_72, ((MR_Box) (PredId_10)), TypeSpecForcePreds_17);
                      succeeded = !(succeeded);
                      if (succeeded)
                      {
                        Var_69 = (MR_Integer) 8;
                        ...
                        {
                          Var_70 = (MR_Integer) 9;
                          succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_63, Var_70);
                          succeeded = !(succeeded);
                          if (succeeded)
                          {
                            hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo_14, &ProcTable_64);
                            TypeCtorInfo_17_73 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0);
                            TypeCtorInfo_18_74 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0);
                            mercury__map__values_2_p_0(TypeCtorInfo_17_73, TypeCtorInfo_18_74, ProcTable_64, &ProcInfos_65);
                            Var_71 = (MR_Word) (&transform_hlds__intermod_scalar_common_2[8]);
                            succeeded = mercury__list__all_true_2_p_0(TypeCtorInfo_18_74, Var_71, ProcInfos_65);
                            if (succeeded)
      ...
      if (succeeded)
      {
        ...
        Var_80 = hlds__hlds_pred__invalid_pred_id_0_f_0();
        succeeded = hlds__hlds_pred____Unify____pred_id_0_0(PredId_10, Var_80);
        if (succeeded)
          STATE_VARIABLE_IntermodInfo_35_35 = STATE_VARIABLE_IntermodInfo_0_3;
        else
        {
          MR_Word MayOptExportPred0_94;
          MR_Word STATE_VARIABLE_IntermodInfo_32_95;

          transform_hlds__intermod__intermod_do_add_pred_4_p_0(PredId_10, &MayOptExportPred0_94, STATE_VARIABLE_IntermodInfo_0_3, &STATE_VARIABLE_IntermodInfo_32_95);
          switch (MayOptExportPred0_94) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              STATE_VARIABLE_IntermodInfo_35_35 = STATE_VARIABLE_IntermodInfo_0_3;
              break;
            case (MR_Integer) 1:
              {
                MR_Word Clauses_26;
                MR_Word MayOptExportPred_98;
                MR_Word STATE_VARIABLE_IntermodInfo_33_99;

                hlds__hlds_clauses__get_clause_list_for_replacement_2_p_0(ClausesRep_24, &Clauses_26);
                transform_hlds__intermod__gather_entities_to_opt_export_in_clauses_4_p_0(Clauses_26, &MayOptExportPred_98, STATE_VARIABLE_IntermodInfo_32_95, &STATE_VARIABLE_IntermodInfo_33_99);
                switch (MayOptExportPred_98) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_IntermodInfo_35_35 = STATE_VARIABLE_IntermodInfo_0_3;
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        MR_Word Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 0))));
                        MR_Word Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 1))));
                        MR_Word Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 2))));
                        MR_Word Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 3))));
                        MR_Word Var_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 4))));
                        MR_Word Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_33_99, (MR_Integer) 5))));

                        {
                          STATE_VARIABLE_IntermodInfo_34_34 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 0) = ((MR_Box) (Var_87));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 1) = ((MR_Box) (Var_88));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 2) = ((MR_Box) (Var_89));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 3) = ((MR_Box) (Var_90));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 4) = ((MR_Box) (Var_91));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 5) = ((MR_Box) (Var_92));
                          MR_hl_field(MR_mktag(0), STATE_VARIABLE_IntermodInfo_34_34, 6) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                        }
                      }
                      else
                        STATE_VARIABLE_IntermodInfo_34_34 = STATE_VARIABLE_IntermodInfo_33_99;
      ...
      {
        {
          ...
          (env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_14, (MR_Integer) 24);
        }
        if (!((env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded))
        {
          {
