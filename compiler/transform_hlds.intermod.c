...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 370, &Threshold_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 418, &Deforestation_7);
    libs__globals__lookup_int_option_3_p_0(Globals_5, (MR_Integer) 382, &HigherOrderSizeLimit_8);
