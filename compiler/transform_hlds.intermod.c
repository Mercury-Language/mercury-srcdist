      ...
      if (succeeded)
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_67, 2) = ((MR_Box) ((MR_Integer) 7));
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 360, &Threshold_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 408, &Deforestation_9);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 372, &HigherOrderSizeLimit_10);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 360, &Threshold_19);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 408, &Deforestation_20);
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 372, &HigherOrderSizeLimit_21);
