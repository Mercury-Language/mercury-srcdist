...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Tag_9)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Tag_9, (MR_Integer) 0))) == (MR_Integer) 1)));
    if (succeeded)
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) Body_11)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeForeignTypeBody_34)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeRepnC_69)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) DuTypeKind_75)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Name_54)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeForeign0_14)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
