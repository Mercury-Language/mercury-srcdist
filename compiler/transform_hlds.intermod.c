...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_50 = (MR_Integer) ((MR_Unsigned) NumHeadSizeVars_30 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 365, &Threshold_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 413, &Deforestation_9);
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 377, &HigherOrderSizeLimit_10);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 365, &Threshold_19);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 413, &Deforestation_20);
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 377, &HigherOrderSizeLimit_21);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              Var_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_13, (MR_Integer) 0))) & (MR_Integer) 3);
