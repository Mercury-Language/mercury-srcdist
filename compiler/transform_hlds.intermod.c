                ...
                if ((env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded)
                {
                  ...
                  if ((env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded)
                  {
                    ...
                    if ((Var_66 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      ...
                      (env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded = transform_hlds__intermod__goal_contains_one_branched_goal_2_p_0(GoalList_61, (MR_Integer) 0);
                    }
                    else
                      (env).transform_hlds__intermod__opt_exporting_pred_is_likely_worthwhile_4_p_0_env_0__succeeded = MR_TRUE;
                  }
