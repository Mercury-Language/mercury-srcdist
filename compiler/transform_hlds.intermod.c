...
{
  {
    ...
    switch (MR_tag((MR_Word) Body_11)) {
      ...
      case (MR_Integer) 0:
        {
          TypeBody_24 = (MR_Word) MR_mkword(MR_mktag(3), &transform_hlds__intermod_scalar_common_1[15]);
        }
        break;
      case (MR_Integer) 1:
        {
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              (env).transform_hlds__intermod__intermod_do_add_proc_4_p_0_env_0__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_markers_0, ((MR_Box) (Markers_12)), ((MR_Box) (Var_48)));
              if ((env).transform_hlds__intermod__intermod_do_add_proc_4_p_0_env_0__succeeded)
              {
