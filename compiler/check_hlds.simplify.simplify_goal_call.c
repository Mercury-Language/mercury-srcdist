...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_call_scalar_common_2[8][3] = {
  ...
  /* row 1 */
  {
    (MR_Box) (((((MR_Unsigned) 46U << 1)) | (MR_Unsigned) 1U)),
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 2 */
        ...
        case (MR_Integer) 3:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_104, (MR_Integer) 245, &Pregen_105);
              switch (Pregen_105) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 7:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_74, (MR_Integer) 245, &Pregen_75);
              switch (Pregen_75) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 8:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 245, &Pregen_31);
              switch (Pregen_31) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 13:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_114, (MR_Integer) 245, &Pregen_115);
              switch (Pregen_115) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 20:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_94, (MR_Integer) 245, &Pregen_95);
              switch (Pregen_95) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 23:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_89, (MR_Integer) 245, &Pregen_90);
              switch (Pregen_90) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 28:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_109, (MR_Integer) 245, &Pregen_110);
              switch (Pregen_110) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 33:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_99, (MR_Integer) 245, &Pregen_100);
              switch (Pregen_100) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 37:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 245, &Pregen_80);
              switch (Pregen_80) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 48:
          {
            ...
            ;
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_84, (MR_Integer) 245, &Pregen_85);
              switch (Pregen_85) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_15, (MR_Integer) 296, (MR_Integer) 1);
    if (succeeded)
    {
        ...
        if ((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded)
          {
            ...
            if ((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded)
            {
              ...
              Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NestedContext_19, (MR_Integer) 1))));
              Var_37 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext_19, (MR_Integer) 2))));
              (env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded = (Var_37 == (MR_Unsigned) 0U);
              if ((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded)
              {
                ...
                (env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded = check_hlds__simplify__simplify_goal_call__input_args_are_equiv_5_p_0((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__ModuleInfo_23, Common_20, ArgVars_14, HeadVars_24, (env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__ArgModes_25);
                if ((env).check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_infinite_loop_call_11_p_0_env_0__succeeded)
                {
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word ArgVar_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
      MR_Word ArgVars_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
      MR_Word HeadVar_13;
      MR_Word HeadVars_14;
      MR_Word Mode_15;
      MR_Word Modes_16;
      ...
      if (succeeded)
      {
        HeadVar_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0))));
        HeadVars_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
        succeeded = (HeadVar__5_5 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Mode_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 0))));
          Modes_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 1))));
          succeeded = check_hlds__mode_util__mode_is_input_2_p_0(ModuleInfo_1, Mode_15);
          if (succeeded)
            succeeded = check_hlds__simplify__common__common_vars_are_equivalent_3_p_0(CommonInfo_2, ArgVar_11, HeadVar_13);
          else
            succeeded = MR_TRUE;
          if (succeeded)
          {
            ...
            ;
            next_value_of_HeadVar__3_3 = ArgVars_12;
            next_value_of_HeadVar__4_4 = HeadVars_14;
            next_value_of_HeadVar__5_5 = Modes_16;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_40, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 46) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
