  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  ...
  hlds__vartypes__add_var_type_4_p_0(*ConstVar_7, Var_13, VarTypes0_52, &VarTypes_54);
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  ...
  hlds__vartypes__add_var_type_4_p_0(*ConstVar_7, Var_14, VarTypes0_53, &VarTypes_55);
