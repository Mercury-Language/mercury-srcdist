...
static MR_Box MR_CALL 
check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_call_to_obsolete_predicate_5_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_call_scalar_common_2[8][3] = {
  ...
  /* row 2 */
  {
    ...
    ((MR_Box) (check_hlds__simplify__simplify_goal_call__maybe_generate_warning_for_call_to_obsolete_predicate_5_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 3 */
  {
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  {
    MR_bool succeeded;
    MR_Word InFavourOf_11;
    MR_Word ModuleInfo_15;
    MR_Word MaybeObsolete_10;
    MR_Word ThisPredProcId_12;
    MR_Word ThisPredId_13;
    MR_Word ThisPredInfo_16;
    MR_Word ThisMaybeObsolete_17;

    succeeded = check_hlds__simplify__simplify_info__simplify_do_warn_obsolete_1_p_0(STATE_VARIABLE_Info_0_30);
    if (succeeded)
    {
      hlds__hlds_pred__pred_info_get_obsolete_in_favour_of_2_p_0(PredInfo_7, &MaybeObsolete_10);
      succeeded = (MaybeObsolete_10 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        InFavourOf_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeObsolete_10, (MR_Integer) 0))));
        check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_0_30, &ThisPredProcId_12);
        ThisPredId_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ThisPredProcId_12, (MR_Integer) 0))));
        succeeded = hlds__hlds_pred____Unify____pred_id_0_0(PredId_6, ThisPredId_13);
        succeeded = !(succeeded);
        if (succeeded)
        {
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_15);
          hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_15, ThisPredId_13, &ThisPredInfo_16);
          hlds__hlds_pred__pred_info_get_obsolete_in_favour_of_2_p_0(ThisPredInfo_16, &ThisMaybeObsolete_17);
          succeeded = (ThisMaybeObsolete_17 == (MR_Word) ((MR_Unsigned) 0U));
        }
      }
    }
    if (succeeded)
    {
      ...
      GoalContext_18 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_8);
      PredPieces_19 = hlds__hlds_error_util__describe_one_pred_name_3_f_0(ModuleInfo_15, (MR_Integer) 0, PredId_6);
      Var_37 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredPieces_19, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[12])));
      MainPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[52])), Var_37);
      if ((InFavourOf_11 == (MR_Word) ((MR_Unsigned) 0U)))
        Pieces_21 = MainPieces_20;
      else
      {
        MR_Word Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InFavourOf_11, (MR_Integer) 1))));
        MR_Word Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InFavourOf_11, (MR_Integer) 0))));
        ...
        if ((Var_93 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_65, 1) = ((MR_Box) (Var_94));
          }
          {
            Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (Var_65));
            MR_hl_field(MR_mktag(1), Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[12])));
          }
          {
            Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[53])));
            MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (Var_64));
          }
          Pieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), MainPieces_20, Var_61);
        }
        else
        {
          MR_Word InFavourOfPieces_26;
          MR_Word Var_46;
          MR_Word Var_48;
          MR_Word Var_53;

          Var_46 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_and_arity_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_2[2]), InFavourOf_11);
          InFavourOfPieces_26 = parse_tree__error_util__component_list_to_pieces_2_f_0((MR_String) "and", Var_46);
          Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), InFavourOfPieces_26, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[12])));
          Var_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[55])), Var_53);
          Pieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), MainPieces_20, Var_48);
        }
      }
      {
        Var_77 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (Pieces_21));
      }
      {
      ...
      {
        Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_73, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 47) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Msg_27, 0) = ((MR_Box) (GoalContext_18));
        MR_hl_field(MR_mktag(0), Msg_27, 1) = ((MR_Box) (Var_72));
      }
      {
        Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (Msg_27));
        MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Spec_29 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Spec_29, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_2[1])));
        MR_hl_field(MR_mktag(0), Spec_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_call_scalar_common_5[0])));
        MR_hl_field(MR_mktag(0), Spec_29, 2) = ((MR_Box) (Var_86));
      }
      check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_29, STATE_VARIABLE_Info_0_30, STATE_VARIABLE_Info_31);
    }
    else
