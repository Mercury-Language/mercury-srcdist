...
{
  {
    ...
    {
      check_hlds__simplify__simplify_goal_call__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__simplify__simplify_goal_call__Globals_18, (MR_Integer) 228, (MR_Integer) 0);
    }
    ...
    if (check_hlds__simplify__simplify_goal_call__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_call__V_39_39, 0) = ((MR_Box) (((MR_Integer) 42 | (((MR_Integer) 1 << (MR_Integer) 10)))));
...
{
  {
    ...
    {
      check_hlds__simplify__simplify_goal_call__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(check_hlds__simplify__simplify_goal_call__GoalInfo_9, (MR_Integer) 23);
    }
    if (check_hlds__simplify__simplify_goal_call__succeeded)
