...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_20, (MR_Integer) 236, (MR_Integer) 0);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_14, (MR_Integer) 282, (MR_Integer) 1);
    if (succeeded)
    {
