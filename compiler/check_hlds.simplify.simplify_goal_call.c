...
{
  {
    ...
    if (check_hlds__simplify__simplify_goal_call__succeeded)
    {
      ...
      {
        MR_Integer check_hlds__simplify__simplify_goal_call__lo_0 = (MR_Integer) 0;
        MR_Integer check_hlds__simplify__simplify_goal_call__hi_1 = (MR_Integer) 4;
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_call__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__simplify__simplify_goal_call__Globals_18, (MR_Integer) 234, (MR_Integer) 0);
    if (check_hlds__simplify__simplify_goal_call__succeeded)
    {
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_call__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__simplify__simplify_goal_call__Globals_14, (MR_Integer) 280, (MR_Integer) 1);
    if (check_hlds__simplify__simplify_goal_call__succeeded)
    {
