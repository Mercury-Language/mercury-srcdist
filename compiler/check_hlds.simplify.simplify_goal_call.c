...
static /* final */ const struct check_hlds__simplify__simplify_goal_call__vector_common_type_9_0_s check_hlds__simplify__simplify_goal_call_vector_common_9[40];
...
static /* final */ const struct check_hlds__simplify__simplify_goal_call__vector_common_type_8_0_s check_hlds__simplify__simplify_goal_call_vector_common_8[64] = {
  ...
  /* row 31 */   {     NULL },
  /* row 32 */   {     NULL },
  /* row 33 */   {     (MR_String) "uint32" },
  /* row 34 */   {     (MR_String) "uint" },
  /* row 35 */   {     NULL },
  /* row 36 */   {     NULL },
  /* row 37 */   {     NULL },
  /* row 38 */   {     (MR_String) "builtin" },
  ...
  /* row 45 */   {     NULL },
  /* row 46 */   {     NULL },
  /* row 47 */   {     (MR_String) "int8" },
  /* row 48 */   {     (MR_String) "int" },
  /* row 49 */   {     (MR_String) "int16" },
  /* row 50 */   {     NULL },
  /* row 51 */   {     NULL },
  /* row 52 */   {     NULL },
  /* row 53 */   {     NULL },
  /* row 54 */   {     NULL },
  /* row 55 */   {     (MR_String) "int32" },
  /* row 56 */   {     NULL },
  /* row 57 */   {     NULL },
  /* row 58 */   {     NULL },
...
{
  {
    ...
    MR_Integer slot_4 = ((MR_hash_string4(ModuleName_12)) & (MR_Integer) 31);
                    ...
                    case (MR_Integer) 0:
                      {
                        // case "@<"
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              X_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_36, (MR_Integer) 0)));
                              Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_36, (MR_Integer) 1)));
                              succeeded = ((MR_tag((MR_Word) Var_37)) == (MR_mktag((MR_Integer) 1)));
                              if (succeeded)
                              {
                                Y_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_37, (MR_Integer) 0)));
                                ...
                                if (succeeded)
                                {
                                  check_hlds__simplify__simplify_goal_call__simplify_inline_builtin_inequality_10_p_0(TI_22, X_23, Y_24, (MR_String) "<", (MR_Integer) 0, GoalInfo0_17, ImprovedGoalExpr_16, InstMap0_11, STATE_VARIABLE_Info_0_25, &STATE_VARIABLE_Info_39_39);
                    ...
                    case (MR_Integer) 1:
                      {
                        // case "@=<"
                        {
                          ...
                          if (succeeded)
                          {
                            TI_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 0)));
                            Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 1)));
                            succeeded = ((MR_tag((MR_Word) Var_46)) == (MR_mktag((MR_Integer) 1)));
                            if (succeeded)
                            {
                              X_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_46, (MR_Integer) 0)));
                              Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_46, (MR_Integer) 1)));
                              succeeded = ((MR_tag((MR_Word) Var_47)) == (MR_mktag((MR_Integer) 1)));
                              if (succeeded)
                              {
                                Y_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_47, (MR_Integer) 0)));
                                ...
                                if (succeeded)
                                {
                                  check_hlds__simplify__simplify_goal_call__simplify_inline_builtin_inequality_10_p_0(TI_43, X_44, Y_45, (MR_String) ">", (MR_Integer) 1, GoalInfo0_17, ImprovedGoalExpr_16, InstMap0_11, STATE_VARIABLE_Info_0_25, &STATE_VARIABLE_Info_39_39);
                                  *ImprovedGoalInfo_18 = GoalInfo0_17;
                                  succeeded = MR_TRUE;
                                }
                              }
                    ...
                    case (MR_Integer) 2:
                      {
                        // case "@>"
                        {
                          ...
                          if (succeeded)
                          {
                            TI_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 0)));
                            Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 1)));
                            succeeded = ((MR_tag((MR_Word) Var_54)) == (MR_mktag((MR_Integer) 1)));
                            if (succeeded)
                            {
                              X_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 0)));
                              Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 1)));
                              succeeded = ((MR_tag((MR_Word) Var_55)) == (MR_mktag((MR_Integer) 1)));
                              if (succeeded)
                              {
                                Y_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_55, (MR_Integer) 0)));
                                ...
                                if (succeeded)
                                {
                                  check_hlds__simplify__simplify_goal_call__simplify_inline_builtin_inequality_10_p_0(TI_51, X_52, Y_53, (MR_String) ">", (MR_Integer) 0, GoalInfo0_17, ImprovedGoalExpr_16, InstMap0_11, STATE_VARIABLE_Info_0_25, &STATE_VARIABLE_Info_39_39);
                                  *ImprovedGoalInfo_18 = GoalInfo0_17;
                                  succeeded = MR_TRUE;
                                }
                              }
                    ...
                    case (MR_Integer) 3:
                      {
                        // case "@>="
                        {
                          ...
                          if (succeeded)
                          {
                            TI_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 0)));
                            Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 1)));
                            succeeded = ((MR_tag((MR_Word) Var_62)) == (MR_mktag((MR_Integer) 1)));
                            if (succeeded)
                            {
                              X_60 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 0)));
                              Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 1)));
                              succeeded = ((MR_tag((MR_Word) Var_63)) == (MR_mktag((MR_Integer) 1)));
                              if (succeeded)
                              {
                                Y_61 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_63, (MR_Integer) 0)));
                                ...
                                if (succeeded)
                                {
                                  check_hlds__simplify__simplify_goal_call__simplify_inline_builtin_inequality_10_p_0(TI_59, X_60, Y_61, (MR_String) "<", (MR_Integer) 1, GoalInfo0_17, ImprovedGoalExpr_16, InstMap0_11, STATE_VARIABLE_Info_0_25, &STATE_VARIABLE_Info_39_39);
                                  *ImprovedGoalInfo_18 = GoalInfo0_17;
                                  succeeded = MR_TRUE;
                                }
                              }
  ...
  label_1:;
    if (succeeded)
    {
      check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_39_39, STATE_VARIABLE_Info_26);
      succeeded = MR_TRUE;
    }
    return succeeded;
  }
...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_20, (MR_Integer) 234, (MR_Integer) 0);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_14, (MR_Integer) 279, (MR_Integer) 1);
    if (succeeded)
    {
