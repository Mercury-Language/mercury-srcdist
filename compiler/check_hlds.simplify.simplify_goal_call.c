...
static void MR_CALL 
check_hlds__simplify__simplify_goal_call__delete_initial_digits_maybe_underscore_2_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * HeadVar__2_2);
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_call_scalar_common_1[75][2];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_call_scalar_common_2[7][3];
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_call_scalar_common_1[75][2] = {
  ...
  /* row 56 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_call_scalar_common_1[55]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 57 */
  {
  ...
  /* row 62 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[61]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 63 */
  {
  ...
  /* row 66 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[65]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 67 */
  {
  ...
  /* row 72 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[71]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 73 */
  {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_46 = (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_2[3]);
    ...
    else
    {
      ...
      switch (BoxPolicy_34) {
        ...
        case (MR_Integer) 1:
          {
            mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_2[4]), Args0_22, &Args_35);
            mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_2[5]), ExtraArgs0_23, &ExtraArgs_36);
            {
      ...
      if (succeeded)
      {
        ...
        ArgVars_54 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_2[6]), Args_35);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), GoalExpr_46, 4) = ((MR_Box) (&check_hlds__simplify__simplify_goal_call_scalar_common_1[74]));
    }
...
{
  {
    ...
    Unique_31 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_2[2]));
    {
      Var_64 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), UnifyExpr_48, 4) = ((MR_Box) (&check_hlds__simplify__simplify_goal_call_scalar_common_1[73]));
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Pieces_23 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[72])), Var_35);
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              ;
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_27 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[63]));
                  Var_32 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[69]));
                  {
                  ...
                  Var_37 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[70]));
                  {
          ...
          case (MR_Integer) 1:
            {
              ...
              ;
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_45 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[57]));
                  {
                  ...
                  Var_52 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[67]));
                  Var_55 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[68]));
                  {
                  ...
                  Var_59 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[66]));
                  {
          ...
          case (MR_Integer) 2:
            {
              ...
              ;
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_19 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[64]));
                  {
                  ...
                  Var_23 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[66]));
                  {
          ...
          case (MR_Integer) 3:
            {
              ...
              ;
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_63 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[57]));
                  Var_68 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[58]));
                  {
                  ...
                  Var_73 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[59]));
                  Var_76 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[60]));
                  {
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[54])));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_150, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[56])));
                }
                {
                  Var_148 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_148, 0) = ((MR_Box) (Var_149));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[54])));
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              {
                Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_call_scalar_common_1[54])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_80, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 31) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
              ...
              {
                Msg_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Msg_45, 0) = ((MR_Box) (Var_78));
                MR_hl_field(MR_mktag(0), Msg_45, 1) = ((MR_Box) (Var_79));
              }
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                MR_Word RevChars_85;
                MR_Char HeadRevChar_86;
                MR_Word TailRevChars_87;
                MR_Word RevNoSuffixChars_88;
                MR_String StrNoSuffixPrime_91;
                MR_Word RevChars_94;
                MR_Char HeadRevChar_95;
                MR_Word TailRevChars_96;
                MR_Word RevNoSuffixChars_97;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      mercury__string__to_rev_char_list_2_p_0(HeadName_48, &RevChars_85);
                      succeeded = (RevChars_85 != (MR_Word) ((MR_Unsigned) 0U));
                      if (succeeded)
                      {
                        HeadRevChar_86 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), RevChars_85, (MR_Integer) 0)));
                        TailRevChars_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RevChars_85, (MR_Integer) 1))));
                        succeeded = mercury__char__is_digit_1_p_0(HeadRevChar_86);
                        if (succeeded)
                        {
                          check_hlds__simplify__simplify_goal_call__delete_initial_digits_maybe_underscore_2_p_0(TailRevChars_87, &RevNoSuffixChars_88);
                          mercury__string__from_rev_char_list_2_p_0(RevNoSuffixChars_88, &StrNoSuffixPrime_82);
                          succeeded = MR_TRUE;
                        }
                      }
                      if (succeeded)
                      ...
                      mercury__string__to_rev_char_list_2_p_0(ArgName_49, &RevChars_94);
                      succeeded = (RevChars_94 != (MR_Word) ((MR_Unsigned) 0U));
                      if (succeeded)
                      {
                        HeadRevChar_95 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), RevChars_94, (MR_Integer) 0)));
                        TailRevChars_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RevChars_94, (MR_Integer) 1))));
                        succeeded = mercury__char__is_digit_1_p_0(HeadRevChar_95);
                        if (succeeded)
                        {
                          check_hlds__simplify__simplify_goal_call__delete_initial_digits_maybe_underscore_2_p_0(TailRevChars_96, &RevNoSuffixChars_97);
                          mercury__string__from_rev_char_list_2_p_0(RevNoSuffixChars_97, &StrNoSuffixPrime_91);
                          succeeded = MR_TRUE;
                        }
                      }
                      if (succeeded)
                        ArgBaseName_51 = StrNoSuffixPrime_91;
                      else
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__char__is_digit_1_p_0(Char0_3);
      if (succeeded)
      {
        MR_Word next_value_of_HeadVar__1_1 = Chars0_4;
      ...
      {
        succeeded = (Char0_3 == (MR_Char) 95);
        if (succeeded)
          *HeadVar__2_2 = Chars0_4;
        else
...
{
  {
    return (MR_Word) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_call_scalar_common_1[53]));
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Pieces_19 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[52])), Var_32);
      {
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_goal_call__IntroducedFrom__pred__maybe_generate_warning_for_implicit_stream_predicate__354__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
