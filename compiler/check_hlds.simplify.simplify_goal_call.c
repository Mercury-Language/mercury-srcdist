...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_14, (MR_Integer) 292, (MR_Integer) 1);
    if (succeeded)
    {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_13, Var_41, Var_42, Var_43, Var_44, Var_45, Var_46, Var_47, Var_48, Var_49, Context_21, &CondEq_22);
              ...
              hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_13, Var_52, Var_53, Var_54, Var_55, Var_56, Var_57, Var_47, Var_59, Var_60, Context_21, &CondLt_23);
