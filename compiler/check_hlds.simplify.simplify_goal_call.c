  ...
  MR_Word * STATE_VARIABLE_Info_44)
{
  ...
  PredOrFunc_64 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_26);
  ModuleSymName_65 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_26);
  succeeded = mdbcomp__builtin_modules__is_std_lib_module_name_2_p_0(ModuleSymName_65, &ModuleName_66);
  if (succeeded)
  {
    succeeded = (PredOrFunc_64 == (MR_Integer) 0);
    if (succeeded)
    {
      succeeded = (Args_21 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ArgA_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_21, (MR_Integer) 0))));
        Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_21, (MR_Integer) 1))));
        succeeded = (Var_77 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          ArgB_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_77, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__pred_info_get_name_2_p_0(PredInfo_26, &PredName_69);
    hlds__instmap__instmap_lookup_var_3_p_0(InstMap0_16, ArgA_67, &InstA_70);
    hlds__instmap__instmap_lookup_var_3_p_0(InstMap0_16, ArgB_68, &InstB_71);
    succeeded = check_hlds__simplify__simplify_goal_call__is_useless_unsigned_comparison_5_p_0(ModuleName_66, PredName_69, InstA_70, InstB_71, &WarnPieces_72);
    if (succeeded)
    {
      MR_Word GoalContext_73;
      ...
      GoalContext_73 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
      PredPieces_74 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 0, PredInfo_26);
      Var_84 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredPieces_74, WarnPieces_72);
      Pieces_75 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_call_scalar_common_1[58])), Var_84);
      {
        Var_92 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_92, 0) = ((MR_Box) (GoalContext_73));
        MR_hl_field(MR_mktag(0), Var_92, 1) = ((MR_Box) (Pieces_75));
      }
      {
      ...
      {
        Spec_76 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Spec_76, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_call.maybe_generate_warning_for_useless_comparison\'/6"));
        MR_hl_field(MR_mktag(3), Spec_76, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        MR_hl_field(MR_mktag(3), Spec_76, 2) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(3), Spec_76, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_call_scalar_common_2[0])));
        MR_hl_field(MR_mktag(3), Spec_76, 4) = ((MR_Box) (Var_91));
      }
      check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_76, STATE_VARIABLE_Info_47_47, &STATE_VARIABLE_Info_48_48);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_11, &ModuleInfo_51);
  IsDummy_52 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_51, Var_13);
  {
    Entry_53 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_53, 0) = ((MR_Box) ((MR_String) ""));
    MR_hl_field(MR_mktag(0), Entry_53, 1) = ((MR_Box) (Var_13));
    MR_hl_field(MR_mktag(0), Entry_53, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_52));
  }
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_11, &VarTable0_54);
  parse_tree__var_table__add_var_entry_4_p_0(Entry_53, ConstVar_7, VarTable0_54, &VarTable_55);
  check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_55, STATE_VARIABLE_Info_0_11, STATE_VARIABLE_Info_12);
  {
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  ...
  IsDummy_53 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_52, Var_14);
  {
    Entry_54 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_54, 0) = ((MR_Box) ((MR_String) ""));
    MR_hl_field(MR_mktag(0), Entry_54, 1) = ((MR_Box) (Var_14));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                        HeadBaseName_51 = StrNoSuffixPrime_82;
                      else
