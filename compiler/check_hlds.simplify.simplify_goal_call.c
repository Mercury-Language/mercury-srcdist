            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_10_73 = (MR_Word) (&check_hlds__simplify__simplify_goal_call_scalar_common_1[0]);
                  TypeCtorInfo_11_74 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
                  succeeded = mercury__map__search_3_p_0(TypeInfo_10_73, TypeCtorInfo_11_74, VarNameRemap_4, ((MR_Box) (HeadVar_37)), &conv0_HeadName_72);
                  if (succeeded)
                  {
