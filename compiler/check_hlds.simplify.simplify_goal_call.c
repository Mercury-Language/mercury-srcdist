  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      Pieces_67 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_call_scalar_common_1[19])), Var_80);
      {
        ...
        MR_hl_field(0, Spec_68, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[4])));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(2, Spec_39, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[4])));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(2, Spec_177, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[4])));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(2, Spec_182, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[5])));
  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_34, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[3])));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Pieces_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_call_scalar_common_1[2])), Var_58);
      {
        ...
        MR_hl_field(0, Spec_35, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[1])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Pieces_113 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_call_scalar_common_1[2])), Var_88);
        {
          ...
          MR_hl_field(0, Spec_114, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_call_scalar_common_2[1])));
