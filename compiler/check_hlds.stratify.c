...
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 126,3,9,11,12,6,7,4,15,21)
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 23,24,18,19,16,27,29,32,33,31)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 35,38,37,46,45,48,50,43)
...
MR_BEGIN_MODULE(check_hlds__stratify_module3)
	...
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,126,3,9,11,12,6,7,4,15,21)
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,23,24,18,19,16,27,29,32,33,31)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,35,38,37,46,45,48,50,43)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,3)
	...
	if (MR_PTAG_TESTR(MR_r8,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i4);
	}
	{
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__stratify__first_order_check_goal_8_0_i9);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,7)
	...
	MR_r1 = MR_r7;
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r8,0)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i15);
	}
	MR_r1 = MR_r7;
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i18);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__stratify__first_order_check_goal_8_0_i23);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,24)
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_sv(2);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,27)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,2)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i29);
	}
	MR_r1 = MR_tfield(3, MR_r8, 1);
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(check_hlds__stratify__first_order_check_goals_8_0);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r8,3,6)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i31);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,33)
	...
	MR_r7 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i126);
	}
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r8,3,4)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i35);
	}
	MR_r1 = MR_tfield(3, MR_r8, 1);
	MR_r2 = (MR_Integer) 1;
	MR_succip_word = MR_sv(8);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,48)
	...
	MR_np_call_localret_ent(fn__check_hlds__stratify__this_file_0_0,
		check_hlds__stratify__first_order_check_goal_8_0_i50);
