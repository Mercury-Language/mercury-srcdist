...
MR_decl_label5(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0, 12,3,4,5,6)
MR_decl_label7(check_hlds__stratify__emit_message_8_0, 2,3,4,6,7,8,9)
MR_decl_label3(check_hlds__stratify__first_order_check_case_list_9_0, 10,3,4)
...
MR_decl_label3(check_hlds__stratify__first_order_check_goal_list_9_0, 10,3,4)
...
MR_BEGIN_MODULE(check_hlds__stratify_module0)
	...
	MR_init_label5(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,12,3,4,5,6)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,6)
	...
	MR_GOTO_LAB(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0_i12);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module4)
	...
	MR_init_label3(check_hlds__stratify__first_order_check_goal_list_9_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_list_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__stratify__first_order_check_goal_list_9_0,4)
	...
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_list_9_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__stratify_module5)
	...
	MR_init_label3(check_hlds__stratify__first_order_check_case_list_9_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__stratify__first_order_check_case_list_9_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_case_list_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__stratify__first_order_check_case_list_9_0,3)
	...
	MR_sv(5) = MR_ctfield(1, MR_tempr3, 1);
	MR_tempr1 = MR_tempr3;
	MR_tempr2 = MR_ctfield(0, MR_ctfield(1, MR_tempr3, 0), 1);
	MR_r1 = MR_ctfield(0, MR_tempr2, 0);
	MR_r2 = MR_ctfield(0, MR_tempr2, 1);
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(2);
...
MR_def_label(check_hlds__stratify__first_order_check_case_list_9_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_case_list_9_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
