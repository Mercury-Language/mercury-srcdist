...
MR_decl_label2(__Unify___check_hlds__stratify__higher_order_info_0_0, 2,1)
MR_decl_label2(__Compare___check_hlds__stratify__higher_order_info_0_0, 3,7)
...
MR_BEGIN_MODULE(check_hlds__stratify_module12)
	...
	MR_init_label2(__Unify___check_hlds__stratify__higher_order_info_0_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__stratify__higher_order_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___check_hlds__stratify__higher_order_info_0_0_i2);
MR_def_label(__Unify___check_hlds__stratify__higher_order_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(check_hlds__stratify_module13)
	...
	MR_init_label2(__Compare___check_hlds__stratify__higher_order_info_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__stratify__higher_order_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___check_hlds__stratify__higher_order_info_0_0_i3);
MR_def_label(__Compare___check_hlds__stratify__higher_order_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__stratify__higher_order_info_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___check_hlds__stratify__higher_order_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__stratify__write_out_proc_statics(FILE *fp);
#endif
