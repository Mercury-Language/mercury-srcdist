...
extern const MR_TypeCtorInfo_Struct
	...
	mercury_data_check_hlds__stratify__type_ctor_info_strat_ho_info_0;
MR_decl_label9(check_hlds__stratify__check_module_for_stratification_3_0, 2,3,4,5,6,7,8,9,10)
...
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 131,3,10,12,13,7,8,5,16,22)
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 24,25,19,20,17,28,30,32,34,35)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 33,41,38,37,48,47,50,45)
...
MR_decl_label8(check_hlds__stratify__first_order_check_sccs_6_0, 28,3,4,7,10,11,6,12)
MR_decl_label5(fn__check_hlds__stratify__generate_stratify_error_5_0, 2,5,6,8,19)
MR_decl_label3(__Unify___check_hlds__stratify__strat_ho_info_0_0, 4,6,1)
MR_decl_label4(__Compare___check_hlds__stratify__strat_ho_info_0_0, 3,2,5,27)
...
MR_def_extern_entry(check_hlds__stratify__check_module_for_stratification_3_0)
...
MR_decl_static(__Unify___check_hlds__stratify__strat_ho_info_0_0)
MR_decl_static(__Compare___check_hlds__stratify__strat_ho_info_0_0)
...
MR_CTOR_ADDR(tree234, tree234, 2),
MR_CTOR0_ADDR(hlds__hlds_pred, pred_proc_id),
MR_CTOR0_ADDR(check_hlds__stratify, strat_ho_info)
}
},
};
...
extern const MR_TypeCtorInfo_Struct mercury_data_check_hlds__stratify__type_ctor_info_strat_ho_info_0;

static const MR_FA_TypeInfo_Struct2 mercury_data_tree234__ti_tree234_2hlds__hlds_pred__type_ctor_info_pred_proc_id_0check_hlds__stratify__type_ctor_info_strat_ho_info_0 = {
	&mercury_data_tree234__type_ctor_info_tree234_2,
{	(MR_TypeInfo) &mercury_data_hlds__hlds_pred__type_ctor_info_pred_proc_id_0,
	(MR_TypeInfo) &mercury_data_check_hlds__stratify__type_ctor_info_strat_ho_info_0
}};
...
const MR_TypeCtorInfo_Struct mercury_data_check_hlds__stratify__type_ctor_info_ho_map_0 = {
	...
	"ho_map",
	{ 0 },
	{ (void *)&mercury_data_tree234__ti_tree234_2hlds__hlds_pred__type_ctor_info_pred_proc_id_0check_hlds__stratify__type_ctor_info_strat_ho_info_0 },
	-1,
	0,
	NULL
};
...
const MR_PseudoTypeInfo mercury_data_check_hlds__stratify__field_types_strat_ho_info_0_0[] = {
...
static const MR_DuFunctorDesc mercury_data_check_hlds__stratify__du_functor_desc_strat_ho_info_0_0 = {
	"strat_ho_info",
	2,
	0,
	MR_SECTAG_NONE,
	...
	-1,
	0,
	(MR_PseudoTypeInfo *) mercury_data_check_hlds__stratify__field_types_strat_ho_info_0_0,
	NULL,
	NULL,
	NULL
};

const MR_DuFunctorDescPtr mercury_data_check_hlds__stratify__du_stag_ordered_strat_ho_info_0_0[] = {
	&mercury_data_check_hlds__stratify__du_functor_desc_strat_ho_info_0_0

};

const MR_DuPtagLayout mercury_data_check_hlds__stratify__du_ptag_ordered_strat_ho_info_0[] = {
	{ 1, MR_SECTAG_NONE,
	mercury_data_check_hlds__stratify__du_stag_ordered_strat_ho_info_0_0 }

};

const MR_DuFunctorDescPtr mercury_data_check_hlds__stratify__du_name_ordered_strat_ho_info_0[] = {
	&mercury_data_check_hlds__stratify__du_functor_desc_strat_ho_info_0_0
};

const MR_Integer mercury_data_check_hlds__stratify__functor_number_map_strat_ho_info_0[] = {
	0 };
	
const MR_TypeCtorInfo_Struct mercury_data_check_hlds__stratify__type_ctor_info_strat_ho_info_0 = {
	0,
	15,
	1,
	MR_TYPECTOR_REP_DU,
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Unify___check_hlds__stratify__strat_ho_info_0_0)),
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Compare___check_hlds__stratify__strat_ho_info_0_0)),
	"check_hlds.stratify",
	"strat_ho_info",
	{ (void *)mercury_data_check_hlds__stratify__du_name_ordered_strat_ho_info_0 },
	{ (void *)mercury_data_check_hlds__stratify__du_ptag_ordered_strat_ho_info_0 },
	1,
	4,
	mercury_data_check_hlds__stratify__functor_number_map_strat_ho_info_0
};
...
MR_BEGIN_MODULE(check_hlds__stratify_module1)
	...
	MR_init_label5(fn__check_hlds__stratify__generate_stratify_error_5_0,2,5,6,8,19)
MR_BEGIN_CODE
...
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,0,7);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i5);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i6);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(fn__check_hlds__stratify__generate_stratify_error_5_0_i8);
	}
	{
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i19);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,8)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i19);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tfield(2, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__stratify_module2)
	...
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,131,3,10,12,13,7,8,5,16,22)
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,24,25,19,20,17,28,30,32,34,35)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,33,41,38,37,48,47,50,45)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,131)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,35)
	...
	MR_r7 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i131);
	}
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,33)
	...
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i41);
	}
	MR_sv(5) = MR_r2;
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,37)
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i47);
	}
	MR_sv(5) = MR_r2;
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_8_0,
		check_hlds__stratify__first_order_check_goal_8_0_i48);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r9,2)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i50);
	}
	MR_r1 = MR_tfield(2, MR_r9, 2);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i131);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__stratify_module6)
	...
	MR_init_label8(check_hlds__stratify__first_order_check_sccs_6_0,28,3,4,7,10,11,6,12)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__stratify__first_order_check_sccs_6_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,3)
	...
	MR_np_call_localret_ent(set__intersect_3_0,
		check_hlds__stratify__first_order_check_sccs_6_0_i4);
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,4)
	...
	MR_np_call_localret_ent(set__is_empty_1_0,
		check_hlds__stratify__first_order_check_sccs_6_0_i7);
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_sccs_6_0_i6);
	}
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_sccs_6_0_i10);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_sccs_6_0_i28);
...
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,6)
	...
	MR_r5 = MR_sv(4);
	MR_np_call_localret_ent(check_hlds__stratify__first_order_check_scc_2_6_0,
		check_hlds__stratify__first_order_check_sccs_6_0_i12);
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(check_hlds__stratify_module7)
	MR_init_entry1(check_hlds__stratify__check_module_for_stratification_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__stratify__check_module_for_stratification_3_0);
	MR_init_label9(check_hlds__stratify__check_module_for_stratification_3_0,2,3,4,5,6,7,8,9,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'check_module_for_stratification'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__stratify__check_module_for_stratification_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i2);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(hlds__hlds_module__module_info_dependency_info_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i3);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, pred_proc_id);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(hlds__hlds_module__hlds_dependency_info_get_dependency_graph_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i4);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(digraph__atsort_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i5);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i6);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i7);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 17;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i8);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_stratified_preds_2_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i9);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__stratify__first_order_check_sccs_6_0,
		check_hlds__stratify__check_module_for_stratification_3_0_i10);
MR_def_label(check_hlds__stratify__check_module_for_stratification_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__stratify_module19)
	MR_init_entry1(__Unify___check_hlds__stratify__strat_ho_info_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__stratify__strat_ho_info_0_0);
	MR_init_label3(__Unify___check_hlds__stratify__strat_ho_info_0_0,4,6,1)
MR_BEGIN_CODE
...
/* code for '__Unify__'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(__Unify___check_hlds__stratify__strat_ho_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__stratify__strat_ho_info_0_0_i6);
	}
	MR_incr_sp(3);
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___check_hlds__stratify__strat_ho_info_0_0_i4);
MR_def_label(__Unify___check_hlds__stratify__strat_ho_info_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__stratify__strat_ho_info_0_0_i1);
	}
	MR_r1 = (MR_sv(1) == MR_sv(2));
	MR_decr_sp_and_return(3);
MR_def_label(__Unify___check_hlds__stratify__strat_ho_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(__Unify___check_hlds__stratify__strat_ho_info_0_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module20)
	MR_init_entry1(__Compare___check_hlds__stratify__strat_ho_info_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__stratify__strat_ho_info_0_0);
	MR_init_label4(__Compare___check_hlds__stratify__strat_ho_info_0_0,3,2,5,27)
MR_BEGIN_CODE
...
/* code for '__Compare__'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(__Compare___check_hlds__stratify__strat_ho_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___check_hlds__stratify__strat_ho_info_0_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_GOTO_LAB(__Compare___check_hlds__stratify__strat_ho_info_0_0_i2);
MR_def_label(__Compare___check_hlds__stratify__strat_ho_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___check_hlds__stratify__strat_ho_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___check_hlds__stratify__strat_ho_info_0_0_i5);
MR_def_label(__Compare___check_hlds__stratify__strat_ho_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__stratify__strat_ho_info_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___check_hlds__stratify__strat_ho_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__stratify__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_check_hlds__stratify__type_ctor_info_strat_ho_info_0,
		check_hlds__stratify__strat_ho_info_0_0);
...
void mercury__check_hlds__stratify__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__check_hlds__stratify);
