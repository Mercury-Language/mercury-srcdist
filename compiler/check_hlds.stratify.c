  ...
  MR_Word * HOInfo_7)
{
  ...
  MR_Word HOInfoL_12;
  MR_Word PredIds_19;
  MR_Word STATE_VARIABLE_ProcCalls_13_20;
  MR_Word STATE_VARIABLE_HOInfo_14_21;
  MR_Word STATE_VARIABLE_CallsHO_15_22;

  mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&check_hlds__stratify_scalar_common_1[0]), &STATE_VARIABLE_ProcCalls_13_20);
  mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&check_hlds__stratify__check_hlds__stratify__type_ctor_info_strat_ho_info_0), &STATE_VARIABLE_HOInfo_14_21);
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &STATE_VARIABLE_CallsHO_15_22);
  hlds__hlds_module__module_info_get_valid_pred_ids_2_p_0(ModuleInfo_5, &PredIds_19);
  check_hlds__stratify__expand_predids_8_p_0(PredIds_19, ModuleInfo_5, STATE_VARIABLE_ProcCalls_13_20, &ProcCalls_8, STATE_VARIABLE_HOInfo_14_21, &HOInfo0_9, STATE_VARIABLE_CallsHO_15_22, &CallsHO_10);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_43, &Goal_45);
      {
        ...
        MR_hl_field(MR_mktag(0), PredProcId_46, 0) = ((MR_Box) (PredId_3));
        MR_hl_field(MR_mktag(0), PredProcId_46, 1) = ((MR_Box) (ProcId_25));
      }
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (HaveAT_48));
        MR_hl_field(MR_mktag(0), Var_51, 1) = (MR_Box) ((MR_Unsigned) (HOInOut_50));
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo__39_39 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
        TypeCtorInfo__40_40 = (MR_Word) (&check_hlds__stratify__check_hlds__stratify__type_ctor_info_strat_ho_info_0);
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo__39_39, TypeCtorInfo__40_40, HeadVar__3_3, ((MR_Box) (PredProcId_13)), &conv0_HigherOrderInfo_25);
        if (succeeded)
        {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        check_hlds__stratify__first_order_check_scc_loop_6_p_0(Var_31, HeadSCC_13, (MR_Integer) 1, ModuleInfo_4, STATE_VARIABLE_Specs_0_5, &STATE_VARIABLE_Specs_25_25);
      }
      else
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            TypeCtorInfo__91_93 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
            succeeded = mercury__set__member_2_p_0(TypeCtorInfo__91_93, ((MR_Box) (Callee_103)), WholeScc_11);
          }
          if (succeeded)
          {
            MR_Word Context_94;
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo__91_91 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
                succeeded = mercury__set__member_2_p_0(TypeCtorInfo__91_91, ((MR_Box) (Callee_42)), WholeScc_11);
              }
              if (succeeded)
              {
                MR_Word Context_43;
