...
MR_decl_label5(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0, 15,3,4,6,7)
MR_decl_label7(check_hlds__stratify__emit_message_8_0, 2,8,9,11,36,44,45)
MR_decl_label3(check_hlds__stratify__first_order_check_cases_9_0, 10,3,4)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_9_0, 92,24,29,26,27,58,3,8)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_9_0, 10,5,6,13,15,18,19,20)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_9_0, 22,34,35,40,46,48,42,43)
MR_decl_label1(check_hlds__stratify__first_order_check_goal_9_0, 52)
MR_decl_label3(check_hlds__stratify__first_order_check_goals_9_0, 10,3,4)
MR_decl_label7(check_hlds__stratify__first_order_check_scc_2_7_0, 14,3,4,5,6,7,8)
MR_decl_label6(check_hlds__stratify__first_order_check_sccs_7_0, 33,3,5,6,4,11)
...
MR_decl_static(check_hlds__stratify__first_order_check_goal_9_0)
MR_decl_static(check_hlds__stratify__first_order_check_goals_9_0)
MR_decl_static(check_hlds__stratify__first_order_check_cases_9_0)
...
MR_BEGIN_MODULE(check_hlds__stratify_module0)
	...
	MR_init_label5(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,15,3,4,6,7)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0,7)
	...
	MR_GOTO_LAB(check_hlds__stratify__dep_sets_to_lists_and_sets_3_0_i15);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module1)
	...
	MR_init_label7(check_hlds__stratify__emit_message_8_0,2,8,9,11,36,44,45)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__emit_message_8_0,9)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(check_hlds__stratify__emit_message_8_0_i11);
	}
	{
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__stratify__emit_message_8_0_i36);
MR_def_label(check_hlds__stratify__emit_message_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		check_hlds__stratify__emit_message_8_0_i36);
MR_def_label(check_hlds__stratify__emit_message_8_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		check_hlds__stratify__emit_message_8_0_i44);
MR_def_label(check_hlds__stratify__emit_message_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(parse_tree__error_util__write_error_spec_8_0,
		check_hlds__stratify__emit_message_8_0_i45);
MR_def_label(check_hlds__stratify__emit_message_8_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(check_hlds__stratify_module3)
	MR_init_entry1(check_hlds__stratify__first_order_check_goal_9_0);
	MR_init_label8(check_hlds__stratify__first_order_check_goal_9_0,92,24,29,26,27,58,3,8)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_9_0,10,5,6,13,15,18,19,20)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_9_0,22,34,35,40,46,48,42,43)
	MR_init_label1(check_hlds__stratify__first_order_check_goal_9_0,52)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__stratify__first_order_check_goal_9_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = MR_ctfield(0, MR_r1, 0);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r8),
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i24) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i58));
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i27);
	}
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__stratify__first_order_check_goal_9_0_i29);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i26);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__stratify__first_order_check_goal_9_0_i10);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r6 = MR_sv(2);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r6;
	MR_decr_sp_and_return(7);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r8, 0),
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i13) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i15) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i52) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i22) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i34) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i18) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i40));
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i6);
	}
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__stratify__first_order_check_goal_9_0_i8);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i5);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__stratify__first_order_check_goal_9_0_i10);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r6 = MR_sv(2);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r6;
	MR_decr_sp_and_return(7);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r8, 2);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(check_hlds__stratify__first_order_check_goals_9_0);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r8, 1);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(check_hlds__stratify__first_order_check_goals_9_0);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_goal_9_0_i19);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_goal_9_0_i20);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r6 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i92);
	}
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r8, 1);
	MR_r2 = (MR_Integer) 1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i92);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r8;
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i35);
	}
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r9;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i92);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i42);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i48);
	}
	}
	MR_np_call_localret_ent(fn__check_hlds__stratify__this_file_0_0,
		check_hlds__stratify__first_order_check_goal_9_0_i46);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("first_order_check_goal: bi_implication", 38);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(2, MR_r9, 2);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i92);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_goal_9_0_i43);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r8, 3);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(check_hlds__stratify__first_order_check_cases_9_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__stratify_module4)
	MR_init_entry1(check_hlds__stratify__first_order_check_goals_9_0);
	MR_init_label3(check_hlds__stratify__first_order_check_goals_9_0,10,3,4)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__stratify__first_order_check_goals_9_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_goals_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goals_9_0_i3);
	}
	MR_r1 = MR_r6;
	MR_decr_sp_and_return(6);
MR_def_label(check_hlds__stratify__first_order_check_goals_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_call_localret_ent(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_goals_9_0_i4);
MR_def_label(check_hlds__stratify__first_order_check_goals_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goals_9_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module5)
	MR_init_entry1(check_hlds__stratify__first_order_check_cases_9_0);
	MR_init_label3(check_hlds__stratify__first_order_check_cases_9_0,10,3,4)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__stratify__first_order_check_cases_9_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_cases_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_cases_9_0_i3);
	}
	MR_r1 = MR_r6;
	MR_decr_sp_and_return(6);
MR_def_label(check_hlds__stratify__first_order_check_cases_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_call_localret_ent(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_cases_9_0_i4);
MR_def_label(check_hlds__stratify__first_order_check_cases_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r6 = MR_tempr1;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_cases_9_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module6)
	...
	MR_init_label7(check_hlds__stratify__first_order_check_scc_2_7_0,14,3,4,5,6,7,8)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__stratify__first_order_check_scc_2_7_0)
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_scc_2_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__stratify__first_order_check_scc_2_7_0,8)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_scc_2_7_0_i14);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__stratify_module7)
	...
	MR_init_label6(check_hlds__stratify__first_order_check_sccs_7_0,33,3,5,6,4,11)
MR_BEGIN_CODE
