            ...
            case (MR_Integer) 0:
              {
                ...
                succeeded = ((MR_tag((MR_Word) ConsId_32)) == (MR_Integer) 1);
                if (succeeded)
                {
                  ShroudedPredProcId_38 = (MR_Word) (MR_body((MR_Word) (ConsId_32), (MR_Integer) 1));
                  {
            ...
            case (MR_Integer) 0:
              {
                ...
                succeeded = ((MR_tag((MR_Word) ConsId_25)) == (MR_Integer) 1);
                if (succeeded)
                {
                  ShroudedPredProcId_31 = (MR_Word) (MR_body((MR_Word) (ConsId_25), (MR_Integer) 1));
                  {
