...
MR_decl_label8(check_hlds__stratify__first_order_check_goal_9_0, 71,24,29,26,27,49,3,8)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_9_0, 10,5,6,13,15,18,19,20)
MR_decl_label7(check_hlds__stratify__first_order_check_goal_9_0, 22,34,36,39,38,41,43)
...
MR_BEGIN_MODULE(check_hlds__stratify_module3)
	...
	MR_init_label8(check_hlds__stratify__first_order_check_goal_9_0,71,24,29,26,27,49,3,8)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_9_0,10,5,6,13,15,18,19,20)
	MR_init_label7(check_hlds__stratify__first_order_check_goal_9_0,22,34,36,39,38,41,43)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__stratify__first_order_check_goal_9_0)
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r8),
		...
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i49));
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,27)
	...
	MR_r1 = MR_r6;
	MR_decr_sp_and_return(7);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r8, 0),
		...
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i43) MR_AND
		...
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_9_0_i36));
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,20)
	...
	MR_r6 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i71);
	}
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,34)
	...
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i71);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(3, MR_r8, 1);
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_9_0_i38);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_9_0,
		check_hlds__stratify__first_order_check_goal_9_0_i39);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__check_hlds__stratify__this_file_0_0,
		check_hlds__stratify__first_order_check_goal_9_0_i41);
MR_def_label(check_hlds__stratify__first_order_check_goal_9_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
