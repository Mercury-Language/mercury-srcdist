            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_15, (MR_Integer) 0)));

                check_hlds__stratify__get_called_procs_3_p_0(LambdaGoal_27, (MR_Word) ((MR_Integer) 0), &CalledProcs_28);
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_9, (MR_Integer) 0)));
...
{
  {
    ...
    check_hlds__stratify__first_order_check_sccs_6_p_0(FOSCCs_7, MustBeStratifiedPreds_10, Warn_9, *STATE_VARIABLE_ModuleInfo_12, (MR_Word) ((MR_Integer) 0), Specs_5);
  }
}
