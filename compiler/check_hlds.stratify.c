  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word HOCalls_26 = ((MR_Word) ((MR_hl_field(0, HigherOrderInfo_25, 0))));
        MR_Word HOLoops_28;
  ...
  MR_Word * STATE_VARIABLE_Specs_67)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr_16)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word CPred_99 = ((MR_Word) ((MR_hl_field(2, GoalExpr_16, 0))));
          MR_Integer CProc_100 = ((MR_Integer) ((MR_hl_field(2, GoalExpr_16, 1))));
          MR_Word Callee_101;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_16, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_90 = ((MR_Word) ((MR_hl_field(3, GoalExpr_16, 1))));
