  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 23, &Warn_23);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 23, &Warn_9);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_19, 1) = ((MR_Box) (Var_53));
    }
    {
