  ...
  MR_Word ErrorOrWarning_11)
{
  ...
  ProcColonPieces_13 = hlds__hlds_error_util__describe_one_proc_name_mode_6_f_0(ModuleInfo_7, (MR_Integer) 0, (MR_Word) (MR_mkword(1, &check_hlds__stratify_scalar_common_3[0])), (MR_Integer) 1, (MR_Word) (MR_mkword(1, &check_hlds__stratify_scalar_common_1[2])), PPId_8);
