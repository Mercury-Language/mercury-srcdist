  ...
  MR_Word ErrorOrWarning_11)
{
  ...
  Var_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PPIdDescription_13, (MR_Word) (MR_mkword(1, &check_hlds__stratify_scalar_common_1[5])));
  Preamble_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(1, &check_hlds__stratify_scalar_common_1[2])), Var_26);
