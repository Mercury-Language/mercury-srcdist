...
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 94,25,30,32,33,27,28,60,3,8)
MR_decl_label10(check_hlds__stratify__first_order_check_goal_8_0, 10,11,5,6,14,16,19,20,21,23)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 36,37,42,47,48,44,45,54)
...
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,20)
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,3,7);
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(check_hlds__stratify_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__stratify__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__stratify_module3)
	...
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,94,25,30,32,33,27,28,60,3,8)
	MR_init_label10(check_hlds__stratify__first_order_check_goal_8_0,10,11,5,6,14,16,19,20,21,23)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,36,37,42,47,48,44,45,54)
MR_BEGIN_CODE
