...
{
  {
    ...
    if (check_hlds__stratify__succeeded)
      *check_hlds__stratify__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word check_hlds__stratify__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__stratify__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word check_hlds__stratify__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word check_hlds__stratify__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word check_hlds__stratify__Var_8;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__stratify_scalar_common_1[0], &check_hlds__stratify__Var_8, ((MR_Box) (check_hlds__stratify__Var_4)), ((MR_Box) (check_hlds__stratify__Var_6)));
        }
        ...
        if (check_hlds__stratify__succeeded)
          *check_hlds__stratify__HeadVar__1_1 = check_hlds__stratify__Var_8;
          ...
          {
            MR_Integer check_hlds__stratify__Var_13 = (MR_Integer) check_hlds__stratify__Var_5;
            MR_Integer check_hlds__stratify__Var_14 = (MR_Integer) check_hlds__stratify__Var_7;
...
{
  {
    ...
    if (check_hlds__stratify__succeeded)
      ...
      {
        MR_Word check_hlds__stratify__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word check_hlds__stratify__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word check_hlds__stratify__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__stratify__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__stratify__HeadVar__2_2, (MR_Integer) 1)));

        {
          check_hlds__stratify__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &check_hlds__stratify_scalar_common_1[0], ((MR_Box) (check_hlds__stratify__Var_3)), ((MR_Box) (check_hlds__stratify__Var_5)));
        }
        if (check_hlds__stratify__succeeded)
          check_hlds__stratify__succeeded = (check_hlds__stratify__Var_4 == check_hlds__stratify__Var_6);
      }
    return check_hlds__stratify__succeeded;
  }
}
