...
MR_decl_label8(check_hlds__stratify__check_stratification_4_0, 2,3,4,5,6,7,8,9)
MR_decl_label1(check_hlds__stratify__check_stratification_4_0, 10)
...
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 94,25,30,32,33,27,28,60)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 3,8,10,11,5,6,14,16)
MR_decl_label8(check_hlds__stratify__first_order_check_goal_8_0, 19,20,21,23,36,37,42,47)
MR_decl_label4(check_hlds__stratify__first_order_check_goal_8_0, 48,44,45,54)
...
MR_decl_label6(check_hlds__stratify__first_order_check_sccs_6_0, 33,3,5,6,4,11)
MR_decl_label5(fn__check_hlds__stratify__generate_stratify_error_5_0, 2,8,9,11,36)
...
MR_BEGIN_MODULE(check_hlds__stratify_module1)
	...
	MR_init_label5(fn__check_hlds__stratify__generate_stratify_error_5_0,2,8,9,11,36)
MR_BEGIN_CODE
...
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,9)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i36);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,11)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__stratify__generate_stratify_error_5_0_i36);
MR_def_label(fn__check_hlds__stratify__generate_stratify_error_5_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_tbmkword(0, 12);
...
MR_BEGIN_MODULE(check_hlds__stratify_module3)
	...
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,94,25,30,32,33,27,28,60)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,3,8,10,11,5,6,14,16)
	MR_init_label8(check_hlds__stratify__first_order_check_goal_8_0,19,20,21,23,36,37,42,47)
	MR_init_label4(check_hlds__stratify__first_order_check_goal_8_0,48,44,45,54)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = MR_ctfield(0, MR_r1, 0);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r8),
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i25) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i60));
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,25)
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__stratify__first_order_check_goal_8_0_i30);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__stratify__first_order_check_goal_8_0_i32);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,32)
	...
	MR_np_call_localret_ent(fn__check_hlds__stratify__generate_stratify_error_5_0,
		check_hlds__stratify__first_order_check_goal_8_0_i33);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_sv(2);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,28)
	...
	MR_r1 = MR_r7;
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r8, 0),
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i14) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i16) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i54) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i23) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i36) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i19) MR_AND
		MR_LABEL_AP(check_hlds__stratify__first_order_check_goal_8_0_i42));
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,3)
	...
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i6);
	}
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
	MR_sv(5) = MR_r6;
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__stratify__first_order_check_goal_8_0_i8);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,10)
	...
	MR_np_call_localret_ent(fn__check_hlds__stratify__generate_stratify_error_5_0,
		check_hlds__stratify__first_order_check_goal_8_0_i11);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_sv(2);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r7;
	MR_decr_sp_and_return(8);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,19)
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_8_0,
		check_hlds__stratify__first_order_check_goal_8_0_i20);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,20)
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_8_0,
		check_hlds__stratify__first_order_check_goal_8_0_i21);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r7 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i94);
	}
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r8, 1);
	MR_r2 = (MR_Integer) 1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i94);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r8;
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,37)
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i94);
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__stratify__first_order_check_goal_8_0_i44);
	}
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_localcall_lab(check_hlds__stratify__first_order_check_goal_8_0,
		check_hlds__stratify__first_order_check_goal_8_0_i45);
...
MR_def_label(check_hlds__stratify__first_order_check_goal_8_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__stratify_module7)
	...
	MR_init_label6(check_hlds__stratify__first_order_check_sccs_6_0,33,3,5,6,4,11)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__stratify__first_order_check_sccs_6_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__stratify__first_order_check_sccs_6_0,6)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(check_hlds__stratify__first_order_check_sccs_6_0_i33);
...
MR_BEGIN_MODULE(check_hlds__stratify_module8)
	...
	MR_init_label8(check_hlds__stratify__check_stratification_4_0,2,3,4,5,6,7,8,9)
	MR_init_label1(check_hlds__stratify__check_stratification_4_0,10)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__stratify_module21)
