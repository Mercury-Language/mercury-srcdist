...
MR_decl_label1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0, 1)
...
MR_decl_static(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0)
...
{
MR_COMMON(1,0),
MR_ENTRY_AP(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(hlds__make_tags_module9)
	MR_init_entry1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0);
	MR_init_label1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__assign_constructor_tags__180__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,11)) {
		MR_GOTO_LAB(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0_i1);
	}
	MR_r2 = MR_tfield(3, MR_r1, 1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__180__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
