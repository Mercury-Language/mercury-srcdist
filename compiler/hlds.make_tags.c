            ...
            if (hlds__make_tags__succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), hlds__make_tags__V_28_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
          ...
          *hlds__make_tags__STATE_VARIABLE_CtorTags_7 = hlds__make_tags__STATE_VARIABLE_CtorTags_0_6;
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_tags__V_33_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                    ...
                    if (hlds__make_tags__succeeded)
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), hlds__make_tags__V_39_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
