...
#line 648 "make_tags.m"
                  case (MR_Integer) 0:
#line 1117 "hlds.make_tags.c"
                    *hlds__make_tags__HeadVar__1_1 = (MR_Integer) 2;
#line 648 "make_tags.m"
                    break;
#line 648 "make_tags.m"
                  case (MR_Integer) 1:
#line 1123 "hlds.make_tags.c"
                    *hlds__make_tags__HeadVar__1_1 = (MR_Integer) 2;
#line 648 "make_tags.m"
                    break;
#line 648 "make_tags.m"
                  case (MR_Integer) 2:
#line 1129 "hlds.make_tags.c"
                    *hlds__make_tags__HeadVar__1_1 = (MR_Integer) 1;
#line 648 "make_tags.m"
                    break;
#line 648 "make_tags.m"
...
#line 1272 "hlds.make_tags.c"
                {
#line 1274 "hlds.make_tags.c"
...
#line 678 "make_tags.m"
                          switch (MR_tag((MR_Word) hlds__make_tags__TypeStatus_8)) {
#line 678 "make_tags.m"
                            default: /*NOTREACHED*/ MR_assert(0);
#line 678 "make_tags.m"
                            case (MR_Integer) 0:
#line 678 "make_tags.m"
#line 678 "make_tags.m"
                              switch (MR_unmkbody(hlds__make_tags__TypeStatus_8)) {
#line 678 "make_tags.m"
                                default: /*NOTREACHED*/ MR_assert(0);
#line 678 "make_tags.m"
                                case (MR_Integer) 0:
...
#line 692 "make_tags.m"
                                  switch (MR_tag((MR_Word) hlds__make_tags__ArgCond_24)) {
#line 692 "make_tags.m"
                                    default:
#line 692 "make_tags.m"
...
#line 692 "make_tags.m"
#line 692 "make_tags.m"
                                      switch (MR_unmkbody(hlds__make_tags__ArgCond_24)) {
#line 692 "make_tags.m"
                                        default:
#line 692 "make_tags.m"
                                          hlds__make_tags__succeeded = MR_FALSE;
...
#line 567 "make_tags.m"
    switch (MR_tag((MR_Word) hlds__make_tags__Body_17)) {
#line 567 "make_tags.m"
      default: /*NOTREACHED*/ MR_assert(0);
#line 567 "make_tags.m"
      case (MR_Integer) 0:
...
#line 550 "make_tags.m"
                  switch (hlds__make_tags__DebugTypeRep_11) {
#line 550 "make_tags.m"
                    default: /*NOTREACHED*/ MR_assert(0);
#line 550 "make_tags.m"
                    case (MR_Integer) 0:
...
#line 567 "make_tags.m"
#line 567 "make_tags.m"
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__make_tags__Body_17, (MR_Integer) 0)))) {
#line 567 "make_tags.m"
          default: /*NOTREACHED*/ MR_assert(0);
#line 567 "make_tags.m"
          case (MR_Integer) 0:
...
#line 435 "make_tags.m"
          {
#line 435 "make_tags.m"
            libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 213, &hlds__make_tags__TermSizeWords_8);
          }
#line 437 "make_tags.m"
          {
#line 437 "make_tags.m"
            libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 214, &hlds__make_tags__TermSizeCells_9);
          }
...
#line 446 "make_tags.m"
              {
#line 446 "make_tags.m"
                libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 238, &hlds__make_tags__NumTagBits_13);
              }
...
#line 122 "make_tags.m"
    {
#line 122 "make_tags.m"
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 238, &hlds__make_tags__NumTagBits_17);
    }
#line 123 "make_tags.m"
    {
#line 123 "make_tags.m"
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 239, &hlds__make_tags__NumReservedAddresses_18);
    }
#line 125 "make_tags.m"
    {
#line 125 "make_tags.m"
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 240, &hlds__make_tags__NumReservedObjects_19);
    }
#line 127 "make_tags.m"
    {
#line 127 "make_tags.m"
      libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 255, &hlds__make_tags__HighLevelCode_20);
    }
...
#line 144 "make_tags.m"
    {
#line 144 "make_tags.m"
      hlds__make_tags__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__make_tags__Globals_13, (MR_Integer) 245, (MR_Integer) 1);
    }
#line 144 "make_tags.m"
    if (hlds__make_tags__succeeded)
#line 144 "make_tags.m"
...
#line 5246 "hlds.make_tags.c"
        if (hlds__make_tags__succeeded)
#line 5248 "hlds.make_tags.c"
          {
#line 5250 "hlds.make_tags.c"
            MR_Word hlds__make_tags__Name_103;
#line 5252 "hlds.make_tags.c"
            MR_Integer hlds__make_tags__Arity_105;
#line 5254 "hlds.make_tags.c"
            MR_Word hlds__make_tags__ConsId_107;
#line 5256 "hlds.make_tags.c"
...
#line 5314 "hlds.make_tags.c"
          }
#line 5316 "hlds.make_tags.c"
        else
#line 5318 "hlds.make_tags.c"
          {
