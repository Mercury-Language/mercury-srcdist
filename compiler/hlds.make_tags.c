      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 217, &hlds__make_tags__TermSizeWords_8);
          }
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 218, &hlds__make_tags__TermSizeCells_9);
          }
          ...
          if (hlds__make_tags__succeeded)
            {
              ...
              {
                libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 242, &hlds__make_tags__NumTagBits_13);
              }
              {
                libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_6, (MR_Integer) 89, &hlds__make_tags__DebugTypeRep_14);
              }
              {
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 242, &hlds__make_tags__NumTagBits_17);
    }
    {
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 243, &hlds__make_tags__NumReservedAddresses_18);
    }
    {
      libs__globals__lookup_int_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 244, &hlds__make_tags__NumReservedObjects_19);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_tags__Globals_13, (MR_Integer) 258, &hlds__make_tags__HighLevelCode_20);
    }
    ...
    {
      hlds__make_tags__succeeded = libs__globals__lookup_bool_option_3_p_1(hlds__make_tags__Globals_13, (MR_Integer) 249, (MR_Integer) 1);
    }
    if (hlds__make_tags__succeeded)
      {
        {
