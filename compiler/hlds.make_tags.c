          ...
          if (hlds__make_tags__succeeded)
            {
                ...
                }
              {
                ...
                MR_hl_field(MR_mktag(0), hlds__make_tags__Var_64, 0) = ((MR_Box) (&hlds__make_tags_scalar_common_4[0]));
              ...
              if ((hlds__make_tags__DirectArgFunctors_39 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                *hlds__make_tags__STATE_VARIABLE_TypeTable_60 = hlds__make_tags__STATE_VARIABLE_TypeTable_0_59;
              else
                {
                  ...
                  {
                    hlds__make_tags__DirectArgFunctorNames_51 = mercury__list__map_2_f_0(hlds__make_tags__TypeCtorInfo_82_82, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_and_arity_0, (MR_Word) &hlds__make_tags_scalar_common_3[1], hlds__make_tags__DirectArgFunctors_39);
                  }
