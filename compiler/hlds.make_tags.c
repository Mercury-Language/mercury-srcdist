...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 267, &HighLevelCode_20);
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_13, (MR_Integer) 258, (MR_Integer) 1);
    if (succeeded)
    {
