...
MR_decl_label5(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0, 39,3,5,7,4)
...
MR_BEGIN_MODULE(hlds__make_tags_module12)
	...
	MR_init_label5(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0,39,3,5,7,4)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0,7)
	...
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(hlds__make_tags__check_incorrect_direct_arg_assertions_4_0_i39);
	}
