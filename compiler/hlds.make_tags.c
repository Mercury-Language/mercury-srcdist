...
{
  {
    MR_bool hlds__make_tags__succeeded = ((((MR_tag((MR_Word) hlds__make_tags__HeadVar__1_1)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__make_tags__HeadVar__1_1, (MR_Integer) 0)))) == (MR_Integer) 16)));
            ...
            if (hlds__make_tags__succeeded)
            ...
            else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
    ...
    else
      {
        ...
        *hlds__make_tags__NextTag_10 = (hlds__make_tags__InitTag_9 + (MR_Integer) 1);
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
                ...
                if ((hlds__make_tags__Constants_66 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_160, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
          ...
          *hlds__make_tags__STATE_VARIABLE_CtorTags_6 = hlds__make_tags__STATE_VARIABLE_CtorTags_0_5;
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_26, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
            ...
            if (hlds__make_tags__succeeded)
              {
                ...
                if ((hlds__make_tags__ReservedAddresses_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_29, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
                    ...
                    if (hlds__make_tags__succeeded)
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), hlds__make_tags__Var_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
                        ...
                        if ((hlds__make_tags__ReservedAddresses_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                        ...
                        else
                          {
                            ...
                            MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_47, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
          ...
          *hlds__make_tags__STATE_VARIABLE_CtorTags_7 = hlds__make_tags__STATE_VARIABLE_CtorTags_0_6;
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_tags__Var_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
        ...
        else
          {
            ...
            if (hlds__make_tags__succeeded)
            ...
            else
              {
                ...
                {
                  hlds__make_tags__Tag_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 16));
                ...
                if (hlds__make_tags__succeeded)
                ...
                else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__make_tags__Tag_34, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 16));
