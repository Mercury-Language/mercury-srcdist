...
MR_def_label(hlds__make_tags__convert_direct_arg_functors_if_suitable_7_0,43)
	...
	MR_tfield(1, MR_r1, 2) = MR_sv(15);
	MR_tfield(1, MR_r1, 3) = MR_sv(4);
	MR_tfield(1, MR_r1, 4) = MR_sv(5);
	MR_tfield(1, MR_r1, 5) = MR_tempr1;
	MR_tfield(1, MR_r1, 6) = ((MR_Integer) MR_sv(6) | ((MR_Integer) MR_sv(7) << (MR_Integer) 1));
	MR_tfield(1, MR_r1, 7) = MR_sv(8);
	MR_r2 = MR_sv(2);
	}
...
MR_def_label(hlds__make_tags__is_direct_arg_ctor_5_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!((((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 3)) || ((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 7))))) {
