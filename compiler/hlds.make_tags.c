...
MR_decl_label8(hlds__make_tags__assign_constructor_tags_8_0, 18,20,15,21,9,25,28,29)
MR_decl_label8(hlds__make_tags__assign_constructor_tags_8_0, 24,34,33,36,37,67,39,41)
MR_decl_label8(hlds__make_tags__assign_constructor_tags_8_0, 42,44,45,31,46,47,49,50)
MR_decl_label3(hlds__make_tags__assign_constructor_tags_8_0, 52,53,54)
MR_decl_label4(hlds__make_tags__assign_enum_constants_4_0, 12,3,4,6)
MR_decl_label6(hlds__make_tags__assign_reserved_numeric_addresses_8_0, 25,3,4,5,6,12)
MR_decl_label6(hlds__make_tags__assign_reserved_symbolic_addresses_9_0, 19,3,4,5,8,9)
MR_decl_label4(hlds__make_tags__assign_shared_local_tags_5_0, 12,3,4,6)
MR_decl_label5(hlds__make_tags__assign_shared_remote_tags_6_0, 18,3,4,7,9)
MR_decl_label8(hlds__make_tags__assign_unshared_tags_6_0, 52,3,4,9,5,12,17,19)
...
MR_decl_label1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0, 1)
...
MR_decl_static(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0)
...
{
MR_COMMON(1,0),
MR_ENTRY_AP(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(hlds__make_tags_module0)
	...
	MR_init_label4(hlds__make_tags__assign_enum_constants_4_0,12,3,4,6)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_enum_constants_4_0,4)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_enum_constants_4_0_i6);
MR_def_label(hlds__make_tags__assign_enum_constants_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_tags_module1)
	...
	MR_init_label6(hlds__make_tags__assign_reserved_numeric_addresses_8_0,25,3,4,5,6,12)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_reserved_numeric_addresses_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__make_tags__assign_reserved_numeric_addresses_8_0,5)
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_data, cons_tag);
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_reserved_numeric_addresses_8_0_i12);
MR_def_label(hlds__make_tags__assign_reserved_numeric_addresses_8_0,6)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_reserved_numeric_addresses_8_0_i12);
MR_def_label(hlds__make_tags__assign_reserved_numeric_addresses_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(hlds__make_tags__assign_reserved_numeric_addresses_8_0_i25);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_tags_module2)
	...
	MR_init_label6(hlds__make_tags__assign_reserved_symbolic_addresses_9_0,19,3,4,5,8,9)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_reserved_symbolic_addresses_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__make_tags__assign_reserved_symbolic_addresses_9_0,8)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_reserved_symbolic_addresses_9_0_i9);
MR_def_label(hlds__make_tags__assign_reserved_symbolic_addresses_9_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(hlds__make_tags__assign_reserved_symbolic_addresses_9_0_i19);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_tags_module3)
	...
	MR_init_label4(hlds__make_tags__assign_shared_local_tags_5_0,12,3,4,6)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_shared_local_tags_5_0,4)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_shared_local_tags_5_0_i6);
MR_def_label(hlds__make_tags__assign_shared_local_tags_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_tags_module4)
	...
	MR_init_label5(hlds__make_tags__assign_shared_remote_tags_6_0,18,3,4,7,9)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_shared_remote_tags_6_0,4)
	...
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(hlds__make_tags__assign_shared_remote_tags_6_0_i7);
	}
	MR_r5 = MR_sv(4);
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_shared_remote_tags_6_0_i9);
MR_def_label(hlds__make_tags__assign_shared_remote_tags_6_0,7)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_shared_remote_tags_6_0_i9);
MR_def_label(hlds__make_tags__assign_shared_remote_tags_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_tags_module5)
	...
	MR_init_label8(hlds__make_tags__assign_unshared_tags_6_0,52,3,4,9,5,12,17,19)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_unshared_tags_6_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__make_tags__assign_unshared_tags_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(2) != MR_sv(3))) {
		MR_GOTO_LAB(hlds__make_tags__assign_unshared_tags_6_0_i12);
	}
...
MR_def_label(hlds__make_tags__assign_unshared_tags_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(hlds__make_tags__assign_unshared_tags_6_0_i17);
	}
	MR_r5 = MR_sv(5);
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_unshared_tags_6_0_i19);
MR_def_label(hlds__make_tags__assign_unshared_tags_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_unshared_tags_6_0_i19);
MR_def_label(hlds__make_tags__assign_unshared_tags_6_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r5 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(hlds__make_tags__assign_unshared_tags_6_0_i52);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_tags_module8)
	...
	MR_init_label8(hlds__make_tags__assign_constructor_tags_8_0,18,20,15,21,9,25,28,29)
	MR_init_label8(hlds__make_tags__assign_constructor_tags_8_0,24,34,33,36,37,67,39,41)
	MR_init_label8(hlds__make_tags__assign_constructor_tags_8_0,42,44,45,31,46,47,49,50)
	MR_init_label3(hlds__make_tags__assign_constructor_tags_8_0,52,53,54)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,9)
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_ctor_should_be_notag_8_0,
		hlds__make_tags__assign_constructor_tags_8_0_i25);
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_tags__assign_constructor_tags_8_0_i24);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_util__make_cons_id_from_qualified_sym_name_2_0,
		hlds__make_tags__assign_constructor_tags_8_0_i28);
...
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,39)
	...
	MR_np_call_localret_ent(hlds__make_tags__assign_reserved_symbolic_addresses_9_0,
		hlds__make_tags__assign_constructor_tags_8_0_i67);
...
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,50)
	...
	MR_np_call_localret_ent(svmap__set_4_0,
		hlds__make_tags__assign_constructor_tags_8_0_i52);
MR_def_label(hlds__make_tags__assign_constructor_tags_8_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_tags_module9)
	MR_init_entry1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0);
	MR_init_label1(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,11)) {
		MR_GOTO_LAB(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0_i1);
	}
	MR_r2 = MR_ctfield(3, MR_r1, 1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(fn__hlds__make_tags__IntroducedFrom__func__assign_constructor_tags__186__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
