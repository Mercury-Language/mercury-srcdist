        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) hlds__make_tags__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word hlds__make_tags__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_tags__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    hlds__status____Compare____type_status_0_0(hlds__make_tags__HeadVar__1_1, hlds__make_tags__Var_15, hlds__make_tags__Var_9);
                  }
                }
                break;
            }
...
{
  {
    ...
    if (hlds__make_tags__succeeded)
      ...
      switch (MR_tag((MR_Word) hlds__make_tags__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word hlds__make_tags__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_tags__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word hlds__make_tags__Var_8;

            hlds__make_tags__succeeded = ((MR_tag((MR_Word) hlds__make_tags__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (hlds__make_tags__succeeded)
              {
                hlds__make_tags__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_tags__HeadVar__2_2, (MR_Integer) 0)));
                {
                  hlds__make_tags__succeeded = hlds__status____Unify____type_status_0_0(hlds__make_tags__Var_7, hlds__make_tags__Var_8);
                }
              }
          }
          break;
