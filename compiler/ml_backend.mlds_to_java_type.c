      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0))));

          Arity_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ElementType_14, (MR_Integer) 2))));
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_19)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForeignType_19, (MR_Integer) 0))));
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_18 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
              MR_Word Var_19;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_7, (MR_Integer) 1))));
  ...
  MR_String * DefaultValue_10)
{
  ...
  switch (MR_tag((MR_Word) ForeignLangType_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForeignLangType_6, (MR_Integer) 0))));
