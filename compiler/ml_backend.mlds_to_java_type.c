...
static void MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__386__1_3_p_0(
  MR_Word Info_4,
  MR_Word LambdaHeadVar__1_16,
  MR_String * LambdaHeadVar__2_17);

static MR_bool MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_java__366__1_2_p_0(
    ...
    switch (MR_tag((MR_Word) MLDS_Type_6)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_53 = ((MR_Word) ((MR_hl_field(0, ClassId_26, (MR_Integer) 0))));

          *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_53, Arity_27);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_9, Var_59);
                  if (succeeded)
                  {
                    ...
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                    ...
                    switch (MR_tag((MR_Word) CtorCat_10)) {
                      ...
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(CtorCat_10)) {
                          ...
                          case (MR_Integer) 2:
                            {
                              MR_Word TVar_62;
                              MR_Word TypeInfo_45_95;
                              MR_Word Var_68 = ((((MR_Unsigned) ((MR_hl_field(0, Info_5, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
                              MR_Word Var_69;
                              MR_Word Var_85 = ((MR_Word) ((MR_hl_field(0, Info_5, (MR_Integer) 6))));
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  TVar_62 = ((MR_Word) ((MR_hl_field(0, Type_9, (MR_Integer) 0))));
                                  Var_69 = ((MR_Word) ((MR_hl_field(0, Type_9, (MR_Integer) 1))));
                                  succeeded = (Var_69 == (MR_Word) ((MR_Unsigned) 0U));
                                  if (succeeded)
                                  {
                                    TypeInfo_45_95 = (MR_Word) (&ml_backend__mlds_to_java_type_scalar_common_1[0]);
                                    succeeded = mercury__list__member_2_p_0(TypeInfo_45_95, ((MR_Box) (TVar_62)), Var_85);
                                  }
                                }
                              }
                              if (succeeded)
                                *String_7 = ml_backend__mlds_to_target_util__generic_tvar_to_string_1_f_0(TVar_62);
                              else
                      ...
                      case (MR_Integer) 2:
                        {
                          ml_backend__mlds_to_java_type__mercury_user_type_to_string_and_dims_for_java_4_p_0(Info_5, Type_9, (MR_Integer) 3, String_7);
                          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                        }
                        break;
                      case (MR_Integer) 3:
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_22)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_40 = ((MR_Word) ((MR_hl_field(1, ForeignType_22, (MR_Integer) 0))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word ElementType_54 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word ArrayDims0_55;

              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, ElementType_54, String_7, &ArrayDims0_55);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 6:
            {
              MR_Word ArrayDims0_57;

              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_57);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(1, base, 1) = ((MR_Box) (ArrayDims0_57));
              }
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Word PointedToType_29 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word next_value_of_MLDS_Type_6 = PointedToType_29;
          ...
          case (MR_Integer) 8:
            {
              ...
              backend_libs__rtti__rtti_id_maybe_element_java_type_3_p_0(RttiIdMaybeElement_33, String_7, &IsArray_34);
              switch (IsArray_34) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
          ...
          case (MR_Integer) 9:
            {
              ...
              backend_libs__rtti__tabling_id_java_type_3_p_0(TablingId_35, String_7, &IsArray_58);
              switch (IsArray_58) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__386__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_java__366__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
