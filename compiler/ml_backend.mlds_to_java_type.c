...
static void MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__421__1_3_p_0(
  MR_Word Info_4,
  MR_Word LambdaHeadVar__1_16,
  MR_String * LambdaHeadVar__2_17);

static MR_bool MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_enum_type_to_string_and_dims_for_java__401__1_2_p_0(
  MR_Word ArrayDims_15,
  MR_Word HeadVar__2_21);

static MR_bool MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_java__380__1_2_p_0(
  MR_Word ArrayDims_15,
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_61 = ((MR_Word) ((MR_hl_field(0, ClassId_26, (MR_Integer) 0))));

          *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_61, Arity_27);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Word ModuleName_30 = ((MR_Word) ((MR_hl_field(0, EnumClassId_29, (MR_Integer) 0))));
          MR_String Name_62 = ((MR_String) ((MR_hl_field(0, EnumClassId_29, (MR_Integer) 1))));
          MR_Integer Arity_63 = ((MR_Integer) ((MR_hl_field(0, EnumClassId_29, (MR_Integer) 2))));

          *String_7 = ml_backend__mlds_to_java_name__qual_nrt_name_to_string_for_java_3_f_0(ModuleName_30, Name_62, Arity_63);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word EnvId_31 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_String Name_64 = ((MR_String) ((MR_hl_field(0, EnvId_31, (MR_Integer) 1))));
              MR_Word ModuleName_65 = ((MR_Word) ((MR_hl_field(0, EnvId_31, (MR_Integer) 0))));
          ...
          case (MR_Integer) 1:
            {
              MR_Word StructId_32 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_String Name_66 = ((MR_String) ((MR_hl_field(0, StructId_32, (MR_Integer) 1))));
              MR_Word ModuleName_67 = ((MR_Word) ((MR_hl_field(0, StructId_32, (MR_Integer) 0))));

              *String_7 = ml_backend__mlds_to_java_name__qual_nrt_name_to_string_for_java_3_f_0(ModuleName_67, Name_66, (MR_Integer) 0);
              *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_40 = CtorCat_10;

              succeeded = ml_backend__mlds_to_java_type__hand_defined_type_for_java_4_p_0(Type_9, Var_40, &StringPrime_11, &ArrayDimsPrime_12);
              if (succeeded)
              {
              ...
              else
              {
                ...
                else
                {
                  ...
                  Var_73 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_9, Var_73);
                  if (succeeded)
                  {
                  ...
                  {
                    MR_Word Var_41 = (MR_Word) (CtorCat_10);

                    ml_backend__mlds_to_java_type__mercury_type_to_string_for_java_5_p_0(Info_5, Type_9, Var_41, String_7, ArrayDims_8);
                  }
                }
              }
            }
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                Var_42 = ((MR_Word) ((MR_hl_field(3, ElementType_13, (MR_Integer) 2))));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_22)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_46 = ((MR_Word) ((MR_hl_field(1, ForeignType_22, (MR_Integer) 0))));

                    *String_7 = (MR_String) (Var_46);
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                  }
                  break;
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 8:
            {
              MR_Word ElementType_68 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word ArrayDims0_69;

              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, ElementType_68, String_7, &ArrayDims0_69);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 9:
            {
              ...
              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_71);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 10:
            {
              MR_Word PointedToType_33 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word next_value_of_MLDS_Type_6 = PointedToType_33;
          ...
          case (MR_Integer) 11:
            {
              MR_Word RttiIdMaybeElement_37 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_38;

              backend_libs__rtti__rtti_id_maybe_element_java_type_3_p_0(RttiIdMaybeElement_37, String_7, &IsArray_38);
              switch (IsArray_38) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
          ...
          case (MR_Integer) 12:
            {
              MR_Word TablingId_39 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_72;

              backend_libs__rtti__tabling_id_java_type_3_p_0(TablingId_39, String_7, &IsArray_72);
              switch (IsArray_72) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_enum_type_to_string_and_dims_for_java__401__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_java_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_java__380__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * ArrayDims_10)
{
  ...
  switch (MR_tag((MR_Word) CtorCat_8)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(CtorCat_8)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word TypeCtor_45;
            MR_Word ArgsTypes_46;
            MR_Word ClassName_47;
            MR_Integer ClassArity_48;
            MR_Word MLDS_Type_49;
            MR_String TypeName_50;
            MR_Word ArrayDims_51;
            MR_Word OutputGenerics_52;
            MR_Word Var_54;
            MR_Word Var_55;

            parse_tree__prog_type__type_to_ctor_and_args_det_3_p_0(Type_7, &TypeCtor_45, &ArgsTypes_46);
            ml_backend__ml_type_gen__ml_gen_class_name_3_p_0(TypeCtor_45, &ClassName_47, &ClassArity_48);
            {
              Var_54 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_54, 0) = ((MR_Box) (ClassName_47));
              MR_hl_field(0, Var_54, 1) = ((MR_Box) (ClassArity_48));
              MR_hl_field(0, Var_54, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            }
            MLDS_Type_49 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_54)));
            ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_6, MLDS_Type_49, &TypeName_50, &ArrayDims_51);
            {
              Var_55 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_55, 0) = ((MR_Box) (&ml_backend__mlds_to_java_type_scalar_common_6[0]));
              MR_hl_field(0, Var_55, 1) = ((MR_Box) (ml_backend__mlds_to_java_type__mercury_type_to_string_for_java_5_p_0_1));
              MR_hl_field(0, Var_55, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(0, Var_55, 3) = ((MR_Box) (ArrayDims_51));
              MR_hl_field(0, Var_55, 4) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            mercury__require__expect_3_p_0(Var_55, (MR_String) "predicate \140ml_backend.mlds_to_java_type.mercury_user_type_to_string_and_dims_for_java\'/4", (MR_String) "ArrayDims != []");
            OutputGenerics_52 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
            switch (OutputGenerics_52) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                *String_9 = TypeName_50;
                break;
              case (MR_Integer) 0:
                {
                  MR_String GenericsString_53;

                  ml_backend__mlds_to_java_type__generic_args_types_to_string_for_java_3_p_0(Info_6, ArgsTypes_46, &GenericsString_53);
                  *String_9 = mercury__string__f_43_43_2_f_0(TypeName_50, GenericsString_53);
                }
                break;
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word Var_19;
            MR_Word Var_34 = ((MR_Word) ((MR_hl_field(0, Info_6, (MR_Integer) 6))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_44_44 = (MR_Word) (&ml_backend__mlds_to_java_type_scalar_common_1[0]);
                  succeeded = mercury__list__member_2_p_0(TypeInfo_44_44, ((MR_Box) (TVar_12)), Var_34);
                }
              }
            }
            if (succeeded)
    ...
    case (MR_Integer) 2:
      {
        MR_Word TypeCtor_68;
        MR_Word ArgsTypes_69;
        MR_Word EnumModule_70;
        MR_String EnumName_71;
        MR_Integer EnumArity_72;
        MR_Word EnumId_73;
        MR_Word MLDS_Type_74;
        MR_String TypeName_75;
        MR_Word ArrayDims_76;
        MR_Word OutputGenerics_77;
        MR_Word Var_79;

        parse_tree__prog_type__type_to_ctor_and_args_det_3_p_0(Type_7, &TypeCtor_68, &ArgsTypes_69);
        ml_backend__ml_type_gen__ml_gen_type_name_4_p_0(TypeCtor_68, &EnumModule_70, &EnumName_71, &EnumArity_72);
        {
          EnumId_73 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, EnumId_73, 0) = ((MR_Box) (EnumModule_70));
          MR_hl_field(0, EnumId_73, 1) = ((MR_Box) (EnumName_71));
          MR_hl_field(0, EnumId_73, 2) = ((MR_Box) (EnumArity_72));
        }
        MLDS_Type_74 = (MR_Word) (MR_mkword(2, (MR_Word) (EnumId_73)));
        ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_6, MLDS_Type_74, &TypeName_75, &ArrayDims_76);
        {
          Var_79 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_79, 0) = ((MR_Box) (&ml_backend__mlds_to_java_type_scalar_common_6[0]));
          MR_hl_field(0, Var_79, 1) = ((MR_Box) (ml_backend__mlds_to_java_type__mercury_type_to_string_for_java_5_p_0_2));
          MR_hl_field(0, Var_79, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_79, 3) = ((MR_Box) (ArrayDims_76));
          MR_hl_field(0, Var_79, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__require__expect_3_p_0(Var_79, (MR_String) "predicate \140ml_backend.mlds_to_java_type.mercury_user_enum_type_to_string_and_dims_for_java\'/3", (MR_String) "ArrayDims != []");
        OutputGenerics_77 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
        switch (OutputGenerics_77) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            *String_9 = TypeName_75;
            break;
          case (MR_Integer) 0:
            {
              MR_String GenericsString_78;

              ml_backend__mlds_to_java_type__generic_args_types_to_string_for_java_3_p_0(Info_6, ArgsTypes_69, &GenericsString_78);
              *String_9 = mercury__string__f_43_43_2_f_0(TypeName_75, GenericsString_78);
            }
            break;
        }
        *ArrayDims_10 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__421__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  switch (MR_tag((MR_Word) MLDS_Type_5)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 7:
          {
            MR_Word ForeignLangType_33 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 1))));
