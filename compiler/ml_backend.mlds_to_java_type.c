  ...
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) MLDS_Type_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Arity_23;
          MR_Word Var_39 = (MR_Word) (MR_body((MR_Word) (MLDS_Type_6), (MR_Integer) 1));
          MR_Word Name_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_39, (MR_Integer) 0))));

          Arity_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_39, (MR_Integer) 1))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ElementType_14, (MR_Integer) 2))));
                ...
                if (succeeded)
                {
                  ...
                  ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_5, ElementType_14, String_7, &ArrayDims0_49);
                  {
                    ...
                    *ArrayDims_8 = base;
                    ...
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ArrayDims0_49));
                  }
                }
                else
                {
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_19)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForeignType_19, (MR_Integer) 0))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word Type_55 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
              ...
              ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_5, Type_55, String_7, &ArrayDims0_56);
              {
                ...
                *ArrayDims_8 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ArrayDims0_56));
              }
            }
            break;
          case (MR_Integer) 6:
          ...
          case (MR_Integer) 7:
            {
              MR_Word Type_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
          ...
          case (MR_Integer) 8:
            {
              MR_Word RttiIdMaybeElement_28 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_29;
          ...
          case (MR_Integer) 2:
            {
                ...
                ClassKind_51 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (ClassName_48));
                MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (ClassArity_49));
                MR_hl_field(MR_mktag(0), Var_56, 2) = (MR_Box) ((MR_Unsigned) (ClassKind_51));
              }
              MLDS_Type_52 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Var_56)));
              ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_6, MLDS_Type_52, &TypeString_53, ArrayDims_10);
              OutputGenerics_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo__45_45 = (MR_Word) (&ml_backend__mlds_to_java_type_scalar_common_1[0]);
                    succeeded = mercury__list__member_2_p_0(TypeInfo__45_45, ((MR_Box) (TVar_12)), Var_35);
                  }
                }
              }
              if (succeeded)
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__371__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  MR_String * DefaultValue_10)
{
  ...
  switch (MR_tag((MR_Word) ForeignLangType_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForeignLangType_6, (MR_Integer) 0))));

        JavaForeignType_11 = (MR_String) (Var_20);
      }
      break;
    case (MR_Integer) 2:
      mercury__require__unexpected_3_p_0((MR_String) "mlds_to_java_type.m", (MR_String) "predicate \140ml_backend.mlds_to_java_type.java_primitive_foreign_language_type\'/5", (MR_String) "foreign_type for C#");
