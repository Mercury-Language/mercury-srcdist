          ...
          case (MR_Integer) 2:
            {
              ...
              OutputGenerics_81 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
              MR_Word Var_22;
              MR_Word Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 6))));
              MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1)));
              MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_66, (MR_Integer) 0)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_12, (MR_Integer) 0)));
