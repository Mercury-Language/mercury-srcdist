      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_3_p_0(Name_53, Arity_27, String_7);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              if (succeeded)
                                ml_backend__mlds_to_target_util__generic_tvar_to_string_2_p_0(TVar_62, String_7);
                              else
