...
static void MR_CALL 
ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__371__1_3_p_0(
  MR_Word Info_4,
...
struct ml_backend__mlds_to_java_type__vector_common_type_6_0_s {
...
static /* final */ const struct ml_backend__mlds_to_java_type__vector_common_type_2_0_s ml_backend__mlds_to_java_type_vector_common_2[4] = {
  ...
  /* row   2 */
  {
    ...
    (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[1]))
  },
  /* row   3 */
  {
  ...
  MR_String * String_6)
{
  ...
  else
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), RevBrackets_12, &Brackets_13);
    {
      ...
      MR_hl_field(1, Var_15, 0) = ((MR_Box) (String0_10));
      MR_hl_field(1, Var_15, 1) = ((MR_Box) (Brackets_13));
    }
  ...
  MR_Word Type_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        CtorCat_8 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          RttiIdMaybeElement_9 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
          {
  ...
  MR_Word Stream_8)
{
  ...
  ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_6, MLDS_Type_7, &String_13, &ArrayDims_14);
    ...
    switch (MR_tag((MR_Word) MLDS_Type_6)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_53 = ((MR_Word) ((MR_hl_field(0, Var_40, (MR_Integer) 0))));

          Arity_23 = ((MR_Integer) ((MR_hl_field(0, Var_40, (MR_Integer) 1))));
          ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_3_p_0(Name_53, Arity_23, String_7);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_9, Var_60);
                  if (succeeded)
                  {
          ...
          case (MR_Integer) 1:
            {
              MR_Word ElementType_14 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word Var_31;

              succeeded = ((((MR_tag((MR_Word) ElementType_14)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ElementType_14, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                Var_31 = ((MR_Word) ((MR_hl_field(3, ElementType_14, (MR_Integer) 2))));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  MR_Word ArrayDims0_49;

                  ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_5, ElementType_14, String_7, &ArrayDims0_49);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *ArrayDims_8 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) ((MR_Integer) 0));
                    MR_hl_field(1, base, 1) = ((MR_Box) (ArrayDims0_49));
                  }
                }
                else
                {
                  *String_7 = (MR_String) "java.lang.Object";
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[1]));
                }
              }
            }
            break;
          ...
          case (MR_Integer) 3:
            {
              MR_Word IntType_13 = ((MR_Unsigned) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_19)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_35 = ((MR_Word) ((MR_hl_field(1, ForeignType_19, (MR_Integer) 0))));

                    *String_7 = (MR_String) (Var_35);
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                  }
                  break;
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 5:
            {
              MR_Word Type_55 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word ArrayDims0_56;

              ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_5, Type_55, String_7, &ArrayDims0_56);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(1, base, 1) = ((MR_Box) (ArrayDims0_56));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_58);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 7:
            {
              MR_Word Type_54 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word next_value_of_MLDS_Type_6 = Type_54;
          ...
          case (MR_Integer) 8:
            {
              MR_Word RttiIdMaybeElement_28 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_29;

              backend_libs__rtti__rtti_id_maybe_element_java_type_3_p_0(RttiIdMaybeElement_28, String_7, &IsArray_29);
              switch (IsArray_29) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[1]));
          ...
          case (MR_Integer) 9:
            {
              MR_Word TablingId_30 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_59;

              backend_libs__rtti__tabling_id_java_type_3_p_0(TablingId_30, String_7, &IsArray_59);
              switch (IsArray_59) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[1]));
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CtorCat_8)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              *ArrayDims_10 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[1]));
            }
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TypeCtor_46;
              MR_Word ArgsTypes_47;
              MR_Word ClassName_48;
              MR_Integer ClassArity_49;
              MR_Word ClassKind_51;
              MR_Word MLDS_Type_52;
              MR_String TypeString_53;
              MR_Word OutputGenerics_54;
              MR_Word Var_56;

              parse_tree__prog_type__type_to_ctor_and_args_det_3_p_0(Type_7, &TypeCtor_46, &ArgsTypes_47);
              ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_46, &ClassName_48, &ClassArity_49);
              succeeded = ((MR_tag((MR_Word) CtorCat_8)) == (MR_Integer) 2);
              if (succeeded)
                ClassKind_51 = (MR_Integer) 3;
              else
                ClassKind_51 = (MR_Integer) 0;
              {
                Var_56 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_56, 0) = ((MR_Box) (ClassName_48));
                MR_hl_field(0, Var_56, 1) = ((MR_Box) (ClassArity_49));
                MR_hl_field(0, Var_56, 2) = (MR_Box) ((MR_Unsigned) (ClassKind_51));
              }
              MLDS_Type_52 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_56)));
              ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_6, MLDS_Type_52, &TypeString_53, ArrayDims_10);
              OutputGenerics_54 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
              switch (OutputGenerics_54) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  *String_9 = TypeString_53;
                  break;
                case (MR_Integer) 0:
                  {
                    MR_String GenericsString_55;

                    ml_backend__mlds_to_java_type__generic_args_types_to_string_for_java_3_p_0(Info_6, ArgsTypes_47, &GenericsString_55);
                    *String_9 = mercury__string__f_43_43_2_f_0(TypeString_53, GenericsString_55);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_19;
              MR_Word Var_35 = ((MR_Word) ((MR_hl_field(0, Info_6, (MR_Integer) 6))));
          ...
          case (MR_Integer) 0:
            {
              // direct tailcall eliminated
              ;
              CtorCat_8 = (MR_Word) (MR_mkword(3, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
              continue;
            }
            break;
          case (MR_Integer) 1:
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_java_type__IntroducedFrom__pred__generic_args_types_to_string_for_java__371__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  switch (MR_tag((MR_Word) MLDS_Type_5)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word MerType_9 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 1))));
            MR_Word TypeCtorCat_10 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 2))));
        ...
        case (MR_Integer) 3:
          {
            MR_Word Var_59 = ((MR_Unsigned) ((MR_hl_field(3, MLDS_Type_5, (MR_Integer) 1))) & (MR_Integer) 15);
