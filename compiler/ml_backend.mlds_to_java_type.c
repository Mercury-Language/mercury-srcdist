      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_60 = ((MR_Word) ((MR_hl_field(0, ClassId_26, (MR_Integer) 0))));

          *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_60, Arity_27);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_String Name_61 = ((MR_String) ((MR_hl_field(0, EnumClassId_28, (MR_Integer) 1))));
          MR_Integer Arity_62 = ((MR_Integer) ((MR_hl_field(0, EnumClassId_28, (MR_Integer) 2))));

          *String_7 = ml_backend__mlds_to_java_name__qual_nrt_name_to_string_for_java_3_f_0(ModuleName_29, Name_61, Arity_62);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_String Name_63 = ((MR_String) ((MR_hl_field(0, EnvId_30, (MR_Integer) 1))));
              MR_Word ModuleName_64 = ((MR_Word) ((MR_hl_field(0, EnvId_30, (MR_Integer) 0))));

              *String_7 = ml_backend__mlds_to_java_name__qual_nrt_name_to_string_for_java_3_f_0(ModuleName_64, Name_63, (MR_Integer) 0);
              *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_String Name_65 = ((MR_String) ((MR_hl_field(0, StructId_31, (MR_Integer) 1))));
              MR_Word ModuleName_66 = ((MR_Word) ((MR_hl_field(0, StructId_31, (MR_Integer) 0))));

              *String_7 = ml_backend__mlds_to_java_name__qual_nrt_name_to_string_for_java_3_f_0(ModuleName_66, Name_65, (MR_Integer) 0);
              *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_39 = CtorCat_10;

              succeeded = ml_backend__mlds_to_java_type__hand_defined_type_for_java_4_p_0(Type_9, Var_39, &StringPrime_11, &ArrayDimsPrime_12);
              if (succeeded)
              {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    MR_Word Var_40 = (MR_Word) (CtorCat_10);

                    ml_backend__mlds_to_java_type__mercury_type_to_string_for_java_5_p_0(Info_5, Type_9, Var_40, String_7, ArrayDims_8);
                  }
                }
              }
            }
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                Var_41 = ((MR_Word) ((MR_hl_field(3, ElementType_13, (MR_Integer) 2))));
                succeeded = (Var_41 == (MR_Word) ((MR_Unsigned) 8U));
              }
              if (succeeded)
              {
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_22)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_45 = ((MR_Word) ((MR_hl_field(1, ForeignType_22, (MR_Integer) 0))));

                    *String_7 = (MR_String) (Var_45);
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                  }
                  break;
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 8:
            {
              MR_Word ElementType_67 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word ArrayDims0_68;

              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, ElementType_67, String_7, &ArrayDims0_68);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(1, base, 1) = ((MR_Box) (ArrayDims0_68));
              }
            }
            break;
          case (MR_Integer) 9:
            {
              ...
              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_70);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 12:
            {
              ...
              backend_libs__rtti__tabling_id_java_type_3_p_0(TablingId_38, String_7, &IsArray_71);
              switch (IsArray_71) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
