      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_56 = ((MR_Word) ((MR_hl_field(0, ClassId_26, (MR_Integer) 0))));

          *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_56, Arity_27);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Word Name_57 = ((MR_Word) ((MR_hl_field(0, EnumClassId_29, (MR_Integer) 0))));
          MR_Integer Arity_58 = ((MR_Integer) ((MR_hl_field(0, EnumClassId_29, (MR_Integer) 1))));

          *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_57, Arity_58);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_9, Var_65);
                  if (succeeded)
                  {
          ...
          case (MR_Integer) 5:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_22)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_42 = ((MR_Word) ((MR_hl_field(1, ForeignType_22, (MR_Integer) 0))));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word Name_59 = (MR_Word) (EnvId_30);

              *String_7 = ml_backend__mlds_to_java_name__qual_class_name_to_string_for_java_2_f_0(Name_59, (MR_Integer) 0);
              *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Word ElementType_60 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word ArrayDims0_61;

              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, ElementType_60, String_7, &ArrayDims0_61);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 8:
            {
              ...
              ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_63);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 9:
            {
              MR_Word PointedToType_31 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
              MR_Word next_value_of_MLDS_Type_6 = PointedToType_31;
          ...
          case (MR_Integer) 10:
            {
              ...
              backend_libs__rtti__rtti_id_maybe_element_java_type_3_p_0(RttiIdMaybeElement_35, String_7, &IsArray_36);
              switch (IsArray_36) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
          ...
          case (MR_Integer) 11:
            {
              ...
              backend_libs__rtti__tabling_id_java_type_3_p_0(TablingId_37, String_7, &IsArray_64);
              switch (IsArray_64) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *ArrayDims_8 = (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_java_type_scalar_common_1[2]));
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_45, &ClassName_47, &ClassArity_48);
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_68, &ClassName_70, &ClassArity_71);
        {
          Var_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_77, 0) = ((MR_Box) (ClassName_70));
          MR_hl_field(0, Var_77, 1) = ((MR_Box) (ClassArity_71));
        }
        MLDS_Type_72 = (MR_Word) (MR_mkword(2, (MR_Word) (Var_77)));
        ml_backend__mlds_to_java_type__type_to_string_and_dims_for_java_4_p_0(Info_6, MLDS_Type_72, &TypeName_73, &ArrayDims_74);
        {
          ...
          MR_hl_field(0, Var_78, 3) = ((MR_Box) (ArrayDims_74));
        ...
        OutputGenerics_75 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
        switch (OutputGenerics_75) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            *String_9 = TypeName_73;
            break;
          case (MR_Integer) 0:
            {
              MR_String GenericsString_76;

              ml_backend__mlds_to_java_type__generic_args_types_to_string_for_java_3_p_0(Info_6, ArgsTypes_69, &GenericsString_76);
              *String_9 = mercury__string__f_43_43_2_f_0(TypeName_73, GenericsString_76);
            }
            break;
        }
        *ArrayDims_10 = (MR_Word) ((MR_Unsigned) 0U);
