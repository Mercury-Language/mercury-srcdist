...
ml_backend.mlds_to_cs.optdate ml_backend.mlds_to_cs.trans_opt_date mlds_to_cs.err ml_backend.mlds_to_cs.c_date ml_backend.mlds_to_cs.java_date : mlds_to_cs.m \
	ml_backend.int0 \
	assoc_list.int \
	backend_libs.int \
	bool.int \
...
#   long deps
#   short deps
ml_backend.mlds_to_cs.optdate ml_backend.mlds_to_cs.trans_opt_date mlds_to_cs.err ml_backend.mlds_to_cs.c_date ml_backend.mlds_to_cs.java_date : \
		mlds_to_cs.m \
	\
		ml_backend.int0 \
	\
...
ml_backend.mlds_to_cs.pic_o ml_backend.mlds_to_cs.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ml_backend.mlds_to_cs.mh ml_backend.mlds_to_cs.mih : ml_backend.mlds_to_cs.c
...
ml_backend.mlds_to_cs.module_dep : jmercury/ml_backend__mlds_to_cs.java
else
ml_backend.mlds_to_cs.module_dep : ml_backend.mlds_to_cs.c
endif
...
ml_backend.mlds_to_cs.date ml_backend.mlds_to_cs.date0 \
	ml_backend.date : mlds_to_cs.m \
	ml_backend.int0 \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
...
#   long dep int3s
#   short dep int3s
ml_backend.mlds_to_cs.date ml_backend.mlds_to_cs.date0 ml_backend.date : \
		mlds_to_cs.m \
	\
		ml_backend.int0 \
	\
...
ml_backend.mlds_to_cs.date0 \
	ml_backend.date0 : mlds_to_cs.m \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
ml_backend.mlds_to_cs.date0 ml_backend.date0 : \
		mlds_to_cs.m \
	\
		assoc_list.int3 \
		backend_libs.int3 \
...
ml_backend.mlds_to_cs.int0 : ml_backend.mlds_to_cs.date0
	@:
ml_backend.mlds_to_cs.int : ml_backend.mlds_to_cs.date
	@:
ml_backend.mlds_to_cs.int2 : ml_backend.mlds_to_cs.date
	@:
ml_backend.mlds_to_cs.int3 : ml_backend.mlds_to_cs.date3
	@:
ml_backend.mlds_to_cs.opt : ml_backend.mlds_to_cs.optdate
	@:
ml_backend.mlds_to_cs.trans_opt : ml_backend.mlds_to_cs.trans_opt_date
	@:
...
ml_backend.mlds_to_cs.date0 : mlds_to_cs.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ml_backend.mlds_to_cs
ml_backend.mlds_to_cs.date : mlds_to_cs.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ml_backend.mlds_to_cs
ml_backend.mlds_to_cs.date3 : mlds_to_cs.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ml_backend.mlds_to_cs
ml_backend.mlds_to_cs.optdate : mlds_to_cs.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ml_backend.mlds_to_cs
ml_backend.mlds_to_cs.trans_opt_date : mlds_to_cs.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ml_backend.mlds_to_cs
ml_backend.mlds_to_cs.c_date : mlds_to_cs.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ml_backend.mlds_to_cs $(ERR_REDIRECT)
ml_backend.mlds_to_cs.java_date : mlds_to_cs.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ml_backend.mlds_to_cs $(ERR_REDIRECT)
