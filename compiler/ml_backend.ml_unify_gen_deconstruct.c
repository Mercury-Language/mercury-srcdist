  ...
  MR_Word * TakeAddrInfo_10)
{
  ...
  ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(Info_6, FieldType_13, &MLDS_FieldType_17);
  ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(Info_6, BoxedFieldType_16, &MLDS_BoxedFieldType_18);
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  switch (CanFail_17) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word TestRval_52;
        MR_Word SetTestResultStmt_53;
        MR_Word SucceededRval_54;
        MR_Word DetDeconstructStmts_55;
        MR_Word STATE_VARIABLE_Info_29_61;
        MR_Word STATE_VARIABLE_Info_30_62;
        MR_Word STATE_VARIABLE_Info_31_63;

        ExpectedCodeModel_24 = (MR_Integer) 1;
        ml_backend__ml_unify_gen_test__ml_generate_test_var_has_cons_id_5_p_0(LHSVar_13, ConsId_14, &TestRval_52, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_29_61);
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0(TestRval_52, Context_20, &SetTestResultStmt_53, STATE_VARIABLE_Info_29_61, &STATE_VARIABLE_Info_30_62);
        ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&SucceededRval_54, STATE_VARIABLE_Info_30_62, &STATE_VARIABLE_Info_31_63);
        ml_backend__ml_unify_gen_deconstruct__ml_generate_det_deconstruction_9_p_0(LHSVar_13, ConsId_14, RHSVars_15, ArgModes_16, Context_20, Defns_21, &DetDeconstructStmts_55, STATE_VARIABLE_Info_31_63, &STATE_VARIABLE_Info_34_34);
        if ((DetDeconstructStmts_55 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            UnifyStmts_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), UnifyStmts_25, 0) = ((MR_Box) (SetTestResultStmt_53));
            MR_hl_field(MR_mktag(1), UnifyStmts_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        else
        {
          MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DetDeconstructStmts_55, (MR_Integer) 1))));
          MR_Word Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DetDeconstructStmts_55, (MR_Integer) 0))));
          ...
          if ((Var_78 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            {
              IfStmt_60 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), IfStmt_60, 0) = ((MR_Box) (SucceededRval_54));
              MR_hl_field(MR_mktag(2), IfStmt_60, 1) = ((MR_Box) (Var_79));
              MR_hl_field(MR_mktag(2), IfStmt_60, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), IfStmt_60, 3) = ((MR_Box) (Context_20));
            }
            {
              Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (IfStmt_60));
              MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              UnifyStmts_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 0) = ((MR_Box) (SetTestResultStmt_53));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 1) = ((MR_Box) (Var_71));
            }
          }
          else
          {
            MR_Word DetDeconstructStmt_73;
            MR_Word IfStmt_74;
            MR_Word Var_76;

            DetDeconstructStmt_73 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), DetDeconstructStmts_55, Context_20);
            {
              IfStmt_74 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), IfStmt_74, 0) = ((MR_Box) (SucceededRval_54));
              MR_hl_field(MR_mktag(2), IfStmt_74, 1) = ((MR_Box) (DetDeconstructStmt_73));
              MR_hl_field(MR_mktag(2), IfStmt_74, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), IfStmt_74, 3) = ((MR_Box) (Context_20));
            }
            {
              Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (IfStmt_74));
              MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              UnifyStmts_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 0) = ((MR_Box) (SetTestResultStmt_53));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 1) = ((MR_Box) (Var_76));
            }
          }
        }
      }
        ...
        switch (MR_tag((MR_Word) ArgPosWidth_31)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Shift_61 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 3))));
                  MR_Word Mask_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 5))));
                  MR_Word Fill_64 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 6))) & (MR_Integer) 7);
                  MR_Integer ShiftInt_65 = (MR_Integer) (Shift_61);
                  MR_Integer MaskInt_66 = (MR_Integer) (Mask_63);
                  MR_Word LeftShiftedArgRval_67;
                  MR_Word Var_81;
                  MR_Unsigned Var_84;
                  MR_Unsigned Var_85;

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_81, 0) = ((MR_Box) (ArgLval_28));
                  }
                  LeftShiftedArgRval_67 = ml_backend__ml_unify_gen_util__ml_left_shift_rval_3_f_0(Var_81, Shift_61, Fill_64);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_ToOrRvals_37 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (LeftShiftedArgRval_67));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_ToOrRvals_0_36));
                  }
                  Var_85 = mercury__uint__cast_from_int_1_f_0(MaskInt_66);
                  Var_84 = mercury__uint__f_60_60_2_f_0(Var_85, ShiftInt_65);
                  *STATE_VARIABLE_ToOrMask_39 = (Var_84 | STATE_VARIABLE_ToOrMask_0_38);
                }
                break;
              case (MR_Integer) 2:
                {
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), UnsignedWordRval_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_deconstruct_scalar_common_1[6])));
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_unify_gen_deconstruct__ml_extract_subword_value_5_p_0(Var_54, Shift_32, Mask_34, Fill_35, &ToAssignRval_39);
