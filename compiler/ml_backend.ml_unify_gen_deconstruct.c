  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  switch (CanFail_17) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word TestRval_43;
        MR_Word SetTestResultStmt_44;
        MR_Word SucceededRval_45;
        MR_Word DetDeconstructStmts_46;
        MR_Word STATE_VARIABLE_Info_29_52;
        MR_Word STATE_VARIABLE_Info_30_53;
        MR_Word STATE_VARIABLE_Info_31_54;

        ExpectedCodeModel_24 = (MR_Integer) 1;
        ml_backend__ml_unify_gen_test__ml_generate_test_var_has_cons_id_5_p_0(LHSVar_13, ConsId_14, &TestRval_43, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_29_52);
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0(TestRval_43, Context_20, &SetTestResultStmt_44, STATE_VARIABLE_Info_29_52, &STATE_VARIABLE_Info_30_53);
        ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&SucceededRval_45, STATE_VARIABLE_Info_30_53, &STATE_VARIABLE_Info_31_54);
        ml_backend__ml_unify_gen_deconstruct__ml_generate_det_deconstruction_9_p_0(LHSVar_13, ConsId_14, RHSVars_15, ArgModes_16, Context_20, Defns_21, &DetDeconstructStmts_46, STATE_VARIABLE_Info_31_54, &STATE_VARIABLE_Info_35_35);
        if ((DetDeconstructStmts_46 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            UnifyStmts_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), UnifyStmts_25, 0) = ((MR_Box) (SetTestResultStmt_44));
            MR_hl_field(MR_mktag(1), UnifyStmts_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        else
        {
          MR_Word Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DetDeconstructStmts_46, (MR_Integer) 1))));
          MR_Word Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DetDeconstructStmts_46, (MR_Integer) 0))));
          ...
          if ((Var_68 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            {
              IfStmt_51 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), IfStmt_51, 0) = ((MR_Box) (SucceededRval_45));
              MR_hl_field(MR_mktag(2), IfStmt_51, 1) = ((MR_Box) (Var_69));
              MR_hl_field(MR_mktag(2), IfStmt_51, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), IfStmt_51, 3) = ((MR_Box) (Context_20));
            }
            {
              Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (IfStmt_51));
          ...
          else
          {
            ...
            DetDeconstructStmt_63 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), DetDeconstructStmts_46, Context_20);
            {
              IfStmt_64 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), IfStmt_64, 0) = ((MR_Box) (SucceededRval_45));
              MR_hl_field(MR_mktag(2), IfStmt_64, 1) = ((MR_Box) (DetDeconstructStmt_63));
              MR_hl_field(MR_mktag(2), IfStmt_64, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), IfStmt_64, 3) = ((MR_Box) (Context_20));
            }
            {
              Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (IfStmt_64));
              MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              UnifyStmts_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 0) = ((MR_Box) (SetTestResultStmt_44));
              MR_hl_field(MR_mktag(1), UnifyStmts_25, 1) = ((MR_Box) (Var_66));
            }
          }
        }
      }
        ...
        switch (MR_tag((MR_Word) ArgPosWidth_31)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Shift_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 3))));
                  MR_Word Mask_59 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 5))));
                  MR_Word Fill_60 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_31, (MR_Integer) 6))) & (MR_Integer) 7);
                  MR_Integer ShiftInt_61 = (MR_Integer) (Shift_57);
                  MR_Integer MaskInt_62 = (MR_Integer) (Mask_59);
                  MR_Word LeftShiftedArgRval_63;
                  MR_Word Var_79;
                  MR_Unsigned Var_80;
                  MR_Unsigned Var_81;

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_79, 0) = ((MR_Box) (ArgLval_28));
                  }
                  LeftShiftedArgRval_63 = ml_backend__ml_unify_gen_util__ml_left_shift_rval_3_f_0(Var_79, Shift_57, Fill_60);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_ToOrRvals_37 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (LeftShiftedArgRval_63));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_ToOrRvals_0_36));
                  }
                  Var_81 = mercury__uint__cast_from_int_1_f_0(MaskInt_62);
                  Var_80 = mercury__uint__f_60_60_2_f_0(Var_81, ShiftInt_61);
                  *STATE_VARIABLE_ToOrMask_39 = (Var_80 | STATE_VARIABLE_ToOrMask_0_38);
                }
                break;
              case (MR_Integer) 2:
                {
