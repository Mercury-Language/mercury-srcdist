...
hlds__make_hlds__superhomogeneous_lambda__IntroducedFrom__func__warn_about_any_inconsistent_inst_vars__893__1_2_f_0(
  MR_Word InstVarSet_6,
  MR_Word HeadVar__2_47);

static MR_Word MR_CALL 
hlds__make_hlds__superhomogeneous_lambda__IntroducedFrom__func__add_some_not_all_args_have_modes_error__454__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_UrInfo_41)
{
  ...
  else
  {
    ...
    hlds__make_hlds__state_var__add_unravel_warns_3_p_0(BodyGoalWarnSpecs_35, STATE_VARIABLE_UrInfo_1_45, &STATE_VARIABLE_UrInfo_2_47);
  }
  ...
  if (((MR_tag((MR_Word) MaybeLambdaHead_37)) == (MR_Integer) 0))
  {
    ...
    hlds__make_hlds__state_var__add_unravel_oom_errs_3_p_0(LambdaHeadSpecs_38, STATE_VARIABLE_UrInfo_3_48, &STATE_VARIABLE_UrInfo_4_49);
    hlds__make_hlds__state_var__record_unravel_found_syntax_error_2_p_0(STATE_VARIABLE_UrInfo_4_49, STATE_VARIABLE_UrInfo_41);
  ...
  MR_Word * STATE_VARIABLE_UrInfo_78)
{
  ...
  if (((MR_tag((MR_Word) MaybeDetism_28)) == (MR_Integer) 0))
  {
    ...
    hlds__make_hlds__state_var__add_unravel_oom_errs_3_p_0(DetismSpecs_35, STATE_VARIABLE_UrInfo_2_80, &STATE_VARIABLE_UrInfo_3_81);
  ...
  if (((MR_tag((MR_Word) MaybeBodyGoal_18)) == (MR_Integer) 0))
  {
    ...
    hlds__make_hlds__state_var__add_unravel_oom_errs_3_p_0(BodyGoalSpecs_37, STATE_VARIABLE_UrInfo_3_81, &STATE_VARIABLE_UrInfo_4_82);
  ...
  else
  {
    ...
    hlds__make_hlds__state_var__add_unravel_errs_3_p_0(ArgSpecs_38, STATE_VARIABLE_UrInfo_5_83, &STATE_VARIABLE_UrInfo_6_84);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_48 = hlds__make_hlds__superhomogeneous_lambda__IntroducedFrom__func__warn_about_any_inconsistent_inst_vars__893__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_UrInfo_17)
{
  ...
  else
  {
    ...
    hlds__make_hlds__state_var__add_unravel_err_3_p_0(Spec_15, STATE_VARIABLE_UrInfo_0_16, STATE_VARIABLE_UrInfo_17);
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_17 = hlds__make_hlds__superhomogeneous_lambda__IntroducedFrom__func__add_some_not_all_args_have_modes_error__454__1_1_f_0(((MR_Word) (wrapper_arg_1)));
