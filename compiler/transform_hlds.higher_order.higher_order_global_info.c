  ...
  MR_Word * Match_10)
{
  ...
  if (succeeded)
  {
    switch (FullOrPartial_37) {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            MatchCompleteness_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MatchCompleteness_11, 0) = ((MR_Box) (NumHOArgs_38));
          }
      ...
      case (MR_Integer) 1:
        {
          MatchCompleteness_11 = (MR_Word) ((MR_Unsigned) 0U);
          succeeded = MR_TRUE;
        }
        break;
    }
      ...
      if (succeeded)
      {
        ...
        Args_12 = mercury__list__f_43_43_2_f_0(TypeInfo_9_65, ExtraArgs_62, Args_63);
        {
          ...
          *Match_10 = base;
          ...
          MR_hl_field(0, base, 1) = ((MR_Box) (MatchCompleteness_11));
