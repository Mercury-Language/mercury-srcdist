      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_34, (MR_Integer) 11);
          succeeded = !(succeeded);
          if (succeeded)
          {
            Var_49 = (MR_Integer) 12;
            succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_34, Var_49);
            succeeded = !(succeeded);
            if (succeeded)
            {
              {
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    {
      Var_9 = (MR_Word) (MR_body((MR_Word) ((env_ptr)->transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__Var_10), (MR_Integer) 2));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((env).transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__succeeded)
        {
          ...
          if ((env).transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__succeeded)
            Var_53 = (MR_Word) (MR_body((MR_Word) (ConsIdR_18), (MR_Integer) 2));
          (env).transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__succeeded = !((env).transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__succeeded);
          if ((env).transform_hlds__higher_order__higher_order_global_info__higher_order_args_match_4_p_0_env_0__succeeded)
          {
