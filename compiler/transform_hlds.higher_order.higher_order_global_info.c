      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_30_30 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[7]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_30_30, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo_31_31 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[8]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_31_31, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
                  TypeInfo_32_32 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[9]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_25_25 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[7]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_25_25, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo_26_26 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[8]);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_28_28 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info_scalar_common_1[9]);
