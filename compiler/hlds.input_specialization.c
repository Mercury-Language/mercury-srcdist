  ...
  MR_Word * STATE_VARIABLE_PredInfo_22)
{
  while (MR_TRUE)
  {
    ...
    mercury__map__values_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable0_12, &ProcInfos0_13);
    ...
    Var_24 = mercury__map__init_0_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0));
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      *HeadVar__5_5 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), SpecProcInfos_27, TailProcInfos_21);
  ...
  MR_Word * SpecProcInfos_10)
{
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(OrigProcInfo_9, &OrigModes_13);
    {
    ...
    hlds__hlds_proc__proc_info_set_argmodes_3_p_0(HeadSpecModes_15, OrigProcInfo_9, &HeadSpecProcInfo_16);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_7)
{
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_8, PredIds_5, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_6)), &conv1_STATE_VARIABLE_ModuleInfo_7);
