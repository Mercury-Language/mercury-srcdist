  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_13)
{
  ...
  if (succeeded)
  {
    MR_Word PredInfo_11;
    MR_Word ArgTypes_16;
    MR_Word ArgsToSpec_17;

    hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_8, &ArgTypes_16);
    hlds__input_specialization__find_args_to_specialize_4_p_0(InModuleMap_10, (MR_Integer) 1, ArgTypes_16, &ArgsToSpec_17);
    if ((ArgsToSpec_17 == (MR_Word) ((MR_Unsigned) 0U)))
      PredInfo_11 = PredInfo0_8;
    else
    {
      MR_Word HeadArgToSpec_18 = ((MR_Word) ((MR_hl_field(1, ArgsToSpec_17, 0))));
      MR_Word TailArgsToSpec_19 = ((MR_Word) ((MR_hl_field(1, ArgsToSpec_17, 1))));

      hlds__input_specialization__input_specialize_in_pred_5_p_0(STATE_VARIABLE_ModuleInfo_0_12, HeadArgToSpec_18, TailArgsToSpec_19, PredInfo0_8, &PredInfo_11);
    }
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        if (((MR_tag((MR_Word) InitInst_19)) == (MR_Integer) 1))
        {
          MR_Word Var_30 = ((MR_Unsigned) ((MR_hl_field(1, InitInst_19, 0))) & (MR_Integer) 7);
          MR_Word Var_31 = ((MR_Word) ((MR_hl_field(1, InitInst_19, 1))));
        ...
        if (((((MR_tag((MR_Word) InitInst_19)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, InitInst_19, 0)))) == (MR_Integer) 0))))
        {
          MR_Word SymName_21;
          MR_String Name_22;
          MR_Word Var_32 = ((MR_Word) ((MR_hl_field(3, InitInst_19, 1))));
          MR_Word Var_33;
          MR_Word Var_34;
          MR_Word Var_39;
          ...
          if (succeeded)
          {
            SymName_21 = ((MR_Word) ((MR_hl_field(0, Var_32, 0))));
            Var_33 = ((MR_Word) ((MR_hl_field(0, Var_32, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_34 = ((MR_Word) ((MR_hl_field(1, SymName_21, 0))));
                Name_22 = ((MR_String) ((MR_hl_field(1, SymName_21, 1))));
                Var_39 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
                succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Var_34, Var_39);
                if (succeeded)
                {
                  if ((strcmp(Name_22, (MR_String) "in") == 0))
                    succeeded = MR_TRUE;
                  else
                  if ((strcmp(Name_22, (MR_String) "input") == 0))
                    succeeded = MR_TRUE;
                  else
                    succeeded = MR_FALSE;
                }
    ...
    if (succeeded)
    {
      ...
      hlds__input_specialization__input_specialize_proc_table_in_given_arg_6_p_0(ModuleInfo_1, ArgNum_2, InputSpecInfo_3, TailProcInfos0_14, &TailProcInfos_23, &_Changed_24);
      ...
      hlds__input_specialization__create_input_specialized_proc_infos_5_p_0(ArgNum_2, ReplaceOrAdd_25, SpecInsts_28, HeadProcInfo0_13, &SpecProcInfos_29);
      *HeadVar__5_5 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), SpecProcInfos_29, TailProcInfos_23);
      *HeadVar__6_6 = (MR_Integer) 1;
    }
    else
    {
      MR_Word TailProcInfos_35;

      hlds__input_specialization__input_specialize_proc_table_in_given_arg_6_p_0(ModuleInfo_1, ArgNum_2, InputSpecInfo_3, TailProcInfos0_14, &TailProcInfos_35, HeadVar__6_6);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__5_5 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (HeadProcInfo0_13));
        MR_hl_field(1, base, 1) = ((MR_Box) (TailProcInfos_35));
      }
    }
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__input_specialization__maybe_input_specialize_in_pred_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ModuleInfo_13);
