...
static void MR_CALL 
parse_tree__source_file_map__write_source_file_map_2_8_p_0(
  MR_Word ProgressStream_9,
  MR_Word MapStream_10,
  MR_Word Globals_11,
...
static /* final */ const MR_Box parse_tree__source_file_map_scalar_common_3[1][11];
...
#line 155 "source_file_map.m"
void 
parse_tree__source_file_map__user_init_pred_32_0(void)
#line 155 "source_file_map.m"
{
#line 155 "source_file_map.m"
...
{
  MR_bool succeeded;
  MR_Word MaybeModuleName_16;

  parse_tree__find_module__find_module_name_6_p_0(ProgressStream_9, Globals_11, FileName_12, &MaybeModuleName_16);
  if ((MaybeModuleName_16 == (MR_Word) ((MR_Unsigned) 0U)))
    *SeenModules_14 = SeenModules0_13;
  else
  {
    MR_Word ModuleName_17 = ((MR_Word) ((MR_hl_field(1, MaybeModuleName_16, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      Var_31 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_17);
      mercury__io__write_string_4_p_0(ProgressStream_9, (MR_String) "mercury_compile: module \140");
      mercury__io__write_string_4_p_0(ProgressStream_9, Var_31);
    ...
    Var_40 = mercury__dir__det_basename_1_f_0(PartialFileName_20);
    parse_tree__file_names__file_name_to_module_name_2_p_0(Var_40, &DefaultModuleName_21);
    Var_41 = mercury__dir__dirname_1_f_0(PartialFileName_20);
    ...
    if (!(succeeded))
    {
      ...
      Var_46 = parse_tree__parse_tree_out_sym_name__escaped_sym_name_to_string_1_f_0(ModuleName_17);
      mercury__io__write_string_4_p_0(MapStream_10, Var_46);
      mercury__io__write_string_4_p_0(MapStream_10, (MR_String) "\t");
      mercury__io__write_string_4_p_0(MapStream_10, FileName_12);
      mercury__io__write_string_4_p_0(MapStream_10, (MR_String) "\n");
    }
  }
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  parse_tree__source_file_map__write_source_file_map_2_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_SeenModules_14);
...
parse_tree__source_file_map__write_source_file_map_5_p_0(
  ...
  MR_Word FileNames_8)
{
  MR_Word FileResult_11;

  mercury__io__open_output_4_p_0((MR_String) "Mercury.modules", &FileResult_11);
  if (((MR_tag((MR_Word) FileResult_11)) == (MR_Integer) 1))
  {
    MR_Word Error_14 = ((MR_Word) ((MR_hl_field(1, FileResult_11, (MR_Integer) 0))));
    MR_Word StdErr_15;
    MR_String Var_30;
  ...
  {
    MR_Word FileStream_12 = ((MR_Word) ((MR_hl_field(0, FileResult_11, (MR_Integer) 0))));
    MR_Word Var_19;
    MR_Word Var_20;
    MR_Box conv2_Var_13;
...

    {
      ...
      MR_hl_field(0, Var_19, 0) = ((MR_Box) (&parse_tree__source_file_map_scalar_common_3[0]));
      ...
      MR_hl_field(0, Var_19, 4) = ((MR_Box) (FileStream_12));
    ...
    mercury__list__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__source_file_map_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_19, FileNames_8, ((MR_Box) (Var_20)), &conv2_Var_13, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_21_21);
...
#undef MR_PROC_LABEL
  ...
  if ((MaybeSourceFileMap0_11 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      MR_Word FileLines_15 = ((MR_Word) ((MR_hl_field(0, ReadResult_14, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
    ...
    SourceFileMap_6 = ((MR_Word) ((MR_hl_field(1, MaybeSourceFileMap0_11, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
  ...
  if ((MaybeSourceFileMap0_18 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      MR_Word FileLines_22 = ((MR_Word) ((MR_hl_field(0, ReadResult_21, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
    ...
    SourceFileMap_8 = ((MR_Word) ((MR_hl_field(1, MaybeSourceFileMap0_18, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_SourceFileMap_20)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String HeadLine_12 = ((MR_String) ((MR_hl_field(1, Lines_7, (MR_Integer) 0))));
      MR_Word TailLines_13 = ((MR_Word) ((MR_hl_field(1, Lines_7, (MR_Integer) 1))));
...
{
	parse_tree__source_file_map__user_init_pred_32_0();
}
