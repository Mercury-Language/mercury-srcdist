...
#line 255 "source_file_map.m"
void 
parse_tree__source_file_map__user_init_pred_35_0(void)
#line 255 "source_file_map.m"
{
#line 255 "source_file_map.m"
  ...
  MR_Word * SeenModules_14)
{
  ...
  else
  {
    ...
    if (!(succeeded))
    {
      ...
      mercury__io__write_string_4_p_0(MapFileStream_10, Var_46);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  parse_tree__source_file_map__write_source_file_map_line_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_SeenModules_14);
  ...
  MR_Word FileNames_8)
{
  ...
  {
    MR_Word Error_14 = ((MR_Word) ((MR_hl_field(1, MapFileResult_11, (MR_Integer) 0))));
    MR_Word StdErr_15;
    MR_String Var_30;
  ...
  {
    MR_Word MapFileStream_12 = ((MR_Word) ((MR_hl_field(0, MapFileResult_11, (MR_Integer) 0))));
    MR_Word Var_19;
    MR_Word Var_20;
    MR_Box conv2_Var_13;
...
{
	parse_tree__source_file_map__user_init_pred_35_0();
}
