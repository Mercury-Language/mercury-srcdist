...
static /* final */ const MR_Box parse_tree__source_file_map_scalar_common_2[34][2];
...
static /* final */ const MR_Box parse_tree__source_file_map_scalar_common_2[34][2] = {
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "cannot find out which module is contained in"))
  },
  /* row   9 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "being in a different file."))
  },
  /* row  11 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[10]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[5])))
  },
  /* row  12 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "suffix is recorded as"))
  },
  /* row  13 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[12]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[11])))
  },
  /* row  14 */
  {
  ...
  /* row  15 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[14]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[13])))
  },
  /* row  16 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "whose name is the file name minus the"))
  },
  /* row  17 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[16]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[15])))
  },
  /* row  18 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "in Mercury.modules, and the module"))
  },
  /* row  19 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[18]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[17])))
  },
  /* row  20 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "because its name does not appear"))
  },
  /* row  21 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[20]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[19])))
  },
  /* row  22 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 8U)),
  ...
  /* row  23 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[22]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[21])))
  },
  /* row  24 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[14]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[7])))
  },
  /* row  25 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
    ((MR_Box) ((MR_String) "and the file name does it end in"))
  },
  /* row  26 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[25]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[24])))
  },
  /* row  27 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  28 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[27]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[26])))
  },
  /* row  29 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[22]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[28])))
  },
  /* row  30 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
...
#line 376 "source_file_map.m"
void 
parse_tree__source_file_map__user_init_pred_43_0(void)
#line 376 "source_file_map.m"
{
#line 376 "source_file_map.m"
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_43, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[32])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_38, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[31])));
          ...
          }
          {
            ...
            MR_hl_field(1, Pieces_20, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[30])));
  ...
  MR_Word * ModuleName_6)
{
  ...
  MR_Word ModuleNamePrime_9;
  MR_Box conv0_ModuleNamePrime_9;

  parse_tree__source_file_map__get_source_file_map_3_p_0(&SourceFileMap_8);
  succeeded = mercury__bimap__reverse_search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), SourceFileMap_8, &conv0_ModuleNamePrime_9, ((MR_Box) (FileName_5)));
  if (succeeded)
  {
    ModuleNamePrime_9 = ((MR_Word) (conv0_ModuleNamePrime_9));
    succeeded = MR_TRUE;
  }
  if (succeeded)
    *ModuleName_6 = ModuleNamePrime_9;
  else
  {
    MR_Word DefaultModuleName_10;
    MR_String FileNameBeforeDotM_113;

    succeeded = mercury__string__remove_suffix_3_p_0(FileName_5, (MR_String) ".m", &FileNameBeforeDotM_113);
    if (succeeded)
    {
      parse_tree__file_names__file_name_to_module_name_2_p_0(FileNameBeforeDotM_113, &DefaultModuleName_10);
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(2, Var_33, 0) = ((MR_Box) (FileName_5));
        }
        {
          Var_32 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_32, 0) = ((MR_Box) (Var_33));
          MR_hl_field(1, Var_32, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[23])));
        }
        {
          Var_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_29, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[9])));
          MR_hl_field(1, Var_29, 1) = ((MR_Box) (Var_32));
        }
        {
          Var_26 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_26, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[8])));
          MR_hl_field(1, Var_26, 1) = ((MR_Box) (Var_29));
        }
        {
          Var_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_23, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[2])));
        ...
        mercury__io__write_string_4_p_0(StdErr_16, ErrorStr_15);
        mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.source_file_map.lookup_source_file_module\'/4", (MR_String) "cannot continue");
          return;
        }
      }
      else
        *ModuleName_6 = DefaultModuleName_10;
    }
    else
    {
      MR_Word Var_67;
      ...
      MR_Word Var_77;
      MR_Word Var_78;
      MR_String Progname_104;
      MR_Word Pieces_105;
      MR_Word ErrorLines_106;
      MR_String ErrorStr_107;
      MR_Word StdErr_108;

      mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &Progname_104);
      {
        Var_67 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, Var_67, 0) = ((MR_Box) (Progname_104));
      }
      {
        Var_78 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, Var_78, 0) = ((MR_Box) (FileName_5));
      }
      {
        Var_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_77, 0) = ((MR_Box) (Var_78));
        MR_hl_field(1, Var_77, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[29])));
      }
      {
        Var_74 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_74, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[9])));
        MR_hl_field(1, Var_74, 1) = ((MR_Box) (Var_77));
      }
      {
        Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_71, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[8])));
        MR_hl_field(1, Var_71, 1) = ((MR_Box) (Var_74));
      }
      {
        Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_68, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[2])));
        MR_hl_field(1, Var_68, 1) = ((MR_Box) (Var_71));
      }
      {
        Pieces_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Pieces_105, 0) = ((MR_Box) (Var_67));
        MR_hl_field(1, Pieces_105, 1) = ((MR_Box) (Var_68));
      }
      ErrorLines_106 = parse_tree__write_error_spec__error_pieces_to_std_lines_1_f_0(Pieces_105);
      ErrorStr_107 = parse_tree__write_error_spec__error_lines_to_multi_line_string_2_f_0((MR_String) "", ErrorLines_106);
      mercury__io__stderr_stream_3_p_0(&StdErr_108);
      mercury__io__write_string_4_p_0(StdErr_108, ErrorStr_107);
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.source_file_map.lookup_source_file_module\'/4", (MR_String) "cannot continue");
        return;
  ...
  MR_String * FileName_6)
{
  ...
  else
  {
    ...
    Var_69 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_5);
    DefaultFileName_10 = mercury__string__f_43_43_2_f_0(Var_69, (MR_String) ".m");
    ...
    if (succeeded)
    {
      ...
      mercury__io__stderr_stream_3_p_0(&StdErr_16);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.source_file_map.lookup_module_source_file\'/4", (MR_String) "cannot continue");
        return;
      }
    }
    else
  ...
  MR_Word FileNames_8)
{
  ...
  if ((Specs_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (((MR_tag((MR_Word) ModulesFileResult_14)) == (MR_Integer) 1))
    {
      ...
      {
        Var_43 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_43, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[33])));
...
{
  parse_tree__source_file_map__user_init_pred_43_0();
}
