  ...
  MR_Word * HaveMap_4)
{
  ...
  if ((MaybeSourceFileMap0_11 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      MR_Word FileLines_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_14, (MR_Integer) 0))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (SourceFileMap_6));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_22);
  }
  else
    SourceFileMap_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSourceFileMap0_11, (MR_Integer) 0))));
  ...
  MR_Word * MaybeModuleName_6)
{
  ...
  if ((MaybeSourceFileMap0_18 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      MR_Word FileLines_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_21, (MR_Integer) 0))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (SourceFileMap_8));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_29);
  }
  else
    SourceFileMap_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSourceFileMap0_18, (MR_Integer) 0))));
