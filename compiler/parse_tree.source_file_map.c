...
#line 338 "source_file_map.m"
void 
parse_tree__source_file_map__user_init_pred_40_0(void)
#line 338 "source_file_map.m"
{
#line 338 "source_file_map.m"
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) OpenRes_82)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_110, 0) = ((MR_Box) (FileName_10));
      ...
      }
      {
        ...
        MR_hl_field(1, Spec_89, 2) = ((MR_Box) (Var_110));
    ...
    else
    {
      ...
      MR_Word MaybeModuleName_118;

      parse_tree__parse_module__peek_at_file_6_p_0(FileStream_83, FileName_10, (MR_Word) ((MR_Unsigned) 0U), &MaybeModuleName_118);
      mercury__io__close_input_3_p_0(FileStream_83);
      if (((MR_tag((MR_Word) MaybeModuleName_118)) == (MR_Integer) 0))
      {
        MR_Word MnSpecs_114 = ((MR_Word) ((MR_hl_field(0, MaybeModuleName_118, 0))));

        *Mn2FnMap_12 = Mn2FnMap0_11;
        *STATE_VARIABLE_Specs_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), STATE_VARIABLE_Specs_0_29, MnSpecs_114);
        *STATE_VARIABLE_MapFileLineCord_28 = STATE_VARIABLE_MapFileLineCord_0_27;
      }
      else
      {
        MR_Word ModuleName_18 = ((MR_Word) ((MR_hl_field(1, MaybeModuleName_118, 0))));
...
{
  parse_tree__source_file_map__user_init_pred_40_0();
}
