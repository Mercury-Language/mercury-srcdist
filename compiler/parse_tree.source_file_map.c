...
static void MR_CALL 
parse_tree__source_file_map__find_name_of_module_in_file_4_p_0(
  ...
  MR_Word * SeenModules_14)
{
  ...
  parse_tree__source_file_map__find_name_of_module_in_file_4_p_0(FileName_12, &MaybeModuleName_16);
  if (((MR_tag((MR_Word) MaybeModuleName_16)) == (MR_Integer) 0))
  {
    MR_Word Specs_22 = ((MR_Word) ((MR_hl_field(0, MaybeModuleName_16, (MR_Integer) 0))));
  ...
  MR_Word * MaybeModuleName_6)
{
  ...
  if (((MR_tag((MR_Word) OpenRes_8)) == (MR_Integer) 1))
  {
    ...
    Var_30 = (MR_Word) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[0]));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_40, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__source_file_map_scalar_common_2[4])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_32, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__source_file_map_scalar_common_2[1])));
    ...
    }
    {
      ...
      MR_hl_field(1, Spec_19, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.source_file_map.find_name_of_module_in_file\'/4"));
