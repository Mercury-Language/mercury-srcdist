...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_29 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_15);
      ...
      Var_38 = mercury__dir__det_basename_1_f_0(PartialFileName_18);
      parse_tree__file_names__file_name_to_module_name_2_p_0(Var_38, &DefaultModuleName_19);
      Var_39 = mercury__dir__dirname_1_f_0(PartialFileName_18);
      Var_52 = mercury__dir__this_directory_0_f_0();
      succeeded = (strcmp(Var_39, Var_52) == 0);
      if (succeeded)
      ...
      if (!(succeeded))
      {
        ...
        Var_44 = parse_tree__prog_out__sym_name_to_escaped_string_1_f_0(ModuleName_15);
        mercury__io__write_string_4_p_0(MapStream_9, Var_44);
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&parse_tree__source_file_map_scalar_common_3[0]));
