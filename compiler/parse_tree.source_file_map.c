  ...
  MR_Word FileNames_6)
{
  ...
  if (((MR_tag((MR_Word) FileResult_9)) == (MR_Integer) 1))
  {
    ...
    mercury__io__write_string_4_p_0(StdErr_13, Var_28);
    mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
  }
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&parse_tree__source_file_map_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_17, 1) = ((MR_Box) (parse_tree__source_file_map__write_source_file_map_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_17, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_17, 3) = ((MR_Box) (Globals_5));
      MR_hl_field(MR_mktag(0), Var_17, 4) = ((MR_Box) (FileStream_10));
    }
    Var_18 = mercury__bimap__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
    mercury__list__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__source_file_map_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_17, FileNames_6, ((MR_Box) (Var_18)), &conv2_Var_11, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_19_19);
  ...
  MR_Word * HaveMap_4)
{
  ...
  MR_Word MaybeSourceFileMap0_15;

  libs__globals__io_get_maybe_source_file_map_3_p_0(&MaybeSourceFileMap0_15);
  if ((MaybeSourceFileMap0_15 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word ReadResult_18;
    MR_Word Var_26;

    mercury__io__read_named_file_as_lines_4_p_0((MR_String) "Mercury.modules", &ReadResult_18);
    if (((MR_tag((MR_Word) ReadResult_18)) == (MR_Integer) 1))
    ...
    {
      MR_Word FileLines_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_18, (MR_Integer) 0))));
      MR_String ErrorMsg_20;
      MR_Word SourceFileMap1_21;
      MR_Word SourceFileMap0_28;

      mercury__bimap__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SourceFileMap0_28);
      parse_tree__source_file_map__parse_source_file_map_6_p_0(FileLines_19, (MR_String) "Mercury.modules", (MR_Integer) 1, &ErrorMsg_20, SourceFileMap0_28, &SourceFileMap1_21);
      succeeded = (strcmp(ErrorMsg_20, (MR_String) "") == 0);
      if (succeeded)
        SourceFileMap_6 = SourceFileMap1_21;
      else
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (SourceFileMap_6));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_26);
  }
  else
    SourceFileMap_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSourceFileMap0_15, (MR_Integer) 0))));
  ...
  MR_Word * MaybeModuleName_6)
{
  ...
  MR_Word MaybeSourceFileMap0_22;
  MR_Word ModuleName_9;
  MR_Box conv0_ModuleName_9;

  libs__globals__io_get_maybe_source_file_map_3_p_0(&MaybeSourceFileMap0_22);
  if ((MaybeSourceFileMap0_22 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word ReadResult_25;
    MR_Word Var_33;

    mercury__io__read_named_file_as_lines_4_p_0((MR_String) "Mercury.modules", &ReadResult_25);
    if (((MR_tag((MR_Word) ReadResult_25)) == (MR_Integer) 1))
    ...
    {
      MR_Word FileLines_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_25, (MR_Integer) 0))));
      MR_String ErrorMsg_27;
      MR_Word SourceFileMap1_28;
      MR_Word SourceFileMap0_35;

      mercury__bimap__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SourceFileMap0_35);
      parse_tree__source_file_map__parse_source_file_map_6_p_0(FileLines_26, (MR_String) "Mercury.modules", (MR_Integer) 1, &ErrorMsg_27, SourceFileMap0_35, &SourceFileMap1_28);
      succeeded = (strcmp(ErrorMsg_27, (MR_String) "") == 0);
      if (succeeded)
        SourceFileMap_8 = SourceFileMap1_28;
      else
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (SourceFileMap_8));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_33);
  }
  else
    SourceFileMap_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSourceFileMap0_22, (MR_Integer) 0))));
  ...
  else
  {
    ...
    MR_String FileNameBeforeDotM_42;

    succeeded = mercury__string__remove_suffix_3_p_0(FileName_5, (MR_String) ".m", &FileNameBeforeDotM_42);
    if (succeeded)
    {
      parse_tree__file_names__file_name_to_module_name_2_p_0(FileNameBeforeDotM_42, &DefaultModuleName_10);
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
  ...
  MR_Word * MaybeFileName_6)
{
  ...
  else
  {
    ...
    Var_41 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_5);
    DefaultFileName_10 = mercury__string__f_43_43_2_f_0(Var_41, (MR_String) ".m");
