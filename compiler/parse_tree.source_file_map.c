  ...
  MR_Word * HaveMap_4)
{
  ...
  MR_Word MaybeSourceFileMap0_12;

  libs__globals__io_get_maybe_source_file_map_3_p_0(&MaybeSourceFileMap0_12);
  if ((MaybeSourceFileMap0_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word ReadResult_15;
    MR_Word Var_23;

    mercury__io__read_named_file_as_lines_4_p_0((MR_String) "Mercury.modules", &ReadResult_15);
    if (((MR_tag((MR_Word) ReadResult_15)) == (MR_Integer) 1))
    ...
    {
      MR_Word FileLines_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_15, (MR_Integer) 0))));
      MR_String ErrorMsg_17;
      MR_Word SourceFileMap1_18;
      MR_Word SourceFileMap0_24;

      mercury__bimap__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SourceFileMap0_24);
      parse_tree__source_file_map__parse_source_file_map_6_p_0(FileLines_16, (MR_String) "Mercury.modules", (MR_Integer) 1, &ErrorMsg_17, SourceFileMap0_24, &SourceFileMap1_18);
      succeeded = (strcmp(ErrorMsg_17, (MR_String) "") == 0);
      if (succeeded)
        SourceFileMap_6 = SourceFileMap1_18;
      else
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) (SourceFileMap_6));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_23);
  }
  else
    SourceFileMap_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSourceFileMap0_12, (MR_Integer) 0))));
  ...
  MR_Word * MaybeModuleName_6)
{
  ...
  if ((MaybeSourceFileMap0_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word ReadResult_22;
    MR_Word Var_30;

    mercury__io__read_named_file_as_lines_4_p_0((MR_String) "Mercury.modules", &ReadResult_22);
    if (((MR_tag((MR_Word) ReadResult_22)) == (MR_Integer) 1))
    ...
    {
      MR_Word FileLines_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadResult_22, (MR_Integer) 0))));
      MR_String ErrorMsg_24;
      MR_Word SourceFileMap1_25;
      MR_Word SourceFileMap0_31;

      mercury__bimap__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SourceFileMap0_31);
      parse_tree__source_file_map__parse_source_file_map_6_p_0(FileLines_23, (MR_String) "Mercury.modules", (MR_Integer) 1, &ErrorMsg_24, SourceFileMap0_31, &SourceFileMap1_25);
      succeeded = (strcmp(ErrorMsg_24, (MR_String) "") == 0);
      if (succeeded)
        SourceFileMap_8 = SourceFileMap1_25;
      else
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (SourceFileMap_8));
    }
    libs__globals__io_set_maybe_source_file_map_3_p_0(Var_30);
  }
  else
  ...
  else
  {
    ...
    MR_String FileNameBeforeDotM_36;

    succeeded = mercury__string__remove_suffix_3_p_0(FileName_5, (MR_String) ".m", &FileNameBeforeDotM_36);
    if (succeeded)
    {
      parse_tree__file_names__file_name_to_module_name_2_p_0(FileNameBeforeDotM_36, &DefaultModuleName_10);
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
  ...
  MR_Word * MaybeFileName_6)
{
  ...
  else
  {
    ...
    Var_36 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_5);
    DefaultFileName_10 = mercury__string__f_43_43_2_f_0(Var_36, (MR_String) ".m");
