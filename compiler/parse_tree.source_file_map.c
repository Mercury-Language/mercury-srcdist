...
{
  {
    ...
    if ((MaybeModuleName_14 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    else
    {
      ...
      Var_26 = mercury__map__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
      mercury__list__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__source_file_map_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_25, FileNames_6, ((MR_Box) (Var_26)), &conv2_Var_11, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_27_27);
...
{
  {
    ...
    if ((MaybeSourceFileMap0_16 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word OpenRes_18;
      MR_Word Var_32;
...
{
  {
    ...
    if ((MaybeSourceFileMap0_19 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word OpenRes_21;
      MR_Word Var_35;

      mercury__io__open_input_4_p_0((MR_String) "Mercury.modules", &OpenRes_21);
      if (((MR_tag((MR_Word) OpenRes_21)) == (MR_Integer) 1))
      {
  ...
  MR_Word * STATE_VARIABLE_Map_18)
{
  while (MR_TRUE)
  {
    ...
    ;
    parse_tree__source_file_map__read_until_char_5_p_0((MR_Char) 9, (MR_Word) ((MR_Integer) 0), &ModuleCharsResult_9);
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__source_file_map__read_until_char_5_p_0((MR_Char) 10, (MR_Word) ((MR_Integer) 0), &FileNameCharsResult_13);
  ...
  MR_Word * Result_8)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) CharRes_10)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        if ((Chars0_7 == (MR_Word) ((MR_Integer) 0)))
