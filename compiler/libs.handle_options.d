...
ifeq ($(TARGET_ASM),yes)
libs.handle_options.mh libs.handle_options.mih : libs.handle_options.s
else
libs.handle_options.mh libs.handle_options.mih : libs.handle_options.c
endif

ifeq ($(TARGET_ASM),yes)
libs.handle_options.module_dep : libs.handle_options.s
else
 ifeq ($(findstring il,$(GRADE)),il)
libs.handle_options.module_dep : libs.handle_options.il
  ifeq ($(findstring java,$(GRADE)),java)
libs.handle_options.module_dep : mercury/libs_/handle_options.java
  else
...
ifeq ($(TARGET_ASM),yes)
libs.handle_options.s_date : handle_options.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only libs.handle_options $(ERR_REDIRECT)
libs.handle_options.pic_s_date : handle_options.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" libs.handle_options $(ERR_REDIRECT)
endif # TARGET_ASM
