...
/*
INIT mercury__hlds__mode_top_functor__init
ENDINIT
*/
...
static void MR_CALL 
hlds__mode_top_functor__find_top_functor_mode_loop_over_notags_6_p_0(
...
static void MR_CALL 
hlds__mode_top_functor__get_single_arg_inst_4_p_0(
...
hlds__mode_top_functor__get_single_arg_inst_in_bound_functors_3_p_0(
...
void MR_CALL 
hlds__mode_top_functor__modes_to_top_functor_modes_4_p_0(
  MR_Word HeadVar__1_1,
  ...
  if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U)))
      *HeadVar__4_4 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.mode_top_functor.modes_to_top_functor_modes\'/4", (MR_String) "length mismatch");
        return;
      }
  else
  {
    ...
    else
    {
      ...
      hlds__mode_util__mode_get_insts_4_p_0(HeadVar__1_1, Var_26, &InitialInst_27, &FinalInst_28);
      hlds__mode_top_functor__find_top_functor_mode_loop_over_notags_6_p_0(HeadVar__1_1, Type_21, (MR_Word) ((MR_Unsigned) 0U), InitialInst_27, FinalInst_28, &TopFunctorMode_23);
      hlds__mode_top_functor__modes_to_top_functor_modes_4_p_0(HeadVar__1_1, Var_25, Types_22, &TopFunctorModes_24);
      {
        MR_Word base;
...
void MR_CALL 
hlds__mode_top_functor__init_final_insts_to_top_functor_mode_5_p_0(
...
{
  hlds__mode_top_functor__find_top_functor_mode_loop_over_notags_6_p_0(ModuleInfo_6, Type_9, (MR_Word) ((MR_Unsigned) 0U), InitialInst_7, FinalInst_8, TopFunctorMode_10);
}

void MR_CALL 
hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(
  MR_Word ModuleInfo_5,
  MR_Word Mode_6,
  MR_Word Type_7,
  MR_Word * TopFunctorMode_8)
{
  ...
  hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_5, Mode_6, &InitialInst_9, &FinalInst_10);
  hlds__mode_top_functor__find_top_functor_mode_loop_over_notags_6_p_0(ModuleInfo_5, Type_7, (MR_Word) ((MR_Unsigned) 0U), InitialInst_9, FinalInst_10, TopFunctorMode_8);
}
  ...
  MR_Word * TopFunctorMode_12)
{
  while (MR_TRUE)
  {
    ...
    ;
    succeeded = hlds__type_util__type_is_no_tag_type_4_p_0(ModuleInfo_7, Type_8, &FunctorName_13, &ArgType_14);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      hlds__mode_top_functor__get_single_arg_inst_4_p_0(ModuleInfo_7, InitialInst_10, ConsId_16, &InitialArgInst_17);
      hlds__mode_top_functor__get_single_arg_inst_4_p_0(ModuleInfo_7, FinalInst_11, ConsId_16, &FinalArgInst_18);
      {
    ...
    {
      succeeded = hlds__inst_test__inst_is_bound_2_p_0(ModuleInfo_7, InitialInst_10);
      if (succeeded)
        *TopFunctorMode_12 = (MR_Integer) 0;
      else
      {
        succeeded = hlds__inst_test__inst_is_bound_2_p_0(ModuleInfo_7, FinalInst_11);
        if (succeeded)
    ...
    switch (MR_tag((MR_Word) Inst_6)) {
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = hlds__mode_top_functor__get_single_arg_inst_in_bound_functors_3_p_0(BoundFunctors_15, ConsId_7, &ArgInst0_16);
          if (succeeded)
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_6, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_5, InstName_9, &NamedInst_10);
              // direct tailcall eliminated
              ;
          ...
          case (MR_Integer) 3:
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.mode_top_functor.get_single_arg_inst\'/4", (MR_String) "inst_var");
              return;
            }
            break;
        }
...
void mercury__hlds__mode_top_functor__init(void)
{
}

void mercury__hlds__mode_top_functor__init_type_tables(void)
{
}

void mercury__hlds__mode_top_functor__init_debugger(void)
{
  MR_fatal_error("debugger initialization in MLDS grade");
}

// Ensure everything is compiled with the same grade.
const char *mercury__hlds__mode_top_functor__grade_check(void)
{
  return &MR_GRADE_VAR;
}
