      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word next_value_of_Type_4 = EqvType_6;
                        ...
                        case (MR_Integer) 2:
                          {
                            ...
                            /* direct tailcall eliminated */
                            {
                              MR_Word next_value_of_Type_6 = SingleArgType_30;
                              MR_Word next_value_of_CoveredTypes_7 = Var_35;
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_TypeBody_4 = TypeBody_22;
