...
{
  {
    ...
    {
      MR_Integer _Ordinal_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__type_util__cons_id_arg_types_4_p_0_env_0__Ctor_18, (MR_Integer) 0))));
...
{
  {
    ...
    {
      MR_Integer Var_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__type_util__type_is_existq_type_2_p_0_env_0__Constructor_9, (MR_Integer) 0))));
      MR_Word Var_11;
      MR_Word Var_12;
      MR_Integer Var_13;
      MR_Word Var_14;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_25 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0), CtorArgs_11);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word Ctor_8;
    MR_Word Ctors_9;
    MR_Integer Ordinal_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Ctor0_6, (MR_Integer) 0))));
    ...
    check_hlds__type_util__substitute_type_args_ctor_args_3_p_0(Subst_1, Args0_13, &Args_16);
    {
      ...
      MR_hl_field(MR_mktag(0), Ctor_8, 0) = ((MR_Box) (Ordinal_10));
