...
MR_def_label(check_hlds__type_util__cons_id_arg_types_4_0,6)
	...
	MR_fv(7) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, cons_id);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_fv(7);
...
MR_def_label(check_hlds__type_util__cons_id_arg_types_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_fv(8) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_data, hlds_cons_defn);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_fv(7);
...
MR_def_label(check_hlds__type_util__cons_id_arg_types_4_0,12)
	...
	MR_fv(5) = MR_tfield(0, MR_r1, 4);
	MR_fv(6) = MR_tfield(0, MR_r1, 6);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_fv(3);
...
MR_def_label(check_hlds__type_util__apply_variable_renaming_to_constraints_3_0,7)
	...
	MR_sv(6) = (MR_Word) MR_TAG_COMMON(0,2,10);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(3);
