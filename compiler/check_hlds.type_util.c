          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = mercury__list__foldl_4_p_3(TypeCtorInfo_41_64, TypeInfo_42_65, Var_54, Ctors_45, ((MR_Box) (STATE_VARIABLE_SeenTypes_30_30)), &conv1_STATE_VARIABLE_SeenTypes_31_31);
                          if (succeeded)
                          {
              ...
              if (succeeded)
              {
                ...
                succeeded = mercury__list__foldl_4_p_3(TypeCtorInfo_14_68, TypeInfo_15_69, Var_67, Args_34, ((MR_Box) (STATE_VARIABLE_SeenTypes_31_31)), &conv3_STATE_VARIABLE_SeenTypes_29);
                if (succeeded)
                {
      ...
      case (MR_Integer) 10:
        {
          ...
          ;
          {
            ...
            if (succeeded)
            {
              ...
              Var_75 = mdbcomp__builtin_modules__mercury_std_lib_module_name_1_f_0(Var_12);
