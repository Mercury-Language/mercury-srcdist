...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) MaybeType_4)) == (MR_Integer) 1);
    MR_Word ArgTypes_11;
    MR_Word Type_7;
    MR_Word Var_8;
    MR_Word Var_9;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeType_7)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeExistConstraints_14)) == (MR_Integer) 1);
        if (succeeded)
        {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeRepn_15)) == (MR_Integer) 1);
          if (succeeded)
          {
  ...
  MR_Word * ConsIdConsRepn_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) TailConsRepns_7)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
...

    {
      ...
      (env_ptr)->check_hlds__type_util__type_is_existq_type_2_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->check_hlds__type_util__type_is_existq_type_2_p_0_env_0__Var_8)) == (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_25 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0), CtorArgs_11);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_21, 2) = ((MR_Box) (&check_hlds__type_util_scalar_common_3[27]));
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeForeignType_10)) == (MR_Integer) 1);
          if (succeeded)
          {
