...
{
  {
    ...
    conv1_LambdaHeadVar__2_41 = check_hlds__type_util__IntroducedFrom__func__cons_id_arg_types__1374__1_1_f_0(((MR_Word) (wrapper_arg_1)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            TypeInfo_43_83 = (MR_Word) (&check_hlds__type_util_scalar_common_1[5]);
                            {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_16_96 = (MR_Word) (&check_hlds__type_util_scalar_common_1[5]);
                  {
