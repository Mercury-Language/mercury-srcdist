          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = mercury__list__foldl_4_p_3((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&check_hlds__type_util_scalar_common_1[6]), Var_69, Args_9, ((MR_Box) (STATE_VARIABLE_SeenTypes_1_29)), &conv5_STATE_VARIABLE_SeenTypes_28);
              if (succeeded)
              {
