...
MR_decl_static(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__966__1_2_0)
MR_decl_static(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__982__1_2_0)
MR_decl_static(parse_tree__prog_io__IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1_2_0)
MR_decl_static(parse_tree__prog_io__IntroducedFrom__pred__parse_promise__2056__1_2_0)
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(parse_tree__prog_io__IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1_2_0),
0
},
{
MR_COMMON(5,1),
MR_ENTRY_AP(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__966__1_2_0),
0
},
{
MR_COMMON(5,2),
MR_ENTRY_AP(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__982__1_2_0),
0
},
{
MR_COMMON(5,3),
MR_ENTRY_AP(parse_tree__prog_io__IntroducedFrom__pred__parse_promise__2056__1_2_0),
0
},
};
...
MR_decl_entry(parse_tree__prog_mode__constrain_inst_vars_in_mode_sub_3_0);
...
MR_def_label(parse_tree__prog_io__parse_type_and_mode_3_0,11)
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(parse_tree__prog_mode__constrain_inst_vars_in_mode_sub_3_0,
...
MR_decl_entry(parse_tree__prog_mode__inst_var_constraints_types_modes_self_consistent_1_0);
...
MR_def_label(parse_tree__prog_io__parse_pred_decl_base_12_0,4)
	...
	MR_sv(15) = (MR_Word) MR_TAG_COMMON(1,0,70);
	MR_r1 = MR_sv(14);
...
MR_def_label(parse_tree__prog_io__parse_pred_decl_base_12_0,8)
	...
	MR_r2 = MR_tempr1;
	MR_r3 = (MR_Word) MR_TAG_COMMON(1,0,71);
	}
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
...
MR_def_label(parse_tree__prog_io__parse_pred_decl_base_12_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(10);
	MR_np_call_localret_ent(parse_tree__prog_mode__inst_var_constraints_types_modes_self_consistent_1_0,
...
MR_def_label(parse_tree__prog_io__parse_pred_decl_base_12_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(14);
	MR_sv(14) = (MR_Word) MR_TAG_COMMON(1,0,72);
	MR_sv(9) = MR_r1;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_io__pred_or_func_decl_pieces_1_0,
...
MR_def_label(parse_tree__prog_io__parse_attributed_decl_8_0,92)
	...
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(8,2);
...
MR_def_label(parse_tree__prog_io__parse_attributed_decl_8_0,103)
	...
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 4);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(8,3);
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(parse_tree__prog_io__parse_module_specifier_3_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r1, 3) = MR_r2;
	MR_r2 = MR_tfield(1, MR_tempr2, 0);
...
MR_def_label(parse_tree__prog_io__parse_attributed_decl_8_0,108)
	...
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 4);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(8,4);
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(parse_tree__prog_io__parse_module_specifier_3_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r1, 3) = MR_r2;
	MR_r2 = MR_tfield(1, MR_tempr2, 0);
...
MR_def_label(parse_tree__prog_io__read_first_item_12_0,4)
	...
	if (MR_RTAGS_TESTR(MR_tempr2,3,27)) {
		MR_GOTO_LAB(parse_tree__prog_io__read_first_item_12_0_i5);
	}
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(parse_tree__prog_io_module58)
	MR_init_entry1(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__966__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_io__IntroducedFrom__pred__parse_clause__966__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__parse_clause__966__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__966__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_io_module59)
	MR_init_entry1(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__982__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_io__IntroducedFrom__pred__parse_clause__982__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__parse_clause__982__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_io__IntroducedFrom__pred__parse_clause__982__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_io_module60)
	MR_init_entry1(parse_tree__prog_io__IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_io__IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_io__IntroducedFrom__pred__get_class_context_and_inst_constraints__1968__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_io_module61)
	MR_init_entry1(parse_tree__prog_io__IntroducedFrom__pred__parse_promise__2056__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_io__IntroducedFrom__pred__parse_promise__2056__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__parse_promise__2056__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_io__IntroducedFrom__pred__parse_promise__2056__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__parse_tree__prog_io__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parse_tree__prog_io);
