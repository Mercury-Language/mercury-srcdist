...
static void MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1608__1_5_p_0(
  MR_Word Globals_10,
  MR_Tuple LambdaHeadVar__1_154,
  MR_String * LambdaHeadVar__2_155);

static MR_Word MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__func__generate_dv_file__1599__1_1_f_0(
  MR_Tuple LambdaHeadVar__1_146);

static MR_bool MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1575__1_2_p_0(
  MR_Word DepsMap_13,
...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_1[155][2];
...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_1[155][2] = {
  ...
  /* row  88 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[87]))),
  ...
  /* row  91 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[90]))),
  ...
  /* row  94 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[93]))),
  ...
  /* row  97 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[96]))),
  ...
  /* row 103 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[102]))),
    ((MR_Box) ((MR_String) ".javas"))
  },
  /* row 104 */
  {
    ((MR_Box) (&parse_tree__write_deps_file_scalar_common_1[103])),
  ...
  /* row 107 */
  {
    ((MR_Box) (&parse_tree__write_deps_file_scalar_common_1[106])),
  ...
  /* row 109 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[108]))),
    ((MR_Box) ((MR_String) ".optdates"))
  },
  /* row 110 */
  {
    ((MR_Box) (&parse_tree__write_deps_file_scalar_common_1[109])),
  ...
  /* row 115 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[114]))),
    ((MR_Box) ((MR_String) ".dates"))
  },
  /* row 116 */
  {
    ((MR_Box) (&parse_tree__write_deps_file_scalar_common_1[115])),
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_42)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_18, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_clean_targets\'/17", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[120])), ModuleName_19, &CleanTargetName_33);
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_18, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_clean_targets\'/17", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[121])), ModuleName_19, &RealCleanTargetName_34);
  {
  ...
  Var_93 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_94, (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[134])));
  ...
  Var_162 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_94, (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[154])));
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_66)
{
  ...
  (env).parse_tree__write_deps_file__generate_dep_file_install_targets_14_p_0_env_0__DepsMap_17 = DepsMap_17;
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[41])), ModuleName_16, &LibInstallIntsTargetName_33);
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[42])), ModuleName_16, &LibInstallOptsTargetName_34);
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[43])), ModuleName_16, &LibInstallHdrsTargetName_35);
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[44])), ModuleName_16, &LibInstallGradeHdrsTargetName_36);
    ...
    Var_118 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeModuleDepsVar_31, (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[45])));
    ...
    Var_152 = mercury__string__f_43_43_2_f_0((MR_String) "for ext in int int2 int3", Var_154);
    {
      ...
      MR_hl_field(1, Var_151, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[53])));
    }
    {
    ...
    else
    {
      ...
      Var_178 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeTransOptsVar_29, (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[54])));
      ...
      Var_215 = mercury__string__f_43_43_2_f_0((MR_String) "for ext in ", Var_217);
      {
        ...
        MR_hl_field(1, Var_214, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[61])));
      }
      {
    ...
    ModuleMakeVarNameMhs_57 = mercury__string__f_43_43_2_f_0((MR_String) "\044(", Var_389);
    {
      ...
      MR_hl_field(1, Var_247, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[45])));
    }
    ...
    Var_261 = mercury__string__f_43_43_2_f_0((MR_String) "for hdr in ", Var_263);
    {
      ...
      MR_hl_field(1, Var_260, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[63])));
    }
    {
    ...
    ModuleMakeVarNameMihs_61 = mercury__string__f_43_43_2_f_0((MR_String) "\044(", Var_392);
    {
      ...
      MR_hl_field(1, Var_280, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[54])));
    }
    ...
    Var_294 = mercury__string__f_43_43_2_f_0((MR_String) "for hdr in ", Var_296);
    {
      ...
      MR_hl_field(1, Var_293, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_1[86])));
    }
    {
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_67)
{
  ...
  parse_tree__file_names__module_name_to_lib_file_name_create_dirs_8_p_0(Globals_16, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_exec_library_targets\'/15", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[38])), ModuleName_17, SharedLibFileName_26);
  parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_16, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_exec_library_targets\'/15", (MR_String) "lib", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[38])), ModuleName_17, &MaybeSharedLibFileName_43);
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_16, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_exec_library_targets\'/15", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[39])), ModuleName_17, JarFileName_24);
  ...
  }
  {
    ...
    MR_hl_field(2, MmakeFragmentSharedLib_57, 0) = ((MR_Box) (MR_mkword(2, &parse_tree__write_deps_file_scalar_common_1[40])));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1608__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Tuple) (wrapper_arg_1)), &conv6_LambdaHeadVar__2_155);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv5_LambdaHeadVar__2_147 = parse_tree__write_deps_file__IntroducedFrom__func__generate_dv_file__1599__1_1_f_0(((MR_Tuple) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1575__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
