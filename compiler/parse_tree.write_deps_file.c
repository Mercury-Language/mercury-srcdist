...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_16, (MR_Integer) 619, &parse_tree__write_deps_file__UseInstallName_44);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__write_deps_file__Globals_9, (MR_Integer) 652, &parse_tree__write_deps_file__IntermodDirs_93);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_9, (MR_Integer) 649, &parse_tree__write_deps_file__UseSubdirs_192);
    }
