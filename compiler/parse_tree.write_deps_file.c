...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 334, &Intermod_24);
    switch (Intermod_24) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 336, &UseOptFiles_91);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 334, &Intermod_92);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 656, &IntermodDirs_93);
    switch (Intermod_92) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 338, &TransOpt_98);
      libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 337, &UseTransOpt_99);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 653, &UseSubdirs_192);
