  ...
  MR_Word * STATE_VARIABLE_Cache_28)
{
  ...
  MR_Word IntermodDeps_25;
  MR_Word MmakeFileD_26;
  MR_Word STATE_VARIABLE_Cache_35_35;

  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file_fragment\'/11", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[0])), ModuleName_24, FileNameD_17);
  parse_tree__write_deps_file__construct_intermod_deps_9_p_0(Globals_12, ParseTreeModuleSrc_23, StdDeps_14, AllDeps_15, &IntermodDeps_25, STATE_VARIABLE_Cache_0_27, &STATE_VARIABLE_Cache_35_35);
  parse_tree__generate_mmakefile_fragments__generate_d_file_11_p_0(Globals_12, BurdenedAugCompUnit_13, StdDeps_14, IntermodDeps_25, AllDeps_15, MaybeInclTransOptRule_16, &MmakeFileD_26, STATE_VARIABLE_Cache_35_35, STATE_VARIABLE_Cache_28);
  *FileContentsStrD_18 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_26);
}
  ...
  MR_Word MaybeInclTransOptRule_14)
{
  ...
  MR_Word IntermodDeps_29;
  MR_Word MmakeFileD_30;
  MR_Word STATE_VARIABLE_Cache_35_35;
  MR_Word _Cache_19;
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file_fragment\'/11", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[0])), ModuleName_28, &FileNameD_17);
  parse_tree__write_deps_file__construct_intermod_deps_9_p_0(Globals_10, ParseTreeModuleSrc_27, StdDeps_12, AllDeps_13, &IntermodDeps_29, Cache0_16, &STATE_VARIABLE_Cache_35_35);
  parse_tree__generate_mmakefile_fragments__generate_d_file_11_p_0(Globals_10, BurdenedAugCompUnit_11, StdDeps_12, IntermodDeps_29, AllDeps_13, MaybeInclTransOptRule_14, &MmakeFileD_30, STATE_VARIABLE_Cache_35_35, &_Cache_19);
  FileContentsStrD_18 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_30);
  ...
  MR_String FileContentsStrD_10)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 75, &Verbose_16);
    switch (Verbose_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
