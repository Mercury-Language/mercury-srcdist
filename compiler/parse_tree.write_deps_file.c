    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 305, &HighLevelCode_83);
  ...
  MR_Word TransOptOrder_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 495, &Intermod_26);
  switch (Intermod_26) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MmakeRulesCHeaders_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 305, &HighLevelCode_18);
