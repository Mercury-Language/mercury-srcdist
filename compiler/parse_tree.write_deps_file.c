      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) MaybeFileName_23)) == (MR_Integer) 1))
          {
            ...
            parse_tree__find_module__search_for_file_returning_dir_5_p_0(IntermodDirs_3, OptName_61, &MaybeOptDir_62);
            ...
            parse_tree__find_module__search_for_file_returning_dir_5_p_0(IntermodDirs_3, TransOptName_63, &MaybeTransOptDir_64);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) Result1_24)) == (MR_Integer) 1))
          {
            ...
            parse_tree__find_module__search_for_file_5_p_0(HeadVar__3_3, OptName_44, &MaybeOptDir_45);
