...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_3[2][1];
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  parse_tree__deps_map__generate_deps_map_9_p_0(ProgressStream_8, Globals_9, (MR_Integer) 1, FileOrModule_10, &ModuleName_14, DepsMap_11, &STATE_VARIABLE_Specs_24_24);
  mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), *DepsMap_11, ((MR_Box) (ModuleName_14)), &conv0_ModuleDep_33);
  ModuleDep_33 = ((MR_Word) (conv0_ModuleDep_33));
  BurdenedModule_36 = ((MR_Word) ((MR_hl_field(0, ModuleDep_33, (MR_Integer) 1))));
  Baggage_37 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_36, (MR_Integer) 0))));
  Errors_39 = ((MR_Word) ((MR_hl_field(0, Baggage_37, (MR_Integer) 7))));
  FatalErrors_40 = ((MR_Word) ((MR_hl_field(0, Errors_39, (MR_Integer) 0))));
  succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), FatalErrors_40);
  if (succeeded)
  {
    MR_Word FatalErrorSpecs_41 = ((MR_Word) ((MR_hl_field(0, Errors_39, (MR_Integer) 1))));

    if ((FatalErrorSpecs_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_String UnexpectedMsg_42;
      MR_String Var_48;
      MR_String Var_71;

      Var_48 = mercury__string__string_1_f_0((MR_Word) (&parse_tree__write_deps_file_scalar_common_2[0]), ((MR_Box) (FatalErrors_40)));
      Var_71 = mercury__string__f_43_43_2_f_0(Var_48, (MR_String) "\n");
      UnexpectedMsg_42 = mercury__string__f_43_43_2_f_0((MR_String) "FatalErrorSpecs = [], with FatalErrors = ", Var_71);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.write_deps_file.do_we_have_a_valid_module_dep\'/3", UnexpectedMsg_42);
        return;
      }
    }
    else
      {
        ...
        MR_hl_field(0, MaybeBurdenedModule_15, 0) = ((MR_Box) (FatalErrorSpecs_41));
      }
  }
  else
    {
      MaybeBurdenedModule_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeBurdenedModule_15, 0) = ((MR_Box) (BurdenedModule_36));
    }
  if (((MR_tag((MR_Word) MaybeBurdenedModule_15)) == (MR_Integer) 0))
  {
    MR_Word FatalErrorSpecs_16 = ((MR_Word) ((MR_hl_field(0, MaybeBurdenedModule_15, (MR_Integer) 0))));

    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_16, STATE_VARIABLE_Specs_24_24);
  }
  else
  {
    MR_Word BurdenedModule_17 = ((MR_Word) ((MR_hl_field(1, MaybeBurdenedModule_15, (MR_Integer) 0))));
    ...
    parse_tree__generate_dep_d_files__compute_deps_for_d_files_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_18, &_BurdenedModules_19, STATE_VARIABLE_Specs_24_24, STATE_VARIABLE_Specs_20);
    {
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  parse_tree__deps_map__generate_deps_map_9_p_0(ProgressStream_8, Globals_9, (MR_Integer) 0, FileOrModule_10, &ModuleName_14, DepsMap_11, &STATE_VARIABLE_Specs_26_26);
  mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__deps_map__parse_tree__deps_map__type_ctor_info_deps_0), *DepsMap_11, ((MR_Box) (ModuleName_14)), &conv0_ModuleDep_33);
  ModuleDep_33 = ((MR_Word) (conv0_ModuleDep_33));
  BurdenedModule_36 = ((MR_Word) ((MR_hl_field(0, ModuleDep_33, (MR_Integer) 1))));
  Baggage_37 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_36, (MR_Integer) 0))));
  ...
  if (((MR_tag((MR_Word) MaybeBurdenedModule_15)) == (MR_Integer) 0))
  {
    ...
    *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_16, STATE_VARIABLE_Specs_26_26);
  }
  else
  {
    MR_Word BurdenedModule_17 = ((MR_Word) ((MR_hl_field(1, MaybeBurdenedModule_15, (MR_Integer) 0))));
    MR_Word Baggage_18 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_17, (MR_Integer) 0))));
    ...
    parse_tree__generate_dep_d_files__compute_deps_for_d_files_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_20, &BurdenedModules_21, STATE_VARIABLE_Specs_26_26, STATE_VARIABLE_Specs_22);
    mercury__map__init_1_p_0((MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_0), (MR_Word) (&parse_tree__write_deps_file_scalar_common_1[0]), &Cache0_73);
  ...
  MR_Word * STATE_VARIABLE_Cache_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word BurdenedModule_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
      MR_Word BurdenedModules_21 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_Cache_29_29;
      MR_Word Baggage_31 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_20, (MR_Integer) 0))));
      MR_Word ParseTreeModuleSrc_32 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_20, (MR_Integer) 1))));
      MR_Word ModuleErrors_33 = ((MR_Word) ((MR_hl_field(0, Baggage_31, (MR_Integer) 7))));
      MR_Word FatalErrors_34 = ((MR_Word) ((MR_hl_field(0, ModuleErrors_33, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        parse_tree__prog_item__init_aug_compilation_unit_2_p_0(ParseTreeModuleSrc_32, &AugCompUnit_35);
        {
        ...
        parse_tree__generate_dep_d_files__generate_d_mmakefile_contents_9_p_0(Globals_2, BurdenedAugCompUnit_36, DFileDeps_37, &FileNameD_38, &FileContentsStrD_39, STATE_VARIABLE_Cache_0_5, &STATE_VARIABLE_Cache_29_29);
      ...
      next_value_of_STATE_VARIABLE_Cache_0_5 = STATE_VARIABLE_Cache_29_29;
  ...
  MR_String FileContentsStrD_10)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 77, &Verbose_16);
    switch (Verbose_16) {
  ...
  MR_Word Baggage_12)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_0), (MR_Word) (&parse_tree__write_deps_file_scalar_common_1[0]), &Cache0_15);
  parse_tree__generate_mmakefile_fragments__generate_dv_mmakefile_9_p_0(Globals_9, SourceFileName_14, ModuleName_10, DepsMap_11, &MmakeFileDv_16, Cache0_15, &_Cache_17);
  parse_tree__generate_mmakefile_fragments__generate_dep_mmakefile_7_p_0(Globals_9, SourceFileName_14, ModuleName_10, DepsMap_11, &MmakeFileDep_18);
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_and_write_dep_dv_files\'/7", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[0])), ModuleName_10, &FileNameDv_21, &_FileNameDvProposed_22);
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_and_write_dep_dv_files\'/7", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[1])), ModuleName_10, &FileNameDep_23, &_FileNameDepProposed_24);
