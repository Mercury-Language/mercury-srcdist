...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_3[4][1];
  ...
  MR_Word MaybeInclTransOptRule_12)
{
  ...
  MR_String FileNameD_16;
  MR_String FileContentsStrD_17;
  MR_Word AugCompUnit_25;
  MR_Word ParseTreeModuleSrc_26;
  MR_Word ModuleName_27;
  MR_Word StdDeps_30;
  MR_Word AllDeps_31;
  MR_Word MaybeInclTransOptRule_32;
  MR_Word IntermodDeps_33;
  MR_Word MmakeFileD_34;
  ...
  parse_tree__generate_dep_d_files__construct_d_file_deps_hlds_5_p_0(Globals_9, BurdenedAugCompUnit_10, AllDeps_11, MaybeInclTransOptRule_12, &DFileDeps_15);
  AugCompUnit_25 = ((MR_Word) ((MR_hl_field(0, BurdenedAugCompUnit_10, 1))));
  ParseTreeModuleSrc_26 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_25, 0))));
  ModuleName_27 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_26, 0))));
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_mmakefile_contents\'/9", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[2])), ModuleName_27, &FileNameD_16, &_FileNameDProposed_29);
  StdDeps_30 = ((MR_Word) ((MR_hl_field(0, DFileDeps_15, 0))));
  AllDeps_31 = ((MR_Word) ((MR_hl_field(0, DFileDeps_15, 1))));
  MaybeInclTransOptRule_32 = ((MR_Word) ((MR_hl_field(0, DFileDeps_15, 2))));
  parse_tree__generate_dep_d_files__construct_intermod_deps_8_p_0(Globals_9, ParseTreeModuleSrc_26, StdDeps_30, &IntermodDeps_33, Cache0_14, &STATE_VARIABLE_Cache_1_38);
  parse_tree__generate_mmakefile_fragments__generate_d_mmakefile_11_p_0(Globals_9, BurdenedAugCompUnit_10, StdDeps_30, AllDeps_31, MaybeInclTransOptRule_32, IntermodDeps_33, &MmakeFileD_34, STATE_VARIABLE_Cache_1_38, &_Cache_18);
  FileContentsStrD_17 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_34);
  parse_tree__write_deps_file__write_out_d_file_6_p_0(ProgressStream_8, Globals_9, FileNameD_16, FileContentsStrD_17);
}
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word Cache0_73;
      MR_Word BurdenedModule_87 = ((MR_Word) ((MR_hl_field(1, MaybeBurdenedModule_15, 0))));
      ...
      parse_tree__write_deps_file__generate_and_write_d_file_gendep_depgraphs_8_p_0(ProgressStream_8, Globals_9, DepGraphs_18, BurdenedModule_87, Cache0_73, &_Cache_74);
    }
  }
  else
  {
    MR_Word FatalErrorSpecs_114 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&parse_tree__write_deps_file_scalar_common_3[3]), 0))));

    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_114, STATE_VARIABLE_Specs_1_24);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__write_deps_file__generate_and_write_dep_dv_files_gendep_7_p_0(ProgressStream_8, Globals_9, *DepsMap_11, ModuleName_14, Baggage_18);
      ...
      mercury__map__init_1_p_0((MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_0), (MR_Word) (&parse_tree__write_deps_file_scalar_common_1[0]), &Cache0_73);
      parse_tree__write_deps_file__generate_and_write_d_file_gendep_depgraphs_loop_8_p_0(ProgressStream_8, Globals_9, DepGraphs_20, BurdenedModules_21, Cache0_73, &_Cache_74);
    }
  }
  else
  {
    MR_Word FatalErrorSpecs_78 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&parse_tree__write_deps_file_scalar_common_3[3]), 0))));
  ...
  MR_Word * STATE_VARIABLE_Cache_25)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word BurdenedAugCompUnit_20;
    MR_Word DFileDeps_21;
    MR_String FileNameD_22;
    MR_String FileContentsStrD_23;
    MR_Word AugCompUnit_43;
    MR_Word ParseTreeModuleSrc_44;
    MR_Word ModuleName_45;
    MR_Word StdDeps_48;
    MR_Word AllDeps_49;
    MR_Word MaybeInclTransOptRule_50;
    MR_Word IntermodDeps_51;
    MR_Word MmakeFileD_52;
    MR_Word STATE_VARIABLE_Cache_1_56;
    MR_String _FileNameDProposed_47;

    parse_tree__prog_parse_tree__init_aug_compilation_unit_2_p_0(ParseTreeModuleSrc_16, &AugCompUnit_19);
    {
      BurdenedAugCompUnit_20 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, BurdenedAugCompUnit_20, 0) = ((MR_Box) (Baggage_15));
      MR_hl_field(0, BurdenedAugCompUnit_20, 1) = ((MR_Box) (AugCompUnit_19));
    }
    parse_tree__generate_dep_d_files__construct_d_file_deps_gendep_4_p_0(Globals_10, DepGraphs_11, BurdenedAugCompUnit_20, &DFileDeps_21);
    AugCompUnit_43 = ((MR_Word) ((MR_hl_field(0, BurdenedAugCompUnit_20, 1))));
    ParseTreeModuleSrc_44 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_43, 0))));
    ModuleName_45 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_44, 0))));
    parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_10, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_mmakefile_contents\'/9", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[2])), ModuleName_45, &FileNameD_22, &_FileNameDProposed_47);
    StdDeps_48 = ((MR_Word) ((MR_hl_field(0, DFileDeps_21, 0))));
    AllDeps_49 = ((MR_Word) ((MR_hl_field(0, DFileDeps_21, 1))));
    MaybeInclTransOptRule_50 = ((MR_Word) ((MR_hl_field(0, DFileDeps_21, 2))));
    parse_tree__generate_dep_d_files__construct_intermod_deps_8_p_0(Globals_10, ParseTreeModuleSrc_44, StdDeps_48, &IntermodDeps_51, STATE_VARIABLE_Cache_0_24, &STATE_VARIABLE_Cache_1_56);
    parse_tree__generate_mmakefile_fragments__generate_d_mmakefile_11_p_0(Globals_10, BurdenedAugCompUnit_20, StdDeps_48, AllDeps_49, MaybeInclTransOptRule_50, IntermodDeps_51, &MmakeFileD_52, STATE_VARIABLE_Cache_1_56, STATE_VARIABLE_Cache_25);
    FileContentsStrD_23 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_52);
    parse_tree__write_deps_file__write_out_d_file_6_p_0(ProgressStream_9, Globals_10, FileNameD_22, FileContentsStrD_23);
  }
  else
      ...
      else
      {
        ...
        if ((RemoveResult_23 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          else
          {
            ...
            libs__file_util__report_error_4_p_0(ProgressStream_7, Message_89);
          }
        }
        else
        {
  ...
  MR_Word Baggage_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_and_write_dep_dv_files_gendep\'/7", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[0])), ModuleName_11, &FileNameDv_19, &_FileNameDvProposed_20);
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_and_write_dep_dv_files_gendep\'/7", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_3[1])), ModuleName_11, &FileNameDep_21, &_FileNameDepProposed_22);
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__module_cmds__create_java_shell_script_6_p_0(ProgressStream_8, Globals_9, ModuleName_11, &_Succeeded_26);
      }
      break;
  }
}
