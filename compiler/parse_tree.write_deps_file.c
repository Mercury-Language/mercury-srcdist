...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_4[24][1];
...
static /* final */ const MR_Box parse_tree__write_deps_file_scalar_common_1[130][2] = {
  ...
  /* row  93 */
  {
    ((MR_Box) (&parse_tree__write_deps_file_scalar_common_4[21])),
    ((MR_Box) ((MR_String) ".dates"))
  },
  /* row  94 */
  {
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_42)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_18, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_clean_targets\'/17", (MR_Word) (&parse_tree__write_deps_file_scalar_common_4[22]), ModuleName_19, &CleanTargetName_33);
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_18, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_clean_targets\'/17", (MR_Word) (&parse_tree__write_deps_file_scalar_common_4[23]), ModuleName_19, &RealCleanTargetName_34);
  {
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_66)
{
  ...
  (env).parse_tree__write_deps_file__generate_dep_file_install_targets_14_p_0_env_0__DepsMap_17 = DepsMap_17;
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (&parse_tree__write_deps_file_scalar_common_4[13]), ModuleName_16, &LibInstallOptsTargetName_34);
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (&parse_tree__write_deps_file_scalar_common_4[14]), ModuleName_16, &LibInstallHdrsTargetName_35);
    parse_tree__file_names__module_name_to_lib_file_name_6_p_0(Globals_15, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_install_targets\'/14", (MR_String) "lib", (MR_Word) (&parse_tree__write_deps_file_scalar_common_4[15]), ModuleName_16, &LibInstallGradeHdrsTargetName_36);
  ...
  MR_Word * STATE_VARIABLE_MmakeFile_67)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_16, (MR_String) "predicate \140parse_tree.write_deps_file.generate_dep_file_exec_library_targets\'/15", (MR_Word) (MR_mkword(2, &parse_tree__write_deps_file_scalar_common_4[2])), ModuleName_17, JarFileName_24);
