  ...
  MR_Word * STATE_VARIABLE_Cache_109)
{
  ...
  Var_461 = mercury__string__f_43_43_2_f_0(ModuleMakeVarName_24, (MR_String) ".analyses");
  Var_733 = mercury__string__f_43_43_2_f_0(ModuleMakeVarName_24, (MR_String) ".mods:%=\044(analyses_subdir)%.analysis)");
