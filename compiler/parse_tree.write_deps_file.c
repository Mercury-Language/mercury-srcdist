...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 623, &UseInstallName_44);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 656, &IntermodDirs_96);
    switch (Intermod_95) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 653, &UseSubdirs_195);
