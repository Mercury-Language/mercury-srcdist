...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 114, &Order_10);
    switch (Order_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 66, &Verbose_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 143, &MmcMakeDeps_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 489, &Intermod_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 493, &TransOpt_25);
...
{
  {
    ...
    Var_97 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_98, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[93])));
    ...
    Var_166 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_98, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[113])));
...
{
  {
    ...
    mercury__list__map_foldl_5_p_2((MR_Word) (&parse_tree__write_deps_file_scalar_common_2[3]), (MR_Word) (&libs__mmakefiles__libs__mmakefiles__type_ctor_info_mmake_entry_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_18, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[81])), &MmakeRules_13, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_17);
...
{
  {
    ...
    (env).parse_tree__write_deps_file__generate_dep_file_install_targets_14_p_0_env_0__DepsMap_17 = DepsMap_17;
    {
      ...
      Var_125 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeModuleDepsVar_31, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[18])));
      ...
      Var_159 = mercury__string__f_43_43_2_f_0((MR_String) "for ext in int int2 int3", Var_161);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_158, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[26])));
      }
      {
        Var_156 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        Var_185 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeTransOptsVar_29, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[27])));
        ...
        Var_222 = mercury__string__f_43_43_2_f_0((MR_String) "for ext in ", Var_224);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_221, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[34])));
        }
        {
      ...
      ModuleMakeVarNameMhs_56 = mercury__string__f_43_43_2_f_0((MR_String) "\044(", Var_364);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_254, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[18])));
      }
      ...
      Var_268 = mercury__string__f_43_43_2_f_0((MR_String) "for hdr in ", Var_270);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_267, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[36])));
      }
      {
      ...
      ModuleMakeVarNameMihs_60 = mercury__string__f_43_43_2_f_0((MR_String) "\044(", Var_367);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_287, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[27])));
      }
      ...
      Var_301 = mercury__string__f_43_43_2_f_0((MR_String) "for hdr in ", Var_303);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_300, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_1[59])));
      }
      {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), MmakeFragmentExtForExe_30, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &parse_tree__write_deps_file_scalar_common_1[16])));
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 651, &UseInstallName_44);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), MmakeFragmentSharedLib_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &parse_tree__write_deps_file_scalar_common_1[17])));
...
{
  {
    ...
    parse_tree__write_deps_file__make_module_file_names_with_suffix_6_p_0(Globals_8, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[25])), Modules_20, &ModulesSourceFileNames_26);
    ...
    parse_tree__write_deps_file__make_module_file_names_with_suffix_6_p_0(Globals_8, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[25])), ModulesWithSubModules_28, &ModulesWithSubModulesSourceFileNames_33);
    ...
    parse_tree__write_deps_file__make_module_file_names_with_suffix_6_p_0(Globals_8, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[25])), ForeignModules_37, &ForeignModulesFileNames_38);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 297, &HighLevelCode_81);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 489, &Intermod_25);
    switch (Intermod_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140parse_tree.write_deps_file.write_dependency_file\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[0])), ModuleName_13, &DependencyFileName_14);
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[4])), ModuleName_30, &TransOptDateFileName_41);
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[5])), ModuleName_30, &OptDateFileName_49);
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[6])), ModuleName_30, &CDateFileName_50);
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[7])), ModuleName_30, &ObjFileName_43);
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[8])), ModuleName_30, &JavaDateFileName_51);
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[9])), ModuleName_30, &PicObjFileName_52);
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[10])), ModuleName_30, &Int0FileName_53);
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[11])), ModuleName_30, &CFileName_57);
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[12])), ModuleName_30, &DateFileName_60);
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[13])), ModuleName_30, &Date0FileName_61);
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_file\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[14])), ModuleName_30, &Date3FileName_64);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 681, &UseSubdirs_10);
        ...
        case (MR_Integer) 2:
          {
            ...
            parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_11, (MR_String) "predicate \140parse_tree.write_deps_file.construct_foreign_import_rules\'/10", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[24])), ModuleName_20, &ClassFileName_48);
            {
              ForeignImportTargets_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 297, &HighLevelCode_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 491, &UseOptFiles_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 489, &Intermod_25);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 684, &IntermodDirs_26);
    switch (Intermod_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 493, &TransOpt_31);
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 492, &UseTransOpt_32);
...
{
  {
    ...
    parse_tree__write_deps_file__make_module_file_name_group_with_suffix_7_p_0(Globals_19, (MR_String) "type_repn self dep", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_deps_file_scalar_common_3[16])), Var_79, &TypeRepnSelfDepGroups_43);
