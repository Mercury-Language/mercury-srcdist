  ...
  MR_Word MaybeInclTransOptRule_12)
{
  ...
  MR_Word ParseTreeModuleSrc_24;
  MR_Word ModuleName_25;
  MR_Word IntermodDeps_28;
  MR_Word MmakeFileD_29;
  MR_Word STATE_VARIABLE_Cache_1_33;
  MR_String _FileNameDProposed_27;
  MR_Word _Cache_18;
  ...
  AugCompUnit_23 = ((MR_Word) ((MR_hl_field(0, BurdenedAugCompUnit_10, 1))));
  ParseTreeModuleSrc_24 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_23, 0))));
  ModuleName_25 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_24, 0))));
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_mmakefile_contents\'/9", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_2[2])), ModuleName_25, &FileNameD_16, &_FileNameDProposed_27);
  parse_tree__d_file_deps__construct_intermod_deps_8_p_0(Globals_9, ParseTreeModuleSrc_24, DFileDeps_15, &IntermodDeps_28, Cache0_14, &STATE_VARIABLE_Cache_1_33);
  parse_tree__generate_mmakefile_fragments__generate_d_mmakefile_9_p_0(Globals_9, BurdenedAugCompUnit_10, DFileDeps_15, IntermodDeps_28, &MmakeFileD_29, STATE_VARIABLE_Cache_1_33, &_Cache_18);
  FileContentsStrD_17 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_29);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
      if ((Var_58 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_47 = mercury__string__string_1_f_0((MR_Word) (&parse_tree__write_deps_file_scalar_common_1[0]), ((MR_Box) (FatalErrors_39)));
    ...
    else
    {
      ...
      MR_Word Cache0_73;
      MR_Word BurdenedModule_85 = ((MR_Word) ((MR_hl_field(1, MaybeBurdenedModule_15, 0))));
      MR_Word _BurdenedModules_19;
      MR_Word _Cache_74;

      parse_tree__d_file_deps__compute_deps_for_d_files_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_18, &_BurdenedModules_19, STATE_VARIABLE_Specs_1_24, STATE_VARIABLE_Specs_20);
      Cache0_73 = parse_tree__make_module_file_names__init_module_file_name_cache_0_f_0();
      parse_tree__write_deps_file__generate_and_write_d_file_gendep_depgraphs_8_p_0(ProgressStream_8, Globals_9, DepGraphs_18, BurdenedModule_85, Cache0_73, &_Cache_74);
    }
  }
  else
  {
    MR_Word FatalErrorSpecs_112 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&parse_tree__write_deps_file_scalar_common_2[3]), 0))));

    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_112, STATE_VARIABLE_Specs_1_24);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__d_file_deps__compute_deps_for_d_files_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_20, &BurdenedModules_21, STATE_VARIABLE_Specs_1_26, STATE_VARIABLE_Specs_22);
      Cache0_73 = parse_tree__make_module_file_names__init_module_file_name_cache_0_f_0();
  ...
  {
    MR_Word FatalErrorSpecs_76 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&parse_tree__write_deps_file_scalar_common_2[3]), 0))));

    *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_76, STATE_VARIABLE_Specs_1_26);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Cache_25)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word IntermodDeps_48;
    MR_Word MmakeFileD_49;
    MR_Word STATE_VARIABLE_Cache_1_53;
    ...
    parse_tree__d_file_deps__construct_d_file_deps_gendep_4_p_0(Globals_10, DepGraphs_11, BurdenedAugCompUnit_20, &DFileDeps_21);
    ...
    parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_10, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_mmakefile_contents\'/9", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_2[2])), ModuleName_45, &FileNameD_22, &_FileNameDProposed_47);
    parse_tree__d_file_deps__construct_intermod_deps_8_p_0(Globals_10, ParseTreeModuleSrc_44, DFileDeps_21, &IntermodDeps_48, STATE_VARIABLE_Cache_0_24, &STATE_VARIABLE_Cache_1_53);
    parse_tree__generate_mmakefile_fragments__generate_d_mmakefile_9_p_0(Globals_10, BurdenedAugCompUnit_20, DFileDeps_21, IntermodDeps_48, &MmakeFileD_49, STATE_VARIABLE_Cache_1_53, STATE_VARIABLE_Cache_25);
    FileContentsStrD_23 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_49);
