  ...
  MR_Word * STATE_VARIABLE_Cache_7)
{
  ...
  else
  {
    ...
    MR_Word SearchAuthDirs_27;
    MR_Word STATE_VARIABLE_OptDeps_51_51;
    MR_Word STATE_VARIABLE_TransOptDeps_52_52;
    MR_Word STATE_VARIABLE_Cache_53_53;

    parse_tree__write_deps_file__get_plain_trans_opt_deps_9_p_0(Globals_1, LookForSrc_2, ModuleNames_21, &STATE_VARIABLE_OptDeps_51_51, &STATE_VARIABLE_TransOptDeps_52_52, STATE_VARIABLE_Cache_0_6, &STATE_VARIABLE_Cache_53_53);
    libs__globals__get_options_2_p_0(Globals_1, &OptionTable_26);
    SearchAuthDirs_27 = parse_tree__find_module__get_search_auth_intermod_dirs_1_f_0(OptionTable_26);
    switch (LookForSrc_2) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          ...
          MR_Word MaybeTransOptDir_42;
          MR_Word STATE_VARIABLE_Cache_60_60;
          MR_Word _SearchDirsNotFoundOpt_35;
          MR_Word _SearchDirsNotFoundTransOpt_41;

          parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[3])), ModuleName_20, &OptName_34, STATE_VARIABLE_Cache_53_53, &STATE_VARIABLE_Cache_60_60);
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDirs_27, OptName_34, &_SearchDirsNotFoundOpt_35, &MaybeOptDir_36);
          if (((MR_tag((MR_Word) MaybeOptDir_36)) == (MR_Integer) 1))
            *HeadVar__4_4 = STATE_VARIABLE_OptDeps_51_51;
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
              ...
              MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_OptDeps_51_51));
            }
          parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[4])), ModuleName_20, &TransOptName_40, STATE_VARIABLE_Cache_60_60, STATE_VARIABLE_Cache_7);
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDirs_27, TransOptName_40, &_SearchDirsNotFoundTransOpt_41, &MaybeTransOptDir_42);
          if (((MR_tag((MR_Word) MaybeTransOptDir_42)) == (MR_Integer) 1))
            *HeadVar__5_5 = STATE_VARIABLE_TransOptDeps_52_52;
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (ModuleName_20));
              MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_TransOptDeps_52_52));
            }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_Word _SearchDirsLook_28;

          parse_tree__find_module__search_for_module_source_6_p_0(SearchAuthDirs_27, ModuleName_20, &_SearchDirsLook_28, &MaybeFileName_29);
          if (((MR_tag((MR_Word) MaybeFileName_29)) == (MR_Integer) 1))
          {
            MR_String OptName_71;
            MR_Word MaybeOptDir_73;
            MR_String TransOptName_75;
            MR_Word MaybeTransOptDir_77;
            MR_Word STATE_VARIABLE_Cache_60_79;
            MR_Word _SearchDirsNotFoundOpt_68;
            MR_Word _SearchDirsNotFoundTransOpt_69;

            parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[3])), ModuleName_20, &OptName_71, STATE_VARIABLE_Cache_53_53, &STATE_VARIABLE_Cache_60_79);
            parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDirs_27, OptName_71, &_SearchDirsNotFoundOpt_68, &MaybeOptDir_73);
            ...
            parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[4])), ModuleName_20, &TransOptName_75, STATE_VARIABLE_Cache_60_79, STATE_VARIABLE_Cache_7);
            parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDirs_27, TransOptName_75, &_SearchDirsNotFoundTransOpt_69, &MaybeTransOptDir_77);
            if (((MR_tag((MR_Word) MaybeTransOptDir_77)) == (MR_Integer) 1))
              *HeadVar__5_5 = STATE_VARIABLE_TransOptDeps_52_52;
            else
              {
                MR_Word base;
          ...
          else
          {
            ...
            *STATE_VARIABLE_Cache_7 = STATE_VARIABLE_Cache_53_53;
          }
        }
        break;
    }
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  {
    MR_Word ModuleName_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 0))));
    MR_Word ModuleNames_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 1))));
    MR_Word OptionTable_21;
    MR_Word STATE_VARIABLE_OptDeps_39_39;

    parse_tree__write_deps_file__get_ext_opt_deps_7_p_0(Globals_1, LookForSrc_2, Ext_3, ModuleNames_18, &STATE_VARIABLE_OptDeps_39_39);
    libs__globals__get_options_2_p_0(Globals_1, &OptionTable_21);
    switch (LookForSrc_2) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word SearchWhichDirsExt_28;
          MR_Word SearchAuthDirsExt_29;
          MR_String OptName_30;
          MR_Word MaybeOptDir_33;
          MR_String _OptNameProposed_31;
          MR_Word _SearchDirsNotFound_32;

          {
            SearchWhichDirsExt_28 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, SearchWhichDirsExt_28, 0) = ((MR_Box) ((MR_Unsigned) 2U));
            MR_hl_field(3, SearchWhichDirsExt_28, 1) = ((MR_Box) (OptionTable_21));
          }
          parse_tree__file_names__module_name_to_search_file_name_8_p_1(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_ext_opt_deps\'/7", Ext_3, ModuleName_17, SearchWhichDirsExt_28, &SearchAuthDirsExt_29, &OptName_30, &_OptNameProposed_31);
          parse_tree__find_module__search_for_file_6_p_0(SearchAuthDirsExt_29, OptName_30, &_SearchDirsNotFound_32, &MaybeOptDir_33);
          if (((MR_tag((MR_Word) MaybeOptDir_33)) == (MR_Integer) 1))
      ...
      case (MR_Integer) 1:
        {
          MR_Word SearchAuthDirsSrc_22;
          MR_Word Result1_24;
          MR_Word _SearchDirsLook_23;

          SearchAuthDirsSrc_22 = parse_tree__find_module__get_search_auth_intermod_dirs_1_f_0(OptionTable_21);
          parse_tree__find_module__search_for_module_source_6_p_0(SearchAuthDirsSrc_22, ModuleName_17, &_SearchDirsLook_23, &Result1_24);
          if (((MR_tag((MR_Word) Result1_24)) == (MR_Integer) 1))
          {
            MR_Word SearchWhichDirsExt_46;
            ...
            {
              SearchWhichDirsExt_46 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, SearchWhichDirsExt_46, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(3, SearchWhichDirsExt_46, 1) = ((MR_Box) (OptionTable_21));
            }
            parse_tree__file_names__module_name_to_search_file_name_8_p_1(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_ext_opt_deps\'/7", Ext_3, ModuleName_17, SearchWhichDirsExt_46, &SearchAuthDirsExt_47, &OptName_48, &_OptNameProposed_44);
