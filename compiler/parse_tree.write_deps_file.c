      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) MaybeFileName_23)) == (MR_Integer) 1))
          {
            ...
            libs__file_util__search_for_file_returning_dir_5_p_0(IntermodDirs_3, OptName_59, &MaybeOptDir_60);
            ...
            libs__file_util__search_for_file_returning_dir_5_p_0(IntermodDirs_3, TransOptName_61, &MaybeTransOptDir_62);
