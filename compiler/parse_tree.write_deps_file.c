...
static void MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1425__1_5_p_0(
  MR_Word Globals_8,
  MR_Word LambdaHeadVar__1_137,
  MR_String * LambdaHeadVar__2_138);

static MR_bool MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1394__1_2_p_0(
  MR_Word DepsMap_11,
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 149, &MmcMakeDeps_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 495, &Intermod_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 499, &TransOpt_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 657, &UseInstallName_44);
...
{
  {
    ...
    parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1425__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_138);
...
{
  {
    ...
    succeeded = parse_tree__write_deps_file__IntroducedFrom__pred__generate_dv_file__1394__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 303, &HighLevelCode_83);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 495, &Intermod_27);
    switch (Intermod_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 687, &UseSubdirs_10);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 303, &HighLevelCode_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 497, &UseOptFiles_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 495, &Intermod_25);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 690, &IntermodDirs_26);
    switch (Intermod_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 499, &TransOpt_31);
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 498, &UseTransOpt_32);
