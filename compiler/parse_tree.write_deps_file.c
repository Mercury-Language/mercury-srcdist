  ...
  MR_Word * STATE_VARIABLE_MmakeFile_67)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 650, &UseInstallName_44);
  ...
  MR_Word * MmakeRulesSubDirShorthand_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 680, &UseSubdirs_10);
  ...
  MR_Word * MmakeRulesIntermod_22)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 683, &IntermodDirs_26);
  switch (Intermod_25) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
