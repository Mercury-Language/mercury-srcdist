      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__write_deps_file__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_1, (MR_Integer) 322, &parse_tree__write_deps_file__Intermod_35);
            }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_19, (MR_Integer) 604, &parse_tree__write_deps_file__UseInstallName_49);
    }
...
{
  {
    ...
    if (((MR_tag((MR_Word) parse_tree__write_deps_file__Result_44)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 324, &parse_tree__write_deps_file__UseOptFiles_76);
        }
        {
          libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 322, &parse_tree__write_deps_file__Intermod_77);
        }
        {
          libs__globals__lookup_accumulating_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 637, &parse_tree__write_deps_file__IntermodDirs_78);
        }
        ...
        if (parse_tree__write_deps_file__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 326, &parse_tree__write_deps_file__TransOpt_79);
            }
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 325, &parse_tree__write_deps_file__UseTransOpt_80);
            }
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 254, &parse_tree__write_deps_file__HighLevelCode_85);
        }
        {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(parse_tree__write_deps_file__Globals_7, (MR_Integer) 634, &parse_tree__write_deps_file__UseSubdirs_156);
        }
