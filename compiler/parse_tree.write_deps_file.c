  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) MaybeBurdenedModule_15)) == (MR_Integer) 0))
    {
      ...
      *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), FatalErrorSpecs_16, STATE_VARIABLE_Specs_1_24);
    }
    else
    {
      ...
      parse_tree__d_file_deps__compute_dep_graphs_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_18, &_BurdenedModules_19, STATE_VARIABLE_Specs_1_24, STATE_VARIABLE_Specs_20);
      {
      ...
      parse_tree__write_deps_file__generate_and_write_d_file_gendep_depgraphs_loop_8_p_0(ProgressStream_8, Globals_9, DepGraphs_18, Var_29, Cache0_73, &_Cache_74);
    }
  }
  else
  {
    ...
    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), FatalErrorSpecs_76, STATE_VARIABLE_Specs_1_24);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) MaybeBurdenedModule_15)) == (MR_Integer) 0))
    {
      ...
      *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), FatalErrorSpecs_16, STATE_VARIABLE_Specs_1_26);
    }
    else
    {
      MR_Word BurdenedModule_17 = ((MR_Word) ((MR_hl_field(1, MaybeBurdenedModule_15, 0))));
      ...
      parse_tree__d_file_deps__compute_dep_graphs_gendep_10_p_0(ProgressStream_8, Globals_9, ModuleName_14, *DepsMap_11, &DepGraphs_20, &BurdenedModules_21, STATE_VARIABLE_Specs_1_26, STATE_VARIABLE_Specs_22);
      Cache0_73 = parse_tree__make_module_file_names__init_module_file_name_cache_0_f_0();
  ...
  else
  {
    ...
    *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), FatalErrorSpecs_76, STATE_VARIABLE_Specs_1_26);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Cache_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Baggage_31 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_21, 0))));
      MR_Word ParseTreeModuleSrc_32 = ((MR_Word) ((MR_hl_field(0, BurdenedModule_21, 1))));
      ...
      if (succeeded)
      {
        MR_Word DFileDeps_35;
        MR_String FileNameD_36;
        MR_String FileContentsStrD_37;
        MR_Word ModuleName_51;
        MR_Word IntermodDeps_54;
        MR_Word MmakeFileD_55;
        MR_Word STATE_VARIABLE_Cache_1_59;
        MR_String _FileNameDProposed_53;

        parse_tree__d_file_deps__construct_d_file_deps_gendep_5_p_0(Globals_2, DepGraphs_3, Baggage_31, ParseTreeModuleSrc_32, &DFileDeps_35);
        ModuleName_51 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_32, 0))));
        parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_2, (MR_String) "predicate \140parse_tree.write_deps_file.generate_d_mmakefile_contents\'/10", (MR_Word) (MR_mkword(1, &parse_tree__write_deps_file_scalar_common_2[2])), ModuleName_51, &FileNameD_36, &_FileNameDProposed_53);
        parse_tree__d_file_deps__construct_intermod_deps_8_p_0(Globals_2, ParseTreeModuleSrc_32, DFileDeps_35, &IntermodDeps_54, STATE_VARIABLE_Cache_0_5, &STATE_VARIABLE_Cache_1_59);
        parse_tree__generate_mmakefile_fragments__generate_d_mmakefile_10_p_0(Globals_2, Baggage_31, ParseTreeModuleSrc_32, DFileDeps_35, IntermodDeps_54, &MmakeFileD_55, STATE_VARIABLE_Cache_1_59, &STATE_VARIABLE_Cache_1_29);
        FileContentsStrD_37 = libs__mmakefiles__mmakefile_to_string_1_f_0(MmakeFileD_55);
        parse_tree__write_deps_file__write_out_d_file_6_p_0(ProgressStream_1, Globals_2, FileNameD_36, FileContentsStrD_37);
      }
      else
