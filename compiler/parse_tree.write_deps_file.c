  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  else
  {
    ...
    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FatalErrorSpecs_76, STATE_VARIABLE_Specs_1_24);
  }
}
