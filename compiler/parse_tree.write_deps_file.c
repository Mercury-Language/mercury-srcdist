...
static void MR_CALL 
parse_tree__write_deps_file__IntroducedFrom__pred__get_dependencies_from_graph__553__1_4_p_0(
  MR_Word DepsGraph_4,
...
parse_tree__write_deps_file__IntroducedFrom__pred__generate_dependencies_write_d_file__514__1_2_p_0(
...
static void MR_CALL 
parse_tree__write_deps_file__get_plain_trans_opt_deps_9_p_0(
  MR_Word Globals_1,
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__write_deps_file__IntroducedFrom__pred__generate_dependencies_write_d_file__514__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__write_deps_file__IntroducedFrom__pred__get_dependencies_from_graph__553__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_17);
  ...
  MR_Word * STATE_VARIABLE_Cache_35)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word TransOpt_21;
    MR_Word LookForSrc_22;
    MR_Word DirectDeps_23;
    MR_Word ModuleName_27;
    MR_Word BaseDeps_28;
    MR_Word PlainOptDeps_29;
    MR_Word MaybeTransOptDeps_31;
    MR_Word Var_42;
    ...
    switch (UseTransOpt_20) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        LookForSrc_22 = (MR_Integer) 1;
        break;
      case (MR_Integer) 1:
        LookForSrc_22 = (MR_Integer) 0;
        break;
    }
    DirectDeps_23 = ((MR_Word) ((MR_hl_field(0, StdDeps_12, (MR_Integer) 0))));
    ModuleName_27 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_11, (MR_Integer) 0))));
    Var_42 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), DirectDeps_23);
    {
      BaseDeps_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, BaseDeps_28, 0) = ((MR_Box) (ModuleName_27));
      MR_hl_field(1, BaseDeps_28, 1) = ((MR_Box) (Var_42));
    }
    ...
    if (succeeded)
    {
      MR_Word TransOptDeps_30;

      parse_tree__write_deps_file__get_plain_trans_opt_deps_9_p_0(Globals_10, LookForSrc_22, BaseDeps_28, &PlainOptDeps_29, &TransOptDeps_30, STATE_VARIABLE_Cache_0_34, STATE_VARIABLE_Cache_35);
      {
        MaybeTransOptDeps_31 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeTransOptDeps_31, 0) = ((MR_Box) (TransOptDeps_30));
      }
    }
    else
    {
      parse_tree__write_deps_file__get_ext_opt_deps_7_p_0(Globals_10, LookForSrc_22, (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[3])), BaseDeps_28, &PlainOptDeps_29);
      MaybeTransOptDeps_31 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    }
    {
      ...
      MR_hl_field(1, MaybeOptFileDeps_33, 0) = ((MR_Box) (PlainOptDeps_29));
      MR_hl_field(1, MaybeOptFileDeps_33, 1) = ((MR_Box) (MaybeTransOptDeps_31));
    }
  }
  else
  {
  ...
  MR_Word * STATE_VARIABLE_Cache_7)
{
  ...
  {
    MR_Word Dep_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
    MR_Word Deps_21 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
    MR_Word OptionTable_26;
    MR_Word STATE_VARIABLE_OptDeps_50_50;
    MR_Word STATE_VARIABLE_TransOptDeps_51_51;
    MR_Word STATE_VARIABLE_Cache_52_52;

    parse_tree__write_deps_file__get_plain_trans_opt_deps_9_p_0(Globals_1, LookForSrc_2, Deps_21, &STATE_VARIABLE_OptDeps_50_50, &STATE_VARIABLE_TransOptDeps_51_51, STATE_VARIABLE_Cache_0_6, &STATE_VARIABLE_Cache_52_52);
    libs__globals__get_options_2_p_0(Globals_1, &OptionTable_26);
    switch (LookForSrc_2) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_String OptName_33;
          MR_Word MaybeOptDir_35;
          MR_String TransOptName_39;
          MR_Word MaybeTransOptDir_41;
          MR_Word STATE_VARIABLE_Cache_60_60;
          MR_Word Var_62;
          MR_Word _SearchDirsNotFoundOpt_34;
          MR_Word _SearchDirsNotFoundTransOpt_40;

          parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[3])), Dep_20, &OptName_33, STATE_VARIABLE_Cache_52_52, &STATE_VARIABLE_Cache_60_60);
          {
            Var_62 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, Var_62, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(3, Var_62, 1) = ((MR_Box) (OptionTable_26));
          }
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(Var_62, OptName_33, &_SearchDirsNotFoundOpt_34, &MaybeOptDir_35);
          if (((MR_tag((MR_Word) MaybeOptDir_35)) == (MR_Integer) 1))
            *HeadVar__4_4 = STATE_VARIABLE_OptDeps_50_50;
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
              ...
              MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_OptDeps_50_50));
            }
          parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[4])), Dep_20, &TransOptName_39, STATE_VARIABLE_Cache_60_60, STATE_VARIABLE_Cache_7);
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(Var_62, TransOptName_39, &_SearchDirsNotFoundTransOpt_40, &MaybeTransOptDir_41);
          if (((MR_tag((MR_Word) MaybeTransOptDir_41)) == (MR_Integer) 1))
            *HeadVar__5_5 = STATE_VARIABLE_TransOptDeps_51_51;
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (Dep_20));
              MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_TransOptDeps_51_51));
            }
        }
        break;
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(3, Var_54, 1) = ((MR_Box) (OptionTable_26));
          }
          parse_tree__find_module__search_for_module_source_6_p_0(Var_54, Dep_20, &_SearchDirsLook_27, &MaybeFileName_28);
          if (((MR_tag((MR_Word) MaybeFileName_28)) == (MR_Integer) 1))
          {
            MR_String OptName_73;
            MR_Word MaybeOptDir_75;
            MR_String TransOptName_77;
            MR_Word MaybeTransOptDir_79;
            MR_Word STATE_VARIABLE_Cache_60_81;
            MR_Word _SearchDirsNotFoundOpt_70;
            MR_Word _SearchDirsNotFoundTransOpt_71;

            parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[3])), Dep_20, &OptName_73, STATE_VARIABLE_Cache_52_52, &STATE_VARIABLE_Cache_60_81);
            parse_tree__find_module__search_for_file_returning_dir_6_p_0(Var_54, OptName_73, &_SearchDirsNotFoundOpt_70, &MaybeOptDir_75);
            if (((MR_tag((MR_Word) MaybeOptDir_75)) == (MR_Integer) 1))
              *HeadVar__4_4 = STATE_VARIABLE_OptDeps_50_50;
            else
              {
                MR_Word base;
            ...
            parse_tree__make_module_file_names__make_module_file_name_9_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_plain_trans_opt_deps\'/9", (MR_Word) (MR_mkword(3, &parse_tree__write_deps_file_scalar_common_1[4])), Dep_20, &TransOptName_77, STATE_VARIABLE_Cache_60_81, STATE_VARIABLE_Cache_7);
            parse_tree__find_module__search_for_file_returning_dir_6_p_0(Var_54, TransOptName_77, &_SearchDirsNotFoundTransOpt_71, &MaybeTransOptDir_79);
            if (((MR_tag((MR_Word) MaybeTransOptDir_79)) == (MR_Integer) 1))
              *HeadVar__5_5 = STATE_VARIABLE_TransOptDeps_51_51;
            else
              {
                MR_Word base;
          ...
          else
          {
            ...
            *STATE_VARIABLE_Cache_7 = STATE_VARIABLE_Cache_52_52;
          }
        }
        break;
    }
...
void MR_CALL 
parse_tree__write_deps_file__get_ext_opt_deps_7_p_0(
  MR_Word Globals_1,
  MR_Word LookForSrc_2,
  MR_Word Ext_3,
  MR_Word HeadVar__4_4,
  MR_Word * HeadVar__5_5)
{
  ...
  {
    MR_Word Dep_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 0))));
    MR_Word Deps_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 1))));
    MR_Word OptionTable_21;
    MR_Word STATE_VARIABLE_OptDeps_36_36;

    parse_tree__write_deps_file__get_ext_opt_deps_7_p_0(Globals_1, LookForSrc_2, Ext_3, Deps_18, &STATE_VARIABLE_OptDeps_36_36);
    libs__globals__get_options_2_p_0(Globals_1, &OptionTable_21);
    switch (LookForSrc_2) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          ...
          MR_Word Var_42;
          MR_String _OptNameProposed_28;
          MR_Word _SearchDirsNotFound_29;

          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_ext_opt_deps\'/7", Ext_3, Dep_17, &OptName_27, &_OptNameProposed_28);
          {
            Var_42 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, Var_42, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(3, Var_42, 1) = ((MR_Box) (OptionTable_21));
          }
          parse_tree__find_module__search_for_file_6_p_0(Var_42, OptName_27, &_SearchDirsNotFound_29, &MaybeOptDir_30);
          if (((MR_tag((MR_Word) MaybeOptDir_30)) == (MR_Integer) 1))
            *HeadVar__5_5 = STATE_VARIABLE_OptDeps_36_36;
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (Dep_17));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(3, Var_38, 1) = ((MR_Box) (OptionTable_21));
          }
          parse_tree__find_module__search_for_module_source_6_p_0(Var_38, Dep_17, &_SearchDirsLook_22, &Result1_23);
          if (((MR_tag((MR_Word) Result1_23)) == (MR_Integer) 1))
          {
            MR_String OptName_45;
            MR_Word MaybeOptDir_48;
            MR_String _OptNameProposed_43;
            MR_Word _SearchDirsNotFound_44;

            parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_1, (MR_String) "predicate \140parse_tree.write_deps_file.get_ext_opt_deps\'/7", Ext_3, Dep_17, &OptName_45, &_OptNameProposed_43);
            parse_tree__find_module__search_for_file_6_p_0(Var_38, OptName_45, &_SearchDirsNotFound_44, &MaybeOptDir_48);
            if (((MR_tag((MR_Word) MaybeOptDir_48)) == (MR_Integer) 1))
              *HeadVar__5_5 = STATE_VARIABLE_OptDeps_36_36;
            else
              {
                MR_Word base;
