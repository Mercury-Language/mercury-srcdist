...
ifeq ($(TARGET_ASM),yes)
libs.md4.mh libs.md4.mih : libs.md4.s
else
libs.md4.mh libs.md4.mih : libs.md4.c
endif

ifeq ($(TARGET_ASM),yes)
libs.md4.module_dep : libs.md4.s
else
 ifeq ($(findstring il,$(GRADE)),il)
libs.md4.module_dep : libs.md4.il
  ifeq ($(findstring java,$(GRADE)),java)
libs.md4.module_dep : mercury/libs_/md4.java
  else
...
ifeq ($(TARGET_ASM),yes)
libs.md4.s_date : md4.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only libs.md4 $(ERR_REDIRECT)
libs.md4.pic_s_date : md4.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" libs.md4 $(ERR_REDIRECT)
endif # TARGET_ASM
