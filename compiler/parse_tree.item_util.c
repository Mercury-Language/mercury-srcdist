      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeDefn_6, (MR_Integer) 2))));

          succeeded = ((MR_tag((MR_Word) Var_30)) == (MR_Integer) 2);
          if (succeeded)
          {
            DetailsForeign_7 = (MR_Word) (MR_body((MR_Word) (Var_30), (MR_Integer) 2));
          ...
          if (succeeded)
          {
            ...
            Var_31 = parse_tree__prog_foreign__foreign_type_language_1_f_0(ForeignType_8);
            {
              Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_31));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 2))));
