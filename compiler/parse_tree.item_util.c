      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 0)));
          MR_Word Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 1)));
          MR_Word Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 3)));
          MR_Word Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 4)));
          MR_Integer Var_26 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 5)));
          MR_Word Var_6;
          ...
          if (succeeded)
          {
            Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (ShortIntFileKind_4) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              if ((MaybeCanonical_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                    AbstractDetails_16 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
                  else
                  {
                    succeeded = parse_tree__prog_type__du_type_is_dummy_1_p_0(DetailsDu_8);
                    if (succeeded)
                      AbstractDetails_16 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
                    else
                ...
                Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 2)));
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((MaybeCanonical_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            *MaybeAbstractItemTypeDefn_6 = ItemTypeDefn_5;
          else
          {
