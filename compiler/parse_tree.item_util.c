                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Word Lang_88 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Word Lang_92 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_25, (MR_Integer) 0))) & (MR_Integer) 3);
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Word Lang_90 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FEInfo_22, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeDefn_5, (MR_Integer) 2))));
...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeDefn_7)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word DetailsDu_8 = (MR_Word) ((MR_Word) (TypeDefn_7));
          ...
          switch (ShortIntFileKind_4) {
            ...
            case (MR_Integer) 0:
              ...
              else
              {
                ...
                {
                  AbstractDetailsDu_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                ...
                AbstractTypeDefn_14 = (MR_Word) ((MR_Word) (AbstractDetailsDu_13));
                {
                  MR_Word base;
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  {
                    AbstractDetails_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            MR_Word AbstractDetailsForeign_23;
            MR_Word AbstractTypeDefn_39;

            {
              AbstractDetailsForeign_23 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), AbstractDetailsForeign_23, 0) = ((MR_Box) (ForeignType_21));
              MR_hl_field(MR_mktag(0), AbstractDetailsForeign_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__item_util_scalar_common_1[1])));
              MR_hl_field(MR_mktag(0), AbstractDetailsForeign_23, 2) = ((MR_Box) (Assertions_22));
            }
            AbstractTypeDefn_39 = (MR_Word) (MR_mkword(MR_mktag(2), (MR_Word) (AbstractDetailsForeign_23)));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
              *MaybeAbstractItemTypeDefn_6 = base;
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_7, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            switch (ShortIntFileKind_4) {
              default: /*NOTREACHED*/ MR_assert(0);
