    ...
    if (succeeded)
    {
      ...
      *STATE_VARIABLE_SectionImportOrUseMap_18 = STATE_VARIABLE_SectionImportOrUseMap_21_21;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Spec_16, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      *STATE_VARIABLE_SectionImportOrUseMap_15 = STATE_VARIABLE_SectionImportOrUseMap_18_18;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Spec_13, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
