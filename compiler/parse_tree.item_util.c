      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeDefn_6, (MR_Integer) 2))));

          succeeded = ((((MR_tag((MR_Word) Var_29)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 0)))) == (MR_Integer) 1)));
          if (succeeded)
          {
            DetailsForeign_7 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_29, (MR_Integer) 1))));
          ...
          if (succeeded)
          {
            ...
            Var_30 = parse_tree__prog_foreign__foreign_type_language_1_f_0(ForeignType_8);
            {
              Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_30));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word Lang_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_5, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);

          {
            Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Lang_57));
            MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_54 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attrs_18);
          {
            Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_54));
            MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Lang_61 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_14, (MR_Integer) 0))) & (MR_Integer) 3);

              {
                Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Lang_61));
                MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            break;
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Lang_59 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FEInfo_11, (MR_Integer) 0))) & (MR_Integer) 3);

              {
                Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Lang_59));
                MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            break;
