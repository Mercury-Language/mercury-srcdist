    ...
    case (MR_Integer) 2:
      {
        ...
        Var_48 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attrs_28);
        {
          Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  Var_80 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attrs_60);
                  {
                    Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_80));
                    MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
                break;
