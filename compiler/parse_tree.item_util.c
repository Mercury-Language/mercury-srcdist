                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_16, (MR_Integer) 0)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FCInfo_20, (MR_Integer) 0)));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word Var_77;
                    MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPInfo_28, (MR_Integer) 2)));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_25, (MR_Integer) 0)));
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FEInfo_22, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            {
              AbsttactDetailsForeign_23 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
