      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeDefn_6, (MR_Integer) 2))));

          succeeded = ((((MR_tag((MR_Word) Var_37)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_37, (MR_Integer) 0)))) == (MR_Integer) 1)));
          if (succeeded)
          {
            DetailsForeign_7 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_37, (MR_Integer) 1))));
          ...
          if (succeeded)
          {
            ...
            Var_38 = parse_tree__prog_foreign__foreign_type_language_1_f_0(ForeignType_8);
            {
              Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_38));
...
{
  {
    ...
    switch (MR_tag((MR_Word) Pragma_3)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word Lang_53 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_5, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);

          {
            Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Lang_53));
            MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
      ...
      case (MR_Integer) 2:
        {
          MR_Word FPInfo_14 = (MR_Word) (MR_body((MR_Word) (Pragma_3), (MR_Integer) 2));
          MR_Word Attrs_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FPInfo_14, (MR_Integer) 0))));
          MR_Word Var_50;

          Var_50 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attrs_15);
          {
            Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Var_50));
            MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Lang_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_11, (MR_Integer) 0))) & (MR_Integer) 3);

              {
                Langs_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Langs_4, 0) = ((MR_Box) (Lang_55));
                MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
            }
            break;
