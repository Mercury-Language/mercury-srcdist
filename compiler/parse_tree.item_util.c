...
static /* final */ const struct parse_tree__item_util__vector_common_type_10_0_s parse_tree__item_util_vector_common_10[4];
...
static /* final */ const struct parse_tree__item_util__vector_common_type_10_0_s parse_tree__item_util_vector_common_10[4] = {
  /* row   0 */   { (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[38])) },
  /* row   1 */   { (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[42])) },
  /* row   2 */   { (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[40])) },
  /* row   3 */   { (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[44])) },
};
            ...
            case (MR_Integer) 0:
              {
                ...
                OldPieces_18 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[148]));
              }
              break;
            case (MR_Integer) 1:
              {
                PrevContext_17 = ((MR_Word) ((MR_hl_field(1, OldEntry_11, (MR_Integer) 0))));
                OldPieces_18 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[151]));
              }
              break;
            case (MR_Integer) 2:
              {
                PrevContext_17 = ((MR_Word) ((MR_hl_field(2, OldEntry_11, (MR_Integer) 0))));
                OldPieces_18 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[142]));
              }
              break;
            case (MR_Integer) 3:
              {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Item_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            ...
            Pieces_4 = ((&parse_tree__item_util_vector_common_10[0 + PromiseType_18]))->parse_tree__item_util__vector_common_type_10_0__vct_10_f_0;
          }
          break;
        case (MR_Integer) 3:
        ...
        case (MR_Integer) 7:
          ...
          break;
        case (MR_Integer) 8:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[46]));
          break;
        case (MR_Integer) 9:
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Pragma_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 3:
          {
            ...
            switch (MR_tag((MR_Word) TabledMethod_22)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[110]));
                break;
              case (MR_Integer) 1:
                Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[112]));
                break;
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 3:
                Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[114]));
                break;
            }
          }
          break;
        ...
        case (MR_Integer) 8:
          ...
          break;
        case (MR_Integer) 9:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[108]));
          break;
        case (MR_Integer) 10:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[102]));
          break;
        case (MR_Integer) 11:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[104]));
          break;
        case (MR_Integer) 12:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[100]));
          break;
        case (MR_Integer) 13:
          Pieces_4 = (MR_Word) (MR_mkword(1, &parse_tree__item_util_scalar_common_2[106]));
          break;
      }
      break;
  }
