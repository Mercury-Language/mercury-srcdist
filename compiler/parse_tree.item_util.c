  ...
  MR_Word * STATE_VARIABLE_Langs_10)
{
  ...
  switch (MR_tag((MR_Word) ImplPragma_6)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Lang_51 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 3);
    ...
    case (MR_Integer) 2:
      {
        MR_Word FPInfo_27 = (MR_Word) (MR_body((MR_Word) (ImplPragma_6), (MR_Integer) 2));
        MR_Word Attrs_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FPInfo_27, (MR_Integer) 0))));
        MR_Word Var_49;

        Var_49 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attrs_28);
        {
          Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (Var_49));
          MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      }
      break;
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Lang_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_22, (MR_Integer) 1))) & (MR_Integer) 3);

            {
              Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (Lang_53));
              MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          break;
