...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_24, 0) = ((MR_Box) ((MR_Unsigned) 23U));
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word EvalMethod_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Tabled_21, (MR_Integer) 0))));

              switch (MR_tag((MR_Word) EvalMethod_22)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(EvalMethod_22)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
