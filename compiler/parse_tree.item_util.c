      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            Var_81 = parse_tree__prog_foreign__foreign_type_language_1_f_0(ForeignType_8);
            {
              ...
              MR_hl_field(MR_mktag(1), Langs_4, 1) = ((MR_Box) ((MR_Integer) 0));
            }
          }
          else
            Langs_4 = (MR_Word) ((MR_Integer) 0);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ItemInstance_4, 4) = ((MR_Box) ((MR_Integer) 0));
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (ShortIntFileKind_4) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              if ((MaybeCanonical_10 == (MR_Word) ((MR_Integer) 0)))
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                    AbstractDetails_16 = (MR_Word) ((MR_Integer) 8);
                  else
                  {
                    succeeded = parse_tree__prog_type__du_type_is_dummy_1_p_0(DetailsDu_8);
                    if (succeeded)
                      AbstractDetails_16 = (MR_Word) ((MR_Integer) 4);
                    else
                      AbstractDetails_16 = (MR_Word) ((MR_Integer) 0);
                  }
                }
                {
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((MaybeCanonical_42 == (MR_Word) ((MR_Integer) 0)))
            *MaybeAbstractItemTypeDefn_6 = ItemTypeDefn_5;
          else
          {
