...
MR_decl_label10(transform_hlds__dead_proc_elim__dead_pred_elim_analyze_2_0, 30,3,6,5,9,10,12,13,14,15)
MR_decl_label2(transform_hlds__dead_proc_elim__dead_pred_elim_analyze_2_0, 32,2)
...
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0, 2,3,7,10,8,13,16,15,18,14)
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0, 12,22,23,25,6,28,29,33,34,35)
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0, 5,40,41,44,45,47,48,49,50,71)
MR_decl_label2(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0, 52,37)
...
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_examine_5_0, 49,3,6,5,9,16,19,18,11,13)
MR_decl_label2(transform_hlds__dead_proc_elim__dead_proc_examine_5_0, 14,2)
MR_decl_label3(transform_hlds__dead_proc_elim__dead_proc_examine_cases_6_0, 10,3,4)
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0, 130,45,51,55,56,67,68,73,75,88)
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0, 48,49,18,20,21,24,27,23,93,3)
MR_decl_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0, 5,6,7,9,12,13,14,16,34,100)
MR_decl_label4(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0, 35,40,41,43)
...
MR_decl_label10(transform_hlds__dead_proc_elim__pre_modecheck_examine_goal_expr_3_0, 39,19,44,3,4,7,11,17,21,23)
MR_decl_label5(transform_hlds__dead_proc_elim__pre_modecheck_examine_goal_expr_3_0, 76,30,75,26,36)
MR_decl_label9(transform_hlds__dead_proc_elim__pre_modecheck_examine_unify_rhs_3_0, 3,7,6,9,10,12,14,11,4)
...
MR_decl_label10(__Compare___transform_hlds__dead_proc_elim__entity_0_0, 3,2,37,41,5,7,9,18,76,20)
MR_decl_label3(__Compare___transform_hlds__dead_proc_elim__entity_0_0, 21,23,123)
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module11)
	...
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0,130,45,51,55,56,67,68,73,75,88)
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0,48,49,18,20,21,24,27,23,93,3)
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0,5,6,7,9,12,13,14,16,34,100)
	MR_init_label4(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0,35,40,41,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__dead_proc_elim__dead_proc_examine_goal_6_0,73)
	...
	MR_tfield(2, MR_tempr1, 2) = MR_tfield(3, MR_tempr2, 3);
	MR_sv(5) = MR_r4;
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__dead_proc_elim, entity);
	MR_r1 = MR_sv(2);
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module13)
	...
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_examine_5_0,49,3,6,5,9,16,19,18,11,13)
	MR_init_label2(transform_hlds__dead_proc_elim__dead_proc_examine_5_0,14,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module17)
	...
	MR_init_label10(transform_hlds__dead_proc_elim__dead_pred_elim_analyze_2_0,30,3,6,5,9,10,12,13,14,15)
	MR_init_label2(transform_hlds__dead_proc_elim__dead_pred_elim_analyze_2_0,32,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module22)
	...
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0,2,3,7,10,8,13,16,15,18,14)
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0,12,22,23,25,6,28,29,33,34,35)
	MR_init_label10(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0,5,40,41,44,45,47,48,49,50,71)
	MR_init_label2(transform_hlds__dead_proc_elim__dead_proc_eliminate_pred_4_0,52,37)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module29)
	...
	MR_init_label10(transform_hlds__dead_proc_elim__pre_modecheck_examine_goal_expr_3_0,39,19,44,3,4,7,11,17,21,23)
	MR_init_label5(transform_hlds__dead_proc_elim__pre_modecheck_examine_goal_expr_3_0,76,30,75,26,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module30)
	...
	MR_init_label9(transform_hlds__dead_proc_elim__pre_modecheck_examine_unify_rhs_3_0,3,7,6,9,10,12,14,11,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module33)
	...
	MR_init_label10(__Compare___transform_hlds__dead_proc_elim__entity_0_0,3,2,37,41,5,7,9,18,76,20)
	MR_init_label3(__Compare___transform_hlds__dead_proc_elim__entity_0_0,21,23,123)
MR_BEGIN_CODE
