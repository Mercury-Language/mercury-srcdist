...
{
  {
    ...
    if (!((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded))
    {
      ...
      if (!((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded))
      {
        ...
        (env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Origin_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_21, (MR_Integer) 0)))) == (MR_Integer) 5)));
        if ((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded)
        {
...
{
  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 61, &VeryVerbose_18);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 61, &VeryVerbose_30);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Origin_25)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_25, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
