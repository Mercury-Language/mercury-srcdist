          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                TypeCtorInfo_82_91 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0);
                mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), TypeCtorInfo_82_91, ProcTable_70, ((MR_Box) (ProcId_67)), &conv1_ProcInfo_71);
