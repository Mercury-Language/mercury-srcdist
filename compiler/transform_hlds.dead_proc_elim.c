  ...
  MR_Word * STATE_VARIABLE_Specs_32)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_28, &Context_29);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) ((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__PredId_13));
      MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (ProcId_18));
    }
    ProcPieces_55 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_11, (MR_Integer) 1, Var_58);
    Var_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ProcPieces_55, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__dead_proc_elim_scalar_common_1[26])));
    Pieces_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__dead_proc_elim_scalar_common_1[23])), Var_63);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_30, 4) = ((MR_Box) (Pieces_56));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1444__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv16_LambdaHeadVar__3_58);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_73, (MR_Integer) 0))));
                  succeeded = ((((MR_tag((MR_Word) Var_85)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_85, (MR_Integer) 0)))) == (MR_Integer) 1)));
                  if (succeeded)
                  {
                    ModuleName_74 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_85, (MR_Integer) 1))));
                    MutableName_75 = ((MR_String) ((MR_hl_field(MR_mktag(3), Var_85, (MR_Integer) 2))));
                    PredKind_76 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_85, (MR_Integer) 3))) & (MR_Integer) 15);
                  }
                }
                if (succeeded)
                {
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (AnalyzeTypeCtor_22) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word TypeCtorGenInfos_91;
                    MR_Word Refs_92;

                    hlds__hlds_module__module_info_get_type_ctor_gen_infos_2_p_0(ModuleInfo_7, &TypeCtorGenInfos_91);
                    succeeded = transform_hlds__dead_proc_elim__find_type_ctor_info_5_p_0(Module_19, Type_20, Arity_21, TypeCtorGenInfos_91, &Refs_92);
                    if (succeeded)
                      transform_hlds__dead_proc_elim__dead_proc_examine_type_ctor_info_refs_5_p_0(Refs_92, STATE_VARIABLE_Queue_29_29, &STATE_VARIABLE_Queue_31_31, STATE_VARIABLE_Needed_0_27, &STATE_VARIABLE_Needed_32_32);
                    else
                    {
                      STATE_VARIABLE_Needed_32_32 = STATE_VARIABLE_Needed_0_27;
                      STATE_VARIABLE_Queue_31_31 = STATE_VARIABLE_Queue_29_29;
