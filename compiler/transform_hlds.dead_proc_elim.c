  ...
  MR_Word * STATE_VARIABLE_Changed_23)
{
  ...
  else
  {
    ...
    *STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 71, &VeryVerbose_18);
  ...
  MR_Word * STATE_VARIABLE_ProcElimInfo_33)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 71, &VeryVerbose_30);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  hlds__hlds_module__module_info_get_pred_id_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_8, &PredIdTable0_21);
  {
    ...
    MR_hl_field(MR_mktag(0), ProcElimInfo0_23, 2) = ((MR_Box) (PredIdTable0_21));
  ...
  PredIdTable_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcElimInfo_24, (MR_Integer) 2))));
  Changed_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcElimInfo_24, (MR_Integer) 3))) & (MR_Integer) 1);
  hlds__hlds_module__module_info_set_pred_id_table_3_p_0(PredIdTable_25, STATE_VARIABLE_ModuleInfo_25_34, &STATE_VARIABLE_ModuleInfo_26_35);
