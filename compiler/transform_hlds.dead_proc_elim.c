          ...
          case (MR_Integer) 0:
            {
              ...
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), AnalyzeLinks_9, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), AnalyzeLinks_9, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), AnalyzeLinks_9, (MR_Integer) 0)));
