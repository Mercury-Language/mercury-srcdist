...
{
  {
    ...
    Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__dead_proc_elim_scalar_common_1[20])), Var_19);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_10, 2) = ((MR_Box) ((MR_Unsigned) 80U));
...
{
  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 70, &VeryVerbose_18);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 70, &VeryVerbose_30);
