    ...
    if (transform_hlds__dead_proc_elim__succeeded)
    ...
    else
      {
        ...
        *transform_hlds__dead_proc_elim__STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(transform_hlds__dead_proc_elim__Globals_17, (MR_Integer) 53, &transform_hlds__dead_proc_elim__VeryVerbose_18);
        }
        ...
        if (transform_hlds__dead_proc_elim__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(transform_hlds__dead_proc_elim__Globals_29, (MR_Integer) 53, &transform_hlds__dead_proc_elim__VeryVerbose_30);
            }
