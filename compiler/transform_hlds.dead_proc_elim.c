...
static /* final */ const MR_Box transform_hlds__dead_proc_elim_scalar_common_6[4][8];
...
{
  {
    ...
    MR_Word transform_hlds__dead_proc_elim__V_17_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__dead_proc_elim__Goal_8, (MR_Integer) 1)));
