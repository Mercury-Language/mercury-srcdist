...
transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1485__1_2_p_0(
  MR_Word NeededPreds_39,
  MR_Word HeadVar__2_89);

static void MR_CALL 
transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1473__1_4_p_0(
  MR_Word SpecMap0_32,
...
static /* final */ const MR_Box transform_hlds__dead_proc_elim_scalar_common_3[8][1];
  ...
  MR_Word * STATE_VARIABLE_Specs_32)
{
  ...
  if (!((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded))
  {
    ...
    if (!((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded))
    {
      ...
      if ((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded)
      {
        Var_37 = ((MR_Word) ((MR_hl_field(1, Origin_21, 0))));
        (env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_37)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_37, 0)))) == (MR_Integer) 1)));
        if ((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__succeeded)
        {
          (env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__MutableModuleName_22 = ((MR_Word) ((MR_hl_field(3, Var_37, 1))));
          (env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__MutableName_23 = ((MR_String) ((MR_hl_field(3, Var_37, 2))));
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(3, Var_37, 3)));
          PredKind_24 = ((MR_Unsigned) ((MR_hl_field(3, Var_37, 3))) & (MR_Integer) 15);
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_28, &Context_29);
    {
      ...
      MR_hl_field(0, Var_60, 0) = ((MR_Box) ((env).transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0_env_0__PredId_13));
      MR_hl_field(0, Var_60, 1) = ((MR_Box) (ProcId_18));
    }
    ProcPieces_55 = hlds__hlds_error_util__describe_one_proc_name_4_f_0(ModuleInfo_11, (MR_Word) (MR_mkword(1, &transform_hlds__dead_proc_elim_scalar_common_3[7])), (MR_Integer) 1, Var_60);
    Var_67 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__dead_proc_elim_scalar_common_1[25])));
    Var_66 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_67, (MR_Word) (MR_mkword(1, &transform_hlds__dead_proc_elim_scalar_common_1[26])));
    Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ProcPieces_55, Var_66);
    Pieces_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &transform_hlds__dead_proc_elim_scalar_common_1[23])), Var_65);
    {
      Spec_30 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Spec_30, 0) = ((MR_Box) ((MR_String) "function \140transform_hlds.dead_proc_elim.warn_dead_proc\'/4"));
      ...
      MR_hl_field(0, Spec_30, 4) = ((MR_Box) (Pieces_56));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__dead_proc_elim__dead_proc_maybe_warn_proc_10_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) ((MR_hl_field(0, closure, 7)))), ((MR_Word) ((MR_hl_field(0, closure, 8)))), ((MR_Word) ((MR_hl_field(0, closure, 9)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Specs_32);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1485__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1473__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv16_LambdaHeadVar__3_58);
  ...
  MR_Word * Specs_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 242, &WarnWithLiveSiblings_13);
  {
