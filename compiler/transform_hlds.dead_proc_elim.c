...
{
  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 63, &VeryVerbose_18);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 63, &VeryVerbose_30);
