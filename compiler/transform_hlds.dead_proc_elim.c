...
MR_decl_label4(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0, 4,6,5,3)
...
MR_decl_label6(transform_hlds__dead_proc_elim__dead_proc_initialize_type_ctor_infos_5_0, 21,6,8,9,4,3)
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module4)
	...
	MR_init_label6(transform_hlds__dead_proc_elim__dead_proc_initialize_type_ctor_infos_5_0,21,6,8,9,4,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__dead_proc_elim__dead_proc_examine_expr_6_0,111)
	...
	MR_tfield(2, MR_tempr1, 2) = MR_ctfield(3, MR_r1, 3);
	MR_sv(2) = MR_r4;
	MR_sv(1) = MR_tempr1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__dead_proc_elim, entity);
	}
...
MR_BEGIN_MODULE(transform_hlds__dead_proc_elim_module17)
	...
	MR_init_label4(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0,4,6,5,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0,5)
	...
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__dead_proc_elim__dead_proc_eliminate_type_ctor_infos_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
