...
{
  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Changed_23 = (MR_Integer) 1;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 67, &VeryVerbose_18);
      switch (VeryVerbose_18) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          hlds__passes_aux__write_proc_progress_message_6_p_0((MR_String) "% Eliminated the dead procedure ", PredId_11, ProcId_12, ModuleInfo_16);
          break;
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 67, &VeryVerbose_30);
...
{
  {
    ...
    transform_hlds__dead_proc_elim__IntroducedFrom__pred__dead_pred_elim__1336__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv8_LambdaHeadVar__3_57);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 41, &WarnWithLiveSiblings_16);
    {
