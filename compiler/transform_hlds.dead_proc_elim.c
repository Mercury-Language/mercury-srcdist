              ...
              if (transform_hlds__dead_proc_elim__succeeded)
              ...
              else
                {
                  ...
                  if (transform_hlds__dead_proc_elim__succeeded)
                    ...
                    {
                      {
                        mercury__map__det_insert_4_p_0(transform_hlds__dead_proc_elim__TypeCtorInfo_239_239, (MR_Word) &transform_hlds__dead_proc_elim__transform_hlds__dead_proc_elim__type_ctor_info_maybe_needed_0, ((MR_Box) (transform_hlds__dead_proc_elim__Entity_37)), ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__dead_proc_elim_scalar_common_3[0]))), transform_hlds__dead_proc_elim__STATE_VARIABLE_Needed_0_99, transform_hlds__dead_proc_elim__STATE_VARIABLE_Needed_100);
                      }
                    }
                }
            }
