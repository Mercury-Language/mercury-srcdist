    ...
    else
    {
      ...
      if ((ProgPoint_Goals_38 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        LastRenaming_51 = ((MR_Word) (conv9_LastRenaming_51));
        {
          ...
          MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&transform_hlds__rbmm__region_resurrection_renaming_scalar_common_5[4]));
          MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) (transform_hlds__rbmm__region_resurrection_renaming__collect_renaming_and_annotation_exec_path_2_13_p_0_2));
          MR_hl_field(MR_mktag(0), Var_65, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), Var_65, 3) = ((MR_Box) (ProgPoint_36));
          MR_hl_field(MR_mktag(0), Var_65, 4) = ((MR_Box) (Graph_6));
          MR_hl_field(MR_mktag(0), Var_65, 5) = ((MR_Box) (LastRenaming_51));
        }
