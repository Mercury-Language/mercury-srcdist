...
{
  {
    ...
    succeeded = analysis__IntroducedFrom__pred__clear_imdg_entries_pointing_at_3__1178__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
