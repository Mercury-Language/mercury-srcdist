...
#undef MR_PROC_LABEL
  ...
  switch (Debug_6) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word TypeInfo_156_16;
        MR_Word TypeInfo_158_18;

        mercury__private_builtin__type_info_from_typeclass_info_3_p_0(Var_10, (MR_Integer) 4, &TypeInfo_156_16);
        mercury__private_builtin__type_info_from_typeclass_info_3_p_0(Var_10, (MR_Integer) 5, &TypeInfo_158_18);
        analysis__write_no_change_in_result_6_p_0(TypeInfo_156_16, TypeInfo_158_18, Var_11, Var_12, Var_13, Var_14);
      }
      break;
  }
}
...
#undef MR_PROC_LABEL
  ...
  switch (Debug_6) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word TypeInfo_175_16;

        mercury__private_builtin__type_info_from_typeclass_info_3_p_0(Var_10, (MR_Integer) 5, &TypeInfo_175_16);
        analysis__write_changed_answer_6_p_0(TypeInfo_175_16, Var_12, Var_11, Var_13, Var_14);
      }
      break;
  }
}
