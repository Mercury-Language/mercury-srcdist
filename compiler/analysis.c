...
static /* final */ const MR_Box analysis_scalar_common_1[5][2];
  ...
  MR_Word * Specs_12)
{
  ...
  *Specs_12 = ((MR_Word) (conv3_Specs_12));
  if ((*Specs_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    analysis__module_name_to_write_file_name_7_p_0(TypeClassInfo_for_compiler_122, Compiler_8, Globals_18, (MR_Word) (((MR_Box) ((MR_String) ".analysis_date"))), ThisModule_14, &TimestampFileName_25);
