...
MR_decl_label8(analysis__lookup_requests_5_0, 3,2,6,11,13,15,17,19)
MR_decl_label2(analysis__lookup_requests_5_0, 20,7)
...
MR_decl_label8(analysis__record_dependency_2_7_0, 22,20,26,28,27,34,35,36)
...
MR_decl_label6(analysis__record_request_2_7_0, 22,20,34,35,36,37)
...
MR_decl_label6(analysis__update_analysis_registry_5_9_0, 45,47,49,53,54,41)
MR_decl_label8(analysis__update_intermodule_dependencies_2_4_0, 5,6,7,9,12,8,13,14)
MR_decl_label1(analysis__update_intermodule_dependencies_2_4_0, 16)
...
MR_decl_label8(fn__analysis__init_analysis_info_3_0, 3,2,4,8,9,13,14,18)
MR_decl_label1(fn__analysis__init_analysis_info_3_0, 19)
...
MR_BEGIN_MODULE(analysis_module15)
	...
	MR_init_label8(fn__analysis__init_analysis_info_3_0,3,2,4,8,9,13,14,18)
	MR_init_label1(fn__analysis__init_analysis_info_3_0,19)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(analysis_module31)
	...
	MR_init_label6(analysis__record_request_2_7_0,22,20,34,35,36,37)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(analysis_module34)
	...
	MR_init_label8(analysis__record_dependency_2_7_0,22,20,26,28,27,34,35,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(analysis_module36)
	...
	MR_init_label8(analysis__lookup_requests_5_0,3,2,6,11,13,15,17,19)
	MR_init_label2(analysis__lookup_requests_5_0,20,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(analysis_module54)
	...
	MR_init_label6(analysis__update_analysis_registry_5_9_0,45,47,49,53,54,41)
MR_BEGIN_CODE
...
MR_def_label(analysis__update_analysis_registry_5_9_0,45)
	...
	MR_np_call_localret_ent(fn__map__elem_2_0,
		analysis__update_analysis_registry_5_9_0_i47);
MR_def_label(analysis__update_analysis_registry_5_9_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(analysis__update_analysis_registry_5_9_0_i41);
	}
...
MR_def_label(analysis__update_analysis_registry_5_9_0,49)
	...
	MR_np_call_localret_ent(fn__list__filter_map_2_0,
		analysis__update_analysis_registry_5_9_0_i53);
MR_def_label(analysis__update_analysis_registry_5_9_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(analysis_module62)
	...
	MR_init_label8(analysis__update_intermodule_dependencies_2_4_0,5,6,7,9,12,8,13,14)
	MR_init_label1(analysis__update_intermodule_dependencies_2_4_0,16)
MR_BEGIN_CODE
