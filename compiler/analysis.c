...
{
  {
    ...
    analysis__module_name_to_write_file_name_7_p_0(TypeClassInfo_for_compiler_115, Compiler_8, Globals_17, ThisModule_13, (MR_Word) (((MR_Box) ((MR_String) ".analysis_date"))), &TimestampFileName_20);
