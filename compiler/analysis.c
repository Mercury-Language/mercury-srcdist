...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_9, &Globals_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&analysis_scalar_common_10[0]));
      ...
      }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&analysis_scalar_common_8[1]));
    ...
    analysis__file__write_module_analysis_results_6_p_0(*STATE_VARIABLE_Info_24, Globals_17, ThisModule_13, ModuleResults_19);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&analysis_scalar_common_8[1]));
    ...
    analysis__file__empty_request_file_5_p_0(*STATE_VARIABLE_Info_24, Globals_17, ThisModule_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&analysis_scalar_common_8[1]));
