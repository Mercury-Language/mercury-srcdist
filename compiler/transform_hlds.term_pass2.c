...

  {
    ...
    else
    {
      ...
      if ((InfCalls_34 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        mercury__map__keys_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass2_scalar_common_2[1]), CallWeights_35, &PPIds_56);
        transform_hlds__term_pass2__zero_or_positive_weight_cycles_2_4_p_0(ModuleInfo_6, CallWeights_35, PPIds_56, &Cycles_42);
    ...
    if (((MR_tag((MR_Word) Termination0_13)) == (MR_Integer) 1))
    {
      ...
      if ((env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
      {
        ...
        {
          MR_Word FirstPPId_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SCCProcs_11, (MR_Integer) 0))));
          MR_Word LaterPPIds_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SCCProcs_11, (MR_Integer) 1))));
          MR_Integer FirstArity_65;
          MR_Word TrialPPId_66;
          MR_Word RestSCC_67;
          MR_Word ProcInfo_75;
          MR_Word HeadVars_76;
          MR_Word Var_74;

          hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_6, FirstPPId_63, &Var_74, &ProcInfo_75);
          hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_75, &HeadVars_76);
          mercury__list__length_2_p_0((MR_Word) (&transform_hlds__term_pass2_scalar_common_1[1]), HeadVars_76, &FirstArity_65);
          transform_hlds__term_pass2__find_min_arity_proc_6_p_0(ModuleInfo_6, LaterPPIds_64, FirstPPId_63, FirstArity_65, &TrialPPId_66, &RestSCC_67);
          transform_hlds__term_pass2__prove_termination_in_scc_single_arg_2_6_p_0(ModuleInfo_6, PassInfo_7, TrialPPId_66, RestSCC_67, (MR_Integer) 1, &SingleArgTerminates_18);
        }
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if ((InfCalls_42 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          mercury__map__keys_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass2_scalar_common_2[1]), CallWeights_43, &PPIds_64);
          transform_hlds__term_pass2__zero_or_positive_weight_cycles_2_4_p_0(ModuleInfo_7, CallWeights_43, PPIds_64, &Cycles_50);
          ...
          if (succeeded)
          {
            ...
            ArgNum1_67 = (MR_Integer) ((MR_Unsigned) ArgNum0_11 + (MR_Unsigned) 1);
            // direct tailcall eliminated
            ;
            next_value_of_ArgNum0_11 = ArgNum1_67;
            ArgNum0_11 = next_value_of_ArgNum0_11;
            continue;
          }
          else
        ...
        else
        {
          ...
          ArgNum1_75 = (MR_Integer) ((MR_Unsigned) ArgNum0_11 + (MR_Unsigned) 1);
          // direct tailcall eliminated
          ;
          next_value_of_ArgNum0_11 = ArgNum1_75;
          ArgNum0_11 = next_value_of_ArgNum0_11;
          continue;
        }
      }
