  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Error_16, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Info_37)) == (MR_Integer) 1))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (transform_hlds__term_pass2__prove_termination_in_scc_pass_8_p_0_1));
          MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Var_55, 4) = ((MR_Box) (CanLoop_59));
        }
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (transform_hlds__term_pass2__prove_termination_in_scc_pass_8_p_0_2));
          MR_hl_field(MR_mktag(0), Var_51, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) (CanLoop_39));
  ...
  MR_Word * STATE_VARIABLE_CallInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallSite_14, (MR_Integer) 0))));

        CallPPId_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_37, (MR_Integer) 0))));
        Context_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_37, (MR_Integer) 1))));
      }
