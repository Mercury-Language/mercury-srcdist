...

    {
      ...
      else
      {
        ...
        if ((InfCalls_34 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          (env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded = ((MR_tag((MR_Word) Cycles_42)) == (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if ((InfCalls_42 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          succeeded = ((MR_tag((MR_Word) Cycles_50)) == (MR_Integer) 1);
          if (succeeded)
          {
            {
