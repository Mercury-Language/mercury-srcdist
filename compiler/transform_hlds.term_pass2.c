...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded = ((env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Var_21 == (MR_Word) ((MR_Integer) 4));
...
{
  {
...

    {
      ...
      else
      {
        ...
        if ((InfCalls_34 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Cycles_42;
          MR_Word PPIds_58;
          MR_Word Var_43;
      ...
      if (((MR_tag((MR_Word) Termination0_13)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if ((env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
        {
          ...
          if ((SCCProcs_11 == (MR_Word) ((MR_Integer) 0)))
          {
            {
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if ((InfCalls_42 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Cycles_50;
          MR_Word PPIds_66;
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    transform_hlds__term_pass2__zero_or_positive_weight_cycles_from_neighbours_7_p_0(NeighboursList_20, PPId_9, Context_24, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), CallWeights_2, &Cycles1_12);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Cycles1_21, 1) = ((MR_Box) ((MR_Integer) 0));
          }
        }
        else
          Cycles1_21 = (MR_Word) ((MR_Integer) 0);
      }
      else
      {
  ...
  MR_Word * Result_12)
{
  while (MR_TRUE)
  {
    ...
    mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass2_scalar_common_2[1]), &CallWeightGraph0_14);
    {
      ...
      MR_hl_field(MR_mktag(0), CallInfo0_15, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__init_1_p_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), &PathSet0_35);
      {
        ...
        MR_hl_field(MR_mktag(0), Info0_36, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      ...
      if (((MR_tag((MR_Word) Info_37)) == (MR_mktag((MR_Integer) 1))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * STATE_VARIABLE_CallInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((CallSite_14 == (MR_Word) ((MR_Integer) 0)))
      {
        {
      ...
      if (!((GammaVars_16 == (MR_Word) ((MR_Integer) 0))))
      {
        {
