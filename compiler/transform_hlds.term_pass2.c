...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_pass2_scalar_common_2[4]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__term_pass2_scalar_common_2[4]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_pass2_scalar_common_2[4]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) (&transform_hlds__term_pass2_scalar_common_2[4]);
