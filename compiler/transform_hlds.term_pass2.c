            ...
            if (((MR_tag((MR_Word) transform_hlds__term_pass2__Info_37)) == (MR_mktag((MR_Integer) 1))))
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 0) = ((MR_Box) (&transform_hlds__term_pass2_scalar_common_5[2]));
            ...
            else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 0) = ((MR_Box) (&transform_hlds__term_pass2_scalar_common_5[2]));
          ...
          if ((transform_hlds__term_pass2__InfCalls_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              ...
              if ((transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
              ...
              else
                {
                  ...
                  transform_hlds__term_pass2__Termination0_13 = (MR_Word) &transform_hlds__term_pass2_scalar_common_3[0];
                }
            }
          else
            {
