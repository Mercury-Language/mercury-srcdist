...
MR_decl_label8(transform_hlds__term_pass2__add_call_arcs_4_0, 62,6,5,4,9,10,8,13)
MR_decl_label8(transform_hlds__term_pass2__add_call_arcs_4_0, 16,19,21,18,24,15,27,28)
MR_decl_label3(transform_hlds__term_pass2__add_call_arcs_4_0, 29,12,3)
...
MR_decl_label8(transform_hlds__term_pass2__prove_termination_in_scc_8_0, 2,3,6,11,12,15,10,5)
MR_decl_label8(transform_hlds__term_pass2__prove_termination_in_scc_8_0, 4,43,19,21,26,25,29,31)
...
MR_decl_label5(transform_hlds__term_pass2__prove_termination_in_scc_single_arg_7_0, 18,5,6,7,8)
...
MR_BEGIN_MODULE(transform_hlds__term_pass2_module6)
	...
	MR_init_label8(transform_hlds__term_pass2__add_call_arcs_4_0,62,6,5,4,9,10,8,13)
	MR_init_label8(transform_hlds__term_pass2__add_call_arcs_4_0,16,19,21,18,24,15,27,28)
	MR_init_label3(transform_hlds__term_pass2__add_call_arcs_4_0,29,12,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_pass2_module14)
	...
	MR_init_label5(transform_hlds__term_pass2__prove_termination_in_scc_single_arg_7_0,18,5,6,7,8)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_pass2__prove_termination_in_scc_single_arg_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_single_arg_7_0_i18);
	}
	MR_r1 = (MR_Word) MR_string_const("term_pass2.m", 12);
	MR_r2 = (MR_Word) MR_string_const("prove_termination_in_scc_single_arg/3: empty SCC.", 49);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_single_arg_7_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__term_pass2_module15)
	...
	MR_init_label8(transform_hlds__term_pass2__prove_termination_in_scc_8_0,2,3,6,11,12,15,10,5)
	MR_init_label8(transform_hlds__term_pass2__prove_termination_in_scc_8_0,4,43,19,21,26,25,29,31)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i10);
	}
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_errors, termination_error_context);
	MR_r2 = MR_ctfield(0, MR_sv(2), 1);
...
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,4)
	...
	if (MR_PTAG_TESTR(MR_sv(4),0)) {
		MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i19);
	}
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(6);
...
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,21)
	...
	if (((MR_Integer) MR_r1 > (MR_Integer) MR_sv(3))) {
		MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i43);
	}
	MR_sv(7) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(8) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_save_maxfr(MR_sv(9));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i25);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_errors, termination_error_context);
	MR_r2 = MR_sv(5);
...
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,26)
	...
	MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i43);
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(7);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(8);
	MR_r1 = MR_sv(1);
...
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,29)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__term_pass2__prove_termination_in_scc_8_0_i31);
	}
	MR_r1 = MR_sv(4);
	MR_decr_sp_and_return(10);
MR_def_label(transform_hlds__term_pass2__prove_termination_in_scc_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,5,0);
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
