  ...
  MR_Word * STATE_VARIABLE_RecSupplierMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__det_insert_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass2_scalar_common_1[0]), ((MR_Box) (PPId_10)), ((MR_Box) (BoolList_16)), STATE_VARIABLE_RecSupplierMap_0_3, &STATE_VARIABLE_RecSupplierMap_1_20);
      // direct tailcall eliminated
      ;
