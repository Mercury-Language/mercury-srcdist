...
{
  {
    ...
    {
      MR_Word transform_hlds__term_pass2__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));

      if (((MR_tag((MR_Word) transform_hlds__term_pass2__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word transform_hlds__term_pass2__ArgY1_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__3_3, (MR_Integer) 0)));

        mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[2], transform_hlds__term_pass2__HeadVar__1_1, ((MR_Box) (transform_hlds__term_pass2__Var_22)), ((MR_Box) (transform_hlds__term_pass2__ArgY1_16)));
      }
      else
    ...
    {
      MR_Word transform_hlds__term_pass2__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));

      if (((MR_tag((MR_Word) transform_hlds__term_pass2__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
        *transform_hlds__term_pass2__HeadVar__1_1 = (MR_Integer) 1;
      else
      {
        MR_Word transform_hlds__term_pass2__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word transform_hlds__term_pass2__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word transform_hlds__term_pass2__Var_8;

        transform_hlds__term_pass2____Compare____call_weight_info_0_0(&transform_hlds__term_pass2__Var_8, transform_hlds__term_pass2__Var_24, transform_hlds__term_pass2__ArgY1_5);
        transform_hlds__term_pass2__succeeded = (transform_hlds__term_pass2__Var_8 == (MR_Integer) 0);
        transform_hlds__term_pass2__succeeded = !(transform_hlds__term_pass2__succeeded);
        if (transform_hlds__term_pass2__succeeded)
          *transform_hlds__term_pass2__HeadVar__1_1 = transform_hlds__term_pass2__Var_8;
        else
        {
          mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_2[4], transform_hlds__term_pass2__HeadVar__1_1, ((MR_Box) (transform_hlds__term_pass2__Var_23)), ((MR_Box) (transform_hlds__term_pass2__ArgY2_7)));
        }
      }
    }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) transform_hlds__term_pass2__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_Word transform_hlds__term_pass2__ArgX1_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgY1_8;

      transform_hlds__term_pass2__succeeded = ((MR_tag((MR_Word) transform_hlds__term_pass2__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (transform_hlds__term_pass2__succeeded)
      {
        transform_hlds__term_pass2__ArgY1_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));
        transform_hlds__term_pass2__TypeInfo_11_11 = (MR_Word) &transform_hlds__term_pass2_scalar_common_1[2];
        transform_hlds__term_pass2__succeeded = mercury__builtin__unify_2_p_0(transform_hlds__term_pass2__TypeInfo_11_11, ((MR_Box) (transform_hlds__term_pass2__ArgX1_7)), ((MR_Box) (transform_hlds__term_pass2__ArgY1_8)));
      }
    }
    else
    {
      MR_Word transform_hlds__term_pass2__TypeInfo_12_12;
      MR_Word transform_hlds__term_pass2__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgY1_4;
      MR_Word transform_hlds__term_pass2__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__ArgY2_6;

      transform_hlds__term_pass2__succeeded = ((MR_tag((MR_Word) transform_hlds__term_pass2__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
      if (transform_hlds__term_pass2__succeeded)
      {
        transform_hlds__term_pass2__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));
        transform_hlds__term_pass2__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 1)));
        transform_hlds__term_pass2__succeeded = transform_hlds__term_pass2____Unify____call_weight_info_0_0(transform_hlds__term_pass2__ArgX1_3, transform_hlds__term_pass2__ArgY1_4);
        if (transform_hlds__term_pass2__succeeded)
        {
          transform_hlds__term_pass2__TypeInfo_12_12 = (MR_Word) &transform_hlds__term_pass2_scalar_common_2[4];
          transform_hlds__term_pass2__succeeded = mercury__builtin__unify_2_p_0(transform_hlds__term_pass2__TypeInfo_12_12, ((MR_Box) (transform_hlds__term_pass2__ArgX2_5)), ((MR_Box) (transform_hlds__term_pass2__ArgY2_6)));
        }
      }
    }
    return transform_hlds__term_pass2__succeeded;
...
{
  {
    ...
    {
      MR_Word transform_hlds__term_pass2__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__Var_8;

      mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[2], &transform_hlds__term_pass2__Var_8, ((MR_Box) (transform_hlds__term_pass2__ArgX1_4)), ((MR_Box) (transform_hlds__term_pass2__ArgY1_5)));
      transform_hlds__term_pass2__succeeded = (transform_hlds__term_pass2__Var_8 == (MR_Integer) 0);
      transform_hlds__term_pass2__succeeded = !(transform_hlds__term_pass2__succeeded);
      if (transform_hlds__term_pass2__succeeded)
        *transform_hlds__term_pass2__HeadVar__1_1 = transform_hlds__term_pass2__Var_8;
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_2[3], transform_hlds__term_pass2__HeadVar__1_1, ((MR_Box) (transform_hlds__term_pass2__ArgX2_6)), ((MR_Box) (transform_hlds__term_pass2__ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word transform_hlds__term_pass2__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__HeadVar__2_2, (MR_Integer) 1)));

      transform_hlds__term_pass2__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[2], ((MR_Box) (transform_hlds__term_pass2__ArgX1_3)), ((MR_Box) (transform_hlds__term_pass2__ArgY1_4)));
      if (transform_hlds__term_pass2__succeeded)
      {
        transform_hlds__term_pass2__TypeInfo_10_10 = (MR_Word) &transform_hlds__term_pass2_scalar_common_2[3];
        transform_hlds__term_pass2__succeeded = mercury__builtin__unify_2_p_0(transform_hlds__term_pass2__TypeInfo_10_10, ((MR_Box) (transform_hlds__term_pass2__ArgX2_5)), ((MR_Box) (transform_hlds__term_pass2__ArgY2_6)));
      }
    }
    return transform_hlds__term_pass2__succeeded;
  }
...
{
  {
    ...
    (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Error_16 = ((MR_Word) (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__conv0_Error_16);
...
{
  {
    ...
    {
      MR_Word transform_hlds__term_pass2__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Error_16, (MR_Integer) 0)));

      (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Error_16, (MR_Integer) 1)));
      (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded = ((transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Var_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
...
{
  {
    ...
    if (MR_builtin_setjmp((transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__commit_0) == 0)
      {
        {
          mercury__list__member_2_p_1((MR_Word) &transform_hlds__term_errors__transform_hlds__term_errors__type_ctor_info_term_error_0, &(transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__conv0_Error_16, (transform_hlds__term_pass2__env_ptr)->transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Errors_14, transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_3, transform_hlds__term_pass2__env_ptr);
        }
...
{
  {
    ...
    {
      MR_Word transform_hlds__term_pass2__TypeCtorInfo_23_23 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
      MR_Word transform_hlds__term_pass2__SCCProcs_11;
      MR_Word transform_hlds__term_pass2__InitRecSuppliers_12;
      MR_Word transform_hlds__term_pass2__Termination0_13;
      MR_Word transform_hlds__term_pass2__Result_31;

      mercury__set__to_sorted_list_2_p_0(transform_hlds__term_pass2__TypeCtorInfo_23_23, transform_hlds__term_pass2__SCC_8, &transform_hlds__term_pass2__SCCProcs_11);
      transform_hlds__term_pass2__init_rec_input_suppliers_3_p_0(transform_hlds__term_pass2__SCCProcs_11, transform_hlds__term_pass2__ModuleInfo_6, &transform_hlds__term_pass2__InitRecSuppliers_12);
      transform_hlds__term_pass2__prove_termination_in_scc_fixpoint_6_p_0(transform_hlds__term_pass2__ModuleInfo_6, transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 1, transform_hlds__term_pass2__SCCProcs_11, transform_hlds__term_pass2__InitRecSuppliers_12, &transform_hlds__term_pass2__Result_31);
      if (((MR_tag((MR_Word) transform_hlds__term_pass2__Result_31)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word transform_hlds__term_pass2__Errors_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Result_31, (MR_Integer) 0)));

        {
          transform_hlds__term_pass2__Termination0_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Termination0_13, 0) = ((MR_Box) (transform_hlds__term_pass2__Errors_48));
        }
      }
      else
      {
        MR_Word transform_hlds__term_pass2__CallInfo_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Result_31, (MR_Integer) 0)));
        MR_Word transform_hlds__term_pass2__InfCalls_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__CallInfo_32, (MR_Integer) 0)));
        MR_Word transform_hlds__term_pass2__CallWeights_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__CallInfo_32, (MR_Integer) 1)));
        MR_Word transform_hlds__term_pass2__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Result_31, (MR_Integer) 1)));

        if ((transform_hlds__term_pass2__InfCalls_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word transform_hlds__term_pass2__Cycles_42;
          MR_Word transform_hlds__term_pass2__PPIds_58;
          MR_Word transform_hlds__term_pass2__Var_43;
          MR_Word transform_hlds__term_pass2__Var_44;

          mercury__map__keys_2_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, (MR_Word) &transform_hlds__term_pass2_scalar_common_2[1], transform_hlds__term_pass2__CallWeights_35, &transform_hlds__term_pass2__PPIds_58);
          transform_hlds__term_pass2__zero_or_positive_weight_cycles_2_4_p_0(transform_hlds__term_pass2__ModuleInfo_6, transform_hlds__term_pass2__CallWeights_35, transform_hlds__term_pass2__PPIds_58, &transform_hlds__term_pass2__Cycles_42);
          (transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded = ((MR_tag((MR_Word) transform_hlds__term_pass2__Cycles_42)) == (MR_mktag((MR_Integer) 1)));
          if ((transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
          {
            transform_hlds__term_pass2__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles_42, (MR_Integer) 0)));
            transform_hlds__term_pass2__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles_42, (MR_Integer) 1)));
            {
              MR_Word transform_hlds__term_pass2__ReportedCycles_47;
              MR_Integer transform_hlds__term_pass2__MaxErrors_50 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 1)));
              MR_Word transform_hlds__term_pass2__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 0)));
              MR_Integer transform_hlds__term_pass2__Var_46 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 2)));

              mercury__list__take_upto_3_p_0((MR_Word) &transform_hlds__term_errors__transform_hlds__term_errors__type_ctor_info_term_error_0, transform_hlds__term_pass2__MaxErrors_50, transform_hlds__term_pass2__Cycles_42, &transform_hlds__term_pass2__ReportedCycles_47);
              {
                transform_hlds__term_pass2__Termination0_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Termination0_13, 0) = ((MR_Box) (transform_hlds__term_pass2__ReportedCycles_47));
              }
            }
          }
          else
          {
            ...
            transform_hlds__term_pass2__Termination0_13 = (MR_Word) &transform_hlds__term_pass2_scalar_common_5[0];
          }
        }
        else
        {
          MR_Integer transform_hlds__term_pass2__MaxErrors_39 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 1)));
          MR_Word transform_hlds__term_pass2__ReportedInfCalls_41;
          MR_Word transform_hlds__term_pass2__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 0)));
          MR_Integer transform_hlds__term_pass2__Var_40 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_7, (MR_Integer) 2)));

          mercury__list__take_upto_3_p_0((MR_Word) &transform_hlds__term_errors__transform_hlds__term_errors__type_ctor_info_term_error_0, transform_hlds__term_pass2__MaxErrors_39, transform_hlds__term_pass2__InfCalls_34, &transform_hlds__term_pass2__ReportedInfCalls_41);
          {
            transform_hlds__term_pass2__Termination0_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Termination0_13, 0) = ((MR_Box) (transform_hlds__term_pass2__ReportedInfCalls_41));
          }
        }
      }
      if (((MR_tag((MR_Word) transform_hlds__term_pass2__Termination0_13)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Integer transform_hlds__term_pass2__ProcCount_15;

        (transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__Errors_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Termination0_13, (MR_Integer) 0)));
        mercury__list__length_2_p_0(transform_hlds__term_pass2__TypeCtorInfo_23_23, transform_hlds__term_pass2__SCCProcs_11, &transform_hlds__term_pass2__ProcCount_15);
        (transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded = (transform_hlds__term_pass2__ProcCount_15 <= transform_hlds__term_pass2__SingleArgs_9);
        if ((transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
        {
        ...
        if ((transform_hlds__term_pass2__env).transform_hlds__term_pass2__prove_termination_in_scc_5_p_0_env_0__succeeded)
        {
          MR_Word transform_hlds__term_pass2__SingleArgTerminates_18;

          if ((transform_hlds__term_pass2__SCCProcs_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            {
          ...
          {
            MR_Word transform_hlds__term_pass2__FirstPPId_65 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__SCCProcs_11, (MR_Integer) 0)));
            MR_Word transform_hlds__term_pass2__LaterPPIds_66 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__SCCProcs_11, (MR_Integer) 1)));
            MR_Integer transform_hlds__term_pass2__FirstArity_67;
            MR_Word transform_hlds__term_pass2__TrialPPId_68;
            MR_Word transform_hlds__term_pass2__RestSCC_69;
            MR_Word transform_hlds__term_pass2__ProcInfo_78;
            MR_Word transform_hlds__term_pass2__HeadVars_79;
            MR_Word transform_hlds__term_pass2__Var_77;

            hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_pass2__ModuleInfo_6, transform_hlds__term_pass2__FirstPPId_65, &transform_hlds__term_pass2__Var_77, &transform_hlds__term_pass2__ProcInfo_78);
            hlds__hlds_pred__proc_info_get_headvars_2_p_0(transform_hlds__term_pass2__ProcInfo_78, &transform_hlds__term_pass2__HeadVars_79);
            mercury__list__length_2_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[1], transform_hlds__term_pass2__HeadVars_79, &transform_hlds__term_pass2__FirstArity_67);
            transform_hlds__term_pass2__find_min_arity_proc_6_p_0(transform_hlds__term_pass2__ModuleInfo_6, transform_hlds__term_pass2__LaterPPIds_66, transform_hlds__term_pass2__FirstPPId_65, transform_hlds__term_pass2__FirstArity_67, &transform_hlds__term_pass2__TrialPPId_68, &transform_hlds__term_pass2__RestSCC_69);
            transform_hlds__term_pass2__prove_termination_in_scc_single_arg_2_6_p_0(transform_hlds__term_pass2__ModuleInfo_6, transform_hlds__term_pass2__PassInfo_7, transform_hlds__term_pass2__TrialPPId_68, transform_hlds__term_pass2__RestSCC_69, (MR_Integer) 1, &transform_hlds__term_pass2__SingleArgTerminates_18);
          }
          switch (transform_hlds__term_pass2__SingleArgTerminates_18) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              *transform_hlds__term_pass2__Termination_10 = transform_hlds__term_pass2__Termination0_13;
              break;
            case (MR_Integer) 1:
              {
                mercury__private_builtin__dummy_var = (MR_Integer) 0;
                *transform_hlds__term_pass2__Termination_10 = (MR_Word) &transform_hlds__term_pass2_scalar_common_5[0];
              }
              break;
          }
        }
  ...
  MR_Word * transform_hlds__term_pass2__Terminates_12)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      MR_Word transform_hlds__term_pass2__Var_26;

      hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_pass2__ModuleInfo_7, transform_hlds__term_pass2__TrialPPId_9, &transform_hlds__term_pass2__Var_26, &transform_hlds__term_pass2__ProcInfo_27);
      ...
      if (transform_hlds__term_pass2__succeeded)
      {
        MR_Word transform_hlds__term_pass2__Var_18;
        MR_Word transform_hlds__term_pass2__Result_39;

        {
          transform_hlds__term_pass2__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Var_18, 0) = ((MR_Box) (transform_hlds__term_pass2__TrialPPId_9));
          MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Var_18, 1) = ((MR_Box) (transform_hlds__term_pass2__RestSCC_10));
        }
        transform_hlds__term_pass2__prove_termination_in_scc_fixpoint_6_p_0(transform_hlds__term_pass2__ModuleInfo_7, transform_hlds__term_pass2__PassInfo_8, (MR_Integer) 0, transform_hlds__term_pass2__Var_18, transform_hlds__term_pass2__InitRecSuppliers_13, &transform_hlds__term_pass2__Result_39);
        if (((MR_tag((MR_Word) transform_hlds__term_pass2__Result_39)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          {
            MR_Integer transform_hlds__term_pass2__next_value_of_ArgNum0_11 = transform_hlds__term_pass2__ArgNum1_16;

            transform_hlds__term_pass2__ArgNum0_11 = transform_hlds__term_pass2__next_value_of_ArgNum0_11;
          }
          continue;
        }
        else
        {
          ...
          MR_Word transform_hlds__term_pass2__Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Result_39, (MR_Integer) 1)));
          ...
          if ((transform_hlds__term_pass2__InfCalls_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            MR_Word transform_hlds__term_pass2__Var_51;
            MR_Word transform_hlds__term_pass2__Var_52;
            ...
            if (transform_hlds__term_pass2__succeeded)
            {
              transform_hlds__term_pass2__Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles_50, (MR_Integer) 0)));
              transform_hlds__term_pass2__Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles_50, (MR_Integer) 1)));
              {
                ...
                MR_Word transform_hlds__term_pass2__Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_8, (MR_Integer) 0)));
                MR_Integer transform_hlds__term_pass2__Var_54 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_8, (MR_Integer) 2)));
                ...
                /* direct tailcall eliminated */
                {
                  MR_Integer transform_hlds__term_pass2__next_value_of_ArgNum0_11 = transform_hlds__term_pass2__ArgNum1_69;
          ...
          else
          {
            ...
            MR_Word transform_hlds__term_pass2__Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_8, (MR_Integer) 0)));
            MR_Integer transform_hlds__term_pass2__Var_48 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__PassInfo_8, (MR_Integer) 2)));
            ...
            /* direct tailcall eliminated */
            {
              MR_Integer transform_hlds__term_pass2__next_value_of_ArgNum0_11 = transform_hlds__term_pass2__ArgNum1_77;
...
{
  {
    ...
    else
    {
      ...
      MR_Word transform_hlds__term_pass2__CurPPId_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Neighbour_13, (MR_Integer) 0)));
      MR_Word transform_hlds__term_pass2__Context_31;
      MR_Integer transform_hlds__term_pass2__EdgeWeight_32;
      MR_Integer transform_hlds__term_pass2__WeightSoFar1_33;
      MR_Word transform_hlds__term_pass2__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Neighbour_13, (MR_Integer) 1)));

      transform_hlds__term_pass2__Context_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_42, (MR_Integer) 0)));
      transform_hlds__term_pass2__EdgeWeight_32 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_42, (MR_Integer) 1)));
      transform_hlds__term_pass2__WeightSoFar1_33 = (transform_hlds__term_pass2__WeightSoFar_4 + transform_hlds__term_pass2__EdgeWeight_32);
      transform_hlds__term_pass2__succeeded = hlds__hlds_pred____Unify____pred_proc_id_0_0(transform_hlds__term_pass2__CurPPId_30, transform_hlds__term_pass2__LookforPPId_2);
      if (transform_hlds__term_pass2__succeeded)
      {
        transform_hlds__term_pass2__succeeded = (transform_hlds__term_pass2__WeightSoFar1_33 >= (MR_Integer) 0);
        if (transform_hlds__term_pass2__succeeded)
        {
          MR_Word transform_hlds__term_pass2__FinalVisitedCalls_34;
          MR_Word transform_hlds__term_pass2__RevFinalVisitedCalls_35;
          MR_Word transform_hlds__term_pass2__CycleError_36;
          MR_Word transform_hlds__term_pass2__CycleErrorContext_37;
          MR_Word transform_hlds__term_pass2__Var_44;

          {
            transform_hlds__term_pass2__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_44, 0) = ((MR_Box) (transform_hlds__term_pass2__CurPPId_30));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_44, 1) = ((MR_Box) (transform_hlds__term_pass2__Context_31));
          }
          {
            transform_hlds__term_pass2__FinalVisitedCalls_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__FinalVisitedCalls_34, 0) = ((MR_Box) (transform_hlds__term_pass2__Var_44));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__FinalVisitedCalls_34, 1) = ((MR_Box) (transform_hlds__term_pass2__VisitedCalls_5));
          }
          mercury__list__reverse_2_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_2[2], transform_hlds__term_pass2__FinalVisitedCalls_34, &transform_hlds__term_pass2__RevFinalVisitedCalls_35);
          {
            transform_hlds__term_pass2__CycleError_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__CycleError_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__CycleError_36, 1) = ((MR_Box) (transform_hlds__term_pass2__LookforPPId_2));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__CycleError_36, 2) = ((MR_Box) (transform_hlds__term_pass2__RevFinalVisitedCalls_35));
          }
          {
            transform_hlds__term_pass2__CycleErrorContext_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__CycleErrorContext_37, 0) = ((MR_Box) (transform_hlds__term_pass2__Context_3));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__CycleErrorContext_37, 1) = ((MR_Box) (transform_hlds__term_pass2__CycleError_36));
          }
          {
            transform_hlds__term_pass2__Cycles1_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles1_21, 0) = ((MR_Box) (transform_hlds__term_pass2__CycleErrorContext_37));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__Cycles1_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
        }
        else
          transform_hlds__term_pass2__Cycles1_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      }
      else
      {
        MR_Word transform_hlds__term_pass2__TypeCtorInfo_32_48 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
        MR_Word transform_hlds__term_pass2__VisitedPPIds_38;

        mercury__assoc_list__keys_2_p_0(transform_hlds__term_pass2__TypeCtorInfo_32_48, (MR_Word) &mercury__term__term__type_ctor_info_context_0, transform_hlds__term_pass2__VisitedCalls_5, &transform_hlds__term_pass2__VisitedPPIds_38);
        transform_hlds__term_pass2__succeeded = mercury__list__member_2_p_0(transform_hlds__term_pass2__TypeCtorInfo_32_48, ((MR_Box) (transform_hlds__term_pass2__CurPPId_30)), transform_hlds__term_pass2__VisitedPPIds_38);
        if (transform_hlds__term_pass2__succeeded)
          transform_hlds__term_pass2__Cycles1_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        else
        {
          MR_Word transform_hlds__term_pass2__TypeCtorInfo_34_50;
          MR_Word transform_hlds__term_pass2__NewVisitedCalls_39;
          MR_Word transform_hlds__term_pass2__NeighboursMap_40;
          MR_Word transform_hlds__term_pass2__NeighboursList_41;
          MR_Word transform_hlds__term_pass2__Var_46;
          MR_Box transform_hlds__term_pass2__conv0_NeighboursMap_40;

          {
            transform_hlds__term_pass2__Var_46 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_46, 0) = ((MR_Box) (transform_hlds__term_pass2__CurPPId_30));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_46, 1) = ((MR_Box) (transform_hlds__term_pass2__Context_31));
          }
          {
            transform_hlds__term_pass2__NewVisitedCalls_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__NewVisitedCalls_39, 0) = ((MR_Box) (transform_hlds__term_pass2__Var_46));
            MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__NewVisitedCalls_39, 1) = ((MR_Box) (transform_hlds__term_pass2__VisitedCalls_5));
          }
          transform_hlds__term_pass2__TypeCtorInfo_34_50 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
          mercury__map__lookup_3_p_0(transform_hlds__term_pass2__TypeCtorInfo_34_50, (MR_Word) &transform_hlds__term_pass2_scalar_common_2[1], transform_hlds__term_pass2__CallWeights_6, ((MR_Box) (transform_hlds__term_pass2__CurPPId_30)), &transform_hlds__term_pass2__conv0_NeighboursMap_40);
          transform_hlds__term_pass2__NeighboursMap_40 = ((MR_Word) transform_hlds__term_pass2__conv0_NeighboursMap_40);
          mercury__map__to_assoc_list_2_p_0(transform_hlds__term_pass2__TypeCtorInfo_34_50, (MR_Word) &transform_hlds__term_pass2_scalar_common_2[0], transform_hlds__term_pass2__NeighboursMap_40, &transform_hlds__term_pass2__NeighboursList_41);
          transform_hlds__term_pass2__zero_or_positive_weight_cycles_from_neighbours_7_p_0(transform_hlds__term_pass2__NeighboursList_41, transform_hlds__term_pass2__LookforPPId_2, transform_hlds__term_pass2__Context_3, transform_hlds__term_pass2__WeightSoFar1_33, transform_hlds__term_pass2__NewVisitedCalls_39, transform_hlds__term_pass2__CallWeights_6, &transform_hlds__term_pass2__Cycles1_21);
        }
      }
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word transform_hlds__term_pass2__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Result1_16, (MR_Integer) 0)));
        ...
        else
        {
          /* direct tailcall eliminated */
          {
            MR_Word transform_hlds__term_pass2__next_value_of_RecSupplierMap0_11 = transform_hlds__term_pass2__RecSupplierMap1_18;

            transform_hlds__term_pass2__RecSupplierMap0_11 = transform_hlds__term_pass2__next_value_of_RecSupplierMap0_11;
          }
          continue;
        }
      }
...
{
  {
    ...
    transform_hlds__term_pass2__succeeded = transform_hlds__term_pass2__IntroducedFrom__pred__prove_termination_in_scc_pass__391__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__closure, (MR_Integer) 4))));
    return transform_hlds__term_pass2__succeeded;
  }
}
...
{
  {
    ...
    transform_hlds__term_pass2__succeeded = transform_hlds__term_pass2__IntroducedFrom__pred__prove_termination_in_scc_pass__408__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__closure, (MR_Integer) 4))));
    return transform_hlds__term_pass2__succeeded;
  }
}
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) transform_hlds__term_pass2__Info_37)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          {
            transform_hlds__term_pass2__Var_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 0) = ((MR_Box) (&transform_hlds__term_pass2_scalar_common_4[2]));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 1) = ((MR_Box) (transform_hlds__term_pass2__prove_termination_in_scc_pass_8_p_0_1));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_51, 4) = ((MR_Box) (transform_hlds__term_pass2__CanLoop_61));
          }
          mercury__require__expect_4_p_0(transform_hlds__term_pass2__Var_51, (MR_String) "transform_hlds.term_pass2", (MR_String) "predicate \140transform_hlds.term_pass2.prove_termination_in_scc_pass\'/8", (MR_String) "can_loop detected in pass2 but not pass1");
          {
            MR_Word base;
        ...
        else
        {
          ...
          MR_Word transform_hlds__term_pass2__Var_56;
          MR_Box transform_hlds__term_pass2__conv0_RecSuppliers0_42;

          {
            transform_hlds__term_pass2__Var_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 0) = ((MR_Box) (&transform_hlds__term_pass2_scalar_common_4[2]));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 1) = ((MR_Box) (transform_hlds__term_pass2__prove_termination_in_scc_pass_8_p_0_2));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 3) = ((MR_Box) (transform_hlds__term_pass2__CanLoop_39));
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_56, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          mercury__require__expect_4_p_0(transform_hlds__term_pass2__Var_56, (MR_String) "transform_hlds.term_pass2", (MR_String) "predicate \140transform_hlds.term_pass2.prove_termination_in_scc_pass\'/8", (MR_String) "can_loop detected in pass2 but not pass1");
          ...
          /* direct tailcall eliminated */
          {
            MR_Word transform_hlds__term_pass2__next_value_of_HeadVar__4_4 = transform_hlds__term_pass2__PPIds_19;
            MR_Word transform_hlds__term_pass2__next_value_of_HeadVar__6_6 = transform_hlds__term_pass2__NewRecSupplierMap1_47;
            MR_Word transform_hlds__term_pass2__next_value_of_HeadVar__7_7 = transform_hlds__term_pass2__CallInfo1_48;

            transform_hlds__term_pass2__HeadVar__7_7 = transform_hlds__term_pass2__next_value_of_HeadVar__7_7;
            transform_hlds__term_pass2__HeadVar__6_6 = transform_hlds__term_pass2__next_value_of_HeadVar__6_6;
            transform_hlds__term_pass2__HeadVar__4_4 = transform_hlds__term_pass2__next_value_of_HeadVar__4_4;
          }
          continue;
        }
      }
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word transform_hlds__term_pass2__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__CallSite_14, (MR_Integer) 0)));

          transform_hlds__term_pass2__CallPPId_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_40, (MR_Integer) 0)));
          transform_hlds__term_pass2__Context_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_40, (MR_Integer) 1)));
        }
        ...
        if (transform_hlds__term_pass2__succeeded)
        {
          ...
          if (transform_hlds__term_pass2__succeeded)
          {
            ...
            else
            {
              ...
              {
                transform_hlds__term_pass2__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_44, 0) = ((MR_Box) (transform_hlds__term_pass2__Context_21));
                MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_44, 1) = ((MR_Box) (transform_hlds__term_pass2__GammaConst_15));
              }
              mercury__map__det_insert_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, (MR_Word) &transform_hlds__term_pass2_scalar_common_2[0], ((MR_Box) (transform_hlds__term_pass2__CallPPId_20)), ((MR_Box) (transform_hlds__term_pass2__Var_44)), transform_hlds__term_pass2__NeighbourMap0_26, &transform_hlds__term_pass2__NeighbourMap_31);
            }
          ...
          else
          {
            ...
            MR_Word transform_hlds__term_pass2__Var_45;
            MR_Word transform_hlds__term_pass2__NeighbourMap_50;

            {
              transform_hlds__term_pass2__Var_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_45, 0) = ((MR_Box) (transform_hlds__term_pass2__Context_21));
              MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__Var_45, 1) = ((MR_Box) (transform_hlds__term_pass2__GammaConst_15));
            }
            transform_hlds__term_pass2__NeighbourMap_50 = mercury__map__singleton_2_f_0(transform_hlds__term_pass2__TypeCtorInfo_62_62, (MR_Word) &transform_hlds__term_pass2_scalar_common_2[0], ((MR_Box) (transform_hlds__term_pass2__CallPPId_20)), ((MR_Box) (transform_hlds__term_pass2__Var_45)));
        ...
        else
        {
          ...
          MR_Word transform_hlds__term_pass2__Var_47;

          {
            transform_hlds__term_pass2__Var_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__Var_47, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__Var_47, 1) = ((MR_Box) (transform_hlds__term_pass2__PPId_13));
            MR_hl_field(MR_mktag(3), transform_hlds__term_pass2__Var_47, 2) = ((MR_Box) (transform_hlds__term_pass2__CallPPId_20));
          }
          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__InfCall_33, 1) = ((MR_Box) (transform_hlds__term_pass2__Var_47));
          }
          {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word transform_hlds__term_pass2__next_value_of_HeadVar__1_1 = transform_hlds__term_pass2__Paths_10;
          MR_Word transform_hlds__term_pass2__next_value_of_STATE_VARIABLE_CallInfo_0_3 = transform_hlds__term_pass2__STATE_VARIABLE_CallInfo_46_46;

          transform_hlds__term_pass2__STATE_VARIABLE_CallInfo_0_3 = transform_hlds__term_pass2__next_value_of_STATE_VARIABLE_CallInfo_0_3;
          transform_hlds__term_pass2__HeadVar__1_1 = transform_hlds__term_pass2__next_value_of_HeadVar__1_1;
        }
        continue;
      }
    }
...
{
  {
    ...
    {
      MR_Word transform_hlds__term_pass2__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word transform_hlds__term_pass2__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_pass2__HeadVar__1_1, (MR_Integer) 0)));
      ...
      else
      {
        ...
        switch (transform_hlds__term_pass2__RecInputSupplier0_35) {
          ...
          case (MR_Integer) 1:
            {
              mercury__bag__insert_3_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[1], ((MR_Box) (transform_hlds__term_pass2__Var_48)), transform_hlds__term_pass2__STATE_VARIABLE_RecBag_0_6, &transform_hlds__term_pass2__STATE_VARIABLE_RecBag_42_42);
            }
            break;
        }
        switch (transform_hlds__term_pass2__FixDir_3) {
          ...
          case (MR_Integer) 1:
            {
              transform_hlds__term_pass2__succeeded = mercury__bag__contains_2_p_0((MR_Word) &transform_hlds__term_pass2_scalar_common_1[1], transform_hlds__term_pass2__ActiveVars_2, ((MR_Box) (transform_hlds__term_pass2__Var_48)));
              if (transform_hlds__term_pass2__succeeded)
        ...
        transform_hlds__term_pass2__update_rec_input_suppliers_7_p_0(transform_hlds__term_pass2__Var_47, transform_hlds__term_pass2__ActiveVars_2, transform_hlds__term_pass2__FixDir_3, transform_hlds__term_pass2__RecInputSuppliers0_36, &transform_hlds__term_pass2__RecInputSuppliers_38, transform_hlds__term_pass2__STATE_VARIABLE_RecBag_42_42, transform_hlds__term_pass2__STATE_VARIABLE_RecBag_7);
        {
          MR_Word base;
...
{
  {
    ...
    transform_hlds__term_pass2__IntroducedFrom__pred__init_rec_input_suppliers_single_arg_others__283__1_2_p_0(((MR_Word) transform_hlds__term_pass2__wrapper_arg_1), &transform_hlds__term_pass2__conv0_HeadVar__2_23);
  ...
  MR_Word * transform_hlds__term_pass2__STATE_VARIABLE_RecSupplierMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word transform_hlds__term_pass2__Var_13;

      hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_pass2__ModuleInfo_1, transform_hlds__term_pass2__PPId_10, &transform_hlds__term_pass2__Var_13, &transform_hlds__term_pass2__ProcInfo_14);
      ...
      /* direct tailcall eliminated */
      {
        MR_Word transform_hlds__term_pass2__next_value_of_HeadVar__2_2 = transform_hlds__term_pass2__PPIds_11;
        MR_Word transform_hlds__term_pass2__next_value_of_STATE_VARIABLE_RecSupplierMap_0_3 = transform_hlds__term_pass2__STATE_VARIABLE_RecSupplierMap_20_20;

        transform_hlds__term_pass2__STATE_VARIABLE_RecSupplierMap_0_3 = transform_hlds__term_pass2__next_value_of_STATE_VARIABLE_RecSupplierMap_0_3;
        transform_hlds__term_pass2__HeadVar__2_2 = transform_hlds__term_pass2__next_value_of_HeadVar__2_2;
      }
      continue;
    }
    break;
...
{
  {
    ...
    transform_hlds__term_pass2__IntroducedFrom__pred__init_rec_input_suppliers_add_single_arg__252__1_2_p_0(((MR_Word) transform_hlds__term_pass2__wrapper_arg_1), &transform_hlds__term_pass2__conv0_HeadVar__2_20);
...
{
  {
    ...
    if (transform_hlds__term_pass2__succeeded)
    {
      ...
      else
      {
        ...
        MR_Word transform_hlds__term_pass2__Var_16;
        ...
        {
          MR_Integer transform_hlds__term_pass2__Var_14;
          MR_Integer transform_hlds__term_pass2__Var_15;

          transform_hlds__term_pass2__succeeded = check_hlds__mode_util__mode_is_input_2_p_0(transform_hlds__term_pass2__ModuleInfo_5, transform_hlds__term_pass2__Mode_6);
          if (transform_hlds__term_pass2__succeeded)
          {
            transform_hlds__term_pass2__Var_14 = (MR_Integer) 1;
            transform_hlds__term_pass2__succeeded = (transform_hlds__term_pass2__ArgNum_8 > transform_hlds__term_pass2__Var_14);
            if (transform_hlds__term_pass2__succeeded)
            {
              transform_hlds__term_pass2__Var_15 = (MR_Integer) 1;
              transform_hlds__term_pass2__NextArgNum_11 = (transform_hlds__term_pass2__ArgNum_8 - transform_hlds__term_pass2__Var_15);
              transform_hlds__term_pass2__succeeded = MR_TRUE;
            }
          }
        }
        if (transform_hlds__term_pass2__succeeded)
        {
          ...
          if (transform_hlds__term_pass2__succeeded)
          {
            transform_hlds__term_pass2__Var_16 = (MR_Integer) 0;
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *transform_hlds__term_pass2__BoolList_9 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (transform_hlds__term_pass2__Var_16));
...
{
  {
    ...
    else
    {
      ...
      MR_Word transform_hlds__term_pass2__Var_23;

      hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_pass2__ModuleInfo_1, transform_hlds__term_pass2__PPId_11, &transform_hlds__term_pass2__Var_23, &transform_hlds__term_pass2__ProcInfo_24);
...
{
  {
    ...
    transform_hlds__term_pass2__IntroducedFrom__pred__init_rec_input_suppliers__141__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__closure, (MR_Integer) 3))), ((MR_Word) transform_hlds__term_pass2__wrapper_arg_1), &transform_hlds__term_pass2__conv0_LambdaHeadVar__2_22);
  ...
  MR_Word * transform_hlds__term_pass2__HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word transform_hlds__term_pass2__Var_11;
    ...
    hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_pass2__ModuleInfo_2, transform_hlds__term_pass2__PPId_6, &transform_hlds__term_pass2__Var_11, &transform_hlds__term_pass2__ProcInfo_12);
    ...
    transform_hlds__term_util__partition_call_args_5_p_0(transform_hlds__term_pass2__ModuleInfo_2, transform_hlds__term_pass2__ArgModes_14, transform_hlds__term_pass2__HeadVars_13, &transform_hlds__term_pass2__InArgs_15, &transform_hlds__term_pass2___OutVars_16);
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__term_pass2__MapIsInput_17, 0) = ((MR_Box) (&transform_hlds__term_pass2_scalar_common_3[0]));
