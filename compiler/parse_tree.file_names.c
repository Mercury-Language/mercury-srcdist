...
static const MR_DuFunctorDescPtr parse_tree__file_names__parse_tree__file_names__du_stag_ordered_ext_0_3[6];

static const MR_DuPtagLayout parse_tree__file_names__parse_tree__file_names__du_ptag_ordered_ext_0[4];

static const MR_DuFunctorDescPtr parse_tree__file_names__parse_tree__file_names__du_name_ordered_ext_0[9];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_0[9];
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_0[34];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_0[34];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_0[34];
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_0[11];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_0[11];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_0[11];
...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_gs_0_23;

static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_gs_0_24;

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_gs_0[25];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_gs_0[25];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_gs_0[25];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[172];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[172] = {
  /* row   0 */   { (MR_String) ".all_int3s" },
  /* row   1 */   { (MR_String) ".all_ints" },
  /* row   2 */   { (MR_String) ".all_opts" },
  /* row   3 */   { (MR_String) ".all_trans_opts" },
  /* row   4 */   { (MR_String) ".check" },
  /* row   5 */   { (MR_String) ".classes" },
  /* row   6 */   { (MR_String) ".clean" },
  /* row   7 */   { (MR_String) ".depend" },
  /* row   8 */   { (MR_String) ".install_grade_hdrs" },
  /* row   9 */   { (MR_String) ".install_hdrs" },
  /* row  10 */   { (MR_String) ".install_ints" },
  /* row  11 */   { (MR_String) ".install_opts" },
  /* row  12 */   { (MR_String) ".int3s" },
  /* row  13 */   { (MR_String) ".ints" },
  /* row  14 */   { (MR_String) ".javas" },
  /* row  15 */   { (MR_String) ".opts" },
  /* row  16 */   { (MR_String) ".realclean" },
  /* row  17 */   { (MR_String) ".trans_opts" },
  /* row  18 */   { (MR_String) ".defn_extents" },
  /* row  19 */   { (MR_String) ".defn_line_counts" },
  /* row  20 */   { (MR_String) ".defns" },
  /* row  21 */   { (MR_String) ".dependency_graph" },
  /* row  22 */   { (MR_String) ".hlds_dump" },
  /* row  23 */   { (MR_String) ".imports_graph" },
  /* row  24 */   { (MR_String) ".local_call_tree" },
  /* row  25 */   { (MR_String) ".local_call_tree_full" },
  /* row  26 */   { (MR_String) ".local_call_tree_order" },
  /* row  27 */   { (MR_String) ".mlds_dump" },
  /* row  28 */   { (MR_String) ".mode_constraints" },
  /* row  29 */   { (MR_String) ".order" },
  /* row  30 */   { (MR_String) ".order_trans_opt" },
  /* row  31 */   { (MR_String) ".type_repns" },
  /* row  32 */   { (MR_String) ".ugly" },
  /* row  33 */   { (MR_String) ".xml" },
  /* row  34 */   { (MR_String) ".int0" },
  /* row  35 */   { (MR_String) ".int" },
  /* row  36 */   { (MR_String) ".int2" },
  /* row  37 */   { (MR_String) ".int3" },
  /* row  38 */   { (MR_String) ".date0" },
  /* row  39 */   { (MR_String) ".date" },
  /* row  40 */   { (MR_String) ".date3" },
  /* row  41 */   { (MR_String) ".d" },
  /* row  42 */   { (MR_String) ".dv" },
  /* row  43 */   { (MR_String) ".dep" },
  /* row  44 */   { (MR_String) ".prof" },
  /* row  45 */   { (MR_String) ".opt" },
  /* row  46 */   { (MR_String) ".trans_opt" },
  /* row  47 */   { (MR_String) ".analysis" },
  /* row  48 */   { (MR_String) ".imdg" },
  /* row  49 */   { (MR_String) ".request" },
  ...
  /* row  68 */   { (MR_String) ".defn_extents" },
  /* row  69 */   { (MR_String) ".defn_line_counts" },
  /* row  70 */   { (MR_String) ".defns" },
  /* row  71 */   { (MR_String) ".dependency_graph" },
  /* row  72 */   { (MR_String) ".hlds_dump" },
  /* row  73 */   { (MR_String) ".imports_graph" },
  /* row  74 */   { (MR_String) ".local_call_tree" },
  /* row  75 */   { (MR_String) ".local_call_tree_full" },
  /* row  76 */   { (MR_String) ".local_call_tree_order" },
  /* row  77 */   { (MR_String) ".mlds_dump" },
  /* row  78 */   { (MR_String) ".mode_constraints" },
  /* row  79 */   { (MR_String) ".order" },
  /* row  80 */   { (MR_String) ".order_trans_opt" },
  /* row  81 */   { (MR_String) ".type_repns" },
  /* row  82 */   { (MR_String) ".ugly" },
  /* row  83 */   { (MR_String) ".xml" },
  /* row  84 */   { (MR_String) "int0s" },
  /* row  85 */   { (MR_String) "ints" },
  /* row  86 */   { (MR_String) "int2s" },
  /* row  87 */   { (MR_String) "int3s" },
  /* row  88 */   { (MR_String) "date0s" },
  /* row  89 */   { (MR_String) "dates" },
  /* row  90 */   { (MR_String) "date3s" },
  /* row  91 */   { (MR_String) "ds" },
  /* row  92 */   { (MR_String) "deps" },
  /* row  93 */   { (MR_String) "deps" },
  /* row  94 */   { (MR_String) "profs" },
  /* row  95 */   { (MR_String) ".int0" },
  /* row  96 */   { (MR_String) ".int" },
  /* row  97 */   { (MR_String) ".int2" },
  /* row  98 */   { (MR_String) ".int3" },
  /* row  99 */   { (MR_String) ".date0" },
  /* row 100 */   { (MR_String) ".date" },
  /* row 101 */   { (MR_String) ".date3" },
  /* row 102 */   { (MR_String) ".d" },
  /* row 103 */   { (MR_String) ".dv" },
  /* row 104 */   { (MR_String) ".dep" },
  /* row 105 */   { (MR_String) ".prof" },
  /* row 106 */   { (MR_String) ".opt" },
  /* row 107 */   { (MR_String) ".trans_opt" },
  /* row 108 */   { (MR_String) ".analysis" },
  /* row 109 */   { (MR_String) ".imdg" },
  /* row 110 */   { (MR_String) ".request" },
  /* row 111 */   { (MR_String) "int0s" },
  /* row 112 */   { (MR_String) "ints" },
  /* row 113 */   { (MR_String) "int2s" },
  /* row 114 */   { (MR_String) "int3s" },
  /* row 115 */   { (MR_String) "date0s" },
  /* row 116 */   { (MR_String) "dates" },
  /* row 117 */   { (MR_String) "date3s" },
  /* row 118 */   { (MR_String) "ds" },
  /* row 119 */   { (MR_String) "deps" },
  /* row 120 */   { (MR_String) "deps" },
  /* row 121 */   { (MR_String) "profs" },
  /* row 122 */   { (MR_String) ".all_int3s" },
  /* row 123 */   { (MR_String) ".all_ints" },
  /* row 124 */   { (MR_String) ".all_opts" },
  /* row 125 */   { (MR_String) ".all_trans_opts" },
  /* row 126 */   { (MR_String) ".check" },
  /* row 127 */   { (MR_String) ".classes" },
  /* row 128 */   { (MR_String) ".clean" },
  /* row 129 */   { (MR_String) ".depend" },
  /* row 130 */   { (MR_String) ".install_grade_hdrs" },
  /* row 131 */   { (MR_String) ".install_hdrs" },
  /* row 132 */   { (MR_String) ".install_ints" },
  /* row 133 */   { (MR_String) ".install_opts" },
  /* row 134 */   { (MR_String) ".int3s" },
  /* row 135 */   { (MR_String) ".ints" },
  /* row 136 */   { (MR_String) ".javas" },
  /* row 137 */   { (MR_String) ".opts" },
  /* row 138 */   { (MR_String) ".realclean" },
  /* row 139 */   { (MR_String) ".trans_opts" },
  /* row 140 */   { (MR_String) ".defn_extents" },
  /* row 141 */   { (MR_String) ".defn_line_counts" },
  /* row 142 */   { (MR_String) ".defns" },
  /* row 143 */   { (MR_String) ".dependency_graph" },
  /* row 144 */   { (MR_String) ".hlds_dump" },
  /* row 145 */   { (MR_String) ".imports_graph" },
  /* row 146 */   { (MR_String) ".local_call_tree" },
  /* row 147 */   { (MR_String) ".local_call_tree_full" },
  /* row 148 */   { (MR_String) ".local_call_tree_order" },
  /* row 149 */   { (MR_String) ".mlds_dump" },
  /* row 150 */   { (MR_String) ".mode_constraints" },
  /* row 151 */   { (MR_String) ".order" },
  /* row 152 */   { (MR_String) ".order_trans_opt" },
  /* row 153 */   { (MR_String) ".type_repns" },
  /* row 154 */   { (MR_String) ".ugly" },
  /* row 155 */   { (MR_String) ".xml" },
  /* row 156 */   { (MR_String) ".int0" },
  /* row 157 */   { (MR_String) ".int" },
  /* row 158 */   { (MR_String) ".int2" },
  /* row 159 */   { (MR_String) ".int3" },
  /* row 160 */   { (MR_String) ".date0" },
  /* row 161 */   { (MR_String) ".date" },
  /* row 162 */   { (MR_String) ".date3" },
  /* row 163 */   { (MR_String) ".d" },
  /* row 164 */   { (MR_String) ".dv" },
  /* row 165 */   { (MR_String) ".dep" },
  /* row 166 */   { (MR_String) ".prof" },
  /* row 167 */   { (MR_String) ".opt" },
  /* row 168 */   { (MR_String) ".trans_opt" },
  /* row 169 */   { (MR_String) ".analysis" },
  /* row 170 */   { (MR_String) ".imdg" },
  /* row 171 */   { (MR_String) ".request" },
};
...
#line 1411 "file_names.m"
void 
parse_tree__file_names__user_init_pred_126_0(void)
#line 1411 "file_names.m"
{
#line 1411 "file_names.m"
...
#line 1538 "file_names.m"
void 
parse_tree__file_names__user_init_pred_139_0(void)
#line 1538 "file_names.m"
{
#line 1538 "file_names.m"
...
#line 1540 "file_names.m"
void 
parse_tree__file_names__user_init_pred_140_0(void)
#line 1540 "file_names.m"
{
#line 1540 "file_names.m"
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_4[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_err_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_5[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_java_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_6[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_max_cur_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_7[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_max_cur_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_8[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_max_ngs_0) };
...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_gs_0_22 = {
  (MR_String) "ext_cur_ngs_gs_misc_module_dep",
  INT32_C(22)
};
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_gs_0[25] = {
  ...
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_gs_0_23,
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_gs_0_24
};
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Integer Var_38 = (MR_Integer) (ArgX1_6);
              MR_Integer Var_39 = (MR_Integer) (ArgY1_7);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Integer Var_36 = (MR_Integer) (ArgX1_8);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      MR_Integer Var_34 = (MR_Integer) (ArgX1_10);
                      MR_Integer Var_35 = (MR_Integer) (ArgY1_11);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Word ArgX1_14 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
                      MR_Word ArgY1_15 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 1);
                      MR_Integer Var_32 = (MR_Integer) (ArgX1_14);
                  ...
                  case (MR_Integer) 5:
                    {
                      ...
                      MR_Word ArgY1_21 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 7);
                      MR_Integer Var_30 = (MR_Integer) (ArgX1_20);
                      MR_Integer Var_31 = (MR_Integer) (ArgY1_21);
  ...
  switch (MR_tag((MR_Word) Ext_22)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[122 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[156 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_22, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_String _SubDirName_54;

            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_12, ExtCurNgsGs_48, &ExtStr0_25, &_SubDirName_54);
          }
          break;
        case (MR_Integer) 1:
        ...
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGsJava_50 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 1);

            switch (ExtCurNgsGsJava_50) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 5:
          {
            MR_Word ExtCurNgsGsMaxNgs_52 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 7);

            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[167 + ExtCurNgsGsMaxNgs_52]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * DirName_4)
{
  ...
  switch (SubdirSetting_5) {
    ...
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      DirComponents_6 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3]));
      break;
    case (MR_Integer) 2:
      {
        MR_String Grade_12;
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_3, (MR_Integer) 727, &TargetArch_13);
        {
          Var_17 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_17, 0) = ((MR_Box) (TargetArch_13));
          MR_hl_field(1, Var_17, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3])));
        }
        {
  ...
  switch (MR_tag((MR_Word) Ext_7)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13 = ((&parse_tree__file_names_vector_common_4[111 + ExtCurNgs_10]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_151;

              {
                Var_151 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_151, 0) = ((MR_Box) (SubDirName_13));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word SubdirSetting_32;

        libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_32);
        switch (SubdirSetting_32) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_14) {
                ...
                case (MR_Integer) 3:
                  {
                    MR_String _ExtStr_155;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 633, &_ExtStr_155);
                    SubDirName_29 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_171;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 632, &_ExtStr_171);
                    SubDirName_29 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_173;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 631, &_ExtStr_173);
                    SubDirName_29 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_107);
              libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 727, &TargetArch_108);
              {
                Var_115 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_115, 0) = ((MR_Box) (SubDirName_29));
                MR_hl_field(1, Var_115, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_113, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, Var_113, 1) = ((MR_Box) (Var_115));
              }
              {
                Var_112 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_112, 0) = ((MR_Box) (TargetArch_108));
                MR_hl_field(1, Var_112, 1) = ((MR_Box) (Var_113));
              }
              {
                Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_111, 0) = ((MR_Box) (Grade_107));
              ...
              }
              {
                ...
                *DirNames_8 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_111));
              }
            }
            break;
        }
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_43);
            switch (SubdirSetting_43) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_40;
                  MR_String _ExtStr_38;

                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_38, &SubDirName_40);
                  *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_40);
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_37;
                  MR_String _ExtStr_35;

                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_35, &SubDirName_37);
                  *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_37);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 1:
          {
            MR_Word ErrorFilesInSubdir_17;

            libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 708, &ErrorFilesInSubdir_17);
            switch (ErrorFilesInSubdir_17) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                {
                  ...
                  libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_54);
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_101_114_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_49, &SubDirName_51);
                        *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_51);
                      }
                      break;
                    case (MR_Integer) 1:
                      {
                        MR_String SubDirName_48;
                        MR_String _ExtStr_46;

                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_101_114_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_46, &SubDirName_48);
                        *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_48);
                      }
                      break;
                  }
                }
        ...
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGsJava_18 = ((MR_Unsigned) ((MR_hl_field(3, Ext_7, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word DirNames0_19;

            parse_tree__file_names__get_java_dir_path_3_p_0(Globals_5, ExtCurNgsGsJava_18, &DirNames0_19);
            *DirNames_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_19, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
          }
          break;
        case (MR_Integer) 3:
          switch (Search_6) {
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_68);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_63, &SubDirName_65);
                      *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_65);
                    }
                    break;
                }
              }
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_85);
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_80, &SubDirName_82);
                      *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_82);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_77, &SubDirName_79);
                      *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_79);
                    }
                    break;
                }
              }
        ...
        case (MR_Integer) 5:
          {
            MR_Word ExtCurNgsGsMaxNgs_22 = ((MR_Unsigned) ((MR_hl_field(3, Ext_7, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_102;

            libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_102);
            switch (SubdirSetting_102) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_99;
                  MR_String _ExtStr_97;

                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_22, &_ExtStr_97, &SubDirName_99);
                  switch (Search_6) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_99);
                      break;
                    case (MR_Integer) 0:
                      *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_99);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_96;
                  MR_String _ExtStr_94;

                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_22, &_ExtStr_94, &SubDirName_96);
                  *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_96);
                }
                break;
            }
          }
  ...
  switch (MR_tag((MR_Word) Ext_13)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_171 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[50 + ExtCur_171]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_25) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_27 = ((&parse_tree__file_names_vector_common_4[84 + ExtCurNgs_24]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_115;

              {
                Var_115 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_115, 0) = ((MR_Box) (SubDirName_27));
                MR_hl_field(1, Var_115, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                MR_Word base;
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurNgs_172 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[95 + ExtCurNgs_172]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        MR_Word SubdirSetting_43;
        MR_Word ExtCurGs_174;

        libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_43);
        switch (SubdirSetting_43) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 2:
            {
              MR_String SubDirName_42;
              MR_String Grade_71;
              MR_String TargetArch_72;
              MR_Word Var_75;
              MR_Word Var_76;
              MR_Word Var_77;
              MR_Word Var_79;
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 633, &_ExtStr_119);
                    SubDirName_42 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 632, &_ExtStr_135);
                    SubDirName_42 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 631, &_ExtStr_137);
                    SubDirName_42 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_71);
              libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 727, &TargetArch_72);
              {
                Var_79 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_79, 0) = ((MR_Box) (SubDirName_42));
                MR_hl_field(1, Var_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_77, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, Var_77, 1) = ((MR_Box) (Var_79));
              }
              {
                Var_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_76, 0) = ((MR_Box) (TargetArch_72));
                MR_hl_field(1, Var_76, 1) = ((MR_Box) (Var_77));
              }
              {
                Var_75 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_75, 0) = ((MR_Box) (Grade_71));
              ...
              }
              {
                ...
                *DirNames_15 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_75));
              }
            }
            break;
        }
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurGs_174 = ((MR_Unsigned) ((MR_hl_field(2, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        switch (ExtCurGs_174) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 3:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 633, &ExtStr_18);
            break;
          case (MR_Integer) 0:
            ExtStr_18 = (MR_String) "";
            break;
          ...
          case (MR_Integer) 9:
            ...
            break;
          case (MR_Integer) 10:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 632, &ExtStr_18);
            break;
          case (MR_Integer) 11:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 631, &ExtStr_18);
            break;
        }
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_13, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ExtCurNgsGs_175;
            MR_String _SubDirName_181;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_48);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_46, &SubDirName_47);
                  *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_47);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_44, &SubDirName_45);
                  *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_45);
                }
                break;
            }
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGs_175 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 31);
            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_175, &ExtStr_18, &_SubDirName_181);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ErrorFilesInSubdir_31;

            libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 708, &ErrorFilesInSubdir_31);
            switch (ErrorFilesInSubdir_31) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                {
                  MR_Word SubdirSetting_53;

                  libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_53);
                  switch (SubdirSetting_53) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                      break;
                    case (MR_Integer) 2:
                      {
                        ...
                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_101_114_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_51, &SubDirName_52);
                        *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_52);
                      }
                      break;
                    case (MR_Integer) 1:
                      {
                        ...
                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_101_114_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_49, &SubDirName_50);
                        *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_50);
                      }
                      break;
                  }
                }
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtStr_18 = (MR_String) ".err";
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGsJava_32 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word DirNames0_33;
            MR_Word ExtCurNgsGsJava_177;

            parse_tree__file_names__get_java_dir_path_3_p_0(Globals_9, ExtCurNgsGsJava_32, &DirNames0_33);
            *DirNames_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_33, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            parse_tree__java_names__mangle_sym_name_for_java_4_p_0(ModuleName_14, (MR_Integer) 0, (MR_String) "__", &BaseNameNoExt_17);
            ExtCurNgsGsJava_177 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_177) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 3:
          {
            switch (Search_11) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word SubdirSetting_56;

                  libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_56);
                  switch (SubdirSetting_56) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                      break;
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_String SubDirName_55;
                        MR_String _ExtStr_54;

                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_54, &SubDirName_55);
                        *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_55);
                      }
                      break;
                  }
                }
        ...
        case (MR_Integer) 4:
          {
            switch (Search_11) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word SubdirSetting_61;

                  libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_61);
                  switch (SubdirSetting_61) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                      break;
                    case (MR_Integer) 2:
                      {
                        MR_String SubDirName_60;
                        MR_String _ExtStr_59;

                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_59, &SubDirName_60);
                        *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_60);
                      }
                      break;
                    case (MR_Integer) 1:
                      {
                        ...
                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_57, &SubDirName_58);
                        *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_58);
                      }
                      break;
                  }
                }
        ...
        case (MR_Integer) 5:
          {
            MR_Word ExtCurNgsGsMaxNgs_36 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_66;
            MR_Word ExtCurNgsGsMaxNgs_179;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_66);
            switch (SubdirSetting_66) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_36, &_ExtStr_64, &SubDirName_65);
                  switch (Search_11) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_65);
                      break;
                    case (MR_Integer) 0:
                      *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_65);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_36, &_ExtStr_62, &SubDirName_63);
                  *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_63);
                }
                break;
            }
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGsMaxNgs_179 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[106 + ExtCurNgsGsMaxNgs_179]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String SubDirName_5)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 727, &TargetArch_8);
  {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 727, &TargetArch_14);
        {
  ...
  switch (MR_tag((MR_Word) Ext_5)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        ExtStr_6 = ((&parse_tree__file_names_vector_common_4[34 + ExtCurNgs_8]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_String _SubDirName_18;

            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_4, ExtCurNgsGs_11, &ExtStr_6, &_SubDirName_18);
          }
          break;
        case (MR_Integer) 1:
        ...
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGsJava_13 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 1);

            switch (ExtCurNgsGsJava_13) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 5:
          {
            MR_Word ExtCurNgsGsMaxNgs_15 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 7);

            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[45 + ExtCurNgsGsMaxNgs_15]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * Dir_8)
{
  switch (Ext_6) {
    ...
    case (MR_Integer) 21:
      {
        *Str_7 = (MR_String) ".err_date";
        *Dir_8 = (MR_String) "err_dates";
      }
      break;
    case (MR_Integer) 22:
      {
        *Str_7 = (MR_String) ".module_dep";
        *Dir_8 = (MR_String) "module_deps";
      }
      break;
    case (MR_Integer) 24:
      {
...
{
	parse_tree__file_names__user_init_pred_126_0();
	parse_tree__file_names__user_init_pred_136_0();
	parse_tree__file_names__user_init_pred_139_0();
	parse_tree__file_names__user_init_pred_140_0();
}
