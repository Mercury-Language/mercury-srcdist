...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_gs_0[24];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_gs_0[24];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_gs_0[24];
...
static /* final */ const MR_Box parse_tree__file_names_scalar_common_2[8][2];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[173];
...
static /* final */ const MR_Box parse_tree__file_names_scalar_common_2[8][2] = {
  ...
  {
    ((MR_Box) ((MR_String) "Mercury")),
    ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[6])))
  },
};
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[173] = {
  ...
  /* row  44 */   { (MR_String) ".module_dep" },
  /* row  45 */   { (MR_String) ".prof" },
  /* row  46 */   { (MR_String) ".opt" },
  /* row  47 */   { (MR_String) ".trans_opt" },
  /* row  48 */   { (MR_String) ".analysis" },
  /* row  49 */   { (MR_String) ".imdg" },
  /* row  50 */   { (MR_String) ".request" },
  ...
  /* row  69 */   { (MR_String) ".defn_extents" },
  /* row  70 */   { (MR_String) ".defn_line_counts" },
  /* row  71 */   { (MR_String) ".defns" },
  /* row  72 */   { (MR_String) ".dependency_graph" },
  /* row  73 */   { (MR_String) ".hlds_dump" },
  /* row  74 */   { (MR_String) ".imports_graph" },
  /* row  75 */   { (MR_String) ".local_call_tree" },
  /* row  76 */   { (MR_String) ".local_call_tree_full" },
  /* row  77 */   { (MR_String) ".local_call_tree_order" },
  /* row  78 */   { (MR_String) ".mlds_dump" },
  /* row  79 */   { (MR_String) ".mode_constraints" },
  /* row  80 */   { (MR_String) ".order" },
  /* row  81 */   { (MR_String) ".order_trans_opt" },
  /* row  82 */   { (MR_String) ".type_repns" },
  /* row  83 */   { (MR_String) ".ugly" },
  /* row  84 */   { (MR_String) ".xml" },
  /* row  85 */   { (MR_String) ".int0" },
  /* row  86 */   { (MR_String) ".int" },
  /* row  87 */   { (MR_String) ".int2" },
  /* row  88 */   { (MR_String) ".int3" },
  /* row  89 */   { (MR_String) ".date0" },
  /* row  90 */   { (MR_String) ".date" },
  /* row  91 */   { (MR_String) ".date3" },
  /* row  92 */   { (MR_String) ".d" },
  /* row  93 */   { (MR_String) ".dv" },
  /* row  94 */   { (MR_String) ".dep" },
  /* row  95 */   { (MR_String) ".module_dep" },
  /* row  96 */   { (MR_String) ".prof" },
  /* row  97 */   { (MR_String) "opts" },
  /* row  98 */   { (MR_String) "trans_opts" },
  /* row  99 */   { (MR_String) "analyses" },
  /* row 100 */   { (MR_String) "imdgs" },
  /* row 101 */   { (MR_String) "requests" },
  /* row 102 */   { (MR_String) "opts" },
  /* row 103 */   { (MR_String) "trans_opts" },
  /* row 104 */   { (MR_String) "analyses" },
  /* row 105 */   { (MR_String) "imdgs" },
  /* row 106 */   { (MR_String) "requests" },
  /* row 107 */   { (MR_String) ".opt" },
  /* row 108 */   { (MR_String) ".trans_opt" },
  /* row 109 */   { (MR_String) ".analysis" },
  /* row 110 */   { (MR_String) ".imdg" },
  /* row 111 */   { (MR_String) ".request" },
  /* row 112 */   { (MR_String) "opts" },
  /* row 113 */   { (MR_String) "trans_opts" },
  /* row 114 */   { (MR_String) "analyses" },
  /* row 115 */   { (MR_String) "imdgs" },
  /* row 116 */   { (MR_String) "requests" },
  /* row 117 */   { (MR_String) "opts" },
  /* row 118 */   { (MR_String) "trans_opts" },
  /* row 119 */   { (MR_String) "analyses" },
  /* row 120 */   { (MR_String) "imdgs" },
  /* row 121 */   { (MR_String) "requests" },
  ...
  /* row 166 */   { (MR_String) ".module_dep" },
  /* row 167 */   { (MR_String) ".prof" },
  /* row 168 */   { (MR_String) ".opt" },
  /* row 169 */   { (MR_String) ".trans_opt" },
  /* row 170 */   { (MR_String) ".analysis" },
  /* row 171 */   { (MR_String) ".imdg" },
  /* row 172 */   { (MR_String) ".request" },
};
        ...
        case (MR_Integer) 5:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[168 + ExtCurNgsGsMaxNgs_52]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * DirName_4)
{
  ...
  switch (SubdirSetting_5) {
    ...
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      DirComponents_6 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[7]));
      break;
    case (MR_Integer) 2:
      {
        MR_String Grade_12;
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_3, (MR_Integer) 726, &TargetArch_13);
        {
          ...
          MR_hl_field(1, Var_17, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[7])));
        }
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13;
              MR_Word Var_118;
              MR_String _ExtStr_12;

              parse_tree__file_names__ext_cur_ngs_extension_dir_3_p_0(ExtCurNgs_10, &_ExtStr_12, &SubDirName_13);
              {
                Var_118 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_118, 0) = ((MR_Box) (SubDirName_13));
              ...
              }
              {
                ...
                *DirNames_8 = base;
                ...
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_118));
              }
            }
            break;
        }
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_14) {
                ...
                case (MR_Integer) 3:
                  {
                    MR_String _ExtStr_154;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 632, &_ExtStr_154);
                    SubDirName_29 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_170;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 631, &_ExtStr_170);
                    SubDirName_29 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_172;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 630, &_ExtStr_172);
                    SubDirName_29 = (MR_String) "lib";
                  }
                  break;
              }
              ...
              case (MR_Integer) 2:
                {
                  ...
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_120);
                  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 726, &TargetArch_121);
                  {
                    Var_128 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_128, 0) = ((MR_Box) (SubDirName_40));
                    MR_hl_field(1, Var_128, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Var_126 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_126, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, Var_126, 1) = ((MR_Box) (Var_128));
                  }
                  {
                    Var_125 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_125, 0) = ((MR_Box) (TargetArch_121));
                    MR_hl_field(1, Var_125, 1) = ((MR_Box) (Var_126));
                  }
                  {
                    Var_124 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_124, 0) = ((MR_Box) (Grade_120));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_35, &SubDirName_37);
                  {
                    ...
                    MR_hl_field(1, Var_131, 0) = ((MR_Box) (SubDirName_37));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  switch (SubdirSetting_54) {
                    ...
                    case (MR_Integer) 2:
                      {
                        MR_String Grade_133;
                        MR_String TargetArch_134;
                        MR_Word Var_137;
                        MR_Word Var_138;

                        libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_133);
                        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 726, &TargetArch_134);
                        {
                          Var_138 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_138, 0) = ((MR_Box) (TargetArch_134));
                          MR_hl_field(1, Var_138, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3])));
                        }
                        {
                          Var_137 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_137, 0) = ((MR_Box) (Grade_133));
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (SubdirSetting_68) {
                  ...
                  case (MR_Integer) 2:
                  case (MR_Integer) 1:
                    *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0((MR_String) "mhs");
                    break;
                }
              }
              break;
                ...
                switch (SubdirSetting_85) {
                  ...
                  case (MR_Integer) 2:
                    *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, (MR_String) "mihs");
                    break;
                  case (MR_Integer) 1:
                    *DirNames_8 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[5]));
                    break;
                }
              }
              break;
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (SubdirSetting_102) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_99 = ((&parse_tree__file_names_vector_common_4[112 + ExtCurNgsGsMaxNgs_22]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
                    ...
                    case (MR_Integer) 1:
                      {
...

                        {
                          ...
                          MR_hl_field(1, Var_150, 0) = ((MR_Box) (SubDirName_99));
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_96 = ((&parse_tree__file_names_vector_common_4[117 + ExtCurNgsGsMaxNgs_22]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_166 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[51 + ExtCur_166]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_25) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_27;
              MR_Word Var_82;
              MR_String _ExtStr_26;

              parse_tree__file_names__ext_cur_ngs_extension_dir_3_p_0(ExtCurNgs_24, &_ExtStr_26, &SubDirName_27);
              {
                Var_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_82, 0) = ((MR_Box) (SubDirName_27));
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurNgs_167 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[85 + ExtCurNgs_167]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_28) {
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 632, &_ExtStr_118);
                    SubDirName_42 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_134;

                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 631, &_ExtStr_134);
                    SubDirName_42 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_136;

                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 630, &_ExtStr_136);
                    SubDirName_42 = (MR_String) "lib";
                  }
                  break;
              }
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurGs_169 = ((MR_Unsigned) ((MR_hl_field(2, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        switch (ExtCurGs_169) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
        ...
        case (MR_Integer) 0:
          {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_84);
                  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 726, &TargetArch_85);
                  {
                    Var_92 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_92, 0) = ((MR_Box) (SubDirName_47));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_44, &SubDirName_45);
                  {
                    ...
                    MR_hl_field(1, Var_95, 0) = ((MR_Box) (SubDirName_45));
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGs_170 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 31);
            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_170, &ExtStr_18, &_SubDirName_176);
          }
          break;
        case (MR_Integer) 1:
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  switch (SubdirSetting_53) {
                    ...
                    case (MR_Integer) 2:
                      {
                        MR_String Grade_97;
                        MR_String TargetArch_98;
                        MR_Word Var_101;
                        MR_Word Var_102;

                        libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_97);
                        libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 726, &TargetArch_98);
                        {
                          Var_102 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_102, 0) = ((MR_Box) (TargetArch_98));
                          MR_hl_field(1, Var_102, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3])));
                        }
                        {
                          Var_101 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_101, 0) = ((MR_Box) (Grade_97));
        ...
        case (MR_Integer) 2:
          {
            ...
            *DirNames_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_33, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            ...
            ExtCurNgsGsJava_172 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_172) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  switch (SubdirSetting_56) {
                    ...
                    case (MR_Integer) 2:
                    case (MR_Integer) 1:
                      *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0((MR_String) "mhs");
                      break;
                  }
                }
                break;
                  ...
                  switch (SubdirSetting_61) {
                    ...
                    case (MR_Integer) 2:
                      *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, (MR_String) "mihs");
                      break;
                    case (MR_Integer) 1:
                      *DirNames_15 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[5]));
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (SubdirSetting_66) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_65 = ((&parse_tree__file_names_vector_common_4[97 + ExtCurNgsGsMaxNgs_36]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
                    ...
                    case (MR_Integer) 1:
                      {
...

                        {
                          ...
                          MR_hl_field(1, Var_114, 0) = ((MR_Box) (SubDirName_65));
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_63 = ((&parse_tree__file_names_vector_common_4[102 + ExtCurNgsGsMaxNgs_36]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGsMaxNgs_174 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[107 + ExtCurNgsGsMaxNgs_174]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
        ...
        case (MR_Integer) 5:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[46 + ExtCurNgsGsMaxNgs_15]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
