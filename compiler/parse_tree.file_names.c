...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[195];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[195] = {
  ...
  /* row 120 */   { (MR_String) ".opt" },
  /* row 121 */   { (MR_String) ".trans_opt" },
  /* row 122 */   { (MR_String) ".analysis" },
  /* row 123 */   { (MR_String) ".imdg" },
  /* row 124 */   { (MR_String) ".request" },
  /* row 125 */   { (MR_String) "int0s" },
  /* row 126 */   { (MR_String) "ints" },
  /* row 127 */   { (MR_String) "int2s" },
  /* row 128 */   { (MR_String) "int3s" },
  /* row 129 */   { (MR_String) "date0s" },
  /* row 130 */   { (MR_String) "dates" },
  /* row 131 */   { (MR_String) "date3s" },
  /* row 132 */   { (MR_String) "ds" },
  /* row 133 */   { (MR_String) "deps" },
  /* row 134 */   { (MR_String) "deps" },
  /* row 135 */   { (MR_String) "mbcs" },
  /* row 136 */   { (MR_String) "bytedebugs" },
  /* row 137 */   { (MR_String) "module_deps" },
  /* row 138 */   { (MR_String) "err_dates" },
  /* row 139 */   { (MR_String) "profs" },
  /* row 140 */   { (MR_String) ".mh" },
  /* row 141 */   { (MR_String) ".all_int3s" },
  /* row 142 */   { (MR_String) ".all_ints" },
  /* row 143 */   { (MR_String) ".all_opts" },
  /* row 144 */   { (MR_String) ".all_trans_opts" },
  /* row 145 */   { (MR_String) ".check" },
  /* row 146 */   { (MR_String) ".classes" },
  /* row 147 */   { (MR_String) ".clean" },
  /* row 148 */   { (MR_String) ".depend" },
  /* row 149 */   { (MR_String) ".install_grade_hdrs" },
  /* row 150 */   { (MR_String) ".install_hdrs" },
  /* row 151 */   { (MR_String) ".install_ints" },
  /* row 152 */   { (MR_String) ".install_opts" },
  /* row 153 */   { (MR_String) ".int3s" },
  /* row 154 */   { (MR_String) ".ints" },
  /* row 155 */   { (MR_String) ".javas" },
  /* row 156 */   { (MR_String) ".opts" },
  /* row 157 */   { (MR_String) ".realclean" },
  /* row 158 */   { (MR_String) ".trans_opts" },
  /* row 159 */   { (MR_String) ".defn_extents" },
  /* row 160 */   { (MR_String) ".defn_line_counts" },
  /* row 161 */   { (MR_String) ".defns" },
  /* row 162 */   { (MR_String) ".dependency_graph" },
  /* row 163 */   { (MR_String) ".err" },
  /* row 164 */   { (MR_String) ".hlds_dump" },
  /* row 165 */   { (MR_String) ".imports_graph" },
  /* row 166 */   { (MR_String) ".local_call_tree" },
  /* row 167 */   { (MR_String) ".local_call_tree_order" },
  /* row 168 */   { (MR_String) ".mlds_dump" },
  /* row 169 */   { (MR_String) ".mode_constraints" },
  /* row 170 */   { (MR_String) ".order" },
  /* row 171 */   { (MR_String) ".order_trans_opt" },
  /* row 172 */   { (MR_String) ".type_repns" },
  /* row 173 */   { (MR_String) ".ugly" },
  /* row 174 */   { (MR_String) ".xml" },
  /* row 175 */   { (MR_String) ".int0" },
  /* row 176 */   { (MR_String) ".int" },
  /* row 177 */   { (MR_String) ".int2" },
  /* row 178 */   { (MR_String) ".int3" },
  /* row 179 */   { (MR_String) ".date0" },
  /* row 180 */   { (MR_String) ".date" },
  /* row 181 */   { (MR_String) ".date3" },
  /* row 182 */   { (MR_String) ".d" },
  /* row 183 */   { (MR_String) ".dv" },
  /* row 184 */   { (MR_String) ".dep" },
  /* row 185 */   { (MR_String) ".mbc" },
  /* row 186 */   { (MR_String) ".bytedebug" },
  /* row 187 */   { (MR_String) ".module_dep" },
  /* row 188 */   { (MR_String) ".err_date" },
  /* row 189 */   { (MR_String) ".prof" },
  /* row 190 */   { (MR_String) ".opt" },
  /* row 191 */   { (MR_String) ".trans_opt" },
  /* row 192 */   { (MR_String) ".analysis" },
  /* row 193 */   { (MR_String) ".imdg" },
  /* row 194 */   { (MR_String) ".request" },
};
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[140 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[175 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[190 + ExtCurNgsGsMaxNgs_51]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13 = ((&parse_tree__file_names_vector_common_4[125 + ExtCurNgs_10]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_128;

              {
                Var_128 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_128, 0) = ((MR_Box) (SubDirName_13));
              ...
              }
              {
                ...
                *DirNames_8 = base;
                ...
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_128));
              }
            }
            break;
        }
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 616, &_ExtStr_132);
                    SubDirName_25 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 615, &_ExtStr_148);
                    SubDirName_25 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 614, &_ExtStr_150);
                    SubDirName_25 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_72);
              libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 709, &TargetArch_73);
              {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_33);
                }
                break;
            }
          }
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      MR_String _ExtStr_45;

                      parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_45, &SubDirName_47);
                      *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_47);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_42, &SubDirName_44);
                      *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_44);
                    }
                    break;
                }
              }
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_177 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[55 + ExtCur_177]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurNgs_178 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[105 + ExtCurNgs_178]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 616, &_ExtStr_119);
                    SubDirName_38 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 615, &_ExtStr_135);
                    SubDirName_38 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 614, &_ExtStr_137);
                    SubDirName_38 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_59);
              libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 709, &TargetArch_60);
              {
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurGs_180 = ((MR_Unsigned) ((MR_hl_field(2, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        switch (ExtCurGs_180) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
              ...
              case (MR_Integer) 1:
                {
                  ...
                  *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_41);
                }
                break;
            }
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGs_181 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 31);
            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_181, &ExtStr_18, &_SubDirName_186);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            *DirNames_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_31, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            ...
            ExtCurNgsGsJava_182 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_182) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_String _ExtStr_47;

                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_47, &SubDirName_48);
                        *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_48);
                      }
                      break;
                    case (MR_Integer) 1:
                      {
                        ...
                        parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(&_ExtStr_45, &SubDirName_46);
                        *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_46);
                      }
                      break;
                  }
                }
        ...
        case (MR_Integer) 3:
          {
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGsMaxNgs_184 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[120 + ExtCurNgsGsMaxNgs_184]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[50 + ExtCurNgsGsMaxNgs_14]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * Dir_8)
{
  switch (Ext_6) {
    ...
    case (MR_Integer) 17:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 563, &Str0_9);
    ...
    case (MR_Integer) 18:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 564, &Str0_16);
    ...
    case (MR_Integer) 12:
      {
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 563, Str_7);
        *Dir_8 = (MR_String) "os";
      }
      break;
    case (MR_Integer) 11:
    ...
    case (MR_Integer) 13:
      {
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 564, Str_7);
        *Dir_8 = (MR_String) "os";
      }
      break;
    case (MR_Integer) 0:
