...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_36;

static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_37;

static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_38;

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_0[39];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_0[39];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_0[39];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[98];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_5_0_s parse_tree__file_names_vector_common_5[20];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[98] = {
  ...
  /* row  23 */   { (MR_String) ".defn_extents" },
  /* row  24 */   { (MR_String) ".defn_line_counts" },
  /* row  25 */   { (MR_String) ".defns" },
  /* row  26 */   { (MR_String) ".dependency_graph" },
  /* row  27 */   { (MR_String) ".err" },
  /* row  28 */   { (MR_String) ".hlds_dump" },
  /* row  29 */   { (MR_String) ".imports_graph" },
  /* row  30 */   { (MR_String) ".local_call_tree" },
  /* row  31 */   { (MR_String) ".local_call_tree_order" },
  /* row  32 */   { (MR_String) ".mlds_dump" },
  /* row  33 */   { (MR_String) ".mode_constraints" },
  /* row  34 */   { (MR_String) ".order" },
  /* row  35 */   { (MR_String) ".order_trans_opt" },
  /* row  36 */   { (MR_String) ".type_repns" },
  /* row  37 */   { (MR_String) ".ugly" },
  /* row  38 */   { (MR_String) ".xml" },
  /* row  39 */   { (MR_String) ".int0" },
  /* row  40 */   { (MR_String) ".int" },
  /* row  41 */   { (MR_String) ".int2" },
  /* row  42 */   { (MR_String) ".int3" },
  /* row  43 */   { (MR_String) ".date0" },
  /* row  44 */   { (MR_String) ".date" },
  /* row  45 */   { (MR_String) ".date3" },
  /* row  46 */   { (MR_String) ".d" },
  /* row  47 */   { (MR_String) ".dv" },
  /* row  48 */   { (MR_String) ".dep" },
  /* row  49 */   { (MR_String) ".mbc" },
  /* row  50 */   { (MR_String) ".bytedebug" },
  /* row  51 */   { (MR_String) ".module_dep" },
  /* row  52 */   { (MR_String) ".err_date" },
  /* row  53 */   { (MR_String) ".prof" },
  /* row  54 */   { (MR_String) ".opt" },
  /* row  55 */   { (MR_String) ".trans_opt" },
  /* row  56 */   { (MR_String) ".analysis" },
  /* row  57 */   { (MR_String) ".imdg" },
  /* row  58 */   { (MR_String) ".request" },
  /* row  59 */   { (MR_String) ".exe" },
  /* row  60 */   { (MR_String) ".\044(EXT_FOR_SHARED_LIB)" },
  /* row  61 */   { (MR_String) ".lib" },
  /* row  62 */   { (MR_String) ".so" },
  /* row  63 */   { (MR_String) ".mh" },
  /* row  64 */   { (MR_String) ".all_int3s" },
  /* row  65 */   { (MR_String) ".all_ints" },
  /* row  66 */   { (MR_String) ".all_opts" },
  /* row  67 */   { (MR_String) ".all_trans_opts" },
  /* row  68 */   { (MR_String) ".check" },
  /* row  69 */   { (MR_String) ".classes" },
  /* row  70 */   { (MR_String) ".clean" },
  /* row  71 */   { (MR_String) ".depend" },
  /* row  72 */   { (MR_String) ".install_grade_hdrs" },
  /* row  73 */   { (MR_String) ".install_hdrs" },
  /* row  74 */   { (MR_String) ".install_ints" },
  /* row  75 */   { (MR_String) ".install_opts" },
  /* row  76 */   { (MR_String) ".int3s" },
  /* row  77 */   { (MR_String) ".ints" },
  /* row  78 */   { (MR_String) ".javas" },
  /* row  79 */   { (MR_String) ".opts" },
  /* row  80 */   { (MR_String) ".realclean" },
  /* row  81 */   { (MR_String) ".trans_opts" },
  /* row  82 */   { (MR_String) ".defn_extents" },
  /* row  83 */   { (MR_String) ".defn_line_counts" },
  /* row  84 */   { (MR_String) ".defns" },
  /* row  85 */   { (MR_String) ".dependency_graph" },
  /* row  86 */   { (MR_String) ".err" },
  /* row  87 */   { (MR_String) ".hlds_dump" },
  /* row  88 */   { (MR_String) ".imports_graph" },
  /* row  89 */   { (MR_String) ".local_call_tree" },
  /* row  90 */   { (MR_String) ".local_call_tree_order" },
  /* row  91 */   { (MR_String) ".mlds_dump" },
  /* row  92 */   { (MR_String) ".mode_constraints" },
  /* row  93 */   { (MR_String) ".order" },
  /* row  94 */   { (MR_String) ".order_trans_opt" },
  /* row  95 */   { (MR_String) ".type_repns" },
  /* row  96 */   { (MR_String) ".ugly" },
  /* row  97 */   { (MR_String) ".xml" },
};
...
#line 1307 "file_names.m"
void 
parse_tree__file_names__user_init_pred_194_0(void)
#line 1307 "file_names.m"
{
#line 1307 "file_names.m"
...
#line 1406 "file_names.m"
void 
parse_tree__file_names__user_init_pred_204_0(void)
#line 1406 "file_names.m"
{
#line 1406 "file_names.m"
...
#line 1432 "file_names.m"
void 
parse_tree__file_names__user_init_pred_207_0(void)
#line 1432 "file_names.m"
{
#line 1432 "file_names.m"
...
#line 1434 "file_names.m"
void 
parse_tree__file_names__user_init_pred_208_0(void)
#line 1434 "file_names.m"
{
#line 1434 "file_names.m"
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_0[39] = {
  ...
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_36,
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_37,
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_0_38
};
  ...
  MR_String * CurDirFileName_16)
{
  ...
  switch (MR_tag((MR_Word) Ext_13)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ExtCur_17 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);

        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[59 + ExtCur_17]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
    ...
    case (MR_Integer) 1:
      {
        MR_Word ExtCurNgs_20 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        MR_String SubDirName_21;
        MR_Word SubdirSetting_22;

        ExtStr_18 = ((&parse_tree__file_names_vector_common_5[0 + ExtCurNgs_20]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
        SubDirName_21 = ((&parse_tree__file_names_vector_common_5[0 + ExtCurNgs_20]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_1;
        BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_18 = ((&parse_tree__file_names_vector_common_5[15 + ExtCurNgsGsMaxNgs_29]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
            SubDirName_77 = ((&parse_tree__file_names_vector_common_5[15 + ExtCurNgsGsMaxNgs_29]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_1;
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
    ...
    case (MR_Integer) 1:
      {
        ...
        ExtStr_6 = ((&parse_tree__file_names_vector_common_4[39 + ExtCurNgs_8]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[54 + ExtCurNgsGsMaxNgs_15]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
...
{
	parse_tree__file_names__user_init_pred_194_0();
	parse_tree__file_names__user_init_pred_204_0();
	parse_tree__file_names__user_init_pred_207_0();
	parse_tree__file_names__user_init_pred_208_0();
}
