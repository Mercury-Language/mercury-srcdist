...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 634, &parse_tree__file_names__UseSubdirs_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 635, &parse_tree__file_names__UseGradeSubdirs_21);
    }
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 563, &parse_tree__file_names__LibExt_22);
    }
    {
      libs__globals__lookup_string_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 562, &parse_tree__file_names__SharedLibExt_23);
    }
        ...
        if (parse_tree__file_names__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 635, &parse_tree__file_names__UseGradeSubdirs_65);
            }
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 634, &parse_tree__file_names__UseSubdirs_66);
            }
            ...
            if (parse_tree__file_names__succeeded)
              {
                ...
                {
                  libs__globals__lookup_string_option_3_p_0(parse_tree__file_names__Globals_11, (MR_Integer) 653, &parse_tree__file_names__TargetArch_68);
                }
                {
              ...
              {
                {
                  ...
                  {
                    libs__globals__lookup_string_option_3_p_0((parse_tree__file_names__env).parse_tree__file_names__file_is_arch_or_grade_dependent_2_p_0_env_0__Globals_1, (MR_Integer) 564, &parse_tree__file_names__V_21_21);
                  }
                  ...
                  {
                    {
                      ...
                      {
                        libs__globals__lookup_string_option_3_p_0((parse_tree__file_names__env).parse_tree__file_names__file_is_arch_or_grade_dependent_2_p_0_env_0__Globals_1, (MR_Integer) 563, &parse_tree__file_names__V_22_22);
                      }
                    ...
                    if (!((parse_tree__file_names__env).parse_tree__file_names__file_is_arch_or_grade_dependent_2_p_0_env_0__succeeded))
                      {
                        ...
                        {
                          libs__globals__lookup_string_option_3_p_0((parse_tree__file_names__env).parse_tree__file_names__file_is_arch_or_grade_dependent_2_p_0_env_0__Globals_1, (MR_Integer) 562, &parse_tree__file_names__V_23_23);
                        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_10, (MR_Integer) 635, &parse_tree__file_names__UseGradeSubdirs_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_10, (MR_Integer) 634, &parse_tree__file_names__UseSubdirs_19);
    }
    ...
    if (parse_tree__file_names__succeeded)
      {
        ...
        {
          libs__globals__lookup_string_option_3_p_0(parse_tree__file_names__Globals_10, (MR_Integer) 653, &parse_tree__file_names__TargetArch_21);
        }
        {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_3, (MR_Integer) 635, &parse_tree__file_names__UseGradeSubdirs_5);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__file_names__Globals_3, (MR_Integer) 634, &parse_tree__file_names__UseSubdirs_6);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_string_option_3_p_0(parse_tree__file_names__Globals_3, (MR_Integer) 653, &parse_tree__file_names__TargetArch_8);
          }
          {
