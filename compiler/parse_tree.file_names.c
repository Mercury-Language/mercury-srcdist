...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_gas_0_9;

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_gas_0[10];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_gas_0[10];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_gas_0[10];
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_gs_0[2];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_gs_0[2];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_gs_0[2];
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_gs_0[13];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_gs_0[13];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_gs_0[13];
...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_max_cur_0_0;

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_max_cur_0[1];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_max_cur_0[1];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_max_cur_0[1];
...
static void MR_CALL 
parse_tree__file_names__make_gs_dir_names_4_p_0(
  MR_Word Globals_5,
  MR_String SubDirName_6,
  MR_Word * GsSubDirNamesLegacy_7,
  MR_Word * GsSubDirNamesProposed_8);
...
static MR_bool MR_CALL 
parse_tree__file_names____Unify____ext_cur_ngs_max_cur_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__file_names____Compare____ext_cur_ngs_max_cur_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static /* final */ const MR_Box parse_tree__file_names_scalar_common_2[5][2];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[226];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_5_0_s parse_tree__file_names_vector_common_5[12];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[226] = {
  ...
  /* row  11 */   { (MR_String) ".order" },
  /* row  12 */   { (MR_String) ".order_trans_opt" },
  /* row  13 */   { (MR_String) ".type_repns" },
  /* row  14 */   { (MR_String) ".ugly" },
  /* row  15 */   { (MR_String) ".xml" },
  /* row  16 */   { (MR_String) ".int0" },
  /* row  17 */   { (MR_String) ".int" },
  /* row  18 */   { (MR_String) ".int2" },
  /* row  19 */   { (MR_String) ".int3" },
  /* row  20 */   { (MR_String) ".date0" },
  /* row  21 */   { (MR_String) ".date" },
  /* row  22 */   { (MR_String) ".date3" },
  /* row  23 */   { (MR_String) ".d" },
  /* row  24 */   { (MR_String) ".dv" },
  /* row  25 */   { (MR_String) ".dep" },
  /* row  26 */   { (MR_String) ".module_dep" },
  /* row  27 */   { (MR_String) ".prof" },
  /* row  28 */   { (MR_String) ".optdate" },
  /* row  29 */   { (MR_String) ".trans_opt_date" },
  /* row  30 */   { (MR_String) ".c" },
  /* row  31 */   { (MR_String) ".cs" },
  /* row  32 */   { (MR_String) ".c_date" },
  /* row  33 */   { (MR_String) ".cs_date" },
  /* row  34 */   { (MR_String) ".java_date" },
  /* row  35 */   { (MR_String) "_init.c" },
  /* row  36 */   { (MR_String) ".analysis_date" },
  /* row  37 */   { (MR_String) ".analysis_status" },
  /* row  38 */   { (MR_String) ".err_date" },
  /* row  39 */   { (MR_String) ".used" },
  /* row  40 */   { (MR_String) ".track_flags" },
  /* row  41 */   { (MR_String) ".opt" },
  /* row  42 */   { (MR_String) ".trans_opt" },
  /* row  43 */   { (MR_String) ".analysis" },
  /* row  44 */   { (MR_String) ".imdg" },
  /* row  45 */   { (MR_String) ".request" },
  /* row  46 */   { (MR_String) ".defn_extents" },
  /* row  47 */   { (MR_String) ".defn_line_counts" },
  /* row  48 */   { (MR_String) ".defns" },
  /* row  49 */   { (MR_String) ".dependency_graph" },
  /* row  50 */   { (MR_String) ".hlds_dump" },
  /* row  51 */   { (MR_String) ".imports_graph" },
  /* row  52 */   { (MR_String) ".local_call_tree" },
  /* row  53 */   { (MR_String) ".local_call_tree_full" },
  /* row  54 */   { (MR_String) ".local_call_tree_order" },
  /* row  55 */   { (MR_String) ".mlds_dump" },
  /* row  56 */   { (MR_String) ".mode_constraints" },
  /* row  57 */   { (MR_String) ".order" },
  /* row  58 */   { (MR_String) ".order_trans_opt" },
  /* row  59 */   { (MR_String) ".type_repns" },
  /* row  60 */   { (MR_String) ".ugly" },
  /* row  61 */   { (MR_String) ".xml" },
  /* row  62 */   { (MR_String) ".int0" },
  /* row  63 */   { (MR_String) ".int" },
  /* row  64 */   { (MR_String) ".int2" },
  /* row  65 */   { (MR_String) ".int3" },
  /* row  66 */   { (MR_String) ".date0" },
  /* row  67 */   { (MR_String) ".date" },
  /* row  68 */   { (MR_String) ".date3" },
  /* row  69 */   { (MR_String) ".d" },
  /* row  70 */   { (MR_String) ".dv" },
  /* row  71 */   { (MR_String) ".dep" },
  /* row  72 */   { (MR_String) ".module_dep" },
  /* row  73 */   { (MR_String) ".prof" },
  /* row  74 */   { (MR_String) "optdates" },
  /* row  75 */   { (MR_String) "trans_opt_dates" },
  /* row  76 */   { (MR_String) "cs" },
  /* row  77 */   { (MR_String) "css" },
  /* row  78 */   { (MR_String) "c_dates" },
  /* row  79 */   { (MR_String) "cs_dates" },
  /* row  80 */   { (MR_String) "java_dates" },
  /* row  81 */   { (MR_String) "cs" },
  /* row  82 */   { (MR_String) "analysis_dates" },
  /* row  83 */   { (MR_String) "analysis_statuss" },
  /* row  84 */   { (MR_String) "err_dates" },
  /* row  85 */   { (MR_String) "useds" },
  /* row  86 */   { (MR_String) "track_flags" },
  /* row  87 */   { (MR_String) "optdates" },
  /* row  88 */   { (MR_String) "trans_opt_dates" },
  /* row  89 */   { (MR_String) "cs" },
  /* row  90 */   { (MR_String) "css" },
  /* row  91 */   { (MR_String) "c_dates" },
  /* row  92 */   { (MR_String) "cs_dates" },
  /* row  93 */   { (MR_String) "java_dates" },
  /* row  94 */   { (MR_String) "cs" },
  /* row  95 */   { (MR_String) "analysis_dates" },
  /* row  96 */   { (MR_String) "analysis_statuss" },
  /* row  97 */   { (MR_String) "err_dates" },
  /* row  98 */   { (MR_String) "useds" },
  /* row  99 */   { (MR_String) "track_flags" },
  /* row 100 */   { (MR_String) ".optdate" },
  /* row 101 */   { (MR_String) ".trans_opt_date" },
  /* row 102 */   { (MR_String) ".c" },
  /* row 103 */   { (MR_String) ".cs" },
  /* row 104 */   { (MR_String) ".c_date" },
  /* row 105 */   { (MR_String) ".cs_date" },
  /* row 106 */   { (MR_String) ".java_date" },
  /* row 107 */   { (MR_String) "_init.c" },
  /* row 108 */   { (MR_String) ".analysis_date" },
  /* row 109 */   { (MR_String) ".analysis_status" },
  /* row 110 */   { (MR_String) ".err_date" },
  /* row 111 */   { (MR_String) ".used" },
  /* row 112 */   { (MR_String) ".track_flags" },
  /* row 113 */   { (MR_String) "opts" },
  /* row 114 */   { (MR_String) "trans_opts" },
  /* row 115 */   { (MR_String) "analyses" },
  /* row 116 */   { (MR_String) "imdgs" },
  /* row 117 */   { (MR_String) "requests" },
  /* row 118 */   { (MR_String) "opts" },
  /* row 119 */   { (MR_String) "trans_opts" },
  /* row 120 */   { (MR_String) "analyses" },
  /* row 121 */   { (MR_String) "imdgs" },
  /* row 122 */   { (MR_String) "requests" },
  /* row 123 */   { (MR_String) ".opt" },
  /* row 124 */   { (MR_String) ".trans_opt" },
  /* row 125 */   { (MR_String) ".analysis" },
  /* row 126 */   { (MR_String) ".imdg" },
  /* row 127 */   { (MR_String) ".request" },
  /* row 128 */   { (MR_String) ".defn_extents" },
  /* row 129 */   { (MR_String) ".defn_line_counts" },
  /* row 130 */   { (MR_String) ".defns" },
  /* row 131 */   { (MR_String) ".dependency_graph" },
  /* row 132 */   { (MR_String) ".hlds_dump" },
  /* row 133 */   { (MR_String) ".imports_graph" },
  /* row 134 */   { (MR_String) ".local_call_tree" },
  /* row 135 */   { (MR_String) ".local_call_tree_full" },
  /* row 136 */   { (MR_String) ".local_call_tree_order" },
  /* row 137 */   { (MR_String) ".mlds_dump" },
  /* row 138 */   { (MR_String) ".mode_constraints" },
  /* row 139 */   { (MR_String) ".order" },
  /* row 140 */   { (MR_String) ".order_trans_opt" },
  /* row 141 */   { (MR_String) ".type_repns" },
  /* row 142 */   { (MR_String) ".ugly" },
  /* row 143 */   { (MR_String) ".xml" },
  /* row 144 */   { (MR_String) "optdates" },
  /* row 145 */   { (MR_String) "trans_opt_dates" },
  /* row 146 */   { (MR_String) "cs" },
  /* row 147 */   { (MR_String) "css" },
  /* row 148 */   { (MR_String) "c_dates" },
  /* row 149 */   { (MR_String) "cs_dates" },
  /* row 150 */   { (MR_String) "java_dates" },
  /* row 151 */   { (MR_String) "cs" },
  /* row 152 */   { (MR_String) "analysis_dates" },
  /* row 153 */   { (MR_String) "analysis_statuss" },
  /* row 154 */   { (MR_String) "err_dates" },
  /* row 155 */   { (MR_String) "useds" },
  /* row 156 */   { (MR_String) "track_flags" },
  /* row 157 */   { (MR_String) "optdates" },
  /* row 158 */   { (MR_String) "trans_opt_dates" },
  /* row 159 */   { (MR_String) "cs" },
  /* row 160 */   { (MR_String) "css" },
  /* row 161 */   { (MR_String) "c_dates" },
  /* row 162 */   { (MR_String) "cs_dates" },
  /* row 163 */   { (MR_String) "java_dates" },
  /* row 164 */   { (MR_String) "cs" },
  /* row 165 */   { (MR_String) "analysis_dates" },
  /* row 166 */   { (MR_String) "analysis_statuss" },
  /* row 167 */   { (MR_String) "err_dates" },
  /* row 168 */   { (MR_String) "useds" },
  /* row 169 */   { (MR_String) "track_flags" },
  /* row 170 */   { (MR_String) "opts" },
  /* row 171 */   { (MR_String) "trans_opts" },
  /* row 172 */   { (MR_String) "analyses" },
  /* row 173 */   { (MR_String) "imdgs" },
  /* row 174 */   { (MR_String) "requests" },
  /* row 175 */   { (MR_String) "opts" },
  /* row 176 */   { (MR_String) "trans_opts" },
  /* row 177 */   { (MR_String) "analyses" },
  /* row 178 */   { (MR_String) "imdgs" },
  /* row 179 */   { (MR_String) "requests" },
  /* row 180 */   { (MR_String) ".defn_extents" },
  /* row 181 */   { (MR_String) ".defn_line_counts" },
  /* row 182 */   { (MR_String) ".defns" },
  /* row 183 */   { (MR_String) ".dependency_graph" },
  /* row 184 */   { (MR_String) ".hlds_dump" },
  /* row 185 */   { (MR_String) ".imports_graph" },
  /* row 186 */   { (MR_String) ".local_call_tree" },
  /* row 187 */   { (MR_String) ".local_call_tree_full" },
  /* row 188 */   { (MR_String) ".local_call_tree_order" },
  /* row 189 */   { (MR_String) ".mlds_dump" },
  /* row 190 */   { (MR_String) ".mode_constraints" },
  /* row 191 */   { (MR_String) ".order" },
  /* row 192 */   { (MR_String) ".order_trans_opt" },
  /* row 193 */   { (MR_String) ".type_repns" },
  /* row 194 */   { (MR_String) ".ugly" },
  /* row 195 */   { (MR_String) ".xml" },
  /* row 196 */   { (MR_String) ".int0" },
  /* row 197 */   { (MR_String) ".int" },
  /* row 198 */   { (MR_String) ".int2" },
  /* row 199 */   { (MR_String) ".int3" },
  /* row 200 */   { (MR_String) ".date0" },
  /* row 201 */   { (MR_String) ".date" },
  /* row 202 */   { (MR_String) ".date3" },
  /* row 203 */   { (MR_String) ".d" },
  /* row 204 */   { (MR_String) ".dv" },
  /* row 205 */   { (MR_String) ".dep" },
  /* row 206 */   { (MR_String) ".module_dep" },
  /* row 207 */   { (MR_String) ".prof" },
  /* row 208 */   { (MR_String) ".optdate" },
  /* row 209 */   { (MR_String) ".trans_opt_date" },
  /* row 210 */   { (MR_String) ".c" },
  /* row 211 */   { (MR_String) ".cs" },
  /* row 212 */   { (MR_String) ".c_date" },
  /* row 213 */   { (MR_String) ".cs_date" },
  /* row 214 */   { (MR_String) ".java_date" },
  /* row 215 */   { (MR_String) "_init.c" },
  /* row 216 */   { (MR_String) ".analysis_date" },
  /* row 217 */   { (MR_String) ".analysis_status" },
  /* row 218 */   { (MR_String) ".err_date" },
  /* row 219 */   { (MR_String) ".used" },
  /* row 220 */   { (MR_String) ".track_flags" },
  /* row 221 */   { (MR_String) ".opt" },
  /* row 222 */   { (MR_String) ".trans_opt" },
  /* row 223 */   { (MR_String) ".analysis" },
  /* row 224 */   { (MR_String) ".imdg" },
  /* row 225 */   { (MR_String) ".request" },
};
...
#line 1583 "file_names.m"
void 
parse_tree__file_names__user_init_pred_136_0(void)
#line 1583 "file_names.m"
{
#line 1583 "file_names.m"
...
#line 1687 "file_names.m"
void 
parse_tree__file_names__user_init_pred_146_0(void)
#line 1687 "file_names.m"
{
#line 1687 "file_names.m"
...
#line 1713 "file_names.m"
void 
parse_tree__file_names__user_init_pred_149_0(void)
#line 1713 "file_names.m"
{
#line 1713 "file_names.m"
...
#line 1715 "file_names.m"
void 
parse_tree__file_names__user_init_pred_150_0(void)
#line 1715 "file_names.m"
{
#line 1715 "file_names.m"
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_8[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_max_cur_0) };
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_gas_0[10] = {
  ...
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_gas_0_9
};
...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_max_cur_0_0 = {
  (MR_String) "ext_cur_ngs_max_cur_mh",
  INT32_C(0)
};

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_max_cur_0[1] = { &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_max_cur_0_0 };

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_max_cur_0[1] = { &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_max_cur_0_0 };

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_max_cur_0[1] = { (MR_Integer) 0 };

const MR_TypeCtorInfo_Struct parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_max_cur_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(-1),
  MR_TYPECTOR_REP_DUMMY,
  ((MR_Box) (parse_tree__file_names____Unify____ext_cur_ngs_max_cur_0_0_10001)),
  ((MR_Box) (parse_tree__file_names____Compare____ext_cur_ngs_max_cur_0_0_10001)),
  (MR_String) "parse_tree.file_names",
  (MR_String) "ext_cur_ngs_max_cur",
  { parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_max_cur_0 },
  { parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_max_cur_0 },
  (MR_Integer) 1,
  UINT16_C(12),
  parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_max_cur_0,
...
void MR_CALL 
parse_tree__file_names____Compare____ext_cur_ngs_max_cur_0_0(
  MR_Word * HeadVar__1_1)
{
  parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_95_95_67_111_109_112_97_114_101_95_95_95_112_97_114_115_101_95_116_114_101_101_95_95_102_105_108_101_95_110_97_109_101_115_95_95_101_120_116_95_99_117_114_95_110_103_115_95_109_97_120_95_99_117_114_95_48_95_95_91_50_44_32_51_93_95_48_3_p_0(HeadVar__1_1);
}
...
MR_bool MR_CALL 
parse_tree__file_names____Unify____ext_cur_ngs_max_cur_0_0(void)
{
  return MR_TRUE;
}
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word ArgX1_10 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 15);
                      MR_Word ArgY1_11 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word ArgX1_12 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 15);
                      MR_Word ArgY1_13 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Word ArgX1_14 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 15);
                      MR_Word ArgY1_15 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 4:
                    {
                      MR_Word ArgX1_18 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
                      MR_Word ArgY1_19 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 1);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 7:
                    {
                      MR_Word ArgX1_24 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 7);
                      MR_Word ArgY1_25 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 7);
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgX1_9 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 15);
              MR_Word ArgY1_10;

              succeeded = ((((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                ArgY1_10 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 1:
            {
              MR_Word ArgX1_11 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 15);
              MR_Word ArgY1_12;

              succeeded = ((((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                ArgY1_12 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 15);
  ...
  MR_Word * STATE_VARIABLE_ExtSchDirMap_38)
{
  ...
  *STATE_VARIABLE_NumLookups_34 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumLookups_0_33 + (MR_Unsigned) Count_20);
  ...
  switch (MR_tag((MR_Word) Ext_22)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ExtCur_44 = ((MR_Unsigned) ((MR_hl_field(0, Ext_22, (MR_Integer) 0))) & (MR_Integer) 15);

        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[180 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[196 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_47 = ((MR_Unsigned) ((MR_hl_field(2, Ext_22, (MR_Integer) 0))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_22, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ExtCurGas_48 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (ExtCurGas_48) {
              ...
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 3:
                libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 633, &ExtStr0_25);
                break;
              case (MR_Integer) 0:
              ...
              case (MR_Integer) 4:
                ...
                break;
              case (MR_Integer) 8:
                libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 632, &ExtStr0_25);
                break;
              case (MR_Integer) 9:
                libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 631, &ExtStr0_25);
                break;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ExtCurNgsGs_49 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 15);

            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[208 + ExtCurNgsGs_49]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGas_50 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 15);

            switch (ExtCurNgsGas_50) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 6:
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 580, &Str0_104);
                  ExtStr0_25 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_104);
                }
                break;
              case (MR_Integer) 8:
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 581, &Str0_111);
                  ExtStr0_25 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_111);
                }
                break;
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 4:
                libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 580, &ExtStr0_25);
                break;
              case (MR_Integer) 3:
                ExtStr0_25 = (MR_String) ".pic_o";
                break;
              case (MR_Integer) 5:
                libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 581, &ExtStr0_25);
                break;
            }
          }
          break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsJava_52 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 1);

            switch (ExtCurNgsGsJava_52) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 7:
          {
            MR_Word ExtCurNgsGsMaxNgs_54 = ((MR_Unsigned) ((MR_hl_field(3, Ext_22, (MR_Integer) 1))) & (MR_Integer) 7);

            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[221 + ExtCurNgsGsMaxNgs_54]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * DirNameProposed_6)
{
  ...
  switch (SubdirSetting_7) {
    ...
    case (MR_Integer) 1:
      {
        DirComponentsLegacy_8 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3]));
        DirComponentsProposed_9 = (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[4]));
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        libs__compute_grade__grade_directory_component_2_p_0(Globals_4, &Grade_18);
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 727, &TargetArch_19);
        {
          Var_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_23, 0) = ((MR_Box) (TargetArch_19));
          MR_hl_field(1, Var_23, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[3])));
        }
        {
  ...
  MR_Word * DirNamesProposed_10)
{
  switch (MR_tag((MR_Word) Ext_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ExtCurNgs_12 = ((MR_Unsigned) ((MR_hl_field(1, Ext_8, (MR_Integer) 0))) & (MR_Integer) 15);
    ...
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_16 = ((MR_Unsigned) ((MR_hl_field(2, Ext_8, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word SubdirSetting_40;

        libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_40);
        switch (SubdirSetting_40) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              MR_String SubDirName_37;
              MR_String Grade_149;
              MR_String TargetArch_150;
              MR_Word Var_153;
              MR_Word Var_154;
              MR_Word Var_155;
              MR_Word Var_157;
              ...
              switch (ExtCurGs_16) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  SubDirName_37 = (MR_String) "inits";
                  break;
                case (MR_Integer) 1:
                  SubDirName_37 = (MR_String) "lib";
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_6, &Grade_149);
              libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 727, &TargetArch_150);
              {
                Var_157 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_157, 0) = ((MR_Box) (SubDirName_37));
              ...
              }
              {
                ...
                MR_hl_field(1, Var_160, 0) = ((MR_Box) (SubDirName_37));
              ...
              }
              {
                ...
                *DirNamesProposed_10 = base;
                ...
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_160));
              }
            }
            break;
        }
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_8, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word ExtCurGas_17 = ((MR_Unsigned) ((MR_hl_field(3, Ext_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_48;

            libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_48);
            switch (SubdirSetting_48) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
              case (MR_Integer) 1:
                {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_45;
                  MR_String Grade_134;
                  MR_String TargetArch_135;
                  MR_Word Var_138;
                  MR_Word Var_139;
                  MR_Word Var_140;
                  MR_Word Var_142;
                  ...
                  switch (ExtCurGas_17) {
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_String _ExtStr_165;

                        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 633, &_ExtStr_165);
                        SubDirName_45 = (MR_String) "bin";
                      }
                      break;
                    case (MR_Integer) 0:
                    ...
                    case (MR_Integer) 8:
                      {
                        MR_String _ExtStr_177;

                        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 632, &_ExtStr_177);
                        SubDirName_45 = (MR_String) "lib";
                      }
                      break;
                    case (MR_Integer) 9:
                      {
                        MR_String _ExtStr_179;

                        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 631, &_ExtStr_179);
                        SubDirName_45 = (MR_String) "lib";
                      }
                      break;
                  }
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_6, &Grade_134);
                  libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 727, &TargetArch_135);
                  {
                    Var_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_142, 0) = ((MR_Box) (SubDirName_45));
                  ...
                  }
                  {
                    ...
                    *DirNamesLegacy_9 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, base, 1) = ((MR_Box) (Var_138));
                  }
                  {
                    Var_147 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_147, 0) = ((MR_Box) (TargetArch_135));
                  ...
                  }
                  {
                    ...
                    *DirNamesProposed_10 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "MercurySystem"));
                    MR_hl_field(1, base, 1) = ((MR_Box) (Var_145));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 1:
          {
            MR_Word ExtCurNgsGs_18 = ((MR_Unsigned) ((MR_hl_field(3, Ext_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_59;

            libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_59);
            switch (SubdirSetting_59) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_56 = ((&parse_tree__file_names_vector_common_4[144 + ExtCurNgsGs_18]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_6, SubDirName_56, DirNamesLegacy_9, DirNamesProposed_10);
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_53 = ((&parse_tree__file_names_vector_common_4[157 + ExtCurNgsGs_18]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_53, DirNamesLegacy_9, DirNamesProposed_10);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGas_19 = ((MR_Unsigned) ((MR_hl_field(3, Ext_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_70;

            libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_70);
            switch (SubdirSetting_70) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gas_extension_dir_4_p_0(Globals_6, ExtCurNgsGas_19, &_ExtStr_65, &SubDirName_67);
                  parse_tree__file_names__make_gas_dir_names_4_p_0(Globals_6, SubDirName_67, DirNamesLegacy_9, DirNamesProposed_10);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gas_extension_dir_4_p_0(Globals_6, ExtCurNgsGas_19, &_ExtStr_62, &SubDirName_64);
                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_64, DirNamesLegacy_9, DirNamesProposed_10);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 3:
          {
            MR_Word ErrorFilesInSubdir_21;

            libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 708, &ErrorFilesInSubdir_21);
            switch (ErrorFilesInSubdir_21) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 1:
                {
                  MR_Word SubdirSetting_81;

                  libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_81);
                  switch (SubdirSetting_81) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
                      ...
                      break;
                    case (MR_Integer) 2:
                      parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_6, (MR_String) "errs", DirNamesLegacy_9, DirNamesProposed_10);
                      break;
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "errs", DirNamesLegacy_9, DirNamesProposed_10);
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsJava_22 = ((MR_Unsigned) ((MR_hl_field(3, Ext_8, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word DirNamesLegacy0_23;
            MR_Word DirNamesProposed0_24;

            parse_tree__file_names__get_java_dir_path_4_p_0(Globals_6, ExtCurNgsGsJava_22, &DirNamesLegacy0_23, &DirNamesProposed0_24);
            *DirNamesLegacy_9 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNamesLegacy0_23, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            *DirNamesProposed_10 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNamesProposed0_24, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
          }
          break;
        case (MR_Integer) 5:
          switch (Search_7) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word SubdirSetting_95;

                libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_95);
                switch (SubdirSetting_95) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
                  ...
                  case (MR_Integer) 2:
                  case (MR_Integer) 1:
                    parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "mhs", DirNamesLegacy_9, DirNamesProposed_10);
                    break;
                }
              }
              break;
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_112);
                switch (SubdirSetting_112) {
                  ...
                  case (MR_Integer) 0:
                    ...
                    break;
                  case (MR_Integer) 2:
                    parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_6, (MR_String) "mihs", DirNamesLegacy_9, DirNamesProposed_10);
                    break;
                  case (MR_Integer) 1:
                    parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "mihs", DirNamesLegacy_9, DirNamesProposed_10);
                    break;
                }
              }
              break;
        ...
        case (MR_Integer) 7:
          {
            MR_Word ExtCurNgsGsMaxNgs_27 = ((MR_Unsigned) ((MR_hl_field(3, Ext_8, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_129;

            libs__globals__get_subdir_setting_2_p_0(Globals_6, &SubdirSetting_129);
            switch (SubdirSetting_129) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_9 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_126 = ((&parse_tree__file_names_vector_common_4[170 + ExtCurNgsGsMaxNgs_27]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  switch (Search_7) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_126, DirNamesLegacy_9, DirNamesProposed_10);
                      break;
                    case (MR_Integer) 0:
                      parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_6, SubDirName_126, DirNamesLegacy_9, DirNamesProposed_10);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_123 = ((&parse_tree__file_names_vector_common_4[175 + ExtCurNgsGsMaxNgs_27]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_123, DirNamesLegacy_9, DirNamesProposed_10);
                }
                break;
            }
          }
  ...
  MR_String * CurDirFileName_6)
{
  ...
  ExtStr_8 = ((&parse_tree__file_names_vector_common_4[128 + ExtCur_4]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
...
parse_tree__file_names__module_name_to_search_file_name_6_p_0(
  ...
  MR_String * FullFileNameProposed_12)
{
  parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_117_108_101_95_110_97_109_101_95_116_111_95_115_101_97_114_99_104_95_102_105_108_101_95_110_97_109_101_95_95_91_50_93_95_48_6_p_0(Globals_7, Ext_9, ModuleName_10, FullFileNameLegacy_11, FullFileNameProposed_12);
}
  ...
  MR_String * FullFileNameProposed_12)
{
  ...
  parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_117_108_101_95_110_97_109_101_95_116_111_95_102_105_108_101_95_110_97_109_101_95_101_120_116_95_95_91_50_44_32_52_93_95_48_9_p_0(Globals_7, (MR_Integer) 1, Ext_9, ModuleName_10, &DirNamesLegacy_13, &DirNamesProposed_14, &CurDirFileName_15);
  if ((DirNamesLegacy_13 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  switch (MR_tag((MR_Word) Ext_14)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNamesProposed_17 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_214 = ((MR_Unsigned) ((MR_hl_field(0, Ext_14, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_20 = ((&parse_tree__file_names_vector_common_4[46 + ExtCur_214]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word ExtCurNgs_26 = ((MR_Unsigned) ((MR_hl_field(1, Ext_14, (MR_Integer) 0))) & (MR_Integer) 15);
        MR_Word SubdirSetting_27;
        MR_Word ExtCurNgs_215;
        ...
        BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
        ExtCurNgs_215 = ((MR_Unsigned) ((MR_hl_field(1, Ext_14, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_20 = ((&parse_tree__file_names_vector_common_4[62 + ExtCurNgs_215]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_30 = ((MR_Unsigned) ((MR_hl_field(2, Ext_14, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word SubdirSetting_51;
        MR_Word ExtCurGs_217;

        libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_51);
        switch (SubdirSetting_51) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_30) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  SubDirName_50 = (MR_String) "inits";
                  break;
                case (MR_Integer) 1:
                  SubDirName_50 = (MR_String) "lib";
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_10, &Grade_102);
              libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 727, &TargetArch_103);
              {
                Var_110 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_110, 0) = ((MR_Box) (SubDirName_50));
              ...
              }
              {
                ...
                MR_hl_field(1, Var_114, 0) = ((MR_Box) (Grade_102));
                MR_hl_field(1, Var_114, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_113, 0) = ((MR_Box) (SubDirName_50));
        ...
        BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
        ExtCurGs_217 = ((MR_Unsigned) ((MR_hl_field(2, Ext_14, (MR_Integer) 0))) & (MR_Integer) 1);
        switch (ExtCurGs_217) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            ExtStr_20 = (MR_String) ".init";
            break;
          case (MR_Integer) 1:
            ExtStr_20 = (MR_String) ".jar";
            break;
        }
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_14, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ExtCurGas_31 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_54;
            MR_Word ExtCurGas_218;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  switch (ExtCurGas_31) {
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_String _ExtStr_118;

                        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 633, &_ExtStr_118);
                        SubDirName_53 = (MR_String) "bin";
                      }
                      break;
                    case (MR_Integer) 0:
                    ...
                    case (MR_Integer) 8:
                      {
                        MR_String _ExtStr_130;

                        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 632, &_ExtStr_130);
                        SubDirName_53 = (MR_String) "lib";
                      }
                      break;
                    case (MR_Integer) 9:
                      {
                        ...
                        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 631, &_ExtStr_132);
                        SubDirName_53 = (MR_String) "lib";
                      }
                      break;
                  }
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_10, &Grade_87);
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 727, &TargetArch_88);
                  {
                    Var_95 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_95, 0) = ((MR_Box) (SubDirName_53));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_98, 0) = ((MR_Box) (SubDirName_53));
            ...
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurGas_218 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            switch (ExtCurGas_218) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 2:
                ExtStr_20 = (MR_String) ".bat";
                break;
              case (MR_Integer) 1:
                ExtStr_20 = (MR_String) ".exe";
                break;
              case (MR_Integer) 3:
                libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 633, &ExtStr_20);
                break;
              case (MR_Integer) 0:
                ExtStr_20 = (MR_String) "";
                break;
              case (MR_Integer) 6:
                ExtStr_20 = (MR_String) ".a";
                break;
              case (MR_Integer) 7:
                ExtStr_20 = (MR_String) ".dll";
                break;
              case (MR_Integer) 5:
                ExtStr_20 = (MR_String) ".\044A";
                break;
              case (MR_Integer) 4:
                ExtStr_20 = (MR_String) ".\044(EXT_FOR_SHARED_LIB)";
                break;
              case (MR_Integer) 8:
                libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 632, &ExtStr_20);
                break;
              case (MR_Integer) 9:
                libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 631, &ExtStr_20);
                break;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ExtCurNgsGs_32 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_59;
            MR_Word ExtCurNgsGs_219;

            libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_59);
            switch (SubdirSetting_59) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_58 = ((&parse_tree__file_names_vector_common_4[74 + ExtCurNgsGs_32]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_10, SubDirName_58, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_56 = ((&parse_tree__file_names_vector_common_4[87 + ExtCurNgsGs_32]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_56, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
            }
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGs_219 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            ExtStr_20 = ((&parse_tree__file_names_vector_common_4[100 + ExtCurNgsGs_219]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGas_33 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word SubdirSetting_64;
            MR_Word ExtCurNgsGas_220;

            libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_64);
            switch (SubdirSetting_64) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_16 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_63;
                  MR_String _ExtStr_62;

                  parse_tree__file_names__ext_cur_ngs_gas_extension_dir_4_p_0(Globals_10, ExtCurNgsGas_33, &_ExtStr_62, &SubDirName_63);
                  parse_tree__file_names__make_gas_dir_names_4_p_0(Globals_10, SubDirName_63, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gas_extension_dir_4_p_0(Globals_10, ExtCurNgsGas_33, &_ExtStr_60, &SubDirName_61);
                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_61, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
            }
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGas_220 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            switch (ExtCurNgsGas_220) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 6:
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 580, &Str0_274);
                  ExtStr_20 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_274);
                }
                break;
              case (MR_Integer) 8:
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 581, &Str0_281);
                  ExtStr_20 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_281);
                }
                break;
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 4:
                libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 580, &ExtStr_20);
                break;
              case (MR_Integer) 3:
                ExtStr_20 = (MR_String) ".pic_o";
                break;
              case (MR_Integer) 5:
                libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 581, &ExtStr_20);
                break;
            }
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Word ErrorFilesInSubdir_35;

            libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 708, &ErrorFilesInSubdir_35);
            switch (ErrorFilesInSubdir_35) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *DirNamesLegacy_16 = (MR_Word) ((MR_Unsigned) 0U);
              ...
              case (MR_Integer) 1:
                {
                  MR_Word SubdirSetting_69;

                  libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_69);
                  switch (SubdirSetting_69) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        *DirNamesLegacy_16 = (MR_Word) ((MR_Unsigned) 0U);
                      ...
                      break;
                    case (MR_Integer) 2:
                      parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_10, (MR_String) "errs", DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "errs", DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsJava_36 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word DirNamesLegacy0_37;
            MR_Word DirNamesProposed0_38;
            MR_Word ExtCurNgsGsJava_222;

            parse_tree__file_names__get_java_dir_path_4_p_0(Globals_10, ExtCurNgsGsJava_36, &DirNamesLegacy0_37, &DirNamesProposed0_38);
            *DirNamesLegacy_16 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNamesLegacy0_37, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            *DirNamesProposed_17 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNamesProposed0_38, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            parse_tree__java_names__mangle_sym_name_for_java_4_p_0(ModuleName_15, (MR_Integer) 0, (MR_String) "__", &BaseNameNoExt_19);
            ExtCurNgsGsJava_222 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_222) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  switch (SubdirSetting_72) {
                    ...
                    case (MR_Integer) 2:
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "mhs", DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 6:
          {
            switch (Search_12) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word SubdirSetting_77;

                  libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_77);
                  switch (SubdirSetting_77) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        *DirNamesLegacy_16 = (MR_Word) ((MR_Unsigned) 0U);
                      ...
                      break;
                    case (MR_Integer) 2:
                      parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_10, (MR_String) "mihs", DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0((MR_String) "mihs", DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 7:
          {
            MR_Word ExtCurNgsGsMaxNgs_41 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_82;
            MR_Word ExtCurNgsGsMaxNgs_224;

            libs__globals__get_subdir_setting_2_p_0(Globals_10, &SubdirSetting_82);
            switch (SubdirSetting_82) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_81 = ((&parse_tree__file_names_vector_common_4[113 + ExtCurNgsGsMaxNgs_41]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  switch (Search_12) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_81, DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                    case (MR_Integer) 0:
                      parse_tree__file_names__make_gs_dir_names_4_p_0(Globals_10, SubDirName_81, DirNamesLegacy_16, DirNamesProposed_17);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_79 = ((&parse_tree__file_names_vector_common_4[118 + ExtCurNgsGsMaxNgs_41]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_79, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
            }
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGsMaxNgs_224 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_20 = ((&parse_tree__file_names_vector_common_4[123 + ExtCurNgsGsMaxNgs_224]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_Word * GasSubDirNamesProposed_8)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 727, &TargetArch_10);
  {
  ...
  switch (Ext_6) {
    ...
    case (MR_Integer) 9:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 580, &Str0_9);
    ...
    case (MR_Integer) 10:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 581, &Str0_16);
    ...
    case (MR_Integer) 2:
      *Str_7 = (MR_String) ".o";
      break;
    case (MR_Integer) 4:
      libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 580, Str_7);
      break;
    case (MR_Integer) 3:
      *Str_7 = (MR_String) ".pic_o";
      break;
    case (MR_Integer) 5:
      libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 581, Str_7);
      break;
  }
  *Dir_8 = (MR_String) "os";
}
...
parse_tree__file_names__ext_cur_ngs_extension_dir_3_p_0(
  ...
  MR_String * Dir_3)
{
  *Str_2 = ((&parse_tree__file_names_vector_common_5[0 + Ext_1]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
  *Dir_3 = ((&parse_tree__file_names_vector_common_5[0 + Ext_1]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_1;
}
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 727, &TargetArch_16);
        {
          Var_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word Ext_5)
{
  ...
  switch (MR_tag((MR_Word) Ext_5)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ExtCur_7 = ((MR_Unsigned) ((MR_hl_field(0, Ext_5, (MR_Integer) 0))) & (MR_Integer) 15);
    ...
    case (MR_Integer) 1:
      {
        ...
        ExtStr_6 = ((&parse_tree__file_names_vector_common_4[16 + ExtCurNgs_8]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_10 = ((MR_Unsigned) ((MR_hl_field(2, Ext_5, (MR_Integer) 0))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ExtCurGas_11 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (ExtCurGas_11) {
              ...
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 3:
                libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 633, &ExtStr_6);
                break;
              case (MR_Integer) 0:
                ExtStr_6 = (MR_String) "";
                break;
              ...
              case (MR_Integer) 4:
                ...
                break;
              case (MR_Integer) 8:
                libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 632, &ExtStr_6);
                break;
              case (MR_Integer) 9:
                libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 631, &ExtStr_6);
                break;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ExtCurNgsGs_12 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 15);

            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[28 + ExtCurNgsGs_12]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ExtCurNgsGas_13 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 15);

            switch (ExtCurNgsGas_13) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 6:
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 580, &Str0_75);
                  ExtStr_6 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_75);
                }
                break;
              case (MR_Integer) 8:
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 581, &Str0_82);
                  ExtStr_6 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_82);
                }
                break;
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 4:
                libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 580, &ExtStr_6);
                break;
              case (MR_Integer) 3:
                ExtStr_6 = (MR_String) ".pic_o";
                break;
              case (MR_Integer) 5:
                libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 581, &ExtStr_6);
                break;
            }
          }
          break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsJava_15 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 1);

            switch (ExtCurNgsGsJava_15) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 7:
          {
            MR_Word ExtCurNgsGsMaxNgs_17 = ((MR_Unsigned) ((MR_hl_field(3, Ext_5, (MR_Integer) 1))) & (MR_Integer) 7);

            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[41 + ExtCurNgsGsMaxNgs_17]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__file_names____Unify____ext_cur_ngs_max_cur_0_0();
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__file_names____Compare____ext_cur_ngs_max_cur_0_0(&conv0_HeadVar__1_1);
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__parse_tree__file_names__init_type_tables(void)
{
	...
	MR_register_type_ctor_info(&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_max_cur_0);
...
{
	parse_tree__file_names__user_init_pred_136_0();
	parse_tree__file_names__user_init_pred_146_0();
	parse_tree__file_names__user_init_pred_149_0();
	parse_tree__file_names__user_init_pred_150_0();
}
