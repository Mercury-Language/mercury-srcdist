...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[119];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[119] = {
  ...
  /* row  28 */   { (MR_String) ".opt" },
  /* row  29 */   { (MR_String) ".trans_opt" },
  /* row  30 */   { (MR_String) ".analysis" },
  /* row  31 */   { (MR_String) ".imdg" },
  /* row  32 */   { (MR_String) ".request" },
  /* row  33 */   { (MR_String) ".defn_extents" },
  /* row  34 */   { (MR_String) ".defn_line_counts" },
  /* row  35 */   { (MR_String) ".defns" },
  /* row  36 */   { (MR_String) ".dependency_graph" },
  /* row  37 */   { (MR_String) ".hlds_dump" },
  /* row  38 */   { (MR_String) ".imports_graph" },
  /* row  39 */   { (MR_String) ".local_call_tree" },
  /* row  40 */   { (MR_String) ".local_call_tree_full" },
  /* row  41 */   { (MR_String) ".local_call_tree_order" },
  /* row  42 */   { (MR_String) ".mlds_dump" },
  /* row  43 */   { (MR_String) ".mode_constraints" },
  /* row  44 */   { (MR_String) ".order" },
  /* row  45 */   { (MR_String) ".order_trans_opt" },
  /* row  46 */   { (MR_String) ".type_repns" },
  /* row  47 */   { (MR_String) ".ugly" },
  /* row  48 */   { (MR_String) ".xml" },
  /* row  49 */   { (MR_String) ".int0" },
  /* row  50 */   { (MR_String) ".int" },
  /* row  51 */   { (MR_String) ".int2" },
  /* row  52 */   { (MR_String) ".int3" },
  /* row  53 */   { (MR_String) ".date0" },
  /* row  54 */   { (MR_String) ".date" },
  /* row  55 */   { (MR_String) ".date3" },
  /* row  56 */   { (MR_String) ".d" },
  /* row  57 */   { (MR_String) ".dv" },
  /* row  58 */   { (MR_String) ".dep" },
  /* row  59 */   { (MR_String) ".module_dep" },
  /* row  60 */   { (MR_String) ".prof" },
  /* row  61 */   { (MR_String) "opts" },
  /* row  62 */   { (MR_String) "trans_opts" },
  /* row  63 */   { (MR_String) "analyses" },
  /* row  64 */   { (MR_String) "imdgs" },
  /* row  65 */   { (MR_String) "requests" },
  /* row  66 */   { (MR_String) "opts" },
  /* row  67 */   { (MR_String) "trans_opts" },
  /* row  68 */   { (MR_String) "analyses" },
  /* row  69 */   { (MR_String) "imdgs" },
  /* row  70 */   { (MR_String) "requests" },
  /* row  71 */   { (MR_String) ".opt" },
  /* row  72 */   { (MR_String) ".trans_opt" },
  /* row  73 */   { (MR_String) ".analysis" },
  /* row  74 */   { (MR_String) ".imdg" },
  /* row  75 */   { (MR_String) ".request" },
  /* row  76 */   { (MR_String) "opts" },
  /* row  77 */   { (MR_String) "trans_opts" },
  /* row  78 */   { (MR_String) "analyses" },
  /* row  79 */   { (MR_String) "imdgs" },
  /* row  80 */   { (MR_String) "requests" },
  /* row  81 */   { (MR_String) "opts" },
  /* row  82 */   { (MR_String) "trans_opts" },
  /* row  83 */   { (MR_String) "analyses" },
  /* row  84 */   { (MR_String) "imdgs" },
  /* row  85 */   { (MR_String) "requests" },
  /* row  86 */   { (MR_String) ".defn_extents" },
  /* row  87 */   { (MR_String) ".defn_line_counts" },
  /* row  88 */   { (MR_String) ".defns" },
  /* row  89 */   { (MR_String) ".dependency_graph" },
  /* row  90 */   { (MR_String) ".hlds_dump" },
  /* row  91 */   { (MR_String) ".imports_graph" },
  /* row  92 */   { (MR_String) ".local_call_tree" },
  /* row  93 */   { (MR_String) ".local_call_tree_full" },
  /* row  94 */   { (MR_String) ".local_call_tree_order" },
  /* row  95 */   { (MR_String) ".mlds_dump" },
  /* row  96 */   { (MR_String) ".mode_constraints" },
  /* row  97 */   { (MR_String) ".order" },
  /* row  98 */   { (MR_String) ".order_trans_opt" },
  /* row  99 */   { (MR_String) ".type_repns" },
  /* row 100 */   { (MR_String) ".ugly" },
  /* row 101 */   { (MR_String) ".xml" },
  /* row 102 */   { (MR_String) ".int0" },
  /* row 103 */   { (MR_String) ".int" },
  /* row 104 */   { (MR_String) ".int2" },
  /* row 105 */   { (MR_String) ".int3" },
  /* row 106 */   { (MR_String) ".date0" },
  /* row 107 */   { (MR_String) ".date" },
  /* row 108 */   { (MR_String) ".date3" },
  /* row 109 */   { (MR_String) ".d" },
  /* row 110 */   { (MR_String) ".dv" },
  /* row 111 */   { (MR_String) ".dep" },
  /* row 112 */   { (MR_String) ".module_dep" },
  /* row 113 */   { (MR_String) ".prof" },
  /* row 114 */   { (MR_String) ".opt" },
  /* row 115 */   { (MR_String) ".trans_opt" },
  /* row 116 */   { (MR_String) ".analysis" },
  /* row 117 */   { (MR_String) ".imdg" },
  /* row 118 */   { (MR_String) ".request" },
};
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[86 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[102 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 5:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[114 + ExtCurNgsGsMaxNgs_52]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (SubdirSetting_102) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_99 = ((&parse_tree__file_names_vector_common_4[76 + ExtCurNgsGsMaxNgs_22]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_96 = ((&parse_tree__file_names_vector_common_4[81 + ExtCurNgsGsMaxNgs_22]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_166 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[33 + ExtCur_166]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[49 + ExtCurNgs_167]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (SubdirSetting_66) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_65 = ((&parse_tree__file_names_vector_common_4[61 + ExtCurNgsGsMaxNgs_36]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_63 = ((&parse_tree__file_names_vector_common_4[66 + ExtCurNgsGsMaxNgs_36]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
            ...
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[71 + ExtCurNgsGsMaxNgs_174]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
        ...
        case (MR_Integer) 5:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[28 + ExtCurNgsGsMaxNgs_15]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
