...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_13;

static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_14;

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_0[15];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_ngs_0[15];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_ngs_0[15];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[215];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[215] = {
  ...
  /* row  45 */   { (MR_String) ".mbc" },
  /* row  46 */   { (MR_String) ".bytedebug" },
  /* row  47 */   { (MR_String) ".module_dep" },
  /* row  48 */   { (MR_String) ".err_date" },
  /* row  49 */   { (MR_String) ".prof" },
  /* row  50 */   { (MR_String) ".opt" },
  /* row  51 */   { (MR_String) ".trans_opt" },
  /* row  52 */   { (MR_String) ".analysis" },
  /* row  53 */   { (MR_String) ".imdg" },
  /* row  54 */   { (MR_String) ".request" },
  /* row  55 */   { (MR_String) ".mh" },
  /* row  56 */   { (MR_String) ".all_int3s" },
  /* row  57 */   { (MR_String) ".all_ints" },
  /* row  58 */   { (MR_String) ".all_opts" },
  /* row  59 */   { (MR_String) ".all_trans_opts" },
  /* row  60 */   { (MR_String) ".check" },
  /* row  61 */   { (MR_String) ".classes" },
  /* row  62 */   { (MR_String) ".clean" },
  /* row  63 */   { (MR_String) ".depend" },
  /* row  64 */   { (MR_String) ".install_grade_hdrs" },
  /* row  65 */   { (MR_String) ".install_hdrs" },
  /* row  66 */   { (MR_String) ".install_ints" },
  /* row  67 */   { (MR_String) ".install_opts" },
  /* row  68 */   { (MR_String) ".int3s" },
  /* row  69 */   { (MR_String) ".ints" },
  /* row  70 */   { (MR_String) ".javas" },
  /* row  71 */   { (MR_String) ".opts" },
  /* row  72 */   { (MR_String) ".realclean" },
  /* row  73 */   { (MR_String) ".trans_opts" },
  /* row  74 */   { (MR_String) ".defn_extents" },
  /* row  75 */   { (MR_String) ".defn_line_counts" },
  /* row  76 */   { (MR_String) ".defns" },
  /* row  77 */   { (MR_String) ".dependency_graph" },
  /* row  78 */   { (MR_String) ".err" },
  /* row  79 */   { (MR_String) ".hlds_dump" },
  /* row  80 */   { (MR_String) ".imports_graph" },
  /* row  81 */   { (MR_String) ".local_call_tree" },
  ...
  /* row 100 */   { (MR_String) "mbcs" },
  /* row 101 */   { (MR_String) "bytedebugs" },
  /* row 102 */   { (MR_String) "module_deps" },
  /* row 103 */   { (MR_String) "err_dates" },
  /* row 104 */   { (MR_String) "profs" },
  /* row 105 */   { (MR_String) ".int0" },
  /* row 106 */   { (MR_String) ".int" },
  /* row 107 */   { (MR_String) ".int2" },
  /* row 108 */   { (MR_String) ".int3" },
  /* row 109 */   { (MR_String) ".date0" },
  /* row 110 */   { (MR_String) ".date" },
  /* row 111 */   { (MR_String) ".date3" },
  /* row 112 */   { (MR_String) ".d" },
  /* row 113 */   { (MR_String) ".dv" },
  /* row 114 */   { (MR_String) ".dep" },
  /* row 115 */   { (MR_String) ".mbc" },
  /* row 116 */   { (MR_String) ".bytedebug" },
  /* row 117 */   { (MR_String) ".module_dep" },
  /* row 118 */   { (MR_String) ".err_date" },
  /* row 119 */   { (MR_String) ".prof" },
  /* row 120 */   { (MR_String) "opts" },
  /* row 121 */   { (MR_String) "trans_opts" },
  /* row 122 */   { (MR_String) "analyses" },
  /* row 123 */   { (MR_String) "imdgs" },
  /* row 124 */   { (MR_String) "requests" },
  /* row 125 */   { (MR_String) "opts" },
  /* row 126 */   { (MR_String) "trans_opts" },
  /* row 127 */   { (MR_String) "analyses" },
  /* row 128 */   { (MR_String) "imdgs" },
  /* row 129 */   { (MR_String) "requests" },
  /* row 130 */   { (MR_String) ".opt" },
  /* row 131 */   { (MR_String) ".trans_opt" },
  /* row 132 */   { (MR_String) ".analysis" },
  /* row 133 */   { (MR_String) ".imdg" },
  /* row 134 */   { (MR_String) ".request" },
  /* row 135 */   { (MR_String) "int0s" },
  /* row 136 */   { (MR_String) "ints" },
  /* row 137 */   { (MR_String) "int2s" },
  /* row 138 */   { (MR_String) "int3s" },
  /* row 139 */   { (MR_String) "date0s" },
  /* row 140 */   { (MR_String) "dates" },
  /* row 141 */   { (MR_String) "date3s" },
  /* row 142 */   { (MR_String) "ds" },
  /* row 143 */   { (MR_String) "deps" },
  /* row 144 */   { (MR_String) "deps" },
  /* row 145 */   { (MR_String) "mbcs" },
  /* row 146 */   { (MR_String) "bytedebugs" },
  /* row 147 */   { (MR_String) "module_deps" },
  /* row 148 */   { (MR_String) "err_dates" },
  /* row 149 */   { (MR_String) "profs" },
  /* row 150 */   { (MR_String) "opts" },
  /* row 151 */   { (MR_String) "trans_opts" },
  /* row 152 */   { (MR_String) "analyses" },
  /* row 153 */   { (MR_String) "imdgs" },
  /* row 154 */   { (MR_String) "requests" },
  /* row 155 */   { (MR_String) "opts" },
  /* row 156 */   { (MR_String) "trans_opts" },
  /* row 157 */   { (MR_String) "analyses" },
  /* row 158 */   { (MR_String) "imdgs" },
  /* row 159 */   { (MR_String) "requests" },
  /* row 160 */   { (MR_String) ".mh" },
  /* row 161 */   { (MR_String) ".all_int3s" },
  /* row 162 */   { (MR_String) ".all_ints" },
  /* row 163 */   { (MR_String) ".all_opts" },
  /* row 164 */   { (MR_String) ".all_trans_opts" },
  /* row 165 */   { (MR_String) ".check" },
  /* row 166 */   { (MR_String) ".classes" },
  /* row 167 */   { (MR_String) ".clean" },
  /* row 168 */   { (MR_String) ".depend" },
  /* row 169 */   { (MR_String) ".install_grade_hdrs" },
  /* row 170 */   { (MR_String) ".install_hdrs" },
  /* row 171 */   { (MR_String) ".install_ints" },
  /* row 172 */   { (MR_String) ".install_opts" },
  /* row 173 */   { (MR_String) ".int3s" },
  /* row 174 */   { (MR_String) ".ints" },
  /* row 175 */   { (MR_String) ".javas" },
  /* row 176 */   { (MR_String) ".opts" },
  /* row 177 */   { (MR_String) ".realclean" },
  /* row 178 */   { (MR_String) ".trans_opts" },
  /* row 179 */   { (MR_String) ".defn_extents" },
  /* row 180 */   { (MR_String) ".defn_line_counts" },
  /* row 181 */   { (MR_String) ".defns" },
  /* row 182 */   { (MR_String) ".dependency_graph" },
  /* row 183 */   { (MR_String) ".err" },
  /* row 184 */   { (MR_String) ".hlds_dump" },
  /* row 185 */   { (MR_String) ".imports_graph" },
  /* row 186 */   { (MR_String) ".local_call_tree" },
  /* row 187 */   { (MR_String) ".local_call_tree_order" },
  /* row 188 */   { (MR_String) ".mlds_dump" },
  /* row 189 */   { (MR_String) ".mode_constraints" },
  /* row 190 */   { (MR_String) ".order" },
  /* row 191 */   { (MR_String) ".order_trans_opt" },
  /* row 192 */   { (MR_String) ".type_repns" },
  /* row 193 */   { (MR_String) ".ugly" },
  /* row 194 */   { (MR_String) ".xml" },
  /* row 195 */   { (MR_String) ".int0" },
  /* row 196 */   { (MR_String) ".int" },
  /* row 197 */   { (MR_String) ".int2" },
  /* row 198 */   { (MR_String) ".int3" },
  /* row 199 */   { (MR_String) ".date0" },
  /* row 200 */   { (MR_String) ".date" },
  /* row 201 */   { (MR_String) ".date3" },
  /* row 202 */   { (MR_String) ".d" },
  /* row 203 */   { (MR_String) ".dv" },
  /* row 204 */   { (MR_String) ".dep" },
  /* row 205 */   { (MR_String) ".mbc" },
  /* row 206 */   { (MR_String) ".bytedebug" },
  /* row 207 */   { (MR_String) ".module_dep" },
  /* row 208 */   { (MR_String) ".err_date" },
  /* row 209 */   { (MR_String) ".prof" },
  /* row 210 */   { (MR_String) ".opt" },
  /* row 211 */   { (MR_String) ".trans_opt" },
  /* row 212 */   { (MR_String) ".analysis" },
  /* row 213 */   { (MR_String) ".imdg" },
  /* row 214 */   { (MR_String) ".request" },
};
...
#line 1429 "file_names.m"
void 
parse_tree__file_names__user_init_pred_212_0(void)
#line 1429 "file_names.m"
{
#line 1429 "file_names.m"
...
#line 1431 "file_names.m"
void 
parse_tree__file_names__user_init_pred_213_0(void)
#line 1431 "file_names.m"
{
#line 1431 "file_names.m"
...
static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_10 = {
  (MR_String) "ext_cur_ngs_bc_mbc",
  INT32_C(10)
};

static const MR_EnumFunctorDesc parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_11 = {
  (MR_String) "ext_cur_ngs_bc_bytedebug",
  INT32_C(11)
};
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_ngs_0[15] = {
  ...
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_13,
  &parse_tree__file_names__parse_tree__file_names__enum_functor_desc_ext_cur_ngs_0_14
};
  ...
  if (succeeded)
    *HeadVar__1_1 = (MR_Integer) 0;
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Var_110 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 63);
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Integer Var_117 = (MR_Integer) (Var_110);
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_112 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 15);
          ...
          switch (MR_tag((MR_Word) HeadVar__3_3)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ArgY1_21 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 15);
                MR_Integer Var_121 = (MR_Integer) (Var_112);
                MR_Integer Var_122 = (MR_Integer) (ArgY1_21);
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_111 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 15);
          ...
          switch (MR_tag((MR_Word) HeadVar__3_3)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word ArgY1_37 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 15);
                MR_Integer Var_119 = (MR_Integer) (Var_111);
                MR_Integer Var_120 = (MR_Integer) (ArgY1_37);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_113 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 31);
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 0:
                      {
                        MR_Word ArgY1_53 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 31);
                        MR_Integer Var_123 = (MR_Integer) (Var_113);
                        MR_Integer Var_124 = (MR_Integer) (ArgY1_53);
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_114 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Word ArgY1_69 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 1);
                        MR_Integer Var_125 = (MR_Integer) (Var_114);
                        MR_Integer Var_126 = (MR_Integer) (ArgY1_69);
          ...
          case (MR_Integer) 3:
            {
              MR_Word Var_116 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 7);
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_Word ArgY1_101 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 7);
                        MR_Integer Var_127 = (MR_Integer) (Var_116);
                        MR_Integer Var_128 = (MR_Integer) (ArgY1_101);
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[160 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[195 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        switch (ExtCurGs_47) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 3:
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 613, &ExtStr0_25);
            break;
          case (MR_Integer) 0:
          ...
          case (MR_Integer) 9:
            ...
            break;
          case (MR_Integer) 10:
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 612, &ExtStr0_25);
            break;
          case (MR_Integer) 11:
            libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 611, &ExtStr0_25);
            break;
        }
      }
      break;
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[210 + ExtCurNgsGsMaxNgs_52]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13 = ((&parse_tree__file_names_vector_common_4[135 + ExtCurNgs_10]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_21;

              {
                Var_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_21, 0) = ((MR_Box) (SubDirName_13));
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_14) {
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    SubDirName_40 = (MR_String) "bin";
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 613, &_ExtStr_124);
                  }
                  break;
                case (MR_Integer) 0:
                  SubDirName_40 = (MR_String) "bin";
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_140;

                    SubDirName_40 = (MR_String) "lib";
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 612, &_ExtStr_140);
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_142;

                    SubDirName_40 = (MR_String) "lib";
                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 611, &_ExtStr_142);
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_102);
              libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 704, &TargetArch_103);
              {
                Var_110 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_110, 0) = ((MR_Box) (SubDirName_40));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_49, &SubDirName_51);
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_112);
                  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 704, &TargetArch_113);
                  {
                    Var_120 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_120, 0) = ((MR_Box) (SubDirName_51));
                    MR_hl_field(1, Var_120, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Var_118 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_118, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, Var_118, 1) = ((MR_Box) (Var_120));
                  }
                  {
                    Var_117 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_117, 0) = ((MR_Box) (TargetArch_113));
                    MR_hl_field(1, Var_117, 1) = ((MR_Box) (Var_118));
                  }
                  {
                    Var_116 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_116, 0) = ((MR_Box) (Grade_112));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_46, &SubDirName_48);
                  {
                    Var_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_24, 0) = ((MR_Box) (SubDirName_48));
                ...
                switch (SubdirSetting_65) {
                  ...
                  case (MR_Integer) 0:
                    *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
                    break;
                  case (MR_Integer) 2:
                    *DirNames_8 = parse_tree__file_names__make_grade_subdir_name_2_f_0(Globals_5, (MR_String) "mihs");
                    break;
                  case (MR_Integer) 1:
        ...
        case (MR_Integer) 3:
          {
            ...
            switch (SubdirSetting_82) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_79 = ((&parse_tree__file_names_vector_common_4[150 + ExtCurNgsGsMaxNgs_19]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
                    ...
                    case (MR_Integer) 1:
                      {
...

                        {
                          ...
                          MR_hl_field(1, Var_36, 0) = ((MR_Box) (SubDirName_79));
                      ...
                      break;
                    case (MR_Integer) 0:
                      *DirNames_8 = parse_tree__file_names__make_grade_subdir_name_2_f_0(Globals_5, SubDirName_79);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word Var_33;
                  MR_String SubDirName_76 = ((&parse_tree__file_names_vector_common_4[155 + ExtCurNgsGsMaxNgs_19]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  {
                    Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_33, 0) = ((MR_Box) (SubDirName_76));
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_185 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[55 + ExtCur_185]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(1, Var_35, 0) = ((MR_Box) (SubDirName_27));
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurNgs_186 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[105 + ExtCurNgs_186]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_28) {
                ...
                case (MR_Integer) 3:
                  {
                    MR_String _ExtStr_111;

                    SubDirName_53 = (MR_String) "bin";
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 613, &_ExtStr_111);
                  }
                  break;
                case (MR_Integer) 0:
                  SubDirName_53 = (MR_String) "bin";
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_127;

                    SubDirName_53 = (MR_String) "lib";
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 612, &_ExtStr_127);
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_129;

                    SubDirName_53 = (MR_String) "lib";
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 611, &_ExtStr_129);
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_89);
              libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 704, &TargetArch_90);
              {
                Var_97 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_97, 0) = ((MR_Box) (SubDirName_53));
                MR_hl_field(1, Var_97, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_95 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_95, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, Var_95, 1) = ((MR_Box) (Var_97));
              }
              {
                Var_94 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_94, 0) = ((MR_Box) (TargetArch_90));
                MR_hl_field(1, Var_94, 1) = ((MR_Box) (Var_95));
              }
              {
                Var_93 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_93, 0) = ((MR_Box) (Grade_89));
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurGs_188 = ((MR_Unsigned) ((MR_hl_field(2, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        switch (ExtCurGs_188) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 3:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 613, &ExtStr_18);
            break;
          case (MR_Integer) 0:
            ExtStr_18 = (MR_String) "";
            break;
          ...
          case (MR_Integer) 9:
            ...
            break;
          case (MR_Integer) 10:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 612, &ExtStr_18);
            break;
          case (MR_Integer) 11:
            libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 611, &ExtStr_18);
            break;
        }
      }
      break;
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ExtCurNgsGs_189;
            MR_String _SubDirName_195;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_59);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_57, &SubDirName_58);
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_99);
                  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 704, &TargetArch_100);
                  {
                    Var_107 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_107, 0) = ((MR_Box) (SubDirName_58));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_55, &SubDirName_56);
                  {
                    Var_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_38, 0) = ((MR_Box) (SubDirName_56));
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGs_189 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 31);
            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_189, &ExtStr_18, &_SubDirName_195);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            *DirNames_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_31, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            ...
            ExtCurNgsGsJava_190 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_190) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_64);
                  switch (SubdirSetting_64) {
                    ...
                    case (MR_Integer) 0:
                      *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                      break;
                    case (MR_Integer) 2:
                      *DirNames_15 = parse_tree__file_names__make_grade_subdir_name_2_f_0(Globals_9, (MR_String) "mihs");
                      break;
                    case (MR_Integer) 1:
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word ExtCurNgsGsMaxNgs_193;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_69);
            switch (SubdirSetting_69) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_68 = ((&parse_tree__file_names_vector_common_4[120 + ExtCurNgsGsMaxNgs_33]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
                    ...
                    case (MR_Integer) 1:
                      {
...

                        {
                          ...
                          MR_hl_field(1, Var_50, 0) = ((MR_Box) (SubDirName_68));
                      ...
                      break;
                    case (MR_Integer) 0:
                      *DirNames_15 = parse_tree__file_names__make_grade_subdir_name_2_f_0(Globals_9, SubDirName_68);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word Var_47;
                  MR_String SubDirName_66 = ((&parse_tree__file_names_vector_common_4[125 + ExtCurNgsGsMaxNgs_33]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  {
                    Var_47 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_47, 0) = ((MR_Box) (SubDirName_66));
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGsMaxNgs_193 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[130 + ExtCurNgsGsMaxNgs_193]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
    ...
    case (MR_Integer) 2:
      {
        ...
        switch (ExtCurNgsGsJava_5) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            SubDirName_15 = (MR_String) "classes";
            break;
          case (MR_Integer) 0:
            SubDirName_15 = (MR_String) "javas";
            break;
        }
        libs__compute_grade__grade_directory_component_2_p_0(Globals_4, &Grade_16);
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 704, &TargetArch_17);
        {
          Var_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_24, 0) = ((MR_Box) (SubDirName_15));
          MR_hl_field(1, Var_24, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_22, 0) = ((MR_Box) ((MR_String) "Mercury"));
          MR_hl_field(1, Var_22, 1) = ((MR_Box) (Var_24));
        }
        {
          Var_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_21, 0) = ((MR_Box) (TargetArch_17));
          MR_hl_field(1, Var_21, 1) = ((MR_Box) (Var_22));
        }
        {
          Var_20 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_20, 0) = ((MR_Box) (Grade_16));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          Var_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_11, 0) = ((MR_Box) (SubDirName_9));
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[50 + ExtCurNgsGsMaxNgs_15]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String * HeadVar__4_4)
{
  switch (HeadVar__2_2) {
    ...
    case (MR_Integer) 19:
      {
        *HeadVar__3_3 = (MR_String) ".analysis_date";
        *HeadVar__4_4 = (MR_String) "analysis_dates";
      }
      break;
    case (MR_Integer) 20:
      {
        *HeadVar__3_3 = (MR_String) ".analysis_status";
        *HeadVar__4_4 = (MR_String) "analysis_statuss";
      }
      break;
    case (MR_Integer) 7:
      {
        *HeadVar__3_3 = (MR_String) "_init.c";
        *HeadVar__4_4 = (MR_String) "cs";
      }
      break;
    case (MR_Integer) 14:
      {
    ...
    case (MR_Integer) 17:
      {
        MR_String ExtStr0_28;

        *HeadVar__4_4 = (MR_String) "os";
        libs__globals__lookup_string_option_3_p_0(Globals_1, (MR_Integer) 560, &ExtStr0_28);
        *HeadVar__3_3 = mercury__string__f_43_43_2_f_0((MR_String) "_init", ExtStr0_28);
      }
      break;
    case (MR_Integer) 16:
      {
    ...
    case (MR_Integer) 18:
      {
        MR_String ExtStr0_33;

        *HeadVar__4_4 = (MR_String) "os";
        libs__globals__lookup_string_option_3_p_0(Globals_1, (MR_Integer) 561, &ExtStr0_33);
        *HeadVar__3_3 = mercury__string__f_43_43_2_f_0((MR_String) "_init", ExtStr0_33);
      }
      break;
    case (MR_Integer) 22:
      {
        *HeadVar__3_3 = (MR_String) ".track_flags";
        *HeadVar__4_4 = (MR_String) "track_flags";
      }
      break;
    case (MR_Integer) 21:
      {
        *HeadVar__3_3 = (MR_String) ".used";
        *HeadVar__4_4 = (MR_String) "useds";
      }
      break;
    case (MR_Integer) 9:
      {
    ...
    case (MR_Integer) 0:
      {
        *HeadVar__3_3 = (MR_String) ".optdate";
        *HeadVar__4_4 = (MR_String) "optdates";
      }
      break;
    case (MR_Integer) 1:
      {
        *HeadVar__3_3 = (MR_String) ".trans_opt_date";
        *HeadVar__4_4 = (MR_String) "trans_opt_dates";
      }
      break;
    case (MR_Integer) 2:
      {
        *HeadVar__3_3 = (MR_String) ".c";
        *HeadVar__4_4 = (MR_String) "cs";
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        *HeadVar__4_4 = (MR_String) "css";
      }
      break;
    case (MR_Integer) 4:
      {
        *HeadVar__3_3 = (MR_String) ".c_date";
        *HeadVar__4_4 = (MR_String) "c_dates";
      }
      break;
    case (MR_Integer) 5:
      {
        *HeadVar__3_3 = (MR_String) ".cs_date";
        *HeadVar__4_4 = (MR_String) "cs_dates";
      }
      break;
    case (MR_Integer) 6:
      {
        *HeadVar__3_3 = (MR_String) ".java_date";
        *HeadVar__4_4 = (MR_String) "java_dates";
      }
      break;
  }
}
...
void mercury__parse_tree__file_names__required_init(void)
{
	...
	parse_tree__file_names__user_init_pred_212_0();
	parse_tree__file_names__user_init_pred_213_0();
}
