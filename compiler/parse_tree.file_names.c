...
static const MR_DuFunctorDescPtr parse_tree__file_names__parse_tree__file_names__du_stag_ordered_ext_0_3[5];

static const MR_DuPtagLayout parse_tree__file_names__parse_tree__file_names__du_ptag_ordered_ext_0[4];

static const MR_DuFunctorDescPtr parse_tree__file_names__parse_tree__file_names__du_name_ordered_ext_0[8];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_0[8];
...
static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_ordinal_ordered_ext_cur_0[35];

static const MR_EnumFunctorDescPtr parse_tree__file_names__parse_tree__file_names__enum_name_ordered_ext_cur_0[35];

static const MR_Integer parse_tree__file_names__parse_tree__file_names__functor_number_map_ext_cur_0[35];
...
static /* final */ const MR_Box parse_tree__file_names_scalar_common_5[1][14];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[205];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[205] = {
  ...
  /* row  22 */   { (MR_String) ".err" },
  /* row  23 */   { (MR_String) ".hlds_dump" },
  /* row  24 */   { (MR_String) ".imports_graph" },
  /* row  25 */   { (MR_String) ".local_call_tree" },
  /* row  26 */   { (MR_String) ".local_call_tree_full" },
  /* row  27 */   { (MR_String) ".local_call_tree_order" },
  /* row  28 */   { (MR_String) ".mlds_dump" },
  /* row  29 */   { (MR_String) ".mode_constraints" },
  /* row  30 */   { (MR_String) ".order" },
  /* row  31 */   { (MR_String) ".order_trans_opt" },
  /* row  32 */   { (MR_String) ".type_repns" },
  /* row  33 */   { (MR_String) ".ugly" },
  /* row  34 */   { (MR_String) ".xml" },
  /* row  35 */   { (MR_String) ".int0" },
  /* row  36 */   { (MR_String) ".int" },
  /* row  37 */   { (MR_String) ".int2" },
  /* row  38 */   { (MR_String) ".int3" },
  /* row  39 */   { (MR_String) ".date0" },
  /* row  40 */   { (MR_String) ".date" },
  /* row  41 */   { (MR_String) ".date3" },
  /* row  42 */   { (MR_String) ".d" },
  /* row  43 */   { (MR_String) ".dv" },
  /* row  44 */   { (MR_String) ".dep" },
  /* row  45 */   { (MR_String) ".module_dep" },
  /* row  46 */   { (MR_String) ".err_date" },
  /* row  47 */   { (MR_String) ".prof" },
  /* row  48 */   { (MR_String) ".opt" },
  /* row  49 */   { (MR_String) ".trans_opt" },
  /* row  50 */   { (MR_String) ".analysis" },
  /* row  51 */   { (MR_String) ".imdg" },
  /* row  52 */   { (MR_String) ".request" },
  /* row  53 */   { (MR_String) ".all_int3s" },
  /* row  54 */   { (MR_String) ".all_ints" },
  /* row  55 */   { (MR_String) ".all_opts" },
  /* row  56 */   { (MR_String) ".all_trans_opts" },
  /* row  57 */   { (MR_String) ".check" },
  /* row  58 */   { (MR_String) ".classes" },
  /* row  59 */   { (MR_String) ".clean" },
  /* row  60 */   { (MR_String) ".depend" },
  /* row  61 */   { (MR_String) ".install_grade_hdrs" },
  /* row  62 */   { (MR_String) ".install_hdrs" },
  /* row  63 */   { (MR_String) ".install_ints" },
  /* row  64 */   { (MR_String) ".install_opts" },
  /* row  65 */   { (MR_String) ".int3s" },
  /* row  66 */   { (MR_String) ".ints" },
  /* row  67 */   { (MR_String) ".javas" },
  /* row  68 */   { (MR_String) ".opts" },
  /* row  69 */   { (MR_String) ".realclean" },
  /* row  70 */   { (MR_String) ".trans_opts" },
  /* row  71 */   { (MR_String) ".defn_extents" },
  /* row  72 */   { (MR_String) ".defn_line_counts" },
  /* row  73 */   { (MR_String) ".defns" },
  /* row  74 */   { (MR_String) ".dependency_graph" },
  /* row  75 */   { (MR_String) ".err" },
  /* row  76 */   { (MR_String) ".hlds_dump" },
  /* row  77 */   { (MR_String) ".imports_graph" },
  /* row  78 */   { (MR_String) ".local_call_tree" },
  /* row  79 */   { (MR_String) ".local_call_tree_full" },
  /* row  80 */   { (MR_String) ".local_call_tree_order" },
  /* row  81 */   { (MR_String) ".mlds_dump" },
  /* row  82 */   { (MR_String) ".mode_constraints" },
  /* row  83 */   { (MR_String) ".order" },
  /* row  84 */   { (MR_String) ".order_trans_opt" },
  /* row  85 */   { (MR_String) ".type_repns" },
  /* row  86 */   { (MR_String) ".ugly" },
  /* row  87 */   { (MR_String) ".xml" },
  /* row  88 */   { (MR_String) "int0s" },
  /* row  89 */   { (MR_String) "ints" },
  /* row  90 */   { (MR_String) "int2s" },
  /* row  91 */   { (MR_String) "int3s" },
  /* row  92 */   { (MR_String) "date0s" },
  /* row  93 */   { (MR_String) "dates" },
  /* row  94 */   { (MR_String) "date3s" },
  /* row  95 */   { (MR_String) "ds" },
  /* row  96 */   { (MR_String) "deps" },
  /* row  97 */   { (MR_String) "deps" },
  /* row  98 */   { (MR_String) "module_deps" },
  /* row  99 */   { (MR_String) "err_dates" },
  /* row 100 */   { (MR_String) "profs" },
  /* row 101 */   { (MR_String) ".int0" },
  /* row 102 */   { (MR_String) ".int" },
  /* row 103 */   { (MR_String) ".int2" },
  /* row 104 */   { (MR_String) ".int3" },
  /* row 105 */   { (MR_String) ".date0" },
  /* row 106 */   { (MR_String) ".date" },
  /* row 107 */   { (MR_String) ".date3" },
  /* row 108 */   { (MR_String) ".d" },
  /* row 109 */   { (MR_String) ".dv" },
  /* row 110 */   { (MR_String) ".dep" },
  /* row 111 */   { (MR_String) ".module_dep" },
  /* row 112 */   { (MR_String) ".err_date" },
  /* row 113 */   { (MR_String) ".prof" },
  /* row 114 */   { (MR_String) "opts" },
  /* row 115 */   { (MR_String) "trans_opts" },
  /* row 116 */   { (MR_String) "analyses" },
  /* row 117 */   { (MR_String) "imdgs" },
  /* row 118 */   { (MR_String) "requests" },
  /* row 119 */   { (MR_String) "opts" },
  /* row 120 */   { (MR_String) "trans_opts" },
  /* row 121 */   { (MR_String) "analyses" },
  /* row 122 */   { (MR_String) "imdgs" },
  /* row 123 */   { (MR_String) "requests" },
  /* row 124 */   { (MR_String) ".opt" },
  /* row 125 */   { (MR_String) ".trans_opt" },
  /* row 126 */   { (MR_String) ".analysis" },
  /* row 127 */   { (MR_String) ".imdg" },
  /* row 128 */   { (MR_String) ".request" },
  /* row 129 */   { (MR_String) "int0s" },
  /* row 130 */   { (MR_String) "ints" },
  /* row 131 */   { (MR_String) "int2s" },
  /* row 132 */   { (MR_String) "int3s" },
  /* row 133 */   { (MR_String) "date0s" },
  /* row 134 */   { (MR_String) "dates" },
  /* row 135 */   { (MR_String) "date3s" },
  /* row 136 */   { (MR_String) "ds" },
  /* row 137 */   { (MR_String) "deps" },
  /* row 138 */   { (MR_String) "deps" },
  /* row 139 */   { (MR_String) "module_deps" },
  /* row 140 */   { (MR_String) "err_dates" },
  /* row 141 */   { (MR_String) "profs" },
  /* row 142 */   { (MR_String) "opts" },
  /* row 143 */   { (MR_String) "trans_opts" },
  /* row 144 */   { (MR_String) "analyses" },
  /* row 145 */   { (MR_String) "imdgs" },
  /* row 146 */   { (MR_String) "requests" },
  /* row 147 */   { (MR_String) "opts" },
  /* row 148 */   { (MR_String) "trans_opts" },
  /* row 149 */   { (MR_String) "analyses" },
  /* row 150 */   { (MR_String) "imdgs" },
  /* row 151 */   { (MR_String) "requests" },
  /* row 152 */   { (MR_String) ".all_int3s" },
  /* row 153 */   { (MR_String) ".all_ints" },
  /* row 154 */   { (MR_String) ".all_opts" },
  /* row 155 */   { (MR_String) ".all_trans_opts" },
  /* row 156 */   { (MR_String) ".check" },
  /* row 157 */   { (MR_String) ".classes" },
  /* row 158 */   { (MR_String) ".clean" },
  /* row 159 */   { (MR_String) ".depend" },
  /* row 160 */   { (MR_String) ".install_grade_hdrs" },
  /* row 161 */   { (MR_String) ".install_hdrs" },
  /* row 162 */   { (MR_String) ".install_ints" },
  /* row 163 */   { (MR_String) ".install_opts" },
  /* row 164 */   { (MR_String) ".int3s" },
  /* row 165 */   { (MR_String) ".ints" },
  /* row 166 */   { (MR_String) ".javas" },
  /* row 167 */   { (MR_String) ".opts" },
  /* row 168 */   { (MR_String) ".realclean" },
  /* row 169 */   { (MR_String) ".trans_opts" },
  /* row 170 */   { (MR_String) ".defn_extents" },
  /* row 171 */   { (MR_String) ".defn_line_counts" },
  /* row 172 */   { (MR_String) ".defns" },
  /* row 173 */   { (MR_String) ".dependency_graph" },
  /* row 174 */   { (MR_String) ".err" },
  /* row 175 */   { (MR_String) ".hlds_dump" },
  /* row 176 */   { (MR_String) ".imports_graph" },
  /* row 177 */   { (MR_String) ".local_call_tree" },
  /* row 178 */   { (MR_String) ".local_call_tree_full" },
  /* row 179 */   { (MR_String) ".local_call_tree_order" },
  /* row 180 */   { (MR_String) ".mlds_dump" },
  /* row 181 */   { (MR_String) ".mode_constraints" },
  /* row 182 */   { (MR_String) ".order" },
  /* row 183 */   { (MR_String) ".order_trans_opt" },
  /* row 184 */   { (MR_String) ".type_repns" },
  /* row 185 */   { (MR_String) ".ugly" },
  /* row 186 */   { (MR_String) ".xml" },
  /* row 187 */   { (MR_String) ".int0" },
  /* row 188 */   { (MR_String) ".int" },
  /* row 189 */   { (MR_String) ".int2" },
  /* row 190 */   { (MR_String) ".int3" },
  /* row 191 */   { (MR_String) ".date0" },
  /* row 192 */   { (MR_String) ".date" },
  /* row 193 */   { (MR_String) ".date3" },
  /* row 194 */   { (MR_String) ".d" },
  /* row 195 */   { (MR_String) ".dv" },
  /* row 196 */   { (MR_String) ".dep" },
  /* row 197 */   { (MR_String) ".module_dep" },
  /* row 198 */   { (MR_String) ".err_date" },
  /* row 199 */   { (MR_String) ".prof" },
  /* row 200 */   { (MR_String) ".opt" },
  /* row 201 */   { (MR_String) ".trans_opt" },
  /* row 202 */   { (MR_String) ".analysis" },
  /* row 203 */   { (MR_String) ".imdg" },
  /* row 204 */   { (MR_String) ".request" },
};
...
#line 1365 "file_names.m"
void 
parse_tree__file_names__user_init_pred_123_0(void)
#line 1365 "file_names.m"
{
#line 1365 "file_names.m"
...
#line 1494 "file_names.m"
void 
parse_tree__file_names__user_init_pred_137_0(void)
#line 1494 "file_names.m"
{
#line 1494 "file_names.m"
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_5[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_max_cur_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_6[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_max_cur_0) };
...
static const MR_PseudoTypeInfo parse_tree__file_names__parse_tree__file_names__field_types_ext_0_7[1] = { (MR_PseudoTypeInfo) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_ext_cur_ngs_gs_max_ngs_0) };
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Integer Var_38 = (MR_Integer) (ArgX1_4);
              MR_Integer Var_39 = (MR_Integer) (ArgY1_5);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Integer Var_34 = (MR_Integer) (ArgX1_8);
              MR_Integer Var_35 = (MR_Integer) (ArgY1_9);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      MR_Integer Var_32 = (MR_Integer) (ArgX1_10);
                      MR_Integer Var_33 = (MR_Integer) (ArgY1_11);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Integer Var_30 = (MR_Integer) (ArgX1_12);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 4:
                    {
                      MR_Word ArgX1_18 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 7);
                      MR_Word ArgY1_19 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 7);
                      MR_Integer Var_28 = (MR_Integer) (ArgX1_18);
                      MR_Integer Var_29 = (MR_Integer) (ArgY1_19);
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[152 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[187 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 4:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[200 + ExtCurNgsGsMaxNgs_51]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
...
#undef MR_PROC_LABEL
  ...
  if (!(succeeded))
  {
...

    {
      ...
      MR_hl_field(0, Var_21, 0) = ((MR_Box) (&parse_tree__file_names_scalar_common_5[0]));
    ...
    if (!(((MR_tag((MR_Word) Result_13)) == (MR_Integer) 1)))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
      {
        ...
        MR_hl_field(0, Var_35, 0) = ((MR_Box) (&parse_tree__file_names_scalar_common_6[0]));
      ...
      mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_count_sum_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_35, ExtMap_11, ((MR_Box) ((MR_Integer) 0)), &conv8_STATE_VARIABLE_IO_36_36);
      {
        ...
        MR_hl_field(0, Var_37, 0) = ((MR_Box) (&parse_tree__file_names_scalar_common_6[0]));
      ...
      mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__file_names__parse_tree__file_names__type_ctor_info_count_sum_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_37, ExtSchDirMap_12, ((MR_Box) ((MR_Integer) 0)), &conv9_STATE_VARIABLE_IO_38_38);
      {
        ...
        MR_hl_field(0, Var_39, 0) = ((MR_Box) (&parse_tree__file_names_scalar_common_6[1]));
      ...
      mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_39, NoMkDirs_7, ((MR_Box) ((MR_Integer) 0)), &conv10_STATE_VARIABLE_IO_40_40);
      {
        ...
        MR_hl_field(0, Var_41, 0) = ((MR_Box) (&parse_tree__file_names_scalar_common_6[1]));
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_3, (MR_Integer) 725, &TargetArch_13);
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13 = ((&parse_tree__file_names_vector_common_4[129 + ExtCurNgs_10]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_137;

              {
                Var_137 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_137, 0) = ((MR_Box) (SubDirName_13));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word SubdirSetting_29;

        libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_29);
        switch (SubdirSetting_29) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_14) {
                ...
                case (MR_Integer) 3:
                  {
                    MR_String _ExtStr_141;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 632, &_ExtStr_141);
                    SubDirName_26 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_157;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 631, &_ExtStr_157);
                    SubDirName_26 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    MR_String _ExtStr_159;

                    libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 630, &_ExtStr_159);
                    SubDirName_26 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &Grade_87);
              libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 725, &TargetArch_88);
              {
                Var_95 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_95, 0) = ((MR_Box) (SubDirName_26));
      ...
      switch (((MR_Integer) ((MR_hl_field(3, Ext_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_40);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_37);
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_34;
                  MR_String _ExtStr_32;

                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_5, ExtCurNgsGs_15, &_ExtStr_32, &SubDirName_34);
                  *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_34);
                }
                break;
            }
          }
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_48);
        ...
        case (MR_Integer) 3:
          switch (Search_6) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word SubdirSetting_65;

                libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_65);
                switch (SubdirSetting_65) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    *DirNames_8 = (MR_Word) ((MR_Unsigned) 0U);
                    break;
                  case (MR_Integer) 2:
                    *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, (MR_String) "mihs");
                    break;
                  case (MR_Integer) 1:
                    *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0((MR_String) "mihs");
                    break;
                }
              }
              break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsMaxNgs_20 = ((MR_Unsigned) ((MR_hl_field(3, Ext_7, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_82;

            libs__globals__get_subdir_setting_2_p_0(Globals_5, &SubdirSetting_82);
            switch (SubdirSetting_82) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_79 = ((&parse_tree__file_names_vector_common_4[142 + ExtCurNgsGsMaxNgs_20]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
                  ...
                  switch (Search_6) {
                    ...
                    case (MR_Integer) 1:
                      *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_79);
                      break;
                    case (MR_Integer) 0:
                      *DirNames_8 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_5, SubDirName_79);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_76 = ((&parse_tree__file_names_vector_common_4[147 + ExtCurNgsGsMaxNgs_20]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  *DirNames_8 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_76);
                }
                break;
            }
          }
  ...
  switch (MR_tag((MR_Word) Ext_13)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_188 = ((MR_Unsigned) ((MR_hl_field(0, Ext_13, (MR_Integer) 0))) & (MR_Integer) 63);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[53 + ExtCur_188]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_25) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_27 = ((&parse_tree__file_names_vector_common_4[88 + ExtCurNgs_24]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_113;

              {
                Var_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_113, 0) = ((MR_Box) (SubDirName_27));
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurNgs_189 = ((MR_Unsigned) ((MR_hl_field(1, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[101 + ExtCurNgs_189]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        MR_Word SubdirSetting_40;
        MR_Word ExtCurGs_191;

        libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_40);
        switch (SubdirSetting_40) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ExtCurGs_28) {
                ...
                case (MR_Integer) 3:
                  {
                    MR_String _ExtStr_117;

                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 632, &_ExtStr_117);
                    SubDirName_39 = (MR_String) "bin";
                  }
                  break;
                case (MR_Integer) 0:
                ...
                case (MR_Integer) 10:
                  {
                    MR_String _ExtStr_133;

                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 631, &_ExtStr_133);
                    SubDirName_39 = (MR_String) "lib";
                  }
                  break;
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 630, &_ExtStr_135);
                    SubDirName_39 = (MR_String) "lib";
                  }
                  break;
              }
              libs__compute_grade__grade_directory_component_2_p_0(Globals_9, &Grade_63);
              libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 725, &TargetArch_64);
              {
                Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_71, 0) = ((MR_Box) (SubDirName_39));
                MR_hl_field(1, Var_71, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_69 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_69, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, Var_69, 1) = ((MR_Box) (Var_71));
              }
              {
                Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_68, 0) = ((MR_Box) (TargetArch_64));
                MR_hl_field(1, Var_68, 1) = ((MR_Box) (Var_69));
              }
              {
                Var_67 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_67, 0) = ((MR_Box) (Grade_63));
        ...
        BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
        ExtCurGs_191 = ((MR_Unsigned) ((MR_hl_field(2, Ext_13, (MR_Integer) 0))) & (MR_Integer) 15);
        switch (ExtCurGs_191) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Ext_13, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ExtCurNgsGs_192;
            MR_String _SubDirName_197;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_45);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_43, &SubDirName_44);
                  *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_44);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_29, &_ExtStr_41, &SubDirName_42);
                  *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_42);
                }
                break;
            }
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGs_192 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 31);
            parse_tree__file_names__ext_cur_ngs_gs_extension_dir_4_p_0(Globals_9, ExtCurNgsGs_192, &ExtStr_18, &_SubDirName_197);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            *DirNames_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNames0_31, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            ...
            ExtCurNgsGsJava_193 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_193) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                  ...
                  switch (SubdirSetting_53) {
                    ...
                    case (MR_Integer) 2:
                      *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, (MR_String) "mihs");
                      break;
                    case (MR_Integer) 1:
                      *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0((MR_String) "mihs");
                      break;
                  }
                }
                break;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ExtCurNgsGsMaxNgs_34 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word SubdirSetting_58;
            MR_Word ExtCurNgsGsMaxNgs_195;

            libs__globals__get_subdir_setting_2_p_0(Globals_9, &SubdirSetting_58);
            switch (SubdirSetting_58) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_57 = ((&parse_tree__file_names_vector_common_4[114 + ExtCurNgsGsMaxNgs_34]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;

                  switch (Search_11) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      *DirNames_15 = parse_tree__file_names__make_ngs_dir_names_1_f_0(SubDirName_57);
                      break;
                    case (MR_Integer) 0:
                      *DirNames_15 = parse_tree__file_names__make_gs_dir_names_2_f_0(Globals_9, SubDirName_57);
                      break;
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_55 = ((&parse_tree__file_names_vector_common_4[119 + ExtCurNgsGsMaxNgs_34]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
            ...
            BaseNameNoExt_17 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_14, (MR_String) ".");
            ExtCurNgsGsMaxNgs_195 = ((MR_Unsigned) ((MR_hl_field(3, Ext_13, (MR_Integer) 1))) & (MR_Integer) 7);
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[124 + ExtCurNgsGsMaxNgs_195]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
  ...
  MR_String SubDirName_5)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 725, &TargetArch_8);
  {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 725, &TargetArch_14);
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        ExtStr_6 = ((&parse_tree__file_names_vector_common_4[35 + ExtCurNgs_8]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 4:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[48 + ExtCurNgsGsMaxNgs_14]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
...
{
	parse_tree__file_names__user_init_pred_123_0();
	parse_tree__file_names__user_init_pred_133_0();
	parse_tree__file_names__user_init_pred_136_0();
	parse_tree__file_names__user_init_pred_137_0();
}
