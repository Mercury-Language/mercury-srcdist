...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[17];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_5_0_s parse_tree__file_names_vector_common_5[155];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_5_0_s parse_tree__file_names_vector_common_5[155] = {
  ...
  /* row  16 */   { (MR_String) ".optdate" },
  /* row  17 */   { (MR_String) ".trans_opt_date" },
  /* row  18 */   { (MR_String) ".c" },
  /* row  19 */   { (MR_String) ".cs" },
  /* row  20 */   { (MR_String) ".c_date" },
  /* row  21 */   { (MR_String) ".cs_date" },
  /* row  22 */   { (MR_String) ".java_date" },
  /* row  23 */   { (MR_String) "_init.c" },
  /* row  24 */   { (MR_String) ".analysis_date" },
  /* row  25 */   { (MR_String) ".analysis_status" },
  /* row  26 */   { (MR_String) ".err_date" },
  /* row  27 */   { (MR_String) ".used" },
  /* row  28 */   { (MR_String) ".track_flags" },
  /* row  29 */   { (MR_String) ".defn_extents" },
  /* row  30 */   { (MR_String) ".defn_line_counts" },
  /* row  31 */   { (MR_String) ".defns" },
  /* row  32 */   { (MR_String) ".dependency_graph" },
  /* row  33 */   { (MR_String) ".hlds_dump" },
  /* row  34 */   { (MR_String) ".imports_graph" },
  /* row  35 */   { (MR_String) ".local_call_tree" },
  /* row  36 */   { (MR_String) ".local_call_tree_full" },
  /* row  37 */   { (MR_String) ".local_call_tree_order" },
  /* row  38 */   { (MR_String) ".mlds_dump" },
  /* row  39 */   { (MR_String) ".mode_constraints" },
  /* row  40 */   { (MR_String) ".order" },
  /* row  41 */   { (MR_String) ".order_trans_opt" },
  /* row  42 */   { (MR_String) ".type_repns" },
  /* row  43 */   { (MR_String) ".ugly" },
  /* row  44 */   { (MR_String) ".xml" },
  /* row  45 */   { (MR_String) "optdates" },
  /* row  46 */   { (MR_String) "trans_opt_dates" },
  /* row  47 */   { (MR_String) "cs" },
  /* row  48 */   { (MR_String) "css" },
  /* row  49 */   { (MR_String) "c_dates" },
  /* row  50 */   { (MR_String) "cs_dates" },
  /* row  51 */   { (MR_String) "java_dates" },
  /* row  52 */   { (MR_String) "cs" },
  /* row  53 */   { (MR_String) "analysis_dates" },
  /* row  54 */   { (MR_String) "analysis_statuss" },
  /* row  55 */   { (MR_String) "err_dates" },
  /* row  56 */   { (MR_String) "useds" },
  /* row  57 */   { (MR_String) "track_flags" },
  /* row  58 */   { (MR_String) "optdates" },
  /* row  59 */   { (MR_String) "trans_opt_dates" },
  /* row  60 */   { (MR_String) "cs" },
  /* row  61 */   { (MR_String) "css" },
  /* row  62 */   { (MR_String) "c_dates" },
  /* row  63 */   { (MR_String) "cs_dates" },
  /* row  64 */   { (MR_String) "java_dates" },
  /* row  65 */   { (MR_String) "cs" },
  /* row  66 */   { (MR_String) "analysis_dates" },
  /* row  67 */   { (MR_String) "analysis_statuss" },
  /* row  68 */   { (MR_String) "err_dates" },
  /* row  69 */   { (MR_String) "useds" },
  /* row  70 */   { (MR_String) "track_flags" },
  /* row  71 */   { (MR_String) ".optdate" },
  /* row  72 */   { (MR_String) ".trans_opt_date" },
  /* row  73 */   { (MR_String) ".c" },
  /* row  74 */   { (MR_String) ".cs" },
  /* row  75 */   { (MR_String) ".c_date" },
  /* row  76 */   { (MR_String) ".cs_date" },
  /* row  77 */   { (MR_String) ".java_date" },
  /* row  78 */   { (MR_String) "_init.c" },
  /* row  79 */   { (MR_String) ".analysis_date" },
  /* row  80 */   { (MR_String) ".analysis_status" },
  /* row  81 */   { (MR_String) ".err_date" },
  /* row  82 */   { (MR_String) ".used" },
  /* row  83 */   { (MR_String) ".track_flags" },
  /* row  84 */   { (MR_String) ".defn_extents" },
  /* row  85 */   { (MR_String) ".defn_line_counts" },
  /* row  86 */   { (MR_String) ".defns" },
  /* row  87 */   { (MR_String) ".dependency_graph" },
  /* row  88 */   { (MR_String) ".hlds_dump" },
  /* row  89 */   { (MR_String) ".imports_graph" },
  /* row  90 */   { (MR_String) ".local_call_tree" },
  /* row  91 */   { (MR_String) ".local_call_tree_full" },
  /* row  92 */   { (MR_String) ".local_call_tree_order" },
  /* row  93 */   { (MR_String) ".mlds_dump" },
  /* row  94 */   { (MR_String) ".mode_constraints" },
  /* row  95 */   { (MR_String) ".order" },
  /* row  96 */   { (MR_String) ".order_trans_opt" },
  /* row  97 */   { (MR_String) ".type_repns" },
  /* row  98 */   { (MR_String) ".ugly" },
  /* row  99 */   { (MR_String) ".xml" },
  /* row 100 */   { (MR_String) "optdates" },
  /* row 101 */   { (MR_String) "trans_opt_dates" },
  /* row 102 */   { (MR_String) "cs" },
  /* row 103 */   { (MR_String) "css" },
  /* row 104 */   { (MR_String) "c_dates" },
  /* row 105 */   { (MR_String) "cs_dates" },
  /* row 106 */   { (MR_String) "java_dates" },
  /* row 107 */   { (MR_String) "cs" },
  /* row 108 */   { (MR_String) "analysis_dates" },
  /* row 109 */   { (MR_String) "analysis_statuss" },
  /* row 110 */   { (MR_String) "err_dates" },
  /* row 111 */   { (MR_String) "useds" },
  /* row 112 */   { (MR_String) "track_flags" },
  /* row 113 */   { (MR_String) "optdates" },
  /* row 114 */   { (MR_String) "trans_opt_dates" },
  /* row 115 */   { (MR_String) "cs" },
  /* row 116 */   { (MR_String) "css" },
  /* row 117 */   { (MR_String) "c_dates" },
  /* row 118 */   { (MR_String) "cs_dates" },
  /* row 119 */   { (MR_String) "java_dates" },
  /* row 120 */   { (MR_String) "cs" },
  /* row 121 */   { (MR_String) "analysis_dates" },
  /* row 122 */   { (MR_String) "analysis_statuss" },
  /* row 123 */   { (MR_String) "err_dates" },
  /* row 124 */   { (MR_String) "useds" },
  /* row 125 */   { (MR_String) "track_flags" },
  /* row 126 */   { (MR_String) ".defn_extents" },
  /* row 127 */   { (MR_String) ".defn_line_counts" },
  /* row 128 */   { (MR_String) ".defns" },
  /* row 129 */   { (MR_String) ".dependency_graph" },
  /* row 130 */   { (MR_String) ".hlds_dump" },
  /* row 131 */   { (MR_String) ".imports_graph" },
  /* row 132 */   { (MR_String) ".local_call_tree" },
  /* row 133 */   { (MR_String) ".local_call_tree_full" },
  /* row 134 */   { (MR_String) ".local_call_tree_order" },
  /* row 135 */   { (MR_String) ".mlds_dump" },
  /* row 136 */   { (MR_String) ".mode_constraints" },
  /* row 137 */   { (MR_String) ".order" },
  /* row 138 */   { (MR_String) ".order_trans_opt" },
  /* row 139 */   { (MR_String) ".type_repns" },
  /* row 140 */   { (MR_String) ".ugly" },
  /* row 141 */   { (MR_String) ".xml" },
  /* row 142 */   { (MR_String) ".optdate" },
  /* row 143 */   { (MR_String) ".trans_opt_date" },
  /* row 144 */   { (MR_String) ".c" },
  /* row 145 */   { (MR_String) ".cs" },
  /* row 146 */   { (MR_String) ".c_date" },
  /* row 147 */   { (MR_String) ".cs_date" },
  /* row 148 */   { (MR_String) ".java_date" },
  /* row 149 */   { (MR_String) "_init.c" },
  /* row 150 */   { (MR_String) ".analysis_date" },
  /* row 151 */   { (MR_String) ".analysis_status" },
  /* row 152 */   { (MR_String) ".err_date" },
  /* row 153 */   { (MR_String) ".used" },
  /* row 154 */   { (MR_String) ".track_flags" },
};
...
#line 1690 "file_names.m"
void 
parse_tree__file_names__user_init_pred_145_0(void)
#line 1690 "file_names.m"
{
#line 1690 "file_names.m"
...
#line 1716 "file_names.m"
void 
parse_tree__file_names__user_init_pred_148_0(void)
#line 1716 "file_names.m"
{
#line 1716 "file_names.m"
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 2:
        switch (MR_tag((MR_Word) HeadVar__3_3)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ArgX1_8 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 3);
              MR_Word ArgY1_9 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_ExtSchDirMap_38)
{
  ...
  *STATE_VARIABLE_NumLookups_34 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumLookups_0_33 + (MR_Unsigned) Count_20);
  ...
  switch (MR_tag((MR_Word) Ext_22)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_5[126 + ExtCur_44]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_47 = ((MR_Unsigned) ((MR_hl_field(2, Ext_22, (MR_Integer) 0))) & (MR_Integer) 3);
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_String _SubDirName_56;

            parse_tree__file_names__ext_cur_gas_extension_dir_4_p_0(Globals_12, ExtCurGas_48, &ExtStr0_25, &_SubDirName_56);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_5[142 + ExtCurNgsGs_49]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 580, &Str0_65);
                  ExtStr0_25 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_65);
                }
                break;
              case (MR_Integer) 8:
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 581, &Str0_72);
                  ExtStr0_25 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_72);
                }
                break;
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 7:
          {
            ...
            MR_String _SubDirName_64;

            parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_54, &ExtStr0_25, &_SubDirName_64);
          }
          break;
      }
      break;
  ...
  MR_Word * DirNamesProposed_10)
{
  switch (MR_tag((MR_Word) Ext_8)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_16 = ((MR_Unsigned) ((MR_hl_field(2, Ext_8, (MR_Integer) 0))) & (MR_Integer) 3);
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__compute_grade__grade_directory_component_2_p_0(Globals_6, &Grade_146);
              libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 727, &TargetArch_147);
              {
                Var_154 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_154, 0) = ((MR_Box) (SubDirName_37));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_gas_extension_dir_4_p_0(Globals_6, ExtCurGas_17, &_ExtStr_43, &SubDirName_45);
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_6, &Grade_131);
                  libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 727, &TargetArch_132);
                  {
                    Var_139 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_139, 0) = ((MR_Box) (SubDirName_45));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_137, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, Var_137, 1) = ((MR_Box) (Var_139));
                  }
                  {
                    Var_136 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_136, 0) = ((MR_Box) (TargetArch_132));
                    MR_hl_field(1, Var_136, 1) = ((MR_Box) (Var_137));
                  }
                  {
                    Var_135 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_135, 0) = ((MR_Box) (Grade_131));
                  ...
                  }
                  {
                    ...
                    *DirNamesLegacy_9 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, base, 1) = ((MR_Box) (Var_135));
                  }
                  {
                    Var_144 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_144, 0) = ((MR_Box) (TargetArch_132));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_143, 0) = ((MR_Box) (Grade_131));
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (SubdirSetting_59) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_56 = ((&parse_tree__file_names_vector_common_5[100 + ExtCurNgsGs_18]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_53 = ((&parse_tree__file_names_vector_common_5[113 + ExtCurNgsGs_18]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
        ...
        case (MR_Integer) 7:
          {
            ...
            switch (SubdirSetting_129) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_126;
                  MR_String _ExtStr_124;

                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_27, &_ExtStr_124, &SubDirName_126);
                  switch (Search_7) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_123;
                  MR_String _ExtStr_121;

                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_27, &_ExtStr_121, &SubDirName_123);
  ...
  MR_String * CurDirFileName_6)
{
  ...
  ExtStr_8 = ((&parse_tree__file_names_vector_common_5[84 + ExtCur_4]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNamesProposed_17 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtCur_179 = ((MR_Unsigned) ((MR_hl_field(0, Ext_14, (MR_Integer) 0))) & (MR_Integer) 15);
        ExtStr_20 = ((&parse_tree__file_names_vector_common_5[29 + ExtCur_179]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        MR_Word ExtCurNgs_180;
        MR_String _SubDirName_181;
        ...
        BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
        ExtCurNgs_180 = ((MR_Unsigned) ((MR_hl_field(1, Ext_14, (MR_Integer) 0))) & (MR_Integer) 15);
        parse_tree__file_names__ext_cur_ngs_extension_dir_3_p_0(ExtCurNgs_180, &ExtStr_20, &_SubDirName_181);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_30 = ((MR_Unsigned) ((MR_hl_field(2, Ext_14, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word SubdirSetting_51;
        MR_Word ExtCurGs_182;
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__compute_grade__grade_directory_component_2_p_0(Globals_10, &Grade_99);
              libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 727, &TargetArch_100);
              {
                Var_107 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_107, 0) = ((MR_Box) (SubDirName_50));
                MR_hl_field(1, Var_107, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_105, 0) = ((MR_Box) ((MR_String) "Mercury"));
                MR_hl_field(1, Var_105, 1) = ((MR_Box) (Var_107));
              }
              {
                Var_104 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_104, 0) = ((MR_Box) (TargetArch_100));
                MR_hl_field(1, Var_104, 1) = ((MR_Box) (Var_105));
              }
              {
                Var_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_103, 0) = ((MR_Box) (Grade_99));
              ...
              }
              {
                ...
                MR_hl_field(1, Var_111, 0) = ((MR_Box) (Grade_99));
              ...
              }
              {
                ...
                *DirNamesProposed_17 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) ((MR_String) "MercurySystem"));
                MR_hl_field(1, base, 1) = ((MR_Box) (Var_110));
              }
            }
            break;
        }
        BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
        ExtCurGs_182 = ((MR_Unsigned) ((MR_hl_field(2, Ext_14, (MR_Integer) 0))) & (MR_Integer) 3);
        switch (ExtCurGs_182) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ExtCurGas_183;
            MR_String _SubDirName_191;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_gas_extension_dir_4_p_0(Globals_10, ExtCurGas_31, &_ExtStr_52, &SubDirName_53);
                  libs__compute_grade__grade_directory_component_2_p_0(Globals_10, &Grade_84);
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 727, &TargetArch_85);
                  {
                    Var_92 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_92, 0) = ((MR_Box) (SubDirName_53));
                    MR_hl_field(1, Var_92, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_90, 0) = ((MR_Box) ((MR_String) "Mercury"));
                    MR_hl_field(1, Var_90, 1) = ((MR_Box) (Var_92));
                  }
                  {
                    Var_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_89, 0) = ((MR_Box) (TargetArch_85));
                    MR_hl_field(1, Var_89, 1) = ((MR_Box) (Var_90));
                  }
                  {
                    Var_88 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_88, 0) = ((MR_Box) (Grade_84));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_97, 0) = ((MR_Box) (TargetArch_85));
                    MR_hl_field(1, Var_97, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Var_96 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_96, 0) = ((MR_Box) (Grade_84));
            ...
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurGas_183 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            parse_tree__file_names__ext_cur_gas_extension_dir_4_p_0(Globals_10, ExtCurGas_183, &ExtStr_20, &_SubDirName_191);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            switch (SubdirSetting_59) {
              ...
              case (MR_Integer) 2:
                {
                  MR_String SubDirName_58 = ((&parse_tree__file_names_vector_common_5[45 + ExtCurNgsGs_32]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
              ...
              case (MR_Integer) 1:
                {
                  MR_String SubDirName_56 = ((&parse_tree__file_names_vector_common_5[58 + ExtCurNgsGs_32]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
            ...
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGs_184 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            ExtStr_20 = ((&parse_tree__file_names_vector_common_5[71 + ExtCurNgsGs_184]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGas_185 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 15);
            switch (ExtCurNgsGas_185) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 6:
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 580, &Str0_200);
                  ExtStr_20 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_200);
                }
                break;
              case (MR_Integer) 8:
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 581, &Str0_207);
                  ExtStr_20 = mercury__string__f_43_43_2_f_0((MR_String) "_init", Str0_207);
                }
                break;
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 4:
          {
            ...
            *DirNamesProposed_17 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DirNamesProposed0_38, (MR_Word) (MR_mkword(1, &parse_tree__file_names_scalar_common_2[1])));
            ...
            ExtCurNgsGsJava_187 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 1);
            switch (ExtCurNgsGsJava_187) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 7:
          {
            ...
            MR_Word ExtCurNgsGsMaxNgs_189;
            MR_String _SubDirName_199;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_41, &_ExtStr_80, &SubDirName_81);
                  switch (Search_12) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_41, &_ExtStr_78, &SubDirName_79);
                  parse_tree__file_names__make_ngs_dir_names_3_p_0(SubDirName_79, DirNamesLegacy_16, DirNamesProposed_17);
                }
                break;
            }
            BaseNameNoExt_19 = mdbcomp__sym_name__sym_name_to_string_sep_2_f_0(ModuleName_15, (MR_String) ".");
            ExtCurNgsGsMaxNgs_189 = ((MR_Unsigned) ((MR_hl_field(3, Ext_14, (MR_Integer) 1))) & (MR_Integer) 7);
            parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_189, &ExtStr_20, &_SubDirName_199);
          }
          break;
      }
      break;
...
void MR_CALL 
parse_tree__file_names__ext_cur_ngs_max_cur_extension_dir_3_p_0(
  MR_String * Str_5,
  MR_String * Dir_6)
{
  parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(Str_5, Dir_6);
}

void MR_CALL 
parse_tree__file_names__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_101_120_116_95_99_117_114_95_110_103_115_95_109_97_120_95_99_117_114_95_101_120_116_101_110_115_105_111_110_95_100_105_114_95_95_91_49_93_95_48_3_p_0(
  MR_String * Str_5,
  MR_String * Dir_6)
{
  *Str_5 = (MR_String) ".mh";
...
void MR_CALL 
parse_tree__file_names__ext_cur_gs_extension_dir_3_p_0(
  MR_Word Ext_4,
  MR_String * Str_5,
  MR_String * Dir_6)
{
  switch (Ext_4) {
    ...
    case (MR_Integer) 0:
      {
        *Str_5 = (MR_String) ".init";
        *Dir_6 = (MR_String) "inits";
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word Ext_5)
{
  ...
  switch (MR_tag((MR_Word) Ext_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word ExtCurGs_10 = ((MR_Unsigned) ((MR_hl_field(2, Ext_5, (MR_Integer) 0))) & (MR_Integer) 3);
        ...
        case (MR_Integer) 0:
          {
            ...
            parse_tree__file_names__ext_cur_gas_extension_dir_4_p_0(Globals_4, ExtCurGas_11, &ExtStr_6, &_SubDirName_20);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_5[16 + ExtCurNgsGs_12]))->parse_tree__file_names__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
              ...
              case (MR_Integer) 9:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 580, &Str0_36);
              ...
              case (MR_Integer) 10:
                {
                  ...
                  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 581, &Str0_43);
        ...
        case (MR_Integer) 7:
          {
            ...
            parse_tree__file_names__ext_cur_ngs_gs_max_ngs_extension_dir_3_p_0(ExtCurNgsGsMaxNgs_17, &ExtStr_6, &_SubDirName_35);
          }
          break;
      }
      break;
  ...
  MR_String * Dir_8)
{
  switch (Ext_6) {
    ...
    case (MR_Integer) 3:
      {
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 633, Str_7);
        *Dir_8 = (MR_String) "bin";
      }
      break;
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 7:
      {
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 632, Str_7);
        *Dir_8 = (MR_String) "lib";
      }
      break;
    case (MR_Integer) 8:
      {
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 631, Str_7);
        *Dir_8 = (MR_String) "lib";
      }
      break;
  }
...
void mercury__parse_tree__file_names__required_init(void)
{
	...
	parse_tree__file_names__user_init_pred_145_0();
	parse_tree__file_names__user_init_pred_148_0();
