...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[198];
...
static /* final */ const struct parse_tree__file_names__vector_common_type_4_0_s parse_tree__file_names_vector_common_4[198] = {
  ...
  /* row  46 */   { (MR_String) ".mbc" },
  /* row  47 */   { (MR_String) ".bytedebug" },
  /* row  48 */   { (MR_String) ".module_dep" },
  /* row  49 */   { (MR_String) ".err_date" },
  /* row  50 */   { (MR_String) ".prof" },
  /* row  51 */   { (MR_String) ".opt" },
  /* row  52 */   { (MR_String) ".trans_opt" },
  /* row  53 */   { (MR_String) ".analysis" },
  /* row  54 */   { (MR_String) ".imdg" },
  /* row  55 */   { (MR_String) ".request" },
  /* row  56 */   { (MR_String) ".mh" },
  /* row  57 */   { (MR_String) ".all_int3s" },
  /* row  58 */   { (MR_String) ".all_ints" },
  /* row  59 */   { (MR_String) ".all_opts" },
  /* row  60 */   { (MR_String) ".all_trans_opts" },
  /* row  61 */   { (MR_String) ".check" },
  /* row  62 */   { (MR_String) ".classes" },
  /* row  63 */   { (MR_String) ".clean" },
  /* row  64 */   { (MR_String) ".depend" },
  /* row  65 */   { (MR_String) ".install_grade_hdrs" },
  /* row  66 */   { (MR_String) ".install_hdrs" },
  /* row  67 */   { (MR_String) ".install_ints" },
  /* row  68 */   { (MR_String) ".install_opts" },
  /* row  69 */   { (MR_String) ".int3s" },
  /* row  70 */   { (MR_String) ".ints" },
  /* row  71 */   { (MR_String) ".javas" },
  /* row  72 */   { (MR_String) ".opts" },
  /* row  73 */   { (MR_String) ".realclean" },
  /* row  74 */   { (MR_String) ".trans_opts" },
  /* row  75 */   { (MR_String) ".defn_extents" },
  /* row  76 */   { (MR_String) ".defn_line_counts" },
  /* row  77 */   { (MR_String) ".defns" },
  /* row  78 */   { (MR_String) ".dependency_graph" },
  /* row  79 */   { (MR_String) ".err" },
  /* row  80 */   { (MR_String) ".hlds_dump" },
  /* row  81 */   { (MR_String) ".imports_graph" },
  /* row  82 */   { (MR_String) ".local_call_tree" },
  /* row  83 */   { (MR_String) ".local_call_tree_full" },
  /* row  84 */   { (MR_String) ".local_call_tree_order" },
  /* row  85 */   { (MR_String) ".mlds_dump" },
  /* row  86 */   { (MR_String) ".mode_constraints" },
  /* row  87 */   { (MR_String) ".order" },
  /* row  88 */   { (MR_String) ".order_trans_opt" },
  /* row  89 */   { (MR_String) ".type_repns" },
  /* row  90 */   { (MR_String) ".ugly" },
  /* row  91 */   { (MR_String) ".xml" },
  /* row  92 */   { (MR_String) "int0s" },
  /* row  93 */   { (MR_String) "ints" },
  /* row  94 */   { (MR_String) "int2s" },
  /* row  95 */   { (MR_String) "int3s" },
  /* row  96 */   { (MR_String) "date0s" },
  /* row  97 */   { (MR_String) "dates" },
  /* row  98 */   { (MR_String) "date3s" },
  /* row  99 */   { (MR_String) "ds" },
  /* row 100 */   { (MR_String) "deps" },
  /* row 101 */   { (MR_String) "deps" },
  /* row 102 */   { (MR_String) "mbcs" },
  /* row 103 */   { (MR_String) "bytedebugs" },
  /* row 104 */   { (MR_String) "module_deps" },
  /* row 105 */   { (MR_String) "err_dates" },
  /* row 106 */   { (MR_String) "profs" },
  /* row 107 */   { (MR_String) ".int0" },
  /* row 108 */   { (MR_String) ".int" },
  /* row 109 */   { (MR_String) ".int2" },
  /* row 110 */   { (MR_String) ".int3" },
  /* row 111 */   { (MR_String) ".date0" },
  /* row 112 */   { (MR_String) ".date" },
  /* row 113 */   { (MR_String) ".date3" },
  /* row 114 */   { (MR_String) ".d" },
  /* row 115 */   { (MR_String) ".dv" },
  /* row 116 */   { (MR_String) ".dep" },
  /* row 117 */   { (MR_String) ".mbc" },
  /* row 118 */   { (MR_String) ".bytedebug" },
  /* row 119 */   { (MR_String) ".module_dep" },
  /* row 120 */   { (MR_String) ".err_date" },
  /* row 121 */   { (MR_String) ".prof" },
  /* row 122 */   { (MR_String) ".opt" },
  /* row 123 */   { (MR_String) ".trans_opt" },
  /* row 124 */   { (MR_String) ".analysis" },
  /* row 125 */   { (MR_String) ".imdg" },
  /* row 126 */   { (MR_String) ".request" },
  /* row 127 */   { (MR_String) "int0s" },
  /* row 128 */   { (MR_String) "ints" },
  /* row 129 */   { (MR_String) "int2s" },
  /* row 130 */   { (MR_String) "int3s" },
  /* row 131 */   { (MR_String) "date0s" },
  /* row 132 */   { (MR_String) "dates" },
  /* row 133 */   { (MR_String) "date3s" },
  /* row 134 */   { (MR_String) "ds" },
  /* row 135 */   { (MR_String) "deps" },
  /* row 136 */   { (MR_String) "deps" },
  /* row 137 */   { (MR_String) "mbcs" },
  /* row 138 */   { (MR_String) "bytedebugs" },
  /* row 139 */   { (MR_String) "module_deps" },
  /* row 140 */   { (MR_String) "err_dates" },
  /* row 141 */   { (MR_String) "profs" },
  /* row 142 */   { (MR_String) ".mh" },
  /* row 143 */   { (MR_String) ".all_int3s" },
  /* row 144 */   { (MR_String) ".all_ints" },
  /* row 145 */   { (MR_String) ".all_opts" },
  /* row 146 */   { (MR_String) ".all_trans_opts" },
  /* row 147 */   { (MR_String) ".check" },
  /* row 148 */   { (MR_String) ".classes" },
  /* row 149 */   { (MR_String) ".clean" },
  /* row 150 */   { (MR_String) ".depend" },
  /* row 151 */   { (MR_String) ".install_grade_hdrs" },
  /* row 152 */   { (MR_String) ".install_hdrs" },
  /* row 153 */   { (MR_String) ".install_ints" },
  /* row 154 */   { (MR_String) ".install_opts" },
  /* row 155 */   { (MR_String) ".int3s" },
  /* row 156 */   { (MR_String) ".ints" },
  /* row 157 */   { (MR_String) ".javas" },
  /* row 158 */   { (MR_String) ".opts" },
  /* row 159 */   { (MR_String) ".realclean" },
  /* row 160 */   { (MR_String) ".trans_opts" },
  /* row 161 */   { (MR_String) ".defn_extents" },
  /* row 162 */   { (MR_String) ".defn_line_counts" },
  /* row 163 */   { (MR_String) ".defns" },
  /* row 164 */   { (MR_String) ".dependency_graph" },
  /* row 165 */   { (MR_String) ".err" },
  /* row 166 */   { (MR_String) ".hlds_dump" },
  /* row 167 */   { (MR_String) ".imports_graph" },
  /* row 168 */   { (MR_String) ".local_call_tree" },
  /* row 169 */   { (MR_String) ".local_call_tree_full" },
  /* row 170 */   { (MR_String) ".local_call_tree_order" },
  /* row 171 */   { (MR_String) ".mlds_dump" },
  /* row 172 */   { (MR_String) ".mode_constraints" },
  /* row 173 */   { (MR_String) ".order" },
  /* row 174 */   { (MR_String) ".order_trans_opt" },
  /* row 175 */   { (MR_String) ".type_repns" },
  /* row 176 */   { (MR_String) ".ugly" },
  /* row 177 */   { (MR_String) ".xml" },
  /* row 178 */   { (MR_String) ".int0" },
  /* row 179 */   { (MR_String) ".int" },
  /* row 180 */   { (MR_String) ".int2" },
  /* row 181 */   { (MR_String) ".int3" },
  /* row 182 */   { (MR_String) ".date0" },
  /* row 183 */   { (MR_String) ".date" },
  /* row 184 */   { (MR_String) ".date3" },
  /* row 185 */   { (MR_String) ".d" },
  /* row 186 */   { (MR_String) ".dv" },
  /* row 187 */   { (MR_String) ".dep" },
  /* row 188 */   { (MR_String) ".mbc" },
  /* row 189 */   { (MR_String) ".bytedebug" },
  /* row 190 */   { (MR_String) ".module_dep" },
  /* row 191 */   { (MR_String) ".err_date" },
  /* row 192 */   { (MR_String) ".prof" },
  /* row 193 */   { (MR_String) ".opt" },
  /* row 194 */   { (MR_String) ".trans_opt" },
  /* row 195 */   { (MR_String) ".analysis" },
  /* row 196 */   { (MR_String) ".imdg" },
  /* row 197 */   { (MR_String) ".request" },
};
    ...
    case (MR_Integer) 0:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[142 + ExtCur_44]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[178 + ExtCurNgs_45]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr0_25 = ((&parse_tree__file_names_vector_common_4[193 + ExtCurNgsGsMaxNgs_51]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_11) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_13 = ((&parse_tree__file_names_vector_common_4[127 + ExtCurNgs_10]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_128;
    ...
    case (MR_Integer) 0:
      {
        ...
        *DirNames_15 = (MR_Word) ((MR_Unsigned) 0U);
        ...
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[56 + ExtCur_177]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        switch (SubdirSetting_25) {
          ...
          case (MR_Integer) 1:
            {
              MR_String SubDirName_27 = ((&parse_tree__file_names_vector_common_4[92 + ExtCurNgs_24]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
              MR_Word Var_115;
        ...
        ExtStr_18 = ((&parse_tree__file_names_vector_common_4[107 + ExtCurNgs_178]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_18 = ((&parse_tree__file_names_vector_common_4[122 + ExtCurNgsGsMaxNgs_184]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
        ...
        case (MR_Integer) 3:
          {
            ...
            ExtStr_6 = ((&parse_tree__file_names_vector_common_4[51 + ExtCurNgsGsMaxNgs_14]))->parse_tree__file_names__vector_common_type_4_0__vct_4_f_0;
          }
          break;
      }
      break;
