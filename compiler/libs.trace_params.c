  ...
  MR_Word Port_13)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_14_20 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
      {
      ...
      succeeded = mercury__set__member_2_p_0(TypeCtorInfo_14_20, ((MR_Box) (Var_18)), SuppressItems_12);
    }
    succeeded = !(succeeded);
  }
  if (succeeded)
  ...
  MR_Word SuppressItems_11)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo_9_15 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
    succeeded = mercury__set__member_2_p_0(TypeCtorInfo_9_15, ((MR_Box) (Var_14)), SuppressItems_11);
    succeeded = !(succeeded);
  }
  if (succeeded)
