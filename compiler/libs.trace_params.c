  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_14_14 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_12, 0) = (MR_Box) ((MR_Unsigned) (Port_7));
      }
  ...
  MR_Word TraceLevel_9)
{
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Origin_11)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word IsExported_44;
              MR_Word AddressTaken_45;

              hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_43);
              IsExported_44 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_43);
              hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_45);
              succeeded = (IsExported_44 == (MR_Integer) 0);
              if (succeeded)
                succeeded = (AddressTaken_45 == (MR_Integer) 1);
              if (succeeded)
              {
                MR_Word ProcHasUserEvent_46;

                hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_46);
                switch (ProcHasUserEvent_46) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    {
                      MR_Word ModuleHasUserEvent_47;

                      hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_47);
                      switch (ModuleHasUserEvent_47) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          EffTraceLevel_10 = (MR_Integer) 0;
                          break;
      ...
      case (MR_Integer) 2:
        {
          MR_Word SpecialPred_12 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_11, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 8:
            {
              MR_Word Transform_14 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 1))));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Word IsExported_54;
                      MR_Word AddressTaken_55;

                      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_53);
                      IsExported_54 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_53);
                      hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_55);
                      succeeded = (IsExported_54 == (MR_Integer) 0);
                      if (succeeded)
                        succeeded = (AddressTaken_55 == (MR_Integer) 1);
                      if (succeeded)
                      {
                        MR_Word ProcHasUserEvent_56;

                        hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_56);
                        switch (ProcHasUserEvent_56) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                              MR_Word ModuleHasUserEvent_57;

                              hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_57);
                              switch (ModuleHasUserEvent_57) {
                                default: /*NOTREACHED*/ MR_assert(0);
                                case (MR_Integer) 1:
                                  EffTraceLevel_10 = (MR_Integer) 0;
                                  break;
