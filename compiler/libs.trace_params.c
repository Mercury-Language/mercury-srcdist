        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) libs__trace_params__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word libs__trace_params__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__trace_params__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Integer libs__trace_params__Var_16 = (MR_Integer) libs__trace_params__Var_15;
                  MR_Integer libs__trace_params__Var_17 = (MR_Integer) libs__trace_params__Var_5;
...
{
  {
    ...
    if (libs__trace_params__succeeded)
      ...
      switch (MR_tag((MR_Word) libs__trace_params__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word libs__trace_params__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__trace_params__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word libs__trace_params__Var_4;

            libs__trace_params__succeeded = ((MR_tag((MR_Word) libs__trace_params__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (libs__trace_params__succeeded)
              {
                libs__trace_params__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__trace_params__HeadVar__2_2, (MR_Integer) 0)));
                libs__trace_params__succeeded = (libs__trace_params__Var_3 == libs__trace_params__Var_4);
              }
          }
          break;
      }
