  ...
  MR_Word TraceLevel_9)
{
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Origin_11)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word IsExported_39;
              MR_Word AddressTaken_40;

              hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_38);
              IsExported_39 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_38);
              hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_40);
              succeeded = (IsExported_39 == (MR_Integer) 0);
              if (succeeded)
                succeeded = (AddressTaken_40 == (MR_Integer) 1);
              if (succeeded)
              {
                MR_Word ProcHasUserEvent_41;

                hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_41);
                switch (ProcHasUserEvent_41) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    {
                      MR_Word ModuleHasUserEvent_42;

                      hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_42);
                      switch (ModuleHasUserEvent_42) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          EffTraceLevel_10 = (MR_Integer) 0;
                          break;
      ...
      case (MR_Integer) 1:
        {
          MR_Word OriginCompiler_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_11, (MR_Integer) 0))));
          MR_Word SpecialPred_17;

          succeeded = ((MR_tag((MR_Word) OriginCompiler_16)) == (MR_Integer) 1);
          if (succeeded)
          {
            SpecialPred_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), OriginCompiler_16, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 3:
        {
          MR_Word ProcTransform_12 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 0))));
          ...
          if (succeeded)
            ...
            switch (TraceLevel_9) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word PredStatus_48;
                  MR_Word IsExported_49;
                  MR_Word AddressTaken_50;

                  hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_48);
                  IsExported_49 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_48);
                  hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_50);
                  succeeded = (IsExported_49 == (MR_Integer) 0);
                  if (succeeded)
                    succeeded = (AddressTaken_50 == (MR_Integer) 1);
                  if (succeeded)
                  {
