  ...
  MR_Integer * SuppressedEventsInt_6)
{
  switch (MR_tag((MR_Word) SuppressItem_4)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Port_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), SuppressItem_4, (MR_Integer) 0)));
        MR_Integer Var_8;
...
{
  {
    ...
    *HeadVar__2_2 = base;
    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Port_3));
  }
}
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_8, 0) = ((MR_Box) (PortName_5));
      }
      {
        MR_Word base;
...
{
  {
    ...
    if (succeeded)
    {
      if (((MR_Integer) 30 & (((MR_Integer) 1 << Var_14))))
      {
        succeeded = MR_TRUE;
      }
      else
      ...
      if (succeeded)
      {
        TypeCtorInfo_14_24 = (MR_Word) &libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0;
        {
          ...
          MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (Port_13));
        }
...
{
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) Origin_11)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word SpecialPred_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Origin_11, (MR_Integer) 0)));
            MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Origin_11, (MR_Integer) 1)));
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word PredCreation_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      Var_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
...
{
  {
    ...
    if (((MR_Integer) 62 & (((MR_Integer) 1 << TraceLevel_4))))
    {
      succeeded = MR_TRUE;
    }
    else
