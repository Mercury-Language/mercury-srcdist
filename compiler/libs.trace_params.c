...
static const MR_EnumFunctorDescPtr libs__trace_params__libs__trace_params__enum_ordinal_ordered_trace_level_0[6];
...
static /* final */ const struct libs__trace_params__vector_common_type_7_0_s libs__trace_params_vector_common_7[6];

struct libs__trace_params__vector_common_type_8_0_s {
  const MR_Word libs__trace_params__vector_common_type_8_0__vct_8_f_0;
};

static /* final */ const struct libs__trace_params__vector_common_type_8_0_s libs__trace_params_vector_common_8[54];

struct libs__trace_params__vector_common_type_9_0_s {
  const MR_Word libs__trace_params__vector_common_type_9_0__vct_9_f_0;
};

static /* final */ const struct libs__trace_params__vector_common_type_9_0_s libs__trace_params_vector_common_9[12];
...
struct libs__trace_params__vector_common_type_12_0_s {
  const MR_String libs__trace_params__vector_common_type_12_0__vct_12_f_0;
};
...
libs__trace_params__trace_level_rep_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&libs__trace_params_vector_common_12[0 + HeadVar__1_1]))->libs__trace_params__vector_common_type_12_0__vct_12_f_0;
  ...
  MR_Word Port_13)
{
  ...
  MR_Word Category_15;
  MR_Word Var_16;
  MR_Word TypeCtorInfo__14_20;
  MR_Word Var_18;

  Var_14 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_8, PredInfo_9, ProcInfo_10, TraceLevel_11);
  Category_15 = ((&libs__trace_params_vector_common_10[0 + Port_13]))->libs__trace_params__vector_common_type_10_0__vct_10_f_0;
  Var_16 = ((&libs__trace_params_vector_common_11[0 + Var_14]))->libs__trace_params__vector_common_type_11_0__vct_11_f_0;
  succeeded = mercury__list__member_2_p_0((MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_port_category_0), ((MR_Box) (Category_15)), Var_16);
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__14_20 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
      {
        Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_18, 0) = (MR_Box) ((MR_Unsigned) (Port_13));
      }
      succeeded = mercury__set__member_2_p_0(TypeCtorInfo__14_20, ((MR_Box) (Var_18)), SuppressItems_12);
    }
    succeeded = !(succeeded);
  }
  if (succeeded)
  ...
  MR_Word SuppressItems_11)
{
  ...
  if (succeeded)
  {
    Var_14 = (MR_Word) ((MR_Unsigned) 4U);
    TypeCtorInfo__9_15 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
    succeeded = mercury__set__member_2_p_0(TypeCtorInfo__9_15, ((MR_Box) (Var_14)), SuppressItems_11);
    succeeded = !(succeeded);
  }
  if (succeeded)
  ...
  MR_Word TraceLevel_9)
{
  ...
  HeadVar__5_5 = ((&libs__trace_params_vector_common_8[48 + Var_10]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
  return HeadVar__5_5;
}
  ...
  MR_Word TraceLevel_9)
{
  ...
  Var_10 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_6, PredInfo_7, ProcInfo_8, TraceLevel_9);
  HeadVar__5_5 = ((&libs__trace_params_vector_common_8[42 + Var_10]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
  return HeadVar__5_5;
}
  ...
  MR_Word TraceLevel_9)
{
  ...
  Var_10 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_6, PredInfo_7, ProcInfo_8, TraceLevel_9);
  HeadVar__5_5 = ((&libs__trace_params_vector_common_8[36 + Var_10]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
  return HeadVar__5_5;
}
  ...
  MR_Word TraceLevel_9)
{
  ...
  Var_10 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_6, PredInfo_7, ProcInfo_8, TraceLevel_9);
  HeadVar__5_5 = ((&libs__trace_params_vector_common_8[30 + Var_10]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
  return HeadVar__5_5;
}

MR_Word MR_CALL 
libs__trace_params__is_exec_trace_enabled_at_eff_trace_level_4_f_0(
  MR_Word ModuleInfo_6,
  MR_Word PredInfo_7,
  MR_Word ProcInfo_8,
  MR_Word TraceLevel_9)
{
  ...
  Var_10 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_6, PredInfo_7, ProcInfo_8, TraceLevel_9);
  HeadVar__5_5 = ((&libs__trace_params_vector_common_9[6 + Var_10]))->libs__trace_params__vector_common_type_9_0__vct_9_f_0;
  return HeadVar__5_5;
}
  ...
  MR_Word TraceSuppressItems_5)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo__9_9 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
    succeeded = mercury__set__member_2_p_0(TypeCtorInfo__9_9, ((MR_Box) (Var_8)), TraceSuppressItems_5);
    succeeded = !(succeeded);
  }
  if (succeeded)
    Need_6 = (MR_Integer) 1;
...
libs__trace_params__trace_level_needs_meaningful_var_names_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_Word HeadVar__2_2 = ((&libs__trace_params_vector_common_8[24 + HeadVar__1_1]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
...
libs__trace_params__trace_level_allows_tail_rec_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_Word HeadVar__2_2 = ((&libs__trace_params_vector_common_8[18 + HeadVar__1_1]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
...
libs__trace_params__trace_level_allows_delay_death_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_Word HeadVar__2_2 = ((&libs__trace_params_vector_common_8[12 + HeadVar__1_1]))->libs__trace_params__vector_common_type_8_0__vct_8_f_0;
...
libs__trace_params__is_exec_trace_enabled_at_given_trace_level_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_Word HeadVar__2_2 = ((&libs__trace_params_vector_common_9[0 + HeadVar__1_1]))->libs__trace_params__vector_common_type_9_0__vct_9_f_0;
  ...
  MR_Word TraceLevel_9)
{
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Origin_11)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_36);
          succeeded = (TraceLevel_9 == (MR_Integer) 3);
          if (succeeded)
          {
            Var_39 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_36);
            succeeded = (Var_39 == (MR_Integer) 0);
            if (succeeded)
            {
              Var_40 = (MR_Integer) 1;
              hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &Var_41);
              succeeded = (Var_40 == Var_41);
            }
          }
          if (succeeded)
          {
            MR_Word ProcHasUserEvent_37;

            hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_37);
            switch (ProcHasUserEvent_37) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  MR_Word ModuleHasUserEvent_38;

                  hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_38);
                  switch (ModuleHasUserEvent_38) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      EffTraceLevel_10 = (MR_Integer) 0;
                      break;
      ...
      case (MR_Integer) 1:
        {
          MR_Word SpecialPred_12 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_11, (MR_Integer) 0))) & (MR_Integer) 3);
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_42);
                    succeeded = (TraceLevel_9 == (MR_Integer) 3);
                    if (succeeded)
                    {
                      Var_45 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_42);
                      succeeded = (Var_45 == (MR_Integer) 0);
                      if (succeeded)
                      {
                        Var_46 = (MR_Integer) 1;
                        hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &Var_47);
                        succeeded = (Var_46 == Var_47);
                      }
                    }
                    if (succeeded)
                    {
                      MR_Word ProcHasUserEvent_43;

                      hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_43);
                      switch (ProcHasUserEvent_43) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          {
                            MR_Word ModuleHasUserEvent_44;

                            hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_44);
                            switch (ModuleHasUserEvent_44) {
                              default: /*NOTREACHED*/ MR_assert(0);
                              case (MR_Integer) 1:
                                EffTraceLevel_10 = (MR_Integer) 0;
                                break;
  ...
  MR_Word * SuppressItemSet_4)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__15_15 = (MR_Word) (&libs__trace_params__libs__trace_params__type_ctor_info_trace_suppress_item_0);
    mercury__list__condense_2_p_0(TypeCtorInfo__15_15, SuppressItemLists_6, &SuppressItems_7);
    mercury__set__list_to_set_2_p_0(TypeCtorInfo__15_15, SuppressItems_7, SuppressItemSet_4);
    succeeded = MR_TRUE;
  }
  return succeeded;
}
        ...
        case (MR_Integer) 0:
          {
            // case "decl"
            ;
            *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[0]));
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            switch (HeadVar__3_3) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[1]));
                break;
              case (MR_Integer) 1:
            ...
            switch (HeadVar__3_3) {
              ...
              case (MR_Integer) 0:
                switch (HeadVar__2_2) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[2]));
                    break;
                  case (MR_Integer) 1:
                    *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[1]));
                    break;
                ...
                switch (HeadVar__2_2) {
                  ...
                  case (MR_Integer) 0:
                    *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[2]));
                    break;
                  case (MR_Integer) 1:
                    *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &libs__trace_params_scalar_common_2[3]));
                    break;
                }
                break;
              case (MR_Integer) 1:
