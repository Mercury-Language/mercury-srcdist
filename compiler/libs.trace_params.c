...
/* sealed */ struct libs__trace_params__vector_common_type_3_0_s {
...
/* sealed */ struct libs__trace_params__vector_common_type_12_0_s {
...
/* sealed */ struct libs__trace_params__vector_common_type_16_0_s {
...
{
  {
    ...
    Category_19 = ((&libs__trace_params_vector_common_10[0 + Port_13]))->libs__trace_params__vector_common_type_10_0__vct_10_f_0;
    Var_20 = ((&libs__trace_params_vector_common_11[0 + Var_14]))->libs__trace_params__vector_common_type_11_0__vct_11_f_0;
        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_41);
            succeeded = (TraceLevel_9 == (MR_Integer) 3);
            if (succeeded)
            {
              Var_44 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_41);
              succeeded = (Var_44 == (MR_Integer) 0);
              if (succeeded)
              {
                Var_45 = (MR_Integer) 1;
                hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &Var_46);
                succeeded = (Var_45 == Var_46);
              }
            }
            if (succeeded)
            {
              MR_Word ProcHasUserEvent_42;

              hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_42);
              switch (ProcHasUserEvent_42) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_Word ModuleHasUserEvent_43;

                    hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_43);
                    switch (ModuleHasUserEvent_43) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 1:
                        EffTraceLevel_10 = (MR_Integer) 0;
                        break;
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_52);
                      succeeded = (TraceLevel_9 == (MR_Integer) 3);
                      if (succeeded)
                      {
                        Var_55 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_52);
                        succeeded = (Var_55 == (MR_Integer) 0);
                        if (succeeded)
                        {
                          Var_56 = (MR_Integer) 1;
                          hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &Var_57);
                          succeeded = (Var_56 == Var_57);
                        }
                      }
                      if (succeeded)
                      {
                        MR_Word ProcHasUserEvent_53;

                        hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_53);
                        switch (ProcHasUserEvent_53) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                              MR_Word ModuleHasUserEvent_54;

                              hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_54);
                              switch (ModuleHasUserEvent_54) {
                                default: /*NOTREACHED*/ MR_assert(0);
                                case (MR_Integer) 1:
                                  EffTraceLevel_10 = (MR_Integer) 0;
                                  break;
