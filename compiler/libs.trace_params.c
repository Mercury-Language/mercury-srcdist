          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word IsExported_42;
              MR_Word AddressTaken_43;

              hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_41);
              IsExported_42 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_41);
              hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_43);
              succeeded = (IsExported_42 == (MR_Integer) 0);
              if (succeeded)
                succeeded = (AddressTaken_43 == (MR_Integer) 1);
              if (succeeded)
              {
                MR_Word ProcHasUserEvent_44;

                hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_44);
                switch (ProcHasUserEvent_44) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    {
                      MR_Word ModuleHasUserEvent_45;

                      hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_45);
                      switch (ModuleHasUserEvent_45) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          EffTraceLevel_10 = (MR_Integer) 0;
                          break;
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Word IsExported_52;
                        MR_Word AddressTaken_53;

                        hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_51);
                        IsExported_52 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_51);
                        hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_53);
                        succeeded = (IsExported_52 == (MR_Integer) 0);
                        if (succeeded)
                          succeeded = (AddressTaken_53 == (MR_Integer) 1);
                        if (succeeded)
                        {
                          MR_Word ProcHasUserEvent_54;

                          hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_54);
                          switch (ProcHasUserEvent_54) {
                            default: /*NOTREACHED*/ MR_assert(0);
                            case (MR_Integer) 1:
                              {
                                MR_Word ModuleHasUserEvent_55;

                                hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_55);
                                switch (ModuleHasUserEvent_55) {
                                  default: /*NOTREACHED*/ MR_assert(0);
                                  case (MR_Integer) 1:
                                    EffTraceLevel_10 = (MR_Integer) 0;
                                    break;
