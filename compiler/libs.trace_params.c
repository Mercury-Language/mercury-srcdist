          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_proc__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_30);
              ...
              if (succeeded)
              {
                ...
                hlds__hlds_proc__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_31);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__hlds_proc__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_25);
                  ...
                  if (succeeded)
                  {
                    ...
                    hlds__hlds_proc__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_26);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__hlds_proc__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_35);
                  ...
                  if (succeeded)
                  {
                    ...
                    hlds__hlds_proc__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_36);
