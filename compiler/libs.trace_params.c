...
static const MR_EnumFunctorDescPtr libs__trace_params__libs__trace_params__enum_value_ordered_maybe_exec_trace_enabled_0[2];
...
const MR_TypeCtorInfo_Struct libs__trace_params__libs__trace_params__type_ctor_info_maybe_exec_trace_enabled_0 = {
  ...
  {     libs__trace_params__libs__trace_params__enum_value_ordered_maybe_exec_trace_enabled_0 },
  (MR_Integer) 2,
  UINT16_C(4),
