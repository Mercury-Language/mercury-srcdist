          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word IsExported_37;
              MR_Word AddressTaken_38;

              hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_7, &PredStatus_36);
              IsExported_37 = hlds__status__pred_status_is_exported_1_f_0(PredStatus_36);
              hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_8, &AddressTaken_38);
              succeeded = (IsExported_37 == (MR_Integer) 0);
              if (succeeded)
                succeeded = (AddressTaken_38 == (MR_Integer) 1);
              if (succeeded)
              {
                MR_Word ProcHasUserEvent_39;

                hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_8, &ProcHasUserEvent_39);
                switch (ProcHasUserEvent_39) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    {
                      MR_Word ModuleHasUserEvent_40;

                      hlds__hlds_module__module_info_get_has_user_event_2_p_0(ModuleInfo_6, &ModuleHasUserEvent_40);
                      switch (ModuleHasUserEvent_40) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          EffTraceLevel_10 = (MR_Integer) 0;
                          break;
