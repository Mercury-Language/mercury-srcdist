...
hlds.make_hlds.add_clause.optdate hlds.make_hlds.add_clause.trans_opt_date add_clause.err hlds.make_hlds.add_clause.c_date hlds.make_hlds.add_clause.java_date : add_clause.m \
	hlds.int0 \
	hlds.make_hlds.int0 \
	bool.int \
	builtin.int \
...
#   long deps
#   short deps
hlds.make_hlds.add_clause.optdate hlds.make_hlds.add_clause.trans_opt_date add_clause.err hlds.make_hlds.add_clause.c_date hlds.make_hlds.add_clause.java_date : \
		add_clause.m \
	\
		hlds.int0 \
		hlds.make_hlds.int0 \
...
hlds.make_hlds.add_clause.pic_o hlds.make_hlds.add_clause.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	bag.mih \
...
hlds.make_hlds.add_clause.mh hlds.make_hlds.add_clause.mih : hlds.make_hlds.add_clause.c
...
hlds.make_hlds.add_clause.module_dep : jmercury/hlds__make_hlds__add_clause.java
else
hlds.make_hlds.add_clause.module_dep : hlds.make_hlds.add_clause.c
endif
...
hlds.make_hlds.add_clause.date hlds.make_hlds.add_clause.date0 \
	hlds.date \
	hlds.make_hlds.date : add_clause.m \
	hlds.int0 \
	hlds.make_hlds.int0 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
hlds.make_hlds.add_clause.date hlds.make_hlds.add_clause.date0 hlds.date hlds.make_hlds.date : \
		add_clause.m \
	\
		hlds.int0 \
		hlds.make_hlds.int0 \
...
hlds.make_hlds.add_clause.date0 \
	hlds.date0 \
	hlds.make_hlds.date0 : add_clause.m \
	bool.int3 \
	builtin.int3 \
	check_hlds.int3 \
	cord.int3 \
...
#   long dep int3s
#   short dep int3s
hlds.make_hlds.add_clause.date0 hlds.date0 hlds.make_hlds.date0 : \
		add_clause.m \
	\
		bool.int3 \
		builtin.int3 \
...
hlds.make_hlds.add_clause.pic_o :  \
	io.mh \
	string.mh \
	time.mh \
	mdbcomp.rtti_access.mh
...
hlds.make_hlds.add_clause.int0 : hlds.make_hlds.add_clause.date0
	@:
hlds.make_hlds.add_clause.int : hlds.make_hlds.add_clause.date
	@:
hlds.make_hlds.add_clause.int2 : hlds.make_hlds.add_clause.date
	@:
hlds.make_hlds.add_clause.int3 : hlds.make_hlds.add_clause.date3
	@:
hlds.make_hlds.add_clause.opt : hlds.make_hlds.add_clause.optdate
	@:
hlds.make_hlds.add_clause.trans_opt : hlds.make_hlds.add_clause.trans_opt_date
	@:
...
hlds.make_hlds.add_clause.date0 : add_clause.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) hlds.make_hlds.add_clause
hlds.make_hlds.add_clause.date : add_clause.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) hlds.make_hlds.add_clause
hlds.make_hlds.add_clause.date3 : add_clause.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) hlds.make_hlds.add_clause
hlds.make_hlds.add_clause.optdate : add_clause.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) hlds.make_hlds.add_clause
hlds.make_hlds.add_clause.trans_opt_date : add_clause.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) hlds.make_hlds.add_clause
hlds.make_hlds.add_clause.c_date : add_clause.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) hlds.make_hlds.add_clause $(ERR_REDIRECT)
hlds.make_hlds.add_clause.java_date : add_clause.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only hlds.make_hlds.add_clause $(ERR_REDIRECT)
