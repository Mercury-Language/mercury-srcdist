    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          MR_Word Var_32 = ((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_ClassDefn_0_24, (MR_Integer) 4))) & (MR_Integer) 1);
  ...
  MR_Word ClassDefn_10)
{
  ...
  MR_Box conv3_STATE_VARIABLE_IO_66_66;
  ...
  Var_82 = ((MR_Word) ((MR_hl_field(0, Info0_7, (MR_Integer) 0))));
  packed_word_3 = (MR_Unsigned) ((MR_hl_field(0, Info0_7, (MR_Integer) 1)));
  Var_86 = ((MR_Word) ((MR_hl_field(0, Info0_7, (MR_Integer) 2))));
  Var_87 = ((MR_String) ((MR_hl_field(0, Info0_7, (MR_Integer) 3))));
  Var_88 = ((MR_Word) ((MR_hl_field(0, Info0_7, (MR_Integer) 4))));
  packed_word_4 = (MR_Unsigned) ((MR_hl_field(0, Info0_7, (MR_Integer) 5)));
  {
    ...
    MR_hl_field(0, Info1_25, 0) = ((MR_Box) (Var_82));
    MR_hl_field(0, Info1_25, 1) = (MR_Box) (packed_word_3);
    MR_hl_field(0, Info1_25, 2) = ((MR_Box) (Var_86));
    MR_hl_field(0, Info1_25, 3) = ((MR_Box) (Var_87));
    MR_hl_field(0, Info1_25, 4) = ((MR_Box) (Var_88));
  ...
  if (succeeded)
  {
    MR_Word Var_92 = ((MR_Word) ((MR_hl_field(0, Info1_25, (MR_Integer) 0))));
    MR_Word Var_96 = ((MR_Word) ((MR_hl_field(0, Info1_25, (MR_Integer) 2))));
    MR_String Var_97 = ((MR_String) ((MR_hl_field(0, Info1_25, (MR_Integer) 3))));
    MR_Word Var_98 = ((MR_Word) ((MR_hl_field(0, Info1_25, (MR_Integer) 4))));
    MR_Word Var_100 = ((MR_Unsigned) ((MR_hl_field(0, Info1_25, (MR_Integer) 5))) & (MR_Integer) 3);
    MR_Word Var_101 = ((MR_Word) ((MR_hl_field(0, Info1_25, (MR_Integer) 6))));
...

    {
      ...
      MR_hl_field(0, Info_26, 0) = ((MR_Box) (Var_92));
      MR_hl_field(0, Info_26, 1) = (MR_Box) (packed_word_5);
      MR_hl_field(0, Info_26, 2) = ((MR_Box) (Var_96));
      MR_hl_field(0, Info_26, 3) = ((MR_Box) (Var_97));
      MR_hl_field(0, Info_26, 4) = ((MR_Box) (Var_98));
      MR_hl_field(0, Info_26, 5) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 2)) | (MR_Unsigned) (Var_100)));
      MR_hl_field(0, Info_26, 6) = ((MR_Box) (Var_101));
    }
  }
  else
    Info_26 = Info1_25;
  ...
  }
  {
    ...
    MR_hl_field(0, Var_65, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_5[0]));
    MR_hl_field(0, Var_65, 1) = ((MR_Box) (ml_backend__mlds_to_java_class__output_class_defn_for_java_6_p_0_4));
    MR_hl_field(0, Var_65, 2) = ((MR_Box) ((MR_Integer) 4));
    MR_hl_field(0, Var_65, 3) = ((MR_Box) (Info_26));
    MR_hl_field(0, Var_65, 4) = ((MR_Box) (Stream_8));
    MR_hl_field(0, Var_65, 5) = ((MR_Box) (Indent1_30));
    MR_hl_field(0, Var_65, 6) = ((MR_Box) (Var_67));
  }
  mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_65, Ctors_24, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_66_66);
  mercury__io__write_string_4_p_0(Stream_8, IndentStr_31);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "}\n\n");
}
