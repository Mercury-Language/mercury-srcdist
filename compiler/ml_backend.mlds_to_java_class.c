...
{
  {
    ...
    PerInstance_41 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Word Var_16;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Interface_4, (MR_Integer) 2)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName_6, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Access_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_10, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClassDefn_0_24, (MR_Integer) 4)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_10, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClassDefn_0_24, (MR_Integer) 4)));
...
{
  {
    ...
    MR_Integer Var_76;
    MR_Word Var_78;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn_8, (MR_Integer) 4)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 1)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 5)));
    MR_Word Var_91;
    MR_Word Var_95;
    MR_String Var_96;
    MR_Word Var_97;
    ...
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 1)));
    ...
    packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 5)));
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_32_32, 1) = (MR_Box) (packed_args_3);
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_32_32, 5) = (MR_Box) (packed_args_4);
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_32_32, (MR_Integer) 1)));
      MR_Unsigned packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_32_32, (MR_Integer) 5)));

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, 1) = (MR_Box) (packed_args_5);
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, 5) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 2)) | (MR_Unsigned) (Var_109)));
    ...
    packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, (MR_Integer) 1)));
    packed_args_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, (MR_Integer) 5)));
    OutputGenerics_23 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
  ...
  MR_Word Flags_6)
{
  {
    MR_bool succeeded;
    MR_Word Access_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            ...
            ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_6, (MR_Word) ((MR_Unsigned) 28U));
            mercury__io__nl_2_p_0();
          }
          break;
      }
