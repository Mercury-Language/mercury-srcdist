...
static /* final */ const MR_Box ml_backend__mlds_to_java_class_scalar_common_1[1][7];

static /* final */ const MR_Box ml_backend__mlds_to_java_class_scalar_common_2[3][3];

static /* final */ const MR_Box ml_backend__mlds_to_java_class_scalar_common_3[1][11];

static /* final */ const MR_Box ml_backend__mlds_to_java_class_scalar_common_4[2][9];

static /* final */ const MR_Box ml_backend__mlds_to_java_class_scalar_common_5[1][10];
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_class_scalar_common_8[0]), N_23, &Var_58);
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_class_scalar_common_8[0]), N_23, &Var_69);
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_class_scalar_common_8[0]), Arity_9, &Var_35);
...
{
  {
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_4[0]));
          ...
          Var_67 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_4[1]));
          ...
          Var_71 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_5[0]));
      ...
      case (MR_Integer) 3:
        {
          ...
          mercury__list__filter_3_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), (MR_Word) (&ml_backend__mlds_to_java_class_scalar_common_2[1]), MemberFields_21, &EnumConstFields_26);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_5[0]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&ml_backend__mlds_to_java_class_scalar_common_3[0]));
  ...
  MR_Word InterfaceList_8)
{
  if (!((InterfaceList_8 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_interface_id_0), (MR_Word) (&ml_backend__mlds_to_java_class_scalar_common_2[0]), (MR_String) ",", InterfaceList_8, Stream_6);
