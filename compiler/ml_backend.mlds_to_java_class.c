...
{
  {
    ...
    PerInstance_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, 5) = (MR_Box) (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 0))) << (MR_Integer) 2)) | (MR_Unsigned) (((MR_Box) (Var_109)))));
