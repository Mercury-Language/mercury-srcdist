...
{
  {
    ...
    MR_Word Var_16;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Interface_4, (MR_Integer) 2)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName_6, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClassDefn_0_24, (MR_Integer) 4)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_10, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClassDefn_0_24, (MR_Integer) 4)));
...
{
  {
    ...
    MR_Integer Var_76;
    MR_Word Var_78;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn_8, (MR_Integer) 4)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 1)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 5)));
    MR_Word Var_91;
    MR_Word Var_95;
    MR_String Var_96;
    MR_Word Var_97;
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_32_32, (MR_Integer) 5)));
    ...
    packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, (MR_Integer) 1)));
    packed_word_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_34_34, (MR_Integer) 5)));
