...
check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1624__1_1_f_0(
  MR_Word LambdaHeadVar__1_19);

static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1385__1_2_p_0(
...
static /* final */ const MR_Box check_hlds__modecheck_unify_scalar_common_1[11][2];
...
{
  {
    ...
    succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(NonLocalInst_45, (MR_Word) (MR_mkword(MR_mktag(2), &check_hlds__modecheck_unify_scalar_common_1[10])), NonLocalType_44, ModuleInfo0_25);
    succeeded = !(succeeded);
    return succeeded;
  }
}
...
{
  {
    ...
    conv0_LambdaHeadVar__2_97 = check_hlds__modecheck_unify__IntroducedFrom__func__categorize_unify_var_lambda__1298__1_1_f_0(((MR_Word) (wrapper_arg_1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            switch (PorF_74) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                RHSTypeCtor_79 = (MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[8]);
                break;
              case (MR_Integer) 0:
...
{
  {
    ...
    conv0_LambdaHeadVar__2_20 = check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1624__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1385__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
