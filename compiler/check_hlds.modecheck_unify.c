        ...
        case (MR_Integer) 2:
          {
            ...
            {
              succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(UnifyGoalInfo0_13, (MR_Integer) 22);
              if (succeeded)
        ...
        else
        {
          ...
          if ((Var_93 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            else
            {
              ...
              hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 22, GoalInfo0_13, &GoalInfo_44);
