...
check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1425__1_2_p_0(
  MR_Word MaybeTakeAddr_34,
  MR_Word HeadVar__2_75);

static MR_Word MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__func__categorize_unify_var_lambda__1346__1_1_f_0(
...
static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_undetermined_mode_lambda__557__1_2_p_0(
...
static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_lambda__392__1_4_p_0(
  MR_Word ModuleInfo0_26,
  MR_Word InstMap1_35,
  MR_Word NonLocalTypes_44,
  MR_Word LambdaHeadVar__1_73);

static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__285__1_2_p_0(
  MR_Word ArgVars0_14,
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_85, 0) = ((MR_Box) (LambdaHeadVar__1_84));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_85, 1) = ((MR_Box) (LambdaHeadVar__1_84));
    }
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[4]), ((MR_Box) (MaybeTakeAddr_32)), ((MR_Box) (HeadVar__2_82)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_105_115_95_97_100_100_101_100_95_98_121_95_112_111_108_121_109_111_114_112_104_105_115_109_95_95_91_49_93_95_48_2_p_0(ModuleInfo_16, HeadVar__2_69);
    return succeeded;
  }
}
  ...
  MR_Word LambdaHeadVar__1_73)
{
  {
    MR_bool succeeded;
    MR_Word NonLocalType_47;
    MR_Word NonLocalInst_48;

    hlds__vartypes__lookup_var_type_3_p_0(NonLocalTypes_44, LambdaHeadVar__1_73, &NonLocalType_47);
    hlds__instmap__instmap_lookup_var_3_p_0(InstMap1_35, LambdaHeadVar__1_73, &NonLocalInst_48);
    succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(ModuleInfo0_26, NonLocalType_47, NonLocalInst_48, (MR_Word) (MR_mkword(MR_mktag(2), &check_hlds__modecheck_unify_scalar_common_1[6])));
    succeeded = !(succeeded);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__inst_test__var_inst_contains_any_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__285__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__283__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_47_47 = (MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[0]);
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_7[0]));
                  ...
                  MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (ModuleInfo_28));
                  MR_hl_field(MR_mktag(0), Var_37, 4) = ((MR_Box) (InstMap_29));
                }
                AnyVars_30 = mercury__list__filter_2_f_0(TypeInfo_47_47, Var_37, LambdaNonLocals_24);
                succeeded = (AnyVars_30 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  HeadAnyVar_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), AnyVars_30, (MR_Integer) 0))));
                  TailAnyVars_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), AnyVars_30, (MR_Integer) 1))));
                }
              }
            }
            if (succeeded)
            {
              ...
              parse_tree__set_of_var__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &WaitingVars_33);
              {
                ...
                MR_hl_field(MR_mktag(0), OoMAnyVars_34, 0) = ((MR_Box) (HeadAnyVar_31));
                MR_hl_field(MR_mktag(0), OoMAnyVars_34, 1) = ((MR_Box) (TailAnyVars_32));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) (OoMAnyVars_34));
              }
              check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_33, Var_38, STATE_VARIABLE_ModeInfo_0_35, &STATE_VARIABLE_ModeInfo_36);
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_undetermined_mode_lambda__557__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Tuple) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    Goal0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5))));
    hlds__goal_util__pred_ids_args_called_from_goal_2_p_0(Goal0_24, &PredIdsArgs0_25);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[3]));
      MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_rhs_undetermined_mode_lambda_8_p_0_1));
      MR_hl_field(MR_mktag(0), Var_51, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) (ModuleInfo_16));
    }
    ...
    if (succeeded)
    {
      Var_52 = ((MR_Tuple) ((MR_hl_field(MR_mktag(1), PredIdsArgs_27, (MR_Integer) 0))));
      Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIdsArgs_27, (MR_Integer) 1))));
      succeeded = (Var_53 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        PredId_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_52, (MR_Integer) 0))));
        ArgVars_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_52, (MR_Integer) 1))));
        succeeded = MR_TRUE;
      }
    }
    if (succeeded)
    {
      ...
      check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_0_49, &InstMap_30);
      check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_0_49, &VarTypes_31);
      hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_16, PredId_28, &PredInfo_32);
      check_hlds__modecheck_unify__match_modes_by_higher_order_insts_6_p_0(ModuleInfo_16, VarTypes_31, InstMap_30, ArgVars_29, PredInfo_32, &MatchResult_33);
      if (((MR_tag((MR_Word) MatchResult_33)) == (MR_Integer) 0))
      {
        MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MatchResult_33, (MR_Integer) 0))));
        ...
        if ((Var_95 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), MultiModeError_35, 0) = ((MR_Box) (ArgVars_29));
          }
          {
            PredMultiModeError_39 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), PredMultiModeError_39, 0) = ((MR_Box) (PredId_28));
            MR_hl_field(MR_mktag(0), PredMultiModeError_39, 1) = ((MR_Box) (MultiModeError_35));
          }
          ...
          {
            ModeError_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ModeError_41, 0) = ((MR_Box) ((MR_Unsigned) 3U));
            MR_hl_field(MR_mktag(3), ModeError_41, 1) = ((MR_Box) (X_9));
            MR_hl_field(MR_mktag(3), ModeError_41, 2) = ((MR_Box) (PredMultiModeError_39));
          }
          check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_40, ModeError_41, STATE_VARIABLE_ModeInfo_0_49, &STATE_VARIABLE_ModeInfo_65_65);
          check_hlds__mode_info__mode_info_get_pred_var_multimode_error_map_2_p_0(STATE_VARIABLE_ModeInfo_65_65, &MultiModeErrorMap0_42);
          ...
          check_hlds__mode_info__mode_info_set_pred_var_multimode_error_map_3_p_0(MultiModeErrorMap_43, STATE_VARIABLE_ModeInfo_65_65, STATE_VARIABLE_ModeInfo_50);
          *Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
        }
        else
        {
          MR_Word Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 1))));
          MR_Integer Var_97 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 0))));
          ...
          if ((Var_96 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            if (((MR_tag((MR_Word) MaybeRHS_45)) == (MR_Integer) 0))
            {
              ...
              Var_57 = mercury__string__f_43_43_2_f_0((MR_String) "could not fix up lambda goal; ", (MR_String) "polymorphism.m should have stopped us getting here");
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_rhs_undetermined_mode_lambda\'/8", Var_57);
                return;
              }
            }
            else
            {
              MR_Word RHS_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRHS_45, (MR_Integer) 0))));
              MR_Word GoalInfo_47;
          ...
          else
          {
            ...
            MR_Word STATE_VARIABLE_ModeInfo_65_81;

            {
              MultiModeError_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MultiModeError_75, 0) = ((MR_Box) (ArgVars_29));
            }
            {
              PredMultiModeError_76 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), PredMultiModeError_76, 0) = ((MR_Box) (PredId_28));
              MR_hl_field(MR_mktag(0), PredMultiModeError_76, 1) = ((MR_Box) (MultiModeError_75));
            }
            ...
            {
              ModeError_78 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ModeError_78, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(MR_mktag(3), ModeError_78, 1) = ((MR_Box) (X_9));
              MR_hl_field(MR_mktag(3), ModeError_78, 2) = ((MR_Box) (PredMultiModeError_76));
            }
            check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_77, ModeError_78, STATE_VARIABLE_ModeInfo_0_49, &STATE_VARIABLE_ModeInfo_65_81);
            check_hlds__mode_info__mode_info_get_pred_var_multimode_error_map_2_p_0(STATE_VARIABLE_ModeInfo_65_81, &MultiModeErrorMap0_79);
            ...
            check_hlds__mode_info__mode_info_set_pred_var_multimode_error_map_3_p_0(MultiModeErrorMap_80, STATE_VARIABLE_ModeInfo_65_81, STATE_VARIABLE_ModeInfo_50);
            *Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
          }
        }
      }
      ...
      {
        MR_Word NonGroundArgVars_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MatchResult_33, (MR_Integer) 0))));
        ...
        MR_Word STATE_VARIABLE_ModeInfo_65_91;

        {
          MultiModeError_85 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), MultiModeError_85, 0) = ((MR_Box) (NonGroundArgVars_34));
        }
        {
          PredMultiModeError_86 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), PredMultiModeError_86, 0) = ((MR_Box) (PredId_28));
          MR_hl_field(MR_mktag(0), PredMultiModeError_86, 1) = ((MR_Box) (MultiModeError_85));
        }
        ...
        {
          ModeError_88 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ModeError_88, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          MR_hl_field(MR_mktag(3), ModeError_88, 1) = ((MR_Box) (X_9));
          MR_hl_field(MR_mktag(3), ModeError_88, 2) = ((MR_Box) (PredMultiModeError_86));
        }
        check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_87, ModeError_88, STATE_VARIABLE_ModeInfo_0_49, &STATE_VARIABLE_ModeInfo_65_91);
        check_hlds__mode_info__mode_info_get_pred_var_multimode_error_map_2_p_0(STATE_VARIABLE_ModeInfo_65_91, &MultiModeErrorMap0_89);
        ...
        check_hlds__mode_info__mode_info_set_pred_var_multimode_error_map_3_p_0(MultiModeErrorMap_90, STATE_VARIABLE_ModeInfo_65_91, STATE_VARIABLE_ModeInfo_50);
        *Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
      }
    }
    else
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_lambda__392__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word LambdaNonLocals_20 = ((MR_Word) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 2))));
    MR_Word VarsModes0_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 3))));
    MR_Word Det_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 4))) & (MR_Integer) 7);
    MR_Word Goal0_23 = ((MR_Word) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 5))));
    MR_Word Vars_24;
    MR_Word Modes0_25;
    MR_Word ModuleInfo0_26;
    MR_Word HowToCheckGoal_27;
    MR_Word Modes_29;
    MR_Word VarsModes_30;
    MR_Word VarInitialInsts_31;
    MR_Word VarInstAL_32;
    MR_Word VarInstMapDelta_33;
    MR_Word InstMap0_34;
    MR_Word InstMap1_35;
    MR_Word ArgLives_36;
    MR_Word LiveVarsList_37;
    MR_Word LiveVars_38;
    MR_Word GoalInfo0_40;
    MR_Word NonLocals0_41;
    MR_Word NonLocals1_42;
    MR_Word NonLocals_43;
    MR_Word NonLocalsList_49;
    MR_Word NonLocalInsts_50;
    MR_Word ModuleInfo2_51;
    MR_Word RHS_59;
    ...
    mercury__assoc_list__keys_and_values_3_p_0((MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), VarsModes0_21, &Vars_24, &Modes0_25);
    check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_0_69, &ModuleInfo0_26);
    check_hlds__mode_info__mode_info_get_how_to_check_2_p_0(STATE_VARIABLE_ModeInfo_0_69, &HowToCheckGoal_27);
    switch (HowToCheckGoal_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word VarTypes_28;

          check_hlds__mode_info__mode_info_get_types_of_vars_3_p_0(STATE_VARIABLE_ModeInfo_0_69, Vars_24, &VarTypes_28);
          check_hlds__inst_mode_type_prop__propagate_types_into_mode_list_4_p_0(ModuleInfo0_26, VarTypes_28, Modes0_25, &Modes_29);
          mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Vars_24, Modes_29, &VarsModes_30);
        }
        break;
      case (MR_Integer) 1:
        {
          Modes_29 = Modes0_25;
          VarsModes_30 = VarsModes0_21;
        }
        break;
    }
    check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_26, Modes_29, &VarInitialInsts_31);
    mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&check_hlds__modecheck_unify_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), Vars_24, VarInitialInsts_31, &VarInstAL_32);
    VarInstMapDelta_33 = hlds__instmap__instmap_delta_from_assoc_list_1_f_0(VarInstAL_32);
    check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_0_69, &InstMap0_34);
    hlds__instmap__apply_instmap_delta_3_p_0(VarInstMapDelta_33, InstMap0_34, &InstMap1_35);
    check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap1_35, STATE_VARIABLE_ModeInfo_0_69, &STATE_VARIABLE_ModeInfo_71_71);
    check_hlds__mode_util__get_arg_lives_3_p_0(ModuleInfo0_26, Modes_29, &ArgLives_36);
    check_hlds__modecheck_util__get_live_vars_3_p_0(Vars_24, ArgLives_36, &LiveVarsList_37);
    parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), LiveVarsList_37, &LiveVars_38);
    check_hlds__mode_info__mode_info_add_live_vars_3_p_0(LiveVars_38, STATE_VARIABLE_ModeInfo_71_71, &STATE_VARIABLE_ModeInfo_72_72);
    GoalInfo0_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_23, (MR_Integer) 1))));
    NonLocals0_41 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_40);
    parse_tree__set_of_var__delete_list_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_24, NonLocals0_41, &NonLocals1_42);
    switch (Groundness_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Word NonLocalTypes_44;
          MR_Word FilterPred_45;

          check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_72_72, &NonLocalTypes_44);
          {
            FilterPred_45 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), FilterPred_45, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_6[0]));
            MR_hl_field(MR_mktag(0), FilterPred_45, 1) = ((MR_Box) (check_hlds__modecheck_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_101_99_104_101_99_107_95_117_110_105_102_105_99_97_116_105_111_110_95_114_104_115_95_108_97_109_98_100_97_95_95_91_53_93_95_48_8_p_0_1));
            MR_hl_field(MR_mktag(0), FilterPred_45, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), FilterPred_45, 3) = ((MR_Box) (ModuleInfo0_26));
            MR_hl_field(MR_mktag(0), FilterPred_45, 4) = ((MR_Box) (InstMap1_35));
            MR_hl_field(MR_mktag(0), FilterPred_45, 5) = ((MR_Box) (NonLocalTypes_44));
          }
          parse_tree__set_of_var__filter_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), FilterPred_45, NonLocals1_42, &NonLocals_43);
        }
        break;
      case (MR_Integer) 0:
        NonLocals_43 = NonLocals1_42;
        break;
    }
    parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_43, &NonLocalsList_49);
    hlds__instmap__instmap_lookup_vars_3_p_0(InstMap1_35, NonLocalsList_49, &NonLocalInsts_50);
    check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_72_72, &ModuleInfo2_51);
    succeeded = (Groundness_17 == (MR_Integer) 0);
    if (succeeded)
      succeeded = (Purity_16 != (MR_Integer) 2);
    if (succeeded)
      succeeded = check_hlds__inst_test__inst_list_is_ground_2_p_0(ModuleInfo2_51, NonLocalInsts_50);
    else
      succeeded = check_hlds__inst_test__inst_list_is_ground_or_any_2_p_0(ModuleInfo2_51, NonLocalInsts_50);
    if (succeeded)
    {
      MR_Word SharedNonLocalInsts_52;
      MR_Word ModuleInfo3_53;
      MR_Word InstMap2_54;
      MR_Word Goal_55;
      MR_Word FinalInsts_56;
      MR_Word InstMap11_57;
      MR_Word RHS0_58;
      ...
      check_hlds__inst_util__make_shared_inst_list_4_p_0(NonLocalInsts_50, &SharedNonLocalInsts_52, ModuleInfo2_51, &ModuleInfo3_53);
      hlds__instmap__instmap_set_vars_corresponding_4_p_0(NonLocalsList_49, SharedNonLocalInsts_52, InstMap1_35, &InstMap2_54);
      check_hlds__mode_info__mode_info_set_module_info_3_p_0(ModuleInfo3_53, STATE_VARIABLE_ModeInfo_72_72, &STATE_VARIABLE_ModeInfo_77_77);
      check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap2_54, STATE_VARIABLE_ModeInfo_77_77, &STATE_VARIABLE_ModeInfo_78_78);
      {
      ...
      check_hlds__mode_info__mode_info_lock_vars_4_p_0(Var_79, NonLocals_43, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_80_80);
      ...
      switch (HowToCheckGoal_27) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          check_hlds__modecheck_goal__modecheck_goal_4_p_0(Goal0_23, &Goal_55, STATE_VARIABLE_ModeInfo_83_83, &STATE_VARIABLE_ModeInfo_85_85);
          break;
        case (MR_Integer) 1:
          check_hlds__unique_modes__unique_modes_check_goal_4_p_0(Goal0_23, &Goal_55, STATE_VARIABLE_ModeInfo_83_83, &STATE_VARIABLE_ModeInfo_85_85);
          break;
      }
      check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo0_26, Modes_29, &FinalInsts_56);
      check_hlds__modes__modecheck_lambda_final_insts_4_p_0(Vars_24, FinalInsts_56, STATE_VARIABLE_ModeInfo_85_85, &STATE_VARIABLE_ModeInfo_86_86);
      ...
      check_hlds__mode_info__mode_info_remove_live_vars_3_p_0(LiveVars_38, STATE_VARIABLE_ModeInfo_89_89, &STATE_VARIABLE_ModeInfo_90_90);
      check_hlds__mode_info__mode_info_unlock_vars_4_p_0(Var_79, NonLocals_43, STATE_VARIABLE_ModeInfo_90_90, &STATE_VARIABLE_ModeInfo_92_92);
      hlds__instmap__instmap_set_vars_corresponding_4_p_0(NonLocalsList_49, SharedNonLocalInsts_52, InstMap0_34, &InstMap11_57);
      check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap11_57, STATE_VARIABLE_ModeInfo_92_92, &STATE_VARIABLE_ModeInfo_93_93);
      {
        RHS0_58 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), RHS0_58, 0) = (MR_Box) (packed_word_0);
        MR_hl_field(MR_mktag(2), RHS0_58, 1) = NULL;
        MR_hl_field(MR_mktag(2), RHS0_58, 2) = ((MR_Box) (LambdaNonLocals_20));
        MR_hl_field(MR_mktag(2), RHS0_58, 3) = ((MR_Box) (VarsModes_30));
        MR_hl_field(MR_mktag(2), RHS0_58, 4) = (MR_Box) ((MR_Unsigned) (Det_22));
        MR_hl_field(MR_mktag(2), RHS0_58, 5) = ((MR_Box) (Goal_55));
      }
      check_hlds__modecheck_unify__modecheck_unify_lambda_12_p_0(X_9, PredOrFunc_18, LambdaNonLocals_20, Modes_29, Det_22, RHS0_58, &RHS_59, Unification0_11, &Unification_60, &UnifyMode_61, STATE_VARIABLE_ModeInfo_93_93, STATE_VARIABLE_ModeInfo_70);
    }
    else
    {
      MR_Word RevNonGroundVarsInsts_62;
      MR_Word NonGroundVarsInsts_63;

      check_hlds__modecheck_unify__acc_non_ground_vars_5_p_0(ModuleInfo2_51, InstMap1_35, NonLocalsList_49, (MR_Word) ((MR_Unsigned) 0U), &RevNonGroundVarsInsts_62);
      mercury__list__reverse_2_p_0((MR_Word) (&check_hlds__modecheck_unify_scalar_common_2[0]), RevNonGroundVarsInsts_62, &NonGroundVarsInsts_63);
      if ((NonGroundVarsInsts_63 == (MR_Word) ((MR_Unsigned) 0U)))
        {
      ...
      else
      {
        ...
        MR_Word Var_98 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonGroundVarsInsts_63, (MR_Integer) 0))));

        BadVar_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_98, (MR_Integer) 0))));
        BadInst_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_98, (MR_Integer) 1))));
        WaitingVars_67 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), BadVar_64);
        {
          ModeError_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ModeError_68, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), ModeError_68, 1) = ((MR_Box) (BadVar_64));
          MR_hl_field(MR_mktag(3), ModeError_68, 2) = ((MR_Box) (BadInst_65));
        }
        check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_67, ModeError_68, STATE_VARIABLE_ModeInfo_72_72, STATE_VARIABLE_ModeInfo_70);
      }
      RHS_59 = LambdaRHS_10;
      UnifyMode_61 = (MR_Word) (&check_hlds__modecheck_unify_scalar_common_3[1]);
      Unification_60 = Unification0_11;
    }
    {
      MR_Word base;
      ...
      *UnifyGoalExpr_14 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (RHS_59));
      MR_hl_field(MR_mktag(1), base, 2) = ((MR_Box) (UnifyMode_61));
      MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Unification_60));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_85 = check_hlds__modecheck_unify__IntroducedFrom__func__categorize_unify_var_lambda__1346__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_lambda__1328__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!((SubInfo_31 == (MR_Word) ((MR_Unsigned) 0U))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_79, 1) = ((MR_Box) (check_hlds__modecheck_unify__categorize_unify_var_lambda_12_p_0_1));
              MR_hl_field(MR_mktag(0), Var_79, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_79, 3) = ((MR_Box) (MaybeTakeAddr_32));
              MR_hl_field(MR_mktag(0), Var_79, 4) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            mercury__require__expect_3_p_0(Var_79, (MR_String) "predicate \140check_hlds.modecheck_unify.categorize_unify_var_lambda\'/12", (MR_String) "take_addr");
          }
        }
        break;
      case (MR_Integer) 1:
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        PredId_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_88, (MR_Integer) 0))));
        ProcId_55 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_88, (MR_Integer) 1))));
        succeeded = ((MR_tag((MR_Word) RHS0_19)) == (MR_Integer) 2);
        if (succeeded)
        {
          Goal_62 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_19, (MR_Integer) 5))));
          succeeded = MR_TRUE;
          if (succeeded)
          {
            Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_62, (MR_Integer) 0))));
            succeeded = ((MR_tag((MR_Word) Var_89)) == (MR_Integer) 2);
            if (succeeded)
            {
              Var_104 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_89, (MR_Integer) 0))));
              Var_105 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_89, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_0_72, &VarTypes0_69);
        hlds__vartypes__lookup_var_type_3_p_0(VarTypes0_69, X_16, &Type_70);
        {
          Var_95 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_95, 0) = ((MR_Box) (ArgVars_17));
          MR_hl_field(MR_mktag(2), Var_95, 1) = ((MR_Box) (ArgFromToInsts_47));
        }
        {
          ModeError_71 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ModeError_71, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), ModeError_71, 1) = ((MR_Box) (X_16));
          MR_hl_field(MR_mktag(3), ModeError_71, 2) = ((MR_Box) (Var_95));
          MR_hl_field(MR_mktag(3), ModeError_71, 3) = ((MR_Box) (Type_70));
          MR_hl_field(MR_mktag(3), ModeError_71, 4) = (MR_Box) ((MR_Unsigned) (PredOrFunc_18));
        }
...
{
  {
    ...
    else
    {
      ...
      {
        Var_76 = (MR_Integer) 0;
        succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0(LiveX_25, InitInstOfX_24, InstConsId_34, InitInstsOfArgVars_31, LiveArgs_32, Var_76, TypeOfX_13, &UnifiedInst_36, &Detism_37, ModuleInfo0_29, &ModuleInfo1_38);
      }
      if (succeeded)
      {
...
{
  {
    ...
    conv0_LambdaHeadVar__2_20 = check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1664__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1425__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 24, &WarnCannotSucceed_12);
...
{
  {
    ...
    succeeded = check_hlds__mode_test__init_final_insts_is_output_3_p_0(ModuleInfo0_30, InitInstX_16, UnifiedInst_18);
    if (succeeded)
    {
      {
        Unification_31 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      succeeded = check_hlds__mode_test__init_final_insts_is_output_3_p_0(ModuleInfo0_30, InitInstY_17, UnifiedInst_18);
      if (succeeded)
      {
        {
          Unification_31 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        succeeded = check_hlds__mode_test__init_final_insts_is_unused_3_p_0(ModuleInfo0_30, InitInstX_16, UnifiedInst_18);
        if (succeeded)
          succeeded = check_hlds__mode_test__init_final_insts_is_unused_3_p_0(ModuleInfo0_30, InitInstY_17, UnifiedInst_18);
        if (succeeded)
        {
          switch (LiveX_19) {
            default: /*NOTREACHED*/ MR_assert(0);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          *Unify_28 = (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_1[7]));
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_39, (MR_Integer) 24, &WarnCannotSucceed_40);
