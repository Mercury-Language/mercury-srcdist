...
check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1650__1_1_f_0(
  MR_Word LambdaHeadVar__1_19);

static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1411__1_2_p_0(
  MR_Word MaybeTakeAddr_34,
  MR_Word HeadVar__2_75);

static MR_Word MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__func__categorize_unify_var_lambda__1332__1_1_f_0(
  MR_Word LambdaHeadVar__1_84);

static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_lambda__1314__1_2_p_0(
  MR_Word MaybeTakeAddr_32,
  MR_Word HeadVar__2_82);

static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_undetermined_mode_lambda__543__1_2_p_0(
...
static MR_bool MR_CALL 
check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__284__1_2_p_0(
  MR_Word ArgVars0_14,
  ...
  MR_Word LambdaHeadVar__1_70)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(NonLocalTypes_40, LambdaHeadVar__1_70, &NonLocalType_43);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__284__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
...
top_of_proc_2:;
  {
    ...
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_20, X_11, &TypeOfX_21);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_undetermined_mode_lambda__543__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Tuple) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_67)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_69_69, &NonLocalTypes_40);
        {
  ...
  if (succeeded)
  {
    ...
    switch (HowToCheckGoal_51) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        check_hlds__modecheck_goal__modecheck_goal_4_p_0(Goal0_23, &Goal_52, STATE_VARIABLE_ModeInfo_80_80, &STATE_VARIABLE_ModeInfo_82_82);
        break;
      case (MR_Integer) 1:
        check_hlds__unique_modes__unique_modes_check_goal_4_p_0(Goal0_23, &Goal_52, STATE_VARIABLE_ModeInfo_80_80, &STATE_VARIABLE_ModeInfo_82_82);
        break;
    }
    check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo0_24, Modes_26, &FinalInsts_53);
    check_hlds__modes__modecheck_lambda_final_insts_4_p_0(Vars_25, FinalInsts_53, STATE_VARIABLE_ModeInfo_82_82, &STATE_VARIABLE_ModeInfo_83_83);
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NonGroundVarsInsts_60, (MR_Integer) 0))));

      BadVar_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_95, (MR_Integer) 0))));
      BadInst_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_95, (MR_Integer) 1))));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_85 = check_hlds__modecheck_unify__IntroducedFrom__func__categorize_unify_var_lambda__1332__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_lambda__1314__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_73)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_69, X_16, &Type_70);
      {
  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(HeadVar__2_2, ArgVar_15, &ArgType_28);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_20 = check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1650__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1411__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_71)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_21, X_18, &TypeOfX_26);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(HeadVar__2_2, ArgVar_11, &ArgType_16);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_22, Var0_10, &VarType_23);
      Var_30 = (MR_Integer) 0;
      ...
      if (succeeded)
      {
        ...
        parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_45, Var0_10, &VarType_47);
        parse_tree__vartypes__add_var_type_4_p_0(Var_24, VarType_47, VarTypes0_45, &VarTypes_48);
  ...
  void * env_ptr_arg)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0((env_ptr)->check_hlds__modecheck_unify__would_construct_partial_term_with_solver_type_5_p_0_env_0__VarTypes_7, (env_ptr)->check_hlds__modecheck_unify__would_construct_partial_term_with_solver_type_5_p_0_env_0__ArgVar_15, &(env_ptr)->check_hlds__modecheck_unify__would_construct_partial_term_with_solver_type_5_p_0_env_0__ArgType_13);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word STATE_VARIABLE_ModeInfo_18_33;
    MR_Word Var_36;

    check_hlds__mode_info__mode_info_get_varset_2_p_0(STATE_VARIABLE_ModeInfo_0_19, &VarSet0_27);
    check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_0_19, &VarTypes0_28);
    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), X_11, VarSet0_27, &VarSet_29);
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_28, X0_10, &VarType_30);
    parse_tree__vartypes__add_var_type_4_p_0(*X_11, VarType_30, VarTypes0_28, &VarTypes_31);
    check_hlds__mode_info__mode_info_set_varset_3_p_0(VarSet_29, STATE_VARIABLE_ModeInfo_0_19, &STATE_VARIABLE_ModeInfo_18_33);
    check_hlds__mode_info__mode_info_set_var_types_3_p_0(VarTypes_31, STATE_VARIABLE_ModeInfo_18_33, STATE_VARIABLE_ModeInfo_20);
    check_hlds__modecheck_unify__create_var_var_unification_5_p_0(X0_10, *X_11, VarType_30, *STATE_VARIABLE_ModeInfo_20, &ExtraGoal_32);
    {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_26, X_21, &Type_32);
