      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(TypeOfX_49, &Purity_50, &Var_51, &PredArgTypes_53);
          if (succeeded)
          {
            succeeded = ((((MR_tag((MR_Word) ConsId_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_17, (MR_Integer) 0)))) == (MR_Integer) 4)));
            if (succeeded)
              ShroudedPredProcId_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_17, (MR_Integer) 1))));
          }
          if (succeeded)
          {
            ...
            MR_Word VarDb0_60;
            MR_Word MaybeRHS0_61;
            MR_Word VarDb_62;
            MR_Word VarTable_63;
            MR_Word Var_66;
            MR_Word STATE_VARIABLE_ModeInfo_45_69;
            ...
            Var_66 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_54);
            PredId_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 0))));
            ProcId_59 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_66, (MR_Integer) 1))));
            {
              VarDb0_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), VarDb0_60, 0) = ((MR_Box) (VarTable0_48));
            }
            check_hlds__polymorphism_lambda__convert_pred_to_lambda_goal_14_p_0(ModuleInfo0_56, Purity_50, LHSVar_9, PredId_58, ProcId_59, RHSVars_19, PredArgTypes_53, UnifyContext_12, UnifyGoalInfo0_13, Context_57, &MaybeRHS0_61, VarDb0_60, &VarDb_62);
            if (((MR_tag((MR_Word) VarDb_62)) == (MR_Integer) 1))
              VarTable_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarDb_62, (MR_Integer) 0))));
            else
              {
            ...
            check_hlds__mode_info__mode_info_set_var_table_3_p_0(VarTable_63, STATE_VARIABLE_ModeInfo_0_35, &STATE_VARIABLE_ModeInfo_45_69);
            if (((MR_tag((MR_Word) MaybeRHS0_61)) == (MR_Integer) 0))
            {
              MR_String Var_71;

              Var_71 = mercury__string__f_43_43_2_f_0((MR_String) "could not convert pred to lambda goal; ", (MR_String) "polymorphism.m should have stopped us getting here");
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", Var_71);
                return;
              }
            }
            else
            {
              MR_Word RHS0_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRHS0_61, (MR_Integer) 0))));
              MR_Word next_value_of_RHS_10 = RHS0_64;
              MR_Word next_value_of_STATE_VARIABLE_ModeInfo_0_35 = STATE_VARIABLE_ModeInfo_45_69;
          ...
          else
          {
            ...
            succeeded = parse_tree__prog_data__cons_id_is_const_struct_2_p_0(ConsId_17, &ConstNum_65);
            if (succeeded)
            {
              MR_Word Var_74;
              MR_Word Var_78;

              {
                ...
                MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[4]));
                MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_1));
                MR_hl_field(MR_mktag(0), Var_74, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (IsExistConstr_18));
                MR_hl_field(MR_mktag(0), Var_74, 4) = ((MR_Box) ((MR_Integer) 0));
              }
              mercury__require__expect_3_p_0(Var_74, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction is existential");
              {
                Var_78 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[5]));
                MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_2));
                MR_hl_field(MR_mktag(0), Var_78, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_78, 3) = ((MR_Box) (RHSVars_19));
                MR_hl_field(MR_mktag(0), Var_78, 4) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              mercury__require__expect_3_p_0(Var_78, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction has args");
              check_hlds__modecheck_unify__modecheck_unify_const_struct_7_p_0(LHSVar_9, ConsId_17, ConstNum_65, UnifyContext_12, Goal_14, STATE_VARIABLE_ModeInfo_0_35, STATE_VARIABLE_ModeInfo_36);
            }
            else
