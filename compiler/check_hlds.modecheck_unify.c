      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word MaybeRHS0_63;
            MR_Word VarSet_64;
            MR_Word VarTypes_65;
            MR_Word Var_68;
            MR_Word STATE_VARIABLE_ModeInfo_42_69;
            MR_Word STATE_VARIABLE_ModeInfo_43_70;
            ...
            Var_68 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_56);
            PredId_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_68, (MR_Integer) 0))));
            ProcId_62 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_68, (MR_Integer) 1))));
            check_hlds__polymorphism_lambda__convert_pred_to_lambda_goal_16_p_0(Purity_52, LHSVar_9, PredId_61, ProcId_62, RHSVars_19, PredArgTypes_55, UnifyContext_12, UnifyGoalInfo0_13, Context_60, ModuleInfo0_58, &MaybeRHS0_63, VarSet0_59, &VarSet_64, VarTypes0_50, &VarTypes_65);
            check_hlds__mode_info__mode_info_set_varset_3_p_0(VarSet_64, STATE_VARIABLE_ModeInfo_0_35, &STATE_VARIABLE_ModeInfo_42_69);
            check_hlds__mode_info__mode_info_set_var_types_3_p_0(VarTypes_65, STATE_VARIABLE_ModeInfo_42_69, &STATE_VARIABLE_ModeInfo_43_70);
            if (((MR_tag((MR_Word) MaybeRHS0_63)) == (MR_Integer) 0))
            {
              MR_String Var_72;

              Var_72 = mercury__string__f_43_43_2_f_0((MR_String) "could not convert pred to lambda goal; ", (MR_String) "polymorphism.m should have stopped us getting here");
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", Var_72);
                return;
              }
            }
            else
            {
              MR_Word RHS0_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRHS0_63, (MR_Integer) 0))));
              MR_Word next_value_of_RHS_10 = RHS0_66;
              MR_Word next_value_of_STATE_VARIABLE_ModeInfo_0_35 = STATE_VARIABLE_ModeInfo_43_70;
          ...
          else
          {
            ...
            succeeded = parse_tree__prog_data__cons_id_is_const_struct_2_p_0(ConsId_17, &ConstNum_67);
            if (succeeded)
            {
              MR_Word Var_75;
              MR_Word Var_79;

              {
                ...
                MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[4]));
                MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_1));
                MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_75, 3) = ((MR_Box) (IsExistConstr_18));
                MR_hl_field(MR_mktag(0), Var_75, 4) = ((MR_Box) ((MR_Integer) 0));
              }
              mercury__require__expect_3_p_0(Var_75, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction is existential");
              {
                Var_79 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[5]));
                MR_hl_field(MR_mktag(0), Var_79, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_2));
                MR_hl_field(MR_mktag(0), Var_79, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_79, 3) = ((MR_Box) (RHSVars_19));
                MR_hl_field(MR_mktag(0), Var_79, 4) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              mercury__require__expect_3_p_0(Var_79, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction has args");
              check_hlds__modecheck_unify__modecheck_unify_const_struct_7_p_0(LHSVar_9, ConsId_17, ConstNum_67, UnifyContext_12, Goal_14, STATE_VARIABLE_ModeInfo_0_35, STATE_VARIABLE_ModeInfo_36);
            }
            else
