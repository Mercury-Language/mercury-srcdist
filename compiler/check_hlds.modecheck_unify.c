      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            PredId_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 0))));
            ProcId_59 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 1))));
            ...
            if (((MR_tag((MR_Word) MaybeRHS0_60)) == (MR_Integer) 0))
            {
              ...
              Var_67 = mercury__string__f_43_43_2_f_0((MR_String) "could not convert pred to lambda goal; ", (MR_String) "polymorphism.m should have stopped us getting here");
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", Var_67);
                return;
              }
            }
            else
            {
              MR_Word RHS0_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRHS0_60, (MR_Integer) 0))));
          ...
          else
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[4]));
                MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_1));
                MR_hl_field(MR_mktag(0), Var_70, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_70, 3) = ((MR_Box) (IsExistConstr_18));
                MR_hl_field(MR_mktag(0), Var_70, 4) = ((MR_Box) ((MR_Integer) 0));
              }
              mercury__require__expect_3_p_0(Var_70, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction is existential");
              {
                Var_74 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[5]));
                MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_2));
                MR_hl_field(MR_mktag(0), Var_74, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (RHSVars_19));
                MR_hl_field(MR_mktag(0), Var_74, 4) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              mercury__require__expect_3_p_0(Var_74, (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction has args");
