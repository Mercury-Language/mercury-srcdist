  ...
  MR_Word LambdaHeadVar__1_70)
{
  ...
  succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(ModuleInfo0_24, NonLocalType_43, NonLocalInst_44, (MR_Word) (MR_mkword(3, &check_hlds__modecheck_unify_scalar_common_2[2])));
  succeeded = !(succeeded);
  return succeeded;
}
  ...
  (env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16 = ArgVars0_16;
  {
    ...
    if ((env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
    {
      ...
      if ((env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
      {
        ...
        *GoalExpr_20 = (MR_Word) (MR_mkword(3, &check_hlds__modecheck_unify_scalar_common_1[6]));
      }
      else
      {
        MR_Word Var_73;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        check_hlds__modecheck_util__modecheck_introduced_type_info_var_has_inst_no_exact_match_5_p_0(ArgVar_11, ArgType_16, (MR_Word) (MR_mkword(1, &check_hlds__modecheck_unify_scalar_common_1[7])), STATE_VARIABLE_ModeInfo_20_20, &STATE_VARIABLE_ModeInfo_22_22);
        // direct tailcall eliminated
        ;
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_23)
{
  ...
  *GoalExpr_16 = (MR_Word) (MR_mkword(3, &check_hlds__modecheck_unify_scalar_common_1[6]));
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          *UnifyGoalExpr_14 = (MR_Word) (MR_mkword(3, &check_hlds__modecheck_unify_scalar_common_1[6]));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_60)
{
  ...
  else
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), NumTypeInfoVars_33, ((MR_Box) (MR_mkword(1, &check_hlds__modecheck_unify_scalar_common_1[7]))), &ExpectedInsts_34);
    {
