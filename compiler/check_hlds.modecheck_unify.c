  ...
  top_of_proc_1:;
    {
      ...
      switch (MR_tag((MR_Word) RHS_10)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_10, (MR_Integer) 1)));
        ...
        case (MR_Integer) 2:
          {
            MR_Word Purity_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_10, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
            MR_Word HOGroundness_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_10, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
            MR_Word LambdaNonLocals_24 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS_10, (MR_Integer) 2))));
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_10, (MR_Integer) 0)));
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_10, (MR_Integer) 5)));
            MR_Word AnyVars_31;
...
{
  {
    ...
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5)));
    MR_Word PredId_25;
    MR_Word ArgVars_26;
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_69)
{
  {
    MR_bool succeeded;
    MR_Word Purity_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
    MR_Word Groundness_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), LambdaRHS_10, (MR_Integer) 5)));
    ...
    if (succeeded)
    {
      ...
      check_hlds__mode_info__mode_info_set_instmap_3_p_0(InstMap11_55, STATE_VARIABLE_ModeInfo_92_92, &STATE_VARIABLE_ModeInfo_93_93);
      {
        ...
        MR_hl_field(MR_mktag(2), RHS0_56, 5) = (MR_Box) (packed_args_1);
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_19, (MR_Integer) 5)));
      ...
      case (MR_Integer) 1:
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification0_19, (MR_Integer) 4)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_17, (MR_Integer) 0)));
          packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_17, (MR_Integer) 5)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_93, (MR_Integer) 3)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_69, (MR_Integer) 1)));
            PorF_70 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_69, (MR_Integer) 1))) & (MR_Integer) 1);
            packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_69, (MR_Integer) 4)));
            switch (PorF_70) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Initial_24, (MR_Integer) 1)));
      ...
      else
      {
        ...
        if ((env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
          {
            ...
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_52, (MR_Integer) 5)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), FinalInst_5, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalInst_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalInst_5, (MR_Integer) 1)));
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_21, (MR_Integer) 5)));
      ...
      case (MR_Integer) 1:
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification0_21, (MR_Integer) 4)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InitialInst_52, (MR_Integer) 1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalInst_53, (MR_Integer) 1)));
      ...
      }
      {
        ...
        *Unification_22 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 4) = (MR_Box) (((((MR_Unsigned) (CanFail_60) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
      }
    }
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification0_8, (MR_Integer) 4)));
        ...
        *ArgVars_11 = ArgVars1_19;
        {
          ...
          *Unification_9 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 4) = (MR_Box) (packed_args_0);
        }
      }
      else
      {
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification0_19, (MR_Integer) 2)));
