  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 31, &WarnCannotSucceed_12);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          *UnifyGoalExpr_14 = (MR_Word) (MR_mkword(3, &check_hlds__modecheck_unify_scalar_common_1[7]));
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_66, (MR_Integer) 31, &WarnCannotSucceed_67);
