  ...
  else
  {
    ...
    else
    {
      ...
      WaitingVars_63 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), BadVar_60);
      {
        ...
        MR_hl_field(3, ModeError_64, 0) = ((MR_Box) ((MR_Unsigned) 2U));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_37)
{
  ...
  else
  {
    ...
    parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_48, &WaitingVars_34);
    {
      ...
      MR_hl_field(3, ModeError_35, 0) = ((MR_Box) ((MR_Unsigned) 0U));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(3, ModeError_70, 0) = ((MR_Box) ((MR_Unsigned) 3U));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_34)
{
  ...
  else
  {
    ...
    {
      ModeError_30 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, ModeError_30, 0) = ((MR_Box) (X_9));
      MR_hl_field(0, ModeError_30, 1) = ((MR_Box) (Y_10));
      MR_hl_field(0, ModeError_30, 2) = ((MR_Box) (InstOfX_19));
      MR_hl_field(0, ModeError_30, 3) = ((MR_Box) (InstOfY_20));
    }
