...
check_hlds__modecheck_unify__modecheck_unification_rhs_undetermined_mode_lambda_8_p_0(
  ...
  MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46,
  MR_Word * check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_47);
...
check_hlds__modecheck_unify__match_modes_by_higher_order_insts_6_p_0(
  MR_Word check_hlds__modecheck_unify__ModuleInfo_7,
  MR_Word check_hlds__modecheck_unify__VarTypes_8,
  MR_Word check_hlds__modecheck_unify__InstMap_9,
  MR_Word check_hlds__modecheck_unify__ArgVars_10,
  MR_Word check_hlds__modecheck_unify__CalleePredInfo_11,
  MR_Word * check_hlds__modecheck_unify__Result_12);

static void MR_CALL 
check_hlds__modecheck_unify__match_modes_by_higher_order_insts_2_9_p_0(
  MR_Word check_hlds__modecheck_unify__ModuleInfo_1,
  MR_Word check_hlds__modecheck_unify__VarTypes_2,
  MR_Word check_hlds__modecheck_unify__InstMap_3,
  MR_Word check_hlds__modecheck_unify__ArgVars_4,
  MR_Word check_hlds__modecheck_unify__CalleePredInfo_5,
  MR_Word check_hlds__modecheck_unify__HeadVar__6_6,
  MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_0_7,
  MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_0_8,
  MR_Word * check_hlds__modecheck_unify__Result_9);
...
check_hlds__modecheck_unify__match_mode_by_higher_order_insts_7_p_0(
  ...
  MR_Word * check_hlds__modecheck_unify__HeadVar__6_6,
  MR_Word * check_hlds__modecheck_unify__HeadVar__7_7);
  ...
  MR_Word check_hlds__modecheck_unify__HeadVar__3_3)
{
  {
    MR_bool check_hlds__modecheck_unify__succeeded;
    MR_Integer check_hlds__modecheck_unify__CastX_12 = (MR_Integer) check_hlds__modecheck_unify__HeadVar__2_2;
    MR_Integer check_hlds__modecheck_unify__CastY_13 = (MR_Integer) check_hlds__modecheck_unify__HeadVar__3_3;

    check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__CastX_12 == check_hlds__modecheck_unify__CastY_13);
    if (check_hlds__modecheck_unify__succeeded)
      *check_hlds__modecheck_unify__HeadVar__1_1 = (MR_Integer) 0;
    else
    if (((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word check_hlds__modecheck_unify__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__HeadVar__2_2, (MR_Integer) 0)));

      if (((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word check_hlds__modecheck_unify__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__HeadVar__3_3, (MR_Integer) 0)));

        mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[3], check_hlds__modecheck_unify__HeadVar__1_1, ((MR_Box) (check_hlds__modecheck_unify__Var_16)), ((MR_Box) (check_hlds__modecheck_unify__ArgY1_5)));
      }
      else
    ...
    {
      MR_Word check_hlds__modecheck_unify__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__2_2, (MR_Integer) 0)));

      if (((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
        *check_hlds__modecheck_unify__HeadVar__1_1 = (MR_Integer) 2;
      else
      {
        MR_Word check_hlds__modecheck_unify__ArgY1_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__3_3, (MR_Integer) 0)));

        mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[1], check_hlds__modecheck_unify__HeadVar__1_1, ((MR_Box) (check_hlds__modecheck_unify__Var_17)), ((MR_Box) (check_hlds__modecheck_unify__ArgY1_11)));
      }
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word check_hlds__modecheck_unify__TypeInfo_9_9;
      MR_Word check_hlds__modecheck_unify__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word check_hlds__modecheck_unify__ArgY1_4;

      check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__HeadVar__2_2, (MR_Integer) 0)));
        check_hlds__modecheck_unify__TypeInfo_9_9 = (MR_Word) &check_hlds__modecheck_unify_scalar_common_1[3];
        check_hlds__modecheck_unify__succeeded = mercury__builtin__unify_2_p_0(check_hlds__modecheck_unify__TypeInfo_9_9, ((MR_Box) (check_hlds__modecheck_unify__ArgX1_3)), ((MR_Box) (check_hlds__modecheck_unify__ArgY1_4)));
      }
    }
    else
    {
      MR_Word check_hlds__modecheck_unify__TypeInfo_10_10;
      MR_Word check_hlds__modecheck_unify__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word check_hlds__modecheck_unify__ArgY1_6;

      check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__2_2, (MR_Integer) 0)));
        check_hlds__modecheck_unify__TypeInfo_10_10 = (MR_Word) &check_hlds__modecheck_unify_scalar_common_1[1];
        check_hlds__modecheck_unify__succeeded = mercury__builtin__unify_2_p_0(check_hlds__modecheck_unify__TypeInfo_10_10, ((MR_Box) (check_hlds__modecheck_unify__ArgX1_5)), ((MR_Box) (check_hlds__modecheck_unify__ArgY1_6)));
      }
    }
    return check_hlds__modecheck_unify__succeeded;
  }
...
{
  {
    ...
    check_hlds__modecheck_unify__succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__277__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 4))));
    return check_hlds__modecheck_unify__succeeded;
  }
}
...
{
  {
    ...
    check_hlds__modecheck_unify__succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_functor__275__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 4))));
    return check_hlds__modecheck_unify__succeeded;
  }
}
...
{
  {
    ...
    MR_Word check_hlds__modecheck_unify__Var_23;
    ...
    check_hlds__modecheck_unify__succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(check_hlds__modecheck_unify__TypeOfX_21, &check_hlds__modecheck_unify__Purity_22, &check_hlds__modecheck_unify__Var_23, &check_hlds__modecheck_unify__PredArgTypes_25);
    if (check_hlds__modecheck_unify__succeeded)
    {
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_41;
      ...
      check_hlds__modecheck_unify__Var_41 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(check_hlds__modecheck_unify__ShroudedPredProcId_26);
      check_hlds__modecheck_unify__PredId_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_41, (MR_Integer) 0)));
      check_hlds__modecheck_unify__ProcId_32 = ((MR_Integer) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_41, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (check_hlds__modecheck_unify__succeeded)
      {
        MR_Word check_hlds__modecheck_unify__Var_50;
        MR_Word check_hlds__modecheck_unify__Var_55;

        {
          check_hlds__modecheck_unify__Var_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_50, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_4[3]));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_50, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_functor_10_p_0_1));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_50, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_50, 3) = ((MR_Box) (check_hlds__modecheck_unify__IsExistConstruction_13));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_50, 4) = ((MR_Box) ((MR_Integer) 0));
        }
        mercury__require__expect_4_p_0(check_hlds__modecheck_unify__Var_50, (MR_String) "check_hlds.modecheck_unify", (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction is existential");
        {
          check_hlds__modecheck_unify__Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_55, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_4[4]));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_55, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_functor_10_p_0_2));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_55, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_55, 3) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars0_14));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_55, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        mercury__require__expect_4_p_0(check_hlds__modecheck_unify__Var_55, (MR_String) "check_hlds.modecheck_unify", (MR_String) "predicate \140check_hlds.modecheck_unify.modecheck_unification_functor\'/10", (MR_String) "const struct construction has args");
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_37;
          MR_Word check_hlds__modecheck_unify__Var_32;
          MR_Word check_hlds__modecheck_unify__Var_33;
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            if (check_hlds__modecheck_unify__succeeded)
            {
              ...
              {
                check_hlds__modecheck_unify__Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_37, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_7[1]));
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_37, 1) = ((MR_Box) (check_hlds__modecheck_unify__modecheck_unification_8_p_0_1));
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_37, 3) = ((MR_Box) (check_hlds__modecheck_unify__ModuleInfo_29));
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_37, 4) = ((MR_Box) (check_hlds__modecheck_unify__InstMap_30));
              }
              check_hlds__modecheck_unify__AnyVars_31 = mercury__list__filter_2_f_0(check_hlds__modecheck_unify__TypeInfo_47_47, check_hlds__modecheck_unify__Var_37, check_hlds__modecheck_unify__LambdaNonLocals_24);
              check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__AnyVars_31)) == (MR_mktag((MR_Integer) 1)));
              if (check_hlds__modecheck_unify__succeeded)
              {
                check_hlds__modecheck_unify__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__AnyVars_31, (MR_Integer) 0)));
                check_hlds__modecheck_unify__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__AnyVars_31, (MR_Integer) 1)));
              }
            }
          }
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            MR_Word check_hlds__modecheck_unify__Var_38;
            ...
            {
              check_hlds__modecheck_unify__Var_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Var_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Var_38, 1) = ((MR_Box) (check_hlds__modecheck_unify__AnyVars_31));
            }
            check_hlds__mode_info__mode_info_error_4_p_0(check_hlds__modecheck_unify__WaitingVars_34, check_hlds__modecheck_unify__Var_38, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_35, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_36);
            *check_hlds__modecheck_unify__Goal_14 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[1]);
          }
          else
          {
            check_hlds__modecheck_unify__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(check_hlds__modecheck_unify__UnifyGoalInfo0_13, (MR_Integer) 21);
            if (check_hlds__modecheck_unify__succeeded)
...
{
  {
    ...
    MR_Word check_hlds__modecheck_unify__Var_16 = ((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 0)))) & (MR_Integer) 3);
    MR_Word check_hlds__modecheck_unify__Var_17 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    MR_Word check_hlds__modecheck_unify__Var_18 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 0)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
    MR_Word check_hlds__modecheck_unify__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 2)));
    MR_Word check_hlds__modecheck_unify__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 3)));
    MR_Word check_hlds__modecheck_unify__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 4)));
    MR_Word check_hlds__modecheck_unify__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_10, (MR_Integer) 5)));
    MR_Word check_hlds__modecheck_unify__PredId_25;
    MR_Word check_hlds__modecheck_unify__ArgVars_26;
    MR_Word check_hlds__modecheck_unify__TypeInfo_95_95;
    MR_Word check_hlds__modecheck_unify__Var_48;
    MR_Tuple check_hlds__modecheck_unify__Var_49;
    MR_Word check_hlds__modecheck_unify__Var_71;

    hlds__goal_util__predids_with_args_from_goal_2_p_0(check_hlds__modecheck_unify__Goal0_24, &check_hlds__modecheck_unify__Var_48);
    check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Var_48)) == (MR_mktag((MR_Integer) 1)));
    if (check_hlds__modecheck_unify__succeeded)
    {
      check_hlds__modecheck_unify__Var_49 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_48, (MR_Integer) 0)));
      check_hlds__modecheck_unify__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_48, (MR_Integer) 1)));
      check_hlds__modecheck_unify__TypeInfo_95_95 = (MR_Word) &check_hlds__modecheck_unify_scalar_common_1[7];
      check_hlds__modecheck_unify__succeeded = mercury__builtin__unify_2_p_0(check_hlds__modecheck_unify__TypeInfo_95_95, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), ((MR_Box) (check_hlds__modecheck_unify__Var_71)));
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__PredId_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_49, (MR_Integer) 0)));
        check_hlds__modecheck_unify__ArgVars_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_49, (MR_Integer) 1)));
        check_hlds__modecheck_unify__succeeded = MR_TRUE;
      }
    }
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__ModuleInfo_27);
      check_hlds__mode_info__mode_info_get_instmap_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__InstMap_28);
      check_hlds__mode_info__mode_info_get_var_types_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__VarTypes_29);
      ...
      check_hlds__modecheck_unify__match_modes_by_higher_order_insts_6_p_0(check_hlds__modecheck_unify__ModuleInfo_27, check_hlds__modecheck_unify__VarTypes_29, check_hlds__modecheck_unify__InstMap_28, check_hlds__modecheck_unify__ArgVars_26, check_hlds__modecheck_unify__PredInfo_30, &check_hlds__modecheck_unify__MatchResult_31);
      if (((MR_tag((MR_Word) check_hlds__modecheck_unify__MatchResult_31)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word check_hlds__modecheck_unify__Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__MatchResult_31, (MR_Integer) 0)));

        if ((check_hlds__modecheck_unify__Var_92 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word check_hlds__modecheck_unify__MultiModeError_33;
          MR_Word check_hlds__modecheck_unify__WaitingVars_37;
          MR_Word check_hlds__modecheck_unify__ModeError_38;
          MR_Word check_hlds__modecheck_unify__MultiModeMap0_39;
          MR_Word check_hlds__modecheck_unify__MultiModeMap_40;
          MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_62;
          MR_Word check_hlds__modecheck_unify__Var_63;

          {
            check_hlds__modecheck_unify__MultiModeError_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__MultiModeError_33, 0) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars_26));
          }
          check_hlds__modecheck_unify__WaitingVars_37 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__X_9);
          {
            ...
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_38, 1) = ((MR_Box) (check_hlds__modecheck_unify__X_9));
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_38, 2) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_38, 3) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_33));
          }
          check_hlds__mode_info__mode_info_error_4_p_0(check_hlds__modecheck_unify__WaitingVars_37, check_hlds__modecheck_unify__ModeError_38, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_62);
          check_hlds__mode_info__mode_info_get_pred_var_multimode_map_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_62, &check_hlds__modecheck_unify__MultiModeMap0_39);
          {
            check_hlds__modecheck_unify__Var_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_63, 0) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_63, 1) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_33));
          }
          mercury__map__set_4_p_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], (MR_Word) &check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_pred_var_multimode_pred_error_0, ((MR_Box) (check_hlds__modecheck_unify__X_9)), ((MR_Box) (check_hlds__modecheck_unify__Var_63)), check_hlds__modecheck_unify__MultiModeMap0_39, &check_hlds__modecheck_unify__MultiModeMap_40);
          check_hlds__mode_info__mode_info_set_pred_var_multimode_map_3_p_0(check_hlds__modecheck_unify__MultiModeMap_40, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_62, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_47);
          *check_hlds__modecheck_unify__Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
        }
        else
        {
          MR_Word check_hlds__modecheck_unify__Var_93 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_92, (MR_Integer) 1)));
          MR_Integer check_hlds__modecheck_unify__Var_94 = ((MR_Integer) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_92, (MR_Integer) 0)));

          if ((check_hlds__modecheck_unify__Var_93 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word check_hlds__modecheck_unify__MaybeRHS_42;

            check_hlds__polymorphism__fix_undetermined_mode_lambda_goal_4_p_0(check_hlds__modecheck_unify__ModuleInfo_27, check_hlds__modecheck_unify__Var_94, check_hlds__modecheck_unify__RHS0_10, &check_hlds__modecheck_unify__MaybeRHS_42);
            if (((MR_tag((MR_Word) check_hlds__modecheck_unify__MaybeRHS_42)) == (MR_mktag((MR_Integer) 0))))
            {
              {
            ...
            {
              MR_Word check_hlds__modecheck_unify__RHS_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__MaybeRHS_42, (MR_Integer) 0)));
              MR_Word check_hlds__modecheck_unify__GoalInfo_44;

              hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 21, check_hlds__modecheck_unify__GoalInfo0_13, &check_hlds__modecheck_unify__GoalInfo_44);
              check_hlds__modecheck_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_101_99_104_101_99_107_95_117_110_105_102_105_99_97_116_105_111_110_95_114_104_115_95_108_97_109_98_100_97_95_95_91_53_93_95_48_8_p_0(check_hlds__modecheck_unify__X_9, check_hlds__modecheck_unify__RHS_43, check_hlds__modecheck_unify__Unification_11, check_hlds__modecheck_unify__UnifyContext_12, check_hlds__modecheck_unify__Goal_14, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_47);
            }
          }
          else
          {
            MR_Word check_hlds__modecheck_unify__MultiModeError_72;
            MR_Word check_hlds__modecheck_unify__WaitingVars_73;
            MR_Word check_hlds__modecheck_unify__ModeError_74;
            MR_Word check_hlds__modecheck_unify__MultiModeMap0_75;
            MR_Word check_hlds__modecheck_unify__MultiModeMap_76;
            MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_77;
            MR_Word check_hlds__modecheck_unify__Var_78;

            {
              check_hlds__modecheck_unify__MultiModeError_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__MultiModeError_72, 0) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars_26));
            }
            check_hlds__modecheck_unify__WaitingVars_73 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__X_9);
            {
              check_hlds__modecheck_unify__ModeError_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_74, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_74, 1) = ((MR_Box) (check_hlds__modecheck_unify__X_9));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_74, 2) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_74, 3) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_72));
            }
            check_hlds__mode_info__mode_info_error_4_p_0(check_hlds__modecheck_unify__WaitingVars_73, check_hlds__modecheck_unify__ModeError_74, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_77);
            check_hlds__mode_info__mode_info_get_pred_var_multimode_map_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_77, &check_hlds__modecheck_unify__MultiModeMap0_75);
            {
              check_hlds__modecheck_unify__Var_78 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_78, 0) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_78, 1) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_72));
            }
            mercury__map__set_4_p_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], (MR_Word) &check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_pred_var_multimode_pred_error_0, ((MR_Box) (check_hlds__modecheck_unify__X_9)), ((MR_Box) (check_hlds__modecheck_unify__Var_78)), check_hlds__modecheck_unify__MultiModeMap0_75, &check_hlds__modecheck_unify__MultiModeMap_76);
            check_hlds__mode_info__mode_info_set_pred_var_multimode_map_3_p_0(check_hlds__modecheck_unify__MultiModeMap_76, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_77, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_47);
            *check_hlds__modecheck_unify__Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
          }
        }
      }
      ...
      {
        MR_Word check_hlds__modecheck_unify__NonGroundArgVars_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__MatchResult_31, (MR_Integer) 0)));
        MR_Word check_hlds__modecheck_unify__MultiModeError_82;
        MR_Word check_hlds__modecheck_unify__WaitingVars_83;
        MR_Word check_hlds__modecheck_unify__ModeError_84;
        MR_Word check_hlds__modecheck_unify__MultiModeMap0_85;
        MR_Word check_hlds__modecheck_unify__MultiModeMap_86;
        MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_87;
        MR_Word check_hlds__modecheck_unify__Var_88;

        {
          check_hlds__modecheck_unify__MultiModeError_82 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__MultiModeError_82, 0) = ((MR_Box) (check_hlds__modecheck_unify__NonGroundArgVars_32));
        }
        check_hlds__modecheck_unify__WaitingVars_83 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__X_9);
        {
          check_hlds__modecheck_unify__ModeError_84 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_84, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
          MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_84, 1) = ((MR_Box) (check_hlds__modecheck_unify__X_9));
          MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_84, 2) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
          MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_84, 3) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_82));
        }
        check_hlds__mode_info__mode_info_error_4_p_0(check_hlds__modecheck_unify__WaitingVars_83, check_hlds__modecheck_unify__ModeError_84, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_46, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_87);
        check_hlds__mode_info__mode_info_get_pred_var_multimode_map_2_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_87, &check_hlds__modecheck_unify__MultiModeMap0_85);
        {
          check_hlds__modecheck_unify__Var_88 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_88, 0) = ((MR_Box) (check_hlds__modecheck_unify__PredId_25));
          MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_88, 1) = ((MR_Box) (check_hlds__modecheck_unify__MultiModeError_82));
        }
        mercury__map__set_4_p_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], (MR_Word) &check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_pred_var_multimode_pred_error_0, ((MR_Box) (check_hlds__modecheck_unify__X_9)), ((MR_Box) (check_hlds__modecheck_unify__Var_88)), check_hlds__modecheck_unify__MultiModeMap0_85, &check_hlds__modecheck_unify__MultiModeMap_86);
        check_hlds__mode_info__mode_info_set_pred_var_multimode_map_3_p_0(check_hlds__modecheck_unify__MultiModeMap_86, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62_87, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_47);
        *check_hlds__modecheck_unify__Goal_14 = hlds__make_goal__true_goal_expr_0_f_0();
      }
    }
    else
...
{
  {
    ...
    check_hlds__modecheck_unify__succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__modecheck_unification_rhs_lambda__459__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 4))), ((MR_Word) check_hlds__modecheck_unify__wrapper_arg_1));
    return check_hlds__modecheck_unify__succeeded;
  }
}
...
{
  {
    ...
    check_hlds__modecheck_unify__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Goal0_24, (MR_Integer) 0)));
    ...
    switch (check_hlds__modecheck_unify__Groundness_17) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word check_hlds__modecheck_unify__NonLocalTypes_42;
          MR_Word check_hlds__modecheck_unify__Var_72;
          ...
          {
            check_hlds__modecheck_unify__Var_72 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_6[0]));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 1) = ((MR_Box) (check_hlds__modecheck_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_101_99_104_101_99_107_95_117_110_105_102_105_99_97_116_105_111_110_95_114_104_115_95_108_97_109_98_100_97_95_95_91_53_93_95_48_8_p_0_1));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 3) = ((MR_Box) (check_hlds__modecheck_unify__ModuleInfo0_25));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 4) = ((MR_Box) (check_hlds__modecheck_unify__InstMap1_33));
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 5) = ((MR_Box) (check_hlds__modecheck_unify__NonLocalTypes_42));
          }
          check_hlds__modecheck_unify__NonLocals_41 = parse_tree__set_of_var__filter_2_f_0(check_hlds__modecheck_unify__TypeCtorInfo_111_111, check_hlds__modecheck_unify__Var_72, check_hlds__modecheck_unify__NonLocals1_40);
        }
        break;
      case (MR_Integer) 0:
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_79;
      ...
      {
        check_hlds__modecheck_unify__Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_79, 0) = ((MR_Box) (check_hlds__modecheck_unify__PredOrFunc_18));
      }
      check_hlds__mode_info__mode_info_lock_vars_4_p_0(check_hlds__modecheck_unify__Var_79, check_hlds__modecheck_unify__NonLocals_41, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_78_78, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_80_80);
      ...
      check_hlds__mode_info__mode_info_unlock_vars_4_p_0(check_hlds__modecheck_unify__Var_79, check_hlds__modecheck_unify__NonLocals_41, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_90_90, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_92_92);
    ...
    else
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_95;

      {
        check_hlds__modecheck_unify__Var_95 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_95, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_7[0]));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_95, 1) = ((MR_Box) (check_hlds__modecheck_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_111_100_101_99_104_101_99_107_95_117_110_105_102_105_99_97_116_105_111_110_95_114_104_115_95_108_97_109_98_100_97_95_95_91_53_93_95_48_8_p_0_2));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_95, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_95, 3) = ((MR_Box) (check_hlds__modecheck_unify__InstMap1_33));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_95, 4) = ((MR_Box) (check_hlds__modecheck_unify__ModuleInfo2_48));
      }
      mercury__list__filter_3_p_0(check_hlds__modecheck_unify__TypeInfo_109_109, check_hlds__modecheck_unify__Var_95, check_hlds__modecheck_unify__NonLocalsList_46, &check_hlds__modecheck_unify__NonGroundNonLocals_62);
      ...
      else
      {
        ...
        MR_Word check_hlds__modecheck_unify__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__NonGroundNonLocals_62, (MR_Integer) 1)));
...
{
  {
    ...
    check_hlds__modecheck_unify__conv0_LambdaHeadVar__2_50 = check_hlds__modecheck_unify__IntroducedFrom__func__modecheck_unify_lambda__509__1_1_f_0(((MR_Word) check_hlds__modecheck_unify__wrapper_arg_1));
...
{
  {
    ...
    MR_Word check_hlds__modecheck_unify__Var_43;
    ...
    check_hlds__modecheck_unify__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) check_hlds__modecheck_unify__LambdaPredInfo_28);
    {
      ...
      MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__InstOfY_27, 2) = ((MR_Box) (check_hlds__modecheck_unify__Var_43));
    }
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      check_hlds__modecheck_unify__ArgFromToInsts_36 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_from_to_insts_0, (MR_Word) &check_hlds__modecheck_unify_scalar_common_3[3], check_hlds__modecheck_unify__ArgInsts_35);
    ...
    else
    {
      ...
      {
        check_hlds__modecheck_unify__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_55, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_13));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__Var_55, &check_hlds__modecheck_unify__WaitingVars_38);
      {
...
{
  {
    ...
    check_hlds__modecheck_unify__succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_lambda__1273__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 4))));
    return check_hlds__modecheck_unify__succeeded;
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__modecheck_unify__Unification0_19)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word check_hlds__modecheck_unify__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 0)));
          MR_Word check_hlds__modecheck_unify__Var_25;
          MR_Word check_hlds__modecheck_unify__Var_26;
          MR_Word check_hlds__modecheck_unify__Var_27;
          MR_Word check_hlds__modecheck_unify__Var_28;
          ...
          check_hlds__modecheck_unify__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 2)));
          check_hlds__modecheck_unify__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 3)));
          check_hlds__modecheck_unify__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 4)));
          check_hlds__modecheck_unify__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 5)));
          ...
          if (!((check_hlds__modecheck_unify__SubInfo_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
          {
            ...
            MR_Word check_hlds__modecheck_unify__Var_87;
            ...
            {
              check_hlds__modecheck_unify__Var_87 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_87, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_87, 1) = ((MR_Box) (check_hlds__modecheck_unify__categorize_unify_var_lambda_11_p_0_1));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_87, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_87, 3) = ((MR_Box) (check_hlds__modecheck_unify__MaybeTakeAddr_30));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_87, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            mercury__require__expect_4_p_0(check_hlds__modecheck_unify__Var_87, (MR_String) "check_hlds.modecheck_unify", (MR_String) "predicate \140check_hlds.modecheck_unify.categorize_unify_var_lambda\'/11", (MR_String) "take_addr");
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word check_hlds__modecheck_unify__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 0)));
          MR_Word check_hlds__modecheck_unify__Var_33;
          MR_Word check_hlds__modecheck_unify__Var_34;
          MR_Word check_hlds__modecheck_unify__Var_35;
          MR_Word check_hlds__modecheck_unify__Var_36;
          ...
          check_hlds__modecheck_unify__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 2)));
          check_hlds__modecheck_unify__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 3)));
          check_hlds__modecheck_unify__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 4)));
          check_hlds__modecheck_unify__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 5)));
      ...
      case (MR_Integer) 2:
        {
          check_hlds__modecheck_unify__SubInfo_29 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            ...
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ConsId_24, 1) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_5[1]));
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      if (check_hlds__modecheck_unify__succeeded)
      {
        ...
        MR_Word check_hlds__modecheck_unify__Var_93;
        MR_Word check_hlds__modecheck_unify__Goal_59;
        MR_Word check_hlds__modecheck_unify__Var_94;
        MR_Word check_hlds__modecheck_unify__Var_119;
        MR_Integer check_hlds__modecheck_unify__Var_120;
        MR_Word check_hlds__modecheck_unify__Var_52;
        MR_Word check_hlds__modecheck_unify__Var_53;
        MR_Word check_hlds__modecheck_unify__Var_54;
        MR_Word check_hlds__modecheck_unify__Var_55;
        MR_Word check_hlds__modecheck_unify__Var_56;
        MR_Word check_hlds__modecheck_unify__Var_57;
        MR_Word check_hlds__modecheck_unify__Var_58;
        MR_Word check_hlds__modecheck_unify__Var_64;
        MR_Word check_hlds__modecheck_unify__Var_60;
        MR_Word check_hlds__modecheck_unify__Var_61;
        MR_Word check_hlds__modecheck_unify__Var_62;
        MR_Word check_hlds__modecheck_unify__Var_63;

        check_hlds__modecheck_unify__Var_93 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(check_hlds__modecheck_unify__ShroudedPredProcId_48);
        check_hlds__modecheck_unify__PredId_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_93, (MR_Integer) 0)));
        check_hlds__modecheck_unify__ProcId_51 = ((MR_Integer) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_93, (MR_Integer) 1)));
        check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__RHS0_17)) == (MR_mktag((MR_Integer) 2)));
        if (check_hlds__modecheck_unify__succeeded)
        {
          check_hlds__modecheck_unify__Var_52 = ((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 0)))) & (MR_Integer) 3);
          check_hlds__modecheck_unify__Var_53 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
          check_hlds__modecheck_unify__Var_54 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 0)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
          check_hlds__modecheck_unify__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 2)));
          check_hlds__modecheck_unify__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 3)));
          check_hlds__modecheck_unify__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 4)));
          check_hlds__modecheck_unify__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__RHS0_17, (MR_Integer) 5)));
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            check_hlds__modecheck_unify__Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Goal_59, (MR_Integer) 0)));
            check_hlds__modecheck_unify__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Goal_59, (MR_Integer) 1)));
            check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Var_94)) == (MR_mktag((MR_Integer) 2)));
            if (check_hlds__modecheck_unify__succeeded)
            {
              check_hlds__modecheck_unify__Var_119 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 0)));
              check_hlds__modecheck_unify__Var_120 = ((MR_Integer) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 1)));
              check_hlds__modecheck_unify__Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 2)));
              check_hlds__modecheck_unify__Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 3)));
              check_hlds__modecheck_unify__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 4)));
              check_hlds__modecheck_unify__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_94, (MR_Integer) 5)));
              check_hlds__modecheck_unify__succeeded = hlds__hlds_pred____Unify____pred_id_0_0(check_hlds__modecheck_unify__PredId_50, check_hlds__modecheck_unify__Var_119);
              if (check_hlds__modecheck_unify__succeeded)
                check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__ProcId_51 == check_hlds__modecheck_unify__Var_120);
            }
          }
        }
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_104;
          MR_Word check_hlds__modecheck_unify__PorF_70;
          MR_Word check_hlds__modecheck_unify__Var_71;
          MR_Word check_hlds__modecheck_unify__Var_72;
          MR_Word check_hlds__modecheck_unify__Var_73;
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            check_hlds__modecheck_unify__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Type_69, (MR_Integer) 2)));
            check_hlds__modecheck_unify__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Type_69, (MR_Integer) 3)));
            check_hlds__modecheck_unify__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Type_69, (MR_Integer) 4)));
          ...
          {
            check_hlds__modecheck_unify__Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_104, 0) = ((MR_Box) (check_hlds__modecheck_unify__PredModule_66));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_104, 1) = ((MR_Box) (check_hlds__modecheck_unify__PredName_67));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__RHSConsId_76, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_104));
    ...
    else
    {
      ...
      if (check_hlds__modecheck_unify__succeeded)
      {
        ...
        MR_Word check_hlds__modecheck_unify__Var_111;
        ...
        {
          check_hlds__modecheck_unify__Var_111 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_111, 0) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars_15));
          MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__Var_111, 1) = ((MR_Box) (check_hlds__modecheck_unify__ArgFromToInsts_13));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_79, 2) = ((MR_Box) (check_hlds__modecheck_unify__Var_111));
...
{
  {
    MR_Word check_hlds__modecheck_unify__CalleeProcIds_13;

    check_hlds__modecheck_unify__CalleeProcIds_13 = hlds__hlds_pred__pred_info_procids_1_f_0(check_hlds__modecheck_unify__CalleePredInfo_11);
    check_hlds__modecheck_unify__match_modes_by_higher_order_insts_2_9_p_0(check_hlds__modecheck_unify__ModuleInfo_7, check_hlds__modecheck_unify__VarTypes_8, check_hlds__modecheck_unify__InstMap_9, check_hlds__modecheck_unify__ArgVars_10, check_hlds__modecheck_unify__CalleePredInfo_11, check_hlds__modecheck_unify__CalleeProcIds_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__modecheck_unify__Result_12);
  }
}
  ...
  MR_Word * check_hlds__modecheck_unify__Result_9)
{
  while (MR_TRUE)
  {
    ...
    if ((check_hlds__modecheck_unify__HeadVar__6_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      if ((check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_0_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word check_hlds__modecheck_unify__Var_23;

        check_hlds__modecheck_unify__Var_23 = mercury__list__reverse_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_0_7);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          *check_hlds__modecheck_unify__Result_9 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var_23));
        }
      }
      else
      {
        MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_22_24;

        check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_22_24 = mercury__list__sort_and_remove_dups_1_f_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_0_8);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *check_hlds__modecheck_unify__Result_9 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_22_24));
        }
      }
    else
    {
      MR_Integer check_hlds__modecheck_unify__ProcId_30 = ((MR_Integer) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__6_6, (MR_Integer) 0)));
      MR_Word check_hlds__modecheck_unify__ProcIds_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__6_6, (MR_Integer) 1)));
      MR_Word check_hlds__modecheck_unify__CalleeProcInfo_35;
      MR_Word check_hlds__modecheck_unify__ArgModes_36;
      MR_Word check_hlds__modecheck_unify__ProcNonGroundNonLocals_37;
      MR_Word check_hlds__modecheck_unify__ProcResult_38;
      MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_41_41;
      MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42;

      hlds__hlds_pred__pred_info_proc_info_3_p_0(check_hlds__modecheck_unify__CalleePredInfo_5, check_hlds__modecheck_unify__ProcId_30, &check_hlds__modecheck_unify__CalleeProcInfo_35);
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(check_hlds__modecheck_unify__CalleeProcInfo_35, &check_hlds__modecheck_unify__ArgModes_36);
      check_hlds__modecheck_unify__match_mode_by_higher_order_insts_7_p_0(check_hlds__modecheck_unify__ModuleInfo_1, check_hlds__modecheck_unify__VarTypes_2, check_hlds__modecheck_unify__InstMap_3, check_hlds__modecheck_unify__ArgVars_4, check_hlds__modecheck_unify__ArgModes_36, &check_hlds__modecheck_unify__ProcNonGroundNonLocals_37, &check_hlds__modecheck_unify__ProcResult_38);
      check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_41_41 = mercury__list__f_43_43_2_f_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], check_hlds__modecheck_unify__ProcNonGroundNonLocals_37, check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_0_8);
      switch (check_hlds__modecheck_unify__ProcResult_38) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42 = check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_0_7;
          break;
        case (MR_Integer) 0:
          {
            check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42, 0) = ((MR_Box) (check_hlds__modecheck_unify__ProcId_30));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42, 1) = ((MR_Box) (check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_0_7));
          }
          break;
      }
      /* direct tailcall eliminated */
      {
        MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__6_6 = check_hlds__modecheck_unify__ProcIds_31;
        MR_Word check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_RevMatchedProcIds_0_7 = check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_42_42;
        MR_Word check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_NonGroundNonLocals_0_8 = check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_41_41;

        check_hlds__modecheck_unify__HeadVar__6_6 = check_hlds__modecheck_unify__next_value_of_HeadVar__6_6;
        check_hlds__modecheck_unify__STATE_VARIABLE_RevMatchedProcIds_0_7 = check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_RevMatchedProcIds_0_7;
        check_hlds__modecheck_unify__STATE_VARIABLE_NonGroundNonLocals_0_8 = check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_NonGroundNonLocals_0_8;
      }
      continue;
    }
    break;
...
{
  {
    ...
    {
      *check_hlds__modecheck_unify__HeadVar__6_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      *check_hlds__modecheck_unify__HeadVar__7_7 = (MR_Integer) 0;
    }
    else
    {
      MR_Word check_hlds__modecheck_unify__ArgVar_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__4_4, (MR_Integer) 0)));
      MR_Word check_hlds__modecheck_unify__ArgVars_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__4_4, (MR_Integer) 1)));
      MR_Word check_hlds__modecheck_unify__ArgMode_20;
      MR_Word check_hlds__modecheck_unify__ArgModes_21;
      MR_Word check_hlds__modecheck_unify__TailNonGroundArgVars_22;
      MR_Word check_hlds__modecheck_unify__TailResult_23;
      MR_Word check_hlds__modecheck_unify__Initial_24;
      MR_Word check_hlds__modecheck_unify__Var_32;
      MR_Word check_hlds__modecheck_unify__Var_25;
      MR_Word check_hlds__modecheck_unify__Var_26;
      ...
      {
        {
          mercury__require__unexpected_3_p_0((MR_String) "check_hlds.modecheck_unify", (MR_String) "predicate \140check_hlds.modecheck_unify.match_mode_by_higher_order_insts\'/7", (MR_String) "too many arguments");
          return;
        }
      }
      else
      {
        check_hlds__modecheck_unify__ArgMode_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__ArgModesList_5, (MR_Integer) 0)));
        check_hlds__modecheck_unify__ArgModes_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__ArgModesList_5, (MR_Integer) 1)));
      }
      check_hlds__modecheck_unify__match_mode_by_higher_order_insts_7_p_0(check_hlds__modecheck_unify__HeadVar__1_1, check_hlds__modecheck_unify__HeadVar__2_2, check_hlds__modecheck_unify__HeadVar__3_3, check_hlds__modecheck_unify__ArgVars_16, check_hlds__modecheck_unify__ArgModes_21, &check_hlds__modecheck_unify__TailNonGroundArgVars_22, &check_hlds__modecheck_unify__TailResult_23);
      check_hlds__modecheck_unify__Initial_24 = check_hlds__mode_util__mode_get_initial_inst_2_f_0(check_hlds__modecheck_unify__HeadVar__1_1, check_hlds__modecheck_unify__ArgMode_20);
      check_hlds__modecheck_unify__succeeded = ((((MR_tag((MR_Word) check_hlds__modecheck_unify__Initial_24)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Initial_24, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Initial_24, (MR_Integer) 1)));
        check_hlds__modecheck_unify__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Initial_24, (MR_Integer) 2)));
        check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Var_32)) == (MR_mktag((MR_Integer) 1)));
        if (check_hlds__modecheck_unify__succeeded)
          check_hlds__modecheck_unify__Var_26 = (MR_Word) MR_body(((MR_Word) check_hlds__modecheck_unify__Var_32), (MR_Integer) 1);
      }
      if (check_hlds__modecheck_unify__succeeded)
      {
        MR_Word check_hlds__modecheck_unify__ArgInst_27;
        MR_Word check_hlds__modecheck_unify__ArgType_28;

        hlds__instmap__instmap_lookup_var_3_p_0(check_hlds__modecheck_unify__HeadVar__3_3, check_hlds__modecheck_unify__ArgVar_15, &check_hlds__modecheck_unify__ArgInst_27);
        hlds__vartypes__lookup_var_type_3_p_0(check_hlds__modecheck_unify__HeadVar__2_2, check_hlds__modecheck_unify__ArgVar_15, &check_hlds__modecheck_unify__ArgType_28);
        check_hlds__modecheck_unify__succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(check_hlds__modecheck_unify__ArgInst_27, check_hlds__modecheck_unify__Initial_24, check_hlds__modecheck_unify__ArgType_28, check_hlds__modecheck_unify__HeadVar__1_1);
        if (check_hlds__modecheck_unify__succeeded)
        {
          *check_hlds__modecheck_unify__HeadVar__6_6 = check_hlds__modecheck_unify__TailNonGroundArgVars_22;
          *check_hlds__modecheck_unify__HeadVar__7_7 = check_hlds__modecheck_unify__TailResult_23;
        }
        else
        {
          check_hlds__modecheck_unify__succeeded = check_hlds__inst_test__inst_is_ground_2_p_0(check_hlds__modecheck_unify__HeadVar__1_1, check_hlds__modecheck_unify__ArgInst_27);
          if (check_hlds__modecheck_unify__succeeded)
            *check_hlds__modecheck_unify__HeadVar__6_6 = check_hlds__modecheck_unify__TailNonGroundArgVars_22;
          else
            {
              ...
              *check_hlds__modecheck_unify__HeadVar__6_6 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (check_hlds__modecheck_unify__ArgVar_15));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__TailNonGroundArgVars_22));
            }
          *check_hlds__modecheck_unify__HeadVar__7_7 = (MR_Integer) 1;
        }
      }
      else
      {
...
{
  {
    ...
    (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16 = check_hlds__modecheck_unify__ArgVars0_16;
    {
      ...
      {
        check_hlds__modecheck_unify__Var_73 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_73, 0) = ((MR_Box) (check_hlds__modecheck_unify__InstConsId_34));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_73, 1) = ((MR_Box) ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__InstsOfArgVars_31));
      }
      {
        check_hlds__modecheck_unify__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_72, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var_73));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__InstOfY_35, 3) = ((MR_Box) (check_hlds__modecheck_unify__Var_72));
      }
      ...
      if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
      {
        ...
        {
          MR_Word check_hlds__modecheck_unify__Var_80;

          {
            check_hlds__modecheck_unify__Var_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_80, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_23));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_80, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          check_hlds__modecheck_unify__handle_var_functor_mode_error_9_p_0(check_hlds__modecheck_unify__X_23, check_hlds__modecheck_unify__InstConsId_34, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__InstOfX_24, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__InstsOfArgVars_31, check_hlds__modecheck_unify__Var_80, check_hlds__modecheck_unify__GoalExpr_20, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_69_69, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_68);
        }
      }
      else
      {
        ...
        MR_Word check_hlds__modecheck_unify__Var_83;
        ...
        if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_57;
          MR_Word check_hlds__modecheck_unify__Var_58;
          MR_Word check_hlds__modecheck_unify__Var_59;
          MR_Word check_hlds__modecheck_unify__Var_60;
          MR_Word check_hlds__modecheck_unify__Var_61;
          ...
          {
            check_hlds__modecheck_unify__Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_87, 0) = ((MR_Box) (check_hlds__modecheck_unify__InstOfY_35));
          }
          check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(check_hlds__modecheck_unify__X_23, check_hlds__modecheck_unify__UnifiedInst_40, check_hlds__modecheck_unify__Var_87, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_86_86, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_88_88);
          ...
          if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
          {
            check_hlds__modecheck_unify__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 0)));
            check_hlds__modecheck_unify__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 1)));
            check_hlds__modecheck_unify__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 2)));
            check_hlds__modecheck_unify__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 3)));
            check_hlds__modecheck_unify__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 4)));
            check_hlds__modecheck_unify__Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 5)));
            check_hlds__modecheck_unify__Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification_52, (MR_Integer) 6)));
          ...
          if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
          {
            *check_hlds__modecheck_unify__GoalExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[1]);
          ...
          else
          {
            ...
            else
            {
              ...
              MR_Word check_hlds__modecheck_unify__Var_99;
              MR_Word check_hlds__modecheck_unify__Var_100;
              MR_Word check_hlds__modecheck_unify__Var_65;
              MR_Word check_hlds__modecheck_unify__Var_66;
              ...
              if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
              {
                ...
                if ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__succeeded)
                {
                  check_hlds__modecheck_unify__Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__ExtraGoals_64, (MR_Integer) 0)));
                  check_hlds__modecheck_unify__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__ExtraGoals_64, (MR_Integer) 1)));
              ...
              {
                check_hlds__modecheck_unify__Var_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_99, 0) = ((MR_Box) (check_hlds__modecheck_unify__X0_12));
                MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_99, 1) = ((MR_Box) ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16));
              }
              {
                check_hlds__modecheck_unify__Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_100, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_23));
                MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_100, 1) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars_53));
              }
              check_hlds__modecheck_util__handle_extra_goals_9_p_0(check_hlds__modecheck_unify__UnifyExpr_63, check_hlds__modecheck_unify__ExtraGoals_64, check_hlds__modecheck_unify__GoalInfo0_19, check_hlds__modecheck_unify__Var_99, check_hlds__modecheck_unify__Var_100, check_hlds__modecheck_unify__InstMap0_22, check_hlds__modecheck_unify__GoalExpr_20, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_89_89, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_68);
            }
          }
        }
        else
        {
          MR_Word check_hlds__modecheck_unify__Var_102;

          {
            check_hlds__modecheck_unify__Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_102, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_23));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_102, 1) = ((MR_Box) ((check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16));
          }
          check_hlds__modecheck_unify__handle_var_functor_mode_error_9_p_0(check_hlds__modecheck_unify__X_23, check_hlds__modecheck_unify__InstConsId_34, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__ArgVars0_16, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__InstOfX_24, (check_hlds__modecheck_unify__env).check_hlds__modecheck_unify__modecheck_unify_functor_11_p_0_env_0__InstsOfArgVars_31, check_hlds__modecheck_unify__Var_102, check_hlds__modecheck_unify__GoalExpr_20, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_69_69, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_68);
        }
      }
    }
  }
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      switch (MR_tag((MR_Word) check_hlds__modecheck_unify__FinalInst_5)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word check_hlds__modecheck_unify__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(2), check_hlds__modecheck_unify__FinalInst_5, (MR_Integer) 1)));
            ...
            check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            if (check_hlds__modecheck_unify__succeeded)
            {
              check_hlds__modecheck_unify__pair_with_final_inst_3_p_0(check_hlds__modecheck_unify__ArgInitInsts_4, check_hlds__modecheck_unify__FinalInst_5, check_hlds__modecheck_unify__ArgFromToInsts_6);
              check_hlds__modecheck_unify__succeeded = MR_TRUE;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_5, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                  ...
                  MR_Word check_hlds__modecheck_unify__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__BoundInsts_9, (MR_Integer) 0)));
                  MR_Word check_hlds__modecheck_unify__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__BoundInsts_9, (MR_Integer) 1)));
                  MR_Word check_hlds__modecheck_unify___Name_10;

                  check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  if (check_hlds__modecheck_unify__succeeded)
                  {
                    check_hlds__modecheck_unify___Name_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_14, (MR_Integer) 0)));
                    check_hlds__modecheck_unify__FunctorArgInsts_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_14, (MR_Integer) 1)));
            ...
            case (MR_Integer) 1:
              {
                MR_Word check_hlds__modecheck_unify__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_5, (MR_Integer) 2)));
                ...
                check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (check_hlds__modecheck_unify__succeeded)
                {
                  check_hlds__modecheck_unify__pair_with_final_inst_3_p_0(check_hlds__modecheck_unify__ArgInitInsts_4, check_hlds__modecheck_unify__FinalInst_5, check_hlds__modecheck_unify__ArgFromToInsts_6);
                  check_hlds__modecheck_unify__succeeded = MR_TRUE;
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word check_hlds__modecheck_unify__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_5, (MR_Integer) 1)));

                /* direct tailcall eliminated */
                {
                  MR_Word check_hlds__modecheck_unify__next_value_of_FinalInst_5 = check_hlds__modecheck_unify__SubInst_13;

                  check_hlds__modecheck_unify__FinalInst_5 = check_hlds__modecheck_unify__next_value_of_FinalInst_5;
                }
                continue;
              }
              break;
  ...
  MR_Word * check_hlds__modecheck_unify__HeadVar__3_3)
{
  ...
  {
    MR_Word check_hlds__modecheck_unify__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__1_1, (MR_Integer) 1)));
    MR_Word check_hlds__modecheck_unify__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__HeadVar__1_1, (MR_Integer) 0)));
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInst_20, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var_23));
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInst_20, 1) = ((MR_Box) (check_hlds__modecheck_unify__InstB_18));
      }
      check_hlds__modecheck_unify__pair_up_insts_3_p_0(check_hlds__modecheck_unify__Var_22, check_hlds__modecheck_unify__InstsB_19, &check_hlds__modecheck_unify__FromToInsts_21);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        *check_hlds__modecheck_unify__HeadVar__3_3 = base;
...
{
  {
    ...
    check_hlds__modecheck_unify__conv0_LambdaHeadVar__2_20 = check_hlds__modecheck_unify__IntroducedFrom__func__bind_args_if_needed__1618__1_1_f_0(((MR_Word) check_hlds__modecheck_unify__wrapper_arg_1));
...
{
  {
    ...
    check_hlds__modecheck_unify__succeeded = check_hlds__modecheck_unify__IntroducedFrom__pred__categorize_unify_var_functor__1378__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__closure, (MR_Integer) 4))));
    return check_hlds__modecheck_unify__succeeded;
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__modecheck_unify__Unification0_21)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word check_hlds__modecheck_unify__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 0)));
          MR_Word check_hlds__modecheck_unify__Var_27;
          MR_Word check_hlds__modecheck_unify__Var_28;
          MR_Word check_hlds__modecheck_unify__Var_29;
          MR_Word check_hlds__modecheck_unify__Var_30;
          ...
          check_hlds__modecheck_unify__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 2)));
          check_hlds__modecheck_unify__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 3)));
          check_hlds__modecheck_unify__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 4)));
          check_hlds__modecheck_unify__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 5)));
          ...
          if (!((check_hlds__modecheck_unify__SubInfo_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
          {
            ...
            {
              check_hlds__modecheck_unify__Var_72 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 0) = ((MR_Box) (&check_hlds__modecheck_unify_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 1) = ((MR_Box) (check_hlds__modecheck_unify__categorize_unify_var_functor_12_p_0_1));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 3) = ((MR_Box) (check_hlds__modecheck_unify__MaybeTakeAddr_32));
              MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_72, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            mercury__require__expect_4_p_0(check_hlds__modecheck_unify__Var_72, (MR_String) "check_hlds.modecheck_unify", (MR_String) "predicate \140check_hlds.modecheck_unify.categorize_unify_var_functor\'/12", (MR_String) "take_addr");
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word check_hlds__modecheck_unify__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 0)));
          MR_Word check_hlds__modecheck_unify__Var_37;
          MR_Word check_hlds__modecheck_unify__Var_38;
          MR_Word check_hlds__modecheck_unify__Var_39;
          MR_Word check_hlds__modecheck_unify__Var_40;
          ...
          check_hlds__modecheck_unify__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 2)));
          check_hlds__modecheck_unify__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 3)));
          check_hlds__modecheck_unify__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 4)));
          check_hlds__modecheck_unify__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_21, (MR_Integer) 5)));
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      {
        check_hlds__modecheck_unify__Var_79 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_79, 0) = ((MR_Box) (check_hlds__modecheck_unify__UnifyContext_20));
      }
      check_hlds__mode_info__mode_info_set_call_context_3_p_0(check_hlds__modecheck_unify__Var_79, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_70, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_80_80);
    ...
    else
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_83;
      MR_Word check_hlds__modecheck_unify__Var_84;
      MR_Word check_hlds__modecheck_unify__Var_85;
      MR_Word check_hlds__modecheck_unify__Var_86;
      MR_Word check_hlds__modecheck_unify__Var_54;
      MR_Word check_hlds__modecheck_unify__Var_55;
      MR_Word check_hlds__modecheck_unify__Var_56;
      MR_Word check_hlds__modecheck_unify__Var_57;
      ...
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__InitialInst_52, (MR_Integer) 1)));
        check_hlds__modecheck_unify__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__InitialInst_52, (MR_Integer) 2)));
        check_hlds__modecheck_unify__Var_83 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__InitialInst_52, (MR_Integer) 3)));
        check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Var_83)) == (MR_mktag((MR_Integer) 1)));
        if (check_hlds__modecheck_unify__succeeded)
        {
          check_hlds__modecheck_unify__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_83, (MR_Integer) 0)));
          check_hlds__modecheck_unify__Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_83, (MR_Integer) 1)));
          check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_84 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            if (check_hlds__modecheck_unify__succeeded)
            {
              check_hlds__modecheck_unify__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_53, (MR_Integer) 1)));
              check_hlds__modecheck_unify__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_53, (MR_Integer) 2)));
              check_hlds__modecheck_unify__Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__FinalInst_53, (MR_Integer) 3)));
              check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Var_85)) == (MR_mktag((MR_Integer) 1)));
              if (check_hlds__modecheck_unify__succeeded)
              {
                check_hlds__modecheck_unify__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_85, (MR_Integer) 0)));
                check_hlds__modecheck_unify__Var_86 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_85, (MR_Integer) 1)));
                check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_86 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
            }
          }
        }
      ...
      else
      {
        ...
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            check_hlds__modecheck_unify__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Constructors_61, (MR_Integer) 0)));
            check_hlds__modecheck_unify__Var_87 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Constructors_61, (MR_Integer) 1)));
            check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_87 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
        }
        if (check_hlds__modecheck_unify__succeeded)
        {
        ...
        else
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_64;
          MR_Word check_hlds__modecheck_unify__Var_67;
          ...
          check_hlds__modecheck_unify__succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(check_hlds__modecheck_unify__TypeOfX_24, &check_hlds__modecheck_unify__Var_64, &check_hlds__modecheck_unify__PredOrFunc_65, &check_hlds__modecheck_unify__Var_67);
          if (check_hlds__modecheck_unify__succeeded)
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            {
              check_hlds__modecheck_unify__Var_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_88, 0) = ((MR_Box) (check_hlds__modecheck_unify__ConsId_35));
              MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_88, 1) = ((MR_Box) (check_hlds__modecheck_unify__ArgVars_18));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_69, 2) = ((MR_Box) (check_hlds__modecheck_unify__Var_88));
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          check_hlds__modecheck_util__modecheck_introduced_type_info_var_has_inst_no_exact_match_5_p_0(check_hlds__modecheck_unify__ArgVar_11, check_hlds__modecheck_unify__ArgType_16, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[0]), check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_20_20, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_22_22);
          /* direct tailcall eliminated */
          {
            MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__1_1 = check_hlds__modecheck_unify__ArgVars_12;
            MR_Word check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_ModeInfo_0_4 = check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_22_22;

            check_hlds__modecheck_unify__HeadVar__1_1 = check_hlds__modecheck_unify__next_value_of_HeadVar__1_1;
            check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_4 = check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_ModeInfo_0_4;
          }
          continue;
        }
        else
...
{
  {
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      check_hlds__modecheck_unify__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Unification0_8, (MR_Integer) 2)));
      ...
      check_hlds__modecheck_unify__succeeded = mercury__builtin__unify_2_p_0(check_hlds__modecheck_unify__TypeInfo_29_29, ((MR_Box) (check_hlds__modecheck_unify__ArgVars0_10)), ((MR_Box) (check_hlds__modecheck_unify__Var_28)));
    }
    if (check_hlds__modecheck_unify__succeeded)
    {
...
{
  {
    ...
    else
    {
      ...
      if (check_hlds__modecheck_unify__succeeded)
      {
        ...
        check_hlds__modecheck_unify__Var_28 = (MR_Integer) 0;
        check_hlds__mode_util__from_to_insts_to_top_functor_mode_4_p_0(check_hlds__modecheck_unify__ModuleInfo_17, check_hlds__modecheck_unify__FromToInstsX_18, check_hlds__modecheck_unify__VarType_21, &check_hlds__modecheck_unify__Var_34);
        check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_28 == check_hlds__modecheck_unify__Var_34);
        if (check_hlds__modecheck_unify__succeeded)
        {
          check_hlds__modecheck_unify__Var_29 = (MR_Integer) 0;
          check_hlds__mode_util__from_to_insts_to_top_functor_mode_4_p_0(check_hlds__modecheck_unify__ModuleInfo_17, check_hlds__modecheck_unify__FromToInstsY_19, check_hlds__modecheck_unify__VarType_21, &check_hlds__modecheck_unify__Var_35);
          check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_29 == check_hlds__modecheck_unify__Var_35);
        }
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_51;
          ...
          {
            check_hlds__modecheck_unify__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_51, 0) = ((MR_Box) (check_hlds__modecheck_unify__ExtraGoal_47));
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__ExtraGoals0_23, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_51));
          }
...
{
  {
    ...
    MR_Integer check_hlds__modecheck_unify__Var_27;
    ...
    check_hlds__modecheck_unify__Var_27 = mercury__list__length_1_f_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0], check_hlds__modecheck_unify__ArgVars0_12);
    check_hlds__modecheck_unify__NoArgInsts_21 = mercury__list__duplicate_2_f_0((MR_Word) &check_hlds__modecheck_unify_scalar_common_1[2], check_hlds__modecheck_unify__Var_27, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))));
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                  ...
                  MR_Word check_hlds__modecheck_unify__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__BoundInsts_14, (MR_Integer) 0)));
                  MR_Word check_hlds__modecheck_unify__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__BoundInsts_14, (MR_Integer) 1)));
                  MR_Word check_hlds__modecheck_unify__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_22, (MR_Integer) 0)));

                  check_hlds__modecheck_unify__ArgInsts_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_22, (MR_Integer) 1)));
                  check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  if (check_hlds__modecheck_unify__succeeded)
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word check_hlds__modecheck_unify__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Inst_6, (MR_Integer) 2)));

                check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (check_hlds__modecheck_unify__succeeded)
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word check_hlds__modecheck_unify__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Inst_6, (MR_Integer) 1)));

                /* direct tailcall eliminated */
                {
                  MR_Word check_hlds__modecheck_unify__next_value_of_Inst_6 = check_hlds__modecheck_unify__SubInst_18;

                  check_hlds__modecheck_unify__Inst_6 = check_hlds__modecheck_unify__next_value_of_Inst_6;
                }
                continue;
              }
              break;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word check_hlds__modecheck_unify__Var_19;
        MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_20_20;
        ...
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          check_hlds__modecheck_unify__Var_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            ...
            MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Ground_16, 2) = ((MR_Box) (check_hlds__modecheck_unify__Var_19));
          }
          ...
          /* direct tailcall eliminated */
          {
            MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__2_2 = check_hlds__modecheck_unify__Args_12;
            MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__3_3 = check_hlds__modecheck_unify__UnifyArgInsts_14;
            MR_Word check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_ModeInfo_0_4 = check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_20_20;

            check_hlds__modecheck_unify__HeadVar__2_2 = check_hlds__modecheck_unify__next_value_of_HeadVar__2_2;
            check_hlds__modecheck_unify__HeadVar__3_3 = check_hlds__modecheck_unify__next_value_of_HeadVar__3_3;
            check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_4 = check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_ModeInfo_0_4;
          }
          continue;
        }
      ...
      else
      {
        ...
        if (check_hlds__modecheck_unify__succeeded)
        {
          ...
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__1_1 = check_hlds__modecheck_unify__Args_10;
              MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__2_2 = check_hlds__modecheck_unify__Insts_12;
              MR_Word check_hlds__modecheck_unify__next_value_of_HeadVar__3_3 = check_hlds__modecheck_unify__UnifyArgInsts_14;
              MR_Word check_hlds__modecheck_unify__next_value_of_STATE_VARIABLE_ModeInfo_0_4 = check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_18_18;
...
{
  {
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      {
        check_hlds__modecheck_unify__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_37, 0) = ((MR_Box) (check_hlds__modecheck_unify__ExtraGoal_33));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        *check_hlds__modecheck_unify__ExtraGoals_14 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_37));
      }
...
{
  {
    ...
    {
      check_hlds__modecheck_unify__Var_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_35, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var_7));
    }
    hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(check_hlds__modecheck_unify__Var0_6, check_hlds__modecheck_unify__Var_35, check_hlds__modecheck_unify__Context_13, check_hlds__modecheck_unify__MainContext_16, check_hlds__modecheck_unify__SubContexts_17, &check_hlds__modecheck_unify__Var_36);
    check_hlds__modecheck_unify__GoalExpr0_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_36, (MR_Integer) 0)));
    check_hlds__modecheck_unify__GoalInfo0_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_36, (MR_Integer) 1)));
    {
      check_hlds__modecheck_unify__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_38, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var_7));
      MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      check_hlds__modecheck_unify__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_37, 0) = ((MR_Box) (check_hlds__modecheck_unify__Var0_6));
      MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_37, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_38));
    }
    parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__Var_37, &check_hlds__modecheck_unify__NonLocals_20);
...
{
  {
    ...
    MR_Word check_hlds__modecheck_unify__Var_19;
    MR_Word check_hlds__modecheck_unify__Var_20;
    MR_Word check_hlds__modecheck_unify__Var_21;
    ...
    check_hlds__modecheck_unify__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__ConstStruct_18, (MR_Integer) 0)));
    check_hlds__modecheck_unify__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__ConstStruct_18, (MR_Integer) 1)));
    check_hlds__modecheck_unify__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__ConstStruct_18, (MR_Integer) 2)));
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      {
        check_hlds__modecheck_unify__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_32, 0) = ((MR_Box) (check_hlds__modecheck_unify__InstOfY_22));
      }
      check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(check_hlds__modecheck_unify__X_8, check_hlds__modecheck_unify__InstOfY_22, check_hlds__modecheck_unify__Var_32, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_30, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_31);
      {
      ...
      {
        check_hlds__modecheck_unify__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_39, 0) = ((MR_Box) (check_hlds__modecheck_unify__ConsId_9));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_39, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_39, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
        *check_hlds__modecheck_unify__UnifyGoalExpr_12 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_39));
    ...
    else
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_42;
      ...
      {
        check_hlds__modecheck_unify__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_42, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_8));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__Var_42, &check_hlds__modecheck_unify__WaitingVars_28);
      {
      ...
      {
        check_hlds__modecheck_unify__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_54, 0) = ((MR_Box) (check_hlds__modecheck_unify__ConsId_9));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_54, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_54, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
        *check_hlds__modecheck_unify__UnifyGoalExpr_12 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_8));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_54));
...
{
  {
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      {
        check_hlds__modecheck_unify__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_40, 0) = ((MR_Box) (check_hlds__modecheck_unify__InstOfY_20));
      }
      check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(check_hlds__modecheck_unify__X_9, check_hlds__modecheck_unify__UnifiedInst_24, check_hlds__modecheck_unify__Var_40, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_39_39, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_41_41);
      {
        check_hlds__modecheck_unify__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_42, 0) = ((MR_Box) (check_hlds__modecheck_unify__InstOfX_19));
      }
      check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(check_hlds__modecheck_unify__Y_10, check_hlds__modecheck_unify__UnifiedInst_24, check_hlds__modecheck_unify__Var_42, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_41_41, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_43_43);
      {
    ...
    else
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_45;
      MR_Word check_hlds__modecheck_unify__Var_46;
      ...
      {
        check_hlds__modecheck_unify__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_46, 0) = ((MR_Box) (check_hlds__modecheck_unify__Y_10));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        check_hlds__modecheck_unify__Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_45, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_9));
        MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Var_45, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_46));
      }
      parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_unify__Var_45, &check_hlds__modecheck_unify__WaitingVars_32);
      {
      ...
      {
        check_hlds__modecheck_unify__Var_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_53, 0) = ((MR_Box) (check_hlds__modecheck_unify__Y_10));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
        *check_hlds__modecheck_unify__UnifyGoalExpr_14 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (check_hlds__modecheck_unify__X_9));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_53));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          {
            MR_Word check_hlds__modecheck_unify__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfX_15, (MR_Integer) 0)));
            MR_Word check_hlds__modecheck_unify__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfX_15, (MR_Integer) 1)));

            check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_57 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          }
          if (!(check_hlds__modecheck_unify__succeeded))
          {
            MR_Word check_hlds__modecheck_unify__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfY_16, (MR_Integer) 0)));
            MR_Word check_hlds__modecheck_unify__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfY_16, (MR_Integer) 1)));

            check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_56 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          }
          if (check_hlds__modecheck_unify__succeeded)
          {
            {
          ...
          else
          {
            ...
            if (check_hlds__modecheck_unify__succeeded)
            {
              check_hlds__modecheck_unify__succeeded = check_hlds__type_util__type_has_user_defined_equality_pred_3_p_0(check_hlds__modecheck_unify__ModuleInfo0_28, check_hlds__modecheck_unify__Type_32, &check_hlds__modecheck_unify__Var_33);
              check_hlds__modecheck_unify__succeeded = !(check_hlds__modecheck_unify__succeeded);
            }
            if (check_hlds__modecheck_unify__succeeded)
            {
            ...
            else
            {
              ...
              check_hlds__modecheck_unify__Var_71 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
              check_hlds__modecheck_unify__succeeded = parse_tree__prog_data____Unify____mer_type_0_0(check_hlds__modecheck_unify__Type_32, check_hlds__modecheck_unify__Var_71);
              if (check_hlds__modecheck_unify__succeeded)
              {
                check_hlds__modecheck_unify__Var_58 = (MR_Integer) 20;
                check_hlds__modecheck_unify__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(check_hlds__modecheck_unify__GoalInfo_23, check_hlds__modecheck_unify__Var_58);
              }
              if (check_hlds__modecheck_unify__succeeded)
              {
                {
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      check_hlds__modecheck_unify__Var_60 = (MR_Integer) 1;
      check_hlds__mode_info__mode_info_var_is_live_3_p_0(check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_59_59, check_hlds__modecheck_unify__AssignTarget_34, &check_hlds__modecheck_unify__Var_72);
      check_hlds__modecheck_unify__succeeded = (check_hlds__modecheck_unify__Var_60 == check_hlds__modecheck_unify__Var_72);
    }
    if (check_hlds__modecheck_unify__succeeded)
    {
      ...
      *check_hlds__modecheck_unify__Unify_26 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[1]);
    ...
    else
    {
      ...
      else
      {
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word check_hlds__modecheck_unify__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfX_15, (MR_Integer) 1)));
                MR_Word check_hlds__modecheck_unify__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__FromToInstsOfY_16, (MR_Integer) 1)));
        ...
        else
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_70;
          ...
          {
            check_hlds__modecheck_unify__Var_70 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_70, 0) = ((MR_Box) (check_hlds__modecheck_unify__Y_20));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
            *check_hlds__modecheck_unify__Unify_26 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (check_hlds__modecheck_unify__Var_70));
...
{
  {
    ...
    parse_tree__prog_data__determinism_components_3_p_0(check_hlds__modecheck_unify__Detism_17, &check_hlds__modecheck_unify__CanFail_27, &check_hlds__modecheck_unify__Var_28);
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      check_hlds__modecheck_unify__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 1)));
      check_hlds__modecheck_unify__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__Unification0_19, (MR_Integer) 2)));
    ...
    else
    {
      ...
      MR_Word check_hlds__modecheck_unify__Var_69;
      MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_70_70;
      MR_Word check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_71_71;
      ...
      mercury__list__duplicate_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, check_hlds__modecheck_unify__NumTypeInfoVars_35, ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[0]))), &check_hlds__modecheck_unify__ExpectedInsts_36);
      {
        check_hlds__modecheck_unify__Var_69 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_69, 0) = ((MR_Box) (check_hlds__modecheck_unify__UnifyContext_18));
      }
      check_hlds__mode_info__mode_info_set_call_context_3_p_0(check_hlds__modecheck_unify__Var_69, check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_0_61, &check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_70_70);
    ...
    if (check_hlds__modecheck_unify__succeeded)
    {
      check_hlds__modecheck_unify__Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Errors_40, (MR_Integer) 0)));
      check_hlds__modecheck_unify__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_unify__Errors_40, (MR_Integer) 1)));
      *check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_62 = check_hlds__modecheck_unify__STATE_VARIABLE_ModeInfo_72_72;
    }
    else
    {
      MR_Word check_hlds__modecheck_unify__Var_43;
      MR_Word check_hlds__modecheck_unify__Var_44;

      check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Type_14)) == (MR_mktag((MR_Integer) 0)));
      if (check_hlds__modecheck_unify__succeeded)
      {
        check_hlds__modecheck_unify__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Type_14, (MR_Integer) 0)));
        check_hlds__modecheck_unify__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Type_14, (MR_Integer) 1)));
      ...
      {
        MR_Word check_hlds__modecheck_unify__Var_47;
        MR_Word check_hlds__modecheck_unify__Var_48;

        check_hlds__modecheck_unify__succeeded = ((MR_tag((MR_Word) check_hlds__modecheck_unify__Type_14)) == (MR_mktag((MR_Integer) 0)));
        if (check_hlds__modecheck_unify__succeeded)
        {
          check_hlds__modecheck_unify__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Type_14, (MR_Integer) 0)));
          check_hlds__modecheck_unify__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Type_14, (MR_Integer) 1)));
        ...
        else
        {
          ...
          MR_Word check_hlds__modecheck_unify__Var_49;
          MR_Word check_hlds__modecheck_unify__Var_52;

          check_hlds__modecheck_unify__succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(check_hlds__modecheck_unify__Type_14, &check_hlds__modecheck_unify__Var_49, &check_hlds__modecheck_unify__PredOrFunc_50, &check_hlds__modecheck_unify__Var_52);
          if (check_hlds__modecheck_unify__succeeded)
          {
            ...
            {
              MR_Word check_hlds__modecheck_unify__Var_75;
              ...
              {
                check_hlds__modecheck_unify__Var_75 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__modecheck_unify__Var_75, 0) = ((MR_Box) (check_hlds__modecheck_unify__Y_13));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), check_hlds__modecheck_unify__ModeError_81, 2) = ((MR_Box) (check_hlds__modecheck_unify__Var_75));
          ...
          else
          {
            ...
            if (check_hlds__modecheck_unify__succeeded)
            {
              ...
              check_hlds__proc_requests__request_unify_6_p_0(check_hlds__modecheck_unify__UnifyProcId_59, check_hlds__modecheck_unify__InstVarSet_58, check_hlds__modecheck_unify__Detism_17, check_hlds__modecheck_unify__Context_57, check_hlds__modecheck_unify__ModuleInfo0_39, &check_hlds__modecheck_unify__ModuleInfo_60);
