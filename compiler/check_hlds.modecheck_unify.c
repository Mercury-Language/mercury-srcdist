  ...
  MR_Word LambdaHeadVar__1_70)
{
  ...
  hlds__vartypes__lookup_var_type_3_p_0(NonLocalTypes_40, LambdaHeadVar__1_70, &NonLocalType_43);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes0_28, X0_10, &VarType_30);
    hlds__vartypes__add_var_type_4_p_0(*X_11, VarType_30, VarTypes0_28, &VarTypes_31);
