  ...
  MR_Word * Result_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_HeadVar__6_6 = ProcIds_31;
      next_value_of_STATE_VARIABLE_RevMatchedProcIds_0_7 = STATE_VARIABLE_RevMatchedProcIds_42_42;
      next_value_of_STATE_VARIABLE_NonGroundNonLocals_0_8 = STATE_VARIABLE_NonGroundNonLocals_41_41;
