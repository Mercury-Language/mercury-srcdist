...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_94_94, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), ((MR_Box) (Var_70)));
      if (succeeded)
      {
...
{
  {
    ...
    TypeInfo_108_108 = (MR_Word) &check_hlds__modecheck_unify_scalar_common_1[0];
    mercury__assoc_list__from_corresponding_lists_3_p_0(TypeInfo_108_108, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, Vars_21, VarInitialInsts_29, &VarInstAL_30);
    ...
    TypeCtorInfo_110_110 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_110_110, LiveVarsList_35, &LiveVars_36);
    ...
    parse_tree__set_of_var__delete_list_3_p_0(TypeCtorInfo_110_110, Vars_21, NonLocals0_39, &NonLocals1_40);
      ...
      case (MR_Integer) 1:
        {
          ...
          NonLocals_41 = parse_tree__set_of_var__filter_2_f_0(TypeCtorInfo_110_110, Var_72, NonLocals1_40);
        }
        break;
      case (MR_Integer) 0:
    ...
    parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_110_110, NonLocals_41, &NonLocalsList_46);
    ...
    else
    {
      ...
      mercury__list__filter_3_p_0(TypeInfo_108_108, Var_95, NonLocalsList_46, &NonGroundNonLocals_62);
      ...
      else
      {
        ...
        WaitingVars_66 = parse_tree__set_of_var__make_singleton_1_f_0(TypeCtorInfo_110_110, BadVar_63);
        {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_93, (MR_Integer) 2)));
              Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_93, (MR_Integer) 3)));
              Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_93, (MR_Integer) 4)));
              Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_93, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          Var_26 = (MR_Word) MR_body(((MR_Word) Var_31), (MR_Integer) 1);
      }
      if (succeeded)
      {
        MR_Word ArgInst_27;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 0)));
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = (Var_55 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
          }
          if (succeeded)
          {
            {
    ...
    if (succeeded)
    {
      ...
      *Unify_26 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[1]);
      ...
      TypeCtorInfo_14_81 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
      succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_14_81, NonLocals_79, AssignTarget_34);
      if (succeeded)
        succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_14_81, NonLocals_79, AssignSource_35);
      if (succeeded)
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word TypeCtorInfo_14_90;

        *Unify_26 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_unify_scalar_common_3[1]);
        NonLocals_88 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo_23);
        TypeCtorInfo_14_90 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
        succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_14_90, NonLocals_88, TestVar1_36);
        if (succeeded)
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_14_90, NonLocals_88, TestVar2_37);
        if (succeeded)
          *STATE_VARIABLE_ModeInfo_52 = STATE_VARIABLE_ModeInfo_58_58;
        else
          check_hlds__mode_info__mode_info_need_to_requantify_2_p_0(STATE_VARIABLE_ModeInfo_58_58, STATE_VARIABLE_ModeInfo_52);
