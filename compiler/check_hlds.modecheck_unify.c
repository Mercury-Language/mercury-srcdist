  ...
  MR_Word * STATE_VARIABLE_ModeInfo_68)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 0, (MR_String) "lambda goal", GoalInfo0_35, STATE_VARIABLE_ModeInfo_77_77, &STATE_VARIABLE_ModeInfo_80_80);
    ...
    check_hlds__mode_debug__mode_checkpoint_5_p_0((MR_Integer) 1, (MR_String) "lambda goal", GoalInfo0_35, STATE_VARIABLE_ModeInfo_83_83, &STATE_VARIABLE_ModeInfo_86_86);
