  ...
  MR_Word * STATE_VARIABLE_ModeInfo_59)
{
  ...
  else
  {
    ...
    check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0((MR_Word) ((MR_Unsigned) 0U), UnifyTypeInfoVars_30, ExpectedInsts_34, (MR_Integer) 0, &_InstVarSub_36, STATE_VARIABLE_ModeInfo_67_67, &STATE_VARIABLE_ModeInfo_69_69);
