...
static /* final */ const MR_Box check_hlds__typecheck_util_scalar_common_2[9][1];
    ...
    switch (MR_tag((MR_Word) Type_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_5, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubType_26 = ((MR_Word) ((MR_hl_field(3, Type_5, 1))));
              MR_Word next_value_of_Type_5 = SubType_26;
