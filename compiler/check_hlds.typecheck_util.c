...
static /* final */ const MR_Box check_hlds__typecheck_util_scalar_common_2[10][1];
  ...
  MR_Word * MaybeDuType_6)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Type_5)) {
      ...
      case (MR_Integer) 0:
        *MaybeDuType_6 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_util_scalar_common_2[4]));
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_5, 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *MaybeDuType_6 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_util_scalar_common_2[3]));
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubType_24 = ((MR_Word) ((MR_hl_field(3, Type_5, 1))));
              MR_Word next_value_of_Type_5 = SubType_24;
  ...
  MR_Word * MaybeDuType_8)
{
  ...
  if (succeeded)
  {
    ...
    switch (MR_tag((MR_Word) TypeBody_10)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, TypeBody_10, 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *MaybeDuType_8 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_util_scalar_common_2[8]));
            break;
          case (MR_Integer) 1:
    ...
    *MaybeDuType_8 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_util_scalar_common_2[9]));
}
