...
{
  {
    ...
    {
      MR_Word ImportLocn_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSection_3, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 3);
      MR_Word ImportedOrUsed_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSection_3, (MR_Integer) 1))) >> (MR_Integer) 4)) & (MR_Integer) 3);
      MR_Word Var_12;
      MR_Word _ModuleName_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntSection_3, (MR_Integer) 0))));
      MR_Word _IntFileKind_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSection_3, (MR_Integer) 1))) & (MR_Integer) 3);
