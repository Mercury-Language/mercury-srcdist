      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = ((((MR_tag((MR_Word) ByteConsId_16)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ByteConsId_16, (MR_Integer) 0))) == (MR_Integer) 3)));
          if (succeeded)
          {
            {
              MR_Word Var_117;
...
bytecode_backend__bytecode_gen__map_test_3_p_0(
  ...
  MR_Word * Code_6)
{
  if (((((MR_tag((MR_Word) TestExpr_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TestExpr_5, (MR_Integer) 0))) == (MR_Integer) 10))))
  {
