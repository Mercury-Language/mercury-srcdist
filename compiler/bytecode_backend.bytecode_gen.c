...
MR_def_static(bytecode_backend__bytecode_gen__map_arg_3_0)
	...
	MR_tfield(2, MR_r1, 0) = MR_tfield(2, MR_tempr2, 0);
	MR_proceed();
	}
...
MR_def_static(bytecode_backend__bytecode_gen__map_test_3_0)
	...
	MR_sv(1) = MR_tempr3;
	MR_tfield(2, MR_tempr3, 0) = MR_tfield(2, MR_tempr1, 0);
	MR_r3 = MR_tempr3;
	MR_sv(1) = MR_r1;
...
MR_def_label(bytecode_backend__bytecode_gen__map_test_3_0,3)
	...
	MR_tfield(3, MR_tempr3, 1) = MR_tfield(3, MR_tempr4, 1);
...
MR_def_static(bytecode_backend__bytecode_gen__map_assign_4_0)
	...
	if (MR_INT_NE(MR_tfield(3, MR_tempr2, 0),0)) {
...
MR_def_label(bytecode_backend__bytecode_gen__map_cons_id_3_0,3)
	...
	MR_tfield(3, MR_tempr1, 1) = MR_tfield(3, MR_tempr2, 1);
	MR_tfield(3, MR_tempr1, 2) = MR_tfield(3, MR_tempr2, 2);
	MR_tfield(3, MR_tempr1, 3) = MR_tfield(3, MR_tempr2, 4);
	MR_proceed();
	}
