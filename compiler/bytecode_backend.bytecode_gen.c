    ...
    case (MR_Integer) 2:
      {
        ...
        bytecode_backend__bytecode_gen__get_next_label_3_p_0(&EndLabel_36, ByteInfo3_34, &ByteInfo_28);
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_54, 1) = ((MR_Box) (EndLabel_36));
          }
          {
            Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (Var_54));
            MR_hl_field(MR_mktag(1), Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &bytecode_backend__bytecode_gen_scalar_common_1[1])));
          }
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) ((MR_Unsigned) 24U));
          MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_60));
        }
        EndofCode_45 = mercury__cord__from_list_1_f_0((MR_Word) (&bytecode_backend__bytecode__bytecode_backend__bytecode__type_ctor_info_byte_code_0), Var_58);
      }
      break;
  }
