  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Integer ProcId_46 = ((MR_Integer) ((MR_hl_field(1, ProcIds_16, (MR_Integer) 0))));
      MR_Word ProcIds_47 = ((MR_Word) ((MR_hl_field(1, ProcIds_16, (MR_Integer) 1))));
      MR_Word ProcCode_51;
...

      {
        ...
        MR_hl_field(0, Var_56, 0) = ((MR_Box) (PredId_11));
        MR_hl_field(0, Var_56, 1) = ((MR_Box) (ProcId_46));
      }
      hlds__passes_aux__maybe_write_proc_progress_message_5_p_0(HeadVar__1_1, (MR_String) "Generating bytecode for", Var_56);
      ...
      {
        Var_31 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_31, 0) = ((MR_Box) (PredName_21));
        MR_hl_field(1, Var_31, 1) = ((MR_Box) (Arity_23));
        MR_hl_field(1, Var_31, 2) = ((MR_Box) (IsFunc_24));
        MR_hl_field(1, Var_31, 3) = ((MR_Box) (ProcsCount_22));
      }
  ...
  switch (MR_tag((MR_Word) ConsId_5)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, ConsId_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 3:
          {
            MR_Integer Arity_63 = ((MR_Integer) ((MR_hl_field(3, ConsId_5, (MR_Integer) 1))));
            MR_Word ConsTag_66;
            ...
            bytecode_backend__bytecode_gen__map_cons_tag_2_p_0(ConsTag_66, &ByteConsTag_67);
            {
              ...
              *ByteConsId_6 = base;
              ...
              MR_hl_field(1, base, 2) = ((MR_Box) (Arity_63));
              MR_hl_field(1, base, 3) = ((MR_Box) (ByteConsTag_67));
            }
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_19, &ProcInt_23);
            {
              ...
              *ByteConsId_6 = base;
              ...
              MR_hl_field(3, base, 1) = ((MR_Box) (ModuleName_69));
              MR_hl_field(3, base, 2) = ((MR_Box) (PredName_20));
              MR_hl_field(3, base, 3) = ((MR_Box) (Arity_68));
        ...
        case (MR_Integer) 10:
          {
            ...
            MR_Word ModuleName_70 = ((MR_Word) ((MR_hl_field(3, ConsId_5, (MR_Integer) 1))));
  ...
  MR_Word * Code_12)
{
  ...
  {
    Var_31 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_31, 0) = ((MR_Box) ((MR_Unsigned) 23U));
    MR_hl_field(3, Var_31, 1) = ((MR_Box) (ModuleName_24));
    MR_hl_field(3, Var_31, 2) = ((MR_Box) (PredName_25));
    MR_hl_field(3, Var_31, 3) = ((MR_Box) (Arity_26));
    MR_hl_field(3, Var_31, 4) = ((MR_Box) (IsFunc_19));
    MR_hl_field(3, Var_31, 5) = ((MR_Box) (ProcInt_27));
  }
