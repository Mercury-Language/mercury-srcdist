  ...
  MR_Word * ByteConsTag_4)
{
  switch (MR_tag((MR_Word) ConsTag_3)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntTagType_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ConsTag_3, (MR_Integer) 0))));

        switch (MR_tag((MR_Word) IntTagType_18)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Integer IntVal_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntTagType_18, (MR_Integer) 0))));

              {
                ...
                *ByteConsTag_4 = base;
                MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (IntVal_19));
              }
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_3, (MR_Integer) 0)))) {
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Integer Var_98;
            MR_Word Ptag_103 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_3, (MR_Integer) 1))));

            Sectag_12 = mercury__uint__cast_to_int_1_f_0(SectagUint_9);
            Var_98 = bytecode_backend__bytecode_gen__ptag_to_int_1_f_0(Ptag_103);
            {
              MR_Word base;
        ...
        case (MR_Integer) 11:
          {
            ...
            Var_101 = bytecode_backend__bytecode_gen__ptag_to_int_1_f_0(Ptag_5);
            {
              MR_Word base;
        ...
        case (MR_Integer) 12:
          {
            MR_Word RemoteSecTag_15 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_3, (MR_Integer) 2))));
            MR_Integer Var_95;
            MR_Word Ptag_104 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_3, (MR_Integer) 1))));
            MR_Unsigned SectagUint_105 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RemoteSecTag_15, (MR_Integer) 0))));
            MR_Integer Sectag_106;

            Sectag_106 = mercury__uint__cast_to_int_1_f_0(SectagUint_105);
            Var_95 = bytecode_backend__bytecode_gen__ptag_to_int_1_f_0(Ptag_104);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *ByteConsTag_4 = base;
              MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Var_95));
              MR_hl_field(MR_mktag(2), base, 1) = ((MR_Box) (Sectag_106));
            }
          }
          break;
        case (MR_Integer) 13:
          {
            {
              mercury__require__sorry_2_p_0((MR_String) "predicate \140bytecode_backend.bytecode_gen.map_cons_tag\'/2", (MR_String) "bytecode with shared_local_tag_with_args");
              return;
            }
          }
          break;
