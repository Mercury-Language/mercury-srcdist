  ...
  MR_Word * Code_8)
{
  ...
  Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ByteInfo0_22, (MR_Integer) 0))));
  Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ByteInfo0_22, (MR_Integer) 1))));
  Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ByteInfo0_22, (MR_Integer) 2))));
  Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ByteInfo0_22, (MR_Integer) 4))));
  {
    ByteInfo1_24 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ByteInfo1_24, 0) = ((MR_Box) (Var_92));
    MR_hl_field(MR_mktag(0), ByteInfo1_24, 1) = ((MR_Box) (Var_93));
    MR_hl_field(MR_mktag(0), ByteInfo1_24, 2) = ((MR_Box) (Var_94));
    MR_hl_field(MR_mktag(0), ByteInfo1_24, 3) = ((MR_Box) (LabelCounter_86));
    MR_hl_field(MR_mktag(0), ByteInfo1_24, 4) = ((MR_Box) (Var_96));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        bytecode_backend__bytecode_gen__get_next_temp_3_p_0(&_FrameTemp_32, ByteInfo1_24, &ByteInfo2_97);
        bytecode_backend__bytecode_gen__gen_goal_4_p_0(Goal_11, ByteInfo2_97, &ByteInfo3_98, &GoalCode_35);
        bytecode_backend__bytecode_gen__get_next_label_3_p_0(&EndLabel_36, ByteInfo3_98, &ByteInfo_28);
        {
  ...
  MR_Word * Code_5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ByteInfo_31_31, (MR_Integer) 0))));
      Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ByteInfo_31_31, (MR_Integer) 1))));
      Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ByteInfo_31_31, (MR_Integer) 2))));
      Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ByteInfo_31_31, (MR_Integer) 4))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
