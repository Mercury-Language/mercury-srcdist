  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Integer ProcId_50 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcIds_16, (MR_Integer) 0))));
      MR_Word ProcIds_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcIds_16, (MR_Integer) 1))));
      MR_Word ProcCode_56;
      MR_Word ProcsCode_57;

      hlds__passes_aux__write_proc_progress_message_6_p_0(HeadVar__1_1, (MR_String) "Generating bytecode for", PredId_11, ProcId_50);
      bytecode_backend__bytecode_gen__gen_proc_4_p_0(ProcId_50, PredInfo_15, HeadVar__1_1, &ProcCode_56);
      bytecode_backend__bytecode_gen__gen_pred_7_p_0(PredId_11, ProcIds_51, PredInfo_15, HeadVar__1_1, &ProcsCode_57);
      ProcsCode_20 = mercury__cord__f_43_43_2_f_0((MR_Word) (&bytecode_backend__bytecode__bytecode_backend__bytecode__type_ctor_info_byte_code_0), ProcCode_56, ProcsCode_57);
      ...
      PredOrFunc_42 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_15);
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(Var_39, Arg_20, &Type_26);
