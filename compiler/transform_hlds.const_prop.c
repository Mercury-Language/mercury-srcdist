                              ...
                              case (MR_Integer) 0:
                                {
                                  ...
                                  ;
                                  {
                                    ...
                                    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_8, (MR_Integer) 264, (MR_Integer) 0);
                                    if (succeeded)
                                    {
