                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      succeeded = (YVal_366 == (MR_Unsigned) 0U);
                                      succeeded = !(succeeded);
                                      if (succeeded)
                                      {
                                        *OutputArg_15 = Z_14;
                                        Var_197 = (MR_Integer) 239;
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      succeeded = (YVal_357 == (MR_Unsigned) 0U);
                                      succeeded = !(succeeded);
                                      if (succeeded)
                                      {
                                        *OutputArg_15 = Z_14;
                                        Var_239 = (MR_Integer) 239;
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      succeeded = (YVal_360 == (MR_Unsigned) 0U);
                                      succeeded = !(succeeded);
                                      if (succeeded)
                                      {
                                        *OutputArg_15 = Z_14;
                                        Var_225 = (MR_Integer) 239;
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      succeeded = (YVal_363 == (MR_Unsigned) 0U);
                                      succeeded = !(succeeded);
                                      if (succeeded)
                                      {
                                        *OutputArg_15 = Z_14;
                                        Var_211 = (MR_Integer) 239;
