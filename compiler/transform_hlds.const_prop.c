  ...
  MR_Word LambdaHeadVar__1_27)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_12, LambdaHeadVar__1_27, &Type_22);
  {
  ...
  MR_Word * STATE_VARIABLE_GoalInfo_22)
{
  ...
  if (succeeded)
  {
    ...
    Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OutputArg_16, (MR_Integer) 0))));
    hlds__make_goal__make_const_construction_4_p_0(Var_58, Var_59, Cons_17, &Goal_56);
    *GoalExpr_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_56, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) Var_40)) == (MR_Integer) 1))
          {
            ...
            MR_Word Var_68;
            MR_Word Var_71;
            MR_Word STATE_VARIABLE_GoalInfo_22_72;
            MR_Word Goal_76;
            MR_Word Var_78;
            MR_Word Var_79;

            Var_78 = mercury__term__context_init_0_f_0();
            Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_41, (MR_Integer) 0))));
            hlds__make_goal__make_const_construction_4_p_0(Var_78, Var_79, Cons_31, &Goal_76);
            *GoalExpr_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_76, (MR_Integer) 0))));
            Delta0_62 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(STATE_VARIABLE_GoalInfo_0_21);
            {
              Var_68 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_68, 0) = ((MR_Box) (Cons_31));
              MR_hl_field(MR_mktag(0), Var_68, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
            ...
            {
              Inst_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Inst_63, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(3), Inst_63, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(3), Inst_63, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Inst_63, 3) = ((MR_Box) (Var_67));
            }
            Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_41, (MR_Integer) 0))));
            hlds__instmap__instmap_delta_set_var_4_p_0(Var_71, Inst_63, Delta0_62, &Delta_64);
            hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(Delta_64, STATE_VARIABLE_GoalInfo_0_21, &STATE_VARIABLE_GoalInfo_22_72);
            hlds__hlds_goal__goal_info_set_determinism_3_p_0((MR_Integer) 0, STATE_VARIABLE_GoalInfo_22_72, STATE_VARIABLE_GoalInfo_22);
          }
          else
          {
            ...
            MR_Word Var_84;
            MR_Word Var_85;
            MR_Word STATE_VARIABLE_GoalInfo_16_86;
            MR_Word OutVar_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_41, (MR_Integer) 0))));
            MR_Word InVar_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InputArg_20, (MR_Integer) 0))));
            MR_Word Inst_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InputArg_20, (MR_Integer) 2))));
            MR_Word UnifyMode_95;
            MR_Word Var_102;
            MR_Word Var_103;

            {
              UnifyMode_95 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), UnifyMode_95, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), UnifyMode_95, 1) = ((MR_Box) (Inst_94));
              MR_hl_field(MR_mktag(0), UnifyMode_95, 2) = ((MR_Box) (Inst_94));
              MR_hl_field(MR_mktag(0), UnifyMode_95, 3) = ((MR_Box) (Inst_94));
            }
            {
              Var_102 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (InVar_93));
            }
            {
              Var_103 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Var_103, 0) = ((MR_Box) (OutVar_92));
              MR_hl_field(MR_mktag(2), Var_103, 1) = ((MR_Box) (InVar_93));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              *GoalExpr_14 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (OutVar_92));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Var_102));
              MR_hl_field(MR_mktag(1), base, 2) = ((MR_Box) (UnifyMode_95));
              MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Var_103));
              MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (&transform_hlds__const_prop_scalar_common_1[2]));
            }
            Delta0_82 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(STATE_VARIABLE_GoalInfo_0_21);
            Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_41, (MR_Integer) 0))));
            Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InputArg_20, (MR_Integer) 2))));
            hlds__instmap__instmap_delta_set_var_4_p_0(Var_84, Var_85, Delta0_82, &Delta_83);
            hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(Delta_83, STATE_VARIABLE_GoalInfo_0_21, &STATE_VARIABLE_GoalInfo_16_86);
            hlds__hlds_goal__goal_info_set_determinism_3_p_0((MR_Integer) 0, STATE_VARIABLE_GoalInfo_16_86, STATE_VARIABLE_GoalInfo_22);
          }
        }
        succeeded = MR_TRUE;
      }
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo__36_54 = (MR_Word) (&transform_hlds__const_prop_scalar_common_1[0]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__36_54, ((MR_Box) (Var_33)), ((MR_Box) (Var_52)));
                    if (succeeded)
                    {
                      MR_Word Var_23;
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    TypeInfo__38_56 = (MR_Word) (&transform_hlds__const_prop_scalar_common_1[1]);
                                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__38_56, ((MR_Box) (XArgVars_28)), ((MR_Box) (YArgVars_32)));
                                  }
                                  if (succeeded)
                                  {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo__38_38 = (MR_Word) (&transform_hlds__const_prop_scalar_common_1[1]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__38_38, ((MR_Box) (XArgVars_10)), ((MR_Box) (YArgVars_14)));
                }
                if (succeeded)
                {
                  *Result_6 = (MR_Integer) 1;
