                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          ;
                          {
                            ...
                            *OutputArg_13 = Y_12;
                            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_8, (MR_Integer) 241, (MR_Integer) 0);
                            if (succeeded)
                            {
