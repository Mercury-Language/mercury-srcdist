...
{
  {
    ...
    conv0_LambdaHeadVar__2_28 = transform_hlds__const_prop__IntroducedFrom__func__evaluate_call__79__1_3_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Goal_66;
      MR_Word Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_16, (MR_Integer) 0)));
      MR_Word Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_16, (MR_Integer) 1)));
      MR_Word Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_16, (MR_Integer) 2)));
      MR_Word Var_67;
      MR_Word Var_61;
      MR_Word Var_62;

      hlds__make_goal__make_const_construction_3_p_0(Var_68, Cons_17, &Goal_66);
...
{
  {
    ...
    MR_Word Goal_30;
    MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_6, (MR_Integer) 0)));
    MR_Word Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_6, (MR_Integer) 1)));
    MR_Word Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), OutputArg_6, (MR_Integer) 2)));
    MR_Word Var_31;
    MR_Word Var_25;
    MR_Word Var_26;

    hlds__make_goal__make_const_construction_3_p_0(Var_32, Cons_7, &Goal_30);
    ...
    if ((strcmp(HeadVar__1_1, (MR_String) "builtin") == 0))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_String next_value_of_HeadVar__1_1 = Var_8;
            MR_String next_value_of_HeadVar__2_2 = Var_9;
            MR_Integer next_value_of_HeadVar__3_3 = Var_10;
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      succeeded = ((((MR_tag((MR_Word) Var_419)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_419, (MR_Integer) 0)))) == (MR_Integer) 13)));
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          succeeded = ((((MR_tag((MR_Word) Var_425)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_425, (MR_Integer) 0)))) == (MR_Integer) 13)));
                                          if (succeeded)
                                          {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Var_26)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_26, (MR_Integer) 0)))) == (MR_Integer) 15)));
            if (succeeded)
            {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = ((((MR_tag((MR_Word) Var_32)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_32, (MR_Integer) 0)))) == (MR_Integer) 15)));
                      if (succeeded)
                      {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    succeeded = ((((MR_tag((MR_Word) Var_144)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_144, (MR_Integer) 0)))) == (MR_Integer) 13)));
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((((MR_tag((MR_Word) Var_146)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_146, (MR_Integer) 0)))) == (MR_Integer) 13)));
                        if (succeeded)
                        {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Var_22)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_22, (MR_Integer) 0)))) == (MR_Integer) 15)));
            if (succeeded)
            {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) Var_46)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_46, (MR_Integer) 0)))) == (MR_Integer) 13)));
              if (succeeded)
              {
                      ...
                      case (MR_Integer) 1:
                        {
                          /* case "-" */
                          {
                            ...
                            *OutputArg_13 = Y_12;
                            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_8, (MR_Integer) 234, (MR_Integer) 0);
                            if (succeeded)
                            {
