                    ...
                    case (MR_Integer) 2:
                      {
                        // case "\"
                        ;
                        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_9, (MR_Integer) 274, (MR_Integer) 0);
                        if (succeeded)
