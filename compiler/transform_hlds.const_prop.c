...
static /* final */ const struct transform_hlds__const_prop__vector_common_type_4_0_s transform_hlds__const_prop_vector_common_4[288];
...
static /* final */ const struct transform_hlds__const_prop__vector_common_type_4_0_s transform_hlds__const_prop_vector_common_4[288] = {
  ...
  /* row   1 */   { NULL },
  /* row   2 */   { (MR_String) "//" },
  /* row   3 */   { (MR_String) "times" },
  /* row   4 */   { NULL },
  /* row   5 */   { (MR_String) "mod" },
  /* row   6 */   { NULL },
  /* row   7 */   { NULL },
  /* row   8 */   { NULL },
  /* row   9 */   { (MR_String) "minus" },
  /* row  10 */   { (MR_String) "+" },
  /* row  11 */   { (MR_String) "*" },
  /* row  12 */   { (MR_String) "-" },
  /* row  13 */   { NULL },
  ...
  /* row  25 */   { (MR_String) "rem" },
  /* row  26 */   { NULL },
  /* row  27 */   { NULL },
  /* row  28 */   { NULL },
  /* row  29 */   { NULL },
  /* row  30 */   { (MR_String) "plus" },
  /* row  31 */   { NULL },
  /* row  32 */   { NULL },
  /* row  33 */   { (MR_String) "unchecked_right_shift" },
  /* row  34 */   { NULL },
  /* row  35 */   { (MR_String) "unchecked_left_ushift" },
  /* row  36 */   { NULL },
  /* row  37 */   { NULL },
  /* row  38 */   { NULL },
  /* row  39 */   { NULL },
  ...
  /* row  45 */   { NULL },
  /* row  46 */   { (MR_String) "<<u" },
  /* row  47 */   { (MR_String) "unchecked_right_ushift" },
  /* row  48 */   { NULL },
  /* row  49 */   { NULL },
  /* row  50 */   { (MR_String) ">>u" },
  /* row  51 */   { NULL },
  /* row  52 */   { NULL },
  /* row  53 */   { (MR_String) "unchecked_left_shift" },
  /* row  54 */   { NULL },
  /* row  55 */   { NULL },
  /* row  56 */   { NULL },
  /* row  57 */   { NULL },
  ...
  /* row  63 */   { NULL },
  /* row  64 */   { NULL },
  /* row  65 */   { (MR_String) "unchecked_right_shift" },
  /* row  66 */   { NULL },
  /* row  67 */   { (MR_String) "unchecked_left_ushift" },
  /* row  68 */   { NULL },
  /* row  69 */   { NULL },
  /* row  70 */   { NULL },
  /* row  71 */   { NULL },
  ...
  /* row  77 */   { NULL },
  /* row  78 */   { (MR_String) "<<u" },
  /* row  79 */   { (MR_String) "unchecked_right_ushift" },
  /* row  80 */   { NULL },
  /* row  81 */   { NULL },
  /* row  82 */   { (MR_String) ">>u" },
  /* row  83 */   { NULL },
  /* row  84 */   { NULL },
  /* row  85 */   { (MR_String) "unchecked_left_shift" },
  /* row  86 */   { NULL },
  /* row  87 */   { NULL },
  /* row  88 */   { NULL },
  /* row  89 */   { NULL },
  ...
  /* row 159 */   { NULL },
  /* row 160 */   { NULL },
  /* row 161 */   { (MR_String) "string" },
  /* row 162 */   { NULL },
  /* row 163 */   { (MR_String) "uint32" },
  /* row 164 */   { NULL },
  /* row 165 */   { NULL },
  /* row 166 */   { NULL },
  /* row 167 */   { (MR_String) "int16" },
  /* row 168 */   { (MR_String) "int" },
  /* row 169 */   { NULL },
  /* row 170 */   { NULL },
  /* row 171 */   { NULL },
  /* row 172 */   { NULL },
  /* row 173 */   { (MR_String) "uint8" },
  /* row 174 */   { NULL },
  /* row 175 */   { NULL },
  /* row 176 */   { NULL },
  /* row 177 */   { NULL },
  /* row 178 */   { NULL },
  /* row 179 */   { NULL },
  /* row 180 */   { (MR_String) "uint" },
  /* row 181 */   { NULL },
  /* row 182 */   { NULL },
  /* row 183 */   { (MR_String) "int8" },
  /* row 184 */   { NULL },
  /* row 185 */   { NULL },
  /* row 186 */   { NULL },
  /* row 187 */   { NULL },
  /* row 188 */   { (MR_String) "uint64" },
  /* row 189 */   { NULL },
  /* row 190 */   { NULL },
  /* row 191 */   { NULL },
  /* row 192 */   { NULL },
  /* row 193 */   { (MR_String) "uint16" },
  /* row 194 */   { NULL },
  /* row 195 */   { (MR_String) "float" },
  /* row 196 */   { NULL },
  /* row 197 */   { (MR_String) "int32" },
  /* row 198 */   { NULL },
  /* row 199 */   { NULL },
  /* row 200 */   { NULL },
  /* row 201 */   { NULL },
  ...
  /* row 225 */   { NULL },
  /* row 226 */   { NULL },
  /* row 227 */   { (MR_String) "uint32" },
  /* row 228 */   { NULL },
  /* row 229 */   { NULL },
  /* row 230 */   { NULL },
  /* row 231 */   { (MR_String) "int16" },
  /* row 232 */   { (MR_String) "int" },
  /* row 233 */   { NULL },
  /* row 234 */   { NULL },
  /* row 235 */   { NULL },
  /* row 236 */   { NULL },
  /* row 237 */   { (MR_String) "uint8" },
  /* row 238 */   { (MR_String) "private_builtin" },
  /* row 239 */   { NULL },
  /* row 240 */   { NULL },
  /* row 241 */   { NULL },
  /* row 242 */   { NULL },
  /* row 243 */   { NULL },
  /* row 244 */   { (MR_String) "uint" },
  /* row 245 */   { NULL },
  /* row 246 */   { NULL },
  /* row 247 */   { (MR_String) "int8" },
  /* row 248 */   { NULL },
  /* row 249 */   { NULL },
  /* row 250 */   { NULL },
  /* row 251 */   { NULL },
  /* row 252 */   { (MR_String) "uint64" },
  /* row 253 */   { NULL },
  /* row 254 */   { NULL },
  /* row 255 */   { NULL },
  /* row 256 */   { NULL },
  /* row 257 */   { (MR_String) "uint16" },
  /* row 258 */   { NULL },
  /* row 259 */   { (MR_String) "float" },
  /* row 260 */   { NULL },
  /* row 261 */   { (MR_String) "int32" },
  /* row 262 */   { NULL },
  /* row 263 */   { NULL },
  /* row 264 */   { NULL },
  /* row 265 */   { NULL },
  ...
  MR_Word * Result_12)
{
  ...
  MR_String str_45 = ((&transform_hlds__const_prop_vector_common_4[224 + slot_44]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
                          ...
                          case (MR_Integer) 0:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_765)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_765, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_766 = ((MR_Word) ((MR_hl_field(3, Var_765, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_741)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_741, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_742 = ((MR_Word) ((MR_hl_field(3, Var_741, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_817)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_817, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_818 = ((MR_Word) ((MR_hl_field(3, Var_817, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_793)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_793, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_794 = ((MR_Word) ((MR_hl_field(3, Var_793, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_869)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_869, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_870 = ((MR_Word) ((MR_hl_field(3, Var_869, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_845)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_845, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_846 = ((MR_Word) ((MR_hl_field(3, Var_845, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_921)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_921, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_922 = ((MR_Word) ((MR_hl_field(3, Var_921, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_897)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_897, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_898 = ((MR_Word) ((MR_hl_field(3, Var_897, (MR_Integer) 3))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Var_223)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_223, (MR_Integer) 0)))) == (MR_Integer) 0)));
                  if (succeeded)
                  {
                    Var_224 = ((MR_Word) ((MR_hl_field(3, Var_223, (MR_Integer) 3))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_228)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_228, (MR_Integer) 0)))) == (MR_Integer) 0)));
                          if (succeeded)
                          {
                            Var_229 = ((MR_Word) ((MR_hl_field(3, Var_228, (MR_Integer) 3))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_57 = ((MR_Word) ((MR_hl_field(3, Var_56, (MR_Integer) 3))));
                    succeeded = (Var_57 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_61)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_61, (MR_Integer) 0)))) == (MR_Integer) 0)));
                          if (succeeded)
                          {
                            Var_62 = ((MR_Word) ((MR_hl_field(3, Var_61, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 0:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1543)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1543, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1544 = ((MR_Word) ((MR_hl_field(3, Var_1543, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1519)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1519, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1520 = ((MR_Word) ((MR_hl_field(3, Var_1519, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1595)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1595, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1596 = ((MR_Word) ((MR_hl_field(3, Var_1595, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1571)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1571, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1572 = ((MR_Word) ((MR_hl_field(3, Var_1571, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1647)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1647, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1648 = ((MR_Word) ((MR_hl_field(3, Var_1647, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1623)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1623, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1624 = ((MR_Word) ((MR_hl_field(3, Var_1623, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1699)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1699, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1700 = ((MR_Word) ((MR_hl_field(3, Var_1699, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1675)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1675, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1676 = ((MR_Word) ((MR_hl_field(3, Var_1675, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_78)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_78, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_79 = ((MR_Word) ((MR_hl_field(3, Var_78, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_83)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_83, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_84 = ((MR_Word) ((MR_hl_field(3, Var_83, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_88)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_88, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_89 = ((MR_Word) ((MR_hl_field(3, Var_88, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_93)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_93, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_94 = ((MR_Word) ((MR_hl_field(3, Var_93, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_98)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_98, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_99 = ((MR_Word) ((MR_hl_field(3, Var_98, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_103)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_103, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_104 = ((MR_Word) ((MR_hl_field(3, Var_103, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_108)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_108, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_109 = ((MR_Word) ((MR_hl_field(3, Var_108, (MR_Integer) 3))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Var_328)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_328, (MR_Integer) 0)))) == (MR_Integer) 0)));
                  if (succeeded)
                  {
                    Var_329 = ((MR_Word) ((MR_hl_field(3, Var_328, (MR_Integer) 3))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_333)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_333, (MR_Integer) 0)))) == (MR_Integer) 0)));
                          if (succeeded)
                          {
                            Var_334 = ((MR_Word) ((MR_hl_field(3, Var_333, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 0:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1154)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1154, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1155 = ((MR_Word) ((MR_hl_field(3, Var_1154, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1130)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1130, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1131 = ((MR_Word) ((MR_hl_field(3, Var_1130, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1206)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1206, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1207 = ((MR_Word) ((MR_hl_field(3, Var_1206, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1182)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1182, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1183 = ((MR_Word) ((MR_hl_field(3, Var_1182, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1258)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1258, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1259 = ((MR_Word) ((MR_hl_field(3, Var_1258, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1234)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1234, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1235 = ((MR_Word) ((MR_hl_field(3, Var_1234, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_1310)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1310, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_1311 = ((MR_Word) ((MR_hl_field(3, Var_1310, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_1286)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_1286, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_1287 = ((MR_Word) ((MR_hl_field(3, Var_1286, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_428)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_428, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_429 = ((MR_Word) ((MR_hl_field(3, Var_428, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_404)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_404, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_405 = ((MR_Word) ((MR_hl_field(3, Var_404, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 2:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_480)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_480, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_481 = ((MR_Word) ((MR_hl_field(3, Var_480, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_456)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_456, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_457 = ((MR_Word) ((MR_hl_field(3, Var_456, (MR_Integer) 3))));
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              ;
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_532)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_532, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                if (succeeded)
                                {
                                  Var_533 = ((MR_Word) ((MR_hl_field(3, Var_532, (MR_Integer) 3))));
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            succeeded = ((((MR_tag((MR_Word) Var_508)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_508, (MR_Integer) 0)))) == (MR_Integer) 0)));
                                            if (succeeded)
                                            {
                                              Var_509 = ((MR_Word) ((MR_hl_field(3, Var_508, (MR_Integer) 3))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = ((((MR_tag((MR_Word) Var_115)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_115, (MR_Integer) 0)))) == (MR_Integer) 0)));
                    if (succeeded)
                    {
                      Var_116 = ((MR_Word) ((MR_hl_field(3, Var_115, (MR_Integer) 3))));
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = ((((MR_tag((MR_Word) Var_121)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_121, (MR_Integer) 0)))) == (MR_Integer) 0)));
                              if (succeeded)
                              {
                                Var_122 = ((MR_Word) ((MR_hl_field(3, Var_121, (MR_Integer) 3))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            Var_264 = ((MR_Word) ((MR_hl_field(3, Var_263, (MR_Integer) 3))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_294 = ((MR_Word) ((MR_hl_field(3, Var_293, (MR_Integer) 3))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_298)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_298, (MR_Integer) 0)))) == (MR_Integer) 0)));
                          if (succeeded)
                          {
                            Var_299 = ((MR_Word) ((MR_hl_field(3, Var_298, (MR_Integer) 3))));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if ((Var_52 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MR_String str_1 = ((&transform_hlds__const_prop_vector_common_4[96 + slot_0]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          // lookup the string for this hash slot
          ;
          str_3 = ((&transform_hlds__const_prop_vector_common_4[160 + slot_2]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
          // did we find a match?
          ;
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Var_85)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_85, (MR_Integer) 0)))) == (MR_Integer) 0)));
  if (succeeded)
  {
    Var_88 = ((MR_Word) ((MR_hl_field(3, Var_85, (MR_Integer) 3))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if ((strcmp(ProcName_11, (MR_String) "-") == 0))
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Var_46)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_46, (MR_Integer) 0)))) == (MR_Integer) 0)));
            if (succeeded)
            {
              Var_47 = ((MR_Word) ((MR_hl_field(3, Var_46, (MR_Integer) 3))));
          ...
          if ((strcmp(ProcName_11, (MR_String) "xor") == 0))
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Var_58)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_58, (MR_Integer) 0)))) == (MR_Integer) 0)));
            if (succeeded)
            {
              Var_59 = ((MR_Word) ((MR_hl_field(3, Var_58, (MR_Integer) 3))));
              succeeded = (Var_59 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  if (succeeded)
  {
    Var_28 = ((MR_Word) ((MR_hl_field(3, Var_27, (MR_Integer) 3))));
    succeeded = (Var_28 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_33 = ((MR_Word) ((MR_hl_field(3, Var_32, (MR_Integer) 3))));
            succeeded = (Var_33 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
                ...
                {
                  {
                    ...
                    switch (MR_nth_code_unit(ProcName_11, 0)) {
                      ...
                      case (MR_Integer) 47:
                        ...
                        break;
                      case (MR_Integer) 60:
                        if (((MR_nth_code_unit(ProcName_11, 1)) == (MR_Integer) 60))
                        ...
                        break;
                      case (MR_Integer) 62:
                        if (((MR_nth_code_unit(ProcName_11, 1)) == (MR_Integer) 62))
                          switch (MR_nth_code_unit(ProcName_11, 2)) {
                            case (MR_Integer) 0:
                              case_num_6 = (MR_Integer) 2;
                              break;
                      ...
                      case (MR_Integer) 116:
                        ...
                        break;
                      case (MR_Integer) 117:
                        if (((((((((((((((((((MR_nth_code_unit(ProcName_11, 1)) == (MR_Integer) 110)) && (((MR_nth_code_unit(ProcName_11, 2)) == (MR_Integer) 99)))) && (((MR_nth_code_unit(ProcName_11, 3)) == (MR_Integer) 104)))) && (((MR_nth_code_unit(ProcName_11, 4)) == (MR_Integer) 101)))) && (((MR_nth_code_unit(ProcName_11, 5)) == (MR_Integer) 99)))) && (((MR_nth_code_unit(ProcName_11, 6)) == (MR_Integer) 107)))) && (((MR_nth_code_unit(ProcName_11, 7)) == (MR_Integer) 101)))) && (((MR_nth_code_unit(ProcName_11, 8)) == (MR_Integer) 100)))) && (((MR_nth_code_unit(ProcName_11, 9)) == (MR_Integer) 95))))
                          switch (MR_nth_code_unit(ProcName_11, 10)) {
                            case (MR_Integer) 108:
                              if (((((((((MR_nth_code_unit(ProcName_11, 11)) == (MR_Integer) 101)) && (((MR_nth_code_unit(ProcName_11, 12)) == (MR_Integer) 102)))) && (((MR_nth_code_unit(ProcName_11, 13)) == (MR_Integer) 116)))) && (((MR_nth_code_unit(ProcName_11, 14)) == (MR_Integer) 95))))
                            ...
                            case (MR_Integer) 114:
                              switch (MR_nth_code_unit(ProcName_11, 11)) {
                                case (MR_Integer) 101:
                                  ...
                                  break;
                                case (MR_Integer) 105:
                                  if (((((((((MR_nth_code_unit(ProcName_11, 12)) == (MR_Integer) 103)) && (((MR_nth_code_unit(ProcName_11, 13)) == (MR_Integer) 104)))) && (((MR_nth_code_unit(ProcName_11, 14)) == (MR_Integer) 116)))) && (((MR_nth_code_unit(ProcName_11, 15)) == (MR_Integer) 95))))
                    ...
                    switch (case_num_6) {
                      ...
                      case (MR_Integer) 0:
                        {
                          // case "*", "+", "-", "/", "//", "minus", "mod", "plus", "rem", "times", "unchecked_quotient", "unchecked_rem"
                          ;
                          {
                            MR_Word IntegerX_23;
                            MR_Word IntegerY_24;
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  // compute the hash value of the input string
                                  ;
                                  slot_0 = ((MR_hash_string4(ProcName_11)) & (MR_Integer) 31);
                                  // no collisions; no hash chain loop
                                  ;
                                  // lookup the string for this hash slot
                                  ;
                                  str_1 = ((&transform_hlds__const_prop_vector_common_4[0 + slot_0]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
                                  // did we find a match?
                                  ;
                                  if ((((str_1 != NULL)) && ((strcmp(str_1, ProcName_11) == 0))))
                                  {
                                    // we found a match; dispatch to the corresponding code
                                    ;
                                    switch (slot_0) {
                                      ...
                                      case (MR_Integer) 24:
                                        {
                                          // case "/", "//", "unchecked_quotient"
                                          ;
                                          succeeded = parse_tree__int_emu__emu_quotient_4_p_0(OpType_10, IntegerX_23, IntegerY_24, &OutputArgVal_16);
                                        }
                                        break;
                                      case (MR_Integer) 3:
                                      case (MR_Integer) 11:
                                      ...
                                      case (MR_Integer) 5:
                                        {
                                          // case "mod"
                                          ;
                                          succeeded = parse_tree__int_emu__emu_mod_4_p_0(OpType_10, IntegerX_23, IntegerY_24, &OutputArgVal_16);
                                        }
                                        break;
                                      case (MR_Integer) 9:
                                      case (MR_Integer) 12:
                                        {
                                          // case "-", "minus"
                                          ;
                                          succeeded = parse_tree__int_emu__emu_minus_4_p_0(OpType_10, IntegerX_23, IntegerY_24, &OutputArgVal_16);
                                        }
                                        break;
                                      case (MR_Integer) 10:
                                      case (MR_Integer) 30:
                                        {
                                          // case "+", "plus"
                                          ;
                                          succeeded = parse_tree__int_emu__emu_plus_4_p_0(OpType_10, IntegerX_23, IntegerY_24, &OutputArgVal_16);
                                        }
                                        break;
                                      case (MR_Integer) 20:
                                      case (MR_Integer) 25:
                                        {
                                          ...
                                          ;
                                          succeeded = parse_tree__int_emu__emu_rem_4_p_0(OpType_10, IntegerX_23, IntegerY_24, &OutputArgVal_16);
                                        }
                                        break;
                                    }
                                  }
                      ...
                      case (MR_Integer) 2:
                        {
                          // case "<<", "<<u", ">>", ">>u", "unchecked_left_shift", "unchecked_left_ushift", "unchecked_right_shift", "unchecked_right_ushift"
                          ;
                          {
                            MR_Integer IntY_25;
                            MR_Word Var_39;
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  ...
                                  // compute the hash value of the input string
                                  ;
                                  slot_2 = ((MR_hash_string6(ProcName_11)) & (MR_Integer) 31);
                                  // no collisions; no hash chain loop
                                  ;
                                  // lookup the string for this hash slot
                                  ;
                                  str_3 = ((&transform_hlds__const_prop_vector_common_4[32 + slot_2]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
                                  // did we find a match?
                                  ;
                                  if ((((str_3 != NULL)) && ((strcmp(str_3, ProcName_11) == 0))))
                                  {
                                    // we found a match; dispatch to the corresponding code
                                    ;
                                    switch (slot_2) {
                                      ...
                                      case (MR_Integer) 30:
                                        {
                                          // case "<<", ">>", "unchecked_left_shift", "unchecked_right_shift"
                                          ;
                                      ...
                                      case (MR_Integer) 18:
                                        {
                                          // case "<<u", ">>u", "unchecked_left_ushift", "unchecked_right_ushift"
                                          ;
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              UIntY_26 = ((MR_Unsigned) ((MR_hl_field(1, Var_48, (MR_Integer) 0))));
                                              IntY_25 = mercury__uint__cast_to_int_1_f_0(UIntY_26);
                                              succeeded = MR_TRUE;
                                            }
                                          }
                                        }
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    // compute the hash value of the input string
                                    ;
                                    slot_4 = ((MR_hash_string6(ProcName_11)) & (MR_Integer) 31);
                                    // no collisions; no hash chain loop
                                    ;
                                    // lookup the string for this hash slot
                                    ;
                                    str_5 = ((&transform_hlds__const_prop_vector_common_4[64 + slot_4]))->transform_hlds__const_prop__vector_common_type_4_0__vct_4_f_0;
                                    // did we find a match?
                                    ;
                                    if ((((str_5 != NULL)) && ((strcmp(str_5, ProcName_11) == 0))))
                                    {
                                      // we found a match; dispatch to the corresponding code
                                      ;
                                      switch (slot_4) {
                                        ...
                                        case (MR_Integer) 30:
                                          {
                                            // case ">>", ">>u", "unchecked_right_shift", "unchecked_right_ushift"
                                            ;
                                            succeeded = parse_tree__int_emu__emu_right_shift_4_p_0(OpType_10, IntegerX_43, IntY_25, &OutputArgVal_16);
                                          }
                                          break;
                                        case (MR_Integer) 3:
                                        case (MR_Integer) 14:
                                        ...
                                        case (MR_Integer) 26:
                                          {
                                            // case "<<", "<<u", "unchecked_left_shift", "unchecked_left_ushift"
                                            ;
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_25 = ((MR_Word) ((MR_hl_field(3, Var_24, (MR_Integer) 3))));
                    ...
                    case (MR_Integer) 2:
                      {
                        // case "\"
                        ;
                        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_9, (MR_Integer) 271, (MR_Integer) 0);
                        if (succeeded)
