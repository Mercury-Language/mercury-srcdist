...
MR_decl_label10(transform_hlds__const_prop__evaluate_det_call_7_0, 6,2286,528,8,9,25,41,59,77,2292)
MR_decl_label10(transform_hlds__const_prop__evaluate_det_call_7_0, 105,2295,2293,2289,164,2291,199,2290,2296,233)
MR_decl_label10(transform_hlds__const_prop__evaluate_det_call_7_0, 249,2288,2287,293,2294,326,328,338,331,347)
MR_decl_label10(transform_hlds__const_prop__evaluate_det_call_7_0, 375,385,378,393,421,4,445,457,455,469)
...
static const struct mercury_type_0 mercury_vector_common_0_0[64] =
{
{
...
MR_BEGIN_MODULE(transform_hlds__const_prop_module0)
	...
	MR_init_label10(transform_hlds__const_prop__evaluate_det_call_7_0,6,2286,528,8,9,25,41,59,77,2292)
	MR_init_label10(transform_hlds__const_prop__evaluate_det_call_7_0,105,2295,2293,2289,164,2291,199,2290,2296,233)
	MR_init_label10(transform_hlds__const_prop__evaluate_det_call_7_0,249,2288,2287,293,2294,326,328,338,331,347)
	MR_init_label10(transform_hlds__const_prop__evaluate_det_call_7_0,375,385,378,393,421,4,445,457,455,469)
...
MR_def_label(transform_hlds__const_prop__evaluate_det_call_7_0,6)
	...
	MR_r6 = ((MR_Word *) &mercury_vector_common_0_0)[((MR_Integer) MR_tempr1 + (MR_Integer) 1)];
...
MR_def_label(transform_hlds__const_prop__evaluate_det_call_7_0,41)
	...
	MR_tempr3 = MR_tfield(0, MR_tfield(1, MR_tempr10, 0), 2);
	if (MR_RTAGS_TESTR(MR_tempr3,3,0)) {
		MR_GOTO_LAB(transform_hlds__const_prop__evaluate_det_call_7_0_i2286);
	}
	MR_tempr4 = MR_tfield(3, MR_tempr3, 2);
...
MR_def_static(transform_hlds__const_prop__make_assignment_goal_5_0)
	...
	MR_tempr5 = MR_r2;
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(0, MR_tempr5, 2);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	...
	MR_tempr6 = MR_r1;
	MR_tfield(2, MR_tempr2, 0) = MR_tfield(0, MR_tempr6, 0);
	...
	MR_tfield(0, MR_tempr4, 4) = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_sv(1) = MR_tempr6;
	MR_sv(2) = MR_tempr5;
	MR_tempr7 = MR_r3;
	MR_sv(4) = MR_tempr7;
