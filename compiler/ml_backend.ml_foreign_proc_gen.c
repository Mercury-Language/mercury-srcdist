...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_foreign_proc_gen__Var_14, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Module_9));
      MR_hl_field(MR_mktag(0), ml_backend__ml_foreign_proc_gen__Var_14, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), ml_backend__ml_foreign_proc_gen__Var_14, 2) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Name_8));
    }
    {
      ...
      if ((ml_backend__ml_foreign_proc_gen__env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__succeeded)
        {
          ...
          MR_Word ml_backend__ml_foreign_proc_gen__Var_33;
          MR_Word ml_backend__ml_foreign_proc_gen__Var_34;
          ...
          {
            ml_backend__ml_foreign_proc_gen__Var_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_34, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_34, 1) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__AllocId_22));
          }
          {
            ml_backend__ml_foreign_proc_gen__Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_33, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Var_34));
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_33, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[6])));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *ml_backend__ml_foreign_proc_gen__HashDefine_9 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Var_33));
          }
...
{
  {
    ...
    *ml_backend__ml_foreign_proc_gen__Decls_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    ...
    {
      ml_backend__ml_foreign_proc_gen__Var_20 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_foreign_proc_gen__Var_20, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__SuccessLval_13));
      MR_hl_field(MR_mktag(2), ml_backend__ml_foreign_proc_gen__Var_20, 1) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__CondRval_14));
    }
    {
      ml_backend__ml_foreign_proc_gen__Var_19 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_19, 1) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Var_20));
    }
    {
      ml_backend__ml_foreign_proc_gen__Statement_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_foreign_proc_gen__Statement_15, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Var_19));
