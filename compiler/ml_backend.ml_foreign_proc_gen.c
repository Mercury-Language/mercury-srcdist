  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_16, Var_10, &VarEntry_17);
  ...
  MR_Word * STATE_VARIABLE_Info_44)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_20, Var_11, &VarEntry_21);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__var_table__lookup_var_entry_3_p_0(VarTable_50, Var_43, &VarEntry_51);
