  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_foreign_proc_gen__IntroducedFrom__pred__ml_gen_foreign_proc_for_csharp_or_java__204__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_50)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_29, (MR_Integer) 24);
  if (succeeded)
