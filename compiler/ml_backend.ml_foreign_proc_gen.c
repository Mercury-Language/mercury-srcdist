...
static /* final */ const MR_Box ml_backend__ml_foreign_proc_gen_scalar_common_2[21][1] = {
  ...
  /* row 19 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_foreign_proc_gen_scalar_common_1[18])))
  },
  /* row 20 */
  {
    ((MR_Box) ((MR_String) ";\n"))
              ...
              if (ml_backend__ml_foreign_proc_gen__succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_86, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 17));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_foreign_proc_gen__Var_53, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_foreign_proc_gen_scalar_common_1[18])));
          }
          {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_169, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[16])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_149, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[11])));
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_125, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[16])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_105, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[11])));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[16])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[17])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[11])));
...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[9])));
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ml_backend__ml_foreign_proc_gen__Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_71, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__Var_72));
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[10])));
          }
          {
            ml_backend__ml_foreign_proc_gen__AssignSucceeded_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__AssignSucceeded_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_2[7])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_foreign_proc_gen__Var_77, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[11])));
    ...
    {
      ml_backend__ml_foreign_proc_gen__EndingFragments_43 = mercury__list__f_43_43_2_f_0(ml_backend__ml_foreign_proc_gen__TypeCtorInfo_103_103, ml_backend__ml_foreign_proc_gen__AssignSucceeded_37, (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[12]));
    }
    {
