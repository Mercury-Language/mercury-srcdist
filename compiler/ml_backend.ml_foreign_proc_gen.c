...
ml_backend__ml_foreign_proc_gen__IntroducedFrom__pred__ml_gen_foreign_proc_for_csharp_or_java__206__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_foreign_proc_gen__IntroducedFrom__pred__ml_gen_foreign_proc_for_csharp_or_java__206__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
