  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[16])));
      }
      {
        MR_Word base;
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
            MLDS_Type_28 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_foreign_proc_gen_scalar_common_1[15]));
          else
