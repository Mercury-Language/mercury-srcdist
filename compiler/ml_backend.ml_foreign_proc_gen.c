  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  if (succeeded)
  {
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_35, Var_11, &VarEntry_36);
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  (env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7 = C_Codes_7;
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 236, &(env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__ProfileMemory_13);
  ...
  MR_String * ReleaseLock_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 258, &Parallel_13);
