  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_foreign_proc_gen__IntroducedFrom__pred__ml_gen_foreign_proc_for_csharp_or_java__205__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Op_16;
        MR_Word STATE_VARIABLE_Info_30_30;
        MR_Word ExprA_32 = ((MR_Word) ((MR_hl_field(2, Expr_5, (MR_Integer) 1))));
        MR_Word RvalA_33;
