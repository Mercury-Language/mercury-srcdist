...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_42, (MR_Integer) 265, &HighLevelData_43);
...
{
  {
    ...
    {
      NonMangledArgVarName_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), NonMangledArgVarName_22, 0) = ((MR_Box) (ArgName_12));
    }
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_pred_id_2_p_0(Info_3, &PredId_6);
    ml_backend__ml_gen_info__ml_gen_info_get_proc_id_2_p_0(Info_3, &ProcId_7);
    ml_backend__ml_code_util__ml_gen_proc_label_5_p_0(ModuleInfo_5, PredId_6, ProcId_7, &Module_8, &PlainFuncName_9);
    Var_15 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) PlainFuncName_9);
    {
      Var_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (Module_8));
      MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (Var_15));
    }
    Var_13 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) Var_14);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_12, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[4])));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        {
          ...
          if ((env_ptr)->ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__succeeded)
          {
            ...
            mercury__list__member_2_p_1(TypeCtorInfo_43_43, &(env_ptr)->ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__conv0_C_Code_14, (env_ptr)->ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7, ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_3, env_ptr);
          }
        }
...
{
  {
    ...
    (env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7 = C_Codes_7;
    {
      ...
      ml_backend__ml_gen_info__ml_gen_info_get_globals_2_p_0(STATE_VARIABLE_Info_0_24, &Globals_12);
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 205, &(env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__ProfileMemory_13);
      ...
      if ((env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__succeeded)
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_24, &ModuleInfo_16);
        ml_backend__ml_gen_info__ml_gen_info_get_pred_id_2_p_0(STATE_VARIABLE_Info_0_24, &PredId_17);
        ml_backend__ml_gen_info__ml_gen_info_get_proc_id_2_p_0(STATE_VARIABLE_Info_0_24, &ProcId_18);
        ml_backend__ml_gen_info__ml_gen_info_get_global_data_2_p_0(STATE_VARIABLE_Info_0_24, &GlobalData0_19);
        ml_backend__ml_code_util__ml_gen_proc_label_5_p_0(ModuleInfo_16, PredId_17, ProcId_18, &_Module_20, &ProcLabel_21);
        Var_28 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ProcLabel_21);
        ml_backend__ml_global_data__ml_gen_alloc_site_7_p_0(Var_28, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, Context_8, &AllocId_22, GlobalData0_19, &GlobalData_23);
        ml_backend__ml_gen_info__ml_gen_info_set_global_data_3_p_0(GlobalData_23, STATE_VARIABLE_Info_0_24, STATE_VARIABLE_Info_25);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_35, 1) = ((MR_Box) (AllocId_22));
        }
        {
          Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (Var_35));
          MR_hl_field(MR_mktag(1), Var_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[4])));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 227, &Parallel_13);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          NonMangledArgVarName_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), NonMangledArgVarName_52, 0) = ((MR_Box) (ArgName_48));
        }
