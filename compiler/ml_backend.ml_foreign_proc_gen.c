              ...
              if (ml_backend__ml_foreign_proc_gen__succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__ml_foreign_proc_gen__Var_86, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 11));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ml_backend__ml_foreign_proc_gen__SuccessIndicatorDecl_36 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) &ml_backend__ml_foreign_proc_gen_scalar_common_2[19], (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_foreign_proc_gen__Context_20);
          }
          {
          ...
          {
            ml_backend__ml_foreign_proc_gen__Var_56 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_foreign_proc_gen__Var_56, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__SuccessIndicatorLval_37));
          }
          {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    ml_backend__ml_foreign_proc_gen__Var_28 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), ml_backend__ml_foreign_proc_gen__Var_28, 0) = ((MR_Box) (ml_backend__ml_foreign_proc_gen__VarLval_18));
                  }
                  {
