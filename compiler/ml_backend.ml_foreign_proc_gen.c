...
static /* final */ const MR_Box ml_backend__ml_foreign_proc_gen_scalar_common_1[19][2] = {
  ...
  /* row 17 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[17]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 18 */
  {
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignArg_7, (MR_Integer) 3)));
    BoxPolicy_14 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignArg_7, (MR_Integer) 3))) & (MR_Integer) 1);
    succeeded = ((MR_tag((MR_Word) MaybeNameAndMode_12)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_86, 0) = ((MR_Box) ((MR_Unsigned) 20U));
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_42, (MR_Integer) 276, &HighLevelData_43);
      succeeded = ml_backend__ml_foreign_proc_gen__input_arg_assignable_with_cast_6_p_0(Lang_6, HighLevelData_43, OrigType_13, MaybeForeignType_40, TypeString_41, &Cast_44);
      if (succeeded)
      {
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_168, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[14])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_180, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[16])));
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_124, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[14])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_136, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[16])));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[14])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[16])));
          ...
          {
            EndingFragments_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), EndingFragments_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_foreign_proc_gen_scalar_common_2[9])));
    ...
    {
      StartingCCode_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), StartingCCode_40, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      MR_hl_field(MR_mktag(3), StartingCCode_40, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), StartingCCode_40, 2) = ((MR_Box) (StartingFragments_37));
    }
    {
      StartingCCodeStmt_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), StartingCCodeStmt_41, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    ...
    {
      EndingCCode_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), EndingCCode_42, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      MR_hl_field(MR_mktag(3), EndingCCode_42, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), EndingCCode_42, 2) = ((MR_Box) (EndingFragments_38));
    }
    {
      EndingCCodeStmt_43 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), EndingCCodeStmt_43, 0) = ((MR_Box) ((MR_Unsigned) 8U));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignArg_12, (MR_Integer) 3)));
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNameAndMode_41)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNameAndMode_18)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    (env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7 = C_Codes_7;
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 211, &(env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__ProfileMemory_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 233, &Parallel_13);
...
{
  {
    ...
    EndingFragments_43 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), AssignSucceeded_37, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__ml_foreign_proc_gen_scalar_common_1[12])));
    {
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), JavaArg_15, (MR_Integer) 3)));
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNameAndMode_44)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNameAndMode_19)) == (MR_Integer) 1);
      if (succeeded)
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
                MLDS_Type_25 = (MR_Word) ((MR_Unsigned) 8U);
              else
                MLDS_Type_25 = (MR_Word) ((MR_Unsigned) 24U);
            }
            break;
          case (MR_Integer) 1:
