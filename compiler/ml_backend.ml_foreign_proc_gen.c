  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  (env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7 = C_Codes_7;
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 267, &(env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__ProfileMemory_13);
  ...
  MR_String * ReleaseLock_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 289, &Parallel_13);
    ...
    case (MR_Integer) 2:
      {
        ...
        ml_backend__ml_foreign_proc_gen__ml_generate_runtime_cond_code_4_p_0(ExprA_32, &RvalA_33, STATE_VARIABLE_Info_0_17, &STATE_VARIABLE_Info_30_30);
        ml_backend__ml_foreign_proc_gen__ml_generate_runtime_cond_code_4_p_0(ExprB_14, &RvalB_15, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_18);
        switch (TraceOp_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
