...
{
  {
    ...
    if (succeeded)
    {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_86, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 20));
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_42, (MR_Integer) 271, &HighLevelData_43);
    ...
    {
      *AssignInput_8 = (MR_Word) ((MR_Integer) 0);
      *STATE_VARIABLE_Info_18 = STATE_VARIABLE_Info_0_17;
    }
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              if ((MaybeForeignType_10 == (MR_Word) ((MR_Integer) 0)))
              {
                *Cast_12 = (MR_String) "";
                succeeded = MR_TRUE;
              }
...
{
  {
    ...
    else
    {
      ...
      {
        Components1_19 = (MR_Word) ((MR_Integer) 0);
        ConvDecls1_20 = (MR_Word) ((MR_Integer) 0);
        ConvStmts1_21 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    if ((MaybeForeignType_26 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    (env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__C_Codes_7 = C_Codes_7;
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 210, &(env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__ProfileMemory_13);
      ...
      if ((env).ml_backend__ml_foreign_proc_gen__ml_gen_hash_define_mr_alloc_id_6_p_0_env_0__succeeded)
      {
        ...
        ml_backend__ml_global_data__ml_gen_alloc_site_7_p_0(Var_27, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, Context_8, &AllocId_21, GlobalData0_20, &GlobalData_22);
      ...
      {
        *HashDefine_9 = (MR_Word) ((MR_Integer) 0);
        *HashUndef_10 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 232, &Parallel_13);
...
{
  {
    ...
    switch (OrdinaryKind_15) {
      ...
      case (MR_Integer) 0:
        {
          SucceededDecl_36 = (MR_Word) ((MR_Integer) 0);
          AssignSucceeded_37 = (MR_Word) ((MR_Integer) 0);
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), SucceededDecl_36, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
    ...
    else
    {
      ...
      if (succeeded)
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), Rval_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        ...
        Var_65 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ArgLval_53, Rval_57, Context_3);
        {
          ...
          MR_hl_field(MR_mktag(1), Stmts1_22, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      }
      else
      {
        Stmts1_22 = (MR_Word) ((MR_Integer) 0);
        ConvDecls1_23 = (MR_Word) ((MR_Integer) 0);
        ConvStmts1_24 = (MR_Word) ((MR_Integer) 0);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
                MLDS_Type_25 = (MR_Word) ((MR_Integer) 8);
              else
                MLDS_Type_25 = (MR_Word) ((MR_Integer) 24);
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 2:
      {
        ...
        switch (TraceOp_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            Op_16 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 0:
            Op_16 = (MR_Word) ((MR_Integer) 4);
            break;
        }
        {
          MR_Word base;
