...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1170__1_5_p_0(
  MR_Word VarSet_12,
...
{
  {
    ...
    hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1170__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
