  ...
  MR_Word * STATE_VARIABLE_State_56)
{
  ...
  hlds__hlds_out__hlds_out_pred__format_rtti_varmaps_6_p_0(VarNamePrint_11, TVarSet_18, VarTable_20, RttiVarMaps_30, STATE_VARIABLE_State_3_75, &STATE_VARIABLE_State_4_76);
