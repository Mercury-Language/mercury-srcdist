...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1167__1_5_p_0(
  MR_Word VarSet_12,
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (!((MaybeObsoleteInFavourOf_52 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        mercury__list__foldl_4_p_2((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_and_arity_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_88, ObsoleteInFavourOf_53, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_89_89);
      }
...
{
  {
    ...
    hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1167__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
