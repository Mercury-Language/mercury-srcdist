...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1140__1_5_p_0(
  MR_Word VarSet_12,
...
{
  {
    ...
    if (succeeded)
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            FuncRetType_37 = ((MR_Word) (conv0_FuncRetType_37));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (Module_16));
              MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (PredName_17));
            }
            parse_tree__parse_tree_out_pred_decl__mercury_output_func_type_11_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_61, FuncArgTypes_36, FuncRetType_37, (MR_Word) ((MR_Unsigned) 0U), Purity_28, ClassContext_25);
          }
          break;
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (Module_16));
              MR_hl_field(MR_mktag(1), Var_64, 1) = ((MR_Box) (PredName_17));
            }
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_type_10_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_64, ArgTypes_19, (MR_Word) ((MR_Unsigned) 0U), Purity_28, ClassContext_25);
          }
          break;
      }
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), PredIdInt_48, &Var_102);
      ...
      hlds__hlds_clauses__get_clause_list_maybe_repeated_2_p_0(ClausesRep_43, &Clauses_52);
      ...
      if (succeeded)
      {
        MR_Word InfoForClauses_55;

        hlds__hlds_out__hlds_out_pred__set_dump_opts_for_clauses_2_p_0(Info_9, &InfoForClauses_55);
        hlds__hlds_out__hlds_out_pred__write_clauses_13_p_0(InfoForClauses_55, Lang_10, ModuleInfo_11, PredId_13, PredOrFunc_18, VarSet_38, (MR_Word) ((MR_Unsigned) 0U), VarNamePrint_32, Indent_12, HeadVars_42, Clauses_52);
      }
      hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo_14, &Origin_56);
      hlds__hlds_out__hlds_out_pred__write_origin_6_p_0(ModuleInfo_11, TVarSet_21, VarNamePrint_32, Origin_56);
    }
...
{
  {
    ...
    Indent1_47 = (MR_Integer) ((MR_Unsigned) Indent_12 + (MR_Unsigned) 1);
    DumpOptions_48 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 0))));
    succeeded = mercury__string__contains_char_2_p_0(DumpOptions_48, (MR_Char) 120);
    if (succeeded)
    {
      ...
      DetismStr_52 = parse_tree__prog_out__determinism_to_string_1_f_0(InferredDeterminism_25);
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent1_47);
      mercury__io__write_string_3_p_0((MR_String) "% pred id ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), PredIdInt_49, &Var_119);
      mercury__io__write_string_3_p_0(Var_119);
      mercury__io__write_string_3_p_0((MR_String) ": ");
      mercury__io__write_string_3_p_0(PredIdStr_51);
      mercury__io__write_string_3_p_0((MR_String) "\n");
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent1_47);
      mercury__io__write_string_3_p_0((MR_String) "% mode number ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), ProcIdInt_50, &Var_133);
      mercury__io__write_string_3_p_0(Var_133);
      mercury__io__write_string_3_p_0((MR_String) " (");
      mercury__io__write_string_3_p_0(DetismStr_52);
      mercury__io__write_string_3_p_0((MR_String) ")\n");
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
      ...
      hlds__hlds_out__hlds_out_pred__write_proc_flags_6_p_0(CanProcess_21, IsAddressTaken_39, HasParallelConj_40, HasUserEvent_41);
      hlds__hlds_out__hlds_out_pred__write_proc_tabling_info_8_p_0(VarSet_22, TVarSet_20, VarNamePrint_13, EvalMethod_37, MaybeProcTableIOInfo_42, MaybeCallTableTip_43);
      hlds__hlds_out__hlds_out_pred__write_proc_deep_profiling_info_5_p_0(VarSet_22, VarNamePrint_13, MaybeDeepProfileInfo_44);
      hlds__hlds_out__hlds_out_pred__write_proc_termination_info_5_p_0(DumpOptions_48, MaybeArgSize_32, MaybeTermination_33);
      hlds__hlds_out__hlds_out_pred__write_proc_opt_info_10_p_0(DumpOptions_48, Indent_12, VarSet_22, TVarSet_20, VarNamePrint_13, MaybeStructureSharing_34, MaybeStructureReuse_35, MaybeUntupleInfo_45);
      hlds__hlds_out__hlds_out_pred__write_proc_deleted_callee_set_3_p_0(DeletedCallCalleeSet_38);
      hlds__hlds_out__hlds_out_pred__write_pred_proc_var_name_remap_5_p_0(Indent_12, VarSet_22, VarNameRemap_46);
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
      Var_93 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo_14, PredId_15);
      {
        PredSymName_53 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), PredSymName_53, 0) = ((MR_Box) (Var_93));
      }
        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), HeadModes_27, &FuncHeadModes_57, &conv0_RetHeadMode_58);
            RetHeadMode_58 = ((MR_Word) (conv0_RetHeadMode_58));
            parse_tree__parse_tree_out_pred_decl__mercury_output_func_mode_decl_8_p_0((MR_Integer) 1, ModeVarSet_55, PredSymName_53, FuncHeadModes_57, RetHeadMode_58, DeclaredDeterminism_24);
          }
          break;
        case (MR_Integer) 0:
          {
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_mode_decl_8_p_0((MR_Integer) 1, ModeVarSet_55, PredSymName_53, HeadModes_27, (MR_Word) ((MR_Unsigned) 0U), DeclaredDeterminism_24);
          }
          break;
      }
      hlds__hlds_out__hlds_out_pred__write_proc_arg_info_9_p_0(DumpOptions_48, Indent_12, VarSet_22, VarNamePrint_13, MaybeArgLives_28, RegR_HeadVars_29, MaybeArgInfos_30);
      hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_16, &PredStatus_59);
      Var_99 = (MR_Word) (PredStatus_59);
      ...
      if (!(succeeded))
      {
        ...
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
        hlds__hlds_out__hlds_out_pred__write_stack_slots_6_p_0(VarSet_22, VarNamePrint_13, Indent_12, StackSlots_60);
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
        mercury__term__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVars_26, &HeadTerms_61);
        hlds__hlds_out__hlds_out_pred__write_clause_head_8_p_0(ModuleInfo_14, VarSet_22, VarNamePrint_13, PredId_15, PredOrFunc_54, HeadTerms_61);
        mercury__io__write_string_3_p_0((MR_String) " :-\n");
        hlds__hlds_out__hlds_out_goal__write_goal_9_p_0(Info_11, ModuleInfo_14, VarSet_22, VarNamePrint_13, Indent1_47, (MR_String) ".\n", Goal_31);
      }
    }
  }
}
...
{
  {
    ...
    hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1140__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
