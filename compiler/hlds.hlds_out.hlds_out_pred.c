...
static /* final */ const struct hlds__hlds_out__hlds_out_pred__vector_common_type_4_0_s hlds__hlds_out__hlds_out_pred_vector_common_4[43];
...
static /* final */ const struct hlds__hlds_out__hlds_out_pred__vector_common_type_4_0_s hlds__hlds_out__hlds_out_pred_vector_common_4[43] = {
  ...
  /* row 41 */   {     (MR_String) "has_incomplete_switch" },
  /* row 42 */   {     (MR_String) "has_format_call" },
};
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(hlds__hlds_out__hlds_out_pred__TrieStep_9)) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 2:
            hlds__hlds_out__hlds_out_pred__V_17_17 = (MR_String) "uint";
            break;
          case (MR_Integer) 3:
