...
{
  {
    ...
    {
      hlds__hlds_out__hlds_out_pred__V_14_14 = parse_tree__unparse__mode_to_term_with_context_3_f_0(hlds__hlds_out__hlds_out_pred__Lang_5, hlds__hlds_out__hlds_out_pred__Context_6, hlds__hlds_out__hlds_out_pred__Mode_8);
    }
    {
