  ...
  MR_Word MaybeUntupleInfo_18)
{
  ...
  if (!((MaybeUntupleInfo_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_11, (MR_String) "% untuple:\n");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_5[1]));
      ...
      MR_hl_field(MR_mktag(0), Var_47, 4) = ((MR_Box) (VarSet_13));
  ...
  MR_Word HeadTerms_24)
{
  ...
  if (succeeded)
  {
    ...
    PredName_51 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo_15, PredId_20);
    ModuleName_52 = hlds__hlds_module__predicate_module_2_f_0(ModuleInfo_15, PredId_20);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_61;
          MR_Word Var_62;
          MR_Box conv2_RetVal_54;

          parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[2]), AnnotatedHeadTerms_31, &FuncArgs_53, &conv2_RetVal_54);
          RetVal_54 = ((MR_Word) (conv2_RetVal_54));
          {
            Var_61 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (VarSet_17));
          }
          {
            Var_62 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (PredName_51));
          }
          Var_59 = hlds__hlds_out__hlds_out_util__qualified_functor_with_term_args_to_string_5_f_0(Var_61, VarNamePrint_18, ModuleName_52, Var_62, FuncArgs_53);
          mercury__io__write_string_4_p_0(Stream_14, Var_59);
          mercury__io__write_string_4_p_0(Stream_14, (MR_String) " = ");
          parse_tree__parse_tree_out_term__mercury_output_term_nq_7_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_17, VarNamePrint_18, (MR_Integer) 0, RetVal_54, Stream_14);
        }
        break;
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (VarSet_17));
          }
          {
            Var_58 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (PredName_51));
          }
          Var_55 = hlds__hlds_out__hlds_out_util__qualified_functor_with_term_args_to_string_5_f_0(Var_57, VarNamePrint_18, ModuleName_52, Var_58, AnnotatedHeadTerms_31);
          mercury__io__write_string_4_p_0(Stream_14, Var_55);
        }
        break;
    }
  }
