...
{
  {
    ...
    switch (MR_tag((MR_Word) TrieStep_9)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TrieStep_9, (MR_Integer) 0))));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word IsPoly_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TrieStep_9, (MR_Integer) 1))) & (MR_Integer) 1);
          MR_Word IsAddr_25 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TrieStep_9, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__parse_tree_out_pred_decl__mercury_output_func_type_11_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_103, FuncArgTypes_33, FuncRetType_34, (MR_Word) ((MR_Integer) 0), Purity_28, ClassContext_25);
          }
          break;
        case (MR_Integer) 0:
          {
            ...
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_type_10_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_106, ArgTypes_19, (MR_Word) ((MR_Integer) 0), Purity_28, ClassContext_25);
          }
          break;
      }
    ...
    if (succeeded)
    {
      ...
      if (!((MarkerList_47 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((ExternalTypeParams_29 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((VarNameRemapList_52 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((Clauses_55 == (MR_Word) ((MR_Integer) 0))))
      {
        MR_Word InfoForClauses_58;

        hlds__hlds_out__hlds_out_pred__set_dump_opts_for_clauses_2_p_0(Info_9, &InfoForClauses_58);
        hlds__hlds_out__hlds_out_pred__write_clauses_13_p_0(InfoForClauses_58, Lang_10, ModuleInfo_11, PredId_13, PredOrFunc_18, VarSet_35, (MR_Word) ((MR_Integer) 0), VarNamePrint_32, Indent_12, HeadVars_39, Clauses_55);
      }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (!((DeletedCallCallees_58 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((MaybeProcTableIOInfo_43 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((MaybeCallTableTip_44 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((MaybeDeepProfileInfo_45 == (MR_Word) ((MR_Integer) 0))))
      {
        ...
        if (!((MaybeRecInfo_67 == (MR_Word) ((MR_Integer) 0))))
        {
        ...
        if (!((MaybeDeepLayout_68 == (MR_Word) ((MR_Integer) 0))))
        {
          ...
          if (!((MaybeOldOutermost_83 == (MR_Word) ((MR_Integer) 0))))
          {
      ...
      if (!((MaybeUntupleInfo_46 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if (!((VarNameRemapList_86 == (MR_Word) ((MR_Integer) 0))))
      {
        ...
        case (MR_Integer) 0:
          {
            ...
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_mode_decl_8_p_0((MR_Integer) 1, ModeVarSet_91, Var_215, HeadModes_28, (MR_Word) ((MR_Integer) 0), DeclaredDeterminism_25);
          }
          break;
      }
      if (!((MaybeArgLives_29 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      succeeded = (Var_236 == (MR_Word) ((MR_Integer) 8));
      if (succeeded)
      {
...
{
  {
    ...
    if ((MaybeArgInfos_8 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    if (!((TVarPairs_10 == (MR_Word) ((MR_Integer) 0))))
    {
      MR_Word Var_21;
  ...
  MR_Word Tail_8)
{
  while (MR_TRUE)
  {
    ...
    if (!((Tail_8 == (MR_Word) ((MR_Integer) 0))))
    {
  ...
  MR_Integer ClauseNum_26)
{
  while (MR_TRUE)
  {
    // setup for model_det tailcalls optimized into a loop
    ;
    if (!((Clauses_25 == (MR_Word) ((MR_Integer) 0))))
    {
...
{
  {
    ...
    if (!((ApplicableModes_28 == (MR_Word) ((MR_Integer) 0))))
    {
    ...
    if (!((ImplLang_30 == (MR_Word) ((MR_Integer) 0))))
    {
