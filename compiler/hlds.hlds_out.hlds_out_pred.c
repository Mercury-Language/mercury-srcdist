...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc__1035__1_5_p_0(
...
static /* final */ const struct hlds__hlds_out__hlds_out_pred__vector_common_type_4_0_s hlds__hlds_out__hlds_out_pred_vector_common_4[42];
...
static /* final */ const struct hlds__hlds_out__hlds_out_pred__vector_common_type_4_0_s hlds__hlds_out__hlds_out_pred_vector_common_4[42] = {
  ...
  /* row 25 */   {     (MR_String) "consider_used" },
  /* row 26 */   {     (MR_String) "class_method" },
  /* row 27 */   {     (MR_String) "class_instance_method" },
  /* row 28 */   {     (MR_String) "named_class_instance_method" },
  /* row 29 */   {     (MR_String) "impure" },
  /* row 30 */   {     (MR_String) "semipure" },
  /* row 31 */   {     (MR_String) "promise_pure" },
  /* row 32 */   {     (MR_String) "promise_semipure" },
  /* row 33 */   {     (MR_String) "promise_equivalent_clauses" },
  /* row 34 */   {     (MR_String) "terminates" },
  /* row 35 */   {     (MR_String) "does_not_terminate" },
  /* row 36 */   {     (MR_String) "check_termination" },
  /* row 37 */   {     (MR_String) "calls_are_fully_qualified" },
  /* row 38 */   {     (MR_String) "mode_check_clauses" },
  /* row 39 */   {     (MR_String) "mutable_access_pred" },
  /* row 40 */   {     (MR_String) "has_require_scope" },
  /* row 41 */   {     (MR_String) "has_format_call" },
};
...
{
  {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__hlds_out__hlds_out_pred_scalar_common_5[0], hlds__hlds_out__hlds_out_pred__STATE_VARIABLE_SlotNum_0_11, &hlds__hlds_out__hlds_out_pred__V_31_31);
    }
    {
    ...
    {
      mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_21_21);
    }
    {
      mercury__io__write_string_3_p_0((MR_String) ">, type ");
    }
    {
      mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_24_24);
    }
    {
      mercury__io__write_string_3_p_0((MR_String) "\n");
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_out__hlds_out_pred__V_114_114, hlds__hlds_out__hlds_out_pred__LineNumber_12, &hlds__hlds_out__hlds_out_pred__V_146_146);
          }
          {
            mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_146_146);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) ">\n");
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_out__hlds_out_pred__V_114_114, hlds__hlds_out__hlds_out_pred__LineNumber_103, &hlds__hlds_out__hlds_out_pred__V_122_122);
          }
          {
            mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_122_122);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) ">, goal path <");
          }
          {
            mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_100_100);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) ">\n");
          }
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_String hlds__hlds_out__hlds_out_pred__V_177_177;
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_out__hlds_out_pred__V_114_114, hlds__hlds_out__hlds_out_pred__LineNumber_77, &hlds__hlds_out__hlds_out_pred__V_177_177);
          }
          {
            mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_177_177);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) ">, goal path <");
          }
          {
            mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_74_74);
          }
          {
            mercury__io__write_string_3_p_0((MR_String) ">\n");
          }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_out__hlds_out_pred__V_114_114, hlds__hlds_out__hlds_out_pred__LineNumber_90, &hlds__hlds_out__hlds_out_pred__V_160_160);
              }
              {
              ...
              {
                mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_87_87);
              }
              {
                mercury__io__write_string_3_p_0((MR_String) ">\n");
              }
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_String hlds__hlds_out__hlds_out_pred__V_194_194;
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_out__hlds_out_pred__V_114_114, hlds__hlds_out__hlds_out_pred__LineNumber_63, &hlds__hlds_out__hlds_out_pred__V_194_194);
              }
              {
                mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_194_194);
              }
              {
                mercury__io__write_string_3_p_0((MR_String) ">, goal path <");
              }
              {
                mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_39_39);
              }
              {
                mercury__io__write_string_3_p_0((MR_String) ">\n");
              }
...
{
  {
    ...
    {
      mercury__list__foldl_4_p_2((MR_Word) &hlds__hlds_out__hlds_out_pred_scalar_common_1[5], hlds__hlds_out__hlds_out_pred__TypeCtorInfo_38_38, hlds__hlds_out__hlds_out_pred__V_22_22, hlds__hlds_out__hlds_out_pred__TypeVars_14, ((MR_Box) ((MR_Integer) 0)), &hlds__hlds_out__hlds_out_pred__conv0_STATE_VARIABLE_IO_23_23);
    }
    {
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(hlds__hlds_out__hlds_out_pred__Indent_11);
    }
...
{
  {
    ...
    {
      hlds__hlds_out__hlds_out_pred__V_14_14 = parse_tree__parse_tree_to_term__mode_to_term_with_context_3_f_0(hlds__hlds_out__hlds_out_pred__Lang_5, hlds__hlds_out__hlds_out_pred__Context_6, hlds__hlds_out__hlds_out_pred__Mode_8);
    }
    {
...
{
  {
    ...
    {
      hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc__1035__1_5_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__closure, (MR_Integer) 4))), ((MR_Word) hlds__hlds_out__hlds_out_pred__wrapper_arg_1));
    }
  }
}
...
{
  {
    ...
    MR_String hlds__hlds_out__hlds_out_pred__V_245_245;
    MR_Word hlds__hlds_out__hlds_out_pred__V_246_246;
    MR_Word hlds__hlds_out__hlds_out_pred__V_247_247;
    MR_Word hlds__hlds_out__hlds_out_pred__V_248_248;
    ...
    hlds__hlds_out__hlds_out_pred__V_245_245 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__Info_11, (MR_Integer) 1)));
    hlds__hlds_out__hlds_out_pred__V_246_246 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__Info_11, (MR_Integer) 2)));
    hlds__hlds_out__hlds_out_pred__V_247_247 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__Info_11, (MR_Integer) 3)));
    hlds__hlds_out__hlds_out_pred__V_248_248 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__Info_11, (MR_Integer) 4)));
    {
    ...
    if (hlds__hlds_out__hlds_out_pred__succeeded)
      {
        ...
        MR_Integer hlds__hlds_out__hlds_out_pred__V_268_268;
        ...
        {
          hlds__hlds_out__hlds_out_pred__V_117_117 = parse_tree__prog_out__determinism_to_string_1_f_0(hlds__hlds_out__hlds_out_pred__InferredDeterminism_26);
        }
        {
          mercury__io__write_string_3_p_0(hlds__hlds_out__hlds_out_pred__V_117_117);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) "):\n");
        }
        ...
        if ((hlds__hlds_out__hlds_out_pred__MaybeDeepProfileInfo_45 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word hlds__hlds_out__hlds_out_pred__V_69_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__DeepProfileInfo_66, (MR_Integer) 2)));
            ...
            if ((hlds__hlds_out__hlds_out_pred__MaybeRecInfo_67 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                MR_Word hlds__hlds_out__hlds_out_pred__V_72_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__DeepRecInfo_70, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word hlds__hlds_out__hlds_out_pred__V_212_212;
              ...
              {
                hlds__hlds_out__hlds_out_pred__V_212_212 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_212_212, 0) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__PredName_89));
              }
              {
                parse_tree__parse_tree_out_pred_decl__mercury_output_func_mode_decl_8_p_0((MR_Integer) 1, hlds__hlds_out__hlds_out_pred__ModeVarSet_91, hlds__hlds_out__hlds_out_pred__V_212_212, hlds__hlds_out__hlds_out_pred__FuncHeadModes_93, hlds__hlds_out__hlds_out_pred__RetHeadMode_94, hlds__hlds_out__hlds_out_pred__DeclaredDeterminism_25);
              }
            }
            break;
          case (MR_Integer) 0:
            {
              MR_Word hlds__hlds_out__hlds_out_pred__V_215_215;

              {
                hlds__hlds_out__hlds_out_pred__V_215_215 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_215_215, 0) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__PredName_89));
              }
              {
                parse_tree__parse_tree_out_pred_decl__mercury_output_pred_mode_decl_8_p_0((MR_Integer) 1, hlds__hlds_out__hlds_out_pred__ModeVarSet_91, hlds__hlds_out__hlds_out_pred__V_215_215, hlds__hlds_out__hlds_out_pred__HeadModes_28, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__hlds_out__hlds_out_pred__DeclaredDeterminism_25);
              }
            }
            break;
        }
        ...
        if (hlds__hlds_out__hlds_out_pred__succeeded)
          {
            ...
            {
              hlds__hlds_out__hlds_out_pred__V_225_225 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, hlds__hlds_out__hlds_out_pred__RegR_HeadVars_30);
            }
            {
              hlds__hlds_out__hlds_out_pred__V_227_227 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_227_227, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[1]));
              MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_227_227, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__write_proc_10_p_0_1));
              MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_227_227, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_227_227, 3) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__VarNamePrint_15));
              MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_pred__V_227_227, 4) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__VarSet_23));
            }
            {
              mercury__io__write_list_5_p_0(hlds__hlds_out__hlds_out_pred__TypeInfo_255_255, hlds__hlds_out__hlds_out_pred__V_225_225, (MR_String) ", ", hlds__hlds_out__hlds_out_pred__V_227_227);
            }
            {
              mercury__io__nl_2_p_0();
            }
        ...
        hlds__hlds_out__hlds_out_pred__V_236_236 = (MR_Word) hlds__hlds_out__hlds_out_pred__PredStatus_14;
        hlds__hlds_out__hlds_out_pred__succeeded = (hlds__hlds_out__hlds_out_pred__V_236_236 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
        if (hlds__hlds_out__hlds_out_pred__succeeded)
          {
            {
              hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&hlds__hlds_out__hlds_out_pred__V_268_268);
            }
            hlds__hlds_out__hlds_out_pred__succeeded = (hlds__hlds_out__hlds_out_pred__ProcId_17 == hlds__hlds_out__hlds_out_pred__V_268_268);
          }
        if (hlds__hlds_out__hlds_out_pred__succeeded)
          {
          }
