...
static /* final */ const MR_Box hlds__hlds_out__hlds_out_pred_scalar_common_10[2][9];
  ...
  MR_Word MaybeArgInfos_16)
{
  ...
  if (succeeded)
  {
    ...
    mercury__io__write_string_4_p_0(Stream_10, (MR_String) "% reg_r headvars: ");
    {
      ...
      MR_hl_field(1, Var_27, 0) = ((MR_Box) (VarTable_12));
    }
    Var_28 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), RegR_HeadVars_15);
    parse_tree__parse_tree_out_term__mercury_output_vars_src_6_p_0(Var_27, VarNamePrint_13, Var_28, Stream_10);
    mercury__io__nl_3_p_0(Stream_10);
  }
