  ...
  MR_Word PredInfo_14)
{
  ...
  if (succeeded)
  {
    ...
    if (!((MaybeObsoleteInFavourOf_55 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_10, (MR_String) "% obsolete in favour of one of\n");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_98, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_7[1]));
        MR_hl_field(MR_mktag(0), Var_98, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__write_pred_8_p_0_1));
        MR_hl_field(MR_mktag(0), Var_98, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_98, 3) = ((MR_Box) (Stream_10));
      }
    ...
    {
      MR_Word FormatCall_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFormatCall_57, (MR_Integer) 0))));
      MR_Word OoMFormatStringValues_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FormatCall_58, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FilledInProcIdsInfos_35, (MR_Integer) 0))));
      Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FilledInProcIdsInfos_35, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
    MR_Integer ProcId_158 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 0))));
    MR_Word ProcInfo_159 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word FmtStringValue_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word FmtStringValues_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
      MR_Integer OrigFmtStr_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), FmtStringValue_10, (MR_Integer) 0))));
      MR_Integer OrigValues_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), FmtStringValue_10, (MR_Integer) 1))));
      MR_Integer CurFmtStr_15 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), FmtStringValue_10, (MR_Integer) 2))));
      MR_Integer CurValues_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), FmtStringValue_10, (MR_Integer) 3))));
      MR_String Var_33;
      MR_String Var_43;
      MR_String Var_53;
      MR_String Var_63;
