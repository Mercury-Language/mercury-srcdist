...
{
  {
    ...
    parse_tree__parse_tree_out_term__mercury_output_var_5_p_0(TypeCtorInfo_42_42, VarSet_9, VarNamePrint_11, Var_14);
    mercury__io__write_string_3_p_0((MR_String) " (number ");
    mercury__term__var_to_int_2_p_0(TypeCtorInfo_42_42, Var_14, &VarNum_16);
