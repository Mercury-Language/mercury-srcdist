...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "% pred id ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), PredIdInt_50, &Var_131);
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), ProcIdInt_51, &Var_145);
      ...
      else
      {
        ...
        mercury__io__write_string_3_p_0((MR_String) "% mode number ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), ProcIdInt_51, &Var_159);
        mercury__io__write_string_3_p_0(Var_159);
        mercury__io__write_string_3_p_0((MR_String) " (");
        mercury__io__write_string_3_p_0(DetismStr_53);
        mercury__io__write_string_3_p_0((MR_String) ") INVALID MODE\n");
      }
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
      ...
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
      Var_104 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo_14, PredId_15);
      {
        PredSymName_54 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), PredSymName_54, 0) = ((MR_Box) (Var_104));
      }
      ...
      Var_110 = (MR_Word) (PredStatus_60);
      succeeded = (Var_110 == (MR_Word) ((MR_Unsigned) 8U));
      if (succeeded)
      {
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_127);
        succeeded = (ProcId_17 == Var_127);
      }
      if (!(succeeded))
      {
...
{
  {
    ...
    {
      MR_Word ProcTableIOInfo_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeProcTableIOInfo_13, (MR_Integer) 0))));
      MR_Word MaybeArgInfos_41 = (MR_Word) (ProcTableIOInfo_20);

      if ((MaybeArgInfos_41 == (MR_Word) ((MR_Unsigned) 0U)))
        mercury__io__write_string_3_p_0((MR_String) "% proc table io info: io tabled, no arg_infos\n");
      else
      {
        MR_Word ArgInfos_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeArgInfos_41, (MR_Integer) 0))));

        mercury__io__write_string_3_p_0((MR_String) "% proc table io info: io tabled, arg_infos:\n");
        hlds__hlds_out__hlds_out_pred__write_table_arg_infos_4_p_0(TVarSet_10, ArgInfos_42);
      }
    }
    if (!((MaybeCallTableTip_14 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word CallTableTip_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallTableTip_14, (MR_Integer) 0))));

      mercury__io__write_string_3_p_0((MR_String) "% call table tip: ");
      parse_tree__parse_tree_out_term__mercury_output_var_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_9, VarNamePrint_11, CallTableTip_21);
      mercury__io__write_string_3_p_0((MR_String) "\n");
    }
  }
}
...
{
  {
    ...
    AllProcIds_39 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_38);
