  ...
  MR_Word ProcInfo_18)
{
  ...
  DumpOptions_48 = ((MR_String) ((MR_hl_field(0, Info_11, (MR_Integer) 0))));
  ...
  DetismStr_52 = parse_tree__parse_tree_out_misc__determinism_to_string_1_f_0(InferredDeterminism_24);
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_12, (MR_Integer) 1);
  ...
  hlds__hlds_out__hlds_out_pred__write_proc_deleted_callee_set_4_p_0(Stream_12, DeletedCallCalleeSet_38);
  {
    ...
    MR_hl_field(1, Var_98, 0) = ((MR_Box) (VarTable_22));
  }
  ...
  Var_101 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo_14, PredId_15);
  {
    ...
    MR_hl_field(0, PredSymName_53, 0) = ((MR_Box) (Var_101));
  }
  ...
  if (!(succeeded))
  {
    ...
    mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVars_25, &HeadTerms_61);
  ...
  MR_Word Clause_28)
{
  ...
  MR_String DumpOptions_36 = ((MR_String) ((MR_hl_field(0, Info_16, (MR_Integer) 0))));
  MR_Word PredInfo_40;
  ...
  switch (MR_tag((MR_Word) ApplicableModes_30)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_17, Indent_26);
    ...
    case (MR_Integer) 1:
      {
        MR_Word Modes_37 = ((MR_Word) ((MR_hl_field(1, ApplicableModes_30, (MR_Integer) 0))));
  ...
  {
    MR_Word ForeignLang_39 = ((MR_Unsigned) ((MR_hl_field(1, ImplLang_32, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  if (succeeded)
  {
    SelectedProcIds_42 = ((MR_Word) ((MR_hl_field(1, ApplicableModes_30, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          ...
          RetVal_89 = ((MR_Word) (conv1_RetVal_89));
          {
            ...
            MR_hl_field(0, Var_92, 0) = ((MR_Box) (PredName_86));
          }
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(0, Var_97, 0) = ((MR_Box) (PredName_86));
          }
  ...
  Var_68 = ((MR_Word) ((MR_hl_field(0, Goal_31, (MR_Integer) 0))));
  succeeded = ((((MR_tag((MR_Word) Var_68)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_68, (MR_Integer) 0)))) == (MR_Integer) 2)));
  if (succeeded)
  {
    Var_69 = ((MR_Unsigned) ((MR_hl_field(3, Var_68, (MR_Integer) 1))) & (MR_Integer) 1);
    Var_70 = ((MR_Word) ((MR_hl_field(3, Var_68, (MR_Integer) 2))));
