  ...
  MR_Word HeadVar__8_8)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__8_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0, ProcTable_6, ProcId_28, &conv0_ProcInfo_31);
      ...
      {
        MR_Word next_value_of_HeadVar__8_8 = ProcIds_29;
  ...
  MR_Word Tail_8)
{
  while (MR_TRUE)
  {
    ...
    if (!((Tail_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_Head_7 = TailHead_12;
  ...
  MR_Integer ClauseNum_26)
{
  while (MR_TRUE)
  {
    ...
    if (!((Clauses_25 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_Clauses_25 = LaterClauses_29;
        MR_Integer next_value_of_ClauseNum_26 = Var_40;
...
{
  {
    ...
    if (!((ApplicableModes_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      if (succeeded)
      {
        ...
        ModeInts_36 = mercury__list__map_2_f_0(TypeCtorInfo_72_72, TypeCtorInfo_72_72, (MR_Word) &hlds__hlds_out__hlds_out_pred_scalar_common_2[2], Modes_35);
    ...
    if (succeeded)
    {
      ...
      TypeInfo_76_76 = (MR_Word) &hlds__hlds_out__hlds_out_pred_scalar_common_1[8];
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_76_76, ((MR_Box) (SelectedProcIds_40)), ((MR_Box) (AllProcIds_39)));
      succeeded = !(succeeded);
    }
    if (succeeded)
  ...
  MR_Word HeadTerms_10)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__8_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__8_8 = ProcIds_33;
