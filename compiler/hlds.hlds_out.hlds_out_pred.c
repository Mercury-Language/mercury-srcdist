  ...
  MR_Word * STATE_VARIABLE_State_50)
{
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__string__builder__append_string_3_p_0(IndentStr_35, STATE_VARIABLE_State_0_49, &Var_137);
                mercury__string__builder__append_string_3_p_0((MR_String) "% this clause applies only to <in,in> unify modes.\n", Var_137, &STATE_VARIABLE_State_3_60);
              }
              break;
          }
          break;
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__string__builder__append_string_3_p_0(IndentStr_35, STATE_VARIABLE_State_0_49, &Var_135);
                mercury__string__builder__append_string_3_p_0((MR_String) "% this clause applies only to non <in,in> unify modes.\n", Var_135, &STATE_VARIABLE_State_3_60);
              }
              break;
          }
          break;
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__builder__append_string_3_p_0(IndentStr_35, STATE_VARIABLE_State_0_49, &Var_139);
              mercury__string__builder__append_string_3_p_0((MR_String) "% modes for which this clause applies: ", Var_139, &STATE_VARIABLE_State_1_54);
  ...
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_35, STATE_VARIABLE_State_3_60, &Var_141);
    mercury__string__builder__append_string_3_p_0((MR_String) "% language of implementation: ", Var_141, &Var_142);
    mercury__string__builder__append_string_3_p_0(Var_77, Var_142, &Var_144);
    mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_144, &STATE_VARIABLE_State_6_73);
  }
  ...
  if (succeeded)
  {
    ...
    TypeInfo_146_146 = (MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[10]);
    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_146_146, ((MR_Box) (SelectedProcIds_44)), ((MR_Box) (AllProcIds_43)));
    succeeded = !(succeeded);
  }
  if (succeeded)
