...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1123__1_5_p_0(
  MR_Word VarSet_12,
...
static /* final */ const MR_Box hlds__hlds_out__hlds_out_pred_scalar_common_9[3][7];
...
static /* final */ const struct hlds__hlds_out__hlds_out_pred__vector_common_type_8_0_s hlds__hlds_out__hlds_out_pred_vector_common_8[54] = {
  ...
  /* row 31 */   {     (MR_String) "obsolete" },
  /* row 32 */   {     (MR_String) "no_determinism_warning" },
  /* row 33 */   {     (MR_String) "inline" },
  /* row 34 */   {     (MR_String) "no_inline" },
  /* row 35 */   {     (MR_String) "heuristic_inline" },
  /* row 36 */   {     (MR_String) "consider_used" },
  /* row 37 */   {     (MR_String) "class_method" },
  /* row 38 */   {     (MR_String) "class_instance_method" },
  /* row 39 */   {     (MR_String) "named_class_instance_method" },
  /* row 40 */   {     (MR_String) "impure" },
  /* row 41 */   {     (MR_String) "semipure" },
  /* row 42 */   {     (MR_String) "promise_pure" },
  /* row 43 */   {     (MR_String) "promise_semipure" },
  /* row 44 */   {     (MR_String) "promise_equivalent_clauses" },
  /* row 45 */   {     (MR_String) "terminates" },
  /* row 46 */   {     (MR_String) "does_not_terminate" },
  /* row 47 */   {     (MR_String) "check_termination" },
  /* row 48 */   {     (MR_String) "calls_are_fully_qualified" },
  /* row 49 */   {     (MR_String) "mode_check_clauses" },
  /* row 50 */   {     (MR_String) "mutable_access_pred" },
  /* row 51 */   {     (MR_String) "has_require_scope" },
  /* row 52 */   {     (MR_String) "has_incomplete_switch" },
  /* row 53 */   {     (MR_String) "has_format_call" },
};
...
{
  {
    ...
    MR_Word ProcTable_54;
    MR_Word ValidProcIds_55;
        ...
        case (MR_Integer) 1:
          {
            ...
            FuncRetType_34 = ((MR_Word) (conv0_FuncRetType_34));
            {
              ...
              MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (Module_16));
              MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (PredName_17));
            }
            parse_tree__parse_tree_out_pred_decl__mercury_output_func_type_11_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_60, FuncArgTypes_33, FuncRetType_34, (MR_Word) ((MR_Unsigned) 0U), Purity_28, ClassContext_25);
          }
          break;
        case (MR_Integer) 0:
          {
            ...
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_type_10_p_0(TVarSet_21, VarNamePrint_32, ExistQVars_20, Var_63, ArgTypes_19, (MR_Word) ((MR_Unsigned) 0U), Purity_28, ClassContext_25);
          }
          break;
      }
    succeeded = mercury__string__contains_char_2_p_0(DumpOptions_31, (MR_Char) 67);
    if (succeeded)
    {
      MR_Word VarSet_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo_22, (MR_Integer) 0))));
      MR_Word VarTypes_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo_22, (MR_Integer) 3))));
      MR_Word HeadVars_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo_22, (MR_Integer) 4))));
      MR_Word ClausesRep_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo_22, (MR_Integer) 5))));
      MR_Word RttiVarMaps_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo_22, (MR_Integer) 7))));
      MR_Integer PredIdInt_45;
      MR_String PredOrFuncStr_46;
      MR_String PredStatusStr_47;
      MR_Word GoalType_48;
      MR_Word Clauses_49;
      MR_Word Origin_53;
      MR_String Var_100;

      hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_13, &PredIdInt_45);
      PredOrFuncStr_46 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_18);
      PredStatusStr_47 = hlds__hlds_out__hlds_out_util__pred_import_status_to_string_1_f_0(PredStatus_23);
      hlds__hlds_pred__pred_info_get_goal_type_2_p_0(PredInfo_14, &GoalType_48);
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_12);
      mercury__io__write_string_3_p_0((MR_String) "% pred id: ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), PredIdInt_45, &Var_100);
      mercury__io__write_string_3_p_0(Var_100);
      mercury__io__write_string_3_p_0((MR_String) ", category: ");
      mercury__io__write_string_3_p_0(PredOrFuncStr_46);
      mercury__io__write_string_3_p_0((MR_String) ", status ");
      mercury__io__write_string_3_p_0(PredStatusStr_47);
      mercury__io__write_string_3_p_0((MR_String) "\n");
      mercury__io__write_string_3_p_0((MR_String) "% goal_type: ");
      mercury__io__write_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_goal_type_0), ((MR_Box) (GoalType_48)));
      mercury__io__write_string_3_p_0((MR_String) "\n");
      hlds__hlds_out__hlds_out_pred__write_pred_markers_3_p_0(Markers_24);
      hlds__hlds_out__hlds_out_pred__write_pred_types_11_p_0(Indent_12, VarSet_35, TVarSet_21, VarNamePrint_32, RttiVarMaps_42, ProofMap_26, ConstraintMap_27, ExternalTypeParams_29, VarTypes_38);
      hlds__hlds_out__hlds_out_pred__write_pred_proc_var_name_remap_5_p_0(Indent_12, VarSet_35, VarNameRemap_30);
      hlds__hlds_clauses__get_clause_list_maybe_repeated_2_p_0(ClausesRep_40, &Clauses_49);
      if (!((Clauses_49 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Word InfoForClauses_52;

        hlds__hlds_out__hlds_out_pred__set_dump_opts_for_clauses_2_p_0(Info_9, &InfoForClauses_52);
        hlds__hlds_out__hlds_out_pred__write_clauses_13_p_0(InfoForClauses_52, Lang_10, ModuleInfo_11, PredId_13, PredOrFunc_18, VarSet_35, (MR_Word) ((MR_Unsigned) 0U), VarNamePrint_32, Indent_12, HeadVars_39, Clauses_49);
      }
      hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo_14, &Origin_53);
      hlds__hlds_out__hlds_out_pred__write_origin_6_p_0(ModuleInfo_11, TVarSet_21, VarNamePrint_32, Origin_53);
    }
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo_14, &ProcTable_54);
    ValidProcIds_55 = hlds__hlds_pred__pred_info_procids_1_f_0(PredInfo_14);
    hlds__hlds_out__hlds_out_pred__write_procs_loop_10_p_0(Info_9, ModuleInfo_11, PredId_13, PredStatus_23, VarNamePrint_32, ProcTable_54, Indent_12, ValidProcIds_55);
    mercury__io__write_string_3_p_0((MR_String) "\n");
  }
}
...
{
  {
    ...
    Indent1_48 = (MR_Integer) ((MR_Unsigned) Indent_16 + (MR_Unsigned) 1);
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_13, &PredIdInt_50);
      hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_17, &ProcIdInt_51);
      PredIdStr_52 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(ModuleInfo_12, PredId_13);
      DetismStr_53 = parse_tree__prog_out__determinism_to_string_1_f_0(InferredDeterminism_26);
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent1_48);
      mercury__io__write_string_3_p_0((MR_String) "% pred id ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), PredIdInt_50, &Var_119);
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), ProcIdInt_51, &Var_133);
      ...
      hlds__hlds_out__hlds_out_pred__write_proc_flags_6_p_0(CanProcess_22, IsAddressTaken_40, HasParallelConj_41, HasUserEvent_42);
      hlds__hlds_out__hlds_out_pred__write_proc_tabling_info_8_p_0(VarSet_23, TVarSet_21, VarNamePrint_15, EvalMethod_38, MaybeProcTableIOInfo_43, MaybeCallTableTip_44);
      hlds__hlds_out__hlds_out_pred__write_proc_deep_profiling_info_5_p_0(VarSet_23, VarNamePrint_15, MaybeDeepProfileInfo_45);
      hlds__hlds_out__hlds_out_pred__write_proc_termination_info_5_p_0(DumpOptions_49, MaybeArgSize_33, MaybeTermination_34);
      hlds__hlds_out__hlds_out_pred__write_proc_opt_info_10_p_0(DumpOptions_49, Indent_16, VarSet_23, TVarSet_21, VarNamePrint_15, MaybeStructureSharing_35, MaybeStructureReuse_36, MaybeUntupleInfo_46);
      hlds__hlds_out__hlds_out_pred__write_proc_deleted_callee_set_3_p_0(DeletedCallCalleeSet_39);
      hlds__hlds_out__hlds_out_pred__write_pred_proc_var_name_remap_5_p_0(Indent_16, VarSet_23, VarNameRemap_47);
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
      Var_93 = hlds__hlds_module__predicate_name_2_f_0(ModuleInfo_12, PredId_13);
      {
        PredSymName_54 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), PredSymName_54, 0) = ((MR_Box) (Var_93));
      }
      PredOrFunc_55 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_20);
        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), HeadModes_28, &FuncHeadModes_58, &conv0_RetHeadMode_59);
            RetHeadMode_59 = ((MR_Word) (conv0_RetHeadMode_59));
            parse_tree__parse_tree_out_pred_decl__mercury_output_func_mode_decl_8_p_0((MR_Integer) 1, ModeVarSet_56, PredSymName_54, FuncHeadModes_58, RetHeadMode_59, DeclaredDeterminism_25);
          }
          break;
        case (MR_Integer) 0:
          {
            parse_tree__parse_tree_out_pred_decl__mercury_output_pred_mode_decl_8_p_0((MR_Integer) 1, ModeVarSet_56, PredSymName_54, HeadModes_28, (MR_Word) ((MR_Unsigned) 0U), DeclaredDeterminism_25);
          }
          break;
      }
      hlds__hlds_out__hlds_out_pred__write_proc_arg_info_9_p_0(DumpOptions_49, Indent_16, VarSet_23, VarNamePrint_15, MaybeArgLives_29, RegR_HeadVars_30, MaybeArgInfos_31);
      Var_99 = (MR_Word) (PredStatus_14);
      succeeded = (Var_99 == (MR_Word) ((MR_Unsigned) 8U));
      if (succeeded)
      {
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_115);
        succeeded = (ProcId_17 == Var_115);
      }
      if (!(succeeded))
      {
        ...
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        hlds__hlds_out__hlds_out_pred__write_stack_slots_6_p_0(VarSet_23, VarNamePrint_15, Indent_16, StackSlots_60);
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__term__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVars_27, &HeadTerms_61);
        hlds__hlds_out__hlds_out_pred__write_clause_head_8_p_0(ModuleInfo_12, VarSet_23, VarNamePrint_15, PredId_13, PredOrFunc_55, HeadTerms_61);
        mercury__io__write_string_3_p_0((MR_String) " :-\n");
...
{
  {
    ...
    if (!((DeletedCallCallees_6 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[7]), ((MR_Box) (DeletedCallCallees_6)));
      mercury__io__nl_2_p_0();
    }
  }
}
...
{
  {
    ...
    hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc_arg_info__1123__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    if (!((MaybeArgLives_14 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__print_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[5]), ((MR_Box) (ArgLives_18)));
      mercury__io__nl_2_p_0();
    }
    ...
    if (succeeded)
    {
      ...
      mercury__io__print_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[6]), ((MR_Box) (ArgInfos_19)));
      mercury__io__nl_2_p_0();
    }
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__parse_tree_out_pragma__write_maybe_arg_size_info_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[4]), (MR_Integer) 1, MaybeArgSize_7);
      mercury__io__nl_2_p_0();
      mercury__io__write_string_3_p_0((MR_String) "% Termination properties: ");
      parse_tree__parse_tree_out_pragma__write_maybe_termination_info_4_p_0((MR_Word) (&mercury__unit__unit__type_ctor_info_unit_0), (MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[4]), (MR_Integer) 1, MaybeTermination_8);
      mercury__io__nl_2_p_0();
    }
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo_85_85 = (MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[8]);
  ...
  MR_Word Origin_10)
{
  switch (MR_tag((MR_Word) Origin_10)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word MethodConstraints_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_10, (MR_Integer) 1))));
        MR_Word ClassId_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MethodConstraints_13, (MR_Integer) 0))));
        MR_Word InstanceTypes_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MethodConstraints_13, (MR_Integer) 1))));
        MR_Word InstanceConstraints_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MethodConstraints_13, (MR_Integer) 2))));
        MR_Word ClassMethodConstraints_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MethodConstraints_13, (MR_Integer) 3))));
        MR_Word ClassName_18;
        MR_Word MethodUnivConstraints_20;
        MR_Word MethodExistConstraints_21;
        MR_Word Var_98;
        MR_Word Var_104;

        mercury__io__write_string_3_p_0((MR_String) "% instance method constraints:\n");
        ClassName_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassId_14, (MR_Integer) 0))));
        {
          Var_98 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_98, 0) = ((MR_Box) (ClassName_18));
          MR_hl_field(MR_mktag(0), Var_98, 1) = ((MR_Box) (InstanceTypes_15));
        }
        parse_tree__mercury_to_mercury__mercury_output_constraint_5_p_0(TVarSet_8, VarNamePrint_9, Var_98);
        mercury__io__nl_2_p_0();
        mercury__io__write_string_3_p_0((MR_String) "instance constraints: ");
        {
          ...
          MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_104, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__write_origin_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_104, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_104, 3) = ((MR_Box) (TVarSet_8));
          MR_hl_field(MR_mktag(0), Var_104, 4) = ((MR_Box) (VarNamePrint_9));
        }
        mercury__io__write_list_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), InstanceConstraints_16, (MR_String) ", ", Var_104);
        mercury__io__nl_2_p_0();
        MethodUnivConstraints_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassMethodConstraints_17, (MR_Integer) 0))));
        MethodExistConstraints_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassMethodConstraints_17, (MR_Integer) 1))));
        mercury__io__write_string_3_p_0((MR_String) "method univ constraints: ");
        mercury__io__write_list_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), MethodUnivConstraints_20, (MR_String) ", ", Var_104);
        mercury__io__nl_2_p_0();
        mercury__io__write_string_3_p_0((MR_String) "method exist constraints: ");
        mercury__io__write_list_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), MethodExistConstraints_21, (MR_String) ", ", Var_104);
        mercury__io__nl_2_p_0();
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word Transformation_24 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_10, (MR_Integer) 0))));
        MR_Word OrigPredId_26 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_10, (MR_Integer) 2))));
        MR_Integer OrigPredIdNum_27;
        MR_String Var_134;

        OrigPredIdNum_27 = hlds__hlds_pred__pred_id_to_int_1_f_0(OrigPredId_26);
        mercury__io__write_string_3_p_0((MR_String) "% transformed from pred id ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[0]), OrigPredIdNum_27, &Var_134);
        mercury__io__write_string_3_p_0(Var_134);
        mercury__io__write_string_3_p_0((MR_String) "\n");
        mercury__io__write_string_3_p_0((MR_String) "% ");
        hlds__hlds_out__hlds_out_util__write_pred_id_4_p_0(ModuleInfo_7, OrigPredId_26);
        mercury__io__nl_2_p_0();
        mercury__io__write_string_3_p_0((MR_String) "% transformation: ");
        mercury__io__write_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_transformation_0), ((MR_Box) (Transformation_24)));
        mercury__io__nl_2_p_0();
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Creation_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 1))) & (MR_Integer) 1);

            mercury__io__write_string_3_p_0((MR_String) "% created: ");
            mercury__io__write_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_creation_0), ((MR_Box) (Creation_28)));
            mercury__io__nl_2_p_0();
          }
          break;
        case (MR_Integer) 1:
        ...
        case (MR_Integer) 3:
          {
            MR_Word TypeCtorSymName_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 1))));
            MR_Integer TypeCtorArity_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 2))));
            MR_Word SolverAuxPredKind_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 3))) & (MR_Integer) 3);
            MR_String TypeCtorStr_34;
            MR_String SolverAuxPredKindStr_35;
            MR_Word Var_67;

            {
              Var_67 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (TypeCtorSymName_31));
              MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (TypeCtorArity_32));
            }
            TypeCtorStr_34 = parse_tree__prog_out__sym_name_and_arity_to_string_1_f_0(Var_67);
            SolverAuxPredKindStr_35 = ((&hlds__hlds_out__hlds_out_pred_vector_common_8[12 + SolverAuxPredKind_33]))->hlds__hlds_out__hlds_out_pred__vector_common_type_8_0__vct_8_f_0;
            mercury__io__write_string_3_p_0((MR_String) "% ");
            mercury__io__write_string_3_p_0(SolverAuxPredKindStr_35);
            mercury__io__write_string_3_p_0((MR_String) " for ");
            mercury__io__write_string_3_p_0(TypeCtorStr_34);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Word BasePredCallId_36 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 1))));
            MR_Word TablingAuxPredKind_37 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_String BasePredStr_38;
            MR_String TablingAuxPredKindStr_39;

            BasePredStr_38 = parse_tree__prog_out__simple_call_id_to_string_1_f_0(BasePredCallId_36);
            switch (TablingAuxPredKind_37) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                TablingAuxPredKindStr_39 = (MR_String) "table reset predicate";
                break;
              case (MR_Integer) 0:
                TablingAuxPredKindStr_39 = (MR_String) "table statistics predicate";
                break;
            }
            mercury__io__write_string_3_p_0((MR_String) "% ");
            mercury__io__write_string_3_p_0(TablingAuxPredKindStr_39);
            mercury__io__write_string_3_p_0((MR_String) " for ");
            mercury__io__write_string_3_p_0(BasePredStr_38);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word MutableModuleName_40 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 1))));
            MR_String MutableName_41 = ((MR_String) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 2))));
            MR_Word MutablePredKind_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_10, (MR_Integer) 3))) & (MR_Integer) 15);
            MR_String MutableModuleNameStr_43;
            MR_String MutablePredKindStr_44;

            MutableModuleNameStr_43 = mdbcomp__sym_name__sym_name_to_string_1_f_0(MutableModuleName_40);
            MutablePredKindStr_44 = ((&hlds__hlds_out__hlds_out_pred_vector_common_8[0 + MutablePredKind_42]))->hlds__hlds_out__hlds_out_pred__vector_common_type_8_0__vct_8_f_0;
            mercury__io__write_string_3_p_0((MR_String) "% ");
            mercury__io__write_string_3_p_0(MutablePredKindStr_44);
            mercury__io__write_string_3_p_0((MR_String) " for mutable ");
            mercury__io__write_string_3_p_0(MutableName_41);
            mercury__io__write_string_3_p_0((MR_String) " in module ");
            mercury__io__write_string_3_p_0(MutableModuleNameStr_43);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
          break;
        case (MR_Integer) 6:
