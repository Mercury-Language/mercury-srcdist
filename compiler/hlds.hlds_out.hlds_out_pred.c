  ...
  MR_Word PredInfo_14)
{
  ...
  if (succeeded)
  {
    MR_Integer ProcId_152 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 0))));
    MR_Word ProcInfo_153 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 1))));

    hlds__hlds_out__hlds_out_pred__write_proc_10_p_0(Info_9, Stream_10, VarNamePrint_32, ModuleInfo_12, PredId_13, PredInfo_14, ProcId_152, ProcInfo_153);
