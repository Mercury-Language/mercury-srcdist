  ...
  MR_Word * STATE_VARIABLE_State_57)
{
  ...
  MR_Word MaybeStructureSharing_29;
  MR_Word MaybeStructureReuse_30;
  MR_Word RttiVarMaps_31;
  MR_Word CseNoPullContexts_32;
  MR_Word EvalMethod_33;
  MR_Word DeletedCallCalleeSet_34;
  MR_Word IsAddressTaken_35;
  MR_Word HasParallelConj_36;
  MR_Word HasUserEvent_37;
  MR_Word MaybeProcTableIOInfo_38;
  MR_Word MaybeCallTableTip_39;
  MR_Word MaybeDeepProfileInfo_40;
  MR_Word MaybeUntupleInfo_41;
  MR_Word VarNameRemap_42;
  MR_String Indent1Str_44;
  MR_Word DumpOptions_45;
  MR_Integer PredIdInt_46;
  MR_Integer ProcIdInt_47;
  MR_String PredIdStr_48;
  MR_String DetismStr_49;
  MR_Word DumpTermination_50;
  MR_Word PredStatus_51;
  MR_Word STATE_VARIABLE_State_1_60;
  MR_Word STATE_VARIABLE_State_2_69;
  MR_Word STATE_VARIABLE_State_3_76;
  MR_Word STATE_VARIABLE_State_4_77;
  MR_Word STATE_VARIABLE_State_5_78;
  MR_Word STATE_VARIABLE_State_6_81;
  MR_String Var_83;
  MR_Word STATE_VARIABLE_State_7_85;
  MR_Word STATE_VARIABLE_State_8_86;
  MR_Word STATE_VARIABLE_State_9_87;
  MR_Word STATE_VARIABLE_State_10_88;
  MR_Word STATE_VARIABLE_State_11_89;
  MR_Word Var_90;
  MR_Word STATE_VARIABLE_State_12_91;
  MR_Word STATE_VARIABLE_State_13_92;
  MR_Word STATE_VARIABLE_State_14_93;
  MR_Word STATE_VARIABLE_State_15_94;
  MR_Word Var_148;
  MR_Word Var_149;
  MR_Word Var_151;
  MR_String Var_152;
  ...
  hlds__hlds_proc__proc_info_get_structure_sharing_2_p_0(ProcInfo_16, &MaybeStructureSharing_29);
  hlds__hlds_proc__proc_info_get_structure_reuse_2_p_0(ProcInfo_16, &MaybeStructureReuse_30);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_16, &RttiVarMaps_31);
  hlds__hlds_proc__proc_info_get_cse_nopull_contexts_2_p_0(ProcInfo_16, &CseNoPullContexts_32);
  hlds__hlds_proc__proc_info_get_eval_method_2_p_0(ProcInfo_16, &EvalMethod_33);
  hlds__hlds_proc__proc_info_get_deleted_call_callees_2_p_0(ProcInfo_16, &DeletedCallCalleeSet_34);
  hlds__hlds_proc__proc_info_get_is_address_taken_2_p_0(ProcInfo_16, &IsAddressTaken_35);
  hlds__hlds_proc__proc_info_get_has_parallel_conj_2_p_0(ProcInfo_16, &HasParallelConj_36);
  hlds__hlds_proc__proc_info_get_has_user_event_2_p_0(ProcInfo_16, &HasUserEvent_37);
  hlds__hlds_proc__proc_info_get_maybe_proc_table_io_info_2_p_0(ProcInfo_16, &MaybeProcTableIOInfo_38);
  hlds__hlds_proc__proc_info_get_call_table_tip_2_p_0(ProcInfo_16, &MaybeCallTableTip_39);
  hlds__hlds_proc__proc_info_get_maybe_deep_profile_info_2_p_0(ProcInfo_16, &MaybeDeepProfileInfo_40);
  hlds__hlds_proc__proc_info_get_maybe_untuple_info_2_p_0(ProcInfo_16, &MaybeUntupleInfo_41);
  hlds__hlds_proc__proc_info_get_var_name_remap_2_p_0(ProcInfo_16, &VarNameRemap_42);
  Indent1Str_44 = libs__indent__indent2_string_1_f_0((MR_Unsigned) 1U);
  DumpOptions_45 = ((MR_Word) ((MR_hl_field(0, Info_10, 0))));
  hlds__pred_proc_id__pred_id_to_int_2_p_0(PredId_13, &PredIdInt_46);
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_15, &ProcIdInt_47);
  PredIdStr_48 = hlds__hlds_out__hlds_out_util__pred_id_to_dev_string_2_f_0(ModuleInfo_12, PredId_13);
  DetismStr_49 = parse_tree__parse_tree_out_misc__determinism_to_string_1_f_0(InferredDeterminism_21);
  mercury__string__builder__append_string_3_p_0(Indent1Str_44, STATE_VARIABLE_State_0_56, &Var_148);
  mercury__string__builder__append_string_3_p_0((MR_String) "% pred id ", Var_148, &Var_149);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_5[0]), PredIdInt_46, &Var_152);
  ...
  mercury__string__builder__append_string_3_p_0(PredIdStr_48, Var_159, &Var_161);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_161, &STATE_VARIABLE_State_1_60);
  mercury__string__builder__append_string_3_p_0(Indent1Str_44, STATE_VARIABLE_State_1_60, &Var_163);
  mercury__string__builder__append_string_3_p_0((MR_String) "% mode number ", Var_163, &Var_164);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_5[0]), ProcIdInt_47, &Var_167);
  mercury__string__builder__append_string_3_p_0(Var_167, Var_164, &Var_166);
  mercury__string__builder__append_string_3_p_0((MR_String) " (", Var_166, &Var_174);
  mercury__string__builder__append_string_3_p_0(DetismStr_49, Var_174, &Var_176);
  mercury__string__builder__append_string_3_p_0((MR_String) ")\n", Var_176, &STATE_VARIABLE_State_2_69);
  hlds__hlds_out__hlds_out_pred__format_var_types_5_p_0(VarNamePrint_11, TVarSet_18, VarTable_20, STATE_VARIABLE_State_2_69, &STATE_VARIABLE_State_3_76);
  hlds__hlds_out__hlds_out_pred__format_rtti_varmaps_6_p_0(VarNamePrint_11, TVarSet_18, VarTable_20, RttiVarMaps_31, STATE_VARIABLE_State_3_76, &STATE_VARIABLE_State_4_77);
  hlds__hlds_out__hlds_out_pred__format_proc_flags_6_p_0(CanProcess_19, IsAddressTaken_35, HasParallelConj_36, HasUserEvent_37, STATE_VARIABLE_State_4_77, &STATE_VARIABLE_State_5_78);
  Var_83 = mercury__string__string_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_4[4]), ((MR_Box) (CseNoPullContexts_32)));
  mercury__string__builder__append_string_3_p_0((MR_String) "% cse_nopull_contexts: ", STATE_VARIABLE_State_5_78, &Var_178);
  mercury__string__builder__append_string_3_p_0(Var_83, Var_178, &Var_180);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_180, &STATE_VARIABLE_State_6_81);
  hlds__hlds_out__hlds_out_pred__format_proc_tabling_info_8_p_0(VarTable_20, TVarSet_18, VarNamePrint_11, EvalMethod_33, MaybeProcTableIOInfo_38, MaybeCallTableTip_39, STATE_VARIABLE_State_6_81, &STATE_VARIABLE_State_7_85);
  hlds__hlds_out__hlds_out_pred__format_proc_deep_profiling_info_5_p_0(VarTable_20, VarNamePrint_11, MaybeDeepProfileInfo_40, STATE_VARIABLE_State_7_85, &STATE_VARIABLE_State_8_86);
  DumpTermination_50 = ((((MR_Unsigned) ((MR_hl_field(0, DumpOptions_45, 0))) >> 17)) & (MR_Integer) 1);
  switch (DumpTermination_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_State_9_87 = STATE_VARIABLE_State_8_86;
      break;
    case (MR_Integer) 1:
      hlds__hlds_out__hlds_out_pred__format_proc_termination_info_4_p_0(MaybeArgSize_27, MaybeTermination_28, STATE_VARIABLE_State_8_86, &STATE_VARIABLE_State_9_87);
      break;
  }
  hlds__hlds_out__hlds_out_pred__format_proc_opt_info_9_p_0(DumpOptions_45, VarTable_20, TVarSet_18, VarNamePrint_11, MaybeStructureSharing_29, MaybeStructureReuse_30, MaybeUntupleInfo_41, STATE_VARIABLE_State_9_87, &STATE_VARIABLE_State_10_88);
  hlds__hlds_out__hlds_out_pred__format_proc_deleted_callee_set_3_p_0(DeletedCallCalleeSet_34, STATE_VARIABLE_State_10_88, &STATE_VARIABLE_State_11_89);
  {
    Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_90, 0) = ((MR_Box) (VarTable_20));
  }
  hlds__hlds_out__hlds_out_pred__format_pred_proc_var_name_remap_4_p_0(Var_90, VarNameRemap_42, STATE_VARIABLE_State_11_89, &STATE_VARIABLE_State_12_91);
  hlds__hlds_out__hlds_out_pred__format_eff_trace_level_5_p_0(ModuleInfo_12, PredInfo_14, ProcInfo_16, STATE_VARIABLE_State_12_91, &STATE_VARIABLE_State_13_92);
  hlds__hlds_out__hlds_out_pred__format_proc_mode_line_5_p_0(PredInfo_14, ProcId_15, ProcInfo_16, STATE_VARIABLE_State_13_92, &STATE_VARIABLE_State_14_93);
  hlds__hlds_out__hlds_out_pred__format_proc_arg_info_8_p_0(DumpOptions_45, VarTable_20, VarNamePrint_11, MaybeArgLives_23, RegR_HeadVars_24, MaybeArgInfos_25, STATE_VARIABLE_State_14_93, &STATE_VARIABLE_State_15_94);
  hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo_14, &PredStatus_51);
  Var_95 = (MR_Word) (PredStatus_51);
  succeeded = (Var_95 == (MR_Word) ((MR_Unsigned) 8U));
  if (succeeded)
  {
    hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_147);
    succeeded = (ProcId_15 == Var_147);
  }
  if (succeeded)
    *STATE_VARIABLE_State_57 = STATE_VARIABLE_State_15_94;
  else
  {
    MR_Word StackSlots_52;
    MR_Word HeadTerms_53;
    MR_Word PredOrFunc_54;
    MR_Word InstVarSet_55;
    MR_Word STATE_VARIABLE_State_16_96;
    MR_Word STATE_VARIABLE_State_17_98;
    MR_Word STATE_VARIABLE_State_18_100;

    hlds__hlds_proc__proc_info_get_stack_slots_2_p_0(ProcInfo_16, &StackSlots_52);
    hlds__hlds_out__hlds_out_pred__format_stack_slots_5_p_0(VarTable_20, VarNamePrint_11, StackSlots_52, STATE_VARIABLE_State_15_94, &STATE_VARIABLE_State_16_96);
    mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVars_22, &HeadTerms_53);
    PredOrFunc_54 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_14);
    hlds__hlds_out__hlds_out_pred__format_clause_head_8_p_0(ModuleInfo_12, Var_90, VarNamePrint_11, PredId_13, PredOrFunc_54, HeadTerms_53, STATE_VARIABLE_State_16_96, &STATE_VARIABLE_State_17_98);
    mercury__string__builder__append_string_3_p_0((MR_String) " :-\n", STATE_VARIABLE_State_17_98, &STATE_VARIABLE_State_18_100);
    hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo_16, &InstVarSet_55);
    hlds__hlds_out__hlds_out_goal__format_goal_11_p_0(Info_10, ModuleInfo_12, Var_90, VarNamePrint_11, TVarSet_18, InstVarSet_55, (MR_Unsigned) 1U, (MR_String) ".\n", Goal_26, STATE_VARIABLE_State_18_100, STATE_VARIABLE_State_57);
  }
}
