  ...
  if (succeeded)
  {
    ...
    if (!((MaybeObsoleteInFavourOf_55 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_10, (MR_String) "% obsolete in favour of one of\n");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_92, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_7[1]));
    ...
    hlds__pred_name__write_origin_7_p_0(Stream_10, ModuleInfo_12, TVarSet_21, VarNamePrint_32, Origin_61);
  ...
  MR_Word HeadTerms_24)
{
  ...
  if (succeeded)
  {
    ...
    mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_1[2]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), HeadTerms_24, ArgModes_29, &AnnotatedPairs_30);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_7[0]));
