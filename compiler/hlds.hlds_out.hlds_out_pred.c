...
static void MR_CALL 
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc__1055__1_5_p_0(
...
{
  {
    ...
    hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__write_proc__1055__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = (MaybeStructureSharing_35 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
      ...
      if (succeeded)
      {
        succeeded = (MaybeStructureReuse_36 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
      ...
      if (!((MaybeDeepProfileInfo_45 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        if (!((MaybeRecInfo_67 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          {
            DeepPredProcId_73 = (MR_Word) ((MR_Word) (Role_71));
      ...
      if (succeeded)
      {
        succeeded = (MaybeArgInfos_31 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
