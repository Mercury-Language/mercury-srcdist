...
static /* final */ const MR_Box hlds__hlds_out__hlds_out_pred_scalar_common_4[4][5];

static /* final */ const MR_Box hlds__hlds_out__hlds_out_pred_scalar_common_5[1][4];
  ...
  MR_Word PredInfo_14)
{
  ...
  if (succeeded)
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), PredIdInt_52, &Var_142);
  ...
  MR_Word ProcInfo_18)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), ProcIdInt_51, &Var_140);
  ...
  MR_Word MaybeUntupleInfo_18)
{
  ...
  if (!((MaybeUntupleInfo_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_11, (MR_String) "% untuple:\n");
    {
      ...
      MR_hl_field(0, Var_40, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_pred_scalar_common_7[1]));
      MR_hl_field(0, Var_40, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_pred__write_proc_opt_info_10_p_0_1));
      MR_hl_field(0, Var_40, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(0, Var_40, 3) = ((MR_Box) (Stream_11));
      MR_hl_field(0, Var_40, 4) = ((MR_Box) (VarTable_13));
      MR_hl_field(0, Var_40, 5) = ((MR_Box) (VarNamePrint_15));
    }
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          ModeInts_39 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_2[3]), Modes_38);
  ...
  MR_Word Clauses_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), Mer_5, &Var_72);
    ...
    else
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), C_6, &Var_87);
    ...
    else
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), Cs_7, &Var_102);
    ...
    mercury__list__filter_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_5[0]), Var_31, &Var_14, &LangStrs_15);
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), Total_9, &Var_57);
  ...
  MR_Integer Count_5)
{
  ...
  else
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), Count_5, &Var_15);
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), OrigFmtStr_13, &Var_33);
      mercury__io__write_string_4_p_0(Stream_1, Var_33);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "/");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), CurFmtStr_15, &Var_43);
      mercury__io__write_string_4_p_0(Stream_1, Var_43);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) ", values in arg ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), OrigValues_14, &Var_53);
      mercury__io__write_string_4_p_0(Stream_1, Var_53);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "/");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_pred_scalar_common_3[0]), CurValues_16, &Var_63);
