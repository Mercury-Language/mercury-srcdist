    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) Origin_59)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_59, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Var_59)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_59, (MR_Integer) 0)))) == (MR_Integer) 2)));
    if (succeeded)
    {
