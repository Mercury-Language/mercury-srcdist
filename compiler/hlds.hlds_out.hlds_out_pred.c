...
hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__report_clause_count__311__1_2_p_0(
  ...
  MR_Word LambdaHeadVar__1_110)
{
  ...
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_138, &LambdaHeadVar__2_111);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv3_LambdaHeadVar__2_111 = hlds__hlds_out__hlds_out_pred__IntroducedFrom__func__format_pred__231__1_1_f_0(((MR_Word) (wrapper_arg_1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_100 = mercury__string__string_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_goal_type_0), ((MR_Box) (GoalType_55)));
  ...
  MR_Word * STATE_VARIABLE_State_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_10, &ProcIdInt_20);
      hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo_11, &InferredDeterminism_21);
      ...
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_11, &HeadModes_23);
      hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_11, &InstVarSet_24);
      hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo_11, &DeclaredDeterminism_25);
  ...
  MR_Word * STATE_VARIABLE_State_57)
{
  ...
  hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo_16, &InferredDeterminism_21);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_16, &HeadVars_22);
  hlds__hlds_pred__proc_info_get_maybe_arglives_2_p_0(ProcInfo_16, &MaybeArgLives_23);
  hlds__hlds_pred__proc_info_get_reg_r_headvars_2_p_0(ProcInfo_16, &RegR_HeadVars_24);
  hlds__hlds_pred__proc_info_get_maybe_arg_info_2_p_0(ProcInfo_16, &MaybeArgInfos_25);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_16, &Goal_26);
  hlds__hlds_pred__proc_info_get_maybe_arg_size_info_2_p_0(ProcInfo_16, &MaybeArgSize_27);
  hlds__hlds_pred__proc_info_get_maybe_termination_info_2_p_0(ProcInfo_16, &MaybeTermination_28);
  hlds__hlds_pred__proc_info_get_structure_sharing_2_p_0(ProcInfo_16, &MaybeStructureSharing_29);
  hlds__hlds_pred__proc_info_get_structure_reuse_2_p_0(ProcInfo_16, &MaybeStructureReuse_30);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_16, &RttiVarMaps_31);
  hlds__hlds_pred__proc_info_get_cse_nopull_contexts_2_p_0(ProcInfo_16, &CseNoPullContexts_32);
  hlds__hlds_pred__proc_info_get_eval_method_2_p_0(ProcInfo_16, &EvalMethod_33);
  hlds__hlds_pred__proc_info_get_deleted_call_callees_2_p_0(ProcInfo_16, &DeletedCallCalleeSet_34);
  hlds__hlds_pred__proc_info_get_is_address_taken_2_p_0(ProcInfo_16, &IsAddressTaken_35);
  hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(ProcInfo_16, &HasParallelConj_36);
  hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_16, &HasUserEvent_37);
  hlds__hlds_pred__proc_info_get_maybe_proc_table_io_info_2_p_0(ProcInfo_16, &MaybeProcTableIOInfo_38);
  hlds__hlds_pred__proc_info_get_call_table_tip_2_p_0(ProcInfo_16, &MaybeCallTableTip_39);
  hlds__hlds_pred__proc_info_get_maybe_deep_profile_info_2_p_0(ProcInfo_16, &MaybeDeepProfileInfo_40);
  hlds__hlds_pred__proc_info_get_maybe_untuple_info_2_p_0(ProcInfo_16, &MaybeUntupleInfo_41);
  hlds__hlds_pred__proc_info_get_var_name_remap_2_p_0(ProcInfo_16, &VarNameRemap_42);
  Indent1Str_44 = libs__indent__indent2_string_1_f_0((MR_Unsigned) 1U);
  DumpOptions_45 = ((MR_Word) ((MR_hl_field(0, Info_10, 0))));
  hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_13, &PredIdInt_46);
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_15, &ProcIdInt_47);
  ...
  if (succeeded)
  {
    hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_147);
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_stack_slots_2_p_0(ProcInfo_16, &StackSlots_52);
    ...
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_16, &InstVarSet_55);
  ...
  MR_Word * STATE_VARIABLE_State_24)
{
  ...
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_12);
  hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo_8, &InferredDeterminism_13);
  ...
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_8, &HeadModes_15);
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_8, &InstVarSet_16);
  hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo_8, &DeclaredDeterminism_17);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__hlds_out__hlds_out_pred__IntroducedFrom__pred__report_clause_count__311__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
  return succeeded;
}
