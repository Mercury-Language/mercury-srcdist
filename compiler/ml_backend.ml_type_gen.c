                ...
                case (MR_Integer) 0:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_79, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                      MR_hl_field(MR_mktag(3), Var_79, 1) = ((MR_Box) (Int_30));
                      MR_hl_field(MR_mktag(3), Var_79, 2) = ((MR_Box) (MLDS_Type_6));
                    }
                    {
                      ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(3), ConstRval_16, 1) = ((MR_Box) (Var_79));
                    }
                  }
                  break;
                case (MR_Integer) 1:
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_76, 1) = ((MR_Box) (Lang_40));
                MR_hl_field(MR_mktag(3), Var_76, 2) = ((MR_Box) (String_41));
                ...
                case (MR_Integer) 0:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_81, 1) = ((MR_Box) (Int_32));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_78, 1) = ((MR_Box) (Lang_42));
                MR_hl_field(MR_mktag(3), Var_78, 2) = ((MR_Box) (String_43));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 274, &HighLevelData_8);
