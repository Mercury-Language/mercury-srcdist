        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), Var_70, 2) = ((MR_Box) (MLDS_Type_6));
            }
            {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_66, 1) = ((MR_Box) (Int_27));
                MR_hl_field(MR_mktag(3), Var_66, 2) = ((MR_Box) (MLDS_Type_6));
              }
              {
                ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(MR_mktag(3), ConstRval_16, 1) = ((MR_Box) (Var_66));
              }
            }
            break;
          case (MR_Integer) 1:
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_69, 1) = (MR_Box) ((MR_Unsigned) (Lang_37));
              MR_hl_field(MR_mktag(3), Var_69, 2) = ((MR_Box) (String_38));
              MR_hl_field(MR_mktag(3), Var_69, 3) = ((MR_Box) (MLDS_Type_6));
            }
            {
              ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(MR_mktag(3), ConstRval_16, 1) = ((MR_Box) (Var_69));
            }
          }
          break;
      }
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_74, 2) = ((MR_Box) (MLDS_Type_6));
            }
            {
              ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          ...
          case (MR_Integer) 0:
            {
...

              {
                Var_70 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_70, 0) = ((MR_Box) ((MR_Unsigned) 9U));
                MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) (Int_31));
                MR_hl_field(MR_mktag(3), Var_70, 2) = ((MR_Box) (MLDS_Type_6));
              }
              {
                ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_73, 1) = (MR_Box) ((MR_Unsigned) (Lang_41));
              MR_hl_field(MR_mktag(3), Var_73, 2) = ((MR_Box) (String_42));
