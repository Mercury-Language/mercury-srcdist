...
ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1068__1_2_p_0(
  MR_Integer Arity_13,
  MR_Integer HeadVar__2_22);

static MR_bool MR_CALL 
ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_enum_constant__340__1_2_p_0(
  MR_Integer Arity_13,
  MR_Integer HeadVar__2_21);
...
{
  {
    MR_bool succeeded = (Arity_13 == HeadVar__2_22);
...
{
  {
    MR_bool succeeded = (Arity_13 == HeadVar__2_21);
...
{
  {
    ...
    succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1068__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
  ...
  MR_Word * ExportConstant_8)
{
  {
    MR_bool succeeded;
    MR_Word QualSymName_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 1)));
    MR_Word ConsTag_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 2)));
    MR_Integer Arity_13 = ((MR_Integer) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 4)));
    MR_Word ConstRval_15;
    MR_String Name_16;
    MR_Word UnqualSymName_17;
    MR_String ForeignName_18;
    MR_Word Var_19;
    MR_Word Var_23;
    MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 0)));
    MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 3)));
    MR_Word Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_7, (MR_Integer) 5)));
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (Arity_13));
    ...
    switch (MR_tag((MR_Word) ConsTag_11)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntTag_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 1)));

              switch (MR_tag((MR_Word) IntTag_30)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Integer Int_31 = ((MR_Integer) (MR_hl_field(MR_mktag(0), IntTag_30, (MR_Integer) 0)));
                    MR_Word Var_75;

                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (Int_31));
                      MR_hl_field(MR_mktag(3), Var_75, 2) = ((MR_Box) (MLDS_Type_6));
                    }
                    {
                      ConstRval_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ConstRval_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(3), ConstRval_15, 1) = ((MR_Box) (Var_75));
                    }
                  }
                  break;
                case (MR_Integer) 1:
          ...
          case (MR_Integer) 1:
            {
              MR_Word Lang_41 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 1)));
              MR_String String_42 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 2)));
              MR_Word Var_72;

              {
                Var_72 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_72, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                MR_hl_field(MR_mktag(3), Var_72, 1) = ((MR_Box) (Lang_41));
                MR_hl_field(MR_mktag(3), Var_72, 2) = ((MR_Box) (String_42));
                MR_hl_field(MR_mktag(3), Var_72, 3) = ((MR_Box) (MLDS_Type_6));
              }
              {
                ConstRval_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConstRval_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ConstRval_15, 1) = ((MR_Box) (Var_72));
              }
            }
            break;
          case (MR_Integer) 2:
    ...
    Name_16 = mdbcomp__sym_name__unqualify_name_1_f_0(QualSymName_10);
    {
      UnqualSymName_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualSymName_17, 0) = ((MR_Box) (Name_16));
    }
    mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Mapping_5, ((MR_Box) (UnqualSymName_17)), &conv0_ForeignName_18);
    ForeignName_18 = ((MR_String) conv0_ForeignName_18);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) (ConstRval_15));
    }
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word CtorRepns_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExportedEnumInfo_3, (MR_Integer) 4)));
    ...
    ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_7, &QualifiedClassName_10, &MLDS_ClassArity_11);
    {
    ...
    mercury__list__map_3_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_exported_enum_constant_0, Var_16, CtorRepns_9, &ExportConstants_13);
    {
      MR_Word base;
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Defn_19, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[7]));
...
{
  {
    ...
    succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_enum_constant__340__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_4[2]));
      MR_hl_field(MR_mktag(0), Var_18, 1) = ((MR_Box) (ml_backend__ml_type_gen__ml_gen_hld_enum_constant_3_f_0_1));
      MR_hl_field(MR_mktag(0), Var_18, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_18, 3) = ((MR_Box) (Arity_13));
      MR_hl_field(MR_mktag(0), Var_18, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_3_p_0(Var_18, (MR_String) "function \140ml_backend.ml_type_gen.ml_gen_hld_enum_constant\'/3", (MR_String) "arity != []");
    switch (MR_tag((MR_Word) ConsTag_11)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    {
      VarName_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), VarName_17, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(3), VarName_17, 1) = ((MR_Box) (Name_16));
    }
    {
      Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) (ConstRval_15));
    }
    {
      FieldVarDefn_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 0) = ((MR_Box) (VarName_17));
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 1) = ((MR_Box) (Context_5));
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[7]));
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 4) = ((MR_Box) (Var_24));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MLDS_ClassName_54 = ((MR_String) (MR_hl_field(MR_mktag(0), QualifiedClassName_50, (MR_Integer) 2)));
                    {
                      ...
                      MR_hl_field(MR_mktag(0), ValueMember_55, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[5]));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), TagVarMember_26, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[5]));
...
{
  {
    ...
    MLDS_ClassName_19 = ((MR_String) (MR_hl_field(MR_mktag(0), QualifiedClassName_15, (MR_Integer) 2)));
    {
      ...
      MR_hl_field(MR_mktag(0), ValueMember_20, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[5]));
...
{
  {
    return (MR_Word) &ml_backend__ml_type_gen_scalar_common_2[4];
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), CtorDefn_18, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[4]));
