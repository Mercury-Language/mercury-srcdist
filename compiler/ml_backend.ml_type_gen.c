...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), LocalVarName_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
  ...
  MR_Integer * STATE_VARIABLE_NumSecTagCtors_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = Ctors_19;
        MR_Integer next_value_of_STATE_VARIABLE_NumCtors_0_4 = STATE_VARIABLE_NumCtors_26_26;
        MR_Integer next_value_of_STATE_VARIABLE_NumSecTagCtors_0_6 = STATE_VARIABLE_NumSecTagCtors_28_28;
