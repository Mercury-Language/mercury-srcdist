          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_80, 0) = ((MR_Box) ((MR_Unsigned) 9U));
                MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (Int_34));
                MR_hl_field(MR_mktag(3), Var_80, 2) = ((MR_Box) (MLDS_Type_6));
              }
              {
                ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(MR_mktag(3), ConstRval_16, 1) = ((MR_Box) (Var_80));
              }
            }
            break;
          case (MR_Integer) 1:
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_77, 1) = (MR_Box) ((MR_Unsigned) (Lang_44));
              MR_hl_field(MR_mktag(3), Var_77, 2) = ((MR_Box) (String_45));
              MR_hl_field(MR_mktag(3), Var_77, 3) = ((MR_Box) (MLDS_Type_6));
            }
            {
              ConstRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ConstRval_16, 0) = ((MR_Box) ((MR_Unsigned) 1U));
