            ...
            case (MR_Integer) 0:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_78, 1) = ((MR_Box) (Int_30));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (Lang_40));
                MR_hl_field(MR_mktag(3), Var_75, 2) = ((MR_Box) (String_41));
            ...
            case (MR_Integer) 0:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (Int_32));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (Lang_42));
                MR_hl_field(MR_mktag(3), Var_77, 2) = ((MR_Box) (String_43));
