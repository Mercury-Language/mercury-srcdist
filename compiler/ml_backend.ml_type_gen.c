...
ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1088__1_2_p_0(
  MR_Integer Arity_14,
  MR_Integer HeadVar__2_22);

static MR_bool MR_CALL 
ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_du_ctor_member__647__1_2_p_0(
  MR_Word UnconstrainedTVarsEC_45,
  MR_Word UnconstrainedTVars_48);

static MR_bool MR_CALL 
ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_enum_constant__336__1_2_p_0(
  MR_Integer Arity_14,
  MR_Integer HeadVar__2_22);
...
static /* final */ const MR_Box ml_backend__ml_type_gen_scalar_common_5[6][1];
...
{
  {
    ...
    succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1088__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
      MLDS_Type_34 = (MR_Word) ((MR_Unsigned) 20U);
    else
...
{
  {
    ...
    if (succeeded)
      MLDS_Type_32 = (MR_Word) ((MR_Unsigned) 20U);
    else
...
{
  {
    ...
    succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_du_ctor_member__647__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (ConstValue_19));
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Defn_20, 2) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_5[2]));
        MR_hl_field(MR_mktag(0), Defn_20, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_type_gen_scalar_common_2[5])));
        MR_hl_field(MR_mktag(0), Defn_20, 4) = ((MR_Box) (Var_25));
...
{
  {
    ...
    succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__ml_gen_hld_enum_constant__336__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) ConsTag_12)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word IntTag_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ConsTag_12, (MR_Integer) 0))));

          switch (MR_tag((MR_Word) IntTag_32)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Integer Int_33 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntTag_32, (MR_Integer) 0))));
                MR_Word Var_79;

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_79, 1) = ((MR_Box) (Int_33));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsTag_12, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Lang_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsTag_12, (MR_Integer) 1))) & (MR_Integer) 3);
              MR_String String_44 = ((MR_String) ((MR_hl_field(MR_mktag(3), ConsTag_12, (MR_Integer) 2))));
              MR_Word Var_76;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_76, 1) = (MR_Box) ((MR_Unsigned) (Lang_43));
                MR_hl_field(MR_mktag(3), Var_76, 2) = ((MR_Box) (String_44));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (ConstRval_16));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FieldVarDefn_8, 4) = ((MR_Box) (Var_26));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), TagVarMember_26, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_type_gen_scalar_common_2[5])));
    ...
    {
      Var_55 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (ml_backend__ml_type_gen__ml_gen_hld_du_type_8_p_0_1));
      MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) ((MR_Integer) 7));
      MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (ModuleInfo_9));
      MR_hl_field(MR_mktag(0), Var_55, 4) = ((MR_Box) (Target_10));
      MR_hl_field(MR_mktag(0), Var_55, 5) = ((MR_Box) (BaseClassId_19));
      MR_hl_field(MR_mktag(0), Var_55, 6) = ((MR_Box) (BaseClassQualifier_23));
      MR_hl_field(MR_mktag(0), Var_55, 7) = ((MR_Box) (TagClassId_31));
      MR_hl_field(MR_mktag(0), Var_55, 8) = ((MR_Box) (TypeCtor_11));
      MR_hl_field(MR_mktag(0), Var_55, 9) = ((MR_Box) (TypeDefn_12));
    }
    mercury__list__foldl3_8_p_0((MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0), (MR_Word) (&ml_backend__ml_type_gen_scalar_common_2[1]), (MR_Word) (&ml_backend__ml_type_gen_scalar_common_2[0]), (MR_Word) (&ml_backend__ml_type_gen_scalar_common_2[2]), Var_55, CtorRepns_13, ((MR_Box) ((MR_Unsigned) 0U)), &conv5_CtorMemberFields_33, ((MR_Box) ((MR_Unsigned) 0U)), &conv4_CtorMemberClasses_34, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_BaseClassCtorMethods_35);
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_59 = ml_backend__ml_code_util__ml_java_mercury_type_interface_0_f_0();
          {
            Implements_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Implements_38, 0) = ((MR_Box) (Var_59));
    ...
    Var_61 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), TagFieldVarMembers_29, CtorMemberFields_33);
    MemberFields_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), MaybeEqualityMembers_14, Var_61);
...
{
  {
    ...
    MLDS_ClassName_19 = ((MR_String) ((MR_hl_field(MR_mktag(0), QualifiedClassName_15, (MR_Integer) 2))));
    {
      ...
      MR_hl_field(MR_mktag(0), ValueMember_20, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_type_gen_scalar_common_2[5])));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&ml_backend__ml_type_gen_scalar_common_1[0]), (MR_Word) (&ml_backend__ml_type_gen_scalar_common_2[0]), Var_10, TypeCtorDefns_9, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_Defns_6);
