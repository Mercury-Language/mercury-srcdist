...
static MR_bool MR_CALL 
ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1303__1_2_p_0(
  MR_Integer ml_backend__ml_type_gen__Arity_18,
  MR_Integer ml_backend__ml_type_gen__HeadVar__2_76);
...
ml_backend__ml_type_gen__generate_foreign_enum_constant_7_p_0(
  ...
  MR_Word ml_backend__ml_type_gen__STATE_VARIABLE_ExportConstants_0_66,
  MR_Word * ml_backend__ml_type_gen__STATE_VARIABLE_ExportConstants_67);
...
{
  {
    MR_bool ml_backend__ml_type_gen__succeeded = (ml_backend__ml_type_gen__Arity_18 == ml_backend__ml_type_gen__HeadVar__2_76);
...
{
  {
    MR_bool ml_backend__ml_type_gen__succeeded = (ml_backend__ml_type_gen__Arity_17 == ml_backend__ml_type_gen__HeadVar__2_71);
...
{
  {
    ...
    {
      ml_backend__ml_type_gen__succeeded = ml_backend__ml_type_gen__IntroducedFrom__pred__generate_foreign_enum_constant__1303__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__closure, (MR_Integer) 4))));
    }
    return ml_backend__ml_type_gen__succeeded;
  }
}
...
{
  {
    ...
    MR_String ml_backend__ml_type_gen__UnqualName_62;
    MR_Word ml_backend__ml_type_gen__UnqualSymName_63;
    MR_String ml_backend__ml_type_gen__ForeignName_64;
    MR_Word ml_backend__ml_type_gen__ExportConstant_65;
    ...
    MR_Box ml_backend__ml_type_gen__conv1_ForeignName_64;

    {
      ml_backend__ml_type_gen__Var_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_68, 1) = ((MR_Box) (ml_backend__ml_type_gen__QualName_16));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_68, 2) = ((MR_Box) (ml_backend__ml_type_gen__Arity_18));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_68, 3) = ((MR_Box) (ml_backend__ml_type_gen__TypeCtor_8));
    }
    {
      mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ml_backend__ml_type_gen__TagValues_10, ((MR_Box) (ml_backend__ml_type_gen__Var_68)), &ml_backend__ml_type_gen__conv0_TagVal_20);
    }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ml_backend__ml_type_gen__Var_72 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_72, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_72, 1) = ((MR_Box) (ml_backend__ml_type_gen__Int_21));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_72, 2) = ((MR_Box) (ml_backend__ml_type_gen__MLDS_Type_11));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_22, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_72));
              }
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 8:
            {
              ...
              {
                ml_backend__ml_type_gen__Var_71 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_71, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 11));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_71, 1) = ((MR_Box) (ml_backend__ml_type_gen__Lang_23));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_71, 2) = ((MR_Box) (ml_backend__ml_type_gen__String_24));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_71, 3) = ((MR_Box) (ml_backend__ml_type_gen__MLDS_Type_11));
              }
              {
                ml_backend__ml_type_gen__ConstValue_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_22, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_71));
              }
            }
            break;
        }
    ...
    {
      ml_backend__ml_type_gen__Var_73 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_4[2]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 1) = ((MR_Box) (ml_backend__ml_type_gen__generate_foreign_enum_constant_7_p_0_1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 3) = ((MR_Box) (ml_backend__ml_type_gen__Arity_18));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      mercury__require__expect_3_p_0(ml_backend__ml_type_gen__Var_73, (MR_String) "predicate \140ml_backend.ml_type_gen.generate_foreign_enum_constant\'/7", (MR_String) "enum constant arity != 0");
    }
    {
      ml_backend__ml_type_gen__UnqualName_62 = mdbcomp__sym_name__unqualify_name_1_f_0(ml_backend__ml_type_gen__QualName_16);
    }
    {
      ml_backend__ml_type_gen__UnqualSymName_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__UnqualSymName_63, 0) = ((MR_Box) (ml_backend__ml_type_gen__UnqualName_62));
    }
    {
      mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, ml_backend__ml_type_gen__Mapping_9, ((MR_Box) (ml_backend__ml_type_gen__UnqualSymName_63)), &ml_backend__ml_type_gen__conv1_ForeignName_64);
    }
    ml_backend__ml_type_gen__ForeignName_64 = ((MR_String) ml_backend__ml_type_gen__conv1_ForeignName_64);
    {
    ...
    {
      ml_backend__ml_type_gen__ExportConstant_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__ExportConstant_65, 0) = ((MR_Box) (ml_backend__ml_type_gen__ForeignName_64));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__ExportConstant_65, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_77));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_type_gen__STATE_VARIABLE_ExportConstants_67 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_type_gen__ExportConstant_65));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_type_gen__STATE_VARIABLE_ExportConstants_0_66));
    }
  }
}
...
{
  {
    ...
    {
      ml_backend__ml_type_gen__DataName_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__DataName_33, 0) = ((MR_Box) (ml_backend__ml_type_gen__FieldVarName_32));
    }
    {
...
{
  {
    ...
    {
      ml_backend__ml_type_gen__DataName_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__DataName_34, 0) = ((MR_Box) (ml_backend__ml_type_gen__FieldVarName_33));
    }
    {
...
{
  {
    ...
    {
      ml_backend__ml_type_gen__DataName_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__DataName_32, 0) = ((MR_Box) (ml_backend__ml_type_gen__FieldVarName_31));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), ml_backend__ml_type_gen__Param_25, 0) = ((MR_Box) (ml_backend__ml_type_gen__Var_32));
    }
    {
      ml_backend__ml_type_gen__Var_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  ml_backend__ml_type_gen__MLDS_ReservedObjDataName_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__MLDS_ReservedObjDataName_41, 0) = ((MR_Box) (ml_backend__ml_type_gen__MLDS_ReservedObjName_40));
                }
                {
                ...
                if (!((ml_backend__ml_type_gen__env).ml_backend__ml_type_gen__ml_gen_hld_du_ctor_member_12_p_0_env_0__succeeded))
                  {
                    ...
                    (ml_backend__ml_type_gen__env).ml_backend__ml_type_gen__ml_gen_hld_du_ctor_member_12_p_0_env_0__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_type_gen__TagVal_35)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__TagVal_35, (MR_Integer) 0)))) == (MR_Integer) 23)));
                    if ((ml_backend__ml_type_gen__env).ml_backend__ml_type_gen__ml_gen_hld_du_ctor_member_12_p_0_env_0__succeeded)
                      {
    ...
    if (ml_backend__ml_type_gen__succeeded)
      {
        ml_backend__ml_type_gen__SecondaryTag_11 = ((MR_Integer) (MR_hl_field(MR_mktag(1), ml_backend__ml_type_gen__Var_35, (MR_Integer) 0)));
        {
          ...
          {
            ml_backend__ml_type_gen__Var_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_type_gen__Var_23, 0) = ((MR_Box) (ml_backend__ml_type_gen__SecondaryTag_11));
          }
          {
          ...
          {
            ml_backend__ml_type_gen__Var_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_24, 0) = ((MR_Box) (ml_backend__ml_type_gen__VarName_19));
          }
          {
...
{
  {
    ...
    MR_String ml_backend__ml_type_gen__UnqualifiedName_61;
    MR_Word ml_backend__ml_type_gen__VarName_62;
    ...
    {
      ml_backend__ml_type_gen__Var_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_63, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_63, 1) = ((MR_Box) (ml_backend__ml_type_gen__Name_15));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_63, 2) = ((MR_Box) (ml_backend__ml_type_gen__Arity_17));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_63, 3) = ((MR_Box) (ml_backend__ml_type_gen__TypeCtor_8));
    }
    {
      mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ml_backend__ml_type_gen__ConsTagValues_9, ((MR_Box) (ml_backend__ml_type_gen__Var_63)), &ml_backend__ml_type_gen__conv0_TagVal_19);
    }
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_67, 1) = ((MR_Box) (ml_backend__ml_type_gen__Int_20));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_67, 2) = ((MR_Box) (ml_backend__ml_type_gen__MLDS_Type_10));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_21, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_67));
              }
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 8:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_66, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 11));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_66, 1) = ((MR_Box) (ml_backend__ml_type_gen__ForeignLang_22));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_66, 2) = ((MR_Box) (ml_backend__ml_type_gen__ForeignTagValue_23));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_66, 3) = ((MR_Box) (ml_backend__ml_type_gen__MLDS_Type_10));
              }
              {
                ml_backend__ml_type_gen__ConstValue_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__ConstValue_21, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_66));
              }
            }
            break;
        }
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_68, 1) = ((MR_Box) (ml_backend__ml_type_gen__ml_gen_hld_enum_constant_5_f_0_1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_68, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_68, 3) = ((MR_Box) (ml_backend__ml_type_gen__Arity_17));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_68, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      mercury__require__expect_3_p_0(ml_backend__ml_type_gen__Var_68, (MR_String) "function \140ml_backend.ml_type_gen.ml_gen_hld_enum_constant\'/5", (MR_String) "arity != []");
    }
    {
      ml_backend__ml_type_gen__UnqualifiedName_61 = mdbcomp__sym_name__unqualify_name_1_f_0(ml_backend__ml_type_gen__Name_15);
    }
    {
      ml_backend__ml_type_gen__Var_72 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_72, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_72, 1) = ((MR_Box) (ml_backend__ml_type_gen__UnqualifiedName_61));
    }
    {
      ml_backend__ml_type_gen__VarName_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__VarName_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__VarName_62, 1) = ((MR_Box) (ml_backend__ml_type_gen__Var_72));
    }
    {
      ml_backend__ml_type_gen__Var_74 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_74, 0) = ((MR_Box) (ml_backend__ml_type_gen__VarName_62));
    }
    {
      ml_backend__ml_type_gen__Var_75 = ml_backend__mlds__init_data_decl_flags_3_f_0((MR_Integer) 0, (MR_Integer) 0, (MR_Integer) 1);
    }
    {
      ml_backend__ml_type_gen__Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_type_gen__Var_77, 0) = ((MR_Box) (ml_backend__ml_type_gen__ConstValue_21));
    }
    {
      ml_backend__ml_type_gen__Var_73 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 0) = ((MR_Box) (ml_backend__ml_type_gen__Var_74));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 1) = ((MR_Box) (ml_backend__ml_type_gen__Context_7));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 2) = ((MR_Box) (ml_backend__ml_type_gen__Var_75));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 4) = ((MR_Box) (ml_backend__ml_type_gen__Var_77));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_73, 5) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ml_backend__ml_type_gen__Defn_12 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_type_gen__Var_73);
    ...
    if (ml_backend__ml_type_gen__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_6[3]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_29, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_2[5]));
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if (((((MR_tag((MR_Word) ml_backend__ml_type_gen__HeadVar__1_1)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__HeadVar__1_1, (MR_Integer) 0)))) == (MR_Integer) 22))))
          {
            *ml_backend__ml_type_gen__RA_2 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__HeadVar__1_1, (MR_Integer) 1)));
            ml_backend__ml_type_gen__succeeded = MR_TRUE;
          }
        else
        if (((((MR_tag((MR_Word) ml_backend__ml_type_gen__HeadVar__1_1)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__HeadVar__1_1, (MR_Integer) 0)))) == (MR_Integer) 23))))
          {
...
{
  {
    ...
    {
      ml_backend__ml_type_gen__Var_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 0) = ((MR_Box) (&ml_backend__ml_type_gen_scalar_common_6[2]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 1) = ((MR_Box) (ml_backend__ml_type_gen__Context_16));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 2) = ((MR_Box) (ml_backend__ml_type_gen__Var_54));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
      MR_hl_field(MR_mktag(0), ml_backend__ml_type_gen__Var_50, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        ...
        switch (MR_tag((MR_Word) ml_backend__ml_type_gen__Tag_3)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Tag_3, (MR_Integer) 0)))) {
              ...
              case (MR_Integer) 14:
                {
                  MR_Word ml_backend__ml_type_gen__SubTag_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Tag_3, (MR_Integer) 2)));
                  ...
                  /* direct tailcall eliminated */
                  {
                    MR_Word ml_backend__ml_type_gen__next_value_of_Tag_3 = ml_backend__ml_type_gen__SubTag_44;
...
{
  {
    ...
    if ((ml_backend__ml_type_gen__MaybeTag_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          ml_backend__ml_type_gen__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_type_gen__Var_68, 0) = ((MR_Box) (ml_backend__ml_type_gen__TagVal_22));
        }
        {
          ml_backend__ml_type_gen__Val_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Val_64, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_type_gen__Var_71, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
