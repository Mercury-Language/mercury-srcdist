                                                  ...
                                                  else
                                                  {
                                                    ...
                                                    else
                                                    {
                                                      ...
                                                      else
                                                      {
                                                        ...
                                                        parse_tree__prog_data_used_modules____Compare____used_modules_0_0(&SubResult27_84, ArgX27_82, ArgY27_83);
                                                ...
                                                if (succeeded)
                                                {
                                                  ...
                                                  if (succeeded)
                                                  {
                                                    ...
                                                    if (succeeded)
                                                    {
                                                      ...
                                                      if (succeeded)
                                                      {
                                                        succeeded = parse_tree__prog_data_used_modules____Unify____used_modules_0_0(ArgX27_55, ArgY27_56);
                                                        if (succeeded)
                                                        {
  ...
  MR_Word * STATE_VARIABLE_MI_9)
{
  ...
  UsedModules0_6 = ((MR_Word) ((MR_hl_field(0, Var_11, 25))));
