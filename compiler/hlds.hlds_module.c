  ...
  MR_Word * STATE_VARIABLE_MI_9)
{
  ...
  Modules0_6 = ((MR_Word) ((MR_hl_field(0, Var_11, (MR_Integer) 25))));
  ...
  MR_Word * STATE_VARIABLE_MI_25)
{
  ...
  packed_word_1 = (MR_Unsigned) ((MR_hl_field(0, Var_30, (MR_Integer) 10)));
  ...
  MR_Word * ModuleInfo_22)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_92 = ((MR_Word) ((MR_hl_field(3, Var_91, (MR_Integer) 0))));
