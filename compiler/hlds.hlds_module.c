...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) Var_135)) == (MR_Integer) 2);
      if (succeeded)
      {
        Var_136 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_135, (MR_Integer) 0))));
    ...
    CtorTable_99 = hlds__hlds_cons__init_cons_table_0_f_0();
