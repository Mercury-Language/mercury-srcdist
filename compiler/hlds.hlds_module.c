...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__term____Compare____context_0_0(&Var_15, ArgX2_6, ArgY2_7);
        succeeded = (Var_15 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
          *HeadVar__1_1 = Var_15;
        else
        {
          ...
          else
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &hlds__hlds_module_scalar_common_1[12], HeadVar__1_1, ((MR_Box) (ArgX5_12)), ((MR_Box) (ArgY5_13)));
            }
          }
        }
      }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_18_18 = (MR_Word) &hlds__hlds_module_scalar_common_1[12];
