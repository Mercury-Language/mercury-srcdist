        ...
        else
        {
          ...
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
            ...
            mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_module_scalar_common_2[15]), HeadVar__1_1, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
        }
      }
    }
  }
...
{
  {
    ...
    Var_97 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module_scalar_common_1[5]));
    {
      ...
      MR_hl_field(MR_mktag(0), TypeRepnDecision_75, 0) = ((MR_Box) ((MR_Unsigned) 0U));
