  ...
  MR_Word QualFuncName_6)
{
  ...
  else
  {
    ...
    Var_60 = ml_backend__mlds_to_c_name__mlds_pred_label_to_string_1_f_0(PredLabel_51);
    mercury__io__write_string_4_p_0(Stream_5, Var_60);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), ModeNum_53, &Var_70);
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_50 = ml_backend__mlds_to_c_name__mlds_tabling_data_name_2_f_0(ProcLabel_45, TablingId_46);
    ...
    case (MR_Integer) 3:
      {
        ...
        Var_47 = ml_backend__mlds__ml_global_const_var_name_to_string_2_f_0(ConstVar_40, Num_41);
        MangledGlobalVarName_42 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_47);
