  ...
  MR_Word QualFieldVarName_6)
{
  ...
  MR_String MangledFieldVarName_33;
  MR_String Var_34;

  SymName_19 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_8);
  MangledModuleName_20 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_19);
  mercury__io__write_string_4_p_0(Stream_5, MangledModuleName_20);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
  Var_34 = ml_backend__mlds__ml_field_var_name_to_string_1_f_0(FieldVarName_10);
  MangledFieldVarName_33 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_34);
  mercury__io__write_string_4_p_0(Stream_5, MangledFieldVarName_33);
}
  ...
  MR_Word QualProcLabel_6)
{
  ...
  if (!(succeeded))
  {
    ...
    SymName_26 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_8);
    MangledModuleName_27 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_26);
    mercury__io__write_string_4_p_0(Stream_5, MangledModuleName_27);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
  }
  PredLabel_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Name_9, (MR_Integer) 0))));
  ProcId_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Name_9, (MR_Integer) 1))));
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_39, &ModeNum_41);
  Var_46 = ml_backend__mlds_to_c_name__mlds_pred_label_to_string_1_f_0(PredLabel_38);
  mercury__io__write_string_4_p_0(Stream_5, Var_46);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), ModeNum_41, &Var_53);
  ...
  MR_Word QualFuncName_6)
{
  ...
  if (!(succeeded))
  {
    ...
    SymName_32 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_8);
    MangledModuleName_33 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_32);
    mercury__io__write_string_4_p_0(Stream_5, MangledModuleName_33);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
  }
  if (((MR_tag((MR_Word) FuncName_9)) == (MR_Integer) 1))
  {
    MR_String Name_55 = ((MR_String) ((MR_hl_field(MR_mktag(1), FuncName_9, (MR_Integer) 0))));

    mercury__io__write_string_4_p_0(Stream_5, Name_55);
  }
  else
  {
    MR_Word PlainFuncName_46 = (MR_Word) ((MR_Word) (FuncName_9));
    MR_Word FuncLabel_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PlainFuncName_46, (MR_Integer) 0))));
    MR_Word ProcLabel_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_47, (MR_Integer) 0))));
    MR_Word MaybeAux_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_47, (MR_Integer) 1))));
    MR_Word PredLabel_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_49, (MR_Integer) 0))));
    MR_Integer ProcId_52 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_49, (MR_Integer) 1))));
    MR_Integer ModeNum_53;
    MR_String FuncIdSuffix_54;
    MR_String Var_61;
    MR_String Var_71;

    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_52, &ModeNum_53);
    FuncIdSuffix_54 = ml_backend__ml_util__mlds_maybe_aux_func_id_to_suffix_1_f_0(MaybeAux_50);
    Var_61 = ml_backend__mlds_to_c_name__mlds_pred_label_to_string_1_f_0(PredLabel_51);
    mercury__io__write_string_4_p_0(Stream_5, Var_61);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), ModeNum_53, &Var_71);
    mercury__io__write_string_4_p_0(Stream_5, Var_71);
    mercury__io__write_string_4_p_0(Stream_5, FuncIdSuffix_54);
  }
}
  ...
  MR_Word GlobalVarName_8)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        SymName_26 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_7);
        MangledModuleName_27 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_26);
        mercury__io__write_string_4_p_0(Stream_6, MangledModuleName_27);
        mercury__io__write_string_4_p_0(Stream_6, (MR_String) "__");
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word RttiId_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GlobalVarName_8, (MR_Integer) 0))));
        MR_Word ShouldModuleQual_63;

        ShouldModuleQual_63 = backend_libs__rtti__module_qualify_name_of_rtti_id_1_f_0(RttiId_16);
        switch (ShouldModuleQual_63) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
            }
          ...
          case (MR_Integer) 1:
            {
              MR_Word SymName_55;
              MR_String MangledModuleName_56;

              SymName_55 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_7);
              MangledModuleName_56 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_55);
              mercury__io__write_string_4_p_0(Stream_6, MangledModuleName_56);
              mercury__io__write_string_4_p_0(Stream_6, (MR_String) "__");
            }
            break;
        }
  ...
  switch (MR_tag((MR_Word) GlobalVarName_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RttiId_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GlobalVarName_8, (MR_Integer) 0))));
        MR_String RttiAddrName_44;

        backend_libs__rtti__id_to_c_identifier_2_p_0(RttiId_43, &RttiAddrName_44);
        mercury__io__write_string_4_p_0(Stream_6, RttiAddrName_44);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word ProcLabel_45 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GlobalVarName_8, (MR_Integer) 0))));
        MR_Word TablingId_46 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GlobalVarName_8, (MR_Integer) 1))));
        MR_String Var_49;

        Var_49 = ml_backend__mlds_to_c_name__mlds_tabling_data_name_2_f_0(ProcLabel_45, TablingId_46);
        mercury__io__write_string_4_p_0(Stream_6, Var_49);
      }
      break;
    case (MR_Integer) 3:
      {
        MR_Word ConstVar_40 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GlobalVarName_8, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Integer Num_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), GlobalVarName_8, (MR_Integer) 1))));
        MR_String MangledGlobalVarName_42;
        MR_String Var_52;

        Var_52 = ml_backend__mlds__ml_global_const_var_name_to_string_2_f_0(ConstVar_40, Num_41);
        MangledGlobalVarName_42 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_52);
        mercury__io__write_string_4_p_0(Stream_6, MangledGlobalVarName_42);
      }
      break;
  }
}
  ...
  MR_Word PredLabel_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_59 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(DefiningModule_14);
      Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "_in__", Var_59);
