...
{
  {
    ...
    MR_String Var_27;
    MR_Word Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFieldVarName_4, (MR_Integer) 1))));
...
{
  {
    ...
    MR_Integer _ProcId_9 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Name_7, (MR_Integer) 1))));
    MR_Word Var_12;
    MR_Word Var_13;
    MR_String Var_14;
    MR_Integer Var_15;
    ...
    succeeded = ((MR_tag((MR_Word) PredLabel_8)) == (MR_mktag((MR_Integer) 0)));
    if (succeeded)
    {
      Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_8, (MR_Integer) 0))));
      ...
      Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_8, (MR_Integer) 4))));
      Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_8, (MR_Integer) 5))));
    ...
    if (((MR_tag((MR_Word) PredLabel_31)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "__");
      if (!((MaybeTypeModule_55 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
    ...
    {
      MR_Word PredOrFunc_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_31, (MR_Integer) 0))));
      ...
      MR_Word _CodeModel_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_31, (MR_Integer) 4))));
      MR_Word _NonOutputFunc_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_31, (MR_Integer) 5))));
      ...
      if (!((MaybeDefiningModule_44 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) FuncName_7)) == (MR_mktag((MR_Integer) 1))))
      succeeded = MR_TRUE;
    else
    {
      MR_Word PlainFuncName_8 = (MR_Word) (MR_body((MR_Word) (FuncName_7), (MR_Integer) 0));
      ...
      MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PlainFuncName_8, (MR_Integer) 1))));
      MR_Word _MaybeSeqNum_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_9, (MR_Integer) 1))));
      MR_Integer _ProcId_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ProcLabel_11, (MR_Integer) 1))));
      MR_Word Var_18;
      MR_Word Var_19;
      MR_String Var_20;
      MR_Integer Var_21;
      ...
      succeeded = ((MR_tag((MR_Word) PredLabel_13)) == (MR_mktag((MR_Integer) 0)));
      if (succeeded)
      {
        Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_13, (MR_Integer) 0))));
        ...
        Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_13, (MR_Integer) 4))));
        Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_13, (MR_Integer) 5))));
  ...
  MR_Word FunctionName_4)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) PredLabel_11)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "__");
      if (!((MaybeTypeModule_40 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
    ...
    {
      MR_Word PredOrFunc_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 0))));
      ...
      MR_Word _CodeModel_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 4))));
      MR_Word _NonOutputFunc_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 5))));
      ...
      if (!((MaybeDefiningModule_29 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
...
{
  {
    ...
    switch (MR_tag((MR_Word) GlobalVarName_6)) {
      ...
      case (MR_Integer) 3:
        {
          MR_Word ConstVar_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GlobalVarName_6, (MR_Integer) 0))));
...
{
  {
    ...
    if (((MR_tag((MR_Word) PredLabel_11)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if ((MaybeTypeModule_32 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        MidStr_39 = (MR_String) "";
      else
      {
    ...
    {
      MR_Word PredOrFunc_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 0))));
      ...
      MR_String Var_52;
      MR_String Var_53;
      MR_Word _CodeModel_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 4))));
      MR_Word _NonOutputFunc_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 5))));
      ...
      if ((MaybeDefiningModule_21 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        Var_13 = MainStr_29;
      else
      {
