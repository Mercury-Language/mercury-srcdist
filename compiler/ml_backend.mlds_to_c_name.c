    ...
    case (MR_Integer) 0:
      {
        ...
        Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "__", (MR_String) "dummy_var");
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ShouldModuleQual_42;
        MR_String GlobalVarNameStr_43;

        ShouldModuleQual_42 = backend_libs__rtti__module_qualify_name_of_rtti_id_1_f_0(RttiId_25);
        backend_libs__rtti__id_to_c_identifier_2_p_0(RttiId_25, &GlobalVarNameStr_43);
        switch (ShouldModuleQual_42) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            MaybeQualGlobalVarNameStr_6 = GlobalVarNameStr_43;
            break;
          case (MR_Integer) 1:
            {
              MR_String Qualifier_34;
              MR_String Var_36;
              MR_Word SymName_37;

              SymName_37 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_4);
              Qualifier_34 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_37);
              Var_36 = mercury__string__f_43_43_2_f_0((MR_String) "__", GlobalVarNameStr_43);
              MaybeQualGlobalVarNameStr_6 = mercury__string__f_43_43_2_f_0(Qualifier_34, Var_36);
            }
            break;
        }
      }
