  ...
  MR_Word ModuleName_6)
{
  ...
  SymName_11 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_6);
  MangledModuleName_12 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_11);
  Qualifier_8 = mercury__string__f_43_43_2_f_0(MangledModuleName_12, (MR_String) "__");
  mercury__io__write_string_4_p_0(Stream_5, Qualifier_8);
}
  ...
  MR_Word ModuleName_3)
{
  ...
  Qualifier_4 = mercury__string__f_43_43_2_f_0(MangledModuleName_6, (MR_String) "__");
  return Qualifier_4;
}
...
{
  MR_String QualProcLabelStr_8;

  QualProcLabelStr_8 = ml_backend__mlds_to_c_name__fully_qualified_proc_label_to_string_for_c_1_f_0(QualProcLabel_6);
  mercury__io__write_string_4_p_0(Stream_5, QualProcLabelStr_8);
}

MR_String MR_CALL 
ml_backend__mlds_to_c_name__fully_qualified_proc_label_to_string_for_c_1_f_0(
...
{
  MR_String QualFuncNameStr_8;

  QualFuncNameStr_8 = ml_backend__mlds_to_c_name__fully_qualified_function_name_to_string_for_c_1_f_0(QualFuncName_6);
  mercury__io__write_string_4_p_0(Stream_5, QualFuncNameStr_8);
}

MR_String MR_CALL 
ml_backend__mlds_to_c_name__fully_qualified_function_name_to_string_for_c_1_f_0(
...
ml_backend__mlds_to_c_name__mlds_output_class_name_arity_5_p_0(
  ...
  MR_Integer Arity_8)
{
  MR_String ClassNameStr_10;
  MR_String MangledClassName_13;
  MR_String Var_20;
  MR_String Var_28;

  MangledClassName_13 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_7);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), Arity_8, &Var_20);
  Var_28 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_20);
  ClassNameStr_10 = mercury__string__f_43_43_2_f_0(MangledClassName_13, Var_28);
  mercury__io__write_string_4_p_0(Stream_6, ClassNameStr_10);
}
...
{
  MR_String QualFieldVarNameStr_8;

  QualFieldVarNameStr_8 = ml_backend__mlds_to_c_name__qual_field_var_name_to_string_for_c_1_f_0(QualFieldVarName_6);
  mercury__io__write_string_4_p_0(Stream_5, QualFieldVarNameStr_8);
}
...
{
  MR_String LocalVarNameStr_8;
  MR_String Var_11;

  Var_11 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_6);
  LocalVarNameStr_8 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_11);
  mercury__io__write_string_4_p_0(Stream_5, LocalVarNameStr_8);
}
...
{
  MR_String MaybeQualGlobalVarNameStr_10;

  MaybeQualGlobalVarNameStr_10 = ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(ModuleName_7, GlobalVarName_8);
  mercury__io__write_string_4_p_0(Stream_6, MaybeQualGlobalVarNameStr_10);
}

MR_String MR_CALL 
ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(
  MR_Word ModuleName_4,
  MR_Word GlobalVarName_5)
{
  MR_String MaybeQualGlobalVarNameStr_6;
  MR_Word ShouldModuleQual_7;
  MR_String GlobalVarNameStr_8;

  switch (MR_tag((MR_Word) GlobalVarName_5)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ShouldModuleQual_7 = (MR_Integer) 1;
        GlobalVarNameStr_8 = (MR_String) "dummy_var";
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ShouldModuleQual_7 = backend_libs__rtti__module_qualify_name_of_rtti_id_1_f_0(RttiId_25);
        backend_libs__rtti__id_to_c_identifier_2_p_0(RttiId_25, &GlobalVarNameStr_8);
      }
      break;
    case (MR_Integer) 2:
    case (MR_Integer) 3:
      {
        ShouldModuleQual_7 = (MR_Integer) 0;
        if (((MR_tag((MR_Word) GlobalVarName_5)) == (MR_Integer) 3))
        {
          ...
          GlobalVarNameStr_8 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_29);
        }
        else
        {
          ...
          GlobalVarNameStr_8 = ml_backend__mlds_to_c_name__mlds_tabling_data_name_2_f_0(ProcLabel_27, TablingId_28);
        }
      }
      break;
  }
  switch (ShouldModuleQual_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      MaybeQualGlobalVarNameStr_6 = GlobalVarNameStr_8;
      break;
    case (MR_Integer) 1:
      {
        ...
        Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "__", GlobalVarNameStr_8);
        MaybeQualGlobalVarNameStr_6 = mercury__string__f_43_43_2_f_0(Qualifier_9, Var_17);
      }
      break;
  }
