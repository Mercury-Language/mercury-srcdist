...
{
  {
    ...
    if (((MR_tag((MR_Word) PredLabel_31)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "__");
      if (!((MaybeTypeModule_55 == (MR_Word) ((MR_Integer) 0))))
      {
    ...
    else
    {
      ...
      if (!((MaybeDefiningModule_44 == (MR_Word) ((MR_Integer) 0))))
      {
  ...
  MR_Word FunctionName_4)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) PredLabel_11)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "__");
      if (!((MaybeTypeModule_40 == (MR_Word) ((MR_Integer) 0))))
      {
    ...
    else
    {
      ...
      if (!((MaybeDefiningModule_29 == (MR_Word) ((MR_Integer) 0))))
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) PredLabel_11)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if ((MaybeTypeModule_32 == (MR_Word) ((MR_Integer) 0)))
        MidStr_39 = (MR_String) "";
      else
      {
    ...
    else
    {
      ...
      if ((MaybeDefiningModule_21 == (MR_Word) ((MR_Integer) 0)))
        Var_13 = MainStr_29;
      else
      {
