    ...
    case (MR_Integer) 3:
      {
        ...
        Var_36 = ml_backend__mlds__ml_global_const_var_name_to_string_2_f_0(ConstVar_27, Num_28);
        MangledGlobalVarName_29 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_36);
