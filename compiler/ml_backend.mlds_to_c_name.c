    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word TablingId_28;

        ShouldModuleQual_7 = (MR_Integer) 0;
        ProcLabel_27 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_5, (MR_Integer) 0))));
        TablingId_28 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_5, (MR_Integer) 1))));
        GlobalVarNameStr_8 = ml_backend__mlds_to_c_name__tabling_struct_id_to_string_2_f_0(ProcLabel_27, TablingId_28);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        ShouldModuleQual_7 = (MR_Integer) 0;
        ConstVar_23 = ((MR_Unsigned) ((MR_hl_field(3, GlobalVarName_5, (MR_Integer) 0))) & (MR_Integer) 7);
        Num_24 = ((MR_Integer) ((MR_hl_field(3, GlobalVarName_5, (MR_Integer) 1))));
