...
{
  {
    ...
    MR_String Var_27;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualFieldVarName_4, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_8, (MR_Integer) 0)));
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_8, (MR_Integer) 4)));
    ...
    else
    {
      ...
      MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_31, (MR_Integer) 0)));
      MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_31, (MR_Integer) 4)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_13, (MR_Integer) 0)));
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_13, (MR_Integer) 4)));
  ...
  MR_Word FunctionName_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 0)));
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_11, (MR_Integer) 4)));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_String Var_45;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GlobalVarName_6, (MR_Integer) 0)));
