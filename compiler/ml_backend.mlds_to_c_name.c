  ...
  MR_Word QualProcLabel_3)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_25, &ModeNum_27);
  ...
  MR_Word QualFuncName_3)
{
  ...
  else
  {
    ...
    hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_36, &ModeNum_38);
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_Unsigned Num_24 = ((MR_Unsigned) ((MR_hl_field(3, GlobalVarName_5, 1))));
        MR_String Var_29;
  ...
  MR_Word TablingId_5)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_18, &ModeNum_20);
