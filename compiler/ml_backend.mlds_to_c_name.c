...
{
  MR_Word ModuleName_8 = ((MR_Word) ((MR_hl_field(0, QualFieldVarName_6, (MR_Integer) 0))));
  MR_Word FieldVarName_10 = ((MR_Word) ((MR_hl_field(0, QualFieldVarName_6, (MR_Integer) 2))));
  MR_Word SymName_14;
...
{
  MR_bool succeeded;
  MR_Word ModuleName_8 = ((MR_Word) ((MR_hl_field(0, QualProcLabel_6, (MR_Integer) 0))));
  MR_Word Name_9 = ((MR_Word) ((MR_hl_field(0, QualProcLabel_6, (MR_Integer) 1))));
  MR_Word PredLabel_10 = ((MR_Word) ((MR_hl_field(0, Name_9, (MR_Integer) 0))));
  MR_Word PredLabel_30;
  ...
  if (succeeded)
  {
    Var_14 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 0))) & (MR_Integer) 1);
    Var_15 = ((MR_Word) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 1))));
    Var_16 = ((MR_String) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 2))));
    Var_17 = ((MR_Word) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 3))));
    Var_19 = ((((MR_Unsigned) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 4))) >> 1)) & (MR_Integer) 3);
    Var_20 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_10, (MR_Integer) 4))) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_18 = (MR_Integer) (Var_17);
              succeeded = (Var_18 == (MR_Integer) 2);
            }
          }
        }
      }
  ...
  if (!(succeeded))
  {
    ...
    SymName_22 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_8);
    MangledModuleName_23 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_22);
    mercury__io__write_string_4_p_0(Stream_5, MangledModuleName_23);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
  }
  PredLabel_30 = ((MR_Word) ((MR_hl_field(0, Name_9, (MR_Integer) 0))));
  ProcId_31 = ((MR_Integer) ((MR_hl_field(0, Name_9, (MR_Integer) 1))));
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_31, &ModeNum_32);
  Var_36 = ml_backend__mlds_to_c_name__mlds_pred_label_to_string_1_f_0(PredLabel_30);
  mercury__io__write_string_4_p_0(Stream_5, Var_36);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), ModeNum_32, &Var_43);
...
{
  MR_bool succeeded;
  MR_Word ModuleName_8 = ((MR_Word) ((MR_hl_field(0, QualFuncName_6, (MR_Integer) 0))));
  MR_Word FuncName_9 = ((MR_Word) ((MR_hl_field(0, QualFuncName_6, (MR_Integer) 1))));
  ...
  else
  {
    ...
    MR_Word FuncLabel_11 = ((MR_Word) ((MR_hl_field(0, PlainFuncName_10, (MR_Integer) 0))));
    MR_Word ProcLabel_13 = ((MR_Word) ((MR_hl_field(0, FuncLabel_11, (MR_Integer) 0))));
    MR_Word PredLabel_15 = ((MR_Word) ((MR_hl_field(0, ProcLabel_13, (MR_Integer) 0))));
    MR_Word Var_20;
    MR_Word Var_21;
    MR_String Var_22;
    MR_Word Var_23;
    ...
    if (succeeded)
    {
      Var_20 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 0))) & (MR_Integer) 1);
      Var_21 = ((MR_Word) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 1))));
      Var_22 = ((MR_String) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 2))));
      Var_23 = ((MR_Word) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 3))));
      Var_25 = ((((MR_Unsigned) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 4))) >> 1)) & (MR_Integer) 3);
      Var_26 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_15, (MR_Integer) 4))) & (MR_Integer) 1);
      succeeded = (Var_20 == (MR_Integer) 0);
      if (succeeded)
      {
  ...
  {
    MR_Word SymName_28;
    MR_String MangledModuleName_29;

    SymName_28 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_8);
    MangledModuleName_29 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(SymName_28);
    mercury__io__write_string_4_p_0(Stream_5, MangledModuleName_29);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
  }
  if (((MR_tag((MR_Word) FuncName_9)) == (MR_Integer) 1))
  {
    MR_String Name_45 = ((MR_String) ((MR_hl_field(1, FuncName_9, (MR_Integer) 0))));

    mercury__io__write_string_4_p_0(Stream_5, Name_45);
  }
  else
  {
    MR_Word PlainFuncName_36 = (MR_Word) ((MR_Word) (FuncName_9));
    MR_Word FuncLabel_37 = ((MR_Word) ((MR_hl_field(0, PlainFuncName_36, (MR_Integer) 0))));
    MR_Word ProcLabel_39 = ((MR_Word) ((MR_hl_field(0, FuncLabel_37, (MR_Integer) 0))));
    MR_Word MaybeAux_40 = ((MR_Word) ((MR_hl_field(0, FuncLabel_37, (MR_Integer) 1))));
    MR_Word PredLabel_41 = ((MR_Word) ((MR_hl_field(0, ProcLabel_39, (MR_Integer) 0))));
    MR_Integer ProcId_42 = ((MR_Integer) ((MR_hl_field(0, ProcLabel_39, (MR_Integer) 1))));
    MR_Integer ModeNum_43;
    MR_String FuncIdSuffix_44;
    MR_String Var_49;
    MR_String Var_59;

    hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_42, &ModeNum_43);
    FuncIdSuffix_44 = ml_backend__ml_util__mlds_maybe_aux_func_id_to_suffix_1_f_0(MaybeAux_40);
    Var_49 = ml_backend__mlds_to_c_name__mlds_pred_label_to_string_1_f_0(PredLabel_41);
    mercury__io__write_string_4_p_0(Stream_5, Var_49);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_name_scalar_common_1[0]), ModeNum_43, &Var_59);
    mercury__io__write_string_4_p_0(Stream_5, Var_59);
    mercury__io__write_string_4_p_0(Stream_5, FuncIdSuffix_44);
  }
}
  ...
  MR_Word GlobalVarName_8)
{
  switch (MR_tag((MR_Word) GlobalVarName_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RttiId_14 = ((MR_Word) ((MR_hl_field(1, GlobalVarName_8, (MR_Integer) 0))));
  ...
  switch (MR_tag((MR_Word) GlobalVarName_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RttiId_30 = ((MR_Word) ((MR_hl_field(1, GlobalVarName_8, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word ProcLabel_32 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_8, (MR_Integer) 0))));
        MR_Word TablingId_33 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_8, (MR_Integer) 1))));
        MR_String Var_35;
    ...
    case (MR_Integer) 3:
      {
        MR_Word ConstVar_27 = ((MR_Unsigned) ((MR_hl_field(3, GlobalVarName_8, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Integer Num_28 = ((MR_Integer) ((MR_hl_field(3, GlobalVarName_8, (MR_Integer) 1))));
  ...
  MR_Word TablingId_5)
{
  ...
  PredLabel_11 = ((MR_Word) ((MR_hl_field(0, Var_10, (MR_Integer) 0))));
  ProcId_12 = ((MR_Integer) ((MR_hl_field(0, Var_10, (MR_Integer) 1))));
