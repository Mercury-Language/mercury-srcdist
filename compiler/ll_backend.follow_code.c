          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_16, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_22;
              MR_Word GoalExpr_74;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
              ...
              ll_backend__follow_code__move_follow_code_in_cases_5_p_0(Cases0_21, &Cases_22, RttiVarMaps_8, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_74, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_30, (MR_Integer) 2)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_31, (MR_Integer) 1)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_51, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 1)));
      ...
      {
        {
          ...
          if ((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
            {
              ...
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_22, (MR_Integer) 4)));
              Var_28 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_22, (MR_Integer) 4))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_Integer) 2))
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17, (MR_Integer) 3)));
      ...
      if (((MR_tag((MR_Word) (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_Integer) 1))
      {
        ...
        if ((env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification_43, (MR_Integer) 2)));
