    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) FollowGoals_24)) == (MR_Integer) 1);
          if (succeeded)
          {
            succeeded = ((((MR_tag((MR_Word) GoalExpr0_22)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_22, (MR_Integer) 0))) == (MR_Integer) 3)));
            if (succeeded)
            {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = ((((MR_tag((MR_Word) GoalExpr0_31)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_31, (MR_Integer) 0))) == (MR_Integer) 2)));
                      if (succeeded)
                      {
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((((MR_tag((MR_Word) GoalExpr0_51)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_51, (MR_Integer) 0))) == (MR_Integer) 2)));
                        if (succeeded)
                        {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) GoalExpr0_17)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 0))) == (MR_Integer) 2)));
              if (succeeded)
              {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) GoalExpr0_21)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 0))) == (MR_Integer) 2)));
              if (succeeded)
              {
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_Integer) 1))
      {
        ...
        (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Unification_43)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Unification_43, (MR_Integer) 0))) == (MR_Integer) 1)));
