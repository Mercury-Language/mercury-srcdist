    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_21, STATE_VARIABLE_ProcInfo_0_22, &STATE_VARIABLE_ProcInfo_1_30);
        hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_17, STATE_VARIABLE_ProcInfo_1_30, &STATE_VARIABLE_ProcInfo_2_31);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_18, STATE_VARIABLE_ProcInfo_2_31, STATE_VARIABLE_ProcInfo_23);
      }
      break;
  }
}
