          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_22;
              MR_Word GoalExpr_74;
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_30, (MR_Integer) 2)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_31, (MR_Integer) 1)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_51, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 1)));
