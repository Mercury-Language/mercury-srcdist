...
MR_decl_label9(ll_backend__follow_code__move_follow_code_in_goal_5_0, 21,18,25,24,28,31,27,36,35)
...
MR_BEGIN_MODULE(ll_backend__follow_code_module6)
	...
	MR_init_label9(ll_backend__follow_code__move_follow_code_in_goal_5_0,21,18,25,24,28,31,27,36,35)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__follow_code__move_follow_code_in_goal_5_0,28)
	...
	MR_r1 = MR_r5;
	MR_np_localcall_lab(ll_backend__follow_code__move_follow_code_in_goal_5_0,
		ll_backend__follow_code__move_follow_code_in_goal_5_0_i31);
...
MR_def_label(ll_backend__follow_code__move_follow_code_in_goal_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(ll_backend__follow_code__move_follow_code_in_goal_5_0_i35);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(ll_backend__follow_code__move_follow_code_in_cases_5_0,
		ll_backend__follow_code__move_follow_code_in_goal_5_0_i36);
