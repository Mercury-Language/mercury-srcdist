    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) FollowGoals_24)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), FollowGoals_24, (MR_Integer) 0)));
            Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), FollowGoals_24, (MR_Integer) 1)));
            succeeded = ((((MR_tag((MR_Word) GoalExpr0_22)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_22, (MR_Integer) 0)))) == (MR_Integer) 3)));
            if (succeeded)
            {
              Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_22, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                ...
                Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_45, (MR_Integer) 0)));
      ...
      {
        STATE_VARIABLE_RevPrevGoals_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = RestGoals_32;
        MR_Word next_value_of_STATE_VARIABLE_RevPrevGoals_0_4 = STATE_VARIABLE_RevPrevGoals_42_42;
        MR_Word next_value_of_STATE_VARIABLE_Changed_0_6 = STATE_VARIABLE_Changed_41_41;
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_10)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_17 = (MR_Word) MR_body(((MR_Word) GoalExpr0_10), (MR_Integer) 0);
          MR_Word SubGoal_18;
          MR_Word GoalExpr_74;
          ...
          GoalExpr_74 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_18);
          {
            MR_Word base;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    ll_backend__follow_code__move_follow_code_in_conj_2_7_p_0(Goals0_13, ConjPurity_14, RttiVarMaps_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevGoals_87, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
                    mercury__list__reverse_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, RevGoals_87, &Goals_15);
                  }
                  break;
              }
              {
                GoalExpr_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), GoalExpr_16, 1) = ((MR_Box) (ConjType_12));
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals0_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 1)));
              MR_Word Goals_72;
              MR_Word GoalExpr_73;

              ll_backend__follow_code__move_follow_code_in_independent_goals_5_p_0(Goals0_71, &Goals_72, RttiVarMaps_8, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_73, 1) = ((MR_Box) (Goals_72));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Det_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
              ...
              ll_backend__follow_code__move_follow_code_in_cases_5_p_0(Cases0_21, &Cases_22, RttiVarMaps_8, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_75, 1) = ((MR_Box) (Var_19));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 2) = ((MR_Box) (Det_20));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 3) = ((MR_Box) (Cases_22));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word GoalExpr_77;
              MR_Word SubGoal0_78 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
              MR_Word SubGoal_79;
              MR_Word FGT_32;
              MR_Word Var_31;
              ...
              if (succeeded)
              {
                SubGoal_79 = SubGoal0_78;
                *STATE_VARIABLE_Changed_58 = STATE_VARIABLE_Changed_0_57;
              }
              else
                ll_backend__follow_code__move_follow_code_in_goal_5_p_0(SubGoal0_78, &SubGoal_79, RttiVarMaps_8, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_77, 1) = ((MR_Box) (Reason_30));
                MR_hl_field(MR_mktag(3), GoalExpr_77, 2) = ((MR_Box) (SubGoal_79));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 6:
            {
              ...
              ll_backend__follow_code__move_follow_code_in_goal_5_p_0(Cond0_24, &Cond_27, RttiVarMaps_8, STATE_VARIABLE_Changed_0_57, &STATE_VARIABLE_Changed_63_63);
              ll_backend__follow_code__move_follow_code_in_goal_5_p_0(Then0_25, &Then_28, RttiVarMaps_8, STATE_VARIABLE_Changed_63_63, &STATE_VARIABLE_Changed_64_64);
              ll_backend__follow_code__move_follow_code_in_goal_5_p_0(Else0_26, &Else_29, RttiVarMaps_8, STATE_VARIABLE_Changed_64_64, STATE_VARIABLE_Changed_58);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_76, 1) = ((MR_Box) (Vars_23));
                MR_hl_field(MR_mktag(3), GoalExpr_76, 2) = ((MR_Box) (Cond_27));
                MR_hl_field(MR_mktag(3), GoalExpr_76, 3) = ((MR_Box) (Then_28));
                MR_hl_field(MR_mktag(3), GoalExpr_76, 4) = ((MR_Box) (Else_29));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Det_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 2)));
              ...
              {
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_15, 2) = ((MR_Box) (Det_12));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = ((((MR_tag((MR_Word) GoalExpr0_31)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_31, (MR_Integer) 0)))) == (MR_Integer) 2)));
                      if (succeeded)
                      {
                        Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_31, (MR_Integer) 1)));
                      ...
                      {
                        Then_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((((MR_tag((MR_Word) GoalExpr0_51)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_51, (MR_Integer) 0)))) == (MR_Integer) 2)));
                        if (succeeded)
                        {
                          Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_51, (MR_Integer) 1)));
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            GoalExpr_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(3), GoalExpr_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                            MR_hl_field(MR_mktag(3), GoalExpr_57, 1) = ((MR_Box) ((MR_Integer) 0));
                        ...
                        {
                          Else_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) GoalExpr0_17)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 0)))) == (MR_Integer) 2)));
              if (succeeded)
              {
                Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_17, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                ...
                {
                  GoalExpr_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_23, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(3), GoalExpr_23, 1) = ((MR_Box) ((MR_Integer) 0));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) GoalExpr0_21)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 0)))) == (MR_Integer) 2)));
              if (succeeded)
              {
                Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_21, (MR_Integer) 1)));
  ...
  MR_Word Detism0_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_11;
      MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_9, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Goals_6;
...
{
  {
    ...
    (env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = ((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__RttiVarInfo_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    (env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = !((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded);
      ...
      {
        {
          ...
          (env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_mktag((MR_Integer) 1)));
          if ((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
          {
            ...
            (env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = ((MR_tag((MR_Word) Unification_22)) == (MR_mktag((MR_Integer) 1)));
            if ((env_ptr)->ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
            {
              ...
              Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), Unification_22, (MR_Integer) 4)));
              Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), Unification_22, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_mktag((MR_Integer) 2))))
      {
        MR_Word Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(2), (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17, (MR_Integer) 3)));
      ...
      if (((MR_tag((MR_Word) (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__GoalExpr_17)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        (env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Unification_43)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Unification_43, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if ((env).ll_backend__follow_code__move_follow_code_select_6_p_0_env_0__succeeded)
        {
          ...
          Var_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), Unification_43, (MR_Integer) 2)));
