  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ProcInfo_0_22, &VarTable0_10);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_clause_body_general_vt_9_p_0((MR_Integer) 1, HeadVars_14, &_Warnings_15, Goal1_12, &Goal2_16, VarTable0_10, &VarTable_17, RttiVarMaps0_11, &RttiVarMaps_18);
  ...
  MR_Word * STATE_VARIABLE_Changed_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_38;
      MR_Word Var_39;
      MR_Word TypeCtorInfo_8_49;
      MR_Word Goal_43;
      MR_Word Goals_44;
      MR_Word GoalInfo_46;
      MR_Word InstMapDelta_47;
      MR_Word ChangedVars_48;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Goal_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FollowGoals_24, (MR_Integer) 0))));
                Goals_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FollowGoals_24, (MR_Integer) 1))));
                GoalInfo_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_43, (MR_Integer) 1))));
                InstMapDelta_47 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_46);
                hlds__instmap__instmap_delta_changed_vars_2_p_0(InstMapDelta_47, &ChangedVars_48);
                TypeCtorInfo_8_49 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                succeeded = parse_tree__set_of_var__is_empty_1_p_0(TypeCtorInfo_8_49, ChangedVars_48);
                if (succeeded)
                  succeeded = ll_backend__follow_code__no_bind_vars_1_p_0(Goals_44);
                succeeded = !(succeeded);
              }
            }
            succeeded = !(succeeded);
