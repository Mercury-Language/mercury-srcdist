      ...
      case (MR_Integer) 0:
        {
          ...
          GoalExpr_73 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_18);
          {
            MR_Word base;
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    ll_backend__follow_code__move_follow_code_in_conj_2_7_p_0(Goals0_13, ConjPurity_14, RttiVarMaps_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevGoals_86, STATE_VARIABLE_Changed_0_57, STATE_VARIABLE_Changed_58);
          ...
          case (MR_Integer) 4:
            {
              ...
              {
                GoalExpr_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_74, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_74, 1) = ((MR_Box) (Var_19));
                MR_hl_field(MR_mktag(3), GoalExpr_74, 2) = ((MR_Box) (Det_20));
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                GoalExpr_76 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_76, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
