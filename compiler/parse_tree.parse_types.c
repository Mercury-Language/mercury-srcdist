...
static const MR_FA_TypeInfo_Struct1 parse_tree__parse_types__one_or_more__ti_one_or_more_1parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static const MR_PseudoTypeInfo parse_tree__parse_types__parse_tree__parse_types__field_types_item_or_marker_0_1[2] = {
  ...
  (MR_PseudoTypeInfo) (&parse_tree__parse_types__one_or_more__ti_one_or_more_1parse_tree__error_spec__type_ctor_info_diag_spec_0)
};

static const MR_DuFunctorDesc parse_tree__parse_types__parse_tree__parse_types__du_functor_desc_item_or_marker_0_1 = {
  (MR_String) "iom_item_and_diag_specs",
  INT16_C(2),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(2),
...
static const MR_PseudoTypeInfo parse_tree__parse_types__parse_tree__parse_types__field_types_item_or_marker_0_11[1] = { (MR_PseudoTypeInfo) (&parse_tree__parse_types__one_or_more__ti_one_or_more_1parse_tree__error_spec__type_ctor_info_diag_spec_0) };
