      ...
      switch (MR_tag((MR_Word) HeadVar__2_2)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0))))) {
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          recompilation____Compare____module_item_version_numbers_0_0(HeadVar__1_1, Var_363, ArgY1_117);
                        }
                        break;
                      case (MR_Integer) 2:
                        *HeadVar__1_1 = (MR_Integer) 1;
            ...
            case (MR_Integer) 3:
              {
                MR_Word Var_356 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 3))));
                      ...
                      case (MR_Integer) 3:
                        {
                          ...
                          MR_Word ArgY3_191 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3))));
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_189;
                              ...
                              parse_tree__prog_data____Compare____item_seq_num_0_0(HeadVar__1_1, Var_356, ArgY3_191);
                          }
                        }
                        break;
                      case (MR_Integer) 4:
            ...
            case (MR_Integer) 4:
              {
                MR_Word Var_353 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 3))));
                      ...
                      case (MR_Integer) 4:
                        {
                          ...
                          MR_Word ArgY3_245 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3))));
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_243;
                              ...
                              parse_tree__prog_data____Compare____item_seq_num_0_0(HeadVar__1_1, Var_353, ArgY3_245);
                          }
                        }
                        break;
                      case (MR_Integer) 5:
            ...
            case (MR_Integer) 5:
              {
                MR_Word Var_359 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 3))));
                      ...
                      case (MR_Integer) 5:
                        {
                          ...
                          MR_Word ArgY3_299 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3))));
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_297;
                              ...
                              parse_tree__prog_data____Compare____item_seq_num_0_0(HeadVar__1_1, Var_359, ArgY3_299);
                          }
                        }
                        break;
                      case (MR_Integer) 6:
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = recompilation____Unify____module_item_version_numbers_0_0(ArgX1_11, ArgY1_12);
                }
              }
              break;
            case (MR_Integer) 2:
            ...
            case (MR_Integer) 3:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                      succeeded = parse_tree__prog_data____Unify____item_seq_num_0_0(ArgX3_19, ArgY3_20);
                  }
                }
              }
              break;
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                      succeeded = parse_tree__prog_data____Unify____item_seq_num_0_0(ArgX3_25, ArgY3_26);
                  }
                }
              }
              break;
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                      succeeded = parse_tree__prog_data____Unify____item_seq_num_0_0(ArgX3_31, ArgY3_32);
                  }
                }
              }
              break;
