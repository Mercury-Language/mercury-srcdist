                      ...
                      case (MR_Integer) 2:
                        {
                          ...
                          MR_Integer ArgY3_139 = ((MR_Integer) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3)));
                          MR_Word Var_140;

                          mdbcomp__sym_name____Compare____sym_name_0_0(&Var_140, Var_258, ArgY1_135);
                          succeeded = (Var_140 == (MR_Integer) 0);
                          succeeded = !(succeeded);
                          if (succeeded)
                            *HeadVar__1_1 = Var_140;
                          else
                          {
                            MR_Word Var_141;

                            mercury__term____Compare____context_0_0(&Var_141, Var_257, ArgY2_137);
                            succeeded = (Var_141 == (MR_Integer) 0);
                            succeeded = !(succeeded);
                            if (succeeded)
                              *HeadVar__1_1 = Var_141;
                            else
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_256, ArgY3_139);
                          }
                        }
                        break;
                      case (MR_Integer) 3:
                      ...
                      case (MR_Integer) 3:
                        {
                          ...
                          MR_Word ArgY2_183 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2)));
                          MR_Integer ArgY3_185 = ((MR_Integer) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3)));
                          MR_Word Var_186;

                          mdbcomp__sym_name____Compare____sym_name_0_0(&Var_186, Var_255, ArgY1_181);
                          succeeded = (Var_186 == (MR_Integer) 0);
                          succeeded = !(succeeded);
                          if (succeeded)
                            *HeadVar__1_1 = Var_186;
                          else
                          {
                            MR_Word Var_187;

                            mercury__term____Compare____context_0_0(&Var_187, Var_254, ArgY2_183);
                            succeeded = (Var_187 == (MR_Integer) 0);
                            succeeded = !(succeeded);
                            if (succeeded)
                              *HeadVar__1_1 = Var_187;
                            else
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_253, ArgY3_185);
                          }
                        }
                        break;
                      case (MR_Integer) 4:
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Word Var_261 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1)));
                ...
                switch (MR_tag((MR_Word) HeadVar__3_3)) {
                  ...
                  case (MR_Integer) 3:
                    switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 0)))) {
                      ...
                      case (MR_Integer) 4:
                        {
                          MR_Word ArgY1_227 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 1)));
                          MR_Word ArgY2_229 = ((MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2)));
                          MR_Integer ArgY3_231 = ((MR_Integer) (MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 3)));
                          MR_Word Var_232;
                          MR_Integer Var_264 = (MR_Integer) Var_261;
                          MR_Integer Var_265 = (MR_Integer) ArgY1_227;

                          mercury__private_builtin__builtin_compare_int_3_p_0(&Var_232, Var_264, Var_265);
                          succeeded = (Var_232 == (MR_Integer) 0);
                          succeeded = !(succeeded);
                          if (succeeded)
                            *HeadVar__1_1 = Var_232;
                          else
                          {
                            MR_Word Var_233;

                            mercury__term____Compare____context_0_0(&Var_233, Var_260, ArgY2_229);
                            succeeded = (Var_233 == (MR_Integer) 0);
                            succeeded = !(succeeded);
                            if (succeeded)
                              *HeadVar__1_1 = Var_233;
                            else
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_259, ArgY3_231);
                          }
                        }
                        break;
                    }
