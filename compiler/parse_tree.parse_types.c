      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__46_46 = (MR_Word) (&parse_tree__parse_types_scalar_common_1[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__46_46, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
            }
          }
        }
        break;
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo__49_49 = (MR_Word) (&parse_tree__parse_types_scalar_common_1[2]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__49_49, ((MR_Box) (ArgX1_9)), ((MR_Box) (ArgY1_10)));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo__47_47 = (MR_Word) (&parse_tree__parse_types_scalar_common_1[1]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__47_47, ((MR_Box) (ArgX1_11)), ((MR_Box) (ArgY1_12)));
              }
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 8:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo__43_43 = (MR_Word) (&parse_tree__parse_types_scalar_common_1[0]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__43_43, ((MR_Box) (ArgX1_39)), ((MR_Box) (ArgY1_40)));
              }
            }
            break;
        }
