                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_139;
                              ...
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_256, ArgY3_141);
                          }
                        }
                        break;
                      case (MR_Integer) 3:
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_185;
                              ...
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_253, ArgY3_187);
                          }
                        }
                        break;
                      case (MR_Integer) 4:
                      ...
                      case (MR_Integer) 4:
                        {
                          ...
                          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_228, Var_264, Var_265);
                          succeeded = (SubResult1_228 != (MR_Integer) 0);
                          if (succeeded)
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_231;
                              ...
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_259, ArgY3_233);
                          }
                        }
                        break;
                    }
