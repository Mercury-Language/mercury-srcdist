          ...
          case (MR_Integer) 1:
            {
              ...
              {
                libs__globals__set_option_4_p_0((MR_Integer) 613, (MR_Word) MR_mkword(MR_mktag(1), &make__util_scalar_common_3[0]), make__util__Globals_12, &make__util__NoRebuildGlobals_19);
              }
              {
