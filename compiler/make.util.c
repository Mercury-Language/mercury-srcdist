  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  make__file_names__module_target_to_file_name_7_p_0(Globals_10, From_11, TargetType_14, ModuleName_13, &FileName_17);
  ...
  succeeded = make__file_names__timestamp_extension_2_p_0(TargetType_14, &TimestampExt_18);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  Var_25 = make__timestamp__init_target_file_timestamps_0_f_0();
