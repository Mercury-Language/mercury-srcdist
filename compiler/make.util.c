    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_String FileName_13;
          MR_Word ModuleName_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Target_8, (MR_Integer) 0))));
          MR_Word TargetType_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Target_8, (MR_Integer) 1))));

          switch (MR_tag((MR_Word) TargetType_75)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word TargetType_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetType_75, (MR_Integer) 0))));

                make__util__module_target_to_file_name_maybe_search_8_p_0(Globals_7, (MR_Integer) 1, (MR_Integer) 1, TargetType_83, ModuleName_74, &FileName_13);
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word LinkedTargetType_78 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), TargetType_75, (MR_Integer) 0))) & (MR_Integer) 7);

                make__util__linked_target_file_name_6_p_0(Globals_7, ModuleName_74, LinkedTargetType_78, &FileName_13);
              }
              break;
            case (MR_Integer) 2:
              {
      ...
      switch (MR_tag((MR_Word) TargetType_18)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(TargetType_18)) {
            ...
            case (MR_Integer) 5:
              {
                MR_Word SearchDirOpt_121 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[23])), (MR_Integer) 0))));
                MR_Word SearchDirs0_122;
                MR_String Var_114;

                libs__globals__lookup_accumulating_option_3_p_0(Globals_10, SearchDirOpt_121, &SearchDirs0_122);
                ...
                else
                {
                  ...
                  {
                    SearchDirs_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), SearchDirs_19, 0) = ((MR_Box) (Var_116));
                    MR_hl_field(MR_mktag(1), SearchDirs_19, 1) = ((MR_Box) (SearchDirs0_122));
                  }
                }
              }
              break;
            ...
            case (MR_Integer) 7:
              {
                MR_Word SearchDirOpt_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[21])), (MR_Integer) 0))));
                MR_Word SearchDirs0_85;
                MR_String Var_88;

                libs__globals__lookup_accumulating_option_3_p_0(Globals_10, SearchDirOpt_84, &SearchDirs0_85);
                Var_88 = mercury__dir__this_directory_0_f_0();
                succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_88)), SearchDirs0_85);
                if (succeeded)
                  SearchDirs_19 = SearchDirs0_85;
                else
                {
                  MR_String Var_89;
                  ...
                  {
                    SearchDirs_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), SearchDirs_19, 0) = ((MR_Box) (Var_89));
                    MR_hl_field(MR_mktag(1), SearchDirs_19, 1) = ((MR_Box) (SearchDirs0_85));
                  }
                }
              }
              break;
        ...
        case (MR_Integer) 1:
          {
            MR_Word SearchDirOpt_109 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[22])), (MR_Integer) 0))));
            MR_Word SearchDirs0_110;
            MR_String Var_102;

            libs__globals__lookup_accumulating_option_3_p_0(Globals_10, SearchDirOpt_109, &SearchDirs0_110);
            ...
            else
            {
              ...
              {
                SearchDirs_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), SearchDirs_19, 0) = ((MR_Box) (Var_104));
                MR_hl_field(MR_mktag(1), SearchDirs_19, 1) = ((MR_Box) (SearchDirs0_110));
              }
            }
          }
          break;
