...
static void MR_CALL 
make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1001__1_4_p_0(
  MR_Word Globals_5,
  MR_Word Target_6);
...
static /* final */ const MR_Box make__util_scalar_common_3[21][1];
...
static /* final */ const struct make__util__vector_common_type_5_0_s make__util_vector_common_5[16] = {
  ...
  /* row 11 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[16])) },
  /* row 12 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[17])) },
...
{
  {
    ...
    switch (OptionValue_36) {
      ...
      case (MR_Integer) 1:
        {
          make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1001__1_4_p_0(Globals_5, Target_6);
...
{
  {
    ...
    switch (MR_tag((MR_Word) TargetType_27)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word LinkedTargetType_31 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), TargetType_27, (MR_Integer) 0))) & (MR_Integer) 7);
...
{
  {
    ...
    switch (MR_tag((MR_Word) TargetType_7)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word LinkedTargetType_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), TargetType_7, (MR_Integer) 0))) & (MR_Integer) 7);
          MR_String FileName_12;
  ...
  MR_String * FileName_10)
{
  switch (TargetType_9) {
    ...
    case (MR_Integer) 6:
    case (MR_Integer) 5:
      parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140make.util.linked_target_file_name\'/6", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[20])), ModuleName_8, FileName_10);
      break;
    case (MR_Integer) 2:
      {
        MR_Word Var_37;
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 600, &Ext_52);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 601, &Ext_51);
        ...
        case (MR_Integer) 0:
          {
            ...
            *MaybeTimestamp_14 = (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_3[15]));
    ...
    switch (MR_tag((MR_Word) TargetType_5)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(TargetType_5)) {
          ...
          case (MR_Integer) 5:
            {
              MR_Word SearchDirs0_50;
              MR_String Var_42;

              libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 676, &SearchDirs0_50);
              Var_42 = mercury__dir__this_directory_0_f_0();
              succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_42)), SearchDirs0_50);
              if (succeeded)
                *SearchDirs_6 = SearchDirs0_50;
              else
              {
                MR_String Var_44;
                ...
                Var_44 = mercury__dir__this_directory_0_f_0();
                {
                  ...
                  *SearchDirs_6 = base;
                  ...
                  MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (SearchDirs0_50));
                }
              }
            }
            break;
      ...
      case (MR_Integer) 1:
        {
          MR_Word SearchDirs0_37;
          MR_String Var_29;

          libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 523, &SearchDirs0_37);
          Var_29 = mercury__dir__this_directory_0_f_0();
          succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_29)), SearchDirs0_37);
          if (succeeded)
            *SearchDirs_6 = SearchDirs0_37;
          else
          {
            MR_String Var_31;
            ...
            Var_31 = mercury__dir__this_directory_0_f_0();
            {
              ...
              *SearchDirs_6 = base;
              ...
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (SearchDirs0_37));
            }
          }
        }
        break;
