...
static void MR_CALL 
make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1854__1_4_p_0(
  MR_Word Globals_5,
  MR_Word Target_6);
...
{
  {
    ...
    switch (OptionValue_36) {
      ...
      case (MR_Integer) 1:
        {
          make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1854__1_4_p_0(Globals_5, Target_6);
...
{
  {
    ...
    }
    {
      ...
      if (succeeded)
      {
        *HeadVar__2_2 = (MR_Word) (MR_mkword(MR_mktag(1), &make__util_scalar_common_7[0]));
        succeeded = MR_TRUE;
      }
      if (succeeded)
        cont(cont_env_ptr);
