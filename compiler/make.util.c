...
static void MR_CALL 
make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__961__1_4_p_0(
  MR_Word Globals_5,
  MR_Word Target_6);
...
{
  {
    ...
    switch (OptionValue_36) {
      ...
      case (MR_Integer) 1:
        {
          make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__961__1_4_p_0(Globals_5, Target_6);
