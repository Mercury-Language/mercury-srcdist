...
make__util__IntroducedFrom__func__make_dependency_list__559__1_2_f_0(
  MR_Word TargetType_5,
  MR_Word LambdaHeadVar__1_8);

static MR_Word MR_CALL 
make__util__IntroducedFrom__func__make_target_file_list__555__1_2_f_0(
  MR_Word TargetType_5,
  MR_Word LambdaHeadVar__1_8);

static void MR_CALL 
make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1042__1_4_p_0(
  MR_Word Globals_5,
  MR_Word Target_6);
...
static void MR_CALL 
make__util__IntroducedFrom__pred__debug_file_msg__927__1_5_p_0(
  MR_Word Globals_6,
...
{
  {
    MR_Word OptionValue_42;

    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 71, &OptionValue_42);
    switch (OptionValue_42) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
        }
      ...
      case (MR_Integer) 1:
        {
          make__util__IntroducedFrom__pred__maybe_symlink_or_copy_linked_target_message__1042__1_4_p_0(Globals_5, Target_6);
...
{
  {
    ...
    MR_Word Var_19;
    MR_Word Var_21;
    MR_Word ModuleName_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Target_6, (MR_Integer) 0))));
    MR_Word TargetType_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Target_6, (MR_Integer) 1))));

    switch (MR_tag((MR_Word) TargetType_34)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word TargetType_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetType_34, (MR_Integer) 0))));

          make__util__module_target_to_file_name_maybe_search_8_p_0(Globals_5, (MR_Integer) 1, (MR_Integer) 1, TargetType_51, ModuleName_33, &FileName_8);
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word LinkedTargetType_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), TargetType_34, (MR_Integer) 0))) & (MR_Integer) 7);

          make__util__linked_target_file_name_6_p_0(Globals_5, ModuleName_33, LinkedTargetType_38, &FileName_8);
        }
        break;
      case (MR_Integer) 2:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 71, &OptionValue_35);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 71, &OptionValue_36);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 71, &OptionValue_36);
    switch (OptionValue_36) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 97, &OptionValue_47);
    switch (OptionValue_47) {
      ...
      case (MR_Integer) 1:
        {
          make__util__IntroducedFrom__pred__debug_file_msg__927__1_5_p_0(Globals_6, TargetFile_7, Msg_8);
          mercury__io__flush_output_2_p_0();
        }
        break;
    }
...
{
  {
    ...
    MR_Word Var_24;
    MR_Word Var_25;
    MR_Word ModuleName_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetFile_7, (MR_Integer) 0))));
    MR_Word TargetType_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetFile_7, (MR_Integer) 1))));

    make__util__module_target_to_file_name_maybe_search_8_p_0(Globals_6, (MR_Integer) 1, (MR_Integer) 1, TargetType_41, ModuleName_40, &FileName_10);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 71, &OptionValue_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 97, &OptionValue_18);
    switch (OptionValue_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    conv0_LambdaHeadVar__2_9 = make__util__IntroducedFrom__func__make_dependency_list__559__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_9 = make__util__IntroducedFrom__func__make_target_file_list__555__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_9));
    return wrapper_arg_2;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__module_imports__module_dep_info_get_source_file_dir_2_p_0(ModuleDepInfo_23, &ModuleDir_24);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        parse_tree__module_imports__module_dep_info_get_source_file_name_2_p_0(ModuleDepInfo_18, FileName_12);
      }
    }
    else
    {
...
{
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&make__make__type_ctor_info_module_name_ext_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Cache0_16, ((MR_Box) (Key_15)), &conv0_FileName0_17);
    if (succeeded)
    {
    ...
    else
    {
      ...
      mercury__map__det_insert_4_p_0((MR_Word) (&make__make__type_ctor_info_module_name_ext_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Key_15)), ((MR_Box) (*FileName_12)), Cache0_16, &Cache_18);
