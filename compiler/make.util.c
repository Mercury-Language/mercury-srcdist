...
make__util__IntroducedFrom__func__make_target_id_list__296__1_2_f_0(
...
make__util__make_target_id_list_2_f_0_1(
  MR_Box closure_arg,
  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 134, &VerboseMake_7);
  ...
  MR_String * Msg_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 249, &Warn_12);
  ...
  MR_String * Msg_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 134, &VerboseMake_5);
...
make__util__verbose_make_four_part_msg_6_p_0(
  ...
  MR_String * Msg_12)
{
  make__util__option_set_four_part_msg_7_p_0(Globals_7, (MR_Integer) 134, Part1_8, Part2_9, Part3_10, Part4_11, Msg_12);
}
...
make__util__verbose_make_three_part_msg_5_p_0(
  ...
  MR_String * Msg_10)
{
  make__util__option_set_three_part_msg_6_p_0(Globals_6, (MR_Integer) 134, Part1_7, Part2_8, Part3_9, Msg_10);
}
...
make__util__verbose_make_two_part_msg_4_p_0(
  ...
  MR_String * Msg_8)
{
  make__util__option_set_two_part_msg_5_p_0(Globals_5, (MR_Integer) 134, Part1_6, Part2_7, Msg_8);
}
  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 134, &OptionValue_8);
  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 727, &DebugMake_7);
  switch (DebugMake_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      *Msg_6 = (MR_String) "";
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_9 = make__util__IntroducedFrom__func__make_target_id_list__296__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_9));
  return wrapper_arg_2;
}

MR_Word MR_CALL 
make__util__make_target_id_list_2_f_0(
  ...
  MR_Word TargetType_5)
{
...

  {
    ...
    MR_hl_field(0, Var_7, 1) = ((MR_Box) (make__util__make_target_id_list_2_f_0_1));
    MR_hl_field(0, Var_7, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_7, 3) = ((MR_Box) (TargetType_5));
  }
  HeadVar__3_3 = mercury__list__map_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_id_0), Var_7, ModuleNames_4);
  return HeadVar__3_3;
}
  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  mercury__io__file__remove_file_4_p_0(FileName_12, &Var_16);
