    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 600, &Ext_43);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 601, &Ext_42);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 521, &SearchDirs0_38);
