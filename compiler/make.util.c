  ...
  MR_Word Target_6)
{
  ...
  switch (MR_tag((MR_Word) TargetType_28)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word TargetType_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetType_28, (MR_Integer) 0))));

        make__util__module_target_to_file_name_maybe_search_8_p_0(Globals_5, (MR_Integer) 1, (MR_Integer) 1, TargetType_43, ModuleName_27, &FileName_8);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_String * FileName_9)
{
  ...
  switch (MR_tag((MR_Word) TargetType_8)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word TargetType_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TargetType_8, (MR_Integer) 0))));

        make__util__module_target_to_file_name_maybe_search_8_p_0(Globals_6, (MR_Integer) 1, (MR_Integer) 1, TargetType_26, ModuleName_7, FileName_9);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_String Msg_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 102, &OptionValue_26);
  ...
  MR_Word P_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 102, &OptionValue_17);
  switch (OptionValue_17) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  else
  {
    ...
    MR_Word TargetType_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Target_15, (MR_Integer) 1))));
    MR_String FileName_43;
    MR_Word STATE_VARIABLE_Info_22_44;
    MR_Word Var_26;
    MR_Word Var_27;

    make__util__get_file_name_8_p_0(Globals_8, (MR_Integer) 0, Target_15, &FileName_43, STATE_VARIABLE_Info_0_19, &STATE_VARIABLE_Info_22_44);
    succeeded = (TargetType_42 == (MR_Word) ((MR_Unsigned) 28U));
    if (succeeded)
      make__util__get_target_timestamp_analysis_registry_9_p_0(Globals_8, (MR_Integer) 0, Target_15, FileName_43, &MaybeTimestamp0_16, STATE_VARIABLE_Info_22_44, STATE_VARIABLE_Info_20);
    else
      make__util__get_target_timestamp_2_9_p_0(Globals_8, (MR_Integer) 0, Target_15, FileName_43, &MaybeTimestamp0_16, STATE_VARIABLE_Info_22_44, STATE_VARIABLE_Info_20);
