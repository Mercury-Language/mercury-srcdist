  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 80, &VerboseMake_7);
  ...
  MR_String * Msg_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 80, &VerboseMake_5);
...
make__util__verbose_make_four_part_msg_6_p_0(
  ...
  MR_String * Msg_12)
{
  make__util__option_set_four_part_msg_7_p_0(Globals_7, (MR_Integer) 80, Part1_8, Part2_9, Part3_10, Part4_11, Msg_12);
}
...
make__util__verbose_make_three_part_msg_5_p_0(
  ...
  MR_String * Msg_10)
{
  make__util__option_set_three_part_msg_6_p_0(Globals_6, (MR_Integer) 80, Part1_7, Part2_8, Part3_9, Msg_10);
}
...
make__util__verbose_make_two_part_msg_4_p_0(
  ...
  MR_String * Msg_8)
{
  make__util__option_set_two_part_msg_5_p_0(Globals_5, (MR_Integer) 80, Part1_6, Part2_7, Msg_8);
}
  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 80, &OptionValue_8);
  ...
  MR_String * Msg_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 124, &DebugMake_7);
  switch (DebugMake_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      *Msg_6 = (MR_String) "";
