...
void mercury__transform_hlds__smm_fixpoint_table__init_threadscope_string_table(void);
#endif
...
void mercury__transform_hlds__smm_fixpoint_table__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__smm_fixpoint_table);
