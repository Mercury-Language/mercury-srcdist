...
{
  {
    ...
    MR_Word parse_tree__check_raw_comp_unit__Var_16;
    MR_Word parse_tree__check_raw_comp_unit__Var_17;
    MR_Word parse_tree__check_raw_comp_unit__Var_18;
    MR_Word parse_tree__check_raw_comp_unit__Var_21;
    MR_Word parse_tree__check_raw_comp_unit__Var_24;
    MR_Word parse_tree__check_raw_comp_unit__Var_25;
    MR_Word parse_tree__check_raw_comp_unit__Var_87;
    MR_Word parse_tree__check_raw_comp_unit__Var_90;

    {
      parse_tree__check_raw_comp_unit__Var_25 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), parse_tree__check_raw_comp_unit__Var_25, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
      MR_hl_field(MR_mktag(3), parse_tree__check_raw_comp_unit__Var_25, 1) = ((MR_Box) (parse_tree__check_raw_comp_unit__ModuleName_4));
    }
    {
      parse_tree__check_raw_comp_unit__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_24, 0) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_25));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__check_raw_comp_unit_scalar_common_2[2])));
    }
    {
      parse_tree__check_raw_comp_unit__Var_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_21, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__check_raw_comp_unit_scalar_common_2[35])));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_21, 1) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_24));
    }
    {
      parse_tree__check_raw_comp_unit__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_18, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__check_raw_comp_unit_scalar_common_3[0])));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_18, 1) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_21));
    }
    {
      parse_tree__check_raw_comp_unit__Var_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), parse_tree__check_raw_comp_unit__Var_17, 0) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_18));
    }
    {
      parse_tree__check_raw_comp_unit__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_16, 0) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_17));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_16, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__check_raw_comp_unit_scalar_common_2[34])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Component_8, 0) = ((MR_Box) (((MR_Integer) 10 | (((MR_Integer) 1 << (MR_Integer) 10)))));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Component_8, 1) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_16));
    }
    {
      parse_tree__check_raw_comp_unit__Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_87, 0) = ((MR_Box) (parse_tree__check_raw_comp_unit__Component_8));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__check_raw_comp_unit__Msg_9, 1) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_87));
    }
    {
      parse_tree__check_raw_comp_unit__Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_90, 0) = ((MR_Box) (parse_tree__check_raw_comp_unit__Msg_9));
      MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Var_90, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      MR_Word base;
      ...
      *parse_tree__check_raw_comp_unit__Spec_6 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (parse_tree__check_raw_comp_unit__Var_90));
    }
  }
}
        ...
        if ((parse_tree__check_raw_comp_unit__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *parse_tree__check_raw_comp_unit__HeadVar__2_2 = (MR_Integer) 0;
        else
          {
            ...
            MR_Word parse_tree__check_raw_comp_unit__Var_6;
            ...
            if (parse_tree__check_raw_comp_unit__succeeded)
              {
                parse_tree__check_raw_comp_unit__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), parse_tree__check_raw_comp_unit__Item_3, (MR_Integer) 1)));
                /* direct tailcall eliminated */
                {
                  MR_Word parse_tree__check_raw_comp_unit__next_value_of_HeadVar__1_1 = parse_tree__check_raw_comp_unit__Items_4;

                  parse_tree__check_raw_comp_unit__HeadVar__1_1 = parse_tree__check_raw_comp_unit__next_value_of_HeadVar__1_1;
                }
                continue;
              }
            else
        ...
        if ((parse_tree__check_raw_comp_unit__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *parse_tree__check_raw_comp_unit__HeadVar__2_2 = (MR_Integer) 0;
        else
          {
            ...
            MR_Word parse_tree__check_raw_comp_unit__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__check_raw_comp_unit__RawItemBlock_3, (MR_Integer) 1)));
            ...
            if (parse_tree__check_raw_comp_unit__succeeded)
              {
                {
                  MR_Word parse_tree__check_raw_comp_unit__Var_11;
                  MR_Word parse_tree__check_raw_comp_unit__Var_12;

                  parse_tree__check_raw_comp_unit__succeeded = ((MR_tag((MR_Word) parse_tree__check_raw_comp_unit__Incls_8)) == (MR_mktag((MR_Integer) 1)));
                  if (parse_tree__check_raw_comp_unit__succeeded)
                    {
                      parse_tree__check_raw_comp_unit__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Incls_8, (MR_Integer) 0)));
                      parse_tree__check_raw_comp_unit__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__check_raw_comp_unit__Incls_8, (MR_Integer) 1)));
                    }
                }
                if (!(parse_tree__check_raw_comp_unit__succeeded))
                  {
                    MR_Word parse_tree__check_raw_comp_unit__Var_14;

                    {
                      parse_tree__check_raw_comp_unit__do_ms_interface_items_export_anything_2_p_0(parse_tree__check_raw_comp_unit__Items_10, &parse_tree__check_raw_comp_unit__Var_14);
                    }
                    parse_tree__check_raw_comp_unit__succeeded = ((MR_Integer) 1 == parse_tree__check_raw_comp_unit__Var_14);
                  }
              }
            if (parse_tree__check_raw_comp_unit__succeeded)
              *parse_tree__check_raw_comp_unit__HeadVar__2_2 = (MR_Integer) 1;
            else
              {
                /* direct tailcall eliminated */
                {
                  MR_Word parse_tree__check_raw_comp_unit__next_value_of_HeadVar__1_1 = parse_tree__check_raw_comp_unit__RawItemBlocks_4;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__check_raw_comp_unit__Globals_5, (MR_Integer) 10, &parse_tree__check_raw_comp_unit__ExportWarning_8);
    }
