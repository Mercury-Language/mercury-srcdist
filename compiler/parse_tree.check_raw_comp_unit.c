      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 12, &Warn_74);
            switch (Warn_74) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_Specs_76 = STATE_VARIABLE_Specs_0_75;
                break;
              case (MR_Integer) 1:
                parse_tree__check_raw_comp_unit__generate_no_exports_warning_4_p_0(ModuleName_9, ModuleNameContext_10, STATE_VARIABLE_Specs_0_75, STATE_VARIABLE_Specs_76);
                break;
            }
          }
        }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_9, 2) = ((MR_Box) ((MR_Unsigned) 12U));
