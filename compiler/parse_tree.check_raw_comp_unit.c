...
{
  {
    ...
    {
      Component_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Component_8, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 10))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10))));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RawItemBlock_3, (MR_Integer) 1))));
      MR_Word _Avails_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RawItemBlock_3, (MR_Integer) 3))));
      ...
      {
        {
          ...
          succeeded = ((MR_tag((MR_Word) Incls_8)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Incls_8, (MR_Integer) 0))));
            Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Incls_8, (MR_Integer) 1))));
          }
        }
        if (!(succeeded))
        {
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item_3)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Item_3, (MR_Integer) 0))) == (MR_Integer) 11)));
      if (succeeded)
      {
        Var_6 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_3, (MR_Integer) 1))));
        {
