...
static /* final */ const MR_Box parse_tree__check_raw_comp_unit_scalar_common_1[1][3] = {
  /* row 0 */
  {
    (MR_Box) (((((MR_Unsigned) 11U << 1)) | (MR_Unsigned) 1U)),
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Component_8, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 11) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_9, 0) = ((MR_Box) (Context_5));
      MR_hl_field(MR_mktag(1), Msg_9, 1) = ((MR_Box) (Var_87));
    }
    {
