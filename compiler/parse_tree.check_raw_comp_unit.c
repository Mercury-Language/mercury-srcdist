      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word IntTypeDefnsAbs_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 14))));
          MR_Word IntTypeDefnsMer_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 15))));
          MR_Word IntTypeDefnsFor_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 16))));
          MR_Word IntInstDefns_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 17))));
          MR_Word IntModeDefns_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 18))));
          ...
          if (succeeded)
          {
            succeeded = (IntTypeDefnsAbs_23 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              succeeded = (IntTypeDefnsMer_24 == (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                succeeded = (IntTypeDefnsFor_25 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  succeeded = (IntInstDefns_26 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    succeeded = (IntModeDefns_27 == (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 12, &Warn_53);
            switch (Warn_53) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_Specs_55 = STATE_VARIABLE_Specs_0_54;
