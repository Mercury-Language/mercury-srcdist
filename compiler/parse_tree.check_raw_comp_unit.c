...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 12, &ExportWarning_8);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word IntTypeDefnsAbs_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 13))));
          MR_Word IntTypeDefnsMer_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 14))));
          MR_Word IntTypeDefnsFor_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 15))));
          MR_Word IntInstDefns_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 16))));
          MR_Word IntModeDefns_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 17))));
          MR_Word IntTypeClasses_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 18))));
          MR_Word IntInstances_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 19))));
          MR_Word IntPredDecls_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 20))));
          MR_Word IntModeDecls_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 21))));
          MR_Word IntDeclPragmas_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 22))));
          MR_Word IntPromises_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 23))));
          ...
          if (succeeded)
          {
            succeeded = (IntTypeDefnsAbs_22 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              succeeded = (IntTypeDefnsMer_23 == (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                succeeded = (IntTypeDefnsFor_24 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  succeeded = (IntInstDefns_25 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    succeeded = (IntModeDefns_26 == (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      succeeded = (IntTypeClasses_27 == (MR_Word) ((MR_Unsigned) 0U));
                      if (succeeded)
                      {
                        succeeded = (IntInstances_28 == (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          succeeded = (IntPredDecls_29 == (MR_Word) ((MR_Unsigned) 0U));
                          if (succeeded)
                          {
                            succeeded = (IntModeDecls_30 == (MR_Word) ((MR_Unsigned) 0U));
                            if (succeeded)
                            {
                              succeeded = (IntDeclPragmas_31 == (MR_Word) ((MR_Unsigned) 0U));
                              if (succeeded)
                                succeeded = (IntPromises_32 == (MR_Word) ((MR_Unsigned) 0U));
                            }
                          }
                        }
                      }
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 12, &Warn_52);
            switch (Warn_52) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_Specs_54 = STATE_VARIABLE_Specs_0_53;
                break;
              case (MR_Integer) 1:
                parse_tree__check_raw_comp_unit__generate_no_exports_warning_4_p_0(ModuleName_9, ModuleNameContext_10, STATE_VARIABLE_Specs_0_53, STATE_VARIABLE_Specs_54);
                break;
            }
          }
          else
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_8, 1) = ((MR_Box) (Var_12));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_9, 2) = ((MR_Box) ((MR_Unsigned) 16U));
