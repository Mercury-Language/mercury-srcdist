...
static /* final */ const MR_Box parse_tree__check_raw_comp_unit_scalar_common_1[1][3] = {
  /* row 0 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 10) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1))),
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Component_8, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 10) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Incls_8)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
        if (!(succeeded))
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item_3)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Item_3, (MR_Integer) 0))) == (MR_Integer) 11)));
      if (succeeded)
      {
        {
