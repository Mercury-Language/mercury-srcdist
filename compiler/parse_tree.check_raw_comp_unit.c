...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Component_8, 0) = ((MR_Box) (((MR_Integer) 10 | (((MR_Integer) 1 << (MR_Integer) 10)))));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item_3)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Item_3, (MR_Integer) 0)))) == (MR_Integer) 10)));
      if (succeeded)
      {
