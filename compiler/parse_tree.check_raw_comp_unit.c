...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 10, &ExportWarning_12);
            ...
            case (MR_Integer) 0:
              {
                ...
                parse_tree__check_raw_comp_unit__generate_no_exports_warning_3_p_0(ModuleName_8, Context_9, &WarnSpec_14);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *STATE_VARIABLE_Specs_16 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (WarnSpec_14));
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Incls_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RawItemBlock_3, (MR_Integer) 3))));
      MR_Word Items_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RawItemBlock_3, (MR_Integer) 5))));

      succeeded = (Section_7 == (MR_Integer) 0);
      if (succeeded)
      {
        succeeded = (Incls_9 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
        }
        if (!(succeeded))
        {
          ...
          parse_tree__check_raw_comp_unit__do_ms_interface_items_export_anything_2_p_0(Items_11, &Var_15);
  ...
  MR_Word * HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item_3)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_3, (MR_Integer) 0)))) == (MR_Integer) 12)));
      if (succeeded)
      {
        {
