  ...
  MR_Word * STATE_VARIABLE_VarTable_14)
{
  ...
  Var_18 = mercury__term__context_init_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(3), Var_23, 1) = ((MR_Box) (MR_Word) (Char_7));
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_18, *Var_10, Var_23, Goal_9);
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_14)
{
  ...
  Var_18 = mercury__term__context_init_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(3), Var_23, 1) = MR_box_float(Float_7);
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_18, *Var_10, Var_23, Goal_9);
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_14)
{
  ...
  Var_18 = mercury__term__context_init_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(3), Var_23, 1) = ((MR_Box) (String_7));
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_18, *Var_10, Var_23, Goal_9);
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_14)
{
  ...
  Var_18 = mercury__term__context_init_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (Int_7));
  }
  {
    ConsId_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), ConsId_23, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(MR_mktag(3), ConsId_23, 1) = ((MR_Box) (Var_24));
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_18, *Var_10, ConsId_23, Goal_9);
}
