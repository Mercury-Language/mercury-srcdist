...
{
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0), Arity_9, ((MR_Box) (UnifyMode_11)), &ArgModes_12);
    {
      ...
      MR_hl_field(MR_mktag(0), Unification_13, 4) = ((MR_Box) ((MR_Unsigned) 4U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Unification_12, 4) = ((MR_Box) ((MR_Unsigned) 4U));
