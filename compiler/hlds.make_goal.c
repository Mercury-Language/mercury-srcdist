...
static /* final */ const MR_Box hlds__make_goal_scalar_common_3[4][4] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
    ((MR_Box) (MR_mkword(3, &hlds__make_goal_scalar_common_2[1]))),
    ((MR_Box) (MR_mkword(3, &hlds__make_goal_scalar_common_2[1]))),
    ((MR_Box) (MR_mkword(3, &hlds__make_goal_scalar_common_2[1])))
  },
  /* row   3 */
  ...
  MR_Word * Goal_8)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Unify_15, 4) = ((MR_Box) (&hlds__make_goal_scalar_common_1[2]));
  }
  {
  ...
  MR_Word * Goal_8)
{
  ...
  {
    Inst_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Inst_10, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(3, Inst_10, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    MR_hl_field(3, Inst_10, 2) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(3, Inst_10, 3) = ((MR_Box) (Var_23));
  }
  {
    UnifyMode_11 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
  ...
  }
  {
    ...
    MR_hl_field(1, GoalExpr_14, 4) = ((MR_Box) (&hlds__make_goal_scalar_common_1[2]));
  }
