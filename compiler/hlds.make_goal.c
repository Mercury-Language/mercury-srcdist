...
{
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0), Arity_9, ((MR_Box) (UnifyMode_11)), &ArgModes_12);
    {
      ...
      MR_hl_field(MR_mktag(0), Unification_13, 4) = ((MR_Box) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(0), Unification_13, 5) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Unification_13, 6) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      Unify_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Unify_15, 0) = ((MR_Box) (Var_5));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), RHS_9, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Inst_10, 2) = ((MR_Box) ((MR_Integer) 4));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Unification_12, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Unification_12, 3) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Unification_12, 4) = ((MR_Box) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(0), Unification_12, 5) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Unification_12, 6) = ((MR_Box) ((MR_Integer) 0));
    }
    {
