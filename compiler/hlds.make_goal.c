  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  Var_17 = mercury__term_context__dummy_context_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(3), Var_18, 1) = ((MR_Box) (MR_Word) (Char_7));
  }
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  {
    Var_18 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_18, 0) = ((MR_Box) ((MR_Unsigned) 6U));
    MR_hl_field(MR_mktag(3), Var_18, 1) = MR_box_float(Float_7);
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_17, *Var_10, Var_18, Goal_9);
}
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  {
    Var_18 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_18, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    MR_hl_field(MR_mktag(3), Var_18, 1) = ((MR_Box) (String_7));
  }
  hlds__make_goal__make_const_construction_4_p_0(Var_17, *Var_10, Var_18, Goal_9);
}
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  Var_17 = mercury__term_context__dummy_context_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (Int_7));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), ConsId_18, 1) = ((MR_Box) (Var_19));
  }
  ...
  MR_Word * Goal_6)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_7, 0) = ((MR_Box) (Var2_5));
    }
