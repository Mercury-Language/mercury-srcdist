...
static /* final */ const MR_Box hlds__make_goal_scalar_common_2[4][4];

static /* final */ const MR_Box hlds__make_goal_scalar_common_3[2][3];
...
static /* final */ const MR_Box hlds__make_goal_scalar_common_2[4][4] = {
  ...
  /* row 1 */
  {
    ...
    ((MR_Box) (&hlds__make_goal_scalar_common_2[0])),
    (MR_Box) ((MR_Unsigned) 0U),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 2 */
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[1]))),
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[1]))),
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[1])))
  },
  /* row 3 */
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Unify_15, 4) = ((MR_Box) (&hlds__make_goal_scalar_common_1[3]));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), GoalExpr_16, 2) = ((MR_Box) (&hlds__make_goal_scalar_common_2[3]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), GoalExpr_16, 0) = ((MR_Box) (X_6));
      MR_hl_field(MR_mktag(1), GoalExpr_16, 1) = ((MR_Box) (Var_29));
      MR_hl_field(MR_mktag(1), GoalExpr_16, 2) = ((MR_Box) (&hlds__make_goal_scalar_common_2[2]));
      MR_hl_field(MR_mktag(1), GoalExpr_16, 3) = ((MR_Box) (Unification_13));
      MR_hl_field(MR_mktag(1), GoalExpr_16, 4) = ((MR_Box) (UnifyContext_14));
    }
    {
...
{
  {
    ...
    hlds__hlds_goal__goal_info_init_context_purity_3_p_0(Context_10, Purity_13, &GoalInfo_18);
    {
      ...
      MR_hl_field(MR_mktag(1), GoalExpr_19, 2) = ((MR_Box) (&hlds__make_goal_scalar_common_2[0]));
      MR_hl_field(MR_mktag(1), GoalExpr_19, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_2[1])));
...
{
  return (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[0]));
}
...
{
  {
    ...
    {
      HeadVar__1_1 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[0])));
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 1) = ((MR_Box) (GoalInfo_2));
    }
    return HeadVar__1_1;
  }
