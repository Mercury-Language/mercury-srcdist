...
{
  {
    ...
    hlds__hlds_goal__goal_info_init_context_purity_3_p_0(Context_10, Purity_13, &GoalInfo_18);
    {
      ...
      MR_hl_field(MR_mktag(1), GoalExpr_19, 2) = ((MR_Box) (&hlds__make_goal_scalar_common_1[2]));
      MR_hl_field(MR_mktag(1), GoalExpr_19, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_goal_scalar_common_3[0])));
