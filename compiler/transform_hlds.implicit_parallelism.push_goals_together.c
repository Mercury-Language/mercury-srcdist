...
transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__652__1_2_p_0(
  MR_Word TailPaths_9,
  MR_Word HeadVar__2_118);

static MR_bool MR_CALL 
transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__673__1_2_p_0(
  MR_Word TailPaths_9,
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_25, VarTypes_26, STATE_VARIABLE_ProcInfo_55_55, &STATE_VARIABLE_ProcInfo_56_56);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_27, STATE_VARIABLE_ProcInfo_56_56, STATE_VARIABLE_ProcInfo_32);
      }
      break;
  }
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__673__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__652__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
