...
{
  {
    ...
    if (transform_hlds__implicit_parallelism__push_goals_together__succeeded)
      *transform_hlds__implicit_parallelism__push_goals_together__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__implicit_parallelism__push_goals_together__Var_4 = (MR_Word) transform_hlds__implicit_parallelism__push_goals_together__HeadVar__2_2;
        MR_Word transform_hlds__implicit_parallelism__push_goals_together__Var_5 = (MR_Word) transform_hlds__implicit_parallelism__push_goals_together__HeadVar__3_3;

        {
          hlds__hlds_rtti____Compare____rtti_varmaps_0_0(transform_hlds__implicit_parallelism__push_goals_together__HeadVar__1_1, transform_hlds__implicit_parallelism__push_goals_together__Var_4, transform_hlds__implicit_parallelism__push_goals_together__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (transform_hlds__implicit_parallelism__push_goals_together__succeeded)
      ...
      {
        MR_Word transform_hlds__implicit_parallelism__push_goals_together__Var_3 = (MR_Word) transform_hlds__implicit_parallelism__push_goals_together__HeadVar__1_1;
        MR_Word transform_hlds__implicit_parallelism__push_goals_together__Var_4 = (MR_Word) transform_hlds__implicit_parallelism__push_goals_together__HeadVar__2_2;

        {
          transform_hlds__implicit_parallelism__push_goals_together__succeeded = hlds__hlds_rtti____Unify____rtti_varmaps_0_0(transform_hlds__implicit_parallelism__push_goals_together__Var_3, transform_hlds__implicit_parallelism__push_goals_together__Var_4);
        }
      }
    return transform_hlds__implicit_parallelism__push_goals_together__succeeded;
  }
