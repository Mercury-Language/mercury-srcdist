  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_29, &RttiVarMaps0_15);
  {
    ...
    MR_hl_field(MR_mktag(0), PushInfo_16, 0) = ((MR_Box) (Globals_11));
    MR_hl_field(MR_mktag(0), PushInfo_16, 1) = ((MR_Box) (ModuleName_12));
    MR_hl_field(MR_mktag(0), PushInfo_16, 2) = ((MR_Box) (RttiVarMaps0_15));
  }
