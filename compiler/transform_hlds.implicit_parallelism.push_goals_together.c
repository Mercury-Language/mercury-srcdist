...
MR_decl_label6(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0, 42,7,6,13,2,1)
MR_decl_label4(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0, 49,4,7,1)
MR_decl_label6(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0, 42,7,6,13,2,1)
...
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0, 138,2,3,8,12,16,51,13,10,20)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0, 22,27,29,30,32,33,24,36,60,40)
MR_decl_label1(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0, 38)
...
MR_decl_label9(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0, 2,7,8,14,16,18,20,21,4)
...
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 5,3,8,14,15,10,20,22,24,25)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 26,16,17,9,34,35,37,38,31,44)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 46,51,54,53,55,52,58,57,56,42)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 68,69,73,76,78,67,121,84,82,89)
MR_decl_label4(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 90,92,93,87)
...
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0)
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0)
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0)
...
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__643__1_2_0)
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__622__1_2_0)
...
"transform_hlds.implicit_parallelism.push_goals_together",
"transform_hlds.implicit_parallelism.push_goals_together",
"lambda_push_goals_together_m_643",
2,
0
},
"transform_hlds.implicit_parallelism.push_goals_together",
...
"transform_hlds.implicit_parallelism.push_goals_together",
"transform_hlds.implicit_parallelism.push_goals_together",
"lambda_push_goals_together_m_622",
2,
0
},
"transform_hlds.implicit_parallelism.push_goals_together",
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module0)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,138,2,3,8,12,16,51,13,10,20)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,22,27,29,30,32,33,24,36,60,40)
	MR_init_label1(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,38)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,3)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i60);
	}
	...
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i138);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,12)
	...
	MR_np_call_localret_ent(list__all_true_2_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i16);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i60);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,10)
	...
	if (MR_RTAGS_TESTR(MR_sv(2),3,2)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i20);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,3)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i22);
	}
	MR_r1 = MR_sv(1);
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_list_3_0);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,6)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i24);
	}
	{
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i27);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i29);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i30);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i32);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tfield(1, MR_sv(2), 0);
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i33);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i51);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,5)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i36);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tfield(3, MR_sv(2), 2);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i138);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,7)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i38);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(3, MR_sv(2), 1);
	if (!(((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))))) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i40);
	}
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.implicit_parallelism.push_goals_together", 55);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.implicit_parallelism.push_goals_together.is_pushable_goal\'/3", 86);
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module7)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0);
	MR_init_label6(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,42,7,6,13,2,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'build_disj_paths_map'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(1, MR_r1, 0);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i1);
	}
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i7);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i6);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i13);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i13);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0_i42);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module8)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0);
	MR_init_label6(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,42,7,6,13,2,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'build_switch_paths_map'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(1, MR_r1, 0);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i1);
	}
	MR_tempr2 = MR_tfield(1, MR_tempr1, 0);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i7);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i6);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i13);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i13);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0_i42);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module9)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0);
	MR_init_label4(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,49,4,7,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'build_ite_paths_map'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0_i49);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(1, MR_r1, 0);
	MR_r1 = MR_tfield(1, MR_r1, 1);
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0_i4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0_i1);
	}
	...
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0_i7);
	}
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0_i1);
	}
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(2);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module11)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,5,3,8,14,15,10,20,22,24,25)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,26,16,17,9,34,35,37,38,31,44)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,46,51,54,53,55,52,58,57,56,42)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,68,69,73,76,78,67,121,84,82,89)
	MR_init_label4(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,90,92,93,87)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__622__1_2_0);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,8)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__643__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r3;
	MR_tfield(0, MR_tempr1, 4) = (MR_Word) MR_tbmkword(0, 0);
	MR_sv(3) = MR_r1;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,10)
	...
	MR_np_call_localret_ent(list__map_3_2,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i20);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_np_call_localret_ent(list__index1_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i22);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i16);
	}
	...
	MR_np_call_localret_ent(list__length_2_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i24);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(8) != MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i16);
	}
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,9)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,3)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i31);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i34);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__build_disj_paths_map_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i35);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,6)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i42);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i44);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
	...
	MR_r5 = MR_tfield(1, MR_tempr2, 0);
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i46);
	}
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r5 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_r4;
	...
	MR_sv(1) = MR_r3;
	MR_r3 = MR_tempr1;
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i51);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i53);
	}
	MR_sv(3) = MR_r1;
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__add_goals_at_end_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i54);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,54)
	...
	MR_sv(3) = MR_r4;
	MR_r3 = (MR_Integer) 1;
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i52);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	{
	MR_Word MR_tempr1;
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i55);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i57);
	}
	MR_sv(1) = MR_r3;
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__add_goals_at_end_3_0,
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,57)
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i56);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,5)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i67);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	...
	MR_sv(9) = MR_tfield(0, MR_sv(8), 1);
	MR_r1 = MR_sv(4);
	}
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_determinism_1_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i68);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_sv(9) = MR_r1;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_determinism_1_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i69);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(9) != MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__maybe_steps_after_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i73);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,76)
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i78);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,7)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i82);
	}
	MR_r2 = MR_tfield(3, MR_r5, 1);
	if (!(((MR_tag(MR_r2) == MR_mktag((MR_Integer) 1)) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 2))))) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i84);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,121)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_r2 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.implicit_parallelism.push_goals_together", 55);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,82)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i121);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i89);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__build_switch_paths_map_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i90);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i87);
	}
	...
	MR_np_call_localret_ent(map__to_assoc_list_2_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i92);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__push_into_cases_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i93);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Integer) 0;
	MR_decr_sp_and_return(10);
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module15)
	...
	MR_init_label9(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,2,7,8,14,16,18,20,21,4)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,8)
	...
	MR_np_call_localret_ent(list__map_3_2,
		transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i14);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i4);
	}
	...
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(list__index1_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i16);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i4);
	}
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i18);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(list__det_replace_nth_4_0,
		transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0_i20);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__perform_push_transform_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module30)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__643__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__643__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__push_into_goal__643__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__643__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module31)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__622__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__622__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__push_into_goal__622__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__622__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
void mercury__transform_hlds__implicit_parallelism__push_goals_together__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__implicit_parallelism__push_goals_together);
