          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mercury__list__map_3_p_2(TypeCtorInfo_140_140, TypeCtorInfo_140_140, Var_113, TailPaths_9, &LaterTailPaths_44);
                  if (succeeded)
                  {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mdbcomp__goal_path____Unify____goal_path_step_0_0(Var_97, Var_154);
                  if (succeeded)
                  {
                    ...
                    succeeded = mercury__list__map_3_p_2(TypeCtorInfo_153_153, TypeCtorInfo_153_153, Var_99, TailPaths_9, &TailPathsAfter_80);
                  }
                }
              }
              if (succeeded)
