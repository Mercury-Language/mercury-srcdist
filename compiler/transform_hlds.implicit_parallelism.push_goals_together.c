        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 1)));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 1)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 4)));
                  MR_Word Var_87;
