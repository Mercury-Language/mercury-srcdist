      ...
      if ((transform_hlds__implicit_parallelism__push_goals_together__HeadVar__4_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_32, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_2[2]));
    ...
    if ((transform_hlds__implicit_parallelism__push_goals_together__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      if ((transform_hlds__implicit_parallelism__push_goals_together__HeadVar__4_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
        {
          ...
          {
            transform_hlds__implicit_parallelism__push_goals_together__Var_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_32, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_2[1]));
    ...
    if ((transform_hlds__implicit_parallelism__push_goals_together__HeadPath_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_116, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_3[1]));
                  ...
                  if (transform_hlds__implicit_parallelism__push_goals_together__succeeded)
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_110, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_3[1]));
                      ...
                      if (transform_hlds__implicit_parallelism__push_goals_together__succeeded)
                        {
                          ...
                          transform_hlds__implicit_parallelism__push_goals_together__TypeCtorInfo_143_143 = (MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_forward_goal_path_0;
                          {
                            ...
                            MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_114, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_2[0]));
                  ...
                  case (MR_Integer) 1:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_89, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_3[0]));
                            ...
                            if (transform_hlds__implicit_parallelism__push_goals_together__succeeded)
                              {
                                ...
                                transform_hlds__implicit_parallelism__push_goals_together__TypeCtorInfo_50_50 = (MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_forward_goal_path_0;
                                {
                                  ...
                                  MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__push_goals_together__Var_38, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__push_goals_together_scalar_common_2[0]));
