...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Case_23 = Case0_21;
        Var_29 = (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Goal_23 = Goal0_21;
        Var_25 = (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 1);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          switch (GoalPushable_26) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer Var_28 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
        ...
        else
        {
          ...
          Var_30 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
            ...
            case (MR_Integer) 3:
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    GoalExpr_119 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_119, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    GoalExpr_122 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_122, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                    MR_hl_field(MR_mktag(3), GoalExpr_122, 1) = ((MR_Box) (Var_54));
                    MR_hl_field(MR_mktag(3), GoalExpr_122, 2) = ((MR_Box) (CanFail_55));
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    GoalExpr_135 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), GoalExpr_135, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            ...
            case (MR_Integer) 6:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = (HeadFirstStep_162 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                  if (succeeded)
                  {
                    {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      GoalExpr_130 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), GoalExpr_130, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
...
{
  {
    ...
    else
    {
      ...
      MR_Integer Var_22 = (MR_Integer) ((MR_Unsigned) Cur_14 + (MR_Unsigned) (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              MR_Word LoHiTail_20;
              MR_Integer Var_22 = (MR_Integer) ((MR_Unsigned) HeadVar__4_4 + (MR_Unsigned) (MR_Integer) 1);
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            MR_Word Goals_107 = ((MR_Word) (MR_hl_field(MR_mktag(1), Goals_101, (MR_Integer) 1)));
