...
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0, 3,9,6,16,13,23,20,30,27,37)
MR_decl_label7(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0, 34,44,41,51,48,58,55)
...
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0, 139,2,3,10,15,51,11,8,19,21)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0, 26,28,29,31,32,23,35,37,61,41)
...
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 5,3,13,14,9,20,22,24,25,26)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 15,16,8,36,37,39,40,31,46,48)
MR_decl_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0, 53,56,55,57,54,60,59,58,44,69)
...
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__624__1_2_0)
MR_decl_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__645__1_2_0)
...
"transform_hlds.implicit_parallelism.push_goals_together",
"transform_hlds.implicit_parallelism.push_goals_together",
"lambda_push_goals_together_m_645",
2,
0
},
"transform_hlds.implicit_parallelism.push_goals_together",
...
"transform_hlds.implicit_parallelism.push_goals_together",
"transform_hlds.implicit_parallelism.push_goals_together",
"lambda_push_goals_together_m_624",
2,
0
},
"transform_hlds.implicit_parallelism.push_goals_together",
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module0)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,139,2,3,10,15,51,11,8,19,21)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,26,28,29,31,32,23,35,37,61,41)
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,10)
	...
	if (MR_PTAG_TESTR(MR_r3,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i11);
	}
	...
	MR_np_call_localret_ent(list__all_true_2_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i15);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i61);
	}
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,51)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,8)
	...
	if (MR_RTAGS_TESTR(MR_sv(2),3,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i19);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,21)
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i26);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i28);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,28)
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i29);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i31);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,31)
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i32);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,23)
	...
	if (MR_RTAGS_TESTR(MR_sv(2),3,4)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i35);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0_i139);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__is_pushable_goal_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module11)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,5,3,13,14,9,20,22,24,25,26)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,15,16,8,36,37,39,40,31,46,48)
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,53,56,55,57,54,60,59,58,44,69)
...
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__624__1_2_0);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,3)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__645__1_2_0);
	...
	MR_np_call_localret_ent(require__expect_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i13);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__add_goals_at_end_3_0,
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i15);
	}
	MR_sv(8) = MR_r2;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,31)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,6)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i44);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__build_ite_steps_map_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i46);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,46)
	...
	MR_r5 = MR_tfield(1, MR_tempr2, 0);
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i48);
	}
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r5 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_r4;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i91);
	}
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,54)
	...
	MR_sv(2) = MR_r3;
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__add_goals_at_end_3_0,
		transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i60);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0,44)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__push_into_goal_6_0_i69);
	}
	MR_r1 = MR_r4;
	MR_r2 = (MR_Integer) 0;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module16)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,3,9,6,16,13,23,20,30,27,37)
	MR_init_label7(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,34,44,41,51,48,58,55)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,3)
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,6)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i55);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i34);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_tfield(0, MR_r4, 0);
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goals_7_0,
		transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i37);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i41);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_tfield(0, MR_r4, 0);
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goals_7_0,
		transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i44);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,1)) {
		MR_GOTO_LAB(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i48);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(0, MR_r4, 0);
	...
	MR_np_localcall_lab(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,
		transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i51);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_cases_7_0,
		transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0_i58);
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 4);
...
MR_def_label(transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_r4;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module30)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__624__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__624__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__push_into_goal__624__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__624__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism__push_goals_together_module31)
	MR_init_entry1(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__645__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__645__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__push_into_goal__645__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__implicit_parallelism__push_goals_together__IntroducedFrom__pred__push_into_goal__645__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
