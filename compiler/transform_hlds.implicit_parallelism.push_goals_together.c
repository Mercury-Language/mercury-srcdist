        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 1)));
              Goals0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 2))));
              {
                ...
                transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goals_7_p_0(N_22, Path_15, PushGoal_2, PushInfo_3, Result_4, Goals0_24, &Goals_25);
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_26, 1) = (MR_Box) (packed_args_0);
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 2)));
                  Cases0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 3))));
                  {
                    ...
                    transform_hlds__implicit_parallelism__push_goals_together__do_push_in_cases_7_p_0(N_93, Path_15, PushGoal_2, PushInfo_3, Result_4, Cases0_31, &Cases_32);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), GoalExpr_91, 2) = (MR_Box) (packed_args_1);
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 1)));
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    mercury__list__det_replace_nth_4_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Conjuncts0_41, ConjNum_43, ((MR_Box) (SelectedConjunct_47)), &Conjuncts_48);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), GoalExpr_49, 1) = (MR_Box) (packed_args_0);
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 2)));
                ...
                if (succeeded)
                {
                  ...
                  transform_hlds__implicit_parallelism__push_goals_together__push_into_cases_6_p_0(LoHi_7, PathsList_123, (MR_Integer) 1, Cases0_56, &Cases_57, Pushable_12);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), GoalExpr_122, 2) = (MR_Box) (packed_args_1);
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 4)));
                  MR_Word Var_87;
