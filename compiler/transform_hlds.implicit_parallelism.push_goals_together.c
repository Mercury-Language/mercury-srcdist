  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, STATE_VARIABLE_ProcInfo_0_29, &VarTable0_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_clause_body_general_vt_9_p_0((MR_Integer) 1, HeadVars_21, &_Warnings_22, Goal1_20, &Goal2_23, VarTable0_14, &VarTable_24, RttiVarMaps0_15, &RttiVarMaps_25);
  ...
  MR_Word * STATE_VARIABLE_Goal_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_String GoalPathStr_25 = ((MR_String) ((MR_hl_field(MR_mktag(0), PushGoal_11, (MR_Integer) 0))));
      MR_Word GoalPath_29;

      succeeded = mdbcomp__goal_path__goal_path_from_string_2_p_0(GoalPathStr_25, &GoalPath_29);
      if (succeeded)
      {
        MR_Word Result_15;
        MR_Word STATE_VARIABLE_Goal_18_18;

        transform_hlds__implicit_parallelism__push_goals_together__do_push_in_goal_6_p_0(PushInfo_1, GoalPath_29, PushGoal_11, &Result_15, STATE_VARIABLE_Goal_0_4, &STATE_VARIABLE_Goal_18_18);
        switch (Result_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = transform_hlds__implicit_parallelism__push_goals_together__maybe_steps_after_3_p_0(Var_112, HeadPath_8, &HeadPathAfter_79);
                if (succeeded)
                {
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word ThenPathsTail_158;
              MR_Word ElsePathsTail_159;
              MR_Word HeadFirstStep_160;
              MR_Word HeadLaterPath_161;

              succeeded = transform_hlds__implicit_parallelism__push_goals_together__build_ite_paths_map_3_p_0(TailPaths_9, &ThenPathsTail_158, &ElsePathsTail_159);
              if (succeeded)
              {
                HeadFirstStep_160 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadPath_8, (MR_Integer) 0))));
                HeadLaterPath_161 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadPath_8, (MR_Integer) 1))));
                succeeded = (HeadFirstStep_160 == (MR_Word) ((MR_Unsigned) 4U));
                if (succeeded)
                {
                  {
                    ThenPaths_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ThenPaths_62, 0) = ((MR_Box) (HeadLaterPath_161));
                    MR_hl_field(MR_mktag(1), ThenPaths_62, 1) = ((MR_Box) (ThenPathsTail_158));
                  }
                  ElsePaths_63 = ElsePathsTail_159;
                  succeeded = MR_TRUE;
                }
                else
                {
                  ...
                  if (succeeded)
                  {
                    ThenPaths_62 = ThenPathsTail_158;
                    {
                      ElsePaths_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ElsePaths_63, 0) = ((MR_Box) (HeadLaterPath_161));
                      MR_hl_field(MR_mktag(1), ElsePaths_63, 1) = ((MR_Box) (ElsePathsTail_159));
                    }
                    succeeded = MR_TRUE;
                  }
                }
