...
void MR_CALL 
backend_libs__lookup_switch_util__get_word_bits_3_p_0(
  MR_Word Globals_4,
    ...
    case (MR_Integer) 1:
      {
        ...
        backend_libs__lookup_switch_util__filter_out_failing_cases_loop_5_p_0(STATE_VARIABLE_TaggedCases_0_9, (MR_Word) ((MR_Unsigned) 0U), &RevTaggedCases_13, STATE_VARIABLE_SwitchCanFail_0_11, STATE_VARIABLE_SwitchCanFail_12);
