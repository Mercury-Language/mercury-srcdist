  ...
  MR_Integer * NumValuesInRange_12)
{
  ...
  if (((MR_tag((MR_Word) TypeCtorCat_8)) == (MR_Integer) 1))
  {
    MR_Word Globals_13;
    MR_Word Target_14;
    MR_Word Var_35 = ((MR_Word) ((MR_hl_field(1, TypeCtorCat_8, 0))));
  ...
  if (((MR_tag((MR_Word) TypeCtorCat_8)) == (MR_Integer) 2))
  {
    ...
    MR_Word TypeDefn_17;
    MR_Word TypeBody_18;
    MR_Word Var_36 = ((MR_Unsigned) ((MR_hl_field(2, TypeCtorCat_8, 0))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word MaybeSuperType_21 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_19, 1))));
            MR_Word MaybeRepn_23 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_19, 3))));
            MR_Word Repn_25;
            ...
            if ((MaybeRepn_23 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              Repn_25 = ((MR_Word) ((MR_hl_field(1, MaybeRepn_23, 0))));
            if ((MaybeSuperType_21 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word TailCtors_27;

              *Min_10 = (MR_Integer) 0;
              TailCtors_27 = ((MR_Word) ((MR_hl_field(0, OoMCtors_20, 1))));
            ...
            else
            {
              ...
              MR_Word CtorRepns_30 = ((MR_Word) ((MR_hl_field(0, Repn_25, 0))));
              MR_Word CtorRepn_48;
              ...
              if (succeeded)
              {
                CtorRepn_48 = ((MR_Word) ((MR_hl_field(1, CtorRepns_30, 0))));
                CtorRepns_49 = ((MR_Word) ((MR_hl_field(1, CtorRepns_30, 1))));
                ConsTag_50 = ((MR_Word) ((MR_hl_field(0, CtorRepn_48, 3))));
                succeeded = ((MR_tag((MR_Word) ConsTag_50)) == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_62 = ((MR_Word) ((MR_hl_field(1, ConsTag_50, 0))));
                  succeeded = ((MR_tag((MR_Word) Var_62)) == (MR_Integer) 0);
                  if (succeeded)
                    IntPrime_61 = ((MR_Integer) ((MR_hl_field(0, Var_62, 0))));
                }
                if (succeeded)
                  Int_51 = IntPrime_61;
                else
