  ...
  MR_Integer * STATE_VARIABLE_Max_14)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
      IntPrime_21 = ((MR_Integer) ((MR_hl_field(0, Var_22, 0))));
  }
  if (succeeded)
    Int_10 = IntPrime_21;
  else
  ...
  MR_Word ConsTag_3)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
      IntPrime_5 = ((MR_Integer) ((MR_hl_field(0, Var_6, 0))));
  }
  if (succeeded)
    Int_4 = IntPrime_5;
  else
      ...
      case (MR_Integer) 0:
        {
          ...
          TypeCategory_26 = hlds__type_util__classify_type_2_f_0(ModuleInfo_12, SwitchVarType_13);
  ...
  MR_Integer * NumValuesInRange_12)
{
  ...
  if (((MR_tag((MR_Word) TypeCtorCat_8)) == (MR_Integer) 1))
  {
    MR_Word Globals_13;
    MR_Word Target_14;
    MR_Word Var_36 = ((MR_Word) ((MR_hl_field(1, TypeCtorCat_8, 0))));
  ...
  if (((MR_tag((MR_Word) TypeCtorCat_8)) == (MR_Integer) 2))
  {
    ...
    MR_Word TypeDefn_17;
    MR_Word TypeBody_18;
    MR_Word Var_37 = ((MR_Unsigned) ((MR_hl_field(2, TypeCtorCat_8, 0))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word OoMCtors_20 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_19, 0))));
            MR_Word MaybeSuperType_22 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_19, 2))));
            MR_Word MaybeRepn_24 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_19, 4))));
            MR_Word Repn_26;
            ...
            if ((MaybeRepn_24 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              Repn_26 = ((MR_Word) ((MR_hl_field(1, MaybeRepn_24, 0))));
            if ((MaybeSuperType_22 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word TailCtors_28;

              *Min_10 = (MR_Integer) 0;
              TailCtors_28 = ((MR_Word) ((MR_hl_field(0, OoMCtors_20, 1))));
              mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), TailCtors_28, Max_11);
              succeeded = MR_TRUE;
            }
            else
            {
              ...
              MR_Word CtorRepns_31 = ((MR_Word) ((MR_hl_field(0, Repn_26, 0))));
              MR_Word CtorRepn_49;
              MR_Word CtorRepns_50;
              MR_Word ConsTag_51;
              MR_Integer Int_52;
              MR_Word Var_53;
              MR_Integer IntPrime_62;
              MR_Word Var_63;
              MR_Box conv3_Min_10;
              MR_Box conv2_Max_11;

              succeeded = (CtorRepns_31 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                CtorRepn_49 = ((MR_Word) ((MR_hl_field(1, CtorRepns_31, 0))));
                CtorRepns_50 = ((MR_Word) ((MR_hl_field(1, CtorRepns_31, 1))));
                ConsTag_51 = ((MR_Word) ((MR_hl_field(0, CtorRepn_49, 3))));
                succeeded = ((MR_tag((MR_Word) ConsTag_51)) == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_63 = ((MR_Word) ((MR_hl_field(1, ConsTag_51, 0))));
                  succeeded = ((MR_tag((MR_Word) Var_63)) == (MR_Integer) 0);
                  if (succeeded)
                    IntPrime_62 = ((MR_Integer) ((MR_hl_field(0, Var_63, 0))));
                }
                if (succeeded)
                  Int_52 = IntPrime_62;
                else
                  mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.lookup_switch_util.get_int_tag\'/1", (MR_String) "not int_tag");
                Var_53 = (MR_Word) (&backend_libs__lookup_switch_util_scalar_common_3[0]);
                TypeCtorInfo_23_60 = (MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0);
                TypeCtorInfo_24_61 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
                mercury__list__foldl2_6_p_0(TypeCtorInfo_23_60, TypeCtorInfo_24_61, TypeCtorInfo_24_61, Var_53, CtorRepns_50, ((MR_Box) (Int_52)), &conv3_Min_10, ((MR_Box) (Int_52)), &conv2_Max_11);
  ...
  if (succeeded)
  {
    Var_42 = (MR_Integer) ((MR_Unsigned) *Max_11 - (MR_Unsigned) *Min_10);
    Var_43 = (MR_Integer) 1;
    *NumValuesInRange_12 = (MR_Integer) ((MR_Unsigned) Var_42 + (MR_Unsigned) Var_43);
    succeeded = MR_TRUE;
  }
  return succeeded;
}
