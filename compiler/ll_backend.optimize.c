...
MR_def_static(ll_backend__optimize__init_opt_debug_info_10_0)
	...
	MR_sv(5) = MR_r6;
	MR_sv(6) = MR_r7;
	MR_sv(7) = MR_tfield(0, MR_r1, 21);
	MR_sv(8) = MR_tfield(0, MR_r1, 22);
	MR_sv(9) = MR_tfield(0, MR_r1, 23);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r4;
...
MR_def_label(ll_backend__optimize__optimize_proc_6_0,3)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(0, MR_sv(2), 20);
	MR_tempr2 = MR_sv(1);
	MR_sv(1) = MR_tempr1;
	MR_sv(10) = MR_r1;
	MR_r1 = MR_tempr2;
