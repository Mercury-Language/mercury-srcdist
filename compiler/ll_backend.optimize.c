...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__optimize_scalar_common_1[1]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__optimize_scalar_common_1[1]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__optimize_scalar_common_1[1]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo_54_54 = (MR_Word) (&ll_backend__optimize_scalar_common_1[1]);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__optimize_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (Var_41)), ((MR_Box) (ArgY6_20)));
                }
              }
            }
          }
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_19_19 = (MR_Word) (&ll_backend__optimize_scalar_common_1[0]);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 329, &NumRealRRegs_7);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 495, &LocalVarAccessThreshold_8);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 503, &OptRepeat_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 493, &CheckedNondetTailCalls_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &OptDelaySlots_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &OptDups_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 500, &OptFrames_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &OptJumps_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 491, &OptFullJumps_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &OptLabels_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 488, &OptPeep_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 489, &OptPeepMkword_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 502, &OptReassign_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 492, &PessimizeTailCalls_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &StdLabels_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &UseLocalVars_28);
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_342_342 = (MR_Word) (&ll_backend__optimize_scalar_common_1[0]);
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__optimize_scalar_common_1[0]), ((MR_Box) (Instrs_10)), ((MR_Box) (PrevInstrs_21)));
      if (succeeded)
      {
