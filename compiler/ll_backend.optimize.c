...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 86, &DebugOptPredIdStrs_5);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 87, &DebugOptPredNames_6);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 330, &NumRealRRegs_7);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 496, &LocalVarAccessThreshold_8);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 504, &OptRepeat_9);
    libs__globals__get_gc_method_2_p_0(Globals_3, &GCMethod_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 84, &DebugOpt_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 156, &AutoComments_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 157, &FrameOptComments_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 72, &DetailedStatistics_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 62, &VeryVerbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &CheckedNondetTailCalls_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 502, &OptDelaySlots_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 499, &OptDups_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &OptFrames_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 491, &OptJumps_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 492, &OptFullJumps_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &OptLabels_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 489, &OptPeep_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &OptPeepMkword_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 503, &OptReassign_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 493, &PessimizeTailCalls_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &StdLabels_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 495, &UseLocalVars_28);
    {
