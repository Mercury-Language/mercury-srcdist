...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 349, &NumRealRRegs_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 172, &AutoCommentsOption_15);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 173, &FrameOptComments_17);
