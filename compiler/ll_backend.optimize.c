  ...
  MR_Word ModuleName_7)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 698, &DebugOptPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 699, &DebugOptPredNames_10);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 568, &NumRealRRegs_11);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 697, &DebugOpt_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 660, &DetailedStatistics_20);
