...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 160, &AutoComments_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 161, &FrameOptComments_13);
