...
MR_decl_label10(ll_backend__optimize__maybe_opt_debug_8_0, 70,4,5,6,7,8,9,10,11,12)
...
MR_decl_label4(ll_backend__optimize__maybe_opt_debug_8_0, 41,22,42,43)
...
MR_decl_label10(ll_backend__optimize__optimize_proc_4_0, 17,11,19,21,22,23,24,25,26,27)
...
MR_def_label(ll_backend__optimize__output_first_opt_debug_7_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("optimize", 8);
	MR_r2 = (MR_Word) MR_string_const("cannot make OptSubdir", 21);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(require__unexpected_2_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__optimize_module6)
	...
	MR_init_label10(ll_backend__optimize__maybe_opt_debug_8_0,70,4,5,6,7,8,9,10,11,12)
	...
	MR_init_label4(ll_backend__optimize__maybe_opt_debug_8_0,41,22,42,43)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__optimize__maybe_opt_debug_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r7,0,0)) {
		MR_GOTO_LAB(ll_backend__optimize__maybe_opt_debug_8_0_i70);
	}
	MR_r1 = MR_r7;
	MR_proceed();
MR_def_label(ll_backend__optimize__maybe_opt_debug_8_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(13);
...
MR_def_label(ll_backend__optimize__maybe_opt_debug_8_0,42)
	...
	MR_np_call_localret_ent(fn__ll_backend__optimize__this_file_0_0,
		ll_backend__optimize__maybe_opt_debug_8_0_i43);
MR_def_label(ll_backend__optimize__maybe_opt_debug_8_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
...
MR_BEGIN_MODULE(ll_backend__optimize_module13)
	...
	MR_init_label10(ll_backend__optimize__optimize_proc_4_0,17,11,19,21,22,23,24,25,26,27)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__optimize_module20)
