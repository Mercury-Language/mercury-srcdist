...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 85, &DebugOptPredIdStrs_5);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 86, &DebugOptPredNames_6);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 325, &NumRealRRegs_7);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 491, &LocalVarAccessThreshold_8);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 499, &OptRepeat_9);
    libs__globals__get_gc_method_2_p_0(Globals_3, &GCMethod_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 83, &DebugOpt_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 155, &AutoComments_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 156, &FrameOptComments_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 71, &DetailedStatistics_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 61, &VeryVerbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 489, &CheckedNondetTailCalls_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &OptDelaySlots_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &OptDups_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &OptFrames_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 486, &OptJumps_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 487, &OptFullJumps_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 493, &OptLabels_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 484, &OptPeep_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 485, &OptPeepMkword_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &OptReassign_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 488, &PessimizeTailCalls_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 492, &StdLabels_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &UseLocalVars_28);
    {
