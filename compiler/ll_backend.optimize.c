...
static const MR_PseudoTypeInfo ll_backend__optimize__ll_backend__optimize__field_types_llds_opt_info_0_0[27] = {
  ...
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_opt_dup_instrs_llds_0),
  ...
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_opt_llds_reassign_0),
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_pessimize_llds_tailcalls_0),
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_standardize_labels_0),
  (MR_PseudoTypeInfo) (&libs__optimization_options__libs__optimization_options__type_ctor_info_maybe_use_local_vars_llds_0)
};
  ...
  MR_Word ModuleName_7)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 729, &DebugOptPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 730, &DebugOptPredNames_10);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 596, &NumRealRRegs_11);
  libs__globals__get_opt_tuple_2_p_0(Globals_6, &OptTuple_12);
  LocalVarAccessThreshold_13 = ((MR_Integer) ((MR_hl_field(0, OptTuple_12, 35))));
  OptRepeat_14 = ((MR_Integer) ((MR_hl_field(0, OptTuple_12, 36))));
  libs__globals__get_gc_method_2_p_0(Globals_6, &GCMethod_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 728, &DebugOpt_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 464, &AutoCommentsOption_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 465, &FrameOptComments_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 689, &DetailedStatistics_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 132, &VeryVerbose_21);
  ...
  MR_Word * MaybeBaseName_12)
{
...

  {
    ...
    hlds__pred_proc_id__pred_id_to_int_2_p_0(PredId_16, &(env).ll_backend__optimize__need_opt_debug_info_6_p_0_env_0__PredIdInt_18);
    hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_17, &ProcIdInt_19);
