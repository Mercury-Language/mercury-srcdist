...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 338, &NumRealRRegs_7);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 160, &AutoCommentsOption_13);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 161, &FrameOptComments_15);
...
{
  {
    ...
    Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "mkdir -p ", (MR_String) "OptSubdir");
    mercury__io__call_system_4_p_0(Var_25, &MkdirRes_14);
    ...
    else
    {
      ...
      Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "cannot make ", (MR_String) "OptSubdir");
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140ll_backend.optimize.output_first_opt_debug\'/7", Var_44);
        return;
      }
    }
  }
