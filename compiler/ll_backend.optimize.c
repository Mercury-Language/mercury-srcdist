...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 88, &DebugOptPredIdStrs_5);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 89, &DebugOptPredNames_6);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 333, &NumRealRRegs_7);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 500, &LocalVarAccessThreshold_8);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 508, &OptRepeat_9);
    libs__globals__get_gc_method_2_p_0(Globals_3, &GCMethod_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 86, &DebugOpt_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 158, &AutoComments_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 159, &FrameOptComments_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 74, &DetailedStatistics_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 64, &VeryVerbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &CheckedNondetTailCalls_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 506, &OptDelaySlots_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 503, &OptDups_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 505, &OptFrames_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 495, &OptJumps_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &OptFullJumps_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 502, &OptLabels_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 493, &OptPeep_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &OptPeepMkword_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 507, &OptReassign_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &PessimizeTailCalls_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &StdLabels_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 499, &UseLocalVars_28);
    {
