...
{
  {
    ...
    MR_Word GCMethod_10;
    MR_Word DebugOpt_11;
    MR_Word AutoCommentsOption_12;
    MR_Word AutoComments_13;
    MR_Word FrameOptComments_14;
    MR_Word DetailedStatistics_15;
    MR_Word VeryVerbose_16;
    MR_Word CheckedNondetTailCalls_17;
    MR_Word OptDelaySlots_18;
    MR_Word OptDups_19;
    MR_Word OptFrames_20;
    MR_Word OptJumps_21;
    MR_Word OptFullJumps_22;
    MR_Word OptLabels_23;
    MR_Word OptPeep_24;
    MR_Word OptPeepMkword_25;
    MR_Word OptReassign_26;
    MR_Word PessimizeTailCalls_27;
    MR_Word StdLabels_28;
    MR_Word UseLocalVars_29;
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 336, &NumRealRRegs_7);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 503, &LocalVarAccessThreshold_8);
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 511, &OptRepeat_9);
    libs__globals__get_gc_method_2_p_0(Globals_3, &GCMethod_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 88, &DebugOpt_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 160, &AutoCommentsOption_12);
    switch (AutoCommentsOption_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        AutoComments_13 = (MR_Integer) 0;
        break;
      case (MR_Integer) 1:
        AutoComments_13 = (MR_Integer) 1;
        break;
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 161, &FrameOptComments_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 76, &DetailedStatistics_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 66, &VeryVerbose_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &CheckedNondetTailCalls_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 509, &OptDelaySlots_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 506, &OptDups_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 508, &OptFrames_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &OptJumps_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 499, &OptFullJumps_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 505, &OptLabels_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &OptPeep_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &OptPeepMkword_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 510, &OptReassign_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 500, &PessimizeTailCalls_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 504, &StdLabels_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 502, &UseLocalVars_29);
    {
      ...
      MR_hl_field(MR_mktag(0), Info_4, 5) = (MR_Box) (((((MR_Unsigned) (GCMethod_10) << 18)) | (((((MR_Unsigned) (DebugOpt_11) << 17)) | (((((MR_Unsigned) (AutoComments_13) << 16)) | (((((MR_Unsigned) (FrameOptComments_14) << 15)) | (((((MR_Unsigned) (DetailedStatistics_15) << 14)) | (((((MR_Unsigned) (VeryVerbose_16) << 13)) | (((((MR_Unsigned) (CheckedNondetTailCalls_17) << 12)) | (((((MR_Unsigned) (OptDelaySlots_18) << 11)) | (((((MR_Unsigned) (OptDups_19) << 10)) | (((((MR_Unsigned) (OptFrames_20) << 9)) | (((((MR_Unsigned) (OptJumps_21) << 8)) | (((((MR_Unsigned) (OptFullJumps_22) << 7)) | (((((MR_Unsigned) (OptLabels_23) << 6)) | (((((MR_Unsigned) (OptPeep_24) << 5)) | (((((MR_Unsigned) (OptPeepMkword_25) << 4)) | (((((MR_Unsigned) (OptReassign_26) << 3)) | (((((MR_Unsigned) (PessimizeTailCalls_27) << 2)) | (((((MR_Unsigned) (StdLabels_28) << 1)) | (MR_Unsigned) (UseLocalVars_29)))))))))))))))))))))))))))))))))))));
    }
    return Info_4;
  }
}
