...
{
  {
    ...
    if (succeeded)
    {
      MR_Word LabelMap_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLayout_27, (MR_Integer) 17))));
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 96, &DebugOptPredIdStrs_7);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 97, &DebugOptPredNames_8);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 94, &DebugOpt_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 173, &AutoCommentsOption_15);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 174, &FrameOptComments_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 81, &DetailedStatistics_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 71, &VeryVerbose_19);
...
{
  {
    ...
    else
    {
      ...
      Var_41 = ll_backend__optimize__num_to_str_1_f_0(OptNum_22);
      ...
      Var_47 = ll_backend__optimize__num_to_str_1_f_0(OptNum_22);
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__io__call_system_4_p_0(DiffCommand_33, &Var_34);
            }
            break;
          case (MR_Integer) 1:
            {
...
{
  {
    ...
    mercury__io__call_system_4_p_0(Var_23, &MkdirRes_14);
