...
ll_backend.store_alloc.optdate ll_backend.store_alloc.trans_opt_date store_alloc.err ll_backend.store_alloc.c_date ll_backend.store_alloc.java_date : store_alloc.m \
	ll_backend.int0 \
	assoc_list.int \
	bool.int \
	builtin.int \
...
#   long deps
#   short deps
ll_backend.store_alloc.optdate ll_backend.store_alloc.trans_opt_date store_alloc.err ll_backend.store_alloc.c_date ll_backend.store_alloc.java_date : \
		store_alloc.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.store_alloc.pic_o ll_backend.store_alloc.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ll_backend.store_alloc.mh ll_backend.store_alloc.mih : ll_backend.store_alloc.c
...
ll_backend.store_alloc.module_dep : jmercury/ll_backend__store_alloc.java
else
ll_backend.store_alloc.module_dep : ll_backend.store_alloc.c
endif
...
ll_backend.store_alloc.date ll_backend.store_alloc.date0 \
	ll_backend.date : store_alloc.m \
	ll_backend.int0 \
	assoc_list.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.store_alloc.date ll_backend.store_alloc.date0 ll_backend.date : \
		store_alloc.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.store_alloc.date0 \
	ll_backend.date0 : store_alloc.m \
	assoc_list.int3 \
	bool.int3 \
	builtin.int3 \
	hlds.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.store_alloc.date0 ll_backend.date0 : \
		store_alloc.m \
	\
		assoc_list.int3 \
		bool.int3 \
...
ll_backend.store_alloc.int0 : ll_backend.store_alloc.date0
	@:
ll_backend.store_alloc.int : ll_backend.store_alloc.date
	@:
ll_backend.store_alloc.int2 : ll_backend.store_alloc.date
	@:
ll_backend.store_alloc.int3 : ll_backend.store_alloc.date3
	@:
ll_backend.store_alloc.opt : ll_backend.store_alloc.optdate
	@:
ll_backend.store_alloc.trans_opt : ll_backend.store_alloc.trans_opt_date
	@:
...
ll_backend.store_alloc.date0 : store_alloc.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ll_backend.store_alloc
ll_backend.store_alloc.date : store_alloc.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ll_backend.store_alloc
ll_backend.store_alloc.date3 : store_alloc.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ll_backend.store_alloc
ll_backend.store_alloc.optdate : store_alloc.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ll_backend.store_alloc
ll_backend.store_alloc.trans_opt_date : store_alloc.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ll_backend.store_alloc
ll_backend.store_alloc.c_date : store_alloc.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ll_backend.store_alloc $(ERR_REDIRECT)
ll_backend.store_alloc.java_date : store_alloc.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ll_backend.store_alloc $(ERR_REDIRECT)
