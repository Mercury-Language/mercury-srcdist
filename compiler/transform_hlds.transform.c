...
#endif
MR_decl_label10(transform_hlds__transform__reschedule_conj_4_0, 24,3,4,5,6,7,10,11,12,13)
...
MR_BEGIN_MODULE(transform_hlds__transform_module0)
	...
	MR_init_label10(transform_hlds__transform__reschedule_conj_4_0,24,3,4,5,6,7,10,11,12,13)
