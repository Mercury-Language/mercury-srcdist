...
#endif
MR_decl_label8(transform_hlds__transform__reschedule_conj_4_0, 23,3,4,5,6,7,10,11)
MR_decl_label4(transform_hlds__transform__reschedule_conj_4_0, 12,13,9,14)
...
MR_BEGIN_MODULE(transform_hlds__transform_module0)
	...
	MR_init_label8(transform_hlds__transform__reschedule_conj_4_0,23,3,4,5,6,7,10,11)
	MR_init_label4(transform_hlds__transform__reschedule_conj_4_0,12,13,9,14)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__transform__reschedule_conj_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__transform__reschedule_conj_4_0,14)
	...
	MR_GOTO_LAB(transform_hlds__transform__reschedule_conj_4_0_i23);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
