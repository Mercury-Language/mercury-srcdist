        ...
        else
          {
            ...
            if ((transform_hlds__transform__WokenGoals_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  MR_Word transform_hlds__transform__next_value_of_HeadVar__1_1 = transform_hlds__transform__Goals1_18;
                  MR_Word transform_hlds__transform__next_value_of_STATE_VARIABLE_ModeInfo_0_3 = transform_hlds__transform__STATE_VARIABLE_ModeInfo_25_25;

                  transform_hlds__transform__STATE_VARIABLE_ModeInfo_0_3 = transform_hlds__transform__next_value_of_STATE_VARIABLE_ModeInfo_0_3;
                  transform_hlds__transform__HeadVar__1_1 = transform_hlds__transform__next_value_of_HeadVar__1_1;
                }
                continue;
              }
          }
