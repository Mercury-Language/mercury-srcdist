  ...
  MR_Word * STATE_VARIABLE_ModeInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((WokenGoals_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        MR_Word Goals1_30;
        MR_Word _Goal0Goal_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal0_8, (MR_Integer) 0)));
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Goals1_18;
          MR_Word next_value_of_STATE_VARIABLE_ModeInfo_0_3 = STATE_VARIABLE_ModeInfo_25_25;
