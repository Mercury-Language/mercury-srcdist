...
#endif
MR_decl_label8(transform_hlds__transform__reschedule_conj_4_0, 25,4,5,6,7,10,11,12)
MR_decl_label4(transform_hlds__transform__reschedule_conj_4_0, 13,9,14,3)
...
MR_BEGIN_MODULE(transform_hlds__transform_module0)
	...
	MR_init_label8(transform_hlds__transform__reschedule_conj_4_0,25,4,5,6,7,10,11,12)
	MR_init_label4(transform_hlds__transform__reschedule_conj_4_0,13,9,14,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__transform__reschedule_conj_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__transform__reschedule_conj_4_0,9)
	...
	MR_np_call_localret_ent(list__append_3_1,
		transform_hlds__transform__reschedule_conj_4_0_i14);
MR_def_label(transform_hlds__transform__reschedule_conj_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(transform_hlds__transform__reschedule_conj_4_0_i25);
...
void mercury__transform_hlds__transform__write_out_proc_statics(FILE *fp);
#endif
