  ...
  MR_Word * ShouldDebug_4)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 697, &DebugPredIdInt_9);
  ...
  MR_Word * CodeInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 644, &OptNoReturnCalls_42);
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 90, &UseTrail_43);
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 633, &DisableTrailOps_44);
