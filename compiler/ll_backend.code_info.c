    ...
    case (MR_Integer) 1:
      {
        ...
        Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_22_22, (MR_Integer) 0))));
        Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_22_22, (MR_Integer) 1))));
        Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 0))));
        Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 1))));
        Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 2))));
        Var_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 3))) & (MR_Integer) 7);
        Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 4))));
        Var_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 5))));
        Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 6))));
        Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 7))));
        Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 8))));
        Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 9))));
        Var_37 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 10))));
        packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 12)));
        Var_48 = ((uint8_t) (MR_Word) (MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 13)));
        Var_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 14))) & (MR_Integer) 7);
        Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 15))));
        Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 16))));
        {
          ...
          MR_hl_field(MR_mktag(0), Var_25, 2) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(0), Var_25, 3) = (MR_Box) ((MR_Unsigned) (Var_30));
          MR_hl_field(MR_mktag(0), Var_25, 4) = ((MR_Box) (Var_31));
          MR_hl_field(MR_mktag(0), Var_25, 5) = ((MR_Box) (Var_32));
          MR_hl_field(MR_mktag(0), Var_25, 6) = ((MR_Box) (Var_33));
          MR_hl_field(MR_mktag(0), Var_25, 7) = ((MR_Box) (Var_34));
          MR_hl_field(MR_mktag(0), Var_25, 8) = ((MR_Box) (Var_35));
          MR_hl_field(MR_mktag(0), Var_25, 9) = ((MR_Box) (Var_36));
          MR_hl_field(MR_mktag(0), Var_25, 10) = ((MR_Box) (Var_37));
          MR_hl_field(MR_mktag(0), Var_25, 11) = ((MR_Box) (Var_23));
          MR_hl_field(MR_mktag(0), Var_25, 12) = (MR_Box) (packed_word_2);
          MR_hl_field(MR_mktag(0), Var_25, 13) = ((MR_Box) (MR_Word) (Var_48));
          MR_hl_field(MR_mktag(0), Var_25, 14) = (MR_Box) ((MR_Unsigned) (Var_49));
          MR_hl_field(MR_mktag(0), Var_25, 15) = ((MR_Box) (Var_50));
          MR_hl_field(MR_mktag(0), Var_25, 16) = ((MR_Box) (Var_51));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
