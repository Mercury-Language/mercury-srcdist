  ...
  MR_Word * STATE_VARIABLE_CI_17)
{
  ...
  ProcLabel_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_22, (MR_Integer) 8))));
  {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__int__max_3_p_0(Var_22, STATE_VARIABLE_Max_0_2, &STATE_VARIABLE_Max_14_14);
                }
                break;
              case (MR_Integer) 0:
                mercury__int__max_3_p_0(N_26, STATE_VARIABLE_Max_0_2, &STATE_VARIABLE_Max_14_14);
                break;
            }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            mercury__int__max_3_p_0(N_20, STATE_VARIABLE_Max_0_2, &STATE_VARIABLE_Max_14_14);
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_CI_11)
{
  ...
  ProcLabel_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_15, (MR_Integer) 8))));
