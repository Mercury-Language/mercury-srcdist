    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(3, Var_101, 1) = ((MR_Box) (ModuleName_9));
          }
          {
            Var_100 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_100, 0) = ((MR_Box) (Var_101));
            MR_hl_field(1, Var_100, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[4])));
          }
          {
            Var_97 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_97, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__check_module_interface_scalar_common_1[1])));
            MR_hl_field(1, Var_97, 1) = ((MR_Box) (Var_100));
          }
          {
            Var_93 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_93, 0) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[0])));
            MR_hl_field(1, Var_93, 1) = ((MR_Box) (Var_97));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_91, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[43])));
          }
          {
            MainMsg_87 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, MainMsg_87, 0) = ((MR_Box) (ModuleNameContext_10));
            MR_hl_field(2, MainMsg_87, 1) = ((MR_Box) (Var_91));
          }
          switch (NumIntIncls_54) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                Msgs_88 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Msgs_88, 0) = ((MR_Box) (MainMsg_87));
                MR_hl_field(1, Msgs_88, 1) = ((MR_Box) (IntPromises_28));
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                {
                  InclMsg_89 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(2, InclMsg_89, 0) = ((MR_Box) (ModuleNameContext_10));
                  MR_hl_field(2, InclMsg_89, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[51])));
                }
                {
                  Var_106 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_106, 0) = ((MR_Box) (InclMsg_89));
                  MR_hl_field(1, Var_106, 1) = ((MR_Box) (IntPromises_28));
                }
                {
                  Msgs_88 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Msgs_88, 0) = ((MR_Box) (MainMsg_87));
                  MR_hl_field(1, Msgs_88, 1) = ((MR_Box) (Var_106));
                }
              }
              break;
          }
          {
            Spec_90 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Spec_90, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.check_module_interface.generate_no_exports_warning\'/5"));
            MR_hl_field(2, Spec_90, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(2, Spec_90, 2) = ((MR_Box) ((MR_Unsigned) 24U));
            MR_hl_field(2, Spec_90, 3) = ((MR_Box) (Msgs_88));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *STATE_VARIABLE_Specs_64 = base;
            MR_hl_field(1, base, 0) = ((MR_Box) (Spec_90));
