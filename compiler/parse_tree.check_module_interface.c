    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          {
            Spec_90 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Spec_90, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.check_module_interface.generate_no_exports_warning\'/5"));
            MR_hl_field(0, Spec_90, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(0, Spec_90, 2) = ((MR_Box) ((MR_Unsigned) 24U));
            MR_hl_field(0, Spec_90, 3) = ((MR_Box) (Msgs_88));
          }
          {
            MR_Word base;
