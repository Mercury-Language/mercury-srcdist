    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(3, Var_91, 1) = ((MR_Box) (ModuleName_9));
          }
          {
            Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_90, 0) = ((MR_Box) (Var_91));
            MR_hl_field(1, Var_90, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_2[3])));
          }
          {
            Var_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_87, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__check_module_interface_scalar_common_2[0])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_82, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_2[42])));
          }
          {
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(2, InclMsg_80, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_2[50])));
                }
                {
                  Var_96 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_96, 0) = ((MR_Box) (InclMsg_80));
                  MR_hl_field(1, Var_96, 1) = ((MR_Box) (IntPromises_28));
                }
                {
                  Msgs_79 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Msgs_79, 0) = ((MR_Box) (MainMsg_78));
                  MR_hl_field(1, Msgs_79, 1) = ((MR_Box) (Var_96));
                }
              }
              break;
          }
          {
            ...
            MR_hl_field(0, Spec_81, 2) = ((MR_Box) ((MR_Unsigned) 20U));
