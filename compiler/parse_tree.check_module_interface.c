    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word IntIncls_11 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 2))));
        MR_Word TypeCtorCheckedMap_23 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 14))));
        MR_Word InstCtorCheckedMap_24 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 15))));
        MR_Word ModeCtorCheckedMap_25 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 16))));
        MR_Word TypeSpecs_26 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 17))));
        MR_Word InstModeSpecs_27 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 18))));
        MR_Word IntTypeClasses_28 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 19))));
        MR_Word IntInstances_29 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 20))));
        MR_Word IntPredDecls_30 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 21))));
        MR_Word IntModeDecls_31 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 22))));
        MR_Word IntDeclPragmas_32 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 23))));
        MR_Word IntPromises_33 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 24))));
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(3, Var_73, 1) = ((MR_Box) (ModuleName_9));
          }
          {
            Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_72, 0) = ((MR_Box) (Var_73));
            MR_hl_field(1, Var_72, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[4])));
          }
          {
            Var_69 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_69, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__check_module_interface_scalar_common_1[1])));
            MR_hl_field(1, Var_69, 1) = ((MR_Box) (Var_72));
          }
          {
            Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_66, 0) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_2[0])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_64, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[43])));
          }
          {
            MainMsg_60 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, MainMsg_60, 0) = ((MR_Box) (ModuleNameContext_10));
            MR_hl_field(2, MainMsg_60, 1) = ((MR_Box) (Var_64));
          }
          switch (NumIntIncls_47) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ...
                MR_hl_field(1, Msgs_61, 0) = ((MR_Box) (MainMsg_60));
                MR_hl_field(1, Msgs_61, 1) = ((MR_Box) (IntPromises_33));
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                {
                  InclMsg_62 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(2, InclMsg_62, 0) = ((MR_Box) (ModuleNameContext_10));
                  MR_hl_field(2, InclMsg_62, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__check_module_interface_scalar_common_1[51])));
                }
                {
                  Var_78 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_78, 0) = ((MR_Box) (InclMsg_62));
                  MR_hl_field(1, Var_78, 1) = ((MR_Box) (IntPromises_33));
                }
                {
                  Msgs_61 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Msgs_61, 0) = ((MR_Box) (MainMsg_60));
                  MR_hl_field(1, Msgs_61, 1) = ((MR_Box) (Var_78));
                }
              }
              break;
          }
          {
            ...
            MR_hl_field(0, Spec_63, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.check_module_interface.generate_no_exports_warning\'/5"));
            MR_hl_field(0, Spec_63, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(0, Spec_63, 2) = ((MR_Box) ((MR_Unsigned) 20U));
            MR_hl_field(0, Spec_63, 3) = ((MR_Box) (Msgs_61));
          }
          {
            MR_Word base;
            ...
            *STATE_VARIABLE_Specs_56 = base;
            ...
            MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_55));
          }
        }
        else
          *STATE_VARIABLE_Specs_56 = STATE_VARIABLE_Specs_0_55;
