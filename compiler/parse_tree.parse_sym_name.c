    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_67, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_67, 1) = ((MR_Box) ((MR_Integer) 12));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          succeeded = (FunctorArgs_6 == (MR_Word) ((MR_Integer) 0));
          if (succeeded)
          {
            Var_18 = (MR_String) "__";
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) MaybeModule_18)) == (MR_mktag((MR_Integer) 0))))
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_89, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_96, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_96, 1) = ((MR_Box) ((MR_Integer) 12));
