...
static /* final */ const MR_Box parse_tree__parse_sym_name_scalar_common_1[41][2] = {
  ...
  /* row  13 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[12]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[4])))
  },
  /* row  14 */
  {
  ...
  MR_Word * MaybeSymNameSpecifier_6)
{
  ...
  if (succeeded)
  {
    Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_5, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          NameTerm_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_21, (MR_Integer) 0))));
          Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_21, (MR_Integer) 1))));
          succeeded = (Var_22 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            ArityTerm_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_22, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__term__decimal_term_to_int_2_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ArityTerm_8, &Arity_10);
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word Name_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeName_11, (MR_Integer) 0))));
          MR_Word UserArity_14 = (MR_Word) (Arity_10);
          MR_Word Var_25;

          {
            Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (Name_13));
            MR_hl_field(MR_mktag(1), Var_25, 1) = ((MR_Box) (UserArity_14));
          }
          {
            MR_Word base;
      ...
      else
      {
        ...
        Var_37 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_5);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_16, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_sym_name.parse_symbol_name_specifier\'/3"));
          ...
          MR_hl_field(MR_mktag(1), Spec_16, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[32])));
        }
        {
    ...
    else
    {
      ...
      Var_51 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_5);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_56, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_sym_name.parse_symbol_name_specifier\'/3"));
        MR_hl_field(MR_mktag(1), Spec_56, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_56, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_56, 3) = ((MR_Box) (Var_51));
        MR_hl_field(MR_mktag(1), Spec_56, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[35])));
      }
      {
        Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (Spec_56));
  ...
  else
  {
    ...
    {
      MR_Word SymbolName_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSymbolName_17, (MR_Integer) 0))));
      MR_Word Var_54;

      {
        Var_54 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (SymbolName_18));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * MaybeSymName_8)
{
  ...
  {
    MR_Word SymName0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSymName0_9, (MR_Integer) 0))));
  ...
  MR_Word * SymName_6)
{
  ...
  {
    MR_Word ModuleName0_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName0_5, (MR_Integer) 0))));
    MR_String Name0_8 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_5, (MR_Integer) 1))));
    ...
    {
      {
        ...
        *SymName_6 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Name0_8));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  {
    MR_String Name0_9 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName0_5, (MR_Integer) 0))));

    {
      ...
      *SymName_6 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (DefaultModuleName_4));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Name0_9));
    }
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[13])));
      }
      {
        ArgPieces_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ArgPieces_18, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[11])));
  ...
  MR_Word * MaybeSymName_8)
{
  ...
  {
    MR_Word ModuleName0_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName0_7, (MR_Integer) 0))));
    MR_String Name0_39 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_7, (MR_Integer) 1))));
    ...
    {
      {
        ...
        MR_hl_field(MR_mktag(1), SymName_9, 0) = ((MR_Box) (DefaultModuleName_5));
        MR_hl_field(MR_mktag(1), SymName_9, 1) = ((MR_Box) (Name0_39));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  {
    MR_String Name0_40 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName0_7, (MR_Integer) 0))));

    {
      SymName_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SymName_9, 0) = ((MR_Box) (DefaultModuleName_5));
      MR_hl_field(MR_mktag(1), SymName_9, 1) = ((MR_Box) (Name0_40));
    }
    succeeded = MR_TRUE;
  }
  if (succeeded)
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_15, 0) = ((MR_Box) ((MR_Unsigned) 7U));
      MR_hl_field(MR_mktag(3), Var_15, 1) = ((MR_Box) (SymName0_7));
    }
    {
      Var_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_14, 0) = ((MR_Box) (Var_15));
      MR_hl_field(MR_mktag(1), Var_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[22])));
    }
    {
      Pieces_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_10, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[14])));
    ...
    Var_34 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_37, Term_6);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_11, 3) = ((MR_Box) (Var_34));
      MR_hl_field(MR_mktag(1), Spec_11, 4) = ((MR_Box) (Pieces_10));
    }
    {
      Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (Spec_11));
  ...
  MR_Word * MaybeSymNameAndArgs_10)
{
  ...
  else
  {
    ...
    {
      MR_Word ModuleName0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName0_12, (MR_Integer) 0))));
      MR_String Name0_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_12, (MR_Integer) 1))));

      succeeded = mdbcomp__sym_name__partial_sym_name_matches_full_2_p_0(ModuleName0_30, DefaultModuleName_6);
      if (succeeded)
      {
        {
          SymName_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), SymName_16, 0) = ((MR_Box) (DefaultModuleName_6));
          MR_hl_field(MR_mktag(1), SymName_16, 1) = ((MR_Box) (Name0_31));
        }
        succeeded = MR_TRUE;
      }
    }
    ...
    {
      MR_String Name0_32 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName0_12, (MR_Integer) 0))));

      {
        SymName_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), SymName_16, 0) = ((MR_Box) (DefaultModuleName_6));
        MR_hl_field(MR_mktag(1), SymName_16, 1) = ((MR_Box) (Name0_32));
      }
      succeeded = MR_TRUE;
    }
    if (succeeded)
      {
        ...
        *MaybeSymNameAndArgs_10 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (SymName_16));
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_22, 1) = ((MR_Box) (SymName0_12));
      }
      {
        Var_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (Var_22));
        MR_hl_field(MR_mktag(1), Var_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[22])));
      }
      {
        Pieces_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[14])));
      ...
      Var_27 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_15, Term_9);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_18, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_sym_name.implicitly_qualify_sym_name_and_args\'/5"));
        MR_hl_field(MR_mktag(1), Spec_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_18, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_18, 3) = ((MR_Box) (Var_27));
        MR_hl_field(MR_mktag(1), Spec_18, 4) = ((MR_Box) (Pieces_17));
      }
      {
        Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (Spec_18));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[7])));
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[10])));
  ...
  MR_Word * Args_6)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      FunctorName_11 = ((MR_String) ((MR_hl_field(MR_mktag(0), Functor_7, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ModuleTerm_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FunctorArgs_8, (MR_Integer) 0))));
          Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FunctorArgs_8, (MR_Integer) 1))));
          succeeded = (Var_17 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            NameArgsTerm_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_17, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameArgsTerm_13, (MR_Integer) 0))));
          *Args_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameArgsTerm_13, (MR_Integer) 1))));
          succeeded = ((MR_tag((MR_Word) Var_19)) == (MR_Integer) 0);
          if (succeeded)
          {
            Name_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 0))));
            ...
            {
              {
                ...
                *SymName_5 = base;
                ...
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Name_14));
              }
              succeeded = MR_TRUE;
            }
          }
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeModule_18)) == (MR_Integer) 0))
      {
        ...
        Var_32 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ContextPieces_6);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (ModuleTermStr_21));
        }
        {
          Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (Var_42));
          MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[6])));
        }
        {
          Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[3])));
          MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) (Var_41));
        }
        {
          Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[2])));
        ...
        Pieces_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_32, Var_33);
        {
        ...
        {
          Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (Spec_23));
          MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Module_19));
          MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (Name_14));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeModule_13)) == (MR_Integer) 0))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_34, 1) = ((MR_Box) (FunctorName_7));
        }
        {
          Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (Var_34));
          MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[26])));
        }
        {
          Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_sym_name_scalar_common_1[24])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_16, 1) = ((MR_Box) (Var_30));
        }
        {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (Module_14));
          MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (Name_11));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
