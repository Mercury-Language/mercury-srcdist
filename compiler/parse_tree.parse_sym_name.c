    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_52 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_7);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_57, 2) = ((MR_Box) ((MR_Unsigned) 16U));
    ...
    else
    {
      ...
      else
      {
        ...
        Var_35 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_39, Term_7);
        {
          ...
          MR_hl_field(MR_mktag(1), ArgSpec_19, 2) = ((MR_Box) ((MR_Unsigned) 16U));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_81, 2) = ((MR_Box) ((MR_Unsigned) 16U));
