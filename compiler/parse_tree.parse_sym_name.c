...
static /* final */ const MR_Box parse_tree__parse_sym_name_scalar_common_1[47][2];
...
static /* final */ const MR_Box parse_tree__parse_sym_name_scalar_common_1[47][2] = {
  ...
  /* row  42 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &parse_tree__parse_sym_name_scalar_common_1[12])))
  },
  /* row  43 */
  {
  ...
  MR_Word * MaybeSymNameArity_6)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__parse_sym_name__parse_symbol_name_3_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_4, NameTerm_7, &MaybeName_10);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) MaybeSymbolName_17)) == (MR_Integer) 0))
      *MaybeSymNameArity_6 = (MR_Word) (MaybeSymbolName_17);
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_28, 0) = ((MR_Box) (SymbolName_18));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * MaybeSymName_8)
{
  ...
  else
  {
    ...
    Var_28 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_29, (MR_Word) (MR_mkword(1, &parse_tree__parse_sym_name_scalar_common_1[46])));
    ...
    Context_18 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_13, Term_6);
    {
      ...
      MR_hl_field(0, Spec_10, 0) = ((MR_Box) ((MR_String) "function \140parse_tree.parse_sym_name.report_failed_implicit_qualification\'/2"));
  ...
  MR_Word * MaybeSymNameAndArgs_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_35, (MR_Word) (MR_mkword(1, &parse_tree__parse_sym_name_scalar_common_1[46])));
      ...
      Context_24 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_15, Term_9);
      {
        ...
        MR_hl_field(0, Spec_17, 0) = ((MR_Box) ((MR_String) "function \140parse_tree.parse_sym_name.report_failed_implicit_qualification\'/2"));
  ...
  MR_Word * MaybeSymName_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__parse_sym_name__parse_symbol_name_3_p_0(TypeInfo_for_T_41, GenericVarSet_17, ModuleTerm_12, &MaybeModule_18);
  ...
  MR_Word * MaybeSymName_6)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__parse_sym_name__parse_symbol_name_3_p_0(TypeInfo_for_T_41, VarSet_4, ModuleTerm_10, &MaybeModule_14);
