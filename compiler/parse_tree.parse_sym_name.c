  ...
  MR_Word * MaybeSymName_8)
{
  ...
  {
    MR_Word ModuleName0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName0_7, (MR_Integer) 0))));
    MR_String Name0_34 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_7, (MR_Integer) 1))));

    succeeded = mdbcomp__sym_name__partial_sym_name_matches_full_2_p_0(ModuleName0_33, DefaultModuleName_5);
    if (succeeded)
    {
      {
        ...
        MR_hl_field(MR_mktag(1), SymName_9, 1) = ((MR_Box) (Name0_34));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  {
    MR_String Name0_35 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName0_7, (MR_Integer) 0))));

    {
      SymName_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SymName_9, 0) = ((MR_Box) (DefaultModuleName_5));
      MR_hl_field(MR_mktag(1), SymName_9, 1) = ((MR_Box) (Name0_35));
    }
    succeeded = MR_TRUE;
  }
  if (succeeded)
  ...
  MR_Word * MaybeSymNameAndArgs_10)
{
  ...
  else
  {
    ...
    {
      MR_Word ModuleName0_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName0_12, (MR_Integer) 0))));
      MR_String Name0_26 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_12, (MR_Integer) 1))));

      succeeded = mdbcomp__sym_name__partial_sym_name_matches_full_2_p_0(ModuleName0_25, DefaultModuleName_6);
      if (succeeded)
      {
        {
          ...
          MR_hl_field(MR_mktag(1), SymName_16, 1) = ((MR_Box) (Name0_26));
        }
        succeeded = MR_TRUE;
      }
    }
    ...
    {
      MR_String Name0_27 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName0_12, (MR_Integer) 0))));

      {
        SymName_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), SymName_16, 0) = ((MR_Box) (DefaultModuleName_6));
        MR_hl_field(MR_mktag(1), SymName_16, 1) = ((MR_Box) (Name0_27));
      }
      succeeded = MR_TRUE;
    }
    if (succeeded)
    ...
    else
    {
      ...
      Var_22 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_15, Term_9);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_18, 3) = ((MR_Box) (Var_22));
        MR_hl_field(MR_mktag(1), Spec_18, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[22])));
      }
      {
