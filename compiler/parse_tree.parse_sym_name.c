  ...
  MR_Word * MaybeSymNameSpecifier_8)
{
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ArityTerm_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MR_Word UserArity_16 = (MR_Word) (Arity_12);
          MR_Word Var_27;

          {
            Var_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (Name_15));
            MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (UserArity_16));
          }
          {
            MR_Word base;
      ...
      else
      {
        ...
        Var_39 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_7);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_18, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_sym_name.parse_implicitly_qualified_symbol_name_specifier\'/4"));
          MR_hl_field(MR_mktag(1), Spec_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(1), Spec_18, 2) = ((MR_Box) ((MR_Unsigned) 20U));
          MR_hl_field(MR_mktag(1), Spec_18, 3) = ((MR_Box) (Var_39));
          MR_hl_field(MR_mktag(1), Spec_18, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[32])));
        }
        {
    ...
    else
    {
      ...
      Var_53 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_7);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_58, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_sym_name.parse_implicitly_qualified_symbol_name_specifier\'/4"));
        MR_hl_field(MR_mktag(1), Spec_58, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_58, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_58, 3) = ((MR_Box) (Var_53));
        MR_hl_field(MR_mktag(1), Spec_58, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_sym_name_scalar_common_1[35])));
      }
      {
  ...
  {
    MR_Word MaybeSymbolName_19;

    parse_tree__parse_sym_name__parse_implicitly_qualified_symbol_name_4_p_0(DefaultModule_5, VarSet_6, Term_7, &MaybeSymbolName_19);
    if (((MR_tag((MR_Word) MaybeSymbolName_19)) == (MR_Integer) 0))
      *MaybeSymNameSpecifier_8 = (MR_Word) (MaybeSymbolName_19);
    else
    {
      MR_Word SymbolName_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSymbolName_19, (MR_Integer) 0))));
      MR_Word Var_56;

      {
        Var_56 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (SymbolName_20));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
