...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) FunctorArgs_6)) == (MR_Integer) 1);
        if (succeeded)
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) FunctorArgs_8)) == (MR_Integer) 1);
          if (succeeded)
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) FunctorArgs_10)) == (MR_Integer) 1);
          if (succeeded)
          {
