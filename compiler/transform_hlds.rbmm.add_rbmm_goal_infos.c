...
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 5,7,8,9,10,13,14,15,3,21)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 25,24,28,30,31,33,19,37,38,39)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 41,43,44,49,36,53,55,52,62,65)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 66,67,68,69,60,75,78,79,80,81)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 82,73,88,90,86,93,94,97,98,99)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 100,101,102,103,104,105,106,108,109,110)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 111,107,112,113,114,58,122,124,121,129)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 133,135,136,140,141,143,132,144,127,147)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 151,148,154,155,159,156,162,164,146,166)
MR_decl_label4(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 165,169,168,171)
...
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0, 3,11,12,13,14,15,9,7,23,24)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0, 27,29,26,32,35,33,40,42,38,44)
MR_decl_label9(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0, 47,49,50,51,52,53,45,56,22)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0, 22,3,4,6,7,8,9,10,11,12)
MR_decl_label7(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0, 19,3,4,6,7,8,9)
...
MR_decl_static(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1_3_0)
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1_3_0),
0
},
};
...
"transform_hlds.rbmm.add_rbmm_goal_infos",
"lambda_rbmm_add_rbmm_goal_infos_m_336",
3,
0
},
"transform_hlds.rbmm.add_rbmm_goal_infos",
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__keep_allocated_regions_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("rbmm.add_rbmm_goal_infos.m", 26);
	MR_r2 = (MR_Word) MR_string_const("keep_allocated_regions: length mismatch", 39);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module3)
	...
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,22,3,4,6,7,8,9,10,11,12)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,12)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0_i22);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module4)
	...
	MR_init_label7(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,19,3,4,6,7,8,9)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,9)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0_i19);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module5)
	...
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,3,11,12,13,14,15,9,7,23,24)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,27,29,26,32,35,33,40,42,38,44)
	MR_init_label9(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,47,49,50,51,52,53,45,56,22)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__rbmm_info_init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i29);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,14)
	...
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i15);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,7)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i22);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i26);
	}
	MR_np_call_localret_ent(fn__hlds__hlds_goal__rbmm_info_init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i29);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,26)
	...
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__points_to_graph__rptg_lookup_region_name_2_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i32);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,32)
	...
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i35);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i33);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i38);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_np_call_localret_ent(fn__list__det_last_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i42);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,42)
	...
	MR_r3 = MR_sv(5);
	MR_r4 = MR_r1;
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i44);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(5);
	MR_r4 = MR_sv(1);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i45);
	}
	MR_sv(1) = MR_r2;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,49)
	...
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i50);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i51);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,52)
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0_i53);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_unification_8_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module9)
	...
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,5,7,8,9,10,13,14,15,3,21)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,25,24,28,30,31,33,19,37,38,39)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,41,43,44,49,36,53,55,52,62,65)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,66,67,68,69,60,75,78,79,80,81)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,82,73,88,90,86,93,94,97,98,99)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,100,101,102,103,104,105,106,108,109,110)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,111,107,112,113,114,58,122,124,121,129)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,133,135,136,140,141,143,132,144,127,147)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,151,148,154,155,159,156,162,164,146,166)
	MR_init_label4(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,165,169,168,171)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,19)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,6)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i36);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,38)
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_9_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i39);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,36)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,4)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i52);
	}
	MR_sv(9) = MR_r9;
	MR_r8 = MR_tfield(3, MR_r8, 1);
	MR_np_call_localret_ent(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_9_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i53);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,52)
	...
	if (MR_PTAG_TESTR(MR_r8,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i58);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i60);
	}
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,65)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i66);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i67);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,68)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i69);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i73);
	}
	MR_sv(1) = MR_r2;
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i78);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i79);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i80);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,81)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i82);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i86);
	}
	MR_np_call_localret_ent(fn__hlds__hlds_goal__rbmm_info_init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i90);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,100)
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__list__length_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i101);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__det_split_list_4_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i102);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,106)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i108);
	}
	MR_r2 = MR_sv(6);
	MR_sv(3) = MR_sv(1);
	MR_r1 = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i107);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,113)
	...
	MR_np_call_localret_ent(fn__set__from_list_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i114);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,58)
	...
	MR_r8 = MR_tfield(3, MR_r8, 2);
	MR_np_call_localret_ent(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_9_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i122);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,122)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 3, (MR_Integer) 3);
	...
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_rbmm_1_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i124);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,121)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,3)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i127);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 10);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,129)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i132);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r1;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,135)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i136);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,136)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,140)
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i141);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,141)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,132)
	...
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__add_rbmm_goal_infos__this_file_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i144);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,127)
	...
	if (MR_PTAG_TESTR(MR_r8,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i146);
	}
	MR_sv(1) = MR_r1;
	MR_sv(3) = MR_r3;
	MR_sv(5) = MR_r5;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,147)
	...
	MR_r4 = MR_sv(4);
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i151);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,151)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i148);
	}
	MR_r3 = MR_sv(6);
	MR_r4 = MR_sv(4);
	MR_sv(4) = MR_r2;
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i155);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,148)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,3);
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i154);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,154)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(6);
	MR_r4 = MR_sv(4);
	MR_sv(4) = MR_r1;
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,155)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,11);
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i159);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,159)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i156);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,156)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,3);
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i162);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,162)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_r6 = MR_sv(7);
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,146)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i165);
	}
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__add_rbmm_goal_infos__this_file_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i166);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,166)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,165)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r8,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i168);
	}
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__add_rbmm_goal_infos__this_file_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i169);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,169)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("collect_rbmm_goal_info_goal_expr: generic call not handled", 58);
	MR_succip_word = MR_sv(12);
	MR_decr_sp(12);
	MR_np_tailcall_ent(require__sorry_2_0);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,168)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__add_rbmm_goal_infos__this_file_0_0,
		transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0_i171);
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,171)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module12)
	MR_init_entry1(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__336__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
static void mercury__transform_hlds__rbmm__add_rbmm_goal_infos_maybe_bunch_0(void)
{
	...
	transform_hlds__rbmm__add_rbmm_goal_infos_module12();
}
