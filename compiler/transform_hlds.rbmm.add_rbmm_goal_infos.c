  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__type_util__is_region_var_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_53, (MR_Integer) 308, &UseAllocRegions_54);
