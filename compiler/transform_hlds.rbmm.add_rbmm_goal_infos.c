...
{
  {
    ...
    transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__297__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_LambdaHeadVar__3_166);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  Var_207 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  MR_hl_field(MR_mktag(0), Var_207, 2) = ((MR_Box) ((MR_Integer) 1));
                ...
                AllocatedIntoAndReadFrom_52 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[1]), Var_210);
                hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_12, &Globals_53);
                libs__globals__lookup_bool_option_3_p_0(Globals_53, (MR_Integer) 254, &UseAllocRegions_54);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      AllocatedIntoRegions_56 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[1]), Var_212);
                    }
                    break;
                }
                Var_213 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[1]), CreatedRegions_51);
                Var_214 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[1]), RemovedRegions_50);
                Var_215 = mercury__set__list_to_set_1_f_0((MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[1]), CarriedRegions_48);
                {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                Var_181 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
                ...
                MR_hl_field(MR_mktag(0), Var_181, 2) = ((MR_Box) ((MR_Integer) 7));
          ...
          case (MR_Integer) 3:
            {
              ...
              {
                Var_171 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
                ...
                MR_hl_field(MR_mktag(0), Var_171, 2) = ((MR_Box) ((MR_Integer) 7));
              ...
              else
              {
                ...
                {
                  Var_176 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              ...
              {
                Var_158 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
                ...
                MR_hl_field(MR_mktag(0), Var_158, 2) = ((MR_Box) ((MR_Integer) 7));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                RbmmInfo_73 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
