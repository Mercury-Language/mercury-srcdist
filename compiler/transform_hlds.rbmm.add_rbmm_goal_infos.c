          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(transform_hlds__rbmm__add_rbmm_goal_infos__Globals_53, (MR_Integer) 241, &transform_hlds__rbmm__add_rbmm_goal_infos__UseAllocRegions_54);
