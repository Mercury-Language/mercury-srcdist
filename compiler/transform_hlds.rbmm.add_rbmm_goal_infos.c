...
MR_decl_label8(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 89,92,91,94,95,96,97,98)
...
MR_decl_label8(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0, 18,4,5,6,7,8,9,10)
MR_decl_label2(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0, 11,3)
MR_decl_label7(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0, 15,4,5,6,7,8,3)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module1)
	...
	MR_init_label8(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,18,4,5,6,7,8,9,10)
	MR_init_label2(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,11,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0,11)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_conjunction_3_0_i18);
	}
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module2)
	...
	MR_init_label7(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,15,4,5,6,7,8,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0,8)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__add_rbmm_goal_infos__compute_rbmm_info_goals_3_0_i15);
	}
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module8)
	...
	MR_init_label8(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,89,92,91,94,95,96,97,98)
