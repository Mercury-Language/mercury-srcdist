...
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 133,135,136,140,141,143,132,127,146,150)
MR_decl_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0, 147,153,154,158,155,161,163,145,164,166)
...
MR_decl_static(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1_3_0)
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1_3_0),
0
},
};
...
"transform_hlds.rbmm.add_rbmm_goal_infos",
"lambda_rbmm_add_rbmm_goal_infos_m_333",
3,
0
},
"transform_hlds.rbmm.add_rbmm_goal_infos",
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module8)
	...
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,133,135,136,140,141,143,132,127,146,150)
	MR_init_label10(transform_hlds__rbmm__add_rbmm_goal_infos__collect_rbmm_goal_info_goal_expr_11_0,147,153,154,158,155,161,163,145,164,166)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__add_rbmm_goal_infos_module11)
	MR_init_entry1(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__add_rbmm_goal_infos__IntroducedFrom__pred__collect_rbmm_goal_info_goal_expr__333__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
