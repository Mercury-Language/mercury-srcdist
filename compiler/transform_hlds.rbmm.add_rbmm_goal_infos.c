          ...
          case (MR_Integer) 4:
            {
              ...
              else
              {
                ...
                mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_2[2]), (MR_Word) (&transform_hlds__rbmm__add_rbmm_goal_infos_scalar_common_1[4]), Cases_82, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv5_Goals_100);
