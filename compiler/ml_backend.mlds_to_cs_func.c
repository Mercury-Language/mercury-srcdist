  ...
  MR_Word Arg_7)
{
  MR_bool succeeded;
  MR_String Str_8;
  MR_Word VarName_9 = ((MR_Word) ((MR_hl_field(0, Arg_7, 0))));
  MR_Word Type_10 = ((MR_Word) ((MR_hl_field(0, Arg_7, 1))));
  ...
  succeeded = ((((MR_tag((MR_Word) Type_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_10, 0)))) == (MR_Integer) 10)));
  if (succeeded)
  {
    MR_String Var_32;
    MR_String Var_33;
  ...
  MR_Unsigned * HeadVar__4_4)
{
  ...
  *HeadVar__4_4 = (Num_7 + (MR_Unsigned) 1U);
  {
  ...
  MR_Word FunctionDefn_12)
{
  ...
  FuncName_15 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 0))));
  Context_16 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 1))));
  Flags_17 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 2))));
  Params_19 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 4))));
  MaybeBody_20 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 5))));
  ...
  Var_36 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, 1))) >> 2)) & (MR_Integer) 1);
  ml_backend__mlds_to_target_util__maybe_output_pre_function_comment_8_p_0(Stream_9, Var_36, IndentStr_14, (MR_String) "// ", (MR_String) "", FunctionDefn_12);
  Access_26 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_17, 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_27 = ((MR_Unsigned) ((MR_hl_field(0, Flags_17, 0))) & (MR_Integer) 1);
  switch (Access_26) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      AccessPrefix_28 = (MR_String) "private ";
      break;
    case (MR_Integer) 0:
      AccessPrefix_28 = (MR_String) "public ";
      break;
  }
  switch (PerInstance_27) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      PerInstancePrefix_29 = (MR_String) "static ";
      break;
    case (MR_Integer) 1:
      PerInstancePrefix_29 = (MR_String) "";
      break;
  }
  mercury__io__write_string_4_p_0(Stream_9, IndentStr_14);
  mercury__io__write_string_4_p_0(Stream_9, AccessPrefix_28);
  mercury__io__write_string_4_p_0(Stream_9, PerInstancePrefix_29);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  MR_Unsigned conv0_HeadVar__4_4;

  ml_backend__mlds_to_cs_func__make_out_param_4_p_0(((MR_Word) (wrapper_arg_1)), &conv1_Argument_6, ((MR_Unsigned) (wrapper_arg_3)), &conv0_HeadVar__4_4);
  ...
  MR_Word MaybeBody_18)
{
  ...
  {
    MR_Word Body_20 = ((MR_Word) ((MR_hl_field(1, MaybeBody_18, 0))));
    MR_Word PrintLineNumbers_21 = ((((MR_Unsigned) ((MR_hl_field(0, Info_11, 1))) >> 1)) & (MR_Integer) 1);
    ...
    Parameters_56 = ((MR_Word) ((MR_hl_field(0, Signature_17, 0))));
    RetTypes_57 = ((MR_Word) ((MR_hl_field(0, Signature_17, 1))));
    succeeded = ((MR_tag((MR_Word) OutputAux_15)) == (MR_Integer) 1);
    if (succeeded)
    {
      ClassName_58 = ((MR_String) ((MR_hl_field(1, OutputAux_15, 0))));
      ClassArity_59 = ((MR_Integer) ((MR_hl_field(1, OutputAux_15, 1))));
      succeeded = ((MR_tag((MR_Word) FuncName_14)) == (MR_Integer) 1);
      if (succeeded)
      {
        Var_67 = ((MR_String) ((MR_hl_field(1, FuncName_14, 0))));
    ...
    else
    {
      ...
      {
        MR_Word RetType_84 = ((MR_Word) ((MR_hl_field(1, RetTypes_57, 0))));

        OutParamTypes_64 = ((MR_Word) ((MR_hl_field(1, RetTypes_57, 1))));
        RetTypeStr_63 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_11, RetType_84);
      }
      mercury__list__map_foldl_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_Word) (&ml_backend__mlds_to_cs_func_scalar_common_2[0]), OutParamTypes_64, &OutParams_65, ((MR_Box) ((MR_Unsigned) 2U)), &conv2_Var_66);
    ...
    Var_34 = (Indent_13 + (MR_Unsigned) 1U);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_Str_8 = ml_backend__mlds_to_cs_func__param_to_string_for_csharp_3_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word Params_7)
{
  ...
  else
  {
    ...
    MR_Unsigned Var_14 = (Indent_6 + (MR_Unsigned) 1U);
    MR_Word Var_16;
    MR_String Var_27;
