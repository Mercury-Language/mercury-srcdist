...
static void MR_CALL 
ml_backend__mlds_to_cs_func__output_func_decl_for_csharp_8_p_0_1(
  MR_Box closure_arg,
...
static void MR_CALL 
ml_backend__mlds_to_cs_func__output_func_decl_for_csharp_8_p_0(
  MR_Word Info_9,
  MR_Word Stream_10,
...
static /* final */ const MR_Box ml_backend__mlds_to_cs_func_scalar_common_3[1][3] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (ml_backend__mlds_to_cs_func__output_func_decl_for_csharp_8_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
...
{
  MR_bool succeeded;
  MR_Word Name_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_9, (MR_Integer) 0))));
  MR_Word Type_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_9, (MR_Integer) 1))));
  ...
  MR_Word FunctionDefn_12)
{
  ...
  MR_Word Access_50;
  MR_Word PerInstance_51;

  mercury__io__nl_3_p_0(Stream_9);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
  FuncName_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FunctionDefn_12, (MR_Integer) 0))));
  Context_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FunctionDefn_12, (MR_Integer) 1))));
  ...
  Access_50 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  switch (Access_50) {
  ...
  {
    MR_Word PredProcId_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProcId_17, (MR_Integer) 0))));
    MR_Word Var_32 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);
  ...
  MR_Word MaybeBody_18)
{
  ...
  {
    MR_Word Body_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeBody_18, (MR_Integer) 0))));
    MR_Word FuncInfo_21;
    MR_Word Var_28;
    MR_Integer Var_32;
    MR_Word Var_35;
    ...
    ml_backend__mlds_to_cs_func__output_func_decl_for_csharp_8_p_0(Info_11, Stream_12, Indent_13, FuncName_14, OutputAux_15, Signature_17);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n");
    Var_28 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    ...
    Var_35 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_12, Var_35, Context_16, Indent_13);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "}\n");
    Var_39 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
  ...
  MR_Word Signature_14)
{
  ...
  MR_Word Parameters_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Signature_14, (MR_Integer) 0))));
  MR_Word RetTypes_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Signature_14, (MR_Integer) 1))));
  MR_Word OutParams_20;
  MR_Word Var_33;
  ...
  if (succeeded)
  {
    ClassName_18 = ((MR_String) ((MR_hl_field(MR_mktag(1), OutputAux_13, (MR_Integer) 0))));
    ClassArity_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OutputAux_13, (MR_Integer) 1))));
    succeeded = ((MR_tag((MR_Word) FuncName_12)) == (MR_Integer) 1);
    if (succeeded)
    {
      Var_25 = ((MR_String) ((MR_hl_field(MR_mktag(1), FuncName_12, (MR_Integer) 0))));
      succeeded = (strcmp(Var_25, (MR_String) "<constructor>") == 0);
    }
  }
  if (succeeded)
  {
    ml_backend__mlds_to_cs_name__output_class_name_arity_for_csharp_5_p_0(Stream_10, ClassName_18, ClassArity_19);
    OutParams_20 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    MR_Word RestRetTypes_21;
    MR_Box conv2_Var_22;

    if ((RetTypes_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__io__write_string_4_p_0(Stream_10, (MR_String) "void");
      RestRetTypes_21 = (MR_Word) ((MR_Unsigned) 0U);
    }
    else
    {
      MR_Word RetType_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 0))));

      RestRetTypes_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 1))));
      ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_9, RetType_49, Stream_10);
    }
    mercury__io__write_char_4_p_0(Stream_10, (MR_Char) 32);
    ml_backend__mlds_to_cs_name__output_function_name_for_csharp_4_p_0(Stream_10, FuncName_12);
    mercury__list__map_foldl_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&ml_backend__mlds_to_cs_func_scalar_common_3[0]), RestRetTypes_21, &OutParams_20, ((MR_Box) ((MR_Integer) 2)), &conv2_Var_22);
  }
  Var_33 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Parameters_16, OutParams_20);
  ml_backend__mlds_to_cs_func__output_params_for_csharp_6_p_0(Info_9, Indent_11, Var_33, Stream_10);
}
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  ml_backend__mlds_to_cs_func__output_param_for_csharp_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
  ...
  MR_Word Stream_10)
{
  ...
  if (!((Parameters_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    Var_22 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_func_scalar_common_1[0]));
      MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (ml_backend__mlds_to_cs_func__output_params_for_csharp_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_19, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (Info_7));
      MR_hl_field(MR_mktag(0), Var_19, 4) = ((MR_Box) (Var_22));
    }
