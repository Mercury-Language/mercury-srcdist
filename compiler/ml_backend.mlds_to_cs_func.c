...
{
  {
    ...
    PerInstance_52 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_51) {
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Word RetType_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 0))));

        RestRetTypes_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 1))));
        ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_9, RetType_50, Stream_10);
      }
      mercury__io__write_char_4_p_0(Stream_10, (MR_Char) 32);
