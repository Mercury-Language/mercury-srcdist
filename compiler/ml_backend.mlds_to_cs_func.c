  ...
  MR_Word FunctionDefn_12)
{
  ...
  Access_44 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  switch (Access_44) {
  ...
  MR_Word MaybeBody_18)
{
  ...
  if (!((MaybeBody_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    MR_Word Var_35;
    MR_Word Var_39;
    MR_Word Parameters_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Signature_17, (MR_Integer) 0))));
    MR_Word RetTypes_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Signature_17, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ClassName_69 = ((MR_String) ((MR_hl_field(MR_mktag(1), OutputAux_15, (MR_Integer) 0))));
      ClassArity_70 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OutputAux_15, (MR_Integer) 1))));
      succeeded = ((MR_tag((MR_Word) FuncName_14)) == (MR_Integer) 1);
      if (succeeded)
      {
        Var_74 = ((MR_String) ((MR_hl_field(MR_mktag(1), FuncName_14, (MR_Integer) 0))));
    ...
    else
    {
      ...
      {
        MR_Word RetType_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_68, (MR_Integer) 0))));

        RestRetTypes_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_68, (MR_Integer) 1))));
