...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0)));
    Access_47 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    if (!((MaybePredProcId_15 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Var_29 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 1);
