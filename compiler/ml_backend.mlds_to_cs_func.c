...
{
  {
    ...
    Access_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_48) {
    ...
    if (!((MaybePredProcId_15 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Var_30 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);

      ml_backend__mlds_to_target_util__maybe_output_pred_proc_id_comment_4_p_0(Var_30, PredProcId_23);
    }
