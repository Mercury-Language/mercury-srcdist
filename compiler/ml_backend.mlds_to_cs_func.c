  ...
  MR_Word Arg_7)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_10, (MR_Integer) 0)))) == (MR_Integer) 7)));
  if (succeeded)
  {
    MR_String Var_32;
    MR_String Var_33;
  ...
  MR_Word MaybeBody_18)
{
  ...
  if (!((MaybeBody_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_78 = ((MR_String) ((MR_hl_field(1, FuncName_14, (MR_Integer) 0))));
        succeeded = (strcmp(Var_78, (MR_String) "<constructor>") == 0);
      }
    }
    if (succeeded)
    {
      MR_String ClassNameStr_71;
      MR_String ParamsStr_72;

      ClassNameStr_71 = ml_backend__mlds_to_cs_name__unqual_class_name_to_ll_string_for_csharp_2_f_0(ClassName_69, ClassArity_70);
      ParamsStr_72 = ml_backend__mlds_to_cs_func__params_to_string_for_csharp_3_f_0(Info_11, Indent_13, Parameters_67);
      mercury__io__write_string_4_p_0(Stream_12, ClassNameStr_71);
      mercury__io__write_string_4_p_0(Stream_12, ParamsStr_72);
    }
    else
    {
      MR_String FuncNameStr_73;
      MR_String RetTypeStr_74;
      MR_Word OutParamTypes_75;
      MR_Word OutParams_76;
      MR_Word Var_81;
      MR_String ParamsStr_82;
      MR_Box conv2_Var_77;

      FuncNameStr_73 = ml_backend__mlds_to_cs_name__function_name_to_ll_string_for_csharp_1_f_0(FuncName_14);
      if ((RetTypes_68 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        RetTypeStr_74 = (MR_String) "void";
        OutParamTypes_75 = (MR_Word) ((MR_Unsigned) 0U);
      }
      else
      {
        MR_Word RetType_91 = ((MR_Word) ((MR_hl_field(1, RetTypes_68, (MR_Integer) 0))));

        OutParamTypes_75 = ((MR_Word) ((MR_hl_field(1, RetTypes_68, (MR_Integer) 1))));
        RetTypeStr_74 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_11, RetType_91);
      }
      mercury__list__map_foldl_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&ml_backend__mlds_to_cs_func_scalar_common_2[0]), OutParamTypes_75, &OutParams_76, ((MR_Box) ((MR_Integer) 2)), &conv2_Var_77);
      Var_81 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Parameters_67, OutParams_76);
      ParamsStr_82 = ml_backend__mlds_to_cs_func__params_to_string_for_csharp_3_f_0(Info_11, Indent_13, Var_81);
      mercury__io__write_string_4_p_0(Stream_12, RetTypeStr_74);
      mercury__io__write_string_4_p_0(Stream_12, (MR_String) " ");
      mercury__io__write_string_4_p_0(Stream_12, FuncNameStr_73);
      mercury__io__write_string_4_p_0(Stream_12, ParamsStr_82);
    }
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n");
