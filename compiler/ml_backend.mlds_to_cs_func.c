...
{
  {
    ...
    *HeadVar__4_4 = (MR_Integer) ((MR_Unsigned) Num_7 + (MR_Unsigned) (MR_Integer) 1);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_11, 0) = ((MR_Box) ((MR_Unsigned) 6U));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0)));
  ...
  MR_Word MaybeBody_16)
{
  if (!((MaybeBody_16 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1)));
    Var_26 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 5)));
    ...
    packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1)));
    Var_33 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 5)));
    ml_backend__mlds_to_cs_util__indent_line_after_context_5_p_0(Var_33, Context_14, Indent_11);
    mercury__io__write_string_3_p_0((MR_String) "}\n");
    packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1)));
    Var_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 5)));
