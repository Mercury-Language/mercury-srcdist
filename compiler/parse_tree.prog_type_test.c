...
static const MR_DuFunctorDescPtr parse_tree__prog_type_test__parse_tree__prog_type_test__du_stag_ordered_non_kinded_type_0_3[2];

static const MR_DuPtagLayout parse_tree__prog_type_test__parse_tree__prog_type_test__du_ptag_ordered_non_kinded_type_0[4];

static const MR_DuFunctorDescPtr parse_tree__prog_type_test__parse_tree__prog_type_test__du_name_ordered_non_kinded_type_0[5];

static const MR_Integer parse_tree__prog_type_test__parse_tree__prog_type_test__functor_number_map_non_kinded_type_0[5];
...
static /* final */ const MR_Box parse_tree__prog_type_test_scalar_common_1[2][2];
  ...
  MR_Word * ArgTypes_6)
{
  ...
  if (succeeded)
  {
    PredOrFunc_8 = ((MR_Unsigned) ((MR_hl_field(3, Var_18, 1))) & (MR_Integer) 1);
    ArgTypes0_9 = ((MR_Word) ((MR_hl_field(3, Var_18, 2))));
    {
      MR_String PredOrFuncStr_10;
      MR_Word Var_12;

      *ArgTypes_6 = ArgTypes0_9;
      PredOrFuncStr_10 = mdbcomp__prim_data__pred_or_func_to_str_1_f_0(PredOrFunc_8);
      {
  ...
  else
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Var_20)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_20, 0)))) == (MR_Integer) 0)));
    if (succeeded)
    {
      *ArgTypes_6 = ((MR_Word) ((MR_hl_field(3, Var_20, 1))));
      *TypeCtor_5 = (MR_Word) (&parse_tree__prog_type_test_scalar_common_1[1]);
      succeeded = MR_TRUE;
    }
  }
  return succeeded;
...
{
  MR_bool succeeded;
  MR_Word Var_2 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  MR_Word Var_3;
  MR_String Var_4;
  MR_String Var_5;
  MR_Integer Var_6 = ((MR_Integer) ((MR_hl_field(0, HeadVar__1_1, 1))));

  succeeded = ((MR_tag((MR_Word) Var_2)) == (MR_Integer) 1);
  if (succeeded)
  {
    Var_3 = ((MR_Word) ((MR_hl_field(1, Var_2, 0))));
    Var_5 = ((MR_String) ((MR_hl_field(1, Var_2, 1))));
    succeeded = ((MR_tag((MR_Word) Var_3)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_4 = ((MR_String) ((MR_hl_field(0, Var_3, 0))));
  ...
  MR_Word Type_2)
{
  ...
  if (succeeded)
  {
    TypeInfo_11_11 = (MR_Word) (&parse_tree__prog_type_test_scalar_common_1[0]);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_10 = ((MR_Word) ((MR_hl_field(1, Var_6, 0))));
...
{
  MR_bool succeeded;
  MR_Word SymName_7 = ((MR_Word) ((MR_hl_field(0, TypeCtor_4, 0))));
  MR_String PorFStr_10;

  if (((MR_tag((MR_Word) SymName_7)) == (MR_Integer) 1))
  {
    MR_Word ModuleSymName_9 = ((MR_Word) ((MR_hl_field(1, SymName_7, 0))));
    MR_String Qualifier_11;

    PorFStr_10 = ((MR_String) ((MR_hl_field(1, SymName_7, 1))));
    succeeded = ((MR_tag((MR_Word) ModuleSymName_9)) == (MR_Integer) 0);
    if (succeeded)
    {
      Qualifier_11 = ((MR_String) ((MR_hl_field(0, ModuleSymName_9, 0))));
  ...
  {
    PorFStr_10 = ((MR_String) ((MR_hl_field(0, SymName_7, 0))));
  ...
  MR_Word * GroundType_4)
{
  ...
  switch (MR_tag((MR_Word) Type_3)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word SymName_8 = ((MR_Word) ((MR_hl_field(1, Type_3, 0))));
        MR_Word ArgTypes_9 = ((MR_Word) ((MR_hl_field(1, Type_3, 1))));
        MR_Word Kind_10 = ((MR_Word) ((MR_hl_field(1, Type_3, 2))));
        MR_Word GroundArgTypes_11;

        succeeded = parse_tree__prog_type_test__types_are_ground_2_p_0(ArgTypes_9, &GroundArgTypes_11);
        if (succeeded)
        {
          {
            MR_Word base;
            ...
            *GroundType_4 = base;
            ...
            MR_hl_field(1, base, 1) = ((MR_Box) (GroundArgTypes_11));
    ...
    case (MR_Integer) 2:
      {
        MR_Word BuiltinType_7 = ((MR_Word) ((MR_hl_field(2, Type_3, 0))));

        {
          MR_Word base;
          base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *GroundType_4 = base;
          MR_hl_field(2, base, 0) = ((MR_Box) (BuiltinType_7));
        }
        succeeded = MR_TRUE;
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_3, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ArgTypes_17 = ((MR_Word) ((MR_hl_field(3, Type_3, 1))));
            MR_Word Kind_18 = ((MR_Word) ((MR_hl_field(3, Type_3, 2))));
            MR_Word GroundArgTypes_19;

            succeeded = parse_tree__prog_type_test__types_are_ground_2_p_0(ArgTypes_17, &GroundArgTypes_19);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 1) = ((MR_Box) (GroundArgTypes_19));
                MR_hl_field(3, base, 2) = ((MR_Box) (Kind_18));
              }
              succeeded = MR_TRUE;
            }
          }
        ...
        case (MR_Integer) 1:
          {
            MR_Word PorF_12 = ((MR_Unsigned) ((MR_hl_field(3, Type_3, 1))) & (MR_Integer) 1);
            MR_Word HoInstInfo_13 = ((MR_Word) ((MR_hl_field(3, Type_3, 3))));
            MR_Word Purity_14 = ((MR_Unsigned) ((MR_hl_field(3, Type_3, 4))) & (MR_Integer) 3);
            MR_Word ArgTypes_20 = ((MR_Word) ((MR_hl_field(3, Type_3, 2))));
            MR_Word GroundArgTypes_21;

            succeeded = parse_tree__prog_type_test__types_are_ground_2_p_0(ArgTypes_20, &GroundArgTypes_21);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (PorF_12));
                MR_hl_field(3, base, 2) = ((MR_Box) (GroundArgTypes_21));
                MR_hl_field(3, base, 3) = ((MR_Box) (HoInstInfo_13));
                MR_hl_field(3, base, 4) = (MR_Box) ((MR_Unsigned) (Purity_14));
              }
              succeeded = MR_TRUE;
            }
          }
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word GroundSubType_16;
            MR_Word Kind_22 = ((MR_Word) ((MR_hl_field(3, Type_3, 2))));

            succeeded = parse_tree__prog_type_test__type_is_ground_2_p_0(SubType_15, &GroundSubType_16);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 1) = ((MR_Box) (GroundSubType_16));
...
{
  MR_bool succeeded;
  MR_Word STATE_VARIABLE_Purity_1_12;
  MR_Word STATE_VARIABLE_PredOrFunc_1_13;
  MR_Word STATE_VARIABLE_PredArgTypes_1_14;
  MR_Word Var_18;
  ...
  if (succeeded)
  {
    STATE_VARIABLE_PredOrFunc_1_13 = ((MR_Unsigned) ((MR_hl_field(3, Var_18, 1))) & (MR_Integer) 1);
    STATE_VARIABLE_PredArgTypes_1_14 = ((MR_Word) ((MR_hl_field(3, Var_18, 2))));
    STATE_VARIABLE_Purity_1_12 = ((MR_Unsigned) ((MR_hl_field(3, Var_18, 4))) & (MR_Integer) 3);
    *STATE_VARIABLE_PredArgTypes_11 = STATE_VARIABLE_PredArgTypes_1_14;
    *STATE_VARIABLE_PredOrFunc_10 = STATE_VARIABLE_PredOrFunc_1_13;
    *STATE_VARIABLE_Purity_9 = STATE_VARIABLE_Purity_1_12;
  }
  else
    {
  ...
  MR_Word * ArgTypes_8)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Var_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_10, 0)))) == (MR_Integer) 1)));
  if (succeeded)
  {
    *PredOrFunc_7 = ((MR_Unsigned) ((MR_hl_field(3, Var_10, 1))) & (MR_Integer) 1);
    *ArgTypes_8 = ((MR_Word) ((MR_hl_field(3, Var_10, 2))));
    *Purity_6 = ((MR_Unsigned) ((MR_hl_field(3, Var_10, 4))) & (MR_Integer) 3);
  }
  return succeeded;
}
  ...
  MR_Word Type_2)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Var_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_7, 0)))) == (MR_Integer) 1)));
  return succeeded;
}
  ...
  MR_Word * ArgTypes_4)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Var_6)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_6, 0)))) == (MR_Integer) 0)));
  if (succeeded)
    *ArgTypes_4 = ((MR_Word) ((MR_hl_field(3, Var_6, 1))));
  return succeeded;
}
  ...
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Type0_3)) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type0_3, 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            Type_4 = (MR_Word) (Type0_3);
          ...
          case (MR_Integer) 2:
            {
              MR_Word Type1_5 = ((MR_Word) ((MR_hl_field(3, Type0_3, 1))));
