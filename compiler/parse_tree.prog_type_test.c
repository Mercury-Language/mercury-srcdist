...
static const MR_PseudoTypeInfo parse_tree__prog_type_test__parse_tree__prog_type_test__field_types_non_kinded_type_0_4[5];

static const MR_DuArgLocn parse_tree__prog_type_test__parse_tree__prog_type_test__field_locns_non_kinded_type_0_4[5];
  ...
  MR_Word * ArgTypes_6)
{
  ...
  Var_19 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type_4);
  ...
  else
  {
    ...
    Var_21 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type_4);
...
MR_bool MR_CALL 
parse_tree__prog_type_test__type_ctor_is_higher_order_4_p_0(
  MR_Word TypeCtor_5,
  MR_Word * Purity_6,
  ...
  switch (MR_tag((MR_Word) Type_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ArgTypes_21 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
            MR_Word Kind_22 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));
            MR_Word GroundArgTypes_23;

            succeeded = parse_tree__prog_type_test__types_are_ground_2_p_0(ArgTypes_21, &GroundArgTypes_23);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 1) = ((MR_Box) (GroundArgTypes_23));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word ArgTypes_24 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));
            MR_Word GroundArgTypes_25;

            succeeded = parse_tree__prog_type_test__types_are_ground_2_p_0(ArgTypes_24, &GroundArgTypes_25);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 2) = ((MR_Box) (GroundArgTypes_25));
        ...
        case (MR_Integer) 3:
          {
            MR_Word SubType_18 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
            MR_Word GroundSubType_19;
            MR_Word Kind_26 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));

            succeeded = parse_tree__prog_type_test__type_is_ground_2_p_0(SubType_18, &GroundSubType_19);
            if (succeeded)
            {
              {
                MR_Word base;
                ...
                *GroundType_4 = base;
                ...
                MR_hl_field(3, base, 1) = ((MR_Box) (GroundSubType_19));
...
void MR_CALL 
parse_tree__prog_type_test__type_is_higher_order_details_det_5_p_0(
  MR_Word Type_6,
  ...
  MR_Word * STATE_VARIABLE_PredArgTypes_14)
{
  ...
  Var_22 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type_6);
  ...
  if (succeeded)
  {
    ...
    *STATE_VARIABLE_Purity_11 = STATE_VARIABLE_Purity_15_15;
    ...
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.prog_type_test.type_is_higher_order_details_det\'/5", (MR_String) "type is not higher-order");
      return;
    }
}

MR_bool MR_CALL 
parse_tree__prog_type_test__type_is_higher_order_details_5_p_0(
  MR_Word Type_6,
  MR_Word * Purity_7,
  MR_Word * PredOrFunc_8,
  MR_Word * ArgTypes_10)
{
  ...
  Var_12 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type_6);
  ...
  MR_Word Type_2)
{
  ...
  Var_8 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type_2);
