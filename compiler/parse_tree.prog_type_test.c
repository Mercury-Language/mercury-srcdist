  ...
  MR_Word * STATE_VARIABLE_PredArgTypes_11)
{
  ...
  if (succeeded)
  {
    STATE_VARIABLE_PredOrFunc_13_13 = ((MR_Unsigned) ((MR_hl_field(3, Var_18, 1))) & (MR_Integer) 1);
    STATE_VARIABLE_PredArgTypes_14_14 = ((MR_Word) ((MR_hl_field(3, Var_18, 2))));
    STATE_VARIABLE_Purity_12_12 = ((MR_Unsigned) ((MR_hl_field(3, Var_18, 4))) & (MR_Integer) 3);
