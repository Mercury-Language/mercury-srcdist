  ...
  MR_Word ProgFunDeps_5)
{
  ...
  MR_Word ProgDomain_7 = ((MR_Word) ((MR_hl_field(0, ProgFunDeps_5, 0))));
  MR_Word ProgRange_8 = ((MR_Word) ((MR_hl_field(0, ProgFunDeps_5, 1))));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HLDSFunDeps_6 = hlds__make_hlds__add_class__make_hlds_fundep_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_68)
{
  ...
  if ((Interface_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      hlds__hlds_module__module_info_set_instance_table_3_p_0(Instances_55, STATE_VARIABLE_ModuleInfo_0_65, &STATE_VARIABLE_ModuleInfo_1_486);
      *STATE_VARIABLE_Specs_68 = STATE_VARIABLE_Specs_0_67;
      ...
      hlds__hlds_module__module_info_set_class_table_3_p_0(ClassTable_488, STATE_VARIABLE_ModuleInfo_1_486, STATE_VARIABLE_ModuleInfo_66);
    }
  }
  else
  {
    ...
    if (succeeded)
    {
      ...
      if ((MismatchPieces_193 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MR_Word STATE_VARIABLE_Specs_1_429;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            STATE_VARIABLE_Specs_1_429 = STATE_VARIABLE_Specs_0_67;
          else
          {
            MR_Word Var_155 = (MR_Word) (ClassArity_24);

            hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "typeclass", ClassName_15, Var_155, Context_21, OldContext_189, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_67, &STATE_VARIABLE_Specs_1_429);
          }
          {
        ...
        if ((HasIncompatibility_418 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          hlds__hlds_module__module_info_set_class_table_3_p_0(ClassTable_261, STATE_VARIABLE_ModuleInfo_3_259, STATE_VARIABLE_ModuleInfo_66);
        }
        else
        {
          MR_Word BadDefn_288;
          ...
          *STATE_VARIABLE_Specs_68 = STATE_VARIABLE_Specs_1_429;
        }
      }
      else
      {
    ...
    else
    {
      ...
      hlds__hlds_module__module_info_set_instance_table_3_p_0(Instances_204, STATE_VARIABLE_ModuleInfo_0_65, &STATE_VARIABLE_ModuleInfo_1_512);
      hlds__make_hlds__add_class__module_declare_class_method_preds_11_p_0(ClassName_15, ClassParamTVars_16, TypeClassStatus0_10, ItemMercuryStatus_9, NeedQual_11, Var_359, &ClassMethodPredProcIds_498, STATE_VARIABLE_ModuleInfo_1_512, &STATE_VARIABLE_ModuleInfo_3_502, STATE_VARIABLE_Specs_0_67, STATE_VARIABLE_Specs_68);
      ...
      hlds__hlds_module__module_info_set_class_table_3_p_0(ClassTable_504, STATE_VARIABLE_ModuleInfo_3_502, STATE_VARIABLE_ModuleInfo_66);
    }
  }
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  hlds__make_hlds__add_class__add_typeclass_defn_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_66, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Specs_68);
