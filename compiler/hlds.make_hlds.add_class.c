...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_28, 2) = ((MR_Box) ((MR_Unsigned) 20U));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_74, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    if ((PredIds_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_74, 0) = ((MR_Box) ((MR_Unsigned) 22U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_25, 0) = ((MR_Box) ((MR_Unsigned) 22U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_43, 2) = ((MR_Box) ((MR_Unsigned) 20U));
