...
hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__699__1_2_p_0(
  MR_Word PredOrFunc_15,
  MR_Word ClausePredOrFunc_26);

static MR_bool MR_CALL 
hlds__make_hlds__add_class__IntroducedFrom__pred__add_class_pred_or_func_decl__321__1_2_p_0(
  MR_Word WithInst_28,
  MR_Word HeadVar__2_60);

static MR_bool MR_CALL 
hlds__make_hlds__add_class__IntroducedFrom__pred__add_class_pred_or_func_decl__320__1_2_p_0(
  MR_Word WithType_27,
  MR_Word HeadVar__2_56);

static MR_Word MR_CALL 
hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__199__1_3_f_0(
  MR_Word TVars_4,
...
static MR_bool MR_CALL 
hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0_2(
  MR_Box closure_arg);

static MR_bool MR_CALL 
hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0_1(
  MR_Box closure_arg);

static void MR_CALL 
hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0(
  ...
  MR_Word NeedQual_19,
  MR_Word PredOrFuncInfo_20,
  MR_Word STATE_VARIABLE_PredProcIds_0_47,
  MR_Word * STATE_VARIABLE_PredProcIds_48,
...
static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_1[46][2];

static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_2[1][16];
...
static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_8[4][5];
...
static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_1[46][2] = {
  ...
  /* row 12 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[10])))
  },
  /* row 13 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row 14 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[13]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[10])))
  },
  /* row 15 */
  {
...
static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_7[2][1] = {
  /* row 0 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[34])))
  },
  /* row 1 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[44])))
  },
};
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[8]), ((MR_Box) (WithInst_28)), ((MR_Box) (HeadVar__2_60)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[7]), ((MR_Box) (WithType_27)), ((MR_Box) (HeadVar__2_56)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__699__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_8[3]));
    ...
    else
    {
      ...
      PredArity_38 = mercury__list__length_1_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[9]), HeadTerms_37);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo_55_55 = (MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[22]);
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[21])));
      }
      {
        PiecesA_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), PiecesA_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[42])));
      ...
      ContextB_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceDefnB_8, (MR_Integer) 4))));
      {
        ...
        MR_hl_field(MR_mktag(0), MsgB_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[45])));
      }
      {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[18])));
    }
    {
      Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[41])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_10, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[40])));
...
{
  {
    ...
    if ((PredIds_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[30])));
      }
      {
        Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[39])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[38])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Msg_64, 0) = ((MR_Box) (Context_24));
        MR_hl_field(MR_mktag(0), Msg_64, 1) = ((MR_Box) (Var_82));
      }
      {
    ...
    else
    {
      ...
      if ((TailPredIds_30 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        succeeded = hlds__hlds_pred__check_marker_2_p_0(PredMarkers_33, (MR_Integer) 11);
        if (succeeded)
        {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[30])));
    }
    {
      Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[39])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[38])));
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__add_class_pred_or_func_decl__321__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__add_class_pred_or_func_decl__320__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_52)
{
  {
    MR_bool succeeded;
    MR_Word PredName_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 0))));
    MR_Word PredOrFunc_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 1))) & (MR_Integer) 1);
    MR_Word TypesAndModes_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 2))));
    MR_Word WithType_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 3))));
    MR_Word WithInst_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 4))));
    MR_Word MaybeDetism_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 5))));
    MR_Word TypeVarSet_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 6))));
    MR_Word InstVarSet_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 7))));
    MR_Word ExistQVars_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 8))));
    MR_Word Purity_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 9))) & (MR_Integer) 3);
    MR_Word Constraints0_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 10))));
    MR_Word Context_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredOrFuncInfo_20, (MR_Integer) 11))));
    MR_Word Origin_36;
    MR_Word ClassParamTypes_37;
    MR_Word ImplicitConstraint_38;
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_8[1]));
      MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0_1));
      MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (WithType_27));
      MR_hl_field(MR_mktag(0), Var_53, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    mercury__require__expect_3_p_0(Var_53, (MR_String) "predicate \140hlds.make_hlds.add_class.add_class_pred_or_func_decl\'/13", (MR_String) "WithType != no");
    {
      Var_57 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_8[2]));
      MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0_2));
      MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (WithInst_28));
      MR_hl_field(MR_mktag(0), Var_57, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    mercury__require__expect_3_p_0(Var_57, (MR_String) "predicate \140hlds.make_hlds.add_class.add_class_pred_or_func_decl\'/13", (MR_String) "WithInst != no");
    {
      Origin_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Origin_36, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      MR_hl_field(MR_mktag(3), Origin_36, 1) = ((MR_Box) (PredName_24));
    }
    Var_61 = mercury__map__init_0_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
    parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_61, ClassParamVars_15, &ClassParamTypes_37);
    {
      ImplicitConstraint_38 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ImplicitConstraint_38, 0) = ((MR_Box) (ClassName_14));
      MR_hl_field(MR_mktag(0), ImplicitConstraint_38, 1) = ((MR_Box) (ClassParamTypes_37));
    }
    UnivConstraints0_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints0_34, (MR_Integer) 0))));
    ExistConstraints_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints0_34, (MR_Integer) 1))));
    {
      UnivConstraints_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), UnivConstraints_41, 0) = ((MR_Box) (ImplicitConstraint_38));
    ...
    hlds__add_pred__module_add_pred_or_func_21_p_0(Origin_36, Context_35, ItemNumber_16, MaybeItemMercuryStatus_17, PredStatus_18, NeedQual_19, PredOrFunc_25, PredName_24, TypeVarSet_30, InstVarSet_31, ExistQVars_32, TypesAndModes_26, Constraints_42, MaybeDetism_29, Purity_33, Markers_44, &MaybePredProcId_45, STATE_VARIABLE_ModuleInfo_0_49, STATE_VARIABLE_ModuleInfo_50, STATE_VARIABLE_Specs_0_51, STATE_VARIABLE_Specs_52);
    if ((MaybePredProcId_45 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_PredProcIds_48 = STATE_VARIABLE_PredProcIds_0_47;
    else
    {
      MR_Word PredProcId_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProcId_45, (MR_Integer) 0))));

      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_PredProcIds_48 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (PredProcId_46));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_PredProcIds_0_47));
      }
    }
  }
}
...
{
  {
    ...
    conv0_LambdaHeadVar__3_13 = hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__199__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
...
{
  {
    ...
    else
    {
      ...
      HeadVarVec_42 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[2]), PredOrFunc_18, HeadVars_32);
      {
        Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[28])));
    }
    {
      Var_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[37])));
    ...
    {
      Pieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[36])));
      MR_hl_field(MR_mktag(1), Pieces_12, 1) = ((MR_Box) (Var_19));
    }
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[18])));
        }
        {
          Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[32])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), NewPieces_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_class_scalar_common_1[31])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), OtherMsg_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[35])));
        }
        {
...
{
  {
    ...
    hlds__hlds_module__module_info_get_class_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_56, &Classes0_22);
      ...
      TypeClassStatus1_25 = TypeClassStatus0_13;
    {
      ...
      MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (hlds__make_hlds__add_class__add_typeclass_defn_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_60, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_60, 3) = ((MR_Box) (ClassParamVars_15));
    }
    HLDSFunDeps_27 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_fundep_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_fundep_0), Var_60, FunDeps_17);
    ...
    if (succeeded)
    {
      ...
      MR_Word OldClassMethodPredProcIds_41;
      ...
      {
        OldClassMethodPredProcIds_41 = (MR_Word) ((MR_Unsigned) 0U);
        ClassInterface_42 = Interface_18;
      }
      else
      {
        OldClassMethodPredProcIds_41 = OldClassMethodPredProcIds0_36;
      ...
      if (succeeded)
      {
        hlds__make_hlds_error__report_multiple_def_error_8_p_0(ClassName_14, ClassArity_23, (MR_String) "typeclass", Context_20, OldContext_38, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[12])), STATE_VARIABLE_Specs_0_58, STATE_VARIABLE_Specs_59);
      ...
      else
      {
        ...
        if (succeeded)
        {
          hlds__make_hlds_error__report_multiple_def_error_8_p_0(ClassName_14, ClassArity_23, (MR_String) "typeclass", Context_20, OldContext_38, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_class_scalar_common_1[14])), STATE_VARIABLE_Specs_0_58, STATE_VARIABLE_Specs_59);
          *STATE_VARIABLE_ModuleInfo_57 = STATE_VARIABLE_ModuleInfo_0_56;
        }
        else
        {
          MR_Word ErrorOrPrevDef_127;
          MR_Word STATE_VARIABLE_Specs_67_128;
          ...
          if (succeeded)
          {
            MR_Word Var_75 = (MR_Word) (TypeClassStatus_39);

            succeeded = (Var_75 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              STATE_VARIABLE_Specs_67_128 = STATE_VARIABLE_Specs_0_58;
            else
            {
              hlds__make_hlds_error__report_multiple_def_error_8_p_0(ClassName_14, ClassArity_23, (MR_String) "typeclass", Context_20, OldContext_38, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_58, &STATE_VARIABLE_Specs_67_128);
            }
            ErrorOrPrevDef_127 = (MR_Integer) 1;
          }
          else
          {
            ErrorOrPrevDef_127 = (MR_Integer) 0;
            STATE_VARIABLE_Specs_67_128 = STATE_VARIABLE_Specs_0_58;
          }
          switch (ErrorOrPrevDef_127) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word ClassMethodPredProcIds_49;
                MR_Word Kinds_51;
                MR_Word ClassDefn_52;
                MR_Word Classes_53;
                MR_Word STATE_VARIABLE_ModuleInfo_79_79;

                if ((Interface_18 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ClassMethodPredProcIds_49 = OldClassMethodPredProcIds_41;
                  STATE_VARIABLE_ModuleInfo_79_79 = STATE_VARIABLE_ModuleInfo_0_56;
                  *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_67_128;
                }
                else
                {
                  MR_Word ClassDecls_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Interface_18, (MR_Integer) 0))));
                  MR_Word Var_78;

                  {
                    Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (ItemMercuryStatus_11));
                  }
                  hlds__make_hlds__add_class__module_add_class_interface_11_p_0(ClassName_14, ClassParamVars_15, TypeClassStatus_39, Var_78, NeedQual_12, ClassDecls_48, &ClassMethodPredProcIds_49, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_79_79, STATE_VARIABLE_Specs_67_128, STATE_VARIABLE_Specs_59);
                }
                Kinds_51 = mercury__map__init_0_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
                {
                  ClassDefn_52 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 0) = ((MR_Box) (TypeClassStatus_39));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 1) = ((MR_Box) (Constraints_16));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 2) = ((MR_Box) (HLDSFunDeps_27));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 3) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 4) = ((MR_Box) (ClassParamVars_15));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 5) = ((MR_Box) (Kinds_51));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 6) = ((MR_Box) (ClassInterface_42));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 7) = ((MR_Box) (ClassMethodPredProcIds_49));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 8) = ((MR_Box) (VarSet_19));
                  MR_hl_field(MR_mktag(0), ClassDefn_52, 9) = ((MR_Box) (Context_20));
                }
                mercury__map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ((MR_Box) (ClassId_24)), ((MR_Box) (ClassDefn_52)), Classes0_22, &Classes_53);
                hlds__hlds_module__module_info_set_class_table_3_p_0(Classes_53, STATE_VARIABLE_ModuleInfo_79_79, STATE_VARIABLE_ModuleInfo_57);
              }
              break;
            case (MR_Integer) 1:
              {
    ...
    else
    {
      ...
      MR_Word ClassMethodPredProcIds_113;
      MR_Word Kinds_115;
      MR_Word ClassDefn_116;
      MR_Word Classes_117;
      MR_Word STATE_VARIABLE_ModuleInfo_79_120;
      MR_Word STATE_VARIABLE_ModuleInfo_81_121;

      if ((Interface_18 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ClassMethodPredProcIds_113 = (MR_Word) ((MR_Unsigned) 0U);
        STATE_VARIABLE_ModuleInfo_79_120 = STATE_VARIABLE_ModuleInfo_0_56;
        *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_0_58;
      }
      else
      {
        MR_Word ClassDecls_103 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Interface_18, (MR_Integer) 0))));
        MR_Word Var_104;

        {
          Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (ItemMercuryStatus_11));
        }
        hlds__make_hlds__add_class__module_add_class_interface_11_p_0(ClassName_14, ClassParamVars_15, TypeClassStatus1_25, Var_104, NeedQual_12, ClassDecls_103, &ClassMethodPredProcIds_113, STATE_VARIABLE_ModuleInfo_0_56, &STATE_VARIABLE_ModuleInfo_79_120, STATE_VARIABLE_Specs_0_58, STATE_VARIABLE_Specs_59);
      }
      Kinds_115 = mercury__map__init_0_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
      {
        ClassDefn_116 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ClassDefn_116, 0) = ((MR_Box) (TypeClassStatus1_25));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 1) = ((MR_Box) (Constraints_16));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 2) = ((MR_Box) (HLDSFunDeps_27));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 3) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 4) = ((MR_Box) (ClassParamVars_15));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 5) = ((MR_Box) (Kinds_115));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 6) = ((MR_Box) (Interface_18));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 7) = ((MR_Box) (ClassMethodPredProcIds_113));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 8) = ((MR_Box) (VarSet_19));
        MR_hl_field(MR_mktag(0), ClassDefn_116, 9) = ((MR_Box) (Context_20));
      }
      mercury__map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ((MR_Box) (ClassId_24)), ((MR_Box) (ClassDefn_116)), Classes0_22, &Classes_117);
      hlds__hlds_module__module_info_set_class_table_3_p_0(Classes_117, STATE_VARIABLE_ModuleInfo_79_120, &STATE_VARIABLE_ModuleInfo_81_121);
      hlds__hlds_module__module_info_get_instance_table_2_p_0(STATE_VARIABLE_ModuleInfo_81_121, &Instances0_54);
      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[1]), ((MR_Box) (ClassId_24)), ((MR_Box) ((MR_Unsigned) 0U)), Instances0_54, &Instances_55);
      hlds__hlds_module__module_info_set_instance_table_3_p_0(Instances_55, STATE_VARIABLE_ModuleInfo_81_121, STATE_VARIABLE_ModuleInfo_57);
    }
  }
}
  ...
  MR_Box * wrapper_arg_7)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_PredProcIds_48;
    MR_Word conv1_STATE_VARIABLE_ModuleInfo_50;
    MR_Word conv0_STATE_VARIABLE_Specs_52;

    hlds__make_hlds__add_class__add_class_pred_or_func_decl_13_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 7)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 8)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_PredProcIds_48, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_ModuleInfo_50, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_52);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_PredProcIds_48));
    *wrapper_arg_5 = ((MR_Box) (conv1_STATE_VARIABLE_ModuleInfo_50));
    *wrapper_arg_7 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_52));
  }
}
...
{
  {
    ...
    PredStatus_24 = (MR_Word) (OldImportStatus_23);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_32, 6) = ((MR_Box) (MaybeItemMercuryStatus_15));
      MR_hl_field(MR_mktag(0), Var_32, 7) = ((MR_Box) (PredStatus_24));
      MR_hl_field(MR_mktag(0), Var_32, 8) = ((MR_Box) (NeedQual_16));
    }
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[16]), ((MR_Box) (OldFunDeps_5)), ((MR_Box) (FunDeps_6)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[15]), ((MR_Box) (OldConstraints_18)), ((MR_Box) (Constraints_12)));
    return succeeded;
  }
}
