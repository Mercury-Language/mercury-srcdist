  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__5_5 = OtherInstanceDefns_20;
          MR_Word next_value_of_STATE_VARIABLE_Specs_0_6 = STATE_VARIABLE_Specs_77_77;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    check_hlds__clause_to_proc__maybe_add_default_func_mode_3_p_0(PredInfo0_41, &PredInfo_42, &MaybeProc_43);
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    succeeded = mercury__map__is_empty_1_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0, Procs_46);
                    if (succeeded)
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Methods_18;
          MR_Word next_value_of_STATE_VARIABLE_PredProcIds_0_2 = STATE_VARIABLE_PredProcIds_72_72;
          MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_4 = STATE_VARIABLE_ModuleInfo_73_73;
          MR_Word next_value_of_STATE_VARIABLE_Specs_0_6 = STATE_VARIABLE_Specs_70_70;
