      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              hlds__make_hlds_error__report_multiple_def_error_8_p_0(ClassName_14, ClassArity_23, (MR_String) "typeclass", Context_20, OldContext_38, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Specs_0_60, &STATE_VARIABLE_Specs_69_151);
            }
