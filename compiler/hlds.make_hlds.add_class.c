...
hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__582__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__582__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_63)
{
    ...
    TypeClassStatus1_26 = TypeClassStatus0_10;
  {
    ...
    MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_9[0]));
