...
MR_decl_label3(hlds__make_hlds__add_class__add_class_pred_or_func_methods_9_0, 13,4,5)
...
MR_decl_label8(hlds__make_hlds__add_class__check_method_modes_7_0, 67,3,7,6,9,10,12,15)
MR_decl_label8(hlds__make_hlds__add_class__check_method_modes_7_0, 17,20,22,24,19,26,41,28)
MR_decl_label4(hlds__make_hlds__add_class__check_method_modes_7_0, 29,11,5,72)
...
MR_decl_label7(hlds__make_hlds__add_class__module_add_class_method_9_0, 4,5,6,7,3,11,10)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module2)
	...
	MR_init_label7(hlds__make_hlds__add_class__module_add_class_method_9_0,4,5,6,7,3,11,10)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_class__module_add_class_method_9_0,5)
	...
	MR_tempr4 = MR_sv(12);
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr4, 0);
...
MR_def_label(hlds__make_hlds__add_class__module_add_class_method_9_0,3)
	...
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_class__module_add_class_method_9_0_i10);
	}
	MR_incr_sp(16);
	MR_sv(16) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module3)
	...
	MR_init_label3(hlds__make_hlds__add_class__add_class_pred_or_func_methods_9_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_class__add_class_pred_or_func_methods_9_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_class__add_class_pred_or_func_methods_9_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__make_hlds__add_class__add_class_pred_or_func_methods_9_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module5)
	...
	MR_init_label8(hlds__make_hlds__add_class__check_method_modes_7_0,67,3,7,6,9,10,12,15)
	MR_init_label8(hlds__make_hlds__add_class__check_method_modes_7_0,17,20,22,24,19,26,41,28)
	MR_init_label4(hlds__make_hlds__add_class__check_method_modes_7_0,29,11,5,72)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_class__check_method_modes_7_0,11)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		hlds__make_hlds__add_class__check_method_modes_7_0_i72);
MR_def_label(hlds__make_hlds__add_class__check_method_modes_7_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 1);
MR_def_label(hlds__make_hlds__add_class__check_method_modes_7_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__add_class__check_method_modes_7_0_i67);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_static(hlds__make_hlds__add_class__report_overlapping_instance_declaration_4_0)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(0, MR_tempr6, 1);
...
MR_def_static(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__485__1_3_0)
	...
	MR_fv(1) = MR_ctfield(0, MR_tempr1, 4);
	MR_fv(2) = MR_ctfield(0, MR_tempr1, 7);
	MR_fv(4) = MR_ctfield(0, MR_tempr1, 2);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_data, hlds_instance_defn);
	}
...
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__485__1_3_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
	MR_r3 = MR_ctfield(0, MR_tempr2, 5);
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	MR_fv(3) = MR_ctfield(0, MR_tempr2, 4);
	MR_fv(5) = MR_ctfield(0, MR_tempr2, 2);
	MR_tempr1 = MR_tempr2;
	MR_r1 = MR_fv(2);
