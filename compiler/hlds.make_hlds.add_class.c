  ...
  MR_Word ProgFunDeps_5)
{
  ...
  ArgPosns_21 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[1]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_15, ProgRange_8);
  mercury__set__list_to_set_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ArgPosns_21, &HLDSRange_10);
  {
