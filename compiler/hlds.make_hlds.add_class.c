  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(3, Var_65, 0) = ((MR_Box) ((MR_Unsigned) 22U));
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(3, Var_79, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  MR_Word * STATE_VARIABLE_Specs_43)
{
  ...
  if ((PredIds_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_71, 0) = ((MR_Box) ((MR_Unsigned) 27U));
