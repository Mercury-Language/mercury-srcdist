    ...
    if (((MR_tag((MR_Word) hlds__make_hlds__add_class__Method_15)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        {
          hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 10, hlds__make_hlds__add_class__Markers0_39, &hlds__make_hlds__add_class__Markers_40);
        }
        {
        ...
        if ((hlds__make_hlds__add_class__TailPredIds_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            {
              hlds__make_hlds__add_class__succeeded = hlds__hlds_pred__check_marker_2_p_0(hlds__make_hlds__add_class__PredMarkers_47, (MR_Integer) 10);
            }
            if (hlds__make_hlds__add_class__succeeded)
              {
