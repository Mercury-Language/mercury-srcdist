...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) NewInstanceBody_63)) == (MR_Integer) 1);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) OtherInstanceBody_28)) == (MR_Integer) 1);
      if (succeeded)
      {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          succeeded = ((MR_tag((MR_Word) Interface_18)) == (MR_Integer) 1);
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) OldInterface_35)) == (MR_Integer) 1);
            if (succeeded)
            {
            }
          }
