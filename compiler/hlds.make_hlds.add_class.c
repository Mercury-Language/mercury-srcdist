...
MR_decl_label10(hlds__make_hlds__add_class__check_method_modes_7_0, 70,3,7,6,9,10,12,15,17,20)
MR_decl_label10(hlds__make_hlds__add_class__check_method_modes_7_0, 43,22,26,19,27,29,31,11,5,75)
...
MR_decl_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0, 4,5,8,3,9,10,12,13,14,15)
MR_decl_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0, 17,16,21,23,20,26,27,30,31,32)
MR_decl_label3(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0, 34,35,36)
...
MR_decl_label10(hlds__make_hlds__add_class__produce_instance_method_clause_12_0, 3,6,8,5,9,11,12,13,14,16)
MR_decl_label1(hlds__make_hlds__add_class__produce_instance_method_clause_12_0, 17)
...
MR_def_static(hlds__make_hlds__add_class__module_add_class_method_9_0)
	...
	MR_sv(12) = MR_tfield(0, MR_tempr1, 11);
	MR_sv(13) = MR_tfield(0, MR_tempr1, 12);
	MR_sv(14) = MR_r5;
	MR_sv(15) = MR_r6;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module5)
	...
	MR_init_label10(hlds__make_hlds__add_class__check_method_modes_7_0,70,3,7,6,9,10,12,15,17,20)
	MR_init_label10(hlds__make_hlds__add_class__check_method_modes_7_0,43,22,26,19,27,29,31,11,5,75)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0);
	MR_init_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0,4,5,8,3,9,10,12,13,14,15)
	MR_init_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0,17,16,21,23,20,26,27,30,31,32)
	MR_init_label3(hlds__make_hlds__add_class__do_produce_instance_method_clauses_14_0,34,35,36)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_class__add_class_pred_or_func_mode_method_10_0)
	...
	MR_sv(8) = MR_tfield(1, MR_tempr1, 7);
	MR_sv(9) = MR_r5;
	MR_r1 = MR_r6;
	MR_sv(11) = MR_r7;
...
MR_def_static(hlds__make_hlds__add_class__report_overlapping_instance_declaration_4_0)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_tempr6, 1);
...
MR_def_label(hlds__make_hlds__add_class__check_instance_constraints_5_0,5)
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_sv(1), 2);
	MR_tfield(0, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_tfield(0, MR_sv(3), 2);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__produce_instance_method_clause_12_0);
	MR_init_label10(hlds__make_hlds__add_class__produce_instance_method_clause_12_0,3,6,8,5,9,11,12,13,14,16)
	MR_init_label1(hlds__make_hlds__add_class__produce_instance_method_clause_12_0,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_defn__155__1_2_0);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__206__1_3_0);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__484__1_3_0);
...
MR_def_static(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__484__1_3_0)
	...
	MR_fv(2) = MR_tfield(0, MR_tempr1, 7);
	MR_fv(4) = MR_tfield(0, MR_tempr1, 2);
...
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__484__1_3_0,2)
	...
	MR_fv(3) = MR_tfield(0, MR_tempr2, 4);
	MR_fv(5) = MR_tfield(0, MR_tempr2, 2);
	MR_tempr1 = MR_tempr2;
	MR_r1 = MR_fv(2);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__661__1_2_0);
MR_BEGIN_CODE
