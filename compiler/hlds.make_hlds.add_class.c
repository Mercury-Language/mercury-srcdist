...
MR_decl_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0, 4,5,9,3,10,11,13,14,15,16)
MR_decl_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0, 18,17,22,24,21,27,28,31,32,33)
...
MR_decl_label1(fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__207__1_3_0, 3)
...
MR_decl_static(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__662__1_2_0)
...
MR_def_label(hlds__make_hlds__add_class__module_add_class_defn_6_0,13)
	...
	MR_sv(14) = MR_tfield(0, MR_r2, 4);
	MR_sv(15) = MR_tfield(0, MR_r2, 6);
	MR_sv(16) = MR_tfield(0, MR_r2, 7);
	MR_sv(17) = MR_tfield(0, MR_r2, 8);
	MR_sv(18) = MR_tfield(0, MR_r2, 9);
	MR_r1 = MR_tempr1;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module11)
	...
	MR_init_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,4,5,9,3,10,11,13,14,15,16)
	MR_init_label10(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,18,17,22,24,21,27,28,31,32,33)
...
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,11)
	...
	MR_sv(14) = (MR_Word) MR_TAG_COMMON(0,0,19);
	MR_r1 = MR_sv(8);
...
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,15)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_nonlocals_3_0,
		hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0_i16);
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,16)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__check_marker_2_0,
		hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0_i18);
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0_i17);
	}
	MR_r1 = (MR_Integer) 2;
	MR_r2 = MR_sv(7);
...
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,17)
	...
	MR_r2 = (MR_Integer) 12;
	MR_np_call_localret_ent(hlds__hlds_pred__check_marker_2_0,
		hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0_i22);
MR_def_label(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_class__do_produce_instance_method_clauses_16_0_i21);
	}
	MR_r1 = (MR_Integer) 1;
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_purity_3_0,
...
MR_def_static(fn__hlds__make_hlds__add_class__make_hlds_fundep_2_0)
	...
	MR_sv(5) = (MR_Word) MR_TAG_COMMON(0,0,20);
...
MR_def_static(hlds__make_hlds__add_class__report_overlapping_instance_declaration_4_0)
	...
	MR_tfield(1, MR_r2, 3) = (MR_Word) MR_TAG_COMMON(1,0,25);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__add_class__check_instance_constraints_5_0,5)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_tempr1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,0,27);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(1,0,29);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
...
MR_def_static(hlds__make_hlds__add_class__produce_instance_method_clause_14_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__662__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_tempr2 = MR_r4;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_defn__156__1_2_0);
	MR_init_label1(hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_defn__156__1_2_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__module_add_class_defn__156__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module22)
	...
	MR_init_label1(fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__207__1_3_0,3)
MR_BEGIN_CODE
...
MR_def_static(fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__207__1_3_0)
	...
	MR_np_call_localret_ent(fn__hlds__make_hlds__add_class__get_list_index_3_0,
		fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__207__1_3_0_i3);
MR_def_label(fn__hlds__make_hlds__add_class__IntroducedFrom__func__make_hlds_fundep_2__207__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__485__1_3_0);
	MR_init_label4(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__485__1_3_0,2,4,5,6)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__check_for_overlapping_instances__485__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module24)
	MR_init_entry1(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__662__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__662__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__produce_instance_method_clause__662__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__662__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
