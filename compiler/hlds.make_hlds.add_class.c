  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_11[2]));
  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  else
  {
    ...
    hlds__make_hlds__qual_info__construct_and_record_pred_or_func_call_8_p_0(Var_64, PredOrFunc_18, InstancePredName_29, HeadVars_30, GoalInfo_35, &IntroducedGoal_38, STATE_VARIABLE_QualInfo_0_51, STATE_VARIABLE_QualInfo_52);
    {
