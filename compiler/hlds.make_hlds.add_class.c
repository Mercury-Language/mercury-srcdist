  ...
  MR_Word * STATE_VARIABLE_Specs_56)
{
  ...
  Var_58 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ClassParamTypes_34);
  {
    ...
    MR_hl_field(MR_mktag(0), ClassId_40, 1) = ((MR_Box) (Var_58));
  }
  ...
  parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_23, &UserArity_42, PredFormArity_41);
  {
    ...
    MR_hl_field(MR_mktag(0), MethodId_43, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_23));
    MR_hl_field(MR_mktag(0), MethodId_43, 1) = ((MR_Box) (PredName_22));
    MR_hl_field(MR_mktag(0), MethodId_43, 2) = ((MR_Box) (UserArity_42));
  }
  {
    Origin_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Origin_44, 0) = ((MR_Box) (ClassId_40));
    MR_hl_field(MR_mktag(1), Origin_44, 1) = ((MR_Box) (MethodId_43));
  }
  Attrs_45 = (MR_Word) (Origin_44);
  {
    MaybeAttrs_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), MaybeAttrs_46, 0) = ((MR_Box) (Attrs_45));
  }
  {
    PredDecl_48 = (MR_Word) MR_new_object(MR_Word, (14 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), PredDecl_48, 0) = ((MR_Box) (PredName_22));
    MR_hl_field(MR_mktag(0), PredDecl_48, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_23));
    MR_hl_field(MR_mktag(0), PredDecl_48, 2) = ((MR_Box) (ArgTypesAndModes_24));
    MR_hl_field(MR_mktag(0), PredDecl_48, 3) = ((MR_Box) (WithType_25));
    MR_hl_field(MR_mktag(0), PredDecl_48, 4) = ((MR_Box) (WithInst_26));
    MR_hl_field(MR_mktag(0), PredDecl_48, 5) = ((MR_Box) (MaybeDetism_27));
    MR_hl_field(MR_mktag(0), PredDecl_48, 6) = ((MR_Box) (MaybeAttrs_46));
    MR_hl_field(MR_mktag(0), PredDecl_48, 7) = ((MR_Box) (TypeVarSet_28));
    MR_hl_field(MR_mktag(0), PredDecl_48, 8) = ((MR_Box) (InstVarSet_29));
    MR_hl_field(MR_mktag(0), PredDecl_48, 9) = ((MR_Box) (ExistQVars_30));
    MR_hl_field(MR_mktag(0), PredDecl_48, 10) = (MR_Box) ((MR_Unsigned) (Purity_31));
    MR_hl_field(MR_mktag(0), PredDecl_48, 11) = ((MR_Box) (Constraints_39));
    MR_hl_field(MR_mktag(0), PredDecl_48, 12) = ((MR_Box) (Context_33));
  ...
  {
    MR_Word PredProcId_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProcId_49, (MR_Integer) 0))));

    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_PredProcIds_52 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (PredProcId_50));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_PredProcIds_0_51));
    }
  }
}
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  hlds__make_hlds__add_class__add_class_pred_or_func_decl_12_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 7)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_PredProcIds_52, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_ModuleInfo_54, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_56);
