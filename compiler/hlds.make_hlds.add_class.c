    ...
    if (((MR_tag((MR_Word) hlds__make_hlds__add_class__Method_19)) == (MR_mktag((MR_Integer) 0))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__Var_60, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_3[2]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__Var_64, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_3[3]));
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if ((hlds__make_hlds__add_class__Interface_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      ...
                      else
                        {
                          ...
                          {
                            mercury__list__filter_map_3_p_0((MR_Word) &hlds__make_hlds__add_class_scalar_common_1[1], hlds__make_hlds__add_class__TypeCtorInfo_104_104, (MR_Word) &hlds__make_hlds__add_class_scalar_common_4[0], hlds__make_hlds__add_class__PredProcIds0_49, &hlds__make_hlds__add_class__PredProcIds1_50);
                          }
                          {
    ...
    else
      {
        ...
        if ((hlds__make_hlds__add_class__Interface_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mercury__list__filter_map_3_p_0((MR_Word) &hlds__make_hlds__add_class_scalar_common_1[1], hlds__make_hlds__add_class__TypeCtorInfo_104_117, (MR_Word) &hlds__make_hlds__add_class_scalar_common_4[1], hlds__make_hlds__add_class__PredProcIds0_112, &hlds__make_hlds__add_class__PredProcIds1_113);
            }
            {
