...
MR_decl_label6(hlds__make_hlds__add_class__add_class_pred_or_func_mode_method_10_0, 21,22,18,15,10,26)
...
extern const MR_TypeCtorInfo_Struct mercury_data_hlds__hlds_data__type_ctor_info_hlds_instance_defn_0;
extern const MR_TypeCtorInfo_Struct mercury_data_builtin__type_ctor_info_int_0;
static const struct mercury_type_0 mercury_common_0[35] =
{
{
{
...
MR_def_static(hlds__make_hlds__add_class__missing_pred_or_func_method_error_6_0)
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,0,20);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module16)
	...
	MR_init_label6(hlds__make_hlds__add_class__add_class_pred_or_func_mode_method_10_0,21,22,18,15,10,26)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_class__report_overlapping_instance_declaration_4_0)
	...
	MR_tfield(1, MR_r2, 3) = (MR_Word) MR_TAG_COMMON(1,0,32);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__add_class__check_instance_constraints_5_0,5)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_tempr1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,0,17);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
