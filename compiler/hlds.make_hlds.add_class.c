...
MR_decl_label4(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0, 2,4,5,6)
...
MR_decl_static(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0)
MR_decl_static(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__658__1_2_0)
...
MR_def_static(hlds__make_hlds__add_class__check_for_overlapping_instances_5_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0);
...
MR_def_static(hlds__make_hlds__add_class__produce_instance_method_clause_14_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__658__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_tempr2 = MR_r4;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module23)
	MR_init_entry1(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0);
	MR_init_label4(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0,2,4,5,6)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__check_for_overlapping_instances__481__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred hlds.make_hlds.add_class.IntroducedFrom__pred__check_for_overlapping_instances__481__1/3-0", 5,
		MR_ENTRY(MR_do_fail));
	...
	MR_np_call_localret_ent(list__member_2_1,
		hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0_i2);
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_tfield(0, MR_r1, 5);
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
	...
	MR_np_call_localret_ent(parse_tree__prog_data__tvarset_merge_renaming_4_0,
		hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0_i4);
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_fv(3);
	MR_np_call_localret_ent(parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_0,
		hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0_i5);
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_list_subsumes_3_0,
		hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0_i6);
MR_def_label(hlds__make_hlds__add_class__IntroducedFrom__pred__check_for_overlapping_instances__481__1_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__add_class_module24)
	MR_init_entry1(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__658__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__658__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__produce_instance_method_clause__658__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__658__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
