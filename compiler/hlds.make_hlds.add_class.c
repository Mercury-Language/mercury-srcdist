...
hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__731__1_2_p_0(
  MR_Word hlds__make_hlds__add_class__PredOrFunc_15,
  MR_Word hlds__make_hlds__add_class__ClausePredOrFunc_26);

static MR_bool MR_CALL 
hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_method__386__1_2_p_0(
  MR_Word hlds__make_hlds__add_class__WithInst_29,
  MR_Word hlds__make_hlds__add_class__HeadVar__2_70);

static MR_bool MR_CALL 
hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_method__385__1_2_p_0(
...
{
  {
    ...
    {
      hlds__make_hlds__add_class__succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__produce_instance_method_clause__731__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 4))));
    }
    return hlds__make_hlds__add_class__succeeded;
  }
}
...
{
  {
    ...
    {
      hlds__make_hlds__add_class__succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_method__386__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 4))));
    }
    return hlds__make_hlds__add_class__succeeded;
  }
}
...
{
  {
    ...
    {
      hlds__make_hlds__add_class__succeeded = hlds__make_hlds__add_class__IntroducedFrom__pred__module_add_class_method__385__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__closure, (MR_Integer) 4))));
    }
    return hlds__make_hlds__add_class__succeeded;
  }
}
    ...
    if (((MR_tag((MR_Word) hlds__make_hlds__add_class__Method_19)) == (MR_mktag((MR_Integer) 0))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_61_61, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_4[2]));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_61_61, 1) = ((MR_Box) (hlds__make_hlds__add_class__module_add_class_method_12_p_0_1));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_61_61, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_61_61, 3) = ((MR_Box) (hlds__make_hlds__add_class__WithType_28));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_61_61, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mercury__require__expect_4_p_0(hlds__make_hlds__add_class__V_61_61, (MR_String) "hlds.make_hlds.add_class", (MR_String) "predicate \140hlds.make_hlds.add_class.module_add_class_method\'/12", (MR_String) "WithType != no");
        }
        {
          hlds__make_hlds__add_class__V_66_66 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_66_66, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_4[3]));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_66_66, 1) = ((MR_Box) (hlds__make_hlds__add_class__module_add_class_method_12_p_0_2));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_66_66, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_66_66, 3) = ((MR_Box) (hlds__make_hlds__add_class__WithInst_29));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_66_66, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mercury__require__expect_4_p_0(hlds__make_hlds__add_class__V_66_66, (MR_String) "hlds.make_hlds.add_class", (MR_String) "predicate \140hlds.make_hlds.add_class.module_add_class_method\'/12", (MR_String) "WithInst != no");
        }
        {
        ...
        {
          hlds__make_hlds__add_class__V_71_71 = mercury__map__init_0_f_0((MR_Word) &hlds__make_hlds__add_class_scalar_common_1[0], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
        }
        {
          parse_tree__prog_type__var_list_to_type_list_3_p_0(hlds__make_hlds__add_class__V_71_71, hlds__make_hlds__add_class__ClassParamVars_14, &hlds__make_hlds__add_class__ClassParamTypes_38);
        }
        ...
        {
          hlds__make_hlds__add_class__V_72_72 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_72_72, 0) = ((MR_Box) (hlds__make_hlds__add_class__ClassName_13));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_72_72, 1) = ((MR_Box) (hlds__make_hlds__add_class__ClassParamTypes_38));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_class__UnivConstraints_41, 0) = ((MR_Box) (hlds__make_hlds__add_class__V_72_72));
...
{
  {
    ...
    {
      mercury__list__filter_4_p_0(hlds__make_hlds__add_class__TypeCtorInfo_40_40, (MR_Word) &hlds__make_hlds__add_class_scalar_common_2[3], hlds__make_hlds__add_class__Methods_17, &hlds__make_hlds__add_class__ModeMethods_21, &hlds__make_hlds__add_class__PredOrFuncMethods_22);
    }
    {
    ...
    {
      hlds__make_hlds__add_class__V_33_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 1) = ((MR_Box) (hlds__make_hlds__add_class__module_add_class_interface_11_p_0_2));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 3) = ((MR_Box) (hlds__make_hlds__add_class__ClassName_12));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 4) = ((MR_Box) (hlds__make_hlds__add_class__ClassParamVars_13));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 5) = ((MR_Box) ((MR_Integer) -1));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 6) = ((MR_Box) (hlds__make_hlds__add_class__MaybeItemMercuryStatus_15));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 7) = ((MR_Box) (hlds__make_hlds__add_class__TypeClassStatus_14));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_class__V_33_33, 8) = ((MR_Box) (hlds__make_hlds__add_class__NeedQual_16));
    }
    {
      mercury__list__foldl3_8_p_0(hlds__make_hlds__add_class__TypeCtorInfo_40_40, (MR_Word) &hlds__make_hlds__add_class_scalar_common_1[7], (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, (MR_Word) &hlds__make_hlds__add_class_scalar_common_1[5], hlds__make_hlds__add_class__V_33_33, hlds__make_hlds__add_class__ModeMethods_21, ((MR_Box) (hlds__make_hlds__add_class__STATE_VARIABLE_PPIds_30_30)), &hlds__make_hlds__add_class__conv5_STATE_VARIABLE_PPIds_34_34, ((MR_Box) (hlds__make_hlds__add_class__STATE_VARIABLE_ModuleInfo_31_31)), &hlds__make_hlds__add_class__conv4_STATE_VARIABLE_ModuleInfo_35_35, ((MR_Box) (hlds__make_hlds__add_class__STATE_VARIABLE_Specs_32_32)), &hlds__make_hlds__add_class__conv3_STATE_VARIABLE_Specs_36_36);
    }
