...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_17_80 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_instance_defn_0;
...
{
  {
    ...
    else
    {
      ...
      mercury__map__set_4_p_0(TypeCtorInfo_106_146, (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0, ((MR_Box) (ClassId_24)), ((MR_Box) (ClassDefn_136)), Classes0_22, &Classes_137);
  ...
  MR_Word FunDeps0_4)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_7_7 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_fundep_0;
