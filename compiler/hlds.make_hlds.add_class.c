  ...
  MR_Word ProgFunDeps_5)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TVarToArgPosFunc_27, 0) = ((MR_Box) (&hlds__make_hlds__add_class_scalar_common_8[1]));
  ...
  MR_Word FunDeps0_4)
{
  ...
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__make_hlds__add_class_scalar_common_1[9]), ((MR_Box) (OldFunDeps_5)), ((MR_Box) (FunDeps_6)));
  return succeeded;
}
