...
static /* final */ const MR_Box hlds__make_hlds__add_class_scalar_common_1[34][2];
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  Var_32 = parse_tree__error_spec__color_as_subject_1_f_0(Var_33);
  {
    ...
    MR_hl_field(1, Var_44, 0) = ((MR_Box) (Var_29));
    MR_hl_field(1, Var_44, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_class_scalar_common_1[26])));
  }
  {
    Var_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_41, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_class_scalar_common_1[29])));
    MR_hl_field(1, Var_41, 1) = ((MR_Box) (Var_44));
  }
  {
    Var_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_38, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_class_scalar_common_1[31])));
    MR_hl_field(1, Var_38, 1) = ((MR_Box) (Var_41));
  }
  Var_37 = parse_tree__error_spec__color_as_incorrect_1_f_0(Var_38);
  Var_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_37, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_class_scalar_common_1[5])));
