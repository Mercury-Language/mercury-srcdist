...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(make__Globals_7, (MR_Integer) 48, &make__Verbose_18);
    }
      ...
      if (!((make__env).make__classify_target_2_4_p_0_env_0__cond_0))
        {
          ...
          if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
          ...
          else
            {
              ...
              {
                libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 564, &make__V_57_57);
              }
              ...
              if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 563, &make__V_58_58);
                  }
                  ...
                  if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
                  ...
                  else
                    {
                      ...
                      {
                        libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 565, &make__V_59_59);
                      }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 617, &make__TrackFlags_15);
    }
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 615, &make__KeepGoing_27);
            }
