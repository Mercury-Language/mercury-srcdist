      ...
      if (!((make__env).make__classify_target_2_4_p_0_env_0__cond_0))
        {
          ...
          if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
          ...
          else
            {
              ...
              {
                libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 576, &make__Var_57);
              }
              ...
              if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 575, &make__Var_58);
                  }
                  ...
                  if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
                  ...
                  else
                    {
                      ...
                      {
                        libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 577, &make__Var_59);
                      }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 629, &make__TrackFlags_15);
    }
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 627, &make__KeepGoing_27);
            }
            ...
            {
              libs__globals__lookup_int_option_3_p_0(make__Globals_8, (MR_Integer) 337, &make__AnalysisRepeat_34);
            }
            {
