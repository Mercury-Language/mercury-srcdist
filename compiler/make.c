    ...
    (env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      if (!((env).make__classify_target_2_4_p_0_env_0__cond_0))
      {
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 584, &Var_57);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 583, &Var_58);
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 585, &Var_59);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 637, &TrackFlags_15);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 635, &KeepGoing_27);
