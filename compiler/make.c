...
struct make__classify_target_2_4_p_0_env_0_s {
  ...
  MR_Word make__classify_target_2_4_p_0_env_0__ModuleTargetType_45;
...
make__IntroducedFrom__pred__make_process_compiler_args__368__1_1_p_0(
  MR_String LambdaHeadVar__1_71);

static void MR_CALL 
make__IntroducedFrom__pred__make_process_compiler_args__342__1_3_p_0(
  MR_String LambdaHeadVar__1_53);

static MR_bool MR_CALL 
make__IntroducedFrom__pred__make_process_compiler_args__332__1_1_p_0(
...
static /* final */ const MR_Box make_scalar_common_9[12][1];
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.make_track_flags_files_2\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make_scalar_common_9[11])), ModuleName_11, &HashFileName_24);
...
{
  {
...

    {
      ...
      (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = make__util__extension_to_target_type_3_p_0((env_ptr)->make__classify_target_2_4_p_0_env_0__Globals_5, (env_ptr)->make__classify_target_2_4_p_0_env_0__ExtStr1_16, &(env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45);
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      {
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45)) == (MR_Integer) 1);
        if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45, (MR_Integer) 0)));
          Var_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45, (MR_Integer) 0))) & (MR_Integer) 1);
        }
    ...
    }
    {
      ...
      (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = make__util__target_extension_synonym_2_p_0((env_ptr)->make__classify_target_2_4_p_0_env_0__ExtStr1_16, &(env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45);
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      {
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45)) == (MR_Integer) 1);
        if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
        {
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45, (MR_Integer) 0)));
          Var_61 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45, (MR_Integer) 0))) & (MR_Integer) 1);
        }
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = !((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded);
      }
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
...
{
  {
    ...
    (env_ptr)->make__classify_target_2_4_p_0_env_0__cond_0 = MR_TRUE;
    {
      ...
      (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) ((env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_45));
      }
      {
        MR_Word base;
...
{
  {
    ...
    (env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      {
        MR_Word ModuleTargetType_54;

        (env).make__classify_target_2_4_p_0_env_0__succeeded = make__util__target_extension_synonym_2_p_0(ExtStr_7, &ModuleTargetType_54);
        if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
        {
          (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
          {
            ...
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            (env).make__classify_target_2_4_p_0_env_0__TargetType_9 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleTargetType_54));
          }
          make__classify_target_2_4_p_0_1(&env);
        }
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 601, &Var_55);
          (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp(ExtStr_7, Var_55) == 0);
          if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
          {
          ...
          {
            MR_String ModuleNameStr1_52;
            MR_String Var_22;
            MR_String Var_56;

            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 600, &Var_56);
            (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp(ExtStr_7, Var_56) == 0);
            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
            {
              Var_22 = (MR_String) "lib";
              (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_22, &ModuleNameStr1_52, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
            }
            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
            {
              (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = ModuleNameStr1_52;
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 602, &Var_57);
              (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp(ExtStr_7, Var_57) == 0);
              if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
              {
                MR_Word ExecutableType_13;
                MR_Word CompilationTarget_60;

                (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                libs__globals__get_target_2_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, &CompilationTarget_60);
                ExecutableType_13 = ((&make_vector_common_10[4 + CompilationTarget_60]))->make__vector_common_type_10_0__vct_10_f_0;
                {
                  MR_Word base;
              ...
              else
              {
                ...
                (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp(ExtStr_7, (MR_String) ".beams") == 0);
                if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                {
                  Var_25 = (MR_String) "lib";
                  (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_25, &ModuleNameStr1_48, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
                }
                if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                {
                ...
                else
                {
                  (env).make__classify_target_2_4_p_0_env_0__cond_0 = MR_FALSE;
                  {
                    ...
                    {
                      Var_29 = (MR_String) "s";
                      (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_3(&DotlessExtStr1_15, Var_29, Rest_14);
                      if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                      {
                        Var_30 = (MR_String) ".";
                        (env).make__classify_target_2_4_p_0_env_0__ExtStr1_16 = mercury__string__f_43_43_2_f_0(Var_30, DotlessExtStr1_15);
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          {
                            MR_String ModuleNameStr1_40;
                            MR_String Var_37;

                            (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp(ExtStr_7, (MR_String) ".install") == 0);
                            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                            {
                              Var_37 = (MR_String) "lib";
                              (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_37, &ModuleNameStr1_40, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
                            }
                            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                            {
                              (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = ModuleNameStr1_40;
                            ...
                            else
                            {
                              ...
                              {
                                (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                                Var_39 = (MR_Word) ((MR_Unsigned) 20U);
...
{
  {
    ...
    make__IntroducedFrom__pred__make_process_compiler_args__342__1_3_p_0(((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    succeeded = make__IntroducedFrom__pred__make_process_compiler_args__368__1_1_p_0(((MR_String) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = make__IntroducedFrom__pred__make_process_compiler_args__332__1_1_p_0(((MR_String) (wrapper_arg_1)));
    return succeeded;
  }
}
