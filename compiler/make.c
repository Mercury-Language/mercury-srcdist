...
MR_decl_label1(make__IntroducedFrom__pred__make_process_args__313__1_1_0, 2)
MR_decl_label2(make__IntroducedFrom__pred__make_process_args__349__1_1_0, 3,1)
...
MR_decl_static(make__IntroducedFrom__pred__make_process_args__313__1_1_0)
MR_decl_static(make__IntroducedFrom__pred__make_process_args__323__1_3_0)
MR_decl_static(make__IntroducedFrom__pred__make_process_args__349__1_1_0)
...
{
MR_COMMON(2,0),
MR_ENTRY_AP(make__IntroducedFrom__pred__make_process_args__313__1_1_0),
0
},
{
MR_COMMON(2,1),
...
{
MR_COMMON(2,4),
MR_ENTRY_AP(make__IntroducedFrom__pred__make_process_args__349__1_1_0),
0
},
{
MR_COMMON(6,0),
...
{
MR_COMMON(5,1),
MR_ENTRY_AP(make__IntroducedFrom__pred__make_process_args__323__1_3_0),
0
},
{
MR_COMMON(8,0),
...
MR_BEGIN_MODULE(make_module47)
	MR_init_entry1(make__IntroducedFrom__pred__make_process_args__313__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__make__IntroducedFrom__pred__make_process_args__313__1_1_0);
	MR_init_label1(make__IntroducedFrom__pred__make_process_args__313__1_1_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__make_process_args__313__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(make__IntroducedFrom__pred__make_process_args__313__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__dir__directory_separator_0_0,
		make__IntroducedFrom__pred__make_process_args__313__1_1_0_i2);
MR_def_label(make__IntroducedFrom__pred__make_process_args__313__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(make_module48)
	MR_init_entry1(make__IntroducedFrom__pred__make_process_args__323__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__make__IntroducedFrom__pred__make_process_args__323__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__make_process_args__323__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(make__IntroducedFrom__pred__make_process_args__323__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(make_module49)
	MR_init_entry1(make__IntroducedFrom__pred__make_process_args__349__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__make__IntroducedFrom__pred__make_process_args__349__1_1_0);
	MR_init_label2(make__IntroducedFrom__pred__make_process_args__349__1_1_0,3,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__make_process_args__349__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(make__IntroducedFrom__pred__make_process_args__349__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r2 = (MR_Word) MR_string_const(".depend", 7);
	MR_np_call_localret_ent(string__suffix_2_0,
		make__IntroducedFrom__pred__make_process_args__349__1_1_0_i3);
MR_def_label(make__IntroducedFrom__pred__make_process_args__349__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(make__IntroducedFrom__pred__make_process_args__349__1_1_0_i1);
	}
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(make__IntroducedFrom__pred__make_process_args__349__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_FALSE;
