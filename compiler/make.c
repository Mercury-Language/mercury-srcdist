...
MR_decl_label2(make__IntroducedFrom__pred__make_process_args__347__1_1_0, 3,1)
...
MR_decl_label6(make__make_target_6_0, 2,4,3,7,15,9)
...
MR_decl_static(make__IntroducedFrom__pred__make_process_args__347__1_1_0)
...
{
MR_COMMON(0,4),
MR_ENTRY_AP(make__IntroducedFrom__pred__make_process_args__347__1_1_0),
0
},
{
MR_COMMON(6,0),
...
/*-------------------------------------------------------------------------*/
/* code for 'make_process_args'/5 mode 0 */
...
/*-------------------------------------------------------------------------*/
/* code for 'make_write_module_dep_file'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'make_track_flags_files'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(make_module4)
	...
	MR_init_label6(make__make_target_6_0,2,4,3,7,15,9)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'make_target'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(make__make_target_6_0,7)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(make__make_target_6_0_i15);
	}
...
MR_def_label(make__make_target_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = MR_sv(1);
	MR_tfield(0, MR_tempr1, 1) = MR_ctfield(0, MR_sv(2), 0);
...
MR_def_label(make__option_table_hash_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(getopt_io, option_data);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(3);
...
MR_def_label(make__option_table_hash_4_0,10)
	...
	MR_tempr2 = MR_sv(2);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,3,3);
	MR_r1 = MR_sv(2);
	MR_r3 = MR_tempr2;
	}
	MR_np_call_localret_ent(list__filter_3_0,
...
/*-------------------------------------------------------------------------*/
/* code for 'compare_hash_file'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'make_track_flags_files_2'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(make_module48)
	MR_init_entry1(make__IntroducedFrom__pred__make_process_args__347__1_1_0);
	MR_init_label2(make__IntroducedFrom__pred__make_process_args__347__1_1_0,3,1)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__make_process_args__347__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(make__IntroducedFrom__pred__make_process_args__347__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r2 = (MR_Word) MR_string_const(".depend", 7);
	MR_np_call_localret_ent(string__suffix_2_0,
		make__IntroducedFrom__pred__make_process_args__347__1_1_0_i3);
MR_def_label(make__IntroducedFrom__pred__make_process_args__347__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(make__IntroducedFrom__pred__make_process_args__347__1_1_0_i1);
	}
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(make__IntroducedFrom__pred__make_process_args__347__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_FALSE;
