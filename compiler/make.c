...
struct make__classify_target_2_4_p_0_env_0_s {
  ...
  MR_String make__classify_target_2_4_p_0_env_0__ExtStr_7;
  ...
  MR_Word make__classify_target_2_4_p_0_env_0__ModuleTargetType_49;
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make_scalar_common_2[3]), ((MR_Box) (AllOptionArgs_21)), ((MR_Box) (Var_105)));
          if (succeeded)
          {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".track_flags"))), ModuleName_11, &HashFileName_24);
...
{
  {
    ...
    (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env_ptr)->make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".cs") == 0);
...
{
  {
...

    {
      ...
      (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49)) == (MR_Integer) 1);
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49, (MR_Integer) 0)));
        Var_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49, (MR_Integer) 0))) & (MR_Integer) 1);
      }
      (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = !((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded);
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
...
{
  {
    ...
    {
      MR_Word Var_33;
      MR_Word Var_34 = (MR_Word) ((env_ptr)->make__classify_target_2_4_p_0_env_0__ExtStr1_16);

      {
        Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (Var_34));
      }
      make__util__target_extension_3_p_1((env_ptr)->make__classify_target_2_4_p_0_env_0__Globals_5, &(env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49, Var_33, make__classify_target_2_4_p_0_6, env_ptr);
    }
    {
      MR_Word Var_65;
      MR_Unsigned packed_word_1;

      (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = make__util__target_extension_synonym_2_p_0((env_ptr)->make__classify_target_2_4_p_0_env_0__ExtStr1_16, &(env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49);
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      {
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49)) == (MR_Integer) 1);
        if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
        {
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49, (MR_Integer) 0)));
          Var_65 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49, (MR_Integer) 0))) & (MR_Integer) 1);
        }
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = !((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded);
      }
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
...
{
  {
    ...
    (env_ptr)->make__classify_target_2_4_p_0_env_0__cond_1 = MR_TRUE;
    {
      ...
      (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) ((env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_49));
      }
      {
        MR_Word base;
...
{
  {
    ...
    (env).make__classify_target_2_4_p_0_env_0__ExtStr_7 = ExtStr_7;
    ...
    (env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      Var_19 = (MR_Word) ((env).make__classify_target_2_4_p_0_env_0__ExtStr_7);
      {
      ...
      make__util__target_extension_3_p_1((env).make__classify_target_2_4_p_0_env_0__Globals_5, &(env).make__classify_target_2_4_p_0_env_0__ModuleTargetType_10, Var_18, make__classify_target_2_4_p_0_3, &env);
      if (!((env).make__classify_target_2_4_p_0_env_0__cond_0))
      {
        MR_Word ModuleTargetType_58;

        (env).make__classify_target_2_4_p_0_env_0__succeeded = make__util__target_extension_synonym_2_p_0((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, &ModuleTargetType_58);
        if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
        {
          (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
          {
            ...
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleTargetType_58));
          }
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 603, &Var_59);
          (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, Var_59) == 0);
          if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
          {
            Var_21 = (MR_String) "lib";
            (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_21, &ModuleNameStr1_12, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
          }
          if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
          {
          ...
          {
            MR_String ModuleNameStr1_56;
            MR_String Var_24;
            MR_String Var_60;

            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 602, &Var_60);
            (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, Var_60) == 0);
            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
            {
              Var_24 = (MR_String) "lib";
              (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_24, &ModuleNameStr1_56, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
            }
            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
            {
              (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = ModuleNameStr1_56;
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 604, &Var_61);
              (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, Var_61) == 0);
              if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
              {
              ...
              else
              {
                ...
                (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".beams") == 0);
                if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                {
                  Var_27 = (MR_String) "lib";
                  (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_27, &ModuleNameStr1_52, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
                }
                if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                {
                ...
                else
                {
                  (env).make__classify_target_2_4_p_0_env_0__cond_1 = MR_FALSE;
                  {
                    ...
                    (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1((MR_String) ".all_", &Rest_14, (env).make__classify_target_2_4_p_0_env_0__ExtStr_7);
                    if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                    {
                      Var_31 = (MR_String) "s";
                      (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_3(&DotlessExtStr1_15, Var_31, Rest_14);
                      if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                      {
                        Var_32 = (MR_String) ".";
                        (env).make__classify_target_2_4_p_0_env_0__ExtStr1_16 = mercury__string__f_43_43_2_f_0(Var_32, DotlessExtStr1_15);
                        (env).make__classify_target_2_4_p_0_env_0__succeeded = MR_TRUE;
                      }
                    }
                    if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                      make__classify_target_2_4_p_0_5(&env);
                  }
                  (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_3(&(env).make__classify_target_2_4_p_0_env_0__ExtStr1_16, (MR_String) "s", (env).make__classify_target_2_4_p_0_env_0__ExtStr_7);
                  if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                    make__classify_target_2_4_p_0_5(&env);
                  if (!((env).make__classify_target_2_4_p_0_env_0__cond_1))
                  {
                    (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".check") == 0);
                    if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                    {
                      (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                    ...
                    {
                      (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".analyse") == 0);
                      if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                      {
                        (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                      ...
                      {
                        (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".clean") == 0);
                        if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                        {
                          (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                        ...
                        {
                          (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".realclean") == 0);
                          if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                          {
                            (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                          ...
                          {
                            MR_String ModuleNameStr1_44;
                            MR_String Var_41;

                            (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".install") == 0);
                            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                            {
                              Var_41 = (MR_String) "lib";
                              (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_1(Var_41, &ModuleNameStr1_44, (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6);
                            }
                            if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                            {
                              (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = ModuleNameStr1_44;
                            ...
                            else
                            {
                              ...
                              (env).make__classify_target_2_4_p_0_env_0__succeeded = (strcmp((env).make__classify_target_2_4_p_0_env_0__ExtStr_7, (MR_String) ".doc") == 0);
                              if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                              {
                                (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                                Var_43 = (MR_Word) ((MR_Unsigned) 20U);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 655, &KeepGoing_29);
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 361, &AnalysisRepeat_36);
