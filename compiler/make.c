...
make__IntroducedFrom__pred__make_process_compiler_args__365__1_1_p_0(
  MR_String LambdaHeadVar__1_71);

static void MR_CALL 
make__IntroducedFrom__pred__make_process_compiler_args__339__1_3_p_0(
  MR_String LambdaHeadVar__1_53);

static MR_bool MR_CALL 
make__IntroducedFrom__pred__make_process_compiler_args__329__1_1_p_0(
...
static /* final */ const MR_Box make_scalar_common_9[11][1] = {
  ...
  /* row 4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &make_scalar_common_9[3])))
  },
  /* row 5 */
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.make_track_flags_files_2\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make_scalar_common_9[10])), ModuleName_11, &HashFileName_24);
...
{
  {
    ...
    if (!((OptionsErrors_10 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_24 = mercury__string__f_43_43_2_f_0((MR_String) ": ", (MR_String) "handle_options returned with errors");
      Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "predicate \140make.option_table_hash\'/4", Var_24);
      {
        mercury__require__unexpected_2_p_0((MR_String) "make.m", Var_22);
        return;
      }
    }
    ...
    (env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 605, &Var_51);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 604, &Var_52);
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 606, &Var_53);
              ...
              else
              {
                ...
                if (!((env).make__classify_target_2_4_p_0_env_0__cond_0))
                {
                  ...
                  {
                    (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                    (env).make__classify_target_2_4_p_0_env_0__TargetType_9 = (MR_Word) (MR_mkword(MR_mktag(2), &make_scalar_common_9[4]));
                    (env).make__classify_target_2_4_p_0_env_0__succeeded = MR_TRUE;
                  }
                  else
                  {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            {
                              (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                              Var_37 = (MR_Word) ((MR_Unsigned) 20U);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 659, &TrackFlags_15);
...
{
  {
    ...
    make__IntroducedFrom__pred__make_process_compiler_args__339__1_3_p_0(((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    succeeded = make__IntroducedFrom__pred__make_process_compiler_args__365__1_1_p_0(((MR_String) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = make__IntroducedFrom__pred__make_process_compiler_args__329__1_1_p_0(((MR_String) (wrapper_arg_1)));
    return succeeded;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 657, &KeepGoing_29);
            ...
            NonDependTargets_33 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make_scalar_common_1[14]), Targets_17);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&make_scalar_common_5[0]));
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 492, &AnalysisRepeat_36);
