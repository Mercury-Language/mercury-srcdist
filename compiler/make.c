      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make_scalar_common_2[3]), ((MR_Box) (AllOptionArgs_21)), ((MR_Box) (Var_104)));
          if (succeeded)
          {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_String) ".track_flags", ModuleName_11, &HashFileName_24);
...
{
  {
...

    {
      ...
      make__util__target_extension_2_f_1((env_ptr)->make__classify_target_2_4_p_0_env_0__Globals_5, &(env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_47, Var_32, make__classify_target_2_4_p_0_6, env_ptr);
    }
    {
      MR_Word Var_63;
      ...
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      {
        ...
        if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
        {
          ...
          Var_63 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__classify_target_2_4_p_0_env_0__ModuleTargetType_47, (MR_Integer) 0))) & (MR_Integer) 1);
        }
        (env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded = !((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded);
      }
      if ((env_ptr)->make__classify_target_2_4_p_0_env_0__succeeded)
      ...
      if (!((env).make__classify_target_2_4_p_0_env_0__cond_0))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 602, &Var_58);
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 604, &Var_59);
              ...
              if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
              {
                ...
                (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr_11 = (env).make__classify_target_2_4_p_0_env_0__ModuleNameStr0_6;
                libs__globals__get_target_2_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, &CompilationTarget_62);
                ExecutableType_13 = ((&make_vector_common_10[4 + CompilationTarget_62]))->make__vector_common_type_10_0__vct_10_f_0;
                {
                  MR_Word base;
              ...
              else
              {
                ...
                else
                {
                  (env).make__classify_target_2_4_p_0_env_0__cond_1 = MR_FALSE;
                  {
                    ...
                    {
                      Var_30 = (MR_String) "s";
                      (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_3(&DotlessSuffix1_15, Var_30, Rest_14);
                      if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                      {
                        Var_31 = (MR_String) ".";
                        (env).make__classify_target_2_4_p_0_env_0__Suffix1_16 = mercury__string__f_43_43_2_f_0(Var_31, DotlessSuffix1_15);
                  ...
                  (env).make__classify_target_2_4_p_0_env_0__succeeded = mercury__string__append_3_p_3(&(env).make__classify_target_2_4_p_0_env_0__Suffix1_16, (MR_String) "s", (env).make__classify_target_2_4_p_0_env_0__Suffix_7);
                  if ((env).make__classify_target_2_4_p_0_env_0__succeeded)
                    make__classify_target_2_4_p_0_5(&env);
