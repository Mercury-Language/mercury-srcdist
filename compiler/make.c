...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(make__Globals_7, (MR_Integer) 52, &make__Verbose_18);
    }
      ...
      if (!((make__env).make__classify_target_2_4_p_0_env_0__cond_0))
        {
          ...
          if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
          ...
          else
            {
              ...
              {
                libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 568, &make__V_57_57);
              }
              ...
              if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 567, &make__V_58_58);
                  }
                  ...
                  if ((make__env).make__classify_target_2_4_p_0_env_0__succeeded)
                  ...
                  else
                    {
                      ...
                      {
                        libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 569, &make__V_59_59);
                      }
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 619, &make__KeepGoing_27);
            }
