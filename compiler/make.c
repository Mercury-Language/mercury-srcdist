...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 62, &Verbose_18);
    switch (Verbose_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    (env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      if (!((env).make__classify_target_2_4_p_0_env_0__cond_0))
      {
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 598, &Var_57);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 597, &Var_58);
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 599, &Var_59);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 651, &TrackFlags_15);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 649, &KeepGoing_27);
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 357, &AnalysisRepeat_34);
