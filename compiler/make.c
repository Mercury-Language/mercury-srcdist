    ...
    (make__env).make__classify_target_2_4_p_0_env_0__cont_env_ptr = make__cont_env_ptr;
    {
      ...
      if (!((make__env).make__classify_target_2_4_p_0_env_0__cond_0))
      {
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 577, &make__Var_57);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 576, &make__Var_58);
            ...
            else
            {
              ...
              libs__globals__lookup_string_option_3_p_0((make__env).make__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 578, &make__Var_59);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 630, &make__TrackFlags_15);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(make__Globals_8, (MR_Integer) 628, &make__KeepGoing_27);
