...
static MR_bool MR_CALL 
check_hlds__inst_merge__merge_bound_insts_6_p_0(
  MR_Word Type_7,
  MR_Word InstA_8,
  MR_Word InstB_9,
  MR_Word * InstAB_10,
      ...
      switch (MR_tag((MR_Word) InstB_9)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, InstB_9, 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word SubInstB_125 = ((MR_Word) ((MR_hl_field(3, InstB_9, 2))));

                succeeded = check_hlds__inst_merge__inst_merge_6_p_0(Type_7, InstA_8, SubInstB_125, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
              }
              break;
            case (MR_Integer) 2:
              {
      ...
      switch (MR_tag((MR_Word) InstB_9)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word UniqA_135 = ((MR_Unsigned) ((MR_hl_field(1, InstA_8, 0))) & (MR_Integer) 7);
            MR_Word HOInstInfoA_136 = ((MR_Word) ((MR_hl_field(1, InstA_8, 1))));

            succeeded = check_hlds__inst_merge__merge_ho_inst_info_5_p_0(STATE_VARIABLE_ModuleInfo_0_40, Type_7, HOInstInfoA_136, HOInstInfoB_58, &HOInstInfo_71);
            if (succeeded)
            {
              check_hlds__inst_merge__merge_uniq_3_p_0(UniqA_135, UniqB_57, &Uniq_70);
              *STATE_VARIABLE_ModuleInfo_41 = STATE_VARIABLE_ModuleInfo_0_40;
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word UniqA_129 = ((MR_Unsigned) ((MR_hl_field(1, InstA_8, 0))) & (MR_Integer) 7);

            succeeded = check_hlds__inst_merge__inst_merge_bound_ground_8_p_0(Type_7, UniqB_76, InstResultsB_59, BoundFunctorsB_60, UniqA_129, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
            if (succeeded)
            {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, InstB_9, 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word SubInstB_139 = ((MR_Word) ((MR_hl_field(3, InstB_9, 2))));

                succeeded = check_hlds__inst_merge__inst_merge_6_p_0(Type_7, InstA_8, SubInstB_139, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
              }
              break;
            case (MR_Integer) 2:
              {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word InstResultsA_115 = ((MR_Word) ((MR_hl_field(2, InstA_8, 1))));
            MR_Word BoundFunctorsA_116 = ((MR_Word) ((MR_hl_field(2, InstA_8, 2))));
            MR_Word UniqA_117 = ((MR_Unsigned) ((MR_hl_field(2, InstA_8, 0))) & (MR_Integer) 7);

            succeeded = check_hlds__inst_merge__inst_merge_bound_ground_8_p_0(Type_7, UniqA_117, InstResultsA_115, BoundFunctorsA_116, UniqB_91, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
            if (succeeded)
            {
          ...
          break;
        case (MR_Integer) 2:
          succeeded = check_hlds__inst_merge__merge_bound_insts_6_p_0(Type_7, InstA_8, InstB_9, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, InstB_9, 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              {
                MR_Word SubInstB_120 = ((MR_Word) ((MR_hl_field(3, InstB_9, 2))));

                succeeded = check_hlds__inst_merge__inst_merge_6_p_0(Type_7, InstA_8, SubInstB_120, InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, STATE_VARIABLE_ModuleInfo_41);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                MR_Word UniqA_94 = ((MR_Unsigned) ((MR_hl_field(2, InstA_8, 0))) & (MR_Integer) 7);

                check_hlds__inst_merge__merge_uniq_bound_5_p_0(STATE_VARIABLE_ModuleInfo_0_40, UniqB_93, UniqA_94, BoundFunctorsA_62, &Uniq_92);
                switch (Uniq_92) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                ...
                if (succeeded)
                  ...
                  succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_40, InstResultsA_61, BoundFunctorsA_62);
                if (succeeded)
                {
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word UniqA_101 = ((MR_Unsigned) ((MR_hl_field(3, InstA_8, 1))) & (MR_Integer) 7);
                MR_Word HOInstInfoA_102 = ((MR_Word) ((MR_hl_field(3, InstA_8, 2))));

                succeeded = check_hlds__inst_merge__merge_ho_inst_info_5_p_0(STATE_VARIABLE_ModuleInfo_0_40, Type_7, HOInstInfoA_102, HOInstInfoB_80, &HOInstInfo_78);
                if (succeeded)
                {
                  check_hlds__inst_merge__merge_uniq_3_p_0(UniqA_101, UniqB_79, &Uniq_77);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    *InstAB_10 = base;
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word UniqA_96 = ((MR_Unsigned) ((MR_hl_field(3, InstA_8, 1))) & (MR_Integer) 7);

                check_hlds__inst_merge__merge_uniq_bound_5_p_0(STATE_VARIABLE_ModuleInfo_0_40, UniqA_96, UniqB_86, BoundFunctorsB_88, &Uniq_85);
                switch (Uniq_85) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                ...
                if (succeeded)
                  ...
                  succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_40, InstResultsB_87, BoundFunctorsB_88);
                if (succeeded)
                {
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__inst_util__get_cons_id_arg_types_for_bound_functor_4_p_0(STATE_VARIABLE_ModuleInfo_0_26, Type_7, Var_38, &Types_22);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_4_p_0(STATE_VARIABLE_ModuleInfo_0_24, Type_9, InstResultsA_11, BoundFunctorsA_12);
  if (succeeded)
  {
    MR_Word Uniq_16;
    MR_Word Uniq0_43;
  ...
  else
  {
    ...
    succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_24, InstResultsA_11, BoundFunctorsA_12);
    if (succeeded)
    {
      succeeded = hlds__type_util__type_constructors_3_p_0(STATE_VARIABLE_ModuleInfo_0_24, Type_9, &Constructors_17);
      if (succeeded)
      {
        MR_Word TypeCtor_18;
        MR_Word BoundFunctorsB0_19;
        MR_Word BoundFunctorsB_111;
        MR_Word Uniq_112;
        MR_Word BoundFunctorsAB_113;
        MR_Word Var_114;
        MR_Word Var_30;
        MR_Word Var_32;
        MR_Word Var_34;
        ...
        hlds__mode_util__constructors_to_bound_functors_5_p_0(STATE_VARIABLE_ModuleInfo_0_24, UniqB_13, TypeCtor_18, Constructors_17, &BoundFunctorsB0_19);
        mercury__list__sort_and_remove_dups_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_functor_0), BoundFunctorsB0_19, &BoundFunctorsB_111);
        ...
        check_hlds__inst_merge__merge_uniq_3_p_0(UniqA_10, UniqB_13, &Uniq_112);
        succeeded = check_hlds__inst_merge__bound_functor_list_merge_6_p_0(Type_9, BoundFunctorsA_12, BoundFunctorsB_111, &BoundFunctorsAB_113, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25);
        if (succeeded)
        {
          Var_114 = (MR_Word) ((MR_Unsigned) 0U);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Result_14 = base;
            MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_112));
            MR_hl_field(2, base, 1) = ((MR_Box) (Var_114));
            MR_hl_field(2, base, 2) = ((MR_Box) (BoundFunctorsAB_113));
          }
          succeeded = MR_TRUE;
        }
      }
...
{
  MR_bool succeeded;
  MR_Word UniqA_12 = ((MR_Unsigned) ((MR_hl_field(2, InstA_8, 0))) & (MR_Integer) 7);
  MR_Word BoundFunctorsA_14 = ((MR_Word) ((MR_hl_field(2, InstA_8, 2))));
  MR_Word UniqB_15 = ((MR_Unsigned) ((MR_hl_field(2, InstB_9, 0))) & (MR_Integer) 7);
  MR_Word BoundFunctorsB_17 = ((MR_Word) ((MR_hl_field(2, InstB_9, 2))));
  MR_Word Uniq_18;
  MR_Word BoundFunctorsAB_19;
  MR_Word Var_23;

  succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_12, UniqB_15);
  if (succeeded)
    Uniq_18 = UniqB_15;
  else
    Uniq_18 = UniqA_12;
  succeeded = check_hlds__inst_merge__bound_functor_list_merge_6_p_0(Type_7, BoundFunctorsA_14, BoundFunctorsB_17, &BoundFunctorsAB_19, STATE_VARIABLE_ModuleInfo_0_20, STATE_VARIABLE_ModuleInfo_21);
  if (succeeded)
  {
    Var_23 = (MR_Word) ((MR_Unsigned) 0U);
    {
      ...
      base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      *InstAB_10 = base;
      MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_18));
      MR_hl_field(2, base, 1) = ((MR_Box) (Var_23));
      MR_hl_field(2, base, 2) = ((MR_Box) (BoundFunctorsAB_19));
    }
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  if (succeeded)
  {
    Var_12 = ((MR_Unsigned) ((MR_hl_field(2, InstA_8, 0))) & (MR_Integer) 7);
    Var_14 = ((MR_Word) ((MR_hl_field(2, InstA_8, 2))));
    succeeded = ((MR_tag((MR_Word) InstB_9)) == (MR_Integer) 2);
    if (succeeded)
    {
      Var_15 = ((MR_Unsigned) ((MR_hl_field(2, InstB_9, 0))) & (MR_Integer) 7);
      Var_17 = ((MR_Word) ((MR_hl_field(2, InstB_9, 2))));
    }
  }
  if (succeeded)
  {
    MR_Word Uniq_43;
    MR_Word BoundFunctorsAB_44;
    MR_Word Var_45;

    check_hlds__inst_merge__merge_uniq_3_p_0(Var_12, Var_15, &Uniq_43);
    succeeded = check_hlds__inst_merge__bound_functor_list_merge_6_p_0(Type_7, Var_14, Var_17, &BoundFunctorsAB_44, STATE_VARIABLE_ModuleInfo_0_31, STATE_VARIABLE_ModuleInfo_32);
    if (succeeded)
    {
      Var_45 = (MR_Word) ((MR_Unsigned) 0U);
      {
        ...
        base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        *InstAB_10 = base;
        MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_43));
        MR_hl_field(2, base, 1) = ((MR_Box) (Var_45));
        MR_hl_field(2, base, 2) = ((MR_Box) (BoundFunctorsAB_44));
      }
      succeeded = MR_TRUE;
    }
  }
  else
  {
    ...
    if ((MaybeOldMaybeMergedInst_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      MR_Word Var_36;
      MR_Word ExpandedInstA_46;
      MR_Word ExpandedInstB_47;
      ...
      hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstA_8, &ExpandedInstA_46);
      hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstB_9, &ExpandedInstB_47);
      switch (MR_tag((MR_Word) ExpandedInstA_46)) {
        default:
          succeeded = MR_FALSE;
          break;
        case (MR_Integer) 0:
          switch (MR_unmkbody(ExpandedInstA_46)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_tag((MR_Word) ExpandedInstB_47)) {
                default:
                  succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
                  switch (MR_unmkbody(ExpandedInstB_47)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      succeeded = check_hlds__inst_merge__inst_merge_3_6_p_0(Type_7, ExpandedInstA_46, ExpandedInstB_47, &InstAB0_25, STATE_VARIABLE_ModuleInfo_2_34, &STATE_VARIABLE_ModuleInfo_3_35);
                      break;
                    case (MR_Integer) 1:
                      {
                        InstAB0_25 = ExpandedInstA_46;
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstB_47, 0))))) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 1:
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstA_46, 0))))) {
            default:
              succeeded = MR_FALSE;
              break;
            case (MR_Integer) 1:
    ...
    if (succeeded)
    {
      succeeded = hlds__inst_test__inst_contains_inst_name_3_p_0(*STATE_VARIABLE_ModuleInfo_32, MergeInstName_21, InstAB0_25);
      if (succeeded)
        {
          MR_Word base;
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_7, InstName_18, &Inst_19);
                // direct tailcall eliminated
                ;
