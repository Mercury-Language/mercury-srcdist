...
check_hlds__inst_merge__inst_merge_3_6_p_0(
  ...
  MR_Word tscc_proc_2_input_4_STATE_VARIABLE_ModuleInfo_0_40,
...
top_of_proc_1:;
  {
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) ExpandedInstA_37)) {
        default:
          succeeded = MR_FALSE;
          break;
        case (MR_Integer) 0:
          switch (MR_unmkbody(ExpandedInstA_37)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_tag((MR_Word) ExpandedInstB_38)) {
                default:
                  succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
                  switch (MR_unmkbody(ExpandedInstB_38)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Word next_value_of_tscc_proc_2_input_4_STATE_VARIABLE_ModuleInfo_0_40 = STATE_VARIABLE_ModuleInfo_0_31;
                        ...
                        tscc_proc_2_input_4_STATE_VARIABLE_ModuleInfo_0_40 = next_value_of_tscc_proc_2_input_4_STATE_VARIABLE_ModuleInfo_0_40;
                        goto top_of_proc_2;
                      }
                      break;
                    case (MR_Integer) 1:
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstB_38, (MR_Integer) 0))))) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 1:
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstA_37, (MR_Integer) 0))))) {
            default:
              succeeded = MR_FALSE;
              break;
            case (MR_Integer) 1:
    ...
    else
    {
      ...
      if ((MaybeMaybeMergedInst_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MR_Word Var_36;
        MR_Word ExpandedInstA_59;
        MR_Word ExpandedInstB_60;
        ...
        check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_34_34, InstA_8, &ExpandedInstA_59);
        check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_34_34, InstB_9, &ExpandedInstB_60);
        switch (MR_tag((MR_Word) ExpandedInstA_59)) {
          default:
            succeeded = MR_FALSE;
            break;
          case (MR_Integer) 0:
            switch (MR_unmkbody(ExpandedInstA_59)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_tag((MR_Word) ExpandedInstB_60)) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 0:
                    switch (MR_unmkbody(ExpandedInstB_60)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        succeeded = check_hlds__inst_merge__inst_merge_3_6_p_0(Type_7, ExpandedInstA_59, ExpandedInstB_60, &InstAB0_25, STATE_VARIABLE_ModuleInfo_34_34, &STATE_VARIABLE_ModuleInfo_35_35);
                        break;
                      case (MR_Integer) 1:
                        {
                          InstAB0_25 = ExpandedInstA_59;
                  ...
                  case (MR_Integer) 2:
                    ...
                    break;
                  case (MR_Integer) 3:
                    switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstB_60, (MR_Integer) 0))))) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 1:
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, ExpandedInstA_59, (MR_Integer) 0))))) {
              default:
                succeeded = MR_FALSE;
                break;
              case (MR_Integer) 1:
...
top_of_proc_2:;
  {
    ...
    MR_Word InstAB_10;
    MR_Word STATE_VARIABLE_ModuleInfo_0_40 = tscc_proc_2_input_4_STATE_VARIABLE_ModuleInfo_0_40;
    ...
    switch (MR_tag((MR_Word) InstA_8)) {
      ...
      case (MR_Integer) 0:
        switch (MR_tag((MR_Word) InstB_9)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_merge__inst_merge_4_6_p_0(Type_7, InstA_8, InstB_9, &InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, &STATE_VARIABLE_ModuleInfo_41);
            break;
          case (MR_Integer) 1:
          case (MR_Integer) 2:
            succeeded = check_hlds__inst_merge__inst_merge_4_6_p_0(Type_7, InstA_8, InstB_9, &InstAB_10, STATE_VARIABLE_ModuleInfo_0_40, &STATE_VARIABLE_ModuleInfo_41);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word next_value_of_tscc_proc_1_input_3_InstB_9 = SubInstB_46;
                  MR_Word next_value_of_tscc_proc_1_input_4_STATE_VARIABLE_ModuleInfo_0_31 = STATE_VARIABLE_ModuleInfo_0_40;
    ...
    tscc_output_succeeded = succeeded;
    tscc_output_1_InstAB_10 = InstAB_10;
    tscc_output_2_STATE_VARIABLE_ModuleInfo_32 = STATE_VARIABLE_ModuleInfo_41;
    goto tscc_end;
  }
tscc_end:;
