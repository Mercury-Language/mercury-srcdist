...
top_of_proc_1:;
  {
    ...
    else
    {
      ...
      {
        MR_Word MaybeMergedInst_24 = ((MR_Word) ((MR_hl_field(1, MaybeMaybeMergedInst_22, (MR_Integer) 0))));
        ...
        if ((MaybeMergedInst_24 == (MR_Word) ((MR_Unsigned) 0U)))
          ...
          InstAB0_25 = ((MR_Word) ((MR_hl_field(1, MaybeMergedInst_24, (MR_Integer) 0))));
        STATE_VARIABLE_ModuleInfo_32 = STATE_VARIABLE_ModuleInfo_0_31;
        succeeded = MR_TRUE;
      }
      if (succeeded)
      {
        ...
        if (succeeded)
          {
            InstAB_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, InstAB_10, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(3, InstAB_10, 1) = ((MR_Box) (MergeInstName_21));
          }
        else
...
top_of_proc_2:;
  {
    ...
    MR_bool succeeded = ((((MR_tag((MR_Word) InstA_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, InstA_8, (MR_Integer) 0)))) == (MR_Integer) 1)));
    MR_Word InstVarsA_12;
    MR_Word SubInstA_13;

    if (succeeded)
    {
      InstVarsA_12 = ((MR_Word) ((MR_hl_field(3, InstA_8, (MR_Integer) 1))));
      SubInstA_13 = ((MR_Word) ((MR_hl_field(3, InstA_8, (MR_Integer) 2))));
      {
        MR_Word InstVarsB_14;
        MR_Word SubInstB_15;

        succeeded = ((((MR_tag((MR_Word) InstB_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, InstB_9, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (succeeded)
        {
          InstVarsB_14 = ((MR_Word) ((MR_hl_field(3, InstB_9, (MR_Integer) 1))));
          SubInstB_15 = ((MR_Word) ((MR_hl_field(3, InstB_9, (MR_Integer) 2))));
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
                {
                  InstAB_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, InstAB_10, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(3, InstAB_10, 1) = ((MR_Box) (InstVars_17));
                  MR_hl_field(3, InstAB_10, 2) = ((MR_Box) (InstAB0_16));
                }
              else
    ...
    else
    {
      ...
      if (succeeded)
      {
        SubInstB_25 = ((MR_Word) ((MR_hl_field(3, InstB_9, (MR_Integer) 2))));
        {
          MR_Word next_value_of_tscc_proc_1_input_1_Type_7 = Type_7;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_35 = (MR_Word) (MR_mkword(1, (MR_Word) (TypeCtor_18)));
        {
          InstResultsB_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, InstResultsB_21, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 2)) | (MR_Unsigned) ((MR_Integer) 0)));
          MR_hl_field(1, InstResultsB_21, 1) = ((MR_Box) (Var_29));
          MR_hl_field(1, InstResultsB_21, 2) = ((MR_Box) (Var_31));
          MR_hl_field(1, InstResultsB_21, 3) = ((MR_Box) (Var_33));
          MR_hl_field(1, InstResultsB_21, 4) = ((MR_Box) (Var_35));
        }
        {
          InstA_22 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, InstA_22, 0) = (MR_Box) ((MR_Unsigned) (UniqA_10));
          MR_hl_field(2, InstA_22, 1) = ((MR_Box) (InstResultsA_11));
          MR_hl_field(2, InstA_22, 2) = ((MR_Box) (BoundInstsA_12));
        }
        {
          InstB_23 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, InstB_23, 0) = (MR_Box) ((MR_Unsigned) (UniqB_13));
          MR_hl_field(2, InstB_23, 1) = ((MR_Box) (InstResultsB_21));
          MR_hl_field(2, InstB_23, 2) = ((MR_Box) (BoundInstsB_20));
        }
      ...
      else
      {
        MR_Word Uniq_38;
        MR_Word Uniq0_47;
        MR_Word Expansions0_48;
        MR_Word _Expansions_49;
        ...
        if (succeeded)
          ...
          Uniq0_47 = UniqB_13;
        mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0), &Expansions0_48);
        check_hlds__inst_merge__merge_bound_inst_list_uniq_6_p_0(STATE_VARIABLE_ModuleInfo_0_24, BoundInstsA_12, Uniq0_47, Expansions0_48, &_Expansions_49, &Uniq_38);
        {
          MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_27)
{
  ...
  switch (MR_tag((MR_Word) InstA_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word UniqA_14 = ((MR_Unsigned) ((MR_hl_field(1, InstA_8, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Word HOInstInfoA_15 = ((MR_Word) ((MR_hl_field(1, InstA_8, (MR_Integer) 1))));
        ...
        switch (MR_tag((MR_Word) InstB_9)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word UniqB_16 = ((MR_Unsigned) ((MR_hl_field(1, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);
              MR_Word HOInstInfoB_17 = ((MR_Word) ((MR_hl_field(1, InstB_9, (MR_Integer) 1))));
              MR_Word Uniq_38;
              MR_Word HOInstInfo_39;
              MR_Word PredA_124;
              MR_Word PredB_125;

              succeeded = (HOInstInfoA_15 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                PredA_124 = (MR_Word) (MR_body((MR_Word) (HOInstInfoA_15), (MR_Integer) 1));
                succeeded = (HOInstInfoB_17 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                  PredB_125 = (MR_Word) (MR_body((MR_Word) (HOInstInfoB_17), (MR_Integer) 1));
              }
              if (succeeded)
              {
                succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_124, PredB_125);
                if (succeeded)
                {
                  HOInstInfo_39 = HOInstInfoB_17;
                  succeeded = MR_TRUE;
                }
                else
                {
                  succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_125, PredA_124);
                  if (succeeded)
                  {
                    HOInstInfo_39 = HOInstInfoA_15;
                    succeeded = MR_TRUE;
                  }
                  else
                  {
                    succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_124);
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_125);
                      if (succeeded)
                      {
                        HOInstInfo_39 = (MR_Word) ((MR_Unsigned) 0U);
                        succeeded = MR_TRUE;
                      }
                    }
                  }
              ...
              {
                succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoA_15);
                if (succeeded)
                {
                  succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoB_17);
                  if (succeeded)
                  {
                    HOInstInfo_39 = (MR_Word) ((MR_Unsigned) 0U);
                    succeeded = MR_TRUE;
              ...
              {
                *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_14, UniqB_16);
                if (succeeded)
                  Uniq_38 = UniqB_16;
                else
                  Uniq_38 = UniqA_14;
                {
                  ...
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *InstAB_10 = base;
                  MR_hl_field(1, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_38));
                  MR_hl_field(1, base, 1) = ((MR_Box) (HOInstInfo_39));
                }
                succeeded = MR_TRUE;
              }
            }
          ...
          case (MR_Integer) 2:
            {
              MR_Word InstResultsB_18 = ((MR_Word) ((MR_hl_field(2, InstB_9, (MR_Integer) 1))));
              MR_Word BoundInstsB_19 = ((MR_Word) ((MR_hl_field(2, InstB_9, (MR_Integer) 2))));
              MR_Word UniqB_44 = ((MR_Unsigned) ((MR_hl_field(2, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);

              succeeded = check_hlds__inst_merge__inst_merge_bound_ground_8_p_0(Type_7, UniqB_44, InstResultsB_18, BoundInstsB_19, UniqA_14, InstAB_10, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27);
              if (succeeded)
              {
                succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_2_p_0(*STATE_VARIABLE_ModuleInfo_27, InstB_9);
                succeeded = !(succeeded);
              }
            }
            break;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word UniqB_42 = ((MR_Unsigned) ((MR_hl_field(3, InstB_9, (MR_Integer) 1))) & (MR_Integer) 7);
                  MR_Word HOInstInfoB_43 = ((MR_Word) ((MR_hl_field(3, InstB_9, (MR_Integer) 2))));
                  MR_Word PredA_122;
                  MR_Word PredB_123;
                  ...
                  if (succeeded)
                  {
                    PredA_122 = (MR_Word) (MR_body((MR_Word) (HOInstInfoA_15), (MR_Integer) 1));
                    succeeded = (HOInstInfoB_43 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                      PredB_123 = (MR_Word) (MR_body((MR_Word) (HOInstInfoB_43), (MR_Integer) 1));
                  }
                  if (succeeded)
                  {
                    succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_122, PredB_123);
                    if (succeeded)
                    {
                      HOInstInfo_41 = HOInstInfoB_43;
                      succeeded = MR_TRUE;
                    }
                    else
                    {
                      succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_123, PredA_122);
                      if (succeeded)
                      {
                        HOInstInfo_41 = HOInstInfoA_15;
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                        succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_122);
                        if (succeeded)
                        {
                          succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_123);
                          if (succeeded)
                          {
                            HOInstInfo_41 = (MR_Word) ((MR_Unsigned) 0U);
                            succeeded = MR_TRUE;
                          }
                        }
                      }
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoB_43);
                      if (succeeded)
                      {
                        HOInstInfo_41 = (MR_Word) ((MR_Unsigned) 0U);
                        succeeded = MR_TRUE;
                  ...
                  {
                    *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                    succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_14, UniqB_42);
                    if (succeeded)
                      Uniq_40 = UniqB_42;
                    else
                      Uniq_40 = UniqA_14;
                    {
                      ...
                      *InstAB_10 = base;
                      MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                      MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_40));
                      MR_hl_field(3, base, 2) = ((MR_Box) (HOInstInfo_41));
                    }
                    succeeded = MR_TRUE;
                  }
                }
    ...
    case (MR_Integer) 2:
      {
        MR_Word InstResultsA_20 = ((MR_Word) ((MR_hl_field(2, InstA_8, (MR_Integer) 1))));
        MR_Word BoundInstsA_21 = ((MR_Word) ((MR_hl_field(2, InstA_8, (MR_Integer) 2))));
        MR_Word UniqA_85 = ((MR_Unsigned) ((MR_hl_field(2, InstA_8, (MR_Integer) 0))) & (MR_Integer) 7);
        ...
        switch (MR_tag((MR_Word) InstB_9)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word UniqB_75 = ((MR_Unsigned) ((MR_hl_field(1, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);

              succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, InstResultsA_20, BoundInstsA_21);
              if (succeeded)
              {
                MR_Word Uniq_98;

                check_hlds__inst_merge__merge_uniq_bound_5_p_0(STATE_VARIABLE_ModuleInfo_0_26, UniqB_75, UniqA_85, BoundInstsA_21, &Uniq_98);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *InstAB_10 = base;
                  MR_hl_field(1, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_98));
                  MR_hl_field(1, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                succeeded = MR_TRUE;
              ...
              {
                MR_Word Constructors_99;

                succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, InstResultsA_20, BoundInstsA_21);
                if (succeeded)
                {
                  succeeded = check_hlds__type_util__type_constructors_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, Type_7, &Constructors_99);
                  if (succeeded)
                  {
                    MR_Word TypeCtor_100;
                    MR_Word BoundInstsB0_101;
                    MR_Word BoundInstsB_102;
                    MR_Word InstResultsB_103;
                    MR_Word InstB_105;
                    MR_Word Var_109;
                    MR_Word Var_110;
                    MR_Word Var_111;
                    ...
                    parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_7, &TypeCtor_100);
                    check_hlds__mode_util__constructors_to_bound_insts_5_p_0(STATE_VARIABLE_ModuleInfo_0_26, UniqB_75, TypeCtor_100, Constructors_99, &BoundInstsB0_101);
                    mercury__list__sort_and_remove_dups_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), BoundInstsB0_101, &BoundInstsB_102);
                    Var_110 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0));
                    {
                      Var_109 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_109, 0) = ((MR_Box) (Var_110));
                    }
                    Var_112 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__inst_merge_scalar_common_1[0]));
                    {
                      Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_111, 0) = ((MR_Box) (Var_112));
                    }
                    Var_114 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0));
                    {
                      Var_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Var_113, 0) = ((MR_Box) (Var_114));
                    }
                    Var_115 = (MR_Word) (MR_mkword(1, (MR_Word) (TypeCtor_100)));
                    {
                      InstResultsB_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, InstResultsB_103, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 2)) | (MR_Unsigned) ((MR_Integer) 0)));
                      MR_hl_field(1, InstResultsB_103, 1) = ((MR_Box) (Var_109));
                      MR_hl_field(1, InstResultsB_103, 2) = ((MR_Box) (Var_111));
                      MR_hl_field(1, InstResultsB_103, 3) = ((MR_Box) (Var_113));
                      MR_hl_field(1, InstResultsB_103, 4) = ((MR_Box) (Var_115));
                    }
                    {
                      InstB_105 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(2, InstB_105, 0) = (MR_Box) ((MR_Unsigned) (UniqB_75));
                      MR_hl_field(2, InstB_105, 1) = ((MR_Box) (InstResultsB_103));
                      MR_hl_field(2, InstB_105, 2) = ((MR_Box) (BoundInstsB_102));
                    }
                    succeeded = check_hlds__inst_merge__inst_merge_4_6_p_0(Type_7, InstA_8, InstB_105, InstAB_10, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27);
                  }
                  else
                  {
                    MR_Word Uniq_117;

                    check_hlds__inst_merge__merge_uniq_bound_5_p_0(STATE_VARIABLE_ModuleInfo_0_26, UniqB_75, UniqA_85, BoundInstsA_21, &Uniq_117);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      *InstAB_10 = base;
                      MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                      MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_117));
                      MR_hl_field(3, base, 2) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                    succeeded = MR_TRUE;
              ...
              if (succeeded)
              {
                succeeded = check_hlds__inst_match__inst_contains_nondefault_func_mode_2_p_0(*STATE_VARIABLE_ModuleInfo_27, InstA_8);
                succeeded = !(succeeded);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word BoundInstsAB_25;
              MR_Word Var_37;
              MR_Word Uniq_78;
              MR_Word UniqB_79 = ((MR_Unsigned) ((MR_hl_field(2, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);
              MR_Word BoundInstsB_80 = ((MR_Word) ((MR_hl_field(2, InstB_9, (MR_Integer) 2))));

              succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_85, UniqB_79);
              if (succeeded)
                Uniq_78 = UniqB_79;
              else
                Uniq_78 = UniqA_85;
              succeeded = check_hlds__inst_merge__bound_inst_list_merge_6_p_0(Type_7, BoundInstsA_21, BoundInstsB_80, &BoundInstsAB_25, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27);
              if (succeeded)
              {
                Var_37 = (MR_Word) ((MR_Unsigned) 0U);
                {
                  ...
                  *InstAB_10 = base;
                  MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_78));
                  MR_hl_field(2, base, 1) = ((MR_Box) (Var_37));
                  MR_hl_field(2, base, 2) = ((MR_Box) (BoundInstsAB_25));
                }
                succeeded = MR_TRUE;
              }
            }
              ...
              case (MR_Integer) 2:
                {
                  MR_Word Var_35;
                  MR_Word Uniq_76;
                  MR_Word UniqB_77 = ((MR_Unsigned) ((MR_hl_field(3, InstB_9, (MR_Integer) 1))) & (MR_Integer) 7);
                  MR_Word Uniq0_94;
                  MR_Word Expansions0_95;
                  MR_Word _Expansions_96;

                  succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqB_77, UniqA_85);
                  if (succeeded)
                    Uniq0_94 = UniqA_85;
                  else
                    Uniq0_94 = UniqB_77;
                  mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0), &Expansions0_95);
                  check_hlds__inst_merge__merge_bound_inst_list_uniq_6_p_0(STATE_VARIABLE_ModuleInfo_0_26, BoundInstsA_21, Uniq0_94, Expansions0_95, &_Expansions_96, &Uniq_76);
                  switch (Uniq_76) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    ...
                    *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                    {
                      ...
                      *InstAB_10 = base;
                      MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                      MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_76));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, InstA_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word UniqA_69 = ((MR_Unsigned) ((MR_hl_field(3, InstA_8, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word HOInstInfoA_70 = ((MR_Word) ((MR_hl_field(3, InstA_8, (MR_Integer) 2))));
            ...
            switch (MR_tag((MR_Word) InstB_9)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Uniq_49;
                  MR_Word HOInstInfo_50;
                  MR_Word UniqB_51 = ((MR_Unsigned) ((MR_hl_field(1, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);
                  MR_Word HOInstInfoB_52 = ((MR_Word) ((MR_hl_field(1, InstB_9, (MR_Integer) 1))));
                  MR_Word PredA_92;
                  MR_Word PredB_93;

                  succeeded = (HOInstInfoA_70 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    PredA_92 = (MR_Word) (MR_body((MR_Word) (HOInstInfoA_70), (MR_Integer) 1));
                    succeeded = (HOInstInfoB_52 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                      PredB_93 = (MR_Word) (MR_body((MR_Word) (HOInstInfoB_52), (MR_Integer) 1));
                  }
                  if (succeeded)
                  {
                    succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_92, PredB_93);
                    if (succeeded)
                    {
                      HOInstInfo_50 = HOInstInfoB_52;
                      succeeded = MR_TRUE;
                    }
                    else
                    {
                      succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_93, PredA_92);
                      if (succeeded)
                      {
                        HOInstInfo_50 = HOInstInfoA_70;
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                        succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_92);
                        if (succeeded)
                        {
                          succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_93);
                          if (succeeded)
                          {
                            HOInstInfo_50 = (MR_Word) ((MR_Unsigned) 0U);
                            succeeded = MR_TRUE;
                          }
                        }
                      }
                  ...
                  {
                    succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoA_70);
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoB_52);
                      if (succeeded)
                      {
                        HOInstInfo_50 = (MR_Word) ((MR_Unsigned) 0U);
                        succeeded = MR_TRUE;
                  ...
                  {
                    *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                    succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_69, UniqB_51);
                    if (succeeded)
                      Uniq_49 = UniqB_51;
                    else
                      Uniq_49 = UniqA_69;
                    {
                      ...
                      *InstAB_10 = base;
                      ...
                      MR_hl_field(3, base, 2) = ((MR_Box) (HOInstInfo_50));
                    }
                    succeeded = MR_TRUE;
                  }
                }
              ...
              case (MR_Integer) 2:
                {
                  MR_Word Var_33;
                  MR_Word Uniq_57;
                  MR_Word UniqB_58 = ((MR_Unsigned) ((MR_hl_field(2, InstB_9, (MR_Integer) 0))) & (MR_Integer) 7);
                  ...
                  MR_Word Uniq0_88;
                  MR_Word Expansions0_89;
                  MR_Word _Expansions_90;

                  succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_69, UniqB_58);
                  if (succeeded)
                    Uniq0_88 = UniqB_58;
                  else
                    Uniq0_88 = UniqA_69;
                  mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0), &Expansions0_89);
                  check_hlds__inst_merge__merge_bound_inst_list_uniq_6_p_0(STATE_VARIABLE_ModuleInfo_0_26, BoundInstsB_60, Uniq0_88, Expansions0_89, &_Expansions_90, &Uniq_57);
                  switch (Uniq_57) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                  ...
                  if (succeeded)
                    ...
                    succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, InstResultsB_59, BoundInstsB_60);
                  if (succeeded)
                  {
                    ...
                    *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                    {
                      ...
                      *InstAB_10 = base;
                      ...
                      MR_hl_field(3, base, 2) = ((MR_Box) (Var_33));
                    }
                    succeeded = MR_TRUE;
                  }
                }
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      MR_Word UniqB_55 = ((MR_Unsigned) ((MR_hl_field(3, InstB_9, (MR_Integer) 1))) & (MR_Integer) 7);
                      MR_Word HOInstInfoB_56 = ((MR_Word) ((MR_hl_field(3, InstB_9, (MR_Integer) 2))));
                      MR_Word PredA_86;
                      MR_Word PredB_87;
                      ...
                      if (succeeded)
                      {
                        PredA_86 = (MR_Word) (MR_body((MR_Word) (HOInstInfoA_70), (MR_Integer) 1));
                        succeeded = (HOInstInfoB_56 != (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                          PredB_87 = (MR_Word) (MR_body((MR_Word) (HOInstInfoB_56), (MR_Integer) 1));
                      }
                      if (succeeded)
                      {
                        succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_86, PredB_87);
                        if (succeeded)
                        {
                          HOInstInfo_54 = HOInstInfoB_56;
                          succeeded = MR_TRUE;
                        }
                        else
                        {
                          succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_87, PredA_86);
                          if (succeeded)
                          {
                            HOInstInfo_54 = HOInstInfoA_70;
                            succeeded = MR_TRUE;
                          }
                          else
                          {
                            succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredA_86);
                            if (succeeded)
                            {
                              succeeded = check_hlds__inst_match__pred_inst_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, PredB_87);
                              if (succeeded)
                              {
                                HOInstInfo_54 = (MR_Word) ((MR_Unsigned) 0U);
                                succeeded = MR_TRUE;
                              }
                            }
                          }
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          succeeded = check_hlds__inst_match__ho_inst_info_matches_ground_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, HOInstInfoB_56);
                          if (succeeded)
                          {
                            HOInstInfo_54 = (MR_Word) ((MR_Unsigned) 0U);
                            succeeded = MR_TRUE;
                      ...
                      {
                        *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_0_26;
                        succeeded = check_hlds__inst_match__unique_matches_initial_2_p_0(UniqA_69, UniqB_55);
                        if (succeeded)
                          Uniq_53 = UniqB_55;
                        else
                          Uniq_53 = UniqA_69;
                        {
                          ...
                          *InstAB_10 = base;
                          MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                          MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_53));
                          MR_hl_field(3, base, 2) = ((MR_Box) (HOInstInfo_54));
                        }
                        succeeded = MR_TRUE;
                      }
                    }
