...
top_of_proc_1:;
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, InstA_8, &ExpandedInstA_45);
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, InstB_9, &ExpandedInstB_46);
      succeeded = (ExpandedInstB_46 == (MR_Word) ((MR_Unsigned) 4U));
      if (succeeded)
      {
        InstAB_10 = ExpandedInstA_45;
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Word next_value_of_tscc_proc_2_input_2_InstA_8 = ExpandedInstA_45;
          MR_Word next_value_of_tscc_proc_2_input_3_InstB_9 = ExpandedInstB_46;
    ...
    else
    {
      ...
      if ((MaybeMaybeMergedInst_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_34_34, InstA_8, &ExpandedInstA_55);
        check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_34_34, InstB_9, &ExpandedInstB_56);
        succeeded = (ExpandedInstB_56 == (MR_Word) ((MR_Unsigned) 4U));
        if (succeeded)
        {
          InstAB0_25 = ExpandedInstA_55;
        ...
        else
        {
          ...
          if (succeeded)
          {
            InstAB0_25 = ExpandedInstB_56;
            STATE_VARIABLE_ModuleInfo_35_35 = STATE_VARIABLE_ModuleInfo_34_34;
            succeeded = MR_TRUE;
          }
          else
            succeeded = check_hlds__inst_merge__inst_merge_3_6_p_0(Type_7, ExpandedInstA_55, ExpandedInstB_56, &InstAB0_25, STATE_VARIABLE_ModuleInfo_34_34, &STATE_VARIABLE_ModuleInfo_35_35);
        }
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  if (succeeded)
  {
    MR_Word Uniq_16;
    MR_Word Uniq0_50;
    MR_Word Expansions0_51;
    MR_Word _Expansions_52;
    ...
    if (succeeded)
      ...
      Uniq0_50 = UniqB_13;
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0), &Expansions0_51);
    check_hlds__inst_merge__merge_bound_inst_list_uniq_6_p_0(STATE_VARIABLE_ModuleInfo_0_24, BoundInstsA_12, Uniq0_50, Expansions0_51, &_Expansions_52, &Uniq_16);
    {
      MR_Word base;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        MR_Word Uniq_38;
        MR_Word Uniq0_62;
        MR_Word Expansions0_63;
        MR_Word _Expansions_64;
        ...
        if (succeeded)
          ...
          Uniq0_62 = UniqB_13;
        mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_name_0), &Expansions0_63);
        check_hlds__inst_merge__merge_bound_inst_list_uniq_6_p_0(STATE_VARIABLE_ModuleInfo_0_24, BoundInstsA_12, Uniq0_62, Expansions0_63, &_Expansions_64, &Uniq_38);
        {
          MR_Word base;
