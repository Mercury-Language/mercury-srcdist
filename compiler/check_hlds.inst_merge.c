  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  else
  {
    ...
    if ((MaybeOldMaybeMergedInst_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstA_8, &ExpandedInstA_67);
      hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstB_9, &ExpandedInstB_68);
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_4_p_0(STATE_VARIABLE_ModuleInfo_0_31, Type_7, InstResultsA_25, BoundFunctorsA_26);
              if (succeeded)
              {
                MR_Word Uniq_110;
              ...
              else
              {
                ...
                succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, InstResultsA_25, BoundFunctorsA_26);
                if (succeeded)
                {
                  succeeded = hlds__type_util__type_constructors_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, Type_7, &Constructors_111);
                  if (succeeded)
                  {
                    ...
                    hlds__mode_util__constructors_to_bound_functors_5_p_0(STATE_VARIABLE_ModuleInfo_0_31, UniqB_84, TypeCtor_112, Constructors_111, &BoundFunctorsB0_113);
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
                ...
                succeeded = hlds__inst_test__inst_results_bound_functor_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, InstResultsB_62, BoundFunctorsB_63);
              if (succeeded)
              {
