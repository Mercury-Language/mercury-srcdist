  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_27)
{
  ...
  {
    MR_Word Var_37 = ((MR_Word) ((MR_hl_field(1, BoundInstsA_8, (MR_Integer) 1))));
    MR_Word Var_38 = ((MR_Word) ((MR_hl_field(1, BoundInstsA_8, (MR_Integer) 0))));
    ...
    else
    {
      ...
      MR_Word ArgInstsB_21 = ((MR_Word) ((MR_hl_field(0, BoundInstB_16, (MR_Integer) 1))));
      ...
      if (succeeded)
      {
        ...
        check_hlds__inst_util__get_cons_id_arg_types_for_bound_inst_4_p_0(STATE_VARIABLE_ModuleInfo_0_26, Type_7, Var_38, &Types_22);
        ...
        {
          {
            ...
            MR_hl_field(0, BoundInst_24, 1) = ((MR_Box) (ArgInstsAB_23));
          }
          succeeded = check_hlds__inst_merge__bound_inst_list_merge_6_p_0(Type_7, Var_37, BoundInstsTailB_17, &BoundInstsABTail_25, STATE_VARIABLE_ModuleInfo_28_28, STATE_VARIABLE_ModuleInfo_27);
          if (succeeded)
          {
            {
              MR_Word base;
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Word BoundInstsABTail_33;

          succeeded = check_hlds__inst_merge__bound_inst_list_merge_6_p_0(Type_7, Var_37, BoundInstsB_9, &BoundInstsABTail_33, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27);
          if (succeeded)
          {
            {
              MR_Word base;
              ...
              *BoundInstsAB_10 = base;
              ...
              MR_hl_field(1, base, 1) = ((MR_Box) (BoundInstsABTail_33));
            }
            succeeded = MR_TRUE;
          }
        }
        else
        {
          ...
          succeeded = check_hlds__inst_merge__bound_inst_list_merge_6_p_0(Type_7, BoundInstsA_8, BoundInstsTailB_17, &BoundInstsABTail_34, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27);
          if (succeeded)
          {
            {
              MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_4_p_0(STATE_VARIABLE_ModuleInfo_0_24, Type_9, InstResultsA_11, BoundInstsA_12);
  if (succeeded)
  {
    MR_Word Uniq_16;
    MR_Word Uniq0_43;
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_4_p_0(STATE_VARIABLE_ModuleInfo_0_31, Type_7, InstResultsA_25, BoundInstsA_26);
              if (succeeded)
              {
                MR_Word Uniq_114;
