  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  else
  {
    ...
    if (succeeded)
      ...
      {
        MR_Word InstanceNum_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proof_20, (MR_Integer) 0))));
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        {
          MR_Word InstanceNum_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proof_40, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  else
  {
    ...
    check_hlds__polymorphism_info__poly_info_get_var_db_2_p_0(STATE_VARIABLE_Info_0_27, &VarDb0_62);
    ...
    parse_tree__var_table__add_entry_to_var_db_4_p_0(VarEntry_68, Var_9, VarDb0_62, &VarDb_69);
    hlds__hlds_rtti__rtti_det_insert_typeclass_info_var_4_p_0(Constraint_7, *Var_9, RttiVarMaps0_63, &RttiVarMaps_70);
    check_hlds__polymorphism_info__poly_info_set_var_db_rtti_4_p_0(VarDb_69, RttiVarMaps_70, STATE_VARIABLE_Info_0_27, STATE_VARIABLE_Info_28);
    {
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  else
  {
    ...
    check_hlds__polymorphism_info__poly_info_get_var_db_2_p_0(STATE_VARIABLE_Info_0_29, &VarDb0_67);
    ...
    parse_tree__var_table__add_entry_to_var_db_4_p_0(VarEntry_73, Var_9, VarDb0_67, &VarDb_74);
    hlds__hlds_rtti__rtti_det_insert_typeclass_info_var_4_p_0(Constraint_7, *Var_9, RttiVarMaps0_68, &RttiVarMaps_75);
    check_hlds__polymorphism_info__poly_info_set_var_db_rtti_4_p_0(VarDb_74, RttiVarMaps_75, STATE_VARIABLE_Info_0_29, &STATE_VARIABLE_Info_35_35);
  ...
  MR_Word * STATE_VARIABLE_Info_14)
{
  ...
  else
  {
    ...
    MR_String ClassNameString_29;
    MR_String VarName_30;
    MR_Word VarEntry_31;
    MR_Word VarDb_32;
    MR_Word RttiVarMaps_33;

    check_hlds__polymorphism_info__poly_info_get_var_db_2_p_0(STATE_VARIABLE_Info_0_13, &VarDb0_25);
    check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_13, &RttiVarMaps0_26);
    ClassName_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 0))));
    ClassNameString_29 = mdbcomp__sym_name__unqualify_name_1_f_0(ClassName_27);
    VarName_30 = mercury__string__f_43_43_2_f_0((MR_String) "TypeClassInfo_for_", ClassNameString_29);
    _TypeClassInfoVarType_12 = parse_tree__builtin_lib_types__typeclass_info_type_0_f_0();
    {
      VarEntry_31 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), VarEntry_31, 0) = ((MR_Box) (VarName_30));
      MR_hl_field(MR_mktag(0), VarEntry_31, 1) = ((MR_Box) (_TypeClassInfoVarType_12));
      MR_hl_field(MR_mktag(0), VarEntry_31, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    }
    parse_tree__var_table__add_entry_to_var_db_4_p_0(VarEntry_31, TypeClassInfoVar_8, VarDb0_25, &VarDb_32);
    hlds__hlds_rtti__rtti_det_insert_typeclass_info_var_4_p_0(Constraint_7, *TypeClassInfoVar_8, RttiVarMaps0_26, &RttiVarMaps_33);
    check_hlds__polymorphism_info__poly_info_set_var_db_rtti_4_p_0(VarDb_32, RttiVarMaps_33, STATE_VARIABLE_Info_0_13, &STATE_VARIABLE_Info_16_16);
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ClassTypes_45;
          MR_Integer ClassArity_46;
          MR_Word ClassId_47;
          MR_Word ClassTable_48;
          MR_Word ClassDefn_49;
          MR_Word SuperClasses_50;
          MR_Integer NumSuperClasses_51;
          MR_Word RttiVarMaps0_52;
          MR_Word RttiVarMaps_53;
          MR_Integer Var_54;
          MR_Box conv0_ClassDefn_49;

          check_hlds__polymorphism_info__poly_info_get_module_info_2_p_0(STATE_VARIABLE_Info_16_16, &ModuleInfo_43);
          ClassName_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 0))));
          ClassTypes_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ClassTypes_45, &ClassArity_46);
          {
            ClassId_47 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ClassId_47, 0) = ((MR_Box) (ClassName_44));
            MR_hl_field(MR_mktag(0), ClassId_47, 1) = ((MR_Box) (ClassArity_46));
          }
          hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_43, &ClassTable_48);
          mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ClassTable_48, ((MR_Box) (ClassId_47)), &conv0_ClassDefn_49);
          ClassDefn_49 = ((MR_Word) (conv0_ClassDefn_49));
          SuperClasses_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_49, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), SuperClasses_50, &NumSuperClasses_51);
          check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_16_16, &RttiVarMaps0_52);
          Var_54 = (MR_Integer) ((MR_Unsigned) NumSuperClasses_51 + (MR_Unsigned) 1);
          check_hlds__polymorphism_type_class_info__record_tci_slots_for_unseen_or_in_type_info_tvars_5_p_0(*TypeClassInfoVar_8, ClassTypes_45, Var_54, RttiVarMaps0_52, &RttiVarMaps_53);
          check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_53, STATE_VARIABLE_Info_16_16, STATE_VARIABLE_Info_14);
        }
        break;
    }
  }
