      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ClassTypes_24;
          MR_Integer ClassArity_25;
          MR_Word ClassId_26;
          MR_Word ClassTable_27;
          MR_Word ClassDefn_28;
          MR_Word SuperClasses_29;
          MR_Integer NumSuperClasses_30;
          MR_Word RttiVarMaps0_31;
          MR_Word RttiVarMaps_32;
          MR_Integer Var_33;
          MR_Box conv0_ClassDefn_28;

          check_hlds__polymorphism_info__poly_info_get_module_info_2_p_0(STATE_VARIABLE_Info_16_16, &ModuleInfo_22);
          ClassName_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 0))));
          ClassTypes_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ClassTypes_24, &ClassArity_25);
          {
            ClassId_26 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ClassId_26, 0) = ((MR_Box) (ClassName_23));
            MR_hl_field(MR_mktag(0), ClassId_26, 1) = ((MR_Box) (ClassArity_25));
          }
          hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_22, &ClassTable_27);
          mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ClassTable_27, ((MR_Box) (ClassId_26)), &conv0_ClassDefn_28);
          ClassDefn_28 = ((MR_Word) (conv0_ClassDefn_28));
          SuperClasses_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_28, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), SuperClasses_29, &NumSuperClasses_30);
          check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_16_16, &RttiVarMaps0_31);
          Var_33 = (MR_Integer) ((MR_Unsigned) NumSuperClasses_30 + (MR_Unsigned) 1);
          check_hlds__polymorphism_type_class_info__record_tci_slots_for_unseen_or_in_type_info_tvars_5_p_0(*TypeClassInfoVar_8, ClassTypes_24, Var_33, RttiVarMaps0_31, &RttiVarMaps_32);
          check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_32, STATE_VARIABLE_Info_16_16, STATE_VARIABLE_Info_14);
        }
        break;
    }
  }
