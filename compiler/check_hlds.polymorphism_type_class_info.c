  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  hlds__type_util__apply_renaming_to_constraint_proof_map_3_p_0(Renaming_43, InstanceProofMap_35, &RenamedInstanceProofMap_49);
  hlds__type_util__apply_rec_subst_to_constraint_proof_map_3_p_0(InstanceSubst_45, RenamedInstanceProofMap_49, &ActualInstanceProofMap_50);
