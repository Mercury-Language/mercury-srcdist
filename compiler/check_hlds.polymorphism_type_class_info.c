  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  parse_tree__prog_type__type_vars_in_types_2_p_0(InstanceTypes_32, &InstanceTvars_40);
  parse_tree__prog_type__get_unconstrained_tvars_3_p_0(InstanceTvars_40, InstanceConstraints_33, &UnconstrainedTvars_41);
