          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_235_235 = (MR_Word) (&check_hlds__polymorphism_type_class_info_scalar_common_1[3]);
                mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), TypeInfo_235_235, InstanceTable_57, ((MR_Box) (SubClassId_27)), &conv1_SubInstanceDefns_58);
                SubInstanceDefns_58 = ((MR_Word) (conv1_SubInstanceDefns_58));
                TypeCtorInfo_236_236 = (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_instance_defn_0);
                succeeded = mercury__list__index1_3_p_0(TypeCtorInfo_236_236, SubInstanceDefns_58, SubInstanceNum_55, &conv2_SubInstanceDefn_59);
                if (succeeded)
                {
                ...
                if (succeeded)
                {
                  ...
                  TypeCtorInfo_237_237 = (MR_Word) (&hlds__const_struct__hlds__const_struct__type_ctor_info_const_struct_arg_0);
                  mercury__list__det_index1_3_p_0(TypeCtorInfo_237_237, OtherArgs_51, Index_61, &conv3_SelectedArg_62);
