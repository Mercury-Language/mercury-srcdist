  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__polymorphism_type_class_info__IntroducedFrom__pred__do_make_typeclass_info_from_instance__589__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  hlds__type_util__apply_variable_renaming_to_constraint_proof_map_3_p_0(Renaming_43, InstanceProofMap_35, &RenamedInstanceProofMap_49);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__polymorphism_type_class_info__IntroducedFrom__pred__record_tci_slots_for_unseen_or_in_type_info_tvars__929__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_28);
