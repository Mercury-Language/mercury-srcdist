      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ClassTypes_19;
          MR_Integer ClassArity_20;
          MR_Word ClassId_21;
          MR_Word ClassTable_22;
          MR_Word ClassDefn_23;
          MR_Word SuperClasses_24;
          MR_Integer NumSuperClasses_25;
          MR_Word RttiVarMaps0_26;
          MR_Word RttiVarMaps_27;
          MR_Integer Var_28;
          MR_Box conv0_ClassDefn_23;

          check_hlds__polymorphism_info__poly_info_get_module_info_2_p_0(STATE_VARIABLE_Info_16_16, &ModuleInfo_17);
          ClassName_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 0))));
          ClassTypes_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_7, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ClassTypes_19, &ClassArity_20);
          {
            ClassId_21 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ClassId_21, 0) = ((MR_Box) (ClassName_18));
            MR_hl_field(MR_mktag(0), ClassId_21, 1) = ((MR_Box) (ClassArity_20));
          }
          hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_17, &ClassTable_22);
          mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ClassTable_22, ((MR_Box) (ClassId_21)), &conv0_ClassDefn_23);
          ClassDefn_23 = ((MR_Word) (conv0_ClassDefn_23));
          SuperClasses_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_23, (MR_Integer) 1))));
          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), SuperClasses_24, &NumSuperClasses_25);
          check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_16_16, &RttiVarMaps0_26);
          Var_28 = (MR_Integer) ((MR_Unsigned) NumSuperClasses_25 + (MR_Unsigned) 1);
          check_hlds__polymorphism_type_class_info__record_tci_slots_for_unseen_or_in_type_info_tvars_5_p_0(*TypeClassInfoVar_8, ClassTypes_19, Var_28, RttiVarMaps0_26, &RttiVarMaps_27);
          check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_27, STATE_VARIABLE_Info_16_16, STATE_VARIABLE_Info_14);
        }
        break;
    }
  }
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  *VarType_10 = parse_tree__builtin_lib_types__typeclass_info_type_0_f_0();
  parse_tree__vartypes__add_var_type_4_p_0(*Var_9, *VarType_10, VarTypes0_13, &VarTypes_21);
