  ...
  MR_Word * STATE_VARIABLE_Info_14)
{
  ...
  else
  {
    ...
    check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_13, &VarTable0_25);
    ...
    parse_tree__var_table__add_var_entry_4_p_0(VarEntry_31, TypeClassInfoVar_8, VarTable0_25, &VarTable_32);
    hlds__hlds_rtti__rtti_det_insert_typeclass_info_var_4_p_0(Constraint_7, *TypeClassInfoVar_8, RttiVarMaps0_26, &RttiVarMaps_33);
    check_hlds__polymorphism_info__poly_info_set_var_table_rtti_4_p_0(VarTable_32, RttiVarMaps_33, STATE_VARIABLE_Info_0_13, &STATE_VARIABLE_Info_16_16);
