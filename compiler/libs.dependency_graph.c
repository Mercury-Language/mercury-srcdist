...
{
  {
    ...
    else
    {
      ...
      mercury__digraph____Compare____digraph_1_0(TypeInfo_for_T_14, &Var_10, ArgX1_4, ArgY1_5);
      ...
      else
      {
        ...
        mercury__list____Compare____list_1_0(TypeInfo_20_20, &Var_11, (MR_Word) ArgX2_6, (MR_Word) ArgY2_7);
        ...
        else
        {
          ...
          mercury__list____Compare____list_1_0(TypeInfo_24_24, HeadVar__1_1, (MR_Word) ArgX3_8, (MR_Word) ArgY3_9);
        }
      }
    }
  }
...
{
  {
    ...
    MR_Word Var_6;
    MR_Word Var_7;
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 0)));
    MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_7;
    MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 0)));
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 0)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 0)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 1)));
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), DepInfo_3, (MR_Integer) 2)));
...
{
  {
    ...
    {
      DepInfo_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
