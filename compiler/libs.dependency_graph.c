    ...
    if (libs__dependency_graph__succeeded)
      *libs__dependency_graph__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Word libs__dependency_graph__V_6_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word libs__dependency_graph__V_7_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word libs__dependency_graph__V_8_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word libs__dependency_graph__V_9_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word libs__dependency_graph__V_10_10;

        {
          mercury__digraph____Compare____digraph_1_0(libs__dependency_graph__TypeInfo_for_T_14, &libs__dependency_graph__V_10_10, libs__dependency_graph__V_4_4, libs__dependency_graph__V_7_7);
        }
        libs__dependency_graph__succeeded = (libs__dependency_graph__V_10_10 == (MR_Integer) 0);
        libs__dependency_graph__succeeded = !(libs__dependency_graph__succeeded);
        if (libs__dependency_graph__succeeded)
          *libs__dependency_graph__HeadVar__1_1 = libs__dependency_graph__V_10_10;
        else
          {
            MR_Word libs__dependency_graph__V_11_11;
            ...
            {
              mercury__list____Compare____list_1_0(libs__dependency_graph__TypeInfo_20_20, &libs__dependency_graph__V_11_11, (MR_Word) libs__dependency_graph__V_5_5, (MR_Word) libs__dependency_graph__V_8_8);
            }
            libs__dependency_graph__succeeded = (libs__dependency_graph__V_11_11 == (MR_Integer) 0);
            libs__dependency_graph__succeeded = !(libs__dependency_graph__succeeded);
            if (libs__dependency_graph__succeeded)
              *libs__dependency_graph__HeadVar__1_1 = libs__dependency_graph__V_11_11;
            else
              {
                ...
                {
                  mercury__list____Compare____list_1_0(libs__dependency_graph__TypeInfo_24_24, libs__dependency_graph__HeadVar__1_1, (MR_Word) libs__dependency_graph__V_6_6, (MR_Word) libs__dependency_graph__V_9_9);
                }
              }
          }
      }
...
{
  {
    ...
    if (libs__dependency_graph__succeeded)
    ...
    else
      {
        ...
        MR_Word libs__dependency_graph__V_5_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word libs__dependency_graph__V_6_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word libs__dependency_graph__V_7_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word libs__dependency_graph__V_8_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__HeadVar__2_2, (MR_Integer) 2)));

        {
          libs__dependency_graph__succeeded = mercury__digraph____Unify____digraph_1_0(libs__dependency_graph__TypeInfo_for_T_11, libs__dependency_graph__V_3_3, libs__dependency_graph__V_6_6);
        }
        if (libs__dependency_graph__succeeded)
          {
            ...
            {
              libs__dependency_graph__succeeded = mercury__list____Unify____list_1_0(libs__dependency_graph__TypeInfo_17_17, (MR_Word) libs__dependency_graph__V_4_4, (MR_Word) libs__dependency_graph__V_7_7);
            }
            if (libs__dependency_graph__succeeded)
              {
                ...
                {
                  libs__dependency_graph__succeeded = mercury__list____Unify____list_1_0(libs__dependency_graph__TypeInfo_21_21, (MR_Word) libs__dependency_graph__V_5_5, (MR_Word) libs__dependency_graph__V_8_8);
                }
              }
          }
      }
...
{
  {
    ...
    {
      libs__dependency_graph__V_8_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_8_8, 0) = ((MR_Box) (&libs__dependency_graph_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_8_8, 1) = ((MR_Box) (libs__dependency_graph__add_scc_entries_to_scc_map_3_p_0_1));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_8_8, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_8_8, 3) = ((MR_Box) (libs__dependency_graph__TypeInfo_for_T_10));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_8_8, 4) = ((MR_Box) (libs__dependency_graph__SCC_4));
    }
    {
      libs__dependency_graph__TypeInfo_15_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      mercury__set__fold_4_p_0(libs__dependency_graph__TypeInfo_for_T_10, libs__dependency_graph__TypeInfo_17_17, libs__dependency_graph__V_8_8, libs__dependency_graph__SCC_4, ((MR_Box) (libs__dependency_graph__STATE_VARIABLE_Map_0_6)), &libs__dependency_graph__conv1_STATE_VARIABLE_Map_7);
    }
...
{
  {
    ...
    MR_Word libs__dependency_graph__V_6_6;
    MR_Word libs__dependency_graph__V_7_7;
    MR_Word libs__dependency_graph__V_17_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 0)));
    MR_Word libs__dependency_graph__V_18_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 1)));
    MR_Box libs__dependency_graph__conv1_SCCMap_4;

    {
      libs__dependency_graph__V_6_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_6_6, 0) = ((MR_Box) (&libs__dependency_graph_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_6_6, 1) = ((MR_Box) (libs__dependency_graph__dependency_info_make_scc_map_1_f_0_1));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_6_6, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), libs__dependency_graph__V_6_6, 3) = ((MR_Box) (libs__dependency_graph__TypeInfo_for_T_8));
    }
    {
      libs__dependency_graph__TypeInfo_13_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), libs__dependency_graph__TypeInfo_13_13, 0) = ((MR_Box) (&mercury__set_ordlist__set_ordlist__type_ctor_info_set_ordlist_1));
    ...
    {
      libs__dependency_graph__V_7_7 = mercury__map__init_0_f_0(libs__dependency_graph__TypeInfo_for_T_8, libs__dependency_graph__TypeInfo_13_13);
    }
    {
    ...
    {
      mercury__list__foldl_4_p_0(libs__dependency_graph__TypeInfo_13_13, libs__dependency_graph__TypeInfo_15_15, (MR_Word) libs__dependency_graph__V_6_6, (MR_Word) libs__dependency_graph__SCCs_5, ((MR_Box) (libs__dependency_graph__V_7_7)), &libs__dependency_graph__conv1_SCCMap_4);
    }
...
{
  {
    ...
    MR_Word libs__dependency_graph__V_17_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word libs__dependency_graph__V_5_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word libs__dependency_graph__V_4_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 0)));
    MR_Word libs__dependency_graph__V_5_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__dependency_graph__DepInfo_3, (MR_Integer) 2)));
