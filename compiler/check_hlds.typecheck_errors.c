...
MR_def_label(fn__check_hlds__typecheck_errors__report_no_clauses_stub_3_0,8)
	...
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 27;
...
MR_def_label(fn__check_hlds__typecheck_errors__too_much_overloading_to_msgs_2_0,38)
	...
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_sv(1), 1);
	MR_r4 = MR_r1;
	MR_sv(1) = MR_r2;
...
MR_def_label(fn__check_hlds__typecheck_errors__type_of_var_to_pieces_2_0,5)
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(3,0,64);
	MR_tfield(1, MR_r1, 1) = MR_tempr1;
	MR_decr_sp_and_return(2);
	}
...
MR_def_label(fn__check_hlds__typecheck_errors__functor_name_to_pieces_2_0,3)
	...
	MR_tfield(3, MR_r2, 1) = ((MR_Integer) MR_sv(2) - (MR_Integer) 1);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
...
MR_def_label(fn__check_hlds__typecheck_errors__report_error_var_either_type_5_0,13)
	...
	MR_sv(7) = MR_tfield(0, MR_tfield(1, MR_r1, 0), 1);
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__check_hlds__typecheck_errors__argument_name_to_pieces_2_0,
...
MR_def_label(fn__check_hlds__typecheck_errors__report_error_undef_cons_4_0,6)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__typecheck_errors__IntroducedFrom__pred__report_error_undef_cons__1073__1_2_0);
...
MR_def_label(fn__check_hlds__typecheck_errors__report_error_undef_cons_4_0,28)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__typecheck_errors__IntroducedFrom__pred__report_error_undef_cons__1095__1_4_0);
...
MR_def_label(fn__check_hlds__typecheck_errors__describe_cons_type_info_source_2_0,13)
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,0,136);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(3,0,135);
	MR_tfield(1, MR_r1, 1) = MR_r2;
	MR_proceed();
	}
...
MR_def_label(fn__check_hlds__typecheck_errors__report_cons_error_2_0,105)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,1,207);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_sv(3) = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(3,0,145);
	MR_tfield(1, MR_tempr2, 1) = MR_r1;
	MR_tempr3 = MR_tfield(2, MR_r2, 3);
	MR_r3 = MR_tempr3;
...
MR_def_label(fn__check_hlds__typecheck_errors__report_cons_error_2_0,41)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_r2;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,1,208);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,0,69);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_sv(2) = MR_r2;
	MR_np_call_localret_ent(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,
...
MR_def_label(fn__check_hlds__typecheck_errors__report_cons_error_2_0,75)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,0,155);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
