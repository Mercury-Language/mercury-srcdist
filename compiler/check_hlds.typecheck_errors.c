...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Msg_31, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(0), Msg_31, 1) = ((MR_Box) (Var_98));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Msg_29, 0) = ((MR_Box) (Context_12));
      MR_hl_field(MR_mktag(0), Msg_29, 1) = ((MR_Box) (Var_76));
    }
    {
      Var_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), SecondMsg_131, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__typecheck_errors_scalar_common_1[469])));
        }
