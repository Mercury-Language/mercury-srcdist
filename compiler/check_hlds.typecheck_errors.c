...
check_hlds__typecheck_errors__IntroducedFrom__pred__higher_order_diff_pieces__1816__1_2_p_0(
  ...
  MR_Word TypeAssignSet_13)
{
  ...
  if (succeeded)
    NoSuffixIntegerPieces_25 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__typecheck_errors_scalar_common_1[141])));
  else
  ...
  MR_Word * DiffPieces_12)
{
  ...
  if ((MaybeSingleActual_15 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    ActualColonPieces_118 = parse_tree__error_spec__color_as_incorrect_1_f_0(ActualColonPieces0_117);
  ...
  if ((MaybeSingleExpected_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      ExpectedDotPieces_121 = parse_tree__error_spec__color_as_correct_1_f_0(ExpectedDotPieces0_120);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_errors__IntroducedFrom__pred__higher_order_diff_pieces__1816__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_117 = parse_tree__error_spec__color_as_incorrect_1_f_0(ActualCommaPieces_156);
  ...
  MR_Word TypeAssignSet_17)
{
  ...
  if (succeeded)
    NoSuffixIntegerPieces_29 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__typecheck_errors_scalar_common_1[141])));
  else
