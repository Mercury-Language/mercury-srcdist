...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__204__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__204__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Targets0_12)
{
  ...
  {
    MR_Word MaybeMainTargets_90;

    make__options_file__lookup_main_target_2_p_0(Variables_10, &MaybeMainTargets_90);
    if (((MR_tag((MR_Word) MaybeMainTargets_90)) == (MR_Integer) 0))
    {
      MR_Word Specs_17 = ((MR_Word) ((MR_hl_field(0, MaybeMainTargets_90, (MR_Integer) 0))));
      MR_Word StdErr_18;
    ...
    {
      MR_Word MainTargets_92 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_90, (MR_Integer) 0))));

      if ((MainTargets_92 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_95;
        MR_Word Spec_96;
        MR_Word Var_99;
...

        {
          ...
          MR_hl_field(2, Var_99, 0) = ((MR_Box) (ProgName_14));
        }
        {
          Pieces_95 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_95, 0) = ((MR_Box) (Var_99));
          MR_hl_field(1, Pieces_95, 1) = ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[4])));
        }
        {
          Spec_96 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Spec_96, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
          MR_hl_field(2, Spec_96, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_96, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_96, 3) = ((MR_Box) (Pieces_95));
        }
        {
          Specs_298 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Specs_298, 0) = ((MR_Box) (Spec_96));
          MR_hl_field(1, Specs_298, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_299);
        parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_299, Globals_8, Specs_298);
      }
      else
      {
        MR_Word AbsTargets_108;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[1]), MainTargets_92, &AbsTargets_108);
        if ((AbsTargets_108 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_19 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_90, (MR_Integer) 0))));
          ...
          Var_65 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), ClassifiedTargets_27);
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_110, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
            MR_hl_field(0, Var_110, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_7));
            MR_hl_field(0, Var_110, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_110, 3) = ((MR_Box) (ProgName_14));
          }
          Specs_308 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_110, AbsTargets_108);
          mercury__io__stderr_stream_3_p_0(&StdErr_309);
          parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_309, Globals_8, Specs_308);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_119;
    MR_Word AbsTargets_122;

    {
      MaybeTargets0_119 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_119, 0) = ((MR_Box) (Targets0_12));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[6]), Targets0_12, &AbsTargets_122);
    if ((AbsTargets_122 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_135 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_119, (MR_Integer) 0))));
      MR_Word KeepGoingBool_136;
      MR_Word KeepGoing_137;
      MR_Word ModuleIndexMap_138;
      MR_Word DepIndexMap_139;
      MR_Word DepStatusMap_140;
      MR_Word NonDependTargets_141;
      MR_Word ClassifiedTargets_142;
      MR_Integer AnalysisRepeat_144;
      MR_Word ModuleDependencies_145;
      MR_Word FileTimestamps_146;
      MR_Word TargetTimestamps_147;
      MR_Word ErrorFileModules_148;
      MR_Word MakeInfo0_151;
      MR_Word Succeeded_152;
      MR_Word Var_155;
      MR_Box Var_157;
      MR_Word Var_159;
      MR_Box Var_161;
      ...
      MR_Word Var_172;
      MR_Word Var_173;
      MR_Word _MakeInfo_134;

      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 662, &KeepGoingBool_136);
      switch (KeepGoingBool_136) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_137 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_137 = (MR_Integer) 1;
          break;
      }
      Var_155 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_1[7]));
      Var_157 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_138 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_138, 0) = ((MR_Box) (Var_155));
        MR_hl_field(0, ModuleIndexMap_138, 1) = ((MR_Box) (Var_157));
        MR_hl_field(0, ModuleIndexMap_138, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      Var_159 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[8]));
      Var_161 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0));
      {
        DepIndexMap_139 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, DepIndexMap_139, 0) = ((MR_Box) (Var_159));
        MR_hl_field(0, DepIndexMap_139, 1) = ((MR_Box) (Var_161));
        MR_hl_field(0, DepIndexMap_139, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      DepStatusMap_140 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_1[9]));
      NonDependTargets_141 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[10]), Targets_135);
      {
        Var_165 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_165, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(0, Var_165, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_13));
        MR_hl_field(0, Var_165, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_165, 3) = ((MR_Box) (Globals_8));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), Var_165, NonDependTargets_141, &ClassifiedTargets_142);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 503, &AnalysisRepeat_144);
      mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), &ModuleDependencies_145);
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[0]), &FileTimestamps_146);
      mercury__map__init_1_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_file_0), (MR_Word) (&libs__timestamp__libs__timestamp__type_ctor_info_timestamp_0), &TargetTimestamps_147);
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ErrorFileModules_148);
      Var_167 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_168 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_169 = make__dependencies__init_cached_indirect_imports_0_f_0();
      Var_170 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
      Var_171 = make__dependencies__init_cached_transitive_foreign_imports_0_f_0();
      Var_172 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), ClassifiedTargets_142);
      Var_173 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
      {
        MakeInfo0_151 = (MR_Word) MR_new_object(MR_Word, (21 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MakeInfo0_151, 0) = ((MR_Box) (ModuleDependencies_145));
        MR_hl_field(0, MakeInfo0_151, 1) = ((MR_Box) (FileTimestamps_146));
        MR_hl_field(0, MakeInfo0_151, 2) = ((MR_Box) (TargetTimestamps_147));
        MR_hl_field(0, MakeInfo0_151, 3) = ((MR_Box) (DetectedGradeFlags_9));
        MR_hl_field(0, MakeInfo0_151, 4) = ((MR_Box) (OptionArgs_11));
        MR_hl_field(0, MakeInfo0_151, 5) = ((MR_Box) (Variables_10));
        MR_hl_field(0, MakeInfo0_151, 6) = ((MR_Box) (ModuleIndexMap_138));
        MR_hl_field(0, MakeInfo0_151, 7) = ((MR_Box) (DepIndexMap_139));
        MR_hl_field(0, MakeInfo0_151, 8) = ((MR_Box) (DepStatusMap_140));
        MR_hl_field(0, MakeInfo0_151, 9) = ((MR_Box) (Var_167));
        MR_hl_field(0, MakeInfo0_151, 10) = ((MR_Box) (Var_168));
        MR_hl_field(0, MakeInfo0_151, 11) = ((MR_Box) (Var_169));
        MR_hl_field(0, MakeInfo0_151, 12) = ((MR_Box) (Var_170));
        MR_hl_field(0, MakeInfo0_151, 13) = ((MR_Box) (Var_171));
        MR_hl_field(0, MakeInfo0_151, 14) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (KeepGoing_137)));
        MR_hl_field(0, MakeInfo0_151, 15) = ((MR_Box) (ErrorFileModules_148));
        MR_hl_field(0, MakeInfo0_151, 16) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_151, 17) = ((MR_Box) (Var_172));
        MR_hl_field(0, MakeInfo0_151, 18) = ((MR_Box) (AnalysisRepeat_144));
        MR_hl_field(0, MakeInfo0_151, 19) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_151, 20) = ((MR_Box) (Var_173));
      }
      make__build__foldl2_make_top_targets_8_p_0(KeepGoing_137, Globals_8, ClassifiedTargets_142, &Succeeded_152, MakeInfo0_151, &_MakeInfo_134);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_152);
    }
    else
    {
      MR_Word Var_114;
...

      {
        ...
        MR_hl_field(0, Var_114, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(0, Var_114, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_14));
        MR_hl_field(0, Var_114, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_114, 3) = ((MR_Box) (ProgName_14));
      }
      Specs_129 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_114, AbsTargets_122);
      mercury__io__stderr_stream_3_p_0(&StdErr_130);
      parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_130, Globals_8, Specs_129);
    }
  }
}
