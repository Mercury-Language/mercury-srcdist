  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 670, &TrackFlags_17);
  ...
  MR_Word Targets0_14)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_95 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 668, &KeepGoingBool_22);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 509, &AnalysisRepeat_24);
  ...
  else
  {
    ...
    if ((AbsTargets_109 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 668, &KeepGoingBool_122);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 509, &AnalysisRepeat_124);
