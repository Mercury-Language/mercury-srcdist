  ...
  MR_Word ArgPack_8)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_96 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 466, &KeepGoingBool_20);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 438, &AnalysisRepeat_22);
  ...
  else
  {
    ...
    if ((AbsTargets_113 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 466, &KeepGoingBool_127);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 438, &AnalysisRepeat_129);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(HeadVar__2_2, (MR_Integer) 470, &TrackFlags_44);
