...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__175__1_1_p_0(
  MR_String LambdaHeadVar__1_15);

static MR_bool MR_CALL 
make__top_level__IntroducedFrom__pred__make_process_compiler_args__110__1_1_p_0(
...
static /* final */ const MR_Box make__top_level_scalar_common_2[39][1];
...
static /* final */ const MR_Box make__top_level_scalar_common_2[39][1] = {
  ...
  /* row   8 */
  { ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[7]))) },
  /* row   9 */
  ...
  /* row  27 */
  { ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[9]))) },
  /* row  28 */
  ...
  /* row  38 */
  { ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[25]))) },
};
...
static /* final */ const struct make__top_level__vector_common_type_7_0_s make__top_level_vector_common_7[37] = {
  /* row   0 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[26])) },
  /* row   1 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[27])) },
  /* row   2 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[28])) },
  /* row   3 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[29])) },
  /* row   4 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[29])) },
  /* row   5 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[8])) },
  /* row   6 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[30])) },
  /* row   7 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[31])) },
  /* row   8 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[32])) },
  /* row   9 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[33])) },
  /* row  10 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[34])) },
  /* row  11 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[35])) },
  /* row  12 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[36])) },
  /* row  13 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[37])) },
  /* row  14 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[38])) },
  /* row  15 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[4])) },
  /* row  16 */   { (MR_Word) (&make__top_level_scalar_common_2[5]) },
  /* row  17 */   { (MR_Word) (&make__top_level_scalar_common_2[6]) },
  /* row  18 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[8])) },
  /* row  19 */   { (MR_Word) (&make__top_level_scalar_common_2[9]) },
  /* row  20 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[10])) },
  /* row  21 */   { (MR_Word) (&make__top_level_scalar_common_2[11]) },
  /* row  22 */   { (MR_Word) (&make__top_level_scalar_common_2[11]) },
  /* row  23 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[12])) },
  /* row  24 */   { (MR_Word) (&make__top_level_scalar_common_2[7]) },
  /* row  25 */   { (MR_Word) (&make__top_level_scalar_common_2[13]) },
  /* row  26 */   { (MR_Word) (&make__top_level_scalar_common_2[14]) },
  /* row  27 */   { (MR_Word) (&make__top_level_scalar_common_2[15]) },
  /* row  28 */   { (MR_Word) (&make__top_level_scalar_common_2[16]) },
  /* row  29 */   { (MR_Word) (&make__top_level_scalar_common_2[17]) },
  /* row  30 */   { (MR_Word) (&make__top_level_scalar_common_2[18]) },
  /* row  31 */   { (MR_Word) (&make__top_level_scalar_common_2[20]) },
  /* row  32 */   { (MR_Word) (&make__top_level_scalar_common_2[21]) },
  /* row  33 */   { (MR_Word) (&make__top_level_scalar_common_2[22]) },
  /* row  34 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[23])) },
  /* row  35 */   { (MR_Word) (&make__top_level_scalar_common_2[24]) },
  /* row  36 */   { (MR_Word) (&make__top_level_scalar_common_2[25]) },
};
  ...
  MR_Word * TopTargetFile_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__get_target_2_p_0(Globals_4, &CompilationTarget_20);
      switch (CompilationTarget_20) {
  ...
  MR_Word * TopTargetFile_8)
{
  ...
  else
  {
    ...
    succeeded = backend_libs__compile_target_code__is_maybe_pic_object_file_extension_3_p_0(Globals_5, ExtStr_7, &PIC_12);
    if (succeeded)
    {
      MR_Word ModuleTargetType_13;

      ModuleNameStr_10 = ModuleNameStr0_6;
      {
        ModuleTargetType_13 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, ModuleTargetType_13, 0) = (MR_Box) ((MR_Unsigned) (PIC_12));
      }
      {
        TargetType_11 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, TargetType_11, 0) = ((MR_Box) (ModuleTargetType_13));
      }
      succeeded = MR_TRUE;
    }
    else
    {
      MR_Word PIC_38;
      MR_String ExtStr1_16;
      MR_String DotAllSLessExtStr_15;
      MR_String DotAllLessExtStr_14;
      MR_String Var_22;

      succeeded = mercury__string__remove_prefix_3_p_0((MR_String) ".all_", ExtStr_7, &DotAllLessExtStr_14);
      if (succeeded)
      {
        Var_22 = (MR_String) "s";
        succeeded = mercury__string__remove_suffix_3_p_0(DotAllLessExtStr_14, Var_22, &DotAllSLessExtStr_15);
      }
      if (succeeded)
      {
        ExtStr1_16 = mercury__string__f_43_43_2_f_0((MR_String) ".", DotAllSLessExtStr_15);
        succeeded = MR_TRUE;
      }
      else
        succeeded = mercury__string__remove_suffix_3_p_0(ExtStr_7, (MR_String) "s", &ExtStr1_16);
      if (succeeded)
        succeeded = backend_libs__compile_target_code__is_maybe_pic_object_file_extension_3_p_0(Globals_5, ExtStr1_16, &PIC_38);
      if (succeeded)
      {
        MR_Word Var_25;
        MR_Word ModuleTargetType_35;

        ModuleNameStr_10 = ModuleNameStr0_6;
        {
          ModuleTargetType_35 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, ModuleTargetType_35, 0) = (MR_Box) ((MR_Unsigned) (PIC_38));
        }
        {
          Var_25 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_25, 0) = ((MR_Box) (ModuleTargetType_35));
        }
        {
          TargetType_11 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, TargetType_11, 0) = ((MR_Box) (Var_25));
        }
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 615, &Var_39);
        succeeded = (strcmp(ExtStr_7, Var_39) == 0);
        if (succeeded)
        {
          MR_Word ExecutableType_18;
          MR_Word CompilationTarget_97;

          ModuleNameStr_10 = ModuleNameStr0_6;
          libs__globals__get_target_2_p_0(Globals_5, &CompilationTarget_97);
          switch (CompilationTarget_97) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              ExecutableType_18 = (MR_Integer) 0;
              break;
            case (MR_Integer) 1:
              ExecutableType_18 = (MR_Integer) 3;
              break;
            case (MR_Integer) 2:
              ExecutableType_18 = (MR_Integer) 5;
              break;
          }
          {
            TargetType_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, TargetType_11, 0) = (MR_Box) ((MR_Unsigned) (ExecutableType_18));
          }
          succeeded = MR_TRUE;
        }
        else
        {
          MR_String ModuleNameStr1_19;
          MR_String Var_28;
          MR_String Var_40;

          libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 614, &Var_40);
          succeeded = (strcmp(ExtStr_7, Var_40) == 0);
          if (succeeded)
          {
            Var_28 = (MR_String) "lib";
            succeeded = mercury__string__append_3_p_1(Var_28, &ModuleNameStr1_19, ModuleNameStr0_6);
          }
          if (succeeded)
          {
            ModuleNameStr_10 = ModuleNameStr1_19;
            TargetType_11 = (MR_Word) (MR_mkword(1, &make__top_level_scalar_common_2[1]));
            succeeded = MR_TRUE;
          }
          else
          {
            MR_String ModuleNameStr1_37;
            MR_String Var_31;
            MR_String Var_41;

            libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 613, &Var_41);
            succeeded = (strcmp(ExtStr_7, Var_41) == 0);
            if (succeeded)
            {
              Var_31 = (MR_String) "lib";
              succeeded = mercury__string__append_3_p_1(Var_31, &ModuleNameStr1_37, ModuleNameStr0_6);
            }
            if (succeeded)
            {
              ModuleNameStr_10 = ModuleNameStr1_37;
              TargetType_11 = (MR_Word) (MR_mkword(1, &make__top_level_scalar_common_2[2]));
              succeeded = MR_TRUE;
            }
            else
            {
              ...
              succeeded = (strcmp(ExtStr_7, (MR_String) ".install") == 0);
              if (succeeded)
              {
                Var_33 = (MR_String) "lib";
                succeeded = mercury__string__append_3_p_1(Var_33, &ModuleNameStr_10, ModuleNameStr0_6);
                if (succeeded)
                {
  ...
  if (succeeded)
  {
    parse_tree__file_names__file_name_to_module_name_2_p_0(ModuleNameStr_10, &ModuleName_20);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__make_process_compiler_args__110__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__175__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
