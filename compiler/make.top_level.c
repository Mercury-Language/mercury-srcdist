  ...
  MR_Word * TopTargetFile_6)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = make__file_names__extension_to_target_type_3_p_0(Globals_4, Suffix_10, &ModuleTargetType_20);
    if (succeeded)
    {
    ...
    {
      MR_Word ModuleTargetType_55;

      succeeded = make__file_names__target_extension_synonym_2_p_0(Suffix_10, &ModuleTargetType_55);
      if (succeeded)
      {
        ModuleNameStr_21 = ModuleNameStr0_9;
        {
          TargetType_22 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, TargetType_22, 0) = ((MR_Box) (ModuleTargetType_55));
        }
        succeeded = MR_TRUE;
      }
      else
      {
        MR_String ModuleNameStr1_23;
        MR_String Var_33;
        MR_String Var_56;

        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 613, &Var_56);
        succeeded = (strcmp(Suffix_10, Var_56) == 0);
        if (succeeded)
        {
          Var_33 = (MR_String) "lib";
          succeeded = mercury__string__append_3_p_1(Var_33, &ModuleNameStr1_23, ModuleNameStr0_9);
        }
        if (succeeded)
        {
          ModuleNameStr_21 = ModuleNameStr1_23;
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 612, &Var_57);
          succeeded = (strcmp(Suffix_10, Var_57) == 0);
          if (succeeded)
          {
            Var_36 = (MR_String) "lib";
            succeeded = mercury__string__append_3_p_1(Var_36, &ModuleNameStr1_54, ModuleNameStr0_9);
          }
          if (succeeded)
          {
            ModuleNameStr_21 = ModuleNameStr1_54;
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 614, &Var_58);
            succeeded = (strcmp(Suffix_10, Var_58) == 0);
            if (succeeded)
            {
              MR_Word ExecutableType_24;
              ...
              switch (CompilationTarget_59) {
                ...
                case (MR_Integer) 0:
                  ExecutableType_24 = (MR_Integer) 0;
                  break;
                case (MR_Integer) 1:
                  ExecutableType_24 = (MR_Integer) 3;
                  break;
                case (MR_Integer) 2:
                  ExecutableType_24 = (MR_Integer) 5;
                  break;
              }
              {
                TargetType_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, TargetType_22, 0) = (MR_Box) ((MR_Unsigned) (ExecutableType_24));
              }
              succeeded = MR_TRUE;
            }
            else
            {
              MR_Word ModuleTargetType_53;
              MR_String ExtStr1_27;
              MR_String DotAllSLessExtStr_26;
              MR_String DotAllLessExtStr_25;
              MR_String Var_40;
              MR_Word ModuleTargetType0_29;

              succeeded = mercury__string__remove_prefix_3_p_0((MR_String) ".all_", Suffix_10, &DotAllLessExtStr_25);
              if (succeeded)
              {
                Var_40 = (MR_String) "s";
                succeeded = mercury__string__remove_suffix_3_p_0(DotAllLessExtStr_25, Var_40, &DotAllSLessExtStr_26);
              }
              if (succeeded)
              {
                ExtStr1_27 = mercury__string__f_43_43_2_f_0((MR_String) ".", DotAllSLessExtStr_26);
                succeeded = MR_TRUE;
              }
              else
                succeeded = mercury__string__remove_suffix_3_p_0(Suffix_10, (MR_String) "s", &ExtStr1_27);
              if (succeeded)
              {
                succeeded = make__file_names__extension_to_target_type_3_p_0(Globals_4, ExtStr1_27, &ModuleTargetType0_29);
                if (succeeded)
                {
                  ModuleTargetType_53 = ModuleTargetType0_29;
                  succeeded = ((MR_tag((MR_Word) ModuleTargetType_53)) == (MR_Integer) 1);
                  if (succeeded)
                  {
                  }
                  succeeded = !(succeeded);
                ...
                {
                  succeeded = make__file_names__target_extension_synonym_2_p_0(ExtStr1_27, &ModuleTargetType_53);
                  if (succeeded)
                  {
                    succeeded = ((MR_tag((MR_Word) ModuleTargetType_53)) == (MR_Integer) 1);
                    if (succeeded)
              ...
              if (succeeded)
              {
                ...
                ModuleNameStr_21 = ModuleNameStr0_9;
                {
                  ...
                  MR_hl_field(1, Var_43, 0) = ((MR_Box) (ModuleTargetType_53));
                }
                {
                  TargetType_22 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(2, TargetType_22, 0) = ((MR_Box) (Var_43));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                succeeded = (strcmp(Suffix_10, (MR_String) ".check") == 0);
                if (succeeded)
                {
                  ModuleNameStr_21 = ModuleNameStr0_9;
                ...
                {
                  succeeded = (strcmp(Suffix_10, (MR_String) ".analyse") == 0);
                  if (succeeded)
                  {
                    ModuleNameStr_21 = ModuleNameStr0_9;
                    TargetType_22 = (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[5]));
                    succeeded = MR_TRUE;
                  }
                  else
                  {
                    succeeded = (strcmp(Suffix_10, (MR_String) ".clean") == 0);
                    if (succeeded)
                    {
                      ModuleNameStr_21 = ModuleNameStr0_9;
                      TargetType_22 = (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[6]));
                      succeeded = MR_TRUE;
                    }
                    else
                    {
                      succeeded = (strcmp(Suffix_10, (MR_String) ".realclean") == 0);
                      if (succeeded)
                      {
                        ModuleNameStr_21 = ModuleNameStr0_9;
                        TargetType_22 = (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[7]));
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          Var_49 = (MR_String) "lib";
                          succeeded = mercury__string__append_3_p_1(Var_49, &ModuleNameStr1_52, ModuleNameStr0_9);
                        }
                        if (succeeded)
                        {
                          ModuleNameStr_21 = ModuleNameStr1_52;
                          TargetType_22 = (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[8]));
                          succeeded = MR_TRUE;
                        }
                        else
                        {
                          succeeded = (strcmp(Suffix_10, (MR_String) ".doc") == 0);
                          if (succeeded)
                          {
                            ModuleNameStr_21 = ModuleNameStr0_9;
                            TargetType_22 = (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[9]));
                            succeeded = MR_TRUE;
                          }
                        }
                      }
    ...
    if (succeeded)
    {
      parse_tree__file_names__file_name_to_module_name_2_p_0(ModuleNameStr_21, &ModuleName_31);
      {
        TopTargetFilePrime_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, TopTargetFilePrime_11, 0) = ((MR_Box) (ModuleName_31));
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__get_target_2_p_0(Globals_4, &CompilationTarget_60);
      switch (CompilationTarget_60) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 668, &TrackFlags_17);
  ...
  MR_Word Targets0_14)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_94 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 666, &KeepGoingBool_22);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 507, &AnalysisRepeat_24);
  ...
  else
  {
    ...
    if ((AbsTargets_108 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 666, &KeepGoingBool_121);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 507, &AnalysisRepeat_123);
