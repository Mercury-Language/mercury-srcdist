...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__190__1_1_p_0(
  MR_String LambdaHeadVar__1_16);

static MR_bool MR_CALL 
make__top_level__IntroducedFrom__pred__make_process_compiler_args__119__1_1_p_0(
  ...
  MR_String LambdaHeadVar__1_16)
{
  ...
  Var_17 = mercury__dir__directory_separator_0_f_0();
  succeeded = mercury__string__contains_char_2_p_0(LambdaHeadVar__1_16, Var_17);
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__make_process_compiler_args__119__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__190__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word ArgPack_8)
{
  ...
  if ((NonOptionArgs_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (((MR_tag((MR_Word) MaybeMainTargets_80)) == (MR_Integer) 0))
    {
      ...
      parse_tree__write_error_spec__write_oom_error_specs_5_p_0(StdErr_18, Globals_7, Specs_17);
    }
    else
    {
      ...
      if ((MainTargets_81 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          Specs_250 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Specs_250, 0) = ((MR_Box) (Spec_85));
          MR_hl_field(0, Specs_250, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_251);
        parse_tree__write_error_spec__write_oom_error_specs_5_p_0(StdErr_251, Globals_7, Specs_250);
      }
      else
      {
        ...
        if ((AbsTargets_96 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 465, &KeepGoingBool_20);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 437, &AnalysisRepeat_22);
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_99, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_5_p_0_7));
            MR_hl_field(0, Var_99, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_99, 3) = ((MR_Box) (ProgName_14));
          }
          AbsTargetSpecs_97 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), Var_99, AbsTargets_96);
          mercury__one_or_more__det_list_to_one_or_more_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), AbsTargetSpecs_97, &Specs_260);
          mercury__io__stderr_stream_3_p_0(&StdErr_261);
          parse_tree__write_error_spec__write_oom_error_specs_5_p_0(StdErr_261, Globals_7, Specs_260);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_110;
    MR_Word AbsTargets_113;

    {
      MaybeTargets0_110 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_110, 0) = ((MR_Box) (NonOptionArgs_13));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_4[5]), NonOptionArgs_13, &AbsTargets_113);
    if ((AbsTargets_113 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_126 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_110, 0))));
      MR_Word KeepGoingBool_127;
      MR_Word KeepGoing_128;
      MR_Integer AnalysisRepeat_129;
      MR_Word ForwardMI_131;
      MR_Box ReverseMI_132;
      MR_Word ModuleIndexMap_133;
      MR_Word ForwardDI_135;
      MR_Box ReverseDI_136;
      MR_Word TargetIndexMap_137;
      MR_Word TargetStatusMap_138;
      MR_Word NonDependTargets_139;
      MR_Word ClassifiedTargets_140;
      MR_Word ClassifiedTargetSet_141;
      MR_Word MaybeStdLibGrades_142;
      MR_Word Params_143;
      MR_Word TimestampMap_144;
      MR_Word MakeInfo0_145;
      MR_Word Succeeded_146;
      MR_Word Var_154;
      MR_Word _MakeInfo_125;

      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 465, &KeepGoingBool_127);
      switch (KeepGoingBool_127) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_128 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_128 = (MR_Integer) 1;
          break;
      }
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 437, &AnalysisRepeat_129);
      ForwardMI_131 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__index_set__make__index_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_4[6]));
      ReverseMI_132 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_133 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_133, 0) = ((MR_Box) (ForwardMI_131));
        MR_hl_field(0, ModuleIndexMap_133, 1) = ((MR_Box) (ReverseMI_132));
        MR_hl_field(0, ModuleIndexMap_133, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      ForwardDI_135 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_id_module_index_0), (MR_Word) (&make__index_set__make__index_set__type_ctor_info_target_id_index_0), (MR_Word) (&make__top_level_scalar_common_4[7]));
      ReverseDI_136 = mercury__version_array__empty_0_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_id_module_index_0));
      {
        TargetIndexMap_137 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, TargetIndexMap_137, 0) = ((MR_Box) (ForwardDI_135));
        MR_hl_field(0, TargetIndexMap_137, 1) = ((MR_Box) (ReverseDI_136));
        MR_hl_field(0, TargetIndexMap_137, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      TargetStatusMap_138 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_id_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_status_0), (MR_Word) (&make__top_level_scalar_common_4[8]));
      mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_4[9]), Targets_126, &NonDependTargets_139);
      {
        Var_154 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_154, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(0, Var_154, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_5_p_0_13));
        MR_hl_field(0, Var_154, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_154, 3) = ((MR_Box) (Globals_7));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), Var_154, NonDependTargets_139, &ClassifiedTargets_140);
      ClassifiedTargetSet_141 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), ClassifiedTargets_140);
      libs__globals__get_maybe_stdlib_grades_2_p_0(Globals_7, &MaybeStdLibGrades_142);
      {
        Params_143 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Params_143, 0) = ((MR_Box) (EnvOptFileVariables_10));
        MR_hl_field(0, Params_143, 1) = ((MR_Box) (EnvVarArgs_11));
        MR_hl_field(0, Params_143, 2) = ((MR_Box) (OptionArgs_12));
      }
      TimestampMap_144 = make__timestamp__init_target_file_timestamp_map_0_f_0();
      MakeInfo0_145 = make__make_info__init_make_info_9_f_0(MaybeStdLibGrades_142, KeepGoing_128, Params_143, ClassifiedTargetSet_141, AnalysisRepeat_129, TimestampMap_144, ModuleIndexMap_133, TargetIndexMap_137, TargetStatusMap_138);
      make__top_level__make_top_targets_10_p_0(ProgressStream_6, Globals_7, KeepGoing_128, ClassifiedTargets_140, (MR_Integer) 1, &Succeeded_146, MakeInfo0_145, &_MakeInfo_125);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_146);
    }
    else
    {
      MR_Word AbsTargetSpecs_102;
      MR_Word Var_104;
      MR_Word Specs_121;
      MR_Word StdErr_122;

      {
        ...
        MR_hl_field(0, Var_104, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_5_p_0_14));
        MR_hl_field(0, Var_104, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_104, 3) = ((MR_Box) (ProgName_14));
      }
      AbsTargetSpecs_102 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), Var_104, AbsTargets_113);
      mercury__one_or_more__det_list_to_one_or_more_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), AbsTargetSpecs_102, &Specs_121);
      mercury__io__stderr_stream_3_p_0(&StdErr_122);
      parse_tree__write_error_spec__write_oom_error_specs_5_p_0(StdErr_122, Globals_7, Specs_121);
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(HeadVar__2_2, (MR_Integer) 469, &TrackFlags_44);
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__write_error_spec__write_diag_specs_5_p_0(ErrorStream_45, HeadVar__2_2, Specs_51);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                parse_tree__write_error_spec__write_diag_specs_5_p_0(ErrorStream_45, HeadVar__2_2, Specs_64);
              }
              break;
          }
          break;
