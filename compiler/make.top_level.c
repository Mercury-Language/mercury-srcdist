  ...
  MR_Word ArgPack_8)
{
  ...
  else
  {
    ...
    if ((AbsTargets_110 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 464, &KeepGoingBool_123);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 436, &AnalysisRepeat_125);
