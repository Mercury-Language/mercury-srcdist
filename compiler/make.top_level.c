  ...
  }
  {
    ...
    if ((env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__succeeded)
    {
      ...
      if ((env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__succeeded)
      {
        ...
        Var_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__ModuleTargetType_43, (MR_Integer) 0))) & (MR_Integer) 1);
      }
      (env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__succeeded = !((env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__succeeded);
    }
    if ((env_ptr)->make__top_level__classify_target_2_4_p_0_env_0__succeeded)
  ...
  (env).make__top_level__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 605, &Var_51);
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 604, &Var_52);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 606, &Var_53);
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (TargetFile_18));
            }
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (ModuleName_13));
              MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (MiscTargetType_23));
            }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv17_Spec_6 = make__top_level__report_target_with_dir_component_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  make__top_level__classify_target_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)), &conv12_HeadVar__3_3);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  make__util__dependency_file_hash_2_p_0(((MR_Word) (wrapper_arg_1)), &conv10_HeadVar__2_2);
  ...
  MR_Word Targets0_12)
{
  ...
  {
    MR_Word MaybeMainTargets_97;

    make__options_file__lookup_main_target_2_p_0(Variables_10, &MaybeMainTargets_97);
    if (((MR_tag((MR_Word) MaybeMainTargets_97)) == (MR_Integer) 0))
    {
      MR_Word Specs_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeMainTargets_97, (MR_Integer) 0))));
      MR_Word StdErr_18;
    ...
    {
      MR_Word MainTargets_99 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeMainTargets_97, (MR_Integer) 0))));

      if ((MainTargets_99 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_102;
        MR_Word Spec_103;
        MR_Word Var_106;
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_106, 1) = ((MR_Box) (ProgName_14));
        }
        {
          Pieces_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_102, 0) = ((MR_Box) (Var_106));
          MR_hl_field(MR_mktag(1), Pieces_102, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &make__top_level_scalar_common_2[8])));
        }
        {
          Spec_103 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Spec_103, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
          MR_hl_field(MR_mktag(2), Spec_103, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(2), Spec_103, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(2), Spec_103, 3) = ((MR_Box) (Pieces_102));
        }
        {
          Specs_305 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Specs_305, 0) = ((MR_Box) (Spec_103));
          MR_hl_field(MR_mktag(1), Specs_305, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_306);
        parse_tree__error_util__write_error_specs_5_p_0(StdErr_306, Globals_8, Specs_305);
      }
      else
      {
        MR_Word AbsTargets_115;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[2]), MainTargets_99, &AbsTargets_115);
        if ((AbsTargets_115 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeMainTargets_97, (MR_Integer) 0))));
          ...
          MR_Box conv6_STATE_VARIABLE_IO_67_67;

          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 657, &KeepGoingBool_20);
          ...
          Var_48 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
          {
            ...
            MR_hl_field(MR_mktag(0), ModuleIndexMap_22, 0) = ((MR_Box) (Var_46));
            MR_hl_field(MR_mktag(0), ModuleIndexMap_22, 1) = ((MR_Box) (Var_48));
            MR_hl_field(MR_mktag(0), ModuleIndexMap_22, 2) = ((MR_Box) ((MR_Integer) 0));
          }
          Var_50 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[4]));
          Var_52 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0));
          {
            DepIndexMap_23 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DepIndexMap_23, 0) = ((MR_Box) (Var_50));
            MR_hl_field(MR_mktag(0), DepIndexMap_23, 1) = ((MR_Box) (Var_52));
          ...
          NonDependTargets_25 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[6]), Targets_19);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
            MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_6));
            MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (Globals_8));
          }
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 500, &AnalysisRepeat_29);
          ...
          Var_62 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
          Var_63 = make__dependencies__init_cached_foreign_imports_0_f_0();
          Var_64 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__top_level_scalar_common_1[0]), ClassifiedTargets_27);
          Var_65 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 9) = ((MR_Box) (Var_60));
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 10) = ((MR_Box) (Var_61));
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 11) = ((MR_Box) (Var_62));
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 12) = ((MR_Box) (Var_63));
            ...
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 16) = ((MR_Box) (Var_64));
            ...
            MR_hl_field(MR_mktag(0), MakeInfo0_36, 19) = ((MR_Box) (Var_65));
          }
          make__build__foldl2_maybe_stop_at_error_9_p_0((MR_Word) (&make__top_level_scalar_common_1[0]), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), KeepGoing_21, (MR_Word) (&make__top_level_scalar_common_1[7]), Globals_8, ClassifiedTargets_27, &Succeeded_37, ((MR_Box) (MakeInfo0_36)), &conv7__MakeInfo_38, ((MR_Box) ((MR_Integer) 0)), &conv6_STATE_VARIABLE_IO_67_67);
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_117, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
            MR_hl_field(MR_mktag(0), Var_117, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_8));
            MR_hl_field(MR_mktag(0), Var_117, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_117, 3) = ((MR_Box) (ProgName_14));
          }
          Specs_315 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_117, AbsTargets_115);
          mercury__io__stderr_stream_3_p_0(&StdErr_316);
          parse_tree__error_util__write_error_specs_5_p_0(StdErr_316, Globals_8, Specs_315);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_126;
    MR_Word AbsTargets_129;

    {
      MaybeTargets0_126 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MaybeTargets0_126, 0) = ((MR_Box) (Targets0_12));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[8]), Targets0_12, &AbsTargets_129);
    if ((AbsTargets_129 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_142 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTargets0_126, (MR_Integer) 0))));
      MR_Word KeepGoingBool_143;
      MR_Word KeepGoing_144;
      MR_Word ModuleIndexMap_145;
      MR_Word DepIndexMap_146;
      MR_Word DepStatusMap_147;
      MR_Word NonDependTargets_148;
      MR_Word ClassifiedTargets_149;
      MR_Integer AnalysisRepeat_151;
      MR_Word ModuleDependencies_152;
      MR_Word FileTimestamps_153;
      MR_Word SearchFileNameCache_154;
      MR_Word ErrorFileModules_155;
      MR_Word MakeInfo0_158;
      ...
      MR_Word Var_178;
      MR_Word Var_179;
      MR_Box conv16__MakeInfo_141;
      MR_Box conv15_STATE_VARIABLE_IO_67_181;

      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 657, &KeepGoingBool_143);
      switch (KeepGoingBool_143) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_144 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_144 = (MR_Integer) 1;
          break;
      }
      Var_162 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_1[9]));
      Var_164 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_145 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ModuleIndexMap_145, 0) = ((MR_Box) (Var_162));
        MR_hl_field(MR_mktag(0), ModuleIndexMap_145, 1) = ((MR_Box) (Var_164));
        MR_hl_field(MR_mktag(0), ModuleIndexMap_145, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      Var_166 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[10]));
      Var_168 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0));
      {
        DepIndexMap_146 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), DepIndexMap_146, 0) = ((MR_Box) (Var_166));
        MR_hl_field(MR_mktag(0), DepIndexMap_146, 1) = ((MR_Box) (Var_168));
        MR_hl_field(MR_mktag(0), DepIndexMap_146, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      DepStatusMap_147 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_1[11]));
      NonDependTargets_148 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[12]), Targets_142);
      {
        Var_172 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_172, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(MR_mktag(0), Var_172, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_14));
        MR_hl_field(MR_mktag(0), Var_172, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_172, 3) = ((MR_Box) (Globals_8));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[0]), Var_172, NonDependTargets_148, &ClassifiedTargets_149);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 500, &AnalysisRepeat_151);
      mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), &ModuleDependencies_152);
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[1]), &FileTimestamps_153);
      mercury__map__init_1_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_module_name_ext_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SearchFileNameCache_154);
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ErrorFileModules_155);
      Var_174 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_175 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_176 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
      Var_177 = make__dependencies__init_cached_foreign_imports_0_f_0();
      Var_178 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__top_level_scalar_common_1[0]), ClassifiedTargets_149);
      Var_179 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
      {
        MakeInfo0_158 = (MR_Word) MR_new_object(MR_Word, (20 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 0) = ((MR_Box) (ModuleDependencies_152));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 1) = ((MR_Box) (FileTimestamps_153));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 2) = ((MR_Box) (SearchFileNameCache_154));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 3) = ((MR_Box) (DetectedGradeFlags_9));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 4) = ((MR_Box) (OptionArgs_11));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 5) = ((MR_Box) (Variables_10));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 6) = ((MR_Box) (ModuleIndexMap_145));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 7) = ((MR_Box) (DepIndexMap_146));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 8) = ((MR_Box) (DepStatusMap_147));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 9) = ((MR_Box) (Var_174));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 10) = ((MR_Box) (Var_175));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 11) = ((MR_Box) (Var_176));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 12) = ((MR_Box) (Var_177));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 13) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (KeepGoing_144)));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 14) = ((MR_Box) (ErrorFileModules_155));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 15) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 16) = ((MR_Box) (Var_178));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 17) = ((MR_Box) (AnalysisRepeat_151));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 18) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), MakeInfo0_158, 19) = ((MR_Box) (Var_179));
      }
      make__build__foldl2_maybe_stop_at_error_9_p_0((MR_Word) (&make__top_level_scalar_common_1[0]), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), KeepGoing_144, (MR_Word) (&make__top_level_scalar_common_1[13]), Globals_8, ClassifiedTargets_149, &Succeeded_159, ((MR_Box) (MakeInfo0_158)), &conv16__MakeInfo_141, ((MR_Box) ((MR_Integer) 0)), &conv15_STATE_VARIABLE_IO_67_181);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_159);
    }
    else
    {
      MR_Word Var_121;
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_121, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(MR_mktag(0), Var_121, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_16));
        MR_hl_field(MR_mktag(0), Var_121, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_121, 3) = ((MR_Box) (ProgName_14));
      }
      Specs_136 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_121, AbsTargets_129);
      mercury__io__stderr_stream_3_p_0(&StdErr_137);
      parse_tree__error_util__write_error_specs_5_p_0(StdErr_137, Globals_8, Specs_136);
    }
  }
}
