  ...
  MR_Word ArgPack_8)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_96 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 464, &KeepGoingBool_20);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 436, &AnalysisRepeat_22);
  ...
  else
  {
    ...
    if ((AbsTargets_113 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 464, &KeepGoingBool_127);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 436, &AnalysisRepeat_129);
