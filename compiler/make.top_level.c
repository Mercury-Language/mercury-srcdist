  ...
  MR_Word Targets0_12)
{
  ...
  else
  {
    ...
    if ((AbsTargets_129 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 655, &KeepGoingBool_143);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 498, &AnalysisRepeat_151);
