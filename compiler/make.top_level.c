...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__183__1_1_p_0(
  MR_String LambdaHeadVar__1_15);

static MR_bool MR_CALL 
make__top_level__IntroducedFrom__pred__make_process_compiler_args__114__1_1_p_0(
...
static /* final */ const MR_Box make__top_level_scalar_common_2[44][1] = {
  ...
  /* row  34 */
  { ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[17]))) },
  /* row  35 */
  ...
  /* row  41 */
  { ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[27]))) },
  /* row  42 */
...
static /* final */ const struct make__top_level__vector_common_type_7_0_s make__top_level_vector_common_7[37] = {
  /* row   0 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[31])) },
  /* row   1 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[32])) },
  /* row   2 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[33])) },
  /* row   3 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[34])) },
  /* row   4 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[34])) },
  /* row   5 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[14])) },
  /* row   6 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[35])) },
  /* row   7 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[36])) },
  /* row   8 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[37])) },
  /* row   9 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[38])) },
  /* row  10 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[39])) },
  /* row  11 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[40])) },
  /* row  12 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[41])) },
  /* row  13 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[42])) },
  /* row  14 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[43])) },
  /* row  15 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[10])) },
  /* row  16 */   { (MR_Word) (&make__top_level_scalar_common_2[11]) },
  /* row  17 */   { (MR_Word) (&make__top_level_scalar_common_2[12]) },
  /* row  18 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[14])) },
  /* row  19 */   { (MR_Word) (&make__top_level_scalar_common_2[15]) },
  /* row  20 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[16])) },
  /* row  21 */   { (MR_Word) (&make__top_level_scalar_common_2[17]) },
  /* row  22 */   { (MR_Word) (&make__top_level_scalar_common_2[17]) },
  /* row  23 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[18])) },
  /* row  24 */   { (MR_Word) (&make__top_level_scalar_common_2[13]) },
  /* row  25 */   { (MR_Word) (&make__top_level_scalar_common_2[19]) },
  /* row  26 */   { (MR_Word) (&make__top_level_scalar_common_2[20]) },
  /* row  27 */   { (MR_Word) (&make__top_level_scalar_common_2[21]) },
  /* row  28 */   { (MR_Word) (&make__top_level_scalar_common_2[22]) },
  /* row  29 */   { (MR_Word) (&make__top_level_scalar_common_2[23]) },
  /* row  30 */   { (MR_Word) (&make__top_level_scalar_common_2[24]) },
  /* row  31 */   { (MR_Word) (&make__top_level_scalar_common_2[25]) },
  /* row  32 */   { (MR_Word) (&make__top_level_scalar_common_2[26]) },
  /* row  33 */   { (MR_Word) (&make__top_level_scalar_common_2[27]) },
  /* row  34 */   { (MR_Word) (MR_mkword(2, &make__top_level_scalar_common_2[28])) },
  /* row  35 */   { (MR_Word) (&make__top_level_scalar_common_2[29]) },
  /* row  36 */   { (MR_Word) (&make__top_level_scalar_common_2[30]) },
};
  ...
  MR_Word * TopTargetFile_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      LinkedTargetKind_15 = ((MR_Unsigned) ((MR_hl_field(0, LinkedTargetExtInfo_13, (MR_Integer) 1))) & (MR_Integer) 15);
      switch (LinkedTargetKind_15) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word Var_23;
            MR_Word CompilationTarget_93;

            ModuleNameStr_10 = ModuleNameStr0_6;
            libs__globals__get_target_2_p_0(Globals_5, &CompilationTarget_93);
            switch (CompilationTarget_93) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                Var_23 = (MR_Integer) 0;
                break;
        ...
        case (MR_Integer) 6:
          {
            TargetType_11 = (MR_Word) (MR_mkword(1, &make__top_level_scalar_common_2[9]));
            succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "lib", ModuleNameStr0_6, &ModuleNameStr_10);
          }
          break;
        case (MR_Integer) 5:
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__make_process_compiler_args__114__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__183__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Targets0_16)
{
  ...
  {
    MR_Word MaybeMainTargets_82;

    make__options_file__lookup_main_target_2_p_0(EnvOptFileVariables_13, &MaybeMainTargets_82);
    if (((MR_tag((MR_Word) MaybeMainTargets_82)) == (MR_Integer) 0))
    {
      MR_Word Specs_21 = ((MR_Word) ((MR_hl_field(0, MaybeMainTargets_82, (MR_Integer) 0))));
      MR_Word StdErr_22;
    ...
    {
      MR_Word MainTargets_83 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_82, (MR_Integer) 0))));

      if ((MainTargets_83 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_86;
        MR_Word Spec_87;
        MR_Word Var_89;
...

        {
          ...
          MR_hl_field(2, Var_89, 0) = ((MR_Box) (ProgName_18));
        }
        {
          Pieces_86 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_86, 0) = ((MR_Box) (Var_89));
          MR_hl_field(1, Pieces_86, 1) = ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_1[4])));
        }
        {
          Spec_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Spec_87, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
        ...
        {
          Specs_242 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Specs_242, 0) = ((MR_Box) (Spec_87));
          MR_hl_field(1, Specs_242, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_243);
        parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_243, Globals_11, Specs_242);
      }
      else
      {
        MR_Word AbsTargets_98;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_4[0]), MainTargets_83, &AbsTargets_98);
        if ((AbsTargets_98 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_23 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_82, (MR_Integer) 0))));
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 685, &KeepGoingBool_24);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 526, &AnalysisRepeat_26);
          ...
          Var_59 = make__timestamp__init_target_file_timestamp_map_0_f_0();
          MakeInfo0_40 = make__make_info__init_make_info_11_f_0(EnvOptFileVariables_13, DetectedGradeFlags_12, KeepGoing_25, EnvVarArgs_14, OptionArgs_15, ClassifiedTargetSet_39, AnalysisRepeat_26, Var_59, ModuleIndexMap_30, DepIndexMap_34, DepStatusMap_35);
          make__top_level__make_top_targets_10_p_0(ProgressStream_10, Globals_11, KeepGoing_25, ClassifiedTargets_38, (MR_Integer) 1, &Succeeded_41, MakeInfo0_40, &_MakeInfo_42);
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_100, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_9_p_0_7));
            MR_hl_field(0, Var_100, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_100, 3) = ((MR_Box) (ProgName_18));
          }
          Specs_252 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_100, AbsTargets_98);
          mercury__io__stderr_stream_3_p_0(&StdErr_253);
          parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_253, Globals_11, Specs_252);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_109;
    MR_Word AbsTargets_112;

    {
      MaybeTargets0_109 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_109, 0) = ((MR_Box) (Targets0_16));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_4[5]), Targets0_16, &AbsTargets_112);
    if ((AbsTargets_112 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_124 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_109, (MR_Integer) 0))));
      MR_Word KeepGoingBool_125;
      MR_Word KeepGoing_126;
      MR_Integer AnalysisRepeat_127;
      MR_Word ForwardMI_129;
      MR_Box ReverseMI_130;
      MR_Word ModuleIndexMap_131;
      MR_Word ForwardDI_133;
      MR_Box ReverseDI_134;
      MR_Word DepIndexMap_135;
      MR_Word DepStatusMap_136;
      MR_Word NonDependTargets_137;
      MR_Word ClassifiedTargets_138;
      MR_Word ClassifiedTargetSet_139;
      MR_Word MakeInfo0_140;
      MR_Word Succeeded_141;
      MR_Word Var_149;
      MR_Word Var_150;
      MR_Word _MakeInfo_123;

      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 685, &KeepGoingBool_125);
      switch (KeepGoingBool_125) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_126 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_126 = (MR_Integer) 1;
          break;
      }
      libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 526, &AnalysisRepeat_127);
      ForwardMI_129 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_4[6]));
      ReverseMI_130 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_131 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_131, 0) = ((MR_Box) (ForwardMI_129));
        MR_hl_field(0, ModuleIndexMap_131, 1) = ((MR_Box) (ReverseMI_130));
        MR_hl_field(0, ModuleIndexMap_131, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      ForwardDI_133 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_4[7]));
      ReverseDI_134 = mercury__version_array__empty_0_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_with_module_index_0));
      {
        DepIndexMap_135 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, DepIndexMap_135, 0) = ((MR_Box) (ForwardDI_133));
        MR_hl_field(0, DepIndexMap_135, 1) = ((MR_Box) (ReverseDI_134));
        MR_hl_field(0, DepIndexMap_135, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      DepStatusMap_136 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_4[8]));
      mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_4[9]), Targets_124, &NonDependTargets_137);
      {
        ...
        MR_hl_field(0, Var_149, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_9_p_0_13));
        MR_hl_field(0, Var_149, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_149, 3) = ((MR_Box) (Globals_11));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), Var_149, NonDependTargets_137, &ClassifiedTargets_138);
      ClassifiedTargetSet_139 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), ClassifiedTargets_138);
      Var_150 = make__timestamp__init_target_file_timestamp_map_0_f_0();
      MakeInfo0_140 = make__make_info__init_make_info_11_f_0(EnvOptFileVariables_13, DetectedGradeFlags_12, KeepGoing_126, EnvVarArgs_14, OptionArgs_15, ClassifiedTargetSet_139, AnalysisRepeat_127, Var_150, ModuleIndexMap_131, DepIndexMap_135, DepStatusMap_136);
      make__top_level__make_top_targets_10_p_0(ProgressStream_10, Globals_11, KeepGoing_126, ClassifiedTargets_138, (MR_Integer) 1, &Succeeded_141, MakeInfo0_140, &_MakeInfo_123);
    ...
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_104, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(0, Var_104, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_9_p_0_14));
        MR_hl_field(0, Var_104, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_104, 3) = ((MR_Box) (ProgName_18));
      }
      Specs_119 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_104, AbsTargets_112);
      mercury__io__stderr_stream_3_p_0(&StdErr_120);
      parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_120, Globals_11, Specs_119);
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Target_26 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 0))));
      MR_Word Targets_27 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 1))));
      MR_Word TargetSucceeded_31;
      MR_Word StopOrContinue_32;
      MR_Word STATE_VARIABLE_Info_39_39;
      MR_Word STATE_VARIABLE_Succeeded_41_41;
      MR_Word ModuleName_42 = ((MR_Word) ((MR_hl_field(0, Target_26, (MR_Integer) 0))));
      MR_Word TargetType_43 = ((MR_Word) ((MR_hl_field(0, Target_26, (MR_Integer) 1))));
      MR_Word TrackFlags_44;
      MR_Word ErrorStream_45;
      MR_Word TrackFlagsSucceeded_46;
      MR_Word STATE_VARIABLE_Info_32_55;

      libs__globals__lookup_bool_option_3_p_0(HeadVar__2_2, (MR_Integer) 687, &TrackFlags_44);
        ...
        case (MR_Integer) 0:
          {
            ...
            STATE_VARIABLE_Info_32_55 = STATE_VARIABLE_Info_0_7;
          }
          break;
        case (MR_Integer) 1:
          make__track_flags__make_track_flags_files_9_p_0(ErrorStream_45, HeadVar__1_1, HeadVar__2_2, ModuleName_42, &TrackFlagsSucceeded_46, STATE_VARIABLE_Info_0_7, &STATE_VARIABLE_Info_32_55);
          break;
      }
        ...
        case (MR_Integer) 0:
          {
            ...
            STATE_VARIABLE_Info_39_39 = STATE_VARIABLE_Info_32_55;
          }
          break;
        case (MR_Integer) 1:
          switch (MR_tag((MR_Word) TargetType_43)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word ModuleTargetType_47 = ((MR_Word) ((MR_hl_field(0, TargetType_43, (MR_Integer) 0))));
                ...
                make__module_target__make_module_target_9_p_0((MR_Word) ((MR_Unsigned) 0U), HeadVar__1_1, HeadVar__2_2, Var_58, &TargetSucceeded_31, STATE_VARIABLE_Info_32_55, &STATE_VARIABLE_Info_39_39);
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ProgramTargetType_49 = ((MR_Unsigned) ((MR_hl_field(1, TargetType_43, (MR_Integer) 0))) & (MR_Integer) 7);
...

                {
                  ...
                  MR_hl_field(0, LinkedTargetFile_50, 1) = (MR_Box) ((MR_Unsigned) (ProgramTargetType_49));
                }
                make__program_target__make_linked_target_10_p_0(HeadVar__1_1, HeadVar__2_2, LinkedTargetFile_50, &TargetSucceeded_31, STATE_VARIABLE_Info_32_55, &STATE_VARIABLE_Info_39_39, (MR_Word) ((MR_Unsigned) 0U), &Specs_51);
                parse_tree__write_error_spec__write_error_specs_5_p_0(ErrorStream_45, HeadVar__2_2, Specs_51);
              }
              break;
            case (MR_Integer) 2:
              {
                MR_Word MiscTargetType_52 = ((MR_Word) ((MR_hl_field(2, TargetType_43, (MR_Integer) 0))));
                MR_Word Var_61;
                MR_Word Specs_64;
                ...
                make__program_target__make_misc_target_10_p_0(HeadVar__1_1, HeadVar__2_2, Var_61, &TargetSucceeded_31, STATE_VARIABLE_Info_32_55, &STATE_VARIABLE_Info_39_39, (MR_Word) ((MR_Unsigned) 0U), &Specs_64);
      ...
      make__util__should_we_stop_or_continue_5_p_0(HeadVar__3_3, TargetSucceeded_31, &StopOrContinue_32, STATE_VARIABLE_Succeeded_0_5, &STATE_VARIABLE_Succeeded_41_41);
      switch (StopOrContinue_32) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          {
            MR_Word next_value_of_HeadVar__4_4 = Targets_27;
            MR_Word next_value_of_STATE_VARIABLE_Succeeded_0_5 = STATE_VARIABLE_Succeeded_41_41;
            MR_Word next_value_of_STATE_VARIABLE_Info_0_7 = STATE_VARIABLE_Info_39_39;
        ...
        case (MR_Integer) 0:
          {
            *STATE_VARIABLE_Succeeded_6 = STATE_VARIABLE_Succeeded_41_41;
            *STATE_VARIABLE_Info_8 = STATE_VARIABLE_Info_39_39;
          }
          break;
      }
    }
