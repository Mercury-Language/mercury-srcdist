  ...
  MR_Word Targets0_14)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_97 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 482, &KeepGoingBool_22);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 319, &AnalysisRepeat_24);
  ...
  else
  {
    ...
    if ((AbsTargets_111 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 482, &KeepGoingBool_124);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 319, &AnalysisRepeat_126);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(HeadVar__2_2, (MR_Integer) 486, &TrackFlags_44);
