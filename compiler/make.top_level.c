  ...
  MR_Word Targets0_16)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_98 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 686, &KeepGoingBool_24);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 527, &AnalysisRepeat_26);
  ...
  else
  {
    ...
    if ((AbsTargets_112 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 686, &KeepGoingBool_125);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 527, &AnalysisRepeat_127);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(HeadVar__2_2, (MR_Integer) 688, &TrackFlags_44);
