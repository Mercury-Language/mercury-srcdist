  ...
  MR_Word Targets0_12)
{
  ...
  {
    MR_Word MaybeMainTargets_100;

    make__options_file__lookup_main_target_2_p_0(Variables_10, &MaybeMainTargets_100);
    if (((MR_tag((MR_Word) MaybeMainTargets_100)) == (MR_Integer) 0))
    {
      MR_Word Specs_17 = ((MR_Word) ((MR_hl_field(0, MaybeMainTargets_100, (MR_Integer) 0))));
      MR_Word StdErr_18;
    ...
    {
      MR_Word MainTargets_102 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_100, (MR_Integer) 0))));

      if ((MainTargets_102 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_105;
        MR_Word Spec_106;
        MR_Word Var_109;
...

        {
          ...
          MR_hl_field(2, Var_109, 0) = ((MR_Box) (ProgName_14));
        }
        {
          Pieces_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_105, 0) = ((MR_Box) (Var_109));
          MR_hl_field(1, Pieces_105, 1) = ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[4])));
        }
        {
          Spec_106 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Spec_106, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
          MR_hl_field(2, Spec_106, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_106, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_106, 3) = ((MR_Box) (Pieces_105));
        }
        {
          Specs_317 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Specs_317, 0) = ((MR_Box) (Spec_106));
          MR_hl_field(1, Specs_317, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_318);
        parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_318, Globals_8, Specs_317);
      }
      else
      {
        MR_Word AbsTargets_118;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[2]), MainTargets_102, &AbsTargets_118);
        if ((AbsTargets_118 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_19 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_100, (MR_Integer) 0))));
          ...
          mercury__map__init_1_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_file_0), (MR_Word) (&libs__timestamp__libs__timestamp__type_ctor_info_timestamp_0), &TargetTimestamps_32);
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_120, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
            MR_hl_field(0, Var_120, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_8));
            MR_hl_field(0, Var_120, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_120, 3) = ((MR_Box) (ProgName_14));
          }
          Specs_327 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_120, AbsTargets_118);
          mercury__io__stderr_stream_3_p_0(&StdErr_328);
          parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_328, Globals_8, Specs_327);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_129;
    MR_Word AbsTargets_132;

    {
      MaybeTargets0_129 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_129, 0) = ((MR_Box) (Targets0_12));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[8]), Targets0_12, &AbsTargets_132);
    if ((AbsTargets_132 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_145 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_129, (MR_Integer) 0))));
      MR_Word KeepGoingBool_146;
      MR_Word KeepGoing_147;
      MR_Word ModuleIndexMap_148;
      MR_Word DepIndexMap_149;
      MR_Word DepStatusMap_150;
      MR_Word NonDependTargets_151;
      MR_Word ClassifiedTargets_152;
      MR_Integer AnalysisRepeat_154;
      MR_Word ModuleDependencies_155;
      MR_Word FileTimestamps_156;
      MR_Word TargetTimestamps_157;
      MR_Word ErrorFileModules_158;
      MR_Word MakeInfo0_161;
      MR_Word Succeeded_162;
      MR_Word Var_165;
      MR_Box Var_167;
      MR_Word Var_169;
      MR_Box Var_171;
      ...
      MR_Word Var_182;
      MR_Word Var_183;
      MR_Box conv16__MakeInfo_144;
      MR_Box conv15_STATE_VARIABLE_IO_68_185;

      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 662, &KeepGoingBool_146);
      switch (KeepGoingBool_146) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_147 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_147 = (MR_Integer) 1;
          break;
      }
      Var_165 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_1[9]));
      Var_167 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_148 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_148, 0) = ((MR_Box) (Var_165));
        MR_hl_field(0, ModuleIndexMap_148, 1) = ((MR_Box) (Var_167));
        MR_hl_field(0, ModuleIndexMap_148, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      Var_169 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[10]));
      Var_171 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0));
      {
        DepIndexMap_149 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, DepIndexMap_149, 0) = ((MR_Box) (Var_169));
        MR_hl_field(0, DepIndexMap_149, 1) = ((MR_Box) (Var_171));
        MR_hl_field(0, DepIndexMap_149, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      DepStatusMap_150 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_1[11]));
      NonDependTargets_151 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[12]), Targets_145);
      {
        Var_175 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_175, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(0, Var_175, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_14));
        MR_hl_field(0, Var_175, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_175, 3) = ((MR_Box) (Globals_8));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[0]), Var_175, NonDependTargets_151, &ClassifiedTargets_152);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 503, &AnalysisRepeat_154);
      mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), &ModuleDependencies_155);
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[1]), &FileTimestamps_156);
      mercury__map__init_1_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_file_0), (MR_Word) (&libs__timestamp__libs__timestamp__type_ctor_info_timestamp_0), &TargetTimestamps_157);
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ErrorFileModules_158);
      Var_177 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_178 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_179 = make__dependencies__init_cached_indirect_imports_0_f_0();
      Var_180 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
      Var_181 = make__dependencies__init_cached_transitive_foreign_imports_0_f_0();
      Var_182 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__top_level_scalar_common_1[0]), ClassifiedTargets_152);
      Var_183 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
      {
        MakeInfo0_161 = (MR_Word) MR_new_object(MR_Word, (21 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MakeInfo0_161, 0) = ((MR_Box) (ModuleDependencies_155));
        MR_hl_field(0, MakeInfo0_161, 1) = ((MR_Box) (FileTimestamps_156));
        MR_hl_field(0, MakeInfo0_161, 2) = ((MR_Box) (TargetTimestamps_157));
        MR_hl_field(0, MakeInfo0_161, 3) = ((MR_Box) (DetectedGradeFlags_9));
        MR_hl_field(0, MakeInfo0_161, 4) = ((MR_Box) (OptionArgs_11));
        MR_hl_field(0, MakeInfo0_161, 5) = ((MR_Box) (Variables_10));
        MR_hl_field(0, MakeInfo0_161, 6) = ((MR_Box) (ModuleIndexMap_148));
        MR_hl_field(0, MakeInfo0_161, 7) = ((MR_Box) (DepIndexMap_149));
        MR_hl_field(0, MakeInfo0_161, 8) = ((MR_Box) (DepStatusMap_150));
        MR_hl_field(0, MakeInfo0_161, 9) = ((MR_Box) (Var_177));
        MR_hl_field(0, MakeInfo0_161, 10) = ((MR_Box) (Var_178));
        MR_hl_field(0, MakeInfo0_161, 11) = ((MR_Box) (Var_179));
        MR_hl_field(0, MakeInfo0_161, 12) = ((MR_Box) (Var_180));
        MR_hl_field(0, MakeInfo0_161, 13) = ((MR_Box) (Var_181));
        MR_hl_field(0, MakeInfo0_161, 14) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (KeepGoing_147)));
        MR_hl_field(0, MakeInfo0_161, 15) = ((MR_Box) (ErrorFileModules_158));
        MR_hl_field(0, MakeInfo0_161, 16) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_161, 17) = ((MR_Box) (Var_182));
        MR_hl_field(0, MakeInfo0_161, 18) = ((MR_Box) (AnalysisRepeat_154));
        MR_hl_field(0, MakeInfo0_161, 19) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_161, 20) = ((MR_Box) (Var_183));
      }
      make__build__foldl2_maybe_stop_at_error_9_p_0((MR_Word) (&make__top_level_scalar_common_1[0]), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), KeepGoing_147, (MR_Word) (&make__top_level_scalar_common_1[13]), Globals_8, ClassifiedTargets_152, &Succeeded_162, ((MR_Box) (MakeInfo0_161)), &conv16__MakeInfo_144, ((MR_Box) ((MR_Integer) 0)), &conv15_STATE_VARIABLE_IO_68_185);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_162);
    }
    else
    {
      MR_Word Var_124;
...

      {
        ...
        MR_hl_field(0, Var_124, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(0, Var_124, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_16));
        MR_hl_field(0, Var_124, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_124, 3) = ((MR_Box) (ProgName_14));
      }
      Specs_139 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_124, AbsTargets_132);
      mercury__io__stderr_stream_3_p_0(&StdErr_140);
      parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_140, Globals_8, Specs_139);
    }
  }
}
