          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_22, Globals_8, Specs_21);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_46, Globals_8, Specs_45);
            }
            break;
        }
        break;
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeTargets_16)) == (MR_Integer) 0))
    {
      ...
      parse_tree__error_util__write_error_specs_ignore_5_p_0(StdErr_18, Globals_8, Specs_17);
    }
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 666, &KeepGoingBool_20);
