  ...
  MR_Word Targets0_12)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_107 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 504, &AnalysisRepeat_29);
  ...
  else
  {
    ...
    if ((AbsTargets_121 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 663, &KeepGoingBool_135);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 504, &AnalysisRepeat_143);
