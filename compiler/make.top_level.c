  ...
  (env).make__top_level__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 608, &Var_51);
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 607, &Var_52);
  ...
  MR_Word Targets0_12)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_115 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 660, &KeepGoingBool_20);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 501, &AnalysisRepeat_29);
  ...
  else
  {
    ...
    if ((AbsTargets_129 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 660, &KeepGoingBool_143);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 501, &AnalysisRepeat_151);
