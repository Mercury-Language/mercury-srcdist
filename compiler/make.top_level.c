...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__182__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__182__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Targets0_16)
{
  ...
  if ((Targets0_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    make__options_file__lookup_main_target_2_p_0(OptionsVariables_13, &MaybeMainTargets_82);
  ...
  else
  {
    ...
    if ((AbsTargets_112 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      MakeInfo0_140 = make__make_info__init_make_info_11_f_0(OptionsVariables_13, DetectedGradeFlags_12, KeepGoing_126, EnvVarArgs_14, OptionArgs_15, ClassifiedTargetSet_139, AnalysisRepeat_127, Var_150, ModuleIndexMap_131, DepIndexMap_135, DepStatusMap_136);
