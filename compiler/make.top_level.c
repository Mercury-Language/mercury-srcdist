  ...
  MR_Word ArgPack_8)
{
  ...
  if ((NonOptionArgs_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (((MR_tag((MR_Word) MaybeMainTargets_80)) == (MR_Integer) 0))
    {
      ...
      parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(StdErr_18, Globals_7, Specs_17);
    }
    else
    {
      ...
      if ((MainTargets_81 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(StdErr_251, Globals_7, Specs_250);
      }
      else
      {
        ...
        else
        {
          ...
          AbsTargetSpecs_97 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Var_99, AbsTargets_96);
          mercury__one_or_more__det_list_to_one_or_more_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), AbsTargetSpecs_97, &Specs_260);
          mercury__io__stderr_stream_3_p_0(&StdErr_261);
          parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(StdErr_261, Globals_7, Specs_260);
        }
      }
    }
  }
  else
  {
    ...
    else
    {
      ...
      AbsTargetSpecs_102 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Var_104, AbsTargets_113);
      mercury__one_or_more__det_list_to_one_or_more_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), AbsTargetSpecs_102, &Specs_121);
      mercury__io__stderr_stream_3_p_0(&StdErr_122);
      parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(StdErr_122, Globals_7, Specs_121);
    }
  }
}
