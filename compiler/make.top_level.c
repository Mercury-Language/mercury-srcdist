  ...
  (env).make__top_level__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 607, &Var_51);
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 606, &Var_52);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 608, &Var_53);
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 661, &TrackFlags_15);
  ...
  MR_Word Targets0_12)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 659, &KeepGoingBool_20);
    ...
    NonDependTargets_25 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[6]), Targets_19);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&make__top_level_scalar_common_5[1]));
      MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_5));
