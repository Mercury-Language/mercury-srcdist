  ...
  MR_Word Targets0_12)
{
  ...
  {
    MR_Word MaybeMainTargets_88;

    make__options_file__lookup_main_target_2_p_0(Variables_10, &MaybeMainTargets_88);
    if (((MR_tag((MR_Word) MaybeMainTargets_88)) == (MR_Integer) 0))
    {
      MR_Word Specs_17 = ((MR_Word) ((MR_hl_field(0, MaybeMainTargets_88, (MR_Integer) 0))));
      MR_Word StdErr_18;
    ...
    {
      MR_Word MainTargets_90 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_88, (MR_Integer) 0))));

      if ((MainTargets_90 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_93;
        MR_Word Spec_94;
        MR_Word Var_97;
...

        {
          ...
          MR_hl_field(2, Var_97, 0) = ((MR_Box) (ProgName_14));
        }
        {
          Pieces_93 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_93, 0) = ((MR_Box) (Var_97));
          MR_hl_field(1, Pieces_93, 1) = ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[4])));
        }
        {
          Spec_94 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Spec_94, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
          MR_hl_field(2, Spec_94, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_94, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_94, 3) = ((MR_Box) (Pieces_93));
        }
        {
          Specs_290 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Specs_290, 0) = ((MR_Box) (Spec_94));
          MR_hl_field(1, Specs_290, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_291);
        parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_291, Globals_8, Specs_290);
      }
      else
      {
        MR_Word AbsTargets_106;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[1]), MainTargets_90, &AbsTargets_106);
        if ((AbsTargets_106 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_19 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_88, (MR_Integer) 0))));
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_108, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
            MR_hl_field(0, Var_108, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_7));
            MR_hl_field(0, Var_108, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_108, 3) = ((MR_Box) (ProgName_14));
          }
          Specs_300 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_108, AbsTargets_106);
          mercury__io__stderr_stream_3_p_0(&StdErr_301);
          parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_301, Globals_8, Specs_300);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_117;
    MR_Word AbsTargets_120;

    {
      MaybeTargets0_117 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_117, 0) = ((MR_Box) (Targets0_12));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[6]), Targets0_12, &AbsTargets_120);
    if ((AbsTargets_120 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_133 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_117, (MR_Integer) 0))));
      MR_Word KeepGoingBool_134;
      MR_Word KeepGoing_135;
      MR_Word ModuleIndexMap_136;
      MR_Word DepIndexMap_137;
      MR_Word DepStatusMap_138;
      MR_Word NonDependTargets_139;
      MR_Word ClassifiedTargets_140;
      MR_Integer AnalysisRepeat_142;
      MR_Word ModuleDependencies_143;
      MR_Word FileTimestamps_144;
      MR_Word TargetTimestamps_145;
      MR_Word ErrorFileModules_146;
      MR_Word MakeInfo0_149;
      MR_Word Succeeded_150;
      MR_Word Var_153;
      MR_Box Var_155;
      MR_Word Var_157;
      MR_Box Var_159;
      ...
      MR_Word Var_170;
      MR_Word Var_171;
      MR_Word _MakeInfo_132;

      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 662, &KeepGoingBool_134);
      switch (KeepGoingBool_134) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_135 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_135 = (MR_Integer) 1;
          break;
      }
      Var_153 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_1[7]));
      Var_155 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_136 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_136, 0) = ((MR_Box) (Var_153));
        MR_hl_field(0, ModuleIndexMap_136, 1) = ((MR_Box) (Var_155));
        MR_hl_field(0, ModuleIndexMap_136, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      Var_157 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[8]));
      Var_159 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_with_module_index_0));
      {
        DepIndexMap_137 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, DepIndexMap_137, 0) = ((MR_Box) (Var_157));
        MR_hl_field(0, DepIndexMap_137, 1) = ((MR_Box) (Var_159));
        MR_hl_field(0, DepIndexMap_137, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      DepStatusMap_138 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_1[9]));
      NonDependTargets_139 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[10]), Targets_133);
      {
        Var_163 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_163, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(0, Var_163, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_13));
        MR_hl_field(0, Var_163, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_163, 3) = ((MR_Box) (Globals_8));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), Var_163, NonDependTargets_139, &ClassifiedTargets_140);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 503, &AnalysisRepeat_142);
      mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), &ModuleDependencies_143);
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[0]), &FileTimestamps_144);
      TargetTimestamps_145 = make__util__init_target_file_timestamps_0_f_0();
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ErrorFileModules_146);
      Var_165 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_166 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_167 = make__dependencies__init_cached_indirect_imports_0_f_0();
      Var_168 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
      Var_169 = make__dependencies__init_cached_transitive_foreign_imports_0_f_0();
      Var_170 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_top_target_file_0), ClassifiedTargets_140);
      Var_171 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
      {
        MakeInfo0_149 = (MR_Word) MR_new_object(MR_Word, (21 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MakeInfo0_149, 0) = ((MR_Box) (ModuleDependencies_143));
        MR_hl_field(0, MakeInfo0_149, 1) = ((MR_Box) (FileTimestamps_144));
        MR_hl_field(0, MakeInfo0_149, 2) = ((MR_Box) (TargetTimestamps_145));
        MR_hl_field(0, MakeInfo0_149, 3) = ((MR_Box) (DetectedGradeFlags_9));
        MR_hl_field(0, MakeInfo0_149, 4) = ((MR_Box) (OptionArgs_11));
        MR_hl_field(0, MakeInfo0_149, 5) = ((MR_Box) (Variables_10));
        MR_hl_field(0, MakeInfo0_149, 6) = ((MR_Box) (ModuleIndexMap_136));
        MR_hl_field(0, MakeInfo0_149, 7) = ((MR_Box) (DepIndexMap_137));
        MR_hl_field(0, MakeInfo0_149, 8) = ((MR_Box) (DepStatusMap_138));
        MR_hl_field(0, MakeInfo0_149, 9) = ((MR_Box) (Var_165));
        MR_hl_field(0, MakeInfo0_149, 10) = ((MR_Box) (Var_166));
        MR_hl_field(0, MakeInfo0_149, 11) = ((MR_Box) (Var_167));
        MR_hl_field(0, MakeInfo0_149, 12) = ((MR_Box) (Var_168));
        MR_hl_field(0, MakeInfo0_149, 13) = ((MR_Box) (Var_169));
        MR_hl_field(0, MakeInfo0_149, 14) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (KeepGoing_135)));
        MR_hl_field(0, MakeInfo0_149, 15) = ((MR_Box) (ErrorFileModules_146));
        MR_hl_field(0, MakeInfo0_149, 16) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_149, 17) = ((MR_Box) (Var_170));
        MR_hl_field(0, MakeInfo0_149, 18) = ((MR_Box) (AnalysisRepeat_142));
        MR_hl_field(0, MakeInfo0_149, 19) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_149, 20) = ((MR_Box) (Var_171));
      }
      make__build__foldl2_make_top_targets_8_p_0(KeepGoing_135, Globals_8, ClassifiedTargets_140, &Succeeded_150, MakeInfo0_149, &_MakeInfo_132);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_150);
    }
    else
    {
      MR_Word Var_112;
...

      {
        ...
        MR_hl_field(0, Var_112, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(0, Var_112, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_14));
        MR_hl_field(0, Var_112, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_112, 3) = ((MR_Box) (ProgName_14));
      }
      Specs_127 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_112, AbsTargets_120);
      mercury__io__stderr_stream_3_p_0(&StdErr_128);
      parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_128, Globals_8, Specs_127);
    }
  }
}
