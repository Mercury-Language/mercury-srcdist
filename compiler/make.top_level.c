...
make__top_level__IntroducedFrom__pred__report_any_absolute_targets__201__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__top_level__IntroducedFrom__pred__report_any_absolute_targets__201__1_1_p_0(((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Targets0_12)
{
  ...
  {
    MR_Word MaybeMainTargets_98;

    make__options_file__lookup_main_target_2_p_0(Variables_10, &MaybeMainTargets_98);
    if (((MR_tag((MR_Word) MaybeMainTargets_98)) == (MR_Integer) 0))
    {
      MR_Word Specs_17 = ((MR_Word) ((MR_hl_field(0, MaybeMainTargets_98, (MR_Integer) 0))));
      MR_Word StdErr_18;
    ...
    {
      MR_Word MainTargets_100 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_98, (MR_Integer) 0))));

      if ((MainTargets_100 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word Pieces_103;
        MR_Word Spec_104;
        MR_Word Var_107;
...

        {
          ...
          MR_hl_field(3, Var_107, 1) = ((MR_Box) (ProgName_14));
        }
        {
          Pieces_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Pieces_103, 0) = ((MR_Box) (Var_107));
          MR_hl_field(1, Pieces_103, 1) = ((MR_Box) (MR_mkword(1, &make__top_level_scalar_common_2[8])));
        }
        {
          Spec_104 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Spec_104, 0) = ((MR_Box) ((MR_String) "predicate \140make.top_level.get_main_target_if_needed\'/4"));
          MR_hl_field(2, Spec_104, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_104, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_104, 3) = ((MR_Box) (Pieces_103));
        }
        {
          Specs_309 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Specs_309, 0) = ((MR_Box) (Spec_104));
          MR_hl_field(1, Specs_309, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__io__stderr_stream_3_p_0(&StdErr_310);
        parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_310, Globals_8, Specs_309);
      }
      else
      {
        MR_Word AbsTargets_116;

        mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[2]), MainTargets_100, &AbsTargets_116);
        if ((AbsTargets_116 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Targets_19 = ((MR_Word) ((MR_hl_field(1, MaybeMainTargets_98, (MR_Integer) 0))));
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_118, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
            MR_hl_field(0, Var_118, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_8));
            MR_hl_field(0, Var_118, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_118, 3) = ((MR_Box) (ProgName_14));
          }
          Specs_319 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_118, AbsTargets_116);
          mercury__io__stderr_stream_3_p_0(&StdErr_320);
          parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_320, Globals_8, Specs_319);
        }
      }
    }
  }
  ...
  {
    MR_Word MaybeTargets0_127;
    MR_Word AbsTargets_130;

    {
      MaybeTargets0_127 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeTargets0_127, 0) = ((MR_Box) (Targets0_12));
    }
    mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[8]), Targets0_12, &AbsTargets_130);
    if ((AbsTargets_130 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Targets_143 = ((MR_Word) ((MR_hl_field(1, MaybeTargets0_127, (MR_Integer) 0))));
      MR_Word KeepGoingBool_144;
      MR_Word KeepGoing_145;
      MR_Word ModuleIndexMap_146;
      MR_Word DepIndexMap_147;
      MR_Word DepStatusMap_148;
      MR_Word NonDependTargets_149;
      MR_Word ClassifiedTargets_150;
      MR_Integer AnalysisRepeat_152;
      MR_Word ModuleDependencies_153;
      MR_Word FileTimestamps_154;
      MR_Word SearchFileNameCache_155;
      MR_Word ErrorFileModules_156;
      MR_Word MakeInfo0_159;
      MR_Word Succeeded_160;
      MR_Word Var_163;
      MR_Box Var_165;
      MR_Word Var_167;
      MR_Box Var_169;
      ...
      MR_Word Var_180;
      MR_Word Var_181;
      MR_Box conv16__MakeInfo_142;
      MR_Box conv15_STATE_VARIABLE_IO_68_183;

      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 662, &KeepGoingBool_144);
      switch (KeepGoingBool_144) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          KeepGoing_145 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          KeepGoing_145 = (MR_Integer) 1;
          break;
      }
      Var_163 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_module_index_0), (MR_Word) (&make__top_level_scalar_common_1[9]));
      Var_165 = mercury__version_array__empty_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
      {
        ModuleIndexMap_146 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ModuleIndexMap_146, 0) = ((MR_Box) (Var_163));
        MR_hl_field(0, ModuleIndexMap_146, 1) = ((MR_Box) (Var_165));
        MR_hl_field(0, ModuleIndexMap_146, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      Var_167 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__deps_set__make__deps_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_1[10]));
      Var_169 = mercury__version_array__empty_0_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0));
      {
        DepIndexMap_147 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, DepIndexMap_147, 0) = ((MR_Box) (Var_167));
        MR_hl_field(0, DepIndexMap_147, 1) = ((MR_Box) (Var_169));
        MR_hl_field(0, DepIndexMap_147, 2) = ((MR_Box) ((MR_Integer) 0));
      }
      DepStatusMap_148 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), (MR_Word) (&make__top_level_scalar_common_1[11]));
      NonDependTargets_149 = mercury__list__filter_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[12]), Targets_143);
      {
        Var_173 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_173, 0) = ((MR_Box) (&make__top_level_scalar_common_6[0]));
        MR_hl_field(0, Var_173, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_14));
        MR_hl_field(0, Var_173, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_173, 3) = ((MR_Box) (Globals_8));
      }
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[0]), Var_173, NonDependTargets_149, &ClassifiedTargets_150);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 503, &AnalysisRepeat_152);
      mercury__map__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), &ModuleDependencies_153);
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__top_level_scalar_common_1[1]), &FileTimestamps_154);
      mercury__map__init_1_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_module_name_ext_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &SearchFileNameCache_155);
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ErrorFileModules_156);
      Var_175 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_176 = make__dependencies__init_cached_direct_imports_0_f_0();
      Var_177 = make__dependencies__init_cached_indirect_imports_0_f_0();
      Var_178 = make__dependencies__init_cached_transitive_dependencies_0_f_0();
      Var_179 = make__dependencies__init_cached_transitive_foreign_imports_0_f_0();
      Var_180 = mercury__set__list_to_set_1_f_0((MR_Word) (&make__top_level_scalar_common_1[0]), ClassifiedTargets_150);
      Var_181 = parse_tree__read_modules__init_have_read_module_maps_0_f_0();
      {
        MakeInfo0_159 = (MR_Word) MR_new_object(MR_Word, (21 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MakeInfo0_159, 0) = ((MR_Box) (ModuleDependencies_153));
        MR_hl_field(0, MakeInfo0_159, 1) = ((MR_Box) (FileTimestamps_154));
        MR_hl_field(0, MakeInfo0_159, 2) = ((MR_Box) (SearchFileNameCache_155));
        MR_hl_field(0, MakeInfo0_159, 3) = ((MR_Box) (DetectedGradeFlags_9));
        MR_hl_field(0, MakeInfo0_159, 4) = ((MR_Box) (OptionArgs_11));
        MR_hl_field(0, MakeInfo0_159, 5) = ((MR_Box) (Variables_10));
        MR_hl_field(0, MakeInfo0_159, 6) = ((MR_Box) (ModuleIndexMap_146));
        MR_hl_field(0, MakeInfo0_159, 7) = ((MR_Box) (DepIndexMap_147));
        MR_hl_field(0, MakeInfo0_159, 8) = ((MR_Box) (DepStatusMap_148));
        MR_hl_field(0, MakeInfo0_159, 9) = ((MR_Box) (Var_175));
        MR_hl_field(0, MakeInfo0_159, 10) = ((MR_Box) (Var_176));
        MR_hl_field(0, MakeInfo0_159, 11) = ((MR_Box) (Var_177));
        MR_hl_field(0, MakeInfo0_159, 12) = ((MR_Box) (Var_178));
        MR_hl_field(0, MakeInfo0_159, 13) = ((MR_Box) (Var_179));
        MR_hl_field(0, MakeInfo0_159, 14) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) (KeepGoing_145)));
        MR_hl_field(0, MakeInfo0_159, 15) = ((MR_Box) (ErrorFileModules_156));
        MR_hl_field(0, MakeInfo0_159, 16) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_159, 17) = ((MR_Box) (Var_180));
        MR_hl_field(0, MakeInfo0_159, 18) = ((MR_Box) (AnalysisRepeat_152));
        MR_hl_field(0, MakeInfo0_159, 19) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, MakeInfo0_159, 20) = ((MR_Box) (Var_181));
      }
      make__build__foldl2_maybe_stop_at_error_9_p_0((MR_Word) (&make__top_level_scalar_common_1[0]), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), KeepGoing_145, (MR_Word) (&make__top_level_scalar_common_1[13]), Globals_8, ClassifiedTargets_150, &Succeeded_160, ((MR_Box) (MakeInfo0_159)), &conv16__MakeInfo_142, ((MR_Box) ((MR_Integer) 0)), &conv15_STATE_VARIABLE_IO_68_183);
      parse_tree__module_cmds__maybe_set_exit_status_3_p_0(Succeeded_160);
    }
    else
    {
      MR_Word Var_122;
...

      {
        ...
        MR_hl_field(0, Var_122, 0) = ((MR_Box) (&make__top_level_scalar_common_6[1]));
        MR_hl_field(0, Var_122, 1) = ((MR_Box) (make__top_level__make_process_compiler_args_7_p_0_16));
        MR_hl_field(0, Var_122, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_122, 3) = ((MR_Box) (ProgName_14));
      }
      Specs_137 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_122, AbsTargets_130);
      mercury__io__stderr_stream_3_p_0(&StdErr_138);
      parse_tree__write_error_spec__write_error_specs_5_p_0(StdErr_138, Globals_8, Specs_137);
    }
  }
}
