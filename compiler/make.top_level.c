  ...
  (env).make__top_level__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 611, &Var_52);
        ...
        else
        {
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 612, &Var_54);
  ...
  MR_Word Targets0_12)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_92 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 664, &KeepGoingBool_20);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 505, &AnalysisRepeat_22);
          ...
          Var_54 = make__util__init_target_file_timestamps_0_f_0();
  ...
  else
  {
    ...
    if ((AbsTargets_106 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 664, &KeepGoingBool_119);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 505, &AnalysisRepeat_121);
      ...
      Var_144 = make__util__init_target_file_timestamps_0_f_0();
