  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 686, &TrackFlags_17);
  ...
  MR_Word Targets0_16)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_97 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 684, &KeepGoingBool_24);
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 525, &AnalysisRepeat_26);
  ...
  else
  {
    ...
    if ((AbsTargets_111 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 684, &KeepGoingBool_124);
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 525, &AnalysisRepeat_126);
