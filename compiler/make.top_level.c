  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 614, &Var_56);
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 613, &Var_57);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 615, &Var_58);
