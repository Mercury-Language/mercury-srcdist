  ...
  MR_Word Targets0_14)
{
    ...
    else
    {
      ...
      else
      {
        ...
        if ((AbsTargets_97 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          ForwardDI_30 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__index_set__make__index_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_4[2]));
  ...
  else
  {
    ...
    if ((AbsTargets_111 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      ForwardDI_132 = mercury__version_hash_table__init_default_1_f_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_with_module_index_0), (MR_Word) (&make__index_set__make__index_set__type_ctor_info_dependency_file_index_0), (MR_Word) (&make__top_level_scalar_common_4[7]));
