  ...
  (env).make__top_level__classify_target_2_4_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 602, &Var_51);
        ...
        else
        {
          ...
          libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 601, &Var_52);
          ...
          else
          {
            ...
            libs__globals__lookup_string_option_3_p_0((env).make__top_level__classify_target_2_4_p_0_env_0__Globals_5, (MR_Integer) 603, &Var_53);
  ...
  MR_Word Targets0_12)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 654, &KeepGoingBool_20);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 497, &AnalysisRepeat_29);
