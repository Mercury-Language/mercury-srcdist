  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, STATE_VARIABLE_ProcInfo_0_41, &VarTable_16);
  switch (RunType_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        GoalExpr1_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_17, (MR_Integer) 0))));
        GoalInfo1_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_17, (MR_Integer) 1))));
        {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), StoreAllocInfo_37, 0) = ((MR_Box) (StackSlots_34));
    MR_hl_field(MR_mktag(0), StoreAllocInfo_37, 1) = ((MR_Box) (VarTable_16));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word RegType_25;
          MR_Word VarTable_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 1))));
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_42, Var_14, &VarType_44);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word VarTable_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 1))));
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_45, Var_20, &VarType_47);
