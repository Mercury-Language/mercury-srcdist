        ...
        case (MR_Integer) 6:
          {
            ...
            ll_backend__store_alloc__store_alloc_in_goal_8_p_0(Else0_28, &Else_41, STATE_VARIABLE_Liveness_0_78, &_Liveness2_42, STATE_VARIABLE_LastLocns_0_80, &LastLocnsElse_43, ResumeVars0_14, StoreAllocInfo_16);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (LastLocnsElse_43));
    ...
    case (MR_Integer) 0:
      {
        ...
        mercury__map__keys_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), AdvisoryStoreMap_31, &FollowKeys_45);
        ...
        mercury__map__keys_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), STATE_VARIABLE_StoreMap_15_50, &StoreVars_46);
        mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), &SeenLvals0_47);
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_45, Var_14, &VarType_47);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MR_Word FloatRegType_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 2))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_48, Var_20, &VarType_50);
