  ...
  MR_Word * STATE_VARIABLE_ProcInfo_41)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, STATE_VARIABLE_ProcInfo_0_40, &VarTable_16);
  switch (RunType_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 301, &FloatRegs_34);
  switch (FloatRegs_34) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  {
    StoreAllocInfo_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), StoreAllocInfo_36, 0) = ((MR_Box) (StackSlots_33));
    MR_hl_field(MR_mktag(0), StoreAllocInfo_36, 1) = ((MR_Box) (VarTable_16));
    MR_hl_field(MR_mktag(0), StoreAllocInfo_36, 2) = (MR_Box) ((MR_Unsigned) (FloatRegType_35));
  }
