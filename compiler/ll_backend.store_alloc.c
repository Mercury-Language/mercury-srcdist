...
MR_decl_label9(ll_backend__store_alloc__allocate_store_maps_5_0, 15,16,18,17,21,23,24,25,27)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module12)
	...
	MR_init_label9(ll_backend__store_alloc__allocate_store_maps_5_0,15,16,18,17,21,23,24,25,27)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,25)
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i27);
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
