...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_2[1]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_2[1]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_2[0]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_2[0]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 279, &FloatRegs_34);
    switch (FloatRegs_34) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_85 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_52, (MR_Integer) 2))) & (MR_Integer) 3);
  ...
  MR_Integer * N_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer N1_9 = (MR_Integer) ((MR_Unsigned) N0_7 + (MR_Unsigned) (MR_Integer) 1);
