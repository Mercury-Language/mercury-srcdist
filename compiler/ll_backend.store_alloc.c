...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 274, &FloatRegs_34);
    switch (FloatRegs_34) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  MR_Word StoreAllocInfo_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ResumeGoal_28, (MR_Integer) 1)));
    }
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_52, (MR_Integer) 2)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Locn_24;
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 2)));
        ...
        else
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 2)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Locn_25, (MR_Integer) 0)));
