  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word RegType_25;
          MR_Word VarTable_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 1))));
          MR_Word FloatRegType_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 2))) & (MR_Integer) 1);
