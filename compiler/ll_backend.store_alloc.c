...
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 18,19,20,15,23,24,25,22,32,28)
MR_decl_label5(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 33,27,37,38,36)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module7)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,18,19,20,15,23,24,25,22,32,28)
	MR_init_label5(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,33,27,37,38,36)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,27)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i36);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,37)
	...
	MR_r1 = MR_r3;
	MR_np_call_localret_ent(ll_backend__store_alloc__merge_last_locations_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i38);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
