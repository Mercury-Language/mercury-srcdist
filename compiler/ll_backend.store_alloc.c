...
MR_decl_label2(__Unify___ll_backend__store_alloc__store_alloc_info_0_0, 2,1)
MR_decl_label2(__Compare___ll_backend__store_alloc__store_alloc_info_0_0, 3,7)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module15)
	...
	MR_init_label2(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___ll_backend__store_alloc__store_alloc_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_module__module_info_0_0,
		__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i2);
MR_def_label(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module16)
	...
	MR_init_label2(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___ll_backend__store_alloc__store_alloc_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_module__module_info_0_0,
		__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i3);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i7);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, stack_slot);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
