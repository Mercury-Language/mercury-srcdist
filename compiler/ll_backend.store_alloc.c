...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 270, &FloatRegs_34);
    switch (FloatRegs_34) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  MR_Word StoreAllocInfo_8)
{
  ...
  else
  {
    ...
    if ((ResumeGoal_28 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Word * STATE_VARIABLE_StoreMap_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = (Locn_25 == (MR_Word) ((MR_Integer) 0));
      if (!(succeeded))
...
ll_backend__store_alloc__merge_last_locations_2_p_0(
  ...
  MR_Word * LastLocns_4)
{
  if ((LastLocnsList_3 == (MR_Word) ((MR_Integer) 0)))
  {
