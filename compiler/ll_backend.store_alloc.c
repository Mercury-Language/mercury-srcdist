...
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 114,7,6,9,4,12,13,11,16,17)
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 18,19,20,15,23,24,25,22,32,28)
MR_decl_label6(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 33,27,37,38,36,40)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module8)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,114,7,6,9,4,12,13,11,16,17)
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,18,19,20,15,23,24,25,22,32,28)
	MR_init_label6(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,33,27,37,38,36,40)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_goal_2_9_0)
	...
	if (!((((((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 0)) || (MR_tag(MR_r1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_r1) == MR_mktag((MR_Integer) 1))) || (MR_tag(MR_r1) == MR_mktag((MR_Integer) 0))))) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i114);
	}
	MR_r4 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
