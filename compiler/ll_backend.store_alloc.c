...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__store_alloc_scalar_common_2[2], &Var_11, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_12_12 = (MR_Word) &ll_backend__store_alloc_scalar_common_2[2];
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__2_2 = Vars_15;
          MR_Integer next_value_of_STATE_VARIABLE_N_0_3 = STATE_VARIABLE_N_30_30;
          MR_Word next_value_of_STATE_VARIABLE_SeenLocns_0_4 = STATE_VARIABLE_SeenLocns_32_32;
          MR_Word next_value_of_STATE_VARIABLE_StoreMap_0_5 = STATE_VARIABLE_StoreMap_31_31;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__2_2 = Vars_21;
          MR_Integer next_value_of_STATE_VARIABLE_N_0_3 = STATE_VARIABLE_N_36_36;
          MR_Word next_value_of_STATE_VARIABLE_SeenLocns_0_5 = STATE_VARIABLE_SeenLocns_38_38;
          MR_Word next_value_of_STATE_VARIABLE_StoreMap_0_7 = STATE_VARIABLE_StoreMap_37_37;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_StoreMap_0_3 = STATE_VARIABLE_StoreMap_15_15;
