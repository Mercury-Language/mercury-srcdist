...
MR_decl_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 66,3,5,4,8,10,12,7,16,18)
MR_decl_label7(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 19,15,14,22,24,25,26)
MR_decl_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0, 66,3,4,8,10,7,12,16,18,19)
MR_decl_label7(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0, 17,15,22,23,25,5,27)
...
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0, 14,17,15,19,20,21,22,23,24,25)
MR_decl_label3(ll_backend__store_alloc__store_alloc_in_goal_8_0, 26,27,12)
...
MR_decl_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0, 23,3,5,4,7)
MR_decl_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0, 18,5,6)
MR_decl_label4(__Unify___ll_backend__store_alloc__store_alloc_info_0_0, 4,6,8,1)
MR_decl_label5(__Compare___ll_backend__store_alloc__store_alloc_info_0_0, 3,2,5,9,38)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module0)
	...
	MR_init_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0,18,5,6)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__store_alloc__initial_last_locns_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__store_alloc__initial_last_locns_1_0_i18);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_np_tailcall_ent(fn__map__init_0_0);
MR_def_label(fn__ll_backend__store_alloc__initial_last_locns_1_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(fn__ll_backend__store_alloc__initial_last_locns_1_0,5)
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		fn__ll_backend__store_alloc__initial_last_locns_1_0_i6);
MR_def_label(fn__ll_backend__store_alloc__initial_last_locns_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module2)
	...
	MR_init_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,23,3,5,4,7)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,5)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0_i23);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module4)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,66,3,4,8,10,7,12,16,18,19)
	MR_init_label7(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,17,15,22,23,25,5,27)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,3)
	...
	MR_sv(8) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(8);
	MR_r3 = MR_tempr1;
	MR_r4 = MR_sv(3);
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i4);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
	...
	MR_r2 = MR_sv(2);
	MR_sv(9) = MR_r1;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i7);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,8)
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(set__member_2_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i10);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i5);
	}
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(9),1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i12);
	}
	MR_r1 = MR_tfield(1, MR_sv(9), 0);
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i22);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(1);
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i15);
	}
	MR_sv(6) = MR_r3;
	MR_sv(2) = MR_r2;
	...
	MR_np_call_localret_ent(parse_tree__prog_data__lookup_var_type_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i16);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,16)
	...
	MR_np_call_localret_ent(fn__parse_tree__builtin_lib_types__float_type_0_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i18);
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i17);
	}
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_r1 = (MR_Integer) 1;
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,17)
	...
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i22);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(ll_backend__store_alloc__next_free_reg_4_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i23);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,23)
	...
	MR_np_call_localret_ent(map__det_update_4_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i25);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_r2 = MR_sv(6);
	MR_sv(6) = MR_r1;
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i27);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,5)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i27);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i66);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module5)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,66,3,5,4,8,10,12,7,16,18)
	MR_init_label7(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,19,15,14,22,24,25,26)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,5)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i66);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i24);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,16)
	...
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(fn__parse_tree__builtin_lib_types__float_type_0_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i18);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,19)
	...
	MR_r2 = MR_sv(2);
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i14);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r4;
	MR_sv(6) = MR_r2;
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,25)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i26);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module6)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0,14,17,15,19,20,21,22,23,24,25)
	MR_init_label3(ll_backend__store_alloc__store_alloc_in_goal_8_0,26,27,12)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,17)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_8_0_i20);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module17)
	...
	MR_init_label4(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,4,6,8,1)
MR_BEGIN_CODE
...
MR_def_label(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,4)
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i6);
MR_def_label(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i1);
	}
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module18)
	...
	MR_init_label5(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, vartypes);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i9);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i38);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__store_alloc__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__store_alloc);
