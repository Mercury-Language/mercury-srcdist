...
{
  {
    ...
    if (ll_backend__store_alloc__succeeded)
      *ll_backend__store_alloc__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word ll_backend__store_alloc__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ll_backend__store_alloc__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word ll_backend__store_alloc__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word ll_backend__store_alloc__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word ll_backend__store_alloc__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word ll_backend__store_alloc__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word ll_backend__store_alloc__Var_10;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__store_alloc_scalar_common_2[1], &ll_backend__store_alloc__Var_10, ((MR_Box) (ll_backend__store_alloc__ArgX1_4)), ((MR_Box) (ll_backend__store_alloc__ArgY1_5)));
        }
        ll_backend__store_alloc__succeeded = (ll_backend__store_alloc__Var_10 == (MR_Integer) 0);
        ll_backend__store_alloc__succeeded = !(ll_backend__store_alloc__succeeded);
        if (ll_backend__store_alloc__succeeded)
          *ll_backend__store_alloc__HeadVar__1_1 = ll_backend__store_alloc__Var_10;
        else
          {
            MR_Word ll_backend__store_alloc__Var_11;

            {
              mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__store_alloc_scalar_common_2[2], &ll_backend__store_alloc__Var_11, ((MR_Box) (ll_backend__store_alloc__ArgX2_6)), ((MR_Box) (ll_backend__store_alloc__ArgY2_7)));
            }
            ll_backend__store_alloc__succeeded = (ll_backend__store_alloc__Var_11 == (MR_Integer) 0);
            ll_backend__store_alloc__succeeded = !(ll_backend__store_alloc__succeeded);
            if (ll_backend__store_alloc__succeeded)
              *ll_backend__store_alloc__HeadVar__1_1 = ll_backend__store_alloc__Var_11;
            else
              {
                MR_Integer ll_backend__store_alloc__Var_17 = (MR_Integer) ll_backend__store_alloc__ArgX3_8;
                MR_Integer ll_backend__store_alloc__Var_18 = (MR_Integer) ll_backend__store_alloc__ArgY3_9;

                {
                  mercury__private_builtin__builtin_compare_int_3_p_0(ll_backend__store_alloc__HeadVar__1_1, ll_backend__store_alloc__Var_17, ll_backend__store_alloc__Var_18);
                }
              }
          }
      }
...
{
  {
    ...
    if (ll_backend__store_alloc__succeeded)
    ...
    else
      {
        ...
        MR_Word ll_backend__store_alloc__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__store_alloc__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ll_backend__store_alloc__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word ll_backend__store_alloc__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word ll_backend__store_alloc__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word ll_backend__store_alloc__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__2_2, (MR_Integer) 2)));

        {
          ll_backend__store_alloc__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &ll_backend__store_alloc_scalar_common_2[1], ((MR_Box) (ll_backend__store_alloc__ArgX1_3)), ((MR_Box) (ll_backend__store_alloc__ArgY1_4)));
        }
        if (ll_backend__store_alloc__succeeded)
          {
            ll_backend__store_alloc__TypeInfo_12_12 = (MR_Word) &ll_backend__store_alloc_scalar_common_2[2];
            {
              ll_backend__store_alloc__succeeded = mercury__builtin__unify_2_p_0(ll_backend__store_alloc__TypeInfo_12_12, ((MR_Box) (ll_backend__store_alloc__ArgX2_5)), ((MR_Box) (ll_backend__store_alloc__ArgY2_6)));
            }
            if (ll_backend__store_alloc__succeeded)
              ll_backend__store_alloc__succeeded = (ll_backend__store_alloc__ArgX3_7 == ll_backend__store_alloc__ArgY3_8);
          }
      }
    return ll_backend__store_alloc__succeeded;
  }
...
{
  {
    ...
    MR_Integer ll_backend__store_alloc__Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__HeadVar__3_3, (MR_Integer) 1)));
    MR_Word ll_backend__store_alloc__Var_38;
    MR_Word ll_backend__store_alloc__Var_39;
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ll_backend__store_alloc__Var_42;
          ...
          {
            ll_backend__store_alloc__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Var_42, 0) = ((MR_Box) (ll_backend__store_alloc__FollowVars_23));
          }
          {
            hlds__hlds_llds__goal_info_set_follow_vars_3_p_0(ll_backend__store_alloc__Var_42, ll_backend__store_alloc__GoalInfo1_22, &ll_backend__store_alloc__GoalInfo2_24);
          }
          {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__store_alloc__Globals_11, (MR_Integer) 262, &ll_backend__store_alloc__FloatRegs_34);
    }
    ...
    {
      ll_backend__store_alloc__store_alloc_in_goal_8_p_0(ll_backend__store_alloc__Goal2_25, &ll_backend__store_alloc__Goal_37, ll_backend__store_alloc__Liveness0_27, &ll_backend__store_alloc__Var_38, ll_backend__store_alloc__LastLocns0_32, &ll_backend__store_alloc__Var_39, ll_backend__store_alloc__ResumeVars_30, ll_backend__store_alloc__StoreAllocInfo_36);
    }
    {
...
{
  {
    ...
    if ((ll_backend__store_alloc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ll_backend__store_alloc__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__Goal0_15, (MR_Integer) 0)));
        ...
        if ((ll_backend__store_alloc__ResumeGoal_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word ll_backend__store_alloc__Var_30;
            ...
            ll_backend__store_alloc__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__store_alloc__ResumeGoal_28, (MR_Integer) 1)));
          }
        {
...
{
  {
    ...
    if ((ll_backend__store_alloc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ll_backend__store_alloc__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__Goal0_17, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ll_backend__store_alloc__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__SubGoal0_44, (MR_Integer) 0)));
          MR_Word ll_backend__store_alloc__Var_49;
          MR_Word ll_backend__store_alloc__Var_51;
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word ll_backend__store_alloc__Var_85;

              ll_backend__store_alloc__succeeded = ((((MR_tag((MR_Word) ll_backend__store_alloc__Reason_52)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__store_alloc__Reason_52, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (ll_backend__store_alloc__succeeded)
                {
                  ll_backend__store_alloc__TermVar_53 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__store_alloc__Reason_52, (MR_Integer) 1)));
                  ll_backend__store_alloc__Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__store_alloc__Reason_52, (MR_Integer) 2)));
                  ll_backend__store_alloc__succeeded = (ll_backend__store_alloc__Var_85 == (MR_Integer) 1);
                }
              if (ll_backend__store_alloc__succeeded)
                {
                  *ll_backend__store_alloc__GoalExpr_11 = ll_backend__store_alloc__GoalExpr0_10;
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word ll_backend__store_alloc__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__Cond0_26, (MR_Integer) 0)));
              MR_Word ll_backend__store_alloc__Var_35;
              MR_Word ll_backend__store_alloc___Liveness2_42;
              MR_Word ll_backend__store_alloc__Var_91;
              ...
              {
                hlds__hlds_llds__goal_info_resume_vars_and_loc_3_p_0(ll_backend__store_alloc__ResumeCond_33, &ll_backend__store_alloc__ResumeCondVars_34, &ll_backend__store_alloc__Var_35);
              }
              {
              ...
              {
                ll_backend__store_alloc__Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Var_91, 0) = ((MR_Box) (ll_backend__store_alloc__LastLocnsElse_43));
                MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Var_91, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                MR_Word base;
        ...
        else
          {
            ...
            if (ll_backend__store_alloc__succeeded)
            ...
            else
              {
                ...
                MR_Word ll_backend__store_alloc__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__StoreAllocInfo_1, (MR_Integer) 1)));
                MR_Word ll_backend__store_alloc__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__StoreAllocInfo_1, (MR_Integer) 2)));
                ...
                if (ll_backend__store_alloc__succeeded)
                ...
                else
                  {
                    ...
                    MR_Word ll_backend__store_alloc__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__StoreAllocInfo_1, (MR_Integer) 0)));
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          MR_Word ll_backend__store_alloc__Var_48;
                          ...
                          {
                            ll_backend__store_alloc__Var_48 = parse_tree__builtin_lib_types__float_type_0_f_0();
                          }
                          {
                            ll_backend__store_alloc__succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ll_backend__store_alloc__VarType_47, ll_backend__store_alloc__Var_48);
                          }
                          if (ll_backend__store_alloc__succeeded)
            ...
            {
              MR_Word ll_backend__store_alloc__next_value_of_HeadVar__2_2 = ll_backend__store_alloc__Vars_15;
              MR_Integer ll_backend__store_alloc__next_value_of_STATE_VARIABLE_N_0_3 = ll_backend__store_alloc__STATE_VARIABLE_N_30_30;
              MR_Word ll_backend__store_alloc__next_value_of_STATE_VARIABLE_SeenLocns_0_4 = ll_backend__store_alloc__STATE_VARIABLE_SeenLocns_32_32;
              MR_Word ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_5 = ll_backend__store_alloc__STATE_VARIABLE_StoreMap_31_31;

              ll_backend__store_alloc__STATE_VARIABLE_StoreMap_0_5 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_5;
              ll_backend__store_alloc__STATE_VARIABLE_SeenLocns_0_4 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_SeenLocns_0_4;
              ll_backend__store_alloc__STATE_VARIABLE_N_0_3 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_N_0_3;
              ll_backend__store_alloc__HeadVar__2_2 = ll_backend__store_alloc__next_value_of_HeadVar__2_2;
            }
            continue;
          }
      }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((ll_backend__store_alloc__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            if (ll_backend__store_alloc__succeeded)
              {
                ...
                MR_Integer ll_backend__store_alloc__Var_27;
                ...
                if (ll_backend__store_alloc__succeeded)
                  {
                    ...
                    ll_backend__store_alloc__Var_27 = ((MR_Integer) (MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Locn_25, (MR_Integer) 1)));
                ...
                else
                  {
                    ...
                    MR_Word ll_backend__store_alloc__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__StoreAllocInfo_1, (MR_Integer) 0)));
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          {
                            ll_backend__store_alloc__Var_51 = parse_tree__builtin_lib_types__float_type_0_f_0();
                          }
                          {
                            ll_backend__store_alloc__succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ll_backend__store_alloc__VarType_50, ll_backend__store_alloc__Var_51);
                          }
                          if (ll_backend__store_alloc__succeeded)
            ...
            /* direct tailcall eliminated */
            {
              MR_Word ll_backend__store_alloc__next_value_of_HeadVar__2_2 = ll_backend__store_alloc__Vars_21;
              MR_Integer ll_backend__store_alloc__next_value_of_STATE_VARIABLE_N_0_3 = ll_backend__store_alloc__STATE_VARIABLE_N_36_36;
              MR_Word ll_backend__store_alloc__next_value_of_STATE_VARIABLE_SeenLocns_0_5 = ll_backend__store_alloc__STATE_VARIABLE_SeenLocns_38_38;
              MR_Word ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_7 = ll_backend__store_alloc__STATE_VARIABLE_StoreMap_37_37;

              ll_backend__store_alloc__STATE_VARIABLE_StoreMap_0_7 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_7;
              ll_backend__store_alloc__STATE_VARIABLE_SeenLocns_0_5 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_SeenLocns_0_5;
              ll_backend__store_alloc__STATE_VARIABLE_N_0_3 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_N_0_3;
              ll_backend__store_alloc__HeadVar__2_2 = ll_backend__store_alloc__next_value_of_HeadVar__2_2;
            }
            continue;
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          ll_backend__store_alloc__Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Var_10, 0) = ((MR_Box) (ll_backend__store_alloc__RegType_5));
          MR_hl_field(MR_mktag(1), ll_backend__store_alloc__Var_10, 1) = ((MR_Box) (ll_backend__store_alloc__N0_7));
        }
        {
          ll_backend__store_alloc__succeeded = mercury__set__member_2_p_0((MR_Word) &hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0, ((MR_Box) (ll_backend__store_alloc__Var_10)), ll_backend__store_alloc__Values_6);
        }
        if (ll_backend__store_alloc__succeeded)
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Integer ll_backend__store_alloc__next_value_of_N0_7 = ll_backend__store_alloc__N1_9;

              ll_backend__store_alloc__N0_7 = ll_backend__store_alloc__next_value_of_N0_7;
            }
            continue;
          }
        else
        ...
        if ((ll_backend__store_alloc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *ll_backend__store_alloc__STATE_VARIABLE_StoreMap_4 = ll_backend__store_alloc__STATE_VARIABLE_StoreMap_0_3;
        else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word ll_backend__store_alloc__next_value_of_HeadVar__1_1 = ll_backend__store_alloc__Vars_10;
              MR_Word ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_3 = ll_backend__store_alloc__STATE_VARIABLE_StoreMap_15_15;

              ll_backend__store_alloc__STATE_VARIABLE_StoreMap_0_3 = ll_backend__store_alloc__next_value_of_STATE_VARIABLE_StoreMap_0_3;
              ll_backend__store_alloc__HeadVar__1_1 = ll_backend__store_alloc__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
...
{
  {
    ...
    if ((ll_backend__store_alloc__LastLocnsList_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word ll_backend__store_alloc__Var_5;
        ...
        *ll_backend__store_alloc__LastLocns_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__store_alloc__LastLocnsList_3, (MR_Integer) 0)));
        ll_backend__store_alloc__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__store_alloc__LastLocnsList_3, (MR_Integer) 1)));
      }
  }
}
...
{
  {
    ...
    if ((ll_backend__store_alloc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ll_backend__store_alloc__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__store_alloc__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__store_alloc__Var_7;
        MR_Word ll_backend__store_alloc__Var_8;

        ll_backend__store_alloc__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__Var_6, (MR_Integer) 0)));
        ll_backend__store_alloc__Lval_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__store_alloc__Var_6, (MR_Integer) 1)));
        {
          ll_backend__store_alloc__Var_7 = ll_backend__store_alloc__initial_last_locns_1_f_0(ll_backend__store_alloc__VarLvals_5);
        }
        {
          ll_backend__store_alloc__Var_8 = mercury__set__make_singleton_set_1_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0, ((MR_Box) (ll_backend__store_alloc__Lval_4)));
        }
        {
          ll_backend__store_alloc__HeadVar__2_2 = mercury__map__det_insert_3_f_0((MR_Word) &ll_backend__store_alloc_scalar_common_1[0], (MR_Word) &ll_backend__store_alloc_scalar_common_1[1], ll_backend__store_alloc__Var_7, ((MR_Box) (ll_backend__store_alloc__Var_3)), ((MR_Box) (ll_backend__store_alloc__Var_8)));
        }
      }
