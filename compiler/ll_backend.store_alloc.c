...
MR_decl_label10(ll_backend__store_alloc__allocate_store_maps_5_0, 15,16,18,20,17,22,24,25,26,28)
...
MR_decl_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 49,3,6,4,10,12,14,8,16,19)
MR_decl_label2(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 20,21)
MR_decl_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0, 38,3,5,9,11,8,13,15,6,17)
...
MR_decl_label4(__Compare___ll_backend__store_alloc__store_alloc_info_0_0, 3,2,5,28)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module4)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,38,3,5,9,11,8,13,15,6,17)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,17)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0_i38);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module5)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,49,3,6,4,10,12,14,8,16,19)
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,6)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i49);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module12)
	...
	MR_init_label10(ll_backend__store_alloc__allocate_store_maps_5_0,15,16,18,20,17,22,24,25,26,28)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module18)
	...
	MR_init_label4(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,3,2,5,28)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i28);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, stack_slot);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
