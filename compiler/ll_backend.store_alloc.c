            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_45, Var_14, &VarType_47);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word VarTable_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 1))));
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_48, Var_20, &VarType_50);
