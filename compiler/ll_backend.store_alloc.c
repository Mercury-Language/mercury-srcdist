...
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0, 11,14,15,18,16,20,21,22)
MR_decl_label7(ll_backend__store_alloc__store_alloc_in_goal_8_0, 23,24,25,26,27,28,13)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 3,46,73,7,6,9,74,12)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 13,78,16,17,18,19,20,76)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 23,24,25,77,32,28,33,79)
MR_decl_label4(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 37,75,40,41)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module7)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0,11,14,15,18,16,20,21,22)
	MR_init_label7(ll_backend__store_alloc__store_alloc_in_goal_8_0,23,24,25,26,27,28,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module8)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,3,46,73,7,6,9,74,12)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,13,78,16,17,18,19,20,76)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,23,24,25,77,32,28,33,79)
	MR_init_label4(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,37,75,40,41)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,77)
	...
	MR_tempr5 = MR_r1;
	MR_r6 = MR_ctfield(3, MR_tempr5, 2);
