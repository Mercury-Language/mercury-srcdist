...
MR_decl_label10(ll_backend__store_alloc__allocate_store_maps_5_0, 2,3,4,5,7,6,10,12,13,14)
MR_decl_label10(ll_backend__store_alloc__allocate_store_maps_5_0, 15,18,19,20,23,17,25,26,28,31)
MR_decl_label1(ll_backend__store_alloc__merge_last_locations_2_0, 3)
MR_decl_label3(ll_backend__store_alloc__next_free_reg_4_0, 13,4,2)
MR_decl_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 70,3,6,4,10,12,14,8,19,21)
MR_decl_label7(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 22,17,16,25,28,29,30)
MR_decl_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0, 67,3,5,9,11,8,13,17,19,20)
MR_decl_label7(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0, 18,16,23,24,26,6,28)
MR_decl_label3(ll_backend__store_alloc__store_alloc_in_cases_8_0, 19,4,6)
MR_decl_label7(ll_backend__store_alloc__store_alloc_in_conj_8_0, 31,5,6,8,4,10,11)
MR_decl_label6(ll_backend__store_alloc__store_alloc_in_disj_8_0, 27,4,6,5,7,8)
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0, 2,3,4,5,6,7,8,9,10,13)
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0, 14,17,15,21,22,23,24,25,26,27)
MR_decl_label3(ll_backend__store_alloc__store_alloc_in_goal_8_0, 28,29,12)
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 3,7,6,9,4,12,13,11,16,17)
MR_decl_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 18,19,20,15,23,24,25,22,30,27)
MR_decl_label5(ll_backend__store_alloc__store_alloc_in_goal_2_9_0, 31,26,35,36,34)
MR_decl_label5(ll_backend__store_alloc__store_alloc_in_par_conj_8_0, 4,3,5,6,8)
MR_decl_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0, 25,3,6,4,9)
MR_decl_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0, 22,9,10)
MR_decl_label4(__Unify___ll_backend__store_alloc__store_alloc_info_0_0, 5,7,9,1)
MR_decl_label5(__Compare___ll_backend__store_alloc__store_alloc_info_0_0, 3,2,6,11,40)
...
MR_decl_static(ll_backend__store_alloc__next_free_reg_4_0)
MR_decl_static(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module0)
	...
	MR_init_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0,22,9,10)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__store_alloc__initial_last_locns_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__store_alloc__initial_last_locns_1_0_i22);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_np_tailcall_ent(fn__map__init_0_0);
MR_def_label(fn__ll_backend__store_alloc__initial_last_locns_1_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module2)
	...
	MR_init_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,25,3,6,4,9)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,6)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0_i25);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module3)
	MR_init_entry1(ll_backend__store_alloc__next_free_reg_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__store_alloc__next_free_reg_4_0);
	MR_init_label3(ll_backend__store_alloc__next_free_reg_4_0,13,4,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'next_free_reg'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__store_alloc__next_free_reg_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(ll_backend__store_alloc__next_free_reg_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(set__member_2_0,
		ll_backend__store_alloc__next_free_reg_4_0_i4);
MR_def_label(ll_backend__store_alloc__next_free_reg_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__next_free_reg_4_0_i2);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = ((MR_Integer) MR_sv(3) + (MR_Integer) 1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(ll_backend__store_alloc__next_free_reg_4_0_i13);
MR_def_label(ll_backend__store_alloc__next_free_reg_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module4)
	MR_init_entry1(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0);
	MR_init_label10(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,67,3,5,9,11,8,13,17,19,20)
	MR_init_label7(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,18,16,23,24,26,6,28)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'store_alloc_handle_conflicts_and_nonreal'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i3);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
	MR_decr_sp_and_return(11);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(6) = MR_r3;
	MR_sv(2) = MR_r4;
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i5);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i9);
	}
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_sv(10) = MR_r1;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i8);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = MR_r1;
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(10);
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(set__member_2_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i11);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i6);
	}
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(10),1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i13);
	}
	MR_r1 = MR_tfield(1, MR_sv(10), 0);
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i23);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(1);
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i16);
	}
	MR_sv(6) = MR_r3;
	MR_sv(2) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i17);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = MR_r1;
	MR_np_call_localret_ent(fn__parse_tree__builtin_lib_types__float_type_0_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i19);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i20);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i18);
	}
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i23);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i23);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(ll_backend__store_alloc__next_free_reg_4_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i24);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i26);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_r2 = MR_sv(6);
	MR_sv(6) = MR_r1;
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i28);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(10);
	MR_r3 = MR_sv(2);
	MR_r2 = MR_r1;
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i28);
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0_i67);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module5)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,70,3,6,4,10,12,14,8,19,21)
	MR_init_label7(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,22,17,16,25,28,29,30)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,6)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i70);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,14)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i28);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,8)
	...
	MR_tempr1 = MR_tfield(0, MR_tempr2, 2);
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i17);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i19);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,21)
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i22);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i17);
	}
	...
	MR_r2 = MR_sv(2);
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i16);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,16)
	...
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(ll_backend__store_alloc__next_free_reg_4_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i25);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r5;
	MR_sv(7) = MR_r3;
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i29);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(5);
	...
	MR_np_call_localret_ent(set__insert_3_0,
		ll_backend__store_alloc__store_alloc_allocate_extras_6_0_i30);
MR_def_label(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module6)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0,2,3,4,5,6,7,8,9,10,13)
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_8_0,14,17,15,21,22,23,24,25,26,27)
	MR_init_label3(ll_backend__store_alloc__store_alloc_in_goal_8_0,28,29,12)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,10)
	...
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_8_0_i12);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,14)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_maybe_get_store_map_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_8_0_i17);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_8_0_i15);
	}
	MR_r3 = MR_r2;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,26)
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_0,
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module7)
	...
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,3,7,6,9,4,12,13,11,16,17)
	MR_init_label10(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,18,19,20,15,23,24,25,22,30,27)
	MR_init_label5(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,31,26,35,36,34)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_goal_2_9_0)
	...
	if (!((((((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 0))) || (MR_tag(MR_r1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_r1) == MR_mktag((MR_Integer) 1))))) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i3);
	}
	MR_r4 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i4);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i11);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i15);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(6) = MR_r4;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i22);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r5;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,25)
	...
	MR_r3 = MR_sv(8);
	MR_decr_sp_and_return(9);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i26);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i27);
	}
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_3_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i30);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r6;
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i31);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i34);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_cases_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i35);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_sv(3) = MR_r2;
	MR_r1 = MR_r3;
	MR_np_call_localret_ent(ll_backend__store_alloc__merge_last_locations_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_9_0_i36);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_9_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ll_backend.store_alloc", 22);
	MR_r2 = (MR_Word) MR_string_const("predicate \140ll_backend.store_alloc.store_alloc_in_goal_2\'/9", 58);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module8)
	...
	MR_init_label7(ll_backend__store_alloc__store_alloc_in_conj_8_0,31,5,6,8,4,10,11)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_conj_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_conj_8_0_i31);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_conj_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module9)
	...
	MR_init_label5(ll_backend__store_alloc__store_alloc_in_par_conj_8_0,4,3,5,6,8)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_par_conj_8_0,6)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__union_2_0,
		ll_backend__store_alloc__store_alloc_in_par_conj_8_0_i8);
MR_def_label(ll_backend__store_alloc__store_alloc_in_par_conj_8_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module10)
	...
	MR_init_label6(ll_backend__store_alloc__store_alloc_in_disj_8_0,27,4,6,5,7,8)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_disj_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_disj_8_0_i27);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_disj_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module11)
	...
	MR_init_label3(ll_backend__store_alloc__store_alloc_in_cases_8_0,19,4,6)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_cases_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_cases_8_0_i19);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_cases_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_decl_entry(ll_backend__follow_vars__find_final_follow_vars_4_0);
MR_decl_entry(ll_backend__follow_vars__find_follow_vars_in_goal_10_0);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module12)
	...
	MR_init_label10(ll_backend__store_alloc__allocate_store_maps_5_0,2,3,4,5,7,6,10,12,13,14)
	MR_init_label10(ll_backend__store_alloc__allocate_store_maps_5_0,15,18,19,20,23,17,25,26,28,31)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,2)
	...
	MR_np_call_localret_ent(ll_backend__liveness__initial_liveness_4_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i3);
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,3)
	...
	MR_np_call_localret_ent(libs__globals__get_trace_level_2_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i4);
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,7)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__allocate_store_maps_5_0_i6);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(9);
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,18)
	...
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(9);
	MR_np_call_localret_ent(ll_backend__follow_vars__find_final_follow_vars_4_0,
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,19)
	...
	MR_np_call_localret_ent(ll_backend__follow_vars__find_follow_vars_in_goal_10_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i20);
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,26)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__allocate_store_maps_5_0_i28);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i31);
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,28)
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__allocate_store_maps_5_0_i31);
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module17)
	...
	MR_init_label4(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,5,7,9,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___ll_backend__store_alloc__store_alloc_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i5);
MR_def_label(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i7);
MR_def_label(__Unify___ll_backend__store_alloc__store_alloc_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___ll_backend__store_alloc__store_alloc_info_0_0_i1);
	}
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module18)
	...
	MR_init_label5(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,3,2,6,11,40)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,2)
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i6);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i40);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i11);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__store_alloc__store_alloc_info_0_0_i40);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___ll_backend__store_alloc__store_alloc_info_0_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__store_alloc__init_threadscope_string_table(void);
#endif
