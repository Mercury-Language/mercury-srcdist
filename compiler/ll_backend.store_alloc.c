...
#line 51 "ll_backend.store_alloc.c"
...
#endif
#line 60 "ll_backend.store_alloc.c"
...
MR_decl_label8(ll_backend__store_alloc__allocate_store_maps_5_0, 2,5,6,7,8,11,4,13)
MR_decl_label8(ll_backend__store_alloc__allocate_store_maps_5_0, 3,14,15,16,18,17,22,24)
MR_decl_label3(ll_backend__store_alloc__allocate_store_maps_5_0, 25,26,28)
...
MR_decl_label8(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 41,3,6,4,10,12,14,8)
MR_decl_label4(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 16,19,20,21)
MR_decl_label8(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0, 29,3,5,9,11,8,13,15)
MR_decl_label2(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0, 6,17)
...
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0, 2,3,4,5,7,8,9,10)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0, 11,14,16,17,20,18,22,23)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0, 24,25,26,27,28,29,30,12)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0, 60,7,6,9,61,12,13,65)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0, 16,17,18,19,20,63,23,24)
MR_decl_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0, 25,64,28,66,31,62,34,35)
MR_decl_label1(ll_backend__store_alloc__store_alloc_in_goal_2_8_0, 59)
...
MR_decl_static(ll_backend__store_alloc__store_alloc_in_goal_2_8_0)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module5)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,29,3,5,9,11,8,13,15)
	MR_init_label2(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,6,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module6)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,41,3,6,4,10,12,14,8)
	MR_init_label4(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,16,19,20,21)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module7)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0,2,3,4,5,7,8,9,10)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0,11,14,16,17,20,18,22,23)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_8_0,24,25,26,27,28,29,30,12)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,8)
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_8_0_i18);
	}
	MR_r3 = MR_r2;
	MR_r1 = MR_sv(11);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_8_0_i23);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,29)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_set_store_map_3_0,
		ll_backend__store_alloc__store_alloc_in_goal_8_0_i30);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_8_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module8)
	MR_init_entry1(ll_backend__store_alloc__store_alloc_in_goal_2_8_0);
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,60,7,6,9,61,12,13,65)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,16,17,18,19,20,63,23,24)
	MR_init_label8(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,25,64,28,66,31,62,34,35)
	MR_init_label1(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,59)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__store_alloc__store_alloc_in_goal_2_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i59);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i59) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i60) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i61) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i62) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i63) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i64) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i65) MR_AND
		MR_LABEL_AP(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i66));
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i6);
	}
	MR_sv(1) = MR_tempr1;
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	}
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_par_conj_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i7);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r6;
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_conj_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i9);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_disj_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i12);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r2;
	MR_sv(1) = MR_r1;
	MR_r1 = MR_r3;
	MR_np_call_localret_ent(ll_backend__store_alloc__merge_last_locations_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i13);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r4;
	...
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_get_resume_point_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i16);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_resume_vars_and_loc_3_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i17);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i18);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r4 = MR_sv(1);
	MR_r5 = MR_sv(2);
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i19);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i20);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_r5;
	...
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_get_resume_point_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i23);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_resume_vars_and_loc_3_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i24);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i25);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 1);
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_goal_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i28);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__ll_backend__store_alloc__this_file_0_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i31);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("store_alloc_in_goal_2: shorthand", 32);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(ll_backend__store_alloc__store_alloc_in_cases_8_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i34);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_r1 = MR_r3;
	MR_np_call_localret_ent(ll_backend__store_alloc__merge_last_locations_2_0,
		ll_backend__store_alloc__store_alloc_in_goal_2_8_0_i35);
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ll_backend__store_alloc__store_alloc_in_goal_2_8_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module13)
	...
	MR_init_label8(ll_backend__store_alloc__allocate_store_maps_5_0,2,5,6,7,8,11,4,13)
	MR_init_label8(ll_backend__store_alloc__allocate_store_maps_5_0,3,14,15,16,18,17,22,24)
	MR_init_label3(ll_backend__store_alloc__allocate_store_maps_5_0,25,26,28)
MR_BEGIN_CODE
