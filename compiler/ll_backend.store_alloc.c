...
#line 55 "ll_backend.store_alloc.c"
...
#endif
#line 64 "ll_backend.store_alloc.c"
...
MR_decl_label8(ll_backend__store_alloc__allocate_store_maps_5_0, 2,5,6,7,8,9,4,10)
MR_decl_label8(ll_backend__store_alloc__allocate_store_maps_5_0, 3,11,12,13,15,14,18,20)
MR_decl_label3(ll_backend__store_alloc__allocate_store_maps_5_0, 21,22,23)
...
MR_decl_label8(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 37,3,5,4,8,10,12,7)
MR_decl_label4(ll_backend__store_alloc__store_alloc_allocate_extras_6_0, 14,15,16,17)
MR_decl_label8(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0, 27,3,4,8,10,7,12,13)
MR_decl_label2(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0, 5,15)
MR_decl_label3(ll_backend__store_alloc__store_alloc_in_cases_8_0, 13,4,5)
MR_decl_label7(ll_backend__store_alloc__store_alloc_in_conj_8_0, 23,5,6,8,4,9,10)
MR_decl_label6(ll_backend__store_alloc__store_alloc_in_disj_8_0, 19,4,6,5,7,8)
...
MR_decl_label5(ll_backend__store_alloc__store_alloc_in_par_conj_8_0, 4,3,5,6,7)
MR_decl_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0, 19,3,5,4,7)
MR_decl_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0, 16,5,6)
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module0)
	...
	MR_init_label3(fn__ll_backend__store_alloc__initial_last_locns_1_0,16,5,6)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__store_alloc__initial_last_locns_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__store_alloc__initial_last_locns_1_0_i16);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_np_tailcall_ent(fn__map__init_0_0);
MR_def_label(fn__ll_backend__store_alloc__initial_last_locns_1_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module3)
	...
	MR_init_label5(ll_backend__store_alloc__store_alloc_remove_nonlive_4_0,19,3,5,4,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module5)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,27,3,4,8,10,7,12,13)
	MR_init_label2(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,5,15)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0,15)
	...
	MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_7_0_i27);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module6)
	...
	MR_init_label8(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,37,3,5,4,8,10,12,7)
	MR_init_label4(ll_backend__store_alloc__store_alloc_allocate_extras_6_0,14,15,16,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module9)
	...
	MR_init_label5(ll_backend__store_alloc__store_alloc_in_par_conj_8_0,4,3,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module10)
	...
	MR_init_label6(ll_backend__store_alloc__store_alloc_in_disj_8_0,19,4,6,5,7,8)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_disj_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_disj_8_0_i19);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_disj_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module11)
	...
	MR_init_label3(ll_backend__store_alloc__store_alloc_in_cases_8_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__store_alloc__store_alloc_in_cases_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__store_alloc__store_alloc_in_cases_8_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__store_alloc__store_alloc_in_cases_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(ll_backend__store_alloc_module12)
	...
	MR_init_label8(ll_backend__store_alloc__allocate_store_maps_5_0,2,5,6,7,8,9,4,10)
	MR_init_label8(ll_backend__store_alloc__allocate_store_maps_5_0,3,11,12,13,15,14,18,20)
	MR_init_label3(ll_backend__store_alloc__allocate_store_maps_5_0,21,22,23)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__store_alloc__allocate_store_maps_5_0,15)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(ll_backend__store_alloc__allocate_store_maps_5_0_i14);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
