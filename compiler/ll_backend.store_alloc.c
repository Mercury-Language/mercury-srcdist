  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 304, &FloatRegs_35);
  switch (FloatRegs_35) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
        ...
        case (MR_Integer) 4:
          {
            ...
            ll_backend__store_alloc__merge_last_locations_2_p_0(LastLocnsList_104, STATE_VARIABLE_LastLocns_81);
            {
              MR_Word base;
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              Var_96 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_52, (MR_Integer) 2))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word StoreMap_32;
        MR_Word FollowKeys_44;
        MR_Word StoreVars_45;
        MR_Word SeenLvals0_46;
        MR_Integer N_47;
        MR_Word SeenLvals_48;
        MR_Word STATE_VARIABLE_StoreMap_15_49;
        MR_Word STATE_VARIABLE_StoreMap_17_51;
        ...
        mercury__map__keys_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), AdvisoryStoreMap_31, &FollowKeys_44);
        ll_backend__store_alloc__store_alloc_remove_nonlive_4_p_0(FollowKeys_44, MappedVars_29, AdvisoryStoreMap_31, &STATE_VARIABLE_StoreMap_15_49);
        mercury__map__keys_2_p_0((MR_Word) (&ll_backend__store_alloc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), STATE_VARIABLE_StoreMap_15_49, &StoreVars_45);
        mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_abs_locn_0), &SeenLvals0_46);
        ll_backend__store_alloc__store_alloc_handle_conflicts_and_nonreal_8_p_0(StoreAllocInfo_15, StoreVars_45, (MR_Integer) 1, &N_47, SeenLvals0_46, &SeenLvals_48, STATE_VARIABLE_StoreMap_15_49, &STATE_VARIABLE_StoreMap_17_51);
        ll_backend__store_alloc__store_alloc_allocate_extras_6_p_0(StoreAllocInfo_15, MappedVars_29, N_47, SeenLvals_48, STATE_VARIABLE_StoreMap_17_51, &StoreMap_32);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word RegType_25;
          MR_Word VarTable_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 1))));
          MR_Word FloatRegType_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), StoreAllocInfo_1, (MR_Integer) 2))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_44, Var_14, &VarType_46);
...
ll_backend__store_alloc__merge_last_locations_2_p_0(
  ...
  MR_Word * LastLocns_4)
{
  if ((LastLocnsList_3 == (MR_Word) ((MR_Unsigned) 0U)))
