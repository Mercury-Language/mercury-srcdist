...
static /* final */ const MR_Box ll_backend__switch_case_scalar_common_1[2][3];

static /* final */ const MR_Box ll_backend__switch_case_scalar_common_2[1][2];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__switch_case_scalar_common_2[0]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_11_11 = (MR_Word) (&ll_backend__switch_case_scalar_common_2[0]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__switch_case_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__switch_case_scalar_common_1[0]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
