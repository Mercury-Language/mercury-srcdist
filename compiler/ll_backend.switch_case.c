    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (CaseLabel_5));
        }
        {
        ...
        Var_20 = mercury__string__f_43_43_2_f_0((MR_String) "goto ", Comment_9);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_17, 1) = ((MR_Box) (Var_20));
        }
        ...
        *Code_6 = CaseCode_10;
        {
          ...
          MR_hl_field(MR_mktag(0), CaseInfo_12, 1) = ((MR_Box) (*Code_6));
  ...
  MR_Word * STATE_VARIABLE_CI_47)
{
  ...
  SwitchVarName_20 = ((MR_String) ((MR_hl_field(MR_mktag(0), Params_12, (MR_Integer) 0))));
  SwitchGoalInfo_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Params_12, (MR_Integer) 1))));
  CodeModel_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_12, (MR_Integer) 2))) & (MR_Integer) 3);
  BranchStart_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Params_12, (MR_Integer) 3))));
  EndLabel_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Params_12, (MR_Integer) 4))));
  MainTaggedConsId_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_13, (MR_Integer) 0))));
  OtherTaggedConsIds_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_13, (MR_Integer) 1))));
  Goal_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_13, (MR_Integer) 3))));
  ...
  ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_37, STATE_VARIABLE_MaybeEnd_0_44, STATE_VARIABLE_MaybeEnd_45, &SaveCode_38, STATE_VARIABLE_CLD_56_56);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (EndLabel_24));
  }
  {
  ...
  Code_40 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), LabelCode_34, Var_63);
  {
    ...
    MR_hl_field(MR_mktag(0), CaseInfo_41, 0) = ((MR_Box) (Comment_33));
    MR_hl_field(MR_mktag(0), CaseInfo_41, 1) = ((MR_Box) (Code_40));
    MR_hl_field(MR_mktag(0), CaseInfo_41, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
  }
