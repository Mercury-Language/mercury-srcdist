...
MR_decl_label5(__Compare___ll_backend__switch_case__case_label_info_0_0, 3,2,5,9,38)
...
MR_BEGIN_MODULE(ll_backend__switch_case_module6)
	...
	MR_init_label5(__Compare___ll_backend__switch_case__case_label_info_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__switch_case__case_label_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__switch_case__case_label_info_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Compare___ll_backend__switch_case__case_label_info_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___ll_backend__switch_case__case_label_info_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__switch_case__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__switch_case);
