...
{
  {
    ...
    MR_Word CaseIncluded_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), CaseInfo_6, (MR_Integer) 2)));
    MR_String _Comment_8 = ((MR_String) (MR_hl_field(MR_mktag(0), CaseInfo_6, (MR_Integer) 0)));
...
{
  {
    MR_Word TypeCtorInfo_25_25 = (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_label_0;
    MR_Word TypeCtorInfo_26_26 = (MR_Word) &ll_backend__switch_case__ll_backend__switch_case__type_ctor_info_case_label_info_0;
    MR_Word CaseInfo0_8;
    MR_String Comment_9;
    MR_Word CaseCode_10;
    ...
    mercury__map__lookup_3_p_0(TypeCtorInfo_25_25, TypeCtorInfo_26_26, STATE_VARIABLE_CaseLabelMap_0_13, ((MR_Box) (CaseLabel_5)), &conv0_CaseInfo0_8);
    ...
    CaseIncluded_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), CaseInfo0_8, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      ...
      case (MR_Integer) 0:
        {
          ...
          *Code_6 = CaseCode_10;
          {
            CaseInfo_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), CaseInfo_12, 0) = ((MR_Box) (Comment_9));
            MR_hl_field(MR_mktag(0), CaseInfo_12, 1) = ((MR_Box) (CaseCode_10));
            MR_hl_field(MR_mktag(0), CaseInfo_12, 2) = ((MR_Box) ((MR_Integer) 1));
          }
          mercury__map__det_update_4_p_0(TypeCtorInfo_25_25, TypeCtorInfo_26_26, ((MR_Box) (CaseLabel_5)), ((MR_Box) (CaseInfo_12)), STATE_VARIABLE_CaseLabelMap_0_13, STATE_VARIABLE_CaseLabelMap_14);
        }
        break;
    }
  }
...
{
  {
    ...
    MR_Word CodeModel_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Params_10, (MR_Integer) 2)));
    ...
    MR_Word Var_61;
    MR_Word Var_62;
    MR_Word Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedCase_11, (MR_Integer) 2)));
    MR_Word Var_27;
    MR_Word Var_29;
    ...
    LabelCode_31 = mercury__cord__singleton_1_f_0(TypeCtorInfo_71_71, ((MR_Box) (Var_48)));
    ...
    GotoEndCode_36 = mercury__cord__singleton_1_f_0(TypeCtorInfo_71_71, ((MR_Box) (Var_55)));
    Var_62 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_71_71, SaveCode_35, GotoEndCode_36);
    Var_61 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_71_71, GoalCode_33, Var_62);
    Var_60 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_71_71, TraceCode_32, Var_61);
    Code_37 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_71_71, LabelCode_31, Var_60);
    {
      CaseInfo_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), CaseInfo_38, 0) = ((MR_Box) (Comment_30));
      MR_hl_field(MR_mktag(0), CaseInfo_38, 1) = ((MR_Box) (Code_37));
      MR_hl_field(MR_mktag(0), CaseInfo_38, 2) = ((MR_Box) ((MR_Integer) 0));
    }
