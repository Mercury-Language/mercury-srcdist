      ...
      case (MR_Integer) 1:
        {
          ...
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 3)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_19;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), AllocData_5, (MR_Integer) 3)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 338, &OptNoReturnCalls_16);
    ...
    ll_backend__live_vars__build_dummy_type_array_4_p_0(ModuleInfo_5, VarTypes_17, &DummyTypeArray_18, &DummyVars_19);
    {
      ...
      MR_hl_field(MR_mktag(0), AllocData_20, 3) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_15) << (MR_Integer) 1)) | (MR_Unsigned) (OptNoReturnCalls_16)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_hl_field(MR_mktag(0), Locn_67, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            }
            break;
          case (MR_Integer) 1:
            {
