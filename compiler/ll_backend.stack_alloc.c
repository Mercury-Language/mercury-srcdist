...
{
  {
    ...
    if ((MaybeDoubleWidthFloats_10 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        *STATE_VARIABLE_FirstFreeSlot_19 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_0_18 + (MR_Unsigned) (MR_Integer) 1);
      }
      switch (MainStack_9) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          STATE_VARIABLE_FirstFreeSlot_24_24 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_0_18 + (MR_Unsigned) (MR_Integer) 1);
        }
        switch (MainStack_9) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
      ...
      if (succeeded)
      {
        ...
        {
          STATE_VARIABLE_FirstFreeSlot_26_26 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_24_24 + (MR_Unsigned) (MR_Integer) 1);
        }
