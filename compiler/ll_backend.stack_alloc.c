    ...
    else
    {
      ...
      if ((MaybeDoubleWidthFloats_2 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_31_48, FirstColour_18, ResVar_38);
        }
        if (succeeded)
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_31_64 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
            succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_31_64, SingleWidthVars_29, ResVar_54);
          }
          if (succeeded)
          {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_31_81 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
            succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_31_81, DoubleWidthVars_28, ResVar_71);
          }
          if (succeeded)
          {
