  ...
  MR_Word * STATE_VARIABLE_ProcInfo_43)
{
  ...
  if (succeeded)
    {
      ...
      MR_hl_field(MR_mktag(1), MaybeDoubleWidthFloats_63, 0) = ((MR_Box) (VarTypes_18));
    }
  else
    MaybeDoubleWidthFloats_63 = (MR_Word) ((MR_Unsigned) 0U);
  FirstFreeSlot_64 = (MR_Integer) ((MR_Unsigned) NumReservedSlots_30 + (MR_Unsigned) 1);
  ...
  ll_backend__stack_alloc__allocate_stack_slots_to_colours_7_p_0(MainStack_39, MaybeDoubleWidthFloats_63, MaybeReservedVarInfo_31, ColourList_37, FirstFreeSlot_64, Var_67, &StackSlots1_40);
