...
MR_decl_static(ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0)
...
{
MR_COMMON(2,2),
MR_ENTRY_AP(ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0),
2,
0,
0
},
...
MR_def_label(ll_backend__stack_alloc__allocate_stack_slots_3_8_0,5)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0);
...
MR_BEGIN_MODULE(ll_backend__stack_alloc_module14)
	MR_init_entry1(ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__allocate_stack_slots_3__290__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__stack_alloc__IntroducedFrom__pred__allocate_stack_slots_3__290__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__stack_alloc__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__stack_alloc);
