...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 333, &OptNoReturnCalls_16);
    ...
    TypeInfo_53_53 = (MR_Word) &ll_backend__stack_alloc_scalar_common_1[0];
    ...
    FirstFreeSlot_63 = (MR_Integer) ((MR_Unsigned) NumReservedSlots_29 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_StackSlots_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_23 = (MR_Integer) ((MR_Unsigned) N0_3 - (MR_Unsigned) (MR_Integer) 1);
    ...
    else
    {
      ...
      if ((MaybeDoubleWidthFloats_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        else
        {
          ...
          STATE_VARIABLE_FirstFreeSlot_25_25 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_0_5 + (MR_Unsigned) (MR_Integer) 1);
        }
        switch (MainStack_1) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            STATE_VARIABLE_FirstFreeSlot_26_45 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_24_43 + (MR_Unsigned) (MR_Integer) 1);
          }
...
{
  {
    ...
    else
    {
      ...
      switch (StackSlotWidth_10) {
        ...
        case (MR_Integer) 1:
          {
            *STATE_VARIABLE_FirstFreeSlot_21 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_0_20 + (MR_Unsigned) (MR_Integer) 2);
          }
          break;
        case (MR_Integer) 0:
          {
            *STATE_VARIABLE_FirstFreeSlot_21 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_FirstFreeSlot_0_20 + (MR_Unsigned) (MR_Integer) 1);
          }
          break;
      }
    }
