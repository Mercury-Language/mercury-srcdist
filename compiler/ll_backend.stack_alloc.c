...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_20, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__stack_alloc__DummyVarArray_23 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__HeadVar__2_2, (MR_Integer) 5)));
          {
            ...
            MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_24, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[0]));
...
{
  {
    ...
    ll_backend__stack_alloc__DummyVarArray_27 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__HeadVar__2_2, (MR_Integer) 5)));
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_28, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[0]));
    ...
    if (ll_backend__stack_alloc__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_25, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[1]));
            ...
            if ((ll_backend__stack_alloc__MaybeDoubleWidthFloats_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_41, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[3]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__stack_alloc__Var_19, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_3[0]));
