  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 361, &OptNoReturnCalls_17);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_41, &VarTable_18);
  {
    Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (VarTable_18));
  }
  {
    AllocData_19 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), AllocData_19, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(MR_mktag(0), AllocData_19, 1) = ((MR_Box) (STATE_VARIABLE_ProcInfo_0_41));
    MR_hl_field(MR_mktag(0), AllocData_19, 2) = ((MR_Box) (HeadVar__2_2));
    MR_hl_field(MR_mktag(0), AllocData_19, 3) = ((MR_Box) (Var_45));
    MR_hl_field(MR_mktag(0), AllocData_19, 4) = (MR_Box) (((((MR_Unsigned) (TypeInfoLiveness_16) << 1)) | (MR_Unsigned) (OptNoReturnCalls_17)));
  }
  ...
  else
  {
    ...
    MR_Word Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeReservedVarInfo_29, (MR_Integer) 0))));

    ResVar_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_49, (MR_Integer) 0))));
  ...
  if (succeeded)
    {
      ...
      MR_hl_field(MR_mktag(1), MaybeDoubleWidthFloats_56, 0) = ((MR_Box) (VarTable_18));
    }
  else
    MaybeDoubleWidthFloats_56 = (MR_Word) ((MR_Unsigned) 0U);
  FirstFreeSlot_57 = (MR_Integer) ((MR_Unsigned) NumReservedSlots_28 + (MR_Unsigned) 1);
  ...
  ll_backend__stack_alloc__allocate_stack_slots_to_colours_7_p_0(MainStack_37, MaybeDoubleWidthFloats_56, MaybeReservedVarInfo_29, ColourList_35, FirstFreeSlot_57, Var_60, &StackSlots1_38);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__stack_alloc__IntroducedFrom__pred__allocate_next_stack_slot__298__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
