...
{
  {
    ...
    if (ll_backend__stack_alloc__succeeded)
      *ll_backend__stack_alloc__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word ll_backend__stack_alloc__Var_4 = (MR_Word) ll_backend__stack_alloc__HeadVar__2_2;
        MR_Word ll_backend__stack_alloc__Var_5 = (MR_Word) ll_backend__stack_alloc__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__stack_alloc_scalar_common_1[3], ll_backend__stack_alloc__HeadVar__1_1, ((MR_Box) (ll_backend__stack_alloc__Var_4)), ((MR_Box) (ll_backend__stack_alloc__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (ll_backend__stack_alloc__succeeded)
      ...
      {
        MR_Word ll_backend__stack_alloc__Var_3 = (MR_Word) ll_backend__stack_alloc__HeadVar__1_1;
        MR_Word ll_backend__stack_alloc__Var_4 = (MR_Word) ll_backend__stack_alloc__HeadVar__2_2;

        {
          ll_backend__stack_alloc__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &ll_backend__stack_alloc_scalar_common_1[3], ((MR_Box) (ll_backend__stack_alloc__Var_3)), ((MR_Box) (ll_backend__stack_alloc__Var_4)));
        }
      }
    return ll_backend__stack_alloc__succeeded;
  }
