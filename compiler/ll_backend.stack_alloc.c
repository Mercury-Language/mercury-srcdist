  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 389, &OptNoReturnCalls_17);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__stack_alloc__IntroducedFrom__pred__allocate_next_stack_slot__299__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
