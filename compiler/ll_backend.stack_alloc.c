...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 334, &OptNoReturnCalls_16);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeDoubleWidthFloats_2 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeReservedVarInfo_3)) == (MR_Integer) 1);
        if (succeeded)
        {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) MaybeReservedVarInfo_11)) == (MR_Integer) 1);
