    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&ll_backend__stack_alloc_scalar_common_2[2]));
          MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (ll_backend__stack_alloc__allocate_stack_slots_to_colours_7_p_0_2));
          MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (VarTable_27));
        }
