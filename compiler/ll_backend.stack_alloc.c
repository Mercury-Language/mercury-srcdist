...
ll_backend__stack_alloc__IntroducedFrom__pred__allocate_next_stack_slot__301__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 671, &OptNoReturnCalls_17);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_41, &VarTable_18);
  {
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_41, &Goal0_22);
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_23, STATE_VARIABLE_ProcInfo_0_41, &STATE_VARIABLE_ProcInfo_1_47);
  ...
  hlds__hlds_proc__proc_info_set_stack_slots_3_p_0(StackSlots_40, STATE_VARIABLE_ProcInfo_2_48, STATE_VARIABLE_ProcInfo_42);
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__stack_alloc__IntroducedFrom__pred__allocate_next_stack_slot__301__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
