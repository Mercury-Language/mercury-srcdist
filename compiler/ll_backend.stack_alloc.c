      ...
      case (MR_Integer) 1:
        {
          ...
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 3)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_19;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), AllocData_5, (MR_Integer) 3)));
    ...
    else
    {
      ...
      if ((MaybeDoubleWidthFloats_2 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        switch (MainStack_1) {
          ...
          case (MR_Integer) 0:
            {
              Locn_67 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 1:
            {
              Locn_67 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
