...
MR_def_static(fn__erl_backend__erl_call_gen__erl_gen_simple_expr_3_0)
	...
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	MR_tfield(3, MR_tempr1, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr1, 1) = MR_tfield(2, MR_r3, 0);
...
MR_def_label(erl_backend__erl_call_gen__erl_gen_ordinary_pragma_foreign_code_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(8) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, foreign_arg);
	MR_r1 = MR_sv(8);
...
MR_def_label(erl_backend__erl_call_gen__erl_gen_ordinary_pragma_foreign_code_8_0,22)
	...
	MR_sv(8) = (MR_Word) MR_TAG_COMMON(2,7,0);
...
MR_def_label(erl_backend__erl_call_gen__erl_gen_ordinary_pragma_foreign_code_8_0,38)
	...
	MR_tfield(1, MR_sv(2), 0) = (MR_Word) MR_tmkword(0, (MR_Word *) MR_r2);
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(fn__erl_backend__elds__exprs_from_vars_1_0,
