...
{
  {
    ...
    if ((MaybeNameMode_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      Name_7 = (MR_String) "_";
    else
    {
      ...
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_9, (MR_Integer) 1)));
    }
    return Name_7;
  }
}
...
{
  {
    ...
    *Type_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));
    Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 3)));
    if ((MaybeNameMode_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    else
    {
      ...
      MR_String _Name_9 = ((MR_String) (MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      Var_10 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_5, Type_9);
    ...
    if (succeeded)
    {
      ...
      {
        Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((MaybeTraceRuntimeCond_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Context_20;

      if ((MaybeContext_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      {
        SendMsg_34 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), SendMsg_34, 0) = ((MR_Box) (Var_45));
      }
      {
        Send_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Send_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
      ...
      {
        AckPattern_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), AckPattern_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
      ...
      {
        Receive_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Receive_37, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
      ...
      {
        TrueCase_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        FalseCase_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    switch (MR_tag((MR_Word) TraceExpr_5)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            Args_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          MR_Word TraceOp_12 = ((MR_Word) (MR_hl_field(MR_mktag(2), TraceExpr_5, (MR_Integer) 0)));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
...
{
  {
    ...
    MR_Word Var_58;
    MR_Word Var_59;
    MR_Word InputExprs_82;

    erl_backend__erl_code_util__erl_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_34, &ModuleInfo_16);
    TypeCtorInfo_63_63 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0;
    mercury__list__map2_4_p_0(TypeCtorInfo_63_63, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0, (MR_Word) &erl_backend__erl_call_gen_scalar_common_4[0], ForeignArgs_9, &ArgTypes_17, &ArgModes_18);
    erl_backend__erl_code_util__erl_gen_arg_list_7_p_0(TypeCtorInfo_63_63, ModuleInfo_16, (MR_Integer) 0, ForeignArgs_9, ArgTypes_17, ArgModes_18, &InputForeignArgs_19, &OutputForeignArgs_20);
    TypeInfo_66_66 = (MR_Word) &erl_backend__erl_call_gen_scalar_common_1[0];
    InputVars_21 = mercury__list__map_2_f_0(TypeCtorInfo_63_63, TypeInfo_66_66, (MR_Word) &erl_backend__erl_call_gen_scalar_common_4[1], InputForeignArgs_19);
    OutputVars_22 = mercury__list__map_2_f_0(TypeCtorInfo_63_63, TypeInfo_66_66, (MR_Word) &erl_backend__erl_call_gen_scalar_common_4[2], OutputForeignArgs_20);
    TypeCtorInfo_71_71 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    InputVarsNames_23 = mercury__list__map_2_f_0(TypeCtorInfo_63_63, TypeCtorInfo_71_71, (MR_Word) &erl_backend__erl_call_gen_scalar_common_4[3], InputForeignArgs_19);
    OutputVarsNames_24 = mercury__list__map_2_f_0(TypeCtorInfo_63_63, TypeCtorInfo_71_71, (MR_Word) &erl_backend__erl_call_gen_scalar_common_4[4], OutputForeignArgs_20);
    {
      ForeignCodeExpr_25 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ForeignCodeExpr_25, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_56 = erl_backend__elds__exprs_from_fixed_vars_1_f_0(OutputVarsNames_24);
          OutputExpr_26 = erl_backend__elds__tuple_or_single_expr_1_f_0(Var_56);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_46 = erl_backend__elds__exprs_from_fixed_vars_1_f_0(OutputVarsNames_24);
          {
            Var_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
            MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (Var_46));
          ...
          {
            OutputTuple_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), OutputTuple_29, 0) = ((MR_Box) (Var_45));
          }
          Var_52 = erl_backend__elds__elds_true_0_f_0();
          {
            OnTrue_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), OnTrue_31, 0) = ((MR_Box) (Var_52));
            MR_hl_field(MR_mktag(0), OnTrue_31, 1) = ((MR_Box) (OutputTuple_29));
          }
          Var_53 = erl_backend__elds__elds_false_0_f_0();
          Var_55 = erl_backend__elds__elds_fail_0_f_0();
          {
          ...
          {
            OnFalse_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), OnFalse_32, 0) = ((MR_Box) (Var_53));
            MR_hl_field(MR_mktag(0), OnFalse_32, 1) = ((MR_Box) (Var_54));
          }
          {
            Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (OnFalse_32));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (OnTrue_31));
            MR_hl_field(MR_mktag(1), Var_47, 1) = ((MR_Box) (Var_48));
          }
          {
            MaybePlaceOutputs_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), MaybePlaceOutputs_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            MR_hl_field(MR_mktag(3), MaybePlaceOutputs_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &erl_backend__erl_call_gen_scalar_common_6[0])));
            MR_hl_field(MR_mktag(3), MaybePlaceOutputs_28, 2) = ((MR_Box) (Var_47));
          }
          InnerFunStatement_27 = erl_backend__elds__join_exprs_2_f_0(ForeignCodeExpr_25, MaybePlaceOutputs_28);
        }
        break;
    }
    Var_58 = erl_backend__elds__terms_from_fixed_vars_1_f_0(InputVarsNames_23);
    {
      Var_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Var_58));
      MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (InnerFunStatement_27));
    }
    InnerFun_33 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) Var_57);
    {
      Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (InnerFun_33));
    }
    InputExprs_82 = erl_backend__elds__exprs_from_vars_1_f_0(InputVars_21);
    erl_backend__erl_call_gen__erl_make_call_2_6_p_0(CodeModel_11, Var_59, InputExprs_82, OutputVars_22, MaybeSuccessExpr_13, Statement_14);
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) ArgVars_8)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            _SrcType_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), ArgTypes_12, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      IsDummy_18 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_17, DestType_16);
      switch (IsDummy_18) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = hlds__vartypes__search_var_type_3_p_0(VarTypes_19, SrcVar_13, &Type_36);
            if (succeeded)
            {
              Var_37 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_17, Type_36);
            ...
            if (succeeded)
            {
              ...
              Var_38 = erl_backend__elds__elds_false_0_f_0();
              {
                SrcVarExpr_20 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), SrcVarExpr_20, 0) = ((MR_Box) (Var_38));
              }
            }
            else
            ...
            {
              Assign_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Assign_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_63 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_18, LvalType_25);
              ...
              else
              {
                ...
                Var_64 = erl_backend__elds__expr_from_var_1_f_0(Lval_23);
                {
                  Assign_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Assign_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), Assign_27, 1) = ((MR_Box) (Var_64));
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_52 = erl_backend__elds__elds_true_0_f_0();
              Var_53 = erl_backend__elds__expr_or_void_1_f_0(MaybeSuccessExpr_15);
              {
                TrueCase_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TrueCase_34, 0) = ((MR_Box) (Var_52));
                MR_hl_field(MR_mktag(0), TrueCase_34, 1) = ((MR_Box) (Var_53));
              }
              Var_54 = erl_backend__elds__elds_false_0_f_0();
              Var_56 = erl_backend__elds__elds_fail_0_f_0();
              {
              ...
              {
                FalseCase_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), FalseCase_35, 0) = ((MR_Box) (Var_54));
                MR_hl_field(MR_mktag(0), FalseCase_35, 1) = ((MR_Box) (Var_55));
              }
              {
                Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (FalseCase_35));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (TrueCase_34));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_42 = erl_backend__elds__elds_false_0_f_0();
          Expr_8 = erl_backend__erl_code_util__erl_var_or_dummy_replacement_4_f_0(ModuleInfo_5, VarTypes_6, Var_42, Var_9);
        }
        break;
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_41, 0) = ((MR_Box) (Int_10));
          }
          {
            Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (UInt_11));
          }
          {
            Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Integer Int8_12 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_39;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_39, 1) = ((MR_Box) (Int8_12));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              MR_Integer UInt8_13 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_38;

              {
                Var_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) (UInt8_13));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              MR_Integer Int16_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_37;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_37, 1) = ((MR_Box) (Int16_14));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 3:
            {
              MR_Integer UInt16_15 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_36;

              {
                Var_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), Var_36, 1) = ((MR_Box) (UInt16_15));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              MR_Integer Int32_16 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_35;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_35, 1) = ((MR_Box) (Int32_16));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 5:
            {
              MR_Integer UInt32_17 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_34;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_34, 1) = ((MR_Box) (UInt32_17));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 6:
            {
              MR_Float Float_18 = MR_unbox_float((MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_33;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_33, 1) = MR_box_float(Float_18);
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 7:
            {
              MR_Word StdOp_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Expr0_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 2)));
              MR_Word Op_21;

              if ((StdOp_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)))))
              {
                Op_21 = (MR_Integer) 3;
                succeeded = MR_TRUE;
              }
              else
              if (((MR_tag((MR_Word) StdOp_19)) == (MR_mktag((MR_Integer) 1))))
              {
                Op_21 = (MR_Integer) 2;
                succeeded = MR_TRUE;
              }
              ...
              if (succeeded)
              {
                MR_Word SimpleExpr1_22;

                SimpleExpr1_22 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr0_20);
                {
                  Expr_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Expr_8, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(3), Expr_8, 1) = ((MR_Box) (Op_21));
                  MR_hl_field(MR_mktag(3), Expr_8, 2) = ((MR_Box) (SimpleExpr1_22));
                }
              }
              else
              {
          ...
          case (MR_Integer) 8:
            {
              MR_Word Expr1_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 2)));
              MR_Word Expr2_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 3)));
              MR_Word StdOp_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Op_44;

              switch (MR_tag((MR_Word) StdOp_46)) {
                default:
                  succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StdOp_46)) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 0:
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), StdOp_46, (MR_Integer) 0)))) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 0:
              ...
              if (succeeded)
              {
                MR_Word SimpleExpr2_25;
                MR_Word SimpleExpr1_43;

                SimpleExpr1_43 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr1_23);
                SimpleExpr2_25 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr2_24);
                {
                  Expr_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Expr_8, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(3), Expr_8, 1) = ((MR_Box) (Op_44));
                  MR_hl_field(MR_mktag(3), Expr_8, 2) = ((MR_Box) (SimpleExpr1_43));
                  MR_hl_field(MR_mktag(3), Expr_8, 3) = ((MR_Box) (SimpleExpr2_25));
                }
              }
              else
              {
                succeeded = (StdOp_46 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 24))));
                if (succeeded)
                {
                  MR_Word Var_26;
                  ...
                  {
                    Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Expr_8, 0) = ((MR_Box) (Var_26));
                  }
                }
                else
                {
...
{
  {
    ...
    MR_Word Var_62;
    MR_Word _ClassId_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), GenericCall_10, (MR_Integer) 2)));
    MR_Word _CallId_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), GenericCall_10, (MR_Integer) 3)));
    ...
    {
      ExtractBaseTypeclassInfo_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ExtractBaseTypeclassInfo_31, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    Var_45 = ((MR_Integer) 1 + MethodNum_19);
    Var_47 = erl_backend__erl_code_util__erl_base_typeclass_info_method_offset_0_f_0();
    MethodFieldNum_32 = (Var_45 + Var_47);
    Var_48 = erl_backend__elds__elds_call_element_2_f_0(BaseTCIVar_22, MethodFieldNum_32);
    {
      ExtractMethodWrapper_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ExtractMethodWrapper_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    {
      CallTarget_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word Var_43;
    MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), GenericCall_10, (MR_Integer) 1)));
    MR_Word Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), GenericCall_10, (MR_Integer) 2)));
    MR_Integer Var_21 = ((MR_Integer) (MR_hl_field(MR_mktag(0), GenericCall_10, (MR_Integer) 3)));
    ...
    {
      CallTarget_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      CallTarget_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            CallExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), CallExpr_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), CallExpr_20, 1) = ((MR_Box) (CallTarget_8));
            MR_hl_field(MR_mktag(3), CallExpr_20, 2) = ((MR_Box) (InputExprs_9));
          }
          if ((OutputVars_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            if ((MaybeSuccessExpr_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              succeeded = MR_TRUE;
            else
            {
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeSuccessExpr_11)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
            ...
            else
            {
              ...
              {
                AssignCall_24 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), AssignCall_24, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = ((((MR_tag((MR_Word) SuccessExpr_14)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SuccessExpr_14, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
          ...
          else
          {
            ...
            SuccessCont_38 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) Var_41);
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            CallExpr_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), CallExpr_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          ...
          {
            UnpackTerm_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), UnpackTerm_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
            MR_hl_field(MR_mktag(3), UnpackTerm_55, 1) = ((MR_Box) (Var_59));
          }
          succeeded = ((MR_tag((MR_Word) SuccessExpr_13)) == (MR_mktag((MR_Integer) 2)));
          if (succeeded)
          {
          ...
          else
          {
            ...
            {
              TrueCase_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            {
              FalseCase_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), FalseCase_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            ...
            {
              Statement0_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Statement0_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
