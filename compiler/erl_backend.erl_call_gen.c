...
{
  {
    ...
    *Type_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 3)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word CondA_42;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TraceExpr_5, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Var_43;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GenericCall_10, (MR_Integer) 1)));
