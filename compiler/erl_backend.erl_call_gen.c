...
{
  {
    ...
    *Type_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 3)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word CondA_42;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TraceExpr_5, (MR_Integer) 0)));
          ...
          case (MR_Integer) 8:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_35, 0) = ((MR_Box) ((MR_Unsigned) 9U));
          ...
          case (MR_Integer) 10:
            {
              ...
              if (succeeded)
              {
                ...
                SimpleExpr2_27 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr2_26);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Expr_8, 1) = (MR_Box) ((MR_Unsigned) (Op_48));
...
{
  {
    ...
    MR_Word Var_43;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GenericCall_10, (MR_Integer) 1)));
