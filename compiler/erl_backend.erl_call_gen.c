...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_38_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_21_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_40_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_45_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word erl_backend__erl_call_gen__V_30_30;

          {
            erl_backend__erl_call_gen__V_30_30 = erl_backend__elds__elds_false_0_f_0();
          }
          {
            erl_backend__erl_call_gen__Expr_8 = erl_backend__erl_code_util__erl_var_or_dummy_replacement_4_f_0(erl_backend__erl_call_gen__ModuleInfo_5, erl_backend__erl_call_gen__VarTypes_6, erl_backend__erl_call_gen__V_30_30, erl_backend__erl_call_gen__Var_9);
          }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          {
            erl_backend__erl_call_gen__V_29_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), erl_backend__erl_call_gen__V_29_29, 0) = ((MR_Box) (erl_backend__erl_call_gen__Int_10));
          }
          {
            ...
            MR_hl_field(MR_mktag(2), erl_backend__erl_call_gen__Expr_8, 0) = ((MR_Box) (erl_backend__erl_call_gen__V_29_29));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          {
            erl_backend__erl_call_gen__V_28_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_28_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_28_28, 1) = ((MR_Box) (erl_backend__erl_call_gen__UInt_11));
          }
          {
            erl_backend__erl_call_gen__Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), erl_backend__erl_call_gen__Expr_8, 0) = ((MR_Box) (erl_backend__erl_call_gen__V_28_28));
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                erl_backend__erl_call_gen__V_27_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_27_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), erl_backend__erl_call_gen__V_27_27, 1) = MR_box_float(erl_backend__erl_call_gen__Float_12);
              }
              {
                erl_backend__erl_call_gen__Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              if (erl_backend__erl_call_gen__succeeded)
                ...
                {
                  erl_backend__erl_call_gen__succeeded = (erl_backend__erl_call_gen__StdOp_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 54))));
                  if (erl_backend__erl_call_gen__succeeded)
                    {
                      MR_Word erl_backend__erl_call_gen__V_20_20;

                      {
                        erl_backend__erl_call_gen__V_20_20 = erl_backend__elds__elds_false_0_f_0();
                      }
                      {
                        erl_backend__erl_call_gen__Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), erl_backend__erl_call_gen__Expr_8, 0) = ((MR_Box) (erl_backend__erl_call_gen__V_20_20));
                      }
                    }
                  else
                    {
