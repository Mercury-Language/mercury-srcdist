          ...
          case (MR_Integer) 0:
            {
              ...
              Var_63 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_18, LvalType_25);
          ...
          case (MR_Integer) 10:
            {
              ...
              {
                succeeded = (StdOp_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 25))));
                if (succeeded)
                {
                  MR_Word Var_28;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              Var_37 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_17, Type_36);
...
{
  {
    ...
    Var_45 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 1 + (MR_Unsigned) MethodNum_19);
