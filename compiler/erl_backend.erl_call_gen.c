          ...
          case (MR_Integer) 9:
            {
              ...
              if ((StdOp_21 == (MR_Word) ((MR_Integer) 16)))
              {
                Op_23 = (MR_Integer) 3;
                succeeded = MR_TRUE;
              }
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) ArgVars_8)) == (MR_Integer) 1);
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) ArgTypes_12)) == (MR_Integer) 1);
          if (succeeded)
          {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeSuccessExpr_11)) == (MR_Integer) 1);
            if (succeeded)
            {
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = ((((MR_tag((MR_Word) SuccessExpr_14)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SuccessExpr_14, (MR_Integer) 0))) == (MR_Integer) 3)));
          if (succeeded)
          {
