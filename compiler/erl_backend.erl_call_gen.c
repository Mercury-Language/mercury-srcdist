...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), AckPattern_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
      ...
      case (MR_Integer) 0:
        {
          ...
          Expr_8 = erl_backend__erl_code_util__erl_var_or_dummy_replacement_4_f_0(ModuleInfo_5, VarTypes_6, Var_46, Var_9);
        }
        break;
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_45, 0) = ((MR_Box) (Int_10));
          }
          {
            Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Expr_8, 0) = ((MR_Box) (Var_45));
          }
        }
        break;
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_44, 1) = ((MR_Box) (UInt_11));
          }
          {
            Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Expr_8, 0) = ((MR_Box) (Var_44));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_43, 1) = ((MR_Box) (MR_Word) (Int8_12));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (MR_Word) (UInt8_13));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_41, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), Var_41, 1) = ((MR_Box) (MR_Word) (Int16_14));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 3:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (MR_Word) (UInt16_15));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_39, 1) = ((MR_Box) (MR_Word) (Int32_16));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 5:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) (MR_Word) (UInt32_17));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 6:
            {
              MR_Integer Int64_18 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_37;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_37, 1) = ((MR_Box) (Int64_18));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 7:
            {
              MR_Integer UInt64_19 = ((MR_Integer) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Var_36;

              {
                Var_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
                MR_hl_field(MR_mktag(3), Var_36, 1) = ((MR_Box) (UInt64_19));
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 8:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_35, 1) = MR_box_float(Float_20);
              }
              {
                Expr_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 9:
            {
              ...
              if ((StdOp_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)))))
              {
                Op_23 = (MR_Integer) 3;
                succeeded = MR_TRUE;
              }
              else
              if (((MR_tag((MR_Word) StdOp_21)) == (MR_mktag((MR_Integer) 1))))
              {
                Op_23 = (MR_Integer) 2;
                succeeded = MR_TRUE;
              }
              ...
              if (succeeded)
              {
                ...
                SimpleExpr1_24 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr0_22);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Expr_8, 1) = ((MR_Box) (Op_23));
          ...
          case (MR_Integer) 10:
            {
              ...
              MR_Word StdOp_50 = ((MR_Word) (MR_hl_field(MR_mktag(3), SimpleExpr_7, (MR_Integer) 1)));
              MR_Word Op_48;

              switch (MR_tag((MR_Word) StdOp_50)) {
                default:
                  succeeded = MR_FALSE;
                  break;
                case (MR_Integer) 0:
                  switch (MR_unmkbody(StdOp_50)) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 0:
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), StdOp_50, (MR_Integer) 0)))) {
                    default:
                      succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 0:
              ...
              if (succeeded)
              {
                ...
                MR_Word SimpleExpr1_47;

                SimpleExpr1_47 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr1_25);
                SimpleExpr2_27 = erl_backend__erl_call_gen__erl_gen_simple_expr_3_f_0(ModuleInfo_5, VarTypes_6, Expr2_26);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Expr_8, 1) = ((MR_Box) (Op_48));
                  MR_hl_field(MR_mktag(3), Expr_8, 2) = ((MR_Box) (SimpleExpr1_47));
                  MR_hl_field(MR_mktag(3), Expr_8, 3) = ((MR_Box) (SimpleExpr2_27));
                }
              }
              else
              {
                succeeded = (StdOp_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 24))));
                if (succeeded)
                {
                  MR_Word Var_28;
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_59 = erl_backend__elds__exprs_from_vars_1_f_0(OutputVars_10);
          {
            ...
            MR_hl_field(MR_mktag(3), UnpackTerm_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
