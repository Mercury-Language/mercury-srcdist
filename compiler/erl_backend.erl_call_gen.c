...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_call_gen__Var_62, 0) = ((MR_Box) (&erl_backend__erl_call_gen_scalar_common_3[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_call_gen__Var_43, 0) = ((MR_Box) (&erl_backend__erl_call_gen_scalar_common_3[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_call_gen__Var_18, 0) = ((MR_Box) (&erl_backend__erl_call_gen_scalar_common_3[0]));
    ...
    if ((erl_backend__erl_call_gen__MaybeTraceRuntimeCond_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), erl_backend__erl_call_gen__Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &erl_backend__erl_call_gen_scalar_common_2[1])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), erl_backend__erl_call_gen__Var_59, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &erl_backend__erl_call_gen_scalar_common_2[2])));
