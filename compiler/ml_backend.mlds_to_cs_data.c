...
static void MR_CALL 
ml_backend__mlds_to_cs_data__IntroducedFrom__pred__output_initializer_body_list_for_csharp__1009__1_4_p_0(
  MR_Word Info_5,
...
{
  {
    ml_backend__mlds_to_cs_data__output_initializer_body_for_csharp_5_p_0(Info_5, LambdaHeadVar__1_14, (MR_Word) ((MR_Integer) 0));
  }
}
...
{
  {
    ...
    ml_backend__mlds_to_cs_data__IntroducedFrom__pred__output_initializer_body_list_for_csharp__1009__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  }
}
      ...
      case (MR_Integer) 3:
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) "new ");
          if ((MaybeType_8 == (MR_Word) ((MR_Integer) 0)))
          {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (((MR_tag((MR_Word) FieldId_11)) == (MR_Integer) 1))
            {
              ...
              succeeded = (FieldVarName_22 == (MR_Word) ((MR_Integer) 4));
              if (succeeded)
              {
            ...
            else
            {
              ...
              if ((FieldType_12 == (MR_Word) ((MR_Integer) 24)))
                succeeded = MR_TRUE;
              else
  ...
  top_of_proc_4:;
    {
      ...
      MR_bool succeeded = (Type_7 == (MR_Word) ((MR_Integer) 36));
      MR_Integer N_10;
      MR_Word Var_15;
      ...
      {
        if ((Type_7 == (MR_Word) ((MR_Integer) 32)))
          succeeded = MR_TRUE;
        else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_cs_data_scalar_common_1[0]), (MR_Integer) 2, Var_19, &Var_26);
