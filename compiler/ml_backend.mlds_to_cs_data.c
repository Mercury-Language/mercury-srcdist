  ...
  MR_Integer N_6)
{
  ...
  if (succeeded)
  {
    ...
    mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_cs_data_scalar_common_1[0]), (MR_Integer) 2, N32_10, &Var_24);
