  ...
  MR_Word Stream_8)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Rval_7, (MR_Integer) 0))));

      if (((((MR_tag((MR_Word) Var_35)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_35, (MR_Integer) 0)))) == (MR_Integer) 1))))
        succeeded = MR_TRUE;
      else
      if (((((MR_tag((MR_Word) Var_35)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_35, (MR_Integer) 0)))) == (MR_Integer) 0))))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
    }
    ...
    {
      MR_Word Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_7, (MR_Integer) 1))));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (((MR_tag((MR_Word) FieldId_13)) == (MR_Integer) 1))
          {
            ...
            if (succeeded)
            {
              ...
              {
                MR_Word Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(2), PtrRval_11, (MR_Integer) 0))));

                if (((((MR_tag((MR_Word) Var_86)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_86, (MR_Integer) 0)))) == (MR_Integer) 1))))
                  succeeded = MR_TRUE;
                else
                if (((((MR_tag((MR_Word) Var_86)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_86, (MR_Integer) 0)))) == (MR_Integer) 0))))
                  succeeded = MR_TRUE;
                else
                  succeeded = MR_FALSE;
              }
