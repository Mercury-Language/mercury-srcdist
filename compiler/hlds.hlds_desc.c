          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) GCall_39)) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    Var_108 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_157);
                    Desc_23 = mercury__string__f_43_43_2_f_0((MR_String) "coerce ", Var_108);
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    MR_String Var_122;
                    MR_String Var_123;
                    MR_Word Var_153 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GCall_39, (MR_Integer) 0))));
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Method_48 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GCall_39, (MR_Integer) 3))));
                    MR_String Var_114;
                    MR_String Var_115;
                    MR_String Var_117;
                    MR_String Var_118;
                    MR_String Var_119;
                    MR_String Var_121;
                    MR_Word Var_154 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GCall_39, (MR_Integer) 0))));
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GCall_39, (MR_Integer) 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        MR_String Event_49 = ((MR_String) ((MR_hl_field(MR_mktag(3), GCall_39, (MR_Integer) 1))));
                        MR_String Var_112;
                        MR_String Var_113;
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        Desc_23 = mercury__string__f_43_43_2_f_0((MR_String) "cast ", Var_110);
                      }
                      break;
                  }
                  break;
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_102 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&hlds__hlds_desc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_desc_scalar_common_4[0]), Args_158);
