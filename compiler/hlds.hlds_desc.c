    ...
    if ((hlds__hlds_desc__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__hlds_desc__Var_14, 0) = ((MR_Box) (&hlds__hlds_desc_scalar_common_4[0]));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                hlds__hlds_desc__Var_102 = mercury__list__map_2_f_0(hlds__hlds_desc__TypeCtorInfo_158_158, hlds__hlds_desc__TypeInfo_159_159, (MR_Word) &hlds__hlds_desc_scalar_common_3[0], hlds__hlds_desc__Args_156);
              }
              {
                hlds__hlds_desc__Var_101 = hlds__hlds_desc__describe_args_2_f_0(hlds__hlds_desc__VarSet_6, hlds__hlds_desc__Var_102);
              }
              {
                hlds__hlds_desc__Var_105 = mercury__list__map_2_f_0(hlds__hlds_desc__TypeCtorInfo_158_158, hlds__hlds_desc__TypeInfo_159_159, (MR_Word) &hlds__hlds_desc_scalar_common_3[1], hlds__hlds_desc__ExtraArgs_54);
              }
              {
