...
MR_decl_label6(fn__hlds__hlds_desc__describe_args_2_0, 21,4,6,7,8,9)
...
MR_decl_label10(fn__hlds__hlds_desc__describe_goal_3_0, 29,30,31,32,8,35,36,38,39,41)
MR_decl_label10(fn__hlds__hlds_desc__describe_goal_3_0, 42,43,44,34,46,47,51,50,54,55)
MR_decl_label10(fn__hlds__hlds_desc__describe_goal_3_0, 56,57,58,59,53,62,63,61,65,66)
MR_decl_label10(fn__hlds__hlds_desc__describe_goal_3_0, 48,68,71,72,73,74,75,76,77,78)
MR_decl_label9(fn__hlds__hlds_desc__describe_goal_3_0, 79,69,80,81,82,83,84,85,86)
...
MR_BEGIN_MODULE(hlds__hlds_desc_module1)
	...
	MR_init_label6(fn__hlds__hlds_desc__describe_args_2_0,21,4,6,7,8,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_desc__describe_args_2_0);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_args_2_0_i21);
	}
	MR_r1 = (MR_Word) MR_string_const("", 0);
	MR_proceed();
MR_def_label(fn__hlds__hlds_desc__describe_args_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(fn__hlds__hlds_desc__describe_args_2_0,4)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_desc__describe_args_2_0_i6);
MR_def_label(fn__hlds__hlds_desc__describe_args_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__hlds_desc_module2)
	...
	MR_init_label10(fn__hlds__hlds_desc__describe_goal_3_0,29,30,31,32,8,35,36,38,39,41)
	MR_init_label10(fn__hlds__hlds_desc__describe_goal_3_0,42,43,44,34,46,47,51,50,54,55)
	MR_init_label10(fn__hlds__hlds_desc__describe_goal_3_0,56,57,58,59,53,62,63,61,65,66)
	MR_init_label10(fn__hlds__hlds_desc__describe_goal_3_0,48,68,71,72,73,74,75,76,77,78)
	MR_init_label9(fn__hlds__hlds_desc__describe_goal_3_0,79,69,80,81,82,83,84,85,86)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,36)
	...
	MR_tempr1 = MR_sv(4);
	MR_sv(4) = MR_r1;
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, foreign_arg);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,39)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_desc__describe_goal_3_0_i41);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,34)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,2)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_goal_3_0_i46);
	}
	MR_r1 = MR_tfield(0, MR_r3, 1);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,47)
	...
	if (MR_PTAG_TESTR(MR_r5,3)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_goal_3_0_i50);
	}
	MR_sv(1) = MR_tfield(0, MR_r3, 1);
	MR_r1 = MR_r2;
	MR_r2 = MR_tfield(3, MR_tempr1, 2);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,53)
	...
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_goal_3_0_i61);
	}
	MR_sv(1) = MR_tfield(0, MR_r3, 1);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,68)
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_goal_3_0_i71);
	}
	MR_r1 = MR_tfield(0, MR_r3, 1);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,76)
	...
	MR_r1 = MR_tfield(0, MR_r3, 1);
	MR_sv(2) = (MR_Word) MR_string_const("scope loop control goal", 23);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		fn__hlds__hlds_desc__describe_goal_3_0_i83);
...
void mercury__hlds__hlds_desc__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__hlds_desc);
