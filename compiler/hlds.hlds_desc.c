...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_12, (MR_Integer) 0)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_String Var_142;
                MR_String Var_143;
                MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_14, (MR_Integer) 5)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 4)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_9, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 5)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GCall_39, (MR_Integer) 1)));
