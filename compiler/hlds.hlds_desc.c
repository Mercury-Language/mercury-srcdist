...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Origin_12)) == (MR_mktag((MR_Integer) 0)));
    if (succeeded)
    {
      SpecialId_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Origin_12, (MR_Integer) 0)));
      TypeCtor_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), Origin_12, (MR_Integer) 1)));
      {
        MR_String Var_19;
        MR_String Var_22;
        MR_String Var_40;
    ...
    Var_47 = (MR_Word) &hlds__hlds_desc_scalar_common_5[0];
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(Var_47, Var_37, &Var_41);
    Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_41);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(Var_47, Arity_11, &Var_50);
