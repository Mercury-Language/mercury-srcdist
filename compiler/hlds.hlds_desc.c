...
MR_decl_label10(fn__hlds__hlds_desc__describe_goal_3_0, 68,69,72,73,74,75,76,77,78,79)
...
MR_BEGIN_MODULE(hlds__hlds_desc_module2)
	...
	MR_init_label10(fn__hlds__hlds_desc__describe_goal_3_0,68,69,72,73,74,75,76,77,78,79)
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,77)
	...
	MR_r1 = MR_tfield(0, MR_r3, 1);
	MR_sv(1) = (MR_Word) MR_string_const("scope require complete switch", 29);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		fn__hlds__hlds_desc__describe_goal_3_0_i83);
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,78)
	...
	MR_r1 = MR_tfield(0, MR_r3, 1);
	MR_sv(1) = (MR_Word) MR_string_const("scope require detism", 20);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		fn__hlds__hlds_desc__describe_goal_3_0_i83);
