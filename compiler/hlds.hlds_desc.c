...
static /* final */ const MR_Box hlds__hlds_desc_scalar_common_4[1][5];

static /* final */ const MR_Box hlds__hlds_desc_scalar_common_5[2][3];

static /* final */ const MR_Box hlds__hlds_desc_scalar_common_6[1][1];


/* sealed */ struct hlds__hlds_desc__vector_common_type_3_0_s {
  const MR_String hlds__hlds_desc__vector_common_type_3_0__vct_3_f_0;
};

static /* final */ const struct hlds__hlds_desc__vector_common_type_3_0_s hlds__hlds_desc_vector_common_3[5];
...
static /* final */ const MR_Box hlds__hlds_desc_scalar_common_5[2][3] = {
  /* row 0 */
  {
    ((MR_Box) (&hlds__hlds_desc_scalar_common_4[0])),
...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtor_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_12, (MR_Integer) 1))));
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_desc_scalar_common_6[0]), TypeCtorArity_69, &Var_77);
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_desc_scalar_common_6[0]), Var_37, &Var_41);
    Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_41);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_desc_scalar_common_6[0]), Arity_11, &Var_50);
...
{
  {
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_140 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, Var_16);
                Var_144 = parse_tree__prog_out__cons_id_and_arity_to_string_1_f_0(ConsId_17);
                Var_145 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_18);
                Var_143 = mercury__string__f_43_43_2_f_0(Var_144, Var_145);
                Var_141 = mercury__string__f_43_43_2_f_0((MR_String) " <= ", Var_143);
                Desc_23 = mercury__string__f_43_43_2_f_0(Var_140, Var_141);
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                MR_String Var_138;
                MR_String Var_139;
                MR_Word Var_149 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 0))));
                MR_Word ConsId_150 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 1))));
                MR_Word Args_151 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_14, (MR_Integer) 2))));

                Var_134 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, Var_149);
                Var_138 = parse_tree__prog_out__cons_id_and_arity_to_string_1_f_0(ConsId_150);
                Var_139 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_151);
                Var_137 = mercury__string__f_43_43_2_f_0(Var_138, Var_139);
                Var_135 = mercury__string__f_43_43_2_f_0((MR_String) " => ", Var_137);
                Desc_23 = mercury__string__f_43_43_2_f_0(Var_134, Var_135);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                Var_130 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, ToVar_27);
                Var_133 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, FromVar_28);
                Var_131 = mercury__string__f_43_43_2_f_0((MR_String) " := ", Var_133);
                Desc_23 = mercury__string__f_43_43_2_f_0(Var_130, Var_131);
              }
              break;
            case (MR_Integer) 3:
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    Var_126 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, VarA_29);
                    Var_129 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, VarB_30);
                    Var_127 = mercury__string__f_43_43_2_f_0((MR_String) " == ", Var_129);
                    Desc_23 = mercury__string__f_43_43_2_f_0(Var_126, Var_127);
                  }
                  break;
                case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_String Var_124;
          MR_String Var_125;
          MR_Word Args_152 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_9, (MR_Integer) 2))));

          Var_124 = mdbcomp__sym_name__sym_name_to_string_1_f_0(SymName_38);
          Var_125 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_152);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Args_157 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 2))));
                ...
                case (MR_Integer) 0:
                  {
                    MR_String Var_122;
                    MR_String Var_123;
                    MR_Word Var_153 = ((MR_Word) ((MR_hl_field(MR_mktag(0), GCall_39, (MR_Integer) 0))));

                    Var_122 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, Var_153);
                    Var_123 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_157);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_String Var_119;
                    MR_String Var_121;
                    MR_Word Var_154 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GCall_39, (MR_Integer) 0))));

                    Var_114 = parse_tree__prog_out__pf_sym_name_orig_arity_to_string_1_f_0(Method_48);
                    Var_118 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, Var_154);
                    Var_121 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_157);
                    ...
                    Desc_23 = mercury__string__f_43_43_2_f_0(Var_114, Var_115);
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    ...
                    Var_113 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_157);
                    Var_112 = mercury__string__f_43_43_2_f_0(Event_49, Var_113);
                    Desc_23 = mercury__string__f_43_43_2_f_0((MR_String) "event ", Var_112);
                  }
                  break;
                case (MR_Integer) 3:
                  {
                    MR_Word CastType_50 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GCall_39, (MR_Integer) 0))) & (MR_Integer) 7);
                    MR_String Var_107;
                    MR_String Var_108;
                    MR_String Var_110;

                    Var_107 = hlds__hlds_desc__describe_cast_1_f_0(CastType_50);
                    Var_110 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Args_157);
                    Var_108 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_110);
                    Desc_23 = mercury__string__f_43_43_2_f_0(Var_107, Var_108);
                  }
                  break;
              }
            }
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_String Var_104;
              MR_Word Var_105;
              MR_Word Args_158 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 4))));
              ...
              Var_102 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&hlds__hlds_desc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_desc_scalar_common_5[0]), Args_158);
              Var_101 = hlds__hlds_desc__describe_args_2_f_0(VarSet_6, Var_102);
              Var_105 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&hlds__hlds_desc_scalar_common_1[0]), (MR_Word) (&hlds__hlds_desc_scalar_common_5[1]), ExtraArgs_54);
          ...
          case (MR_Integer) 4:
            {
              MR_String Var_97;
              MR_Word Var_159 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 1))));

              Var_97 = hlds__hlds_desc__describe_var_2_f_0(VarSet_6, Var_159);
    ...
    Var_148 = mercury__string__int_to_string_1_f_0(Line_95);
    Var_146 = mercury__string__f_43_43_2_f_0((MR_String) "\100", Var_148);
    FullDesc_8 = mercury__string__f_43_43_2_f_0(Desc_23, Var_146);
    return FullDesc_8;
  }
}
...
{
  {
    MR_String Desc_4 = ((&hlds__hlds_desc_vector_common_3[0 + CastType_3]))->hlds__hlds_desc__vector_common_type_3_0__vct_3_f_0;
