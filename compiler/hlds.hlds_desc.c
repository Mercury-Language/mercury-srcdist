  ...
  MR_Integer ProcId_5)
{
  ...
  if (succeeded)
  {
    ...
    MR_String Var_23;
    MR_String Var_41;
    MR_Word TypeCtorSymName_69;
    MR_Integer TypeCtorArity_70;
    MR_String Var_74;
    MR_String Var_78;
    MR_String Var_86;

    Var_20 = mdbcomp__prim_data__get_special_pred_id_generic_name_1_f_0(SpecialId_13);
    TypeCtorSymName_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_14, (MR_Integer) 0))));
    TypeCtorArity_70 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_14, (MR_Integer) 1))));
    Var_74 = mdbcomp__sym_name__sym_name_to_string_1_f_0(TypeCtorSymName_69);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_desc_scalar_common_2[0]), TypeCtorArity_70, &Var_78);
    Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_78);
    Var_23 = mercury__string__f_43_43_2_f_0(Var_74, Var_86);
