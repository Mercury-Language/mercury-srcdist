          ...
          case (MR_Integer) 1:
            {
              ...
              ConsIdStr_190 = parse_tree__parse_tree_out_cons_id__cons_id_and_arity_to_string_1_f_0(ConsId_186);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  Var_132 = parse_tree__parse_tree_out_sym_name__pf_sym_name_pred_form_arity_to_string_1_f_0(MethodSNA_50);
