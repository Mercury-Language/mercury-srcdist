  ...
  MR_Word PredProcId_7)
{
  ...
  ProcDesc_8 = hlds__hlds_desc__describe_proc_3_f_0(IncludeModuleName_5, PredInfo_11, ProcId_10);
  return ProcDesc_8;
}
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_37 = parse_tree__prog_out__pred_or_func_to_str_1_f_0(PredOrFunc_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) Unification_14)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_185 = ((MR_Word) ((MR_hl_field(1, Unification_14, (MR_Integer) 0))));
              MR_Word ConsId_186 = ((MR_Word) ((MR_hl_field(1, Unification_14, (MR_Integer) 1))));
              MR_Word Args_187 = ((MR_Word) ((MR_hl_field(1, Unification_14, (MR_Integer) 2))));
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, Unification_14, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word VarA_202 = ((MR_Word) ((MR_hl_field(3, Unification_14, (MR_Integer) 1))));
                  MR_Word VarB_203 = ((MR_Word) ((MR_hl_field(3, Unification_14, (MR_Integer) 2))));
                  MR_String Var_207;
                  MR_String Var_212;
                  MR_String Var_216;
                  MR_String Var_217;
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_String Var_120;
        MR_String Var_121;
        MR_Word Args_170 = ((MR_Word) ((MR_hl_field(2, GoalExpr_9, (MR_Integer) 2))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_9, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Args_175 = ((MR_Word) ((MR_hl_field(3, GoalExpr_9, (MR_Integer) 2))));
            ...
            switch (MR_tag((MR_Word) GCall_41)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_String Var_125;
                  MR_Word Var_171 = ((MR_Word) ((MR_hl_field(0, GCall_41, (MR_Integer) 0))));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_String Var_132;
                  MR_String Var_135;
                  MR_Word Var_172 = ((MR_Word) ((MR_hl_field(1, GCall_41, (MR_Integer) 0))));
                  MR_String Var_240;
                  MR_String Var_241;
                  MR_String Var_243;

                  Var_132 = parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_1_f_0(MethodSNA_50);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_String Var_159;
            MR_String Var_162;
            MR_Word Args_177 = ((MR_Word) ((MR_hl_field(3, GoalExpr_9, (MR_Integer) 4))));
            MR_String Var_246;
            MR_String Var_247;
        ...
        case (MR_Integer) 4:
          {
            MR_String Var_165;
            MR_Word Var_178 = ((MR_Word) ((MR_hl_field(3, GoalExpr_9, (MR_Integer) 1))));
