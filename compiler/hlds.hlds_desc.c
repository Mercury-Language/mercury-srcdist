  ...
  MR_Word PredInfo_5)
{
  ...
  if (succeeded)
  {
    Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_10, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_16)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialId_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
    ...
    TypeCtorSymName_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_12, (MR_Integer) 0))));
    TypeCtorArity_76 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_12, (MR_Integer) 1))));
