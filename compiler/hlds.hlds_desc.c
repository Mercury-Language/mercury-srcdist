...
MR_decl_label9(fn__hlds__hlds_desc__describe_goal_3_0, 80,70,81,82,83,84,85,86,87)
...
MR_BEGIN_MODULE(hlds__hlds_desc_module2)
	...
	MR_init_label9(fn__hlds__hlds_desc__describe_goal_3_0,80,70,81,82,83,84,85,86,87)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,70)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(fn__hlds__hlds_desc__describe_goal_3_0_i81);
	}
	MR_r1 = MR_tfield(0, MR_r3, 1);
...
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,86)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_desc__describe_goal_3_0_i87);
MR_def_label(fn__hlds__hlds_desc__describe_goal_3_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
