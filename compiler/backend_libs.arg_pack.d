...
ifeq ($(TARGET_ASM),yes)
backend_libs.arg_pack.mh backend_libs.arg_pack.mih : backend_libs.arg_pack.s
else
backend_libs.arg_pack.mh backend_libs.arg_pack.mih : backend_libs.arg_pack.c
endif

ifeq ($(TARGET_ASM),yes)
backend_libs.arg_pack.module_dep : backend_libs.arg_pack.s
else
...
ifeq ($(TARGET_ASM),yes)
backend_libs.arg_pack.s_date : arg_pack.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only backend_libs.arg_pack $(ERR_REDIRECT)
backend_libs.arg_pack.pic_s_date : arg_pack.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" backend_libs.arg_pack $(ERR_REDIRECT)
endif # TARGET_ASM
