...
MR_decl_label8(backend_libs__arg_pack__chunk_list_by_words_3_0, 3,11,10,15,16,14,19,8)
...
MR_BEGIN_MODULE(backend_libs__arg_pack_module2)
	...
	MR_init_label8(backend_libs__arg_pack__chunk_list_by_words_3_0,3,11,10,15,16,14,19,8)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__arg_pack__chunk_list_by_words_3_0,14)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,1)) {
		MR_GOTO_LAB(backend_libs__arg_pack__chunk_list_by_words_3_0_i19);
	}
...
MR_def_label(backend_libs__arg_pack__chunk_list_by_words_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("backend_libs.arg_pack", 21);
	MR_r2 = (MR_Word) MR_string_const("predicate \140backend_libs.arg_pack.chunk_list_by_words\'/3", 55);
