    ...
    else
      {
        ...
        if ((backend_libs__arg_pack__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            switch (MR_tag((MR_Word) backend_libs__arg_pack__V_28_28)) {
    ...
    else
      {
        ...
        if ((backend_libs__arg_pack__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            switch (MR_tag((MR_Word) backend_libs__arg_pack__V_77_77)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(backend_libs__arg_pack__V_77_77)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
    ...
    else
      {
        ...
        if ((backend_libs__arg_pack__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            switch (MR_tag((MR_Word) backend_libs__arg_pack__V_36_36)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
