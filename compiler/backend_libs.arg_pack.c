        ...
        case (MR_Integer) 1:
          {
            ...
            Var_27 = backend_libs__arg_pack__count_distinct_words_1_f_0(T_4);
            HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 1 + (MR_Unsigned) Var_27);
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            Var_25 = backend_libs__arg_pack__count_distinct_words_1_f_0(T_4);
            HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 2 + (MR_Unsigned) Var_25);
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), H_3, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Integer Var_27;
