...
{
  {
    ...
    {
      MR_Integer backend_libs__arg_pack__Var_35;
      ...
      if ((backend_libs__arg_pack__env_ptr)->backend_libs__arg_pack__pack_args_8_p_0_env_0__succeeded)
        {
          backend_libs__arg_pack__Var_35 = ((MR_Integer) (MR_hl_field(MR_mktag(1), (backend_libs__arg_pack__env_ptr)->backend_libs__arg_pack__pack_args_8_p_0_env_0__Var_29, (MR_Integer) 0)));
          {
