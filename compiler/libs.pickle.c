  ...
  MR_Box T_8)
{
  ...
  if (succeeded)
  {
    ...
    mercury__io__write_byte_4_p_0(OutputStream_6, D_44);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&libs__pickle_scalar_common_1[1]));
      MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (libs__pickle__pickle_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_39, 3) = ((MR_Box) (OutputStream_6));
    }
	...
	Pickle_16  = B;
          ...
          else
          {
            ...
            mercury__io__write_byte_4_p_0(OutputStream_6, D_91);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (&libs__pickle_scalar_common_1[1]));
              MR_hl_field(MR_mktag(0), Var_86, 1) = ((MR_Box) (libs__pickle__pickle_5_p_0_2));
              MR_hl_field(MR_mktag(0), Var_86, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_86, 3) = ((MR_Box) (OutputStream_6));
            }
