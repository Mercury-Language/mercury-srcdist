...
MR_def_label(libs__pickle__unpickle_from_file_5_0,8)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(libs__pickle__IntroducedFrom__pred__unpickle_from_file__218__1_4_0);
	...
	MR_tfield(0, MR_r2, 5) = MR_tfield(0, MR_sv(2), 0);
	MR_r1 = MR_tempr1;
	}
