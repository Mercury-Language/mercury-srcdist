...
MR_decl_label2(libs__pickle__user_defined_pickler_3_0, 2,1)
MR_decl_label1(__Unify___libs__pickle__get_byte_out_of_range_0_0, 4)
MR_decl_label1(__Unify___libs__pickle__picklers_0_0, 6)
MR_decl_label1(__Unify___libs__pickle__unpicklers_0_0, 6)
...
MR_CTOR0_ADDR(type_desc, type_ctor_desc),
MR_TAG_COMMON(0,0,0)
}
},
{
...
MR_BEGIN_MODULE(libs__pickle_module3)
	...
	MR_init_label2(libs__pickle__user_defined_pickler_3_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(libs__pickle__user_defined_pickler_3_0)
	...
	MR_np_call_localret_ent(map__search_3_0,
		libs__pickle__user_defined_pickler_3_0_i2);
MR_def_label(libs__pickle__user_defined_pickler_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(libs__pickle_module29)
	...
	MR_init_label1(__Unify___libs__pickle__picklers_0_0,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___libs__pickle__picklers_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___libs__pickle__picklers_0_0_i6);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(__Unify___libs__pickle__picklers_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__pickle_module37)
	...
	MR_init_label1(__Unify___libs__pickle__unpicklers_0_0,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___libs__pickle__unpicklers_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___libs__pickle__unpicklers_0_0_i6);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___libs__pickle__unpicklers_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__libs__pickle__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__libs__pickle);
