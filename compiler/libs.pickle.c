  ...
  MR_Box * LambdaHeadVar__1_27)
{
  ...
  Var_41 = mercury__type_desc__type_of_1_f_0(TypeInfo_for_T_33);
  libs__pickle__unpickle_2_6_p_0(Unpicklers_6, Bitmap_13, Var_41, &Univ_40, (MR_Integer) 0, &_State_16);
  mercury__univ__det_univ_to_type_2_p_0(TypeInfo_for_T_33, Univ_40, LambdaHeadVar__1_27);
}
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Integer A_86;
        MR_Integer B_87;
        MR_Integer STATE_VARIABLE_State_12_88;

        libs__pickle__unpickle_int32_4_p_0(Handle_8, &A_86, STATE_VARIABLE_State_0_29, &STATE_VARIABLE_State_12_88);
        libs__pickle__unpickle_int32_4_p_0(Handle_8, &B_87, STATE_VARIABLE_State_12_88, STATE_VARIABLE_State_30);
{
#define MR_PROC_LABEL libs__pickle__unpickle_2_6_p_0
	...
	Float_17  = Flt;
      ...
      else
      {
        ...
        else
        {
          MR_Word Unpickle_20;
          MR_Word Var_39;
          MR_Word Unpicklers_91;
          MR_Word Unpickle0_92;
          MR_Box conv0_Unpickle0_92;

          Var_39 = mercury__type_desc__type_ctor_1_f_0(TypeDesc_9);
          Unpicklers_91 = (MR_Word) (Unpicklers_7);
          succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__type_desc__type_desc__type_ctor_info_type_ctor_desc_0), (MR_Word) (&libs__pickle_scalar_common_2[0]), Unpicklers_91, ((MR_Box) (Var_39)), &conv0_Unpickle0_92);
          if (succeeded)
          {
            Unpickle0_92 = ((MR_Word) (conv0_Unpickle0_92));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_37 = mercury__string__from_int_1_f_0(STATE_VARIABLE_State_0_16);
        Var_36 = mercury__string__f_43_43_2_f_0(Var_37, (MR_String) " is out of range");
        Msg_33 = mercury__string__f_43_43_2_f_0((MR_String) "byte ", Var_36);
        Var_39 = (MR_Word) (Msg_33);
        {
          mercury__exception__throw_1_p_0((MR_Word) (&libs__pickle__libs__pickle__type_ctor_info_get_byte_out_of_range_0), ((MR_Box) (Var_39)));
          return;
        }
      }
  ...
  MR_Integer * STATE_VARIABLE_State_10)
{
  ...
  *STATE_VARIABLE_State_10 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_State_0_9 + (MR_Unsigned) 1);
  ...
  else
  {
    ...
    Var_18 = mercury__string__from_int_1_f_0(STATE_VARIABLE_State_0_9);
    Var_17 = mercury__string__f_43_43_2_f_0(Var_18, (MR_String) " is out of range");
    Msg_14 = mercury__string__f_43_43_2_f_0((MR_String) "byte ", Var_17);
    Var_20 = (MR_Word) (Msg_14);
    {
      mercury__exception__throw_1_p_0((MR_Word) (&libs__pickle__libs__pickle__type_ctor_info_get_byte_out_of_range_0), ((MR_Box) (Var_20)));
      return;
    }
  }
  ...
  MR_Box T_8)
{
  ...
  if (succeeded)
  {
    ...
    Length_42 = mercury__string__length_1_f_0(String_10);
    Var_58 = mercury__int__f_62_62_2_f_0(Length_42, (MR_Integer) 24);
    A_54 = (Var_58 & (MR_Integer) 255);
    Var_61 = mercury__int__f_62_62_2_f_0(Length_42, (MR_Integer) 16);
    B_55 = (Var_61 & (MR_Integer) 255);
    Var_64 = mercury__int__f_62_62_2_f_0(Length_42, (MR_Integer) 8);
    C_56 = (Var_64 & (MR_Integer) 255);
    Var_67 = mercury__int__f_62_62_2_f_0(Length_42, (MR_Integer) 0);
    D_57 = (Var_67 & (MR_Integer) 255);
    mercury__io__write_byte_4_p_0(OutputStream_6, A_54);
    mercury__io__write_byte_4_p_0(OutputStream_6, B_55);
    mercury__io__write_byte_4_p_0(OutputStream_6, C_56);
    mercury__io__write_byte_4_p_0(OutputStream_6, D_57);
    {
      Var_44 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&libs__pickle_scalar_common_1[1]));
      MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (libs__pickle__pickle_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_44, 3) = ((MR_Box) (OutputStream_6));
    }
    mercury__string__foldl_4_p_0((MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_44, String_10, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_20);
  }
  else
  {
    MR_Integer Int_11;
    ...
    if (succeeded)
    {
      ...
      Var_82 = mercury__int__f_62_62_2_f_0(Int_11, (MR_Integer) 24);
      A_78 = (Var_82 & (MR_Integer) 255);
      Var_85 = mercury__int__f_62_62_2_f_0(Int_11, (MR_Integer) 16);
      B_79 = (Var_85 & (MR_Integer) 255);
      Var_88 = mercury__int__f_62_62_2_f_0(Int_11, (MR_Integer) 8);
      C_80 = (Var_88 & (MR_Integer) 255);
      Var_91 = mercury__int__f_62_62_2_f_0(Int_11, (MR_Integer) 0);
      D_81 = (Var_91 & (MR_Integer) 255);
      mercury__io__write_byte_4_p_0(OutputStream_6, A_78);
      mercury__io__write_byte_4_p_0(OutputStream_6, B_79);
      mercury__io__write_byte_4_p_0(OutputStream_6, C_80);
      mercury__io__write_byte_4_p_0(OutputStream_6, D_81);
    }
    else
    {
      MR_Float Float_12;
      ...
      else
      {
        ...
        if (succeeded)
          libs__pickle__pickle_char_4_p_0(OutputStream_6, Char_13);
        else
        {
          MR_Word Pickle_16;
          MR_Word TypeDesc_14;
          ...
          succeeded = libs__pickle__user_defined_pickler_3_p_0(Pickles_7, TypeCtorDesc_15, &Pickle_16);
          if (succeeded)
          {
            MR_Word Var_25;
            void MR_CALL (* func_5)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *);
            MR_Box conv6_STATE_VARIABLE_IO_20;

            Var_25 = mercury__univ__univ_1_f_0(TypeInfo_for_T_31, T_8);
            func_5 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Pickle_16, (MR_Integer) 1))));
            func_5(((MR_Box) (Pickle_16)), ((MR_Box) (OutputStream_6)), ((MR_Box) (Pickles_7)), ((MR_Box) (Var_25)), ((MR_Box) ((MR_Integer) 0)), &conv6_STATE_VARIABLE_IO_20);
          }
          else
          {
...
#undef MR_PROC_LABEL
  ...
  Var_22 = mercury__int__f_62_62_2_f_0(A_8, (MR_Integer) 24);
  A_18 = (Var_22 & (MR_Integer) 255);
  Var_25 = mercury__int__f_62_62_2_f_0(A_8, (MR_Integer) 16);
  B_19 = (Var_25 & (MR_Integer) 255);
  Var_28 = mercury__int__f_62_62_2_f_0(A_8, (MR_Integer) 8);
  C_20 = (Var_28 & (MR_Integer) 255);
  Var_31 = mercury__int__f_62_62_2_f_0(A_8, (MR_Integer) 0);
  D_21 = (Var_31 & (MR_Integer) 255);
  mercury__io__write_byte_4_p_0(OutputStream_5, A_18);
  mercury__io__write_byte_4_p_0(OutputStream_5, B_19);
  mercury__io__write_byte_4_p_0(OutputStream_5, C_20);
  mercury__io__write_byte_4_p_0(OutputStream_5, D_21);
  Var_46 = mercury__int__f_62_62_2_f_0(B_9, (MR_Integer) 24);
  A_42 = (Var_46 & (MR_Integer) 255);
  Var_49 = mercury__int__f_62_62_2_f_0(B_9, (MR_Integer) 16);
  B_43 = (Var_49 & (MR_Integer) 255);
  Var_52 = mercury__int__f_62_62_2_f_0(B_9, (MR_Integer) 8);
  C_44 = (Var_52 & (MR_Integer) 255);
  Var_55 = mercury__int__f_62_62_2_f_0(B_9, (MR_Integer) 0);
  D_45 = (Var_55 & (MR_Integer) 255);
  mercury__io__write_byte_4_p_0(OutputStream_5, A_42);
  mercury__io__write_byte_4_p_0(OutputStream_5, B_43);
  mercury__io__write_byte_4_p_0(OutputStream_5, C_44);
  mercury__io__write_byte_4_p_0(OutputStream_5, D_45);
}
  ...
  MR_String String_6)
{
  ...
  Var_26 = mercury__int__f_62_62_2_f_0(Length_8, (MR_Integer) 24);
  A_22 = (Var_26 & (MR_Integer) 255);
  Var_29 = mercury__int__f_62_62_2_f_0(Length_8, (MR_Integer) 16);
  B_23 = (Var_29 & (MR_Integer) 255);
  Var_32 = mercury__int__f_62_62_2_f_0(Length_8, (MR_Integer) 8);
  C_24 = (Var_32 & (MR_Integer) 255);
  Var_35 = mercury__int__f_62_62_2_f_0(Length_8, (MR_Integer) 0);
  D_25 = (Var_35 & (MR_Integer) 255);
  mercury__io__write_byte_4_p_0(OutputStream_5, A_22);
  mercury__io__write_byte_4_p_0(OutputStream_5, B_23);
  mercury__io__write_byte_4_p_0(OutputStream_5, C_24);
  mercury__io__write_byte_4_p_0(OutputStream_5, D_25);
  {
