    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Pickles_83 = (MR_Word) (Pickles_7);
          succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__type_desc__type_desc__type_ctor_info_type_ctor_desc_0), (MR_Word) (&libs__pickle_scalar_common_1[0]), Pickles_83, ((MR_Box) (TypeCtorDesc_15)), &conv5_Pickle0_84);
          if (succeeded)
          {
            Pickle0_84 = ((MR_Word) (conv5_Pickle0_84));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
