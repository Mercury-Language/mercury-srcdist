...
{
  {
    ...
    if (libs__pickle__succeeded)
      *libs__pickle__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word libs__pickle__Var_4 = (MR_Word) libs__pickle__HeadVar__2_2;
        MR_Word libs__pickle__Var_5 = (MR_Word) libs__pickle__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &libs__pickle_scalar_common_3[1], libs__pickle__HeadVar__1_1, ((MR_Box) (libs__pickle__Var_4)), ((MR_Box) (libs__pickle__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (libs__pickle__succeeded)
      ...
      {
        MR_Word libs__pickle__Var_3 = (MR_Word) libs__pickle__HeadVar__1_1;
        MR_Word libs__pickle__Var_4 = (MR_Word) libs__pickle__HeadVar__2_2;

        {
          libs__pickle__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &libs__pickle_scalar_common_3[1], ((MR_Box) (libs__pickle__Var_3)), ((MR_Box) (libs__pickle__Var_4)));
        }
      }
    return libs__pickle__succeeded;
  }
    ...
    if (libs__pickle__succeeded)
      *libs__pickle__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &libs__pickle_scalar_common_3[0], libs__pickle__HeadVar__1_1, ((MR_Box) (libs__pickle__Var_4)), ((MR_Box) (libs__pickle__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (libs__pickle__succeeded)
    ...
    else
      {
        ...
        {
          libs__pickle__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &libs__pickle_scalar_common_3[0], ((MR_Box) (libs__pickle__Var_3)), ((MR_Box) (libs__pickle__Var_4)));
        }
      }
    return libs__pickle__succeeded;
  }
...
{
  {
    ...
    if (libs__pickle__succeeded)
      *libs__pickle__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String libs__pickle__Var_4 = (MR_String) libs__pickle__HeadVar__2_2;
        MR_String libs__pickle__Var_5 = (MR_String) libs__pickle__HeadVar__3_3;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(libs__pickle__HeadVar__1_1, libs__pickle__Var_4, libs__pickle__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (libs__pickle__succeeded)
      ...
      {
        MR_String libs__pickle__Var_3 = (MR_String) libs__pickle__HeadVar__1_1;
        MR_String libs__pickle__Var_4 = (MR_String) libs__pickle__HeadVar__2_2;

        libs__pickle__succeeded = (strcmp(libs__pickle__Var_3, libs__pickle__Var_4) == 0);
      }
    return libs__pickle__succeeded;
  }
}
