...
{
  {
    ...
    Var_66 = mercury__type_desc__type_of_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0);
    succeeded = mercury__type_desc____Unify____type_desc_0_0(TypeDesc_9, Var_66);
    if (succeeded)
    {
      MR_String String_13;
      MR_Integer Length_79;
      MR_String String0_80;
      MR_Integer STATE_VARIABLE_State_12_81;

      libs__pickle__unpickle_int32_4_p_0(Handle_8, &Length_79, STATE_VARIABLE_State_0_29, &STATE_VARIABLE_State_12_81);
{
...
#undef MR_PROC_LABEL
	 String0_80  = Str;
      ...
      libs__pickle__unpickle_string_2_7_p_0(Handle_8, (MR_Integer) 0, Length_79, String0_80, &String_13, STATE_VARIABLE_State_12_81, STATE_VARIABLE_State_30);
    ...
    else
    {
      ...
      Var_67 = mercury__type_desc__type_of_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
      ...
      else
      {
        ...
        Var_68 = mercury__type_desc__type_of_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_float_0);
        succeeded = mercury__type_desc____Unify____type_desc_0_0(TypeDesc_9, Var_68);
        if (succeeded)
        {
          MR_Float Float_17;
        ...
        else
        {
          ...
          Var_69 = mercury__type_desc__type_of_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0);
          succeeded = mercury__type_desc____Unify____type_desc_0_0(TypeDesc_9, Var_69);
          if (succeeded)
          {
            MR_Char Char_19;
          ...
          else
          {
            MR_Word Unpickle_20;
            MR_Word Var_39;
            MR_Word Unpicklers_90;
            MR_Word Unpickle0_91;
            MR_Box conv0_Unpickle0_91;

            Var_39 = mercury__type_desc__type_ctor_1_f_0(TypeDesc_9);
            Unpicklers_90 = (MR_Word) Unpicklers_7;
            succeeded = mercury__map__search_3_p_0((MR_Word) &mercury__type_desc__type_desc__type_ctor_info_type_ctor_desc_0, (MR_Word) &libs__pickle_scalar_common_2[0], Unpicklers_90, ((MR_Box) (Var_39)), &conv0_Unpickle0_91);
            if (succeeded)
            {
              Unpickle0_91 = ((MR_Word) conv0_Unpickle0_91);
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
  ...
  MR_Integer * STATE_VARIABLE_State_17)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      {
        MR_Char Char_13;
        MR_Integer STATE_VARIABLE_State_18_18 = (STATE_VARIABLE_State_0_16 + (MR_Integer) 1);
...
#undef MR_PROC_LABEL
	 STATE_VARIABLE_String_19_19  = Str;
        ...
        Var_20 = (Index_9 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Index_9 = Var_20;
          MR_String next_value_of_STATE_VARIABLE_String_0_14 = STATE_VARIABLE_String_19_19;
          MR_Integer next_value_of_STATE_VARIABLE_State_0_16 = STATE_VARIABLE_State_18_18;
...
{
  {
    ...
    *STATE_VARIABLE_State_10 = (STATE_VARIABLE_State_0_9 + (MR_Integer) 1);
...
{
  {
    ...
    MR_Integer D_11;
    MR_Integer Int0_12;
    MR_Integer STATE_VARIABLE_State_15_15 = (STATE_VARIABLE_State_0_13 + (MR_Integer) 1);
    ...
    STATE_VARIABLE_State_16_16 = (STATE_VARIABLE_State_15_15 + (MR_Integer) 1);
    ...
    STATE_VARIABLE_State_17_17 = (STATE_VARIABLE_State_16_16 + (MR_Integer) 1);
    ...
    *STATE_VARIABLE_State_14 = (STATE_VARIABLE_State_17_17 + (MR_Integer) 1);
    ...
    Var_21 = (A_8 << (MR_Integer) 24);
    Var_23 = (B_9 << (MR_Integer) 16);
    Var_20 = (Var_21 | Var_23);
    Var_25 = (C_10 << (MR_Integer) 8);
    Var_19 = (Var_20 | Var_25);
    Var_27 = (D_11 << (MR_Integer) 0);
    Int0_12 = (Var_19 | Var_27);
    Mask_75 = ((MR_Integer) 1 << (MR_Integer) 31);
    Var_78 = (Int0_12 ^ Mask_75);
    *Int_6 = (Var_78 - Mask_75);
  }
}
...
{
  {
    ...
    if ((SeeResult_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word ReadResult_11;

      mercury__io__read_binary_file_as_bitmap_3_p_0(&ReadResult_11);
      mercury__io__seen_binary_2_p_0();
      if (((MR_tag((MR_Word) ReadResult_11)) == (MR_mktag((MR_Integer) 1))))
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) TryResult_13)) == (MR_mktag((MR_Integer) 2))))
        {
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (!(succeeded))
      {
        ...
        succeeded = mercury__deconstruct__arg_4_p_0(TypeInfo_for_T_23, &TypeInfo_24_24, T_10, (MR_Integer) 0, N_8, &Arg_12);
        if (succeeded)
        {
          MR_Integer Var_17;

          libs__pickle__pickle_4_p_0(TypeInfo_24_24, Pickles_7, Arg_12);
          Var_17 = (N_8 + (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_N_8 = Var_17;
