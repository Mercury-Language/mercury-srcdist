...
{
  {
    ...
    libs__pickle__IntroducedFrom__pred__unpickle_from_file__238__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Box) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), wrapper_arg_1);
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        Var_17 = (MR_Integer) ((MR_Unsigned) N_8 + (MR_Unsigned) 1);
        // direct tailcall eliminated
        ;
