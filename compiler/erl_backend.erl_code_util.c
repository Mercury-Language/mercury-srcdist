  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv6_STATE_VARIABLE_Set_24;

    erl_backend__erl_code_util__erl_vars_in_term_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv6_STATE_VARIABLE_Set_24);
    *wrapper_arg_3 = ((MR_Box) (conv6_STATE_VARIABLE_Set_24));
  }
}
  ...
  top_of_proc_1:;
    {
      ...
      MR_Word * STATE_VARIABLE_Set_23 = tscc_output_1_STATE_VARIABLE_Set_23;
  ...
  top_of_proc_2:;
    {
      ...
      MR_Word * STATE_VARIABLE_Set_9 = tscc_output_1_STATE_VARIABLE_Set_23;
