  ...
  MR_Word * STATE_VARIABLE_PredInfo_23)
{
  ...
  MR_Word ProcInfo_21;
  MR_Word ProdVarsMap_25;
  MR_Word LambdaNesting0_26;
  MR_Word ForwardGoalPathMap_27;
  MR_Word MOI0_28;
  MR_Word Goal0_29;
  MR_Word Goal_30;
  ...
  ProdVarsMap_25 = check_hlds__mode_constraint_robdd__atomic_prodvars_map_2_f_0(Constraint_18, MCI_12);
  LambdaNesting0_26 = mercury__stack__init_0_f_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0));
  check_hlds__mode_constraint_robdd__get_forward_goal_path_map_for_pred_3_p_0(MCI_12, PredId_11, &ForwardGoalPathMap_27);
  {
    MOI0_28 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), MOI0_28, 0) = ((MR_Box) (InstGraph_20));
    MR_hl_field(MR_mktag(0), MOI0_28, 1) = ((MR_Box) (ProdVarsMap_25));
    MR_hl_field(MR_mktag(0), MOI0_28, 2) = ((MR_Box) (LambdaNesting0_26));
    MR_hl_field(MR_mktag(0), MOI0_28, 3) = ((MR_Box) (ModuleInfo_9));
    MR_hl_field(MR_mktag(0), MOI0_28, 4) = ((MR_Box) (PredConstraintMap_10));
    MR_hl_field(MR_mktag(0), MOI0_28, 5) = ((MR_Box) (ForwardGoalPathMap_27));
  }
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo0_16, &Goal0_29);
  GoalExpr0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_29, (MR_Integer) 0))));
  GoalInfo0_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_29, (MR_Integer) 1))));
  check_hlds__mode_ordering__mode_order_goal_2_6_p_0(GoalExpr0_33, &GoalExpr_35, GoalInfo0_34, &GoalInfo_36, MOI0_28, &_MOI_31);
  {
    Goal_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Goal_30, 0) = ((MR_Box) (GoalExpr_35));
    MR_hl_field(MR_mktag(0), Goal_30, 1) = ((MR_Box) (GoalInfo_36));
  }
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_30, ProcInfo0_16, &ProcInfo_21);
  ...
  MR_Word * STATE_VARIABLE_MOI_8)
{
  ...
  Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_MOI_0_7, (MR_Integer) 0))));
  Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_MOI_0_7, (MR_Integer) 1))));
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_MOI_0_7, (MR_Integer) 3))));
  Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_MOI_0_7, (MR_Integer) 4))));
  Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_MOI_0_7, (MR_Integer) 5))));
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  ModeConstraint0_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 0))));
  MCI_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 1))));
