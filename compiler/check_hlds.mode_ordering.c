  ...
  MR_Word * STATE_VARIABLE_PredInfo_23)
{
  ...
  check_hlds__mode_constraint_robdd__get_forward_goal_path_map_for_pred_3_p_0(MCI_12, PredId_11, &ForwardGoalPathMap_30);
  {
    ...
    MR_hl_field(MR_mktag(0), MOI0_31, 0) = ((MR_Box) (InstGraph_20));
    MR_hl_field(MR_mktag(0), MOI0_31, 1) = ((MR_Box) (ProdVarsMap_28));
    MR_hl_field(MR_mktag(0), MOI0_31, 2) = ((MR_Box) (LambdaNesting0_29));
    MR_hl_field(MR_mktag(0), MOI0_31, 3) = ((MR_Box) (ModuleInfo_9));
    MR_hl_field(MR_mktag(0), MOI0_31, 4) = ((MR_Box) (PredConstraintMap_10));
    MR_hl_field(MR_mktag(0), MOI0_31, 5) = ((MR_Box) (ForwardGoalPathMap_30));
  }
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo0_16, &Goal0_32);
  GoalExpr0_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_32, (MR_Integer) 0))));
  GoalInfo0_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_32, (MR_Integer) 1))));
  check_hlds__mode_ordering__mode_order_goal_2_6_p_0(GoalExpr0_36, &GoalExpr_38, GoalInfo0_37, &GoalInfo_39, MOI0_31, &_MOI_34);
  {
    ...
    MR_hl_field(MR_mktag(0), Goal_33, 0) = ((MR_Box) (GoalExpr_38));
    MR_hl_field(MR_mktag(0), Goal_33, 1) = ((MR_Box) (GoalInfo_39));
  }
  ...
  MR_Word * STATE_VARIABLE_MOI_27)
{
  ...
  MCInfo_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_52, (MR_Integer) 1))));
