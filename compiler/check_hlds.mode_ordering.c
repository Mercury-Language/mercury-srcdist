            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS0_38, (MR_Integer) 1)));
            ...
            case (MR_Integer) 2:
              {
                ...
                packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_38, (MR_Integer) 5)));
      ...
      case (MR_Integer) 2:
        {
          ...
          packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_7, (MR_Integer) 3)));
...
{
  {
    ...
    while (MR_TRUE)
    {
      ...
      ;
      (env).check_hlds__mode_ordering__find_matching_proc_2_8_p_0_env_0__succeeded = ((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1);
