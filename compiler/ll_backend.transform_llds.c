...
MR_decl_label9(ll_backend__transform_llds__split_computed_goto_9_0, 37,6,7,8,19,20,21,22,25)
...
MR_decl_label7(ll_backend__transform_llds__transform_instructions_6_0, 36,4,8,9,10,5,6)
...
MR_BEGIN_MODULE(ll_backend__transform_llds_module1)
	...
	MR_init_label9(ll_backend__transform_llds__split_computed_goto_9_0,37,6,7,8,19,20,21,22,25)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__transform_llds__split_computed_goto_9_0)
	...
	if (((MR_Integer) MR_r6 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(ll_backend__transform_llds__split_computed_goto_9_0_i37);
	}
	{
...
MR_def_label(ll_backend__transform_llds__split_computed_goto_9_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(13);
...
MR_def_label(ll_backend__transform_llds__split_computed_goto_9_0,7)
	...
	MR_np_call_localret_ent(list__det_split_list_4_0,
		ll_backend__transform_llds__split_computed_goto_9_0_i8);
MR_def_label(ll_backend__transform_llds__split_computed_goto_9_0,8)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		ll_backend__transform_llds__split_computed_goto_9_0_i19);
MR_def_label(ll_backend__transform_llds__split_computed_goto_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__transform_llds_module2)
	...
	MR_init_label7(ll_backend__transform_llds__transform_instructions_6_0,36,4,8,9,10,5,6)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__transform_llds__transform_instructions_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__transform_llds__transform_instructions_6_0_i36);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__transform_llds__transform_instructions_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
...
void mercury__ll_backend__transform_llds__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__transform_llds);
