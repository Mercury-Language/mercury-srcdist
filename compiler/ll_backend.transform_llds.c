  ...
  MR_Integer HeadVar__3_3)
{
  ...
  else
  {
    ...
    Var_40 = ((MR_String) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 0))));
    Var_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 1))));
    Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 2))));
    Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 3))));
    Var_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 4))) & (MR_Integer) 3);
    Var_47 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 7))) & (MR_Integer) 1);
    Var_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 8))));
    {
      Proc_7 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Proc_7, 0) = ((MR_Box) (Var_40));
      MR_hl_field(MR_mktag(0), Proc_7, 1) = ((MR_Box) (Var_41));
      MR_hl_field(MR_mktag(0), Proc_7, 2) = ((MR_Box) (Var_42));
      MR_hl_field(MR_mktag(0), Proc_7, 3) = ((MR_Box) (Var_43));
      MR_hl_field(MR_mktag(0), Proc_7, 4) = (MR_Box) ((MR_Unsigned) (Var_44));
      MR_hl_field(MR_mktag(0), Proc_7, 5) = ((MR_Box) (Instrs_13));
      MR_hl_field(MR_mktag(0), Proc_7, 6) = ((MR_Box) (C_14));
      MR_hl_field(MR_mktag(0), Proc_7, 7) = (MR_Box) ((MR_Unsigned) (Var_47));
      MR_hl_field(MR_mktag(0), Proc_7, 8) = ((MR_Box) (Var_48));
    }
  ...
  MR_Integer MaxSize_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__29_29 = (MR_Word) (&ll_backend__transform_llds_scalar_common_1[0]);
      mercury__list__length_2_p_0(TypeInfo__29_29, Targets_20, &NumTargets_22);
