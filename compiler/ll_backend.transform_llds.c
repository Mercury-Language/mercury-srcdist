...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__transform_llds__Globals_4, (MR_Integer) 319, &ll_backend__transform_llds__MaxSize_8);
    }
...
{
  {
    ...
    if (ll_backend__transform_llds__succeeded)
    ...
    else
      {
        ...
        MR_Word ll_backend__transform_llds__Var_39;
        MR_Word ll_backend__transform_llds__Var_44;
        MR_Word ll_backend__transform_llds__Var_45;
        MR_Word ll_backend__transform_llds__Var_47;
        MR_String ll_backend__transform_llds__Var_50;
        MR_Word ll_backend__transform_llds__STATE_VARIABLE_C_51_51;
        MR_String ll_backend__transform_llds__Var_53;
        MR_Integer ll_backend__transform_llds__Var_55;
        MR_Word ll_backend__transform_llds__Var_57;
        MR_Word ll_backend__transform_llds__Var_58;
        ...
        {
          ll_backend__transform_llds__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__Var_39, 0) = ((MR_Box) (ll_backend__transform_llds__Mid_19));
        }
        {
          ll_backend__transform_llds__Var_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_38, 1) = ((MR_Box) (ll_backend__transform_llds__Var_39));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Index_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__transform_llds_scalar_common_2[0])));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Index_22, 2) = ((MR_Box) (ll_backend__transform_llds__Rval_10));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Index_22, 3) = ((MR_Box) (ll_backend__transform_llds__Var_38));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Test_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__transform_llds_scalar_common_1[1])));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Test_23, 2) = ((MR_Box) (ll_backend__transform_llds__Rval_10));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Test_23, 3) = ((MR_Box) (ll_backend__transform_llds__Var_38));
        }
        {
          ll_backend__transform_llds__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__Var_44, 0) = ((MR_Box) (ll_backend__transform_llds__LabelNum_18));
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__Var_44, 1) = ((MR_Box) (ll_backend__transform_llds__ProcLabel_17));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__ElseAddr_24, 0) = ((MR_Box) (ll_backend__transform_llds__Var_44));
        }
        {
          ll_backend__transform_llds__Var_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_45, 1) = ((MR_Box) (ll_backend__transform_llds__Test_23));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_45, 2) = ((MR_Box) (ll_backend__transform_llds__ElseAddr_24));
        }
        {
          ll_backend__transform_llds__IfInstr_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__IfInstr_25, 0) = ((MR_Box) (ll_backend__transform_llds__Var_45));
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__IfInstr_25, 1) = ((MR_Box) ((MR_String) "binary search"));
        }
        {
          ll_backend__transform_llds__Var_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_47, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(3), ll_backend__transform_llds__Var_47, 1) = ((MR_Box) (ll_backend__transform_llds__Var_44));
        }
        {
          ll_backend__transform_llds__ElseInstr_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__ElseInstr_26, 0) = ((MR_Box) (ll_backend__transform_llds__Var_47));
          MR_hl_field(MR_mktag(0), ll_backend__transform_llds__ElseInstr_26, 1) = ((MR_Box) ((MR_String) ""));
        }
        {
          ll_backend__transform_llds__Var_50 = mercury__string__f_43_43_2_f_0(ll_backend__transform_llds__Comment_12, (MR_String) " then");
        }
        {
          ll_backend__transform_llds__split_computed_goto_9_p_0(ll_backend__transform_llds__Rval_10, ll_backend__transform_llds__StartTargets_20, ll_backend__transform_llds__Var_50, &ll_backend__transform_llds__ThenInstrs_27, ll_backend__transform_llds__STATE_VARIABLE_C_34_34, &ll_backend__transform_llds__STATE_VARIABLE_C_51_51, ll_backend__transform_llds__MaxSize_15, ll_backend__transform_llds__Mid_19, ll_backend__transform_llds__ProcLabel_17);
        }
        {
          ll_backend__transform_llds__Var_53 = mercury__string__f_43_43_2_f_0(ll_backend__transform_llds__Comment_12, (MR_String) " else");
        }
        ll_backend__transform_llds__Var_55 = (ll_backend__transform_llds__NumTargets_16 - ll_backend__transform_llds__Mid_19);
        {
          ll_backend__transform_llds__split_computed_goto_9_p_0(ll_backend__transform_llds__Index_22, ll_backend__transform_llds__EndTargets_21, ll_backend__transform_llds__Var_53, &ll_backend__transform_llds__ElseInstrs_28, ll_backend__transform_llds__STATE_VARIABLE_C_51_51, ll_backend__transform_llds__STATE_VARIABLE_C_30, ll_backend__transform_llds__MaxSize_15, ll_backend__transform_llds__Var_55, ll_backend__transform_llds__ProcLabel_17);
        }
        {
          ll_backend__transform_llds__Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__Var_57, 0) = ((MR_Box) (ll_backend__transform_llds__IfInstr_25));
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__Var_57, 1) = ((MR_Box) (ll_backend__transform_llds__ThenInstrs_27));
        }
        {
          ll_backend__transform_llds__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__Var_58, 0) = ((MR_Box) (ll_backend__transform_llds__ElseInstr_26));
          MR_hl_field(MR_mktag(1), ll_backend__transform_llds__Var_58, 1) = ((MR_Box) (ll_backend__transform_llds__ElseInstrs_28));
        }
        {
          *ll_backend__transform_llds__Instrs_13 = mercury__list__f_43_43_2_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, ll_backend__transform_llds__Var_57, ll_backend__transform_llds__Var_58);
        }
      }
  }
}
