  ...
  MR_Word * STATE_VARIABLE_CFile_18)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 600, &MaxSize_8);
  ...
  MR_String LastModule_5)
{
  ...
  ProcId_8 = hlds__pred_proc_id__initial_proc_id_0_f_0();
  PredId_9 = hlds__pred_proc_id__initial_pred_id_0_f_0();
  Var_16 = hlds__pred_proc_id__proc_id_to_int_1_f_0(ProcId_8);
  {
