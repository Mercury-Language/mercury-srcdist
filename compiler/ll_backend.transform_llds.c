...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 319, &MaxSize_8);
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Test_23, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
