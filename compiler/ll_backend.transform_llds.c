...
MR_decl_label10(ll_backend__transform_llds__split_computed_goto_9_0, 48,6,7,10,8,23,24,25,26,27)
...
MR_BEGIN_MODULE(ll_backend__transform_llds_module1)
	...
	MR_init_label10(ll_backend__transform_llds__split_computed_goto_9_0,48,6,7,10,8,23,24,25,26,27)
...
MR_def_static(ll_backend__transform_llds__split_computed_goto_9_0)
	...
	if (((MR_Integer) MR_r6 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(ll_backend__transform_llds__split_computed_goto_9_0_i48);
	}
	{
...
MR_def_label(ll_backend__transform_llds__split_computed_goto_9_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(13);
