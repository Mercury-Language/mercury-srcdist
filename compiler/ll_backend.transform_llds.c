  ...
  MR_Word * STATE_VARIABLE_CFile_18)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 379, &MaxSize_8);
  ...
  MR_Integer MaxSize_6)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_C_27_27;
    MR_Word Rval_19;
    MR_Word Targets_21;
    ...
    ll_backend__transform_llds__transform_instructions_6_p_0(Instrs0_13, &InstrsTail_18, STATE_VARIABLE_C_0_3, &STATE_VARIABLE_C_27_27, ProcLabel_5, MaxSize_6);
    Var_28 = ((MR_Word) ((MR_hl_field(0, Instr0_12, (MR_Integer) 0))));
    Comment_22 = ((MR_String) ((MR_hl_field(0, Instr0_12, (MR_Integer) 1))));
    succeeded = ((((MR_tag((MR_Word) Var_28)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_28, (MR_Integer) 0)))) == (MR_Integer) 7)));
    if (succeeded)
    {
      Rval_19 = ((MR_Word) ((MR_hl_field(3, Var_28, (MR_Integer) 1))));
      Targets_21 = ((MR_Word) ((MR_hl_field(3, Var_28, (MR_Integer) 3))));
    ...
    if (succeeded)
    {
      ...
      ll_backend__transform_llds__split_computed_goto_9_p_0(Rval_19, Targets_21, Comment_22, &InstrsHead_24, STATE_VARIABLE_C_27_27, STATE_VARIABLE_C_4, MaxSize_6, NumTargets_23, ProcLabel_5);
    ...
    else
    {
      ...
      *STATE_VARIABLE_C_4 = STATE_VARIABLE_C_27_27;
    }
  }
}
  ...
  MR_Word ProcLabel_17)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_C_35_35;
    MR_Word Var_40;
    MR_Word Var_41;
    MR_Word Var_47;
    MR_Word Var_48;
    MR_Word Var_50;
    MR_String Var_53;
    MR_Word STATE_VARIABLE_C_54_54;
    MR_String Var_56;
    MR_Integer Var_58;
    MR_Word Var_60;
    MR_Word Var_61;

    mercury__counter__allocate_3_p_0(&LabelNum_18, STATE_VARIABLE_C_0_29, &STATE_VARIABLE_C_35_35);
    ...
    ll_backend__transform_llds__split_computed_goto_9_p_0(Rval_10, StartTargets_20, Var_53, &ThenInstrs_27, STATE_VARIABLE_C_35_35, &STATE_VARIABLE_C_54_54, MaxSize_15, Mid_19, ProcLabel_17);
    ...
    ll_backend__transform_llds__split_computed_goto_9_p_0(Index_22, EndTargets_21, Var_56, &ElseInstrs_28, STATE_VARIABLE_C_54_54, STATE_VARIABLE_C_30, MaxSize_15, Var_58, ProcLabel_17);
    {
