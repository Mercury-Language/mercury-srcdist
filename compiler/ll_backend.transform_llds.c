...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 328, &MaxSize_8);
  ...
  MR_Integer HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word Var_48;
    MR_Word Var_53;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 4)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 7)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 4)));
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 7)));
    Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 8))));
    {
      ...
      MR_hl_field(MR_mktag(0), Proc_7, 4) = (MR_Box) (packed_args_2);
      MR_hl_field(MR_mktag(0), Proc_7, 5) = ((MR_Box) (Instrs_17));
      MR_hl_field(MR_mktag(0), Proc_7, 6) = ((MR_Box) (C_18));
      MR_hl_field(MR_mktag(0), Proc_7, 7) = (MR_Box) (packed_args_3);
