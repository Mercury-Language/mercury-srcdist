  ...
  MR_Integer HeadVar__3_3)
{
  ...
  else
  {
    ...
    Var_48 = ((MR_String) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 0))));
    Var_49 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 1))));
    Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 2))));
    Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 3))));
    packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 4)));
    Var_56 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 7))) & (MR_Integer) 1);
    Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc0_5, (MR_Integer) 8))));
    {
      Proc_7 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Proc_7, 0) = ((MR_Box) (Var_48));
      MR_hl_field(MR_mktag(0), Proc_7, 1) = ((MR_Box) (Var_49));
      MR_hl_field(MR_mktag(0), Proc_7, 2) = ((MR_Box) (Var_50));
      MR_hl_field(MR_mktag(0), Proc_7, 3) = ((MR_Box) (Var_51));
      ...
      MR_hl_field(MR_mktag(0), Proc_7, 7) = (MR_Box) ((MR_Unsigned) (Var_56));
      MR_hl_field(MR_mktag(0), Proc_7, 8) = ((MR_Box) (Var_57));
    }
