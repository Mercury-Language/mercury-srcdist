...
#line 51 "ll_backend.transform_llds.c"
...
#endif
#line 60 "ll_backend.transform_llds.c"
...
MR_decl_label8(ll_backend__transform_llds__split_computed_goto_9_0, 42,6,7,10,8,23,24,25)
MR_decl_label3(ll_backend__transform_llds__split_computed_goto_9_0, 26,27,30)
MR_decl_label8(ll_backend__transform_llds__transform_c_file_3_0, 2,3,5,7,11,12,13,14)
MR_decl_label5(ll_backend__transform_llds__transform_c_file_3_0, 21,22,24,8,29)
...
MR_BEGIN_MODULE(ll_backend__transform_llds_module0)
	...
	MR_init_label8(ll_backend__transform_llds__split_computed_goto_9_0,42,6,7,10,8,23,24,25)
	MR_init_label3(ll_backend__transform_llds__split_computed_goto_9_0,26,27,30)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__transform_llds_module4)
	...
	MR_init_label5(ll_backend__transform_llds__transform_c_file_3_0,21,22,24,8,29)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'transform_c_file'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,7)
	...
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, comp_gen_c_module);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(2);
...
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,14)
	...
	MR_np_call_localret_ent(fn__counter__init_1_0,
		ll_backend__transform_llds__transform_c_file_3_0_i21);
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_np_call_localret_ent(fn__set__init_0_0,
		ll_backend__transform_llds__transform_c_file_3_0_i22);
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 9);
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		ll_backend__transform_llds__transform_c_file_3_0_i24);
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ll_backend__transform_llds__transform_c_file_3_0_i29);
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
MR_def_label(ll_backend__transform_llds__transform_c_file_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
/*-------------------------------------------------------------------------*/
/* code for 'transform_llds'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
