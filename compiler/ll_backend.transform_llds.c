...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Modules1_9)) == (MR_Integer) 1);
      if (succeeded)
      {
      }
    }
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_27)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_27, (MR_Integer) 0))) == (MR_Integer) 7)));
      if (succeeded)
      {
