    ...
    case (MR_Integer) 0:
      {
        ...
        switch (MR_tag((MR_Word) MsgA_6)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Pieces_21 = ((MR_Word) ((MR_hl_field(0, MsgA_6, (MR_Integer) 1))));
              MR_Word Var_27;
          ...
          case (MR_Integer) 1:
            {
              MR_Word Pieces_29 = ((MR_Word) ((MR_hl_field(1, MsgA_6, (MR_Integer) 0))));
              MR_Word Var_30;
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, MsgA_6, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                ComponentsA_14 = ((MR_Word) ((MR_hl_field(3, MsgA_6, (MR_Integer) 4))));
                break;
              case (MR_Integer) 1:
        ...
        switch (MR_tag((MR_Word) MsgB_7)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Pieces_33 = ((MR_Word) ((MR_hl_field(0, MsgB_7, (MR_Integer) 1))));
              MR_Word Var_39;
          ...
          case (MR_Integer) 1:
            {
              MR_Word Pieces_41 = ((MR_Word) ((MR_hl_field(1, MsgB_7, (MR_Integer) 0))));
              MR_Word Var_42;
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, MsgB_7, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                ComponentsB_15 = ((MR_Word) ((MR_hl_field(3, MsgB_7, (MR_Integer) 4))));
                break;
              case (MR_Integer) 1:
  ...
  MR_Word * Msg_6)
{
  ...
  switch (MR_tag((MR_Word) Msg0_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_19;
        MR_Word Pieces0_28 = ((MR_Word) ((MR_hl_field(1, Msg0_5, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Context_29 = ((MR_Word) ((MR_hl_field(2, Msg0_5, (MR_Integer) 0))));
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Msg0_5, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MaybeContext_9 = ((MR_Word) ((MR_hl_field(3, Msg0_5, (MR_Integer) 1))));
            TreatAsFirst_10 = ((MR_Unsigned) ((MR_hl_field(3, Msg0_5, (MR_Integer) 2))) & (MR_Integer) 1);
            ExtraIndent_11 = ((MR_Unsigned) ((MR_hl_field(3, Msg0_5, (MR_Integer) 3))));
            Components0_12 = ((MR_Word) ((MR_hl_field(3, Msg0_5, (MR_Integer) 4))));
          }
          break;
        case (MR_Integer) 1:
          {
  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  ...
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 200)), &ReverseErrorOrder_6);
  {
