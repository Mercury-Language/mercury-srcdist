...
static /* final */ const MR_Box parse_tree__error_sort_scalar_common_4[1][8];
...
static /* final */ const MR_Box parse_tree__error_sort_scalar_common_7[2][7];

static /* final */ const MR_Box parse_tree__error_sort_scalar_common_8[1][4];
...
static /* final */ const MR_Box parse_tree__error_sort_scalar_common_8[1][4] = {
  /* row   0 */
  {
    ((MR_Box) (&parse_tree__error_sort_scalar_common_7[0])),
  ...
  MR_Word * Result_10)
{
  ...
  parse_tree__error_spec__extract_spec_msgs_and_id_opt_table_4_p_0(OptionTable_6, SpecA_8, &MsgsA_11, &_IdA_12);
  parse_tree__error_spec__extract_spec_msgs_and_id_opt_table_4_p_0(OptionTable_6, SpecB_9, &MsgsB_13, &_IdB_14);
  parse_tree__error_sort__compare_error_msg_lists_4_p_0(ReverseErrorOrder_7, MsgsA_11, MsgsB_13, &MsgsResult_15);
  switch (MsgsResult_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
    case (MR_Integer) 2:
      *Result_10 = MsgsResult_15;
      break;
    case (MR_Integer) 0:
  ...
  MR_Word * Result_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_18 = ((MR_Word) ((MR_hl_field(1, MsgsA_6, 1))));
      MR_Word Var_19 = ((MR_Word) ((MR_hl_field(1, MsgsA_6, 0))));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__error_sort__remove_conditionals_in_msg_component_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ComponentCord_18);
  ...
  MR_Word * Msg_6)
{
  ...
  }
  {
    ...
    MR_hl_field(0, Var_26, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_7[1]));
  ...
  Var_27 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0), (MR_Word) (&parse_tree__error_sort_scalar_common_1[1]), Var_26, Components0_12, ((MR_Box) (Var_27)), &conv1_ComponentCord_13);
  ...
  {
    {
      ...
      *Msg_6 = base;
      ...
      MR_hl_field(3, base, 4) = ((MR_Box) (Components_14));
    }
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = parse_tree__error_sort__remove_conditionals_in_msg_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Msg_6);
  if (succeeded)
  {
  ...
  MR_Word * Spec_6)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        Severity0_27 = ((MR_Word) ((MR_hl_field(0, Spec0_5, 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Severity0_28 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 1))));
        Phase_9 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 2))));
        Pieces0_29 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 3))));
    ...
    case (MR_Integer) 2:
      {
        ...
        MaybeActualSeverity_11 = parse_tree__error_util__actual_error_severity_opt_table_2_f_0(OptionTable_4, Severity0_8);
        {
          ...
          MR_hl_field(0, Var_22, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_3[2]));
    ...
    case (MR_Integer) 3:
      {
        ...
        Id_7 = ((MR_String) ((MR_hl_field(3, Spec0_5, 0))));
        Option_15 = ((((MR_Unsigned) ((MR_hl_field(3, Spec0_5, 1))) >> 1)) & (MR_Integer) 1023);
        MatchValue_16 = ((MR_Unsigned) ((MR_hl_field(3, Spec0_5, 1))) & (MR_Integer) 1);
        Severity0_30 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 2))));
        Phase_9 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 3))));
        Msgs_12 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 4))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ActualSeverity_18 = ((MR_Word) ((MR_hl_field(1, MaybeActualSeverity_11, 0))));
...
parse_tree__error_sort__sort_error_msgs_2_p_0(
  ...
  MR_Word * Msgs_4)
{
  mercury__list__sort_and_remove_dups_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), (MR_Word) (&parse_tree__error_sort_scalar_common_8[0]), Msgs0_3, Msgs_4);
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__error_sort__compare_error_specs_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_Result_10);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = parse_tree__error_sort__remove_conditionals_in_spec_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Spec_6);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  ...
  MR_Word Var_9;
  MR_Word STATE_VARIABLE_Specs_1_10;
  MR_Word Var_12;

  {
    Var_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_9, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_3[0]));
  ...
  mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_9, STATE_VARIABLE_Specs_0_7, &STATE_VARIABLE_Specs_1_10);
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 140)), &ReverseErrorOrder_6);
  {
    Var_12 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_12, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_4[0]));
  ...
  mercury__list__sort_and_remove_dups_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_12, STATE_VARIABLE_Specs_1_10, STATE_VARIABLE_Specs_8);
}
