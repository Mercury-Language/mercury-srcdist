...
static /* final */ const MR_Box parse_tree__error_sort_scalar_common_1[2][2];
  ...
  MR_Word * Msg_6)
{
    ...
    case (MR_Integer) 3:
      {
        ...
        ExtraIndent_11 = ((MR_Integer) ((MR_hl_field(3, Msg0_5, (MR_Integer) 2))));
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0), (MR_Word) (&parse_tree__error_sort_scalar_common_1[0]), Var_21, Components0_12, ((MR_Box) (Var_22)), &conv1_ComponentCord_13);
