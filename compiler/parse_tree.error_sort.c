...
static MR_bool MR_CALL 
parse_tree__error_sort__remove_conditionals_in_spec_3_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
  ...
  MR_Box * wrapper_arg_2)
{
  MR_bool succeeded;
  MR_Box closure = closure_arg;
  MR_Word conv1_StdMsg_6;

  succeeded = parse_tree__error_sort__remove_conditionals_in_msg_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_StdMsg_6);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv1_StdMsg_6));
    succeeded = MR_TRUE;
  }
  return succeeded;
}
  ...
  MR_Word * StdSpec_6)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_26;
        MR_Word Var_27;
        MR_Word Severity0_39;

        Id_7 = ((MR_String) ((MR_hl_field(0, Spec0_5, 0))));
        Severity0_39 = ((MR_Word) ((MR_hl_field(0, Spec0_5, 1))));
        ...
        Pieces0_14 = ((MR_Word) ((MR_hl_field(0, Spec0_5, 4))));
        {
          ...
          MR_hl_field(1, MaybeStdSeverity_11, 0) = ((MR_Box) (Severity0_39));
        }
        {
          Var_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_23, 0) = ((MR_Box) (Context0_13));
        }
        {
          Var_27 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_27, 0) = ((MR_Box) (Pieces0_14));
        }
        {
        ...
        {
          Var_22 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          ...
          MR_hl_field(3, Var_22, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, Var_22, 4) = ((MR_Box) (Var_26));
        }
        {
          StdMsgs_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdMsgs_12, 0) = ((MR_Box) (Var_22));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Var_34;
        MR_Word Var_35;
        MR_Word Severity0_40;
        MR_Word Pieces0_41;

        Id_7 = ((MR_String) ((MR_hl_field(1, Spec0_5, 0))));
        Severity0_40 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 1))));
        Phase_9 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 2))));
        Pieces0_41 = ((MR_Word) ((MR_hl_field(1, Spec0_5, 3))));
        {
          MaybeStdSeverity_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeStdSeverity_11, 0) = ((MR_Box) (Severity0_40));
        }
        {
          Var_35 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_35, 0) = ((MR_Box) (Pieces0_41));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(3, Var_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, Var_30, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
          MR_hl_field(3, Var_30, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, Var_30, 4) = ((MR_Box) (Var_34));
        }
        {
          StdMsgs_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdMsgs_12, 0) = ((MR_Box) (Var_30));
          MR_hl_field(1, StdMsgs_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
    ...
    case (MR_Integer) 2:
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Var_21, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_3[2]));
          MR_hl_field(0, Var_21, 1) = ((MR_Box) (parse_tree__error_sort__remove_conditionals_in_spec_3_p_0_2));
          MR_hl_field(0, Var_21, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_21, 3) = ((MR_Box) (OptionTable_4));
        }
        mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_std_error_msg_0), Var_21, Msgs0_10, &StdMsgs_12);
    ...
    case (MR_Integer) 3:
      {
        ...
        Severity0_42 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 2))));
        Phase_9 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 3))));
        Msgs0_43 = ((MR_Word) ((MR_hl_field(3, Spec0_5, 4))));
        ...
        if (succeeded)
        {
          TypeCtorInfo_51_51 = (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0);
          TypeCtorInfo_52_52 = (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_std_error_msg_0);
          {
            MaybeStdSeverity_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeStdSeverity_11, 0) = ((MR_Box) (Severity0_42));
          }
          {
            Var_38 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_38, 0) = ((MR_Box) (&parse_tree__error_sort_scalar_common_3[2]));
            MR_hl_field(0, Var_38, 1) = ((MR_Box) (parse_tree__error_sort__remove_conditionals_in_spec_3_p_0_1));
            MR_hl_field(0, Var_38, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_38, 3) = ((MR_Box) (OptionTable_4));
          }
          mercury__list__filter_map_3_p_0(TypeCtorInfo_51_51, TypeCtorInfo_52_52, Var_38, Msgs0_43, &StdMsgs_12);
          succeeded = (StdMsgs_12 != (MR_Word) ((MR_Unsigned) 0U));
        }
      }
      break;
  ...
  if (succeeded)
  {
    succeeded = (MaybeStdSeverity_11 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      StdSeverity_18 = ((MR_Word) ((MR_hl_field(1, MaybeStdSeverity_11, 0))));
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        *StdSpec_6 = base;
        MR_hl_field(2, base, 0) = ((MR_Box) (Id_7));
        MR_hl_field(2, base, 1) = ((MR_Box) (StdSeverity_18));
