...
{
  MR_bool succeeded;
  MR_Word MaybeContext_7;
  MR_Word TreatAsFirst_8;
  MR_Unsigned ExtraIndent_9;
  MR_Word StdComponents_10;
  ...
  switch (MR_tag((MR_Word) Msg0_3)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          MaybeContext_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeContext_7, 0) = ((MR_Box) (Context_5));
        }
        TreatAsFirst_8 = (MR_Integer) 1;
        ExtraIndent_9 = (MR_Unsigned) 0U;
        {
          Var_13 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_13, 0) = ((MR_Box) (Pieces0_6));
        }
        {
          StdComponents_10 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdComponents_10, 0) = ((MR_Box) (Var_13));
          MR_hl_field(1, StdComponents_10, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_15;
        MR_Word Pieces0_22 = ((MR_Word) ((MR_hl_field(1, Msg0_3, 0))));

        MaybeContext_7 = (MR_Word) ((MR_Unsigned) 0U);
        TreatAsFirst_8 = (MR_Integer) 1;
        ExtraIndent_9 = (MR_Unsigned) 0U;
        {
          Var_15 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_15, 0) = ((MR_Box) (Pieces0_22));
        }
        {
          StdComponents_10 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdComponents_10, 0) = ((MR_Box) (Var_15));
          MR_hl_field(1, StdComponents_10, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word Context_23 = ((MR_Word) ((MR_hl_field(2, Msg0_3, 0))));

        StdComponents_10 = ((MR_Word) ((MR_hl_field(2, Msg0_3, 1))));
        succeeded = (StdComponents_10 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          TreatAsFirst_8 = (MR_Integer) 1;
          ExtraIndent_9 = (MR_Unsigned) 0U;
          {
            MaybeContext_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeContext_7, 0) = ((MR_Box) (Context_23));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Msg0_3, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MaybeContext_7 = ((MR_Word) ((MR_hl_field(3, Msg0_3, 1))));
            TreatAsFirst_8 = ((MR_Unsigned) ((MR_hl_field(3, Msg0_3, 2))) & (MR_Integer) 1);
            ExtraIndent_9 = ((MR_Unsigned) ((MR_hl_field(3, Msg0_3, 3))));
            StdComponents_10 = ((MR_Word) ((MR_hl_field(3, Msg0_3, 4))));
            succeeded = (StdComponents_10 != (MR_Word) ((MR_Unsigned) 0U));
          }
          break;
        case (MR_Integer) 1:
          {
            succeeded = ((MR_Word) (MR_mkword(1, &parse_tree__error_sort_scalar_common_1[3])) != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              MaybeContext_7 = ((MR_Word) ((MR_hl_field(3, Msg0_3, 1))));
              TreatAsFirst_8 = (MR_Integer) 0;
              ExtraIndent_9 = (MR_Unsigned) 0U;
              StdComponents_10 = (MR_Word) (MR_mkword(1, &parse_tree__error_sort_scalar_common_1[3]));
              succeeded = MR_TRUE;
            }
          }
          break;
  ...
  {
    {
      ...
      *StdMsg_4 = base;
      ...
      MR_hl_field(3, base, 2) = (MR_Box) ((MR_Unsigned) (TreatAsFirst_8));
      MR_hl_field(3, base, 3) = ((MR_Box) (ExtraIndent_9));
      MR_hl_field(3, base, 4) = ((MR_Box) (StdComponents_10));
    }
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = parse_tree__error_sort__standardize_error_msg_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_StdMsg_4);
  if (succeeded)
  {
    ...
    case (MR_Integer) 0:
      {
        ...
        Id_5 = ((MR_String) ((MR_hl_field(0, Spec0_3, 0))));
        Severity_6 = ((MR_Word) ((MR_hl_field(0, Spec0_3, 1))));
        Phase_7 = ((MR_Word) ((MR_hl_field(0, Spec0_3, 2))));
        Context0_10 = ((MR_Word) ((MR_hl_field(0, Spec0_3, 3))));
        Pieces0_11 = ((MR_Word) ((MR_hl_field(0, Spec0_3, 4))));
        {
        ...
        {
          StdMsgs_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdMsgs_9, 0) = ((MR_Box) (Var_15));
          MR_hl_field(1, StdMsgs_9, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        Id_5 = ((MR_String) ((MR_hl_field(1, Spec0_3, 0))));
        Severity_6 = ((MR_Word) ((MR_hl_field(1, Spec0_3, 1))));
        Phase_7 = ((MR_Word) ((MR_hl_field(1, Spec0_3, 2))));
        Pieces0_31 = ((MR_Word) ((MR_hl_field(1, Spec0_3, 3))));
        {
          Var_28 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_28, 0) = ((MR_Box) (Pieces0_31));
        }
        {
        ...
        {
          StdMsgs_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, StdMsgs_9, 0) = ((MR_Box) (Var_23));
          MR_hl_field(1, StdMsgs_9, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
    ...
    case (MR_Integer) 2:
      {
        ...
        Id_5 = ((MR_String) ((MR_hl_field(2, Spec0_3, 0))));
        Severity_6 = ((MR_Word) ((MR_hl_field(2, Spec0_3, 1))));
        Phase_7 = ((MR_Word) ((MR_hl_field(2, Spec0_3, 2))));
        Msgs0_8 = ((MR_Word) ((MR_hl_field(2, Spec0_3, 3))));
        mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_std_error_msg_0), (MR_Word) (&parse_tree__error_sort_scalar_common_4[3]), Msgs0_8, &StdMsgs_9);
        succeeded = (StdMsgs_9 != (MR_Word) ((MR_Unsigned) 0U));
      }
      break;
  }
  if (succeeded)
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = parse_tree__error_sort__standardize_error_spec_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_StdSpec_4);
  if (succeeded)
  {
  ...
  MR_Word * StdSpecs_4)
{
  ...
  mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_std_error_spec_0), (MR_Word) (&parse_tree__error_sort_scalar_common_4[0]), Specs_3, StdSpecs_4);
}
