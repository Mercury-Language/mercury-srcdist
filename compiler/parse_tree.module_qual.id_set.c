        ...
        switch (InInt_11) {
          ...
          case (MR_Integer) 1:
            ...
            else
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), PermInInt_55, (MR_Integer) 0)));
    ...
    switch (InInt_11) {
      ...
      case (MR_Integer) 1:
        ...
        else
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), PermInInt_18, (MR_Integer) 0)));
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), PermInInt_14, (MR_Integer) 0)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), OldPermInt_42, (MR_Integer) 0)));
              ...
              else
              {
                ...
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), NewPermInt_44, (MR_Integer) 0)));
