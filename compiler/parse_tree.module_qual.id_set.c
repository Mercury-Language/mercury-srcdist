      ...
      if (succeeded)
      {
        ...
        switch (InInt_11) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            if ((PermInInt_55 == (MR_Word) ((MR_Integer) 0)))
            {
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    switch (InInt_11) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        if ((PermInInt_18 == (MR_Word) ((MR_Integer) 0)))
        {
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      Matches_22 = (MR_Word) ((MR_Integer) 0);
      IntMismatches_23 = (MR_Word) ((MR_Integer) 0);
      QualMismatches_24 = (MR_Word) ((MR_Integer) 0);
    }
    if ((Matches_22 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      if ((Var_56 == (MR_Word) ((MR_Integer) 0)))
      {
        {
      ...
      else
      {
        ...
        MaybeUniqModuleName_107 = (MR_Word) ((MR_Integer) 0);
      ...
      if ((MaybeUniqModuleName_107 == (MR_Word) ((MR_Integer) 0)))
      {
        *SymName_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Id0_15, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_PossibleArities_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__foldr3_8_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__module_qual__id_set__parse_tree__module_qual__id_set__type_ctor_info_module_permissions_0), (MR_Word) (&parse_tree__module_qual__id_set_scalar_common_2[0]), (MR_Word) (&parse_tree__module_qual__id_set_scalar_common_2[0]), (MR_Word) (&parse_tree__module_qual__id_set_scalar_common_2[0]), Var_36, PermissionsMap_14, ((MR_Box) ((MR_Integer) 0)), &conv5_Matches_15, ((MR_Box) ((MR_Integer) 0)), &conv4_IntMismatches_16, ((MR_Box) ((MR_Integer) 0)), &conv3_QualMismatches_17);
