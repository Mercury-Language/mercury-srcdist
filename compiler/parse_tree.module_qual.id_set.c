  ...
  MR_Word * STATE_VARIABLE_QualMismatches_29)
{
  ...
  if (((MR_tag((MR_Word) SymName_12)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        OtherPermission_45 = PermUnqual_43;
      }
      else
      {
        Permission_44 = PermUnqual_43;
        OtherPermission_45 = PermQual_42;
      }
      switch (Permission_44) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            switch (OtherPermission_45) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  {
  ...
  else
  {
    ...
    MR_Word OtherPermission_56;

    switch (InInt_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          OtherPermission_56 = ((((MR_Unsigned) ((MR_hl_field(0, PermInImp_52, 0))) >> 2)) & (MR_Integer) 3);
          Permission_55 = ((MR_Unsigned) ((MR_hl_field(0, PermInImp_52, 0))) & (MR_Integer) 3);
        }
        break;
      case (MR_Integer) 1:
        {
          OtherPermission_56 = ((((MR_Unsigned) ((MR_hl_field(0, PermInInt_51, 0))) >> 2)) & (MR_Integer) 3);
