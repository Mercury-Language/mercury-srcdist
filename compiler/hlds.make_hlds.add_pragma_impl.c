...
static const MR_FA_PseudoTypeInfo_Struct1 hlds__make_hlds__add_pragma_impl__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static /* final */ const MR_Box hlds__make_hlds__add_pragma_impl_scalar_common_4[2][12] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0)),
    ((MR_Box) (&hlds__make_hlds__add_pragma_impl__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0)),
    ((MR_Box) (&hlds__make_hlds__add_pragma_impl__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0))
  },
  /* row   1 */
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_40)
{
  ...
  if (((MR_tag((MR_Word) MatchingPredIdResult_20)) == (MR_Integer) 1))
  {
    ...
    *STATE_VARIABLE_Specs_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ErrorSpecs_36, STATE_VARIABLE_Specs_0_39);
    ...
    else
    {
      ...
      else
      {
        ...
        Pieces_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[4])), Var_50);
        {
          ...
          MR_hl_field(0, Spec_35, 2) = ((MR_Box) ((MR_Unsigned) 48U));
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  if (((MR_tag((MR_Word) MatchingPredIdResult_22)) == (MR_Integer) 1))
  {
    ...
    *STATE_VARIABLE_Specs_45 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ErrorSpecs_41, STATE_VARIABLE_Specs_0_44);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) CheckResult_27)) == (MR_Integer) 1))
    {
      ...
      *STATE_VARIABLE_Specs_45 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), CheckSpecs_28, STATE_VARIABLE_Specs_0_44);
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  if (((MR_tag((MR_Word) MaybePredId_21)) == (MR_Integer) 0))
  {
    ...
    if ((Origin_9 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_Specs_45 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Specs_8, STATE_VARIABLE_Specs_0_44);
    else
  ...
  else
  {
    ...
    else
    {
      if ((Origin_9 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        hlds__make_hlds_error__report_undeclared_mode_error_8_p_0(STATE_VARIABLE_ModuleInfo_0_42, PredId_22, PredInfo_23, VarSet_13, ArgModes_18, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[22])), Context_14, &Spec_108);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_Specs_45 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (Spec_108));
          MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_44));
        }
      }
      else
