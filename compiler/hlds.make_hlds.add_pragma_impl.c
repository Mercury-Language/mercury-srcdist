  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 749, &TypeLayout_20);
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              switch (PredOrFunc_74) {
                ...
                case (MR_Integer) 1:
                  {
                    hlds__pred_table__predicate_table_lookup_func_sym_arity_5_p_0(PredicateTable0_73, (MR_Integer) 0, SymName_75, UserArity_76, &PredIds_77);
                    hlds__pred_table__predicate_table_lookup_func_sym_4_p_0(PredicateTable0_73, (MR_Integer) 0, SymName_75, &AllArityPredIds_78);
                    DeclPieces_79 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[27]));
                  }
                  break;
                case (MR_Integer) 0:
                  {
                    hlds__pred_table__predicate_table_lookup_pred_sym_arity_5_p_0(PredicateTable0_73, (MR_Integer) 0, SymName_75, UserArity_76, &PredIds_77);
                    hlds__pred_table__predicate_table_lookup_pred_sym_4_p_0(PredicateTable0_73, (MR_Integer) 0, SymName_75, &AllArityPredIds_78);
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_46)
{
  ...
  parse_tree__prog_item__pfumm_to_maybe_pf_arity_maybe_modes_4_p_0(PFUMM_16, &MaybePredOrFunc_18, &UserArity_19, &MaybeModes_20);
  UserArityInt_21 = (MR_Integer) (UserArity_19);
  PFU_22 = parse_tree__prog_item__maybe_pred_or_func_to_pfu_1_f_0(MaybePredOrFunc_18);
  ...
  else
  {
    ...
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Procs0_29, &Procs_30);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Procs0_29, ((MR_Box) (ProcId_32)), &conv4_Proc_33);
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_51)
{
  ...
  else
  {
    ...
    ll_backend__fact_table_gen__fact_table_check_args_5_p_0(STATE_VARIABLE_ModuleInfo_0_46, Context_20, PredId_26, PredInfo0_29, &CheckResult_30);
    if (((MR_tag((MR_Word) CheckResult_30)) == (MR_Integer) 1))
    {
      ...
      *STATE_VARIABLE_ErrSpecs_49 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), CheckSpecs_31, STATE_VARIABLE_ErrSpecs_0_48);
      ...
      hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 30, PredMarkers0_32, &PredMarkers_33);
    ...
    {
      MR_Word GenInfo_35 = ((MR_Word) ((MR_hl_field(0, CheckResult_30, 0))));
      ...
      ll_backend__fact_table_gen__fact_table_compile_facts_13_p_0(ProgressStream_11, STATE_VARIABLE_ModuleInfo_0_46, FileName_19, Context_20, GenInfo_35, &C_HeaderCode_37, &PrimaryProcId_38, PredInfo0_29, &PredInfo1_39, STATE_VARIABLE_ErrSpecs_0_48, &STATE_VARIABLE_ErrSpecs_2_59);
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_16)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_6, ((MR_Box) (ProcId_44)), &conv0_ProcInfo_58);
      ProcInfo_58 = ((MR_Word) (conv0_ProcInfo_58));
      hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_58, &InstVarSet_59);
