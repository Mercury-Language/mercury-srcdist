...
static /* final */ const MR_Box hlds__make_hlds__add_pragma_impl_scalar_common_1[106][2] = {
  ...
  /* row 101 */
  {
    ((MR_Box) (MR_mkword(2, &hlds__make_hlds__add_pragma_impl_scalar_common_1[100]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 102 */
  {
  ...
  /* row 103 */
  {
    ((MR_Box) (MR_mkword(2, &hlds__make_hlds__add_pragma_impl_scalar_common_1[102]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 104 */
  {
  ...
  /* row 105 */
  {
    ((MR_Box) (MR_mkword(2, &hlds__make_hlds__add_pragma_impl_scalar_common_1[104]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_36)
{
  ...
  else
  {
    ...
    Var_47 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[45])));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_67, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[18])));
    }
    Var_66 = parse_tree__error_spec__color_as_subject_1_f_0(Var_67);
    Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_66, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[19])));
    ...
    Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[37])), Var_63);
    ...
    MainPieces_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[4])), Var_46);
    ...
    }
    {
      ...
      MR_hl_field(0, Var_87, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_impl_scalar_common_1[47])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(2, Spec_31, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_pragma_impl.add_pragma_require_tail_rec_proc\'/10"));
