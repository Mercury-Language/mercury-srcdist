  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 522, &NormalErrors_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 523, &VerboseErrors_21);
  {
