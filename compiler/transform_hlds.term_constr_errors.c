...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_errors__Globals_19, (MR_Integer) 418, &transform_hlds__term_constr_errors__NormalErrors_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_errors__Globals_19, (MR_Integer) 419, &transform_hlds__term_constr_errors__VerboseErrors_21);
    }
    {
