...
{
  {
    ...
    if ((((ErrorKind_24 == (MR_Word) ((MR_Integer) 4))) || (((MR_tag((MR_Word) ErrorKind_24)) == (MR_Integer) 3))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    return succeeded;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 437, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 438, &VerboseErrors_21);
    {
...
{
  {
    ...
    else
    {
      ...
      Single_15 = (MR_Word) ((MR_Integer) 0);
    }
    ...
    else
    {
      ...
      if ((Var_73 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        transform_hlds__term_constr_errors__describe_term2_error_6_p_0(ModuleInfo_6, Single_15, (MR_Word) ((MR_Integer) 0), Var_74, Var_51, &ReasonMsgsCord_18);
      }
      else
      {
        MR_Word Var_45;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) ((MR_Integer) 56));
...
{
  {
    ...
    if ((MaybeErrorNum_9 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((Single_6 == (MR_Word) ((MR_Integer) 0)))
          {
