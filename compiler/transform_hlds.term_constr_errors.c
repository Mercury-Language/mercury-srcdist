  ...
  MR_Word * STATE_VARIABLE_ReasonMsgsCord_21)
{
  ...
  switch (MR_tag((MR_Word) ErrorKind_13)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word CallerPPId_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ErrorKind_13, (MR_Integer) 0))));
        MR_Word CalleePPId_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ErrorKind_13, (MR_Integer) 1))));
        MR_Word Piece1_36;
        ...
        {
          MR_Word PPId_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Single_8, (MR_Integer) 0))));
          MR_Word Var_60;

          {
            Var_60 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[0]));
            MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (transform_hlds__term_constr_errors__describe_term2_error_6_p_0_1));
            MR_hl_field(MR_mktag(0), Var_60, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_60, 3) = ((MR_Box) (CallerPPId_33));
            MR_hl_field(MR_mktag(0), Var_60, 4) = ((MR_Box) (PPId_35));
          }
          mercury__require__expect_3_p_0(Var_60, (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "caller outside this SCC");
          Piece1_36 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[13]));
        }
        CalleePiece_38 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_7, (MR_Integer) 0, CalleePPId_34);
        Var_71 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), CalleePiece_38, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[17])));
        Var_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[18])), Var_71);
        Pieces0_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Piece1_36, Var_68);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word PredId_40 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ErrorKind_13, (MR_Integer) 0))));
        MR_Word Pieces2_44;
        ...
        if ((Single_8 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Pieces2_44 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredDesc_45, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[30])));
        }
        else
        {
          MR_Word SCCPredId_42;
          MR_Word Var_56;
          MR_Word PPId_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Single_8, (MR_Integer) 0))));

          SCCPredId_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPId_72, (MR_Integer) 0))));
          {
            Var_56 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[1]));
            MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (transform_hlds__term_constr_errors__describe_term2_error_6_p_0_2));
            MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (PredId_40));
            MR_hl_field(MR_mktag(0), Var_56, 4) = ((MR_Box) (SCCPredId_42));
          }
          mercury__require__expect_3_p_0(Var_56, (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "does not terminate pragma outside this SCC");
          Pieces2_44 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[32]));
        }
        Pieces0_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[28])), Pieces2_44);
      }
      break;
    case (MR_Integer) 3:
      {
        MR_Word Name_46;
        MR_Word Var_52;
        MR_Word PPId_73 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ErrorKind_13, (MR_Integer) 0))));

        Name_46 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_7, (MR_Integer) 0, PPId_73);
        Var_52 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Name_46, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[36])));
        Pieces0_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[34])), Var_52);
      }
      break;
  }
