...
{
  {
    ...
    else
    {
      ...
      if ((Var_73 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        transform_hlds__term_constr_errors__describe_term2_error_6_p_0(ModuleInfo_6, Single_15, (MR_Word) ((MR_Unsigned) 0U), Var_74, Var_51, &ReasonMsgsCord_18);
      }
      else
      {
        MR_Word Var_45;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) ((MR_Unsigned) 56U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ReasonMsg_19, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), ReasonMsg_40, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
