  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(2), Var_55, 0) = ((MR_Box) (Context_10));
  ...
  MR_Word * STATE_VARIABLE_ReasonMsgsCord_21)
{
  ...
  {
    ReasonMsg_19 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), ReasonMsg_19, 0) = ((MR_Box) (Var_26));
    MR_hl_field(MR_mktag(3), ReasonMsg_19, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(3), ReasonMsg_19, 2) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(3), ReasonMsg_19, 3) = ((MR_Box) (Var_29));
  }
  ...
  MR_Word * STATE_VARIABLE_ReasonMsgsCord_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        ReasonMsg_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ReasonMsg_40, 0) = ((MR_Box) (Var_45));
        MR_hl_field(MR_mktag(3), ReasonMsg_40, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), ReasonMsg_40, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), ReasonMsg_40, 3) = ((MR_Box) (Var_48));
      }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__term_constr_errors__IntroducedFrom__pred__term2_error_kind_description__285__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__term_constr_errors__IntroducedFrom__pred__term2_error_kind_description__262__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
