  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 465, &NormalErrors_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 466, &VerboseErrors_16);
  {
  ...
  else
  {
    ...
    else
    {
      ...
      ProcNames_34 = hlds__hlds_error_util__describe_several_proc_names_4_f_0(ModuleInfo_6, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, Var_49);
    ...
    {
      MR_Word Var_83 = ((MR_Word) ((MR_hl_field(1, ErrorsToReport_11, 1))));
      MR_Word Var_84 = ((MR_Word) ((MR_hl_field(1, ErrorsToReport_11, 0))));
      ...
      else
      {
        ...
        MR_Word Error_93;
        MR_Word Errors_94;
        MR_Word STATE_VARIABLE_ReasonMsgsCord_1_98;
        ...
        Error_93 = ((MR_Word) ((MR_hl_field(1, ErrorsToReport_11, 0))));
        Errors_94 = ((MR_Word) ((MR_hl_field(1, ErrorsToReport_11, 1))));
        transform_hlds__term_constr_errors__describe_term2_error_6_p_0(ModuleInfo_6, Single_33, (MR_Word) (MR_mkword(1, &transform_hlds__term_constr_errors_scalar_common_5[0])), Error_93, Var_64, &STATE_VARIABLE_ReasonMsgsCord_1_98);
        transform_hlds__term_constr_errors__describe_term2_errors_6_p_0(ModuleInfo_6, Single_33, (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 1), Errors_94, STATE_VARIABLE_ReasonMsgsCord_1_98, &ReasonMsgsCord_36);
      }
    }
    ...
    }
    {
      ...
      MR_hl_field(2, Spec_43, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.term_constr_errors.report_term2_errors\'/5"));
      MR_hl_field(2, Spec_43, 1) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(2, Spec_43, 2) = ((MR_Box) ((MR_Unsigned) 92U));
      MR_hl_field(2, Spec_43, 3) = ((MR_Box) (Msgs_42));
    }
    {
      MR_Word base;
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(0, Var_46, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[0]));
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          SCCPredId_41 = ((MR_Word) ((MR_hl_field(0, PPId_59, 0))));
          {
            ...
            MR_hl_field(0, Var_52, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[1]));
