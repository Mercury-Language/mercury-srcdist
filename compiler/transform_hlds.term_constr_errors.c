  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 522, &NormalErrors_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 523, &VerboseErrors_16);
  {
