...
transform_hlds__term_constr_errors__IntroducedFrom__pred__term2_error_kind_description__283__1_2_p_0(
  MR_Word PredId_17,
  ...
  MR_Word * STATE_VARIABLE_ReasonMsgsCord_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_23 = (MR_Integer) ((MR_Unsigned) ErrNum0_3 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    succeeded = transform_hlds__term_constr_errors__IntroducedFrom__pred__term2_error_kind_description__283__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_82 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, CalleePiece_15, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[6]));
          Var_79 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[34]), Var_82);
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            Var_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PPId_102, (MR_Integer) 1)));
            {
      ...
      case (MR_Integer) 3:
        {
          ...
          Var_29 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, Name_23, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[22]));
          *Pieces_8 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[36]), Var_29);
        }
        break;
    }
  }
