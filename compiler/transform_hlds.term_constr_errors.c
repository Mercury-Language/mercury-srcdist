  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 520, &NormalErrors_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 521, &VerboseErrors_20);
  {
    IsCheckTerm_21 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), IsCheckTerm_21, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[2]));
    MR_hl_field(MR_mktag(0), IsCheckTerm_21, 1) = ((MR_Box) (transform_hlds__term_constr_errors__maybe_report_term2_errors_5_p_0_1));
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), IsNonImported_27, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[2]));
      MR_hl_field(MR_mktag(0), IsNonImported_27, 1) = ((MR_Box) (transform_hlds__term_constr_errors__maybe_report_term2_errors_5_p_0_2));
        ...
        case (MR_Integer) 0:
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__list__filter_3_p_0((MR_Word) (&transform_hlds__term_constr_errors__transform_hlds__term_constr_errors__type_ctor_info_term2_error_0), (MR_Word) (&transform_hlds__term_constr_errors_scalar_common_4[0]), Errors_8, &DirectErrors_34);
            ...
            else
            {
              ...
              transform_hlds__term_constr_errors__report_term2_errors_5_p_0(ModuleInfo_6, SCC_7, ErrorsToReport_55, STATE_VARIABLE_Specs_0_12, STATE_VARIABLE_Specs_13);
            }
          }
          break;
        case (MR_Integer) 1:
