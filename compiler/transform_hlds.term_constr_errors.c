...
{
  {
    ...
    if ((((ErrorKind_24 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))))) || (((MR_tag((MR_Word) ErrorKind_24)) == (MR_mktag((MR_Integer) 3))))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    return succeeded;
    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        transform_hlds__term_constr_errors____Compare____term2_error_kind_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__hlds_pred____Compare____pred_proc_id_0_0(&Var_14, Var_60, ArgY1_11);
                  succeeded = (Var_14 == (MR_Integer) 0);
                  succeeded = !(succeeded);
                  if (succeeded)
                    *HeadVar__1_1 = Var_14;
                  else
                    hlds__hlds_pred____Compare____pred_proc_id_0_0(HeadVar__1_1, Var_59, ArgY2_13);
                }
                break;
              case (MR_Integer) 2:
                *HeadVar__1_1 = (MR_Integer) 1;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 431, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 432, &VerboseErrors_21);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Pieces1_14 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[38]), ProcName_13);
      {
        Single_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      Pieces1_14 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[3]), ProcNames_16);
      Single_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    }
    if ((Errors_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      Pieces2_17 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[40]);
    ...
    {
      MR_Word Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 1)));
      MR_Word Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 0)));

      if ((Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word Var_51;

        Pieces2_17 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[42]);
        Var_51 = mercury__cord__init_0_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0);
        transform_hlds__term_constr_errors__describe_term2_error_6_p_0(ModuleInfo_6, Single_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_74, Var_51, &ReasonMsgsCord_18);
      }
      else
      {
        MR_Word Var_45;

        Pieces2_17 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[44]);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (Var_56));
    }
    {
      Msgs_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 14))));
      MR_hl_field(MR_mktag(0), Spec_25, 2) = ((MR_Box) (Msgs_24));
    }
    {
      MR_Word base;
...
{
  {
    ...
    if ((MaybeErrorNum_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    {
      ReasonMsg_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ReasonMsg_19, 0) = ((MR_Box) (Var_26));
      MR_hl_field(MR_mktag(1), ReasonMsg_19, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), ReasonMsg_19, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), ReasonMsg_19, 3) = ((MR_Box) (Var_29));
    }
  ...
  MR_Word * STATE_VARIABLE_ReasonMsgsCord_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        ReasonMsg_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ReasonMsg_40, 0) = ((MR_Box) (Var_45));
        MR_hl_field(MR_mktag(1), ReasonMsg_40, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), ReasonMsg_40, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), ReasonMsg_40, 3) = ((MR_Box) (Var_48));
      }
      ...
      Var_23 = (ErrNum0_3 + (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_ErrNum0_3 = Var_23;
        MR_Word next_value_of_HeadVar__4_4 = Errors_17;
        MR_Word next_value_of_STATE_VARIABLE_ReasonMsgsCord_0_5 = STATE_VARIABLE_ReasonMsgsCord_22_22;
...
{
  {
    ...
    succeeded = transform_hlds__term_constr_errors__IntroducedFrom__pred__term2_error_kind_description__260__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
    ...
    switch (MR_tag((MR_Word) Error_7)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Error_7)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *Pieces_8 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[30]);
            break;
          case (MR_Integer) 1:
            *Pieces_8 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[10]);
            break;
          case (MR_Integer) 2:
            *Pieces_8 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[24]);
            break;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          if ((Single_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (transform_hlds__term_constr_errors__term2_error_kind_description_4_p_0_1));
              MR_hl_field(MR_mktag(0), Var_67, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_67, 3) = ((MR_Box) (CallerPPId_9));
              MR_hl_field(MR_mktag(0), Var_67, 4) = ((MR_Box) (PPId_11));
            }
            mercury__require__expect_4_p_0(Var_67, (MR_String) "transform_hlds.term_constr_errors", (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "caller outside this SCC");
            Piece1_12 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[32]);
          }
          ...
          Var_84 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_109_109, CalleePiece_15, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[6]));
          Var_81 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_109_109, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[34]), Var_84);
          *Pieces_8 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_109_109, Piece1_12, Var_81);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          if ((Single_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            Pieces2_21 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, PredDesc_22, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[18]));
          }
          else
          {
            MR_Word SCCPredId_19;
            MR_Word Var_52;
            MR_Word PPId_104 = ((MR_Word) (MR_hl_field(MR_mktag(1), Single_6, (MR_Integer) 0)));
            MR_Integer Var_20;

            SCCPredId_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), PPId_104, (MR_Integer) 0)));
            Var_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PPId_104, (MR_Integer) 1)));
            {
            ...
            mercury__require__expect_4_p_0(Var_52, (MR_String) "transform_hlds.term_constr_errors", (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "does not terminate pragma outside this SCC");
            Pieces2_21 = (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[20]);
          }
          *Pieces_8 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[16]), Pieces2_21);
        }
        break;
      case (MR_Integer) 3:
        {
          ...
          MR_Word Name_23;
          MR_Word Var_29;
          MR_Word PPId_107 = ((MR_Word) (MR_hl_field(MR_mktag(3), Error_7, (MR_Integer) 0)));

          Name_23 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_5, (MR_Integer) 0, PPId_107);
          TypeCtorInfo_113_113 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
          Var_29 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_113_113, Name_23, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[22]));
          *Pieces_8 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_113_113, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[36]), Var_29);
        }
        break;
    }
  }
