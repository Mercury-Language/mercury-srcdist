    ...
    case (MR_Integer) 1:
      {
        ...
        CalleePiece_37 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_7, (MR_Integer) 0, CalleePPId_34);
        Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), CalleePiece_37, (MR_Word) (MR_mkword(1, &transform_hlds__term_constr_errors_scalar_common_1[17])));
        Var_51 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &transform_hlds__term_constr_errors_scalar_common_1[18])), Var_53);
        Pieces0_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Piece1_36, Var_51);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        if ((Single_8 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          PredDesc_44 = hlds__hlds_error_util__describe_one_pred_name_3_f_0(ModuleInfo_7, (MR_Integer) 0, PredId_39);
        ...
        else
        {
          ...
          MR_Word Var_54;
          MR_Word PPId_63 = ((MR_Word) ((MR_hl_field(1, Single_8, (MR_Integer) 0))));

          SCCPredId_41 = ((MR_Word) ((MR_hl_field(0, PPId_63, (MR_Integer) 0))));
          {
            Var_54 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_54, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[1]));
            MR_hl_field(0, Var_54, 1) = ((MR_Box) (transform_hlds__term_constr_errors__describe_term2_error_6_p_0_2));
            MR_hl_field(0, Var_54, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(0, Var_54, 3) = ((MR_Box) (PredId_39));
            MR_hl_field(0, Var_54, 4) = ((MR_Box) (SCCPredId_41));
          }
          mercury__require__expect_3_p_0(Var_54, (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "does not terminate pragma outside this SCC");
    ...
    case (MR_Integer) 3:
      {
        MR_Word Name_45;
        MR_Word Var_61;
        MR_Word PPId_64 = ((MR_Word) ((MR_hl_field(3, ErrorKind_13, (MR_Integer) 0))));

        Name_45 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_7, (MR_Integer) 0, PPId_64);
        Var_61 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Name_45, (MR_Word) (MR_mkword(1, &transform_hlds__term_constr_errors_scalar_common_1[36])));
        Pieces0_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &transform_hlds__term_constr_errors_scalar_common_1[34])), Var_61);
      }
      break;
  }
