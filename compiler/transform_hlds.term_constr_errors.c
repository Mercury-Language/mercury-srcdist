...
{
  {
    ...
    MR_Word transform_hlds__term_constr_errors__V_23_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_constr_errors__LambdaHeadVar__1_33, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word transform_hlds__term_constr_errors__V_19_19;

    {
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_constr_errors__ModuleInfo_5, transform_hlds__term_constr_errors__LambdaHeadVar__1_32, &transform_hlds__term_constr_errors__PredInfo_37, &transform_hlds__term_constr_errors__V_19_19);
    }
    {
...
{
  {
    ...
    MR_Word transform_hlds__term_constr_errors__V_31_31;
    MR_Word transform_hlds__term_constr_errors__V_15_15;

    {
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(transform_hlds__term_constr_errors__ModuleInfo_5, transform_hlds__term_constr_errors__LambdaHeadVar__1_30, &transform_hlds__term_constr_errors__PredInfo_14, &transform_hlds__term_constr_errors__V_15_15);
    }
    {
    ...
    if (transform_hlds__term_constr_errors__succeeded)
      {
        ...
        transform_hlds__term_constr_errors__V_31_31 = (MR_Integer) 20;
        {
          transform_hlds__term_constr_errors__succeeded = hlds__hlds_pred__check_marker_2_p_0(transform_hlds__term_constr_errors__Markers_16, transform_hlds__term_constr_errors__V_31_31);
        }
      }
    return transform_hlds__term_constr_errors__succeeded;
  }
...
{
  {
    ...
    if (transform_hlds__term_constr_errors__succeeded)
    ...
    else
      {
        ...
        {
          transform_hlds__term_constr_errors__V_39_39 = mercury__set__to_sorted_list_1_f_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, transform_hlds__term_constr_errors__SCC_7);
        }
        {
          transform_hlds__term_constr_errors__ProcNames_16 = hlds__hlds_error_util__describe_several_proc_names_3_f_0(transform_hlds__term_constr_errors__ModuleInfo_6, (MR_Integer) 0, transform_hlds__term_constr_errors__V_39_39);
        }
        {
    ...
    if ((transform_hlds__term_constr_errors__Errors_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word transform_hlds__term_constr_errors__V_73_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_constr_errors__Errors_8, (MR_Integer) 1)));
        MR_Word transform_hlds__term_constr_errors__V_74_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_constr_errors__Errors_8, (MR_Integer) 0)));

        if ((transform_hlds__term_constr_errors__V_73_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            {
              transform_hlds__term_constr_errors__describe_term2_error_6_p_0(transform_hlds__term_constr_errors__ModuleInfo_6, transform_hlds__term_constr_errors__Single_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), transform_hlds__term_constr_errors__V_74_74, transform_hlds__term_constr_errors__V_51_51, &transform_hlds__term_constr_errors__ReasonMsgsCord_18);
            }
          }
        else
          {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_errors__Globals_19, (MR_Integer) 424, &transform_hlds__term_constr_errors__NormalErrors_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_errors__Globals_19, (MR_Integer) 425, &transform_hlds__term_constr_errors__VerboseErrors_21);
    }
