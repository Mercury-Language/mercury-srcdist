  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 522, &NormalErrors_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 523, &VerboseErrors_20);
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              transform_hlds__term_constr_errors__report_term2_errors_5_p_0(ModuleInfo_6, SCC_7, ErrorsToReport_54, STATE_VARIABLE_Specs_0_12, STATE_VARIABLE_Specs_13);
            }
          }
          break;
        case (MR_Integer) 1:
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
    ...
    if ((Var_74 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_48 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0));
      transform_hlds__term_constr_errors__describe_term2_error_6_p_0(ModuleInfo_6, Single_15, (MR_Word) ((MR_Unsigned) 0U), Var_75, Var_48, &ReasonMsgsCord_18);
    }
    else
    {
      MR_Word Var_54;
      ...
      transform_hlds__term_constr_errors__describe_term2_errors_6_p_0(ModuleInfo_6, Single_15, (MR_Integer) 1, Errors_8, Var_54, &ReasonMsgsCord_18);
    }
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[0]));
            MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (transform_hlds__term_constr_errors__term2_error_kind_description_4_p_0_1));
            MR_hl_field(MR_mktag(0), Var_43, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_43, 3) = ((MR_Box) (CallerPPId_9));
            MR_hl_field(MR_mktag(0), Var_43, 4) = ((MR_Box) (PPId_11));
          }
          mercury__require__expect_3_p_0(Var_43, (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "caller outside this SCC");
        ...
        Var_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), CalleePiece_15, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[17])));
        Var_57 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[18])), Var_60);
        *Pieces_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Piece1_12, Var_57);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          SCCPredId_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPId_102, (MR_Integer) 0))));
          {
            ...
            MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&transform_hlds__term_constr_errors_scalar_common_2[1]));
            MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (transform_hlds__term_constr_errors__term2_error_kind_description_4_p_0_2));
            MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_75, 3) = ((MR_Box) (PredId_17));
            MR_hl_field(MR_mktag(0), Var_75, 4) = ((MR_Box) (SCCPredId_19));
          }
          mercury__require__expect_3_p_0(Var_75, (MR_String) "predicate \140transform_hlds.term_constr_errors.term2_error_kind_description\'/4", (MR_String) "does not terminate pragma outside this SCC");
    ...
    case (MR_Integer) 3:
      {
        ...
        Var_95 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Name_23, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[36])));
        *Pieces_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_constr_errors_scalar_common_1[34])), Var_95);
      }
      break;
  }
}
