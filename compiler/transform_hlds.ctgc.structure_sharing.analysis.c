  ...
  MR_Word * STATE_VARIABLE_DepProcs_38)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 339, &WideningLimit_17);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 409, &IntermodAnalysis_7);
