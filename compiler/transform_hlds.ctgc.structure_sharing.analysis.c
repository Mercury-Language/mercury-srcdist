...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_sharing__analysis__Globals_13, (MR_Integer) 90, &transform_hlds__ctgc__structure_sharing__analysis__MakeAnalysisRegistry_14);
    }
