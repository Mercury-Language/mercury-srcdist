...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_sharing__analysis__Globals_16, (MR_Integer) 53, &transform_hlds__ctgc__structure_sharing__analysis__Verbose_17);
    }
    {
...
{
  {
    ...
    transform_hlds__ctgc__structure_sharing__analysis__succeeded = ((MR_tag((MR_Word) transform_hlds__ctgc__structure_sharing__analysis__OpMode_14)) == (MR_mktag((MR_Integer) 3)));
    if (transform_hlds__ctgc__structure_sharing__analysis__succeeded)
      {
        transform_hlds__ctgc__structure_sharing__analysis__V_32_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__ctgc__structure_sharing__analysis__OpMode_14, (MR_Integer) 0)));
