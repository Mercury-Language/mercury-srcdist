  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  ProcIds_15 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo0_6);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_sharing__analysis_scalar_common_8[2]));
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_sharing__analysis_scalar_common_1[7]), PredIds_34, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_9)), &conv3_STATE_VARIABLE_ModuleInfo_12_12);
