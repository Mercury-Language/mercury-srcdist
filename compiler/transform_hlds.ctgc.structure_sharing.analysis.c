  ...
  MR_Word * STATE_VARIABLE_DepProcs_20)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_STATE_VARIABLE_FixpointTable_0_17 = STATE_VARIABLE_FixpointTable_36_36;
        MR_Word next_value_of_STATE_VARIABLE_DepProcs_0_19 = STATE_VARIABLE_DepProcs_34_34;
