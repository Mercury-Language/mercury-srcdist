  ...
  MR_Word Answer2_6)
{
  ...
  if (!(succeeded))
  {
    ...
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_11, HeadVars_9, &HeadVarTypes_12);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_31, HeadVars_29, &HeadVarTypes_32);
                  {
      ...
      case (MR_Integer) 2:
        {
          ...
          hlds__vartypes__lookup_var_types_3_p_0(CallerVarTypes_44, CallArgs_33, &ActualTypes_45);
