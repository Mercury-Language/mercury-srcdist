...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 424, &WideningLimit_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 345, &IntermodAnalysis_8);
