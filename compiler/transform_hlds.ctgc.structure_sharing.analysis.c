  ...
  MR_Word * STATE_VARIABLE_DepProcs_36)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 513, &WideningLimit_15);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 505, &IntermodAnalysis_5);
