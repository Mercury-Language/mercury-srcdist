...
static void MR_CALL 
transform_hlds__ctgc__structure_sharing__analysis__IntroducedFrom__pred__analyse_scc__413__1_4_p_0(
  ...
  MR_Word * STATE_VARIABLE_DepProcs_36)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_17, &VarTable_28);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__ctgc__structure_sharing__analysis__IntroducedFrom__pred__analyse_scc__413__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_LambdaHeadVar__3_35);
