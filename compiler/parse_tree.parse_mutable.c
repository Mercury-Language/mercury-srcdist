...
{
  {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if ((OptMutAttrsTerm_19 == (MR_Word) ((MR_Integer) 0)))
            {
              MaybeAttrsTerm_20 = (MR_Word) ((MR_Integer) 0);
              succeeded = MR_TRUE;
            }
            else
            {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeAttrsTerm_20 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_46;
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_41, 1) = ((MR_Box) ((MR_Integer) 12));
...

    {
      ...
      if ((env).parse_tree__parse_mutable__parse_mutable_attrs_3_p_0_env_0__succeeded)
      {
        ...
        if ((env).parse_tree__parse_mutable__parse_mutable_attrs_3_p_0_env_0__succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) ((MR_Integer) 4));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_111, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_111, 1) = ((MR_Box) ((MR_Integer) 12));
        ...
        else
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), ItemFinalise_23, 2) = ((MR_Box) ((MR_Integer) 0));
        ...
        else
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), ItemInitialise_23, 2) = ((MR_Box) ((MR_Integer) 0));
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Spec_120, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), Spec_120, 1) = ((MR_Box) ((MR_Integer) 12));
