      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_mutable_scalar_common_2[82])));
...

    {
      ...
      if ((env).parse_tree__parse_mutable__parse_mutable_attrs_3_p_0_env_0__succeeded)
      {
        TypeCtorInfo_104_104 = (MR_Word) (&parse_tree__parse_mutable__parse_tree__parse_mutable__type_ctor_info_collected_mutable_attribute_0);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&parse_tree__parse_mutable_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (parse_tree__parse_mutable__parse_mutable_attrs_3_p_0_1));
          MR_hl_field(MR_mktag(0), Var_48, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_48, 3) = ((MR_Box) (VarSet_4));
        }
