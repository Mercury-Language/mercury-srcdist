  ...
  MR_Word * MaybeInst_6)
{
  ...
  else
  {
    ...
    ContextPieces_11 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__parse_mutable_scalar_common_1[58])));
