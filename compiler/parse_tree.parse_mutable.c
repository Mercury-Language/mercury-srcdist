...
static /* final */ const MR_Box parse_tree__parse_mutable_scalar_common_2[91][2] = {
  ...
  /* row 70 */
  {
    ((MR_Box) (&parse_tree__parse_mutable_scalar_common_3[2])),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 71 */
  {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MutAttr_56 = (MR_Word) ((MR_Word) (Var_30));
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *MutAttrResult_4 = base;
      ...
      else
      {
        ...
        Var_49 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), MutAttrTerm_3);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_2[90])));
        }
        {
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (Context_11));
...
{
  {
...

    {
      ...
      else
      {
        ...
        MutAttrsStr_109 = parse_tree__parse_tree_out_term__mercury_term_to_string_3_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_4, (MR_Integer) 0, MutAttrsTerm_5);
        {
        ...
        Var_102 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), MutAttrsTerm_5);
        {
        ...
        {
          Spec_111 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_111, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_111, 1) = ((MR_Box) ((MR_Unsigned) 12U));
...
{
  {
    ...
    if ((env).parse_tree__parse_mutable__parse_mutable_inst_3_p_0_env_0__succeeded)
    {
      ...
      Var_32 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), (env).parse_tree__parse_mutable__parse_mutable_inst_3_p_0_env_0__InstTerm_5);
      {
    ...
    else
    {
      ...
      parse_tree__parse_inst_mode_name__parse_inst_5_p_0((MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_3[6])), VarSet_4, ContextPieces_11, (env).parse_tree__parse_mutable__parse_mutable_inst_3_p_0_env_0__InstTerm_5, MaybeInst_6);
    }
  }
}
...
{
  {
    ...
    if ((env).parse_tree__parse_mutable__parse_mutable_type_3_p_0_env_0__succeeded)
    {
      ...
      Var_32 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), (env).parse_tree__parse_mutable__parse_mutable_type_3_p_0_env_0__TypeTerm_5);
      {
        Var_34 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (Pieces_9));
      }
    ...
    else
    {
      ...
      parse_tree__parse_type_name__parse_type_5_p_0((MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_3[5])), VarSet_4, ContextPieces_11, (env).parse_tree__parse_mutable__parse_mutable_type_3_p_0_env_0__TypeTerm_5, MaybeType_6);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      Var_20 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), NameTerm_3);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_2[76])));
      }
      {
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            TermStr_115 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_8, Term_13);
            {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_108, 0) = ((MR_Box) (Context_10));
        MR_hl_field(MR_mktag(1), Var_108, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_2[75])));
      }
      {
        Var_107 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            TermStr_118 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_8, Term_13);
            {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_111, 0) = ((MR_Box) (Context_10));
        MR_hl_field(MR_mktag(1), Var_111, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_mutable_scalar_common_2[70])));
      }
      {
