      ...
      else
      {
        ...
        switch (Var_118) {
          ...
          case (MR_Integer) 1:
            {
              Local_19 = (MR_Word) ((MR_Unsigned) 0U);
              parse_tree__parse_mutable__report_conflicting_attributes_5_p_0(VarSet_8, Var_121, Var_119, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_Specs_81_81);
            }
            break;
          case (MR_Integer) 0:
            {
  ...
  else
  {
    ...
    else
    {
      ...
      switch (Var_113) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          parse_tree__parse_mutable__report_conflicting_attributes_5_p_0(VarSet_8, ConstTerm_27, Var_114, STATE_VARIABLE_Specs_37_37, &STATE_VARIABLE_Specs_40_40);
          break;
        case (MR_Integer) 0:
          STATE_VARIABLE_Specs_40_40 = STATE_VARIABLE_Specs_37_37;
          break;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (Item_25));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
