      ...
      else
      {
        ...
        switch (Var_122) {
          ...
          case (MR_Integer) 1:
            {
              Local_19 = (MR_Word) ((MR_Unsigned) 0U);
              parse_tree__parse_mutable__report_conflicting_attributes_5_p_0(VarSet_8, Var_125, Var_123, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_Specs_41_41);
            }
            break;
          case (MR_Integer) 0:
            {
  ...
  else
  {
    ...
    else
    {
      ...
      switch (Var_117) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          parse_tree__parse_mutable__report_conflicting_attributes_5_p_0(VarSet_8, ConstTerm_27, Var_118, STATE_VARIABLE_Specs_75_75, &STATE_VARIABLE_Specs_80_80);
          break;
        case (MR_Integer) 0:
          STATE_VARIABLE_Specs_80_80 = STATE_VARIABLE_Specs_75_75;
          break;
