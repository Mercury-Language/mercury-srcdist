  ...
  MR_Word * STATE_VARIABLE_BuiltinTypes_16)
{
  ...
  check_hlds__typecheck_error_builtin__acc_builtin_type_3_p_0(ActualType_10, STATE_VARIABLE_BuiltinTypes_0_15, &STATE_VARIABLE_BuiltinTypes_17_17);
  check_hlds__typecheck_error_builtin__acc_builtin_type_3_p_0(ExpectedType_12, STATE_VARIABLE_BuiltinTypes_17_17, STATE_VARIABLE_BuiltinTypes_16);
}
