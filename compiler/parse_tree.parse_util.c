...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_16, 2) = ((MR_Box) (Context_7));
...
{
  {
    ...
    succeeded = parse_tree__parse_util__parse_implicitly_qualified_name_and_arity_4_p_0(TypeInfo_for_T_9, (MR_Word) (&parse_tree__parse_util_scalar_common_2[0]), PredAndArityTerm_4, SymName_5, Arity_6);
    return succeeded;
  }
}
