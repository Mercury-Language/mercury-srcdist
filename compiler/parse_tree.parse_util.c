  ...
  MR_Word * Specs_10)
{
...

  {
    ...
    MR_hl_field(0, Var_11, 0) = ((MR_Box) (&parse_tree__parse_util_scalar_common_7[0]));
    ...
    if (((MR_tag((MR_Word) MaybePredAndModes_20)) == (MR_Integer) 0))
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_59, 0) = ((MR_Box) ((MR_Unsigned) 4U));
  ...
  MR_Word * MaybeNameAndModes_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_28 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ((MR_Box) (MR_mkword(3, &parse_tree__parse_util_scalar_common_1[20]))));
  ...
  MR_Word * MaybePredSpec_10)
{
  ...
  else
  {
    ...
    TermStr_19 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_8, Term_9);
    {
      ...
      MR_hl_field(3, Var_25, 0) = ((MR_Box) ((MR_Unsigned) 29U));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_38, 0) = ((MR_Box) ((MR_Unsigned) 4U));
  ...
  MR_Word * MaybePredSpec_10)
{
  ...
  else
  {
    ...
    {
      Var_56 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_56, 0) = ((MR_Box) ((MR_Unsigned) 4U));
