...
{
  {
    ...
    mercury__list__foldl_4_p_0(TypeInfo_18_18, (MR_Word) &parse_tree__parse_util_scalar_common_1[0], (MR_Word) Var_11, (MR_Word) Conflicts_8, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_Specs_10);
