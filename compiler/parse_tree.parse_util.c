  ...
  if (((MR_tag((MR_Word) Term_9)) == (MR_Integer) 0))
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_30 = parse_tree__maybe_error__get_any_errors1_1_f_0(TypeInfo_for_T_40, HeadResult_19);
        {
        ...
        Var_31 = parse_tree__maybe_error__get_any_errors1_1_f_0(TypeInfo_43_43, (MR_Word) (TailResult_20));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_util_scalar_common_1[22])));
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) HeadResult_9)) == (MR_Integer) 0))
    {
      ...
      if (((MR_tag((MR_Word) TailResult_14)) == (MR_Integer) 0))
      {
        ...
        Var_23 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_31, TailSpecs_16);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *Result_8 = base;
    ...
    else
    {
      ...
      else
      {
        ...
        Var_24 = mercury__one_or_more__cons_2_f_0(TypeInfo_for_T_29, Var_32, TailItems_20);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Result_8 = base;
