  ...
  MR_Word * MaybeNameAndModes_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_27 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_util_scalar_common_1[20]))));
