  ...
  if (((MR_tag((MR_Word) Term_9)) == (MR_Integer) 0))
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_28 = parse_tree__maybe_error__get_any_errors1_1_f_0(TypeInfo_for_T_37, HeadResult_19);
        {
        ...
        Var_29 = parse_tree__maybe_error__get_any_errors1_1_f_0(TypeInfo_40_40, (MR_Word) (TailResult_20));
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) HeadResult_9)) == (MR_Integer) 0))
    {
      ...
      if (((MR_tag((MR_Word) TailResult_14)) == (MR_Integer) 0))
      {
        ...
        Var_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_29, TailSpecs_16);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *Result_8 = base;
    ...
    else
    {
      ...
      else
      {
        ...
        Var_21 = mercury__one_or_more__cons_2_f_0(TypeInfo_for_T_27, Var_30, TailItems_20);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Result_8 = base;
