...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_15;

    {
      parse_tree__parse_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_105_110_111_112_95_116_101_114_109_95_116_111_95_111_110_101_95_111_114_95_109_111_114_101_95_108_111_111_112_95_95_91_49_93_95_48_4_p_0((MR_String) ",", parse_tree__parse_util__Term_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &parse_tree__parse_util__Var_15);
    }
    parse_tree__parse_util__Head_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_15, (MR_Integer) 0)));
    parse_tree__parse_util__Tail_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_15, (MR_Integer) 1)));
    {
    ...
    if ((parse_tree__parse_util__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__parse_util__HeadResult_10)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word parse_tree__parse_util__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__HeadResult_10, (MR_Integer) 0)));
            ...
            if (((MR_tag((MR_Word) parse_tree__parse_util__TailResult_11)) == (MR_mktag((MR_Integer) 0))))
              {
                ...
                MR_Word parse_tree__parse_util__Var_20;

                {
                  parse_tree__parse_util__Var_20 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, parse_tree__parse_util__Var_24, parse_tree__parse_util__TailSpecs_13);
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  *parse_tree__parse_util__HeadVar__3_3 = base;
                  MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (parse_tree__parse_util__Var_20));
                }
              }
            else
          ...
          {
            MR_Box parse_tree__parse_util__Var_25 = (MR_hl_field(MR_mktag(1), parse_tree__parse_util__HeadResult_10, (MR_Integer) 0));
            ...
            if (((MR_tag((MR_Word) parse_tree__parse_util__TailResult_11)) == (MR_mktag((MR_Integer) 0))))
              *parse_tree__parse_util__HeadVar__3_3 = parse_tree__parse_util__TailResult_11;
            else
              {
                ...
                MR_Word parse_tree__parse_util__Var_19;

                {
                  parse_tree__parse_util__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, 0) = parse_tree__parse_util__Var_25;
                  MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, 1) = ((MR_Box) (parse_tree__parse_util__TailItems_18));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  *parse_tree__parse_util__HeadVar__3_3 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__parse_util__Var_19));
                }
              }
          }
      }
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_9;

    {
      parse_tree__parse_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_105_110_111_112_95_116_101_114_109_95_116_111_95_111_110_101_95_111_114_95_109_111_114_101_95_108_111_111_112_95_95_91_49_93_95_48_4_p_0((MR_String) ",", parse_tree__parse_util__Term_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &parse_tree__parse_util__Var_9);
    }
    parse_tree__parse_util__Head_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_9, (MR_Integer) 0)));
    parse_tree__parse_util__Tail_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_9, (MR_Integer) 1)));
    {
      ...
      if (((MR_tag((MR_Word) parse_tree__parse_util__HeadResult_9)) == (MR_mktag((MR_Integer) 0))))
        *parse_tree__parse_util__Result_8 = (MR_Word) parse_tree__parse_util__HeadResult_9;
      else
        {
          ...
          MR_Word parse_tree__parse_util__Var_23;

          {
            parse_tree__parse_util__Var_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_23, 0) = parse_tree__parse_util__Item_11;
            MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *parse_tree__parse_util__Result_8 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__parse_util__Var_23));
          }
        }
    else
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__parse_util__HeadResult_9)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word parse_tree__parse_util__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__HeadResult_9, (MR_Integer) 0)));
            ...
            if (((MR_tag((MR_Word) parse_tree__parse_util__TailResult_14)) == (MR_mktag((MR_Integer) 0))))
              {
                ...
                MR_Word parse_tree__parse_util__Var_22;

                {
                  parse_tree__parse_util__Var_22 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, parse_tree__parse_util__Var_31, parse_tree__parse_util__TailSpecs_16);
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  *parse_tree__parse_util__Result_8 = base;
                  MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (parse_tree__parse_util__Var_22));
                }
              }
            else
              *parse_tree__parse_util__Result_8 = (MR_Word) parse_tree__parse_util__HeadResult_9;
          ...
          {
            MR_Box parse_tree__parse_util__Var_32 = (MR_hl_field(MR_mktag(1), parse_tree__parse_util__HeadResult_9, (MR_Integer) 0));
            ...
            if (((MR_tag((MR_Word) parse_tree__parse_util__TailResult_14)) == (MR_mktag((MR_Integer) 0))))
              *parse_tree__parse_util__Result_8 = parse_tree__parse_util__TailResult_14;
            else
              {
                ...
                MR_Word parse_tree__parse_util__Var_21;

                {
                  parse_tree__parse_util__Var_21 = mercury__list__one_or_more_cons_2_f_0(parse_tree__parse_util__TypeInfo_for_T_29, parse_tree__parse_util__Var_32, parse_tree__parse_util__TailItems_20);
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  *parse_tree__parse_util__Result_8 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__parse_util__Var_21));
                }
              }
          }
      }
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_8;

    {
      parse_tree__parse_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_105_110_111_112_95_116_101_114_109_95_116_111_95_111_110_101_95_111_114_95_109_111_114_101_95_108_111_111_112_95_95_91_49_93_95_48_4_p_0((MR_String) "+", parse_tree__parse_util__Term_3, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &parse_tree__parse_util__Var_8);
    }
    parse_tree__parse_util__Head_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_8, (MR_Integer) 0)));
    parse_tree__parse_util__Tail_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_8, (MR_Integer) 1)));
    {
      MR_Word base;
  ...
  MR_Word * parse_tree__parse_util__Term_3)
{
  {
    MR_bool parse_tree__parse_util__succeeded;
    MR_Word parse_tree__parse_util__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__HeadVar__2_2, (MR_Integer) 1)));
    MR_Word parse_tree__parse_util__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__HeadVar__2_2, (MR_Integer) 0)));

    if ((parse_tree__parse_util__Var_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *parse_tree__parse_util__Term_3 = parse_tree__parse_util__Var_22;
    else
      {
        MR_Word parse_tree__parse_util__Second_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_21, (MR_Integer) 0)));
        MR_Word parse_tree__parse_util__Rest_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_21, (MR_Integer) 1)));
        MR_Word parse_tree__parse_util__Tail_12;
        MR_Word parse_tree__parse_util__Var_14;
        MR_Word parse_tree__parse_util__Var_17;
        MR_Word parse_tree__parse_util__Var_18;

        {
          parse_tree__parse_util__Var_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_14, 0) = ((MR_Box) (parse_tree__parse_util__Second_9));
          MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_14, 1) = ((MR_Box) (parse_tree__parse_util__Rest_10));
        }
        {
          parse_tree__parse_util__one_or_more_to_conjunction_3_p_0(parse_tree__parse_util__TypeInfo_for_T_20, parse_tree__parse_util__Context_1, parse_tree__parse_util__Var_14, &parse_tree__parse_util__Tail_12);
        }
        {
          parse_tree__parse_util__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_18, 0) = ((MR_Box) (parse_tree__parse_util__Tail_12));
          MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__parse_util__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_17, 0) = ((MR_Box) (parse_tree__parse_util__Var_22));
          MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_17, 1) = ((MR_Box) (parse_tree__parse_util__Var_18));
        }
        {
          MR_Word base;
          ...
          *parse_tree__parse_util__Term_3 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (parse_tree__parse_util__Var_17));
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        MR_Word parse_tree__parse_util__Var_14;
        MR_Word parse_tree__parse_util__Var_15;
        MR_Word parse_tree__parse_util__Var_16;
        MR_Word parse_tree__parse_util__Var_17;
        MR_String parse_tree__parse_util__Var_21;
        MR_Word parse_tree__parse_util___Context_11;

        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_6, (MR_Integer) 0)));
            parse_tree__parse_util__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_6, (MR_Integer) 1)));
            parse_tree__parse_util___Context_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_6, (MR_Integer) 2)));
            parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_14)) == (MR_mktag((MR_Integer) 0)));
            if (parse_tree__parse_util__succeeded)
              {
                parse_tree__parse_util__Var_21 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_14, (MR_Integer) 0)));
                parse_tree__parse_util__succeeded = (strcmp(parse_tree__parse_util__Op_5, parse_tree__parse_util__Var_21) == 0);
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_15)) == (MR_mktag((MR_Integer) 1)));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__L_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 0)));
                        parse_tree__parse_util__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 1)));
                        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_16)) == (MR_mktag((MR_Integer) 1)));
                        if (parse_tree__parse_util__succeeded)
                          {
                            parse_tree__parse_util__R_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 0)));
                            parse_tree__parse_util__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 1)));
                            parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                      }
                  }
              }
        ...
        if (parse_tree__parse_util__succeeded)
          {
            ...
            {
              parse_tree__parse_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_105_110_111_112_95_116_101_114_109_95_116_111_95_111_110_101_95_111_114_95_109_111_114_101_95_108_111_111_112_95_95_91_49_93_95_48_4_p_0(parse_tree__parse_util__Op_5, parse_tree__parse_util__R_10, parse_tree__parse_util__List0_7, &parse_tree__parse_util__Var_18);
            }
            parse_tree__parse_util__RHead_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_18, (MR_Integer) 0)));
            parse_tree__parse_util__RTail_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_18, (MR_Integer) 1)));
            {
              parse_tree__parse_util__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, 0) = ((MR_Box) (parse_tree__parse_util__RHead_12));
              MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, 1) = ((MR_Box) (parse_tree__parse_util__RTail_13));
            }
            /* direct tailcall eliminated */
            {
              MR_Word parse_tree__parse_util__next_value_of_Term_6 = parse_tree__parse_util__L_9;
              MR_Word parse_tree__parse_util__next_value_of_List0_7 = parse_tree__parse_util__Var_19;

              parse_tree__parse_util__List0_7 = parse_tree__parse_util__next_value_of_List0_7;
              parse_tree__parse_util__Term_6 = parse_tree__parse_util__next_value_of_Term_6;
            }
            continue;
          }
        else
...
{
  {
    ...
    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_3, (MR_Integer) 0)));
        parse_tree__parse_util__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_3, (MR_Integer) 1)));
        parse_tree__parse_util__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term_3, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_20)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__Var_21 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_20, (MR_Integer) 0)));
            if ((parse_tree__parse_util__Var_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                parse_tree__parse_util__succeeded = (strcmp(parse_tree__parse_util__Var_21, (MR_String) "[]") == 0);
                if (parse_tree__parse_util__succeeded)
                  {
            ...
            else
              {
                ...
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__HeadTerm_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, (MR_Integer) 0)));
                    parse_tree__parse_util__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_19, (MR_Integer) 1)));
                    parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_16)) == (MR_mktag((MR_Integer) 1)));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__TailTerm_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 0)));
                        parse_tree__parse_util__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 1)));
                        parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        if (parse_tree__parse_util__succeeded)
                          {
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_22;
    MR_String parse_tree__parse_util__Var_23;
    MR_Word parse_tree__parse_util__Var_24;
    MR_Word parse_tree__parse_util__Var_25;
    MR_Word parse_tree__parse_util__Var_26;
    MR_Word parse_tree__parse_util__Var_13;

    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_7, (MR_Integer) 0)));
        parse_tree__parse_util__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_7, (MR_Integer) 1)));
        parse_tree__parse_util__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_7, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_22)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__Var_23 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_22, (MR_Integer) 0)));
            parse_tree__parse_util__succeeded = (strcmp(parse_tree__parse_util__Var_23, (MR_String) "=") == 0);
            if (parse_tree__parse_util__succeeded)
              {
                parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_24)) == (MR_mktag((MR_Integer) 1)));
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__FuncAndArgsTerm_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_24, (MR_Integer) 0)));
                    parse_tree__parse_util__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_24, (MR_Integer) 1)));
                    parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_25)) == (MR_mktag((MR_Integer) 1)));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__FuncResultTerm_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_25, (MR_Integer) 0)));
                        parse_tree__parse_util__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_25, (MR_Integer) 1)));
                        parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                  }
              }
          }
    ...
    if (((MR_tag((MR_Word) parse_tree__parse_util__Result_18)) == (MR_mktag((MR_Integer) 0))))
      *parse_tree__parse_util__PredAndArgsResult_10 = (MR_Word) parse_tree__parse_util__Result_18;
    else
      {
        ...
        MR_Word parse_tree__parse_util__Var_27;

        {
          parse_tree__parse_util__Var_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_27, 0) = ((MR_Box) (parse_tree__parse_util__Args_20));
          MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_27, 1) = ((MR_Box) (parse_tree__parse_util__MaybeFuncResult_15));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *parse_tree__parse_util__PredAndArgsResult_10 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (parse_tree__parse_util__Var_27));
        }
      }
  }
}
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_16;
    MR_Word parse_tree__parse_util__Var_13;
    MR_String parse_tree__parse_util__Var_14;
    MR_Word parse_tree__parse_util__Var_15;
    MR_Word parse_tree__parse_util__Var_17;
    MR_Word parse_tree__parse_util__Var_11;
    MR_Word parse_tree__parse_util__FuncResultTerm_10;

    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_5, (MR_Integer) 0)));
        parse_tree__parse_util__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_5, (MR_Integer) 1)));
        parse_tree__parse_util__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArgsTerm_5, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_13)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__Var_14 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_13, (MR_Integer) 0)));
            parse_tree__parse_util__succeeded = (strcmp(parse_tree__parse_util__Var_14, (MR_String) "=") == 0);
            if (parse_tree__parse_util__succeeded)
              {
                parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_15)) == (MR_mktag((MR_Integer) 1)));
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__FuncAndArgsTerm_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 0)));
                    parse_tree__parse_util__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 1)));
                    parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_16)) == (MR_mktag((MR_Integer) 1)));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__FuncResultTerm_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 0)));
                        parse_tree__parse_util__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_16, (MR_Integer) 1)));
                        parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                  }
        ...
        if (parse_tree__parse_util__succeeded)
          {
            *parse_tree__parse_util__PredOrFunc_6 = (MR_Integer) 1;
            ...
            {
              parse_tree__parse_util__conv0_ArgTerms_8 = mercury__list__f_43_43_2_f_0(parse_tree__parse_util__TypeInfo_22_22, (MR_Word) parse_tree__parse_util__ArgTerms0_12, (MR_Word) parse_tree__parse_util__Var_16);
            }
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_14;
    MR_Word parse_tree__parse_util__Var_15;
    MR_String parse_tree__parse_util__Var_16;
    MR_Word parse_tree__parse_util__Var_11;

    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PorFPredAndArityTerm_5, (MR_Integer) 0)));
        ...
        parse_tree__parse_util__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PorFPredAndArityTerm_5, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_14)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__PredOrFuncStr_9 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_14, (MR_Integer) 0)));
                ...
                if (parse_tree__parse_util__succeeded)
                  {
                    ...
                    parse_tree__parse_util__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Args_10, (MR_Integer) 1)));
                    parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__Var_16 = (MR_String) "";
...
{
  {
    ...
    MR_Word parse_tree__parse_util__Var_12;
    MR_String parse_tree__parse_util__Var_13;
    MR_Word parse_tree__parse_util__Var_14;
    MR_Word parse_tree__parse_util__Var_15;
    MR_Word parse_tree__parse_util__Var_16;
    MR_Word parse_tree__parse_util__Var_11;
    ...
    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArityTerm_6, (MR_Integer) 0)));
        parse_tree__parse_util__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArityTerm_6, (MR_Integer) 1)));
        parse_tree__parse_util__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__PredAndArityTerm_6, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_12)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__Var_13 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Var_12, (MR_Integer) 0)));
            parse_tree__parse_util__succeeded = (strcmp(parse_tree__parse_util__Var_13, (MR_String) "/") == 0);
            if (parse_tree__parse_util__succeeded)
              {
                parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_14)) == (MR_mktag((MR_Integer) 1)));
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__PredNameTerm_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_14, (MR_Integer) 0)));
                    parse_tree__parse_util__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_14, (MR_Integer) 1)));
                    parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Var_15)) == (MR_mktag((MR_Integer) 1)));
                    if (parse_tree__parse_util__succeeded)
                      {
                        parse_tree__parse_util__ArityTerm_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 0)));
                        parse_tree__parse_util__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__Var_15, (MR_Integer) 1)));
                        parse_tree__parse_util__succeeded = (parse_tree__parse_util__Var_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        if (parse_tree__parse_util__succeeded)
                          {
                            {
                              parse_tree__parse_util__succeeded = parse_tree__parse_sym_name__try_parse_implicitly_qualified_sym_name_and_no_args_3_p_0(parse_tree__parse_util__TypeInfo_for_T_17, parse_tree__parse_util__ModuleName_5, parse_tree__parse_util__PredNameTerm_9, parse_tree__parse_util__SymName_7);
                            }
                            if (parse_tree__parse_util__succeeded)
                              {
                                parse_tree__parse_util__succeeded = mercury__term__decimal_term_to_int_2_p_0(parse_tree__parse_util__TypeInfo_for_T_17, parse_tree__parse_util__ArityTerm_10, parse_tree__parse_util__Arity_8);
                              }
                          }
                      }
                  }
