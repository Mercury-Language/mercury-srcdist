...
void MR_CALL 
parse_tree__parse_util__parse_purity_annotation_3_p_0(
  MR_Word parse_tree__parse_util__TypeInfo_for_T_14,
  MR_Word parse_tree__parse_util__Term0_4,
  MR_Word * parse_tree__parse_util__Purity_5,
  MR_Word * parse_tree__parse_util__Term_6)
{
  {
    MR_bool parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__Term0_4)) == (MR_mktag((MR_Integer) 0)));
    MR_Word parse_tree__parse_util__Term1_8;
    MR_Word parse_tree__parse_util__Purity0_10;
    MR_String parse_tree__parse_util__PurityName_7;
    ...
    if (parse_tree__parse_util__succeeded)
      {
        parse_tree__parse_util__V_11_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term0_4, (MR_Integer) 0)));
        parse_tree__parse_util__V_12_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term0_4, (MR_Integer) 1)));
        parse_tree__parse_util__V_9_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__Term0_4, (MR_Integer) 2)));
        parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__V_11_11)) == (MR_mktag((MR_Integer) 0)));
        if (parse_tree__parse_util__succeeded)
          {
            parse_tree__parse_util__PurityName_7 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__parse_util__V_11_11, (MR_Integer) 0)));
            parse_tree__parse_util__succeeded = ((MR_tag((MR_Word) parse_tree__parse_util__V_12_12)) == (MR_mktag((MR_Integer) 1)));
            if (parse_tree__parse_util__succeeded)
              {
                parse_tree__parse_util__Term1_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__V_12_12, (MR_Integer) 0)));
                parse_tree__parse_util__V_13_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__parse_util__V_12_12, (MR_Integer) 1)));
                parse_tree__parse_util__succeeded = (parse_tree__parse_util__V_13_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (parse_tree__parse_util__succeeded)
                  {
                    parse_tree__parse_util__succeeded = parse_tree__prog_out__purity_name_2_p_1(&parse_tree__parse_util__Purity0_10, parse_tree__parse_util__PurityName_7);
                  }
              }
          }
      }
    if (parse_tree__parse_util__succeeded)
      {
        *parse_tree__parse_util__Purity_5 = parse_tree__parse_util__Purity0_10;
        *parse_tree__parse_util__Term_6 = parse_tree__parse_util__Term1_8;
      }
    else
      {
        *parse_tree__parse_util__Purity_5 = (MR_Integer) 0;
        *parse_tree__parse_util__Term_6 = parse_tree__parse_util__Term0_4;
      }
  }
}
...
{
  {
    ...
    if ((parse_tree__parse_util__MaybeModuleName_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        parse_tree__parse_sym_name__parse_sym_name_and_args_4_p_0(parse_tree__parse_util__TypeInfo_for_T_28, parse_tree__parse_util__FunctorTerm_14, parse_tree__parse_util__GenericVarSet_16, parse_tree__parse_util__ContextPieces_9, &parse_tree__parse_util__Result_18);
      }
    else
      {
