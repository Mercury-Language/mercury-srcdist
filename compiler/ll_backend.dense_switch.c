...
{
  {
    ...
    MR_Word Var_74;
    MR_Word Var_75;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DenseSwitchInfo_19, (MR_Integer) 2)));
    ...
    else
    {
      ...
      if ((IndexPairs_11 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if ((STATE_VARIABLE_MaybeFailLabel_0_22 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            STATE_VARIABLE_MaybeFailLabel_39_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        else
        {
          ...
          if ((STATE_VARIABLE_MaybeFailLabel_0_22 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            {
              STATE_VARIABLE_MaybeFailLabel_34_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
