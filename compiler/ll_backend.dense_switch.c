...
ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__252__1_2_p_0(
  ...
  MR_Word STATE_VARIABLE_CLD_0_48)
{
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(1, Var_60, 0) = ((MR_Box) (Difference_30));
        }
        {
  ...
  *MaybeEnd_22 = ((MR_Word) (conv5_MaybeEnd_22));
  ...
  ll_backend__dense_switch__generate_dense_jump_table_8_p_0(FirstVal_26, LastVal_27, IndexPairs_36, &Targets_37, (MR_Word) ((MR_Unsigned) 0U), &MaybeFailLabel_38, STATE_VARIABLE_CI_63_63, &STATE_VARIABLE_CI_65_65);
  {
    ...
    MR_hl_field(3, Var_67, 2) = ((MR_Box) (Targets_37));
  }
  {
  ...
  else
  {
...

    {
      ...
      MR_hl_field(3, Var_70, 1) = ((MR_Box) (FailLabel_41));
    }
    {
      Var_69 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_69, 0) = ((MR_Box) (Var_70));
      MR_hl_field(0, Var_69, 1) = ((MR_Box) ((MR_String) "compiler-introduced \140fail\' case of dense switch"));
    }
    FailLabelCode_43 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_69)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__252__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
