...
MR_decl_label4(ll_backend__dense_switch__cases_list_is_dense_switch_8_0, 17,13,9,1)
MR_decl_label8(ll_backend__dense_switch__generate_dense_case_11_0, 5,6,7,8,9,10,2,11)
MR_decl_label4(ll_backend__dense_switch__generate_dense_cases_12_0, 14,3,4,5)
...
MR_decl_static(ll_backend__dense_switch__generate_dense_case_11_0)
MR_decl_static(ll_backend__dense_switch__generate_dense_cases_12_0)
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module1)
	...
	MR_init_label4(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,17,13,9,1)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,7)
	...
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(ll_backend__dense_switch__cases_list_is_dense_switch_8_0_i9);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__dense_switch__cases_list_is_dense_switch_8_0_i13);
	}
...
MR_def_label(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,17)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(7);
	MR_r4 = MR_sv(4);
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(ll_backend__dense_switch__cases_list_is_dense_switch_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(7);
	MR_r4 = (MR_Integer) 1;
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module2)
	MR_init_entry1(ll_backend__dense_switch__generate_dense_case_11_0);
	MR_init_label8(ll_backend__dense_switch__generate_dense_case_11_0,5,6,7,8,9,10,2,11)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__dense_switch__generate_dense_case_11_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dense_switch__generate_dense_case_11_0_i2);
	}
	{
	...
	MR_np_call_localret_ent(ll_backend__code_info__remember_position_2_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i5);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(4);
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(3);
	...
	MR_np_call_localret_ent(ll_backend__trace_gen__maybe_generate_internal_event_code_5_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i6);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__code_gen__generate_goal_5_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i7);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_llds__goal_info_get_store_map_2_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i8);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(ll_backend__code_info__generate_branch_end_6_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i9);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(ll_backend__code_info__reset_to_position_3_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i10);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
...
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(6) = MR_r5;
	MR_r1 = MR_r6;
	MR_np_call_localret_ent(ll_backend__code_info__generate_failure_3_0,
		ll_backend__dense_switch__generate_dense_case_11_0_i11);
MR_def_label(ll_backend__dense_switch__generate_dense_case_11_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module3)
	MR_init_entry1(ll_backend__dense_switch__generate_dense_cases_12_0);
	MR_init_label4(ll_backend__dense_switch__generate_dense_cases_12_0,14,3,4,5)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__dense_switch__generate_dense_cases_12_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r2 <= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(ll_backend__dense_switch__generate_dense_cases_12_0_i14);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ll_backend__dense_switch__generate_dense_cases_12_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__code_info__get_next_label_3_0,
		ll_backend__dense_switch__generate_dense_cases_12_0_i3);
MR_def_label(ll_backend__dense_switch__generate_dense_cases_12_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(ll_backend__dense_switch__generate_dense_case_11_0,
		ll_backend__dense_switch__generate_dense_cases_12_0_i4);
MR_def_label(ll_backend__dense_switch__generate_dense_cases_12_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_localcall_lab(ll_backend__dense_switch__generate_dense_cases_12_0,
		ll_backend__dense_switch__generate_dense_cases_12_0_i5);
MR_def_label(ll_backend__dense_switch__generate_dense_cases_12_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_13_0,8)
	...
	MR_np_call_localret_ent(ll_backend__dense_switch__generate_dense_cases_12_0,
