...
ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__253__1_2_p_0(
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ll_backend__dense_switch__record_dense_label_for_cons_tag_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_IndexMap_10);
  ...
  MR_Word * STATE_VARIABLE_IndexMap_10)
{
  ...
  if (succeeded)
  {
    Var_11 = ((MR_Word) ((MR_hl_field(1, ConsTag_6, 0))));
    succeeded = ((MR_tag((MR_Word) Var_11)) == (MR_Integer) 0);
    if (succeeded)
      Index_8 = ((MR_Integer) ((MR_hl_field(0, Var_11, 0))));
  }
  if (succeeded)
...
{
  MR_bool succeeded;
  MR_Integer FirstVal_26 = ((MR_Integer) ((MR_hl_field(0, DenseSwitchInfo_19, 0))));
  MR_Integer LastVal_27 = ((MR_Integer) ((MR_hl_field(0, DenseSwitchInfo_19, 1))));
  MR_Word NeedRangeCheck_28 = ((MR_Unsigned) ((MR_hl_field(0, DenseSwitchInfo_19, 2))) & (MR_Integer) 1);
  MR_Word IndexRval_29;
  MR_Integer LastFirstValDifference_30;
  ...
  MR_Word STATE_VARIABLE_CI_1_55;
  MR_Word STATE_VARIABLE_CLD_1_56;
  MR_Word Var_61;
  MR_Word Var_62;
  ...
  MR_Box conv4_STATE_VARIABLE_CI_2_63;
  ...
  else
  {
...

    {
      ...
      MR_hl_field(1, Var_53, 0) = ((MR_Box) (FirstVal_26));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(3, IndexRval_29, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__dense_switch_scalar_common_3[0])));
      MR_hl_field(3, IndexRval_29, 2) = ((MR_Box) (VarRval_15));
      MR_hl_field(3, IndexRval_29, 3) = ((MR_Box) (Var_52));
    }
  }
  LastFirstValDifference_30 = (MR_Integer) ((MR_Unsigned) LastVal_27 - (MR_Unsigned) FirstVal_26);
    ...
    case (MR_Integer) 0:
      {
        ...
        STATE_VARIABLE_CI_1_55 = STATE_VARIABLE_CI_0_46;
        STATE_VARIABLE_CLD_1_56 = STATE_VARIABLE_CLD_0_48;
      }
      break;
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(1, Var_60, 0) = ((MR_Box) (LastFirstValDifference_30));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(3, Var_54, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__dense_switch_scalar_common_1[3])));
          MR_hl_field(3, Var_54, 2) = ((MR_Box) (IndexRval_29));
          MR_hl_field(3, Var_54, 3) = ((MR_Box) (Var_59));
        }
        ll_backend__code_loc_dep__fail_if_rval_is_false_6_p_0(Var_54, &RangeCheckCode_31, STATE_VARIABLE_CI_0_46, &STATE_VARIABLE_CI_1_55, STATE_VARIABLE_CLD_0_48, &STATE_VARIABLE_CLD_1_56);
      }
      break;
  }
  ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_1_56, &BranchStart_32);
  {
    Var_61 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_61, 0) = ((MR_Box) (&ll_backend__dense_switch_scalar_common_5[0]));
    MR_hl_field(0, Var_61, 1) = ((MR_Box) (ll_backend__dense_switch__generate_dense_switch_13_p_0_1));
    MR_hl_field(0, Var_61, 2) = ((MR_Box) ((MR_Integer) 5));
    MR_hl_field(0, Var_61, 3) = ((MR_Box) (BranchStart_32));
    MR_hl_field(0, Var_61, 4) = ((MR_Box) (VarName_16));
    MR_hl_field(0, Var_61, 5) = ((MR_Box) (CodeModel_17));
    MR_hl_field(0, Var_61, 6) = ((MR_Box) (SwitchGoalInfo_18));
    MR_hl_field(0, Var_61, 7) = ((MR_Box) (EndLabel_20));
  }
  Var_62 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0));
  mercury__list__map_foldl3_9_p_1((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), (MR_Word) (&ll_backend__dense_switch_scalar_common_1[0]), (MR_Word) (&ll_backend__dense_switch_scalar_common_2[0]), (MR_Word) (&ll_backend__dense_switch_scalar_common_1[1]), (MR_Word) (&ll_backend__code_info__ll_backend__code_info__type_ctor_info_code_info_0), Var_61, TaggedCases_14, &CasesCodes_33, ((MR_Box) (Var_62)), &conv6_IndexMap_34, ((MR_Box) (MaybeEnd0_21)), &conv5_MaybeEnd_22, ((MR_Box) (STATE_VARIABLE_CI_1_55)), &conv4_STATE_VARIABLE_CI_2_63);
  IndexMap_34 = ((MR_Word) (conv6_IndexMap_34));
  *MaybeEnd_22 = ((MR_Word) (conv5_MaybeEnd_22));
  STATE_VARIABLE_CI_2_63 = ((MR_Word) (conv4_STATE_VARIABLE_CI_2_63));
  ...
  ll_backend__dense_switch__generate_dense_jump_table_8_p_0(FirstVal_26, LastVal_27, IndexPairs_36, &Targets_37, (MR_Word) ((MR_Unsigned) 0U), &MaybeFailLabel_38, STATE_VARIABLE_CI_2_63, STATE_VARIABLE_CI_47);
  {
    Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_68, 0) = ((MR_Box) (LastFirstValDifference_30));
  }
  {
    Var_67 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_67, 0) = ((MR_Box) ((MR_Unsigned) 7U));
    MR_hl_field(3, Var_67, 1) = ((MR_Box) (IndexRval_29));
    MR_hl_field(3, Var_67, 2) = ((MR_Box) (Var_68));
    MR_hl_field(3, Var_67, 3) = ((MR_Box) (Targets_37));
  }
  {
    Var_66 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_66, 0) = ((MR_Box) (Var_67));
    MR_hl_field(0, Var_66, 1) = ((MR_Box) ((MR_String) "switch (using dense jump table)"));
  }
  JumpCode_39 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_66)));
  ...
  {
    MR_Word FailLabel_41 = ((MR_Word) ((MR_hl_field(1, MaybeFailLabel_38, 0))));
...

    {
      ...
      MR_hl_field(3, Var_71, 1) = ((MR_Box) (FailLabel_41));
    }
    {
      Var_70 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_70, 0) = ((MR_Box) (Var_71));
      MR_hl_field(0, Var_70, 1) = ((MR_Box) ((MR_String) "compiler-introduced \140fail\' case of dense switch"));
    }
    FailLabelCode_43 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_70)));
    ll_backend__code_loc_dep__generate_failure_3_p_0(&FailureCode_44, *STATE_VARIABLE_CI_47, STATE_VARIABLE_CLD_1_56);
  ...
  }
  {
    ...
    MR_hl_field(3, Var_73, 1) = ((MR_Box) (EndLabel_20));
  }
  {
    Var_72 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_72, 0) = ((MR_Box) (Var_73));
    MR_hl_field(0, Var_72, 1) = ((MR_Box) ((MR_String) "end of dense switch"));
  }
  EndLabelCode_45 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_72)));
  Var_77 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FailCode_40, EndLabelCode_45);
  Var_76 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CasesCode_35, Var_77);
  Var_75 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), JumpCode_39, Var_76);
  *Code_23 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RangeCheckCode_31, Var_75);
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__253__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * DenseSwitchInfo_18)
{
  ...
  if (succeeded)
  {
    ...
    Density_22 = backend_libs__lookup_switch_util__switch_density_2_f_0(NumValues_15, Range_21);
        ...
        case (MR_Integer) 0:
          {
            ...
            TypeCategory_24 = hlds__type_util__classify_type_2_f_0(ModuleInfo_23, VarType_11);
            succeeded = backend_libs__lookup_switch_util__type_range_6_p_0(ModuleInfo_23, TypeCategory_24, VarType_11, &TypeMin_25, &TypeMax_26, &TypeRange_27);
            if (succeeded)
            {
              DetDensity_28 = backend_libs__lookup_switch_util__switch_density_2_f_0(NumValues_15, TypeRange_27);
