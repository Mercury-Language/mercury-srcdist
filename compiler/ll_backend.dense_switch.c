...
{
  {
    ...
    if (succeeded)
    {
      Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ConsTag_6, (MR_Integer) 0))));
...
{
  {
    ...
    MR_Word CanFail_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DenseSwitchInfo_19, (MR_Integer) 2))) & (MR_Integer) 1);
    ...
    MR_Word Var_74;
    MR_Word Var_75;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DenseSwitchInfo_19, (MR_Integer) 2)));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), IndexRval_29, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_53, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          *DenseSwitchInfo_18 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (CanFail_29));
        }
        succeeded = MR_TRUE;
      }
    }
