...
MR_decl_label10(ll_backend__dense_switch__generate_dense_case_12_0, 2,4,5,6,7,10,13,14,15,16)
MR_decl_label8(ll_backend__dense_switch__generate_dense_case_12_0, 20,21,22,23,24,25,26,27)
MR_decl_label9(ll_backend__dense_switch__generate_dense_jump_table_8_0, 4,2,9,8,6,14,20,19,22)
MR_decl_label10(ll_backend__dense_switch__generate_dense_switch_12_0, 2,7,13,9,15,8,17,21,22,23)
MR_decl_label10(ll_backend__dense_switch__generate_dense_switch_12_0, 24,27,30,29,35,36,37,28,40,41)
MR_decl_label3(ll_backend__dense_switch__generate_dense_switch_12_0, 42,43,44)
...
MR_decl_static(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__246__1_2_0)
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module1)
	...
	MR_init_label9(ll_backend__dense_switch__generate_dense_jump_table_8_0,4,2,9,8,6,14,20,19,22)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dense_switch__generate_dense_jump_table_8_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__246__1_2_0);
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module2)
	...
	MR_init_label10(ll_backend__dense_switch__generate_dense_switch_12_0,2,7,13,9,15,8,17,21,22,23)
	MR_init_label10(ll_backend__dense_switch__generate_dense_switch_12_0,24,27,30,29,35,36,37,28,40,41)
	MR_init_label3(ll_backend__dense_switch__generate_dense_switch_12_0,42,43,44)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module4)
	...
	MR_init_label10(ll_backend__dense_switch__generate_dense_case_12_0,2,4,5,6,7,10,13,14,15,16)
	MR_init_label8(ll_backend__dense_switch__generate_dense_case_12_0,20,21,22,23,24,25,26,27)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module7)
	MR_init_entry1(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__246__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__246__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_dense_jump_table__246__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__246__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
