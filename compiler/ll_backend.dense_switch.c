...
{
  {
    ...
    MR_Word NeedRangeCheck_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DenseSwitchInfo_19, (MR_Integer) 2))) & (MR_Integer) 1);
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), IndexRval_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__dense_switch_scalar_common_3[0])));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&ll_backend__dense_switch_scalar_common_4[0]));
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          *DenseSwitchInfo_18 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (NeedRangeCheck_29));
        }
        succeeded = MR_TRUE;
      }
    }
