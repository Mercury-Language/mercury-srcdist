...
static /* final */ const MR_Box ll_backend__dense_switch_scalar_common_4[1][16];

static /* final */ const MR_Box ll_backend__dense_switch_scalar_common_5[1][6];

static /* final */ const MR_Box ll_backend__dense_switch_scalar_common_6[1][7];
...
static /* final */ const MR_Box ll_backend__dense_switch_scalar_common_2[3][3] = {
  ...
  /* row 2 */
  {
    ((MR_Box) (&ll_backend__dense_switch_scalar_common_5[0])),
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__dense_switch__Var_50, 0) = ((MR_Box) (&ll_backend__dense_switch_scalar_common_6[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__dense_switch__Var_58, 0) = ((MR_Box) (&ll_backend__dense_switch_scalar_common_4[0]));
