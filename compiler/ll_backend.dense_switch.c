...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_53, 1) = ((MR_Box) ((MR_Integer) 44));
    ...
    *MaybeEnd_22 = ((MR_Word) (conv5_MaybeEnd_22));
    ...
    ll_backend__dense_switch__generate_dense_jump_table_8_p_0(FirstVal_26, LastVal_27, IndexPairs_36, &Targets_37, (MR_Word) ((MR_Integer) 0), &MaybeFailLabel_38, STATE_VARIABLE_CI_61_61, &STATE_VARIABLE_CI_63_63);
    {
    ...
    if ((MaybeFailLabel_38 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *Targets_12 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      if ((IndexPairs_11 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        if ((STATE_VARIABLE_MaybeFailLabel_0_22 == (MR_Word) ((MR_Integer) 0)))
        {
