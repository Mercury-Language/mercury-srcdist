...
MR_decl_label8(ll_backend__dense_switch__generate_dense_case_12_0, 2,4,5,6,7,10,13,14)
MR_decl_label8(ll_backend__dense_switch__generate_dense_case_12_0, 15,16,20,21,22,23,24,25)
MR_decl_label2(ll_backend__dense_switch__generate_dense_case_12_0, 26,27)
MR_decl_label8(ll_backend__dense_switch__generate_dense_jump_table_8_0, 4,2,9,8,6,14,20,19)
MR_decl_label1(ll_backend__dense_switch__generate_dense_jump_table_8_0, 22)
MR_decl_label8(ll_backend__dense_switch__generate_dense_switch_12_0, 2,7,13,9,15,8,17,21)
MR_decl_label8(ll_backend__dense_switch__generate_dense_switch_12_0, 22,23,24,27,30,29,35,36)
MR_decl_label7(ll_backend__dense_switch__generate_dense_switch_12_0, 37,28,40,41,42,43,44)
MR_decl_label1(ll_backend__dense_switch__record_dense_label_for_cons_tag_4_0, 2)
MR_decl_label8(ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_0, 2,3,6,7,9,11,8,5)
MR_decl_label1(ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_0, 1)
...
MR_decl_static(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__245__1_2_0)
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module0)
	...
	MR_init_label8(ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_0,2,3,6,7,9,11,8,5)
	MR_init_label1(ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module1)
	...
	MR_init_label8(ll_backend__dense_switch__generate_dense_jump_table_8_0,4,2,9,8,6,14,20,19)
...
MR_def_static(ll_backend__dense_switch__generate_dense_jump_table_8_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__245__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r3;
	MR_tfield(0, MR_tempr1, 4) = (MR_Word) MR_tbmkword(0, 0);
	MR_sv(1) = MR_r4;
	MR_sv(2) = MR_r5;
	MR_r2 = (MR_Word) MR_string_const("dense_switch.m", 14);
	MR_r3 = (MR_Word) MR_string_const("generate_dense_jump_table: NextVal > LastVal, IndexList not []", 62);
	}
...
MR_def_label(ll_backend__dense_switch__generate_dense_jump_table_8_0,6)
	...
	MR_tempr3 = MR_r1;
	MR_r6 = ((MR_Integer) MR_tempr3 + (MR_Integer) 1);
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module2)
	...
	MR_init_label8(ll_backend__dense_switch__generate_dense_switch_12_0,2,7,13,9,15,8,17,21)
	MR_init_label8(ll_backend__dense_switch__generate_dense_switch_12_0,22,23,24,27,30,29,35,36)
	MR_init_label7(ll_backend__dense_switch__generate_dense_switch_12_0,37,28,40,41,42,43,44)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,7)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = ((MR_Integer) MR_sv(8) - (MR_Integer) MR_sv(7));
	MR_tag_alloc_heap(MR_tempr2, 3, (MR_Integer) 2);
	MR_tfield(3, MR_tempr2, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr3, 3, (MR_Integer) 4);
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,21)
	...
	MR_np_call_localret_ent(fn__cord__cord_list_to_cord_1_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i22);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
	...
	MR_np_call_localret_ent(map__to_assoc_list_2_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i23);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,27)
	...
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(ll_backend__dense_switch__generate_dense_switch_12_0_i29);
	}
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(12);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i30);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(12);
	MR_GOTO_LAB(ll_backend__dense_switch__generate_dense_switch_12_0_i28);
	}
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_r2 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_string_const("compiler-introduced \140fail\' case of dense switch", 47);
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(12);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i35);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(ll_backend__code_info__generate_failure_3_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i36);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(6);
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(12) = MR_r1;
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
...
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,41)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i42);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i43);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__dense_switch__generate_dense_switch_12_0_i44);
MR_def_label(ll_backend__dense_switch__generate_dense_switch_12_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__dense_switch__record_dense_label_for_cons_tag_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("dense_switch.m", 14);
	MR_r2 = (MR_Word) MR_string_const("record_label_for_index: not int_tag", 35);
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module4)
	...
	MR_init_label8(ll_backend__dense_switch__generate_dense_case_12_0,2,4,5,6,7,10,13,14)
	MR_init_label8(ll_backend__dense_switch__generate_dense_case_12_0,15,16,20,21,22,23,24,25)
	MR_init_label2(ll_backend__dense_switch__generate_dense_case_12_0,26,27)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,7)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		ll_backend__dense_switch__generate_dense_case_12_0_i10);
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,15)
	...
	MR_np_call_localret_ent(ll_backend__code_gen__generate_goal_5_0,
		ll_backend__dense_switch__generate_dense_case_12_0_i16);
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,26)
	...
	MR_np_call_localret_ent(ll_backend__code_info__reset_to_position_3_0,
		ll_backend__dense_switch__generate_dense_case_12_0_i27);
MR_def_label(ll_backend__dense_switch__generate_dense_case_12_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__dense_switch_module7)
	MR_init_entry1(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__245__1_2_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_dense_jump_table__245__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__dense_switch__IntroducedFrom__pred__generate_dense_jump_table__245__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
