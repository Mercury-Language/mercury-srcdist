...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), IndexRval_29, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
...
{
  {
    ...
    {
      MR_Integer NextVal_15 = (MR_Integer) ((MR_Unsigned) CurVal_9 + (MR_Unsigned) (MR_Integer) 1);
      ...
      if ((IndexPairs_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        {
          ll_backend__code_info__get_next_label_3_p_0(&FailLabel_16, STATE_VARIABLE_CI_0_24, &STATE_VARIABLE_CI_40_40);
          {
            STATE_VARIABLE_MaybeFailLabel_39_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeFailLabel_39_39, 0) = ((MR_Box) (FailLabel_16));
          }
        }
        else
        {
        ...
        ll_backend__dense_switch__generate_dense_jump_table_8_p_0(NextVal_15, LastVal_10, IndexPairs_11, &LaterTargets_17, STATE_VARIABLE_MaybeFailLabel_39_39, STATE_VARIABLE_MaybeFailLabel_23, STATE_VARIABLE_CI_40_40, STATE_VARIABLE_CI_25);
        {
          Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (FailLabel_16));
        }
        {
          MR_Word base;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          ll_backend__dense_switch__generate_dense_jump_table_8_p_0(NextVal_15, LastVal_10, LaterIndexPairs_19, &LaterTargets_44, STATE_VARIABLE_MaybeFailLabel_0_22, STATE_VARIABLE_MaybeFailLabel_23, STATE_VARIABLE_CI_0_24, STATE_VARIABLE_CI_25);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (FirstLabel_21));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *Targets_12 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (LaterTargets_44));
          }
        }
        else
        {
          MR_Word STATE_VARIABLE_MaybeFailLabel_34_34;
          ...
          if ((STATE_VARIABLE_MaybeFailLabel_0_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ll_backend__code_info__get_next_label_3_p_0(&FailLabel_45, STATE_VARIABLE_CI_0_24, &STATE_VARIABLE_CI_35_35);
            {
              STATE_VARIABLE_MaybeFailLabel_34_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeFailLabel_34_34, 0) = ((MR_Box) (FailLabel_45));
            }
          }
          else
          {
            FailLabel_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeFailLabel_0_22, (MR_Integer) 0)));
            STATE_VARIABLE_MaybeFailLabel_34_34 = STATE_VARIABLE_MaybeFailLabel_0_22;
            STATE_VARIABLE_CI_35_35 = STATE_VARIABLE_CI_0_24;
          }
          ll_backend__dense_switch__generate_dense_jump_table_8_p_0(NextVal_15, LastVal_10, IndexPairs_11, &LaterTargets_46, STATE_VARIABLE_MaybeFailLabel_34_34, STATE_VARIABLE_MaybeFailLabel_23, STATE_VARIABLE_CI_35_35, STATE_VARIABLE_CI_25);
          {
            Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (FailLabel_45));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *Targets_12 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (LaterTargets_46));
          }
        }
      }
    }
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                LastVal_31 = (MR_Integer) ((MR_Unsigned) TypeRange_27 - (MR_Unsigned) (MR_Integer) 1);
              }
              else
              {
