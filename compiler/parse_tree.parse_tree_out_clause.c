      ...
      switch (MR_tag((MR_Word) Goal_8)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 6:
              {
                MR_Word QuantType_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 1))) & (MR_Integer) 1);
                MR_Word QuantVarsKind_18 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
