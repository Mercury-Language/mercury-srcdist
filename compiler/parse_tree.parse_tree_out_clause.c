  ...
  MR_Word GoalsB_12)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    parse_tree__parse_tree_out_misc__mercury_format_tabs_4_p_0((MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_2[0]), Indent1_14, ((MR_Box) (Stream_8)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_20_20);
  ...
  MR_Word Stream_6)
{
  ...
  mercury__term_io__format_quoted_string_4_p_0((MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_4[0]), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_4[1]), ((MR_Box) (Stream_6)), EnvVarName_5, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_12_12);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) ")");
}
