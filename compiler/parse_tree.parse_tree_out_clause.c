  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_term__mercury_format_var_vs_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_2[0]), VarSet_2, VarNamePrint_3, SVar_19, ((MR_Box) (Stream_1)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_27_27);
  ...
  MR_Word Term_10)
{
  if (((MR_tag((MR_Word) SymName_9)) == (MR_Integer) 1))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) ".");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (PredName_13));
    }
    Var_22 = mercury__term_context__dummy_context_0_f_0();
    {
      SubTerm_14 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SubTerm_14, 0) = ((MR_Box) (Var_21));
      MR_hl_field(MR_mktag(0), SubTerm_14, 1) = ((MR_Box) (Term_10));
      MR_hl_field(MR_mktag(0), SubTerm_14, 2) = ((MR_Box) (Var_22));
    }
  ...
  else
  {
    MR_Word Var_26;
    MR_Word Var_27;
    MR_String PredName_31 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName_9, (MR_Integer) 0))));
    MR_Word SubTerm_32;

    {
      Var_26 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (PredName_31));
    }
    Var_27 = mercury__term_context__dummy_context_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), SubTerm_32, 2) = ((MR_Box) (Var_27));
    }
