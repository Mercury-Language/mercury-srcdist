...
static void MR_CALL 
parse_tree__parse_tree_out_clause__mercury_output_pred_clause_6_p_0(
  MR_Word VarSet_7,
  MR_Word PredName_8,
  MR_Word Args_9,
  MR_Word Body_10);
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeBodyGoal_13)) == (MR_Integer) 0))
    {
      ...
      {
        BodyGoal_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), BodyGoal_16, 0) = ((MR_Box) (Var_31));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MR_Word HeadArg_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncArgTerms_17, (MR_Integer) 0))));
            MR_Word TailArgs_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncArgTerms_17, (MR_Integer) 1))));
            MR_Box conv1_STATE_VARIABLE_IO_23_49;

            mercury__io__write_string_3_p_0((MR_String) "(");
            parse_tree__parse_tree_out_term__mercury_format_comma_separated_terms_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_12, (MR_Integer) 0, HeadArg_42, TailArgs_43, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_23_49);
            mercury__io__write_string_3_p_0((MR_String) ")");
          }
          mercury__io__write_string_3_p_0((MR_String) " = ");
          succeeded = ((((MR_tag((MR_Word) BodyGoal_16)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), BodyGoal_16, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
          {
          ...
          {
            MR_Box conv3_STATE_VARIABLE_IO_32_58;

            parse_tree__parse_tree_out_term__mercury_format_term_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_12, (MR_Integer) 0, ResultTerm_18, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_32_58);
            mercury__io__write_string_3_p_0((MR_String) " :-\n\t");
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            MR_Word HeadArg_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTerms_10, (MR_Integer) 0))));
            MR_Word TailArgs_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTerms_10, (MR_Integer) 1))));
            MR_Box conv4_STATE_VARIABLE_IO_21_83;

            mercury__io__write_string_3_p_0((MR_String) "(");
            parse_tree__parse_tree_out_term__mercury_format_comma_separated_terms_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_12, (MR_Integer) 0, HeadArg_76, TailArgs_77, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_21_83);
            mercury__io__write_string_3_p_0((MR_String) ")");
          }
          succeeded = ((((MR_tag((MR_Word) BodyGoal_16)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), BodyGoal_16, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeBodyGoal_13)) == (MR_Integer) 0))
    {
      ...
      {
        BodyGoal_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), BodyGoal_16, 0) = ((MR_Box) (Var_35));
        MR_hl_field(MR_mktag(1), BodyGoal_16, 1) = ((MR_Box) (&parse_tree__parse_tree_out_clause_scalar_common_4[0]));
        MR_hl_field(MR_mktag(1), BodyGoal_16, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), BodyGoal_16, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MR_Word HeadArg_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncArgTerms_18, (MR_Integer) 0))));
            MR_Word TailArgs_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncArgTerms_18, (MR_Integer) 1))));
            MR_Box conv1_STATE_VARIABLE_IO_23_53;

            mercury__io__write_string_3_p_0((MR_String) "(");
            parse_tree__parse_tree_out_term__mercury_format_comma_separated_terms_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_12, (MR_Integer) 0, HeadArg_46, TailArgs_47, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_23_53);
            mercury__io__write_string_3_p_0((MR_String) ")");
          }
          mercury__io__write_string_3_p_0((MR_String) " = ");
          succeeded = ((((MR_tag((MR_Word) BodyGoal_16)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), BodyGoal_16, (MR_Integer) 0)))) == (MR_Integer) 0)));
          ...
          {
            MR_Box conv3_STATE_VARIABLE_IO_32_62;

            parse_tree__parse_tree_out_term__mercury_format_term_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_12, (MR_Integer) 0, ResultTerm_19, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_32_62);
            mercury__io__write_string_3_p_0((MR_String) " :-\n\t");
            parse_tree__parse_tree_out_clause__mercury_output_goal_5_p_0(VarSet_12, (MR_Integer) 1, BodyGoal_16);
          }
        }
        break;
      case (MR_Integer) 0:
        parse_tree__parse_tree_out_clause__mercury_output_pred_clause_6_p_0(VarSet_12, PredName_17, ArgTerms_10, BodyGoal_16);
        break;
    }
    mercury__io__write_string_3_p_0((MR_String) ".\n");
  }
...
{
  {
    ...
    parse_tree__mercury_to_mercury__mercury_output_sym_name_3_p_0(PredName_8);
    if (!((Args_9 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word HeadArg_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_9, (MR_Integer) 0))));
      MR_Word TailArgs_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_9, (MR_Integer) 1))));
      MR_Box conv0_STATE_VARIABLE_IO_21_21;

      mercury__io__write_string_3_p_0((MR_String) "(");
      parse_tree__parse_tree_out_term__mercury_format_comma_separated_terms_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_out_clause_scalar_common_1[1]), VarSet_7, (MR_Integer) 0, HeadArg_12, TailArgs_13, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_21_21);
      mercury__io__write_string_3_p_0((MR_String) ")");
    }
    succeeded = ((((MR_tag((MR_Word) Body_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Body_10, (MR_Integer) 0)))) == (MR_Integer) 0)));
    if (succeeded)
    {
    }
    if (!(succeeded))
    {
      mercury__io__write_string_3_p_0((MR_String) " :-\n\t");
      parse_tree__parse_tree_out_clause__mercury_output_goal_5_p_0(VarSet_7, (MR_Integer) 1, Body_10);
    }
  }
}
  ...
  top_of_proc_1:;
    {
      ...
      switch (MR_tag((MR_Word) Goal_8)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                ...
                Indent1_435 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 2:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "(");
                Indent1_449 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "\\+ (");
                Indent1_440 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 5:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "(");
                Indent1_446 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 6:
              {
                MR_Word QuantType_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
                ...
                else
                {
                  ...
                  mercury__io__write_string_3_p_0((MR_String) "] (");
                  Indent1_400 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 7:
              {
                ...
                Indent1_415 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 11:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) " (");
                Indent1_417 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 12:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "] (");
                Indent1_419 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 13:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "] (");
                Indent1_421 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 14:
              {
                MR_Word HeadWarning_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 2))) & (MR_Integer) 7);
                ...
                mercury__io__write_string_3_p_0((MR_String) "] (");
                Indent1_425 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 15:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "]");
                Var_213 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
                parse_tree__mercury_to_mercury__mercury_output_newline_3_p_0(Var_213);
                Var_216 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 16:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) ")] (");
                Indent1_427 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 17:
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "] (");
                Indent1_431 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
            ...
            case (MR_Integer) 19:
              {
                ...
                MR_Integer Indent1_399 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
  ...
  top_of_proc_2:;
    {
      ...
      else
      {
        ...
        mercury__io__write_string_3_p_0((MR_String) "] (");
        Indent1_38 = (MR_Integer) ((MR_Unsigned) Indent_12 + (MR_Unsigned) 1);
  ...
  MR_Word Goals_8)
{
  while (MR_TRUE)
  {
    ...
    if (!((Goals_8 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      {
        MR_Integer Var_16 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
  ...
  MR_Word Goal_8)
{
  while (MR_TRUE)
  {
    ...
    parse_tree__mercury_to_mercury__mercury_output_newline_3_p_0(Indent_7);
    mercury__io__write_string_3_p_0((MR_String) "&");
    Indent1_10 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
    parse_tree__mercury_to_mercury__mercury_output_newline_3_p_0(Indent1_10);
    succeeded = ((((MR_tag((MR_Word) Goal_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 0)))) == (MR_Integer) 5)));
    if (succeeded)
    {
  ...
  MR_Word Goal_8)
{
  while (MR_TRUE)
  {
    ...
    Indent1_10 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
    parse_tree__mercury_to_mercury__mercury_output_newline_3_p_0(Indent1_10);
    succeeded = ((((MR_tag((MR_Word) Goal_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 0)))) == (MR_Integer) 2)));
    if (succeeded)
    {
      SubGoalA_12 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 2))));
      SubGoalB_13 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_8, (MR_Integer) 3))));
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__io__write_string_3_p_0((MR_String) "(");
        Indent1_105 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
...
{
  {
    MR_bool succeeded = (Vars_7 != (MR_Word) ((MR_Unsigned) 0U));
    ...
    if (!(succeeded))
    {
      succeeded = (StateVars_8 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
      }
    }
    if (succeeded)
    {
      ...
      succeeded = (Vars_7 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        succeeded = (StateVars_8 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
  ...
  MR_Word Term_8)
{
  if (((MR_tag((MR_Word) SymName_7)) == (MR_Integer) 1))
  {
    ...
    {
      SubTerm_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
  ...
  else
  {
    ...
    {
      SubTerm_30 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
