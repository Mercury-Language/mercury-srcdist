  ...
  MR_Word Term_10)
{
  if (((MR_tag((MR_Word) SymName_9)) == (MR_Integer) 1))
  {
    ...
    parse_tree__parse_tree_out_term__mercury_output_term_nq_vs_7_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_8, (MR_Integer) 0, (MR_Integer) 0, SubTerm_15, Stream_7);
  }
  else
  {
    MR_Word Var_26;
