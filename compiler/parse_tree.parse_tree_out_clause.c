    ...
    if (((MR_tag((MR_Word) parse_tree__parse_tree_out_clause__MaybeBodyGoal_13)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__parse_tree_out_clause__BodyGoal_16, 1) = ((MR_Box) (&parse_tree__parse_tree_out_clause_scalar_common_4[0]));
              ...
              case (MR_Integer) 15:
                {
                    ...
                    }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_clause__Var_208, 0) = ((MR_Box) (&parse_tree__parse_tree_out_clause_scalar_common_2[0]));
              ...
              case (MR_Integer) 17:
                {
                    ...
                    }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_clause__Var_175, 0) = ((MR_Box) (&parse_tree__parse_tree_out_clause_scalar_common_3[0]));
