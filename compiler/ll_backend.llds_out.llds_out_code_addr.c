  ...
  MR_Word Label_6)
{
  ...
  {
    MR_Word Var_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_6, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 0:
        {
          ...
          Str_8 = mercury__string__f_43_43_2_f_0((MR_String) "MR_LABEL_AP(", Var_15);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          Str_8 = mercury__string__f_43_43_2_f_0((MR_String) "MR_ENTRY_AP(", Var_18);
        }
        break;
      case (MR_Integer) 1:
        {
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              MR_Integer Num_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_13, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              MR_Integer Num_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_20, (MR_Integer) 0))));

              Var_15 = mercury__string__int_to_string_1_f_0(Num_31);
            }
    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_43 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_12, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          MR_Word Label_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CodeAddress_14, (MR_Integer) 0))));

          if (((MR_tag((MR_Word) Label_33)) == (MR_Integer) 1))
          {
            MR_Word Var_71 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_33, (MR_Integer) 0))) & (MR_Integer) 3);
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((Variant_14 == (MR_Word) ((MR_Unsigned) 0U)))
              Var_27 = (MR_String) "compact";
            else
            {
              MR_Integer Num_100 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_14, (MR_Integer) 0))));

              Var_27 = mercury__string__int_to_string_1_f_0(Num_100);
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            if ((Variant_48 == (MR_Word) ((MR_Unsigned) 0U)))
              Var_21 = (MR_String) "compact";
            else
            {
              MR_Integer Num_99 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_48, (MR_Integer) 0))));

              Var_21 = mercury__string__int_to_string_1_f_0(Num_99);
            }
