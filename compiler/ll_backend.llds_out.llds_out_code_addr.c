    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_42 = ((((MR_Unsigned) ((MR_hl_field(0, Info_12, 7))) >> 2)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MR_Word Var_69 = ((MR_Unsigned) ((MR_hl_field(1, Label_32, 0))) & (MR_Integer) 3);
  ...
  switch (MR_tag((MR_Word) CodeAddr_8)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(CodeAddr_8)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word UseMacro_13 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, 7))) >> 2)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 2:
          {
            MR_Word UseMacro_47 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, 7))) >> 2)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              MR_Integer Num_106 = ((MR_Integer) ((MR_hl_field(1, Variant_14, 0))));
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              MR_Integer Num_105 = ((MR_Integer) ((MR_hl_field(1, Variant_48, 0))));
