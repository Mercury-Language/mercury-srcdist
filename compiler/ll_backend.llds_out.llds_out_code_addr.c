  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Word Var_12 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  MR_Word Label_6)
{
  ...
  {
    MR_Word Var_29 = ((MR_Unsigned) ((MR_hl_field(1, Label_6, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  MR_Word * Wrapper_8)
{
  switch (MR_tag((MR_Word) CodeAddr_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Label_9 = ((MR_Word) ((MR_hl_field(1, CodeAddr_5, (MR_Integer) 0))));
        ...
        *NeedsPrefix_7 = (MR_Integer) 1;
        ...
        {
          MR_Word Var_30 = ((MR_Unsigned) ((MR_hl_field(1, Label_9, (MR_Integer) 0))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 2:
      {
        MR_Word ProcLabel_11 = ((MR_Word) ((MR_hl_field(2, CodeAddr_5, (MR_Integer) 0))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, CodeAddr_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Last_12 = ((MR_Unsigned) ((MR_hl_field(3, CodeAddr_5, (MR_Integer) 1))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            MR_Word Variant_13 = ((MR_Word) ((MR_hl_field(3, CodeAddr_5, (MR_Integer) 1))));
            MR_String Var_17;
            ...
            {
              MR_Integer Num_32 = ((MR_Integer) ((MR_hl_field(1, Variant_13, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_String Var_19;
            MR_Word Variant_20 = ((MR_Word) ((MR_hl_field(3, CodeAddr_5, (MR_Integer) 1))));

            if ((Variant_20 == (MR_Word) ((MR_Unsigned) 0U)))
              Var_19 = (MR_String) "compact";
            else
            {
              MR_Integer Num_31 = ((MR_Integer) ((MR_hl_field(1, Variant_20, (MR_Integer) 0))));
  ...
  MR_Word Label_5)
{
  ...
  {
    MR_Word ProcLabel_8 = ((MR_Word) ((MR_hl_field(1, Label_5, (MR_Integer) 1))));

    LabelStr_6 = backend_libs__name_mangle__proc_label_to_c_string_2_f_0(AddPrefix_4, ProcLabel_8);
  }
  else
  {
    MR_Integer Num_9 = ((MR_Integer) ((MR_hl_field(0, Label_5, (MR_Integer) 0))));
    MR_String ProcLabelStr_10;
    MR_String NumStr_11;
    MR_String Var_12;
    MR_Word ProcLabel_14 = ((MR_Word) ((MR_hl_field(0, Label_5, (MR_Integer) 1))));
  ...
  MR_Word Variant_3)
{
  ...
  {
    MR_Integer Num_5 = ((MR_Integer) ((MR_hl_field(1, Variant_3, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_DeclSet_24)
{
  ...
  succeeded = ll_backend__llds_out__llds_out_util__decl_set_insert_new_3_p_0(Var_27, STATE_VARIABLE_DeclSet_0_23, &STATE_VARIABLE_DeclSet_28_28);
  if (succeeded)
  {
    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_42 = ((((MR_Unsigned) ((MR_hl_field(0, Info_12, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          MR_Word Label_32 = ((MR_Word) ((MR_hl_field(1, CodeAddress_14, (MR_Integer) 0))));

          if (((MR_tag((MR_Word) Label_32)) == (MR_Integer) 1))
          {
            MR_Word Var_69 = ((MR_Unsigned) ((MR_hl_field(1, Label_32, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, CodeAddress_14, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *STATE_VARIABLE_N_22 = STATE_VARIABLE_N_0_21;
            break;
  ...
  switch (MR_tag((MR_Word) CodeAddr_8)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(CodeAddr_8)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word UseMacro_13 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 2:
          {
            MR_Word UseMacro_47 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
    ...
    case (MR_Integer) 1:
      {
        MR_Word Label_10 = ((MR_Word) ((MR_hl_field(1, CodeAddr_8, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word ProcLabel_11 = ((MR_Word) ((MR_hl_field(2, CodeAddr_8, (MR_Integer) 0))));
        MR_String Var_22;
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, CodeAddr_8, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
          }
        ...
        case (MR_Integer) 1:
          {
            MR_Word Variant_14 = ((MR_Word) ((MR_hl_field(3, CodeAddr_8, (MR_Integer) 1))));
            MR_String Var_37;
            ...
            {
              MR_Integer Num_106 = ((MR_Integer) ((MR_hl_field(1, Variant_14, (MR_Integer) 0))));

              Var_37 = mercury__string__int_to_string_1_f_0(Num_106);
            }
        ...
        case (MR_Integer) 2:
          {
            MR_String Var_43;
            MR_Word Variant_48 = ((MR_Word) ((MR_hl_field(3, CodeAddr_8, (MR_Integer) 1))));

            if ((Variant_48 == (MR_Word) ((MR_Unsigned) 0U)))
              Var_43 = (MR_String) "compact";
            else
            {
              MR_Integer Num_105 = ((MR_Integer) ((MR_hl_field(1, Variant_48, (MR_Integer) 0))));

              Var_43 = mercury__string__int_to_string_1_f_0(Num_105);
            }
  ...
  MR_Word Label_6)
{
  if (((MR_tag((MR_Word) Label_6)) == (MR_Integer) 1))
  {
    MR_Word Var_25 = ((MR_Word) ((MR_hl_field(1, Label_6, (MR_Integer) 1))));
    MR_Word Var_26 = ((MR_Unsigned) ((MR_hl_field(1, Label_6, (MR_Integer) 0))) & (MR_Integer) 3);
