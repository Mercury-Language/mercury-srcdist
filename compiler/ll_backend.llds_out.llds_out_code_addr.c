      ...
      switch (MR_tag((MR_Word) CodeAddress_12)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(CodeAddress_12)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word UseMacro_45 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 7))) >> (MR_Integer) 3)) & (MR_Integer) 1);
  ...
  switch (MR_tag((MR_Word) CodeAddr_6)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(CodeAddr_6)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word UseMacro_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 7))) >> (MR_Integer) 3)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 2:
          {
            MR_Word UseMacro_43 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 7))) >> (MR_Integer) 3)) & (MR_Integer) 1);
