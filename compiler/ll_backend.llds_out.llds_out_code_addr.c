    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_42 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_12, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          MR_Word Label_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CodeAddress_14, (MR_Integer) 0))));

          if (((MR_tag((MR_Word) Label_32)) == (MR_Integer) 1))
          {
            MR_Word Var_70 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_32, (MR_Integer) 0))) & (MR_Integer) 3);
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              MR_Integer Num_108 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_14, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              MR_Integer Num_107 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Variant_48, (MR_Integer) 0))));
