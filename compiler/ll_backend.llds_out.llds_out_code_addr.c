      ...
      case (MR_Integer) 0:
        {
          ...
          Str_8 = mercury__string__f_43_43_2_f_0((MR_String) "MR_LABEL_AP(", Var_21);
        }
        break;
      case (MR_Integer) 2:
        {
    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_47 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_12, (MR_Integer) 7))) >> 2)) & (MR_Integer) 1);
