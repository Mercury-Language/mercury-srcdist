    ...
    switch (MR_tag((MR_Word) CodeAddress_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CodeAddress_14)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word UseMacro_43 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_12, (MR_Integer) 7))) >> 3)) & (MR_Integer) 1);
  ...
  MR_Word Label_6)
{
  if (((MR_tag((MR_Word) Label_6)) == (MR_Integer) 1))
  {
    ...
    switch (Var_27) {
      ...
      case (MR_Integer) 2:
        {
          MR_String LabelStr_28;

          mercury__io__write_string_4_p_0(Stream_5, (MR_String) "MR_decl_entry(");
          LabelStr_28 = backend_libs__name_mangle__proc_label_to_c_string_2_f_0((MR_Integer) 0, Var_26);
          mercury__io__write_string_4_p_0(Stream_5, LabelStr_28);
