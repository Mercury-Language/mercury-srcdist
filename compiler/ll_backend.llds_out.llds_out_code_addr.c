...
{
  {
    ...
    if (((MR_tag((MR_Word) Label_4)) == (MR_Integer) 1))
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_4, (MR_Integer) 0)));
    ...
    case (MR_Integer) 1:
      {
        ...
        *NeedsPrefix_7 = (MR_Integer) 1;
        if (((MR_tag((MR_Word) Label_9)) == (MR_Integer) 1))
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_9, (MR_Integer) 0)));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CodeAddr_5, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (((MR_tag((MR_Word) Label_35)) == (MR_Integer) 1))
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_35, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 7)));
