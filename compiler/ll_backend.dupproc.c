          ...
          case (MR_Integer) 1:
            {
              ...
              switch (MR_tag((MR_Word) ll_backend__dupproc__Const_12)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(ll_backend__dupproc__Const_12)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__dupproc__Const_12, (MR_Integer) 0)))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      ll_backend__dupproc__StdConst_13 = ll_backend__dupproc__Const_12;
                      break;
                    ...
                    case (MR_Integer) 4:
                      {
                        MR_Word ll_backend__dupproc__CodeAddr_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__dupproc__Const_12, (MR_Integer) 1)));
                        MR_Word ll_backend__dupproc__StdCodeAddr_37;

                        {
                          ll_backend__dupproc__standardize_code_addr_3_p_0(ll_backend__dupproc__CodeAddr_36, &ll_backend__dupproc__StdCodeAddr_37, ll_backend__dupproc__DupProcMap_6);
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(3), ll_backend__dupproc__StdConst_13, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                          MR_hl_field(MR_mktag(3), ll_backend__dupproc__StdConst_13, 1) = ((MR_Box) (ll_backend__dupproc__StdCodeAddr_37));
                        }
                      }
                      break;
                    case (MR_Integer) 5:
...
{
  {
    ...
    switch (MR_tag((MR_Word) ll_backend__dupproc__CodeAddr_4)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        switch (MR_unmkbody(ll_backend__dupproc__CodeAddr_4)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__dupproc__CodeAddr_4, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *ll_backend__dupproc__StdCodeAddr_5 = ll_backend__dupproc__CodeAddr_4;
            break;
...
{
  {
    ...
    MR_Word ll_backend__dupproc__V_13_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__CProc_4, (MR_Integer) 4)));
    ...
    ll_backend__dupproc__V_25_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__CProc_4, (MR_Integer) 8)));
    {
      ...
      *ll_backend__dupproc__StdCProc_5 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (ll_backend__dupproc__V_21_21));
        ...
        if (ll_backend__dupproc__succeeded)
          {
            ...
            ll_backend__dupproc__V_45_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__Proc_10, (MR_Integer) 4)));
            ...
            ll_backend__dupproc__V_30_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__ModelStdProc_7, (MR_Integer) 4)));
            ...
            if (ll_backend__dupproc__succeeded)
              {
                ...
                ll_backend__dupproc__V_67_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__Proc0_12, (MR_Integer) 4)));
                ...
                if (ll_backend__dupproc__succeeded)
                ...
                else
                  {
                    ...
                    ll_backend__dupproc__V_79_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__Proc0_12, (MR_Integer) 8)));
                    {
                      ...
                      MR_hl_field(MR_mktag(0), ll_backend__dupproc__Proc_54, 4) = ((MR_Box) (ll_backend__dupproc__V_75_75));
    ...
    else
      {
        ...
        if ((ll_backend__dupproc__V_30_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word ll_backend__dupproc__V_21_21;
            MR_Word ll_backend__dupproc__V_23_23;
            MR_Word ll_backend__dupproc__Instrs_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__V_32_32, (MR_Integer) 5)));
            ...
            MR_Word ll_backend__dupproc__V_43_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__V_32_32, (MR_Integer) 4)));
            ...
            ll_backend__dupproc__V_55_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__dupproc__V_32_32, (MR_Integer) 8)));
            {
              ...
              MR_hl_field(MR_mktag(0), ll_backend__dupproc__StdProc1_15, 4) = ((MR_Box) (ll_backend__dupproc__V_51_51));
