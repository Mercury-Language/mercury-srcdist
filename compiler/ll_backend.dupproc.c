...
MR_decl_label10(ll_backend__dupproc__eliminate_dup_procs_5_0, 57,7,9,15,16,17,23,24,25,4)
...
MR_decl_label9(ll_backend__dupproc__standardize_code_addr_3_0, 69,13,11,19,70,5,4,36,68)
MR_decl_label10(ll_backend__dupproc__standardize_instr_3_0, 45,49,76,5,75,8,82,11,84,15)
MR_decl_label10(ll_backend__dupproc__standardize_instr_3_0, 81,18,83,21,22,24,85,27,77,30)
MR_decl_label9(ll_backend__dupproc__standardize_instr_3_0, 80,33,78,36,37,79,41,43,73)
...
MR_decl_label10(ll_backend__dupproc__standardize_rval_3_0, 32,37,4,5,7,21,25,10,67,30)
MR_decl_label1(ll_backend__dupproc__standardize_rval_3_0, 65)
...
MR_BEGIN_MODULE(ll_backend__dupproc_module2)
	...
	MR_init_label9(ll_backend__dupproc__standardize_code_addr_3_0,69,13,11,19,70,5,4,36,68)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupproc_module4)
	...
	MR_init_label10(ll_backend__dupproc__standardize_rval_3_0,32,37,4,5,7,21,25,10,67,30)
	MR_init_label1(ll_backend__dupproc__standardize_rval_3_0,65)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupproc_module6)
	...
	MR_init_label10(ll_backend__dupproc__standardize_instr_3_0,45,49,76,5,75,8,82,11,84,15)
	MR_init_label10(ll_backend__dupproc__standardize_instr_3_0,81,18,83,21,22,24,85,27,77,30)
	MR_init_label9(ll_backend__dupproc__standardize_instr_3_0,80,33,78,36,37,79,41,43,73)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupproc_module9)
	...
	MR_init_label10(ll_backend__dupproc__eliminate_dup_procs_5_0,57,7,9,15,16,17,23,24,25,4)
...
MR_def_label(ll_backend__dupproc__eliminate_duplicate_procs_4_0,3)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_tfield(1, MR_tempr2, 0), 1);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
...
MR_def_static(ll_backend__dupproc__disallowed_instr_1_0)
	...
	MR_r1 = ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 3));
	MR_proceed();
	}
