...
MR_decl_label8(ll_backend__dupproc__eliminate_dup_procs_5_0, 43,7,9,10,11,12,14,15)
MR_decl_label6(ll_backend__dupproc__eliminate_dup_procs_5_0, 16,4,5,17,18,20)
...
MR_decl_label8(ll_backend__dupproc__standardize_code_addr_3_0, 60,15,13,19,61,24,23,27)
MR_decl_label1(ll_backend__dupproc__standardize_code_addr_3_0, 59)
...
MR_decl_label3(ll_backend__dupproc__standardize_instrs_3_0, 13,4,5)
MR_decl_label4(ll_backend__dupproc__standardize_label_3_0, 5,3,9,8)
MR_decl_label6(ll_backend__dupproc__standardize_labels_3_0, 35,7,5,11,10,14)
...
MR_BEGIN_MODULE(ll_backend__dupproc_module1)
	...
	MR_init_label6(ll_backend__dupproc__standardize_labels_3_0,35,7,5,11,10,14)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__standardize_labels_3_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_labels_3_0_i35);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__dupproc__standardize_labels_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_BEGIN_MODULE(ll_backend__dupproc_module2)
	...
	MR_init_label8(ll_backend__dupproc__standardize_code_addr_3_0,60,15,13,19,61,24,23,27)
	MR_init_label1(ll_backend__dupproc__standardize_code_addr_3_0,59)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__standardize_code_addr_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ll_backend__dupproc__standardize_code_addr_3_0_i27));
...
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,23)
	...
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(3);
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__dupproc_module5)
	...
	MR_init_label3(ll_backend__dupproc__standardize_instrs_3_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__standardize_instrs_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instrs_3_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__dupproc__standardize_instrs_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(ll_backend__dupproc_module9)
	...
	MR_init_label8(ll_backend__dupproc__eliminate_dup_procs_5_0,43,7,9,10,11,12,14,15)
	MR_init_label6(ll_backend__dupproc__eliminate_dup_procs_5_0,16,4,5,17,18,20)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__eliminate_dup_procs_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__eliminate_dup_procs_5_0_i43);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
