...
MR_decl_label10(ll_backend__dupproc__eliminate_dup_procs_5_0, 74,7,9,15,16,17,23,24,25,4)
MR_decl_label4(ll_backend__dupproc__eliminate_dup_procs_5_0, 5,27,30,32)
MR_decl_label5(ll_backend__dupproc__eliminate_duplicate_procs_4_0, 3,32,7,11,12)
MR_decl_label6(ll_backend__dupproc__find_matching_model_proc_5_0, 25,3,4,6,5,1)
MR_decl_label5(ll_backend__dupproc__standardize_code_addr_3_0, 11,10,9,16,62)
...
MR_decl_label10(ll_backend__dupproc__standardize_instr_3_0, 35,36,34,39,40,41,38,44,45,43)
MR_decl_label6(ll_backend__dupproc__standardize_instr_3_0, 48,49,47,53,55,128)
...
MR_decl_label4(ll_backend__dupproc__standardize_maybe_labels_3_0, 26,5,6,8)
MR_decl_label1(ll_backend__dupproc__standardize_proc_3_0, 2)
MR_decl_label8(ll_backend__dupproc__standardize_rval_3_0, 4,5,3,14,99,7,25,24)
...
MR_BEGIN_MODULE(ll_backend__dupproc_module1)
	...
	MR_init_label4(ll_backend__dupproc__standardize_maybe_labels_3_0,26,5,6,8)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__standardize_maybe_labels_3_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_maybe_labels_3_0_i26);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__dupproc__standardize_maybe_labels_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_np_localcall_lab(ll_backend__dupproc__standardize_maybe_labels_3_0,
		ll_backend__dupproc__standardize_maybe_labels_3_0_i8);
MR_def_label(ll_backend__dupproc__standardize_maybe_labels_3_0,5)
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_label_3_0,
		ll_backend__dupproc__standardize_maybe_labels_3_0_i6);
MR_def_label(ll_backend__dupproc__standardize_maybe_labels_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_localcall_lab(ll_backend__dupproc__standardize_maybe_labels_3_0,
		ll_backend__dupproc__standardize_maybe_labels_3_0_i8);
MR_def_label(ll_backend__dupproc__standardize_maybe_labels_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ll_backend__dupproc_module2)
	...
	MR_init_label5(ll_backend__dupproc__standardize_code_addr_3_0,11,10,9,16,62)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__standardize_code_addr_3_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_code_addr_3_0_i62);
	}
...
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_code_addr_3_0_i10);
	}
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 1);
	MR_tfield(2, MR_r1, 0) = MR_r2;
	MR_decr_sp_and_return(2);
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(2);
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,9)
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_label_3_0,
		ll_backend__dupproc__standardize_code_addr_3_0_i16);
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(ll_backend__dupproc__standardize_code_addr_3_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__dupproc_module4)
	...
	MR_init_label8(ll_backend__dupproc__standardize_rval_3_0,4,5,3,14,99,7,25,24)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupproc__standardize_rval_3_0,3)
	...
	if (MR_LTAGS_TEST(MR_tempr1,0,1)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_rval_3_0_i99);
	}
...
MR_def_label(ll_backend__dupproc__standardize_rval_3_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(ll_backend__dupproc__standardize_rval_3_0,7)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_rval_3_0_i24);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_np_localcall_lab(ll_backend__dupproc__standardize_rval_3_0,
		ll_backend__dupproc__standardize_rval_3_0_i25);
...
MR_BEGIN_MODULE(ll_backend__dupproc_module6)
	...
	MR_init_label10(ll_backend__dupproc__standardize_instr_3_0,35,36,34,39,40,41,38,44,45,43)
	MR_init_label6(ll_backend__dupproc__standardize_instr_3_0,48,49,47,53,55,128)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,9)
	...
	if (MR_RTAGS_TEST(MR_r1,3,27)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instr_3_0_i128);
	}
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,34)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,33)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instr_3_0_i38);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(6) = MR_r2;
	...
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_rval_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i39);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(5);
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_rval_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i40);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,40)
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_label_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i41);
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,32)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instr_3_0_i43);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(6) = MR_r2;
	...
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_rval_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i44);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_label_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i45);
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instr_3_0_i47);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(6) = MR_r2;
	...
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_code_addr_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i48);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_code_addr_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i49);
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__dupproc__standardize_instr_3_0_i53);
	}
	...
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_maybe_code_addr_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i55);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_sv(6) = MR_r3;
	MR_np_call_localret_ent(ll_backend__dupproc__standardize_maybe_code_addr_3_0,
		ll_backend__dupproc__standardize_instr_3_0_i55);
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ll_backend__dupproc__standardize_instr_3_0,128)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__dupproc_module8)
	...
	MR_init_label6(ll_backend__dupproc__find_matching_model_proc_5_0,25,3,4,6,5,1)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__find_matching_model_proc_5_0)
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(ll_backend__dupproc__find_matching_model_proc_5_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__dupproc__find_matching_model_proc_5_0,5)
	...
	MR_GOTO_LAB(ll_backend__dupproc__find_matching_model_proc_5_0_i25);
...
MR_BEGIN_MODULE(ll_backend__dupproc_module9)
	...
	MR_init_label10(ll_backend__dupproc__eliminate_dup_procs_5_0,74,7,9,15,16,17,23,24,25,4)
	MR_init_label4(ll_backend__dupproc__eliminate_dup_procs_5_0,5,27,30,32)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupproc__eliminate_dup_procs_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__dupproc__eliminate_dup_procs_5_0_i74);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,25)
	...
	MR_np_localcall_lab(ll_backend__dupproc__eliminate_dup_procs_5_0,
		ll_backend__dupproc__eliminate_dup_procs_5_0_i32);
...
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,27)
	...
	MR_np_call_localret_ent(list__append_3_1,
		ll_backend__dupproc__eliminate_dup_procs_5_0_i30);
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_sv(7) = MR_sv(6);
	MR_r3 = MR_sv(5);
	MR_np_localcall_lab(ll_backend__dupproc__eliminate_dup_procs_5_0,
		ll_backend__dupproc__eliminate_dup_procs_5_0_i32);
MR_def_label(ll_backend__dupproc__eliminate_dup_procs_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
void mercury__ll_backend__dupproc__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__dupproc);
