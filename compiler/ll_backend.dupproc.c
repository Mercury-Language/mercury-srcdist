  ...
  MR_Word * STATE_VARIABLE_DupProcMap_19)
{
  ...
  else
  {
    ...
    else
    {
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(0, Var_32, (MR_Integer) 5)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, Proc0_12, (MR_Integer) 5)));
  ...
  MR_Word DupProcMap_6)
{
  ...
  packed_word_1 = (MR_Unsigned) ((MR_hl_field(0, CProc_4, (MR_Integer) 5)));
