    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__write_string_3_p_0((MR_String) "");
        mercury__io__write_string_3_p_0((MR_String) "disj(\n");
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, (MR_String) "\t", Constraints_11);
        mercury__io__write_string_3_p_0((MR_String) "");
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, (MR_String) "\t", Constraints_31);
        mercury__io__write_string_3_p_0((MR_String) "");
