...
MR_decl_label10(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0, 5,7,8,3,14,15,13,22,24,25)
MR_decl_label10(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0, 20,31,32,30,39,40,41,42,43,37)
MR_decl_label3(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0, 47,48,49)
...
MR_decl_label10(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0, 43,44,136,45,40,51,52,53,142,54)
MR_decl_label7(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0, 57,49,64,65,66,67,294)
...
MR_BEGIN_MODULE(check_hlds__abstract_mode_constraints_module26)
	...
	MR_init_label10(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0,5,7,8,3,14,15,13,22,24,25)
	MR_init_label10(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0,20,31,32,30,39,40,41,42,43,37)
	MR_init_label3(check_hlds__abstract_mode_constraints__dump_var_constraint_7_0,47,48,49)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__abstract_mode_constraints_module50)
	...
	MR_init_label10(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0,43,44,136,45,40,51,52,53,142,54)
	MR_init_label7(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0,57,49,64,65,66,67,294)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0_i294);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(4);
...
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0,67)
	...
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__var_constraint_1_0,294)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
