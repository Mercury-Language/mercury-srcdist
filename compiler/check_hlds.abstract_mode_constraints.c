    ...
    case (MR_Integer) 1:
      {
        ...
        Var_34 = mercury__string__f_43_43_2_f_0((MR_String) "\t", (MR_String) "");
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, Var_34, Constraints_17);
        mercury__io__write_string_3_p_0((MR_String) "");
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "\t", (MR_String) "");
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, Var_25, Constraints_40);
        mercury__io__write_string_3_p_0((MR_String) "");
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) "disj(\n");
            Var_42 = mercury__string__f_43_43_2_f_0((MR_String) "\t", HeadVar__2_2);
            check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(HeadVar__1_1, Var_42, Constraints_25);
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) ") end disj\n");
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) "conj(\n");
            Var_33 = mercury__string__f_43_43_2_f_0((MR_String) "\t", HeadVar__2_2);
            check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(HeadVar__1_1, Var_33, Constraints_48);
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) ") end conj\n");
          }
          break;
  ...
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (!((Vars_11 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Word Var_33;
        MR_Word Vars_34;
        MR_String VarName_48;

        mercury__io__write_string_3_p_0((MR_String) ", ");
        Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Vars_11, (MR_Integer) 0))));
        Vars_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Vars_11, (MR_Integer) 1))));
        mercury__varset__lookup_name_3_p_0((MR_Word) (&check_hlds__abstract_mode_constraints__check_hlds__abstract_mode_constraints__type_ctor_info_mc_type_0), HeadVar__1_1, Var_33, &VarName_48);
        mercury__io__write_string_3_p_0(VarName_48);
        if (!((Vars_34 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__2_2 = Vars_34;
