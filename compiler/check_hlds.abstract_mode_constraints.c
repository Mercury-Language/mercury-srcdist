    ...
    case (MR_Integer) 1:
      {
        ...
        Var_24 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_51, 5) = ((MR_Box) (Var_24));
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_37 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_48, 5) = ((MR_Box) (Var_37));
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (X_14));
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (X_81));
        ...
        check_hlds__abstract_mode_constraints__mc_var_list_to_string_3_p_0(VarSet_9, Var_45, &XName_22);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (Y_21));
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (X_83));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_25, 0) = ((MR_Box) (Var_58));
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_90, 0) = ((MR_Box) (Var_66));
        ...
        case (MR_Integer) 2:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_94, 0) = ((MR_Box) (Var_73));
