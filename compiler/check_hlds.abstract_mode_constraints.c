    ...
    case (MR_Integer) 1:
      {
        ...
        Var_24 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_71, 5) = ((MR_Box) (Var_24));
          MR_hl_field(MR_mktag(0), Var_71, 6) = ((MR_Box) (Annotation_11));
        }
        mercury__list__foldl_4_p_2((MR_Word) (&check_hlds__abstract_mode_constraints__check_hlds__abstract_mode_constraints__type_ctor_info_mc_constraint_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_71, Constraints_14, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_25_25);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_23 = mercury__string__f_43_43_2_f_0((MR_String) "\t", (MR_String) "");
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, Var_23, Constraints_18);
        mercury__io__write_string_3_p_0((MR_String) "");
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_32 = mercury__string__f_43_43_2_f_0((MR_String) "\t", (MR_String) "");
        check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(VarSet_5, Var_32, Constraints_41);
        mercury__io__write_string_3_p_0((MR_String) "");
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) "disj(\n");
            Var_31 = mercury__string__f_43_43_2_f_0((MR_String) "\t", HeadVar__2_2);
            check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(HeadVar__1_1, Var_31, Constraints_26);
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) ") end disj\n");
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) "conj(\n");
            Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "\t", HeadVar__2_2);
            check_hlds__abstract_mode_constraints__pretty_print_constraints_indent_5_p_0(HeadVar__1_1, Var_40, Constraints_49);
            mercury__io__write_string_3_p_0(HeadVar__2_2);
            mercury__io__write_string_3_p_0((MR_String) ") end conj\n");
          }
          break;
