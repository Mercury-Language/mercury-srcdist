...
MR_decl_label7(check_hlds__abstract_mode_constraints__pretty_print_bindings_6_0, 2,3,4,5,6,8,9)
...
MR_decl_label5(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0, 3,2,5,9,38)
...
{
{
MR_CTOR1_ADDR(check_hlds__abstract_mode_constraints, var_constraint),
MR_CTOR0_ADDR(check_hlds__abstract_mode_constraints, mc_type)
}
},
{
...
MR_def_label(check_hlds__abstract_mode_constraints__dump_constraint_7_0,39)
	...
	MR_sv(6) = MR_tempr1;
	MR_r2 = MR_tempr1;
	MR_r4 = (MR_Word) MR_TAG_COMMON(1,0,8);
	}
...
MR_def_label(check_hlds__abstract_mode_constraints__dump_constraint_7_0,10)
	...
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(3);
	MR_r4 = (MR_Word) MR_TAG_COMMON(1,0,9);
...
MR_def_label(check_hlds__abstract_mode_constraints__dump_constraint_7_0,5)
	...
	MR_sv(6) = MR_tempr1;
	MR_r2 = MR_tempr1;
	MR_r4 = (MR_Word) MR_TAG_COMMON(1,0,10);
	}
	MR_np_call_localret_ent(parse_tree__error_util__write_error_pieces_6_0,
...
MR_BEGIN_MODULE(check_hlds__abstract_mode_constraints_module29)
	...
	MR_init_label7(check_hlds__abstract_mode_constraints__pretty_print_bindings_6_0,2,3,4,5,6,8,9)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__abstract_mode_constraints_module46)
	...
	MR_init_label5(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,4);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___check_hlds__abstract_mode_constraints__pred_p_c_constraints_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__check_hlds__abstract_mode_constraints__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__check_hlds__abstract_mode_constraints);
