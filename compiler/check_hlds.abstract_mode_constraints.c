    ...
    case (MR_Integer) 0:
      {
        ...
        MR_String Var_76;
        MR_String Var_77;
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Constraint_12, (MR_Integer) 1)));
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Constraint_6, (MR_Integer) 1)));
