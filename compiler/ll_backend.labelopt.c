  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Instrs0_17;
          MR_Word next_value_of_STATE_VARIABLE_RevInstrs_0_2 = STATE_VARIABLE_RevInstrs_34_34;
          MR_Word next_value_of_STATE_VARIABLE_Mod_0_4 = STATE_VARIABLE_Mod_38_38;
          MR_Word next_value_of_HeadVar__6_6 = STATE_VARIABLE_Fallthrough_35_35;
  ...
  MR_Word * STATE_VARIABLE_Useset_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Instructions_8;
        MR_Word next_value_of_STATE_VARIABLE_Useset_0_2 = STATE_VARIABLE_Useset_15_15;
