...
{
  {
    ...
    ll_backend__labelopt__opt_labels_in_instr_list_2_7_p_0(Instrs0_8, (MR_Word) ((MR_Unsigned) 0U), &RevInstrs_19, (MR_Integer) 0, Mod_10, (MR_Integer) 1, Useset_11);
  ...
  MR_Word HeadVar__7_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Uinstr0_22)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 0))) == (MR_Integer) 5)));
      if (succeeded)
      {
        Label_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 1))));
        {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Label_24, (MR_Integer) 0)));
