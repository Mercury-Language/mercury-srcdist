        ...
        if ((ll_backend__labelopt__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            /* direct tailcall eliminated */
            {
              ...
              MR_Word ll_backend__labelopt__STATE_VARIABLE_RevInstrs_0__tmp_copy_2 = ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34;
              MR_Word ll_backend__labelopt__STATE_VARIABLE_Mod_0__tmp_copy_4 = ll_backend__labelopt__STATE_VARIABLE_Mod_38_38;
              MR_Word ll_backend__labelopt__HeadVar__6__tmp_copy_6 = ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35;
