...
#line 28 "ll_backend.labelopt.c"
#line 150 "../library/io.int2"
#include "time.mh"

#line 32 "ll_backend.labelopt.c"
#line 151 "../library/io.int2"
#include "string.mh"

#line 36 "ll_backend.labelopt.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 40 "ll_backend.labelopt.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 44 "ll_backend.labelopt.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 48 "ll_backend.labelopt.c"
#line 49 "ll_backend.labelopt.c"
#include "ll_backend.labelopt.mh"

#line 52 "ll_backend.labelopt.c"
#line 53 "ll_backend.labelopt.c"
#ifndef LL_BACKEND__LABELOPT_DECL_GUARD
#define LL_BACKEND__LABELOPT_DECL_GUARD

#line 57 "ll_backend.labelopt.c"
#line 58 "ll_backend.labelopt.c"

#endif
#line 61 "ll_backend.labelopt.c"
...
MR_decl_label10(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0, 59,3,12,9,14,8,6,4,19,21)
MR_decl_label1(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0, 23)
...
MR_decl_entry(ll_backend__opt_util__instr_labels_only_2_0);
...
MR_BEGIN_MODULE(ll_backend__labelopt_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__labelopt__build_useset_3_0);
...
MR_def_label(ll_backend__labelopt__build_useset_3_0,3)
	...
	MR_np_call_localret_ent(ll_backend__opt_util__instr_labels_only_2_0,
...
MR_BEGIN_MODULE(ll_backend__labelopt_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__labelopt__opt_labels_in_instr_list_2_7_0);
	MR_init_label10(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,59,3,12,9,14,8,6,4,19,21)
	MR_init_label1(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,23)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__labelopt_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__labelopt__labelopt_main_5_0);
...
void mercury__ll_backend__labelopt__init_threadscope_string_table(void);
#endif
...
void mercury__ll_backend__labelopt__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__labelopt);
