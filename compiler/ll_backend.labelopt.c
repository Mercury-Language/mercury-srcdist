  ...
  MR_Word HeadVar__7_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Uinstr0_22)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Uinstr0_22, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
        Label_24 = ((MR_Word) ((MR_hl_field(3, Uinstr0_22, (MR_Integer) 1))));
        {
          ...
          if (succeeded)
          {
            EntryType_25 = ((MR_Unsigned) ((MR_hl_field(1, Label_24, (MR_Integer) 0))) & (MR_Integer) 3);
            switch (EntryType_25) {
              default:
                succeeded = MR_FALSE;
                break;
        ...
        {
          {
            STATE_VARIABLE_RevInstrs_34_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, STATE_VARIABLE_RevInstrs_34_34, 0) = ((MR_Box) (Instr0_16));
            MR_hl_field(1, STATE_VARIABLE_RevInstrs_34_34, 1) = ((MR_Box) (STATE_VARIABLE_RevInstrs_0_2));
          }
  ...
  MR_Word * STATE_VARIABLE_Useset_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Instructions_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
