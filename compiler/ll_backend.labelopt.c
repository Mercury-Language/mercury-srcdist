      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((ll_backend__labelopt__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34;
            MR_Word ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35;
            MR_Word ll_backend__labelopt__STATE_VARIABLE_Mod_38_38;
            ...
            if (ll_backend__labelopt__succeeded)
              {
                ll_backend__labelopt__Label_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__labelopt__Uinstr0_22, (MR_Integer) 1)));
                {
                  ...
                  MR_Word ll_backend__labelopt__Var_26;
                  ...
                  if (ll_backend__labelopt__succeeded)
                    {
                      ...
                      ll_backend__labelopt__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__labelopt__Label_24, (MR_Integer) 1)));
                ...
                if (ll_backend__labelopt__succeeded)
                  {
                    {
                      ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34, 0) = ((MR_Box) (ll_backend__labelopt__Instr0_16));
                      MR_hl_field(MR_mktag(1), ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34, 1) = ((MR_Box) (ll_backend__labelopt__STATE_VARIABLE_RevInstrs_0_2));
                    }
                    ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35 = (MR_Integer) 1;
                    ll_backend__labelopt__STATE_VARIABLE_Mod_38_38 = ll_backend__labelopt__STATE_VARIABLE_Mod_0_4;
                  }
                else
                  {
                    ll_backend__labelopt__STATE_VARIABLE_Mod_38_38 = (MR_Integer) 1;
                    ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34 = ll_backend__labelopt__STATE_VARIABLE_RevInstrs_0_2;
                    ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35 = ll_backend__labelopt__HeadVar__6_6;
                  }
              }
            else
              {
                MR_Word ll_backend__labelopt__Canfallthrough_28;
                ...
                {
                  ll_backend__labelopt__Canfallthrough_28 = ll_backend__opt_util__can_instr_fall_through_1_f_0(ll_backend__labelopt__Uinstr0_22);
                }
                switch (ll_backend__labelopt__Canfallthrough_28) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35 = (MR_Integer) 0;
                    break;
                  case (MR_Integer) 1:
                    ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35 = ll_backend__labelopt__HeadVar__6_6;
                    break;
            ...
            {
              MR_Word ll_backend__labelopt__next_value_of_HeadVar__1_1 = ll_backend__labelopt__Instrs0_17;
              MR_Word ll_backend__labelopt__next_value_of_STATE_VARIABLE_RevInstrs_0_2 = ll_backend__labelopt__STATE_VARIABLE_RevInstrs_34_34;
              MR_Word ll_backend__labelopt__next_value_of_STATE_VARIABLE_Mod_0_4 = ll_backend__labelopt__STATE_VARIABLE_Mod_38_38;
              MR_Word ll_backend__labelopt__next_value_of_HeadVar__6_6 = ll_backend__labelopt__STATE_VARIABLE_Fallthrough_35_35;

              ll_backend__labelopt__HeadVar__6_6 = ll_backend__labelopt__next_value_of_HeadVar__6_6;
              ll_backend__labelopt__STATE_VARIABLE_Mod_0_4 = ll_backend__labelopt__next_value_of_STATE_VARIABLE_Mod_0_4;
              ll_backend__labelopt__STATE_VARIABLE_RevInstrs_0_2 = ll_backend__labelopt__next_value_of_STATE_VARIABLE_RevInstrs_0_2;
              ll_backend__labelopt__HeadVar__1_1 = ll_backend__labelopt__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
        ...
        if ((ll_backend__labelopt__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *ll_backend__labelopt__STATE_VARIABLE_Useset_3 = ll_backend__labelopt__STATE_VARIABLE_Useset_0_2;
        else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word ll_backend__labelopt__next_value_of_HeadVar__1_1 = ll_backend__labelopt__Instructions_8;
              MR_Word ll_backend__labelopt__next_value_of_STATE_VARIABLE_Useset_0_2 = ll_backend__labelopt__STATE_VARIABLE_Useset_15_15;

              ll_backend__labelopt__STATE_VARIABLE_Useset_0_2 = ll_backend__labelopt__next_value_of_STATE_VARIABLE_Useset_0_2;
              ll_backend__labelopt__HeadVar__1_1 = ll_backend__labelopt__next_value_of_HeadVar__1_1;
            }
            continue;
          }
...
{
  {
    ...
    if (ll_backend__labelopt__succeeded)
      {
        MR_Word ll_backend__labelopt__Var_13;

        {
          ll_backend__labelopt__labelopt_main_5_p_0(ll_backend__labelopt__Final_6, ll_backend__labelopt__LayoutLabelSet_7, ll_backend__labelopt__Instrs1_12, ll_backend__labelopt__Instrs_9, &ll_backend__labelopt__Var_13);
        }
      }
    else
