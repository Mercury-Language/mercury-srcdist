...
MR_decl_label4(ll_backend__labelopt__build_useset_3_0, 12,4,5,3)
MR_decl_label4(ll_backend__labelopt__labelopt_main_5_0, 2,3,4,5)
MR_decl_label8(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0, 57,12,9,14,8,6,4,18)
MR_decl_label3(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0, 19,21,3)
...
MR_BEGIN_MODULE(ll_backend__labelopt_module0)
	...
	MR_init_label4(ll_backend__labelopt__build_useset_3_0,12,4,5,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__labelopt__build_useset_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__labelopt__build_useset_3_0,5)
	...
	MR_GOTO_LAB(ll_backend__labelopt__build_useset_3_0_i12);
...
MR_BEGIN_MODULE(ll_backend__labelopt_module1)
	...
	MR_init_label8(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,57,12,9,14,8,6,4,18)
	MR_init_label3(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,19,21,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,8)
	...
	MR_GOTO_LAB(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0_i57);
	}
...
MR_def_label(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,4)
	...
	if (MR_INT_NE(MR_r4,0)) {
		MR_GOTO_LAB(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0_i18);
	}
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
	MR_sv(6) = MR_r7;
	...
	MR_np_call_localret_ent(fn__ll_backend__opt_util__can_instr_fall_through_1_0,
		ll_backend__labelopt__opt_labels_in_instr_list_2_7_0_i19);
MR_def_label(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0,19)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__labelopt__opt_labels_in_instr_list_2_7_0_i21);
	}
	MR_r5 = MR_sv(4);
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
...
void mercury__ll_backend__labelopt__write_out_proc_statics(FILE *fp);
#endif
