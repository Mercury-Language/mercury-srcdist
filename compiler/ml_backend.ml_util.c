      ...
      case (MR_Integer) 2:
        {
          ...
          ContainsVar_6 = ml_backend__ml_util__lval_contains_var_2_f_0(Lval_7, SearchVarName_5);
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word next_value_of_Rval_4 = SubRval_9;
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word next_value_of_Rval_4 = RvalA_40;
          ...
          case (MR_Integer) 3:
            {
              ...
              switch (RvalAContainsVar_42) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word next_value_of_Rval_4 = RvalB_41;
          ...
          case (MR_Integer) 4:
            {
              ...
              ContainsVar_6 = ml_backend__ml_util__lval_contains_var_2_f_0(Lval_50, SearchVarName_5);
            }
            break;
          case (MR_Integer) 5:
            {
              ...
              MR_Word next_value_of_Rval_4 = IndexRval_44;
      ...
      case (MR_Integer) 0:
        {
          ...
          ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_8, SearchVarName_5);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_17, SearchVarName_5);
        }
        break;
      case (MR_Integer) 2:
        ContainsVar_6 = (MR_Integer) 0;
