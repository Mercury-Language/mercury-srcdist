...
MR_def_label(fn__ml_backend__ml_util__target_code_components_contains_var_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tfield(3, MR_r3, 0),2)) {
...
MR_define_entry(mercury__ml_backend__ml_util__has_foreign_languages_2_0);
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__594__1_2_0);
...
MR_define_entry(mercury__fn__ml_backend__ml_util__gen_init_boxed_int_1_0);
	...
	MR_tfield(3, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(0,3,4);
