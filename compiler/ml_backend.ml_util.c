  ...
  void * env_ptr_arg)
{
...

  {
    ...
    if ((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0_env_0__succeeded)
    {
      ...
      if ((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(3, (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0_env_0__Var_13, 1)));
        *((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0_env_0__LambdaHeadVar__1_12) = ((MR_Unsigned) ((MR_hl_field(3, (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0_env_0__Var_13, 1))) & (MR_Integer) 3);
  ...
  MR_Word MaybeAux_3)
{
  ...
  switch (MR_tag((MR_Word) MaybeAux_3)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_2[2]), (MR_Integer) 1, (MR_Unsigned) 10000U, &Var_32);
            Suffix_4 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_32);
          }
          break;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Unsigned SeqNum_5 = ((MR_Unsigned) ((MR_hl_field(1, MaybeAux_3, 0))));
        MR_String Var_23;

        mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_2[2]), (MR_Integer) 1, SeqNum_5, &Var_23);
        Suffix_4 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_23);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Unsigned Var_18;
        MR_Unsigned SeqNum_21 = ((MR_Unsigned) ((MR_hl_field(2, MaybeAux_3, 0))));
        MR_String Var_41;

        Var_18 = ((MR_Unsigned) 10001U + SeqNum_21);
        mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_2[2]), (MR_Integer) 1, Var_18, &Var_41);
        Suffix_4 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_41);
      }
      break;
  }
  return Suffix_4;
...
ml_backend__ml_util__project_mlds_argument_name_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_Word LocalVarName_3 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  ...
  MR_Word Stmt_3)
{
  ...
  switch (MR_tag((MR_Word) Stmt_3)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      Context_4 = ((MR_Word) ((MR_hl_field(0, Stmt_3, 3))));
      break;
    case (MR_Integer) 1:
      Context_4 = ((MR_Word) ((MR_hl_field(1, Stmt_3, 4))));
      break;
    case (MR_Integer) 2:
      Context_4 = ((MR_Word) ((MR_hl_field(2, Stmt_3, 3))));
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Stmt_3, 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 6))));
          break;
        case (MR_Integer) 1:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 2))));
          break;
        case (MR_Integer) 2:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 2))));
          break;
        case (MR_Integer) 3:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 3))));
          break;
        case (MR_Integer) 4:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 6))));
          break;
        case (MR_Integer) 5:
          ...
          break;
        case (MR_Integer) 6:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 4))));
          break;
        case (MR_Integer) 7:
          Context_4 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 2))));
          break;
  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Box X_7 = (MR_hl_field(1, HeadVar__3_3, 0));
    MR_Box MR_CALL (* func_0)(MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, HeadVar__2_2, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  {
    MR_Word Rval_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
  ...
  MR_Word SearchVarName_5)
{
  ...
  MR_Word Body_12 = ((MR_Word) ((MR_hl_field(0, FuncDefn_4, 5))));

  if ((Body_12 == (MR_Word) ((MR_Unsigned) 0U)))
    ContainsVar_6 = (MR_Integer) 0;
  else
  {
    MR_Word Stmt_15 = ((MR_Word) ((MR_hl_field(1, Body_12, 0))));
...
{
  MR_Word ContainsVar_6;
  MR_Word Initializer_10 = ((MR_Word) ((MR_hl_field(0, LocalVarDefn_4, 3))));
  ...
  void * cont_env_ptr)
{
  ...
  (env).ml_backend__ml_util__has_foreign_languages_2_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__625__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), &(env).ml_backend__ml_util__has_foreign_languages_2_p_0_2_env_0__conv0_LambdaHeadVar__1_12, ml_backend__ml_util__has_foreign_languages_2_p_0_1, &env);
  }
}
  ...
  MR_Word SearchVarName_5)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Stmt_4)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word LocalVarDefns_7 = ((MR_Word) ((MR_hl_field(0, Stmt_4, 0))));
          MR_Word FuncDefns_8 = ((MR_Word) ((MR_hl_field(0, Stmt_4, 1))));
          MR_Word SubStmts_9 = ((MR_Word) ((MR_hl_field(0, Stmt_4, 2))));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Rval_14 = ((MR_Word) ((MR_hl_field(1, Stmt_4, 1))));
          MR_Word BodyStmt_15 = ((MR_Word) ((MR_hl_field(1, Stmt_4, 2))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Cond_18 = ((MR_Word) ((MR_hl_field(2, Stmt_4, 0))));
          MR_Word ThenStmt_19 = ((MR_Word) ((MR_hl_field(2, Stmt_4, 1))));
          MR_Word MaybeElseStmt_20 = ((MR_Word) ((MR_hl_field(2, Stmt_4, 2))));
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (ThenContainsVar_22) {
                  ...
                  case (MR_Integer) 0:
                    ...
                    {
                      MR_Word Stmt_104 = ((MR_Word) ((MR_hl_field(1, MaybeElseStmt_20, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Stmt_4, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Val_24 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 2))));
              MR_Word Cases_26 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 4))));
              MR_Word Default_27 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 5))));
                    ...
                    switch (CasesContainsVar_29) {
                      ...
                      case (MR_Integer) 0:
                        switch (MR_tag((MR_Word) Default_27)) {
                          ...
                          case (MR_Integer) 1:
                            {
                              MR_Word Stmt_107 = ((MR_Word) ((MR_hl_field(1, Default_27, 0))));
          ...
          case (MR_Integer) 3:
            {
              MR_Word Rval_58 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 1))));
          ...
          case (MR_Integer) 4:
            {
              MR_Word Func_34 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 2))));
              MR_Word Args_35 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 3))));
              MR_Word RetLvals_36 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 4))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word Rvals_40 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 1))));
          ...
          case (MR_Integer) 6:
            {
              MR_Word HandlerStmt_42 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 3))));
              MR_Word RefContainsVar_43;
              MR_Word BodyStmt_67 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 2))));
              MR_Word Ref_68 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 1))));
          ...
          case (MR_Integer) 7:
            {
              MR_Word Ref_41 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 1))));
          ...
          case (MR_Integer) 8:
            {
              MR_Word AtomicStmt_45 = ((MR_Word) ((MR_hl_field(3, Stmt_4, 1))));
              ...
              switch (MR_tag((MR_Word) AtomicStmt_45)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Lval_71 = ((MR_Word) ((MR_hl_field(2, AtomicStmt_45, 0))));
                    MR_Word Rval_72 = ((MR_Word) ((MR_hl_field(2, AtomicStmt_45, 1))));
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, AtomicStmt_45, 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        MR_Word Lval_95 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                        MR_Word Rval_96 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 2))));
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Word Rval_91 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                    ...
                    case (MR_Integer) 2:
                      {
                        MR_Word Target_74 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                        MR_Word ArgRvalsTypes_80 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 7))));
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_Word Lval_92 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                    ...
                    case (MR_Integer) 4:
                      {
                        MR_Word Rval_93 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                    ...
                    case (MR_Integer) 5:
                      {
                        MR_Word TrailOp_84 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 1))));
                        ...
                        switch (MR_tag((MR_Word) TrailOp_84)) {
                          ...
                          case (MR_Integer) 1:
                            {
                              MR_Word Lval_98 = ((MR_Word) ((MR_hl_field(1, TrailOp_84, 0))));
                          ...
                          case (MR_Integer) 2:
                            {
                              MR_Word Rval_99 = ((MR_Word) ((MR_hl_field(2, TrailOp_84, 0))));

                              ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_99, SearchVarName_5);
                            }
                            break;
                          case (MR_Integer) 3:
                            switch (((MR_Integer) ((MR_hl_field(3, TrailOp_84, 0))))) {
                              default: /*NOTREACHED*/ MR_assert(0);
                              case (MR_Integer) 0:
                                {
                                  MR_Word Lval_101 = ((MR_Word) ((MR_hl_field(3, TrailOp_84, 1))));
                              ...
                              case (MR_Integer) 1:
                                {
                                  MR_Word Rval_102 = ((MR_Word) ((MR_hl_field(3, TrailOp_84, 1))));
                    ...
                    case (MR_Integer) 6:
                      {
                        MR_Word Components_86 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 2))));
                    ...
                    case (MR_Integer) 7:
                      {
                        MR_Word OutlineArgs_87 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 2))));
                        MR_Word ReturnLvals_88 = ((MR_Word) ((MR_hl_field(3, AtomicStmt_45, 3))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Case_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Cases_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word Stmt_11 = ((MR_Word) ((MR_hl_field(0, Case_5, 2))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Stmt_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Stmts_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word FuncDefn_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word FuncDefns_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word Body_15 = ((MR_Word) ((MR_hl_field(0, FuncDefn_5, 5))));
      ...
      else
      {
        ...
        MR_Word Stmt_18 = ((MR_Word) ((MR_hl_field(1, Body_15, 0))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypedRval_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word TypedRvals_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word Rval_9 = ((MR_Word) ((MR_hl_field(0, TypedRval_5, 0))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word OutlineArg_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word OutlineArgs_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      ...
      switch (MR_tag((MR_Word) OutlineArg_5)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Rval_12 = ((MR_Word) ((MR_hl_field(1, OutlineArg_5, 2))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word Lval_13 = ((MR_Word) ((MR_hl_field(2, OutlineArg_5, 2))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TargetCode_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word TargetCodes_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      ...
      switch (MR_tag((MR_Word) TargetCode_5)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, TargetCode_5, 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word Rval_16 = ((MR_Word) ((MR_hl_field(3, TargetCode_5, 1))));
            ...
            case (MR_Integer) 1:
              {
                MR_Word Lval_17 = ((MR_Word) ((MR_hl_field(3, TargetCode_5, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Lvals_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Rval_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Rvals_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word LocalVarDefn_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word LocalVarDefns_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word LocalVarDefnContainsVar_9;
      MR_Word Initializer_13 = ((MR_Word) ((MR_hl_field(0, LocalVarDefn_5, 3))));
  ...
  MR_Word SearchVarName_5)
{
  ...
  switch (MR_tag((MR_Word) Initializer_4)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Rval_7 = ((MR_Word) ((MR_hl_field(1, Initializer_4, 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word FieldInitializers_9 = ((MR_Word) ((MR_hl_field(2, Initializer_4, 1))));
    ...
    case (MR_Integer) 3:
      {
        MR_Word ElementInitializers_10 = ((MR_Word) ((MR_hl_field(3, Initializer_4, 0))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Initializer_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Initializers_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
...
top_of_proc_1:;
  {
    ...
    switch (MR_tag((MR_Word) Rval_4)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Lval_7 = ((MR_Word) ((MR_hl_field(2, Rval_4, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Rval_4, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word SubRval_9 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 1:
            {
              MR_Word Const_10 = ((MR_Word) ((MR_hl_field(3, Rval_4, 1))));
              ...
              switch (MR_tag((MR_Word) Const_10)) {
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, Const_10, 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                    case (MR_Integer) 1:
                    case (MR_Integer) 2:
                    ...
                    case (MR_Integer) 16:
                      {
                        MR_Word RawVarName_11 = ((MR_Word) ((MR_hl_field(3, Const_10, 1))));
          ...
          case (MR_Integer) 2:
            {
              MR_Word RvalA_42 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 3:
            {
              MR_Word RvalA_59 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 4:
            {
              MR_Word RvalA_58 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word RvalA_60 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
              MR_Word next_value_of_tscc_proc_1_input_1_Rval_4 = RvalA_60;
              MR_Word next_value_of_tscc_proc_1_input_2_SearchVarName_5 = SearchVarName_5;
          ...
          case (MR_Integer) 6:
            {
              MR_Word RvalB_44 = ((MR_Word) ((MR_hl_field(3, Rval_4, 3))));
              MR_Word RvalAContainsVar_45;
              MR_Word RvalA_53 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 7:
            {
              MR_Word Lval_55 = ((MR_Word) ((MR_hl_field(3, Rval_4, 1))));
          ...
          case (MR_Integer) 8:
            {
              MR_Word IndexRval_47 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
...
top_of_proc_2:;
  {
    ...
    switch (MR_tag((MR_Word) Lval_4)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Rval_8 = ((MR_Word) ((MR_hl_field(0, Lval_4, 1))));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Rval_19 = ((MR_Word) ((MR_hl_field(1, Lval_4, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Lval_4, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word VarName_16 = ((MR_Word) ((MR_hl_field(3, Lval_4, 1))));
  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Word _FirstCond_61;
    MR_Word _LaterConds_62;

    (env_ptr)->ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__Stmt_63 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__Case_60, 2))));
  ...
  void * cont_env_ptr)
{
  ...
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Stmt_3)) {
      case (MR_Integer) 0:
        {
          MR_Word Stmts_7 = ((MR_Word) ((MR_hl_field(0, Stmt_3, 2))));
          MR_Word _LocalVarDefns_5;
          MR_Word _FuncDefns_6;
          MR_Word _Context_8;
      ...
      case (MR_Integer) 1:
        {
          MR_Word BodyStmt_11 = ((MR_Word) ((MR_hl_field(1, Stmt_3, 2))));
          MR_Word _Kind_9;
          MR_Word _Rval_10;
          MR_Word _LoopLocalVars_12;
          MR_Word _Context_33;
      ...
      case (MR_Integer) 2:
        {
          MR_Word ThenStmt_14 = ((MR_Word) ((MR_hl_field(2, Stmt_3, 1))));
          MR_Word MaybeElseStmt_15 = ((MR_Word) ((MR_hl_field(2, Stmt_3, 2))));
          MR_Word _Cond_13;
          MR_Word _Context_35;
          ...
          *((env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__SubStmt_4) = ThenStmt_14;
          ...
          ml_backend__ml_util__stmt_contains_statement_2_p_0(ThenStmt_14, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__SubStmt_4, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__cont, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__cont_env_ptr);
          {
            ...
            if (succeeded)
            {
              Stmt_57 = ((MR_Word) ((MR_hl_field(1, MaybeElseStmt_15, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Stmt_3, 0))))) {
          case (MR_Integer) 0:
            {
              MR_Word Cases_19 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 4))));
              MR_Word Default_20 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 5))));
              MR_Word _Type_16;
              MR_Word _Val_17;
              MR_Word _Range_18;
              MR_Word _Context_37;
              ...
              mercury__list__member_2_p_1((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0), &(env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__conv1_Case_60, Cases_19, ml_backend__ml_util__stmt_contains_statement_2_p_0_4, &env);
              {
                ...
                if (succeeded)
                {
                  Stmt_67 = ((MR_Word) ((MR_hl_field(1, Default_20, 0))));
          ...
          case (MR_Integer) 6:
            {
              MR_Word HandlerStmt_22 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 3))));
              MR_Word BodyStmt_41 = ((MR_Word) ((MR_hl_field(3, Stmt_3, 2))));
              MR_Word _Ref_21;
              MR_Word _Context_39;
...
{
  MR_bool succeeded;
  MR_Word QualFuncLabel_7 = ((MR_Word) ((MR_hl_field(0, CodeAddr_4, 0))));
  MR_Word FuncModuleName_9 = ((MR_Word) ((MR_hl_field(0, QualFuncLabel_7, 0))));
  MR_Word FuncLabel_10 = ((MR_Word) ((MR_hl_field(0, QualFuncLabel_7, 1))));
  MR_Word Var_12;
  MR_Word Var_13;
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      FuncDefn_2 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      FuncDefns_3 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      FuncName_4 = ((MR_Word) ((MR_hl_field(0, FuncDefn_2, 0))));
      succeeded = ((MR_tag((MR_Word) FuncName_4)) == (MR_Integer) 0);
      if (succeeded)
      {
        PlainFuncName_12 = (MR_Word) ((MR_Word) (FuncName_4));
        FuncLabel_13 = ((MR_Word) ((MR_hl_field(0, PlainFuncName_12, 0))));
        ProcLabel_15 = ((MR_Word) ((MR_hl_field(0, FuncLabel_13, 0))));
        PredLabel_17 = ((MR_Word) ((MR_hl_field(0, ProcLabel_15, 0))));
        succeeded = ((MR_tag((MR_Word) PredLabel_17)) == (MR_Integer) 0);
        if (succeeded)
        {
          Var_20 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_17, 0))) & (MR_Integer) 1);
          Var_21 = ((MR_String) ((MR_hl_field(0, PredLabel_17, 2))));
          Var_22 = ((MR_Word) ((MR_hl_field(0, PredLabel_17, 3))));
