...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_7, 3) = ((MR_Box) ((MR_Integer) 8));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_4, 1) = ((MR_Box) ((MR_Integer) 8));
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (ThenContainsVar_22) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    if ((MaybeElseStmt_20 == (MR_Word) ((MR_Integer) 0)))
                      ContainsVar_6 = (MR_Integer) 0;
                    else
                    {
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Body_18 == (MR_Word) ((MR_Integer) 0)))
      {
