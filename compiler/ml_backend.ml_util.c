...
MR_decl_label8(ml_backend__ml_util__defn_body_contains_var_2_0, 50,9,10,7,14,15,13,21)
...
MR_decl_label8(ml_backend__ml_util__initializer_contains_var_2_0, 5,6,50,14,15,13,9,1)
MR_decl_label4(ml_backend__ml_util__lval_contains_var_2_0, 10,6,3,1)
...
MR_decl_label8(ml_backend__ml_util__stmt_contains_statement_2_0, 2,3,27,5,9,7,35,12)
MR_decl_label7(ml_backend__ml_util__stmt_contains_statement_2_0, 15,18,22,20,25,31,1)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 352,79,80,77,84,85,353,153)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 354,114,118,161,3,71,9,359)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 15,27,17,19,21,30,24,29)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 34,358,41,44,45,184,43,48)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 51,62,66,56,235,356,92,96)
MR_decl_label8(ml_backend__ml_util__stmt_contains_var_2_0, 100,107,122,355,129,133,357,141)
MR_decl_label2(ml_backend__ml_util__stmt_contains_var_2_0, 145,1)
...
MR_def_label(ml_backend__ml_util__defns_contain_main_1_0,3)
	...
	if ((strcmp((char *) (MR_Word *) MR_r2, MR_string_const("main", 4)) != 0)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_BEGIN_MODULE(ml_backend__ml_util_module4)
	...
	MR_init_label8(ml_backend__ml_util__stmt_contains_statement_2_0,2,3,27,5,9,7,35,12)
	MR_init_label7(ml_backend__ml_util__stmt_contains_statement_2_0,15,18,22,20,25,31,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ml_backend__ml_util__stmt_contains_statement_2_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i27) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i5) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i35));
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,2)
	...
	MR_np_call_localret_ent(list__member_2_1,
		ml_backend__ml_util__stmt_contains_statement_2_0_i3);
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(ml_backend__ml_util__statement_contains_statement_2_0,
		ml_backend__ml_util__stmt_contains_statement_2_0_i1);
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
	MR_fv(2) = MR_ctfield(2, MR_tempr2, 2);
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i9);
	MR_tempr1 = MR_ctfield(2, MR_tempr2, 1);
	MR_fv(1) = MR_tempr1;
	MR_r1 = MR_tempr1;
	MR_succeed();
	}
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i7);
	MR_r1 = MR_ctfield(0, MR_fv(1), 0);
	MR_np_localcall_lab(ml_backend__ml_util__stmt_contains_statement_2_0,
		ml_backend__ml_util__stmt_contains_statement_2_0_i1);
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
	MR_r1 = MR_fv(2);
	MR_maxfr_word = (MR_Word) MR_prevfr_slot(MR_curfr);
...
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i12) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		...
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i31));
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_fv(1) = MR_ctfield(3, MR_r1, 5);
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i15);
...
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,18)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i22);
	MR_tempr1 = MR_ctfield(3, MR_tempr2, 2);
	MR_fv(2) = MR_tempr1;
	MR_r1 = MR_tempr1;
	MR_succeed();
	}
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i20);
	MR_r1 = MR_ctfield(0, MR_fv(2), 0);
	MR_np_localcall_lab(ml_backend__ml_util__stmt_contains_statement_2_0,
		ml_backend__ml_util__stmt_contains_statement_2_0_i1);
MR_def_label(ml_backend__ml_util__stmt_contains_statement_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_statement_2_0_i25);
	MR_r1 = MR_fv(1);
...
MR_BEGIN_MODULE(ml_backend__ml_util_module9)
	...
	MR_init_label4(ml_backend__ml_util__lval_contains_var_2_0,10,6,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ml_backend__ml_util__lval_contains_var_2_0);
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(ml_backend__ml_util__lval_contains_var_2_0_i3);
	}
...
MR_def_label(ml_backend__ml_util__lval_contains_var_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ml_backend__ml_util_module10)
	...
	MR_init_label8(ml_backend__ml_util__initializer_contains_var_2_0,5,6,50,14,15,13,9,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ml_backend__ml_util__initializer_contains_var_2_0);
	...
	MR_tempr1 = MR_tag(MR_r1);
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(ml_backend__ml_util__initializer_contains_var_2_0_i9);
	}
	...
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__initializer_contains_var_2_0_i13);
	MR_sv(1) = MR_r2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_util__initializer_contains_var_2_0,15)
	...
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(5);
MR_def_label(ml_backend__ml_util__initializer_contains_var_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(2);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(3);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(ml_backend__ml_util_module18)
	...
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,352,79,80,77,84,85,353,153)
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,354,114,118,161,3,71,9,359)
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,15,27,17,19,21,30,24,29)
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,34,358,41,44,45,184,43,48)
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,51,62,66,56,235,356,92,96)
	MR_init_label8(ml_backend__ml_util__stmt_contains_var_2_0,100,107,122,355,129,133,357,141)
	MR_init_label2(ml_backend__ml_util__stmt_contains_var_2_0,145,1)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_util__stmt_contains_var_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i352) MR_AND
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,352)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	...
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i77);
	MR_sv(1) = MR_r2;
	MR_tempr1 = MR_tempr2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ml_backend__mlds, mlds_defn);
	MR_r2 = MR_ctfield(0, MR_tempr1, 0);
	...
	MR_np_call_localret_ent(list__member_2_1,
		ml_backend__ml_util__stmt_contains_var_2_0_i79);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(ml_backend__ml_util__defn_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i80);
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_redoip_slot_word(MR_maxfr) = MR_sv(6);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(7);
	...
	MR_save_maxfr(MR_sv(8));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i43);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ml_backend__mlds, statement);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(list__member_2_1,
		ml_backend__ml_util__stmt_contains_var_2_0_i84);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_r2 = MR_sv(1);
	MR_np_localcall_lab(ml_backend__ml_util__stmt_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i85);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,153)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i235);
	}
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(2);
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,3)
	...
	if ((MR_r4 != MR_mktag((MR_Integer) 3))) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i71);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i1) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i358) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i34) MR_AND
		MR_LABEL_AP(ml_backend__ml_util__stmt_contains_var_2_0_i48) MR_AND
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,15)
	...
	if ((MR_r3 != MR_mktag((MR_Integer) 3))) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i30);
	}
	if (MR_INT_NE(MR_ctfield(3, MR_tempr1, 0),0)) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i17);
	}
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_r2 = MR_sv(1);
	}
	MR_np_call_localret_ent(ml_backend__ml_util__lval_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i27);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i184);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_ctfield(3, MR_r1, 1);
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,19)
	...
	MR_np_call_localret_ent(__Unify___ml_backend__mlds__mlds_data_name_0_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i21);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i184);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i29);
	}
	MR_r1 = MR_ctfield(2, MR_r1, 0);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(ml_backend__ml_util__rval_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i24);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_GOTO(MR_ENTRY(MR_do_redo));
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,358)
	...
	MR_np_call_localret_ent(ml_backend__ml_util__lval_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i41);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i235);
	}
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,44)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(ml_backend__ml_util__rval_contains_var_2_0,
		ml_backend__ml_util__stmt_contains_var_2_0_i45);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,184)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_restore_maxfr(MR_sv(8));
	MR_redoip_slot_word(MR_maxfr) = MR_sv(6);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(7);
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(9);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(6);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(7);
	MR_r1 = MR_FALSE;
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,51)
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 3))) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i66);
	}
...
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,62)
	...
	MR_np_tailcall_ent(ml_backend__ml_util__lval_contains_var_2_0);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r4, 0),0)) {
		MR_GOTO_LAB(ml_backend__ml_util__stmt_contains_var_2_0_i56);
	}
	MR_r1 = MR_ctfield(3, MR_r4, 1);
	MR_np_tailcall_ent(ml_backend__ml_util__lval_contains_var_2_0);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r4, 1);
	MR_np_tailcall_ent(ml_backend__ml_util__rval_contains_var_2_0);
MR_def_label(ml_backend__ml_util__stmt_contains_var_2_0,235)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(9);
...
MR_BEGIN_MODULE(ml_backend__ml_util_module21)
	...
	MR_init_label8(ml_backend__ml_util__defn_body_contains_var_2_0,50,9,10,7,14,15,13,21)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_util__defn_body_contains_var_2_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(ml_backend__ml_util__defn_body_contains_var_2_0_i50);
	}
	MR_r1 = MR_ctfield(0, MR_r1, 1);
	MR_np_tailcall_ent(ml_backend__ml_util__initializer_contains_var_2_0);
	}
MR_def_label(ml_backend__ml_util__defn_body_contains_var_2_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
