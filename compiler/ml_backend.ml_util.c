...
static /* final */ const MR_Box ml_backend__ml_util_scalar_common_2[3][2];
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_3[2]), (MR_Integer) 10000, &Var_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_3[2]), SeqNum_5, &Var_22);
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__ml_util_scalar_common_3[2]), Var_9, &Var_38);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_7, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_util_scalar_common_2[2])));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_4, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_util_scalar_common_2[2])));
