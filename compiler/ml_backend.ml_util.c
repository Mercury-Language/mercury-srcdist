  ...
  switch (MR_tag((MR_Word) AtomicStmt_4)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Lval_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 1))));
            MR_Word Rval_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 2))));
            MR_Word LvalContainsVar_34;

            LvalContainsVar_34 = ml_backend__ml_util__lval_contains_var_2_f_0(Lval_32, SearchVarName_5);
            switch (LvalContainsVar_34) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_33, SearchVarName_5);
                break;
              case (MR_Integer) 1:
                ContainsVar_6 = (MR_Integer) 1;
                break;
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (MR_tag((MR_Word) TrailOp_21)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Lval_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TrailOp_21, (MR_Integer) 0))));

                  ContainsVar_6 = ml_backend__ml_util__lval_contains_var_2_f_0(Lval_38, SearchVarName_5);
                }
                break;
              case (MR_Integer) 2:
                {
                  MR_Word Rval_39 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TrailOp_21, (MR_Integer) 0))));

                  ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_39, SearchVarName_5);
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TrailOp_21, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word Lval_41 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TrailOp_21, (MR_Integer) 1))));

                      ContainsVar_6 = ml_backend__ml_util__lval_contains_var_2_f_0(Lval_41, SearchVarName_5);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      MR_Word Rval_42 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TrailOp_21, (MR_Integer) 1))));

                      ContainsVar_6 = ml_backend__ml_util__rval_contains_var_2_f_0(Rval_42, SearchVarName_5);
                    }
                    break;
                }
                break;
...
top_of_proc_2:;
  {
    ...
    switch (MR_tag((MR_Word) Lval_4)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Rval_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Lval_4, (MR_Integer) 0))));
