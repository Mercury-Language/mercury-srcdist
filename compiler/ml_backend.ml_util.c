...
MR_decl_label10(fn__ml_backend__ml_util__rval_contains_var_2_0, 83,3,5,7,10,9,8,18,20,14)
MR_decl_label3(fn__ml_backend__ml_util__rval_contains_var_2_0, 23,39,25)
...
MR_def_label(ml_backend__ml_util__can_optimize_tailcall_2_0,12)
	...
	MR_tempr1 = MR_sv(5);
	MR_tempr3 = MR_sv(6);
	MR_sv(5) = MR_tfield(2, MR_tempr3, 1);
	MR_tempr2 = MR_tempr3;
...
MR_BEGIN_MODULE(ml_backend__ml_util_module8)
	...
	MR_init_label10(fn__ml_backend__ml_util__rval_contains_var_2_0,83,3,5,7,10,9,8,18,20,14)
	MR_init_label3(fn__ml_backend__ml_util__rval_contains_var_2_0,23,39,25)
MR_BEGIN_CODE
...
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i5);
	}
...
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i7);
	}
	MR_r1 = (MR_Integer) 0;
...
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,7)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i8);
	}
	MR_sv(2) = MR_tfield(3, MR_r1, 3);
	MR_sv(1) = MR_r2;
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_np_localcall_lab(fn__ml_backend__ml_util__rval_contains_var_2_0,
		fn__ml_backend__ml_util__rval_contains_var_2_0_i10);
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i9);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,9)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i83);
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
...
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,18)
	...
	MR_np_call_localret_ent(__Unify___ml_backend__mlds__mlds_data_name_0_0,
		fn__ml_backend__ml_util__rval_contains_var_2_0_i20);
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i39);
	}
...
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,14)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(fn__ml_backend__ml_util__rval_contains_var_2_0_i23);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(fn__ml_backend__ml_util__lval_contains_var_2_0);
MR_def_label(fn__ml_backend__ml_util__rval_contains_var_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_define_entry(mercury__fn__ml_backend__ml_util__gen_init_boxed_int_1_0);
	...
	MR_tfield(3, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(0,4,2);
...
void mercury__ml_backend__ml_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_util);
