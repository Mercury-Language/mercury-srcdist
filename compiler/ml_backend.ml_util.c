...
MR_decl_label2(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0, 2,1)
...
MR_decl_static(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0)
...
MR_define_entry(mercury__ml_backend__ml_util__has_foreign_languages_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0);
...
MR_BEGIN_MODULE(ml_backend__ml_util_module43)
	MR_init_entry1(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0);
	MR_init_label2(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0,2,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred ml_backend.ml_util.IntroducedFrom__pred__has_foreign_languages__476__1/2-0", 1,
		MR_LABEL_AP(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0_i2));
	MR_fv(1) = MR_r1;
	MR_GOTO_LAB(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0_i1);
MR_def_label(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
	MR_r1 = MR_ctfield(0, MR_fv(1), 0);
	MR_np_call_localret_ent(ml_backend__ml_util__stmt_contains_statement_2_0,
		ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0_i1);
MR_def_label(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__476__1_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
