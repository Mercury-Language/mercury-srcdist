...
MR_decl_label2(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0, 2,1)
...
MR_decl_static(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0)
...
MR_define_entry(mercury__ml_backend__ml_util__has_foreign_languages_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0);
...
MR_define_entry(mercury__ml_backend__ml_util__defn_is_type_ctor_info_1_0);
	...
	MR_tempr1 = MR_ctfield(0, MR_r1, 1);
	MR_r1 = ((MR_Integer) MR_tempr1 == (MR_Integer) MR_tbmkword(0, 14));
	MR_proceed();
	}
...
MR_def_label(ml_backend__ml_util__type_ctor_needs_lowlevel_rep_2_0,10)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_COMMON(5,0))[(MR_Integer) MR_r5];
	MR_r6 = MR_tempr1;
	...
	MR_r5 = (MR_COMMON(4,0))[(MR_Integer) MR_r5];
...
MR_define_entry(mercury__fn__ml_backend__ml_util__gen_init_boxed_int_1_0);
	...
	MR_tfield(3, MR_tempr1, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(0,6,4);
...
MR_BEGIN_MODULE(ml_backend__ml_util_module42)
	MR_init_entry1(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0);
	MR_init_label2(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0,2,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred ml_backend.ml_util.IntroducedFrom__pred__has_foreign_languages__486__1/2-0", 1,
		MR_LABEL_AP(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0_i2));
	MR_fv(1) = MR_r1;
	MR_GOTO_LAB(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0_i1);
MR_def_label(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
	MR_r1 = MR_ctfield(0, MR_fv(1), 0);
	MR_np_call_localret_ent(ml_backend__ml_util__stmt_contains_statement_2_0,
		ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0_i1);
MR_def_label(ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__486__1_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
...
void mercury__ml_backend__ml_util__write_out_proc_statics(FILE *fp);
#endif
