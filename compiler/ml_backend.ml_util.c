...
{
  {
...

    {
      ...
      if ((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__succeeded)
      {
        ...
        (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__succeeded = ((((MR_tag((MR_Word) (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__Var_13)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__Var_13, (MR_Integer) 0))) == (MR_Integer) 7)));
        if ((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__Var_13, (MR_Integer) 1)));
          *((env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__LambdaHeadVar__1_12) = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), (env_ptr)->ml_backend__ml_util__IntroducedFrom__pred__has_foreign_languages__621__1_2_p_0_env_0__Var_13, (MR_Integer) 1))) & (MR_Integer) 3);
...
{
  {
    ...
    switch (MR_tag((MR_Word) Stmt_3)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_3, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Stmt_3, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 4:
            {
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt_3, (MR_Integer) 5)));
...
{
  {
    ...
    if ((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_13, 0) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_5, 0) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_7, 0) = ((MR_Box) ((MR_Unsigned) 14U));
      MR_hl_field(MR_mktag(3), Var_7, 1) = (MR_Box) ((MR_Unsigned) (Lang_4));
      MR_hl_field(MR_mktag(3), Var_7, 2) = ((MR_Box) (String_5));
      MR_hl_field(MR_mktag(3), Var_7, 3) = ((MR_Box) ((MR_Unsigned) 8U));
    }
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_7, 0) = ((MR_Box) ((MR_Unsigned) 15U));
      MR_hl_field(MR_mktag(3), Var_7, 1) = ((MR_Box) (TargetPrefixes_4));
      MR_hl_field(MR_mktag(3), Var_7, 2) = ((MR_Box) (Name_5));
    }
    {
      Rval_6 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Rval_6, 0) = ((MR_Box) ((MR_Unsigned) 1U));
...
{
  {
    ...
    {
      Var_5 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_5, 0) = ((MR_Box) ((MR_Unsigned) 12U));
...
{
  {
    ...
    {
      Var_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_4, 0) = ((MR_Box) ((MR_Unsigned) 2U));
      MR_hl_field(MR_mktag(3), Var_4, 1) = ((MR_Box) ((MR_Unsigned) 8U));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_4, (MR_Integer) 0)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt_4, (MR_Integer) 5)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 3)));
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 8)));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TrailOp_21, (MR_Integer) 1)));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 1)));
          ...
          case (MR_Integer) 7:
            {
              ...
              MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt_4, (MR_Integer) 1)));
  ...
  top_of_proc_2:;
    {
      ...
      switch (MR_tag((MR_Word) Lval_4)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Rval_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Lval_4, (MR_Integer) 0))));
            MR_Word next_value_of_tscc_proc_1_input_1_Rval_4 = Rval_19;
            MR_Word next_value_of_tscc_proc_1_input_2_SearchVarName_5 = SearchVarName_5;
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word _Kind_9 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_3, (MR_Integer) 0))) & (MR_Integer) 1);
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_3, (MR_Integer) 0)));
        ...
        case (MR_Integer) 2:
          {
            ...
            *((env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__SubStmt_4) = ThenStmt_14;
            ...
            ml_backend__ml_util__stmt_contains_statement_2_p_0(ThenStmt_14, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__SubStmt_4, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__cont, (env).ml_backend__ml_util__stmt_contains_statement_2_p_0_env_0__cont_env_ptr);
            {
              ...
              succeeded = ((MR_tag((MR_Word) MaybeElseStmt_15)) == (MR_Integer) 1);
              if (succeeded)
              {
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_17, (MR_Integer) 0)));
          Var_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_17, (MR_Integer) 0))) & (MR_Integer) 1);
          ...
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_17, (MR_Integer) 4)));
