...
{
  {
    ...
    if (ml_backend__ml_util__succeeded)
      *ml_backend__ml_util__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word ml_backend__ml_util__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ml_backend__ml_util__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word ml_backend__ml_util__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word ml_backend__ml_util__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word ml_backend__ml_util__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word ml_backend__ml_util__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word ml_backend__ml_util__Var_10;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_util_scalar_common_1[0], &ml_backend__ml_util__Var_10, ((MR_Box) (ml_backend__ml_util__Var_4)), ((MR_Box) (ml_backend__ml_util__Var_7)));
        }
        ...
        if (ml_backend__ml_util__succeeded)
          *ml_backend__ml_util__HeadVar__1_1 = ml_backend__ml_util__Var_10;
        else
          {
            ...
            {
              mercury__counter____Compare____counter_0_0(&ml_backend__ml_util__Var_11, ml_backend__ml_util__Var_5, ml_backend__ml_util__Var_8);
            }
            ...
            if (ml_backend__ml_util__succeeded)
              *ml_backend__ml_util__HeadVar__1_1 = ml_backend__ml_util__Var_11;
              ...
              {
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_util_scalar_common_1[1], ml_backend__ml_util__HeadVar__1_1, ((MR_Box) (ml_backend__ml_util__Var_6)), ((MR_Box) (ml_backend__ml_util__Var_9)));
                }
              }
          }
      }
...
{
  {
    ...
    if (ml_backend__ml_util__succeeded)
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_util__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ml_backend__ml_util__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word ml_backend__ml_util__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word ml_backend__ml_util__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ml_backend__ml_util__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word ml_backend__ml_util__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_util__HeadVar__2_2, (MR_Integer) 2)));

        {
          ml_backend__ml_util__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &ml_backend__ml_util_scalar_common_1[0], ((MR_Box) (ml_backend__ml_util__Var_3)), ((MR_Box) (ml_backend__ml_util__Var_6)));
        }
        if (ml_backend__ml_util__succeeded)
          {
            {
              ml_backend__ml_util__succeeded = mercury__counter____Unify____counter_0_0(ml_backend__ml_util__Var_4, ml_backend__ml_util__Var_7);
            }
            if (ml_backend__ml_util__succeeded)
              {
                ml_backend__ml_util__TypeInfo_13_13 = (MR_Word) &ml_backend__ml_util_scalar_common_1[1];
                {
                  ml_backend__ml_util__succeeded = mercury__builtin__unify_2_p_0(ml_backend__ml_util__TypeInfo_13_13, ((MR_Box) (ml_backend__ml_util__Var_5)), ((MR_Box) (ml_backend__ml_util__Var_8)));
                }
              }
          }
      }
