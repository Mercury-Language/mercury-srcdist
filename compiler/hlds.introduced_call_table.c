      ...
      case (MR_Integer) 13:
        {
          ...
          ;
          {
            ...
            switch (case_num_28) {
              ...
              case (MR_Integer) 40:
                {
                  // case "format_unsigned_int_component_nowidth_noprec"
                  ;
                  succeeded = (OrigArity_8 == (MR_Integer) 4);
                }
                break;
              case (MR_Integer) 41:
                {
                  // case "format_unsigned_int_component_nowidth_prec"
                  ;
                  succeeded = (OrigArity_8 == (MR_Integer) 5);
                }
                break;
              case (MR_Integer) 42:
                {
                  // case "format_unsigned_int_component_width_noprec"
                  ;
                  succeeded = (OrigArity_8 == (MR_Integer) 5);
                }
                break;
              case (MR_Integer) 43:
                {
                  // case "format_unsigned_int_component_width_prec"
                  ;
                  succeeded = (OrigArity_8 == (MR_Integer) 6);
                }
                break;
