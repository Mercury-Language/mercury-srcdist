  ...
  MR_Word Stream_8)
{
  ...
  InstTerm_38 = parse_tree__parse_tree_to_term__inst_to_term_2_f_0(Lang_6, InstB_11);
  ...
  MR_Word Stream_8)
{
  ...
  mercury__io__nl_3_p_0(Stream_8);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "InstB: ");
  InstTerm_48 = parse_tree__parse_tree_to_term__inst_to_term_2_f_0(Lang_6, InstB_13);
  ...
  parse_tree__parse_tree_out_term__mercury_output_term_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_49, (MR_Integer) 0, InstTerm_48, Stream_8);
  mercury__io__nl_3_p_0(Stream_8);
}
