      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__mode_util__recompute_instmap_delta_8_p_0((MR_Integer) 0, Goal2_31, &Goal_36, VarTypes2_33, InstVarSet0_16, InstMap0_35, STATE_VARIABLE_ModuleInfo_48_48, STATE_VARIABLE_ModuleInfo_45);
        }
        break;
      case (MR_Integer) 0:
        {
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Detism_23 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5))) & (MR_Integer) 7);
        ...
        transform_hlds__lambda__expand_lambdas_in_goal_4_p_0(LambdaGoal0_24, &LambdaGoal_25, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_53_53);
        {
          RHS_26 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), RHS_26, 0) = (MR_Box) (packed_word_0);
          MR_hl_field(MR_mktag(2), RHS_26, 1) = NULL;
          MR_hl_field(MR_mktag(2), RHS_26, 2) = ((MR_Box) (NonLocals_20));
          MR_hl_field(MR_mktag(2), RHS_26, 3) = ((MR_Box) (Vars_21));
          MR_hl_field(MR_mktag(2), RHS_26, 4) = ((MR_Box) (Modes_22));
          MR_hl_field(MR_mktag(2), RHS_26, 5) = (MR_Box) ((MR_Unsigned) (Detism_23));
          MR_hl_field(MR_mktag(2), RHS_26, 6) = ((MR_Box) (LambdaGoal_25));
        }
        switch (MR_tag((MR_Word) Unification0_12)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            transform_hlds__lambda__expand_lambda_9_p_0((MR_Word) ((MR_Unsigned) 0U), LHSVar_9, RHS_26, UnifyMode_11, Unification0_12, UnifyContext_13, GoalExpr_14, STATE_VARIABLE_Info_53_53, STATE_VARIABLE_Info_52);
            break;
          case (MR_Integer) 1:
          case (MR_Integer) 2:
            {
...
{
  {
    ...
    MR_Word Vars_34 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_12, (MR_Integer) 3))));
    MR_Word Detism_36 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_12, (MR_Integer) 5))) & (MR_Integer) 7);
    MR_Word LambdaGoal_37 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_12, (MR_Integer) 6))));
    MR_Word Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_14, (MR_Integer) 0))));
    MR_Word ArgVars0_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_14, (MR_Integer) 2))));
    MR_Word ArgUnifyModes0_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_14, (MR_Integer) 3))));
    MR_Word PredId_53;
    ...
    succeeded = transform_hlds__lambda__can_we_use_existing_pred_11_p_0(ModuleInfo0_19, PredOrFunc_31, Vars_34, Detism_36, LambdaGoal_37, &PredId0_47, &ProcId0_48, &CalleePredInfo_49, &CalleeProcInfo0_50, &CurriedArgVars_51, &ArgUnifyModes1_52);
    if (succeeded)
    {
...
{
  {
    ...
    MR_Word Vars_38 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_14, (MR_Integer) 3))));
    MR_Word Modes_39 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_14, (MR_Integer) 4))));
    MR_Word Detism_40 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_14, (MR_Integer) 5))) & (MR_Integer) 7);
    MR_Word LambdaGoal_41 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_14, (MR_Integer) 6))));
    MR_Word LambdaGoalInfo_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaGoal_41, (MR_Integer) 1))));
    MR_Word AllConstraints_44;
    MR_Word LambdaVarTypeList_45;
    MR_Word LambdaTypeVarsList_46;
    MR_Word LambdaTypeVars_47;
    MR_Word UnivConstraints_48;
    MR_Word Constraints_49;
    MR_Word LambdaGoalNonLocals_51;
    MR_Word LambdaNonLocals_52;
    MR_Word ExtraTypeInfos_53;
    MR_Word NonLocals1_54;
    MR_Word NewTypeInfos_55;
    MR_Word NonLocals_56;
    MR_Word ArgVars1_57;
    MR_Word AllArgVars_58;
    MR_Word ModuleName_59;
    MR_String OrigPredName_60;
    MR_Word OrigContext_61;
    MR_String OrigFile_62;
    MR_Integer OrigLine_63;
    MR_Integer LambdaCount_64;
    MR_Word PredName_65;
    ...
    MR_Word LambdaVarSet_82;
    MR_Word LambdaVarTypes_83;
    MR_Word LambdaRttiVarMaps_84;
    MR_Word ProcInfo_85;
    ...
    hlds__hlds_rtti__rtti_varmaps_reusable_constraints_2_p_0(RttiVarMaps_29, &AllConstraints_44);
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_28, Vars_38, &LambdaVarTypeList_45);
    mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&transform_hlds__lambda_scalar_common_1[2]), (MR_Word) (&transform_hlds__lambda_scalar_common_2[4]), LambdaVarTypeList_45, &LambdaTypeVarsList_46);
    mercury__list__condense_2_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[1]), LambdaTypeVarsList_46, &LambdaTypeVars_47);
    {
      Var_98 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_98, 0) = ((MR_Box) (&transform_hlds__lambda_scalar_common_5[3]));
      MR_hl_field(MR_mktag(0), Var_98, 1) = ((MR_Box) (transform_hlds__lambda__create_new_pred_for_lambda_12_p_0_2));
      MR_hl_field(MR_mktag(0), Var_98, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_98, 3) = ((MR_Box) (LambdaTypeVars_47));
    }
    mercury__list__filter_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_98, AllConstraints_44, &UnivConstraints_48);
    {
      Constraints_49 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Constraints_49, 0) = ((MR_Box) (UnivConstraints_48));
      MR_hl_field(MR_mktag(0), Constraints_49, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    LambdaGoalNonLocals_51 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(LambdaGoalInfo_43);
    parse_tree__set_of_var__insert_list_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_38, LambdaGoalNonLocals_51, &LambdaNonLocals_52);
    hlds__goal_util__extra_nonlocal_typeinfos_5_p_0(RttiVarMaps_29, VarTypes_28, (MR_Word) ((MR_Unsigned) 0U), LambdaNonLocals_52, &ExtraTypeInfos_53);
    parse_tree__set_of_var__delete_list_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_38, LambdaGoalNonLocals_51, &NonLocals1_54);
    parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ExtraTypeInfos_53, NonLocals1_54, &NewTypeInfos_55);
    parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals1_54, NewTypeInfos_55, &NonLocals_56);
    parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_56, &ArgVars1_57);
    succeeded = parse_tree__set_of_var__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NewTypeInfos_55);
    if (succeeded)
    ...
    *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(ArgVars1_57, VarTypes_28);
    AllArgVars_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), *ArgVars_16, Vars_38);
    hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_96_96, &ModuleName_59);
    OrigPredName_60 = hlds__hlds_pred__pred_info_name_1_f_0(OrigPredInfo_24);
    OrigContext_61 = hlds__hlds_goal__goal_info_get_context_1_f_0(LambdaGoalInfo_43);
    mercury__term__context_file_2_p_0(OrigContext_61, &OrigFile_62);
    mercury__term__context_line_2_p_0(OrigContext_61, &OrigLine_63);
    hlds__hlds_module__module_info_next_lambda_count_4_p_0(OrigContext_61, &LambdaCount_64, STATE_VARIABLE_ModuleInfo_96_96, &STATE_VARIABLE_ModuleInfo_101_101);
    parse_tree__prog_util__make_pred_name_with_context_7_p_0(ModuleName_59, (MR_String) "IntroducedFrom", PredOrFunc_35, OrigPredName_60, OrigLine_63, LambdaCount_64, &PredName_65);
    ...
    AllArgModes_75 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes1_74, Modes_39);
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_28, AllArgVars_58, &ArgTypes_76);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_104, 1) = ((MR_Box) (transform_hlds__lambda__create_new_pred_for_lambda_12_p_0_3));
    ...
    transform_hlds__lambda__restrict_var_maps_8_p_0(AllArgVars_58, LambdaGoal_41, VarSet_25, &LambdaVarSet_82, VarTypes_28, &LambdaVarTypes_83, RttiVarMaps_29, &LambdaRttiVarMaps_84);
    hlds__hlds_pred__proc_info_create_15_p_0(LambdaContext_66, (MR_Word) ((MR_Unsigned) 0U), LambdaVarSet_82, LambdaVarTypes_83, AllArgVars_58, InstVarSet_27, AllArgModes_75, (MR_Integer) 0, Detism_40, LambdaGoal_41, LambdaRttiVarMaps_84, (MR_Integer) 0, HasParallelConj_30, VarNameRemap_81, &STATE_VARIABLE_ProcInfo_108_108);
    ...
    if ((RegWrapperProc_13 == (MR_Word) ((MR_Unsigned) 0U)))
      ProcInfo_85 = STATE_VARIABLE_ProcInfo_111_111;
    else
    {
      MR_Word RegRHeadVars_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RegWrapperProc_13, (MR_Integer) 0))));

      hlds__hlds_pred__proc_info_set_reg_r_headvars_3_p_0(RegRHeadVars_87, STATE_VARIABLE_ProcInfo_111_111, &ProcInfo_85);
    }
    mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_promise__hlds__hlds_promise__type_ctor_info_assert_id_0), &Assertions_88);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_114, 1) = ((MR_Box) (OrigFile_62));
      MR_hl_field(MR_mktag(3), Var_114, 2) = ((MR_Box) (OrigLine_63));
      MR_hl_field(MR_mktag(3), Var_114, 3) = ((MR_Box) (LambdaCount_64));
    }
    hlds__hlds_pred__pred_info_create_17_p_0(ModuleName_59, PredName_65, PredOrFunc_35, LambdaContext_66, Var_114, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), LambdaMarkers_80, ArgTypes_76, TVarSet_26, (MR_Word) ((MR_Unsigned) 0U), Constraints_49, Assertions_88, VarNameRemap_81, (MR_Word) (&transform_hlds__lambda_scalar_common_3[0]), ProcInfo_85, ProcId_18, &PredInfo_90);
    hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_101_101, &PredicateTable0_91);
    hlds__pred_table__predicate_table_insert_4_p_0(PredInfo_90, PredId_17, PredicateTable0_91, &PredicateTable_92);
    hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredicateTable_92, STATE_VARIABLE_ModuleInfo_101_101, &STATE_VARIABLE_ModuleInfo_117_117);
    transform_hlds__direct_arg_in_out__find_and_record_any_direct_arg_in_out_posns_7_p_0(*PredId_17, *ProcId_18, LambdaVarTypes_83, AllArgVars_58, AllArgModes_75, STATE_VARIABLE_ModuleInfo_117_117, STATE_VARIABLE_ModuleInfo_95);
  }
}
          ...
          case (MR_Integer) 1:
            {
              ...
              ArgVars_175 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&transform_hlds__lambda_scalar_common_2[2]), Args_99);
              ExtraVars_103 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&transform_hlds__lambda_scalar_common_2[3]), ExtraArgs_100);
...
{
  {
    ...
    succeeded = check_hlds__mode_util__mode_is_input_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
