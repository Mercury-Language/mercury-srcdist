    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__var_table__var_table_max_var_num_2_p_0(VarTable2_51, &MaxVarNum_73);
        ...
        parse_tree__var_table__var_table_to_sorted_assoc_list_2_p_0(VarTable2_51, &VarTypesList0_77);
        transform_hlds__lambda__filter_vartypes_4_p_0(VarTypesList0_77, VarUses_76, (MR_Word) ((MR_Unsigned) 0U), &RevVarTypesList_78);
        parse_tree__var_table__var_table_from_rev_sorted_assoc_list_2_p_0(RevVarTypesList_78, &VarTable_55);
