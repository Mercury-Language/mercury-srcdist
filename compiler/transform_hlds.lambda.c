  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_94)
{
  ...
  MR_Word STATE_VARIABLE_ModuleInfo_95_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaInfo0_22, (MR_Integer) 0))));
  MR_Word Var_96;
  ...
  parse_tree__prog_type__set_of_type_vars_in_types_2_p_0(LambdaVarTypeList_45, &LambdaTypeVars_46);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_96, 0) = ((MR_Box) (&transform_hlds__lambda_scalar_common_5[2]));
    MR_hl_field(MR_mktag(0), Var_96, 1) = ((MR_Box) (transform_hlds__lambda__create_new_pred_for_lambda_12_p_0_1));
    MR_hl_field(MR_mktag(0), Var_96, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_96, 3) = ((MR_Box) (LambdaTypeVars_46));
  }
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_96, AllConstraints_44, &UnivConstraints_47);
  {
  ...
  *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTable_27, ArgVars1_56);
  ...
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_95_95, &ModuleName_58);
  ...
  hlds__hlds_module__module_info_next_lambda_count_4_p_0(OrigContext_60, &LambdaCount_63, STATE_VARIABLE_ModuleInfo_95_95, &STATE_VARIABLE_ModuleInfo_99_99);
  {
    Var_100 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_100, 0) = ((MR_Box) (OrigLine_62));
    MR_hl_field(MR_mktag(0), Var_100, 1) = ((MR_Box) (LambdaCount_63));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_64, 2) = ((MR_Box) (Var_100));
  }
  parse_tree__pred_name__make_transformed_pred_name_3_p_0(OrigPredName_59, Transform_64, &TransformedName_65);
  ...
  check_hlds__mode_util__modes_to_unify_modes_4_p_0(STATE_VARIABLE_ModuleInfo_99_99, ArgModes1_74, ArgModes1_74, ArgUnifyModes_20);
  ...
  hlds__hlds_pred__proc_info_create_vt_14_p_0(LambdaContext_66, (MR_Word) ((MR_Unsigned) 0U), LambdaVarTable_82, AllArgVars_57, InstVarSet_26, AllArgModes_75, (MR_Integer) 0, Detism_38, LambdaGoal_39, LambdaRttiVarMaps_83, (MR_Integer) 0, HasParallelConj_29, VarNameRemap_81, &STATE_VARIABLE_ProcInfo_106_106);
  hlds__hlds_pred__ensure_all_headvars_are_named_2_p_0(STATE_VARIABLE_ProcInfo_106_106, &STATE_VARIABLE_ProcInfo_107_107);
  ...
  if ((RegWrapperProc_13 == (MR_Word) ((MR_Unsigned) 0U)))
    ProcInfo_84 = STATE_VARIABLE_ProcInfo_109_109;
  else
  {
    MR_Word RegRHeadVars_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RegWrapperProc_13, (MR_Integer) 0))));

    hlds__hlds_pred__proc_info_set_reg_r_headvars_3_p_0(RegRHeadVars_86, STATE_VARIABLE_ProcInfo_109_109, &ProcInfo_84);
  }
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_promise__hlds__hlds_promise__type_ctor_info_assert_id_0), &Assertions_87);
  {
    ...
    MR_hl_field(MR_mktag(3), Var_112, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(3), Var_112, 1) = ((MR_Box) (OrigFile_61));
    MR_hl_field(MR_mktag(3), Var_112, 2) = ((MR_Box) (OrigLine_62));
    MR_hl_field(MR_mktag(3), Var_112, 3) = ((MR_Box) (LambdaCount_63));
  }
  hlds__hlds_pred__pred_info_create_18_p_0(STATE_VARIABLE_ModuleInfo_99_99, PredOrFunc_34, ModuleName_58, TransformedName_65, LambdaContext_66, Var_112, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), LambdaMarkers_80, ArgTypes_76, TVarSet_25, (MR_Word) ((MR_Unsigned) 0U), Constraints_48, Assertions_87, VarNameRemap_81, (MR_Word) (&transform_hlds__lambda_scalar_common_2[0]), ProcInfo_84, ProcId_18, &PredInfo_89);
  ...
  transform_hlds__direct_arg_in_out__find_and_record_any_direct_arg_in_out_posns_7_p_0(*PredId_17, *ProcId_18, LambdaVarTable_82, AllArgVars_57, AllArgModes_75, STATE_VARIABLE_ModuleInfo_115_115, STATE_VARIABLE_ModuleInfo_94);
}
