  ...
  MR_Integer * X_5)
{
  ...
  *X_5 = X_9;
  Inst_10 = hlds__mode_util__mode_get_initial_inst_2_f_0(ModuleInfo_6, Mode_8);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo0_10, &HeadVars_22);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo0_10, &VarTable0_23);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(ProcInfo0_10, &Goal0_24);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(ProcInfo0_10, &RttiVarMaps0_25);
  hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo0_10, &InstVarSet0_26);
  hlds__hlds_proc__proc_info_get_has_parallel_conj_2_p_0(ProcInfo0_10, &HasParallelConj_27);
  {
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_44, ProcInfo0_10, &STATE_VARIABLE_ProcInfo_1_52);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_45, STATE_VARIABLE_ProcInfo_1_52, &STATE_VARIABLE_ProcInfo_2_53);
  hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_46, STATE_VARIABLE_ProcInfo_2_53, &ProcInfo_11);
  ...
  MR_Word * LambdaInfo_18)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_proc__proc_info_set_address_taken_3_p_0((MR_Integer) 0, CalleeProcInfo0_48, &CalleeProcInfo_55);
  ...
  ShroudedPredProcId_58 = hlds__pred_proc_id__shroud_pred_proc_id_1_f_0(Var_69);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_94)
{
  ...
  *ArgVars_16 = hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTable_27, ArgVars1_55);
  ...
  hlds__mode_util__modes_to_unify_modes_4_p_0(STATE_VARIABLE_ModuleInfo_2_99, ArgModes1_73, ArgModes1_73, ArgUnifyModes_20);
  ...
  hlds__hlds_proc__proc_info_create_14_p_0(LambdaContext_65, (MR_Word) ((MR_Unsigned) 0U), LambdaVarTable_81, AllArgVars_56, InstVarSet_26, AllArgModes_74, (MR_Integer) 0, Detism_37, LambdaGoal_38, LambdaRttiVarMaps_82, (MR_Integer) 0, HasParallelConj_29, VarNameRemap_80, &STATE_VARIABLE_ProcInfo_1_106);
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_set_reg_r_headvars_3_p_0(RegRHeadVars_85, STATE_VARIABLE_ProcInfo_3_109, &ProcInfo_83);
  }
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__mode_test__mode_is_input_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  if (succeeded)
  {
    ...
    *ProcId_18 = ((MR_Integer) ((MR_hl_field(2, LambdaGoalExpr_23, 1))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        hlds__hlds_proc__proc_info_get_argmodes_2_p_0(*CalleeProcInfo_20, &CalleeArgModes_32);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            hlds__mode_util__modes_to_unify_modes_4_p_0(ModuleInfo_12, CurriedArgModes_34, CurriedArgModes_34, CurriedArgUnifyModes_22);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__lambda_scalar_common_4[0]), PredIds_4, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_5)), &conv1_STATE_VARIABLE_ModuleInfo_1_8);
