...
transform_hlds__lambda__create_new_pred_for_lambda_12_p_0(
  ...
  MR_Word STATE_VARIABLE_MustRecomputeNonLocals_0_95,
  MR_Word * STATE_VARIABLE_MustRecomputeNonLocals_96,
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  transform_hlds__lambda__do_expand_lambdas_in_proc_6_p_0(ProcInfo0_10, &ProcInfo_11, PredInfo0_8, &PredInfo1_12, STATE_VARIABLE_ModuleInfo_0_16, &STATE_VARIABLE_ModuleInfo_18_18);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_45)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_40, &VarSet0_12, &VarTypes0_13);
  ...
  switch (HaveExpandedLambdas_29) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word MaxVar_67;
        MR_Integer MaxVarNum_68;
        MR_ArrayPtr VarUses0_69;
        MR_ArrayPtr VarUses1_70;
        MR_ArrayPtr VarUses_71;
        MR_Word VarTypesList0_72;
        MR_Word RevVarTypesList_73;
        MR_Word VarTypesList_74;
        MR_Integer Var_75;
        MR_ArrayPtr conv0_VarUses0_69;

        MaxVar_67 = mercury__varset__max_var_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet2_32);
        MaxVarNum_68 = mercury__term__var_to_int_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), MaxVar_67);
        Var_75 = (MR_Integer) ((MR_Unsigned) MaxVarNum_68 + (MR_Unsigned) 1);
        mercury__array__init_3_p_0((MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_75, ((MR_Box) ((MR_Integer) 0)), &conv0_VarUses0_69);
        VarUses0_69 = (MR_ArrayPtr) (conv0_VarUses0_69);
        transform_hlds__lambda__mark_vars_as_used_3_p_0(HeadVars_11, VarUses0_69, &VarUses1_70);
        transform_hlds__lambda__find_used_vars_in_goal_3_p_0(Goal_36, VarUses1_70, &VarUses_71);
        hlds__vartypes__vartypes_to_sorted_assoc_list_2_p_0(VarTypes2_33, &VarTypesList0_72);
        transform_hlds__lambda__filter_vartypes_4_p_0(VarTypesList0_72, (MR_Word) ((MR_Unsigned) 0U), &RevVarTypesList_73, VarUses_71);
        mercury__list__reverse_2_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_2[0]), RevVarTypesList_73, &VarTypesList_74);
        hlds__vartypes__vartypes_from_sorted_assoc_list_2_p_0(VarTypesList_74, &VarTypes_38);
        hlds__hlds_rtti__restrict_rtti_varmaps_3_p_0(VarUses_71, RttiVarMaps2_34, &RttiVarMaps_39);
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_37, VarTypes_38, STATE_VARIABLE_ProcInfo_52_52, &STATE_VARIABLE_ProcInfo_53_53);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_39, STATE_VARIABLE_ProcInfo_53_53, STATE_VARIABLE_ProcInfo_41);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_97)
{
  ...
  MR_Word Transform_66;
  MR_String TransformedName_67;
  MR_Word LambdaContext_68;
  MR_Word OrigArgModes_69;
  MR_Integer NumArgVars_70;
  MR_Word In_71;
  MR_Word InModes_72;
  MR_Word ArgModesMap_73;
  MR_Word OrigArgModesMap_74;
  MR_Word ArgModesMap1_75;
  MR_Word ArgModes1_76;
  MR_Word AllArgModes_77;
  MR_Word ArgTypes_78;
  MR_Word PurityMarkers_80;
  MR_Word LambdaMarkers0_81;
  MR_Word LambdaMarkers_82;
  MR_Word VarNameRemap_83;
  MR_Word LambdaVarSet_84;
  MR_Word LambdaVarTypes_85;
  MR_Word LambdaRttiVarMaps_86;
  MR_Word ProcInfo_87;
  MR_Word Assertions_90;
  MR_Word PredInfo_92;
  MR_Word PredicateTable0_93;
  MR_Word PredicateTable_94;
  MR_Word STATE_VARIABLE_ModuleInfo_98_98 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaInfo0_22, (MR_Integer) 0))));
  MR_Word Var_100;
  ...
  mercury__list__condense_2_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[1]), LambdaTypeVarsList_47, &LambdaTypeVars_48);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_100, 0) = ((MR_Box) (&transform_hlds__lambda_scalar_common_5[3]));
    MR_hl_field(MR_mktag(0), Var_100, 1) = ((MR_Box) (transform_hlds__lambda__create_new_pred_for_lambda_12_p_0_2));
    MR_hl_field(MR_mktag(0), Var_100, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_100, 3) = ((MR_Box) (LambdaTypeVars_48));
  }
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_100, AllConstraints_45, &UnivConstraints_49);
  {
  ...
  if (succeeded)
    *STATE_VARIABLE_MustRecomputeNonLocals_96 = STATE_VARIABLE_MustRecomputeNonLocals_0_95;
  else
    *STATE_VARIABLE_MustRecomputeNonLocals_96 = (MR_Integer) 1;
  *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTypes_28, ArgVars1_58);
  AllArgVars_59 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), *ArgVars_16, Vars_41);
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_98_98, &ModuleName_60);
  ...
  hlds__hlds_module__module_info_next_lambda_count_4_p_0(OrigContext_62, &LambdaCount_65, STATE_VARIABLE_ModuleInfo_98_98, &STATE_VARIABLE_ModuleInfo_103_103);
  {
    Var_104 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (OrigLine_64));
    MR_hl_field(MR_mktag(0), Var_104, 1) = ((MR_Box) (LambdaCount_65));
  }
  {
    Transform_66 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Transform_66, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    MR_hl_field(MR_mktag(3), Transform_66, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_35));
    MR_hl_field(MR_mktag(3), Transform_66, 2) = ((MR_Box) (Var_104));
  }
  parse_tree__pred_name__make_transformed_pred_name_3_p_0(OrigPredName_61, Transform_66, &TransformedName_67);
  LambdaContext_68 = hlds__hlds_goal__goal_info_get_context_1_f_0(LambdaGoalInfo_44);
  transform_hlds__lambda__unify_modes_to_modes_2_p_0(ArgUnifyModes0_19, &OrigArgModes_69);
  mercury__list__length_2_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), *ArgVars_16, &NumArgVars_70);
  parse_tree__prog_mode__in_mode_1_p_0(&In_71);
  mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), NumArgVars_70, ((MR_Box) (In_71)), &InModes_72);
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), *ArgVars_16, InModes_72, &ArgModesMap_73);
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), OrigVars_15, OrigArgModes_69, &OrigArgModesMap_74);
  mercury__map__overlay_3_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModesMap_73, OrigArgModesMap_74, &ArgModesMap1_75);
  mercury__map__apply_to_list_3_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), *ArgVars_16, ArgModesMap1_75, &ArgModes1_76);
  check_hlds__mode_util__modes_to_unify_modes_4_p_0(STATE_VARIABLE_ModuleInfo_103_103, ArgModes1_76, ArgModes1_76, ArgUnifyModes_20);
  AllArgModes_77 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes1_76, Modes_42);
  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_28, AllArgVars_59, &ArgTypes_78);
  {
    Var_106 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_106, 0) = ((MR_Box) (&transform_hlds__lambda_scalar_common_6[0]));
    MR_hl_field(MR_mktag(0), Var_106, 1) = ((MR_Box) (transform_hlds__lambda__create_new_pred_for_lambda_12_p_0_3));
    MR_hl_field(MR_mktag(0), Var_106, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_106, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_103_103));
  }
  mercury__list__foldl_corresponding_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_106, ArgTypes_78, AllArgModes_77, ((MR_Box) ((MR_Integer) 0)), &conv2_Var_79);
  hlds__hlds_pred__purity_to_markers_2_p_0(Purity_33, &PurityMarkers_80);
  hlds__hlds_pred__init_markers_1_p_0(&LambdaMarkers0_81);
  hlds__hlds_pred__add_markers_3_p_0(PurityMarkers_80, LambdaMarkers0_81, &LambdaMarkers_82);
  mercury__map__init_1_p_0((MR_Word) (&transform_hlds__lambda_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &VarNameRemap_83);
  transform_hlds__lambda__restrict_var_maps_8_p_0(AllArgVars_59, LambdaGoal_40, VarSet_25, &LambdaVarSet_84, VarTypes_28, &LambdaVarTypes_85, RttiVarMaps_29, &LambdaRttiVarMaps_86);
  hlds__hlds_pred__proc_info_create_15_p_0(LambdaContext_68, (MR_Word) ((MR_Unsigned) 0U), LambdaVarSet_84, LambdaVarTypes_85, AllArgVars_59, InstVarSet_27, AllArgModes_77, (MR_Integer) 0, Detism_39, LambdaGoal_40, LambdaRttiVarMaps_86, (MR_Integer) 0, HasParallelConj_30, VarNameRemap_83, &STATE_VARIABLE_ProcInfo_110_110);
  hlds__hlds_pred__ensure_all_headvars_are_named_2_p_0(STATE_VARIABLE_ProcInfo_110_110, &STATE_VARIABLE_ProcInfo_111_111);
  switch (MustRecomputeNonLocals0_31) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_111_111, &STATE_VARIABLE_ProcInfo_113_113);
      break;
    case (MR_Integer) 0:
      STATE_VARIABLE_ProcInfo_113_113 = STATE_VARIABLE_ProcInfo_111_111;
      break;
  }
  if ((RegWrapperProc_13 == (MR_Word) ((MR_Unsigned) 0U)))
    ProcInfo_87 = STATE_VARIABLE_ProcInfo_113_113;
  else
  {
    MR_Word RegRHeadVars_89 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RegWrapperProc_13, (MR_Integer) 0))));

    hlds__hlds_pred__proc_info_set_reg_r_headvars_3_p_0(RegRHeadVars_89, STATE_VARIABLE_ProcInfo_113_113, &ProcInfo_87);
  }
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_promise__hlds__hlds_promise__type_ctor_info_assert_id_0), &Assertions_90);
  {
    Var_116 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_116, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(3), Var_116, 1) = ((MR_Box) (OrigFile_63));
    MR_hl_field(MR_mktag(3), Var_116, 2) = ((MR_Box) (OrigLine_64));
    MR_hl_field(MR_mktag(3), Var_116, 3) = ((MR_Box) (LambdaCount_65));
  }
  hlds__hlds_pred__pred_info_create_17_p_0(PredOrFunc_35, ModuleName_60, TransformedName_67, LambdaContext_68, Var_116, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), LambdaMarkers_82, ArgTypes_78, TVarSet_26, (MR_Word) ((MR_Unsigned) 0U), Constraints_50, Assertions_90, VarNameRemap_83, (MR_Word) (&transform_hlds__lambda_scalar_common_3[0]), ProcInfo_87, ProcId_18, &PredInfo_92);
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_103_103, &PredicateTable0_93);
  hlds__pred_table__predicate_table_insert_4_p_0(PredInfo_92, PredId_17, PredicateTable0_93, &PredicateTable_94);
  hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredicateTable_94, STATE_VARIABLE_ModuleInfo_103_103, &STATE_VARIABLE_ModuleInfo_119_119);
  transform_hlds__direct_arg_in_out__find_and_record_any_direct_arg_in_out_posns_7_p_0(*PredId_17, *ProcId_18, LambdaVarTypes_85, AllArgVars_59, AllArgModes_77, STATE_VARIABLE_ModuleInfo_119_119, STATE_VARIABLE_ModuleInfo_97);
}
