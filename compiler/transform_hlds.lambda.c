...
{
  {
    ...
    *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(ArgVars1_58, VarTypes_28);
    ...
    {
      Transform_66 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Transform_66, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_35));
      MR_hl_field(MR_mktag(2), Transform_66, 1) = ((MR_Box) (Var_104));
    }
    parse_tree__pred_name__make_pred_name_4_p_0(ModuleName_60, OrigPredName_61, Transform_66, &PredSymName_67);
