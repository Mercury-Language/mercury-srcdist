  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_97)
{
  ...
  *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(ArgVars1_58, VarTypes_28);
  ...
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(ModuleName_60, OrigPredName_61, Transform_66, &PredSymName_67);
