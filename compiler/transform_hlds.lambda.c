...
MR_decl_label5(transform_hlds__lambda__expand_lambdas_in_goal_4_0, 45,32,48,106,114)
...
MR_decl_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0, 224,5,176,6,10,3,13,16,17,204)
MR_decl_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0, 19,23,18,29,32,33,31,35,15,40)
MR_decl_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0, 42,43,37,45,47,50,51,52,49,54)
MR_decl_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0, 58,60,61,63,143,64,66,56,72,73)
MR_decl_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0, 74,75,76,77,78,79,119,81,83,71)
MR_decl_label5(transform_hlds__lambda__find_used_vars_in_goal_3_0, 86,85,69,89,90)
...
MR_BEGIN_MODULE(transform_hlds__lambda_module5)
	...
	MR_init_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0,224,5,176,6,10,3,13,16,17,204)
	MR_init_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0,19,23,18,29,32,33,31,35,15,40)
	MR_init_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0,42,43,37,45,47,50,51,52,49,54)
	MR_init_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0,58,60,61,63,143,64,66,56,72,73)
	MR_init_label10(transform_hlds__lambda__find_used_vars_in_goal_3_0,74,75,76,77,78,79,119,81,83,71)
	MR_init_label5(transform_hlds__lambda__find_used_vars_in_goal_3_0,86,85,69,89,90)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,224)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,176)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r2;
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,6)
	...
	if (MR_PTAG_TESTR(MR_r3,2)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i176);
	}
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,204)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,19)
	...
	if (MR_PTAG_TESTR(MR_sv(2),0)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i204);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,23)
	...
	MR_np_call_localret_ent(array__set_4_0,
		transform_hlds__lambda__find_used_vars_in_goal_3_0_i204);
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,33)
	...
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i224);
	}
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,61)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,1)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i63);
	}
	MR_r1 = MR_tfield(3, MR_r5, 2);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i224);
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,143)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(3, MR_r5, 2);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i224);
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,64)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,2)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i143);
	}
	MR_sv(1) = MR_tfield(3, MR_r5, 2);
	MR_sv(6) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,56)
	...
	MR_np_call_localret_ent(fn__term__var_to_int_1_0,
		transform_hlds__lambda__find_used_vars_in_goal_3_0_i72);
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,72)
	...
	MR_np_call_localret_ent(array__set_4_0,
		transform_hlds__lambda__find_used_vars_in_goal_3_0_i73);
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,79)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i81);
	}
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,81)
	...
	MR_np_call_localret_ent(transform_hlds__lambda__mark_vars_as_used_3_0,
		transform_hlds__lambda__find_used_vars_in_goal_3_0_i119);
...
MR_def_label(transform_hlds__lambda__find_used_vars_in_goal_3_0,71)
	...
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(transform_hlds__lambda__find_used_vars_in_goal_3_0_i85);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
...
MR_BEGIN_MODULE(transform_hlds__lambda_module10)
	...
	MR_init_label5(transform_hlds__lambda__expand_lambdas_in_goal_4_0,45,32,48,106,114)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,20)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__lambda__expand_lambdas_in_goal_4_0_i106);
	}
	}
...
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,40)
	...
	MR_np_call_localret_ent(fn__transform_hlds__lambda__this_file_0_0,
		transform_hlds__lambda__expand_lambdas_in_goal_4_0_i45);
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,32)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,3)) {
		MR_GOTO_LAB(transform_hlds__lambda__expand_lambdas_in_goal_4_0_i114);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__lambda__expand_lambdas_in_goal_4_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
