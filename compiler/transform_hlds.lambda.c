      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            hlds__var_table____Compare____var_table_0_0(&SubResult5_18, ArgX5_16, ArgY5_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = hlds__var_table____Unify____var_table_0_0(ArgX5_11, ArgY5_12);
            if (succeeded)
            {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 0, VarTable2_51, InstVarSet0_36, InstMap0_53, Goal2_50, &Goal_54, STATE_VARIABLE_ModuleInfo_44_59, &STATE_VARIABLE_ModuleInfo_18_18);
      }
      break;
    case (MR_Integer) 0:
      {
  ...
  switch (HaveExpandedLambdas_48) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer MaxVarNum_73;
        MR_ArrayPtr VarUses0_74;
        MR_ArrayPtr VarUses1_75;
        MR_ArrayPtr VarUses_76;
        MR_Word VarTypesList0_77;
        MR_Word RevVarTypesList_78;
        MR_Integer Var_79;
        MR_ArrayPtr conv1_VarUses0_74;

        hlds__var_table__var_table_max_var_num_2_p_0(VarTable2_51, &MaxVarNum_73);
        Var_79 = (MR_Integer) ((MR_Unsigned) MaxVarNum_73 + (MR_Unsigned) 1);
        mercury__array__init_3_p_0((MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_79, ((MR_Box) ((MR_Integer) 0)), &conv1_VarUses0_74);
        VarUses0_74 = (MR_ArrayPtr) (conv1_VarUses0_74);
        transform_hlds__lambda__mark_vars_as_used_3_p_0(HeadVars_32, VarUses0_74, &VarUses1_75);
        transform_hlds__lambda__find_used_vars_in_goal_3_p_0(Goal_54, VarUses1_75, &VarUses_76);
        hlds__var_table__var_table_to_sorted_assoc_list_2_p_0(VarTable2_51, &VarTypesList0_77);
        transform_hlds__lambda__filter_vartypes_4_p_0(VarTypesList0_77, VarUses_76, (MR_Word) ((MR_Unsigned) 0U), &RevVarTypesList_78);
        hlds__var_table__var_table_from_rev_sorted_assoc_list_2_p_0(RevVarTypesList_78, &VarTable_55);
        hlds__hlds_rtti__restrict_rtti_varmaps_3_p_0(VarUses_76, RttiVarMaps2_52, &RttiVarMaps_56);
      }
      break;
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_96)
{
  ...
  hlds__var_table__lookup_var_types_3_p_0(VarTable_27, LambdaVars_40, &LambdaVarTypeList_45);
  ...
  *ArgVars_16 = check_hlds__type_util__put_typeinfo_vars_first_table_2_f_0(VarTable_27, ArgVars1_56);
  ...
  hlds__var_table__lookup_var_types_3_p_0(VarTable_27, AllArgVars_57, &ArgTypes_76);
  {
  ...
  hlds__var_table__split_var_table_3_p_0(LambdaVarTable_82, &_LambdaVarSet_92, &LambdaVarTypes_93);
  ...
  MR_Word * STATE_VARIABLE_RttiVarMaps_20)
{
  ...
  hlds__var_table__var_table_max_var_num_2_p_0(STATE_VARIABLE_VarTable_0_17, &MaxVarNum_11);
  ...
  hlds__var_table__var_table_to_sorted_assoc_list_2_p_0(STATE_VARIABLE_VarTable_0_17, &VarTypesList0_15);
  transform_hlds__lambda__filter_vartypes_4_p_0(VarTypesList0_15, VarUses_14, (MR_Word) ((MR_Unsigned) 0U), &RevVarTypesList_16);
  hlds__var_table__var_table_from_rev_sorted_assoc_list_2_p_0(RevVarTypesList_16, STATE_VARIABLE_VarTable_18);
