...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[27][2];
  ...
  MR_String BaseName_10)
{
  ...
  Var_106 = libs__shell_util__quote_shell_cmd_arg_1_f_0(CFileName_35);
  {
    ...
    MR_hl_field(1, Var_109, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[25])));
  }
  {
