  ...
  MR_Box * wrapper_arg_2)
{
  ...
  backend_libs__compile_target_code__IntroducedFrom__pred__link_module_list__1540__1_2_p_0(((MR_String) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Word * Succeeded_16)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 697, &RestrictedCommandLine_67);
  ...
  MR_String * ResCmdLinkOpts_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 697, &RestrictedCommandLine_7);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 623, &MkInit_14);
  ...
  if (((MR_tag((MR_Word) InitFileRes_18)) == (MR_Integer) 1))
  {
    ...
    Var_65 = mercury__io__error_message_1_f_0(Error_29);
    ...
    mercury__io__write_string_4_p_0(ProgressStream_9, Var_65);
  ...
  else
  {
...

    {
      ...
      MR_hl_field(0, Var_40, 0) = ((MR_Box) (&backend_libs__compile_target_code_scalar_common_8[0]));
      MR_hl_field(0, Var_40, 1) = ((MR_Box) (backend_libs__compile_target_code__make_library_init_file_7_p_0_1));
      MR_hl_field(0, Var_40, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(0, Var_40, 3) = ((MR_Box) (Globals_8));
      MR_hl_field(0, Var_40, 4) = ((MR_Box) ((MR_String) "predicate \140backend_libs.compile_target_code.make_library_init_file\'/7"));
      MR_hl_field(0, Var_40, 5) = ((MR_Box) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[1])));
    }
    mercury__list__map_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_40, AllModules_11, &AllTargetFilesList_20);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_8, (MR_Integer) 670, &MaybeInitFileCommand_22);
          ...
          else
          {
            ...
            parse_tree__module_cmds__invoke_system_command_8_p_0(Globals_8, ProgressStream_9, InitFileStream_19, (MR_Integer) 1, CommandString_24, &Succeeded0_25);
          }
        }
        break;
    }
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 697, &RestrictedCommandLine_19);
  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 697, &RestrictedCommandLine_22);
  ...
  MR_String * AllCFlags_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 707, &TargetArch_47);
