  ...
  MR_Word * Succeeded_18)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 732, &RestrictedCommandLine_69);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 732, &RestrictedCommandLine_19);
  ...
  MR_String * AllCFlags_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 742, &TargetArch_47);
