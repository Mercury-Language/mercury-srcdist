  ...
  MR_Word * Result_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 77, &Verbose_82);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 87, &Stats_83);
  ...
  MR_String * InclOpts_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 562, &CInclDirs_5);
