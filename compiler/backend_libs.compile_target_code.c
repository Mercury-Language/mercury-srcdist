  ...
  MR_Word * STATE_VARIABLE_Succeeded_37)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 588, &MercuryLibs_26);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 685, (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_3[0])), Globals_9, &NoSubDirGlobals_28);
  ...
  MR_Word * Succeeded_14)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 560, &PicObjExt_79);
        libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 559, &ObjExt_80);
  ...
  else
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 583, &ExtraLinkObjectsList_33);
    ...
    case (MR_Integer) 5:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140backend_libs.compile_target_code.link_output_filename\'/7", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[10])), ModuleName_14, &OutputFileName_100);
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 660, &Jar_52);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 597, &MercuryOrCsharpLinkage_11);
        }
        break;
      case (MR_Integer) 6:
      case (MR_Integer) 5:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 684, (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_3[0])), Globals_10, &NoSubdirGlobals0_21);
        libs__globals__set_option_4_p_0((MR_Integer) 685, (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_3[0])), NoSubdirGlobals0_21, &NoSubdirGlobals_22);
        switch (LinkTargetType_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 3:
            {
  ...
  MR_Word * MaybeInitTargetFile_26)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 592, &InitFileDirsList_33);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 593, &InitFileNamesList0_35);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 594, &TraceInitFileNamesList0_37);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 604, &RuntimeFlagsList_46);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 605, &ExtraInits_48);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 601, &Main_50);
  switch (Main_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 684, (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_3[0])), Globals_9, &NoSubdirGlobals0_30);
                libs__globals__set_option_4_p_0((MR_Integer) 685, (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_3[0])), NoSubdirGlobals0_30, &NoSubdirGlobals_31);
  ...
  MR_String * AllCFlags_6)
{
  ...
  switch (OptimizeC_40) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 549, &OptimizeOpt_41);
      break;
  }
  ...
  switch (Warn_44) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 548, &WarningOpt_45);
      break;
  }
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 237, &ExecTrace_46);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 703, &TargetArch_47);
