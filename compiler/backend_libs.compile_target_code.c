  ...
  MR_Word Stream_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 646, &UseInstallName_70);
  backend_libs__compile_target_code__shared_libraries_supported_2_p_0(Globals_5, &SharedLibsSupported_71);
  libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 587, &Linkage_72);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 572, &RpathDirs0_73);
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 641, &RpathSep_77);
      libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 640, &RpathFlag_78);
  ...
  MR_Word Stream_6)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 533, &C_Incl_Dirs_14);
  ...
  MR_String BaseName_10)
{
  ...
  else
  {
    ...
    mercury__io__write_strings_4_p_0(HdrFileStream_24, Var_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 553, &PicObjExt_92);
        libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 552, &ObjExt_93);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 604, &ExtStr_46);
        _Ext_86 = (MR_Word) (ExtStr_46);
        {
          Var_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (_Ext_86));
        }
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140backend_libs.compile_target_code.link_output_filename\'/7", (MR_Integer) 0, Var_80, ModuleName_14, &OutputFileName_95);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 603, &ExtStr_82);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          MR_Word Var_56;
          MR_Word TargetEnvType_89;

          libs__globals__get_target_env_type_2_p_0(Globals_10, &TargetEnvType_89);
          ScriptOtherExt_28 = ((&backend_libs__compile_target_code_vector_common_10[0 + TargetEnvType_89]))->backend_libs__compile_target_code__vector_common_type_10_0__vct_10_f_0;
          {
  ...
  MR_Word * Result_16)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      backend_libs__compile_target_code__IntroducedFrom__pred__do_make_init_obj_file__1275__1_9_p_0(Var_31, Var_32, Var_33, Var_34, Var_35, InitTargetFileName_20, &CompileSucceeded_22);
      libs__file_util__maybe_report_stats_4_p_0(ProgressStream_11, Stats_19);
  ...
  MR_Word * Succeeded_14)
{
  ...
  switch (PIC_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 552, &ExtStr_34);
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 553, &ExtStr_34);
      break;
  }
