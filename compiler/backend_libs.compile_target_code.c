...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[16][2];
...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[16][2] = {
  ...
  /* row 12 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_1[10])))
  },
  /* row 13 */
  {
...
{
  {
    ...
    else
    {
      ...
      Var_76 = mercury__string__to_upper_1_f_0(BaseName_10);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_1[14])));
      }
      {
...
{
  {
    ...
    Var_104 = libs__options__quote_arg_1_f_0(CFileName_35);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_107, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_1[15])));
    }
    {
              ...
              switch (MR_tag((MR_Word) C_CompilerType_8)) {
                ...
                case (MR_Integer) 2:
                  *ResCmdLinkOpts_6 = (MR_String) "";
                  break;
                case (MR_Integer) 3:
                  backend_libs__compile_target_code__join_string_list_5_p_0((MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_1[9])), (MR_String) "", (MR_String) "", (MR_String) " ", ResCmdLinkOpts_6);
                  break;
              }
            }
            break;
...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 280, &BytesPerWord_33);
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__compile_target_code_scalar_common_3[4]), BytesPerWord_33, &Var_382);
              Var_389 = mercury__string__f_43_43_2_f_0(Var_382, (MR_String) " ");
              C_FnAlignOpt_34 = mercury__string__f_43_43_2_f_0((MR_String) "-falign-functions=", Var_389);
            }
            break;
          case (MR_Integer) 3:
            C_FnAlignOpt_34 = (MR_String) "";
    ...
    {
      Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (C_FnAlignOpt_34));
      MR_hl_field(MR_mktag(1), Var_121, 1) = ((MR_Box) (Var_122));
    }
    {
      Var_119 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
