...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[32][2];

static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_2[7][1];
...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[32][2] = {
  ...
  /* row   9 */
  {
    ((MR_Box) (&backend_libs__compile_target_code_scalar_common_2[4])),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  10 */
  {
  ...
  /* row  19 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[18])))
  },
  /* row  20 */
  {
  ...
  {
    ((MR_Box) ((MR_String) "-nologo")),
    ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[22])))
  },
  /* row  24 */
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
  ...
  /* row  26 */
  {
    ((MR_Box) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[25]))),
    ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[24])))
  },
  /* row  27 */
  {
...
static /* final */ const struct backend_libs__compile_target_code__vector_common_type_9_0_s backend_libs__compile_target_code_vector_common_9[5] = {
  /* row   0 */   { (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[12])) },
  /* row   1 */   { (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[12])) },
  /* row   2 */   { (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[12])) },
  /* row   3 */   { (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[13])) },
  /* row   4 */   { (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[13])) },
};
  ...
  MR_Word LambdaHeadVar__1_17)
{
  ...
  if (succeeded)
    LambdaHeadVar__2_18 = (MR_Word) (&backend_libs__compile_target_code_scalar_common_2[6]);
  else
  {
    MR_String Var_20;
  ...
  MR_Word * LambdaHeadVar__2_82)
{
  ...
  parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_9, (MR_String) "predicate \140backend_libs.compile_target_code.compile_csharp_file\'/8", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[4])), LambdaHeadVar__1_81, &FileName_40, &_FileNameProposed_41);
  {
  ...
  MR_Word Stream_8)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_40, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[27])));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_Succeeded_40)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_full_curdir_8_p_0(Globals_10, (MR_String) "predicate \140backend_libs.compile_target_code.get_link_opts_for_library\'/9", (MR_String) "lib", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[8])), LibModuleName_29, &_FullLibFileName_30, &_FullLibFileNameProposed_31, &LibFileName_32);
    ...
    if (((MR_tag((MR_Word) MaybeDirName_33)) == (MR_Integer) 1))
    {
      ...
      *LinkerOpt_13 = (MR_String) "";
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_36, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[26])));
      }
      {
  ...
  MR_String BaseName_8)
{
  ...
  else
  {
    ...
    Var_66 = mercury__string__to_upper_1_f_0(BaseName_8);
    {
      ...
      MR_hl_field(1, Var_65, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[28])));
    }
    {
  ...
  MR_String BaseName_8)
{
  ...
  Var_104 = libs__shell_util__quote_shell_cmd_arg_1_f_0(CFileName_33);
  {
    ...
    MR_hl_field(1, Var_107, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[29])));
  }
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_114 = parse_tree__file_names__extension_to_string_2_f_0(Globals_6, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[31])));
  ...
  MR_Word * Succeeded_14)
{
  ...
  switch (TargetType_22) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 2:
      InitObjResult_31 = (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_2[1]));
      break;
  }
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__compile_target_code_scalar_common_2[3]), ReserveStackSize_5, &Var_22);
      ...
      case (MR_Integer) 3:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__compile_target_code_scalar_common_2[3]), ReserveStackSize_5, &Var_30);
            ...
            switch (MR_tag((MR_Word) C_CompilerType_8)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, C_CompilerType_8, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    backend_libs__compile_target_code__join_string_list_5_p_0((MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[23])), (MR_String) "", (MR_String) "", (MR_String) " ", ResCmdLinkOpts_6);
                    break;
                  case (MR_Integer) 1:
                    backend_libs__compile_target_code__join_string_list_5_p_0((MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[19])), (MR_String) "", (MR_String) "", (MR_String) " ", ResCmdLinkOpts_6);
                    break;
                }
                break;
            }
  ...
  MR_String * StdLibs_6)
{
  ...
  else
  {
    ...
    switch (TargetType_5) {
      ...
      case (MR_Integer) 4:
        {
          LibExt_10 = (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[4]));
      ...
      case (MR_Integer) 2:
        {
          LibExt_10 = (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[8]));
    ...
    case (MR_Integer) 4:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_8, (MR_String) "predicate \140backend_libs.compile_target_code.linked_target_file_name_full_curdir\'/7", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[4])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_32, CurDirFileName_12);
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_8, (MR_String) "predicate \140backend_libs.compile_target_code.linked_target_file_name_full_curdir\'/7", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[6])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_36, CurDirFileName_12);
      }
      break;
    case (MR_Integer) 6:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_8, (MR_String) "predicate \140backend_libs.compile_target_code.linked_target_file_name_full_curdir\'/7", (MR_Word) (MR_mkword(2, &backend_libs__compile_target_code_scalar_common_2[2])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_40, CurDirFileName_12);
      }
      break;
    case (MR_Integer) 5:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_8, (MR_String) "predicate \140backend_libs.compile_target_code.linked_target_file_name_full_curdir\'/7", (MR_Word) (MR_mkword(2, &backend_libs__compile_target_code_scalar_common_2[2])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_44, CurDirFileName_12);
      }
      break;
    case (MR_Integer) 2:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_lib_file_name_full_curdir_create_dirs_10_p_0(Globals_8, (MR_String) "predicate \140backend_libs.compile_target_code.linked_target_file_name_full_curdir\'/7", (MR_String) "lib", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[8])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_48, CurDirFileName_12);
      }
      break;
  }
}
  ...
  MR_Word * Result_14)
{
  ...
  backend_libs__compile_target_code__make_init_target_file_13_p_0(Globals_9, ProgressStream_10, MkInit_24, ModuleName_12, ModuleNames_13, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[2])), (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[11])), StdInitFileNames_21, StdTraceInitFileNames_22, SourceDebugInitFileNames_23, &MaybeInitTargetFile_25);
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140backend_libs.compile_target_code.do_make_init_obj_file\'/8", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[30])), ModuleName_12, &InitObjFileName_29, &_InitObjFileNameProposed_30);
  ...
  MR_Word * Succeeded_14)
{
  ...
  succeeded = parse_tree__file_names__mercury_std_library_module_name_1_p_0(ModuleName_26);
  if (succeeded)
    mercury__set__insert_list_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[10])), DepModules_121, &ReferencedDlls_37);
  else
        ...
        case (MR_Integer) 2:
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__compile_target_code_scalar_common_2[3]), BytesPerWord_33, &Var_375);
