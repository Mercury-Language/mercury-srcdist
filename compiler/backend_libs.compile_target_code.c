  ...
  MR_Word * STATE_VARIABLE_Succeeded_37)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 683, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_3[3])), Globals_9, &NoSubDirGlobals_28);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 682, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_3[3])), Globals_10, &NoSubdirGlobals0_21);
        libs__globals__set_option_4_p_0((MR_Integer) 683, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_3[3])), NoSubdirGlobals0_21, &NoSubdirGlobals_22);
        switch (LinkTargetType_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 3:
            {
            ...
            case (MR_Integer) 1:
              {
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 682, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_3[3])), Globals_9, &NoSubdirGlobals0_37);
                libs__globals__set_option_4_p_0((MR_Integer) 683, (MR_Word) (MR_mkword(MR_mktag(1), &backend_libs__compile_target_code_scalar_common_3[3])), NoSubdirGlobals0_37, &NoSubdirGlobals_38);
