  ...
  MR_Word * Succeeded_16)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 698, &RestrictedCommandLine_67);
  ...
  MR_String * ResCmdLinkOpts_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 698, &RestrictedCommandLine_7);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 698, &RestrictedCommandLine_19);
  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 698, &RestrictedCommandLine_22);
  ...
  MR_String * AllCFlags_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 708, &TargetArch_47);
