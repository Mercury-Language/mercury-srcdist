...
backend_libs__compile_target_code__IntroducedFrom__func__get_c_include_dir_flags__1564__1_1_f_0(
...
static MR_bool MR_CALL 
backend_libs__compile_target_code__IntroducedFrom__pred__compile_java_files__603__1_2_p_0(
  MR_Word DestDirPath_35,
...
static void MR_CALL 
backend_libs__compile_target_code__make_standalone_interface_body_5_p_0(
...
static void MR_CALL 
backend_libs__compile_target_code__get_env_classpath_3_p_0(
  ...
  MR_String BaseName_8)
{
  ...
  {
    MR_Word IOError_18 = ((MR_Word) ((MR_hl_field(1, OpenResult_15, 0))));

    libs__file_util__report_cannot_open_file_for_output_6_p_0(ProgressStream_6, Globals_7, HdrFileName_14, IOError_18);
  }
  else
  {
    ...
    backend_libs__compile_target_code__make_standalone_interface_body_5_p_0(ProgressStream_6, Globals_7, BaseName_8);
  }
}
  ...
  MR_String BaseName_8)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 530, &InitFiles0_10);
  mercury__list__remove_dups_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), InitFiles0_10, &InitFiles1_11);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 531, &TraceInitFiles0_12);
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_7, (MR_Integer) 517, &MaybeStdLibDir_13);
  libs__globals__get_grade_dir_2_p_0(Globals_7, &GradeDir_14);
  ...
  libs__globals__get_trace_level_2_p_0(Globals_7, &TraceLevel_19);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 520, &SourceDebug_23);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 541, &RuntimeFlagsList_25);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 529, &InitFileDirsList_27);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 82, &ExperimentalComplexity_29);
  ...
  libs__compute_grade__compute_grade_2_p_0(Globals_7, &Grade_31);
  libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 600, &MkInit_32);
  ...
  backend_libs__compile_target_code__invoke_mkinit_10_p_0(ProgressStream_6, ProgressStream_6, Globals_7, (MR_Integer) 1, MkInit_32, MkInitArgs_34, InitFiles_24, &MkInitCmdSucceeded_36);
  switch (MkInitCmdSucceeded_36) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
        mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "mercury_compile: error while creating ");
        mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "standalone interface in \140");
        mercury__io__write_string_4_p_0(ProgressStream_6, CFileName_33);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_113 = parse_tree__file_names__extension_to_string_2_f_0(Globals_7, Ext_40);
        ObjFileName_41 = mercury__string__f_43_43_2_f_0(BaseName_8, Var_113);
        backend_libs__compile_target_code__do_compile_c_file_8_p_0(ProgressStream_6, Globals_7, PIC_37, CFileName_33, ObjFileName_41, &CompileSucceeded_42);
        switch (CompileSucceeded_42) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
              mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "mercury_compile: error while compiling");
              mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "standalone interface in \140");
              mercury__io__write_string_4_p_0(ProgressStream_6, CFileName_33);
              mercury__io__write_string_4_p_0(ProgressStream_6, (MR_String) "\'\n");
            }
  ...
  MR_Word * PIC_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 495, &Var_9);
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 496, &Var_10);
  ...
  MR_Word * Result_14)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_10, (MR_Integer) 517, &MaybeStdLibDir_16);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 600, &MkInit_24);
  backend_libs__compile_target_code__make_init_target_file_13_p_0(ProgressStream_9, Globals_10, MkInit_24, ModuleName_12, ModuleNames_13, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[1])), (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[2])), StdInitFileNames_21, StdTraceInitFileNames_22, SourceDebugInitFileNames_23, &MaybeInitTargetFile_25);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 134, &Stats_83);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      backend_libs__compile_target_code__do_compile_c_file_8_p_0(ProgressStream_9, Globals_10, (MR_Integer) 1, InitTargetFileName_84, InitObjFileName_29, &CompileSucceeded_86);
  ...
  MR_Word * MaybeInitTargetFile_24)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 131, &Verbose_26);
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 134, &Stats_27);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_14, Verbose_26, (MR_String) "% Creating initialization file...\n");
  libs__compute_grade__compute_grade_2_p_0(Globals_15, &Grade_28);
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_15, (MR_String) "predicate \140backend_libs.compile_target_code.make_init_target_file\'/13", InitTargetOtherExt_20, ModuleName_17, &InitTargetFileName_29, &_InitTargetFileNameProposed_30);
  {
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 529, &InitFileDirsList_33);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 530, &InitFileNamesList0_35);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 531, &TraceInitFileNamesList0_37);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 520, &SourceDebug_44);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 541, &RuntimeFlagsList_46);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 542, &ExtraInits_48);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 538, &Main_50);
  switch (Main_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 82, &ExperimentalComplexity_52);
  ...
  backend_libs__compile_target_code__invoke_mkinit_10_p_0(ProgressStream_14, ProgressStream_14, Globals_15, (MR_Integer) 1, MkInit_16, MkInitArgs_55, Var_112, &MkInitSucceeded_57);
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_14, Stats_27);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__module_cmds__copy_dot_tmp_to_base_file_return_succeeded_6_p_0(ProgressStream_14, Globals_15, InitTargetFileName_29, &UpdateResult_58);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 600, &MkInit_14);
  parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_9, (MR_String) "predicate \140backend_libs.compile_target_code.make_library_init_file\'/7", (MR_Word) (MR_mkword(2, &backend_libs__compile_target_code_scalar_common_2[0])), MainModuleName_10, &FullInitFileName_15, &_FullInitFileNameProposed_16, &CurDirInitFileName_17);
  ...
  if (((MR_tag((MR_Word) TmpInitFileOpenResult_19)) == (MR_Integer) 1))
  {
    ...
    mercury__io__write_string_4_p_0(ProgressStream_8, ProgName_32);
    mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) ": can\'t open \140");
    mercury__io__write_string_4_p_0(ProgressStream_8, TmpFullInitFileName_18);
    mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "\' for output: ");
    mercury__io__write_string_4_p_0(ProgressStream_8, ErrorMsg_33);
  ...
  else
  {
...

    {
      ...
      MR_hl_field(0, Var_43, 3) = ((MR_Box) (Globals_9));
    ...
    backend_libs__compile_target_code__invoke_mkinit_10_p_0(ProgressStream_8, TmpInitFileStream_20, Globals_9, (MR_Integer) 1, MkInit_14, (MR_String) " -k ", AllTargetCFilesList_21, &TmpMkInitSucceeded0_23);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_9, (MR_Integer) 581, &MaybeInitFileCommand_24);
          ...
          else
          {
            ...
            libs__system_cmds__invoke_system_command_8_p_0(Globals_9, ProgressStream_8, TmpInitFileStream_20, (MR_Integer) 1, CommandStr_26, &TmpMkInitSucceeded_27);
          }
        }
        break;
    }
    mercury__io__close_output_3_p_0(TmpInitFileStream_20);
    parse_tree__module_cmds__copy_dot_tmp_to_base_file_return_succeeded_6_p_0(ProgressStream_8, Globals_9, FullInitFileName_15, &CopyTmpSucceeded_28);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            parse_tree__module_cmds__make_symlink_or_copy_file_7_p_0(ProgressStream_8, Globals_9, FullInitFileName_15, CurDirInitFileName_17, Succeeded_12);
          }
        }
        break;
    }
  ...
  MR_Word * MkInitSucceeded_18)
{
  ...
  if (((MR_tag((MR_Word) TmpFileResult_21)) == (MR_Integer) 1))
  {
    ...
    mercury__io__write_string_4_p_0(ProgressStream_11, ErrorMessage_28);
  ...
  else
  {
    ...
    libs__system_cmds__invoke_system_command_8_p_0(Globals_13, ProgressStream_11, InitFileStream_12, Verbosity_14, MkInitCmd_24, &MkInitSucceeded0_25);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__compile_target_code__IntroducedFrom__pred__compile_java_files__603__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * Succeeded_12)
{
  ...
  switch (Verbose_14) {
    ...
    case (MR_Integer) 1:
      ...
      {
        mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "% Compiling \140");
        mercury__io__write_string_4_p_0(ProgressStream_8, HeadJavaFile_10);
        mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "\':\n");
      }
      else
      {
        mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "% Compiling \140");
        mercury__io__write_string_4_p_0(ProgressStream_8, HeadJavaFile_10);
        mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "\', etc.:\n");
      }
      break;
  }
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 497, &JavaCompiler_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 499, &JavaFlagsList_18);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 592, &RestrictedCommandLine_19);
  ...
  parse_tree__module_cmds__get_mercury_std_libs_for_java_2_p_0(Globals_9, &MercuryStdLibs_24);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 501, &UserClasspath_25);
  ...
  backend_libs__compile_target_code__get_env_classpath_3_p_0(&EnvClasspath_27);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 471, &TargetDebug_31);
  ...
  parse_tree__file_names__get_java_dir_path_4_p_0(Globals_9, (MR_Integer) 0, &SourceDirPath_33, &_SourceDirPathProposed_34);
  parse_tree__file_names__get_java_dir_path_4_p_0(Globals_9, (MR_Integer) 1, &DestDirPath_35, &_DestDirPathProposed_36);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 612, &MFilterJavac_43);
  ...
  libs__system_cmds__invoke_long_system_command_maybe_filter_output_11_p_0(Globals_9, ProgressStream_8, ProgressStream_8, (MR_Integer) 1, JavaCompiler_17, NonAtFileCommandArgs_45, CommandArgs_47, MaybeMFilterJavac_44, Succeeded_12);
}
  ...
  MR_Word * Succeeded_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140backend_libs.compile_target_code.compile_c_file\'/7", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[1])), ModuleName_11, &C_File_14, &_C_FileProposed_15);
  switch (PIC_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_9, (MR_String) "predicate \140backend_libs.compile_target_code.compile_c_file\'/7", Var_27, ModuleName_11, &O_File_18, &_O_FileProposed_19);
  backend_libs__compile_target_code__do_compile_c_file_8_p_0(ProgressStream_8, Globals_9, PIC_10, C_File_14, O_File_18, Succeeded_12);
}
  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 494, &NameObjectFile_17);
  switch (Verbose_16) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__write_string_4_p_0(ProgressStream_9, C_File_12);
        mercury__io__write_string_4_p_0(ProgressStream_9, (MR_String) "\':\n");
      }
      break;
  }
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 473, &CC_18);
  backend_libs__compile_target_code__gather_c_compiler_flags_3_p_0(Globals_10, PIC_11, &AllCFlags_19);
  ...
  succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_10, (MR_Integer) 53, (MR_Integer) 1);
  if (succeeded)
  {
    Var_58 = (MR_Integer) 611;
  ...
  libs__system_cmds__invoke_system_command_maybe_filter_output_9_p_0(Globals_10, ProgressStream_9, ProgressStream_9, (MR_Integer) 1, Command_20, MaybeFilterCmd_21, Succeeded_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 134, &Stats_22);
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_9, Stats_22);
}
  ...
  MR_String * AllCFlags_6)
{
  ...
  MR_Word TypeLayoutOption_38;
  MR_String TypeLayoutOpt_39;
  MR_Word OptTuple_40;
  MR_Word OptimizeC_41;
  MR_String OptimizeOpt_42;
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 477, &C_Flags_List_7);
  ...
  switch (GCC_Regs_15) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 488, &CFLAGS_FOR_REGS_16);
      break;
  }
  ...
  switch (GCC_Gotos_17) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 489, &CFLAGS_FOR_GOTOS_18);
      break;
  }
  ...
  switch (Parallel_19) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 490, &CFLAGS_FOR_THREADS_20);
      break;
  }
  switch (PIC_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 491, &CFLAGS_FOR_PIC_21);
      break;
  }
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 493, &CFLAGS_FOR_LTO_22);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 471, &Target_Debug_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 487, &Target_DebugOpt0_24);
        Target_DebugOpt_25 = mercury__string__f_43_43_2_f_0(Target_DebugOpt0_24, (MR_String) " ");
      }
      break;
  }
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 492, &SanitizerOpts_26);
        ...
        case (MR_Integer) 2:
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&backend_libs__compile_target_code_scalar_common_2[1]), BytesPerWord_33, &Var_376);
            Var_383 = mercury__string__f_43_43_2_f_0(Var_376, (MR_String) " ");
            C_FnAlignOpt_34 = mercury__string__f_43_43_2_f_0((MR_String) "-falign-functions=", Var_383);
          }
          break;
        case (MR_Integer) 3:
          C_FnAlignOpt_34 = (MR_String) "";
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 752, &TypeLayoutOption_38);
  switch (TypeLayoutOption_38) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      TypeLayoutOpt_39 = (MR_String) "-DMR_NO_TYPE_LAYOUT ";
      break;
    case (MR_Integer) 1:
      TypeLayoutOpt_39 = (MR_String) "";
      break;
  }
  libs__globals__get_opt_tuple_2_p_0(Globals_4, &OptTuple_40);
  InlineAlloc_43 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_40, 2))) >> 1)) & (MR_Integer) 1);
  OptimizeC_41 = ((MR_Unsigned) ((MR_hl_field(0, OptTuple_40, 2))) & (MR_Integer) 1);
  switch (OptimizeC_41) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      OptimizeOpt_42 = (MR_String) "";
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 486, &OptimizeOpt_42);
      break;
  }
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 472, &Warn_45);
  switch (Warn_45) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 485, &WarningOpt_46);
      break;
  }
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 57, &ExecTrace_47);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 601, &TargetArch_48);
  ...
  if (succeeded)
  {
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_80 = ((MR_Word) ((MR_hl_field(1, C_CompilerType_27, 0))));
          succeeded = (Var_80 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Var_81 = ((MR_Integer) ((MR_hl_field(1, Var_80, 0))));
            succeeded = (Var_81 == (MR_Integer) 9);
            if (succeeded)
            {
              Var_82 = (MR_String) "x86_64";
              succeeded = mercury__string__prefix_2_p_0(TargetArch_48, Var_82);
            }
          }
        }
      }
    ...
    OverrideOpts_51 = (MR_String) "";
  {
    ...
    MR_hl_field(1, Var_125, 0) = ((MR_Box) (OverrideOpts_51));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_116, 0) = ((MR_Box) (WarningOpt_46));
    MR_hl_field(1, Var_116, 1) = ((MR_Box) (Var_117));
  }
  {
    Var_115 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_115, 0) = ((MR_Box) (C_FnAlignOpt_34));
    MR_hl_field(1, Var_115, 1) = ((MR_Box) (Var_116));
  }
  {
    Var_114 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_114, 0) = ((MR_Box) (InlineAllocOpt_44));
    MR_hl_field(1, Var_114, 1) = ((MR_Box) (Var_115));
  }
  {
    Var_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_113, 0) = ((MR_Box) (TypeLayoutOpt_39));
  ...
  {
    Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_90, 0) = ((MR_Box) (OptimizeOpt_42));
    MR_hl_field(1, Var_90, 1) = ((MR_Box) (Var_91));
  }
  {
    Var_88 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_String * Flags_4)
{
  ...
  switch (MR_tag((MR_Word) C_CompilerType_5)) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 479, &FlagsList_9);
      break;
    case (MR_Integer) 2:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 481, &FlagsList_9);
      break;
    case (MR_Integer) 3:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 483, &FlagsList_9);
      break;
  }
  ...
  MR_String * FrameworkDirOpts_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 544, &FrameworkDirs0_5);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_12 = backend_libs__compile_target_code__IntroducedFrom__func__get_c_include_dir_flags__1564__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_String * InclOpts_4)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_3, (MR_Integer) 476, &CInclDirs_5);
