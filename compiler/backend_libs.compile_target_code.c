  ...
  MR_Word * LinkedTargetType_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 133, &MakeSharedLib_5);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 133, &CompileToSharedLib_19);
