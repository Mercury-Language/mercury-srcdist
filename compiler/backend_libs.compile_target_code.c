...
backend_libs__compile_target_code__IntroducedFrom__func__referenced_csharp_dlls__749__1_1_f_0(
  MR_Word LambdaHeadVar__1_17);

static MR_Word MR_CALL 
backend_libs__compile_target_code__IntroducedFrom__func__get_c_include_dir_flags__1641__1_1_f_0(
  MR_String LambdaHeadVar__1_11);

static void MR_CALL 
backend_libs__compile_target_code__IntroducedFrom__pred__compile_csharp_file__710__1_4_p_0(
  MR_Word Globals_9,
  MR_String Prefix_27,
...
backend_libs__compile_target_code__IntroducedFrom__pred__compile_csharp_file__700__1_3_p_0(
  MR_Word ModuleName_26,
  MR_Word LambdaHeadVar__1_76,
  MR_Word * LambdaHeadVar__2_77);

static MR_Word MR_CALL 
backend_libs__compile_target_code__IntroducedFrom__func__compile_csharp_file__690__1_1_f_0(
  MR_String LambdaHeadVar__1_67);

static MR_bool MR_CALL 
backend_libs__compile_target_code__IntroducedFrom__pred__compile_java_files__604__1_2_p_0(
  ...
  MR_Word * Result_14)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_10, (MR_Integer) 620, &MaybeStdLibDir_16);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 650, &MkInit_24);
  backend_libs__compile_target_code__make_init_target_file_13_p_0(Globals_10, ProgressStream_9, MkInit_24, ModuleName_12, ModuleNames_13, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[1])), (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[3])), StdInitFileNames_21, StdTraceInitFileNames_22, SourceDebugInitFileNames_23, &MaybeInitTargetFile_25);
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_10, (MR_String) "predicate \140backend_libs.compile_target_code.make_init_obj_file\'/8", (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[8])), ModuleName_12, &InitObjFileName_29, &_InitObjFileNameProposed_30);
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 81, &Verbose_82);
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 91, &Stats_83);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  backend_libs__compile_target_code__IntroducedFrom__pred__compile_csharp_file__710__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv3_LambdaHeadVar__2_82);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_18 = backend_libs__compile_target_code__IntroducedFrom__func__referenced_csharp_dlls__749__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = backend_libs__compile_target_code__IntroducedFrom__pred__compile_csharp_file__700__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_77);
  if (succeeded)
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_68 = backend_libs__compile_target_code__IntroducedFrom__func__compile_csharp_file__690__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__compile_target_code__IntroducedFrom__pred__compile_java_files__604__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_12 = backend_libs__compile_target_code__IntroducedFrom__func__get_c_include_dir_flags__1641__1_1_f_0(((MR_String) (wrapper_arg_1)));
