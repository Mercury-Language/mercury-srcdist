                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      libs__globals__set_option_4_p_0((MR_Integer) 647, backend_libs__compile_target_code__V_75_75, backend_libs__compile_target_code__Globals_10, &backend_libs__compile_target_code__NoSubdirGlobals0_32);
                    }
                    {
                      libs__globals__set_option_4_p_0((MR_Integer) 648, backend_libs__compile_target_code__V_75_75, backend_libs__compile_target_code__NoSubdirGlobals0_32, &backend_libs__compile_target_code__NoSubdirGlobals_33);
                    }
                    {
...
{
  {
    ...
    if (backend_libs__compile_target_code__succeeded)
      {
        backend_libs__compile_target_code__V_81_81 = (MR_Integer) 259;
...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(backend_libs__compile_target_code__Globals_1, (MR_Integer) 516, &backend_libs__compile_target_code__V_14_14);
    }
    ...
    if (backend_libs__compile_target_code__succeeded)
    ...
    else
      {
        ...
        {
          libs__globals__lookup_string_option_3_p_0(backend_libs__compile_target_code__Globals_1, (MR_Integer) 517, &backend_libs__compile_target_code__V_15_15);
        }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__set_option_4_p_0((MR_Integer) 647, backend_libs__compile_target_code__V_40_40, backend_libs__compile_target_code__Globals_9, &backend_libs__compile_target_code__NoSubdirGlobals0_19);
          }
          {
            libs__globals__set_option_4_p_0((MR_Integer) 648, backend_libs__compile_target_code__V_40_40, backend_libs__compile_target_code__NoSubdirGlobals0_19, &backend_libs__compile_target_code__NoSubdirGlobals_20);
          }
