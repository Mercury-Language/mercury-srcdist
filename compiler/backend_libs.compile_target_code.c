...
backend_libs__compile_target_code__IntroducedFrom__func__get_link_libraries__2210__1_2_f_0(
...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[28][2];
...
static /* final */ const MR_Box backend_libs__compile_target_code_scalar_common_1[28][2] = {
  ...
  /* row  22 */
  {
    ((MR_Box) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[21]))),
  ...
  MR_Word Stream_8)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_40, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[23])));
  }
  {
  ...
  MR_Word * STATE_VARIABLE_Succeeded_37)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_10_p_0(NoSubDirGlobals_28, (MR_String) "predicate \140backend_libs.compile_target_code.process_link_library\'/8", (MR_Integer) 1, (MR_String) "lib", Var_51, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[12])), LibModuleName_26, &LibFileName_29);
    ...
    if (((MR_tag((MR_Word) MaybeDirName_30)) == (MR_Integer) 1))
    {
      ...
      *LinkerOpt_12 = (MR_String) "";
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_33, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[22])));
      }
      {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_20 = backend_libs__compile_target_code__IntroducedFrom__func__get_link_libraries__2210__1_2_f_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_String BaseName_10)
{
  ...
  else
  {
    ...
    Var_68 = mercury__string__to_upper_1_f_0(BaseName_10);
    {
      ...
      MR_hl_field(1, Var_67, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[24])));
    }
    {
  ...
  MR_String BaseName_10)
{
  ...
  Var_108 = libs__shell_util__quote_shell_cmd_arg_1_f_0(CFileName_35);
  {
    ...
    MR_hl_field(1, Var_111, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__compile_target_code_scalar_common_1[25])));
  }
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_118 = parse_tree__file_names__extension_to_string_3_f_0(Globals_7, Ext_43, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[27])));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_20 = backend_libs__compile_target_code__IntroducedFrom__func__get_link_libraries__2210__1_2_f_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * Result_16)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140backend_libs.compile_target_code.do_make_init_obj_file\'/9", (MR_Integer) 0, Var_77, (MR_Word) (MR_mkword(3, &backend_libs__compile_target_code_scalar_common_1[26])), ModuleName_14, &InitObjFileName_34);
