  ...
  MR_Word * STATE_VARIABLE_Succeeded_37)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__68_68 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
    succeeded = mercury__list__member_2_p_0(TypeCtorInfo__68_68, ((MR_Box) (LibName_11)), MercuryLibs_25);
  }
  if (succeeded)
  {
  ...
  MR_Word * Succeeded_16)
{
  ...
  if (succeeded)
  {
    Var_58 = (MR_Integer) 615;
    libs__globals__lookup_string_option_3_p_0(Globals_10, Var_58, &FilterCmd_55);
  ...
  if (succeeded)
    {
      ...
      MR_hl_field(MR_mktag(1), MaybeFilterCmd_23, 0) = ((MR_Box) (FilterCmd_55));
    }
  else
