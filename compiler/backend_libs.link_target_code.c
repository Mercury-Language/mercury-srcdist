  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 552, &Jar_18);
  ...
  else
  {
    ...
    Stream_25 = ((MR_Word) ((MR_hl_field(0, Var_41, 1))));
    {
      ...
      MR_hl_field(0, Var_42, 0) = ((MR_Box) (&backend_libs__link_target_code_scalar_common_7[0]));
