  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 179, &MakeSharedLib_45);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 590, &PicObjExt_51);
        libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 589, &ObjExt_52);
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_140, 0) = ((MR_Box) (FrameworkDirectoriesOpts_50));
  ...
  MR_String * StdLibs_6)
{
  ...
  else
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 338, &CDebugGrade_15);
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 271, &ProfTime_17);
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 273, &ProfDeep_18);
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 294, &Parallel_20);
          switch (Parallel_20) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
      ...
      case (MR_Integer) 3:
        {
          ...
          backend_libs__link_target_code__link_lib_args_for_c_cs_8_p_0(Globals_4, LinkedTargetType_5, StdLibDir_8, (MR_String) "", LibExt_10, GCGrade_127, &StaticGCLibs_12, &SharedGCLibs_13);
        }
        break;
      case (MR_Integer) 4:
        {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 312, &SourceDebug_34);
    ...
    switch (LinkedTargetType_5) {
      ...
      case (MR_Integer) 4:
        {
          ...
          {
            Var_112 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_112, 0) = ((MR_Box) (StdLib_44));
            MR_hl_field(1, Var_112, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_111, 0) = ((MR_Box) (SharedSourceDebugLibs_42));
            MR_hl_field(1, Var_111, 1) = ((MR_Box) (Var_112));
          }
          {
            Var_110 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_110, 0) = ((MR_Box) (SharedTraceLibs_25));
      ...
      case (MR_Integer) 2:
        {
          MR_String MercuryLinkage_47;

          libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 627, &MercuryLinkage_47);
          succeeded = (strcmp(MercuryLinkage_47, (MR_String) "static") == 0);
          if (succeeded)
          {
            MR_Word Var_93;
            MR_Word Var_94;
          ...
          {
            succeeded = (strcmp(MercuryLinkage_47, (MR_String) "shared") == 0);
            if (succeeded)
            {
              MR_Word Var_100;
              MR_Word Var_101;
            ...
            else
            {
              ...
              Var_107 = mercury__string__f_43_43_2_f_0((MR_String) "unknown mercury_linkage ", MercuryLinkage_47);
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.link_target_code.get_mercury_std_libs_for_c_cs\'/3", Var_107);
                return;
              }
            }
          }
