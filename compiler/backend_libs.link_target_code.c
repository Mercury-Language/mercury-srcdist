  ...
  MR_Word * Specs_8)
{
  ...
  if (succeeded)
  {
    ...
    RpathOpts_16 = (MR_String) "";
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 612, &LinkLibrariesList0_71);
  {
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 338, &CDebugGrade_117);
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 271, &ProfTime_119);
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 273, &ProfDeep_120);
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 294, &Parallel_122);
          switch (Parallel_122) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
