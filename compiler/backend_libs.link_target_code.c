...
static /* final */ const MR_Box backend_libs__link_target_code_scalar_common_1[26][2];
...
static /* final */ const MR_Box backend_libs__link_target_code_scalar_common_1[26][2] = {
  ...
  {
    ((MR_Box) ((MR_String) "-subsystem:console")),
    ((MR_Box) (MR_mkword(1, &backend_libs__link_target_code_scalar_common_1[16])))
  },
  /* row  18 */
  {
    ((MR_Box) ((MR_String) "-ignore:4001")),
  ...
  /* row  25 */
  {
    ((MR_Box) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[24]))),
    ((MR_Box) (MR_mkword(1, &backend_libs__link_target_code_scalar_common_1[23])))
  },
};
...
static /* final */ const struct backend_libs__link_target_code__vector_common_type_3_0_s backend_libs__link_target_code_vector_common_3[10] = {
  /* row   0 */   { (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[21])) },
  /* row   1 */   { (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[21])) },
  /* row   2 */   { (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[21])) },
  /* row   3 */   { (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[22])) },
  /* row   4 */   { (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[22])) },
  ...
  MR_Word * STATE_VARIABLE_Succeeded_41)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__file_names__module_name_to_lib_file_name_full_curdir_8_p_0(Globals_9, (MR_String) "predicate \140backend_libs.link_target_code.get_link_opts_for_library_for_c_cs\'/8", (MR_String) "lib", (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[5])), LibModuleName_28, &_FullLibFileName_29, &_FullLibFileNameProposed_30, &LibFileName_31);
    ...
    if (((MR_tag((MR_Word) MaybeDirName_34)) == (MR_Integer) 1))
    {
      ...
      *LinkerOpt_11 = (MR_String) "";
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_37, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__link_target_code_scalar_common_1[25])));
      }
      {
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 552, &Jar_37);
  ...
  MR_String * ContentStr_6)
{
  ...
  backend_libs__compile_target_code__join_quoted_string_list_5_p_0(AllSearchPaths_10, (MR_String) "", (MR_String) "", (MR_String) ":", &MonoPathDirectories_11);
  {
    ...
    MR_hl_field(1, Var_36, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__link_target_code_scalar_common_1[20])));
  }
  {
            ...
            switch (MR_tag((MR_Word) C_CompilerType_8)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, C_CompilerType_8, 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    backend_libs__compile_target_code__join_string_list_5_p_0((MR_Word) (MR_mkword(1, &backend_libs__link_target_code_scalar_common_1[19])), (MR_String) "", (MR_String) "", (MR_String) " ", RestrictedCmdLinkOpts_6);
                    break;
                  case (MR_Integer) 1:
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_full_curdir_create_dirs_9_p_0(Globals_8, (MR_String) "predicate \140backend_libs.link_target_code.linked_target_file_name_full_curdir\'/7", (MR_Word) (MR_mkword(3, &backend_libs__link_target_code_scalar_common_1[3])), ModuleName_9, FullFileName_11, &_FullFileNameProposed_41, CurDirFileName_12);
      }
      break;
    case (MR_Integer) 6:
      {
