  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 158, &CompileToSharedLib_18);
  ...
  MR_Word * LinkedTargetType_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 158, &MakeSharedLib_5);
