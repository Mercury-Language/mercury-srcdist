  ...
  MR_Word * STATE_VARIABLE_DumpInfo_36)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 188, &DumpHLDSStages_15);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 187, &DumpTraceStages_16);
  libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 197, &UserFileSuffix_17);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 198, &DumpSameHLDS_23);
