...
MR_decl_label8(hlds__passes_aux__process_nonimported_procs_8_0, 43,3,4,5,6,7,10,12)
MR_decl_label8(hlds__passes_aux__process_nonimported_procs_8_0, 14,15,16,17,18,19,20,21)
MR_decl_label8(hlds__passes_aux__process_nonimported_procs_8_0, 22,24,26,27,28,29,8,30)
MR_decl_label6(hlds__passes_aux__process_nonimported_procs_8_0, 31,32,33,34,35,36)
...
MR_decl_label6(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0, 13,3,4,5,6,7)
...
MR_BEGIN_MODULE(hlds__passes_aux_module1)
	...
	MR_init_label8(hlds__passes_aux__process_nonimported_procs_8_0,43,3,4,5,6,7,10,12)
	MR_init_label8(hlds__passes_aux__process_nonimported_procs_8_0,14,15,16,17,18,19,20,21)
	MR_init_label8(hlds__passes_aux__process_nonimported_procs_8_0,22,24,26,27,28,29,8,30)
	MR_init_label6(hlds__passes_aux__process_nonimported_procs_8_0,31,32,33,34,35,36)
MR_BEGIN_CODE
...
MR_def_label(hlds__passes_aux__invoke_system_command_maybe_filter_output_7_0,18)
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,8,1);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const(" > ", 3);
...
#undef	MR_PROC_LABEL
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const("sh -c ", 6);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
...
MR_BEGIN_MODULE(hlds__passes_aux_module40)
	...
	MR_init_label6(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0,13,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_static(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0,7)
	...
	MR_r1 = MR_sv(4);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(hlds__passes_aux__process_nonimported_procs_in_preds__ho5_8_0_i13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
