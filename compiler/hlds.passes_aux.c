...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 68, &Verbose_14);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 181, &DumpHLDSStages_15);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 180, &DumpTraceStages_16);
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 190, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 191, &DumpSameHLDS_23);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 68, &Verbose_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 78, &Stats_10);
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_58);
    hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_59);
    libs__globals__get_progress_output_stream_5_p_0(Globals_58, ModuleName_59, &ProgressStream_11);
    switch (Verbose_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    if (((MR_tag((MR_Word) DumpFileResult_12)) == (MR_Integer) 1))
    {
      ...
      hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_66);
      hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_67);
      libs__globals__get_error_output_stream_5_p_0(Globals_66, ModuleName_67, &ErrorStream_15);
      Var_37 = mercury__io__error_message_1_f_0(IOError_14);
      Var_50 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_37);
      Var_51 = mercury__string__f_43_43_2_f_0(DumpFile_5, Var_50);
      Msg_16 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open file \140", Var_51);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 78, &Statistics_7);
    switch (Statistics_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 69, &VeryVerbose_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 69, &VeryVerbose_11);
