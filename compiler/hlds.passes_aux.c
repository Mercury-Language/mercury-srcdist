                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      mercury__builtin__compare_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_3[0]), &SubResult1_16, ((MR_Box) (ArgX1_14)), ((MR_Box) (ArgY1_15)));
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 75, &Verbose_16);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 212, &DumpHLDSStages_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 211, &DumpTraceStages_18);
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 222, &UserFileSuffix_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 223, &DumpSameHLDS_26);
  ...
  MR_String HLDSStr_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 75, &Verbose_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 85, &Stats_13);
  switch (Verbose_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word HLDS_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 85, &Statistics_7);
  switch (Statistics_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word PredProcId_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 76, &VeryVerbose_13);
