  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 192, &DumpHLDSStages_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 191, &DumpTraceStages_18);
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 201, &UserFileSuffix_19);
  ...
  if (succeeded)
  {
    ...
    Var_49 = mercury__string__f_43_43_2_f_0(StageName_12, UserFileSuffix_19);
    Var_47 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_49);
    Var_46 = mercury__string__f_43_43_2_f_0(StageNumStr_20, Var_47);
    Var_44 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_46);
    DumpFileName_22 = mercury__string__f_43_43_2_f_0(BaseFileName_21, Var_44);
    succeeded = (STATE_VARIABLE_DumpInfo_0_36 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      PrevDumpFileName_23 = ((MR_String) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_36, (MR_Integer) 0))));
      PrevHLDS_24 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_36, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 202, &DumpSameHLDS_25);
        ...
        case (MR_Integer) 0:
          {
            ...
            *STATE_VARIABLE_DumpInfo_37 = STATE_VARIABLE_DumpInfo_0_36;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            if (((MR_tag((MR_Word) Res_28)) == (MR_Integer) 1))
            {
              ...
              Var_108 = mercury__string__f_43_43_2_f_0(IOErrorMsg_31, (MR_String) "\n");
              Var_110 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_108);
              Var_111 = mercury__string__f_43_43_2_f_0(DumpFileName_22, Var_110);
              Msg_32 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open file \140", Var_111);
              hlds__passes_aux__get_error_output_stream_4_p_0(HLDS_10, &ErrorStream_33);
              libs__file_util__report_error_4_p_0(ErrorStream_33, Msg_32);
            }
            else
            {
            ...
            }
            {
              ...
              *STATE_VARIABLE_DumpInfo_37 = base;
    ...
    {
      hlds__passes_aux__dump_hlds_4_p_0(DumpFileName_22, HLDS_10);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_DumpInfo_37 = base;
  ...
  else
  {
    ...
    if (succeeded)
    {
      MR_Word MaybeTraceCountsError_34;
      MR_String Var_79;
      MR_String Var_81;
      MR_String Var_83;
      MR_String Var_84;
      MR_String Var_86;
      MR_String BaseFileName_101;
      MR_String DumpFileName_102;

      hlds__hlds_module__module_info_get_dump_hlds_base_file_name_2_p_0(HLDS_10, &BaseFileName_101);
      Var_79 = mercury__string__det_remove_suffix_2_f_0(BaseFileName_101, (MR_String) ".hlds_dump");
      Var_86 = mercury__string__f_43_43_2_f_0(StageName_12, UserFileSuffix_19);
      Var_84 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_86);
      Var_83 = mercury__string__f_43_43_2_f_0(StageNumStr_20, Var_84);
      Var_81 = mercury__string__f_43_43_2_f_0((MR_String) ".trace_counts.", Var_83);
      DumpFileName_102 = mercury__string__f_43_43_2_f_0(Var_79, Var_81);
      mercury__benchmarking__write_out_trace_counts_4_p_0(DumpFileName_102, &MaybeTraceCountsError_34);
      if ((MaybeTraceCountsError_34 == (MR_Word) ((MR_Unsigned) 0U)))
        switch (Verbose_16) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__io__write_string_4_p_0(ProgressStream_9, DumpFileName_102);
      ...
      {
        MR_String TraceCountsError_35 = ((MR_String) ((MR_hl_field(1, MaybeTraceCountsError_34, (MR_Integer) 0))));

        mercury__io__write_string_4_p_0(ProgressStream_9, (MR_String) "% ");
        mercury__io__write_string_4_p_0(ProgressStream_9, TraceCountsError_35);
        mercury__io__write_string_4_p_0(ProgressStream_9, (MR_String) "\n");
        mercury__io__flush_output_3_p_0(ProgressStream_9);
      }
    }
  ...
  MR_Word HLDS_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 72, &Verbose_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 82, &Stats_10);
  ...
  {
    MR_Word IOError_14 = ((MR_Word) ((MR_hl_field(1, DumpFileResult_12, (MR_Integer) 0))));
    ...
    Var_42 = mercury__io__error_message_1_f_0(IOError_14);
    Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_42);
  ...
  {
    MR_Word DumpFileStream_13 = ((MR_Word) ((MR_hl_field(0, DumpFileResult_12, (MR_Integer) 0))));
...
void MR_CALL 
hlds__passes_aux__maybe_write_proc_progress_message_5_p_0(
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__get_progress_output_stream_5_p_0(Globals_10, ModuleName_12, &ProgressStream_13);
        ProcStr_14 = hlds__hlds_out__hlds_out_util__pred_proc_id_to_user_string_2_f_0(ModuleInfo_6, PredProcId_8);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) "% ");
        mercury__io__write_string_4_p_0(ProgressStream_13, Message_7);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) " ");
        mercury__io__write_string_4_p_0(ProgressStream_13, ProcStr_14);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) "\n");
...
void MR_CALL 
hlds__passes_aux__maybe_write_pred_progress_message_5_p_0(
  MR_Word ModuleInfo_6,
  MR_String Message_7,
  MR_Word PredId_8)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_6, &ModuleName_12);
        libs__globals__get_progress_output_stream_5_p_0(Globals_10, ModuleName_12, &ProgressStream_13);
        PredStr_14 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(ModuleInfo_6, PredId_8);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) "% ");
        mercury__io__write_string_4_p_0(ProgressStream_13, Message_7);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) " ");
        mercury__io__write_string_4_p_0(ProgressStream_13, PredStr_14);
        mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) "\n");
        mercury__io__flush_output_3_p_0(ProgressStream_13);
      }
      break;
