  ...
  MR_Word HLDS_6)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_53);
  hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_54);
  libs__globals__get_progress_output_stream_5_p_0(Globals_53, ModuleName_54, &ProgressStream_11);
  switch (Verbose_9) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  if (((MR_tag((MR_Word) DumpFileResult_12)) == (MR_Integer) 1))
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_55);
    hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_56);
    libs__globals__get_error_output_stream_5_p_0(Globals_55, ModuleName_56, &ErrorStream_15);
