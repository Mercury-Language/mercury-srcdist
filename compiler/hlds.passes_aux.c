  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 133, &Verbose_16);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 704, &DumpHLDSStages_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 719, &DumpTraceStages_18);
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 714, &UserFileSuffix_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      PrevHLDSDumpFileName_24 = ((MR_String) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_37, 0))));
      PrevHLDSStr_25 = ((MR_String) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_37, 1))));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 715, &DumpSameHLDS_26);
  ...
  if (succeeded)
  {
    ...
    {
      MR_String TraceCountsError_36 = ((MR_String) ((MR_hl_field(1, MaybeTraceCountsError_35, 0))));
  ...
  MR_String HLDSStr_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 133, &Verbose_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 135, &Stats_13);
  switch (Verbose_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word HLDS_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 135, &Statistics_7);
  switch (Statistics_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word PredProcId_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 134, &VeryVerbose_13);
