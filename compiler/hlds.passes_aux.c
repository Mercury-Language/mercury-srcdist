  ...
  MR_Word * STATE_VARIABLE_DumpInfo_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 72, &Verbose_14);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 189, &DumpHLDSStages_15);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 188, &DumpTraceStages_16);
  libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 198, &UserFileSuffix_17);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 199, &DumpSameHLDS_23);
  ...
  MR_Word HLDS_6)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_57);
  hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_58);
  libs__globals__get_progress_output_stream_5_p_0(Globals_57, ModuleName_58, &ProgressStream_11);
  switch (Verbose_9) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  if (((MR_tag((MR_Word) DumpFileResult_12)) == (MR_Integer) 1))
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_64);
    hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_65);
    libs__globals__get_error_output_stream_5_p_0(Globals_64, ModuleName_65, &ErrorStream_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_4, &Globals_82);
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_4, &ModuleName_83);
        libs__globals__get_debug_output_stream_5_p_0(Globals_82, ModuleName_83, &Stream_15);
        hlds__hlds_module__module_info_get_pred_id_table_2_p_0(HLDS_4, &PredIdTable_16);
        Var_26 = mercury__map__count_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_16);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "Pred table size = ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_26, &Var_47);
        mercury__io__write_string_4_p_0(Stream_15, Var_47);
        ...
        Var_32 = mercury__list__length_1_f_0((MR_Word) (&hlds__passes_aux_scalar_common_2[0]), TypeCtorDefns_18);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "Type table size = ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_32, &Var_58);
        mercury__io__write_string_4_p_0(Stream_15, Var_58);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "\n");
        ...
        Var_38 = mercury__list__length_1_f_0((MR_Word) (&hlds__passes_aux_scalar_common_2[1]), CtorDefns_20);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "Constructor table size = ");
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_38, &Var_69);
        mercury__io__write_string_4_p_0(Stream_15, Var_69);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "\n");
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        ProcStr_16 = hlds__hlds_out__hlds_out_util__pred_proc_id_pair_to_user_string_3_f_0(ModuleInfo_7, PredId_9, ProcId_10);
        mercury__io__write_string_4_p_0(Stream_15, (MR_String) "% ");
