...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if ((MaybeTraceCountsError_30 == (MR_Word) ((MR_Integer) 0)))
        {
...
{
  {
    ...
    if ((MaybeContext_11 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Word ArgModes_3)
{
  switch (HeadVar__1_1) {
    ...
    case (MR_Integer) 1:
      {
        ...
        if (!((FuncArgModes_27 == (MR_Word) ((MR_Integer) 0))))
        {
          mercury__io__write_string_3_p_0((MR_String) "(");
    ...
    case (MR_Integer) 0:
      {
        mercury__io__write_string_3_p_0(HeadVar__2_2);
        if (!((ArgModes_3 == (MR_Word) ((MR_Integer) 0))))
        {
