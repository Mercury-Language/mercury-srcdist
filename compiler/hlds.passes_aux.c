      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_module__module_info_get_pred_id_table_2_p_0(HLDS_4, &PredIdTable_17);
          Var_27 = mercury__map__count_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_17);
