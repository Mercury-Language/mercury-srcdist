...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 179, &DumpHLDSStages_15);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 178, &DumpTraceStages_16);
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 188, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 189, &DumpSameHLDS_23);
