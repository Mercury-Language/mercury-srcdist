...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 161, &DumpHLDSStages_15);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 160, &DumpTraceStages_16);
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 168, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 169, &DumpSameHLDS_23);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 58, &Verbose_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 68, &Stats_10);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 68, &Statistics_7);
    switch (Statistics_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 59, &VeryVerbose_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 59, &VeryVerbose_11);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      TypeCtorInfo_54_54 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
      TypeCtorInfo_55_55 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__map__lookup_3_p_0(TypeCtorInfo_54_54, TypeCtorInfo_55_55, Procs0_21, ((MR_Box) (ProcId_15)), &conv1_Proc0_22);
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_54_54, TypeCtorInfo_55_55, ((MR_Box) (ProcId_15)), ((MR_Box) (Proc_25)), Procs8_30, &Procs_31);
  ...
  MR_Word * STATE_VARIABLE_PredInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0(TypeCtorInfo_31_31, TypeCtorInfo_32_32, ProcMap0_19, ((MR_Box) (ProcId_16)), &conv0_Proc0_20);
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_31_31, TypeCtorInfo_32_32, ((MR_Box) (ProcId_16)), ((MR_Box) (Proc_23)), ProcMap0_19, &ProcMap_24);
