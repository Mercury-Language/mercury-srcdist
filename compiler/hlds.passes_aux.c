  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 193, &DumpHLDSStages_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 192, &DumpTraceStages_18);
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 203, &UserFileSuffix_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 204, &DumpSameHLDS_25);
