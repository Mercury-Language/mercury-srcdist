  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 207, &DumpSameHLDS_26);
  ...
  MR_String HLDSStr_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 83, &Stats_13);
  switch (Verbose_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
