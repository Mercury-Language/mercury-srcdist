...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(hlds__passes_aux__Globals_13, (MR_Integer) 158, &hlds__passes_aux__DumpHLDSStages_15);
    }
    {
      libs__globals__lookup_accumulating_option_3_p_0(hlds__passes_aux__Globals_13, (MR_Integer) 157, &hlds__passes_aux__DumpTraceStages_16);
    }
    {
      libs__globals__lookup_string_option_3_p_0(hlds__passes_aux__Globals_13, (MR_Integer) 165, &hlds__passes_aux__UserFileSuffix_17);
    }
    {
        ...
        if (hlds__passes_aux__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(hlds__passes_aux__Globals_13, (MR_Integer) 166, &hlds__passes_aux__DumpSameHLDS_23);
            }
