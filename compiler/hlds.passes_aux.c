...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 177, &DumpHLDSStages_15);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 176, &DumpTraceStages_16);
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 186, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 187, &DumpSameHLDS_23);
...
{
  {
    ...
    {
      MR_Word IOError_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Res_11, (MR_Integer) 0))));
      MR_String Msg_14;
      MR_String Var_29;
      MR_String Var_30;
      MR_String Var_32;
      ...
      libs__file_util__maybe_write_string_4_p_0(Verbose_9, (MR_String) "\n");
      Var_32 = mercury__io__error_message_1_f_0(IOError_13);
      Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_32);
      Var_29 = mercury__string__f_43_43_2_f_0(DumpFile_5, Var_30);
      Msg_14 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open file \140", Var_29);
      libs__file_util__report_error_3_p_0(Msg_14);
    }
    else
    {
      MR_Word FileStream_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Res_11, (MR_Integer) 0))));

      hlds__hlds_out__hlds_out_module__write_hlds_5_p_0(FileStream_12, (MR_Integer) 0, HLDS_6);
...
{
  {
    ...
    parse_tree__prog_out__write_context_to_cur_stream_3_p_0(OutContext_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word StrippedArgModes_28;
        MR_Word FuncArgModes_29;
        MR_Word FuncRetMode_30;
        MR_Word Stream_31;
        MR_Box conv0_FuncRetMode_30;

        mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), &InstVarSet_27);
        parse_tree__prog_mode__strip_builtin_qualifiers_from_mode_list_2_p_0(ArgModes_3, &StrippedArgModes_28);
        parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), StrippedArgModes_28, &FuncArgModes_29, &conv0_FuncRetMode_30);
        FuncRetMode_30 = ((MR_Word) (conv0_FuncRetMode_30));
        mercury__io__write_string_3_p_0(HeadVar__2_2);
        mercury__io__output_stream_3_p_0(&Stream_31);
        if (!((FuncArgModes_29 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          mercury__io__write_string_3_p_0((MR_String) "(");
          parse_tree__parse_tree_out_inst__mercury_output_mode_list_6_p_0(Stream_31, (MR_Integer) 1, InstVarSet_27, FuncArgModes_29);
          mercury__io__write_string_3_p_0((MR_String) ")");
        }
        mercury__io__write_string_3_p_0((MR_String) " = ");
        parse_tree__parse_tree_out_inst__mercury_output_mode_6_p_0(Stream_31, (MR_Integer) 1, InstVarSet_27, FuncRetMode_30);
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        if (!((ArgModes_3 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          mercury__io__output_stream_3_p_0(&Stream_13);
          parse_tree__parse_tree_out_inst__mercury_output_mode_list_6_p_0(Stream_13, (MR_Integer) 1, InstVarSet_11, StrippedArgModes_12);
          mercury__io__write_string_3_p_0((MR_String) ")");
        }
      }
      break;
      ...
      case (MR_Integer) 1:
        {
          ...
          ProcStr_14 = hlds__hlds_out__hlds_out_util__pred_proc_id_pair_to_string_3_f_0(ModuleInfo_10, PredId_8, ProcId_9);
          mercury__io__write_string_3_p_0(Message_7);
          mercury__io__write_string_3_p_0(ProcStr_14);
          mercury__io__write_string_3_p_0((MR_String) "\n");
        }
        break;
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          PredStr_12 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(ModuleInfo_8, PredId_7);
          mercury__io__write_string_3_p_0(Message_6);
          mercury__io__write_string_3_p_0(PredStr_12);
          mercury__io__write_string_3_p_0((MR_String) "\n");
        }
        break;
    }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__passes_aux__seq_process_valid_nonimported_procs_6_p_0(PredId_12, ProcIds_18, STATE_VARIABLE_Task_0_2, &STATE_VARIABLE_Task_23_23, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_24_24);
