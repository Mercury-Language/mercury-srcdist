  ...
  MR_Word * STATE_VARIABLE_DumpInfo_36)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 190, &DumpHLDSStages_15);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 189, &DumpTraceStages_16);
  libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 199, &UserFileSuffix_17);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      PrevDumpFileName_21 = ((MR_String) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_35, (MR_Integer) 0))));
      PrevHLDS_22 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_DumpInfo_0_35, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 200, &DumpSameHLDS_23);
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              MR_Word IOError_29 = ((MR_Word) ((MR_hl_field(1, Res_27, (MR_Integer) 0))));
            ...
            }
            {
              ...
              *STATE_VARIABLE_DumpInfo_36 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (PrevDumpFileName_21));
              MR_hl_field(1, base, 1) = ((MR_Box) (HLDS_8));
            }
          }
          break;
      }
    ...
    else
    {
      hlds__passes_aux__dump_hlds_4_p_0(DumpFileName_20, HLDS_8);
      {
        ...
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_DumpInfo_36 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (DumpFileName_20));
        MR_hl_field(1, base, 1) = ((MR_Box) (HLDS_8));
      }
    }
  }
