  ...
  MR_Word HLDS_6)
{
  ...
  if (((MR_tag((MR_Word) DumpFileResult_12)) == (MR_Integer) 1))
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_6, &Globals_65);
    hlds__hlds_module__module_info_get_name_2_p_0(HLDS_6, &ModuleName_66);
    libs__globals__get_error_output_stream_5_p_0(Globals_65, ModuleName_66, &ErrorStream_15);
