...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 170, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 171, &DumpSameHLDS_23);
