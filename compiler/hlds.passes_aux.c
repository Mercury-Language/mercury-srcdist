...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 178, &DumpHLDSStages_15);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 177, &DumpTraceStages_16);
    libs__globals__lookup_string_option_3_p_0(Globals_13, (MR_Integer) 187, &UserFileSuffix_17);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 188, &DumpSameHLDS_23);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 66, &Verbose_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 76, &Stats_10);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 76, &Statistics_7);
    switch (Statistics_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_27, &Var_48);
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_33, &Var_59);
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__passes_aux_scalar_common_9[1]), Var_39, &Var_70);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 67, &VeryVerbose_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 67, &VeryVerbose_11);
