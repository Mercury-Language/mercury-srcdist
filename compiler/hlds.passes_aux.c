  ...
  MR_Word * STATE_VARIABLE_DumpInfo_36)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 734, &DumpHLDSStages_17);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 749, &DumpTraceStages_18);
  libs__globals__lookup_string_option_3_p_0(Globals_15, (MR_Integer) 744, &UserFileSuffix_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 745, &DumpSameHLDS_26);
