  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_Task_0_2 = STATE_VARIABLE_Task_23_23;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_Task_0_3 = STATE_VARIABLE_Task_41_41;
      next_value_of_STATE_VARIABLE_ModuleInfo_0_5 = STATE_VARIABLE_ModuleInfo_44_44;
