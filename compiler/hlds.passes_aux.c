...
{
  {
    ...
    mercury__list__length_2_p_0(TypeCtorInfo_32_32, ArgModes0_19, &NumArgModes_20);
    NumToDrop_21 = (MR_Integer) ((MR_Unsigned) NumArgModes_20 - (MR_Unsigned) Arity_17);
    mercury__list__det_drop_3_p_0(TypeCtorInfo_32_32, NumToDrop_21, ArgModes0_19, &ArgModes_22);
