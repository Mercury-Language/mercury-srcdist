...
{
  {
    ...
    libs__rat__write_rat_4_p_0(Stream_6, Rat_4);
  }
}

void MR_CALL 
libs__rat__write_rat_4_p_0(
  MR_Word Stream_5,
  MR_Word HeadVar__2_2)
{
  {
    MR_Integer Numerator_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
    MR_Integer Denominator_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))));
    MR_String Var_21;
    MR_String Var_31;

    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "r(");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&libs__rat_scalar_common_2[0]), Numerator_6, &Var_21);
    mercury__io__write_string_4_p_0(Stream_5, Var_21);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) ", ");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&libs__rat_scalar_common_2[0]), Denominator_7, &Var_31);
      ...
      if (succeeded)
        {
          ...
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = ((MR_Box) (Numer_8));
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) ((MR_Integer) 1));
        }
      else
      {
        MR_Integer G_27;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        {
          HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = ((MR_Box) (Num_4));
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) ((MR_Integer) 1));
        }
      else
      {
