...
{
  {
    ...
    if (succeeded)
    {
      ...
      conv0_Var_6 = mercury__require__unexpected_3_f_0((MR_Word) (&libs__rat__libs__rat__type_ctor_info_rat_0), (MR_String) "libs.rat", (MR_String) "function \140libs.rat.reciprocal\'/1", (MR_String) "division by zero");
    ...
    else
    {
      ...
      Var_12 = (MR_Integer) ((MR_Unsigned) Var_13 * (MR_Unsigned) Den_8);
      Var_14 = mercury__int__abs_1_f_0(Num_7);
      {
        Var_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_6, 0) = ((MR_Box) (Var_12));
        MR_hl_field(MR_mktag(0), Var_6, 1) = ((MR_Box) (Var_14));
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        HeadVar__3_3 = (MR_Word) (&libs__rat_scalar_common_1[0]);
      }
      else
      {
        MR_Integer G_27;
        ...
        Var_40 = mercury__int__abs_1_f_0(Numer_8);
        Var_41 = mercury__int__abs_1_f_0(Denom_9);
        G_27 = libs__rat__gcd_2_2_f_0(Var_40, Var_41);
        succeeded = (Denom_9 == (MR_Integer) 0);
        if (succeeded)
          Var_35 = (MR_Integer) 0;
        else
        ...
        Num2_28 = (MR_Integer) ((MR_Unsigned) Numer_8 * (MR_Unsigned) Var_35);
        Den2_29 = mercury__int__abs_1_f_0(Denom_9);
        Var_36 = mercury__int__f_47_47_2_f_0(Num2_28, G_27);
        Var_37 = mercury__int__f_47_47_2_f_0(Den2_29, G_27);
        {
          HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = ((MR_Box) (Var_36));
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) (Var_37));
        }
      }
    }
    return HeadVar__3_3;
...
{
  {
    ...
    MR_Integer Num_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Y_5, (MR_Integer) 0))));
    MR_Integer Den_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Y_5, (MR_Integer) 1))));
    MR_Integer Var_9 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Num_7);
...
{
  {
    ...
    MR_Integer Num_3 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0))));
    MR_Integer Den_4 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1))));
    MR_Integer Var_5 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Num_3);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_22 = mercury__int__abs_1_f_0(Num_4);
        Var_23 = mercury__int__abs_1_f_0(Den_5);
        G_9 = libs__rat__gcd_2_2_f_0(Var_22, Var_23);
        ...
        Num2_10 = (MR_Integer) ((MR_Unsigned) Num_4 * (MR_Unsigned) Var_17);
        Den2_11 = mercury__int__abs_1_f_0(Den_5);
        Var_18 = mercury__int__f_47_47_2_f_0(Num2_10, G_9);
        Var_19 = mercury__int__f_47_47_2_f_0(Den2_11, G_9);
        {
          HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = ((MR_Box) (Var_18));
          MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) (Var_19));
        }
      }
    }
    return HeadVar__3_3;
...
{
  {
    ...
    MR_Integer Var_15 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Num_13);
    MR_Integer Var_17;
    MR_Integer Var_16;
    ...
    Var_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Diff_9, (MR_Integer) 1))));
    ...
    else
    {
      ...
      MR_Integer Var_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Diff_9, (MR_Integer) 1))));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_40 = mercury__int__abs_1_f_0(M_9);
        G_26 = libs__rat__gcd_2_2_f_0(Var_39, Var_40);
        succeeded = (M_9 == (MR_Integer) 0);
        if (succeeded)
          Var_34 = (MR_Integer) 0;
        else
        ...
        Num2_27 = (MR_Integer) ((MR_Unsigned) Numer_8 * (MR_Unsigned) Var_34);
        Den2_28 = mercury__int__abs_1_f_0(M_9);
        Var_35 = mercury__int__f_47_47_2_f_0(Num2_27, G_26);
        Var_36 = mercury__int__f_47_47_2_f_0(Den2_28, G_26);
        {
          HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
