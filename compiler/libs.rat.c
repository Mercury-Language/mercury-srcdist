...
{
  {
    ...
    if (libs__rat__succeeded)
      *libs__rat__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer libs__rat__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer libs__rat__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer libs__rat__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer libs__rat__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word libs__rat__Var_8;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&libs__rat__Var_8, libs__rat__Var_4, libs__rat__Var_6);
        }
        ...
        if (libs__rat__succeeded)
          *libs__rat__HeadVar__1_1 = libs__rat__Var_8;
          ...
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(libs__rat__HeadVar__1_1, libs__rat__Var_5, libs__rat__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (libs__rat__succeeded)
    ...
    else
      {
        ...
        MR_Integer libs__rat__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer libs__rat__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), libs__rat__HeadVar__2_2, (MR_Integer) 1)));

        libs__rat__succeeded = (libs__rat__Var_3 == libs__rat__Var_5);
        if (libs__rat__succeeded)
          libs__rat__succeeded = (libs__rat__Var_4 == libs__rat__Var_6);
      }
    return libs__rat__succeeded;
  }
}
