  ...
  MR_Word * STATE_VARIABLE_RI_10)
{
  ...
  else
  {
    ...
    ModuleInfo0_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_9, (MR_Integer) 0)));
    Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_9, (MR_Integer) 1)));
    hlds__instmap__bind_var_to_functors_8_p_0(HeadVar__2_2, Type_34, MainConsId_31, OtherConsIds_32, HeadVar__6_6, &InstMap1_35, ModuleInfo0_58, &ModuleInfo_59);
    Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_9, (MR_Integer) 0)));
    Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_9, (MR_Integer) 1)));
    {
      STATE_VARIABLE_RI_41_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_41_41, 0) = ((MR_Box) (ModuleInfo_59));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_41_41, 1) = ((MR_Box) (Var_63));
    }
    ...
    ModuleInfo0_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_42_42, (MR_Integer) 0)));
    Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_42_42, (MR_Integer) 1)));
    hlds__instmap__instmap_delta_bind_var_to_functors_9_p_0(HeadVar__2_2, Type_34, MainConsId_31, OtherConsIds_32, HeadVar__6_6, InstMapDelta0_37, &InstMapDelta_28, ModuleInfo0_70, &ModuleInfo_71);
    Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_42_42, (MR_Integer) 0)));
    Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_42_42, (MR_Integer) 1)));
    {
      STATE_VARIABLE_RI_44_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_44_44, 0) = ((MR_Box) (ModuleInfo_71));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_44_44, 1) = ((MR_Box) (Var_75));
    }
    {
          ...
          case (MR_Integer) 3:
            {
              ...
              succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo_13, (MR_Integer) 15);
              if (succeeded)
              {
      ...
      else
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            ...
            MR_Word next_value_of_HeadVar__4_4 = Insts_48;
            MR_Word next_value_of_STATE_VARIABLE_Sub_0_5 = STATE_VARIABLE_Sub_62_62;
            MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_7 = STATE_VARIABLE_ModuleInfo_61_61;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Type_8 = ArgType_14;
          MR_Word next_value_of_ContainingTypes_9 = Var_20;
          MR_Word next_value_of_InitialInst_10 = InitialArgInst_17;
          MR_Word next_value_of_FinalInst_11 = FinalArgInst_18;
            ...
            case (MR_Integer) 4:
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_Inst_6 = NamedInst_10;
            ...
            case (MR_Integer) 4:
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_Inst0_9 = NamedInst_44;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = Mode_26;
