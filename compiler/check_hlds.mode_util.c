...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&check_hlds__mode_util_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeParams_19, TypeArgs_13, &ArgSubst_30);
        ...
        check_hlds__mode_util__propagate_ctor_info_into_bound_functors_7_p_0(ModuleInfo_5, ArgSubst_30, TypeCtor_12, TypeModule_14, Constructors_31, BoundInsts0_11, &BoundInsts1_32);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&check_hlds__mode_util_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (check_hlds__mode_util__propagate_ctor_info_into_bound_inst_4_p_0_1));
        ...
        check_hlds__mode_util__construct_new_bound_inst_5_p_0(Uniq_9, InstResults0_10, (MR_Word) ((MR_Unsigned) 0U), BoundInsts_40, Inst_8);
      }
      else
      {
        MR_Word Var_38;
        ...
        if (succeeded)
        {
          ...
          mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), (MR_Word) (&check_hlds__mode_util_scalar_common_2[1]), BoundInsts0_11, &BoundInsts_42);
          check_hlds__mode_util__construct_new_bound_inst_5_p_0(Uniq_9, InstResults0_10, (MR_Word) ((MR_Unsigned) 0U), BoundInsts_42, Inst_8);
        }
        else
          *Inst_8 = Inst0_7;
      }
