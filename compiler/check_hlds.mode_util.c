...
MR_def_label(check_hlds__mode_util__recompute_instmap_delta_2_9_0,13)
	...
	MR_sv(9) = ((MR_Integer) MR_tfield(2, MR_tempr1, 0) & (MR_Integer) 3);
...
MR_def_label(check_hlds__mode_util__recompute_instmap_delta_2_9_0,19)
	...
	MR_tfield(2, MR_r2, 0) = ((MR_Integer) MR_sv(9) | (((MR_Integer) MR_sv(10) << (MR_Integer) 2) | ((MR_Integer) MR_sv(11) << (MR_Integer) 3)));
