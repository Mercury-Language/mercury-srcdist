            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_60, (MR_Integer) 5)));
                MR_Word Var_75;
                ...
                check_hlds__mode_util__recompute_instmap_delta_1_8_p_0(RecomputeAtomic_10, Goal0_71, &Goal_74, VarTypes_14, InstMap_73, &Var_75, STATE_VARIABLE_RI_0_105, &STATE_VARIABLE_RI_118_118);
                {
                  ...
                  MR_hl_field(MR_mktag(2), RHS_64, 5) = (MR_Box) (packed_args_1);
                  ...
                  {
                    {
                      ...
                      MR_hl_field(MR_mktag(1), InstResults_37, 4) = ((MR_Box) ((MR_Unsigned) 0U));
