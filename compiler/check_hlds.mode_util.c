    ...
    switch (MR_tag((MR_Word) check_hlds__mode_util__ConsId_6)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__mode_util__ConsId_6, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 4:
            {
              MR_Word check_hlds__mode_util__PredProcId_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__mode_util__ConsId_6, (MR_Integer) 1)));
              MR_Word check_hlds__mode_util__PredInfo_21;
              MR_Word check_hlds__mode_util__ProcInfo_22;
              MR_Word check_hlds__mode_util__PorF_23;
              MR_Word check_hlds__mode_util__Det_24;
              MR_Word check_hlds__mode_util__ProcArgModes_25;
              MR_Word check_hlds__mode_util__Modes_26;
              MR_Word check_hlds__mode_util__Inst_27;
              MR_Word check_hlds__mode_util__Var_46;
              MR_Word check_hlds__mode_util__Var_48;
              MR_Word check_hlds__mode_util__Var_49;

              {
                check_hlds__mode_util__Var_46 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(check_hlds__mode_util__PredProcId_19);
              }
              {
                hlds__hlds_module__module_info_pred_proc_info_4_p_0(check_hlds__mode_util__ModuleInfo_5, check_hlds__mode_util__Var_46, &check_hlds__mode_util__PredInfo_21, &check_hlds__mode_util__ProcInfo_22);
              }
              {
                check_hlds__mode_util__PorF_23 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(check_hlds__mode_util__PredInfo_21);
              }
              {
                hlds__hlds_pred__proc_info_interface_determinism_2_p_0(check_hlds__mode_util__ProcInfo_22, &check_hlds__mode_util__Det_24);
              }
              {
                hlds__hlds_pred__proc_info_get_argmodes_2_p_0(check_hlds__mode_util__ProcInfo_22, &check_hlds__mode_util__ProcArgModes_25);
              }
              {
                mercury__list__det_drop_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0, check_hlds__mode_util__NumArgs_7, check_hlds__mode_util__ProcArgModes_25, &check_hlds__mode_util__Modes_26);
              }
              {
                check_hlds__mode_util__Var_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_49, 0) = ((MR_Box) (check_hlds__mode_util__PorF_23));
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_49, 1) = ((MR_Box) (check_hlds__mode_util__Modes_26));
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_49, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_49, 3) = ((MR_Box) (check_hlds__mode_util__Det_24));
              }
              check_hlds__mode_util__Var_48 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) check_hlds__mode_util__Var_49);
              {
                check_hlds__mode_util__Inst_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Inst_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Inst_27, 1) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Inst_27, 2) = ((MR_Box) (check_hlds__mode_util__Var_48));
              }
              {
                ...
                MR_hl_field(MR_mktag(1), check_hlds__mode_util__MaybeInst_8, 0) = ((MR_Box) (check_hlds__mode_util__Inst_27));
              }
            }
            break;
          case (MR_Integer) 5:
          ...
          case (MR_Integer) 9:
            {
              ...
              {
                check_hlds__mode_util__Var_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_58, 0) = ((MR_Box) (check_hlds__mode_util__ConsId_6));
                MR_hl_field(MR_mktag(0), check_hlds__mode_util__Var_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                check_hlds__mode_util__Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__mode_util__Var_57, 0) = ((MR_Box) (check_hlds__mode_util__Var_58));
                MR_hl_field(MR_mktag(1), check_hlds__mode_util__Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                check_hlds__mode_util__Var_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Var_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Var_54, 1) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Var_54, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                MR_hl_field(MR_mktag(3), check_hlds__mode_util__Var_54, 3) = ((MR_Box) (check_hlds__mode_util__Var_57));
              }
              {
                check_hlds__mode_util__MaybeInst_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), check_hlds__mode_util__MaybeInst_8, 0) = ((MR_Box) (check_hlds__mode_util__Var_54));
              }
            }
            break;
          case (MR_Integer) 10:
