          ...
          case (MR_Integer) 4:
            {
              ...
              else
              {
                ...
                check_hlds__mode_util__recompute_instmap_delta_cases_10_p_0(RecomputeAtomic_9, Var_18, Cases0_20, &Cases_21, VarTypes_12, InstMap0_13, NonLocals0_23, &InstMapDelta1_22, STATE_VARIABLE_RI_0_112, STATE_VARIABLE_RI_113);
              }
              {
  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_15, ((MR_Box) (Var_27)), &conv0_HLDS_Mode0_16);
      if (succeeded)
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_33_33 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
