...
{
  {
    ...
    check_hlds__mode_util__IntroducedFrom__pred__recompute_instmap_delta_unify__1847__1_2_p_0(((MR_Word) wrapper_arg_1), &conv0_LambdaHeadVar__2_65);
          ...
          case (MR_Integer) 17:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (ConsId_6));
                MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
              ...
              {
                Var_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Var_62, 1) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Var_62, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                MR_hl_field(MR_mktag(3), Var_62, 3) = ((MR_Box) (Var_65));
              }
              {
                MaybeInst_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), MaybeInst_8, 0) = ((MR_Box) (Var_62));
              }
            }
            break;
          case (MR_Integer) 18:
