  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word InitInstX_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_21, (MR_Integer) 0))));
      MR_Word FinalInstX_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_21, (MR_Integer) 1))));
      MR_Word InitInstY_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FromToInstsY_16, (MR_Integer) 0))));
      MR_Word FinalInstY_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FromToInstsY_16, (MR_Integer) 1))));

      {
        UnifyMode_18 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), UnifyMode_18, 0) = ((MR_Box) (InitInstX_22));
        MR_hl_field(MR_mktag(0), UnifyMode_18, 1) = ((MR_Box) (FinalInstX_23));
        MR_hl_field(MR_mktag(0), UnifyMode_18, 2) = ((MR_Box) (InitInstY_24));
        MR_hl_field(MR_mktag(0), UnifyMode_18, 3) = ((MR_Box) (FinalInstY_25));
      }
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__31_31 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
          TypeCtorInfo__32_32 = (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0);
          {
          ...
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo__31_31, TypeCtorInfo__32_32, ModeDefns_13, ((MR_Box) (Var_27)), &conv1_HLDS_Mode_15);
          if (succeeded)
          {
