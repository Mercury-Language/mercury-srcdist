...
ifeq ($(TARGET_ASM),yes)
parse_tree.java_names.mh parse_tree.java_names.mih : parse_tree.java_names.s
else
parse_tree.java_names.mh parse_tree.java_names.mih : parse_tree.java_names.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.java_names.module_dep : parse_tree.java_names.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.java_names.module_dep : parse_tree.java_names.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.java_names.module_dep : mercury/parse_tree_/java_names.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.java_names.s_date : java_names.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.java_names $(ERR_REDIRECT)
parse_tree.java_names.pic_s_date : java_names.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.java_names $(ERR_REDIRECT)
endif # TARGET_ASM
