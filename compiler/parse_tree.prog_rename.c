      ...
      else
      {
        ...
        else
        {
          ...
          parse_tree__prog_rename__rename_vars_in_term_list_4_p_2(TypeInfo_for_V_40, Must_5, Renaming_6, OtherArgTerms0_20, &OtherArgTerms_22);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (Arg3Term_21));
            MR_hl_field(MR_mktag(1), Var_32, 1) = ((MR_Box) (OtherArgTerms_22));
          }
          {
            Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Arg2Term_38));
            MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (Var_32));
          }
          {
            Args_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Args_14, 0) = ((MR_Box) (Arg1Term_36));
            MR_hl_field(MR_mktag(1), Args_14, 1) = ((MR_Box) (Var_31));
          }
        }
      }
    }
