  ...
  MR_Integer * HeadVar__4_4)
{
  ...
  else
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BlockInfo_13, (MR_Integer) 4)));
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BlockInfo_17, (MR_Integer) 4)));
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NextBlockInfo_18, (MR_Integer) 4)));
