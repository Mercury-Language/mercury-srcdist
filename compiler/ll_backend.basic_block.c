    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word next_value_of_HeadVar__1_1 = Var_60;
            MR_Word next_value_of_STATE_VARIABLE_BlockMap_0_3 = STATE_VARIABLE_BlockMap_59_59;
  ...
  MR_Integer * STATE_VARIABLE_N_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Xs_13;
        MR_Word next_value_of_STATE_VARIABLE_List_0_2 = STATE_VARIABLE_List_20_20;
        MR_Integer next_value_of_STATE_VARIABLE_N_0_4 = STATE_VARIABLE_N_21_21;
        ...
        else
        {
          ...
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              ...
              MR_Word next_value_of_STATE_VARIABLE_RevBlockInstrs_0_2 = STATE_VARIABLE_RevBlockInstrs_19_19;
