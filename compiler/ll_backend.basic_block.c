...
MR_decl_label9(__Compare___ll_backend__basic_block__block_info_0_0, 3,2,5,9,13,17,21,25,82)
...
MR_CTOR0_ADDR(ll_backend__llds, label),
MR_CTOR0_ADDR(ll_backend__basic_block, block_info)
}
},
};
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,10)
	...
	MR_sv(12) = MR_tfield(0, MR_r1, 2);
	MR_sv(13) = MR_tfield(0, MR_r1, 3);
	MR_sv(14) = MR_tfield(0, MR_r1, 4);
	MR_sv(15) = MR_tfield(0, MR_r1, 5);
	MR_sv(16) = MR_tfield(0, MR_r1, 6);
	MR_r1 = MR_tempr1;
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,14)
	...
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 5);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(2,2);
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(17) = MR_r1;
	MR_sv(18) = ((MR_Integer) MR_sv(18) + (MR_Integer) MR_sv(13));
	MR_r1 = MR_sv(19);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(15);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
...
MR_def_label(ll_backend__basic_block__flatten_basic_blocks_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = ((MR_Integer) MR_sv(2) + (MR_Integer) MR_sv(1));
...
MR_BEGIN_MODULE(ll_backend__basic_block_module6)
	...
	MR_init_label9(__Compare___ll_backend__basic_block__block_info_0_0,3,2,5,9,13,17,21,25,82)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i82);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(7);
...
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__basic_block__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__basic_block);
