...
MR_decl_label8(ll_backend__basic_block__build_block_map_10_0, 4,6,7,9,11,13,14,15)
MR_decl_label8(ll_backend__basic_block__build_block_map_10_0, 30,17,10,21,22,25,26,3)
MR_decl_label4(ll_backend__basic_block__create_basic_blocks_8_0, 2,3,4,5)
MR_decl_label8(ll_backend__basic_block__extend_basic_blocks_5_0, 35,7,9,10,11,12,13,14)
MR_decl_label8(ll_backend__basic_block__extend_basic_blocks_5_0, 15,16,17,18,4,5,20,3)
MR_decl_label3(ll_backend__basic_block__flatten_basic_blocks_3_0, 4,5,3)
MR_decl_label5(ll_backend__basic_block__take_until_end_of_block_3_0, 27,4,7,6,9)
MR_decl_label5(__Unify___ll_backend__basic_block__block_info_0_0, 2,4,6,8,1)
MR_decl_label6(__Compare___ll_backend__basic_block__block_info_0_0, 3,7,11,15,19,27)
...
MR_decl_static(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__210__1_2_0)
...
MR_BEGIN_MODULE(ll_backend__basic_block_module0)
	...
	MR_init_label5(ll_backend__basic_block__take_until_end_of_block_3_0,27,4,7,6,9)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__basic_block__take_until_end_of_block_3_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__basic_block__take_until_end_of_block_3_0_i27);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__basic_block__take_until_end_of_block_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(ll_backend__basic_block__take_until_end_of_block_3_0,6)
	...
	MR_np_localcall_lab(ll_backend__basic_block__take_until_end_of_block_3_0,
		ll_backend__basic_block__take_until_end_of_block_3_0_i9);
MR_def_label(ll_backend__basic_block__take_until_end_of_block_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__basic_block_module1)
	...
	MR_init_label8(ll_backend__basic_block__build_block_map_10_0,4,6,7,9,11,13,14,15)
	MR_init_label8(ll_backend__basic_block__build_block_map_10_0,30,17,10,21,22,25,26,3)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__basic_block__build_block_map_10_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i3);
	}
	MR_incr_sp(11);
	...
	MR_np_call_localret_ent(ll_backend__basic_block__take_until_end_of_block_3_0,
		ll_backend__basic_block__build_block_map_10_0_i9);
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,6)
	...
	MR_np_call_localret_ent(svset__insert_3_0,
		ll_backend__basic_block__build_block_map_10_0_i7);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(ll_backend__basic_block__take_until_end_of_block_3_0,
		ll_backend__basic_block__build_block_map_10_0_i9);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = MR_r2;
	...
	MR_np_call_localret_ent(list__last_2_0,
		ll_backend__basic_block__build_block_map_10_0_i11);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i10);
	}
	MR_sv(8) = MR_ctfield(0, MR_r2, 0);
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(ll_backend__opt_util__possible_targets_3_0,
		ll_backend__basic_block__build_block_map_10_0_i13);
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,14)
	...
	MR_np_localcall_lab(ll_backend__basic_block__build_block_map_10_0,
		ll_backend__basic_block__build_block_map_10_0_i15);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i17);
	}
MR_def_label(ll_backend__basic_block__build_block_map_10_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i25);
	}
MR_def_label(ll_backend__basic_block__build_block_map_10_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i30);
	}
	{
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(2);
	MR_r3 = (MR_Integer) 1;
	...
	MR_r6 = MR_sv(10);
	MR_np_localcall_lab(ll_backend__basic_block__build_block_map_10_0,
		ll_backend__basic_block__build_block_map_10_0_i21);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__basic_block__build_block_map_10_0_i22);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r4;
	MR_np_call_localret_ent(map__det_insert_4_0,
		ll_backend__basic_block__build_block_map_10_0_i26);
MR_def_label(ll_backend__basic_block__build_block_map_10_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__basic_block__build_block_map_10_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
...
MR_BEGIN_MODULE(ll_backend__basic_block_module2)
	...
	MR_init_label4(ll_backend__basic_block__create_basic_blocks_8_0,2,3,4,5)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__basic_block__create_basic_blocks_8_0,2)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__basic_block__create_basic_blocks_8_0_i3);
MR_def_label(ll_backend__basic_block__create_basic_blocks_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, label);
...
MR_BEGIN_MODULE(ll_backend__basic_block_module3)
	...
	MR_init_label8(ll_backend__basic_block__extend_basic_blocks_5_0,35,7,9,10,11,12,13,14)
	MR_init_label8(ll_backend__basic_block__extend_basic_blocks_5_0,15,16,17,18,4,5,20,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__210__1_2_0);
	...
	MR_sv(15) = MR_ctfield(0, MR_r1, 4);
	MR_sv(16) = MR_ctfield(0, MR_r1, 5);
	MR_r1 = MR_tempr1;
	...
	MR_np_call_localret_ent(libs__compiler_util__expect_3_0,
		ll_backend__basic_block__extend_basic_blocks_5_0_i11);
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 5);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(0,1);
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__212__1_2_0);
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,12)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__214__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
	...
	MR_np_call_localret_ent(libs__compiler_util__expect_3_0,
		ll_backend__basic_block__extend_basic_blocks_5_0_i13);
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 5);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_COMMON(0,3);
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__216__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_r1, 3) = MR_sv(14);
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,14)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ll_backend__basic_block__extend_basic_blocks_5_0_i15);
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, label);
	MR_r2 = MR_sv(10);
	MR_r3 = MR_sv(15);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ll_backend__basic_block__extend_basic_blocks_5_0_i16);
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,17)
	...
	MR_np_call_localret_ent(svmap__delete_3_0,
		ll_backend__basic_block__extend_basic_blocks_5_0_i18);
MR_def_label(ll_backend__basic_block__extend_basic_blocks_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_GOTO_LAB(ll_backend__basic_block__extend_basic_blocks_5_0_i35);
	}
...
MR_BEGIN_MODULE(ll_backend__basic_block_module4)
	...
	MR_init_label3(ll_backend__basic_block__flatten_basic_blocks_3_0,4,5,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__basic_block__flatten_basic_blocks_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__basic_block__flatten_basic_blocks_3_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(ll_backend__basic_block__flatten_basic_blocks_3_0,5)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_ctfield(0, MR_r1, 2);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_r3 = MR_sv(1);
...
MR_def_label(ll_backend__basic_block__flatten_basic_blocks_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__basic_block_module5)
	...
	MR_init_label5(__Unify___ll_backend__basic_block__block_info_0_0,2,4,6,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ll_backend__basic_block__block_info_0_0);
	...
	MR_np_call_localret_ent(__Unify___ll_backend__llds__label_0_0,
		__Unify___ll_backend__basic_block__block_info_0_0_i2);
MR_def_label(__Unify___ll_backend__basic_block__block_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(ll_backend__basic_block_module6)
	...
	MR_init_label6(__Compare___ll_backend__basic_block__block_info_0_0,3,7,11,15,19,27)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___ll_backend__basic_block__block_info_0_0);
	...
	MR_np_call_localret_ent(__Compare___ll_backend__llds__label_0_0,
		__Compare___ll_backend__basic_block__block_info_0_0_i3);
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(__Compare___ll_backend__llds__instruction_0_0,
		__Compare___ll_backend__basic_block__block_info_0_0_i7);
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___ll_backend__basic_block__block_info_0_0_i11);
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i27);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___ll_backend__basic_block__block_info_0_0_i15);
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i27);
	}
	...
	MR_r3 = MR_sv(9);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___ll_backend__basic_block__block_info_0_0_i19);
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__basic_block__block_info_0_0_i27);
	}
...
MR_def_label(__Compare___ll_backend__basic_block__block_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__basic_block_module9)
	MR_init_entry1(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__210__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__basic_block__IntroducedFrom__pred__extend_basic_blocks__210__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
void mercury__ll_backend__basic_block__write_out_proc_statics(FILE *fp);
#endif
