  ...
  MR_Word * STATE_VARIABLE_C_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word X_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RevBlockInstrs_36, (MR_Integer) 0))));
      MR_Word Xs_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RevBlockInstrs_36, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_List_20_83;
      MR_Word _SideCodeAddrs_47;

      {
        STATE_VARIABLE_List_20_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_List_20_83, 0) = ((MR_Box) (X_77));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_List_20_83, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      ll_backend__basic_block__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_114_101_118_101_114_115_101_95_97_110_100_95_99_111_117_110_116_95_108_105_115_116_95_95_91_49_93_95_48_5_p_0(Xs_78, STATE_VARIABLE_List_20_83, &BlockInstrs_42, (MR_Integer) ((MR_Unsigned) 0 + (MR_Unsigned) 1), &NumBlockInstrs_43);
      LastUinstr_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), X_77, (MR_Integer) 0))));
    ...
    switch (NextFallInto_39) {
      ...
      case (MR_Integer) 1:
        ...
        {
          MR_Word NextLabel_71 = ((MR_Word) ((MR_hl_field(MR_mktag(1), LabelSeq1_38, (MR_Integer) 0))));

          {
            MaybeFallThrough_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeFallThrough_48, 0) = ((MR_Box) (NextLabel_71));
          }
        }
        break;
    }
