  ...
  MR_Integer * HeadVar__4_4)
{
  ...
  else
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BlockInfo_13, (MR_Integer) 4)));
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BlockInfo_17, (MR_Integer) 4)));
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NextBlockInfo_18, (MR_Integer) 4)));
        ...
        Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), BlockSideLabels_24, NextBlockSideLabels_31);
        {
          ...
          MR_hl_field(MR_mktag(0), NewBlockInfo_33, 4) = (MR_Box) (packed_args_0);
