...
MR_decl_label5(ll_backend__delay_slot__fill_branch_delay_slot_2_0, 60,15,16,4,17)
...
MR_BEGIN_MODULE(ll_backend__delay_slot_module0)
	...
	MR_init_label5(ll_backend__delay_slot__fill_branch_delay_slot_2_0,60,15,16,4,17)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__delay_slot__fill_branch_delay_slot_2_0);
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__delay_slot__fill_branch_delay_slot_2_0_i60);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__delay_slot__fill_branch_delay_slot_2_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
