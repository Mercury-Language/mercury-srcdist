...
MR_def_label(ll_backend__delay_slot__fill_branch_delay_slot_2_0,68)
	...
	MR_r2 = MR_tempr1;
	MR_sv(1) = MR_tfield(1, MR_tempr9, 0);
	...
	MR_tempr4 = MR_tfield(0, MR_tfield(1, MR_tempr1, 0), 0);
	if (MR_RTAGS_TESTR(MR_tempr4,3,9)) {
		MR_GOTO_LAB(ll_backend__delay_slot__fill_branch_delay_slot_2_0_i4);
	}
	MR_tempr4 = MR_tfield(0, MR_tfield(1, MR_tempr2, 0), 0);
	...
	MR_tempr8 = MR_tfield(3, MR_tempr4, 1);
	MR_tempr4 = MR_tfield(3, MR_tempr7, 1);
	if ((MR_tempr8 != MR_tempr4)) {
		MR_GOTO_LAB(ll_backend__delay_slot__fill_branch_delay_slot_2_0_i4);
	}
	MR_tempr4 = MR_tfield(3, MR_tempr6, 2);
