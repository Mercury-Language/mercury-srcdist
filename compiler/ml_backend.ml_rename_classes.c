  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&ml_backend__ml_rename_classes_scalar_common_1[0]);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo__48_48 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo__48_48, TypeCtorInfo__48_48, RenamingMap_16, ((MR_Box) (ClassName0_15)), &conv0_ClassName_17);
          if (succeeded)
          {
