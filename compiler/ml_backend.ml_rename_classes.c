...
{
  {
    ...
    MR_Word Var_25;
    MR_Word Var_26;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn0_5, (MR_Integer) 4)));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_Stmt_0_56, (MR_Integer) 0)));
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          {
            MaybeElse_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word Rval_89;
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Stmt_0_56, (MR_Integer) 5)));
            ...
            mercury__list__map_3_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), Var_66, RetLvals0_39, &RetLvals_47);
            {
              ...
              *STATE_VARIABLE_Stmt_57 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 5) = (MR_Box) (packed_args_0);
  ...
  MR_Word * STATE_VARIABLE_Stmt_34)
{
  switch (MR_tag((MR_Word) STATE_VARIABLE_Stmt_0_33)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_Stmt_0_33, (MR_Integer) 0)))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word Var_37;
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Stmt_0_33, (MR_Integer) 3)));
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Stmt_0_33, (MR_Integer) 8)));
            ...
            mercury__list__map_3_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_typed_rval_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_typed_rval_0), Var_37, ArgRvalsTypes0_16, &ArgRvalsTypes_21);
            {
              ...
              *STATE_VARIABLE_Stmt_34 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 8) = (MR_Box) (packed_args_2);
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Stmt_0_33, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Rval_27)
{
  switch (MR_tag((MR_Word) STATE_VARIABLE_Rval_0_26)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_Rval_0_26, (MR_Integer) 0)))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word Rval_5;
                  ...
                  case (MR_Integer) 14:
                    {
                      ...
                      MR_Word Type_61;
                      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), RvalConst0_10, (MR_Integer) 1)));
                      ...
                      ml_backend__ml_rename_classes__rename_class_names_in_type_3_p_0(Renaming_4, Type0_60, &Type_61);
                      {
                        ...
                        MR_hl_field(MR_mktag(3), RvalConst_11, 1) = (MR_Box) (packed_args_0);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (((MR_tag((MR_Word) FieldId0_9)) == (MR_Integer) 1))
        {
          ...
          {
            FieldId_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          {
            FieldId_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassId0_9, (MR_Integer) 2)));
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName0_10, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), QualClassName_18, 1) = (MR_Box) (packed_args_1);
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), ClassId_19, 2) = (MR_Box) (packed_args_0);
            }
