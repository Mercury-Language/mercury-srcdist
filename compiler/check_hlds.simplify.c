...
MR_decl_static(check_hlds__simplify__IntroducedFrom__pred__create_test_unification__3509__1_2_0)
...
{
MR_COMMON(4,0),
MR_ENTRY_AP(check_hlds__simplify__IntroducedFrom__pred__create_test_unification__3509__1_2_0),
0
},
{
MR_COMMON(4,1),
...
MR_BEGIN_MODULE(check_hlds__simplify_module131)
	MR_init_entry1(check_hlds__simplify__IntroducedFrom__pred__create_test_unification__3509__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__simplify__IntroducedFrom__pred__create_test_unification__3509__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__create_test_unification__3509__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__simplify__IntroducedFrom__pred__create_test_unification__3509__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 0);
