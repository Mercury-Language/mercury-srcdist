...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_opt_duplicate_calls_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 8);
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_common_struct_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 10);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_warn_simple_code_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 0);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_elim_removable_scopes_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 7);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_info_set_rerun_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 17);
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_once_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 4);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_excess_assign_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 6);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_info_do_add_error_spec_3_0);
	...
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 17);
...
MR_define_entry(mercury__check_hlds__simplify__simplify_info_incr_cost_delta_3_0);
	...
	MR_tfield(0, MR_tempr1, 8) = MR_tfield(0, MR_r2, 8);
	MR_tfield(0, MR_tempr1, 9) = MR_tfield(0, MR_r2, 9);
	MR_tfield(0, MR_tempr1, 10) = ((MR_Integer) MR_tfield(0, MR_r2, 10) + (MR_Integer) MR_r1);
	MR_tfield(0, MR_tempr1, 11) = MR_tfield(0, MR_r2, 11);
	MR_tfield(0, MR_tempr1, 12) = MR_tfield(0, MR_r2, 12);
	MR_tfield(0, MR_tempr1, 13) = MR_tfield(0, MR_r2, 13);
	MR_tfield(0, MR_tempr1, 14) = MR_tfield(0, MR_r2, 14);
...
MR_def_label(check_hlds__simplify__simplify_goal_generic_call_6_0,45)
	...
	MR_r4 = MR_tfield(2, MR_r1, 3);
	MR_r9 = MR_tfield(2, MR_r1, 2);
	MR_r10 = MR_tfield(2, MR_r1, 1);
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(check_hlds__simplify__simplify_goal_generic_call_6_0_i7);
	}
	MR_tempr4 = MR_r3;
	MR_tempr1 = MR_tfield(0, MR_tfield(0, MR_tempr4, 2), 8);
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(check_hlds__simplify__simplify_goal_generic_call_6_0_i7);
	}
	MR_sv(1) = MR_r2;
...
MR_def_label(check_hlds__simplify__inequality_goal_10_0,53)
	...
	MR_tfield(0, MR_tempr5, 4) = (MR_Word) MR_TAG_COMMON(0,1,4);
	MR_r1 = MR_sv(7);
	}
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_warn_obsolete_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 3);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_const_prop_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 9);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(check_hlds__simplify__simplify_library_call_int_arity2_8_0,33)
	...
	MR_tfield(1, MR_tempr2, 3) = (MR_Integer) 0;
...
MR_def_static(check_hlds__simplify__simplify_info_leave_lambda_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = ((MR_Integer) MR_tfield(0, MR_r1, 11) - (MR_Integer) 1);
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_after_front_end_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 5);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__check_hlds__simplify__simplify_do_extra_common_struct_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 11);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(check_hlds__simplify__simplify_goal_parallel_conj_6_0,16)
	...
	MR_tfield(0, MR_tempr2, 15) = MR_tfield(0, MR_r2, 15);
...
MR_def_label(check_hlds__simplify__simplify_proc_return_msgs_8_0,103)
	...
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,1,48);
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
...
MR_define_entry(mercury__fn__check_hlds__simplify__simplifications_to_list_1_0);
	...
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_r4 = MR_tfield(0, MR_r1, 11);
	MR_r5 = MR_tfield(0, MR_r1, 10);
	MR_r6 = MR_tfield(0, MR_r1, 9);
	MR_r7 = MR_tfield(0, MR_r1, 8);
	MR_r8 = MR_tfield(0, MR_r1, 7);
	MR_r9 = MR_tfield(0, MR_r1, 6);
	MR_r10 = MR_tfield(0, MR_r1, 5);
	MR_r11 = MR_tfield(0, MR_r1, 4);
	MR_r12 = MR_tfield(0, MR_r1, 3);
	MR_r13 = MR_tfield(0, MR_r1, 2);
	MR_r14 = MR_tfield(0, MR_r1, 1);
	MR_r15 = MR_tfield(0, MR_r1, 0);
...
MR_def_label(f_99_104_101_99_107_95_104_108_100_115_95_95_115_105_109_112_108_105_102_121_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_115_105_109_112_108_105_102_121_95_108_105_98_114_97_114_121_95_99_97_108_108_95_95_91_51_93_95_48_11_0,15)
	...
	MR_tfield(0, MR_r2, 4) = (MR_Word) MR_TAG_COMMON(0,1,55);
	MR_r3 = MR_sv(4);
	MR_r4 = MR_sv(5);
	MR_succip_word = MR_sv(11);
	MR_decr_sp(11);
