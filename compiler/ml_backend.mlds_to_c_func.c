  ...
  MR_Word FunctionDefn_12)
{
  ...
  Access_46 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_47 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_48) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  succeeded = (Access_46 == (MR_Integer) 1);
  if (succeeded)
  {
  ...
  MR_Word OutputSuffix_20)
{
  ...
  else
  {
    ...
    Var_95 = (MR_Integer) ((MR_Unsigned) Indent_14 + (MR_Unsigned) 1);
    {
      Var_93 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_93, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_ho_11_p_0_3));
      MR_hl_field(MR_mktag(0), Var_93, 2) = ((MR_Box) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_93, 3) = ((MR_Box) (Opts_12));
      MR_hl_field(MR_mktag(0), Var_93, 4) = ((MR_Box) (OutputPrefix_19));
      MR_hl_field(MR_mktag(0), Var_93, 5) = ((MR_Box) (OutputSuffix_20));
      MR_hl_field(MR_mktag(0), Var_93, 6) = ((MR_Box) (Var_95));
      MR_hl_field(MR_mktag(0), Var_93, 7) = ((MR_Box) (Context_16));
    }
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_93, (MR_String) ",\n", Parameters_29, Stream_13);
  }
  ...
  MR_Word FunctionDefn_12)
{
  ...
  MR_Word Var_26 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  MR_Word Access_48;
  MR_Word PerInstance_49;
  MR_Word Comments_50;

  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_26, Context_15);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
  Access_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_50 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  succeeded = (Access_48 == (MR_Integer) 1);
  if (succeeded)
  {
    succeeded = (MaybeBody_19 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
