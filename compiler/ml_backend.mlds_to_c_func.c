  ...
  MR_Word FunctionDefn_12)
{
  ...
  Access_52 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_54) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word FunctionBody_16)
{
  ...
  ml_backend__mlds_to_c_func__mlds_output_func_decl_ho__ho1_11_p_0(Opts_10, Stream_11, Indent_12, QualFuncName_13, Context_14, (MR_String) "MR_CALL ", Params_15);
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_5[0]));
  ...
  MR_Word Parameters_16)
{
  ...
  else
  {
    ...
    Var_30 = (MR_Integer) ((MR_Unsigned) Indent_14 + (MR_Unsigned) 1);
    {
      Var_27 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_params_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (Opts_10));
      MR_hl_field(MR_mktag(0), Var_27, 4) = ((MR_Box) (OutputPrefix_12));
      MR_hl_field(MR_mktag(0), Var_27, 5) = ((MR_Box) (OutputSuffix_13));
      MR_hl_field(MR_mktag(0), Var_27, 6) = ((MR_Box) (Var_30));
      MR_hl_field(MR_mktag(0), Var_27, 7) = ((MR_Box) (Context_15));
    }
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_27, (MR_String) ",\n", Parameters_16, Stream_11);
  }
  ...
  MR_Word FunctionDefn_12)
{
  ...
  MR_Word Var_26 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
  MR_Word Access_54;
  MR_Word PerInstance_55;
  MR_Word Comments_56;

  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_26, Context_15);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
  Access_54 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  PerInstance_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  Comments_56 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
  switch (Comments_56) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  succeeded = (Access_54 == (MR_Integer) 1);
  if (succeeded)
  {
    succeeded = (MaybeBody_19 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
  ...
  else
  {
    ...
    else
    {
...

      {
        Var_42 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_ho__ho1_11_p_0_3));
        MR_hl_field(MR_mktag(0), Var_42, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_42, 3) = ((MR_Box) (Opts_12));
        MR_hl_field(MR_mktag(0), Var_42, 4) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[2]));
        MR_hl_field(MR_mktag(0), Var_42, 5) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[3]));
      }
      ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), Stream_13, Var_42, RetTypes_23);
    }
  }
  ...
  MR_Word Parameters_16)
{
  ...
  else
  {
    ...
    Var_30 = (MR_Integer) ((MR_Unsigned) Indent_14 + (MR_Unsigned) 1);
    {
      Var_27 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_params__ho2_9_p_0_3));
      MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (Opts_10));
      MR_hl_field(MR_mktag(0), Var_27, 4) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_27, 5) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[1]));
      MR_hl_field(MR_mktag(0), Var_27, 6) = ((MR_Box) (Var_30));
      MR_hl_field(MR_mktag(0), Var_27, 7) = ((MR_Box) (Context_15));
    }
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_27, (MR_String) ",\n", Parameters_16, Stream_11);
