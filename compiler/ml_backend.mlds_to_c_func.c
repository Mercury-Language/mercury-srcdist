...
{
  {
    ...
    if (((((MR_tag((MR_Word) Type_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_8, (MR_Integer) 0))) == (MR_Integer) 0))))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_23)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_23, (MR_Integer) 0))) == (MR_Integer) 1)));
      if (succeeded)
      {
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) MaybeBody_17)) == (MR_Integer) 1);
      if (succeeded)
      {
      }
    }
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) MaybeBody_8)) == (MR_Integer) 1);
      if (succeeded)
      {
      }
    }
