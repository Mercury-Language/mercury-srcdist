  ...
  MR_Word OutputSuffix_20)
{
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_ho_11_p_0_1));
        MR_hl_field(MR_mktag(0), Var_42, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_42, 3) = ((MR_Box) (Opts_12));
        MR_hl_field(MR_mktag(0), Var_42, 4) = ((MR_Box) (OutputPrefix_19));
        MR_hl_field(MR_mktag(0), Var_42, 5) = ((MR_Box) (OutputSuffix_20));
      }
  ...
  else
  {
    ...
    Var_97 = (MR_Integer) ((MR_Unsigned) Indent_14 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_95, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_95, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_ho_11_p_0_3));
      MR_hl_field(MR_mktag(0), Var_95, 2) = ((MR_Box) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_95, 3) = ((MR_Box) (Opts_12));
      MR_hl_field(MR_mktag(0), Var_95, 4) = ((MR_Box) (OutputPrefix_19));
      MR_hl_field(MR_mktag(0), Var_95, 5) = ((MR_Box) (OutputSuffix_20));
      MR_hl_field(MR_mktag(0), Var_95, 6) = ((MR_Box) (Var_97));
      MR_hl_field(MR_mktag(0), Var_95, 7) = ((MR_Box) (Context_16));
    }
  ...
  MR_Word Signature_14)
{
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_30, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_8_p_0_3));
        MR_hl_field(MR_mktag(0), Var_30, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_30, 3) = ((MR_Box) (Opts_9));
        MR_hl_field(MR_mktag(0), Var_30, 4) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[0]));
        MR_hl_field(MR_mktag(0), Var_30, 5) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[1]));
      }
  ...
  else
  {
    ...
    Var_71 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_69, 1) = ((MR_Box) (ml_backend__mlds_to_c_func__mlds_output_func_decl_8_p_0_7));
      MR_hl_field(MR_mktag(0), Var_69, 2) = ((MR_Box) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_69, 3) = ((MR_Box) (Opts_9));
      MR_hl_field(MR_mktag(0), Var_69, 4) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[3]));
      MR_hl_field(MR_mktag(0), Var_69, 5) = ((MR_Box) (&ml_backend__mlds_to_c_func_scalar_common_3[4]));
      MR_hl_field(MR_mktag(0), Var_69, 6) = ((MR_Box) (Var_71));
      MR_hl_field(MR_mktag(0), Var_69, 7) = ((MR_Box) (Context_13));
    }
