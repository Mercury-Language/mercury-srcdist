...
transform_hlds.lco.optdate transform_hlds.lco.trans_opt_date lco.err transform_hlds.lco.c_date transform_hlds.lco.java_date : lco.m \
	transform_hlds.int0 \
	assoc_list.int \
	bag.int \
	bool.int \
...
#   long deps
#   short deps
transform_hlds.lco.optdate transform_hlds.lco.trans_opt_date lco.err transform_hlds.lco.c_date transform_hlds.lco.java_date : \
		lco.m \
	\
		transform_hlds.int0 \
	\
...
transform_hlds.lco.pic_o transform_hlds.lco.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	bag.mih \
...
transform_hlds.lco.mh transform_hlds.lco.mih : transform_hlds.lco.c
...
transform_hlds.lco.module_dep : jmercury/transform_hlds__lco.java
else
transform_hlds.lco.module_dep : transform_hlds.lco.c
endif
...
transform_hlds.lco.date transform_hlds.lco.date0 \
	transform_hlds.date : lco.m \
	transform_hlds.int0 \
	assoc_list.int3 \
	bag.int3 \
	bool.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.lco.date transform_hlds.lco.date0 transform_hlds.date : \
		lco.m \
	\
		transform_hlds.int0 \
	\
...
transform_hlds.lco.date0 \
	transform_hlds.date0 : lco.m \
	assoc_list.int3 \
	bag.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.lco.date0 transform_hlds.date0 : \
		lco.m \
	\
		assoc_list.int3 \
		bag.int3 \
...
transform_hlds.lco.int0 : transform_hlds.lco.date0
	@:
transform_hlds.lco.int : transform_hlds.lco.date
	@:
transform_hlds.lco.int2 : transform_hlds.lco.date
	@:
transform_hlds.lco.int3 : transform_hlds.lco.date3
	@:
transform_hlds.lco.opt : transform_hlds.lco.optdate
	@:
transform_hlds.lco.trans_opt : transform_hlds.lco.trans_opt_date
	@:
...
transform_hlds.lco.date0 : lco.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) transform_hlds.lco
transform_hlds.lco.date : lco.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) transform_hlds.lco
transform_hlds.lco.date3 : lco.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) transform_hlds.lco
transform_hlds.lco.optdate : lco.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) transform_hlds.lco
transform_hlds.lco.trans_opt_date : lco.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) transform_hlds.lco
transform_hlds.lco.c_date : lco.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) transform_hlds.lco $(ERR_REDIRECT)
transform_hlds.lco.java_date : lco.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only transform_hlds.lco $(ERR_REDIRECT)
