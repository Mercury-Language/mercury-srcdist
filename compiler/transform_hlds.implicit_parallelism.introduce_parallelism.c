          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), transform_hlds__implicit_parallelism__introduce_parallelism__V_64_64, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), transform_hlds__implicit_parallelism__introduce_parallelism__V_20_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), transform_hlds__implicit_parallelism__introduce_parallelism__V_22_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
    ...
    if (transform_hlds__implicit_parallelism__introduce_parallelism__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__implicit_parallelism__introduce_parallelism__V_40_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 16))));
