      ...
      case (MR_Integer) 2:
        {
          ...
          *Goal_18 = Goal0_17;
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_88, 0) = ((MR_Box) (Context_59));
...
{
  {
    ...
    {
      Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (Context_15));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (Context_59));
...
{
  {
    ...
    else
    {
      ...
      {
        Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (Context_20));
        MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[21])));
      }
      {
        Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (Var_44));
