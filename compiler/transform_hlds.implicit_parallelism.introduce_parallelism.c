      ...
      case (MR_Integer) 2:
        {
          ...
          *Goal_18 = Goal0_17;
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_12, &Context_59);
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 80U));
...
{
  {
    ...
    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_5, &Context_15);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_8, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_14, &Context_59);
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 80U));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_40, 2) = ((MR_Box) ((MR_Unsigned) 80U));
