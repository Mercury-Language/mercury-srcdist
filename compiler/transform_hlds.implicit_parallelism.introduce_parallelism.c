...
{
  {
    ...
    {
      ProgRepInfo_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ProgRepInfo_30, 0) = ((MR_Box) (*STATE_VARIABLE_ModuleInfo_37));
      MR_hl_field(MR_mktag(0), ProgRepInfo_30, 1) = ((MR_Box) (FileName_24));
      MR_hl_field(MR_mktag(0), ProgRepInfo_30, 2) = ((MR_Box) (VarTypes_25));
      MR_hl_field(MR_mktag(0), ProgRepInfo_30, 3) = ((MR_Box) (VarNumMap_29));
      MR_hl_field(MR_mktag(0), ProgRepInfo_30, 4) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)));
    }
