          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), transform_hlds__implicit_parallelism__introduce_parallelism__Var_64, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), transform_hlds__implicit_parallelism__introduce_parallelism__Var_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
