      ...
      case (MR_Integer) 1:
        {
          ...
          FileName_52 = mercury__term_context__context_file_1_f_0(Context_51);
          hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_39_61, &VarTable_53);
