  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_40_40, &VarSet_25, &VarTypes_26);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_40_40, &HeadVars_28);
  ll_backend__stack_layout__compute_var_number_map_5_p_0(HeadVars_28, VarSet_25, (MR_Word) ((MR_Unsigned) 0U), Goal0_22, &VarNumMap_29);
  {
    ...
    MR_hl_field(MR_mktag(0), ProgRepInfo_30, 2) = ((MR_Box) (VarTypes_26));
