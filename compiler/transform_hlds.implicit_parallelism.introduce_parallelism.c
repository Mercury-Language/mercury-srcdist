...
transform_hlds__implicit_parallelism__introduce_parallelism__IntroducedFrom__func__maybe_parallelise_conj__360__1_1_f_0(
...
static void MR_CALL 
transform_hlds__implicit_parallelism__introduce_parallelism__apply_implicit_parallelism_transformation_4_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3,
...
static MR_bool MR_CALL 
transform_hlds__implicit_parallelism__introduce_parallelism__apply_implicit_parallelism_transformation_4_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
static /* final */ const MR_Box transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[23][2];

static /* final */ const MR_Box transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_3[1][1];
...
static /* final */ const MR_Box transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[23][2] = {
  ...
  /* row 17 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[16]))),
  ...
  {
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[19])))
  },
  /* row 21 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[13]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[20])))
  },
  /* row 22 */
  {
    ((MR_Box) (&mercury__list__list__type_ctor_info_list_1)),
...
{
  {
    ...
    conv0_LambdaHeadVar__2_35 = transform_hlds__implicit_parallelism__introduce_parallelism__IntroducedFrom__func__maybe_parallelise_conj__360__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Instmap_8)
{
  if ((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_3[0]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_16_29 = (MR_Word) (&transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[22]);
      ...
      case (MR_Integer) 2:
        {
          ...
          *Goal_18 = Goal0_17;
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_64, 0) = ((MR_Box) ((MR_Unsigned) 27U));
          ...
          Var_68 = (MR_Word) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[13]));
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_80, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[15])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[14])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[12])));
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_12, &Context_59);
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 92U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_20, 0) = ((MR_Box) ((MR_Unsigned) 27U));
    ...
    Var_24 = (MR_Word) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[13]));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[15])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[14])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[12])));
    ...
    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_5, &Context_15);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_8, 2) = ((MR_Box) ((MR_Unsigned) 92U));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (Var_66));
              MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_2[21])));
            }
            {
              Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Var_64));
            ...
            hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_14, &Context_59);
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 92U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_13_78 = (MR_Word) (&transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_1[2]);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (transform_hlds__implicit_parallelism__introduce_parallelism__apply_implicit_parallelism_transformation_4_p_0_1));
    ...
    if (succeeded)
    {
      ...
      hlds__pred_table__predicate_table_get_preds_2_p_0(PredTable0_14, &PredMap0_15);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (&transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (transform_hlds__implicit_parallelism__introduce_parallelism__apply_implicit_parallelism_transformation_4_p_0_2));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) ((MR_String) "predicate \140transform_hlds.implicit_parallelism.introduce_parallelism.apply_implicit_parallelism_transformation\'/4"));
        MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Var_40, 2) = ((MR_Box) ((MR_Unsigned) 92U));
