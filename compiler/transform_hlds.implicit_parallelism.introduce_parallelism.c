...
static /* final */ const MR_Box transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_8[5][1];
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *MaybeGoal_12 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_8[4]));
  }
}
...
{
  {
    ...
    if ((MaybeGoalsBefore_17 == (MR_Word) ((MR_Unsigned) 0U)))
      *MaybeParConjunction_12 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_8[1]));
    else
    {
      ...
      if ((MaybeParConjuncts_18 == (MR_Word) ((MR_Unsigned) 0U)))
        *MaybeParConjunction_12 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_8[2]));
      else
      {
        ...
        if ((MaybeGoalsAfter_19 == (MR_Word) ((MR_Unsigned) 0U)))
          *MaybeParConjunction_12 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_8[3]));
        else
        {
