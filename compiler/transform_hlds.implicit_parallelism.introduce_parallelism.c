    ...
    case (MR_Integer) 0:
      {
        ...
        *Goal_18 = Goal0_17;
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_12, &Context_89);
        {
          ...
          MR_hl_field(0, Spec_47, 1) = ((MR_Box) (MR_mkword(2, &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_3[1])));
    ...
    case (MR_Integer) 2:
      {
        ...
        *Goal_18 = Goal0_17;
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_12, &Context_55);
        {
          ...
          MR_hl_field(0, Spec_25, 1) = ((MR_Box) (MR_mkword(2, &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_3[1])));
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_14, &Context_83);
          {
            ...
            MR_hl_field(0, Spec_30, 1) = ((MR_Box) (MR_mkword(2, &transform_hlds__implicit_parallelism__introduce_parallelism_scalar_common_3[1])));
