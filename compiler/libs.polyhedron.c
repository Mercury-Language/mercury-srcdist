...
MR_decl_label5(libs__polyhedron__add_sigma_constraints_3_0, 4,5,8,9,10)
MR_decl_label4(libs__polyhedron__change_var_6_0, 4,2,7,9)
MR_decl_label10(libs__polyhedron__convex_hull_4_0, 66,10,11,12,17,18,19,22,21,41)
MR_decl_label5(libs__polyhedron__convex_hull_4_0, 24,25,26,28,3)
...
MR_decl_label5(libs__polyhedron__make_last_terms_4_0, 3,5,6,9,1)
MR_decl_label4(libs__polyhedron__optimize_3_0, 28,4,7,5)
MR_decl_label5(libs__polyhedron__project_4_0, 35,4,6,8,7)
MR_decl_label6(libs__polyhedron__transform_constraint_7_0, 2,8,9,11,12,13)
MR_decl_label4(libs__polyhedron__transform_polyhedron_5_0, 2,5,8,9)
MR_decl_label2(libs__polyhedron__write_polyhedron_4_0, 3,6)
MR_decl_label1(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0, 3)
MR_decl_label5(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0, 35,4,6,8,7)
MR_decl_label4(fn__libs__polyhedron__add_last_constraints_2_0, 5,7,9,10)
MR_decl_label2(fn__libs__polyhedron__bounding_box_2_0, 16,4)
MR_decl_label2(fn__libs__polyhedron__constraints_1_0, 4,3)
MR_decl_label8(fn__libs__polyhedron__from_constraints_1_0, 42,7,5,9,12,13,14,15)
MR_decl_label1(fn__libs__polyhedron__get_keys_from_map_2_0, 3)
MR_decl_label5(fn__libs__polyhedron__intersection_2_0, 3,28,6,7,8)
MR_decl_label5(fn__libs__polyhedron__make_last_constraint_2_0, 7,9,12,13,1)
...
MR_decl_label3(fn__libs__polyhedron__widen_3_0, 3,10,8)
MR_decl_label2(fn__libs__polyhedron__zero_vars_2_0, 16,4)
MR_decl_label3(__Unify___libs__polyhedron__constr_info_0_0, 5,9,1)
MR_decl_label3(__Unify___libs__polyhedron__convex_hull_result_0_0, 12,5,1)
MR_decl_label4(__Unify___libs__polyhedron__polyhedra_info_0_0, 6,8,12,1)
MR_decl_label3(__Unify___libs__polyhedron__polyhedron_0_0, 12,5,1)
MR_decl_label4(__Compare___libs__polyhedron__constr_info_0_0, 3,2,6,28)
MR_decl_label4(__Compare___libs__polyhedron__convex_hull_result_0_0, 18,7,5,9)
MR_decl_label5(__Compare___libs__polyhedron__polyhedra_info_0_0, 3,2,7,12,41)
...
MR_decl_static(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0)
MR_decl_static(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0)
...
{
MR_COMMON(6,2),
MR_ENTRY_AP(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0),
0
},
{
MR_COMMON(10,0),
...
static const MR_UserClosureId
mercury_data__closure_layout__libs__polyhedron__convex_hull_4_0_2;
static const MR_UserClosureId
...
{
{
(MR_Word *) &mercury_data__closure_layout__libs__polyhedron__convex_hull_4_0_2,
(MR_Word *) (MR_Integer) 0
},
3,
{
...
MR_BEGIN_MODULE(libs__polyhedron_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__empty_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__universe_0_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'universe'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__polyhedron_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__intersection_2_0);
	MR_init_label5(fn__libs__polyhedron__intersection_2_0,3,28,6,7,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'intersection'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__libs__polyhedron__intersection_2_0,3)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__intersection_2_0_i28);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__intersection_2_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
...
MR_BEGIN_MODULE(libs__polyhedron_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__from_constraints_1_0);
	MR_init_label8(fn__libs__polyhedron__from_constraints_1_0,42,7,5,9,12,13,14,15)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'from_constraints'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__libs__polyhedron__from_constraints_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__from_constraints_1_0_i42);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	...
	MR_np_call_localret_ent(libs__lp_rational__is_false_1_0,
		fn__libs__polyhedron__from_constraints_1_0_i7);
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__libs__polyhedron__from_constraints_1_0_i5);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(3);
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(2);
	MR_np_localcall_lab(fn__libs__polyhedron__from_constraints_1_0,
		fn__libs__polyhedron__from_constraints_1_0_i9);
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(1);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 0);
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__from_constraints_1_0_i12);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(3);
...
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(libs__lp_rational__restore_equalities_2_0,
		fn__libs__polyhedron__from_constraints_1_0_i14);
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__libs__lp_rational__simplify_constraints_1_0,
		fn__libs__polyhedron__from_constraints_1_0_i15);
MR_def_label(fn__libs__polyhedron__from_constraints_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(libs__polyhedron_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__constraints_1_0);
	MR_init_label2(fn__libs__polyhedron__constraints_1_0,4,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'constraints'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__polyhedron_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__non_false_constraints_1_0);
	MR_init_label1(fn__libs__polyhedron__non_false_constraints_1_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'non_false_constraints'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__libs__polyhedron__non_false_constraints_1_0,3)
	...
	MR_r2 = (MR_Word) MR_string_const("libs.polyhedron", 15);
	MR_r3 = (MR_Word) MR_string_const("function \140libs.polyhedron.non_false_constraints\'/1", 50);
	MR_r4 = (MR_Word) MR_string_const("empty polyhedron", 16);
...
MR_BEGIN_MODULE(libs__polyhedron_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__is_empty_1_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__is_universe_1_0);
	MR_init_label1(libs__polyhedron__is_universe_1_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'is_universe'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__polyhedron_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__optimize_3_0);
	MR_init_label4(libs__polyhedron__optimize_3_0,28,4,7,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'optimize'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__polyhedron__optimize_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(libs__polyhedron__optimize_3_0_i28);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(libs__polyhedron__optimize_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
...
MR_BEGIN_MODULE(libs__polyhedron_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__intersection_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__add_sigma_constraints_3_0);
	MR_init_label5(libs__polyhedron__add_sigma_constraints_3_0,4,5,8,9,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_sigma_constraints'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__polyhedron__add_sigma_constraints_3_0)
	...
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(libs__lp_rational, constraint);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
...
MR_def_label(libs__polyhedron__add_sigma_constraints_3_0,5)
	...
	MR_r4 = MR_sv(1);
	MR_np_call_localret_ent(fn__list__map_2_0,
		libs__polyhedron__add_sigma_constraints_3_0_i8);
MR_def_label(libs__polyhedron__add_sigma_constraints_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__libs__rat__one_0_0,
		libs__polyhedron__add_sigma_constraints_3_0_i9);
MR_def_label(libs__polyhedron__add_sigma_constraints_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__libs__lp_rational__construct_constraint_3_0,
		libs__polyhedron__add_sigma_constraints_3_0_i10);
MR_def_label(libs__polyhedron__add_sigma_constraints_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(libs__polyhedron_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__add_last_constraints_2_0);
	MR_init_label4(fn__libs__polyhedron__add_last_constraints_2_0,5,7,9,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_last_constraints'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__libs__polyhedron__add_last_constraints_2_0,5)
	...
	MR_np_call_localret_ent(fn__list__foldl_3_0,
		fn__libs__polyhedron__add_last_constraints_2_0_i7);
MR_def_label(fn__libs__polyhedron__add_last_constraints_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__set__filter_map_2_0,
		fn__libs__polyhedron__add_last_constraints_2_0_i9);
MR_def_label(fn__libs__polyhedron__add_last_constraints_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__set__to_sorted_list_1_0,
		fn__libs__polyhedron__add_last_constraints_2_0_i10);
MR_def_label(fn__libs__polyhedron__add_last_constraints_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(libs__polyhedron_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__convex_hull_4_0);
	MR_init_label10(libs__polyhedron__convex_hull_4_0,66,10,11,12,17,18,19,22,21,41)
	MR_init_label5(libs__polyhedron__convex_hull_4_0,24,25,26,28,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'convex_hull'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__polyhedron__convex_hull_4_0)
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(libs__polyhedron__convex_hull_4_0_i66);
	}
...
MR_def_label(libs__polyhedron__convex_hull_4_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	{
...
MR_def_label(libs__polyhedron__convex_hull_4_0,11)
	...
	MR_np_call_localret_ent(fn__libs__polyhedron__add_last_constraints_2_0,
		libs__polyhedron__convex_hull_4_0_i12);
MR_def_label(libs__polyhedron__convex_hull_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
...
MR_def_label(libs__polyhedron__convex_hull_4_0,18)
	...
	MR_np_call_localret_ent(libs__lp_rational__project_5_0,
		libs__polyhedron__convex_hull_4_0_i19);
MR_def_label(libs__polyhedron__convex_hull_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(libs__polyhedron__convex_hull_4_0_i21);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__libs__lp_rational__nonneg_box_2_0,
		libs__polyhedron__convex_hull_4_0_i22);
MR_def_label(libs__polyhedron__convex_hull_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(libs__polyhedron__convex_hull_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(libs__polyhedron__convex_hull_4_0_i24);
	}
MR_def_label(libs__polyhedron__convex_hull_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(6);
MR_def_label(libs__polyhedron__convex_hull_4_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(libs__lp_rational__restore_equalities_2_0,
		libs__polyhedron__convex_hull_4_0_i25);
MR_def_label(libs__polyhedron__convex_hull_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__libs__lp_rational__simplify_constraints_1_0,
		libs__polyhedron__convex_hull_4_0_i26);
MR_def_label(libs__polyhedron__convex_hull_4_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(libs__lp_rational__remove_some_entailed_constraints_3_0,
		libs__polyhedron__convex_hull_4_0_i28);
MR_def_label(libs__polyhedron__convex_hull_4_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(libs__polyhedron__convex_hull_4_0_i41);
	}
...
MR_def_label(libs__polyhedron__convex_hull_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("libs.polyhedron", 15);
	MR_r2 = (MR_Word) MR_string_const("predicate \140libs.polyhedron.convex_hull\'/4", 41);
...
MR_BEGIN_MODULE(libs__polyhedron_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__convex_union_5_0);
	MR_init_label3(libs__polyhedron__convex_union_5_0,5,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'convex_union'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__polyhedron__convex_union_5_0,7)
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tfield(1, MR_r3, 0);
...
MR_BEGIN_MODULE(libs__polyhedron_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__convex_union_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'convex_union'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__polyhedron_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__convex_union_4_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__convex_union_4_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__bounding_box_2_0);
	MR_init_label2(fn__libs__polyhedron__bounding_box_2_0,16,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__libs__polyhedron__bounding_box_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__bounding_box_2_0_i16);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__bounding_box_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(libs__polyhedron_module18)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__widen_3_0);
	MR_init_label3(fn__libs__polyhedron__widen_3_0,3,10,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'widen'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(fn__libs__polyhedron__widen_3_0,3)
	...
	MR_np_call_localret_ent(fn__list__filter_2_0,
		fn__libs__polyhedron__widen_3_0_i10);
MR_def_label(fn__libs__polyhedron__widen_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(fn__libs__polyhedron__widen_3_0,8)
	...
	MR_r2 = (MR_Word) MR_string_const("libs.polyhedron", 15);
	MR_r3 = (MR_Word) MR_string_const("function \140libs.polyhedron.widen\'/3", 34);
	MR_r4 = (MR_Word) MR_string_const("empty polyhedron", 16);
	MR_np_tailcall_ent(fn__require__unexpected_3_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__polyhedron_module19)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__project_all_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'project_all'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__libs__polyhedron__project_all_3_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(libs__polyhedron_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__project_4_0);
	MR_init_label5(libs__polyhedron__project_4_0,35,4,6,8,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury__libs__polyhedron__project_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(libs__polyhedron__project_4_0_i35);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(libs__polyhedron__project_4_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
...
MR_def_label(libs__polyhedron__project_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(libs__polyhedron__project_4_0_i6);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(1);
MR_def_label(libs__polyhedron__project_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(libs__lp_rational__restore_equalities_2_0,
		libs__polyhedron__project_4_0_i8);
...
MR_def_label(libs__polyhedron__project_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("libs.polyhedron", 15);
	MR_r2 = (MR_Word) MR_string_const("predicate \140libs.polyhedron.project\'/4", 37);
	MR_r3 = (MR_Word) MR_string_const("abort from project", 18);
...
MR_BEGIN_MODULE(libs__polyhedron_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__project_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__substitute_vars_3_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__substitute_vars_2_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__zero_vars_2_0);
	MR_init_label2(fn__libs__polyhedron__zero_vars_2_0,16,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'zero_vars'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__libs__polyhedron__zero_vars_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__zero_vars_2_0_i16);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__zero_vars_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(libs__polyhedron_module25)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__write_polyhedron_4_0);
	MR_init_label2(libs__polyhedron__write_polyhedron_4_0,3,6)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'write_polyhedron'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(libs__polyhedron_module26)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__transform_polyhedron_5_0);
	MR_init_label4(libs__polyhedron__transform_polyhedron_5_0,2,5,8,9)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'transform_polyhedron'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__polyhedron__transform_polyhedron_5_0,5)
	...
	MR_np_call_localret_ent(list__map_foldl2_7_0,
		libs__polyhedron__transform_polyhedron_5_0_i8);
MR_def_label(libs__polyhedron__transform_polyhedron_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r2;
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		libs__polyhedron__transform_polyhedron_5_0_i9);
MR_def_label(libs__polyhedron__transform_polyhedron_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(libs__polyhedron_module27)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__transform_constraint_7_0);
	MR_init_label6(libs__polyhedron__transform_constraint_7_0,2,8,9,11,12,13)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'transform_constraint'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(libs__polyhedron__transform_constraint_7_0,2)
	...
	MR_np_call_localret_ent(list__map_foldl2_7_0,
		libs__polyhedron__transform_constraint_7_0_i8);
MR_def_label(libs__polyhedron__transform_constraint_7_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__f_108_105_98_115_95_95_114_97_116_95_95_45_1_0,
		libs__polyhedron__transform_constraint_7_0_i9);
MR_def_label(libs__polyhedron__transform_constraint_7_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(list__cons_3_0,
		libs__polyhedron__transform_constraint_7_0_i11);
MR_def_label(libs__polyhedron__transform_constraint_7_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(fn__libs__rat__zero_0_0,
		libs__polyhedron__transform_constraint_7_0_i12);
MR_def_label(libs__polyhedron__transform_constraint_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__libs__lp_rational__construct_constraint_3_0,
		libs__polyhedron__transform_constraint_7_0_i13);
MR_def_label(libs__polyhedron__transform_constraint_7_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(libs__polyhedron_module28)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__change_var_6_0);
	MR_init_label4(libs__polyhedron__change_var_6_0,4,2,7,9)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'change_var'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__polyhedron__change_var_6_0)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		libs__polyhedron__change_var_6_0_i4);
MR_def_label(libs__polyhedron__change_var_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(libs__polyhedron__change_var_6_0,2)
	...
	MR_np_call_localret_ent(varset__new_var_3_0,
		libs__polyhedron__change_var_6_0_i7);
MR_def_label(libs__polyhedron__change_var_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		libs__polyhedron__change_var_6_0_i9);
MR_def_label(libs__polyhedron__change_var_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(libs__polyhedron_module29)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__get_keys_from_map_2_0);
	MR_init_label1(fn__libs__polyhedron__get_keys_from_map_2_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'get_keys_from_map'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__polyhedron__get_keys_from_map_2_0)
	...
	MR_np_call_localret_ent(fn__map__keys_1_0,
		fn__libs__polyhedron__get_keys_from_map_2_0_i3);
MR_def_label(fn__libs__polyhedron__get_keys_from_map_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(libs__polyhedron_module30)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__make_last_constraint_2_0);
	MR_init_label5(fn__libs__polyhedron__make_last_constraint_2_0,7,9,12,13,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_last_constraint'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__polyhedron__make_last_constraint_2_0)
	...
	MR_np_call_localret_ent(list__foldl_4_3,
		fn__libs__polyhedron__make_last_constraint_2_0_i7);
MR_def_label(fn__libs__polyhedron__make_last_constraint_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(fn__libs__rat__one_0_0,
		fn__libs__polyhedron__make_last_constraint_2_0_i9);
MR_def_label(fn__libs__polyhedron__make_last_constraint_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__libs__rat__zero_0_0,
		fn__libs__polyhedron__make_last_constraint_2_0_i12);
MR_def_label(fn__libs__polyhedron__make_last_constraint_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__libs__lp_rational__construct_constraint_3_0,
		fn__libs__polyhedron__make_last_constraint_2_0_i13);
MR_def_label(fn__libs__polyhedron__make_last_constraint_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
...
MR_BEGIN_MODULE(libs__polyhedron_module31)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__polyhedron__make_last_terms_4_0);
	MR_init_label5(libs__polyhedron__make_last_terms_4_0,3,5,6,9,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'make_last_terms'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__polyhedron__make_last_terms_4_0)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		libs__polyhedron__make_last_terms_4_0_i3);
MR_def_label(libs__polyhedron__make_last_terms_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(libs__polyhedron__make_last_terms_4_0,6)
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(list__cons_3_0,
		libs__polyhedron__make_last_terms_4_0_i9);
MR_def_label(libs__polyhedron__make_last_terms_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_BEGIN_MODULE(libs__polyhedron_module32)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__constr_info_0_0);
	MR_init_label3(__Unify___libs__polyhedron__constr_info_0_0,5,9,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___libs__polyhedron__constr_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___libs__polyhedron__constr_info_0_0_i9);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___libs__polyhedron__constr_info_0_0_i5);
MR_def_label(__Unify___libs__polyhedron__constr_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(__Unify___libs__polyhedron__constr_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(libs__polyhedron_module33)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__constr_info_0_0);
	MR_init_label4(__Compare___libs__polyhedron__constr_info_0_0,3,2,6,28)
MR_BEGIN_CODE
...
MR_def_label(__Compare___libs__polyhedron__constr_info_0_0,2)
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___libs__polyhedron__constr_info_0_0_i6);
MR_def_label(__Compare___libs__polyhedron__constr_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__polyhedron__constr_info_0_0_i28);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___libs__polyhedron__constr_info_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__polyhedron_module34)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__convex_hull_result_0_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module35)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__convex_hull_result_0_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module36)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__polyhedra_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module37)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__polyhedra_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module38)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__polyhedra_info_0_0);
	MR_init_label4(__Unify___libs__polyhedron__polyhedra_info_0_0,6,8,12,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___libs__polyhedron__polyhedra_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___libs__polyhedron__polyhedra_info_0_0_i12);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(__Unify___libs__polyhedron__polyhedra_info_0_0,6)
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___libs__polyhedron__polyhedra_info_0_0_i8);
MR_def_label(__Unify___libs__polyhedron__polyhedra_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___libs__polyhedron__polyhedra_info_0_0_i1);
	}
	...
	MR_decr_sp(6);
	MR_np_tailcall_ent(__Unify___varset__varset_1_0);
MR_def_label(__Unify___libs__polyhedron__polyhedra_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(libs__polyhedron_module39)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__polyhedra_info_0_0);
	MR_init_label5(__Compare___libs__polyhedron__polyhedra_info_0_0,3,2,7,12,41)
MR_BEGIN_CODE
...
MR_def_label(__Compare___libs__polyhedron__polyhedra_info_0_0,2)
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___libs__polyhedron__polyhedra_info_0_0_i7);
MR_def_label(__Compare___libs__polyhedron__polyhedra_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__polyhedron__polyhedra_info_0_0_i41);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___libs__polyhedron__polyhedra_info_0_0_i12);
MR_def_label(__Compare___libs__polyhedron__polyhedra_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___libs__polyhedron__polyhedra_info_0_0_i41);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___varset__varset_1_0);
MR_def_label(__Compare___libs__polyhedron__polyhedra_info_0_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__polyhedron_module40)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__polyhedron_0_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module41)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__polyhedron_0_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module42)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__sigma_var_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module43)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__sigma_var_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module44)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__sigma_vars_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module45)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__sigma_vars_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module46)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__var_map_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module47)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__var_map_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module48)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___libs__polyhedron__var_maps_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module49)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___libs__polyhedron__var_maps_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__polyhedron_module50)
	MR_init_entry1(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0);
	MR_init_label5(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,35,4,6,8,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__project_all__549__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0_i35);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(libs__lp_rational__project_4_0,
		fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0_i4);
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0_i6);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(1);
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0_i7);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(libs__lp_rational__restore_equalities_2_0,
		fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0_i8);
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__549__1_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("libs.polyhedron", 15);
	MR_r2 = (MR_Word) MR_string_const("function \140libs.polyhedron.project_all\'/3", 40);
	MR_r3 = (MR_Word) MR_string_const("abort from project", 18);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(require__unexpected_3_0);
...
MR_BEGIN_MODULE(libs__polyhedron_module51)
	MR_init_entry1(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0);
	MR_init_label1(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__convex_hull__366__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(fn__map__values_1_0,
		fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0_i3);
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__convex_hull__366__1_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__libs__polyhedron__init_threadscope_string_table(void);
#endif
