  ...
  MR_Word * STATE_VARIABLE_VarSet_18)
{
  ...
  MR_Word STATE_VARIABLE_Var_19_19 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Term_0_13, 0))));
  ...
  MR_Word * STATE_VARIABLE_PolyInfo_17)
{
  ...
  MR_Word NewEqns_14;
  MR_Word VarMap_15;
  MR_Word STATE_VARIABLE_VarSet_18_18 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_PolyInfo_0_16, 2))));
  ...
  else
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) ProjectionResult_35)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word STATE_VARIABLE_Hull_46_40 = ((MR_Word) ((MR_hl_field(1, ProjectionResult_35, 0))));
