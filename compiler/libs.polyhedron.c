...
MR_decl_label5(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0, 35,4,6,8,7)
...
MR_BEGIN_MODULE(libs__polyhedron_module50)
	...
	MR_init_label5(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0,35,4,6,8,7)
MR_BEGIN_CODE
...
MR_def_static(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0_i35);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
...
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0_i7);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(libs__lp_rational__restore_equalities_2_0,
		fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0_i8);
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(fn__libs__polyhedron__IntroducedFrom__func__project_all__550__1_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("polyhedron.m", 12);
