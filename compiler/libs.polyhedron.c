  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&libs__polyhedron_scalar_common_1[2]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&libs__polyhedron_scalar_common_1[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    {
      ArgY1_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      TypeInfo__9_9 = (MR_Word) (&libs__polyhedron_scalar_common_1[0]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&libs__polyhedron_scalar_common_1[3]);
  ...
  MR_Word * STATE_VARIABLE_Terms_10)
{
  ...
  if (succeeded)
  {
    ...
    TypeInfo__16_16 = (MR_Word) (&libs__polyhedron_scalar_common_2[1]);
    {
    ...
    mercury__list__cons_3_p_0(TypeInfo__16_16, ((MR_Box) (Var_11)), STATE_VARIABLE_Terms_0_9, STATE_VARIABLE_Terms_10);
    succeeded = MR_TRUE;
  }
  return succeeded;
}
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&libs__polyhedron_scalar_common_7[3]));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = libs__polyhedron__make_last_constraint_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv8_Constraint_6);
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), PolyInfo0_25, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), PolyInfo0_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), PolyInfo0_25, 2) = ((MR_Box) (VarSet_1));
      }
      ...
      VarMaps_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PolyInfo_27, (MR_Integer) 0))));
      Sigmas_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PolyInfo_27, (MR_Integer) 1))));
      VarSet_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PolyInfo_27, (MR_Integer) 2))));
      ...
      Keys_64 = ((MR_Word) (conv7_Keys_64));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (&libs__polyhedron_scalar_common_7[1]));
        MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (libs__polyhedron__convex_union_5_p_0_5));
        MR_hl_field(MR_mktag(0), Var_66, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_66, 3) = ((MR_Box) (VarMaps_28));
      }
      ...
      switch (MR_tag((MR_Word) ProjectionResult_35)) {
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_43 = libs__lp_rational__nonneg_box_2_f_0(VarsToEliminate_34, Matrix_32);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__5_5 = base;
        ...
        case (MR_Integer) 1:
          {
            MR_Word STATE_VARIABLE_Hull_45_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProjectionResult_35, (MR_Integer) 0))));
            MR_Word STATE_VARIABLE_Hull_46_40;
            MR_Word STATE_VARIABLE_Hull_47_41;
            MR_Word STATE_VARIABLE_Hull_48_42;

            libs__lp_rational__restore_equalities_2_p_0(STATE_VARIABLE_Hull_45_39, &STATE_VARIABLE_Hull_46_40);
            STATE_VARIABLE_Hull_47_41 = libs__lp_rational__simplify_constraints_1_f_0(STATE_VARIABLE_Hull_46_40);
            succeeded = libs__lp_rational__remove_some_entailed_constraints_3_p_0(VarSet_30, STATE_VARIABLE_Hull_47_41, &STATE_VARIABLE_Hull_48_42);
            if (succeeded)
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *HeadVar__5_5 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (STATE_VARIABLE_Hull_48_42));
              }
            else
              *HeadVar__5_5 = (MR_Word) ((MR_Unsigned) 0U);
          }
  ...
  MR_Word HeadVar__1_1)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo__5_5 = (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0);
    succeeded = mercury__list__all_true_2_p_0(TypeCtorInfo__5_5, Var_3, Constraints_2);
  }
  return succeeded;
}
