  ...
  else
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) ProjectionResult_35)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word STATE_VARIABLE_Hull_46_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProjectionResult_35, (MR_Integer) 0))));
            ...
            if (succeeded)
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *HeadVar__5_5 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (STATE_VARIABLE_Hull_49_43));
              }
            else
              *HeadVar__5_5 = (MR_Word) ((MR_Unsigned) 0U);
          }
