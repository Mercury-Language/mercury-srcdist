...
MR_decl_label8(check_hlds__format_call__follow_list_5_0, 11,10,15,18,19,33,21,14)
...
MR_decl_label8(check_hlds__format_call__traverse_conj_13_0, 57,3,4,7,8,9,10,11)
MR_decl_label8(check_hlds__format_call__traverse_conj_13_0, 12,15,17,18,19,14,22,24)
MR_decl_label8(check_hlds__format_call__traverse_conj_13_0, 26,28,29,31,32,34,36,37)
MR_decl_label8(check_hlds__format_call__traverse_conj_13_0, 38,39,40,41,42,43,44,45)
MR_decl_label2(check_hlds__format_call__traverse_conj_13_0, 46,68)
MR_decl_label5(check_hlds__format_call__traverse_disj_13_0, 2,3,4,5,6)
MR_decl_label5(check_hlds__format_call__traverse_disj_arms_11_0, 15,4,5,6,7)
...
MR_BEGIN_MODULE(check_hlds__format_call_module6)
	...
	MR_init_label8(check_hlds__format_call__traverse_conj_13_0,57,3,4,7,8,9,10,11)
	MR_init_label8(check_hlds__format_call__traverse_conj_13_0,12,15,17,18,19,14,22,24)
	MR_init_label8(check_hlds__format_call__traverse_conj_13_0,26,28,29,31,32,34,36,37)
	MR_init_label8(check_hlds__format_call__traverse_conj_13_0,38,39,40,41,42,43,44,45)
	MR_init_label2(check_hlds__format_call__traverse_conj_13_0,46,68)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__format_call__traverse_conj_13_0,4)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r6),
		...
		MR_LABEL_AP(check_hlds__format_call__traverse_conj_13_0_i68) MR_AND
...
MR_def_label(check_hlds__format_call__traverse_conj_13_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__format_call_module8)
	...
	MR_init_label5(check_hlds__format_call__traverse_disj_arms_11_0,15,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__format_call__traverse_disj_arms_11_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__format_call__traverse_disj_arms_11_0_i15);
	}
	...
	MR_proceed();
MR_def_label(check_hlds__format_call__traverse_disj_arms_11_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(check_hlds__format_call_module11)
	...
	MR_init_label8(check_hlds__format_call__follow_list_5_0,11,10,15,18,19,33,21,14)
