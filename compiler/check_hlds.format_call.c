...
MR_decl_label10(check_hlds__format_call__replace_string_format_9_0, 6,7,8,5,4,9,3,54,14,15)
MR_decl_label7(check_hlds__format_call__replace_string_format_9_0, 16,17,24,25,26,28,29)
...
MR_BEGIN_MODULE(check_hlds__format_call_module17)
	...
	MR_init_label10(check_hlds__format_call__replace_string_format_9_0,6,7,8,5,4,9,3,54,14,15)
	MR_init_label7(check_hlds__format_call__replace_string_format_9_0,16,17,24,25,26,28,29)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__format_call__replace_string_format_9_0,3)
	...
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(check_hlds__format_call__replace_string_format_9_0_i54);
	}
	MR_r2 = MR_tfield(1, MR_r2, 0);
	MR_np_tailcall_ent(check_hlds__format_call__represent_component_9_0);
MR_def_label(check_hlds__format_call__replace_string_format_9_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(5) = MR_r1;
...
MR_def_label(check_hlds__format_call__replace_string_format_9_0,17)
	...
	MR_np_call_localret_ent(fn__hlds__instmap__instmap_delta_from_assoc_list_1_0,
		check_hlds__format_call__replace_string_format_9_0_i24);
MR_def_label(check_hlds__format_call__replace_string_format_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_np_call_localret_ent(fn__term__context_init_0_0,
