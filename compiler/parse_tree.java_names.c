  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Word Qual_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    ...
    Var_7 = parse_tree__java_names__flip_initial_case_1_f_0(Name_6);
    {
      ...
      MR_hl_field(1, HeadVar__2_2, 0) = ((MR_Box) (Qual_5));
...
{
  return (MR_Word) (MR_mkword(1, &parse_tree__java_names_scalar_common_2[1]));
}
      ...
      case (MR_Integer) 97:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 98:
            ...
            break;
          case (MR_Integer) 114:
            if (MR_offset_streq(2, HeadVar__1_1, (MR_String) "args"))
      ...
      case (MR_Integer) 102:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          ...
          case (MR_Integer) 105:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              case (MR_Integer) 108:
                if (MR_offset_streq(3, HeadVar__1_1, (MR_String) "file"))
          ...
          case (MR_Integer) 101:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              case (MR_Integer) 97:
                ...
                break;
              case (MR_Integer) 99:
                if (MR_offset_streq(3, HeadVar__1_1, (MR_String) "record"))
              ...
              case (MR_Integer) 102:
                ...
                break;
              case (MR_Integer) 113:
                if (MR_offset_streq(3, HeadVar__1_1, (MR_String) "required"))
      ...
      case (MR_Integer) 115:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 98:
            ...
            break;
          case (MR_Integer) 99:
            if (MR_offset_streq(2, HeadVar__1_1, (MR_String) "scoped"))
  ...
  MR_Word * MangledSymName_6)
{
  ...
  {
    MR_Word ModuleName0_9 = ((MR_Word) ((MR_hl_field(1, SymName_4, (MR_Integer) 0))));
    MR_String PlainName_10 = ((MR_String) ((MR_hl_field(1, SymName_4, (MR_Integer) 1))));
    MR_Word MangledModuleName_11;
    MR_String SafePlainName_12;
    MR_String MangledName_14;
    MR_String FlippedName_15;

    parse_tree__java_names__mangle_sym_name_for_csharp_2_3_p_0(ModuleName0_9, (MR_Integer) 0, &MangledModuleName_11);
    MangledName_14 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(PlainName_10);
    switch (QualKind_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        FlippedName_15 = MangledName_14;
        break;
      case (MR_Integer) 1:
        FlippedName_15 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_14);
        break;
    }
    SafePlainName_12 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(FlippedName_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *MangledSymName_6 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (MangledModuleName_11));
      MR_hl_field(1, base, 1) = ((MR_Box) (SafePlainName_12));
    }
  }
  else
  {
    MR_String Name_7 = ((MR_String) ((MR_hl_field(0, SymName_4, (MR_Integer) 0))));
    MR_String SafeName_8;
    MR_String MangledName_16;
    MR_String FlippedName_17;

    MangledName_16 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(Name_7);
    switch (QualKind_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        FlippedName_17 = MangledName_16;
        break;
      case (MR_Integer) 1:
        FlippedName_17 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_16);
        break;
    }
    SafeName_8 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(FlippedName_17);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      *MangledSymName_6 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (SafeName_8));
    }
  }
}
      ...
      case (MR_Integer) 97:
        switch (MR_nth_code_unit(SymName_3, 1)) {
          case (MR_Integer) 98:
            ...
            break;
          case (MR_Integer) 114:
            if (MR_offset_streq(2, SymName_3, (MR_String) "args"))
              case_num_0 = (MR_Integer) 1;
            break;
          case (MR_Integer) 115:
      ...
      case (MR_Integer) 102:
        switch (MR_nth_code_unit(SymName_3, 1)) {
          ...
          case (MR_Integer) 105:
            switch (MR_nth_code_unit(SymName_3, 2)) {
              case (MR_Integer) 108:
                if (MR_offset_streq(3, SymName_3, (MR_String) "file"))
                  case_num_0 = (MR_Integer) 25;
                break;
              case (MR_Integer) 110:
              ...
              case (MR_Integer) 116:
                switch (MR_nth_code_unit(SymName_3, 3)) {
                  case (MR_Integer) 0:
                    ...
                    break;
                  case (MR_Integer) 101:
                    switch (MR_nth_code_unit(SymName_3, 4)) {
                      case (MR_Integer) 114:
          ...
          case (MR_Integer) 101:
            switch (MR_nth_code_unit(SymName_3, 2)) {
              case (MR_Integer) 97:
                ...
                break;
              case (MR_Integer) 99:
                if (MR_offset_streq(3, SymName_3, (MR_String) "record"))
                  case_num_0 = (MR_Integer) 53;
                break;
              case (MR_Integer) 102:
                ...
                break;
              case (MR_Integer) 113:
                if (MR_offset_streq(3, SymName_3, (MR_String) "required"))
                  case_num_0 = (MR_Integer) 55;
                break;
              case (MR_Integer) 116:
      ...
      case (MR_Integer) 115:
        switch (MR_nth_code_unit(SymName_3, 1)) {
          case (MR_Integer) 98:
            ...
            break;
          case (MR_Integer) 99:
            if (MR_offset_streq(2, SymName_3, (MR_String) "scoped"))
              case_num_0 = (MR_Integer) 58;
            break;
          case (MR_Integer) 101:
...
{
  return (MR_Word) (MR_mkword(1, &parse_tree__java_names_scalar_common_2[0]));
}
      ...
      case (MR_Integer) 102:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            ...
            break;
          case (MR_Integer) 105:
            if (MR_offset_strn_eq(2, 3, HeadVar__1_1, (MR_String) "final"))
              switch (MR_nth_code_unit(HeadVar__1_1, 5)) {
                case (MR_Integer) 0:
                  case_num_0 = (MR_Integer) 17;
                  break;
          ...
          case (MR_Integer) 104:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              case (MR_Integer) 105:
                ...
                break;
              case (MR_Integer) 114:
                if (MR_offset_strn_eq(3, 2, HeadVar__1_1, (MR_String) "throw"))
                  switch (MR_nth_code_unit(HeadVar__1_1, 5)) {
                    case (MR_Integer) 0:
                      case_num_0 = (MR_Integer) 44;
                      break;
  ...
  MR_Word * MangledSymName_6)
{
  if (((MR_tag((MR_Word) SymName_4)) == (MR_Integer) 1))
  {
    ...
    switch (QualKind_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeFlippedName_15 = MangledName_14;
        break;
      case (MR_Integer) 1:
        MaybeFlippedName_15 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_14);
        break;
    }
    JavaSafePlainName_12 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(MaybeFlippedName_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *MangledSymName_6 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (MangledModuleName_11));
      MR_hl_field(1, base, 1) = ((MR_Box) (JavaSafePlainName_12));
    }
  }
  else
  {
    ...
    MR_String JavaSafeName_8;
    MR_String MangledName_16;
    MR_String MaybeFlippedName_17;

    MangledName_16 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(Name_7);
    switch (QualKind_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeFlippedName_17 = MangledName_16;
        break;
      case (MR_Integer) 1:
        MaybeFlippedName_17 = parse_tree__java_names__flip_initial_case_1_f_0(MangledName_16);
        break;
    }
    JavaSafeName_8 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(MaybeFlippedName_17);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      *MangledSymName_6 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (JavaSafeName_8));
    }
  }
}
      ...
      case (MR_Integer) 102:
        switch (MR_nth_code_unit(SymName_3, 1)) {
          case (MR_Integer) 97:
            ...
            break;
          case (MR_Integer) 105:
            if (MR_offset_strn_eq(2, 3, SymName_3, (MR_String) "final"))
              switch (MR_nth_code_unit(SymName_3, 5)) {
                case (MR_Integer) 0:
                  case_num_0 = (MR_Integer) 17;
                  break;
          ...
          case (MR_Integer) 104:
            switch (MR_nth_code_unit(SymName_3, 2)) {
              case (MR_Integer) 105:
                ...
                break;
              case (MR_Integer) 114:
                if (MR_offset_strn_eq(3, 2, SymName_3, (MR_String) "throw"))
                  switch (MR_nth_code_unit(SymName_3, 5)) {
                    case (MR_Integer) 0:
                      case_num_0 = (MR_Integer) 44;
                      break;
