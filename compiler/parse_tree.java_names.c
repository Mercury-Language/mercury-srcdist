    ...
    if (((MR_tag((MR_Word) parse_tree__java_names__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String parse_tree__java_names__Var_7;

        {
          parse_tree__java_names__Var_7 = parse_tree__java_names__flip_initial_case_1_f_0(parse_tree__java_names__Name_6);
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__java_names__HeadVar__2_2, 1) = ((MR_Box) (parse_tree__java_names__Var_7));
        }
      }
    else
      {
        ...
        MR_String parse_tree__java_names__Var_4;

        {
          parse_tree__java_names__Var_4 = parse_tree__java_names__flip_initial_case_1_f_0(parse_tree__java_names__Name_3);
        }
        {
          parse_tree__java_names__HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__java_names__HeadVar__2_2, 0) = ((MR_Box) (parse_tree__java_names__Var_4));
        }
      }
  ...
  if (((MR_tag((MR_Word) parse_tree__java_names__SymName_4)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      {
        parse_tree__java_names__SafePlainName_12 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(parse_tree__java_names__FlippedName_18);
      }
      {
        MR_Word base;
  ...
  else
    {
      ...
      {
        parse_tree__java_names__SafeName_8 = parse_tree__java_names__make_valid_csharp_symbol_name_1_f_0(parse_tree__java_names__FlippedName_23);
      }
      {
        MR_Word base;
        ...
        if (parse_tree__java_names__succeeded)
          {
            ...
            {
              parse_tree__java_names__Var_7 = mercury__string__f_43_43_2_f_0((MR_String) "_", parse_tree__java_names__Suffix_6);
            }
            {
              parse_tree__java_names__ValidSymName_4 = mercury__string__f_43_43_2_f_0((MR_String) "mr_", parse_tree__java_names__Var_7);
            }
          }
        else
...
{
  {
    ...
    MR_String parse_tree__java_names__Var_13;

    {
      parse_tree__java_names__succeeded = mdbcomp__sym_name__strip_outermost_qualifier_3_p_0(parse_tree__java_names__SymName0_5, &parse_tree__java_names__Var_13, &parse_tree__java_names__StrippedSymName_9);
    }
    if (parse_tree__java_names__succeeded)
      parse_tree__java_names__succeeded = (strcmp((MR_String) "mercury", parse_tree__java_names__Var_13) == 0);
    if (parse_tree__java_names__succeeded)
  ...
  if (((MR_tag((MR_Word) parse_tree__java_names__SymName_4)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_String parse_tree__java_names__MangledName_17;
      MR_String parse_tree__java_names__MaybeFlippedName_18;
      ...
      switch (parse_tree__java_names__QualKind_5) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          parse_tree__java_names__MaybeFlippedName_18 = parse_tree__java_names__MangledName_17;
          break;
        case (MR_Integer) 1:
          {
            parse_tree__java_names__MaybeFlippedName_18 = parse_tree__java_names__flip_initial_case_1_f_0(parse_tree__java_names__MangledName_17);
          }
          break;
      }
      {
        parse_tree__java_names__JavaSafePlainName_12 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(parse_tree__java_names__MaybeFlippedName_18);
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
    {
      ...
      MR_String parse_tree__java_names__JavaSafeName_8;
      MR_String parse_tree__java_names__MangledName_22;
      MR_String parse_tree__java_names__MaybeFlippedName_23;
      ...
      switch (parse_tree__java_names__QualKind_5) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          parse_tree__java_names__MaybeFlippedName_23 = parse_tree__java_names__MangledName_22;
          break;
        case (MR_Integer) 1:
          {
            parse_tree__java_names__MaybeFlippedName_23 = parse_tree__java_names__flip_initial_case_1_f_0(parse_tree__java_names__MangledName_22);
          }
          break;
      }
      {
        parse_tree__java_names__JavaSafeName_8 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(parse_tree__java_names__MaybeFlippedName_23);
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
