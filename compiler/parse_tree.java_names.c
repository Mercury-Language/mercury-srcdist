    ...
    if (((MR_tag((MR_Word) parse_tree__java_names__SymName_4)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          parse_tree__java_names__JavaSafePlainName_12 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(parse_tree__java_names__FlippedName_18);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
      {
        ...
        {
          parse_tree__java_names__JavaSafeName_8 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(parse_tree__java_names__FlippedName_23);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
