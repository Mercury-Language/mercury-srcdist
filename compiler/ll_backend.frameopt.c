    ...
    if (succeeded)
    {
      ...
      *STATE_VARIABLE_C_28 = STATE_VARIABLE_C_30_30;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Var_21)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 0)))) == (MR_Integer) 12)));
            if (succeeded)
            {
