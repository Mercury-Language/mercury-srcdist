...
MR_def_label(ll_backend__frameopt__delay_frame_transform_13_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(15) = (MR_Word) MR_TAG_COMMON(0,6,2);
	MR_r1 = MR_sv(15);
...
MR_def_label(ll_backend__frameopt__frameopt_main_nondet_stack_7_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = (MR_Word) MR_CTOR0_ADDR(ll_backend__frameopt, nondet_entry_info);
	MR_sv(12) = (MR_Word) MR_CTOR0_ADDR(ll_backend__frameopt, nondet_exit_info);
