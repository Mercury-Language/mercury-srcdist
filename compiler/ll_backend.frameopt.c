...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Comments_31 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Comments0_15, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__frameopt_scalar_common_2[15])));
