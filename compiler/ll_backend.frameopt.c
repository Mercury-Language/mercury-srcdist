...
MR_def_static(ll_backend__frameopt__delay_frame_transform_13_0)
	...
	MR_sv(17) = (MR_Word) MR_CTOR0_ADDR(ll_backend__frameopt, block_needs_frame);
	MR_r1 = MR_sv(14);
	MR_r2 = MR_sv(17);
...
MR_def_label(ll_backend__frameopt__frameopt_main_nondet_stack_7_0,2)
	...
	MR_sv(1) = MR_r2;
	MR_sv(5) = MR_tempr5;
	MR_sv(9) = (MR_Word) MR_CTOR0_ADDR(ll_backend__frameopt, nondet_entry_info);
	MR_sv(10) = (MR_Word) MR_CTOR0_ADDR(ll_backend__frameopt, nondet_exit_info);
	MR_sv(11) = (MR_Word) MR_TAG_COMMON(0,6,8);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, label);
	MR_r2 = MR_sv(11);
	}
	MR_np_call_localret_ent(map__init_1_0,
