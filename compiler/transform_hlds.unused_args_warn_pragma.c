      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_18, &ModeNum_98);
            {
            ...
            mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_unused_args_info_0), ((MR_Box) (UnusedArgInfo_100)), STATE_VARIABLE_PragmaUnusedArgInfos_0_22, STATE_VARIABLE_PragmaUnusedArgInfos_23);
          }
          else
  ...
  MR_Word * STATE_VARIABLE_WarnUnusedPredArgsMap_31)
{
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_20, &ArgModes0_21);
