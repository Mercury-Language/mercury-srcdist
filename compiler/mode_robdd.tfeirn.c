      ...
      if (mode_robdd__tfeirn__succeeded)
      {
        ...
        *mode_robdd__tfeirn__FalseVars_8 = mode_robdd__tfeirn__FalseVars0_10;
        mode_robdd__tfeirn__cont(mode_robdd__tfeirn__cont_env_ptr);
        {
          ...
          mode_robdd__tfeirn__minimal_model_4_p_0(mode_robdd__tfeirn__TypeInfo_for_T_14, mode_robdd__tfeirn__Vars_5, mode_robdd__tfeirn__X_11, mode_robdd__tfeirn__TrueVars_7, mode_robdd__tfeirn__FalseVars_8, mode_robdd__tfeirn__cont, mode_robdd__tfeirn__cont_env_ptr);
        }
      }
    }
  }
