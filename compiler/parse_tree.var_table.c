  ...
  MR_Word * STATE_VARIABLE_VarDb_21)
{
  if (((MR_tag((MR_Word) STATE_VARIABLE_VarDb_0_20)) == (MR_Integer) 1))
  {
    ...
    Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_16, (MR_Integer) 1))));
    Var_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_16, (MR_Integer) 2))) & (MR_Integer) 1);
    {
      Entry_17 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Entry_17, 0) = ((MR_Box) (Name_6));
      MR_hl_field(MR_mktag(0), Entry_17, 1) = ((MR_Box) (Var_23));
      MR_hl_field(MR_mktag(0), Entry_17, 2) = (MR_Box) ((MR_Unsigned) (Var_24));
    }
