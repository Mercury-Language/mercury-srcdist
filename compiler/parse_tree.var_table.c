...
parse_tree__var_table__update_var_name_4_p_0(
  ...
  MR_Word * STATE_VARIABLE_VarTable_14)
{
  MR_Word Counter_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarTable_0_13, (MR_Integer) 0))));
  ...
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_10, (MR_Integer) 1))));
  Var_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_10, (MR_Integer) 2))) & (MR_Integer) 1);
  {
    Entry_11 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_11, 0) = ((MR_Box) (Name_6));
    MR_hl_field(MR_mktag(0), Entry_11, 1) = ((MR_Box) (Var_17));
    MR_hl_field(MR_mktag(0), Entry_11, 2) = (MR_Box) ((MR_Unsigned) (Var_18));
  }
