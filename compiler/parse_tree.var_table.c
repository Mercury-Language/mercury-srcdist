  ...
  MR_String * Name_6)
{
  ...
  if (((MR_tag((MR_Word) VarNameSrc_4)) == (MR_Integer) 1))
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_16, ((MR_Box) (Var_5)), &conv0_Entry_9);
    Entry_9 = ((MR_Word) (conv0_Entry_9));
