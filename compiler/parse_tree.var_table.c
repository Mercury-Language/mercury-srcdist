...
static void MR_CALL 
parse_tree__var_table__apply_renaming_to_type_in_vte_3_p_0(
  MR_Word Renaming_4,
  MR_Word Entry0_5,
  MR_Word * Entry_6);
...
static void MR_CALL 
parse_tree__var_table__rename_vars_in_var_table_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
  ...
  MR_Word * Entry_6)
{
  ...
  parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(Renaming_4, Type0_7, &Type_8);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__var_table__apply_renaming_to_type_in_vte_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Entry_6);
  *wrapper_arg_2 = ((MR_Box) (conv0_Entry_6));
}

void MR_CALL 
parse_tree__var_table__rename_vars_in_var_table_3_p_0(
  MR_Word Renaming_4,
  ...
  MR_Word * STATE_VARIABLE_VarTable_7)
{
...

  {
    ...
    MR_hl_field(0, Var_8, 1) = ((MR_Box) (parse_tree__var_table__rename_vars_in_var_table_3_p_0_1));
