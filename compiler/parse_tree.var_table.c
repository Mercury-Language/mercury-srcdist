...
static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_db_0_0[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_0;

static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_db_0_1[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_1;

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_0[1];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_1[1];

static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_db_0[2];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_db_0[2];

static const MR_Integer parse_tree__var_table__parse_tree__var_table__functor_number_map_var_db_0[2];

static const MR_FA_TypeInfo_Struct1 parse_tree__var_table__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_prog_var_type_0;

static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_name_source_0_0[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_0;

static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_name_source_0_1[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_1;

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_0[1];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_1[1];

static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_name_source_0[2];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_name_source_0[2];

static const MR_Integer parse_tree__var_table__parse_tree__var_table__functor_number_map_var_name_source_0[2];
...
static const MR_FA_TypeInfo_Struct2 parse_tree__var_table__tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0parse_tree__prog_data__type_ctor_info_mer_type_0;

static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_type_source_0_0[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_0;

static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_type_source_0_1[1];

static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_1;

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_0[1];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_1[1];

static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_type_source_0[2];

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_type_source_0[2];

static const MR_Integer parse_tree__var_table__parse_tree__var_table__functor_number_map_var_type_source_0[2];

static void MR_CALL 
parse_tree__var_table__apply_rec_subst_to_type_in_vte_3_p_0(
  MR_Word Subst_4,
  MR_Word Entry0_5,
  MR_Word * Entry_6);

static void MR_CALL 
parse_tree__var_table__apply_subst_to_type_in_vte_3_p_0(
  MR_Word Subst_4,
  MR_Word Entry0_5,
  MR_Word * Entry_6);
...
static void MR_CALL 
parse_tree__var_table__apply_rec_subst_to_var_table_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__var_table__apply_subst_to_var_table_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
parse_tree__var_table____Unify____var_db_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__var_table____Compare____var_db_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);

static MR_bool MR_CALL 
parse_tree__var_table____Unify____var_name_source_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__var_table____Compare____var_name_source_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static MR_bool MR_CALL 
parse_tree__var_table____Unify____var_type_source_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__var_table____Compare____var_type_source_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static /* final */ const MR_Box parse_tree__var_table_scalar_common_4[2][6];
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__var_table__parse_tree__var_table__field_types_var_db_0_0,
  NULL,
  NULL,
  NULL,
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_1 = {
  ...
  (MR_Integer) -1,
  INT32_C(1),
  parse_tree__var_table__parse_tree__var_table__field_types_var_db_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_0[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_0
};

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_1[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_db_0_1
};
...
static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_db_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_db_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
const MR_TypeCtorInfo_Struct parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_db_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__var_table____Unify____var_db_0_0_10001)),
  ((MR_Box) (parse_tree__var_table____Compare____var_db_0_0_10001)),
  (MR_String) "parse_tree.var_table",
  (MR_String) "var_db",
  { parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_db_0 },
  { parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_db_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  parse_tree__var_table__parse_tree__var_table__functor_number_map_var_db_0,
...
static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_name_source_0_0[1] = {
  (MR_PseudoTypeInfo) (&parse_tree__var_table__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_prog_var_type_0)
};
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__var_table__parse_tree__var_table__field_types_var_name_source_0_0,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_1 = {
  ...
  (MR_Integer) -1,
  INT32_C(1),
  parse_tree__var_table__parse_tree__var_table__field_types_var_name_source_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_0[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_0
};

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_1[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_name_source_0_1
};
...
static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_name_source_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_name_source_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
const MR_TypeCtorInfo_Struct parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_name_source_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__var_table____Unify____var_name_source_0_0_10001)),
  ((MR_Box) (parse_tree__var_table____Compare____var_name_source_0_0_10001)),
  (MR_String) "parse_tree.var_table",
  (MR_String) "var_name_source",
  { parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_name_source_0 },
  { parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_name_source_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  parse_tree__var_table__parse_tree__var_table__functor_number_map_var_name_source_0,
...
static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_table_0_0[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_table_0_0
};
...
static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_table_entry_0_0[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_table_entry_0_0
};
...
static const MR_PseudoTypeInfo parse_tree__var_table__parse_tree__var_table__field_types_var_type_source_0_0[1] = {
  (MR_PseudoTypeInfo) (&parse_tree__var_table__tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0parse_tree__prog_data__type_ctor_info_mer_type_0)
};
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__var_table__parse_tree__var_table__field_types_var_type_source_0_0,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDesc parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_1 = {
  ...
  (MR_Integer) -1,
  INT32_C(1),
  parse_tree__var_table__parse_tree__var_table__field_types_var_type_source_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_0[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_0
};

static const MR_DuFunctorDescPtr parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_1[1] = {
  &parse_tree__var_table__parse_tree__var_table__du_functor_desc_var_type_source_0_1
};
...
static const MR_DuPtagLayout parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_type_source_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__var_table__parse_tree__var_table__du_stag_ordered_var_type_source_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
const MR_TypeCtorInfo_Struct parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_type_source_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__var_table____Unify____var_type_source_0_0_10001)),
  ((MR_Box) (parse_tree__var_table____Compare____var_type_source_0_0_10001)),
  (MR_String) "parse_tree.var_table",
  (MR_String) "var_type_source",
  { parse_tree__var_table__parse_tree__var_table__du_name_ordered_var_type_source_0 },
  { parse_tree__var_table__parse_tree__var_table__du_ptag_ordered_var_type_source_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  parse_tree__var_table__parse_tree__var_table__functor_number_map_var_type_source_0,

};

void MR_CALL 
parse_tree__var_table____Compare____var_type_source_0_0(
...
MR_bool MR_CALL 
parse_tree__var_table____Unify____var_type_source_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_9_9 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
...
void MR_CALL 
parse_tree__var_table____Compare____var_name_source_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY1_5)));
    }
  }
}

MR_bool MR_CALL 
parse_tree__var_table____Unify____var_name_source_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    {
      ArgY1_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
      TypeInfo_9_9 = (MR_Word) (&parse_tree__var_table_scalar_common_1[1]);
...
void MR_CALL 
parse_tree__var_table____Compare____var_db_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
parse_tree__var_table____Unify____var_db_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
...
void MR_CALL 
parse_tree__var_table__var_db_count_2_p_0(
  MR_Word VarDb_3,
  MR_Integer * Count_4)
{
  if (((MR_tag((MR_Word) VarDb_3)) == (MR_Integer) 1))
  {
    ...
    MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable_7, (MR_Integer) 1))));

    mercury__map__count_2_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_12, Count_4);
  }
  else
  {
    MR_Word VarSet_5;
...
void MR_CALL 
parse_tree__var_table__set_var_name_in_db_4_p_0(
  MR_Word Var_5,
  MR_String Name_6,
  ...
  MR_Word * STATE_VARIABLE_VarDb_21)
{
  ...
  {
    MR_Word VarTable0_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_VarDb_0_20, (MR_Integer) 0))));
    MR_Word Counter_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable0_13, (MR_Integer) 0))));
    MR_Word VarTableMap0_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable0_13, (MR_Integer) 1))));
    MR_Word Entry0_16;
    MR_Word Entry_17;
    MR_Word VarTableMap_18;
    MR_Word VarTable_19;
    MR_Box conv0_Entry0_16;
    MR_Word Var_25;
    MR_Word Var_26;

    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), VarTableMap0_15, ((MR_Box) (Var_5)), &conv0_Entry0_16);
    Entry0_16 = ((MR_Word) (conv0_Entry0_16));
    Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_16, (MR_Integer) 1))));
    Var_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_16, (MR_Integer) 2))) & (MR_Integer) 1);
    {
      Entry_17 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Entry_17, 0) = ((MR_Box) (Name_6));
      MR_hl_field(MR_mktag(0), Entry_17, 1) = ((MR_Box) (Var_25));
      MR_hl_field(MR_mktag(0), Entry_17, 2) = (MR_Box) ((MR_Unsigned) (Var_26));
    }
    mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), ((MR_Box) (Var_5)), ((MR_Box) (Entry_17)), VarTableMap0_15, &VarTableMap_18);
    {
      VarTable_19 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), VarTable_19, 0) = ((MR_Box) (Counter_14));
      MR_hl_field(MR_mktag(0), VarTable_19, 1) = ((MR_Box) (VarTableMap_18));
    }
    {
      MR_Word base;
  ...
  {
    MR_Word VarSetVarTypes0_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarDb_0_20, (MR_Integer) 0))));
...
void MR_CALL 
parse_tree__var_table__lookup_var_types_in_db_3_p_0(
  MR_Word VarDb_4,
  MR_Word Vars_5,
  MR_Word * Types_6)
{
...
void MR_CALL 
parse_tree__var_table__lookup_var_type_in_db_3_p_0(
  MR_Word VarDb_4,
  MR_Word Var_5,
  MR_Word * Type_6)
{
  if (((MR_tag((MR_Word) VarDb_4)) == (MR_Integer) 1))
  {
    MR_Word VarTable_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarDb_4, (MR_Integer) 0))));
    MR_Word Entry_14;
    MR_Word Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable_9, (MR_Integer) 1))));
    MR_Box conv0_Entry_14;

    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_20, ((MR_Box) (Var_5)), &conv0_Entry_14);
    Entry_14 = ((MR_Word) (conv0_Entry_14));
    *Type_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_14, (MR_Integer) 1))));
  }
  else
  {
    MR_Word VarTypes_8;
...
void MR_CALL 
parse_tree__var_table__add_prefix_number_var_entry_to_var_db_6_p_0(
  MR_String Prefix_7,
  MR_Word Type_8,
  MR_Word IsDummy_9,
  MR_Word * Var_10,
  ...
  MR_Word * STATE_VARIABLE_VarDb_21)
{
  ...
  else
  {
    ...
    parse_tree__var_table__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_97_100_100_95_112_114_101_102_105_120_95_110_117_109_98_101_114_95_118_97_114_95_101_110_116_114_121_95_116_111_95_118_97_114_95_115_101_116_95_118_97_114_116_121_112_101_115_95_95_91_51_93_95_48_8_p_0(Prefix_7, Type_8, Var_10, VarSet0_13, &VarSet_15, VarTypes0_14, &VarTypes_16);
    {
...
void MR_CALL 
parse_tree__var_table__add_prefix_number_var_entry_to_var_set_vartypes_8_p_0(
  MR_String Prefix_9,
  MR_Word Type_10,
  MR_Word _IsDummy_11,
  MR_Word * Var_12,
  ...
  MR_Word * STATE_VARIABLE_VarTypes_20)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_3[0]), VarNum_15, &Var_31);
  Var_39 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_31);
  Name_16 = mercury__string__f_43_43_2_f_0(Prefix_9, Var_39);
...
void MR_CALL 
parse_tree__var_table__add_entry_to_var_db_4_p_0(
  MR_Word Entry_5,
  MR_Word * Var_6,
...
void MR_CALL 
parse_tree__var_table__lookup_var_name_in_source_3_p_0(
  ...
  MR_String * Name_6)
{
  if (((MR_tag((MR_Word) VarNameSrc_4)) == (MR_Integer) 1))
  {
    ...
    MR_Word Entry_9;
    MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable_8, (MR_Integer) 1))));
    MR_Box conv0_Entry_9;

    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_14, ((MR_Box) (Var_5)), &conv0_Entry_9);
...
MR_bool MR_CALL 
parse_tree__var_table__search_var_name_in_source_3_p_0(
  MR_Word VarNameSrc_4,
  MR_Word Var_5,
  MR_String * Name_6)
{
  ...
  if (((MR_tag((MR_Word) VarNameSrc_4)) == (MR_Integer) 1))
  {
    MR_Word VarTable_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarNameSrc_4, (MR_Integer) 0))));
    MR_Word Entry_9;
    MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable_8, (MR_Integer) 1))));
    MR_Box conv0_Entry_9;

    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_16, ((MR_Box) (Var_5)), &conv0_Entry_9);
    if (succeeded)
    {
      Entry_9 = ((MR_Word) (conv0_Entry_9));
      succeeded = MR_TRUE;
    ...
    if (succeeded)
    {
      *Name_6 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_9, (MR_Integer) 0))));
...
void MR_CALL 
parse_tree__var_table__lookup_var_types_in_source_3_p_0(
...
void MR_CALL 
parse_tree__var_table__lookup_var_type_in_source_3_p_0(
  MR_Word VarTypeSrc_4,
  MR_Word Var_5,
  MR_Word * Type_6)
{
  if (((MR_tag((MR_Word) VarTypeSrc_4)) == (MR_Integer) 1))
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_18, ((MR_Box) (Var_5)), &conv0_Entry_12);
  ...
  MR_Box * STATE_VARIABLE_Acc_9)
{
  ...
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), TypeInfo_for_T_13, (MR_Word) (&parse_tree__var_table_scalar_common_1[0]), Pred_5, Var_10, STATE_VARIABLE_Acc_0_8, STATE_VARIABLE_Acc_9);
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__var_table__apply_rec_subst_to_type_in_vte_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Entry_6);
  *wrapper_arg_2 = ((MR_Box) (conv0_Entry_6));
}

void MR_CALL 
parse_tree__var_table__apply_rec_subst_to_var_table_3_p_0(
  MR_Word Subst_4,
  ...
  MR_Word * STATE_VARIABLE_VarTable_7)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__var_table_scalar_common_4[1]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__var_table__apply_rec_subst_to_var_table_3_p_0_1));
  ...
  mercury__map__map_values_only_3_p_0((MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), (MR_Word) (&parse_tree__var_table_scalar_common_1[0]), Var_8, VarTableMap0_14, &VarTableMap_15);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__var_table__apply_subst_to_type_in_vte_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Entry_6);
  *wrapper_arg_2 = ((MR_Box) (conv0_Entry_6));
}

void MR_CALL 
parse_tree__var_table__apply_subst_to_var_table_3_p_0(
  MR_Word Subst_4,
  MR_Word STATE_VARIABLE_VarTable_0_6,
  MR_Word * STATE_VARIABLE_VarTable_7)
{
...

  {
    Var_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__var_table_scalar_common_4[1]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__var_table__apply_subst_to_var_table_3_p_0_1));
    MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_8, 3) = ((MR_Box) (Subst_4));
  }
  Counter_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarTable_0_6, (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__var_table__apply_variable_renaming_to_type_in_vte_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Entry_6);
  *wrapper_arg_2 = ((MR_Box) (conv0_Entry_6));
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_7)
{
  ...
  {
    Var_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__var_table_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__var_table__apply_variable_renaming_to_var_table_3_p_0_1));
    MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) ((MR_Integer) 1));
  ...
  MR_Word * STATE_VARIABLE_VarTable_10)
{
  ...
  parse_tree__var_table__var_table_map_to_var_table_2_p_0(VarTableMap_8, STATE_VARIABLE_VarTable_10);
}
  ...
  MR_Word * VarTable_4)
{
  ...
  parse_tree__var_table__var_table_map_to_var_table_2_p_0(VarTableMap_5, VarTable_4);
}
  ...
  MR_Word * VarTable_6)
{
  ...
  parse_tree__var_table__var_table_map_to_var_table_2_p_0(VarTableMap_7, VarTable_6);
}
  ...
  MR_String DefaultPrefix_7)
{
  MR_String Name_8;
  MR_Word Entry_9;
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarTable_5, (MR_Integer) 1))));
  MR_Box conv0_Entry_9;

  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_13, ((MR_Box) (Var_6)), &conv0_Entry_9);
  Entry_9 = ((MR_Word) (conv0_Entry_9));
  ...
  MR_Word Var_5)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_11, ((MR_Box) (Var_5)), &conv0_Entry_7);
  ...
  MR_String DefaultPrefix_7)
{
  MR_bool succeeded;
  MR_String Name_8;
  MR_String Name0_9 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_6, (MR_Integer) 0))));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_19, ((MR_Box) (Var_6)), &conv0_Entry_13);
  ...
  MR_Word * Type_6)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_13, ((MR_Box) (Var_5)), &conv0_Entry_7);
  Entry_7 = ((MR_Word) (conv0_Entry_7));
  ...
  MR_Word Var_5)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_16, ((MR_Box) (Var_5)), &conv0_Entry_10);
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_13, ((MR_Box) (Var_6)), &conv0_Entry_8);
  ...
  MR_Word Var_5)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), Var_10, ((MR_Box) (Var_5)), &conv0_Entry_6);
  Entry_6 = ((MR_Word) (conv0_Entry_6));
  return Entry_6;
}
...
{
  MR_Word Counter0_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarTable_0_19, (MR_Integer) 0))));
  MR_Word VarTableMap0_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_VarTable_0_19, (MR_Integer) 1))));
  ...
  *Var_10 = mercury__term__force_construct_var_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarNum_14);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__var_table_scalar_common_3[0]), VarNum_14, &Var_31);
  Var_39 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_31);
  Name_16 = mercury__string__f_43_43_2_f_0(Prefix_7, Var_39);
  {
    Entry_17 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_17, 0) = ((MR_Box) (Name_16));
    MR_hl_field(MR_mktag(0), Entry_17, 1) = ((MR_Box) (Type_8));
    MR_hl_field(MR_mktag(0), Entry_17, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_9));
  }
  mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), ((MR_Box) (*Var_10)), ((MR_Box) (Entry_17)), VarTableMap0_13, &VarTableMap_18);
  {
    ...
    *STATE_VARIABLE_VarTable_20 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Counter_15));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (VarTableMap_18));
  }
}
...
void MR_CALL 
parse_tree__var_table__var_table_map_to_var_table_2_p_0(
  MR_Word VarTableMap_3,
  MR_Word * VarTable_4)
{
  MR_bool succeeded;
  MR_Integer NextAllocVarNum_6;
  MR_Word Counter_7;
  MR_Word MaxVar_5;
  MR_Box conv0_MaxVar_5;

  succeeded = mercury__map__max_key_1_f_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), VarTableMap_3, &conv0_MaxVar_5);
  if (succeeded)
  {
    MaxVar_5 = ((MR_Word) (conv0_MaxVar_5));
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
    ...
    Var_8 = mercury__term__var_to_int_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), MaxVar_5);
    NextAllocVarNum_6 = (MR_Integer) ((MR_Unsigned) Var_8 + (MR_Unsigned) 1);
  }
  else
    NextAllocVarNum_6 = (MR_Integer) 1;
  mercury__counter__init_2_p_0(NextAllocVarNum_6, &Counter_7);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *VarTable_4 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Counter_7));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (VarTableMap_3));
  }
}
...
parse_tree__var_table__deconstruct_var_table_3_p_0(
  ...
  MR_Word * Map_5)
{
  *Counter_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0))));
  *Map_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1))));
}
...
{
  {
    ...
    *HeadVar__3_3 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Counter_4));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Map_5));
  }
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__var_table____Unify____var_db_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__var_table____Compare____var_db_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__var_table____Unify____var_name_source_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__var_table____Compare____var_name_source_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__var_table____Unify____var_type_source_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__var_table____Compare____var_type_source_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__parse_tree__var_table__init_type_tables(void)
{
	...
	MR_register_type_ctor_info(&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_db_0);
	MR_register_type_ctor_info(&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_name_source_0);
	...
	MR_register_type_ctor_info(&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_type_source_0);
}
