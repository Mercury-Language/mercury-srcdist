  ...
  MR_Word * STATE_VARIABLE_VarTable_10)
{
  ...
  succeeded = mercury__map__max_key_1_f_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), VarTableMap_8, &conv0_MaxVar_13);
  if (succeeded)
  {
  ...
  MR_Word * VarTable_4)
{
  ...
  succeeded = mercury__map__max_key_1_f_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), VarTableMap_5, &conv0_MaxVar_8);
  if (succeeded)
  {
  ...
  MR_Word * VarTable_6)
{
  ...
  succeeded = mercury__map__max_key_1_f_0((MR_Word) (&parse_tree__var_table_scalar_common_1[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_entry_0), VarTableMap_7, &conv0_MaxVar_10);
  if (succeeded)
  {
