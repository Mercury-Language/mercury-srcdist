...
MR_decl_label10(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0, 2,5,6,7,8,9,10,11,12,13)
MR_decl_label10(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0, 15,16,14,19,21,22,20,25,28,29)
MR_decl_label6(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0, 30,27,34,33,37,38)
MR_decl_label2(hlds__hlds_llds__rename_vars_in_set_of_var_4_0, 2,5)
MR_decl_label3(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0, 18,4,6)
MR_decl_label2(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0, 3,4)
...
MR_decl_static(hlds__hlds_llds__rename_vars_in_set_of_var_4_0)
MR_decl_static(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0)
MR_decl_static(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0)
...
MR_decl_static(hlds__hlds_llds__IntroducedFrom__pred__rename_vars_in_set_of_var__736__1_4_0)
...
mercury_data__closure_layout__hlds__hlds_llds__rename_vars_in_set_of_var_4_0_1;
extern const MR_TypeCtorInfo_Struct mercury_data_parse_tree__prog_data__type_ctor_info_must_rename_0;
static const MR_UserClosureId
mercury_data__closure_layout__hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_1;
static const struct mercury_type_2 mercury_common_2[2] =
{
{
{
(MR_Word *) &mercury_data__closure_layout__hlds__hlds_llds__rename_vars_in_set_of_var_4_0_1,
(MR_Word *) (MR_Integer) 0
},
4,
{
MR_CTOR0_ADDR(parse_tree__prog_data, must_rename),
MR_COMMON(1,0),
MR_COMMON(0,2),
MR_COMMON(0,2)
}
...
{
{
(MR_Word *) &mercury_data__closure_layout__hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_1,
(MR_Word *) (MR_Integer) 0
},
4,
{
...
MR_BEGIN_MODULE(hlds__hlds_llds_module37)
	MR_init_entry1(hlds__hlds_llds__rename_vars_in_set_of_var_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__hlds_llds__rename_vars_in_set_of_var_4_0);
	MR_init_label2(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,2,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'rename_vars_in_set_of_var'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__hlds_llds__rename_vars_in_set_of_var_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__to_sorted_list_1_0,
		hlds__hlds_llds__rename_vars_in_set_of_var_4_0_i2);
MR_def_label(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(hlds__hlds_llds__IntroducedFrom__pred__rename_vars_in_set_of_var__736__1_4_0);
	...
	MR_np_call_localret_ent(list__map_3_0,
		hlds__hlds_llds__rename_vars_in_set_of_var_4_0_i5);
MR_def_label(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(fn__parse_tree__set_of_var__list_to_set_1_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(hlds__hlds_llds_module39)
	MR_init_entry1(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__hlds_llds__rename_vars_in_var_locn_map_4_0);
	MR_init_label2(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'rename_vars_in_var_locn_map'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(map__to_assoc_list_2_0,
		hlds__hlds_llds__rename_vars_in_var_locn_map_4_0_i3);
MR_def_label(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0,
		hlds__hlds_llds__rename_vars_in_var_locn_map_4_0_i4);
MR_def_label(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__hlds_llds_module40)
	...
	MR_init_label10(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,2,5,6,7,8,9,10,11,12,13)
	MR_init_label10(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,15,16,14,19,21,22,20,25,28,29)
	MR_init_label6(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,30,27,34,33,37,38)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,5)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__list_to_set_1_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i6);
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,6)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__to_sorted_list_1_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i7);
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,12)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,15)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0,
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,14)
	...
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_var_locn_map_4_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i19);
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,19)
	...
	MR_GOTO_LAB(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i20);
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,25)
	...
	if (MR_PTAG_TESTR(MR_sv(8),1)) {
		MR_GOTO_LAB(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i27);
	}
	MR_sv(9) = MR_r1;
	MR_sv(1) = MR_r2;
	{
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,28)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i29);
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,27)
	...
	if (MR_PTAG_TESTR(MR_sv(8),3)) {
		MR_GOTO_LAB(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i33);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(8);
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,33)
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i37);
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(9);
	...
	MR_np_call_localret_ent(hlds__hlds_llds__rename_vars_in_set_of_var_4_0,
		hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i38);
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(hlds__hlds_llds_module71)
	MR_init_entry1(hlds__hlds_llds__IntroducedFrom__pred__rename_vars_in_set_of_var__736__1_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__hlds_llds__IntroducedFrom__pred__rename_vars_in_set_of_var__736__1_4_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rename_vars_in_set_of_var__736__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__hlds_llds__IntroducedFrom__pred__rename_vars_in_set_of_var__736__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_r3 = MR_tempr2;
	MR_r4 = MR_tempr3;
	MR_np_tailcall_ent(parse_tree__prog_data__rename_var_4_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
