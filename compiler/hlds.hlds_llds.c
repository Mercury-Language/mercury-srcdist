...
MR_decl_label4(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0, 33,32,36,37)
...
MR_BEGIN_MODULE(hlds__hlds_llds_module38)
	...
	MR_init_label4(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,33,32,36,37)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,25)
	...
	if (MR_PTAG_TESTR(MR_sv(9),3)) {
		MR_GOTO_LAB(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0_i32);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(9);
