...
MR_decl_label1(__Unify___hlds__hlds_llds__need_for_loop_control_0_0, 8)
...
MR_decl_label5(__Compare___hlds__hlds_llds__abs_follow_vars_0_0, 3,2,6,10,39)
...
MR_define_entry(mercury__hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0);
	...
	MR_sv(9) = MR_tfield(0, MR_tempr2, 7);
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,7)
	...
	MR_sv(1) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_llds, abs_locn);
...
MR_BEGIN_MODULE(hlds__hlds_llds_module44)
	...
	MR_init_label5(__Compare___hlds__hlds_llds__abs_follow_vars_0_0,3,2,6,10,39)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__hlds_llds__abs_follow_vars_0_0,6)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_llds__abs_follow_vars_0_0_i39);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___hlds__hlds_llds__abs_follow_vars_0_0_i10);
MR_def_label(__Compare___hlds__hlds_llds__abs_follow_vars_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_llds__abs_follow_vars_0_0_i39);
	}
...
MR_def_label(__Compare___hlds__hlds_llds__abs_follow_vars_0_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__hlds_llds_module57)
	...
	MR_init_label1(__Unify___hlds__hlds_llds__need_for_loop_control_0_0,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__hlds_llds__need_for_loop_control_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___hlds__hlds_llds__need_for_loop_control_0_0_i8);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(__Unify___hlds__hlds_llds__need_for_loop_control_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
