...
MR_decl_label9(__Unify___hlds__hlds_llds__llds_code_gen_details_0_0, 4,6,8,10,12,14,16,20,1)
...
MR_decl_label10(__Compare___hlds__hlds_llds__llds_code_gen_details_0_0, 3,2,5,9,13,17,21,25,29,93)
...
MR_BEGIN_MODULE(hlds__hlds_llds_module51)
	...
	MR_init_label9(__Unify___hlds__hlds_llds__llds_code_gen_details_0_0,4,6,8,10,12,14,16,20,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__hlds_llds_module52)
	...
	MR_init_label10(__Compare___hlds__hlds_llds__llds_code_gen_details_0_0,3,2,5,9,13,17,21,25,29,93)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__hlds_llds__llds_code_gen_details_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_llds__llds_code_gen_details_0_0_i93);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(8);
...
MR_def_label(__Compare___hlds__hlds_llds__llds_code_gen_details_0_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
