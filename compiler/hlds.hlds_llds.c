...
MR_decl_label3(hlds__hlds_llds__goal_info_get_maybe_need_across_call_2_0, 2,10,3)
MR_decl_label3(hlds__hlds_llds__goal_info_get_maybe_need_in_par_conj_2_0, 2,10,3)
MR_decl_label3(hlds__hlds_llds__goal_info_get_maybe_need_in_resume_2_0, 2,10,3)
...
MR_decl_label3(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0, 13,4,5)
...
MR_BEGIN_MODULE(hlds__hlds_llds_module7)
	...
	MR_init_label3(hlds__hlds_llds__goal_info_get_maybe_need_across_call_2_0,2,10,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_across_call_2_0,2)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),1)) {
		MR_GOTO_LAB(hlds__hlds_llds__goal_info_get_maybe_need_across_call_2_0_i10);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r1, 0) = MR_ctfield(1, MR_tempr1, 0);
	MR_decr_sp_and_return(1);
	}
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_across_call_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__hlds_llds_module8)
	...
	MR_init_label3(hlds__hlds_llds__goal_info_get_maybe_need_in_resume_2_0,2,10,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_in_resume_2_0,2)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),2)) {
		MR_GOTO_LAB(hlds__hlds_llds__goal_info_get_maybe_need_in_resume_2_0_i10);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r1, 0) = MR_ctfield(2, MR_tempr1, 0);
	MR_decr_sp_and_return(1);
	}
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_in_resume_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(1);
...
MR_BEGIN_MODULE(hlds__hlds_llds_module9)
	...
	MR_init_label3(hlds__hlds_llds__goal_info_get_maybe_need_in_par_conj_2_0,2,10,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_in_par_conj_2_0,2)
	...
	MR_r2 = MR_ctfield(0, MR_ctfield(1, MR_r1, 0), 7);
	if (MR_INT_EQ(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(hlds__hlds_llds__goal_info_get_maybe_need_in_par_conj_2_0_i10);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(1);
MR_def_label(hlds__hlds_llds__goal_info_get_maybe_need_in_par_conj_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r1, 0) = MR_ctfield(3, MR_r2, 0);
	MR_decr_sp_and_return(1);
...
MR_BEGIN_MODULE(hlds__hlds_llds_module35)
	...
	MR_init_label3(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(hlds__hlds_llds__rename_vars_in_var_locn_list_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,23)
	...
	MR_tfield(0, MR_tempr3, 4) = MR_sv(7);
	MR_tfield(0, MR_tempr3, 5) = MR_sv(8);
	MR_tfield(0, MR_tempr3, 6) = MR_sv(9);
	MR_tfield(0, MR_tempr3, 7) = MR_tempr2;
	MR_decr_sp_and_return(12);
	}
...
MR_def_label(hlds__hlds_llds__rename_vars_in_llds_code_gen_info_4_0,28)
	...
	MR_tfield(0, MR_tempr2, 6) = MR_sv(9);
	MR_tfield(0, MR_tempr2, 7) = MR_tempr1;
	MR_decr_sp_and_return(12);
	}
#ifdef MR_maybe_local_thread_engine_base
