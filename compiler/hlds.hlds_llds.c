  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__11_11 = (MR_Word) (&hlds__hlds_llds_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__12_12 = (MR_Word) (&hlds__hlds_llds_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&hlds__hlds_llds_scalar_common_1[1]);
