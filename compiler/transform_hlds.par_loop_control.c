...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__par_loop_control__libs__dependency_graph__pti_dependency_info_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
static void MR_CALL 
transform_hlds__par_loop_control__IntroducedFrom__pred__update_outer_proc__1366__1_3_p_0(
  MR_Word Remap_22,
  MR_Word HeadVar__2_104,
  MR_Word * HeadVar__3_105);

static MR_bool MR_CALL 
transform_hlds__par_loop_control__IntroducedFrom__pred__goal_update_non_loop_control_paths__1140__1_2_p_0(
  MR_Word RecPredProcId_41,
  MR_Word HeadVar__2_81);

static MR_bool MR_CALL 
transform_hlds__par_loop_control__IntroducedFrom__pred__goal_update_non_loop_control_paths__1151__1_2_p_0(
  MR_Word ConjType_48,
...
static /* final */ const MR_Box transform_hlds__par_loop_control_scalar_common_4[3][9] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 6)),
    ((MR_Box) (&transform_hlds__par_loop_control__libs__dependency_graph__pti_dependency_info_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0)),
  ...
  MR_Word HeadVar__2_81)
{
  ...
  succeeded = hlds__pred_proc_id____Unify____pred_proc_id_0_0(RecPredProcId_41, HeadVar__2_81);
  return succeeded;
}
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    hlds__pred_proc_id____Compare____pred_proc_id_0_0(&SubResult9_30, ArgX9_28, ArgY9_29);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    succeeded = hlds__pred_proc_id____Unify____pred_proc_id_0_0(ArgX9_19, ArgY9_20);
                    if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_VarTable_25)
{
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(LastConjunct_16, &LastConjGoals_19);
  ...
  hlds__goal_list_util__create_conj_from_list_3_p_0(Conjuncts_21, (MR_Integer) 0, &Goal0_22);
    ...
    case (MR_Integer) 2:
      {
        ...
        succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(CallPredId0_14, Var_211);
        if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_VarTable_6)
{
  ...
  else
  {
    ...
    hlds__goal_list_util__goal_to_conj_list_2_p_0(Conjunct0_14, &Conjunct0Goals_23);
    ...
    hlds__goal_list_util__conj_list_to_goal_3_p_0(ConjunctGoals_24, ScopeGoalInfo_28, &Conjunct_27);
    {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_22)
{
  ...
  hlds__hlds_proc__proc_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &HasParallelConj_24);
  succeeded = (HasParallelConj_24 == (MR_Integer) 0);
  if (succeeded)
  {
    hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &Detism_25);
    switch (Detism_25) {
      default:
        succeeded = MR_FALSE;
        break;
    ...
    if (succeeded)
    {
      TypeCtorInfo_12_33 = (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &Body0_11);
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &VarTable_12);
    ...
    hlds__hlds_proc__proc_info_set_goal_3_p_0(Body_14, STATE_VARIABLE_ProcInfo_0_19, &STATE_VARIABLE_ProcInfo_1_23);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__par_loop_control__IntroducedFrom__pred__update_outer_proc__1366__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_105);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_48)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_47, &HeadVars0_16);
  hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_47, &Detism_17);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_47, &OrigGoal_18);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_47, &OldVarTable_21);
  {
  ...
  hlds__hlds_proc__proc_info_set_headvars_3_p_0(HeadVars_23, STATE_VARIABLE_ProcInfo_0_47, &STATE_VARIABLE_ProcInfo_1_55);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_1_55, &RttiVarmaps0_24);
  ...
  hlds__hlds_rtti__apply_renamings_and_subst_to_rtti_varmaps_5_p_0(Var_56, Var_57, Remap_22, RttiVarmaps0_24, &RttiVarmaps_25);
  hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarmaps_25, STATE_VARIABLE_ProcInfo_1_55, &STATE_VARIABLE_ProcInfo_2_58);
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Body_45, STATE_VARIABLE_ProcInfo_2_58, &STATE_VARIABLE_ProcInfo_3_91);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_4_74, STATE_VARIABLE_ProcInfo_3_91, STATE_VARIABLE_ProcInfo_48);
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__par_loop_control__IntroducedFrom__pred__remap_instmap__1455__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_19);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_58)
{
  ...
  Var_59 = hlds__pred_proc_id__proc_id_to_int_1_f_0(OldProcId_17);
  {
  ...
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(OldProcInfo_11, &ArgModes0_38);
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(OldProcInfo_11, &HeadVars0_39);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(OldProcInfo_11, &STATE_VARIABLE_VarTable_1_76);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(OldProcInfo_11, &STATE_VARIABLE_Body_1_77);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_105, (MR_Integer) 686, &PreserveTailRecursionBool_106);
  ...
  hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(OldProcInfo_11, &InstVarSet_53);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(OldProcInfo_11, &RttiVarMaps_54);
  hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(OldProcInfo_11, &Detism_55);
  ...
  hlds__hlds_proc__proc_info_create_14_p_0(Context_23, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_VarTable_3_85, HeadVars_48, InstVarSet_53, ArgModes_52, (MR_Integer) 2, Detism_55, STATE_VARIABLE_Body_3_86, RttiVarMaps_54, (MR_Integer) 1, (MR_Integer) 0, Var_94, &ProcInfo_56);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__par_loop_control__IntroducedFrom__pred__goal_update_non_loop_control_paths__1140__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__par_loop_control__IntroducedFrom__pred__goal_update_non_loop_control_paths__1151__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__succeeded = hlds__pred_proc_id____Unify____pred_proc_id_0_0((env_ptr)->transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__Callee_106, (env_ptr)->transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__Var_197);
  ...
  (env).transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__STATE_VARIABLE_Goal_0_70 = STATE_VARIABLE_Goal_0_70;
  {
    ...
    else
    {
      ...
      if ((env).transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__succeeded)
      {
        ...
        hlds__goal_list_util__goal_to_conj_list_2_p_0((env).transform_hlds__par_loop_control__goal_update_non_loop_control_paths_5_p_0_env_0__STATE_VARIABLE_Goal_0_70, &Conjs0_13);
        ...
        hlds__goal_list_util__conj_list_to_goal_3_p_0(Conjs_15, GoalInfo0_10, &STATE_VARIABLE_Goal_1_74);
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(PredId_17, Var_64);
          if (succeeded)
