  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_22)
{
  ...
  MR_Word DepGraph_34;
  MR_Word SelfKey_35;
  MR_Word DepGraphWOSelfEdge_36;
  MR_Word TCDepGraphWOSelfEdge_37;

  hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &HasParallelConj_30);
  succeeded = (HasParallelConj_30 == (MR_Integer) 0);
  if (succeeded)
  {
    hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &Detism_31);
    switch (Detism_31) {
      default:
        succeeded = MR_FALSE;
        break;
    ...
    if (succeeded)
    {
      TypeCtorInfo_12_41 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
      DepGraph_34 = libs__dependency_graph__dependency_info_get_graph_1_f_0(TypeCtorInfo_12_41, DepInfo_7);
      mercury__digraph__lookup_key_3_p_0(TypeCtorInfo_12_41, DepGraph_34, ((MR_Box) (PredProcId_8)), &SelfKey_35);
      succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo_12_41, DepGraph_34, SelfKey_35, SelfKey_35);
      if (succeeded)
      {
        mercury__digraph__delete_edge_4_p_0(TypeCtorInfo_12_41, SelfKey_35, SelfKey_35, DepGraph_34, &DepGraphWOSelfEdge_36);
        mercury__digraph__tc_2_p_0(TypeCtorInfo_12_41, DepGraphWOSelfEdge_36, &TCDepGraphWOSelfEdge_37);
        succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo_12_41, TCDepGraphWOSelfEdge_37, SelfKey_35, SelfKey_35);
        succeeded = !(succeeded);
      }
    }
  }
