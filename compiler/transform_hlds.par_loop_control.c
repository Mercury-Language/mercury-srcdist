...
#line 171 "transform_hlds.par_loop_control.c"
...
#line 174 "transform_hlds.par_loop_control.c"
...
#line 177 "transform_hlds.par_loop_control.c"
...
#line 1479 "transform_hlds.par_loop_control.c"
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__par_loop_control__hlds__hlds_module__pti_dependency_info_1__plain_hlds__hlds_pred__type_ctor_info_pred_proc_id_0 = {
...
#line 1561 "transform_hlds.par_loop_control.c"
static const MR_EnumFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_functor_desc_fixup_goal_info_0_1 = {
...
#line 1606 "transform_hlds.par_loop_control.c"
static const MR_EnumFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_functor_desc_goal_is_last_goal_on_path_0_0 = {
  (MR_String) "goal_is_last_goal_on_path",
  (MR_Integer) 0
};

#line 1612 "transform_hlds.par_loop_control.c"
static const MR_EnumFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_functor_desc_goal_is_last_goal_on_path_0_1 = {
  (MR_String) "goal_is_not_last_goal_on_path",
  (MR_Integer) 1
};

#line 1618 "transform_hlds.par_loop_control.c"
static const MR_EnumFunctorDescPtr transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_value_ordered_goal_is_last_goal_on_path_0[2] = {
...
#line 1624 "transform_hlds.par_loop_control.c"
static const MR_EnumFunctorDescPtr transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_name_ordered_goal_is_last_goal_on_path_0[2] = {
  &transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_functor_desc_goal_is_last_goal_on_path_0_0,
  &transform_hlds__par_loop_control__transform_hlds__par_loop_control__enum_functor_desc_goal_is_last_goal_on_path_0_1
};

#line 1630 "transform_hlds.par_loop_control.c"
static const MR_Integer transform_hlds__par_loop_control__transform_hlds__par_loop_control__functor_number_map_goal_is_last_goal_on_path_0[2] = {
  (MR_Integer) 0,
  (MR_Integer) 1
};

#line 1636 "transform_hlds.par_loop_control.c"
...
#line 1796 "transform_hlds.par_loop_control.c"
static const MR_DuFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_functor_desc_seen_usable_recursion_0_0 = {
...
#line 1811 "transform_hlds.par_loop_control.c"
static const MR_DuFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_functor_desc_seen_usable_recursion_0_1 = {
...
#line 1826 "transform_hlds.par_loop_control.c"
static const MR_DuFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_functor_desc_seen_usable_recursion_0_2 = {
...
#line 1854 "transform_hlds.par_loop_control.c"
static const MR_DuFunctorDesc transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_functor_desc_seen_usable_recursion_0_3 = {
...
#line 1869 "transform_hlds.par_loop_control.c"
static const MR_DuFunctorDescPtr transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_stag_ordered_seen_usable_recursion_0_0[3] = {
...
#line 1881 "transform_hlds.par_loop_control.c"
static const MR_DuPtagLayout transform_hlds__par_loop_control__transform_hlds__par_loop_control__du_ptag_ordered_seen_usable_recursion_0[2] = {
  {
    (MR_Integer) 3,
    mercury__private_builtin__MR_SECTAG_LOCAL,
...
#line 1911 "transform_hlds.par_loop_control.c"
...
#line 2352 "transform_hlds.par_loop_control.c"
...
#line 2376 "transform_hlds.par_loop_control.c"
              *transform_hlds__par_loop_control__HeadVar__1_1 = (MR_Integer) 1;
#line 210 "par_loop_control.m"
      else
#line 210 "par_loop_control.m"
...
#line 2400 "transform_hlds.par_loop_control.c"
                *transform_hlds__par_loop_control__HeadVar__1_1 = (MR_Integer) 1;
#line 210 "par_loop_control.m"
        else
#line 210 "par_loop_control.m"
...
#line 2424 "transform_hlds.par_loop_control.c"
                  *transform_hlds__par_loop_control__HeadVar__1_1 = (MR_Integer) 1;
#line 210 "par_loop_control.m"
          else
#line 210 "par_loop_control.m"
...
#line 210 "par_loop_control.m"
                  if ((transform_hlds__par_loop_control__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)))))
#line 2447 "transform_hlds.par_loop_control.c"
                    *transform_hlds__par_loop_control__HeadVar__1_1 = (MR_Integer) 2;
#line 210 "par_loop_control.m"
                  else
#line 210 "par_loop_control.m"
...
#line 2562 "transform_hlds.par_loop_control.c"
                  {
#line 2564 "transform_hlds.par_loop_control.c"
...
#line 2619 "transform_hlds.par_loop_control.c"
  {
#line 2621 "transform_hlds.par_loop_control.c"
...
#line 2624 "transform_hlds.par_loop_control.c"
    return transform_hlds__par_loop_control__succeeded;
#line 2626 "transform_hlds.par_loop_control.c"
  }
#line 688 "par_loop_control.m"
}
...
#line 674 "par_loop_control.m"
    if (transform_hlds__par_loop_control__succeeded)
#line 2655 "transform_hlds.par_loop_control.c"
      *transform_hlds__par_loop_control__HeadVar__1_1 = (MR_Integer) 0;
#line 674 "par_loop_control.m"
    else
#line 674 "par_loop_control.m"
...
#line 2709 "transform_hlds.par_loop_control.c"
...
#line 2729 "transform_hlds.par_loop_control.c"
...
#line 2769 "transform_hlds.par_loop_control.c"
...
#line 2789 "transform_hlds.par_loop_control.c"
...
#line 2813 "transform_hlds.par_loop_control.c"
...
#line 2833 "transform_hlds.par_loop_control.c"
...
#line 2853 "transform_hlds.par_loop_control.c"
...
#line 2873 "transform_hlds.par_loop_control.c"
...
#line 2984 "transform_hlds.par_loop_control.c"
        {
#line 2986 "transform_hlds.par_loop_control.c"
...
#line 2995 "transform_hlds.par_loop_control.c"
            {
#line 2997 "transform_hlds.par_loop_control.c"
...
#line 3037 "transform_hlds.par_loop_control.c"
                                {
#line 3039 "transform_hlds.par_loop_control.c"
...
#line 3186 "transform_hlds.par_loop_control.c"
  {
#line 3188 "transform_hlds.par_loop_control.c"
    MR_bool transform_hlds__par_loop_control__succeeded = (transform_hlds__par_loop_control__HeadVar__2_1 == transform_hlds__par_loop_control__HeadVar__2_2);

#line 3191 "transform_hlds.par_loop_control.c"
    return transform_hlds__par_loop_control__succeeded;
#line 3193 "transform_hlds.par_loop_control.c"
  }
#line 1303 "par_loop_control.m"
}
...
#line 3536 "transform_hlds.par_loop_control.c"
...
#line 3826 "transform_hlds.par_loop_control.c"
...
#line 3857 "transform_hlds.par_loop_control.c"
...
#line 3864 "transform_hlds.par_loop_control.c"
...
#line 3906 "transform_hlds.par_loop_control.c"
...
#line 5916 "transform_hlds.par_loop_control.c"
...
#line 6817 "transform_hlds.par_loop_control.c"
...
#line 7065 "transform_hlds.par_loop_control.c"
...
#line 7308 "transform_hlds.par_loop_control.c"
...
#line 7642 "transform_hlds.par_loop_control.c"
        {
#line 7644 "transform_hlds.par_loop_control.c"
...
#line 7647 "transform_hlds.par_loop_control.c"
        {
#line 7649 "transform_hlds.par_loop_control.c"
...
#line 725 "par_loop_control.m"
                      {
#line 7833 "transform_hlds.par_loop_control.c"
...
#line 8029 "transform_hlds.par_loop_control.c"
...
#line 8146 "transform_hlds.par_loop_control.c"
                    {
#line 8148 "transform_hlds.par_loop_control.c"
...
#line 8151 "transform_hlds.par_loop_control.c"
                    {
#line 8153 "transform_hlds.par_loop_control.c"
...
#line 8717 "transform_hlds.par_loop_control.c"
...
#line 9121 "transform_hlds.par_loop_control.c"
...
#line 9146 "transform_hlds.par_loop_control.c"
                  {
#line 455 "par_loop_control.m"
                    /* direct tailcall eliminated */
#line 455 "par_loop_control.m"
...
#line 9165 "transform_hlds.par_loop_control.c"
                else
...
#line 9177 "transform_hlds.par_loop_control.c"
                  if ((transform_hlds__par_loop_control__STATE_VARIABLE_SeenUsableRecursion_0_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
#line 455 "par_loop_control.m"
                    {
#line 455 "par_loop_control.m"
...
#line 9200 "transform_hlds.par_loop_control.c"
                  else
...
#line 9501 "transform_hlds.par_loop_control.c"
...
#line 9557 "transform_hlds.par_loop_control.c"
            if (transform_hlds__par_loop_control__succeeded)
#line 9559 "transform_hlds.par_loop_control.c"
              {
#line 359 "par_loop_control.m"
                if ((((transform_hlds__par_loop_control__Detism_9 == (MR_Integer) 4)) || ((transform_hlds__par_loop_control__Detism_9 == (MR_Integer) 0))))
#line 358 "par_loop_control.m"
...
#line 9571 "transform_hlds.par_loop_control.c"
            else
...
#line 9579 "transform_hlds.par_loop_control.c"
...
#line 9585 "transform_hlds.par_loop_control.c"
...
#line 9599 "transform_hlds.par_loop_control.c"
...
#line 9652 "transform_hlds.par_loop_control.c"
                  {
...
#line 9659 "transform_hlds.par_loop_control.c"
                    if (transform_hlds__par_loop_control__succeeded)
#line 286 "par_loop_control.m"
                      *transform_hlds__par_loop_control__SeenUsableRecursion_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
#line 9663 "transform_hlds.par_loop_control.c"
                    else
...
#line 9671 "transform_hlds.par_loop_control.c"
...
#line 9687 "transform_hlds.par_loop_control.c"
...
#line 9705 "transform_hlds.par_loop_control.c"
...
#line 9739 "transform_hlds.par_loop_control.c"
                        else
...
#line 9753 "transform_hlds.par_loop_control.c"
...
#line 9783 "transform_hlds.par_loop_control.c"
                          {
...
#line 9802 "transform_hlds.par_loop_control.c"
                            MR_Word transform_hlds__par_loop_control__V_58_58;
...
#line 9828 "transform_hlds.par_loop_control.c"
...
#line 9842 "transform_hlds.par_loop_control.c"
...
#line 9870 "transform_hlds.par_loop_control.c"
                          }
#line 370 "par_loop_control.m"
    else
...
#line 178 "par_loop_control.m"
          {
#line 9951 "transform_hlds.par_loop_control.c"
