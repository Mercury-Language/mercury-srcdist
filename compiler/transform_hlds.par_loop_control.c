          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_45, Var_46);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 694, &PreserveTailRecursionBool_6);
