...
{
  {
    ...
    {
      hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 13, transform_hlds__par_loop_control__STATE_VARIABLE_Markers_66_66, &transform_hlds__par_loop_control__STATE_VARIABLE_Markers_68_68);
    }
    {
      hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, transform_hlds__par_loop_control__STATE_VARIABLE_Markers_68_68, &transform_hlds__par_loop_control__Markers_26);
    }
    {
