  ...
  MR_Word * HeadVar__3_106)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&transform_hlds__par_loop_control_scalar_common_1[0]), (MR_Word) (&transform_hlds__par_loop_control_scalar_common_1[0]), Remap_22, ((MR_Box) (HeadVar__2_105)), &conv0_HeadVar__3_106);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__13_13 = (MR_Word) (&transform_hlds__par_loop_control_scalar_common_1[2]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__26_26 = (MR_Word) (&transform_hlds__par_loop_control_scalar_common_1[0]);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeCtorInfo__97_97 = (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0);
              succeeded = mercury__list__index1_3_p_0(TypeCtorInfo__97_97, Conjs0_19, N_18, &conv0_Conj0_20);
              if (succeeded)
              {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                TypeCtorInfo__100_100 = (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0);
                succeeded = mercury__list__index1_3_p_0(TypeCtorInfo__100_100, Cases0_28, N_80, &conv1_Case0_29);
                if (succeeded)
                {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &HasParallelConj_25);
  succeeded = (HasParallelConj_25 == (MR_Integer) 0);
  if (succeeded)
  {
    hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &Detism_26);
    switch (Detism_26) {
      default:
        succeeded = MR_FALSE;
        break;
    ...
    if (succeeded)
    {
      TypeCtorInfo__12_34 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
      DepGraph_27 = libs__dependency_graph__dependency_info_get_graph_1_f_0(TypeCtorInfo__12_34, DepInfo_7);
      mercury__digraph__lookup_key_3_p_0(TypeCtorInfo__12_34, DepGraph_27, ((MR_Box) (PredProcId_8)), &SelfKey_28);
      succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo__12_34, DepGraph_27, SelfKey_28, SelfKey_28);
      if (succeeded)
      {
        mercury__digraph__delete_edge_4_p_0(TypeCtorInfo__12_34, SelfKey_28, SelfKey_28, DepGraph_27, &DepGraphWOSelfEdge_29);
        mercury__digraph__tc_2_p_0(TypeCtorInfo__12_34, DepGraphWOSelfEdge_29, &TCDepGraphWOSelfEdge_30);
        succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo__12_34, TCDepGraphWOSelfEdge_30, SelfKey_28, SelfKey_28);
        succeeded = !(succeeded);
      }
    }
  }
  if (succeeded)
  {
    ...
    MR_Word Body_15;
    MR_Word RecursiveParConjIds_16;
    MR_Word STATE_VARIABLE_ProcInfo_24_24;
    MR_Word _VarSet_12;

    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &Body0_11);
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_20, &_VarSet_12, &VarTypes_13);
    hlds__goal_path__fill_goal_id_slots_in_proc_body_5_p_0(STATE_VARIABLE_ModuleInfo_0_22, VarTypes_13, &ContainingGoalMap_14, Body0_11, &Body_15);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(Body_15, STATE_VARIABLE_ProcInfo_0_20, &STATE_VARIABLE_ProcInfo_24_24);
    transform_hlds__par_loop_control__goal_get_loop_control_par_conjs_3_p_0(Body_15, PredProcId_8, &RecursiveParConjIds_16);
    switch (MR_tag((MR_Word) RecursiveParConjIds_16)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        switch (MR_unmkbody(RecursiveParConjIds_16)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *STATE_VARIABLE_ProcInfo_21 = STATE_VARIABLE_ProcInfo_24_24;
      ...
      case (MR_Integer) 1:
        {
          MR_Word GoalIds_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RecursiveParConjIds_16, (MR_Integer) 0))));
          MR_Word InnerPredProcId_18;
          MR_Word InnerPredName_19;

          transform_hlds__par_loop_control__create_inner_proc_8_p_0(GoalIds_17, PredProcId_8, STATE_VARIABLE_ProcInfo_24_24, ContainingGoalMap_14, &InnerPredProcId_18, &InnerPredName_19, STATE_VARIABLE_ModuleInfo_0_22, STATE_VARIABLE_ModuleInfo_23);
          transform_hlds__par_loop_control__update_outer_proc_6_p_0(PredProcId_8, InnerPredProcId_18, InnerPredName_19, *STATE_VARIABLE_ModuleInfo_23, STATE_VARIABLE_ProcInfo_24_24, STATE_VARIABLE_ProcInfo_21);
        }
        break;
    }
  }
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__par_loop_control__IntroducedFrom__pred__update_outer_proc__1361__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_106);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_48)
{
  ...
  Var_112 = mdbcomp__builtin_modules__mercury_par_builtin_module_0_f_0();
  hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(ModuleInfo_10, Var_112, (MR_String) "lc_default_num_contexts", (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_Integer) 1))), (MR_Word) ((MR_Unsigned) 0U), &LCDefaultNumContextsPredId_28, &LCDefaultNumContextsProcId_29);
  {
  ...
  Var_116 = mdbcomp__builtin_modules__mercury_par_builtin_module_0_f_0();
  {
    Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (Var_116));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_58)
{
  ...
  MR_Word Var_104;
  MR_Word Globals_106;
  MR_Word PreserveTailRecursionBool_107;
  MR_Word Var_109;
  MR_Word Var_111;
  MR_Word Var_46;
  ...
  {
    Sym_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Sym_101, 0) = ((MR_Box) (Var_104));
    MR_hl_field(MR_mktag(1), Sym_101, 1) = ((MR_Box) ((MR_String) "loop_control"));
  }
  {
    Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (Sym_101));
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_75_75, &Globals_106);
  libs__globals__lookup_bool_option_3_p_0(Globals_106, (MR_Integer) 712, &PreserveTailRecursionBool_107);
  switch (PreserveTailRecursionBool_107) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  Var_109 = mdbcomp__builtin_modules__mercury_par_builtin_module_0_f_0();
  {
    Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (Var_109));
  ...
  {
    Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (Var_111));
...
{
  MR_Box closure = closure_arg;
  MR_Word conv1_STATE_VARIABLE_ProcInfo_21;
  MR_Word conv0_STATE_VARIABLE_ModuleInfo_23;

  transform_hlds__par_loop_control__maybe_par_loop_control_proc_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ProcInfo_21, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_ModuleInfo_23);
  *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ProcInfo_21));
