...
{
  {
    ...
    mercury__list__foldl3_corresponding_9_p_0(TypeInfo_110_110, TypeCtorInfo_111_111, (MR_Word) &transform_hlds__par_loop_control_scalar_common_1[1], (MR_Word) &transform_hlds__par_loop_control_scalar_common_2[0], (MR_Word) &transform_hlds__par_loop_control_scalar_common_2[1], Var_51, HeadVars0_16, HeadVarTypes_15, ((MR_Box) (STATE_VARIABLE_VarSet_49_49)), &conv5_STATE_VARIABLE_VarSet_52_52, ((MR_Box) (STATE_VARIABLE_VarTypes_50_50)), &conv4_STATE_VARIABLE_VarTypes_53_53, ((MR_Box) (Var_54)), &conv3_Remap_23);
...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) &transform_hlds__par_loop_control_scalar_common_2[2], (MR_Word) &hlds__instmap__hlds__instmap__type_ctor_info_instmap_0, Var_15, VarInsts_7, ((MR_Box) (STATE_VARIABLE_InstmapDelta_14_14)), &conv1_STATE_VARIABLE_InstmapDelta_13);
...
{
  {
    ...
    Var_72 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
        ...
        case (MR_Integer) 0:
          {
            ...
            transform_hlds__par_loop_control__goal_get_loop_control_par_conjs_3_p_0(SubGoal_43, SelfPredProcId_5, &SeenUsableRecursion0_93);
                              ...
                              case (MR_Integer) 1:
                                {
                                  ...
                                  {
                                    SeenUsableRecursion0_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      transform_hlds__par_loop_control__conj_get_loop_control_par_conjs_4_p_0(Conjs_36, SelfPredProcId_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &SeenUsableRecursion0_89);
            ...
            case (MR_Integer) 4:
              {
                ...
                {
                  MR_Word TypeCtorInfo_10_88 = (MR_Word) &transform_hlds__par_loop_control__transform_hlds__par_loop_control__type_ctor_info_seen_usable_recursion_0;
                  MR_Word Seen_81 = ((MR_Word) (MR_hl_field(MR_mktag(1), SeenUsableRecursionCases_42, (MR_Integer) 0)));
                  MR_Word Seens_82 = ((MR_Word) (MR_hl_field(MR_mktag(1), SeenUsableRecursionCases_42, (MR_Integer) 1)));
                  MR_Word SeenUsableRecursion0_102;
                  MR_Box conv2_SeenUsableRecursion0_102;

                  mercury__list__foldl_4_p_0(TypeCtorInfo_10_88, TypeCtorInfo_10_88, (MR_Word) &transform_hlds__par_loop_control_scalar_common_2[3], Seens_82, ((MR_Box) (Seen_81)), &conv2_SeenUsableRecursion0_102);
            ...
            case (MR_Integer) 5:
              {
                ...
                MR_Word SeenUsableRecursion0_95;
                MR_Word Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1)));

                transform_hlds__par_loop_control__goal_get_loop_control_par_conjs_3_p_0(SubGoal_60, SelfPredProcId_5, &SeenUsableRecursion0_95);
                switch (MR_tag((MR_Word) SeenUsableRecursion0_95)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    switch (MR_unmkbody(SeenUsableRecursion0_95)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                      case (MR_Integer) 2:
                        *SeenUsableRecursion_6 = SeenUsableRecursion0_95;
                        break;
                      case (MR_Integer) 1:
                        switch (Detism_9) {
                          default: /*NOTREACHED*/ MR_assert(0);
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          transform_hlds__par_loop_control__merge_loop_control_par_conjs_between_branches_3_p_0(SeenUsableRecursionThen_50, SeenUsableRecursionElse_51, &SeenUsableRecursion0_92);
