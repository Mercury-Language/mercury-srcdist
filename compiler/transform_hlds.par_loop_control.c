...
static /* final */ const MR_Box transform_hlds__par_loop_control_scalar_common_1[4][2] = {
  ...
  /* row   3 */
  {
    ((MR_Box) (MR_mkword(3, &transform_hlds__par_loop_control_scalar_common_2[2]))),
    ((MR_Box) (MR_mkword(3, &transform_hlds__par_loop_control_scalar_common_2[2])))
  },
};
        ...
        case (MR_Integer) 0:
          {
            ...
            GoalExpr_238 = (MR_Word) ((MR_Word) (SubGoal_100));
            {
              ...
              MR_hl_field(0, STATE_VARIABLE_Goal_138_237, 0) = ((MR_Box) (GoalExpr_238));
              MR_hl_field(0, STATE_VARIABLE_Goal_138_237, 1) = ((MR_Box) (GoalInfo_13));
            }
            ...
            case (MR_Integer) 2:
              {
                ...
                Conjs_88 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), EarlierConjs_83, Var_124);
                {
                  ...
                  MR_hl_field(3, GoalExpr_232, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                  MR_hl_field(3, GoalExpr_232, 1) = (MR_Box) ((MR_Unsigned) (ConjType_76));
                  MR_hl_field(3, GoalExpr_232, 2) = ((MR_Box) (Conjs_88));
                }
                {
                  STATE_VARIABLE_Goal_138_231 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_231, 0) = ((MR_Box) (GoalExpr_232));
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_231, 1) = ((MR_Box) (GoalInfo_13));
                }
                switch (*FixupGoalInfo_11) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
            ...
            case (MR_Integer) 3:
              {
                ...
                {
                  GoalExpr_234 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, GoalExpr_234, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                  MR_hl_field(3, GoalExpr_234, 1) = ((MR_Box) (Disjs_90));
                }
                {
                  STATE_VARIABLE_Goal_138_233 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_233, 0) = ((MR_Box) (GoalExpr_234));
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_233, 1) = ((MR_Box) (GoalInfo_13));
                }
                switch (*FixupGoalInfo_11) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
            ...
            case (MR_Integer) 4:
              {
                ...
                {
                  GoalExpr_242 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, GoalExpr_242, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                  MR_hl_field(3, GoalExpr_242, 1) = ((MR_Box) (Var_93));
                  MR_hl_field(3, GoalExpr_242, 2) = (MR_Box) ((MR_Unsigned) (CanFail_94));
                  MR_hl_field(3, GoalExpr_242, 3) = ((MR_Box) (Cases_96));
                }
                {
                  STATE_VARIABLE_Goal_138_241 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_241, 0) = ((MR_Box) (GoalExpr_242));
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_241, 1) = ((MR_Box) (GoalInfo_13));
                }
                switch (*FixupGoalInfo_11) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
            ...
            case (MR_Integer) 5:
              {
                ...
                {
                  GoalExpr_240 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, GoalExpr_240, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                  MR_hl_field(3, GoalExpr_240, 1) = ((MR_Box) (Reason_101));
                  MR_hl_field(3, GoalExpr_240, 2) = ((MR_Box) (SubGoal_143));
                }
                {
                  STATE_VARIABLE_Goal_138_239 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_239, 0) = ((MR_Box) (GoalExpr_240));
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_239, 1) = ((MR_Box) (GoalInfo_13));
                }
                switch (*FixupGoalInfo_11) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
            ...
            case (MR_Integer) 6:
              {
                ...
                {
                  GoalExpr_236 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, GoalExpr_236, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                  MR_hl_field(3, GoalExpr_236, 1) = ((MR_Box) (Vars_102));
                  MR_hl_field(3, GoalExpr_236, 2) = ((MR_Box) (Cond_106));
                  MR_hl_field(3, GoalExpr_236, 3) = ((MR_Box) (Then_109));
                  MR_hl_field(3, GoalExpr_236, 4) = ((MR_Box) (Else_112));
                }
                {
                  STATE_VARIABLE_Goal_138_235 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_235, 0) = ((MR_Box) (GoalExpr_236));
                  MR_hl_field(0, STATE_VARIABLE_Goal_138_235, 1) = ((MR_Box) (GoalInfo_13));
                }
                switch (*FixupGoalInfo_11) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_58)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_105, (MR_Integer) 720, &PreserveTailRecursionBool_106);
  ...
  }
  {
    ...
    MR_hl_field(1, ArgModes_52, 0) = ((MR_Box) (&transform_hlds__par_loop_control_scalar_common_1[3]));
