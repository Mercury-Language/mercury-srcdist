...
{
  {
    ...
    Var_58 = hlds__hlds_pred__proc_id_to_int_1_f_0(OldProcId_17);
    {
      ...
      MR_hl_field(MR_mktag(3), Transform_21, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    ...
    parse_tree__pred_name__make_pred_name_4_p_0(ModuleName_19, Var_59, Transform_21, PredSymName_14);
