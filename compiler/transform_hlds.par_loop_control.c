...
{
  {
    ...
    {
      hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(transform_hlds__par_loop_control__Var_12, (MR_Word) &transform_hlds__par_loop_control_scalar_common_8[1], (MR_String) "lc_finish", (MR_Integer) 0, (MR_Integer) 1, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &transform_hlds__par_loop_control__PredId_5, &transform_hlds__par_loop_control__ProcId_6);
    }
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), transform_hlds__par_loop_control__Var_94, 0) = ((MR_Box) (&transform_hlds__par_loop_control_scalar_common_6[1]));
                    ...
                    case (MR_Integer) 2:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(0), transform_hlds__par_loop_control__Var_89, 0) = ((MR_Box) (&transform_hlds__par_loop_control_scalar_common_6[0]));
                    ...
                    case (MR_Integer) 4:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(0), transform_hlds__par_loop_control__Var_85, 0) = ((MR_Box) (&transform_hlds__par_loop_control_scalar_common_7[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), transform_hlds__par_loop_control__ArgModes_51, 0) = ((MR_Box) (&transform_hlds__par_loop_control_scalar_common_1[4]));
