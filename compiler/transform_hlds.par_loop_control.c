...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__par_loop_control__Globals_5, (MR_Integer) 679, &transform_hlds__par_loop_control__PreserveTailRecursionBool_6);
    }
