  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  MR_Word DepGraph_32;
  MR_Word SelfKey_33;
  MR_Word DepGraphWOSelfEdge_34;
  MR_Word TCDepGraphWOSelfEdge_35;

  hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &HasParallelConj_28);
  succeeded = (HasParallelConj_28 == (MR_Integer) 0);
  if (succeeded)
  {
    hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &Detism_29);
    switch (Detism_29) {
      default:
        succeeded = MR_FALSE;
        break;
    ...
    if (succeeded)
    {
      TypeCtorInfo_12_39 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
      DepGraph_32 = libs__dependency_graph__dependency_info_get_graph_1_f_0(TypeCtorInfo_12_39, DepInfo_7);
      mercury__digraph__lookup_key_3_p_0(TypeCtorInfo_12_39, DepGraph_32, ((MR_Box) (PredProcId_8)), &SelfKey_33);
      succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo_12_39, DepGraph_32, SelfKey_33, SelfKey_33);
      if (succeeded)
      {
        mercury__digraph__delete_edge_4_p_0(TypeCtorInfo_12_39, SelfKey_33, SelfKey_33, DepGraph_32, &DepGraphWOSelfEdge_34);
        mercury__digraph__tc_2_p_0(TypeCtorInfo_12_39, DepGraphWOSelfEdge_34, &TCDepGraphWOSelfEdge_35);
        succeeded = mercury__digraph__is_edge_3_p_1(TypeCtorInfo_12_39, TCDepGraphWOSelfEdge_35, SelfKey_33, SelfKey_33);
        succeeded = !(succeeded);
      }
    }
  }
  ...
  MR_Word * PreserveTailRecursion_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 712, &PreserveTailRecursionBool_6);
