      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            {
              *UseParentStack_10 = (MR_Integer) 0;
              hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 24, STATE_VARIABLE_Goal_139_139, &STATE_VARIABLE_Goal_141_141);
            }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 683, &PreserveTailRecursionBool_6);
