...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), GoalExpr_12, 4) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    Var_77 = transform_hlds__par_loop_control__lc_default_num_contexts_name_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(2), Var_72, 4) = ((MR_Box) ((MR_Integer) 0));
    ...
    InnerProcId_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), InnerPredProcId_8, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(2), Var_81, 4) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(ModuleInfo_4, (MR_Word) (&transform_hlds__par_loop_control_scalar_common_6[0]), (MR_String) "lc_default_num_contexts", (MR_Integer) 0, (MR_Integer) 1, (MR_Word) ((MR_Integer) 0), PredId_5, ProcId_6);
  }
}
...
{
  {
    ...
    hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(ModuleInfo_9, (MR_Word) (&transform_hlds__par_loop_control_scalar_common_6[0]), (MR_String) "lc_create", (MR_Integer) 0, (MR_Integer) 2, (MR_Word) ((MR_Integer) 0), &LCCreatePredId_15, &LCCreateProcId_16);
    {
...
{
  {
    ...
    parse_tree__prog_util__make_pred_name_6_p_0(ModuleName_19, (MR_String) "LoopControl", Var_59, Var_60, (MR_Word) ((MR_Integer) 0), &PredSym0_21);
    ...
    hlds__hlds_pred__pred_info_get_origin_2_p_0(OldPredInfo_18, &OldOrigin_24);
    {
      ...
      MR_hl_field(MR_mktag(2), Origin_25, 0) = ((MR_Box) ((MR_Integer) 4));
    ...
    hlds__hlds_pred__pred_info_create_16_p_0(ModuleName_19, *PredSym_14, PredOrFunc_20, Context_23, Origin_25, (MR_Word) (((MR_Box) ((MR_Integer) 32))), Markers_26, ArgTypes0_30, TypeVarSet_27, ExistQVars_28, ClassConstraints_29, Var_72, Var_73, OldProcInfo_11, &ProcId_35, &STATE_VARIABLE_PredInfo_74_74);
...
{
  {
    ...
    hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(ModuleInfo_3, (MR_Word) (&transform_hlds__par_loop_control_scalar_common_6[0]), (MR_String) "lc_join_and_terminate", (MR_Integer) 0, (MR_Integer) 2, (MR_Word) ((MR_Integer) 0), &PredId_4, &ProcId_5);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__2_2 = base;
...
{
  {
    ...
    hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(ModuleInfo_3, (MR_Word) (&transform_hlds__par_loop_control_scalar_common_6[0]), (MR_String) "lc_wait_free_slot", (MR_Integer) 0, (MR_Integer) 2, (MR_Word) ((MR_Integer) 0), &PredId_4, &ProcId_5);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__2_2 = base;
...
{
  {
    ...
    hlds__pred_table__lookup_builtin_pred_proc_id_8_p_0(Var_12, (MR_Word) (&transform_hlds__par_loop_control_scalar_common_6[0]), (MR_String) "lc_finish", (MR_Integer) 0, (MR_Integer) 1, (MR_Word) ((MR_Integer) 0), &PredId_5, &ProcId_6);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), GoalExpr_8, 4) = ((MR_Box) ((MR_Integer) 0));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        ;
                        HeadVar__1_1 = next_value_of_HeadVar__1_1;
                        STATE_VARIABLE_SeenUsableRecursion_0_3 = (MR_Word) ((MR_Integer) 4);
                        continue;
                      }
                      break;
                    case (MR_Integer) 1:
                      *STATE_VARIABLE_SeenUsableRecursion_4 = (MR_Word) ((MR_Integer) 8);
                      break;
                  }
                  break;
                case (MR_Integer) 1:
  ...
  MR_Word * SeenUsableRecursion_8)
{
  while (MR_TRUE)
  {
    ...
    if ((Conjs_6 == (MR_Word) ((MR_Integer) 0)))
      ...
      switch (MR_tag((MR_Word) SeenUsableRecursion0_9)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(SeenUsableRecursion0_9)) {
            ...
            case (MR_Integer) 1:
            case (MR_Integer) 2:
              *SeenUsableRecursion_8 = (MR_Word) ((MR_Integer) 8);
              break;
          }
          break;
        case (MR_Integer) 1:
    ...
    if (succeeded)
      switch (MR_tag((MR_Word) GoalExpr_7)) {
        ...
        case (MR_Integer) 0:
                ...
                switch (MR_unmkbody(SeenUsableRecursion0_92)) {
                  ...
                  case (MR_Integer) 1:
                    switch (Detism_9) {
                      ...
                      case (MR_Integer) 3:
                      case (MR_Integer) 1:
                        *SeenUsableRecursion_6 = (MR_Word) ((MR_Integer) 8);
                        break;
                    }
                    break;
                }
          ...
          break;
        case (MR_Integer) 1:
          *SeenUsableRecursion_6 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              switch (Detism_9) {
                ...
                case (MR_Integer) 4:
                case (MR_Integer) 0:
                  *SeenUsableRecursion_6 = (MR_Word) ((MR_Integer) 4);
                  break;
                case (MR_Integer) 5:
                case (MR_Integer) 6:
                case (MR_Integer) 7:
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if ((Conjs_36 == (MR_Word) ((MR_Integer) 0)))
                      {
                        {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      transform_hlds__par_loop_control__conj_get_loop_control_par_conjs_4_p_0(Conjs_36, SelfPredProcId_5, (MR_Word) ((MR_Integer) 0), &SeenUsableRecursion0_88);
            ...
            case (MR_Integer) 4:
              {
                ...
                if ((SeenUsableRecursionCases_42 == (MR_Word) ((MR_Integer) 0)))
                  *SeenUsableRecursion_6 = (MR_Word) ((MR_Integer) 0);
                else
                {
          ...
          switch (MR_tag((MR_Word) Seen0_2)) {
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(Seen0_2)) {
                ...
                case (MR_Integer) 1:
                case (MR_Integer) 2:
                  *HeadVar__3_3 = (MR_Word) ((MR_Integer) 8);
                  break;
              }
              break;
            case (MR_Integer) 1:
