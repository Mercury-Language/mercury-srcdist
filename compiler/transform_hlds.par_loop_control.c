  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_58)
{
  ...
  hlds__hlds_pred__pred_info_get_origin_2_p_0(OldPredInfo_18, &OldOrigin_24);
  {
    ...
    MR_hl_field(MR_mktag(3), Origin_25, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Origin_25, 1) = ((MR_Box) (OldOrigin_24));
    MR_hl_field(MR_mktag(3), Origin_25, 2) = ((MR_Box) (OldPredId_16));
    MR_hl_field(MR_mktag(3), Origin_25, 3) = ((MR_Box) (OldProcId_17));
  }
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_105, (MR_Integer) 717, &PreserveTailRecursionBool_106);
