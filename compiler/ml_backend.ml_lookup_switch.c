                ...
                if (ml_backend__ml_lookup_switch__succeeded)
                  *ml_backend__ml_lookup_switch__HeadVar__1_1 = ml_backend__ml_lookup_switch__Var_18;
                else
                  {
                    ...
                    {
                      ml_backend__mlds____Compare____statement_0_0(&ml_backend__ml_lookup_switch__Var_19, ml_backend__ml_lookup_switch__ArgX4_10, ml_backend__ml_lookup_switch__ArgY4_11);
                    }
                    ...
                    if (ml_backend__ml_lookup_switch__succeeded)
                      *ml_backend__ml_lookup_switch__HeadVar__1_1 = ml_backend__ml_lookup_switch__Var_19;
                    else
                      {
                        ...
                        {
                          ml_backend__mlds____Compare____statement_0_0(&ml_backend__ml_lookup_switch__Var_20, ml_backend__ml_lookup_switch__ArgX5_12, ml_backend__ml_lookup_switch__ArgY5_13);
                        }
            ...
            if (ml_backend__ml_lookup_switch__succeeded)
              {
                ...
                if (ml_backend__ml_lookup_switch__succeeded)
                  {
                    {
                      ml_backend__ml_lookup_switch__succeeded = ml_backend__mlds____Unify____statement_0_0(ml_backend__ml_lookup_switch__ArgX4_9, ml_backend__ml_lookup_switch__ArgY4_10);
                    }
                    if (ml_backend__ml_lookup_switch__succeeded)
                      {
                        {
                          ml_backend__ml_lookup_switch__succeeded = ml_backend__mlds____Unify____statement_0_0(ml_backend__ml_lookup_switch__ArgX5_11, ml_backend__ml_lookup_switch__ArgY5_12);
                        }
                        if (ml_backend__ml_lookup_switch__succeeded)
                          {
