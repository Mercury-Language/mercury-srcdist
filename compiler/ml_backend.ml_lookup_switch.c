          ...
          case (MR_Integer) 9:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(2), Var_20, 0) = ((MR_Box) (MLDS_Type_3));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), DefaultRval_4, 1) = ((MR_Box) (Var_20));
...
{
  {
    ...
    ml_backend__ml_global_data__ml_gen_static_scalar_const_value_8_p_0(MLDS_ModuleName_10, (MR_Integer) 6, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[6]), Initializer_69, Context_11, &BitVecRval_23, GlobalData0_21, &GlobalData_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 458, &StaticGroundCells_19);
