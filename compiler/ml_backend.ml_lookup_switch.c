...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_lookup_switch__Globals_18, (MR_Integer) 448, &ml_backend__ml_lookup_switch__StaticGroundCells_19);
    }
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(ml_backend__ml_lookup_switch__MLDS_Type_3)) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word ml_backend__ml_lookup_switch__V_32_32;
              MR_Unsigned ml_backend__ml_lookup_switch__V_33_33;

              {
                ml_backend__ml_lookup_switch__V_33_33 = mercury__uint__cast_from_int_1_f_0((MR_Integer) 0);
              }
              {
                ml_backend__ml_lookup_switch__V_32_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__V_32_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__V_32_32, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__V_33_33));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__DefaultRval_4, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__V_32_32));
              }
            }
            break;
          case (MR_Integer) 4:
