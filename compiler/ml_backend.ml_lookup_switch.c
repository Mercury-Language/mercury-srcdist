      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((ml_backend__ml_lookup_switch__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_6[3], ml_backend__ml_lookup_switch__Var_30, ml_backend__ml_lookup_switch__TaggedOtherConsIds_20, ((MR_Box) (ml_backend__ml_lookup_switch__STATE_VARIABLE_TagMap_29_29)), &ml_backend__ml_lookup_switch__conv2_STATE_VARIABLE_TagMap_31_31);
            }
            ml_backend__ml_lookup_switch__STATE_VARIABLE_TagMap_31_31 = ((MR_Word) ml_backend__ml_lookup_switch__conv2_STATE_VARIABLE_TagMap_31_31);
            /* direct tailcall eliminated */
            {
...
{
  {
    ...
    if ((ml_backend__ml_lookup_switch__FirstSolnTableFieldIds_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word ml_backend__ml_lookup_switch__Var_97 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_lookup_switch__FirstSolnTableFieldIds_34, (MR_Integer) 1)));
        MR_Word ml_backend__ml_lookup_switch__Var_98 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_lookup_switch__FirstSolnTableFieldIds_34, (MR_Integer) 0)));

        if ((ml_backend__ml_lookup_switch__Var_97 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            {
              mercury__require__unexpected_3_p_0((MR_String) "ml_backend.ml_lookup_switch", (MR_String) "predicate \140ml_backend.ml_lookup_switch.ml_gen_several_soln_atomic_lookup_switch\'/12", (MR_String) "not enough field_ids");
              return;
          ...
          {
            ml_backend__ml_lookup_switch__NumLaterSolnsFieldId_41 = ml_backend__ml_lookup_switch__Var_98;
            ml_backend__ml_lookup_switch__FirstLaterSolnRowFieldId_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_lookup_switch__Var_97, (MR_Integer) 0)));
            ml_backend__ml_lookup_switch__FirstSolnOutFieldIds_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_lookup_switch__Var_97, (MR_Integer) 1)));
          }
      }
    ...
    {
      ml_backend__ml_lookup_switch__Var_70 = mercury__cord__init_0_f_0(ml_backend__ml_lookup_switch__TypeCtorInfo_88_88);
    }
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            ml_backend__ml_lookup_switch__Var_86 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_lookup_switch__Var_86, 0) = ((MR_Box) (ml_backend__ml_lookup_switch__Difference_57));
          }
          {
            ml_backend__ml_lookup_switch__Var_85 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__Var_85, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__Var_85, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__Var_86));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_lookup_switch__RangeCheckCond_58, 3) = ((MR_Box) (ml_backend__ml_lookup_switch__Var_85));
          }
          {
