...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) BitVecArgRvals_22)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 463, &StaticGroundCells_19);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) GoalExpr_29)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_29, (MR_Integer) 0))) == (MR_Integer) 3)));
      if (succeeded)
      {
