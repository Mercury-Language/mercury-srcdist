...
{
  {
    MR_bool succeeded = (HadDummyRows_45 == HeadVar__2_72);
...
{
  {
    MR_bool succeeded = (HadDummyRows_45 == HeadVar__2_76);
...
{
  {
    MR_bool succeeded = (NeedBitVecCheck_22 == HeadVar__2_83);
...
{
  {
    ...
    else
    {
      ...
      ml_backend__mlds____Compare____mlds_lval_0_0(&Var_16, ArgX1_4, ArgY1_5);
      ...
      else
      {
        ...
        ml_backend__mlds____Compare____mlds_lval_0_0(&Var_17, ArgX2_6, ArgY2_7);
        ...
        else
        {
          ...
          ml_backend__mlds____Compare____mlds_lval_0_0(&Var_18, ArgX3_8, ArgY3_9);
          ...
          else
          {
            ...
            ml_backend__mlds____Compare____mlds_stmt_0_0(&Var_19, ArgX4_10, ArgY4_11);
            ...
            else
            {
              ...
              ml_backend__mlds____Compare____mlds_stmt_0_0(&Var_20, ArgX5_12, ArgY5_13);
              ...
              {
                mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[5], HeadVar__1_1, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
              }
            }
          }
        }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ml_backend__mlds____Unify____mlds_lval_0_0(ArgX2_5, ArgY2_6);
        if (succeeded)
        {
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_lookup_switch_scalar_common_2[0], &Var_10, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[3], &Var_11, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[4], HeadVar__1_1, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
        }
      }
    }
  }
    ...
    switch (MR_tag((MR_Word) MLDS_Type_3)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(MLDS_Type_3)) {
          ...
          case (MR_Integer) 1:
            {
              DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[13]);
            }
            break;
          case (MR_Integer) 2:
            {
              DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[16]);
            }
            break;
          case (MR_Integer) 3:
            {
              DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[22]);
            }
            break;
          case (MR_Integer) 4:
            {
              DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[20]);
            }
            break;
          case (MR_Integer) 5:
            {
              DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[18]);
            }
            break;
          case (MR_Integer) 6:
          case (MR_Integer) 8:
          case (MR_Integer) 9:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(2), Var_22, 0) = ((MR_Box) (MLDS_Type_3));
              }
              {
                DefaultRval_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), DefaultRval_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), DefaultRval_4, 1) = ((MR_Box) (Var_22));
                MR_hl_field(MR_mktag(3), DefaultRval_4, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[16])));
              }
            }
            break;
        }
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_3, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 2:
          case (MR_Integer) 3:
...
{
  {
    ...
    FieldInitializers_7 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[8], Rvals_5);
    {
      RowInitializer_6 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_case_id_soln_consts_to_tag_soln_consts__224__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_gen_atomic_lookup_switch__281__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    ml_backend__ml_code_util__ml_gen_var_3_p_0(STATE_VARIABLE_Info_0_38, SwitchVar_13, &SwitchVarLval_27);
    {
    ...
    else
    {
      ...
      {
        StartRval_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), StartRval_30, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(3), StartRval_30, 1) = ((MR_Box) (Var_40));
      }
      {
        IndexRval_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), IndexRval_29, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), IndexRval_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_lookup_switch_scalar_common_7[2])));
        MR_hl_field(MR_mktag(3), IndexRval_29, 2) = ((MR_Box) (SwitchVarRval_28));
        MR_hl_field(MR_mktag(3), IndexRval_29, 3) = ((MR_Box) (StartRval_30));
      }
    }
    if (((MR_tag((MR_Word) CaseIdConstMap_24)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word TypeInfo_for_V_71 = (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[1];
      ...
      Var_66 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, TypeInfo_for_V_71);
      ml_backend__ml_lookup_switch__ml_case_id_soln_consts_to_tag_soln_consts_loop__ho3_6_p_0(TaggedCases_14, CaseIdValueMap_31, &DepletedCaseIdMap_65, Var_66, &IntValueMap_32);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[0]));
        ...
        MR_hl_field(MR_mktag(0), Var_67, 3) = ((MR_Box) (TypeInfo_for_V_71));
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[6]));
      ...
      TypeInfo_for_V_84 = (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[0];
      Var_79 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, TypeInfo_for_V_84);
      ml_backend__ml_lookup_switch__ml_case_id_soln_consts_to_tag_soln_consts_loop__ho4_6_p_0(TaggedCases_14, CaseIdSolnMap_34, &DepletedCaseIdMap_78, Var_79, &IntSolnMap_36);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[0]));
        ...
        MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (TypeInfo_for_V_84));
  ...
  MR_Word * STATE_VARIABLE_TagMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsTag_54;
      MR_Integer Index_55;
      MR_Word _Goal_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedCase_15, (MR_Integer) 3)));
      ...
      _ConsId_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedMainConsId_19, (MR_Integer) 0)));
      ...
      mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_p_0((MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[0], Index_55, ((MR_Box) (SolnConsts_23)), STATE_VARIABLE_TagMap_0_5, &STATE_VARIABLE_TagMap_29_29);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_9[1]));
      ...
      mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[7], Var_30, TaggedOtherConsIds_20, ((MR_Box) (STATE_VARIABLE_TagMap_29_29)), &conv2_STATE_VARIABLE_TagMap_31_31);
      STATE_VARIABLE_TagMap_31_31 = ((MR_Word) conv2_STATE_VARIABLE_TagMap_31_31);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = TaggedCases_16;
        MR_Word next_value_of_STATE_VARIABLE_CaseIdMap_0_3 = STATE_VARIABLE_CaseIdMap_28_28;
        MR_Word next_value_of_STATE_VARIABLE_TagMap_0_5 = STATE_VARIABLE_TagMap_31_31;
  ...
  MR_Word * STATE_VARIABLE_TagMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[6], Var_30, TaggedOtherConsIds_20, ((MR_Box) (STATE_VARIABLE_TagMap_29_29)), &conv2_STATE_VARIABLE_TagMap_31_31);
      STATE_VARIABLE_TagMap_31_31 = ((MR_Word) conv2_STATE_VARIABLE_TagMap_31_31);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = TaggedCases_16;
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_gen_several_soln_atomic_lookup_switch__449__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_gen_several_soln_atomic_lookup_switch__446__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    MLDS_IntType_28 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
    {
      Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (MLDS_IntType_28));
      MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (OutTypes_15));
    }
    {
      FirstSolnFieldTypes_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), FirstSolnFieldTypes_29, 0) = ((MR_Box) (MLDS_IntType_28));
      MR_hl_field(MR_mktag(1), FirstSolnFieldTypes_29, 1) = ((MR_Box) (Var_59));
    }
    ...
    if ((FirstSolnTableFieldIds_33 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      {
    ...
    {
      MR_Word Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(1), FirstSolnTableFieldIds_33, (MR_Integer) 1)));
      MR_Word Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(1), FirstSolnTableFieldIds_33, (MR_Integer) 0)));
      ...
      {
        NumLaterSolnsFieldId_40 = Var_91;
        FirstLaterSolnRowFieldId_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_90, (MR_Integer) 0)));
        FirstSolnOutFieldIds_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_90, (MR_Integer) 1)));
      }
    }
    TypeCtorInfo_83_83 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0;
    Var_66 = mercury__cord__init_0_f_0(TypeCtorInfo_83_83);
    ml_backend__ml_lookup_switch__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_99_111_110_115_116_114_117_99_116_95_109_111_100_101_108_95_110_111_110_95_115_119_105_116_99_104_95_118_101_99_116_111_114_95_95_91_49_93_95_48_14_p_0(StartVal_18, EndVal_19, (MR_Integer) 0, CaseSolns_16, FirstSolnStructType_32, LaterSolnStructType_36, OutTypes_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevFirstSolnRowInitializers_43, Var_66, &LaterSolnRowInitializersCord_44, (MR_Integer) 0, &HadDummyRows_45);
    mercury__list__reverse_2_p_0(TypeCtorInfo_83_83, RevFirstSolnRowInitializers_43, &FirstSolnRowInitializers_46);
    LaterSolnRowInitializers_47 = mercury__cord__list_1_f_0(TypeCtorInfo_83_83, LaterSolnRowInitializersCord_44);
    ...
    ml_backend__ml_gen_info__ml_gen_info_set_global_data_3_p_0(GlobalData_51, STATE_VARIABLE_Info_0_57, &STATE_VARIABLE_Info_68_68);
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[5]));
            MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__ml_gen_several_soln_atomic_lookup_switch_12_p_0_1));
            MR_hl_field(MR_mktag(0), Var_73, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_73, 3) = ((MR_Box) (HadDummyRows_45));
            MR_hl_field(MR_mktag(0), Var_73, 4) = ((MR_Box) ((MR_Integer) 0));
          }
          mercury__require__expect_3_p_0(Var_73, (MR_String) "predicate \140ml_backend.ml_lookup_switch.ml_gen_several_soln_atomic_lookup_switch\'/12", (MR_String) "bad dont_need_bit_vec_check");
        }
        break;
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[5]));
            MR_hl_field(MR_mktag(0), Var_69, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__ml_gen_several_soln_atomic_lookup_switch_12_p_0_2));
            MR_hl_field(MR_mktag(0), Var_69, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_69, 3) = ((MR_Box) (HadDummyRows_45));
            MR_hl_field(MR_mktag(0), Var_69, 4) = ((MR_Box) ((MR_Integer) 1));
          }
          mercury__require__expect_3_p_0(Var_69, (MR_String) "predicate \140ml_backend.ml_lookup_switch.ml_gen_several_soln_atomic_lookup_switch\'/12", (MR_String) "bad need_bit_vec_check");
        }
        break;
    }
    ml_backend__ml_lookup_switch__ml_gen_several_soln_lookup_code_17_p_0(Context_17, IndexRval_13, OutVars_14, OutTypes_15, FirstSolnStructType_32, LaterSolnStructType_36, NumLaterSolnsFieldId_40, FirstLaterSolnRowFieldId_41, FirstSolnOutFieldIds_42, LaterSolnOutFieldIds_37, FirstSolnVectorCommon_48, LaterSolnVectorCommon_50, NeedBitVecCheck_20, &MatchDefns_52, &InRangeStmts_53, STATE_VARIABLE_Info_68_68, STATE_VARIABLE_Info_58);
    {
      InRangeStmt_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), InRangeStmt_54, 0) = ((MR_Box) (MatchDefns_52));
      MR_hl_field(MR_mktag(0), InRangeStmt_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    switch (NeedRangeCheck_21) {
      ...
      case (MR_Integer) 0:
        {
          MR_Integer Difference_55 = (EndVal_19 - StartVal_18);
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_81, 0) = ((MR_Box) (Difference_55));
          }
          {
          ...
          {
            RangeCheckCond_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), RangeCheckCond_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), RangeCheckCond_56, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
            MR_hl_field(MR_mktag(3), RangeCheckCond_56, 2) = ((MR_Box) (IndexRval_13));
            MR_hl_field(MR_mktag(3), RangeCheckCond_56, 3) = ((MR_Box) (Var_80));
          }
          {
            MR_Word base;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if ((HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        else
        {
          ...
          Var_34 = (CurIndex_2 + (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_CurIndex_2 = Var_34;
            MR_Word next_value_of_STATE_VARIABLE_RevFirstSolnRowInitializers_0_9 = STATE_VARIABLE_RevFirstSolnRowInitializers_32_32;
      ...
      else
      {
        ...
        {
          if (((MR_tag((MR_Word) Soln_53)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            FieldInitializers_56 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[4], FieldRvals_55);
            ...
            {
              FirstSolnFieldInitializers_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              FirstSolnRowInitializer_60 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              STATE_VARIABLE_RevFirstSolnRowInitializers_72_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            MR_Word TypeCtorInfo_101_101 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0;
            ...
            FieldInitializers_91 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, TypeCtorInfo_101_101, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[5], FirstSolnRvals_61);
            TypeInfo_104_104 = (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[1];
            mercury__list__length_2_p_0(TypeInfo_104_104, LaterSolns_62, &NumLaterSolns_63);
            ...
            {
              FirstSolnFieldInitializers_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              FirstSolnRowInitializer_95 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_3[1]));
            ...
            LaterSolnRowInitializers_64 = mercury__list__map_2_f_0(TypeInfo_104_104, TypeCtorInfo_101_101, Var_77, LaterSolns_62);
            Var_79 = mercury__cord__from_list_1_f_0(TypeCtorInfo_101_101, LaterSolnRowInitializers_64);
            STATE_VARIABLE_LaterSolnRowInitializersCord_78_78 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_101_101, STATE_VARIABLE_LaterSolnRowInitializersCord_0_11, Var_79);
            STATE_VARIABLE_NextLaterSolnRow_80_80 = (STATE_VARIABLE_NextLaterSolnRow_0_4 + NumLaterSolns_63);
          }
          NextPairs_54 = Pairs_45;
          STATE_VARIABLE_HadDummyRows_73_73 = STATE_VARIABLE_HadDummyRows_0_13;
        }
        Var_86 = (CurIndex_2 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_CurIndex_2 = Var_86;
          MR_Integer next_value_of_STATE_VARIABLE_NextLaterSolnRow_0_4 = STATE_VARIABLE_NextLaterSolnRow_80_80;
          MR_Word next_value_of_HeadVar__5_5 = NextPairs_54;
          MR_Word next_value_of_STATE_VARIABLE_RevFirstSolnRowInitializers_0_9 = STATE_VARIABLE_RevFirstSolnRowInitializers_72_72;
          MR_Word next_value_of_STATE_VARIABLE_LaterSolnRowInitializersCord_0_11 = STATE_VARIABLE_LaterSolnRowInitializersCord_78_78;
          MR_Word next_value_of_STATE_VARIABLE_HadDummyRows_0_13 = STATE_VARIABLE_HadDummyRows_73_73;
...
{
  {
    MR_Word TypeCtorInfo_23_23 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0;
    ...
    FieldRvals_8 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, TypeCtorInfo_23_23, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[2], FieldTypes_6);
    FieldInitializers_9 = mercury__list__map_2_f_0(TypeCtorInfo_23_23, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[3], FieldRvals_8);
    ...
    {
      FirstSolnFieldInitializers_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      FirstSolnRowInitializer_13 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word NumLaterSolnsVarLval_35;
    MR_Word LaterSlotVarLval_36;
    MR_Word LimitVarLval_37;
    MR_Word LimitAssignStmt_38;
    MR_Word IncrLaterSlotVarStmt_39;
    MR_Word NumLaterSolnsVarRval_40;
    MR_Word LaterSlotVarRval_41;
    MR_Word LimitVarRval_42;
    MR_Word MLDS_IntType_43;
    MR_Word NumLaterSolnsAssignStmt_44;
    MR_Word LaterSlotVarAssignStmt_45;
    MR_Word FirstSolnLookupStmts_46;
    MR_Word LaterSolnLookupStmts_47;
    MR_Word CallContStmt_48;
    MR_Word FirstLookupSucceedStmt_49;
    MR_Word LaterLookupSucceedStmt_50;
    MR_Word MoreSolnsLoopCond_51;
    MR_Word MoreSolnsLoopStmt_52;
    MR_Word OneOrMoreSolnsStmts_53;
    ...
    ml_backend__ml_lookup_switch__make_several_soln_lookup_vars_4_p_0(Context_18, &SeveralSolnLookupVars_34, STATE_VARIABLE_Info_0_57, &STATE_VARIABLE_Info_59_59);
    NumLaterSolnsVarLval_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), SeveralSolnLookupVars_34, (MR_Integer) 0)));
    LaterSlotVarLval_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), SeveralSolnLookupVars_34, (MR_Integer) 1)));
    LimitVarLval_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), SeveralSolnLookupVars_34, (MR_Integer) 2)));
    ...
    *MatchDefns_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), SeveralSolnLookupVars_34, (MR_Integer) 5)));
    {
      NumLaterSolnsVarRval_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), NumLaterSolnsVarRval_40, 0) = ((MR_Box) (NumLaterSolnsVarLval_35));
    }
    {
      LaterSlotVarRval_41 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), LaterSlotVarRval_41, 0) = ((MR_Box) (LaterSlotVarLval_36));
    }
    {
      LimitVarRval_42 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), LimitVarRval_42, 0) = ((MR_Box) (LimitVarLval_37));
    }
    MLDS_IntType_43 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
    ml_backend__ml_code_util__ml_generate_field_assign_10_p_0(NumLaterSolnsVarLval_35, MLDS_IntType_43, NumLaterSolnsFieldId_24, FirstSolnVectorCommon_28, FirstSolnStructType_22, SlotVarRval_19, Context_18, &NumLaterSolnsAssignStmt_44, STATE_VARIABLE_Info_59_59, &STATE_VARIABLE_Info_60_60);
    ml_backend__ml_code_util__ml_generate_field_assign_10_p_0(LaterSlotVarLval_36, MLDS_IntType_43, FirstLaterSolnRowFieldId_25, FirstSolnVectorCommon_28, FirstSolnStructType_22, SlotVarRval_19, Context_18, &LaterSlotVarAssignStmt_45, STATE_VARIABLE_Info_60_60, &STATE_VARIABLE_Info_61_61);
    ml_backend__ml_code_util__ml_generate_field_assigns_10_p_0(OutVars_20, OutTypes_21, FirstSolnOutFieldIds_26, FirstSolnVectorCommon_28, FirstSolnStructType_22, SlotVarRval_19, Context_18, &FirstSolnLookupStmts_46, STATE_VARIABLE_Info_61_61, &STATE_VARIABLE_Info_62_62);
    ml_backend__ml_code_util__ml_generate_field_assigns_10_p_0(OutVars_20, OutTypes_21, LaterSolnOutFieldIds_27, LaterSolnVectorCommon_29, LaterSolnStructType_23, LaterSlotVarRval_41, Context_18, &LaterSolnLookupStmts_47, STATE_VARIABLE_Info_62_62, &STATE_VARIABLE_Info_63_63);
    ml_backend__ml_code_util__ml_gen_call_current_success_cont_4_p_0(Context_18, &CallContStmt_48, STATE_VARIABLE_Info_63_63, STATE_VARIABLE_Info_58);
    TypeCtorInfo_93_93 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0;
    {
      ...
      MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (CallContStmt_48));
      MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    Var_67 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_93_93, FirstSolnLookupStmts_46, Var_68);
    {
      FirstLookupSucceedStmt_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FirstLookupSucceedStmt_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), FirstLookupSucceedStmt_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), FirstLookupSucceedStmt_49, 2) = ((MR_Box) (Var_67));
      MR_hl_field(MR_mktag(0), FirstLookupSucceedStmt_49, 3) = ((MR_Box) (Context_18));
    }
    {
      Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (IncrLaterSlotVarStmt_39));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (CallContStmt_48));
      MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_74));
    }
    Var_72 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_93_93, LaterSolnLookupStmts_47, Var_73);
    {
      LaterLookupSucceedStmt_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), LaterLookupSucceedStmt_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LaterLookupSucceedStmt_50, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LaterLookupSucceedStmt_50, 2) = ((MR_Box) (Var_72));
      MR_hl_field(MR_mktag(0), LaterLookupSucceedStmt_50, 3) = ((MR_Box) (Context_18));
    }
    {
      MoreSolnsLoopCond_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), MoreSolnsLoopCond_51, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), MoreSolnsLoopCond_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[14])));
      MR_hl_field(MR_mktag(3), MoreSolnsLoopCond_51, 2) = ((MR_Box) (LaterSlotVarRval_41));
      MR_hl_field(MR_mktag(3), MoreSolnsLoopCond_51, 3) = ((MR_Box) (LimitVarRval_42));
    }
    {
      MoreSolnsLoopStmt_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MoreSolnsLoopStmt_52, 0) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), MoreSolnsLoopStmt_52, 1) = ((MR_Box) (MoreSolnsLoopCond_51));
      MR_hl_field(MR_mktag(1), MoreSolnsLoopStmt_52, 2) = ((MR_Box) (LaterLookupSucceedStmt_50));
      MR_hl_field(MR_mktag(1), MoreSolnsLoopStmt_52, 3) = ((MR_Box) (Context_18));
    }
    {
      Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (MoreSolnsLoopStmt_52));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (LimitAssignStmt_38));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (LaterSlotVarAssignStmt_45));
      MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) (Var_80));
    }
    {
      OneOrMoreSolnsStmts_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), OneOrMoreSolnsStmts_53, 0) = ((MR_Box) (FirstLookupSucceedStmt_49));
      MR_hl_field(MR_mktag(1), OneOrMoreSolnsStmts_53, 1) = ((MR_Box) (Var_79));
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_32 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NumLaterSolnsAssignStmt_44));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (OneOrMoreSolnsStmts_53));
        }
        break;
      case (MR_Integer) 0:
        {
          MR_Word OneOrMoreSolnsBlockStmt_54;
          MR_Word AnySolnsCond_55;
          MR_Word ZeroOrMoreSolnsStmt_56;
          MR_Word Var_91;

          {
            OneOrMoreSolnsBlockStmt_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), OneOrMoreSolnsBlockStmt_54, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), OneOrMoreSolnsBlockStmt_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), OneOrMoreSolnsBlockStmt_54, 2) = ((MR_Box) (OneOrMoreSolnsStmts_53));
            MR_hl_field(MR_mktag(0), OneOrMoreSolnsBlockStmt_54, 3) = ((MR_Box) (Context_18));
          }
          {
            AnySolnsCond_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), AnySolnsCond_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), AnySolnsCond_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[15])));
            MR_hl_field(MR_mktag(3), AnySolnsCond_55, 2) = ((MR_Box) (NumLaterSolnsVarRval_40));
            MR_hl_field(MR_mktag(3), AnySolnsCond_55, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[16])));
          }
          {
            ZeroOrMoreSolnsStmt_56 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ZeroOrMoreSolnsStmt_56, 0) = ((MR_Box) (AnySolnsCond_55));
            MR_hl_field(MR_mktag(2), ZeroOrMoreSolnsStmt_56, 1) = ((MR_Box) (OneOrMoreSolnsBlockStmt_54));
            MR_hl_field(MR_mktag(2), ZeroOrMoreSolnsStmt_56, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(2), ZeroOrMoreSolnsStmt_56, 3) = ((MR_Box) (Context_18));
          }
          {
            Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (ZeroOrMoreSolnsStmt_56));
...
{
  {
    ...
    MR_Word NumLaterSolnsVarDefn_9;
    MR_Word NumLaterSolnsVarLval_10;
    MR_Word LaterSlotVarName_11;
    MR_Word LaterSlotVarDefn_12;
    MR_Word LaterSlotVarLval_13;
    MR_Word LimitVarName_14;
    MR_Word LimitVarDefn_15;
    MR_Word LimitVarLval_16;
    MR_Word Defns_17;
    MR_Word LaterSlotVarRval_18;
    MR_Word NumLaterSolnsVarRval_19;
    MR_Word LimitAssign_20;
    MR_Word LimitAssignStmt_21;
    MR_Word IncrLaterSlotVar_22;
    MR_Word IncrLaterSlotVarStmt_23;
    ...
    ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 3, &NumLaterSolnsVarName_8, STATE_VARIABLE_Info_0_24, &STATE_VARIABLE_Info_27_27);
    NumLaterSolnsVarDefn_9 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(NumLaterSolnsVarName_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Context_5);
    {
      NumLaterSolnsVarLval_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), NumLaterSolnsVarLval_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), NumLaterSolnsVarLval_10, 1) = ((MR_Box) (NumLaterSolnsVarName_8));
      MR_hl_field(MR_mktag(3), NumLaterSolnsVarLval_10, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
    }
    ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 2, &LaterSlotVarName_11, STATE_VARIABLE_Info_27_27, &STATE_VARIABLE_Info_32_32);
    LaterSlotVarDefn_12 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(LaterSlotVarName_11, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Context_5);
    {
      LaterSlotVarLval_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LaterSlotVarLval_13, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), LaterSlotVarLval_13, 1) = ((MR_Box) (LaterSlotVarName_11));
      MR_hl_field(MR_mktag(3), LaterSlotVarLval_13, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
    }
    ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 4, &LimitVarName_14, STATE_VARIABLE_Info_32_32, STATE_VARIABLE_Info_25);
    LimitVarDefn_15 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(LimitVarName_14, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Context_5);
    {
      LimitVarLval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LimitVarLval_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), LimitVarLval_16, 1) = ((MR_Box) (LimitVarName_14));
      MR_hl_field(MR_mktag(3), LimitVarLval_16, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
    }
    {
      Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (LimitVarDefn_15));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (LaterSlotVarDefn_12));
      MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (Var_42));
    }
    {
      Defns_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Defns_17, 0) = ((MR_Box) (NumLaterSolnsVarDefn_9));
      MR_hl_field(MR_mktag(1), Defns_17, 1) = ((MR_Box) (Var_41));
    }
    {
      LaterSlotVarRval_18 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), LaterSlotVarRval_18, 0) = ((MR_Box) (LaterSlotVarLval_13));
    }
    {
      NumLaterSolnsVarRval_19 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), NumLaterSolnsVarRval_19, 0) = ((MR_Box) (NumLaterSolnsVarLval_10));
    }
    Var_45 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_lookup_switch_scalar_common_7[2]);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_44, 2) = ((MR_Box) (LaterSlotVarRval_18));
      MR_hl_field(MR_mktag(3), Var_44, 3) = ((MR_Box) (NumLaterSolnsVarRval_19));
    }
    {
      LimitAssign_20 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), LimitAssign_20, 0) = ((MR_Box) (LimitVarLval_16));
      MR_hl_field(MR_mktag(2), LimitAssign_20, 1) = ((MR_Box) (Var_44));
    }
    {
      LimitAssignStmt_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LimitAssignStmt_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), LimitAssignStmt_21, 1) = ((MR_Box) (LimitAssign_20));
      MR_hl_field(MR_mktag(3), LimitAssignStmt_21, 2) = ((MR_Box) (Context_5));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_47, 1) = ((MR_Box) (Var_45));
      MR_hl_field(MR_mktag(3), Var_47, 2) = ((MR_Box) (LaterSlotVarRval_18));
      MR_hl_field(MR_mktag(3), Var_47, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[11])));
    }
    {
      IncrLaterSlotVar_22 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), IncrLaterSlotVar_22, 0) = ((MR_Box) (LaterSlotVarLval_13));
      MR_hl_field(MR_mktag(2), IncrLaterSlotVar_22, 1) = ((MR_Box) (Var_47));
    }
    {
      IncrLaterSlotVarStmt_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), IncrLaterSlotVarStmt_23, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), IncrLaterSlotVarStmt_23, 1) = ((MR_Box) (IncrLaterSlotVar_22));
      MR_hl_field(MR_mktag(3), IncrLaterSlotVarStmt_23, 2) = ((MR_Box) (Context_5));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      *SeveralSolnLookupVars_6 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (NumLaterSolnsVarLval_10));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (LaterSlotVarLval_13));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (LimitVarLval_16));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (LimitAssignStmt_21));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (IncrLaterSlotVarStmt_23));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Defns_17));
    }
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_gen_simple_atomic_lookup_switch__337__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_lookup_switch__IntroducedFrom__pred__ml_gen_simple_atomic_lookup_switch__335__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    if ((OutTypes_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      LookupStmts_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_76, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[3]));
          ...
          {
            Var_80 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[4]));
            MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (ml_backend__ml_lookup_switch__ml_gen_simple_atomic_lookup_switch_13_p_0_2));
            MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (NeedBitVecCheck_22));
            MR_hl_field(MR_mktag(0), Var_80, 4) = ((MR_Box) ((MR_Integer) 1));
          }
          mercury__require__expect_3_p_0(Var_80, (MR_String) "predicate \140ml_backend.ml_lookup_switch.ml_gen_simple_atomic_lookup_switch\'/13", (MR_String) "model_det need_bit_vec_check");
          {
            MR_Word base;
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[12]), Context_19, &SetSuccessTrueStmt_41, STATE_VARIABLE_Info_51_51, &STATE_VARIABLE_Info_55_55);
          {
          ...
          {
            LookupSucceedStmt_42 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), LookupSucceedStmt_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), LookupSucceedStmt_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          ...
          switch (NeedRangeCheck_23) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[13]), Context_19, &SetSuccessFalseStmt_44, STATE_VARIABLE_Info_71_71, STATE_VARIABLE_Info_49);
                    {
            ...
            case (MR_Integer) 0:
              {
                MR_Integer Difference_45 = (EndVal_21 - StartVal_20);
                ...
                MR_Word Var_70;
                MR_Word SetSuccessFalseStmt_89;
                ...
                {
                  RangeCheckCond_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), RangeCheckCond_46, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                  MR_hl_field(MR_mktag(3), RangeCheckCond_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
                  MR_hl_field(MR_mktag(3), RangeCheckCond_46, 2) = ((MR_Box) (IndexRval_14));
                  MR_hl_field(MR_mktag(3), RangeCheckCond_46, 3) = ((MR_Box) (Var_63));
                }
                ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[13]), Context_19, &SetSuccessFalseStmt_89, STATE_VARIABLE_Info_55_55, &STATE_VARIABLE_Info_66_66);
                switch (NeedBitVecCheck_22) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      ml_backend__ml_lookup_switch__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_101_114_97_116_101_95_98_105_116_118_101_99_95_116_101_115_116_95_95_91_49_44_32_55_93_95_48_9_p_0(MLDS_ModuleName_28, Context_19, IndexRval_14, CaseValues_17, StartVal_20, &BitVecCheckCond_86, STATE_VARIABLE_Info_66_66, STATE_VARIABLE_Info_49);
                      {
                        ...
                        MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (SetSuccessFalseStmt_89));
                      }
                      {
                        RangeCheckSuccessStmt_47 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), RangeCheckSuccessStmt_47, 0) = ((MR_Box) (BitVecCheckCond_86));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (SetSuccessFalseStmt_89));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        FieldRvals_21 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[0], FieldTypes_3);
      ...
      FieldInitializers_23 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_8[1], FieldRvals_21);
      {
      ...
      Var_26 = (CurIndex_4 + (MR_Integer) 1);
...
{
  {
    ...
    MR_Word BitMap_66;
    MR_Word WordVals_67;
    MR_Word WordInitializers_68;
    MR_Word Initializer_69;
    ...
    TypeCtorInfo_31_75 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
    mercury__map__init_1_p_0(TypeCtorInfo_31_75, TypeCtorInfo_31_75, &BitMap0_65);
    ml_backend__ml_lookup_switch__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_101_114_97_116_101_95_98_105_116_95_118_101_99_95_50_95_95_91_49_93_95_48_5_p_0(CaseVals_13, Start_14, WordBits_19, BitMap0_65, &BitMap_66);
    mercury__map__to_assoc_list_2_p_0(TypeCtorInfo_31_75, TypeCtorInfo_31_75, BitMap_66, &WordVals_67);
    ml_backend__ml_lookup_switch__ml_generate_bit_vec_initializers_4_p_0(WordVals_67, (MR_Integer) 0, &BitVecArgRvals_22, &WordInitializers_68);
    {
      Initializer_69 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Initializer_69, 0) = ((MR_Box) (WordInitializers_68));
    }
    ml_backend__ml_global_data__ml_gen_static_scalar_const_value_8_p_0(MLDS_ModuleName_10, (MR_Integer) 4, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[6]), Initializer_69, Context_11, &BitVecRval_23, GlobalData0_21, &GlobalData_24);
    succeeded = ((MR_tag((MR_Word) BitVecArgRvals_22)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      ml_backend__ml_gen_info__ml_gen_info_set_global_data_3_p_0(GlobalData_24, STATE_VARIABLE_Info_0_30, STATE_VARIABLE_Info_31);
      {
        ...
        MR_hl_field(MR_mktag(2), Var_37, 0) = ((MR_Box) (Log2WordBits_20));
      }
      {
      ...
      {
        WordNumRval_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), WordNumRval_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), WordNumRval_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[7])));
        MR_hl_field(MR_mktag(3), WordNumRval_28, 2) = ((MR_Box) (IndexRval_12));
        MR_hl_field(MR_mktag(3), WordNumRval_28, 3) = ((MR_Box) (Var_36));
      }
      {
        WordRval_26 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), WordRval_26, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), WordRval_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[8])));
        MR_hl_field(MR_mktag(3), WordRval_26, 2) = ((MR_Box) (BitVecRval_23));
        MR_hl_field(MR_mktag(3), WordRval_26, 3) = ((MR_Box) (WordNumRval_28));
      }
      Var_44 = (WordBits_19 - (MR_Integer) 1);
      {
      ...
      {
        BitNumRval_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), BitNumRval_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), BitNumRval_27, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[9])));
        MR_hl_field(MR_mktag(3), BitNumRval_27, 2) = ((MR_Box) (IndexRval_12));
        MR_hl_field(MR_mktag(3), BitNumRval_27, 3) = ((MR_Box) (Var_42));
      }
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[10])));
      MR_hl_field(MR_mktag(3), Var_48, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_lookup_switch_scalar_common_1[11])));
      MR_hl_field(MR_mktag(3), Var_48, 3) = ((MR_Box) (BitNumRval_27));
    }
    {
      MR_Word base;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        succeeded = mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, STATE_VARIABLE_BitMap_0_4, WordNum_18, &conv0_X0_20);
        if (succeeded)
        {
        ...
        mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, WordNum_18, ((MR_Box) (X1_21)), STATE_VARIABLE_BitMap_0_4, &STATE_VARIABLE_BitMap_28_28);
        /* direct tailcall eliminated */
        {
...
{
  {
    ...
    else
    {
      ...
      Bits_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 1)));
      succeeded = (Count_2 < WordNum_7);
      if (succeeded)
      {
        WordVal_15 = (MR_Integer) 0;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Var_18, 0) = ((MR_Box) (WordVal_15));
      }
      {
        Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(3), Rval_11, 1) = ((MR_Box) (Var_18));
      }
      {
        Initializer_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Initializer_13, 0) = ((MR_Box) (Rval_11));
      }
      Var_19 = (Count_2 + (MR_Integer) 1);
...
{
  {
    ...
    ml_backend__ml_lookup_switch__ml_case_id_soln_consts_to_tag_soln_consts_loop_6_p_0(TypeInfo_for_T_14, TypeInfo_for_V_15, GetTag_5, TaggedCases_6, CaseIdMap_7, &DepletedCaseIdMap_9, Var_10, TagMap_8);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_6[0]));
  ...
  MR_Word * STATE_VARIABLE_TagMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      _ConsId_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedMainConsId_19, (MR_Integer) 0)));
      ...
      {
        Var_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_5[0]));
        ...
        MR_hl_field(MR_mktag(0), Var_30, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
...
{
  {
    ...
    parse_tree__set_of_var__delete_3_p_0(TypeCtorInfo_35_35, SwitchVar_8, NonLocals_14, &OtherNonLocals_15);
    parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_35_35, OtherNonLocals_15, &OutVars_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 457, &StaticGroundCells_19);
    succeeded = (StaticGroundCells_19 == (MR_Integer) 1);
    if (succeeded)
    {
      TypeCtorInfo_36_36 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0;
      TypeInfo_37_37 = (MR_Word) &ml_backend__ml_lookup_switch_scalar_common_1[0];
      Var_30 = mercury__map__init_0_f_0(TypeCtorInfo_36_36, TypeInfo_37_37);
    ...
    if (succeeded)
    {
      ...
      *STATE_VARIABLE_Info_28 = STATE_VARIABLE_Info_31_31;
      ...
      if (succeeded)
        {
          CaseConsts_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), CaseConsts_22, 0) = ((MR_Box) (CaseValuePairMap_21));
        }
      else
      {
        {
          CaseConsts_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), CaseConsts_22, 0) = ((MR_Box) (CaseSolnMap_20));
          MR_hl_field(MR_mktag(1), CaseConsts_22, 1) = NULL;
        }
      }
      ml_backend__ml_gen_info__ml_gen_info_get_var_types_2_p_0(STATE_VARIABLE_Info_31_31, &VarTypes_23);
      hlds__vartypes__lookup_var_types_3_p_0(VarTypes_23, OutVars_16, &OutTypes_24);
      {
        Var_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (&ml_backend__ml_lookup_switch_scalar_common_3[0]));
      ...
      FieldTypes_25 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, Var_33, OutTypes_24);
      {
        LookupSwitchInfo_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      *MaybeLookupSwitchInfo_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word _TaggedMainConsId_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedCase_21, (MR_Integer) 0)));
        MR_Word _TaggedOtherConsIds_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), TaggedCase_21, (MR_Integer) 1)));
        MR_Word _GoalInfo_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_28, (MR_Integer) 1)));
        MR_Word Disjuncts_31;

        succeeded = ((((MR_tag((MR_Word) GoalExpr_29)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_29, (MR_Integer) 0)))) == (MR_Integer) 3)));
        if (succeeded)
        {
          Disjuncts_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_29, (MR_Integer) 1)));
          if ((Disjuncts_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ml_backend__ml_code_util__ml_generate_constants_for_arm_5_p_0(HeadVar__2_2, FirstDisjunct_32, &FirstSoln_34, STATE_VARIABLE_Info_0_7, &STATE_VARIABLE_Info_42_42);
                ml_backend__ml_code_util__ml_generate_constants_for_arms_5_p_0(HeadVar__2_2, LaterDisjuncts_33, &LaterSolns_35, STATE_VARIABLE_Info_42_42, &STATE_VARIABLE_Info_43_43);
                ...
                {
                  SolnConsts_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ml_backend__ml_code_util__ml_generate_constants_for_arm_5_p_0(HeadVar__2_2, Goal_28, &Soln_37, STATE_VARIABLE_Info_0_7, &STATE_VARIABLE_Info_43_43);
            ...
            {
              SolnConsts_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__4_4 = TaggedCases_22;
            MR_Word next_value_of_HeadVar__5_5 = STATE_VARIABLE_CaseIdMap_44_44;
            MR_Word next_value_of_STATE_VARIABLE_Info_0_7 = STATE_VARIABLE_Info_43_43;
