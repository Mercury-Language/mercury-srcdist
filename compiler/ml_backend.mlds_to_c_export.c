...
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant_hashdef__420__1_2_p_0(
  MR_Word Lang_12,
...
static MR_bool MR_CALL 
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__197__1_1_p_0(
  ...
  MR_Word LambdaHeadVar__1_41)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_124)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_124, (MR_Integer) 0)))) == (MR_Integer) 8)));
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant_hashdef__420__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word Arg_5)
{
  ...
  else
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Type_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0)))) == (MR_Integer) 8)));
    if (succeeded)
    {
  ...
  MR_Word Arg_3)
{
  ...
  succeeded = ((((MR_tag((MR_Word) PtrType_6)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, PtrType_6, (MR_Integer) 0)))) == (MR_Integer) 8)));
  if (succeeded)
  {
  ...
  switch (MR_tag((MR_Word) Type_8)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_48 = ((MR_Unsigned) ((MR_hl_field(3, Type_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_56;

            {
              Var_56 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_56, 0) = (MR_Box) ((MR_Unsigned) (IntType_48));
            }
            TypePrefix_34 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_56);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_49 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_49)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_60 = ((MR_Word) ((MR_hl_field(0, ForeignType_49, (MR_Integer) 0))));

                  TypePrefix_34 = (MR_String) (Var_60);
                }
                break;
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 8:
          {
            MR_Word BaseType_52 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));
            MR_String BaseTypeStr_53;

            BaseTypeStr_53 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_52);
            TypePrefix_34 = mercury__string__f_43_43_2_f_0(BaseTypeStr_53, (MR_String) " *");
          }
          break;
        case (MR_Integer) 10:
          TypePrefix_34 = (MR_String) "MR_Word";
  ...
  if (succeeded)
  {
    Name_72 = ((MR_String) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 0))));
    Seq_73 = ((MR_Integer) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 1))));
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Name_72));
      MR_hl_field(3, BoxedLocalVarName_10, 2) = ((MR_Box) (Seq_73));
    }
  }
  else
  {
    MR_String NameStr_74;
    MR_Word Var_75;

    NameStr_74 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_5);
    {
      Var_75 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_75, 0) = ((MR_Box) (NameStr_74));
    }
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Var_75));
    }
  }
  ...
  MR_Word Arg_3)
{
  ...
  switch (MR_tag((MR_Word) Type_6)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_43 = ((MR_Unsigned) ((MR_hl_field(3, Type_6, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_51;

            {
              Var_51 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_51, 0) = (MR_Box) ((MR_Unsigned) (IntType_43));
            }
            TypePrefix_29 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_51);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_44 = ((MR_Word) ((MR_hl_field(3, Type_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_44)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_55 = ((MR_Word) ((MR_hl_field(0, ForeignType_44, (MR_Integer) 0))));

                  TypePrefix_29 = (MR_String) (Var_55);
                }
                break;
              case (MR_Integer) 1:
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_c_export.export_type_to_prefix_suffix\'/3", (MR_String) "java foreign_type");
        ...
        case (MR_Integer) 8:
          {
            MR_Word BaseType_47 = ((MR_Word) ((MR_hl_field(3, Type_6, (MR_Integer) 1))));
            MR_String BaseTypeStr_48;

            BaseTypeStr_48 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_47);
            TypePrefix_29 = mercury__string__f_43_43_2_f_0(BaseTypeStr_48, (MR_String) " *");
          }
          break;
        case (MR_Integer) 10:
          TypePrefix_29 = (MR_String) "MR_Word";
  ...
  if (succeeded)
  {
    Name_67 = ((MR_String) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 0))));
    Seq_68 = ((MR_Integer) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(3, BoxedLocalVarName_9, 1) = ((MR_Box) (Name_67));
      MR_hl_field(3, BoxedLocalVarName_9, 2) = ((MR_Box) (Seq_68));
    }
  }
  else
  {
    MR_String NameStr_69;
    MR_Word Var_70;

    NameStr_69 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_5);
    {
      Var_70 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_70, 0) = ((MR_Box) (NameStr_69));
    }
    {
      ...
      MR_hl_field(3, BoxedLocalVarName_9, 1) = ((MR_Box) (Var_70));
    }
  }
  ...
  MR_Word Arg_5)
{
  ...
  succeeded = ((((MR_tag((MR_Word) PtrType_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, PtrType_8, (MR_Integer) 0)))) == (MR_Integer) 8)));
  if (succeeded)
  {
  ...
  switch (MR_tag((MR_Word) MLDS_Type_6)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
...

            {
              ...
              MR_hl_field(1, Var_27, 0) = (MR_Box) ((MR_Unsigned) (IntType_19));
            }
            *TypePrefix_7 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_27);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_20 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_20)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_31 = ((MR_Word) ((MR_hl_field(0, ForeignType_20, (MR_Integer) 0))));

                  *TypePrefix_7 = (MR_String) (Var_31);
                }
                break;
              case (MR_Integer) 1:
                {
        ...
        case (MR_Integer) 8:
          {
            MR_Word BaseType_23 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
            MR_String BaseTypeStr_24;
            MR_String TypePrefix_43;

            switch (MR_tag((MR_Word) BaseType_23)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(BaseType_23)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 5:
                  case (MR_Integer) 6:
                  case (MR_Integer) 7:
                  case (MR_Integer) 8:
                    TypePrefix_43 = (MR_String) "MR_Word";
                    break;
                  case (MR_Integer) 1:
                    TypePrefix_43 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 0U));
                    break;
                  case (MR_Integer) 2:
                    TypePrefix_43 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 4U));
                    break;
                  case (MR_Integer) 3:
                    TypePrefix_43 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 8U));
                    break;
                  case (MR_Integer) 4:
                    TypePrefix_43 = (MR_String) "MR_bool";
                    break;
                  case (MR_Integer) 9:
                    {
                      mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_c_export.export_type_to_prefix_suffix\'/3", (MR_String) "unknown_type");
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, BaseType_23, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 3:
                  case (MR_Integer) 6:
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word MerType_48 = ((MR_Word) ((MR_hl_field(3, BaseType_23, (MR_Integer) 1))));

                      TypePrefix_43 = backend_libs__foreign__maybe_foreign_type_to_c_string_2_f_0(MerType_48, (MR_Word) ((MR_Unsigned) 0U));
                    }
                    break;
                  case (MR_Integer) 2:
                    TypePrefix_43 = (MR_String) "MR_ArrayPtr";
                    break;
                  case (MR_Integer) 4:
                    {
                      MR_Word IntType_57 = ((MR_Unsigned) ((MR_hl_field(3, BaseType_23, (MR_Integer) 1))) & (MR_Integer) 15);
                      MR_Word Var_65;

                      {
                        Var_65 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(1, Var_65, 0) = (MR_Box) ((MR_Unsigned) (IntType_57));
                      }
                      TypePrefix_43 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_65);
                    }
                    break;
                  case (MR_Integer) 5:
                    {
                      MR_Word ForeignType_58 = ((MR_Word) ((MR_hl_field(3, BaseType_23, (MR_Integer) 1))));

                      switch (MR_tag((MR_Word) ForeignType_58)) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 0:
                          {
                            MR_Word Var_69 = ((MR_Word) ((MR_hl_field(0, ForeignType_58, (MR_Integer) 0))));

                            TypePrefix_43 = (MR_String) (Var_69);
                          }
                          break;
                        case (MR_Integer) 1:
                          {
                  ...
                  case (MR_Integer) 8:
                    {
                      MR_Word BaseType_61 = ((MR_Word) ((MR_hl_field(3, BaseType_23, (MR_Integer) 1))));
                      MR_String BaseTypeStr_62;

                      BaseTypeStr_62 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_61);
                      TypePrefix_43 = mercury__string__f_43_43_2_f_0(BaseTypeStr_62, (MR_String) " *");
                    }
                    break;
                  case (MR_Integer) 10:
                    TypePrefix_43 = (MR_String) "MR_Word";
            ...
            succeeded = (strcmp((MR_String) "", (MR_String) "") == 0);
            if (succeeded)
              BaseTypeStr_24 = TypePrefix_43;
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "function \140ml_backend.mlds_to_c_export.export_type_to_string_for_c\'/1", (MR_String) "TypeSuffix is not empty");
                return;
              }
            *TypePrefix_7 = mercury__string__f_43_43_2_f_0(BaseTypeStr_24, (MR_String) " *");
          }
          break;
        case (MR_Integer) 10:
          *TypePrefix_7 = (MR_String) "MR_Word";
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__197__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  switch (MR_tag((MR_Word) MLDS_Type_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_19 = ((MR_Unsigned) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_27;
            ...
            TypePrefix_5 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_27);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_20 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))));
        ...
        case (MR_Integer) 8:
          {
            MR_Word BaseType_23 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))));
            MR_String BaseTypeStr_24;

            BaseTypeStr_24 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_23);
            TypePrefix_5 = mercury__string__f_43_43_2_f_0(BaseTypeStr_24, (MR_String) " *");
          }
          break;
        case (MR_Integer) 10:
          TypePrefix_5 = (MR_String) "MR_Word";
