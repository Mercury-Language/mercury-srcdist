...
{
  {
    ...
    if (succeeded)
    {
      Name_29 = ((MR_String) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 0))));
      Seq_30 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Name_29));
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 2) = ((MR_Box) (Seq_30));
      }
    }
    else
    {
      ...
      NameStr_31 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_10);
      {
        Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (NameStr_31));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Var_32));
      }
    }
...
{
  {
    ...
    if (succeeded)
    {
      Type_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_11, (MR_Integer) 1))));
      PointedToType_14 = Type_33;
    }
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      Name_28 = ((MR_String) ((MR_hl_field(MR_mktag(1), LocalVarName_8, (MR_Integer) 0))));
      Seq_29 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), LocalVarName_8, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 1) = ((MR_Box) (Name_28));
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 2) = ((MR_Box) (Seq_29));
      }
    }
    else
    {
      ...
      NameStr_30 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_8);
      {
        Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (NameStr_30));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 1) = ((MR_Box) (Var_31));
      }
    }
    ...
    if (succeeded)
    {
      Type_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 1))));
      Var_16 = Type_33;
    }
    else
    {
...
{
  {
    ...
    if (!((RetTypes_13 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if ((Var_141 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t");
          ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_prefix_suffix_4_p_0(Var_142, Stream_8);
    ...
    else
    {
      ...
      if ((Var_143 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\tret_value = (");
          ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_prefix_suffix_4_p_0(Var_144, Stream_8);
          mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
        }
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_call_6_p_0(Opts_7, Stream_8, FuncName_9, Parameters_12);
      }
    ...
    if (!((RetTypes_13 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if ((Var_145 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_prefix_suffix_4_p_0(Var_146, Stream_8);
