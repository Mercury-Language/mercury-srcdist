...
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant_hashdef__421__1_2_p_0(
  MR_Word Lang_12,
  MR_Word HeadVar__2_31);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__203__1_1_p_0(
  MR_Word LambdaHeadVar__1_41);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__198__1_1_p_0(
  ...
  MR_Word LambdaHeadVar__1_41)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_124)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_124, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
    Var_42 = ((MR_Word) ((MR_hl_field(3, Type_124, (MR_Integer) 1))));
    succeeded = ((((MR_tag((MR_Word) Var_42)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_42, (MR_Integer) 0)))) == (MR_Integer) 5)));
    if (succeeded)
    {
  ...
  MR_Word LambdaHeadVar__1_39)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_17, (MR_Integer) 0)))) == (MR_Integer) 5)));
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant_hashdef__421__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word Arg_5)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0)))) == (MR_Integer) 5)));
  if (succeeded)
  {
  ...
  else
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Type_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0)))) == (MR_Integer) 9)));
    if (succeeded)
    {
  ...
  MR_Word Arg_3)
{
  ...
  succeeded = ((((MR_tag((MR_Word) PtrType_6)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, PtrType_6, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
  ...
  switch (MR_tag((MR_Word) Type_8)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_49 = ((MR_Unsigned) ((MR_hl_field(3, Type_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_57;

            {
              Var_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_57, 0) = (MR_Box) ((MR_Unsigned) (IntType_49));
            }
            TypePrefix_34 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_57);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_50 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_50)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_61 = ((MR_Word) ((MR_hl_field(0, ForeignType_50, (MR_Integer) 0))));

                  TypePrefix_34 = (MR_String) (Var_61);
                }
                break;
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 9:
          {
            MR_Word BaseType_53 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));
            MR_String BaseTypeStr_54;

            BaseTypeStr_54 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_53);
            TypePrefix_34 = mercury__string__f_43_43_2_f_0(BaseTypeStr_54, (MR_String) " *");
          }
          break;
        case (MR_Integer) 11:
          TypePrefix_34 = (MR_String) "MR_Word";
  ...
  if (succeeded)
  {
    Name_73 = ((MR_String) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 0))));
    Seq_74 = ((MR_Integer) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 1))));
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Name_73));
      MR_hl_field(3, BoxedLocalVarName_10, 2) = ((MR_Box) (Seq_74));
    }
  }
  else
  {
    MR_String NameStr_75;
    MR_Word Var_76;

    NameStr_75 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_5);
    {
      Var_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_76, 0) = ((MR_Box) (NameStr_75));
    }
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Var_76));
    }
  }
  ...
  MR_Word Arg_3)
{
  ...
  switch (MR_tag((MR_Word) Type_6)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_44 = ((MR_Unsigned) ((MR_hl_field(3, Type_6, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_52;

            {
              Var_52 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_52, 0) = (MR_Box) ((MR_Unsigned) (IntType_44));
            }
            TypePrefix_29 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_52);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_45 = ((MR_Word) ((MR_hl_field(3, Type_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_45)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_56 = ((MR_Word) ((MR_hl_field(0, ForeignType_45, (MR_Integer) 0))));

                  TypePrefix_29 = (MR_String) (Var_56);
                }
                break;
              case (MR_Integer) 1:
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_c_export.export_type_to_prefix_suffix\'/3", (MR_String) "java foreign_type");
        ...
        case (MR_Integer) 9:
          {
            MR_Word BaseType_48 = ((MR_Word) ((MR_hl_field(3, Type_6, (MR_Integer) 1))));
            MR_String BaseTypeStr_49;

            BaseTypeStr_49 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_48);
            TypePrefix_29 = mercury__string__f_43_43_2_f_0(BaseTypeStr_49, (MR_String) " *");
          }
          break;
        case (MR_Integer) 11:
          TypePrefix_29 = (MR_String) "MR_Word";
  ...
  if (succeeded)
  {
    Name_68 = ((MR_String) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 0))));
    Seq_69 = ((MR_Integer) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(3, BoxedLocalVarName_9, 1) = ((MR_Box) (Name_68));
      MR_hl_field(3, BoxedLocalVarName_9, 2) = ((MR_Box) (Seq_69));
    }
  }
  else
  {
    ...
    NameStr_70 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_5);
    {
      Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_71, 0) = ((MR_Box) (NameStr_70));
    }
    {
      ...
      MR_hl_field(3, BoxedLocalVarName_9, 1) = ((MR_Box) (Var_71));
    }
  }
  ...
  MR_Word Arg_5)
{
  ...
  succeeded = ((((MR_tag((MR_Word) PtrType_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, PtrType_8, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
  ...
  switch (MR_tag((MR_Word) MLDS_Type_6)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_20 = ((MR_Unsigned) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_28;

            {
              Var_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_28, 0) = (MR_Box) ((MR_Unsigned) (IntType_20));
            }
            *TypePrefix_7 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_28);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_21 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ForeignType_21)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word Var_32 = ((MR_Word) ((MR_hl_field(0, ForeignType_21, (MR_Integer) 0))));

                  *TypePrefix_7 = (MR_String) (Var_32);
                }
                break;
              case (MR_Integer) 1:
                {
        ...
        case (MR_Integer) 9:
          {
            MR_Word BaseType_24 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_6, (MR_Integer) 1))));
            MR_String BaseTypeStr_25;
            MR_String TypePrefix_44;

            switch (MR_tag((MR_Word) BaseType_24)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(BaseType_24)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 5:
                  case (MR_Integer) 6:
                  case (MR_Integer) 7:
                  case (MR_Integer) 8:
                    TypePrefix_44 = (MR_String) "MR_Word";
                    break;
                  case (MR_Integer) 1:
                    TypePrefix_44 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 0U));
                    break;
                  case (MR_Integer) 2:
                    TypePrefix_44 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 4U));
                    break;
                  case (MR_Integer) 3:
                    TypePrefix_44 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 8U));
                    break;
                  case (MR_Integer) 4:
                    TypePrefix_44 = (MR_String) "MR_bool";
                    break;
                  case (MR_Integer) 9:
                    {
                      mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_c_export.export_type_to_prefix_suffix\'/3", (MR_String) "unknown_type");
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, BaseType_24, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 3:
                  case (MR_Integer) 6:
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word MerType_49 = ((MR_Word) ((MR_hl_field(3, BaseType_24, (MR_Integer) 1))));

                      TypePrefix_44 = backend_libs__foreign__maybe_foreign_type_to_c_string_2_f_0(MerType_49, (MR_Word) ((MR_Unsigned) 0U));
                    }
                    break;
                  case (MR_Integer) 2:
                    TypePrefix_44 = (MR_String) "MR_ArrayPtr";
                    break;
                  case (MR_Integer) 4:
                    {
                      MR_Word IntType_59 = ((MR_Unsigned) ((MR_hl_field(3, BaseType_24, (MR_Integer) 1))) & (MR_Integer) 15);
                      MR_Word Var_67;

                      {
                        Var_67 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(1, Var_67, 0) = (MR_Box) ((MR_Unsigned) (IntType_59));
                      }
                      TypePrefix_44 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_67);
                    }
                    break;
                  case (MR_Integer) 5:
                    {
                      MR_Word ForeignType_60 = ((MR_Word) ((MR_hl_field(3, BaseType_24, (MR_Integer) 1))));

                      switch (MR_tag((MR_Word) ForeignType_60)) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 0:
                          {
                            MR_Word Var_71 = ((MR_Word) ((MR_hl_field(0, ForeignType_60, (MR_Integer) 0))));

                            TypePrefix_44 = (MR_String) (Var_71);
                          }
                          break;
                        case (MR_Integer) 1:
                          {
                  ...
                  case (MR_Integer) 9:
                    {
                      MR_Word BaseType_63 = ((MR_Word) ((MR_hl_field(3, BaseType_24, (MR_Integer) 1))));
                      MR_String BaseTypeStr_64;

                      BaseTypeStr_64 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_63);
                      TypePrefix_44 = mercury__string__f_43_43_2_f_0(BaseTypeStr_64, (MR_String) " *");
                    }
                    break;
                  case (MR_Integer) 11:
                    TypePrefix_44 = (MR_String) "MR_Word";
            ...
            succeeded = (strcmp((MR_String) "", (MR_String) "") == 0);
            if (succeeded)
              BaseTypeStr_25 = TypePrefix_44;
            else
              {
                mercury__require__unexpected_2_p_0((MR_String) "function \140ml_backend.mlds_to_c_export.export_type_to_string_for_c\'/1", (MR_String) "TypeSuffix is not empty");
                return;
              }
            *TypePrefix_7 = mercury__string__f_43_43_2_f_0(BaseTypeStr_25, (MR_String) " *");
          }
          break;
        case (MR_Integer) 11:
          *TypePrefix_7 = (MR_String) "MR_Word";
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__203__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_pragma_export_defn_body__198__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Signature_10)
{
  ...
  else
  {
    ...
    if ((Var_169 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_170)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_170, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
  ...
  switch (MR_tag((MR_Word) MLDS_Type_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_20 = ((MR_Unsigned) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_28;
            ...
            TypePrefix_5 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_28);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word ForeignType_21 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))));
        ...
        case (MR_Integer) 9:
          {
            MR_Word BaseType_24 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_3, (MR_Integer) 1))));
            MR_String BaseTypeStr_25;

            BaseTypeStr_25 = ml_backend__mlds_to_c_export__export_type_to_string_for_c_1_f_0(BaseType_24);
            TypePrefix_5 = mercury__string__f_43_43_2_f_0(BaseTypeStr_25, (MR_String) " *");
          }
          break;
        case (MR_Integer) 11:
          TypePrefix_5 = (MR_String) "MR_Word";
