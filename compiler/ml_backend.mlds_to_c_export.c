    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_23, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_27;
    MR_Word Var_32;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PragmaExport_10, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Var_23;
    MR_Word Var_27;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Export_10, (MR_Integer) 0)));
    MR_Unsigned packed_args_1;
