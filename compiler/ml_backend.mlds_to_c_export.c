  ...
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_5[0]));
    ...
    case (MR_Integer) 0:
      {
        ...
        ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_8, Var_18, Context_13);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_4[2]));
  ...
  MR_Word Stream_8)
{
  ...
  if (succeeded)
  {
    Name_25 = ((MR_String) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 0))));
    Seq_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 1))));
    {
      BoxedLocalVarName_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Name_25));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 2) = ((MR_Box) (Seq_26));
    }
  }
  else
  {
    ...
    }
    {
      BoxedLocalVarName_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Var_28));
    }
  }
  succeeded = ((((MR_tag((MR_Word) Type_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_11, (MR_Integer) 0)))) == (MR_Integer) 7)));
  if (succeeded)
  {
    Type_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_11, (MR_Integer) 1))));
  ...
  MR_Word Stream_8)
{
  ...
  if (succeeded)
  {
    Name_24 = ((MR_String) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 0))));
    Seq_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), LocalVarName_10, (MR_Integer) 1))));
    {
      BoxedLocalVarName_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Name_24));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 2) = ((MR_Box) (Seq_25));
    }
  }
  else
  {
    ...
    NameStr_26 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_10);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (NameStr_26));
    }
    {
      BoxedLocalVarName_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_13, 1) = ((MR_Box) (Var_27));
    }
  }
  ...
  MR_Word Stream_6)
{
  ...
  if (succeeded)
  {
    Type_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 1))));
    Var_16 = Type_29;
  }
  else
  {
  ...
  MR_Word Stream_6)
{
  ...
  if (succeeded)
  {
    Name_24 = ((MR_String) ((MR_hl_field(MR_mktag(1), LocalVarName_8, (MR_Integer) 0))));
    Seq_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), LocalVarName_8, (MR_Integer) 1))));
    {
      BoxedLocalVarName_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 1) = ((MR_Box) (Name_24));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 2) = ((MR_Box) (Seq_25));
    }
  }
  else
  {
    ...
    }
    {
      BoxedLocalVarName_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), BoxedLocalVarName_11, 1) = ((MR_Box) (Var_27));
    }
  }
  ...
  MR_Word ExportedEnums_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_6[1]));
  ...
  MR_Word Stream_12)
{
  ...
  MR_Word Var_34;
  MR_Word Lang_68;
  MR_String ExportName_69;
  MR_Word Signature_71;
  MR_Word Context_73;
  MR_Word FuncName_74;
  MR_Word QualFuncName_75;
  MR_Word Var_77;
  MR_Word Var_81;

  {
    Var_22 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_5[0]));
  ...
  Lang_68 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PragmaExport_11, (MR_Integer) 0))) & (MR_Integer) 3);
  ExportName_69 = ((MR_String) ((MR_hl_field(MR_mktag(0), PragmaExport_11, (MR_Integer) 1))));
  Signature_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PragmaExport_11, (MR_Integer) 3))));
  Context_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PragmaExport_11, (MR_Integer) 5))));
  {
    Var_77 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (ml_backend__mlds_to_c_export__mlds_output_pragma_export_defn_7_p_0_2));
    MR_hl_field(MR_mktag(0), Var_77, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_77, 3) = ((MR_Box) (Lang_68));
    MR_hl_field(MR_mktag(0), Var_77, 4) = ((MR_Box) ((MR_Integer) 0));
  }
  mercury__require__expect_3_p_0(Var_77, (MR_String) "predicate \140ml_backend.mlds_to_c_export.mlds_output_pragma_export_func_name\'/7", (MR_String) "export to language other than C.");
  {
    FuncName_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), FuncName_74, 0) = ((MR_Box) (ExportName_69));
  }
  {
    QualFuncName_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), QualFuncName_75, 0) = ((MR_Box) (ModuleName_9));
    MR_hl_field(MR_mktag(0), QualFuncName_75, 1) = ((MR_Box) (FuncName_74));
  }
  Var_81 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
  ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_12, Var_81, Context_73);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_12, Indent_10);
  ml_backend__mlds_to_c_func__mlds_output_func_decl_ho_11_p_0(Opts_8, Stream_12, Indent_10, QualFuncName_75, Context_73, (MR_String) "", Signature_71, (MR_Word) (&ml_backend__mlds_to_c_export_scalar_common_2[1]), (MR_Word) (&ml_backend__mlds_to_c_export_scalar_common_2[2]));
  ...
  MR_Word Signature_10)
{
  ...
  CForeignTypeOutputs_23 = mercury__list__filter_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_c_export_scalar_common_3[1]), Parameters_12);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_1[0]));
  ...
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_46, (MR_String) "", CForeignTypeInputs_22, Stream_8);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_1[0]));
  ...
  {
    MR_Word Var_141 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 1))));
    MR_Word Var_142 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 0))));

    if ((Var_141 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_54;

      succeeded = ((((MR_tag((MR_Word) Var_142)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_142, (MR_Integer) 0)))) == (MR_Integer) 4)));
      if (succeeded)
      {
        Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_142, (MR_Integer) 1))));
      ...
      {
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t");
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 0, Var_142, Stream_8);
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 1, Var_142, Stream_8);
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) " ret_value;\n");
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t");
        ml_backend__mlds_to_c_type__mlds_output_type_5_p_0(Opts_7, Var_142, Stream_8);
  ...
  if ((RetTypes_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_156, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_1[0]));
      MR_hl_field(MR_mktag(0), Var_156, 1) = ((MR_Box) (ml_backend__mlds_to_c_export__mlds_output_pragma_export_defn_body_6_p_0_6));
      MR_hl_field(MR_mktag(0), Var_156, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_156, 3) = ((MR_Box) (Opts_7));
    }
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_156, (MR_String) ", ", Parameters_12, Stream_8);
    mercury__io__write_string_4_p_0(Stream_8, (MR_String) ");\n");
  }
  else
  {
    MR_Word Var_143 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 1))));
    MR_Word Var_144 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 0))));

    if ((Var_143 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_81;

      succeeded = ((((MR_tag((MR_Word) Var_144)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_144, (MR_Integer) 0)))) == (MR_Integer) 4)));
      if (succeeded)
      {
        Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_144, (MR_Integer) 1))));
      ...
      {
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\tret_value = (");
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 0, Var_144, Stream_8);
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 1, Var_144, Stream_8);
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
      }
  ...
  if (!((RetTypes_13 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_Word Var_145 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 1))));
    MR_Word Var_146 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_13, (MR_Integer) 0))));

    if ((Var_145 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_98;

      succeeded = ((((MR_tag((MR_Word) Var_146)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_146, (MR_Integer) 0)))) == (MR_Integer) 4)));
      if (succeeded)
      {
        Var_98 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_146, (MR_Integer) 1))));
      ...
      if (succeeded)
      {
        ...
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 0, Var_146, Stream_8);
        ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_5_p_0((MR_Integer) 1, Var_146, Stream_8);
  ...
  MR_Word Parameters_10)
{
  ...
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
  {
    ...
    MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&ml_backend__mlds_to_c_export_scalar_common_1[0]));
            ...
            case (MR_Integer) 3:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_49, 0) = (MR_Box) ((MR_Unsigned) (IntType_20));
                }
                TypeStr_59 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_49);
            ...
            case (MR_Integer) 4:
              {
                ...
                switch (MR_tag((MR_Word) ForeignType_21)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_String Name_22;
                      MR_Word Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignType_21, (MR_Integer) 0))));

                      Name_22 = (MR_String) (Var_41);
