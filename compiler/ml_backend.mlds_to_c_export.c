  ...
  MR_Word Arg_3)
{
  ...
  switch (MR_tag((MR_Word) Type_8)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 3:
          {
            MR_Word IntType_47 = ((MR_Unsigned) ((MR_hl_field(3, Type_8, (MR_Integer) 1))) & (MR_Integer) 15);
            MR_Word Var_55;
        ...
        case (MR_Integer) 4:
          {
            MR_Word ForeignType_48 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));
        ...
        case (MR_Integer) 7:
          {
            MR_Word BaseType_51 = ((MR_Word) ((MR_hl_field(3, Type_8, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    Seq_72 = ((MR_Integer) ((MR_hl_field(1, LocalVarName_5, (MR_Integer) 1))));
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Name_71));
      MR_hl_field(3, BoxedLocalVarName_10, 2) = ((MR_Box) (Seq_72));
    }
  }
  else
  {
    ...
    }
    {
      BoxedLocalVarName_10 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BoxedLocalVarName_10, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(3, BoxedLocalVarName_10, 1) = ((MR_Box) (Var_74));
    }
  }
