...
ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant__430__1_2_p_0(
  MR_Word Lang_10,
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_c_export__IntroducedFrom__pred__mlds_output_exported_enum_constant__430__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      switch (MR_tag((MR_Word) MLDS_Type_6)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(MLDS_Type_6)) {
            ...
            case (MR_Integer) 1:
              {
                MR_String TypeStr_58;

                TypeStr_58 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 0U));
                mercury__io__write_string_3_p_0(TypeStr_58);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                TypeStr_59 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 4U));
                mercury__io__write_string_3_p_0(TypeStr_59);
              }
              break;
            case (MR_Integer) 3:
              {
                ...
                TypeStr_60 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0((MR_Word) ((MR_Unsigned) 8U));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word Var_47;
                MR_String TypeStr_57;

                {
                  Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_47, 0) = (MR_Box) ((MR_Unsigned) (IntType_18));
                }
                TypeStr_57 = backend_libs__foreign__exported_builtin_type_to_c_string_1_f_0(Var_47);
                mercury__io__write_string_3_p_0(TypeStr_57);
              }
              break;
            case (MR_Integer) 4:
              {
                ...
                switch (MR_tag((MR_Word) ForeignType_19)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_String Name_20;
                      MR_Word Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignType_19, (MR_Integer) 0))));

                      Name_20 = (MR_String) (Var_39);
            ...
            case (MR_Integer) 7:
              {
                MR_Word Type_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));

                ml_backend__mlds_to_c_export__mlds_output_pragma_export_type_4_p_0((MR_Integer) 0, Type_23);
                mercury__io__write_string_3_p_0((MR_String) " *");
              }
              break;
            case (MR_Integer) 9:
