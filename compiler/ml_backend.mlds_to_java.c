...
ml_backend__mlds_to_java__IntroducedFrom__pred__output_rval_const_for_java__4670__1_2_p_0(
  MR_Word Lang_17,
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_122 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 5)));
              Var_123 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 6)));
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_java__IntroducedFrom__pred__output_rval_const_for_java__4670__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
