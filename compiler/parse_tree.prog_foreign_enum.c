  ...
  MR_Word Final_5)
{
  ...
  Pieces_6 = parse_tree__error_spec__component_list_to_color_line_pieces_3_f_0((MR_Word) (MR_mkword(1, &parse_tree__prog_foreign_enum_scalar_common_2[0])), Final_5, Components_7);
  return Pieces_6;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  Var_46 = parse_tree__error_spec__component_list_to_color_line_pieces_3_f_0((MR_Word) (MR_mkword(1, &parse_tree__prog_foreign_enum_scalar_common_2[0])), (MR_Word) (MR_mkword(1, &parse_tree__prog_foreign_enum_scalar_common_1[19])), UnqualCtors_12);
  ...
  Var_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_7, ErrorPieces_13);
  {
    ...
    MR_hl_field(0, Spec_14, 4) = ((MR_Box) (Var_60));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_15)
{
  ...
  Var_44 = parse_tree__error_spec__component_list_to_color_line_pieces_3_f_0((MR_Word) (MR_mkword(1, &parse_tree__prog_foreign_enum_scalar_common_2[0])), (MR_Word) (MR_mkword(1, &parse_tree__prog_foreign_enum_scalar_common_1[19])), QualCtors_11);
  ...
  Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_7, ErrorPieces_12);
  {
    ...
    MR_hl_field(0, Spec_13, 4) = ((MR_Box) (Var_58));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
