  ...
  MR_Word * STATE_VARIABLE_Specs_48)
{
  ...
  else
  {
    ...
    Pieces_41 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), MainPieces_34, Var_127);
    {
      ...
      MR_hl_field(0, Spec_42, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.prog_foreign_enum.build_ctor_name_to_foreign_name_map\'/9"));
      MR_hl_field(0, Spec_42, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      MR_hl_field(0, Spec_42, 3) = ((MR_Box) (Context_11));
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  }
  {
    ...
    MR_hl_field(2, Spec_23, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.prog_foreign_enum.add_foreign_enum_unmapped_ctors_error\'/5"));
    MR_hl_field(2, Spec_23, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(2, Spec_23, 2) = ((MR_Box) ((MR_Unsigned) 44U));
    MR_hl_field(2, Spec_23, 3) = ((MR_Box) (Var_100));
  }
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  Var_43 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_7, ErrorPieces_11);
  {
    ...
    MR_hl_field(0, Spec_12, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.prog_foreign_enum.add_unknown_ctors_error\'/5"));
    ...
    MR_hl_field(0, Spec_12, 4) = ((MR_Box) (Var_43));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  {
    Spec_12 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Spec_12, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.prog_foreign_enum.add_bad_qual_ctors_error\'/5"));
    MR_hl_field(0, Spec_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, Spec_12, 2) = ((MR_Box) ((MR_Unsigned) 44U));
    MR_hl_field(0, Spec_12, 3) = ((MR_Box) (Context_6));
    MR_hl_field(0, Spec_12, 4) = ((MR_Box) (Var_46));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
