  ...
  MR_Word * STATE_VARIABLE_RepeatedForeignNames_16)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_RepeatedCtorNames_1_73 = mercury__cord__snoc_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), STATE_VARIABLE_RepeatedCtorNames_0_13, ((MR_Box) (CtorName_53)));
