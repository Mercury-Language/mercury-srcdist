  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  if ((CtorsEnd_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_Word Var_83;
    MR_Word Var_84;
    MR_Word Components_105;

    Components_105 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_foreign_enum_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_foreign_enum_scalar_common_4[3]), CtorNames_10);
    Var_84 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_105, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[28])));
  ...
  else
  {
    ...
    MR_Word Var_69;
    MR_Word Var_70;
    MR_Word Components_109;

    mercury__list__length_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CtorsEnd_12, &NumEndCtors_19);
    Components_109 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_foreign_enum_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_foreign_enum_scalar_common_4[4]), CtorsStart_11);
    Var_43 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_109, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[31])));
    {
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  Var_32 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_47, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[23])));
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  Var_35 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_50, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[23])));
