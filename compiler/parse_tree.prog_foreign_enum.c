  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  if ((CtorsEnd_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_84 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_104, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[28])));
    ...
    CtorsPieces_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[10])), Var_83);
    {
  ...
  else
  {
    ...
    Var_43 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Components_108, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[31])));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[34])));
    }
    {
      Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_foreign_enum_scalar_common_1[32])));
      MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (Var_57));
    }
    {
      Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_foreign_enum_scalar_common_1[13])));
    ...
    NonVerboseCtorsPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[10])), Var_42);
    Var_70 = parse_tree__prog_foreign_enum__ctor_names_to_line_pieces_2_f_0(CtorNames_10, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[28])));
    Var_69 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_70, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[14])));
    VerboseCtorsPieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[10])), Var_69);
    {
