  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  else
  {
    ...
    Var_43 = parse_tree__prog_foreign_enum__ctor_names_to_line_pieces_2_f_0(CtorsStart_11, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__prog_foreign_enum_scalar_common_1[31])));
    {
