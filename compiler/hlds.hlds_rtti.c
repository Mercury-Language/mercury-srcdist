  ...
  MR_Word * STATE_VARIABLE_TypeInfoVars_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((TypeVars_17 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        *VarInfo_6 = (MR_Word) ((MR_Integer) 0);
    }
  }
}
...
{
  {
    ...
    hlds__hlds_rtti__filter_type_info_varmap_4_p_0(TIList0_10, VarUses_4, (MR_Word) ((MR_Integer) 0), &RevTIList_11);
    ...
    hlds__hlds_rtti__filter_type_info_map_4_p_0(TypeList0_13, VarUses_4, (MR_Word) ((MR_Integer) 0), &RevTypeList_14);
    ...
    hlds__hlds_rtti__filter_constraint_map_6_p_0(ConstraintList0_16, VarUses_4, (MR_Word) ((MR_Integer) 0), &RevConstraintList_17, TCIMap0_6, &TCIMap_18);
