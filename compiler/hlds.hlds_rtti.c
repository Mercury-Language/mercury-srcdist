...
MR_define_entry(mercury____Unify___hlds__hlds_rtti__rtti_proc_label_0_0);
	...
	MR_sv(14) = MR_tfield(0, MR_tempr3, 15);
	...
	MR_sv(23) = MR_tfield(0, MR_tempr4, 10);
	MR_sv(24) = MR_tfield(0, MR_tempr4, 11);
	MR_sv(25) = MR_tfield(0, MR_tempr4, 12);
	MR_sv(26) = MR_tfield(0, MR_tempr4, 13);
	MR_sv(27) = MR_tfield(0, MR_tempr4, 14);
	MR_sv(28) = MR_tfield(0, MR_tempr4, 15);
