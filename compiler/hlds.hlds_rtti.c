...
{
  {
      ...
      ProcIsImported_29 = (MR_Integer) 0;
    {
      ...
      MR_hl_field(MR_mktag(0), ProcLabel_8, 10) = (MR_Box) (((((MR_Unsigned) (ProcDetism_20) << (MR_Integer) 2)) | (((((MR_Unsigned) (PredIsImported_22) << (MR_Integer) 1)) | (MR_Unsigned) (PredIsPseudoImp_23)))));
      MR_hl_field(MR_mktag(0), ProcLabel_8, 11) = ((MR_Box) (Origin_25));
      MR_hl_field(MR_mktag(0), ProcLabel_8, 12) = (MR_Box) (((((MR_Unsigned) (ProcIsExported_24) << (MR_Integer) 1)) | (MR_Unsigned) (ProcIsImported_29)));
    }
    return ProcLabel_8;
  }
}
