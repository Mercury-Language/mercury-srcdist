  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__hlds_rtti__IntroducedFrom__pred__get_typeinfo_vars_acc__880__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_28);
  ...
  MR_Word * STATE_VARIABLE_RttiVarMaps_11)
{
  ...
  if (((MR_tag((MR_Word) Locn_6)) == (MR_Integer) 0))
  {
    ...
    if (succeeded)
    {
      Var_41 = ((MR_Word) ((MR_hl_field(0, Type_24, 0))));
