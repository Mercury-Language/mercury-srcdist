...
MR_decl_label4(hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_0, 5,6,7,19)
...
MR_def_label(fn__hlds__hlds_rtti__make_rtti_proc_label_3_0,36)
	...
	MR_tfield(0, MR_r1, 10) = ((MR_Integer) MR_sv(6) | (((MR_Integer) MR_sv(15) << (MR_Integer) 3) | ((MR_Integer) MR_sv(1) << (MR_Integer) 4)));
	MR_tfield(0, MR_r1, 11) = MR_sv(12);
	MR_tfield(0, MR_r1, 12) = ((MR_Integer) MR_sv(5) | ((MR_Integer) 1 << (MR_Integer) 1));
...
MR_def_label(fn__hlds__hlds_rtti__make_rtti_proc_label_3_0,35)
	...
	MR_tfield(0, MR_r2, 10) = ((MR_Integer) MR_sv(6) | (((MR_Integer) MR_sv(15) << (MR_Integer) 3) | ((MR_Integer) MR_sv(1) << (MR_Integer) 4)));
	MR_tfield(0, MR_r2, 11) = MR_sv(12);
	MR_tfield(0, MR_r2, 12) = ((MR_Integer) MR_sv(5) | ((MR_Integer) 0 << (MR_Integer) 1));
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(16);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__hlds__hlds_rtti__restrict_rtti_varmaps_3_0);
	...
	MR_sv(7) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_rtti, type_info_locn);
	MR_r1 = MR_sv(6);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(hlds__hlds_rtti__apply_substitutions_to_rtti_varmaps_5_0,15)
	...
	MR_sv(12) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_rtti, type_info_locn);
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(12);
	}
	MR_np_call_localret_ent(fn__map__init_0_0,
...
MR_BEGIN_MODULE(hlds__hlds_rtti_module33)
	...
	MR_init_label4(hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_0,5,6,7,19)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_0);
	...
	if (MR_INT_EQ(MR_r2,0)) {
		MR_GOTO_LAB(hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_0_i19);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
