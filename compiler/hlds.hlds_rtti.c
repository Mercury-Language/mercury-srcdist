...
{
  {
    ...
    TypeInfo_8_32 = (MR_Word) &hlds__hlds_rtti_scalar_common_1[0];
    succeeded = mercury__map__search_3_p_0(TypeInfo_8_32, TypeInfo_8_32, Subst_10, ((MR_Box) (Var0_11)), &conv0_Var1_31);
    if (succeeded)
    {
...
{
  {
    ...
    TypeInfo_8_47 = (MR_Word) &hlds__hlds_rtti_scalar_common_1[0];
    succeeded = mercury__map__search_3_p_0(TypeInfo_8_47, TypeInfo_8_47, Subst_10, ((MR_Box) (Var0_11)), &conv0_Var1_46);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (!(succeeded))
      {
        ...
        Var_27 = mercury__string__string_1_f_0(TypeCtorInfo_35_35, ((MR_Box) (Type_15)));
        Var_30 = mercury__string__string_1_f_0(TypeCtorInfo_35_35, ((MR_Box) (ExistingType_17)));
