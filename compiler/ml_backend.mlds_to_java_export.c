  ...
  MR_Word HeadVar__1_1)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Var_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_5, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
  }
  return succeeded;
  ...
  MR_Integer * HeadVar__6_6)
{
  ...
  *HeadVar__6_6 = (MR_Integer) ((MR_Unsigned) N_13 + (MR_Unsigned) 1);
  ...
  succeeded = ((((MR_tag((MR_Word) Type_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_17, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
  ...
  MR_Word Stream_10)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_13, (MR_Integer) 0)))) == (MR_Integer) 9)));
  if (succeeded)
  {
