  ...
  MR_Word Export_10)
{
  ...
  if (!((ReturnTypes_19 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_Word Var_48 = ((MR_Word) ((MR_hl_field(1, ReturnTypes_19, (MR_Integer) 1))));
    MR_Word Var_49 = ((MR_Word) ((MR_hl_field(1, ReturnTypes_19, (MR_Integer) 0))));

    if ((Var_48 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "return (");
      ml_backend__mlds_to_java_type__output_type_for_java_5_p_0(Info_7, Var_49, Stream_8);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) ") ");
    }
    else
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "return ");
  }
  ModuleName_50 = ((MR_Word) ((MR_hl_field(0, QualFuncName_14, (MR_Integer) 0))));
  FuncName_51 = ((MR_Word) ((MR_hl_field(0, QualFuncName_14, (MR_Integer) 1))));
  ml_backend__mlds_to_java_name__output_qual_name_prefix_java_5_p_0(Stream_8, ModuleName_50, (MR_Integer) 0);
  ml_backend__mlds_to_java_name__output_function_name_for_java_4_p_0(Stream_8, FuncName_51);
  mercury__io__write_char_4_p_0(Stream_8, (MR_Char) 40);
