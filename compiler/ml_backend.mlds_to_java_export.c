  ...
  MR_Word Export_10)
{
  ...
  if (!((Parameters_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    Var_77 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_2[2]));
      MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (ml_backend__mlds_to_java_export__output_export_ref_out_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_74, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (Info_7));
      MR_hl_field(MR_mktag(0), Var_74, 4) = ((MR_Box) (Var_77));
    }
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_74, (MR_String) ",\n", Parameters_18, Stream_8);
  }
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
  mercury__io__nl_3_p_0(Stream_8);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
  ...
  MR_Word Export_10)
{
  ...
  ModuleName_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 0))));
  FuncName_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 1))));
  ml_backend__mlds_to_java_name__output_qual_name_prefix_java_5_p_0(Stream_8, ModuleName_56, (MR_Integer) 0);
  ml_backend__mlds_to_java_name__output_function_name_for_java_4_p_0(Stream_8, FuncName_57);
