...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) " = ");
    ml_backend__mlds_to_java_data__output_initializer_body_for_java_5_p_0(Info_7, Initializer_13, (MR_Word) ((MR_Integer) 0));
    mercury__io__write_string_3_p_0((MR_String) ";\n");
  }
}
...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Var_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_5, (MR_Integer) 0))) == (MR_Integer) 6)));
    if (succeeded)
    {
    }
    return succeeded;
...
{
  {
    ...
    *HeadVar__5_5 = (MR_Integer) ((MR_Unsigned) N_11 + (MR_Unsigned) (MR_Integer) 1);
    ...
    succeeded = ((((MR_tag((MR_Word) Type_14)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_14, (MR_Integer) 0))) == (MR_Integer) 6)));
    if (succeeded)
    {
...
{
  {
...

    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 1)));
      Var_60 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 1))) & (MR_Integer) 1);
      Var_61 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      Var_62 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 1);
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 5)));
      Var_66 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 5))) & (MR_Integer) 1);
      Var_67 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 5))) >> (MR_Integer) 1)) & (MR_Integer) 3);
      Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 6))));
      {
        ...
        MR_hl_field(MR_mktag(0), Info_18, 1) = (MR_Box) (packed_args_0);
        ...
        MR_hl_field(MR_mktag(0), Info_18, 5) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 0))) | (((MR_Unsigned) (((MR_Box) (Var_67))) << (MR_Integer) 1))));
      ...
      else
      {
        ...
        if ((Var_81 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "(");
    if (!((Parameters_16 == (MR_Word) ((MR_Integer) 0))))
    {
      MR_Word Var_73;
      MR_Integer Var_75;
    ...
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_7);
    mercury__io__write_string_3_p_0((MR_String) "{\n");
    Var_31 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) (MR_Integer) 1);
    ...
    succeeded = (ReturnTypes_17 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) ReturnTypes_17)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        succeeded = (Var_37 == (MR_Word) ((MR_Integer) 4));
        if (succeeded)
    ...
    Var_43 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) (MR_Integer) 1);
    {
    ...
    switch (FirstRefArg_20) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Var_45 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) (MR_Integer) 1);
