  ...
  MR_Word Export_10)
{
  ...
  ModuleName_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 0))));
  FuncName_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 1))));
  ml_backend__mlds_to_java_name__output_qual_name_prefix_java_5_p_0(Stream_8, ModuleName_51, (MR_Integer) 0);
  ml_backend__mlds_to_java_name__output_function_name_for_java_4_p_0(Stream_8, FuncName_52);
  mercury__io__write_char_4_p_0(Stream_8, (MR_Char) 40);
