...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) " = ");
    Var_26 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
    ml_backend__mlds_to_java_data__output_initializer_body_for_java_8_p_0(Info_7, (MR_Integer) 0, Var_26, Initializer_13, (MR_Word) ((MR_Unsigned) 0U), (MR_String) ";");
  }
}
