...
{
  {
...

    {
      ...
      Var_60 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 1);
      ...
      Var_66 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
      ...
      Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info0_6, (MR_Integer) 6))));
      {
        ...
        MR_hl_field(MR_mktag(0), Info_18, 5) = (MR_Box) (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 0))) << (MR_Integer) 2)) | (MR_Unsigned) (((MR_Box) (Var_67)))));
