  ...
  MR_Word Export_10)
{
  ...
  if (!((Parameters_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    Var_68 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_2[2]));
      MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) (ml_backend__mlds_to_java_export__output_export_ref_out_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_65, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_65, 3) = ((MR_Box) (Info_7));
  ...
  ModuleName_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 0))));
  FuncName_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncName_14, (MR_Integer) 1))));
