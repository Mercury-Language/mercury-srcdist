...
static /* final */ const MR_Box ml_backend__mlds_to_java_export_scalar_common_1[3][9];

static /* final */ const MR_Box ml_backend__mlds_to_java_export_scalar_common_2[1][7];
...
static /* final */ const MR_Box ml_backend__mlds_to_java_export_scalar_common_5[1][11];
...
{
  {
    ...
    *HeadVar__6_6 = (MR_Integer) ((MR_Unsigned) N_13 + (MR_Unsigned) 1);
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_export_scalar_common_7[0]), N_13, &Var_38);
...
{
  {
...

    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_6[0]));
...
{
  {
    ...
    mercury__list__filter_4_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_java_export_scalar_common_3[2]), Parameters_18, &RefParams_20, &NonRefParams_21);
    ...
    if (!((Parameters_18 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_78 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_1[2]));
    ...
    Var_45 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_5[0]));
...
{
  {
    ...
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_java_export_scalar_common_3[1]), (MR_String) ", ", Parameters_8, Stream_6);
...
{
  {
    ...
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_java_export_scalar_common_3[0]), (MR_String) ", ", Parameters_18, Stream_8);
    mercury__io__write_string_4_p_0(Stream_8, (MR_String) ");\n");
    ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
    mercury__io__write_string_4_p_0(Stream_8, (MR_String) "}\n");
  }
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_1[1]));
...
{
  {
    ...
    {
      Var_14 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_java_export_scalar_common_1[0]));
