...
MR_decl_label10(hlds__hlds_args__proc_arg_vector_foldl4_corresponding3_12_0, 2,3,4,5,6,7,8,9,14,18)
MR_decl_label1(hlds__hlds_args__proc_arg_vector_foldl4_corresponding3_12_0, 21)
...
MR_define_entry(mercury__fn__hlds__hlds_args__proc_arg_vector_to_list_1_0);
	...
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_tempr3, 6);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(1,0,0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tfield(0, MR_tempr3, 5);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_tempr3, 4);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tfield(0, MR_tempr3, 3);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_define_entry(mercury__hlds__hlds_args__proc_arg_vector_partition_poly_args_3_0);
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tfield(0, MR_tempr3, 2);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(hlds__hlds_args_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__hlds_args__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__hlds_args_module32)
	...
	MR_init_label10(hlds__hlds_args__proc_arg_vector_foldl4_corresponding3_12_0,2,3,4,5,6,7,8,9,14,18)
	MR_init_label1(hlds__hlds_args__proc_arg_vector_foldl4_corresponding3_12_0,21)
MR_BEGIN_CODE
