...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeRetValA_28)) == (MR_Integer) 1);
    if (succeeded)
    {
      RetValA_45 = (MR_hl_field(MR_mktag(1), MaybeRetValA_28, (MR_Integer) 0));
      succeeded = ((MR_tag((MR_Word) MaybeRetValB_36)) == (MR_Integer) 1);
      if (succeeded)
      {
        RetValB_46 = (MR_hl_field(MR_mktag(1), MaybeRetValB_36, (MR_Integer) 0));
        succeeded = ((MR_tag((MR_Word) MaybeRetValC_44)) == (MR_Integer) 1);
        if (succeeded)
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeRetValA_25)) == (MR_Integer) 1);
    if (succeeded)
    {
      RetValA_42 = (MR_hl_field(MR_mktag(1), MaybeRetValA_25, (MR_Integer) 0));
      succeeded = ((MR_tag((MR_Word) MaybeRetValB_33)) == (MR_Integer) 1);
      if (succeeded)
      {
        RetValB_43 = (MR_hl_field(MR_mktag(1), MaybeRetValB_33, (MR_Integer) 0));
        succeeded = ((MR_tag((MR_Word) MaybeRetValC_41)) == (MR_Integer) 1);
        if (succeeded)
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeRetValA_22)) == (MR_Integer) 1);
    if (succeeded)
    {
      RetValA_39 = (MR_hl_field(MR_mktag(1), MaybeRetValA_22, (MR_Integer) 0));
      succeeded = ((MR_tag((MR_Word) MaybeRetValB_30)) == (MR_Integer) 1);
      if (succeeded)
      {
        RetValB_40 = (MR_hl_field(MR_mktag(1), MaybeRetValB_30, (MR_Integer) 0));
        succeeded = ((MR_tag((MR_Word) MaybeRetValC_38)) == (MR_Integer) 1);
        if (succeeded)
    ...
    {
      {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeRetValue_12)) == (MR_Integer) 1);
        if (succeeded)
        {
