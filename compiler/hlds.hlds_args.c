...
{
  MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 0))));
  MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 1))));
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 2))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 3))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 4))));
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 6))));
  MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 7))));
  ...
  MR_Word * STATE_VARIABLE_A_7)
{
  ...
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 2))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 3))));
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 5))));
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 6))));
  MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_A_0_6, (MR_Integer) 7))));
...
hlds__hlds_args__proc_arg_vector_foldl3_corresponding_9_p_0(
  MR_Word TypeInfo_for_A_67,
  MR_Word TypeInfo_for_B_68,
  MR_Word TypeInfo_for_C_69,
  MR_Word TypeInfo_for_D_70,
  MR_Word TypeInfo_for_E_71,
  MR_Word P_10,
  MR_Word A_11,
  MR_Word B_12,
  ...
  MR_Box * STATE_VARIABLE_Acc3_41)
{
  ...
  {
    MR_Box Var_72 = (MR_hl_field(MR_mktag(1), MaybeRetValA_23, (MR_Integer) 0));
    ...
    else
    {
      ...
      func_0(((MR_Box) (P_10)), Var_72, RetValB_33, STATE_VARIABLE_Acc1_60_60, STATE_VARIABLE_Acc1_37, STATE_VARIABLE_Acc2_61_61, STATE_VARIABLE_Acc2_39, STATE_VARIABLE_Acc3_62_62, STATE_VARIABLE_Acc3_41);
    }
  }
}
...
hlds__hlds_args__proc_arg_vector_map_corresponding_foldl2_8_p_0(
  MR_Word TypeInfo_for_A_66,
  MR_Word TypeInfo_for_B_67,
  MR_Word TypeInfo_for_C_68,
  MR_Word TypeInfo_for_D_69,
  MR_Word TypeInfo_for_E_70,
  MR_Word P_9,
  MR_Word A_10,
  MR_Word B_11,
  MR_Word * C_12,
  ...
  MR_Box * STATE_VARIABLE_Acc2_47)
{
  ...
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, ITIA_15, ITIB_23, &ITIC_31, STATE_VARIABLE_Acc1_0_44, &STATE_VARIABLE_Acc1_48_48, STATE_VARIABLE_Acc2_0_46, &STATE_VARIABLE_Acc2_49_49);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, ITCIA_16, ITCIB_24, &ITCIC_32, STATE_VARIABLE_Acc1_48_48, &STATE_VARIABLE_Acc1_50_50, STATE_VARIABLE_Acc2_49_49, &STATE_VARIABLE_Acc2_51_51);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, UTIA_17, UTIB_25, &UTIC_33, STATE_VARIABLE_Acc1_50_50, &STATE_VARIABLE_Acc1_52_52, STATE_VARIABLE_Acc2_51_51, &STATE_VARIABLE_Acc2_53_53);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, ETIA_18, ETIB_26, &ETIC_34, STATE_VARIABLE_Acc1_52_52, &STATE_VARIABLE_Acc1_54_54, STATE_VARIABLE_Acc2_53_53, &STATE_VARIABLE_Acc2_55_55);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, UTCIA_19, UTCIB_27, &UTCIC_35, STATE_VARIABLE_Acc1_54_54, &STATE_VARIABLE_Acc1_56_56, STATE_VARIABLE_Acc2_55_55, &STATE_VARIABLE_Acc2_57_57);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, ETCIA_20, ETCIB_28, &ETCIC_36, STATE_VARIABLE_Acc1_56_56, &STATE_VARIABLE_Acc1_58_58, STATE_VARIABLE_Acc2_57_57, &STATE_VARIABLE_Acc2_59_59);
  mercury__list__map_corresponding_foldl2_8_p_0(TypeInfo_for_A_66, TypeInfo_for_B_67, TypeInfo_for_C_68, TypeInfo_for_D_69, TypeInfo_for_E_70, P_9, ArgsA_21, ArgsB_29, &ArgsC_37, STATE_VARIABLE_Acc1_58_58, &STATE_VARIABLE_Acc1_60_60, STATE_VARIABLE_Acc2_59_59, &STATE_VARIABLE_Acc2_61_61);
  ...
  {
    MR_Box Var_71 = (MR_hl_field(MR_mktag(1), MaybeRetValA_22, (MR_Integer) 0));
    ...
    else
    {
      ...
      func_0(((MR_Box) (P_9)), Var_71, RetValB_39, &RetValC_40, STATE_VARIABLE_Acc1_60_60, STATE_VARIABLE_Acc1_45, STATE_VARIABLE_Acc2_61_61, STATE_VARIABLE_Acc2_47);
      {
        MaybeRetValC_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * C_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MaybeRetValC_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * V_6)
{
  ...
  else
  {
    ...
    {
      MaybeRetVal_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * ArgVec_6)
{
  ...
  else
  {
    ...
    if (succeeded)
      {
        MaybeRetValue_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word ArgVec_3)
{
  ...
  else
  {
    ...
    {
      RetValue_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), RetValue_14, 0) = Value_13;
      MR_hl_field(MR_mktag(1), RetValue_14, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  {
    Var_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  MR_Word Var_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 0))));
  MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 1))));
  MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 2))));
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 3))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 4))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 5))));
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 6))));
  ...
  MR_Word * STATE_VARIABLE_V_7)
{
  ...
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 4))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 5))));
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_V_0_6, (MR_Integer) 7))));
  ...
  MR_Word Args0_5)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MaybeRetVal_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), ArgVec_6, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), ArgVec_6, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), ArgVec_6, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), ArgVec_6, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), ArgVec_6, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), ArgVec_6, 5) = ((MR_Box) ((MR_Unsigned) 0U));
