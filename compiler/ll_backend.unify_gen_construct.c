...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 259, &OptUnboxedFloats_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 260, &OptUnboxedInt64s_11);
      ...
      else
      {
        ...
        switch (MR_tag((MR_Word) ArgPosWidth_21)) {
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ArgPosWidth_21, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word WordNU_34;
      ...
      else
      {
        ...
        switch (MR_tag((MR_Word) ArgPosWidth_38)) {
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ArgPosWidth_38, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  *HeadVar__5_5 = HeadVar__1_1;
