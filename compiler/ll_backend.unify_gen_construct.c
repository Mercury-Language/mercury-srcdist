  ...
  MR_Word * STATE_VARIABLE_GlobalData_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 100, &OptUnboxedFloats_9);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 101, &OptUnboxedInt64s_11);
