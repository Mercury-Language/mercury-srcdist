        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              hlds__type_classify__update_type_may_use_atomic_alloc_4_p_0(ModuleInfo_199, RHSType_196, STATE_VARIABLE_MayUseAtomic_0_6, &STATE_VARIABLE_MayUseAtomic_1_145);
              switch (IsReal_197) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              hlds__type_classify__update_type_may_use_atomic_alloc_4_p_0(ModuleInfo_95, RHSType_92, STATE_VARIABLE_MayUseAtomic_0_6, &STATE_VARIABLE_MayUseAtomic_1_145);
              switch (IsReal_93) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
            ...
            case (MR_Integer) 0:
              {
                ...
                hlds__type_classify__update_type_may_use_atomic_alloc_4_p_0(ModuleInfo_187, RHSType_184, STATE_VARIABLE_MayUseAtomic_0_6, &STATE_VARIABLE_MayUseAtomic_1_145);
                switch (IsReal_185) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
