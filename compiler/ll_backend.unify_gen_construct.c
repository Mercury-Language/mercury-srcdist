...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 263, &OptUnboxedFloats_9);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 264, &OptUnboxedInt64s_11);
