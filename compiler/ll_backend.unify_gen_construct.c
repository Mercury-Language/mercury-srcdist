              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__var_table__lookup_var_entry_3_p_0(VarTable_77, RHSVar_32, &RHSVarEntry_78);
  ...
  MR_Word * STATE_VARIABLE_CLD_23)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_39, RHSVar_11, &RHSVarEntry_40);
