  ...
  MR_Word * STATE_VARIABLE_Specs_73)
{
  ...
  else
  {
    ...
    Var_168 = parse_tree__error_spec__color_as_hint_1_f_0((MR_Word) (MR_mkword(1, &parse_tree__module_qual__qual_errors_scalar_common_1[26])));
    {
  ...
  if (succeeded)
  {
    ...
    parse_tree__module_qual__mq_info__mq_info_get_this_module_2_p_0(Info_11, &Var_271);
      ...
      case (MR_Integer) 3:
        {
          ...
          parse_tree__module_qual__mq_info__mq_info_get_classes_2_p_0(Info_11, &IdSet_260);
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__module_qual__mq_info__mq_info_get_insts_2_p_0(Info_11, &IdSet_258);
      ...
      case (MR_Integer) 2:
        {
          ...
          parse_tree__module_qual__mq_info__mq_info_get_modes_2_p_0(Info_11, &IdSet_259);
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__module_qual__mq_info__mq_info_get_types_2_p_0(Info_11, &IdSet_67);
