  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  mercury__list__map_3_p_0((MR_Word) (&mercury__term_context__term_context__type_ctor_info_term_context_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), Var_53, TailContexts_10, &TailMsgs_13);
  {
    ...
    MR_hl_field(1, Var_58, 0) = ((MR_Box) (HeadMsg_12));
    MR_hl_field(1, Var_58, 1) = ((MR_Box) (TailMsgs_13));
  }
  {
    Spec_14 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(2, Spec_14, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.module_qual.qual_errors.warn_unused_interface_import\'/4"));
    MR_hl_field(2, Spec_14, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__module_qual__qual_errors_scalar_common_2[0])));
    MR_hl_field(2, Spec_14, 2) = ((MR_Box) ((MR_Unsigned) 44U));
    MR_hl_field(2, Spec_14, 3) = ((MR_Box) (Var_58));
  }
  {
    MR_Word base;
