                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        {
                          mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__module_qual__qual_errors_scalar_common_1[0]), &Var_6, ((MR_Box) (ArgX5_24)), ((MR_Box) (ArgY5_25)));
                        }
                      }
                    }
                  }
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__module_qual__qual_errors_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (Var_199)), ((MR_Box) (ArgY3_89)));
                    }
                  }
                }
                break;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_84_84 = (MR_Word) (&parse_tree__module_qual__qual_errors_scalar_common_1[0]);
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_99_99 = (MR_Word) (&parse_tree__module_qual__qual_errors_scalar_common_1[1]);
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_42_42 = (MR_Word) (&parse_tree__module_qual__qual_errors_scalar_common_1[2]);
