  ...
  MR_Word * STATE_VARIABLE_Specs_74)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_98, 0) = ((MR_Box) ((MR_Unsigned) 12U));
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_124, 0) = ((MR_Box) ((MR_Unsigned) 11U));
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(3, Var_204, 0) = ((MR_Box) ((MR_Unsigned) 8U));
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_243, 0) = ((MR_Box) ((MR_Unsigned) 6U));
