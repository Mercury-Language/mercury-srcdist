...
check_hlds__typecheck_error_overload__IntroducedFrom__func__too_much_overloading_to_msgs__111__1_1_f_0(
  ...
  MR_Word TypeAssign2_11)
{
  ...
  }
  {
    ...
    MR_hl_field(0, Spec_12, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.typecheck_error_overload.report_ambiguity_error\'/5"));
    MR_hl_field(0, Spec_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, Spec_12, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    MR_hl_field(0, Spec_12, 3) = ((MR_Box) (Var_48));
  }
  return Spec_12;
}
  ...
  MR_Word OverloadedSymbolMap_7)
{
  ...
  Msgs_9 = check_hlds__typecheck_error_overload__too_much_overloading_to_msgs_4_f_0(ClauseContext_5, Context_6, OverloadedSymbolMap_7, (MR_Integer) 1);
  {
    ...
    MR_hl_field(0, Spec_8, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.typecheck_error_overload.report_error_too_much_overloading\'/3"));
    MR_hl_field(0, Spec_8, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, Spec_8, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    MR_hl_field(0, Spec_8, 3) = ((MR_Box) (Msgs_9));
  }
  return Spec_8;
}
  ...
  MR_Word OverloadedSymbolMap_7)
{
  ...
  {
    Spec_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Spec_8, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.typecheck_error_overload.report_warning_too_much_overloading\'/3"));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_113 = check_hlds__typecheck_error_overload__IntroducedFrom__func__too_much_overloading_to_msgs__111__1_1_f_0(((MR_Word) (wrapper_arg_1)));
