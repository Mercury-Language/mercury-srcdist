  ...
  MR_Word HeadVar__2_2)
{
  ...
  LaterMsgs_27 = mercury__list__map_2_f_0((MR_Word) (&mercury__term_context__term_context__type_ctor_info_term_context_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), (MR_Word) (&check_hlds__typecheck_error_overload_scalar_common_7[1]), LaterContexts_9);
  {
  ...
  MR_Word OverloadedSymbolMap_7)
{
  ...
  else
  {
    ...
    if ((Var_107 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), DetailMsgsList_25, &DetailMsgs_26);
      {
    ...
    else
    {
      ...
      mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), DetailMsgsList_95, &DetailMsgs_96);
      {
        Msgs_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
