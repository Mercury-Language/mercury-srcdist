  ...
  MR_Word Var_9)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_58 = parse_tree__error_spec__pieces_list_to_color_line_pieces_3_f_0((MR_Integer) 3, (MR_Word) (MR_mkword(1, &check_hlds__typecheck_error_overload_scalar_common_1[59])), PossibleTypePiecesList_20);
