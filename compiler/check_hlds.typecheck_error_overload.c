  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Symbol_5)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_67, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_overload_scalar_common_1[33])));
      }
      {
        StartPieces_99 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, StartPieces_99, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_overload_scalar_common_1[26])));
      ...
      SourcePiecesList_25 = mercury__list__map_2_f_0((MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_cons_type_info_source_0), (MR_Word) (&check_hlds__typecheck_error_overload_scalar_common_1[2]), Var_81, Sources_24);
      ...
      FirstPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), StartPieces_99, SourcePieces_27);
      {
        ...
        MR_hl_field(1, Var_90, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_overload_scalar_common_1[36])));
      }
      {
    ...
    else
    {
      ...
      FirstPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), StartPieces_16, PredIdPieces_19);
      {
        ...
        MR_hl_field(1, Var_57, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_overload_scalar_common_1[36])));
      }
      {
        LaterPieces_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
