...
static void MR_CALL 
check_hlds__typecheck_error_overload__IntroducedFrom__pred__describe_overloaded_symbols__340__1_2_p_0(
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    parse_tree__error_util__construct_sorted_line_pieces_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), MakeItemPiecesFunc_18, PredIds_11, &PredIdPieces_19);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__typecheck_error_overload__IntroducedFrom__pred__describe_overloaded_symbols__340__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_73);
