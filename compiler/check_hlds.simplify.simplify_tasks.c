...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 377, &check_hlds__simplify__simplify_tasks__OptFormatCalls_12);
    ...
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 375, &check_hlds__simplify__simplify_tasks__ExcessAssign_15);
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 376, &check_hlds__simplify__simplify_tasks__TestAfterSwitch_16);
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 354, &check_hlds__simplify__simplify_tasks__CommonStruct_17);
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 373, &check_hlds__simplify__simplify_tasks__OptDuplicateCalls_18);
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 374, &check_hlds__simplify__simplify_tasks__ConstantProp_19);
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 674, &check_hlds__simplify__simplify_tasks__RemoveParConjunctions_24);
