...
static const MR_EnumFunctorDesc check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__enum_functor_desc_simplify_task_0_15 = {
  (MR_String) "simptask_warn_infinite_recursion_modulo_svar",
  INT32_C(15)
};
...
static const MR_ConstString check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__field_names_simplify_tasks_0_0[16] = {
  ...
  (MR_String) "do_warn_inf_rec_modulo_svar"
};
...
{
  {
    ...
    MR_Word WarnInfRecModuloSvar_25;
    MR_Word Var_40;
    MR_Word Var_41;
    MR_Word Var_42;
    MR_Word Var_43;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 43, &WarnKnownBadFormat_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 45, &WarnUnknownFormat_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 393, &OptFormatCalls_12);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 46, &WarnObsolete_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 391, &ExcessAssign_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 392, &TestAfterSwitch_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 370, &CommonStruct_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 389, &OptDuplicateCalls_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 390, &ConstantProp_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 692, &RemoveParConjunctions_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 31, &WarnInfRecModuloSvar_25);
...
{
  {
    ...
    MR_Word WarnInfRecModuloSvar_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_3, (MR_Integer) 0))) & (MR_Integer) 1);
    MR_Word Var_21;
    MR_Word Var_24;
    MR_Word Var_25;
    MR_Word Var_28;
    ...
    succeeded = (WarnInfRecModuloSvar_20 == (MR_Integer) 1);
    if (succeeded)
