...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 675, &check_hlds__simplify__simplify_tasks__RemoveParConjunctions_24);
