  ...
  MR_Word * SimplifyTasks_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 716, &RemoveParConjunctions_27);
  ...
  MR_Word SimplifyTasks_3)
{
  ...
  MR_Word TestAfterSwitch_13 = ((((MR_Unsigned) ((MR_hl_field(0, SimplifyTasks_3, (MR_Integer) 0))) >> 11)) & (MR_Integer) 1);
