...
static const MR_EnumFunctorDesc check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__enum_functor_desc_simplify_task_0_2 = {
  (MR_String) "simptask_warn_no_stream_calls",
  (MR_Integer) 2
};
...
static const MR_ConstString check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__field_names_simplify_tasks_0_0[14] = {
  ...
  (MR_String) "do_warn_no_stream_calls",
...
{
  {
    ...
    MR_Word check_hlds__simplify__simplify_tasks__WarnNoStreamCalls_9;
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 22, &check_hlds__simplify__simplify_tasks__WarnNoStreamCalls_9);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 35, &check_hlds__simplify__simplify_tasks__WarnKnownBadFormat_10);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 37, &check_hlds__simplify__simplify_tasks__WarnUnknownFormat_11);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 364, &check_hlds__simplify__simplify_tasks__OptFormatCalls_12);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 38, &check_hlds__simplify__simplify_tasks__WarnObsolete_14);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 363, &check_hlds__simplify__simplify_tasks__ExcessAssign_15);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 342, &check_hlds__simplify__simplify_tasks__CommonStruct_16);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 361, &check_hlds__simplify__simplify_tasks__OptDuplicateCalls_17);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 362, &check_hlds__simplify__simplify_tasks__ConstantProp_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 661, &check_hlds__simplify__simplify_tasks__RemoveParConjunctions_23);
    }
    ...
    check_hlds__simplify__simplify_tasks__succeeded = (check_hlds__simplify__simplify_tasks__WarnNoStreamCalls_9 == (MR_Integer) 1);
    if (check_hlds__simplify__simplify_tasks__succeeded)
      check_hlds__simplify__simplify_tasks__succeeded = (check_hlds__simplify__simplify_tasks__WarnThisPass_4 == (MR_Integer) 1);
    if (check_hlds__simplify__simplify_tasks__succeeded)
...
{
  {
    ...
    MR_Word check_hlds__simplify__simplify_tasks__WarnNoStreamCalls_7 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_tasks__SimplifyTasks_3, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    ...
    check_hlds__simplify__simplify_tasks__succeeded = (check_hlds__simplify__simplify_tasks__WarnNoStreamCalls_7 == (MR_Integer) 1);
    if (check_hlds__simplify__simplify_tasks__succeeded)
      {
