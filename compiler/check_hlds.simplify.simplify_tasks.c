...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 368, &check_hlds__simplify__simplify_tasks__OptFormatCalls_12);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 367, &check_hlds__simplify__simplify_tasks__ExcessAssign_15);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 346, &check_hlds__simplify__simplify_tasks__CommonStruct_16);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 365, &check_hlds__simplify__simplify_tasks__OptDuplicateCalls_17);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 366, &check_hlds__simplify__simplify_tasks__ConstantProp_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_tasks__Globals_5, (MR_Integer) 665, &check_hlds__simplify__simplify_tasks__RemoveParConjunctions_23);
    }
