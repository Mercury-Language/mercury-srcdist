...
MR_decl_label8(ml_backend__java_util__java_unary_prefix_op_2_0, 3,4,5,6,7,8,9,10)
...
MR_BEGIN_MODULE(ml_backend__java_util_module0)
	...
	MR_init_label8(ml_backend__java_util__java_unary_prefix_op_2_0,3,4,5,6,7,8,9,10)
MR_BEGIN_CODE
