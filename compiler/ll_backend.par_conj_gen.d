...
ll_backend.par_conj_gen.optdate ll_backend.par_conj_gen.trans_opt_date par_conj_gen.err ll_backend.par_conj_gen.c_date ll_backend.par_conj_gen.java_date : par_conj_gen.m \
	ll_backend.int0 \
	bool.int \
	builtin.int \
	check_hlds.int \
...
#   long deps
#   short deps
ll_backend.par_conj_gen.optdate ll_backend.par_conj_gen.trans_opt_date par_conj_gen.err ll_backend.par_conj_gen.c_date ll_backend.par_conj_gen.java_date : \
		par_conj_gen.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.par_conj_gen.pic_o ll_backend.par_conj_gen.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ll_backend.par_conj_gen.mh ll_backend.par_conj_gen.mih : ll_backend.par_conj_gen.c
...
ll_backend.par_conj_gen.module_dep : jmercury/ll_backend__par_conj_gen.java
else
ll_backend.par_conj_gen.module_dep : ll_backend.par_conj_gen.c
endif
...
ll_backend.par_conj_gen.date ll_backend.par_conj_gen.date0 \
	ll_backend.date : par_conj_gen.m \
	ll_backend.int0 \
	bool.int3 \
	builtin.int3 \
	check_hlds.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.par_conj_gen.date ll_backend.par_conj_gen.date0 ll_backend.date : \
		par_conj_gen.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.par_conj_gen.date0 \
	ll_backend.date0 : par_conj_gen.m \
	bool.int3 \
	builtin.int3 \
	check_hlds.int3 \
	cord.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.par_conj_gen.date0 ll_backend.date0 : \
		par_conj_gen.m \
	\
		bool.int3 \
		builtin.int3 \
...
ll_backend.par_conj_gen.int0 : ll_backend.par_conj_gen.date0
	@:
ll_backend.par_conj_gen.int : ll_backend.par_conj_gen.date
	@:
ll_backend.par_conj_gen.int2 : ll_backend.par_conj_gen.date
	@:
ll_backend.par_conj_gen.int3 : ll_backend.par_conj_gen.date3
	@:
ll_backend.par_conj_gen.opt : ll_backend.par_conj_gen.optdate
	@:
ll_backend.par_conj_gen.trans_opt : ll_backend.par_conj_gen.trans_opt_date
	@:
...
ll_backend.par_conj_gen.date0 : par_conj_gen.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ll_backend.par_conj_gen
ll_backend.par_conj_gen.date : par_conj_gen.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ll_backend.par_conj_gen
ll_backend.par_conj_gen.date3 : par_conj_gen.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ll_backend.par_conj_gen
ll_backend.par_conj_gen.optdate : par_conj_gen.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ll_backend.par_conj_gen
ll_backend.par_conj_gen.trans_opt_date : par_conj_gen.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ll_backend.par_conj_gen
ll_backend.par_conj_gen.c_date : par_conj_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ll_backend.par_conj_gen $(ERR_REDIRECT)
ll_backend.par_conj_gen.java_date : par_conj_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ll_backend.par_conj_gen $(ERR_REDIRECT)
