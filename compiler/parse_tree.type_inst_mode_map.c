...
parse_tree__type_inst_mode_map__accumulate_type_ctor_repns_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_TypeRepns_7)
{
  *STATE_VARIABLE_TypeRepns_7 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__type_inst_mode_map_scalar_common_1[3]), STATE_VARIABLE_TypeRepns_0_6, ((MR_Box) (TypeRepn_4)));
}
