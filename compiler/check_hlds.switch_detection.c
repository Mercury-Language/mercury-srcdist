...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_76_76 = (MR_Word) &check_hlds__switch_detection__check_hlds__switch_detection__type_ctor_info_case_arm_0;
      MR_Word Arms_17;

      Arms_17 = mercury__cord__list_1_f_0(TypeCtorInfo_76_76, Var_90);
      switch (Var_91) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            ...
            Disjuncts_62 = mercury__list__map_2_f_0(TypeCtorInfo_76_76, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &check_hlds__switch_detection_scalar_common_2[4], Arms_17);
        ...
        case (MR_Integer) 2:
          {
            ...
            Disjuncts_19 = mercury__list__map_2_f_0(TypeCtorInfo_76_76, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &check_hlds__switch_detection_scalar_common_2[5], Arms_17);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              mercury__list__filter_4_p_0(TypeCtorInfo_89_89, Var_40, AllConsIds0_26, &Var_27, &AllConsIds_28);
              ...
              else
              {
                ...
                mercury__set_tree234__insert_list_3_p_0(TypeCtorInfo_89_89, OtherConsIds_30, STATE_VARIABLE_AlreadyHandledConsIds_0_33, STATE_VARIABLE_AlreadyHandledConsIds_34);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  *STATE_VARIABLE_Cases_32 = base;
