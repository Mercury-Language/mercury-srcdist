...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__switch_detection__Globals_8, (MR_Integer) 303, &check_hlds__switch_detection__Allow_9);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__switch_detection__Globals_21, (MR_Integer) 303, &check_hlds__switch_detection__Allow_22);
    }
