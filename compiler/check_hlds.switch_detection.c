              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo_33_69 = (MR_Word) (&check_hlds__switch_detection_scalar_common_1[0]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_33_69, ((MR_Box) (RequiredVar_63)), ((MR_Box) (Var_24)));
                  }
                  if (succeeded)
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo_22_77 = (MR_Word) (&check_hlds__switch_detection_scalar_common_1[0]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_22_77, ((MR_Box) (Var_9)), ((MR_Box) (Var_76)));
                    if (succeeded)
                    {
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          mercury__term__apply_rec_substitution_in_term_3_p_0(TypeCtorInfo_119_119, STATE_VARIABLE_Subst_0_87, Var_96, &Var_97);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              mercury__term__apply_rec_substitution_in_term_3_p_0(TypeCtorInfo_119_119, STATE_VARIABLE_Subst_0_87, Var_100, &Var_101);
