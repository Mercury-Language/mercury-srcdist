...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 305, &Allow_22);
    switch (Allow_22) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_CasesTable_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 15, GoalInfo0_27, &GoalInfo_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 305, &Allow_9);
    switch (Allow_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
