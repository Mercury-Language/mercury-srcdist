  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 338, &Allow_22);
  switch (Allow_22) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_CasesTable_31_31, 0) = ((MR_Box) (CasesMap_81));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_CasesTable_31_31, 1) = ((MR_Box) (ConflictConsIds_78));
        }
