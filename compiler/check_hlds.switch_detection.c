        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_RevUnifies_0_36, &Unifies_33);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&check_hlds__switch_detection_scalar_common_5[0]));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_CasesTable_31_31, 0) = ((MR_Box) (CasesMap_60));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_CasesTable_31_31, 1) = ((MR_Box) (ConflictConsIds_57));
        }
