...
MR_decl_label6(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0, 3,2,5,9,13,49)
...
MR_BEGIN_MODULE(check_hlds__switch_detection_module47)
	...
	MR_init_label6(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0_i49);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0,13)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___check_hlds__switch_detection__local_switch_detect_info_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
