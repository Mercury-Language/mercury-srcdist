          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_59, (MR_Integer) 5)));
              MR_Word Var_163;
              MR_Word Var_164;
              MR_Word Var_165;
              ...
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_59, (MR_Integer) 0)));
              ...
              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_59, (MR_Integer) 5)));
              {
                RHS_73 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), RHS_73, 0) = (MR_Box) (packed_args_2);
                ...
                MR_hl_field(MR_mktag(2), RHS_73, 5) = (MR_Box) (packed_args_3);
