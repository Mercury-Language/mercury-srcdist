...
MR_def_label(check_hlds__switch_detection__detect_switches_in_goal_expr_6_0,9)
	...
	MR_tempr3 = MR_sv(1);
	MR_tfield(1, MR_r1, 0) = MR_tfield(1, MR_tempr3, 0);
	MR_tfield(1, MR_r1, 1) = MR_tempr1;
	MR_tfield(1, MR_r1, 2) = MR_tfield(1, MR_tempr3, 2);
	MR_tfield(1, MR_r1, 3) = MR_tfield(1, MR_tempr3, 3);
	MR_tfield(1, MR_r1, 4) = MR_tfield(1, MR_tempr3, 4);
	MR_decr_sp_and_return(8);
	}
