...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_25, Var_26);
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_12, Var_27, Var_28);
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_67, ArgY1_32);
                        ...
                        case (MR_Integer) 2:
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_68, ArgY1_44);
                            succeeded = (SubResult5_18 != (MR_Integer) 0);
                          }
                          break;
                      }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 315, &Allow_22);
    switch (Allow_22) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 315, &Allow_9);
    switch (Allow_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
