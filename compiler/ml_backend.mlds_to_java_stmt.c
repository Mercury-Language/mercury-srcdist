      ...
      case (MR_Integer) 0:
        {
          ...
          if (!((FuncDefns_137 == (MR_Word) ((MR_Unsigned) 0U))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_155, 2) = ((MR_Box) ((MR_Integer) 3));
            ...
            case (MR_Integer) 0:
              {
                ...
                ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Cond_573);
                mercury__io__write_string_3_p_0((MR_String) ")\n");
                succeeded = ((((MR_tag((MR_Word) Cond_573)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Cond_573, (MR_Integer) 0)))) == (MR_Integer) 1)));
                if (succeeded)
                {
                ...
                if (succeeded)
                {
                  ...
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
                  mercury__io__write_string_3_p_0((MR_String) "{\n");
                  Var_603 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = (MaybeElse_351 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_484 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 4:
            {
              ...
              Var_227 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ...
              succeeded = ((((MR_tag((MR_Word) FuncRval_194)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), FuncRval_194, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                ...
                mercury__io__write_string_3_p_0((MR_String) "(");
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_242, 2) = ((MR_Box) ((MR_Integer) 1));
              ...
              mercury__io__write_string_3_p_0((MR_String) ";\n");
              succeeded = (Results_196 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                MR_Integer Var_287 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 5:
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  Var_418 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_418);
                  Var_425 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
                  Var_424 = (MR_Integer) ((MR_Unsigned) Var_425 * (MR_Unsigned) 2);
                  ...
                  Separator_411 = mercury__string__f_43_43_2_f_0((MR_String) ",\n", Var_422);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_428, 2) = ((MR_Box) ((MR_Integer) 1));
          ...
          case (MR_Integer) 6:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_540 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_552 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_552);
              Var_555 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 2:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_68 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              Var_70 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_68, (MR_Integer) 2, Context_10, Var_70);
          ...
          case (MR_Integer) 6:
            {
              ...
              switch (TargetLang_40) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Var_53;
                    MR_Box conv0_STATE_VARIABLE_IO_47;

                    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
                    {
                      Var_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_4[0]));
                      MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (ml_backend__mlds_to_java_stmt__output_atomic_stmt_for_java_6_p_0_1));
                      MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (Info_7));
                    }
                    mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_53, Components_41, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_47);
                  }
                  break;
              }
            }
