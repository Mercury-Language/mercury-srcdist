          ...
          case (MR_Integer) 1:
            {
              ...
              Var_619 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_10, Var_619, (MR_Integer) 2, Context_589, Indent_11);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                Var_599 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Cond_586, (MR_Integer) 1))));
              ...
              if (succeeded)
              {
                ...
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Indent_11);
                mercury__io__write_string_4_p_0(Stream_10, (MR_String) "{\n");
                Var_603 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Var_603);
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          MR_Word Var_381 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);

          ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_10, Var_381, (MR_Integer) 2, Context_358, Indent_11);
        ...
        case (MR_Integer) 5:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                Var_435 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Var_435);
                {
                ...
                Var_449 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
                Var_448 = (MR_Integer) ((MR_Unsigned) Var_449 * (MR_Unsigned) 2);
                Var_446 = mercury__string__duplicate_char_2_f_0((MR_Char) 32, Var_448);
