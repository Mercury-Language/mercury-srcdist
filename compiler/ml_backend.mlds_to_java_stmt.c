...
static void MR_CALL 
ml_backend__mlds_to_java_stmt__output_local_var_defn_for_java_5_p_0(
  MR_Word Info_6,
  MR_Integer Indent_7,
...
static void MR_CALL 
ml_backend__mlds_to_java_stmt__output_init_args_for_java_6_p_0(
  MR_Word Info_7,
  MR_Integer Indent_8,
  MR_Word HeadArg_9,
  MR_Word TailArgs_10);
...
static /* final */ const MR_Box ml_backend__mlds_to_java_stmt_scalar_common_5[1][8];

static /* final */ const MR_Box ml_backend__mlds_to_java_stmt_scalar_common_6[2][9];
  ...
  MR_Word TargetCode_6)
{
  switch (MR_tag((MR_Word) TargetCode_6)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word FuncName_15 = (MR_Word) ((MR_Word) (TargetCode_6));
...
{
  {
    MR_Word LocalVarName_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalVarDefn_8, (MR_Integer) 0))));
    MR_Word Context_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalVarDefn_8, (MR_Integer) 1))));
    MR_Word Type_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalVarDefn_8, (MR_Integer) 2))));
    MR_Word Initializer_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalVarDefn_8, (MR_Integer) 3))));
    MR_Word Var_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    MR_Integer Var_22;

    ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_17, (MR_Integer) 2, Context_11, Indent_7);
    ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_6, Type_12);
    mercury__io__write_char_3_p_0((MR_Char) 32);
    ml_backend__mlds_to_java_name__output_local_var_name_for_java_3_p_0(LocalVarName_10);
    Var_22 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
    ml_backend__mlds_to_java_data__output_initializer_for_java_8_p_0(Info_6, (MR_Word) ((MR_Unsigned) 8U), Var_22, Type_12, Initializer_13, (MR_String) ";");
  }
}
...
{
  {
    ...
    else
    {
      ...
      ml_backend__mlds_to_java_stmt__output_case_cond_for_java_6_p_0(Info_1, Indent_2, Context_4, FirstCond_52);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_6[1]));
      ...
      if (succeeded)
      {
        ...
        MR_Integer Var_65 = (MR_Integer) ((MR_Unsigned) Indent_2 + (MR_Unsigned) 1);
        MR_Word Var_70;
...
{
  {
    ...
    ml_backend__mlds_to_java_stmt__output_local_var_defn_for_java_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Integer BlockIndent_141 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
          MR_Word Var_160;
          ...
          {
            MR_Word Var_154;
            MR_Box conv1_STATE_VARIABLE_IO_35_155;

            {
              Var_154 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_154, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_6[0]));
              MR_hl_field(MR_mktag(0), Var_154, 1) = ((MR_Box) (ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0_2));
              MR_hl_field(MR_mktag(0), Var_154, 2) = ((MR_Box) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), Var_154, 3) = ((MR_Box) (Info_8));
              MR_hl_field(MR_mktag(0), Var_154, 4) = ((MR_Box) (BlockIndent_141));
              MR_hl_field(MR_mktag(0), Var_154, 5) = ((MR_Box) ((MR_Unsigned) 8U));
            }
            mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_154, FuncDefns_137, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_35_155);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
          ...
          Var_160 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
          ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_160, (MR_Integer) 2, Context_139, Indent_9);
          mercury__io__write_string_3_p_0((MR_String) "}\n");
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word Kind_571 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt_11, (MR_Integer) 0))) & (MR_Integer) 1);
          ...
          MR_Word Context_575 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Stmt_11, (MR_Integer) 4))));
          MR_Integer ScopeIndent_576;

          ml_backend__mlds_to_target_util__scope_indent_3_p_0(BodyStmt_573, Indent_9, &ScopeIndent_576);
          switch (Kind_571) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              {
                MR_Word Var_584;
                MR_Word BodyInfo_613;
                MR_Word StmtExitMethods_614;
                MR_Word Var_625;
                MR_Word Var_629;
                MR_String Var_630;
                MR_Word Var_631;
                ...
                Var_629 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 2))));
                Var_630 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3))));
                Var_631 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 4))));
                Var_632 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
                Var_634 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 6))));
                {
                  BodyInfo_613 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 0) = ((MR_Box) (Var_625));
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 1) = (MR_Box) (packed_word_20);
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 2) = ((MR_Box) (Var_629));
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 3) = ((MR_Box) (Var_630));
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 4) = ((MR_Box) (Var_631));
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 5) = (MR_Box) (((((MR_Unsigned) (Var_632) << 2)) | (MR_Unsigned) ((MR_Integer) 2)));
                  MR_hl_field(MR_mktag(0), BodyInfo_613, 6) = ((MR_Box) (Var_634));
                }
                ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(BodyInfo_613, ScopeIndent_576, FuncInfo_10, BodyStmt_573, &StmtExitMethods_614);
                Var_584 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
                ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_584, (MR_Integer) 2, Context_575, Indent_9);
                mercury__io__write_string_3_p_0((MR_String) "while (");
                ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Cond_572);
                mercury__io__write_string_3_p_0((MR_String) ");\n");
                *ExitMethods_12 = ml_backend__mlds_to_java_stmt__while_exit_methods_for_java_2_f_0(Cond_572, StmtExitMethods_614);
              }
              break;
            case (MR_Integer) 0:
              {
                ...
                ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Cond_572);
                mercury__io__write_string_3_p_0((MR_String) ")\n");
                succeeded = ((((MR_tag((MR_Word) Cond_572)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Cond_572, (MR_Integer) 0)))) == (MR_Integer) 1)));
                if (succeeded)
                {
                  Var_598 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Cond_572, (MR_Integer) 1))));
                  succeeded = (Var_598 == (MR_Word) ((MR_Unsigned) 4U));
                }
                if (succeeded)
                {
                  MR_Integer Var_602;
                  ...
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
                  mercury__io__write_string_3_p_0((MR_String) "{\n");
                  Var_602 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_602);
                ...
                {
                  MR_Word BodyInfo_577;
                  MR_Word StmtExitMethods_578;
                  MR_Word Var_615 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 0))));
                  MR_Word Var_619 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 2))));
                  MR_String Var_620 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3))));
                  MR_Word Var_621 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 4))));
                  MR_Word Var_622 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
                  MR_Word Var_624 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 6))));
                  MR_Unsigned packed_word_24 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1)));

                  {
                    BodyInfo_577 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 0) = ((MR_Box) (Var_615));
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 1) = (MR_Box) (packed_word_24);
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 2) = ((MR_Box) (Var_619));
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 3) = ((MR_Box) (Var_620));
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 4) = ((MR_Box) (Var_621));
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 5) = (MR_Box) (((((MR_Unsigned) (Var_622) << 2)) | (MR_Unsigned) ((MR_Integer) 2)));
                    MR_hl_field(MR_mktag(0), BodyInfo_577, 6) = ((MR_Box) (Var_624));
                  }
                  ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(BodyInfo_577, ScopeIndent_576, FuncInfo_10, BodyStmt_573, &StmtExitMethods_578);
                  *ExitMethods_12 = ml_backend__mlds_to_java_stmt__while_exit_methods_for_java_2_f_0(Cond_572, StmtExitMethods_578);
                }
              }
              break;
          }
      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = (MaybeElse_350 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) Then0_349)) == (MR_Integer) 2);
            if (succeeded)
            {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_365, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Then_356 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Then_356, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), Then_356, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          ...
          ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Cond_348);
          mercury__io__write_string_3_p_0((MR_String) ")\n");
          ml_backend__mlds_to_target_util__scope_indent_3_p_0(Then_356, Indent_9, &ThenScopeIndent_357);
          ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_8, ThenScopeIndent_357, FuncInfo_10, Then_356, &ThenExitMethods_358);
          if ((MaybeElse_350 == (MR_Word) ((MR_Unsigned) 0U)))
          ...
          else
          {
            ...
            MR_Word Var_375 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);

            ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_375, (MR_Integer) 2, Context_351, Indent_9);
            ...
            ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_8, ElseScopeIndent_360, FuncInfo_10, Else_359, &ElseExitMethods_361);
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_474 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              MR_Integer Var_483;
              MR_Word Var_486;
              MR_Word Var_500;
              MR_Word Var_504;
              ...
              ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_474, (MR_Integer) 2, Context_472, Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "switch (");
              ml_backend__mlds_to_java_data__output_rval_maybe_with_enum_for_java_4_p_0(Info_8, Val_468);
              mercury__io__write_string_3_p_0((MR_String) ") {\n");
              ...
              Var_507 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
              Var_509 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 6))));
              {
                CaseInfo_473 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), CaseInfo_473, 0) = ((MR_Box) (Var_500));
                MR_hl_field(MR_mktag(0), CaseInfo_473, 1) = (MR_Box) (packed_word_15);
                ...
                MR_hl_field(MR_mktag(0), CaseInfo_473, 5) = (MR_Box) (((((MR_Unsigned) (Var_507) << 2)) | (MR_Unsigned) ((MR_Integer) 1)));
                MR_hl_field(MR_mktag(0), CaseInfo_473, 6) = ((MR_Box) (Var_509));
              }
              Var_483 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_stmt__output_switch_cases_for_java_9_p_0(CaseInfo_473, Var_483, FuncInfo_10, Context_472, Cases_470, Default_471, ExitMethods_12);
              Var_486 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_486, (MR_Integer) 2, Context_472, Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "}\n");
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 4:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_224 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              Var_226 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_224, (MR_Integer) 2, Context_197, Var_226);
              if (!((Results_195 == (MR_Word) ((MR_Unsigned) 0U))))
              {
                ...
                {
                  ml_backend__mlds_to_java_data__output_lval_for_java_4_p_0(Info_8, Var_309);
                  mercury__io__write_string_3_p_0((MR_String) " = ");
                }
                else
                  mercury__io__write_string_3_p_0((MR_String) "java.lang.Object [] result = ");
              }
              succeeded = ((((MR_tag((MR_Word) FuncRval_193)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), FuncRval_193, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_236 = ((MR_Word) ((MR_hl_field(MR_mktag(3), FuncRval_193, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_236)) == (MR_Integer) 1);
                if (succeeded)
                {
                }
              }
              if (succeeded)
              {
                ...
                ml_backend__mlds_to_java_data__output_call_rval_for_java_4_p_0(Info_8, FuncRval_193);
                mercury__io__write_string_3_p_0((MR_String) "(");
                {
                  Var_241 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_241, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_4[1]));
                  MR_hl_field(MR_mktag(0), Var_241, 1) = ((MR_Box) (ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0_3));
                  MR_hl_field(MR_mktag(0), Var_241, 2) = ((MR_Box) ((MR_Integer) 1));
              ...
              else
              {
                ...
                if (!((RetTypes_199 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  if ((Var_310 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    ml_backend__mlds_to_java_type__boxed_type_to_string_for_java_3_p_0(Info_8, Var_311, &RetTypeString_206);
                    mercury__io__write_string_3_p_0((MR_String) "((");
                ...
                succeeded = ml_backend__mlds_to_java_util__is_specialised_method_ptr_arity_1_p_0(Arity_210);
                if (succeeded)
                {
                  mercury__io__write_string_3_p_0((MR_String) "((jmercury.runtime.MethodPtr");
                  mercury__io__write_int_3_p_0(Arity_210);
                  mercury__io__write_string_3_p_0((MR_String) ") ");
                  ml_backend__mlds_to_java_data__output_bracketed_rval_for_java_4_p_0(Info_8, FuncRval_193);
                  mercury__io__write_string_3_p_0((MR_String) ").call___0_0(");
                  ml_backend__mlds_to_java_stmt__output_boxed_args_5_p_0(Info_8, CallArgs_194, ArgTypes_198);
                }
                else
                {
                  ...
                  ml_backend__mlds_to_java_data__output_bracketed_rval_for_java_4_p_0(Info_8, FuncRval_193);
                  mercury__io__write_string_3_p_0((MR_String) ").call___0_0(");
                  ml_backend__mlds_to_java_stmt__output_args_as_array_5_p_0(Info_8, CallArgs_194, ArgTypes_198);
                }
                mercury__io__write_string_3_p_0((MR_String) ")");
                if (!((RetTypes_199 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  if ((Var_312 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    succeeded = ml_backend__mlds_to_java_type__java_builtin_type_4_p_0(Var_313, &Var_212, &Var_213, &UnboxMethod_214);
                    if (succeeded)
                    {
                      mercury__io__write_string_3_p_0((MR_String) ").");
              ...
              mercury__io__write_string_3_p_0((MR_String) ";\n");
              succeeded = (Results_195 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                MR_Integer Var_286 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);

                ml_backend__mlds_to_java_stmt__output_assign_results_8_p_0(Info_8, Results_195, RetTypes_199, (MR_Integer) 0, Var_286, Context_197);
              }
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "}\n");
              *ExitMethods_12 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&ml_backend__mlds_to_target_util__ml_backend__mlds_to_target_util__type_ctor_info_exit_method_0), ((MR_Box) ((MR_Integer) 4)));
          ...
          case (MR_Integer) 5:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              if ((Results_400 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              else
              {
                ...
                if ((Var_457 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  mercury__io__write_string_3_p_0((MR_String) "return ");
                  ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Var_458);
                  mercury__io__write_string_3_p_0((MR_String) ";\n");
                }
                else
                {
                  ...
                  Var_417 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_417);
                  Var_424 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
                  Var_423 = (MR_Integer) ((MR_Unsigned) Var_424 * (MR_Unsigned) 2);
                  Var_421 = mercury__string__duplicate_char_2_f_0((MR_Char) 32, Var_423);
                  Separator_410 = mercury__string__f_43_43_2_f_0((MR_String) ",\n", Var_421);
                  {
                    Var_427 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_427, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_4[2]));
                    MR_hl_field(MR_mktag(0), Var_427, 1) = ((MR_Box) (ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0_4));
                    MR_hl_field(MR_mktag(0), Var_427, 2) = ((MR_Box) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), Var_427, 3) = ((MR_Box) (Info_8));
                  }
                  mercury__io__write_list_5_p_0((MR_Word) (&ml_backend__mlds_to_java_stmt_scalar_common_1[0]), TypesAndResults_409, Separator_410, Var_427);
                  mercury__io__write_string_3_p_0((MR_String) "\n");
                  ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
                  mercury__io__write_string_3_p_0((MR_String) "};\n");
                }
          ...
          case (MR_Integer) 6:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_539 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_8, Var_539, FuncInfo_10, BodyStmt_528, &TryExitMethods0_531);
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "}\n");
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_551 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_551);
              Var_554 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_8, Var_554, FuncInfo_10, HandlerStmt_529, &CatchExitMethods_532);
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              mercury__io__write_string_3_p_0((MR_String) "}\n");
              Var_560 = mercury__set__delete_2_f_0((MR_Word) (&ml_backend__mlds_to_target_util__ml_backend__mlds_to_target_util__type_ctor_info_exit_method_0), TryExitMethods0_531, ((MR_Box) ((MR_Integer) 3)));
              *ExitMethods_12 = mercury__set__union_2_f_0((MR_Word) (&ml_backend__mlds_to_target_util__ml_backend__mlds_to_target_util__type_ctor_info_exit_method_0), Var_560, CatchExitMethods_532);
            }
            break;
          case (MR_Integer) 7:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
              ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_8, Ref_326);
          ...
          case (MR_Integer) 2:
            {
              ...
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
              mercury__io__write_string_3_p_0((MR_String) "{\n");
              Var_72 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              Var_74 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
              ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_72, (MR_Integer) 2, Context_10, Var_74);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ml_backend__mlds_to_java_type__hand_defined_type_for_java_4_p_0(MerType_28, CtorCat_29, &Var_30, &Var_31);
                }
                succeeded = !(succeeded);
              }
              if (succeeded)
              {
                ...
                ml_backend__mlds_to_java_name__output_unqual_class_name_for_java_4_p_0(CtorName_35, CtorArity_36);
              }
              else
                ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_7, Type_21);
              IsArray_37 = ml_backend__mlds_to_java_type__type_is_array_for_java_1_f_0(Type_21);
              ...
              else
              {
                ...
                ml_backend__mlds_to_java_stmt__output_init_args_for_java_6_p_0(Info_7, Var_90, HeadArgRvalType_40, TailArgRvalsTypes_41);
                Var_93 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
                ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Var_93);
                mercury__io__write_string_3_p_0(End_39);
                mercury__io__write_string_3_p_0((MR_String) ";\n");
              }
              ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&ml_backend__mlds_to_java_stmt_scalar_common_4[0]));
                      MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (ml_backend__mlds_to_java_stmt__output_atomic_stmt_for_java_6_p_0_1));
                      MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (Info_7));
                    }
                    mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_57, Components_45, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_51);
                  }
                  break;
              }
            }
  ...
  MR_Word TailArgs_10)
{
  while (MR_TRUE)
  {
    ...
    ;
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_8);
    ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_7, HeadArgRval_12);
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Val_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Val_12, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__io__write_string_3_p_0((MR_String) ";\n");
        Var_36 = (MR_Integer) ((MR_Unsigned) ResultIndex_4 + (MR_Unsigned) 1);
        // direct tailcall eliminated
        ;
