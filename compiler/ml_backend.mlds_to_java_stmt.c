  ...
  switch (MR_tag((MR_Word) Stmt_13)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Stmt_13, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Val_408 = ((MR_Word) ((MR_hl_field(3, Stmt_13, (MR_Integer) 2))));
            ...
            ml_backend__mlds_to_java_data__output_rval_maybe_with_enum_for_java_5_p_0(Info_9, Val_408, Stream_10);
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) ") {\n");
