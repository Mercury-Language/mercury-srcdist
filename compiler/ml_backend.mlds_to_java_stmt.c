    ...
    switch (MR_tag((MR_Word) Default_7)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Default_7)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_55 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              MR_Word Var_60;
              MR_Integer Var_62;
              ...
              Var_60 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
          MR_Integer Var_53;
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_472 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                Var_454 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Cond_441, (MR_Integer) 1))));
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          MR_Word Var_299 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
