...
MR_def_static(check_hlds__det_analysis__det_infer_unify_13_0)
	...
	MR_sv(15) = MR_tfield(2, MR_tempr2, 8);
	MR_tempr1 = MR_tfield(2, MR_tempr2, 7);
...
MR_def_label(check_hlds__det_analysis__det_infer_unify_13_0,39)
	...
	MR_tempr5 = MR_sv(2);
	MR_tfield(3, MR_tempr1, 1) = MR_tfield(1, MR_tempr5, 0);
	MR_tfield(3, MR_tempr1, 2) = MR_tfield(1, MR_tempr5, 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_r3 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_r1;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
...
MR_def_label(check_hlds__det_analysis__det_infer_unify_13_0,50)
	...
	MR_r2 = MR_tempr1;
	MR_tempr5 = MR_sv(2);
	MR_tfield(2, MR_tempr1, 0) = MR_tfield(3, MR_tempr5, 1);
	MR_tfield(2, MR_tempr1, 1) = MR_tfield(3, MR_tempr5, 2);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_r3 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_r1;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
...
MR_def_label(check_hlds__det_analysis__det_infer_unify_13_0,26)
	...
	MR_tfield(2, MR_tempr2, 1) = MR_tfield(0, MR_tempr6, 0);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_r3 = MR_tempr3;
...
MR_def_static(__Unify___check_hlds__det_analysis__hlds__hlds_module__pragma_exported_proc_0_2)
	...
	MR_tempr3 = MR_tfield(0, MR_tempr5, 4);
