...
MR_decl_label10(check_hlds__det_analysis__det_infer_goal_2_11_0, 3,6,5,9,8,12,11,15,18,13)
MR_decl_label10(check_hlds__det_analysis__det_infer_goal_2_11_0, 21,20,24,23,27,26,30,29,35,34)
MR_decl_label5(check_hlds__det_analysis__det_infer_goal_2_11_0, 39,38,42,32,44)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_proc_8_0, 99,68,102,103,104,105,106,107,109,113)
MR_decl_label4(check_hlds__det_analysis__det_infer_proc_8_0, 112,114,115,116)
...
MR_decl_label5(check_hlds__det_analysis__det_infer_scope_12_0, 257,236,260,259,2)
...
MR_decl_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1451__1_2_0)
...
MR_def_label(check_hlds__det_analysis__det_infer_goal_1_11_0,32)
	...
	MR_sv(8) = MR_r1;
	MR_r1 = MR_tfield(0, MR_tfield(3, MR_sv(4), 2), 1);
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module10)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_goal_2_11_0,3,6,5,9,8,12,11,15,18,13)
	MR_init_label10(check_hlds__det_analysis__det_infer_goal_2_11_0,21,20,24,23,27,26,30,29,35,34)
	MR_init_label5(check_hlds__det_analysis__det_infer_goal_2_11_0,39,38,42,32,44)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_par_conj_11_0,11)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(1,0,30);
	MR_r5 = MR_sv(6);
	MR_r3 = (MR_Integer) 0;
	MR_r4 = (MR_Word) MR_tbmkword(0, 0);
	MR_GOTO_LAB(check_hlds__det_analysis__det_infer_par_conj_11_0_i10);
...
MR_def_label(check_hlds__det_analysis__det_infer_atomic_goal_9_0,2)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1451__1_2_0);
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module24)
	...
	MR_init_label5(check_hlds__det_analysis__det_infer_scope_12_0,257,236,260,259,2)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = (MR_Word) MR_TAG_COMMON(1,0,58);
	MR_np_call_localret_ent(fn__parse_tree__error_util__list_to_pieces_1_0,
		check_hlds__det_analysis__det_infer_scope_12_0_i97);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,196)
	...
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,0,63);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,200)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_r2;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,0,65);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,1,45);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_r1 = MR_sv(2);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,3)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i259);
	}
	MR_r1 = MR_r2;
	MR_r2 = (MR_Integer) 0;
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,236)
	...
	MR_np_call_localret_ent(check_hlds__det_util__det_info_set_has_req_scope_2_0,
		check_hlds__det_analysis__det_infer_scope_12_0_i260);
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,260)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module27)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_proc_8_0,99,68,102,103,104,105,106,107,109,113)
	MR_init_label4(check_hlds__det_analysis__det_infer_proc_8_0,112,114,115,116)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_proc_8_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(13) = (MR_Word) MR_TAG_COMMON(1,0,66);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__error_util, format_component);
...
MR_def_label(check_hlds__det_analysis__det_infer_proc_8_0,107)
	...
	if (MR_INT_NE(MR_sv(11),1)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_proc_8_0_i109);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__det_analysis__det_infer_proc_8_0,109)
	...
	if (MR_INT_NE(MR_sv(12),1)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_proc_8_0_i112);
	}
	MR_r1 = (MR_Integer) 22;
	MR_np_call_localret_ent(hlds__hlds_pred__add_marker_3_0,
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module41)
	MR_init_entry1(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1451__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1451__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__det_infer_atomic_goal__1451__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1451__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(f_99_104_101_99_107_95_104_108_100_115_95_95_100_101_116_95_97_110_97_108_121_115_105_115_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_100_101_116_95_105_110_102_101_114_95_102_111_114_101_105_103_110_95_112_114_111_99_95_95_91_52_93_95_48_11_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(1,0,66);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__error_util, format_component);
