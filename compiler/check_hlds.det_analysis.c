  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 112, &Debug_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 74, &Verbose_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 112, &Debug_16);
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__det_util__det_info_get_module_info_2_p_0(STATE_VARIABLE_DetInfo_165_165, &ModuleInfo_56);
        {
          ...
          MR_hl_field(0, Var_264, 0) = ((MR_Box) (&check_hlds__det_analysis_scalar_common_6[1]));
          ...
          MR_hl_field(0, Var_264, 4) = ((MR_Box) (InstMap0_17));
        }
