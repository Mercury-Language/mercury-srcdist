...
MR_decl_label9(check_hlds__det_analysis__det_infer_atomic_11_0, 2,4,5,6,7,8,9,10,13)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_conj_11_0, 29,4,5,6,7,10,11,12,14,15)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_foreign_proc_11_0, 29,32,34,45,51,28,52,54,53,60)
MR_decl_label10(check_hlds__det_analysis__det_infer_foreign_proc_11_0, 61,62,66,73,74,75,80,82,57,83)
MR_decl_label3(check_hlds__det_analysis__det_infer_foreign_proc_11_0, 84,87,86)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_goal_2_11_0, 47,48,23,24,15,53,3,4,5,8)
MR_decl_label10(check_hlds__det_analysis__det_infer_goal_2_11_0, 7,10,12,13,17,18,20,21,26,27)
MR_decl_label8(check_hlds__det_analysis__det_infer_goal_2_11_0, 29,39,35,36,31,32,44,45)
...
MR_decl_label9(check_hlds__det_analysis__det_infer_par_conj_goals_11_0, 20,4,5,6,8,9,10,11,12)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 9,10,11,12,16,43,45,46,47,48)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 14,53,67,68,69,72,70,75,76,80)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 78,101,77,103,106,107,121,51,13,123)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 124,125,128,129,131,132,133,134,135,136)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 139,137,142,143,144,148,146,149,145,155)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 156,153,158,152,176,179,180,186,187,188)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 189,190,196,194,192,200,201,202,206,204)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 223,203,225,228,229,235,264,239,244,245)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_unify_13_0, 6,5,7,8,9,10,11,3,2,14)
MR_decl_label10(check_hlds__det_analysis__det_infer_unify_13_0, 15,17,18,21,36,37,39,23,24,50)
MR_decl_label4(check_hlds__det_analysis__det_infer_unify_13_0, 26,28,29,20)
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module6)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_foreign_proc_11_0,29,32,34,45,51,28,52,54,53,60)
	MR_init_label10(check_hlds__det_analysis__det_infer_foreign_proc_11_0,61,62,66,73,74,75,80,82,57,83)
	MR_init_label3(check_hlds__det_analysis__det_infer_foreign_proc_11_0,84,87,86)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_foreign_proc_11_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_tag(MR_sv(4)) == MR_mktag((MR_Integer) 0)) || (MR_tag(MR_sv(4)) == MR_mktag((MR_Integer) 2)))) {
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module11)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_goal_2_11_0,47,48,23,24,15,53,3,4,5,8)
	MR_init_label10(check_hlds__det_analysis__det_infer_goal_2_11_0,7,10,12,13,17,18,20,21,26,27)
	MR_init_label8(check_hlds__det_analysis__det_infer_goal_2_11_0,29,39,35,36,31,32,44,45)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module12)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_conj_11_0,29,4,5,6,7,10,11,12,14,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module14)
	...
	MR_init_label9(check_hlds__det_analysis__det_infer_par_conj_goals_11_0,20,4,5,6,8,9,10,11,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module19)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_unify_13_0,6,5,7,8,9,10,11,3,2,14)
	MR_init_label10(check_hlds__det_analysis__det_infer_unify_13_0,15,17,18,21,36,37,39,23,24,50)
	MR_init_label4(check_hlds__det_analysis__det_infer_unify_13_0,26,28,29,20)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module22)
	...
	MR_init_label9(check_hlds__det_analysis__det_infer_atomic_11_0,2,4,5,6,7,8,9,10,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module25)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,9,10,11,12,16,43,45,46,47,48)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,14,53,67,68,69,72,70,75,76,80)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,78,101,77,103,106,107,121,51,13,123)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,124,125,128,129,131,132,133,134,135,136)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,139,137,142,143,144,148,146,149,145,155)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,156,153,158,152,176,179,180,186,187,188)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,189,190,196,194,192,200,201,202,206,204)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,223,203,225,228,229,235,264,239,244,245)
