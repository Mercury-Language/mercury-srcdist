...
check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1785__1_2_f_0(
  MR_Word VarSet_27,
  MR_Word HeadVar__2_328);

static MR_String MR_CALL 
check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1745__1_2_f_0(
  MR_Word VarSet_27,
  MR_Word HeadVar__2_322);

static MR_String MR_CALL 
check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1692__1_2_f_0(
  MR_Word VarSet_27,
  MR_Word HeadVar__2_313);

static MR_bool MR_CALL 
check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1577__1_2_p_0(
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__succeeded = check_hlds__det_analysis____Unify______hlds__hlds_modulepragma_exported_proc_0_2((env_ptr)->check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__Var_125, (env_ptr)->check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__Var_161);
  ...
  MR_Word * STATE_VARIABLE_Specs_70)
{
  ...
  (env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__NewDetism_13 = NewDetism_13;
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo0_16, &VarSet_26);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo0_16, &VarTypes_27);
    {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_HeadVar__3_329 = check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1785__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_323 = check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1745__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_314 = check_hlds__det_analysis__IntroducedFrom__func__det_infer_scope__1692__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1577__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_DetInfo_40)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word PredInfo_76;
    MR_Word ProcTable_77;
    MR_Word ProcIdsInfos_78;

    check_hlds__det_util__det_info_get_module_info_2_p_0(STATE_VARIABLE_DetInfo_41_41, &ModuleInfo_75);
    hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_75, PredId_12, &PredInfo_76);
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo_76, &ProcTable_77);
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_77, &ProcIdsInfos_78);
    succeeded = check_hlds__det_analysis__det_find_matching_non_cc_mode_procs_5_p_0(ModuleInfo_75, PredInfo_76, ProcIdsInfos_78, ProcId0_13, &ProcIdPrime_29);
    if (succeeded)
    {
