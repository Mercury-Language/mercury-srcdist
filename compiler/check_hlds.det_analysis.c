...
MR_def_static(check_hlds__det_analysis__det_infer_unify_13_0)
	...
	MR_sv(8) = ((MR_Integer) MR_tfield(2, MR_r2, 0) & (MR_Integer) 3);
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	MR_sv(5) = MR_r5;
...
MR_def_label(check_hlds__det_analysis__det_infer_unify_13_0,10)
	...
	MR_tfield(2, MR_r2, 0) = ((MR_Integer) MR_sv(8) | (((MR_Integer) MR_sv(9) << (MR_Integer) 2) | ((MR_Integer) MR_sv(10) << (MR_Integer) 3)));
	MR_tfield(2, MR_r2, 2) = MR_sv(11);
	MR_tfield(2, MR_r2, 3) = MR_sv(12);
	MR_tfield(2, MR_r2, 4) = MR_sv(13);
	MR_tfield(2, MR_r2, 5) = MR_sv(14);
