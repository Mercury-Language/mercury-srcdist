  ...
  MR_Word * Specs_5)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 94, &Debug_12);
  ...
  (env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__NewDetism_13 = NewDetism_13;
  {
    ...
    *((env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__NewDetism_13) = hlds__hlds_pred__eval_method_change_determinism_2_f_0(EvalMethod_42, TentativeDetism_41);
    ...
    switch (HasFormatCalls_32) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 27, STATE_VARIABLE_Markers_148_148, &STATE_VARIABLE_Markers_150_150);
        break;
      case (MR_Integer) 0:
    ...
    switch (HasRequireScope_33) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 25, STATE_VARIABLE_Markers_150_150, &STATE_VARIABLE_Markers_152_152);
        break;
      case (MR_Integer) 0:
    ...
    switch (HasIncompleteSwitch_34) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 26, STATE_VARIABLE_Markers_152_152, &STATE_VARIABLE_Markers_154_154);
        break;
      case (MR_Integer) 0:
