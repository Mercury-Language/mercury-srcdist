...
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 206,3,211,212,209,216,219,220,217,222)
MR_decl_label5(check_hlds__det_analysis__det_infer_scope_12_0, 223,237,215,240,239)
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module23)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,206,3,211,212,209,216,219,220,217,222)
	MR_init_label5(check_hlds__det_analysis__det_infer_scope_12_0,223,237,215,240,239)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,216)
	...
	if (MR_INT_NE(MR_r2,4)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i219);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,220)
	...
	if (MR_INT_NE(MR_r2,6)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i217);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,215)
	...
	if (!((((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 0))))) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i239);
	}
	MR_sv(2) = MR_r2;
	MR_sv(4) = MR_r4;
	MR_sv(8) = MR_r5;
