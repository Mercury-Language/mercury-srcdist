  ...
  MR_Word * STATE_VARIABLE_Globals_9)
{
  ...
  libs__globals__lookup_option_3_p_0(STATE_VARIABLE_Globals_0_8, (MR_Integer) 33, &WarnSimple_6);
  libs__globals__lookup_option_3_p_0(STATE_VARIABLE_Globals_0_8, (MR_Integer) 12, &WarnDeclsTooLax_7);
  libs__globals__set_option_4_p_0((MR_Integer) 33, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_0_8, &STATE_VARIABLE_Globals_1_14);
  libs__globals__set_option_4_p_0((MR_Integer) 12, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_1_14, STATE_VARIABLE_Globals_9);
  {
    Var_20 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_20, 0) = ((MR_Box) ((MR_Integer) 33));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 123, &Debug_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 83, &Verbose_15);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 123, &Debug_16);
