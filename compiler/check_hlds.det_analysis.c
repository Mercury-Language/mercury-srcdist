  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_16)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), Procs0_8, ((MR_Box) (ProcId_5)), &conv0_ProcInfo0_9);
  ProcInfo0_9 = ((MR_Word) (conv0_ProcInfo0_9));
  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo0_9, &MaybeDet_10);
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_set_inferred_determinism_3_p_0(Det_11, ProcInfo0_9, &ProcInfo_12);
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_5)), ((MR_Box) (ProcInfo_12)), Procs0_8, &Procs_13);
  ...
  MR_Word * STATE_VARIABLE_Globals_9)
{
  ...
  libs__globals__lookup_option_3_p_0(STATE_VARIABLE_Globals_0_8, (MR_Integer) 187, &WarnSimple_6);
  libs__globals__lookup_option_3_p_0(STATE_VARIABLE_Globals_0_8, (MR_Integer) 173, &WarnDeclsTooLax_7);
  libs__globals__set_option_4_p_0((MR_Integer) 187, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_0_8, &STATE_VARIABLE_Globals_1_14);
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_1_14, STATE_VARIABLE_Globals_9);
  {
    Var_20 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_20, 0) = ((MR_Box) ((MR_Integer) 187));
    MR_hl_field(0, Var_20, 1) = ((MR_Box) (WarnSimple_6));
  }
  {
    Var_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_23, 0) = ((MR_Box) ((MR_Integer) 173));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 710, &Debug_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 710, &Debug_16);
  ...
  *Specs_6 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), InferenceSpecs_17, FinalSpecs_21);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_5, Verbose_15, (MR_String) "% done.\n");
}
  ...
  MR_Word * STATE_VARIABLE_ImportedProcs_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), HeadVar__1_1, ((MR_Box) (PredId_25)), &conv0_PredInfo_31);
      ...
      {
        {
          ...
          if (succeeded)
          {
            hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_55);
        ...
        else
        {
          ...
          mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_36, ((MR_Box) (ProcId_28)), &conv0_ProcInfo_37);
          ProcInfo_37 = ((MR_Word) (conv0_ProcInfo_37));
          hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo_37, &MaybeDetism_38);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_54)
{
  ...
  hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(ProcInfo0_19, &OldDetism_20);
  check_hlds__det_infer_goal__det_get_soln_context_2_p_0(OldDetism_20, &OldInferredSolnContext_21);
  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo0_19, &MaybeDeclaredDetism_22);
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(ProcInfo0_19, &Goal0_29);
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_53, ProcInfo0_19, &InstMap0_30);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo0_19, &VarTable_31);
  ...
  check_hlds__det_util__det_info_get_diag_specs_2_p_0(DetInfo_35, STATE_VARIABLE_Specs_50);
  ...
  hlds__hlds_proc__proc_info_get_eval_method_2_p_0(ProcInfo0_19, &EvalMethod_43);
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_34, ProcInfo0_19, &ProcInfo1_45);
  hlds__hlds_proc__proc_info_set_inferred_determinism_3_p_0(NewDetism_44, ProcInfo1_45, &ProcInfo_46);
