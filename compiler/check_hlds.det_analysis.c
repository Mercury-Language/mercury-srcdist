  ...
  MR_Word * STATE_VARIABLE_Globals_9)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 28, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_0_8, &STATE_VARIABLE_Globals_14_14);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_54)
{
  ...
  {
    MR_Word TabledMethoed_87 = ((MR_Word) ((MR_hl_field(1, EvalMethod_43, (MR_Integer) 0))));
