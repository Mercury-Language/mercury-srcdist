  ...
  MR_Word * STATE_VARIABLE_Globals_9)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 32, (MR_Word) (MR_mkword(1, &check_hlds__det_analysis_scalar_common_3[0])), STATE_VARIABLE_Globals_0_8, &STATE_VARIABLE_Globals_1_14);
