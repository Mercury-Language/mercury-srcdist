      ...
      *((env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__NewDetism_13) = hlds__hlds_pred__eval_method_change_determinism_2_f_0(EvalMethod_44, TentativeDetism_43);
      ...
      if ((env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_116, 0) = ((MR_Box) (ProcContext_49));
      ...
      if ((env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__det_analysis__det_infer_proc_8_p_0_env_0__succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_147, 0) = ((MR_Box) (PragmaContext_60));
...
{
  {
    ...
    if ((MaybeDetism_25 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (Context_139));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (ProcContext_29));
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_130, 0) = ((MR_Box) (GoalContext_33));
