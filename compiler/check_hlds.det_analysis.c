    ...
    case (MR_Integer) 2:
      {
        ...
        BoundVars_61 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_26, BoundVars0_60);
      ...
      case (MR_Integer) 6:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&check_hlds__det_analysis_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (check_hlds__det_analysis__det_infer_orelse_goals_12_p_0_1));
            MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (GoalFailingContexts_49));
      ...
      case (MR_Integer) 1:
        {
          ...
          DetismStr_53 = parse_tree__prog_out__determinism_to_string_1_f_0(FirstDetism_37);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (DetismStr_53));
          }
          {
            Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Var_64));
            MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_analysis_scalar_common_1[53])));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_54, 1) = ((MR_Box) (Var_63));
          }
          {
    ...
    case (MR_Integer) 6:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&check_hlds__det_analysis_scalar_common_3[0]));
          MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (check_hlds__det_analysis__det_infer_atomic_11_p_0_1));
          MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (GoalFailingContexts_33));
    ...
    case (MR_Integer) 1:
      {
        ...
        DetismStr_37 = parse_tree__prog_out__determinism_to_string_1_f_0(MainDetism_22);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_48, 1) = ((MR_Box) (DetismStr_37));
        }
        {
          Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (Var_48));
          MR_hl_field(MR_mktag(1), Var_47, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_analysis_scalar_common_1[53])));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_38, 1) = ((MR_Box) (Var_47));
        }
        {
  ...
  MR_Word * STATE_VARIABLE_DetInfo_39)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word PredInfo_71;
    MR_Word ProcTable_72;
    MR_Word ProcIdsInfos_73;

    check_hlds__det_util__det_info_get_module_info_2_p_0(STATE_VARIABLE_DetInfo_40_40, &ModuleInfo_70);
    hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_70, PredId_12, &PredInfo_71);
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo_71, &ProcTable_72);
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_72, &ProcIdsInfos_73);
    succeeded = check_hlds__det_analysis__det_find_matching_non_cc_mode_procs_5_p_0(ModuleInfo_70, PredInfo_71, ProcIdsInfos_73, ProcId0_13, &ProcIdPrime_29);
    if (succeeded)
    {
