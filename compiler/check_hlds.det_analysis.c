...
MR_decl_label5(check_hlds__det_analysis__det_infer_goal_2_11_0, 34,39,38,147,43)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 71,96,99,100,114,45,7,116,117,118)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 121,122,124,125,126,127,128,129,132,130)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 135,136,137,141,139,138,147,148,145,150)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 144,168,171,172,178,179,180,181,182,188)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 186,184,192,193,194,198,196,195,216,219)
MR_decl_label10(check_hlds__det_analysis__det_infer_scope_12_0, 220,226,3,231,229,234,239,240,254,233)
MR_decl_label3(check_hlds__det_analysis__det_infer_scope_12_0, 257,256,2)
...
MR_decl_label10(check_hlds__det_analysis__det_infer_unify_13_0, 13,15,16,19,23,21,28,32,36,18)
...
MR_decl_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1450__1_2_0)
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module9)
	...
	MR_init_label5(check_hlds__det_analysis__det_infer_goal_2_11_0,34,39,38,147,43)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_goal_2_11_0,29)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_goal_2_11_0_i147);
	}
...
MR_def_label(check_hlds__det_analysis__det_infer_goal_2_11_0,147)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(check_hlds__det_analysis__det_infer_switch_13_0,
		check_hlds__det_analysis__det_infer_goal_2_11_0_i43);
MR_def_label(check_hlds__det_analysis__det_infer_goal_2_11_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module17)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_unify_13_0,13,15,16,19,23,21,28,32,36,18)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_unify_13_0,23)
	...
	MR_r3 = (MR_Word) MR_string_const("complicated_unify but no var", 28);
...
MR_def_label(check_hlds__det_analysis__det_infer_atomic_goal_9_0,2)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1450__1_2_0);
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module23)
	...
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,71,96,99,100,114,45,7,116,117,118)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,121,122,124,125,126,127,128,129,132,130)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,135,136,137,141,139,138,147,148,145,150)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,144,168,171,172,178,179,180,181,182,188)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,186,184,192,193,194,198,196,195,216,219)
	MR_init_label10(check_hlds__det_analysis__det_infer_scope_12_0,220,226,3,231,229,234,239,240,254,233)
	MR_init_label3(check_hlds__det_analysis__det_infer_scope_12_0,257,256,2)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,132)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i130);
	}
	MR_r3 = MR_sv(7);
	MR_sv(12) = MR_sv(15);
	MR_r1 = MR_sv(16);
	MR_r2 = MR_sv(17);
	MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i179);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,137)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i141);
	}
	MR_r2 = MR_sv(12);
	MR_sv(12) = MR_r1;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,141)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(12);
	MR_sv(12) = MR_r1;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,138)
	...
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(check_hlds__det_analysis__det_infer_scope_12_0_i145);
	MR_sv(17) = MR_r1;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,147)
	...
	MR_np_call_localret_ent(f_115_101_116_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_109_101_109_98_101_114_95_95_91_84_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_2_0,
		check_hlds__det_analysis__det_infer_scope_12_0_i148);
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,148)
	...
	MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i150);
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(17);
	MR_redoip_slot_word(MR_maxfr) = MR_sv(18);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(19);
	MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i144);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,172)
	...
	MR_np_call_localret_ent(check_hlds__det_util__det_info_add_error_spec_3_0,
		check_hlds__det_analysis__det_infer_scope_12_0_i178);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,186)
	...
	MR_r1 = MR_sv(7);
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i184);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_r4 = MR_sv(5);
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,240)
	...
	MR_np_call_localret_ent(check_hlds__det_util__det_info_add_error_spec_3_0,
		check_hlds__det_analysis__det_infer_scope_12_0_i254);
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,254)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,233)
	...
	if (!((((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_r1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r1, 0) == (MR_Integer) 0))))) {
		MR_GOTO_LAB(check_hlds__det_analysis__det_infer_scope_12_0_i256);
	}
	MR_sv(1) = MR_r2;
	MR_sv(3) = MR_r4;
	MR_sv(4) = MR_r5;
...
MR_def_label(check_hlds__det_analysis__det_infer_scope_12_0,256)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module40)
	MR_init_entry1(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1450__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1450__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__det_infer_atomic_goal__1450__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1450__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
