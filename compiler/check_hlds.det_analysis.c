...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 91, &Debug_11);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 91, &Debug_12);
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(2), NestedSpec_37, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
