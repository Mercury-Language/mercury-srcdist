...
MR_decl_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1495__1_2_0)
...
MR_def_label(check_hlds__det_analysis__det_infer_atomic_goal_9_0,2)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1495__1_2_0);
...
MR_BEGIN_MODULE(check_hlds__det_analysis_module40)
	MR_init_entry1(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1495__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1495__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__det_infer_atomic_goal__1495__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__det_analysis__IntroducedFrom__pred__det_infer_atomic_goal__1495__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
