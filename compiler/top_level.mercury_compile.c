...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 322, &top_level__mercury_compile__IntermodOpt_16);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 324, &top_level__mercury_compile__UseOptInt_17);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 88, &top_level__mercury_compile__MakeOptInt_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 326, &top_level__mercury_compile__TransOpt_19);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 89, &top_level__mercury_compile__MakeTransOptInt_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 327, &top_level__mercury_compile__IntermodAnalysis_21);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals0_11, (MR_Integer) 88, &top_level__mercury_compile__MakeOptInt_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals0_11, (MR_Integer) 89, &top_level__mercury_compile__MakeTransOptInt_21);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals0_11, (MR_Integer) 90, &top_level__mercury_compile__MakeAnalysisRegistry_22);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals0_11, (MR_Integer) 91, &top_level__mercury_compile__MakeXmlDocumentation_23);
    }
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals0_11, (MR_Integer) 56, &top_level__mercury_compile__ReportCmdLineArgsDotErr_25);
          }
          {
    ...
    if (top_level__mercury_compile__succeeded)
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_26, (MR_Integer) 123, &top_level__mercury_compile__TraceProf_48);
        }
        {
        ...
        if (top_level__mercury_compile__succeeded)
          {
            ...
            {
              libs__globals__set_option_4_p_0((MR_Integer) 266, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_scalar_common_4[1]), top_level__mercury_compile__Globals_26, &top_level__mercury_compile__GlobalsNoTrace0_49);
            }
            {
      ...
      case (MR_Integer) 3:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 648, &top_level__mercury_compile__FileNamesFromStdin_35);
          }
          ...
          else
            {
              ...
              if (top_level__mercury_compile__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 49, &top_level__mercury_compile__VerboseErrors_47);
                  }
                  {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile__Globals_9, (MR_Integer) 57, &top_level__mercury_compile__Statistics_49);
              }
