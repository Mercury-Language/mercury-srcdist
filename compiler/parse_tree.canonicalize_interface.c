  ...
  MR_Word * STATE_VARIABLE_PredRelatedMap_36)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      AllItems_26 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_or_mode_decl_item_0), AllItems0_24, ((MR_Box) (Var_38)));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      AllItems_57 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_or_mode_decl_item_0), AllItems0_56, ((MR_Box) (Var_42)));
      {
