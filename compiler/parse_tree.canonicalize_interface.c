  ...
  MR_Word * STATE_VARIABLE_NonReorderableItemsCord_13)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_NonReorderableItemsCord_155_155;
      MR_Word STATE_VARIABLE_SortableItems_156_156;
      MR_Word STATE_VARIABLE_PredRelatedMap_161_161;
      MR_Word STATE_VARIABLE_ModeDefnMap_165_165;
      MR_Word STATE_VARIABLE_InstDefnMap_166_166;
      MR_Word STATE_VARIABLE_TypeDefnMap_167_167;
      ...
      switch (MR_tag((MR_Word) Item_32)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_NonReorderableItemsCord_155_155 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), STATE_VARIABLE_NonReorderableItemsCord_0_12, ((MR_Box) (Item_32)));
            STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_ModeDefnMap_165_165 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_161_161 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_156_156 = STATE_VARIABLE_SortableItems_0_10;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word ItemInstDefnInfo_49 = (MR_Word) (MR_body((MR_Word) (Item_32), (MR_Integer) 1));
            MR_Word SymName_174 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 0))));
            MR_Word Params_175 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 1))));
            MR_Integer Arity_176;
            MR_Word SymNameAndArity_177;

            mercury__list__length_2_p_0((MR_Word) (&parse_tree__canonicalize_interface_scalar_common_1[4]), Params_175, &Arity_176);
            {
              SymNameAndArity_177 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), SymNameAndArity_177, 0) = ((MR_Box) (SymName_174));
              MR_hl_field(MR_mktag(0), SymNameAndArity_177, 1) = ((MR_Box) (Arity_176));
            }
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_177, Item_32, STATE_VARIABLE_InstDefnMap_0_4, &STATE_VARIABLE_InstDefnMap_166_166);
            STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_ModeDefnMap_165_165 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_161_161 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_156_156 = STATE_VARIABLE_SortableItems_0_10;
            STATE_VARIABLE_NonReorderableItemsCord_155_155 = STATE_VARIABLE_NonReorderableItemsCord_0_12;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ItemModeDefnInfo_55 = (MR_Word) (MR_body((MR_Word) (Item_32), (MR_Integer) 2));
            MR_Word SymName_178 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 0))));
            MR_Word Params_179 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 1))));
            MR_Integer Arity_180;
            MR_Word SymNameAndArity_181;

            mercury__list__length_2_p_0((MR_Word) (&parse_tree__canonicalize_interface_scalar_common_1[4]), Params_179, &Arity_180);
            {
              SymNameAndArity_181 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), SymNameAndArity_181, 0) = ((MR_Box) (SymName_178));
              MR_hl_field(MR_mktag(0), SymNameAndArity_181, 1) = ((MR_Box) (Arity_180));
            }
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_181, Item_32, STATE_VARIABLE_ModeDefnMap_0_6, &STATE_VARIABLE_ModeDefnMap_165_165);
            STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_PredRelatedMap_161_161 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_156_156 = STATE_VARIABLE_SortableItems_0_10;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_32, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word SymName_212 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPredDeclInfo_60, (MR_Integer) 0))));
                ...
                {
                  MR_Word ArityPf_74;
                  MR_Integer Arity_192;
                  MR_Word PredRelated0_75;
                  MR_Box conv3_PredRelated0_75;

                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0), Args_62, &Arity_192);
                  {
                    ArityPf_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_74, 0) = ((MR_Box) (Arity_192));
                    MR_hl_field(MR_mktag(0), ArityPf_74, 1) = (MR_Box) ((MR_Unsigned) (PorF_61));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_212)), &conv3_PredRelated0_75);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      MR_Word ModeItems_182;
                      MR_Word PredItems_183;
                      MR_Word ArityPfItems_184;

                      PredItems_183 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      ModeItems_182 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      {
                        ArityPfItems_184 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_184, 0) = ((MR_Box) (PredItems_183));
                        MR_hl_field(MR_mktag(0), ArityPfItems_184, 1) = ((MR_Box) (ModeItems_182));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_184)), ArityPfMap0_78, &ArityPfMap_85);
                    }
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_212)), ((MR_Box) (PredRelated_86)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                  else
                  {
                    MR_Word AllItems_186;
                    MR_Word ModeItems_187;
                    MR_Word PredItems_188;
                    MR_Word ArityPfItems_189;
                    MR_Word ArityPfMap_190;
                    MR_Word PredRelated_191;

                    AllItems_186 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_188 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    ModeItems_187 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    {
                      ArityPfItems_189 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_189, 0) = ((MR_Box) (PredItems_188));
                      MR_hl_field(MR_mktag(0), ArityPfItems_189, 1) = ((MR_Box) (ModeItems_187));
                    }
                    ArityPfMap_190 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_189)));
                    {
                      PredRelated_191 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_191, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_191, 1) = ((MR_Box) (AllItems_186));
                      MR_hl_field(MR_mktag(0), PredRelated_191, 2) = ((MR_Box) (ArityPfMap_190));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_212)), ((MR_Box) (PredRelated_191)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                }
                else
                {
                  MR_Word PredRelated0_200;
                  MR_Box conv5_PredRelated0_200;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_212)), &conv5_PredRelated0_200);
                  if (succeeded)
                  {
                    PredRelated0_200 = ((MR_Word) (conv5_PredRelated0_200));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_193 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_200, (MR_Integer) 1))));
                    MR_Word AllItems_194;
                    MR_Word ArityPfMap_195 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_200, (MR_Integer) 2))));
                    MR_Word PredRelated_196;

                    AllItems_194 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_193, ((MR_Box) (Item_32)));
                    {
                      PredRelated_196 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_196, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_196, 1) = ((MR_Box) (AllItems_194));
                      MR_hl_field(MR_mktag(0), PredRelated_196, 2) = ((MR_Box) (ArityPfMap_195));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_212)), ((MR_Box) (PredRelated_196)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                  else
                  {
                    MR_Word AllItems_197;
                    MR_Word ArityPfMap_198;
                    MR_Word PredRelated_199;

                    AllItems_197 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_198);
                    {
                      PredRelated_199 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_199, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_199, 1) = ((MR_Box) (AllItems_197));
                      MR_hl_field(MR_mktag(0), PredRelated_199, 2) = ((MR_Box) (ArityPfMap_198));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_212)), ((MR_Box) (PredRelated_199)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word SymName_302 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 0))));
                MR_Word Args_305 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 2))));
                MR_Word MaybeWithInst_306 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 3))));
                MR_Word PorF_288;

                succeeded = (MaybeWithInst_306 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  succeeded = (MaybePorF_89 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                    PorF_288 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePorF_89, (MR_Integer) 0))));
                }
                if (succeeded)
                {
                  MR_Integer Arity_252;
                  MR_Word ArityPf_253;
                  MR_Word PredRelated0_241;
                  MR_Box conv0_PredRelated0_241;

                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Args_305, &Arity_252);
                  {
                    ArityPf_253 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_253, 0) = ((MR_Box) (Arity_252));
                    MR_hl_field(MR_mktag(0), ArityPf_253, 1) = (MR_Box) ((MR_Unsigned) (PorF_288));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_302)), &conv0_PredRelated0_241);
                  if (succeeded)
                  {
                    PredRelated0_241 = ((MR_Word) (conv0_PredRelated0_241));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word Known_224 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredRelated0_241, (MR_Integer) 0))) & (MR_Integer) 1);
                    MR_Word AllItems0_225 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_241, (MR_Integer) 1))));
                    MR_Word ArityPfMap0_226 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_241, (MR_Integer) 2))));
                    MR_Word AllItems_227;
                    MR_Word ArityPfMap_232;
                    MR_Word PredRelated_233;
                    MR_Word ArityPfItems0_220;
                    MR_Box conv1_ArityPfItems0_220;

                    AllItems_227 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_225, ((MR_Box) (Item_32)));
                    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ArityPfMap0_226, ((MR_Box) (ArityPf_253)), &conv1_ArityPfItems0_220);
                    if (succeeded)
                    {
                      ArityPfItems0_220 = ((MR_Word) (conv1_ArityPfItems0_220));
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                    {
                      MR_Word ModeItems0_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_220, (MR_Integer) 1))));
                      MR_Word ModeItems_214;
                      MR_Word PredItems_215 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_220, (MR_Integer) 0))));
                      MR_Word ArityPfItems_216;

                      ModeItems_214 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ModeItems0_94, ((MR_Box) (Item_32)));
                      {
                        ArityPfItems_216 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_216, 0) = ((MR_Box) (PredItems_215));
                        MR_hl_field(MR_mktag(0), ArityPfItems_216, 1) = ((MR_Box) (ModeItems_214));
                      }
                      mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_253)), ((MR_Box) (ArityPfItems_216)), ArityPfMap0_226, &ArityPfMap_232);
                    }
                    else
                    {
                      MR_Word ModeItems_217;
                      MR_Word PredItems_218;
                      MR_Word ArityPfItems_219;

                      PredItems_218 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      ModeItems_217 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      {
                        ArityPfItems_219 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_219, 0) = ((MR_Box) (PredItems_218));
                        MR_hl_field(MR_mktag(0), ArityPfItems_219, 1) = ((MR_Box) (ModeItems_217));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_253)), ((MR_Box) (ArityPfItems_219)), ArityPfMap0_226, &ArityPfMap_232);
                    }
                    {
                      PredRelated_233 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_233, 0) = (MR_Box) ((MR_Unsigned) (Known_224));
                      MR_hl_field(MR_mktag(0), PredRelated_233, 1) = ((MR_Box) (AllItems_227));
                      MR_hl_field(MR_mktag(0), PredRelated_233, 2) = ((MR_Box) (ArityPfMap_232));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_302)), ((MR_Box) (PredRelated_233)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                  else
                  {
                    MR_Word AllItems_235;
                    MR_Word ModeItems_236;
                    MR_Word PredItems_237;
                    MR_Word ArityPfItems_238;
                    MR_Word ArityPfMap_239;
                    MR_Word PredRelated_240;

                    AllItems_235 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_237 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    ModeItems_236 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    {
                      ArityPfItems_238 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_238, 0) = ((MR_Box) (PredItems_237));
                      MR_hl_field(MR_mktag(0), ArityPfItems_238, 1) = ((MR_Box) (ModeItems_236));
                    }
                    ArityPfMap_239 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_253)), ((MR_Box) (ArityPfItems_238)));
                    {
                      PredRelated_240 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_240, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_240, 1) = ((MR_Box) (AllItems_235));
                      MR_hl_field(MR_mktag(0), PredRelated_240, 2) = ((MR_Box) (ArityPfMap_239));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_302)), ((MR_Box) (PredRelated_240)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                }
                else
                {
                  MR_Word PredRelated0_274;
                  MR_Box conv2_PredRelated0_274;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_302)), &conv2_PredRelated0_274);
                  if (succeeded)
                  {
                    PredRelated0_274 = ((MR_Word) (conv2_PredRelated0_274));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_266 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_274, (MR_Integer) 1))));
                    MR_Word AllItems_267;
                    MR_Word ArityPfMap_268 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_274, (MR_Integer) 2))));
                    MR_Word PredRelated_269;

                    AllItems_267 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_266, ((MR_Box) (Item_32)));
                    {
                      PredRelated_269 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_269, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_269, 1) = ((MR_Box) (AllItems_267));
                      MR_hl_field(MR_mktag(0), PredRelated_269, 2) = ((MR_Box) (ArityPfMap_268));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_302)), ((MR_Box) (PredRelated_269)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                  else
                  {
                    MR_Word AllItems_271;
                    MR_Word ArityPfMap_272;
                    MR_Word PredRelated_273;

                    AllItems_271 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_272);
                    {
                      PredRelated_273 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_273, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_273, 1) = ((MR_Box) (AllItems_271));
                      MR_hl_field(MR_mktag(0), PredRelated_273, 2) = ((MR_Box) (ArityPfMap_272));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_302)), ((MR_Box) (PredRelated_273)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_161_161);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 10:
              {
                mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)), STATE_VARIABLE_SortableItems_0_10, &STATE_VARIABLE_SortableItems_156_156);
                STATE_VARIABLE_TypeDefnMap_167_167 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
                STATE_VARIABLE_ModeDefnMap_165_165 = STATE_VARIABLE_ModeDefnMap_0_6;
                STATE_VARIABLE_PredRelatedMap_161_161 = STATE_VARIABLE_PredRelatedMap_0_8;
            ...
            case (MR_Integer) 11:
              {
                ...
                parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_48, Item_32, STATE_VARIABLE_TypeDefnMap_0_2, &STATE_VARIABLE_TypeDefnMap_167_167);
                STATE_VARIABLE_InstDefnMap_166_166 = STATE_VARIABLE_InstDefnMap_0_4;
                STATE_VARIABLE_ModeDefnMap_165_165 = STATE_VARIABLE_ModeDefnMap_0_6;
                STATE_VARIABLE_PredRelatedMap_161_161 = STATE_VARIABLE_PredRelatedMap_0_8;
                STATE_VARIABLE_SortableItems_156_156 = STATE_VARIABLE_SortableItems_0_10;
      ...
      next_value_of_STATE_VARIABLE_TypeDefnMap_0_2 = STATE_VARIABLE_TypeDefnMap_167_167;
      next_value_of_STATE_VARIABLE_InstDefnMap_0_4 = STATE_VARIABLE_InstDefnMap_166_166;
      next_value_of_STATE_VARIABLE_ModeDefnMap_0_6 = STATE_VARIABLE_ModeDefnMap_165_165;
      next_value_of_STATE_VARIABLE_PredRelatedMap_0_8 = STATE_VARIABLE_PredRelatedMap_161_161;
      next_value_of_STATE_VARIABLE_SortableItems_0_10 = STATE_VARIABLE_SortableItems_156_156;
      next_value_of_STATE_VARIABLE_NonReorderableItemsCord_0_12 = STATE_VARIABLE_NonReorderableItemsCord_155_155;
