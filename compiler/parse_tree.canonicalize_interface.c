  ...
  MR_Word * STATE_VARIABLE_NonReorderableItemsCord_13)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_NonReorderableItemsCord_158_158;
      MR_Word STATE_VARIABLE_SortableItems_159_159;
      MR_Word STATE_VARIABLE_PredRelatedMap_164_164;
      MR_Word STATE_VARIABLE_ModeDefnMap_168_168;
      MR_Word STATE_VARIABLE_InstDefnMap_169_169;
      MR_Word STATE_VARIABLE_TypeDefnMap_170_170;
      ...
      switch (MR_tag((MR_Word) Item_32)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_NonReorderableItemsCord_158_158 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), STATE_VARIABLE_NonReorderableItemsCord_0_12, ((MR_Box) (Item_32)));
            STATE_VARIABLE_TypeDefnMap_170_170 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_InstDefnMap_169_169 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_ModeDefnMap_168_168 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_164_164 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_159_159 = STATE_VARIABLE_SortableItems_0_10;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_48, Item_32, STATE_VARIABLE_TypeDefnMap_0_2, &STATE_VARIABLE_TypeDefnMap_170_170);
            STATE_VARIABLE_InstDefnMap_169_169 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_ModeDefnMap_168_168 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_164_164 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_159_159 = STATE_VARIABLE_SortableItems_0_10;
            STATE_VARIABLE_NonReorderableItemsCord_158_158 = STATE_VARIABLE_NonReorderableItemsCord_0_12;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ItemInstDefnInfo_49 = (MR_Word) (MR_body((MR_Word) (Item_32), (MR_Integer) 2));
            MR_Word SymName_177 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 0))));
            MR_Word Params_178 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 1))));
            MR_Integer Arity_179;
            MR_Word SymNameAndArity_180;

            mercury__list__length_2_p_0((MR_Word) (&parse_tree__canonicalize_interface_scalar_common_1[4]), Params_178, &Arity_179);
            {
              SymNameAndArity_180 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), SymNameAndArity_180, 0) = ((MR_Box) (SymName_177));
              MR_hl_field(MR_mktag(0), SymNameAndArity_180, 1) = ((MR_Box) (Arity_179));
            }
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_180, Item_32, STATE_VARIABLE_InstDefnMap_0_4, &STATE_VARIABLE_InstDefnMap_169_169);
            STATE_VARIABLE_TypeDefnMap_170_170 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_ModeDefnMap_168_168 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_164_164 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_159_159 = STATE_VARIABLE_SortableItems_0_10;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_32, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word SymName_181 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 0))));
                MR_Word Params_182 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 1))));
                MR_Integer Arity_183;
                MR_Word SymNameAndArity_184;

                mercury__list__length_2_p_0((MR_Word) (&parse_tree__canonicalize_interface_scalar_common_1[4]), Params_182, &Arity_183);
                {
                  SymNameAndArity_184 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), SymNameAndArity_184, 0) = ((MR_Box) (SymName_181));
                  MR_hl_field(MR_mktag(0), SymNameAndArity_184, 1) = ((MR_Box) (Arity_183));
                }
                parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_184, Item_32, STATE_VARIABLE_ModeDefnMap_0_6, &STATE_VARIABLE_ModeDefnMap_168_168);
                STATE_VARIABLE_TypeDefnMap_170_170 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_169_169 = STATE_VARIABLE_InstDefnMap_0_4;
                STATE_VARIABLE_PredRelatedMap_164_164 = STATE_VARIABLE_PredRelatedMap_0_8;
                STATE_VARIABLE_SortableItems_159_159 = STATE_VARIABLE_SortableItems_0_10;
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word SymName_215 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPredDeclInfo_60, (MR_Integer) 0))));
                ...
                if (succeeded)
                {
                  ...
                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0), Args_62, &Arity_195);
                  {
                    ArityPf_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_74, 0) = ((MR_Box) (Arity_195));
                    MR_hl_field(MR_mktag(0), ArityPf_74, 1) = (MR_Box) ((MR_Unsigned) (PorF_61));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_215)), &conv3_PredRelated0_75);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      MR_Word ModeItems_185;
                      MR_Word PredItems_186;
                      MR_Word ArityPfItems_187;

                      PredItems_186 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      ModeItems_185 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      {
                        ArityPfItems_187 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_187, 0) = ((MR_Box) (PredItems_186));
                        MR_hl_field(MR_mktag(0), ArityPfItems_187, 1) = ((MR_Box) (ModeItems_185));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_187)), ArityPfMap0_78, &ArityPfMap_85);
                    }
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_215)), ((MR_Box) (PredRelated_86)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                  else
                  {
                    MR_Word AllItems_189;
                    MR_Word ModeItems_190;
                    MR_Word PredItems_191;
                    MR_Word ArityPfItems_192;
                    MR_Word ArityPfMap_193;
                    MR_Word PredRelated_194;

                    AllItems_189 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_191 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    ModeItems_190 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    {
                      ArityPfItems_192 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_192, 0) = ((MR_Box) (PredItems_191));
                      MR_hl_field(MR_mktag(0), ArityPfItems_192, 1) = ((MR_Box) (ModeItems_190));
                    }
                    ArityPfMap_193 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_192)));
                    {
                      PredRelated_194 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_194, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_194, 1) = ((MR_Box) (AllItems_189));
                      MR_hl_field(MR_mktag(0), PredRelated_194, 2) = ((MR_Box) (ArityPfMap_193));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_215)), ((MR_Box) (PredRelated_194)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                }
                else
                {
                  MR_Word PredRelated0_203;
                  MR_Box conv5_PredRelated0_203;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_215)), &conv5_PredRelated0_203);
                  if (succeeded)
                  {
                    PredRelated0_203 = ((MR_Word) (conv5_PredRelated0_203));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_196 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_203, (MR_Integer) 1))));
                    MR_Word AllItems_197;
                    MR_Word ArityPfMap_198 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_203, (MR_Integer) 2))));
                    MR_Word PredRelated_199;

                    AllItems_197 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_196, ((MR_Box) (Item_32)));
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_215)), ((MR_Box) (PredRelated_199)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                  else
                  {
                    MR_Word AllItems_200;
                    MR_Word ArityPfMap_201;
                    MR_Word PredRelated_202;

                    AllItems_200 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_201);
                    {
                      PredRelated_202 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_202, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_202, 1) = ((MR_Box) (AllItems_200));
                      MR_hl_field(MR_mktag(0), PredRelated_202, 2) = ((MR_Box) (ArityPfMap_201));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_215)), ((MR_Box) (PredRelated_202)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_170_170 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_169_169 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word SymName_305 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 0))));
                MR_Word Args_308 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 2))));
                MR_Word MaybeWithInst_309 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 3))));
                MR_Word PorF_291;

                succeeded = (MaybeWithInst_309 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  succeeded = (MaybePorF_89 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                    PorF_291 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePorF_89, (MR_Integer) 0))));
                }
                if (succeeded)
                {
                  MR_Integer Arity_255;
                  MR_Word ArityPf_256;
                  MR_Word PredRelated0_244;
                  MR_Box conv0_PredRelated0_244;

                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Args_308, &Arity_255);
                  {
                    ArityPf_256 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_256, 0) = ((MR_Box) (Arity_255));
                    MR_hl_field(MR_mktag(0), ArityPf_256, 1) = (MR_Box) ((MR_Unsigned) (PorF_291));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_305)), &conv0_PredRelated0_244);
                  if (succeeded)
                  {
                    PredRelated0_244 = ((MR_Word) (conv0_PredRelated0_244));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word Known_227 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredRelated0_244, (MR_Integer) 0))) & (MR_Integer) 1);
                    MR_Word AllItems0_228 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_244, (MR_Integer) 1))));
                    MR_Word ArityPfMap0_229 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_244, (MR_Integer) 2))));
                    MR_Word AllItems_230;
                    MR_Word ArityPfMap_235;
                    MR_Word PredRelated_236;
                    MR_Word ArityPfItems0_223;
                    MR_Box conv1_ArityPfItems0_223;

                    AllItems_230 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_228, ((MR_Box) (Item_32)));
                    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ArityPfMap0_229, ((MR_Box) (ArityPf_256)), &conv1_ArityPfItems0_223);
                    if (succeeded)
                    {
                      ArityPfItems0_223 = ((MR_Word) (conv1_ArityPfItems0_223));
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                    {
                      MR_Word ModeItems0_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_223, (MR_Integer) 1))));
                      MR_Word ModeItems_217;
                      MR_Word PredItems_218 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_223, (MR_Integer) 0))));
                      MR_Word ArityPfItems_219;

                      ModeItems_217 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ModeItems0_94, ((MR_Box) (Item_32)));
                      {
                      ...
                      mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_256)), ((MR_Box) (ArityPfItems_219)), ArityPfMap0_229, &ArityPfMap_235);
                    }
                    else
                    {
                      MR_Word ModeItems_220;
                      MR_Word PredItems_221;
                      MR_Word ArityPfItems_222;

                      PredItems_221 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      ModeItems_220 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      {
                        ArityPfItems_222 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_222, 0) = ((MR_Box) (PredItems_221));
                        MR_hl_field(MR_mktag(0), ArityPfItems_222, 1) = ((MR_Box) (ModeItems_220));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_256)), ((MR_Box) (ArityPfItems_222)), ArityPfMap0_229, &ArityPfMap_235);
                    }
                    {
                      PredRelated_236 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_236, 0) = (MR_Box) ((MR_Unsigned) (Known_227));
                      MR_hl_field(MR_mktag(0), PredRelated_236, 1) = ((MR_Box) (AllItems_230));
                      MR_hl_field(MR_mktag(0), PredRelated_236, 2) = ((MR_Box) (ArityPfMap_235));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_305)), ((MR_Box) (PredRelated_236)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                  else
                  {
                    MR_Word AllItems_238;
                    MR_Word ModeItems_239;
                    MR_Word PredItems_240;
                    MR_Word ArityPfItems_241;
                    MR_Word ArityPfMap_242;
                    MR_Word PredRelated_243;

                    AllItems_238 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_240 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    ModeItems_239 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    {
                      ArityPfItems_241 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_241, 0) = ((MR_Box) (PredItems_240));
                      MR_hl_field(MR_mktag(0), ArityPfItems_241, 1) = ((MR_Box) (ModeItems_239));
                    }
                    ArityPfMap_242 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_256)), ((MR_Box) (ArityPfItems_241)));
                    {
                      PredRelated_243 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_243, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_243, 1) = ((MR_Box) (AllItems_238));
                      MR_hl_field(MR_mktag(0), PredRelated_243, 2) = ((MR_Box) (ArityPfMap_242));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_305)), ((MR_Box) (PredRelated_243)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                }
                else
                {
                  MR_Word PredRelated0_277;
                  MR_Box conv2_PredRelated0_277;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_305)), &conv2_PredRelated0_277);
                  if (succeeded)
                  {
                    PredRelated0_277 = ((MR_Word) (conv2_PredRelated0_277));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_269 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_277, (MR_Integer) 1))));
                    MR_Word AllItems_270;
                    MR_Word ArityPfMap_271 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_277, (MR_Integer) 2))));
                    MR_Word PredRelated_272;

                    AllItems_270 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_269, ((MR_Box) (Item_32)));
                    {
                      PredRelated_272 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_272, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_272, 1) = ((MR_Box) (AllItems_270));
                      MR_hl_field(MR_mktag(0), PredRelated_272, 2) = ((MR_Box) (ArityPfMap_271));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_305)), ((MR_Box) (PredRelated_272)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                  else
                  {
                    MR_Word AllItems_274;
                    MR_Word ArityPfMap_275;
                    MR_Word PredRelated_276;

                    AllItems_274 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_275);
                    {
                      PredRelated_276 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_276, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_276, 1) = ((MR_Box) (AllItems_274));
                      MR_hl_field(MR_mktag(0), PredRelated_276, 2) = ((MR_Box) (ArityPfMap_275));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_305)), ((MR_Box) (PredRelated_276)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_164_164);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_170_170 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_169_169 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 3:
              {
                ...
                switch (MR_tag((MR_Word) Pragma_96)) {
                  ...
                  case (MR_Integer) 3:
                    {
                      mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)), STATE_VARIABLE_SortableItems_0_10, &STATE_VARIABLE_SortableItems_159_159);
                      STATE_VARIABLE_NonReorderableItemsCord_158_158 = STATE_VARIABLE_NonReorderableItemsCord_0_12;
                    }
                    break;
                }
            ...
            case (MR_Integer) 11:
              {
                {
                  mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.canonicalize_interface.classify_items\'/13", (MR_String) "item_type_repn");
                  return;
                }
              }
              break;
      ...
      next_value_of_STATE_VARIABLE_TypeDefnMap_0_2 = STATE_VARIABLE_TypeDefnMap_170_170;
      next_value_of_STATE_VARIABLE_InstDefnMap_0_4 = STATE_VARIABLE_InstDefnMap_169_169;
      next_value_of_STATE_VARIABLE_ModeDefnMap_0_6 = STATE_VARIABLE_ModeDefnMap_168_168;
      next_value_of_STATE_VARIABLE_PredRelatedMap_0_8 = STATE_VARIABLE_PredRelatedMap_164_164;
      next_value_of_STATE_VARIABLE_SortableItems_0_10 = STATE_VARIABLE_SortableItems_159_159;
      next_value_of_STATE_VARIABLE_NonReorderableItemsCord_0_12 = STATE_VARIABLE_NonReorderableItemsCord_158_158;
