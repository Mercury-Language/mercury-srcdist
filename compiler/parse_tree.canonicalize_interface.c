  ...
  MR_Word * STATE_VARIABLE_NonReorderableItemsCord_13)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_NonReorderableItemsCord_159_159;
      MR_Word STATE_VARIABLE_SortableItems_160_160;
      MR_Word STATE_VARIABLE_PredRelatedMap_165_165;
      MR_Word STATE_VARIABLE_ModeDefnMap_169_169;
      MR_Word STATE_VARIABLE_InstDefnMap_170_170;
      MR_Word STATE_VARIABLE_TypeDefnMap_171_171;
      ...
      switch (MR_tag((MR_Word) Item_32)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_NonReorderableItemsCord_159_159 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), STATE_VARIABLE_NonReorderableItemsCord_0_12, ((MR_Box) (Item_32)));
            STATE_VARIABLE_TypeDefnMap_171_171 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_InstDefnMap_170_170 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_ModeDefnMap_169_169 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_165_165 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_160_160 = STATE_VARIABLE_SortableItems_0_10;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_48, Item_32, STATE_VARIABLE_TypeDefnMap_0_2, &STATE_VARIABLE_TypeDefnMap_171_171);
            STATE_VARIABLE_InstDefnMap_170_170 = STATE_VARIABLE_InstDefnMap_0_4;
            STATE_VARIABLE_ModeDefnMap_169_169 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_165_165 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_160_160 = STATE_VARIABLE_SortableItems_0_10;
            STATE_VARIABLE_NonReorderableItemsCord_159_159 = STATE_VARIABLE_NonReorderableItemsCord_0_12;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ItemInstDefnInfo_49 = (MR_Word) (MR_body((MR_Word) (Item_32), (MR_Integer) 2));
            MR_Word SymName_178 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 0))));
            MR_Word Params_179 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_49, (MR_Integer) 1))));
            ...
            parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_181, Item_32, STATE_VARIABLE_InstDefnMap_0_4, &STATE_VARIABLE_InstDefnMap_170_170);
            STATE_VARIABLE_TypeDefnMap_171_171 = STATE_VARIABLE_TypeDefnMap_0_2;
            STATE_VARIABLE_ModeDefnMap_169_169 = STATE_VARIABLE_ModeDefnMap_0_6;
            STATE_VARIABLE_PredRelatedMap_165_165 = STATE_VARIABLE_PredRelatedMap_0_8;
            STATE_VARIABLE_SortableItems_160_160 = STATE_VARIABLE_SortableItems_0_10;
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word SymName_182 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 0))));
                MR_Word Params_183 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_55, (MR_Integer) 1))));
                MR_Integer Arity_184;
                MR_Word SymNameAndArity_185;

                mercury__list__length_2_p_0((MR_Word) (&parse_tree__canonicalize_interface_scalar_common_1[4]), Params_183, &Arity_184);
                {
                  SymNameAndArity_185 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), SymNameAndArity_185, 0) = ((MR_Box) (SymName_182));
                  MR_hl_field(MR_mktag(0), SymNameAndArity_185, 1) = ((MR_Box) (Arity_184));
                }
                parse_tree__canonicalize_interface__add_to_sym_name_items_map_4_p_0(SymNameAndArity_185, Item_32, STATE_VARIABLE_ModeDefnMap_0_6, &STATE_VARIABLE_ModeDefnMap_169_169);
                STATE_VARIABLE_TypeDefnMap_171_171 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_170_170 = STATE_VARIABLE_InstDefnMap_0_4;
                STATE_VARIABLE_PredRelatedMap_165_165 = STATE_VARIABLE_PredRelatedMap_0_8;
                STATE_VARIABLE_SortableItems_160_160 = STATE_VARIABLE_SortableItems_0_10;
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word SymName_216 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPredDeclInfo_60, (MR_Integer) 0))));
                ...
                if (succeeded)
                {
                  ...
                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0), Args_62, &Arity_196);
                  {
                    ArityPf_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_74, 0) = ((MR_Box) (Arity_196));
                    MR_hl_field(MR_mktag(0), ArityPf_74, 1) = (MR_Box) ((MR_Unsigned) (PorF_61));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_216)), &conv3_PredRelated0_75);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      MR_Word ModeItems_186;
                      MR_Word PredItems_187;
                      MR_Word ArityPfItems_188;

                      PredItems_187 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      ModeItems_186 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      {
                        ArityPfItems_188 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_188, 0) = ((MR_Box) (PredItems_187));
                        MR_hl_field(MR_mktag(0), ArityPfItems_188, 1) = ((MR_Box) (ModeItems_186));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_188)), ArityPfMap0_78, &ArityPfMap_85);
                    }
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_216)), ((MR_Box) (PredRelated_86)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                  else
                  {
                    MR_Word AllItems_190;
                    MR_Word ModeItems_191;
                    MR_Word PredItems_192;
                    MR_Word ArityPfItems_193;
                    MR_Word ArityPfMap_194;
                    MR_Word PredRelated_195;

                    AllItems_190 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_192 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    ModeItems_191 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    {
                      ArityPfItems_193 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_193, 0) = ((MR_Box) (PredItems_192));
                      MR_hl_field(MR_mktag(0), ArityPfItems_193, 1) = ((MR_Box) (ModeItems_191));
                    }
                    ArityPfMap_194 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_74)), ((MR_Box) (ArityPfItems_193)));
                    {
                      PredRelated_195 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_195, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_195, 1) = ((MR_Box) (AllItems_190));
                      MR_hl_field(MR_mktag(0), PredRelated_195, 2) = ((MR_Box) (ArityPfMap_194));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_216)), ((MR_Box) (PredRelated_195)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                }
                else
                {
                  MR_Word PredRelated0_204;
                  MR_Box conv5_PredRelated0_204;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_216)), &conv5_PredRelated0_204);
                  if (succeeded)
                  {
                    PredRelated0_204 = ((MR_Word) (conv5_PredRelated0_204));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_197 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_204, (MR_Integer) 1))));
                    MR_Word AllItems_198;
                    MR_Word ArityPfMap_199 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_204, (MR_Integer) 2))));
                    MR_Word PredRelated_200;

                    AllItems_198 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_197, ((MR_Box) (Item_32)));
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_216)), ((MR_Box) (PredRelated_200)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                  else
                  {
                    MR_Word AllItems_201;
                    MR_Word ArityPfMap_202;
                    MR_Word PredRelated_203;

                    AllItems_201 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_202);
                    {
                      PredRelated_203 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_203, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_203, 1) = ((MR_Box) (AllItems_201));
                      MR_hl_field(MR_mktag(0), PredRelated_203, 2) = ((MR_Box) (ArityPfMap_202));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_216)), ((MR_Box) (PredRelated_203)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_171_171 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_170_170 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word SymName_306 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 0))));
                MR_Word Args_309 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 2))));
                MR_Word MaybeWithInst_310 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDeclInfo_88, (MR_Integer) 3))));
                MR_Word PorF_292;

                succeeded = (MaybeWithInst_310 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  succeeded = (MaybePorF_89 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                    PorF_292 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePorF_89, (MR_Integer) 0))));
                }
                if (succeeded)
                {
                  MR_Integer Arity_256;
                  MR_Word ArityPf_257;
                  MR_Word PredRelated0_245;
                  MR_Box conv0_PredRelated0_245;

                  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Args_309, &Arity_256);
                  {
                    ArityPf_257 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ArityPf_257, 0) = ((MR_Box) (Arity_256));
                    MR_hl_field(MR_mktag(0), ArityPf_257, 1) = (MR_Box) ((MR_Unsigned) (PorF_292));
                  }
                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_306)), &conv0_PredRelated0_245);
                  if (succeeded)
                  {
                    PredRelated0_245 = ((MR_Word) (conv0_PredRelated0_245));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word Known_228 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredRelated0_245, (MR_Integer) 0))) & (MR_Integer) 1);
                    MR_Word AllItems0_229 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_245, (MR_Integer) 1))));
                    MR_Word ArityPfMap0_230 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_245, (MR_Integer) 2))));
                    MR_Word AllItems_231;
                    MR_Word ArityPfMap_236;
                    MR_Word PredRelated_237;
                    MR_Word ArityPfItems0_224;
                    MR_Box conv1_ArityPfItems0_224;

                    AllItems_231 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_229, ((MR_Box) (Item_32)));
                    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ArityPfMap0_230, ((MR_Box) (ArityPf_257)), &conv1_ArityPfItems0_224);
                    if (succeeded)
                    {
                      ArityPfItems0_224 = ((MR_Word) (conv1_ArityPfItems0_224));
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                    {
                      MR_Word ModeItems0_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_224, (MR_Integer) 1))));
                      MR_Word ModeItems_218;
                      MR_Word PredItems_219 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArityPfItems0_224, (MR_Integer) 0))));
                      MR_Word ArityPfItems_220;

                      ModeItems_218 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ModeItems0_94, ((MR_Box) (Item_32)));
                      {
                      ...
                      mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_257)), ((MR_Box) (ArityPfItems_220)), ArityPfMap0_230, &ArityPfMap_236);
                    }
                    else
                    {
                      MR_Word ModeItems_221;
                      MR_Word PredItems_222;
                      MR_Word ArityPfItems_223;

                      PredItems_222 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                      ModeItems_221 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                      {
                        ArityPfItems_223 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ArityPfItems_223, 0) = ((MR_Box) (PredItems_222));
                        MR_hl_field(MR_mktag(0), ArityPfItems_223, 1) = ((MR_Box) (ModeItems_221));
                      }
                      mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_257)), ((MR_Box) (ArityPfItems_223)), ArityPfMap0_230, &ArityPfMap_236);
                    }
                    {
                      PredRelated_237 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_237, 0) = (MR_Box) ((MR_Unsigned) (Known_228));
                      MR_hl_field(MR_mktag(0), PredRelated_237, 1) = ((MR_Box) (AllItems_231));
                      MR_hl_field(MR_mktag(0), PredRelated_237, 2) = ((MR_Box) (ArityPfMap_236));
                    }
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_306)), ((MR_Box) (PredRelated_237)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                  else
                  {
                    MR_Word AllItems_239;
                    MR_Word ModeItems_240;
                    MR_Word PredItems_241;
                    MR_Word ArityPfItems_242;
                    MR_Word ArityPfMap_243;
                    MR_Word PredRelated_244;

                    AllItems_239 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    PredItems_241 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0));
                    ModeItems_240 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    {
                      ArityPfItems_242 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ArityPfItems_242, 0) = ((MR_Box) (PredItems_241));
                      MR_hl_field(MR_mktag(0), ArityPfItems_242, 1) = ((MR_Box) (ModeItems_240));
                    }
                    ArityPfMap_243 = mercury__map__singleton_2_f_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), ((MR_Box) (ArityPf_257)), ((MR_Box) (ArityPfItems_242)));
                    {
                      PredRelated_244 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_244, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), PredRelated_244, 1) = ((MR_Box) (AllItems_239));
                      MR_hl_field(MR_mktag(0), PredRelated_244, 2) = ((MR_Box) (ArityPfMap_243));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_306)), ((MR_Box) (PredRelated_244)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                }
                else
                {
                  MR_Word PredRelated0_278;
                  MR_Box conv2_PredRelated0_278;

                  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), STATE_VARIABLE_PredRelatedMap_0_8, ((MR_Box) (SymName_306)), &conv2_PredRelated0_278);
                  if (succeeded)
                  {
                    PredRelated0_278 = ((MR_Word) (conv2_PredRelated0_278));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                  {
                    MR_Word AllItems0_270 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_278, (MR_Integer) 1))));
                    MR_Word AllItems_271;
                    MR_Word ArityPfMap_272 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredRelated0_278, (MR_Integer) 2))));
                    MR_Word PredRelated_273;

                    AllItems_271 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), AllItems0_270, ((MR_Box) (Item_32)));
                    {
                    ...
                    mercury__map__det_update_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_306)), ((MR_Box) (PredRelated_273)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                  else
                  {
                    MR_Word AllItems_275;
                    MR_Word ArityPfMap_276;
                    MR_Word PredRelated_277;

                    AllItems_275 = mercury__cord__singleton_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)));
                    mercury__map__init_1_p_0((MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_arity_pf_items_0), &ArityPfMap_276);
                    {
                      PredRelated_277 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), PredRelated_277, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), PredRelated_277, 1) = ((MR_Box) (AllItems_275));
                      MR_hl_field(MR_mktag(0), PredRelated_277, 2) = ((MR_Box) (ArityPfMap_276));
                    }
                    mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__canonicalize_interface__parse_tree__canonicalize_interface__type_ctor_info_pred_related_items_0), ((MR_Box) (SymName_306)), ((MR_Box) (PredRelated_277)), STATE_VARIABLE_PredRelatedMap_0_8, &STATE_VARIABLE_PredRelatedMap_165_165);
                  }
                }
                STATE_VARIABLE_TypeDefnMap_171_171 = STATE_VARIABLE_TypeDefnMap_0_2;
                STATE_VARIABLE_InstDefnMap_170_170 = STATE_VARIABLE_InstDefnMap_0_4;
            ...
            case (MR_Integer) 3:
              {
                ...
                switch (MR_tag((MR_Word) Pragma_96)) {
                  ...
                  case (MR_Integer) 3:
                    {
                      mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_32)), STATE_VARIABLE_SortableItems_0_10, &STATE_VARIABLE_SortableItems_160_160);
                      STATE_VARIABLE_NonReorderableItemsCord_159_159 = STATE_VARIABLE_NonReorderableItemsCord_0_12;
                    }
                    break;
                }
      ...
      next_value_of_STATE_VARIABLE_TypeDefnMap_0_2 = STATE_VARIABLE_TypeDefnMap_171_171;
      next_value_of_STATE_VARIABLE_InstDefnMap_0_4 = STATE_VARIABLE_InstDefnMap_170_170;
      next_value_of_STATE_VARIABLE_ModeDefnMap_0_6 = STATE_VARIABLE_ModeDefnMap_169_169;
      next_value_of_STATE_VARIABLE_PredRelatedMap_0_8 = STATE_VARIABLE_PredRelatedMap_165_165;
      next_value_of_STATE_VARIABLE_SortableItems_0_10 = STATE_VARIABLE_SortableItems_160_160;
      next_value_of_STATE_VARIABLE_NonReorderableItemsCord_0_12 = STATE_VARIABLE_NonReorderableItemsCord_159_159;
