  ...
  MR_Word * Types_8)
{
  ...
  check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(ModuleInfo_5, Type_6, ConsId_9, ArgInsts_10, Types_8);
}
  ...
  MR_Word * Types_10)
{
  ...
  if (succeeded)
  {
    DuCtor_12 = (MR_Word) (MR_body((MR_Word) (ConsId_8), (MR_Integer) 1));
    {
      ...
      succeeded = check_hlds__type_util__get_du_ctor_non_existential_arg_types_4_p_0(ModuleInfo_6, Type_7, DuCtor_12, &ArgTypes_13);
      if (succeeded)
      {
        TypeCtorInfo_22_22 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
        mercury__list__length_2_p_0(TypeCtorInfo_22_22, ArgTypes_13, &Var_25);
        succeeded = (Arity_11 == Var_25);
      }
      if (succeeded)
        *Types_10 = ArgTypes_13;
      else
      {
        MR_Word TypeArgs_15;
        MR_Word TypeCtor_14;

        succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_7, &TypeCtor_14, &TypeArgs_15);
        if (succeeded)
          succeeded = parse_tree__prog_type_test__type_ctor_is_tuple_1_p_0(TypeCtor_14);
        if (succeeded)
          *Types_10 = TypeArgs_15;
        else
        {
          MR_Word Var_18;
          MR_Word VarSet0_26;
          ...
          mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Arity_11, ((MR_Box) (Var_18)), Types_10);
        }
      }
    }
  }
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_7, &_TypeCtor_17, &TypeArgs_20);
      if (succeeded)
        *Types_10 = TypeArgs_20;
      else
      {
        MR_Word Var_19;
        MR_Word VarSet0_31;
        ...
        mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &Var_32, VarSet0_31, &_VarSet_33);
        {
          ...
          MR_hl_field(0, Var_19, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Arity_11, ((MR_Box) (Var_19)), Types_10);
      }
    }
    else
