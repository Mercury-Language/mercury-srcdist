...
static /* final */ const MR_Box check_hlds__inst_util_scalar_common_4[3][3];
...
{
  {
    ...
    if (succeeded)
      *MaybeTypes_6 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&check_hlds__inst_util_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_util_scalar_common_4[2]), ArgTypes_11);
    else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        *MaybeTypes_10 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&check_hlds__inst_util_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_util_scalar_common_4[1]), Types_16);
      else
