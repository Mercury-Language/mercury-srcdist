  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    Var_22 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ArgInsts0_17);
    check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_4, Type_1, ConsId_16, Var_22, &ArgTypes_18);
    check_hlds__inst_util__make_shared_inst_list_5_p_0(ArgTypes_18, ArgInsts0_17, &ArgInsts_19, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_23_23);
    {
    ...
    check_hlds__inst_util__make_shared_bound_inst_list_5_p_0(Type_1, BoundInsts0_12, &BoundInsts_14, STATE_VARIABLE_ModuleInfo_23_23, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    Var_22 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ArgInsts0_17);
    check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_4, Type_1, ConsId_16, Var_22, &ArgTypes_18);
    check_hlds__inst_util__make_mostly_uniq_inst_list_5_p_0(ArgTypes_18, ArgInsts0_17, &ArgInsts_19, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_23_23);
    {
      BoundInst_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, BoundInst_13, 0) = ((MR_Box) (ConsId_16));
      MR_hl_field(0, BoundInst_13, 1) = ((MR_Box) (ArgInsts_19));
    }
    check_hlds__inst_util__make_mostly_uniq_bound_inst_list_5_p_0(Type_1, BoundInsts0_12, &BoundInsts_14, STATE_VARIABLE_ModuleInfo_23_23, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
  ...
  MR_Word * Types_10)
{
  ...
  if (succeeded)
  {
    DuCtor_11 = (MR_Word) (MR_body((MR_Word) (ConsId_8), (MR_Integer) 1));
    {
      MR_Word ArgTypes_12;
      MR_Word TypeCtorInfo_20_20;
      MR_Integer Var_23;

      succeeded = check_hlds__type_util__get_du_ctor_non_existential_arg_types_4_p_0(ModuleInfo_6, Type_7, DuCtor_11, &ArgTypes_12);
      if (succeeded)
      {
        TypeCtorInfo_20_20 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
        mercury__list__length_2_p_0(TypeCtorInfo_20_20, ArgTypes_12, &Var_23);
        succeeded = (Arity_9 == Var_23);
      }
      if (succeeded)
        *Types_10 = ArgTypes_12;
      else
      {
        MR_Word TypeArgs_14;
        MR_Word TypeCtor_13;

        succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_7, &TypeCtor_13, &TypeArgs_14);
        if (succeeded)
          succeeded = parse_tree__prog_type_test__type_ctor_is_tuple_1_p_0(TypeCtor_13);
        if (succeeded)
          *Types_10 = TypeArgs_14;
        else
        {
          MR_Word Var_17;
          MR_Word VarSet0_24;
          ...
          mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &VarSet0_24);
          mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &Var_25, VarSet0_24, &_VarSet_26);
          {
            Var_17 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_17, 0) = ((MR_Box) (Var_25));
            MR_hl_field(0, Var_17, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Arity_9, ((MR_Box) (Var_17)), Types_10);
        }
      }
    }
  }
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_7, &_TypeCtor_16, &TypeArgs_19);
      if (succeeded)
        *Types_10 = TypeArgs_19;
      else
      {
        MR_Word Var_18;
        MR_Word VarSet0_29;
        ...
        mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &VarSet0_29);
        mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &Var_30, VarSet0_29, &_VarSet_31);
        {
          Var_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_18, 0) = ((MR_Box) (Var_30));
          MR_hl_field(0, Var_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Arity_9, ((MR_Box) (Var_18)), Types_10);
      }
    }
    else
