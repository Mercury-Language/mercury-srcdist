...
static void MR_CALL 
check_hlds__inst_util__make_mostly_uniq_bound_functors_5_p_0(
  MR_Word Type_1,
  MR_Word HeadVar__2_2,
  MR_Word * HeadVar__3_3,
  MR_Word STATE_VARIABLE_ModuleInfo_0_4,
...
void MR_CALL 
check_hlds__inst_util__get_cons_id_arg_types_for_bound_functor_4_p_0(
...
void MR_CALL 
check_hlds__inst_util__make_shared_bound_functors_5_p_0(
  MR_Word Type_1,
  MR_Word HeadVar__2_2,
  MR_Word * HeadVar__3_3,
  MR_Word STATE_VARIABLE_ModuleInfo_0_4,
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    check_hlds__inst_util__make_shared_inst_list_5_p_0(ArgTypes_18, ArgInsts0_17, &ArgInsts_19, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_1_22);
    {
    ...
    check_hlds__inst_util__make_shared_bound_functors_5_p_0(Type_1, BoundFunctors0_12, &BoundFunctors_14, STATE_VARIABLE_ModuleInfo_1_22, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__inst_util__make_shared_bound_functors_5_p_0(Type_6, BoundFunctors0_14, &BoundFunctors_15, STATE_VARIABLE_ModuleInfo_0_33, STATE_VARIABLE_ModuleInfo_34);
        {
          MR_Word base;
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((MaybeOldMaybeInst_24 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_3_41, InstName_21, &SubInst0_49);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_3_41, SubInst0_49, &SubInst1_50);
              check_hlds__inst_util__make_shared_inst_5_p_0(Type_6, SubInst1_50, &SharedInst_27, STATE_VARIABLE_ModuleInfo_3_41, &STATE_VARIABLE_ModuleInfo_4_42);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__make_shared_inst_5_p_0(Var_36, Inst0_27, &Inst_29, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_1_34);
      check_hlds__inst_util__make_shared_inst_list_5_p_0(Var_35, Insts0_28, &Insts_30, STATE_VARIABLE_ModuleInfo_1_34, STATE_VARIABLE_ModuleInfo_5);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__3_3 = base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__make_mostly_uniq_inst_5_p_0(Var_36, Inst0_27, &Inst_29, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_1_34);
      check_hlds__inst_util__make_mostly_uniq_inst_list_5_p_0(Var_35, Insts0_28, &Insts_30, STATE_VARIABLE_ModuleInfo_1_34, STATE_VARIABLE_ModuleInfo_5);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__3_3 = base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_4, Type_1, ConsId_16, ArgInsts0_17, &ArgTypes_18);
    check_hlds__inst_util__make_mostly_uniq_inst_list_5_p_0(ArgTypes_18, ArgInsts0_17, &ArgInsts_19, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_1_22);
    {
      BoundFunctor_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, BoundFunctor_13, 0) = ((MR_Box) (ConsId_16));
      MR_hl_field(0, BoundFunctor_13, 1) = ((MR_Box) (ArgInsts_19));
    }
    check_hlds__inst_util__make_mostly_uniq_bound_functors_5_p_0(Type_1, BoundFunctors0_12, &BoundFunctors_14, STATE_VARIABLE_ModuleInfo_1_22, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__inst_util__make_mostly_uniq_bound_functors_5_p_0(Type_6, BoundFunctors0_14, &BoundFunctors_15, STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ModuleInfo_35);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          *Inst_8 = base;
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((MaybeOldMaybeInst_24 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_3_41, InstName_21, &SubInst0_49);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_3_41, SubInst0_49, &SubInst1_29);
              check_hlds__inst_util__make_mostly_uniq_inst_5_p_0(Type_6, SubInst1_29, &MostlyUniqInst_27, STATE_VARIABLE_ModuleInfo_3_41, &STATE_VARIABLE_ModuleInfo_4_42);
