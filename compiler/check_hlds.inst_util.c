...
MR_decl_label3(check_hlds__inst_util__allow_unify_with_clobbered_3_0, 3,20,2)
...
MR_decl_label3(check_hlds__inst_util__make_mostly_uniq_bound_inst_list_4_0, 4,5,3)
...
MR_decl_label3(check_hlds__inst_util__make_mostly_uniq_inst_list_4_0, 4,5,3)
MR_decl_label3(check_hlds__inst_util__make_shared_bound_inst_list_4_0, 4,5,3)
...
MR_decl_label3(check_hlds__inst_util__make_shared_inst_list_4_0, 4,5,3)
MR_decl_label5(check_hlds__inst_util__maybe_make_shared_inst_list_5_0, 3,11,10,12,8)
MR_decl_label3(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0, 11,4,3)
MR_decl_label3(check_hlds__inst_util__merge_inst_list_uniq_6_0, 11,4,3)
...
MR_decl_label8(check_hlds__inst_util__unify_uniq_6_0, 3,8,10,13,185,17,19,22)
MR_decl_label8(check_hlds__inst_util__unify_uniq_6_0, 24,25,190,29,191,32,34,37)
MR_decl_label8(check_hlds__inst_util__unify_uniq_6_0, 40,87,42,43,45,48,51,53)
MR_decl_label8(check_hlds__inst_util__unify_uniq_6_0, 56,59,61,64,184,68,70,72)
MR_decl_label3(check_hlds__inst_util__unify_uniq_6_0, 2,188,1)
...
MR_BEGIN_MODULE(check_hlds__inst_util_module1)
	...
	MR_init_label3(check_hlds__inst_util__allow_unify_with_clobbered_3_0,3,20,2)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__allow_unify_with_clobbered_3_0)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__allow_unify_with_clobbered_3_0_i3);
	}
	MR_incr_sp(1);
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__allow_unify_with_clobbered_3_0_i2);
MR_def_label(check_hlds__inst_util__allow_unify_with_clobbered_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__allow_unify_with_clobbered_3_0_i20);
	}
	MR_r1 = ((MR_Integer) MR_r3 == (MR_Integer) 0);
	MR_proceed();
MR_def_label(check_hlds__inst_util__allow_unify_with_clobbered_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
MR_def_label(check_hlds__inst_util__allow_unify_with_clobbered_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
...
MR_BEGIN_MODULE(check_hlds__inst_util_module2)
	...
	MR_init_label8(check_hlds__inst_util__unify_uniq_6_0,3,8,10,13,185,17,19,22)
	MR_init_label8(check_hlds__inst_util__unify_uniq_6_0,24,25,190,29,191,32,34,37)
	MR_init_label8(check_hlds__inst_util__unify_uniq_6_0,40,87,42,43,45,48,51,53)
	MR_init_label8(check_hlds__inst_util__unify_uniq_6_0,56,59,61,64,184,68,70,72)
	MR_init_label3(check_hlds__inst_util__unify_uniq_6_0,2,188,1)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,3)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r5,
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i87) MR_AND
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i87) MR_AND
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i87) MR_AND
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i8) MR_AND
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i185));
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i10);
	}
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_string_const("inst_util", 9);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i13);
	}
	MR_r2 = (MR_Integer) 3;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i188);
	}
	MR_r2 = (MR_Integer) 3;
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,19)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r5,
		...
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i190) MR_AND
		MR_LABEL_AP(check_hlds__inst_util__unify_uniq_6_0_i191));
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,25)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,190)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(check_hlds__inst_util__allow_unify_with_clobbered_3_0,
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,29)
	...
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(1);
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,191)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(check_hlds__inst_util__allow_unify_with_clobbered_3_0,
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 0;
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i45);
	}
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_string_const("inst_util", 9);
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__unify_uniq_6_0_i2);
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,1)) {
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i53);
	}
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_string_const("inst_util", 9);
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__unify_uniq_6_0_i2);
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i56);
	}
	MR_r2 = (MR_Integer) 4;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i188);
	}
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i61);
	}
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_string_const("inst_util", 9);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i64);
	}
	MR_r2 = (MR_Integer) 3;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i188);
	}
...
MR_BEGIN_MODULE(check_hlds__inst_util_module3)
	...
	MR_init_label3(check_hlds__inst_util__make_shared_inst_list_4_0,4,5,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__check_hlds__inst_util__make_shared_inst_list_4_0);
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_shared_inst_list_4_0_i3);
	}
	MR_incr_sp(2);
...
MR_def_label(check_hlds__inst_util__make_shared_inst_list_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__inst_util__make_shared_inst_4_0,110)
	...
	MR_tempr2 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_0, MR_tempr1);
...
MR_BEGIN_MODULE(check_hlds__inst_util_module5)
	...
	MR_init_label3(check_hlds__inst_util__make_shared_bound_inst_list_4_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__make_shared_bound_inst_list_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_shared_bound_inst_list_4_0_i3);
	}
	MR_incr_sp(3);
...
MR_def_label(check_hlds__inst_util__make_shared_bound_inst_list_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(check_hlds__inst_util__abstractly_unify_bound_inst_list_lives_9_0,3)
	...
	MR_r7 = MR_ctfield(1, MR_tempr2, 1);
	MR_tempr7 = MR_r2;
	MR_r8 = MR_ctfield(1, MR_tempr7, 1);
	if ((MR_r7 != MR_r8)) {
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,111)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_ctfield(3, MR_r1, 1);
	MR_tempr2 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, MR_tempr1);
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_sv(1) = MR_ctfield(0, MR_tempr2, 0);
	}
...
MR_BEGIN_MODULE(check_hlds__inst_util_module27)
	...
	MR_init_label3(check_hlds__inst_util__make_mostly_uniq_bound_inst_list_4_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__make_mostly_uniq_bound_inst_list_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_mostly_uniq_bound_inst_list_4_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_bound_inst_list_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__inst_util_module28)
	...
	MR_init_label3(check_hlds__inst_util__make_mostly_uniq_inst_list_4_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__make_mostly_uniq_inst_list_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_mostly_uniq_inst_list_4_0_i3);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_list_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__inst_util_module33)
	...
	MR_init_label3(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(check_hlds__inst_util__merge_bound_inst_list_uniq_6_0_i11);
...
MR_BEGIN_MODULE(check_hlds__inst_util_module34)
	...
	MR_init_label3(check_hlds__inst_util__merge_inst_list_uniq_6_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__merge_inst_list_uniq_6_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(check_hlds__inst_util__merge_inst_list_uniq_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(check_hlds__inst_util__merge_inst_list_uniq_6_0,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(check_hlds__inst_util__merge_inst_list_uniq_6_0_i11);
...
void mercury__check_hlds__inst_util__write_out_proc_statics(FILE *fp);
#endif
