          ...
          case (MR_Integer) 4:
            {
              ...
              else
              {
                ...
                next_value_of_STATE_VARIABLE_Expansions_0_29 = STATE_VARIABLE_Expansions_30_40;
                Inst_6 = next_value_of_Inst_6;
          ...
          case (MR_Integer) 4:
            {
              ...
              else
              {
                ...
                /* direct tailcall eliminated */
                next_value_of_InstA_7 = Inst_22;
                next_value_of_STATE_VARIABLE_Expansions_0_26 = STATE_VARIABLE_Expansions_32_32;
                InstA_7 = next_value_of_InstA_7;
  ...
  MR_Word * Uniq_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_HeadVar__2_2 = Uniq1_18;
  ...
  MR_Word * Uniq_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_HeadVar__2_2 = Uniq1_20;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          next_value_of_HeadVar__2_2 = ConsArgs_8;
          HeadVar__1_1 = next_value_of_HeadVar__1_1;
          HeadVar__2_2 = next_value_of_HeadVar__2_2;
          continue;
        }
