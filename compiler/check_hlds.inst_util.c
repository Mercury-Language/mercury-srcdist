  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &Var_21, VarSet0_20, &_VarSet_22);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (Var_21));
        ...
        case (MR_Integer) 4:
          {
            ...
            if ((MaybeMaybeInst_25 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              hlds__hlds_inst_mode__inst_table_get_shared_insts_2_p_0(InstTable2_30, &SharedInstTable2_31);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (SharedInst_28));
              }
        ...
        case (MR_Integer) 4:
          {
            ...
            if ((MaybeMaybeInst_25 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              hlds__hlds_inst_mode__inst_table_get_mostly_uniq_insts_2_p_0(InstTable2_31, &MostlyUniqInstTable2_32);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (MostlyUniqInst_28));
              }
