  ...
  MR_Word * Types_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__17_17 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
      mercury__list__length_2_p_0(TypeCtorInfo__17_17, ArgTypes_15, &Var_19);
