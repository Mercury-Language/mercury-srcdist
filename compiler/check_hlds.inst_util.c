  ...
  top_of_proc_1:;
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            {
              Inst_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Inst_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
          ...
          if (succeeded)
          {
            ...
            SubInstB_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstB_8, (MR_Integer) 2)));
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  {
                    Inst_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Inst_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
