...
MR_decl_label10(check_hlds__inst_util__make_any_inst_8_0, 3,6,7,5,11,12,14,17,10,77)
...
MR_decl_label10(check_hlds__inst_util__make_any_inst_8_0, 22,54,53,57,63,64,62,201,68,1)
...
MR_decl_label10(check_hlds__inst_util__make_ground_inst_8_0, 3,6,5,10,12,15,9,74,16,21)
...
MR_decl_label8(check_hlds__inst_util__make_ground_inst_8_0, 51,56,55,61,60,204,65,1)
...
MR_decl_label10(check_hlds__inst_util__make_mostly_uniq_inst_4_0, 52,53,56,54,32,59,63,65,121,67)
MR_decl_label4(check_hlds__inst_util__make_mostly_uniq_inst_4_0, 61,72,73,241)
...
MR_decl_label8(check_hlds__inst_util__make_shared_inst_4_0, 32,61,63,59,70,71,73,75)
...
MR_decl_label10(check_hlds__inst_util__merge_inst_uniq_6_0, 67,3,5,8,7,10,14,13,16,17)
MR_decl_label6(check_hlds__inst_util__merge_inst_uniq_6_0, 12,20,21,23,22,24)
...
MR_decl_label10(check_hlds__inst_util__unify_uniq_6_0, 6,3,12,14,116,16,11,27,24,35)
MR_decl_label10(check_hlds__inst_util__unify_uniq_6_0, 32,40,43,22,51,257,48,57,56,59)
MR_decl_label10(check_hlds__inst_util__unify_uniq_6_0, 100,46,63,62,66,65,68,107,71,258)
...
MR_BEGIN_MODULE(check_hlds__inst_util_module2)
	...
	MR_init_label10(check_hlds__inst_util__unify_uniq_6_0,6,3,12,14,116,16,11,27,24,35)
	MR_init_label10(check_hlds__inst_util__unify_uniq_6_0,32,40,43,22,51,257,48,57,56,59)
	MR_init_label10(check_hlds__inst_util__unify_uniq_6_0,100,46,63,62,66,65,68,107,71,258)
...
MR_def_static(check_hlds__inst_util__unify_uniq_6_0)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i257);
	}
	if (MR_INT_EQ(MR_r2,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i6);
	}
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i258);
	}
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,14)
	...
	if (MR_INT_EQ(MR_r3,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i116);
	}
	if (MR_INT_NE(MR_r4,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i1);
	}
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(1);
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,16)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__unify_uniq_6_0_i116);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,32)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i100);
	}
	MR_r2 = (MR_Integer) 2;
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i107);
	}
	MR_r2 = (MR_Integer) 2;
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,51)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,257)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_string_const("inst_util", 9);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,48)
	...
	MR_np_call_localret_ent(check_hlds__inst_util__allow_unify_with_clobbered_3_0,
		check_hlds__inst_util__unify_uniq_6_0_i57);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 0;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,46)
	...
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(check_hlds__inst_util__allow_unify_with_clobbered_3_0,
		check_hlds__inst_util__unify_uniq_6_0_i63);
...
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r5,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__unify_uniq_6_0_i71);
	}
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 0;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,71)
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__unify_uniq_6_0,258)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(check_hlds__inst_util_module4)
	...
	MR_init_label8(check_hlds__inst_util__make_shared_inst_4_0,32,61,63,59,70,71,73,75)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__inst_util_module14)
	...
	MR_init_label10(check_hlds__inst_util__make_ground_inst_8_0,3,6,5,10,12,15,9,74,16,21)
	...
	MR_init_label8(check_hlds__inst_util__make_ground_inst_8_0,51,56,55,61,60,204,65,1)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_util__make_ground_inst_8_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(10);
...
MR_def_label(check_hlds__inst_util__make_ground_inst_8_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_ground_inst_8_0_i204);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 1);
	MR_r3 = (MR_Integer) 6;
	MR_r4 = MR_r5;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__make_ground_inst_8_0,204)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
...
MR_def_label(check_hlds__inst_util__make_ground_inst_8_0,65)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__make_ground_inst_8_0_i74);
...
MR_BEGIN_MODULE(check_hlds__inst_util_module16)
	...
	MR_init_label10(check_hlds__inst_util__make_any_inst_8_0,3,6,7,5,11,12,14,17,10,77)
	...
	MR_init_label10(check_hlds__inst_util__make_any_inst_8_0,22,54,53,57,63,64,62,201,68,1)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_util__make_any_inst_8_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(10);
...
MR_def_label(check_hlds__inst_util__make_any_inst_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_any_inst_8_0_i201);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 1);
	MR_r3 = (MR_Integer) 6;
	MR_r4 = MR_r5;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__inst_util__make_any_inst_8_0,201)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__check_hlds__inst_util__this_file_0_0,
...
MR_def_label(check_hlds__inst_util__make_any_inst_8_0,68)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__inst_util__make_any_inst_8_0_i77);
...
MR_BEGIN_MODULE(check_hlds__inst_util_module26)
	...
	MR_init_label10(check_hlds__inst_util__make_mostly_uniq_inst_4_0,52,53,56,54,32,59,63,65,121,67)
	MR_init_label4(check_hlds__inst_util__make_mostly_uniq_inst_4_0,61,72,73,241)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,59)
	...
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_mostly_uniq_inst_4_0_i241);
	}
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,121)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__make_mostly_uniq_inst_4_0_i121);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,73)
	...
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__inst_util__make_mostly_uniq_inst_4_0,241)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__inst_util_module36)
	...
	MR_init_label10(check_hlds__inst_util__merge_inst_uniq_6_0,67,3,5,8,7,10,14,13,16,17)
	MR_init_label6(check_hlds__inst_util__merge_inst_uniq_6_0,12,20,21,23,22,24)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_util__merge_inst_uniq_6_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
...
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i5);
	}
	MR_sv(3) = MR_r4;
...
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i7);
	}
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	MR_sv(1) = MR_tfield(3, MR_r1, 2);
...
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i10);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i67);
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i12);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(check_hlds__inst_util__merge_inst_uniq_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(check_hlds__inst_util__merge_inst_uniq_6_0_i22);
	}
	MR_sv(3) = MR_r4;
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(check_hlds__inst_util__merge_uniq_3_0,
