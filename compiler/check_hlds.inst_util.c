...
check_hlds__inst_util__IntroducedFrom__func__maybe_get_higher_order_arg_types__390__1_1_f_0(
  MR_Word LambdaHeadVar__1_14);

static MR_Word MR_CALL 
check_hlds__inst_util__IntroducedFrom__func__maybe_get_cons_id_arg_types__377__1_1_f_0(
...
static /* final */ const MR_Box check_hlds__inst_util_scalar_common_1[1][2];

static /* final */ const MR_Box check_hlds__inst_util_scalar_common_3[1][5];

static /* final */ const MR_Box check_hlds__inst_util_scalar_common_4[2][3];
...
static /* final */ const MR_Box check_hlds__inst_util_scalar_common_4[2][3] = {
  /* row 0 */
  {
    ((MR_Box) (&check_hlds__inst_util_scalar_common_3[0])),
...
{
  {
    ...
    conv0_LambdaHeadVar__2_15 = check_hlds__inst_util__IntroducedFrom__func__maybe_get_higher_order_arg_types__390__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    if (succeeded)
      *MaybeTypes_6 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&check_hlds__inst_util_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_util_scalar_common_4[1]), ArgTypes_11);
    else
...
{
  {
    ...
    conv0_LambdaHeadVar__2_20 = check_hlds__inst_util__IntroducedFrom__func__maybe_get_cons_id_arg_types__377__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        *MaybeTypes_10 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&check_hlds__inst_util_scalar_common_1[0]), (MR_Word) (&check_hlds__inst_util_scalar_common_4[0]), Types_16);
      else
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Uniq_49 = ((&check_hlds__inst_util_vector_common_2[5 + Uniq0_48]))->check_hlds__inst_util__vector_common_type_2_0__vct_2_f_0;
          ...
          case (MR_Integer) 1:
            {
              MR_Word PredInst_15 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst0_5, (MR_Integer) 2))));
              MR_Word Uniq0_50 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst0_5, (MR_Integer) 1))) & (MR_Integer) 7);
              MR_Word Uniq_51 = ((&check_hlds__inst_util_vector_common_2[10 + Uniq0_50]))->check_hlds__inst_util__vector_common_type_2_0__vct_2_f_0;
