  ...
  MR_Word * Types_6)
{
  ...
  else
  {
    ...
    mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &VarSet0_13);
    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), &Var_14, VarSet0_13, &_VarSet_15);
    {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  switch (MR_tag((MR_Word) Inst0_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word PredInst_15 = ((MR_Word) ((MR_hl_field(1, Inst0_5, (MR_Integer) 1))));
        MR_Word Uniq0_52 = ((MR_Unsigned) ((MR_hl_field(1, Inst0_5, (MR_Integer) 0))) & (MR_Integer) 7);
...

        {
          ...
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Inst_6 = base;
          MR_hl_field(1, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_53));
          MR_hl_field(1, base, 1) = ((MR_Box) (PredInst_15));
        }
        *STATE_VARIABLE_ModuleInfo_35 = STATE_VARIABLE_ModuleInfo_0_34;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        MR_Word Uniq0_50 = ((MR_Unsigned) ((MR_hl_field(2, Inst0_5, (MR_Integer) 0))) & (MR_Integer) 7);
        ...
        check_hlds__inst_util__make_shared_bound_inst_list_4_p_0(BoundInsts0_13, &BoundInsts_14, STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ModuleInfo_35);
        {
          ...
          *Inst_6 = base;
          MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_51));
          MR_hl_field(2, base, 1) = ((MR_Box) (InstResults0_12));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Inst0_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word InstName_22 = ((MR_Word) ((MR_hl_field(3, Inst0_5, (MR_Integer) 1))));
            ...
            if ((MaybeMaybeInst_25 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              hlds__hlds_module__module_info_set_inst_table_3_p_0(InstTable1_29, STATE_VARIABLE_ModuleInfo_0_34, &STATE_VARIABLE_ModuleInfo_46_46);
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_46_46, InstName_22, &SubInst0_54);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_46_46, SubInst0_54, &SubInst1_55);
              check_hlds__inst_util__make_shared_inst_4_p_0(SubInst1_55, &SharedInst_28, STATE_VARIABLE_ModuleInfo_46_46, &STATE_VARIABLE_ModuleInfo_47_47);
              hlds__hlds_module__module_info_get_inst_table_2_p_0(STATE_VARIABLE_ModuleInfo_47_47, &InstTable2_30);
              hlds__hlds_inst_mode__inst_table_get_shared_insts_2_p_0(InstTable2_30, &SharedInstTable2_31);
              {
                ...
                MR_hl_field(1, Var_48, 0) = ((MR_Box) (SharedInst_28));
              }
              hlds__hlds_inst_mode__det_update_shared_inst_4_p_0(InstName_22, Var_48, SharedInstTable2_31, &SharedInstTable_32);
              hlds__hlds_inst_mode__inst_table_set_shared_insts_3_p_0(SharedInstTable_32, InstTable2_30, &InstTable_33);
              hlds__hlds_module__module_info_set_inst_table_3_p_0(InstTable_33, STATE_VARIABLE_ModuleInfo_47_47, STATE_VARIABLE_ModuleInfo_35);
            }
            else
            {
              MR_Word MaybeInst_27 = ((MR_Word) ((MR_hl_field(1, MaybeMaybeInst_25, (MR_Integer) 0))));

              if ((MaybeInst_27 == (MR_Word) ((MR_Unsigned) 0U)))
                SharedInst_28 = Inst0_5;
              else
                SharedInst_28 = ((MR_Word) ((MR_hl_field(1, MaybeInst_27, (MR_Integer) 0))));
              *STATE_VARIABLE_ModuleInfo_35 = STATE_VARIABLE_ModuleInfo_0_34;
            }
        ...
        case (MR_Integer) 1:
          {
            MR_Word InstVars_17 = ((MR_Word) ((MR_hl_field(3, Inst0_5, (MR_Integer) 1))));
            MR_Word SubInst0_18 = ((MR_Word) ((MR_hl_field(3, Inst0_5, (MR_Integer) 2))));
            MR_Word SubInst1_19;
            ...
            if (succeeded)
              {
                ...
                *Inst_6 = base;
                ...
                MR_hl_field(3, base, 2) = ((MR_Box) (SubInst1_19));
              }
            else
              *Inst_6 = SubInst1_19;
          }
        ...
        case (MR_Integer) 2:
          {
            MR_Word Uniq0_9 = ((MR_Unsigned) ((MR_hl_field(3, Inst0_5, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word HOInstInfo_10 = ((MR_Word) ((MR_hl_field(3, Inst0_5, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_36)
{
  ...
  switch (MR_tag((MR_Word) Inst0_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word PredInst_15 = ((MR_Word) ((MR_hl_field(1, Inst0_5, (MR_Integer) 1))));
        MR_Word Uniq0_50 = ((MR_Unsigned) ((MR_hl_field(1, Inst0_5, (MR_Integer) 0))) & (MR_Integer) 7);
...

        {
          ...
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Inst_6 = base;
          MR_hl_field(1, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_51));
          MR_hl_field(1, base, 1) = ((MR_Box) (PredInst_15));
        }
        *STATE_VARIABLE_ModuleInfo_36 = STATE_VARIABLE_ModuleInfo_0_35;
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word BoundInsts0_13 = ((MR_Word) ((MR_hl_field(2, Inst0_5, (MR_Integer) 2))));
        MR_Word BoundInsts_14;
        MR_Word Uniq0_48 = ((MR_Unsigned) ((MR_hl_field(2, Inst0_5, (MR_Integer) 0))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((MaybeMaybeInst_25 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              hlds__hlds_module__module_info_set_inst_table_3_p_0(InstTable1_29, STATE_VARIABLE_ModuleInfo_0_35, &STATE_VARIABLE_ModuleInfo_44_44);
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_44_44, InstName_22, &SubInst0_52);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_44_44, SubInst0_52, &SubInst1_30);
              check_hlds__inst_util__make_mostly_uniq_inst_4_p_0(SubInst1_30, &MostlyUniqInst_28, STATE_VARIABLE_ModuleInfo_44_44, &STATE_VARIABLE_ModuleInfo_45_45);
              hlds__hlds_module__module_info_get_inst_table_2_p_0(STATE_VARIABLE_ModuleInfo_45_45, &InstTable2_31);
              hlds__hlds_inst_mode__inst_table_get_mostly_uniq_insts_2_p_0(InstTable2_31, &MostlyUniqInstTable2_32);
              {
                ...
                MR_hl_field(1, Var_46, 0) = ((MR_Box) (MostlyUniqInst_28));
              }
              hlds__hlds_inst_mode__det_update_mostly_uniq_inst_4_p_0(InstName_22, Var_46, MostlyUniqInstTable2_32, &MostlyUniqInstTable_33);
              hlds__hlds_inst_mode__inst_table_set_mostly_uniq_insts_3_p_0(MostlyUniqInstTable_33, InstTable2_31, &InstTable_34);
              hlds__hlds_module__module_info_set_inst_table_3_p_0(InstTable_34, STATE_VARIABLE_ModuleInfo_45_45, STATE_VARIABLE_ModuleInfo_36);
            }
            else
            {
              MR_Word MaybeInst_27 = ((MR_Word) ((MR_hl_field(1, MaybeMaybeInst_25, (MR_Integer) 0))));
              ...
              if ((MaybeInst_27 == (MR_Word) ((MR_Unsigned) 0U)))
                ...
                MostlyUniqInst_28 = ((MR_Word) ((MR_hl_field(1, MaybeInst_27, (MR_Integer) 0))));
              *STATE_VARIABLE_ModuleInfo_36 = STATE_VARIABLE_ModuleInfo_0_35;
            }
            ...
            if (succeeded)
              {
                ...
                *Inst_6 = base;
                MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(3, base, 1) = ((MR_Box) (InstVars_17));
                MR_hl_field(3, base, 2) = ((MR_Box) (SubInst_19));
              }
            else
              *Inst_6 = SubInst_19;
          }
