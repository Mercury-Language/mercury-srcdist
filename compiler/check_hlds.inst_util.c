...
check_hlds__inst_util__get_cons_id_arg_types_for_bound_functor_4_p_0(
  ...
  MR_Word * ArgTypes_8)
{
  MR_Word ConsId_9 = ((MR_Word) ((MR_hl_field(0, BoundFunctor_7, (MR_Integer) 0))));
  MR_Word ArgInsts_10 = ((MR_Word) ((MR_hl_field(0, BoundFunctor_7, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  {
    MR_Word BoundFunctor0_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
    MR_Word BoundFunctors0_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
    MR_Word BoundFunctor_13;
    MR_Word BoundFunctors_14;
    MR_Word ConsId_16 = ((MR_Word) ((MR_hl_field(0, BoundFunctor0_11, (MR_Integer) 0))));
    MR_Word ArgInsts0_17 = ((MR_Word) ((MR_hl_field(0, BoundFunctor0_11, (MR_Integer) 1))));
    MR_Word ArgTypes_18;
    MR_Word ArgInsts_19;
    ...
    check_hlds__inst_util__make_shared_bound_functors_5_p_0(Type_1, BoundFunctors0_12, &BoundFunctors_14, STATE_VARIABLE_ModuleInfo_22_22, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BoundFunctors0_14 = ((MR_Word) ((MR_hl_field(2, Inst0_7, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  ...
  else
  {
    ...
    check_hlds__inst_util__make_mostly_uniq_bound_functors_5_p_0(Type_1, BoundFunctors0_12, &BoundFunctors_14, STATE_VARIABLE_ModuleInfo_22_22, STATE_VARIABLE_ModuleInfo_5);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
