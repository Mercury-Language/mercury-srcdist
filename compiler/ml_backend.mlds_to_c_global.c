...
ml_backend__mlds_to_c_global__IntroducedFrom__pred__mlds_output_scalar_cell_group_struct_field__223__1_2_p_0(
  ...
  MR_Word HeadVar__5_5)
{
  ...
  QualFuncNameStr_20 = ml_backend__mlds_to_c_name__fully_qualified_function_name_to_string_for_c_1_f_0(QualFuncName_19);
  ...
  mercury__io__write_string_4_p_0(Stream_9, IndentStr_24);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "{ ");
  mercury__io__write_string_4_p_0(Stream_9, QualFuncNameStr_20);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
  mercury__io__write_string_4_p_0(Stream_9, FileName_22);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), LineNumber_23, &Var_52);
  mercury__io__write_string_4_p_0(Stream_9, Var_52);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
  mercury__io__write_string_4_p_0(Stream_9, TypeStr_21);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), Size_18, &Var_65);
  mercury__io__write_string_4_p_0(Stream_9, Var_65);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) " },\n");
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_global__IntroducedFrom__pred__mlds_output_scalar_cell_group_struct_field__223__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__6_6 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      QualGlobalVarNameStr_83 = ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(ModuleName_5, GlobalVarName_28);
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      QualGlobalVarNameStr_71 = ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(ModuleName_4, GlobalVarName_26);
...
ml_backend__mlds_to_c_global__scalar_cell_group_type_and_name_to_string_for_c_6_f_0(
  ...
  MR_Integer NumRows_13)
{
  MR_bool succeeded = ((((MR_tag((MR_Word) Type_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_11, (MR_Integer) 0)))) == (MR_Integer) 6)));
  MR_String Str_14;
