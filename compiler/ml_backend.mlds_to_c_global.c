...
ml_backend__mlds_to_c_global__mlds_output_cell_8_p_0(
  ...
  MR_Integer STATE_VARIABLE_RowNum_0_17,
  MR_Integer * STATE_VARIABLE_RowNum_18);
...
{
  {
    ...
    mercury__io__write_int_4_p_0(Stream_10, STATE_VARIABLE_RowNum_0_17);
    mercury__io__write_string_4_p_0(Stream_10, (MR_String) " */");
    succeeded = ((MR_tag((MR_Word) Initializer_12)) == (MR_Integer) 2);
    if (succeeded)
    {
      Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Initializer_12, (MR_Integer) 1))));
    ...
    *STATE_VARIABLE_RowNum_18 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_RowNum_0_17 + (MR_Unsigned) 1);
  ...
  MR_Box * wrapper_arg_5)
{
  {
    MR_Box closure = closure_arg;
    MR_Integer conv0_STATE_VARIABLE_RowNum_18;

    ml_backend__mlds_to_c_global__mlds_output_cell_8_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv0_STATE_VARIABLE_RowNum_18);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_RowNum_18));
  }
}
