  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Type_28)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_28, (MR_Integer) 0)))) == (MR_Integer) 8)));
      if (succeeded)
      {
...
ml_backend__mlds_to_c_global__scalar_cell_group_type_and_name_to_string_for_c_6_f_0(
  ...
  MR_Integer NumRows_13)
{
  MR_bool succeeded = ((((MR_tag((MR_Word) Type_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_11, (MR_Integer) 0)))) == (MR_Integer) 8)));
  MR_String Str_14;
