...
{
  {
    ...
    *STATE_VARIABLE_RowNum_16 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_RowNum_0_15 + (MR_Unsigned) 1);
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) " = {\n");
    Var_44 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) 1);
    {
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) " = {\n");
      Var_49 = (MR_Integer) ((MR_Unsigned) HeadVar__2_2 + (MR_Unsigned) 1);
      {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (succeeded)
      {
        ElemTypes_37 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_32, (MR_Integer) 1))));
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) " {\n");
          Var_67 = (MR_Integer) ((MR_Unsigned) HeadVar__2_2 + (MR_Unsigned) 1);
          {
