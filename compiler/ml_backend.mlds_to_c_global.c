  ...
  MR_Word HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__6_6 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), TypeRawNum_38, &Var_70);
      mercury__io__write_string_4_p_0(Stream_2, Var_70);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "[");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), NumRows_44, &Var_80);
      mercury__io__write_string_4_p_0(Stream_2, Var_80);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "]");
