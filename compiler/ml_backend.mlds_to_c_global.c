...
{
  {
    ...
    *HeadVar__5_5 = (MR_Integer) ((MR_Unsigned) Num_11 + (MR_Unsigned) (MR_Integer) 1);
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
    if ((FieldType_10 == (MR_Word) ((MR_Integer) 16)))
    {
    ...
    if (((((MR_tag((MR_Word) FieldType_10)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), FieldType_10, (MR_Integer) 0))) == (MR_Integer) 0))))
    {
      ...
      if (succeeded)
      {
        ...
        if ((BuiltinType_14 == (MR_Word) ((MR_Integer) 0)))
        {
          TypeName_13 = (MR_String) "MR_Float_Aligned";
          succeeded = MR_TRUE;
        }
...
{
  if (!((AllocSites_10 == (MR_Word) ((MR_Integer) 0))))
  {
...
{
  if (!((AllocSites_6 == (MR_Word) ((MR_Integer) 0))))
  {
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "]");
    ml_backend__mlds_to_c_type__mlds_output_type_suffix_5_p_0(Opts_7, Type_14, (MR_Word) ((MR_Integer) 0));
    mercury__io__write_string_3_p_0((MR_String) " = {\n");
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Integer) 0))))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "]");
      ml_backend__mlds_to_c_type__mlds_output_type_suffix_5_p_0(HeadVar__1_1, Type_36, (MR_Word) ((MR_Integer) 0));
      mercury__io__write_string_3_p_0((MR_String) ";\n");
      // direct tailcall eliminated
      ;
