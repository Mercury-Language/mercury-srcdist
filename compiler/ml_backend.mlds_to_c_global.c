...
{
  {
    ...
    *HeadVar__5_5 = (MR_Integer) ((MR_Unsigned) Num_11 + (MR_Unsigned) (MR_Integer) 1);
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
    if ((FieldType_10 == (MR_Word) ((MR_Unsigned) 16U)))
    {
      TypeName_13 = (MR_String) "MR_Float_Aligned";
      succeeded = MR_TRUE;
    }
    else
    if (((((MR_tag((MR_Word) FieldType_10)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), FieldType_10, (MR_Integer) 0))) == (MR_Integer) 0))))
    {
      ...
      if (succeeded)
      {
        ...
        if ((BuiltinType_14 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          TypeName_13 = (MR_String) "MR_Float_Aligned";
          succeeded = MR_TRUE;
        }
        else
        if (((MR_tag((MR_Word) BuiltinType_14)) == (MR_Integer) 1))
        {
          MR_Word Var_31 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_14, (MR_Integer) 0))) & (MR_Integer) 15);
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_14, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Access_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    MR_Word ShouldModuleQual_22;
    MR_Word Var_29;
    MR_Word Var_34;
    MR_Word Access_60;
    MR_Word Constness_61;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0)));
    ...
    Var_29 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
    ml_backend__mlds_to_c_util__c_output_context_4_p_0(Var_29, Context_15);
    ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_9);
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0)));
    Access_60 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    Constness_61 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_60) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    MR_Word Var_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> (MR_Integer) 16)) & (MR_Integer) 1);
    MR_Word Var_25;
    MR_Word Access_48;
    ...
    Access_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    Constness_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_48) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Type_32)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_32, (MR_Integer) 0))) == (MR_Integer) 5)));
      if (succeeded)
      {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) Type_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_12, (MR_Integer) 0))) == (MR_Integer) 5)));
    MR_String Var_56;
    MR_String Var_66;
    ...
    mercury__io__write_string_3_p_0((MR_String) "]");
    succeeded = ((((MR_tag((MR_Word) Type_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_12, (MR_Integer) 0))) == (MR_Integer) 5)));
    if (succeeded)
    {
    }
    if (!(succeeded))
