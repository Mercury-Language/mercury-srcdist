  ...
  MR_Word GlobalVarDefn_14)
{
  ...
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_10, Indent_11);
  Access_62 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
  Constness_63 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0))) & (MR_Integer) 1);
  switch (Access_62) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  MR_Word GlobalVarDefn_12)
{
  ...
  Constness_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
  switch (Access_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  MR_Word HeadVar__5_5)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), TypeRawNum_15, &Var_63);
  mercury__io__write_string_4_p_0(Stream_9, Var_63);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "[");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), NumRows_22, &Var_73);
  ...
  MR_Word HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__6_6 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word TypeNum_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_22, (MR_Integer) 0))));
      MR_Word CellGroup_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_22, (MR_Integer) 1))));
      MR_Integer TypeRawNum_38 = (MR_Integer) (TypeNum_35);
      MR_Word Type_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_36, (MR_Integer) 0))));
      MR_Word ClassDefn_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_36, (MR_Integer) 1))));
      MR_Word Rows_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_36, (MR_Integer) 4))));
      MR_Integer NumRows_44;
      MR_String Var_69;
      MR_String Var_79;
      MR_Word next_value_of_HeadVar__6_6;

      ml_backend__mlds_to_c_class__mlds_output_class_defn_7_p_0(Opts_1, Stream_2, Indent_3, ModuleName_4, ClassDefn_40);
      ...
      ml_backend__mlds_to_c_type__mlds_output_type_prefix_5_p_0(Opts_1, Stream_2, Type_39);
      NumRows_44 = mercury__cord__length_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), Rows_43);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) " ");
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), TypeRawNum_38, &Var_69);
      mercury__io__write_string_4_p_0(Stream_2, Var_69);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "[");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), NumRows_44, &Var_79);
      mercury__io__write_string_4_p_0(Stream_2, Var_79);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "]");
      ml_backend__mlds_to_c_type__mlds_output_type_suffix_6_p_0(Opts_1, Stream_2, Type_39, (MR_Word) ((MR_Unsigned) 0U));
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) ";\n");
      // direct tailcall eliminated
      ;
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word CellGroup_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 0))));
      MR_Word CellGroups_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 1))));
      MR_Word TypeNum_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_19, (MR_Integer) 0))));
      MR_Word CellGroup_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_19, (MR_Integer) 1))));
      MR_Integer TypeRawNum_34 = (MR_Integer) (TypeNum_31);
      MR_Word Type_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_32, (MR_Integer) 0))));
      MR_Word InitArraySize_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_32, (MR_Integer) 1))));
      MR_Word RowCords_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CellGroup_32, (MR_Integer) 4))));
      MR_Word Rows_40;
      MR_Integer NumRows_41;
      MR_Word Var_49;
      MR_Integer Var_52;
      MR_Box conv2_Var_42;
      MR_Box conv1_STATE_VARIABLE_IO_34_51;
      MR_Word next_value_of_HeadVar__5_5;

      Rows_40 = mercury__cord__list_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), RowCords_39);
      mercury__list__length_2_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), Rows_40, &NumRows_41);
      ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_2, Indent_3);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "\nstatic /* final */ const ");
      ml_backend__mlds_to_c_global__mlds_output_scalar_cell_group_type_and_name_9_p_0(Opts_1, Stream_2, MangledModuleName_4, TypeRawNum_34, Type_35, InitArraySize_36, NumRows_41);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) " = {\n");
      Var_52 = (MR_Integer) ((MR_Unsigned) Indent_3 + (MR_Unsigned) 1);
      {
        Var_49 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&ml_backend__mlds_to_c_global_scalar_common_3[1]));
        MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (ml_backend__mlds_to_c_global__mlds_output_scalar_cell_group_defns_7_p_0_1));
        MR_hl_field(MR_mktag(0), Var_49, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_49, 3) = ((MR_Box) (Opts_1));
        MR_hl_field(MR_mktag(0), Var_49, 4) = ((MR_Box) (Stream_2));
        MR_hl_field(MR_mktag(0), Var_49, 5) = ((MR_Box) (Var_52));
      }
      mercury__list__foldl2_6_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_49, Rows_40, ((MR_Box) ((MR_Integer) 0)), &conv2_Var_42, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_34_51);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "};\n");
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__5_5 = CellGroups_20;
  ...
  MR_Word HeadVar__5_5)
{
  ...
  if (succeeded)
  {
    ElemTypes_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_16, (MR_Integer) 1))));
    {
      ...
      MR_String Var_72;
      MR_Box conv2_Var_41;
      MR_Box conv1_STATE_VARIABLE_IO_29_52;
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_global_scalar_common_2[0]), TypeRawNum_15, &Var_72);
      mercury__io__write_string_4_p_0(Stream_9, Var_72);
      mercury__io__write_string_4_p_0(Stream_9, (MR_String) " {\n");
      Var_53 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
      {
        Var_50 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&ml_backend__mlds_to_c_global_scalar_common_3[0]));
        MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (ml_backend__mlds_to_c_global__mlds_output_scalar_cell_group_decl_7_p_0_1));
        MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (Opts_8));
        MR_hl_field(MR_mktag(0), Var_50, 4) = ((MR_Box) (Stream_9));
        MR_hl_field(MR_mktag(0), Var_50, 5) = ((MR_Box) (Var_53));
      }
      mercury__list__foldl2_6_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_50, ElemTypes_21, ((MR_Box) ((MR_Integer) 1)), &conv2_Var_41, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_29_52);
      ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
      mercury__io__write_string_4_p_0(Stream_9, (MR_String) "};\n");
