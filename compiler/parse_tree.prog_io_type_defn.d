...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_io_type_defn.mh parse_tree.prog_io_type_defn.mih : parse_tree.prog_io_type_defn.s
else
parse_tree.prog_io_type_defn.mh parse_tree.prog_io_type_defn.mih : parse_tree.prog_io_type_defn.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.prog_io_type_defn.module_dep : parse_tree.prog_io_type_defn.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.prog_io_type_defn.module_dep : parse_tree.prog_io_type_defn.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.prog_io_type_defn.module_dep : mercury/parse_tree_/prog_io_type_defn.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_io_type_defn.s_date : prog_io_type_defn.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.prog_io_type_defn $(ERR_REDIRECT)
parse_tree.prog_io_type_defn.pic_s_date : prog_io_type_defn.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.prog_io_type_defn $(ERR_REDIRECT)
endif # TARGET_ASM
