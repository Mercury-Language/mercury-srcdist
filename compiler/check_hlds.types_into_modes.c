  ...
  MR_Word * STATE_VARIABLE_PredInfo_32)
{
  ...
  succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_17, (MR_Integer) 28);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  ...
  else
  {
    ...
    if ((Lang_34 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_46 = ((MR_Word) ((MR_hl_field(0, Clause0_22, 0))));
      Var_48 = ((MR_Word) ((MR_hl_field(0, Clause0_22, 2))));
      Var_49 = ((MR_Word) ((MR_hl_field(0, Clause0_22, 3))));
      Var_50 = ((MR_Word) ((MR_hl_field(0, Clause0_22, 4))));
      Var_51 = ((MR_Word) ((MR_hl_field(0, Clause0_22, 5))));
      {
        Clause_24 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Clause_24, 0) = ((MR_Box) (Var_46));
        MR_hl_field(0, Clause_24, 1) = ((MR_Box) (Goal_39));
        MR_hl_field(0, Clause_24, 2) = ((MR_Box) (Var_48));
        MR_hl_field(0, Clause_24, 3) = ((MR_Box) (Var_49));
        MR_hl_field(0, Clause_24, 4) = ((MR_Box) (Var_50));
        MR_hl_field(0, Clause_24, 5) = ((MR_Box) (Var_51));
      }
    }
    else
    {
  ...
  MR_Word * STATE_VARIABLE_Specs_10)
{
  ...
  else
  {
    ...
    check_hlds__inst_mode_type_prop__propagate_checked_type_into_mode_9_p_0(TPropInfo_1, Context_33, Type_32, Mode0_26, &Mode_28, STATE_VARIABLE_Cache_0_7, &STATE_VARIABLE_Cache_1_40, STATE_VARIABLE_Specs_0_9, &STATE_VARIABLE_Specs_1_41);
    {
  ...
  MR_Word * STATE_VARIABLE_Procs_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_mode_type_prop__propagate_checked_types_into_modes_9_p_0(TPropInfo_51, Var_58, ArgTypes_46, ArgModes0_50, &ArgModes_52, STATE_VARIABLE_Cache_0_6, &STATE_VARIABLE_Cache_1_43, STATE_VARIABLE_Specs_0_8, &STATE_VARIABLE_Specs_1_44);
