    ...
    {
      {
        ...
        check_hlds__inst_match__mode_list_contains_inst_var_2_p_0((env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49, &_InstVar_50, check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_1, env_ptr);
      }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__hlds_pred__proc_info_set_argmodes_3_p_0((env).check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49, ProcInfo0_47, &ProcInfo_51);
