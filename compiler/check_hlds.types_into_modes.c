  ...
  MR_Word * STATE_VARIABLE_PredInfo_32)
{
  ...
  ProcIds_14 = hlds__hlds_pred__pred_info_all_proc_ids_1_f_0(STATE_VARIABLE_PredInfo_0_31);
  ...
  MR_Word * STATE_VARIABLE_Procs_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), STATE_VARIABLE_Procs_0_10, ((MR_Box) (ProcId_28)), &conv0_ProcInfo0_48);
      ProcInfo0_48 = ((MR_Word) (conv0_ProcInfo0_48));
      hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(ProcInfo0_48, &InstVarSet_49);
      hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo0_48, &ArgModes0_50);
      {
      ...
      if ((InstVarsInArgModes_54 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        hlds__hlds_proc__proc_info_set_argmodes_3_p_0(ArgModes_52, ProcInfo0_48, &ProcInfo_57);
        mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_28)), ((MR_Box) (ProcInfo_57)), STATE_VARIABLE_Procs_0_10, &STATE_VARIABLE_Procs_1_45);
