...
top_of_proc_1:;
  {
    ...
    switch (MR_tag((MR_Word) Inst_4)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word InstResults_10 = ((MR_Word) ((MR_hl_field(2, Inst_4, (MR_Integer) 1))));
          MR_Word BoundInsts_11 = ((MR_Word) ((MR_hl_field(2, Inst_4, (MR_Integer) 2))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_4, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word HOInstInfo_18 = ((MR_Word) ((MR_hl_field(3, Inst_4, (MR_Integer) 2))));
