      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word BoundFunctors_10 = ((MR_Word) ((MR_hl_field(2, Inst_4, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_InstVars_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word BoundFunctor_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word BoundFunctors_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word ArgInsts_11 = ((MR_Word) ((MR_hl_field(0, BoundFunctor_7, (MR_Integer) 1))));
