...
struct check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0_s {
  MR_bool check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__succeeded;
  MR_Word check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49;
  jmp_buf check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__commit_0;
};
...
static void MR_CALL 
check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_1(
  void * env_ptr_arg);

static void MR_CALL 
check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_2(
  void * env_ptr_arg);
...
static /* final */ const MR_Box check_hlds__types_into_modes_scalar_common_1[1][2];

static /* final */ const MR_Box check_hlds__types_into_modes_scalar_common_2[1][3];
  ...
  MR_Word * STATE_VARIABLE_PredInfo_31)
{
  ...
  check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0(ModuleInfo_8, STATE_VARIABLE_PredInfo_0_30, ProcIds_14, (MR_Word) ((MR_Unsigned) 0U), &RevErrorProcIds_15, STATE_VARIABLE_Cache_0_28, &STATE_VARIABLE_Cache_34_34, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_Specs_35_35, Procs0_13, &Procs_16);
          ...
          case (MR_Integer) 2:
            {
              ...
              PredFormArity_34 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&check_hlds__types_into_modes_scalar_common_2[0]), ArgVarsModes0_31);
...
check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_1(
  void * env_ptr_arg)
{
  struct check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0_s * env_ptr = (struct check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0_s *) (env_ptr_arg);

  MR_builtin_longjmp((env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__commit_0, 1);
}
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__commit_0) == 0)
    {
      {
        MR_Word InstVar_52;

        check_hlds__inst_match__mode_list_contains_inst_var_2_p_0((env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49, &InstVar_52, check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_1, env_ptr);
      }
      (env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__succeeded = MR_FALSE;
    }
  else
    (env_ptr)->check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__succeeded = MR_TRUE;
}
...
check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0(
  ...
  MR_Word * STATE_VARIABLE_Procs_11)
{
  struct check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0_s env;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo0_47, &ArgModes0_48);
      {
        ...
        MR_hl_field(0, Var_51, 0) = ((MR_Box) (PredInfo_2));
      }
      check_hlds__inst_mode_type_prop__propagate_checked_types_into_modes_9_p_0(ModuleInfo_1, Var_51, ArgTypes_46, ArgModes0_48, &(env).check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49, STATE_VARIABLE_Cache_0_6, &STATE_VARIABLE_Cache_43_43, STATE_VARIABLE_Specs_0_8, &STATE_VARIABLE_Specs_44_44);
      check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_2(&env);
      if ((env).check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__succeeded)
      {
        {
      ...
      else
      {
        ...
        hlds__hlds_pred__proc_info_set_argmodes_3_p_0((env).check_hlds__types_into_modes__propagate_checked_types_into_procs_modes_11_p_0_env_0__ArgModes_49, ProcInfo0_47, &ProcInfo_50);
        mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_28)), ((MR_Box) (ProcInfo_50)), STATE_VARIABLE_Procs_0_10, &STATE_VARIABLE_Procs_45_45);
