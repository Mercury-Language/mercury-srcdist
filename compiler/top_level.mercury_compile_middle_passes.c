  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 538, &ClosureAnalysis_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 514, &SharingAnalysis_20);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 716, &Experiment5_32);
  ...
  MR_Word * STATE_VARIABLE_HLDS_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 721, &ImplicitParallelism_16);
