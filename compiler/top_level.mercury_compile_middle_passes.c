...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 56, &Verbose_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 66, &Stats_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 439, &ClosureAnalysis_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 415, &SharingAnalysis_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 56, &Verbose_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 66, &Stats_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 439, &ClosureAnalysis_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 415, &SharingAnalysis_11);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_82, (MR_Integer) 439, &ClosureAnalysis_83);
...
{
  {
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 3, Verbose_11, Stats_12, STATE_VARIABLE_HLDS_167_167, &STATE_VARIABLE_HLDS_175_175, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &_SimplifySpecsPreImpPar_14);
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 2, Verbose_11, Stats_12, STATE_VARIABLE_HLDS_224_224, &STATE_VARIABLE_HLDS_232_232, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &_SimplifySpecsPreProf_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 396, &Dead_12);
    switch (Dead_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 414, &Analysis_12);
    switch (Analysis_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    if ((MaybeNumProcMap_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 206, &ProfileDeep_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 223, &AsWords_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 224, &AsCells_13);
    switch (AsWords_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        switch (AsCells_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            MaybeTransform_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            break;
          case (MR_Integer) 1:
            {
    ...
    if ((MaybeTransform_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&top_level__mercury_compile_middle_passes_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (top_level__mercury_compile_middle_passes__maybe_term_size_prof_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (Transform_15));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_30, 1) = ((MR_Box) (Var_32));
      }
      hlds__passes_aux__process_all_nonimported_procs_3_p_0(Var_30, STATE_VARIABLE_HLDS_0_16, STATE_VARIABLE_HLDS_17);
      libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
      libs__file_util__maybe_report_stats_3_p_0(Stats_8);
    }
  }
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_16, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 263, &UseFloatRegs_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 681, &LoopControl_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 227, &Parallel_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 264, &HighLevelCode_13);
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 678, &Distance_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 227, &Parallel_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 264, &HighLevelCode_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 677, &Control_14);
    hlds__hlds_module__module_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_HLDS_0_17, &HasParallelConj_15);
    succeeded = (Parallel_12 == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 405, &TablingAnalysis_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 372, &LCO_12);
    switch (LCO_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 363, &UnneededCode_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 402, &AnalyseTrail_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 417, &ReuseAnalysis_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 415, &Sharing_12);
    switch (Sharing_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 394, &DelayConstruct_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 397, &Deforest_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 357, &Constraints_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 393, &LoopInv_15);
    switch (LoopInv_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_17, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 340, &Allow_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 342, &Simple_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 344, &SingleUse_14);
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 346, &Threshold_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 350, &LinearRec_16);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 369, &Optimize_12);
    switch (Optimize_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
          TypeInfo_43_43 = (MR_Word) &top_level__mercury_compile_middle_passes_scalar_common_1[1];
          mercury__univ__type_to_univ_2_p_0(TypeInfo_43_43, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &Cookie0_13);
          {
            Task0_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Task0_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          ...
          succeeded = ((((MR_tag((MR_Word) Task_15)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Task_15, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
            Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), Task_15, (MR_Integer) 1)));
            Cookie_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), Task_15, (MR_Integer) 2)));
            succeeded = mercury__univ__univ_to_type_2_p_0(TypeInfo_43_43, Cookie_17, &conv3_SpecsPrime_18);
            if (succeeded)
            {
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 679, &ImplicitParallelism_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 146, &ForceDisableSSDB_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 360, &HigherOrder_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 368, &Types_13);
    ...
    Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), TypeSpecInfo_14, (MR_Integer) 1)));
    Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), TypeSpecInfo_14, (MR_Integer) 2)));
    Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), TypeSpecInfo_14, (MR_Integer) 3)));
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 407, &Tuple_12);
    switch (Tuple_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_14, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 406, &Untuple_12);
    switch (Untuple_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_15 = STATE_VARIABLE_HLDS_0_14;
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
          top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 1, Verbose_7, Stats_8, STATE_VARIABLE_HLDS_22_22, STATE_VARIABLE_HLDS_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &SimplifySpecs_13);
          Var_35 = parse_tree__error_util__contains_errors_2_f_0(Globals_11, SimplifySpecs_13);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (Var_35));
            MR_hl_field(MR_mktag(0), Var_31, 4) = ((MR_Box) ((MR_Integer) 0));
          }
          mercury__require__expect_4_p_0(Var_31, (MR_String) "top_level.mercury_compile_middle_passes", (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_untuple_arguments\'/6", (MR_String) "simplify has errors");
          libs__file_util__maybe_report_stats_3_p_0(Stats_8);
        }
        break;
    }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 147, &GenBytecode_14);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_17, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 37, &WarnDeadProcs_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 38, &WarnDeadPreds_13);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 284, &TypeCtorInfo_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_16, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 430, &Termination2_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_16, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 423, &Termination_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 438, &ExceptionAnalysis_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 439, &ClosureAnalysis_12);
...
{
  {
    ...
    libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
    transform_hlds__table_gen__table_gen_process_module_4_p_0(STATE_VARIABLE_HLDS_0_15, &STATE_VARIABLE_HLDS_22_22, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Specs_11);
    libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) " done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_8);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 225, &FileName_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 223, &RecordTermSizesAsWords_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 224, &RecordTermSizesAsCells_10);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) MaybeNumProcMap_12)) == (MR_mktag((MR_Integer) 1))))
      {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 359, &Intermod_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 358, &Optimize_15);
