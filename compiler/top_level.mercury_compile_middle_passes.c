  ...
  MR_Word * Specs_17)
{
  ...
  MR_Word STATE_VARIABLE_HLDS_23_176;
  MR_Word STATE_VARIABLE_Specs_7_177;
  MR_Word STATE_VARIABLE_DumpInfo_24_181;
  MR_Word STATE_VARIABLE_HLDS_24_183;
  MR_Word STATE_VARIABLE_DumpInfo_25_187;
  MR_Word STATE_VARIABLE_HLDS_25_189;
  MR_Word STATE_VARIABLE_DumpInfo_26_193;
  MR_Word STATE_VARIABLE_HLDS_26_198;
  MR_Word STATE_VARIABLE_DumpInfo_27_203;
  MR_Word STATE_VARIABLE_HLDS_27_205;
  MR_Word STATE_VARIABLE_Specs_8_206;
  MR_Word STATE_VARIABLE_DumpInfo_28_210;
  MR_Word STATE_VARIABLE_HLDS_28_212;
  MR_Word STATE_VARIABLE_DumpInfo_29_216;
  MR_Word STATE_VARIABLE_HLDS_29_218;
  MR_Word STATE_VARIABLE_DumpInfo_30_222;
  MR_Word STATE_VARIABLE_HLDS_30_224;
  MR_Word STATE_VARIABLE_DumpInfo_31_228;
  MR_Word STATE_VARIABLE_HLDS_31_230;
  MR_Word STATE_VARIABLE_DumpInfo_32_234;
  MR_Word STATE_VARIABLE_HLDS_32_236;
  MR_Word STATE_VARIABLE_DumpInfo_33_240;
  MR_Word STATE_VARIABLE_HLDS_33_242;
  MR_Word STATE_VARIABLE_DumpInfo_34_246;
  MR_Word STATE_VARIABLE_HLDS_34_248;
  MR_Word STATE_VARIABLE_DumpInfo_35_253;
  ...
  top_level__mercury_compile_middle_passes__maybe_higher_order_or_type_spec_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_13_112, &STATE_VARIABLE_HLDS_14_118);
  ...
  top_level__mercury_compile_middle_passes__maybe_unused_args_12_p_0(ProgressStream_12, Verbose_20, Stats_21, (MR_Integer) 0, (MR_Integer) 0, &_PragmaUnusedArgsInfos_22, STATE_VARIABLE_HLDS_22_168, &STATE_VARIABLE_HLDS_23_176, STATE_VARIABLE_Specs_6_131, &STATE_VARIABLE_Specs_7_177);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_23_176, (MR_Integer) 165, (MR_String) "unused_args", STATE_VARIABLE_DumpInfo_23_172, &STATE_VARIABLE_DumpInfo_24_181);
  top_level__mercury_compile_middle_passes__maybe_analyse_trail_usage_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_23_176, &STATE_VARIABLE_HLDS_24_183);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_24_183, (MR_Integer) 167, (MR_String) "trail_usage", STATE_VARIABLE_DumpInfo_24_181, &STATE_VARIABLE_DumpInfo_25_187);
  top_level__mercury_compile_middle_passes__maybe_unneeded_code_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_24_183, &STATE_VARIABLE_HLDS_25_189);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_25_189, (MR_Integer) 170, (MR_String) "unneeded_code", STATE_VARIABLE_DumpInfo_25_187, &STATE_VARIABLE_DumpInfo_26_193);
  top_level__mercury_compile_front_end__maybe_simplify_12_p_0(ProgressStream_12, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_25_189, &STATE_VARIABLE_HLDS_26_198, (MR_Word) ((MR_Unsigned) 0U), &_SimplifySpecsPreImpPar_23);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_26_198, (MR_Integer) 172, (MR_String) "pre_implicit_parallelism_simplify", STATE_VARIABLE_DumpInfo_26_193, &STATE_VARIABLE_DumpInfo_27_203);
  top_level__mercury_compile_middle_passes__maybe_implicit_parallelism_10_p_0(ProgressStream_12, ErrorStream_13, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_26_198, &STATE_VARIABLE_HLDS_27_205, STATE_VARIABLE_Specs_7_177, &STATE_VARIABLE_Specs_8_206);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_27_205, (MR_Integer) 173, (MR_String) "implicit_parallelism", STATE_VARIABLE_DumpInfo_27_203, &STATE_VARIABLE_DumpInfo_28_210);
  top_level__mercury_compile_middle_passes__maybe_analyse_mm_tabling_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_27_205, &STATE_VARIABLE_HLDS_28_212);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_28_212, (MR_Integer) 185, (MR_String) "mm_tabling_analysis", STATE_VARIABLE_DumpInfo_28_210, &STATE_VARIABLE_DumpInfo_29_216);
  top_level__mercury_compile_middle_passes__maybe_control_granularity_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_28_212, &STATE_VARIABLE_HLDS_29_218);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_29_218, (MR_Integer) 200, (MR_String) "granularity", STATE_VARIABLE_DumpInfo_29_216, &STATE_VARIABLE_DumpInfo_30_222);
  top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_29_218, &STATE_VARIABLE_HLDS_30_224);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_30_224, (MR_Integer) 201, (MR_String) "distance_granularity", STATE_VARIABLE_DumpInfo_30_222, &STATE_VARIABLE_DumpInfo_31_228);
  top_level__mercury_compile_middle_passes__maybe_impl_dependent_par_conjs_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_30_224, &STATE_VARIABLE_HLDS_31_230);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_31_230, (MR_Integer) 205, (MR_String) "dependent_par_conj", STATE_VARIABLE_DumpInfo_31_228, &STATE_VARIABLE_DumpInfo_32_234);
  top_level__mercury_compile_middle_passes__maybe_par_loop_control_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_31_230, &STATE_VARIABLE_HLDS_32_236);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_32_236, (MR_Integer) 206, (MR_String) "par_loop_control", STATE_VARIABLE_DumpInfo_32_234, &STATE_VARIABLE_DumpInfo_33_240);
  top_level__mercury_compile_middle_passes__maybe_lco_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_32_236, &STATE_VARIABLE_HLDS_33_242);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_33_242, (MR_Integer) 210, (MR_String) "lco", STATE_VARIABLE_DumpInfo_33_240, &STATE_VARIABLE_DumpInfo_34_246);
  top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_9_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_33_242, &STATE_VARIABLE_HLDS_34_248, STATE_VARIABLE_Specs_8_206, Specs_17);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_34_248, (MR_Integer) 213, (MR_String) "float_reg_wrapper", STATE_VARIABLE_DumpInfo_34_246, &STATE_VARIABLE_DumpInfo_35_253);
  switch (OpModeFrontAndMiddle_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        *STATE_VARIABLE_HLDS_26 = STATE_VARIABLE_HLDS_34_248;
        *STATE_VARIABLE_DumpInfo_28 = STATE_VARIABLE_DumpInfo_35_253;
      }
      break;
    case (MR_Integer) 2:
    case (MR_Integer) 1:
    case (MR_Integer) 3:
      {
        MR_Word STATE_VARIABLE_HLDS_35_258;
        MR_Word STATE_VARIABLE_DumpInfo_36_263;
        MR_Word STATE_VARIABLE_HLDS_36_265;
        MR_Word STATE_VARIABLE_DumpInfo_37_269;
        MR_Word STATE_VARIABLE_HLDS_37_271;
        MR_Word STATE_VARIABLE_DumpInfo_38_275;
        MR_Word STATE_VARIABLE_HLDS_38_277;
        MR_Word STATE_VARIABLE_DumpInfo_39_281;
        MR_Word STATE_VARIABLE_HLDS_39_283;
        MR_Word STATE_VARIABLE_DumpInfo_40_287;
        MR_Word STATE_VARIABLE_DumpInfo_41_293;
        MR_Word _SimplifySpecsPreProf_24;

        top_level__mercury_compile_front_end__maybe_simplify_12_p_0(ProgressStream_12, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 3, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_34_248, &STATE_VARIABLE_HLDS_35_258, (MR_Word) ((MR_Unsigned) 0U), &_SimplifySpecsPreProf_24);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_35_258, (MR_Integer) 215, (MR_String) "pre_prof_transforms_simplify", STATE_VARIABLE_DumpInfo_35_253, &STATE_VARIABLE_DumpInfo_36_263);
        top_level__mercury_compile_middle_passes__maybe_term_size_prof_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_35_258, &STATE_VARIABLE_HLDS_36_265);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_36_265, (MR_Integer) 220, (MR_String) "term_size_prof", STATE_VARIABLE_DumpInfo_36_263, &STATE_VARIABLE_DumpInfo_37_269);
        top_level__mercury_compile_middle_passes__maybe_deep_profiling_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_36_265, &STATE_VARIABLE_HLDS_37_271);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_37_271, (MR_Integer) 225, (MR_String) "deep_profiling", STATE_VARIABLE_DumpInfo_37_269, &STATE_VARIABLE_DumpInfo_38_275);
        top_level__mercury_compile_middle_passes__maybe_experimental_complexity_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_37_271, &STATE_VARIABLE_HLDS_38_277);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_38_277, (MR_Integer) 230, (MR_String) "complexity", STATE_VARIABLE_DumpInfo_38_275, &STATE_VARIABLE_DumpInfo_39_281);
        top_level__mercury_compile_middle_passes__maybe_region_analysis_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_38_277, &STATE_VARIABLE_HLDS_39_283);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, STATE_VARIABLE_HLDS_39_283, (MR_Integer) 240, (MR_String) "region_analysis", STATE_VARIABLE_DumpInfo_39_281, &STATE_VARIABLE_DumpInfo_40_287);
        top_level__mercury_compile_middle_passes__maybe_eliminate_dead_procs_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_39_283, STATE_VARIABLE_HLDS_26);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, *STATE_VARIABLE_HLDS_26, (MR_Integer) 250, (MR_String) "dead_procs", STATE_VARIABLE_DumpInfo_40_287, &STATE_VARIABLE_DumpInfo_41_293);
        hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_12, *STATE_VARIABLE_HLDS_26, (MR_Integer) 299, (MR_String) "middle_pass", STATE_VARIABLE_DumpInfo_41_293, STATE_VARIABLE_DumpInfo_28);
      }
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_HLDS_17)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_16, &Globals_13);
  libs__globals__get_opt_tuple_2_p_0(Globals_13, &OptTuple_14);
  Tuple_15 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_14, 1))) >> 25)) & (MR_Integer) 1);
  switch (Tuple_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      *STATE_VARIABLE_HLDS_17 = STATE_VARIABLE_HLDS_0_16;
