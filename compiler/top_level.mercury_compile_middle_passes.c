...
MR_decl_static(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__786__1_2_0)
...
"top_level.mercury_compile_middle_passes",
"top_level.mercury_compile_middle_passes",
"lambda_mercury_compile_middle_passes_m_786",
2,
0
},
"top_level.mercury_compile_middle_passes",
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_untuple_arguments_6_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__786__1_2_0);
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,14)
	...
	MR_sv(4) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("maybe_introduce_accumulators: bad task", 38);
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module41)
	MR_init_entry1(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__786__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__786__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__maybe_untuple_arguments__786__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__786__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
