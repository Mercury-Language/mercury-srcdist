  ...
  MR_Word * Specs_17)
{
  ...
  top_level__mercury_compile_middle_passes__maybe_ssdb_7_p_0(ProgressStream_12, Verbose_20, Stats_21, STATE_VARIABLE_HLDS_14_118, &STATE_VARIABLE_HLDS_15_124);
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 47, &WarnDeadProcs_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 48, &WarnDeadPreds_17);
