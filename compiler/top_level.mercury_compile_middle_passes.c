...
static /* final */ const MR_Box top_level__mercury_compile_middle_passes_scalar_common_1[7][2];
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_9_p_0(Globals_16, ProgressStream_10, ErrorStream_11, ModuleName_21, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt_date"))), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[3])), &_TouchSucceeded_31);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__file_util__maybe_flush_output_4_p_0(ProgressStream_10, Verbose_11);
        hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[6])), STATE_VARIABLE_HLDS_25_25, STATE_VARIABLE_HLDS_20);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_10, Verbose_11, (MR_String) "% done.\n");
        libs__file_util__maybe_report_stats_4_p_0(ProgressStream_10, Stats_12);
      }
      break;
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) " done.\n");
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_bytecodes\'/8", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[2])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[5])), ModuleName_19, &BytecodeFile_21);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) "% Writing bytecodes to \140");
