  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_29_29, &Globals_86);
  libs__globals__lookup_bool_option_3_p_0(Globals_86, (MR_Integer) 530, &ClosureAnalysis_87);
  switch (ClosureAnalysis_87) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
