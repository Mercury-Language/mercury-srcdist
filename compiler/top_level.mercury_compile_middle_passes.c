      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
          TypeInfo_42_42 = (MR_Word) &top_level__mercury_compile_middle_passes_scalar_common_1[1];
          mercury__univ__type_to_univ_2_p_0(TypeInfo_42_42, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &Cookie0_13);
          {
          ...
          if (succeeded)
          {
            ...
            succeeded = mercury__univ__univ_to_type_2_p_0(TypeInfo_42_42, Cookie_17, &conv3_SpecsPrime_18);
            if (succeeded)
            {
