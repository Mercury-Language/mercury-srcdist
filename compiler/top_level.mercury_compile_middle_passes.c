    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__termination__analyse_termination_in_module_3_p_0(STATE_VARIABLE_HLDS_5_39, &STATE_VARIABLE_HLDS_6_42, &TermSpecs_80);
    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__term_constr_main__term2_analyse_module_3_p_0(STATE_VARIABLE_HLDS_6_42, &STATE_VARIABLE_HLDS_7_45, &TermSpecs_88);
