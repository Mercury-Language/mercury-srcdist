  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_16, ProgressStream_10, ErrorStream_11, ModuleName_21, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_middle_passes_scalar_common_2[0])), &_TouchSucceeded_31);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_155 = mercury__string__f_43_43_2_f_0(OptFileName_22, (MR_String) "x");
          mercury__io__open_output_4_p_0(Var_155, &OptXResult_33);
