    ...
    case (MR_Integer) 1:
      {
        ...
        top_level__mercury_compile_middle_passes__maybe_higher_order_or_type_spec_7_p_0(ProgressStream_9, Verbose_15, Stats_16, STATE_VARIABLE_HLDS_5_83, &STATE_VARIABLE_HLDS_6_90);
