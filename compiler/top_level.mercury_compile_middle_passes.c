  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_16, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.output_trans_opt_file\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_middle_passes_scalar_common_2[0])), ModuleName_21, &OptFileName_22);
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_16, ProgressStream_10, ErrorStream_11, ModuleName_21, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_middle_passes_scalar_common_2[1])), &_TouchSucceeded_31);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_bytecodes\'/8", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[2])), ModuleName_19, &BytedebugFile_20);
        ...
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) " done.\n");
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_bytecodes\'/8", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[3])), ModuleName_19, &BytecodeFile_21);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) "% Writing bytecodes to \140");
