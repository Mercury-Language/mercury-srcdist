...
MR_decl_label10(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0, 2,3,4,5,6,11,14,15,16,17)
MR_decl_label5(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0, 18,13,19,20,56)
MR_decl_label10(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0, 2,3,4,5,6,12,15,16,17,18)
MR_decl_label5(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0, 19,14,20,21,57)
...
MR_decl_label10(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0, 2,3,5,6,7,8,9,10,11,12)
...
MR_decl_label10(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0, 2,3,5,6,7,8,11,15,12,13)
MR_decl_label5(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0, 18,19,20,21,22)
...
MR_decl_label7(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0, 2,3,6,7,8,9,4)
...
MR_decl_label4(top_level__mercury_compile_middle_passes__middle_pass_7_0, 82,83,84,85)
...
MR_decl_label2(top_level__mercury_compile_middle_passes__output_analysis_file_5_0, 45,46)
...
MR_decl_static(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0)
...
MR_decl_static(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__794__1_2_0)
...
"top_level.mercury_compile_middle_passes",
"top_level.mercury_compile_middle_passes",
"lambda_mercury_compile_middle_passes_m_794",
2,
0
},
"top_level.mercury_compile_middle_passes",
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_untuple_arguments_6_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__794__1_2_0);
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module16)
	...
	MR_init_label7(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0,2,3,6,7,8,9,4)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0_i4);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Word) MR_string_const("% Maybe apply source to source debugging transformation ...\n", 60);
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		top_level__mercury_compile_middle_passes__maybe_ssdb_6_0_i6);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(transform_hlds__ssdebug__ssdebug_transform_module_4_0,
		top_level__mercury_compile_middle_passes__maybe_ssdb_6_0_i7);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_ssdb_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module18)
	...
	MR_init_label10(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,2,3,5,6,7,8,11,15,12,13)
	MR_init_label5(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,18,19,20,21,22)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,7)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_0,
		top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i8);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(hlds__passes_aux__process_all_nonimported_procs_update_4_0,
		top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i11);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(univ__univ_to_type_2_0,
		top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i15);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i12);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,13)
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i18);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__error_util__write_error_specs_8_0,
		top_level__mercury_compile_middle_passes__maybe_introduce_accumulators_6_0_i19);
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module29)
	...
	MR_init_label10(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,2,3,4,5,6,12,15,16,17,18)
	MR_init_label5(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,19,14,20,21,57)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0_i57);
	}
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0_i57);
	}
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,12)
	...
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0_i15);
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,14)
	...
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0_i20);
	}
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(8);
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_granularity_6_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module30)
	...
	MR_init_label10(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,2,3,4,5,6,11,14,15,16,17)
	MR_init_label5(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,18,13,19,20,56)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0_i56);
	}
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0_i56);
	}
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,11)
	...
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0_i14);
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0_i19);
	}
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(8);
...
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
MR_def_label(top_level__mercury_compile_middle_passes__maybe_control_distance_granularity_6_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
...
MR_decl_entry(transform_hlds__float_regs__insert_reg_wrappers_3_0);

MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module33)
	MR_init_entry1(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0);
	MR_init_label10(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,2,3,5,6,7,8,9,10,11,12)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'maybe_float_reg_wrapper'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i2);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r2 = (MR_Integer) 246;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i3);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i5);
	}
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(5);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Word) MR_string_const("% Inserting float register wrappers...", 38);
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i6);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(libs__file_util__maybe_flush_output_3_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i7);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(transform_hlds__float_regs__insert_reg_wrappers_3_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i8);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_call_localret_ent(parse_tree__error_util__write_error_specs_8_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i9);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_incr_num_errors_3_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i10);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
	...
	MR_np_call_localret_ent(libs__file_util__maybe_write_string_4_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i11);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(libs__file_util__maybe_report_stats_3_0,
		top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0_i12);
MR_def_label(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module39)
	...
	MR_init_label4(top_level__mercury_compile_middle_passes__middle_pass_7_0,82,83,84,85)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__middle_pass_7_0,70)
	...
	MR_np_call_localret_ent(top_level__mercury_compile_middle_passes__maybe_float_reg_wrapper_6_0,
...
MR_def_label(top_level__mercury_compile_middle_passes__middle_pass_7_0,71)
	...
	MR_r3 = (MR_Word) MR_string_const("float_reg_wrapper", 17);
	MR_r4 = MR_tempr1;
	}
	MR_np_call_localret_ent(hlds__passes_aux__maybe_dump_hlds_7_0,
...
MR_def_label(top_level__mercury_compile_middle_passes__middle_pass_7_0,83)
	...
	MR_np_call_localret_ent(hlds__passes_aux__maybe_dump_hlds_7_0,
		top_level__mercury_compile_middle_passes__middle_pass_7_0_i84);
MR_def_label(top_level__mercury_compile_middle_passes__middle_pass_7_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__passes_aux__maybe_dump_hlds_7_0,
		top_level__mercury_compile_middle_passes__middle_pass_7_0_i85);
MR_def_label(top_level__mercury_compile_middle_passes__middle_pass_7_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module42)
	...
	MR_init_label2(top_level__mercury_compile_middle_passes__output_analysis_file_5_0,45,46)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_middle_passes__output_analysis_file_5_0,45)
	...
	MR_np_call_localret_ent(analysis__write_analysis_files_7_0,
		top_level__mercury_compile_middle_passes__output_analysis_file_5_0_i46);
MR_def_label(top_level__mercury_compile_middle_passes__output_analysis_file_5_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(top_level__mercury_compile_middle_passes_module43)
	MR_init_entry1(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__794__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__794__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__maybe_untuple_arguments__794__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__794__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
static void mercury__top_level__mercury_compile_middle_passes_maybe_bunch_1(void)
{
	...
	top_level__mercury_compile_middle_passes_module43();
}
...
void mercury__top_level__mercury_compile_middle_passes__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__top_level__mercury_compile_middle_passes);
