...
{
  {
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 3, Verbose_11, Stats_12, STATE_VARIABLE_HLDS_167_167, &STATE_VARIABLE_HLDS_175_175, (MR_Word) ((MR_Integer) 0), &_SimplifySpecsPreImpPar_14);
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 2, Verbose_11, Stats_12, STATE_VARIABLE_HLDS_224_224, &STATE_VARIABLE_HLDS_232_232, (MR_Word) ((MR_Integer) 0), &_SimplifySpecsPreProf_15);
...
{
  {
    ...
    if ((MaybeNumProcMap_11 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    switch (AsWords_12) {
      ...
      case (MR_Integer) 0:
        switch (AsCells_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            MaybeTransform_14 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 1:
    ...
    if ((MaybeTransform_14 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
          mercury__univ__type_to_univ_2_p_0((MR_Word) (&top_level__mercury_compile_middle_passes_scalar_common_1[1]), ((MR_Box) ((MR_Integer) 0)), &Cookie0_13);
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
          top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 1, Verbose_7, Stats_8, STATE_VARIABLE_HLDS_22_22, STATE_VARIABLE_HLDS_15, (MR_Word) ((MR_Integer) 0), &SimplifySpecs_13);
...
{
  {
    ...
    libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
    transform_hlds__table_gen__table_gen_process_module_4_p_0(STATE_VARIABLE_HLDS_0_15, &STATE_VARIABLE_HLDS_22_22, (MR_Word) ((MR_Integer) 0), &Specs_11);
    libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) " done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_8);
