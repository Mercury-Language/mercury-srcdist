...
top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__785__1_2_p_0(
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_12, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt.tmp"))), ModuleName_17, &TmpOptName_18);
    ...
    else
    {
      ...
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_12, (MR_Integer) 1, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt"))), ModuleName_17, &OptName_25);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_141 = mercury__string__f_43_43_2_f_0(OptName_25, (MR_String) "x");
            mercury__io__open_output_4_p_0(Var_141, &OptXResult_27);
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (SupportsParConj_13) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_middle_passes_scalar_common_7[1])), STATE_VARIABLE_HLDS_0_14, STATE_VARIABLE_HLDS_15);
              break;
            case (MR_Integer) 1:
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
          hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_middle_passes_scalar_common_7[0])), STATE_VARIABLE_HLDS_0_13, STATE_VARIABLE_HLDS_14);
          libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
          libs__file_util__maybe_report_stats_3_p_0(Stats_8);
        }
        break;
...
{
  {
    ...
    succeeded = top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__785__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_13, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".bytedebug"))), ModuleName_17, &BytedebugFile_18);
          ...
          libs__file_util__maybe_write_string_4_p_0(Verbose_9, (MR_String) " done.\n");
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_13, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".mbc"))), ModuleName_17, &BytecodeFile_19);
          libs__file_util__maybe_write_string_4_p_0(Verbose_9, (MR_String) "% Writing bytecodes to \140");
