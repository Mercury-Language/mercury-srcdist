...
top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__811__1_2_p_0(
...
{
  {
    ...
    else
    {
      ...
      MR_Word Experiment5_28;

      transform_hlds__intermod__write_trans_opt_file_5_p_0(TmpOptStream_24, STATE_VARIABLE_HLDS_119_119, &ParseTreeTransOpt_25);
      ...
      libs__globals__get_progress_output_stream_5_p_0(Globals_12, ModuleName_17, &ProgressStream_26);
      libs__globals__get_error_output_stream_5_p_0(Globals_12, ModuleName_17, &ErrorStream_27);
      parse_tree__module_cmds__touch_interface_datestamp_7_p_0(Globals_12, ProgressStream_26, ErrorStream_27, ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt_date"))));
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 707, &Experiment5_28);
      switch (Experiment5_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
          }
        ...
        case (MR_Integer) 1:
          {
            MR_Word OptXResult_29;
            MR_String Var_142;

            Var_142 = mercury__string__f_43_43_2_f_0(OptFileName_18, (MR_String) "x");
            mercury__io__open_output_4_p_0(Var_142, &OptXResult_29);
            if (!(((MR_tag((MR_Word) OptXResult_29)) == (MR_Integer) 1)))
            {
              MR_Word OptXStream_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OptXResult_29, (MR_Integer) 0))));
              MR_Word Info_32;

              Info_32 = parse_tree__parse_tree_out_info__init_merc_out_info_3_f_0(Globals_12, (MR_Integer) 0, (MR_Integer) 0);
              parse_tree__parse_tree_out__mercury_output_parse_tree_trans_opt_5_p_0(Info_32, OptXStream_31, ParseTreeTransOpt_25);
              mercury__io__close_output_3_p_0(OptXStream_31);
            }
          }
          break;
      }
...
{
  {
    ...
    succeeded = top_level__mercury_compile_middle_passes__IntroducedFrom__pred__maybe_untuple_arguments__811__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
