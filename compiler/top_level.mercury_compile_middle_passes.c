...
static /* final */ const MR_Box top_level__mercury_compile_middle_passes_scalar_common_2[8][1];
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_16, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.output_trans_opt_file\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[0])), (MR_Word) (MR_mkword(2, &top_level__mercury_compile_middle_passes_scalar_common_2[1])), ModuleName_21, &OptFileName_22);
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_9_p_0(Globals_16, ProgressStream_10, ErrorStream_11, ModuleName_21, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt_date"))), (MR_Word) (MR_mkword(2, &top_level__mercury_compile_middle_passes_scalar_common_2[2])), &_TouchSucceeded_31);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_161 = mercury__string__f_43_43_2_f_0(OptFileName_22, (MR_String) "x");
          mercury__io__open_output_4_p_0(Var_161, &OptXResult_33);
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 245, &ProfileDeep_14);
  ...
  MR_Word * STATE_VARIABLE_HLDS_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 262, &AsWords_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 263, &AsCells_15);
  switch (AsWords_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      switch (AsCells_15) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          MaybeTransform_16 = (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[5]));
          break;
      }
      break;
    case (MR_Integer) 1:
      switch (AsCells_15) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          MaybeTransform_16 = (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[6]));
          break;
        case (MR_Integer) 1:
          {
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 308, &UseFloatRegs_17);
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (SupportsParConj_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[7])), STATE_VARIABLE_HLDS_0_18, STATE_VARIABLE_HLDS_19);
            break;
          case (MR_Integer) 1:
            {
  ...
  MR_Word * STATE_VARIABLE_HLDS_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 266, &Parallel_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 309, &HighLevelCode_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_bytecodes\'/8", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[3])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[2])), ModuleName_19, &BytedebugFile_20);
        ...
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) " done.\n");
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_middle_passes.maybe_bytecodes\'/8", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_middle_passes_scalar_common_2[4])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[3])), ModuleName_19, &BytecodeFile_21);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_9, Verbose_11, (MR_String) "% Writing bytecodes to \140");
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 264, &FileName_10);
