    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_14, ProgressStream_9, ModuleName_23, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_4[3])), &_TouchSucceeded_44);
      }
      break;
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_14, ProgressStream_9, ModuleName_23, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_4[3])), &_TouchSucceeded_313);
            }
            break;
        }
      }
