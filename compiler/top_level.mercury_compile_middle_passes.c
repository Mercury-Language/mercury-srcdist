  ...
  MR_Word * STATE_VARIABLE_DumpInfo_41)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_16, ProgressStream_10, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_middle_passes_scalar_common_1[3])), &_TouchSucceeded_31);
