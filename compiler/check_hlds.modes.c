...
MR_decl_label10(check_hlds__modes__check_final_insts_12_0, 132,2,10,11,14,12,17,19,21,23)
...
MR_BEGIN_MODULE(check_hlds__modes_module1)
	...
	MR_init_label10(check_hlds__modes__check_final_insts_12_0,132,2,10,11,14,12,17,19,21,23)
...
MR_def_label(check_hlds__modes__check_final_insts_12_0,132)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__modes__check_final_insts_12_0,14)
	...
	MR_GOTO_LAB(check_hlds__modes__check_final_insts_12_0_i132);
