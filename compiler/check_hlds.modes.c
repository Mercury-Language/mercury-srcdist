            ...
            else
            {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(0, Spec_82, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
              ...
              else
              {
                ...
                Pieces_83 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__modes_scalar_common_1[25])), Var_111);
                {
                  ...
                  MR_hl_field(1, Spec_121, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
      ...
      if ((ModeErrors_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(0, GroundArgsSpec_28, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(0, UniquenessSpec_29, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_24, &Context_119);
          {
            ...
            MR_hl_field(1, MainSpec_30, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(2, MaxIterSpec_27, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
