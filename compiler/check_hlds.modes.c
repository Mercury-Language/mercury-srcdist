        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_12_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_74, (MR_Integer) 225, &InferModesOpt_75);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 229, &MaxIterations_16);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 325, &DelayPartialInstantiations_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_81, (MR_Integer) 229, &MaxIterations_82);
                {
