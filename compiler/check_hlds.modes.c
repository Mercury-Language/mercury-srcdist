...
check_hlds__modes__IntroducedFrom__pred__modecheck_queued_proc__1104__1_2_p_0(
...
static void MR_CALL 
check_hlds__modes__modecheck_procs_11_p_0(
...
{
  {
...

    {
      ...
      else
      {
        ...
        check_hlds__modes__modecheck_procs_11_p_0(WhatToCheck_10, MayChangeCalledProc_11, PredId_12, ProcTable0_75, ProcIds_76, STATE_VARIABLE_ModuleInfo_0_25, &STATE_VARIABLE_ModuleInfo_33_33, STATE_VARIABLE_Changed_0_27, STATE_VARIABLE_Changed_28, Var_81, &SpecsAcc_77);
  ...
  MR_Word * STATE_VARIABLE_Specs_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__modes__proc_check_eval_methods_5_p_0(ModuleInfo_1, PredInfo_14, ProcIds_15, STATE_VARIABLE_Specs_0_3, &STATE_VARIABLE_Specs_18_18);
      // direct tailcall eliminated
      ;
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      hlds__hlds_module__module_info_get_preds_2_p_0(STATE_VARIABLE_ModuleInfo_35_35, &PredTable0_116);
                      {
                      ...
                      hlds__hlds_module__module_info_set_preds_3_p_0(PredTable_117, STATE_VARIABLE_ModuleInfo_35_35, &STATE_VARIABLE_ModuleInfo_50_50);
                    }
                    break;
                }
                MaxIterations1_26 = (MR_Integer) ((MR_Unsigned) MaxIterations_10 - (MR_Unsigned) 1);
                // direct tailcall eliminated
                ;
...
{
  {
    ...
    succeeded = check_hlds__modes__IntroducedFrom__pred__modecheck_queued_proc__1104__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
