...
{
  {
...

    {
      ...
      (env_ptr)->check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__Var_84)) == (MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 192, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 288, &DelayPartialInstantiations_16);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) Modes_19)) == (MR_Integer) 1);
            if (succeeded)
            {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_71, (MR_Integer) 192, &MaxIterations_72);
                {
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (InferModes_57) {
            ...
            case (MR_Integer) 0:
              {
                succeeded = ((((MR_tag((MR_Word) Origin_59)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Origin_59, (MR_Integer) 0))) == (MR_Integer) 5)));
                if (succeeded)
                {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((((MR_tag((MR_Word) BodyGoalExpr0_31)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 0))) == (MR_Integer) 3))))
        {
          MR_Word Disjuncts0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 1))));

          succeeded = ((MR_tag((MR_Word) Disjuncts0_33)) == (MR_Integer) 1);
          if (succeeded)
          {
            {
        ...
        if (((((MR_tag((MR_Word) BodyGoalExpr0_31)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 0))) == (MR_Integer) 4))))
        {
          ...
          succeeded = ((MR_tag((MR_Word) Cases0_39)) == (MR_Integer) 1);
          if (succeeded)
          {
            {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_40)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) Vars_14)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) Insts_15)) == (MR_Integer) 1);
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) VarInsts_16)) == (MR_Integer) 1);
          if (succeeded)
          {
                ...
                {
                  {
                    ...
                    succeeded = ((((MR_tag((MR_Word) Inst_26)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Inst_26, (MR_Integer) 0))) == (MR_Integer) 1)));
                    if (succeeded)
                    {
