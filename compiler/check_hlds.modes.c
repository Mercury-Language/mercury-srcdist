          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_101, (MR_Integer) 214, &InferModesOpt_102);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 218, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 218, &MaxIterations_71);
                {
