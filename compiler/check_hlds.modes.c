          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Msg_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_59, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((((MR_tag((MR_Word) BodyGoalExpr0_31)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 0))) == (MR_Integer) 4))))
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 2)));
      ...
      switch (WhatToCheck_17) {
        ...
        case (MR_Integer) 0:
          ...
          else
          {
            ...
            MR_Word Cases_54;
            MR_Word Var_89;
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClausesForm0_36, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              MR_Word Cases_106;
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClausesForm0_36, (MR_Integer) 1)));
                ...
                {
                  {
                    ...
                    if (succeeded)
                    {
                      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_26, (MR_Integer) 1)));
