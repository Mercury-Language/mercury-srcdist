    ...
    else
    {
      ...
      if ((ModeErrors_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_101 = ((MR_Word) ((MR_hl_field(1, Modes_26, (MR_Integer) 1))));
                succeeded = (Var_101 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Uo_93 = ((MR_Word) ((MR_hl_field(1, Var_101, (MR_Integer) 0))));
                  Var_102 = ((MR_Word) ((MR_hl_field(1, Var_101, (MR_Integer) 1))));
                  ...
                  if (succeeded)
                  {
                    ...
                    Free_100 = (MR_Word) ((MR_Unsigned) 0U);
                    check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_1, DiInitialInst_94, &Var_107);
                    succeeded = parse_tree__prog_data____Unify____mer_inst_0_0(Unique_98, Var_107);
                    if (succeeded)
                    {
                      check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_1, DiFinalInst_95, &Var_108);
                      succeeded = parse_tree__prog_data____Unify____mer_inst_0_0(Clobbered_99, Var_108);
                      if (succeeded)
                      {
                        check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_1, UoInitialInst_96, &Var_109);
                        succeeded = parse_tree__prog_data____Unify____mer_inst_0_0(Free_100, Var_109);
                        if (succeeded)
                        {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_24, &Context_115);
          {
            ...
            MR_hl_field(1, MainSpec_30, 3) = ((MR_Box) (Context_115));
