...

    {
      ...
      else
      {
        ...
        *STATE_VARIABLE_Specs_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ThisPredDeclSpecs_20, Var_36);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 73, &Statistics_24);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 198, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 300, &DelayPartialInstantiations_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_67, (MR_Integer) 198, &MaxIterations_68);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 77, &DebugModes_23);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_54, (MR_Integer) 63, &VeryVerbose_55);
