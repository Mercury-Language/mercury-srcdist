...
check_hlds__modes__IntroducedFrom__func__report_mode_inference_message__1850__1_1_f_0(
...
{
  {
...

    {
      ...
      else
      {
        ...
        hlds__passes_aux__write_pred_progress_message_5_p_0(STATE_VARIABLE_ModuleInfo_0_27, Msg_59, PredId_12);
        switch (WhatToCheck_10) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_101, (MR_Integer) 215, &InferModesOpt_102);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        else
                        {
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(2), Var_137, 0) = ((MR_Box) (Context_108));
                            MR_hl_field(MR_mktag(2), Var_137, 1) = ((MR_Box) (Var_138));
                          }
                          {
        ...
        *STATE_VARIABLE_Specs_32 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ThisPredDeclSpecs_20, Var_38);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 81, &Statistics_24);
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                switch (WhatToCheck_11) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word PredTable0_110;
                      MR_Word PredTable_111;
                      MR_Word Var_112;
                      MR_Box conv7_PredTable_111;

                      hlds__hlds_module__module_info_get_preds_2_p_0(STATE_VARIABLE_ModuleInfo_36_36, &PredTable0_110);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_112, 3) = ((MR_Box) (OldPredTable_18));
                      }
                      mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__modes_scalar_common_2[0]), Var_112, PredIds_9, ((MR_Box) (PredTable0_110)), &conv7_PredTable_111);
                      PredTable_111 = ((MR_Word) (conv7_PredTable_111));
                      hlds__hlds_module__module_info_set_preds_3_p_0(PredTable_111, STATE_VARIABLE_ModuleInfo_36_36, &STATE_VARIABLE_ModuleInfo_52_52);
                    }
                    break;
                }
...
{
  {
    ...
    conv1_LambdaHeadVar__2_47 = check_hlds__modes__IntroducedFrom__func__report_mode_inference_message__1850__1_1_f_0(((MR_Word) (wrapper_arg_1)));
