...
static /* final */ const MR_Box check_hlds__modes_scalar_common_1[65][2];
...
static /* final */ const MR_Box check_hlds__modes_scalar_common_1[65][2] = {
  ...
  /* row  31 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[29])))
  },
  /* row  32 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  42 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[40])))
  },
  /* row  43 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  52 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__modes_scalar_common_1[51]))),
  ...
  /* row  54 */
  {
    ...
    ((MR_Box) (&check_hlds__modes_scalar_common_1[53]))
  },
  /* row  55 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__modes_scalar_common_1[54]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[52])))
  },
  /* row  56 */
  {
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 0U)),
    ((MR_Box) (&check_hlds__modes_scalar_common_1[57]))
  },
  /* row  59 */
  {
    (MR_Box) ((MR_Unsigned) 1U),
  ...
  /* row  64 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_1[63]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
};
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_10_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 224, &InferModesOpt_69);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      else
                      {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(1, Var_89, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[64])));
                        }
                        {
  ...
  MR_Word * STATE_VARIABLE_Specs_35)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 228, &MaxIterations_16);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_46, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[31])));
          }
          {
            MainPieces_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MainPieces_41, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__modes_scalar_common_1[27])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_49, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[60])));
          }
          {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_68, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[42])));
          }
          {
            MainPieces_63 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MainPieces_63, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__modes_scalar_common_1[38])));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_71, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[62])));
          }
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Unique_89 = (MR_Word) (MR_mkword(1, &check_hlds__modes_scalar_common_1[26]));
                  Clobbered_90 = (MR_Word) (MR_mkword(1, &check_hlds__modes_scalar_common_1[25]));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (((((MR_tag((MR_Word) Free_91)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Free_91, (MR_Integer) 0)))) == (MR_Integer) 3))))
                        succeeded = MR_TRUE;
                      else
                        succeeded = MR_FALSE;
                      if (succeeded)
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_17, &Context_105);
        {
          ...
          MR_hl_field(1, MainSpec_23, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[56])));
        }
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 228, &MaxIterations_71);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 89, &DebugModes_25);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), OrigPredFormArityInt_43, ((MR_Box) (MR_mkword(3, &check_hlds__modes_scalar_common_1[58]))), &FinalInsts_44);
          ...
          STATE_VARIABLE_ArgModes_44_56 = mercury__list__map_2_f_0((MR_Word) (&check_hlds__modes_scalar_common_2[2]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&check_hlds__modes_scalar_common_2[3]), Var_58);
  ...
  else
  {
    ...
    else
    {
      ...
      switch (IsLive_16) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          Inst_18 = (MR_Word) (MR_mkword(1, &check_hlds__modes_scalar_common_1[25]));
          break;
        case (MR_Integer) 0:
          Inst_18 = Var_23;
          break;
