              ...
              case (MR_Integer) 1:
                {
                  ...
                  check_hlds__det_analysis__determinism_check_proc_5_p_0(ProcId_66, PredId_65, STATE_VARIABLE_ModuleInfo_47_91, &STATE_VARIABLE_ModuleInfo_48_92, &DetismSpecs_79);
                  {
