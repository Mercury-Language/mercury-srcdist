          ...
          case (MR_Integer) 1:
            {
              ...
              ProcStr_54 = hlds__hlds_out__hlds_out_util__pred_proc_id_to_string_2_f_0(STATE_VARIABLE_ModuleInfo_34_34, PredProcId_17);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_93)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_93, (MR_Integer) 0)))) == (MR_Integer) 2)));
          if (succeeded)
          {
          }
        }
