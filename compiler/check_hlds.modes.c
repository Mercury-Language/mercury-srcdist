        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_10_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 221, &InferModesOpt_69);
  ...
  MR_Word * STATE_VARIABLE_Specs_35)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 225, &MaxIterations_16);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 321, &DelayPartialInstantiations_18);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 225, &MaxIterations_71);
                {
