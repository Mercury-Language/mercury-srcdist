...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 201, &MaxIterations_14);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        EvalMethodS_37 = parse_tree__prog_out__eval_method_to_string_1_f_0(EvalMethod_35);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_44, 0) = ((MR_Box) ((MR_Unsigned) 19U));
      ...
      if (succeeded)
      {
        ...
        EvalMethodS_81 = parse_tree__prog_out__eval_method_to_string_1_f_0(EvalMethod_79);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_88, 0) = ((MR_Box) ((MR_Unsigned) 19U));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_67, (MR_Integer) 201, &MaxIterations_68);
                {
