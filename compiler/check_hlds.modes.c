...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word ArgY2_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 292, &DelayPartialInstantiations_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Msg_74, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Origin_59, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((((MR_tag((MR_Word) BodyGoalExpr0_31)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 0))) == (MR_Integer) 4))))
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), BodyGoalExpr0_31, (MR_Integer) 2)));
          ...
          {
            {
              ...
              MR_hl_field(MR_mktag(1), ClausesForm0_36, 1) = (MR_Box) (packed_args_0);
      ...
      switch (WhatToCheck_17) {
        ...
        case (MR_Integer) 0:
          ...
          else
          {
            ...
            MR_Word Cases_54;
            MR_Word Var_89;
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClausesForm0_36, (MR_Integer) 1)));
            ...
            *STATE_VARIABLE_ModeInfo_67 = ((MR_Word) (conv5_STATE_VARIABLE_ModeInfo_67));
            {
              ...
              MR_hl_field(MR_mktag(3), NewGoalExpr_50, 2) = (MR_Box) (packed_args_1);
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              MR_Word Cases_106;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClausesForm0_36, (MR_Integer) 1)));
              ...
              *STATE_VARIABLE_ModeInfo_67 = ((MR_Word) (conv11_STATE_VARIABLE_ModeInfo_67));
              {
                ...
                MR_hl_field(MR_mktag(3), NewGoalExpr_50, 2) = (MR_Box) (packed_args_2);
                ...
                {
                  {
                    ...
                    if (succeeded)
                    {
                      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_26, (MR_Integer) 1)));
