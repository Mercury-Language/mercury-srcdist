...

    {
      ...
      else
      {
        ...
        *STATE_VARIABLE_Specs_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ThisPredDeclSpecs_20, Var_36);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 74, &Statistics_24);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 199, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 301, &DelayPartialInstantiations_16);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_83, 0) = ((MR_Box) (Context_79));
          MR_hl_field(MR_mktag(1), Msg_83, 1) = ((MR_Box) (Var_111));
        }
        {
      ...
      if (succeeded)
      {
        ...
        {
          Msg_149 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Msg_149, 0) = ((MR_Box) (Context_147));
          MR_hl_field(MR_mktag(1), Msg_149, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__modes_scalar_common_1[51])));
        }
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_67, (MR_Integer) 199, &MaxIterations_68);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 78, &DebugModes_23);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_54, (MR_Integer) 64, &VeryVerbose_55);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (InferModes_57) {
            ...
            case (MR_Integer) 0:
              {
                succeeded = ((((MR_tag((MR_Word) Origin_59)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_59, (MR_Integer) 0)))) == (MR_Integer) 6)));
                if (succeeded)
