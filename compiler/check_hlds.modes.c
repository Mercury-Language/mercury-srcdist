    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          Var_89 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), WarningSpecs_76, StateVarWarningSpecs_74);
