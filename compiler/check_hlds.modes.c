...

  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ThisPredDeclSpecs_24, Var_43);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 660, &Statistics_28);
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 673, &DebugModes_28);
