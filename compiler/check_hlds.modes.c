...

  {
    ...
    else
    {
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_12_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_74, (MR_Integer) 248, &InferModesOpt_75);
      ...
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ThisPredDeclSpecs_24, Var_43);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 89, &Statistics_28);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 252, &MaxIterations_16);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 348, &DelayPartialInstantiations_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_81, (MR_Integer) 252, &MaxIterations_82);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 110, &DebugModes_28);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 80, &VerboseErrors_33);
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_35, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 70) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 79, &VeryVerbose_53);
