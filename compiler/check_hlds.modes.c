        ...
        if (check_hlds__modes__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(check_hlds__modes__Globals_46, (MR_Integer) 55, &check_hlds__modes__VeryVerbose_47);
            }
...

    {
      ...
      if ((check_hlds__modes__env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
      ...
      else
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(check_hlds__modes__Globals_22, (MR_Integer) 65, &check_hlds__modes__Statistics_24);
          }
          {
                  ...
                  if (check_hlds__modes__succeeded)
                    {
                      ...
                      {
                        libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_73, (MR_Integer) 182, &check_hlds__modes__MaxIterations_74);
                      }
                      {
                  ...
                  else
                    {
                      ...
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__modes__Globals_22, (MR_Integer) 69, &check_hlds__modes__DebugModes_25);
                      }
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_13, (MR_Integer) 182, &check_hlds__modes__MaxIterations_14);
    }
    {
