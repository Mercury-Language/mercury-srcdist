...
check_hlds__modes__IntroducedFrom__func__report_mode_inference_message__1983__1_1_f_0(
  MR_Word LambdaHeadVar__1_48);

static MR_bool MR_CALL 
check_hlds__modes__IntroducedFrom__pred__modecheck_queued_proc__1355__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_27)
{
  ...
  MainConsId_18 = ((MR_Word) ((MR_hl_field(0, Case0_15, 0))));
  OtherConsIds_19 = ((MR_Word) ((MR_hl_field(0, Case0_15, 1))));
  Goal0_20 = ((MR_Word) ((MR_hl_field(0, Case0_15, 2))));
  ...
  check_hlds__modecheck_util__modecheck_record_functors_test_5_p_0(Var_14, MainConsId_18, OtherConsIds_19, STATE_VARIABLE_ModeInfo_30_30, &STATE_VARIABLE_ModeInfo_31_31);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_24)
{
  ...
  check_hlds__unique_modes__unique_modes_prepare_for_disjunct_5_p_0(Disjunct0_19, DisjDetism_16, DisjNonLocals_17, STATE_VARIABLE_ModeInfo_28_28, &STATE_VARIABLE_ModeInfo_29_29);
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_12_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_74, (MR_Integer) 246, &InferModesOpt_75);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 250, &MaxIterations_16);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 346, &DelayPartialInstantiations_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_81, (MR_Integer) 250, &MaxIterations_82);
                {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_49 = check_hlds__modes__IntroducedFrom__func__report_mode_inference_message__1983__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modes__IntroducedFrom__pred__modecheck_queued_proc__1355__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          Var_80 = ((MR_Word) ((MR_hl_field(1, Origin_42, 0))));
          succeeded = ((((MR_tag((MR_Word) Var_80)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_80, 0)))) == (MR_Integer) 1)));
        }
        if (succeeded)
          *Specs_21 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          ...
          {
            MR_Word ErrorSpec_67 = ((MR_Word) ((MR_hl_field(1, AllErrorSpecs_66, 0))));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__modes__unique_modecheck_clause_switch_9_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) ((MR_hl_field(0, closure, 7)))), ((MR_Word) (wrapper_arg_1)), &conv10_Case_16, ((MR_Word) (wrapper_arg_3)), &conv9_STATE_VARIABLE_ModeInfo_27);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__modes__modecheck_clause_switch_9_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) ((MR_hl_field(0, closure, 7)))), ((MR_Word) (wrapper_arg_1)), &conv4_Case_16, ((MR_Word) (wrapper_arg_3)), &conv3_STATE_VARIABLE_ModeInfo_27);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__modes__modecheck_clause_disj_8_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) (wrapper_arg_1)), &conv1_Disjunct_14, ((MR_Word) (wrapper_arg_3)), &conv0_STATE_VARIABLE_ModeInfo_18);
