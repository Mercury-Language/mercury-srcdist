...

    {
      ...
      else
      {
        ...
        *STATE_VARIABLE_Specs_30 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_43_43, ThisPredDeclSpecs_20, Var_36);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 68, &Statistics_24);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 187, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_71, (MR_Integer) 187, &MaxIterations_72);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 72, &DebugModes_23);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_54, (MR_Integer) 58, &VeryVerbose_55);
