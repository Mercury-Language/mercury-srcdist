            ...
            if (check_hlds__modes__succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), check_hlds__modes__V_44_44, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 16));
            ...
            if (check_hlds__modes__succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), check_hlds__modes__V_87_87, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 16));
