...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_13, (MR_Integer) 186, &check_hlds__modes__MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(check_hlds__modes__Globals_13, (MR_Integer) 282, &check_hlds__modes__DelayPartialInstantiations_16);
            ...
            case (MR_Integer) 0:
              {
                ...
                if (check_hlds__modes__succeeded)
                {
                  ...
                  libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_71, (MR_Integer) 186, &check_hlds__modes__MaxIterations_72);
                  {
