  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          check_hlds__unify_proc__get_req_queue_2_p_0(check_hlds__modes__Requests0_15, &check_hlds__modes__RequestQueue0_16);
        }
        {
        ...
        if (check_hlds__modes__succeeded)
          {
            ...
            {
              check_hlds__unify_proc__set_req_queue_3_p_0(check_hlds__modes__RequestQueue1_18, check_hlds__modes__Requests0_15, &check_hlds__modes__Requests1_19);
            }
            {
...
{
  {
    ...
    if (check_hlds__modes__succeeded)
      {
        check_hlds__modes__Var_76 = (MR_Integer) 22;
        {
                  ...
                  if (check_hlds__modes__succeeded)
                    {
                      ...
                      {
                        libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_71, (MR_Integer) 184, &check_hlds__modes__MaxIterations_72);
                      }
                      {
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__modes__Globals_13, (MR_Integer) 184, &check_hlds__modes__MaxIterations_14);
    }
    {
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(check_hlds__modes__Globals_13, (MR_Integer) 280, &check_hlds__modes__DelayPartialInstantiations_16);
              }
