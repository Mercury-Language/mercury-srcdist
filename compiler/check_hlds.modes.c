...

  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ThisPredDeclSpecs_24, Var_43);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 687, &Statistics_28);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 762, &DelayPartialInstantiations_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 700, &DebugModes_28);
          ...
          case (MR_Integer) 0:
            {
              ...
              hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_1, STATE_VARIABLE_ArgModes_3_65, &InitialInsts_51);
