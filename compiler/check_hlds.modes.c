          ...
          case (MR_Integer) 0:
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
                ThisPredDeclSpecs_20 = (MR_Word) ((MR_Integer) 0);
              else
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if ((MaybeBeforeDPISeverity_24 == (MR_Word) ((MR_Integer) 0)))
                      if ((MaybeAfterDPISeverity_25 == (MR_Word) ((MR_Integer) 0)))
                      {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), GroundArgsSpec_20, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), UniquenessSpec_21, 0) = ((MR_Box) ((MR_Integer) 0));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = (Var_134 == (MR_Word) ((MR_Integer) 0));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if ((Free_131 == (MR_Word) ((MR_Integer) 0)))
                        succeeded = MR_TRUE;
                      else
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), MainSpec_22, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  while (MR_TRUE)
  {
    ...
    mercury__list__foldl3_8_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), (MR_Word) (&check_hlds__modes_scalar_common_1[0]), Var_32, PredIds_9, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_29)), &conv5_STATE_VARIABLE_ModuleInfo_33_33, ((MR_Box) ((MR_Integer) 0)), &conv4_Changed1_17, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_Specs_36_36);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) ((MR_Integer) 4));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Msg_74, 0) = ((MR_Box) ((MR_Integer) 0));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), MaxIterSpec_22, 0) = ((MR_Box) ((MR_Integer) 0));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      check_hlds__mode_errors__report_mode_inference_messages_for_preds_5_p_0(STATE_VARIABLE_ModuleInfo_37_37, (MR_Integer) 1, PredIds_9, (MR_Word) ((MR_Integer) 0), &InferenceSpecs_24);
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((Clauses_61 == (MR_Word) ((MR_Integer) 0)))
          ...
          if ((ModeErrors1_144 == (MR_Word) ((MR_Integer) 0)))
          {
            Body_78 = Body1_141;
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                  ...
                  if ((AllErrorSpecs_84 == (MR_Word) ((MR_Integer) 0)))
                  {
                    ErrorSpecs_87 = (MR_Word) ((MR_Integer) 0);
                    StateVarWarningSpecs_88 = (MR_Word) ((MR_Integer) 0);
                  }
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), ErrorSpecs_87, 1) = ((MR_Box) ((MR_Integer) 0));
                    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = (SolverNonLocals_44 == (MR_Word) ((MR_Integer) 0));
        }
      }
    }
    if (succeeded)
    ...
    else
    {
      ...
      if ((Errors_181 == (MR_Word) ((MR_Integer) 0)))
      {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_40)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = (Vars_14 == (MR_Word) ((MR_Integer) 0));

    // setup for model_det tailcalls optimized into a loop
    ;
    if (succeeded)
    {
      succeeded = (Insts_15 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
        succeeded = (VarInsts_16 == (MR_Word) ((MR_Integer) 0));
    }
    if (succeeded)
    {
