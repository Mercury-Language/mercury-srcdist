        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_97, (MR_Integer) 219, &InferModesOpt_98);
  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 223, &MaxIterations_14);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 319, &DelayPartialInstantiations_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 223, &MaxIterations_71);
                {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Spec_25, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 68) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_50, (MR_Integer) 73, &VeryVerbose_51);
