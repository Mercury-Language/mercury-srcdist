          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_101, (MR_Integer) 208, &InferModesOpt_102);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 212, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 312, &DelayPartialInstantiations_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 212, &MaxIterations_71);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 81, &DebugModes_23);
