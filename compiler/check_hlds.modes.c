        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              if ((env).check_hlds__modes__maybe_modecheck_pred_12_p_0_env_0__succeeded)
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_74, (MR_Integer) 235, &InferModesOpt_75);
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(2, Spec_82, 3) = ((MR_Box) (Msgs_77));
                      }
                      {
              ...
              else
              {
                ...
                Pieces_83 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__modes_scalar_common_1[25])), Var_111);
                {
                  ...
                  MR_hl_field(0, Spec_121, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.modes.maybe_report_error_no_modes\'/3"));
                  MR_hl_field(0, Spec_121, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_121, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__modes_scalar_common_3[0])));
                  MR_hl_field(0, Spec_121, 3) = ((MR_Box) (Context_120));
                  MR_hl_field(0, Spec_121, 4) = ((MR_Box) (Pieces_83));
                }
                {
                  ThisPredDeclSpecs_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 239, &MaxIterations_16);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 335, &DelayPartialInstantiations_21);
      ...
      if ((ModeErrors_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(2, GroundArgsSpec_28, 3) = ((MR_Box) (Var_68));
            }
            {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(2, UniquenessSpec_29, 3) = ((MR_Box) (Var_94));
            }
            {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_24, &Context_119);
          {
            ...
            MR_hl_field(0, MainSpec_30, 3) = ((MR_Box) (Context_119));
            MR_hl_field(0, MainSpec_30, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__modes_scalar_common_1[57])));
          }
          {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_81, (MR_Integer) 239, &MaxIterations_82);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 99, &DebugModes_28);
