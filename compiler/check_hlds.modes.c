...

    {
      ...
      else
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                if ((env).check_hlds__modes__maybe_modecheck_pred_9_p_0_env_0__succeeded)
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_101, (MR_Integer) 212, &InferModesOpt_102);
        ...
        *STATE_VARIABLE_Specs_32 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ThisPredDeclSpecs_20, Var_38);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 80, &Statistics_24);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 216, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_70, (MR_Integer) 216, &MaxIterations_71);
                {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 85, &DebugModes_23);
  ...
  MR_Word * STATE_VARIABLE_Specs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 71, &VerboseErrors_23);
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(2), Spec_25, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 65) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_54, (MR_Integer) 70, &VeryVerbose_55);
