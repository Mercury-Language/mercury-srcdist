...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 203, &MaxIterations_14);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 304, &DelayPartialInstantiations_16);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Msg_153 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Msg_153, 0) = ((MR_Box) (Context_151));
          MR_hl_field(MR_mktag(1), Msg_153, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__modes_scalar_common_1[51])));
        }
        {
          Var_181 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_181, 0) = ((MR_Box) (Msg_153));
          MR_hl_field(MR_mktag(1), Var_181, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MainSpec_22 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), MainSpec_22, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.modes.report_wrong_mode_for_main\'/1"));
          MR_hl_field(MR_mktag(0), MainSpec_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), MainSpec_22, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__modes_scalar_common_3[2])));
          MR_hl_field(MR_mktag(0), MainSpec_22, 3) = ((MR_Box) (Var_181));
        }
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_67, (MR_Integer) 203, &MaxIterations_68);
                {
