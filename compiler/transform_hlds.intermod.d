...
transform_hlds.intermod.optdate transform_hlds.intermod.trans_opt_date intermod.err transform_hlds.intermod.c_date transform_hlds.intermod.java_date : intermod.m \
	transform_hlds.int0 \
	assoc_list.int \
	backend_libs.int \
	bool.int \
...
#   long deps
#   short deps
transform_hlds.intermod.optdate transform_hlds.intermod.trans_opt_date intermod.err transform_hlds.intermod.c_date transform_hlds.intermod.java_date : \
		intermod.m \
	\
		transform_hlds.int0 \
	\
...
transform_hlds.intermod.pic_o transform_hlds.intermod.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
transform_hlds.intermod.mh transform_hlds.intermod.mih : transform_hlds.intermod.c
...
transform_hlds.intermod.module_dep : jmercury/transform_hlds__intermod.java
else
transform_hlds.intermod.module_dep : transform_hlds.intermod.c
endif
...
transform_hlds.intermod.date transform_hlds.intermod.date0 \
	transform_hlds.date : intermod.m \
	transform_hlds.int0 \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.intermod.date transform_hlds.intermod.date0 transform_hlds.date : \
		intermod.m \
	\
		transform_hlds.int0 \
	\
...
transform_hlds.intermod.date0 \
	transform_hlds.date0 : intermod.m \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.intermod.date0 transform_hlds.date0 : \
		intermod.m \
	\
		assoc_list.int3 \
		backend_libs.int3 \
...
transform_hlds.intermod.int0 : transform_hlds.intermod.date0
	@:
transform_hlds.intermod.int : transform_hlds.intermod.date
	@:
transform_hlds.intermod.int2 : transform_hlds.intermod.date
	@:
transform_hlds.intermod.int3 : transform_hlds.intermod.date3
	@:
transform_hlds.intermod.opt : transform_hlds.intermod.optdate
	@:
transform_hlds.intermod.trans_opt : transform_hlds.intermod.trans_opt_date
	@:
...
transform_hlds.intermod.date0 : intermod.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) transform_hlds.intermod
transform_hlds.intermod.date : intermod.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) transform_hlds.intermod
transform_hlds.intermod.date3 : intermod.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) transform_hlds.intermod
transform_hlds.intermod.optdate : intermod.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) transform_hlds.intermod
transform_hlds.intermod.trans_opt_date : intermod.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) transform_hlds.intermod
transform_hlds.intermod.c_date : intermod.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) transform_hlds.intermod $(ERR_REDIRECT)
transform_hlds.intermod.java_date : intermod.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only transform_hlds.intermod $(ERR_REDIRECT)
