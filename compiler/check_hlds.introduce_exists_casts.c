  ...
  MR_Word * STATE_VARIABLE_ProcInfo_46)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_45, &VarTable0_13);
  ...
  ExistConstraints_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredConstraints_10, (MR_Integer) 1))));
  ...
  GoalInfo0_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Body0_15, (MR_Integer) 1))));
  ...
  hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_42, GoalInfo0_38, &GoalInfo_43);
  {
    ...
    MR_hl_field(MR_mktag(3), Var_53, 2) = ((MR_Box) (Goals_40));
  }
  {
    Body_44 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Body_44, 0) = ((MR_Box) (Var_53));
    MR_hl_field(MR_mktag(0), Body_44, 1) = ((MR_Box) (GoalInfo_43));
  }
  hlds__hlds_pred__proc_info_set_body_vt_6_p_0(VarTable_34, HeadVars_41, Body_44, RttiVarMaps_35, STATE_VARIABLE_ProcInfo_0_45, STATE_VARIABLE_ProcInfo_46);
}
  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_11)
{
  ...
  {
    MR_Word ModeAndVar_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0))));
    MR_Word ModesAndVars_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
    MR_Word Var_33;
    MR_Word Vars_34;
    MR_Word ArgMode_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModeAndVar_31, (MR_Integer) 0))));
    MR_Word Var0_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModeAndVar_31, (MR_Integer) 1))));
    ...
    {
      MR_Word Context_40;
      MR_Word ExtraGoal_41;
      MR_Word VarInfo_42;
      MR_Word OldVarEntry_73;
      MR_String OldName_74;
      MR_Word OldType_75;
      MR_Word OldTypeIsDummy_76;
      MR_String CloneName_77;
      MR_Word CloneVarEntry_78;

      parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_0_6, Var0_39, &OldVarEntry_73);
      OldName_74 = ((MR_String) ((MR_hl_field(MR_mktag(0), OldVarEntry_73, (MR_Integer) 0))));
      OldType_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OldVarEntry_73, (MR_Integer) 1))));
      OldTypeIsDummy_76 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OldVarEntry_73, (MR_Integer) 2))) & (MR_Integer) 1);
      CloneName_77 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", OldName_74);
      {
        CloneVarEntry_78 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CloneVarEntry_78, 0) = ((MR_Box) (CloneName_77));
        MR_hl_field(MR_mktag(0), CloneVarEntry_78, 1) = ((MR_Box) (OldType_75));
        MR_hl_field(MR_mktag(0), CloneVarEntry_78, 2) = (MR_Box) ((MR_Unsigned) (OldTypeIsDummy_76));
      }
      parse_tree__var_table__add_var_entry_4_p_0(CloneVarEntry_78, &Var_33, STATE_VARIABLE_VarTable_0_6, &STATE_VARIABLE_VarTable_56_56);
      mercury__term__context_init_1_p_0(&Context_40);
      hlds__goal_util__generate_cast_5_p_0((MR_Integer) 3, Var0_39, Var_33, Context_40, &ExtraGoal_41);
      {
        STATE_VARIABLE_ExtraGoals_58_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_ExtraGoals_58_58, 0) = ((MR_Box) (ExtraGoal_41));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_ExtraGoals_58_58, 1) = ((MR_Box) (STATE_VARIABLE_ExtraGoals_0_10));
      }
      hlds__hlds_rtti__rtti_varmaps_var_info_3_p_0(STATE_VARIABLE_RttiVarMaps_0_8, Var0_39, &VarInfo_42);
      switch (MR_tag((MR_Word) VarInfo_42)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word TypeInfoType0_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarInfo_42, (MR_Integer) 0))));
            MR_Word TypeInfoType_44;
            MR_Word STATE_VARIABLE_RttiVarMaps_59_59;

            parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(Subn_2, TypeInfoType0_43, &TypeInfoType_44);
            hlds__hlds_rtti__rtti_set_type_info_type_4_p_0(Var0_39, TypeInfoType_44, STATE_VARIABLE_RttiVarMaps_0_8, &STATE_VARIABLE_RttiVarMaps_59_59);
            hlds__hlds_rtti__rtti_det_insert_type_info_type_4_p_0(Var_33, TypeInfoType0_43, STATE_VARIABLE_RttiVarMaps_59_59, &STATE_VARIABLE_RttiVarMaps_60_60);
            ExistConstraints_45 = HeadVar__3_3;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word ExistConstraint_47;
            MR_Word ConstraintArgs_49;
            ...
            {
              ExistConstraint_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
              ExistConstraints_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
            }
            hlds__hlds_rtti__rtti_det_insert_typeclass_info_var_4_p_0(ExistConstraint_47, Var_33, STATE_VARIABLE_RttiVarMaps_0_8, &STATE_VARIABLE_RttiVarMaps_63_63);
            ConstraintArgs_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExistConstraint_47, (MR_Integer) 1))));
            check_hlds__introduce_exists_casts__maybe_add_type_info_locns_5_p_0(ConstraintArgs_49, Var_33, (MR_Integer) 1, STATE_VARIABLE_RttiVarMaps_63_63, &STATE_VARIABLE_RttiVarMaps_60_60);
          }
          break;
      }
    }
    else
    {
      ...
      STATE_VARIABLE_VarTable_56_56 = STATE_VARIABLE_VarTable_0_6;
    }
    check_hlds__introduce_exists_casts__introduce_exists_casts_extra_11_p_0(ModuleInfo_1, Subn_2, ExistConstraints_45, ModesAndVars_32, &Vars_34, STATE_VARIABLE_VarTable_56_56, STATE_VARIABLE_VarTable_7, STATE_VARIABLE_RttiVarMaps_60_60, STATE_VARIABLE_RttiVarMaps_9, STATE_VARIABLE_ExtraGoals_58_58, STATE_VARIABLE_ExtraGoals_11);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__5_5 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Var_33));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Vars_34));
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_31)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ArgType_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_13, (MR_Integer) 0))));
      ArgTypesRest_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgTypes_13, (MR_Integer) 1))));
      succeeded = (ArgModes_14 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ArgMode_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgModes_14, (MR_Integer) 0))));
        ArgModesRest_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgModes_14, (MR_Integer) 1))));
        succeeded = (STATE_VARIABLE_HeadVars_0_26 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          HeadVar0_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_HeadVars_0_26, (MR_Integer) 0))));
          HeadVarsRest0_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_HeadVars_0_26, (MR_Integer) 1))));
        }
      }
    }
    if (succeeded)
    {
      ...
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(Subn_12, ArgType_18, &InternalType_51);
      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(InternalType_51, ArgType_18);
      if (succeeded)
      {
      ...
      else
      {
        MR_Word Inst_53;
        MR_Word Context_54;
        MR_Word ExtraGoal_55;
        MR_Word InternalTypeIsDummy_68;
        MR_Word ExternalTypeIsDummy_69;
        MR_Word InternalVarEntry0_70;
        MR_String InternalName_71;
        MR_Word InternalVarEntry_74;
        MR_String ExternalName_75;
        MR_Word ExternalVarEntry_76;
        MR_Word STATE_VARIABLE_VarTable_26_78;
        MR_Word Var_52;

        InternalTypeIsDummy_68 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, InternalType_51);
        ExternalTypeIsDummy_69 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, ArgType_18);
        parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_32_32, HeadVar0_22, &InternalVarEntry0_70);
        InternalName_71 = ((MR_String) ((MR_hl_field(MR_mktag(0), InternalVarEntry0_70, (MR_Integer) 0))));
        {
          InternalVarEntry_74 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InternalVarEntry_74, 0) = ((MR_Box) (InternalName_71));
          MR_hl_field(MR_mktag(0), InternalVarEntry_74, 1) = ((MR_Box) (InternalType_51));
          MR_hl_field(MR_mktag(0), InternalVarEntry_74, 2) = (MR_Box) ((MR_Unsigned) (InternalTypeIsDummy_68));
        }
        ExternalName_75 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", InternalName_71);
        {
          ExternalVarEntry_76 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ExternalVarEntry_76, 0) = ((MR_Box) (ExternalName_75));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_76, 1) = ((MR_Box) (ArgType_18));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_76, 2) = (MR_Box) ((MR_Unsigned) (ExternalTypeIsDummy_69));
        }
        parse_tree__var_table__update_var_entry_4_p_0(HeadVar0_22, InternalVarEntry_74, STATE_VARIABLE_VarTable_32_32, &STATE_VARIABLE_VarTable_26_78);
        parse_tree__var_table__add_var_entry_4_p_0(ExternalVarEntry_76, &HeadVar_25, STATE_VARIABLE_VarTable_26_78, STATE_VARIABLE_VarTable_29);
        check_hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_11, ArgMode_20, &Var_52, &Inst_53);
        mercury__term__context_init_1_p_0(&Context_54);
        hlds__goal_util__generate_cast_with_insts_7_p_0((MR_Integer) 3, HeadVar0_22, HeadVar_25, Inst_53, Inst_53, Context_54, &ExtraGoal_55);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_ExtraGoals_31 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ExtraGoal_55));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_ExtraGoals_33_33));
        }
      }
      {
        MR_Word base;
        ...
        *STATE_VARIABLE_HeadVars_27 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (HeadVar_25));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (HeadVarsRest_24));
      }
    }
    else
      {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__introduce_exists_casts__introduce_exists_casts_proc_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_ProcInfo_46);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_6, &ProcMap0_7);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&check_hlds__introduce_exists_casts_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_12, 1) = ((MR_Box) (check_hlds__introduce_exists_casts__introduce_exists_casts_poly_3_p_0_1));
    MR_hl_field(MR_mktag(0), Var_12, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_12, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_10));
    MR_hl_field(MR_mktag(0), Var_12, 4) = ((MR_Box) (PredInfo0_6));
  }
