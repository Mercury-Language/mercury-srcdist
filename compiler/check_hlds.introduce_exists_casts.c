...
static void MR_CALL 
check_hlds__introduce_exists_casts__introduce_exists_casts_pred_4_p_0(
...
static /* final */ const MR_Box check_hlds__introduce_exists_casts_scalar_common_3[1][7];
...
{
  {
    ...
    succeeded = mercury__map__is_empty_1_p_0((MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, Subn_9);
    succeeded = !(succeeded);
    if (succeeded)
...
{
  {
    ...
    if (succeeded)
    {
      TypeInfo_62_62 = (MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[0];
    ...
    TypeInfo_65_65 = (MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[0];
...
{
  {
    ...
    check_hlds__introduce_exists_casts__introduce_exists_casts_pred_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_STATE_VARIABLE_PredTable_15);
