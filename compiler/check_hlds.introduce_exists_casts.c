...
{
  {
    ...
    Var_50 = mercury__list__length_1_f_0(TypeCtorInfo_60_60, ArgTypes_8);
    ...
    succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_60_60, NumExtraHeadVars_12, ArgTypes_8, &OrigArgTypes0_19);
    if (succeeded)
    {
    ...
    check_hlds__introduce_exists_casts__introduce_exists_casts_for_head_12_p_0(ModuleInfo_5, Subn_9, OrigArgTypes_24, OrigArgModes_28, OrigHeadVars1_26, &OrigHeadVars_29, VarSet0_13, &VarSet1_30, VarTypes0_14, &VarTypes1_31, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ExistsCastHeadGoals_32);
    Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredConstraints_10, (MR_Integer) 0)));
    ExistConstraints_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredConstraints_10, (MR_Integer) 1)));
    TypeInfo_64_64 = (MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[1];
    mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0, TypeInfo_64_64, ExtraArgModes_27, ExtraHeadVars1_25, &ExtraModesAndVars_34);
    check_hlds__introduce_exists_casts__introduce_exists_casts_extra_13_p_0(ModuleInfo_5, Subn_9, ExistConstraints_33, ExtraModesAndVars_34, &ExtraHeadVars_35, VarSet1_30, &VarSet_36, VarTypes1_31, &VarTypes_37, RttiVarMaps0_17, &RttiVarMaps_38, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ExistsCastExtraGoals_39);
    ...
    TypeCtorInfo_65_65 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
    Var_55 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_65_65, ExistsCastHeadGoals_32, ExistsCastExtraGoals_39);
    Goals_43 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_65_65, Goals0_42, Var_55);
    HeadVars_44 = mercury__list__f_43_43_2_f_0(TypeInfo_64_64, ExtraHeadVars_35, OrigHeadVars_29);
    ...
    hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_45, GoalInfo0_41, &GoalInfo_46);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_56, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__mode_util__mode_is_output_2_p_0(ModuleInfo_1, ArgMode_44);
      if (succeeded)
      {
        MR_Word TypeCtorInfo_15_92;
        MR_Word Context_46;
        MR_Word VarType_47;
        ...
        TypeCtorInfo_15_92 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
        mercury__varset__new_var_3_p_0(TypeCtorInfo_15_92, &Var_38, STATE_VARIABLE_VarSet_0_6, &STATE_VARIABLE_VarSet_12_89);
        mercury__varset__lookup_name_3_p_0(TypeCtorInfo_15_92, STATE_VARIABLE_VarSet_12_89, Var0_45, &InternalName_87);
        mercury__string__append_3_p_2((MR_String) "ExistQ", InternalName_87, &ExternalName_88);
        mercury__varset__name_var_4_p_0(TypeCtorInfo_15_92, Var_38, ExternalName_88, STATE_VARIABLE_VarSet_12_89, &STATE_VARIABLE_VarSet_65_65);
        ...
        {
          STATE_VARIABLE_ExtraGoals_68_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraint_54, (MR_Integer) 0)));
  ...
  MR_Word * STATE_VARIABLE_RttiVarMaps_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_23 = (MR_Integer) ((MR_Unsigned) Num_3 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          TypeCtorInfo_15_83 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
          mercury__varset__new_var_3_p_0(TypeCtorInfo_15_83, &HeadVar_28, STATE_VARIABLE_VarSet_37_37, &STATE_VARIABLE_VarSet_12_80);
          mercury__varset__lookup_name_3_p_0(TypeCtorInfo_15_83, STATE_VARIABLE_VarSet_12_80, HeadVar0_25, &InternalName_78);
          mercury__string__append_3_p_2((MR_String) "ExistQ", InternalName_78, &ExternalName_79);
          mercury__varset__name_var_4_p_0(TypeCtorInfo_15_83, HeadVar_28, ExternalName_79, STATE_VARIABLE_VarSet_12_80, STATE_VARIABLE_VarSet_32);
...
{
  {
    ...
    TypeCtorInfo_17_17 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
    mercury__map__lookup_3_p_0(TypeCtorInfo_16_16, TypeCtorInfo_17_17, PredMap0_6, ((MR_Box) (PredId_4)), &conv0_PredInfo0_7);
    ...
    TypeCtorInfo_20_20 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
    mercury__map__map_values_only_3_p_0(TypeCtorInfo_20_20, TypeCtorInfo_20_20, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, Var_14, ProcMap0_8, &ProcMap_9);
    hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcMap_9, PredInfo0_7, &PredInfo_10);
    mercury__map__det_update_4_p_0(TypeCtorInfo_16_16, TypeCtorInfo_17_17, ((MR_Box) (PredId_4)), ((MR_Box) (PredInfo_10)), PredMap0_6, &PredMap_11);
