  ...
  MR_Word * STATE_VARIABLE_ProcInfo_49)
{
  ...
  if (succeeded)
  {
    TypeInfo__61_61 = (MR_Word) (&check_hlds__introduce_exists_casts_scalar_common_2[1]);
    succeeded = mercury__list__split_list_4_p_0(TypeInfo__61_61, NumExtraHeadVars_12, HeadVars0_15, &ExtraHeadVars0_20, &OrigHeadVars0_21);
    if (succeeded)
    {
      TypeCtorInfo__62_62 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0);
      succeeded = mercury__list__split_list_4_p_0(TypeCtorInfo__62_62, NumExtraHeadVars_12, ArgModes_18, &ExtraArgModes0_22, &OrigArgModes0_23);
    }
  }
  if (succeeded)
  {
