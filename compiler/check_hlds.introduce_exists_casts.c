...
{
  {
    ...
    if (succeeded)
    {
      TypeInfo_62_62 = (MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[1];
    ...
    {
      {
        mercury__require__unexpected_3_p_0((MR_String) "check_hlds.introduce_exists_casts", (MR_String) "predicate \140check_hlds.introduce_exists_casts.introduce_exists_casts_proc\'/4", (MR_String) "split_list failed");
        return;
      }
    }
    ...
    TypeInfo_65_65 = (MR_Word) &check_hlds__introduce_exists_casts_scalar_common_2[1];
...
{
  {
    ...
    if ((HeadVar__4_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *HeadVar__5_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      {
        {
          mercury__require__unexpected_3_p_0((MR_String) "check_hlds.introduce_exists_casts", (MR_String) "predicate \140check_hlds.introduce_exists_casts.introduce_exists_casts_extra\'/13", (MR_String) "length mismatch");
          return;
        }
      }
      ...
      if (succeeded)
      {
        ...
        switch (MR_tag((MR_Word) VarInfo_50)) {
          ...
          case (MR_Integer) 0:
            {
              {
                mercury__require__unexpected_3_p_0((MR_String) "check_hlds.introduce_exists_casts", (MR_String) "predicate \140check_hlds.introduce_exists_casts.introduce_exists_casts_extra\'/13", (MR_String) "rtti_varmaps info not found");
                return;
              }
            }
            break;
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                {
                  mercury__require__unexpected_3_p_0((MR_String) "check_hlds.introduce_exists_casts", (MR_String) "predicate \140check_hlds.introduce_exists_casts.introduce_exists_casts_extra\'/13", (MR_String) "missing constraint");
                  return;
                }
              }
              else
              ...
              check_hlds__introduce_exists_casts__maybe_add_type_info_locns_5_p_0(ConstraintArgs_57, Var_39, (MR_Integer) 1, STATE_VARIABLE_RttiVarMaps_76_76, &STATE_VARIABLE_RttiVarMaps_80_80);
            }
            break;
        }
      }
...
{
  {
    ...
    else
    {
      ...
      {
        {
          mercury__require__unexpected_3_p_0((MR_String) "check_hlds.introduce_exists_casts", (MR_String) "predicate \140check_hlds.introduce_exists_casts.introduce_exists_casts_for_head\'/12", (MR_String) "length mismatch");
          return;
        }
      }
    }
