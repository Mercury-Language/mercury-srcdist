...
{
  {
    ...
    check_hlds__introduce_exists_casts__introduce_exists_casts_for_head_12_p_0(ModuleInfo_5, Subn_9, OrigArgTypes_24, OrigArgModes_28, OrigHeadVars1_26, &OrigHeadVars_29, VarSet0_13, &VarSet1_30, VarTypes0_14, &VarTypes1_31, (MR_Word) ((MR_Integer) 0), &ExistsCastHeadGoals_32);
    ...
    check_hlds__introduce_exists_casts__introduce_exists_casts_extra_13_p_0(ModuleInfo_5, Subn_9, ExistConstraints_33, ExtraModesAndVars_34, &ExtraHeadVars_35, VarSet1_30, &VarSet_36, VarTypes1_31, &VarTypes_37, RttiVarMaps0_17, &RttiVarMaps_38, (MR_Word) ((MR_Integer) 0), &ExistsCastExtraGoals_39);
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = (ArgModes_16 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
        succeeded = (STATE_VARIABLE_HeadVars_0_29 == (MR_Word) ((MR_Integer) 0));
    }
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) ArgModes_16)) == (MR_Integer) 1);
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_HeadVars_0_29)) == (MR_Integer) 1);
          if (succeeded)
          {
