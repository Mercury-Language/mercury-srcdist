  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_11)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word VarInfo_42;
      MR_Word OldVarEntry_76;
      MR_String OldName_77;
      MR_Word OldType_78;
      MR_Word OldTypeIsDummy_79;
      MR_String CloneName_80;
      MR_Word CloneVarEntry_81;

      parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_0_6, Var0_39, &OldVarEntry_76);
      OldName_77 = ((MR_String) ((MR_hl_field(MR_mktag(0), OldVarEntry_76, (MR_Integer) 0))));
      OldType_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OldVarEntry_76, (MR_Integer) 1))));
      OldTypeIsDummy_79 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OldVarEntry_76, (MR_Integer) 2))) & (MR_Integer) 1);
      CloneName_80 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", OldName_77);
      {
        CloneVarEntry_81 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CloneVarEntry_81, 0) = ((MR_Box) (CloneName_80));
        MR_hl_field(MR_mktag(0), CloneVarEntry_81, 1) = ((MR_Box) (OldType_78));
        MR_hl_field(MR_mktag(0), CloneVarEntry_81, 2) = (MR_Box) ((MR_Unsigned) (OldTypeIsDummy_79));
      }
      parse_tree__var_table__add_var_entry_4_p_0(CloneVarEntry_81, &Var_33, STATE_VARIABLE_VarTable_0_6, &STATE_VARIABLE_VarTable_56_56);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Word InternalTypeIsDummy_69;
        MR_Word ExternalTypeIsDummy_70;
        MR_Word InternalVarEntry0_71;
        MR_String InternalName_72;
        MR_Word InternalVarEntry_75;
        MR_String ExternalName_76;
        MR_Word ExternalVarEntry_77;
        MR_Word STATE_VARIABLE_VarTable_26_79;
        MR_Word Var_52;

        InternalTypeIsDummy_69 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, InternalType_51);
        ExternalTypeIsDummy_70 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, ArgType_18);
        parse_tree__var_table__lookup_var_entry_3_p_0(STATE_VARIABLE_VarTable_32_32, HeadVar0_22, &InternalVarEntry0_71);
        InternalName_72 = ((MR_String) ((MR_hl_field(MR_mktag(0), InternalVarEntry0_71, (MR_Integer) 0))));
        {
          InternalVarEntry_75 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InternalVarEntry_75, 0) = ((MR_Box) (InternalName_72));
          MR_hl_field(MR_mktag(0), InternalVarEntry_75, 1) = ((MR_Box) (InternalType_51));
          MR_hl_field(MR_mktag(0), InternalVarEntry_75, 2) = (MR_Box) ((MR_Unsigned) (InternalTypeIsDummy_69));
        }
        ExternalName_76 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", InternalName_72);
        {
          ExternalVarEntry_77 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ExternalVarEntry_77, 0) = ((MR_Box) (ExternalName_76));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_77, 1) = ((MR_Box) (ArgType_18));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_77, 2) = (MR_Box) ((MR_Unsigned) (ExternalTypeIsDummy_70));
        }
        parse_tree__var_table__update_var_entry_4_p_0(HeadVar0_22, InternalVarEntry_75, STATE_VARIABLE_VarTable_32_32, &STATE_VARIABLE_VarTable_26_79);
        parse_tree__var_table__add_var_entry_4_p_0(ExternalVarEntry_77, &HeadVar_25, STATE_VARIABLE_VarTable_26_79, STATE_VARIABLE_VarTable_29);
