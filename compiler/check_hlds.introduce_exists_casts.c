  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_13)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word VarInfo_49;
      MR_String InternalName_83;
      MR_String ExternalName_84;
      MR_Word STATE_VARIABLE_VarSet_12_85;

      mercury__term__context_init_1_p_0(&Context_46);
      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &Var_38, STATE_VARIABLE_VarSet_0_6, &STATE_VARIABLE_VarSet_12_85);
      mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_VarSet_12_85, Var0_45, &InternalName_83);
      mercury__string__append_3_p_2((MR_String) "ExistQ", InternalName_83, &ExternalName_84);
      mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_38, ExternalName_84, STATE_VARIABLE_VarSet_12_85, &STATE_VARIABLE_VarSet_65_65);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        parse_tree__vartypes__update_var_type_4_p_0(HeadVar0_25, InternalType_61, STATE_VARIABLE_VarTypes_38_38, &STATE_VARIABLE_VarTypes_33_66);
        ...
        parse_tree__vartypes__add_var_type_4_p_0(HeadVar_28, ArgType_21, STATE_VARIABLE_VarTypes_33_66, STATE_VARIABLE_VarTypes_34);
