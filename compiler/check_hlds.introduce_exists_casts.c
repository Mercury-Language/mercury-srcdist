...
static const MR_FA_PseudoTypeInfo_Struct2 check_hlds__introduce_exists_casts__tree234__pti_tree234_2__plain_hlds__pred_proc_id__type_ctor_info_pred_id_0__plain_hlds__hlds_pred__type_ctor_info_pred_info_0;
...
static /* final */ const MR_Box check_hlds__introduce_exists_casts_scalar_common_3[2][7] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0)),
    ((MR_Box) (&check_hlds__introduce_exists_casts__tree234__pti_tree234_2__plain_hlds__pred_proc_id__type_ctor_info_pred_id_0__plain_hlds__hlds_pred__type_ctor_info_pred_info_0)),
    ((MR_Box) (&check_hlds__introduce_exists_casts__tree234__pti_tree234_2__plain_hlds__pred_proc_id__type_ctor_info_pred_id_0__plain_hlds__hlds_pred__type_ctor_info_pred_info_0))
  },
  /* row   1 */
  {
  ...
  MR_Word * STATE_VARIABLE_PredTable_15)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), STATE_VARIABLE_PredTable_0_14, ((MR_Box) (PredId_6)), &conv0_PredInfo0_8);
  ...
  if (succeeded)
  {
    ...
    ProcIds_11 = hlds__hlds_pred__pred_info_will_codegen_proc_ids_1_f_0(PredInfo0_8);
    ...
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), ((MR_Box) (PredId_6)), ((MR_Box) (PredInfo_13)), STATE_VARIABLE_PredTable_0_14, STATE_VARIABLE_PredTable_15);
  }
  else
  ...
  MR_Word * STATE_VARIABLE_Procs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), STATE_VARIABLE_Procs_0_4, ((MR_Box) (ProcId_13)), &conv0_ProcInfo0_16);
      ...
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_13)), ((MR_Box) (ProcInfo_17)), STATE_VARIABLE_Procs_0_4, &STATE_VARIABLE_Procs_1_20);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_46)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_45, &VarTable0_13);
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_45, &HeadVars0_14);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_45, &Body0_15);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_45, &RttiVarMaps0_16);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_0_45, &ArgModes_17);
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(Body0_15, &Goals0_39);
  ...
  hlds__hlds_proc__proc_info_set_body_6_p_0(VarTable_34, HeadVars_41, Body_44, RttiVarMaps_35, STATE_VARIABLE_ProcInfo_0_45, STATE_VARIABLE_ProcInfo_46);
}
  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_11)
{
  ...
  else
  {
    ...
    succeeded = hlds__mode_test__mode_is_output_2_p_0(ModuleInfo_1, ArgMode_38);
    if (succeeded)
    {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        InternalTypeIsDummy_47 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, InternalType_39);
        ExternalTypeIsDummy_48 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_11, ArgType_18);
        ...
        hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_11, ArgMode_20, &Var_40, &Inst_41);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  mercury__map__map_values_only_3_p_0((MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), Var_12, ProcMap0_7, &ProcMap_8);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__introduce_exists_casts_scalar_common_1[0]), Var_10, PredIds_4, ((MR_Box) (PredIdTable0_6)), &conv1_PredIdTable_7);
