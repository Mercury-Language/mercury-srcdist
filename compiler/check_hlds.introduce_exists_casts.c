  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__goal_util__generate_cast_5_p_0((MR_Integer) 3, Var0_39, Var_33, Var_57, &ExtraGoal_40);
      {
        ...
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_ExtraGoals_58_58, 0) = ((MR_Box) (ExtraGoal_40));
      ...
      switch (MR_tag((MR_Word) VarInfo_41)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word TypeInfoType0_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarInfo_41, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              ExistConstraint_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
              ExistConstraints_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
            }
            ...
            ConstraintArgs_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExistConstraint_46, (MR_Integer) 1))));
      ...
      else
      {
        ...
        hlds__goal_util__generate_cast_with_insts_7_p_0((MR_Integer) 3, HeadVar0_22, HeadVar_25, Inst_41, Inst_41, Var_45, &ExtraGoal_42);
        {
          ...
          *STATE_VARIABLE_ExtraGoals_31 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ExtraGoal_42));
