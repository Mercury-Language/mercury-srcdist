  ...
  MR_Word * STATE_VARIABLE_ProcInfo_49)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_48, &VarSet0_13, &VarTypes0_14);
  ...
  if (succeeded)
  {
    TypeInfo_60_60 = (MR_Word) (&check_hlds__introduce_exists_casts_scalar_common_2[1]);
    succeeded = mercury__list__split_list_4_p_0(TypeInfo_60_60, NumExtraHeadVars_12, HeadVars0_15, &ExtraHeadVars0_20, &OrigHeadVars0_21);
    if (succeeded)
    {
      TypeCtorInfo_61_61 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0);
      succeeded = mercury__list__split_list_4_p_0(TypeCtorInfo_61_61, NumExtraHeadVars_12, ArgModes_18, &ExtraArgModes0_22, &OrigArgModes0_23);
    }
  }
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_13)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_RttiVarMaps_70_70;
    ...
    if (succeeded)
    {
      ...
      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &Var_38, STATE_VARIABLE_VarSet_0_6, &STATE_VARIABLE_VarSet_12_80);
      mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_VarSet_12_80, Var0_45, &InternalName_78);
      mercury__string__append_3_p_2((MR_String) "ExistQ", InternalName_78, &ExternalName_79);
      mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_38, ExternalName_79, STATE_VARIABLE_VarSet_12_80, &STATE_VARIABLE_VarSet_65_65);
      parse_tree__vartypes__lookup_var_type_3_p_0(STATE_VARIABLE_VarTypes_0_8, Var0_45, &VarType_47);
      parse_tree__vartypes__add_var_type_4_p_0(Var_38, VarType_47, STATE_VARIABLE_VarTypes_0_8, &STATE_VARIABLE_VarTypes_66_66);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word STATE_VARIABLE_RttiVarMaps_69_69;

            parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(Subn_2, TypeInfoType0_50, &TypeInfoType_51);
            hlds__hlds_rtti__rtti_set_type_info_type_4_p_0(Var0_45, TypeInfoType_51, STATE_VARIABLE_RttiVarMaps_0_10, &STATE_VARIABLE_RttiVarMaps_69_69);
            hlds__hlds_rtti__rtti_det_insert_type_info_type_4_p_0(Var_38, TypeInfoType0_50, STATE_VARIABLE_RttiVarMaps_69_69, &STATE_VARIABLE_RttiVarMaps_70_70);
        ...
        case (MR_Integer) 2:
          {
            ...
            check_hlds__introduce_exists_casts__maybe_add_type_info_locns_5_p_0(ConstraintArgs_56, Var_38, (MR_Integer) 1, STATE_VARIABLE_RttiVarMaps_73_73, &STATE_VARIABLE_RttiVarMaps_70_70);
          }
          break;
      }
    }
  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_36)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(Subn_14, ArgType_21, &InternalType_46);
      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(InternalType_46, ArgType_21);
      if (succeeded)
      {
      ...
      else
      {
        MR_Word Context_47;
        MR_Word Inst_49;
        MR_Word ExtraGoal_50;
        MR_Word STATE_VARIABLE_VarTypes_33_51;
        MR_String InternalName_55;
        MR_String ExternalName_56;
        MR_Word STATE_VARIABLE_VarSet_12_57;
        MR_Word Var_48;

        mercury__term__context_init_1_p_0(&Context_47);
        parse_tree__vartypes__update_var_type_4_p_0(HeadVar0_25, InternalType_46, STATE_VARIABLE_VarTypes_38_38, &STATE_VARIABLE_VarTypes_33_51);
        mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &HeadVar_28, STATE_VARIABLE_VarSet_37_37, &STATE_VARIABLE_VarSet_12_57);
        mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_VarSet_12_57, HeadVar0_25, &InternalName_55);
        mercury__string__append_3_p_2((MR_String) "ExistQ", InternalName_55, &ExternalName_56);
        mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVar_28, ExternalName_56, STATE_VARIABLE_VarSet_12_57, STATE_VARIABLE_VarSet_32);
        parse_tree__vartypes__add_var_type_4_p_0(HeadVar_28, ArgType_21, STATE_VARIABLE_VarTypes_33_51, STATE_VARIABLE_VarTypes_34);
        check_hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_13, ArgMode_23, &Var_48, &Inst_49);
        hlds__goal_util__generate_cast_with_insts_7_p_0((MR_Integer) 3, HeadVar0_25, HeadVar_28, Inst_49, Inst_49, Context_47, &ExtraGoal_50);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_ExtraGoals_36 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ExtraGoal_50));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  MR_Word conv0_STATE_VARIABLE_ProcInfo_49;

  check_hlds__introduce_exists_casts__introduce_exists_casts_proc_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_ProcInfo_49);
  *wrapper_arg_2 = ((MR_Box) (conv0_STATE_VARIABLE_ProcInfo_49));
}
