  ...
  MR_Word * STATE_VARIABLE_ExtraGoals_11)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      OldName_69 = ((MR_String) ((MR_hl_field(MR_mktag(0), OldVarEntry_68, (MR_Integer) 0))));
      OldType_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OldVarEntry_68, (MR_Integer) 1))));
      OldTypeIsDummy_71 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OldVarEntry_68, (MR_Integer) 2))) & (MR_Integer) 1);
      CloneName_72 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", OldName_69);
      {
        ...
        MR_hl_field(MR_mktag(0), CloneVarEntry_73, 0) = ((MR_Box) (CloneName_72));
        MR_hl_field(MR_mktag(0), CloneVarEntry_73, 1) = ((MR_Box) (OldType_70));
        MR_hl_field(MR_mktag(0), CloneVarEntry_73, 2) = (MR_Box) ((MR_Unsigned) (OldTypeIsDummy_71));
      }
      parse_tree__var_table__add_var_entry_4_p_0(CloneVarEntry_73, &Var_33, STATE_VARIABLE_VarTable_0_6, &STATE_VARIABLE_VarTable_56_56);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        InternalName_50 = ((MR_String) ((MR_hl_field(MR_mktag(0), InternalVarEntry0_49, (MR_Integer) 0))));
        {
          InternalVarEntry_53 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InternalVarEntry_53, 0) = ((MR_Box) (InternalName_50));
          MR_hl_field(MR_mktag(0), InternalVarEntry_53, 1) = ((MR_Box) (InternalType_39));
          MR_hl_field(MR_mktag(0), InternalVarEntry_53, 2) = (MR_Box) ((MR_Unsigned) (InternalTypeIsDummy_47));
        }
        ExternalName_54 = mercury__string__f_43_43_2_f_0((MR_String) "ExistQ", InternalName_50);
        {
          ...
          MR_hl_field(MR_mktag(0), ExternalVarEntry_55, 0) = ((MR_Box) (ExternalName_54));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_55, 1) = ((MR_Box) (ArgType_18));
          MR_hl_field(MR_mktag(0), ExternalVarEntry_55, 2) = (MR_Box) ((MR_Unsigned) (ExternalTypeIsDummy_48));
        }
        ...
        mercury__term__context_init_1_p_0(&Context_42);
        hlds__goal_util__generate_cast_with_insts_7_p_0((MR_Integer) 3, HeadVar0_22, HeadVar_25, Inst_41, Inst_41, Context_42, &ExtraGoal_43);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_ExtraGoals_31 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ExtraGoal_43));
