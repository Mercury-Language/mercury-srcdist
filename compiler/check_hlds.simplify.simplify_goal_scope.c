        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_26, (MR_Integer) 354, &check_hlds__simplify__simplify_goal_scope__CommonStruct_27);
        ...
        case (MR_Integer) 1:
          {
            ...
            check_hlds__simplify__simplify_goal_scope__Var_122 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_scope__TermConstStruct_46, (MR_Integer) 3)));
            {
              ...
              MR_hl_field(MR_mktag(3), check_hlds__simplify__simplify_goal_scope__ConsId_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 21));
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (check_hlds__simplify__simplify_goal_scope__Grade_22) {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 264, &check_hlds__simplify__simplify_goal_scope__NotResult_26);
                  ...
                  case (MR_Integer) 8:
                    {
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 264, &check_hlds__simplify__simplify_goal_scope__Result_6);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 203, &check_hlds__simplify__simplify_goal_scope__ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 204, &check_hlds__simplify__simplify_goal_scope__ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 205, &check_hlds__simplify__simplify_goal_scope__ProfMem_25);
                      {
                  ...
                  case (MR_Integer) 3:
                    {
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 206, &check_hlds__simplify__simplify_goal_scope__Result_6);
                    }
                    break;
                  case (MR_Integer) 6:
                    {
                  ...
                  case (MR_Integer) 1:
                    {
                      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 244, &check_hlds__simplify__simplify_goal_scope__Result_6);
                    }
                    break;
                  case (MR_Integer) 5:
                    {
