          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 166, &Flags_18);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 313, &NotResult_23);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 246, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 247, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 248, &ProfMem_22);
                    {
                  ...
                  break;
                case (MR_Integer) 3:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 249, &Result_6);
                  break;
                case (MR_Integer) 6:
                ...
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 5:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 272, &Result_6);
                  break;
              }
            }
            break;
