          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 165, &Flags_18);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 239, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 312, &NotResult_23);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 245, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 246, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 247, &ProfMem_22);
                    {
