...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_20, (MR_Integer) 2)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr_30, (MR_Integer) 1)));
              ...
              case (MR_Integer) 5:
                {
                  ...
                  MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalReason_59, (MR_Integer) 1)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BaseExpr_7, (MR_Integer) 0)));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), BaseExpr_7, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ResultA_14;
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TraceExpr_4, (MR_Integer) 0)));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unify_23, (MR_Integer) 5)));
      }
    }
    if (succeeded)
    {
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_5, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason1_9, (MR_Integer) 1)));
        ...
        else
        {
          ...
          if (succeeded)
          {
            packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_5, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason1_9, (MR_Integer) 1)));
