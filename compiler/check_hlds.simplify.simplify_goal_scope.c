    ...
    case (MR_Integer) 0:
      {
        ...
        switch (MR_tag((MR_Word) BaseExpr_7)) {
          ...
          case (MR_Integer) 0:
            {
              MR_String FlagName_17 = ((MR_String) ((MR_hl_field(MR_mktag(0), BaseExpr_7, (MR_Integer) 0))));
              MR_Word Flags_18;
          ...
          case (MR_Integer) 1:
            {
              MR_Word Grade_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BaseExpr_7, (MR_Integer) 0))) & (MR_Integer) 15);
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 232, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 305, &NotResult_23);
                ...
                case (MR_Integer) 8:
                  ...
                  break;
                case (MR_Integer) 4:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 262, &Result_6);
                  break;
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 238, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 239, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 240, &ProfMem_22);
                    {
                      Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (ProfMem_22));
                      MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    {
                      Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (ProfTime_21));
                      MR_hl_field(MR_mktag(1), Var_35, 1) = ((MR_Box) (Var_36));
                    }
                    {
                      Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (ProfCalls_20));
                  ...
                  break;
                case (MR_Integer) 3:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 241, &Result_6);
                  break;
                case (MR_Integer) 6:
          ...
          case (MR_Integer) 2:
            {
              MR_Word RequiredLevel_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), BaseExpr_7, (MR_Integer) 0))) & (MR_Integer) 1);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__325__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
