        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 359, &CommonStruct_27);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 202, &Result_6);
                    }
                    break;
                  case (MR_Integer) 12:
                    {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 270, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 270, &Result_6);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 232, &Result_6);
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 208, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 209, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 210, &ProfMem_25);
                      {
                  ...
                  case (MR_Integer) 3:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 211, &Result_6);
                    }
                    break;
                  case (MR_Integer) 6:
                    {
                  ...
                  case (MR_Integer) 5:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 234, &Result_6);
                    }
                    break;
                }
              }
