      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_11_p_0(DefinedWhere_39, VarTable_38, TermVar_22, HeadConjunct_36, TailConjuncts_37, (MR_Word) ((MR_Unsigned) 0U), &ElimVars_40, Var_96, &VarArgMap_41, ConstStructDb0_24, &ConstStructDb_42);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 237, &ProfMem_22);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (ProfMem_22));
                      MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    {
                      Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (ProfTime_21));
                      MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) (Var_39));
                    }
                    {
                      Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (ProfCalls_20));
