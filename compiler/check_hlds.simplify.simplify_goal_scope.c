      ...
      case (MR_Integer) 1:
        {
          ...
          CommonStruct_28 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_27, 0))) >> 25)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            Var_264 = ((MR_Word) ((MR_hl_field(0, Var_102, 0))));
      ...
      switch (MR_tag((MR_Word) FinalReason_65)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, FinalReason_65, 0))))) {
            ...
            case (MR_Integer) 5:
              {
                MR_Word Var_265 = ((MR_Unsigned) ((MR_hl_field(3, FinalReason_65, 1))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 0:
      {
        ...
        *Goal_12 = hlds__make_goal__true_goal_with_context_1_f_0(Context_18);
        ...
        mercury__set__union_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_20, DeletedCallCallees0_19, &DeletedCallCallees_21);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 277, &Flags_18);
