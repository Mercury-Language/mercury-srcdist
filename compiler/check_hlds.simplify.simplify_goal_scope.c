        ...
        case (MR_Integer) 1:
          {
            ...
            TypeInfo_121_121 = (MR_Word) &check_hlds__simplify__simplify_goal_scope_scalar_common_1[0];
            TypeCtorInfo_122_122 = (MR_Word) &hlds__const_struct__hlds__const_struct__type_ctor_info_const_struct_arg_0;
            Var_90 = mercury__map__init_0_f_0(TypeInfo_121_121, TypeCtorInfo_122_122);
            check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_10_p_0(TermVar_22, VarTypes_37, HeadConjunct_35, TailConjuncts_36, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ElimVars_38, Var_90, &VarArgMap_39, ConstStructDb0_24, &ConstStructDb_40);
            ...
            mercury__map__to_assoc_list_2_p_0(TypeInfo_121_121, TypeCtorInfo_122_122, VarArgMap_39, &VarArgs_42);
            ...
            Var_118 = ((MR_Word) (MR_hl_field(MR_mktag(0), TermConstStruct_46, (MR_Integer) 1)));
            Var_119 = ((MR_Word) (MR_hl_field(MR_mktag(0), TermConstStruct_46, (MR_Integer) 2)));
            Var_120 = ((MR_Word) (MR_hl_field(MR_mktag(0), TermConstStruct_46, (MR_Integer) 3)));
            {
            ...
            hlds__instmap__instmap_delta_lookup_var_3_p_0(InstMapDelta_51, TermVar_22, &TermInst_52);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        ...
        switch (MR_tag((MR_Word) FinalReason_59)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), FinalReason_59, (MR_Integer) 0)))) {
              ...
              case (MR_Integer) 5:
                {
                  MR_Word Var_124 = ((MR_Word) (MR_hl_field(MR_mktag(3), FinalReason_59, (MR_Integer) 1)));
