            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 147, &Flags_21);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 10:
                    ...
                    break;
                  case (MR_Integer) 0:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 213, &Result_6);
                    break;
                  case (MR_Integer) 12:
                    {
                      MR_Word Target_51;
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 287, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 287, &Result_6);
                    break;
                  case (MR_Integer) 4:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 243, &Result_6);
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 219, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 220, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 221, &ProfMem_25);
                      {
