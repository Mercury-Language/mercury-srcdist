                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 286, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 286, &Result_6);
                    break;
                  case (MR_Integer) 4:
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 218, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 219, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 220, &ProfMem_25);
                      {
                    ...
                    break;
                  case (MR_Integer) 3:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 221, &Result_6);
                    break;
                  case (MR_Integer) 6:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 255, &Result_6);
                    break;
                  case (MR_Integer) 1:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 259, &Result_6);
                    break;
                  case (MR_Integer) 5:
