...
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__312__1_2_p_0(
  MR_Word TermVar_11,
  MR_Word LHSVar_32);

static void MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__302__1_4_p_0(
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 374, &CommonStruct_27);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 145, &Flags_21);
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 284, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 284, &Result_6);
                    break;
                  case (MR_Integer) 4:
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 216, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 217, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 218, &ProfMem_25);
                      {
                    ...
                    break;
                  case (MR_Integer) 3:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 219, &Result_6);
                    break;
                  case (MR_Integer) 6:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 253, &Result_6);
                    break;
                  case (MR_Integer) 1:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 257, &Result_6);
                    break;
                  case (MR_Integer) 5:
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__312__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__302__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_66, ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_68);
