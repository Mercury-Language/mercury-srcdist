...
{
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 366, &CommonStruct_27);
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) GoalExpr1_57)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr1_57, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
        ...
        switch (MR_tag((MR_Word) FinalReason_59)) {
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), FinalReason_59, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  Goal_66 = Goal1_56;
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 142, &Flags_21);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 204, &Result_6);
                    }
                    break;
                  case (MR_Integer) 12:
                    {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 277, &NotResult_26);
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 210, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 211, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 212, &ProfMem_25);
                      {
                  ...
                  case (MR_Integer) 5:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 236, &Result_6);
                    }
                    break;
                }
              }
