            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 156, &Flags_21);
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 301, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 301, &Result_6);
                    break;
                  case (MR_Integer) 4:
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 233, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 234, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 235, &ProfMem_25);
                      {
