          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 193, &Flags_18);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 266, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 339, &NotResult_23);
                    mercury__bool__not_2_p_0(NotResult_23, &Result_6);
                  }
                  break;
                case (MR_Integer) 8:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 339, &Result_6);
                  break;
                case (MR_Integer) 4:
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 272, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 273, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 274, &ProfMem_22);
                    {
                  ...
                  break;
                case (MR_Integer) 3:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 275, &Result_6);
                  break;
                case (MR_Integer) 6:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 308, &Result_6);
                  break;
                case (MR_Integer) 1:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 312, &Result_6);
                  break;
                case (MR_Integer) 5:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 298, &Result_6);
                  break;
              }
            }
            break;
