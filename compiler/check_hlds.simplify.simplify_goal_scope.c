          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 175, &Flags_18);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 248, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 321, &NotResult_23);
                    mercury__bool__not_2_p_0(NotResult_23, &Result_6);
                  }
                  break;
                case (MR_Integer) 8:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 321, &Result_6);
                  break;
                case (MR_Integer) 4:
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 254, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 255, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 256, &ProfMem_22);
                    {
