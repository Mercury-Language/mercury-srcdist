            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 146, &Flags_21);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 10:
                    ...
                    break;
                  case (MR_Integer) 0:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 217, &Result_6);
                    break;
                  case (MR_Integer) 11:
                    {
                      MR_Word Target_50;
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 291, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 291, &Result_6);
                    break;
                  case (MR_Integer) 4:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 247, &Result_6);
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 223, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 224, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 225, &ProfMem_25);
                      {
                    ...
                    break;
                  case (MR_Integer) 3:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 226, &Result_6);
                    break;
                  case (MR_Integer) 6:
                  ...
                  case (MR_Integer) 1:
                    ...
                    break;
                  case (MR_Integer) 5:
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 249, &Result_6);
                    break;
                }
              }
              break;
