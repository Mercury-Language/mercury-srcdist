...
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__308__1_2_p_0(
  MR_Word TermVar_11,
  MR_Word LHSVar_32);

static void MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__298__1_4_p_0(
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_89 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason0_20, (MR_Integer) 2))) & (MR_Integer) 3);
    ...
    if (succeeded)
    {
      ...
      check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_87, &ModuleInfo0_23);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 371, &CommonStruct_27);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(SubGoal0_21, &SubGoal_28, NestedContext0_15, InstMap0_16, Common0_17, Common_18, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                  {
                    NewReason_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((((MR_tag((MR_Word) SubGoalExpr_30)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SubGoalExpr_30, (MR_Integer) 0)))) == (MR_Integer) 2)));
            if (succeeded)
            {
              Var_90 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr_30, (MR_Integer) 1))) & (MR_Integer) 1);
              Conjuncts_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), SubGoalExpr_30, (MR_Integer) 2))));
              succeeded = (Var_90 == (MR_Integer) 0);
              if (succeeded)
              {
                succeeded = (Conjuncts_32 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_87, &VarTypes_37);
            Var_94 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]), (MR_Word) (&hlds__const_struct__hlds__const_struct__type_ctor_info_const_struct_arg_0));
            check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_10_p_0(TermVar_22, VarTypes_37, HeadConjunct_35, TailConjuncts_36, (MR_Word) ((MR_Unsigned) 0U), &ElimVars_38, Var_94, &VarArgMap_39, ConstStructDb0_24, &ConstStructDb_40);
            hlds__hlds_module__module_info_set_const_struct_db_3_p_0(ConstStructDb_40, ModuleInfo0_23, &ModuleInfo_41);
            check_hlds__simplify__simplify_info__simplify_info_add_elim_vars_3_p_0(ElimVars_38, STATE_VARIABLE_Info_0_87, &STATE_VARIABLE_Info_95_95);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_41, STATE_VARIABLE_Info_95_95, STATE_VARIABLE_Info_88);
            ...
            succeeded = (VarArgs_42 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_97 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarArgs_42, (MR_Integer) 0))));
              Var_98 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarArgs_42, (MR_Integer) 1))));
              Var_137 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_97, (MR_Integer) 0))));
              TermArg_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_97, (MR_Integer) 1))));
              TypeInfo_139_139 = (MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_139_139, ((MR_Box) (TermVar_22)), ((MR_Box) (Var_137)));
              if (succeeded)
              {
            ...
            {
              ConsId_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              RHS_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_110, 0) = ((MR_Box) (TermInst_52));
              MR_hl_field(MR_mktag(0), Var_110, 1) = ((MR_Box) (TermInst_52));
            }
            {
              UnifyMode_53 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), UnifyMode_53, 0) = ((MR_Box) (Var_108));
              MR_hl_field(MR_mktag(0), UnifyMode_53, 1) = ((MR_Box) (Var_110));
            }
            {
              MR_Word base;
    ...
    else
    {
      ...
      MR_Word SubGoal_126;
      MR_Word HeadWarning_55;
      MR_Word TailWarnings_56;
      MR_Word FinalReason_63;
      MR_Word FinalSubGoal_64;

      succeeded = ((MR_tag((MR_Word) Reason0_20)) == (MR_Integer) 1);
      if (succeeded)
      {
        HeadWarning_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason0_20, (MR_Integer) 0))) & (MR_Integer) 3);
        TailWarnings_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Reason0_20, (MR_Integer) 1))));
        {
          MR_Word Tasks0_57;
          MR_Word ScopeTasks_58;
          MR_Word Var_118;
          MR_Word STATE_VARIABLE_Info_119_119;
          MR_Word STATE_VARIABLE_Info_120_120;
          MR_Box conv1_ScopeTasks_58;

          check_hlds__simplify__simplify_info__simplify_info_get_simplify_tasks_2_p_0(STATE_VARIABLE_Info_0_87, &Tasks0_57);
          {
            Var_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_118, 0) = ((MR_Box) (HeadWarning_55));
            MR_hl_field(MR_mktag(1), Var_118, 1) = ((MR_Box) (TailWarnings_56));
          }
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0), (MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_tasks_0), (MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_2[2]), Var_118, ((MR_Box) (Tasks0_57)), &conv1_ScopeTasks_58);
          ScopeTasks_58 = ((MR_Word) (conv1_ScopeTasks_58));
          check_hlds__simplify__simplify_info__simplify_info_set_simplify_tasks_3_p_0(ScopeTasks_58, STATE_VARIABLE_Info_0_87, &STATE_VARIABLE_Info_119_119);
          check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(SubGoal0_21, &SubGoal_126, NestedContext0_15, InstMap0_16, Common0_17, &Common1_59, STATE_VARIABLE_Info_119_119, &STATE_VARIABLE_Info_120_120);
          check_hlds__simplify__simplify_info__simplify_info_set_simplify_tasks_3_p_0(Tasks0_57, STATE_VARIABLE_Info_120_120, &STATE_VARIABLE_Info_121_121);
        }
      }
      else
        check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(SubGoal0_21, &SubGoal_126, NestedContext0_15, InstMap0_16, Common0_17, &Common1_59, STATE_VARIABLE_Info_0_87, &STATE_VARIABLE_Info_121_121);
      check_hlds__simplify__simplify_goal_scope__try_to_merge_nested_scopes_4_p_0(Reason0_20, SubGoal_126, GoalInfo0_13, &Goal1_60);
      GoalExpr1_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_60, (MR_Integer) 0))));
      succeeded = ((((MR_tag((MR_Word) GoalExpr1_61)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr1_61, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
        FinalReason_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr1_61, (MR_Integer) 1))));
        FinalSubGoal_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr1_61, (MR_Integer) 2))));
        switch (MR_tag((MR_Word) FinalReason_63)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              Goal_70 = Goal1_60;
              *Common_18 = Common0_17;
              *STATE_VARIABLE_Info_88 = STATE_VARIABLE_Info_121_121;
            }
            break;
          case (MR_Integer) 1:
            {
              Goal_70 = Goal1_60;
              *Common_18 = Common1_59;
              *STATE_VARIABLE_Info_88 = STATE_VARIABLE_Info_121_121;
            }
            break;
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), FinalReason_63, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  Goal_70 = Goal1_60;
              ...
              case (MR_Integer) 5:
                {
                  MR_Word Var_138 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalReason_63, (MR_Integer) 1))) & (MR_Integer) 1);
              ...
              case (MR_Integer) 7:
                {
                  MR_Word MaybeCompiletimeExpr_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), FinalReason_63, (MR_Integer) 1))));
                  MR_Word MaybeRuntimeExpr_83 = ((MR_Word) ((MR_hl_field(MR_mktag(3), FinalReason_63, (MR_Integer) 2))));

                  succeeded = check_hlds__simplify__simplify_info__simplify_do_after_front_end_1_p_0(STATE_VARIABLE_Info_121_121);
                  if (succeeded)
                    check_hlds__simplify__simplify_goal_scope__simplify_goal_trace_goal_7_p_0(MaybeCompiletimeExpr_82, MaybeRuntimeExpr_83, FinalSubGoal_64, Goal1_60, &Goal_70, STATE_VARIABLE_Info_121_121, STATE_VARIABLE_Info_88);
                  else
                  {
                    Goal_70 = Goal1_60;
                    *STATE_VARIABLE_Info_88 = STATE_VARIABLE_Info_121_121;
      ...
      *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_70, (MR_Integer) 0))));
      *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_70, (MR_Integer) 1))));
    }
  }
}
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 143, &Flags_21);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 281, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 281, &Result_6);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 238, &Result_6);
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 214, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 215, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 216, &ProfMem_25);
                      {
                  ...
                  case (MR_Integer) 6:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 251, &Result_6);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 255, &Result_6);
                    }
                    break;
                  case (MR_Integer) 5:
                    {
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__308__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__298__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_66, ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_68);
