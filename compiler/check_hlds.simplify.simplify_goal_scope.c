...
static MR_bool MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__275__1_2_p_0(
...
static void MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__265__1_4_p_0(
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  libs__globals__lookup_accumulating_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 129, &check_hlds__simplify__simplify_goal_scope__Flags_21);
                }
                {
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (check_hlds__simplify__simplify_goal_scope__Grade_22) {
                  ...
                  case (MR_Integer) 0:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 186, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 12:
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 254, &check_hlds__simplify__simplify_goal_scope__NotResult_26);
                      }
                      {
                  ...
                  case (MR_Integer) 8:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 254, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 216, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 192, &check_hlds__simplify__simplify_goal_scope__ProfCalls_23);
                      }
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 193, &check_hlds__simplify__simplify_goal_scope__ProfTime_24);
                      }
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 194, &check_hlds__simplify__simplify_goal_scope__ProfMem_25);
                      }
                      {
                  ...
                  case (MR_Integer) 6:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 229, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 233, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 5:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 218, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            check_hlds__simplify__simplify_goal_scope__SubGoalCalledProcs_20 = hlds__goal_util__goal_callees_1_f_0(check_hlds__simplify__simplify_goal_scope__SubGoal_10);
          }
          {
        ...
        else
          {
            ...
            switch (check_hlds__simplify__simplify_goal_scope__Target_25) {
              ...
              case (MR_Integer) 3:
                {
                  {
                    check_hlds__simplify__simplify_goal_scope__STATE_VARIABLE_EvalAttributes_41_41 = parse_tree__prog_data__default_attributes_1_f_0((MR_Integer) 3);
                  }
                }
                break;
              case (MR_Integer) 2:
            ...
            {
              parse_tree__prog_data__set_may_call_mm_tabled_3_p_0((MR_Integer) 1, check_hlds__simplify__simplify_goal_scope__STATE_VARIABLE_EvalAttributes_54_54, &check_hlds__simplify__simplify_goal_scope__EvalAttributes_28);
            }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_26, (MR_Integer) 342, &check_hlds__simplify__simplify_goal_scope__CommonStruct_27);
              }
