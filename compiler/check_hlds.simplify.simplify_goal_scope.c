...
static MR_bool MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__276__1_2_p_0(
...
static void MR_CALL 
check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__266__1_4_p_0(
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (check_hlds__simplify__simplify_goal_scope__Grade_22) {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 253, &check_hlds__simplify__simplify_goal_scope__NotResult_26);
                      }
                      {
                  ...
                  case (MR_Integer) 8:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_19, (MR_Integer) 253, &check_hlds__simplify__simplify_goal_scope__Result_6);
                      }
                    }
                    break;
                  case (MR_Integer) 4:
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_scope__Globals_26, (MR_Integer) 341, &check_hlds__simplify__simplify_goal_scope__CommonStruct_27);
              }
