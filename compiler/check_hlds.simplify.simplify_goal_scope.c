          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 235, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 308, &NotResult_23);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 241, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 242, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 243, &ProfMem_22);
                    {
                  ...
                  break;
                case (MR_Integer) 3:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 244, &Result_6);
                  break;
                case (MR_Integer) 6:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 277, &Result_6);
                  break;
                case (MR_Integer) 1:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 281, &Result_6);
                  break;
                case (MR_Integer) 5:
