        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 358, &CommonStruct_27);
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 269, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 269, &Result_6);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
