        ...
        case (MR_Integer) 1:
          {
            ...
            check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_10_p_0(TermVar_22, VarTypes_37, HeadConjunct_35, TailConjuncts_36, (MR_Word) ((MR_Integer) 0), &ElimVars_38, Var_90, &VarArgMap_39, ConstStructDb0_24, &ConstStructDb_40);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                succeeded = (Var_94 == (MR_Word) ((MR_Integer) 0));
                if (succeeded)
                {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), RHS_49, 2) = ((MR_Box) ((MR_Integer) 0));
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Unification_50, 2) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), Unification_50, 3) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), Unification_50, 4) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), Unification_50, 5) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Unification_50, 6) = ((MR_Box) ((MR_Integer) 0));
            }
            ...
            hlds__instmap__instmap_delta_lookup_var_3_p_0(InstMapDelta_51, TermVar_22, &TermInst_52);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if ((MaybeCompiletimeExpr_8 == (MR_Word) ((MR_Integer) 0)))
    ...
    switch (KeepGoal_15) {
      ...
      case (MR_Integer) 1:
        {
          if ((MaybeRuntimeExpr_9 == (MR_Word) ((MR_Integer) 0)))
            *Goal_12 = Goal0_11;
          else
          {
            ...
            hlds__goal_util__generate_foreign_proc_16_p_0(PrivateBuiltin_26, (MR_String) "trace_evaluate_runtime_condition", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 1, (MR_Integer) 1, EvalAttributes_28, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), MaybeRuntimeExpr_9, (MR_String) "", (MR_Word) ((MR_Integer) 0), Var_64, ModuleInfo_23, Context_71, &CondGoal_31);
            Var_66 = hlds__make_goal__true_goal_0_f_0();
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_32, 1) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * STATE_VARIABLE_ConstStructDb_51)
{
  while (MR_TRUE)
  {
    ...
    if ((RHSVars_34 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    if ((Conjuncts_14 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_62;
