        ...
        case (MR_Integer) 1:
          {
            ...
            Var_122 = ((MR_Word) (MR_hl_field(MR_mktag(0), TermConstStruct_46, (MR_Integer) 3)));
            {
              ...
              MR_hl_field(MR_mktag(3), ConsId_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 23));
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 140, &Flags_21);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (Grade_22) {
                  ...
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 201, &Result_6);
                    }
                    break;
                  case (MR_Integer) 12:
                    {
                  ...
                  case (MR_Integer) 7:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 267, &NotResult_26);
                      mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                    }
                    break;
                  case (MR_Integer) 8:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 267, &Result_6);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 231, &Result_6);
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 207, &ProfCalls_23);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 208, &ProfTime_24);
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 209, &ProfMem_25);
                      {
                  ...
                  case (MR_Integer) 3:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 210, &Result_6);
                    }
                    break;
                  case (MR_Integer) 6:
                    {
                  ...
                  case (MR_Integer) 1:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 248, &Result_6);
                    }
                    break;
                  case (MR_Integer) 5:
                    {
