      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            Var_94 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr_31, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          if (succeeded)
          {
            Var_101 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarArgs_44, (MR_Integer) 0))));
            Var_102 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarArgs_44, (MR_Integer) 1))));
            Var_263 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_101, (MR_Integer) 0))));
            TermArg_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_101, (MR_Integer) 1))));
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (MR_tag((MR_Word) BaseExpr_7)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 163, &Flags_21);
                ...
                case (MR_Integer) 10:
                  {
                    ...
                    libs__globals__get_target_2_p_0(Globals_19, &Target_47);
                    succeeded = (Target_47 == (MR_Integer) 1);
                    if (succeeded)
                      Result_6 = (MR_Integer) 1;
                    else
                      Result_6 = (MR_Integer) 0;
                ...
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__get_target_2_p_0(Globals_19, &Target_48);
                    succeeded = (Target_48 == (MR_Integer) 2);
                    if (succeeded)
                      Result_6 = (MR_Integer) 1;
                    else
                      Result_6 = (MR_Integer) 0;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 305, &NotResult_26);
                    mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                  }
                  break;
                case (MR_Integer) 8:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 305, &Result_6);
                  break;
                case (MR_Integer) 4:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 262, &Result_6);
                  break;
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 238, &ProfCalls_23);
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 239, &ProfTime_24);
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 240, &ProfMem_25);
                    {
                      Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (ProfMem_25));
                      MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    {
                      Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (ProfTime_24));
                      MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) (Var_39));
                    }
                    {
                      Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (ProfCalls_23));
                      MR_hl_field(MR_mktag(1), Var_37, 1) = ((MR_Box) (Var_38));
                    }
                    mercury__bool__or_list_2_p_0(Var_37, &Result_6);
                  }
                  break;
                case (MR_Integer) 3:
                  ...
                  break;
                case (MR_Integer) 6:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 274, &Result_6);
                  break;
                case (MR_Integer) 1:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 278, &Result_6);
                  break;
                case (MR_Integer) 5:
          ...
          case (MR_Integer) 2:
            {
              MR_Word RequiredLevel_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), BaseExpr_7, (MR_Integer) 0))) & (MR_Integer) 1);
              MR_Word EffTraceLevel_29;
              MR_Word Var_30;

              check_hlds__simplify__simplify_info__simplify_info_get_eff_trace_level_optimized_3_p_0(Info_5, &EffTraceLevel_29, &Var_30);
              switch (RequiredLevel_28) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  Result_6 = libs__trace_params__at_least_at_deep_1_f_0(EffTraceLevel_29);
                  break;
                case (MR_Integer) 0:
                  Result_6 = libs__trace_params__at_least_at_shallow_1_f_0(EffTraceLevel_29);
                  break;
              }
            }
            break;
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__simplify__simplify_goal_scope__IntroducedFrom__pred__simplify_construct_ground_terms__308__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_65, ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_67);
  ...
  while (MR_TRUE)
  {
    ...
    if ((Conjuncts_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_scope_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_11_p_0_2));
        MR_hl_field(MR_mktag(0), Var_60, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_60, 3) = ((MR_Box) (TermVar_14));
        MR_hl_field(MR_mktag(0), Var_60, 4) = ((MR_Box) (LHSVar_34));
      }
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_ElimVars_63_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_ElimVars_63_63, 0) = ((MR_Box) (LHSVar_34));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_ElimVars_63_63, 1) = ((MR_Box) (STATE_VARIABLE_ElimVars_0_48));
      }
