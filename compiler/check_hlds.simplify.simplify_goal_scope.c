...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scope_scalar_common_5[1][1];
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              Var_262 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_99, (MR_Integer) 0))));
              TermArg_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_99, (MR_Integer) 1))));
              TypeInfo_264_264 = (MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_264_264, ((MR_Box) (TermVar_22)), ((MR_Box) (Var_262)));
              if (succeeded)
              {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Unification_52, 4) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_scope_scalar_common_5[0])));
        ...
        switch (MR_tag((MR_Word) FinalReason_65)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), FinalReason_65, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 5:
                {
                  MR_Word Var_263 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), FinalReason_65, (MR_Integer) 1))) & (MR_Integer) 1);
