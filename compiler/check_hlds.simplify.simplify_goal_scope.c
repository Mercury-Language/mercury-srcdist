      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__265_265 = (MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__265_265, ((MR_Box) (TermVar_22)), ((MR_Box) (Var_263)));
            if (succeeded)
            {
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (MR_tag((MR_Word) BaseExpr_7)) {
                ...
                case (MR_Integer) 10:
                  {
                    ...
                    libs__globals__get_target_2_p_0(Globals_16, &Target_46);
                    succeeded = (Target_46 == (MR_Integer) 1);
                    if (succeeded)
                      Result_6 = (MR_Integer) 1;
                    else
                      Result_6 = (MR_Integer) 0;
                ...
                case (MR_Integer) 11:
                  {
                    ...
                    libs__globals__get_target_2_p_0(Globals_16, &Target_47);
                    succeeded = (Target_47 == (MR_Integer) 2);
                    if (succeeded)
                      Result_6 = (MR_Integer) 1;
                    else
                      Result_6 = (MR_Integer) 0;
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 237, &ProfMem_22);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (ProfMem_22));
                      MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    {
                      Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (ProfTime_21));
                      MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) (Var_41));
                    }
                    {
                      Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (ProfCalls_20));
                      MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (Var_40));
                    }
                    mercury__bool__or_list_2_p_0(Var_39, &Result_6);
                  }
                  break;
                case (MR_Integer) 3:
          ...
          case (MR_Integer) 2:
            {
              MR_Word Level_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), BaseExpr_7, (MR_Integer) 0))) & (MR_Integer) 1);
              MR_Word TraceLevel_26;
              MR_Word PredInfo_27;
              MR_Word ProcInfo_28;
              MR_Word EffTraceLevel_29;

              libs__globals__get_trace_level_2_p_0(Globals_16, &TraceLevel_26);
              check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_info_3_p_0(Info_5, &PredInfo_27, &ProcInfo_28);
              EffTraceLevel_29 = libs__trace_params__eff_trace_level_4_f_0(ModuleInfo_15, PredInfo_27, ProcInfo_28, TraceLevel_26);
              switch (Level_25) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
  ...
  MR_Word * STATE_VARIABLE_ConstStructDb_53)
{
  while (MR_TRUE)
  {
    ...
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_13, LHSVar_34, &TermType_37);
