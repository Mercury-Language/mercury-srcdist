          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 162, &Flags_21);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_22) {
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 304, &NotResult_26);
                    mercury__bool__not_2_p_0(NotResult_26, &Result_6);
                  }
                  break;
                case (MR_Integer) 8:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 304, &Result_6);
                  break;
                case (MR_Integer) 4:
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 237, &ProfCalls_23);
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 238, &ProfTime_24);
                    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 239, &ProfMem_25);
                    {
                ...
                case (MR_Integer) 3:
                  ...
                  break;
                case (MR_Integer) 6:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 273, &Result_6);
                  break;
                case (MR_Integer) 1:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 277, &Result_6);
                  break;
                case (MR_Integer) 5:
                  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 263, &Result_6);
                  break;
              }
            }
            break;
