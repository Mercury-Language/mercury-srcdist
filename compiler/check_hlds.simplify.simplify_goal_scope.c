    ...
    case (MR_Integer) 4:
      {
...

        {
          ...
          *STATE_VARIABLE_Tasks_7 = base;
          MR_hl_field(0, base, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 1U)))) | (MR_Unsigned) ((MR_Integer) 0)));
        }
      }
      break;
    case (MR_Integer) 2:
    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_Tasks_7 = base;
          MR_hl_field(0, base, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 2U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 1))));
        }
      }
      break;
    case (MR_Integer) 5:
  ...
  MR_Word * STATE_VARIABLE_Info_90)
{
  ...
  if (succeeded)
  {
    ...
    Var_91 = ((MR_Unsigned) ((MR_hl_field(3, Reason0_20, (MR_Integer) 2))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            Var_94 = ((MR_Unsigned) ((MR_hl_field(3, SubGoalExpr_31, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_89, &VarTable_38);
          check_hlds__simplify__simplify_info__simplify_info_get_defined_where_2_p_0(STATE_VARIABLE_Info_0_89, &DefinedWhere_39);
          Var_98 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]), (MR_Word) (&hlds__const_struct__hlds__const_struct__type_ctor_info_const_struct_arg_0));
          check_hlds__simplify__simplify_goal_scope__simplify_construct_ground_terms_11_p_0(DefinedWhere_39, VarTable_38, TermVar_22, HeadConjunct_36, TailConjuncts_37, (MR_Word) ((MR_Unsigned) 0U), &ElimVars_40, Var_98, &VarArgMap_41, ConstStructDb0_24, &ConstStructDb_42);
          hlds__hlds_module__module_info_set_const_struct_db_3_p_0(ConstStructDb_42, ModuleInfo0_23, &ModuleInfo_43);
          check_hlds__simplify__simplify_info__simplify_info_add_elim_vars_3_p_0(ElimVars_40, STATE_VARIABLE_Info_0_89, &STATE_VARIABLE_Info_99_99);
          check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_43, STATE_VARIABLE_Info_99_99, STATE_VARIABLE_Info_90);
          ...
          if (succeeded)
          {
            Var_101 = ((MR_Word) ((MR_hl_field(1, VarArgs_44, (MR_Integer) 0))));
            Var_102 = ((MR_Word) ((MR_hl_field(1, VarArgs_44, (MR_Integer) 1))));
            Var_263 = ((MR_Word) ((MR_hl_field(0, Var_101, (MR_Integer) 0))));
            TermArg_45 = ((MR_Word) ((MR_hl_field(0, Var_101, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      TailWarnings_58 = ((MR_Word) ((MR_hl_field(1, Reason0_20, (MR_Integer) 1))));
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_simplify_tasks_2_p_0(STATE_VARIABLE_Info_0_89, &Tasks0_59);
        {
          ...
          MR_hl_field(1, Var_119, 0) = ((MR_Box) (HeadWarning_57));
          MR_hl_field(1, Var_119, 1) = ((MR_Box) (TailWarnings_58));
        }
      ...
      switch (MR_tag((MR_Word) FinalReason_65)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, FinalReason_65, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 5:
              {
                MR_Word Var_264 = ((MR_Unsigned) ((MR_hl_field(3, FinalReason_65, (MR_Integer) 1))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 7:
              {
                MR_Word MaybeCompiletimeExpr_84 = ((MR_Word) ((MR_hl_field(3, FinalReason_65, (MR_Integer) 1))));
                MR_Word MaybeRuntimeExpr_85 = ((MR_Word) ((MR_hl_field(3, FinalReason_65, (MR_Integer) 2))));
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_16, (MR_Integer) 163, &Flags_18);
          ...
          case (MR_Integer) 1:
            {
              ...
              switch (Grade_19) {
                ...
                case (MR_Integer) 10:
                  ...
                  break;
                case (MR_Integer) 0:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 236, &Result_6);
                  break;
                case (MR_Integer) 11:
                  {
                    MR_Word Target_45;
                ...
                case (MR_Integer) 7:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 309, &NotResult_23);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 242, &ProfCalls_20);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 243, &ProfTime_21);
                    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 244, &ProfMem_22);
                    {
                  ...
                  break;
                case (MR_Integer) 3:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 245, &Result_6);
                  break;
                case (MR_Integer) 6:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 278, &Result_6);
                  break;
                case (MR_Integer) 1:
                  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 282, &Result_6);
                  break;
                case (MR_Integer) 5:
  ...
  MR_Word * Goal_8)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(3, Var_16, 0) = ((MR_Box) ((MR_Unsigned) 5U));
      MR_hl_field(3, Var_16, 1) = ((MR_Box) (Reason_9));
      MR_hl_field(3, Var_16, 2) = ((MR_Box) (InnerGoal_10));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * Goal_8)
{
  while (MR_TRUE)
  {
    ...
    MR_Word Reason2_14;
    MR_Word Reason1_9;
    MR_Word Var_21 = ((MR_Word) ((MR_hl_field(0, Goal0_7, (MR_Integer) 0))));
    MR_Word Vars0_12;
    MR_Word Vars1_13;

    // setup for model_det tailcalls optimized into a loop
    ;
    succeeded = ((((MR_tag((MR_Word) Var_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_21, (MR_Integer) 0)))) == (MR_Integer) 5)));
    if (succeeded)
    {
      Reason1_9 = ((MR_Word) ((MR_hl_field(3, Var_21, (MR_Integer) 1))));
      Goal1_10 = ((MR_Word) ((MR_hl_field(3, Var_21, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          Vars1_13 = ((MR_Word) ((MR_hl_field(0, Reason1_9, (MR_Integer) 0))));
      }
      if (succeeded)
      {
        MR_Word Var_22;
        ...
        Var_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_scope_scalar_common_1[0]), Vars0_12, Vars1_13);
        {
          ...
          MR_hl_field(0, Reason2_14, 0) = ((MR_Box) (Var_22));
        }
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        if (succeeded)
        {
          Removable0_15 = ((MR_Unsigned) ((MR_hl_field(3, Reason0_5, (MR_Integer) 1))) & (MR_Integer) 1);
          succeeded = ((((MR_tag((MR_Word) Reason1_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason1_9, (MR_Integer) 0)))) == (MR_Integer) 5)));
          if (succeeded)
            Removable1_16 = ((MR_Unsigned) ((MR_hl_field(3, Reason1_9, (MR_Integer) 1))) & (MR_Integer) 1);
        }
        if (succeeded)
        {
          ...
          {
            Reason2_14 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, Reason2_14, 0) = ((MR_Box) ((MR_Unsigned) 5U));
            MR_hl_field(3, Reason2_14, 1) = (MR_Box) ((MR_Unsigned) (Removable2_17));
          }
          succeeded = MR_TRUE;
        }
        else
        {
          ...
          if (succeeded)
          {
            ForcePruning0_18 = ((MR_Unsigned) ((MR_hl_field(3, Reason0_5, (MR_Integer) 1))) & (MR_Integer) 1);
            succeeded = ((((MR_tag((MR_Word) Reason1_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason1_9, (MR_Integer) 0)))) == (MR_Integer) 4)));
            if (succeeded)
            {
              ForcePruning1_19 = ((MR_Unsigned) ((MR_hl_field(3, Reason1_9, (MR_Integer) 1))) & (MR_Integer) 1);
              ...
              {
                Reason2_14 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, Reason2_14, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(3, Reason2_14, 1) = (MR_Box) ((MR_Unsigned) (ForcePruning2_20));
              }
              succeeded = MR_TRUE;
            }
          }
