  ...
  MR_Word * STATE_VARIABLE_ProcCounter_18)
{
  ...
  Var_19 = ((MR_Word) ((MR_hl_field(0, LabelInstr_9, (MR_Integer) 0))));
  succeeded = ((((MR_tag((MR_Word) Var_19)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_19, (MR_Integer) 0)))) == (MR_Integer) 5)));
  if (succeeded)
  {
    FirstLabel_12 = ((MR_Word) ((MR_hl_field(3, Var_19, (MR_Integer) 1))));
    succeeded = ((MR_tag((MR_Word) FirstLabel_12)) == (MR_Integer) 1);
    if (succeeded)
      ProcLabel_15 = ((MR_Word) ((MR_hl_field(1, FirstLabel_12, (MR_Integer) 1))));
  }
  if (succeeded)
  {
    MR_Word Map_16;
  ...
  MR_Word * STATE_VARIABLE_Map_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Instr_14 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word Instrs_15 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_Counter_28_28;
      MR_Word STATE_VARIABLE_Map_29_29;
      MR_Word Label_19;
      MR_Word Var_27 = ((MR_Word) ((MR_hl_field(0, Instr_14, (MR_Integer) 0))));
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_Counter_0_3;
      MR_Word next_value_of_STATE_VARIABLE_Map_0_5;

      succeeded = ((((MR_tag((MR_Word) Var_27)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_27, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
        Label_19 = ((MR_Word) ((MR_hl_field(3, Var_27, (MR_Integer) 1))));
        {
