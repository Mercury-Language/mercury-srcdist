...
{
  {
    ...
    Var_13 = ((MR_String) (MR_hl_field(MR_mktag(0), LabelInstr_9, (MR_Integer) 1)));
    succeeded = ((((MR_tag((MR_Word) Var_19)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_19, (MR_Integer) 0)))) == (MR_Integer) 5)));
    if (succeeded)
    {
      FirstLabel_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), Var_19, (MR_Integer) 1)));
      succeeded = ((MR_tag((MR_Word) FirstLabel_12)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), FirstLabel_12, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_30_30 = (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_label_0;
      Var_22 = mercury__map__init_0_f_0(TypeCtorInfo_30_30, TypeCtorInfo_30_30);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_String Var_20 = ((MR_String) (MR_hl_field(MR_mktag(0), Instr_14, (MR_Integer) 1)));
        ...
        if (succeeded)
        {
          Label_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), Var_27, (MR_Integer) 1)));
          {
            ...
            {
              StdLabel_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), StdLabel_22, 0) = ((MR_Box) (LabelNum_21));
              MR_hl_field(MR_mktag(0), StdLabel_22, 1) = ((MR_Box) (ProcLabel_2));
            }
            TypeCtorInfo_32_32 = (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_label_0;
            mercury__map__det_insert_4_p_0(TypeCtorInfo_32_32, TypeCtorInfo_32_32, ((MR_Box) (Label_19)), ((MR_Box) (StdLabel_22)), STATE_VARIABLE_Map_0_5, &STATE_VARIABLE_Map_29_29);
          }
        }
        else
        {
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Instrs_15;
          MR_Word next_value_of_STATE_VARIABLE_Counter_0_3 = STATE_VARIABLE_Counter_28_28;
          MR_Word next_value_of_STATE_VARIABLE_Map_0_5 = STATE_VARIABLE_Map_29_29;
