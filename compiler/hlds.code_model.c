...
MR_decl_label8(hlds__code_model__determinism_to_code_model_2_1, 4,5,6,2,9,10,11,7)
MR_decl_label1(hlds__code_model__determinism_to_code_model_2_1, 13)
MR_decl_label1(hlds__code_model__goal_info_get_code_model_2_0, 2)
MR_decl_label1(hlds__code_model__proc_info_interface_code_model_2_0, 2)
...
MR_def_extern_entry(hlds__code_model__proc_info_interface_code_model_2_0)
MR_def_extern_entry(hlds__code_model__goal_info_get_code_model_2_0)
...
MR_BEGIN_MODULE(hlds__code_model_module1)
	...
	MR_init_label8(hlds__code_model__determinism_to_code_model_2_1,4,5,6,2,9,10,11,7)
	MR_init_label1(hlds__code_model__determinism_to_code_model_2_1,13)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__code_model__determinism_to_code_model_2_1);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, (MR_Integer) 0);
...
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,6)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, MR_r2);
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_succeed();
	}
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,2)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, (MR_Integer) 0);
	MR_fv(1) = (MR_Integer) 1;
...
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,9)
	...
	MR_r2 = MR_fv(1);
	if (MR_INT_GE(MR_r2,2)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_1_i10);
	}
	MR_fv(1) = ((MR_Integer) MR_fv(1) + (MR_Integer) 1);
	MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_1_i11);
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,11)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, MR_r2);
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_succeed();
	}
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(hlds__code_model__determinism_to_code_model_2_1_i13);
	MR_r1 = (MR_Integer) 3;
	MR_succeed();
...
MR_BEGIN_MODULE(hlds__code_model_module2)
	MR_init_entry1(hlds__code_model__proc_info_interface_code_model_2_0);
	MR_init_label1(hlds__code_model__proc_info_interface_code_model_2_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__hlds__code_model__proc_info_interface_code_model_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_interface_determinism_2_0,
		hlds__code_model__proc_info_interface_code_model_2_0_i2);
MR_def_label(hlds__code_model__proc_info_interface_code_model_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__code_model_module3)
	MR_init_entry1(hlds__code_model__goal_info_get_code_model_2_0);
	MR_init_label1(hlds__code_model__goal_info_get_code_model_2_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__hlds__code_model__goal_info_get_code_model_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_get_determinism_2_0,
		hlds__code_model__goal_info_get_code_model_2_0_i2);
MR_def_label(hlds__code_model__goal_info_get_code_model_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(hlds__code_model__determinism_to_code_model_2_0);
...
MR_define_entry(mercury__fn__hlds__code_model__represent_determinism_1_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		...
		MR_LABEL_AP(fn__hlds__code_model__represent_determinism_1_0_i11) MR_AND
		...
		MR_LABEL_AP(fn__hlds__code_model__represent_determinism_1_0_i17));
...
void mercury__hlds__code_model__write_out_proc_statics(FILE *fp);
#endif
