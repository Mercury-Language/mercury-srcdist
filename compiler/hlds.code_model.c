...
MR_decl_label7(hlds__code_model__determinism_to_code_model_2_0, 3,4,5,6,14,7,8)
...
MR_decl_label7(fn__hlds__code_model__represent_determinism_1_0, 3,5,7,9,11,13,15)
...
static const struct mercury_type_0 mercury_vector_common_0_0[3] =
{
{
0
},
...
MR_BEGIN_MODULE(hlds__code_model_module0)
	...
	MR_init_label7(hlds__code_model__determinism_to_code_model_2_0,3,4,5,6,14,7,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__code_model__determinism_to_code_model_2_0);
	...
	if (MR_INT_NE(MR_r1,4)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i3);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i4);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i5);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i6);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,7)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i7);
	}
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i8);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(hlds__code_model__determinism_to_code_model_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(hlds__code_model__determinism_to_code_model_2_0_i14);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__hlds__code_model__determinism_to_code_model_2_1);
	...
	MR_r2 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_0, 0);
...
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_0, (MR_Integer) MR_r2);
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_succeed();
...
MR_BEGIN_MODULE(hlds__code_model_module4)
	...
	MR_init_label7(fn__hlds__code_model__represent_determinism_1_0,3,5,7,9,11,13,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__code_model__represent_determinism_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,4)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i3);
	}
	MR_r1 = (MR_Integer) 5;
...
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i5);
	}
	MR_r1 = (MR_Integer) 4;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i7);
	}
	MR_r1 = (MR_Integer) 0;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i9);
	}
	MR_r1 = (MR_Integer) 6;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,7)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i11);
	}
	MR_r1 = (MR_Integer) 7;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i13);
	}
	MR_r1 = (MR_Integer) 3;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
MR_def_label(fn__hlds__code_model__represent_determinism_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(fn__hlds__code_model__represent_determinism_1_0_i15);
	}
	MR_r1 = (MR_Integer) 2;
	MR_np_tailcall_ent(fn__mdbcomp__program_representation__detism_rep_1_0);
...
void mercury__hlds__code_model__init_threadscope_string_table(void);
#endif
...
void mercury__hlds__code_model__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__code_model);
