...
static const MR_EnumFunctorDescPtr hlds__code_model__hlds__code_model__enum_ordinal_ordered_code_model_0[3];
...
struct hlds__code_model__vector_common_type_1_0_s {
...
struct hlds__code_model__vector_common_type_2_0_s {
...
const MR_TypeCtorInfo_Struct hlds__code_model__hlds__code_model__type_ctor_info_code_model_0 = {
  ...
  { hlds__code_model__hlds__code_model__enum_ordinal_ordered_code_model_0 },
  (MR_Integer) 3,
  UINT16_C(12),
  ...
  MR_Word ProcInfo_3)
{
  ...
  hlds__hlds_proc_util__proc_info_interface_determinism_2_p_0(ProcInfo_3, &Determinism_5);
  hlds__code_model__determinism_to_code_model_2_p_0(Determinism_5, &CodeModel_4);
  return CodeModel_4;
}
