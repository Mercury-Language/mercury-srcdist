...
MR_define_entry(mercury__hlds__code_model__determinism_to_code_model_2_1);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, 0);
...
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,6)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, (MR_Integer) MR_r2);
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_succeed();
	}
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,2)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, 0);
	MR_fv(1) = (MR_Integer) 1;
...
MR_def_label(hlds__code_model__determinism_to_code_model_2_1,11)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, (MR_Integer) MR_r2);
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_succeed();
	}
