...
MR_decl_label8(hlds__code_model__determinism_to_code_model_2_1, 4,5,6,2,9,7,11,12)
...
MR_BEGIN_MODULE(hlds__code_model_module1)
	...
	MR_init_label8(hlds__code_model__determinism_to_code_model_2_1,4,5,6,2,9,7,11,12)
