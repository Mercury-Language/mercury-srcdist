  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_81_81 = (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_81_81, ((MR_Box) (VarB_27)), ((MR_Box) (STATE_VARIABLE_DCGVar_0_44)));
        }
        if (succeeded)
        {
