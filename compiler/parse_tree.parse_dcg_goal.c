            ...
            // case "all"
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  mercury__list__map_3_p_0(TypeInfo_665_665, TypeInfo_666_666, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[4], StateVars0_39, &StateVars_40);
                  mercury__list__map_3_p_0(TypeInfo_665_665, TypeInfo_666_666, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[5], Vars0_38, &Vars_41);
            ...
            // case "some"
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  mercury__list__map_3_p_0(TypeInfo_665_825, TypeInfo_666_826, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[6], StateVars0_836, &StateVars_811);
                  mercury__list__map_3_p_0(TypeInfo_665_825, TypeInfo_666_826, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[7], Vars0_835, &Vars_812);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__map_3_p_0(TypeInfo_72_72, TypeInfo_73_73, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[1], Vars0_25, &Vars_28);
      mercury__list__map_3_p_0(TypeInfo_72_72, TypeInfo_73_73, (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[2], StateVars0_26, &StateVars_29);
      {
        MR_Word base;
