...
static /* final */ const MR_Box parse_tree__parse_dcg_goal_scalar_common_3[7][3];
...
static /* final */ const MR_Box parse_tree__parse_dcg_goal_scalar_common_1[64][2] = {
  ...
  /* row 7 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_dcg_goal_scalar_common_1[6]))),
  ...
  /* row 9 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[7])))
  },
  /* row 10 */
  {
  ...
  /* row 19 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_dcg_goal_scalar_common_1[18]))),
  ...
  /* row 42 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_dcg_goal_scalar_common_1[41]))),
...
{
  {
    ...
    else
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[1]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[6]), ArgTerms0_27, &ArgTerms1_28);
      {
        ...
        case (MR_Integer) 2:
          {
            ...
            ;
            {
              ...
              else
              {
                ...
                mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[1]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[3]), Args_13, &ProgArgTerms_169);
                parse_tree__parse_dcg_goal__make_dcg_call_10_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_4[2]), ProgArgTerms_169, Context_14, &Goal_182, STATE_VARIABLE_VarSet_0_20, STATE_VARIABLE_VarSet_21, STATE_VARIABLE_Counter_0_22, STATE_VARIABLE_Counter_23, STATE_VARIABLE_DCGVar_0_24, STATE_VARIABLE_DCGVar_25);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *MaybeGoal_16 = base;
        ...
        case (MR_Integer) 5:
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Spec_324, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                MR_hl_field(MR_mktag(1), Spec_324, 3) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Spec_324, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[46])));
              }
              {
            ...
            ;
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__parse_dcg_goal__new_dcg_var_5_p_0(STATE_VARIABLE_VarSet_0_20, STATE_VARIABLE_VarSet_21, STATE_VARIABLE_Counter_0_22, STATE_VARIABLE_Counter_23, STATE_VARIABLE_DCGVar_25);
                {
                  ...
                  MR_hl_field(MR_mktag(0), ConsTerm0_392, 0) = ((MR_Box) (&parse_tree__parse_dcg_goal_scalar_common_4[3]));
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Spec_398, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                    MR_hl_field(MR_mktag(1), Spec_398, 3) = ((MR_Box) (Context_14));
                    MR_hl_field(MR_mktag(1), Spec_398, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[51])));
                  }
                  {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_457, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                  MR_hl_field(MR_mktag(1), Spec_457, 3) = ((MR_Box) (Context_14));
                  MR_hl_field(MR_mktag(1), Spec_457, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[61])));
                }
                {
        ...
        case (MR_Integer) 8:
          {
            ...
            ;
            {
              ...
              if ((strcmp(Functor_12, (MR_String) "all") == 0))
              {
                ...
                VarsTailPieces_502 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[12]));
              }
              else
              {
                QuantType_501 = (MR_Integer) 0;
                VarsTailPieces_502 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[16]));
              }
              succeeded = (Args_13 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[2]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[4]), StateVars0_510, &StateVars_513);
                  mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[2]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[5]), Vars0_509, &Vars_514);
            ...
            ;
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_597, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[29])));
                }
                {
            ...
            ;
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_669, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                  MR_hl_field(MR_mktag(1), Spec_669, 3) = ((MR_Box) (Context_14));
                  MR_hl_field(MR_mktag(1), Spec_669, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[29])));
                }
                {
        ...
        case (MR_Integer) 13:
          {
            ...
            if ((Args_13 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Spec_781, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                MR_hl_field(MR_mktag(1), Spec_781, 3) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Spec_781, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[33])));
              }
              {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_54 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[16])));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_30 = (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[0]);
    ...
    else
    {
      ...
      parse_tree__parse_dcg_goal__make_dcg_call_10_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_4[0]), Var_39, Context_16, &Goal_46, STATE_VARIABLE_VarSet_0_24, STATE_VARIABLE_VarSet_25, STATE_VARIABLE_Counter_0_26, STATE_VARIABLE_Counter_27, STATE_VARIABLE_DCGVar_0_28, STATE_VARIABLE_DCGVar_29);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *MaybeGoal_12 = base;
