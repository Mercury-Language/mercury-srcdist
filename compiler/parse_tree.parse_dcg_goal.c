  ...
  MR_Word * STATE_VARIABLE_DCGVar_30)
{
  ...
  else
  {
    ...
    parse_tree__parse_dcg_goal__make_dcg_call_10_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_3[2]), ProgArgTerms_24, Context_12, &Goal_43, STATE_VARIABLE_VarSet_0_25, STATE_VARIABLE_VarSet_26, STATE_VARIABLE_Counter_0_27, STATE_VARIABLE_Counter_28, STATE_VARIABLE_DCGVar_0_29, STATE_VARIABLE_DCGVar_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *MaybeGoal_14 = base;
  ...
  MR_Word * STATE_VARIABLE_Disjuncts_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Disjunct0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RevDisjunctDCGVar_16, (MR_Integer) 0))));
      MR_Word DisjunctEndDCGVar_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RevDisjunctDCGVar_16, (MR_Integer) 1))));
      MR_Word Disjunct_31;
      MR_Word next_value_of_HeadVar__4_4;
      MR_Word next_value_of_STATE_VARIABLE_Disjuncts_0_5;

      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]), ((MR_Box) (DisjunctEndDCGVar_30)), ((MR_Box) (HeadVar__2_2)));
      if (succeeded)
        Disjunct_31 = Disjunct0_29;
      else
      {
        succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]), ((MR_Box) (DisjunctEndDCGVar_30)), ((MR_Box) (HeadVar__1_1)));
        if (succeeded)
        {
          MR_Word Unify_32;
          MR_Word Var_33;
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) (HeadVar__3_3));
          }
          {
            Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (HeadVar__1_1));
            MR_hl_field(MR_mktag(1), Var_34, 1) = ((MR_Box) (HeadVar__3_3));
          }
          {
            Unify_32 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Unify_32, 0) = ((MR_Box) (HeadVar__3_3));
            MR_hl_field(MR_mktag(0), Unify_32, 1) = ((MR_Box) (Var_33));
            MR_hl_field(MR_mktag(0), Unify_32, 2) = ((MR_Box) (Var_34));
            MR_hl_field(MR_mktag(0), Unify_32, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          }
          {
            Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (Unify_32));
            MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Disjunct_31 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Disjunct_31, 0) = ((MR_Box) (HeadVar__3_3));
            MR_hl_field(MR_mktag(2), Disjunct_31, 1) = ((MR_Box) (Disjunct0_29));
            MR_hl_field(MR_mktag(2), Disjunct_31, 2) = ((MR_Box) (Var_36));
          }
        }
        else
          parse_tree__prog_util__rename_in_goal_4_p_0(DisjunctEndDCGVar_30, HeadVar__2_2, Disjunct0_29, &Disjunct_31);
      }
      {
        STATE_VARIABLE_Disjuncts_21_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Disjuncts_21_21, 0) = ((MR_Box) (Disjunct_31));
