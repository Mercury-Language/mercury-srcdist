  ...
  MR_Word * STATE_VARIABLE_VarSet_17)
{
  ...
  MR_Word Var_19;
  MR_Integer N_28;
  MR_String StringN_29;
  MR_String VarName_30;
  MR_Word STATE_VARIABLE_VarSet_18_33;
  MR_Word _Counter_15;

  Var_19 = mercury__counter__init_1_f_0((MR_Integer) 0);
  mercury__counter__allocate_3_p_0(&N_28, Var_19, &Counter0_14);
  mercury__string__int_to_string_2_p_0(N_28, &StringN_29);
  mercury__string__append_3_p_2((MR_String) "DCG_", StringN_29, &VarName_30);
  mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), DCGVar0_11, STATE_VARIABLE_VarSet_0_16, &STATE_VARIABLE_VarSet_18_33);
  mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), *DCGVar0_11, VarName_30, STATE_VARIABLE_VarSet_18_33, &STATE_VARIABLE_VarSet_18_18);
  ...
  MR_Word * MaybeClause_14)
{
  ...
  else
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[1]), (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_4[6]), ArgTerms0_28, &ArgTerms1_29);
    {
  ...
  MR_Word * STATE_VARIABLE_DCGVar_42)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__parse_dcg_goal__parse_dcg_if_then_12_p_0(CondGoalTerm_18, ThenGoalTerm_19, Context_12, ContextPieces_13, &MaybeVarsCondGoal_22, &MaybeThenGoal_23, STATE_VARIABLE_VarSet_0_37, STATE_VARIABLE_VarSet_38, STATE_VARIABLE_Counter_0_39, STATE_VARIABLE_Counter_40, STATE_VARIABLE_DCGVar_0_41, STATE_VARIABLE_DCGVar_42);
  ...
  MR_Word * STATE_VARIABLE_DCGVar_30)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word Goal_22;
    MR_Integer N_59;
    MR_String StringN_60;
    MR_String VarName_61;
    MR_Word STATE_VARIABLE_VarSet_18_64;

    mercury__counter__allocate_3_p_0(&N_59, STATE_VARIABLE_Counter_0_27, STATE_VARIABLE_Counter_28);
    mercury__string__int_to_string_2_p_0(N_59, &StringN_60);
    mercury__string__append_3_p_2((MR_String) "DCG_", StringN_60, &VarName_61);
    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_DCGVar_30, STATE_VARIABLE_VarSet_0_25, &STATE_VARIABLE_VarSet_18_64);
    mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), *STATE_VARIABLE_DCGVar_30, VarName_61, STATE_VARIABLE_VarSet_18_64, STATE_VARIABLE_VarSet_26);
  ...
  else
  {
    ...
    parse_tree__parse_dcg_goal__make_dcg_call_10_p_0((MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_2[2]), ProgArgTerms_24, Context_12, &Goal_43, STATE_VARIABLE_VarSet_0_25, STATE_VARIABLE_VarSet_26, STATE_VARIABLE_Counter_0_27, STATE_VARIABLE_Counter_28, STATE_VARIABLE_DCGVar_0_29, STATE_VARIABLE_DCGVar_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *MaybeGoal_14 = base;
  ...
  MR_Word * STATE_VARIABLE_DCGVar_34)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__parse_dcg_goal__new_dcg_var_5_p_0(STATE_VARIABLE_VarSet_0_29, STATE_VARIABLE_VarSet_30, STATE_VARIABLE_Counter_0_31, STATE_VARIABLE_Counter_32, STATE_VARIABLE_DCGVar_34);
    {
  ...
  MR_Word * STATE_VARIABLE_DCGVar_30)
{
  if ((ArgTerms_11 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_Word Var_63;
    MR_Integer N_73;
    MR_String StringN_74;
    MR_String VarName_75;
    MR_Word STATE_VARIABLE_VarSet_18_78;

    mercury__counter__allocate_3_p_0(&N_73, STATE_VARIABLE_Counter_0_27, STATE_VARIABLE_Counter_28);
    mercury__string__int_to_string_2_p_0(N_73, &StringN_74);
    mercury__string__append_3_p_2((MR_String) "DCG_", StringN_74, &VarName_75);
    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), STATE_VARIABLE_DCGVar_30, STATE_VARIABLE_VarSet_0_25, &STATE_VARIABLE_VarSet_18_78);
    mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), *STATE_VARIABLE_DCGVar_30, VarName_75, STATE_VARIABLE_VarSet_18_78, STATE_VARIABLE_VarSet_26);
    {
      Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
