            ...
            if ((parse_tree__parse_dcg_goal__Args_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_205, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[63])));
                }
                {
              ...
              if (parse_tree__parse_dcg_goal__succeeded)
                  ...
                  if (parse_tree__parse_dcg_goal__succeeded)
                  ...
                  else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_139, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[64])));
                      }
                      {
              ...
              else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_172, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[65])));
                  }
                  {
              ...
              if (parse_tree__parse_dcg_goal__succeeded)
              ...
              else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_321, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[66])));
                  }
                  {
              ...
              if (parse_tree__parse_dcg_goal__succeeded)
              ...
              else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_276, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[66])));
                  }
                  {
            ...
            if ((parse_tree__parse_dcg_goal__Args_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), parse_tree__parse_dcg_goal__Var_231, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[67])));
                }
                {
        ...
        if (parse_tree__parse_dcg_goal__succeeded)
          {
            ...
            parse_tree__parse_dcg_goal__Var_31 = (MR_Word) &parse_tree__parse_dcg_goal_scalar_common_3[1];
