  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_79_79 = (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_79_79, ((MR_Box) (VarB_27)), ((MR_Box) (STATE_VARIABLE_DCGVar_0_44)));
        }
        if (succeeded)
        {
  ...
  MR_Word * Var_22)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeInfo_67_67 = (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_67_67, ((MR_Box) (VarElse_27)), ((MR_Box) (Var0_21)));
    }
    if (succeeded)
    {
      *Var_22 = Var0_21;
  ...
  MR_Word * STATE_VARIABLE_DCGVar_42)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeInfo_45_104 = (MR_Word) (&parse_tree__parse_dcg_goal_scalar_common_1[3]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_45_104, ((MR_Box) (Var1_88)), ((MR_Box) (Var2_90)));
    }
    if (succeeded)
