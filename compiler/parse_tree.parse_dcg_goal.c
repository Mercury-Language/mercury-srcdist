        ...
        case (MR_Integer) 5:
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_205, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Var_205, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[63])));
              }
              {
            ...
            ;
            {
              ...
              if (succeeded)
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_139, 0) = ((MR_Box) (Context_14));
                    MR_hl_field(MR_mktag(1), Var_139, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[64])));
                  }
                  {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_172, 0) = ((MR_Box) (Context_14));
                  MR_hl_field(MR_mktag(1), Var_172, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[65])));
                }
                {
            ...
            ;
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_321, 0) = ((MR_Box) (Context_14));
                  MR_hl_field(MR_mktag(1), Var_321, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[66])));
                }
                {
            ...
            ;
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_276, 0) = ((MR_Box) (Context_14));
                  MR_hl_field(MR_mktag(1), Var_276, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[66])));
                }
                {
        ...
        case (MR_Integer) 17:
          {
            ...
            if ((Args_13 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_231, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Var_231, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_dcg_goal_scalar_common_1[67])));
              }
              {
