  ...
  MR_Word * Errors_18)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_31)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_16 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 152, &SmartRecompilation_34);
  ...
  MR_Word * SearchDirs_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 73, &VeryVerbose_33);
  ...
  MR_Word * Errors_24)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_42)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_22 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 152, &SmartRecompilation_45);
  ...
  MR_Word * SearchDirs_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 73, &VeryVerbose_42);
