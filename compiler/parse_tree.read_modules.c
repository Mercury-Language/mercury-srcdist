...
{
  {
    ...
    switch (Search_15) {
      ...
      case (MR_Integer) 0:
        {
          libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 658, &SearchDirs_27);
        }
        break;
    }
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 658, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 60, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 658, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
