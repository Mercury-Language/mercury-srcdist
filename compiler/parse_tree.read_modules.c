        ...
        if (((MR_tag((MR_Word) parse_tree__read_modules__V_55_55)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            *parse_tree__read_modules__MaybeTimestamp_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 124, &parse_tree__read_modules__SmartRecompilation_50);
            }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 55, &parse_tree__read_modules__VeryVerbose_22);
    }
    {
    ...
    switch (parse_tree__read_modules__Search_15) {
      ...
      case (MR_Integer) 0:
        {
          {
            libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 644, &parse_tree__read_modules__SearchDirs_27);
          }
        }
        break;
    }
        ...
        if (((MR_tag((MR_Word) parse_tree__read_modules__V_65_65)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            *parse_tree__read_modules__MaybeTimestamp_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 124, &parse_tree__read_modules__SmartRecompilation_60);
            }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 55, &parse_tree__read_modules__VeryVerbose_29);
    }
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 644, &parse_tree__read_modules___InterfaceSearchDirs_30);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_14, (MR_Integer) 55, &parse_tree__read_modules__VeryVerbose_27);
    }
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_14, (MR_Integer) 644, &parse_tree__read_modules__InterfaceSearchDirs_28);
    }
