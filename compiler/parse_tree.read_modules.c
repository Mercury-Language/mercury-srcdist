...
{
  {
    ...
    switch (Search_17) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 689, &SearchDirs_26);
        break;
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 71, &VeryVerbose_25);
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_38)) == (MR_Integer) 1))
      {
        ...
        *MaybeTimestamp_15 = (MR_Word) ((MR_Unsigned) 0U);
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 147, &SmartRecompilation_33);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 32, &Warn_45);
              switch (Warn_45) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 81, &Statistics_28);
  ...
  MR_Word * MaybeTimestamp_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Var_21)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_10 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 147, &SmartRecompilation_14);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 689, SearchDirs_18);
        }
        break;
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 71, VeryVerbose_17);
