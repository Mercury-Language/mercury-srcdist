  ...
  MR_Word * SearchDirs_20)
{
          ...
          case (MR_Integer) 0:
            {
              ...
              parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_24, ModuleName_16, FileName_18, &_FileNameProposed_41);
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_24, ModuleName_16, FileName_18, &_FileNameProposed_27);
              libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 710, SearchDirs_20);
            }
            break;
        }
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_kind__opt_file_kind_to_extension_3_p_0(OptFileKind_26, &_ExtStr_39, &Ext_56);
        switch (Search_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_String Var_44;
              MR_String _FileNameProposed_42;

              parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_56, ModuleName_16, FileName_18, &_FileNameProposed_42);
          ...
          case (MR_Integer) 1:
            {
              MR_String _FileNameProposed_47;

              parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_56, ModuleName_16, FileName_18, &_FileNameProposed_47);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 77, &VeryVerbose_64);
  switch (VeryVerbose_64) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_94 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
              Msg_65 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_94);
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              Var_91 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
              Msg_65 = mercury__string__f_43_43_2_f_0((MR_String) "% Getting dependencies for \140", Var_91);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              Var_88 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
              Msg_65 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading old version of \140", Var_88);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              Msg_65 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_85);
            }
            break;
        }
        {
        ...
        mercury__io__write_string_4_p_0(ProgressStream_12, Msg_65);
