  ...
  MR_Word * HaveModule_18)
{
  ...
  switch (Search_16) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 700, &SearchDirs_22);
      break;
  }
  ...
  MR_Word * Errors_18)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_25)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_16 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 164, &SmartRecompilation_28);
  ...
  MR_Word * Errors_26)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_38)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_24 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 164, &SmartRecompilation_41);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 701, SearchDirs_20);
            }
            break;
        }
      }
