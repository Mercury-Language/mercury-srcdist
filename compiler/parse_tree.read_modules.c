...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 673, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    switch (Search_17) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 673, &SearchDirs_28);
        break;
    }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 64, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 673, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
