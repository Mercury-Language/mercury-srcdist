...
{
  {
    ...
    parse_tree__parse_module__actually_read_module_src_11_p_0(Globals_12, DefaultModuleName_26, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), MaybeFileNameAndStream_28, ReadModuleAndTimestamps_16, &MaybeTimestampRes_29, ParseTreeSrc_18, &Specs0_30, Errors_20);
    parse_tree__read_modules__check_timestamp_6_p_0(Globals_12, FullFileName_23, MaybeTimestampRes_29, MaybeTimestamp_17);
    succeeded = mercury__set__is_empty_1_p_0((MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0, *Errors_20);
    if (succeeded)
    {
      libs__file_util__maybe_write_string_4_p_0(VeryVerbose_22, (MR_String) "successful parse.\n");
      *Specs_19 = Specs0_30;
    }
    else
    {
      MR_Word TypeCtorInfo_30_74;
      MR_Word FatalErrors_61;
      MR_Word Var_64;

      Var_64 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
      TypeCtorInfo_30_74 = (MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0;
      mercury__set__intersect_3_p_0(TypeCtorInfo_30_74, *Errors_20, Var_64, &FatalErrors_61);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_30_74, FatalErrors_61);
      if (succeeded)
      {
        libs__file_util__maybe_write_string_4_p_0(VeryVerbose_22, (MR_String) "parse error(s).\n");
      }
      else
      {
        libs__file_util__maybe_write_string_4_p_0(VeryVerbose_22, (MR_String) "fatal error(s).\n");
      }
      parse_tree__error_util__maybe_write_out_errors_no_module_6_p_0(VeryVerbose_22, Globals_12, Specs0_30, Specs_19);
...
parse_tree__read_modules__check_timestamp_6_p_0(
  ...
  MR_Word * MaybeTimestamp_10)
{
  if ((MaybeTimestampRes_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    *MaybeTimestamp_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  else
  {
    MR_Word Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeTimestampRes_9, (MR_Integer) 0)));

    if (((MR_tag((MR_Word) Var_21)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_Word IOError_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_21, (MR_Integer) 0)));
      MR_Word SmartRecompilation_14;

      *MaybeTimestamp_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 128, &SmartRecompilation_14);
...
{
  {
    ...
    Extension_66 = parse_tree__file_kind__file_kind_to_extension_1_f_0(Var_48);
    ...
    switch (Search_18) {
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_15, (MR_Integer) 1, Extension_66, ModuleName_19, &FileName0_28);
          Var_81 = mercury__dir__this_directory_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), SearchDirs_31, 0) = ((MR_Box) (Var_81));
      ...
      case (MR_Integer) 0:
        {
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_15, Extension_66, ModuleName_19, &FileName0_28);
          SearchDirs_31 = _InterfaceSearchDirs_30;
        }
        break;
    }
    Var_76 = mercury__string__f_43_43_2_f_0(FileName0_28, (MR_String) "\'... ");
    Var_74 = mercury__string__f_43_43_2_f_0((MR_String) " \140", Var_76);
    Var_73 = mercury__string__f_43_43_2_f_0(Descr_16, Var_74);
    Msg_67 = mercury__string__f_43_43_2_f_0((MR_String) "% ", Var_73);
    libs__file_util__maybe_write_string_4_p_0(VeryVerbose_29, Msg_67);
    ...
    parse_tree__parse_module__actually_read_module_int_12_p_0(IntFileKind_20, Globals_15, ModuleName_19, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), MaybeFileNameAndStream_32, ReadModuleAndTimestamps_22, &MaybeTimestampRes_33, ParseTreeInt_24, &ModuleSpecs_34, Errors_26);
...
{
  {
    ...
    MR_String Var_68;
    MR_String Var_70;
    MR_Word _ActualModuleName_36;

    Extension_60 = parse_tree__file_kind__file_kind_to_extension_1_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 59, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 654, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
    ...
    _ActualModuleName_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), ParseTreeSrc0_34, (MR_Integer) 0)));
