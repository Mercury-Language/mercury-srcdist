        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleTimestamp_19, (MR_Integer) 2)));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleTimestamp_21, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_44 = mercury__dir__this_directory_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), SearchDirs_27, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
      case (MR_Integer) 0:
        {
          libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 663, &SearchDirs_27);
        }
        break;
    }
    libs__file_util__search_for_file_and_stream_5_p_0(SearchDirs_27, FullFileName_23, &MaybeFileNameAndStream_28);
    parse_tree__parse_module__actually_read_module_src_11_p_0(Globals_12, DefaultModuleName_26, (MR_Word) ((MR_Unsigned) 0U), MaybeFileNameAndStream_28, ReadModuleAndTimestamps_16, &MaybeTimestampRes_29, ParseTreeSrc_18, &Specs0_30, Errors_20);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_48, 0) = (MR_Box) ((MR_Unsigned) (IntFileKind_20));
    }
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 663, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), *ParseTreeInt_24, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = (IntItems_43 == (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            succeeded = (ImpAvails_42 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              succeeded = (ImplItems_44 == (MR_Word) ((MR_Unsigned) 0U));
          }
        }
      }
    }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 60, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 663, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
