      ...
      *Errors_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModule_18, (MR_Integer) 4))));
      switch (ReturnTimestamp_11) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          *MaybeTimestamp_13 = (MR_Word) ((MR_Integer) 0);
          break;
      }
      succeeded = MR_TRUE;
    }
      ...
      *Errors_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HaveReadModule_20, (MR_Integer) 4))));
      switch (ReturnTimestamp_13) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          *MaybeTimestamp_15 = (MR_Word) ((MR_Integer) 0);
          break;
      }
      succeeded = MR_TRUE;
    }
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_44 = mercury__dir__this_directory_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), SearchDirs_27, 1) = ((MR_Box) ((MR_Integer) 0));
          }
        }
        break;
      case (MR_Integer) 0:
    ...
    parse_tree__parse_module__actually_read_module_src_11_p_0(Globals_12, DefaultModuleName_26, (MR_Word) ((MR_Integer) 0), MaybeFileNameAndStream_28, ReadModuleAndTimestamps_16, &MaybeTimestampRes_29, ParseTreeSrc_18, &Specs0_30, Errors_20);
...
parse_tree__read_modules__check_timestamp_6_p_0(
  ...
  MR_Word * MaybeTimestamp_10)
{
  if ((MaybeTimestampRes_9 == (MR_Word) ((MR_Integer) 0)))
    *MaybeTimestamp_10 = (MR_Word) ((MR_Integer) 0);
  else
  {
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_81 = mercury__dir__this_directory_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), SearchDirs_31, 1) = ((MR_Box) ((MR_Integer) 0));
          }
        }
        break;
      case (MR_Integer) 0:
    ...
    parse_tree__parse_module__actually_read_module_int_12_p_0(IntFileKind_20, Globals_15, ModuleName_19, (MR_Word) ((MR_Integer) 0), MaybeFileNameAndStream_32, ReadModuleAndTimestamps_22, &MaybeTimestampRes_33, ParseTreeInt_24, &ModuleSpecs_34, Errors_26);
    ...
    succeeded = (IntIncls_39 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    {
      succeeded = (ImpIncls_40 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
        succeeded = (IntAvails_41 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
          succeeded = (IntItems_43 == (MR_Word) ((MR_Integer) 0));
          if (succeeded)
          {
            succeeded = (ImpAvails_42 == (MR_Word) ((MR_Integer) 0));
            if (succeeded)
              succeeded = (ImplItems_44 == (MR_Word) ((MR_Integer) 0));
          }
        }
      }
    }
...
{
  {
    ...
    Extension_60 = parse_tree__file_kind__file_kind_to_extension_1_f_0((MR_Word) ((MR_Integer) 0));
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 60, &VeryVerbose_29);
...
{
  {
    ...
    if ((MaybeTimestampRes_21 == (MR_Word) ((MR_Integer) 0)))
      *MaybeTimestamp_22 = (MR_Word) ((MR_Integer) 0);
    else
    {
