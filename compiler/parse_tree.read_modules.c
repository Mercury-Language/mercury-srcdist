    ...
    case (MR_Integer) 1:
      {
        ...
        SearchWhichDirs_22 = parse_tree__find_module__get_search_auth_normal_dirs_1_f_0(OptionTable_54);
      }
      break;
  }
  ...
  MR_Word * SearchAuthDirs_20)
{
  ...
  switch (MR_tag((MR_Word) FileKind_17)) {
        ...
        switch (Search_15) {
          ...
          case (MR_Integer) 0:
            *SearchAuthDirs_20 = (MR_Word) ((MR_Unsigned) 0U);
            break;
          case (MR_Integer) 1:
            *SearchAuthDirs_20 = parse_tree__find_module__get_search_auth_normal_dirs_1_f_0(OptionTable_22);
            break;
        }
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        switch (Search_15) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word SearchWhichDirs_26;
              MR_String _FileNameProposed_27;

              {
                SearchWhichDirs_26 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, SearchWhichDirs_26, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                MR_hl_field(3, SearchWhichDirs_26, 1) = ((MR_Box) (OptionTable_22));
              }
              parse_tree__file_names__module_name_to_search_file_name_8_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_25, ModuleName_16, SearchWhichDirs_26, SearchAuthDirs_20, FileName_18, &_FileNameProposed_27);
            }
            break;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_28 = ((MR_Unsigned) ((MR_hl_field(2, FileKind_17, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word Ext_48;
        MR_String _ExtStr_39;

        parse_tree__file_kind__opt_file_kind_to_extension_3_p_0(OptFileKind_28, &_ExtStr_39, &Ext_48);
        switch (Search_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
          ...
          case (MR_Integer) 1:
            {
              MR_Word SearchWhichDirs_41;
              MR_String _FileNameProposed_40;

              {
                SearchWhichDirs_41 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, SearchWhichDirs_41, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                MR_hl_field(3, SearchWhichDirs_41, 1) = ((MR_Box) (OptionTable_22));
              }
              parse_tree__file_names__module_name_to_search_file_name_8_p_1(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_48, ModuleName_16, SearchWhichDirs_41, SearchAuthDirs_20, FileName_18, &_FileNameProposed_40);
            }
            break;
        }
      }
