...
{
  {
    ...
    Extension_53 = parse_tree__file_kind__file_kind_to_extension_1_f_0(Var_36);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 64, &VeryVerbose_29);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_15, (MR_Integer) 1, Extension_53, ModuleName_19, &FileName0_28);
          Var_67 = mercury__dir__this_directory_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(1), SearchDirs_30, 0) = ((MR_Box) (Var_67));
      ...
      case (MR_Integer) 0:
        {
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_15, Extension_53, ModuleName_19, &FileName0_28);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 675, &SearchDirs_30);
        }
        break;
    }
    Var_63 = mercury__string__f_43_43_2_f_0(FileName0_28, (MR_String) "\'... ");
    Var_61 = mercury__string__f_43_43_2_f_0((MR_String) " \140", Var_63);
    Var_60 = mercury__string__f_43_43_2_f_0(Descr_16, Var_61);
    Msg_54 = mercury__string__f_43_43_2_f_0((MR_String) "% ", Var_60);
    libs__file_util__maybe_write_string_4_p_0(VeryVerbose_29, Msg_54);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 64, &VeryVerbose_24);
    ...
    switch (Search_17) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 675, &SearchDirs_30);
        break;
    }
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_38)) == (MR_Integer) 1))
      {
        ...
        *MaybeTimestamp_15 = (MR_Word) ((MR_Unsigned) 0U);
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 133, &SmartRecompilation_33);
    ...
    if (succeeded)
    {
      libs__file_util__maybe_write_string_4_p_0(VeryVerbose_12, (MR_String) "successful parse.\n");
      *Specs_17 = ModuleSpecs_16;
    }
    else
    {
      MR_Word FatalErrors_77;
      MR_Word Var_80;

      Var_80 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
      mercury__set__intersect_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), Errors_18, Var_80, &FatalErrors_77);
      succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0), FatalErrors_77);
      if (succeeded)
        libs__file_util__maybe_write_string_4_p_0(VeryVerbose_12, (MR_String) "parse error(s).\n");
      else
        libs__file_util__maybe_write_string_4_p_0(VeryVerbose_12, (MR_String) "fatal error(s).\n");
      parse_tree__error_util__maybe_write_out_errors_no_module_6_p_0(VeryVerbose_12, Globals_11, ModuleSpecs_16, Specs_17);
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
    }
  }
}
...
{
  {
    ...
    MR_String Extension_56;
    MR_String Msg_57;
    MR_String Var_63;
    MR_String Var_64;
    MR_String Var_66;

    Extension_56 = parse_tree__file_kind__file_kind_to_extension_1_f_0((MR_Word) ((MR_Unsigned) 0U));
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 64, &VeryVerbose_29);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_15, (MR_Integer) 1, Extension_56, ModuleName_19, &FileName0_28);
          Var_70 = mercury__dir__this_directory_0_f_0();
          {
            SearchDirs_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SearchDirs_30, 0) = ((MR_Box) (Var_70));
            MR_hl_field(MR_mktag(1), SearchDirs_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
      case (MR_Integer) 0:
        {
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_15, Extension_56, ModuleName_19, &FileName0_28);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 675, &SearchDirs_30);
        }
        break;
    }
    Var_66 = mercury__string__f_43_43_2_f_0(FileName0_28, (MR_String) "\'... ");
    Var_64 = mercury__string__f_43_43_2_f_0((MR_String) " \140", Var_66);
    Var_63 = mercury__string__f_43_43_2_f_0(Descr_16, Var_64);
    Msg_57 = mercury__string__f_43_43_2_f_0((MR_String) "% ", Var_63);
    libs__file_util__maybe_write_string_4_p_0(VeryVerbose_29, Msg_57);
    libs__file_util__maybe_flush_output_3_p_0(VeryVerbose_29);
...
{
  {
    ...
    {
      MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeFileNameAndStream_17, (MR_Integer) 0))));

      *FileName_19 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_30, (MR_Integer) 0))));
    }
    if ((MaybeTimestampRes_20 == (MR_Word) ((MR_Unsigned) 0U)))
      *MaybeTimestamp_21 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTimestampRes_20, (MR_Integer) 0))));

      if (((MR_tag((MR_Word) Var_53)) == (MR_Integer) 1))
      {
        MR_Word IOError_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_53, (MR_Integer) 0))));
        MR_Word SmartRecompilation_48;

        *MaybeTimestamp_21 = (MR_Word) ((MR_Unsigned) 0U);
        libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 133, &SmartRecompilation_48);
        switch (SmartRecompilation_48) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
            }
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__io_set_disable_smart_recompilation_3_p_0((MR_Integer) 1);
              libs__globals__io_set_disable_generate_item_version_numbers_3_p_0((MR_Integer) 1);
              libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 30, &Warn_60);
              switch (Warn_60) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    MR_String Msg_61;
                    MR_Word HaltAtWarn_62;

                    mercury__io__write_string_3_p_0((MR_String) "Warning: cannot find modification time for ");
                    mercury__io__write_string_3_p_0(FileName0_18);
                    mercury__io__write_string_3_p_0((MR_String) ":\n");
                    mercury__io__error_message_2_p_0(IOError_47, &Msg_61);
                    mercury__io__write_string_3_p_0((MR_String) "  ");
                    mercury__io__write_string_3_p_0(Msg_61);
                    mercury__io__write_string_3_p_0((MR_String) ".\n");
                    mercury__io__write_string_3_p_0((MR_String) "  Smart recompilation will not work.\n");
                    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 3, &HaltAtWarn_62);
                    switch (HaltAtWarn_62) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        {
                        }
      ...
      {
        MR_Word Timestamp_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_53, (MR_Integer) 0))));

        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *MaybeTimestamp_21 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Timestamp_46));
        }
      }
    }
    switch (IgnoreErrors_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        parse_tree__read_modules__handle_any_read_module_errors_7_p_0(Globals_14, VeryVerbose_16, Errors_24, ModuleSpecs_22, Specs_23);
        break;
      case (MR_Integer) 0:
        {
