...
parse_tree__read_modules__read_module_end_17_p_0(
  ...
  MR_Word parse_tree__read_modules__MaybeFileNameAndStream_24,
  MR_String parse_tree__read_modules__FileName0_25,
        ...
        if (((MR_tag((MR_Word) parse_tree__read_modules__V_21_21)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            *parse_tree__read_modules__MaybeTimestamp_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_7, (MR_Integer) 117, &parse_tree__read_modules__SmartRecompilation_14);
            }
...
{
  {
    ...
    if (parse_tree__read_modules__succeeded)
    ...
    else
      {
        ...
        {
          parse_tree__read_modules__V_20_20 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
        }
  ...
  MR_Word parse_tree__read_modules__Errors_32)
{
  {
    MR_bool parse_tree__read_modules__succeeded;
    MR_Word parse_tree__read_modules__NameSpecs_36;
    MR_Word parse_tree__read_modules__V_42_42;

    if (((MR_tag((MR_Word) parse_tree__read_modules__MaybeFileNameAndStream_24)) == (MR_mktag((MR_Integer) 1))))
      *parse_tree__read_modules__FileName_26 = parse_tree__read_modules__FileName0_25;
    else
      {
        MR_Word parse_tree__read_modules__V_40_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__read_modules__MaybeFileNameAndStream_24, (MR_Integer) 0)));
        MR_Word parse_tree__read_modules__V_34_34;

        *parse_tree__read_modules__FileName_26 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__read_modules__V_40_40, (MR_Integer) 0)));
        parse_tree__read_modules__V_34_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__read_modules__V_40_40, (MR_Integer) 1)));
      }
    {
      parse_tree__read_modules__V_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__read_modules__V_42_42, 0) = ((MR_Box) (parse_tree__read_modules__ActualModuleNameContext_23));
    }
    {
      parse_tree__parse_module__check_module_has_expected_name_6_p_0((MR_Integer) 1, *parse_tree__read_modules__FileName_26, parse_tree__read_modules__ModuleName_21, parse_tree__read_modules__ActualModuleName_22, parse_tree__read_modules__V_42_42, &parse_tree__read_modules__NameSpecs_36);
    }
    {
      parse_tree__read_modules__check_timestamp_6_p_0(parse_tree__read_modules__Globals_18, parse_tree__read_modules__FileName0_25, parse_tree__read_modules__MaybeTimestampRes_27, parse_tree__read_modules__MaybeTimestamp_28);
    }
    switch (parse_tree__read_modules__IgnoreErrors_19) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Word parse_tree__read_modules__ModuleNameSpecs_37;

          {
            parse_tree__read_modules__ModuleNameSpecs_37 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, parse_tree__read_modules__NameSpecs_36, parse_tree__read_modules__ModuleSpecs_30);
          }
          {
            parse_tree__read_modules__succeeded = mercury__set__is_empty_1_p_0((MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0, parse_tree__read_modules__Errors_32);
          }
          if (parse_tree__read_modules__succeeded)
            {
              {
                libs__file_util__maybe_write_string_4_p_0(parse_tree__read_modules__VeryVerbose_20, (MR_String) "successful parse.\n");
              }
              *parse_tree__read_modules__Specs_31 = parse_tree__read_modules__ModuleNameSpecs_37;
            }
          else
            {
              MR_Word parse_tree__read_modules__TypeCtorInfo_30_75;
              MR_Word parse_tree__read_modules__FatalErrors_62;
              MR_Word parse_tree__read_modules__V_65_65;

              {
                parse_tree__read_modules__V_65_65 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
              }
              parse_tree__read_modules__TypeCtorInfo_30_75 = (MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0;
              {
                mercury__set__intersect_3_p_0(parse_tree__read_modules__TypeCtorInfo_30_75, parse_tree__read_modules__Errors_32, parse_tree__read_modules__V_65_65, &parse_tree__read_modules__FatalErrors_62);
              }
              {
                parse_tree__read_modules__succeeded = mercury__set__is_empty_1_p_0(parse_tree__read_modules__TypeCtorInfo_30_75, parse_tree__read_modules__FatalErrors_62);
              }
              if (parse_tree__read_modules__succeeded)
                {
                  {
                    libs__file_util__maybe_write_string_4_p_0(parse_tree__read_modules__VeryVerbose_20, (MR_String) "parse error(s).\n");
                  }
                }
              else
                {
                  {
                    libs__file_util__maybe_write_string_4_p_0(parse_tree__read_modules__VeryVerbose_20, (MR_String) "fatal error(s).\n");
                  }
                }
              {
                parse_tree__error_util__maybe_write_out_errors_no_module_6_p_0(parse_tree__read_modules__VeryVerbose_20, parse_tree__read_modules__Globals_18, parse_tree__read_modules__ModuleNameSpecs_37, parse_tree__read_modules__Specs_31);
              }
              {
                mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
              }
      ...
      case (MR_Integer) 0:
        {
          {
            parse_tree__read_modules__succeeded = mercury__set__contains_2_p_0((MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0, parse_tree__read_modules__Errors_32, ((MR_Box) ((MR_Integer) 0)));
          }
          if (parse_tree__read_modules__succeeded)
          ...
          if (parse_tree__read_modules__succeeded)
          ...
          else
            {
              ...
              {
                *parse_tree__read_modules__Specs_31 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, parse_tree__read_modules__NameSpecs_36, parse_tree__read_modules__ModuleSpecs_30);
              }
            }
        }
        break;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 48, &parse_tree__read_modules__VeryVerbose_22);
    }
    {
    ...
    switch (parse_tree__read_modules__Search_15) {
      ...
      case (MR_Integer) 1:
        {
          MR_String parse_tree__read_modules__V_44_44;

          {
            parse_tree__read_modules__V_44_44 = mercury__dir__this_directory_0_f_0();
          }
          {
            ...
            MR_hl_field(MR_mktag(1), parse_tree__read_modules__SearchDirs_27, 0) = ((MR_Box) (parse_tree__read_modules__V_44_44));
    ...
    if ((parse_tree__read_modules__MaybeTimestampRes_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *parse_tree__read_modules__MaybeTimestamp_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      {
        MR_Word parse_tree__read_modules__V_65_65 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__read_modules__MaybeTimestampRes_29, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) parse_tree__read_modules__V_65_65)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word parse_tree__read_modules__IOError_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__read_modules__V_65_65, (MR_Integer) 0)));
            MR_Word parse_tree__read_modules__SmartRecompilation_60;

            *parse_tree__read_modules__MaybeTimestamp_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 117, &parse_tree__read_modules__SmartRecompilation_60);
            }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 24, &parse_tree__read_modules__Warn_72);
                  }
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        {
                          libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 2, &parse_tree__read_modules__HaltAtWarn_74);
                        }
          ...
          {
            MR_Word parse_tree__read_modules__Timestamp_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__read_modules__V_65_65, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word parse_tree__read_modules__ActualModuleName_35;
    MR_Word parse_tree__read_modules__ActualModuleNameContext_37;
    ...
    MR_Word parse_tree__read_modules__V_48_48;
    ...
    {
      parse_tree__read_modules__V_48_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), parse_tree__read_modules__V_48_48, 0) = ((MR_Box) (parse_tree__read_modules__IntFileKind_20));
    }
    {
      parse_tree__read_modules__Extension_65 = parse_tree__file_kind__file_kind_to_extension_1_f_0(parse_tree__read_modules__V_48_48);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 48, &parse_tree__read_modules__VeryVerbose_29);
    }
    {
    ...
    parse_tree__read_modules__ActualModuleName_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), *parse_tree__read_modules__ParseTreeInt_24, (MR_Integer) 0)));
    ...
    parse_tree__read_modules__ActualModuleNameContext_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), *parse_tree__read_modules__ParseTreeInt_24, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word parse_tree__read_modules__ModuleSpecs_32;
    MR_Word parse_tree__read_modules__ActualModuleName_33;
    MR_Word parse_tree__read_modules__ActualModuleNameContext_34;
    MR_Word parse_tree__read_modules__ComponentsCord_35;
    MR_Word parse_tree__read_modules__IsEmpty_36;
    MR_String parse_tree__read_modules__Extension_57;
    MR_String parse_tree__read_modules__Msg_58;
    MR_String parse_tree__read_modules__V_64_64;
    MR_String parse_tree__read_modules__V_65_65;
    MR_String parse_tree__read_modules__V_67_67;

    {
      parse_tree__read_modules__Extension_57 = parse_tree__file_kind__file_kind_to_extension_1_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_14, (MR_Integer) 48, &parse_tree__read_modules__VeryVerbose_27);
    }
    {
    ...
    switch (parse_tree__read_modules__Search_17) {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            parse_tree__file_names__module_name_to_file_name_7_p_0(parse_tree__read_modules__Globals_14, parse_tree__read_modules__ModuleName_18, parse_tree__read_modules__Extension_57, (MR_Integer) 1, &parse_tree__read_modules__FileName0_26);
          }
          {
            parse_tree__read_modules__V_72_72 = mercury__dir__this_directory_0_f_0();
          }
          {
            ...
            MR_hl_field(MR_mktag(1), parse_tree__read_modules__SearchDirs_29, 0) = ((MR_Box) (parse_tree__read_modules__V_72_72));
      ...
      case (MR_Integer) 0:
        {
          {
            parse_tree__file_names__module_name_to_search_file_name_6_p_0(parse_tree__read_modules__Globals_14, parse_tree__read_modules__ModuleName_18, parse_tree__read_modules__Extension_57, &parse_tree__read_modules__FileName0_26);
          }
    ...
    {
      parse_tree__read_modules__V_67_67 = mercury__string__f_43_43_2_f_0(parse_tree__read_modules__FileName0_26, (MR_String) "\'... ");
    }
    {
      parse_tree__read_modules__V_65_65 = mercury__string__f_43_43_2_f_0((MR_String) " \140", parse_tree__read_modules__V_67_67);
    }
    {
      parse_tree__read_modules__V_64_64 = mercury__string__f_43_43_2_f_0(parse_tree__read_modules__Descr_15, parse_tree__read_modules__V_65_65);
    }
    {
      parse_tree__read_modules__Msg_58 = mercury__string__f_43_43_2_f_0((MR_String) "% ", parse_tree__read_modules__V_64_64);
    }
    {
      libs__file_util__maybe_write_string_4_p_0(parse_tree__read_modules__VeryVerbose_27, parse_tree__read_modules__Msg_58);
    }
    {
    ...
    {
      parse_tree__parse_module__actually_read_module_src_10_p_0(parse_tree__read_modules__Globals_14, parse_tree__read_modules__ModuleName_18, parse_tree__read_modules__MaybeFileNameAndStream_30, parse_tree__read_modules__ReadModuleAndTimestamps_20, &parse_tree__read_modules__MaybeTimestampRes_31, parse_tree__read_modules__ParseTreeSrc_22, &parse_tree__read_modules__ModuleSpecs_32, parse_tree__read_modules__Errors_24);
    }
    parse_tree__read_modules__ActualModuleName_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), *parse_tree__read_modules__ParseTreeSrc_22, (MR_Integer) 0)));
    parse_tree__read_modules__ActualModuleNameContext_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), *parse_tree__read_modules__ParseTreeSrc_22, (MR_Integer) 1)));
    parse_tree__read_modules__ComponentsCord_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), *parse_tree__read_modules__ParseTreeSrc_22, (MR_Integer) 2)));
    {
      parse_tree__read_modules__succeeded = mercury__cord__is_empty_1_p_0((MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_component_0, parse_tree__read_modules__ComponentsCord_35);
    }
    if (parse_tree__read_modules__succeeded)
      parse_tree__read_modules__IsEmpty_36 = (MR_Integer) 1;
    else
      parse_tree__read_modules__IsEmpty_36 = (MR_Integer) 0;
    {
      parse_tree__read_modules__read_module_end_17_p_0(parse_tree__read_modules__Globals_14, parse_tree__read_modules__IgnoreErrors_16, parse_tree__read_modules__VeryVerbose_27, parse_tree__read_modules__ModuleName_18, parse_tree__read_modules__ActualModuleName_33, parse_tree__read_modules__ActualModuleNameContext_34, parse_tree__read_modules__MaybeFileNameAndStream_30, parse_tree__read_modules__FileName0_26, parse_tree__read_modules__FileName_19, parse_tree__read_modules__MaybeTimestampRes_31, parse_tree__read_modules__MaybeTimestamp_21, parse_tree__read_modules__IsEmpty_36, parse_tree__read_modules__ModuleSpecs_32, parse_tree__read_modules__Specs_23, *parse_tree__read_modules__Errors_24);
    }
  }
}
