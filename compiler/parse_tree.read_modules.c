  ...
  MR_Word HeadVar__3_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__9_9, 0) = ((MR_Box) (&parse_tree__read_modules__parse_tree__read_modules__type_ctor_info_have_read_module_1));
    MR_hl_field(MR_mktag(0), TypeInfo__9_9, 1) = ((MR_Box) (TypeInfo_for_PT_7));
  }
  mercury__tree234____Compare____tree234_2_0(TypeInfo_for_Key_6, TypeInfo__9_9, HeadVar__1_1, (MR_Word) (Cast_HeadVar1_4), (MR_Word) (Cast_HeadVar2_5));
}
  ...
  MR_Word HeadVar__2_2)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 0) = ((MR_Box) (&parse_tree__read_modules__parse_tree__read_modules__type_ctor_info_have_read_module_1));
    MR_hl_field(MR_mktag(0), TypeInfo__8_8, 1) = ((MR_Box) (TypeInfo_for_PT_6));
  }
  succeeded = mercury__tree234____Unify____tree234_2_0(TypeInfo_for_Key_5, TypeInfo__8_8, (MR_Word) (Cast_HeadVar1_3), (MR_Word) (Cast_HeadVar2_4));
  return succeeded;
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__16_16 = (MR_Word) (&parse_tree__read_modules_scalar_common_1[7]);
