  ...
  MR_Word * HaveReadModule_16)
{
  ...
  switch (Search_14) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 680, &SearchDirs_20);
      break;
  }
  ...
  MR_Word * Errors_18)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_24)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_16 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 151, &SmartRecompilation_27);
  ...
  MR_Word * Errors_24)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_35)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_22 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 151, &SmartRecompilation_38);
