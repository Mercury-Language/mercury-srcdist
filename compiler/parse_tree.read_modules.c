  ...
  MR_Word Errors_20)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_33)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_17 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 148, &SmartRecompilation_36);
  ...
  MR_Word * MaybeTimestamp_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_12)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_10 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 148, &SmartRecompilation_15);
