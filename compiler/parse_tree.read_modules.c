...
MR_decl_label10(parse_tree__read_modules__do_read_module_15_0, 13,14,15,16,20,22,24,26,25,27)
MR_decl_label10(parse_tree__read_modules__do_read_module_15_0, 28,31,34,35,33,38,37,39,40,30)
MR_decl_label2(parse_tree__read_modules__do_read_module_15_0, 42,46)
...
MR_decl_label10(parse_tree__read_modules__read_module_from_file_13_0, 15,18,17,21,16,23,24,27,28,26)
MR_decl_label5(parse_tree__read_modules__read_module_from_file_13_0, 31,30,32,33,34)
...
MR_BEGIN_MODULE(parse_tree__read_modules_module1)
	...
	MR_init_label10(parse_tree__read_modules__do_read_module_15_0,13,14,15,16,20,22,24,26,25,27)
	MR_init_label10(parse_tree__read_modules__do_read_module_15_0,28,31,34,35,33,38,37,39,40,30)
	MR_init_label2(parse_tree__read_modules__do_read_module_15_0,42,46)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__read_modules_module5)
	...
	MR_init_label10(parse_tree__read_modules__read_module_from_file_13_0,15,18,17,21,16,23,24,27,28,26)
	MR_init_label5(parse_tree__read_modules__read_module_from_file_13_0,31,30,32,33,34)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__read_modules__find_read_module_9_0,7)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r2;
	MR_tfield(1, MR_r6, 0) = MR_tfield(0, MR_tfield(0, MR_tempr2, 0), 1);
	MR_tempr1 = MR_tempr2;
	MR_r2 = MR_tfield(0, MR_r2, 1);
	MR_r3 = MR_tfield(0, MR_tempr1, 2);
	MR_r4 = MR_tfield(0, MR_tempr1, 3);
