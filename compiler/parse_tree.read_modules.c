  ...
  MR_Word * MaybeTimestamp_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Var_21)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_10 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 133, &SmartRecompilation_14);
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_55)) == (MR_Integer) 1))
      {
        ...
        *MaybeTimestamp_22 = (MR_Word) ((MR_Unsigned) 0U);
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 133, &SmartRecompilation_50);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__io_set_disable_smart_recompilation_3_p_0((MR_Integer) 1);
              libs__globals__io_set_disable_generate_item_version_numbers_3_p_0((MR_Integer) 1);
              libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 30, &Warn_62);
              switch (Warn_62) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
