  ...
  MR_Word * Errors_18)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_25)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_16 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 175, &SmartRecompilation_28);
  ...
  MR_Word * Errors_26)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_38)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_24 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 175, &SmartRecompilation_41);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 89, &Statistics_31);
