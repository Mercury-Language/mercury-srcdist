...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 60, &VeryVerbose_22);
    ...
    switch (Search_15) {
      ...
      case (MR_Integer) 0:
        {
          libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 657, &SearchDirs_27);
        }
        break;
    }
  ...
  MR_Word * MaybeTimestamp_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Var_21)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      *MaybeTimestamp_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 129, &SmartRecompilation_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 60, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 657, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 60, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 657, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_55)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        *MaybeTimestamp_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 129, &SmartRecompilation_50);
