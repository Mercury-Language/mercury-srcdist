...
{
  {
    ...
    switch (parse_tree__read_modules__Search_15) {
      ...
      case (MR_Integer) 0:
        {
          {
            libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 636, &parse_tree__read_modules__SearchDirs_27);
          }
        }
        break;
    }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 636, &parse_tree__read_modules___InterfaceSearchDirs_30);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_14, (MR_Integer) 636, &parse_tree__read_modules__InterfaceSearchDirs_28);
    }
