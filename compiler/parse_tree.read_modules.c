  ...
  MR_Word * Errors_18)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_24)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_16 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 671, &SmartRecompilation_27);
  ...
  MR_Word * Errors_24)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) TimestampRes_36)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_22 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 671, &SmartRecompilation_39);
