...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 63, &VeryVerbose_24);
    ...
    switch (Search_17) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 672, &SearchDirs_28);
        break;
    }
  ...
  MR_Word * MaybeTimestamp_10)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Var_21)) == (MR_Integer) 1))
    {
      ...
      *MaybeTimestamp_10 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 132, &SmartRecompilation_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 63, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 672, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 63, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 672, &InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_55)) == (MR_Integer) 1))
      {
        ...
        *MaybeTimestamp_22 = (MR_Word) ((MR_Unsigned) 0U);
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 132, &SmartRecompilation_50);
