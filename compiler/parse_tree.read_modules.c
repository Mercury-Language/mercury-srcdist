  ...
  MR_Word * HaveReadModule_16)
{
  ...
  switch (Search_14) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 683, &SearchDirs_20);
      break;
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (MR_tag((MR_Word) FileKind_15)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 683, SearchDirs_18);
            break;
          case (MR_Integer) 1:
            libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 683, SearchDirs_18);
            break;
