...
MR_decl_label3(parse_tree__read_modules__find_read_module_9_0, 3,6,1)
...
MR_decl_label7(__Compare___parse_tree__read_modules__have_read_module_0_0, 3,2,5,9,13,17,60)
...
MR_BEGIN_MODULE(parse_tree__read_modules_module6)
	...
	MR_init_label3(parse_tree__read_modules__find_read_module_9_0,3,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__read_modules__find_read_module_9_0);
	...
	MR_np_call_localret_ent(map__search_3_0,
		parse_tree__read_modules__find_read_module_9_0_i3);
MR_def_label(parse_tree__read_modules__find_read_module_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__read_modules__find_read_module_9_0_i1);
	}
	if (MR_INT_NE(MR_sv(1),1)) {
		MR_GOTO_LAB(parse_tree__read_modules__find_read_module_9_0_i6);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(parse_tree__read_modules__find_read_module_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parse_tree__read_modules_module9)
	...
	MR_init_label7(__Compare___parse_tree__read_modules__have_read_module_0_0,3,2,5,9,13,17,60)
MR_BEGIN_CODE
...
MR_def_label(__Compare___parse_tree__read_modules__have_read_module_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parse_tree__read_modules__have_read_module_0_0_i60);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
...
MR_def_label(__Compare___parse_tree__read_modules__have_read_module_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__parse_tree__read_modules__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parse_tree__read_modules);
