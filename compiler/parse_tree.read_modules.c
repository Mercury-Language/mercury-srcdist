  ...
  MR_Word * SearchDirs_18)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_11, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/10", Ext_21, ModuleName_14, FileName_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 73, &VeryVerbose_34);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) ReadReasonMsg_12)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              Msg_35 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_69);
          ...
          case (MR_Integer) 1:
            {
              MR_Word ModuleName_58 = ((MR_Word) ((MR_hl_field(1, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_60;

              Var_60 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_35 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_60);
              libs__globals__get_progress_output_stream_5_p_0(Globals_11, ModuleName_58, &Stream_36);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ReadDoneMsg_17 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) (Stream_36));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word ModuleName_57 = ((MR_Word) ((MR_hl_field(2, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_63;

              Var_63 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_35 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading old version of \140", Var_63);
              libs__globals__get_progress_output_stream_5_p_0(Globals_11, ModuleName_57, &Stream_36);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ReadDoneMsg_17 = base;
          ...
          case (MR_Integer) 3:
            {
              MR_Word ModuleName_37 = ((MR_Word) ((MR_hl_field(3, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_66;

              Var_66 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_35 = mercury__string__f_43_43_2_f_0((MR_String) "% Getting dependencies for \140", Var_66);
