  ...
  MR_Word Errors_20)
{
  ...
  {
    MR_Word TimestampRes_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTimestampRes_16, (MR_Integer) 0))));

    if (((MR_tag((MR_Word) TimestampRes_33)) == (MR_Integer) 1))
    {
      MR_Word IOError_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TimestampRes_33, (MR_Integer) 0))));
      MR_Word SmartRecompilation_36;

      *MaybeTimestamp_17 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 149, &SmartRecompilation_36);
      switch (SmartRecompilation_36) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
          }
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 32, &Warn_45);
            switch (Warn_45) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__io__error_message_2_p_0(IOError_35, &ErrorMsg_46);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_57, 1) = ((MR_Box) (FileName_15));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (ErrorMsg_46));
                  }
                  {
                    Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Var_64));
                    MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__read_modules_scalar_common_1[17])));
                  }
                  {
                    Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (Var_63));
                  }
                  {
                    Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__read_modules_scalar_common_1[11])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__read_modules_scalar_common_1[10])));
                    MR_hl_field(MR_mktag(1), Pieces_47, 1) = ((MR_Box) (Var_56));
                  }
                  {
                    Spec_48 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Spec_48, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.read_modules.record_and_report_missing_timestamp\'/5"));
                    MR_hl_field(MR_mktag(2), Spec_48, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(2), Spec_48, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                    MR_hl_field(MR_mktag(2), Spec_48, 3) = ((MR_Box) (Pieces_47));
                  }
                  parse_tree__error_util__write_error_spec_4_p_0(Globals_12, Spec_48);
                }
                break;
            }
          }
    ...
    {
      MR_Word Timestamp_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TimestampRes_33, (MR_Integer) 0))));

      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *MaybeTimestamp_17 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Timestamp_34));
      }
    }
  }
  ...
  MR_Word * SearchDirs_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 72, &VeryVerbose_39);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__io_set_disable_smart_recompilation_3_p_0((MR_Integer) 1);
            libs__globals__io_set_disable_generate_item_version_numbers_3_p_0((MR_Integer) 1);
            libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 32, &Warn_26);
            switch (Warn_26) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__io__error_message_2_p_0(IOError_14, &ErrorMsg_27);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) (FileName_8));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (ErrorMsg_27));
                  }
                  {
                    Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (Var_45));
                    MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__read_modules_scalar_common_1[17])));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__read_modules_scalar_common_1[11])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_28, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__read_modules_scalar_common_1[10])));
                    MR_hl_field(MR_mktag(1), Pieces_28, 1) = ((MR_Box) (Var_37));
                  }
                  {
                    Spec_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Spec_29, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.read_modules.record_and_report_missing_timestamp\'/5"));
                    MR_hl_field(MR_mktag(2), Spec_29, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(2), Spec_29, 2) = ((MR_Box) ((MR_Unsigned) 12U));
                    MR_hl_field(MR_mktag(2), Spec_29, 3) = ((MR_Box) (Pieces_28));
                  }
                  parse_tree__error_util__write_error_spec_4_p_0(Globals_7, Spec_29);
                }
                break;
            }
          }
