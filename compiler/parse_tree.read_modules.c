  ...
  MR_Word * SearchDirs_18)
{
  ...
  parse_tree__file_kind__file_kind_to_extension_4_p_0(FileKind_15, &_ExtStr_20, &Ext_21, &NewExt_22);
  switch (Search_13) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_11, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/10", (MR_Integer) 1, Ext_21, NewExt_22, ModuleName_14, FileName_16);
    ...
    case (MR_Integer) 0:
      {
        parse_tree__file_names__module_name_to_search_file_name_8_p_0(Globals_11, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/10", Ext_21, NewExt_22, ModuleName_14, FileName_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 73, &VeryVerbose_36);
  switch (VeryVerbose_36) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) ReadReasonMsg_12)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              Msg_37 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_71);
              mercury__io__output_stream_3_p_0(&Stream_38);
              *ReadDoneMsg_17 = (MR_Word) ((MR_Unsigned) 4U);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ModuleName_60 = ((MR_Word) ((MR_hl_field(1, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_62;

              Var_62 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_37 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_62);
              libs__globals__get_progress_output_stream_5_p_0(Globals_11, ModuleName_60, &Stream_38);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ReadDoneMsg_17 = base;
                MR_hl_field(1, base, 0) = ((MR_Box) (Stream_38));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word ModuleName_59 = ((MR_Word) ((MR_hl_field(2, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_65;

              Var_65 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_37 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading old version of \140", Var_65);
              libs__globals__get_progress_output_stream_5_p_0(Globals_11, ModuleName_59, &Stream_38);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ReadDoneMsg_17 = base;
          ...
          case (MR_Integer) 3:
            {
              MR_Word ModuleName_39 = ((MR_Word) ((MR_hl_field(3, ReadReasonMsg_12, (MR_Integer) 0))));
              MR_String Var_68;

              Var_68 = mercury__string__f_43_43_2_f_0(*FileName_16, (MR_String) "\'... ");
              Msg_37 = mercury__string__f_43_43_2_f_0((MR_String) "% Getting dependencies for \140", Var_68);
              libs__globals__get_progress_output_stream_5_p_0(Globals_11, ModuleName_39, &Stream_38);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ReadDoneMsg_17 = base;
        ...
        mercury__io__write_string_4_p_0(Stream_38, Msg_37);
        mercury__io__flush_output_3_p_0(Stream_38);
      }
      break;
  }
}
