...
{
  {
    ...
    switch (Search_13) {
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_11, (MR_Integer) 1, Ext_21, ModuleName_14, FileName0_16);
          Var_37 = mercury__dir__this_directory_0_f_0();
          {
            MR_Word base;
      ...
      case (MR_Integer) 0:
        {
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_11, Ext_21, ModuleName_14, FileName0_16);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 678, SearchDirs_18);
        }
        break;
    }
    Var_41 = mercury__string__f_43_43_2_f_0(*FileName0_16, (MR_String) "\'... ");
    Var_43 = mercury__string__f_43_43_2_f_0((MR_String) " \140", Var_41);
    Var_44 = mercury__string__f_43_43_2_f_0(Descr_12, Var_43);
    Msg_22 = mercury__string__f_43_43_2_f_0((MR_String) "% ", Var_44);
    libs__file_util__maybe_write_string_4_p_0(*VeryVerbose_17, Msg_22);
