...
{
  {
    ...
    {
      parse_tree__parse_module__check_module_has_expected_name_6_p_0((MR_Integer) 1, *parse_tree__read_modules__FileName_26, parse_tree__read_modules__ModuleName_21, parse_tree__read_modules__ActualModuleName_22, parse_tree__read_modules__V_39_39, &parse_tree__read_modules__NameSpecs_34);
    }
        ...
        if (((MR_tag((MR_Word) parse_tree__read_modules__V_64_64)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            *parse_tree__read_modules__MaybeTimestamp_28 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              libs__globals__lookup_bool_option_3_p_0(parse_tree__read_modules__Globals_18, (MR_Integer) 117, &parse_tree__read_modules__SmartRecompilation_59);
            }
...
{
  {
    ...
    switch (parse_tree__read_modules__Search_15) {
      ...
      case (MR_Integer) 0:
        {
          {
            libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_12, (MR_Integer) 634, &parse_tree__read_modules__SearchDirs_27);
          }
        }
        break;
    }
    ...
    {
      parse_tree__read_modules__succeeded = mercury__set__is_empty_1_p_0((MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0, *parse_tree__read_modules__Errors_20);
    }
    if (parse_tree__read_modules__succeeded)
      {
        {
    ...
    else
      {
        ...
        {
          parse_tree__read_modules__V_68_68 = parse_tree__parse_error__fatal_read_module_errors_0_f_0();
        }
        parse_tree__read_modules__TypeCtorInfo_30_78 = (MR_Word) &parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0;
        {
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_15, (MR_Integer) 634, &parse_tree__read_modules___InterfaceSearchDirs_30);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(parse_tree__read_modules__Globals_14, (MR_Integer) 634, &parse_tree__read_modules__InterfaceSearchDirs_28);
    }
