...
{
  {
    ...
    switch (Search_13) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 690, SearchDirs_18);
        break;
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (MR_tag((MR_Word) FileKind_15)) {
            ...
            case (MR_Integer) 1:
              ...
              break;
            case (MR_Integer) 2:
              libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 691, SearchDirs_18);
              break;
          }
        }
        break;
