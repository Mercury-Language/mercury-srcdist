...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 58, &VeryVerbose_22);
    ...
    switch (Search_15) {
      ...
      case (MR_Integer) 0:
        {
          libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 654, &SearchDirs_27);
        }
        break;
    }
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_65)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        *MaybeTimestamp_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 127, &SmartRecompilation_60);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 58, &VeryVerbose_29);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 654, &_InterfaceSearchDirs_30);
    switch (Search_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 58, &VeryVerbose_27);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_14, (MR_Integer) 654, &InterfaceSearchDirs_28);
    switch (Search_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_55)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        *MaybeTimestamp_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 127, &SmartRecompilation_50);
