  ...
  MR_Word * HaveModule_18)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__get_options_2_p_0(Globals_12, &OptionTable_54);
        {
          SearchWhichDirs_22 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, SearchWhichDirs_22, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, SearchWhichDirs_22, 1) = ((MR_Box) (OptionTable_54));
        }
      }
      break;
  }
  ...
  if (((MR_tag((MR_Word) MaybeFileNameAndStream_24)) == (MR_Integer) 1))
  {
    ...
    parse_tree__read_modules__read_module_end_file_10_p_0(Globals_12, (MR_Word) ((MR_Unsigned) 0U), ReadDoneMsg_21, FileNameDotM_14, (MR_Word) ((MR_Unsigned) 0U), &_MaybeTimestamp_35, Errors0_53, &Errors_36);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HaveModule_18 = base;
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(1, Var_46, 1) = ((MR_Box) (Errors1_97));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HaveModule_20)
{
  ...
  MR_Word SearchWhichDirs_24;
  MR_Word MaybeFileNameAndStream_26;
  MR_Word _SearchDirs_25;

  parse_tree__read_modules__read_module_begin_11_p_0(ProgressStream_12, Globals_13, ReadReasonMsg_14, Search_16, ModuleName_17, (MR_Word) ((MR_Unsigned) 0U), &FileName0_22, &ReadDoneMsg_23, &SearchWhichDirs_24);
  parse_tree__find_module__search_for_module_source_and_stream_6_p_0(SearchWhichDirs_24, ModuleName_17, &_SearchDirs_25, &MaybeFileNameAndStream_26);
  ...
  MR_Word * SearchWhichDirs_20)
{
  ...
  libs__globals__get_options_2_p_0(Globals_13, &OptionTable_22);
  switch (MR_tag((MR_Word) FileKind_17)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (Search_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *SearchWhichDirs_20 = (MR_Word) ((MR_Unsigned) 0U);
            break;
          case (MR_Integer) 1:
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *SearchWhichDirs_20 = base;
              MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(3, base, 1) = ((MR_Box) (OptionTable_22));
            }
            break;
        }
      }
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_23 = ((MR_Unsigned) ((MR_hl_field(1, FileKind_17, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word Ext_25;
        MR_Word SearchWhichDirs0_26;
        MR_String _ExtStr_24;

        parse_tree__file_kind__int_file_kind_to_extension_3_p_0(IntFileKind_23, &_ExtStr_24, &Ext_25);
        {
          SearchWhichDirs0_26 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, SearchWhichDirs0_26, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, SearchWhichDirs0_26, 1) = ((MR_Box) (OptionTable_22));
        }
        switch (Search_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              ...
              parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_25, ModuleName_16, FileName_18, &_FileNameProposed_37);
              *SearchWhichDirs_20 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_String _FileNameProposed_28;

              parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_25, ModuleName_16, FileName_18, &_FileNameProposed_28);
              *SearchWhichDirs_20 = SearchWhichDirs0_26;
            }
            break;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Ext_48;
        MR_Word SearchWhichDirs0_49;
        MR_String _ExtStr_35;

        parse_tree__file_kind__opt_file_kind_to_extension_3_p_0(OptFileKind_27, &_ExtStr_35, &Ext_48);
        {
          SearchWhichDirs0_49 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, SearchWhichDirs0_49, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(3, SearchWhichDirs0_49, 1) = ((MR_Box) (OptionTable_22));
        }
        switch (Search_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              ...
              parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_48, ModuleName_16, FileName_18, &_FileNameProposed_38);
              *SearchWhichDirs_20 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_13, (MR_String) "predicate \140parse_tree.read_modules.read_module_begin\'/11", Ext_48, ModuleName_16, FileName_18, &_FileNameProposed_41);
              *SearchWhichDirs_20 = SearchWhichDirs0_49;
            }
            break;
        }
      }
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 77, &VeryVerbose_54);
    ...
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_84 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
          ...
          case (MR_Integer) 3:
            {
              ...
              Var_81 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_78 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_75 = mercury__string__f_43_43_2_f_0(*FileName_18, (MR_String) "\'... ");
        ...
        mercury__io__write_string_4_p_0(ProgressStream_12, Msg_55);
