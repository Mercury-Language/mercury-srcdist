...
{
  {
    ...
    switch (Search_17) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__globals__lookup_accumulating_option_3_p_0(Globals_13, (MR_Integer) 676, &SearchDirs_30);
        break;
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 676, SearchDirs_18);
        }
        break;
    }
