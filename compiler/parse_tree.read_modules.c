        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleTimestamp_19, (MR_Integer) 2)));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleTimestamp_21, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            SearchDirs_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), *ParseTreeInt_24, (MR_Integer) 1)));
