...
ll_backend.code_loc_dep.optdate ll_backend.code_loc_dep.trans_opt_date code_loc_dep.err ll_backend.code_loc_dep.c_date ll_backend.code_loc_dep.java_date : code_loc_dep.m \
	ll_backend.int0 \
	assoc_list.int \
	backend_libs.int \
	bool.int \
...
#   long deps
#   short deps
ll_backend.code_loc_dep.optdate ll_backend.code_loc_dep.trans_opt_date code_loc_dep.err ll_backend.code_loc_dep.c_date ll_backend.code_loc_dep.java_date : \
		code_loc_dep.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.code_loc_dep.pic_o ll_backend.code_loc_dep.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ll_backend.code_loc_dep.mh ll_backend.code_loc_dep.mih : ll_backend.code_loc_dep.c
...
ll_backend.code_loc_dep.module_dep : jmercury/ll_backend__code_loc_dep.java
else
ll_backend.code_loc_dep.module_dep : ll_backend.code_loc_dep.c
endif
...
ll_backend.code_loc_dep.date ll_backend.code_loc_dep.date0 \
	ll_backend.date : code_loc_dep.m \
	ll_backend.int0 \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.code_loc_dep.date ll_backend.code_loc_dep.date0 ll_backend.date : \
		code_loc_dep.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.code_loc_dep.date0 \
	ll_backend.date0 : code_loc_dep.m \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.code_loc_dep.date0 ll_backend.date0 : \
		code_loc_dep.m \
	\
		assoc_list.int3 \
		backend_libs.int3 \
...
ll_backend.code_loc_dep.int0 : ll_backend.code_loc_dep.date0
	@:
ll_backend.code_loc_dep.int : ll_backend.code_loc_dep.date
	@:
ll_backend.code_loc_dep.int2 : ll_backend.code_loc_dep.date
	@:
ll_backend.code_loc_dep.int3 : ll_backend.code_loc_dep.date3
	@:
ll_backend.code_loc_dep.opt : ll_backend.code_loc_dep.optdate
	@:
ll_backend.code_loc_dep.trans_opt : ll_backend.code_loc_dep.trans_opt_date
	@:
...
ll_backend.code_loc_dep.date0 : code_loc_dep.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ll_backend.code_loc_dep
ll_backend.code_loc_dep.date : code_loc_dep.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ll_backend.code_loc_dep
ll_backend.code_loc_dep.date3 : code_loc_dep.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ll_backend.code_loc_dep
ll_backend.code_loc_dep.optdate : code_loc_dep.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ll_backend.code_loc_dep
ll_backend.code_loc_dep.trans_opt_date : code_loc_dep.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ll_backend.code_loc_dep
ll_backend.code_loc_dep.c_date : code_loc_dep.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ll_backend.code_loc_dep $(ERR_REDIRECT)
ll_backend.code_loc_dep.java_date : code_loc_dep.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ll_backend.code_loc_dep $(ERR_REDIRECT)
