        ...
        case (MR_Integer) 1:
          {
            ...
            if ((STATE_VARIABLE_Specs_77_77 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...
{
  {
    ...
    hlds__add_foreign_enum__report_if_builtin_type_6_p_0(Context_14, ContextPieces_25, TypeSymName_22, TypeArity_23, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_Specs_82_82);
