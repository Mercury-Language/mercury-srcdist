  ...
  MR_Word * Specs_9)
{
  ...
  if (succeeded)
  {
    ...
    switch (MR_tag((MR_Word) TypeBody_24)) {
      ...
      case (MR_Integer) 1:
        {
          hlds__add_foreign_enum__report_not_du_type_7_p_0(Context_14, ContextPieces_18, TypeSymName_16, TypeArity_17, TypeBody_24, STATE_VARIABLE_Specs_67_67, &STATE_VARIABLE_Specs_70_70);
          *STATE_VARIABLE_ModuleInfo_49 = STATE_VARIABLE_ModuleInfo_0_48;
        }
        break;
      case (MR_Integer) 2:
