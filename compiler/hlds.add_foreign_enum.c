    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            NotThisModuleMsg_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), NotThisModuleMsg_32, 0) = ((MR_Box) (Context_17));
            MR_hl_field(MR_mktag(0), NotThisModuleMsg_32, 1) = ((MR_Box) (Var_98));
          }
          {
