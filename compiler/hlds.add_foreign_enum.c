...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FEEInfo_10, (MR_Integer) 0)));
    MR_Word TypeDefn_22;
        ...
        case (MR_Integer) 1:
          {
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_16, (MR_Integer) 1)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FEInfo_12, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            STATE_VARIABLE_Specs_89_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
