...
static MR_Word MR_CALL 
hlds__add_foreign_enum__IntroducedFrom__func__build_export_enum_overrides_map__545__1_2_f_0(
...
{
  {
    ...
    MR_Word STATE_VARIABLE_ErrorSeveritiesPieces_80_80;
    MR_Word STATE_VARIABLE_Specs_89_89;
    MR_Word STATE_VARIABLE_ErrorSeveritiesPieces_92_92;
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (TypeName_18));
      MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (TypeArity_19));
    }
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__add_foreign_enum_scalar_common_1[9])));
    }
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_foreign_enum_scalar_common_1[75])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_foreign_enum_scalar_common_1[81])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ContextPieces_20, 1) = ((MR_Box) (Var_63));
    }
    STATE_VARIABLE_Specs_79_79 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    hlds__add_foreign_enum__report_if_builtin_type_4_p_0(TypeName_18, TypeArity_19, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &STATE_VARIABLE_ErrorSeveritiesPieces_80_80);
    hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_59, &TypeTable_22);
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) TypeBody_24)) {
        ...
        case (MR_Integer) 0:
          {
            hlds__add_foreign_enum__report_not_enum_type_5_p_0(TypeName_18, TypeArity_19, (MR_Word) MR_mkword(MR_mktag(1), &hlds__add_foreign_enum_scalar_common_4[3]), STATE_VARIABLE_ErrorSeveritiesPieces_80_80, &STATE_VARIABLE_ErrorSeveritiesPieces_92_92);
            *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
            STATE_VARIABLE_Specs_89_89 = STATE_VARIABLE_Specs_79_79;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            MR_Word MaybePrefix_47;
            MR_Word MakeUpperCase_48;
            MR_String Prefix_49;
            MR_Word MaybeOverridesMap_50;
            MR_Word Var_83;
            ...
            Var_83 = mercury__map__keys_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, TagValues_35);
            hlds__add_foreign_enum__find_enum_nonenum_cons_ids_5_p_0(Var_83, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &_EnumSymNames_41, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &NonEnumConsIds_42);
            switch (MR_tag((MR_Word) DuTypeKind_39)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(DuTypeKind_39)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_ErrorSeveritiesPieces_92_92 = STATE_VARIABLE_ErrorSeveritiesPieces_80_80;
                    break;
                  case (MR_Integer) 1:
                    STATE_VARIABLE_ErrorSeveritiesPieces_92_92 = STATE_VARIABLE_ErrorSeveritiesPieces_80_80;
                    break;
                  case (MR_Integer) 2:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (NonEnumConsIds_42));
                      }
                      hlds__add_foreign_enum__report_not_enum_type_5_p_0(TypeName_18, TypeArity_19, Var_86, STATE_VARIABLE_ErrorSeveritiesPieces_80_80, &STATE_VARIABLE_ErrorSeveritiesPieces_92_92);
                    }
                    break;
                }
                break;
            ...
            MaybePrefix_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), Attributes_16, (MR_Integer) 0)));
            MakeUpperCase_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), Attributes_16, (MR_Integer) 1)));
            if ((MaybePrefix_47 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              Prefix_49 = (MR_String) "";
            else
              Prefix_49 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybePrefix_47, (MR_Integer) 0)));
            hlds__add_foreign_enum__build_export_enum_overrides_map_7_p_0(TypeName_18, Context_12, ContextPieces_20, Overrides_17, &MaybeOverridesMap_50, STATE_VARIABLE_Specs_79_79, &STATE_VARIABLE_Specs_88_88);
            if ((MaybeOverridesMap_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
              STATE_VARIABLE_Specs_89_89 = STATE_VARIABLE_Specs_88_88;
            }
            else
            {
              MR_Word OverridesMap_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeOverridesMap_50, (MR_Integer) 0)));
              MR_Word MaybeMapping_52;

              hlds__add_foreign_enum__build_export_enum_name_map_12_p_0(ContextPieces_20, Lang_14, TypeName_18, TypeArity_19, Context_12, Prefix_49, MakeUpperCase_48, OverridesMap_51, Ctors_30, &MaybeMapping_52, STATE_VARIABLE_Specs_88_88, &STATE_VARIABLE_Specs_89_89);
              if ((MaybeMapping_52 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
              else
              {
                MR_Word Mapping_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeMapping_52, (MR_Integer) 0)));
                MR_Word ExportedEnum_54;

                {
                  ExportedEnum_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 0) = ((MR_Box) (Lang_14));
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 1) = ((MR_Box) (Context_12));
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 2) = ((MR_Box) (TypeCtor_15));
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 3) = ((MR_Box) (Mapping_53));
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 4) = ((MR_Box) (Ctors_30));
                  MR_hl_field(MR_mktag(0), ExportedEnum_54, 5) = ((MR_Box) (TagValues_35));
                }
                succeeded = (STATE_VARIABLE_ErrorSeveritiesPieces_92_92 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (succeeded)
                  succeeded = (STATE_VARIABLE_Specs_89_89 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (succeeded)
                {
                  MR_Word ExportedEnums0_55;
                  MR_Word ExportedEnums_56;

                  hlds__hlds_module__module_info_get_exported_enums_2_p_0(STATE_VARIABLE_ModuleInfo_0_59, &ExportedEnums0_55);
                  {
                    ExportedEnums_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ExportedEnums_56, 0) = ((MR_Box) (ExportedEnum_54));
                    MR_hl_field(MR_mktag(1), ExportedEnums_56, 1) = ((MR_Box) (ExportedEnums0_55));
                  }
                  hlds__hlds_module__module_info_set_exported_enums_3_p_0(ExportedEnums_56, STATE_VARIABLE_ModuleInfo_0_59, STATE_VARIABLE_ModuleInfo_60);
                }
                else
                  *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
              }
        ...
        case (MR_Integer) 2:
          {
            hlds__add_foreign_enum__report_not_enum_type_5_p_0(TypeName_18, TypeArity_19, (MR_Word) MR_mkword(MR_mktag(1), &hlds__add_foreign_enum_scalar_common_4[2]), STATE_VARIABLE_ErrorSeveritiesPieces_80_80, &STATE_VARIABLE_ErrorSeveritiesPieces_92_92);
            *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
            STATE_VARIABLE_Specs_89_89 = STATE_VARIABLE_Specs_79_79;
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_24, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                hlds__add_foreign_enum__report_not_enum_type_5_p_0(TypeName_18, TypeArity_19, (MR_Word) MR_mkword(MR_mktag(1), &hlds__add_foreign_enum_scalar_common_4[4]), STATE_VARIABLE_ErrorSeveritiesPieces_80_80, &STATE_VARIABLE_ErrorSeveritiesPieces_92_92);
                *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
                STATE_VARIABLE_Specs_89_89 = STATE_VARIABLE_Specs_79_79;
              }
              break;
            case (MR_Integer) 1:
              {
                hlds__add_foreign_enum__report_not_enum_type_5_p_0(TypeName_18, TypeArity_19, (MR_Word) MR_mkword(MR_mktag(1), &hlds__add_foreign_enum_scalar_common_4[1]), STATE_VARIABLE_ErrorSeveritiesPieces_80_80, &STATE_VARIABLE_ErrorSeveritiesPieces_92_92);
                *STATE_VARIABLE_ModuleInfo_60 = STATE_VARIABLE_ModuleInfo_0_59;
                STATE_VARIABLE_Specs_89_89 = STATE_VARIABLE_Specs_79_79;
              }
              break;
    ...
    if ((STATE_VARIABLE_ErrorSeveritiesPieces_92_92 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      STATE_VARIABLE_Specs_94_94 = STATE_VARIABLE_Specs_89_89;
    else
    {
      MR_Word Var_93;
      MR_Box conv1_STATE_VARIABLE_Specs_94_94;

      {
        Var_93 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&hlds__add_foreign_enum_scalar_common_8[0]));
        MR_hl_field(MR_mktag(0), Var_93, 1) = ((MR_Box) (hlds__add_foreign_enum__add_pragma_foreign_export_enum_5_p_0_1));
        MR_hl_field(MR_mktag(0), Var_93, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_93, 3) = ((MR_Box) (Context_12));
        MR_hl_field(MR_mktag(0), Var_93, 4) = ((MR_Box) (ContextPieces_20));
      }
      mercury__list__foldl_4_p_0((MR_Word) &hlds__add_foreign_enum_scalar_common_2[0], (MR_Word) &hlds__add_foreign_enum_scalar_common_1[1], Var_93, STATE_VARIABLE_ErrorSeveritiesPieces_92_92, ((MR_Box) (STATE_VARIABLE_Specs_89_89)), &conv1_STATE_VARIABLE_Specs_94_94);
      STATE_VARIABLE_Specs_94_94 = ((MR_Word) conv1_STATE_VARIABLE_Specs_94_94);
    }
    *Specs_9 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, STATE_VARIABLE_Specs_94_94, Specs0_8);
  }
}
...
{
  {
    ...
    conv8_LambdaHeadVar__2_105 = hlds__add_foreign_enum__IntroducedFrom__func__build_export_enum_name_map__635__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    conv6_LambdaHeadVar__2_69 = hlds__add_foreign_enum__IntroducedFrom__func__build_export_enum_name_map__616__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_35 = hlds__add_foreign_enum__IntroducedFrom__func__build_export_enum_overrides_map__545__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
