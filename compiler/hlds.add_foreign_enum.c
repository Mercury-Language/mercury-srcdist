...
{
  {
    ...
    *NameMap_18 = ((MR_Word) (conv3_NameMap_18));
    ...
    else
    {
      ...
      BadForeignPiecesList_28 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__add_foreign_enum_scalar_common_1[2]), (MR_Word) (&hlds__add_foreign_enum_scalar_common_2[10]), BadForeignNames_21);
...
{
  {
    ...
    if (((MR_tag((MR_Word) NotEnumInfo_12)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      else
      {
        ...
        Var_29 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_and_arity_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (&hlds__add_foreign_enum_scalar_common_2[9]), OrderedNonEnumSNAs_20);
