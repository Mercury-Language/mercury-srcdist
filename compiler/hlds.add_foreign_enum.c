  ...
  MR_Word * Specs_9)
{
  ...
  if (succeeded)
  {
    ...
    switch (MR_tag((MR_Word) TypeBody_24)) {
      ...
      case (MR_Integer) 1:
        {
          MR_String TypeKindDesc_102;
          MR_Word Var_106;

          switch (MR_tag((MR_Word) TypeBody_24)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              TypeKindDesc_102 = (MR_String) "a foreign type";
              break;
            case (MR_Integer) 2:
              TypeKindDesc_102 = (MR_String) "an equivalence type";
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) ((MR_hl_field(3, TypeBody_24, (MR_Integer) 0))))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  TypeKindDesc_102 = (MR_String) "a solver type";
                  break;
                case (MR_Integer) 1:
                  TypeKindDesc_102 = (MR_String) "an abstract type";
                  break;
              }
              break;
          }
          {
            ...
            MR_hl_field(1, Var_106, 0) = ((MR_Box) (TypeKindDesc_102));
          }
          hlds__add_foreign_enum__report_not_enum_type_7_p_0(Context_14, ContextPieces_18, TypeSymName_16, TypeArity_17, Var_106, STATE_VARIABLE_Specs_67_67, &STATE_VARIABLE_Specs_70_70);
          *STATE_VARIABLE_ModuleInfo_49 = STATE_VARIABLE_ModuleInfo_0_48;
        }
        break;
      case (MR_Integer) 2:
