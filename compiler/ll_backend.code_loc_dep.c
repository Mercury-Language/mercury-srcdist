  ...
  MR_Word * STATE_VARIABLE_CLD_15)
{
  ...
  MR_Word Vars1_25;
  MR_Word Vars_26;
  MR_Word Variables_27;
  MR_Word Var_28;
  MR_Word ForwardLiveVars_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 0))));
  ...
  ResumeVars_33 = ll_backend__code_loc_dep__current_resume_point_vars_1_f_0(STATE_VARIABLE_CLD_0_14);
  ...
  Variables0_19 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_34);
  ...
  ll_backend__code_info__get_var_table_2_p_0(CI_10, &VarTable_22);
  ll_backend__code_info__get_proc_info_2_p_0(CI_10, &ProcInfo_23);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_23, &RttiVarMaps_24);
  hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_vt_5_p_0(VarTable_22, RttiVarMaps_24, TypeInfoLiveness_21, Vars0_20, &Vars1_25);
  parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars1_25, OutArgs_7, &Vars_26);
  Variables_27 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_26);
  {
    Var_28 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (&ll_backend__code_loc_dep_scalar_common_6[1]));
    MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (ll_backend__code_loc_dep__save_variables_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_28, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_28, 3) = ((MR_Box) (CI_10));
  }
  mercury__list__map_3_p_0((MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[0]), (MR_Word) (&ll_backend__code_loc_dep_scalar_common_2[0]), Var_28, Variables_27, &VarLocs_12);
  ...
  VarLocnInfo0_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 3))));
  ll_backend__var_locn__var_locn_place_vars_4_p_0(VarLocs_12, Code_9, VarLocnInfo0_42, &VarLocnInfo_43);
  Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 0))));
  Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 1))));
  Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 2))));
  Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 4))));
  Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 5))));
  Var_56 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 6))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_CLD_36)
{
  ...
  else
  {
    ...
    MR_Word Vars1_57;
    MR_Word Vars_58;
    MR_Word Variables_59;
    MR_Word Var_60;
    MR_Word ForwardLiveVars_64;
    MR_Word ResumeVars_65;
    MR_Word Vars_66;
    ...
    ForwardLiveVars_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_35, (MR_Integer) 0))));
    ResumeVars_65 = ll_backend__code_loc_dep__current_resume_point_vars_1_f_0(STATE_VARIABLE_CLD_0_35);
    parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ForwardLiveVars_64, ResumeVars_65, &Vars_66);
    Variables0_51 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_66);
    ...
    ll_backend__code_info__get_var_table_2_p_0(CI_12, &VarTable_54);
    ll_backend__code_info__get_proc_info_2_p_0(CI_12, &ProcInfo_55);
    hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_55, &RttiVarMaps_56);
    hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_vt_5_p_0(VarTable_54, RttiVarMaps_56, TypeInfoLiveness_53, Vars0_52, &Vars1_57);
    parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars1_57, Var_37, &Vars_58);
    Variables_59 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_58);
    {
      Var_60 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (&ll_backend__code_loc_dep_scalar_common_6[1]));
      MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (ll_backend__code_loc_dep__setup_call_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_60, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_60, 3) = ((MR_Box) (CI_12));
    }
    mercury__list__map_3_p_0((MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[0]), (MR_Word) (&ll_backend__code_loc_dep_scalar_common_2[0]), Var_60, Variables_59, &ForwardVarLocs_24);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word FailInfo_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_35, (MR_Integer) 5))));
          MR_Word ResumePointStack_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FailInfo_74, (MR_Integer) 0))));
          MR_Word ResumePoint_80;
          MR_Word StackMap_81;
          MR_Word VarLocSets_83;
          MR_Box conv1_ResumePoint_80;
          MR_Word MapPrime_93;

          mercury__stack__det_top_2_p_0((MR_Word) (&ll_backend__code_loc_dep__ll_backend__code_loc_dep__type_ctor_info_resume_point_info_0), ResumePointStack_75, &conv1_ResumePoint_80);
          ResumePoint_80 = ((MR_Word) (conv1_ResumePoint_80));
          switch (MR_tag((MR_Word) ResumePoint_80)) {
            default:
              succeeded = MR_FALSE;
              break;
            case (MR_Integer) 1:
              {
                MapPrime_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ResumePoint_80, (MR_Integer) 0))));
                succeeded = MR_TRUE;
              }
              break;
            case (MR_Integer) 2:
              {
                MapPrime_93 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ResumePoint_80, (MR_Integer) 2))));
                succeeded = MR_TRUE;
              }
              break;
            case (MR_Integer) 3:
              {
                MapPrime_93 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ResumePoint_80, (MR_Integer) 0))));
                succeeded = MR_TRUE;
              }
              break;
          }
          if (succeeded)
            StackMap_81 = MapPrime_93;
          else
            {
          ...
          mercury__map__to_assoc_list_2_p_0((MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[0]), (MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[1]), StackMap_81, &VarLocSets_83);
          ll_backend__code_loc_dep__pick_var_places_2_p_0(VarLocSets_83, &ResumeVarLocs_26);
  ...
  MR_Word * STATE_VARIABLE_CLD_37)
{
  ...
  MR_Word UseFloatRegs_20;
  MR_Word FloatRegType_21;
  MR_Word TraceLevel_22;
  MR_Word TraceEnabled_23;
  MR_Word MaybeFailVars_25;
  MR_Word EffLiveness_26;
  MR_Word VarLocnInfo_27;
  MR_Word ResumePoints_28;
  MR_Word OptTuple_29;
  MR_Word AllowHijack_30;
  MR_Word DummyFailInfo_31;
  MR_Word TempsInUse_32;
  MR_Word Zombies_33;
  MR_Word STATE_VARIABLE_CLD_42_42;

  ll_backend__code_info__get_module_info_2_p_0(STATE_VARIABLE_CI_0_35, &ModuleInfo_10);
  ll_backend__code_info__get_pred_info_2_p_0(STATE_VARIABLE_CI_0_35, &PredInfo_11);
  ll_backend__code_info__get_proc_info_2_p_0(STATE_VARIABLE_CI_0_35, &ProcInfo_12);
  ...
  ll_backend__code_info__get_var_table_2_p_0(STATE_VARIABLE_CI_0_35, &VarTable_18);
  hlds__hlds_pred__proc_info_get_stack_slots_2_p_0(ProcInfo_12, &StackSlots_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 301, &UseFloatRegs_20);
  switch (UseFloatRegs_20) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      FloatRegType_21 = (MR_Integer) 0;
      break;
    case (MR_Integer) 1:
      FloatRegType_21 = (MR_Integer) 1;
      break;
  }
  libs__globals__get_trace_level_2_p_0(Globals_13, &TraceLevel_22);
  TraceEnabled_23 = libs__trace_params__is_exec_trace_enabled_at_eff_trace_level_4_f_0(ModuleInfo_10, PredInfo_11, ProcInfo_12, TraceLevel_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        ll_backend__trace_gen__trace_fail_vars_3_p_0(ModuleInfo_10, ProcInfo_12, &FailVars_24);
        {
          MaybeFailVars_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeFailVars_25, 0) = ((MR_Box) (FailVars_24));
        }
        parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Liveness_15, FailVars_24, &EffLiveness_26);
      }
      break;
    case (MR_Integer) 0:
      {
        MaybeFailVars_25 = (MR_Word) ((MR_Unsigned) 0U);
        EffLiveness_26 = Liveness_15;
      }
      break;
  }
  ll_backend__var_locn__init_var_locn_state_7_p_0(VarTable_18, FloatRegType_21, StackSlots_19, FollowVars_6, EffLiveness_26, ArgList_17, &VarLocnInfo_27);
  mercury__stack__init_1_p_0((MR_Word) (&ll_backend__code_loc_dep__ll_backend__code_loc_dep__type_ctor_info_resume_point_info_0), &ResumePoints_28);
  libs__globals__get_opt_tuple_2_p_0(Globals_13, &OptTuple_29);
  AllowHijack_30 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_29, (MR_Integer) 1))) >> 6)) & (MR_Integer) 1);
  {
    DummyFailInfo_31 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), DummyFailInfo_31, 0) = ((MR_Box) (ResumePoints_28));
    MR_hl_field(MR_mktag(0), DummyFailInfo_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), DummyFailInfo_31, 2) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 2)) | (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (MR_Unsigned) (AllowHijack_30)))));
  }
  mercury__set__init_1_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), &TempsInUse_32);
  Zombies_33 = parse_tree__set_of_var__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0));
  {
    STATE_VARIABLE_CLD_42_42 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 0) = ((MR_Box) (Liveness_15));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 1) = ((MR_Box) (InstMap_14));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 2) = ((MR_Box) (Zombies_33));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 3) = ((MR_Box) (VarLocnInfo_27));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 4) = ((MR_Box) (TempsInUse_32));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 5) = ((MR_Box) (DummyFailInfo_31));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_42_42, 6) = ((MR_Box) ((MR_Integer) 0));
  }
  ll_backend__code_loc_dep__init_fail_info_7_p_0(CodeModel_16, MaybeFailVars_25, ResumePoint_7, STATE_VARIABLE_CI_0_35, STATE_VARIABLE_CI_36, STATE_VARIABLE_CLD_42_42, STATE_VARIABLE_CLD_37);
}
