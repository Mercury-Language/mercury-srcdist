...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((ArgX2_6 == (MR_Word) ((MR_Unsigned) 0U)))
          if ((ArgY2_7 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            succeeded = MR_TRUE;
            succeeded = !(succeeded);
            if (succeeded)
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 282, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 300, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 305, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 310, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 272, &UseFloatRegs_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 472, &AllowHijack_30);
