...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__code_loc_dep_scalar_common_3[15]), ParConjDepth_19, &Var_60);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 87, &DebugPredIdInt_7);
...
{
  {
    ...
    ll_backend__var_locn__var_locn_acquire_reg_require_given_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__code_loc_dep_scalar_common_1[47])), VarLocnInfo1_7, &VarLocnInfo_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 304, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 321, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 325, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 330, &EntrySize_28);
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_36, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__code_loc_dep_scalar_common_1[30])));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 295, &UseFloatRegs_21);
    ...
    AllowHijack_31 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_30, (MR_Integer) 1))) >> 7)) & (MR_Integer) 1);
    {
