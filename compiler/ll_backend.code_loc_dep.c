...
static const MR_FA_PseudoTypeInfo_Struct2 ll_backend__code_loc_dep__tree234__pti_tree234_2__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0__plain_hlds__var_table__type_ctor_info_var_table_entry_0;
...
static /* final */ const MR_Box ll_backend__code_loc_dep_scalar_common_4[14][5] = {
  ...
  /* row  10 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&ll_backend__code_loc_dep__tree234__pti_tree234_2__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0__plain_hlds__var_table__type_ctor_info_var_table_entry_0)),
  ...
  MR_Word CI_2)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 93, &DebugPredIdInt_7);
  ...
  MR_Word * STATE_VARIABLE_CLD_15)
{
  ...
  Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 0))));
  Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 1))));
  Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 2))));
  Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 4))));
  Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 5))));
  Var_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_14, (MR_Integer) 6))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word CLD_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 309, &AgcStackLayout_11);
  ...
  MR_Word * STATE_VARIABLE_CLD_51)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 325, &UseMinimalModelStackCopyCut_36);
    {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 329, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 334, &EntrySize_28);
  ...
  MR_Word * STATE_VARIABLE_CLD_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 300, &UseFloatRegs_21);
