  ...
  MR_Word CLD_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 332, &AgcStackLayout_11);
  ...
  MR_Word * STATE_VARIABLE_CLD_50)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 348, &UseMinimalModelStackCopyCut_36);
    {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 352, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 357, &EntrySize_28);
  ...
  MR_Word * STATE_VARIABLE_CLD_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 323, &UseFloatRegs_19);
