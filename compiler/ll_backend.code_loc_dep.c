...
ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3824__1_2_p_0(
  MR_Word IsInPersistentTemps0_14,
  MR_Word HeadVar__2_30);

static MR_bool MR_CALL 
ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3830__1_2_p_0(
  MR_Word IsInPersistentTemps0_14,
...
{
  {
    ...
    succeeded = ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3824__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3830__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
