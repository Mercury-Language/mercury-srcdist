...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 291, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 309, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 314, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 319, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 281, &UseFloatRegs_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 482, &AllowHijack_30);
