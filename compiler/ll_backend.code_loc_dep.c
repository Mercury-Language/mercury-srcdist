...
{
  {
    ...
    ll_backend__code_loc_dep__pick_stack_resume_point_3_p_0(NewResumePoint_26, &Var_29, &StackLabel_30);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_100, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_119, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
