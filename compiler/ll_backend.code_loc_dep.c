...
static MR_bool MR_CALL 
ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3862__1_2_p_0(
  MR_Word IsInPersistentTemps0_14,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__code_loc_dep__IntroducedFrom__pred__release_temp_slot__3862__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
