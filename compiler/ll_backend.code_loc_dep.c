...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 294, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 312, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 317, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 322, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 285, &UseFloatRegs_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 485, &AllowHijack_30);
