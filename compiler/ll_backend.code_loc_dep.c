...
{
  {
    ...
    Var_23 = parse_tree__set_of_var__bitset_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ResumeVars_7);
    mercury__map__select_3_p_0((MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[0]), (MR_Word) (&ll_backend__code_loc_dep_scalar_common_1[1]), FullMap_9, Var_23, &OrigMap_13);
    switch (ResumeLocs_8) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word OrigLabel_67;
          MR_Word OrigAddr_68;
          MR_Word StackMap_69;
          MR_Word StackLabel_70;
          MR_Word StackAddr_71;

          ll_backend__code_loc_dep__make_stack_resume_map_3_p_0(ResumeVars_7, StackSlots_12, &StackMap_69);
          ll_backend__code_info__get_next_label_3_p_0(&OrigLabel_67, STATE_VARIABLE_CI_0_21, &STATE_VARIABLE_CI_34_34);
          {
            OrigAddr_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), OrigAddr_68, 0) = ((MR_Box) (OrigLabel_67));
          }
          ll_backend__code_info__get_next_label_3_p_0(&StackLabel_70, STATE_VARIABLE_CI_34_34, STATE_VARIABLE_CI_22);
          {
            StackAddr_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), StackAddr_71, 0) = ((MR_Box) (StackLabel_70));
          }
          {
            MR_Word base;
            ...
            *ResumePoint_10 = base;
            ...
            MR_hl_field(MR_mktag(2), base, 1) = ((MR_Box) (OrigAddr_68));
            MR_hl_field(MR_mktag(2), base, 2) = ((MR_Box) (StackMap_69));
            MR_hl_field(MR_mktag(2), base, 3) = ((MR_Box) (StackAddr_71));
          }
        }
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word OrigLabel_75;
          MR_Word OrigAddr_76;
          MR_Word StackMap_77;
          MR_Word StackLabel_78;
          MR_Word StackAddr_79;

          ll_backend__code_loc_dep__make_stack_resume_map_3_p_0(ResumeVars_7, StackSlots_12, &StackMap_77);
          ll_backend__code_info__get_next_label_3_p_0(&StackLabel_78, STATE_VARIABLE_CI_0_21, &STATE_VARIABLE_CI_24_24);
          {
            StackAddr_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), StackAddr_79, 0) = ((MR_Box) (StackLabel_78));
          }
          ll_backend__code_info__get_next_label_3_p_0(&OrigLabel_75, STATE_VARIABLE_CI_24_24, STATE_VARIABLE_CI_22);
          {
            OrigAddr_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), OrigAddr_76, 0) = ((MR_Box) (OrigLabel_75));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            *ResumePoint_10 = base;
            MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (StackMap_77));
            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (StackAddr_79));
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (OrigMap_13));
            MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (OrigAddr_76));
          }
        }
        break;
    }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 299, &AgcStackLayout_11);
  ...
  MR_Word STATE_VARIABLE_CLD_0_28)
{
  {
    MR_bool succeeded;
    MR_Word FailInfo_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CLD_0_28, (MR_Integer) 5))));
    ...
    else
    {
      ...
      succeeded = ll_backend__code_loc_dep__pick_matching_resume_addr_3_p_0(STATE_VARIABLE_CLD_0_28, TopResumePoint_15, &FailureAddress0_16);
      if (succeeded)
      {
      ...
      else
      {
        ...
        ll_backend__code_loc_dep__pick_and_place_vars_5_p_0(AssocList_20, &Var_21, &PlaceCode_18, STATE_VARIABLE_CLD_0_28, &_AfterPlaceCLD_22);
      }
      {
        Var_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_34, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        MR_hl_field(MR_mktag(3), Var_34, 1) = ((MR_Box) (FailureAddress_17));
      }
      {
        Var_33 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (Var_34));
        MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) ((MR_String) "fail"));
      }
      BranchCode_23 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_33)));
    ...
    *STATE_VARIABLE_CI_27 = STATE_VARIABLE_CI_0_26;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 317, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 321, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 326, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 290, &UseFloatRegs_21);
