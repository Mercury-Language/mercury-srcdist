...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 273, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 292, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 297, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 302, &EntrySize_28);
