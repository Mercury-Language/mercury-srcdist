                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        else
                        {
                          ...
                          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_12, Var_90, Var_91);
                          succeeded = (SubResult3_12 != (MR_Integer) 0);
                        }
                      }
                      break;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_31, Var_32);
          succeeded = (SubResult1_6 != (MR_Integer) 0);
        }
      }
      if (succeeded)
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_27, Var_28);
            succeeded = (SubResult4_15 != (MR_Integer) 0);
            if (succeeded)
              *HeadVar__1_1 = SubResult4_15;
            else
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 286, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 304, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 309, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 314, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 276, &UseFloatRegs_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 476, &AllowHijack_30);
