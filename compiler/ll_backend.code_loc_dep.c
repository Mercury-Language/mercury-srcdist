...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 280, &AgcStackLayout_11);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 298, &UseMinimalModelStackCopyCut_36);
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 303, &FixedSize_27);
          libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 308, &EntrySize_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 270, &UseFloatRegs_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 470, &AllowHijack_30);
