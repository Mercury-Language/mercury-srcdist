...
static void MR_CALL 
hlds__var_origins__IntroducedFrom__pred__represent_origins_on_all_branches__689__1_3_p_0(
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      else
                      {
                        ...
                        hlds__pred_proc_id____Compare____pred_id_0_0(&SubResult2_38, ArgX2_36, ArgY2_37);
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      else
                      {
                        ...
                        hlds__pred_proc_id____Compare____pred_id_0_0(&SubResult2_49, ArgX2_47, ArgY2_48);
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(ArgX2_27, ArgY2_28);
                  if (succeeded)
                  {
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(ArgX2_35, ArgY2_36);
                  if (succeeded)
                  {
  ...
  MR_Word * ArgNumPieces_14)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_15, ((MR_Box) (PredId_9)), &conv0_PredInfo_16);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__var_origins__IntroducedFrom__pred__represent_origins_on_all_branches__689__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_12);
