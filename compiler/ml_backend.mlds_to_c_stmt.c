  ...
  switch (MR_tag((MR_Word) Type_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word TypeCategory_17 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));

            NeedsForwardingPtrSpace_4 = parse_tree__prog_type__is_introduced_type_info_type_category_1_f_0(TypeCategory_17);
          }
          break;
        case (MR_Integer) 10:
