        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Unsigned Num_87 = (MR_Unsigned) (AllocId_24);
            MR_String Var_95;
            MR_String Var_102;

            mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_c_stmt_scalar_common_1[2]), (MR_Integer) 1, Num_87, &Var_95);
            Var_102 = mercury__string__f_43_43_2_f_0(Var_95, (MR_String) "]");
            MaybeAllocIdStr_25 = mercury__string__f_43_43_2_f_0((MR_String) "&MR_alloc_sites[", Var_102);
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  ProcIdNum_638 = hlds__pred_proc_id__proc_id_to_int_1_f_0(ProcId_628);
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  ProcIdNum_733 = hlds__pred_proc_id__proc_id_to_int_1_f_0(ProcId_723);
  ...
  MR_Word MaybeAllocId_3)
{
  ...
  else
  {
    ...
    Num_5 = (MR_Unsigned) (Var_6);
    mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_c_stmt_scalar_common_1[2]), (MR_Integer) 1, Num_5, &Var_13);
    Var_20 = mercury__string__f_43_43_2_f_0(Var_13, (MR_String) "]");
    MaybeAllocIdStr_4 = mercury__string__f_43_43_2_f_0((MR_String) "&MR_alloc_sites[", Var_20);
  }
