            ...
            case (MR_Integer) 1:
              {
                ...
                Var_1145 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
                ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_1145, Context_1130);
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
                ...
                if (!((Results_524 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_616, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_5));
                      MR_hl_field(MR_mktag(0), Var_616, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_616, 3) = ((MR_Box) (Opts_8));
                    }
                    ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), Stream_9, Var_616, Results_524);
                    mercury__io__write_string_4_p_0(Stream_9, (MR_String) " = ");
                  }
                }
                ...
                if (!((Results_524 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_679, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_7));
                      MR_hl_field(MR_mktag(0), Var_679, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_679, 3) = ((MR_Box) (Opts_8));
                    }
                    ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), Stream_9, Var_679, Results_524);
                    mercury__io__write_string_4_p_0(Stream_9, (MR_String) " = ");
                  }
                }
                ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, FuncRval_522);
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_540, Context_526);
                      ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, BodyIndent_532);
                      mercury__io__write_string_4_p_0(Stream_9, (MR_String) "return;\n");
                    }
                    break;
          ...
          case (MR_Integer) 5:
            {
              ...
              if (!((Results_956 == (MR_Word) ((MR_Unsigned) 0U))))
              {
                ...
                else
                {
                  ...
                  {
                    Var_970 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_970, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_8[1]));
                    MR_hl_field(MR_mktag(0), Var_970, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_10));
                    MR_hl_field(MR_mktag(0), Var_970, 2) = ((MR_Box) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), Var_970, 3) = ((MR_Box) (Opts_8));
                  }
                  ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), Stream_9, Var_970, Results_956);
                }
              }
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ";\n");
            }
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            Var_281 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Size_215, (MR_Integer) 1))));
                            succeeded = ((MR_tag((MR_Word) Var_281)) == (MR_Integer) 2);
                            if (succeeded)
                              SizeInt_216 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_281, (MR_Integer) 0))));
                          }
                          if (succeeded)
                          ...
                          case (MR_Integer) 0:
                            {
                              ...
                              {
                                Var_174 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), Var_174, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_5[0]));
                                MR_hl_field(MR_mktag(0), Var_174, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_2));
                                MR_hl_field(MR_mktag(0), Var_174, 2) = ((MR_Box) ((MR_Integer) 3));
                                MR_hl_field(MR_mktag(0), Var_174, 3) = ((MR_Box) (Opts_8));
                                MR_hl_field(MR_mktag(0), Var_174, 4) = ((MR_Box) (Stream_9));
                                MR_hl_field(MR_mktag(0), Var_174, 5) = ((MR_Box) (Context_108));
                              }
                              mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_174, Components_124, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_43);
                            }
                            break;
                          case (MR_Integer) 1:
                          case (MR_Integer) 2:
