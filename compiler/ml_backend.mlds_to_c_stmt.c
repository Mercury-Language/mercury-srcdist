            ...
            case (MR_Integer) 1:
              {
                ...
                Var_904 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 16)) & (MR_Integer) 1);
                ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_904, Context_896);
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
              ...
              if (succeeded)
              {
                ...
                if (!((Results_448 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  else
                  {
                    ...
                    {
                      Var_524 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_524, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_8[0]));
                      MR_hl_field(MR_mktag(0), Var_524, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_5));
                      MR_hl_field(MR_mktag(0), Var_524, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_524, 3) = ((MR_Box) (Opts_8));
                    }
                    ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), Stream_9, Var_524, Results_448);
                    mercury__io__write_string_4_p_0(Stream_9, (MR_String) " = ");
                  }
                }
              ...
              else
              {
                ...
                if (!((Results_448 == (MR_Word) ((MR_Unsigned) 0U))))
                {
                  ...
                  else
                  {
                    ...
                    {
                      Var_560 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_560, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_8[0]));
                      MR_hl_field(MR_mktag(0), Var_560, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_7));
                      MR_hl_field(MR_mktag(0), Var_560, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_560, 3) = ((MR_Box) (Opts_8));
                    }
                    ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), Stream_9, Var_560, Results_448);
                    mercury__io__write_string_4_p_0(Stream_9, (MR_String) " = ");
                  }
                }
                ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, FuncRval_446);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (!((Results_763 == (MR_Word) ((MR_Unsigned) 0U))))
              {
                ...
                else
                {
                  ...
                  {
                    Var_768 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_768, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_8[1]));
                    MR_hl_field(MR_mktag(0), Var_768, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_10));
                    MR_hl_field(MR_mktag(0), Var_768, 2) = ((MR_Box) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), Var_768, 3) = ((MR_Box) (Opts_8));
                  }
                  ml_backend__mlds_to_c_type__mlds_output_return_list_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), Stream_9, Var_768, Results_763);
                }
              }
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ";\n");
            }
          ...
          case (MR_Integer) 6:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = mercury__term____Unify____context_0_0(Context_851, Var_890);
                if (succeeded)
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            Var_237 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Size_172, (MR_Integer) 1))));
                            succeeded = ((MR_tag((MR_Word) Var_237)) == (MR_Integer) 2);
                            if (succeeded)
                              SizeInt_173 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_237, (MR_Integer) 0))));
                          }
                          if (succeeded)
                          ...
                          case (MR_Integer) 0:
                            {
...

                              {
                                ...
                                MR_hl_field(MR_mktag(0), Var_111, 0) = ((MR_Box) (&ml_backend__mlds_to_c_stmt_scalar_common_5[0]));
                                MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (ml_backend__mlds_to_c_stmt__mlds_output_statement_7_p_0_2));
                                MR_hl_field(MR_mktag(0), Var_111, 2) = ((MR_Box) ((MR_Integer) 3));
                                MR_hl_field(MR_mktag(0), Var_111, 3) = ((MR_Box) (Opts_8));
                                MR_hl_field(MR_mktag(0), Var_111, 4) = ((MR_Box) (Stream_9));
                                MR_hl_field(MR_mktag(0), Var_111, 5) = ((MR_Box) (Context_100));
                              }
                              mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_111, Components_106, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_43);
                            }
                            break;
                          case (MR_Integer) 1:
                          case (MR_Integer) 2:
