          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                ...
                MR_Word TypeInfo__17_519;

                succeeded = (Results_449 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  TypeInfo__17_519 = (MR_Word) (&ml_backend__mlds_to_c_stmt_scalar_common_2[1]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__17_519, ((MR_Box) (CalleeRetTypes_514)), ((MR_Box) (CallerRetTypes_516)));
                }
                if (succeeded)
