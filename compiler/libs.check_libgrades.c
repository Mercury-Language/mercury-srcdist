  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 729, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 728, &MaybeChosenStdLibDir_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 607, &MercuryLibDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 615, &InitFileDirs_13);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 611, &NamedLibs_14);
        {
  ...
  MR_Word * MaybeStdLibGrades_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 78, &Verbose_9);
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 728, &MaybeChosenStdLibDir_11);
