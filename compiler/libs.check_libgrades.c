  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 728, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 727, &MaybeChosenStdLibDir_11);
  ...
  MR_Word * MaybeStdLibGrades_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 77, &Verbose_9);
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 727, &MaybeChosenStdLibDir_11);
  ...
  {
    MR_String ChosenStdLibDir_39 = ((MR_String) ((MR_hl_field(1, MaybeChosenStdLibDir_11, (MR_Integer) 0))));
    MR_Word CanRead_41;
    ...
    if ((CanRead_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        MR_Word Grades0_68 = ((MR_Word) ((MR_hl_field(0, MaybeGrades0_67, (MR_Integer) 0))));
        ...
        if (((MR_tag((MR_Word) MaybeGrades_70)) == (MR_Integer) 1))
          ...
          StdLibGrades_14 = ((MR_Word) ((MR_hl_field(0, MaybeGrades_70, (MR_Integer) 0))));
      }
      {
        MR_Word base;
    ...
    {
      MR_Word ReadError_42 = ((MR_Word) ((MR_hl_field(1, CanRead_41, (MR_Integer) 0))));
      ...
      *MaybeStdLibGrades_6 = (MR_Word) (MaybeMerStdLibDir_79);
    }
  }
}
