    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 786, &MaybeChosenStdLibDir_11);
  ...
  MR_Word * MaybeStdLibGrades_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_7, (MR_Integer) 786, &MaybeChosenStdLibDir_12);
