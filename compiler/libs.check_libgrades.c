  ...
  MR_Word * MaybeStdLibGrades_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 81, &Verbose_10);
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_7, (MR_Integer) 734, &MaybeChosenStdLibDir_12);
