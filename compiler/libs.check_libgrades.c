    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 590, &SearchDirs_15);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 582, &MercuryLibDirs_16);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 582, &MercuryLibDirs_85);
  ...
  MR_Word * STATE_VARIABLE_Specs_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 687, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 586, &Libs_9);
        libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &GradeDirName_10);
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 588, &MaybeStdLibDir_28);
  ...
  MR_Word * StdlibGradeOpts_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 673, &Detect_12);
  switch (Detect_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeMerStdLibDir_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 588, &MaybeStdLibDir_10);
  ...
  if (succeeded)
  {
    MerStdLibDir_11 = ((MR_String) ((MR_hl_field(1, MaybeStdLibDir_10, (MR_Integer) 0))));
    {
      ...
      mercury__io__file__check_file_accessibility_5_p_0(MerStdLibDir_11, (MR_Word) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[33])), &CanRead_94);
      ...
      {
        MR_Word ReadError_95 = ((MR_Word) ((MR_hl_field(1, CanRead_94, (MR_Integer) 0))));
        ...
        mercury__io__error_message_2_p_0(ReadError_95, &ReadErrorMsg_96);
        {
          ...
          MR_hl_field(2, Var_105, 0) = ((MR_Box) (MerStdLibDir_11));
        }
        {
          ...
          MR_hl_field(3, Var_112, 1) = ((MR_Box) (ReadErrorMsg_96));
        }
        {
          Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_111, 0) = ((MR_Box) (Var_112));
          MR_hl_field(1, Var_111, 1) = ((MR_Box) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[37])));
        }
        {
          Var_109 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_109, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(1, Var_109, 1) = ((MR_Box) (Var_111));
        }
        {
          Var_106 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_106, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[35])));
        ...
        }
        {
          ...
          MR_hl_field(1, Pieces_97, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[34])));
          MR_hl_field(1, Pieces_97, 1) = ((MR_Box) (Var_104));
        }
        {
          Spec_98 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Spec_98, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
          MR_hl_field(2, Spec_98, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_98, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_98, 3) = ((MR_Box) (Pieces_97));
        }
        {
          Var_117 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_117, 0) = ((MR_Box) (Spec_98));
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_92 = ((MR_Word) ((MR_hl_field(1, MerStdLibDirs_13, (MR_Integer) 1))));
        MR_String Var_93 = ((MR_String) ((MR_hl_field(1, MerStdLibDirs_13, (MR_Integer) 0))));

        if ((Var_92 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word CanRead_119;

          mercury__io__file__check_file_accessibility_5_p_0(Var_93, (MR_Word) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[33])), &CanRead_119);
          ...
          {
            MR_Word ReadError_120 = ((MR_Word) ((MR_hl_field(1, CanRead_119, (MR_Integer) 0))));
            ...
            mercury__io__error_message_2_p_0(ReadError_120, &ReadErrorMsg_121);
            {
              ...
              MR_hl_field(2, Var_130, 0) = ((MR_Box) (Var_93));
            }
            {
              ...
              MR_hl_field(3, Var_137, 1) = ((MR_Box) (ReadErrorMsg_121));
            }
            {
              Var_136 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_136, 0) = ((MR_Box) (Var_137));
              MR_hl_field(1, Var_136, 1) = ((MR_Box) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[37])));
            }
            {
              Var_134 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_134, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(1, Var_134, 1) = ((MR_Box) (Var_136));
            }
            {
              Var_131 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_131, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[35])));
            ...
            {
              Pieces_122 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Pieces_122, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[34])));
              MR_hl_field(1, Pieces_122, 1) = ((MR_Box) (Var_129));
            }
            {
              Spec_123 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(2, Spec_123, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
              MR_hl_field(2, Spec_123, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(2, Spec_123, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(2, Spec_123, 3) = ((MR_Box) (Pieces_122));
            }
            {
              Var_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_142, 0) = ((MR_Box) (Spec_123));
