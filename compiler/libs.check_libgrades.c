  ...
  MR_Word * StdlibGradeOpts_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 676, &Detect_12);
  switch (Detect_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeMerStdLibDir_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 591, &MaybeStdLibDir_10);
