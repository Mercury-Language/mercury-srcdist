      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 576, &MercuryLibDirs_65);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 582, &MaybeStdLibDir_33);
