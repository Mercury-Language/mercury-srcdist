  ...
  MR_Word * STATE_VARIABLE_Specs_24)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        SearchAuthDirs_14 = parse_tree__find_module__get_search_auth_init_file_dirs_1_f_0(OptionTable_12);
      }
      break;
    case (MR_Integer) 1:
      {
        TestFileName_13 = mercury__string__f_43_43_2_f_0(LibName_8, (MR_String) ".dll");
        SearchAuthDirs_14 = parse_tree__find_module__get_search_auth_mercury_library_dirs_1_f_0(Globals_7);
      }
      break;
    case (MR_Integer) 2:
      {
  ...
  parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDirs_14, TestFileName_13, &_SearchDirs_15, &MaybeDirName_16);
