      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 595, &SearchDirs_15);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 587, &MercuryLibDirs_16);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 587, &MercuryLibDirs_65);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 692, &LibgradeCheck_8);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 591, &Libs_9);
          libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &GradeDirName_10);
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 593, &MaybeStdLibDir_33);
