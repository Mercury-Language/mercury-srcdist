...
libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__394__2_2_f_0(
  MR_String GradeDirNameDir_86,
  MR_String LambdaHeadVar__1_74);

static MR_String MR_CALL 
libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__394__1_2_f_0(
  MR_String GradeDirNameDir_17,
  MR_String LambdaHeadVar__1_33);

static MR_Word MR_CALL 
libs__check_libgrades__IntroducedFrom__func__maybe_detect_stdlib_grades__121__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_75 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__394__2_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_34 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__394__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__compute_grade__grade_directory_component_2_p_0(Globals_8, &GradeDirNameDir_17);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&libs__check_libgrades_scalar_common_8[0]));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 582, &MaybeStdLibDir_31);
        ...
        else
        {
          ...
          MR_Word StdLibCheckFileResult_35;
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_51 = mercury__dir__f_slash_2_f_0(StdLibDir_32, (MR_String) "modules");
                Var_50 = mercury__dir__f_slash_2_f_0(Var_51, GradeDirName_10);
                StdLibCheckFile_34 = mercury__dir__f_slash_2_f_0(Var_50, (MR_String) "mer_std.init");
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                Var_43 = mercury__dir__f_slash_2_f_0(StdLibDir_32, (MR_String) "lib");
                Var_42 = mercury__dir__f_slash_2_f_0(Var_43, GradeDirName_10);
                StdLibCheckFile_34 = mercury__dir__f_slash_2_f_0(Var_42, (MR_String) "mer_std.dll");
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                Var_47 = mercury__dir__f_slash_2_f_0(StdLibDir_32, (MR_String) "lib");
                Var_46 = mercury__dir__f_slash_2_f_0(Var_47, GradeDirName_10);
                StdLibCheckFile_34 = mercury__dir__f_slash_2_f_0(Var_46, (MR_String) "mer_std.jar");
              }
              break;
          }
          mercury__io__open_input_4_p_0(StdLibCheckFile_34, &StdLibCheckFileResult_35);
          if (((MR_tag((MR_Word) StdLibCheckFileResult_35)) == (MR_Integer) 1))
          {
            ...
            mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_38);
            {
              ...
              MR_hl_field(MR_mktag(2), Var_56, 0) = ((MR_Box) (ProgName_38));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) (GradeDirName_10));
            }
            {
              Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (Var_70));
              MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
            }
            {
              Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[40])));
              MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Var_69));
            }
            {
              Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[39])));
              MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (Var_66));
            }
            {
              Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[38])));
              MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (Var_63));
            }
            {
              Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
              MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (Var_60));
            }
            {
              Pieces_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Pieces_39, 0) = ((MR_Box) (Var_56));
              MR_hl_field(MR_mktag(1), Pieces_39, 1) = ((MR_Box) (Var_57));
            }
            {
              Spec_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Spec_40, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.check_stdlib_is_installed\'/6"));
              MR_hl_field(MR_mktag(2), Spec_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), Spec_40, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(2), Spec_40, 3) = ((MR_Box) (Pieces_39));
            }
            {
              STATE_VARIABLE_Specs_18_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_18_18, 0) = ((MR_Box) (Spec_40));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_18_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          else
          {
            MR_Word StdLibCheckFileStream_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StdLibCheckFileResult_35, (MR_Integer) 0))));

            mercury__io__close_input_3_p_0(StdLibCheckFileStream_36);
            STATE_VARIABLE_Specs_18_18 = (MR_Word) ((MR_Unsigned) 0U);
          }
        }
        {
          Var_20 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&libs__check_libgrades_scalar_common_7[0]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_39 = libs__check_libgrades__IntroducedFrom__func__maybe_detect_stdlib_grades__121__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * MaybeMerStdLibDir_8)
{
  ...
  if (succeeded)
  {
    MerStdLibDir_11 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeStdLibDir_10, (MR_Integer) 0))));
    {
      ...
      mercury__io__file__check_file_accessibility_5_p_0(MerStdLibDir_11, (MR_Word) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[33])), &CanRead_98);
      if ((CanRead_98 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        MR_Word ReadError_99 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CanRead_98, (MR_Integer) 0))));
        MR_String ReadErrorMsg_100;
        MR_Word Pieces_101;
        MR_Word Spec_102;
        MR_Word Var_108;
        MR_Word Var_109;
        ...
        mercury__io__error_message_2_p_0(ReadError_99, &ReadErrorMsg_100);
        {
          Var_109 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_109, 0) = ((MR_Box) (MerStdLibDir_11));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_116, 1) = ((MR_Box) (ReadErrorMsg_100));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_115, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_110, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_101, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[34])));
          MR_hl_field(MR_mktag(1), Pieces_101, 1) = ((MR_Box) (Var_108));
        }
        {
          Spec_102 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Spec_102, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
          MR_hl_field(MR_mktag(2), Spec_102, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(2), Spec_102, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(2), Spec_102, 3) = ((MR_Box) (Pieces_101));
        }
        {
          Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (Spec_102));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_96 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          mercury__io__file__check_file_accessibility_5_p_0(Var_97, (MR_Word) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[33])), &CanRead_123);
          if ((CanRead_123 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *MaybeMerStdLibDir_8 = base;
          ...
          {
            MR_Word ReadError_124 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CanRead_123, (MR_Integer) 0))));
            MR_String ReadErrorMsg_125;
            MR_Word Pieces_126;
            MR_Word Spec_127;
            MR_Word Var_133;
            MR_Word Var_134;
            ...
            mercury__io__error_message_2_p_0(ReadError_124, &ReadErrorMsg_125);
            {
              Var_134 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Var_134, 0) = ((MR_Box) (Var_97));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_141, 1) = ((MR_Box) (ReadErrorMsg_125));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_140, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
            }
            {
              Var_138 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_138, 0) = ((MR_Box) ((MR_Unsigned) 4U));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_135, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_126, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[34])));
              MR_hl_field(MR_mktag(1), Pieces_126, 1) = ((MR_Box) (Var_133));
            }
            {
              Spec_127 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Spec_127, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
              MR_hl_field(MR_mktag(2), Spec_127, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), Spec_127, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), Spec_127, 3) = ((MR_Box) (Pieces_126));
            }
            {
              Var_146 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_146, 0) = ((MR_Box) (Spec_127));
