    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 587, &MercuryLibDirs_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 595, &InitFileDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 591, &Libs_13);
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 593, &MaybeStdLibDir_14);
{
