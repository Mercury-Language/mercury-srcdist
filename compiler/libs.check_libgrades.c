...
{
  {
    ...
    conv1_LambdaHeadVar__2_55 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__143__2_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_33 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__143__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 581, &SearchDirs_15);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 573, &MercuryLibDirs_16);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 573, &MercuryLibDirs_65);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 678, &LibgradeCheck_8);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 577, &Libs_9);
          libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &GradeDirName_10);
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 579, &MaybeStdLibDir_33);
