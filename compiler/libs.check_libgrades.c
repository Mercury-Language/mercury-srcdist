...
static const MR_FA_TypeInfo_Struct1 libs__check_libgrades__list__ti_list_1parse_tree__error_spec__type_ctor_info_err_spec_0;
...
static const MR_PseudoTypeInfo libs__check_libgrades__libs__check_libgrades__field_types_check_libraries_maybe_done_0_1[2] = {
  ...
  (MR_PseudoTypeInfo) (&libs__check_libgrades__list__ti_list_1parse_tree__error_spec__type_ctor_info_err_spec_0)
};
  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 581, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 789, &MaybeChosenStdLibDir_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 512, &MercuryLibDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 530, &InitFileDirs_13);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 516, &NamedLibs_14);
        {
  ...
  MR_Word * Specs_6)
{
  ...
  if ((MaybeChosenStdLibDir_8 == (MR_Word) ((MR_Unsigned) 0U)))
    MaybeMerStdLibDir_9 = (MR_Word) (&libs__check_libgrades_scalar_common_2[0]);
  else
  {
    MR_String ChosenStdLibDir_79 = ((MR_String) ((MR_hl_field(1, MaybeChosenStdLibDir_8, 0))));
    MR_Word MaybeMerStdLibDirOoM_80;
    MR_Word CanRead_83;

    mercury__io__file__check_file_accessibility_5_p_0(ChosenStdLibDir_79, (MR_Word) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[4])), &CanRead_83);
    if ((CanRead_83 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MaybeMerStdLibDirOoM_80 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeMerStdLibDirOoM_80, 0) = ((MR_Box) (ChosenStdLibDir_79));
      }
    else
    {
      MR_Word ReadError_84 = ((MR_Word) ((MR_hl_field(1, CanRead_83, 0))));
      MR_String ReadErrorMsg_85;
      MR_Word Pieces_86;
      MR_Word Spec_87;
      MR_Word Var_93;
      MR_Word Var_94;
      ...
      mercury__io__error_message_2_p_0(ReadError_84, &ReadErrorMsg_85);
      {
        Var_94 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, Var_94, 0) = ((MR_Box) (ChosenStdLibDir_79));
      }
      {
        ...
        MR_hl_field(3, Var_101, 1) = ((MR_Box) (ReadErrorMsg_85));
      }
      {
        Var_100 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_100, 0) = ((MR_Box) (Var_101));
        MR_hl_field(1, Var_100, 1) = ((MR_Box) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[9])));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_95, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[6])));
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_86, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[5])));
        MR_hl_field(1, Pieces_86, 1) = ((MR_Box) (Var_93));
      }
      {
        Spec_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Spec_87, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
        MR_hl_field(1, Spec_87, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, Spec_87, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, Spec_87, 3) = ((MR_Box) (Pieces_86));
      }
      {
        Var_106 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_106, 0) = ((MR_Box) (Spec_87));
        MR_hl_field(0, Var_106, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        MaybeMerStdLibDirOoM_80 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MaybeMerStdLibDirOoM_80, 0) = ((MR_Box) (Var_106));
      }
    }
    parse_tree__maybe_error__maybe1_to_maybe1el_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeMerStdLibDirOoM_80, &MaybeMerStdLibDir_9);
  }
  if (((MR_tag((MR_Word) MaybeMerStdLibDir_9)) == (MR_Integer) 0))
    *Specs_6 = ((MR_Word) ((MR_hl_field(0, MaybeMerStdLibDir_9, 0))));
  else
  {
    MR_String StdLibDir_10 = ((MR_String) ((MR_hl_field(1, MaybeMerStdLibDir_9, 0))));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_24 = mercury__dir__f_slash_2_f_0(StdLibDir_10, (MR_String) "modules");
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_32 = mercury__dir__f_slash_2_f_0(StdLibDir_10, (MR_String) "lib");
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_28 = mercury__dir__f_slash_2_f_0(StdLibDir_10, (MR_String) "lib");
  ...
  MR_Word * MaybeStdLibGrades_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_7, (MR_Integer) 789, &MaybeChosenStdLibDir_12);
  if ((MaybeChosenStdLibDir_12 == (MR_Word) ((MR_Unsigned) 0U)))
    MaybeMerStdLibDir_13 = (MR_Word) (&libs__check_libgrades_scalar_common_2[0]);
  else
  {
    MR_String ChosenStdLibDir_39 = ((MR_String) ((MR_hl_field(1, MaybeChosenStdLibDir_12, 0))));
    MR_Word MaybeMerStdLibDirOoM_40;
    MR_Word CanRead_43;

    mercury__io__file__check_file_accessibility_5_p_0(ChosenStdLibDir_39, (MR_Word) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[4])), &CanRead_43);
    if ((CanRead_43 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MaybeMerStdLibDirOoM_40 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeMerStdLibDirOoM_40, 0) = ((MR_Box) (ChosenStdLibDir_39));
      }
    else
    {
      MR_Word ReadError_44 = ((MR_Word) ((MR_hl_field(1, CanRead_43, 0))));
      MR_String ReadErrorMsg_45;
      MR_Word Pieces_46;
      MR_Word Spec_47;
      MR_Word Var_53;
      MR_Word Var_54;
      ...
      mercury__io__error_message_2_p_0(ReadError_44, &ReadErrorMsg_45);
      {
        Var_54 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(2, Var_54, 0) = ((MR_Box) (ChosenStdLibDir_39));
      }
      {
        Var_61 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, Var_61, 0) = ((MR_Box) ((MR_Unsigned) 9U));
        MR_hl_field(3, Var_61, 1) = ((MR_Box) (ReadErrorMsg_45));
      }
      {
        Var_60 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_60, 0) = ((MR_Box) (Var_61));
        MR_hl_field(1, Var_60, 1) = ((MR_Box) (MR_mkword(1, &libs__check_libgrades_scalar_common_1[9])));
      }
      {
        Var_58 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_58, 0) = ((MR_Box) ((MR_Unsigned) 12U));
        MR_hl_field(1, Var_58, 1) = ((MR_Box) (Var_60));
      }
      {
        Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_55, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[6])));
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_46, 0) = ((MR_Box) (MR_mkword(3, &libs__check_libgrades_scalar_common_1[5])));
        MR_hl_field(1, Pieces_46, 1) = ((MR_Box) (Var_53));
      }
      {
        Spec_47 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Spec_47, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
        MR_hl_field(1, Spec_47, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, Spec_47, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, Spec_47, 3) = ((MR_Box) (Pieces_46));
      }
      {
        Var_66 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_66, 0) = ((MR_Box) (Spec_47));
        MR_hl_field(0, Var_66, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        MaybeMerStdLibDirOoM_40 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, MaybeMerStdLibDirOoM_40, 0) = ((MR_Box) (Var_66));
      }
    }
    parse_tree__maybe_error__maybe1_to_maybe1el_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MaybeMerStdLibDirOoM_40, &MaybeMerStdLibDir_13);
  }
  if (((MR_tag((MR_Word) MaybeMerStdLibDir_13)) == (MR_Integer) 0))
    *MaybeStdLibGrades_8 = (MR_Word) (MaybeMerStdLibDir_13);
  else
  {
    MR_String MerStdLibDir_14 = ((MR_String) ((MR_hl_field(1, MaybeMerStdLibDir_13, 0))));
    MR_Word StdLibGrades_15;
    MR_String ModulesDir_68;
    MR_Word MaybeGrades0_69;
    MR_Word Var_75;

    ModulesDir_68 = mercury__dir__f_slash_2_f_0(MerStdLibDir_14, (MR_String) "modules");
    Var_75 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
    mercury__dir__foldl2_6_p_0((MR_Word) (&libs__check_libgrades_scalar_common_1[0]), (MR_Word) (&libs__check_libgrades_scalar_common_4[0]), ModulesDir_68, ((MR_Box) (Var_75)), &MaybeGrades0_69);
    if (((MR_tag((MR_Word) MaybeGrades0_69)) == (MR_Integer) 1))
      mercury__set__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &StdLibGrades_15);
    else
    {
      MR_Word Grades0_70 = ((MR_Word) ((MR_hl_field(0, MaybeGrades0_69, 0))));
      MR_String LibsDir_71;
      MR_Word MaybeGrades_72;

      LibsDir_71 = mercury__dir__f_slash_2_f_0(MerStdLibDir_14, (MR_String) "lib");
      mercury__dir__foldl2_6_p_0((MR_Word) (&libs__check_libgrades_scalar_common_1[0]), (MR_Word) (&libs__check_libgrades_scalar_common_4[1]), LibsDir_71, ((MR_Box) (Grades0_70)), &MaybeGrades_72);
      if (((MR_tag((MR_Word) MaybeGrades_72)) == (MR_Integer) 1))
        mercury__set__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &StdLibGrades_15);
      else
        StdLibGrades_15 = ((MR_Word) ((MR_hl_field(0, MaybeGrades_72, 0))));
    }
    {
      MR_Word base;
