...
static void MR_CALL 
libs__check_libgrades__can_you_read_dir_4_p_0(
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 588, &SearchDirs_15);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 580, &MercuryLibDirs_16);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 580, &MercuryLibDirs_85);
  ...
  MR_Word * STATE_VARIABLE_Specs_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 685, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Var_19;
        MR_Word MaybeStdLibDir_36;
        MR_Box conv2_STATE_VARIABLE_Specs_11;
        MR_Box conv1_STATE_VARIABLE_IO_13;

        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 584, &Libs_9);
        libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &GradeDirName_10);
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 586, &MaybeStdLibDir_36);
        if ((MaybeStdLibDir_36 == (MR_Word) ((MR_Unsigned) 0U)))
          STATE_VARIABLE_Specs_17_17 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_String StdLibDir_37 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeStdLibDir_36, (MR_Integer) 0))));
          MR_Word Target_38;
          MR_String StdLibCheckFile_39;
          MR_Word StdLibCheckFileResult_40;

          libs__globals__get_target_2_p_0(Globals_5, &Target_38);
          switch (Target_38) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ...
                Var_48 = mercury__dir__f_slash_2_f_0(StdLibDir_37, (MR_String) "modules");
                Var_47 = mercury__dir__f_slash_2_f_0(Var_48, GradeDirName_10);
                StdLibCheckFile_39 = mercury__dir__f_slash_2_f_0(Var_47, (MR_String) "mer_std.init");
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                Var_56 = mercury__dir__f_slash_2_f_0(StdLibDir_37, (MR_String) "lib");
                Var_55 = mercury__dir__f_slash_2_f_0(Var_56, GradeDirName_10);
                StdLibCheckFile_39 = mercury__dir__f_slash_2_f_0(Var_55, (MR_String) "mer_std.dll");
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                Var_52 = mercury__dir__f_slash_2_f_0(StdLibDir_37, (MR_String) "lib");
                Var_51 = mercury__dir__f_slash_2_f_0(Var_52, GradeDirName_10);
                StdLibCheckFile_39 = mercury__dir__f_slash_2_f_0(Var_51, (MR_String) "mer_std.jar");
              }
              break;
          }
          mercury__io__open_input_4_p_0(StdLibCheckFile_39, &StdLibCheckFileResult_40);
          if (((MR_tag((MR_Word) StdLibCheckFileResult_40)) == (MR_Integer) 1))
          {
            ...
            mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_43);
            {
              Var_63 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Var_63, 0) = ((MR_Box) (ProgName_43));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (GradeDirName_10));
            }
            {
              Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (Var_77));
              MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
            }
            {
              Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[40])));
              MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_76));
            }
            {
              Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[39])));
              MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_73));
            }
            {
              Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[38])));
              MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (Var_70));
            }
            {
              Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_44, 0) = ((MR_Box) (Var_63));
              MR_hl_field(MR_mktag(1), Pieces_44, 1) = ((MR_Box) (Var_64));
            }
            {
              Spec_45 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Spec_45, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.check_stdlib_is_installed\'/6"));
              MR_hl_field(MR_mktag(2), Spec_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(2), Spec_45, 2) = ((MR_Box) ((MR_Unsigned) 4U));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_17_17, 0) = ((MR_Box) (Spec_45));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_17_17, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          else
          {
            MR_Word StdLibCheckFileStream_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StdLibCheckFileResult_40, (MR_Integer) 0))));

            mercury__io__close_input_3_p_0(StdLibCheckFileStream_41);
            STATE_VARIABLE_Specs_17_17 = (MR_Word) ((MR_Unsigned) 0U);
          }
        }
        {
  ...
  MR_Word * StdlibGradeOpts_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 671, &Detect_12);
  switch (Detect_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeMerStdLibDir_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 586, &MaybeStdLibDir_10);
  ...
  if (succeeded)
  {
    ...
    libs__check_libgrades__can_you_read_dir_4_p_0(MerStdLibDir_11, MaybeMerStdLibDir_8);
  }
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_92 == (MR_Word) ((MR_Unsigned) 0U)))
          libs__check_libgrades__can_you_read_dir_4_p_0(Var_93, MaybeMerStdLibDir_8);
        else
  ...
  MR_Word * MaybeMerStdLibDir_6)
{
  ...
  mercury__io__file__check_file_accessibility_5_p_0(MerStdLibDir_5, (MR_Word) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[33])), &CanRead_8);
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_11, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[34])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Spec_12, 0) = ((MR_Box) ((MR_String) "predicate \140libs.check_libgrades.can_you_read_dir\'/4"));
