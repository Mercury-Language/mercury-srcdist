  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 727, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 726, &MaybeChosenStdLibDir_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 606, &MercuryLibDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 614, &InitFileDirs_13);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 610, &NamedLibs_14);
        {
  ...
  MR_Word * MaybeStdlibGrades_6)
{
  ...
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_5, ((MR_Box) ((MR_Integer) 77)), &Verbose_9);
  mercury__getopt__lookup_maybe_string_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_5, ((MR_Box) ((MR_Integer) 726)), &MaybeChosenStdLibDir_11);
  ...
  else
  {
    ...
    if ((CanRead_42 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mercury__dir__foldl2_6_p_0((MR_Word) (&libs__check_libgrades_scalar_common_1[0]), (MR_Word) (&libs__check_libgrades_scalar_common_4[0]), ModulesDir_67, ((MR_Box) (Var_74)), &MaybeGrades0_68);
      ...
      else
      {
        ...
        mercury__dir__foldl2_6_p_0((MR_Word) (&libs__check_libgrades_scalar_common_1[0]), (MR_Word) (&libs__check_libgrades_scalar_common_4[1]), LibsDir_70, ((MR_Box) (Grades0_69)), &MaybeGrades_71);
...
{
	libs__check_libgrades__user_init_pred_35_0();
}
