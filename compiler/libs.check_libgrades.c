  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 555, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 761, &MaybeChosenStdLibDir_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 486, &MercuryLibDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 504, &InitFileDirs_13);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 490, &NamedLibs_14);
        {
  ...
  MR_Word * MaybeStdLibGrades_8)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_7, (MR_Integer) 761, &MaybeChosenStdLibDir_12);
