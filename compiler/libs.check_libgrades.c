  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 704, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 597, &MercuryLibDirs_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 605, &InitFileDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 601, &Libs_13);
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 603, &MaybeStdLibDir_14);
{
  ...
  MR_Word * StdlibGradeOpts_10)
{
  ...
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_7, ((MR_Box) ((MR_Integer) 689)), &Detect_12);
  switch (Detect_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeMerStdLibDir_8)
{
  ...
  mercury__getopt__lookup_maybe_string_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_6, ((MR_Box) ((MR_Integer) 603)), &MaybeStdLibDir_10);
