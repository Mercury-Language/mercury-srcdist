  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_36 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__394__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 582, &MaybeStdLibDir_28);
