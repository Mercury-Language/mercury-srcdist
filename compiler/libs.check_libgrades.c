  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 731, &LibgradeCheck_8);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 730, &MaybeChosenStdLibDir_11);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 609, &MercuryLibDirs_12);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 617, &InitFileDirs_13);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 613, &NamedLibs_14);
        {
  ...
  MR_Word * MaybeStdLibGrades_6)
{
  ...
  {
    MR_String ChosenStdLibDir_39 = ((MR_String) ((MR_hl_field(1, MaybeChosenStdLibDir_11, 0))));
    MR_Word CanRead_41;
    ...
    if ((CanRead_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeGrades_70)) == (MR_Integer) 1))
          ...
          StdLibGrades_14 = ((MR_Word) ((MR_hl_field(0, MaybeGrades_70, 0))));
      }
      {
        MR_Word base;
