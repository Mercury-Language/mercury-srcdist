    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 584, &MaybeStdLibDir_39);
        ...
        else
        {
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_51 = mercury__dir__f_slash_2_f_0(StdLibDir_40, (MR_String) "modules");
                Var_50 = mercury__dir__f_slash_2_f_0(Var_51, GradeDirName_10);
                StdLibCheckFile_42 = mercury__dir__f_slash_2_f_0(Var_50, (MR_String) "mer_std.init");
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                Var_59 = mercury__dir__f_slash_2_f_0(StdLibDir_40, (MR_String) "lib");
                Var_58 = mercury__dir__f_slash_2_f_0(Var_59, GradeDirName_10);
                StdLibCheckFile_42 = mercury__dir__f_slash_2_f_0(Var_58, (MR_String) "mer_std.dll");
              }
              break;
            case (MR_Integer) 2:
              {
          ...
          if (((MR_tag((MR_Word) StdLibCheckFileResult_43)) == (MR_Integer) 1))
          {
            ...
            mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_46);
            {
              ...
              MR_hl_field(MR_mktag(2), Var_66, 0) = ((MR_Box) (ProgName_46));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (GradeDirName_10));
            }
            {
              Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (Var_80));
              MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__check_libgrades_scalar_common_1[37])));
            }
            {
              Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[40])));
              MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (Var_79));
            }
            {
              Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[39])));
              MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_76));
            }
            {
              Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[38])));
              MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_73));
            }
            {
              Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &libs__check_libgrades_scalar_common_1[35])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_47, 0) = ((MR_Box) (Var_66));
              MR_hl_field(MR_mktag(1), Pieces_47, 1) = ((MR_Box) (Var_67));
            }
            {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_96 == (MR_Word) ((MR_Unsigned) 0U)))
          libs__check_libgrades__can_you_read_dir_4_p_0(Var_97, MaybeMerStdLibDir_8);
        else
