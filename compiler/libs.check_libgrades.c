      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 583, &SearchDirs_15);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 575, &MercuryLibDirs_16);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 575, &MercuryLibDirs_65);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 680, &LibgradeCheck_8);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 579, &Libs_9);
          libs__compute_grade__grade_directory_component_2_p_0(Globals_5, &GradeDirName_10);
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 581, &MaybeStdLibDir_33);
