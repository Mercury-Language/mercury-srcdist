...
libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__142__2_2_f_0(
  MR_String GradeDirNameDir_66,
  MR_String LambdaHeadVar__1_54);

static MR_String MR_CALL 
libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__142__1_2_f_0(
...
{
  {
    ...
    conv1_LambdaHeadVar__2_55 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__142__2_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_33 = libs__check_libgrades__IntroducedFrom__func__check_library_is_installed__142__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 581, &MercuryLibDirs_65);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 587, &MaybeStdLibDir_33);
          ...
          else
          {
            ...
            MR_Word StdLibCheckFileResult_37;
              ...
              case (MR_Integer) 0:
                {
                  ...
                  Var_52 = mercury__dir__f_slash_2_f_0(StdLibDir_34, (MR_String) "modules");
                  Var_51 = mercury__dir__f_slash_2_f_0(Var_52, GradeDirName_10);
                  StdLibCheckFile_36 = mercury__dir__f_slash_2_f_0(Var_51, (MR_String) "mer_std.init");
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  Var_44 = mercury__dir__f_slash_2_f_0(StdLibDir_34, (MR_String) "lib");
                  Var_43 = mercury__dir__f_slash_2_f_0(Var_44, GradeDirName_10);
                  StdLibCheckFile_36 = mercury__dir__f_slash_2_f_0(Var_43, (MR_String) "mer_std.dll");
                }
                break;
              case (MR_Integer) 2:
                {
                  ...
                  Var_48 = mercury__dir__f_slash_2_f_0(StdLibDir_34, (MR_String) "lib");
                  Var_47 = mercury__dir__f_slash_2_f_0(Var_48, GradeDirName_10);
                  StdLibCheckFile_36 = mercury__dir__f_slash_2_f_0(Var_47, (MR_String) "mer_std.jar");
                }
                break;
            }
            mercury__io__open_input_4_p_0(StdLibCheckFile_36, &StdLibCheckFileResult_37);
            if (((MR_tag((MR_Word) StdLibCheckFileResult_37)) == (MR_Integer) 1))
            {
              MR_Word Stderr_40;
              MR_String ProgName_41;

              mercury__io__stderr_stream_3_p_0(&Stderr_40);
              mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_41);
              mercury__io__write_string_4_p_0(Stderr_40, ProgName_41);
              mercury__io__write_string_4_p_0(Stderr_40, (MR_String) ": error: the Mercury standard library cannot be found in grade ");
              mercury__io__write_string_4_p_0(Stderr_40, GradeDirName_10);
              mercury__io__write_string_4_p_0(Stderr_40, (MR_String) ".\n");
              Succeeded0_11 = (MR_Integer) 0;
            }
            else
            {
              MR_Word StdLibCheckFileStream_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StdLibCheckFileResult_37, (MR_Integer) 0))));

              mercury__io__close_input_3_p_0(StdLibCheckFileStream_38);
              Succeeded0_11 = (MR_Integer) 1;
            }
          }
          {
