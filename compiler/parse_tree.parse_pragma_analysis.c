    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_351 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          parse_tree__parse_util__parse_pred_or_func_and_arg_modes_5_p_0(Var_91, PAMContextPieces_18, VarSet_9, Var_348, &MaybeNameAndModes_19);
          succeeded = ((MR_tag((MR_Word) Var_350)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_350, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
            ...
            if ((strcmp(ArgSizeFunctor_20, (MR_String) "finite") == 0))
              if ((ArgSizeArgTerms_21 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                Var_191 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
                {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if ((Var_382 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    parse_tree__parse_util__parse_list_elements_5_p_0((MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), (MR_String) "a list of booleans", Var_162, VarSet_9, Var_383, &MaybeUsedArgs_39);
            ...
            if ((strcmp(ArgSizeFunctor_20, (MR_String) "not_set") == 0))
              ...
              else
              {
                ...
                Var_121 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
                {
            ...
            else
            {
              ...
              Var_142 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
              {
          ...
          else
          {
            ...
            Var_242 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
            {
