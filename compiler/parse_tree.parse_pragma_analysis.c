      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeCtorInfo__46_46 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
              succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__46_46, NumerTerm_7, &Numer_10);
              if (succeeded)
                succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__46_46, DenomTerm_8, &Denom_11);
            }
          }
        }
      }
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo__46_89 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__46_89, NumerTerm_55, &Numer_58);
                if (succeeded)
                  succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__46_89, DenomTerm_56, &Denom_59);
              }
            }
          }
        }
            ...
            if ((Var_270 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_191, 0) = ((MR_Box) (Item_43));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_388 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Var_309 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_309, 0) = ((MR_Box) (Item_57));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeCtorInfo__90_90 = (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0);
            Var_50 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_analysis_scalar_common_1[88]));
            ReuseContextPieces_19 = mercury__cord__from_list_1_f_0(TypeCtorInfo__90_90, Var_50);
            {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeCtorInfo__91_91 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                    mercury__term__vars_list_2_p_0(TypeCtorInfo__91_91, ListHVTerm_24, &HeadVarsGeneric_26);
                    Var_65 = (MR_Word) (&parse_tree__parse_pragma_analysis_scalar_common_2[3]);
                    TypeInfo__96_96 = (MR_Word) (&parse_tree__parse_pragma_analysis_scalar_common_1[8]);
                    TypeInfo__97_97 = (MR_Word) (&parse_tree__parse_pragma_analysis_scalar_common_1[9]);
                    mercury__list__map_3_p_0(TypeInfo__96_96, TypeInfo__97_97, Var_65, HeadVarsGeneric_26, &HeadVars_27);
                              ...
                              if (succeeded)
                              {
                                ...
                                if ((strcmp(ReuseFunctor_31, (MR_String) "yes") == 0))
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      StructureReuse_36 = parse_tree__prog_ctgc__parse_structure_reuse_domain_1_f_0(TypeCtorInfo__91_91, StructureReuseTerm_35);
                                      {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            ModesContextPieces_19 = mercury__cord__from_list_1_f_0(TypeCtorInfo__90_90, Var_49);
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo__96_96 = (MR_Word) (&parse_tree__parse_pragma_analysis_scalar_common_1[8]);
                    TypeInfo__97_97 = (MR_Word) (&parse_tree__parse_pragma_analysis_scalar_common_1[9]);
                    mercury__list__map_3_p_0(TypeInfo__96_96, TypeInfo__97_97, Var_64, HeadVarsGeneric_26, &HeadVars_27);
                    succeeded = ((MR_tag((MR_Word) HeadVarTypesTerm_17)) == (MR_Integer) 0);
                    if (succeeded)
                    {
                              ...
                              if (succeeded)
                              {
                                ...
                                if ((strcmp(SharingFunctor_31, (MR_String) "yes") == 0))
                                {
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      Var_71 = parse_tree__prog_ctgc__parse_structure_sharing_domain_1_f_0(TypeCtorInfo__91_91, SharingAsTerm_35);
                                      {
          ...
          if ((Var_172 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_106, 0) = ((MR_Box) (Item_35));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      if ((Var_349 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_325 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_321, 2) = ((MR_Box) ((MR_Unsigned) 20U));
      ...
      else
      {
        ...
        if ((Var_351 == (MR_Word) ((MR_Unsigned) 0U)))
        {
              ...
              else
              {
                ...
                if ((Var_380 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  Var_358 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
                  {
                    ...
                    MR_hl_field(MR_mktag(1), FiniteSpec_354, 2) = ((MR_Box) ((MR_Unsigned) 20U));
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    Var_367 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_350);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), FiniteSpec_363, 2) = ((MR_Box) ((MR_Unsigned) 20U));
          ...
          if (succeeded)
          {
            ...
            {
              Var_279 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_279, 0) = ((MR_Box) (Item_64));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          Var_334 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_330, 2) = ((MR_Box) ((MR_Unsigned) 20U));
            ...
            if ((Var_229 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_147, 0) = ((MR_Box) (Item_38));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
