    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_347 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          parse_tree__parse_util__parse_pred_or_func_and_arg_modes_5_p_0(Var_114, PAMContextPieces_18, VarSet_9, Var_344, &MaybeNameAndModes_19);
          succeeded = ((MR_tag((MR_Word) Var_346)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_115 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_346, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
            ...
            if ((strcmp(ArgSizeFunctor_20, (MR_String) "finite") == 0))
              if ((ArgSizeArgTerms_21 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                Var_153 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_346);
                {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if ((Var_378 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    parse_tree__parse_util__parse_list_elements_5_p_0((MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), (MR_String) "a list of booleans", Var_173, VarSet_9, Var_379, &MaybeUsedArgs_39);
            ...
            if ((strcmp(ArgSizeFunctor_20, (MR_String) "not_set") == 0))
              ...
              else
              {
                ...
                Var_214 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_346);
                {
            ...
            else
            {
              ...
              Var_193 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_346);
              {
          ...
          else
          {
            ...
            Var_265 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_346);
            {
