          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_46_89, NumerTerm_55, &Numer_58);
                if (succeeded)
                  succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_46_89, DenomTerm_56, &Denom_59);
              }
            }
          }
        }
