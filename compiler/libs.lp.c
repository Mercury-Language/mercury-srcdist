...
MR_decl_label10(libs__lp__extract_obj_var_4_0, 5,7,10,11,14,15,18,19,2,23)
MR_decl_label3(libs__lp__extract_obj_var2_3_0, 3,6,7)
...
MR_def_label(libs__lp__optimize_4_0,5)
	...
	* (MR_Float *) &MR_sv(4) = MR_f(1);
	...
	MR_sv(7) = (MR_Word) MR_FLOAT_CTOR_ADDR;
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(7);
	}
...
MR_def_label(libs__lp__standardize_equation_4_0,96)
	...
	* (MR_Float *) &MR_sv(3) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r1, 2));
	if ((MR_float_from_dword_ptr(&MR_sv(3)) >= (MR_Float) 0.0000000000000000)) {
...
MR_BEGIN_MODULE(libs__lp_module30)
	...
	MR_init_label3(libs__lp__extract_obj_var2_3_0,3,6,7)
MR_BEGIN_CODE
...
MR_def_label(libs__lp__extract_obj_var2_3_0,3)
	...
	MR_np_call_localret_ent(solutions__solutions_2_1,
		libs__lp__extract_obj_var2_3_0_i6);
MR_def_label(libs__lp__extract_obj_var2_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(libs__lp__extract_obj_var2_3_0_i7);
	}
	...
	MR_decr_sp_and_return(2);
MR_def_label(libs__lp__extract_obj_var2_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_f(1) = (MR_Float) 0.0000000000000000;
	MR_decr_sp_and_return(2);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__lp_module31)
	...
	MR_init_label10(libs__lp__extract_obj_var_4_0,5,7,10,11,14,15,18,19,2,23)
MR_BEGIN_CODE
...
MR_def_label(libs__lp__extract_obj_var_4_0,7)
	...
	MR_np_call_localret_ent(solutions__solutions_2_1,
		libs__lp__extract_obj_var_4_0_i10);
MR_def_label(libs__lp__extract_obj_var_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(libs__lp__extract_obj_var_4_0_i11);
	}
	...
	* (MR_Float *) &MR_sv(5) = MR_word_to_float(MR_tfield(1, MR_r1, 0));
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r3 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_GOTO_LAB(libs__lp__extract_obj_var_4_0_i14);
...
MR_def_label(libs__lp__extract_obj_var_4_0,15)
	...
	MR_np_call_localret_ent(solutions__solutions_2_1,
		libs__lp__extract_obj_var_4_0_i18);
MR_def_label(libs__lp__extract_obj_var_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(libs__lp__extract_obj_var_4_0_i19);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r1, 1);
	...
	MR_r4 = MR_sv(2);
	MR_r5 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(5)) - MR_word_to_float(MR_tfield(1, MR_r1, 0))));
	MR_r6 = MR_sv(6);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = MR_sv(7);
...
MR_def_label(libs__lp__extract_obj_var_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(2);
	MR_r5 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(5)) - (MR_Float) 0.0000000000000000));
	MR_r6 = MR_sv(6);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = MR_sv(7);
	MR_r3 = (MR_Word) MR_FLOAT_CTOR_ADDR;
...
MR_def_label(libs__lp__extract_obj_var_4_0,2)
	...
	MR_np_call_localret_ent(libs__lp__extract_obj_var2_3_0,
		libs__lp__extract_obj_var_4_0_i23);
MR_def_label(libs__lp__extract_obj_var_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(2);
	MR_r5 = MR_float_to_word(MR_f(1));
	MR_r6 = MR_sv(6);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_FLOAT_CTOR_ADDR;
...
MR_def_label(libs__lp__IntroducedFrom__pred__simplify_coeffs__340__1_3_0,4)
	...
	MR_r4 = MR_sv(1);
	MR_r6 = MR_sv(4);
	MR_r5 = MR_float_to_word((MR_word_to_float(MR_r2) + MR_float_from_dword_ptr(&MR_sv(3))));
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = MR_sv(5);
	MR_r3 = (MR_Word) MR_FLOAT_CTOR_ADDR;
	MR_succip_word = MR_sv(6);
...
MR_def_label(libs__lp__IntroducedFrom__pred__simplify_coeffs__340__1_3_0,2)
	...
	MR_r4 = MR_sv(1);
	MR_r6 = MR_sv(4);
	MR_r5 = MR_float_to_word(((MR_Float) 0.0000000000000000 + MR_float_from_dword_ptr(&MR_sv(3))));
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_FLOAT_CTOR_ADDR;
	MR_succip_word = MR_sv(6);
...
MR_BEGIN_MODULE(libs__lp_module77)
