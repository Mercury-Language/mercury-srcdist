...
MR_def_label(libs__lp__insert_coeffs_5_0,5)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tempr1;
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(6)));
	MR_r4 = MR_sv(3);
	}
...
MR_def_label(libs__lp__ensure_zero_obj_coeffs_3_0,12)
	...
	MR_r1 = MR_float_to_word(((MR_Float) 0.0000000000000000 - MR_float_from_dword_ptr(&MR_sv(5))));
...
MR_def_label(libs__lp__negate_equation_2_0,14)
	...
	MR_tfield(0, MR_r2, 2) = MR_float_to_word(((MR_Float) 0.0000000000000000 - MR_float_from_dword_ptr(&MR_sv(2))));
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__lp__insert_equations_6_0,3)
	...
	MR_sv(4) = MR_tfield(1, MR_r1, 1);
	MR_tempr1 = MR_tfield(1, MR_r1, 0);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(0, MR_tempr1, 2));
...
MR_def_label(libs__lp__simplify_eq_2_0,8)
	...
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = MR_sv(2);
	MR_tfield(0, MR_r2, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_static(libs__lp__expand_urs_vars_e_3_0)
	...
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(0, MR_r1, 2));
...
MR_def_label(libs__lp__expand_urs_vars_e_3_0,5)
	...
	MR_tfield(0, MR_r2, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(3)));
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__lp__standardize_equation_4_0,17)
	...
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word(((MR_Float) 0.0000000000000000 - MR_float_from_dword_ptr(&MR_sv(3))));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(4);
	MR_succip_word = MR_sv(6);
...
MR_def_label(libs__lp__standardize_equation_4_0,20)
	...
	MR_tfield(0, MR_r1, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(3)));
	MR_sv(4) = MR_r2;
	}
...
MR_define_entry(mercury____Unify___libs__lp__equation_0_0);
	...
	* (MR_Float *) &MR_sv(7) = MR_word_to_float(MR_tfield(0, MR_tempr1, 2));
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,8);
	MR_r2 = MR_tfield(0, MR_tempr2, 0);
...
MR_def_label(libs__lp__IntroducedFrom__pred__simplex__500__1_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_r1) >= MR_float_from_dword_ptr(&MR_sv(2)))) {
...
MR_def_label(libs__lp__IntroducedFrom__pred__pivot__642__1_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) * MR_float_from_dword_ptr(&MR_sv(8))));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(2)));
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(libs__lp__IntroducedFrom__pred__pivot__642__1_6_0,5)
	...
	MR_r1 = MR_sv(10);
	MR_r2 = MR_sv(11);
	MR_r3 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(5)) - MR_word_to_float(MR_tempr1)));
	MR_r4 = MR_sv(9);
...
MR_def_static(libs__lp__IntroducedFrom__pred__pivot__661__1_5_0)
	...
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_r2);
	MR_sv(4) = MR_r3;
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r4;
...
MR_def_label(libs__lp__IntroducedFrom__pred__row_op__674__1_6_0,3)
	...
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(6);
	MR_r3 = MR_float_to_word((MR_word_to_float(MR_tempr1) + (MR_float_from_dword_ptr(&MR_sv(2)) * MR_float_from_dword_ptr(&MR_sv(5)))));
	MR_r4 = MR_sv(7);
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(libs__lp__set_index_5_0);
