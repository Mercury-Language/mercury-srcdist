...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[12])));
      }
      {
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_96, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
                  }
                  {
                    Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[25])));
                    MR_hl_field(MR_mktag(1), Var_93, 1) = ((MR_Box) (Var_96));
                  }
                  {
                    Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[24])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_115, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[21])));
