  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_HeadVar__3_131 = parse_tree__prog_event__IntroducedFrom__func__build_dep_map__625__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
            ...
            if ((AttrErrorSpecs_42 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              if (succeeded)
              {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(0, ErrorSpec_54, 3) = ((MR_Box) (Var_86));
                ...
                else
                {
                  ...
                  {
                    ErrorSpec_116 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, ErrorSpec_116, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.prog_event.build_dep_map\'/11"));
                    MR_hl_field(0, ErrorSpec_116, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(0, ErrorSpec_116, 2) = ((MR_Box) ((MR_Unsigned) 24U));
                    MR_hl_field(0, ErrorSpec_116, 3) = ((MR_Box) (Var_110));
                    MR_hl_field(0, ErrorSpec_116, 4) = ((MR_Box) (Pieces_115));
                  }
                  {
                    STATE_VARIABLE_ErrorSpecs_66_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
