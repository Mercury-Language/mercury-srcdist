...
parse_tree__prog_event__IntroducedFrom__pred__describe_attr_type__810__1_2_p_0(
  MR_Word parse_tree__prog_event__Kind_7,
  MR_Word parse_tree__prog_event__HeadVar__2_33);

static MR_bool MR_CALL 
parse_tree__prog_event__IntroducedFrom__pred__convert_terms_to_attrs__648__1_3_p_0(
...
parse_tree__prog_event__IntroducedFrom__func__build_dep_map__536__1_2_f_0(
...
parse_tree__prog_event__read_specs_file_5_p_0(
  MR_String parse_tree__prog_event__SpecsFile_6,
  MR_String parse_tree__prog_event__TermFile_7,
  MR_Word * parse_tree__prog_event__Result_8);
...
static void MR_CALL 
parse_tree__prog_event__read_event_set_6_p_0_1(
  MR_Box parse_tree__prog_event__closure_arg,
  MR_Box parse_tree__prog_event__wrapper_arg_1,
  MR_Box * parse_tree__prog_event__wrapper_arg_2,
  MR_Box parse_tree__prog_event__wrapper_arg_3,
  MR_Box * parse_tree__prog_event__wrapper_arg_4);
...
static /* final */ const MR_Box parse_tree__prog_event_scalar_common_4[4][6];

static /* final */ const MR_Box parse_tree__prog_event_scalar_common_5[2][1];

static /* final */ const MR_Box parse_tree__prog_event_scalar_common_6[1][8];

static /* final */ const MR_Box parse_tree__prog_event_scalar_common_7[1][4];
...
static /* final */ const MR_Box parse_tree__prog_event_scalar_common_1[34][2] = {
  ...
  /* row 32 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_7[0]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 33 */
  {
    ((MR_Box) (&parse_tree__prog_event_scalar_common_2[6])),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
};
...
static /* final */ const MR_Box parse_tree__prog_event_scalar_common_2[14][3] = {
  ...
  /* row 6 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[32])))
  },
  /* row 7 */
  {
...
static /* final */ const MR_Box parse_tree__prog_event_scalar_common_7[1][4] = {
  /* row 0 */
  {
    ...
    ((MR_Box) ((MR_Integer) 1)),
    ((MR_Box) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[31])))
  },
};
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String parse_tree__prog_event__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer parse_tree__prog_event__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgX3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        MR_Integer parse_tree__prog_event__ArgY3_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__Var_12;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&parse_tree__prog_event__Var_12, parse_tree__prog_event__ArgX1_4, parse_tree__prog_event__ArgY1_5);
        }
        parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_12 == (MR_Integer) 0);
        parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_12;
        else
          {
            MR_Word parse_tree__prog_event__Var_13;

            {
              mercury__private_builtin__builtin_compare_int_3_p_0(&parse_tree__prog_event__Var_13, parse_tree__prog_event__ArgX2_6, parse_tree__prog_event__ArgY2_7);
            }
            parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_13 == (MR_Integer) 0);
            parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
            if (parse_tree__prog_event__succeeded)
              *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_13;
            else
              {
                MR_Word parse_tree__prog_event__Var_14;

                {
                  mercury__private_builtin__builtin_compare_int_3_p_0(&parse_tree__prog_event__Var_14, parse_tree__prog_event__ArgX3_8, parse_tree__prog_event__ArgY3_9);
                }
                parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_14 == (MR_Integer) 0);
                parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
                if (parse_tree__prog_event__succeeded)
                  *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_14;
                else
                  {
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_event_scalar_common_1[5], parse_tree__prog_event__HeadVar__1_1, ((MR_Box) (parse_tree__prog_event__ArgX4_10)), ((MR_Box) (parse_tree__prog_event__ArgY4_11)));
                    }
                  }
              }
          }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
    ...
    else
      {
        ...
        MR_String parse_tree__prog_event__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer parse_tree__prog_event__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgX3_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer parse_tree__prog_event__ArgY3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 3)));

        parse_tree__prog_event__succeeded = (strcmp(parse_tree__prog_event__ArgX1_3, parse_tree__prog_event__ArgY1_4) == 0);
        if (parse_tree__prog_event__succeeded)
          {
            parse_tree__prog_event__succeeded = (parse_tree__prog_event__ArgX2_5 == parse_tree__prog_event__ArgY2_6);
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__succeeded = (parse_tree__prog_event__ArgX3_7 == parse_tree__prog_event__ArgY3_8);
                if (parse_tree__prog_event__succeeded)
                  {
                    parse_tree__prog_event__TypeInfo_13_13 = (MR_Word) &parse_tree__prog_event_scalar_common_1[5];
                    {
                      parse_tree__prog_event__succeeded = mercury__builtin__unify_2_p_0(parse_tree__prog_event__TypeInfo_13_13, ((MR_Box) (parse_tree__prog_event__ArgX4_9)), ((MR_Box) (parse_tree__prog_event__ArgY4_10)));
                    }
                  }
              }
          }
    ...
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        MR_String parse_tree__prog_event__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word parse_tree__prog_event__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&parse_tree__prog_event__Var_8, parse_tree__prog_event__ArgX1_4, parse_tree__prog_event__ArgY1_5);
        }
        parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_8 == (MR_Integer) 0);
        parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_8;
        else
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_event_scalar_common_1[4], parse_tree__prog_event__HeadVar__1_1, ((MR_Box) (parse_tree__prog_event__ArgX2_6)), ((MR_Box) (parse_tree__prog_event__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
    ...
    else
      {
        ...
        MR_String parse_tree__prog_event__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word parse_tree__prog_event__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        ...
        if (parse_tree__prog_event__succeeded)
          {
            ...
            {
              parse_tree__prog_event__succeeded = mercury__builtin__unify_2_p_0(parse_tree__prog_event__TypeInfo_9_9, ((MR_Box) (parse_tree__prog_event__ArgX2_5)), ((MR_Box) (parse_tree__prog_event__ArgY2_6)));
            }
          }
      }
    return parse_tree__prog_event__succeeded;
    ...
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Integer parse_tree__prog_event__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__Var_10;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&parse_tree__prog_event__Var_10, parse_tree__prog_event__ArgX1_4, parse_tree__prog_event__ArgY1_5);
        }
        parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_10 == (MR_Integer) 0);
        parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_10;
        else
          {
            MR_Word parse_tree__prog_event__Var_11;

            {
              mercury__private_builtin__builtin_compare_int_3_p_0(&parse_tree__prog_event__Var_11, parse_tree__prog_event__ArgX2_6, parse_tree__prog_event__ArgY2_7);
            }
            parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_11 == (MR_Integer) 0);
            parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
            if (parse_tree__prog_event__succeeded)
              *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_11;
            else
              {
                parse_tree__prog_event____Compare____event_attr_type_0_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__ArgX3_8, parse_tree__prog_event__ArgY3_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
    ...
    else
      {
        ...
        MR_Integer parse_tree__prog_event__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        ...
        if (parse_tree__prog_event__succeeded)
          {
            ...
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__succeeded = parse_tree__prog_event____Unify____event_attr_type_0_0(parse_tree__prog_event__ArgX3_7, parse_tree__prog_event__ArgY3_8);
              }
          }
      }
    return parse_tree__prog_event__succeeded;
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer parse_tree__prog_event__ArgX1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer parse_tree__prog_event__ArgY1_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgX2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_String parse_tree__prog_event__ArgY2_7 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgX3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        MR_Integer parse_tree__prog_event__ArgY3_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 3)));
        ...
        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&parse_tree__prog_event__Var_12, parse_tree__prog_event__ArgX1_4, parse_tree__prog_event__ArgY1_5);
        }
        parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_12 == (MR_Integer) 0);
        parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_12;
        else
          {
            ...
            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&parse_tree__prog_event__Var_13, parse_tree__prog_event__ArgX2_6, parse_tree__prog_event__ArgY2_7);
            }
            parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_13 == (MR_Integer) 0);
            parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
            if (parse_tree__prog_event__succeeded)
            ...
            else
              {
                ...
                if (parse_tree__prog_event__succeeded)
                  *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_14;
                  ...
                  {
                    parse_tree__prog_event____Compare____event_attr_type_0_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__ArgX4_10, parse_tree__prog_event__ArgY4_11);
                  }
              }
          }
      }
    ...
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) parse_tree__prog_event__HeadVar__2_2)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word parse_tree__prog_event__Var_36 = (MR_Word) MR_body(((MR_Word) parse_tree__prog_event__HeadVar__2_2), (MR_Integer) 0);

            switch (MR_tag((MR_Word) parse_tree__prog_event__HeadVar__3_3)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word parse_tree__prog_event__ArgY1_5 = (MR_Word) MR_body(((MR_Word) parse_tree__prog_event__HeadVar__3_3), (MR_Integer) 0);

                  {
                    parse_tree__prog_event____Compare____event_attr_type_term_0_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__Var_36, parse_tree__prog_event__ArgY1_5);
                  }
                }
                break;
              case (MR_Integer) 1:
        ...
        case (MR_Integer) 1:
          {
            MR_Word parse_tree__prog_event__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
            MR_Word parse_tree__prog_event__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) parse_tree__prog_event__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word parse_tree__prog_event__ArgY1_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Word parse_tree__prog_event__ArgY2_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 1)));
                  MR_Word parse_tree__prog_event__Var_18;

                  {
                    parse_tree__prog_event____Compare____event_attr_type_term_0_0(&parse_tree__prog_event__Var_18, parse_tree__prog_event__Var_38, parse_tree__prog_event__ArgY1_15);
                  }
                  parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_18 == (MR_Integer) 0);
                  parse_tree__prog_event__succeeded = !(parse_tree__prog_event__succeeded);
                  if (parse_tree__prog_event__succeeded)
                    *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_18;
                  else
                    {
                      parse_tree__prog_event____Compare____event_attr_synth_call_term_0_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__Var_37, parse_tree__prog_event__ArgY2_17);
                    }
                }
                break;
              case (MR_Integer) 2:
        ...
        case (MR_Integer) 2:
          {
            MR_Word parse_tree__prog_event__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) parse_tree__prog_event__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word parse_tree__prog_event__ArgY1_28 = ((MR_Word) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Integer parse_tree__prog_event__Var_39 = (MR_Integer) parse_tree__prog_event__Var_35;
                  MR_Integer parse_tree__prog_event__Var_40 = (MR_Integer) parse_tree__prog_event__ArgY1_28;

                  {
                    mercury__private_builtin__builtin_compare_int_3_p_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__Var_39, parse_tree__prog_event__Var_40);
                  }
                }
                break;
            }
    ...
    else
      {
        ...
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_event_scalar_common_1[3], parse_tree__prog_event__HeadVar__1_1, ((MR_Box) (parse_tree__prog_event__ArgX2_6)), ((MR_Box) (parse_tree__prog_event__ArgY2_7)));
            }
          }
      }
  }
    ...
    else
      {
        ...
        if (parse_tree__prog_event__succeeded)
          *parse_tree__prog_event__HeadVar__1_1 = parse_tree__prog_event__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__prog_event_scalar_common_1[2], parse_tree__prog_event__HeadVar__1_1, ((MR_Box) (parse_tree__prog_event__ArgX2_6)), ((MR_Box) (parse_tree__prog_event__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
      ...
      {
        MR_Integer parse_tree__prog_event__ArgX1_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer parse_tree__prog_event__ArgY1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__ArgX2_5 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
        MR_String parse_tree__prog_event__ArgY2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer parse_tree__prog_event__ArgX3_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer parse_tree__prog_event__ArgY3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word parse_tree__prog_event__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 3)));

        parse_tree__prog_event__succeeded = (parse_tree__prog_event__ArgX1_3 == parse_tree__prog_event__ArgY1_4);
        if (parse_tree__prog_event__succeeded)
          {
            parse_tree__prog_event__succeeded = (strcmp(parse_tree__prog_event__ArgX2_5, parse_tree__prog_event__ArgY2_6) == 0);
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__succeeded = (parse_tree__prog_event__ArgX3_7 == parse_tree__prog_event__ArgY3_8);
                if (parse_tree__prog_event__succeeded)
                  {
                    parse_tree__prog_event__succeeded = parse_tree__prog_event____Unify____event_attr_type_0_0(parse_tree__prog_event__ArgX4_9, parse_tree__prog_event__ArgY4_10);
                  }
              }
          }
      }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
      ...
      switch (MR_tag((MR_Word) parse_tree__prog_event__HeadVar__1_1)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word parse_tree__prog_event__ArgX1_3 = (MR_Word) MR_body(((MR_Word) parse_tree__prog_event__HeadVar__1_1), (MR_Integer) 0);
            MR_Word parse_tree__prog_event__ArgY1_4;

            parse_tree__prog_event__succeeded = ((MR_tag((MR_Word) parse_tree__prog_event__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__ArgY1_4 = (MR_Word) MR_body(((MR_Word) parse_tree__prog_event__HeadVar__2_2), (MR_Integer) 0);
                {
                  parse_tree__prog_event__succeeded = parse_tree__prog_event____Unify____event_attr_type_term_0_0(parse_tree__prog_event__ArgX1_3, parse_tree__prog_event__ArgY1_4);
                }
              }
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word parse_tree__prog_event__ArgX1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word parse_tree__prog_event__ArgY1_6;
            MR_Word parse_tree__prog_event__ArgX2_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word parse_tree__prog_event__ArgY2_8;

            parse_tree__prog_event__succeeded = ((MR_tag((MR_Word) parse_tree__prog_event__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__ArgY1_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
                parse_tree__prog_event__ArgY2_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 1)));
                {
                  parse_tree__prog_event__succeeded = parse_tree__prog_event____Unify____event_attr_type_term_0_0(parse_tree__prog_event__ArgX1_5, parse_tree__prog_event__ArgY1_6);
                }
                if (parse_tree__prog_event__succeeded)
                  {
                    parse_tree__prog_event__succeeded = parse_tree__prog_event____Unify____event_attr_synth_call_term_0_0(parse_tree__prog_event__ArgX2_7, parse_tree__prog_event__ArgY2_8);
                  }
              }
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word parse_tree__prog_event__ArgX1_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word parse_tree__prog_event__ArgY1_10;

            parse_tree__prog_event__succeeded = ((MR_tag((MR_Word) parse_tree__prog_event__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (parse_tree__prog_event__succeeded)
              {
                parse_tree__prog_event__ArgY1_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__HeadVar__2_2, (MR_Integer) 0)));
                parse_tree__prog_event__succeeded = (parse_tree__prog_event__ArgX1_9 == parse_tree__prog_event__ArgY1_10);
              }
          }
          break;
      }
...
{
  {
    MR_bool parse_tree__prog_event__succeeded;
    MR_Word parse_tree__prog_event__Var_8;
    MR_Integer parse_tree__prog_event__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 0)));
    MR_String parse_tree__prog_event__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 1)));
    MR_Word parse_tree__prog_event__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 2)));

    *parse_tree__prog_event__HeadVar__2_2 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 3)));
    parse_tree__prog_event__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 4)));
    parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    return parse_tree__prog_event__succeeded;
  }
}
...
{
  {
    ...
    MR_Integer parse_tree__prog_event__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 0)));
    MR_String parse_tree__prog_event__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 1)));
    MR_Word parse_tree__prog_event__Var_7;

    *parse_tree__prog_event__HeadVar__2_2 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 2)));
    parse_tree__prog_event__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 3)));
    parse_tree__prog_event__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Attribute_3, (MR_Integer) 4)));
    parse_tree__prog_event__succeeded = (parse_tree__prog_event__Var_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    return parse_tree__prog_event__succeeded;
  }
...
{
  {
    ...
    MR_String parse_tree__prog_event__Var_26;
    MR_String parse_tree__prog_event__Var_28;
    ...
    if ((parse_tree__prog_event__MaybeSynthCall_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word parse_tree__prog_event__Var_18;
        MR_String parse_tree__prog_event__Var_20;
        MR_String parse_tree__prog_event__Var_21;
        MR_String parse_tree__prog_event__Var_22;
        MR_String parse_tree__prog_event__Var_24;
        ...
        MR_Box parse_tree__prog_event__conv0_Var_21;

        {
          parse_tree__prog_event__Var_18 = mercury__assoc_list__keys_1_f_0(parse_tree__prog_event__TypeCtorInfo_29_29, parse_tree__prog_event__TypeCtorInfo_30_30, parse_tree__prog_event__ArgAttrNameNums_14);
        }
        {
          parse_tree__prog_event__ArgAttrDesc_16 = mercury__string__join_list_2_f_0((MR_String) ", ", parse_tree__prog_event__Var_18);
        }
        {
          parse_tree__prog_event__conv0_Var_21 = mercury__pair__fst_1_f_0(parse_tree__prog_event__TypeCtorInfo_29_29, parse_tree__prog_event__TypeCtorInfo_30_30, parse_tree__prog_event__FuncAttrNameNum_13);
        }
        parse_tree__prog_event__Var_21 = ((MR_String) parse_tree__prog_event__conv0_Var_21);
        {
          parse_tree__prog_event__Var_24 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__ArgAttrDesc_16, (MR_String) ")");
        }
        {
          parse_tree__prog_event__Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "(", parse_tree__prog_event__Var_24);
        }
        {
          parse_tree__prog_event__Var_20 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__Var_21, parse_tree__prog_event__Var_22);
        }
        {
          parse_tree__prog_event__SynthCallDesc_11 = mercury__string__f_43_43_2_f_0((MR_String) " synthesized by ", parse_tree__prog_event__Var_20);
        }
      }
    {
      parse_tree__prog_event__Var_28 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__TypeDesc_10, parse_tree__prog_event__SynthCallDesc_11);
    }
    {
      parse_tree__prog_event__Var_26 = mercury__string__f_43_43_2_f_0((MR_String) ": ", parse_tree__prog_event__Var_28);
    }
    {
      parse_tree__prog_event__Desc_4 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__Name_6, parse_tree__prog_event__Var_26);
    }
...
{
  {
    ...
    {
      parse_tree__prog_event__succeeded = parse_tree__prog_event__IntroducedFrom__pred__describe_attr_type__810__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__closure, (MR_Integer) 4))));
    }
    return parse_tree__prog_event__succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word parse_tree__prog_event__Var_29;
          MR_String parse_tree__prog_event__Var_41;

          {
            parse_tree__prog_event__Var_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_29, 0) = ((MR_Box) (&parse_tree__prog_event_scalar_common_3[6]));
            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_29, 1) = ((MR_Box) (parse_tree__prog_event__describe_attr_type_1_f_0_1));
            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_29, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_29, 3) = ((MR_Box) (parse_tree__prog_event__Kind_7));
            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_29, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            mercury__require__expect_4_p_0(parse_tree__prog_event__Var_29, (MR_String) "parse_tree.prog_event", (MR_String) "function \140parse_tree.prog_event.describe_attr_type\'/1", (MR_String) "not kind_star");
          }
          if ((parse_tree__prog_event__ArgTypes_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            {
              MR_String parse_tree__prog_event__Var_35;
              MR_String parse_tree__prog_event__Var_36;
              MR_Word parse_tree__prog_event__Var_38;

              {
                parse_tree__prog_event__Var_38 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_event_scalar_common_2[13], parse_tree__prog_event__ArgTypes_6);
              }
              {
                parse_tree__prog_event__Var_36 = mercury__string__join_list_2_f_0((MR_String) ", ", parse_tree__prog_event__Var_38);
              }
              {
                parse_tree__prog_event__Var_35 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__Var_36, (MR_String) ")");
              }
              {
                parse_tree__prog_event__ArgTypeDescs_8 = mercury__string__f_43_43_2_f_0((MR_String) "(", parse_tree__prog_event__Var_35);
              }
            }
          {
            parse_tree__prog_event__Var_41 = mdbcomp__sym_name__sym_name_to_string_1_f_0(parse_tree__prog_event__SymName_5);
          }
          {
            parse_tree__prog_event__Desc_4 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__Var_41, parse_tree__prog_event__ArgTypeDescs_8);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          {
            parse_tree__prog_data__builtin_type_to_string_2_p_0(parse_tree__prog_event__BuiltinType_11, &parse_tree__prog_event__Desc_4);
          }
        }
        break;
      case (MR_Integer) 3:
...
{
  {
    ...
    MR_Word parse_tree__prog_event__Var_12;
    MR_String parse_tree__prog_event__Var_15;
    MR_String parse_tree__prog_event__Var_16;
    MR_String parse_tree__prog_event__Var_18;
    ...
    {
      parse_tree__prog_event__Var_12 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_attribute_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_event_scalar_common_2[12], parse_tree__prog_event__Attrs_8);
    }
    {
      parse_tree__prog_event__AttrDescs_10 = mercury__string__join_list_2_f_0((MR_String) ",\n", parse_tree__prog_event__Var_12);
    }
    {
      parse_tree__prog_event__Var_18 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__AttrDescs_10, (MR_String) ")\n");
    }
    {
      parse_tree__prog_event__Var_16 = mercury__string__f_43_43_2_f_0((MR_String) "(", parse_tree__prog_event__Var_18);
    }
    {
      parse_tree__prog_event__Var_15 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__EventName_6, parse_tree__prog_event__Var_16);
    }
    {
      parse_tree__prog_event__Desc_4 = mercury__string__f_43_43_2_f_0((MR_String) "event ", parse_tree__prog_event__Var_15);
    }
    return parse_tree__prog_event__Desc_4;
  }
}
  ...
  MR_Word * parse_tree__prog_event__Result_6)
{
  {
    MR_bool parse_tree__prog_event__succeeded;
    MR_Integer parse_tree__prog_event__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecA_4, (MR_Integer) 0)));
    MR_Integer parse_tree__prog_event__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecB_5, (MR_Integer) 0)));
    MR_String parse_tree__prog_event__Var_9 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecA_4, (MR_Integer) 1)));
    MR_Integer parse_tree__prog_event__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecA_4, (MR_Integer) 2)));
    MR_Word parse_tree__prog_event__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecA_4, (MR_Integer) 3)));
    MR_Word parse_tree__prog_event__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecA_4, (MR_Integer) 4)));
    MR_String parse_tree__prog_event__Var_13 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecB_5, (MR_Integer) 1)));
    MR_Integer parse_tree__prog_event__Var_14 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecB_5, (MR_Integer) 2)));
    MR_Word parse_tree__prog_event__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecB_5, (MR_Integer) 3)));
    MR_Word parse_tree__prog_event__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__SpecB_5, (MR_Integer) 4)));

    {
      mercury__private_builtin__builtin_compare_int_3_p_0(parse_tree__prog_event__Result_6, parse_tree__prog_event__Var_7, parse_tree__prog_event__Var_8);
    }
  }
}
...
{
  {
    ...
    MR_Integer parse_tree__prog_event__Var_11 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Spec_4, (MR_Integer) 0)));
    MR_String parse_tree__prog_event__Var_12 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Spec_4, (MR_Integer) 1)));
    MR_Integer parse_tree__prog_event__Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Spec_4, (MR_Integer) 2)));
    MR_Word parse_tree__prog_event__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Spec_4, (MR_Integer) 4)));

    {
      mercury__list__length_2_p_0((MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_attribute_0, parse_tree__prog_event__AllAttrs_6, &parse_tree__prog_event__NumAttr_7);
    }
    {
  ...
  MR_Word * parse_tree__prog_event__Result_8)
{
  {
    MR_bool parse_tree__prog_event__succeeded;
    MR_String parse_tree__prog_event__Problem_10;
...
#define MR_PROC_LABEL parse_tree__prog_event__read_specs_file_5_p_0
	...
	SpecsFileName =  parse_tree__prog_event__SpecsFile_6 ;
	TermFileName =  parse_tree__prog_event__TermFile_7 ;
		{
    ...
    */
    ...
    MR_restore_transient_hp();
		...
		;}
#undef MR_PROC_LABEL
	 parse_tree__prog_event__Problem_10  = Problem;
}
    parse_tree__prog_event__succeeded = (strcmp(parse_tree__prog_event__Problem_10, (MR_String) "") == 0);
    if (parse_tree__prog_event__succeeded)
      *parse_tree__prog_event__Result_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        *parse_tree__prog_event__Result_8 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__prog_event__Problem_10));
      }
  }
}
...
{
  {
    ...
    MR_Integer parse_tree__prog_event__Var_17;
    MR_String parse_tree__prog_event__Var_18;
    MR_Integer parse_tree__prog_event__Var_19;
    MR_Word parse_tree__prog_event__Var_20;

    {
      parse_tree__prog_event__succeeded = mercury__map__search_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0, parse_tree__prog_event__EventSpecMap_4, ((MR_Box) (parse_tree__prog_event__EventName_5)), &parse_tree__prog_event__conv0_EventSpec_16);
    }
    if (parse_tree__prog_event__succeeded)
      {
    ...
    if (parse_tree__prog_event__succeeded)
      {
        parse_tree__prog_event__Var_17 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 0)));
        parse_tree__prog_event__Var_18 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 1)));
        parse_tree__prog_event__Var_19 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 2)));
        parse_tree__prog_event__Attributes_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 3)));
        parse_tree__prog_event__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 4)));
        parse_tree__prog_event__Var_8 = (MR_Word) &parse_tree__prog_event_scalar_common_2[11];
        parse_tree__prog_event__TypeCtorInfo_11_11 = (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_attribute_0;
        ...
        {
          mercury__list__filter_map_3_p_0(parse_tree__prog_event__TypeCtorInfo_11_11, parse_tree__prog_event__TypeCtorInfo_12_12, parse_tree__prog_event__Var_8, parse_tree__prog_event__Attributes_7, parse_tree__prog_event__ArgModes_6);
        }
        parse_tree__prog_event__succeeded = MR_TRUE;
      }
    return parse_tree__prog_event__succeeded;
    ...
    if (parse_tree__prog_event__succeeded)
      {
        ...
        parse_tree__prog_event__Attributes_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 3)));
        parse_tree__prog_event__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_16, (MR_Integer) 4)));
        parse_tree__prog_event__Var_8 = (MR_Word) &parse_tree__prog_event_scalar_common_2[10];
        parse_tree__prog_event__TypeCtorInfo_11_11 = (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_attribute_0;
        ...
        {
          mercury__list__filter_map_3_p_0(parse_tree__prog_event__TypeCtorInfo_11_11, parse_tree__prog_event__TypeCtorInfo_12_12, parse_tree__prog_event__Var_8, parse_tree__prog_event__Attributes_7, parse_tree__prog_event__ArgTypes_6);
        }
        parse_tree__prog_event__succeeded = MR_TRUE;
      }
    return parse_tree__prog_event__succeeded;
...
{
  {
    ...
    MR_Integer parse_tree__prog_event__Var_8;
    MR_String parse_tree__prog_event__Var_9;
    MR_Integer parse_tree__prog_event__Var_10;
    MR_Word parse_tree__prog_event__Var_11;

    {
      parse_tree__prog_event__succeeded = mercury__map__search_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0, parse_tree__prog_event__EventSpecMap_4, ((MR_Box) (parse_tree__prog_event__EventName_5)), &parse_tree__prog_event__conv0_EventSpec_7);
    }
    if (parse_tree__prog_event__succeeded)
      {
    ...
    if (parse_tree__prog_event__succeeded)
      {
        parse_tree__prog_event__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 0)));
        parse_tree__prog_event__Var_9 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 1)));
        parse_tree__prog_event__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 2)));
        *parse_tree__prog_event__Attributes_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 3)));
        parse_tree__prog_event__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 4)));
        parse_tree__prog_event__succeeded = MR_TRUE;
      }
    return parse_tree__prog_event__succeeded;
  }
...
{
  {
    ...
    MR_Word parse_tree__prog_event__EventSpec_7;
    MR_Box parse_tree__prog_event__conv0_EventSpec_7;
    MR_String parse_tree__prog_event__Var_8;
    MR_Integer parse_tree__prog_event__Var_9;
    MR_Word parse_tree__prog_event__Var_10;
    MR_Word parse_tree__prog_event__Var_11;
    ...
    if (parse_tree__prog_event__succeeded)
      {
        *parse_tree__prog_event__EventNumber_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 0)));
        parse_tree__prog_event__Var_8 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 1)));
        parse_tree__prog_event__Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 2)));
        parse_tree__prog_event__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 3)));
        parse_tree__prog_event__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSpec_7, (MR_Integer) 4)));
        parse_tree__prog_event__succeeded = MR_TRUE;
      }
    return parse_tree__prog_event__succeeded;
...
{
  {
    ...
    MR_Word parse_tree__prog_event__TypeCtorInfo_22_22 = (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0;
    ...
    MR_String parse_tree__prog_event__Var_16;
    MR_String parse_tree__prog_event__Var_17;
    ...
    {
      mercury__list__sort_3_p_0(parse_tree__prog_event__TypeCtorInfo_22_22, (MR_Word) &parse_tree__prog_event_scalar_common_2[7], parse_tree__prog_event__EventSpecList_7, &parse_tree__prog_event__SortedEventSpecList_8);
    }
    {
      parse_tree__prog_event__EventDescStrings_9 = mercury__list__map_2_f_0(parse_tree__prog_event__TypeCtorInfo_22_22, parse_tree__prog_event__TypeCtorInfo_21_21, (MR_Word) &parse_tree__prog_event_scalar_common_2[8], parse_tree__prog_event__SortedEventSpecList_8);
    }
    {
      mercury__string__append_list_2_p_0(parse_tree__prog_event__EventDescStrings_9, &parse_tree__prog_event__EventDescs_10);
    }
    {
      parse_tree__prog_event__Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "\n", parse_tree__prog_event__EventDescs_10);
    }
    {
      parse_tree__prog_event__Var_16 = mercury__string__f_43_43_2_f_0(parse_tree__prog_event__EventSetName_5, parse_tree__prog_event__Var_17);
    }
    {
      parse_tree__prog_event__Desc_11 = mercury__string__f_43_43_2_f_0((MR_String) "event set ", parse_tree__prog_event__Var_16);
    }
    {
      mercury__list__foldl_4_p_0(parse_tree__prog_event__TypeCtorInfo_22_22, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &parse_tree__prog_event_scalar_common_2[9], parse_tree__prog_event__EventSpecList_7, ((MR_Box) ((MR_Integer) -1)), &parse_tree__prog_event__conv3_MaxNumAttr_12);
    }
  ...
  MR_Box * parse_tree__prog_event__wrapper_arg_4)
{
  {
    MR_Box parse_tree__prog_event__closure = parse_tree__prog_event__closure_arg;
    MR_Word parse_tree__prog_event__conv0_Result_8;

    {
      parse_tree__prog_event__read_specs_file_5_p_0(((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__closure, (MR_Integer) 3))), ((MR_String) parse_tree__prog_event__wrapper_arg_1), &parse_tree__prog_event__conv0_Result_8);
    }
    *parse_tree__prog_event__wrapper_arg_2 = ((MR_Box) (parse_tree__prog_event__conv0_Result_8));
  }
}
  ...
  MR_Word * parse_tree__prog_event__ErrorSpecs_10)
{
  {
    MR_bool parse_tree__prog_event__succeeded;
    MR_Word parse_tree__prog_event__TermFileResult_12;
    MR_Word parse_tree__prog_event__Var_26;

    {
      parse_tree__prog_event__Var_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_26, 0) = ((MR_Box) (&parse_tree__prog_event_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_26, 1) = ((MR_Box) (parse_tree__prog_event__read_event_set_6_p_0_1));
      MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_26, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_26, 3) = ((MR_Box) (parse_tree__prog_event__SpecsFileName_7));
    }
    {
      libs__file_util__open_temp_input_4_p_0(&parse_tree__prog_event__TermFileResult_12, parse_tree__prog_event__Var_26);
    }
    if (((MR_tag((MR_Word) parse_tree__prog_event__TermFileResult_12)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String parse_tree__prog_event__ErrorMessage_23 = ((MR_String) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__TermFileResult_12, (MR_Integer) 0)));
        MR_Word parse_tree__prog_event__Var_28;
        MR_Word parse_tree__prog_event__Var_34;
        MR_Word parse_tree__prog_event__Var_35;
        MR_Word parse_tree__prog_event__Var_39;
        MR_Word parse_tree__prog_event__Var_40;
        MR_Word parse_tree__prog_event__Pieces_83;
        MR_Word parse_tree__prog_event__ErrorSpec_84;

        *parse_tree__prog_event__EventSetName_8 = (MR_String) "";
        {
          *parse_tree__prog_event__EventSpecMap_9 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0);
        }
        {
          parse_tree__prog_event__Var_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_28, 1) = ((MR_Box) (parse_tree__prog_event__ErrorMessage_23));
        }
        {
          parse_tree__prog_event__Pieces_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_83, 0) = ((MR_Box) (parse_tree__prog_event__Var_28));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_83, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[6])));
        }
        {
          parse_tree__prog_event__Var_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_40, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_83));
        }
        {
          parse_tree__prog_event__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_39, 0) = ((MR_Box) (parse_tree__prog_event__Var_40));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__prog_event__Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_35, 1) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_35, 2) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_35, 3) = ((MR_Box) (parse_tree__prog_event__Var_39));
        }
        {
          parse_tree__prog_event__Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_34, 0) = ((MR_Box) (parse_tree__prog_event__Var_35));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__prog_event__ErrorSpec_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_84, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_84, 2) = ((MR_Box) (parse_tree__prog_event__Var_34));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *parse_tree__prog_event__ErrorSpecs_10 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__prog_event__ErrorSpec_84));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
      }
    else
      {
        MR_String parse_tree__prog_event__TermFileName_13;
        MR_Word parse_tree__prog_event__TermStream_14;
        MR_Word parse_tree__prog_event__TermReadRes_15;
        MR_Tuple parse_tree__prog_event__Var_44 = ((MR_Tuple) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__TermFileResult_12, (MR_Integer) 0)));
        MR_Word parse_tree__prog_event___RemoveRes_22;

        parse_tree__prog_event__TermFileName_13 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_44, (MR_Integer) 0)));
        parse_tree__prog_event__TermStream_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_44, (MR_Integer) 1)));
        {
          mercury__io__read_4_p_0((MR_Word) &parse_tree__prog_event__parse_tree__prog_event__type_ctor_info_event_set_spec_0, parse_tree__prog_event__TermStream_14, &parse_tree__prog_event__TermReadRes_15);
        }
        switch (MR_tag((MR_Word) parse_tree__prog_event__TermReadRes_15)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *parse_tree__prog_event__EventSetName_8 = (MR_String) "";
              ...
              *parse_tree__prog_event__ErrorSpecs_10 = (MR_Word) MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[33]);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word parse_tree__prog_event__EventSetTerm_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__TermReadRes_15, (MR_Integer) 0)));
              MR_Word parse_tree__prog_event__EventSpecsTerm_17;
              MR_Word parse_tree__prog_event__Var_77;

              *parse_tree__prog_event__EventSetName_8 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSetTerm_16, (MR_Integer) 0)));
              parse_tree__prog_event__EventSpecsTerm_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventSetTerm_16, (MR_Integer) 1)));
              {
                parse_tree__prog_event__Var_77 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0);
              }
              {
                parse_tree__prog_event__convert_list_to_spec_map_6_p_0(parse_tree__prog_event__SpecsFileName_7, parse_tree__prog_event__EventSpecsTerm_17, parse_tree__prog_event__Var_77, parse_tree__prog_event__EventSpecMap_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), parse_tree__prog_event__ErrorSpecs_10);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_String parse_tree__prog_event__TermReadMsg_20 = ((MR_String) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__TermReadRes_15, (MR_Integer) 0)));
              MR_Integer parse_tree__prog_event__LineNumber_21 = ((MR_Integer) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__TermReadRes_15, (MR_Integer) 1)));
              MR_Word parse_tree__prog_event__Var_46;
              MR_Word parse_tree__prog_event__Var_52;
              MR_Word parse_tree__prog_event__Var_53;
              MR_Word parse_tree__prog_event__Var_54;
              MR_Word parse_tree__prog_event__Var_55;
              MR_Word parse_tree__prog_event__Var_56;
              MR_Word parse_tree__prog_event__Pieces_81;
              MR_Word parse_tree__prog_event__ErrorSpec_82;
              ...
              *parse_tree__prog_event__EventSetName_8 = (MR_String) "";
              ...
              {
                parse_tree__prog_event__Var_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_46, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_46, 1) = ((MR_Box) (parse_tree__prog_event__TermReadMsg_20));
              }
              {
                parse_tree__prog_event__Pieces_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_81, 0) = ((MR_Box) (parse_tree__prog_event__Var_46));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[6])));
              }
              {
                parse_tree__prog_event__Var_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_54, 0) = ((MR_Box) (parse_tree__prog_event__TermFileName_13));
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_54, 1) = ((MR_Box) (parse_tree__prog_event__LineNumber_21));
              }
              {
                parse_tree__prog_event__Var_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_56, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_81));
              }
              {
                parse_tree__prog_event__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_55, 0) = ((MR_Box) (parse_tree__prog_event__Var_56));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                parse_tree__prog_event__Var_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_53, 0) = ((MR_Box) (parse_tree__prog_event__Var_54));
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_53, 1) = ((MR_Box) (parse_tree__prog_event__Var_55));
              }
              {
                parse_tree__prog_event__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_52, 0) = ((MR_Box) (parse_tree__prog_event__Var_53));
                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_52, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                parse_tree__prog_event__ErrorSpec_82 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
                MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_82, 2) = ((MR_Box) (parse_tree__prog_event__Var_52));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *parse_tree__prog_event__ErrorSpecs_10 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (parse_tree__prog_event__ErrorSpec_82));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
            }
            break;
        ...
        {
          mercury__io__close_input_3_p_0(parse_tree__prog_event__TermStream_14);
        }
        {
          mercury__io__remove_file_4_p_0(parse_tree__prog_event__TermFileName_13, &parse_tree__prog_event___RemoveRes_22);
        }
      }
  }
}
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__prog_event__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              MR_Word parse_tree__prog_event__next_value_of_HeadVar__2_2 = parse_tree__prog_event__SpecTerms_16;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_EventSpecMap_0_3 = parse_tree__prog_event__STATE_VARIABLE_EventSpecMap_23_23;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_5 = parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_24_24;

              parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_5 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_5;
              parse_tree__prog_event__STATE_VARIABLE_EventSpecMap_0_3 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_EventSpecMap_0_3;
              parse_tree__prog_event__HeadVar__2_2 = parse_tree__prog_event__next_value_of_HeadVar__2_2;
            }
            continue;
          }
      }
...
{
  {
    ...
    MR_Word parse_tree__prog_event__Var_39;
    MR_Word parse_tree__prog_event__Var_40;
    MR_Word parse_tree__prog_event__Var_41;
    MR_Word parse_tree__prog_event__Var_42;
    MR_Word parse_tree__prog_event__Var_43;
    ...
    {
      parse_tree__prog_event__Var_39 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, parse_tree__prog_event__TypeCtorInfo_109_109);
    }
    parse_tree__prog_event__TypeCtorInfo_110_110 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    {
      parse_tree__prog_event__Var_40 = mercury__map__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110, parse_tree__prog_event__TypeCtorInfo_109_109);
    }
    {
      parse_tree__prog_event__Var_41 = mercury__map__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
    }
    {
      parse_tree__prog_event__Var_42 = mercury__bimap__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110, (MR_Word) &parse_tree__prog_event_scalar_common_1[0]);
    }
    {
      parse_tree__prog_event__Var_43 = mercury__digraph__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110);
    }
    {
      parse_tree__prog_event__build_plain_type_map_17_p_0(parse_tree__prog_event__EventName_11, parse_tree__prog_event__FileName_7, parse_tree__prog_event__EventLineNumber_13, parse_tree__prog_event__AttrTerms_14, (MR_Integer) 0, parse_tree__prog_event__Var_39, &parse_tree__prog_event___AttrNumMap_15, parse_tree__prog_event__Var_40, &parse_tree__prog_event__AttrNameMap_16, parse_tree__prog_event__Var_41, &parse_tree__prog_event__AttrTypeMap0_17, parse_tree__prog_event__Var_42, &parse_tree__prog_event__KeyMap_18, parse_tree__prog_event__Var_43, &parse_tree__prog_event__DepRel0_19, parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_36, &parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_44_44);
    }
    {
    ...
    if (parse_tree__prog_event__succeeded)
    ...
    else
      {
        ...
        MR_Word parse_tree__prog_event__Var_51;
        MR_Word parse_tree__prog_event__Var_54;
        MR_Word parse_tree__prog_event__Var_55;
        MR_Word parse_tree__prog_event__Var_64;
        MR_Word parse_tree__prog_event__Var_65;
        MR_Word parse_tree__prog_event__Var_66;
        MR_Word parse_tree__prog_event__Var_67;
        MR_Word parse_tree__prog_event__Var_68;

        {
          parse_tree__prog_event__Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_55, 1) = ((MR_Box) (parse_tree__prog_event__EventName_11));
        }
        {
          parse_tree__prog_event__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_54, 0) = ((MR_Box) (parse_tree__prog_event__Var_55));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
        }
        {
          parse_tree__prog_event__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[28])));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_51, 1) = ((MR_Box) (parse_tree__prog_event__Var_54));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_25, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[27])));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_25, 1) = ((MR_Box) (parse_tree__prog_event__Var_51));
        }
        {
          parse_tree__prog_event__Var_66 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_66, 0) = ((MR_Box) (parse_tree__prog_event__FileName_7));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_66, 1) = ((MR_Box) (parse_tree__prog_event__EventLineNumber_13));
        }
        {
          parse_tree__prog_event__Var_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_68, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_25));
        }
        {
          parse_tree__prog_event__Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_67, 0) = ((MR_Box) (parse_tree__prog_event__Var_68));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__prog_event__Var_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_65, 0) = ((MR_Box) (parse_tree__prog_event__Var_66));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_65, 1) = ((MR_Box) (parse_tree__prog_event__Var_67));
        }
        {
          parse_tree__prog_event__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_64, 0) = ((MR_Box) (parse_tree__prog_event__Var_65));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__CircErrorSpec_26, 2) = ((MR_Box) (parse_tree__prog_event__Var_64));
        }
        {
    ...
    {
      mercury__list__reverse_2_p_0((MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_attribute_0, parse_tree__prog_event__RevAttrs_22, &parse_tree__prog_event__Attrs_27);
    }
    {
    ...
    {
      parse_tree__prog_event__succeeded = mercury__map__search_3_p_0(parse_tree__prog_event__TypeCtorInfo_110_110, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0, parse_tree__prog_event__STATE_VARIABLE_EventSpecMap_0_34, ((MR_Box) (parse_tree__prog_event__EventName_11)), &parse_tree__prog_event__conv0_OldEventSpec_29);
    }
    if (parse_tree__prog_event__succeeded)
      {
    ...
    if (parse_tree__prog_event__succeeded)
      {
        ...
        MR_Word parse_tree__prog_event__Var_74;
        MR_Word parse_tree__prog_event__Var_75;
        MR_Word parse_tree__prog_event__Var_89;
        MR_Word parse_tree__prog_event__Var_90;
        MR_Word parse_tree__prog_event__Var_91;
        MR_Word parse_tree__prog_event__Var_92;
        MR_Word parse_tree__prog_event__Var_93;
        MR_Word parse_tree__prog_event__Var_95;
        MR_Word parse_tree__prog_event__Var_96;
        MR_Word parse_tree__prog_event__Var_97;
        MR_Integer parse_tree__prog_event__Var_104 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__OldEventSpec_29, (MR_Integer) 0)));
        MR_String parse_tree__prog_event__Var_105 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__OldEventSpec_29, (MR_Integer) 1)));
        MR_Word parse_tree__prog_event__Var_106 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__OldEventSpec_29, (MR_Integer) 3)));
        MR_Word parse_tree__prog_event__Var_107 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__OldEventSpec_29, (MR_Integer) 4)));

        {
          parse_tree__prog_event__Var_75 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_75, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_75, 1) = ((MR_Box) (parse_tree__prog_event__EventName_11));
        }
        {
          parse_tree__prog_event__Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_74, 0) = ((MR_Box) (parse_tree__prog_event__Var_75));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces1_31, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[29])));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces1_31, 1) = ((MR_Box) (parse_tree__prog_event__Var_74));
        }
        {
          parse_tree__prog_event__Var_91 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_91, 0) = ((MR_Box) (parse_tree__prog_event__FileName_7));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_91, 1) = ((MR_Box) (parse_tree__prog_event__EventLineNumber_13));
        }
        {
          parse_tree__prog_event__Var_93 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_93, 0) = ((MR_Box) (parse_tree__prog_event__Pieces1_31));
        }
        {
          parse_tree__prog_event__Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_92, 0) = ((MR_Box) (parse_tree__prog_event__Var_93));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_92, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__prog_event__Var_90 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_90, 0) = ((MR_Box) (parse_tree__prog_event__Var_91));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_90, 1) = ((MR_Box) (parse_tree__prog_event__Var_92));
        }
        {
          parse_tree__prog_event__Var_97 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_97, 0) = ((MR_Box) (parse_tree__prog_event__FileName_7));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_97, 1) = ((MR_Box) (parse_tree__prog_event__OldLineNumber_30));
        }
        {
          parse_tree__prog_event__Var_96 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_96, 0) = ((MR_Box) (parse_tree__prog_event__Var_97));
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_96, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[30])));
        }
        {
          parse_tree__prog_event__Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_95, 0) = ((MR_Box) (parse_tree__prog_event__Var_96));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          parse_tree__prog_event__Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_89, 0) = ((MR_Box) (parse_tree__prog_event__Var_90));
          MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_89, 1) = ((MR_Box) (parse_tree__prog_event__Var_95));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), parse_tree__prog_event__DuplErrorSpec_33, 2) = ((MR_Box) (parse_tree__prog_event__Var_89));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        {
          mercury__map__det_insert_4_p_0(parse_tree__prog_event__TypeCtorInfo_110_110, (MR_Word) &parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0, ((MR_Box) (parse_tree__prog_event__EventName_11)), ((MR_Box) (parse_tree__prog_event__EventSpec_28)), parse_tree__prog_event__STATE_VARIABLE_EventSpecMap_0_34, parse_tree__prog_event__STATE_VARIABLE_EventSpecMap_35);
        }
...
{
  {
    ...
    {
      parse_tree__prog_event__succeeded = parse_tree__prog_event__IntroducedFrom__pred__convert_terms_to_attrs__648__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__closure, (MR_Integer) 3))), ((MR_String) parse_tree__prog_event__wrapper_arg_1), &parse_tree__prog_event__conv4_HeadVar__3_114);
    }
    if (parse_tree__prog_event__succeeded)
      {
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__prog_event__HeadVar__6_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Integer parse_tree__prog_event__Var_95;
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    parse_tree__prog_event__Var_92 = parse_tree__prog_mode__in_mode_0_f_0();
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventAttr_36, 3) = ((MR_Box) (parse_tree__prog_event__Var_92));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word parse_tree__prog_event__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__AttrTypeTerm_33, (MR_Integer) 0)));
                  ...
                  MR_Word parse_tree__prog_event__Var_84;
                  ...
                  if (parse_tree__prog_event__succeeded)
                    {
                      ...
                      {
                        parse_tree__prog_event__Var_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 0) = ((MR_Box) (&parse_tree__prog_event_scalar_common_4[1]));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 1) = ((MR_Box) (parse_tree__prog_event__convert_terms_to_attrs_10_p_0_1));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 3) = ((MR_Box) (parse_tree__prog_event__AttrNameMap_3));
                      }
                      {
                        parse_tree__prog_event__succeeded = mercury__list__map_3_p_2(parse_tree__prog_event__TypeCtorInfo_110_110, parse_tree__prog_event__TypeCtorInfo_112_112, parse_tree__prog_event__Var_84, parse_tree__prog_event__ArgAttrNames_40, &parse_tree__prog_event__ArgAttrInfos_43);
                      }
                    }
                  if (parse_tree__prog_event__succeeded)
                    {
                      ...
                      MR_Word parse_tree__prog_event__Var_86;
                      MR_Word parse_tree__prog_event__Var_87;
                      MR_Word parse_tree__prog_event__Var_88;
                      MR_Word parse_tree__prog_event__Var_89;
                      MR_Word parse_tree__prog_event__Var_90;
                      ...
                      {
                        parse_tree__prog_event__ArgAttrNums_44 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_event__parse_tree__prog_event__type_ctor_info_attr_info_0, parse_tree__prog_event__TypeCtorInfo_118_118, (MR_Word) &parse_tree__prog_event_scalar_common_2[5], parse_tree__prog_event__ArgAttrInfos_43);
                      }
                      {
                      ...
                      {
                        parse_tree__prog_event__Var_86 = mercury__set__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110);
                      }
                      {
                        parse_tree__prog_event__Var_87 = mercury__set__init_0_f_0(parse_tree__prog_event__TypeCtorInfo_110_110);
                      }
                      {
                        parse_tree__prog_event__compute_prev_synth_attr_order_6_p_0(parse_tree__prog_event__AttrNameMap_3, parse_tree__prog_event__AttrName_31, parse_tree__prog_event__Var_86, parse_tree__prog_event__Var_87, &parse_tree__prog_event__Var_46, &parse_tree__prog_event__PrevSynthAttrOrder_47);
                      }
                      {
                        parse_tree__prog_event__Var_88 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_88, 0) = ((MR_Box) (parse_tree__prog_event__FuncAttrName_39));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_88, 1) = ((MR_Box) (parse_tree__prog_event__FuncAttrNum_42));
                      }
                      {
                        parse_tree__prog_event__SynthCall_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__SynthCall_48, 0) = ((MR_Box) (parse_tree__prog_event__Var_88));
                      ...
                      {
                        parse_tree__prog_event__Var_89 = parse_tree__prog_mode__in_mode_0_f_0();
                      }
                      {
                        parse_tree__prog_event__Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_90, 0) = ((MR_Box) (parse_tree__prog_event__SynthCall_48));
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventAttr_99, 3) = ((MR_Box) (parse_tree__prog_event__Var_89));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventAttr_99, 4) = ((MR_Box) (parse_tree__prog_event__Var_90));
                      }
                      {
                        parse_tree__prog_event__STATE_VARIABLE_RevAttrs_94_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  if (parse_tree__prog_event__succeeded)
                    {
                      ...
                      {
                        parse_tree__prog_event__Var_56 = parse_tree__prog_mode__in_mode_0_f_0();
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__EventAttr_103, 3) = ((MR_Box) (parse_tree__prog_event__Var_56));
                  ...
                  else
                    {
                      ...
                      MR_Word parse_tree__prog_event__Var_61;
                      MR_Word parse_tree__prog_event__Var_62;
                      MR_Word parse_tree__prog_event__Var_63;
                      MR_Word parse_tree__prog_event__Var_66;
                      MR_Word parse_tree__prog_event__Var_67;
                      MR_Word parse_tree__prog_event__Var_76;
                      MR_Word parse_tree__prog_event__Var_77;
                      MR_Word parse_tree__prog_event__Var_78;
                      MR_Word parse_tree__prog_event__Var_79;
                      MR_Word parse_tree__prog_event__Var_80;

                      {
                        parse_tree__prog_event__Var_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_62, 1) = ((MR_Box) (parse_tree__prog_event__EventName_1));
                      }
                      {
                        parse_tree__prog_event__Var_67 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_67, 1) = ((MR_Box) (parse_tree__prog_event__AttrName_31));
                      }
                      {
                        parse_tree__prog_event__Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_66, 0) = ((MR_Box) (parse_tree__prog_event__Var_67));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
                      }
                      {
                        parse_tree__prog_event__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[26])));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_63, 1) = ((MR_Box) (parse_tree__prog_event__Var_66));
                      }
                      {
                        parse_tree__prog_event__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_61, 0) = ((MR_Box) (parse_tree__prog_event__Var_62));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_61, 1) = ((MR_Box) (parse_tree__prog_event__Var_63));
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[19])));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_50, 1) = ((MR_Box) (parse_tree__prog_event__Var_61));
                      }
                      {
                        parse_tree__prog_event__Var_78 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_78, 0) = ((MR_Box) (parse_tree__prog_event__FileName_2));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_78, 1) = ((MR_Box) (parse_tree__prog_event__AttrLineNumber_32));
                      }
                      {
                        parse_tree__prog_event__Var_80 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_80, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_50));
                      }
                      {
                        parse_tree__prog_event__Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_79, 0) = ((MR_Box) (parse_tree__prog_event__Var_80));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_79, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        parse_tree__prog_event__Var_77 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_77, 0) = ((MR_Box) (parse_tree__prog_event__Var_78));
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_77, 1) = ((MR_Box) (parse_tree__prog_event__Var_79));
                      }
                      {
                        parse_tree__prog_event__Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_76, 0) = ((MR_Box) (parse_tree__prog_event__Var_77));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_51, 2) = ((MR_Box) (parse_tree__prog_event__Var_76));
                      }
                      {
            ...
            parse_tree__prog_event__Var_95 = (parse_tree__prog_event__AttrNum_5 + (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Integer parse_tree__prog_event__next_value_of_AttrNum_5 = parse_tree__prog_event__Var_95;
              MR_Word parse_tree__prog_event__next_value_of_HeadVar__6_6 = parse_tree__prog_event__AttrTerms_28;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_RevAttrs_0_7 = parse_tree__prog_event__STATE_VARIABLE_RevAttrs_94_94;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_9 = parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_83_83;

              parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_9 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_9;
              parse_tree__prog_event__STATE_VARIABLE_RevAttrs_0_7 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_RevAttrs_0_7;
              parse_tree__prog_event__HeadVar__6_6 = parse_tree__prog_event__next_value_of_HeadVar__6_6;
              parse_tree__prog_event__AttrNum_5 = parse_tree__prog_event__next_value_of_AttrNum_5;
            }
            continue;
          }
      }
        ...
        if (parse_tree__prog_event__succeeded)
          {
            ...
            MR_Integer parse_tree__prog_event__Var_30 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 0)));
            MR_String parse_tree__prog_event__Var_31 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 1)));
            MR_Integer parse_tree__prog_event__Var_32 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 2)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word parse_tree__prog_event__Var_25;
                  MR_Word parse_tree__prog_event__STATE_VARIABLE_AlreadyComputed_26_26;
                  MR_Word parse_tree__prog_event__Var_28;
                  MR_Word parse_tree__prog_event__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__AttrTerm_13, (MR_Integer) 0)));
                  MR_String parse_tree__prog_event__Var_38;
                  MR_Integer parse_tree__prog_event__Var_39;
                  MR_Word parse_tree__prog_event__Var_40;
                  ...
                  {
                    parse_tree__prog_event__Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_25, 0) = ((MR_Box) (parse_tree__prog_event__FuncAttrName_18));
                    MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_25, 1) = ((MR_Box) (parse_tree__prog_event__ArgAttrNames_19));
                  }
                  {
                    parse_tree__prog_event__compute_prev_synth_attr_order_for_args_6_p_0(parse_tree__prog_event__AttrNameMap_7, parse_tree__prog_event__Var_25, parse_tree__prog_event__SubAncestors_20, parse_tree__prog_event__STATE_VARIABLE_AlreadyComputed_0_23, &parse_tree__prog_event__STATE_VARIABLE_AlreadyComputed_26_26, &parse_tree__prog_event__SubPrevSynthOrder_21);
                  }
                  {
                  ...
                  parse_tree__prog_event__Var_38 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 1)));
                  parse_tree__prog_event__Var_39 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 2)));
                  parse_tree__prog_event__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_12, (MR_Integer) 3)));
                  {
                    parse_tree__prog_event__Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_28, 0) = ((MR_Box) (parse_tree__prog_event__AttrNum_22));
                    MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    *parse_tree__prog_event__PrevSynthOrder_11 = mercury__list__f_43_43_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, parse_tree__prog_event__SubPrevSynthOrder_21, parse_tree__prog_event__Var_28);
                  }
                }
                break;
              case (MR_Integer) 2:
            ...
            if (parse_tree__prog_event__succeeded)
              {
                ...
                MR_Integer parse_tree__prog_event__Var_48 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 0)));
                MR_String parse_tree__prog_event__Var_49 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 1)));
                MR_Integer parse_tree__prog_event__Var_50 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 2)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Word parse_tree__prog_event__Var_46;
                      MR_Word parse_tree__prog_event__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__prog_event__AttrTerm_33, (MR_Integer) 0)));
                      MR_String parse_tree__prog_event__Var_56;
                      MR_Integer parse_tree__prog_event__Var_57;
                      MR_Word parse_tree__prog_event__Var_58;
                      ...
                      {
                        parse_tree__prog_event__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_43, 0) = ((MR_Box) (parse_tree__prog_event__FuncAttrName_38));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_43, 1) = ((MR_Box) (parse_tree__prog_event__ArgAttrNames_39));
                      }
                      {
                        parse_tree__prog_event__compute_prev_synth_attr_order_for_args_6_p_0(parse_tree__prog_event__HeadVar__1_1, parse_tree__prog_event__Var_43, parse_tree__prog_event__SubAncestors_40, parse_tree__prog_event__STATE_VARIABLE_AlreadyComputed_0_4, &parse_tree__prog_event__STATE_VARIABLE_AlreadyComputed_26_44, &parse_tree__prog_event__SubPrevSynthOrder_41);
                      }
                      {
                      ...
                      parse_tree__prog_event__Var_56 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 1)));
                      parse_tree__prog_event__Var_57 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 2)));
                      parse_tree__prog_event__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__AttrInfo_32, (MR_Integer) 3)));
                      {
                        parse_tree__prog_event__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_46, 0) = ((MR_Box) (parse_tree__prog_event__AttrNum_42));
                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        parse_tree__prog_event__PrevSynthOrderArg_18 = mercury__list__f_43_43_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, parse_tree__prog_event__SubPrevSynthOrder_41, parse_tree__prog_event__Var_46);
                      }
                    }
                    break;
                  case (MR_Integer) 2:
...
{
  {
    ...
    MR_String parse_tree__prog_event__Var_3 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 1)));
    MR_Integer parse_tree__prog_event__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 2)));
    MR_Word parse_tree__prog_event__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__HeadVar__1_1, (MR_Integer) 3)));
...
{
  {
    ...
    {
      parse_tree__prog_event__conv2_HeadVar__3_142 = parse_tree__prog_event__IntroducedFrom__func__build_dep_map__536__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__closure, (MR_Integer) 3))), ((MR_String) parse_tree__prog_event__wrapper_arg_1));
    }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__prog_event__HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if ((parse_tree__prog_event__AttrErrorSpecs_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      ...
                      if (parse_tree__prog_event__succeeded)
                        {
                          ...
                          MR_Integer parse_tree__prog_event__Var_129;
                          MR_String parse_tree__prog_event__Var_130;
                          MR_Integer parse_tree__prog_event__Var_131;

                          {
                            parse_tree__prog_event__Var_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_64, 0) = ((MR_Box) (&parse_tree__prog_event_scalar_common_4[0]));
                            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_64, 1) = ((MR_Box) (parse_tree__prog_event__build_dep_map_11_p_0_1));
                            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_64, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                            MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_64, 3) = ((MR_Box) (parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_0_6));
                          }
                          {
                            parse_tree__prog_event__ArgTypes_46 = mercury__list__map_2_f_0(parse_tree__prog_event__TypeCtorInfo_135_135, parse_tree__prog_event__TypeCtorInfo_140_140, parse_tree__prog_event__Var_64, parse_tree__prog_event__ArgAttrNames_41);
                          }
                          {
                          ...
                          if (parse_tree__prog_event__succeeded)
                            {
                              parse_tree__prog_event__Var_129 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 0)));
                              parse_tree__prog_event__Var_130 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 1)));
                              parse_tree__prog_event__Var_131 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 2)));
                              parse_tree__prog_event__Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 3)));
                              parse_tree__prog_event__succeeded = ((MR_tag((MR_Word) parse_tree__prog_event__Var_65)) == (MR_mktag((MR_Integer) 2)));
                              if (parse_tree__prog_event__succeeded)
                                parse_tree__prog_event__FuncAttrPurity_48 = ((MR_Word) (MR_hl_field(MR_mktag(2), parse_tree__prog_event__Var_65, (MR_Integer) 0)));
                            }
                          if (parse_tree__prog_event__succeeded)
                            {
                              ...
                              if (parse_tree__prog_event__succeeded)
                                {
                                  ...
                                  if (parse_tree__prog_event__succeeded)
                                  ...
                                  else
                                    {
                                      ...
                                      MR_Word parse_tree__prog_event__Var_69;
                                      MR_Word parse_tree__prog_event__Var_70;
                                      MR_Word parse_tree__prog_event__Var_82;
                                      MR_Word parse_tree__prog_event__Var_83;
                                      MR_Word parse_tree__prog_event__Var_84;
                                      MR_Word parse_tree__prog_event__Var_85;
                                      MR_Word parse_tree__prog_event__Var_86;
                                      MR_Integer parse_tree__prog_event__Var_132 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 0)));
                                      MR_String parse_tree__prog_event__Var_133 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 1)));
                                      MR_Word parse_tree__prog_event__Var_134 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__FuncAttrInfo_47, (MR_Integer) 3)));

                                      {
                                        parse_tree__prog_event__Var_70 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_70, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                                        MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_70, 1) = ((MR_Box) (parse_tree__prog_event__FuncAttrName_40));
                                      }
                                      {
                                        parse_tree__prog_event__Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_69, 0) = ((MR_Box) (parse_tree__prog_event__Var_70));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[16])));
                                      }
                                      {
                                        ...
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[21])));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_53, 1) = ((MR_Box) (parse_tree__prog_event__Var_69));
                                      }
                                      {
                                        parse_tree__prog_event__Var_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 0) = ((MR_Box) (parse_tree__prog_event__FileName_2));
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_84, 1) = ((MR_Box) (parse_tree__prog_event__FuncAttrLineNumber_52));
                                      }
                                      {
                                        parse_tree__prog_event__Var_86 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_86, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_53));
                                      }
                                      {
                                        parse_tree__prog_event__Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_85, 0) = ((MR_Box) (parse_tree__prog_event__Var_86));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                      }
                                      {
                                        parse_tree__prog_event__Var_83 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_83, 0) = ((MR_Box) (parse_tree__prog_event__Var_84));
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_83, 1) = ((MR_Box) (parse_tree__prog_event__Var_85));
                                      }
                                      {
                                        parse_tree__prog_event__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_82, 0) = ((MR_Box) (parse_tree__prog_event__Var_83));
                                        MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                                      }
                                      {
                                        ...
                                        MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_54, 2) = ((MR_Box) (parse_tree__prog_event__Var_82));
                                      }
                                      {
                            ...
                            {
                              MR_Word parse_tree__prog_event__Var_93;
                              MR_Word parse_tree__prog_event__Var_94;
                              MR_Word parse_tree__prog_event__Var_95;
                              MR_Word parse_tree__prog_event__Var_98;
                              MR_Word parse_tree__prog_event__Var_101;
                              MR_Word parse_tree__prog_event__Var_102;
                              MR_Word parse_tree__prog_event__Var_111;
                              MR_Word parse_tree__prog_event__Var_112;
                              MR_Word parse_tree__prog_event__Var_113;
                              MR_Word parse_tree__prog_event__Var_114;
                              MR_Word parse_tree__prog_event__Var_115;
                              MR_Word parse_tree__prog_event__Pieces_125;
                              MR_Word parse_tree__prog_event__ErrorSpec_126;

                              {
                                parse_tree__prog_event__Var_94 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_94, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_94, 1) = ((MR_Box) (parse_tree__prog_event__AttrName_34));
                              }
                              {
                                parse_tree__prog_event__Var_102 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_102, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                                MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_102, 1) = ((MR_Box) (parse_tree__prog_event__FuncAttrName_40));
                              }
                              {
                                parse_tree__prog_event__Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_101, 0) = ((MR_Box) (parse_tree__prog_event__Var_102));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
                              }
                              {
                                parse_tree__prog_event__Var_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_98, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[25])));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_98, 1) = ((MR_Box) (parse_tree__prog_event__Var_101));
                              }
                              {
                                parse_tree__prog_event__Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_95, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[24])));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_95, 1) = ((MR_Box) (parse_tree__prog_event__Var_98));
                              }
                              {
                                parse_tree__prog_event__Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_93, 0) = ((MR_Box) (parse_tree__prog_event__Var_94));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_93, 1) = ((MR_Box) (parse_tree__prog_event__Var_95));
                              }
                              {
                                ...
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[21])));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_125, 1) = ((MR_Box) (parse_tree__prog_event__Var_93));
                              }
                              {
                                parse_tree__prog_event__Var_113 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_113, 0) = ((MR_Box) (parse_tree__prog_event__FileName_2));
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_113, 1) = ((MR_Box) (parse_tree__prog_event__AttrLineNumber_35));
                              }
                              {
                                parse_tree__prog_event__Var_115 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_115, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_125));
                              }
                              {
                                parse_tree__prog_event__Var_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_114, 0) = ((MR_Box) (parse_tree__prog_event__Var_115));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_114, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                              }
                              {
                                parse_tree__prog_event__Var_112 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_112, 0) = ((MR_Box) (parse_tree__prog_event__Var_113));
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_112, 1) = ((MR_Box) (parse_tree__prog_event__Var_114));
                              }
                              {
                                parse_tree__prog_event__Var_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_111, 0) = ((MR_Box) (parse_tree__prog_event__Var_112));
                                MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_111, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                              }
                              {
                                ...
                                MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_126, 2) = ((MR_Box) (parse_tree__prog_event__Var_111));
                              }
                              {
                                parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_121_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    {
                      MR_Word parse_tree__prog_event__Var_119;

                      {
                        parse_tree__prog_event__Var_119 = parse_tree__builtin_lib_types__void_type_0_f_0();
                      }
                      {
                        mercury__map__det_insert_4_p_0(parse_tree__prog_event__TypeCtorInfo_135_135, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ((MR_Box) (parse_tree__prog_event__FuncAttrName_40)), ((MR_Box) (parse_tree__prog_event__Var_119)), parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_0_6, &parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_120_120);
                      }
                      {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word parse_tree__prog_event__next_value_of_HeadVar__5_5 = parse_tree__prog_event__AttrTerms_30;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrTypeMap_0_6 = parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_120_120;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_8 = parse_tree__prog_event__STATE_VARIABLE_DepRel_62_62;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_10 = parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_121_121;

              parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_10 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_10;
              parse_tree__prog_event__STATE_VARIABLE_DepRel_0_8 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_8;
              parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_0_6 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrTypeMap_0_6;
              parse_tree__prog_event__HeadVar__5_5 = parse_tree__prog_event__next_value_of_HeadVar__5_5;
            }
            continue;
          }
      }
        ...
        else
          {
            ...
            if (parse_tree__prog_event__succeeded)
            ...
            else
              {
                ...
                MR_Word parse_tree__prog_event__Var_44;
                MR_Word parse_tree__prog_event__Var_45;
                MR_Word parse_tree__prog_event__Var_46;
                MR_Word parse_tree__prog_event__Var_49;
                MR_Word parse_tree__prog_event__Var_50;
                MR_Word parse_tree__prog_event__Var_51;
                MR_Word parse_tree__prog_event__Var_54;
                MR_Word parse_tree__prog_event__Var_55;
                MR_Word parse_tree__prog_event__Var_64;
                ...
                {
                  parse_tree__prog_event__Var_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_45, 1) = ((MR_Box) (parse_tree__prog_event__SynthAttrName_5));
                }
                {
                  parse_tree__prog_event__Var_50 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_50, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_50, 1) = ((MR_Box) (parse_tree__prog_event__EventName_1));
                }
                {
                  parse_tree__prog_event__Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_55, 1) = ((MR_Box) (parse_tree__prog_event__AttrName_30));
                }
                {
                  parse_tree__prog_event__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_54, 0) = ((MR_Box) (parse_tree__prog_event__Var_55));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[18])));
                }
                {
                  parse_tree__prog_event__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[23])));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_51, 1) = ((MR_Box) (parse_tree__prog_event__Var_54));
                }
                {
                  parse_tree__prog_event__Var_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_49, 0) = ((MR_Box) (parse_tree__prog_event__Var_50));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_49, 1) = ((MR_Box) (parse_tree__prog_event__Var_51));
                }
                {
                  parse_tree__prog_event__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[22])));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_46, 1) = ((MR_Box) (parse_tree__prog_event__Var_49));
                }
                {
                  parse_tree__prog_event__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_44, 0) = ((MR_Box) (parse_tree__prog_event__Var_45));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_44, 1) = ((MR_Box) (parse_tree__prog_event__Var_46));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[21])));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_35, 1) = ((MR_Box) (parse_tree__prog_event__Var_44));
                }
                {
                  parse_tree__prog_event__Var_66 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_66, 0) = ((MR_Box) (parse_tree__prog_event__FileName_2));
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_66, 1) = ((MR_Box) (parse_tree__prog_event__AttrLineNumber_3));
                }
                {
                  parse_tree__prog_event__Var_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_68, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_35));
                }
                {
                  parse_tree__prog_event__Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_67, 0) = ((MR_Box) (parse_tree__prog_event__Var_68));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_36, 2) = ((MR_Box) (parse_tree__prog_event__Var_64));
                }
                {
                  parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_71_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            /* direct tailcall eliminated */
            {
              MR_Word parse_tree__prog_event__next_value_of_HeadVar__7_7 = parse_tree__prog_event__AttrNames_31;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_8 = parse_tree__prog_event__STATE_VARIABLE_DepRel_41_41;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_10 = parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_71_71;

              parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_10 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_10;
              parse_tree__prog_event__STATE_VARIABLE_DepRel_0_8 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_8;
              parse_tree__prog_event__HeadVar__7_7 = parse_tree__prog_event__next_value_of_HeadVar__7_7;
            }
            continue;
          }
      }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((parse_tree__prog_event__HeadVar__4_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Integer parse_tree__prog_event__Var_107;
            ...
            if (parse_tree__prog_event__succeeded)
            ...
            else
              {
                ...
                MR_Word parse_tree__prog_event__Var_97;
                MR_Word parse_tree__prog_event__Var_98;
                MR_Word parse_tree__prog_event__Var_99;
                MR_Word parse_tree__prog_event__Var_100;
                MR_Word parse_tree__prog_event__Var_101;

                {
                  parse_tree__prog_event__Var_83 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_83, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_83, 1) = ((MR_Box) (parse_tree__prog_event__EventName_1));
                }
                {
                  parse_tree__prog_event__Var_88 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_88, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), parse_tree__prog_event__Var_88, 1) = ((MR_Box) (parse_tree__prog_event__AttrName_52));
                }
                {
                  parse_tree__prog_event__Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_87, 0) = ((MR_Box) (parse_tree__prog_event__Var_88));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__prog_event_scalar_common_1[10])));
                }
                {
                  parse_tree__prog_event__Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_84, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[20])));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_84, 1) = ((MR_Box) (parse_tree__prog_event__Var_87));
                }
                {
                  parse_tree__prog_event__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_82, 0) = ((MR_Box) (parse_tree__prog_event__Var_83));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_82, 1) = ((MR_Box) (parse_tree__prog_event__Var_84));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__prog_event_scalar_common_1[19])));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Pieces_57, 1) = ((MR_Box) (parse_tree__prog_event__Var_82));
                }
                {
                  parse_tree__prog_event__Var_99 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_99, 0) = ((MR_Box) (parse_tree__prog_event__FileName_2));
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_99, 1) = ((MR_Box) (parse_tree__prog_event__EventLineNumber_3));
                }
                {
                  parse_tree__prog_event__Var_101 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_101, 0) = ((MR_Box) (parse_tree__prog_event__Pieces_57));
                }
                {
                  parse_tree__prog_event__Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_100, 0) = ((MR_Box) (parse_tree__prog_event__Var_101));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_100, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  parse_tree__prog_event__Var_98 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_98, 0) = ((MR_Box) (parse_tree__prog_event__Var_99));
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_98, 1) = ((MR_Box) (parse_tree__prog_event__Var_100));
                }
                {
                  parse_tree__prog_event__Var_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_97, 0) = ((MR_Box) (parse_tree__prog_event__Var_98));
                  MR_hl_field(MR_mktag(1), parse_tree__prog_event__Var_97, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), parse_tree__prog_event__ErrorSpec_58, 2) = ((MR_Box) (parse_tree__prog_event__Var_97));
                }
                {
            ...
            parse_tree__prog_event__Var_107 = (parse_tree__prog_event__AttrNum_5 + (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Word parse_tree__prog_event__next_value_of_HeadVar__4_4 = parse_tree__prog_event__AttrTerms_44;
              MR_Integer parse_tree__prog_event__next_value_of_AttrNum_5 = parse_tree__prog_event__Var_107;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrNumMap_0_6 = parse_tree__prog_event__STATE_VARIABLE_AttrNumMap_76_76;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrNameMap_0_8 = parse_tree__prog_event__STATE_VARIABLE_AttrNameMap_79_79;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrTypeMap_0_10 = parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_106_106;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_KeyMap_0_12 = parse_tree__prog_event__STATE_VARIABLE_KeyMap_105_105;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_14 = parse_tree__prog_event__STATE_VARIABLE_DepRel_77_77;
              MR_Word parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_16 = parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_104_104;

              parse_tree__prog_event__STATE_VARIABLE_ErrorSpecs_0_16 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_ErrorSpecs_0_16;
              parse_tree__prog_event__STATE_VARIABLE_DepRel_0_14 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_DepRel_0_14;
              parse_tree__prog_event__STATE_VARIABLE_KeyMap_0_12 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_KeyMap_0_12;
              parse_tree__prog_event__STATE_VARIABLE_AttrTypeMap_0_10 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrTypeMap_0_10;
              parse_tree__prog_event__STATE_VARIABLE_AttrNameMap_0_8 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrNameMap_0_8;
              parse_tree__prog_event__STATE_VARIABLE_AttrNumMap_0_6 = parse_tree__prog_event__next_value_of_STATE_VARIABLE_AttrNumMap_0_6;
              parse_tree__prog_event__AttrNum_5 = parse_tree__prog_event__next_value_of_AttrNum_5;
              parse_tree__prog_event__HeadVar__4_4 = parse_tree__prog_event__next_value_of_HeadVar__4_4;
            }
            continue;
          }
      }
...
{
  {
    ...
    if (parse_tree__prog_event__succeeded)
      {
        parse_tree__prog_event__succeeded = parse_tree__prog_data__builtin_type_to_string_2_p_1(&parse_tree__prog_event__BuiltinType_7, parse_tree__prog_event__Name_5);
      }
    if (parse_tree__prog_event__succeeded)
      {
    ...
    if ((parse_tree__prog_event__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *parse_tree__prog_event__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        MR_Word parse_tree__prog_event__Var_18;
        MR_Box parse_tree__prog_event__conv0_Var_18;
        MR_String parse_tree__prog_event__Var_11;
        MR_Integer parse_tree__prog_event__Var_12;
        ...
        {
          mercury__map__lookup_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &parse_tree__prog_event__parse_tree__prog_event__type_ctor_info_attr_info_0, parse_tree__prog_event__AttrMap_1, ((MR_Box) (parse_tree__prog_event__AttrName_6)), &parse_tree__prog_event__conv0_Var_18);
        }
        parse_tree__prog_event__Var_18 = ((MR_Word) parse_tree__prog_event__conv0_Var_18);
        parse_tree__prog_event__AttrNum_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_18, (MR_Integer) 0)));
        parse_tree__prog_event__Var_11 = ((MR_String) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_18, (MR_Integer) 1)));
        parse_tree__prog_event__Var_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_18, (MR_Integer) 2)));
        parse_tree__prog_event__AttrType_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_event__Var_18, (MR_Integer) 3)));
