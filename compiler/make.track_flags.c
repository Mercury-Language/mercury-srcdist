  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  make__dependencies__find_reachable_local_modules_9_p_0(ProgressStream_11, Globals_12, ModuleName_13, &Succeeded0_17, &ModuleNames_18, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_25_25);
  ...
  MR_Word * STATE_VARIABLE_Info_34)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word OptionsErrors_51;
      MR_Word AllOptionArgsGlobals_52;
      MR_Word OptionTable_53;
      MR_Word OptionList_54;
      MR_Word InconsequentialOptions_55;
      MR_Word InconsequentialOptionsSet_56;
      MR_Word HashOptionList_57;
      MR_Word OptTuple_58;
      MR_Word Var_61;
      MR_String Var_62;
      MR_Tuple Var_63;
      ...
      libs__handle_options__handle_given_options_9_p_0(ProgressStream_13, DefaultOptionTable_27, AllOptionArgs_24, &Var_49, &Var_50, &OptionsErrors_51, &AllOptionArgsGlobals_52);
      if (!((OptionsErrors_51 == (MR_Word) ((MR_Unsigned) 0U))))
        {
      ...
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_52, &OptionTable_53);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_53, &OptionList_54);
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_55);
      InconsequentialOptionsSet_56 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_55);
      {
        Var_61 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_61, 0) = ((MR_Box) (&make__track_flags_scalar_common_4[0]));
        MR_hl_field(0, Var_61, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_11_p_0_1));
        MR_hl_field(0, Var_61, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_61, 3) = ((MR_Box) (InconsequentialOptionsSet_56));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_61, OptionList_54, &HashOptionList_57);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_52, &OptTuple_58);
      {
        Var_63 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_63, 0) = ((MR_Box) (HashOptionList_57));
        MR_hl_field(0, Var_63, 1) = ((MR_Box) (OptTuple_58));
      }
      Var_62 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_63)));
      Hash_26 = libs__md5__md5sum_1_f_0(Var_62);
      {
        MR_Word base;
    ...
    mercury__io__open_input_4_p_0(HashFileName_28, &OpenResult_68);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 72, &Verbose_74);
    if (((MR_tag((MR_Word) OpenResult_68)) == (MR_Integer) 1))
    {
      switch (Verbose_74) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
    ...
    {
      MR_Word Stream_69 = ((MR_Word) ((MR_hl_field(0, OpenResult_68, (MR_Integer) 0))));
      MR_Word ReadResult_70;

      mercury__io__read_line_as_string_4_p_0(Stream_69, &ReadResult_70);
      mercury__io__close_input_3_p_0(Stream_69);
      switch (MR_tag((MR_Word) ReadResult_70)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            switch (Verbose_74) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Line_71 = ((MR_String) ((MR_hl_field(1, ReadResult_70, (MR_Integer) 0))));

            succeeded = (strcmp(Line_71, Hash_26) == 0);
            if (succeeded)
            {
              switch (Verbose_74) {
                default: /*NOTREACHED*/ MR_assert(0);
