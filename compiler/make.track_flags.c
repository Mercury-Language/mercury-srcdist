...
static const MR_PseudoTypeInfo make__track_flags__make__track_flags__field_types_last_hash_0_0[3];

static const MR_ConstString make__track_flags__make__track_flags__field_names_last_hash_0_0[3];
...
make__track_flags__make_track_flags_files_for_module_11_p_0(
  ...
  MR_Word STATE_VARIABLE_LastHash_0_35,
  MR_Word * STATE_VARIABLE_LastHash_36,
...
static /* final */ const MR_Box make__track_flags_scalar_common_1[3][3];
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[1]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_1[1]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    if (succeeded)
    {
      TypeInfo_12_12 = (MR_Word) (&make__track_flags_scalar_common_2[1]);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_31 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ModuleNames_18);
        make__track_flags__foldl3_make_track_flags_for_modules_loop_11_p_0(ErrorStream_10, ProgressStream_11, Globals_12, Var_31, Succeeded_14, (MR_Word) (&make__track_flags_scalar_common_1[2]), &_LastHash_20, STATE_VARIABLE_Info_25_25, STATE_VARIABLE_Info_22);
      }
      break;
  }
}
...
{
  MR_bool succeeded;
  MR_Word EnvOptFileVariables_20;
  MR_Word MaybeModuleOptionArgs_21;
  MR_Word MaybeStdLibDirs_22;

  EnvOptFileVariables_20 = make__make_info__make_info_get_env_optfile_variables_1_f_0(STATE_VARIABLE_Info_0_37);
  make__options_file__lookup_mmc_module_options_3_p_0(EnvOptFileVariables_20, ModuleName_15, &MaybeModuleOptionArgs_21);
  make__options_file__lookup_mercury_stdlib_dir_2_p_0(EnvOptFileVariables_20, &MaybeStdLibDirs_22);
  if (((MR_tag((MR_Word) MaybeModuleOptionArgs_21)) == (MR_Integer) 0))
  {
    MR_Word LookupSpecs_34 = ((MR_Word) ((MR_hl_field(0, MaybeModuleOptionArgs_21, (MR_Integer) 0))));

    parse_tree__write_error_spec__write_error_specs_5_p_0(ErrorStream_12, Globals_14, LookupSpecs_34);
    *Succeeded_16 = (MR_Integer) 0;
    *STATE_VARIABLE_LastHash_36 = STATE_VARIABLE_LastHash_0_35;
  }
  else
  {
    MR_Word ModuleOptionArgs_23 = ((MR_Word) ((MR_hl_field(1, MaybeModuleOptionArgs_21, (MR_Integer) 0))));
    MR_Word DetectedGradeFlags_24;
    MR_Word EnvVarArgs_25;
    MR_Word OptionArgs_26;
    MR_Word AllOptionArgs_27;
    MR_String Hash_29;
    MR_String HashFileName_31;
    MR_Word Var_41;
    MR_Word Var_42;
    MR_Word OpenResult_74;
    MR_Word Verbose_80;
    MR_String HashPrime_28;
    MR_Word TypeInfo_54_54;
    MR_Word Var_51;
    MR_Word Var_52;
    MR_String _HashFileNameProposed_32;

    DetectedGradeFlags_24 = make__make_info__make_info_get_detected_grade_flags_1_f_0(STATE_VARIABLE_Info_0_37);
    EnvVarArgs_25 = make__make_info__make_info_get_env_var_args_1_f_0(STATE_VARIABLE_Info_0_37);
    OptionArgs_26 = make__make_info__make_info_get_option_args_1_f_0(STATE_VARIABLE_Info_0_37);
    Var_42 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), EnvVarArgs_25, OptionArgs_26);
    Var_41 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_23, Var_42);
    AllOptionArgs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DetectedGradeFlags_24, Var_41);
    Var_51 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, (MR_Integer) 0))));
    Var_52 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, (MR_Integer) 1))));
    HashPrime_28 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, (MR_Integer) 2))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_1[1]), ((MR_Box) (MaybeStdLibDirs_22)), ((MR_Box) (Var_51)));
    if (succeeded)
    {
      TypeInfo_54_54 = (MR_Word) (&make__track_flags_scalar_common_2[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_54_54, ((MR_Box) (AllOptionArgs_27)), ((MR_Box) (Var_52)));
    }
    if (succeeded)
    {
      Hash_29 = HashPrime_28;
      *STATE_VARIABLE_LastHash_36 = STATE_VARIABLE_LastHash_0_35;
    }
    else
    {
      MR_Word DefaultOptionTable_30;
      MR_Word OptionsErrors_57;
      MR_Word AllOptionArgsGlobals_58;
      MR_Word OptionTable_59;
      MR_Word OptionList_60;
      MR_Word InconsequentialOptions_61;
      MR_Word InconsequentialOptionsSet_62;
      MR_Word HashOptionList_63;
      MR_Word OptTuple_64;
      MR_Word Var_67;
      MR_String Var_68;
      MR_Tuple Var_69;
      ...
      libs__handle_options__handle_given_options_10_p_0(ProgressStream_13, DefaultOptionTable_30, MaybeStdLibDirs_22, AllOptionArgs_27, &Var_55, &Var_56, &OptionsErrors_57, &AllOptionArgsGlobals_58);
      if (!((OptionsErrors_57 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          mercury__require__unexpected_2_p_0((MR_String) "make.track_flags.m", (MR_String) "predicate \140make.track_flags.option_table_hash\'/7: handle_options returned with errors");
          return;
        }
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_58, &OptionTable_59);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_59, &OptionList_60);
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_61);
      InconsequentialOptionsSet_62 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_61);
      {
        Var_67 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_67, 0) = ((MR_Box) (&make__track_flags_scalar_common_5[0]));
        MR_hl_field(0, Var_67, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_11_p_0_1));
        MR_hl_field(0, Var_67, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_67, 3) = ((MR_Box) (InconsequentialOptionsSet_62));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_67, OptionList_60, &HashOptionList_63);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_58, &OptTuple_64);
      {
        Var_69 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_69, 0) = ((MR_Box) (HashOptionList_63));
        MR_hl_field(0, Var_69, 1) = ((MR_Box) (OptTuple_64));
      }
      Var_68 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_69)));
      Hash_29 = libs__md5__md5sum_1_f_0(Var_68);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_LastHash_36 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (MaybeStdLibDirs_22));
        MR_hl_field(0, base, 1) = ((MR_Box) (AllOptionArgs_27));
        MR_hl_field(0, base, 2) = ((MR_Box) (Hash_29));
      }
    }
    parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_14, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/11", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_15, &HashFileName_31, &_HashFileNameProposed_32);
    mercury__io__open_input_4_p_0(HashFileName_31, &OpenResult_74);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 76, &Verbose_80);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_4_p_0(ProgressStream_13, HashFileName_31);
            mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) " will be UPDATED.\n");
          }
          break;
      }
      make__track_flags__write_hash_file_6_p_0(ProgressStream_13, HashFileName_31, Hash_29, Succeeded_16);
    }
    else
    {
      MR_Word Stream_75 = ((MR_Word) ((MR_hl_field(0, OpenResult_74, (MR_Integer) 0))));
      MR_Word ReadResult_76;

      mercury__io__read_line_as_string_4_p_0(Stream_75, &ReadResult_76);
      mercury__io__close_input_3_p_0(Stream_75);
      switch (MR_tag((MR_Word) ReadResult_76)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            switch (Verbose_80) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Line_77 = ((MR_String) ((MR_hl_field(1, ReadResult_76, (MR_Integer) 0))));

            succeeded = (strcmp(Line_77, Hash_29) == 0);
            if (succeeded)
            {
              switch (Verbose_80) {
                default: /*NOTREACHED*/ MR_assert(0);
