...
static const MR_FA_TypeInfo_Struct1 make__track_flags__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0;

static const MR_FA_TypeInfo_Struct2 make__track_flags__parse_tree__maybe_error__ti_maybe1_2list__ti_list_1builtin__type_ctor_info_string_0list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
make__track_flags__make_track_flags_files_for_module_10_p_0(
  ...
  MR_Word STATE_VARIABLE_LastHash_0_36,
  MR_Word * STATE_VARIABLE_LastHash_37);
...
static /* final */ const MR_Box make__track_flags_scalar_common_1[4][2];

static /* final */ const MR_Box make__track_flags_scalar_common_2[2][3];
...
static /* final */ const MR_Box make__track_flags_scalar_common_2[2][3] = {
  ...
  /* row   1 */
  {
    ...
    ((MR_Box) (&make__track_flags_scalar_common_1[2]))
  },
};
...
static /* final */ const MR_Box make__track_flags_scalar_common_3[2][4] = {
  /* row   0 */
  {
    ...
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&make__track_flags_scalar_common_1[1])),
...
static const MR_FA_TypeInfo_Struct2 make__track_flags__parse_tree__maybe_error__ti_maybe1_2list__ti_list_1builtin__type_ctor_info_string_0list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0 = {
  &parse_tree__maybe_error__parse_tree__maybe_error__type_ctor_info_maybe1_2,
  {
    ...
    (MR_TypeInfo) (&make__track_flags__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0)
  }
};

static const MR_PseudoTypeInfo make__track_flags__make__track_flags__field_types_last_hash_0_0[4] = {
  (MR_PseudoTypeInfo) (&libs__globals__libs__globals__type_ctor_info_maybe_stdlib_grades_0),
  (MR_PseudoTypeInfo) (&make__track_flags__parse_tree__maybe_error__ti_maybe1_2list__ti_list_1builtin__type_ctor_info_string_0list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo_14_14 = (MR_Word) (&make__track_flags_scalar_common_2[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_14_14, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo_15_15 = (MR_Word) (&make__track_flags_scalar_common_1[0]);
  ...
  MR_Word * STATE_VARIABLE_LastHash_37)
{
  ...
  MR_Word EnvVarArgs_21;
  MR_Word OptionArgs_22;
  MR_Word MaybeModuleOptionArgs_23;

  Params_19 = make__make_info__make_info_get_compiler_params_1_f_0(Info_14);
  EnvOptFileVariables_20 = ((MR_Word) ((MR_hl_field(0, Params_19, 0))));
  EnvVarArgs_21 = ((MR_Word) ((MR_hl_field(0, Params_19, 1))));
  OptionArgs_22 = ((MR_Word) ((MR_hl_field(0, Params_19, 2))));
  ...
  {
    MR_Word LookupSpecs_35 = ((MR_Word) ((MR_hl_field(0, MaybeModuleOptionArgs_23, 0))));

    parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(ErrorStream_11, Globals_13, LookupSpecs_35);
    *Succeeded_16 = (MR_Integer) 0;
    *STATE_VARIABLE_LastHash_37 = STATE_VARIABLE_LastHash_0_36;
  }
  else
  {
    MR_Word ModuleOptionArgs_24 = ((MR_Word) ((MR_hl_field(1, MaybeModuleOptionArgs_23, 0))));
    MR_Word MaybeStdLibGrades_25;
    MR_Word MaybeStdLibDirs0_26;
    MR_Word AllOptionArgs_27;
    MR_Word MaybeStdLibDirs_28;
    MR_String Hash_30;
    MR_String HashFileName_32;
    MR_Word Var_40;
    MR_Word OpenResult_75;
    MR_Word Verbose_81;
    MR_String HashPrime_29;
    MR_Word TypeInfo_54_54;
    MR_Word TypeInfo_55_55;
    MR_Word Var_50;
    MR_Word Var_51;
    MR_Word Var_52;
    MR_String _HashFileNameProposed_33;

    MaybeStdLibGrades_25 = make__make_info__make_info_get_maybe_stdlib_grades_1_f_0(Info_14);
    make__options_file__lookup_mercury_stdlib_dir_2_p_0(EnvOptFileVariables_20, &MaybeStdLibDirs0_26);
    Var_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), EnvVarArgs_21, OptionArgs_22);
    AllOptionArgs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_24, Var_40);
    parse_tree__maybe_error__maybe1_to_maybe1el_2_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), MaybeStdLibDirs0_26, &MaybeStdLibDirs_28);
    Var_50 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_36, 0))));
    Var_51 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_36, 1))));
    Var_52 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_36, 2))));
    HashPrime_29 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_36, 3))));
    succeeded = libs__globals____Unify____maybe_stdlib_grades_0_0(MaybeStdLibGrades_25, Var_50);
    if (succeeded)
    {
      TypeInfo_54_54 = (MR_Word) (&make__track_flags_scalar_common_2[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_54_54, ((MR_Box) (MaybeStdLibDirs_28)), ((MR_Box) (Var_51)));
      if (succeeded)
      {
        TypeInfo_55_55 = (MR_Word) (&make__track_flags_scalar_common_1[0]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_55_55, ((MR_Box) (AllOptionArgs_27)), ((MR_Box) (Var_52)));
      }
    }
    if (succeeded)
    {
      Hash_30 = HashPrime_29;
      *STATE_VARIABLE_LastHash_37 = STATE_VARIABLE_LastHash_0_36;
    }
    else
    {
      MR_Word DefaultOptionTable_31;
      MR_Word OptionsErrors_58;
      MR_Word AllOptionArgsGlobals_59;
      MR_Word OptionTable_60;
      MR_Word OptionList_61;
      MR_Word DoNotTrackOptions_62;
      ...
      libs__globals__get_default_options_2_p_0(Globals_13, &DefaultOptionTable_31);
      libs__handle_options__handle_given_options_11_p_0(ProgressStream_12, DefaultOptionTable_31, MaybeStdLibGrades_25, MaybeStdLibDirs_28, AllOptionArgs_27, &Var_56, &Var_57, &OptionsErrors_58, &AllOptionArgsGlobals_59);
      if (!((OptionsErrors_58 == (MR_Word) ((MR_Unsigned) 0U))))
        {
      ...
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_59, &OptionTable_60);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_60, &OptionList_61);
      Var_67 = libs__options__options_not_to_track_0_f_0();
      DoNotTrackOptions_62 = mercury__set_tree234__list_to_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), Var_67);
      {
        Var_68 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_68, 0) = ((MR_Box) (&make__track_flags_scalar_common_5[0]));
        MR_hl_field(0, Var_68, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_10_p_0_1));
        MR_hl_field(0, Var_68, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_68, 3) = ((MR_Box) (DoNotTrackOptions_62));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_2[0]), Var_68, OptionList_61, &HashOptionList_63);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_59, &OptTuple_64);
      {
        Var_70 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_70, 0) = ((MR_Box) (HashOptionList_63));
        MR_hl_field(0, Var_70, 1) = ((MR_Box) (OptTuple_64));
      }
      Var_69 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_70)));
      Hash_30 = libs__md5__md5sum_1_f_0(Var_69);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_LastHash_37 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (MaybeStdLibGrades_25));
        MR_hl_field(0, base, 1) = ((MR_Box) (MaybeStdLibDirs_28));
        MR_hl_field(0, base, 2) = ((MR_Box) (AllOptionArgs_27));
        MR_hl_field(0, base, 3) = ((MR_Box) (Hash_30));
      }
    }
    parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_13, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/10", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_1[3])), ModuleName_15, &HashFileName_32, &_HashFileNameProposed_33);
    mercury__io__open_input_4_p_0(HashFileName_32, &OpenResult_75);
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 131, &Verbose_81);
    if (((MR_tag((MR_Word) OpenResult_75)) == (MR_Integer) 1))
    {
      switch (Verbose_81) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_4_p_0(ProgressStream_12, HashFileName_32);
            mercury__io__write_string_4_p_0(ProgressStream_12, (MR_String) " will be UPDATED.\n");
          }
          break;
      }
      make__track_flags__write_hash_file_6_p_0(ProgressStream_12, HashFileName_32, Hash_30, Succeeded_16);
    }
    else
    {
      MR_Word Stream_76 = ((MR_Word) ((MR_hl_field(0, OpenResult_75, 0))));
      MR_Word ReadResult_77;

      mercury__io__read_line_as_string_4_p_0(Stream_76, &ReadResult_77);
      mercury__io__close_input_3_p_0(Stream_76);
      switch (MR_tag((MR_Word) ReadResult_77)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            switch (Verbose_81) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Line_78 = ((MR_String) ((MR_hl_field(1, ReadResult_77, 0))));

            succeeded = (strcmp(Line_78, Hash_30) == 0);
            if (succeeded)
            {
              switch (Verbose_81) {
                default: /*NOTREACHED*/ MR_assert(0);
