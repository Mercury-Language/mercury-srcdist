  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  {
    MR_bool succeeded;
    MR_Word ModuleOptionArgs_16;
    MR_Word LookupSpecs_17;
    MR_Word LookupErrors_18;
    MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_28, (MR_Integer) 5))));

    make__options_file__lookup_mmc_module_options_4_p_0(Var_32, ModuleName_11, &ModuleOptionArgs_16, &LookupSpecs_17);
    parse_tree__error_util__write_error_specs_ignore_4_p_0(Globals_10, LookupSpecs_17);
    LookupErrors_18 = parse_tree__error_util__contains_errors_2_f_0(Globals_10, LookupSpecs_17);
    switch (LookupErrors_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word DetectedGradeFlags_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_28, (MR_Integer) 3))));
          MR_Word OptionArgs_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_28, (MR_Integer) 4))));
          MR_Word AllOptionArgs_21;
          MR_String Hash_23;
          MR_String HashFileName_24;
          MR_Word Same_25;
          MR_Word Var_34;
          MR_String HashPrime_22;
          MR_Word Var_106;

          Var_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_16, OptionArgs_20);
          AllOptionArgs_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DetectedGradeFlags_19, Var_34);
          Var_106 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
          HashPrime_22 = ((MR_String) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_LastHash_0_26, (MR_Integer) 1))));
          succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_21)), ((MR_Box) (Var_106)));
          if (succeeded)
          {
            Hash_23 = HashPrime_22;
            *STATE_VARIABLE_LastHash_27 = STATE_VARIABLE_LastHash_0_26;
          }
          else
          {
            make__track_flags__option_table_hash_4_p_0(AllOptionArgs_21, &Hash_23);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_LastHash_27 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (AllOptionArgs_21));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Hash_23));
            }
          }
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_2\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make__track_flags_scalar_common_4[0])), ModuleName_11, &HashFileName_24);
          make__track_flags__compare_hash_file_6_p_0(Globals_10, HashFileName_24, Hash_23, &Same_25);
          switch (Same_25) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              make__track_flags__write_hash_file_5_p_0(HashFileName_24, Hash_23, Succeeded_12);
              break;
            case (MR_Integer) 1:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 70, &Verbose_18);
    switch (Verbose_18) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
