...
make__track_flags__make_track_flags_files_for_module_11_p_0(
  ...
  MR_Word STATE_VARIABLE_LastHash_0_31,
  MR_Word * STATE_VARIABLE_LastHash_32,
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  make__dependencies__find_reachable_local_modules_8_p_0(Globals_12, ModuleName_13, &Succeeded0_17, &ModuleNames_18, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_25_25);
  ...
  MR_Word * STATE_VARIABLE_Info_34)
{
  ...
  Var_37 = make__make_info__make_info_get_options_variables_1_f_0(STATE_VARIABLE_Info_0_33);
  make__options_file__lookup_mmc_module_options_3_p_0(Var_37, ModuleName_15, &MaybeModuleOptionArgs_20);
  if (((MR_tag((MR_Word) MaybeModuleOptionArgs_20)) == (MR_Integer) 0))
  {
    MR_Word LookupSpecs_30 = ((MR_Word) ((MR_hl_field(0, MaybeModuleOptionArgs_20, (MR_Integer) 0))));

    parse_tree__write_error_spec__write_error_specs_5_p_0(ErrorStream_12, Globals_14, LookupSpecs_30);
    *Succeeded_16 = (MR_Integer) 0;
    *STATE_VARIABLE_LastHash_32 = STATE_VARIABLE_LastHash_0_31;
  }
  else
  {
    ...
    MR_Word AllOptionArgs_24;
    MR_String Hash_26;
    MR_String HashFileName_28;
    MR_Word Var_38;
    MR_Word OpenResult_70;
    MR_Word Verbose_76;
    MR_String HashPrime_25;
    MR_Word Var_47;

    DetectedGradeFlags_22 = make__make_info__make_info_get_detected_grade_flags_1_f_0(STATE_VARIABLE_Info_0_33);
    OptionArgs_23 = make__make_info__make_info_get_option_args_1_f_0(STATE_VARIABLE_Info_0_33);
    Var_38 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_21, OptionArgs_23);
    AllOptionArgs_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DetectedGradeFlags_22, Var_38);
    Var_47 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_31, (MR_Integer) 0))));
    HashPrime_25 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_31, (MR_Integer) 1))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_24)), ((MR_Box) (Var_47)));
    if (succeeded)
    {
      Hash_26 = HashPrime_25;
      *STATE_VARIABLE_LastHash_32 = STATE_VARIABLE_LastHash_0_31;
    }
    else
    {
      ...
      MR_Word OptionsErrors_52;
      MR_Word AllOptionArgsGlobals_53;
      MR_Word OptionTable_54;
      MR_Word OptionList_55;
      MR_Word InconsequentialOptions_56;
      MR_Word InconsequentialOptionsSet_57;
      MR_Word HashOptionList_58;
      MR_Word OptTuple_59;
      MR_Word Var_63;
      MR_String Var_64;
      MR_Tuple Var_65;
      ...
      libs__handle_options__handle_given_options_9_p_0(ProgressStream_49, DefaultOptionTable_27, AllOptionArgs_24, &Var_50, &Var_51, &OptionsErrors_52, &AllOptionArgsGlobals_53);
      if (!((OptionsErrors_52 == (MR_Word) ((MR_Unsigned) 0U))))
        {
      ...
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_53, &OptionTable_54);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_54, &OptionList_55);
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_56);
      InconsequentialOptionsSet_57 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_56);
      {
        ...
        MR_hl_field(0, Var_63, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_11_p_0_1));
        MR_hl_field(0, Var_63, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_63, 3) = ((MR_Box) (InconsequentialOptionsSet_57));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_63, OptionList_55, &HashOptionList_58);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_53, &OptTuple_59);
      {
        Var_65 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_65, 0) = ((MR_Box) (HashOptionList_58));
        MR_hl_field(0, Var_65, 1) = ((MR_Box) (OptTuple_59));
      }
      Var_64 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_65)));
      Hash_26 = libs__md5__md5sum_1_f_0(Var_64);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_LastHash_32 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (AllOptionArgs_24));
        MR_hl_field(0, base, 1) = ((MR_Box) (Hash_26));
      }
    }
    parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/11", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_15, &HashFileName_28);
    mercury__io__open_input_4_p_0(HashFileName_28, &OpenResult_70);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 72, &Verbose_76);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_4_p_0(ProgressStream_13, HashFileName_28);
            mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) " will be UPDATED.\n");
          }
          break;
      }
      make__track_flags__write_hash_file_6_p_0(ProgressStream_13, HashFileName_28, Hash_26, Succeeded_16);
    }
    else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = (strcmp(Line_73, Hash_26) == 0);
            if (succeeded)
            {
              switch (Verbose_76) {
                default: /*NOTREACHED*/ MR_assert(0);
