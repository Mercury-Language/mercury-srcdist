  ...
  MR_Word * STATE_VARIABLE_LastHash_36)
{
  ...
  {
    MR_Word LookupSpecs_34 = ((MR_Word) ((MR_hl_field(0, MaybeModuleOptionArgs_23, 0))));

    parse_tree__write_error_spec__write_error_specs_5_p_0(ErrorStream_11, Globals_13, LookupSpecs_34);
  ...
  else
  {
    ...
    make__options_file__lookup_mercury_stdlib_dir_2_p_0(EnvOptFileVariables_20, &MaybeStdLibDirs_26);
    Var_39 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), EnvVarArgs_21, OptionArgs_22);
    AllOptionArgs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_24, Var_39);
    Var_48 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, 0))));
    Var_49 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, 1))));
    Var_50 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, 2))));
    HashPrime_28 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_35, 3))));
    succeeded = libs__globals____Unify____maybe_stdlib_grades_0_0(MaybeStdLibGrades_25, Var_48);
    if (succeeded)
    {
      TypeInfo_52_52 = (MR_Word) (&make__track_flags_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_52_52, ((MR_Box) (MaybeStdLibDirs_26)), ((MR_Box) (Var_49)));
      if (succeeded)
      {
        TypeInfo_53_53 = (MR_Word) (&make__track_flags_scalar_common_2[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_53_53, ((MR_Box) (AllOptionArgs_27)), ((MR_Box) (Var_50)));
      }
    }
    if (succeeded)
    {
    ...
    else
    {
      ...
      MR_Word OptionsErrors_56;
      MR_Word AllOptionArgsGlobals_57;
      MR_Word OptionTable_58;
      MR_Word OptionList_59;
      MR_Word DoNotTrackOptions_60;
      MR_Word HashOptionList_61;
      MR_Word OptTuple_62;
      MR_Word Var_65;
      MR_Word Var_66;
      MR_String Var_67;
      ...
      libs__globals__get_default_options_2_p_0(Globals_13, &DefaultOptionTable_30);
      libs__handle_options__handle_given_options_11_p_0(ProgressStream_12, DefaultOptionTable_30, MaybeStdLibGrades_25, MaybeStdLibDirs_26, AllOptionArgs_27, &Var_54, &Var_55, &OptionsErrors_56, &AllOptionArgsGlobals_57);
      if (!((OptionsErrors_56 == (MR_Word) ((MR_Unsigned) 0U))))
        {
      ...
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_57, &OptionTable_58);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_58, &OptionList_59);
      Var_65 = libs__options__options_not_to_track_0_f_0();
      DoNotTrackOptions_60 = mercury__set_tree234__list_to_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), Var_65);
      {
        Var_66 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_66, 0) = ((MR_Box) (&make__track_flags_scalar_common_5[0]));
        MR_hl_field(0, Var_66, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_10_p_0_1));
        MR_hl_field(0, Var_66, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_66, 3) = ((MR_Box) (DoNotTrackOptions_60));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_66, OptionList_59, &HashOptionList_61);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_57, &OptTuple_62);
      {
        Var_68 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_68, 0) = ((MR_Box) (HashOptionList_61));
        MR_hl_field(0, Var_68, 1) = ((MR_Box) (OptTuple_62));
      }
      Var_67 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_68)));
      Hash_29 = libs__md5__md5sum_1_f_0(Var_67);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_LastHash_36 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (MaybeStdLibGrades_25));
        MR_hl_field(0, base, 1) = ((MR_Box) (MaybeStdLibDirs_26));
        MR_hl_field(0, base, 2) = ((MR_Box) (AllOptionArgs_27));
        MR_hl_field(0, base, 3) = ((MR_Box) (Hash_29));
      }
    }
    parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_13, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/10", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_15, &HashFileName_31, &_HashFileNameProposed_32);
    mercury__io__open_input_4_p_0(HashFileName_31, &OpenResult_73);
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 131, &Verbose_79);
    if (((MR_tag((MR_Word) OpenResult_73)) == (MR_Integer) 1))
    {
      switch (Verbose_79) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_4_p_0(ProgressStream_12, HashFileName_31);
            mercury__io__write_string_4_p_0(ProgressStream_12, (MR_String) " will be UPDATED.\n");
          }
          break;
      }
      make__track_flags__write_hash_file_6_p_0(ProgressStream_12, HashFileName_31, Hash_29, Succeeded_16);
    }
    else
    {
      MR_Word Stream_74 = ((MR_Word) ((MR_hl_field(0, OpenResult_73, 0))));
      MR_Word ReadResult_75;

      mercury__io__read_line_as_string_4_p_0(Stream_74, &ReadResult_75);
      mercury__io__close_input_3_p_0(Stream_74);
      switch (MR_tag((MR_Word) ReadResult_75)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            switch (Verbose_79) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Line_76 = ((MR_String) ((MR_hl_field(1, ReadResult_75, 0))));

            succeeded = (strcmp(Line_76, Hash_29) == 0);
            if (succeeded)
            {
              switch (Verbose_79) {
                default: /*NOTREACHED*/ MR_assert(0);
