  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  else
  {
    ...
    Var_112 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
    HashPrime_21 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 1))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_20)), ((MR_Box) (Var_112)));
    if (succeeded)
    {
