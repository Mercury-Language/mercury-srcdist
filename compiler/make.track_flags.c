  ...
  MR_Word * STATE_VARIABLE_LastHash_35)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word InconsequentialOptions_59;
      MR_Word InconsequentialOptionsSet_60;
      ...
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_59);
      InconsequentialOptionsSet_60 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_59);
      {
        ...
        MR_hl_field(0, Var_65, 3) = ((MR_Box) (InconsequentialOptionsSet_60));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_65, OptionList_58, &HashOptionList_61);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_56, &OptTuple_62);
      {
        Var_67 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_67, 0) = ((MR_Box) (HashOptionList_61));
        MR_hl_field(0, Var_67, 1) = ((MR_Box) (OptTuple_62));
      }
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 82, &Verbose_78);
