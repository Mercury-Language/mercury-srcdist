  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  Var_32 = make__make_info__make_info_get_options_variables_1_f_0(STATE_VARIABLE_Info_0_28);
  ...
  else
  {
    ...
    DetectedGradeFlags_18 = make__make_info__make_info_get_detected_grade_flags_1_f_0(STATE_VARIABLE_Info_0_28);
    OptionArgs_19 = make__make_info__make_info_get_option_args_1_f_0(STATE_VARIABLE_Info_0_28);
    ...
    Var_46 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
    HashPrime_21 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 1))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_20)), ((MR_Box) (Var_46)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      mercury__io__output_stream_3_p_0(&CurStream_48);
      libs__handle_options__handle_given_options_8_p_0(CurStream_48, AllOptionArgs_20, &Var_49, &Var_50, &OptionsErrors_51, &AllOptionArgsGlobals_52);
      if (!((OptionsErrors_51 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_String Var_61;
        MR_String Var_63;

        Var_63 = mercury__string__f_43_43_2_f_0((MR_String) ": ", (MR_String) "handle_options returned with errors");
        Var_61 = mercury__string__f_43_43_2_f_0((MR_String) "predicate \140make.track_flags.option_table_hash\'/4", Var_63);
        {
          mercury__require__unexpected_2_p_0((MR_String) "make.track_flags.m", Var_61);
          return;
        }
      }
      ...
      InconsequentialOptionsSet_56 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_55);
      {
        ...
        MR_hl_field(0, Var_66, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_9_p_0_1));
        MR_hl_field(0, Var_66, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_66, 3) = ((MR_Box) (InconsequentialOptionsSet_56));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_66, OptionList_54, &HashOptionList_57);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_52, &OptTuple_58);
      {
        ...
        MR_hl_field(0, Var_68, 0) = ((MR_Box) (HashOptionList_57));
        MR_hl_field(0, Var_68, 1) = ((MR_Box) (OptTuple_58));
      }
      Var_67 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_68)));
      Hash_22 = libs__md5__md5sum_1_f_0(Var_67);
      {
        MR_Word base;
    ...
    parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &make__track_flags_scalar_common_4[0])), (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_11, &HashFileName_23);
    mercury__io__open_input_4_p_0(HashFileName_23, &OpenResult_73);
    if (((MR_tag((MR_Word) OpenResult_73)) == (MR_Integer) 1))
      Same_24 = (MR_Integer) 0;
    else
    {
      MR_Word Stream_74 = ((MR_Word) ((MR_hl_field(0, OpenResult_73, (MR_Integer) 0))));
      ...
      switch (MR_tag((MR_Word) ReadResult_75)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Line_76 = ((MR_String) ((MR_hl_field(1, ReadResult_75, (MR_Integer) 0))));

            succeeded = (strcmp(Line_76, Hash_22) == 0);
            if (succeeded)
              Same_24 = (MR_Integer) 1;
            else
              Same_24 = (MR_Integer) 0;
          }
          break;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 72, &Verbose_79);
    switch (Verbose_79) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_3_p_0(HashFileName_23);
          switch (Same_24) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
    ...
    switch (Same_24) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word OpenResult_89;

          mercury__io__open_output_4_p_0(HashFileName_23, &OpenResult_89);
          if (((MR_tag((MR_Word) OpenResult_89)) == (MR_Integer) 1))
          {
            MR_Word Error_91 = ((MR_Word) ((MR_hl_field(1, OpenResult_89, (MR_Integer) 0))));
            MR_String Var_99;

            Var_99 = mercury__io__error_message_1_f_0(Error_91);
          ...
          {
            MR_Word Stream_90 = ((MR_Word) ((MR_hl_field(0, OpenResult_89, (MR_Integer) 0))));

            mercury__io__write_string_4_p_0(Stream_90, Hash_22);
            mercury__io__close_output_3_p_0(Stream_90);
