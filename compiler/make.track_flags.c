  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  else
  {
    ...
    Var_42 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
    HashPrime_21 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 1))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_20)), ((MR_Box) (Var_42)));
    if (succeeded)
    {
    ...
    {
      MR_Word CurStream_44;
      MR_Word OptionsErrors_47;
      MR_Word AllOptionArgsGlobals_48;
      MR_Word OptionTable_49;
      MR_Word OptionList_50;
      MR_Word InconsequentialOptions_51;
      MR_Word InconsequentialOptionsSet_52;
      MR_Word HashOptionList_53;
      MR_Word OptTuple_54;
      MR_Word Var_62;
      MR_String Var_63;
      MR_Tuple Var_64;
      ...
      mercury__io__output_stream_3_p_0(&CurStream_44);
      libs__handle_options__handle_given_options_8_p_0(CurStream_44, AllOptionArgs_20, &Var_45, &Var_46, &OptionsErrors_47, &AllOptionArgsGlobals_48);
      if (!((OptionsErrors_47 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_String Var_57;
        MR_String Var_59;

        Var_59 = mercury__string__f_43_43_2_f_0((MR_String) ": ", (MR_String) "handle_options returned with errors");
        Var_57 = mercury__string__f_43_43_2_f_0((MR_String) "predicate \140make.track_flags.option_table_hash\'/4", Var_59);
        {
          mercury__require__unexpected_2_p_0((MR_String) "make.track_flags.m", Var_57);
          return;
        }
      }
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_48, &OptionTable_49);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_49, &OptionList_50);
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_51);
      InconsequentialOptionsSet_52 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_51);
      {
        Var_62 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_62, 0) = ((MR_Box) (&make__track_flags_scalar_common_4[0]));
        MR_hl_field(0, Var_62, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_9_p_0_1));
        MR_hl_field(0, Var_62, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_62, 3) = ((MR_Box) (InconsequentialOptionsSet_52));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_62, OptionList_50, &HashOptionList_53);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_48, &OptTuple_54);
      {
        Var_64 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_64, 0) = ((MR_Box) (HashOptionList_53));
        MR_hl_field(0, Var_64, 1) = ((MR_Box) (OptTuple_54));
      }
      Var_63 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_64)));
      Hash_22 = libs__md5__md5sum_1_f_0(Var_63);
      {
        MR_Word base;
    ...
    parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/9", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_11, &HashFileName_23);
    mercury__io__open_input_4_p_0(HashFileName_23, &OpenResult_69);
    if (((MR_tag((MR_Word) OpenResult_69)) == (MR_Integer) 1))
      Same_24 = (MR_Integer) 0;
    else
    {
      MR_Word Stream_70 = ((MR_Word) ((MR_hl_field(0, OpenResult_69, (MR_Integer) 0))));
      MR_Word ReadResult_71;

      mercury__io__read_line_as_string_4_p_0(Stream_70, &ReadResult_71);
      switch (MR_tag((MR_Word) ReadResult_71)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Same_24 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          {
            MR_String Line_72 = ((MR_String) ((MR_hl_field(1, ReadResult_71, (MR_Integer) 0))));

            succeeded = (strcmp(Line_72, Hash_22) == 0);
            if (succeeded)
      ...
      mercury__io__close_input_3_p_0(Stream_70);
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 72, &Verbose_75);
    switch (Verbose_75) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    switch (Same_24) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word OpenResult_85;

          mercury__io__open_output_4_p_0(HashFileName_23, &OpenResult_85);
          if (((MR_tag((MR_Word) OpenResult_85)) == (MR_Integer) 1))
          {
            MR_Word Error_87 = ((MR_Word) ((MR_hl_field(1, OpenResult_85, (MR_Integer) 0))));
            MR_String Var_95;

            Var_95 = mercury__io__error_message_1_f_0(Error_87);
          ...
          {
            MR_Word Stream_86 = ((MR_Word) ((MR_hl_field(0, OpenResult_85, (MR_Integer) 0))));

            mercury__io__write_string_4_p_0(Stream_86, Hash_22);
            mercury__io__close_output_3_p_0(Stream_86);
