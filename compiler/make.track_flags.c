  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  else
  {
    ...
    Var_104 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_2\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &make__track_flags_scalar_common_4[0])), ModuleName_11, &HashFileName_23);
  ...
  MR_String * Hash_6)
{
  ...
  InconsequentialOptionsSet_17 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_16);
  {
    ...
    MR_hl_field(0, Var_29, 0) = ((MR_Box) (&make__track_flags_scalar_common_6[0]));
    MR_hl_field(0, Var_29, 1) = ((MR_Box) (make__track_flags__option_table_hash_4_p_0_1));
    MR_hl_field(0, Var_29, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_29, 3) = ((MR_Box) (InconsequentialOptionsSet_17));
  }
  ...
  libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_11, &OptTuple_19);
  {
    ...
    MR_hl_field(0, Var_31, 0) = ((MR_Box) (HashOptionList_18));
    MR_hl_field(0, Var_31, 1) = ((MR_Box) (OptTuple_19));
  }
