...
static MR_bool MR_CALL 
make__track_flags__make_track_flags_files_for_module_9_p_0_1(
  MR_Box closure_arg,
...
make__track_flags__make_track_flags_files_for_module_9_p_0(
  ...
  MR_Word STATE_VARIABLE_LastHash_0_27,
  MR_Word * STATE_VARIABLE_LastHash_28,
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  Var_33 = make__make_info__make_info_get_options_variables_1_f_0(STATE_VARIABLE_Info_0_29);
  make__options_file__lookup_mmc_module_options_3_p_0(Var_33, ModuleName_11, &MaybeModuleOptionArgs_16);
  if (((MR_tag((MR_Word) MaybeModuleOptionArgs_16)) == (MR_Integer) 0))
  {
    MR_Word LookupSpecs_26 = ((MR_Word) ((MR_hl_field(0, MaybeModuleOptionArgs_16, (MR_Integer) 0))));

    parse_tree__write_error_spec__write_error_specs_4_p_0(Globals_10, LookupSpecs_26);
    *Succeeded_12 = (MR_Integer) 0;
    *STATE_VARIABLE_LastHash_28 = STATE_VARIABLE_LastHash_0_27;
  }
  else
  {
    ...
    MR_String Hash_22;
    MR_String HashFileName_24;
    MR_Word Same_25;
    MR_Word Var_34;
    MR_Word OpenResult_70;
    MR_Word Verbose_76;
    MR_String HashPrime_21;
    MR_Word Var_43;

    DetectedGradeFlags_18 = make__make_info__make_info_get_detected_grade_flags_1_f_0(STATE_VARIABLE_Info_0_29);
    OptionArgs_19 = make__make_info__make_info_get_option_args_1_f_0(STATE_VARIABLE_Info_0_29);
    Var_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ModuleOptionArgs_17, OptionArgs_19);
    AllOptionArgs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DetectedGradeFlags_18, Var_34);
    Var_43 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_27, (MR_Integer) 0))));
    HashPrime_21 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_27, (MR_Integer) 1))));
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__track_flags_scalar_common_2[1]), ((MR_Box) (AllOptionArgs_20)), ((MR_Box) (Var_43)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      MR_Word OptionsErrors_48;
      MR_Word AllOptionArgsGlobals_49;
      MR_Word OptionTable_50;
      MR_Word OptionList_51;
      MR_Word InconsequentialOptions_52;
      MR_Word InconsequentialOptionsSet_53;
      MR_Word HashOptionList_54;
      MR_Word OptTuple_55;
      MR_Word Var_63;
      MR_String Var_64;
      MR_Tuple Var_65;
      ...
      libs__globals__get_default_options_2_p_0(Globals_10, &DefaultOptionTable_23);
      mercury__io__output_stream_3_p_0(&ProgressStream_45);
      libs__handle_options__handle_given_options_9_p_0(ProgressStream_45, DefaultOptionTable_23, AllOptionArgs_20, &Var_46, &Var_47, &OptionsErrors_48, &AllOptionArgsGlobals_49);
      if (!((OptionsErrors_48 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_String Var_58;
        MR_String Var_60;

        Var_60 = mercury__string__f_43_43_2_f_0((MR_String) ": ", (MR_String) "handle_options returned with errors");
        Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "predicate \140make.track_flags.option_table_hash\'/5", Var_60);
        {
          mercury__require__unexpected_2_p_0((MR_String) "make.track_flags.m", Var_58);
          return;
        }
      }
      libs__globals__get_options_2_p_0(AllOptionArgsGlobals_49, &OptionTable_50);
      mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_50, &OptionList_51);
      libs__options__inconsequential_options_1_p_0(&InconsequentialOptions_52);
      InconsequentialOptionsSet_53 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_52);
      {
        Var_63 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_63, 0) = ((MR_Box) (&make__track_flags_scalar_common_4[0]));
        MR_hl_field(0, Var_63, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_9_p_0_1));
        MR_hl_field(0, Var_63, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_63, 3) = ((MR_Box) (InconsequentialOptionsSet_53));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_63, OptionList_51, &HashOptionList_54);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_49, &OptTuple_55);
      {
        Var_65 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_65, 0) = ((MR_Box) (HashOptionList_54));
        MR_hl_field(0, Var_65, 1) = ((MR_Box) (OptTuple_55));
      }
      Var_64 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_65)));
      Hash_22 = libs__md5__md5sum_1_f_0(Var_64);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_LastHash_28 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (AllOptionArgs_20));
        MR_hl_field(0, base, 1) = ((MR_Box) (Hash_22));
      }
    }
    parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/9", (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_11, &HashFileName_24);
    mercury__io__open_input_4_p_0(HashFileName_24, &OpenResult_70);
    if (((MR_tag((MR_Word) OpenResult_70)) == (MR_Integer) 1))
      Same_25 = (MR_Integer) 0;
    else
    {
      MR_Word Stream_71 = ((MR_Word) ((MR_hl_field(0, OpenResult_70, (MR_Integer) 0))));
      MR_Word ReadResult_72;

      mercury__io__read_line_as_string_4_p_0(Stream_71, &ReadResult_72);
      switch (MR_tag((MR_Word) ReadResult_72)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Same_25 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          {
            MR_String Line_73 = ((MR_String) ((MR_hl_field(1, ReadResult_72, (MR_Integer) 0))));

            succeeded = (strcmp(Line_73, Hash_22) == 0);
            if (succeeded)
      ...
      mercury__io__close_input_3_p_0(Stream_71);
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 72, &Verbose_76);
    switch (Verbose_76) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_3_p_0(HashFileName_24);
          switch (Same_25) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
    ...
    switch (Same_25) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word OpenResult_86;

          mercury__io__open_output_4_p_0(HashFileName_24, &OpenResult_86);
          if (((MR_tag((MR_Word) OpenResult_86)) == (MR_Integer) 1))
          {
            MR_Word Error_88 = ((MR_Word) ((MR_hl_field(1, OpenResult_86, (MR_Integer) 0))));
            MR_String Var_96;

            Var_96 = mercury__io__error_message_1_f_0(Error_88);
          ...
          {
            MR_Word Stream_87 = ((MR_Word) ((MR_hl_field(0, OpenResult_86, (MR_Integer) 0))));

            mercury__io__write_string_4_p_0(Stream_87, Hash_22);
            mercury__io__close_output_3_p_0(Stream_87);
