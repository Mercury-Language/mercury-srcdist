  ...
  else
  {
    ...
    else
    {
      ...
      if (!((OptionsErrors_48 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          mercury__require__unexpected_2_p_0((MR_String) "make.track_flags.m", (MR_String) "predicate \140make.track_flags.option_table_hash\'/5: handle_options returned with errors");
          return;
        }
      ...
      InconsequentialOptionsSet_53 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), InconsequentialOptions_52);
      {
        ...
        MR_hl_field(0, Var_59, 0) = ((MR_Box) (&make__track_flags_scalar_common_4[0]));
        MR_hl_field(0, Var_59, 1) = ((MR_Box) (make__track_flags__make_track_flags_files_for_module_9_p_0_1));
        MR_hl_field(0, Var_59, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_59, 3) = ((MR_Box) (InconsequentialOptionsSet_53));
      }
      mercury__list__filter_3_p_0((MR_Word) (&make__track_flags_scalar_common_1[0]), Var_59, OptionList_51, &HashOptionList_54);
      libs__globals__get_opt_tuple_2_p_0(AllOptionArgsGlobals_49, &OptTuple_55);
      {
        Var_61 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_61, 0) = ((MR_Box) (HashOptionList_54));
        MR_hl_field(0, Var_61, 1) = ((MR_Box) (OptTuple_55));
      }
      Var_60 = mercury__string__string_1_f_0((MR_Word) (&make__track_flags_scalar_common_3[0]), ((MR_Box) (Var_61)));
      Hash_22 = libs__md5__md5sum_1_f_0(Var_60);
      {
        MR_Word base;
    ...
    mercury__io__open_input_4_p_0(HashFileName_24, &OpenResult_66);
    ...
    else
    {
      ...
      MR_Word ReadResult_68;

      mercury__io__read_line_as_string_4_p_0(Stream_67, &ReadResult_68);
      switch (MR_tag((MR_Word) ReadResult_68)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Same_25 = (MR_Integer) 0;
          break;
        case (MR_Integer) 1:
          {
            MR_String Line_69 = ((MR_String) ((MR_hl_field(1, ReadResult_68, (MR_Integer) 0))));

            succeeded = (strcmp(Line_69, Hash_22) == 0);
            if (succeeded)
      ...
      mercury__io__close_input_3_p_0(Stream_67);
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 72, &Verbose_72);
    switch (Verbose_72) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          mercury__io__open_output_4_p_0(HashFileName_24, &OpenResult_82);
          if (((MR_tag((MR_Word) OpenResult_82)) == (MR_Integer) 1))
          {
            MR_Word Error_84 = ((MR_Word) ((MR_hl_field(1, OpenResult_82, (MR_Integer) 0))));
            MR_String Var_92;

            Var_92 = mercury__io__error_message_1_f_0(Error_84);
          ...
          {
            MR_Word Stream_83 = ((MR_Word) ((MR_hl_field(0, OpenResult_82, (MR_Integer) 0))));

            mercury__io__write_string_4_p_0(Stream_83, Hash_22);
            mercury__io__close_output_3_p_0(Stream_83);
