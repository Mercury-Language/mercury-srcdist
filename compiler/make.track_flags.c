  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  else
  {
    ...
    Var_43 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_LastHash_0_26, (MR_Integer) 0))));
    ...
    else
    {
      ...
      mercury__io__output_stream_3_p_0(&CurStream_45);
      libs__handle_options__handle_given_options_8_p_0(CurStream_45, AllOptionArgs_20, &Var_46, &Var_47, &OptionsErrors_48, &AllOptionArgsGlobals_49);
      if (!((OptionsErrors_48 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "predicate \140make.track_flags.option_table_hash\'/4", Var_60);
        {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.track_flags.make_track_flags_files_for_module\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &make__track_flags_scalar_common_2[3])), ModuleName_11, &HashFileName_23);
    mercury__io__open_input_4_p_0(HashFileName_23, &OpenResult_70);
      ...
      case (MR_Integer) 0:
        {
          ...
          mercury__io__open_output_4_p_0(HashFileName_23, &OpenResult_86);
