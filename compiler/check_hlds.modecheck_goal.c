      ...
      case (MR_Integer) 3:
        {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0))) == (MR_Integer) 13)));
                          if (succeeded)
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), BoundInst_59, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), BoundInst_59, 1) = ((MR_Box) (Unique_47));
          ...
          check_hlds__modecheck_call__modecheck_builtin_cast_7_p_0(Modes_110, Args0_9, &Args_109, &Det_111, &ExtraGoals_112, STATE_VARIABLE_ModeInfo_67_67, &STATE_VARIABLE_ModeInfo_88_88);
          {
            ...
            MR_hl_field(MR_mktag(3), GoalExpr1_113, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            ...
            MR_hl_field(MR_mktag(3), GoalExpr1_113, 5) = ((MR_Box) (Det_111));
          }
