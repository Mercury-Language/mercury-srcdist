                ...
                case (MR_Integer) 0:
                  {
                    ...
                    hlds__instmap__instmap_delta_set_vars_same_4_p_0((MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[4]), Var_84, InstMapDelta0_95, &InstMapDelta_96);
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                hlds__instmap__instmap_delta_set_var_4_p_0(Var_104, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[4]), InstMapDelta0_46, &InstMapDelta_47);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    switch (IsLive_38) {
                      ...
                      case (MR_Integer) 1:
                        {
                          *GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[3]);
    ...
    else
    {
      ...
      else
      {
        ...
        LargeFlatConstructList_44 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, LargeFlatConstructs_23);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_47, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[4])));
    ...
    else
    {
      ...
      else
      {
        ...
        LargeFlatConstructList_43 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, LargeFlatConstructs_18);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_46, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[4])));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    *GoalExpr_8 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__modecheck_goal_scalar_common_2[3]);
      ...
      case (MR_Integer) 3:
        {
          ...
          succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo0_11, (MR_Integer) 12);
          if (succeeded)
          {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_STATE_VARIABLE_LargeFlatConstructs_0_2 = STATE_VARIABLE_LargeFlatConstructs_13_13;
