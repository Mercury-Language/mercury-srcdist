              ...
              case (MR_Integer) 0:
                {
                  ...
                  hlds__instmap__instmap_delta_set_vars_same_4_p_0((MR_Word) (MR_mkword(3, &check_hlds__modecheck_goal_scalar_common_2[2])), Var_93, InstMapDelta0_96, &InstMapDelta_97);
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              hlds__instmap__instmap_delta_set_var_4_p_0(Var_105, (MR_Word) (MR_mkword(3, &check_hlds__modecheck_goal_scalar_common_2[2])), InstMapDelta0_46, &InstMapDelta_47);
