...
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1485__1_2_p_0(
...
static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1478__1_2_p_0(
                    ...
                    case (MR_Integer) 6:
                      {
                        ...
                        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2)));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2)));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1485__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1478__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_6, (MR_Integer) 0)));
...
{
  {
    ...
    if ((MaybeGroundTermMode_15 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr0_24, (MR_Integer) 1)));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_7, (MR_Integer) 2)));
          ...
          case (MR_Integer) 8:
            {
              ...
              MR_Word SubGoal_151;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_7, (MR_Integer) 3)));
...
{
  {
    ...
    check_hlds__modecheck_call__modecheck_call_pred_10_p_0(PredId_13, (MR_Word) ((MR_Unsigned) 0U), ProcId0_14, &ProcId_26, ArgVars0_25, &ArgVars_27, GoalInfo0_19, &ExtraGoals_28, STATE_VARIABLE_ModeInfo_36_36, &STATE_VARIABLE_ModeInfo_39_39);
    {
      Pragma_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Pragma_29, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word AllArgs_27;
          MR_Word STATE_VARIABLE_ModeInfo_98_98;
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GenericCall_8, (MR_Integer) 1)));
      ...
      case (MR_Integer) 3:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_46, (MR_Integer) 1)));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0))) == (MR_Integer) 2)));
                          if (succeeded)
                          {
                            LocalSectag_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 2))));
                            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 3)));
                          }
                        }
                      }
                    }
          ...
          if (succeeded)
          {
            ...
            {
              BoundFunctor_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            {
              BoundInst_59 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), BoundInst_59, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(3), BoundInst_59, 1) = (MR_Box) (packed_args_0);
              MR_hl_field(MR_mktag(3), BoundInst_59, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), BoundInst_59, 3) = ((MR_Box) (Var_83));
            }
            {
              NewMode2_60 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            {
              Modes_110 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            GoalExpr1_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    check_hlds__modecheck_call__modecheck_call_pred_10_p_0(PredId_10, (MR_Word) ((MR_Unsigned) 0U), ProcId0_11, &ProcId_23, Args0_12, &Args_24, GoalInfo0_15, &ExtraGoals_25, STATE_VARIABLE_ModeInfo_36_36, &STATE_VARIABLE_ModeInfo_38_38);
    ...
    Builtin_28 = hlds__hlds_pred__builtin_state_4_f_0(ModuleInfo_26, CallerPredId_27, PredId_10, ProcId_23);
    {
      ...
      MR_hl_field(MR_mktag(2), Call_29, 3) = (MR_Box) ((MR_Unsigned) (Builtin_28));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_19, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr_9, (MR_Integer) 1)));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_42, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TermVarInst_7, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_7, (MR_Integer) 1)));
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_54, (MR_String) "copy", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__modecheck_goal_scalar_common_4[0])), (MR_Integer) 0, (MR_Integer) 0, Var_60, (MR_Word) ((MR_Unsigned) 0U), InstMapDelta_33, ModuleInfo_34, Context_30, &CopyGoal_35);
