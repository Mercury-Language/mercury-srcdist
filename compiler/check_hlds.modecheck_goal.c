...
static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_make_type_info_var_for_type__982__1_2_p_0(
  MR_Word check_hlds__modecheck_goal__PolySpecs_23,
  MR_Word check_hlds__modecheck_goal__HeadVar__2_36);

static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_scope__813__1_2_p_0(
...
{
  {
    ...
    {
      check_hlds__modecheck_goal__succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_make_type_info_var_for_type__982__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_goal__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_goal__closure, (MR_Integer) 4))));
    }
    return check_hlds__modecheck_goal__succeeded;
  }
}
...
{
  {
    ...
    {
      check_hlds__modecheck_goal__succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_scope__813__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_goal__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_goal__closure, (MR_Integer) 4))));
    }
    return check_hlds__modecheck_goal__succeeded;
  }
}
