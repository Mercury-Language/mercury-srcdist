                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_116, DuCtor_53, &ConsRepn_54);
                              if (succeeded)
                              {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_194, DuCtor_178, &ConsRepn_179);
                              if (succeeded)
                              {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_392, DuCtor_376, &ConsRepn_377);
                              if (succeeded)
                              {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_590, DuCtor_574, &ConsRepn_575);
                              if (succeeded)
                              {
