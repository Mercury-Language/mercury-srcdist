  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (&check_hlds__modecheck_goal_scalar_common_4[1]));
    ...
    hlds__instmap__instmap_merge_5_p_0(LargeFlatConstructs0_19, ArmInstMaps_44, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_29_29, &STATE_VARIABLE_ModeInfo_28_28);
  }
  {
    MR_Word base;
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&check_hlds__modecheck_goal_scalar_common_4[0]));
      ...
      LargeFlatConstructList_45 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), LargeFlatConstructs_19);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&check_hlds__modecheck_goal_scalar_common_5[0]));
    ...
    hlds__instmap__instmap_merge_5_p_0(LargeFlatConstructs0_15, ArmInstMaps_44, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_30_30, &STATE_VARIABLE_ModeInfo_28_28);
