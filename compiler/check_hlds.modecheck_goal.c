...
static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_make_type_info_var_for_type__1001__1_2_p_0(
  MR_Word PolySpecs_23,
  MR_Word HeadVar__2_35);

static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_scope__832__1_2_p_0(
  MR_Word Kind1_42,
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_scope__832__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      check_hlds__mode_info__mode_info_set_pred_var_multimode_error_map_3_p_0(MultiModeErrorMap0_1, STATE_VARIABLE_ModeInfo_0_7, &STATE_VARIABLE_ModeInfo_30_30);
      ...
      check_hlds__modecheck_goal__modecheck_disj_list_8_p_0(MultiModeErrorMap0_1, Goals0_18, &Goals_20, &InstMaps_22, STATE_VARIABLE_LargeFlatConstructs_32_32, STATE_VARIABLE_LargeFlatConstructs_6, STATE_VARIABLE_ModeInfo_33_33, STATE_VARIABLE_ModeInfo_8);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__3_3 = base;
...
{
  {
    ...
    else
    {
      ...
      check_hlds__mode_info__mode_info_get_pred_var_multimode_error_map_2_p_0(STATE_VARIABLE_ModeInfo_26_26, &MultiModeErrorMap0_13);
      LargeFlatConstructs0_15 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_7);
      check_hlds__modecheck_goal__modecheck_disj_list_8_p_0(MultiModeErrorMap0_13, Disjuncts0_6, &Disjuncts1_16, &InstMaps_17, LargeFlatConstructs0_15, &LargeFlatConstructs_18, STATE_VARIABLE_ModeInfo_26_26, &STATE_VARIABLE_ModeInfo_27_27);
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_make_type_info_var_for_type__1001__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
