...
static MR_bool MR_CALL 
check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1480__1_2_p_0(
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1480__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_goal__IntroducedFrom__pred__modecheck_goal_shorthand__1475__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          conv0_MainGoal_23 = mercury__list__det_head_1_f_0(TypeCtorInfo_78_78, AtomicGoalList_20);
          MainGoal_23 = ((MR_Word) conv0_MainGoal_23);
          OrElseGoals_24 = mercury__list__det_tail_1_f_0(TypeCtorInfo_78_78, AtomicGoalList_20);
          ...
          case (MR_Integer) 7:
            {
              ...
              check_hlds__mode_info__mode_info_lock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), NonLocals_18, STATE_VARIABLE_ModeInfo_98_98, &STATE_VARIABLE_ModeInfo_100_100);
              ...
              check_hlds__mode_info__mode_info_unlock_vars_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), NonLocals_18, STATE_VARIABLE_ModeInfo_101_101, &STATE_VARIABLE_ModeInfo_103_103);
...
{
  {
    ...
    check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 0, (MR_String) "generic_call", STATE_VARIABLE_ModeInfo_0_56, &STATE_VARIABLE_ModeInfo_60_60);
    check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_60_60, &InstMap0_14);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (CallId_16));
    }
    check_hlds__mode_info__mode_info_set_call_context_3_p_0(Var_61, STATE_VARIABLE_ModeInfo_60_60, &STATE_VARIABLE_ModeInfo_62_62);
      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__modecheck_call__modecheck_higher_order_call_9_p_0(PredOrFunc_19, PredVar_17, Args0_9, &Args_21, &Modes_22, &Det_23, &ExtraGoals_24, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_93_93);
          {
          ...
          check_hlds__modecheck_util__handle_extra_goals_9_p_0(GoalExpr1_25, ExtraGoals_24, GoalInfo0_11, AllArgs0_26, AllArgs_27, InstMap0_14, GoalExpr_12, STATE_VARIABLE_ModeInfo_93_93, &STATE_VARIABLE_ModeInfo_95_95);
        }
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_62_62, &ModuleInfo_33);
          hlds__hlds_module__module_info_get_event_set_2_p_0(ModuleInfo_33, &EventSet_34);
          Var_110 = ((MR_String) (MR_hl_field(MR_mktag(0), EventSet_34, (MR_Integer) 0)));
          ...
          check_hlds__modecheck_call__modecheck_event_call_5_p_0(Modes_101, Args0_9, &Args_100, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_95_95);
          {
            MR_Word base;
            ...
            *GoalExpr_12 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Modes_101));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word Modes_105;
          MR_Word Det_106;
          MR_Word ExtraGoals_107;
          MR_Word GoalExpr1_108;
          MR_Word Mode1_44;
          MR_Word Unique_47;
          MR_Integer LocalTag_52;
          MR_Word InstMap_38;
          MR_Word Arg1_43;
          MR_Word Mode2_45;
          MR_Word Inst1_46;
          ...
          if (succeeded)
          {
            check_hlds__mode_info__mode_info_get_instmap_2_p_0(STATE_VARIABLE_ModeInfo_62_62, &InstMap_38);
            succeeded = ((MR_tag((MR_Word) Args0_9)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
              Arg1Prime_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args0_9, (MR_Integer) 0)));
              Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args0_9, (MR_Integer) 1)));
              succeeded = ((MR_tag((MR_Word) Var_64)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
                _Arg2Prime_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_64, (MR_Integer) 0)));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(1), Modes0_10, (MR_Integer) 1)));
                    succeeded = ((MR_tag((MR_Word) Var_66)) == (MR_mktag((MR_Integer) 1)));
                    if (succeeded)
                    {
                      Mode2Prime_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_66, (MR_Integer) 0)));
            ...
            succeeded = parse_tree__prog_data____Unify____mer_mode_0_0(Mode1_44, Var_116);
            if (succeeded)
            {
              Var_117 = parse_tree__prog_mode__out_mode_0_f_0();
              succeeded = parse_tree__prog_data____Unify____mer_mode_0_0(Mode2_45, Var_117);
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(3), Inst1_46, (MR_Integer) 3)));
                  succeeded = ((MR_tag((MR_Word) Var_70)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                    Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_70, (MR_Integer) 0)));
                    Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_70, (MR_Integer) 1)));
                    succeeded = (Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    if (succeeded)
                    {
                      ConsId_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 0)));
                      Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 1)));
                      succeeded = (Var_72 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      if (succeeded)
                      {
                        check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_62_62, &ModuleInfo_102);
                        succeeded = check_hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_102, ConsId_49, &ConsRepn_50);
                        if (succeeded)
                        {
                          Var_111 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 0)));
                          Var_112 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 1)));
                          Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 2)));
                          Var_113 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 3)));
                          Var_114 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 4)));
                          Var_115 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 5)));
                          succeeded = ((((MR_tag((MR_Word) Var_74)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_74, (MR_Integer) 0)))) == (MR_Integer) 14)));
                          if (succeeded)
                          {
                            Var_51 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Var_74, (MR_Integer) 1)));
                            LocalTag_52 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Var_74, (MR_Integer) 2)));
                          }
                        }
                      }
                    }
          ...
          if (succeeded)
          {
            MR_Word BoundFunctor_53;
            MR_Word BoundInst_54;
            MR_Word NewMode2_55;
            MR_Word Var_75;
            MR_Word Var_78;
            MR_Word Var_81;

            {
              ...
              MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (LocalTag_52));
            }
            {
              BoundFunctor_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), BoundFunctor_53, 0) = ((MR_Box) (Var_75));
              MR_hl_field(MR_mktag(0), BoundFunctor_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (BoundFunctor_53));
              MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              BoundInst_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), BoundInst_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), BoundInst_54, 1) = ((MR_Box) (Unique_47));
              MR_hl_field(MR_mktag(3), BoundInst_54, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              MR_hl_field(MR_mktag(3), BoundInst_54, 3) = ((MR_Box) (Var_78));
            }
            {
              NewMode2_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), NewMode2_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              MR_hl_field(MR_mktag(0), NewMode2_55, 1) = ((MR_Box) (BoundInst_54));
            }
            {
              Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (NewMode2_55));
              MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              Modes_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Modes_105, 0) = ((MR_Box) (Mode1_44));
              MR_hl_field(MR_mktag(1), Modes_105, 1) = ((MR_Box) (Var_81));
            }
          }
          else
            Modes_105 = Modes0_10;
          check_hlds__modecheck_call__modecheck_builtin_cast_7_p_0(Modes_105, Args0_9, &Args_104, &Det_106, &ExtraGoals_107, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_83_83);
          {
            GoalExpr1_108 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 1) = ((MR_Box) (GenericCall_8));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 2) = ((MR_Box) (Args_104));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 3) = ((MR_Box) (Modes_105));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(3), GoalExpr1_108, 5) = ((MR_Box) (Det_106));
          }
          check_hlds__modecheck_util__handle_extra_goals_9_p_0(GoalExpr1_108, ExtraGoals_107, GoalInfo0_11, Args0_9, Args_104, InstMap0_14, GoalExpr_12, STATE_VARIABLE_ModeInfo_83_83, &STATE_VARIABLE_ModeInfo_95_95);
        }
        break;
    }
    check_hlds__mode_info__mode_info_unset_call_context_2_p_0(STATE_VARIABLE_ModeInfo_95_95, &STATE_VARIABLE_ModeInfo_96_96);
    check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "generic_call", STATE_VARIABLE_ModeInfo_96_96, STATE_VARIABLE_ModeInfo_57);
  }
}
