      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__modecheck_call__modecheck_higher_order_call_9_p_0(PredOrFunc_19, PredVar_17, Args0_9, &Args_21, &Modes_22, &Det_23, &ExtraGoals_24, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_96_96);
          {
          ...
          check_hlds__modecheck_util__handle_extra_goals_9_p_0(GoalExpr1_25, ExtraGoals_24, GoalInfo0_11, AllArgs0_26, AllArgs_27, InstMap0_14, GoalExpr_12, STATE_VARIABLE_ModeInfo_96_96, &STATE_VARIABLE_ModeInfo_98_98);
        }
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_113 = ((MR_String) (MR_hl_field(MR_mktag(0), EventSet_34, (MR_Integer) 0)));
          ...
          check_hlds__modecheck_call__modecheck_event_call_5_p_0(Modes_104, Args0_9, &Args_103, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_98_98);
          {
            MR_Word base;
            ...
            *GoalExpr_12 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Args_103));
            MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Modes_104));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word Modes_108;
          MR_Word Det_109;
          MR_Word ExtraGoals_110;
          MR_Word GoalExpr1_111;
          MR_Word Mode1_44;
          MR_Word Unique_47;
          ...
          if (succeeded)
          {
            ...
            Var_119 = parse_tree__prog_mode__in_mode_0_f_0();
            succeeded = parse_tree__prog_data____Unify____mer_mode_0_0(Mode1_44, Var_119);
            if (succeeded)
            {
              Var_120 = parse_tree__prog_mode__out_mode_0_f_0();
              succeeded = parse_tree__prog_data____Unify____mer_mode_0_0(Mode2_45, Var_120);
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), Inst1_46, (MR_Integer) 3)));
                  succeeded = ((MR_tag((MR_Word) Var_71)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
                    Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_71, (MR_Integer) 0)));
                    Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_71, (MR_Integer) 1)));
                    succeeded = (Var_74 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    if (succeeded)
                    {
                      ConsId_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 0)));
                      Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 1)));
                      succeeded = (Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      if (succeeded)
                      {
                        check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_62_62, &ModuleInfo_105);
                        succeeded = check_hlds__type_util__get_cons_repn_defn_3_p_0(ModuleInfo_105, ConsId_49, &ConsRepn_50);
                        if (succeeded)
                        {
                          Var_114 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 0)));
                          Var_115 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 1)));
                          Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 2)));
                          Var_116 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 3)));
                          Var_117 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 4)));
                          Var_118 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsRepn_50, (MR_Integer) 5)));
                          succeeded = ((((MR_tag((MR_Word) Var_75)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_75, (MR_Integer) 0)))) == (MR_Integer) 14)));
                          if (succeeded)
                          {
                            Var_51 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Var_75, (MR_Integer) 1)));
                            LocalTag_52 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Var_75, (MR_Integer) 2)));
                          }
                        }
                      }
                    }
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_76, 1) = ((MR_Box) (LocalTag_52));
            }
            {
              BoundFunctor_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), BoundFunctor_53, 0) = ((MR_Box) (Var_76));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (BoundFunctor_53));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), BoundInst_54, 3) = ((MR_Box) (Var_79));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (NewMode2_55));
              MR_hl_field(MR_mktag(1), Var_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              Modes_108 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Modes_108, 0) = ((MR_Box) (Mode1_44));
              MR_hl_field(MR_mktag(1), Modes_108, 1) = ((MR_Box) (Var_82));
            }
          }
          else
            Modes_108 = Modes0_10;
          check_hlds__modecheck_call__modecheck_builtin_cast_7_p_0(Modes_108, Args0_9, &Args_107, &Det_109, &ExtraGoals_110, STATE_VARIABLE_ModeInfo_62_62, &STATE_VARIABLE_ModeInfo_84_84);
          {
            GoalExpr1_111 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 1) = ((MR_Box) (GenericCall_8));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 2) = ((MR_Box) (Args_107));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 3) = ((MR_Box) (Modes_108));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(3), GoalExpr1_111, 5) = ((MR_Box) (Det_109));
          }
          check_hlds__modecheck_util__handle_extra_goals_9_p_0(GoalExpr1_111, ExtraGoals_110, GoalInfo0_11, Args0_9, Args_107, InstMap0_14, GoalExpr_12, STATE_VARIABLE_ModeInfo_84_84, &STATE_VARIABLE_ModeInfo_98_98);
        }
        break;
    }
    check_hlds__mode_info__mode_info_unset_call_context_2_p_0(STATE_VARIABLE_ModeInfo_98_98, &STATE_VARIABLE_ModeInfo_99_99);
    check_hlds__mode_debug__mode_checkpoint_4_p_0((MR_Integer) 1, (MR_String) "generic_call", STATE_VARIABLE_ModeInfo_99_99, STATE_VARIABLE_ModeInfo_57);
  }
}
