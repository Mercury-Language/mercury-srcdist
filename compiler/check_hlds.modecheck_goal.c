                    ...
                    case (MR_Integer) 6:
                      {
                        ...
                        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_43, (MR_Integer) 2)));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_6, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_6, (MR_Integer) 0)));
...
{
  {
    ...
    if ((MaybeGroundTermMode_15 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr0_24, (MR_Integer) 1)));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_7, (MR_Integer) 2)));
          ...
          case (MR_Integer) 8:
            {
              ...
              MR_Word SubGoal_151;
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_7, (MR_Integer) 3)));
...
{
  {
    ...
    {
      Pragma_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word AllArgs_27;
          MR_Word STATE_VARIABLE_ModeInfo_98_98;
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), GenericCall_8, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_46, (MR_Integer) 1)));
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 3)));
                          }
                        }
                      }
                    }
...
{
  {
    ...
    {
      Call_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_19, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubGoalExpr_9, (MR_Integer) 1)));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_42, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TermVarInst_7, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_7, (MR_Integer) 1)));
