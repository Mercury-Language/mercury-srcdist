  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 146, &OutputOrder_21);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 78, &Verbose_56);
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_13, (MR_Integer) 213, &MaybeSpecFileName_23);
