  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 145, &OutputOrder_21);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 77, &Verbose_56);
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_13, (MR_Integer) 212, &MaybeSpecFileName_23);
