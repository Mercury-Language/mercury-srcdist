  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 407, &OutputOrder_21);
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_13, (MR_Integer) 408, &MaybeSpecFileName_23);
