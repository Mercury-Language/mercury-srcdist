  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 432, &OutputOrder_21);
  ...
  *IndirectOptDepsGraph_16 = mercury__digraph__transitive_closure_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_15);
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_13, (MR_Integer) 433, &MaybeSpecFileName_23);
