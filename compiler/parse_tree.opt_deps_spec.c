  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_15, 1) = ((MR_Box) (MR_mkword(2, &parse_tree__opt_deps_spec_scalar_common_5[2])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(0, Spec_27, 1) = ((MR_Box) (MR_mkword(2, &parse_tree__opt_deps_spec_scalar_common_5[2])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Spec_87, 1) = ((MR_Box) (MR_mkword(2, &parse_tree__opt_deps_spec_scalar_common_5[2])));
