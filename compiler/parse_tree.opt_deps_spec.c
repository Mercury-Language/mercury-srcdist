  ...
  *IndirectOptDepsGraph_16 = mercury__digraph__transitive_closure_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpDepsGraph_15);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) MaybeEdgesToRemove_25)) == (MR_Integer) 0))
    {
      ...
      Var_43 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), EdgeSpecs_29);
      *STATE_VARIABLE_Specs_33 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_43, STATE_VARIABLE_Specs_0_32);
      *TransOptDepsGraph_17 = *IndirectOptDepsGraph_16;
    }
    else
    {
  ...
  MR_Word * Result_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&parse_tree__opt_deps_spec_scalar_common_1[2]), (MR_Word) (&parse_tree__opt_deps_spec_scalar_common_2[4]), FileSpecs0_14, ((MR_Box) (Var_33)), &conv1_FileSpecContextsSet_17);
