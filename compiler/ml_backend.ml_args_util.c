    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 312, &CopyOut_122);
        switch (CopyOut_122) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 312, &CopyOut_75);
          switch (CopyOut_75) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 312, &CopyOut_63);
        switch (CopyOut_63) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
