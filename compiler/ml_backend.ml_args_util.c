      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 277, &CopyOut_45);
          switch (CopyOut_45) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 278, &CopyOut_86);
          switch (CopyOut_86) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
  ...
  MR_Word * HeadVar__19_19)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadTuple_33, (MR_Integer) 3)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), HeadMLDS_PtrType_78, 0) = ((MR_Box) ((MR_Unsigned) 6U));
  ...
  MR_Word * STATE_VARIABLE_MaybeInfo_10)
{
  ...
  else
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadTuple_20, (MR_Integer) 3)));
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 277, &CopyOut_53);
            switch (CopyOut_53) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 2:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 278, &CopyOut_85);
            switch (CopyOut_85) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), HeadMLDS_ArgType_44, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 277, &CopyOut_21);
          switch (CopyOut_21) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 278, &CopyOut_55);
          switch (CopyOut_55) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
