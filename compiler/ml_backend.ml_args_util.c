...
ml_backend__ml_args_util__IntroducedFrom__pred__ml_gen_proc_params_inputs_only_no_gc_stmts__565__1_2_p_0(
  MR_Word RetTypes_11,
...
static /* final */ const MR_Box ml_backend__ml_args_util_scalar_common_1[11][2] = {
  ...
  /* row   3 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_2[3]))),
...
static /* final */ const MR_Box ml_backend__ml_args_util_scalar_common_2[5][3] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[8]))),
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__mode_top_functor__mode_to_top_functor_mode_4_p_0(ModuleInfo_79, CalleeMode_28, CalleeType_26, &CalleeArgTopFunctorMode_80);
      ...
      switch (CalleeIsDummy_81) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word CallerMLDSVarName_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallerArg_30, (MR_Integer) 0))));
            MR_Word CallerVarLval_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallerArg_30, (MR_Integer) 1))));
            MR_Word CallerType_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallerArg_30, (MR_Integer) 2))));

            switch (CalleeArgTopFunctorMode_80) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word CallerIsDummy_89;
                  MR_Word CallerVarRval_90;
                  MR_Word ArgRval_91;

                  CallerIsDummy_89 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_79, CallerType_87);
                  switch (CallerIsDummy_89) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      CallerVarRval_90 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[10]));
                      break;
                    case (MR_Integer) 1:
                      {
                        CallerVarRval_90 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), CallerVarRval_90, 0) = ((MR_Box) (CallerVarLval_86));
                      }
                      break;
                  }
                  ml_backend__ml_code_util__ml_gen_box_or_unbox_rval_6_p_0(ModuleInfo_79, CallerType_87, CalleeType_26, (MR_Integer) 0, CallerVarRval_90, &ArgRval_91);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_InputRvals_32 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ArgRval_91));
              ...
              case (MR_Integer) 1:
                switch (WhatParams_16) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word ArgLval_92;
                      MR_Word ThisArgConvDecls_93;
                      MR_Word ThisArgConvOutput_95;
                      MR_Word _ThisArgConvInput_94;

                      ml_backend__ml_code_util__ml_gen_box_or_unbox_lval_14_p_0(CallerType_87, CalleeType_26, (MR_Integer) 0, CallerVarLval_86, CallerMLDSVarName_85, Context_15, (MR_Integer) 1, ArgNum_17, &ArgLval_92, &ThisArgConvDecls_93, &_ThisArgConvInput_94, &ThisArgConvOutput_95, STATE_VARIABLE_Info_47_47, STATE_VARIABLE_Info_37);
                      *STATE_VARIABLE_ConvOutputDefns_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0), ThisArgConvDecls_93, STATE_VARIABLE_ConvOutputDefns_45_45);
                      *STATE_VARIABLE_ConvOutputStmts_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), ThisArgConvOutput_95, STATE_VARIABLE_ConvOutputStmts_46_46);
                      ...
                      if (succeeded)
                      {
                        MR_Word OutputType_96;
                        MR_Word Var_106;

                        ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(*STATE_VARIABLE_Info_37, CalleeType_26, &OutputType_96);
                        {
                          Var_106 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), Var_106, 0) = ((MR_Box) (ArgLval_92));
                          MR_hl_field(MR_mktag(0), Var_106, 1) = ((MR_Box) (OutputType_96));
                        }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      else
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) ArgLval_92)) == (MR_Integer) 1);
                        if (succeeded)
                        {
                          Rval_114 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgLval_92, (MR_Integer) 0))));
                          Var_108 = Rval_114;
                        }
                        else
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_108, 1) = ((MR_Box) (ArgLval_92));
                          }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word VarTable_83;
            MR_Word CallerArgVarEntry_84;
            MR_Word CallerMLDSVarName_85;
            MR_Word CallerVarLval_86;
            MR_Word CallerType_87;

            ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_47_47, &VarTable_83);
            parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_83, CallerArgVar_82, &CallerArgVarEntry_84);
            CallerMLDSVarName_85 = ml_backend__ml_code_util__ml_gen_local_var_name_2_f_0(CallerArgVar_82, CallerArgVarEntry_84);
            ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_47_47, CallerArgVar_82, CallerArgVarEntry_84, &CallerVarLval_86);
            CallerType_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CallerArgVarEntry_84, (MR_Integer) 1))));
            switch (CalleeArgTopFunctorMode_80) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      ml_backend__ml_code_util__ml_gen_box_or_unbox_lval_14_p_0(CallerType_87, CalleeType_26, (MR_Integer) 0, CallerVarLval_86, CallerMLDSVarName_85, Context_15, (MR_Integer) 0, ArgNum_17, &ArgLval_92, &ThisArgConvDecls_93, &_ThisArgConvInput_94, &ThisArgConvOutput_95, STATE_VARIABLE_Info_47_47, STATE_VARIABLE_Info_37);
                      *STATE_VARIABLE_ConvOutputDefns_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0), ThisArgConvDecls_93, STATE_VARIABLE_ConvOutputDefns_45_45);
                      *STATE_VARIABLE_ConvOutputStmts_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), ThisArgConvOutput_95, STATE_VARIABLE_ConvOutputStmts_46_46);
                      switch (CopyOutWhen_14) {
                        default:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 305, &CopyOut_45);
        switch (CopyOut_45) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), CopySucceededStmt_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_args_util_scalar_common_1[3])));
              ...
              }
              {
                ...
                *ReturnRvalsTypes_36 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (&ml_backend__ml_args_util_scalar_common_1[4]));
              ...
              }
              {
                ...
                *OutVarsTypes_37 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (&ml_backend__ml_args_util_scalar_common_1[5]));
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 306, &CopyOut_86);
        switch (CopyOut_86) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (HeadTsccInVar_58));
                    MR_hl_field(MR_mktag(0), Var_102, 1) = ((MR_Box) (HeadVar__3_3));
                    MR_hl_field(MR_mktag(0), Var_102, 2) = ((MR_Box) (HeadMLDS_Type_54));
                    MR_hl_field(MR_mktag(0), Var_102, 3) = ((MR_Box) ((MR_Unsigned) 0U));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), HeadTsccInLocalVarDefns_67, 0) = ((MR_Box) (Var_102));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_108, 0) = ((MR_Box) (HeadTsccInVarLval_60));
                  }
                  {
                    Var_107 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_107, 0) = ((MR_Box) (HeadMLDSVarLval_59));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_106, 2) = ((MR_Box) (HeadVar__3_3));
                  }
                  {
                    HeadCopyTsccInToOwnStmts_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), HeadCopyTsccInToOwnStmts_69, 0) = ((MR_Box) (Var_106));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_112, 0) = ((MR_Box) (HeadTsccOutVarValue_75));
                    MR_hl_field(MR_mktag(0), Var_112, 1) = ((MR_Box) (HeadMLDS_Type_54));
                  }
                  {
                    HeadOutVarsTypes_150 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), HeadOutVarsTypes_150, 0) = ((MR_Box) (Var_112));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_116, 0) = ((MR_Box) (HeadTsccOutVarValue_75));
                    MR_hl_field(MR_mktag(0), Var_116, 1) = ((MR_Box) (HeadVar__3_3));
                    MR_hl_field(MR_mktag(0), Var_116, 2) = ((MR_Box) (HeadMLDS_Type_54));
                    MR_hl_field(MR_mktag(0), Var_116, 3) = ((MR_Box) ((MR_Unsigned) 0U));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), HeadTsccOutLocalVarDefns_153, 0) = ((MR_Box) (Var_116));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_122, 0) = ((MR_Box) (HeadMLDSVarLval_135));
                  }
                  {
                    Var_121 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_121, 0) = ((MR_Box) (HeadTsccOutVarValueLval_76));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_120, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                    MR_hl_field(MR_mktag(3), Var_120, 1) = ((MR_Box) (Var_121));
                    MR_hl_field(MR_mktag(3), Var_120, 2) = ((MR_Box) (HeadVar__3_3));
                  }
                  {
                    HeadCopyOwnToTsccOutStmts_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), HeadCopyOwnToTsccOutStmts_155, 0) = ((MR_Box) (Var_120));
                  ...
                  if (succeeded)
                  {
                    ...
                    HeadTsccArgs_148 = (MR_Word) ((MR_Unsigned) 0U);
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_124, 0) = ((MR_Box) (HeadReturnRval_77));
                      MR_hl_field(MR_mktag(0), Var_124, 1) = ((MR_Box) (HeadMLDS_Type_54));
                    }
                    {
                      HeadReturnRvalsTypes_149 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), HeadReturnRvalsTypes_149, 0) = ((MR_Box) (Var_124));
                  ...
                  else
                  {
                    ...
                    HeadReturnRvalsTypes_149 = (MR_Word) ((MR_Unsigned) 0U);
                    {
                      ...
                      MR_hl_field(MR_mktag(2), Var_131, 0) = ((MR_Box) (HeadTsccOutVarPtrLval_80));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_130, 1) = ((MR_Box) (HeadMLDS_Type_54));
                    }
                    {
                      Var_132 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), Var_132, 0) = ((MR_Box) (HeadTsccOutVarValueLval_76));
                    }
                    {
                      Var_129 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), Var_129, 0) = ((MR_Box) (Var_130));
                      MR_hl_field(MR_mktag(2), Var_129, 1) = ((MR_Box) (Var_132));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), HeadCopyOutValThroughPtrStmts_156, 0) = ((MR_Box) (Var_128));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_args_util__IntroducedFrom__pred__ml_gen_proc_params_inputs_only_no_gc_stmts__565__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word PredProcId_5)
{
  ...
  hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_4, PredProcId_5, &_PredInfo_7, &ProcInfo_28);
  _PredOrFunc_8 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(_PredInfo_7);
  _CodeModel_9 = hlds__code_model__proc_info_interface_code_model_1_f_0(ProcInfo_28);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_4, ProcInfo_28, &VarTable_29);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_28, &HeadVars_30);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(_PredInfo_7, &HeadTypes_31);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_28, &HeadModes_32);
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_4, VarTable_29, HeadVars_30, HeadTypes_31, HeadModes_32, &ArgTuples_10);
  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_14, PredProcId_8, &PredInfo_15, &ProcInfo_35);
  PredOrFunc_16 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_15);
  CodeModel_17 = hlds__code_model__proc_info_interface_code_model_1_f_0(ProcInfo_35);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_14, ProcInfo_35, &VarTable_36);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_35, &HeadVars_37);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo_15, &HeadTypes_38);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_35, &HeadModes_39);
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_14, VarTable_36, HeadVars_37, HeadTypes_38, HeadModes_39, ArgTuples_9);
  ...
  else
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_14, &Globals_51);
    switch (CodeModel_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 305, &CopyOut_52);
          switch (CopyOut_52) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
          ...
          ml_backend__ml_args_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_95_97_114_103_95_100_101_99_108_115_95_95_91_51_93_95_50_10_p_2(ModuleInfo_14, CopyOutWhen_53, *ArgTuples_9, &FuncArgs0_54, &RetTypes0_55, ByRefOutputVars_11, CopiedOutputVars_12, Var_27, &Var_28);
          switch (CodeModel_17) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                FuncArgs_56 = FuncArgs0_54;
                {
                  RetTypes_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), RetTypes_57, 0) = ((MR_Box) ((MR_Unsigned) 16U));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 306, &CopyOut_84);
          switch (CopyOut_84) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ml_backend__ml_args_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_95_97_114_103_95_100_101_99_108_115_95_95_91_51_93_95_50_10_p_2(ModuleInfo_14, (MR_Integer) 0, *ArgTuples_9, &FuncArgs0_86, &RetTypes_57, ByRefOutputVars_11, CopiedOutputVars_12, Var_27, &Var_28);
                ContType_58 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[6]));
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                ml_backend__ml_args_util__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_95_97_114_103_95_100_101_99_108_115_95_95_91_51_93_95_50_10_p_2(ModuleInfo_14, (MR_Integer) 2, *ArgTuples_9, &FuncArgs0_86, &RetTypes0_92, ByRefOutputVars_11, CopiedOutputVars_12, Var_27, &Var_28);
                {
                  ContType_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ContType_58, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                  MR_hl_field(MR_mktag(3), ContType_58, 1) = ((MR_Box) (RetTypes0_92));
                }
                RetTypes_57 = (MR_Word) ((MR_Unsigned) 0U);
              }
              break;
          }
          {
            ContArg_60 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ContArg_60, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[7])));
            MR_hl_field(MR_mktag(0), ContArg_60, 1) = ((MR_Box) (ContType_58));
            MR_hl_field(MR_mktag(0), ContArg_60, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (ContArg_60));
            MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_args_util_scalar_common_1[9])));
          }
          FuncArgs_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), FuncArgs0_86, Var_71);
        }
        break;
    }
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (HeadMode_34) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word HeadFuncArg_38;
                MR_Word Info0_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeInfo_41_41, (MR_Integer) 0))));
                MR_Word Context_54;
                MR_Word GCStmt_55;
                MR_Word Info_56;

                mercury__term__context_init_1_p_0(&Context_54);
                ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(HeadMLDSVar_32, HeadType_33, Context_54, &GCStmt_55, Info0_53, &Info_56);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *STATE_VARIABLE_MaybeInfo_10 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Info_56));
                }
                {
                  HeadFuncArg_38 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 0) = ((MR_Box) (HeadMLDSVar_32));
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 1) = ((MR_Box) (HeadMLDS_Type_36));
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 2) = ((MR_Box) (GCStmt_55));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  Info0_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeInfo_41_41, (MR_Integer) 0))));
                  mercury__term__context_init_1_p_0(&Context_65);
                  ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(HeadMLDSVar_32, HeadType_33, Context_65, &GCStmt_66, Info0_64, &Info_67);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_MaybeInfo_10 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Info_67));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), HeadFuncArg_45, 2) = ((MR_Box) (GCStmt_66));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * FuncParams_8)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, ProcInfo_23, &VarTable_24);
  ...
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_5, VarTable_24, HeadVars_25, HeadTypes_26, HeadModes_27, ArgTuples_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 305, &CopyOut_21);
        switch (CopyOut_21) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 306, &CopyOut_55);
        switch (CopyOut_55) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              ...
              ContType_27 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[6]));
            }
            break;
          case (MR_Integer) 1:
            {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ContArg_29, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[7])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (ContArg_29));
          MR_hl_field(MR_mktag(1), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_args_util_scalar_common_1[9])));
        }
        FuncArgs_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), FuncArgs0_57, Var_42);
      }
      break;
  }
  {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      HeadMLDSVarName_22 = ml_backend__ml_code_util__ml_gen_local_var_name_2_f_0(HeadVar_13, HeadVarEntry_21);
      {
        HeadArgTuple_23 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), HeadArgTuple_23, 0) = ((MR_Box) (HeadVar_13));
        MR_hl_field(MR_mktag(0), HeadArgTuple_23, 1) = ((MR_Box) (HeadMLDSVarName_22));
        MR_hl_field(MR_mktag(0), HeadArgTuple_23, 2) = ((MR_Box) (HeadType_15));
        MR_hl_field(MR_mktag(0), HeadArgTuple_23, 3) = (MR_Box) ((MR_Unsigned) (HeadTopFunctorMode_20));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 0:
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (ReturnStmt_27));
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (ReturnStmt_14));
