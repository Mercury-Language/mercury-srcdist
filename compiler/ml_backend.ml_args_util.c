      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 275, &CopyOut_45);
          switch (CopyOut_45) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), SucceededTsccOutVarDefn_61, 2) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 276, &CopyOut_86);
          switch (CopyOut_86) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
...
{
  {
    ...
    MR_Word Detism_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 10))) >> (MR_Integer) 2)) & (MR_Integer) 7);
    MR_Word CodeModel_9;
    MR_Word HeadVars_10;
    MR_Word ArgTypes_11;
    MR_Word TopFunctorModes_12;
    MR_Word ArgTuples_13;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 10)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 12)));
    ...
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 0)));
    ...
    packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 10)));
    packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcId_5, (MR_Integer) 12)));
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 275, &CopyOut_53);
            switch (CopyOut_53) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
              ...
              case (MR_Integer) 1:
                {
                  FuncArgs_57 = FuncArgs0_55;
                  {
                    ...
                    MR_hl_field(MR_mktag(1), RetTypes_58, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        ...
        case (MR_Integer) 2:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 276, &CopyOut_85);
            switch (CopyOut_85) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 275, &CopyOut_21);
          switch (CopyOut_21) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                FuncArgs_25 = FuncArgs0_23;
                {
                  ...
                  MR_hl_field(MR_mktag(1), RetTypes_26, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 276, &CopyOut_55);
          switch (CopyOut_55) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
