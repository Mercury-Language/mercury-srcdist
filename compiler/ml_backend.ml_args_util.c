    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 330, &CopyOut_45);
        switch (CopyOut_45) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 330, &CopyOut_122);
        switch (CopyOut_122) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 331, &CopyOut_79);
        switch (CopyOut_79) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 330, &CopyOut_36);
          switch (CopyOut_36) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 330, &CopyOut_75);
          switch (CopyOut_75) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 331, &CopyOut_60);
          switch (CopyOut_60) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 330, &CopyOut_21);
        switch (CopyOut_21) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 330, &CopyOut_63);
        switch (CopyOut_63) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 331, &CopyOut_48);
        switch (CopyOut_48) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
