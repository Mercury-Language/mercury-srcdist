...
ml_backend__ml_args_util__IntroducedFrom__pred__ml_gen_proc_params_inputs_only_no_gc_stmts__566__1_2_p_0(
  MR_Word RetTypes_11,
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 307, &CopyOut_45);
        switch (CopyOut_45) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 308, &CopyOut_79);
        switch (CopyOut_79) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_args_util__IntroducedFrom__pred__ml_gen_proc_params_inputs_only_no_gc_stmts__566__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_34, (MR_Integer) 307, &CopyOut_35);
          switch (CopyOut_35) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_34, (MR_Integer) 308, &CopyOut_59);
          switch (CopyOut_59) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 0:
              {
                ...
                ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(HeadMLDSVar_32, HeadType_33, Var_49, &GCStmt_47, Info0_46, &Info_48);
                {
                  ...
                  *STATE_VARIABLE_MaybeInfo_10 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Info_48));
                }
                {
                  HeadFuncArg_38 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 0) = ((MR_Box) (HeadMLDSVar_32));
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 1) = ((MR_Box) (HeadMLDS_Type_36));
                  MR_hl_field(MR_mktag(0), HeadFuncArg_38, 2) = ((MR_Box) (GCStmt_47));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(HeadMLDSVar_32, HeadType_33, Var_53, &GCStmt_51, Info0_50, &Info_52);
                  {
                    ...
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_MaybeInfo_10 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Info_52));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), HeadFuncArg_45, 2) = ((MR_Box) (GCStmt_51));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 307, &CopyOut_21);
        switch (CopyOut_21) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 308, &CopyOut_48);
        switch (CopyOut_48) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
