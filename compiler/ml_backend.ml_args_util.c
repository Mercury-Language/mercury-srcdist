  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_14, ProcInfo_36, &VarTable_37);
  ...
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_14, VarTable_37, HeadVars_38, HeadTypes_39, HeadModes_40, ArgTuples_9);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 305, &CopyOut_53);
          switch (CopyOut_53) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 306, &CopyOut_85);
          switch (CopyOut_85) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ...
                ContType_59 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[6]));
              }
              break;
            case (MR_Integer) 1:
              {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ContArg_61, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_args_util_scalar_common_1[7])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (ContArg_61));
            MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_args_util_scalar_common_1[9])));
          }
          FuncArgs_57 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), FuncArgs0_87, Var_72);
        }
        break;
    }
    {
