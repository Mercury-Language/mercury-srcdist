  ...
  MR_Word PredProcId_5)
{
  ...
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_28, &HeadVars_31);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(_PredInfo_7, &HeadTypes_32);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_28, &HeadModes_33);
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_4, VarSet_29, HeadVars_31, HeadTypes_32, HeadModes_33, &ArgTuples_10);
  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_35, &VarSet_36, &_VarTypes_37);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_35, &HeadVars_38);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo_15, &HeadTypes_39);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_35, &HeadModes_40);
  ml_backend__ml_args_util__package_vars_types_modes_6_p_0(ModuleInfo_14, VarSet_36, HeadVars_38, HeadTypes_39, HeadModes_40, ArgTuples_9);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 303, &CopyOut_53);
          switch (CopyOut_53) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 304, &CopyOut_85);
          switch (CopyOut_85) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
