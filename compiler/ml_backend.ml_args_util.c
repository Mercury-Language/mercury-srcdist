  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__16_16 = (MR_Word) (&ml_backend__ml_args_util_scalar_common_1[1]);
                      ...
                      *STATE_VARIABLE_ConvOutputStmts_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), ThisArgConvOutput_72, STATE_VARIABLE_ConvOutputStmts_46_46);
                      ...
                      if (succeeded)
                      {
                        ...
                        ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(*STATE_VARIABLE_Info_37, CalleeType_26, &OutputType_73);
                        {
                          ...
                          MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (ArgLval_69));
                          MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (OutputType_73));
                        }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                        ...
                        else
                          {
                            ...
                            MR_hl_field(MR_mktag(3), Var_76, 1) = ((MR_Box) (ArgLval_69));
                          }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (ContArg_44));
            MR_hl_field(MR_mktag(1), Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_args_util_scalar_common_1[9])));
          }
          FuncArgs_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), FuncArgs0_62, Var_53);
        }
        break;
    }
    {
    ...
    case (MR_Integer) 2:
      {
        ...
        FuncArgs_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), FuncArgs0_50, Var_41);
      }
      break;
  }
  {
