  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_72)
{
  ...
  else
  {
    ...
    hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(GoalFinalIOVar_45, Var_97, Var_98, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__try_expand_scalar_common_2[0])), (MR_Word) ((MR_Unsigned) 0U), &UnifyThenInitialIOVar_48);
  ...
  MR_Word * CastOrUnify_8)
{
  ...
  else
  {
    ...
    hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(TupleVar_6, Var_23, Var_24, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__try_expand_scalar_common_2[0])), (MR_Word) ((MR_Unsigned) 0U), CastOrUnify_8);
  }
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_39)
{
  ...
  hlds__goal_util__generate_plain_call_13_p_0(*STATE_VARIABLE_ModuleInfo_39, (MR_Integer) 0, Var_45, PredName_15, Var_46, Var_47, Var_48, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__try_expand_scalar_common_2[1])), (MR_Integer) 4, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), Context_21, &CallGoal0_30);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_40)
{
  ...
  if ((MaybeIO_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_60 = parse_tree__prog_mode__out_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (OutputTupleVar_20));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), LambdaParamsModes_23, 0) = ((MR_Box) (Var_59));
  ...
  else
  {
    ...
    MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIO_12, (MR_Integer) 0))));
    MR_Word Var_45;
    MR_Word Var_46;
    MR_Word Var_47;
    MR_Word Var_48;
    ...
    IOVarInitial_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 0))));
    IOVarFinal_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 1))));
    Var_46 = parse_tree__prog_mode__out_mode_0_f_0();
    {
      Var_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (OutputTupleVar_20));
    ...
    Var_49 = parse_tree__prog_mode__di_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (IOVarInitial_21));
    ...
    Var_52 = parse_tree__prog_mode__uo_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (IOVarFinal_22));
    ...
    {
      LambdaParamsModes_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), LambdaParamsModes_23, 0) = ((MR_Box) (Var_45));
      MR_hl_field(MR_mktag(1), LambdaParamsModes_23, 1) = ((MR_Box) (Var_47));
    }
  ...
  hlds__goal_util__clone_variables_var_table_6_p_0(Var_71, VarTable0_29, VarTable0_29, &VarTable_30, Var_73, &Renaming_31);
  ...
  BodyGoalInfo_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaBody_32, (MR_Integer) 1))));
  ...
  {
    RHS_37 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), RHS_37, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)))));
    MR_hl_field(MR_mktag(2), RHS_37, 1) = NULL;
    MR_hl_field(MR_mktag(2), RHS_37, 2) = ((MR_Box) (Var_79));
    MR_hl_field(MR_mktag(2), RHS_37, 3) = ((MR_Box) (LambdaParamsModes_23));
    MR_hl_field(MR_mktag(2), RHS_37, 4) = (MR_Box) ((MR_Unsigned) (LambdaDetism_36));
    MR_hl_field(MR_mktag(2), RHS_37, 5) = ((MR_Box) (LambdaBody_32));
  }
  Var_80 = mercury__term__context_init_0_f_0();
  hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(*LambdaVar_13, RHS_37, Var_80, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__try_expand_scalar_common_2[0])), (MR_Word) ((MR_Unsigned) 0U), &AssignLambdaVarGoal0_38);
