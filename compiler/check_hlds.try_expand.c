...
MR_decl_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 25,29,33,37,89,213,212,51,111,56)
MR_decl_label9(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 55,59,19,65,66,64,70,62,74)
...
MR_BEGIN_MODULE(check_hlds__try_expand_module13)
	...
	MR_init_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0,25,29,33,37,89,213,212,51,111,56)
	MR_init_label9(check_hlds__try_expand__expand_try_goals_in_goal_5_0,55,59,19,65,66,64,70,62,74)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,15)
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i56);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,37)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i212);
	}
	MR_r6 = MR_tfield(3, MR_r5, 2);
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i213);
	}
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,213)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r6,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i111);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i56);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,212)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r5,3,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i51);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i56);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,0)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i55);
	}
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,111)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,19)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i62);
	}
	MR_r5 = MR_tfield(3, MR_r4, 1);
	if (MR_PTAG_TESTR(MR_r5,1)) {
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,62)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i89);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_call_localret_ent(check_hlds__try_expand__expand_try_goals_in_cases_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i74);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 4);
