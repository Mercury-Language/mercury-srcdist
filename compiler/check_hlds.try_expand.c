  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__det_analysis__disable_det_warnings_3_p_0(&OptionsToRestore_12, STATE_VARIABLE_Globals_19_19, &STATE_VARIABLE_Globals_20_20);
    ...
    *STATE_VARIABLE_Specs_17 = ((MR_Word) (conv3_STATE_VARIABLE_Specs_17));
    ...
    check_hlds__det_analysis__restore_det_warnings_3_p_0(OptionsToRestore_12, STATE_VARIABLE_Globals_25_25, &STATE_VARIABLE_Globals_26_26);
