...
static /* final */ const MR_Box check_hlds__try_expand_scalar_common_2[2][3];

static /* final */ const MR_Box check_hlds__try_expand_scalar_common_3[2][1];

static /* final */ const MR_Box check_hlds__try_expand_scalar_common_4[2][8];
...
static /* final */ const MR_Box check_hlds__try_expand_scalar_common_2[2][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (&check_hlds__try_expand_scalar_common_4[0])),
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_19, STATE_VARIABLE_ProcInfo_24_24, &InitInstMap_14);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ProcModeErrorMap0_30;
        MR_Word ModeSpecs_33;
        MR_Word Globals_34;
        MR_Word HasModeErrors_35;
        MR_Word STATE_VARIABLE_ProcInfo_32_40;
        MR_Word STATE_VARIABLE_ProcInfo_34_42;
        MR_Word STATE_VARIABLE_ModuleInfo_35_43;
        MR_Word STATE_VARIABLE_ModuleInfo_36_44;
        MR_Word _ProcModeErrorMap0_31;
        MR_Word _Changed_32;

        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_16, STATE_VARIABLE_ProcInfo_28_28, &STATE_VARIABLE_ProcInfo_32_40);
        hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_32_40, &STATE_VARIABLE_ProcInfo_34_42);
        hlds__hlds_module__module_info_set_pred_proc_info_6_p_0(PredId_7, ProcId_8, STATE_VARIABLE_PredInfo_27_27, STATE_VARIABLE_ProcInfo_34_42, STATE_VARIABLE_ModuleInfo_26_26, &STATE_VARIABLE_ModuleInfo_35_43);
        mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__try_expand_scalar_common_2[0]), &ProcModeErrorMap0_30);
        check_hlds__modes__modecheck_proc_8_p_0(PredId_7, ProcId_8, STATE_VARIABLE_ModuleInfo_35_43, &STATE_VARIABLE_ModuleInfo_36_44, ProcModeErrorMap0_30, &_ProcModeErrorMap0_31, &_Changed_32, &ModeSpecs_33);
        hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_36_44, &Globals_34);
        HasModeErrors_35 = parse_tree__error_util__contains_errors_2_f_0(Globals_34, ModeSpecs_33);
        switch (HasModeErrors_35) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word _DetismSpecs_39;

              check_hlds__det_analysis__determinism_check_proc_5_p_0(PredId_7, ProcId_8, STATE_VARIABLE_ModuleInfo_36_44, &STATE_VARIABLE_ModuleInfo_29_29, &_DetismSpecs_39);
              *STATE_VARIABLE_Specs_22 = STATE_VARIABLE_Specs_0_21;
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ProcTable0_36;
              MR_Word ProcTable_37;
              MR_Word UpdatedPredInfo_38;

              *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ModeSpecs_33, STATE_VARIABLE_Specs_0_21);
              hlds__hlds_pred__pred_info_get_proc_table_2_p_0(STATE_VARIABLE_PredInfo_27_27, &ProcTable0_36);
              mercury__map__delete_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_8)), ProcTable0_36, &ProcTable_37);
              hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_37, STATE_VARIABLE_PredInfo_27_27, &UpdatedPredInfo_38);
              hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_7, UpdatedPredInfo_38, STATE_VARIABLE_ModuleInfo_36_44, &STATE_VARIABLE_ModuleInfo_29_29);
            }
            break;
        }
  ...
  MR_Word * STATE_VARIABLE_Info_11)
{
...

  {
    ...
    MR_hl_field(0, Var_12, 0) = ((MR_Box) (&check_hlds__try_expand_scalar_common_4[1]));
