  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_68)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_69_69, GoalOutputVars_30, &GoalOutputVarTypes_31);
  {
  ...
  hlds__vartypes__update_var_type_4_p_0(ResultVar_17, RealResultVarType_33, STATE_VARIABLE_VarTypes_69_69, &STATE_VARIABLE_VarTypes_77_77);
