...
MR_decl_label4(check_hlds__try_expand__expand_try_goal_5_0, 15,22,17,19)
...
MR_decl_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 26,30,34,38,91,196,195,167,60,20)
MR_decl_label7(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 66,67,65,199,73,63,76)
...
MR_BEGIN_MODULE(check_hlds__try_expand_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__try_expand__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__try_expand_module14)
	...
	MR_init_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0,26,30,34,38,91,196,195,167,60,20)
	MR_init_label7(check_hlds__try_expand__expand_try_goals_in_goal_5_0,66,67,65,199,73,63,76)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,196)
	...
	if (MR_INT_NE(MR_r6,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i167);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,195)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,167)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i199);
	}
	MR_r2 = MR_r5;
	MR_np_tailcall_ent(check_hlds__try_expand__expand_try_goal_5_0);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,199)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__check_hlds__try_expand__this_file_0_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i73);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__try_expand_module18)
	...
	MR_init_label4(check_hlds__try_expand__expand_try_goal_5_0,15,22,17,19)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goal_5_0,17)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tempr1;
	MR_r3 = MR_tfield(0, MR_tfield(1, MR_sv(2), 0), 1);
	}
	MR_np_call_localret_ent(set__delete_3_0,
