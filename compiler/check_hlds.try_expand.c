...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__try_expand__Var_47, 0) = ((MR_Box) (&check_hlds__try_expand_scalar_common_8[0]));
    ...
    {
      hlds__goal_util__generate_simple_call_12_p_0(check_hlds__try_expand__Var_57, check_hlds__try_expand__PredName_15, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__try_expand_scalar_common_6[5]), (MR_Integer) 4, (MR_Integer) 0, check_hlds__try_expand__Args_32, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__try_expand__Var_61, *check_hlds__try_expand__STATE_VARIABLE_ModuleInfo_43, check_hlds__try_expand__Context_21, &check_hlds__try_expand__CallGoal0_34);
    }
    {
...
{
  {
    ...
    {
      hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(*check_hlds__try_expand__LambdaVar_13, check_hlds__try_expand__RHS_40, check_hlds__try_expand__Var_84, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__try_expand_scalar_common_6[1]), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), check_hlds__try_expand__AssignLambdaVar_14);
    }
  }
}
...
{
  {
    ...
    if ((check_hlds__try_expand__MaybeIO_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          hlds__hlds_pred__proc_info_create_var_from_type_5_p_0(check_hlds__try_expand__Var_85, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__try_expand_scalar_common_6[0]), &check_hlds__try_expand__TryIOOutputVar_41, check_hlds__try_expand__STATE_VARIABLE_ProcInfo_78_78, &check_hlds__try_expand__STATE_VARIABLE_ProcInfo_87_87);
        }
        {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__try_expand__Var_65, 0) = ((MR_Box) (&check_hlds__try_expand_scalar_common_5[0]));
