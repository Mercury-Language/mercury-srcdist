...
MR_decl_label4(check_hlds__try_expand__expand_try_goal_5_0, 15,17,18,19)
MR_decl_label10(check_hlds__try_expand__expand_try_goal_2_15_0, 2,4,5,7,11,12,13,14,15,18)
...
MR_decl_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 3,5,4,9,8,13,12,17,16,22)
MR_decl_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 26,30,34,38,90,196,195,52,112,57)
MR_decl_label9(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 56,60,20,66,67,65,71,63,75)
...
MR_decl_label10(check_hlds__try_expand__make_try_lambda_8_0, 2,4,6,11,8,18,19,23,25,27)
MR_decl_label10(check_hlds__try_expand__make_try_lambda_8_0, 29,32,33,34,35,36,37,38,39,40)
...
MR_BEGIN_MODULE(check_hlds__try_expand_module4)
	...
	MR_init_label10(check_hlds__try_expand__make_try_lambda_8_0,2,4,6,11,8,18,19,23,25,27)
	MR_init_label10(check_hlds__try_expand__make_try_lambda_8_0,29,32,33,34,35,36,37,38,39,40)
...
MR_def_label(check_hlds__try_expand__make_try_lambda_8_0,25)
	...
	MR_sv(3) = MR_r2;
	MR_np_call_localret_ent(fn__parse_tree__prog_mode__out_mode_0_0,
		check_hlds__try_expand__make_try_lambda_8_0_i27);
MR_def_label(check_hlds__try_expand__make_try_lambda_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(check_hlds__try_expand__make_try_lambda_8_0,53)
	...
	MR_tfield(2, MR_r2, 2) = (MR_Integer) 0;
	MR_tfield(2, MR_r2, 4) = MR_r1;
	MR_tfield(2, MR_r2, 5) = MR_sv(7);
	MR_tfield(2, MR_r2, 6) = MR_sv(5);
	MR_tfield(2, MR_r2, 7) = MR_sv(2);
...
MR_BEGIN_MODULE(check_hlds__try_expand_module7)
	...
	MR_init_label10(check_hlds__try_expand__expand_try_goal_2_15_0,2,4,5,7,11,12,13,14,15,18)
...
MR_BEGIN_MODULE(check_hlds__try_expand_module13)
	...
	MR_init_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0,3,5,4,9,8,13,12,17,16,22)
	MR_init_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0,26,30,34,38,90,196,195,52,112,57)
	MR_init_label9(check_hlds__try_expand__expand_try_goals_in_goal_5_0,56,60,20,66,67,65,71,63,75)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i4);
	}
	MR_incr_sp(9);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,4)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i8);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,8)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,6)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i12);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,12)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i16);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,16)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,5)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i20);
	}
	MR_r5 = MR_tfield(3, MR_r4, 1);
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i22);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i26);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i30);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,34)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i38);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i195);
	}
	MR_r6 = MR_tfield(3, MR_r5, 2);
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i196);
	}
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,196)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r6,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i112);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,195)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r5,3,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i52);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i57);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,0)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i56);
	}
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,112)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i60);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i63);
	}
	MR_r5 = MR_tfield(3, MR_r4, 1);
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i65);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i66);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,63)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,3)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i90);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	...
	MR_np_call_localret_ent(check_hlds__try_expand__expand_try_goals_in_cases_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i75);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 4);
...
MR_BEGIN_MODULE(check_hlds__try_expand_module17)
	...
	MR_init_label4(check_hlds__try_expand__expand_try_goal_5_0,15,17,18,19)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goal_5_0,17)
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_tfield(0, MR_tfield(1, MR_sv(2), 0), 1);
	MR_r3 = MR_tempr1;
	}
	MR_np_call_localret_ent(set__delete_3_0,
