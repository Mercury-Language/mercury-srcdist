...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_17, (MR_Integer) 3)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_81, (MR_Integer) 0)));
                    ...
                    check_hlds__try_expand__expand_try_goals_in_disj_5_p_0(Instmap_6, OrElseGoals0_90, &OrElseGoals_93, STATE_VARIABLE_Info_101_101, STATE_VARIABLE_Info_97);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), GoalExpr_125, 0) = (MR_Box) (packed_args_2);
...
{
  {
    ...
    MR_Word Var_65;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_33, (MR_Integer) 3)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_39_39, (MR_Integer) 3)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_39_39, (MR_Integer) 3)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_50, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), MagicCall_39, (MR_Integer) 3)));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Switch_41, (MR_Integer) 2)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), MagicCall_17, (MR_Integer) 3)));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Switch_19, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_48, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), TestRHS_23, (MR_Integer) 1)));
...
{
  {
...

    {
      ...
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), (env_ptr)->check_hlds__try_expand__make_output_tuple_inst_cast_4_p_0_env_0__ArgInst_9, (MR_Integer) 1)));
