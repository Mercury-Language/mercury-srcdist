          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = ((((MR_tag((MR_Word) Var_55)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_55, (MR_Integer) 0)))) == (MR_Integer) 4)));
                if (succeeded)
                {
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_40)
{
  ...
  hlds__hlds_proc_util__proc_info_create_var_from_type_6_p_0((MR_String) "TryLambda", LambdaType_26, (MR_Integer) 1, LambdaVar_13, STATE_VARIABLE_ProcInfo_43_43, &STATE_VARIABLE_ProcInfo_68_68);
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_68_68, &VarTable0_29);
  ...
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_30, STATE_VARIABLE_ProcInfo_68_68, STATE_VARIABLE_ProcInfo_40);
