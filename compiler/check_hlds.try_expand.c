...
MR_decl_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 26,30,34,189,38,83,52,20,58,59)
MR_decl_label5(check_hlds__try_expand__expand_try_goals_in_goal_5_0, 57,192,65,55,68)
...
MR_BEGIN_MODULE(check_hlds__try_expand_module14)
	...
	MR_init_label10(check_hlds__try_expand__expand_try_goals_in_goal_5_0,26,30,34,189,38,83,52,20,58,59)
	MR_init_label5(check_hlds__try_expand__expand_try_goals_in_goal_5_0,57,192,65,55,68)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,16)
	...
	MR_np_localcall_lab(check_hlds__try_expand__expand_try_goals_in_goal_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i52);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,189)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,38)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i189);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_proceed();
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i55);
	}
	MR_r5 = MR_tfield(3, MR_r4, 1);
	if (MR_PTAG_TESTR(MR_r5,1)) {
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,58)
	...
	MR_np_call_localret_ent(check_hlds__try_expand__expand_try_goals_in_disj_5_0,
		check_hlds__try_expand__expand_try_goals_in_goal_5_0_i59);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i192);
	}
	MR_r2 = MR_r5;
	MR_np_tailcall_ent(check_hlds__try_expand__expand_try_goal_5_0);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,192)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
...
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,65)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__try_expand__expand_try_goals_in_goal_5_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,3)) {
		MR_GOTO_LAB(check_hlds__try_expand__expand_try_goals_in_goal_5_0_i83);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
