            ...
            switch (MR_tag((MR_Word) Reason_43)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, Reason_43, 0))))) {
                  ...
                  case (MR_Integer) 6:
                    {
                      MR_Word Var_171 = ((MR_Unsigned) ((MR_hl_field(3, Reason_43, 2))) & (MR_Integer) 3);
                      ...
                      switch (Var_171) {
                        ...
                        case (MR_Integer) 3:
                          {
                            MR_Word InnerGoal_153;
                            MR_Word GoalExpr_154;

                            check_hlds__try_expand__expand_try_goals_in_goal_5_p_0(InstMap0_6, InnerGoal0_44, &InnerGoal_153, STATE_VARIABLE_Info_0_111, STATE_VARIABLE_Info_112);
                            {
                              GoalExpr_154 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(3, GoalExpr_154, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                              MR_hl_field(3, GoalExpr_154, 1) = ((MR_Box) (Reason_43));
                              MR_hl_field(3, GoalExpr_154, 2) = ((MR_Box) (InnerGoal_153));
                            }
                            {
                              MR_Word base;
                              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  case (MR_Integer) 7:
                    {
                      MR_Word InnerGoal_169;
                      MR_Word GoalExpr_170;

                      check_hlds__try_expand__expand_try_goals_in_goal_5_p_0(InstMap0_6, InnerGoal0_44, &InnerGoal_169, STATE_VARIABLE_Info_0_111, STATE_VARIABLE_Info_112);
                      {
                        GoalExpr_170 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(3, GoalExpr_170, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                        MR_hl_field(3, GoalExpr_170, 1) = ((MR_Box) (Reason_43));
                        MR_hl_field(3, GoalExpr_170, 2) = ((MR_Box) (InnerGoal_169));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        *Goal_8 = base;
                        MR_hl_field(0, base, 0) = ((MR_Box) (GoalExpr_170));
                        MR_hl_field(0, base, 1) = ((MR_Box) (GoalInfo0_11));
                      }
                    }
                    break;
