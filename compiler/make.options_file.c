...
{
  {
    ...
    else
    {
      ...
      switch (make__options_file__Search_12) {
        ...
        case (MR_Integer) 0:
          {
            libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_10, (MR_Integer) 649, &make__options_file__SearchDirs_17);
          }
          break;
      }
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_6, (MR_Integer) 647, &make__options_file__OptionsFiles_9);
    {
