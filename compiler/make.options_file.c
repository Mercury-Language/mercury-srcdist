            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    STATE_VARIABLE_ParseSpecs_67_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_ParseSpecs_67_67, 0) = ((MR_Box) (ParseSpec_123));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_ParseSpecs_67_67, 1) = ((MR_Box) (STATE_VARIABLE_ParseSpecs_0_7));
                  }
                  STATE_VARIABLE_RevChars_69_69 = STATE_VARIABLE_RevChars_0_5;
                  STATE_VARIABLE_UndefVarNames_68_68 = STATE_VARIABLE_UndefVarNames_0_9;
          ...
          case (MR_Char) 43:
            {
              ...
              if (succeeded)
              {
                Var_30 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0)));
          ...
          case (MR_Char) 58:
            {
              ...
              if (succeeded)
              {
                Var_33 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 0)));
                Line3_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_82, (MR_Integer) 1))));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          conv0_Var_33 = mercury__list__det_head_1_f_0(TypeInfo_75_56, TopDownIncludes_16);
          ...
          InclMsgs_21 = mercury__list__map_2_f_0(TypeInfo_75_56, TypeCtorInfo_76_57, Var_38, TopDownIncludes_16);
          ...
          Var_43 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_76_57, Var_44, Var_45);
          {
