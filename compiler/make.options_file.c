  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_15 = make__options_file__IntroducedFrom__func__convert_to_mmc_options_with_value__1414__1_2_f_0(((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__options_file__IntroducedFrom__pred__parse_variable_name__866__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
