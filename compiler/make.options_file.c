  ...
  MR_Word * UndefSpecs_12)
{
  ...
  mercury__getopt__lookup_accumulating_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_9, ((MR_Box) ((MR_Integer) 710)), &OptionsFiles_14);
