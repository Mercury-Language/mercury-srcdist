    ...
    if ((make__options_file__MaybeEnvValue_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), make__options_file__Var_59, 0) = ((MR_Box) (&make__options_file_scalar_common_6[5]));
        ...
        if (((MR_tag((MR_Word) make__options_file__SplitResult_14)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), make__options_file__Var_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &make__options_file_scalar_common_2[42])));
            }
            {
              make__options_file__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), make__options_file__Var_40, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[41])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), make__options_file__Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[40])));
                ...
                *make__options_file__Result_12 = make__options_file__Result0_23;
              else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), make__options_file__Var_59, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[39])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), make__options_file__Var_56, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[38])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), make__options_file__Var_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[37])));
                    MR_hl_field(MR_mktag(1), make__options_file__Var_53, 1) = ((MR_Box) (make__options_file__Var_56));
                  }
                  {
                    make__options_file__Pieces_31 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, make__options_file__Var_53, (MR_Word) MR_mkword(MR_mktag(1), &make__options_file_scalar_common_2[33]));
                  }
                  {
          ...
          case (MR_Integer) 16:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), make__options_file__Var_177, 0) = ((MR_Box) (&make__options_file_scalar_common_7[1]));
          ...
          case (MR_Integer) 17:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), make__options_file__Var_185, 0) = ((MR_Box) (&make__options_file_scalar_common_7[1]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), make__options_file__Var_22, 0) = ((MR_Box) (&make__options_file_scalar_common_10[0]));
    ...
    {
      make__options_file__succeeded = mercury__list__map_3_p_2(make__options_file__TypeInfo_39_39, (MR_Word) &make__options_file_scalar_common_2[2], (MR_Word) &make__options_file_scalar_common_1[13], make__options_file__Results_13, &make__options_file__Values_18);
    }
    if (make__options_file__succeeded)
      {
        ...
        {
          make__options_file__Var_30 = mercury__list__map_2_f_0((MR_Word) &make__options_file_scalar_common_1[2], (MR_Word) &make__options_file_scalar_common_2[0], (MR_Word) &make__options_file_scalar_common_1[14], make__options_file__VariableValues_19);
        }
        {
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          mercury__list__drop_while_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &make__options_file_scalar_common_1[12], make__options_file__Chars0_4, &make__options_file__Chars1_7);
        }
    ...
    if (make__options_file__succeeded)
      {
        ...
        {
          mercury__list__drop_while_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &make__options_file_scalar_common_1[8], make__options_file__Line3_8, &make__options_file__Line4_9);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
      {
        ...
        {
          mercury__list__drop_while_3_p_0(make__options_file__TypeCtorInfo_42_42, (MR_Word) &make__options_file_scalar_common_1[10], make__options_file__Line1_34, &make__options_file__Line2_35);
        }
        ...
        {
          mercury__list__drop_while_3_p_0(make__options_file__TypeCtorInfo_42_42, (MR_Word) &make__options_file_scalar_common_1[11], make__options_file__Line4_37, &make__options_file__VarValue_12);
        }
        {
          MR_Word base;
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                make__options_file__Var_38 = mercury__list__map_2_f_0(make__options_file__TypeCtorInfo_48_56, make__options_file__TypeCtorInfo_48_56, (MR_Word) &make__options_file_scalar_common_1[7], make__options_file__Var_40);
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), make__options_file__Var_41, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[34])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), make__options_file__Var_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &make__options_file_scalar_common_2[36])));
              }
              {
        ...
        if (((MR_tag((MR_Word) make__options_file__ParsedLine_15)) == (MR_mktag((MR_Integer) 0))))
        ...
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), make__options_file__Var_31, 0) = ((MR_Box) (&make__options_file_scalar_common_8[0]));
    ...
    if (make__options_file__succeeded)
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), make__options_file__Var_45, 0) = ((MR_Box) (&make__options_file_scalar_common_7[0]));
        ...
        switch (make__options_file__Search_12) {
          ...
          case (MR_Integer) 0:
            {
              {
                libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_10, (MR_Integer) 646, &make__options_file__SearchDirs_17);
              }
            }
            break;
        }
        ...
        if (((MR_tag((MR_Word) make__options_file__MaybeDirAndStream_23)) == (MR_mktag((MR_Integer) 1))))
              ...
              case (MR_Integer) 0:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), make__options_file__Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &make__options_file_scalar_common_2[33])));
                  }
                  {
                    make__options_file__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), make__options_file__Var_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &make__options_file_scalar_common_2[31])));
        ...
        else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), make__options_file__Var_78, 0) = ((MR_Box) (&make__options_file_scalar_common_7[0]));
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_6, (MR_Integer) 644, &make__options_file__OptionsFiles_9);
    }
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), make__options_file__Var_15, 0) = ((MR_Box) (&make__options_file_scalar_common_4[0]));
