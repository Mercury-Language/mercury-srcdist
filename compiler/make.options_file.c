    ...
    else
    {
      ...
      switch (Search_12) {
        ...
        case (MR_Integer) 1:
          ...
          break;
        case (MR_Integer) 0:
          libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 669, &SearchDirs_17);
          break;
      }
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 667, &OptionsFiles_9);
    {
