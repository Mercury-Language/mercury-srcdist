...
{
  {
    ...
    if ((make__options_file__V_10_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(make__options_file__Globals_5, (MR_Integer) 26, &make__options_file__Warn_22);
        }
    ...
    else
      {
        ...
        switch (make__options_file__Search_12) {
          ...
          case (MR_Integer) 0:
            {
              {
                libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_10, (MR_Integer) 635, &make__options_file__SearchDirs_17);
              }
            }
            break;
        }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(make__options_file__Globals_6, (MR_Integer) 633, &make__options_file__OptionsFiles_9);
    }
    {
