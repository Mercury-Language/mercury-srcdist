  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_Chars0_4 = Chars_11;
          MR_Word next_value_of_RevWords0_5 = Var_13;
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__1_1 = Var_15;
              MR_Word next_value_of_HeadVar__3_3 = Chars1_12;
          ...
          else
          {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  /* direct tailcall eliminated */
                  {
                    ...
                    MR_Word next_value_of_HeadVar__3_3 = Chars1_20;
            ...
            else
            {
              ...
              /* direct tailcall eliminated */
              {
                ...
                MR_Word next_value_of_HeadVar__3_3 = Chars0_9;
        ...
        else
        {
          ...
          if (succeeded)
            ...
            else
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_String0_1 = String1_17;
                MR_Word next_value_of_HeadVar__3_3 = Chars1_16;
          ...
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_String0_1 = Var_21;
              MR_Word next_value_of_HeadVar__3_3 = Chars0_13;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__2_2 = Chars1_26;
                MR_Word next_value_of_STATE_VARIABLE_RevChars_0_3 = STATE_VARIABLE_RevChars_40_40;
            ...
            else
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__2_2 = Chars4_31;
                MR_Word next_value_of_STATE_VARIABLE_RevChars_0_3 = STATE_VARIABLE_RevChars_49_49;
                MR_Word next_value_of_STATE_VARIABLE_RevUndef_0_5 = STATE_VARIABLE_RevUndef_47_47;
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = Chars_21;
            MR_Word next_value_of_STATE_VARIABLE_RevChars_0_3 = STATE_VARIABLE_RevChars_56_56;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__2_2 = Var_15;
            MR_Word next_value_of_HeadVar__4_4 = Chars0_12;
            ...
            else
            {
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      /* direct tailcall eliminated */
                      {
                        MR_Word next_value_of_STATE_VARIABLE_Chars_0_13 = STATE_VARIABLE_Chars_23_23;
              ...
              else
              {
                ...
                else
                {
                  ...
                  /* direct tailcall eliminated */
                  {
                    MR_Word next_value_of_STATE_VARIABLE_Chars_0_13 = STATE_VARIABLE_Chars_29_29;
...
{
  {
    ...
    else
    {
      ...
      switch (Search_12) {
        ...
        case (MR_Integer) 0:
          {
            libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 649, &SearchDirs_17);
          }
          break;
      }
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 647, &OptionsFiles_9);
    {
