...
make__options_file__IntroducedFrom__func__convert_to_mmc_options_with_value__1416__1_2_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_15 = make__options_file__IntroducedFrom__func__convert_to_mmc_options_with_value__1416__1_2_f_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * MaybeOptionsFileLine_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_96 = mercury__string__from_char_list_1_f_0(FirstWordChars_86);
      {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_94, 1) = ((MR_Box) (MR_mkword(1, &make__options_file_scalar_common_1[15])));
      }
      {
        ...
        MR_hl_field(1, Pieces_87, 1) = ((MR_Box) (Var_94));
      }
      {
