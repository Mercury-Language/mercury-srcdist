...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_24, Var_41, Var_42);
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Line0_3)) == (MR_Integer) 1);
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) Line2_35)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((MR_tag((MR_Word) Chars2_29)) == (MR_Integer) 1);
              if (succeeded)
              {
...
{
  {
    ...
    else
    {
      ...
      switch (Search_12) {
        ...
        case (MR_Integer) 0:
          {
            libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 662, &SearchDirs_17);
          }
          break;
      }
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((MR_tag((MR_Word) Dirs_21)) == (MR_Integer) 1);
              if (succeeded)
              {
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 660, &OptionsFiles_9);
    {
