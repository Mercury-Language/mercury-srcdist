        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            Pieces_28 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_45, (MR_Word) (MR_mkword(1, &make__options_file_scalar_common_1[92])));
            {
              ...
              MR_hl_field(1, Spec_30, 0) = ((MR_Box) ((MR_String) "predicate \140make.options_file.lookup_options_variable\'/6"));
              MR_hl_field(1, Spec_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(1, Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 16U));
              MR_hl_field(1, Spec_30, 3) = ((MR_Box) (Pieces_28));
            }
            {
              MR_Word base;
  ...
  else
  {
    ...
    else
    {
      ...
      Pieces_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_65, (MR_Word) (MR_mkword(1, &make__options_file_scalar_common_1[95])));
      {
        ...
        MR_hl_field(0, Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140make.options_file.report_any_undefined_variables\'/5"));
        MR_hl_field(0, Spec_64, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(0, Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 16U));
        MR_hl_field(0, Spec_64, 3) = ((MR_Box) (Context_62));
