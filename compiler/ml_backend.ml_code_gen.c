        ...
        case (MR_Integer) 6:
          {
            ...
            SubGoal_124 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 0))));
            SubGoals_125 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 1))));
            NonLocals_126 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(SubGoal_124);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_126, Var_63, &STATE_VARIABLE_SubGoalNonLocals_13_129);
