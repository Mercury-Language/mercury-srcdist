...
MR_decl_label10(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0, 6,8,9,3,11,15,14,19,88,21)
MR_decl_label10(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0, 17,32,33,34,35,36,37,28,39,41)
MR_decl_label8(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0, 43,46,45,50,54,57,60,48)
...
MR_BEGIN_MODULE(ml_backend__ml_code_gen_module4)
	...
	MR_init_label10(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,6,8,9,3,11,15,14,19,88,21)
	MR_init_label10(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,17,32,33,34,35,36,37,28,39,41)
	MR_init_label8(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,43,46,45,50,54,57,60,48)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,3)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__init_0_0,
		ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i15);
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i14);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,14)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i17);
	}
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,21)
	...
	if (MR_PTAG_TESTR(MR_r3,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i88);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,17)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i28);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,36)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_get_nonlocals_1_0,
		ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i37);
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i39);
	}
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,39)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i41);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,41)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i43);
	}
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,43)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i45);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,45)
	...
	if (MR_PTAG_TESTR(MR_tempr1,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i50);
	}
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i54);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	{
	MR_Word MR_tempr1;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,1)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i57);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	{
	MR_Word MR_tempr1;
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r3,3,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0_i60);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ml_backend.ml_code_gen", 22);
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_ite_9_0,13)
	...
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(7);
	MR_r3 = (MR_Word) MR_TAG_COMMON(3,0,1);
	MR_r4 = MR_tempr1;
	}
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_ite_9_0,22)
	...
	MR_r1 = MR_sv(11);
	MR_r2 = MR_sv(7);
	MR_r3 = (MR_Word) MR_TAG_COMMON(3,0,0);
	MR_r4 = MR_sv(6);
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_gen_set_cond_var_5_0,
