  ...
  MR_Word * STATE_VARIABLE_Info_17)
{
  ...
  MR_Word LocalVarDefns_25;
  MR_Word FuncDefns_26;
  MR_Word Stmts_27;
  MR_Word GoalInfo_29;
  MR_Word Context_30;
  MR_Word GoalInfo_37;
  ...
  ml_backend__ml_code_gen__ml_gen_goal_7_p_0(CodeModel_8, Goal_9, &LocalVarDefns_25, &FuncDefns_26, &Stmts_27, STATE_VARIABLE_Info_0_16, &STATE_VARIABLE_Info_18_18);
  GoalInfo_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 1))));
  Context_30 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_29);
  *Stmt_10 = ml_backend__ml_code_util__ml_gen_block_4_f_0(LocalVarDefns_25, FuncDefns_26, Stmts_27, Context_30);
  GoalInfo_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_9, (MR_Integer) 1))));
  InstMapDelta_38 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_37);
  succeeded = hlds__instmap__instmap_delta_is_reachable_1_p_0(InstMapDelta_38);
  if (succeeded)
  {
    MR_Word ConstVarMap_39;

    ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_18_18, &ConstVarMap_39);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_ReachableConstVarMaps_15 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ConstVarMap_39));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__656__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_89)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr_14)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Unification_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_14, (MR_Integer) 3))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word PredId_25 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_14, (MR_Integer) 0))));
        MR_Integer ProcId_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), GoalExpr_14, (MR_Integer) 1))));
        MR_Word ArgVars_27 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_14, (MR_Integer) 2))));
        MR_Word BuiltinState_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_14, (MR_Integer) 3))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word GenericCall_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 1))));
            MR_Word Vars_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))));
            MR_Word Modes_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 3))));
            MR_Word Detism_35 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 5))) & (MR_Integer) 7);
            MR_Word CallCodeModel_36;
            MR_Word Var_93;
            ...
            hlds__code_model__determinism_to_code_model_2_p_0(Detism_35, &CallCodeModel_36);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&ml_backend__ml_code_gen_scalar_common_2[1]));
              MR_hl_field(MR_mktag(0), Var_93, 1) = ((MR_Box) (ml_backend__ml_code_gen__ml_gen_goal_expr_10_p_0_1));
              MR_hl_field(MR_mktag(0), Var_93, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_93, 3) = ((MR_Box) (CodeModel_12));
              MR_hl_field(MR_mktag(0), Var_93, 4) = ((MR_Box) (CallCodeModel_36));
            }
        ...
        case (MR_Integer) 1:
          {
            MR_Word Attributes_37 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 1))));
            MR_Word Args_38 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 4))));
            MR_Word ExtraArgs_39 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 5))));
            MR_Word MaybeTraceRuntimeCond_40 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 6))));
            MR_Word PragmaImpl_41 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 7))));
            MR_String ForeignCode_42 = ((MR_String) ((MR_hl_field(MR_mktag(0), PragmaImpl_41, (MR_Integer) 0))));
            MR_Word MaybeContext_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PragmaImpl_41, (MR_Integer) 1))));
            MR_Word ContextToUse_44;
            MR_Word PredId_125 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))));
            MR_Integer ProcId_126 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 3))));

            if ((MaybeContext_43 == (MR_Word) ((MR_Unsigned) 0U)))
              ContextToUse_44 = Context_13;
            else
              ContextToUse_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeContext_43, (MR_Integer) 0))));
            ...
            {
              MR_Word TraceRuntimeCond_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTraceRuntimeCond_40, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word Conjuncts_47 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))));
        ...
        case (MR_Integer) 3:
          {
            MR_Word Disjuncts_51 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 1))));
        ...
        case (MR_Integer) 4:
          {
            MR_Word Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 1))));
            MR_Word CanFail_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_Word CasesList_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 3))));
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 1))));
            MR_Word SubGoal_127 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))));
            ...
            switch (MR_tag((MR_Word) Reason_60)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word HeadWarning_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason_60, (MR_Integer) 0))) & (MR_Integer) 7);
                  MR_Word TailWarnings_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Reason_60, (MR_Integer) 1))));
                  ...
                  ml_backend__ml_gen_info__ml_gen_info_get_disabled_warnings_2_p_0(STATE_VARIABLE_Info_0_88, &Warnings0_76);
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_113, 0) = ((MR_Box) (HeadWarning_74));
                    MR_hl_field(MR_mktag(1), Var_113, 1) = ((MR_Box) (TailWarnings_75));
                  }
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  ...
                  case (MR_Integer) 6:
                    {
                      MR_Word Var_133 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 2))) & (MR_Integer) 3);
                      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 1))));
        ...
        case (MR_Integer) 6:
          {
            MR_Word Cond_56 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 2))));
            MR_Word Then_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 3))));
            MR_Word Else_58 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 4))));
  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  {
    MR_Word Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Conjuncts_11, (MR_Integer) 1))));
    MR_Word Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Conjuncts_11, (MR_Integer) 0))));
    ...
    {
      MR_Word HeadGoalInfo_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_46, (MR_Integer) 1))));
      ...
      else
      {
        ...
        hlds__code_model__determinism_to_code_model_2_p_0(HeadDeterminism_23, &HeadCodeModel_25);
        {
          ...
          MR_hl_field(MR_mktag(0), DoGenHead_26, 0) = ((MR_Box) (&ml_backend__ml_code_gen_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), DoGenHead_26, 1) = ((MR_Box) (ml_backend__ml_code_gen__ml_gen_conj_8_p_0_1));
          MR_hl_field(MR_mktag(0), DoGenHead_26, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), DoGenHead_26, 3) = ((MR_Box) (HeadCodeModel_25));
          MR_hl_field(MR_mktag(0), DoGenHead_26, 4) = ((MR_Box) (Var_46));
        }
        {
          DoGenTail_27 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), DoGenTail_27, 0) = ((MR_Box) (&ml_backend__ml_code_gen_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), DoGenTail_27, 1) = ((MR_Box) (ml_backend__ml_code_gen__ml_gen_conj_8_p_0_2));
          MR_hl_field(MR_mktag(0), DoGenTail_27, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), DoGenTail_27, 3) = ((MR_Box) (CodeModel_9));
          MR_hl_field(MR_mktag(0), DoGenTail_27, 4) = ((MR_Box) (Context_10));
          MR_hl_field(MR_mktag(0), DoGenTail_27, 5) = ((MR_Box) (Var_45));
        }
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word HeadGoal_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))));
      MR_Word TailGoals_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      MR_Word HeadVars_28;
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word InitConstVarMap_80;
        MR_Word STATE_VARIABLE_Info_22_81;
        MR_Word GoalInfo_88;
        MR_Word InstMapDelta_89;

        ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_0_28, &InitConstVarMap_80);
        ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 1, Cond_9, LocalVarDefns_12, FuncDefns_13, Stmts_14, STATE_VARIABLE_Info_0_28, &STATE_VARIABLE_Info_22_81);
        GoalInfo_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond_9, (MR_Integer) 1))));
        InstMapDelta_89 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_88);
        succeeded = hlds__instmap__instmap_delta_is_reachable_1_p_0(InstMapDelta_89);
        if (succeeded)
        {
          MR_Word ConstVarMap_90;

          ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_22_81, &ConstVarMap_90);
        }
        ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_80, STATE_VARIABLE_Info_22_81, &STATE_VARIABLE_Info_32_32);
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_code_gen__ml_gen_goal_as_branch_9_p_0((MR_Integer) 0, Cond_9, LocalVarDefns_12, FuncDefns_13, &CondStmts_24, (MR_Word) ((MR_Unsigned) 0U), &_ReachableConstVarMaps_60, STATE_VARIABLE_Info_0_28, &STATE_VARIABLE_Info_37_37);
            ...
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[4])), Context_11, &SetSuccessFalseStmt_25, STATE_VARIABLE_Info_39_39, STATE_VARIABLE_Info_29);
            {
              Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (SetSuccessFalseStmt_25));
        ...
        case (MR_Integer) 1:
          {
            ...
            ml_backend__ml_code_gen__ml_gen_goal_as_branch_9_p_0((MR_Integer) 1, Cond_9, LocalVarDefns_12, FuncDefns_13, &CondStmts_66, (MR_Word) ((MR_Unsigned) 0U), &_ReachableConstVarMaps_62, STATE_VARIABLE_Info_0_28, &STATE_VARIABLE_Info_47_47);
            ...
            ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_26, STATE_VARIABLE_Info_49_49, &STATE_VARIABLE_Info_50_50);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_51, 1) = ((MR_Box) ((MR_Unsigned) 16U));
              MR_hl_field(MR_mktag(3), Var_51, 2) = ((MR_Box) (Succeeded_26));
            }
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0(Var_51, Context_11, &InvertSuccessStmt_27, STATE_VARIABLE_Info_50_50, STATE_VARIABLE_Info_29);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (InvertSuccessStmt_27));
    ...
    case (MR_Integer) 0:
      {
        ...
        *FuncDefns_17 = (MR_Word) ((MR_Unsigned) 0U);
        {
          Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (ThenStmt_25));
          MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (*LocalVarDefns_16));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(Var_85, STATE_VARIABLE_Info_84_84, &STATE_VARIABLE_Info_86_86);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (ThenStmt_106));
          MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_89, 0) = ((MR_Box) (SetCondTrue_45));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ThenFuncBody_46, 2) = ((MR_Box) (Var_89));
        ...
        ml_backend__ml_code_gen__ml_gen_record_consensus_const_var_map_3_p_0(ReachableConstVarMaps_113, STATE_VARIABLE_Info_95_95, STATE_VARIABLE_Info_50);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_97, 1) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(3), Var_97, 2) = ((MR_Box) (CondSucceeded_48));
        }
        {
          IfStmt_114 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), IfStmt_114, 0) = ((MR_Box) (Var_97));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (ThenFuncDefn_47));
        ...
        *FuncDefns_17 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), CondFuncDefns_109, Var_100);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (SetCondFalse_37));
          MR_hl_field(MR_mktag(1), Var_102, 1) = ((MR_Box) (CondStmts_110));
        }
        {
          Var_103 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_103, 0) = ((MR_Box) (IfStmt_114));
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_gen__ml_gen_record_consensus_const_var_map_3_p_0(ReachableConstVarMaps_33, STATE_VARIABLE_Info_63_63, STATE_VARIABLE_Info_50);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (ElseStmt_32));
        }
        {
          ...
          MR_hl_field(MR_mktag(2), IfStmt_34, 2) = ((MR_Box) (Var_65));
          MR_hl_field(MR_mktag(2), IfStmt_34, 3) = ((MR_Box) (Context_15));
        }
        {
          Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (IfStmt_34));
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  MR_Word SubGoalNonLocals_33;
  MR_Word NonLocals_34;
  MR_Word VarsToDeclareSet_35;
  MR_Word VarsToDeclare0_36;

  ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_24, &VarTable_16);
  ml_backend__ml_code_gen__goal_expr_find_subgoal_nonlocals_2_p_0(GoalExpr_14, &SubGoalNonLocals_33);
  NonLocals_34 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo_15);
  parse_tree__set_of_var__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), SubGoalNonLocals_33, NonLocals_34, &VarsToDeclareSet_35);
  parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarsToDeclareSet_35, &VarsToDeclare0_36);
  Context_18 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_15);
  if ((VarsToDeclare0_36 == (MR_Word) ((MR_Unsigned) 0U)))
  {
  ...
  else
  {
    ...
    MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), VarsToDeclare0_36, (MR_Integer) 1))));

    if ((Var_44 == (MR_Word) ((MR_Unsigned) 0U)))
      VarsToDeclare_17 = VarsToDeclare0_36;
    else
      VarsToDeclare_17 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTable_16, VarsToDeclare0_36);
  ...
  MR_Word * STATE_VARIABLE_Info_21)
{
  ...
  GoalInfo_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_11, (MR_Integer) 1))));
  InstMapDelta_30 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_29);
  succeeded = hlds__instmap__instmap_delta_is_reachable_1_p_0(InstMapDelta_30);
  if (succeeded)
  {
    MR_Word ConstVarMap_31;

    ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_22_22, &ConstVarMap_31);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_ReachableConstVarMaps_19 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ConstVarMap_31));
  ...
  switch (MR_tag((MR_Word) GoalExpr_3)) {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (LHSVar_10));
                MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (ArgVars_12));
              }
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (LHSVar_85));
                MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (ArgVars_87));
              }
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (RHSVar_19));
                MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              {
                Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (LHSVar_89));
              ...
              case (MR_Integer) 0:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (RHSVar_91));
                    MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  {
                    Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (LHSVar_90));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (HOVar_32));
                    MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (ArgVars_93));
                  }
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (MethodVar_36));
                    MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (ArgVars_93));
                  }
        ...
        case (MR_Integer) 3:
          {
            MR_Word SubGoals_118 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 1))));
            MR_Word Var_119;
        ...
        case (MR_Integer) 5:
          {
            MR_Word SubGoal_121 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 2))));
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_Word STATE_VARIABLE_SubGoalNonLocals_13_131;
            MR_Word SubGoal_136;
            MR_Word SubGoals_137;
            MR_Word NonLocals_139;
            MR_Word STATE_VARIABLE_SubGoalNonLocals_13_142;
            MR_Word SubGoal_147;
            MR_Word NonLocals_150;

            {
              Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (Else_55));
              MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (Then_54));
              MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) (Var_78));
            }
            {
              Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (Cond_53));
            ...
            SubGoal_125 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_75, (MR_Integer) 0))));
            SubGoals_126 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_75, (MR_Integer) 1))));
            NonLocals_128 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(SubGoal_125);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_128, Var_76, &STATE_VARIABLE_SubGoalNonLocals_13_131);
            SubGoal_136 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SubGoals_126, (MR_Integer) 0))));
            SubGoals_137 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SubGoals_126, (MR_Integer) 1))));
            NonLocals_139 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(SubGoal_136);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_139, STATE_VARIABLE_SubGoalNonLocals_13_131, &STATE_VARIABLE_SubGoalNonLocals_13_142);
            SubGoal_147 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SubGoals_137, (MR_Integer) 0))));
            NonLocals_150 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(SubGoal_147);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_150, STATE_VARIABLE_SubGoalNonLocals_13_142, SubGoalNonLocals_4);
          }
          break;
        case (MR_Integer) 7:
          {
  ...
  MR_Word * STATE_VARIABLE_Info_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      IsDummy_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_18, (MR_Integer) 2))) & (MR_Integer) 1);
      switch (IsDummy_21) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
        ...
        case (MR_Integer) 1:
          {
            ...
            ml_backend__ml_code_gen__ml_gen_local_var_decls_6_p_0(VarTable_1, Context_2, Vars_15, &TailDefns_24, STATE_VARIABLE_Info_28_28, STATE_VARIABLE_Info_6);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (HeadDefn_23));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TailDefns_24));
            }
          }
          break;
      }
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_code_util__ml_gen_call_current_success_cont_4_p_0(Context_10, &CallCont_14, STATE_VARIABLE_Info_0_19, STATE_VARIABLE_Info_20);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (CallCont_14));
        ...
        case (MR_Integer) 1:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (IfStmt_16));
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[3])), Context_10, &SetSuccessTrue_13, STATE_VARIABLE_Info_0_19, STATE_VARIABLE_Info_20);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (SetSuccessTrue_13));
