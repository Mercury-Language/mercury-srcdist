...
ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__583__1_2_p_0(
...
static /* final */ const MR_Box ml_backend__ml_code_gen_scalar_common_1[4][2];
...
{
  {
    ...
    succeeded = ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__583__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_unify_gen__ml_gen_unification_7_p_0(Unification_21, CodeModel_11, Context_12, LocalVarDefns_14, Stmts_16, STATE_VARIABLE_Info_0_82, STATE_VARIABLE_Info_83);
          *FuncDefns_15 = (MR_Word) ((MR_Integer) 0);
        }
        break;
      case (MR_Integer) 2:
        {
...
{
  {
    ...
    if ((Conjuncts_9 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      *LocalVarDefns_12 = (MR_Word) ((MR_Integer) 0);
      *FuncDefns_13 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
...
{
  {
    ...
    MR_Word EntryPackedArgsMap_19;

    CondCodeModel_18 = hlds__code_model__goal_info_get_code_model_1_f_0(CondGoalInfo_17);
    ml_backend__ml_gen_info__ml_gen_info_get_packed_args_map_2_p_0(STATE_VARIABLE_Info_0_26, &EntryPackedArgsMap_19);
    switch (CodeModel_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_19, STATE_VARIABLE_Info_44_44, &STATE_VARIABLE_Info_45_45);
              ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[3])), Context_11, &SetSuccessFalse_23, STATE_VARIABLE_Info_45_45, STATE_VARIABLE_Info_27);
              {
          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_19, STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_36_36);
              ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_24, STATE_VARIABLE_Info_36_36, &STATE_VARIABLE_Info_37_37);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) ((MR_Integer) 16));
...
{
  {
    ...
    MR_Word EntryPackedArgsMap_23;

    CondCodeModel_22 = hlds__code_model__goal_info_get_code_model_1_f_0(CondGoalInfo_21);
    ml_backend__ml_gen_info__ml_gen_info_get_packed_args_map_2_p_0(STATE_VARIABLE_Info_0_48, &EntryPackedArgsMap_23);
      ...
      case (MR_Integer) 2:
        {
          ...
          ml_backend__ml_code_util__ml_gen_set_cond_var_4_p_0(CondVar_34, (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[3])), Context_15, &SetCondFalse_36);
          ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0((MR_Word) ((MR_Integer) 0), &ThenFuncLabel_37, &ThenFuncLabelRval_38, STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_54_54);
          ml_backend__ml_code_util__ml_get_env_ptr_1_p_0(&EnvPtrRval_39);
          {
            SuccessCont_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), SuccessCont_40, 2) = ((MR_Box) ((MR_Integer) 0));
          }
          ...
          ml_backend__ml_code_util__ml_gen_set_cond_var_4_p_0(CondVar_34, (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[2])), ThenContext_43, &SetCondTrue_44);
          Var_62 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_code_gen_scalar_common_1[1]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_62, STATE_VARIABLE_Info_59_59, &STATE_VARIABLE_Info_63_63);
          ...
          Var_67 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_code_gen_scalar_common_1[1]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_67, STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_Info_68_68);
          {
          ...
          {
            ThenFuncBody_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ThenFuncBody_45, 0) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), ThenFuncBody_45, 1) = ((MR_Box) ((MR_Integer) 0));
          ...
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_23, STATE_VARIABLE_Info_74_74, &STATE_VARIABLE_Info_75_75);
          ...
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_23, STATE_VARIABLE_Info_76_76, &STATE_VARIABLE_Info_77_77);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(EntryConstVarMap_33, STATE_VARIABLE_Info_77_77, STATE_VARIABLE_Info_49);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_79, 1) = ((MR_Box) ((MR_Integer) 16));
            MR_hl_field(MR_mktag(3), Var_79, 2) = ((MR_Box) (CondSucceeded_47));
          }
          {
            IfStmt_110 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), IfStmt_110, 0) = ((MR_Box) (Var_79));
            MR_hl_field(MR_mktag(2), IfStmt_110, 1) = ((MR_Box) (ElseStmt_109));
            MR_hl_field(MR_mktag(2), IfStmt_110, 2) = ((MR_Box) ((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_23, STATE_VARIABLE_Info_91_91, &STATE_VARIABLE_Info_92_92);
          ...
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(EntryPackedArgsMap_23, STATE_VARIABLE_Info_93_93, &STATE_VARIABLE_Info_94_94);
          ...
          {
            Var_96 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_96, 0) = ((MR_Box) (ElseStmt_31));
          }
          {
            IfStmt_32 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((VarsToDeclare0_39 == (MR_Word) ((MR_Integer) 0)))
    {
      VarDefns_20 = (MR_Word) ((MR_Integer) 0);
        ...
        case (MR_Integer) 1:
          {
            ...
            ml_backend__ml_code_util__ml_gen_call_current_success_cont_4_p_0(Context_10, &CallCont_46, STATE_VARIABLE_Info_21_21, STATE_VARIABLE_Info_20);
            {
              ...
              MR_hl_field(MR_mktag(2), IfStmt_16, 2) = ((MR_Box) ((MR_Integer) 0));
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_1[2])), Context_10, &SetSuccessTrue_13, STATE_VARIABLE_Info_0_19, STATE_VARIABLE_Info_20);
            {
