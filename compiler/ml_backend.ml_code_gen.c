          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_24, STATE_VARIABLE_Info_36_36, &STATE_VARIABLE_Info_37_37);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
      ...
      case (MR_Integer) 2:
        {
          ...
          ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &ThenFuncLabel_37, &ThenFuncLabelRval_38, STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_54_54);
          ml_backend__ml_code_util__ml_get_env_ptr_1_p_0(&EnvPtrRval_39);
          {
            ...
            MR_hl_field(MR_mktag(0), SuccessCont_40, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ThenFuncBody_45, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), ThenFuncBody_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          ...
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(EntryConstVarMap_33, STATE_VARIABLE_Info_77_77, STATE_VARIABLE_Info_49);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_79, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), IfStmt_110, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
