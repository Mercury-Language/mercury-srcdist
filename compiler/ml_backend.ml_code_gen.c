        ...
        case (MR_Integer) 0:
          {
            ...
            switch (MR_tag((MR_Word) GenericCall_28)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word HOVar_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GenericCall_28, (MR_Integer) 0))));
                  MR_Word Var_72;
              ...
              case (MR_Integer) 2:
                {
                  MR_Word MethodVar_36 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCall_28, (MR_Integer) 0))));
                  MR_Word Var_71;
