...
MR_decl_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0, 7,8,10,11,18,5,22,23,25,26)
MR_decl_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0, 20,29,28,31,3,34,36,39,41,42)
MR_decl_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0, 38,44,46,51,52,53,54,50,48,58)
MR_decl_label5(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0, 57,198,67,66,68)
...
MR_BEGIN_MODULE(ml_backend__ml_code_gen_module9)
	...
	MR_init_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,7,8,10,11,18,5,22,23,25,26)
	MR_init_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,20,29,28,31,3,34,36,39,41,42)
	MR_init_label10(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,38,44,46,51,52,53,54,50,48,58)
	MR_init_label5(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,57,198,67,66,68)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__676__1_2_0);
	MR_tfield(0, MR_tempr2, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr2, 3) = MR_tfield(3, MR_r1, 5);
	...
	MR_sv(16) = MR_tfield(3, MR_r1, 2);
	MR_sv(17) = MR_tfield(3, MR_r1, 3);
	}
	MR_np_call_localret_ent(fn__ml_backend__ml_code_gen__this_file_0_0,
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,8)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__678__1_2_0);
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,5)
	...
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(3, MR_r1, 5);
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,23)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__667__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_r1, 3) = MR_sv(6);
	MR_tfield(0, MR_r1, 4) = (MR_Word) MR_tbmkword(0, 0);
	MR_sv(6) = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,28)
	...
	if (MR_LTAGS_TESTR(MR_sv(6),0,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i31);
	}
	MR_succip_word = MR_sv(18);
	MR_decr_sp(18);
	MR_np_tailcall_ent(ml_backend__ml_foreign_proc_gen__ml_gen_ordinary_pragma_foreign_proc_12_0);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i34);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ml_backend__ml_code_gen__ml_gen_conj_7_0);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i36);
	}
	MR_incr_sp(18);
	MR_sv(18) = (MR_Word) MR_succip;
	MR_r1 = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(ml_backend__ml_disj_gen__ml_gen_disj_7_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i67);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i38);
	}
	MR_incr_sp(18);
	MR_sv(18) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(hlds__code_model__determinism_to_code_model_2_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i39);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,39)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__636__1_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_r2, 3) = MR_sv(1);
	MR_tfield(0, MR_r2, 4) = MR_r1;
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(fn__ml_backend__ml_code_gen__this_file_0_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i41);
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i44);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i46);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_r4 = MR_r5;
	MR_np_tailcall_ent(ml_backend__ml_code_gen__ml_gen_negation_7_0);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i48);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(1, MR_r1, 3);
	if (MR_INT_NE(MR_tempr1,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i50);
	}
	MR_incr_sp(18);
	MR_sv(18) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_gen_var_list_3_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i51);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(14);
	MR_np_call_localret_ent(ml_backend__ml_gen_info__ml_gen_info_get_varset_2_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i52);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(fn__ml_backend__ml_code_util__ml_gen_var_names_2_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i53);
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i57);
	}
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i58);
	}
	...
	MR_np_call_localret_ent(ml_backend__ml_unify_gen__ml_gen_ground_term_5_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i67);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_r4 = MR_r5;
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i198);
	}
	{
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,198)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(18);
	MR_sv(18) = (MR_Word) MR_succip;
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i66);
	}
	MR_r1 = MR_tfield(0, MR_r1, 3);
	MR_r4 = MR_r5;
	MR_np_call_localret_ent(ml_backend__ml_unify_gen__ml_gen_unification_6_0,
		ml_backend__ml_code_gen__ml_gen_goal_expr_8_0_i67);
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_goal_expr_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__ml_backend__ml_code_gen__this_file_0_0,
...
MR_def_label(ml_backend__ml_code_gen__ml_gen_negation_7_0,22)
	...
	MR_tfield(3, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(3,5,0);
