...
ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__625__1_2_p_0(
...
{
  {
    MR_bool succeeded = (CodeModel_11 == CallCodeModel_39);
      ...
      case (MR_Integer) 0:
        {
          ...
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0((MR_Integer) 0, Cond_12, &CondStmt_23, STATE_VARIABLE_Info_0_46, &STATE_VARIABLE_Info_90_90);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_24, STATE_VARIABLE_Info_90_90, STATE_VARIABLE_Info_47);
          ...
          *FuncDefns_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            ...
            MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (ThenStmt_24));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_77;
          MR_Word ThenStmt_95;
          MR_Word InitConstVarMap_96;
          MR_Word CondLocalVarDefns_97;
          MR_Word CondFuncDefns_98;
          MR_Word CondStmts_99;
          MR_Word ElseStmt_100;
          MR_Word IfStmt_101;
          MR_Word Var_39;

          ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_0_46, &InitConstVarMap_96);
          ...
          {
            SuccessCont_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), SuccessCont_38, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          ml_backend__ml_gen_info__ml_gen_info_push_success_cont_3_p_0(SuccessCont_38, STATE_VARIABLE_Info_52_52, &STATE_VARIABLE_Info_55_55);
          ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 2, Cond_12, &CondLocalVarDefns_97, &CondFuncDefns_98, &CondStmts_99, STATE_VARIABLE_Info_55_55, &STATE_VARIABLE_Info_57_57);
          ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(STATE_VARIABLE_Info_57_57, &STATE_VARIABLE_Info_58_58);
          ...
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_95, STATE_VARIABLE_Info_58_58, &STATE_VARIABLE_Info_61_61);
          {
            Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (ThenStmt_95));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (SetCondTrue_42));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ThenFuncBody_43, 2) = ((MR_Box) (Var_64));
            MR_hl_field(MR_mktag(0), ThenFuncBody_43, 3) = ((MR_Box) (ThenContext_41));
          }
          ml_backend__ml_code_util__ml_gen_nondet_label_func_5_p_0(STATE_VARIABLE_Info_61_61, ThenFuncLabel_35, ThenContext_41, ThenFuncBody_43, &ThenFuncDefn_44);
          ml_backend__ml_code_util__ml_gen_test_cond_var_2_p_0(CondVar_32, &CondSucceeded_45);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_96, STATE_VARIABLE_Info_61_61, &STATE_VARIABLE_Info_67_67);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Else_14, &ElseStmt_100, STATE_VARIABLE_Info_67_67, &STATE_VARIABLE_Info_68_68);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_96, STATE_VARIABLE_Info_68_68, STATE_VARIABLE_Info_47);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_4[0])));
            MR_hl_field(MR_mktag(3), Var_70, 2) = ((MR_Box) (CondSucceeded_45));
          }
          {
            IfStmt_101 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), IfStmt_101, 0) = ((MR_Box) (Var_70));
            MR_hl_field(MR_mktag(2), IfStmt_101, 1) = ((MR_Box) (ElseStmt_100));
            MR_hl_field(MR_mktag(2), IfStmt_101, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(2), IfStmt_101, 3) = ((MR_Box) (Context_15));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *LocalVarDefns_16 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (CondLocalVarDefns_97));
          }
          {
            Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (ThenFuncDefn_44));
            MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *FuncDefns_17 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0, CondFuncDefns_98, Var_74);
          {
            Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (SetCondFalse_34));
            MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (CondStmts_99));
          }
          {
            Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (IfStmt_101));
            MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *Stmts_18 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0, Var_76, Var_77);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 1, Cond_12, LocalVarDefns_16, FuncDefns_17, &CondStmts_28, STATE_VARIABLE_Info_0_46, &STATE_VARIABLE_Info_80_80);
          ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_29, STATE_VARIABLE_Info_80_80, &STATE_VARIABLE_Info_81_81);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_94, STATE_VARIABLE_Info_81_81, &STATE_VARIABLE_Info_82_82);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_25, STATE_VARIABLE_Info_82_82, &STATE_VARIABLE_Info_83_83);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Else_14, &ElseStmt_30, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_84_84);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_25, STATE_VARIABLE_Info_84_84, STATE_VARIABLE_Info_47);
          {
            Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (ElseStmt_30));
          }
          {
            ...
            MR_hl_field(MR_mktag(2), IfStmt_31, 1) = ((MR_Box) (ThenStmt_94));
            MR_hl_field(MR_mktag(2), IfStmt_31, 2) = ((MR_Box) (Var_86));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) (IfStmt_31));
            MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *Stmts_18 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0, CondStmts_28, Var_87);
        }
        break;
    }
  }
...
{
  {
    ...
    succeeded = ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__625__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr_10)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal_58 = (MR_Word) MR_body(((MR_Word) GoalExpr_10), (MR_Integer) 0);

          ml_backend__ml_code_gen__ml_gen_negation_8_p_0(SubGoal_58, CodeModel_11, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_unify_gen__ml_gen_unification_6_p_0(Unification_21, CodeModel_11, Context_12, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
      ...
      case (MR_Integer) 2:
        {
          ...
          switch (BuiltinState_26) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              ml_backend__ml_call_gen__ml_gen_builtin_10_p_0(PredId_23, ProcId_24, ArgVars_25, CodeModel_11, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
              break;
            case (MR_Integer) 1:
              {
                MR_Word ArgLvals_29;
                MR_Word VarSet_30;
                MR_Word ArgNames_31;
                MR_Word ActualArgTypes_32;

                ml_backend__ml_code_util__ml_gen_var_list_3_p_0(STATE_VARIABLE_Info_0_87, ArgVars_25, &ArgLvals_29);
                ml_backend__ml_gen_info__ml_gen_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_87, &VarSet_30);
                ArgNames_31 = ml_backend__ml_code_util__ml_gen_local_var_names_2_f_0(VarSet_30, ArgVars_25);
                ml_backend__ml_code_util__ml_variable_types_3_p_0(STATE_VARIABLE_Info_0_87, ArgVars_25, &ActualArgTypes_32);
                ml_backend__ml_call_gen__ml_gen_plain_call_14_p_0(PredId_23, ProcId_24, ArgNames_31, ArgLvals_29, ActualArgTypes_32, CodeModel_11, Context_12, GoalInfo_13, (MR_Integer) 0, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
              }
              break;
          }
        }
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word GenericCall_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
              MR_Word Vars_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
              MR_Word Modes_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 3)));
              MR_Word Detism_38 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 5)));
              MR_Word CallCodeModel_39;
              MR_Word Var_113;
              MR_Word Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 4)));

              hlds__code_model__determinism_to_code_model_2_p_0(Detism_38, &CallCodeModel_39);
              {
                Var_113 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_113, 0) = ((MR_Box) (&ml_backend__ml_code_gen_scalar_common_2[1]));
                MR_hl_field(MR_mktag(0), Var_113, 1) = ((MR_Box) (ml_backend__ml_code_gen__ml_gen_goal_expr_9_p_0_1));
                MR_hl_field(MR_mktag(0), Var_113, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_113, 3) = ((MR_Box) (CodeModel_11));
                MR_hl_field(MR_mktag(0), Var_113, 4) = ((MR_Box) (CallCodeModel_39));
              }
              mercury__require__expect_4_p_0(Var_113, (MR_String) "ml_backend.ml_code_gen", (MR_String) "predicate \140ml_backend.ml_code_gen.ml_gen_goal_expr\'/9", (MR_String) "code model mismatch");
              ml_backend__ml_call_gen__ml_gen_generic_call_10_p_0(GenericCall_34, Vars_35, Modes_36, Detism_38, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word Attributes_40 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
              MR_Word Args_41 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 4)));
              MR_Word ExtraArgs_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 5)));
              MR_Word MaybeTraceRuntimeCond_43 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 6)));
              MR_Word PragmaImpl_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 7)));
              MR_String ForeignCode_45 = ((MR_String) (MR_hl_field(MR_mktag(0), PragmaImpl_44, (MR_Integer) 0)));
              MR_Word MaybeContext_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), PragmaImpl_44, (MR_Integer) 1)));
              MR_Word ContextToUse_47;
              MR_Word PredId_121 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
              MR_Integer ProcId_122 = ((MR_Integer) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 3)));

              if ((MaybeContext_46 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ContextToUse_47 = Context_12;
              else
                ContextToUse_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeContext_46, (MR_Integer) 0)));
              if ((MaybeTraceRuntimeCond_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ml_backend__ml_foreign_proc_gen__ml_gen_ordinary_pragma_foreign_proc_12_p_0(CodeModel_11, Attributes_40, PredId_121, ProcId_122, Args_41, ExtraArgs_42, ForeignCode_45, ContextToUse_47, LocalVarDefns_14, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                *FuncDefns_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              }
              else
              {
                MR_Word TraceRuntimeCond_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeTraceRuntimeCond_43, (MR_Integer) 0)));

                ml_backend__ml_foreign_proc_gen__ml_gen_trace_runtime_cond_5_p_0(TraceRuntimeCond_48, ContextToUse_47, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                *LocalVarDefns_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                *FuncDefns_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              }
            }
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word _ConjType_49 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));

              ml_backend__ml_code_gen__ml_gen_conj_8_p_0(Goals_50, CodeModel_11, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Word Goals_123 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));

              ml_backend__ml_disj_gen__ml_gen_disj_7_p_0(Goals_123, GoalInfo_13, CodeModel_11, Context_12, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
              *LocalVarDefns_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              *FuncDefns_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            }
            break;
          case (MR_Integer) 4:
            {
              MR_Word Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
              MR_Word CanFail_52 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
              MR_Word CasesList_53 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 3)));

              ml_backend__ml_switch_gen__ml_gen_switch_10_p_0(Var_51, CanFail_52, CasesList_53, CodeModel_11, Context_12, GoalInfo_13, LocalVarDefns_14, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
              *FuncDefns_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Word Reason_59 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));
              MR_Word SubGoal_124 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));

              switch (MR_tag((MR_Word) Reason_59)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                case (MR_Integer) 2:
                  ml_backend__ml_commit_gen__ml_gen_commit_8_p_0(SubGoal_124, CodeModel_11, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word HeadWarning_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), Reason_59, (MR_Integer) 0)));
                    MR_Word TailWarnings_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), Reason_59, (MR_Integer) 1)));
                    ...
                    ml_backend__ml_gen_info__ml_gen_info_get_disabled_warnings_2_p_0(STATE_VARIABLE_Info_0_87, &Warnings0_75);
                    {
                      Var_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (HeadWarning_73));
                      MR_hl_field(MR_mktag(1), Var_97, 1) = ((MR_Box) (TailWarnings_74));
                    }
                    mercury__set__insert_list_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0, Var_97, Warnings0_75, &Warnings_76);
                    ml_backend__ml_gen_info__ml_gen_info_set_disabled_warnings_3_p_0(Warnings_76, STATE_VARIABLE_Info_0_87, &STATE_VARIABLE_Info_98_98);
                    ml_backend__ml_code_gen__ml_gen_goal_7_p_0(CodeModel_11, SubGoal_124, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_98_98, &STATE_VARIABLE_Info_99_99);
                    ml_backend__ml_gen_info__ml_gen_info_set_disabled_warnings_3_p_0(Warnings0_75, STATE_VARIABLE_Info_99_99, STATE_VARIABLE_Info_88);
                  }
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_59, (MR_Integer) 0)))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      ml_backend__ml_code_gen__ml_gen_goal_7_p_0(CodeModel_11, SubGoal_124, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                      break;
                    case (MR_Integer) 1:
                      ml_backend__ml_code_gen__ml_gen_goal_7_p_0(CodeModel_11, SubGoal_124, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                      break;
                    ...
                    case (MR_Integer) 6:
                      {
                        MR_Word Var_127 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_59, (MR_Integer) 2)));
                        MR_Word Var_128 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_59, (MR_Integer) 1)));

                        switch (Var_127) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                              ml_backend__ml_unify_gen__ml_gen_ground_term_5_p_0(Var_128, SubGoal_124, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
                              *LocalVarDefns_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                              *FuncDefns_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                            }
                            break;
          ...
          case (MR_Integer) 6:
            {
              MR_Word Cond_55 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2)));
              MR_Word Then_56 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 3)));
              MR_Word Else_57 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 4)));
              MR_Word _Vars_54 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1)));

              ml_backend__ml_code_gen__ml_gen_ite_10_p_0(CodeModel_11, Cond_55, Then_56, Else_57, Context_12, LocalVarDefns_14, FuncDefns_15, Stmts_16, STATE_VARIABLE_Info_0_87, STATE_VARIABLE_Info_88);
            }
            break;
          case (MR_Integer) 7:
            {
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_26, &VarTypes_17);
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_26, &VarSet_19);
    ...
    else
    {
      ...
      if ((Var_47 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        VarsToDeclare_18 = VarsToDeclare0_39;
      else
        VarsToDeclare_18 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(VarsToDeclare0_39, VarTypes_17);
      ml_backend__ml_code_gen__ml_gen_local_var_decls_7_p_0(VarSet_19, VarTypes_17, Context_16, VarsToDeclare_18, &VarDefns_20, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_28_28);
    }
    GoalCodeModel_21 = hlds__code_model__goal_info_get_code_model_1_f_0(GoalInfo_15);
    ml_backend__ml_code_gen__ml_gen_goal_expr_9_p_0(GoalExpr_14, GoalCodeModel_21, Context_16, GoalInfo_15, &GoalLocalVarDefns_22, FuncDefns_11, &GoalStmts0_24, STATE_VARIABLE_Info_28_28, &STATE_VARIABLE_Info_29_29);
    ml_backend__ml_code_gen__ml_gen_maybe_convert_goal_code_model_7_p_0(CodeModel_8, GoalCodeModel_21, Context_16, GoalStmts0_24, Stmts_12, STATE_VARIABLE_Info_29_29, STATE_VARIABLE_Info_27);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_STATE_VARIABLE_SubGoalNonLocals_0_2 = STATE_VARIABLE_SubGoalNonLocals_16_16;
  ...
  MR_Word * STATE_VARIABLE_SubGoalNonLocals_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = SubGoals_8;
        MR_Word next_value_of_STATE_VARIABLE_SubGoalNonLocals_0_2 = STATE_VARIABLE_SubGoalNonLocals_13_13;
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      IsDummy_23 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_22, Type_21);
      switch (IsDummy_23) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
