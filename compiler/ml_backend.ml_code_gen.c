      ...
      case (MR_Integer) 2:
        {
          ...
          ml_backend__ml_code_gen__Var_71 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_code_gen__CondVarDecl_30);
          {
          ...
          ml_backend__ml_code_gen__Var_73 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_code_gen__ThenFunc_41);
          {
...
{
  {
    ...
    {
      ml_backend__ml_code_gen__conv1_HeadVar__2_2 = ml_backend__mlds__wrap_data_defn_1_f_0(((MR_Word) ml_backend__ml_code_gen__wrapper_arg_1));
    }
...
{
  {
    ...
    {
      ml_backend__ml_code_gen__conv0_HeadVar__2_2 = ml_backend__mlds__wrap_data_defn_1_f_0(((MR_Word) ml_backend__ml_code_gen__wrapper_arg_1));
    }
              ...
              if ((ml_backend__ml_code_gen__MaybeTraceRuntimeCond_40 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                {
                  ...
                  {
                    *ml_backend__ml_code_gen__Decls_13 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0, (MR_Word) &ml_backend__ml_code_gen_scalar_common_3[3], ml_backend__ml_code_gen__DataDecls_45);
                  }
                }
              else
                {
          ...
          case (MR_Integer) 4:
            {
              ...
              {
                *ml_backend__ml_code_gen__Decls_13 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0, (MR_Word) &ml_backend__ml_code_gen_scalar_common_3[4], ml_backend__ml_code_gen__DataDecls_125);
              }
            }
            break;
          case (MR_Integer) 5:
...
{
  {
    ...
    {
      ml_backend__ml_code_gen__Var_28 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, ml_backend__ml_code_gen__TypeCtorInfo_30_30, (MR_Word) &ml_backend__ml_code_gen_scalar_common_3[2], ml_backend__ml_code_gen__VarDecls_18);
    }
    {
