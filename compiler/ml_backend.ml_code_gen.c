    ...
    case (MR_Integer) 0:
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_80, STATE_VARIABLE_Info_22_81, &STATE_VARIABLE_Info_57_57);
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  else
  {
    ...
    if ((Var_45 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      VarsToDeclare_17 = check_hlds__type_util__put_typeinfo_vars_first_table_2_f_0(VarTable_16, VarsToDeclare0_37);
  ...
  MR_Word * STATE_VARIABLE_Info_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__var_table__lookup_var_entry_3_p_0(VarTable_1, Var_14, &Entry_18);
