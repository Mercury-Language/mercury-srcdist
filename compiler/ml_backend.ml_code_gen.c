          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word ml_backend__ml_code_gen__CallCodeModel_36;
              MR_Word ml_backend__ml_code_gen__V_110_110;
              ...
              {
                ml_backend__ml_code_gen__V_110_110 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ml_backend__ml_code_gen__V_110_110, 0) = ((MR_Box) (&ml_backend__ml_code_gen_scalar_common_2[0]));
                MR_hl_field(MR_mktag(0), ml_backend__ml_code_gen__V_110_110, 1) = ((MR_Box) (ml_backend__ml_code_gen__ml_gen_goal_expr_8_p_0_1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_code_gen__V_110_110, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), ml_backend__ml_code_gen__V_110_110, 3) = ((MR_Box) (ml_backend__ml_code_gen__CodeModel_10));
                MR_hl_field(MR_mktag(0), ml_backend__ml_code_gen__V_110_110, 4) = ((MR_Box) (ml_backend__ml_code_gen__CallCodeModel_36));
              }
              {
                mercury__require__expect_4_p_0(ml_backend__ml_code_gen__V_110_110, (MR_String) "ml_backend.ml_code_gen", (MR_String) "predicate \140ml_backend.ml_code_gen.ml_gen_goal_expr\'/8", (MR_String) "code model mismatch");
              }
              {
              ...
              switch (MR_tag((MR_Word) ml_backend__ml_code_gen__Reason_56)) {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word ml_backend__ml_code_gen__V_94_94;
                    ...
                    {
                      ml_backend__ml_code_gen__V_94_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_code_gen__V_94_94, 0) = ((MR_Box) (ml_backend__ml_code_gen__HeadWarning_70));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_code_gen__V_94_94, 1) = ((MR_Box) (ml_backend__ml_code_gen__TailWarnings_71));
                    }
                    {
                      mercury__set__insert_list_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0, ml_backend__ml_code_gen__V_94_94, ml_backend__ml_code_gen__Warnings0_72, &ml_backend__ml_code_gen__Warnings_73);
                    }
                    {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_code_gen__Reason_56, (MR_Integer) 0)))) {
                    ...
                    case (MR_Integer) 6:
                      {
                        MR_Word ml_backend__ml_code_gen__V_125_125 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_code_gen__Reason_56, (MR_Integer) 2)));
                        MR_Word ml_backend__ml_code_gen__V_126_126 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_code_gen__Reason_56, (MR_Integer) 1)));

                        switch (ml_backend__ml_code_gen__V_125_125) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                              {
                                ml_backend__ml_unify_gen__ml_gen_ground_term_5_p_0(ml_backend__ml_code_gen__V_126_126, ml_backend__ml_code_gen__SubGoal_122, ml_backend__ml_code_gen__Statements_14, ml_backend__ml_code_gen__STATE_VARIABLE_Info_0_84, ml_backend__ml_code_gen__STATE_VARIABLE_Info_85);
                              }
                              *ml_backend__ml_code_gen__Decls_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                            }
                            break;
