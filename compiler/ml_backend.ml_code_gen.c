    ...
    case (MR_Integer) 0:
      {
        ...
        ml_backend__ml_code_gen__ml_gen_goal_as_branch_9_p_0((MR_Integer) 1, Cond_9, LocalVarDefns_12, FuncDefns_13, Stmts_14, (MR_Word) ((MR_Unsigned) 0U), &_ReachableConstVarMaps_21, STATE_VARIABLE_Info_0_28, &STATE_VARIABLE_Info_32_32);
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  else
  {
    ...
    if ((Var_45 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      VarsToDeclare_17 = check_hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTable_16, VarsToDeclare0_37);
        ...
        case (MR_Integer) 6:
          {
            ...
            SubGoal_126 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_75, (MR_Integer) 0))));
            SubGoals_127 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_75, (MR_Integer) 1))));
            NonLocals_129 = hlds__hlds_goal__goal_get_nonlocals_1_f_0(SubGoal_126);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_129, Var_76, &STATE_VARIABLE_SubGoalNonLocals_13_132);
