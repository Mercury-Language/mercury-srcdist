...
ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__590__1_2_p_0(
...
{
  {
    ...
    succeeded = ml_backend__ml_code_gen__IntroducedFrom__pred__ml_gen_goal_expr__590__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
