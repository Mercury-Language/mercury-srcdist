      ...
      case (MR_Integer) 0:
        {
          ...
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0((MR_Integer) 0, Cond_12, &CondStmt_23, STATE_VARIABLE_Info_0_46, &STATE_VARIABLE_Info_89_89);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_24, STATE_VARIABLE_Info_89_89, STATE_VARIABLE_Info_47);
          ...
          *FuncDefns_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          {
            ...
            MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (ThenStmt_24));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_76;
          MR_Word ThenStmt_94;
          MR_Word InitConstVarMap_95;
          MR_Word CondLocalVarDefns_96;
          MR_Word CondFuncDefns_97;
          MR_Word CondStmts_98;
          MR_Word ElseStmt_99;
          MR_Word IfStmt_100;
          MR_Word Var_39;

          ml_backend__ml_gen_info__ml_gen_info_get_const_var_map_2_p_0(STATE_VARIABLE_Info_0_46, &InitConstVarMap_95);
          ...
          ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 2, Cond_12, &CondLocalVarDefns_96, &CondFuncDefns_97, &CondStmts_98, STATE_VARIABLE_Info_54_54, &STATE_VARIABLE_Info_56_56);
          ...
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_94, STATE_VARIABLE_Info_57_57, &STATE_VARIABLE_Info_60_60);
          {
            Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (ThenStmt_94));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (SetCondTrue_42));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ThenFuncBody_43, 2) = ((MR_Box) (Var_63));
            MR_hl_field(MR_mktag(0), ThenFuncBody_43, 3) = ((MR_Box) (ThenContext_41));
          }
          ml_backend__ml_code_util__ml_gen_nondet_label_func_5_p_0(STATE_VARIABLE_Info_60_60, ThenFuncLabel_35, ThenContext_41, ThenFuncBody_43, &ThenFuncDefn_44);
          ml_backend__ml_code_util__ml_gen_test_cond_var_2_p_0(CondVar_32, &CondSucceeded_45);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_95, STATE_VARIABLE_Info_60_60, &STATE_VARIABLE_Info_66_66);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Else_14, &ElseStmt_99, STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_Info_67_67);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_95, STATE_VARIABLE_Info_67_67, STATE_VARIABLE_Info_47);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_gen_scalar_common_4[0])));
            MR_hl_field(MR_mktag(3), Var_69, 2) = ((MR_Box) (CondSucceeded_45));
          }
          {
            IfStmt_100 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), IfStmt_100, 0) = ((MR_Box) (Var_69));
            MR_hl_field(MR_mktag(2), IfStmt_100, 1) = ((MR_Box) (ElseStmt_99));
            MR_hl_field(MR_mktag(2), IfStmt_100, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(2), IfStmt_100, 3) = ((MR_Box) (Context_15));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *LocalVarDefns_16 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (CondLocalVarDefns_96));
          }
          {
            Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (ThenFuncDefn_44));
            MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *FuncDefns_17 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0, CondFuncDefns_97, Var_73);
          {
            Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (SetCondFalse_34));
            MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (CondStmts_98));
          }
          {
            Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (IfStmt_100));
            MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *Stmts_18 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0, Var_75, Var_76);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_code_gen__ml_gen_goal_7_p_0((MR_Integer) 1, Cond_12, LocalVarDefns_16, FuncDefns_17, &CondStmts_28, STATE_VARIABLE_Info_0_46, &STATE_VARIABLE_Info_79_79);
          ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_29, STATE_VARIABLE_Info_79_79, &STATE_VARIABLE_Info_80_80);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Then_13, &ThenStmt_93, STATE_VARIABLE_Info_80_80, &STATE_VARIABLE_Info_81_81);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_25, STATE_VARIABLE_Info_81_81, &STATE_VARIABLE_Info_82_82);
          ml_backend__ml_code_gen__ml_gen_goal_as_block_5_p_0(CodeModel_11, Else_14, &ElseStmt_30, STATE_VARIABLE_Info_82_82, &STATE_VARIABLE_Info_83_83);
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_map_3_p_0(InitConstVarMap_25, STATE_VARIABLE_Info_83_83, STATE_VARIABLE_Info_47);
          {
            Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (ElseStmt_30));
          }
          {
            ...
            MR_hl_field(MR_mktag(2), IfStmt_31, 1) = ((MR_Box) (ThenStmt_93));
            MR_hl_field(MR_mktag(2), IfStmt_31, 2) = ((MR_Box) (Var_85));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (IfStmt_31));
            MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          *Stmts_18 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0, CondStmts_28, Var_86);
        }
        break;
    }
  }
