...
MR_decl_label10(ml_backend__ml_code_gen__ml_gen_goal_6_0, 2,3,4,5,6,7,8,10,12,13)
MR_decl_label7(ml_backend__ml_code_gen__ml_gen_goal_6_0, 11,14,9,15,16,17,18)
...
MR_BEGIN_MODULE(ml_backend__ml_code_gen_module6)
	...
	MR_init_label10(ml_backend__ml_code_gen__ml_gen_goal_6_0,2,3,4,5,6,7,8,10,12,13)
	MR_init_label7(ml_backend__ml_code_gen__ml_gen_goal_6_0,11,14,9,15,16,17,18)
MR_BEGIN_CODE
...
void mercury__ml_backend__ml_code_gen__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_code_gen);
