...
transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__1056__1_3_f_0(
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  succeeded = transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__1056__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_14);
  if (succeeded)
  {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      PredOrFunc_35 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(STATE_VARIABLE_PredInfo_29_48);
      {
        ...
        MR_hl_field(MR_mktag(3), Transform_36, 0) = ((MR_Box) ((MR_Unsigned) 6U));
