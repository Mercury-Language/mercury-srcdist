...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Origin_15)) == (MR_Integer) 2);
    if (succeeded)
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((((MR_tag((MR_Word) ConsId0_21)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId0_21, (MR_Integer) 0))) == (MR_Integer) 4)));
            if (succeeded)
