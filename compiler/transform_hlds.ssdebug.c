...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(SSDBModule_16, HandleTypeString_10, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, Arguments_11, (MR_Word) ((MR_Unsigned) 0U), Var_29, STATE_VARIABLE_ModuleInfo_0_19, Context_18, HandleEventGoal_12);
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_41, (MR_String) "set_context", (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, Args_21, (MR_Word) ((MR_Unsigned) 0U), InstMapDelta_23, ModuleInfo_6, Context_12, &SetContextGoal_24);
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__pred_info_set_status_3_p_0((MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), STATE_VARIABLE_PredInfo_17_37, &STATE_VARIABLE_PredInfo_19_39);
        ...
        hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_25_45, &Origin_33);
        {
          ...
          MR_hl_field(MR_mktag(2), NewOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 20U));
