...
MR_decl_label2(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0, 2,1)
...
MR_decl_static(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0)
...
MR_def_static(transform_hlds__ssdebug__get_output_args_4_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
...
MR_BEGIN_MODULE(transform_hlds__ssdebug_module31)
	MR_init_entry1(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0);
	MR_init_label2(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0,2,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__get_output_args__947__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(check_hlds__mode_util__mode_is_output_2_0,
		fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0_i2);
MR_def_label(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0_i1);
	}
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(fn__transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__947__1_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_FALSE;
