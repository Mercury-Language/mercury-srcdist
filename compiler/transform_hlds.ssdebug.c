  ...
  MR_Word VarTypes_18)
{
  ...
  hlds__hlds_goal__goal_info_set_purity_3_p_0((MR_Integer) 2, GoalInfo0_51, &GoalInfo1_52);
  hlds__hlds_goal__goal_info_set_determinism_3_p_0(ConjDetism_19, GoalInfo1_52, &ConjGoalInfo_20);
  {
