...
{
  {
    ...
    hlds__hlds_goal__goal_info_set_determinism_3_p_0(ProcDetism_45, OrigGoalInfo_58, &IteGoalInfo_59);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_149, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if ((HeadVar__3_3 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      hlds__make_goal__construct_functor_4_p_0(*OutVar_5, ConsId_32, (MR_Word) ((MR_Integer) 0), &Goal_23);
      {
        MR_Word base;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ValueGoals_76 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(VarValueTypeCtor_32, (MR_Word) ((MR_Integer) 0), &VarValueType_33);
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(VarValueTypeCtor_4, (MR_Word) ((MR_Integer) 0), &VarValueType_5);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_18, 2) = ((MR_Box) ((MR_Integer) 0));
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_35 == (MR_Word) ((MR_Integer) 20));
    }
    if (succeeded)
    ...
    parse_tree__prog_type__construct_type_3_p_0(TypeCtor_27, (MR_Word) ((MR_Integer) 0), &ProcIdType_29);
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(SSDBModule_16, HandleTypeString_10, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 2, Arguments_11, (MR_Word) ((MR_Integer) 0), Var_29, STATE_VARIABLE_ModuleInfo_0_19, Context_18, HandleEventGoal_12);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), CaseDoRetry_14, 1) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), CaseDoNotRetry_15, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    BuiltIn_16 = hlds__hlds_pred__builtin_state_4_f_0(ModuleInfo_8, PredId_9, PredId_9, ProcId_10);
    {
      ...
      MR_hl_field(MR_mktag(2), GoalExpr_17, 4) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(TypeCtor_12, (MR_Word) ((MR_Integer) 0), &RetryType_13);
...
{
  {
    ...
    hlds__hlds_pred__pred_info_get_sym_name_2_p_0(STATE_VARIABLE_PredInfo_0_20, &SymName_13);
    {
      ...
      MR_hl_field(MR_mktag(2), CallExpr_14, 4) = ((MR_Box) ((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if ((MaybeNewPredId_31 == (MR_Word) ((MR_Integer) 0)))
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((MaybeNewPredId_135 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_41, (MR_String) "set_context", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 2, Args_21, (MR_Word) ((MR_Integer) 0), InstMapDelta_23, ModuleInfo_6, Context_12, &SetContextGoal_24);
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__pred_info_set_status_3_p_0((MR_Word) (((MR_Box) ((MR_Integer) 32))), STATE_VARIABLE_PredInfo_17_37, &STATE_VARIABLE_PredInfo_19_39);
        ...
        hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_25_45, &Origin_33);
        {
          ...
          MR_hl_field(MR_mktag(2), NewOrigin_34, 0) = ((MR_Box) ((MR_Integer) 20));
      ...
      {
        *MaybeNewPredId_8 = (MR_Word) ((MR_Integer) 0);
        *STATE_VARIABLE_ModuleInfo_18 = STATE_VARIABLE_ModuleInfo_0_17;
      }
