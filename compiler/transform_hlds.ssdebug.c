...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        ConsId_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      {
        ConsId_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_18, (MR_Integer) 5)));
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_18, (MR_Integer) 5)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_13, (MR_Integer) 3)));
...
{
  {
    ...
    {
      Args_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          NewOrigin_34 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
