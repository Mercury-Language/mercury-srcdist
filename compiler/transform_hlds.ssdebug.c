  ...
  MR_Word * STATE_VARIABLE_VarTable_30)
{
  ...
  if (succeeded)
  {
    Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_12, (MR_Integer) 0))));
    OrigPredId_14 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_12, (MR_Integer) 2))));
    succeeded = (Var_31 == (MR_Word) ((MR_Unsigned) 4U));
  }
  if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        NewOrigin_37 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), NewOrigin_37, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(2), NewOrigin_37, 1) = ((MR_Box) (Origin_36));
        MR_hl_field(MR_mktag(2), NewOrigin_37, 2) = ((MR_Box) (PredId_7));
      }
