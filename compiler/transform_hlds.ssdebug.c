...
{
  {
    ...
    succeeded = transform_hlds__ssdebug__IntroducedFrom__pred__make_var_value__1439__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__1054__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_14);
    if (succeeded)
    {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ProcIds_31 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(STATE_VARIABLE_PredInfo_19_39);
        {
        ...
        {
          NewOrigin_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), NewOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), NewOrigin_34, 1) = ((MR_Box) ((MR_Unsigned) 20U));
          MR_hl_field(MR_mktag(3), NewOrigin_34, 2) = ((MR_Box) (Origin_33));
          MR_hl_field(MR_mktag(3), NewOrigin_34, 3) = ((MR_Box) (PredId_7));
        }
