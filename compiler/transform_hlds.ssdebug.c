...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Origin_15)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_15, (MR_Integer) 0)))) == (MR_Integer) 0)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_25_45, &Origin_33);
        {
          ...
          MR_hl_field(MR_mktag(3), NewOrigin_34, 0) = ((MR_Box) ((MR_Unsigned) 0U));
