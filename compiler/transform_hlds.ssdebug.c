  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_2_37, &STATE_VARIABLE_ProcInfo_3_39);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_2_28, &STATE_VARIABLE_ProcInfo_3_30);
