...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &transform_hlds__ssdebug_scalar_common_1[2], ((MR_Box) (PolySpecs_45)), ((MR_Box) (HeadVar__2_84)));
    return succeeded;
  }
}
...
{
  {
    ...
    TypeInfo_165_165 = (MR_Word) &transform_hlds__ssdebug_scalar_common_1[1];
    Var_72 = mercury__map__init_0_f_0(TypeInfo_165_165, TypeInfo_165_165);
    Var_78 = mercury__map__init_0_f_0(TypeInfo_165_165, TypeInfo_165_165);
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__map__apply_to_list_3_p_0(TypeInfo_165_165, TypeInfo_165_165, OutputVars_29, Renaming_32, &RenamedOutputVars_50);
    ...
    GoalsThen_52 = mercury__list__condense_1_f_0(TypeCtorInfo_166_166, Var_128);
    {
    ...
    GoalsElse_55 = mercury__list__condense_1_f_0(TypeCtorInfo_166_166, Var_139);
    {
      Var_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), Var_147, 1) = ((MR_Box) ((MR_Integer) 0));
    ...
    {
      Var_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(3), Var_149, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    BodyGoals_61 = mercury__list__condense_1_f_0(TypeCtorInfo_166_166, Var_151);
...
{
  {
    ...
    mercury__varset__lookup_name_3_p_0(TypeCtorInfo_119_119, STATE_VARIABLE_VarSet_0_56, VarToInspect_20, &VarName_34);
    ...
    mercury__varset__new_named_var_4_p_0(TypeCtorInfo_119_119, (MR_String) "VarDesc", VarDesc_22, STATE_VARIABLE_VarSet_71_71, &STATE_VARIABLE_VarSet_75_75);
    ...
    if (succeeded)
    {
      ...
      mercury__require__expect_3_p_0(Var_81, (MR_String) "predicate \140transform_hlds.ssdebug.make_var_value\'/18", (MR_String) "got errors while making type_info_var");
      hlds__hlds_pred__proc_info_get_varset_2_p_0(*STATE_VARIABLE_ProcInfo_53, STATE_VARIABLE_VarSet_57);
      hlds__hlds_pred__proc_info_get_vartypes_2_p_0(*STATE_VARIABLE_ProcInfo_53, &STATE_VARIABLE_VarTypes_86_86);
      {
        Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) (SSDBModule_31));
        MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) ((MR_String) "bound_head_var"));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), ConsId_46, 1) = ((MR_Box) (Var_87));
        MR_hl_field(MR_mktag(3), ConsId_46, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), ConsId_46, 3) = ((MR_Box) (VarValueTypeCtor_32));
      }
      hlds__vartypes__add_var_type_4_p_0(*VarDesc_22, VarValueType_33, STATE_VARIABLE_VarTypes_86_86, STATE_VARIABLE_VarTypes_59);
      TypeInfo_121_121 = (MR_Word) &transform_hlds__ssdebug_scalar_common_1[1];
      succeeded = mercury__map__is_empty_1_p_0(TypeInfo_121_121, TypeInfo_121_121, Renaming_21);
      if (succeeded)
      {
        MR_Word Var_91;
        MR_Word Var_92;
        ...
        {
          Var_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_94, 0) = ((MR_Box) (VarToInspect_20));
          MR_hl_field(MR_mktag(1), Var_94, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) (VarPosVar_38));
          MR_hl_field(MR_mktag(1), Var_93, 1) = ((MR_Box) (Var_94));
        }
        {
          Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (VarNameVar_36));
          MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (Var_93));
        }
        {
          Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (TypeInfoVar_42));
          MR_hl_field(MR_mktag(1), Var_91, 1) = ((MR_Box) (Var_92));
        }
        hlds__make_goal__construct_functor_4_p_0(*VarDesc_22, ConsId_46, Var_91, &ConstructVarGoal_47);
      }
      else
      {
        MR_Word TypeInfo_122_122 = (MR_Word) &transform_hlds__ssdebug_scalar_common_1[1];
        ...
        mercury__map__lookup_3_p_0(TypeInfo_122_122, TypeInfo_122_122, Renaming_21, ((MR_Box) (VarToInspect_20)), &conv0_RenamedVar_48);
        RenamedVar_48 = ((MR_Word) conv0_RenamedVar_48);
        {
          Var_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_99, 0) = ((MR_Box) (RenamedVar_48));
          MR_hl_field(MR_mktag(1), Var_99, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          Var_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_98, 0) = ((MR_Box) (VarPosVar_38));
          MR_hl_field(MR_mktag(1), Var_98, 1) = ((MR_Box) (Var_99));
        }
        {
          Var_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (VarNameVar_36));
          MR_hl_field(MR_mktag(1), Var_97, 1) = ((MR_Box) (Var_98));
        }
        {
          Var_96 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_96, 0) = ((MR_Box) (TypeInfoVar_42));
          MR_hl_field(MR_mktag(1), Var_96, 1) = ((MR_Box) (Var_97));
        }
        hlds__make_goal__construct_functor_4_p_0(*VarDesc_22, ConsId_46, Var_96, &ConstructVarGoal_47);
      }
      hlds__hlds_goal__rename_vars_in_goals_4_p_0((MR_Integer) 1, Renaming_21, TypeInfoGoals0_43, &TypeInfoGoals_49);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_103, 0) = ((MR_Box) (ConstructVarPos_37));
        MR_hl_field(MR_mktag(1), Var_103, 1) = ((MR_Box) (TypeInfoGoals_49));
      }
      {
        Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (ConstructVarName_35));
        MR_hl_field(MR_mktag(1), Var_102, 1) = ((MR_Box) (Var_103));
      }
      {
        Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (ConstructVarGoal_47));
        MR_hl_field(MR_mktag(1), Var_104, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      *Goals_24 = mercury__list__f_43_43_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, Var_102, Var_104);
      TypeInfo_124_124 = (MR_Word) &transform_hlds__ssdebug_scalar_common_1[1];
      mercury__map__det_insert_4_p_0(TypeInfo_124_124, TypeInfo_124_124, ((MR_Box) (VarToInspect_20)), ((MR_Box) (*VarDesc_22)), STATE_VARIABLE_BoundVarDescs_0_60, STATE_VARIABLE_BoundVarDescs_61);
    }
    else
    {
      MR_Word Var_107;
      ...
      MR_Word Var_115;
      MR_Word ConsId_117;
      MR_Word ConstructVarGoal_118;

      {
        Var_107 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_107, 0) = ((MR_Box) (SSDBModule_31));
        MR_hl_field(MR_mktag(1), Var_107, 1) = ((MR_Box) ((MR_String) "unbound_head_var"));
      }
      {
        ConsId_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ConsId_117, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(3), ConsId_117, 1) = ((MR_Box) (Var_107));
        MR_hl_field(MR_mktag(3), ConsId_117, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(3), ConsId_117, 3) = ((MR_Box) (VarValueTypeCtor_32));
      }
      hlds__vartypes__add_var_type_4_p_0(*VarDesc_22, VarValueType_33, STATE_VARIABLE_VarTypes_72_72, STATE_VARIABLE_VarTypes_59);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_112, 0) = ((MR_Box) (VarPosVar_38));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_111, 0) = ((MR_Box) (VarNameVar_36));
        MR_hl_field(MR_mktag(1), Var_111, 1) = ((MR_Box) (Var_112));
      }
      hlds__make_goal__construct_functor_4_p_0(*VarDesc_22, ConsId_117, Var_111, &ConstructVarGoal_118);
      {
        Var_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_115, 0) = ((MR_Box) (ConstructVarGoal_118));
        MR_hl_field(MR_mktag(1), Var_115, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Var_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_114, 0) = ((MR_Box) (ConstructVarPos_37));
    ...
    switch (MR_tag((MR_Word) GoalExpr0_13)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          GoalExpr_151 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_66);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              Var_157 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unification0_18, (MR_Integer) 1)));
              ...
              Var_161 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unification0_18, (MR_Integer) 5)));
              Var_162 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unification0_18, (MR_Integer) 6)));
              {
                ...
                MR_hl_field(MR_mktag(0), Unification_36, 5) = ((MR_Box) (Var_161));
              ...
              Var_166 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_13, (MR_Integer) 3)));
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((MaybeNewPredId_135 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                {
                  ...
                  {
                    GoalExpr_132 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    MR_hl_field(MR_mktag(2), GoalExpr_132, 3) = ((MR_Box) (Builtin_39));
                    MR_hl_field(MR_mktag(2), GoalExpr_132, 4) = ((MR_Box) (Context_40));
                    MR_hl_field(MR_mktag(2), GoalExpr_132, 5) = ((MR_Box) (NewSymName_45));
                  }
                  {
                    STATE_VARIABLE_Goal_123_123 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              ...
              *STATE_VARIABLE_ModuleInfo_83 = ((MR_Word) conv4_STATE_VARIABLE_ModuleInfo_83);
              {
                GoalExpr_146 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_146, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), GoalExpr_146, 1) = ((MR_Box) (ConjType_58));
          ...
          case (MR_Integer) 3:
            {
              MR_Word TypeCtorInfo_188_188 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              ...
              *STATE_VARIABLE_ModuleInfo_83 = ((MR_Word) conv11_STATE_VARIABLE_ModuleInfo_83);
              {
                GoalExpr_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          ...
          case (MR_Integer) 4:
            {
              MR_Word TypeCtorInfo_200_200 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0;
              ...
              *STATE_VARIABLE_ModuleInfo_83 = ((MR_Word) conv18_STATE_VARIABLE_ModuleInfo_83);
              {
                GoalExpr_150 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_150, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_150, 1) = ((MR_Box) (Var_61));
                MR_hl_field(MR_mktag(3), GoalExpr_150, 2) = ((MR_Box) (CanFail_62));
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                GoalExpr_152 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_152, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
