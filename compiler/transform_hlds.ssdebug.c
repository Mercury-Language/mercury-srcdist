  ...
  MR_Word * STATE_VARIABLE_VarTypes_24)
{
  ...
  hlds__goal_util__generate_simple_call_12_p_0(STATE_VARIABLE_ModuleInfo_0_19, SSDBModule_16, HandleTypeString_10, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, ArgVars_11, (MR_Word) ((MR_Unsigned) 0U), Var_29, Context_18, HandleEventGoal_12);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_26)
{
  ...
  hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_6, Var_41, (MR_String) "set_context", (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 2, ArgVars_21, (MR_Word) ((MR_Unsigned) 0U), InstMapDelta_23, Context_12, &SetContextGoal_24);
  {
    Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
