  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_10)
{
  switch (SSTraceLevel_6) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word STATE_VARIABLE_ModuleInfo_2_16;
        MR_Word Var_17;
        MR_Word Var_19;
        MR_Word PredIds_20;
        MR_Word Var_23;
        MR_Box conv3__ProxyMap_21;
        MR_Box conv2_STATE_VARIABLE_ModuleInfo_2_16;
        ...
        hlds__passes_aux__process_valid_nonimported_procs_3_p_0(Var_17, STATE_VARIABLE_ModuleInfo_2_16, STATE_VARIABLE_ModuleInfo_10);
      }
      break;
    case (MR_Integer) 1:
      {
