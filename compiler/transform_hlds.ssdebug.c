  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_30_40, &Origin_29);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_41, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_26));
      }
      {
        NewOrigin_30 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), NewOrigin_30, 0) = ((MR_Box) (Var_41));
        MR_hl_field(MR_mktag(2), NewOrigin_30, 1) = ((MR_Box) (Origin_29));
        MR_hl_field(MR_mktag(2), NewOrigin_30, 2) = ((MR_Box) (PredId_7));
      }
