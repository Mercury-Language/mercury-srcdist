  ...
  MR_Box * wrapper_arg_3)
{
  ...
  succeeded = transform_hlds__ssdebug__IntroducedFrom__func__get_output_args__1042__1_3_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_14);
  if (succeeded)
  {
