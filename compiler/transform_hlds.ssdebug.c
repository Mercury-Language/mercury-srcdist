...
{
  {
    ...
    hlds__make_goal__make_string_const_construction_alloc_8_p_0(VarName_34, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__ssdebug_scalar_common_5[5])), &ConstructVarName_35, &VarNameVar_36, STATE_VARIABLE_VarSet_0_53, &STATE_VARIABLE_VarSet_64_64, STATE_VARIABLE_VarTypes_0_55, &STATE_VARIABLE_VarTypes_65_65);
    hlds__make_goal__make_int_const_construction_alloc_8_p_0(VarPos_23, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__ssdebug_scalar_common_5[6])), &ConstructVarPos_37, &VarPosVar_38, STATE_VARIABLE_VarSet_64_64, &STATE_VARIABLE_VarSet_68_68, STATE_VARIABLE_VarTypes_65_65, &STATE_VARIABLE_VarTypes_69_69);
