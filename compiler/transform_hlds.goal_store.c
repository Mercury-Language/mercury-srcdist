    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&transform_hlds__goal_store_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (transform_hlds__goal_store__ancestors_loop_8_p_0_1));
          MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) ((MR_Integer) 6));
          MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (TypeInfo_for_T_33));
          MR_hl_field(MR_mktag(0), Var_40, 4) = ((MR_Box) (ModuleInfo_1));
          MR_hl_field(MR_mktag(0), Var_40, 5) = ((MR_Box) (VarTable_2));
          MR_hl_field(MR_mktag(0), Var_40, 6) = ((MR_Box) (GoalStore_3));
          MR_hl_field(MR_mktag(0), Var_40, 7) = ((MR_Box) (FullyStrict_4));
          MR_hl_field(MR_mktag(0), Var_40, 8) = Id_22;
        }
        mercury__solutions__solutions_set_2_p_1(TypeInfo_for_T_33, Var_40, &IdAncestors_25);
