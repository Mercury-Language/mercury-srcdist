...
{
  {
    ...
    {
      MR_Word transform_hlds__goal_store__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word transform_hlds__goal_store__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word transform_hlds__goal_store__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word transform_hlds__goal_store__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word transform_hlds__goal_store__Var_8;

      hlds__hlds_goal____Compare____hlds_goal_0_0(&transform_hlds__goal_store__Var_8, transform_hlds__goal_store__ArgX1_4, transform_hlds__goal_store__ArgY1_5);
      ...
      if (transform_hlds__goal_store__succeeded)
        *transform_hlds__goal_store__HeadVar__1_1 = transform_hlds__goal_store__Var_8;
        ...
        hlds__instmap____Compare____instmap_0_0(transform_hlds__goal_store__HeadVar__1_1, transform_hlds__goal_store__ArgX2_6, transform_hlds__goal_store__ArgY2_7);
    }
  }
}
...
{
  {
    ...
    {
      MR_Word transform_hlds__goal_store__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word transform_hlds__goal_store__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word transform_hlds__goal_store__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word transform_hlds__goal_store__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__goal_store__HeadVar__2_2, (MR_Integer) 1)));

      transform_hlds__goal_store__succeeded = hlds__hlds_goal____Unify____hlds_goal_0_0(transform_hlds__goal_store__ArgX1_3, transform_hlds__goal_store__ArgY1_4);
      if (transform_hlds__goal_store__succeeded)
        transform_hlds__goal_store__succeeded = hlds__instmap____Unify____instmap_0_0(transform_hlds__goal_store__ArgX2_5, transform_hlds__goal_store__ArgY2_6);
    }
