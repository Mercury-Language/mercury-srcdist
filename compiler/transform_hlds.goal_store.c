  ...
  MR_Word * AncestorIds_12)
{
  ...
  Var_13 = mercury__set__init_0_f_0(TypeInfo_for_T_17);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_14, 0) = StartId_11;
  ...
  void * cont_env_ptr)
{
  ...
  transform_hlds__goal_store__direct_ancestor_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 7)))), (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 8)), wrapper_arg_1, cont, cont_env_ptr);
}
  ...
  MR_Word * STATE_VARIABLE_AncestorIds_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Box Id_22 = (MR_hl_field(MR_mktag(1), HeadVar__6_6, (MR_Integer) 0));
      MR_Word Ids_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__6_6, (MR_Integer) 1))));

      succeeded = mercury__set__member_2_p_0(TypeInfo_for_T_34, Id_22, VisitedIds0_5);
      if (succeeded)
      {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&transform_hlds__goal_store_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (transform_hlds__goal_store__ancestors_loop_8_p_0_1));
          MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 6));
          MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (TypeInfo_for_T_34));
          MR_hl_field(MR_mktag(0), Var_35, 4) = ((MR_Box) (ModuleInfo_1));
          MR_hl_field(MR_mktag(0), Var_35, 5) = ((MR_Box) (VarTable_2));
          MR_hl_field(MR_mktag(0), Var_35, 6) = ((MR_Box) (GoalStore_3));
          MR_hl_field(MR_mktag(0), Var_35, 7) = ((MR_Box) (FullyStrict_4));
          MR_hl_field(MR_mktag(0), Var_35, 8) = Id_22;
        }
        mercury__solutions__solutions_set_2_p_1(TypeInfo_for_T_34, Var_35, &IdAncestors_25);
        mercury__set__insert_3_p_0(TypeInfo_for_T_34, Id_22, VisitedIds0_5, &VisitedIds_26);
        Var_31 = mercury__set__to_sorted_list_1_f_0(TypeInfo_for_T_34, IdAncestors_25);
        ToProcessIds_27 = mercury__list__f_43_43_2_f_0(TypeInfo_for_T_34, Var_31, Ids_23);
        mercury__set__union_3_p_0(TypeInfo_for_T_34, IdAncestors_25, STATE_VARIABLE_AncestorIds_0_7, &STATE_VARIABLE_AncestorIds_32_32);
        // direct tailcall eliminated
        ;
