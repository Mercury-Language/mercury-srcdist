    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&transform_hlds__goal_store_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (transform_hlds__goal_store__ancestors_loop_8_p_0_1));
          MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 6));
          MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (TypeInfo_for_T_34));
          MR_hl_field(MR_mktag(0), Var_41, 4) = ((MR_Box) (ModuleInfo_1));
          MR_hl_field(MR_mktag(0), Var_41, 5) = ((MR_Box) (VarTable_2));
          MR_hl_field(MR_mktag(0), Var_41, 6) = ((MR_Box) (GoalStore_3));
          MR_hl_field(MR_mktag(0), Var_41, 7) = ((MR_Box) (FullyStrict_4));
          MR_hl_field(MR_mktag(0), Var_41, 8) = Id_22;
        }
        mercury__solutions__solutions_set_2_p_1(TypeInfo_for_T_34, Var_41, &IdAncestors_25);
