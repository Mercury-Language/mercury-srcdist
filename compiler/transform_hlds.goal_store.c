...
#line 56 "transform_hlds.goal_store.c"
#line 57 "transform_hlds.goal_store.c"

#endif
#line 60 "transform_hlds.goal_store.c"
...
MR_decl_label8(fn__transform_hlds__goal_store__ancestors_2_6_0, 27,3,7,5,11,12,13,14)
MR_decl_label1(fn__transform_hlds__goal_store__ancestors_2_6_0, 15)
...
MR_BEGIN_MODULE(transform_hlds__goal_store_module5)
	...
	MR_init_label8(fn__transform_hlds__goal_store__ancestors_2_6_0,27,3,7,5,11,12,13,14)
	MR_init_label1(fn__transform_hlds__goal_store__ancestors_2_6_0,15)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__goal_store__ancestors_2_6_0,5)
	...
	MR_tfield(0, MR_tempr8, 0) = (MR_Word) MR_COMMON(4,0);
	MR_tfield(0, MR_tempr8, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__goal_store__direct_ancestor_6_0);
	MR_tfield(0, MR_tempr8, 2) = (MR_Integer) 6;
	MR_tfield(0, MR_tempr8, 3) = MR_tempr7;
	MR_tfield(0, MR_tempr8, 4) = MR_tempr1;
	MR_tfield(0, MR_tempr8, 5) = MR_tempr6;
	MR_tfield(0, MR_tempr8, 6) = MR_tempr3;
	MR_tfield(0, MR_tempr8, 7) = MR_tempr4;
	MR_tfield(0, MR_tempr8, 8) = MR_tempr5;
	MR_r2 = MR_tempr8;
	}
