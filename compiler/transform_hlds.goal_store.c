  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__EarlierGoal_15 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__Var_18, 0))));
  (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__EarlierInstMap_16 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__Var_18, 1))));
  ...
  {
    (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__succeeded = hlds__goal_reorder__can_reorder_goals_old_7_p_0((env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__ModuleInfo_7, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__VarTable_8, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__FullyStrict_10, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__EarlierInstMap_16, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__EarlierGoal_15, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__LaterInstMap_14, (env_ptr)->transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__LaterGoal_13);
  ...
  void * cont_env_ptr)
{
  ...
  (env).transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    (env).transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__LaterGoal_13 = ((MR_Word) ((MR_hl_field(0, Var_17, 0))));
    (env).transform_hlds__goal_store__direct_ancestor_6_p_0_env_0__LaterInstMap_14 = ((MR_Word) ((MR_hl_field(0, Var_17, 1))));
  ...
  void * cont_env_ptr)
{
  ...
  transform_hlds__goal_store__direct_ancestor_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) ((MR_hl_field(0, closure, 7)))), (MR_hl_field(0, closure, 8)), wrapper_arg_1, cont, cont_env_ptr);
}
  ...
  MR_Word * STATE_VARIABLE_AncestorIds_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Box Id_22 = (MR_hl_field(1, HeadVar__6_6, 0));
      MR_Word Ids_23 = ((MR_Word) ((MR_hl_field(1, HeadVar__6_6, 1))));
      ...
      else
      {
        ...
        MR_Word Var_31;
        MR_Word STATE_VARIABLE_AncestorIds_2_32;
        MR_Word Var_34;
        ...
        mercury__set__union_3_p_0(TypeInfo_for_T_33, IdAncestors_25, STATE_VARIABLE_AncestorIds_0_7, &STATE_VARIABLE_AncestorIds_2_32);
        // direct tailcall eliminated
        ;
        next_value_of_VisitedIds0_5 = VisitedIds_26;
        next_value_of_HeadVar__6_6 = ToProcessIds_27;
        next_value_of_STATE_VARIABLE_AncestorIds_0_7 = STATE_VARIABLE_AncestorIds_2_32;
