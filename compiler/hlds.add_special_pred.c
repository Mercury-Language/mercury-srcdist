  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_57)
{
  ...
  {
    Origin_28 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Origin_28, 0) = (MR_Box) ((MR_Unsigned) (SpecialPredId_9));
    MR_hl_field(MR_mktag(2), Origin_28, 1) = ((MR_Box) (TypeCtor_12));
  }
