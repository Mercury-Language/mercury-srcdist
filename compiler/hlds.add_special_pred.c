  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  MR_Word PredInfo_77;
  MR_Word STATE_VARIABLE_ModuleInfo_1_78;
  MR_Word Var_79;
  MR_Word Var_80;
  MR_Word STATE_VARIABLE_ModuleInfo_3_84;
  ...
  if (succeeded)
  {
    ...
    Var_39 = mercury__map__init_0_f_0((MR_Word) (&hlds__add_special_pred_scalar_common_1[5]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
    ...
    mercury__map__from_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__add_special_pred_scalar_common_1[6]), Var_43, &ConsCtorMap_32);
    {
  ...
  else
  {
    ...
    hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_63, &Context_11);
    {
      ...
      MR_hl_field(0, Var_68, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
    ...
    parse_tree__prog_type_construct__construct_type_3_p_0(TypeCtor_5, TypeArgs_67, &Type_8);
  }
  ...
  if (succeeded)
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_defn_9_p_0((MR_Integer) 0, TVarSet_9, Type_8, TypeCtor_5, TypeBody_10, (MR_Word) (((MR_Box) ((MR_Unsigned) 8U))), Context_11, STATE_VARIABLE_ModuleInfo_0_14, &STATE_VARIABLE_ModuleInfo_1_78);
  }
  else
  {
    DeclMaybeDefn_13 = (MR_Integer) 0;
    hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 0, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(2, &hlds__add_special_pred_scalar_common_3[0])))), Context_11, STATE_VARIABLE_ModuleInfo_0_14, &STATE_VARIABLE_ModuleInfo_1_78);
  }
  hlds__hlds_module__module_info_get_special_pred_maps_2_p_0(STATE_VARIABLE_ModuleInfo_1_78, &SpecialPredMaps_71);
  hlds__special_pred__lookup_special_pred_maps_4_p_0(SpecialPredMaps_71, (MR_Integer) 0, TypeCtor_5, PredId_6);
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_1_78, *PredId_6, &PredInfo0_72);
  switch (DeclMaybeDefn_13) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      check_hlds__post_typecheck__setup_var_table_in_clauses_for_imported_pred_3_p_0(STATE_VARIABLE_ModuleInfo_1_78, PredInfo0_72, &PredInfo1_73);
      break;
  }
  Var_79 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&hlds__add_special_pred_scalar_common_2[1]));
  check_hlds__types_into_modes__propagate_checked_types_into_pred_modes_7_p_0(STATE_VARIABLE_ModuleInfo_1_78, &ErrorProcs_74, &_InstForTypeSpecs_75, Var_79, &_Cache_76, PredInfo1_73, &PredInfo_77);
  {
    Var_80 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_80, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_5[0]));
    MR_hl_field(0, Var_80, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_2));
    MR_hl_field(0, Var_80, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_80, 3) = ((MR_Box) (ErrorProcs_74));
    MR_hl_field(0, Var_80, 4) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  mercury__require__expect_3_p_0(Var_80, (MR_String) "predicate \140hlds.add_special_pred.add_lazily_generated_special_pred\'/11", (MR_String) "ErrorProcs != []");
  hlds__hlds_module__module_info_set_pred_info_4_p_0(*PredId_6, PredInfo_77, STATE_VARIABLE_ModuleInfo_1_78, &STATE_VARIABLE_ModuleInfo_3_84);
  check_hlds__polymorphism__polymorphism_process_generated_pred_3_p_0(*PredId_6, STATE_VARIABLE_ModuleInfo_3_84, STATE_VARIABLE_ModuleInfo_15);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  MR_Word STATE_VARIABLE_ModuleInfo_1_35;
  MR_Word STATE_VARIABLE_PredStatus_1_59;
  MR_Word ClausesInfo_69;
  MR_Word Markers0_70;
  MR_Word Markers_71;
  MR_Word PredId_72;
  MR_Word STATE_VARIABLE_ModuleInfo_1_73;
  MR_Word STATE_VARIABLE_PredInfo_1_74;
  MR_Word STATE_VARIABLE_PredInfo_2_76;
  MR_String Name_47;
  ...
  if (succeeded)
  {
    TypeInfo_13_54 = (MR_Word) (&hlds__add_special_pred_scalar_common_1[8]);
  ...
  if (succeeded)
  {
    ...
    parse_tree__prog_type_construct__construct_type_3_p_0(Var_49, (MR_Word) ((MR_Unsigned) 0U), &Type_18);
  }
  else
    Type_18 = Type0_12;
  ...
  if ((Var_68 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    succeeded = MR_FALSE;
  if (succeeded)
    STATE_VARIABLE_PredStatus_1_59 = (MR_Word) (((MR_Box) (MR_mkword(2, &hlds__add_special_pred_scalar_common_3[1]))));
  else
  {
    ...
    if (succeeded)
      STATE_VARIABLE_PredStatus_1_59 = (MR_Word) (((MR_Box) ((MR_Unsigned) 12U)));
    else
    {
      MR_Word OldStatus_55 = (MR_Word) (TypeStatus0_15);

      STATE_VARIABLE_PredStatus_1_59 = (MR_Word) (OldStatus_55);
    }
  }
  succeeded = (SpecialPredId_10 == (MR_Integer) 0);
  if (succeeded)
  {
    MR_Word Var_64 = (MR_Word) (STATE_VARIABLE_PredStatus_1_59);
    ...
    {
      MR_Word Var_66 = (MR_Word) (STATE_VARIABLE_PredStatus_1_59);

      succeeded = (Var_66 == (MR_Word) ((MR_Unsigned) 12U));
      if (succeeded)
        PredStatus_19 = (MR_Word) (((MR_Box) ((MR_Unsigned) 24U)));
      else
        PredStatus_19 = STATE_VARIABLE_PredStatus_1_59;
    }
  }
  else
    PredStatus_19 = STATE_VARIABLE_PredStatus_1_59;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_38 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_29, 2))));
  ...
  check_hlds__unify_proc__generate_clauses_for_special_pred_4_p_0(SpecDefnInfo_32, &ClausesInfo_69, STATE_VARIABLE_ModuleInfo_1_35, &STATE_VARIABLE_ModuleInfo_1_73);
  hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_69, PredInfo1_28, &STATE_VARIABLE_PredInfo_1_74);
  hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_1_74, &Markers0_70);
  hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 23, Markers0_70, &Markers_71);
  hlds__hlds_pred__pred_info_set_markers_3_p_0(Markers_71, STATE_VARIABLE_PredInfo_1_74, &STATE_VARIABLE_PredInfo_2_76);
  PredId_72 = ((MR_Word) ((MR_hl_field(0, SpecDefnInfo_32, 1))));
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_72, STATE_VARIABLE_PredInfo_2_76, STATE_VARIABLE_ModuleInfo_1_73, STATE_VARIABLE_ModuleInfo_34);
}
