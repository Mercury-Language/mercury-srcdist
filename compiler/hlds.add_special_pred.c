  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_57)
{
  ...
  hlds__hlds_clauses__clauses_info_set_var_table_3_p_0(VarTable_26, ClausesInfo0_23, &ClausesInfo_27);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_61, 0) = (MR_Box) ((MR_Unsigned) (SpecialPredId_9));
    MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (TypeCtor_12));
  }
  {
  ...
  hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Word) ((MR_Unsigned) 0U), PredArity_21, InstVarSet_40, ArgModes_18, Var_66, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_68, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_38, &PredInfo_43, &_ProcId_44);
