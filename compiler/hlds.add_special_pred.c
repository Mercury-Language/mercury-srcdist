  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__special_pred__special_pred_is_generated_lazily_for_defn_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_57)
{
  ...
  hlds__hlds_clauses__clauses_info_set_var_table_3_p_0(VarTable_26, ClausesInfo0_23, &ClausesInfo_27);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_61, 0) = (MR_Box) ((MR_Unsigned) (SpecialPredId_9));
    MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) (TypeCtor_12));
  }
  {
    Origin_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Origin_28, 0) = ((MR_Box) (Var_61));
  }
  ...
  mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), &InstVarSet_40);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (ArgModes_18));
  }
  {
    Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (Det_19));
  }
  ...
  Var_100 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 0))));
  Var_99 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 1))));
  Var_98 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 2))));
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 0))));
        Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 1))));
        {
          SpecialPredMaps_51 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 0) = ((MR_Box) (Var_83));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 1) = ((MR_Box) (Var_84));
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 0))));
        Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 2))));
        {
          SpecialPredMaps_51 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 0) = ((MR_Box) (Var_78));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 1) = ((MR_Box) (IndexMap_53));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 2) = ((MR_Box) (Var_80));
        }
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 1))));
        Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_48, (MR_Integer) 2))));
        {
          SpecialPredMaps_51 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 0) = ((MR_Box) (UnifyMap_50));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 1) = ((MR_Box) (Var_74));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_51, 2) = ((MR_Box) (Var_75));
        }
      }
      break;
  }
