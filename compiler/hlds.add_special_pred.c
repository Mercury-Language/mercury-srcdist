...
static const MR_EnumFunctorDescPtr hlds__add_special_pred__hlds__add_special_pred__enum_value_ordered_decl_maybe_defn_0[2];
...
hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__535__1_2_f_0(
  MR_Word Context_10,
  MR_Word LambdaHeadVar__1_36);

static MR_Word MR_CALL 
hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__532__1_2_f_0(
  MR_Word Context_10,
  MR_Word LambdaHeadVar__1_33);

static MR_bool MR_CALL 
hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__483__1_2_p_0(
...
static MR_bool MR_CALL 
hlds__add_special_pred__collect_type_defn_6_p_0_1(
  MR_Box closure_arg);

static void MR_CALL 
hlds__add_special_pred__collect_type_defn_6_p_0(
...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_1[8][2];
...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_5[2][6];
...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_1[8][2] = {
  ...
  {
    ((MR_Box) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__add_special_pred_scalar_common_1[4])))
  },
  /* row 6 */
  {
    ((MR_Box) (&mercury__list__list__type_ctor_info_list_1)),
...
const MR_TypeCtorInfo_Struct hlds__add_special_pred__hlds__add_special_pred__type_ctor_info_decl_maybe_defn_0 = {
  ...
  {     hlds__add_special_pred__hlds__add_special_pred__enum_value_ordered_decl_maybe_defn_0 },
  (MR_Integer) 2,
  (MR_Integer) 4,
...
{
  {
    ...
    {
      LambdaHeadVar__2_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_37, 1) = ((MR_Box) (LambdaHeadVar__1_36));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_37, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_37, 3) = ((MR_Box) (Context_10));
    }
...
{
  {
    ...
    {
      LambdaHeadVar__2_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_34, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_34, 1) = ((MR_Box) (LambdaHeadVar__1_33));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_34, 2) = ((MR_Box) (Context_10));
    }
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__add_special_pred_scalar_common_1[1], ((MR_Box) (ErrorProcs_25)), ((MR_Box) (HeadVar__2_34)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__483__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[2]))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_53);
...
{
  {
    ...
    conv1_LambdaHeadVar__2_37 = hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__535__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_34 = hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__532__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_62_77 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
      MR_Word TypeCtorInfo_65_80;
      ...
      MR_Word MaybeExistConstraints_31;
      MR_Word MakeUnnamedField_32;
      MR_Word CtorArgs_34;
      MR_Word MakeUnnamedFieldRepn_35;
      MR_Word CtorArgRepns_36;
      MR_Word CtorSymName_37;
      MR_Word Ctor_38;
      MR_Word CtorRepn_39;
      MR_Word ConsId_40;
      MR_Word ConsTagValues_41;
      MR_Word ConsCtorMap_42;
      MR_Word Repn_44;
      MR_Word Var_47;
      MR_Word Var_57;
      MR_Word Var_58;
      ...
      MR_Word Var_72;
      MR_Word Var_74;
      MR_Word Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), TypeCtor_5, (MR_Integer) 0)));

      mercury__varset__init_1_p_0(TypeCtorInfo_62_77, &TVarSet0_28);
      mercury__varset__new_vars_4_p_0(TypeCtorInfo_62_77, TupleArity_27, &TupleArgTVars_29, TVarSet0_28, &TVarSet_9);
      Var_47 = mercury__map__init_0_f_0((MR_Word) &hlds__add_special_pred_scalar_common_1[2], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
      parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_47, TupleArgTVars_29, &TupleArgTypes_30);
      MaybeExistConstraints_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      TypeCtorInfo_65_80 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
      CtorSymName_37 = (MR_Word) &hlds__add_special_pred_scalar_common_2[1];
      {
        ConsId_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ConsId_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(3), ConsId_40, 1) = ((MR_Box) (TupleArity_27));
      }
      {
        Var_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (ConsId_40));
        MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, Var_57, &ConsTagValues_41);
      ...
      {
        MakeUnnamedField_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MakeUnnamedField_32, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), MakeUnnamedField_32, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_1));
        MR_hl_field(MR_mktag(0), MakeUnnamedField_32, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), MakeUnnamedField_32, 3) = ((MR_Box) (Context_11));
      }
      CtorArgs_34 = mercury__list__map_2_f_0(TypeCtorInfo_65_80, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, MakeUnnamedField_32, TupleArgTypes_30);
      {
        MakeUnnamedFieldRepn_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MakeUnnamedFieldRepn_35, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), MakeUnnamedFieldRepn_35, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_2));
        MR_hl_field(MR_mktag(0), MakeUnnamedFieldRepn_35, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), MakeUnnamedFieldRepn_35, 3) = ((MR_Box) (Context_11));
      }
      CtorArgRepns_36 = mercury__list__map_2_f_0(TypeCtorInfo_65_80, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_arg_repn_0, MakeUnnamedFieldRepn_35, TupleArgTypes_30);
      {
        Ctor_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Ctor_38, 0) = ((MR_Box) (MaybeExistConstraints_31));
        MR_hl_field(MR_mktag(0), Ctor_38, 1) = ((MR_Box) (CtorSymName_37));
        MR_hl_field(MR_mktag(0), Ctor_38, 2) = ((MR_Box) (CtorArgs_34));
        MR_hl_field(MR_mktag(0), Ctor_38, 3) = ((MR_Box) (TupleArity_27));
        MR_hl_field(MR_mktag(0), Ctor_38, 4) = ((MR_Box) (Context_11));
      }
      {
        Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Ctor_38));
        MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        CtorRepn_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CtorRepn_39, 0) = ((MR_Box) (MaybeExistConstraints_31));
        MR_hl_field(MR_mktag(0), CtorRepn_39, 1) = ((MR_Box) (CtorSymName_37));
        MR_hl_field(MR_mktag(0), CtorRepn_39, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), CtorRepn_39, 3) = ((MR_Box) (CtorArgRepns_36));
        MR_hl_field(MR_mktag(0), CtorRepn_39, 4) = ((MR_Box) (TupleArity_27));
        MR_hl_field(MR_mktag(0), CtorRepn_39, 5) = ((MR_Box) (Context_11));
      }
      {
        Var_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (CtorRepn_39));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) ((MR_String) "{}"));
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &hlds__add_special_pred_scalar_common_1[3], Var_61, &ConsCtorMap_42);
      {
        Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (CtorRepn_39));
        MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Repn_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Repn_44, 0) = ((MR_Box) (ConsTagValues_41));
        MR_hl_field(MR_mktag(0), Repn_44, 1) = ((MR_Box) (Var_67));
        MR_hl_field(MR_mktag(0), Repn_44, 2) = ((MR_Box) (ConsCtorMap_42));
        MR_hl_field(MR_mktag(0), Repn_44, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), Repn_44, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
        MR_hl_field(MR_mktag(0), Repn_44, 5) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), Repn_44, 6) = ((MR_Box) ((MR_Integer) 1));
      }
      {
        Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (Repn_44));
      }
      {
        TypeBody_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), TypeBody_10, 0) = ((MR_Box) (Var_72));
        MR_hl_field(MR_mktag(1), TypeBody_10, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(1), TypeBody_10, 2) = ((MR_Box) (Var_74));
        MR_hl_field(MR_mktag(1), TypeBody_10, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    else
      hlds__add_special_pred__collect_type_defn_6_p_0(STATE_VARIABLE_ModuleInfo_0_14, TypeCtor_5, &Type_8, &TVarSet_9, &TypeBody_10, &Context_11);
    ...
    if (succeeded)
    {
      TypeStatus_12 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
      DeclMaybeDefn_13 = (MR_Integer) 1;
    }
    else
    {
      TypeStatus_12 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[2])));
...
{
  {
    ...
    hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_7, &TypeTable_13);
    hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_13, TypeCtor_8, &TypeDefn_14);
    hlds__hlds_data__get_type_defn_tvarset_2_p_0(TypeDefn_14, TVarSet_10);
    hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_14, &TypeParams_15);
    hlds__hlds_data__get_type_defn_kind_map_2_p_0(TypeDefn_14, &KindMap_16);
    hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_14, TypeBody_11);
    hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_14, &TypeStatus_17);
    hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_14, Context_12);
    {
      Var_19 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (hlds__add_special_pred__collect_type_defn_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_19, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (ModuleInfo_7));
      MR_hl_field(MR_mktag(0), Var_19, 4) = ((MR_Box) (TypeCtor_8));
      MR_hl_field(MR_mktag(0), Var_19, 5) = ((MR_Box) (*TypeBody_11));
      MR_hl_field(MR_mktag(0), Var_19, 6) = ((MR_Box) (TypeStatus_17));
    }
    mercury__require__expect_3_p_0(Var_19, (MR_String) "predicate \140hlds.add_special_pred.collect_type_defn\'/6", (MR_String) "not generated lazily");
    parse_tree__prog_type__var_list_to_type_list_3_p_0(KindMap_16, TypeParams_15, &TypeArgs_18);
    parse_tree__prog_type__construct_type_3_p_0(TypeCtor_8, TypeArgs_18, Type_9);
  }
}
...
{
  {
    ...
    switch (Item_13) {
      ...
      case (MR_Integer) 1:
        hlds__add_special_pred__add_special_pred_decl_defn_9_p_0(SpecialId_12, TVarSet_14, Type_15, TypeCtor_16, TypeBody_17, TypeStatus_19, Context_18, STATE_VARIABLE_ModuleInfo_0_27, &STATE_VARIABLE_ModuleInfo_30_30);
        break;
      case (MR_Integer) 0:
        hlds__add_special_pred__add_special_pred_decl_8_p_0(SpecialId_12, TVarSet_14, Type_15, TypeCtor_16, TypeStatus_19, Context_18, STATE_VARIABLE_ModuleInfo_0_27, &STATE_VARIABLE_ModuleInfo_30_30);
        break;
    }
    ...
    check_hlds__post_typecheck__propagate_types_into_modes_4_p_0(STATE_VARIABLE_ModuleInfo_30_30, &ErrorProcs_25, PredInfo1_24, &PredInfo_26);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_special_pred_11_p_0_1));
    ...
    mercury__require__expect_3_p_0(Var_31, (MR_String) "predicate \140hlds.add_special_pred.add_lazily_generated_special_pred\'/11", (MR_String) "ErrorProcs != []");
...
{
  {
    ...
    {
      MR_Word SpecialPredIds_19 = (MR_Word) MR_mkword(MR_mktag(1), &hlds__add_special_pred_scalar_common_1[5]);
...
{
  {
    ...
    if (succeeded)
    {
      TypeInfo_13_58 = (MR_Word) &hlds__add_special_pred_scalar_common_1[6];
...
{
  {
    ...
    Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 0)));
    PredId_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 1)));
    Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 2)));
    Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 3)));
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 4)));
    Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 5)));
    Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 6)));
    Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 7)));
...
{
  {
    ...
    mercury__map__init_1_p_0(TypeCtorInfo_80_80, (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0, &Proofs_27);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0, TypeCtorInfo_80_80, &ConstraintMap_28);
