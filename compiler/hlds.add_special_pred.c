...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Ctor_36));
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
...
{
  {
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0((MR_Integer) 0, PredArity_22, Var_54, &ClausesInfo0_23);
    {
    ...
    hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Integer) -1, PredArity_22, InstVarSet_35, ArgModes_18, Var_59, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_61, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_33, &PredInfo_38, &_ProcId_39);
