...
static MR_bool MR_CALL 
hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_3(
  MR_Box closure_arg);
...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_4[2][6];

static /* final */ const MR_Box hlds__add_special_pred_scalar_common_5[1][7];
...
{
  {
    ...
    {
      LambdaHeadVar__2_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_35, 1) = ((MR_Box) (LambdaHeadVar__1_34));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_35, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_35, 3) = ((MR_Box) (Context_10));
    }
...
{
  {
    ...
    {
      LambdaHeadVar__2_32 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_32, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_32, 1) = ((MR_Box) (LambdaHeadVar__1_31));
      MR_hl_field(MR_mktag(0), LambdaHeadVar__2_32, 2) = ((MR_Box) (Context_10));
    }
...
{
  {
    ...
    hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_27, &Context_11);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_5[0]));
...
{
  {
    ...
    conv1_LambdaHeadVar__2_35 = hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__535__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_32 = hlds__add_special_pred__IntroducedFrom__func__collect_type_defn_for_tuple__532__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_55_70 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
      MR_Word TypeCtorInfo_58_73;
      ...
      mercury__varset__init_1_p_0(TypeCtorInfo_55_70, &TVarSet0_28);
      mercury__varset__new_vars_4_p_0(TypeCtorInfo_55_70, TupleArity_27, &TupleArgTVars_29, TVarSet0_28, &TVarSet_9);
      ...
      TypeCtorInfo_58_73 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
      ...
      mercury__term__context_init_1_p_0(&Context_11);
      {
        ...
        MR_hl_field(MR_mktag(0), MakeUnnamedField_32, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
      ...
      CtorArgs_34 = mercury__list__map_2_f_0(TypeCtorInfo_58_73, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, MakeUnnamedField_32, TupleArgTypes_30);
      {
        MakeUnnamedFieldRepn_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MakeUnnamedFieldRepn_35, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[1]));
      ...
      CtorArgRepns_36 = mercury__list__map_2_f_0(TypeCtorInfo_58_73, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_arg_repn_0, MakeUnnamedFieldRepn_35, TupleArgTypes_30);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (Ctor_38));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (CtorRepn_39));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) ((MR_String) "{}"));
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &hlds__add_special_pred_scalar_common_1[3], Var_55, &ConsCtorMap_40);
      {
        Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (CtorRepn_39));
        MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Repn_42 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Repn_42, 0) = ((MR_Box) (Var_61));
        MR_hl_field(MR_mktag(0), Repn_42, 1) = ((MR_Box) (ConsCtorMap_40));
        MR_hl_field(MR_mktag(0), Repn_42, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), Repn_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
        MR_hl_field(MR_mktag(0), Repn_42, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (Repn_42));
      }
      {
        TypeBody_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), TypeBody_10, 0) = ((MR_Box) (Var_65));
        MR_hl_field(MR_mktag(1), TypeBody_10, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(1), TypeBody_10, 2) = ((MR_Box) (Var_67));
    ...
    else
    {
      ...
      MR_Word KindMap_87;
      MR_Word TypeStatus_88;
      MR_Word TypeArgs_89;
      MR_Word Var_90;

      hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_14, &TypeTable_84);
      hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_84, TypeCtor_5, &TypeDefn_85);
      hlds__hlds_data__get_type_defn_tvarset_2_p_0(TypeDefn_85, &TVarSet_9);
      hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_85, &TypeParams_86);
      hlds__hlds_data__get_type_defn_kind_map_2_p_0(TypeDefn_85, &KindMap_87);
      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_85, &TypeBody_10);
      hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_85, &TypeStatus_88);
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_85, &Context_11);
      {
        Var_90 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_90, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_90, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_3));
        MR_hl_field(MR_mktag(0), Var_90, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_90, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14));
        MR_hl_field(MR_mktag(0), Var_90, 4) = ((MR_Box) (TypeCtor_5));
        MR_hl_field(MR_mktag(0), Var_90, 5) = ((MR_Box) (TypeBody_10));
        MR_hl_field(MR_mktag(0), Var_90, 6) = ((MR_Box) (TypeStatus_88));
      }
      mercury__require__expect_3_p_0(Var_90, (MR_String) "predicate \140hlds.add_special_pred.collect_type_defn\'/6", (MR_String) "not generated lazily");
      parse_tree__prog_type__var_list_to_type_list_3_p_0(KindMap_87, TypeParams_86, &TypeArgs_89);
      parse_tree__prog_type__construct_type_3_p_0(TypeCtor_5, TypeArgs_89, &Type_8);
    }
