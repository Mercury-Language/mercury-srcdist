  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_31_53);
  hlds__hlds_module__module_info_get_special_pred_maps_2_p_0(STATE_VARIABLE_ModuleInfo_31_53, &SpecialPredMaps_46);
  hlds__special_pred__lookup_special_pred_maps_4_p_0(SpecialPredMaps_46, (MR_Integer) 2, TypeCtor_5, PredId_6);
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_31_53, *PredId_6, &PredInfo0_47);
  check_hlds__post_typecheck__setup_vartypes_in_clauses_for_imported_pred_2_p_0(PredInfo0_47, &PredInfo1_48);
  check_hlds__post_typecheck__propagate_checked_types_into_pred_modes_5_p_0(STATE_VARIABLE_ModuleInfo_31_53, &ErrorProcs_49, &_InstForTypeSpecs_50, PredInfo1_48, &PredInfo_51);
  {
  ...
  hlds__hlds_module__module_info_set_pred_info_4_p_0(*PredId_6, PredInfo_51, STATE_VARIABLE_ModuleInfo_31_53, &STATE_VARIABLE_ModuleInfo_36_58);
