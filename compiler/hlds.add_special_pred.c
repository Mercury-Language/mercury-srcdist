...
hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__446__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__446__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_53);
  ...
  check_hlds__post_typecheck__propagate_checked_types_into_pred_modes_5_p_0(STATE_VARIABLE_ModuleInfo_30_53, &ErrorProcs_50, &_InstForTypeSpecs_51, PredInfo1_49, &PredInfo_52);
  {
  ...
  hlds__hlds_module__module_info_set_pred_info_4_p_0(*PredId_6, PredInfo_52, STATE_VARIABLE_ModuleInfo_30_53, &STATE_VARIABLE_ModuleInfo_36_59);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  MR_Word STATE_VARIABLE_PredStatus_12_66;
  MR_String Name_50;
  MR_Word TypeInfo_13_57;
  MR_Word TypeCtor_49;
  MR_Word Var_56;
  MR_Word Var_79;
  MR_Word Var_21;
  ...
  succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type0_12, &TypeCtor_49, &Var_56);
  if (succeeded)
  {
    TypeInfo_13_57 = (MR_Word) (&hlds__add_special_pred_scalar_common_1[5]);
    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_13_57, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_56)));
    if (succeeded)
      succeeded = hlds__special_pred__is_builtin_type_special_preds_defined_in_mercury_2_p_0(TypeCtor_49, &Name_50);
  }
  if (succeeded)
  {
    MR_Word Var_52;
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (Name_50));
    }
    {
      Var_52 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (Var_54));
      MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    parse_tree__prog_type__construct_type_3_p_0(Var_52, (MR_Word) ((MR_Unsigned) 0U), &Type_18);
  }
  else
    Type_18 = Type0_12;
  Var_79 = (MR_Word) (TypeStatus0_15);
  if ((Var_79 == (MR_Word) ((MR_Unsigned) 4U)))
    succeeded = MR_TRUE;
  else
  if ((Var_79 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    succeeded = MR_FALSE;
  if (succeeded)
    STATE_VARIABLE_PredStatus_12_66 = (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[1]))));
  else
  {
    MR_Word Var_69 = (MR_Word) (TypeStatus0_15);

    succeeded = (Var_69 == (MR_Word) ((MR_Unsigned) 20U));
    if (succeeded)
      STATE_VARIABLE_PredStatus_12_66 = (MR_Word) (((MR_Box) ((MR_Unsigned) 12U)));
    else
    {
      MR_Word OldStatus_62 = (MR_Word) (TypeStatus0_15);

      STATE_VARIABLE_PredStatus_12_66 = (MR_Word) (OldStatus_62);
    }
  }
  succeeded = (SpecialPredId_10 == (MR_Integer) 0);
  if (succeeded)
  {
    MR_Word Var_73 = (MR_Word) (STATE_VARIABLE_PredStatus_12_66);
    ...
    {
      MR_Word Var_76 = (MR_Word) (STATE_VARIABLE_PredStatus_12_66);

      succeeded = (Var_76 == (MR_Word) ((MR_Unsigned) 12U));
      if (succeeded)
        PredStatus_19 = (MR_Word) (((MR_Box) ((MR_Unsigned) 24U)));
      else
        PredStatus_19 = STATE_VARIABLE_PredStatus_12_66;
    }
  }
  else
    PredStatus_19 = STATE_VARIABLE_PredStatus_12_66;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_53)
{
  ...
  Var_55 = (MR_Word) (PredFormArity_22);
  Var_56 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
  hlds__hlds_clauses__clauses_info_init_4_p_0((MR_Integer) 0, Var_55, Var_56, &ClausesInfo0_23);
  {
  ...
  {
    Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (ArgModes_18));
  }
  {
    Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Det_19));
  }
  hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Word) ((MR_Unsigned) 0U), PredArity_21, InstVarSet_36, ArgModes_18, Var_61, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_63, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_34, &PredInfo_39, &_ProcId_40);
  ...
  hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredicateTable_43, STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_65_65);
  hlds__hlds_module__module_info_get_special_pred_maps_2_p_0(STATE_VARIABLE_ModuleInfo_65_65, &SpecialPredMaps0_44);
  Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 0))));
  Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 1))));
  Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 2))));
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (TypeCtor_12)), ((MR_Box) (PredId_42)), Var_94, &CompareMap_51);
        Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 0))));
        Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 1))));
        {
          SpecialPredMaps_47 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 0) = ((MR_Box) (Var_79));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 1) = ((MR_Box) (Var_80));
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (TypeCtor_12)), ((MR_Box) (PredId_42)), Var_95, &IndexMap_49);
        Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 0))));
        Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 2))));
        {
          SpecialPredMaps_47 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 0) = ((MR_Box) (Var_74));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 1) = ((MR_Box) (IndexMap_49));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 2) = ((MR_Box) (Var_76));
        }
      }
      break;
    case (MR_Integer) 0:
      {
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (TypeCtor_12)), ((MR_Box) (PredId_42)), Var_96, &UnifyMap_46);
        Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 1))));
        Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecialPredMaps0_44, (MR_Integer) 2))));
        {
          SpecialPredMaps_47 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 0) = ((MR_Box) (UnifyMap_46));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 1) = ((MR_Box) (Var_70));
          MR_hl_field(MR_mktag(0), SpecialPredMaps_47, 2) = ((MR_Box) (Var_71));
        }
      }
      break;
  }
  hlds__hlds_module__module_info_set_special_pred_maps_3_p_0(SpecialPredMaps_47, STATE_VARIABLE_ModuleInfo_65_65, STATE_VARIABLE_ModuleInfo_53);
}
