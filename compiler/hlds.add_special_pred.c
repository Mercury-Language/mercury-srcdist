  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_34);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  else
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 0, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])))), Context_11, STATE_VARIABLE_ModuleInfo_0_14, &STATE_VARIABLE_ModuleInfo_30_77);
  }
