...
{
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[2]))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_53);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), CtorRepn_37, 3) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), TypeBody_10, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), TypeBody_10, 2) = ((MR_Box) (Var_58));
        MR_hl_field(MR_mktag(1), TypeBody_10, 3) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    else
    {
    ...
    if (succeeded)
    {
      TypeStatus_12 = ((MR_Box) ((MR_Unsigned) 8U));
      DeclMaybeDefn_13 = (MR_Integer) 1;
    }
    else
    {
      TypeStatus_12 = ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[2])));
...
{
  {
    ...
    check_hlds__post_typecheck__propagate_types_into_modes_4_p_0(STATE_VARIABLE_ModuleInfo_30_30, &ErrorProcs_25, PredInfo1_24, &PredInfo_26);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_31, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_13_58, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_57)));
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_type__construct_type_3_p_0(Var_53, (MR_Word) ((MR_Unsigned) 0U), &Type_18);
    }
    else
      Type_18 = Type0_12;
    Var_80 = (MR_Word) (TypeStatus0_15);
    if ((Var_80 == (MR_Word) ((MR_Unsigned) 4U)))
      succeeded = MR_TRUE;
    else
    if ((Var_80 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      succeeded = MR_FALSE;
    if (succeeded)
      STATE_VARIABLE_PredStatus_12_67 = ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])));
    else
    {
      MR_Word Var_70 = (MR_Word) (TypeStatus0_15);

      succeeded = (Var_70 == (MR_Word) ((MR_Unsigned) 20U));
      if (succeeded)
        STATE_VARIABLE_PredStatus_12_67 = ((MR_Box) ((MR_Unsigned) 12U));
      else
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        PredStatus_19 = ((MR_Box) ((MR_Unsigned) 8U));
      }
      else
      {
        MR_Word Var_77 = (MR_Word) (STATE_VARIABLE_PredStatus_12_67);

        succeeded = (Var_77 == (MR_Word) ((MR_Unsigned) 12U));
        if (succeeded)
          PredStatus_19 = ((MR_Box) ((MR_Unsigned) 24U));
        else
    ...
    if ((Var_47 == (MR_Word) ((MR_Unsigned) 8U)))
      succeeded = MR_TRUE;
    else
...
{
  {
    ...
    hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_16, PredName_21, Arity_22, (MR_Integer) 0, Context_14, Origin_24, PredStatus_25, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 12U), Markers_29, ArgTypes_17, TVarSet_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__add_special_pred_scalar_common_1[7]), Proofs_27, ConstraintMap_28, ClausesInfo0_23, VarNameRemap_32, &PredInfo0_33);
    ...
    hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Integer) -1, Arity_22, InstVarSet_35, ArgModes_18, Var_59, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_61, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_33, &PredInfo_38, &_ProcId_39);
...
{
  {
    ...
    if ((Var_25 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      succeeded = MR_FALSE;
    if (succeeded)
      STATE_VARIABLE_PredStatus_12_12 = ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[0])));
    else
    {
      ...
      if (succeeded)
        STATE_VARIABLE_PredStatus_12_12 = ((MR_Box) ((MR_Unsigned) 12U));
      else
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        *STATE_VARIABLE_PredStatus_9 = ((MR_Box) ((MR_Unsigned) 8U));
      }
      else
      {
        ...
        if (succeeded)
          *STATE_VARIABLE_PredStatus_9 = ((MR_Box) ((MR_Unsigned) 24U));
        else
