...
hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__443__1_2_p_0(
...
{
  {
    ...
    succeeded = hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__443__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[1])))), Context_11, STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_53);
...
{
  {
    ...
    {
      TypeStatus_12 = (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[1]))));
...
{
  {
    ...
    hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_16, PredName_21, PredArity_22, (MR_Integer) 0, Context_14, Origin_24, PredStatus_25, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__add_special_pred_scalar_common_2[1]), Markers_30, ArgTypes_17, TVarSet_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__add_special_pred_scalar_common_1[5]), Proofs_28, ConstraintMap_29, ClausesInfo0_23, VarNameRemap_33, &PredInfo0_34);
