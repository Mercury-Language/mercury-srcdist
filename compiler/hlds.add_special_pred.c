...
{
  {
    ...
    if (succeeded)
    {
      TypeInfo_13_59 = (MR_Word) (&hlds__add_special_pred_scalar_common_1[5]);
    ...
    if ((Var_81 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      succeeded = MR_FALSE;
    if (succeeded)
      STATE_VARIABLE_PredStatus_12_68 = (MR_Word) (((MR_Box) (MR_mkword(MR_mktag(2), &hlds__add_special_pred_scalar_common_2[1]))));
    else
    {
