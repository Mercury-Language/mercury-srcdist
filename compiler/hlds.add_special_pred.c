...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_43 = mercury__map__init_0_f_0((MR_Word) (&hlds__add_special_pred_scalar_common_1[2]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
      parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_43, TupleArgTVars_29, &TupleArgTypes_30);
      ...
      {
        Ctor_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Ctor_36, 0) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), Ctor_36, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), Ctor_36, 2) = ((MR_Box) (&hlds__add_special_pred_scalar_common_2[1]));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (Ctor_36));
        MR_hl_field(MR_mktag(1), Var_56, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        CtorRepn_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CtorRepn_37, 0) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), CtorRepn_37, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), CtorRepn_37, 2) = ((MR_Box) (&hlds__add_special_pred_scalar_common_2[1]));
        MR_hl_field(MR_mktag(0), CtorRepn_37, 3) = ((MR_Box) ((MR_Integer) 0));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (CtorRepn_37));
        MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        Var_47 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) ((MR_String) "{}"));
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__add_special_pred_scalar_common_1[3]), Var_46, &ConsCtorMap_38);
      {
        Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (CtorRepn_37));
        MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        Repn_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Repn_40, 0) = ((MR_Box) (Var_52));
        MR_hl_field(MR_mktag(0), Repn_40, 1) = ((MR_Box) (ConsCtorMap_38));
        MR_hl_field(MR_mktag(0), Repn_40, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), Repn_40, 3) = ((MR_Box) ((MR_Integer) 8));
        MR_hl_field(MR_mktag(0), Repn_40, 4) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (Repn_40));
      }
      {
        TypeBody_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), TypeBody_10, 0) = ((MR_Box) (Var_56));
        MR_hl_field(MR_mktag(1), TypeBody_10, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), TypeBody_10, 2) = ((MR_Box) (Var_58));
        MR_hl_field(MR_mktag(1), TypeBody_10, 3) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    else
    {
      ...
      MR_Word KindMap_78;
      MR_Word TypeStatus_79;
      MR_Word TypeArgs_80;
      MR_Word Var_81;

      hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_14, &TypeTable_75);
      hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_75, TypeCtor_5, &TypeDefn_76);
      hlds__hlds_data__get_type_defn_tvarset_2_p_0(TypeDefn_76, &TVarSet_9);
      hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_76, &TypeParams_77);
      hlds__hlds_data__get_type_defn_kind_map_2_p_0(TypeDefn_76, &KindMap_78);
      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_76, &TypeBody_10);
      hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_76, &TypeStatus_79);
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_76, &Context_11);
      {
        Var_81 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_1));
        MR_hl_field(MR_mktag(0), Var_81, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_81, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14));
        MR_hl_field(MR_mktag(0), Var_81, 4) = ((MR_Box) (TypeCtor_5));
        MR_hl_field(MR_mktag(0), Var_81, 5) = ((MR_Box) (TypeBody_10));
        MR_hl_field(MR_mktag(0), Var_81, 6) = ((MR_Box) (TypeStatus_79));
      }
      mercury__require__expect_3_p_0(Var_81, (MR_String) "predicate \140hlds.add_special_pred.collect_type_defn\'/6", (MR_String) "not generated lazily");
      parse_tree__prog_type__var_list_to_type_list_3_p_0(KindMap_78, TypeParams_77, &TypeArgs_80);
      parse_tree__prog_type__construct_type_3_p_0(TypeCtor_5, TypeArgs_80, &Type_8);
    }
    ...
    if (succeeded)
    {
      TypeStatus_12 = (MR_Word) (((MR_Box) ((MR_Integer) 8)));
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), CtorArg_12, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), CtorArgRepn_14, 0) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_13_58, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_57)));
      if (succeeded)
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_type__construct_type_3_p_0(Var_53, (MR_Word) ((MR_Integer) 0), &Type_18);
    }
    else
      Type_18 = Type0_12;
    Var_80 = (MR_Word) (TypeStatus0_15);
    if ((Var_80 == (MR_Word) ((MR_Integer) 4)))
      succeeded = MR_TRUE;
    else
    if ((Var_80 == (MR_Word) ((MR_Integer) 0)))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    ...
    else
    {
      ...
      succeeded = (Var_70 == (MR_Word) ((MR_Integer) 20));
      if (succeeded)
        STATE_VARIABLE_PredStatus_12_67 = (MR_Word) (((MR_Box) ((MR_Integer) 12)));
      else
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        PredStatus_19 = (MR_Word) (((MR_Box) ((MR_Integer) 8)));
      }
      else
      {
        MR_Word Var_77 = (MR_Word) (STATE_VARIABLE_PredStatus_12_67);

        succeeded = (Var_77 == (MR_Word) ((MR_Integer) 12));
        if (succeeded)
          PredStatus_19 = (MR_Word) (((MR_Box) ((MR_Integer) 24)));
        else
    ...
    if ((Var_47 == (MR_Word) ((MR_Integer) 8)))
      succeeded = MR_TRUE;
    else
    if (((MR_tag((MR_Word) Var_47)) == (MR_Integer) 2))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) TypeBody_14)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = (Var_39 == (MR_Word) ((MR_Integer) 8));
          if (succeeded)
          {
...
{
  {
    ...
    mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0), &Proofs_27);
    mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), &ConstraintMap_28);
    ...
    hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_16, PredName_21, Arity_22, (MR_Integer) 0, Context_14, Origin_24, PredStatus_25, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 12), Markers_29, ArgTypes_17, TVarSet_10, (MR_Word) ((MR_Integer) 0), (MR_Word) (&hlds__add_special_pred_scalar_common_1[7]), Proofs_27, ConstraintMap_28, ClausesInfo0_23, VarNameRemap_32, &PredInfo0_33);
    ...
    hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Integer) -1, Arity_22, InstVarSet_35, ArgModes_18, Var_59, (MR_Word) ((MR_Integer) 0), (MR_Integer) 1, Var_61, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_33, &PredInfo_38, &_ProcId_39);
...
{
  {
    ...
    if ((Var_25 == (MR_Word) ((MR_Integer) 4)))
      succeeded = MR_TRUE;
    else
    if ((Var_25 == (MR_Word) ((MR_Integer) 0)))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    ...
    else
    {
      ...
      succeeded = (Var_15 == (MR_Word) ((MR_Integer) 20));
      if (succeeded)
        STATE_VARIABLE_PredStatus_12_12 = (MR_Word) (((MR_Box) ((MR_Integer) 12)));
      else
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        *STATE_VARIABLE_PredStatus_9 = (MR_Word) (((MR_Box) ((MR_Integer) 8)));
      }
      else
      {
        MR_Word Var_22 = (MR_Word) (STATE_VARIABLE_PredStatus_12_12);

        succeeded = (Var_22 == (MR_Word) ((MR_Integer) 12));
        if (succeeded)
          *STATE_VARIABLE_PredStatus_9 = (MR_Word) (((MR_Box) ((MR_Integer) 24)));
        else
