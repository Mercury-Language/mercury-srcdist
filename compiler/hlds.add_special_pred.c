  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_52)
{
  ...
  parse_tree__pred_name__make_uci_pred_sym_name_3_p_0(SpecialPredId_9, TypeCtor_12, &PredSymName_20);
  ...
  hlds__hlds_clauses__clauses_info_init_4_p_0((MR_Integer) 0, PredArity_21, Var_54, &ClausesInfo0_22);
  {
    Origin_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Origin_23, 0) = (MR_Box) ((MR_Unsigned) (SpecialPredId_9));
    MR_hl_field(MR_mktag(1), Origin_23, 1) = ((MR_Box) (TypeCtor_12));
  }
  hlds__add_special_pred__adjust_special_pred_status_3_p_0(SpecialPredId_9, TypeStatus_13, &PredStatus_24);
  ...
  hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_16, (MR_Integer) 0, PredSymName_20, PredArity_21, Context_14, Origin_23, PredStatus_24, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__add_special_pred_scalar_common_2[0]), Markers_29, ArgTypes_17, TVarSet_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__add_special_pred_scalar_common_1[4]), Proofs_27, ConstraintMap_28, ClausesInfo0_22, VarNameRemap_32, &PredInfo0_33);
  ...
  hlds__add_pred__add_new_proc_14_p_0(Context_14, (MR_Word) ((MR_Unsigned) 0U), PredArity_21, InstVarSet_35, ArgModes_18, Var_59, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_61, (MR_Integer) 1, (MR_Integer) 1, PredInfo0_33, &PredInfo_38, &_ProcId_39);
