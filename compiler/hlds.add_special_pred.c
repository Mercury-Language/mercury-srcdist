...
hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__454__1_2_p_0(
...
{
  {
    ...
    succeeded = hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__454__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_43_58 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
      ...
      mercury__varset__init_1_p_0(TypeCtorInfo_43_58, &TVarSet0_28);
      mercury__varset__new_vars_4_p_0(TypeCtorInfo_43_58, TupleArity_27, &TupleArgTVars_29, TVarSet0_28, &TVarSet_9);
      Var_42 = mercury__map__init_0_f_0((MR_Word) &hlds__add_special_pred_scalar_common_1[2], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
      parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_42, TupleArgTVars_29, &TupleArgTypes_30);
      MaybeExistConstraints_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      CtorSymName_34 = (MR_Word) &hlds__add_special_pred_scalar_common_2[1];
      ...
      {
        Ctor_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Ctor_35, 0) = ((MR_Box) (MaybeExistConstraints_31));
        MR_hl_field(MR_mktag(0), Ctor_35, 1) = ((MR_Box) (CtorSymName_34));
        MR_hl_field(MR_mktag(0), Ctor_35, 2) = ((MR_Box) (CtorArgs_32));
        MR_hl_field(MR_mktag(0), Ctor_35, 3) = ((MR_Box) (TupleArity_27));
        MR_hl_field(MR_mktag(0), Ctor_35, 4) = ((MR_Box) (Context_11));
      }
      {
        Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (Ctor_35));
        MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        CtorRepn_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CtorRepn_36, 0) = ((MR_Box) (MaybeExistConstraints_31));
        MR_hl_field(MR_mktag(0), CtorRepn_36, 1) = ((MR_Box) (CtorSymName_34));
        MR_hl_field(MR_mktag(0), CtorRepn_36, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), CtorRepn_36, 3) = ((MR_Box) (CtorArgRepns_33));
        MR_hl_field(MR_mktag(0), CtorRepn_36, 4) = ((MR_Box) (TupleArity_27));
        MR_hl_field(MR_mktag(0), CtorRepn_36, 5) = ((MR_Box) (Context_11));
      }
      {
        Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (CtorRepn_36));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) ((MR_String) "{}"));
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &hlds__add_special_pred_scalar_common_1[3], Var_45, &ConsCtorMap_37);
      {
        Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (CtorRepn_36));
        MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Repn_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Repn_39, 0) = ((MR_Box) (Var_51));
        MR_hl_field(MR_mktag(0), Repn_39, 1) = ((MR_Box) (ConsCtorMap_37));
        MR_hl_field(MR_mktag(0), Repn_39, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(0), Repn_39, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
        MR_hl_field(MR_mktag(0), Repn_39, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (Repn_39));
      }
      {
        TypeBody_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), TypeBody_10, 0) = ((MR_Box) (Var_55));
        MR_hl_field(MR_mktag(1), TypeBody_10, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(1), TypeBody_10, 2) = ((MR_Box) (Var_57));
    ...
    else
    {
      ...
      MR_Word KindMap_77;
      MR_Word TypeStatus_78;
      MR_Word TypeArgs_79;
      MR_Word Var_80;

      hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_14, &TypeTable_74);
      hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_74, TypeCtor_5, &TypeDefn_75);
      hlds__hlds_data__get_type_defn_tvarset_2_p_0(TypeDefn_75, &TVarSet_9);
      hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_75, &TypeParams_76);
      hlds__hlds_data__get_type_defn_kind_map_2_p_0(TypeDefn_75, &KindMap_77);
      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_75, &TypeBody_10);
      hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_75, &TypeStatus_78);
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_75, &Context_11);
      {
        Var_80 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_1));
        MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14));
        MR_hl_field(MR_mktag(0), Var_80, 4) = ((MR_Box) (TypeCtor_5));
        MR_hl_field(MR_mktag(0), Var_80, 5) = ((MR_Box) (TypeBody_10));
        MR_hl_field(MR_mktag(0), Var_80, 6) = ((MR_Box) (TypeStatus_78));
      }
      mercury__require__expect_3_p_0(Var_80, (MR_String) "predicate \140hlds.add_special_pred.collect_type_defn\'/6", (MR_String) "not generated lazily");
      parse_tree__prog_type__var_list_to_type_list_3_p_0(KindMap_77, TypeParams_76, &TypeArgs_79);
      parse_tree__prog_type__construct_type_3_p_0(TypeCtor_5, TypeArgs_79, &Type_8);
    }
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    {
      CtorArg_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), CtorArg_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    {
      ArgPosWidth_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ArgPosWidth_16, 0) = ((MR_Box) (Var_18));
      MR_hl_field(MR_mktag(1), ArgPosWidth_16, 1) = ((MR_Box) (Var_19));
    }
    {
      CtorArgRepn_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), CtorArgRepn_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    Var_21 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
