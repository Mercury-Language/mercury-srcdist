...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_1[9][2];
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (Ctor_36));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), CtorRepn_37, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__add_special_pred_scalar_common_1[8])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (CtorRepn_37));
        MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) ((MR_String) "{}"));
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__add_special_pred_scalar_common_1[3]), Var_47, &ConsCtorMap_38);
      {
        Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (CtorRepn_37));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Repn_40, 0) = ((MR_Box) (Var_53));
    ...
    else
    {
      ...
      MR_Word TypeDefn_77;
      MR_Word TypeParams_78;
      MR_Word KindMap_79;
      MR_Word TypeStatus_80;
      MR_Word TypeArgs_81;
      MR_Word Var_82;

      hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_14, &TypeTable_76);
      hlds__hlds_data__lookup_type_ctor_defn_3_p_0(TypeTable_76, TypeCtor_5, &TypeDefn_77);
      hlds__hlds_data__get_type_defn_tvarset_2_p_0(TypeDefn_77, &TVarSet_9);
      hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_77, &TypeParams_78);
      hlds__hlds_data__get_type_defn_kind_map_2_p_0(TypeDefn_77, &KindMap_79);
      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_77, &TypeBody_10);
      hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_77, &TypeStatus_80);
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_77, &Context_11);
      {
        Var_82 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&hlds__add_special_pred_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_82, 1) = ((MR_Box) (hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0_1));
        MR_hl_field(MR_mktag(0), Var_82, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_82, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14));
        MR_hl_field(MR_mktag(0), Var_82, 4) = ((MR_Box) (TypeCtor_5));
        MR_hl_field(MR_mktag(0), Var_82, 5) = ((MR_Box) (TypeBody_10));
        MR_hl_field(MR_mktag(0), Var_82, 6) = ((MR_Box) (TypeStatus_80));
      }
      mercury__require__expect_3_p_0(Var_82, (MR_String) "predicate \140hlds.add_special_pred.collect_type_defn\'/6", (MR_String) "not generated lazily");
      parse_tree__prog_type__var_list_to_type_list_3_p_0(KindMap_79, TypeParams_78, &TypeArgs_81);
      parse_tree__prog_type__construct_type_3_p_0(TypeCtor_5, TypeArgs_81, &Type_8);
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        STATE_VARIABLE_PredStatus_12_67 = (MR_Word) (((MR_Box) ((MR_Unsigned) 12U)));
      else
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_74, (MR_Integer) 0)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SpecDefnInfo_5, (MR_Integer) 0)));
...
{
  {
    ...
    hlds__hlds_clauses__clauses_info_init_4_p_0((MR_Integer) 0, Arity_22, Var_54, &ClausesInfo0_23);
    {
      ...
      MR_hl_field(MR_mktag(0), Origin_24, 0) = (MR_Box) ((MR_Unsigned) (SpecialPredId_9));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_19, (MR_Integer) 0)));
