...
hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__453__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__add_special_pred__IntroducedFrom__pred__add_lazily_generated_special_pred__453__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_14)
{
  ...
  check_hlds__post_typecheck__propagate_checked_types_into_pred_modes_7_p_0(STATE_VARIABLE_ModuleInfo_31_35, &ErrorProcs_31, &_InstForTypeSpecs_32, Var_36, &_Cache_33, PredInfo1_30, &PredInfo_34);
  {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  check_hlds__post_typecheck__propagate_checked_types_into_pred_modes_7_p_0(STATE_VARIABLE_ModuleInfo_31_78, &ErrorProcs_74, &_InstForTypeSpecs_75, Var_79, &_Cache_76, PredInfo1_73, &PredInfo_77);
  {
