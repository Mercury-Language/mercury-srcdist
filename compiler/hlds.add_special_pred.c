...
static /* final */ const MR_Box hlds__add_special_pred_scalar_common_2[2][3];
  ...
  MR_Word HeadVar__2_37)
{
  ...
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__add_special_pred_scalar_common_1[2]), ((MR_Box) (ErrorProcs_25)), ((MR_Box) (HeadVar__2_37)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  if (succeeded)
  {
    ...
    Var_39 = mercury__map__init_0_f_0((MR_Word) (&hlds__add_special_pred_scalar_common_1[3]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
    ...
    }
    {
      ...
      MR_hl_field(0, CtorRepn_31, 3) = ((MR_Box) (MR_mkword(3, &hlds__add_special_pred_scalar_common_1[7])));
    ...
    mercury__map__from_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__add_special_pred_scalar_common_1[4]), Var_43, &ConsCtorMap_32);
    {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  if (succeeded)
  {
    TypeInfo_13_54 = (MR_Word) (&hlds__add_special_pred_scalar_common_1[6]);
