...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__add_special_pred__make_tuple_args_and_repns_loop_5_p_0(Context_11, TupleArgTypes_30, (MR_Integer) 0, &CtorArgs_32, &CtorArgRepns_33);
      {
        ...
        MR_hl_field(MR_mktag(0), Ctor_35, 1) = ((MR_Box) (&hlds__add_special_pred_scalar_common_2[1]));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), CtorRepn_36, 1) = ((MR_Box) (&hlds__add_special_pred_scalar_common_2[1]));
