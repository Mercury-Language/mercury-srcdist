...
{
  {
    ...
    check_hlds__post_typecheck__propagate_types_into_pred_modes_5_p_0(STATE_VARIABLE_ModuleInfo_31_54, &ErrorProcs_50, &_InstForTypeSpecs_51, PredInfo1_49, &PredInfo_52);
    {
...
{
  {
    ...
    check_hlds__post_typecheck__propagate_types_into_pred_modes_5_p_0(STATE_VARIABLE_ModuleInfo_31_31, &ErrorProcs_25, &_InstForTypeSpecs_26, PredInfo1_24, &PredInfo_27);
    {
