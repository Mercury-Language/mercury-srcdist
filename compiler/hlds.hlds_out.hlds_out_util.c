  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    HeadVar__2_2 = parse_tree__parse_tree_out_sym_name__pf_sym_name_pred_form_arity_to_string_1_f_0(PredCallId_3);
  }
  return HeadVar__2_2;
}
  ...
  MR_Word PredMarkers_7)
{
  ...
  else
  {
    ...
    Var_19 = parse_tree__parse_tree_out_sym_name__pf_sym_name_pred_form_arity_to_string_1_f_0(PredCallId_72);
  }
  ...
  MR_Word Lang_5)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 210, &DumpOptions_7);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 204, &Ids_8);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 205, &Names_9);
