    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        switch (STATE_VARIABLE_First_0_1) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            STATE_VARIABLE_Pieces_11_38 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), STATE_VARIABLE_Pieces_0_4, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__hlds_out__hlds_out_util_scalar_common_1[14])));
            break;
          case (MR_Integer) 1:
            STATE_VARIABLE_Pieces_11_38 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), STATE_VARIABLE_Pieces_0_4, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__hlds_out__hlds_out_util_scalar_common_1[16])));
            break;
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__hlds_out__hlds_out_util_scalar_common_1[12])));
          MR_hl_field(MR_mktag(1), Var_43, 1) = ((MR_Box) (Var_46));
        }
        {
          Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__hlds_out__hlds_out_util_scalar_common_1[11])));
  ...
  MR_Word PredMarkers_7)
{
        ...
        case (MR_Integer) 2:
          {
            ...
            Var_77 = mercury__string__int_to_string_1_f_0(ArgNum_6);
            Var_15 = mercury__string__f_43_43_2_f_0((MR_String) "argument ", Var_77);
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Word Var_78 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GenericCallId_28, (MR_Integer) 0))) & (MR_Integer) 7);
  ...
  if (((MR_tag((MR_Word) CallId_5)) == (MR_Integer) 1))
  {
    MR_Word GenericCallId_80 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallId_5, (MR_Integer) 0))));

    Var_19 = hlds__hlds_out__hlds_out_util__generic_call_id_to_string_1_f_0(GenericCallId_80);
  }
  else
  {
    MR_Word PredCallId_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CallId_5, (MR_Integer) 0))));

    Var_19 = parse_tree__prog_out__pf_sym_name_orig_arity_to_string_1_f_0(PredCallId_79);
  }
