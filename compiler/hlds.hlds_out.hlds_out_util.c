...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 175, &DumpOptions_7);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 169, &Ids_8);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 170, &Names_9);
