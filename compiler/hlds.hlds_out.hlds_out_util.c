...
static void MR_CALL 
hlds__hlds_out__hlds_out_util__IntroducedFrom__pred__cons_id_and_vars_or_arity_to_string__693__1_3_p_0(
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_out__hlds_out_util__IntroducedFrom__pred__cons_id_and_vars_or_arity_to_string__693__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_53);
  ...
  MR_Word PredId_5)
{
  ...
  if (succeeded)
    Str_6 = hlds__pred_name__pred_info_id_to_string_1_f_0(PredInfo_8);
  else
  {
