...
MR_decl_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0, 3,5,7,6,11,12,13,4,19,18)
MR_decl_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0, 21,22,25,26,27,28,29,24,32,33)
MR_decl_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0, 34,35,36,31,38,40,42,44,47,48)
MR_decl_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0, 49,50,51,46,54,55,56,57,58,53)
MR_decl_label8(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0, 61,62,63,64,65,66,67,60)
...
MR_BEGIN_MODULE(hlds__hlds_out__hlds_out_util_module16)
	...
	MR_init_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,3,5,7,6,11,12,13,4,19,18)
	MR_init_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,21,22,25,26,27,28,29,24,32,33)
	MR_init_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,34,35,36,31,38,40,42,44,47,48)
	MR_init_label10(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,49,50,51,46,54,55,56,57,58,53)
	MR_init_label8(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,61,62,63,64,65,66,67,60)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,4)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0_i18);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,18)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0_i21);
	}
...
MR_def_label(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,24)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,11)) {
		MR_GOTO_LAB(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0_i31);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r2 = MR_tfield(3, MR_r1, 1);
...
MR_def_label(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0,46)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,9)) {
		MR_GOTO_LAB(fn__hlds__hlds_out__hlds_out_util__cons_id_and_arity_to_string_1_0_i53);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_r2 = MR_tfield(3, MR_r1, 1);
