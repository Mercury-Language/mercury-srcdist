...
static void MR_CALL 
hlds__hlds_out__hlds_out_util__IntroducedFrom__pred__cons_id_and_vars_or_arity_to_string__676__1_3_p_0(
...
static /* final */ const struct hlds__hlds_out__hlds_out_util__vector_common_type_5_0_s hlds__hlds_out__hlds_out_util_vector_common_5[25];
...
static /* final */ const struct hlds__hlds_out__hlds_out_util__vector_common_type_5_0_s hlds__hlds_out__hlds_out_util_vector_common_5[25] = {
  ...
  /* row  10 */   { (MR_String) "other_module(full_own_int)" },
  /* row  11 */   { (MR_String) "other_module(full_own_imp)" },
  /* row  12 */   { (MR_String) "other_module(full_int0_int)" },
  /* row  13 */   { (MR_String) "other_module(full_int0_imp)" },
  /* row  14 */   { (MR_String) "other_module(full_by_ancestor)" },
  /* row  15 */   { (MR_String) "other_module(full_opt)" },
  /* row  16 */   { (MR_String) "other_module(abstract)" },
  /* row  17 */   { (MR_String) "this_module(gen_none_sub_none)" },
  /* row  18 */   { (MR_String) "this_module(gen_none_sub_full)" },
  /* row  19 */   { (MR_String) "this_module(gen_abs_sub_full)" },
  /* row  20 */   { (MR_String) "this_module(gen_full_sub_full)" },
  /* row  21 */   { (MR_String) "this_module(gen_none_sub_none)" },
  /* row  22 */   { (MR_String) "this_module(gen_none_sub_abs)" },
  /* row  23 */   { (MR_String) "this_module(gen_abs_sub_abs)" },
  /* row  24 */   { (MR_String) "this_module(full_opt)" },
};
  ...
  MR_Word InstanceStatus_3)
{
  ...
  {
    MR_Word InstanceImport_5 = ((MR_Unsigned) ((MR_hl_field(1, InstanceStatus_3, 0))) & (MR_Integer) 1);

    switch (InstanceImport_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        HeadVar__2_2 = (MR_String) "other_module(abstract)";
        break;
      case (MR_Integer) 0:
        HeadVar__2_2 = (MR_String) "other_module(full_opt)";
        break;
    }
  }
  else
  {
    MR_Word InstanceExport_4 = ((MR_Unsigned) ((MR_hl_field(0, InstanceStatus_3, 0))) & (MR_Integer) 3);

    HeadVar__2_2 = ((&hlds__hlds_out__hlds_out_util_vector_common_5[21 + InstanceExport_4]))->hlds__hlds_out__hlds_out_util__vector_common_type_5_0__vct_5_f_0;
  }
  return HeadVar__2_2;
}
  ...
  MR_Word TypeClassStatus_3)
{
  ...
  {
    MR_Word TypeClassImport_5 = ((MR_Unsigned) ((MR_hl_field(1, TypeClassStatus_3, 0))) & (MR_Integer) 7);

    HeadVar__2_2 = ((&hlds__hlds_out__hlds_out_util_vector_common_5[10 + TypeClassImport_5]))->hlds__hlds_out__hlds_out_util__vector_common_type_5_0__vct_5_f_0;
  }
  else
  {
    MR_Word TypeClassExport_4 = ((MR_Unsigned) ((MR_hl_field(0, TypeClassStatus_3, 0))) & (MR_Integer) 3);

    HeadVar__2_2 = ((&hlds__hlds_out__hlds_out_util_vector_common_5[17 + TypeClassExport_4]))->hlds__hlds_out__hlds_out_util__vector_common_type_5_0__vct_5_f_0;
  }
  return HeadVar__2_2;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_out__hlds_out_util__IntroducedFrom__pred__cons_id_and_vars_or_arity_to_string__676__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_53);
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_58 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_24);
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_108 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_138);
              PredId_139 = ((MR_Word) ((MR_hl_field(0, Var_108, 0))));
              ProcId_43 = ((MR_Integer) ((MR_hl_field(0, Var_108, 1))));
              hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_43, &ProcIdInt_44);
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_116 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_140);
              PredId_141 = ((MR_Word) ((MR_hl_field(0, Var_116, 0))));
              ProcId_142 = ((MR_Integer) ((MR_hl_field(0, Var_116, 1))));
              hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_142, &ProcIdInt_143);
          ...
          case (MR_Integer) 3:
            {
              ...
              Var_124 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_144);
              PredId_145 = ((MR_Word) ((MR_hl_field(0, Var_124, 0))));
              ProcId_146 = ((MR_Integer) ((MR_hl_field(0, Var_124, 1))));
              hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_146, &ProcIdInt_147);
  ...
  MR_Integer ProcId_7)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_7, &ModeNum_9);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_6, &ModeNum_7);
  ...
  MR_Word PredId_5)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_7, ((MR_Box) (PredId_5)), &conv0_PredInfo_8);
  if (succeeded)
  {
  ...
  else
  {
    ...
    hlds__pred_proc_id__pred_id_to_int_2_p_0(PredId_5, &PredIdInt_10);
  ...
  MR_Word Lang_5)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 742, &DumpOptionsStr_7);
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 736, &Ids_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 737, &Names_10);
