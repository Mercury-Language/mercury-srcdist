      ...
      case (MR_Integer) 0:
        {
          ...
          Str_4 = parse_tree__prog_out__simple_call_id_to_string_3_f_0(PredOrFunc_8, SymName_98, Arity_7);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          case (MR_Integer) 3:
            {
              ...
              else
              {
                ...
                Str_4 = parse_tree__prog_out__simple_call_id_to_string_3_f_0(PredOrFunc_8, SymName_36, Arity_7);
              }
            }
            break;
          case (MR_Integer) 5:
            {
              ...
              TypeStr_43 = parse_tree__prog_out__sym_name_and_arity_to_string_1_f_0(Var_55);
          ...
          case (MR_Integer) 6:
            {
              ...
              BasePredIdStr_39 = parse_tree__prog_out__simple_call_id_to_string_1_f_0(BasePredId_37);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 178, &DumpOptions_7);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 172, &Ids_8);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 173, &Names_9);
