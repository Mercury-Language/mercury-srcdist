  ...
  MR_Integer Indent_4)
{
  while (MR_TRUE)
  {
    ...
    if (!(succeeded))
    {
      ...
      mercury__io__write_string_3_p_0((MR_String) "  ");
      Var_10 = (MR_Integer) ((MR_Unsigned) Indent_4 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            switch (ArgNum_11) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Integer Var_19 = (MR_Integer) ((MR_Unsigned) NumElementsBefore_7 + (MR_Unsigned) (MR_Integer) 1);
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                else
                {
                  MR_String Var_43;
                  MR_String Var_44;
                  MR_Integer Var_45 = (MR_Integer) ((MR_Unsigned) ArgNum_6 - (MR_Unsigned) (MR_Integer) 1);
                  MR_String Var_47;
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 169, &DumpOptions_7);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 163, &Ids_8);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 164, &Names_9);
