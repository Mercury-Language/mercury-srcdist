...
static /* final */ const struct hlds__hlds_out__hlds_out_util__vector_common_type_5_0_s hlds__hlds_out__hlds_out_util_vector_common_5[18];
...
static /* final */ const struct hlds__hlds_out__hlds_out_util__vector_common_type_5_0_s hlds__hlds_out__hlds_out_util_vector_common_5[18] = {
  ...
  /* row  10 */   { (MR_String) "this_module(gen_none_sub_none)" },
  /* row  11 */   { (MR_String) "this_module(gen_none_sub_full)" },
  /* row  12 */   { (MR_String) "this_module(gen_abs_sub_full)" },
  /* row  13 */   { (MR_String) "this_module(gen_full_sub_full)" },
  /* row  14 */   { (MR_String) "this_module(gen_none_sub_none)" },
  /* row  15 */   { (MR_String) "this_module(gen_none_sub_abs)" },
  /* row  16 */   { (MR_String) "this_module(gen_abs_sub_abs)" },
  /* row  17 */   { (MR_String) "this_module(full_opt)" },
};
  ...
  MR_Word InstanceStatus_3)
{
  ...
  else
  {
    ...
    HeadVar__2_2 = ((&hlds__hlds_out__hlds_out_util_vector_common_5[14 + InstanceExport_4]))->hlds__hlds_out__hlds_out_util__vector_common_type_5_0__vct_5_f_0;
  }
  return HeadVar__2_2;
}
  ...
  MR_Word TypeClassStatus_3)
{
  ...
  {
    MR_Word TypeClassImport_5 = ((MR_Word) ((MR_hl_field(1, TypeClassStatus_3, 0))));

    switch (MR_tag((MR_Word) TypeClassImport_5)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        switch (MR_unmkbody(TypeClassImport_5)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            HeadVar__2_2 = (MR_String) "other_module(full_opt)";
            break;
        ...
        break;
      case (MR_Integer) 1:
        HeadVar__2_2 = (MR_String) "other_module(full_self_or_anc)";
        break;
      case (MR_Integer) 2:
        HeadVar__2_2 = (MR_String) "other_module(full_int0)";
        break;
    }
  }
  else
  {
    ...
    HeadVar__2_2 = ((&hlds__hlds_out__hlds_out_util_vector_common_5[10 + TypeClassExport_4]))->hlds__hlds_out__hlds_out_util__vector_common_type_5_0__vct_5_f_0;
  }
  return HeadVar__2_2;
}
