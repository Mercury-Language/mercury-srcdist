...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 191, &DumpOptions_7);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 185, &Ids_8);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_4, (MR_Integer) 186, &Names_9);
