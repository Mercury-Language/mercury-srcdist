...
{
  {
    ...
    if ((STATE_VARIABLE_Regions_0_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word NewRegion_8;
    ...
    else
    {
      ...
      MR_Integer Var_25 = (MR_Integer) ((MR_Unsigned) LowerNum0_11 - (MR_Unsigned) (MR_Integer) 1);

      succeeded = (ItemNum_5 < Var_25);
      if (succeeded)
      {
        MR_Word NewRegion_47;

        {
          NewRegion_47 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), NewRegion_47, 0) = ((MR_Box) (ItemNum_5));
          MR_hl_field(MR_mktag(0), NewRegion_47, 1) = ((MR_Box) (ItemNum_5));
          MR_hl_field(MR_mktag(0), NewRegion_47, 2) = ((MR_Box) (Context_6));
          MR_hl_field(MR_mktag(0), NewRegion_47, 3) = ((MR_Box) (Context_6));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_Regions_24 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NewRegion_47));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Regions_0_23));
        }
      }
      else
      {
        MR_Integer Var_31 = (MR_Integer) ((MR_Unsigned) LowerNum0_11 - (MR_Unsigned) ItemNum_5);
        ...
        else
        {
          ...
          {
            MR_Integer Var_35 = (MR_Integer) ((MR_Unsigned) ItemNum_5 - (MR_Unsigned) UpperNum0_12);

            succeeded = (Var_35 == (MR_Integer) 1);
            if (succeeded)
            {
              MR_Word FirstRegion_48;

              {
                FirstRegion_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), FirstRegion_48, 0) = ((MR_Box) (LowerNum0_11));
                MR_hl_field(MR_mktag(0), FirstRegion_48, 1) = ((MR_Box) (ItemNum_5));
                MR_hl_field(MR_mktag(0), FirstRegion_48, 2) = ((MR_Box) (LowerContext0_13));
                MR_hl_field(MR_mktag(0), FirstRegion_48, 3) = ((MR_Box) (Context_6));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *STATE_VARIABLE_Regions_24 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (FirstRegion_48));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (LaterRegions0_10));
              }
            }
            else
            {
              ...
              if ((LaterRegions1_16 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                {
                  mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.hlds_clauses.add_clause_item_number_regions\'/4", (MR_String) "insertion yields empty list");
                  return;
                }
              }
              else
              {
                ...
                MR_Integer Var_37 = (MR_Integer) ((MR_Unsigned) LowerNum1_19 - (MR_Unsigned) UpperNum0_12);

                succeeded = (Var_37 == (MR_Integer) 1);
                if (succeeded)
                {
                  MR_Word FirstRegion_49;

                  {
                    FirstRegion_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), FirstRegion_49, 0) = ((MR_Box) (LowerNum0_11));
                    MR_hl_field(MR_mktag(0), FirstRegion_49, 1) = ((MR_Box) (UpperNum1_20));
                    MR_hl_field(MR_mktag(0), FirstRegion_49, 2) = ((MR_Box) (LowerContext0_13));
                    MR_hl_field(MR_mktag(0), FirstRegion_49, 3) = ((MR_Box) (UpperContext1_22));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    *STATE_VARIABLE_Regions_24 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (FirstRegion_49));
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ClauseItemNumbers_6)) == (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((MR_tag((MR_Word) BothRegions_12)) == (MR_Integer) 1);
            if (succeeded)
            {
        ...
        case (MR_Integer) 0:
          {
            ...
            succeeded = ((MR_tag((MR_Word) MercuryRegions_11)) == (MR_Integer) 1);
            if (succeeded)
            {
...
{
  {
    ...
    *ItemNumbers_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_10, (MR_Integer) 6))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_10, (MR_Integer) 8)));
    ...
    *Clauses_5 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), ClausesCord0_45);
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_10, (MR_Integer) 8)));
    {
      MR_Word base;
      ...
      *STATE_VARIABLE_CI_11 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (packed_args_1);
    }
  }
}
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 8)));
...
{
  {
    ...
    MR_Integer NumClauses_8 = (MR_Integer) ((MR_Unsigned) NumClauses0_6 + (MR_Unsigned) (MR_Integer) 1);
    MR_Word ClausesCord_9;
...
{
  {
    ...
    MR_Word Var_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_6, (MR_Integer) 8))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_6, (MR_Integer) 8)));

    {
      ...
      *STATE_VARIABLE_CI_7 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) (Var_17) << (MR_Integer) 1)) | (MR_Unsigned) (X_4)));
    }
  }
}
...
{
  {
...

    {
      ...
      *STATE_VARIABLE_CI_7 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_15));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_16));
      MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) (X_4) << (MR_Integer) 1)) | (MR_Unsigned) (Var_18)));
    }
  }
}
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_8, (MR_Integer) 8)));
...
{
  {
    ...
    *HeadVar__2_2 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 8))) >> (MR_Integer) 1)) & (MR_Integer) 1);
  }
}
...
{
  {
    ...
    *HeadVar__2_2 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 7))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 8)));
  }
}
...
{
  {
    ...
    *HeadVar__3_3 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CI_4, (MR_Integer) 6))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_4, (MR_Integer) 8)));
  }
}
