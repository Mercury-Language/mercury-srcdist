    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &hlds__hlds_clauses_scalar_common_2[1], &Var_26, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &hlds__hlds_clauses_scalar_common_2[1], &Var_27, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_27_27 = (MR_Word) &hlds__hlds_clauses_scalar_common_2[1];
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_27_27, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
          if (succeeded)
          {
            TypeInfo_28_28 = (MR_Word) &hlds__hlds_clauses_scalar_common_2[1];
