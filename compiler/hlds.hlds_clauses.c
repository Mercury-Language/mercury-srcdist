...
MR_def_label(hlds__hlds_clauses__clauses_info_init_4_0,10)
	...
	MR_tfield(0, MR_r1, 6) = MR_sv(3);
	MR_tfield(0, MR_r1, 7) = MR_sv(6);
...
MR_define_entry(mercury__hlds__hlds_clauses__add_clause_3_0);
	...
	MR_tfield(1, MR_tempr1, 1) = MR_mask_field(MR_r2, 1);
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = ((MR_Integer) MR_mask_field(MR_r2, 0) + (MR_Integer) 1);
	MR_tfield(0, MR_r1, 1) = MR_tempr1;
	MR_proceed();
	}
