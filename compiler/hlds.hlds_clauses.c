...
MR_decl_label4(__Unify___hlds__hlds_clauses__clause_0_0, 2,4,6,1)
MR_decl_label8(__Unify___hlds__hlds_clauses__clauses_info_0_0, 2,4,6,8,10,12,14,1)
MR_decl_label5(__Unify___hlds__hlds_clauses__clauses_rep_0_0, 62,10,4,63,1)
MR_decl_label4(__Compare___hlds__hlds_clauses__clause_0_0, 3,7,11,17)
MR_decl_label8(__Compare___hlds__hlds_clauses__clauses_info_0_0, 3,7,11,15,19,23,27,37)
MR_decl_label8(__Compare___hlds__hlds_clauses__clauses_rep_0_0, 36,15,96,21,25,4,51,14)
MR_decl_label3(__Compare___hlds__hlds_clauses__clauses_rep_0_0, 98,9,94)
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module25)
	...
	MR_init_label4(__Unify___hlds__hlds_clauses__clause_0_0,2,4,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__hlds_clauses__clause_0_0);
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___hlds__hlds_clauses__clause_0_0_i2);
MR_def_label(__Unify___hlds__hlds_clauses__clause_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module26)
	...
	MR_init_label4(__Compare___hlds__hlds_clauses__clause_0_0,3,7,11,17)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___hlds__hlds_clauses__clause_0_0);
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___hlds__hlds_clauses__clause_0_0_i3);
MR_def_label(__Compare___hlds__hlds_clauses__clause_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clause_0_0_i17);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(__Compare___hlds__hlds_goal__hlds_goal_0_0,
		__Compare___hlds__hlds_clauses__clause_0_0_i7);
MR_def_label(__Compare___hlds__hlds_clauses__clause_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clause_0_0_i17);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__implementation_language_0_0,
		__Compare___hlds__hlds_clauses__clause_0_0_i11);
MR_def_label(__Compare___hlds__hlds_clauses__clause_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clause_0_0_i17);
	}
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module27)
	...
	MR_init_label8(__Unify___hlds__hlds_clauses__clauses_info_0_0,2,4,6,8,10,12,14,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__hlds_clauses__clauses_info_0_0);
	...
	MR_np_call_localret_ent(__Unify___varset__varset_1_0,
		__Unify___hlds__hlds_clauses__clauses_info_0_0_i2);
MR_def_label(__Unify___hlds__hlds_clauses__clauses_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module28)
	...
	MR_init_label8(__Compare___hlds__hlds_clauses__clauses_info_0_0,3,7,11,15,19,23,27,37)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___hlds__hlds_clauses__clauses_info_0_0);
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i3);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i7);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
	...
	MR_r4 = MR_sv(9);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i11);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,15)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_args__proc_arg_vector_1_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i19);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_clauses__clauses_rep_0_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i23);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_rtti__rtti_varmaps_0_0,
		__Compare___hlds__hlds_clauses__clauses_info_0_0_i27);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i37);
	}
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module29)
	...
	MR_init_label5(__Unify___hlds__hlds_clauses__clauses_rep_0_0,62,10,4,63,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__hlds_clauses__clauses_rep_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Unify___hlds__hlds_clauses__clauses_rep_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Unify___hlds__hlds_clauses__clauses_rep_0_0_i62);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Unify___hlds__hlds_clauses__clauses_rep_0_0_i63);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
...
MR_def_label(__Unify___hlds__hlds_clauses__clauses_rep_0_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_sv(2) = MR_ctfield(2, MR_tempr3, 2);
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___hlds__hlds_clauses__clauses_rep_0_0_i10);
MR_def_label(__Unify___hlds__hlds_clauses__clauses_rep_0_0,10)
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(__Unify___list__list_1_0);
MR_def_label(__Unify___hlds__hlds_clauses__clauses_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___hlds__hlds_clauses__clauses_rep_0_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module30)
	...
	MR_init_label8(__Compare___hlds__hlds_clauses__clauses_rep_0_0,36,15,96,21,25,4,51,14)
	MR_init_label3(__Compare___hlds__hlds_clauses__clauses_rep_0_0,98,9,94)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___hlds__hlds_clauses__clauses_rep_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i15);
	}
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i14);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___hlds__hlds_clauses__clauses_rep_0_0_i36);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i94);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_clauses, clause);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i51);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i96);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___hlds__hlds_clauses__clauses_rep_0_0_i21);
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,25)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i98);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_rep_0_0_i14);
	}
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,98)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_rep_0_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
