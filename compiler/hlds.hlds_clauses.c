...
static const MR_Integer hlds__hlds_clauses__hlds__hlds_clauses__functor_number_map_clause_init_types_0[1];

static const MR_NotagFunctorDesc hlds__hlds_clauses__hlds__hlds_clauses__notag_functor_desc_clause_init_types_0;
...
const MR_TypeCtorInfo_Struct hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_init_types_0 = {
  ...
  { &hlds__hlds_clauses__hlds__hlds_clauses__notag_functor_desc_clause_init_types_0 },
  { &hlds__hlds_clauses__hlds__hlds_clauses__notag_functor_desc_clause_init_types_0 },
  (MR_Integer) 1,
  UINT16_C(4),
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              MR_Integer Var_55 = (MR_Integer) ((MR_Unsigned) LowerNum1_49 - (MR_Unsigned) ItemNum_5);
          ...
          else
          {
            ...
            else
            {
              ...
              MR_Integer Var_72 = (MR_Integer) ((MR_Unsigned) LowerNum1_66 - (MR_Unsigned) UpperNum0_63);
  ...
  MR_Word * ClausesInfo_8)
{
  ...
  MR_Word VarSet_14;
  MR_Word VarTypes_15;
  MR_Word TVarNameMap_16;
  MR_Word HeadVarVec_17;
  ...
  parse_tree__vartypes__init_vartypes_1_p_0(&VarTypes_15);
  PredFormArity_11 = (MR_Word) (InitTypes_6);
  PredFormArityInt_12 = (MR_Integer) (PredFormArity_11);
  ...
  mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__hlds_clauses_scalar_common_1[0]), &TVarNameMap_16);
  HeadVarVec_17 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[1]), PredOrFunc_5, HeadVars_13);
  Var_31 = mercury__list__length_1_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) ((MR_Unsigned) 0U));
  Var_32 = mercury__cord__from_list_1_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) ((MR_Unsigned) 0U));
  {
    ClausesRep_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ClausesRep_18, 0) = ((MR_Box) (Var_31));
    MR_hl_field(MR_mktag(0), ClausesRep_18, 1) = ((MR_Box) (Var_32));
  }
  hlds__hlds_rtti__rtti_varmaps_init_1_p_0(&RttiVarMaps_19);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
    *ClausesInfo_8 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (VarSet_14));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (TVarNameMap_16));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (VarTypes_15));
    MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (VarTypes_15));
    MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (HeadVarVec_17));
    MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (ClausesRep_18));
    MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (ItemNumbers_7));
    MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (RttiVarMaps_19));
    MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
  }
}
