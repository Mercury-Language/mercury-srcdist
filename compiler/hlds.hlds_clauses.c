...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          NewRegion_47 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                FirstRegion_48 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    FirstRegion_49 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    *ItemNumbers_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_10, (MR_Integer) 6))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_CI_0_10, (MR_Integer) 8)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 8)));
...
{
  {
    ...
    *HeadVar__2_2 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 7))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_3, (MR_Integer) 8)));
  }
}
...
{
  {
    ...
    *HeadVar__3_3 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CI_4, (MR_Integer) 6))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CI_4, (MR_Integer) 8)));
  }
}
