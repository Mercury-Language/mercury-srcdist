...
static void MR_CALL 
hlds__hlds_clauses__IntroducedFrom__pred__clauses_info_init__496__1_8_p_0(
...
static const MR_PseudoTypeInfo hlds__hlds_clauses__hlds__hlds_clauses__field_types_clause_0_0[7] = {
  ...
  (MR_PseudoTypeInfo) (&hlds__pred_info_types__hlds__pred_info_types__type_ctor_info_implementation_language_0),
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__pred_info_types____Compare____implementation_language_0_0(&SubResult3_12, ArgX3_10, ArgY3_11);
        succeeded = (SubResult3_12 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult3_12;
        else
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = hlds__pred_info_types____Unify____implementation_language_0_0(ArgX3_7, ArgY3_8);
        if (succeeded)
        {
          succeeded = mercury__term_context____Unify____term_context_0_0(ArgX4_9, ArgY4_10);
          if (succeeded)
          {
            TypeInfo_22_22 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[3]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_22_22, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo_23_23 = (MR_Word) (&hlds__hlds_clauses_scalar_common_2[0]);
  ...
  MR_Box * wrapper_arg_8)
{
  ...
  hlds__hlds_clauses__IntroducedFrom__pred__clauses_info_init__496__1_8_p_0(((MR_Word) (wrapper_arg_1)), &conv3_LambdaHeadVar__2_35, ((MR_Integer) (wrapper_arg_3)), &conv2_LambdaHeadVar__4_37, ((MR_Word) (wrapper_arg_5)), &conv1_LambdaHeadVar__6_39, ((MR_Word) (wrapper_arg_7)), &conv0_LambdaHeadVar__8_41);
