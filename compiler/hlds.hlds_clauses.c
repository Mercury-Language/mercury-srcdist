        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              MR_Integer Var_52 = (MR_Integer) ((MR_Unsigned) LowerNum1_47 - (MR_Unsigned) ItemNum_5);
          ...
          else
          {
            ...
            else
            {
              ...
              MR_Integer Var_69 = (MR_Integer) ((MR_Unsigned) LowerNum1_64 - (MR_Unsigned) UpperNum0_61);
  ...
  MR_Word * ClausesInfo_8)
{
  ...
  Var_29 = mercury__list__length_1_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) ((MR_Unsigned) 0U));
  Var_30 = mercury__cord__from_list_1_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) ((MR_Unsigned) 0U));
  {
    ClausesRep_16 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ClausesRep_16, 0) = ((MR_Box) (Var_29));
    MR_hl_field(MR_mktag(0), ClausesRep_16, 1) = ((MR_Box) (Var_30));
  }
