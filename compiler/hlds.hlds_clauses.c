      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[7]), HeadVar__1_1, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
            }
          }
        }
      }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_18_18 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[7]);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[6]), HeadVar__1_1, ((MR_Box) (Var_15)), ((MR_Box) (ArgY1_7)));
                }
                break;
            }
          }
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_13_13 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[6]);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[3]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[4]), &SubResult5_18, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[5]), &SubResult1_6, ((MR_Box) (Var_18)), ((MR_Box) (ArgY1_5)));
        succeeded = (SubResult1_6 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult1_6;
        else
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY2_8)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[3]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_29_29 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[4]);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_11_11 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[5]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_11_11, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
        if (succeeded)
        {
          TypeInfo_12_12 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[5]);
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_clauses_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_9_9 = (MR_Word) (&hlds__hlds_clauses_scalar_common_1[2]);
...
{
  {
    ...
    else
    {
      ...
      MR_Integer Var_20 = (MR_Integer) ((MR_Unsigned) LowerNum0_11 - (MR_Unsigned) (MR_Integer) 1);
