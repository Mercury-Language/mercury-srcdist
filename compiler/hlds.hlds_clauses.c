...
MR_decl_label3(hlds__hlds_clauses__add_clause_3_0, 12,3,7)
...
MR_decl_label7(__Compare___hlds__hlds_clauses__clause_0_0, 3,2,5,9,13,17,45)
...
MR_decl_label1(__Compare___hlds__hlds_clauses__clauses_info_0_0, 108)
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module7)
	...
	MR_init_label3(hlds__hlds_clauses__add_clause_3_0,12,3,7)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_clauses__add_clause_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__hlds_clauses__add_clause_3_0,3)
	...
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(hlds__hlds_clauses__add_clause_3_0_i12);
	}
	MR_incr_sp(3);
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module30)
	...
	MR_init_label7(__Compare___hlds__hlds_clauses__clause_0_0,3,2,5,9,13,17,45)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__hlds_clauses__clause_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clause_0_0_i45);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
...
MR_def_label(__Compare___hlds__hlds_clauses__clause_0_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__hlds_clauses_module42)
	...
	MR_init_label1(__Compare___hlds__hlds_clauses__clauses_info_0_0,108)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__hlds_clauses__clauses_info_0_0_i108);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,37)
	...
	MR_decr_sp(17);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___hlds__hlds_clauses__clauses_info_0_0,108)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(17);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
