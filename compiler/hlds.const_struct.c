      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 288, &HighLevelData_6);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 376, &PolyEnabled_8);
