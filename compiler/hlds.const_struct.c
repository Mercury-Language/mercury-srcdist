...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_33, Var_34);
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_35, Var_36);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 278, &HighLevelData_6);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 365, &PolyEnabled_8);
