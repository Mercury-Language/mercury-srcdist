          ...
          else
          {
            ...
            if ((MaybeOldConstNum_45 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              ...
              *ConstNum_6 = NextConstNum_44;
              ...
              Var_33 = (NextConstNum_44 + (MR_Integer) 1);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 267, &HighLevelData_6);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 354, &PolyEnabled_8);
