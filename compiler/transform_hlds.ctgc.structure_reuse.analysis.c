  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 500, &IntermodAnalysis_7);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 513, &Repeats_18);
