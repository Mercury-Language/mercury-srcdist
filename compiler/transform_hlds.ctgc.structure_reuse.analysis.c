...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 355, &IntermodAnalysis_10);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 439, &Repeats_20);
