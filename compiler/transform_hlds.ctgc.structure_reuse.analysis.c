      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ConditionsTerm_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_22, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__term_conversion__type_to_term_2_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_2[8]), (MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ((MR_Box) (Conditions_5)), &ConditionsTerm_8);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (ConditionsTerm_8));
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_16, ProcInfo_17, &VarTable_19);
        parse_tree__var_table__lookup_var_types_3_p_0(VarTable_19, HeadVars_18, &HeadVarTypes_20);
        ImpHeadVars_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 0))));
        ImpTypes_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 1))));
        ImpReuseConditions_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (ImpReuseConditions_33));
          }
        ...
        ImpHeadVars_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 0))));
        ImpTypes_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 1))));
        ImpReuseConditions_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (ImpReuseConditions_47));
          }
  ...
  MR_Word Answer2_6)
{
  ...
  if (((MR_tag((MR_Word) Answer1_5)) == (MR_Integer) 1))
    ...
    if (((MR_tag((MR_Word) Answer2_6)) == (MR_Integer) 1))
    {
      ...
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_16, ProcInfo_17, &VarTable_19);
      parse_tree__var_table__lookup_var_types_3_p_0(VarTable_19, HeadVars_18, &HeadVarTypes_20);
      ImpHeadVars_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 0))));
      ImpTypes_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 1))));
      ImpReuseConditions_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer1_5, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (ImpReuseConditions_30));
        }
        parse_tree__prog_ctgc__rename_structure_reuse_domain_4_p_0(VarRenaming_32, TypeSubst_33, Var_36, &Reuse1_21);
      }
      else
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.ctgc.structure_reuse.analysis.structure_reuse_answer_to_domain\'/4", (MR_String) "type_unify_list failed");
      ImpHeadVars_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 0))));
      ImpTypes_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 1))));
      ImpReuseConditions_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer2_6, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (ImpReuseConditions_44));
        }
  ...
  MR_Word * STATE_VARIABLE_AnalysisInfo_16)
{
  ...
  PredId_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RecordPPId_13, (MR_Integer) 0))));
  ProcId_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), RecordPPId_13, (MR_Integer) 1))));
  ReuseAs_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReuseAs_Status_10, (MR_Integer) 0))));
  Status_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReuseAs_Status_10, (MR_Integer) 1))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) Reuse_31)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Conditions_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Reuse_31, (MR_Integer) 0))));
              MR_Word ProcInfo_33;
              MR_Word HeadVars_34;
              MR_Word VarTable_35;
              ...
              hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_33, &VarTable_35);
              parse_tree__var_table__lookup_var_types_3_p_0(VarTable_35, HeadVars_34, &HeadVarTypes_36);
              {
                Answer_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Answer_25, 0) = ((MR_Box) (HeadVars_34));
                MR_hl_field(MR_mktag(1), Answer_25, 1) = ((MR_Box) (HeadVarTypes_36));
                MR_hl_field(MR_mktag(1), Answer_25, 2) = ((MR_Box) (Conditions_32));
              }
            }
            break;
        }
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_7)
{
  ...
  transform_hlds__ctgc__structure_reuse__lfu__forward_use_information_3_p_0(ModuleInfo_4, STATE_VARIABLE_ProcInfo_0_6, &STATE_VARIABLE_ProcInfo_8_8);
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_29)
{
  ...
  switch (MR_tag((MR_Word) Answer_16)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ImpHeadVars_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer_16, (MR_Integer) 0))));
        MR_Word ImpTypes_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer_16, (MR_Integer) 1))));
        MR_Word ImpReuseConditions_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Answer_16, (MR_Integer) 2))));
        MR_Word HeadVars_36;
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (ImpReuseConditions_35));
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, ProcInfo_56, &VarTable_58);
          parse_tree__var_table__lookup_var_types_3_p_0(VarTable_58, HeadVars_57, &HeadVarTypes_59);
          {
            ...
            MR_hl_field(MR_mktag(1), NewAnswer_21, 1) = ((MR_Box) (HeadVarTypes_59));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 499, &IntermodAnalysis_7);
  switch (IntermodAnalysis_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        transform_hlds__ctgc__structure_reuse__analysis__process_imported_reuse_2_p_0(STATE_VARIABLE_ModuleInfo_0_29, &STATE_VARIABLE_ModuleInfo_33_33);
        STATE_VARIABLE_ReuseTable_35_35 = transform_hlds__ctgc__structure_reuse__domain__load_structure_reuse_table_1_f_0(STATE_VARIABLE_ModuleInfo_33_33);
        ExternalRequests_9 = (MR_Word) ((MR_Unsigned) 0U);
        MustHaveReuseVersions_10 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
    case (MR_Integer) 1:
      transform_hlds__ctgc__structure_reuse__analysis__process_intermod_analysis_reuse_5_p_0(STATE_VARIABLE_ModuleInfo_0_29, &STATE_VARIABLE_ModuleInfo_33_33, &STATE_VARIABLE_ReuseTable_35_35, &ExternalRequests_9, &MustHaveReuseVersions_10);
      break;
  }
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_33_33, &DebugStream_102);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_102, VeryVerbose_5, (MR_String) "% Annotating in use information...");
  hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_5[3]), STATE_VARIABLE_ModuleInfo_33_33, &STATE_VARIABLE_ModuleInfo_41_41);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 512, &Repeats_18);
  ...
  switch (IntermodAnalysis_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      transform_hlds__ctgc__structure_reuse__analysis__maybe_create_forwarding_procedures_intermod_opt_4_p_0(STATE_VARIABLE_ReuseTable_35_35, ReuseTable_11, STATE_VARIABLE_ModuleInfo_82_82, &STATE_VARIABLE_ModuleInfo_83_83);
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_84;
        MR_Box conv7_STATE_VARIABLE_ModuleInfo_83_83;

        {
          Var_84 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_9[0]));
          MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_3));
          MR_hl_field(MR_mktag(0), Var_84, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_84, 3) = ((MR_Box) (ReuseTable_11));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_84, MustHaveReuseVersions_10, ((MR_Box) (STATE_VARIABLE_ModuleInfo_82_82)), &conv7_STATE_VARIABLE_ModuleInfo_83_83);
        STATE_VARIABLE_ModuleInfo_83_83 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_83_83));
      }
      break;
  }
