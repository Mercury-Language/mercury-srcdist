...
{
  {
    ...
    hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_8[0]), STATE_VARIABLE_ModuleInfo_33_33, &STATE_VARIABLE_ModuleInfo_39_39);
