          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_46, &VarTable_48);
              parse_tree__var_table__lookup_var_types_3_p_0(VarTable_48, HeadVars_47, &HeadVarTypes_49);
              {
