...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 61, &VeryVerbose_8);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 348, &IntermodAnalysis_10);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 432, &Repeats_20);
    ...
    hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_97_97, &PredTable0_29);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_98, 2) = ((MR_Box) ((MR_Integer) 3));
