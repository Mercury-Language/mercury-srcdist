  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 532, &IntermodAnalysis_9);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 545, &Repeats_19);
  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_28)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 82, &VeryVerbose_31);
