  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 435, &IntermodAnalysis_9);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 370, &Repeats_19);
