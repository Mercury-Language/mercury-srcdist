...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 494, &IntermodAnalysis_7);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 507, &Repeats_18);
