...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &transform_hlds__ctgc__structure_reuse__analysis_scalar_common_1[2], Var_22, ProcIds_20, ((MR_Box) (STATE_VARIABLE_ProcTable_8_21)), &conv2_STATE_VARIABLE_ProcTable_10_23);
