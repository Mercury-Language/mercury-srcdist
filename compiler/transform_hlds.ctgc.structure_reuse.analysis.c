          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_34, &VarTable_36);
              parse_tree__var_table__lookup_var_types_3_p_0(VarTable_36, HeadVars_35, &HeadVarTypes_37);
              {
                ...
                MR_hl_field(MR_mktag(1), Answer_26, 1) = ((MR_Box) (HeadVarTypes_37));
