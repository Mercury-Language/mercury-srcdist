...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 341, &IntermodAnalysis_10);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 425, &Repeats_20);
