...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 495, &IntermodAnalysis_7);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 508, &Repeats_18);
