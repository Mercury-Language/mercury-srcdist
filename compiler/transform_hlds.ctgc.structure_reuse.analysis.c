  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__vartypes__lookup_var_types_3_p_0(VarTypes_20, HeadVars_18, &HeadVarTypes_21);
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__vartypes__lookup_var_types_3_p_0(VarTypes_49, HeadVars_47, &HeadVarTypes_50);
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__vartypes__lookup_var_types_3_p_0(VarTypes_67, HeadVars_65, &HeadVarTypes_68);
          {
