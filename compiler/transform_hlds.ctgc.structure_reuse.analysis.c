  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 505, &IntermodAnalysis_9);
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 518, &Repeats_19);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_87 = ((MR_Word) ((MR_hl_field(2, Var_86, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_28)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 73, &VeryVerbose_31);
