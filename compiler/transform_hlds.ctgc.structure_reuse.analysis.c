...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 487, &IntermodAnalysis_7);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 500, &Repeats_17);
