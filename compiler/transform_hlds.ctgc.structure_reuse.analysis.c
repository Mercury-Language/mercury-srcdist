  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_16)
{
  ...
  hlds__hlds_proc__proc_info_set_structure_reuse_3_p_0(Domain_Status_11, ProcInfo0_13, &ProcInfo_14);
  ...
  MR_Word * STATE_VARIABLE_ProcTable_19)
{
  ...
  conv0_STATE_VARIABLE_ProcInfo_1_20 = mercury__map__det_elem_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_6)), STATE_VARIABLE_ProcTable_0_18);
  STATE_VARIABLE_ProcInfo_1_20 = ((MR_Word) (conv0_STATE_VARIABLE_ProcInfo_1_20));
  succeeded = hlds__hlds_proc__proc_info_get_imported_structure_reuse_4_p_0(STATE_VARIABLE_ProcInfo_1_20, &ImpHeadVars_9, &ImpTypes_10, &ImpReuse_11);
  if (succeeded)
  {
    MR_Word HeadVars_12;
    ...
    hlds__hlds_proc__proc_info_set_structure_reuse_3_p_0(Var_24, STATE_VARIABLE_ProcInfo_1_20, &STATE_VARIABLE_ProcInfo_2_25);
    hlds__hlds_proc__proc_info_reset_imported_structure_reuse_2_p_0(STATE_VARIABLE_ProcInfo_2_25, &STATE_VARIABLE_ProcInfo_3_27);
