...
static void MR_CALL 
transform_hlds__ctgc__structure_reuse__analysis__handle_structure_reuse_requests_11_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
transform_hlds__ctgc__structure_reuse__analysis__handle_structure_reuse_requests_11_p_0(
  ...
  MR_Word STATE_VARIABLE_DepProcs_0_23,
  MR_Word * STATE_VARIABLE_DepProcs_24,
  MR_Word STATE_VARIABLE_IntermodRequests_0_25,
...
static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__analysis_scalar_common_1[10][3] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__handle_structure_reuse_requests_11_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   5 */
  {
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_32, HeadVarTypes_20, Var_37, Var_38, &TypeSubst_36);
        if (succeeded)
        {
          MR_Word Var_39;
        ...
        succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_46, HeadVarTypes_20, Var_51, Var_52, &TypeSubst_50);
        if (succeeded)
        {
          MR_Word Var_53;
  ...
  MR_Word Answer2_6)
{
  ...
  if (((MR_tag((MR_Word) Answer1_5)) == (MR_Integer) 1))
    ...
    if (((MR_tag((MR_Word) Answer2_6)) == (MR_Integer) 1))
    {
      ...
      succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_29, HeadVarTypes_20, (MR_Word) ((MR_Unsigned) 0U), Var_35, &TypeSubst_33);
      if (succeeded)
      {
        MR_Word Var_36;
      ...
      succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_43, HeadVarTypes_20, (MR_Word) ((MR_Unsigned) 0U), Var_49, &TypeSubst_47);
      if (succeeded)
      {
        MR_Word Var_50;
  ...
  MR_Word * STATE_VARIABLE_PredTable_23)
{
  ...
  ReuseAs_15 = ((MR_Word) ((MR_hl_field(0, ReuseAs_Status_14, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          PPIdStr_19 = hlds__hlds_out__hlds_out_util__pred_proc_id_to_dev_string_2_f_0(ModuleInfo_8, PPId_12);
    ...
    PredId_20 = ((MR_Word) ((MR_hl_field(0, PPId_12, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_34, HeadVarTypes_19, (MR_Word) ((MR_Unsigned) 0U), Var_40, &TypeSubst_38);
        if (succeeded)
        {
          MR_Word Var_41;
  ...
  MR_Word * STATE_VARIABLE_ReuseTable_22)
{
  ...
  analysis__lookup_results_4_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_4[0]), AnalysisInfo_14, ModuleName_15, FuncId_16, &ImportedResults_18);
  {
    ...
    MR_hl_field(0, Var_23, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_11[0]));
  ...
  MR_Word * STATE_VARIABLE_MustHaveReuseVersions_26)
{
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(0, Var_28, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_10[1]));
  ...
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(0, Var_32, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_10[2]));
  ...
  MR_Word * Harsher_8)
{
  ...
  hlds__hlds_module__module_info_proc_info_3_p_0(ModuleInfo_5, OrigPPId_10, &ProcInfo_14);
  {
    ...
    MR_hl_field(0, FuncInfo_15, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(0, FuncInfo_15, 1) = ((MR_Box) (ProcInfo_14));
  }
  ...
  if (succeeded)
  {
    Var_25 = ((MR_Word) ((MR_hl_field(1, MaybeOldResult_17, (MR_Integer) 0))));
    OldCall_18 = ((MR_Word) ((MR_hl_field(0, Var_25, (MR_Integer) 0))));
    OldAnswer_19 = ((MR_Word) ((MR_hl_field(0, Var_25, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    succeeded = transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_search_3_p_0(ReuseTable_6, ReusePPId_7, &ReuseAs_Status_49);
    if (succeeded)
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_module__module_info_proc_info_3_p_0(ModuleInfo_5, ReusePPId_7, &ProcInfo_56);
          ...
          {
            NewAnswer_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, NewAnswer_21, 0) = ((MR_Box) (HeadVars_57));
            MR_hl_field(1, NewAnswer_21, 1) = ((MR_Box) (HeadVarTypes_59));
            MR_hl_field(1, NewAnswer_21, 2) = ((MR_Box) (Conditions_55));
          }
        }
        break;
    }
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__ctgc__structure_reuse__analysis__remove_useless_reuse_proc_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv16_STATE_VARIABLE_PredTable_23);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_31)
{
  ...
  MR_Word STATE_VARIABLE_ReuseTable_62_62;
  MR_Word STATE_VARIABLE_ModuleInfo_72_72;
  MR_Word STATE_VARIABLE_ReuseTable_73_73;
  MR_Word STATE_VARIABLE_ReuseTable_80_80;
  ...
  MR_Box conv5_STATE_VARIABLE_ReuseTable_52_52;
  MR_Box conv4_STATE_VARIABLE_ModuleInfo_53_53;
  MR_Word DebugStream_105;
  MR_Word DebugStream_106;
  MR_Word DebugStream_107;
  MR_Word DebugStream_108;
  MR_Box conv9_STATE_VARIABLE_ModuleInfo_88_88;
  MR_Word Var_91;
  MR_Word Var_92;
  MR_Box conv17_PredTable_29;

  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_30, &Globals_4);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 73, &VeryVerbose_5);
  SharingTable_6 = transform_hlds__ctgc__structure_sharing__domain__load_structure_sharing_table_1_f_0(STATE_VARIABLE_ModuleInfo_0_30);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 504, &IntermodAnalysis_7);
  switch (IntermodAnalysis_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        transform_hlds__ctgc__structure_reuse__analysis__process_imported_reuse_2_p_0(STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_34_34);
        STATE_VARIABLE_ReuseTable_36_36 = transform_hlds__ctgc__structure_reuse__domain__load_structure_reuse_table_1_f_0(STATE_VARIABLE_ModuleInfo_34_34);
        ExternalRequests_9 = (MR_Word) ((MR_Unsigned) 0U);
        MustHaveReuseVersions_10 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
    case (MR_Integer) 1:
      transform_hlds__ctgc__structure_reuse__analysis__process_intermod_analysis_reuse_5_p_0(STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_34_34, &STATE_VARIABLE_ReuseTable_36_36, &ExternalRequests_9, &MustHaveReuseVersions_10);
      break;
  }
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_34_34, &DebugStream_103);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_103, VeryVerbose_5, (MR_String) "% Annotating in use information...");
  hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_5[3]), STATE_VARIABLE_ModuleInfo_34_34, &STATE_VARIABLE_ModuleInfo_42_42);
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_42_42, &DebugStream_104);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_104, VeryVerbose_5, (MR_String) "done.\n");
  libs__file_util__maybe_write_string_5_p_0(DebugStream_104, VeryVerbose_5, (MR_String) "% Reuse table before intermediate reuse:\n");
  transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_maybe_dump_6_p_0(DebugStream_104, VeryVerbose_5, STATE_VARIABLE_ModuleInfo_42_42, STATE_VARIABLE_ReuseTable_36_36);
  mercury__list__map_foldl2_7_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__indirect__transform_hlds__ctgc__structure_reuse__indirect__type_ctor_info_sr_request_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_table_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_1[8]), ExternalRequests_9, &_NewPPIds_14, ((MR_Box) (STATE_VARIABLE_ReuseTable_36_36)), &conv5_STATE_VARIABLE_ReuseTable_52_52, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_42)), &conv4_STATE_VARIABLE_ModuleInfo_53_53);
  STATE_VARIABLE_ReuseTable_52_52 = ((MR_Word) (conv5_STATE_VARIABLE_ReuseTable_52_52));
  STATE_VARIABLE_ModuleInfo_53_53 = ((MR_Word) (conv4_STATE_VARIABLE_ModuleInfo_53_53));
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_53_53, &DebugStream_105);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_105, VeryVerbose_5, (MR_String) "% Reuse table after intermediate reuse:\n");
  transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_maybe_dump_6_p_0(DebugStream_105, VeryVerbose_5, STATE_VARIABLE_ModuleInfo_53_53, STATE_VARIABLE_ReuseTable_52_52);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_105, VeryVerbose_5, (MR_String) "% Direct reuse...\n");
  transform_hlds__ctgc__structure_reuse__direct__direct_reuse_pass_5_p_0(SharingTable_6, STATE_VARIABLE_ModuleInfo_53_53, &STATE_VARIABLE_ModuleInfo_61_61, STATE_VARIABLE_ReuseTable_52_52, &STATE_VARIABLE_ReuseTable_62_62);
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_61_61, &DebugStream_106);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_106, VeryVerbose_5, (MR_String) "% Direct reuse: done.\n");
  transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_maybe_dump_6_p_0(DebugStream_106, VeryVerbose_5, STATE_VARIABLE_ModuleInfo_61_61, STATE_VARIABLE_ReuseTable_62_62);
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_61_61, &DebugStream_107);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_107, VeryVerbose_5, (MR_String) "% Indirect reuse...\n");
  transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_8_p_0(SharingTable_6, STATE_VARIABLE_ModuleInfo_61_61, &STATE_VARIABLE_ModuleInfo_72_72, STATE_VARIABLE_ReuseTable_62_62, &STATE_VARIABLE_ReuseTable_73_73, &DepProcs0_15, &InternalRequests_16, &IntermodRequests0_17);
  hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_72_72, &DebugStream_108);
  libs__file_util__maybe_write_string_5_p_0(DebugStream_108, VeryVerbose_5, (MR_String) "% Indirect reuse: done.\n");
  transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_maybe_dump_6_p_0(DebugStream_108, VeryVerbose_5, STATE_VARIABLE_ModuleInfo_72_72, STATE_VARIABLE_ReuseTable_73_73);
  libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 517, &Repeats_18);
  transform_hlds__ctgc__structure_reuse__analysis__handle_structure_reuse_requests_11_p_0(Repeats_18, SharingTable_6, InternalRequests_16, STATE_VARIABLE_ReuseTable_73_73, &STATE_VARIABLE_ReuseTable_80_80, STATE_VARIABLE_ModuleInfo_72_72, &STATE_VARIABLE_ModuleInfo_81_81, DepProcs0_15, &DepProcs_19, IntermodRequests0_17, &IntermodRequests_20);
  transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_p_0(STATE_VARIABLE_ReuseTable_80_80, &ReuseTable_11, STATE_VARIABLE_ModuleInfo_81_81, &STATE_VARIABLE_ModuleInfo_83_83);
  switch (IntermodAnalysis_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      transform_hlds__ctgc__structure_reuse__analysis__maybe_create_forwarding_procedures_intermod_opt_4_p_0(STATE_VARIABLE_ReuseTable_36_36, ReuseTable_11, STATE_VARIABLE_ModuleInfo_83_83, &STATE_VARIABLE_ModuleInfo_84_84);
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_85;
        MR_Box conv7_STATE_VARIABLE_ModuleInfo_84_84;

        {
          Var_85 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_85, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_9[0]));
          MR_hl_field(0, Var_85, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_3));
          MR_hl_field(0, Var_85, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_85, 3) = ((MR_Box) (ReuseTable_11));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_85, MustHaveReuseVersions_10, ((MR_Box) (STATE_VARIABLE_ModuleInfo_83_83)), &conv7_STATE_VARIABLE_ModuleInfo_84_84);
        STATE_VARIABLE_ModuleInfo_84_84 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_84_84));
      }
      break;
  }
  ReuseInfoMap_21 = ((MR_Word) ((MR_hl_field(0, ReuseTable_11, (MR_Integer) 0))));
  ReuseVersionMap_22 = ((MR_Word) ((MR_hl_field(0, ReuseTable_11, (MR_Integer) 1))));
  mercury__map__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_and_status_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_1[9]), ReuseInfoMap_21, ((MR_Box) (STATE_VARIABLE_ModuleInfo_84_84)), &conv9_STATE_VARIABLE_ModuleInfo_88_88);
  STATE_VARIABLE_ModuleInfo_88_88 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_88_88));
  hlds__hlds_module__module_info_get_proc_analysis_kinds_2_p_0(STATE_VARIABLE_ModuleInfo_88_88, &ProcAnalysisKinds0_23);
  ...
  hlds__hlds_module__module_info_set_proc_analysis_kinds_3_p_0(ProcAnalysisKinds_24, STATE_VARIABLE_ModuleInfo_88_88, &STATE_VARIABLE_ModuleInfo_90_90);
  libs__globals__get_op_mode_2_p_0(Globals_4, &OpMode_25);
  succeeded = ((MR_tag((MR_Word) OpMode_25)) == (MR_Integer) 3);
  if (succeeded)
  {
    Var_91 = ((MR_Word) ((MR_hl_field(3, OpMode_25, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    MR_Word STATE_VARIABLE_AnalysisInfo_93_93;
    MR_Word Var_94;
    MR_Word STATE_VARIABLE_AnalysisInfo_95_95;
    MR_Word Var_96;
    MR_Word STATE_VARIABLE_AnalysisInfo_97_97;
    MR_Word Var_98;
    MR_Word STATE_VARIABLE_AnalysisInfo_99_99;
    MR_Box conv11_STATE_VARIABLE_AnalysisInfo_95_95;
    MR_Box conv13_STATE_VARIABLE_AnalysisInfo_97_97;
    MR_Box conv15_STATE_VARIABLE_AnalysisInfo_99_99;

    hlds__hlds_module__module_info_get_analysis_info_2_p_0(STATE_VARIABLE_ModuleInfo_90_90, &STATE_VARIABLE_AnalysisInfo_93_93);
    {
      Var_94 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_94, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_6[1]));
      MR_hl_field(0, Var_94, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_5));
      MR_hl_field(0, Var_94, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(0, Var_94, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_90_90));
      MR_hl_field(0, Var_94, 4) = ((MR_Box) (ReuseVersionMap_22));
    }
    mercury__map__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_and_status_0), (MR_Word) (&analysis__analysis__type_ctor_info_analysis_info_0), Var_94, ReuseInfoMap_21, ((MR_Box) (STATE_VARIABLE_AnalysisInfo_93_93)), &conv11_STATE_VARIABLE_AnalysisInfo_95_95);
    STATE_VARIABLE_AnalysisInfo_95_95 = ((MR_Word) (conv11_STATE_VARIABLE_AnalysisInfo_95_95));
    {
      Var_96 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_96, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_9[2]));
      MR_hl_field(0, Var_96, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_6));
      MR_hl_field(0, Var_96, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_96, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_90_90));
    }
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_ppid_no_clobbers_0), (MR_Word) (&analysis__analysis__type_ctor_info_analysis_info_0), Var_96, DepProcs_19, ((MR_Box) (STATE_VARIABLE_AnalysisInfo_95_95)), &conv13_STATE_VARIABLE_AnalysisInfo_97_97);
    STATE_VARIABLE_AnalysisInfo_97_97 = ((MR_Word) (conv13_STATE_VARIABLE_AnalysisInfo_97_97));
    {
      Var_98 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_98, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_9[3]));
      MR_hl_field(0, Var_98, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_7));
      MR_hl_field(0, Var_98, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_98, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_90_90));
    }
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__indirect__transform_hlds__ctgc__structure_reuse__indirect__type_ctor_info_sr_request_0), (MR_Word) (&analysis__analysis__type_ctor_info_analysis_info_0), Var_98, IntermodRequests_20, ((MR_Box) (STATE_VARIABLE_AnalysisInfo_97_97)), &conv15_STATE_VARIABLE_AnalysisInfo_99_99);
    STATE_VARIABLE_AnalysisInfo_99_99 = ((MR_Word) (conv15_STATE_VARIABLE_AnalysisInfo_99_99));
    hlds__hlds_module__module_info_set_analysis_info_3_p_0(STATE_VARIABLE_AnalysisInfo_99_99, STATE_VARIABLE_ModuleInfo_90_90, &STATE_VARIABLE_ModuleInfo_100_100);
  }
  else
    STATE_VARIABLE_ModuleInfo_100_100 = STATE_VARIABLE_ModuleInfo_90_90;
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_100_100, &PredTable0_28);
  {
    Var_101 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_101, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_10[0]));
    MR_hl_field(0, Var_101, 1) = ((MR_Box) (transform_hlds__ctgc__structure_reuse__analysis__perform_structure_reuse_analysis_2_p_0_8));
    MR_hl_field(0, Var_101, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(0, Var_101, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_100_100));
    MR_hl_field(0, Var_101, 4) = ((MR_Box) (VeryVerbose_5));
    MR_hl_field(0, Var_101, 5) = ((MR_Box) (ReuseInfoMap_21));
  }
  mercury__bimap__foldl_4_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_ppid_no_clobbers_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__pred_table__hlds__pred_table__type_ctor_info_predicate_table_0), Var_101, ReuseVersionMap_22, ((MR_Box) (PredTable0_28)), &conv17_PredTable_29);
  PredTable_29 = ((MR_Word) (conv17_PredTable_29));
  hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredTable_29, STATE_VARIABLE_ModuleInfo_100_100, STATE_VARIABLE_ModuleInfo_31);
}
  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_26)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word RequestList_30;
      MR_Word NewPPIds_31;
      MR_Word NewDepProcs_32;
      MR_Word NewRequests_33;
      MR_Word STATE_VARIABLE_ReuseTable_37_36;
      MR_Word STATE_VARIABLE_ModuleInfo_38_37;
      MR_Word STATE_VARIABLE_ModuleInfo_43_42;
      MR_Word STATE_VARIABLE_ReuseTable_44_43;
      MR_Word STATE_VARIABLE_ModuleInfo_53_52;
      MR_Word STATE_VARIABLE_ReuseTable_54_53;
      MR_Word STATE_VARIABLE_IntermodRequests_55_54;
      MR_Word STATE_VARIABLE_DepProcs_56_55;
      MR_Box conv4_STATE_VARIABLE_ReuseTable_37_36;
      MR_Box conv3_STATE_VARIABLE_ModuleInfo_38_37;
      MR_Word ProgressStream_70;
      MR_Word ProgressStream_71;
      MR_Word ProgressStream_72;
      MR_Word ProgressStream_73;

      hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_21, &Globals_28);
      libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 73, &VeryVerbose_29);
      RequestList_30 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__indirect__transform_hlds__ctgc__structure_reuse__indirect__type_ctor_info_sr_request_0), Requests_14);
      mercury__list__map_foldl2_7_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__indirect__transform_hlds__ctgc__structure_reuse__indirect__type_ctor_info_sr_request_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_reuse_as_table_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&transform_hlds__ctgc__structure_reuse__analysis_scalar_common_1[4]), RequestList_30, &NewPPIds_31, ((MR_Box) (STATE_VARIABLE_ReuseTable_0_19)), &conv4_STATE_VARIABLE_ReuseTable_37_36, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_21)), &conv3_STATE_VARIABLE_ModuleInfo_38_37);
      STATE_VARIABLE_ReuseTable_37_36 = ((MR_Word) (conv4_STATE_VARIABLE_ReuseTable_37_36));
      STATE_VARIABLE_ModuleInfo_38_37 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_38_37));
      hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_38_37, &ProgressStream_70);
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_70, VeryVerbose_29, (MR_String) "% Repeating direct reuse...\n");
      transform_hlds__ctgc__structure_reuse__direct__direct_reuse_process_specific_procs_6_p_0(SharingTable_13, NewPPIds_31, STATE_VARIABLE_ModuleInfo_38_37, &STATE_VARIABLE_ModuleInfo_43_42, STATE_VARIABLE_ReuseTable_37_36, &STATE_VARIABLE_ReuseTable_44_43);
      hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_43_42, &ProgressStream_71);
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_71, VeryVerbose_29, (MR_String) "% done.\n");
      hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_43_42, &ProgressStream_72);
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_72, VeryVerbose_29, (MR_String) "% Repeating indirect reuse...\n");
      transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_rerun_9_p_0(SharingTable_13, STATE_VARIABLE_ModuleInfo_43_42, &STATE_VARIABLE_ModuleInfo_53_52, STATE_VARIABLE_ReuseTable_44_43, &STATE_VARIABLE_ReuseTable_54_53, &NewDepProcs_32, &NewRequests_33, STATE_VARIABLE_IntermodRequests_0_25, &STATE_VARIABLE_IntermodRequests_55_54);
      STATE_VARIABLE_DepProcs_56_55 = mercury__set__union_2_f_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__domain__transform_hlds__ctgc__structure_reuse__domain__type_ctor_info_ppid_no_clobbers_0), NewDepProcs_32, STATE_VARIABLE_DepProcs_0_23);
      hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_53_52, &ProgressStream_73);
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_73, VeryVerbose_29, (MR_String) "% done.\n");
      succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&transform_hlds__ctgc__structure_reuse__indirect__transform_hlds__ctgc__structure_reuse__indirect__type_ctor_info_sr_request_0), NewRequests_33);
      if (succeeded)
      {
        MR_Word ProgressStream_74;

        hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_53_52, &ProgressStream_74);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_74, VeryVerbose_29, (MR_String) "% No more structure reuse requests.\n");
        *STATE_VARIABLE_IntermodRequests_26 = STATE_VARIABLE_IntermodRequests_55_54;
        *STATE_VARIABLE_DepProcs_24 = STATE_VARIABLE_DepProcs_56_55;
        *STATE_VARIABLE_ModuleInfo_22 = STATE_VARIABLE_ModuleInfo_53_52;
        *STATE_VARIABLE_ReuseTable_20 = STATE_VARIABLE_ReuseTable_54_53;
      }
      else
      {
        MR_Integer Var_68;
        MR_Word ProgressStream_75;
        MR_Integer next_value_of_Repeats_12;
        MR_Word next_value_of_Requests_14;
        MR_Word next_value_of_STATE_VARIABLE_ReuseTable_0_19;
        MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_21;
        MR_Word next_value_of_STATE_VARIABLE_DepProcs_0_23;
        MR_Word next_value_of_STATE_VARIABLE_IntermodRequests_0_25;

        hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_53_52, &ProgressStream_75);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_75, VeryVerbose_29, (MR_String) "% Outstanding structure reuse requests exist.\n");
        Var_68 = (MR_Integer) ((MR_Unsigned) Repeats_12 - (MR_Unsigned) 1);
        // direct tailcall eliminated
        ;
        next_value_of_Repeats_12 = Var_68;
        next_value_of_Requests_14 = NewRequests_33;
        next_value_of_STATE_VARIABLE_ReuseTable_0_19 = STATE_VARIABLE_ReuseTable_54_53;
        next_value_of_STATE_VARIABLE_ModuleInfo_0_21 = STATE_VARIABLE_ModuleInfo_53_52;
        next_value_of_STATE_VARIABLE_DepProcs_0_23 = STATE_VARIABLE_DepProcs_56_55;
        next_value_of_STATE_VARIABLE_IntermodRequests_0_25 = STATE_VARIABLE_IntermodRequests_55_54;
        Repeats_12 = next_value_of_Repeats_12;
        Requests_14 = next_value_of_Requests_14;
        STATE_VARIABLE_ReuseTable_0_19 = next_value_of_STATE_VARIABLE_ReuseTable_0_19;
        STATE_VARIABLE_ModuleInfo_0_21 = next_value_of_STATE_VARIABLE_ModuleInfo_0_21;
        STATE_VARIABLE_DepProcs_0_23 = next_value_of_STATE_VARIABLE_DepProcs_0_23;
        STATE_VARIABLE_IntermodRequests_0_25 = next_value_of_STATE_VARIABLE_IntermodRequests_0_25;
        continue;
      }
    }
    else
