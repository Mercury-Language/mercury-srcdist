...
{
  {
    ...
    if (((MR_tag((MR_Word) Answer1_5)) == (MR_mktag((MR_Integer) 1))))
      ...
      if (((MR_tag((MR_Word) Answer2_6)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        TypeInfo_20_49 = (MR_Word) &transform_hlds__ctgc__structure_reuse__analysis_scalar_common_2[2];
        mercury__map__from_corresponding_lists_3_p_0(TypeInfo_20_49, TypeInfo_20_49, ImpHeadVars_38, HeadVars_41, &VarRenaming_42);
        ...
        TypeInfo_20_67 = (MR_Word) &transform_hlds__ctgc__structure_reuse__analysis_scalar_common_2[2];
        mercury__map__from_corresponding_lists_3_p_0(TypeInfo_20_67, TypeInfo_20_67, ImpHeadVars_56, HeadVars_59, &VarRenaming_60);
        ...
        succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ImpTypes_57, HeadVarTypes_20, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_63, &TypeSubst_61);
        if (succeeded)
        {
          MR_Word Var_64;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          MR_Integer Var_20 = (MR_Integer) ((MR_Unsigned) I_1 + (MR_Unsigned) (MR_Integer) 1);
        ...
        {
          MR_Integer Var_22 = (MR_Integer) ((MR_Unsigned) I_1 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 60, &VeryVerbose_8);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 342, &IntermodAnalysis_10);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 426, &Repeats_20);
  ...
  top_of_proc_2:;
    {
      ...
      else
      {
        ...
        Var_62 = (MR_Integer) ((MR_Unsigned) Repeats_12 - (MR_Unsigned) (MR_Integer) 1);
        // direct tailcall eliminated
