  ...
  MR_Word * STATE_VARIABLE_VarDb_57)
{
  ...
  if ((MaybeDet_66 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (PredOrFuncStr_74));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_85, 1) = ((MR_Box) (PredSymName_77));
    }
    {
      Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (Var_85));
      MR_hl_field(MR_mktag(1), Var_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__polymorphism_lambda_scalar_common_1[8])));
    }
    {
  ...
  else
  {
    ...
    Var_92 = (MR_Integer) ((MR_Unsigned) NumArgModes_69 - (MR_Unsigned) NumLambdaVars_70);
    mercury__list__det_drop_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Var_92, ArgModes_68, &LambdaModes_71);
