...
{
  {
    ...
    if ((MaybeDet_60 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__polymorphism_lambda_scalar_common_1[8])));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_67, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__polymorphism_lambda_scalar_common_1[1])));
...
{
  {
    ...
    if ((MaybeDet_15 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__polymorphism_lambda_scalar_common_1[1])));
