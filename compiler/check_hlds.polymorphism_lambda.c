...
{
  MR_bool succeeded;
  MR_Word ArgVars0_12 = ((MR_Word) ((MR_hl_field(2, RHS0_7, 1))));
  MR_Word LambdaVarsModes0_13 = ((MR_Word) ((MR_hl_field(2, RHS0_7, 2))));
  MR_Word LambdaGoal0_15 = ((MR_Word) ((MR_hl_field(2, RHS0_7, 4))));
  ...
  MR_Word ProcInfo_35;
  MR_Word MaybeDet_52;
  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(2, RHS0_7, 0)));
  ...
  LambdaGoalInfo_18 = ((MR_Word) ((MR_hl_field(0, LambdaGoal0_15, 1))));
  hlds__goal_list_util__goal_to_conj_list_2_p_0(LambdaGoal0_15, &LambdaGoalList0_19);
  ...
  if (succeeded)
  {
    LastGoalExpr0_22 = ((MR_Word) ((MR_hl_field(0, LastGoal0_21, 0))));
    LastGoalInfo0_23 = ((MR_Word) ((MR_hl_field(0, LastGoal0_21, 1))));
    succeeded = ((MR_tag((MR_Word) LastGoalExpr0_22)) == (MR_Integer) 2);
    if (succeeded)
    {
      PredId0_24 = ((MR_Word) ((MR_hl_field(2, LastGoalExpr0_22, 0))));
      Args0_26 = ((MR_Word) ((MR_hl_field(2, LastGoalExpr0_22, 2))));
      Var_41 = ((MR_Unsigned) ((MR_hl_field(2, LastGoalExpr0_22, 3))) & (MR_Integer) 1);
      MaybeCallUnifyContext0_27 = ((MR_Word) ((MR_hl_field(2, LastGoalExpr0_22, 4))));
      QualifiedPName0_28 = ((MR_Word) ((MR_hl_field(2, LastGoalExpr0_22, 5))));
  ...
  if (succeeded)
  {
    ...
    hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_43, LambdaGoalInfo_18, &LambdaGoal_32);
  ...
  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo_35, &MaybeDet_52);
  if ((MaybeDet_52 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      Specs_40 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Specs_40, 0) = ((MR_Box) (Spec_65));
      MR_hl_field(0, Specs_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      MR_Word base;
  ...
  else
  {
    ...
    MR_Word LambdaDet_38 = ((MR_Word) ((MR_hl_field(1, MaybeDet_52, 0))));
    MR_Word RHS_39;
    MR_Word ArgModes_54;
    ...
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_35, &ArgModes_54);
  ...
  MR_Word * STATE_VARIABLE_VarTable_56)
{
  ...
  hlds__var_table_hlds__create_fresh_vars_5_p_0(ModuleInfo0_14, PredArgTypes_20, &LambdaVars_26, STATE_VARIABLE_VarTable_0_55, STATE_VARIABLE_VarTable_56);
  ...
  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo_29, &MaybeDet_65);
  if ((MaybeDet_65 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Pieces_77 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_80, Var_86);
    {
      ...
      MR_hl_field(0, Spec_78, 2) = ((MR_Box) ((MR_Unsigned) 68U));
      MR_hl_field(0, Spec_78, 3) = ((MR_Box) (Context_23));
      MR_hl_field(0, Spec_78, 4) = ((MR_Box) (Pieces_77));
    }
    {
      Specs_54 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Specs_54, 0) = ((MR_Box) (Spec_78));
      MR_hl_field(0, Specs_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
  ...
  else
  {
    ...
    MR_Word LambdaDet_50 = ((MR_Word) ((MR_hl_field(1, MaybeDet_65, 0))));
    ...
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_29, &ArgModes_67);
