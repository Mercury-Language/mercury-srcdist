  ...
  MR_Word * MaybeRHS_8)
{
  ...
  if ((MaybeDet_53 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_66, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.polymorphism_lambda.lambda_modes_and_det\'/5"));
      MR_hl_field(0, Spec_66, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_66, 2) = ((MR_Box) ((MR_Unsigned) 60U));
      MR_hl_field(0, Spec_66, 3) = ((MR_Box) (Context_34));
  ...
  MR_Word * STATE_VARIABLE_VarTable_57)
{
  ...
  if ((MaybeDet_66 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_79, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.polymorphism_lambda.lambda_modes_and_det\'/5"));
      MR_hl_field(0, Spec_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_79, 2) = ((MR_Box) ((MR_Unsigned) 60U));
      MR_hl_field(0, Spec_79, 3) = ((MR_Box) (Context_25));
