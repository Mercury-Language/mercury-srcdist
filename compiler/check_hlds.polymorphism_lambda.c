...
check_hlds__polymorphism_lambda__create_fresh_vars_5_p_0(
  ...
  MR_Word STATE_VARIABLE_VarDb_0_4,
  MR_Word * STATE_VARIABLE_VarDb_5);
  ...
  MR_Word * MaybeRHS_8)
{
  ...
  if ((MaybeDet_53 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_71, 1) = ((MR_Box) (PredOrFuncStr_61));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_73, 1) = ((MR_Box) (PredSymName_64));
    }
    {
      Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Var_73));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__polymorphism_lambda_scalar_common_1[8])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_65, 1) = ((MR_Box) (Var_70));
    }
    {
...
check_hlds__polymorphism_lambda__convert_pred_to_lambda_goal_14_p_0(
  ...
  MR_Word Context_25,
  MR_Word * MaybeRHS_26,
  MR_Word STATE_VARIABLE_VarDb_0_56,
  MR_Word * STATE_VARIABLE_VarDb_57)
{
  ...
  check_hlds__polymorphism_lambda__create_fresh_vars_5_p_0(ModuleInfo0_15, PredArgTypes_22, &LambdaVars_28, STATE_VARIABLE_VarDb_0_56, STATE_VARIABLE_VarDb_57);
  ...
  if ((MaybeDet_66 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    PredOrFuncStr_74 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_73);
    ...
    {
      PredSymName_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), PredSymName_77, 0) = ((MR_Box) (PredModuleName_75));
      MR_hl_field(MR_mktag(1), PredSymName_77, 1) = ((MR_Box) (PredName_76));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_84, 1) = ((MR_Box) (PredOrFuncStr_74));
    }
    {
      Var_86 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_86, 0) = ((MR_Box) ((MR_Unsigned) 7U));
      MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (PredSymName_77));
    }
    {
      Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (Var_86));
      MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__polymorphism_lambda_scalar_common_1[8])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_78, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__polymorphism_lambda_scalar_common_1[1])));
      MR_hl_field(MR_mktag(1), Pieces_78, 1) = ((MR_Box) (Var_83));
    }
    {
      Spec_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Spec_79, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.polymorphism_lambda.lambda_modes_and_det\'/5"));
      MR_hl_field(MR_mktag(1), Spec_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(1), Spec_79, 2) = ((MR_Box) ((MR_Unsigned) 56U));
      MR_hl_field(MR_mktag(1), Spec_79, 3) = ((MR_Box) (Context_25));
      MR_hl_field(MR_mktag(1), Spec_79, 4) = ((MR_Box) (Pieces_78));
    }
    {
      Specs_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Specs_55, 0) = ((MR_Box) (Spec_79));
      MR_hl_field(MR_mktag(1), Specs_55, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
  ...
  else
  {
    ...
    MR_Word LambdaDet_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDet_66, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_VarDb_5)
{
  if ((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *STATE_VARIABLE_VarDb_5 = STATE_VARIABLE_VarDb_0_4;
  }
  else
  {
    ...
    MR_Word IsDummy_16;
    MR_Word Entry_17;
    MR_Word STATE_VARIABLE_VarDb_21_21;
    ...
    parse_tree__var_table__add_entry_to_var_db_4_p_0(Entry_17, &Var_13, STATE_VARIABLE_VarDb_0_4, &STATE_VARIABLE_VarDb_21_21);
    check_hlds__polymorphism_lambda__create_fresh_vars_5_p_0(ModuleInfo_1, Types_12, &Vars_14, STATE_VARIABLE_VarDb_21_21, STATE_VARIABLE_VarDb_5);
    {
      MR_Word base;
