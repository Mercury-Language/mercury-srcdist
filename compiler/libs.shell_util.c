  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Char Char_3 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_8, 0) = ((MR_Box) (MR_Word) (Char_3));
        MR_hl_field(MR_mktag(1), Var_8, 1) = ((MR_Box) (Chars1_6));
      }
      {
        HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Char) 92));
      ...
      {
        HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (Char_3));
        MR_hl_field(MR_mktag(1), HeadVar__2_2, 1) = ((MR_Box) (Chars1_6));
      }
  }
  return HeadVar__2_2;
}
