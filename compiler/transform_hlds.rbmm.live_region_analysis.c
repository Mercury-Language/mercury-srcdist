...
MR_decl_label3(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 43,44,7)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__live_region_analysis_module3)
	...
	MR_init_label3(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,43,44,7)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,16)
	...
	MR_sv(20) = (MR_Word) MR_CTOR1_ADDR(set_ordlist, set_ordlist);
...
MR_def_label(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,7)
	...
	MR_r3 = (MR_Word) MR_string_const("rpta_info must exist", 20);
