  ...
  MR_Word * STATE_VARIABLE_ProcLRMap_16)
{
  ...
  else
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_20);
    {
      Var_21 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__proc_lv_to_proc_lr_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_21, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_21, 3) = ((MR_Box) (Graph_8));
      MR_hl_field(MR_mktag(0), Var_21, 4) = ((MR_Box) (ModuleInfo_9));
      MR_hl_field(MR_mktag(0), Var_21, 5) = ((MR_Box) (ProcInfo_10));
    }
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[1]), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[0]), Var_21, LVs_12, ((MR_Box) (LRSet0_20)), &conv1_LRs_14);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__rbmm__live_region_analysis__proc_lv_to_proc_lr_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv5_STATE_VARIABLE_ProcLRMap_16);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__rbmm__points_to_graph__rptg_reach_from_a_variable_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_HeadVar__6_6);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_108);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_109, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_109, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_p_0_1));
          MR_hl_field(MR_mktag(0), Var_109, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), Var_109, 3) = ((MR_Box) (Graph_41));
          MR_hl_field(MR_mktag(0), Var_109, 4) = ((MR_Box) (ModuleInfo_24));
          MR_hl_field(MR_mktag(0), Var_109, 5) = ((MR_Box) (ProcInfo_43));
        }
      ...
      else
      {
        ...
        mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_115);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_116, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_116, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_p_0_2));
          MR_hl_field(MR_mktag(0), Var_116, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), Var_116, 3) = ((MR_Box) (Graph_41));
          MR_hl_field(MR_mktag(0), Var_116, 4) = ((MR_Box) (ModuleInfo_24));
          MR_hl_field(MR_mktag(0), Var_116, 5) = ((MR_Box) (ProcInfo_43));
        }
      ...
      ProcLVBefore_52 = ((MR_Word) (conv4_ProcLVBefore_52));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_85, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_6[0]));
        MR_hl_field(MR_mktag(0), Var_85, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_p_0_3));
  ...
  MR_Word * STATE_VARIABLE_LocalRTable_54)
{
  ...
  ProcIds_38 = hlds__hlds_pred__pred_info_valid_non_imported_procids_1_f_0(PredInfo_37);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__live_region_analysis_pred_22_p_0_1));
    MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) ((MR_Integer) 6));
    MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (ModuleInfo_23));
    MR_hl_field(MR_mktag(0), Var_55, 4) = ((MR_Box) (RptaInfoTable_24));
    MR_hl_field(MR_mktag(0), Var_55, 5) = ((MR_Box) (LVBeforeTable_25));
    MR_hl_field(MR_mktag(0), Var_55, 6) = ((MR_Box) (LVAfterTable_26));
    MR_hl_field(MR_mktag(0), Var_55, 7) = ((MR_Box) (VoidVarTable_27));
    MR_hl_field(MR_mktag(0), Var_55, 8) = ((MR_Box) (PredId_28));
  }
  ...
  MR_Word * LocalRTable_26)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[0]), &LocalRTable0_35);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_36, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__live_region_analysis_13_p_0_1));
    MR_hl_field(MR_mktag(0), Var_36, 2) = ((MR_Box) ((MR_Integer) 5));
    MR_hl_field(MR_mktag(0), Var_36, 3) = ((MR_Box) (ModuleInfo_14));
    MR_hl_field(MR_mktag(0), Var_36, 4) = ((MR_Box) (RptaInfoTable_15));
    MR_hl_field(MR_mktag(0), Var_36, 5) = ((MR_Box) (LVBeforeTable_16));
    MR_hl_field(MR_mktag(0), Var_36, 6) = ((MR_Box) (LVAfterTable_17));
    MR_hl_field(MR_mktag(0), Var_36, 7) = ((MR_Box) (VoidVarTable_18));
  }
