  ...
  MR_Word * STATE_VARIABLE_ProcLRMap_16)
{
  ...
  else
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_24);
    {
      Var_25 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_25, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__proc_lv_to_proc_lr_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_25, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_25, 3) = ((MR_Box) (Graph_8));
      MR_hl_field(MR_mktag(0), Var_25, 4) = ((MR_Box) (ModuleInfo_9));
      MR_hl_field(MR_mktag(0), Var_25, 5) = ((MR_Box) (ProcInfo_10));
    }
    mercury__set__fold_4_p_0((MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[1]), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[0]), Var_25, LVs_12, ((MR_Box) (LRSet0_24)), &conv1_LRs_14);
  ...
  MR_Word * STATE_VARIABLE_LocalRTable_73)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_2[3]), LVBeforeTable_26, ((MR_Box) (PPId_39)), &conv0_ProcLVBefore_52);
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_2[3]), LVAfterTable_27, ((MR_Box) (PPId_39)), &conv3_ProcLVAfter_54);
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_2[3]), VoidVarTable_28, ((MR_Box) (PPId_39)), &conv5_ProcVoidVar_56);
  ...
  MR_Word * LRSet_10)
{
  ...
  else
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_11);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
