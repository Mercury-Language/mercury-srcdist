  ...
  MR_Word * STATE_VARIABLE_ProcLRMap_16)
{
  ...
  else
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), &LRSet0_19);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (transform_hlds__rbmm__live_region_analysis__proc_lv_to_proc_lr_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (Graph_8));
      MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (ModuleInfo_9));
      MR_hl_field(MR_mktag(0), Var_20, 5) = ((MR_Box) (ProcInfo_10));
    }
