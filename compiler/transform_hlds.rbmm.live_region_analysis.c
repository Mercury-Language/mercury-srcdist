    ...
    if (transform_hlds__rbmm__live_region_analysis__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__live_region_analysis__Var_12, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_4[0]));
    ...
    if (transform_hlds__rbmm__live_region_analysis__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__live_region_analysis__Var_26, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_4[0]));
        ...
        if (transform_hlds__rbmm__live_region_analysis__succeeded)
          {
            ...
            transform_hlds__rbmm__live_region_analysis__ProcLVBefore_52 = ((MR_Word) transform_hlds__rbmm__live_region_analysis__conv0_ProcLVBefore_52);
            {
              ...
              MR_hl_field(MR_mktag(0), transform_hlds__rbmm__live_region_analysis__Var_85, 0) = ((MR_Box) (&transform_hlds__rbmm__live_region_analysis_scalar_common_3[0]));
