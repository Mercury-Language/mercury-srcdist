...
MR_decl_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_13_0, 2,5,6,7,8,9,10,11)
MR_decl_label1(transform_hlds__rbmm__live_region_analysis__live_region_analysis_13_0, 12)
MR_decl_label2(transform_hlds__rbmm__live_region_analysis__live_region_analysis_pred_22_0, 2,3)
MR_decl_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 5,3,8,10,11,13,14,15)
MR_decl_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 16,18,19,20,21,22,23,24)
MR_decl_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 25,26,27,28,31,33,35,36)
MR_decl_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 37,38,39,40,41,42,43,44)
MR_decl_label2(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0, 7,45)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__live_region_analysis_module0)
	...
	MR_init_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_13_0,2,5,6,7,8,9,10,11)
	MR_init_label1(transform_hlds__rbmm__live_region_analysis__live_region_analysis_13_0,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__live_region_analysis_module4)
	...
	MR_init_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,5,3,8,10,11,13,14,15)
	MR_init_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,16,18,19,20,21,22,23,24)
	MR_init_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,25,26,27,28,31,33,35,36)
	MR_init_label8(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,37,38,39,40,41,42,43,44)
	MR_init_label2(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,7,45)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__live_region_analysis__live_region_analysis_proc_23_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(14) = MR_r1;
	MR_sv(19) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
	MR_r1 = MR_sv(19);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(8);
