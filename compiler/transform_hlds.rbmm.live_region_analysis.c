...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_76 = mercury__set__from_list_1_f_0((MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[1]), Inputs_44);
        transform_hlds__rbmm__live_region_analysis__lv_to_lr_5_p_0(Var_76, Graph_41, ModuleInfo_24, ProcInfo_43, &InputR_46);
        Var_77 = mercury__set__from_list_1_f_0((MR_Word) (&transform_hlds__rbmm__live_region_analysis_scalar_common_1[1]), Outputs_45);
        ...
        Var_83 = mercury__set__from_list_1_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), Nodes_50);
