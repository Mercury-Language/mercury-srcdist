  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_79 = ((MR_Word) ((MR_hl_field(1, ArgVectorTypeErrors_71, 1))));
      ...
      {
        MR_Box conv1_STATE_VARIABLE_Info_1_50;

        mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_typecheck_info_0), (MR_Word) (&check_hlds__typecheck_clauses_scalar_common_4[4]), Specs_69, ((MR_Box) (STATE_VARIABLE_Info_0_8)), &conv1_STATE_VARIABLE_Info_1_50);
        STATE_VARIABLE_Info_1_50 = ((MR_Word) (conv1_STATE_VARIABLE_Info_1_50));
      }
      check_hlds__typecheck_clauses__typecheck_goal_7_p_0(Body0_39, &Body_46, Context_41, STATE_VARIABLE_TypeAssignSet_1_49, &STATE_VARIABLE_TypeAssignSet_2_51, STATE_VARIABLE_Info_1_50, &STATE_VARIABLE_Info_2_52);
      ...
      check_hlds__typecheck_clauses__typecheck_check_for_ambiguity_6_p_0(Context_41, (MR_Integer) 0, HeadVars_1, STATE_VARIABLE_TypeAssignSet_1_35, STATE_VARIABLE_Info_2_52, &STATE_VARIABLE_Info_1_36);
      {
