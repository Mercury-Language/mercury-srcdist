...
check_hlds__typecheck_clauses__IntroducedFrom__pred__typecheck_goal_expr__477__1_2_p_0(
  MR_Word GoalType_94,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_clauses__IntroducedFrom__pred__typecheck_goal_expr__477__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
