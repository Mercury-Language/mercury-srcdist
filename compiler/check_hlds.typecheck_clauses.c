...
check_hlds__typecheck_clauses__IntroducedFrom__pred__typecheck_goal_expr__459__1_2_p_0(
  MR_Word GoalType_94,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_clauses__IntroducedFrom__pred__typecheck_goal_expr__459__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  hlds__pred_table__predicate_table_lookup_pf_sym_name_name_pfa_6_p_0(PredicateTable_18, IsFullyQualified_21, (MR_Integer) 0, SymName_12, PredFormArity_19, &PredIds_22);
  if ((PredIds_22 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *PredId_14 = hlds__pred_proc_id__invalid_pred_id_0_f_0();
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_74, ((MR_Box) (PredId_92)), &conv0_PredInfo_95);
  ...
  MR_Word * STATE_VARIABLE_ArgsTypeAssignSet_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), HeadVar__1_1, ((MR_Box) (PredId_18)), &conv0_PredInfo_22);
  ...
  MR_Word * STATE_VARIABLE_ArgsTypeAssigns_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__type_rename__apply_renaming_to_constraint_db_3_p_0(Renaming_26, PredConstraintDb_4, &ParentConstraintDb_29);
