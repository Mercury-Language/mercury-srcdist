  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  TailCalls_29 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_28, (MR_Integer) 1))) >> 4)) & (MR_Integer) 1);
  switch (TailCalls_29) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
  ...
  MR_Word * STATE_VARIABLE_CodeGenPredProcIds_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
        ProcIds_18 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo0_14);
      else
        ProcIds_18 = hlds__hlds_pred__pred_info_all_non_imported_procids_1_f_0(PredInfo0_14);
