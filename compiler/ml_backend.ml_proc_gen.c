...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_38, (MR_Integer) 488, &EliminateUnusedAssigns_39);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 486, &TailCalls_26);
    switch (TailCalls_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
