...
static /* final */ const MR_Box ml_backend__ml_proc_gen_scalar_common_1[26][3] = {
  ...
  /* row 22 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_proc_gen_scalar_common_2[20])))
  },
  /* row 23 */
  {
...
{
  {
    ...
    SelectorType_20 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_proc_gen_scalar_common_2[20]));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_proc_gen_scalar_common_1[22])));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_38, (MR_Integer) 478, &EliminateUnusedAssigns_39);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 476, &TailCalls_26);
    switch (TailCalls_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
