      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__proc_info_interface_determinism_2_p_0(ProcInfo_16, &Detism_38);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_39 = ml_backend__ml_proc_gen__IntroducedFrom__func__ml_find_and_requantify_procs_for_code_gen__170__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)));
