...
{
  {
    ...
    Var_11 = mercury__term__context_init_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), DescStmt_6, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
...
{
  {
    ...
    Var_15 = mercury__term__context_init_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), MsgStmt_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
