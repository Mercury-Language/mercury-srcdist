  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  MR_Word Context_12 = ((MR_Word) ((MR_hl_field(0, NonTailRecCall_8, 2))));
  MR_Word Reason_13 = ((((MR_Unsigned) ((MR_hl_field(0, NonTailRecCall_8, 3))) >> 2)) & (MR_Integer) 3);
  MR_Word Obviousness_14 = ((((MR_Unsigned) ((MR_hl_field(0, NonTailRecCall_8, 3))) >> 1)) & (MR_Integer) 1);
  MR_Word Status_15 = ((MR_Unsigned) ((MR_hl_field(0, NonTailRecCall_8, 3))) & (MR_Integer) 1);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__ml_proc_gen__report_nontail_rec_call_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_Specs_20);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
          ProcIds_22 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo0_17);
        else
          ProcIds_22 = hlds__hlds_pred__pred_info_all_non_imported_procids_1_f_0(PredInfo0_17);
