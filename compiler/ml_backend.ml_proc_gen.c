...
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__760__2_2_p_0(
  MR_Word ml_backend__ml_proc_gen__GC_Method_10,
  MR_Word ml_backend__ml_proc_gen__HeadVar__2_14);

static MR_bool MR_CALL 
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__760__1_2_p_0(
...
static /* final */ const MR_Box ml_backend__ml_proc_gen_scalar_common_2[7][3];
...
static /* final */ const MR_Box ml_backend__ml_proc_gen_scalar_common_6[4][5];
...
{
  {
    ...
    if ((ml_backend__ml_proc_gen__InputSteps_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_proc_gen__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_11[1]);
    ...
    if ((ml_backend__ml_proc_gen__MaybeOutputSteps_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        ml_backend__ml_proc_gen__Var_79 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_11[2]);
        {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ...
        ml_backend__ml_proc_gen__Var_34 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_11[0]);
        {
        ...
        if ((ml_backend__ml_proc_gen__ReturnTypes_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            {
              mercury__list__filter_3_p_0(ml_backend__ml_proc_gen__TypeCtorInfo_26_40, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[6], ml_backend__ml_proc_gen__Args_28, &ml_backend__ml_proc_gen__OutArgs_30);
            }
            {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_34, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_10[0]));
    ...
    {
      ml_backend__ml_proc_gen__Var_67 = mercury__list__map_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_24_70, ml_backend__ml_proc_gen__TypeCtorInfo_25_71, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[5], ml_backend__ml_proc_gen__Var_68);
    }
    {
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__760__2_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 4))));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__760__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__conv0_HeadVar__2_2 = ml_backend__mlds__wrap_local_var_defn_1_f_0(((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_proc_gen__Var_79 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0, ml_backend__ml_proc_gen__TypeCtorInfo_84_84, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[4], ml_backend__ml_proc_gen__MLDS_LocalVars_42);
        }
        {
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__conv6_HeadVar__2_2 = ml_backend__mlds__wrap_local_var_defn_1_f_0(((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_proc_gen__Var_45 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0, ml_backend__ml_proc_gen__TypeCtorInfo_57_57, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[3], ml_backend__ml_proc_gen__ConvDecls_24);
        }
        {
