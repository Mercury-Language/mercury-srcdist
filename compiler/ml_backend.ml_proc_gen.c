        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_65, Var_66);
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_38, (MR_Integer) 479, &EliminateUnusedAssigns_39);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 477, &TailCalls_26);
    switch (TailCalls_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
