...
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__735__2_2_p_0(
  MR_Word ml_backend__ml_proc_gen__GC_Method_10,
  MR_Word ml_backend__ml_proc_gen__HeadVar__2_15);

static MR_bool MR_CALL 
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__735__1_2_p_0(
  MR_Word ml_backend__ml_proc_gen__HeadVar__1_16,
  MR_Word ml_backend__ml_proc_gen__HeadVar__2_22);

static void MR_CALL 
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_proc_body__612__1_7_p_0(
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_9, (MR_Integer) 257, &ml_backend__ml_proc_gen__DetCopyOut_10);
    }
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_87, (MR_Integer) 258, &ml_backend__ml_proc_gen__NondetCopyOut_88);
              }
...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ml_backend__ml_proc_gen__V_34_34 = (MR_Integer) 257;
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__735__2_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 4))));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__735__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
