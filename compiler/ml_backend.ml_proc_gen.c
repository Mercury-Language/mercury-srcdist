...
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__741__2_2_p_0(
  MR_Word ml_backend__ml_proc_gen__GC_Method_10,
  MR_Word ml_backend__ml_proc_gen__HeadVar__2_15);

static MR_bool MR_CALL 
ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__741__1_2_p_0(
...
static MR_Word MR_CALL 
ml_backend__ml_proc_gen__IntroducedFrom__func__ml_gen_imports__147__1_1_f_0(
...
static MR_Box MR_CALL 
ml_backend__ml_proc_gen__ml_gen_proc_9_p_0_1(
  MR_Box ml_backend__ml_proc_gen__closure_arg,
  MR_Box ml_backend__ml_proc_gen__wrapper_arg_1);
...
ml_backend__ml_proc_gen__ml_gen_proc_9_p_0(
  ...
  MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_62,
  MR_Word * ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_63,
...
ml_backend__ml_proc_gen__ml_gen_procs_9_p_0(
  ...
  MR_Word ml_backend__ml_proc_gen__HeadVar__6_6,
  MR_Word * ml_backend__ml_proc_gen__HeadVar__7_7,
...
ml_backend__ml_proc_gen__ml_gen_preds_acc_8_p_0(
  ...
  MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_24,
  MR_Word * ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_25,
...
static /* final */ const MR_Box ml_backend__ml_proc_gen_scalar_common_5[5][5];
...
static /* final */ const MR_Box ml_backend__ml_proc_gen_scalar_common_2[8][3] = {
  ...
  /* row 6 */
  {
    ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_5[4])),
    ((MR_Box) (ml_backend__ml_proc_gen__ml_gen_proc_9_p_0_1)),
    ((MR_Box) (MR_Word) ((MR_Integer) 0))
  },
  /* row 7 */
  {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_6, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[5]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__DataDefn_12, 1) = ((MR_Box) (ml_backend__ml_proc_gen__MLDS_Context_8));
    ...
    if ((ml_backend__ml_proc_gen__StepDescs_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_27, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[4]));
...
{
  {
    ...
    MR_Word ml_backend__ml_proc_gen__Var_94;
    ...
    MR_Word ml_backend__ml_proc_gen__Var_139;
    ...
    MR_Word ml_backend__ml_proc_gen__Var_146;
    MR_Word ml_backend__ml_proc_gen__Var_152;
    MR_Word ml_backend__ml_proc_gen__Var_153;
    ...
    if ((ml_backend__ml_proc_gen__InputSteps_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_proc_gen__Var_59 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_9[1]);
        MR_Word ml_backend__ml_proc_gen__Var_61;

        {
          ml_backend__ml_proc_gen__InputStepsRefInit_29 = ml_backend__ml_proc_gen__gen_init_tabling_name_3_f_0(ml_backend__ml_proc_gen__MLDS_ModuleName_10, ml_backend__ml_proc_gen__MLDS_ProcLabel_26, ml_backend__ml_proc_gen__Var_59);
        }
        {
          ml_backend__ml_proc_gen__Var_61 = mercury__list__map_2_f_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_table_step_desc_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_6[2], ml_backend__ml_proc_gen__InputSteps_20);
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_proc_gen__InputStepsInit_33, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_61));
        }
        {
          ml_backend__ml_proc_gen__InputStepsDefn_34 = ml_backend__ml_proc_gen__tabling_name_and_init_to_defn_5_f_0(ml_backend__ml_proc_gen__MLDS_ProcLabel_26, ml_backend__ml_proc_gen__MLDS_Context_27, (MR_Integer) 1, ml_backend__ml_proc_gen__Var_59, ml_backend__ml_proc_gen__InputStepsInit_33);
        }
        {
    ...
    ml_backend__ml_proc_gen__TypeCtorInfo_158_158 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0;
    {
      ml_backend__ml_proc_gen__Var_76 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__CallStatsDefns_36, ml_backend__ml_proc_gen__PrevCallStatsDefns_38);
    }
    {
      ml_backend__ml_proc_gen__CallDefns_39 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__InputStepsDefns_30, ml_backend__ml_proc_gen__Var_76);
    }
    if ((ml_backend__ml_proc_gen__MaybeOutputSteps_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        ml_backend__ml_proc_gen__Var_77 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_9[2]);
        {
          ml_backend__ml_proc_gen__OutputStepsRefInit_41 = ml_backend__ml_proc_gen__gen_init_tabling_name_3_f_0(ml_backend__ml_proc_gen__MLDS_ModuleName_10, ml_backend__ml_proc_gen__MLDS_ProcLabel_26, ml_backend__ml_proc_gen__Var_77);
        }
        {
          ml_backend__ml_proc_gen__Var_79 = mercury__list__map_2_f_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_table_step_desc_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_6[3], ml_backend__ml_proc_gen__OutputSteps_43);
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_proc_gen__OutputStepsInit_44, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_79));
        }
        {
          ml_backend__ml_proc_gen__OutputStepsDefn_45 = ml_backend__ml_proc_gen__tabling_name_and_init_to_defn_5_f_0(ml_backend__ml_proc_gen__MLDS_ProcLabel_26, ml_backend__ml_proc_gen__MLDS_Context_27, (MR_Integer) 1, ml_backend__ml_proc_gen__Var_77, ml_backend__ml_proc_gen__OutputStepsInit_44);
        }
        {
    ...
    {
      ml_backend__ml_proc_gen__Var_94 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__AnswerStatsDefns_47, ml_backend__ml_proc_gen__PrevAnswerStatsDefns_49);
    }
    {
      ml_backend__ml_proc_gen__AnswerDefns_50 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__OutputStepsDefns_42, ml_backend__ml_proc_gen__Var_94);
    }
    {
    ...
    {
      ml_backend__ml_proc_gen__Var_102 = ml_backend__ml_util__gen_init_int_1_f_0((MR_Integer) 0);
    }
    {
      ml_backend__ml_proc_gen__Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_101, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_102));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(2), ml_backend__ml_proc_gen__RootNodeInit_53, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_101));
    }
    {
    ...
    {
      ml_backend__ml_proc_gen__Var_110 = ml_backend__ml_util__gen_init_builtin_const_1_f_0(ml_backend__ml_proc_gen__TableTypeStr_28);
    }
    {
      ml_backend__ml_proc_gen__Var_112 = ml_backend__ml_util__gen_init_int_1_f_0(ml_backend__ml_proc_gen__NumInputs_18);
    }
    {
      ml_backend__ml_proc_gen__Var_114 = ml_backend__ml_util__gen_init_int_1_f_0(ml_backend__ml_proc_gen__NumOutputs_19);
    }
    {
      ml_backend__ml_proc_gen__Var_116 = ml_backend__ml_util__gen_init_int_1_f_0(ml_backend__ml_proc_gen__HasAnswerTable_40);
    }
    {
      ml_backend__ml_proc_gen__Var_123 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_123, 0) = ((MR_Box) (ml_backend__ml_proc_gen__OutputStepsRefInit_41));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_123, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_122, 0) = ((MR_Box) (ml_backend__ml_proc_gen__InputStepsRefInit_29));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_122, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_123));
    }
    {
      ml_backend__ml_proc_gen__Var_121 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_proc_gen__Var_121, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_122));
    }
    {
      ml_backend__ml_proc_gen__Var_130 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_130, 0) = ((MR_Box) (ml_backend__ml_proc_gen__PrevCallStatsInit_37));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_130, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_129, 0) = ((MR_Box) (ml_backend__ml_proc_gen__CallStatsInit_35));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_129, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_130));
    }
    {
    ...
    {
      ml_backend__ml_proc_gen__Var_135 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_135, 0) = ((MR_Box) (ml_backend__ml_proc_gen__PrevAnswerStatsInit_48));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_135, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_134, 0) = ((MR_Box) (ml_backend__ml_proc_gen__AnswerStatsInit_46));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_134, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_135));
    }
    {
      ml_backend__ml_proc_gen__Var_133 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_proc_gen__Var_133, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_134));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_132, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_133));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_127, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_132));
    }
    {
      ml_backend__ml_proc_gen__Var_126 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_proc_gen__Var_126, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_127));
    }
    {
      ml_backend__ml_proc_gen__Var_139 = ml_backend__ml_util__gen_init_int_1_f_0((MR_Integer) 0);
    }
    {
      ml_backend__ml_proc_gen__Var_143 = ml_backend__ml_util__gen_init_int_1_f_0((MR_Integer) 0);
    }
    {
      ml_backend__ml_proc_gen__Var_146 = ml_backend__ml_util__gen_init_int_1_f_0((MR_Integer) 0);
    }
    {
      ml_backend__ml_proc_gen__Var_145 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_145, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_146));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_145, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ml_backend__ml_proc_gen__Var_142 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_142, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_143));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_142, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_145));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_141, 0) = ((MR_Box) (ml_backend__ml_proc_gen__TipsRefInit_54));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_141, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_142));
    }
    {
      ml_backend__ml_proc_gen__Var_138 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_138, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_139));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_138, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_141));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_125, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_126));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_125, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_138));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_120, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_121));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_120, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_125));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_119, 0) = ((MR_Box) (ml_backend__ml_proc_gen__RootNodeInit_53));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_118, 0) = ((MR_Box) (ml_backend__ml_proc_gen__TypeParamLocnsRefInit_52));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_117, 0) = ((MR_Box) (ml_backend__ml_proc_gen__PTIsRefInit_51));
    ...
    {
      ml_backend__ml_proc_gen__Var_109 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_109, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_110));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_109, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_111));
    }
    {
      ...
      MR_hl_field(MR_mktag(2), ml_backend__ml_proc_gen__ProcTableInfoInit_55, 1) = ((MR_Box) (ml_backend__ml_proc_gen__Var_109));
    }
    {
    ...
    {
      ml_backend__ml_proc_gen__Var_153 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_153, 0) = ((MR_Box) (ml_backend__ml_proc_gen__ProcTableInfoDefn_56));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_153, 1) = ((MR_Box) (ml_backend__ml_proc_gen__STATE_VARIABLE_DataDefns_0_57));
    }
    {
      ml_backend__ml_proc_gen__Var_152 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__AnswerDefns_50, ml_backend__ml_proc_gen__Var_153);
    }
    {
      *ml_backend__ml_proc_gen__STATE_VARIABLE_DataDefns_58 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_158_158, ml_backend__ml_proc_gen__CallDefns_39, ml_backend__ml_proc_gen__Var_152);
    }
  }
}
...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_proc_gen__Var_45 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, ml_backend__ml_proc_gen__TypeCtorInfo_57_57, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[7], ml_backend__ml_proc_gen__ConvDecls_24);
        }
        {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_8, (MR_Integer) 266, &ml_backend__ml_proc_gen__NondetCopyOut_9);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_9, (MR_Integer) 265, &ml_backend__ml_proc_gen__DetCopyOut_10);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_21, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[3]));
...
{
  {
    ...
    MR_Word ml_backend__ml_proc_gen__MLDS_ProcContext_52;
    MR_Word ml_backend__ml_proc_gen__DeclFlags_53;
    MR_Word ml_backend__ml_proc_gen__MaybePredProcId_54;
    MR_Word ml_backend__ml_proc_gen__MaybeRequireTailrecInfo_55;
    MR_Word ml_backend__ml_proc_gen__Attributes_56;
    MR_Word ml_backend__ml_proc_gen__AttributeList_57;
    MR_Word ml_backend__ml_proc_gen__MLDS_Attributes_58;
    MR_Word ml_backend__ml_proc_gen__FunctionDefn_59;
    MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_Info_68_68;
    MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_Info_75_75;
    MR_Word ml_backend__ml_proc_gen__Var_79;
    MR_Word ml_backend__ml_proc_gen__Var_80;
    MR_Word ml_backend__ml_proc_gen__Var_82;
    MR_Word ml_backend__ml_proc_gen__PredInfo_92;
    MR_Word ml_backend__ml_proc_gen__Access_93;
    ...
    ml_backend__ml_proc_gen__Var_69 = (MR_Word) ml_backend__ml_proc_gen__PredStatus_19;
    ml_backend__ml_proc_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_proc_gen__Var_69)) == (MR_mktag((MR_Integer) 1)));
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ml_backend__ml_proc_gen__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_69, (MR_Integer) 0)));
        {
      ...
      {
        MR_Word ml_backend__ml_proc_gen__TypeCtorInfo_83_83;
        ...
        switch (ml_backend__ml_proc_gen__CodeModel_21) {
          ...
          case (MR_Integer) 2:
            {
              ml_backend__ml_proc_gen__ml_set_up_initial_succ_cont_4_p_0(*ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_61, &ml_backend__ml_proc_gen__CopiedOutputVars_34, ml_backend__ml_proc_gen__STATE_VARIABLE_Info_68_68, &ml_backend__ml_proc_gen__STATE_VARIABLE_Info_71_71);
            }
            break;
        }
        ...
        {
          ml_backend__ml_proc_gen__Var_73 = ml_backend__ml_code_util__ml_gen_succeeded_var_decl_1_f_0(ml_backend__ml_proc_gen__MLDS_Context_41);
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__MLDS_LocalVars_42, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_73));
        ...
        ml_backend__ml_proc_gen__TypeCtorInfo_83_83 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0;
        {
          ml_backend__ml_proc_gen__Var_77 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0, ml_backend__ml_proc_gen__TypeCtorInfo_83_83, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[6], ml_backend__ml_proc_gen__MLDS_LocalVars_42);
        }
        {
          ml_backend__ml_proc_gen__Defns_46 = mercury__list__f_43_43_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_83_83, ml_backend__ml_proc_gen__Var_77, ml_backend__ml_proc_gen__Defns0_44);
        }
        {
          ml_backend__ml_proc_gen__Statement_47 = ml_backend__ml_code_util__ml_gen_block_3_f_0(ml_backend__ml_proc_gen__Defns_46, ml_backend__ml_proc_gen__Statements_45, ml_backend__ml_proc_gen__Context_27);
        }
        ml_backend__ml_proc_gen__FunctionBody_30 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_proc_gen__Statement_47);
      }
    {
      ml_backend__ml_gen_info__ml_gen_info_get_env_var_names_2_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_Info_75_75, &ml_backend__ml_proc_gen__EnvVarNames_48);
    }
    {
      hlds__hlds_pred__proc_info_get_context_2_p_0(ml_backend__ml_proc_gen__ProcInfo0_17, &ml_backend__ml_proc_gen__ProcContext_49);
    }
    {
      ml_backend__ml_code_util__ml_gen_proc_label_5_p_0(*ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_61, ml_backend__ml_proc_gen__PredId_12, ml_backend__ml_proc_gen__ProcId_13, &ml_backend__ml_proc_gen___ModuleName_50, &ml_backend__ml_proc_gen__PlainFuncName_51);
    }
    {
      ml_backend__ml_proc_gen__MLDS_ProcContext_52 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_proc_gen__ProcContext_49);
    }
    {
      hlds__hlds_module__module_info_pred_info_3_p_0(*ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_61, ml_backend__ml_proc_gen__PredId_12, &ml_backend__ml_proc_gen__PredInfo_92);
    }
    {
      ml_backend__ml_proc_gen__succeeded = hlds__hlds_pred__procedure_is_exported_3_p_0(*ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_61, ml_backend__ml_proc_gen__PredInfo_92, ml_backend__ml_proc_gen__ProcId_13);
    }
    if (ml_backend__ml_proc_gen__succeeded)
      ml_backend__ml_proc_gen__Access_93 = (MR_Integer) 0;
    else
      ml_backend__ml_proc_gen__Access_93 = (MR_Integer) 1;
    {
      ml_backend__ml_proc_gen__DeclFlags_53 = ml_backend__mlds__init_function_decl_flags_2_f_0(ml_backend__ml_proc_gen__Access_93, (MR_Integer) 0);
    }
    {
      ml_backend__ml_proc_gen__Var_79 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_79, 0) = ((MR_Box) (ml_backend__ml_proc_gen__PredId_12));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_79, 1) = ((MR_Box) (ml_backend__ml_proc_gen__ProcId_13));
    }
    {
      ml_backend__ml_proc_gen__MaybePredProcId_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__MaybePredProcId_54, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_79));
    }
    {
      hlds__hlds_pred__proc_info_get_maybe_require_tailrec_info_2_p_0(ml_backend__ml_proc_gen__ProcInfo0_17, &ml_backend__ml_proc_gen__MaybeRequireTailrecInfo_55);
    }
    {
      hlds__hlds_pred__pred_info_get_attributes_2_p_0(ml_backend__ml_proc_gen__PredInfo_16, &ml_backend__ml_proc_gen__Attributes_56);
    }
    {
      hlds__hlds_pred__attributes_to_attribute_list_2_p_0(ml_backend__ml_proc_gen__Attributes_56, &ml_backend__ml_proc_gen__AttributeList_57);
    }
    {
      ml_backend__ml_proc_gen__MLDS_Attributes_58 = ml_backend__ml_proc_gen__attributes_to_mlds_attributes_2_f_0(*ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_61, ml_backend__ml_proc_gen__AttributeList_57);
    }
    ml_backend__ml_proc_gen__Var_80 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_proc_gen__PlainFuncName_51);
    {
      ml_backend__ml_proc_gen__FunctionDefn_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 0) = ((MR_Box) (ml_backend__ml_proc_gen__Var_80));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 1) = ((MR_Box) (ml_backend__ml_proc_gen__MLDS_ProcContext_52));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 2) = ((MR_Box) (ml_backend__ml_proc_gen__DeclFlags_53));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 3) = ((MR_Box) (ml_backend__ml_proc_gen__MaybePredProcId_54));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 4) = ((MR_Box) (ml_backend__ml_proc_gen__MLDS_Params_32));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 5) = ((MR_Box) (ml_backend__ml_proc_gen__FunctionBody_30));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 6) = ((MR_Box) (ml_backend__ml_proc_gen__MLDS_Attributes_58));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 7) = ((MR_Box) (ml_backend__ml_proc_gen__EnvVarNames_48));
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FunctionDefn_59, 8) = ((MR_Box) (ml_backend__ml_proc_gen__MaybeRequireTailrecInfo_55));
    }
    {
      ml_backend__ml_proc_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_82, 0) = ((MR_Box) (ml_backend__ml_proc_gen__FunctionDefn_59));
      MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_82, 1) = ((MR_Box) (ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_62));
    }
    {
      *ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_63 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0, ml_backend__ml_proc_gen__ExtraDefns_31, ml_backend__ml_proc_gen__Var_82);
    }
  }
}
        ...
        if ((ml_backend__ml_proc_gen__HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            *ml_backend__ml_proc_gen__HeadVar__7_7 = ml_backend__ml_proc_gen__HeadVar__6_6;
        ...
        else
          {
            ...
            MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_35;
            MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_36_36;

            {
              ml_backend__ml_proc_gen__ml_gen_proc_9_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_1, &ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_34_34, ml_backend__ml_proc_gen__ConstStructMap_3, ml_backend__ml_proc_gen__PredId_4, ml_backend__ml_proc_gen__ProcId_24, ml_backend__ml_proc_gen__HeadVar__6_6, &ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_35, ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_0_8, &ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_36_36);
            }
            /* direct tailcall eliminated */
            {
              MR_Word ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_ModuleInfo_0_1 = ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_34_34;
              MR_Word ml_backend__ml_proc_gen__next_value_of_HeadVar__5_5 = ml_backend__ml_proc_gen__ProcIds_25;
              MR_Word ml_backend__ml_proc_gen__next_value_of_HeadVar__6_6 = ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_35;
              MR_Word ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_GlobalData_0_8 = ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_36_36;

              ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_0_8 = ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_GlobalData_0_8;
              ml_backend__ml_proc_gen__HeadVar__6_6 = ml_backend__ml_proc_gen__next_value_of_HeadVar__6_6;
              ml_backend__ml_proc_gen__HeadVar__5_5 = ml_backend__ml_proc_gen__next_value_of_HeadVar__5_5;
              ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_1 = ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_ModuleInfo_0_1;
            }
            continue;
          }
      }
        ...
        if ((ml_backend__ml_proc_gen__PredIds0_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            *ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_25 = ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_24;
        ...
        else
          {
            ...
            MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_33_33;
            ...
            {
              MR_Word ml_backend__ml_proc_gen__Var_30 = (MR_Word) ml_backend__ml_proc_gen__PredStatus_18;
              MR_Word ml_backend__ml_proc_gen__Var_19;

              ml_backend__ml_proc_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_proc_gen__Var_30)) == (MR_mktag((MR_Integer) 2)));
              if (ml_backend__ml_proc_gen__succeeded)
                ml_backend__ml_proc_gen__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(2), ml_backend__ml_proc_gen__Var_30, (MR_Integer) 0)));
            }
            if (!(ml_backend__ml_proc_gen__succeeded))
              {
                MR_Word ml_backend__ml_proc_gen__Var_28;
                ...
                if (ml_backend__ml_proc_gen__succeeded)
                  {
                    ml_backend__ml_proc_gen__Var_28 = (MR_Word) ml_backend__ml_proc_gen__PredStatus_18;
                    ml_backend__ml_proc_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_proc_gen__Var_28)) == (MR_mktag((MR_Integer) 1)));
                    if (ml_backend__ml_proc_gen__succeeded)
                      {
                        ml_backend__ml_proc_gen__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_28, (MR_Integer) 0)));
                        ml_backend__ml_proc_gen__succeeded = (ml_backend__ml_proc_gen__Var_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
                      }
                  }
              }
            if (ml_backend__ml_proc_gen__succeeded)
              {
                ...
                ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_33_33 = ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_24;
            ...
            else
              {
                ...
                MR_Word ml_backend__ml_proc_gen__Var_31 = (MR_Word) ml_backend__ml_proc_gen__PredStatus_18;
                MR_Word ml_backend__ml_proc_gen__Var_20;

                ml_backend__ml_proc_gen__succeeded = ((MR_tag((MR_Word) ml_backend__ml_proc_gen__Var_31)) == (MR_mktag((MR_Integer) 1)));
                if (ml_backend__ml_proc_gen__succeeded)
                  {
                    ml_backend__ml_proc_gen__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_proc_gen__Var_31, (MR_Integer) 0)));
                    {
                ...
                if ((ml_backend__ml_proc_gen__ProcIds_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    MR_Word ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_86;
                    ...
                    {
                      ml_backend__ml_proc_gen__ml_gen_proc_9_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_22, &ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_34_85, ml_backend__ml_proc_gen__ConstStructMap_10, ml_backend__ml_proc_gen__PredId_14, ml_backend__ml_proc_gen__ProcId_75, ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_24, &ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_86, ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalDefns_0_26, &ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_36_87);
                    }
                    {
                      ml_backend__ml_proc_gen__ml_gen_procs_9_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_34_85, &ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_32_32, ml_backend__ml_proc_gen__ConstStructMap_10, ml_backend__ml_proc_gen__PredId_14, ml_backend__ml_proc_gen__ProcIds_76, ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_35_86, &ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_33_33, ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_36_87, &ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalDefns_34_34);
                    }
                  }
              }
            /* direct tailcall eliminated */
            {
              MR_Word ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_ModuleInfo_0_22 = ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_32_32;
              MR_Word ml_backend__ml_proc_gen__next_value_of_PredIds0_11 = ml_backend__ml_proc_gen__PredIds_15;
              MR_Word ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_FunctionDefns_0_24 = ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_33_33;
              MR_Word ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_GlobalDefns_0_26 = ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalDefns_34_34;

              ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalDefns_0_26 = ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_GlobalDefns_0_26;
              ml_backend__ml_proc_gen__STATE_VARIABLE_FunctionDefns_0_24 = ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_FunctionDefns_0_24;
              ml_backend__ml_proc_gen__PredIds0_11 = ml_backend__ml_proc_gen__next_value_of_PredIds0_11;
              ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_22 = ml_backend__ml_proc_gen__next_value_of_STATE_VARIABLE_ModuleInfo_0_22;
            }
            continue;
          }
      }
...
{
  {
    ...
    MR_Word ml_backend__ml_proc_gen__Var_20;
    MR_Word ml_backend__ml_proc_gen__Globals_25;
    MR_Word ml_backend__ml_proc_gen__Target_26;
    MR_Word ml_backend__ml_proc_gen__FuncParamsByRef_29;
    MR_Word ml_backend__ml_proc_gen__GlobalsByRef_27;
    MR_Word ml_backend__ml_proc_gen__ModuleInfoByRef_28;
    MR_Word ml_backend__ml_proc_gen__Args_30;
    MR_Word ml_backend__ml_proc_gen__ReturnTypes_31;
    MR_Word ml_backend__ml_proc_gen__Var_35;
    ...
    ml_backend__ml_proc_gen__Var_20 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_proc_gen__PlainName_13);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__MLDS_Name_14, 2) = ((MR_Box) (ml_backend__ml_proc_gen__Var_20));
    }
    {
      hlds__hlds_module__module_info_get_globals_2_p_0(ml_backend__ml_proc_gen__ModuleInfo_4, &ml_backend__ml_proc_gen__Globals_25);
    }
    {
      libs__globals__get_target_2_p_0(ml_backend__ml_proc_gen__Globals_25, &ml_backend__ml_proc_gen__Target_26);
    }
    switch (ml_backend__ml_proc_gen__Target_26) {
      default:
    ...
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ml_backend__ml_proc_gen__Var_35 = (MR_Integer) 265;
        ml_backend__ml_proc_gen__Var_37 = (MR_Integer) 0;
        ml_backend__ml_proc_gen__Var_36 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_proc_gen_scalar_common_9[0]);
        {
          libs__globals__set_option_4_p_0(ml_backend__ml_proc_gen__Var_35, ml_backend__ml_proc_gen__Var_36, ml_backend__ml_proc_gen__Globals_25, &ml_backend__ml_proc_gen__GlobalsByRef_27);
        }
        {
          hlds__hlds_module__module_info_set_globals_3_p_0(ml_backend__ml_proc_gen__GlobalsByRef_27, ml_backend__ml_proc_gen__ModuleInfo_4, &ml_backend__ml_proc_gen__ModuleInfoByRef_28);
        }
        {
          ml_backend__ml_proc_gen__FuncParamsByRef_29 = ml_backend__ml_code_util__ml_gen_proc_params_3_f_0(ml_backend__ml_proc_gen__ModuleInfoByRef_28, ml_backend__ml_proc_gen__PredId_8, ml_backend__ml_proc_gen__ProcId_9);
        }
        ml_backend__ml_proc_gen__Args_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FuncParamsByRef_29, (MR_Integer) 0)));
        ml_backend__ml_proc_gen__ReturnTypes_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__FuncParamsByRef_29, (MR_Integer) 1)));
        if ((ml_backend__ml_proc_gen__ReturnTypes_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word ml_backend__ml_proc_gen__TypeCtorInfo_26_42 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0;
            MR_Word ml_backend__ml_proc_gen__OutArgs_32;
            MR_Integer ml_backend__ml_proc_gen__Var_39;

            {
              mercury__list__filter_3_p_0(ml_backend__ml_proc_gen__TypeCtorInfo_26_42, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[5], ml_backend__ml_proc_gen__Args_30, &ml_backend__ml_proc_gen__OutArgs_32);
            }
            {
              ml_backend__ml_proc_gen__Var_39 = mercury__list__length_1_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_26_42, ml_backend__ml_proc_gen__OutArgs_32);
            }
            ml_backend__ml_proc_gen__succeeded = (ml_backend__ml_proc_gen__Var_39 > (MR_Integer) 1);
          }
        else
          ml_backend__ml_proc_gen__succeeded = MR_TRUE;
      }
    if (ml_backend__ml_proc_gen__succeeded)
      ml_backend__ml_proc_gen__FuncParams_15 = ml_backend__ml_proc_gen__FuncParamsByRef_29;
    else
      {
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__741__2_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 4))));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__succeeded = ml_backend__ml_proc_gen__IntroducedFrom__pred__ml_gen_table_structs__741__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
    return ml_backend__ml_proc_gen__succeeded;
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_proc_gen__Globals_48;
    MR_Word ml_backend__ml_proc_gen__Target_49;
    MR_Word ml_backend__ml_proc_gen__UseCommonCells_50;
    MR_Word ml_backend__ml_proc_gen__UnboxedFloats_51;
    MR_Word ml_backend__ml_proc_gen__HaveUnboxedFloats_52;
    MR_Word ml_backend__ml_proc_gen__PredTable_62;
    MR_Word ml_backend__ml_proc_gen__PredIds_63;
      ...
      *ml_backend__ml_proc_gen__TableStructDefns_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_28, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_5[3]));
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_28, 4) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_6[0]));
        }
        {
          mercury__require__expect_4_p_0(ml_backend__ml_proc_gen__Var_28, (MR_String) "ml_backend.ml_proc_gen", (MR_String) "predicate \140ml_backend.ml_proc_gen.ml_gen_table_structs\'/2", (MR_String) "tabling and \140--gc accurate\'");
        }
        {
          ml_backend__ml_proc_gen__Var_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_34, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_34, 1) = ((MR_Box) (ml_backend__ml_proc_gen__ml_gen_defns_6_p_0_3));
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_34, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_34, 3) = ((MR_Box) (ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_13));
        }
        {
          mercury__list__foldl_4_p_0((MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[2], (MR_Word) &ml_backend__ml_proc_gen_scalar_common_1[4], ml_backend__ml_proc_gen__Var_34, ml_backend__ml_proc_gen__TableStructs_23, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &ml_backend__ml_proc_gen__conv1_TableStructDefns_9);
        }
        *ml_backend__ml_proc_gen__TableStructDefns_9 = ((MR_Word) ml_backend__ml_proc_gen__conv1_TableStructDefns_9);
      }
    {
      hlds__hlds_module__module_info_get_globals_2_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_13, &ml_backend__ml_proc_gen__Globals_48);
    }
    {
      libs__globals__get_target_2_p_0(ml_backend__ml_proc_gen__Globals_48, &ml_backend__ml_proc_gen__Target_49);
    }
    ml_backend__ml_proc_gen__UseCommonCells_50 = ((&ml_backend__ml_proc_gen_vector_common_8[0 + ml_backend__ml_proc_gen__Target_49]))->ml_backend__ml_proc_gen__vector_common_type_8_0__vct_8_f_0;
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_48, (MR_Integer) 252, &ml_backend__ml_proc_gen__UnboxedFloats_51);
    }
    switch (ml_backend__ml_proc_gen__UnboxedFloats_51) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ml_backend__ml_proc_gen__HaveUnboxedFloats_52 = (MR_Integer) 1;
        break;
      case (MR_Integer) 1:
        ml_backend__ml_proc_gen__HaveUnboxedFloats_52 = (MR_Integer) 0;
        break;
    }
    {
      ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_16_16 = ml_backend__ml_global_data__ml_global_data_init_2_f_0(ml_backend__ml_proc_gen__UseCommonCells_50, ml_backend__ml_proc_gen__HaveUnboxedFloats_52);
    }
    {
    ...
    {
      hlds__hlds_module__module_info_get_preds_2_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_13, &ml_backend__ml_proc_gen__PredTable_62);
    }
    {
      mercury__map__keys_2_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0, ml_backend__ml_proc_gen__PredTable_62, &ml_backend__ml_proc_gen__PredIds_63);
    }
    {
      ml_backend__ml_proc_gen__ml_gen_preds_acc_8_p_0(ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_0_13, ml_backend__ml_proc_gen__STATE_VARIABLE_ModuleInfo_14, ml_backend__ml_proc_gen__ConstStructMap_12, ml_backend__ml_proc_gen__PredIds_63, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_proc_gen__PredDefns_10, ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_17_17, ml_backend__ml_proc_gen__STATE_VARIABLE_GlobalData_15);
    }
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_26, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[2]));
...
{
  {
    ...
    {
      ml_backend__ml_proc_gen__conv3_LambdaHeadVar__2_16 = ml_backend__ml_proc_gen__IntroducedFrom__func__ml_gen_imports__147__1_1_f_0(((MR_Word) ml_backend__ml_proc_gen__wrapper_arg_1));
    }
...
{
  {
    ...
    ml_backend__ml_proc_gen__TypeCtorInfo_24_46 = (MR_Word) &libs__globals__libs__globals__type_ctor_info_foreign_language_0;
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_39, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[0]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_40, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_4[0]));
    ...
    ml_backend__ml_proc_gen__TypeCtorInfo_25_77 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_import_0;
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_proc_gen__Var_72, 0) = ((MR_Box) (&ml_backend__ml_proc_gen_scalar_common_3[1]));
    ...
    {
      ml_backend__ml_proc_gen__Var_73 = mercury__list__map_2_f_0(ml_backend__ml_proc_gen__TypeCtorInfo_24_76, ml_backend__ml_proc_gen__TypeCtorInfo_25_77, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[3], ml_backend__ml_proc_gen__Var_74);
    }
    {
    ...
    {
      ml_backend__ml_proc_gen__Var_19 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0, (MR_Word) &ml_backend__ml_proc_gen_scalar_common_2[4], ml_backend__ml_proc_gen__PredDefns_11);
    }
    {
      MR_Word base;
