...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_9, (MR_Integer) 263, &ml_backend__ml_proc_gen__DetCopyOut_10);
    }
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_87, (MR_Integer) 264, &ml_backend__ml_proc_gen__NondetCopyOut_88);
              }
...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ml_backend__ml_proc_gen__V_34_34 = (MR_Integer) 263;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_49, (MR_Integer) 250, &ml_backend__ml_proc_gen__UnboxedFloats_52);
    }
