...
{
  {
    ...
    if (ml_backend__ml_proc_gen__succeeded)
      {
        ml_backend__ml_proc_gen__Var_35 = (MR_Integer) 266;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_proc_gen__Globals_48, (MR_Integer) 253, &ml_backend__ml_proc_gen__UnboxedFloats_51);
    }
