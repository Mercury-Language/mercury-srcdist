  ...
  MR_Word * STATE_VARIABLE_DepsGraph_12)
{
  ...
  MR_Word IntDeps_36;
  MR_Word STATE_VARIABLE_DepsGraph_14_37;
  ...
  MR_Box conv3_STATE_VARIABLE_DepsGraph_14_37;
  ...
  {
    AddDep_33 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), AddDep_33, 0) = ((MR_Box) (&parse_tree__module_deps_graph_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), AddDep_33, 1) = ((MR_Box) (parse_tree__module_deps_graph__add_parent_imp_deps_5_p_0_1));
    MR_hl_field(MR_mktag(0), AddDep_33, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), AddDep_33, 3) = ((MR_Box) (ModuleKey_7));
  }
  parse_tree__module_dep_info__module_dep_info_get_module_name_2_p_0(ParentModuleDepInfo_10, &ModuleName_34);
  Ancestors_35 = mdbcomp__sym_name__get_ancestors_set_1_f_0(ModuleName_34);
  parse_tree__module_dep_info__module_dep_info_get_int_deps_2_p_0(ParentModuleDepInfo_10, &IntDeps_36);
  mercury__set__fold_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__module_deps_graph_scalar_common_1[0]), AddDep_33, Ancestors_35, ((MR_Box) (STATE_VARIABLE_DepsGraph_0_11)), &conv3_STATE_VARIABLE_DepsGraph_14_37);
  STATE_VARIABLE_DepsGraph_14_37 = ((MR_Word) (conv3_STATE_VARIABLE_DepsGraph_14_37));
  mercury__set__fold_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__module_deps_graph_scalar_common_1[0]), AddDep_33, IntDeps_36, ((MR_Box) (STATE_VARIABLE_DepsGraph_14_37)), &conv4_STATE_VARIABLE_DepsGraph_11_19);
  ...
  parse_tree__module_dep_info__module_dep_info_get_imp_deps_2_p_0(ParentModuleDepInfo_10, &ImpDeps_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&parse_tree__module_deps_graph_scalar_common_4[0]));
