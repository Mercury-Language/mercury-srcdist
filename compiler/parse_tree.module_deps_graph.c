...
{
  {
    ...
    MR_Word Var_84;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_7, (MR_Integer) 15)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_7, (MR_Integer) 25)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_6, (MR_Integer) 15)));
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_6, (MR_Integer) 25)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_6, (MR_Integer) 15)));
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleImports_6, (MR_Integer) 25)));
