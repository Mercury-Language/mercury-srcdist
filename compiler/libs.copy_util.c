    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          MR_Word SourceRes_31;

          DestinationFile_17 = mercury__dir__f_slash_2_f_0(DestinationDir_11, BaseSourceFile_16);
          mercury__io__open_binary_input_4_p_0(SourceFile_10, &SourceRes_31);
          if (((MR_tag((MR_Word) SourceRes_31)) == (MR_Integer) 1))
          {
            MR_Word Error_19 = ((MR_Word) ((MR_hl_field(1, SourceRes_31, (MR_Integer) 0))));
            MR_String Var_26;
            MR_String Var_29;
          ...
          {
            MR_Word SourceStream_32 = ((MR_Word) ((MR_hl_field(0, SourceRes_31, (MR_Integer) 0))));
            MR_Word DestRes_33;
            MR_Word Res_50;

            mercury__io__open_binary_output_4_p_0(DestinationFile_17, &DestRes_33);
            if (((MR_tag((MR_Word) DestRes_33)) == (MR_Integer) 1))
            {
              MR_Word Error_35 = ((MR_Word) ((MR_hl_field(1, DestRes_33, (MR_Integer) 0))));

              {
                Res_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Res_50, 0) = ((MR_Box) (Error_35));
              }
            }
            else
            {
              MR_Word DestStream_34 = ((MR_Word) ((MR_hl_field(0, DestRes_33, (MR_Integer) 0))));
              MR_Word ShouldReduce_41;
...
#define MR_PROC_LABEL libs__copy_util__copy_file_to_directory_7_p_0
    ...
    ShouldReduce = MR_NO;
		...
		;}
#undef MR_PROC_LABEL
	ShouldReduce_41  = ShouldReduce;
}
              switch (ShouldReduce_41) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  libs__copy_util__copy_bytes_plain_5_p_0(SourceStream_32, DestStream_34, &Res_50);
                  break;
                case (MR_Integer) 1:
                  libs__copy_util__copy_bytes_chunk_5_p_0(SourceStream_32, DestStream_34, &Res_50);
                  break;
              }
              mercury__io__close_binary_input_3_p_0(SourceStream_32);
              mercury__io__close_binary_output_3_p_0(DestStream_34);
            }
            if ((Res_50 == (MR_Word) ((MR_Unsigned) 0U)))
              *Succeeded_12 = (MR_Integer) 1;
            else
            {
              MR_Word Error_42 = ((MR_Word) ((MR_hl_field(1, Res_50, (MR_Integer) 0))));
              MR_String Var_43;
              MR_String Var_45;

              Var_45 = mercury__io__error_message_1_f_0(Error_42);
              Var_43 = mercury__string__f_43_43_2_f_0((MR_String) "Could not copy file:  ", Var_45);
              libs__file_util__report_error_4_p_0(ProgressStream_9, Var_43);
              *Succeeded_12 = (MR_Integer) 0;
            }
          }
        }
  ...
  MR_Word * Succeeded_12)
{
  ...
  switch (InstallMethod_14) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word SourceRes_28;

        mercury__io__open_binary_input_4_p_0(SourceFile_10, &SourceRes_28);
        if (((MR_tag((MR_Word) SourceRes_28)) == (MR_Integer) 1))
        {
          MR_Word Error_17 = ((MR_Word) ((MR_hl_field(1, SourceRes_28, (MR_Integer) 0))));
          MR_String Var_24;
          MR_String Var_27;
        ...
        {
          MR_Word SourceStream_29 = ((MR_Word) ((MR_hl_field(0, SourceRes_28, (MR_Integer) 0))));
          MR_Word DestRes_30;
          MR_Word Res_47;

          mercury__io__open_binary_output_4_p_0(DestinationFile_11, &DestRes_30);
          if (((MR_tag((MR_Word) DestRes_30)) == (MR_Integer) 1))
          {
            MR_Word Error_32 = ((MR_Word) ((MR_hl_field(1, DestRes_30, (MR_Integer) 0))));

            {
              Res_47 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Res_47, 0) = ((MR_Box) (Error_32));
            }
          }
          else
          {
            MR_Word DestStream_31 = ((MR_Word) ((MR_hl_field(0, DestRes_30, (MR_Integer) 0))));
            MR_Word ShouldReduce_38;
...
#define MR_PROC_LABEL libs__copy_util__copy_file_to_file_name_7_p_0
    ...
    ShouldReduce = MR_NO;
		...
		;}
#undef MR_PROC_LABEL
	ShouldReduce_38  = ShouldReduce;
}
            switch (ShouldReduce_38) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                libs__copy_util__copy_bytes_plain_5_p_0(SourceStream_29, DestStream_31, &Res_47);
                break;
              case (MR_Integer) 1:
                libs__copy_util__copy_bytes_chunk_5_p_0(SourceStream_29, DestStream_31, &Res_47);
                break;
            }
            mercury__io__close_binary_input_3_p_0(SourceStream_29);
            mercury__io__close_binary_output_3_p_0(DestStream_31);
          }
          if ((Res_47 == (MR_Word) ((MR_Unsigned) 0U)))
            *Succeeded_12 = (MR_Integer) 1;
          else
          {
            MR_Word Error_39 = ((MR_Word) ((MR_hl_field(1, Res_47, (MR_Integer) 0))));
            MR_String Var_40;
            MR_String Var_42;

            Var_42 = mercury__io__error_message_1_f_0(Error_39);
            Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "Could not copy file:  ", Var_42);
            libs__file_util__report_error_4_p_0(ProgressStream_9, Var_40);
            *Succeeded_12 = (MR_Integer) 0;
          }
        }
      }
