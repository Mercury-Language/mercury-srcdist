...
{
  {
    ...
    switch (MR_tag((MR_Word) ll_backend__llds_out__llds_out_data__Const_6)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Integer ll_backend__llds_out__llds_out_data__N_94 = ((MR_Integer) (MR_hl_field(MR_mktag(2), ll_backend__llds_out__llds_out_data__Const_6, (MR_Integer) 0)));

          {
            backend_libs__c_util__output_int_expr_cur_stream_3_p_0(ll_backend__llds_out__llds_out_data__N_94);
          }
        }
        break;
      case (MR_Integer) 3:
