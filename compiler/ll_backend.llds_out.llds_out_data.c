...
ll_backend__llds_out__llds_out_data__IntroducedFrom__func__output_rval_const__1468__1_2_f_0(
                      ...
                      case (MR_Integer) 7:
                        {
                          ...
                          if (succeeded)
                            succeeded = (StaticGroundInt64s_186 == (MR_Integer) 1);
                          if (succeeded)
                          {
                      ...
                      case (MR_Integer) 13:
                        {
                          ...
                          if (succeeded)
                          {
                            succeeded = (StaticGroundFloats_190 == (MR_Integer) 1);
                            if (succeeded)
                      ...
                      case (MR_Integer) 14:
                        {
                          ...
                          if (succeeded)
                          {
                            succeeded = (StaticGroundFloats_951 == (MR_Integer) 1);
                            if (succeeded)
                      ...
                      case (MR_Integer) 15:
                        {
                          ...
                          if (succeeded)
                          {
                            succeeded = (StaticGroundFloats_746 == (MR_Integer) 1);
                            if (succeeded)
                      ...
                      case (MR_Integer) 16:
                        {
                          ...
                          if (succeeded)
                          {
                            succeeded = (StaticGroundFloats_541 == (MR_Integer) 1);
                            if (succeeded)
...
{
  {
    ...
    conv0_LambdaHeadVar__3_62 = ll_backend__llds_out__llds_out_data__IntroducedFrom__func__output_rval_const__1468__1_2_f_0(((MR_String) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)));
