                                        ...
                                        *ll_backend__llds_out__llds_out_data__STATE_VARIABLE_N_42 = (ll_backend__llds_out__llds_out_data__STATE_VARIABLE_N_0_41 + (MR_Integer) 1);
                                        {
                                          ...
                                          MR_hl_field(MR_mktag(1), ll_backend__llds_out__llds_out_data__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__llds_out__llds_out_data_scalar_common_3[0])));
                                        }
                                        {
