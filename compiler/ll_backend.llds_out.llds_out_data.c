    ...
    switch (MR_tag((MR_Word) Const_6)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              int8_t N_101 = ((int8_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              uint8_t N_102 = ((uint8_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              int16_t N_103 = ((int16_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 3:
            {
              uint16_t N_104 = ((uint16_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              int32_t N_105 = ((int32_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
          ...
          case (MR_Integer) 5:
            {
              uint32_t N_106 = ((uint32_t) (MR_hl_field(MR_mktag(3), Const_6, (MR_Integer) 1)));
