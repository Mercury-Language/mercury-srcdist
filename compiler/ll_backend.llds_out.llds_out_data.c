...
{
  MR_bool succeeded;
  MR_Word UnboxInt64s_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7))) >> 4)) & (MR_Integer) 1);
  MR_Word StaticGroundInt64s_21 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 7))) >> 3)) & (MR_Integer) 1);
  ...
  MR_Word IsPtr_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 1))));
        succeeded = ((((MR_tag((MR_Word) Var_77)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_77, (MR_Integer) 0)))) == (MR_Integer) 6)));
        if (succeeded)
        {
          Int64_76 = MR_unbox_int64((MR_hl_field(MR_mktag(3), Var_77, (MR_Integer) 1)));
          Int64Name0_80 = mercury__string__int64_to_string_1_f_0(Int64_76);
          Var_81 = (MR_String) "-";
          Var_82 = (MR_String) "neg";
          mercury__string__replace_all_4_p_0(Int64Name0_80, Var_81, Var_82, &Int64Name_14);
          succeeded = MR_TRUE;
        }
      }
    }
