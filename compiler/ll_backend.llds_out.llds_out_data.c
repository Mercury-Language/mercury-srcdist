...
ll_backend__llds_out__llds_out_data__output_ptag_4_p_0(
  ...
  MR_Word Ptag_6)
{
  uint8_t PtagUint8_14;

  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "MR_mktag(");
  PtagUint8_14 = (uint8_t) (Ptag_6);
  mercury__io__write_uint8_4_p_0(Stream_5, PtagUint8_14);
  ...
  MR_Word Lval_8)
{
  ...
  {
    MR_Word Var_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), ActualType_10, (MR_Integer) 0))) & (MR_Integer) 15);
  ...
  MR_String * Name_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg1_6, (MR_Integer) 1))));
      succeeded = ((((MR_tag((MR_Word) Var_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 0)))) == (MR_Integer) 9)));
      if (succeeded)
        Float_17 = MR_unbox_float((MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 1)));
    }
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Op_18 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg1_6, (MR_Integer) 1))));
        Arg1_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg1_6, (MR_Integer) 2))));
        Arg2_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg1_6, (MR_Integer) 3))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg2_7, (MR_Integer) 1))));
        succeeded = ((((MR_tag((MR_Word) Var_43)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_43, (MR_Integer) 0)))) == (MR_Integer) 9)));
        if (succeeded)
          Float_39 = MR_unbox_float((MR_hl_field(MR_mktag(3), Var_43, (MR_Integer) 1)));
      }
      if (succeeded)
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          Op_40 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg2_7, (MR_Integer) 1))));
          Arg1_41 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg2_7, (MR_Integer) 2))));
          Arg2_42 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Arg2_7, (MR_Integer) 3))));
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(DesiredType_9)) {
        ...
        case (MR_Integer) 0:
          ...
          {
            MR_Word Var_65 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), ActualType_12, (MR_Integer) 0))) & (MR_Integer) 15);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          Var_64 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), DesiredType_9, (MR_Integer) 0))) & (MR_Integer) 15);
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      MR_Word IntType_75 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), DesiredType_9, (MR_Integer) 0))) & (MR_Integer) 15);
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(Op_16)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, SubRvalA_17, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_data_scalar_common_1[1])), Stream_8);
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) " ");
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "&&");
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) " ");
                  ...
                  case (MR_Integer) 11:
                    {
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, SubRvalA_17, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_data_scalar_common_1[2])), Stream_8);
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) " < ");
                      ll_backend__llds_out__llds_out_data__output_rval_as_type_6_p_0(Info_6, SubRvalB_18, (MR_Word) (MR_mkword(MR_mktag(2), &ll_backend__llds_out__llds_out_data_scalar_common_1[2])), Stream_8);
                      mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
                    }
                    break;
                  case (MR_Integer) 12:
  ...
  MR_Word IsPtr_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 1))));
        succeeded = ((((MR_tag((MR_Word) Var_76)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_76, (MR_Integer) 0)))) == (MR_Integer) 7)));
        if (succeeded)
        {
          UInt64_75 = MR_unbox_uint64((MR_hl_field(MR_mktag(3), Var_76, (MR_Integer) 1)));
          UInt64Name_14 = mercury__string__uint64_to_string_1_f_0(UInt64_75);
          succeeded = MR_TRUE;
        }
      }
    }
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Int64Name0_77 = mercury__string__int64_to_string_1_f_0(Int64_75);
          Var_78 = (MR_String) "-";
          Var_79 = (MR_String) "neg";
          mercury__string__replace_all_4_p_0(Int64Name0_77, Var_78, Var_79, &Int64Name_14);
          succeeded = MR_TRUE;
        }
      }
    }
  ...
  MR_Word IsPtr_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 1))));
        succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0)))) == (MR_Integer) 9)));
        if (succeeded)
          Float_75 = MR_unbox_float((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 1)));
      }
      if (succeeded)
      {
        MR_String FloatName0_80;
        MR_String FloatName1_81;
        MR_String FloatName2_82;

        FloatName0_80 = backend_libs__c_util__make_float_literal_1_f_0(Float_75);
        mercury__string__replace_all_4_p_0(FloatName0_80, (MR_String) ".", (MR_String) "pt", &FloatName1_81);
        mercury__string__replace_all_4_p_0(FloatName1_81, (MR_String) "+", (MR_String) "plus", &FloatName2_82);
        mercury__string__replace_all_4_p_0(FloatName2_82, (MR_String) "-", (MR_String) "neg", &FloatName_14);
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        MR_Word Arg2_78;
        MR_String OpName_89;
        MR_String Arg1Name_90;
        MR_String Arg2Name_91;
        MR_String Var_92;
        MR_String Var_93;
        MR_String Var_94;
        MR_String Var_95;
        ...
        succeeded = ((((MR_tag((MR_Word) Rval_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 0)))) == (MR_Integer) 4)));
        if (succeeded)
        {
          Op_76 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 1))));
          Arg1_77 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 2))));
          Arg2_78 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_9, (MR_Integer) 3))));
          succeeded = ll_backend__llds_out__llds_out_data__float_op_name_2_p_0(Op_76, &OpName_89);
          if (succeeded)
          {
            succeeded = ll_backend__llds_out__llds_out_data__float_const_expr_name_2_p_0(Arg1_77, &Arg1Name_90);
            if (succeeded)
            {
              succeeded = ll_backend__llds_out__llds_out_data__float_const_expr_name_2_p_0(Arg2_78, &Arg2Name_91);
              if (succeeded)
              {
                Var_93 = (MR_String) "_";
                Var_96 = (MR_String) "_";
                Var_95 = mercury__string__f_43_43_2_f_0(Var_96, Arg2Name_91);
                Var_94 = mercury__string__f_43_43_2_f_0(Arg1Name_90, Var_95);
                Var_92 = mercury__string__f_43_43_2_f_0(Var_93, Var_94);
                FloatName_14 = mercury__string__f_43_43_2_f_0(OpName_89, Var_92);
                succeeded = MR_TRUE;
              }
            }
          }
        ...
        case (MR_Integer) 9:
          {
            ...
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            ll_backend__llds_out__llds_out_data__output_llds_type_4_p_0(Stream_8, (MR_Word) ((MR_Unsigned) 4U));
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) ") ");
