    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 286, &UnboxedFloat_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 287, &UnboxedInt64s_11);
