  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), FieldLval_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[12])));
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  ...
  {
    Assign_25 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Assign_25, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_4[3])));
    MR_hl_field(MR_mktag(2), Assign_25, 1) = ((MR_Box) (Value_6));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    *Stmt_8 = base;
    MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Assign_25));
    MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Context_7));
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Integer VarNumber_15;

    parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_1, Var_6, &VarEntry_10);
    VarName_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), VarEntry_10, (MR_Integer) 0))));
    mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_6, &VarNumber_15);
    {
      ...
      MR_hl_field(MR_mktag(1), MLDSVarName_8, 1) = ((MR_Box) (VarNumber_15));
    }
    ...
    case (MR_Integer) 1:
      {
        ...
        VarName_27 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_13, (MR_Integer) 0))));
        mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_6, &VarNumber_28);
        {
          VarName_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), VarName_14, 0) = ((MR_Box) (VarName_27));
          MR_hl_field(MR_mktag(1), VarName_14, 1) = ((MR_Box) (VarNumber_28));
        }
        {
  ...
  MR_Word * Lval_8)
{
  ...
  {
    MR_Word Type_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_7, (MR_Integer) 1))));
    MR_Word IsDummy_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_7, (MR_Integer) 2))) & (MR_Integer) 1);
    MR_Word MLDS_Type_20;
    MR_Word ModuleInfo_30;

    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(Info_5, &ModuleInfo_30);
    MLDS_Type_20 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ModuleInfo_30, Type_18);
    switch (IsDummy_19) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          ...
          Var_24 = ml_backend__mlds__global_dummy_var_0_f_0();
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Lval_8 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MLDS_Type_20));
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word VarName_21;
          MR_Word VarLval_22;
          MR_Word ByRefOutputVars_23;
          MR_String VarName_34 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_7, (MR_Integer) 0))));
          MR_Integer VarNumber_35;

          mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_6, &VarNumber_35);
          {
            VarName_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), VarName_21, 0) = ((MR_Box) (VarName_34));
            MR_hl_field(MR_mktag(1), VarName_21, 1) = ((MR_Box) (VarNumber_35));
          }
          {
            VarLval_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), VarLval_22, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), VarLval_22, 1) = ((MR_Box) (VarName_21));
            MR_hl_field(MR_mktag(3), VarLval_22, 2) = ((MR_Box) (MLDS_Type_20));
          }
          ml_backend__ml_gen_info__ml_gen_info_get_byref_output_vars_2_p_0(Info_5, &ByRefOutputVars_23);
          succeeded = parse_tree__set_of_var__member_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ByRefOutputVars_23, Var_6);
          if (succeeded)
          {
            MR_Word Var_25;

            {
              ...
              MR_hl_field(MR_mktag(2), Var_25, 0) = ((MR_Box) (VarLval_22));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_8 = base;
              ...
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MLDS_Type_20));
            }
          }
          else
            *Lval_8 = VarLval_22;
  ...
  MR_Word * Lval_6)
{
  ...
  else
  {
    ...
    Type_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 1))));
    IsDummy_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 2))) & (MR_Integer) 1);
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(Info_4, &ModuleInfo_30);
    MLDS_Type_20 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ModuleInfo_30, Type_18);
    switch (IsDummy_19) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word VarLval_22;
          MR_Word ByRefOutputVars_23;
          MR_String VarName_34 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_10, (MR_Integer) 0))));
          MR_Integer VarNumber_35;

          mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_5, &VarNumber_35);
          {
            VarName_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), VarName_21, 0) = ((MR_Box) (VarName_34));
            MR_hl_field(MR_mktag(1), VarName_21, 1) = ((MR_Box) (VarNumber_35));
          ...
          ml_backend__ml_gen_info__ml_gen_info_get_byref_output_vars_2_p_0(Info_4, &ByRefOutputVars_23);
          succeeded = parse_tree__set_of_var__member_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ByRefOutputVars_23, Var_5);
          if (succeeded)
          {
            MR_Word Var_25;
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_gen_test_success_3_p_0(&Succeeded_24, STATE_VARIABLE_Info_37_37, &STATE_VARIABLE_Info_38_38);
  ...
  MR_Word * MLDS_Module_8)
{
  ...
  else
  {
    ...
    MR_Word ArgTypes_54;
    MR_Word ArgVars_55;
    MR_Word TopFunctorModes_56;
    MR_Word RetTopFunctorMode_58;
    MR_Word RetArgType_60;
    MR_Word Var_62;
    MR_Word Var_63;
    MR_Word Var_64;
    MR_Word _InputTopFunctorModes_57;
    MR_Box conv0_RetTopFunctorMode_58;
    MR_Word _InputArgTypes_59;
    MR_Box conv1_RetArgType_60;
    MR_Word _InputArgVars_61;
    MR_Box conv2_Var_33;
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_5, Var_42, &PredInfo_51, &ProcInfo_52);
      Var_62 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_51);
      succeeded = (Var_62 == (MR_Integer) 1);
      if (succeeded)
      {
        Var_63 = hlds__code_model__proc_info_interface_code_model_1_f_0(ProcInfo_52);
        succeeded = (Var_63 == (MR_Integer) 0);
        if (succeeded)
        {
          hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_52, &Modes_53);
          hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo_51, &ArgTypes_54);
          hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_52, &ArgVars_55);
          check_hlds__mode_top_functor__modes_to_top_functor_modes_4_p_0(ModuleInfo_5, Modes_53, ArgTypes_54, &TopFunctorModes_56);
          TypeCtorInfo_21_65 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_top_functor_mode_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo_21_65, TopFunctorModes_56, &_InputTopFunctorModes_57, &conv0_RetTopFunctorMode_58);
          RetTopFunctorMode_58 = ((MR_Word) (conv0_RetTopFunctorMode_58));
          TypeCtorInfo_22_66 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo_22_66, ArgTypes_54, &_InputArgTypes_59, &conv1_RetArgType_60);
          RetArgType_60 = ((MR_Word) (conv1_RetArgType_60));
          TypeInfo_23_67 = (MR_Word) (&ml_backend__ml_code_util_scalar_common_1[3]);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeInfo_23_67, ArgVars_55, &_InputArgVars_61, &conv2_Var_33);
          succeeded = (RetTopFunctorMode_58 == (MR_Integer) 1);
          if (succeeded)
          {
            Var_64 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_5, RetArgType_60);
