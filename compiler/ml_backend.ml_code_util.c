    ...
    case (MR_Integer) 0:
      {
        ...
        Var_18 = ml_backend__mlds__global_dummy_var_0_f_0();
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          *Lval_8 = base;
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), Var_17, 0) = ((MR_Box) (VarLval_15));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_21 = ml_backend__mlds__global_dummy_var_0_f_0();
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Lval_8 = base;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(2), Var_20, 0) = ((MR_Box) (VarLval_18));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_set_used_succeeded_var_3_p_0((MR_Integer) 1, STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_51_51);
