...
static MR_Word MR_CALL 
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_proc_params_from_rtti__909__1_1_f_0(
  MR_Word ml_backend__ml_code_util__LambdaHeadVar__1_20);

static MR_Word MR_CALL 
ml_backend__ml_code_util__IntroducedFrom__func__ml_append_return_statement__579__1_1_f_0(
...
static void MR_CALL 
ml_backend__ml_code_util__ml_gen_arg_decls_9_p_1(
  MR_Word ml_backend__ml_code_util__ModuleInfo_10,
  MR_Word ml_backend__ml_code_util__Vars_11,
  MR_Word ml_backend__ml_code_util__Types_12,
  MR_Word ml_backend__ml_code_util__Modes_13,
  ...
  MR_Word ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_0_30,
  MR_Word * ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31);
...
static /* final */ const MR_Box ml_backend__ml_code_util_scalar_common_1[25][2] = {
  ...
  /* row 10 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[9]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 11 */
  {
...
static /* final */ const MR_Box ml_backend__ml_code_util_scalar_common_2[8][3] = {
  ...
  /* row 4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[8]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7)))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 5 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[16]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7)))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 6 */
...
{
  {
    ...
    ml_backend__ml_code_util__MLDS_ModuleName_34 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ml_backend__ml_code_util__ModuleName_33);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_35, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[15])));
    }
    {
    ...
    ml_backend__ml_code_util__MLDS_ModuleName_42 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ml_backend__ml_code_util__ModuleName_41);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_43, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[16])));
    }
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadVar__2_2, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[7])));
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_success_lval_3_p_0(&ml_backend__ml_code_util__Succeeded_26, ml_backend__ml_code_util__STATE_VARIABLE_Info_0_11, ml_backend__ml_code_util__STATE_VARIABLE_Info_12);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__SetSuccessFalse_10, 1) = ((MR_Box) (ml_backend__ml_code_util__Assign_32));
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_success_lval_3_p_0(&ml_backend__ml_code_util__Succeeded_26, ml_backend__ml_code_util__STATE_VARIABLE_Info_0_12, ml_backend__ml_code_util__STATE_VARIABLE_Info_13);
        {
          ml_backend__ml_code_util__Assign_32 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ml_backend__ml_code_util__Assign_32, 0) = ((MR_Box) (ml_backend__ml_code_util__Succeeded_26));
          MR_hl_field(MR_mktag(2), ml_backend__ml_code_util__Assign_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[23])));
        }
        {
...
{
  {
    ...
    ml_backend__ml_code_util__conv0_LambdaHeadVar__2_27 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1872__1_1_f_0(((MR_Word) ml_backend__ml_code_util__wrapper_arg_1));
      ...
      case (MR_Integer) 0:
        {
          ...
          ml_backend__ml_code_util__ArgTypes_16 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, ml_backend__ml_code_util__ArgTypes0_11, (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[12]));
          {
...
{
  {
    ...
    ml_backend__ml_code_util__ml_gen_local_var_lval_4_p_0(ml_backend__ml_code_util__STATE_VARIABLE_Info_0_34, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[20]), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)), &ml_backend__ml_code_util__ClosureLayoutPtrLval_16);
    ml_backend__ml_code_util__ml_gen_local_var_lval_4_p_0(ml_backend__ml_code_util__STATE_VARIABLE_Info_0_34, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[21]), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)), &ml_backend__ml_code_util__TypeParamsLval_19);
    ml_backend__ml_code_util__TypeInfoName_20 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[22]);
...
{
  {
    return (MR_Word) &ml_backend__ml_code_util_scalar_common_1[19];
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          ml_backend__ml_code_util__MLDS_Type_13 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ml_backend__ml_code_util__ModuleInfo_28, ml_backend__ml_code_util__Type_7);
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__Var_19, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[18])));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    ml_backend__ml_code_util__conv0_LambdaHeadVar__2_21 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_proc_params_from_rtti__909__1_1_f_0(((MR_Word) ml_backend__ml_code_util__wrapper_arg_1));
...
{
  {
    ...
    ml_backend__ml_code_util__CodeModel_18 = hlds__code_model__proc_info_interface_code_model_1_f_0(ml_backend__ml_code_util__ProcInfo_12);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__Var_28, 0) = ((MR_Box) (&ml_backend__ml_code_util_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__Var_28, 1) = ((MR_Box) (ml_backend__ml_code_util__ml_gen_info_proc_params_5_p_0_1));
...
{
  {
    ...
    MR_Word ml_backend__ml_code_util__Var_21;
    MR_Word ml_backend__ml_code_util__Globals_33;
    MR_Word ml_backend__ml_code_util__FuncArgs_41;
    MR_Word ml_backend__ml_code_util__RetTypes_47;
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ml_backend__ml_code_util__ModuleInfo_16, &ml_backend__ml_code_util__Globals_33);
    switch (ml_backend__ml_code_util__CodeModel_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 1:
        {
          MR_Word ml_backend__ml_code_util__CopyOut_34;
          MR_Word ml_backend__ml_code_util__FuncArgs0_35;
          MR_Word ml_backend__ml_code_util__RetTypes0_36;

          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_code_util__Globals_33, (MR_Integer) 267, &ml_backend__ml_code_util__CopyOut_34);
          ml_backend__ml_code_util__ml_gen_arg_decls_9_p_1(ml_backend__ml_code_util__ModuleInfo_16, ml_backend__ml_code_util__HeadVarNames_9, ml_backend__ml_code_util__HeadTypes_10, ml_backend__ml_code_util__TopFunctorModes_17, ml_backend__ml_code_util__CopyOut_34, &ml_backend__ml_code_util__FuncArgs0_35, &ml_backend__ml_code_util__RetTypes0_36, ml_backend__ml_code_util__Var_21, &ml_backend__ml_code_util__MaybeInfo_18);
          switch (ml_backend__ml_code_util__CodeModel_13) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word ml_backend__ml_code_util__TypeCtorInfo_60_73;
                MR_Word ml_backend__ml_code_util__TypeCtorInfo_61_74;
                MR_Word ml_backend__ml_code_util__ResultMode_38;
                MR_Word ml_backend__ml_code_util__ResultType_40;
                MR_Word ml_backend__ml_code_util__Var_68;
                MR_Word ml_backend__ml_code_util__Var_37;
                MR_Box ml_backend__ml_code_util__conv0_ResultMode_38;
                MR_Word ml_backend__ml_code_util__Var_39;
                MR_Box ml_backend__ml_code_util__conv1_ResultType_40;

                ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__RetTypes0_36 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (ml_backend__ml_code_util__succeeded)
                {
                  ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__PredOrFunc_12 == (MR_Integer) 1);
                  if (ml_backend__ml_code_util__succeeded)
                  {
                    ml_backend__ml_code_util__TypeCtorInfo_60_73 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_top_functor_mode_0;
                    parse_tree__prog_util__pred_args_to_func_args_3_p_0(ml_backend__ml_code_util__TypeCtorInfo_60_73, ml_backend__ml_code_util__TopFunctorModes_17, &ml_backend__ml_code_util__Var_37, &ml_backend__ml_code_util__conv0_ResultMode_38);
                    ml_backend__ml_code_util__ResultMode_38 = ((MR_Word) ml_backend__ml_code_util__conv0_ResultMode_38);
                    ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__ResultMode_38 == (MR_Integer) 1);
                    if (ml_backend__ml_code_util__succeeded)
                    {
                      ml_backend__ml_code_util__TypeCtorInfo_61_74 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
                      parse_tree__prog_util__pred_args_to_func_args_3_p_0(ml_backend__ml_code_util__TypeCtorInfo_61_74, ml_backend__ml_code_util__HeadTypes_10, &ml_backend__ml_code_util__Var_39, &ml_backend__ml_code_util__conv1_ResultType_40);
                      ml_backend__ml_code_util__ResultType_40 = ((MR_Word) ml_backend__ml_code_util__conv1_ResultType_40);
                      ml_backend__ml_code_util__Var_68 = check_hlds__type_util__check_dummy_type_2_f_0(ml_backend__ml_code_util__ModuleInfo_16, ml_backend__ml_code_util__ResultType_40);
                      ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__Var_68 == (MR_Integer) 1);
                    }
                  }
                }
                if (ml_backend__ml_code_util__succeeded)
                {
                  MR_Word ml_backend__ml_code_util__RetArg_42;
                  MR_Word ml_backend__ml_code_util__RetTypePtr_44;
                  MR_Box ml_backend__ml_code_util__conv2_RetArg_42;
                  MR_Word ml_backend__ml_code_util___RetArgName_43;
                  MR_Word ml_backend__ml_code_util___GCStmt_45;
                  MR_Word ml_backend__ml_code_util__RetType_46;

                  parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0, ml_backend__ml_code_util__FuncArgs0_35, &ml_backend__ml_code_util__FuncArgs_41, &ml_backend__ml_code_util__conv2_RetArg_42);
                  ml_backend__ml_code_util__RetArg_42 = ((MR_Word) ml_backend__ml_code_util__conv2_RetArg_42);
                  ml_backend__ml_code_util___RetArgName_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__RetArg_42, (MR_Integer) 0)));
                  ml_backend__ml_code_util__RetTypePtr_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__RetArg_42, (MR_Integer) 1)));
                  ml_backend__ml_code_util___GCStmt_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__RetArg_42, (MR_Integer) 2)));
                  ml_backend__ml_code_util__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_code_util__RetTypePtr_44)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__RetTypePtr_44, (MR_Integer) 0)))) == (MR_Integer) 6)));
                  if (ml_backend__ml_code_util__succeeded)
                  {
                    ml_backend__ml_code_util__RetType_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__RetTypePtr_44, (MR_Integer) 1)));
                    {
                      ml_backend__ml_code_util__RetTypes_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__RetTypes_47, 0) = ((MR_Box) (ml_backend__ml_code_util__RetType_46));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__RetTypes_47, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    }
                  }
                  else
                  {
                ...
                {
                  ml_backend__ml_code_util__FuncArgs_41 = ml_backend__ml_code_util__FuncArgs0_35;
                  ml_backend__ml_code_util__RetTypes_47 = ml_backend__ml_code_util__RetTypes0_36;
                }
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                {
                  ml_backend__ml_code_util__RetTypes_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__RetTypes_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__RetTypes_47, 1) = ((MR_Box) (ml_backend__ml_code_util__RetTypes0_36));
                }
              }
              break;
          }
      ...
      case (MR_Integer) 2:
        {
          MR_Word ml_backend__ml_code_util__ContType_48;
          MR_Word ml_backend__ml_code_util__ContArg_51;
          MR_Word ml_backend__ml_code_util__NestedFunctions_56;
          MR_Word ml_backend__ml_code_util__CopyOut_83;
          MR_Word ml_backend__ml_code_util__FuncArgs0_84;
          MR_Word ml_backend__ml_code_util__RetTypes0_85;

          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_code_util__Globals_33, (MR_Integer) 268, &ml_backend__ml_code_util__CopyOut_83);
          ml_backend__ml_code_util__ml_gen_arg_decls_9_p_1(ml_backend__ml_code_util__ModuleInfo_16, ml_backend__ml_code_util__HeadVarNames_9, ml_backend__ml_code_util__HeadTypes_10, ml_backend__ml_code_util__TopFunctorModes_17, ml_backend__ml_code_util__CopyOut_83, &ml_backend__ml_code_util__FuncArgs0_84, &ml_backend__ml_code_util__RetTypes0_85, ml_backend__ml_code_util__Var_21, &ml_backend__ml_code_util__MaybeInfo_18);
          switch (ml_backend__ml_code_util__CopyOut_83) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ml_backend__ml_code_util__ContType_48 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[14]);
                ml_backend__ml_code_util__RetTypes_47 = ml_backend__ml_code_util__RetTypes0_85;
              }
              break;
            case (MR_Integer) 1:
              {
                {
                  ml_backend__ml_code_util__ContType_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__ContType_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__ContType_48, 1) = ((MR_Box) (ml_backend__ml_code_util__RetTypes0_85));
                }
                ml_backend__ml_code_util__RetTypes_47 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              }
              break;
          }
          {
            ml_backend__ml_code_util__ContArg_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__ContArg_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[15])));
            MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__ContArg_51, 1) = ((MR_Box) (ml_backend__ml_code_util__ContType_48));
            MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__ContArg_51, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_code_util__Globals_33, (MR_Integer) 266, &ml_backend__ml_code_util__NestedFunctions_56);
          switch (ml_backend__ml_code_util__NestedFunctions_56) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word ml_backend__ml_code_util__Var_62;
                ...
                {
                  ml_backend__ml_code_util__Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Var_62, 0) = ((MR_Box) (ml_backend__ml_code_util__ContArg_51));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[17])));
                }
                ml_backend__ml_code_util__FuncArgs_41 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0, ml_backend__ml_code_util__FuncArgs0_84, ml_backend__ml_code_util__Var_62);
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                {
                  ml_backend__ml_code_util__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Var_65, 0) = ((MR_Box) (ml_backend__ml_code_util__ContArg_51));
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                ml_backend__ml_code_util__FuncArgs_41 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0, ml_backend__ml_code_util__FuncArgs0_84, ml_backend__ml_code_util__Var_65);
              }
              break;
          }
        }
    ...
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *ml_backend__ml_code_util__FuncParams_14 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ml_backend__ml_code_util__FuncArgs_41));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ml_backend__ml_code_util__RetTypes_47));
    }
...
{
  {
    MR_bool ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__Vars_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));

    if (ml_backend__ml_code_util__succeeded)
    {
      ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__Types_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      if (ml_backend__ml_code_util__succeeded)
        ml_backend__ml_code_util__succeeded = (ml_backend__ml_code_util__Modes_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    if (ml_backend__ml_code_util__succeeded)
    {
      ...
      *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_0_30;
    }
    else
    {
      MR_Word ml_backend__ml_code_util__HeadVar_18;
      MR_Word ml_backend__ml_code_util__TailVars_19;
      MR_Word ml_backend__ml_code_util__HeadType_20;
      MR_Word ml_backend__ml_code_util__TailTypes_21;
      MR_Word ml_backend__ml_code_util__HeadMode_22;
      MR_Word ml_backend__ml_code_util__TailModes_23;

      ml_backend__ml_code_util__succeeded = ((MR_tag((MR_Word) ml_backend__ml_code_util__Vars_11)) == (MR_mktag((MR_Integer) 1)));
      if (ml_backend__ml_code_util__succeeded)
      {
        ml_backend__ml_code_util__HeadVar_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Vars_11, (MR_Integer) 0)));
        ml_backend__ml_code_util__TailVars_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Vars_11, (MR_Integer) 1)));
        ml_backend__ml_code_util__succeeded = ((MR_tag((MR_Word) ml_backend__ml_code_util__Types_12)) == (MR_mktag((MR_Integer) 1)));
        if (ml_backend__ml_code_util__succeeded)
        {
          ml_backend__ml_code_util__HeadType_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Types_12, (MR_Integer) 0)));
          ml_backend__ml_code_util__TailTypes_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Types_12, (MR_Integer) 1)));
          ml_backend__ml_code_util__succeeded = ((MR_tag((MR_Word) ml_backend__ml_code_util__Modes_13)) == (MR_mktag((MR_Integer) 1)));
          if (ml_backend__ml_code_util__succeeded)
          {
            ml_backend__ml_code_util__HeadMode_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Modes_13, (MR_Integer) 0)));
            ml_backend__ml_code_util__TailModes_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Modes_13, (MR_Integer) 1)));
          }
        }
      }
      if (ml_backend__ml_code_util__succeeded)
      {
        MR_Word ml_backend__ml_code_util__TailFuncArgs_24;
        MR_Word ml_backend__ml_code_util__TailRetTypes_25;
        MR_Word ml_backend__ml_code_util__HeadIsDummy_26;
        MR_Word ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32;

        ml_backend__ml_code_util__ml_gen_arg_decls_9_p_1(ml_backend__ml_code_util__ModuleInfo_10, ml_backend__ml_code_util__TailVars_19, ml_backend__ml_code_util__TailTypes_21, ml_backend__ml_code_util__TailModes_23, ml_backend__ml_code_util__CopyOut_14, &ml_backend__ml_code_util__TailFuncArgs_24, &ml_backend__ml_code_util__TailRetTypes_25, ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_0_30, &ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32);
        ml_backend__ml_code_util__HeadIsDummy_26 = check_hlds__type_util__check_dummy_type_2_f_0(ml_backend__ml_code_util__ModuleInfo_10, ml_backend__ml_code_util__HeadType_20);
        switch (ml_backend__ml_code_util__HeadIsDummy_26) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *ml_backend__ml_code_util__FuncArgs_15 = ml_backend__ml_code_util__TailFuncArgs_24;
              *ml_backend__ml_code_util__RetTypes_16 = ml_backend__ml_code_util__TailRetTypes_25;
              *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32;
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ml_backend__ml_code_util__HeadMLDS_Type_27;

              ml_backend__ml_code_util__HeadMLDS_Type_27 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ml_backend__ml_code_util__ModuleInfo_10, ml_backend__ml_code_util__HeadType_20);
              switch (ml_backend__ml_code_util__HeadMode_22) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Word ml_backend__ml_code_util__HeadFuncArg_39;
                    MR_Word ml_backend__ml_code_util__Info0_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32, (MR_Integer) 0)));
                    MR_Word ml_backend__ml_code_util__Context_48;
                    MR_Word ml_backend__ml_code_util__GCStmt_49;
                    MR_Word ml_backend__ml_code_util__Info_50;

                    mercury__term__context_init_1_p_0(&ml_backend__ml_code_util__Context_48);
                    ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(ml_backend__ml_code_util__HeadVar_18, ml_backend__ml_code_util__HeadType_20, ml_backend__ml_code_util__Context_48, &ml_backend__ml_code_util__GCStmt_49, ml_backend__ml_code_util__Info0_47, &ml_backend__ml_code_util__Info_50);
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_code_util__Info_50));
                    }
                    {
                      ml_backend__ml_code_util__HeadFuncArg_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadVar_18));
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 1) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_Type_27));
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 2) = ((MR_Box) (ml_backend__ml_code_util__GCStmt_49));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      *ml_backend__ml_code_util__FuncArgs_15 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadFuncArg_39));
                      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_code_util__TailFuncArgs_24));
                    }
                    *ml_backend__ml_code_util__RetTypes_16 = ml_backend__ml_code_util__TailRetTypes_25;
                  }
                  break;
                case (MR_Integer) 1:
                  switch (ml_backend__ml_code_util__CopyOut_14) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        MR_Word ml_backend__ml_code_util__HeadMLDS_ArgType_28;
                        MR_Word ml_backend__ml_code_util__HeadFuncArg_29;
                        MR_Word ml_backend__ml_code_util__Info0_60;
                        MR_Word ml_backend__ml_code_util__Context_61;
                        MR_Word ml_backend__ml_code_util__GCStmt_62;
                        MR_Word ml_backend__ml_code_util__Info_63;

                        {
                          ml_backend__ml_code_util__HeadMLDS_ArgType_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__HeadMLDS_ArgType_28, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_code_util__HeadMLDS_ArgType_28, 1) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_Type_27));
                        }
                        ml_backend__ml_code_util__Info0_60 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32, (MR_Integer) 0)));
                        mercury__term__context_init_1_p_0(&ml_backend__ml_code_util__Context_61);
                        ml_backend__ml_accurate_gc__ml_gen_gc_statement_6_p_0(ml_backend__ml_code_util__HeadVar_18, ml_backend__ml_code_util__HeadType_20, ml_backend__ml_code_util__Context_61, &ml_backend__ml_code_util__GCStmt_62, ml_backend__ml_code_util__Info0_60, &ml_backend__ml_code_util__Info_63);
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                          *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = base;
                          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_code_util__Info_63));
                        }
                        {
                          ml_backend__ml_code_util__HeadFuncArg_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadVar_18));
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 1) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_ArgType_28));
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 2) = ((MR_Box) (ml_backend__ml_code_util__GCStmt_62));
                        }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          *ml_backend__ml_code_util__FuncArgs_15 = base;
                          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadFuncArg_29));
                          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_code_util__TailFuncArgs_24));
                        }
                        *ml_backend__ml_code_util__RetTypes_16 = ml_backend__ml_code_util__TailRetTypes_25;
                      }
                        ...
                        *ml_backend__ml_code_util__FuncArgs_15 = ml_backend__ml_code_util__TailFuncArgs_24;
                        {
                          ...
                          *ml_backend__ml_code_util__RetTypes_16 = base;
                          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_Type_27));
                          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_code_util__TailRetTypes_25));
                        }
                        *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32;
                      }
                      break;
...
{
  {
    ...
    ml_backend__ml_code_util__CodeModel_16 = hlds__code_model__proc_info_interface_code_model_1_f_0(ml_backend__ml_code_util__ProcInfo_10);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__Var_20, 0) = ((MR_Box) (&ml_backend__ml_code_util_scalar_common_6[0]));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_code_util__Globals_18, (MR_Integer) 268, &ml_backend__ml_code_util__CopyOut_70);
          ...
          switch (ml_backend__ml_code_util__CopyOut_70) {
            ...
            case (MR_Integer) 0:
              {
                ml_backend__ml_code_util__ContType_33 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[14]);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__ContArg_36, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[15])));
          ...
          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_code_util__Globals_18, (MR_Integer) 266, &ml_backend__ml_code_util__NestedFunctions_41);
            ...
            case (MR_Integer) 0:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), ml_backend__ml_code_util__Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[17])));
                }
...
{
  {
    ...
    else
    {
      ...
      if (ml_backend__ml_code_util__succeeded)
      {
        ...
        ml_backend__ml_code_util__ml_gen_arg_decls_9_p_0(ml_backend__ml_code_util__ModuleInfo_10, ml_backend__ml_code_util__TailVars_19, ml_backend__ml_code_util__TailTypes_21, ml_backend__ml_code_util__TailModes_23, ml_backend__ml_code_util__CopyOut_14, &ml_backend__ml_code_util__TailFuncArgs_24, &ml_backend__ml_code_util__TailRetTypes_25, ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_0_30, &ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_32_32);
        ml_backend__ml_code_util__HeadIsDummy_26 = check_hlds__type_util__check_dummy_type_2_f_0(ml_backend__ml_code_util__ModuleInfo_10, ml_backend__ml_code_util__HeadType_20);
        switch (ml_backend__ml_code_util__HeadIsDummy_26) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                    {
                      ml_backend__ml_code_util__HeadFuncArg_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadVar_18));
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 1) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_Type_27));
                      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_39, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        *ml_backend__ml_code_util__STATE_VARIABLE_MaybeInfo_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                        {
                          ...
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 0) = ((MR_Box) (ml_backend__ml_code_util__HeadVar_18));
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 1) = ((MR_Box) (ml_backend__ml_code_util__HeadMLDS_ArgType_28));
                          MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__HeadFuncArg_29, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        }
                        {
                          MR_Word base;
                          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    ml_backend__ml_code_util__MLDS_ModuleName_13 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ml_backend__ml_code_util__ModuleName_12);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_14, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[13])));
    }
    {
...
{
  {
    ...
    if ((ml_backend__ml_code_util__MaybeParams_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      switch (ml_backend__ml_code_util__UseNestedFuncs_15) {
        ...
        case (MR_Integer) 0:
          {
            ml_backend__ml_code_util__ArgTypes_18 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[12]);
          }
          break;
        case (MR_Integer) 1:
...
{
  {
    ...
    ml_backend__ml_code_util__conv1_LambdaHeadVar__2_33 = ml_backend__ml_code_util__IntroducedFrom__func__ml_append_return_statement__579__1_1_f_0(((MR_Word) ml_backend__ml_code_util__wrapper_arg_1));
...
{
  {
    ...
    ml_backend__ml_code_util__conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_append_return_statement__588__1_1_f_0(((MR_Word) ml_backend__ml_code_util__wrapper_arg_1));
...
{
  {
    ...
    ml_backend__ml_code_util__MLDS_ModuleName_18 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ml_backend__ml_code_util__ModuleName_17);
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_19, 0) = ((MR_Box) (ml_backend__ml_code_util__MLDS_ModuleName_18));
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_19, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), ml_backend__ml_code_util__MLDS_Var_19, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[7])));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
