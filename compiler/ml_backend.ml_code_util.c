      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 264, &UnboxedFloat_10);
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 265, &UnboxedInt64s_11);
