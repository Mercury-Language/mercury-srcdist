    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_108, 0) = ((MR_Box) (MR_mkword(2, &ml_backend__ml_code_util_scalar_common_3[14])));
    ...
    case (MR_Integer) 2:
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_51, 0) = ((MR_Box) (MR_mkword(2, &ml_backend__ml_code_util_scalar_common_3[14])));
                ...
                else
                {
                  ...
                  else
                  {
                      ...
                      {
                        {
                          ...
                          succeeded = parse_tree__prog_type_test__type_ctor_is_array_1_p_0(SourceTypeCtor_24);
                          if (succeeded)
                          {
                        ...
                        if (!(succeeded))
                        {
                          ...
                          succeeded = parse_tree__prog_type_test__type_ctor_is_array_1_p_0(DestTypeCtor_26);
                          if (succeeded)
                          {
                    ...
                    else
                    {
                      ...
                      succeeded = parse_tree__prog_type_unify__type_unify_5_p_0(SourceType_8, DestType_9, (MR_Word) ((MR_Unsigned) 0U), Var_52, &Var_32);
                      succeeded = !(succeeded);
                      if (succeeded)
                      {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 292, &UnboxedFloat_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 293, &UnboxedInt64s_11);
