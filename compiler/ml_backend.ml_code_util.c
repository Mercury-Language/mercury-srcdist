...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1625__1_1_f_0(
...
{
  {
    ...
    conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1625__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_39 = (MR_Integer) 0;
          switch (MR_tag((MR_Word) Width_12)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(Width_12)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (MLDS_Type_11));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              IntType_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_46, (MR_Integer) 0)));
              switch (IntType_29) {
                default:
                  succeeded = MR_FALSE;
                  break;
              ...
              if (succeeded)
              {
                hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_9, &Globals_53);
                libs__globals__get_target_2_p_0(Globals_53, &Target_54);
                succeeded = (Target_54 == (MR_Integer) 0);
              }
            }
          }
        }
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word MLDS_ModuleName_56;
            MR_Word Initializer_57;
            MR_Word ConstAddrRval_58;

            hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_9, &ModuleName_55);
            MLDS_ModuleName_56 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_55);
            {
              Initializer_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Initializer_57, 0) = ((MR_Box) (Rval_13));
            }
            ml_backend__ml_global_data__ml_gen_static_scalar_const_addr_8_p_0(MLDS_ModuleName_56, ConstVarKind_32, MLDS_Type_11, Initializer_57, Context_10, &ConstAddrRval_58, STATE_VARIABLE_GlobalData_0_34, STATE_VARIABLE_GlobalData_35);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              *BoxedRval_14 = base;
              MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_code_util_scalar_common_3[9])));
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (ConstAddrRval_58));
            }
          }
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (MLDS_Type_11));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (MLDS_Type_11));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 256, &UnboxedFloat_10);
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 257, &UnboxedInt64s_11);
          succeeded = ((MR_tag((MR_Word) Category_9)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(1), Category_9, (MR_Integer) 0)));
