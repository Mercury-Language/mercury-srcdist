    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(3, &ml_backend__ml_code_util_scalar_common_1[17])), Context_7, &SetSuccessFalse_10, STATE_VARIABLE_Info_0_11, STATE_VARIABLE_Info_12);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_8 = base;
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(3, &ml_backend__ml_code_util_scalar_common_1[16])), Context_7, &SetSuccessTrue_10, STATE_VARIABLE_Info_0_12, STATE_VARIABLE_Info_13);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_8 = base;
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 287, &UnboxedFloat_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 288, &UnboxedInt64s_11);
    ...
    case (MR_Integer) 1:
      {
        ...
        *STATE_VARIABLE_Info_34 = ((MR_Word) (conv26_STATE_VARIABLE_Info_34));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            SingleStmt_92 = ((MR_Word) ((MR_hl_field(1, RestStmts_65, (MR_Integer) 0))));
            Var_93 = ((MR_Word) ((MR_hl_field(1, RestStmts_65, (MR_Integer) 1))));
            succeeded = (Var_93 == (MR_Word) ((MR_Unsigned) 0U));
          }
        }
        if (succeeded)
          ThenStmt_25 = SingleStmt_92;
        else
          {
