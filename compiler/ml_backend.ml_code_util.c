...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1599__1_1_f_0(
...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[2]), (MR_Word) (&ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_ground_term_0), FinalConstVarMap_4, ((MR_Box) (Var_5)), &conv0_GroundTerm_7);
...
{
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[2]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), Var_19, Vars_6, Soln_8);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1599__1_1_f_0(((MR_Word) (wrapper_arg_1)));
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        Var_52 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0));
...
{
  {
    ...
    {
      FieldVarName_6 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    return (MR_Word) (&ml_backend__ml_code_util_scalar_common_1[16]);
  }
}
...
{
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[2]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), VarLvals_7, ((MR_Box) (Var_5)), &conv0_VarLval_8);
    if (succeeded)
    {
      ...
      case (MR_Integer) 2:
        {
          ...
          *Stmts_16 = ((MR_Word) (conv12_Stmts_16));
          ...
          Var_41 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[0]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_41, STATE_VARIABLE_Info_40_40, &STATE_VARIABLE_Info_42_42);
          ...
          Var_46 = mercury__map__init_0_f_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[0]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0));
          ml_backend__ml_gen_info__ml_gen_info_set_packed_args_map_3_p_0(Var_46, STATE_VARIABLE_Info_45_45, STATE_VARIABLE_Info_34);
          succeeded = (RestLocalVarDefns_69 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          if (succeeded)
          {
            succeeded = (RestFuncDefns_70 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) RestStmts_71)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          *STATE_VARIABLE_Info_34 = ((MR_Word) (conv26_STATE_VARIABLE_Info_34));
          ThenStmt_25 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), RestStmts_65, Context_11);
          {
...
{
  {
    ...
    Var_22 = (MR_Word) (MR_mkword(MR_mktag(0), (MR_Word) (FuncName_15)));
    {
      ...
      *Func_12 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (&ml_backend__ml_code_util_scalar_common_1[8]));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_6, (MR_Integer) 10)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_6, (MR_Integer) 12)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_23_66 = (MR_Word) (&ml_backend__ml_code_util_scalar_common_1[2]);
