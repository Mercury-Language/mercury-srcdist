...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1518__1_1_f_0(
...
{
  {
    ...
    {
      LambdaHeadVar__2_29 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), LambdaHeadVar__2_29, 0) = ((MR_Box) (LambdaHeadVar__1_28));
    }
...
{
  {
    ...
    conv0_LambdaHeadVar__2_29 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1518__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    ArgTypes_13 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, ArgTypes0_11, (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[10]));
    TypeCtorInfo_35_35 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0;
    ArgRvals0_14 = mercury__list__map_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0, TypeCtorInfo_35_35, (MR_Word) &ml_backend__ml_code_util_scalar_common_4[6], ArgLvals0_12);
    {
      Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (EnvPtrRval_10));
      MR_hl_field(MR_mktag(1), Var_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ArgRvals_16 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_35_35, ArgRvals0_14, Var_30);
    {
      Signature_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Signature_18, 0) = ((MR_Box) (ArgTypes_13));
      MR_hl_field(MR_mktag(0), Signature_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    mercury__set__init_1_p_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_ml_call_marker_0, &Markers_21);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL));
      *Stmt_6 = base;
      MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Signature_18));
      ...
      MR_hl_field(MR_mktag(3), base, 6) = ((MR_Box) (Markers_21));
...
{
  {
    ...
    {
      Signature_15 = (MR_Word) &ml_backend__ml_code_util_scalar_common_1[11];
    }
    else
    {
    ...
    _PredId_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredProcId_11, (MR_Integer) 0)));
...
{
  {
    ml_backend__ml_code_util__ml_gen_label_func_6_p_0(Info_6, MaybeAux_7, (MR_Word) &ml_backend__ml_code_util_scalar_common_1[9], Context_8, Stmt_9, Func_10);
  }
}
