  ...
  MR_Word * MLDS_Module_8)
{
  ...
  else
  {
    ...
    MR_Word TypeCtorInfo__21_61;
    MR_Word TypeCtorInfo__22_62;
    MR_Word TypeInfo__23_63;
    MR_Word Var_41;
    MR_Word PredInfo_47;
    MR_Word ProcInfo_48;
    MR_Word Modes_49;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__21_61 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_top_functor_mode_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo__21_61, TopFunctorModes_52, &_InputTopFunctorModes_53, &conv0_RetTopFunctorMode_54);
          RetTopFunctorMode_54 = ((MR_Word) (conv0_RetTopFunctorMode_54));
          TypeCtorInfo__22_62 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo__22_62, ArgTypes_50, &_InputArgTypes_55, &conv1_RetArgType_56);
          RetArgType_56 = ((MR_Word) (conv1_RetArgType_56));
          TypeInfo__23_63 = (MR_Word) (&ml_backend__ml_code_util_scalar_common_1[3]);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeInfo__23_63, ArgVars_51, &_InputArgVars_57, &conv2_Var_33);
