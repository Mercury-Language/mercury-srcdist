...
MR_decl_label4(ml_backend__ml_code_util__ml_gen_call_current_success_cont_indirectly_4_0, 17,19,32,36)
...
MR_def_label(ml_backend__ml_code_util__ml_gen_local_for_output_arg_7_0,17)
	...
	MR_sv(8) = (MR_Word) MR_TAG_COMMON(1,0,10);
...
MR_BEGIN_MODULE(ml_backend__ml_code_util_module67)
	...
	MR_init_label4(ml_backend__ml_code_util__ml_gen_call_current_success_cont_indirectly_4_0,17,19,32,36)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_code_util__ml_gen_call_current_success_cont_indirectly_4_0,19)
	...
	MR_tfield(0, MR_tempr3, 2) = (MR_Word) MR_TAG_COMMON(0,0,15);
