              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_40, (MR_Integer) 0)));
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_41, (MR_Integer) 0)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 0)));
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_45, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if (((((MR_tag((MR_Word) MLDS_Type_11)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 0))) == (MR_Integer) 0))))
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word IntType_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_21, (MR_Integer) 0))) & (MR_Integer) 15);
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_21, (MR_Integer) 0)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_94, (MR_Integer) 0)));
...
{
  {
    return (MR_Word) (&ml_backend__ml_code_util_scalar_common_3[9]);
  }
}
...
{
  {
    ...
    Var_2 = parse_tree__builtin_lib_types__char_type_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 0) = ((MR_Box) ((MR_Unsigned) 0U));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ElemType_3)) == (MR_Integer) 0))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ElemType_3, (MR_Integer) 0)));
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_9 = parse_tree__builtin_lib_types__string_type_0_f_0();
            {
              ...
              MR_hl_field(MR_mktag(3), MLDS_Type_4, 0) = ((MR_Box) ((MR_Unsigned) 0U));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_22, (MR_Integer) 0)));
      SpecialPred_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_22, (MR_Integer) 0))) & (MR_Integer) 3);
    ...
    else
    {
      ...
      hlds__code_model__determinism_to_code_model_2_p_0(Detism_19, &CodeModel_35);
      {
        ...
        *MLDS_PredLabel_7 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (((((MR_Unsigned) (CodeModel_35) << (MR_Integer) 1)) | (MR_Unsigned) (NonOutputFunc_34)));
      }
    }
