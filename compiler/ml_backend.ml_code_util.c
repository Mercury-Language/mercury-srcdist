...
static /* final */ const MR_Box ml_backend__ml_code_util_scalar_common_1[27][2] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
    ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_code_util_scalar_common_3[10])))
  },
  /* row 22 */
  {
    ((MR_Box) ((MR_Unsigned) 24U)),
...
static /* final */ const MR_Box ml_backend__ml_code_util_scalar_common_4[8][3] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[26]))),
    ((MR_Box) ((MR_Unsigned) 24U))
  },
};
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), FieldLval_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[13])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FieldLval_21, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[13])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ContLval_9, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[25])));
    ...
    }
    {
      ...
      *Cont_6 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_code_util_scalar_common_3[12])));
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[24])), Context_7, &SetSuccessFalse_10, STATE_VARIABLE_Info_0_11, STATE_VARIABLE_Info_12);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_8 = base;
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_code_util__ml_gen_set_success_5_p_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_code_util_scalar_common_1[23])), Context_7, &SetSuccessTrue_10, STATE_VARIABLE_Info_0_12, STATE_VARIABLE_Info_13);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_8 = base;
...
{
  {
    ...
    ArgTypes_18 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), ArgTypes0_13, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_1[22])));
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_3[11]), ArgNum_10, &Var_142);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_116, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_code_util_scalar_common_3[9])));
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_3[11]), ArgNum_10, &Var_152);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_code_util_scalar_common_3[9])));
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 276, &UnboxedFloat_10);
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 277, &UnboxedInt64s_11);
