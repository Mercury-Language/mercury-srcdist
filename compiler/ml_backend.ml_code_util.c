...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[3]), (MR_Word) (&ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_ground_term_0), FinalConstVarMap_4, ((MR_Box) (Var_5)), &conv0_GroundTerm_7);
...
{
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&ml_backend__ml_code_util_scalar_common_1[3]), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), Var_19, Vars_6, Soln_8);
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_40, (MR_Integer) 0)));
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_41, (MR_Integer) 0)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 0)));
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_45, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if (((((MR_tag((MR_Word) MLDS_Type_11)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 0))) == (MR_Integer) 0))))
      {
        ...
        if (succeeded)
        {
          ...
          if (((MR_tag((MR_Word) BuiltinType_21)) == (MR_Integer) 1))
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_21, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            Initializer_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_94, (MR_Integer) 0)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ElemType_3)) == (MR_Integer) 0))
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ElemType_3, (MR_Integer) 0)));
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              MLDS_Type_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_6, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_6, (MR_Integer) 10)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_6, (MR_Integer) 12)));
    ...
    if (succeeded)
    {
      packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_22, (MR_Integer) 0)));
