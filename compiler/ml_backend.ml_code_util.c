  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_1, Var_6, &VarEntry_10);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_12, Var_6, &Entry_13);
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_25 = ml_backend__mlds__global_dummy_var_0_f_0();
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Lval_8 = base;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(2), Var_24, 0) = ((MR_Box) (VarLval_22));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * Lval_6)
{
  ...
  else
  {
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_9, Var_5, &Entry_10);
