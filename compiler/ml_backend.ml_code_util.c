...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1612__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1612__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * MLDS_Module_8)
{
  ...
  succeeded = ((MR_tag((MR_Word) Origin_22)) == (MR_Integer) 2);
  if (succeeded)
  {
    SpecialPred_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_22, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_26 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_22, (MR_Integer) 1))));
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          check_hlds__mode_top_functor__modes_to_top_functor_modes_4_p_0(ModuleInfo_5, Modes_52, ArgTypes_53, &TopFunctorModes_55);
