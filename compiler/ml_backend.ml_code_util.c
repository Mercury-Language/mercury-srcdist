...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1616__1_1_f_0(
...
{
  {
    ...
    conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1616__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    {
      MR_Word Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (((((MR_tag((MR_Word) MLDS_Type_11)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 0)))) == (MR_Integer) 0))))
      {
        ...
        MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 1)));
        MR_Word Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 2)));
        MR_Word Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_11, (MR_Integer) 3)));

        succeeded = ((MR_tag((MR_Word) Var_32)) == (MR_mktag((MR_Integer) 2)));
        if (succeeded)
        {
          BuiltinType_21 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_32, (MR_Integer) 0)));
          if ((BuiltinType_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ConstVarKind_20 = (MR_Integer) 1;
            succeeded = MR_TRUE;
          }
          else
          if (((MR_tag((MR_Word) BuiltinType_21)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word IntType_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), BuiltinType_21, (MR_Integer) 0)));
            ...
            switch (IntType_24) {
              ...
              case (MR_Integer) 8:
                {
                  ConstVarKind_20 = (MR_Integer) 2;
                  succeeded = MR_TRUE;
                }
                break;
              case (MR_Integer) 9:
                {
                  ConstVarKind_20 = (MR_Integer) 3;
                  succeeded = MR_TRUE;
                }
                break;
            }
      ...
      {
        Var_33 = (MR_Integer) 0;
        ml_backend__ml_global_data__ml_global_data_get_target_2_p_0(STATE_VARIABLE_GlobalData_0_29, &Var_42);
        succeeded = (Var_33 == Var_42);
      }
      if (succeeded)
      {
        MR_Word Var_36;

        switch (ConstVarKind_20) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              MR_Word Var_43;

              ml_backend__ml_global_data__ml_global_data_have_unboxed_floats_2_p_0(STATE_VARIABLE_GlobalData_0_29, &Var_43);
          ...
          case (MR_Integer) 3:
            {
              ...
              ml_backend__ml_global_data__ml_global_data_have_unboxed_int64s_2_p_0(STATE_VARIABLE_GlobalData_0_29, &Var_44);
        ...
        if (succeeded)
        {
          ...
          ml_backend__ml_global_data__ml_gen_static_scalar_const_addr_8_p_0(MLDS_ModuleName_26, ConstVarKind_20, MLDS_Type_11, Initializer_27, Context_10, &ConstAddrRval_28, STATE_VARIABLE_GlobalData_0_29, STATE_VARIABLE_GlobalData_30);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            *BoxedRval_14 = base;
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (MLDS_Type_11));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (MLDS_Type_11));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 257, &UnboxedFloat_10);
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 258, &UnboxedInt64s_11);
          ...
          if (succeeded)
          {
            ...
            switch (MR_tag((MR_Word) Var_94)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word IntType_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_94, (MR_Integer) 0)));
...
{
  {
    ...
    Var_2 = parse_tree__builtin_lib_types__char_type_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[8])));
    }
    return HeadVar__1_1;
  }
}
...
{
  {
    ...
    Var_2 = parse_tree__builtin_lib_types__int_type_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 1) = ((MR_Box) (Var_2));
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[7])));
    }
    return HeadVar__1_1;
  }
}
...
{
  {
    ...
    Var_2 = parse_tree__builtin_lib_types__string_type_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 1) = ((MR_Box) (Var_2));
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(3), HeadVar__1_1, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[5])));
    }
    return HeadVar__1_1;
  }
}
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_9 = parse_tree__builtin_lib_types__string_type_0_f_0();
            {
              ...
              MR_hl_field(MR_mktag(3), MLDS_Type_4, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              MR_hl_field(MR_mktag(3), MLDS_Type_4, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_code_util_scalar_common_3[5])));
            }
          }
          break;
      }
