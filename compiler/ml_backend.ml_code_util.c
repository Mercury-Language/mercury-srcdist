  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  FuncRval_9 = ((MR_Word) ((MR_hl_field(0, SuccCont_8, 0))));
  EnvPtrRval_10 = ((MR_Word) ((MR_hl_field(0, SuccCont_8, 1))));
  ArgTypesLvals0_11 = ((MR_Word) ((MR_hl_field(0, SuccCont_8, 2))));
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  switch (MR_tag((MR_Word) GCStmt0_26)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word CallTraceFuncCode_93 = ((MR_Word) ((MR_hl_field(1, GCStmt0_26, 0))));
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              Var_34 = ((MR_Word) ((MR_hl_field(2, SourceType_8, 0))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_33 = ((MR_Word) ((MR_hl_field(2, DestType_9, 0))));
            ...
            else
            {
              ...
              if (succeeded)
              {
                Var_38 = ((MR_Word) ((MR_hl_field(2, DestType_9, 0))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_37 = ((MR_Word) ((MR_hl_field(2, SourceType_8, 0))));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Var_40 = ((MR_Word) ((MR_hl_field(2, DestType_9, 0))));
                  succeeded = ((MR_tag((MR_Word) Var_40)) == (MR_Integer) 1);
                  if (succeeded)
                  {
                    IntType_23 = ((MR_Unsigned) ((MR_hl_field(1, Var_40, 0))) & (MR_Integer) 15);
                    switch (IntType_23) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Var_41 = ((MR_Word) ((MR_hl_field(2, SourceType_8, 0))));
                        succeeded = ((MR_tag((MR_Word) Var_41)) == (MR_Integer) 1);
                        if (succeeded)
                        {
                          Var_64 = ((MR_Unsigned) ((MR_hl_field(1, Var_41, 0))) & (MR_Integer) 15);
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    Var_44 = ((MR_Word) ((MR_hl_field(2, SourceType_8, 0))));
                    succeeded = ((MR_tag((MR_Word) Var_44)) == (MR_Integer) 1);
                    if (succeeded)
                    {
                      IntType_57 = ((MR_Unsigned) ((MR_hl_field(1, Var_44, 0))) & (MR_Integer) 15);
                      switch (IntType_57) {
                        default:
                          succeeded = MR_FALSE;
                          break;
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          Var_45 = ((MR_Word) ((MR_hl_field(2, DestType_9, 0))));
                          succeeded = ((MR_tag((MR_Word) Var_45)) == (MR_Integer) 1);
                          if (succeeded)
                          {
                            Var_65 = ((MR_Unsigned) ((MR_hl_field(1, Var_45, 0))) & (MR_Integer) 15);
                      ...
                      {
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              Var_47 = ((MR_Word) ((MR_hl_field(1, SourceTypeArgs_25, 0))));
                              Var_48 = ((MR_Word) ((MR_hl_field(1, SourceTypeArgs_25, 1))));
                        ...
                        if (!(succeeded))
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              Var_49 = ((MR_Word) ((MR_hl_field(1, DestTypeArgs_27, 0))));
                              Var_50 = ((MR_Word) ((MR_hl_field(1, DestTypeArgs_27, 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 318, &UnboxedFloat_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 319, &UnboxedInt64s_11);
