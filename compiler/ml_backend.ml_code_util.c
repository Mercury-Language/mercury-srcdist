...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 257, &UnboxedFloat_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 258, &UnboxedInt64s_10);
    switch (Target_8) {
      default:
        succeeded = MR_FALSE;
        break;
