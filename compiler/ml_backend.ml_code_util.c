...
ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1630__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_26 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1630__1_1_f_0(((MR_Word) (wrapper_arg_1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 282, &UnboxedFloat_10);
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 283, &UnboxedInt64s_11);
...
MR_Word MR_CALL 
ml_backend__ml_code_util__ml_gen_local_var_names_from_varset_2_f_0(
  MR_Word VarSet_1,
  MR_Word HeadVar__2_2)
{
  MR_Word HeadVar__3_3;
  ...
  else
  {
    ...
    MLDSVarName_8 = ml_backend__ml_code_util__ml_gen_local_var_name_from_varset_2_f_0(VarSet_1, Var_6);
    MLDSVarNames_9 = ml_backend__ml_code_util__ml_gen_local_var_names_from_varset_2_f_0(VarSet_1, Vars_7);
    {
...
MR_Word MR_CALL 
ml_backend__ml_code_util__ml_gen_local_var_name_from_varset_2_f_0(
  MR_Word VarSet_4,
  MR_Word Var_5)
{
  MR_bool succeeded;
  ...
  MR_String VarNamePrime_7;

  succeeded = mercury__varset__search_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_4, Var_5, &VarNamePrime_7);
  if (succeeded)
    VarName_8 = VarNamePrime_7;
  else
    VarName_8 = (MR_String) "";
  mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_5, &VarNumber_9);
  {
    MLDSVarName_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), MLDSVarName_6, 0) = ((MR_Box) (VarName_8));
    MR_hl_field(MR_mktag(1), MLDSVarName_6, 1) = ((MR_Box) (VarNumber_9));
  }
  return MLDSVarName_6;
}
  ...
  MR_Word * MLDS_Module_8)
{
  ...
  else
  {
    ...
    MR_Word TypeCtorInfo_21_61;
    MR_Word TypeCtorInfo_22_62;
    MR_Word TypeInfo_23_63;
    MR_Word Var_41;
    MR_Word PredInfo_47;
    MR_Word ProcInfo_48;
    MR_Word Modes_49;
    MR_Word ArgTypes_50;
    MR_Word ArgVars_51;
    MR_Word TopFunctorModes_52;
    MR_Word RetTopFunctorMode_54;
    MR_Word RetArgType_56;
    MR_Word Var_58;
    MR_Word Var_59;
    MR_Word Var_60;
    MR_Word _InputTopFunctorModes_53;
    MR_Box conv0_RetTopFunctorMode_54;
    MR_Word _InputArgTypes_55;
    MR_Box conv1_RetArgType_56;
    MR_Word _InputArgVars_57;
    MR_Box conv2_Var_33;
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_5, Var_41, &PredInfo_47, &ProcInfo_48);
      Var_58 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_47);
      succeeded = (Var_58 == (MR_Integer) 1);
      if (succeeded)
      {
        Var_59 = hlds__code_model__proc_info_interface_code_model_1_f_0(ProcInfo_48);
        succeeded = (Var_59 == (MR_Integer) 0);
        if (succeeded)
        {
          hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_48, &Modes_49);
          hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo_47, &ArgTypes_50);
          hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_48, &ArgVars_51);
          check_hlds__mode_top_functor__modes_to_top_functor_modes_4_p_0(ModuleInfo_5, Modes_49, ArgTypes_50, &TopFunctorModes_52);
          TypeCtorInfo_21_61 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_top_functor_mode_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo_21_61, TopFunctorModes_52, &_InputTopFunctorModes_53, &conv0_RetTopFunctorMode_54);
          RetTopFunctorMode_54 = ((MR_Word) (conv0_RetTopFunctorMode_54));
          TypeCtorInfo_22_62 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeCtorInfo_22_62, ArgTypes_50, &_InputArgTypes_55, &conv1_RetArgType_56);
          RetArgType_56 = ((MR_Word) (conv1_RetArgType_56));
          TypeInfo_23_63 = (MR_Word) (&ml_backend__ml_code_util_scalar_common_1[3]);
          parse_tree__prog_util__pred_args_to_func_args_3_p_0(TypeInfo_23_63, ArgVars_51, &_InputArgVars_57, &conv2_Var_33);
          succeeded = (RetTopFunctorMode_54 == (MR_Integer) 1);
          if (succeeded)
          {
            Var_60 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_5, RetArgType_56);
