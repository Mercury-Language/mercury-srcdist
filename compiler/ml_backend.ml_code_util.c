...
MR_decl_label2(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0, 21,8)
...
MR_decl_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1_1_0)
MR_decl_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1_1_0)
MR_decl_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0)
...
{
MR_COMMON(1,3),
MR_ENTRY_AP(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1_1_0),
0
},
{
MR_COMMON(1,4),
MR_ENTRY_AP(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1_1_0),
0
},
};
...
MR_def_label(ml_backend__ml_code_util__ml_gen_box_or_unbox_lval_14_0,20)
	...
	MR_tfield(1, MR_sv(12), 0) = MR_sv(5);
	MR_sv(7) = MR_r1;
	MR_sv(10) = MR_r2;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(fn__ml_backend__mlds__mlds_make_context_1_0,
...
MR_def_label(ml_backend__ml_code_util__ml_gen_call_current_success_cont_indirectly_4_0,17)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
...
MR_BEGIN_MODULE(ml_backend__ml_code_util_module84)
	MR_init_entry1(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1866__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(ml_backend__ml_code_util_module85)
	MR_init_entry1(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1895__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(ml_backend__ml_code_util_module86)
	MR_init_entry1(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0);
	MR_init_label2(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0,21,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(0, MR_r2, 0);
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0_i21);
	}
...
MR_def_label(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__ml_backend__ml_code_util__this_file_0_0,
		fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0_i8);
MR_def_label(fn__ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont_indirectly__1929__1_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
