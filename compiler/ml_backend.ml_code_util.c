...
{
  {
    ...
    conv0_LambdaHeadVar__2_27 = ml_backend__ml_code_util__IntroducedFrom__func__ml_gen_call_current_success_cont__1518__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 255, &UnboxedFloat_9);
    switch (Target_8) {
      default:
        succeeded = MR_FALSE;
        break;
