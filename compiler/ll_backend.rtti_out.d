...
ll_backend.rtti_out.optdate ll_backend.rtti_out.trans_opt_date rtti_out.err ll_backend.rtti_out.c_date ll_backend.rtti_out.s_date ll_backend.rtti_out.pic_s_date ll_backend.rtti_out.il_date ll_backend.rtti_out.java_date : rtti_out.m \
	...
	ll_backend.llds_out.llds_out_instr.int \
...
ifeq ($(TARGET_ASM),yes)
ll_backend.rtti_out.mh ll_backend.rtti_out.mih : ll_backend.rtti_out.s
else
ll_backend.rtti_out.mh ll_backend.rtti_out.mih : ll_backend.rtti_out.c
endif

ifeq ($(TARGET_ASM),yes)
ll_backend.rtti_out.module_dep : ll_backend.rtti_out.s
else
...
ll_backend.rtti_out.date ll_backend.rtti_out.date0 \
	...
	ll_backend.llds_out.llds_out_instr.int3 \
...
ifeq ($(TARGET_ASM),yes)
ll_backend.rtti_out.s_date : rtti_out.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only ll_backend.rtti_out $(ERR_REDIRECT)
ll_backend.rtti_out.pic_s_date : rtti_out.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" ll_backend.rtti_out $(ERR_REDIRECT)
endif # TARGET_ASM
