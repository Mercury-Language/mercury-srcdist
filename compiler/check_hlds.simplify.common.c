...
static void MR_CALL 
check_hlds__simplify__common__IntroducedFrom__pred__common_optimise_construct__660__1_4_p_0(
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_27, &ArgModes_29);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = hlds__inst_match__inst_matches_binding_4_p_0(ModuleInfo_1, Type_42, InitialInst_40, FinalInst_41);
        if (succeeded)
        {
          {
            MR_Word base;
        ...
        else
        {
          ...
          if (succeeded)
          {
            succeeded = hlds__inst_match__inst_matches_binding_4_p_0(ModuleInfo_1, Type_42, FinalInst_41, FinalInst_41);
            if (succeeded)
            {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_43, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__common_scalar_common_3[3])));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__simplify__common__IntroducedFrom__pred__common_optimise_construct__660__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__2_126, ((MR_Word) (wrapper_arg_3)), &conv1_HeadVar__4_128);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          Var_27 = ((MR_Word) ((MR_hl_field(0, TypeB_4, 0))));
          TypeInfo_36_36 = (MR_Word) (&check_hlds__simplify__common_scalar_common_1[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_36_36, ((MR_Box) (TVar_5)), ((MR_Box) (Var_27)));
        }
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_28 = ((MR_Word) ((MR_hl_field(1, TypeB_4, 0))));
          ArgTypesB_11 = ((MR_Word) ((MR_hl_field(1, TypeB_4, 1))));
          succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Name_8, Var_28);
          if (succeeded)
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          Var_29 = ((MR_Word) ((MR_hl_field(2, TypeB_4, 0))));
          succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_13, Var_29);
        }
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word ArgTypesA_23 = ((MR_Word) ((MR_hl_field(3, TypeA_3, 2))));
            ...
            if (succeeded)
            {
              Var_30 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_4, 1))) & (MR_Integer) 1);
              ArgTypesB_24 = ((MR_Word) ((MR_hl_field(3, TypeB_4, 2))));
              Var_31 = ((MR_Word) ((MR_hl_field(3, TypeB_4, 3))));
              Var_32 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_4, 4))) & (MR_Integer) 3);
              succeeded = (PorF_14 == Var_30);
              if (succeeded)
              {
                succeeded = parse_tree__prog_data____Unify____ho_inst_info_0_0(H_15, Var_31);
                if (succeeded)
                {
                  succeeded = (P_16 == Var_32);
                  if (succeeded)
                    succeeded = check_hlds__simplify__common__types_match_exactly_list_2_p_0(ArgTypesA_23, ArgTypesB_24);
                }
              }
            }
          }
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                Var_29 = ((MR_Word) ((MR_hl_field(0, TypeB_5, 0))));
                TypeInfo_36_38 = (MR_Word) (&check_hlds__simplify__common_scalar_common_1[4]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_36_38, ((MR_Box) (TVar_7)), ((MR_Box) (Var_29)));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_30 = ((MR_Word) ((MR_hl_field(1, TypeB_5, 0))));
                ArgTypesB_13 = ((MR_Word) ((MR_hl_field(1, TypeB_5, 1))));
                succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Name_10, Var_30);
                if (succeeded)
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                Var_31 = ((MR_Word) ((MR_hl_field(2, TypeB_5, 0))));
                succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_15, Var_31);
              }
            }
            break;
          case (MR_Integer) 3:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    ArgTypesB_28 = ((MR_Word) ((MR_hl_field(3, TypeB_5, 1))));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    Var_32 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_5, 1))) & (MR_Integer) 1);
                    ArgTypesB_26 = ((MR_Word) ((MR_hl_field(3, TypeB_5, 2))));
                    Var_33 = ((MR_Word) ((MR_hl_field(3, TypeB_5, 3))));
                    Var_34 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_5, 4))) & (MR_Integer) 3);
                    succeeded = (PorF_16 == Var_32);
                    if (succeeded)
                    {
                      succeeded = parse_tree__prog_data____Unify____ho_inst_info_0_0(H_17, Var_33);
                      if (succeeded)
                      {
                        succeeded = (P_18 == Var_34);
                        if (succeeded)
                          succeeded = check_hlds__simplify__common__types_match_exactly_list_2_p_0(ArgTypesA_25, ArgTypesB_26);
                      }
                    }
