  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  switch (MR_tag((MR_Word) ToVarRttiInfo_66)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word TypeInfo_14_85;
        MR_Word TypeCtorInfo_15_86;

        succeeded = (FromVarRttiInfo_65 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          TypeInfo_14_85 = (MR_Word) (&check_hlds__simplify__common_scalar_common_1[4]);
          TypeCtorInfo_15_86 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          mercury__map__init_1_p_0(TypeInfo_14_85, TypeCtorInfo_15_86, &TSubst_67);
          succeeded = MR_TRUE;
        }
      }
      break;
