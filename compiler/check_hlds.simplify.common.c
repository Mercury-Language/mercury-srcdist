      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_42, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.common.common_do_optimise_call\'/11"));
            MR_hl_field(MR_mktag(2), Spec_42, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 28) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            MR_hl_field(MR_mktag(2), Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(2), Spec_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__common_scalar_common_3[3])));
