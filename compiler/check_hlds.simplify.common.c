...
static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_1[13][2];
...
static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_4[1][5];

static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_5[1][6];

static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_6[1][1];
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_47, &ModuleInfo_27);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&check_hlds__simplify__common_scalar_common_5[0]));
        ...
        if (succeeded)
        {
          ...
          Var_57 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__common_scalar_common_1[11]));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__common_scalar_common_6[0])));
    ...
    else
    {
      ...
      }
      {
        ...
        *GoalExpr_15 = base;
        ...
        MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__common_scalar_common_1[8])));
