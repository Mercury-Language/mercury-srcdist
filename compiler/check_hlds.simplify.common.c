...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          CallPieces_37 = check_hlds__det_report__det_report_seen_call_id_2_f_0(ModuleInfo_27, SeenCall_12);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__common_scalar_common_1[7])));
            MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (CallPieces_37));
          }
          Var_57 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__common_scalar_common_1[9]));
          CurPieces_38 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_54, Var_57);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__common_scalar_common_1[10])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__common_scalar_common_3[0])));
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_85_85, &STATE_VARIABLE_Info_86_86);
        ...
        switch (Detism0_44) {
          ...
          case (MR_Integer) 3:
          case (MR_Integer) 1:
            check_hlds__simplify__simplify_info__simplify_info_set_should_rerun_det_2_p_0(STATE_VARIABLE_Info_86_86, STATE_VARIABLE_Info_48);
            break;
          case (MR_Integer) 0:
      ...
      else
      {
        ...
        Var_101 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 0))));
        Var_102 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 1))));
        Var_103 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 2))));
        {
          MR_Word base;
          ...
          *Common_20 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (SeenCalls_46));
        }
        *MaybeAssignsGoalExpr_18 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      Var_105 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 0))));
      Var_106 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 1))));
      Var_107 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Common0_19, (MR_Integer) 2))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        *Common_20 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (SeenCalls_94));
      }
      *MaybeAssignsGoalExpr_18 = (MR_Word) ((MR_Unsigned) 0U);
      *STATE_VARIABLE_Info_48 = STATE_VARIABLE_Info_0_47;
    }
