  ...
  MR_Word * STATE_VARIABLE_Info_43)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_42, &VarTable_79);
  parse_tree__var_table__lookup_var_type_3_p_0(VarTable_79, Var_14, &Type_80);
