...
{
  {
    ...
    *GoalInfo_24 = GoalInfo0_23;
    LVarInitInst_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_20, (MR_Integer) 0))));
    succeeded = check_hlds__inst_test__inst_is_ground_2_p_0(ModuleInfo_27, LVarInitInst_28);
    succeeded = !(succeeded);
    if (succeeded)
    {
...
{
  {
    ...
    check_hlds__simplify__common__IntroducedFrom__pred__common_optimise_construct__352__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__2_70, ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_72);
...
{
  {
    MR_bool succeeded;
    MR_Word ModuleInfo_23;
    MR_Word LVarFinalInst_25;

    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_48, &ModuleInfo_23);
    LVarFinalInst_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_16, (MR_Integer) 1))));
    succeeded = check_hlds__inst_test__inst_is_ground_2_p_0(ModuleInfo_23, LVarFinalInst_25);
    if (succeeded)
    {
      MR_Word TypeCtor_28;
      MR_Word VarEqv0_29;
      ...
      if (succeeded)
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), VarFromToInsts_43, 0) = ((MR_Box) (LVarFinalInst_25));
            MR_hl_field(MR_mktag(0), VarFromToInsts_43, 1) = ((MR_Box) (LVarFinalInst_25));
          }
