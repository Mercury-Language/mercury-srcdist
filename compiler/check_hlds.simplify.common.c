...
static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_3[2][1];
...
static /* final */ const MR_Box check_hlds__simplify__common_scalar_common_2[6][3] = {
  ...
  /* row 3 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 25) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 4 */
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      succeeded = mercury__eqvclass__partition_id_3_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), EqvVars_7, ((MR_Box) (X_4)), &Id_14);
      if (succeeded)
      {
        succeeded = mercury__eqvclass__partition_id_3_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), EqvVars_7, ((MR_Box) (Y_5)), &Var_16);
        if (succeeded)
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) AssignGoals_29)) == (MR_Integer) 1);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_74, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 25) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          {
            Msg_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_85, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 25) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          {
            PrevMsg_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PrevMsg_42, 0) = ((MR_Box) (Var_81));
            MR_hl_field(MR_mktag(1), PrevMsg_42, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__common_scalar_common_3[1])));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (!(succeeded))
        {
          ...
          succeeded = mercury__eqvclass__partition_id_3_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), HeadVar__3_3, ((MR_Box) (X_5)), &Id_13);
          if (succeeded)
          {
            succeeded = mercury__eqvclass__partition_id_3_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), HeadVar__3_3, ((MR_Box) (Y_7)), &Var_15);
            if (succeeded)
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_11, (MR_Integer) 5)));
          MR_Word MaybeTakeAddr_24;

          succeeded = ((MR_tag((MR_Word) SubInfo_23)) == (MR_Integer) 1);
          if (succeeded)
          {
            MaybeTakeAddr_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SubInfo_23, (MR_Integer) 0))));
            succeeded = ((MR_tag((MR_Word) MaybeTakeAddr_24)) == (MR_Integer) 1);
            if (succeeded)
            {
            }
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word CanFail_28 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification0_11, (MR_Integer) 4))) >> 1)) & (MR_Integer) 1);
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification0_11, (MR_Integer) 4)));
...
{
  {
    ...
    *GoalInfo_24 = GoalInfo0_23;
    ...
    else
    {
      ...
      mercury__eqvclass__ensure_element_partition_id_4_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), ((MR_Box) (Var_15)), &VarId_34, VarEqv0_33, &VarEqv1_35);
      ...
      if (succeeded)
      {
        ...
        mercury__eqvclass__ensure_corresponding_equivalences_4_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), ArgVars_17, OldArgVars_41, VarEqv1_35, &VarEqv_42);
        ...
        {
          STATE_VARIABLE_Common_53_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        ...
        RHSFromToInsts_43 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_from_to_insts_0), (MR_Word) (&check_hlds__simplify__common_scalar_common_2[5]), ArgModes_18);
      ...
      else
      {
        ...
        *GoalExpr_22 = GoalExpr0_21;
        {
          Struct_46 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) OutputArgs_11)) == (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) OldOutputArgs_12)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) FromToInsts_13)) == (MR_Integer) 1);
        if (succeeded)
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        mercury__eqvclass__ensure_equivalence_4_p_0((MR_Word) (&check_hlds__simplify__common_scalar_common_1[0]), ((MR_Box) (Var_13)), ((MR_Box) (OldVar_38)), VarEqv1_31, &VarEqv_40);
        ...
        {
          STATE_VARIABLE_Common_51_51 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          {
            VarFromToInsts_43 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        *GoalInfo_20 = GoalInfo0_19;
        {
          Struct_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        UnifyMode_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1)));
                Var_36 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
                ...
                Var_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 4))) & (MR_Integer) 3);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Type2_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 0))) == (MR_Integer) 0)));
                  if (succeeded)
                  {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word Var_41;
                  MR_Word Var_42;
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type1_3, (MR_Integer) 1)));
                  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type1_3, (MR_Integer) 4)));
                  MR_Unsigned packed_word_2;
                  MR_Unsigned packed_word_3;

                  succeeded = ((((MR_tag((MR_Word) Type2_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 0))) == (MR_Integer) 1)));
                  if (succeeded)
                  {
                    packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 1)));
                    Var_40 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 1))) & (MR_Integer) 1);
                    Bs_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 2))));
                    Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 3))));
                    packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 4)));
                    Var_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 4))) & (MR_Integer) 3);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Type2_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type2_5, (MR_Integer) 0))) == (MR_Integer) 2)));
                  if (succeeded)
                  {
