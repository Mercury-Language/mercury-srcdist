  ...
  MR_Word * STATE_VARIABLE_Info_48)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_42, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 29) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    ...
    else
    {
      ...
      mercury__map__det_update_4_p_0((MR_Word) (&check_hlds__simplify__common__check_hlds__simplify__common__type_ctor_info_seen_call_id_0), (MR_Word) (&check_hlds__simplify__common_scalar_common_1[2]), ((MR_Box) (SeenCall_12)), ((MR_Box) (Var_88)), SeenCalls0_23, &SeenCalls_46);
  ...
  else
  {
    ...
    mercury__map__det_insert_4_p_0((MR_Word) (&check_hlds__simplify__common__check_hlds__simplify__common__type_ctor_info_seen_call_id_0), (MR_Word) (&check_hlds__simplify__common_scalar_common_1[2]), ((MR_Box) (SeenCall_12)), ((MR_Box) (Var_89)), SeenCalls0_23, &SeenCalls_94);
