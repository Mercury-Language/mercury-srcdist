...
static void MR_CALL 
check_hlds__simplify__common__IntroducedFrom__pred__common_optimise_construct__649__1_4_p_0(
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_42, 3) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__common_scalar_common_3[3])));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__simplify__common__IntroducedFrom__pred__common_optimise_construct__649__1_4_p_0(((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__2_126, ((MR_Word) (wrapper_arg_3)), &conv1_HeadVar__4_128);
