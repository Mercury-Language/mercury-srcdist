...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_48_48, &STATE_VARIABLE_Info_49_49);
        {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_0_42, STATE_VARIABLE_Info_43);
      }
      else
        {
