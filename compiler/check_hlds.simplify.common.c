      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            ...
            MR_Word next_value_of_HeadVar__2_2 = Ys_8;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__map_foldl_5_p_0(TypeInfo_74_74, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &check_hlds__simplify__common_scalar_common_1[3], (MR_Word) &check_hlds__simplify__common_scalar_common_2[3], ArgVars_15, &ArgVarIds_30, ((MR_Box) (VarEqv0_29)), &conv2_VarEqv1_31);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Types1_4;
            MR_Word next_value_of_HeadVar__2_2 = Types2_6;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__1_1 = Ids_6;
              MR_Word next_value_of_HeadVar__2_2 = Vars_8;
