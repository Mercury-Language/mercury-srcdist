...
check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__198__1_2_p_0(
  MR_Word MaybeTraceRuntimeCond_33,
  MR_Word HeadVar__2_97);

static MR_bool MR_CALL 
check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__197__1_2_p_0(
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[3]), ((MR_Box) (MaybeTraceRuntimeCond_33)), ((MR_Box) (HeadVar__2_97)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[1]), ((MR_Box) (ExtraArgs_32)), ((MR_Box) (HeadVar__2_92)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__198__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__197__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    {
      MR_Word Var_131 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 1))));
      MR_Word Var_132 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 0))));
      MR_Word Var_133 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_132, (MR_Integer) 1))));
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_132, (MR_Integer) 0))));
        ...
        switch (MR_tag((MR_Word) Var_134)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Args_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 4))));
                  MR_Word ExtraArgs_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 5))));
                  MR_Word MaybeTraceRuntimeCond_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 6))));
                  MR_Word Var_88;
                  MR_Word Var_93;
                  MR_Box conv1_VarSet_35;

                  mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[0]), (MR_Word) (&check_hlds__clause_to_proc_scalar_common_1[2]), Args_31, ((MR_Box) (VarSet0_9)), &conv1_VarSet_35);
                  ...
                  mercury__require__expect_4_p_0(Var_88, (MR_String) "check_hlds.clause_to_proc", (MR_String) "predicate \140check_hlds.clause_to_proc.copy_clauses_to_proc_in_proc_info\'/4", (MR_String) "extra_args");
                  {
                    Var_93 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&check_hlds__clause_to_proc_scalar_common_5[1]));
                    MR_hl_field(MR_mktag(0), Var_93, 1) = ((MR_Box) (check_hlds__clause_to_proc__copy_clauses_to_proc_in_proc_info_4_p_0_3));
                    MR_hl_field(MR_mktag(0), Var_93, 2) = ((MR_Box) ((MR_Integer) 2));
                    MR_hl_field(MR_mktag(0), Var_93, 3) = ((MR_Box) (MaybeTraceRuntimeCond_33));
                    MR_hl_field(MR_mktag(0), Var_93, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  mercury__require__expect_4_p_0(Var_93, (MR_String) "check_hlds.clause_to_proc", (MR_String) "predicate \140check_hlds.clause_to_proc.copy_clauses_to_proc_in_proc_info\'/4", (MR_String) "trace runtime cond");
                }
                break;
            }
            break;
      ...
      {
        MR_Word Context_109;
        MR_Word NonLocalVars_110;
        MR_Word DisjunctionPurity_111;
        MR_Word InstMapDelta_112;
        MR_Word GoalInfo_114;
        MR_Word Var_115;
        MR_Word Var_117;
        MR_Word Disjunct_149;
        MR_Word Disjuncts_150;
        MR_Word DisjunctPurity_152;
        MR_Word STATE_VARIABLE_Purity_13_155;

        Context_109 = hlds__hlds_goal__goal_info_get_context_1_f_0(Var_133);
        VarSet_35 = VarSet0_9;
        Var_115 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[4]), HeadVars_13);
        NonLocalVars_110 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_115);
        Disjunct_149 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 0))));
        Disjuncts_150 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 1))));
        DisjunctPurity_152 = hlds__hlds_goal__goal_get_purity_1_f_0(Disjunct_149);
        STATE_VARIABLE_Purity_13_155 = parse_tree__prog_data__worst_purity_2_f_0((MR_Integer) 0, DisjunctPurity_152);
        check_hlds__clause_to_proc__accumulate_disjunction_purity_3_p_0(Disjuncts_150, STATE_VARIABLE_Purity_13_155, &DisjunctionPurity_111);
        hlds__instmap__instmap_delta_init_unreachable_1_p_0(&InstMapDelta_112);
        hlds__hlds_goal__goal_info_init_6_p_0(NonLocalVars_110, InstMapDelta_112, (MR_Integer) 6, DisjunctionPurity_111, Context_109, &GoalInfo_114);
        {
          Var_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_117, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          MR_hl_field(MR_mktag(3), Var_117, 1) = ((MR_Box) (ClausesDisjuncts_21));
        }
        {
          Goal_66 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Goal_66, 0) = ((MR_Box) (Var_117));
          MR_hl_field(MR_mktag(0), Goal_66, 1) = ((MR_Box) (GoalInfo_114));
        }
      }
    }
...
{
  {
    ...
    if (succeeded)
    {
      Var_14 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_9, (MR_Integer) 0))) & (MR_Integer) 3);
