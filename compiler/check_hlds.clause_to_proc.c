  ...
  MR_Word * STATE_VARIABLE_Warnings_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_Warnings_1_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), HeadWarnings_20, STATE_VARIABLE_Warnings_0_4);
      // direct tailcall eliminated
      ;
