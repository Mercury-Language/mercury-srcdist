  ...
  MR_Word HeadVar__2_91)
{
  ...
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[3]), ((MR_Box) (MaybeTraceRuntimeCond_33)), ((MR_Box) (HeadVar__2_91)));
  return succeeded;
}
  ...
  MR_Word HeadVar__2_87)
{
  ...
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[1]), ((MR_Box) (ExtraArgs_32)), ((MR_Box) (HeadVar__2_87)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_PredIdTable_9)
{
  ...
  succeeded = hlds__hlds_pred__check_marker_2_p_0(PredMarkers_12, (MR_Integer) 10);
  succeeded = !(succeeded);
  if (succeeded)
  {
    MR_Word PredInfo_7;
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_18)
{
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_22);
      succeeded = (ProcId_10 == Var_22);
    }
  }
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_14, VarTypes_15, STATE_VARIABLE_ProcInfo_19_19, &STATE_VARIABLE_ProcInfo_20_20);
    hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_16, STATE_VARIABLE_ProcInfo_20_20, STATE_VARIABLE_ProcInfo_18);
  }
  else
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_80)
{
  ...
  if (succeeded)
  {
    Var_137 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_132, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_139);
    succeeded = (ProcId_6 == Var_139);
    if (succeeded)
  ...
  if ((ClausesDisjuncts_21 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    VarSet_35 = VarSet0_9;
    Var_93 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[4]), HeadVars_13);
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word DisjunctPurity_153;
      MR_Word STATE_VARIABLE_Purity_13_156;

      Context_106 = hlds__hlds_goal__goal_info_get_context_1_f_0(Var_130);
      VarSet_35 = VarSet0_9;
      Var_112 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__clause_to_proc_scalar_common_2[4]), HeadVars_13);
      ...
      Disjunct_151 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 0))));
      Disjuncts_152 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 1))));
      DisjunctPurity_153 = hlds__hlds_goal__goal_get_purity_1_f_0(Disjunct_151);
      STATE_VARIABLE_Purity_13_156 = parse_tree__prog_data__worst_purity_2_f_0((MR_Integer) 0, DisjunctPurity_153);
      check_hlds__clause_to_proc__accumulate_disjunction_purity_3_p_0(Disjuncts_152, STATE_VARIABLE_Purity_13_156, &DisjunctionPurity_108);
