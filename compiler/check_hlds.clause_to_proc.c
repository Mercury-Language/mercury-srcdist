...
MR_decl_label10(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0, 5,74,9,11,12,13,14,15,17,20)
MR_decl_label10(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0, 21,22,19,25,24,27,28,23,7,30)
MR_decl_label1(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0, 31)
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module11)
	...
	MR_init_label10(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,5,74,9,11,12,13,14,15,17,20)
	MR_init_label10(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,21,22,19,25,24,27,28,23,7,30)
	MR_init_label1(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,31)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0_i74);
	}
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
...
MR_def_label(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,5)
	...
	MR_r3 = (MR_Word) MR_string_const("length mismatch", 15);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
	{
