...
static MR_bool MR_CALL 
check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__218__1_2_p_0(
    ...
    if (check_hlds__clause_to_proc__succeeded)
      {
        ...
        MR_Word check_hlds__clause_to_proc__V_26_26;
        ...
        {
          check_hlds__clause_to_proc__V_24_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__V_24_24, 0) = ((MR_Box) (check_hlds__clause_to_proc__FuncRetMode_15));
          MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__V_24_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mercury__list__append_3_p_1(check_hlds__clause_to_proc__TypeCtorInfo_32_32, check_hlds__clause_to_proc__FuncArgModes_14, check_hlds__clause_to_proc__V_24_24, &check_hlds__clause_to_proc__PredArgModes_16);
        }
        {
...
{
  {
    ...
    {
      check_hlds__clause_to_proc__succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__218__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 4))));
    }
    return check_hlds__clause_to_proc__succeeded;
  }
}
