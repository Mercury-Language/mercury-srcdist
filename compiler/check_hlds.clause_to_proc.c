...
{
  {
    ...
    if ((MaybeNameMode_7 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((StateVarWarnings_21 == (MR_Word) ((MR_Integer) 0)))
    ...
    if ((ClausesDisjuncts_20 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Context_71;
    ...
    else
    {
      ...
      if ((Var_130 == (MR_Word) ((MR_Integer) 0)))
      {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__require__expect_4_p_0(Var_87, (MR_String) "check_hlds.clause_to_proc", (MR_String) "predicate \140check_hlds.clause_to_proc.copy_clauses_to_proc_in_proc_info\'/4", (MR_String) "extra_args");
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_92, 4) = ((MR_Box) ((MR_Integer) 0));
                  }
...
{
  {
    ...
    check_hlds__clause_to_proc__select_matching_clauses_acc_4_p_0(ProcId_4, Clauses_5, (MR_Word) ((MR_Integer) 0), &RevMatchingClauses_8);
  ...
  MR_Word * STATE_VARIABLE_RevMatchingClauses_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((ApplicableProcIds_13 == (MR_Word) ((MR_Integer) 0)))
        {
