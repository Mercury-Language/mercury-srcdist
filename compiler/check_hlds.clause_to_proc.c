...
static MR_bool MR_CALL 
check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__180__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_PredIdTable_9)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(PredMarkers_12, (MR_Integer) 11);
  succeeded = !(succeeded);
  if (succeeded)
  {
    MR_Word PredInfo_7;
  ...
  MR_Word PredInfo_2)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(PredMarkers_3, (MR_Integer) 11);
  succeeded = !(succeeded);
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc_in_proc_info__180__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
