...
MR_decl_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 2,3,4,7,8,9,11,12)
MR_decl_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 15,18,20,21,13,6,41,46)
MR_decl_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 33,35,36,38,39,28,47,48)
MR_decl_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 49,51,52,55,58,60,61,53)
MR_decl_label1(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 67)
...
MR_decl_label8(check_hlds__clause_to_proc__copy_pred_clauses_to_procs_if_needed_3_0, 2,4,6,8,9,10,11,12)
MR_decl_label1(check_hlds__clause_to_proc__copy_pred_clauses_to_procs_if_needed_3_0, 3)
...
MR_decl_label8(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0, 18,22,23,24,26,28,27,30)
MR_decl_label4(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0, 31,7,34,35)
...
/*-------------------------------------------------------------------------*/
/* code for 'get_clause_goals'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module5)
	...
	MR_init_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,2,3,4,7,8,9,11,12)
	MR_init_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,15,18,20,21,13,6,41,46)
	MR_init_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,33,35,36,38,39,28,47,48)
	MR_init_label8(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,49,51,52,55,58,60,61,53)
	MR_init_label1(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,67)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i6);
	}
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_context_2_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i7);
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i13);
	}
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,21)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_args__proc_arg_vector_to_list_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i67);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,13)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_args__proc_arg_vector_to_list_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i67);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i28);
	}
	MR_r6 = MR_ctfield(0, MR_ctfield(1, MR_tempr1, 0), 0);
	if (MR_INT_EQ(MR_tag(MR_r6),3)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i46);
	}
	}
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,46)
	...
	if (MR_INT_NE(MR_ctfield(3, MR_r6, 0),0)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i41);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r6;
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,28)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i47);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_init_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i48);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,49)
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__hlds__hlds_args__proc_arg_vector_to_set_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i51);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_nonlocals_3_0,
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i53);
	}
	...
	MR_r4 = MR_sv(1);
	MR_np_call_localret_ent(fn__list__map_2_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i58);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__list__foldl_3_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i60);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_purity_3_0,
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,61)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_args__proc_arg_vector_to_list_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i67);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_args__proc_arg_vector_to_list_1_0,
		check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i67);
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
/*-------------------------------------------------------------------------*/
/* code for 'introduce_exists_casts_for_arg'/12 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module13)
	...
	MR_init_label8(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,18,22,23,24,26,28,27,30)
	MR_init_label4(check_hlds__clause_to_proc__introduce_exists_casts_extra_13_0,31,7,34,35)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module16)
	...
	MR_init_label8(check_hlds__clause_to_proc__copy_pred_clauses_to_procs_if_needed_3_0,2,4,6,8,9,10,11,12)
	MR_init_label1(check_hlds__clause_to_proc__copy_pred_clauses_to_procs_if_needed_3_0,3)
MR_BEGIN_CODE
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__copy_clauses_to_proc__208__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
