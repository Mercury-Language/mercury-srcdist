  ...
  MR_Word * STATE_VARIABLE_PredIdTable_9)
{
  ...
  succeeded = hlds__hlds_pred__check_marker_2_p_0(PredMarkers_13, (MR_Integer) 11);
  succeeded = !(succeeded);
  if (succeeded)
  {
    MR_Word PredInfo_7;
  ...
  MR_Word * MatchingClauses_8)
{
  ...
  if (succeeded)
  {
    Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_9, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_14)) == (MR_Integer) 0);
    if (succeeded)
    {
      Var_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_17);
    succeeded = (ProcId_6 == Var_17);
    if (succeeded)
