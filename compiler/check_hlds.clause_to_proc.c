...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,6)
	...
	MR_r6 = MR_tfield(0, MR_tfield(1, MR_r1, 0), 0);
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,33)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__206__1_2_0);
