...
{
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_17_29 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__map__map_values_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, TypeCtorInfo_17_29, TypeCtorInfo_17_29, Var_23, ProcMap0_21, &ProcMap_22);
...
{
  {
    ...
    MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ClausesInfo_5, (MR_Integer) 1)));
    MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ClausesInfo_5, (MR_Integer) 2)));
    MR_Word _ItemNumbers_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), ClausesInfo_5, (MR_Integer) 6)));
    MR_Word _HaveForeignClauses_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), ClausesInfo_5, (MR_Integer) 8)));
    MR_Word _HadSyntaxError_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), ClausesInfo_5, (MR_Integer) 9)));
...
{
  {
    ...
    TypeCtorInfo_17_26 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
    mercury__map__map_values_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, TypeCtorInfo_17_26, TypeCtorInfo_17_26, Var_20, ProcMap0_18, &ProcMap_19);
...
{
  {
    ...
    TypeCtorInfo_11_11 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    mercury__map__keys_2_p_0(TypeCtorInfo_11_11, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0, PredTable0_4, &PredIds_5);
    mercury__list__foldl_4_p_0(TypeCtorInfo_11_11, (MR_Word) &check_hlds__clause_to_proc_scalar_common_1[0], (MR_Word) &check_hlds__clause_to_proc_scalar_common_1[1], PredIds_5, ((MR_Box) (PredTable0_4)), &conv1_PredTable_6);
