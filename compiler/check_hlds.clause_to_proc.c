...
MR_decl_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 2,3,4,5,8,9,10,11,12,13)
MR_decl_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 16,19,21,22,14,7,33,35,37,31)
MR_decl_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 29,38,39,40,41,42,43,46,49,51)
MR_decl_label3(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0, 52,44,58)
...
MR_decl_static(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__204__1_2_0)
MR_decl_static(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__205__1_2_0)
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module4)
	...
	MR_init_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,2,3,4,5,8,9,10,11,12,13)
	MR_init_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,16,19,21,22,14,7,33,35,37,31)
	MR_init_label10(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,29,38,39,40,41,42,43,46,49,51)
	MR_init_label3(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,52,44,58)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,33)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__204__1_2_0);
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,35)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__205__1_2_0);
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = MR_tfield(0, MR_tfield(1, MR_sv(6), 0), 1);
...
MR_def_label(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__clause_to_proc__copy_clauses_to_proc_4_0_i44);
	}
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, purity);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = MR_sv(4);
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module17)
	MR_init_entry1(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__204__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__204__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__copy_clauses_to_proc__204__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__204__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__clause_to_proc_module18)
	MR_init_entry1(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__205__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__205__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__copy_clauses_to_proc__205__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__205__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
