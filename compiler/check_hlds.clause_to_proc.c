  ...
  MR_Word * STATE_VARIABLE_ProcInfo_80)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word Var_113;
      MR_Word Var_115;
      MR_Word Disjunct_146;
      MR_Word Disjuncts_147;
      MR_Word DisjunctPurity_149;
      MR_Word STATE_VARIABLE_Purity_13_152;
      ...
      Disjunct_146 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 0))));
      Disjuncts_147 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ClausesDisjuncts_21, (MR_Integer) 1))));
      DisjunctPurity_149 = hlds__hlds_goal__goal_get_purity_1_f_0(Disjunct_146);
      STATE_VARIABLE_Purity_13_152 = parse_tree__prog_data__worst_purity_2_f_0((MR_Integer) 0, DisjunctPurity_149);
      check_hlds__clause_to_proc__accumulate_disjunction_purity_3_p_0(Disjuncts_147, STATE_VARIABLE_Purity_13_152, &DisjunctionPurity_109);
