...
{
  {
    ...
    MR_Word check_hlds__clause_to_proc__Var_23;
    ...
    if (check_hlds__clause_to_proc__succeeded)
      {
        ...
        check_hlds__clause_to_proc__Var_23 = (MR_Integer) 11;
        {
          check_hlds__clause_to_proc__succeeded = hlds__hlds_pred__check_marker_2_p_0(check_hlds__clause_to_proc__PredMarkers_22, check_hlds__clause_to_proc__Var_23);
        }
        check_hlds__clause_to_proc__succeeded = !(check_hlds__clause_to_proc__succeeded);
      }
    if (check_hlds__clause_to_proc__succeeded)
        ...
        if ((check_hlds__clause_to_proc__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__clause_to_proc__STATE_VARIABLE_Procs_5 = check_hlds__clause_to_proc__STATE_VARIABLE_Procs_0_4;
        else
          {
            ...
            {
              MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__3_3 = check_hlds__clause_to_proc__ProcIds_14;
              MR_Word check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_Procs_0_4 = check_hlds__clause_to_proc__STATE_VARIABLE_Procs_20_20;

              check_hlds__clause_to_proc__STATE_VARIABLE_Procs_0_4 = check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_Procs_0_4;
              check_hlds__clause_to_proc__HeadVar__3_3 = check_hlds__clause_to_proc__next_value_of_HeadVar__3_3;
            }
            continue;
          }
      }
...
{
  {
    ...
    if ((check_hlds__clause_to_proc__MaybeNameMode_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word check_hlds__clause_to_proc__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__MaybeNameMode_7, (MR_Integer) 0)));
        MR_Word check_hlds__clause_to_proc__Var_9;

        check_hlds__clause_to_proc__Name_8 = ((MR_String) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_12, (MR_Integer) 0)));
        check_hlds__clause_to_proc__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_12, (MR_Integer) 1)));
        {
...
{
  {
    ...
    {
      check_hlds__clause_to_proc__succeeded = hlds__hlds_pred__check_marker_2_p_0(check_hlds__clause_to_proc__PredMarkers_14, (MR_Integer) 11);
    }
    check_hlds__clause_to_proc__succeeded = !(check_hlds__clause_to_proc__succeeded);
    if (check_hlds__clause_to_proc__succeeded)
      {
        ...
        if ((check_hlds__clause_to_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__clause_to_proc__STATE_VARIABLE_Procs_4 = check_hlds__clause_to_proc__STATE_VARIABLE_Procs_0_3;
        else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__1_1 = check_hlds__clause_to_proc__ProcIds_10;
              MR_Word check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_Procs_0_3 = check_hlds__clause_to_proc__STATE_VARIABLE_Procs_17_17;

              check_hlds__clause_to_proc__STATE_VARIABLE_Procs_0_3 = check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_Procs_0_3;
              check_hlds__clause_to_proc__HeadVar__1_1 = check_hlds__clause_to_proc__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
...
{
  {
    ...
    MR_Integer check_hlds__clause_to_proc__Var_50;
    MR_Word check_hlds__clause_to_proc__Var_56;
    MR_Word check_hlds__clause_to_proc__Var_57;
    ...
    MR_Word check_hlds__clause_to_proc__Var_60;
    MR_Word check_hlds__clause_to_proc__Var_40;
    ...
    {
      check_hlds__clause_to_proc__Var_50 = mercury__list__length_1_f_0(check_hlds__clause_to_proc__TypeCtorInfo_61_61, check_hlds__clause_to_proc__ArgTypes_8);
    }
    check_hlds__clause_to_proc__NumExtraHeadVars_12 = (check_hlds__clause_to_proc__Var_50 - check_hlds__clause_to_proc__OrigArity_11);
    {
    ...
    check_hlds__clause_to_proc__Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__PredConstraints_10, (MR_Integer) 0)));
    ...
    check_hlds__clause_to_proc__Var_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Body0_16, (MR_Integer) 0)));
    ...
    {
      check_hlds__clause_to_proc__Var_56 = mercury__list__f_43_43_2_f_0(check_hlds__clause_to_proc__TypeCtorInfo_66_66, check_hlds__clause_to_proc__ExistsCastHeadGoals_32, check_hlds__clause_to_proc__ExistsCastExtraGoals_39);
    }
    {
      check_hlds__clause_to_proc__Goals_43 = mercury__list__f_43_43_2_f_0(check_hlds__clause_to_proc__TypeCtorInfo_66_66, check_hlds__clause_to_proc__Goals0_42, check_hlds__clause_to_proc__Var_56);
    }
    {
    ...
    {
      check_hlds__clause_to_proc__Var_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_57, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_57, 2) = ((MR_Box) (check_hlds__clause_to_proc__Goals_43));
    }
    {
      check_hlds__clause_to_proc__Body_47 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Body_47, 0) = ((MR_Box) (check_hlds__clause_to_proc__Var_57));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  check_hlds__clause_to_proc__Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__ExistConstraint_55, (MR_Integer) 0)));
        ...
        if ((check_hlds__clause_to_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__clause_to_proc__STATE_VARIABLE_RttiVarMaps_5 = check_hlds__clause_to_proc__STATE_VARIABLE_RttiVarMaps_0_4;
        else
          {
            ...
            MR_Integer check_hlds__clause_to_proc__Var_23;
            MR_Word check_hlds__clause_to_proc__TVar_16;
            MR_Word check_hlds__clause_to_proc__Var_17;
            MR_Word check_hlds__clause_to_proc__Var_18;
            ...
            if (check_hlds__clause_to_proc__succeeded)
              {
                ...
                check_hlds__clause_to_proc__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__ArgType_11, (MR_Integer) 1)));
                {
                  check_hlds__clause_to_proc__succeeded = hlds__hlds_rtti__rtti_search_type_info_locn_3_p_0(check_hlds__clause_to_proc__STATE_VARIABLE_RttiVarMaps_0_4, check_hlds__clause_to_proc__TVar_16, &check_hlds__clause_to_proc__Var_18);
                }
                check_hlds__clause_to_proc__succeeded = !(check_hlds__clause_to_proc__succeeded);
              }
            if (check_hlds__clause_to_proc__succeeded)
            ...
            check_hlds__clause_to_proc__Var_23 = (check_hlds__clause_to_proc__Num_3 + (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__1_1 = check_hlds__clause_to_proc__ArgTypes_12;
              MR_Integer check_hlds__clause_to_proc__next_value_of_Num_3 = check_hlds__clause_to_proc__Var_23;
              MR_Word check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_RttiVarMaps_0_4 = check_hlds__clause_to_proc__STATE_VARIABLE_RttiVarMaps_22_22;

              check_hlds__clause_to_proc__STATE_VARIABLE_RttiVarMaps_0_4 = check_hlds__clause_to_proc__next_value_of_STATE_VARIABLE_RttiVarMaps_0_4;
              check_hlds__clause_to_proc__Num_3 = check_hlds__clause_to_proc__next_value_of_Num_3;
              check_hlds__clause_to_proc__HeadVar__1_1 = check_hlds__clause_to_proc__next_value_of_HeadVar__1_1;
            }
            continue;
          }
        ...
        if (check_hlds__clause_to_proc__succeeded)
          {
            ...
            if (check_hlds__clause_to_proc__succeeded)
            ...
            else
              {
                ...
                MR_Word check_hlds__clause_to_proc__Var_64;
                ...
                {
                  check_hlds__mode_util__mode_get_insts_4_p_0(check_hlds__clause_to_proc__ModuleInfo_13, check_hlds__clause_to_proc__ArgMode_23, &check_hlds__clause_to_proc__Var_64, &check_hlds__clause_to_proc__Inst_65);
                }
                {
...
{
  {
    ...
    MR_Word check_hlds__clause_to_proc__Var_10;
    ...
    {
      check_hlds__clause_to_proc__Var_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_10, 0) = ((MR_Box) (&check_hlds__clause_to_proc_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_10, 1) = ((MR_Box) (check_hlds__clause_to_proc__introduce_exists_casts_3_p_0_1));
      MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_10, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_10, 3) = ((MR_Box) (check_hlds__clause_to_proc__STATE_VARIABLE_ModuleInfo_0_8));
    }
    {
      mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &check_hlds__clause_to_proc_scalar_common_1[0], check_hlds__clause_to_proc__Var_10, check_hlds__clause_to_proc__PredIds_4, ((MR_Box) (check_hlds__clause_to_proc__PredTable0_6)), &check_hlds__clause_to_proc__conv1_PredTable_7);
    }
        ...
        if ((check_hlds__clause_to_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__clause_to_proc__Preds_3 = check_hlds__clause_to_proc__HeadVar__2_2;
        else
          {
            ...
            MR_Word check_hlds__clause_to_proc__Var_11;
            ...
            {
              check_hlds__clause_to_proc__maybe_add_default_func_mode_3_p_0(check_hlds__clause_to_proc__PredInfo0_9, &check_hlds__clause_to_proc__PredInfo_10, &check_hlds__clause_to_proc__Var_11);
            }
            {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__1_1 = check_hlds__clause_to_proc__PredIds_6;
              MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__2_2 = check_hlds__clause_to_proc__Preds1_12;

              check_hlds__clause_to_proc__HeadVar__2_2 = check_hlds__clause_to_proc__next_value_of_HeadVar__2_2;
              check_hlds__clause_to_proc__HeadVar__1_1 = check_hlds__clause_to_proc__next_value_of_HeadVar__1_1;
            }
            continue;
          }
...
{
  {
    ...
    if (check_hlds__clause_to_proc__succeeded)
      {
        check_hlds__clause_to_proc__TypeCtorInfo_30_30 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
        check_hlds__clause_to_proc__TypeCtorInfo_31_31 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
        {
          check_hlds__clause_to_proc__succeeded = mercury__map__is_empty_1_p_0(check_hlds__clause_to_proc__TypeCtorInfo_30_30, check_hlds__clause_to_proc__TypeCtorInfo_31_31, check_hlds__clause_to_proc__Procs0_7);
        }
      }
    if (check_hlds__clause_to_proc__succeeded)
      {
        MR_Word check_hlds__clause_to_proc__TypeCtorInfo_32_32;
        MR_Integer check_hlds__clause_to_proc__PredArity_10;
        MR_Integer check_hlds__clause_to_proc__FuncArity_11;
        MR_Word check_hlds__clause_to_proc__InMode_12;
        MR_Word check_hlds__clause_to_proc__FuncArgModes_14;
        MR_Word check_hlds__clause_to_proc__FuncRetMode_15;
        MR_Word check_hlds__clause_to_proc__PredArgModes_16;
        MR_Word check_hlds__clause_to_proc__Context_18;
        MR_Word check_hlds__clause_to_proc__InstVarSet_20;
        MR_Integer check_hlds__clause_to_proc__ProcId_22;
        MR_Word check_hlds__clause_to_proc__Var_24;
        MR_Word check_hlds__clause_to_proc__Var_26;

        {
          check_hlds__clause_to_proc__PredArity_10 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(check_hlds__clause_to_proc__PredInfo0_4);
        }
        check_hlds__clause_to_proc__FuncArity_11 = (check_hlds__clause_to_proc__PredArity_10 - (MR_Integer) 1);
        {
          parse_tree__prog_mode__in_mode_1_p_0(&check_hlds__clause_to_proc__InMode_12);
        }
        {
          parse_tree__prog_mode__out_mode_1_p_0(&check_hlds__clause_to_proc__FuncRetMode_15);
        }
        check_hlds__clause_to_proc__TypeCtorInfo_32_32 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0;
        {
          mercury__list__duplicate_3_p_0(check_hlds__clause_to_proc__TypeCtorInfo_32_32, check_hlds__clause_to_proc__FuncArity_11, ((MR_Box) (check_hlds__clause_to_proc__InMode_12)), &check_hlds__clause_to_proc__FuncArgModes_14);
        }
        {
          check_hlds__clause_to_proc__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__Var_24, 0) = ((MR_Box) (check_hlds__clause_to_proc__FuncRetMode_15));
          MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mercury__list__append_3_p_1(check_hlds__clause_to_proc__TypeCtorInfo_32_32, check_hlds__clause_to_proc__FuncArgModes_14, check_hlds__clause_to_proc__Var_24, &check_hlds__clause_to_proc__PredArgModes_16);
        }
        {
          hlds__hlds_pred__pred_info_get_context_2_p_0(check_hlds__clause_to_proc__PredInfo0_4, &check_hlds__clause_to_proc__Context_18);
        }
        {
          mercury__varset__init_1_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0, &check_hlds__clause_to_proc__InstVarSet_20);
        }
        {
          check_hlds__clause_to_proc__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__Var_26, 0) = ((MR_Box) (check_hlds__clause_to_proc__PredArgModes_16));
        }
        {
          hlds__make_hlds__add_new_proc_14_p_0(check_hlds__clause_to_proc__Context_18, (MR_Integer) -1, check_hlds__clause_to_proc__PredArity_10, check_hlds__clause_to_proc__InstVarSet_20, check_hlds__clause_to_proc__PredArgModes_16, check_hlds__clause_to_proc__Var_26, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 1, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__clause_to_proc_scalar_common_5[0]), (MR_Integer) 1, (MR_Integer) 1, check_hlds__clause_to_proc__PredInfo0_4, check_hlds__clause_to_proc__PredInfo_5, &check_hlds__clause_to_proc__ProcId_22);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *check_hlds__clause_to_proc__MaybeProcId_6 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (check_hlds__clause_to_proc__ProcId_22));
        }
      }
    else
      {
...
{
  {
    ...
    {
      check_hlds__clause_to_proc__succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__220__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 4))));
    }
    return check_hlds__clause_to_proc__succeeded;
  }
}
...
{
  {
    ...
    {
      check_hlds__clause_to_proc__succeeded = check_hlds__clause_to_proc__IntroducedFrom__pred__copy_clauses_to_proc__219__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__closure, (MR_Integer) 4))));
    }
    return check_hlds__clause_to_proc__succeeded;
  }
}
...
{
  {
    ...
    MR_Word check_hlds__clause_to_proc__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__ClausesInfo_6, (MR_Integer) 1)));
    MR_Word check_hlds__clause_to_proc__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__ClausesInfo_6, (MR_Integer) 2)));
    ...
    if ((check_hlds__clause_to_proc__ClausesDisjuncts_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        MR_Word check_hlds__clause_to_proc__Var_84;
        MR_Word check_hlds__clause_to_proc__Var_88;
        ...
        {
          check_hlds__clause_to_proc__Var_84 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) &check_hlds__clause_to_proc_scalar_common_2[4], check_hlds__clause_to_proc__HeadVars_12);
        }
        {
          check_hlds__clause_to_proc__NonLocalVars_74 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__clause_to_proc__Var_84);
        }
        {
        ...
        {
          check_hlds__clause_to_proc__Var_88 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_88, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_88, 1) = ((MR_Box) (check_hlds__clause_to_proc__ClausesDisjuncts_20));
        }
        {
          check_hlds__clause_to_proc__Goal_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Goal_65, 0) = ((MR_Box) (check_hlds__clause_to_proc__Var_88));
          MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Goal_65, 1) = ((MR_Box) (check_hlds__clause_to_proc__GoalInfo_78));
        }
      }
    else
      {
        MR_Word check_hlds__clause_to_proc__Var_172 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__ClausesDisjuncts_20, (MR_Integer) 1)));
        MR_Word check_hlds__clause_to_proc__Var_173 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__clause_to_proc__ClausesDisjuncts_20, (MR_Integer) 0)));
        MR_Word check_hlds__clause_to_proc__Var_174 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_173, (MR_Integer) 1)));
        MR_Word check_hlds__clause_to_proc__Var_175 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_173, (MR_Integer) 0)));

        if ((check_hlds__clause_to_proc__Var_172 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            switch (MR_tag((MR_Word) check_hlds__clause_to_proc__Var_175)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                check_hlds__clause_to_proc__VarSet_34 = check_hlds__clause_to_proc__VarSet0_8;
                break;
              ...
              case (MR_Integer) 2:
                ...
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 0)))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 2:
                  case (MR_Integer) 3:
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word check_hlds__clause_to_proc__Args_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 4)));
                      MR_Word check_hlds__clause_to_proc__ExtraArgs_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 5)));
                      MR_Word check_hlds__clause_to_proc__MaybeTraceRuntimeCond_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 6)));
                      MR_Word check_hlds__clause_to_proc__Var_91;
                      MR_Word check_hlds__clause_to_proc__Var_96;
                      MR_Word check_hlds__clause_to_proc__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 1)));
                      MR_Word check_hlds__clause_to_proc__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 2)));
                      MR_Integer check_hlds__clause_to_proc__Var_29 = ((MR_Integer) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 3)));
                      MR_Word check_hlds__clause_to_proc__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_175, (MR_Integer) 7)));
                      ...
                      {
                        check_hlds__clause_to_proc__Var_91 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_91, 0) = ((MR_Box) (&check_hlds__clause_to_proc_scalar_common_4[1]));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_91, 1) = ((MR_Box) (check_hlds__clause_to_proc__copy_clauses_to_proc_4_p_0_4));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_91, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_91, 3) = ((MR_Box) (check_hlds__clause_to_proc__ExtraArgs_31));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_91, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        mercury__require__expect_4_p_0(check_hlds__clause_to_proc__Var_91, (MR_String) "check_hlds.clause_to_proc", (MR_String) "predicate \140check_hlds.clause_to_proc.copy_clauses_to_proc\'/4", (MR_String) "extra_args");
                      }
                      {
                        check_hlds__clause_to_proc__Var_96 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_96, 0) = ((MR_Box) (&check_hlds__clause_to_proc_scalar_common_4[2]));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_96, 1) = ((MR_Box) (check_hlds__clause_to_proc__copy_clauses_to_proc_4_p_0_5));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_96, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_96, 3) = ((MR_Box) (check_hlds__clause_to_proc__MaybeTraceRuntimeCond_32));
                        MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Var_96, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        mercury__require__expect_4_p_0(check_hlds__clause_to_proc__Var_96, (MR_String) "check_hlds.clause_to_proc", (MR_String) "predicate \140check_hlds.clause_to_proc.copy_clauses_to_proc\'/4", (MR_String) "trace runtime cond");
                      }
                    }
                    break;
                }
            ...
            check_hlds__clause_to_proc__Goal_65 = check_hlds__clause_to_proc__Var_173;
          }
        else
          {
            ...
            MR_Word check_hlds__clause_to_proc__Var_146;
            MR_Word check_hlds__clause_to_proc__Var_150;

            {
              check_hlds__clause_to_proc__Context_138 = hlds__hlds_goal__goal_info_get_context_1_f_0(check_hlds__clause_to_proc__Var_174);
            }
            check_hlds__clause_to_proc__VarSet_34 = check_hlds__clause_to_proc__VarSet0_8;
            {
            ...
            {
              check_hlds__clause_to_proc__Var_146 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) &check_hlds__clause_to_proc_scalar_common_2[4], check_hlds__clause_to_proc__HeadVars_12);
            }
            {
              check_hlds__clause_to_proc__NonLocalVars_141 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__clause_to_proc__Var_146);
            }
            {
            ...
            {
              check_hlds__clause_to_proc__Var_150 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_150, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(3), check_hlds__clause_to_proc__Var_150, 1) = ((MR_Box) (check_hlds__clause_to_proc__ClausesDisjuncts_20));
            }
            {
              check_hlds__clause_to_proc__Goal_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Goal_65, 0) = ((MR_Box) (check_hlds__clause_to_proc__Var_150));
...
{
  {
    ...
    if ((check_hlds__clause_to_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word check_hlds__clause_to_proc__Var_13;
        MR_Word check_hlds__clause_to_proc__Var_14;
        MR_Word check_hlds__clause_to_proc__Var_15;
        MR_Word check_hlds__clause_to_proc__Var_16;
        ...
        check_hlds__clause_to_proc__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_4, (MR_Integer) 0)));
        check_hlds__clause_to_proc__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_4, (MR_Integer) 1)));
        check_hlds__clause_to_proc__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_4, (MR_Integer) 2)));
        check_hlds__clause_to_proc__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_4, (MR_Integer) 3)));
    ...
    if ((check_hlds__clause_to_proc__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *check_hlds__clause_to_proc__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        MR_Word check_hlds__clause_to_proc__Var_12;
        MR_Word check_hlds__clause_to_proc__Var_13;
        MR_Word check_hlds__clause_to_proc__Var_14;
        MR_Word check_hlds__clause_to_proc__Var_15;
        ...
        check_hlds__clause_to_proc__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_5, (MR_Integer) 1)));
        check_hlds__clause_to_proc__Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_5, (MR_Integer) 2)));
        check_hlds__clause_to_proc__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_5, (MR_Integer) 3)));
        check_hlds__clause_to_proc__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__clause_to_proc__Clause_5, (MR_Integer) 4)));
        ...
        if (check_hlds__clause_to_proc__succeeded)
          {
            ...
            {
              MR_Word check_hlds__clause_to_proc__Var_4;

              {
                check_hlds__clause_to_proc__Var_4 = hlds__hlds_goal__goal_get_purity_1_f_0(check_hlds__clause_to_proc__Goal_2);
              }
              check_hlds__clause_to_proc__succeeded = (check_hlds__clause_to_proc__Var_4 == (MR_Integer) 0);
              check_hlds__clause_to_proc__succeeded = !(check_hlds__clause_to_proc__succeeded);
            }
            if (!(check_hlds__clause_to_proc__succeeded))
              {
                /* direct tailcall eliminated */
                {
                  MR_Word check_hlds__clause_to_proc__next_value_of_HeadVar__1_1 = check_hlds__clause_to_proc__Goals_3;
