  ...
  MR_Word * STATE_VARIABLE_PredIdTable_9)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_6, &ProcMap0_21);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (check_hlds__clause_to_proc__copy_pred_clauses_to_nonmethod_procs_in_pred_id_table_3_p_0_1));
  ...
  MR_Word * STATE_VARIABLE_PredIdTable_9)
{
  ...
  hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_6, &ProcMap0_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (check_hlds__clause_to_proc__copy_pred_clauses_to_procs_in_pred_id_table_3_p_0_1));
