  ...
  MR_Word * STATE_VARIABLE_ProcInfo_80)
{
  ...
  MR_Word STATE_VARIABLE_ProcInfo_1_81;
  MR_Word Origin_132;
  ...
  if ((StateVarWarnings_22 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_ProcInfo_1_81 = STATE_VARIABLE_ProcInfo_0_79;
  else
    hlds__hlds_pred__proc_info_set_statevar_warnings_3_p_0(StateVarWarnings_22, STATE_VARIABLE_ProcInfo_0_79, &STATE_VARIABLE_ProcInfo_1_81);
  if ((ClausesDisjuncts_21 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    hlds__hlds_pred__proc_info_get_context_2_p_0(STATE_VARIABLE_ProcInfo_1_81, &Context_72);
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Purity_1_157;
      ...
      STATE_VARIABLE_Purity_1_157 = parse_tree__prog_data__worst_purity_2_f_0((MR_Integer) 0, DisjunctPurity_154);
      check_hlds__clause_to_proc__accumulate_disjunction_purity_3_p_0(Disjuncts_153, STATE_VARIABLE_Purity_1_157, &DisjunctionPurity_108);
  ...
  hlds__hlds_pred__proc_info_set_body_6_p_0(VarTable_35, HeadVarList_78, Goal_66, RttiVarMaps_12, STATE_VARIABLE_ProcInfo_1_81, STATE_VARIABLE_ProcInfo_80);
}
