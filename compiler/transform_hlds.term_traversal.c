...
static void MR_CALL 
transform_hlds__term_traversal__params_get_max_paths_2_p_0(
  MR_Word Params_3,
  MR_Integer * X_4);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_24_24 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Word * Info_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      transform_hlds__term_traversal__params_get_max_paths_2_p_0(Params_7, &MaxPaths_21);
...
transform_hlds__term_traversal__params_get_max_paths_2_p_0(
  ...
  MR_Integer * X_4)
{
  *X_4 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Params_3, (MR_Integer) 7))));
}
...
transform_hlds__term_traversal__params_get_context_2_p_0(
  ...
  MR_Word * X_4)
{
  *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Params_3, (MR_Integer) 2))));
}
