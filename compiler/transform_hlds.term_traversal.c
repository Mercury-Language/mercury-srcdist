...
MR_decl_label4(transform_hlds__term_traversal__compute_rec_start_vars_3_0, 3,10,9,44)
MR_decl_label4(transform_hlds__term_traversal__error_if_intersect_5_0, 29,5,6,4)
MR_decl_label6(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0, 3,9,10,13,12,8)
MR_decl_label4(transform_hlds__term_traversal__record_change_6_0, 15,4,5,6)
MR_decl_label8(transform_hlds__term_traversal__record_change_2_7_0, 27,3,5,7,8,9,4,12)
MR_decl_label4(transform_hlds__term_traversal__some_active_vars_in_bag_2_0, 22,5,3,1)
...
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 321,3,4,5,2,6,9,10,12,13)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 14,17,15,22,21,8,30,29,32,35)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 37,38,40,41,43,45,47,50,51,49)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 42,34,60,61,62,57,63,66,67,69)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 70,71,72,73,76,77,78,75,83,82)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 86,91,87,92,94,95,98,93,101,102)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 104,100,65,110,112,117,118,119,116,124)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 126,122,121,131,133,134,130,129,137,114)
MR_decl_label5(transform_hlds__term_traversal__term_traverse_switch_8_0, 4,3,6,7,8)
MR_decl_label7(transform_hlds__term_traversal__unify_change_9_0, 2,5,11,12,13,14,1)
MR_decl_label2(transform_hlds__term_traversal__upper_bound_active_vars_2_0, 17,5)
MR_decl_label5(__Unify___transform_hlds__term_traversal__term_path_info_0_0, 4,6,8,12,1)
MR_decl_label5(__Unify___transform_hlds__term_traversal__term_traversal_info_0_0, 7,21,5,12,1)
MR_decl_label8(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0, 4,6,8,10,12,14,16,1)
MR_decl_label7(__Compare___transform_hlds__term_traversal__term_path_info_0_0, 3,2,5,9,13,17,60)
MR_decl_label8(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0, 3,2,9,7,5,15,17,66)
MR_decl_label10(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0, 3,2,5,9,13,17,21,25,29,93)
...
MR_decl_static(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0)
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module7)
	...
	MR_init_label4(transform_hlds__term_traversal__compute_rec_start_vars_3_0,3,10,9,44)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__compute_rec_start_vars_3_0,10)
	...
	if (MR_INT_EQ(MR_sv(1),0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__compute_rec_start_vars_3_0_i44);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__compute_rec_start_vars_3_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module8)
	MR_init_entry1(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0);
	MR_init_label6(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,3,9,10,13,12,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'filter_typeinfos_from_args_and_modes'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i8);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_localcall_lab(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,
		transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i9);
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(parse_tree__prog_data__lookup_var_type_3_0,
		transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i10);
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__prog_type__is_introduced_type_info_type_1_0,
		transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i13);
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0_i12);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	...
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.term_traversal", 29);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.term_traversal.filter_typeinfos_from_args_and_modes\'/5", 80);
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module10)
	...
	MR_init_label7(transform_hlds__term_traversal__unify_change_9_0,2,5,11,12,13,14,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__unify_change_9_0,5)
	...
	MR_r1 = MR_sv(6);
	if (MR_RTAGS_TEST(MR_sv(1),3,12)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__unify_change_9_0_i1);
	}
	if (MR_RTAGS_TEST(MR_sv(1),3,13)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__unify_change_9_0_i1);
	}
...
MR_def_label(transform_hlds__term_traversal__unify_change_9_0,11)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__filter_typeinfos_from_args_and_modes_5_0,
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module11)
	...
	MR_init_label8(transform_hlds__term_traversal__record_change_2_7_0,27,3,5,7,8,9,4,12)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,5)
	...
	MR_sv(10) = ((MR_Integer) MR_sv(3) + (MR_Integer) MR_sv(11));
...
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,9)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_traversal, term_path_info);
	MR_np_call_localret_ent(set__insert_3_0,
		transform_hlds__term_traversal__record_change_2_7_0_i12);
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,4)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		transform_hlds__term_traversal__record_change_2_7_0_i12);
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(transform_hlds__term_traversal__record_change_2_7_0_i27);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module13)
	...
	MR_init_label4(transform_hlds__term_traversal__some_active_vars_in_bag_2_0,22,5,3,1)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_traversal__some_active_vars_in_bag_2_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_traversal__some_active_vars_in_bag_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__some_active_vars_in_bag_2_0,5)
	...
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__term_traversal__some_active_vars_in_bag_2_0_i22);
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module18)
	...
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,321,3,4,5,2,6,9,10,12,13)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,14,17,15,22,21,8,30,29,32,35)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,37,38,40,41,43,45,47,50,51,49)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,42,34,60,61,62,57,63,66,67,69)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,70,71,72,73,76,77,78,75,83,82)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,86,91,87,92,94,95,98,93,101,102)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,104,100,65,110,112,117,118,119,116,124)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,126,122,121,131,133,134,130,129,137,114)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,321)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,10)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i12);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,14)
	...
	MR_np_call_localret_ent(transform_hlds__term_util__is_termination_known_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i17);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i15);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(2);
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__error_if_intersect_5_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,15)
	...
	MR_np_call_localret_ent(transform_hlds__term_util__attributes_imply_termination_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i22);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i21);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(2);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__error_if_intersect_5_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,8)
	...
	if (MR_RTAGS_TESTR(MR_sv(3),3,2)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i29);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = MR_tfield(3, MR_sv(3), 2);
	MR_np_call_localret_ent(list__reverse_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i30);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,3)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i32);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i34);
	}
	MR_r2 = MR_sv(3);
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i35);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),3)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i37);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(7);
	MR_decr_sp_and_return(11);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,38)
	...
	if (MR_PTAG_TESTR(MR_sv(3),2)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i40);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(7);
	MR_decr_sp_and_return(11);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_ho_values_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i41);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,41)
	...
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i43);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i42);
	}
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, pred_proc_id);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__set__to_sorted_list_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i45);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(list__filter_4_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i47);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i49);
	}
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(2);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,50)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__params_get_ppid_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i51);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__error_if_intersect_5_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,42)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__add_error_5_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,6)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i57);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__term_traverse_conj_8_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i60);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,60)
	...
	MR_np_localcall_lab(transform_hlds__term_traversal__term_traverse_goal_8_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i61);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__combine_paths_4_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i62);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_decr_sp_and_return(11);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i63);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(11);
	MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i321);
	}
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),2)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i65);
	}
	MR_r2 = MR_sv(3);
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i66);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(transform_hlds__term_traversal__params_get_ppid_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i67);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,70)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_maybe_arg_size_info_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i71);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_sv(6) = MR_r1;
	MR_r1 = MR_r2;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,73)
	...
	if (MR_LTAGS_TESTR(MR_sv(6),0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i75);
	}
	MR_sv(6) = MR_r1;
	MR_sv(10) = MR_r2;
	MR_r1 = MR_sv(1);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,76)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i77);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__term_util__remove_unused_args_4_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i78);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,78)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__record_change_6_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i86);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,75)
	...
	if (MR_PTAG_TESTR(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i82);
	}
	...
	MR_np_call_localret_ent(transform_hlds__term_util__remove_unused_args_4_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i83);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(10);
	MR_r3 = MR_sv(6);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,86)
	...
	if (MR_LTAGS_TEST(MR_sv(5),0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i87);
	}
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__called_can_loop_5_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i91);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i92);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_r3;
	MR_sv(6) = MR_r4;
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(transform_hlds__term_traversal__params_get_var_types_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i94);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i93);
	}
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,98)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__params_get_rec_input_suppliers_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i101);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_sv(6);
	MR_np_call_localret_ent(transform_hlds__term_traversal__params_get_rec_input_suppliers_2_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i101);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i100);
	}
	MR_r1 = MR_sv(9);
	MR_np_call_localret_ent(transform_hlds__term_traversal__compute_rec_start_vars_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i104);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,104)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__add_path_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(7);
	MR_decr_sp_and_return(11);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,65)
	...
	if (MR_RTAGS_TESTR(MR_sv(3),3,5)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i110);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,110)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(3),3,4)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i112);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,112)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i114);
	}
	MR_r2 = MR_tfield(1, MR_sv(3), 3);
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i116);
	}
	MR_sv(7) = MR_r1;
	MR_sv(3) = MR_tfield(2, MR_r2, 0);
	...
	MR_np_call_localret_ent(bag__init_1_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i117);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,117)
	...
	MR_np_call_localret_ent(bag__insert_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i118);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,118)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(bag__insert_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i119);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,119)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__record_change_6_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i122);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(bag__insert_3_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i126);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__record_change_6_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,122)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,121)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i129);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__unify_change_9_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i131);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,131)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__term_traverse_goal_8_0_i130);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,133)
	...
	MR_np_call_localret_ent(transform_hlds__term_traversal__record_change_6_0,
		transform_hlds__term_traversal__term_traverse_goal_8_0_i134);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
	MR_decr_sp_and_return(11);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,130)
	...
	MR_decr_sp(11);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,129)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,137)
	...
	MR_decr_sp(11);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__term_traversal__term_traverse_goal_8_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.term_traversal", 29);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.term_traversal.term_traverse_goal\'/8", 62);
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module22)
	...
	MR_init_label2(transform_hlds__term_traversal__upper_bound_active_vars_2_0,17,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__term_traversal__upper_bound_active_vars_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__upper_bound_active_vars_2_0_i17);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_tailcall_ent(bag__init_1_0);
MR_def_label(transform_hlds__term_traversal__upper_bound_active_vars_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_np_localcall_lab(transform_hlds__term_traversal__upper_bound_active_vars_2_0,
		transform_hlds__term_traversal__upper_bound_active_vars_2_0_i5);
MR_def_label(transform_hlds__term_traversal__upper_bound_active_vars_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module23)
	...
	MR_init_label5(__Unify___transform_hlds__term_traversal__term_path_info_0_0,4,6,8,12,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__term_traversal__term_path_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_path_info_0_0_i12);
	}
	MR_incr_sp(9);
...
MR_def_label(__Unify___transform_hlds__term_traversal__term_path_info_0_0,4)
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___transform_hlds__term_traversal__term_path_info_0_0_i6);
MR_def_label(__Unify___transform_hlds__term_traversal__term_path_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_path_info_0_0_i1);
	}
	...
	MR_r3 = MR_sv(7);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___transform_hlds__term_traversal__term_path_info_0_0_i8);
MR_def_label(__Unify___transform_hlds__term_traversal__term_path_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_path_info_0_0_i1);
	}
...
MR_def_label(__Unify___transform_hlds__term_traversal__term_path_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module24)
	...
	MR_init_label7(__Compare___transform_hlds__term_traversal__term_path_info_0_0,3,2,5,9,13,17,60)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_path_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_path_info_0_0_i60);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__term_traversal__term_path_info_0_0_i9);
MR_def_label(__Compare___transform_hlds__term_traversal__term_path_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_path_info_0_0_i60);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___transform_hlds__term_traversal__term_path_info_0_0_i13);
MR_def_label(__Compare___transform_hlds__term_traversal__term_path_info_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_path_info_0_0_i60);
	}
	...
	MR_r3 = MR_sv(7);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__term_traversal__term_path_info_0_0_i17);
MR_def_label(__Compare___transform_hlds__term_traversal__term_path_info_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_path_info_0_0_i60);
	}
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_path_info_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module26)
	...
	MR_init_label8(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0,3,2,9,7,5,15,17,66)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0_i66);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,6);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0,17)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_info_0_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module27)
	...
	MR_init_label8(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0,4,6,8,10,12,14,16,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__term_traversal__term_traversal_params_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0_i16);
	}
	MR_incr_sp(15);
...
MR_def_label(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0,8)
	...
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___transform_hlds__term_traversal__term_traversal_params_0_0_i10);
MR_def_label(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0_i1);
	}
	...
	MR_r3 = MR_sv(11);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___transform_hlds__term_traversal__term_traversal_params_0_0_i12);
MR_def_label(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_traversal__term_traversal_params_0_0_i1);
	}
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module28)
	...
	MR_init_label10(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,3,2,5,9,13,17,21,25,29,93)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i93);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__pred_proc_id_0_0,
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,13)
	...
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i17);
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i93);
	}
	...
	MR_r3 = MR_sv(11);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i21);
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i93);
	}
	...
	MR_r3 = MR_sv(12);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i25);
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i93);
	}
	...
	MR_r2 = MR_sv(13);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i29);
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0_i93);
	}
...
MR_def_label(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__term_traversal__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__term_traversal);
