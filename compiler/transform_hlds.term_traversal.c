            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  transform_hlds__term_traversal__record_change_6_p_0(InVars_172, OutVars_175, Gamma_171, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                }
                else
                {
                  {
            ...
            case (MR_Integer) 2:
              {
                ...
                transform_hlds__term_traversal__record_change_6_p_0(InVars_183, OutVars_184, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
              }
              break;
            case (MR_Integer) 3:
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) Var_241)) == (MR_mktag((MR_Integer) 0))))
            {
              ...
              transform_hlds__term_traversal__record_change_6_p_0(UsedInVars_55, OutVars_190, CallGamma_53, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Info_112_112, &STATE_VARIABLE_Info_149_149);
            }
            else
            {
              MR_Word Var_145;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_150, (MR_Integer) 0)));
          }
          if (succeeded)
          {
            MR_Word Var_151;
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) Details_72)) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_219, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                      }
                    }
                    else
                    {
                ...
                case (MR_Integer) 1:
                  {
                    transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_219, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                  }
                  break;
                case (MR_Integer) 2:
                  *STATE_VARIABLE_Info_110 = STATE_VARIABLE_Info_112_112;
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                transform_hlds__term_traversal__error_if_intersect_5_p_0(OutVars_192, Context_195, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
              }
              else
              {
