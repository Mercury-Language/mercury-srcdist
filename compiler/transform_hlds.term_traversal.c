...
#line 55 "transform_hlds.term_traversal.c"
...
#endif
#line 64 "transform_hlds.term_traversal.c"
...
MR_decl_label4(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0, 2,3,6,1)
...
MR_decl_label8(transform_hlds__term_traversal__combine_paths_4_0, 6,7,8,9,11,10,12,5)
MR_decl_label8(transform_hlds__term_traversal__combine_paths_4_0, 14,15,3,18,19,17,20,21)
MR_decl_label2(transform_hlds__term_traversal__combine_paths_4_0, 22,23)
MR_decl_label4(transform_hlds__term_traversal__compute_rec_start_vars_3_0, 3,10,9,40)
...
MR_decl_label8(transform_hlds__term_traversal__record_change_2_7_0, 20,3,5,7,8,9,4,11)
MR_decl_label4(transform_hlds__term_traversal__some_active_vars_in_bag_2_0, 18,5,3,1)
MR_decl_label3(transform_hlds__term_traversal__traverse_conj_8_0, 10,3,4)
MR_decl_label5(transform_hlds__term_traversal__traverse_disj_8_0, 4,3,5,6,7)
...
MR_decl_label5(transform_hlds__term_traversal__traverse_switch_8_0, 4,3,5,6,7)
...
MR_decl_label2(transform_hlds__term_traversal__upper_bound_active_vars_2_0, 15,5)
...
MR_decl_static(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0)
...
static const MR_FA_TypeInfo_Struct1 mercury_data_set_ordlist__ti_set_ordlist_1transform_hlds__term_traversal__type_ctor_info_path_info_0 = {
...
const MR_PseudoTypeInfo mercury_data_transform_hlds__term_traversal__field_types_traversal_info_0_0[] = {
	(MR_PseudoTypeInfo) &mercury_data_set_ordlist__ti_set_ordlist_1transform_hlds__term_traversal__type_ctor_info_path_info_0,
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module3)
	...
	MR_init_label8(transform_hlds__term_traversal__combine_paths_4_0,6,7,8,9,11,10,12,5)
	MR_init_label8(transform_hlds__term_traversal__combine_paths_4_0,14,15,3,18,19,17,20,21)
	MR_init_label2(transform_hlds__term_traversal__combine_paths_4_0,22,23)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__combine_paths_4_0,11)
	...
	if (((MR_Integer) MR_r1 > (MR_Integer) MR_sv(4))) {
		MR_GOTO_LAB(transform_hlds__term_traversal__combine_paths_4_0_i10);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_traversal__combine_paths_4_0,5)
	...
	MR_np_call_localret_ent(list__append_3_1,
		transform_hlds__term_traversal__combine_paths_4_0_i14);
MR_def_label(transform_hlds__term_traversal__combine_paths_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_errors, termination_error_context);
	MR_r2 = MR_sv(2);
...
MR_def_label(transform_hlds__term_traversal__combine_paths_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__combine_paths_4_0_i17);
	}
	...
	MR_np_call_localret_ent(list__append_3_1,
		transform_hlds__term_traversal__combine_paths_4_0_i18);
MR_def_label(transform_hlds__term_traversal__combine_paths_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_errors, termination_error_context);
	MR_r2 = MR_sv(1);
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module8)
	...
	MR_init_label4(transform_hlds__term_traversal__compute_rec_start_vars_3_0,3,10,9,40)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__compute_rec_start_vars_3_0,10)
	...
	if (MR_INT_EQ(MR_sv(1),0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__compute_rec_start_vars_3_0_i40);
	}
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = MR_sv(2);
...
MR_def_label(transform_hlds__term_traversal__compute_rec_start_vars_3_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_traversal__unify_change_9_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0);
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module11)
	...
	MR_init_label8(transform_hlds__term_traversal__record_change_2_7_0,20,3,5,7,8,9,4,11)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__term_traversal__record_change_2_7_0,11)
	...
	MR_GOTO_LAB(transform_hlds__term_traversal__record_change_2_7_0_i20);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module20)
	...
	MR_init_label3(transform_hlds__term_traversal__traverse_conj_8_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_traversal__traverse_conj_8_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_traversal__traverse_conj_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__term_traversal__traverse_conj_8_0,4)
	...
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__term_traversal__traverse_conj_8_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module21)
	...
	MR_init_label5(transform_hlds__term_traversal__traverse_disj_8_0,4,3,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module22)
	...
	MR_init_label5(transform_hlds__term_traversal__traverse_switch_8_0,4,3,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module23)
	...
	MR_init_label2(transform_hlds__term_traversal__upper_bound_active_vars_2_0,15,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__term_traversal__upper_bound_active_vars_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_traversal__upper_bound_active_vars_2_0_i15);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_tailcall_ent(bag__init_1_0);
MR_def_label(transform_hlds__term_traversal__upper_bound_active_vars_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module30)
	MR_init_entry1(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0);
	MR_init_label4(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0,2,3,6,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(fn__pair__fst_1_0,
		transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0_i2);
MR_def_label(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	...
	MR_r4 = MR_sv(1);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0_i3);
MR_def_label(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__prog_type__is_introduced_type_info_type_1_0,
		transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0_i6);
MR_def_label(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0_i1);
	}
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__530__1_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_FALSE;
