        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_traversal_scalar_common_2[1]), &Var_24, ((MR_Box) (ArgX5_12)), ((MR_Box) (ArgY5_13)));
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__term_traversal_scalar_common_2[1]), &Var_25, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_17, (MR_Integer) 5)));
                MR_Integer Gamma_26;
                MR_Word InVars_27;
                MR_Word OutVars0_28;
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_17, (MR_Integer) 4)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word InVars_189;
          MR_Word OutVars_190;
          MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_10, (MR_Integer) 3)));
          MR_Word Var_48;
          MR_Word Var_150;
          MR_Word VarTypes_59;
          ...
          succeeded = ((MR_tag((MR_Word) CallTerminationInfo_52)) == (MR_Integer) 1);
          if (succeeded)
          {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Details_72, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      if (((((MR_tag((MR_Word) ConsId_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_12, (MR_Integer) 0))) == (MR_Integer) 21))))
        succeeded = MR_TRUE;
      else
      if (((((MR_tag((MR_Word) ConsId_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_12, (MR_Integer) 0))) == (MR_Integer) 22))))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
      succeeded = !(succeeded);
