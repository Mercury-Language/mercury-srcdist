            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  transform_hlds__term_traversal__record_change_6_p_0(InVars_27, OutVars_29, Gamma_26, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                }
                else
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  transform_hlds__term_traversal__record_change_6_p_0(InVars_172, OutVars_175, Gamma_171, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                }
                else
                {
                  {
            ...
            case (MR_Integer) 2:
              {
                ...
                transform_hlds__term_traversal__record_change_6_p_0(InVars_183, OutVars_184, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
              }
              break;
            case (MR_Integer) 3:
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((CallArgSizeInfo_51 == (MR_Word) ((MR_Integer) 0)))
          {
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) Var_241)) == (MR_mktag((MR_Integer) 0))))
            {
              ...
              transform_hlds__term_traversal__record_change_6_p_0(UsedInVars_55, OutVars_190, CallGamma_53, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Info_112_112, &STATE_VARIABLE_Info_149_149);
            }
            else
            {
              MR_Word Var_145;

              {
                ...
                MR_hl_field(MR_mktag(3), Var_145, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          if (succeeded)
          {
            ...
            {
              Var_153 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), NewPath_64, 3) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) Details_72)) {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if ((NonTerminating_84 == (MR_Word) ((MR_Integer) 0)))
                      {
                        MR_Word Error_85;
                        MR_Word OutVars_199;
                        MR_Word PPId_200;
                      ...
                      {
                        transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_219, (MR_Word) ((MR_Integer) 8), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                      }
                    }
                    else
                    {
                ...
                case (MR_Integer) 1:
                  {
                    transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_219, (MR_Word) ((MR_Integer) 12), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                  }
                  break;
                case (MR_Integer) 2:
                  *STATE_VARIABLE_Info_110 = STATE_VARIABLE_Info_112_112;
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                transform_hlds__term_traversal__error_if_intersect_5_p_0(OutVars_192, Context_195, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
              }
              else
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_138, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
...
{
  {
    ...
    if (succeeded)
    {
      if (((((MR_tag((MR_Word) ConsId_12)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_12, (MR_Integer) 0))) == (MR_Integer) 21))))
        succeeded = MR_TRUE;
      else
      if (((((MR_tag((MR_Word) ConsId_12)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_12, (MR_Integer) 0))) == (MR_Integer) 22))))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
      succeeded = !(succeeded);
      ...
      else
      {
        ...
        else
        {
          ...
          transform_hlds__term_traversal__params_get_context_2_p_0(Params_7, &Context_23);
          {
            ...
            MR_hl_field(MR_mktag(0), Error_24, 1) = ((MR_Box) ((MR_Integer) 20));
          }
          {
