      ...
      case (MR_Integer) 2:
        {
          ...
          if ((CallArgSizeInfo_51 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            transform_hlds__term_traversal__remove_unused_args_4_p_0(Args_188, OutputSuppliers_186, InVars_189, &UsedInVars_187);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_132, 0) = ((MR_Box) (CallPPId_47));
          ...
          else
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_129, 1) = ((MR_Box) (PPId_46));
                MR_hl_field(MR_mktag(3), Var_129, 2) = ((MR_Box) (CallPPId_47));
              }
          ...
          if (succeeded)
          {
            Var_135 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallTerminationInfo_52, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_136, 0) = ((MR_Box) (PPId_46));
              MR_hl_field(MR_mktag(1), Var_136, 1) = ((MR_Box) (CallPPId_47));
            }
          ...
          if (succeeded)
          {
            ...
            {
              Var_138 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), Var_138, 0) = ((MR_Box) (PPId_46));
              MR_hl_field(MR_mktag(2), Var_138, 1) = ((MR_Box) (CallPPId_47));
            }
            transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_45, Var_138, STATE_VARIABLE_Info_137_137, &STATE_VARIABLE_Info_139_139);
          }
          else
          ...
          if (succeeded)
          {
            ...
            transform_hlds__term_traversal__compute_rec_start_vars_3_p_0(Args_188, RecInputSuppliers_61, &Bag_62);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_140, 0) = ((MR_Box) (CallPPId_47));
              MR_hl_field(MR_mktag(0), Var_140, 1) = ((MR_Box) (Context_45));
            }
            {
              PathStart_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), PathStart_63, 0) = ((MR_Box) (Var_140));
            }
            {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      ClosureValues_82 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), ClosureValues0_81);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_152, 0) = ((MR_Box) (&transform_hlds__term_traversal_scalar_common_3[1]));
                        MR_hl_field(MR_mktag(0), Var_152, 1) = ((MR_Box) (transform_hlds__term_traversal__term_traverse_goal_5_p_0_2));
                        MR_hl_field(MR_mktag(0), Var_152, 2) = ((MR_Box) ((MR_Integer) 1));
                        MR_hl_field(MR_mktag(0), Var_152, 3) = ((MR_Box) (ModuleInfo_6));
                      }
          ...
          case (MR_Integer) 1:
            {
              ...
              Context_195 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_145, 0) = ((MR_Box) (CallPredId_193));
                MR_hl_field(MR_mktag(0), Var_145, 1) = ((MR_Box) (CallProcId_194));
              }
              ...
              else
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_150, 1) = ((MR_Box) (CallPredId_193));
                  }
                  transform_hlds__term_traversal__add_error_5_p_0(Params_7, Context_195, Var_150, STATE_VARIABLE_Info_112_112, STATE_VARIABLE_Info_110);
                }
              }
            }
            break;
          ...
          case (MR_Integer) 6:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_164, 0) = ((MR_Box) (Cond_101));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_163, 0) = ((MR_Box) (Then_102));
                MR_hl_field(MR_mktag(1), Var_163, 1) = ((MR_Box) (Var_164));
              }
              transform_hlds__term_traversal__term_traverse_rev_conj_5_p_0(ModuleInfo_6, Params_7, Var_163, STATE_VARIABLE_Info_112_112, &CondThenInfo_104);
  ...
  MR_Word * Info_10)
{
  if (((MR_tag((MR_Word) Info0_9)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), CanLoop1_13, 0) = ((MR_Box) (Var_17));
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), CanLoop1_20, 0) = ((MR_Box) (Var_18));
  ...
  MR_Word * Info_10)
{
  if (((MR_tag((MR_Word) Info0_9)) == (MR_Integer) 1))
  {
    ...
    {
      Var_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (Context_7));
      MR_hl_field(MR_mktag(0), Var_18, 1) = ((MR_Box) (ErrorKind_8));
    }
    {
      Errors1_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Errors1_13, 0) = ((MR_Box) (Var_18));
  ...
  else
  {
    ...
    {
      Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (ErrorContext_17));
      MR_hl_field(MR_mktag(1), Var_19, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      MR_Word base;
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Error_24));
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__bag__delete_3_p_0((MR_Word) (&transform_hlds__term_traversal_scalar_common_1[0]), ((MR_Box) (Var_34)), STATE_VARIABLE_Vars_0_3, &STATE_VARIABLE_Vars_30_30);
              // direct tailcall eliminated
              ;
