...
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 238,3,4,5,2,127,138,141,144,139)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 147,149,152,148,154,129,131,132,133,161)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 135,136,73,74,75,77,78,79,80,81)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 84,86,87,83,92,91,95,100,96,101)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 103,104,107,102,110,112,114,109,35,36)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 42,43,47,49,51,54,55,53,44,39)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 38,166,8,9,10,13,14,15,18,16)
MR_decl_label10(transform_hlds__term_traversal__term_traverse_goal_8_0, 23,22,27,30,31,33,65,68,69,70)
...
MR_decl_label10(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0, 3,2,5,9,13,18,23,28,32,72)
...
MR_def_label(transform_hlds__term_traversal__add_error_5_0,3)
	...
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_tempr2;
	MR_tfield(1, MR_tempr3, 1) = MR_tfield(0, MR_r4, 1);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__term_traversal__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module18)
	...
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,238,3,4,5,2,127,138,141,144,139)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,147,149,152,148,154,129,131,132,133,161)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,135,136,73,74,75,77,78,79,80,81)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,84,86,87,83,92,91,95,100,96,101)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,103,104,107,102,110,112,114,109,35,36)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,42,43,47,49,51,54,55,53,44,39)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,38,166,8,9,10,13,14,15,18,16)
	MR_init_label10(transform_hlds__term_traversal__term_traverse_goal_8_0,23,22,27,30,31,33,65,68,69,70)
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module28)
	...
	MR_init_label10(__Compare___transform_hlds__term_traversal__term_traversal_params_0_0,3,2,5,9,13,18,23,28,32,72)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_traversal_module29)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__term_traversal__IntroducedFrom__pred__filter_args_and_modes__545__1_2_0);
