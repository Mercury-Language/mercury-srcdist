          ...
          case (MR_Integer) 11:
            {
              ...
              {
                LHSRval_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    else
                    {
                      ...
                      {
                        LHSSectagWordLval_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      {
                        LHSSectagWordRval_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                      ...
                      else
                      {
                        ...
                        {
                          ComplementMask_76 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        {
                          MaskedOldSectagWordRval_77 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        {
                          NewSectagWordRval_78 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) ArgPosWidth_32)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ArgPosWidth_32, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      case (MR_Integer) 0:
        {
          switch (MR_tag((MR_Word) ArgPosWidth_23)) {
            ...
            case (MR_Integer) 2:
              ...
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ArgPosWidth_23, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned Var_75;
                    MR_Unsigned Var_76;
                    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_23, (MR_Integer) 6)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Var_45;
            MR_Word Var_46;
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_10, (MR_Integer) 6)));
            ...
            {
              MaskedLeftRval0_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_CLD_9)
{
  ...
  else
  {
    ...
    else
    {
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), ArgPosWidth_52, (MR_Integer) 2)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_52, (MR_Integer) 6)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_52, (MR_Integer) 6)));
      ...
      {
        LHSField_69 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_63;
              MR_Word LHSLval_89;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_15, (MR_Integer) 6)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_114;
              MR_Word LHSLval_116;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArgPosWidth_15, (MR_Integer) 6)));
