  ...
  MR_Word * STATE_VARIABLE_CLD_34)
{
  ...
  switch (CanFail_16) {
    ...
    case (MR_Integer) 0:
      ll_backend__unify_gen_deconstruct__generate_semi_deconstruction_9_p_0(LHSVar_12, ConsId_13, RHSVars_14, ArgModes_15, &DeconstructCode_21, STATE_VARIABLE_CI_0_31, STATE_VARIABLE_CI_32, STATE_VARIABLE_CLD_0_33, &STATE_VARIABLE_CLD_37_37);
      break;
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_22, LHSVar_12, &LHSVarEntry_23);
        LHSVarName_24 = hlds__var_table__var_entry_name_2_f_0(LHSVar_12, LHSVarEntry_23);
  ...
  MR_Word * STATE_VARIABLE_CLD_33)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_19, LHSVar_10, &LHSVarEntry_20);
  LHSVarName_21 = hlds__var_table__var_entry_name_2_f_0(LHSVar_10, LHSVarEntry_20);
  ...
  MR_Word * STATE_VARIABLE_CLD_34)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_25, RHSVar_22, &RHSVarEntry_26);
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (RHSVar_22));
                  }
                  LeftShiftedRHSRval_59 = ll_backend__unify_gen_util__left_shift_rval_3_f_0(Var_75, Shift_53, Fill_56);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  Var_79 = mercury__uint__cast_from_int_1_f_0(MaskInt_58);
                  Var_78 = mercury__uint__f_60_60_2_f_0(Var_79, ShiftInt_57);
                  *STATE_VARIABLE_ToOrMask_32 = (Var_78 | STATE_VARIABLE_ToOrMask_0_31);
                }
                break;
              case (MR_Integer) 2:
                {
  ...
  MR_Word * STATE_VARIABLE_CLD_9)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__var_table__lookup_var_entry_3_p_0(VarTable_1, RHSVar_51, &RHSVarEntry_53);
