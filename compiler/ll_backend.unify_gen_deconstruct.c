        ...
        case (MR_Integer) 11:
          {
            ...
            switch (MR_tag((MR_Word) RemoteArgsTagInfo_51)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word LHSPtag_153 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RemoteArgsTagInfo_51, (MR_Integer) 0))));
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (RHSVar_22));
                  }
                  LeftShiftedRHSRval_56 = ll_backend__unify_gen_util__left_shift_rval_3_f_0(Var_70, Shift_50, Fill_53);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  Var_74 = mercury__uint__cast_from_int_1_f_0(MaskInt_55);
                  Var_73 = mercury__uint__f_60_60_2_f_0(Var_74, ShiftInt_54);
                  *STATE_VARIABLE_ToOrMask_32 = (Var_73 | STATE_VARIABLE_ToOrMask_0_31);
                }
                break;
              case (MR_Integer) 2:
                {
  ...
  MR_Word * STATE_VARIABLE_CLD_9)
{
  ...
  {
    MR_Word Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
    MR_Word Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0))));
    ...
    else
    {
      ...
      MR_Word RHSVar_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0))));
      MR_Word LHSArgPosWidth_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 1))));
      ...
      ll_backend__code_info__get_module_info_2_p_0(HeadVar__7_7, &ModuleInfo_77);
      ll_backend__unify_gen_util__compute_assign_direction_4_p_0(ModuleInfo_77, ArgMode_46, RHSType_54, &Dir_78);
      switch (Dir_78) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
