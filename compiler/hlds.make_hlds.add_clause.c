...
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__674__1_1_f_0(
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_108, 1) = ((MR_Box) (CallId_48));
      }
      {
    ...
    if ((STATE_VARIABLE_PredSpecs_153_153 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        {
          MR_Word SimpleCallId_79;
          MR_Word STATE_VARIABLE_Specs_172_172;

          {
            SimpleCallId_79 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), SimpleCallId_79, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
            MR_hl_field(MR_mktag(0), SimpleCallId_79, 1) = ((MR_Box) (PredName_22));
            MR_hl_field(MR_mktag(0), SimpleCallId_79, 2) = ((MR_Box) (Arity_25));
          }
          hlds__make_hlds__make_hlds_warn__warn_singletons_6_p_0(STATE_VARIABLE_ModuleInfo_158_158, SimpleCallId_79, VarSet_68, Goal_67, STATE_VARIABLE_Specs_160_160, &STATE_VARIABLE_Specs_172_172);
          hlds__make_hlds__make_hlds_warn__add_quant_warnings_5_p_0(SimpleCallId_79, VarSet_68, Warnings_70, STATE_VARIABLE_Specs_172_172, STATE_VARIABLE_Specs_86);
        }
      }
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__674__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_104);
    if (succeeded)
    {
