...
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__669__1_1_f_0(
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_122 = mercury__string__f_43_43_2_f_0(NameString_43, (MR_String) ").\n");
        Var_124 = mercury__string__f_43_43_2_f_0((MR_String) " (", Var_122);
        Var_125 = mercury__string__f_43_43_2_f_0((MR_String) "name to an existing predicate", Var_124);
        Var_127 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_125);
        Var_128 = mercury__string__f_43_43_2_f_0((MR_String) "for a promise with an identical", Var_127);
        Var_130 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_128);
        UnexpectedMsg_44 = mercury__string__f_43_43_2_f_0((MR_String) "Attempted to introduce a predicate", Var_130);
        {
    ...
    {
      MR_Word MaybePredId_133;
      MR_Word STATE_VARIABLE_Specs_106_135;
      MR_Word STATE_VARIABLE_ModuleInfo_107_136;
      MR_String Var_75;
      ...
      if (succeeded)
      {
        ...
        MaybePredId_133 = (MR_Word) ((MR_Unsigned) 0U);
        {
          Msg_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Msg_46, 0) = ((MR_Box) (Context_22));
          MR_hl_field(MR_mktag(1), Msg_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[72])));
        }
        {
          Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (Msg_46));
          MR_hl_field(MR_mktag(1), Var_104, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Spec_47 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_47, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_47, 1) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(0), Spec_47, 2) = ((MR_Box) (Var_104));
        }
        {
          STATE_VARIABLE_Specs_106_135 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_106_135, 0) = ((MR_Box) (Spec_47));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_106_135, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_56));
        }
        STATE_VARIABLE_ModuleInfo_107_136 = STATE_VARIABLE_ModuleInfo_0_52;
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__add_pred__preds_add_implicit_for_assertion_10_p_0(STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_107_136, ModuleName_34, PredName_18, Arity_36, PredOrFunc_17, HeadVars_49, Status_21, Context_22, &NewPredId_50);
          STATE_VARIABLE_Specs_106_135 = STATE_VARIABLE_Specs_0_56;
        }
        else
        {
          MR_Word Var_110;

          {
            ...
            MR_hl_field(MR_mktag(3), Var_110, 0) = ((MR_Box) ((MR_Unsigned) 7U));
            MR_hl_field(MR_mktag(3), Var_110, 1) = ((MR_Box) (PredName_18));
          }
          hlds__add_pred__preds_add_implicit_report_error_14_p_0(STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_107_136, ModuleName_34, PredName_18, Arity_36, PredOrFunc_17, Status_21, (MR_Integer) 0, Context_22, Var_110, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[74])), &NewPredId_50, STATE_VARIABLE_Specs_0_56, &STATE_VARIABLE_Specs_106_135);
        }
        {
          MaybePredId_133 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybePredId_133, 0) = ((MR_Box) (NewPredId_50));
        }
      }
      if ((MaybePredId_133 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        *STATE_VARIABLE_ModuleInfo_53 = STATE_VARIABLE_ModuleInfo_107_136;
        *STATE_VARIABLE_QualInfo_55 = STATE_VARIABLE_QualInfo_0_54;
        *STATE_VARIABLE_Specs_57 = STATE_VARIABLE_Specs_106_135;
      }
      else
      {
        MR_Word PredId_131 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredId_133, (MR_Integer) 0))));

        hlds__make_hlds__add_clause__module_add_clause_2_19_p_0(ClauseVarSet_16, PredOrFunc_17, PredName_18, PredId_131, ArgTerms_33, Arity_36, ArityAdjustment_31, MaybeBodyGoal_20, Status_21, Context_22, MaybeSeqNum_23, GoalType_24, IllegalSVarResult_30, STATE_VARIABLE_ModuleInfo_107_136, STATE_VARIABLE_ModuleInfo_53, STATE_VARIABLE_QualInfo_0_54, STATE_VARIABLE_QualInfo_55, STATE_VARIABLE_Specs_106_135, STATE_VARIABLE_Specs_57);
      }
    }
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_207, (MR_Integer) 64, &VeryVerbose_42);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_103 = (MR_Integer) ((MR_Unsigned) NumClauses_44 + (MR_Unsigned) 1);
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, InitMarkers0_48, &InitMarkers_49);
    ...
    if ((IllegalSVarResult_32 == (MR_Word) ((MR_Unsigned) 0U)))
      STATE_VARIABLE_PredSpecs_121_121 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word StateVar_50;
      ...
      hlds__make_hlds__state_var__report_illegal_func_svar_result_5_p_0(StateVarContext_51, ClauseVarSet_20, StateVar_50, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_PredSpecs_121_121);
    }
    ...
    if (succeeded)
    {
      ...
      {
        CallId_55 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), CallId_55, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
      ...
      {
        FieldAccessMainPieces_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        FieldAccessMsg_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), FieldAccessMsg_58, 0) = ((MR_Box) (Context_29));
        MR_hl_field(MR_mktag(1), FieldAccessMsg_58, 1) = ((MR_Box) (Var_155));
      }
      {
      ...
      {
        FieldAccessSpec_59 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), FieldAccessSpec_59, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_59, 1) = ((MR_Box) ((MR_Unsigned) 16U));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_59, 2) = ((MR_Box) (Var_163));
      }
      {
        STATE_VARIABLE_PredSpecs_165_165 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 302, &AllowDefnOfBuiltin_60);
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              BuiltinMsg_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BuiltinMsg_61, 0) = ((MR_Box) (Context_29));
              MR_hl_field(MR_mktag(1), BuiltinMsg_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[34])));
            }
            {
            ...
            {
              BuiltinSpec_62 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), BuiltinSpec_62, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), BuiltinSpec_62, 1) = ((MR_Box) ((MR_Unsigned) 16U));
              MR_hl_field(MR_mktag(0), BuiltinSpec_62, 2) = ((MR_Box) (Var_176));
            }
            {
              STATE_VARIABLE_PredSpecs_178_178 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((STATE_VARIABLE_PredSpecs_178_178 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word PredMap_87;
      ...
      if (((MR_tag((MR_Word) MaybeBodyGoal_27)) == (MR_Integer) 0))
      {
        ...
        *STATE_VARIABLE_Specs_93 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), BodyGoalSpecs_66, STATE_VARIABLE_Specs_0_92);
        ...
        Var_228 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 8))) >> 1)) & (MR_Integer) 1);
        {
          Clauses_68 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
          ...
          MR_hl_field(MR_mktag(0), Clauses_68, 8) = (MR_Box) (((((MR_Unsigned) (Var_228) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        }
      ...
      else
      {
        ...
        if (succeeded)
          ...
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_PredInfo_186_186, &STATE_VARIABLE_PredInfo_188_188);
        ...
        succeeded = (ProcIds_82 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) GoalType_31)) == (MR_Integer) 1);
          if (succeeded)
        ...
        if (!(succeeded))
        {
          MR_Word Var_195 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 8))) & (MR_Integer) 1);
        ...
        else
        {
          ...
          {
            SimpleCallId_86 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), SimpleCallId_86, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__669__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_104);
    if (succeeded)
    {
...
{
  {
    ...
    else
    {
      ...
      hlds__goal_util__attach_features_to_all_goals_4_p_1((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[53])), (MR_Integer) 1, HeadGoal1_50, &HeadGoal_46);
    }
