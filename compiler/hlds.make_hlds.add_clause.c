...
hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__495__1_1_f_0(
  MR_Integer LambdaHeadVar__1_126);

static MR_bool MR_CALL 
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__682__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_127 = hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__495__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  ...
  if ((ModeAnnotationSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    if ((ArgsWithoutModes_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        parse_tree__module_qual__qualify_clause_mode_list_8_p_0(InInt_39, Context_19, ArgModes0_30, &ArgModes_37, MQInfo0_40, &MQInfo_41, STATE_VARIABLE_Specs_0_64, &STATE_VARIABLE_Specs_80_80);
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word Var_185 = ((MR_Word) ((MR_hl_field(1, ExistingProcs_43, (MR_Integer) 1))));
    ...
    else
    {
      ...
      Var_159 = parse_tree__error_spec__component_list_to_color_pieces_4_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_clause_scalar_common_2[3])), (MR_String) "and", (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_clause_scalar_common_1[8])), ArgsWithoutModePieces_58);
      ...
      Pieces_175 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_128, Var_142);
      {
        Spec_176 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Spec_176, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.select_applicable_modes\'/15"));
        MR_hl_field(0, Spec_176, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_176, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        MR_hl_field(0, Spec_176, 3) = ((MR_Box) (Context_19));
      ...
      }
      {
        ...
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_Specs_65 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (Spec_176));
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MaybeMode_62 = ((MR_Word) ((MR_hl_field(1, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_clause_scalar_common_2[4])), (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__682__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_117);
  if (succeeded)
  {
