  ...
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(0, Spec_42, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_clause_scalar_common_1[19])));
      }
      {
        MR_Word base;
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(0, Spec_131, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.select_applicable_modes\'/15"));
                MR_hl_field(0, Spec_131, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(0, Spec_131, 2) = ((MR_Box) ((MR_Unsigned) 44U));
                MR_hl_field(0, Spec_131, 3) = ((MR_Box) (Context_19));
                MR_hl_field(0, Spec_131, 4) = ((MR_Box) (Pieces_130));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 336, &AllowDefnOfBuiltin_11);
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            BuiltinSpec_12 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, BuiltinSpec_12, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.maybe_add_error_for_builtin\'/5"));
            MR_hl_field(0, BuiltinSpec_12, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, BuiltinSpec_12, 2) = ((MR_Box) ((MR_Unsigned) 44U));
            MR_hl_field(0, BuiltinSpec_12, 3) = ((MR_Box) (Context_8));
            MR_hl_field(0, BuiltinSpec_12, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_clause_scalar_common_1[36])));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(2, FieldAccessSpec_23, 3) = ((MR_Box) (Var_70));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__683__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_117);
  if (succeeded)
  {
