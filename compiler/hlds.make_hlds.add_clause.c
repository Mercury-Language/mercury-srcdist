...
static MR_bool MR_CALL 
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__637__1_1_f_0(
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_2[3], hlds__make_hlds__add_clause__V_102_102, &hlds__make_hlds__add_clause__V_239_239);
          }
          {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_124_124, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[57])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__FieldAccessMainPieces_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[56])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_153_153, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[59])));
        }
        {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_205, (MR_Integer) 272, &hlds__make_hlds__add_clause__AllowDefnOfBuiltin_59);
        }
...
{
  {
    ...
    {
      hlds__make_hlds__add_clause__succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__637__1_1_f_0(((MR_Word) hlds__make_hlds__add_clause__wrapper_arg_1), &hlds__make_hlds__add_clause__conv0_LambdaHeadVar__2_104);
    }
    if (hlds__make_hlds__add_clause__succeeded)
      {
...
{
  {
    ...
    MR_Word hlds__make_hlds__add_clause__ArgTerms_32;
    ...
    {
      hlds__make_hlds__add_clause__succeeded = hlds__make_hlds__state_var__illegal_state_var_func_result_3_p_0(hlds__make_hlds__add_clause__PredOrFunc_17, hlds__make_hlds__add_clause__ArgTerms0_19, &hlds__make_hlds__add_clause__SVar_28);
    }
    if (hlds__make_hlds__add_clause__succeeded)
      {
    ...
    {
      hlds__make_hlds__state_var__expand_bang_state_pairs_in_terms_2_p_0(hlds__make_hlds__add_clause__ArgTerms0_19, &hlds__make_hlds__add_clause__ArgTerms_32);
    }
    {
    ...
    {
      mercury__list__length_2_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_1[0], hlds__make_hlds__add_clause__ArgTerms_32, &hlds__make_hlds__add_clause__Arity0_34);
    }
        ...
        if (hlds__make_hlds__add_clause__succeeded)
          {
            hlds__make_hlds__add_clause__V_41_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__GoalType_24, (MR_Integer) 0)));
            {
              ...
              MR_String hlds__make_hlds__add_clause__V_124_124;
              ...
              {
                hlds__make_hlds__add_clause__V_121_121 = mercury__string__f_43_43_2_f_0(hlds__make_hlds__add_clause__NameString_42, (MR_String) ").\n");
              }
              {
                hlds__make_hlds__add_clause__V_123_123 = mercury__string__f_43_43_2_f_0((MR_String) " (", hlds__make_hlds__add_clause__V_121_121);
              }
              {
                hlds__make_hlds__add_clause__V_124_124 = mercury__string__f_43_43_2_f_0((MR_String) "name to an existing predicate", hlds__make_hlds__add_clause__V_123_123);
              }
              {
                hlds__make_hlds__add_clause__V_126_126 = mercury__string__f_43_43_2_f_0((MR_String) " ", hlds__make_hlds__add_clause__V_124_124);
              }
              {
                hlds__make_hlds__add_clause__V_127_127 = mercury__string__f_43_43_2_f_0((MR_String) "for a promise with an identical", hlds__make_hlds__add_clause__V_126_126);
              }
              {
                hlds__make_hlds__add_clause__V_129_129 = mercury__string__f_43_43_2_f_0((MR_String) " ", hlds__make_hlds__add_clause__V_127_127);
              }
              {
                hlds__make_hlds__add_clause__UnexpectedMsg_43 = mercury__string__f_43_43_2_f_0((MR_String) "Attempted to introduce a predicate", hlds__make_hlds__add_clause__V_129_129);
              }
              {
        ...
        if (hlds__make_hlds__add_clause__succeeded)
          {
            ...
            hlds__make_hlds__add_clause__MaybePredId_132 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              ...
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Msg_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[53])));
            }
            {
            ...
            {
              hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Spec_46));
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134, 1) = ((MR_Box) (hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_0_55));
            }
            hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_106_135 = hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_0_51;
          }
        else
          {
            ...
            if (hlds__make_hlds__add_clause__succeeded)
            ...
            else
              {
                ...
                {
                  hlds__make_hlds__add_pred__preds_add_implicit_report_error_14_p_0(hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_0_51, &hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_106_135, hlds__make_hlds__add_clause__ModuleName_33, hlds__make_hlds__add_clause__PredName_18, hlds__make_hlds__add_clause__Arity_35, hlds__make_hlds__add_clause__PredOrFunc_17, hlds__make_hlds__add_clause__Status_21, (MR_Integer) 0, hlds__make_hlds__add_clause__Context_22, hlds__make_hlds__add_clause__V_109_109, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[55]), &hlds__make_hlds__add_clause__NewPredId_49, hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_0_55, &hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134);
                }
              }
            {
              hlds__make_hlds__add_clause__MaybePredId_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__MaybePredId_132, 0) = ((MR_Box) (hlds__make_hlds__add_clause__NewPredId_49));
            }
          }
        if ((hlds__make_hlds__add_clause__MaybePredId_132 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            *hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_52 = hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_106_135;
            *hlds__make_hlds__add_clause__STATE_VARIABLE_QualInfo_54 = hlds__make_hlds__add_clause__STATE_VARIABLE_QualInfo_0_53;
            *hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_56 = hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134;
          }
        else
          {
            MR_Word hlds__make_hlds__add_clause__PredId_130 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__MaybePredId_132, (MR_Integer) 0)));

            {
              hlds__make_hlds__add_clause__module_add_clause_2_19_p_0(hlds__make_hlds__add_clause__ClauseVarSet_16, hlds__make_hlds__add_clause__PredOrFunc_17, hlds__make_hlds__add_clause__PredName_18, hlds__make_hlds__add_clause__PredId_130, hlds__make_hlds__add_clause__ArgTerms_32, hlds__make_hlds__add_clause__Arity_35, hlds__make_hlds__add_clause__ArityAdjustment_30, hlds__make_hlds__add_clause__MaybeBodyGoal_20, hlds__make_hlds__add_clause__Status_21, hlds__make_hlds__add_clause__Context_22, hlds__make_hlds__add_clause__MaybeSeqNum_23, hlds__make_hlds__add_clause__GoalType_24, hlds__make_hlds__add_clause__IllegalSVarResult_29, hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_106_135, hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_52, hlds__make_hlds__add_clause__STATE_VARIABLE_QualInfo_0_53, hlds__make_hlds__add_clause__STATE_VARIABLE_QualInfo_54, hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_105_134, hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_56);
            }
          }
      }
  }
