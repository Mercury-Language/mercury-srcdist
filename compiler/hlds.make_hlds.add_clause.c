      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if ((Var_181 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_45, (MR_Integer) 258, &Warn_46);
            switch (Warn_46) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_Specs_62 = STATE_VARIABLE_Specs_2_77;
  ...
  MR_Word PredFormArity_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 134, &VeryVerbose_17);
  ...
  MR_Word * ShouldWarn_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 213, &WarnSingleton_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 214, &WarnRepeatedSingleton_11);
