...
hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__499__1_1_f_0(
  ...
  if ((STATE_VARIABLE_PredSpecs_84_84 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 3, EndMarkers0_63, &EndMarkers_64);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_127 = hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__499__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 346, &AllowDefnOfBuiltin_11);
  ...
  MR_Word PredFormArity_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 78, &VeryVerbose_17);
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__make_hlds_warn__warn_singletons_in_clause_body_7_p_0(*STATE_VARIABLE_ModuleInfo_94, WarnPFSymNameArity_68, VarSet2_58, Goal0_57, &SeenQuant_69, STATE_VARIABLE_Specs_103_103, &STATE_VARIABLE_Specs_109_109);
          switch (SeenQuant_69) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
          ...
          hlds__make_hlds__make_hlds_warn__add_quant_warnings_6_p_0(*STATE_VARIABLE_ModuleInfo_94, WarnPFSymNameArity_68, VarSet_65, QuantWarnings_59, STATE_VARIABLE_Specs_109_109, STATE_VARIABLE_Specs_98);
        }
        break;
    }
