...
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__688__1_1_f_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__688__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_103);
  if (succeeded)
  {
