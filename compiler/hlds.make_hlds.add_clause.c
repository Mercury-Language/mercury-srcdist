...
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__679__1_1_f_0(
...
static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_1[73][2];

static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_2[1][5];

static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_3[1][3];

static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_4[2][1];
...
static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_1[73][2] = {
  ...
  /* row 63 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_clause_scalar_common_1[62]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 64 */
  {
  ...
  /* row 66 */
  {
    ((MR_Box) (&hlds__make_hlds__add_clause_scalar_common_4[1])),
    ((MR_Box) ((MR_Integer) 2))
  },
  /* row 67 */
  {
  ...
  /* row 68 */
  {
    ...
    ((MR_Box) (&hlds__make_hlds__add_clause_scalar_common_1[66]))
  },
  /* row 69 */
  {
  ...
  /* row 70 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[69])))
  },
  /* row 71 */
  {
    ((MR_Box) ((MR_Unsigned) 5U)),
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_117 = mercury__string__f_43_43_2_f_0(NameString_43, (MR_String) ").\n");
        Var_119 = mercury__string__f_43_43_2_f_0((MR_String) " (", Var_117);
        Var_120 = mercury__string__f_43_43_2_f_0((MR_String) "name to an existing predicate", Var_119);
        Var_122 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_120);
        Var_123 = mercury__string__f_43_43_2_f_0((MR_String) "for a promise with an identical", Var_122);
        Var_125 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_123);
        UnexpectedMsg_44 = mercury__string__f_43_43_2_f_0((MR_String) "Attempted to introduce a predicate", Var_125);
        {
    ...
    {
      MR_Word MaybePredId_128;
      MR_Word STATE_VARIABLE_Specs_101_130;
      MR_Word STATE_VARIABLE_ModuleInfo_102_131;
      MR_String Var_75;
      ...
      if (succeeded)
      {
        ...
        MaybePredId_128 = (MR_Word) ((MR_Unsigned) 0U);
        {
          Spec_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Spec_47, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.module_add_clause\'/15"));
          MR_hl_field(MR_mktag(1), Spec_47, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(1), Spec_47, 2) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(1), Spec_47, 3) = ((MR_Box) (Context_22));
          MR_hl_field(MR_mktag(1), Spec_47, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[70])));
        }
        {
          STATE_VARIABLE_Specs_101_130 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_101_130, 0) = ((MR_Box) (Spec_47));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_101_130, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_56));
        }
        STATE_VARIABLE_ModuleInfo_102_131 = STATE_VARIABLE_ModuleInfo_0_52;
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__add_pred__preds_add_implicit_for_assertion_10_p_0(STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_102_131, ModuleName_34, PredName_18, Arity_36, PredOrFunc_17, HeadVars_49, Status_21, Context_22, &NewPredId_50);
          STATE_VARIABLE_Specs_101_130 = STATE_VARIABLE_Specs_0_56;
        }
        else
        {
          MR_Word Var_105;

          {
            ...
            MR_hl_field(MR_mktag(3), Var_105, 0) = ((MR_Box) ((MR_Unsigned) 8U));
            MR_hl_field(MR_mktag(3), Var_105, 1) = ((MR_Box) (PredName_18));
          }
          hlds__add_pred__preds_add_implicit_report_error_14_p_0(STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_102_131, ModuleName_34, PredName_18, Arity_36, PredOrFunc_17, Status_21, (MR_Integer) 0, Context_22, Var_105, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[72])), &NewPredId_50, STATE_VARIABLE_Specs_0_56, &STATE_VARIABLE_Specs_101_130);
        }
        {
          MaybePredId_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybePredId_128, 0) = ((MR_Box) (NewPredId_50));
        }
      }
      if ((MaybePredId_128 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        *STATE_VARIABLE_ModuleInfo_53 = STATE_VARIABLE_ModuleInfo_102_131;
        *STATE_VARIABLE_QualInfo_55 = STATE_VARIABLE_QualInfo_0_54;
        *STATE_VARIABLE_Specs_57 = STATE_VARIABLE_Specs_101_130;
      }
      else
      {
        MR_Word PredId_126 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredId_128, (MR_Integer) 0))));

        hlds__make_hlds__add_clause__module_add_clause_2_19_p_0(ClauseVarSet_16, PredOrFunc_17, PredName_18, PredId_126, ArgTerms_33, Arity_36, ArityAdjustment_31, MaybeBodyGoal_20, Status_21, Context_22, MaybeSeqNum_23, GoalType_24, IllegalSVarResult_30, STATE_VARIABLE_ModuleInfo_102_131, STATE_VARIABLE_ModuleInfo_53, STATE_VARIABLE_QualInfo_0_54, STATE_VARIABLE_QualInfo_55, STATE_VARIABLE_Specs_101_130, STATE_VARIABLE_Specs_57);
      }
    }
  }
}
...
{
  {
    MR_bool succeeded;
    MR_Word PredMap0_39;
    MR_Word STATE_VARIABLE_PredicateTable_87_87;
    MR_Word STATE_VARIABLE_PredInfo_88_88;
    MR_Word STATE_VARIABLE_PredInfo_96_96;
    MR_Word STATE_VARIABLE_PredSpecs_99_99;
    MR_Word STATE_VARIABLE_PredSpecs_144_144;
    MR_Word STATE_VARIABLE_PredSpecs_153_153;
    MR_Word STATE_VARIABLE_PredInfo_154_154;
    MR_Box conv0_STATE_VARIABLE_PredInfo_88_88;
    MR_Word Var_91;
    ...
    hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_81, &STATE_VARIABLE_PredicateTable_87_87);
    hlds__pred_table__predicate_table_get_preds_2_p_0(STATE_VARIABLE_PredicateTable_87_87, &PredMap0_39);
    mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredMap0_39, ((MR_Box) (PredId_23)), &conv0_STATE_VARIABLE_PredInfo_88_88);
    STATE_VARIABLE_PredInfo_88_88 = ((MR_Word) (conv0_STATE_VARIABLE_PredInfo_88_88));
    hlds__make_hlds__add_clause__add_clause_progress_msg_8_p_0(STATE_VARIABLE_ModuleInfo_0_81, STATE_VARIABLE_PredInfo_88_88, PredOrFunc_21, PredName_22, MaybeAnnotatedArgTerms_24, ArityAdjustment_26);
    Var_91 = (MR_Word) (PredStatus_28);
    succeeded = (Var_91 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      MR_Word InitMarkers0_41;
      MR_Word InitMarkers_42;
      MR_Word STATE_VARIABLE_PredInfo_93_93;

      hlds__hlds_pred__pred_info_set_status_3_p_0(PredStatus_28, STATE_VARIABLE_PredInfo_88_88, &STATE_VARIABLE_PredInfo_93_93);
      hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_93_93, &InitMarkers0_41);
      hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, InitMarkers0_41, &InitMarkers_42);
      hlds__hlds_pred__pred_info_set_markers_3_p_0(InitMarkers_42, STATE_VARIABLE_PredInfo_93_93, &STATE_VARIABLE_PredInfo_96_96);
    }
    else
      STATE_VARIABLE_PredInfo_96_96 = STATE_VARIABLE_PredInfo_88_88;
    if ((IllegalSVarResult_32 == (MR_Word) ((MR_Unsigned) 0U)))
      STATE_VARIABLE_PredSpecs_99_99 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word StateVar_43;
      MR_Word StateVarContext_44;
      MR_Tuple Var_98 = ((MR_Tuple) ((MR_hl_field(MR_mktag(1), IllegalSVarResult_32, (MR_Integer) 0))));

      StateVar_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_98, (MR_Integer) 0))));
      StateVarContext_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_98, (MR_Integer) 1))));
      hlds__make_hlds__state_var__report_illegal_func_svar_result_5_p_0(StateVarContext_44, ClauseVarSet_20, StateVar_43, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_PredSpecs_99_99);
    }
    succeeded = (PredOrFunc_21 == (MR_Integer) 1);
    if (succeeded)
    {
      Var_100 = (MR_Integer) 1;
      parse_tree__prog_util__adjust_func_arity_3_p_1(Var_100, &FuncArity_45, Arity_25);
      succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(STATE_VARIABLE_ModuleInfo_0_81, PredName_22, &Var_209, &Var_46, &Var_47);
      if (succeeded)
      {
        succeeded = (FuncArity_45 == Var_209);
        if (succeeded)
        {
          Var_101 = (MR_Word) (PredStatus_28);
    ...
    if (succeeded)
    {
      MR_Word FieldPFSymNameArity_48;
      ...
      {
        FieldPFSymNameArity_48 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), FieldPFSymNameArity_48, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
        MR_hl_field(MR_mktag(0), FieldPFSymNameArity_48, 1) = ((MR_Box) (PredName_22));
        MR_hl_field(MR_mktag(0), FieldPFSymNameArity_48, 2) = ((MR_Box) (Arity_25));
      }
      {
        Var_108 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_108, 0) = ((MR_Box) ((MR_Unsigned) 12U));
        MR_hl_field(MR_mktag(3), Var_108, 1) = ((MR_Box) (FieldPFSymNameArity_48));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_107, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[14])));
      }
      {
        Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[61])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), FieldAccessMainPieces_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[60])));
        MR_hl_field(MR_mktag(1), FieldAccessMainPieces_49, 1) = ((MR_Box) (Var_104));
      }
      {
        Var_134 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_134, 0) = ((MR_Box) (FieldAccessMainPieces_49));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_133, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[63])));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), FieldAccessMsg_51, 1) = ((MR_Box) (Var_133));
      }
      {
      ...
      {
        FieldAccessSpec_52 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), FieldAccessSpec_52, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.module_add_clause_2\'/19"));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_52, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_52, 2) = ((MR_Box) ((MR_Unsigned) 16U));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_52, 3) = ((MR_Box) (Var_142));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_PredSpecs_144_144, 1) = ((MR_Box) (STATE_VARIABLE_PredSpecs_99_99));
      }
    }
    else
      STATE_VARIABLE_PredSpecs_144_144 = STATE_VARIABLE_PredSpecs_99_99;
    succeeded = hlds__hlds_pred__pred_info_is_builtin_1_p_0(STATE_VARIABLE_PredInfo_96_96);
    if (succeeded)
    {
      MR_Word AllowDefnOfBuiltin_54;
      MR_Word Globals_182;

      hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_81, &Globals_182);
      libs__globals__lookup_bool_option_3_p_0(Globals_182, (MR_Integer) 305, &AllowDefnOfBuiltin_54);
      switch (AllowDefnOfBuiltin_54) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word BuiltinSpec_55;

            {
              BuiltinSpec_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.module_add_clause_2\'/19"));
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 2) = ((MR_Box) ((MR_Unsigned) 16U));
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 3) = ((MR_Box) (Context_29));
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[65])));
            }
            {
              STATE_VARIABLE_PredSpecs_153_153 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_PredSpecs_153_153, 0) = ((MR_Box) (BuiltinSpec_55));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_PredSpecs_153_153, 1) = ((MR_Box) (STATE_VARIABLE_PredSpecs_144_144));
            }
          }
          break;
        case (MR_Integer) 1:
          STATE_VARIABLE_PredSpecs_153_153 = STATE_VARIABLE_PredSpecs_144_144;
          break;
      }
    }
    else
      STATE_VARIABLE_PredSpecs_153_153 = STATE_VARIABLE_PredSpecs_144_144;
    hlds__default_func_mode__maybe_add_default_func_mode_3_p_0(STATE_VARIABLE_PredInfo_96_96, &STATE_VARIABLE_PredInfo_154_154, &Var_56);
    if ((STATE_VARIABLE_PredSpecs_153_153 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word PredMap_80;
      MR_Word STATE_VARIABLE_ModuleInfo_158_158;
      MR_Word STATE_VARIABLE_PredInfo_176_176;
      MR_Word STATE_VARIABLE_PredicateTable_177_177;

      if (((MR_tag((MR_Word) MaybeBodyGoal_27)) == (MR_Integer) 0))
      {
        MR_Word BodyGoalSpecs_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeBodyGoal_27, (MR_Integer) 0))));
        MR_Word Clauses0_60;
        MR_Word Clauses_61;
        MR_Word Var_185;
        MR_Word Var_186;
        ...
        *STATE_VARIABLE_Specs_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), BodyGoalSpecs_59, STATE_VARIABLE_Specs_0_85);
        hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_154_154, &Clauses0_60);
        Var_185 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 0))));
        Var_186 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 1))));
        Var_187 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 2))));
        Var_188 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 3))));
        Var_189 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 4))));
        Var_190 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 5))));
        Var_191 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 6))));
        Var_192 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 7))));
        Var_193 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses0_60, (MR_Integer) 8))) >> 1)) & (MR_Integer) 1);
        {
          Clauses_61 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clauses_61, 0) = ((MR_Box) (Var_185));
          MR_hl_field(MR_mktag(0), Clauses_61, 1) = ((MR_Box) (Var_186));
          MR_hl_field(MR_mktag(0), Clauses_61, 2) = ((MR_Box) (Var_187));
          MR_hl_field(MR_mktag(0), Clauses_61, 3) = ((MR_Box) (Var_188));
          MR_hl_field(MR_mktag(0), Clauses_61, 4) = ((MR_Box) (Var_189));
          MR_hl_field(MR_mktag(0), Clauses_61, 5) = ((MR_Box) (Var_190));
          MR_hl_field(MR_mktag(0), Clauses_61, 6) = ((MR_Box) (Var_191));
          MR_hl_field(MR_mktag(0), Clauses_61, 7) = ((MR_Box) (Var_192));
          MR_hl_field(MR_mktag(0), Clauses_61, 8) = (MR_Box) (((((MR_Unsigned) (Var_193) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        }
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(Clauses_61, STATE_VARIABLE_PredInfo_154_154, &STATE_VARIABLE_PredInfo_176_176);
        STATE_VARIABLE_ModuleInfo_158_158 = STATE_VARIABLE_ModuleInfo_0_81;
        *STATE_VARIABLE_QualInfo_84 = STATE_VARIABLE_QualInfo_0_83;
      }
      else
      {
        MR_Word BodyGoal_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeBodyGoal_27, (MR_Integer) 0))));
        MR_Word TVarSet0_63;
        MR_Word ArgTerms_64;
        MR_Word ProcIdsForThisClause_65;
        MR_Word AllProcIds_66;
        MR_Word Goal_67;
        MR_Word VarSet_68;
        MR_Word TVarSet_69;
        MR_Word Warnings_70;
        ...
        MR_Word STATE_VARIABLE_PredInfo_161_161;
        MR_Word STATE_VARIABLE_PredInfo_163_163;
        MR_Word STATE_VARIABLE_PredInfo_166_166;
        MR_Word STATE_VARIABLE_PredInfo_167_167;
        MR_Word Clauses0_183;
        MR_Word Clauses_184;
        MR_Word _ArgTVarSet_72;

        hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_154_154, &Clauses0_183);
        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_154_154, &TVarSet0_63);
        hlds__make_hlds__add_clause__select_applicable_modes_15_p_0(MaybeAnnotatedArgTerms_24, ClauseVarSet_20, PredStatus_28, Context_29, PredId_23, STATE_VARIABLE_PredInfo_154_154, &ArgTerms_64, &ProcIdsForThisClause_65, &AllProcIds_66, STATE_VARIABLE_ModuleInfo_0_81, &STATE_VARIABLE_ModuleInfo_155_155, STATE_VARIABLE_QualInfo_0_83, &STATE_VARIABLE_QualInfo_156_156, STATE_VARIABLE_Specs_0_85, &STATE_VARIABLE_Specs_157_157);
        hlds__make_hlds__add_clause__clauses_info_add_clause_24_p_0(ProcIdsForThisClause_65, AllProcIds_66, ClauseVarSet_20, TVarSet0_63, ArgTerms_64, BodyGoal_62, Context_29, MaybeSeqNum_30, PredStatus_28, PredOrFunc_21, Arity_25, GoalType_31, &Goal_67, &VarSet_68, &TVarSet_69, &Warnings_70, Clauses0_183, &Clauses_184, STATE_VARIABLE_ModuleInfo_155_155, &STATE_VARIABLE_ModuleInfo_158_158, STATE_VARIABLE_QualInfo_156_156, STATE_VARIABLE_QualInfo_84, STATE_VARIABLE_Specs_157_157, &STATE_VARIABLE_Specs_160_160);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(Clauses_184, STATE_VARIABLE_PredInfo_154_154, &STATE_VARIABLE_PredInfo_161_161);
        succeeded = ((MR_tag((MR_Word) GoalType_31)) == (MR_Integer) 1);
        if (succeeded)
          hlds__hlds_pred__pred_info_set_goal_type_3_p_0(GoalType_31, STATE_VARIABLE_PredInfo_161_161, &STATE_VARIABLE_PredInfo_163_163);
        else
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_PredInfo_161_161, &STATE_VARIABLE_PredInfo_163_163);
        hlds__hlds_pred__pred_info_set_typevarset_3_p_0(TVarSet_69, STATE_VARIABLE_PredInfo_163_163, &STATE_VARIABLE_PredInfo_166_166);
        hlds__hlds_pred__pred_info_get_arg_types_4_p_0(STATE_VARIABLE_PredInfo_166_166, &_ArgTVarSet_72, &ExistQVars_73, &ArgTypes_74);
        hlds__hlds_pred__pred_info_set_arg_types_5_p_0(TVarSet_69, ExistQVars_73, ArgTypes_74, STATE_VARIABLE_PredInfo_166_166, &STATE_VARIABLE_PredInfo_167_167);
        ProcIds_75 = hlds__hlds_pred__pred_info_all_procids_1_f_0(STATE_VARIABLE_PredInfo_167_167);
        succeeded = (ProcIds_75 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) GoalType_31)) == (MR_Integer) 1);
          if (succeeded)
        ...
        if (succeeded)
        {
          MR_Word EndMarkers0_77;
          MR_Word EndMarkers_78;

          hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_167_167, &EndMarkers0_77);
          hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 3, EndMarkers0_77, &EndMarkers_78);
          hlds__hlds_pred__pred_info_set_markers_3_p_0(EndMarkers_78, STATE_VARIABLE_PredInfo_167_167, &STATE_VARIABLE_PredInfo_176_176);
        }
        else
          STATE_VARIABLE_PredInfo_176_176 = STATE_VARIABLE_PredInfo_167_167;
        {
          MR_Word Var_171 = (MR_Word) (PredStatus_28);

          succeeded = (Var_171 == (MR_Word) ((MR_Unsigned) 0U));
        }
        if (!(succeeded))
        {
          MR_Word Var_170 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses_184, (MR_Integer) 8))) & (MR_Integer) 1);

          succeeded = (Var_170 == (MR_Integer) 1);
        }
        if (succeeded)
          *STATE_VARIABLE_Specs_86 = STATE_VARIABLE_Specs_160_160;
        else
        {
          MR_Word WarnPFSymNameArity_79;
          MR_Word STATE_VARIABLE_Specs_172_172;

          {
            WarnPFSymNameArity_79 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), WarnPFSymNameArity_79, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
            MR_hl_field(MR_mktag(0), WarnPFSymNameArity_79, 1) = ((MR_Box) (PredName_22));
            MR_hl_field(MR_mktag(0), WarnPFSymNameArity_79, 2) = ((MR_Box) (Arity_25));
          }
          hlds__make_hlds__make_hlds_warn__warn_singletons_6_p_0(STATE_VARIABLE_ModuleInfo_158_158, WarnPFSymNameArity_79, VarSet_68, Goal_67, STATE_VARIABLE_Specs_160_160, &STATE_VARIABLE_Specs_172_172);
          hlds__make_hlds__make_hlds_warn__add_quant_warnings_5_p_0(WarnPFSymNameArity_79, VarSet_68, Warnings_70, STATE_VARIABLE_Specs_172_172, STATE_VARIABLE_Specs_86);
        }
      }
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), ((MR_Box) (PredId_23)), ((MR_Box) (STATE_VARIABLE_PredInfo_176_176)), PredMap0_39, &PredMap_80);
      hlds__pred_table__predicate_table_set_preds_3_p_0(PredMap_80, STATE_VARIABLE_PredicateTable_87_87, &STATE_VARIABLE_PredicateTable_177_177);
      hlds__hlds_module__module_info_set_predicate_table_3_p_0(STATE_VARIABLE_PredicateTable_177_177, STATE_VARIABLE_ModuleInfo_158_158, STATE_VARIABLE_ModuleInfo_82);
    }
    else
    {
      MR_Word Var_180;
      ...
      Var_181 = parse_tree__maybe_error__get_any_errors1_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), MaybeBodyGoal_27);
      Var_180 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_181, STATE_VARIABLE_Specs_0_85);
      *STATE_VARIABLE_Specs_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), STATE_VARIABLE_PredSpecs_153_153, Var_180);
      *STATE_VARIABLE_ModuleInfo_82 = STATE_VARIABLE_ModuleInfo_0_81;
      *STATE_VARIABLE_QualInfo_84 = STATE_VARIABLE_QualInfo_0_83;
    }
  }
}
...
{
  {
    ...
    *AllProcIds_24 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_21);
    ...
    Var_52 = (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[59]));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[28])));
    }
    {
            ...
            case (MR_Integer) 2:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[34])));
                }
                {
                  Pieces_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Pieces_43, 0) = ((MR_Box) (Var_52));
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              hlds__make_hlds__add_clause__undeclared_mode_error_8_p_0(ModeList_35, VarSet_17, PredId_20, PredInfo_21, STATE_VARIABLE_ModuleInfo_0_45, Context_19, STATE_VARIABLE_Specs_88_88, STATE_VARIABLE_Specs_50);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ApplProcIds_23 = base;
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[44])));
      }
      {
        Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[58])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[51])));
    ...
    MainPieces_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[50])), Var_41);
    ...
    if ((ProcIds_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_100, 0) = ((MR_Box) ((MR_Unsigned) 18U));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_99, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[36])));
      }
      {
    ...
    else
    {
      ...
      if ((ProcIdsTail_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_83, 0) = ((MR_Box) ((MR_Unsigned) 18U));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[40])));
        }
        {
          Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[54])));
        ...
        Var_91 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_92, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[56])));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_62, 0) = ((MR_Box) ((MR_Unsigned) 18U));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[42])));
        }
        {
          Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[57])));
        ...
        Var_70 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_71, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[56])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_30, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_clause.undeclared_mode_error\'/8"));
      MR_hl_field(MR_mktag(0), Spec_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(0), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 16U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[48])));
    }
    {
      HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[46])));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__make_hlds__add_clause_scalar_common_4[0]), Var_32, &Var_54);
          ...
          parse_tree__prog_out__write_sym_name_arity_3_p_0(SNA_23);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__679__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_104);
    if (succeeded)
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_101 = mercury__list__filter_map_2_f_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) (&hlds__make_hlds__add_clause_scalar_common_1[1]), (MR_Word) (&hlds__make_hlds__add_clause_scalar_common_3[0]), Clauses0_66);
...
{
  {
    ...
    MR_Word Globals_55;
    MR_Word Goal0_56;
    MR_Word FoundTraceGoal_57;
    MR_Word Goal1_58;
    MR_Word VarTypes0_59;
    MR_Word EmptyRttiVarmaps_60;
    MR_Word VarTypes_61;
    MR_Word STATE_VARIABLE_VarSet_72_72;
    MR_Word STATE_VARIABLE_SVarStore_74_74;
    ...
    MR_Word STATE_VARIABLE_SVarStore_88_88;
    ...
    hlds__make_hlds__state_var__svar_prepare_for_clause_head_9_p_0(ArgTerms1_41, &ArgTerms_42, STATE_VARIABLE_VarSet_0_63, &STATE_VARIABLE_VarSet_72_72, &FinalSVarMap_43, &InitialSVarState_44, &STATE_VARIABLE_SVarStore_74_74, STATE_VARIABLE_Specs_0_69, &STATE_VARIABLE_Specs_75_75);
    succeeded = ((MR_tag((MR_Word) GoalType_28)) == (MR_Integer) 1);
    if (succeeded)
    {
      HeadGoal_46 = hlds__make_goal__true_goal_0_f_0();
      STATE_VARIABLE_SVarStore_77_77 = STATE_VARIABLE_SVarStore_74_74;
      STATE_VARIABLE_SVarState_76_76 = InitialSVarState_44;
      STATE_VARIABLE_Specs_81_81 = STATE_VARIABLE_Specs_75_75;
      STATE_VARIABLE_QualInfo_80_80 = STATE_VARIABLE_QualInfo_0_67;
      STATE_VARIABLE_ModuleInfo_79_79 = STATE_VARIABLE_ModuleInfo_0_65;
      STATE_VARIABLE_VarSet_78_78 = STATE_VARIABLE_VarSet_72_72;
    }
    else
    {
      ...
      hlds__make_hlds__superhomogeneous__insert_arg_unifications_17_p_0(HeadVarsArgTerms_49, Context_25, ArgContext_47, HeadGoal0_48, &HeadGoal1_50, InitialSVarState_44, &STATE_VARIABLE_SVarState_76_76, STATE_VARIABLE_SVarStore_74_74, &STATE_VARIABLE_SVarStore_77_77, STATE_VARIABLE_VarSet_72_72, &STATE_VARIABLE_VarSet_78_78, STATE_VARIABLE_ModuleInfo_0_65, &STATE_VARIABLE_ModuleInfo_79_79, STATE_VARIABLE_QualInfo_0_67, &STATE_VARIABLE_QualInfo_80_80, STATE_VARIABLE_Specs_75_75, &STATE_VARIABLE_Specs_81_81);
      hlds__goal_util__attach_features_to_all_goals_4_p_1((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[45])), (MR_Integer) 1, HeadGoal1_50, &HeadGoal_46);
    }
    hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0((MR_Integer) 0, ParseTreeBodyGoal_24, Renaming_21, &BodyGoal_51, STATE_VARIABLE_SVarState_76_76, &FinalSVarState_54, STATE_VARIABLE_SVarStore_77_77, &STATE_VARIABLE_SVarStore_88_88, STATE_VARIABLE_VarSet_78_78, &STATE_VARIABLE_VarSet_89_89, STATE_VARIABLE_ModuleInfo_79_79, STATE_VARIABLE_ModuleInfo_66, STATE_VARIABLE_QualInfo_80_80, &STATE_VARIABLE_QualInfo_91_91, STATE_VARIABLE_Specs_81_81, STATE_VARIABLE_Specs_70);
    hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_66, &Globals_55);
    hlds__make_hlds__state_var__svar_finish_clause_body_11_p_0(Globals_55, Context_25, FinalSVarMap_43, HeadGoal_46, BodyGoal_51, &Goal0_56, InitialSVarState_44, FinalSVarState_54, STATE_VARIABLE_SVarStore_88_88, StateVarWarnings_32, StateVarErrors_33);
    hlds__make_hlds__qual_info__qual_info_get_found_trace_goal_2_p_0(STATE_VARIABLE_QualInfo_91_91, &FoundTraceGoal_57);
    switch (FoundTraceGoal_57) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Goal1_58 = Goal0_56;
        break;
      case (MR_Integer) 1:
        hlds__pre_quantification__separate_trace_goal_only_locals_2_p_0(Goal0_56, &Goal1_58);
        break;
    }
    hlds__make_hlds__qual_info__qual_info_get_var_types_2_p_0(STATE_VARIABLE_QualInfo_91_91, &VarTypes0_59);
    hlds__hlds_rtti__rtti_varmaps_init_1_p_0(&EmptyRttiVarmaps_60);
    hlds__quantification__implicitly_quantify_clause_body_general_11_p_0((MR_Integer) 0, HeadVarList_40, QuantWarnings_31, Goal1_58, Goal_29, STATE_VARIABLE_VarSet_89_89, STATE_VARIABLE_VarSet_64, VarTypes0_59, &VarTypes_61, EmptyRttiVarmaps_60, &Var_62);
    hlds__make_hlds__qual_info__qual_info_set_var_types_3_p_0(VarTypes_61, STATE_VARIABLE_QualInfo_91_91, STATE_VARIABLE_QualInfo_68);
  }
}
