...
static MR_bool MR_CALL 
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__665__1_1_f_0(
...
static /* final */ const MR_Box hlds__make_hlds__add_clause_scalar_common_1[75][2] = {
  ...
  /* row 59 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_clause_scalar_common_1[58]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 60 */
  {
  ...
  /* row 72 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[71]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 73 */
  {
...
{
  {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
    ...
    else
      {
        ...
        {
          hlds__goal_util__attach_features_to_all_goals_4_p_1((MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[74]), (MR_Integer) 1, hlds__make_hlds__add_clause__HeadGoal1_49, &hlds__make_hlds__add_clause__HeadGoal_46);
        }
      }
    {
...
{
  {
    ...
    if ((hlds__make_hlds__add_clause__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word hlds__make_hlds__add_clause__V_37_37;
        ...
        MR_Integer hlds__make_hlds__add_clause__V_50_50;
        ...
        MR_String hlds__make_hlds__add_clause__V_70_70;
        MR_Word hlds__make_hlds__add_clause__V_71_71;
        ...
        {
          hlds__make_hlds__add_clause__V_41_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_41_41, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_41_41, 1) = ((MR_Box) (hlds__make_hlds__add_clause__ArgNum_4));
        }
        {
          hlds__make_hlds__add_clause__V_40_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_40_40, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_41_41));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_40_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[52])));
        }
        {
          hlds__make_hlds__add_clause__V_37_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_37_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[73])));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_37_37, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_40_40));
        }
        {
          hlds__make_hlds__add_clause__V_36_36 = mercury__cord__from_list_1_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_54_54, hlds__make_hlds__add_clause__V_37_37);
        }
        {
          hlds__make_hlds__add_clause__ArgContextPieces_28 = mercury__cord__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_54_54, hlds__make_hlds__add_clause__ContextPieces_2, hlds__make_hlds__add_clause__V_36_36);
        }
        hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__MAArgTerm_21)) == (MR_mktag((MR_Integer) 0)));
        if (hlds__make_hlds__add_clause__succeeded)
          {
            hlds__make_hlds__add_clause__V_69_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MAArgTerm_21, (MR_Integer) 0)));
            hlds__make_hlds__add_clause__V_71_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MAArgTerm_21, (MR_Integer) 1)));
            hlds__make_hlds__add_clause__V_63_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MAArgTerm_21, (MR_Integer) 2)));
            hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__V_69_69)) == (MR_mktag((MR_Integer) 0)));
            if (hlds__make_hlds__add_clause__succeeded)
              {
                hlds__make_hlds__add_clause__V_70_70 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_69_69, (MR_Integer) 0)));
                hlds__make_hlds__add_clause__succeeded = (strcmp(hlds__make_hlds__add_clause__V_70_70, (MR_String) "::") == 0);
                if (hlds__make_hlds__add_clause__succeeded)
                  {
                    hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__V_71_71)) == (MR_mktag((MR_Integer) 1)));
                    if (hlds__make_hlds__add_clause__succeeded)
                      {
                        hlds__make_hlds__add_clause__ArgTermPrime_61 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_71_71, (MR_Integer) 0)));
                        hlds__make_hlds__add_clause__V_72_72 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_71_71, (MR_Integer) 1)));
                        hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__V_72_72)) == (MR_mktag((MR_Integer) 1)));
                        if (hlds__make_hlds__add_clause__succeeded)
                          {
                            hlds__make_hlds__add_clause__ModeTerm_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_72_72, (MR_Integer) 0)));
                            hlds__make_hlds__add_clause__V_73_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_72_72, (MR_Integer) 1)));
                            hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_73_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                      }
                  }
              }
                ...
                switch (MR_tag((MR_Word) hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_0_6)) {
                  ...
                  case (MR_Integer) 0:
                    switch (MR_unmkbody(hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_0_6)) {
                      ...
                      case (MR_Integer) 0:
                        {
                          MR_Word hlds__make_hlds__add_clause__V_80_80;

                          {
                            hlds__make_hlds__add_clause__V_80_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_80_80, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Mode_67));
                            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_80_80, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_49_49, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_80_80));
                          }
                        }
                        break;
                      case (MR_Integer) 1:
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word hlds__make_hlds__add_clause__V_86_86;
                      MR_Word hlds__make_hlds__add_clause__V_87_87;
                      MR_Word hlds__make_hlds__add_clause__V_92_92 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_0_6, (MR_Integer) 0)));

                      {
                        hlds__make_hlds__add_clause__V_87_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_87_87, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Mode_67));
                        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_87_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        hlds__make_hlds__add_clause__V_86_86 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0, hlds__make_hlds__add_clause__V_92_92, hlds__make_hlds__add_clause__V_87_87);
                      }
                      {
                        hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__STATE_VARIABLE_Annotations_49_49, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_86_86));
                      }
                    }
                    break;
                }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_8_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[72])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__HeadVar__3_3, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[70])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_47_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[64])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_42_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[63])));
    ...
    {
      hlds__make_hlds__add_clause__MainPieces_22 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[62]), hlds__make_hlds__add_clause__V_41_41);
    }
    {
    ...
    if ((hlds__make_hlds__add_clause__ProcIds_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_100_100, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_99_99, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[44])));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__VerbosePieces_24, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[65])));
        ...
        if ((hlds__make_hlds__add_clause__ProcIdsTail_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_83_83, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_82_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[48])));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_79_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[66])));
            ...
            {
              hlds__make_hlds__add_clause__V_91_91 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, hlds__make_hlds__add_clause__V_92_92, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[68]));
            }
            {
        ...
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_62_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_61_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[50])));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_58_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[69])));
            ...
            {
              hlds__make_hlds__add_clause__V_70_70 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, hlds__make_hlds__add_clause__V_71_71, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[68]));
            }
            {
...
{
  {
    ...
    MR_Word hlds__make_hlds__add_clause__V_55_55;
    MR_Word hlds__make_hlds__add_clause__V_56_56;
    ...
    hlds__make_hlds__add_clause__V_53_53 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[60]);
    {
      hlds__make_hlds__add_clause__V_56_56 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), hlds__make_hlds__add_clause__V_56_56, 0) = ((MR_Box) (hlds__make_hlds__add_clause__PredIdStr_28));
    }
    {
      hlds__make_hlds__add_clause__V_55_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_55_55, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_56_56));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_55_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[36])));
    }
    {
      hlds__make_hlds__add_clause__V_52_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_52_52, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_53_53));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_52_52, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_55_55));
    }
    {
      hlds__make_hlds__add_clause__ContextPieces_29 = mercury__cord__from_list_1_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, hlds__make_hlds__add_clause__V_52_52);
    }
    {
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word hlds__make_hlds__add_clause__V_84_84;
                MR_Word hlds__make_hlds__add_clause__V_85_85;
                MR_Word hlds__make_hlds__add_clause__V_89_89;

                {
                  hlds__make_hlds__add_clause__V_68_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_68_68, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_56_56));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_68_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[42])));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Pieces_43, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_53_53));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Pieces_43, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_68_68));
                }
                {
                  hlds__make_hlds__add_clause__V_85_85 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_85_85, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Pieces_43));
                }
                {
                  hlds__make_hlds__add_clause__V_84_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_84_84, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_85_85));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_84_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Msg_44, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_84_84));
                }
                {
                  hlds__make_hlds__add_clause__V_89_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_89_89, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Msg_44));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_89_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Spec_45, 2) = ((MR_Box) (hlds__make_hlds__add_clause__V_89_89));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word hlds__make_hlds__add_clause__V_92_92 = (MR_Word) hlds__make_hlds__add_clause__PredStatus_18;
            MR_Integer hlds__make_hlds__add_clause__ProcId_42;

            hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_92_92 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            if (hlds__make_hlds__add_clause__succeeded)
              {
            ...
            if (hlds__make_hlds__add_clause__succeeded)
              {
                ...
                {
                  hlds__make_hlds__add_clause__V_95_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_95_95, 0) = ((MR_Box) (hlds__make_hlds__add_clause__ProcId_42));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_95_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  *hlds__make_hlds__add_clause__ApplProcIds_23 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_95_95));
                }
...
{
  {
    ...
    MR_Integer hlds__make_hlds__add_clause__V_247_247;
    MR_Word hlds__make_hlds__add_clause__V_53_53;
    MR_Word hlds__make_hlds__add_clause__V_54_54;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Integer hlds__make_hlds__add_clause__V_103_103;
          MR_Word hlds__make_hlds__add_clause__V_109_109;
          MR_String hlds__make_hlds__add_clause__V_251_251;
          ...
          hlds__make_hlds__add_clause__V_213_213 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 0)));
          hlds__make_hlds__add_clause__V_214_214 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 1)));
          hlds__make_hlds__add_clause__V_215_215 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 2)));
          hlds__make_hlds__add_clause__V_216_216 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 3)));
          hlds__make_hlds__add_clause__V_217_217 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 4)));
          hlds__make_hlds__add_clause__V_98_98 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 5)));
          hlds__make_hlds__add_clause__V_218_218 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 6)));
          hlds__make_hlds__add_clause__V_219_219 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 7)));
          hlds__make_hlds__add_clause__V_220_220 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 8)));
          hlds__make_hlds__add_clause__V_221_221 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__MsgClauses_43, (MR_Integer) 9)));
          {
            hlds__make_hlds__add_clause__NumClauses_44 = hlds__hlds_clauses__num_clauses_in_clauses_rep_1_f_0(hlds__make_hlds__add_clause__V_98_98);
          }
          hlds__make_hlds__add_clause__V_103_103 = (hlds__make_hlds__add_clause__NumClauses_44 + (MR_Integer) 1);
          {
            mercury__io__write_string_3_p_0((MR_String) "% Processing clause ");
          }
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_2[3], hlds__make_hlds__add_clause__V_103_103, &hlds__make_hlds__add_clause__V_251_251);
          }
          {
            mercury__io__write_string_3_p_0(hlds__make_hlds__add_clause__V_251_251);
          }
          {
          ...
          {
            hlds__make_hlds__add_clause__V_109_109 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_109_109, 0) = ((MR_Box) (hlds__make_hlds__add_clause__PredName_22));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_109_109, 1) = ((MR_Box) (hlds__make_hlds__add_clause__OrigArity_47));
          }
          {
            parse_tree__prog_out__write_sym_name_and_arity_3_p_0(hlds__make_hlds__add_clause__V_109_109);
          }
          {
    ...
    hlds__make_hlds__add_clause__V_113_113 = (MR_Word) hlds__make_hlds__add_clause__PredStatus_28;
    hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_113_113 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    if (hlds__make_hlds__add_clause__succeeded)
      {
    ...
    if ((hlds__make_hlds__add_clause__IllegalSVarResult_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Tuple hlds__make_hlds__add_clause__V_120_120 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__IllegalSVarResult_32, (MR_Integer) 0)));

        hlds__make_hlds__add_clause__StateVar_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_120_120, (MR_Integer) 0)));
        hlds__make_hlds__add_clause__StateVarContext_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_120_120, (MR_Integer) 1)));
        {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        hlds__make_hlds__add_clause__V_122_122 = (MR_Integer) 1;
        {
          parse_tree__prog_util__adjust_func_arity_3_p_1(hlds__make_hlds__add_clause__V_122_122, &hlds__make_hlds__add_clause__FuncArity_52, hlds__make_hlds__add_clause__Arity_25);
        }
        {
          hlds__make_hlds__add_clause__succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_0_88, hlds__make_hlds__add_clause__PredName_22, &hlds__make_hlds__add_clause__V_247_247, &hlds__make_hlds__add_clause__V_53_53, &hlds__make_hlds__add_clause__V_54_54);
        }
        if (hlds__make_hlds__add_clause__succeeded)
          {
            hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__FuncArity_52 == hlds__make_hlds__add_clause__V_247_247);
            if (hlds__make_hlds__add_clause__succeeded)
              {
                hlds__make_hlds__add_clause__V_123_123 = (MR_Word) hlds__make_hlds__add_clause__PredStatus_28;
                hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_123_123 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        MR_Word hlds__make_hlds__add_clause__V_126_126;
        MR_Word hlds__make_hlds__add_clause__V_129_129;
        MR_Word hlds__make_hlds__add_clause__V_130_130;
        MR_Word hlds__make_hlds__add_clause__V_155_155;
        MR_Word hlds__make_hlds__add_clause__V_156_156;
        MR_Word hlds__make_hlds__add_clause__V_163_163;
        ...
        {
          hlds__make_hlds__add_clause__V_130_130 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_130_130, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_130_130, 1) = ((MR_Box) (hlds__make_hlds__add_clause__CallId_55));
        }
        {
          hlds__make_hlds__add_clause__V_129_129 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_129_129, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_130_130));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_129_129, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[19])));
        }
        {
          hlds__make_hlds__add_clause__V_126_126 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_126_126, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[57])));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_126_126, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_129_129));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__FieldAccessMainPieces_56, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[56])));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__FieldAccessMainPieces_56, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_126_126));
        }
        {
          hlds__make_hlds__add_clause__V_156_156 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_156_156, 0) = ((MR_Box) (hlds__make_hlds__add_clause__FieldAccessMainPieces_56));
        }
        {
          hlds__make_hlds__add_clause__V_155_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_155_155, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_156_156));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_155_155, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[59])));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__FieldAccessMsg_58, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_155_155));
        }
        {
          hlds__make_hlds__add_clause__V_163_163 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_163_163, 0) = ((MR_Box) (hlds__make_hlds__add_clause__FieldAccessMsg_58));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_163_163, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__FieldAccessSpec_59, 2) = ((MR_Box) (hlds__make_hlds__add_clause__V_163_163));
        }
        {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_208, (MR_Integer) 281, &hlds__make_hlds__add_clause__AllowDefnOfBuiltin_60);
        }
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word hlds__make_hlds__add_clause__V_176_176;
              ...
              {
                hlds__make_hlds__add_clause__V_176_176 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_176_176, 0) = ((MR_Box) (hlds__make_hlds__add_clause__BuiltinMsg_61));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_176_176, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                ...
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__BuiltinSpec_62, 2) = ((MR_Box) (hlds__make_hlds__add_clause__V_176_176));
              }
              {
      ...
      hlds__make_hlds__add_clause__STATE_VARIABLE_PredSpecs_178_178 = hlds__make_hlds__add_clause__STATE_VARIABLE_PredSpecs_165_165;
    {
      check_hlds__clause_to_proc__maybe_add_default_func_mode_3_p_0(hlds__make_hlds__add_clause__STATE_VARIABLE_PredInfo_118_118, &hlds__make_hlds__add_clause__STATE_VARIABLE_PredInfo_179_179, &hlds__make_hlds__add_clause__V_63_63);
    }
    if ((hlds__make_hlds__add_clause__STATE_VARIABLE_PredSpecs_178_178 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        if (((MR_tag((MR_Word) hlds__make_hlds__add_clause__MaybeBodyGoal_27)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            MR_Word hlds__make_hlds__add_clause__V_229_229;
            MR_Word hlds__make_hlds__add_clause__V_230_230;
            MR_Word hlds__make_hlds__add_clause__V_231_231;
            ...
            hlds__make_hlds__add_clause__V_222_222 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 0)));
            hlds__make_hlds__add_clause__V_223_223 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 1)));
            hlds__make_hlds__add_clause__V_224_224 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 2)));
            hlds__make_hlds__add_clause__V_225_225 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 3)));
            hlds__make_hlds__add_clause__V_226_226 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 4)));
            hlds__make_hlds__add_clause__V_227_227 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 5)));
            hlds__make_hlds__add_clause__V_228_228 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 6)));
            hlds__make_hlds__add_clause__V_229_229 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 7)));
            hlds__make_hlds__add_clause__V_230_230 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 8)));
            hlds__make_hlds__add_clause__V_231_231 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses0_67, (MR_Integer) 9)));
            {
              hlds__make_hlds__add_clause__Clauses_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 10 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_222_222));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 1) = ((MR_Box) (hlds__make_hlds__add_clause__V_223_223));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 2) = ((MR_Box) (hlds__make_hlds__add_clause__V_224_224));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 3) = ((MR_Box) (hlds__make_hlds__add_clause__V_225_225));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 4) = ((MR_Box) (hlds__make_hlds__add_clause__V_226_226));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 5) = ((MR_Box) (hlds__make_hlds__add_clause__V_227_227));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 6) = ((MR_Box) (hlds__make_hlds__add_clause__V_228_228));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 7) = ((MR_Box) (hlds__make_hlds__add_clause__V_229_229));
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_68, 8) = ((MR_Box) (hlds__make_hlds__add_clause__V_230_230));
        ...
        else
          {
            ...
            if (hlds__make_hlds__add_clause__succeeded)
              {
                hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__GoalType_31)) == (MR_mktag((MR_Integer) 1)));
                if (hlds__make_hlds__add_clause__succeeded)
                  hlds__make_hlds__add_clause__V_83_83 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__GoalType_31, (MR_Integer) 0)));
                hlds__make_hlds__add_clause__succeeded = !(hlds__make_hlds__add_clause__succeeded);
              }
            if (hlds__make_hlds__add_clause__succeeded)
              {
            ...
            {
              MR_Word hlds__make_hlds__add_clause__V_196_196 = (MR_Word) hlds__make_hlds__add_clause__PredStatus_28;

              hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_196_196 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            if (!(hlds__make_hlds__add_clause__succeeded))
              {
                MR_Word hlds__make_hlds__add_clause__V_195_195 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 9)));
                MR_Word hlds__make_hlds__add_clause__V_232_232 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 0)));
                MR_Word hlds__make_hlds__add_clause__V_233_233 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 1)));
                MR_Word hlds__make_hlds__add_clause__V_234_234 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 2)));
                MR_Word hlds__make_hlds__add_clause__V_235_235 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 3)));
                MR_Word hlds__make_hlds__add_clause__V_236_236 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 4)));
                MR_Word hlds__make_hlds__add_clause__V_237_237 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 5)));
                MR_Word hlds__make_hlds__add_clause__V_238_238 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 6)));
                MR_Word hlds__make_hlds__add_clause__V_239_239 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 7)));
                MR_Word hlds__make_hlds__add_clause__V_240_240 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Clauses_210, (MR_Integer) 8)));

                hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_195_195 == (MR_Integer) 1);
              }
            if (hlds__make_hlds__add_clause__succeeded)
    ...
    else
      {
        ...
        MR_Word hlds__make_hlds__add_clause__V_205_205;
        MR_Word hlds__make_hlds__add_clause__V_206_206;

        {
          hlds__make_hlds__add_clause__V_206_206 = parse_tree__maybe_error__get_any_errors1_1_f_0((MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0, hlds__make_hlds__add_clause__MaybeBodyGoal_27);
        }
        {
          hlds__make_hlds__add_clause__V_205_205 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_244_244, hlds__make_hlds__add_clause__V_206_206, hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_0_92);
        }
        {
          *hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_93 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_244_244, hlds__make_hlds__add_clause__STATE_VARIABLE_PredSpecs_178_178, hlds__make_hlds__add_clause__V_205_205);
        }
...
{
  {
    ...
    {
      hlds__make_hlds__add_clause__succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__665__1_1_f_0(((MR_Word) hlds__make_hlds__add_clause__wrapper_arg_1), &hlds__make_hlds__add_clause__conv0_LambdaHeadVar__2_104);
    }
    if (hlds__make_hlds__add_clause__succeeded)
      {
...
{
  {
    ...
    MR_Tuple hlds__make_hlds__add_clause__V_32_32;
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        MR_Tuple hlds__make_hlds__add_clause__V_58_58;

        {
          hlds__make_hlds__add_clause__V_58_58 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_58_58, 0) = ((MR_Box) (hlds__make_hlds__add_clause__SVar_28));
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__V_58_58, 1) = ((MR_Box) (hlds__make_hlds__add_clause__SVarCtxt_29));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__IllegalSVarResult_30, 0) = ((MR_Box) (hlds__make_hlds__add_clause__V_58_58));
        }
      }
    else
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        hlds__make_hlds__add_clause__V_32_32 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__IllegalSVarResult_30, (MR_Integer) 0)));
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        hlds__make_hlds__add_clause__V_60_60 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__PredIds_39, (MR_Integer) 1)));
        hlds__make_hlds__add_clause__succeeded = (hlds__make_hlds__add_clause__V_60_60 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    if (hlds__make_hlds__add_clause__succeeded)
      {
        MR_Word hlds__make_hlds__add_clause__V_42_42;
        ...
        if (hlds__make_hlds__add_clause__succeeded)
          {
            hlds__make_hlds__add_clause__V_42_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__GoalType_24, (MR_Integer) 0)));
            {
              MR_String hlds__make_hlds__add_clause__NameString_43;
              MR_String hlds__make_hlds__add_clause__UnexpectedMsg_44;
              MR_String hlds__make_hlds__add_clause__V_123_123;
              MR_String hlds__make_hlds__add_clause__V_125_125;
              MR_String hlds__make_hlds__add_clause__V_126_126;
              MR_String hlds__make_hlds__add_clause__V_128_128;
              MR_String hlds__make_hlds__add_clause__V_129_129;
              ...
              {
                hlds__make_hlds__add_clause__V_123_123 = mercury__string__f_43_43_2_f_0(hlds__make_hlds__add_clause__NameString_43, (MR_String) ").\n");
              }
              {
                hlds__make_hlds__add_clause__V_125_125 = mercury__string__f_43_43_2_f_0((MR_String) " (", hlds__make_hlds__add_clause__V_123_123);
              }
              {
                hlds__make_hlds__add_clause__V_126_126 = mercury__string__f_43_43_2_f_0((MR_String) "name to an existing predicate", hlds__make_hlds__add_clause__V_125_125);
              }
              {
                hlds__make_hlds__add_clause__V_128_128 = mercury__string__f_43_43_2_f_0((MR_String) " ", hlds__make_hlds__add_clause__V_126_126);
              }
              {
                hlds__make_hlds__add_clause__V_129_129 = mercury__string__f_43_43_2_f_0((MR_String) "for a promise with an identical", hlds__make_hlds__add_clause__V_128_128);
              }
              {
                hlds__make_hlds__add_clause__V_131_131 = mercury__string__f_43_43_2_f_0((MR_String) " ", hlds__make_hlds__add_clause__V_129_129);
              }
              {
                hlds__make_hlds__add_clause__UnexpectedMsg_44 = mercury__string__f_43_43_2_f_0((MR_String) "Attempted to introduce a predicate", hlds__make_hlds__add_clause__V_131_131);
              }
              {
    ...
    else
      {
        ...
        MR_String hlds__make_hlds__add_clause__V_76_76;

        {
          hlds__make_hlds__add_clause__V_76_76 = mdbcomp__sym_name__unqualify_name_1_f_0(hlds__make_hlds__add_clause__PredName_18);
        }
        hlds__make_hlds__add_clause__succeeded = (strcmp(hlds__make_hlds__add_clause__V_76_76, (MR_String) ",") == 0);
        if (hlds__make_hlds__add_clause__succeeded)
        ...
        if (hlds__make_hlds__add_clause__succeeded)
          {
            ...
            hlds__make_hlds__add_clause__MaybePredId_134 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            {
              ...
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Msg_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[53])));
            }
            {
              hlds__make_hlds__add_clause__V_105_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_105_105, 0) = ((MR_Box) (hlds__make_hlds__add_clause__Msg_46));
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__V_105_105, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              ...
              MR_hl_field(MR_mktag(0), hlds__make_hlds__add_clause__Spec_47, 2) = ((MR_Box) (hlds__make_hlds__add_clause__V_105_105));
            }
            {
        ...
        else
          {
            ...
            MR_Word hlds__make_hlds__add_clause__V_48_48;

            hlds__make_hlds__add_clause__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_clause__GoalType_24)) == (MR_mktag((MR_Integer) 1)));
            if (hlds__make_hlds__add_clause__succeeded)
              {
                hlds__make_hlds__add_clause__V_48_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__GoalType_24, (MR_Integer) 0)));
                {
            ...
            else
              {
                ...
                {
                  hlds__make_hlds__add_clause__V_111_111 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_111_111, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                  MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_111_111, 1) = ((MR_Box) (hlds__make_hlds__add_clause__PredName_18));
                }
                {
                  hlds__make_hlds__add_pred__preds_add_implicit_report_error_14_p_0(hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_0_52, &hlds__make_hlds__add_clause__STATE_VARIABLE_ModuleInfo_108_137, hlds__make_hlds__add_clause__ModuleName_34, hlds__make_hlds__add_clause__PredName_18, hlds__make_hlds__add_clause__Arity_36, hlds__make_hlds__add_clause__PredOrFunc_17, hlds__make_hlds__add_clause__Status_21, (MR_Integer) 0, hlds__make_hlds__add_clause__Context_22, hlds__make_hlds__add_clause__V_111_111, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[55]), &hlds__make_hlds__add_clause__NewPredId_50, hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_0_56, &hlds__make_hlds__add_clause__STATE_VARIABLE_Specs_107_136);
                }
              }
            {
