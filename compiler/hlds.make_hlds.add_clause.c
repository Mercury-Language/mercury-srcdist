  ...
  MR_Word * STATE_VARIABLE_Specs_71)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 22, Markers0_37, &Markers_38);
  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 320, &AllowDefnOfBuiltin_11);
  ...
  MR_Word PredFormArity_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 73, &VeryVerbose_15);
