...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_207, (MR_Integer) 63, &VeryVerbose_42);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 301, &AllowDefnOfBuiltin_60);
