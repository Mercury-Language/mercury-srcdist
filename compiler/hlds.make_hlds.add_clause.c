              ...
              case (MR_Integer) 0:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_Annotations_48_48, 0) = ((MR_Box) (Var_80));
                  }
                }
                break;
              case (MR_Integer) 1:
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                STATE_VARIABLE_Annotations_48_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_Annotations_48_48, 0) = ((MR_Box) (Var_86));
              }
            }
            break;
        }
          ...
          switch (MR_unmkbody(STATE_VARIABLE_Annotations_0_6)) {
            ...
            case (MR_Integer) 0:
              ...
              else
              {
                ...
                {
                  STATE_VARIABLE_Annotations_48_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_Annotations_48_48, 0) = ((MR_Box) (Var_94));
                }
              }
              break;
            case (MR_Integer) 1:
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              {
                STATE_VARIABLE_Annotations_48_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_Annotations_48_48, 0) = ((MR_Box) (Var_100));
              }
            }
          }
          break;
