                            ...
                            if (hlds__make_hlds__add_clause__succeeded)
                              {
                                ...
                                {
                                  hlds__make_hlds__add_clause__succeeded = parse_tree__parse_inst_mode_name__convert_mode_3_p_0(hlds__make_hlds__add_clause__V_30_30, hlds__make_hlds__add_clause__V_31_31, &hlds__make_hlds__add_clause__Mode_24);
                                }
                              }
                          }
                      }
