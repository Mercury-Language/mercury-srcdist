...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_207, (MR_Integer) 53, &hlds__make_hlds__add_clause__VeryVerbose_42);
    }
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_208, (MR_Integer) 277, &hlds__make_hlds__add_clause__AllowDefnOfBuiltin_60);
        }
