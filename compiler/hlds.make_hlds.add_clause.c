...
hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__523__1_1_f_0(
  MR_Integer LambdaHeadVar__1_129);

static MR_bool MR_CALL 
hlds__make_hlds__add_clause__IntroducedFrom__func__add_clause_to_clauses_info__715__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_56)
{
  ...
  succeeded = hlds__make_hlds__unravel_info__illegal_state_var_func_result_4_p_0(PredOrFunc_21, ArgTerms0_23, &SVar_31, &SVarCtxt_32);
  if (succeeded)
  {
    MR_Tuple Var_59;
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_77)
{
  ...
  else
  {
    ...
    ResultSpec_46 = hlds__make_hlds__unravel_info__report_illegal_func_svar_result_raw_3_f_0(StateVarContext_45, ClauseVarSet_30, StateVar_44);
    {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_130 = hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__523__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
  ...
  *AllProcIds_26 = hlds__hlds_pred__pred_info_all_proc_ids_1_f_0(PredInfo_23);
  ...
  if ((ModeAnnotationSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    if ((ArgsWithoutModes_33 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), Procs_44, &ExistingProcs_45);
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  succeeded = hlds__hlds_pred_tests__pred_info_is_builtin_1_p_0(PredInfo_7);
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 767, &AllowDefnOfBuiltin_11);
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = hlds__hlds_pred_tests__is_field_access_function_name_6_p_0(ModuleInfo_9, PredSymName_12, &Var_85, &Var_17, &Var_18, &Var_19);
    if (succeeded)
    {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__add_clause_to_clauses_info__715__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_122);
  if (succeeded)
  {
          ...
          case (MR_Integer) 1:
            {
              ...
              ForeignModeIds_80 = mercury__list__condense_1_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), Var_119);
              ...
              ModeIds_86 = mercury__list__delete_elems_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), ModeIds0_85, ForeignModeIds_80);
