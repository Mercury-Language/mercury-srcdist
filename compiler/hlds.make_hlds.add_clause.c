      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if ((Var_184 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_46, (MR_Integer) 66, &Warn_47);
            switch (Warn_47) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_Specs_65 = STATE_VARIABLE_Specs_80_80;
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 353, &AllowDefnOfBuiltin_11);
  ...
  MR_Word PredFormArity_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 83, &VeryVerbose_17);
