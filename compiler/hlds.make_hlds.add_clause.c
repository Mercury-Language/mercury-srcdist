    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MaybePredId_123 = (MR_Word) ((MR_Unsigned) 0U);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 314, &AllowDefnOfBuiltin_11);
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), BuiltinSpec_12, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), FieldAccessSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 24U));
