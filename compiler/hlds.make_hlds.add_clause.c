...
MR_decl_label10(hlds__make_hlds__add_clause__add_clause_transform_20_0, 3,4,5,8,6,10,11,13,15,18)
MR_decl_label4(hlds__make_hlds__add_clause__add_clause_transform_20_0, 19,20,21,22)
MR_decl_label10(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0, 2,4,5,3,6,7,8,9,10,11)
MR_decl_label10(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0, 15,14,18,19,13,21,24,27,28,30)
MR_decl_label6(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0, 31,33,36,20,37,38)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module0)
	...
	MR_init_label10(hlds__make_hlds__add_clause__add_clause_transform_20_0,3,4,5,8,6,10,11,13,15,18)
	MR_init_label4(hlds__make_hlds__add_clause__add_clause_transform_20_0,19,20,21,22)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,4)
	...
	MR_np_call_localret_ent(hlds__make_hlds__state_var__svar_prepare_for_clause_head_9_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i5);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(7),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__add_clause_transform_20_0_i6);
	}
	MR_sv(6) = MR_r3;
	MR_sv(7) = MR_r4;
	MR_sv(11) = MR_r2;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__true_goal_0_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i8);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__goal_expr_to_goal__transform_goal_expr_context_to_goal_17_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i15);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,10)
	...
	MR_np_call_localret_ent(hlds__make_hlds__superhomogeneous__insert_arg_unifications_19_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i11);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r3;
	MR_sv(8) = MR_r4;
	MR_sv(9) = MR_r5;
	...
	MR_np_call_localret_ent(hlds__goal_util__attach_features_to_all_goals_4_1,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i13);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__goal_expr_to_goal__transform_goal_expr_context_to_goal_17_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i15);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,21)
	...
	MR_np_call_localret_ent(hlds__make_hlds__qual_info__qual_info_set_var_types_3_0,
		hlds__make_hlds__add_clause__add_clause_transform_20_0_i22);
MR_def_label(hlds__make_hlds__add_clause__add_clause_transform_20_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module1)
	...
	MR_init_label10(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,15,14,18,19,13,21,24,27,28,30)
	MR_init_label6(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,31,33,36,20,37,38)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,27)
	...
	MR_np_call_localret_ent(fn__list__condense_1_0,
		hlds__make_hlds__add_clause__clauses_info_add_clause_24_0_i28);
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0_i30);
	}
	MR_r3 = MR_r1;
	MR_r2 = MR_sv(2);
	MR_r1 = MR_sv(12);
...
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,31)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0_i33);
	}
	MR_sv(1) = MR_sv(18);
	MR_r1 = MR_sv(11);
	MR_GOTO_LAB(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0_i20);
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,37)
	...
	MR_np_call_localret_ent(hlds__hlds_clauses__add_clause_item_number_5_0,
		hlds__make_hlds__add_clause__clauses_info_add_clause_24_0_i38);
MR_def_label(hlds__make_hlds__add_clause__clauses_info_add_clause_24_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
