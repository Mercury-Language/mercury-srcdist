        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) hlds__make_hlds__add_clause__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word hlds__make_hlds__add_clause__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_1[4], hlds__make_hlds__add_clause__HeadVar__1_1, ((MR_Box) (hlds__make_hlds__add_clause__Var_15)), ((MR_Box) (hlds__make_hlds__add_clause__Var_9)));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word hlds__make_hlds__add_clause__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__HeadVar__1_1, (MR_Integer) 0)));
            ...
            if (hlds__make_hlds__add_clause__succeeded)
              {
                hlds__make_hlds__add_clause__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__HeadVar__2_2, (MR_Integer) 0)));
                hlds__make_hlds__add_clause__TypeInfo_13_13 = (MR_Word) &hlds__make_hlds__add_clause_scalar_common_1[4];
                {
                  hlds__make_hlds__add_clause__succeeded = mercury__builtin__unify_2_p_0(hlds__make_hlds__add_clause__TypeInfo_13_13, ((MR_Box) (hlds__make_hlds__add_clause__Var_7)), ((MR_Box) (hlds__make_hlds__add_clause__Var_8)));
                }
              }
          }
          break;
...
{
  {
    ...
    MR_Word hlds__make_hlds__add_clause__Var_127;
    ...
    {
      hlds__make_hlds__add_clause__Var_127 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_127, 0) = ((MR_Box) (hlds__make_hlds__add_clause__BodyGoal_50));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_127, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_126, 0) = ((MR_Box) (hlds__make_hlds__add_clause__HeadGoal_46));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_126, 1) = ((MR_Box) (hlds__make_hlds__add_clause__Var_127));
    }
    {
      hlds__make_hlds__state_var__svar_finish_clause_body_9_p_0(hlds__make_hlds__add_clause__Context_25, hlds__make_hlds__add_clause__FinalSVarMap_43, hlds__make_hlds__add_clause__Var_126, &hlds__make_hlds__add_clause__Goal0_54, hlds__make_hlds__add_clause__InitialSVarState_44, hlds__make_hlds__add_clause__FinalSVarState_53, hlds__make_hlds__add_clause__STATE_VARIABLE_SVarStore_84_84, hlds__make_hlds__add_clause__StateVarWarnings_32, hlds__make_hlds__add_clause__StateVarErrors_33);
    }
    {
    ...
    if ((hlds__make_hlds__add_clause__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[73])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[72])));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[64])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[63])));
    ...
    {
      hlds__make_hlds__add_clause__MainPieces_22 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[62]), hlds__make_hlds__add_clause__Var_41);
    }
    {
    ...
    if ((hlds__make_hlds__add_clause__ProcIds_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__Var_100, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
        ...
        if ((hlds__make_hlds__add_clause__ProcIdsTail_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__Var_83, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[66])));
            ...
            {
              hlds__make_hlds__add_clause__Var_91 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, hlds__make_hlds__add_clause__Var_92, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[68]));
            }
            {
        ...
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__Var_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[69])));
            ...
            {
              hlds__make_hlds__add_clause__Var_70 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_clause__TypeCtorInfo_120_120, hlds__make_hlds__add_clause__Var_71, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[68]));
            }
            {
...
{
  {
    ...
    hlds__make_hlds__add_clause__Var_53 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[60]);
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_2[3], hlds__make_hlds__add_clause__Var_103, &hlds__make_hlds__add_clause__Var_251);
          }
          {
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__Var_130, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
        ...
        {
          hlds__make_hlds__add_clause__Var_126 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_126, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_clause_scalar_common_1[57])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_clause__Var_155, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[59])));
        }
        {
