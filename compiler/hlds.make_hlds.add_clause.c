  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MaybePredId_127 = (MR_Word) ((MR_Unsigned) 0U);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_45, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[19])));
      }
      {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__668__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_102);
  if (succeeded)
  {
