...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_207, (MR_Integer) 55, &hlds__make_hlds__add_clause__VeryVerbose_42);
    }
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_clause__V_130_130, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
    ...
    if (hlds__make_hlds__add_clause__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_clause__Globals_208, (MR_Integer) 279, &hlds__make_hlds__add_clause__AllowDefnOfBuiltin_60);
        }
