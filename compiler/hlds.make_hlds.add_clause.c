...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) IllegalSVarResult_30)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    succeeded = ((MR_tag((MR_Word) PredIds_39)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MaybePredId_134 = (MR_Word) ((MR_Unsigned) 0U);
        {
        ...
        {
          STATE_VARIABLE_Specs_107_136 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_111, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        ...
        {
          MaybePredId_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybePredId_134, 0) = ((MR_Box) (NewPredId_50));
        }
      }
      if ((MaybePredId_134 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 295, &AllowDefnOfBuiltin_60);
...
{
  {
    ...
    if (!(succeeded))
    {
      succeeded = ((MR_tag((MR_Word) StateVarErrors_62)) == (MR_Integer) 1);
      if (succeeded)
      {
      }
    }
    if (succeeded)
    {
      ...
      *Goal_37 = hlds__make_goal__true_goal_0_f_0();
      Var_118 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 0))));
      Var_119 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 1))));
      Var_120 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 2))));
      Var_121 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 3))));
      Var_122 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 4))));
      Var_123 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 5))));
      Var_124 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 6))));
      Var_125 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 7))));
      Var_126 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 8))) >> 1)) & (MR_Integer) 1);
      {
        MR_Word base;
        ...
        *STATE_VARIABLE_ClausesInfo_83 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) (Var_126) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
      }
    }
    else
    {
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              Clause_117 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Clause_117, 0) = ((MR_Box) (ApplModeIds0_25));
              MR_hl_field(MR_mktag(0), Clause_117, 1) = ((MR_Box) (*Goal_37));
              MR_hl_field(MR_mktag(0), Clause_117, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), Clause_117, 3) = ((MR_Box) (Context_31));
              MR_hl_field(MR_mktag(0), Clause_117, 4) = ((MR_Box) (StateVarWarnings_61));
            }
            hlds__hlds_clauses__add_clause_3_p_0(Clause_117, ClausesRep0_50, &ClausesRep_75);
          }
          break;
        case (MR_Integer) 1:
          {
