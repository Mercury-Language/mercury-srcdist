...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), FieldAccessSpec_52, 2) = ((MR_Box) ((MR_Unsigned) 20U));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_184, (MR_Integer) 312, &AllowDefnOfBuiltin_54);
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), BuiltinSpec_55, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    if ((ProcIds_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_100, 0) = ((MR_Box) ((MR_Unsigned) 20U));
    ...
    else
    {
      ...
      if ((ProcIdsTail_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_83, 0) = ((MR_Box) ((MR_Unsigned) 20U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 20U));
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__prog_out__write_pred_or_func_to_cur_stream_3_p_0(PredOrFunc_11);
          ...
          parse_tree__prog_out__write_sym_name_arity_to_cur_stream_3_p_0(SNA_23);
...
{
  {
    ...
    hlds__make_hlds__state_var__svar_prepare_for_clause_head_9_p_0(ArgTerms1_41, &ArgTerms_42, STATE_VARIABLE_VarSet_0_64, &STATE_VARIABLE_VarSet_73_73, &FinalSVarMap_43, &InitialSVarState_44, &STATE_VARIABLE_SVarStore_75_75, STATE_VARIABLE_Specs_0_70, &STATE_VARIABLE_Specs_76_76);
    ...
    if (succeeded)
    {
      ...
      STATE_VARIABLE_SVarState_77_77 = InitialSVarState_44;
    ...
    hlds__make_hlds__goal_expr_to_goal__transform_parse_tree_goal_to_hlds_16_p_0((MR_Integer) 0, ParseTreeBodyGoal_24, Renaming_21, &BodyGoal_51, STATE_VARIABLE_SVarState_77_77, &FinalSVarState_55, STATE_VARIABLE_SVarStore_78_78, &STATE_VARIABLE_SVarStore_89_89, STATE_VARIABLE_VarSet_79_79, &STATE_VARIABLE_VarSet_90_90, STATE_VARIABLE_ModuleInfo_80_80, STATE_VARIABLE_ModuleInfo_67, STATE_VARIABLE_QualInfo_81_81, &STATE_VARIABLE_QualInfo_92_92, STATE_VARIABLE_Specs_82_82, STATE_VARIABLE_Specs_71);
    hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_67, &Globals_56);
    hlds__make_hlds__state_var__svar_finish_clause_body_11_p_0(Globals_56, Context_25, FinalSVarMap_43, HeadGoal_46, BodyGoal_51, &Goal0_57, InitialSVarState_44, FinalSVarState_55, STATE_VARIABLE_SVarStore_89_89, StateVarWarnings_32, StateVarErrors_33);
    ...
    hlds__quantification__implicitly_quantify_clause_body_general_11_p_0((MR_Integer) 0, HeadVarList_40, QuantWarnings_31, Goal1_59, Goal_29, STATE_VARIABLE_VarSet_90_90, STATE_VARIABLE_VarSet_65, VarTypes0_60, &VarTypes_62, EmptyRttiVarmaps_61, &Var_63);
