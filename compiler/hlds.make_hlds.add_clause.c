...
{
  {
    ...
    if (succeeded)
    {
      if ((ApplProcIds_72 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      IllegalSVarResult_30 = (MR_Word) ((MR_Integer) 0);
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_60 == (MR_Word) ((MR_Integer) 0));
    }
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MaybePredId_134 = (MR_Word) ((MR_Integer) 0);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_105, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          Spec_47 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_47, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_47, 1) = ((MR_Box) ((MR_Integer) 16));
      ...
      if ((MaybePredId_134 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    succeeded = (Var_113 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    {
    ...
    if ((IllegalSVarResult_32 == (MR_Word) ((MR_Integer) 0)))
      STATE_VARIABLE_PredSpecs_121_121 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Word StateVar_50;
      ...
      hlds__make_hlds__state_var__report_illegal_func_svar_result_5_p_0(StateVarContext_51, ClauseVarSet_20, StateVar_50, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_PredSpecs_121_121);
    }
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = (Var_123 == (MR_Word) ((MR_Integer) 0));
          succeeded = !(succeeded);
        }
      }
    }
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_163, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      {
        FieldAccessSpec_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), FieldAccessSpec_59, 0) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), FieldAccessSpec_59, 1) = ((MR_Box) ((MR_Integer) 16));
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 289, &AllowDefnOfBuiltin_60);
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_176, 1) = ((MR_Box) ((MR_Integer) 0));
            }
            {
              BuiltinSpec_62 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), BuiltinSpec_62, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), BuiltinSpec_62, 1) = ((MR_Box) ((MR_Integer) 16));
    ...
    if ((STATE_VARIABLE_PredSpecs_178_178 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word PredMap_87;
      ...
      else
      {
        ...
        {
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) ((MR_Integer) 0), STATE_VARIABLE_PredInfo_186_186, &STATE_VARIABLE_PredInfo_188_188);
        }
        ...
        succeeded = (ProcIds_82 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) GoalType_31)) == (MR_Integer) 1);
          if (succeeded)
          ...
          STATE_VARIABLE_PredInfo_201_201 = STATE_VARIABLE_PredInfo_192_192;
        {
          ...
          succeeded = (Var_196 == (MR_Word) ((MR_Integer) 0));
        }
        if (!(succeeded))
        {
...
{
  {
    ...
    *AllProcIds_24 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_21);
    ...
    hlds__make_hlds__add_clause__get_mode_annotations_9_p_0(VarSet_17, ContextPieces_29, MaybeAnnotatedArgTerms_16, (MR_Integer) 1, ArgTerms_22, (MR_Word) ((MR_Integer) 0), &ModeAnnotations_30, (MR_Word) ((MR_Integer) 0), &ModeAnnotationSpecs_31);
    if ((ModeAnnotationSpecs_31 == (MR_Word) ((MR_Integer) 0)))
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                  ...
                  *ApplProcIds_23 = (MR_Word) ((MR_Integer) 0);
            ...
            case (MR_Integer) 2:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_84, 1) = ((MR_Box) ((MR_Integer) 0));
                }
                {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_89, 1) = ((MR_Box) ((MR_Integer) 0));
                }
                {
                  Spec_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Spec_45, 0) = ((MR_Box) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(0), Spec_45, 1) = ((MR_Box) ((MR_Integer) 16));
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = (Var_92 == (MR_Word) ((MR_Integer) 0));
            if (succeeded)
            {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) ((MR_Integer) 0));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__parse_inst_mode_name__parse_mode_5_p_0((MR_Word) ((MR_Integer) 0), GenVarSet_64, ArgContextPieces_28, GenModeTerm_65, &MaybeMode_66);
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(STATE_VARIABLE_Annotations_0_6)) {
                ...
                case (MR_Integer) 0:
                  ...
                  break;
                case (MR_Integer) 1:
                  STATE_VARIABLE_Annotations_49_49 = (MR_Word) ((MR_Integer) 8);
                  break;
                case (MR_Integer) 2:
                  STATE_VARIABLE_Annotations_49_49 = (MR_Word) ((MR_Integer) 8);
                  break;
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) ((MR_Integer) 0));
                }
        ...
        switch (MR_tag((MR_Word) STATE_VARIABLE_Annotations_0_6)) {
          ...
          case (MR_Integer) 0:
            switch (MR_unmkbody(STATE_VARIABLE_Annotations_0_6)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                STATE_VARIABLE_Annotations_49_49 = (MR_Word) ((MR_Integer) 4);
                break;
              case (MR_Integer) 1:
                STATE_VARIABLE_Annotations_49_49 = (MR_Word) ((MR_Integer) 4);
                break;
...
{
  {
    ...
    SubDeclStr_21 = parse_tree__parse_tree_out_pred_decl__mercury_mode_subdecl_to_string_6_f_0((MR_Integer) 1, PredOrFunc_18, Var_35, Var_36, StrippedModeList_17, (MR_Word) ((MR_Integer) 0));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) ((MR_Integer) 4));
    ...
    if ((ProcIds_23 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_99;
      MR_Word Var_100;
    ...
    else
    {
      ...
      if ((ProcIdsTail_26 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_79;
        MR_Word Var_82;
        MR_Word Var_83;
      ...
      else
      {
        ...
        Var_71 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_72, (MR_Word) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_109, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_115, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      Spec_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Spec_30, 0) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Spec_30, 1) = ((MR_Box) ((MR_Integer) 16));
...
{
  {
    ...
    succeeded = (Var_90 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Clause_113, 2) = ((MR_Box) ((MR_Integer) 0));
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((ApplModeIds0_25 == (MR_Word) ((MR_Integer) 0)))
            ...
            if ((ModeIds_74 == (MR_Word) ((MR_Integer) 0)))
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Clause_79, 2) = ((MR_Box) ((MR_Integer) 0));
