...
MR_decl_label10(hlds__make_hlds__add_clause__module_add_clause_15_0, 148,48,49,50,51,52,53,54,55,56)
...
MR_decl_label3(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0, 17,3,1)
...
MR_decl_static(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0)
...
{
MR_COMMON(5,0),
MR_ENTRY_AP(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module6)
	...
	MR_init_label10(hlds__make_hlds__add_clause__module_add_clause_15_0,148,48,49,50,51,52,53,54,55,56)
...
MR_def_label(hlds__make_hlds__add_clause__module_add_clause_15_0,148)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(19);
...
MR_def_label(hlds__make_hlds__add_clause__module_add_clause_15_0,60)
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		hlds__make_hlds__add_clause__module_add_clause_15_0_i148);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module9)
	MR_init_entry1(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0);
	MR_init_label3(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0,17,3,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__clauses_info_add_clause__522__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(0, MR_r1, 2);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0_i1);
	}
	MR_tempr1 = MR_tfield(0, MR_r1, 0);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0_i17);
	}
	MR_r2 = MR_tfield(1, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
MR_def_label(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0_i3);
MR_def_label(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(1);
MR_def_label(fn__hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__522__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
