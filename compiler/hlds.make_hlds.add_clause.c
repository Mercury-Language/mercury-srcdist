...
hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__687__1_1_f_0(
  ...
  else
  {
    ...
    else
    {
      ...
      if ((ClauseType_11 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          Origin_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Origin_43, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_16));
          MR_hl_field(MR_mktag(1), Origin_43, 1) = ((MR_Box) (PredSymName_17));
          MR_hl_field(MR_mktag(1), Origin_43, 2) = ((MR_Box) (UserArity_42));
        }
        hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0(PredOrFunc_16, PredModuleName_23, PredName_24, PredFormArity_33, PredStatus_10, (MR_Integer) 0, Context_21, Origin_43, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[17])), &PredId_97, STATE_VARIABLE_ModuleInfo_0_44, &STATE_VARIABLE_ModuleInfo_89_89, STATE_VARIABLE_Specs_0_48, &STATE_VARIABLE_Specs_90_90);
      }
      else
        {
      ...
      hlds__make_hlds__add_clause__module_add_clause_2_18_p_0(PredStatus_10, ClauseType_11, PredId_97, PredOrFunc_16, PredSymName_17, ArgTerms_29, PredFormArity_33, ClauseVarSet_19, MaybeBodyGoal_20, Context_21, SeqNum_22, IllegalSVarResult_28, STATE_VARIABLE_ModuleInfo_89_89, STATE_VARIABLE_ModuleInfo_45, STATE_VARIABLE_QualInfo_0_46, STATE_VARIABLE_QualInfo_47, STATE_VARIABLE_Specs_90_90, STATE_VARIABLE_Specs_49);
    }
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__687__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_103);
  if (succeeded)
  {
