...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_207, (MR_Integer) 59, &VeryVerbose_42);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 284, &AllowDefnOfBuiltin_60);
