...
MR_decl_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0, 100,101,103,104,111,112,105,117)
MR_decl_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0, 116,119,120,121,114,123,124,125)
MR_decl_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0, 126,130,129,132,133,127,134,135)
MR_decl_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0, 136,137,138,139,140,144,152,145)
MR_decl_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0, 161,162,154,163,164,165,166,167)
...
MR_decl_label2(__Unify___hlds__make_hlds__add_clause__mode_annotations_0_0, 4,1)
MR_decl_label8(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0, 32,5,15,36,11,20,4,25)
MR_decl_label2(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0, 42,24)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module8)
	...
	MR_init_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0,100,101,103,104,111,112,105,117)
	MR_init_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0,116,119,120,121,114,123,124,125)
	MR_init_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0,126,130,129,132,133,127,134,135)
	MR_init_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0,136,137,138,139,140,144,152,145)
	MR_init_label8(hlds__make_hlds__add_clause__transform_goal_2_15_0,161,162,154,163,164,165,166,167)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,24)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(hlds__make_hlds__add_clause__transform_goal_2_15_0_i144));
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,105)
	...
	MR_r1 = MR_sv(6);
	MR_sv(6) = MR_r3;
	MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i116);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r2;
	MR_np_call_localret_ent(hlds__make_hlds__state_var__prepare_for_call_2_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i119);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(term__apply_substitution_to_list_3_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i120);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,120)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(8);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_clause__transform_dcg_record_syntax_15_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i121);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,121)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(4) = MR_r4;
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,114)
	...
	MR_np_call_localret_ent(hlds__make_hlds__state_var__prepare_for_call_2_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i123);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,123)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(term__apply_substitution_to_list_3_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i124);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,124)
	...
	MR_r4 = MR_sv(7);
	MR_np_call_localret_ent(hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_8_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i125);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,125)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(11) = MR_r3;
	MR_sv(12) = MR_r2;
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(list__length_2_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i126);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,126)
	...
	if ((strcmp((char *)MR_r2, (char *)(MR_Word) MR_string_const("", 0)) != 0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i130);
	}
	MR_sv(6) = MR_r1;
	MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i129);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,129)
	...
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i132);
	}
	MR_r1 = MR_sv(6);
	MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i127);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,133)
	...
	MR_sv(10) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i136);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,135)
	...
	MR_tfield(0, MR_sv(10), 0) = MR_tempr2;
	MR_r1 = MR_sv(1);
	MR_sv(7) = MR_tempr1;
	}
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,136)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_init_2_0,
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,137)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_purity_3_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i138);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,138)
	...
	MR_np_call_localret_ent(hlds__make_hlds__qual_info__record_called_pred_or_func_5_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i139);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,139)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r4, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r4, 0) = MR_sv(10);
	MR_r8 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,144)
	...
	if (MR_PTAG_TESTR(MR_tempr1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i145);
	}
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_clause__report_svar_unify_error_5_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i152);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,152)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__true_goal_0_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i162);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(8),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_clause__transform_goal_2_15_0_i154);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr3 = MR_sv(8);
...
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,161)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__true_goal_0_0,
		hlds__make_hlds__add_clause__transform_goal_2_15_0_i162);
MR_def_label(hlds__make_hlds__add_clause__transform_goal_2_15_0,162)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 0;
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(4);
...
MR_def_label(hlds__make_hlds__add_clause__module_add_clause_14_0,22)
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(2,0,4);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(2,0,3);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,0,2);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module22)
	...
	MR_init_label2(__Unify___hlds__make_hlds__add_clause__mode_annotations_0_0,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___hlds__make_hlds__add_clause__mode_annotations_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___hlds__make_hlds__add_clause__mode_annotations_0_0_i4);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___hlds__make_hlds__add_clause__mode_annotations_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_clause_module23)
	...
	MR_init_label8(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,32,5,15,36,11,20,4,25)
	MR_init_label2(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,42,24)
MR_BEGIN_CODE
...
MR_def_static(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i4);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r1),0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i5);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i32);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i32);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,5)
	...
	if (MR_INT_NE(MR_unmkbody(MR_r1),1)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i11);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i32);
	}
...
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,36)
	...
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i42);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i20);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r2),1)) {
	...
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i24);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i25);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r2),1)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0_i32);
	}
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__make_hlds__add_clause__mode_annotations_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
