...
{
  {
    ...
    Arity_36 = (Arity0_35 + ArityAdjustment_31);
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalType_24, (MR_Integer) 0)));
          {
            ...
            hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_10_p_0(STATE_VARIABLE_ModuleInfo_0_52, &STATE_VARIABLE_ModuleInfo_108_137, ModuleName_34, PredName_18, Arity_36, PredOrFunc_17, HeadVars_49, Status_21, Context_22, &NewPredId_50);
...
{
  {
    ...
    TypeCtorInfo_241_241 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    TypeCtorInfo_242_242 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
    mercury__map__lookup_3_p_0(TypeCtorInfo_241_241, TypeCtorInfo_242_242, PredMap0_39, ((MR_Box) (PredId_23)), &conv0_STATE_VARIABLE_PredInfo_95_95);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_207, (MR_Integer) 57, &VeryVerbose_42);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_213 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 0)));
          Var_214 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 1)));
          Var_215 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 2)));
          Var_216 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 3)));
          Var_217 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 4)));
          Var_98 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 5)));
          Var_218 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 6)));
          Var_219 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 7)));
          Var_220 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 8)));
          Var_221 = ((MR_Word) (MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 9)));
          NumClauses_44 = hlds__hlds_clauses__num_clauses_in_clauses_rep_1_f_0(Var_98);
          Var_103 = (NumClauses_44 + (MR_Integer) 1);
          mercury__io__write_string_3_p_0((MR_String) "% Processing clause ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__make_hlds__add_clause_scalar_common_2[2], Var_103, &Var_251);
          mercury__io__write_string_3_p_0(Var_251);
          ...
          PredArity_46 = (PredArity0_45 + ArityAdjustment_26);
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(STATE_VARIABLE_ModuleInfo_0_88, PredName_22, &Var_247, &Var_53, &Var_54);
      if (succeeded)
      {
        succeeded = (FuncArity_52 == Var_247);
        if (succeeded)
        {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_208, (MR_Integer) 283, &AllowDefnOfBuiltin_60);
      ...
      STATE_VARIABLE_PredSpecs_178_178 = STATE_VARIABLE_PredSpecs_165_165;
    check_hlds__clause_to_proc__maybe_add_default_func_mode_3_p_0(STATE_VARIABLE_PredInfo_118_118, &STATE_VARIABLE_PredInfo_179_179, &Var_63);
    if ((STATE_VARIABLE_PredSpecs_178_178 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      MR_Word STATE_VARIABLE_PredInfo_201_211;
      MR_Word STATE_VARIABLE_PredicateTable_202_212;
      ...
      if (((MR_tag((MR_Word) MaybeBodyGoal_27)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        *STATE_VARIABLE_Specs_93 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, BodyGoalSpecs_66, STATE_VARIABLE_Specs_0_92);
        ...
        Var_222 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 0)));
        Var_223 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 1)));
        Var_224 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 2)));
        Var_225 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 3)));
        Var_226 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 4)));
        Var_227 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 5)));
        Var_228 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 6)));
        Var_229 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 7)));
        Var_230 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 8)));
        Var_231 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 9)));
        {
          Clauses_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 10 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clauses_68, 0) = ((MR_Box) (Var_222));
          MR_hl_field(MR_mktag(0), Clauses_68, 1) = ((MR_Box) (Var_223));
          MR_hl_field(MR_mktag(0), Clauses_68, 2) = ((MR_Box) (Var_224));
          MR_hl_field(MR_mktag(0), Clauses_68, 3) = ((MR_Box) (Var_225));
          MR_hl_field(MR_mktag(0), Clauses_68, 4) = ((MR_Box) (Var_226));
          MR_hl_field(MR_mktag(0), Clauses_68, 5) = ((MR_Box) (Var_227));
          MR_hl_field(MR_mktag(0), Clauses_68, 6) = ((MR_Box) (Var_228));
          MR_hl_field(MR_mktag(0), Clauses_68, 7) = ((MR_Box) (Var_229));
          MR_hl_field(MR_mktag(0), Clauses_68, 8) = ((MR_Box) (Var_230));
          MR_hl_field(MR_mktag(0), Clauses_68, 9) = ((MR_Box) ((MR_Integer) 1));
        }
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(Clauses_68, STATE_VARIABLE_PredInfo_179_179, &STATE_VARIABLE_PredInfo_201_211);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__pred_info_set_markers_3_p_0(EndMarkers_85, STATE_VARIABLE_PredInfo_192_192, &STATE_VARIABLE_PredInfo_201_211);
        }
        else
          STATE_VARIABLE_PredInfo_201_211 = STATE_VARIABLE_PredInfo_192_192;
        {
        ...
        if (!(succeeded))
        {
          ...
          MR_Word Var_232 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 0)));
          MR_Word Var_233 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 1)));
          MR_Word Var_234 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 2)));
          MR_Word Var_235 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 3)));
          MR_Word Var_236 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 4)));
          MR_Word Var_237 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 5)));
          MR_Word Var_238 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 6)));
          MR_Word Var_239 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 7)));
          MR_Word Var_240 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 8)));
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_241_241, TypeCtorInfo_242_242, ((MR_Box) (PredId_23)), ((MR_Box) (STATE_VARIABLE_PredInfo_201_211)), PredMap0_39, &PredMap_87);
      hlds__pred_table__predicate_table_set_preds_3_p_0(PredMap_87, STATE_VARIABLE_PredicateTable_94_94, &STATE_VARIABLE_PredicateTable_202_212);
      hlds__hlds_module__module_info_set_predicate_table_3_p_0(STATE_VARIABLE_PredicateTable_202_212, STATE_VARIABLE_ModuleInfo_183_183, STATE_VARIABLE_ModuleInfo_89);
    }
    else
    {
      MR_Word TypeCtorInfo_244_244 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0;
      MR_Word Var_205;
      MR_Word Var_206;
      ...
      Var_205 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_244_244, Var_206, STATE_VARIABLE_Specs_0_92);
      *STATE_VARIABLE_Specs_93 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_244_244, STATE_VARIABLE_PredSpecs_178_178, Var_205);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__map__to_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0, Procs_40, &ExistingProcs_41);
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_54_54 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
      ...
      Var_36 = mercury__cord__from_list_1_f_0(TypeCtorInfo_54_54, Var_37);
      ArgContextPieces_28 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_54_54, ContextPieces_2, Var_36);
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_27_77 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
        TypeCtorInfo_28_78 = (MR_Word) &mercury__term__term__type_ctor_info_generic_0;
        mercury__varset__coerce_2_p_0(TypeCtorInfo_27_77, TypeCtorInfo_28_78, VarSet_1, &GenVarSet_64);
        mercury__term__coerce_2_p_0(TypeCtorInfo_27_77, TypeCtorInfo_28_78, ModeTerm_62, &GenModeTerm_65);
...
{
  {
    ...
    Var_41 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, PredIdPieces_16, Var_42);
    MainPieces_22 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[58]), Var_41);
    ...
    else
    {
      ...
      if ((ProcIdsTail_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        Var_91 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, Var_92, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[64]));
        VerbosePieces_24 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, Var_79, Var_91);
      }
      else
      {
        MR_Word Var_58;
        ...
        Var_72 = mercury__list__map_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__make_hlds__add_clause_scalar_common_1[2], Var_73, ProcIds_23);
        ...
        Var_70 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, Var_71, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_clause_scalar_common_1[64]));
        VerbosePieces_24 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_120_120, Var_58, Var_70);
      }
    }
    {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__clauses_info_add_clause__666__1_1_f_0(((MR_Word) wrapper_arg_1), &conv0_LambdaHeadVar__2_104);
    if (succeeded)
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            TypeCtorInfo_135_135 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
            ...
            ForeignModeIds_68 = mercury__list__condense_1_f_0(TypeCtorInfo_135_135, Var_101);
            ...
            ModeIds_74 = mercury__list__delete_elems_2_f_0(TypeCtorInfo_135_135, ModeIds0_73, ForeignModeIds_68);
...
{
  {
    ...
    {
      Var_129 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_129, 0) = ((MR_Box) (BodyGoal_50));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_128, 0) = ((MR_Box) (HeadGoal_46));
      MR_hl_field(MR_mktag(1), Var_128, 1) = ((MR_Box) (Var_129));
    }
    hlds__make_hlds__state_var__svar_finish_clause_body_9_p_0(Context_25, FinalSVarMap_43, Var_128, &Goal0_54, InitialSVarState_44, FinalSVarState_53, STATE_VARIABLE_SVarStore_86_86, StateVarWarnings_32, StateVarErrors_33);
