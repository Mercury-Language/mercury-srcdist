...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_105, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), GoalType_24, (MR_Integer) 0)));
        {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), GoalType_24, (MR_Integer) 0)));
          {
            MR_Word HeadVars_49;
      ...
      case (MR_Integer) 1:
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), MsgClauses_43, (MR_Integer) 8)));
    ...
    if ((STATE_VARIABLE_PredSpecs_178_178 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (((MR_tag((MR_Word) MaybeBodyGoal_27)) == (MR_Integer) 0))
      {
        ...
        *STATE_VARIABLE_Specs_93 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), BodyGoalSpecs_66, STATE_VARIABLE_Specs_0_92);
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 8)));
        Var_228 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses0_67, (MR_Integer) 8))) >> (MR_Integer) 1)) & (MR_Integer) 1);
        {
          Clauses_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
          ...
          MR_hl_field(MR_mktag(0), Clauses_68, 8) = (MR_Box) (((((MR_Unsigned) (Var_228) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        }
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), GoalType_31, (MR_Integer) 0)));
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) GoalType_31)) == (MR_Integer) 1);
          if (succeeded)
            packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), GoalType_31, (MR_Integer) 0)));
          succeeded = !(succeeded);
        }
        if (succeeded)
        {
        ...
        if (!(succeeded))
        {
          ...
          MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Clauses_210, (MR_Integer) 8)));
...
{
  {
    ...
    MR_Word HasForeignClauses_53 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 8))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    MR_Word IsEmpty_55;
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 8)));
    MR_Word Var_90;
    ...
    if (succeeded)
    {
      ...
      *Goal_37 = hlds__make_goal__true_goal_0_f_0();
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 8)));
      Var_122 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_82, (MR_Integer) 8))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      {
        MR_Word base;
        ...
        *STATE_VARIABLE_ClausesInfo_83 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) (Var_122) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
      }
    }
    else
    {
      ...
      *Goal_37 = Goal0_60;
      ...
      hlds__hlds_clauses__add_clause_item_number_5_p_0(MaybeSeqNum_32, Context_31, (MR_Integer) 0, ItemNumbers0_51, &ItemNumbers_81);
      {
        ...
        *STATE_VARIABLE_ClausesInfo_83 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (packed_args_0);
      }
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), GoalType_28, (MR_Integer) 0)));
