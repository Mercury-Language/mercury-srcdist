...
hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__517__1_1_f_0(
  MR_Integer LambdaHeadVar__1_129);

static MR_bool MR_CALL 
hlds__make_hlds__add_clause__IntroducedFrom__func__add_clause_to_clauses_info__709__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_WarnSpecs_56)
{
  ...
  hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredicateTable_40, (MR_Integer) 0, PredOrFunc_21, PredSymName_22, PredFormArity_38, &PredIds_41);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_130 = hlds__make_hlds__add_clause__IntroducedFrom__func__select_applicable_modes__517__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if ((Var_187 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_48, (MR_Integer) 222, &Warn_49);
            switch (Warn_49) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_WarnSpecs_69 = STATE_VARIABLE_WarnSpecs_0_68;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_clause__IntroducedFrom__func__add_clause_to_clauses_info__709__1_1_f_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_122);
  if (succeeded)
  {
