    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (!(succeeded))
        {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), PtagReg_28, (MR_Integer) 0)));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (!(succeeded))
                  {
                    ...
                    if (succeeded)
                    {
                      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), StagReg_18, (MR_Integer) 0)));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (!(succeeded))
                  {
                    ...
                    if (succeeded)
                    {
                      packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), StagReg_18, (MR_Integer) 0)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (!(succeeded))
              {
                ...
                if (succeeded)
                {
                  packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), StagReg_18, (MR_Integer) 0)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (!(succeeded))
              {
                ...
                if (succeeded)
                {
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), StagReg_18, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if ((Cases_18 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        else
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CaseInfo0_51, (MR_Integer) 2)));
          {
      ...
      else
      {
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CaseInfo0_75, (MR_Integer) 2)));
        {
