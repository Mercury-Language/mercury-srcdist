  ...
  MR_String * Comment_8)
{
  if ((OtherPtags_7 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_21 = mercury__string__uint8_to_string_1_f_0(Ptag_24);
  ...
  else
  {
    ...
    Var_12 = mercury__string__uint8_to_string_1_f_0(Ptag_25);
  ...
  MR_Word * STATE_VARIABLE_CI_44)
{
  ...
  if ((OtherPtags_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_78 = mercury__string__uint8_to_string_1_f_0(Ptag_81);
  ...
  else
  {
    ...
    Var_69 = mercury__string__uint8_to_string_1_f_0(Ptag_82);
