...
ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_binary_search__1080__1_2_p_0(
  MR_Unsigned LoRangeMax_28,
  MR_Word LambdaHeadVar__1_65);

static MR_bool MR_CALL 
ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_binary_search__1069__1_2_p_0(
  MR_Unsigned MinSectag_14,
  MR_Unsigned CurSectagPrime_23);

static MR_bool MR_CALL 
ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_jump_table__1019__1_2_p_0(
  MR_Word Cases_7,
  MR_Word HeadVar__2_18);

static MR_bool MR_CALL 
ll_backend__tag_switch__IntroducedFrom__pred__generate_primary_binary_search__674__1_2_p_0(
  uint8_t LoRangeMax_33,
  MR_Word LambdaHeadVar__1_70);

static MR_bool MR_CALL 
ll_backend__tag_switch__IntroducedFrom__pred__generate_primary_binary_search__662__1_2_p_0(
  MR_Word MainPtag_29,
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ll_backend__tag_switch__IntroducedFrom__pred__generate_primary_binary_search__674__1_2_p_0(((uint8_t) (MR_Word) (MR_hl_field(0, closure, (MR_Integer) 3))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__tag_switch__IntroducedFrom__pred__generate_primary_binary_search__662__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CI_52)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, TestRval_44, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[11])));
  ...
  if (((MR_tag((MR_Word) PtagGroup_18)) == (MR_Integer) 0))
  {
    ...
    if ((OtherPtags_49 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(3, IsApplicableTestRval_24, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[5])));
    ...
    else
    {
      ...
      ll_backend__tag_switch__encode_ptags_as_bitmap_loop_4_p_0(HeadTailPtag_114, TailTailPtags_115, STATE_VARIABLE_Bitmap_13_116, &Bitmap_62);
      {
        ...
        MR_hl_field(3, SelectedBitMaskRval_64, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[6])));
        MR_hl_field(3, SelectedBitMaskRval_64, 2) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[7])));
      ...
      }
      {
        ...
        MR_hl_field(3, SelectedBitRval_65, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[8])));
      ...
      }
      {
        ...
        MR_hl_field(3, IsApplicableTestRval_24, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[10])));
      }
    }
  }
  else
      ...
      if (((MR_tag((MR_Word) HeadPtagGroup_16)) == (MR_Integer) 0))
      {
        ...
        if ((OtherPtags_65 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          }
          {
            ...
            MR_hl_field(3, IsApplicableTestRval_47, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[5])));
        ...
        else
        {
          ...
          ll_backend__tag_switch__encode_ptags_as_bitmap_loop_4_p_0(HeadTailPtag_103, TailTailPtags_104, STATE_VARIABLE_Bitmap_13_105, &Bitmap_78);
          {
            ...
            MR_hl_field(3, SelectedBitMaskRval_80, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[6])));
            MR_hl_field(3, SelectedBitMaskRval_80, 2) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[7])));
          ...
          }
          {
            ...
            MR_hl_field(3, SelectedBitRval_81, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[8])));
          ...
          }
          {
            ...
            MR_hl_field(3, IsApplicableTestRval_47, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[10])));
          }
        }
      }
      else
  ...
  if (((MR_tag((MR_Word) PtagGroup_15)) == (MR_Integer) 0))
  {
    ...
    if ((OtherPtags_44 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(3, IsApplicableTestRval_20, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[5])));
    ...
    else
    {
      ...
      ll_backend__tag_switch__encode_ptags_as_bitmap_loop_4_p_0(HeadTailPtag_82, TailTailPtags_83, STATE_VARIABLE_Bitmap_13_84, &Bitmap_57);
      {
        ...
        MR_hl_field(3, SelectedBitMaskRval_59, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[6])));
        MR_hl_field(3, SelectedBitMaskRval_59, 2) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[7])));
      ...
      }
      {
        ...
        MR_hl_field(3, SelectedBitRval_60, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[8])));
      ...
      }
      {
        ...
        MR_hl_field(3, IsApplicableTestRval_20, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[10])));
      }
    }
  }
  else
      ...
      case (MR_Integer) 2:
        {
          ...
          ll_backend__tag_switch__generate_secondary_jump_table_5_p_0(MaybeSecFailLabel_38, SectagToLabelAL_44, (MR_Unsigned) 0U, MaxSectag_29, &TargetMaybeLabels_45);
          {
            ...
            MR_hl_field(3, Var_52, 2) = ((MR_Box) (TargetMaybeLabels_45));
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__map__to_sorted_assoc_list_2_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), (MR_Word) (&ll_backend__tag_switch_scalar_common_2[3]), LabelToSectagsMap_33, &LabelToSectagsAL_55);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_binary_search__1080__1_2_p_0(((MR_Unsigned) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_binary_search__1069__1_2_p_0(((MR_Unsigned) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Unsigned) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CI_48)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, TestRval_40, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[11])));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_jump_table__1019__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * TestRval_8)
{
  ...
  }
  {
    ...
    MR_hl_field(3, HeadTestRval_10, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[5])));
        ...
        case (MR_Integer) 3:
          {
            ...
            }
            {
              ...
              MR_hl_field(3, Var_33, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[12])));
            }
            {
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(3, OrigSectagRval_23, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[8])));
    ...
    case (MR_Integer) 2:
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Var_37, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__tag_switch_scalar_common_2[12])));
        }
        {
