...
MR_def_label(ll_backend__tag_switch__generate_secondary_binary_search_10_0,22)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__tag_switch__IntroducedFrom__pred__generate_secondary_binary_search__971__1_2_0);
...
MR_def_label(ll_backend__tag_switch__generate_primary_tag_code_13_0,27)
	...
	MR_tfield(0, MR_sv(5), 0) = MR_tempr1;
	MR_sv(1) = MR_r1;
...
MR_def_label(ll_backend__tag_switch__generate_primary_jump_table_13_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = ((MR_Integer) MR_r2 + (MR_Integer) 1);
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__tag_switch__generate_primary_binary_search_13_0,27)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__tag_switch__IntroducedFrom__pred__generate_primary_binary_search__629__1_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r2, 3) = MR_r1;
	{
	MR_Word MR_tempr1;
