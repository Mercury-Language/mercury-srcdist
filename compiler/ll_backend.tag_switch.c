...
{
  {
    ...
    *STATE_VARIABLE_MaybeEnd_65 = ((MR_Word) conv5_STATE_VARIABLE_MaybeEnd_65);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 445, &DenseSwitchSize_40);
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 451, &TrySwitchSize_41);
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 452, &BinarySwitchSize_42);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 445, &DenseSwitchSize_32);
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 452, &BinarySwitchSize_33);
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 451, &TrySwitchSize_34);
          switch (StagLoc_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
              {
