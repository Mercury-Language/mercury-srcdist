...
{
  {
    ...
    *STATE_VARIABLE_MaybeEnd_65 = ((MR_Word) conv5_STATE_VARIABLE_MaybeEnd_65);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 443, &DenseSwitchSize_40);
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 449, &TrySwitchSize_41);
    libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 450, &BinarySwitchSize_42);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            MR_Word next_value_of_HeadVar__1_1 = PtagGroups_32;
            MR_Word next_value_of_PrevTestsCode0_7 = PrevTestsCode1_53;
            MR_Word next_value_of_PrevCasesCode0_8 = PrevCasesCode1_54;
            MR_Word next_value_of_STATE_VARIABLE_CaseLabelMap_0_10 = STATE_VARIABLE_CaseLabelMap_83_83;
            MR_Word next_value_of_STATE_VARIABLE_CI_0_12 = STATE_VARIABLE_CI_84_84;
  ...
  MR_Word * TestRval_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = OtherPtags_8;
        MR_Word next_value_of_HeadVar__3_3 = TestRval1_13;
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 443, &DenseSwitchSize_32);
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 450, &BinarySwitchSize_33);
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 449, &TrySwitchSize_34);
          switch (StagLoc_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
              {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Cases_19;
          MR_Word next_value_of_PrevTestsCode0_4 = PrevTestsCode1_29;
