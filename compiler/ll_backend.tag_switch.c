...
MR_decl_label10(ll_backend__tag_switch__generate_primary_try_chain_13_0, 51,5,7,8,13,16,17,18,19,12)
...
MR_BEGIN_MODULE(ll_backend__tag_switch_module13)
	...
	MR_init_label10(ll_backend__tag_switch__generate_primary_try_chain_13_0,51,5,7,8,13,16,17,18,19,12)
...
MR_def_label(ll_backend__tag_switch__generate_primary_try_chain_13_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__tag_switch__generate_primary_try_chain_13_0,28)
	...
	MR_GOTO_LAB(ll_backend__tag_switch__generate_primary_try_chain_13_0_i51);
	}
