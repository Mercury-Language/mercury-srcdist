      ...
      if ((PtagGroups_31 == (MR_Word) ((MR_Unsigned) 0U)))
        if ((MaybeFailLabel_5 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if ((OtherPtags_43 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            Var_102 = mercury__string__uint8_to_string_1_f_0(Ptag_105);
            Comment_56 = mercury__string__f_43_43_2_f_0((MR_String) "fallthrough to last primary tag value: ", Var_102);
          }
          else
          {
            MR_String Var_92;
            ...
            Var_99 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ptag_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__tag_switch_scalar_common_1[4]), OtherPtags_43);
            Var_97 = mercury__string__join_list_2_f_0((MR_String) ", ", Var_99);
            Var_96 = mercury__string__f_43_43_2_f_0(Var_97, (MR_String) ")");
            Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "(shared with ", Var_96);
  ...
  else
  {
    ...
    if ((PtagGroups_27 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        {
          TestRval0_77 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TestRval0_77, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), TestRval0_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__tag_switch_scalar_common_2[8])));
          MR_hl_field(MR_mktag(3), TestRval0_77, 2) = ((MR_Box) (PtagRval_2));
          MR_hl_field(MR_mktag(3), TestRval0_77, 3) = ((MR_Box) (Var_87));
        }
        ll_backend__tag_switch__generate_primary_try_me_else_chain_other_ptags_4_p_0(OtherPtags_37, PtagRval_2, TestRval0_77, &TestRval_78);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (ElseLabel_75));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_91, 1) = ((MR_Box) (TestRval_78));
          MR_hl_field(MR_mktag(3), Var_91, 2) = ((MR_Box) (Var_92));
        }
        {
          Var_90 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_90, 0) = ((MR_Box) (Var_91));
          MR_hl_field(MR_mktag(0), Var_90, 1) = ((MR_Box) ((MR_String) "test primary tag only"));
        }
        ...
        StagLoc_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PtagCase_38, (MR_Integer) 0))));
        StagGoalMap_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PtagCase_38, (MR_Integer) 1))));
        ll_backend__tag_switch__generate_primary_tag_code_13_p_0(StagGoalMap_81, MainPtag_36, OtherPtags_37, MaxSecondary_43, StagReg_3, StagLoc_80, VarRval_4, MaybeFailLabel_5, &TagCode_82, STATE_VARIABLE_CaseLabelMap_0_8, STATE_VARIABLE_CaseLabelMap_9, STATE_VARIABLE_CI_38_84, STATE_VARIABLE_CI_11);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_95, 1) = ((MR_Box) (ElseLabel_75));
        }
        {
          Var_94 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (Var_95));
          MR_hl_field(MR_mktag(0), Var_94, 1) = ((MR_Box) ((MR_String) "handle next primary tag"));
        }
    ...
    else
    {
      ...
      if ((Cases_18 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        else
        {
          ...
          Comment_44 = ((MR_String) ((MR_hl_field(MR_mktag(0), CaseInfo0_43, (MR_Integer) 0))));
          {
            Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Secondary_24));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_50, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__tag_switch_scalar_common_2[9])));
            MR_hl_field(MR_mktag(3), Var_50, 2) = ((MR_Box) (StagRval_2));
            MR_hl_field(MR_mktag(3), Var_50, 3) = ((MR_Box) (Var_53));
          }
          {
            Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (CaseLabel_25));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_49, 2) = ((MR_Box) (Var_55));
          }
          Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "test sec tag only for ", Comment_44);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (Var_56));
          }
      ...
      else
      {
        ...
        Comment_62 = ((MR_String) ((MR_hl_field(MR_mktag(0), CaseInfo0_61, (MR_Integer) 0))));
        {
          Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Secondary_24));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__tag_switch_scalar_common_2[9])));
          MR_hl_field(MR_mktag(3), Var_68, 2) = ((MR_Box) (StagRval_2));
          MR_hl_field(MR_mktag(3), Var_68, 3) = ((MR_Box) (Var_71));
        }
        {
          Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (CaseLabel_25));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_67, 2) = ((MR_Box) (Var_73));
        }
        Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "test sec tag only for ", Comment_62);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (Var_74));
        }
  ...
  else
  {
    ...
    if ((Cases_21 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        {
          Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Secondary_27));
        }
        {
          Var_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__tag_switch_scalar_common_2[8])));
          MR_hl_field(MR_mktag(3), Var_59, 2) = ((MR_Box) (StagRval_2));
          MR_hl_field(MR_mktag(3), Var_59, 3) = ((MR_Box) (Var_62));
        }
        {
          Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (ElseLabel_54));
        }
        {
          Var_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        }
        {
          Var_57 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Var_58));
          MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) ((MR_String) "test sec tag only"));
        }
        TestCode_55 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_57)));
        {
          ...
          MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (ElseLabel_54));
        }
        {
          Var_66 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (Var_67));
          MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) ((MR_String) "handle next secondary tag"));
        }
    ...
    else
    {
      ...
      ll_backend__switch_case__generate_case_code_or_jump_4_p_0(CaseLabel_28, &CaseCode_71, STATE_VARIABLE_CaseLabelMap_0_5, &STATE_VARIABLE_CaseLabelMap_46_46);
      ll_backend__code_info__get_next_label_3_p_0(&ElseLabel_72, STATE_VARIABLE_CI_0_7, &STATE_VARIABLE_CI_47_47);
      {
        Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Secondary_27));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__tag_switch_scalar_common_2[8])));
        MR_hl_field(MR_mktag(3), Var_77, 2) = ((MR_Box) (StagRval_2));
        MR_hl_field(MR_mktag(3), Var_77, 3) = ((MR_Box) (Var_80));
      }
      {
        Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (ElseLabel_72));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_76, 2) = ((MR_Box) (Var_82));
      }
      {
        Var_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (Var_76));
        MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) ((MR_String) "test sec tag only"));
      }
      TestCode_73 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_75)));
      {
        ...
        MR_hl_field(MR_mktag(3), Var_85, 1) = ((MR_Box) (ElseLabel_72));
      }
      {
        Var_84 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (Var_85));
        MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) ((MR_String) "handle next secondary tag"));
      }
