    ...
    *STATE_VARIABLE_MaybeEnd_66 = ((MR_Word) (conv5_STATE_VARIABLE_MaybeEnd_66));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_525 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_525, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          MR_hl_field(MR_mktag(3), Var_525, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(3), Var_525, 2) = ((MR_Box) (VarRval_16));
        }
        {
          Var_524 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_524, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), Var_524, 1) = ((MR_Box) (PtagReg_28));
          MR_hl_field(MR_mktag(3), Var_524, 2) = ((MR_Box) (Var_525));
        }
        {
          Var_523 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_523, 0) = ((MR_Box) (Var_524));
          MR_hl_field(MR_mktag(0), Var_523, 1) = ((MR_Box) ((MR_String) "compute tag to switch on"));
        }
        PtagCode_47 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_523)));
        {
          PtagRval_540 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), PtagRval_540, 0) = ((MR_Box) (PtagReg_28));
        }
      }
      else
      {
        PtagCode_47 = mercury__cord__empty_0_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0));
        {
          PtagRval_540 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), PtagRval_540, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          MR_hl_field(MR_mktag(3), PtagRval_540, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(3), PtagRval_540, 2) = ((MR_Box) (VarRval_16));
        }
      }
      ...
      if (succeeded)
      {
        ...
        ll_backend__tag_switch__generate_primary_binary_search_13_p_0(PtagCaseList_55, UINT8_C(0), MaxPrimary_32, PtagRval_540, StagReg_29, VarRval_16, MaybeFailLabel_50, PtagCountMap_33, &CasesCode_56, CaseLabelMap0_35, &CaseLabelMap_57, STATE_VARIABLE_CI_99_99, STATE_VARIABLE_CI_68);
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          ll_backend__tag_switch__generate_primary_try_chain_13_p_0(PtagCaseList_125, PtagRval_540, StagReg_29, VarRval_16, MaybeFailLabel_50, PtagCountMap_33, Var_103, Var_104, &CasesCode_56, CaseLabelMap0_35, &CaseLabelMap_57, STATE_VARIABLE_CI_99_99, STATE_VARIABLE_CI_68);
        }
        else
        {
          ...
          ll_backend__tag_switch__generate_primary_try_me_else_chain_11_p_0(PtagCaseList_126, PtagRval_540, StagReg_29, VarRval_16, MaybeFailLabel_50, PtagCountMap_33, &CasesCode_56, CaseLabelMap0_35, &CaseLabelMap_57, STATE_VARIABLE_CI_99_99, STATE_VARIABLE_CI_68);
        }
      }
    }
      ...
      else
      {
        ...
        if ((Var_123 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          CurPrimaryPrime_29 = (uint8_t) (Var_68);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (&ll_backend__tag_switch_scalar_common_4[7]));
          ...
          MaxSecondary_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CountInfo_33, (MR_Integer) 1))));
          {
            ...
            MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&ll_backend__tag_switch_scalar_common_4[4]));
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                if ((Var_3090 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  MR_Integer Var_104 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_3091, (MR_Integer) 0))));
          ...
          case (MR_Integer) 3:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), OrigStagRval_2674, 0) = ((MR_Box) (Var_72));
              }
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&ll_backend__tag_switch_scalar_common_4[3]));
          ...
          else
          {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                ll_backend__tag_switch__generate_secondary_try_chain_7_p_0(StagGoalList_25, StagRval_3104, MaybeSecFailLabel_49, Var_91, &Codes_51, STATE_VARIABLE_CaseLabelMap_0_52, STATE_VARIABLE_CaseLabelMap_53);
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), OrigStagRval_1809, 3) = ((MR_Box) (Var_70));
          }
          {
      ...
      else
      {
        ...
        if ((Var_99 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&ll_backend__tag_switch_scalar_common_4[1]));
