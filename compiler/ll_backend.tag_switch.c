      ...
      case (MR_Integer) 3:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_31, (MR_Integer) 436, &ll_backend__tag_switch__DenseSwitchSize_32);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_31, (MR_Integer) 443, &ll_backend__tag_switch__BinarySwitchSize_33);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_31, (MR_Integer) 442, &ll_backend__tag_switch__TrySwitchSize_34);
          }
          switch (ll_backend__tag_switch__StagLoc_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
          ...
          if (ll_backend__tag_switch__succeeded)
          ...
          else
            {
              ...
              if (ll_backend__tag_switch__succeeded)
                {
                  ll_backend__tag_switch__V_67_67 = (MR_Integer) 311;
                  {
...
{
  {
    ...
    *ll_backend__tag_switch__STATE_VARIABLE_MaybeEnd_65 = ((MR_Word) ll_backend__tag_switch__conv5_STATE_VARIABLE_MaybeEnd_65);
    ...
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_39, (MR_Integer) 436, &ll_backend__tag_switch__DenseSwitchSize_40);
    }
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_39, (MR_Integer) 442, &ll_backend__tag_switch__TrySwitchSize_41);
    }
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__tag_switch__Globals_39, (MR_Integer) 443, &ll_backend__tag_switch__BinarySwitchSize_42);
    }
    ...
    if (ll_backend__tag_switch__succeeded)
    ...
    else
      {
        ...
        if (ll_backend__tag_switch__succeeded)
          {
            ll_backend__tag_switch__V_83_83 = (MR_Integer) 311;
            {
