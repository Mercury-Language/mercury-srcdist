  ...
  MR_Word * STATE_VARIABLE_CI_30)
{
  if ((TailPtagGroups_17 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    else
    {
      ...
      ll_backend__code_util__neg_rval_2_p_0(IsApplicableTestRval_47, &IsNotApplicableRval_48);
      {
        Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_CI_28)
{
  ...
  ll_backend__code_util__neg_rval_2_p_0(IsApplicableTestRval_20, &IsNotApplicableRval_21);
  {
  ...
  MR_Word * STATE_VARIABLE_CI_29)
{
  if ((TailCases_11 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    else
    {
      ...
      ll_backend__code_util__neg_rval_2_p_0(IsApplicableTestRval_47, &IsNotApplicableTestRval_51);
  ...
  MR_Word * STATE_VARIABLE_CI_27)
{
  ...
  ll_backend__code_util__neg_rval_2_p_0(IsApplicableTestRval_14, &IsNotApplicableTestRval_18);
