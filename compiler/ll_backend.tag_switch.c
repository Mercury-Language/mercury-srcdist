  ...
  MR_Integer NumAlternatives_5)
{
  ...
  DenseSwitchSize_8 = ((MR_Integer) ((MR_hl_field(0, OptTuple_7, 28))));
  TrySwitchSize_9 = ((MR_Integer) ((MR_hl_field(0, OptTuple_7, 34))));
  BinarySwitchSize_10 = ((MR_Integer) ((MR_hl_field(0, OptTuple_7, 35))));
