...
ifeq ($(TARGET_ASM),yes)
erl_backend.erl_code_util.mh erl_backend.erl_code_util.mih : erl_backend.erl_code_util.s
else
erl_backend.erl_code_util.mh erl_backend.erl_code_util.mih : erl_backend.erl_code_util.c
endif

ifeq ($(TARGET_ASM),yes)
erl_backend.erl_code_util.module_dep : erl_backend.erl_code_util.s
else
 ifeq ($(findstring il,$(GRADE)),il)
erl_backend.erl_code_util.module_dep : erl_backend.erl_code_util.il
  ifeq ($(findstring java,$(GRADE)),java)
erl_backend.erl_code_util.module_dep : mercury/erl_backend_/erl_code_util.java
  else
...
ifeq ($(TARGET_ASM),yes)
erl_backend.erl_code_util.s_date : erl_code_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only erl_backend.erl_code_util $(ERR_REDIRECT)
erl_backend.erl_code_util.pic_s_date : erl_code_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" erl_backend.erl_code_util $(ERR_REDIRECT)
endif # TARGET_ASM
