...
static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__712__1_2_p_0(
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_7, (MR_Integer) 406, &hlds__make_hlds__add_foreign_proc__SharingAnalysis_12);
    }
...
{
  {
    ...
    {
      hlds__make_hlds__add_foreign_proc__succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__495__1_2_p_0(((MR_Word) hlds__make_hlds__add_foreign_proc__wrapper_arg_1), &hlds__make_hlds__add_foreign_proc__conv0_LambdaHeadVar__2_113);
    }
    if (hlds__make_hlds__add_foreign_proc__succeeded)
      {
    ...
    if (hlds__make_hlds__add_foreign_proc__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_37, (MR_Integer) 277, &hlds__make_hlds__add_foreign_proc__AllowDefnOfBuiltin_38);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_22, (MR_Integer) 53, &hlds__make_hlds__add_foreign_proc__VeryVerbose_29);
    }
                ...
                if (hlds__make_hlds__add_foreign_proc__succeeded)
                  {
                    ...
                    {
                      mercury__assoc_list__keys_2_p_0((MR_Word) &hlds__make_hlds__add_foreign_proc_scalar_common_1[1], (MR_Word) &parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_box_policy_0, hlds__make_hlds__add_foreign_proc__ArgInfoBox_64, &hlds__make_hlds__add_foreign_proc__ArgInfo_65);
                    }
                    {
