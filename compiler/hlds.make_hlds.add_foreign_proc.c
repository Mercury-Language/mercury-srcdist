...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__991__1_2_f_0(
  MR_Word ProgVarSet_8,
  MR_Word HeadVar__2_89);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__586__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  MR_Word STATE_VARIABLE_PredInfo_1_51;
  MR_Word STATE_VARIABLE_PredInfo_2_54;
  MR_Word STATE_VARIABLE_PredInfo_3_56;
  MR_Word STATE_VARIABLE_ModuleInfo_2_57;
  MR_Word STATE_VARIABLE_Specs_2_58;
  MR_Word PredOrFunc_64;
  MR_Word PredSymName_65;
  MR_Word PredFormArity_66;
  MR_Word PredModuleName_67;
  MR_String PredName_68;
  MR_Word PredTable0_69;
  MR_Word MaybePredId_70;
  MR_Word ClausesInfo0_76;
  MR_Word ItemNumbers0_77;
  MR_Word ItemNumbers_78;
  MR_Word ClausesInfo_79;
  MR_Word MaybeThreadSafe_100;
  MR_Word ThreadSafe_101;
  MR_Word Var_52;
  MR_Word Var_90;
  MR_Word Var_91;
  MR_Word Var_92;
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_38, &Globals_26);
  ...
  PredOrFunc_64 = ((MR_Unsigned) ((MR_hl_field(0, PFSymNameArity_25, 0))) & (MR_Integer) 1);
  PredSymName_65 = ((MR_Word) ((MR_hl_field(0, PFSymNameArity_25, 1))));
  PredFormArity_66 = ((MR_Word) ((MR_hl_field(0, PFSymNameArity_25, 2))));
  mdbcomp__sym_name__det_sym_name_get_module_name_and_name_3_p_0(PredSymName_65, &PredModuleName_67, &PredName_68);
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_38, &PredTable0_69);
  hlds__pred_table__predicate_table_search_pf_fqm_n_a_6_p_0(PredTable0_69, PredOrFunc_64, PredModuleName_67, PredName_68, PredFormArity_66, &MaybePredId_70);
  if ((MaybePredId_70 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word UserArity_71;
    MR_Word Origin_72;
    MR_Word Var_73;

    parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_64, &UserArity_71, PredFormArity_66);
    {
      Var_73 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_73, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_64));
      MR_hl_field(0, Var_73, 1) = ((MR_Box) (PredSymName_65));
      MR_hl_field(0, Var_73, 2) = ((MR_Box) (UserArity_71));
    }
    {
      Origin_72 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Origin_72, 0) = ((MR_Box) (Var_73));
    }
    hlds__make_hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0(PredOrFunc_64, PredModuleName_67, PredName_68, PredFormArity_66, PredStatus_11, (MR_Integer) 0, Context_22, Origin_72, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])), &PredId_31, STATE_VARIABLE_ModuleInfo_0_38, &STATE_VARIABLE_ModuleInfo_1_49, STATE_VARIABLE_Specs_0_40, &STATE_VARIABLE_Specs_1_50);
  }
  else
  {
    PredId_31 = ((MR_Word) ((MR_hl_field(1, MaybePredId_70, 0))));
    STATE_VARIABLE_ModuleInfo_1_49 = STATE_VARIABLE_ModuleInfo_0_38;
    STATE_VARIABLE_Specs_1_50 = STATE_VARIABLE_Specs_0_40;
  }
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_1_49, PredId_31, &STATE_VARIABLE_PredInfo_1_51);
  Var_52 = (MR_Word) (PredStatus_11);
  succeeded = (Var_52 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    hlds__hlds_pred__pred_info_set_status_3_p_0((MR_Word) (((MR_Box) ((MR_Unsigned) 0U))), STATE_VARIABLE_PredInfo_1_51, &STATE_VARIABLE_PredInfo_2_54);
  else
    STATE_VARIABLE_PredInfo_2_54 = STATE_VARIABLE_PredInfo_1_51;
  hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_2_54, &ClausesInfo0_76);
  ItemNumbers0_77 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 7))));
  hlds__hlds_clauses__add_clause_item_number_5_p_0(SeqNum_23, Context_22, (MR_Integer) 1, ItemNumbers0_77, &ItemNumbers_78);
  Var_90 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 0))));
  Var_91 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 1))));
  Var_92 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 2))));
  Var_93 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 3))));
  Var_94 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 4))));
  Var_95 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 5))));
  Var_96 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_76, 6))));
  packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, ClausesInfo0_76, 8)));
  {
    ClausesInfo_79 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ClausesInfo_79, 0) = ((MR_Box) (Var_90));
    MR_hl_field(0, ClausesInfo_79, 1) = ((MR_Box) (Var_91));
    MR_hl_field(0, ClausesInfo_79, 2) = ((MR_Box) (Var_92));
    MR_hl_field(0, ClausesInfo_79, 3) = ((MR_Box) (Var_93));
    MR_hl_field(0, ClausesInfo_79, 4) = ((MR_Box) (Var_94));
    MR_hl_field(0, ClausesInfo_79, 5) = ((MR_Box) (Var_95));
    MR_hl_field(0, ClausesInfo_79, 6) = ((MR_Box) (Var_96));
    MR_hl_field(0, ClausesInfo_79, 7) = ((MR_Box) (ItemNumbers_78));
    MR_hl_field(0, ClausesInfo_79, 8) = (MR_Box) (packed_word_2);
  }
  hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_79, STATE_VARIABLE_PredInfo_2_54, &STATE_VARIABLE_PredInfo_3_56);
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_31, STATE_VARIABLE_PredInfo_3_56, STATE_VARIABLE_ModuleInfo_1_49, &STATE_VARIABLE_ModuleInfo_2_57);
  libs__globals__get_maybe_thread_safe_2_p_0(Globals_26, &MaybeThreadSafe_100);
  ThreadSafe_101 = parse_tree__prog_data_foreign__get_thread_safe_1_f_0(Attributes0_15);
  switch (ThreadSafe_101) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 2:
      switch (MaybeThreadSafe_100) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
  ...
  hlds__make_hlds__add_foreign_proc__compute_intended_proc_id_7_p_0(STATE_VARIABLE_ModuleInfo_2_57, STATE_VARIABLE_PredInfo_3_56, PFSymNameArity_25, PragmaVars_18, Attributes_32, Context_22, &MaybeProcId_33);
  hlds__make_hlds__add_foreign_proc__check_foreign_proc_12_p_0(STATE_VARIABLE_ModuleInfo_2_57, STATE_VARIABLE_PredInfo_3_56, PFSymNameArity_25, MaybeProcId_33, ProgVarSet_19, PragmaVars_18, Attributes_32, PragmaImpl_21, Context_22, &AllowedToAdd_34, STATE_VARIABLE_Specs_1_50, &STATE_VARIABLE_Specs_2_58);
  succeeded = (AllowedToAdd_34 == (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = ((MR_tag((MR_Word) MaybeProcId_33)) == (MR_Integer) 0);
    if (succeeded)
      ProcId_35 = ((MR_Integer) ((MR_hl_field(0, MaybeProcId_33, 0))));
  }
  if (succeeded)
  {
    MR_Word ForThisBackend_36;

    hlds__make_hlds__add_foreign_proc__is_foreign_proc_for_this_backend_3_p_0(Globals_26, Attributes_32, &ForThisBackend_36);
    if ((ForThisBackend_36 == (MR_Word) ((MR_Unsigned) 0U)))
      hlds__make_hlds__add_foreign_proc__add_nonimported_foreign_proc_12_p_0(PredId_31, STATE_VARIABLE_PredInfo_3_56, ProcId_35, PFSymNameArity_25, Attributes_32, PragmaVars_18, PragmaImpl_21, Context_22, STATE_VARIABLE_ModuleInfo_2_57, STATE_VARIABLE_ModuleInfo_39, STATE_VARIABLE_Specs_2_58, STATE_VARIABLE_Specs_41);
    else
    {
      MR_Word RejectCause_37 = ((MR_Word) ((MR_hl_field(1, ForThisBackend_36, 0))));

      hlds__make_hlds__add_foreign_proc__handle_wrong_backend_foreign_proc_9_p_0(ItemMercuryStatus_10, PredId_31, STATE_VARIABLE_PredInfo_3_56, RejectCause_37, Context_22, STATE_VARIABLE_ModuleInfo_2_57, STATE_VARIABLE_ModuleInfo_39, STATE_VARIABLE_Specs_2_58, STATE_VARIABLE_Specs_41);
    }
  }
  else
  {
    *STATE_VARIABLE_Specs_41 = STATE_VARIABLE_Specs_2_58;
    *STATE_VARIABLE_ModuleInfo_39 = STATE_VARIABLE_ModuleInfo_2_57;
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_90 = hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__991__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__586__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  hlds__make_hlds__add_foreign_proc__add_foreign_proc_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_39, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Specs_41);
  *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ModuleInfo_39));
  *wrapper_arg_5 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_41));
}
