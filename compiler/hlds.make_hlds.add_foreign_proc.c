...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 308, &AllowDefnOfBuiltin_38);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 494, &SharingAnalysis_12);
