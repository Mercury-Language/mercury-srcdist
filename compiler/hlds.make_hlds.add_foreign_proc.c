  ...
  MR_Word * STATE_VARIABLE_Specs_108)
{
  ...
  else
  {
    ...
    Var_241 = ((MR_Word) ((MR_hl_field(1, MultiplyOccurringArgVars_63, (MR_Integer) 0))));
    Var_240 = ((MR_Word) ((MR_hl_field(1, MultiplyOccurringArgVars_63, (MR_Integer) 1))));
    if ((Var_240 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      BadVarPiece_71 = parse_tree__error_spec__var_to_quote_piece_2_f_0(PVarSet_27, Var_241);
      {
