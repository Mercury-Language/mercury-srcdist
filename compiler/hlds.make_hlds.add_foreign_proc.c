    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), AmbiSpec_35, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_52, 2) = ((MR_Box) ((MR_Unsigned) 24U));
        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_178, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_200, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
      ...
      Var_196 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Pieces1_70, Pieces2_72);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_76, 2) = ((MR_Box) ((MR_Unsigned) 24U));
                ...
                *Overridden_26 = (MR_Integer) 0;
                ...
                if (succeeded)
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Spec_52, 2) = ((MR_Box) ((MR_Unsigned) 24U));
