...
{
  {
    ...
    TypeCtorInfo_226_226 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    TypeCtorInfo_227_227 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
    mercury__map__lookup_3_p_0(TypeCtorInfo_226_226, TypeCtorInfo_227_227, Preds0_41, ((MR_Box) (PredId_34)), &conv0_STATE_VARIABLE_PredInfo_119_119);
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__map__det_update_4_p_0(TypeCtorInfo_226_226, TypeCtorInfo_227_227, ((MR_Box) (PredId_34)), ((MR_Box) (STATE_VARIABLE_PredInfo_154_191)), Preds0_41, &Preds_62);
