    ...
    if (hlds__make_hlds__add_foreign_proc__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_37, (MR_Integer) 272, &hlds__make_hlds__add_foreign_proc__AllowDefnOfBuiltin_38);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_22, (MR_Integer) 48, &hlds__make_hlds__add_foreign_proc__VeryVerbose_29);
    }
