...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__730__1_2_p_0(
  MR_Word LaterOverridden_31,
  MR_Word HeadVar__2_101);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__503__1_2_p_0(
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 61, &VeryVerbose_29);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 295, &AllowDefnOfBuiltin_38);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__503__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_113);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__730__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 427, &SharingAnalysis_12);
...
{
  {
    ...
    if ((PredIds_21 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      if ((MaybeAttrs_8 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        hlds__make_hlds_error__report_undefined_pred_or_func_error_7_p_0(PredSymName_16, Arity_20, OtherArities_24, Context_10, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])), STATE_VARIABLE_Specs_0_42, STATE_VARIABLE_Specs_43);
      }
      else
      {
        MR_Word CompilerAttrs_26 = (MR_Word) (MR_body((MR_Word) (MaybeAttrs_8), (MR_Integer) 1));
        MR_Word AllowExport_27 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_26, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_49, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_18));
        }
        {
        ...
        {
          StartPieces_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeDetism_31)) == (MR_Integer) 1);
      if (succeeded)
      {
    ...
    else
    {
      ...
      {
        hlds__make_hlds_error__report_undefined_mode_error_6_p_0(PredSymName_18, Arity_14, Context_22, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])), STATE_VARIABLE_Specs_0_47, STATE_VARIABLE_Specs_48);
      }
      else
      {
        MR_Word CompilerAttrs_42 = (MR_Word) (MR_body((MR_Word) (MaybeAttrs_16), (MR_Integer) 1));
        MR_Word AllowExport_43 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_42, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
