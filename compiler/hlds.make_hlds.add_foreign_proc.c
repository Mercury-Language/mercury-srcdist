...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__683__1_2_p_0(
  MR_Word LaterOverridden_32,
  MR_Word HeadVar__2_70);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__444__1_2_p_0(
...
static /* final */ const MR_Box hlds__make_hlds__add_foreign_proc_scalar_common_1[77][2];
...
static /* final */ const MR_Box hlds__make_hlds__add_foreign_proc_scalar_common_1[77][2] = {
  ...
  /* row  62 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[60])))
  },
  /* row  63 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  MR_Word * STATE_VARIABLE_Specs_71)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 74, &VeryVerbose_30);
  ...
  else
  {
    ...
    else
    {
      ...
      {
        AmbiSpec_41 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, AmbiSpec_41, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/8"));
        MR_hl_field(0, AmbiSpec_41, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, AmbiSpec_41, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        MR_hl_field(0, AmbiSpec_41, 3) = ((MR_Box) (Context_22));
        MR_hl_field(0, AmbiSpec_41, 4) = ((MR_Box) (AmbiPieces_40));
      }
      {
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_55, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/8"));
      MR_hl_field(0, Spec_55, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_55, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      MR_hl_field(0, Spec_55, 3) = ((MR_Box) (Context_22));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Spec_183, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/8"));
          MR_hl_field(0, Spec_183, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Spec_183, 2) = ((MR_Box) ((MR_Unsigned) 44U));
          MR_hl_field(0, Spec_183, 3) = ((MR_Box) (Context_22));
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 336, &AllowDefnOfBuiltin_38);
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(0, Spec_40, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.clauses_info_add_foreign_proc\'/19"));
            MR_hl_field(0, Spec_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Spec_40, 2) = ((MR_Box) ((MR_Unsigned) 44U));
            MR_hl_field(0, Spec_40, 3) = ((MR_Box) (Context_31));
            MR_hl_field(0, Spec_40, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[48])));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_3 = parse_tree__error_spec__var_to_quote_piece_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__444__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_112);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_108)
{
  ...
  if ((MultiplyOccurringArgVars_63 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_21, &UserArity_226, PredFormArity_52);
        {
        ...
        parse_tree__parse_tree_out_misc__purity_name_2_p_0(Purity_30, &PurityStr_82);
        {
          ...
          MR_hl_field(3, Var_178, 0) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(3, Var_178, 1) = ((MR_Box) (PFSymNameArity_228));
        }
        {
          Var_177 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_177, 0) = ((MR_Box) (Var_178));
          MR_hl_field(1, Var_177, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[51])));
        }
        {
          Var_174 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_174, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[49])));
        ...
        }
        {
          ...
          MR_hl_field(3, Var_186, 1) = ((MR_Box) (ForeignAttributePurityStr_81));
        }
        {
          Var_185 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_185, 0) = ((MR_Box) (Var_186));
          MR_hl_field(1, Var_185, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[29])));
        }
        Var_184 = parse_tree__error_spec__color_as_incorrect_1_f_0(Var_185);
        {
          Var_196 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, Var_196, 0) = ((MR_Box) ((MR_Unsigned) 28U));
          MR_hl_field(3, Var_196, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
        }
        {
          Var_195 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_195, 0) = ((MR_Box) (Var_196));
          MR_hl_field(1, Var_195, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[54])));
        }
        {
          Var_192 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_192, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[52])));
        ...
        }
        {
          ...
          MR_hl_field(3, Var_204, 1) = ((MR_Box) (PurityStr_82));
        }
        {
          Var_203 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_203, 0) = ((MR_Box) (Var_204));
          MR_hl_field(1, Var_203, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[55])));
        }
        Var_202 = parse_tree__error_spec__color_as_correct_1_f_0(Var_203);
        Var_201 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_202, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[9])));
        Var_191 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_192, Var_201);
        Var_183 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_184, Var_191);
        Pieces_83 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_174, Var_183);
        {
          Spec_229 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Spec_229, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.clauses_info_do_add_foreign_proc\'/20"));
          ...
          MR_hl_field(0, Spec_229, 4) = ((MR_Box) (Pieces_83));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__quantification__implicitly_quantify_clause_body_general_vs_12_p_0((MR_Integer) 0, (MR_Integer) 0, HeadVarList_85, &_Warnings_94, HldsGoal0_91, &HldsGoal_95, VarSet0_38, &VarSet_96, EmptyExplicitVarTypes_92, &Var_97, EmptyRttiVarmaps_93, &Var_98);
          {
            ...
            MR_hl_field(1, Var_219, 0) = ((MR_Box) (ProcId_25));
          ...
          }
          {
            ...
            MR_hl_field(1, Var_221, 0) = (MR_Box) ((MR_Unsigned) (NewLang_51));
          }
          {
            Clause_99 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Clause_99, 0) = ((MR_Box) (Var_218));
            MR_hl_field(0, Clause_99, 1) = ((MR_Box) (HldsGoal_95));
            MR_hl_field(0, Clause_99, 2) = ((MR_Box) (Var_221));
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_122, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[62])));
    }
    {
      Var_119 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_119, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[57])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces1_69, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[56])));
      MR_hl_field(1, Pieces1_69, 1) = ((MR_Box) (Var_116));
    }
    Var_240 = ((MR_Word) ((MR_hl_field(1, MultiplyOccurringArgVars_63, (MR_Integer) 0))));
    Var_239 = ((MR_Word) ((MR_hl_field(1, MultiplyOccurringArgVars_63, (MR_Integer) 1))));
    if ((Var_239 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      BadVarPiece_71 = parse_tree__error_spec__var_to_quote_piece_2_f_0(PVarSet_27, Var_240);
      {
        Var_138 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_138, 0) = ((MR_Box) (BadVarPiece_71));
        MR_hl_field(1, Var_138, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_135 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_135, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[63])));
        MR_hl_field(1, Var_135, 1) = ((MR_Box) (Var_138));
      }
      Var_134 = parse_tree__error_spec__color_as_subject_1_f_0(Var_135);
      Var_140 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[65])));
      Pieces2_72 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_134, Var_140);
    }
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_146, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_6[0]));
        MR_hl_field(0, Var_146, 1) = ((MR_Box) (hlds__make_hlds__add_foreign_proc__clauses_info_do_add_foreign_proc_20_p_0_2));
        MR_hl_field(0, Var_146, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_146, 3) = ((MR_Box) (PVarSet_27));
      }
      BadVarPieces_76 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[2]), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_146, MultiplyOccurringArgVars_63);
      BadVarsPieces_77 = parse_tree__error_spec__component_list_to_color_pieces_3_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_3[0])), (MR_String) "and", BadVarPieces_76);
      Var_150 = parse_tree__error_spec__color_as_subject_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[67])));
      Var_156 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[69])));
      Var_155 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), BadVarsPieces_77, Var_156);
      Pieces2_72 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_150, Var_155);
    }
    Var_170 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces2_72, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[71])));
    Var_169 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces1_69, Var_170);
    {
      ...
      MR_hl_field(0, Spec_79, 4) = ((MR_Box) (Var_169));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__683__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
              ...
              *Overridden_26 = (MR_Integer) 0;
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_79, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[73])));
                ...
                }
                {
                  ...
                  MR_hl_field(1, PiecesA_51, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[72])));
                ...
                }
                {
                  ...
                  MR_hl_field(3, MsgB_54, 3) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[76])));
                }
                {
                ...
                }
                {
                  ...
                  MR_hl_field(2, Spec_55, 3) = ((MR_Box) (Var_109));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(0, Var_67, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_5[1]));
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 523, &SharingAnalysis_12);
