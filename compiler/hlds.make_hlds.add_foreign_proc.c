...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__597__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_66)
{
  ...
  if ((PredIds_32 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    hlds__add_pred__preds_add_implicit_report_error_14_p_0(PredOrFunc_16, PredModuleName_21, PredName_22, PredFormArity_24, PredStatus_7, (MR_Integer) 0, Context_12, Var_101, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[7])), &PredId_33, STATE_VARIABLE_ModuleInfo_0_63, &STATE_VARIABLE_ModuleInfo_103_103, STATE_VARIABLE_Specs_0_65, &STATE_VARIABLE_Specs_104_104);
  }
  else
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__364__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_110);
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__597__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
