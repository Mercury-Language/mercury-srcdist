  ...
  MR_Word * STATE_VARIABLE_Specs_73)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 78, &VeryVerbose_33);
  ...
  MR_Word * STATE_VARIABLE_Specs_50)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 346, &AllowDefnOfBuiltin_38);
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 533, &SharingAnalysis_12);
