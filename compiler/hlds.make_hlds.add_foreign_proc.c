...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 62, &VeryVerbose_29);
    ...
    else
    {
      ...
      else
      {
        ...
        {
          AmbiMsg_38 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              Msg_193 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Msg_193, 0) = ((MR_Box) (Context_11));
              MR_hl_field(MR_mktag(0), Msg_193, 1) = ((MR_Box) (Var_183));
            }
            {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 300, &AllowDefnOfBuiltin_38);
...
{
  {
    ...
    if ((MultiplyOccurringArgVars_65 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            Msg_211 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      {
        Msg_76 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 0:
              {
                ...
                *Overridden_26 = (MR_Integer) 0;
                ...
                if (succeeded)
                {
                  ...
                  {
                    MsgA_48 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), MsgA_48, 0) = ((MR_Box) (NewContext_18));
                    MR_hl_field(MR_mktag(0), MsgA_48, 1) = ((MR_Box) (Var_82));
                  }
                  {
                  ...
                  {
                    MsgB_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), MsgB_49, 0) = ((MR_Box) (Var_85));
                    MR_hl_field(MR_mktag(1), MsgB_49, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(1), MsgB_49, 2) = ((MR_Box) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(1), MsgB_49, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[53])));
                  }
                  {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 433, &SharingAnalysis_12);
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Msg_36, 1) = ((MR_Box) (Var_78));
        }
        {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Msg_34, 1) = ((MR_Box) (Var_69));
        }
        {
