...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__clauses_info_do_add_foreign_proc__467__1_2_f_0(
  MR_Word PVarSet_27,
...
static /* final */ const MR_Box hlds__make_hlds__add_foreign_proc_scalar_common_1[78][2];
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_238 = hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__clauses_info_do_add_foreign_proc__467__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_108)
{
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_178, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[51])));
        }
        {
          Var_175 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_175, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[49])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_186, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[29])));
        }
        ...
        }
        {
          ...
          MR_hl_field(1, Var_196, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[54])));
        }
        {
          Var_193 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_193, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[52])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_204, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[55])));
        }
        Var_203 = parse_tree__error_spec__color_as_correct_1_f_0(Var_204);
        Var_202 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_203, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[9])));
  ...
  else
  {
    ...
    else
    {
      ...
      BadVarsPieces_77 = parse_tree__error_spec__component_list_to_color_pieces_4_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_3[0])), (MR_String) "and", (MR_Word) ((MR_Unsigned) 0U), BadVarPieces_76);
      Var_151 = parse_tree__error_spec__color_as_subject_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[67])));
      Var_157 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[69])));
      ...
      Pieces2_72 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_151, Var_156);
    }
    Var_171 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces2_72, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[71])));
          ...
          case (MR_Integer) 0:
            {
              ...
              *Overridden_26 = (MR_Integer) 0;
              ...
              if (succeeded)
              {
                ...
                Var_76 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[74])));
                {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_95, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[11])));
                }
                {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_87, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[75])));
                ...
                PiecesA_51 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[72])), Var_75);
                {
                ...
                }
                {
                  ...
                  MR_hl_field(0, MsgB_54, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[77])));
                }
                {
