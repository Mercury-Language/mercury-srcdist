                          ...
                          if (hlds__make_hlds__add_foreign_proc__succeeded)
                            {
                              ...
                              }
                              {
                                ...
                                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_foreign_proc__Var_127, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[64])));
                              ...
                              }
                              {
                                ...
                                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_foreign_proc__PiecesA_115, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[63])));
                              ...
                              }
                              {
                                ...
                                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_foreign_proc__MsgB_118, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[65])));
                              }
                              {
                      ...
                      case (MR_Integer) 1:
                        {
                            ...
                            }
                          {
                            ...
                            MR_hl_field(MR_mktag(0), hlds__make_hlds__add_foreign_proc__Var_229, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_5[2]));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_7, (MR_Integer) 414, &hlds__make_hlds__add_foreign_proc__SharingAnalysis_12);
    }
    ...
    if (hlds__make_hlds__add_foreign_proc__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_37, (MR_Integer) 282, &hlds__make_hlds__add_foreign_proc__AllowDefnOfBuiltin_38);
        }
