  ...
  MR_Word * STATE_VARIABLE_Specs_108)
{
  ...
  {
    succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_32, (MR_Integer) 16);
    if (!(succeeded))
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_32, (MR_Integer) 17);
    if (succeeded)
