  ...
  MR_Word * STATE_VARIABLE_Specs_66)
{
  ...
  if ((PredIds_32 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0(PredOrFunc_16, PredModuleName_21, PredName_22, PredFormArity_24, PredStatus_7, (MR_Integer) 0, Context_12, Var_101, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[7])), &PredId_33, STATE_VARIABLE_ModuleInfo_0_63, &STATE_VARIABLE_ModuleInfo_103_103, STATE_VARIABLE_Specs_0_65, &STATE_VARIABLE_Specs_104_104);
  }
  else
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 316, &AllowDefnOfBuiltin_38);
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 503, &SharingAnalysis_12);
