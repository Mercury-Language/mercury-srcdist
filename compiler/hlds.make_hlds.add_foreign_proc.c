...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__677__1_2_p_0(
  MR_Word LaterOverridden_32,
  MR_Word HeadVar__2_70);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__445__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__445__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_110);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_106)
{
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Spec_199, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.clauses_info_do_add_foreign_proc\'/20"));
          MR_hl_field(0, Spec_199, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Spec_199, 2) = ((MR_Box) ((MR_Unsigned) 44U));
          MR_hl_field(0, Spec_199, 3) = ((MR_Box) (Context_33));
          MR_hl_field(0, Spec_199, 4) = ((MR_Box) (Pieces_81));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    Var_153 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces1_69, Pieces2_72);
    {
      ...
      MR_hl_field(0, Spec_77, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.clauses_info_do_add_foreign_proc\'/20"));
      MR_hl_field(0, Spec_77, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_77, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      MR_hl_field(0, Spec_77, 3) = ((MR_Box) (Context_33));
      MR_hl_field(0, Spec_77, 4) = ((MR_Box) (Var_153));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__677__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
