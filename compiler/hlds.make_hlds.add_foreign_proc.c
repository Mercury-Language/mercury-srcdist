        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_178, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 313, &AllowDefnOfBuiltin_38);
      ...
      else
      {
        ...
        else
        {
          ...
          parse_tree__prog_out__purity_name_2_p_0(Purity_21, &PurityStr_79);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_117, 0) = ((MR_Box) ((MR_Unsigned) 23U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 501, &SharingAnalysis_12);
