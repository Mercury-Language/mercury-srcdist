...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__717__1_2_p_0(
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_85, 0) = ((MR_Box) ((MR_Unsigned) 15U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_137, 0) = ((MR_Box) ((MR_Unsigned) 15U));
        ...
        else
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_176, 0) = ((MR_Box) ((MR_Unsigned) 15U));
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__490__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_113);
    if (succeeded)
    {
...
{
  {
    ...
    MR_Word HadSyntaxError_47 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_103, (MR_Integer) 8))) & (MR_Integer) 1);
    MR_Word Clauses0_48;
    MR_Word Globals_49;
    MR_Word Target_50;
    MR_Word NewLang_51;
      ...
      else
      {
        ...
        else
        {
          ...
          parse_tree__prog_out__purity_name_2_p_0(Purity_21, &PurityStr_82);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_120, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_31));
          }
          {
          ...
          {
            Msg_211 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Msg_211, 0) = ((MR_Box) (Context_30));
            MR_hl_field(MR_mktag(1), Msg_211, 1) = ((MR_Box) (Var_145));
          }
          {
            Var_150 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Spec_212 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Spec_212, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(0), Spec_212, 1) = ((MR_Box) ((MR_Unsigned) 16U));
        ...
        case (MR_Integer) 1:
          {
            ...
            HeadVarList_85 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[2]), HeadVars_42);
            ...
            {
              GoalExpr_90 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), GoalExpr_90, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_90, 5) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(3), GoalExpr_90, 6) = ((MR_Box) ((MR_Unsigned) 0U));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_157, 0) = (MR_Box) ((MR_Unsigned) (NewLang_51));
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Clause_99, 4) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Clauses_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_169, 0) = ((MR_Box) ((MR_Unsigned) 15U));
      ...
      if ((Var_226 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_193 = parse_tree__parse_tree_out_term__mercury_var_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PVarSet_26, Var_227);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_192, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_76, 1) = ((MR_Box) (Var_200));
      }
      {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__717__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
