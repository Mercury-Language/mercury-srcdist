...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__706__1_2_p_0(
  MR_Word LaterOverridden_32,
  MR_Word HeadVar__2_72);

static MR_Word MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__563__1_2_f_0(
  MR_Word PVarSet_13,
  MR_Word HeadVar__2_110);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__check_foreign_proc_arg_list__540__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__706__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(0, Var_69, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_4[2]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_111 = hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__563__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__check_foreign_proc_arg_list__540__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_42);
  if (succeeded)
  {
  ...
  MR_Word * Specs_16)
{
  ...
  mercury__list__filter_map_3_p_0((MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_2[0]), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[2]), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_2[2]), ArgVarBagAssocList_19, &MultiplyOccurringArgVars_23);
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_78, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_5[0]));
