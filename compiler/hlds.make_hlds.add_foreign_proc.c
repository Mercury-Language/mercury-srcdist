...
{
  {
    ...
    Var_206 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 0))));
    Var_207 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 1))));
    Var_208 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 2))));
    Var_209 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 3))));
    Var_210 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 4))));
    Var_211 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 5))));
    ItemNumbers0_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 6))));
    Var_212 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 7))));
    Var_213 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 8))));
    Var_214 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 9))));
    ...
    Var_221 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 6))));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))), PredInfo0_47, &STATE_VARIABLE_PredInfo_154_154);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))), STATE_VARIABLE_PredInfo_158_158, &STATE_VARIABLE_PredInfo_154_191);
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Spec_194, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              MR_hl_field(MR_mktag(0), Spec_194, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4))));
