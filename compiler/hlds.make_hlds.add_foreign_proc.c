...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__1012__1_2_f_0(
  MR_Word ProgVarSet_8,
  MR_Word HeadVar__2_89);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__602__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_90 = hlds__make_hlds__add_foreign_proc__IntroducedFrom__func__check_foreign_proc_arg_list__1012__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_ErrSpecs_24)
{
  ...
  if (succeeded)
  {
    ...
    *AllowedToAdd_12 = (MR_Integer) 1;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 766, &AllowDefnOfBuiltin_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 365, &SharingAnalysis_92);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__602__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
