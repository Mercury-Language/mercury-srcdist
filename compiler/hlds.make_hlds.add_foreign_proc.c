...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__678__1_2_p_0(
  MR_Word LaterOverridden_32,
  MR_Word HeadVar__2_70);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__446__1_2_p_0(
...
hlds__make_hlds__add_foreign_proc__add_foreign_proc_7_p_0_1(
  MR_Box closure_arg,
...
static void MR_CALL 
hlds__make_hlds__add_foreign_proc__add_foreign_procs_5_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static /* final */ const MR_Box hlds__make_hlds__add_foreign_proc_scalar_common_2[4][3] = {
  ...
  /* row   3 */
  {
    ...
    ((MR_Box) (hlds__make_hlds__add_foreign_proc__add_foreign_proc_7_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
...
void MR_CALL 
hlds__make_hlds__add_foreign_proc__add_foreign_proc_7_p_0(
...
{
  MR_bool succeeded;
  MR_Word Attributes0_13 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 0))));
  MR_Word PredSymName_14 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 1))));
  MR_Word PredOrFunc_15 = ((MR_Unsigned) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 2))) & (MR_Integer) 1);
  MR_Word PragmaVars_16 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 3))));
  MR_Word ProgVarSet_17 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 4))));
  MR_Word PragmaImpl_19 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 6))));
  MR_Word Context_20 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 7))));
  MR_Word SeqNum_21 = ((MR_Word) ((MR_hl_field(0, FPInfo_10, (MR_Integer) 8))));
  MR_Word PredModuleName_22;
  MR_String PredName_23;
  MR_Word PredFormArity_25;
  MR_Word PFSymNameArity_26;
  MR_Word Globals_27;
  ...
  MR_Word ItemNumbers0_43;
  MR_Word ItemNumbers_44;
  MR_Word ClausesInfo1_45;
  ...
  MR_Word MaybeForSpecificBackend_52;
  ...
  if (((MR_tag((MR_Word) PredSymName_14)) == (MR_Integer) 1))
  {
    PredModuleName_22 = ((MR_Word) ((MR_hl_field(1, PredSymName_14, (MR_Integer) 0))));
    PredName_23 = ((MR_String) ((MR_hl_field(1, PredSymName_14, (MR_Integer) 1))));
  }
  else
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/7", (MR_String) "unexpected PredSymName");
      return;
    }
  PredFormArity_25 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_pragma_var_0), PragmaVars_16);
  {
    PFSymNameArity_26 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, PFSymNameArity_26, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_15));
    MR_hl_field(0, PFSymNameArity_26, 1) = ((MR_Box) (PredSymName_14));
    MR_hl_field(0, PFSymNameArity_26, 2) = ((MR_Box) (PredFormArity_25));
  }
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_67, &Globals_27);
  libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 73, &VeryVerbose_28);
  switch (VeryVerbose_28) {
    ...
    case (MR_Integer) 1:
      {
        ...
        IdStr_30 = parse_tree__parse_tree_out_sym_name__pf_sym_name_pred_form_arity_to_string_1_f_0(PFSymNameArity_26);
        hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_0_67, &ProgressStream_31);
        mercury__io__write_string_4_p_0(ProgressStream_31, (MR_String) "% Processing \140:- pragma foreign_proc\' for ");
        mercury__io__write_string_4_p_0(ProgressStream_31, IdStr_30);
        mercury__io__write_string_4_p_0(ProgressStream_31, (MR_String) "...\n");
      }
      break;
  }
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_67, &PredTable0_32);
  hlds__pred_table__predicate_table_lookup_pf_m_n_a_7_p_0(PredTable0_32, (MR_Integer) 0, PredOrFunc_15, PredModuleName_22, PredName_23, PredFormArity_25, &PredIds_33);
  if ((PredIds_33 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_15, &UserArity_34, PredFormArity_25);
    {
      Var_82 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_82, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_15));
      MR_hl_field(0, Var_82, 1) = ((MR_Box) (PredSymName_14));
      MR_hl_field(0, Var_82, 2) = ((MR_Box) (UserArity_34));
    }
    {
      Origin_35 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Origin_35, 0) = ((MR_Box) (Var_82));
    }
    hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0(PredOrFunc_15, PredModuleName_22, PredName_23, PredFormArity_25, PredStatus_9, (MR_Integer) 0, Context_20, Origin_35, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_foreign_proc_scalar_common_1[7])), &PredId_36, STATE_VARIABLE_ModuleInfo_0_67, &STATE_VARIABLE_ModuleInfo_85_85, STATE_VARIABLE_Specs_0_69, &STATE_VARIABLE_Specs_86_86);
  }
  else
  {
    MR_Word Var_211 = ((MR_Word) ((MR_hl_field(1, PredIds_33, (MR_Integer) 1))));
    MR_Word Var_212 = ((MR_Word) ((MR_hl_field(1, PredIds_33, (MR_Integer) 0))));

    if ((Var_211 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      PredId_36 = Var_212;
      STATE_VARIABLE_ModuleInfo_85_85 = STATE_VARIABLE_ModuleInfo_0_67;
      STATE_VARIABLE_Specs_86_86 = STATE_VARIABLE_Specs_0_69;
    }
    else
    {
      MR_Word AmbiPieces_39;
      MR_Word AmbiSpec_40;
      MR_Word Var_97;
      MR_Word Var_98;
      ...
      PredId_36 = Var_212;
      {
        ...
        MR_hl_field(3, Var_98, 1) = ((MR_Box) (PFSymNameArity_26));
      }
      {
      ...
      {
        AmbiPieces_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, AmbiPieces_39, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])));
        MR_hl_field(1, AmbiPieces_39, 1) = ((MR_Box) (Var_97));
      }
      {
        AmbiSpec_40 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, AmbiSpec_40, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/7"));
        MR_hl_field(1, AmbiSpec_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, AmbiSpec_40, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(1, AmbiSpec_40, 3) = ((MR_Box) (Context_20));
        MR_hl_field(1, AmbiSpec_40, 4) = ((MR_Box) (AmbiPieces_39));
      }
      {
        STATE_VARIABLE_Specs_86_86 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, STATE_VARIABLE_Specs_86_86, 0) = ((MR_Box) (AmbiSpec_40));
        MR_hl_field(1, STATE_VARIABLE_Specs_86_86, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_69));
      }
      STATE_VARIABLE_ModuleInfo_85_85 = STATE_VARIABLE_ModuleInfo_0_67;
    }
  }
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_85_85, PredId_36, &STATE_VARIABLE_PredInfo_115_115);
  Var_116 = (MR_Word) (PredStatus_9);
  ...
  hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_118_118, &ClausesInfo0_42);
  ItemNumbers0_43 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 7))));
  hlds__hlds_clauses__add_clause_item_number_5_p_0(SeqNum_21, Context_20, (MR_Integer) 1, ItemNumbers0_43, &ItemNumbers_44);
  Var_193 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 0))));
  Var_194 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 1))));
  Var_195 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 2))));
  Var_196 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 3))));
  Var_197 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 4))));
  Var_198 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 5))));
  Var_199 = ((MR_Word) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 6))));
  packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, ClausesInfo0_42, (MR_Integer) 8)));
  {
    ClausesInfo1_45 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ClausesInfo1_45, 0) = ((MR_Box) (Var_193));
    MR_hl_field(0, ClausesInfo1_45, 1) = ((MR_Box) (Var_194));
    MR_hl_field(0, ClausesInfo1_45, 2) = ((MR_Box) (Var_195));
    MR_hl_field(0, ClausesInfo1_45, 3) = ((MR_Box) (Var_196));
    MR_hl_field(0, ClausesInfo1_45, 4) = ((MR_Box) (Var_197));
    MR_hl_field(0, ClausesInfo1_45, 5) = ((MR_Box) (Var_198));
    MR_hl_field(0, ClausesInfo1_45, 6) = ((MR_Box) (Var_199));
    MR_hl_field(0, ClausesInfo1_45, 7) = ((MR_Box) (ItemNumbers_44));
    MR_hl_field(0, ClausesInfo1_45, 8) = (MR_Box) (packed_word_2);
  }
  hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo1_45, STATE_VARIABLE_PredInfo_118_118, &STATE_VARIABLE_PredInfo_121_121);
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_36, STATE_VARIABLE_PredInfo_121_121, STATE_VARIABLE_ModuleInfo_85_85, &STATE_VARIABLE_ModuleInfo_122_122);
  libs__globals__get_maybe_thread_safe_2_p_0(Globals_27, &MaybeThreadSafe_46);
  ThreadSafe_47 = parse_tree__prog_data_foreign__get_thread_safe_1_f_0(Attributes0_13);
  switch (ThreadSafe_47) {
    ...
    case (MR_Integer) 2:
      switch (MaybeThreadSafe_46) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 0, Attributes0_13, &Attributes_48);
          break;
        case (MR_Integer) 1:
          parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 1, Attributes0_13, &Attributes_48);
          break;
      }
      break;
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      Attributes_48 = Attributes0_13;
      break;
  }
  CurrentBackend_49 = libs__globals__lookup_current_backend_1_f_0(Globals_27);
  libs__globals__get_backend_foreign_languages_2_p_0(Globals_27, &BackendForeignLangs_50);
  PragmaForeignLanguage_51 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attributes_48);
  MaybeForSpecificBackend_52 = parse_tree__prog_data_foreign__get_for_specific_backend_1_f_0(Attributes_48);
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(3, Var_134, 1) = ((MR_Box) (PFSymNameArity_26));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_53, 1) = ((MR_Box) (Var_127));
    }
    {
      Spec_54 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Spec_54, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/7"));
      MR_hl_field(1, Spec_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(1, Spec_54, 2) = ((MR_Box) ((MR_Unsigned) 40U));
      MR_hl_field(1, Spec_54, 3) = ((MR_Box) (Context_20));
    ...
    *STATE_VARIABLE_ModuleInfo_68 = STATE_VARIABLE_ModuleInfo_122_122;
  }
  else
  {
    MR_Word RejectCause_55;
    ...
    {
      {
        RejectCause_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, RejectCause_55, 0) = (MR_Box) ((MR_Unsigned) (PragmaForeignLanguage_51));
        MR_hl_field(1, RejectCause_55, 1) = ((MR_Box) (BackendForeignLangs_50));
      }
      succeeded = MR_TRUE;
    }
    else
    {
      MR_Word SpecificBackend_56;

      succeeded = (MaybeForSpecificBackend_52 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        SpecificBackend_56 = ((MR_Word) ((MR_hl_field(1, MaybeForSpecificBackend_52, (MR_Integer) 0))));
        succeeded = (SpecificBackend_56 != CurrentBackend_49);
        if (succeeded)
        {
          RejectCause_55 = (MR_Word) ((MR_Unsigned) 0U);
          succeeded = MR_TRUE;
        }
      }
    }
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_145 = ((MR_Word) ((MR_hl_field(1, ItemMercurystatus_8, (MR_Integer) 0))));
        succeeded = (Var_145 == (MR_Word) ((MR_Unsigned) 4U));
      }
      if (succeeded)
        hlds__make_hlds__add_foreign_proc__report_bad_foreign_proc_in_dot_opt_file_4_p_0(RejectCause_55, Context_20, STATE_VARIABLE_Specs_86_86, STATE_VARIABLE_Specs_70);
      else
        *STATE_VARIABLE_Specs_70 = STATE_VARIABLE_Specs_86_86;
      ...
      hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_36, STATE_VARIABLE_PredInfo_148_148, STATE_VARIABLE_ModuleInfo_122_122, STATE_VARIABLE_ModuleInfo_68);
    }
    else
    {
      MR_Word Procs_57;
      MR_Word ExistingProcs_58;
      MR_Word Modes_59;
      MR_Integer ProcId_60;

      hlds__hlds_pred__pred_info_get_proc_table_2_p_0(STATE_VARIABLE_PredInfo_121_121, &Procs_57);
      mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Procs_57, &ExistingProcs_58);
      parse_tree__prog_data_foreign__pragma_get_modes_2_p_0(PragmaVars_16, &Modes_59);
      succeeded = hlds__hlds_code_util__get_procedure_matching_declmodes_with_renaming_4_p_0(STATE_VARIABLE_ModuleInfo_122_122, ExistingProcs_58, Modes_59, &ProcId_60);
      if (succeeded)
      {
        MR_Word ArgTypes_61;
        MR_Word Purity_62;
        ...
        hlds__hlds_pred__pred_info_get_arg_types_2_p_0(STATE_VARIABLE_PredInfo_121_121, &ArgTypes_61);
        hlds__hlds_pred__pred_info_get_purity_2_p_0(STATE_VARIABLE_PredInfo_121_121, &Purity_62);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_121_121, &Markers_63);
        hlds__make_hlds__add_foreign_proc__clauses_info_add_foreign_proc_19_p_0(PredOrFunc_15, PredModuleName_22, PredName_23, PredId_36, ProcId_60, ProgVarSet_17, PragmaVars_16, ArgTypes_61, Purity_62, Attributes_48, Markers_63, Context_20, PragmaImpl_19, ClausesInfo1_45, &ClausesInfo_64, STATE_VARIABLE_ModuleInfo_122_122, &STATE_VARIABLE_ModuleInfo_150_150, STATE_VARIABLE_Specs_86_86, &STATE_VARIABLE_Specs_151_151);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_64, STATE_VARIABLE_PredInfo_121_121, &STATE_VARIABLE_PredInfo_152_152);
        ...
        hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_36, STATE_VARIABLE_PredInfo_148_181, STATE_VARIABLE_ModuleInfo_150_150, STATE_VARIABLE_ModuleInfo_68);
        parse_tree__prog_data_foreign__pragma_get_var_infos_2_p_0(PragmaVars_16, &ArgInfos_65);
        ArgNameModes_66 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_foreign_arg_name_mode_box_0), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[1]), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_2[3]), ArgInfos_65);
        hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_p_0(*STATE_VARIABLE_ModuleInfo_68, PragmaImpl_19, PragmaForeignLanguage_51, ArgNameModes_66, Context_20, PFSymNameArity_26, PredId_36, ProcId_60, STATE_VARIABLE_Specs_151_151, STATE_VARIABLE_Specs_70);
      }
      else
      {
        MR_Word Var_160;
...

        {
          ...
          MR_hl_field(3, Var_170, 1) = ((MR_Box) (PFSymNameArity_26));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(1, Spec_183, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_foreign_proc\'/7"));
          MR_hl_field(1, Spec_183, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(1, Spec_183, 2) = ((MR_Box) ((MR_Unsigned) 40U));
          MR_hl_field(1, Spec_183, 3) = ((MR_Box) (Context_20));
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 326, &AllowDefnOfBuiltin_38);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_foreign_proc__446__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_110);
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__678__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 513, &SharingAnalysis_12);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  hlds__make_hlds__add_foreign_proc__add_foreign_proc_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_68, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Specs_70);
  *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ModuleInfo_68));
  *wrapper_arg_5 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_70));
}

void MR_CALL 
hlds__make_hlds__add_foreign_proc__add_foreign_procs_5_p_0(
  MR_Word HeadVar__1_1,
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_16, &PredStatus_18);
      {
        ...
        MR_hl_field(0, Var_23, 1) = ((MR_Box) (hlds__make_hlds__add_foreign_proc__add_foreign_procs_5_p_0_1));
