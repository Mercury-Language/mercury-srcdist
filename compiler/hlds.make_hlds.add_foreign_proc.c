  ...
  MR_Word * STATE_VARIABLE_Specs_68)
{
  ...
  if ((PredIds_32 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_16, &UserArity_33, PredFormArity_24);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_80, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_16));
      MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (PredSymName_15));
      MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) (UserArity_33));
    }
    {
      Origin_34 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Origin_34, 0) = ((MR_Box) (Var_80));
    }
    hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0(PredOrFunc_16, PredModuleName_21, PredName_22, PredFormArity_24, PredStatus_7, (MR_Integer) 0, Context_12, Origin_34, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[7])), &PredId_35, STATE_VARIABLE_ModuleInfo_0_65, &STATE_VARIABLE_ModuleInfo_83_83, STATE_VARIABLE_Specs_0_67, &STATE_VARIABLE_Specs_84_84);
  }
  else
  {
    MR_Word Var_208 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_32, (MR_Integer) 1))));
    MR_Word Var_209 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_32, (MR_Integer) 0))));
    ...
    else
    {
      ...
      PredId_35 = Var_209;
      {
        ...
        MR_hl_field(MR_mktag(3), Var_96, 0) = ((MR_Box) ((MR_Unsigned) 12U));
        MR_hl_field(MR_mktag(3), Var_96, 1) = ((MR_Box) (PFSymNameArity_25));
      }
      {
        Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Var_96));
        MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[15])));
      }
      {
        AmbiPieces_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), AmbiPieces_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])));
        MR_hl_field(MR_mktag(1), AmbiPieces_38, 1) = ((MR_Box) (Var_95));
      }
      {
        AmbiSpec_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), AmbiSpec_39, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
        MR_hl_field(MR_mktag(1), AmbiSpec_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), AmbiSpec_39, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(MR_mktag(1), AmbiSpec_39, 3) = ((MR_Box) (Context_12));
        MR_hl_field(MR_mktag(1), AmbiSpec_39, 4) = ((MR_Box) (AmbiPieces_38));
      }
      {
        STATE_VARIABLE_Specs_84_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_84_84, 0) = ((MR_Box) (AmbiSpec_39));
  ...
  ItemNumbers0_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 7))));
  hlds__hlds_clauses__add_clause_item_number_5_p_0(SeqNum_13, Context_12, (MR_Integer) 1, ItemNumbers0_42, &ItemNumbers_43);
  Var_190 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 0))));
  Var_191 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 1))));
  Var_192 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 2))));
  Var_193 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 3))));
  Var_194 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 4))));
  Var_195 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 5))));
  Var_196 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 6))));
  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo0_41, (MR_Integer) 8)));
  {
    ClausesInfo1_44 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 0) = ((MR_Box) (Var_190));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 1) = ((MR_Box) (Var_191));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 2) = ((MR_Box) (Var_192));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 3) = ((MR_Box) (Var_193));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 4) = ((MR_Box) (Var_194));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 5) = ((MR_Box) (Var_195));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 6) = ((MR_Box) (Var_196));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 7) = ((MR_Box) (ItemNumbers_43));
    MR_hl_field(MR_mktag(0), ClausesInfo1_44, 8) = (MR_Box) (packed_word_2);
  }
  ...
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_133, 1) = ((MR_Box) (PFSymNameArity_25));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_129, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[17])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_126, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[16])));
        MR_hl_field(MR_mktag(1), Pieces_53, 1) = ((MR_Box) (Var_126));
      }
      {
        Spec_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Spec_54, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
        MR_hl_field(MR_mktag(1), Spec_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_54, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(MR_mktag(1), Spec_54, 3) = ((MR_Box) (Context_12));
      ...
      }
      {
        ...
        *STATE_VARIABLE_Specs_68 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_84_84));
      }
      *STATE_VARIABLE_ModuleInfo_66 = STATE_VARIABLE_ModuleInfo_120_120;
    }
    else
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_167, 0) = ((MR_Box) ((MR_Unsigned) 12U));
            MR_hl_field(MR_mktag(3), Var_167, 1) = ((MR_Box) (PFSymNameArity_25));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_166, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[11])));
          }
          {
            Var_163 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_163, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[18])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_160, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[4])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_157, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])));
            MR_hl_field(MR_mktag(1), Var_157, 1) = ((MR_Box) (Var_160));
          }
          {
            Pieces_179 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_179, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[16])));
            MR_hl_field(MR_mktag(1), Pieces_179, 1) = ((MR_Box) (Var_157));
          }
          {
            Spec_180 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_180, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
            MR_hl_field(MR_mktag(1), Spec_180, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_180, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_180, 3) = ((MR_Box) (Context_12));
            MR_hl_field(MR_mktag(1), Spec_180, 4) = ((MR_Box) (Pieces_179));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *STATE_VARIABLE_Specs_68 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Spec_180));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_84_84));
          }
          *STATE_VARIABLE_ModuleInfo_66 = STATE_VARIABLE_ModuleInfo_120_120;
        }
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 320, &AllowDefnOfBuiltin_38);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__604__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 507, &SharingAnalysis_12);
