...
{
  {
    ...
    if ((PredIds_21 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        MR_Word AllowExport_27 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_26, (MR_Integer) 0))) & (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word AllowExport_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_42, (MR_Integer) 0))) & (MR_Integer) 1);
