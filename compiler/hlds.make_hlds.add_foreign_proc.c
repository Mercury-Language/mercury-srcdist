...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 57, &VeryVerbose_29);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__map__to_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0, Procs_53, &ExistingProcs_54);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 283, &AllowDefnOfBuiltin_38);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__494__1_2_p_0(((MR_Word) wrapper_arg_1), &conv0_LambdaHeadVar__2_113);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__711__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
    ...
    else
    {
      ...
      if ((ApplProcIds0_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        if ((ClauseLang_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          succeeded = mercury__list__delete_first_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, AllProcIds_22, ((MR_Box) (NewClauseProcId_23)), &ProcIds_38);
          if (succeeded)
      ...
      else
      {
        ...
        if ((ClauseLang_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          succeeded = mercury__list__delete_first_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, Var_490, ((MR_Box) (NewClauseProcId_23)), &ProcIds_423);
          if (succeeded)
        ...
        else
        {
          ...
          succeeded = mercury__list__delete_first_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, Var_490, ((MR_Box) (NewClauseProcId_23)), &ProcIds_362);
          if (succeeded)
          {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 415, &SharingAnalysis_12);
...
{
  {
    ...
    MR_Word Name_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), PrednameModesPF_14, (MR_Integer) 0)));
    ...
    hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_36, &PredTable_19);
    ...
    hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredTable_19, (MR_Integer) 1, PredOrFunc_18, Name_16, Arity_20, &PredIds_21);
    if ((PredIds_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        hlds__make_hlds__make_hlds_error__report_undefined_pred_or_func_error_6_p_0(Name_16, Arity_20, Context_10, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6]), STATE_VARIABLE_Specs_0_38, STATE_VARIABLE_Specs_39);
      }
      else
      {
        MR_Word CompilerAttrs_22 = (MR_Word) MR_body(((MR_Word) MaybeAttrs_8), (MR_Integer) 1);
        MR_Word AllowExport_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), CompilerAttrs_22, (MR_Integer) 0)));
        MR_Word _IsMutable_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), CompilerAttrs_22, (MR_Integer) 1)));

        switch (AllowExport_23) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
            }
    ...
    else
    {
      ...
      if ((Var_106 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_2_13_p_0(Arity_20, PredTable_19, MaybeAttrs_8, Lang_13, Name_16, Var_107, Modes_17, ExportedName_15, Context_10, STATE_VARIABLE_ModuleInfo_0_36, STATE_VARIABLE_ModuleInfo_37, STATE_VARIABLE_Specs_0_38, STATE_VARIABLE_Specs_39);
      else
      {
        MR_Word StartPieces_29;
        MR_Word PredIdPiecesList_30;
        MR_Word PredIdPieces_31;
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (PredOrFunc_18));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[16])));
        }
        {
          StartPieces_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), StartPieces_29, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[46])));
          MR_hl_field(MR_mktag(1), StartPieces_29, 1) = ((MR_Box) (Var_44));
        }
        {
          Var_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_64, 0) = ((MR_Box) (&hlds__make_hlds__add_foreign_proc_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_64, 1) = ((MR_Box) (hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0_1));
          MR_hl_field(MR_mktag(0), Var_64, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_64, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_36));
          MR_hl_field(MR_mktag(0), Var_64, 4) = ((MR_Box) ((MR_Integer) 0));
        }
        PredIdPiecesList_30 = mercury__list__map_2_f_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &hlds__make_hlds__add_foreign_proc_scalar_common_1[0], Var_64, PredIds_21);
        PredIdPieces_31 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(PredIdPiecesList_30, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[48]));
        MainPieces_32 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, StartPieces_29, PredIdPieces_31);
        {
          Var_77 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (MainPieces_32));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[50])));
        }
        {
          Msg_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Msg_34, 0) = ((MR_Box) (Context_10));
          MR_hl_field(MR_mktag(0), Msg_34, 1) = ((MR_Box) (Var_76));
        }
        {
          Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (Msg_34));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_35, 2) = ((MR_Box) (Var_84));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    mercury__map__to_assoc_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, TypeCtorInfo_95_95, Procs_27, &ExistingProcs_28);
    ...
    if (succeeded)
    {
      ...
      mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_p_0(TypeCtorInfo_95_95, Procs_27, ProcId_29, &conv1_ProcInfo0_30);
    ...
    else
    {
      ...
      {
        hlds__make_hlds__make_hlds_error__report_undefined_mode_error_6_p_0(Name_18, Arity_14, Context_22, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6]), STATE_VARIABLE_Specs_0_47, STATE_VARIABLE_Specs_48);
      }
      else
      {
