...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPInfo_9, (MR_Integer) 2)));
    ...
    else
    {
      ...
      else
      {
        ...
        PredId_34 = Var_236;
        {
          ...
          MR_hl_field(MR_mktag(0), Var_86, 0) = (MR_Box) (packed_args_0);
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 8)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 8)));
    {
      ClausesInfo1_46 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), ClausesInfo1_46, 8) = (MR_Box) (packed_args_2);
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_138, 0) = (MR_Box) (packed_args_0);
      ...
      else
      {
        ...
        else
        {
          ...
          parse_tree__prog_data_foreign__pragma_get_modes_2_p_0(PVars_18, &Modes_55);
          {
            ...
            MR_hl_field(MR_mktag(0), SimpleCallId_56, 0) = (MR_Box) (packed_args_0);
          ...
          else
          {
            ...
            {
              Pieces_192 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              Msg_193 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            {
              Spec_194 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_103, (MR_Integer) 8)));
        ...
        case (MR_Integer) 1:
          {
            ...
            hlds__hlds_clauses__set_clause_list_2_p_0(Clauses_100, &ClausesRep_101);
            {
              ...
              *STATE_VARIABLE_ClausesInfo_104 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 1)) | (MR_Unsigned) (HadSyntaxError_47)));
            }
          }
          break;
        case (MR_Integer) 0:
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClauseLang_34, (MR_Integer) 0)));
          MR_Word ProcIds_362;
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Attr_6, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Integer Arity_20;
    MR_Word PredIds_21;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_9, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PrednameModesPF_14, (MR_Integer) 2)));
    ...
    if ((PredIds_21 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        MR_Word AllowExport_27 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_26, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
        MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_26, (MR_Integer) 0)));
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_49, 1) = (MR_Box) (packed_args_1);
        }
        {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word AllowExport_43 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_42, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_42, (MR_Integer) 0)));
