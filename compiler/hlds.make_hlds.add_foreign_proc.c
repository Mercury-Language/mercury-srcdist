...
{
  {
    ...
    if ((PredIds_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_64, &ModuleName_29);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_100, 0) = ((MR_Box) ((MR_Unsigned) 8U));
        MR_hl_field(MR_mktag(3), Var_100, 1) = ((MR_Box) (PredName_16));
      }
      hlds__add_pred__preds_add_implicit_report_error_14_p_0(STATE_VARIABLE_ModuleInfo_0_64, &STATE_VARIABLE_ModuleInfo_98_98, ModuleName_29, PredName_16, Arity_22, PredOrFunc_17, PredStatus_10, (MR_Integer) 0, Context_11, Var_100, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[5])), &PredId_30, STATE_VARIABLE_Specs_0_66, &STATE_VARIABLE_Specs_102_102);
    }
    else
    {
      ...
      {
        PredId_30 = Var_215;
        STATE_VARIABLE_ModuleInfo_98_98 = STATE_VARIABLE_ModuleInfo_0_64;
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), AmbiSpec_34, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/8"));
          MR_hl_field(MR_mktag(1), AmbiSpec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(1), AmbiSpec_34, 2) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(1), AmbiSpec_34, 3) = ((MR_Box) (Context_11));
    ...
    hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_98_98, &PredTable1_35);
    ...
    Var_110 = (MR_Word) (PredStatus_10);
    succeeded = (Var_110 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      hlds__hlds_pred__pred_info_set_status_3_p_0(PredStatus_10, STATE_VARIABLE_PredInfo_109_109, &STATE_VARIABLE_PredInfo_112_112);
    else
    ...
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_30, PredInfo0_42, STATE_VARIABLE_ModuleInfo_98_98, &STATE_VARIABLE_ModuleInfo_116_116);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_129, 0) = ((MR_Box) ((MR_Unsigned) 17U));
          MR_hl_field(MR_mktag(3), Var_129, 1) = ((MR_Box) (SimpleCallId_23));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_128, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])));
        }
        {
          Var_125 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[39])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_122, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[24])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_51, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/8"));
          MR_hl_field(MR_mktag(1), Spec_51, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(1), Spec_51, 2) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(1), Spec_51, 3) = ((MR_Box) (Context_11));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) ((MR_Unsigned) 4U), PredInfo0_42, &STATE_VARIABLE_PredInfo_141_141);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_p_0(*STATE_VARIABLE_ModuleInfo_65, PragmaImpl_21, PragmaForeignLanguage_48, ArgInfo_63, Context_11, SimpleCallId_23, PredId_30, ProcId_55, STATE_VARIABLE_Specs_144_144, STATE_VARIABLE_Specs_67);
          }
          else
          {
            MR_Word Var_153;
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_163, 0) = ((MR_Box) ((MR_Unsigned) 17U));
              MR_hl_field(MR_mktag(3), Var_163, 1) = ((MR_Box) (SimpleCallId_23));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_162, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])));
            }
            {
              Var_159 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_159, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[40])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_156, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[25])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_153, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[24])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Pieces_175, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[38])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_176, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/8"));
              MR_hl_field(MR_mktag(1), Spec_176, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), Spec_176, 2) = ((MR_Box) ((MR_Unsigned) 16U));
              MR_hl_field(MR_mktag(1), Spec_176, 3) = ((MR_Box) (Context_11));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_162, 1) = ((MR_Box) (SimpleCallId_69));
      }
      {
