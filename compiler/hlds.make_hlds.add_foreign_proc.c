  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 335, &AllowDefnOfBuiltin_38);
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 522, &SharingAnalysis_12);
