...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__598__1_2_p_0(
  MR_Word LaterOverridden_32,
  MR_Word HeadVar__2_109);

static MR_bool MR_CALL 
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__365__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_67)
{
  ...
  MR_Integer PredFormArityInt_32;
  MR_Word PredIds_33;
  MR_Word PredId_34;
  MR_Word ClausesInfo0_40;
  MR_Word ItemNumbers0_41;
  MR_Word ItemNumbers_42;
  MR_Word ClausesInfo1_43;
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__passes_aux__get_progress_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_0_64, &ProgressStream_30);
  ...
  hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_64, &PredTable0_31);
  PredFormArityInt_32 = (MR_Integer) (PredFormArity_24);
  hlds__pred_table__predicate_table_lookup_pf_m_n_a_7_p_0(PredTable0_31, (MR_Integer) 0, PredOrFunc_16, PredModuleName_21, PredName_22, PredFormArityInt_32, &PredIds_33);
  if ((PredIds_33 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_102, 1) = ((MR_Box) (PredSymName_15));
    }
    hlds__add_pred__preds_add_implicit_report_error_14_p_0(PredOrFunc_16, PredModuleName_21, PredName_22, PredFormArity_24, PredStatus_7, (MR_Integer) 0, Context_12, Var_102, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[7])), &PredId_34, STATE_VARIABLE_ModuleInfo_0_64, &STATE_VARIABLE_ModuleInfo_104_104, STATE_VARIABLE_Specs_0_66, &STATE_VARIABLE_Specs_105_105);
  }
  else
  {
    MR_Word Var_215 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_33, (MR_Integer) 1))));
    MR_Word Var_216 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_33, (MR_Integer) 0))));

    if ((Var_215 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      PredId_34 = Var_216;
      STATE_VARIABLE_ModuleInfo_104_104 = STATE_VARIABLE_ModuleInfo_0_64;
      STATE_VARIABLE_Specs_105_105 = STATE_VARIABLE_Specs_0_66;
    }
    else
    {
      ...
      PredId_34 = Var_216;
      {
        ...
        MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (PFSymNameArity_25));
      }
      {
        Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (Var_83));
        MR_hl_field(MR_mktag(1), Var_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[15])));
      }
      {
        AmbiPieces_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), AmbiPieces_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[8])));
        MR_hl_field(MR_mktag(1), AmbiPieces_37, 1) = ((MR_Box) (Var_82));
      }
      {
        AmbiSpec_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), AmbiSpec_38, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
        MR_hl_field(MR_mktag(1), AmbiSpec_38, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), AmbiSpec_38, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(MR_mktag(1), AmbiSpec_38, 3) = ((MR_Box) (Context_12));
        MR_hl_field(MR_mktag(1), AmbiSpec_38, 4) = ((MR_Box) (AmbiPieces_37));
      }
      {
        STATE_VARIABLE_Specs_105_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_105_105, 0) = ((MR_Box) (AmbiSpec_38));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_105_105, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_66));
      }
      STATE_VARIABLE_ModuleInfo_104_104 = STATE_VARIABLE_ModuleInfo_0_64;
    }
  }
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_104_104, PredId_34, &STATE_VARIABLE_PredInfo_112_112);
  Var_113 = (MR_Word) (PredStatus_7);
  succeeded = (Var_113 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    hlds__hlds_pred__pred_info_set_status_3_p_0((MR_Word) (((MR_Box) ((MR_Unsigned) 0U))), STATE_VARIABLE_PredInfo_112_112, &STATE_VARIABLE_PredInfo_115_115);
  else
    STATE_VARIABLE_PredInfo_115_115 = STATE_VARIABLE_PredInfo_112_112;
  hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_115_115, &ClausesInfo0_40);
  ItemNumbers0_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 6))));
  hlds__hlds_clauses__add_clause_item_number_5_p_0(SeqNum_13, Context_12, (MR_Integer) 1, ItemNumbers0_41, &ItemNumbers_42);
  Var_197 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 0))));
  Var_198 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 1))));
  Var_199 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 2))));
  Var_200 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 3))));
  Var_201 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 4))));
  Var_202 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 5))));
  Var_204 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 7))));
  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo0_40, (MR_Integer) 8)));
  {
    ClausesInfo1_43 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 0) = ((MR_Box) (Var_197));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 1) = ((MR_Box) (Var_198));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 2) = ((MR_Box) (Var_199));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 3) = ((MR_Box) (Var_200));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 4) = ((MR_Box) (Var_201));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 5) = ((MR_Box) (Var_202));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 6) = ((MR_Box) (ItemNumbers_42));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 7) = ((MR_Box) (Var_204));
    MR_hl_field(MR_mktag(0), ClausesInfo1_43, 8) = (MR_Box) (packed_word_2);
  }
  hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo1_43, STATE_VARIABLE_PredInfo_115_115, &PredInfo0_44);
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_34, PredInfo0_44, STATE_VARIABLE_ModuleInfo_104_104, &STATE_VARIABLE_ModuleInfo_119_119);
  libs__globals__get_maybe_thread_safe_2_p_0(Globals_26, &MaybeThreadSafe_45);
  ThreadSafe_46 = parse_tree__prog_data_foreign__get_thread_safe_1_f_0(Attributes0_14);
  switch (ThreadSafe_46) {
    ...
    case (MR_Integer) 2:
      switch (MaybeThreadSafe_45) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 0, Attributes0_14, &Attributes_47);
          break;
        case (MR_Integer) 1:
          parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 1, Attributes0_14, &Attributes_47);
          break;
      }
      break;
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      Attributes_47 = Attributes0_14;
      break;
  }
  CurrentBackend_48 = libs__globals__lookup_current_backend_1_f_0(Globals_26);
  libs__globals__get_backend_foreign_languages_2_p_0(Globals_26, &BackendForeignLangs_49);
  PragmaForeignLanguage_50 = parse_tree__prog_data_foreign__get_foreign_language_1_f_0(Attributes_47);
  ExtraAttrs_51 = parse_tree__prog_data_foreign__get_extra_attributes_1_f_0(Attributes_47);
  Var_122 = hlds__make_hlds__add_foreign_proc__is_applicable_for_current_backend_2_f_0(CurrentBackend_48, ExtraAttrs_51);
  succeeded = (Var_122 == (MR_Integer) 0);
  if (succeeded)
  {
    *STATE_VARIABLE_Specs_67 = STATE_VARIABLE_Specs_105_105;
    *STATE_VARIABLE_ModuleInfo_65 = STATE_VARIABLE_ModuleInfo_119_119;
  }
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_132, 1) = ((MR_Box) (PFSymNameArity_25));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_131, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[11])));
      }
      {
        Var_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_128, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[17])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_52, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[16])));
        MR_hl_field(MR_mktag(1), Pieces_52, 1) = ((MR_Box) (Var_125));
      }
      {
        Spec_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Spec_53, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
        MR_hl_field(MR_mktag(1), Spec_53, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_53, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(MR_mktag(1), Spec_53, 3) = ((MR_Box) (Context_12));
      ...
      }
      {
        ...
        *STATE_VARIABLE_Specs_67 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_105_105));
      }
      *STATE_VARIABLE_ModuleInfo_65 = STATE_VARIABLE_ModuleInfo_119_119;
    }
    else
    {
      ...
      if (succeeded)
      {
        MR_Word STATE_VARIABLE_PredInfo_144_144;

        hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 2, PredInfo0_44, &STATE_VARIABLE_PredInfo_144_144);
        hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_34, STATE_VARIABLE_PredInfo_144_144, STATE_VARIABLE_ModuleInfo_119_119, STATE_VARIABLE_ModuleInfo_65);
        *STATE_VARIABLE_Specs_67 = STATE_VARIABLE_Specs_105_105;
      }
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_44, &Procs_54);
        mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Procs_54, &ExistingProcs_55);
        parse_tree__prog_data_foreign__pragma_get_modes_2_p_0(PragmaVars_17, &Modes_56);
        succeeded = hlds__hlds_code_util__get_procedure_matching_declmodes_with_renaming_4_p_0(STATE_VARIABLE_ModuleInfo_119_119, ExistingProcs_55, Modes_56, &ProcId_57);
        if (succeeded)
        {
          MR_Word ArgTypes_58;
          MR_Word Purity_59;
          ...
          MR_Word ArgInfos_62;
          MR_Word ArgNameModes_63;
          MR_Word STATE_VARIABLE_ModuleInfo_146_146;
          MR_Word STATE_VARIABLE_Specs_147_147;
          MR_Word STATE_VARIABLE_PredInfo_148_148;
          MR_Word STATE_VARIABLE_PredInfo_144_177;

          hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_44, &ArgTypes_58);
          hlds__hlds_pred__pred_info_get_purity_2_p_0(PredInfo0_44, &Purity_59);
          hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_44, &Markers_60);
          hlds__make_hlds__add_foreign_proc__clauses_info_add_pragma_foreign_proc_19_p_0(PredOrFunc_16, PredModuleName_21, PredName_22, PredId_34, ProcId_57, ProgVarSet_18, PragmaVars_17, ArgTypes_58, Purity_59, Attributes_47, Markers_60, Context_12, PragmaImpl_20, ClausesInfo1_43, &ClausesInfo_61, STATE_VARIABLE_ModuleInfo_119_119, &STATE_VARIABLE_ModuleInfo_146_146, STATE_VARIABLE_Specs_105_105, &STATE_VARIABLE_Specs_147_147);
          hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_61, PredInfo0_44, &STATE_VARIABLE_PredInfo_148_148);
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 2, STATE_VARIABLE_PredInfo_148_148, &STATE_VARIABLE_PredInfo_144_177);
          hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_34, STATE_VARIABLE_PredInfo_144_177, STATE_VARIABLE_ModuleInfo_146_146, STATE_VARIABLE_ModuleInfo_65);
          parse_tree__prog_data_foreign__pragma_get_var_infos_2_p_0(PragmaVars_17, &ArgInfos_62);
          ArgNameModes_63 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_foreign_arg_name_mode_box_0), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[2]), (MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_2[2]), ArgInfos_62);
          hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_p_0(*STATE_VARIABLE_ModuleInfo_65, PragmaImpl_20, PragmaForeignLanguage_50, ArgNameModes_63, Context_12, PFSymNameArity_25, PredId_34, ProcId_57, STATE_VARIABLE_Specs_147_147, STATE_VARIABLE_Specs_67);
        }
        else
        {
          MR_Word Var_156;
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_166, 0) = ((MR_Box) ((MR_Unsigned) 12U));
            MR_hl_field(MR_mktag(3), Var_166, 1) = ((MR_Box) (PFSymNameArity_25));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_165, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[11])));
          }
          {
            Var_162 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_162, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[18])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_159, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[4])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_156, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_178, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[16])));
            MR_hl_field(MR_mktag(1), Pieces_178, 1) = ((MR_Box) (Var_156));
          }
          {
            Spec_179 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_179, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_foreign_proc.add_pragma_foreign_proc\'/6"));
            MR_hl_field(MR_mktag(1), Spec_179, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_179, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_179, 3) = ((MR_Box) (Context_12));
            MR_hl_field(MR_mktag(1), Spec_179, 4) = ((MR_Box) (Pieces_178));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *STATE_VARIABLE_Specs_67 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Spec_179));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_105_105));
          }
          *STATE_VARIABLE_ModuleInfo_65 = STATE_VARIABLE_ModuleInfo_119_119;
        }
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 317, &AllowDefnOfBuiltin_38);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__clauses_info_do_add_pragma_foreign_proc__365__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_110);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_106)
{
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__prog_out__purity_name_2_p_0(Purity_30, &PurityStr_80);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_117, 0) = ((MR_Box) ((MR_Unsigned) 15U));
          MR_hl_field(MR_mktag(3), Var_117, 1) = ((MR_Box) (PFSymNameArity_197));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_122, 1) = ((MR_Box) (ForeignAttributePurityStr_79));
        }
        {
          Var_127 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_127, 0) = ((MR_Box) ((MR_Unsigned) 27U));
          MR_hl_field(MR_mktag(3), Var_127, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_21));
        }
        {
          Var_132 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_132, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(MR_mktag(3), Var_132, 1) = ((MR_Box) (PurityStr_80));
        }
        {
          Var_131 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_131, 0) = ((MR_Box) (Var_132));
        ...
        {
          Var_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_128, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[24])));
          MR_hl_field(MR_mktag(1), Var_128, 1) = ((MR_Box) (Var_131));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_123, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[23])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_118, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[22])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_81, 1) = ((MR_Box) (Var_116));
        }
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          HeadVarList_83 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&hlds__make_hlds__add_foreign_proc_scalar_common_1[3]), HeadVars_42);
          ...
          hlds__quantification__implicitly_quantify_clause_body_general_11_p_0((MR_Integer) 0, HeadVarList_83, &_Warnings_92, HldsGoal0_89, &HldsGoal_93, VarSet0_38, &VarSet_94, EmptyVarTypes_90, &Var_95, EmptyRttiVarmaps_91, &Var_96);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_145, 0) = ((MR_Box) (ProcId_25));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_147, 0) = (MR_Box) ((MR_Unsigned) (NewLang_51));
          }
          {
            Clause_97 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Clause_97, 0) = ((MR_Box) (Var_144));
            MR_hl_field(MR_mktag(0), Clause_97, 1) = ((MR_Box) (HldsGoal_93));
            MR_hl_field(MR_mktag(0), Clause_97, 2) = ((MR_Box) (Var_147));
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_159, 0) = ((MR_Box) ((MR_Unsigned) 14U));
      MR_hl_field(MR_mktag(3), Var_159, 1) = ((MR_Box) (PFSymNameArity_68));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_158, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[28])));
    }
    {
      Var_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_155, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[26])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_152, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[6])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces1_69, 1) = ((MR_Box) (Var_152));
    }
    Var_222 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MultiplyOccurringArgVars_63, (MR_Integer) 0))));
    Var_221 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MultiplyOccurringArgVars_63, (MR_Integer) 1))));
    if ((Var_221 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      BadVarStr_71 = parse_tree__parse_tree_out_term__mercury_var_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PVarSet_27, Var_222);
      {
        Var_181 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_181, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(3), Var_181, 1) = ((MR_Box) (BadVarStr_71));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_180, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[31])));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces2_72, 1) = ((MR_Box) (Var_180));
      }
    }
    else
    {
      ...
      BadVarsStr_76 = parse_tree__parse_tree_out_term__mercury_vars_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PVarSet_27, MultiplyOccurringArgVars_63);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_170, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(3), Var_170, 1) = ((MR_Box) (BadVarsStr_76));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_169, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_foreign_proc_scalar_common_1[34])));
      }
      {
        Pieces2_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces2_72, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_foreign_proc_scalar_common_1[32])));
        MR_hl_field(MR_mktag(1), Pieces2_72, 1) = ((MR_Box) (Var_169));
      }
    }
    Var_191 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Pieces1_69, Pieces2_72);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_77, 4) = ((MR_Box) (Var_191));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__598__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv1_STATE_VARIABLE_ModuleInfo_65;
  MR_Word conv0_STATE_VARIABLE_Specs_67;

  hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ModuleInfo_65, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Specs_67);
  *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ModuleInfo_65));
  *wrapper_arg_5 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_67));
}
