...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_7, (MR_Integer) 402, &hlds__make_hlds__add_foreign_proc__SharingAnalysis_12);
    }
    ...
    if (hlds__make_hlds__add_foreign_proc__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_37, (MR_Integer) 273, &hlds__make_hlds__add_foreign_proc__AllowDefnOfBuiltin_38);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_foreign_proc__Globals_22, (MR_Integer) 49, &hlds__make_hlds__add_foreign_proc__VeryVerbose_29);
    }
