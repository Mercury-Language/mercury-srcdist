  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 737, &AllowDefnOfBuiltin_37);
  ...
  MR_Word * STATE_VARIABLE_Attributes_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 391, &SharingAnalysis_12);
