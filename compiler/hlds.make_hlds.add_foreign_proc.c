...
hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__720__1_2_p_0(
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPInfo_9, (MR_Integer) 2)));
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 60, &VeryVerbose_29);
    ...
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo0_43, (MR_Integer) 8)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 293, &AllowDefnOfBuiltin_38);
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ClausesInfo_0_103, (MR_Integer) 8)));
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_foreign_proc__IntroducedFrom__pred__add_foreign_proc_update_existing_clauses__720__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      if ((ApplProcIds0_32 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        if ((ClauseLang_34 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if (succeeded)
            if ((ProcIds_423 == (MR_Word) ((MR_Unsigned) 0U)))
              *Clauses_25 = LaterClauses_30;
            else
            {
              ...
              {
                Var_418 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_418, 0) = ((MR_Box) (ProcIds_423));
              }
              {
                FirstClause_417 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        ...
        {
          MR_Word OldLang_365 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClauseLang_34, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ClauseLang_34, (MR_Integer) 0)));
          MR_Word ProcIds_362;
                  ...
                  *Overridden_26 = (MR_Integer) 0;
                  ...
                  if (succeeded)
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_123, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_17));
                    }
                    {
                    ...
                    {
                      PiecesA_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    {
                      MsgA_117 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    {
                      MsgB_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), MsgB_118, 0) = ((MR_Box) (Var_137));
                      MR_hl_field(MR_mktag(1), MsgB_118, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Spec_119, 1) = ((MR_Box) ((MR_Unsigned) 16U));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if ((ProcIds_362 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    *Clauses_25 = LaterClauses_30;
                    *Overridden_26 = LaterOverridden_31;
                  }
                  else
                  {
                    ...
                    {
                      Var_218 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_218, 0) = ((MR_Box) (ProcIds_362));
                    }
                    {
                      FirstClause_219 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 425, &SharingAnalysis_12);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Attr_6, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Integer Arity_20;
    MR_Word PredIds_21;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FPEInfo_9, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PrednameModesPF_14, (MR_Integer) 2)));
    ...
    if ((PredIds_21 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_26, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CompilerAttrs_42, (MR_Integer) 0)));
