                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Instrs1_184 = mercury__list__f_43_43_2_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, Skipped_182, Rest_183);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_200, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = ((((MR_tag((MR_Word) Var_201)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_201, (MR_Integer) 0)))) == (MR_Integer) 12)));
                        if (succeeded)
                        {
