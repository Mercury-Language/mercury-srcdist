                                                  ...
                                                  if (ll_backend__peephole__succeeded)
                                                    {
                                                      ...
                                                      ll_backend__peephole__Var_209 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__peephole_scalar_common_1[7]);
                                                      {
                          ...
                          if (ll_backend__peephole__succeeded)
                            {
...

                              {
                                ...
                                MR_hl_field(MR_mktag(0), ll_backend__peephole__Var_129, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__peephole_scalar_common_1[9])));
                              ...
                              if (ll_backend__peephole__succeeded)
                                {
...

                                  {
                                    ...
                                    MR_hl_field(MR_mktag(1), ll_backend__peephole__Var_137, 0) = ((MR_Box) (&ll_backend__peephole_scalar_common_1[11]));
                                      ...
                                      if (ll_backend__peephole__succeeded)
                                        {
                                          ...
                                          ll_backend__peephole__Var_138 = (MR_Word) MR_mkword(MR_mktag(3), &ll_backend__peephole_scalar_common_1[12]);
