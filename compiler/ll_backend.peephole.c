...
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 3,8,10,12,6,22,24,26)
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 32,35,37,38,40,41,51,68)
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 71,74,69,79,82,78,85,89)
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 91,93,96,100,99,104,106,108)
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 98,114,120,119,117,127,113,141)
MR_decl_label8(ll_backend__peephole__peephole_match_4_0, 140,151,149,160,164,168,173,174)
MR_decl_label2(ll_backend__peephole__peephole_match_4_0, 178,1)
MR_decl_label5(ll_backend__peephole__peephole_opt_instr_5_0, 3,4,7,8,2)
MR_decl_label1(ll_backend__peephole__peephole_optimize_4_0, 3)
...
MR_BEGIN_MODULE(ll_backend__peephole_module2)
	...
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,3,8,10,12,6,22,24,26)
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,32,35,37,38,40,41,51,68)
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,71,74,69,79,82,78,85,89)
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,91,93,96,100,99,104,106,108)
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,98,114,120,119,117,127,113,141)
	MR_init_label8(ll_backend__peephole__peephole_match_4_0,140,151,149,160,164,168,173,174)
	MR_init_label2(ll_backend__peephole__peephole_match_4_0,178,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__peephole_module5)
	...
	MR_init_label1(ll_backend__peephole__peephole_optimize_4_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__peephole__peephole_optimize_4_0);
	...
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(ll_backend__peephole__peephole_optimize_4_0_i3);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,4);
	MR_np_tailcall_ent(ll_backend__peephole__peephole_optimize_2_4_0);
MR_def_label(ll_backend__peephole__peephole_optimize_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_tailcall_ent(ll_backend__peephole__peephole_optimize_2_4_0);
#ifdef MR_maybe_local_thread_engine_base
