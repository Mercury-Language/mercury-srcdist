...
struct ll_backend__peephole__vector_common_type_2_0_s {
...
static /* final */ const MR_Box ll_backend__peephole_scalar_common_1[15][2] = {
  ...
  /* row   2 */
  {
    ...
    ((MR_Box) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[1])))
  },
  /* row   3 */
  {
    ((MR_Box) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[2]))),
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &ll_backend__peephole_scalar_common_1[5])))
  },
  /* row   7 */
  {
    ((MR_Box) ((MR_Unsigned) 4U)),
  ...
  /* row  10 */
  {
    ((MR_Box) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[9]))),
  ...
  MR_Word * Mod_10)
{
  ...
  MR_Word InvalidPatterns0_12 = ((&ll_backend__peephole_vector_common_2[0 + GC_Method_6]))->ll_backend__peephole__vector_common_type_2_0__vct_2_f_0;
  ...
  MR_Word * Mod_10)
{
  ...
  {
    MR_Word Instrs2_16;
    MR_Word Uinstr0_17 = ((MR_Word) ((MR_hl_field(0, Instr0_6, (MR_Integer) 0))));
    MR_Word Lval_19;
    MR_Word Ptag_20;
    MR_Word Base_21;
    MR_Word Instrs1_22;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo_17_25, ((MR_Box) (Var_24)), InvalidPatterns_8);
        succeeded = !(succeeded);
        if (succeeded)
        {
          ll_backend__peephole__replace_tagged_ptr_components_in_instrs_5_p_0(Lval_19, Ptag_20, Base_21, Instrs1_11, &Instrs1_22);
          {
            ...
            MR_hl_field(1, Instrs2_16, 0) = ((MR_Box) (Instr0_6));
...
{
  MR_bool succeeded;
  MR_String Var_235 = ((MR_String) ((MR_hl_field(0, Instr0_1, (MR_Integer) 1))));
  MR_Word Var_236 = ((MR_Word) ((MR_hl_field(0, Instr0_1, (MR_Integer) 0))));
  ...
  switch (MR_tag((MR_Word) Var_236)) {
    default:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Var_236, (MR_Integer) 0))))) {
        default:
          succeeded = MR_FALSE;
          break;
        case (MR_Integer) 1:
          {
            MR_Word Base_179;
            MR_Word Redoip0_180 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 2))));
            MR_Word Var_190 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word Var_191;
            MR_Word Redoip1_181;
            MR_Word Skipped_182;
            MR_Word Rest_183;
            ...
            succeeded = ((((MR_tag((MR_Word) Var_190)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_190, (MR_Integer) 0)))) == (MR_Integer) 6)));
            if (succeeded)
            {
              Var_191 = ((MR_Word) ((MR_hl_field(3, Var_190, (MR_Integer) 1))));
              succeeded = ((MR_tag((MR_Word) Var_191)) == (MR_Integer) 0);
              if (succeeded)
              {
                Base_179 = ((MR_Word) ((MR_hl_field(0, Var_191, (MR_Integer) 0))));
                Var_193 = (MR_Word) ((MR_Unsigned) 0U);
                {
                  Var_192 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Var_192, 0) = ((MR_Box) (Base_179));
                ...
                if (succeeded)
                {
                  ...
                  Instrs1_184 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Skipped_182, Rest_183);
                  {
                    ...
                    MR_hl_field(3, Var_200, 0) = ((MR_Box) ((MR_Unsigned) 12U));
                    MR_hl_field(3, Var_200, 1) = ((MR_Box) (Redoip1_181));
                  }
                  {
                    Var_199 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, Var_199, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                    MR_hl_field(3, Var_199, 1) = ((MR_Box) (Var_200));
                  }
                  {
                    ...
                    MR_hl_field(3, Var_196, 1) = ((MR_Box) (Var_190));
                    MR_hl_field(3, Var_196, 2) = ((MR_Box) (Var_199));
                  }
                  {
                    RedoipInstr_185 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, RedoipInstr_185, 0) = ((MR_Box) (Var_196));
                    MR_hl_field(0, RedoipInstr_185, 1) = ((MR_Box) (Var_235));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *Instrs_4 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) (RedoipInstr_185));
                    MR_hl_field(1, base, 1) = ((MR_Box) (Instrs1_184));
                  }
                  succeeded = MR_TRUE;
                }
                else
                {
                  ...
                  if (succeeded)
                  {
                    succeeded = ((((MR_tag((MR_Word) Redoip0_180)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Redoip0_180, (MR_Integer) 0)))) == (MR_Integer) 1)));
                    if (succeeded)
                    {
                      Var_201 = ((MR_Word) ((MR_hl_field(3, Redoip0_180, (MR_Integer) 1))));
                      succeeded = ((((MR_tag((MR_Word) Var_201)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_201, (MR_Integer) 0)))) == (MR_Integer) 12)));
                      if (succeeded)
                      {
                        Var_202 = ((MR_Word) ((MR_hl_field(3, Var_201, (MR_Integer) 1))));
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                Var_210 = (MR_Word) (MR_mkword(1, &ll_backend__peephole_scalar_common_1[14]));
        ...
        case (MR_Integer) 4:
          {
            MR_Word NondetFrameInfo_73 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word Redoip0_74;
            MR_Word Var_101 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 2))));
            MR_Word Redoip1_79;
            MR_Word Skipped_80;
            MR_Word Rest_81;
            ...
            if (succeeded)
            {
              Redoip0_74 = ((MR_Word) ((MR_hl_field(1, Var_101, (MR_Integer) 0))));
              if (((MR_tag((MR_Word) NondetFrameInfo_73)) == (MR_Integer) 1))
                AllowedBases_77 = (MR_Word) (MR_mkword(1, &ll_backend__peephole_scalar_common_1[6]));
              else
                AllowedBases_77 = (MR_Word) (MR_mkword(1, &ll_backend__peephole_scalar_common_1[7]));
              ...
              if (succeeded)
              {
                ...
                Instrs1_82 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Skipped_80, Rest_81);
                {
                  ...
                  MR_hl_field(1, Var_111, 0) = ((MR_Box) (Redoip1_79));
                }
                {
                  Var_110 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, Var_110, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                  MR_hl_field(3, Var_110, 1) = ((MR_Box) (NondetFrameInfo_73));
                  MR_hl_field(3, Var_110, 2) = ((MR_Box) (Var_111));
                }
                {
                  NewInstr_83 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, NewInstr_83, 0) = ((MR_Box) (Var_110));
                  MR_hl_field(0, NewInstr_83, 1) = ((MR_Box) (Var_235));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *Instrs_4 = base;
                  MR_hl_field(1, base, 0) = ((MR_Box) (NewInstr_83));
                  MR_hl_field(1, base, 1) = ((MR_Box) (Instrs1_82));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                if (succeeded)
                {
                  Instr1_84 = ((MR_Word) ((MR_hl_field(1, Instrs1_144, (MR_Integer) 0))));
                  Instrs2_85 = ((MR_Word) ((MR_hl_field(1, Instrs1_144, (MR_Integer) 1))));
                  Var_112 = ((MR_Word) ((MR_hl_field(0, Instr1_84, (MR_Integer) 0))));
                  Comment1_88 = ((MR_String) ((MR_hl_field(0, Instr1_84, (MR_Integer) 1))));
                  succeeded = ((((MR_tag((MR_Word) Var_112)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_112, (MR_Integer) 0)))) == (MR_Integer) 9)));
                  if (succeeded)
                  {
                    Test_86 = ((MR_Word) ((MR_hl_field(3, Var_112, (MR_Integer) 1))));
                    Target_87 = ((MR_Word) ((MR_hl_field(3, Var_112, (MR_Integer) 2))));
                    ...
                    if (succeeded)
                    {
...

                      {
                        ...
                        MR_hl_field(3, Var_114, 1) = ((MR_Box) (Test_86));
                        MR_hl_field(3, Var_114, 2) = ((MR_Box) ((MR_Unsigned) 4U));
                      }
                      {
                        Var_113 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(0, Var_113, 0) = ((MR_Box) (Var_114));
                        MR_hl_field(0, Var_113, 1) = ((MR_Box) (Comment1_88));
                      }
                      {
                        Var_116 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(1, Var_116, 0) = ((MR_Box) (Instr0_1));
                        MR_hl_field(1, Var_116, 1) = ((MR_Box) (Instrs2_85));
                      }
                      {
                        InstrsPrime_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(1, InstrsPrime_89, 0) = ((MR_Box) (Var_113));
                        MR_hl_field(1, InstrsPrime_89, 1) = ((MR_Box) (Var_116));
                      }
                      succeeded = MR_TRUE;
                    }
                    else
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
...

                          {
                            ...
                            MR_hl_field(3, Var_122, 1) = ((MR_Box) (Test_86));
                            MR_hl_field(3, Var_122, 2) = ((MR_Box) ((MR_Unsigned) 4U));
                          }
                          {
                            Var_121 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                            MR_hl_field(0, Var_121, 0) = ((MR_Box) (Var_122));
                            MR_hl_field(0, Var_121, 1) = ((MR_Box) (Comment1_88));
                          }
                          {
                            Var_124 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(1, Var_124, 0) = ((MR_Box) (Instr0_1));
                            MR_hl_field(1, Var_124, 1) = ((MR_Box) (Instrs2_85));
                          }
                          {
                            InstrsPrime_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(1, InstrsPrime_89, 0) = ((MR_Box) (Var_121));
                            MR_hl_field(1, InstrsPrime_89, 1) = ((MR_Box) (Var_124));
                          }
                          succeeded = MR_TRUE;
                        }
                        else
                          ...
                          {
                            {
                              ...
                              MR_hl_field(3, Var_127, 0) = ((MR_Box) ((MR_Unsigned) 9U));
                              MR_hl_field(3, Var_127, 1) = ((MR_Box) (Test_86));
                              MR_hl_field(3, Var_127, 2) = ((MR_Box) (Redoip0_74));
                            }
                            {
                              Var_126 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(0, Var_126, 0) = ((MR_Box) (Var_127));
                              MR_hl_field(0, Var_126, 1) = ((MR_Box) (Comment1_88));
                            }
                            {
                              Var_125 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(1, Var_125, 0) = ((MR_Box) (Var_126));
                              MR_hl_field(1, Var_125, 1) = ((MR_Box) (Instrs2_85));
                            }
                            {
                              InstrsPrime_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(1, InstrsPrime_89, 0) = ((MR_Box) (Instr0_1));
                              MR_hl_field(1, InstrsPrime_89, 1) = ((MR_Box) (Var_125));
                            }
                            succeeded = MR_TRUE;
                          }
                        }
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    Instr1_146 = ((MR_Word) ((MR_hl_field(1, Instrs1_145, (MR_Integer) 0))));
                    Instrs2_155 = ((MR_Word) ((MR_hl_field(1, Instrs1_145, (MR_Integer) 1))));
                    Var_128 = ((MR_Word) ((MR_hl_field(0, Instr1_146, (MR_Integer) 0))));
                    Comment2_91 = ((MR_String) ((MR_hl_field(0, Instr1_146, (MR_Integer) 1))));
                    succeeded = ((((MR_tag((MR_Word) Var_128)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_128, (MR_Integer) 0)))) == (MR_Integer) 6)));
                    if (succeeded)
                    {
                      Var_129 = ((MR_Word) ((MR_hl_field(3, Var_128, (MR_Integer) 1))));
                  ...
                  if (succeeded)
                  {
...

                    {
                      ...
                      MR_hl_field(0, Var_130, 0) = ((MR_Box) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[8])));
                      MR_hl_field(0, Var_130, 1) = ((MR_Box) (Comment2_91));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      *Instrs_4 = base;
                      ...
                      MR_hl_field(1, base, 1) = ((MR_Box) (Instrs2_155));
                    }
                    succeeded = MR_TRUE;
                  }
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Instr1_148 = ((MR_Word) ((MR_hl_field(1, Instrs1_147, (MR_Integer) 0))));
                        Instrs2_152 = ((MR_Word) ((MR_hl_field(1, Instrs1_147, (MR_Integer) 1))));
                        Var_133 = ((MR_Word) ((MR_hl_field(0, Instr1_148, (MR_Integer) 0))));
                        succeeded = ((((MR_tag((MR_Word) Var_133)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_133, (MR_Integer) 0)))) == (MR_Integer) 6)));
                        if (succeeded)
                        {
                          Var_134 = ((MR_Word) ((MR_hl_field(3, Var_133, (MR_Integer) 1))));
                          succeeded = ((((MR_tag((MR_Word) Var_134)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_134, (MR_Integer) 0)))) == (MR_Integer) 0)));
                          if (succeeded)
                          {
                          }
                        }
                    ...
                    if (succeeded)
                    {
...

                      {
                        ...
                        MR_hl_field(1, Var_138, 0) = ((MR_Box) (&ll_backend__peephole_scalar_common_1[10]));
                        MR_hl_field(1, Var_138, 1) = ((MR_Box) (Instrs2_152));
                      }
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          DiscardUinstr_98 = (MR_Word) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[12]));
                          ...
                          TypeCtorInfo_228_228 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                          {
                            ...
                            MR_hl_field(0, DiscardInstr_100, 0) = ((MR_Box) (DiscardUinstr_98));
                            MR_hl_field(0, DiscardInstr_100, 1) = ((MR_Box) (DiscardComment_99));
                          }
                          {
                            Var_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(1, Var_142, 0) = ((MR_Box) (Instr0_1));
                            MR_hl_field(1, Var_142, 1) = ((MR_Box) (UntilSucceed_96));
                          }
                          {
                            Var_143 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(1, Var_143, 0) = ((MR_Box) (DiscardInstr_100));
                            MR_hl_field(1, Var_143, 1) = ((MR_Box) (Instrs2_149));
                          }
        ...
        case (MR_Integer) 7:
          {
            MR_Word SelectorRval_11 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word Labels_12 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 2))));
            MR_Word LabelMap_13;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_28 = ((MR_Word) ((MR_hl_field(1, LabelValsList_14, (MR_Integer) 0))));
                Var_29 = ((MR_Word) ((MR_hl_field(1, LabelValsList_14, (MR_Integer) 1))));
                succeeded = (Var_29 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Label_15 = ((MR_Word) ((MR_hl_field(0, Var_28, (MR_Integer) 0))));
                  succeeded = MR_TRUE;
                }
              }
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(1, Var_31, 0) = ((MR_Box) (Label_15));
                }
                {
                ...
                }
                {
                  ...
                  MR_hl_field(0, GotoInstr_17, 0) = ((MR_Box) (Var_30));
                  MR_hl_field(0, GotoInstr_17, 1) = ((MR_Box) (Var_235));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *Instrs_4 = base;
                  MR_hl_field(1, base, 0) = ((MR_Box) (GotoInstr_17));
                  MR_hl_field(1, base, 1) = ((MR_Box) (Instrs0_2));
                }
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                if (succeeded)
                {
                  LabelVals1_18 = ((MR_Word) ((MR_hl_field(1, LabelValsList_14, (MR_Integer) 0))));
                  Var_32 = ((MR_Word) ((MR_hl_field(1, LabelValsList_14, (MR_Integer) 1))));
                  succeeded = (Var_32 != (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    LabelVals2_19 = ((MR_Word) ((MR_hl_field(1, Var_32, (MR_Integer) 0))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Var_34 = (MR_Word) (MR_mkword(3, &ll_backend__peephole_scalar_common_1[4]));
                        Var_39 = (MR_String) "";
                        {
                          Var_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_37, 0) = ((MR_Box) (Val_21));
                        }
                        {
                        ...
                        {
                          CondRval_23 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(3, CondRval_23, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                          MR_hl_field(3, CondRval_23, 1) = ((MR_Box) (Var_34));
                          MR_hl_field(3, CondRval_23, 2) = ((MR_Box) (SelectorRval_11));
                          MR_hl_field(3, CondRval_23, 3) = ((MR_Box) (Var_36));
                        }
                        {
                          Var_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_38, 0) = ((MR_Box) (Var_235));
                        }
                        {
                          CommentInstr_24 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(0, CommentInstr_24, 0) = ((MR_Box) (Var_38));
                          MR_hl_field(0, CommentInstr_24, 1) = ((MR_Box) (Var_39));
                        }
                        {
                          Var_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_41, 0) = ((MR_Box) (OneValLabel_20));
                        }
                        {
                          Var_40 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(3, Var_40, 0) = ((MR_Box) ((MR_Unsigned) 9U));
                          MR_hl_field(3, Var_40, 1) = ((MR_Box) (CondRval_23));
                          MR_hl_field(3, Var_40, 2) = ((MR_Box) (Var_41));
                        }
                        {
                          BranchInstr_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(0, BranchInstr_25, 0) = ((MR_Box) (Var_40));
                          MR_hl_field(0, BranchInstr_25, 1) = ((MR_Box) (Var_39));
                        }
                        {
                          Var_44 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_44, 0) = ((MR_Box) (OtherLabel_22));
                        }
                        {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(0, GotoInstr_47, 0) = ((MR_Box) (Var_43));
                          MR_hl_field(0, GotoInstr_47, 1) = ((MR_Box) (Var_235));
                        }
                        {
                          Var_46 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_46, 0) = ((MR_Box) (GotoInstr_47));
                          MR_hl_field(1, Var_46, 1) = ((MR_Box) (Instrs0_2));
                        }
                        {
                          Var_45 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, Var_45, 0) = ((MR_Box) (BranchInstr_25));
                        ...
                        }
                        {
                          ...
                          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          *Instrs_4 = base;
                          MR_hl_field(1, base, 0) = ((MR_Box) (CommentInstr_24));
        ...
        case (MR_Integer) 9:
          {
            MR_Word Rval_55 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word CodeAddr_56 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 2))));
            MR_Word Taken_57;
            ...
            else
            {
              ...
              if (succeeded)
              {
                Instr1_59 = ((MR_Word) ((MR_hl_field(1, Instrs1_58, (MR_Integer) 0))));
                Var_66 = ((MR_Word) ((MR_hl_field(0, Instr1_59, (MR_Integer) 0))));
                succeeded = ((((MR_tag((MR_Word) Var_66)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_66, (MR_Integer) 0)))) == (MR_Integer) 6)));
                if (succeeded)
                {
                  Var_233 = ((MR_Word) ((MR_hl_field(3, Var_66, (MR_Integer) 1))));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Label_62 = ((MR_Word) ((MR_hl_field(1, CodeAddr_56, (MR_Integer) 0))));
        ...
        case (MR_Integer) 20:
          {
            MR_Word Lval_163 = ((MR_Word) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word Instrs1_164;
            MR_Word Instr1_165;
            MR_Word Instrs2_166;
            MR_Word Var_170;
            ...
            if (succeeded)
            {
              Instr1_165 = ((MR_Word) ((MR_hl_field(1, Instrs1_164, (MR_Integer) 0))));
              Instrs2_166 = ((MR_Word) ((MR_hl_field(1, Instrs1_164, (MR_Integer) 1))));
              Var_170 = ((MR_Word) ((MR_hl_field(0, Instr1_165, (MR_Integer) 0))));
              succeeded = ((((MR_tag((MR_Word) Var_170)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_170, (MR_Integer) 0)))) == (MR_Integer) 21)));
              if (succeeded)
              {
                Var_171 = ((MR_Word) ((MR_hl_field(3, Var_170, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_171)) == (MR_Integer) 0);
                if (succeeded)
                {
                  Var_234 = ((MR_Word) ((MR_hl_field(0, Var_171, (MR_Integer) 0))));
                  ...
                  {
                    {
                      ...
                      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      *Instrs_4 = base;
                      MR_hl_field(1, base, 0) = ((MR_Box) (Instr0_1));
                      MR_hl_field(1, base, 1) = ((MR_Box) (Instrs2_166));
                    }
                    succeeded = MR_TRUE;
                  }
                }
        ...
        case (MR_Integer) 24:
          {
            ...
            MR_Integer N_218 = ((MR_Integer) ((MR_hl_field(3, Var_236, (MR_Integer) 1))));
            MR_Word Between_221;
            MR_Word Remain_222;
...
{
  MR_bool succeeded;
  MR_Word Label1_11 = ((MR_Word) ((MR_hl_field(0, LabelVals1_6, (MR_Integer) 0))));
  MR_Word Vals1_12 = ((MR_Word) ((MR_hl_field(0, LabelVals1_6, (MR_Integer) 1))));
  MR_Word Label2_13 = ((MR_Word) ((MR_hl_field(0, LabelVals2_7, (MR_Integer) 0))));
  MR_Word Vals2_14 = ((MR_Word) ((MR_hl_field(0, LabelVals2_7, (MR_Integer) 1))));
  MR_Integer Val1_15;
  MR_Word Var_17;
  ...
  if (succeeded)
  {
    Val1_15 = ((MR_Integer) ((MR_hl_field(1, Vals1_12, (MR_Integer) 0))));
    Var_17 = ((MR_Word) ((MR_hl_field(1, Vals1_12, (MR_Integer) 1))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      *Val_9 = ((MR_Integer) ((MR_hl_field(1, Vals2_14, (MR_Integer) 0))));
      Var_18 = ((MR_Word) ((MR_hl_field(1, Vals2_14, (MR_Integer) 1))));
