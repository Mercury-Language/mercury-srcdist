          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (OldPtag_7));
                }
                {
          ...
          case (MR_Integer) 3:
            {
              ...
              else
              {
                ...
                ll_backend__peephole__replace_tagged_ptr_components_in_rval_5_p_0(OldLval_6, OldPtag_7, OldBase_8, RvalA0_34, &RvalA_32);
