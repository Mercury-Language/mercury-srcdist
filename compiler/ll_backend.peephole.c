          ...
          case (MR_Integer) 12:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_11, (MR_Integer) 6)));
              ...
              else
              {
                ...
                else
                {
                  ...
                  ll_backend__peephole__replace_tagged_ptr_components_in_rval_5_p_0(OldLval_6, OldPtag_7, OldBase_8, SizeRval0_24, &SizeRval_30);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Uinstr_116, 6) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 21:
            {
              ...
              MR_Word Uinstr_135;
              MR_Word Instr_136;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_11, (MR_Integer) 2)));
              ...
              ll_backend__peephole__replace_tagged_ptr_components_in_rval_5_p_0(OldLval_6, OldPtag_7, OldBase_8, Rval0_133, &Rval_134);
              {
                ...
                MR_hl_field(MR_mktag(3), Uinstr_135, 2) = (MR_Box) (packed_args_1);
              }
              {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 1)));
                          }
                        }
                      }
                      if (succeeded)
          ...
          case (MR_Integer) 20:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_170, (MR_Integer) 2)));
          ...
          case (MR_Integer) 24:
            {
              ...
              MR_Word Between_221;
              MR_Word Remain_222;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_236, (MR_Integer) 3)));
