...
static /* final */ const MR_Box ll_backend__peephole_scalar_common_1[15][2] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__peephole_scalar_common_1[5])))
  },
  /* row   7 */
  {
    ((MR_Box) ((MR_Unsigned) 4U)),
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_hl_field(MR_mktag(1), InvalidPatterns_11, 1) = ((MR_Box) (InvalidPatterns0_12));
      }
      break;
    case (MR_Integer) 0:
  ...
  MR_Word * Mod_10)
{
  ...
  {
    MR_Word Instrs2_16;
    MR_Word Uinstr0_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instr0_6, (MR_Integer) 0))));
    MR_Word Lval_19;
    MR_Word Ptag_20;
    MR_Word Base_21;
    MR_Word Instrs1_22;
    MR_Word Var_23;
    MR_Word TypeCtorInfo__17_25;
    MR_Word Var_24;

    succeeded = ((((MR_tag((MR_Word) Uinstr0_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Uinstr0_17, (MR_Integer) 0)))) == (MR_Integer) 1)));
    if (succeeded)
    {
      Lval_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_17, (MR_Integer) 1))));
      Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_17, (MR_Integer) 2))));
      succeeded = ((MR_tag((MR_Word) Var_23)) == (MR_Integer) 2);
      if (succeeded)
      {
        Ptag_20 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_23, (MR_Integer) 0))));
        Base_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_23, (MR_Integer) 1))));
        Var_24 = (MR_Integer) 1;
        TypeCtorInfo__17_25 = (MR_Word) (&ll_backend__peephole__ll_backend__peephole__type_ctor_info_pattern_0);
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo__17_25, ((MR_Box) (Var_24)), InvalidPatterns_8);
        succeeded = !(succeeded);
        if (succeeded)
        {
          ll_backend__peephole__replace_tagged_ptr_components_in_instrs_5_p_0(Lval_19, Ptag_20, Base_21, Instrs1_11, &Instrs1_22);
          {
            ...
            MR_hl_field(MR_mktag(1), Instrs2_16, 1) = ((MR_Box) (Instrs1_22));
          }
          succeeded = MR_TRUE;
        }
      }
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                TypeCtorInfo__230_230 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                                Var_210 = (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__peephole_scalar_common_1[14]));
                                Var_209 = mercury__list__f_43_43_2_f_0(TypeCtorInfo__230_230, Var_210, After_187);
                                *Instrs_4 = mercury__list__f_43_43_2_f_0(TypeCtorInfo__230_230, Between_186, Var_209);
                                succeeded = MR_TRUE;
                              }
                            }
                          }
        ...
        case (MR_Integer) 4:
          {
            ...
            if (succeeded)
            {
              ...
              if (((MR_tag((MR_Word) NondetFrameInfo_73)) == (MR_Integer) 1))
                AllowedBases_77 = (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__peephole_scalar_common_1[6]));
              else
                AllowedBases_77 = (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__peephole_scalar_common_1[7]));
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_130, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__peephole_scalar_common_1[8])));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(1), Var_138, 0) = ((MR_Box) (&ll_backend__peephole_scalar_common_1[10]));
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          DiscardUinstr_98 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__peephole_scalar_common_1[12]));
                          Var_141 = (MR_String) " (added discard)";
                          DiscardComment_99 = mercury__string__f_43_43_2_f_0(SucceedComment_97, Var_141);
                          TypeCtorInfo__228_228 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                          {
                          ...
                          *Instrs_4 = mercury__list__f_43_43_2_f_0(TypeCtorInfo__228_228, Var_142, Var_143);
                          succeeded = MR_TRUE;
                        }
                      }
                    }
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        Var_34 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__peephole_scalar_common_1[4]));
                        Var_39 = (MR_String) "";
                        {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(0), BranchInstr_25, 1) = ((MR_Box) (Var_39));
                        }
                        {
        ...
        case (MR_Integer) 24:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo__232_232 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                *Instrs_4 = mercury__list__f_43_43_2_f_0(TypeCtorInfo__232_232, Between_221, Remain_222);
                succeeded = MR_TRUE;
              }
            }
          }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__25_25 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
        TypeInfo__26_26 = (MR_Word) (&ll_backend__peephole_scalar_common_1[0]);
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo__25_25, TypeInfo__26_26, STATE_VARIABLE_LabelMap_0_3, ((MR_Box) (Label_13)), &conv0_Vals0_14);
        if (succeeded)
        {
