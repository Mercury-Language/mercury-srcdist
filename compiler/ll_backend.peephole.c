                      ...
                      if (ll_backend__peephole__succeeded)
                        {
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(3), ll_backend__peephole__V_199_199, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                              ...
                              if (ll_backend__peephole__succeeded)
                                {
                                  ...
                                  ll_backend__peephole__succeeded = ((((MR_tag((MR_Word) ll_backend__peephole__V_200_200)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__peephole__V_200_200, (MR_Integer) 0)))) == (MR_Integer) 4)));
                                  if (ll_backend__peephole__succeeded)
                                    {
