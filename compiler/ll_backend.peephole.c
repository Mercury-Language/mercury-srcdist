          ...
          case (MR_Integer) 12:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_11, (MR_Integer) 6)));
          ...
          case (MR_Integer) 21:
            {
              ...
              MR_Word Uinstr_135;
              MR_Word Instr_136;
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_11, (MR_Integer) 2)));
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_134, (MR_Integer) 1)));
                          }
                        }
                      }
                      if (succeeded)
          ...
          case (MR_Integer) 20:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_170, (MR_Integer) 2)));
          ...
          case (MR_Integer) 24:
            {
              ...
              MR_Word Between_221;
              MR_Word Remain_222;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_236, (MR_Integer) 3)));
