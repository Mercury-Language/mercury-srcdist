    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_46 = parse_tree__prog_out__promise_to_string_1_f_0(PromiseType_5);
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_56, 1) = ((MR_Box) (Var_27));
          }
          {
            Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (Var_56));
            MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[8])));
          }
          {
            Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[64])));
            MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) (Var_55));
          }
          {
            Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) (Var_52));
          }
          {
            Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[63])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_40, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[62])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_41, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_warn.promise_ex_error\'/5"));
            MR_hl_field(MR_mktag(1), Spec_41, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_41, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_41, 3) = ((MR_Box) (Context_16));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_28_28, 0) = ((MR_Box) (Spec_41));
        ...
        else
        {
          ...
          Var_69 = parse_tree__prog_out__promise_to_string_1_f_0(PromiseType_5);
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[83])));
          }
          {
            Pieces_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[62])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_64, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_warn.promise_ex_error\'/5"));
            MR_hl_field(MR_mktag(1), Spec_64, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_64, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_64, 3) = ((MR_Box) (Var_32));
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_p_0(Var_108, PragmaImpl_75, Lang_77, NamesModes_78, Context_76, Var_145, PredId_71, ProcId_72, (MR_Word) ((MR_Unsigned) 0U), &PragmaSpecs_79);
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word STATE_VARIABLE_Info_128_190;
                    MR_Word next_value_of_tscc_proc_1_input_1_Goal_5;
                    MR_Word next_value_of_tscc_proc_1_input_2_QuantVars_6;
                    MR_Word next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95;
                    ...
                    if ((Vars_184 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      ...
                      STATE_VARIABLE_Info_128_190 = STATE_VARIABLE_Info_0_95;
                    }
                    else
                    {
                      ...
                      hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_p_0(Vars_184, GoalInfo_9, EmptySet_177, SubGoalVars_176, STATE_VARIABLE_Info_0_95, &STATE_VARIABLE_Info_128_190);
                    ...
                    next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95 = STATE_VARIABLE_Info_128_190;
                    tscc_proc_1_input_1_Goal_5 = next_value_of_tscc_proc_1_input_1_Goal_5;
                    tscc_proc_1_input_2_QuantVars_6 = next_value_of_tscc_proc_1_input_2_QuantVars_6;
                    tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95 = next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95;
                    goto top_of_proc_1;
            ...
            case (MR_Integer) 6:
              {
                ...
                if (succeeded)
                {
                  ...
                  LangStr_28 = libs__globals__foreign_language_string_1_f_0(Lang_11);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_57, 0) = ((MR_Box) (LangStr_28));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[66])));
                  }
                  {
                    Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Spec_30, 4) = ((MR_Box) (Var_74));
                  }
                  {
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  LangStr_77 = libs__globals__foreign_language_string_1_f_0(Lang_11);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_34, 0) = ((MR_Box) (LangStr_77));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[68])));
                  }
                  {
                    Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Spec_79, 4) = ((MR_Box) (Var_51));
                  }
                  {
                    STATE_VARIABLE_Specs_23_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
