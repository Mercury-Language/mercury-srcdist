            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (((MR_Integer) 52 | (((MR_Integer) 1 << (MR_Integer) 10)))));
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_88, 0) = ((MR_Box) (((MR_Integer) 52 | (((MR_Integer) 1 << (MR_Integer) 10)))));
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (((MR_Integer) 52 | (((MR_Integer) 1 << (MR_Integer) 10)))));
