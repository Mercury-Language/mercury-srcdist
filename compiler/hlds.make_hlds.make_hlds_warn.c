...
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0, 188,4,6,7,3,10,9,12,15,16)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0, 20,14,22,24,28,30,31,33,34,35)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0, 27,36,37,38,26,40,46,47,49,50)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0, 51,44,131,55,56,58,59,60,53,63)
MR_decl_label7(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0, 42,73,74,69,78,76,67)
...
MR_decl_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__350__1_3_0)
MR_decl_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__382__1_3_0)
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,17)
	...
	MR_tfield(1, MR_tempr1, 0) = (MR_Integer) 39;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,7)
	...
	MR_tfield(1, MR_tempr2, 0) = (MR_Integer) 39;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_8_0,5)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_sv(6) = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(3,2,19);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 5);
	MR_r3 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_COMMON(1,2);
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__350__1_3_0);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_8_0,25)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,2,21);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_8_0,55)
	...
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__382__1_3_0);
	MR_tfield(0, MR_tempr4, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr4, 3) = MR_sv(4);
	MR_tfield(0, MR_tempr4, 4) = (MR_Integer) 0;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module10)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,188,4,6,7,3,10,9,12,15,16)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,20,14,22,24,28,30,31,33,34,35)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,27,36,37,38,26,40,46,47,49,50)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,51,44,131,55,56,58,59,60,53,63)
	MR_init_label7(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,42,73,74,69,78,76,67)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,69)
	...
	MR_np_localcall_lab(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0_i78);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_7_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,27)
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 3);
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 6;
	MR_tfield(1, MR_r2, 1) = (MR_Integer) 1;
	MR_tfield(1, MR_r2, 2) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module26)
	MR_init_entry1(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__350__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__350__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__warn_singletons_goal_vars__350__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__350__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module27)
	MR_init_entry1(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__382__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__382__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__warn_singletons_goal_vars__382__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__warn_singletons_goal_vars__382__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r1;
