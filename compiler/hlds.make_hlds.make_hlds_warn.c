...
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 186,3,6,5,8,11,12,16,17,10)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 20,22,25,27,28,24,32,33,34,35)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 36,37,31,38,39,40,30,46,47,48)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 49,50,44,129,54,55,56,57,58,52)
MR_decl_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 61,42,70,67,75,76,73,65)
...
MR_decl_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__453__1_3_0)
...
MR_def_static(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0)
	...
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__453__1_3_0);
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module12)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,186,3,6,5,8,11,12,16,17,10)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,20,22,25,27,28,24,32,33,34,35)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,36,37,31,38,39,40,30,46,47,48)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,49,50,44,129,54,55,56,57,58,52)
	MR_init_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,61,42,70,67,75,76,73,65)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,186)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,40)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i186);
	}
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,44)
	...
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i52);
	}
	MR_r6 = MR_tfield(1, MR_r5, 0);
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i54);
	}
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,129)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i186);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,55)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(parse_tree__set_of_var__init_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i56);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i57);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,52)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i129);
	}
	MR_sv(6) = MR_r2;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,42)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i65);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i70);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,67)
	...
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i73);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module32)
	MR_init_entry1(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__453__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__453__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__generate_variable_warning__453__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__453__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r1;
