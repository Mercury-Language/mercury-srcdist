  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_6, (MR_Integer) 1)));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_6, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_24)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadGoal_10, (MR_Integer) 3)));
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadGoal_10, (MR_Integer) 1)));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadGoal_10, (MR_Integer) 3)));
            {
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_8, (MR_Integer) 3)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word Args_142;
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 5)));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 1)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 2)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason_16, (MR_Integer) 0)));
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Reason_16, (MR_Integer) 1)));
                      MR_Word next_value_of_tscc_proc_1_input_1_Goal_5;
                      MR_Word next_value_of_tscc_proc_1_input_2_QuantVars_6;
                      MR_Word next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95;
                      ...
                      case (MR_Integer) 6:
                        {
                          ...
                          MR_Word Var_122;
                          MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_16, (MR_Integer) 2)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand_80, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_8, (MR_Integer) 1)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_word_9 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_8, (MR_Integer) 0)));
            MR_Unsigned packed_word_10 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_8, (MR_Integer) 5)));
            MR_Word next_value_of_tscc_proc_1_input_1_Goal_5;
            MR_Word next_value_of_tscc_proc_1_input_2_QuantVars_6;
            MR_Word next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95;
