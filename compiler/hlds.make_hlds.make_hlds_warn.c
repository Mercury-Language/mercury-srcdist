...
struct hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0_s {
  ...
  MR_Word hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__TypeCtorInfo__14_14;
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__21_21 = (MR_Word) (&hlds__make_hlds__make_hlds_warn_scalar_common_1[3]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__21_21, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__22_22 = (MR_Word) (&hlds__make_hlds__make_hlds_warn_scalar_common_1[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__22_22, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__23_23 = (MR_Word) (&hlds__make_hlds__make_hlds_warn_scalar_common_1[5]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__23_23, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__24_24 = (MR_Word) (&hlds__make_hlds__make_hlds_warn_scalar_common_1[5]);
  ...
  MR_Word Var_8)
{
  ...
  (env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__VarSet_7 = VarSet_7;
  {
    ...
    {
      (env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__TypeCtorInfo__14_14 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      (env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__succeeded = mercury__varset__search_name_3_p_0((env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__TypeCtorInfo__14_14, (env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__VarSet_7, Var_8, &(env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__Name_9);
      if ((env).hlds__make_hlds__make_hlds_warn__is_singleton_var_4_p_0_env_0__succeeded)
      {
        Var_11 = (MR_String) "_";
  ...
  if (succeeded)
  {
    ...
    *Name_6 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_8, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__list__member_2_p_0(TypeCtorInfo__10_10, ((MR_Box) (*Name_6)), NameList1_4);
      succeeded = !(succeeded);
    }
  }
  return succeeded;
      ...
      case (MR_Integer) 0:
        {
          ...
          mercury__string__to_char_list_2_p_0(Code_11, &CharList_52);
          hlds__make_hlds__make_hlds_warn__c_code_to_name_list_2_2_p_0(CharList_52, &C_CodeList_12);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_47 = parse_tree__prog_out__promise_to_string_1_f_0(PromiseType_5);
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_57, 1) = ((MR_Box) (Var_27));
          }
          {
            Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (Var_57));
            MR_hl_field(MR_mktag(1), Var_56, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[8])));
          }
          {
            Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[64])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[63])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_41, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[62])));
            MR_hl_field(MR_mktag(1), Pieces_41, 1) = ((MR_Box) (Var_45));
          }
          {
            Spec_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_42, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_warn.promise_ex_error\'/5"));
            MR_hl_field(MR_mktag(1), Spec_42, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_42, 3) = ((MR_Box) (Context_16));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_28_28, 0) = ((MR_Box) (Spec_42));
        ...
        else
        {
          ...
          Var_70 = parse_tree__prog_out__promise_to_string_1_f_0(PromiseType_5);
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[83])));
          }
          {
            Pieces_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[62])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_65, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_warn.promise_ex_error\'/5"));
            MR_hl_field(MR_mktag(1), Spec_65, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_65, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_65, 3) = ((MR_Box) (Var_32));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Word Goal_196 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ShortHand_80, (MR_Integer) 0))));
                    MR_Word Goals_197;
                    ...
                    {
                      Goals_197 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Goals_197, 0) = ((MR_Box) (GoalB_94));
                      MR_hl_field(MR_mktag(1), Goals_197, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_p_0(Goal_196, QuantVars_6, STATE_VARIABLE_Info_0_95, &STATE_VARIABLE_Info_15_201);
                    Goal_205 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_197, (MR_Integer) 0))));
                    // direct tailcall eliminated
                    ;
                    next_value_of_tscc_proc_1_input_1_Goal_5 = Goal_205;
                    next_value_of_tscc_proc_1_input_2_QuantVars_6 = QuantVars_6;
                    next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95 = STATE_VARIABLE_Info_15_201;
                    tscc_proc_1_input_1_Goal_5 = next_value_of_tscc_proc_1_input_1_Goal_5;
                    tscc_proc_1_input_2_QuantVars_6 = next_value_of_tscc_proc_1_input_2_QuantVars_6;
                    tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95 = next_value_of_tscc_proc_1_input_3_STATE_VARIABLE_Info_0_95;
                    goto top_of_proc_1;
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_101 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 0))));
      Var_102 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 1))));
      Var_103 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 2))));
      Specs0_99 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 3))));
      Var_104 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 4))));
      Var_105 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 5))));
      Var_106 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 6))));
      {
        Specs_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Specs_100, 0) = ((MR_Box) (SingleSpec_18));
        MR_hl_field(MR_mktag(1), Specs_100, 1) = ((MR_Box) (Specs0_99));
      }
      {
        STATE_VARIABLE_Info_31_31 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 0) = ((MR_Box) (Var_101));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 1) = ((MR_Box) (Var_102));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 2) = ((MR_Box) (Var_103));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 3) = ((MR_Box) (Specs_100));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 4) = ((MR_Box) (Var_104));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 5) = ((MR_Box) (Var_105));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_31_31, 6) = ((MR_Box) (Var_106));
      }
    }
  }
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  mercury__string__to_char_list_2_p_0(Code_21, &CharList_76);
  hlds__make_hlds__make_hlds_warn__c_code_to_name_list_2_2_p_0(CharList_76, &C_CodeList_23);
  {
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_77 = ((MR_String) ((MR_hl_field(MR_mktag(1), UnmentionedVars_24, (MR_Integer) 0))));
      Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), UnmentionedVars_24, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_82, 1) = ((MR_Box) (Var_77));
      }
      {
        Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Var_82));
        MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[42])));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_49, 1) = ((MR_Box) (Var_81));
      }
    }
    else
    {
      ...
      Var_92 = mercury__string__join_list_2_f_0((MR_String) ", ", UnmentionedVars_24);
      Var_91 = parse_tree__error_util__add_quotes_1_f_0(Var_92);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_warn_scalar_common_1[44])));
      }
      {
        Var_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_warn_scalar_common_1[34])));
        MR_hl_field(MR_mktag(1), Var_49, 1) = ((MR_Box) (Var_89));
      }
    }
    {
      Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
