  ...
  MR_Word Warning_7)
{
  ...
  Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces1_11, Pieces2_15);
  {
    ...
    MR_hl_field(0, Spec_8, 1) = ((MR_Box) (MR_mkword(2, &hlds__make_hlds__make_hlds_warn_scalar_common_2[1])));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(0, Spec_15, 1) = ((MR_Box) (MR_mkword(2, &hlds__make_hlds__make_hlds_warn_scalar_common_2[0])));
              MR_hl_field(0, Spec_15, 2) = ((MR_Box) ((MR_Unsigned) 44U));
              MR_hl_field(0, Spec_15, 3) = ((MR_Box) (Context_8));
              MR_hl_field(0, Spec_15, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__make_hlds_warn_scalar_common_1[20])));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
