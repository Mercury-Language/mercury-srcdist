    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Goal_6 = SubGoal_35;
            MR_Word next_value_of_STATE_VARIABLE_Specs_0_18 = STATE_VARIABLE_Specs_28_28;
  ...
  MR_Word * STATE_VARIABLE_Specs_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_DisjConjList_6 = Rest_9;
        MR_Word next_value_of_STATE_VARIABLE_Specs_0_10 = STATE_VARIABLE_Specs_13_13;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Goals_7 = Var_28;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadGoal_10, (MR_Integer) 3)));
            {
              ...
              {
                MR_Word next_value_of_Goals_7 = TailGoals_11;
                MR_Word next_value_of_STATE_VARIABLE_Specs_0_23 = STATE_VARIABLE_Specs_31_31;
          ...
          else
          {
            ...
            {
              MR_Word next_value_of_Goals_7 = TailGoals_11;
              MR_Word next_value_of_STATE_VARIABLE_Specs_0_23 = STATE_VARIABLE_Specs_36_36;
    ...
    case (MR_Integer) 2:
      {
        ...
        hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_p_0(LambdaGoal_25, QuantVars_10, STATE_VARIABLE_Info_33_33, STATE_VARIABLE_Info_30);
      }
      break;
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Goal_5 = SubGoal_15;
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__make_hlds_warn__warn_singletons_in_unify_6_p_0(Var_65, RHS_66, GoalInfo_9, QuantVars_6, STATE_VARIABLE_Info_0_95, STATE_VARIABLE_Info_96);
        }
        break;
      case (MR_Integer) 2:
        {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word next_value_of_Goal_5 = SubGoal_136;
                      MR_Word next_value_of_QuantVars_6 = SubQuantVars_23;
                      MR_Word next_value_of_STATE_VARIABLE_Info_0_95 = STATE_VARIABLE_Info_129_129;

                      Goal_5 = next_value_of_Goal_5;
                      QuantVars_6 = next_value_of_QuantVars_6;
                      STATE_VARIABLE_Info_0_95 = next_value_of_STATE_VARIABLE_Info_0_95;
                    }
                    continue;
                  }
                  break;
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    {
                      MR_Word next_value_of_Goal_5 = SubGoal_136;
                      MR_Word next_value_of_QuantVars_6 = SubQuantVars_192;
                      MR_Word next_value_of_STATE_VARIABLE_Info_0_95 = STATE_VARIABLE_Info_129_193;
          ...
          case (MR_Integer) 6:
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_Goal_5 = Else_46;
                MR_Word next_value_of_STATE_VARIABLE_Info_0_95 = STATE_VARIABLE_Info_118_118;
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word next_value_of_Goal_5 = SubGoal_145;
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Cases_10;
        MR_Word next_value_of_STATE_VARIABLE_Info_0_3 = STATE_VARIABLE_Info_18_18;
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Goals_10;
...
{
  {
    ...
    if (!(succeeded))
    {
      succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo_8, (MR_Integer) 13);
    }
    if (succeeded)
...
{
  {
    ...
    conv0_HeadVar__3_83 = hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__476__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (((MR_Integer) 51 | (((MR_Integer) 1 << (MR_Integer) 10)))));
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_88, 0) = ((MR_Box) (((MR_Integer) 51 | (((MR_Integer) 1 << (MR_Integer) 10)))));
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (((MR_Integer) 51 | (((MR_Integer) 1 << (MR_Integer) 10)))));
