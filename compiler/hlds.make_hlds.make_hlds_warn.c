...
MR_decl_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0, 22,23,27,29,31,33,35,30,37)
MR_decl_label3(hlds__make_hlds__make_hlds_warn__warn_singletons_in_cases_4_0, 10,3,4)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 196,3,6,5,8,11,12,16,17,10)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 20,22,25,27,28,24,32,33,34,35)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 36,37,31,38,39,40,30,44,48,49)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 50,51,52,46,55,54,60,61,62,63)
MR_decl_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 64,58,42,72,69,77,75,67)
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module11)
	...
	MR_init_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,22,23,27,29,31,33,35,30,37)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module12)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,196,3,6,5,8,11,12,16,17,10)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,20,22,25,27,28,24,32,33,34,35)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,36,37,31,38,39,40,30,44,48,49)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,50,51,52,46,55,54,60,61,62,63)
	MR_init_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,64,58,42,72,69,77,75,67)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,196)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,40)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i196);
	}
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,5)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i42);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r4;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,49)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(parse_tree__set_of_var__init_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i50);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,46)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i54);
	}
	MR_sv(1) = MR_r2;
	MR_sv(5) = MR_tfield(0, MR_r1, 1);
	...
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i55);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i58);
	}
	MR_r6 = MR_tfield(1, MR_r5, 0);
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i60);
	}
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i196);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,62)
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i63);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i64);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,42)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i67);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i72);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,72)
	...
	MR_np_localcall_lab(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i77);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i75);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_localcall_lab(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i77);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,75)
	...
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i196);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
