...
MR_decl_label9(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0, 78,9,11,7,5,4,27,29,26)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0, 2,3,5,7,9,10,11,14,69,13)
MR_decl_label4(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0, 16,12,39,41)
...
MR_decl_label7(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0, 38,2,7,9,5,13,11)
...
MR_decl_label6(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0, 3,14,15,16,18,36)
...
MR_decl_label3(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0, 2,4,1)
MR_decl_label8(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0, 3,5,8,11,17,18,16,1)
...
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0, 2,3,4,6,7,8,9,10,12,13)
MR_decl_label3(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0, 11,17,15)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0, 2,4,8,10,7,5,14,16,18,13)
MR_decl_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0, 21,22,26,28,30,32,34,29,36)
MR_decl_label3(hlds__make_hlds__make_hlds_warn__warn_singletons_in_cases_4_0, 10,3,4)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 194,3,6,5,8,11,12,14,15,10)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 18,20,23,24,25,22,29,30,31,32)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 33,34,28,35,36,37,27,41,45,46)
MR_decl_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 47,48,49,43,52,51,57,58,59,60)
MR_decl_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0, 61,55,39,69,66,74,75,72,64)
MR_decl_label3(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_list_4_0, 10,3,4)
MR_decl_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0, 2,3,4,6,8,17,21,22)
...
MR_decl_label4(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0, 10,6,17,24)
MR_decl_label8(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0, 4,6,8,10,12,14,18,1)
MR_decl_label9(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0, 3,2,5,9,13,17,21,25,82)
...
MR_decl_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0)
...
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__variable_warning_start_1_0)
	...
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(3,2,10);
...
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__variable_warning_start_1_0,36)
	...
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(3,2,12);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module5)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,2,3,5,7,9,10,11,14,69,13)
	MR_init_label4(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,16,12,39,41)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_decr_sp_and_return(6);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,16)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,4,3);
	...
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(3,2,15);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr3;
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,2,14);
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(1,3,2);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,12)
	...
	MR_r3 = MR_sv(4);
	MR_np_call_localret_ent(list__member_2_0,
		hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0_i39);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0_i69);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__libs__globals__foreign_language_string_1_0,
		hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0_i41);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_success_indicator_9_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(2,4,3);
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,1,11);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(3,2,17);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,2,14);
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module6)
	...
	MR_init_label9(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,78,9,11,7,5,4,27,29,26)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0)
	...
	if (MR_INT_NE(MR_r1,4)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0_i78);
	}
	MR_r1 = MR_r5;
	MR_proceed();
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,7)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,2,18);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,4)
	...
	MR_r3 = MR_r4;
	MR_np_call_localret_ent(list__member_2_0,
		hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0_i27);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0_i26);
	}
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__libs__globals__foreign_language_string_1_0,
		hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0_i29);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	{
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,1,16);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,2,15);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_fp_body_for_return_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module8)
	...
	MR_init_label8(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,2,3,4,6,8,17,21,22)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0_i8);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,8)
	...
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 2);
	MR_sv(9) = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(3,2,19);
	MR_tfield(1, MR_tempr4, 1) = MR_tempr2;
	}
	MR_np_call_localret_ent(fn__hlds__make_hlds__make_hlds_warn__variable_warning_start_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0_i17);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_sv(10);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(1,1,8);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr2;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0_i21);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module9)
	...
	MR_init_label6(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,3,14,15,16,18,36)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_sv(3) = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(3,2,21);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 5);
	MR_r3 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_COMMON(5,1);
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i14);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,3)
	...
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 5);
	MR_r3 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_COMMON(5,2);
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0);
	MR_tfield(0, MR_tempr4, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr4, 3) = MR_r4;
	MR_tfield(0, MR_tempr4, 4) = (MR_Integer) 0;
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i14);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__sort_and_remove_dups_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i15);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const(", ", 2);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__string__join_list_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i16);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	if (MR_LTAGS_TEST(MR_sv(4),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i18);
	}
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = MR_tempr2;
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_TAG_COMMON(1,1,9);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i36);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0_i36);
MR_def_label(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(1,3,0);
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module11)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,2,4,8,10,7,5,14,16,18,13)
	MR_init_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,21,22,26,28,30,32,34,29,36)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,2)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i4);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
	...
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i7);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,8)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_has_feature_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i10);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i5);
	}
	MR_r3 = MR_sv(8);
	MR_r1 = MR_sv(9);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_sv(7) = MR_sv(5);
	MR_np_call_localret_ent(list__filter_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i26);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,5)
	...
	MR_r2 = (MR_Integer) 1;
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_has_feature_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i14);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i13);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(6);
	MR_r3 = MR_tfield(0, MR_sv(5), 4);
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i16);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i18);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 7);
	...
	MR_np_call_localret_ent(list__filter_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i26);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(3);
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i21);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i28);
	}
	MR_r1 = MR_sv(7);
	MR_decr_sp_and_return(10);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Integer) 1;
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_has_feature_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i30);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,30)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(8);
	MR_r3 = MR_tfield(0, MR_sv(7), 5);
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i32);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 7);
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i34);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,29)
	...
	MR_r5 = MR_sv(8);
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0_i36);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module12)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,194,3,6,5,8,11,12,14,15,10)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,18,20,23,24,25,22,29,30,31,32)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,33,34,28,35,36,37,27,41,45,46)
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,47,48,49,43,52,51,57,58,59,60)
	MR_init_label9(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,61,55,39,69,66,74,75,72,64)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,194)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,12)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i14);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__warn_singletons_in_pragma_foreign_proc_10_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i15);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,10)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,2)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i18);
	}
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_list_4_0);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,20)
	...
	MR_np_call_localret_ent(hlds__goal_util__generic_call_vars_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i23);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i24);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,22)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,6)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i27);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r4;
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i29);
	}
	MR_sv(5) = MR_r3;
	MR_r3 = MR_r2;
	...
	MR_r2 = MR_tempr1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i28);
	}
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(5) = MR_tfield(0, MR_r1, 1);
	{
	...
	MR_np_call_localret_ent(fn__hlds__quantification__free_goal_vars_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i30);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__hlds__quantification__free_goal_vars_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i31);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,31)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__union_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i32);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,32)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__init_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i33);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,35)
	...
	MR_np_localcall_lab(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i36);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,37)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i194);
	}
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,5)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i39);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r4;
	MR_tempr1 = MR_tfield(3, MR_tempr2, 1);
	MR_r5 = MR_tempr1;
	if (!((((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 3)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1))) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 5))))) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i41);
	}
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,41)
	...
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i43);
	}
	MR_r6 = MR_tfield(0, MR_r5, 0);
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i45);
	}
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i194);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(5) = MR_tfield(0, MR_r1, 1);
	MR_sv(6) = MR_r6;
	...
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__hlds__quantification__free_goal_vars_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i46);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,46)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(parse_tree__set_of_var__init_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i47);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__warn_singletons_goal_vars_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i48);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,49)
	...
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i194);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i51);
	}
	MR_sv(1) = MR_r2;
	MR_sv(5) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,58)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(parse_tree__set_of_var__init_1_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i59);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("hlds.make_hlds.make_hlds_warn", 29);
	MR_r2 = (MR_Word) MR_string_const("predicate \140hlds.make_hlds.make_hlds_warn.warn_singletons_in_goal\'/4", 67);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,39)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i64);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i66);
	}
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__insert_list_3_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i69);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i72);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_localcall_lab(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i74);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(5);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(2, MR_r5, 2);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0_i194);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_in_goal_4_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module16)
	...
	MR_init_label10(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,2,3,4,6,7,8,9,10,12,13)
	MR_init_label3(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,11,17,15)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,4)
	...
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__init_0_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_6_0_i6);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,10)
	...
	MR_sv(7) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0_i11);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,12)
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_6_0_i13);
...
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,11)
	...
	if (MR_LTAGS_TEST(MR_sv(7),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0_i15);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(7);
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__generate_variable_warning_6_0,
		hlds__make_hlds__make_hlds_warn__warn_singletons_6_0_i17);
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = MR_sv(7);
	MR_r1 = MR_r2;
MR_def_label(hlds__make_hlds__make_hlds_warn__warn_singletons_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module21)
	...
	MR_init_label7(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,38,2,7,9,5,13,11)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,7)
	...
	MR_np_call_localret_ent(list__map_3_0,
		hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0_i9);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,5)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,2)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0_i11);
	}
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__make_hlds__make_hlds_warn__promise_ex_error_5_0,
		hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0_i13);
MR_def_label(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0,13)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__check_promise_ex_goal_4_0_i38);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module23)
	...
	MR_init_label4(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,10,6,17,24)
MR_BEGIN_CODE
...
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0)
	...
	if (MR_LTAGS_TEST(MR_tempr4,0,0)) {
		MR_GOTO_LAB(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i6);
	}
	MR_tempr2 = MR_tfield(1, MR_tempr4, 1);
	if (MR_LTAGS_TESTR(MR_tempr2,0,0)) {
		MR_GOTO_LAB(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i6);
	}
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(3,2,10);
	MR_tempr2 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_tempr2;
	MR_r3 = (MR_Integer) 0;
	...
	MR_np_call_localret_ent(fn__parse_tree__mercury_to_mercury__mercury_var_to_string_3_0,
		fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i10);
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,1,31);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr3;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i24);
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(3,2,12);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	...
	MR_np_call_localret_ent(fn__parse_tree__mercury_to_mercury__mercury_vars_to_string_3_0,
		fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i17);
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,1,32);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_sv(3);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0_i24);
MR_def_label(fn__hlds__make_hlds__make_hlds_warn__warn_overlap_to_spec_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	{
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(1,3,1);
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_tbmkword(0, 2);
	MR_tfield(0, MR_r1, 2) = MR_tempr1;
	MR_decr_sp_and_return(4);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module25)
	...
	MR_init_label8(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,3,5,8,11,17,18,16,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_0,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i3);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i5);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i1);
	}
	...
	MR_r2 = (MR_Word) MR_string_const("_", 1);
	MR_np_call_localret_ent(string__prefix_2_0,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i8);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i1);
	}
	...
	MR_np_call_localret_ent(string__prefix_2_0,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i11);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i1);
	}
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i16);
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_1,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i17);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,17)
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0_i18);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r1 = MR_FALSE;
	MR_proceed();
MR_def_label(hlds__make_hlds__make_hlds_warn__is_singleton_var_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(5);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(6);
	MR_succip_word = MR_sv(8);
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module26)
	...
	MR_init_label3(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_0,
		hlds__make_hlds__make_hlds_warn__is_multi_var_3_0_i2);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__make_hlds__make_hlds_warn__is_multi_var_3_0_i4);
MR_def_label(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_warn__is_multi_var_3_0_i1);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module30)
	...
	MR_init_label8(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0,4,6,8,10,12,14,18,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i18);
	}
	MR_incr_sp(13);
...
MR_def_label(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0,10)
	...
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i12);
MR_def_label(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i1);
	}
	...
	MR_r3 = MR_sv(11);
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i14);
MR_def_label(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i1);
	}
...
MR_def_label(__Unify___hlds__make_hlds__make_hlds_warn__warn_info_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module31)
	...
	MR_init_label9(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,3,2,5,9,13,17,21,25,82)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i82);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(7);
...
MR_def_label(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,17)
	...
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i21);
MR_def_label(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i82);
	}
	...
	MR_r3 = MR_sv(11);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i25);
MR_def_label(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0_i82);
	}
...
MR_def_label(__Compare___hlds__make_hlds__make_hlds_warn__warn_info_0_0,82)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_warn_module32)
	MR_init_entry1(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__generate_variable_warning__459__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__make_hlds_warn__IntroducedFrom__func__generate_variable_warning__459__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r1;
...
void mercury__hlds__make_hlds__make_hlds_warn__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__make_hlds__make_hlds_warn);
