  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsId_10 = ((MR_Word) ((MR_hl_field(0, BoundInst_8, (MR_Integer) 0))));
      MR_Word ArgInsts_11 = ((MR_Word) ((MR_hl_field(0, BoundInst_8, (MR_Integer) 1))));
      MR_Word ArgTypes_12;
      MR_Integer Var_13;
      MR_Word next_value_of_HeadVar__3_3;

      Var_13 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ArgInsts_11);
      check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(ModuleInfo_1, Type_2, ConsId_10, Var_13, &ArgTypes_12);
      succeeded = check_hlds__inst_test__inst_list_is_ground_mt_3_p_0(ModuleInfo_1, ArgTypes_12, ArgInsts_11);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word * STATE_VARIABLE_Expansions_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ArgInsts_14 = ((MR_Word) ((MR_hl_field(0, BoundInst_10, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Expansions_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_21 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ArgInsts_17);
      check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(ModuleInfo_1, Type_2, ConsId_16, Var_21, &ArgTypes_18);
      succeeded = check_hlds__inst_test__inst_list_is_ground_mt_2_5_p_0(ModuleInfo_1, ArgTypes_18, ArgInsts_17, STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_22_22);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
