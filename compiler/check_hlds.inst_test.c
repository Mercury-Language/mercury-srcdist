  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__maybe_get_cons_id_arg_types_5_p_0(ModuleInfo_3, MaybeType_2, Name_10, Var_13, &MaybeTypes_12);
  ...
  MR_Word * STATE_VARIABLE_Expansions_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__maybe_get_cons_id_arg_types_5_p_0(ModuleInfo_3, MaybeType_2, Name_16, Var_21, &MaybeTypes_18);
