              ...
              case (MR_Integer) 2:
                {
                  ...
                  succeeded = check_hlds__inst_test__inst_results_bound_functor_list_is_ground_mt_2_6_p_0(ModuleInfo_1, Type_6, InstResults_37, BoundFunctors_38, STATE_VARIABLE_Expansions_15_15, &_Expansions_55);
                }
                break;
              case (MR_Integer) 3:
