  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Live_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      MR_Word Lives_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
      MR_Word Type_9;
      MR_Word Types_10;
      MR_Word Inst_11;
      MR_Word Insts_12;
      ...
      if (succeeded)
      {
        Type_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
        Types_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
        succeeded = (HeadVar__4_4 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Inst_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 0))));
          Insts_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 1))));
          switch (Live_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              succeeded = MR_TRUE;
              break;
            case (MR_Integer) 0:
              succeeded = check_hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo_1, Type_9, Inst_11);
              break;
          }
          if (succeeded)
          {
            ...
            next_value_of_HeadVar__3_3 = Types_10;
            next_value_of_HeadVar__4_4 = Insts_12;
            HeadVar__2_2 = next_value_of_HeadVar__2_2;
            HeadVar__3_3 = next_value_of_HeadVar__3_3;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Inst_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
        Insts_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
        succeeded = check_hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo_1, Type_6, Inst_8);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
...
MR_bool MR_CALL 
check_hlds__inst_test__inst_results_bound_inst_list_is_ground_4_p_0(
  MR_Word ModuleInfo_5,
  MR_Word Type_6,
  MR_Word InstResults_7,
  MR_Word BoundInsts_8)
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word BoundInsts_38 = ((MR_Word) ((MR_hl_field(2, Inst_8, (MR_Integer) 2))));
                  MR_Word _Expansions_55;

                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_1, Type_6, InstResults_37, BoundInsts_38, STATE_VARIABLE_Expansions_15_15, &_Expansions_55);
                }
                break;
              case (MR_Integer) 3:
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_1, InstName_41, &NextInst_42);
                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Type_6, NextInst_42, STATE_VARIABLE_Expansions_15_15, &_Expansions_59);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      MR_Word SubInst_40 = ((MR_Word) ((MR_hl_field(3, Inst_8, (MR_Integer) 2))));
                      MR_Word _Expansions_57;

                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Type_6, SubInst_40, STATE_VARIABLE_Expansions_15_15, &_Expansions_57);
                    }
                    break;
                  case (MR_Integer) 3:
                    {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word BoundInsts_51 = ((MR_Word) ((MR_hl_field(2, Inst_6, (MR_Integer) 2))));
                  MR_Word _Expansions_68;

                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_4, Type_5, InstResults_50, BoundInsts_51, STATE_VARIABLE_Expansions_15_28, &_Expansions_68);
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, Inst_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_6, Type_7, InstResults_37, BoundInsts_38, STATE_VARIABLE_Expansions_15_15, STATE_VARIABLE_Expansions_13);
            }
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, Inst_8, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word BoundInsts_62 = ((MR_Word) ((MR_hl_field(2, Inst_29, (MR_Integer) 2))));

                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_1, Var_36, InstResults_61, BoundInsts_62, STATE_VARIABLE_Expansions_15_39, &STATE_VARIABLE_Expansions_34_34);
                }
                break;
              case (MR_Integer) 3:
