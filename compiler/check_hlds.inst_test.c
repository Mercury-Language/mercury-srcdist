          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_7, (MR_Integer) 1)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_25, (MR_Integer) 0)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstResults_4)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word GroundnessResult_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_4, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_4, (MR_Integer) 0)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstResults_5)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word GroundnessResult_9 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_5, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
    ...
    switch (MR_tag((MR_Word) Inst_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Inst_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_4, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_4, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) InstResults_13)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word GroundnessResult_38 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_13, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_13, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 0)));
      ...
      else
      {
        ...
        MR_Word NextInst_50;
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word NextInst_78;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 0)));
  ...
  MR_Word * STATE_VARIABLE_Expansions_13)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0)));
      ...
      else
      {
        ...
        MR_Word NextInst_46;
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word NextInst_74;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0)));
              MR_Word next_value_of_Inst_8;
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstResults_7)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word GroundnessResult_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_7, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_7, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              InstResult_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), InstResult_14, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 2) << (MR_Integer) 2)) | (MR_Unsigned) ((MR_Integer) 2)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCtorCat_31, (MR_Integer) 1)));
