  ...
  MR_Word Var_6)
{
  ...
  Var_11 = check_hlds__inst_test__inst_contains_any_2_3_f_0(ModuleInfo_4, Inst_7, Expansions_10);
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_4_p_0(ModuleInfo_1, Inst_8, Expansions0_12, &_Expansions_13);
            }
            break;
        }
        if (succeeded)
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_test__inst_is_not_fully_unique_2_4_p_0(ModuleInfo_1, Inst_5, Expansions0_9, &_Expansions_10);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), &Expansions0_9);
      succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_4_p_0(ModuleInfo_1, Inst_5, Expansions0_9, &_Expansions_10);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), &Expansions0_9);
      succeeded = check_hlds__inst_test__inst_is_mostly_unique_2_4_p_0(ModuleInfo_1, Inst_5, Expansions0_9, &_Expansions_10);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), &Expansions0_9);
      succeeded = check_hlds__inst_test__inst_is_unique_2_4_p_0(ModuleInfo_1, Inst_5, Expansions0_9, &_Expansions_10);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), &Expansions0_9);
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_4_p_0(ModuleInfo_1, Inst_5, Expansions0_9, &_Expansions_10);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Inst_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
        Insts_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
        succeeded = check_hlds__inst_test__inst_is_ground_mt_3_p_0(ModuleInfo_1, Type_6, Inst_8);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) InstResults_13)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word GroundnessResult_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_13, (MR_Integer) 0))) >> 2)) & (MR_Integer) 3);

                    switch (GroundnessResult_37) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 2:
    ...
    case (MR_Integer) 0:
      {
        ...
        succeeded = check_hlds__inst_test__inst_is_ground_mt_3_p_0(ModuleInfo_3, Var_17, Inst_4);
        if (succeeded)
        {
{
#define MR_PROC_LABEL check_hlds__inst_test__inst_is_ground_2_p_0
  ...
  MR_Word Inst_6)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word Uniq_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 0))) & (MR_Integer) 7);
      MR_Word HOInstInfo_39 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 1))));
      MR_Word NextInst_49;
      MR_Word _Expansions_78;

      succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, Type_5, Uniq_38, HOInstInfo_39, &NextInst_49);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_49, Expansions0_7, &_Expansions_78);
    }
  }
  else
  {
    ...
    if (succeeded)
      switch (MR_tag((MR_Word) Inst_6)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Uniq_66 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 0))) & (MR_Integer) 7);
            MR_Word HOInstInfo_67 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_6, (MR_Integer) 1))));
            MR_Word NextInst_77;
            MR_Word _Expansions_89;

            succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, Type_5, Uniq_66, HOInstInfo_67, &NextInst_77);
            if (succeeded)
              succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_77, STATE_VARIABLE_Expansions_15_19, &_Expansions_89);
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word InstResults_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 2))));
                MR_Word BoundInsts_61 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 3))));
                MR_Word _Expansions_91;

                succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_4, Type_5, InstResults_60, BoundInsts_61, STATE_VARIABLE_Expansions_15_19, &_Expansions_91);
              }
              break;
            case (MR_Integer) 1:
              succeeded = MR_TRUE;
            ...
            case (MR_Integer) 3:
              {
                MR_Word SubInst_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 2))));
                MR_Word _Expansions_93;

                succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, SubInst_63, STATE_VARIABLE_Expansions_15_19, &_Expansions_93);
              }
              break;
            case (MR_Integer) 4:
              {
                MR_Word InstName_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 1))));
                MR_Word NextInst_65;
                MR_Word _Expansions_95;

                check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_4, InstName_64, &NextInst_65);
                succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_65, STATE_VARIABLE_Expansions_15_19, &_Expansions_95);
              }
              break;
          }
          break;
  ...
  MR_Word * STATE_VARIABLE_Expansions_13)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Uniq_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Word HOInstInfo_35 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 1))));
        MR_Word NextInst_45;
        MR_Word next_value_of_Inst_8;

        succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_34, HOInstInfo_35, &NextInst_45);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
    ...
    else
    {
      ...
      if (succeeded)
        switch (MR_tag((MR_Word) Inst_8)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Uniq_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0))) & (MR_Integer) 7);
              MR_Word HOInstInfo_63 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 1))));
              MR_Word NextInst_73;
              MR_Word next_value_of_Inst_8;
              MR_Word next_value_of_STATE_VARIABLE_Expansions_0_12;

              succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_62, HOInstInfo_63, &NextInst_73);
              if (succeeded)
              {
                // direct tailcall eliminated
                ;
                next_value_of_Inst_8 = NextInst_73;
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word InstResults_56 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 2))));
                  MR_Word BoundInsts_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 3))));

                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_6, Type_7, InstResults_56, BoundInsts_57, STATE_VARIABLE_Expansions_15_15, STATE_VARIABLE_Expansions_13);
                }
                break;
              case (MR_Integer) 1:
                {
              ...
              case (MR_Integer) 3:
                {
                  MR_Word SubInst_59 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 2))));
                  MR_Word next_value_of_Inst_8 = SubInst_59;
              ...
              case (MR_Integer) 4:
                {
                  MR_Word InstName_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1))));
                  MR_Word NextInst_61;
                  MR_Word next_value_of_Inst_8;
                  MR_Word next_value_of_STATE_VARIABLE_Expansions_0_12;

                  check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_6, InstName_60, &NextInst_61);
                  // direct tailcall eliminated
                  ;
                  next_value_of_Inst_8 = NextInst_61;
                  next_value_of_STATE_VARIABLE_Expansions_0_12 = STATE_VARIABLE_Expansions_15_15;
                  Inst_8 = next_value_of_Inst_8;
                  STATE_VARIABLE_Expansions_0_12 = next_value_of_STATE_VARIABLE_Expansions_0_12;
                  continue;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_36, Inst_29, STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_34_34);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        TypeCtorCat_31 = check_hlds__type_util__classify_type_2_f_0(ModuleInfo_6, Type_7);
