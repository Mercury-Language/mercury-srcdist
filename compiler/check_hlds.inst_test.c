  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Inst_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
        Insts_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
        TypeCtorInfo__9_12 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0);
        Expansions0_10 = mercury__set_tree234__init_0_f_0(TypeCtorInfo__9_12);
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) InstResults_13)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word GroundnessResult_32 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_13, (MR_Integer) 0))) >> 2)) & (MR_Integer) 3);

                    switch (GroundnessResult_32) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 2:
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_3, Var_13, Uniq_40, HOInstInfo_41, &NextInst_47);
            if (succeeded)
              succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_3, Var_13, NextInst_47, Expansions0_22, &_Expansions_66);
          }
        }
        else
        {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_3, Var_13, Uniq_58, HOInstInfo_59, &NextInst_65);
                  if (succeeded)
                    succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_3, Var_13, NextInst_65, STATE_VARIABLE_Expansions_15_27, &_Expansions_77);
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_4, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_3, Var_13, InstResults_52, BoundInsts_53, STATE_VARIABLE_Expansions_15_27, &_Expansions_79);
                    }
                    break;
                  case (MR_Integer) 1:
                    succeeded = MR_TRUE;
                  ...
                  case (MR_Integer) 3:
                    {
                      ...
                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_3, Var_13, SubInst_55, STATE_VARIABLE_Expansions_15_27, &_Expansions_81);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      ...
                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_3, Var_13, NextInst_57, STATE_VARIABLE_Expansions_15_27, &_Expansions_83);
                    }
                    break;
                }
                break;
  ...
  MR_Word * STATE_VARIABLE_Expansions_13)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Uniq_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Word HOInstInfo_30 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 1))));
        MR_Word NextInst_36;
        MR_Word next_value_of_Inst_8;

        succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_29, HOInstInfo_30, &NextInst_36);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          next_value_of_Inst_8 = NextInst_36;
    ...
    else
    {
      ...
      if (succeeded)
        switch (MR_tag((MR_Word) Inst_8)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Uniq_47 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0))) & (MR_Integer) 7);
              MR_Word HOInstInfo_48 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 1))));
              MR_Word NextInst_54;
              MR_Word next_value_of_Inst_8;
              MR_Word next_value_of_STATE_VARIABLE_Expansions_0_12;

              succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_47, HOInstInfo_48, &NextInst_54);
              if (succeeded)
              {
                // direct tailcall eliminated
                ;
                next_value_of_Inst_8 = NextInst_54;
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word InstResults_41 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 2))));
                  MR_Word BoundInsts_42 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 3))));

                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_6, Type_7, InstResults_41, BoundInsts_42, STATE_VARIABLE_Expansions_15_15, STATE_VARIABLE_Expansions_13);
                }
                break;
              case (MR_Integer) 1:
                {
              ...
              case (MR_Integer) 3:
                {
                  MR_Word SubInst_44 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 2))));
                  MR_Word next_value_of_Inst_8 = SubInst_44;
              ...
              case (MR_Integer) 4:
                {
                  MR_Word InstName_45 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1))));
                  MR_Word NextInst_46;
                  MR_Word next_value_of_Inst_8;
                  MR_Word next_value_of_STATE_VARIABLE_Expansions_0_12;

                  check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_6, InstName_45, &NextInst_46);
                  // direct tailcall eliminated
                  ;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word Uniq_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_29, (MR_Integer) 0))) & (MR_Integer) 7);
            MR_Word HOInstInfo_54 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_29, (MR_Integer) 1))));
            MR_Word NextInst_60;

            succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_1, Var_37, Uniq_53, HOInstInfo_54, &NextInst_60);
            if (succeeded)
              succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_37, NextInst_60, STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_34_34);
          }
        }
        else
        {
          MR_Word STATE_VARIABLE_Expansions_15_40;

          succeeded = mercury__set_tree234__insert_new_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Inst_29)), STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_15_40);
          if (succeeded)
            switch (MR_tag((MR_Word) Inst_29)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(Inst_29)) {
                  ...
                  case (MR_Integer) 1:
                    {
                      STATE_VARIABLE_Expansions_34_34 = STATE_VARIABLE_Expansions_15_40;
                      succeeded = MR_TRUE;
                    }
                    break;
                }
              ...
              case (MR_Integer) 2:
                {
                  MR_Word Uniq_71 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_29, (MR_Integer) 0))) & (MR_Integer) 7);
                  MR_Word HOInstInfo_72 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Inst_29, (MR_Integer) 1))));
                  MR_Word NextInst_78;

                  succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_1, Var_37, Uniq_71, HOInstInfo_72, &NextInst_78);
                  if (succeeded)
                    succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_37, NextInst_78, STATE_VARIABLE_Expansions_15_40, &STATE_VARIABLE_Expansions_34_34);
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_29, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word InstResults_65 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_29, (MR_Integer) 2))));
                      MR_Word BoundInsts_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_29, (MR_Integer) 3))));

                      succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_1, Var_37, InstResults_65, BoundInsts_66, STATE_VARIABLE_Expansions_15_40, &STATE_VARIABLE_Expansions_34_34);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                  ...
                  case (MR_Integer) 3:
                    {
                      MR_Word SubInst_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_29, (MR_Integer) 2))));

                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_37, SubInst_68, STATE_VARIABLE_Expansions_15_40, &STATE_VARIABLE_Expansions_34_34);
                    }
                    break;
                  case (MR_Integer) 4:
                    {
                      MR_Word InstName_69 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst_29, (MR_Integer) 1))));
                      MR_Word NextInst_70;

                      check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_1, InstName_69, &NextInst_70);
                      succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_37, NextInst_70, STATE_VARIABLE_Expansions_15_40, &STATE_VARIABLE_Expansions_34_34);
                    }
                    break;
                }
                break;
        ...
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__2_2 = Var_36;
