    ...
    switch (MR_tag((MR_Word) InstResults_7)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(InstResults_7)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_test__bound_inst_list_is_ground_mt_3_p_0(ModuleInfo_5, MaybeType_6, BoundInsts_8);
            break;
          case (MR_Integer) 1:
            succeeded = MR_TRUE;
            break;
    ...
    switch (MR_tag((MR_Word) InstResults_5)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(InstResults_5)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_test__bound_inst_list_is_ground_mt_3_p_0(ModuleInfo_4, (MR_Word) ((MR_Unsigned) 0U), BoundInsts_6);
            break;
          case (MR_Integer) 1:
            succeeded = MR_TRUE;
            break;
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__maybe_get_cons_id_arg_types_5_p_0(ModuleInfo_1, MaybeType_2, Name_10, Var_13, &MaybeTypes_12);
      succeeded = check_hlds__inst_test__inst_list_is_ground_mt_3_p_0(ModuleInfo_1, MaybeTypes_12, Args_11);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word MaybeType_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word MaybeTypes_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
      MR_Word Inst_8;
      MR_Word Insts_9;
      MR_Word next_value_of_HeadVar__2_2;
      MR_Word next_value_of_HeadVar__3_3;
      ...
      if (succeeded)
      {
        Inst_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
        Insts_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
        succeeded = check_hlds__inst_test__inst_is_ground_mt_3_p_0(ModuleInfo_1, MaybeType_6, Inst_8);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__2_2 = MaybeTypes_7;
          next_value_of_HeadVar__3_3 = Insts_9;
          HeadVar__2_2 = next_value_of_HeadVar__2_2;
          HeadVar__3_3 = next_value_of_HeadVar__3_3;
          continue;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, MaybeType_5, Uniq_39, HOInstInfo_40, &NextInst_50);
        if (succeeded)
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, MaybeType_5, Uniq_67, HOInstInfo_68, &NextInst_78);
              if (succeeded)
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_4, MaybeType_5, InstResults_61, BoundInsts_62, STATE_VARIABLE_Expansions_15_19, &_Expansions_92);
                }
                break;
              case (MR_Integer) 1:
                succeeded = MR_TRUE;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, MaybeType_7, Uniq_35, HOInstInfo_36, &NextInst_46);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, MaybeType_7, Uniq_63, HOInstInfo_64, &NextInst_74);
              if (succeeded)
              {
                // direct tailcall eliminated
                ;
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_6, MaybeType_7, InstResults_57, BoundInsts_58, STATE_VARIABLE_Expansions_15_15, STATE_VARIABLE_Expansions_13);
                }
                break;
              case (MR_Integer) 1:
                {
    ...
    switch (MR_tag((MR_Word) InstResults_9)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(InstResults_9)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_test__bound_inst_list_is_ground_mt_2_5_p_0(ModuleInfo_7, MaybeType_8, BoundInsts_10, STATE_VARIABLE_Expansions_0_18, STATE_VARIABLE_Expansions_19);
            break;
          case (MR_Integer) 1:
            {
  ...
  MR_Word * STATE_VARIABLE_Expansions_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__maybe_get_cons_id_arg_types_5_p_0(ModuleInfo_1, MaybeType_2, Name_16, Var_21, &MaybeTypes_18);
      succeeded = check_hlds__inst_test__inst_list_is_ground_mt_2_5_p_0(ModuleInfo_1, MaybeTypes_18, Args_17, STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_22_22);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Type_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
