  ...
  MR_Word Inst_6)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, Type_5, Uniq_39, HOInstInfo_40, &NextInst_50);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_50, Expansions0_7, &_Expansions_79);
    }
  }
  else
  {
        ...
        case (MR_Integer) 2:
          {
            ...
            succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_4, Type_5, Uniq_67, HOInstInfo_68, &NextInst_78);
            if (succeeded)
              succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_78, STATE_VARIABLE_Expansions_15_19, &_Expansions_90);
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_6, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_4, Type_5, InstResults_61, BoundInsts_62, STATE_VARIABLE_Expansions_15_19, &_Expansions_92);
              }
              break;
            case (MR_Integer) 1:
              succeeded = MR_TRUE;
            ...
            case (MR_Integer) 3:
              {
                ...
                succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, SubInst_64, STATE_VARIABLE_Expansions_15_19, &_Expansions_94);
              }
              break;
            case (MR_Integer) 4:
              {
                ...
                check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_4, InstName_65, &NextInst_66);
                succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_4, Type_5, NextInst_66, STATE_VARIABLE_Expansions_15_19, &_Expansions_96);
              }
              break;
          }
          break;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_35, HOInstInfo_36, &NextInst_46);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = check_hlds__inst_test__maybe_any_to_bound_5_p_0(ModuleInfo_6, Type_7, Uniq_63, HOInstInfo_64, &NextInst_74);
              if (succeeded)
              {
                // direct tailcall eliminated
                ;
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_mt_2_6_p_0(ModuleInfo_6, Type_7, InstResults_57, BoundInsts_58, STATE_VARIABLE_Expansions_15_15, STATE_VARIABLE_Expansions_13);
                }
                break;
              case (MR_Integer) 1:
                {
              ...
              case (MR_Integer) 4:
                {
                  ...
                  check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_6, InstName_61, &NextInst_62);
                  // direct tailcall eliminated
                  ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_test__inst_is_ground_mt_1_5_p_0(ModuleInfo_1, Var_37, Inst_29, STATE_VARIABLE_Expansions_0_4, &STATE_VARIABLE_Expansions_34_34);
        if (succeeded)
        {
          // direct tailcall eliminated
          ;
