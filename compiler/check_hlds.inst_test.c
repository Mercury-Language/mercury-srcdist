  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__get_cons_id_arg_types_for_bound_inst_4_p_0(ModuleInfo_1, Type_2, BoundInst_8, &ArgTypes_10);
      ArgInsts_12 = ((MR_Word) ((MR_hl_field(0, BoundInst_8, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Expansions_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__inst_util__get_cons_id_arg_types_for_bound_inst_4_p_0(ModuleInfo_1, Type_2, BoundInst_13, &ArgTypes_16);
      ArgInsts_18 = ((MR_Word) ((MR_hl_field(0, BoundInst_13, (MR_Integer) 1))));
