...
top_level__mercury_compile_make_hlds__make_hlds_pass_21_p_0(
  ...
  MR_Word STATE_VARIABLE_DumpInfo_0_85,
  MR_Word * STATE_VARIABLE_DumpInfo_86,
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_90)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 666, &InvokedByMMCMake_41);
  ParseTreeModuleSrc_43 = ((MR_Word) ((MR_hl_field(0, AugCompUnit0_28, (MR_Integer) 0))));
  top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0(Globals_24, ParseTreeModuleSrc_43, STATE_VARIABLE_Specs_0_87, &STATE_VARIABLE_Specs_96_96);
  ...
  else
  {
    ...
    switch (WriteDFile_42) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        top_level__mercury_compile_make_hlds__maybe_read_d_file_for_trans_opt_deps_7_p_0(ProgressStream_22, ErrorStream_23, Globals_24, ModuleName_44, &MaybeDFileTransOptDeps_45);
        break;
    }
  }
  ...
  *MaybeTimestampMap_31 = ((MR_Word) ((MR_hl_field(0, Baggage1_47, (MR_Integer) 4))));
  Var_189 = ((MR_Word) ((MR_hl_field(0, Baggage1_47, (MR_Integer) 6))));
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_24, (MR_Integer) 227, &EventSetFileName_49);
  ...
  else
  {
    ...
    STATE_VARIABLE_Specs_105_105 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), EventSetSpecs_55, STATE_VARIABLE_Specs_100_100);
  ...
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_23, Verbose_40, Globals_24, STATE_VARIABLE_Specs_105_105, &STATE_VARIABLE_Specs_106_106);
  ...
  STATE_VARIABLE_Specs_112_112 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), QualifySpecs_63, STATE_VARIABLE_Specs_106_106);
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_23, Verbose_40, Globals_24, STATE_VARIABLE_Specs_112_112, &STATE_VARIABLE_Specs_113_113);
  ...
  STATE_VARIABLE_Specs_121_121 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ExpandSpecs_70, STATE_VARIABLE_Specs_113_113);
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_23, Verbose_40, Globals_24, STATE_VARIABLE_Specs_121_121, &STATE_VARIABLE_Specs_122_122);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_22, Verbose_40, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_22, Stats_39);
  ...
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_22, *HLDS0_29, (MR_Integer) 1, (MR_String) "initial", STATE_VARIABLE_DumpInfo_0_85, STATE_VARIABLE_DumpInfo_86);
  switch (WriteDFile_42) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        MR_Word BurdenedAugCompUnit0_77;
        MR_Word AllDeps_78;
        MR_Word MaybeInclTransOptRule_82;
        MR_Word OutputMMCMakeDeps_83;

        {
          BurdenedAugCompUnit0_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, BurdenedAugCompUnit0_77, 0) = ((MR_Box) (Baggage0_27));
          MR_hl_field(0, BurdenedAugCompUnit0_77, 1) = ((MR_Box) (AugCompUnit0_28));
        }
        hlds__hlds_module__module_info_get_all_deps_2_p_0(*HLDS0_29, &AllDeps_78);
        if ((MaybeDFileTransOptDeps_45 == (MR_Word) ((MR_Unsigned) 0U)))
          MaybeInclTransOptRule_82 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word DFileTransOptDepsList_79 = ((MR_Word) ((MR_hl_field(1, MaybeDFileTransOptDeps_45, (MR_Integer) 0))));
          MR_Word DFileTransOptDeps_80;
          MR_Word TransOptRuleInfo_81;

          mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), DFileTransOptDepsList_79, &DFileTransOptDeps_80);
          {
            TransOptRuleInfo_81 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, TransOptRuleInfo_81, 0) = ((MR_Box) (DFileTransOptDeps_80));
          }
          {
            MaybeInclTransOptRule_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeInclTransOptRule_82, 0) = ((MR_Box) (TransOptRuleInfo_81));
          }
        }
        parse_tree__write_deps_file__write_dependency_file_7_p_0(Globals_24, BurdenedAugCompUnit0_77, (MR_Word) ((MR_Unsigned) 0U), AllDeps_78, MaybeInclTransOptRule_82);
        libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 154, &OutputMMCMakeDeps_83);
        switch (OutputMMCMakeDeps_83) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
            }
          ...
          case (MR_Integer) 1:
            {
              MR_Word BurdenedModule0_84;

              {
                BurdenedModule0_84 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, BurdenedModule0_84, 0) = ((MR_Box) (Baggage0_27));
                MR_hl_field(0, BurdenedModule0_84, 1) = ((MR_Box) (ParseTreeModuleSrc_43));
              }
              make__module_dep_file__write_module_dep_file_4_p_0(Globals_24, BurdenedModule0_84);
            }
            break;
        }
      }
