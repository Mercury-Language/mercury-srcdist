...
struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0_s {
  MR_Word * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LambdaHeadVar__1_59;
  MR_Cont top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont;
  void * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont_env_ptr;
  MR_String top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LibModuleNameStr_18;
};
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__294__1_2_p_0(
  MR_Word ModuleName_9,
  MR_Word LambdaHeadVar__1_60);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_1(
  void * env_ptr_arg);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0(
...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_1[61][2];
...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_1[61][2] = {
  ...
  /* row  54 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[53]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[1])))
  },
  /* row  55 */
  {
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_1(
  void * env_ptr_arg)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0_s * env_ptr = (struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0_s *) (env_ptr_arg);

  *((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LambdaHeadVar__1_59) = mdbcomp__sym_name__string_to_sym_name_1_f_0((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LibModuleNameStr_18);
  ((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont)((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont_env_ptr);
}
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0(
  ...
  void * cont_env_ptr)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0_s env;

  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LambdaHeadVar__1_59 = LambdaHeadVar__1_59;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont = cont;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    MR_Word _DocUndoc_19;

    mercury__library__stdlib_module_doc_undoc_2_p_1(&(env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_env_0__LibModuleNameStr_18, &_DocUndoc_19, top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__285__1_1_p_0_1, &env);
  }
}
...
top_level__mercury_compile_make_hlds__make_hlds_pass_22_p_0(
  ...
  MR_Word Globals_25,
  MR_Word OpModeAugment_26,
  MR_Word InvokedByMMCMake_27,
  MR_Word WriteDFile0_28,
  MR_Word Baggage0_29,
  MR_Word AugCompUnit0_30,
  MR_Word * HLDS0_31,
  MR_Word * QualInfo_32,
  ...
  MR_Word STATE_VARIABLE_DumpInfo_0_86,
  MR_Word * STATE_VARIABLE_DumpInfo_87,
  MR_Word STATE_VARIABLE_Specs_0_88,
  MR_Word * STATE_VARIABLE_Specs_89,
  MR_Word STATE_VARIABLE_HaveReadModuleMaps_0_90,
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_91)
{
  MR_bool succeeded;
  MR_Word Stats_41;
  MR_Word Verbose_42;
  ...
  MR_Word MaybeDFileTransOptDeps_46;
  MR_Word IntermodError_47;
  MR_Word Baggage1_48;
  MR_Word AugCompUnit1_49;
  MR_String EventSetFileName_50;
  MR_String EventSetName_51;
  MR_Word EventSpecMap1_52;
  MR_Word EventSetErrors_53;
  MR_Word AugCompUnit2_57;
  MR_Word EventSpecMap2_58;
  MR_Word MQInfo0_59;
  MR_Word MQUndefTypes_60;
  MR_Word MQUndefInsts_61;
  MR_Word MQUndefModes_62;
  MR_Word MQUndefTypeClasses_63;
  MR_Word QualifySpecs_64;
  MR_Word RecompInfo0_65;
  MR_Word AugCompUnit_66;
  MR_Word EventSpecMap_67;
  MR_Word TypeEqvMap_68;
  MR_Word UsedModules_69;
  MR_Word RecompInfo_70;
  MR_Word ExpandSpecs_71;
  MR_Word ExpandErrors_72;
  MR_Word MQInfo_73;
  MR_Word EventSet_74;
  MR_Word MakeHLDSFoundInvalidType_75;
  MR_Word MakeHLDSFoundInvalidInstOrMode_76;
  MR_Word FoundSemanticError_77;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 82, &Stats_41);
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 72, &Verbose_42);
  ParseTreeModuleSrc_44 = ((MR_Word) ((MR_hl_field(0, AugCompUnit0_30, (MR_Integer) 0))));
  top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0(Globals_25, ParseTreeModuleSrc_44, STATE_VARIABLE_Specs_0_88, &STATE_VARIABLE_Specs_96_96);
  ModuleName_45 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_44, (MR_Integer) 0))));
  succeeded = (InvokedByMMCMake_27 == (MR_Integer) 1);
  if (!(succeeded))
    succeeded = (OpModeAugment_26 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    WriteDFile_43 = (MR_Integer) 0;
    MaybeDFileTransOptDeps_46 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    WriteDFile_43 = WriteDFile0_28;
    switch (WriteDFile_43) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        top_level__mercury_compile_make_hlds__maybe_read_d_file_for_trans_opt_deps_7_p_0(ProgressStream_23, ErrorStream_24, Globals_25, ModuleName_45, &MaybeDFileTransOptDeps_46);
        break;
    }
  }
  top_level__mercury_compile_make_hlds__maybe_grab_plain_and_trans_opt_files_15_p_0(ProgressStream_23, ErrorStream_24, Globals_25, OpModeAugment_26, Verbose_42, MaybeDFileTransOptDeps_46, &IntermodError_47, Baggage0_29, &Baggage1_48, AugCompUnit0_30, &AugCompUnit1_49, STATE_VARIABLE_HaveReadModuleMaps_0_90, STATE_VARIABLE_HaveReadModuleMaps_91);
  *MaybeTimestampMap_33 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 4))));
  Var_187 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 6))));
  Var_101 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_187);
  STATE_VARIABLE_Specs_100_100 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_101, STATE_VARIABLE_Specs_96_96);
  libs__globals__lookup_string_option_3_p_0(Globals_25, (MR_Integer) 229, &EventSetFileName_50);
  succeeded = (strcmp(EventSetFileName_50, (MR_String) "") == 0);
  if (succeeded)
  {
    EventSetName_51 = (MR_String) "";
    EventSpecMap1_52 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0));
    EventSetErrors_53 = (MR_Integer) 0;
    STATE_VARIABLE_Specs_105_105 = STATE_VARIABLE_Specs_100_100;
  }
  else
  {
    MR_String EventSetName0_54;
    MR_Word EventSpecMap0_55;
    MR_Word EventSetSpecs_56;

    parse_tree__prog_event__read_event_set_6_p_0(EventSetFileName_50, &EventSetName0_54, &EventSpecMap0_55, &EventSetSpecs_56);
    STATE_VARIABLE_Specs_105_105 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), EventSetSpecs_56, STATE_VARIABLE_Specs_100_100);
    EventSetErrors_53 = parse_tree__error_util__contains_errors_2_f_0(Globals_25, EventSetSpecs_56);
    switch (EventSetErrors_53) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          EventSetName_51 = EventSetName0_54;
          EventSpecMap1_52 = EventSpecMap0_55;
        }
        break;
      case (MR_Integer) 1:
        {
  ...
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_24, Verbose_42, Globals_25, STATE_VARIABLE_Specs_105_105, &STATE_VARIABLE_Specs_106_106);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_23, Verbose_42, (MR_String) "% Module qualifying items...\n");
  libs__file_util__maybe_flush_output_4_p_0(ProgressStream_23, Verbose_42);
  parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_25, AugCompUnit1_49, &AugCompUnit2_57, EventSpecMap1_52, &EventSpecMap2_58, EventSetFileName_50, &MQInfo0_59, &MQUndefTypes_60, &MQUndefInsts_61, &MQUndefModes_62, &MQUndefTypeClasses_63, (MR_Word) ((MR_Unsigned) 0U), &QualifySpecs_64);
  STATE_VARIABLE_Specs_112_112 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), QualifySpecs_64, STATE_VARIABLE_Specs_106_106);
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_24, Verbose_42, Globals_25, STATE_VARIABLE_Specs_112_112, &STATE_VARIABLE_Specs_113_113);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_23, Verbose_42, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_23, Stats_41);
  parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_59, &RecompInfo0_65);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_23, Verbose_42, (MR_String) "% Expanding equivalence types and insts...\n");
  libs__file_util__maybe_flush_output_4_p_0(ProgressStream_23, Verbose_42);
  parse_tree__equiv_type__expand_eqv_types_insts_9_p_0(AugCompUnit2_57, &AugCompUnit_66, EventSpecMap2_58, &EventSpecMap_67, &TypeEqvMap_68, &UsedModules_69, RecompInfo0_65, &RecompInfo_70, &ExpandSpecs_71);
  ExpandErrors_72 = parse_tree__error_util__contains_errors_2_f_0(Globals_25, ExpandSpecs_71);
  STATE_VARIABLE_Specs_121_121 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ExpandSpecs_71, STATE_VARIABLE_Specs_113_113);
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_24, Verbose_42, Globals_25, STATE_VARIABLE_Specs_121_121, &STATE_VARIABLE_Specs_122_122);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_23, Verbose_42, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_23, Stats_41);
  parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(RecompInfo_70, MQInfo0_59, &MQInfo_73);
  {
    EventSet_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, EventSet_74, 0) = ((MR_Box) (EventSetName_51));
    MR_hl_field(0, EventSet_74, 1) = ((MR_Box) (EventSpecMap_67));
  }
  top_level__mercury_compile_make_hlds__make_hlds_19_p_0(ProgressStream_23, ErrorStream_24, Globals_25, AugCompUnit_66, EventSet_74, MQInfo_73, TypeEqvMap_68, UsedModules_69, Verbose_42, Stats_41, HLDS0_31, QualInfo_32, &MakeHLDSFoundInvalidType_75, &MakeHLDSFoundInvalidInstOrMode_76, &FoundSemanticError_77, STATE_VARIABLE_Specs_122_122, STATE_VARIABLE_Specs_89);
  mercury__bool__or_3_p_0(FoundSemanticError_77, IntermodError_47, PreHLDSErrors_36);
  top_level__mercury_compile_make_hlds__maybe_write_definitions_7_p_0(ProgressStream_23, ErrorStream_24, Verbose_42, Stats_41, *HLDS0_31);
  top_level__mercury_compile_make_hlds__maybe_write_definition_line_counts_7_p_0(ProgressStream_23, ErrorStream_24, Verbose_42, Stats_41, *HLDS0_31);
  top_level__mercury_compile_make_hlds__maybe_write_definition_extents_7_p_0(ProgressStream_23, ErrorStream_24, Verbose_42, Stats_41, *HLDS0_31);
  succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), MQUndefTypes_60);
  if (succeeded)
  {
    TypeCtorInfo_200_200 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_200_200, MQUndefTypeClasses_63);
    if (succeeded)
    {
      succeeded = (EventSetErrors_53 == (MR_Integer) 0);
      if (succeeded)
      {
        succeeded = (ExpandErrors_72 == (MR_Integer) 0);
        if (succeeded)
          succeeded = (MakeHLDSFoundInvalidType_75 == (MR_Integer) 0);
      }
    }
  }
  if (succeeded)
    *UndefTypes_34 = (MR_Integer) 0;
  else
    *UndefTypes_34 = (MR_Integer) 1;
  succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), MQUndefInsts_61);
  if (succeeded)
  {
    TypeCtorInfo_202_202 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_202_202, MQUndefModes_62);
    if (succeeded)
      succeeded = (MakeHLDSFoundInvalidInstOrMode_76 == (MR_Integer) 0);
  }
  if (succeeded)
    *UndefModes_35 = (MR_Integer) 0;
  else
    *UndefModes_35 = (MR_Integer) 1;
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_23, *HLDS0_31, (MR_Integer) 1, (MR_String) "initial", STATE_VARIABLE_DumpInfo_0_86, STATE_VARIABLE_DumpInfo_87);
  switch (WriteDFile_43) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word AllDeps_79;
        MR_Word MaybeInclTransOptRule_83;
        MR_Word OutputMMCMakeDeps_84;

        {
          BurdenedAugCompUnit0_78 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, BurdenedAugCompUnit0_78, 0) = ((MR_Box) (Baggage0_29));
          MR_hl_field(0, BurdenedAugCompUnit0_78, 1) = ((MR_Box) (AugCompUnit0_30));
        }
        hlds__hlds_module__module_info_get_all_deps_2_p_0(*HLDS0_31, &AllDeps_79);
        if ((MaybeDFileTransOptDeps_46 == (MR_Word) ((MR_Unsigned) 0U)))
          MaybeInclTransOptRule_83 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word DFileTransOptDepsList_80 = ((MR_Word) ((MR_hl_field(1, MaybeDFileTransOptDeps_46, (MR_Integer) 0))));
          MR_Word DFileTransOptDeps_81;
          MR_Word TransOptRuleInfo_82;

          mercury__set__list_to_set_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), DFileTransOptDepsList_80, &DFileTransOptDeps_81);
          {
            TransOptRuleInfo_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, TransOptRuleInfo_82, 0) = ((MR_Box) (DFileTransOptDeps_81));
          }
          {
            MaybeInclTransOptRule_83 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeInclTransOptRule_83, 0) = ((MR_Box) (TransOptRuleInfo_82));
          }
        }
        parse_tree__write_deps_file__write_dependency_file_7_p_0(Globals_25, BurdenedAugCompUnit0_78, (MR_Word) ((MR_Unsigned) 0U), AllDeps_79, MaybeInclTransOptRule_83);
        libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 155, &OutputMMCMakeDeps_84);
        switch (OutputMMCMakeDeps_84) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
            }
          ...
          case (MR_Integer) 1:
            {
              MR_Word BurdenedModule0_85;

              {
                BurdenedModule0_85 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, BurdenedModule0_85, 0) = ((MR_Box) (Baggage0_29));
                MR_hl_field(0, BurdenedModule0_85, 1) = ((MR_Box) (ParseTreeModuleSrc_44));
              }
              make__module_dep_file__write_module_dep_file_4_p_0(Globals_25, BurdenedModule0_85);
            }
            break;
        }
      }
  ...
  MR_Word HLDS_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 184, &Extents_15);
  switch (Extents_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_extents\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[60])), ModuleName_16, &FileName_17);
        ...
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          ...
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definition extents: ", Var_37);
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 183, &LineCounts_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_line_counts\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[59])), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
          ...
          Var_37 = mercury__io__error_message_1_f_0(IOError_20);
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definition line counts: ", Var_37);
          libs__file_util__report_error_4_p_0(ErrorStream_9, ErrorMsg_21);
        }
        else
        {
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 182, &ShowDefns_15);
  switch (ShowDefns_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definitions\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[58])), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
          ...
          Var_37 = mercury__io__error_message_1_f_0(IOError_20);
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definitions: ", Var_37);
          libs__file_util__report_error_4_p_0(ErrorStream_9, ErrorMsg_21);
        }
        else
        {
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  MR_Word DumpDirs_39;
  MR_String DumpBaseFileName_40;
  MR_Word MakeSpecs_41;
  MR_Integer Status_42;
  MR_Word SpecsErrors_43;
  MR_Word STATE_VARIABLE_Specs_49_49;
  MR_Word STATE_VARIABLE_HLDS_57_57;
  MR_Word STATE_VARIABLE_Specs_58_58;

  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_21, Verbose_28, Globals_22, STATE_VARIABLE_Specs_0_45, &STATE_VARIABLE_Specs_49_49);
  ...
  parse_tree__file_names__module_name_to_file_name_return_dirs_6_p_0(Globals_22, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.make_hlds\'/19", (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_2[0]), ModuleName_38, &DumpDirs_39, &DumpBaseFileName_40);
  parse_tree__file_names__create_any_dirs_on_path_3_p_0(DumpDirs_39);
  hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_11_p_0(AugCompUnit_23, Globals_22, DumpBaseFileName_40, MQInfo_25, TypeEqvMap_26, UsedModules_27, QualInfo_31, FoundInvalidType_32, FoundInvalidInstOrMode_33, &STATE_VARIABLE_HLDS_57_57, &MakeSpecs_41);
  STATE_VARIABLE_Specs_58_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), MakeSpecs_41, STATE_VARIABLE_Specs_49_49);
  hlds__hlds_module__module_info_set_event_set_3_p_0(EventSet_24, STATE_VARIABLE_HLDS_57_57, STATE_VARIABLE_HLDS_44);
  mercury__io__get_exit_status_3_p_0(&Status_42);
  SpecsErrors_43 = parse_tree__error_util__contains_errors_2_f_0(Globals_22, STATE_VARIABLE_Specs_58_58);
  succeeded = (Status_42 != (MR_Integer) 0);
  if (!(succeeded))
    succeeded = (SpecsErrors_43 == (MR_Integer) 1);
  if (succeeded)
  {
  ...
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_21, Verbose_28, Globals_22, STATE_VARIABLE_Specs_58_58, STATE_VARIABLE_Specs_46);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 500, &IntermodOpt_27);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 502, &UseOptInt_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 504, &TransOpt_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 505, &IntermodAnalysis_30);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_76, 1) = ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[57])));
                  }
                  {
                    Var_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_73, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[52])));
                    MR_hl_field(1, Var_73, 1) = ((MR_Box) (Var_76));
                  }
                  {
                    Pieces_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Pieces_37, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[51])));
  ...
  MR_Word * MaybeDFileTransOptDeps_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 504, &TransOpt_14);
  switch (TransOpt_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[49])), ModuleName_11, &DependencyFileName_16);
        switch (Verbose_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        if (((MR_tag((MR_Word) DepFileOpenResult_17)) == (MR_Integer) 1))
        {
          ...
          Var_63 = mercury__string__f_43_43_2_f_0((MR_String) " for input: ", IOErrorMessage_24);
          Var_64 = mercury__string__f_43_43_2_f_0(DependencyFileName_16, Var_63);
          Message_25 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_64);
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[50])), ModuleName_11, &TransOptDateFileName_19);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__294__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
