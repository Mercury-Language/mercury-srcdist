...
static const MR_FA_TypeInfo_Struct1 top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0;
...
static const MR_PseudoTypeInfo top_level__mercury_compile_make_hlds__top_level__mercury_compile_make_hlds__field_types_make_hlds_result_0_0[5] = {
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_error_spec_0)
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_74)
{
  ...
  *MaybeTimestampMap_29 = ((MR_Word) ((MR_hl_field(0, Baggage1_42, 5))));
  ...
  mercury__map__values_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), UnusedImportsSpecsMap_53, &UnusedImportsSpecs_54);
