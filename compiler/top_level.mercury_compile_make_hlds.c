  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_92)
{
  ...
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_2_101;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_3_103;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_4_105;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_5_107;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_6_109;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_7_115;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_8_116;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_9_124;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_10_125;
  MR_Word Var_190;
  ...
  switch (MR_tag((MR_Word) OpModeAugment_25)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_203 = ((MR_Unsigned) ((MR_hl_field(1, OpModeAugment_25, 0))) & (MR_Integer) 3);
  ...
  top_level__mercury_compile_make_hlds__maybe_grab_plain_and_trans_opt_files_16_p_0(ProgressStream_22, Globals_24, OpModeAugment_25, Verbose_40, MaybeDFileTransOptDeps_45, &OptBlockingSpecs_46, Baggage0_27, &Baggage1_47, AugCompUnit0_28, &AugCompUnit1_48, STATE_VARIABLE_HaveReadModuleMaps_0_89, STATE_VARIABLE_HaveReadModuleMaps_90, STATE_VARIABLE_MaybeWrittenSpecs_1_97, &STATE_VARIABLE_MaybeWrittenSpecs_2_101);
  if ((OptBlockingSpecs_46 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    IntermodError_49 = (MR_Integer) 0;
    STATE_VARIABLE_MaybeWrittenSpecs_3_103 = STATE_VARIABLE_MaybeWrittenSpecs_2_101;
  }
  else
  {
    parse_tree__error_util__add_to_be_written_specs_3_p_0(OptBlockingSpecs_46, STATE_VARIABLE_MaybeWrittenSpecs_2_101, &STATE_VARIABLE_MaybeWrittenSpecs_3_103);
    IntermodError_49 = (MR_Integer) 1;
  }
  *MaybeTimestampMap_31 = ((MR_Word) ((MR_hl_field(0, Baggage1_47, 5))));
  Var_190 = ((MR_Word) ((MR_hl_field(0, Baggage1_47, 7))));
  BaggageSpecs_52 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_190);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(BaggageSpecs_52, STATE_VARIABLE_MaybeWrittenSpecs_3_103, &STATE_VARIABLE_MaybeWrittenSpecs_4_105);
  libs__globals__lookup_string_option_3_p_0(Globals_24, (MR_Integer) 280, &EventSetFileName_53);
  top_level__mercury_compile_make_hlds__maybe_read_event_set_9_p_0(Globals_24, EventSetFileName_53, &EventSetName_54, &EventSpecMap0_55, &EventSetErrors_56, STATE_VARIABLE_MaybeWrittenSpecs_4_105, &STATE_VARIABLE_MaybeWrittenSpecs_5_107);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_23, Globals_24, Verbose_40, STATE_VARIABLE_MaybeWrittenSpecs_5_107, &STATE_VARIABLE_MaybeWrittenSpecs_6_109);
  ...
  parse_tree__error_util__add_to_be_written_specs_3_p_0(QualifySpecs_65, STATE_VARIABLE_MaybeWrittenSpecs_6_109, &STATE_VARIABLE_MaybeWrittenSpecs_7_115);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_23, Globals_24, Verbose_40, STATE_VARIABLE_MaybeWrittenSpecs_7_115, &STATE_VARIABLE_MaybeWrittenSpecs_8_116);
  ...
  parse_tree__error_util__add_to_be_written_specs_3_p_0(ExpandSpecs_72, STATE_VARIABLE_MaybeWrittenSpecs_8_116, &STATE_VARIABLE_MaybeWrittenSpecs_9_124);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_23, Globals_24, Verbose_40, STATE_VARIABLE_MaybeWrittenSpecs_9_124, &STATE_VARIABLE_MaybeWrittenSpecs_10_125);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_22, Verbose_40, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_22, Stats_39);
  ...
  top_level__mercury_compile_make_hlds__make_hlds_20_p_0(ProgressStream_22, ErrorStream_23, Globals_24, AugCompUnit_67, EventSet_75, MQInfo_74, TypeEqvMap_69, UsedEqvModules_70, UnusedImports_60, Verbose_40, Stats_39, HLDS0_29, QualInfo_30, &MakeHLDSFoundInvalidType_76, &MakeHLDSFoundInvalidInstOrMode_77, &FoundSemanticError_78, STATE_VARIABLE_MaybeWrittenSpecs_10_125, STATE_VARIABLE_MaybeWrittenSpecs_92);
  ...
  if (succeeded)
  {
    TypeCtorInfo_199_199 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_199_199, MQUndefTypeClasses_64);
    if (succeeded)
    {
  ...
  if (succeeded)
  {
    TypeCtorInfo_201_201 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_201_201, MQUndefModes_63);
    if (succeeded)
