    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          top_level__mercury_compile_make_hlds__read_d_file_find_start_5_p_0(DFileInStream_19, SearchPattern_22, &FindResult_23);
            ...
            case (MR_Integer) 1:
              {
                ...
                top_level__mercury_compile_make_hlds__read_d_file_get_modules_4_p_0(DFileInStream_19, &TransOptDeps_24);
                {
                  MR_Word base;
