...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_2[5][1];
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_91)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 83, &Stats_41);
  libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 73, &Verbose_42);
  ...
  *MaybeTimestampMap_33 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 5))));
  Var_188 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 7))));
  Var_101 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_188);
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_25, (MR_Integer) 232, &EventSetFileName_50);
  ...
  if (succeeded)
  {
    TypeCtorInfo_202_202 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_202_202, MQUndefTypeClasses_63);
    if (succeeded)
    {
  ...
  if (succeeded)
  {
    TypeCtorInfo_204_204 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_204_204, MQUndefModes_62);
    if (succeeded)
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__write_deps_file__write_dependency_file_8_p_0(ProgressStream_23, Globals_25, BurdenedAugCompUnit0_78, (MR_Word) ((MR_Unsigned) 0U), AllDeps_79, MaybeInclTransOptRule_83);
        libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 157, &OutputMMCMakeDeps_84);
          ...
          case (MR_Integer) 1:
            {
              ...
              make__module_dep_file__write_module_dep_file_5_p_0(ProgressStream_23, Globals_25, BurdenedModule0_85);
            }
            break;
        }
      }
  ...
  MR_Word HLDS_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 186, &Extents_15);
  switch (Extents_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_extents\'/7", (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_2[4]), ModuleName_16, &FileName_17);
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 185, &LineCounts_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_line_counts\'/7", (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_2[3]), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 184, &ShowDefns_15);
  switch (ShowDefns_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definitions\'/7", (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_2[2]), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  parse_tree__file_names__module_name_to_file_name_return_dirs_6_p_0(Globals_22, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.make_hlds\'/19", (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_2[1]), ModuleName_38, &DumpDirs_39, &DumpBaseFileName_40);
  parse_tree__file_names__create_any_dirs_on_path_3_p_0(DumpDirs_39);
  hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_12_p_0(ProgressStream_20, AugCompUnit_23, Globals_22, DumpBaseFileName_40, MQInfo_25, TypeEqvMap_26, UsedModules_27, QualInfo_31, FoundInvalidType_32, FoundInvalidInstOrMode_33, &STATE_VARIABLE_HLDS_57_57, &MakeSpecs_41);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 503, &IntermodOpt_27);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 505, &UseOptInt_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 507, &TransOpt_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 508, &IntermodAnalysis_30);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(2, Spec_38, 2) = ((MR_Box) ((MR_Unsigned) 16U));
  ...
  MR_Word * MaybeDFileTransOptDeps_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 507, &TransOpt_14);
  switch (TransOpt_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 73, &Verbose_15);
        parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[0])), ModuleName_11, &DependencyFileName_16);
        switch (Verbose_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[49])), ModuleName_11, &TransOptDateFileName_19);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Context_123 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 1))));
            {
              ...
              MR_hl_field(1, Spec_124, 2) = ((MR_Box) ((MR_Unsigned) 16U));
