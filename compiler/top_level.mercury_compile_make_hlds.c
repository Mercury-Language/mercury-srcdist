  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  parse_tree__file_names__module_name_to_file_name_return_dirs_8_p_0(Globals_22, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.make_hlds\'/19", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[57])), ModuleName_38, &DumpDirs_39, &DumpBaseFileName_40);
  parse_tree__file_names__create_any_dirs_on_path_3_p_0(DumpDirs_39);
  hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_11_p_0(AugCompUnit_23, Globals_22, DumpBaseFileName_40, MQInfo_25, TypeEqvMap_26, UsedModules_27, QualInfo_31, FoundInvalidType_32, FoundInvalidInstOrMode_33, &STATE_VARIABLE_HLDS_58_58, &MakeSpecs_41);
  STATE_VARIABLE_Specs_59_59 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), MakeSpecs_41, STATE_VARIABLE_Specs_49_49);
  hlds__hlds_module__module_info_set_event_set_3_p_0(EventSet_24, STATE_VARIABLE_HLDS_58_58, STATE_VARIABLE_HLDS_44);
  mercury__io__get_exit_status_3_p_0(&Status_42);
  SpecsErrors_43 = parse_tree__error_util__contains_errors_2_f_0(Globals_22, STATE_VARIABLE_Specs_59_59);
  ...
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_21, Verbose_28, Globals_22, STATE_VARIABLE_Specs_59_59, STATE_VARIABLE_Specs_46);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[49])), ModuleName_11, &DependencyFileName_16);
        switch (Verbose_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        if (((MR_tag((MR_Word) DepFileOpenResult_17)) == (MR_Integer) 1))
        {
          ...
          Var_65 = mercury__string__f_43_43_2_f_0((MR_String) " for input: ", IOErrorMessage_24);
          Var_66 = mercury__string__f_43_43_2_f_0(DependencyFileName_16, Var_65);
          Message_25 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_66);
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(2, &top_level__mercury_compile_make_hlds_scalar_common_2[0])), ModuleName_11, &TransOptDateFileName_19);
