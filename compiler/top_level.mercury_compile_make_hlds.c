  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_82)
{
  ...
  *MaybeTimestampMap_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage1_43, (MR_Integer) 4))));
  ...
  Var_93 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_182);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) OpenResult_13)) == (MR_Integer) 1))
        {
          ...
          Var_66 = mercury__string__f_43_43_2_f_0((MR_String) " for input: ", IOErrorMessage_22);
          Var_67 = mercury__string__f_43_43_2_f_0(DependencyFileName_12, Var_66);
          Message_23 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_67);
  ...
  MR_Word * TransOptDeps_4)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo__25_25 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0);
    mercury__list__drop_while_3_p_0(TypeCtorInfo__25_25, Var_19, CharList0_7, &CharList1_8);
    Var_20 = (MR_Word) (&top_level__mercury_compile_make_hlds_scalar_common_4[2]);
    mercury__list__take_while_not_3_p_0(TypeCtorInfo__25_25, Var_20, CharList1_8, &CharList_9);
