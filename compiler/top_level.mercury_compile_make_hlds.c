  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_87)
{
  ...
  switch (MR_tag((MR_Word) OpModeAugment_25)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_198 = ((MR_Unsigned) ((MR_hl_field(1, OpModeAugment_25, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__301__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
