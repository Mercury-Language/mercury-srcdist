...
struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0_s {
  MR_Word * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LambdaHeadVar__1_59;
  MR_Cont top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont;
  void * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont_env_ptr;
  MR_String top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LibModuleNameStr_18;
};
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__293__1_2_p_0(
  MR_Word ModuleName_9,
  MR_Word LambdaHeadVar__1_60);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_1(
  void * env_ptr_arg);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0(
...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_1[62][2];
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_1(
  void * env_ptr_arg)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0_s * env_ptr = (struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0_s *) (env_ptr_arg);

  *((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LambdaHeadVar__1_59) = mdbcomp__sym_name__string_to_sym_name_1_f_0((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LibModuleNameStr_18);
  ((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont)((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont_env_ptr);
}
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0(
  ...
  void * cont_env_ptr)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0_s env;

  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LambdaHeadVar__1_59 = LambdaHeadVar__1_59;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont = cont;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    MR_Word _DocUndoc_19;

    mercury__library__stdlib_module_doc_undoc_2_p_1(&(env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_env_0__LibModuleNameStr_18, &_DocUndoc_19, top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0_1, &env);
  }
}
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_91)
{
  ...
  *MaybeTimestampMap_33 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 4))));
  Var_189 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 6))));
  Var_101 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_189);
  ...
  succeeded = (MQUndefTypes_60 == (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = (MQUndefTypeClasses_63 == (MR_Integer) 0);
    if (succeeded)
    {
  ...
  succeeded = (MQUndefInsts_61 == (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = (MQUndefModes_62 == (MR_Integer) 0);
    if (succeeded)
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_extents\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[5])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[61])), ModuleName_16, &FileName_17);
        ...
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          ...
          Var_41 = mercury__io__error_message_1_f_0(IOError_20);
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definition extents: ", Var_41);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definition_line_counts\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[4])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[60])), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
          ...
          Var_41 = mercury__io__error_message_1_f_0(IOError_20);
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definition line counts: ", Var_41);
          libs__file_util__report_error_4_p_0(ErrorStream_9, ErrorMsg_21);
        }
        else
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(HLDS_12, &ModuleName_16);
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_write_definitions\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[3])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[59])), ModuleName_16, &FileName_17);
        mercury__io__open_output_4_p_0(FileName_17, &Res_18);
        if (((MR_tag((MR_Word) Res_18)) == (MR_Integer) 1))
        {
          MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, Res_18, (MR_Integer) 0))));
          ...
          Var_41 = mercury__io__error_message_1_f_0(IOError_20);
          ErrorMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write definitions: ", Var_41);
          libs__file_util__report_error_4_p_0(ErrorStream_9, ErrorMsg_21);
        }
        else
        {
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_22, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.make_hlds\'/19", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[2])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[58])), ModuleName_38, &DumpBaseFileName_39);
  hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_11_p_0(AugCompUnit_23, Globals_22, DumpBaseFileName_39, MQInfo_25, TypeEqvMap_26, UsedModules_27, QualInfo_31, FoundInvalidType_32, FoundInvalidInstOrMode_33, &STATE_VARIABLE_HLDS_60_60, &MakeSpecs_40);
  STATE_VARIABLE_Specs_61_61 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), MakeSpecs_40, STATE_VARIABLE_Specs_48_48);
  hlds__hlds_module__module_info_set_event_set_3_p_0(EventSet_24, STATE_VARIABLE_HLDS_60_60, STATE_VARIABLE_HLDS_43);
  mercury__io__get_exit_status_3_p_0(&Status_41);
  SpecsErrors_42 = parse_tree__error_util__contains_errors_2_f_0(Globals_22, STATE_VARIABLE_Specs_61_61);
  ...
  parse_tree__write_error_spec__pre_hlds_maybe_write_out_errors_7_p_0(ErrorStream_21, Verbose_28, Globals_22, STATE_VARIABLE_Specs_61_61, STATE_VARIABLE_Specs_45);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[0])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[49])), ModuleName_11, &DependencyFileName_16);
        switch (Verbose_15) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        if (((MR_tag((MR_Word) DepFileOpenResult_17)) == (MR_Integer) 1))
        {
          ...
          Var_73 = mercury__string__f_43_43_2_f_0((MR_String) " for input: ", IOErrorMessage_24);
          Var_74 = mercury__string__f_43_43_2_f_0(DependencyFileName_16, Var_73);
          Message_25 = mercury__string__f_43_43_2_f_0((MR_String) "error opening file \140", Var_74);
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[1])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[50])), ModuleName_11, &TransOptDateFileName_19);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__293__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  void * cont_env_ptr)
{
  ...
  (env).top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__284__1_1_p_0(&(env).top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_2_env_0__conv0_LambdaHeadVar__1_59, top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_1, &env);
  }
}
