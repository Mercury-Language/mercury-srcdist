...
struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0_s {
  MR_Word * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LambdaHeadVar__1_62;
  MR_Cont top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont;
  void * top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont_env_ptr;
  MR_String top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LibModuleNameStr_19;
};
...
static const MR_FA_TypeInfo_Struct1 top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__251__1_2_p_0(
  MR_Word ModuleName_9,
  MR_Word LambdaHeadVar__1_63);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_1(
  void * env_ptr_arg);

static void MR_CALL 
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0(
...
static void MR_CALL 
top_level__mercury_compile_make_hlds__maybe_read_event_set_7_p_0(
  MR_Word Globals_8,
  MR_String EventSetFileName_9,
  MR_String * EventSetName_10,
  MR_Word * EventSpecMap_11,
  MR_Word * EventSetSpecs_12);
...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_1[58][2] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[3]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[2])))
  },
  /* row   5 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row   6 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[5]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[4])))
  },
  /* row   7 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  10 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[9]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[8])))
  },
  /* row  11 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  12 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[10])))
  },
  /* row  13 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  26 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[25]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[24])))
  },
  /* row  27 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  28 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[26])))
  },
  /* row  29 */
  {
  ...
  /* row  45 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[44]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[2])))
  },
  /* row  46 */
  {
  ...
  /* row  47 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[46]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[45])))
  },
  /* row  48 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 9U)),
  ...
  /* row  49 */
  {
    ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[48]))),
    ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[47])))
  },
  /* row  50 */
  {
...
static const MR_PseudoTypeInfo top_level__mercury_compile_make_hlds__top_level__mercury_compile_make_hlds__field_types_make_hlds_result_0_0[5] = {
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0),
  (MR_PseudoTypeInfo) (&top_level__mercury_compile_make_hlds__list__ti_list_1parse_tree__error_spec__type_ctor_info_diag_spec_0)
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_1(
  void * env_ptr_arg)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0_s * env_ptr = (struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0_s *) (env_ptr_arg);

  *((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LambdaHeadVar__1_62) = mdbcomp__sym_name__string_to_sym_name_1_f_0((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LibModuleNameStr_19);
  ((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont)((env_ptr)->top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont_env_ptr);
}
...
top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0(
  ...
  void * cont_env_ptr)
{
  struct top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0_s env;

  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LambdaHeadVar__1_62 = LambdaHeadVar__1_62;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont = cont;
  (env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__cont_env_ptr = cont_env_ptr;
  {
    MR_Word _DocUndoc_20;

    mercury__library__stdlib_module_doc_undoc_2_p_1(&(env).top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_env_0__LibModuleNameStr_19, &_DocUndoc_20, top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0_1, &env);
  }
}
...
top_level__mercury_compile_make_hlds__make_hlds_pass_19_p_0(
  ...
  MR_Word * STATE_VARIABLE_HLDS_68,
  MR_Word * QualInfo_28,
  MR_Word * MaybeTimestampMap_29,
  MR_Word * Result_30,
  MR_Word STATE_VARIABLE_DumpInfo_0_69,
  MR_Word * STATE_VARIABLE_DumpInfo_70,
  MR_Word STATE_VARIABLE_HaveReadModuleMaps_0_71,
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_72,
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_0_73,
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_74)
{
  MR_Word Stats_35;
  MR_Word Verbose_36;
  ...
  MR_Word EventSpecMap1_50;
  MR_Word MQInfo0_51;
  MR_Word UnusedImports_52;
  MR_Word UnusedImportsSpecsMap_53;
  MR_Word UnusedImportsSpecs_54;
  MR_Word RecompInfo0_55;
  MR_Word AugCompUnit_56;
  MR_Word EventSpecMap_57;
  MR_Word TypeEqvMap_58;
  MR_Word UsedEqvModules_59;
  MR_Word RecompInfo_60;
  MR_Word ExpandSpecs_61;
  MR_Word MQInfo_62;
  MR_String DumpBaseFileName_63;
  MR_Word InvalidTypeSpecs_64;
  MR_Word InvalidInstModeSpecs_65;
  MR_Word MakeSpecs_66;
  MR_Word EventSet_67;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_1_79;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_2_82;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_3_84;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_4_86;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_5_89;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_6_90;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_7_95;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_8_96;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_9_104;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_10_105;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_11_110;
  MR_Word STATE_VARIABLE_HLDS_1_115;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_12_116;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_13_117;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_14_118;
  MR_Word Var_181;

  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 133, &Stats_35);
  ...
  top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0(Globals_22, ParseTreeModuleSrc0_37, STATE_VARIABLE_MaybeWrittenSpecs_0_73, &STATE_VARIABLE_MaybeWrittenSpecs_1_79);
  ...
  top_level__mercury_compile_make_hlds__maybe_grab_plain_and_trans_opt_files_16_p_0(ProgressStream_20, Globals_22, OpModeAugment_23, Verbose_36, MaybeDFileTransOptDeps_40, &OptBlockingSpecs_41, Baggage0_25, &Baggage1_42, AugCompUnit0_26, &AugCompUnit1_43, STATE_VARIABLE_HaveReadModuleMaps_0_71, STATE_VARIABLE_HaveReadModuleMaps_72, STATE_VARIABLE_MaybeWrittenSpecs_1_79, &STATE_VARIABLE_MaybeWrittenSpecs_2_82);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(OptBlockingSpecs_41, STATE_VARIABLE_MaybeWrittenSpecs_2_82, &STATE_VARIABLE_MaybeWrittenSpecs_3_84);
  *MaybeTimestampMap_29 = ((MR_Word) ((MR_hl_field(0, Baggage1_42, 5))));
  Var_181 = ((MR_Word) ((MR_hl_field(0, Baggage1_42, 7))));
  BaggageSpecs_44 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_181);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(BaggageSpecs_44, STATE_VARIABLE_MaybeWrittenSpecs_3_84, &STATE_VARIABLE_MaybeWrittenSpecs_4_86);
  libs__globals__lookup_string_option_3_p_0(Globals_22, (MR_Integer) 280, &EventSetFileName_45);
  top_level__mercury_compile_make_hlds__maybe_read_event_set_7_p_0(Globals_22, EventSetFileName_45, &EventSetName_46, &EventSpecMap0_47, &EventSetSpecs_48);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(EventSetSpecs_48, STATE_VARIABLE_MaybeWrittenSpecs_4_86, &STATE_VARIABLE_MaybeWrittenSpecs_5_89);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_21, Globals_22, Verbose_36, STATE_VARIABLE_MaybeWrittenSpecs_5_89, &STATE_VARIABLE_MaybeWrittenSpecs_6_90);
  ...
  parse_tree__module_qual__qualify_items__module_qualify_aug_comp_unit_9_p_0(Globals_22, AugCompUnit1_43, &AugCompUnit2_49, EventSpecMap0_47, &EventSpecMap1_50, EventSetFileName_45, &MQInfo0_51, &UnusedImports_52, &UnusedImportsSpecsMap_53);
  mercury__map__values_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), UnusedImportsSpecsMap_53, &UnusedImportsSpecs_54);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(UnusedImportsSpecs_54, STATE_VARIABLE_MaybeWrittenSpecs_6_90, &STATE_VARIABLE_MaybeWrittenSpecs_7_95);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_21, Globals_22, Verbose_36, STATE_VARIABLE_MaybeWrittenSpecs_7_95, &STATE_VARIABLE_MaybeWrittenSpecs_8_96);
  ...
  parse_tree__module_qual__mq_info__mq_info_get_recompilation_info_2_p_0(MQInfo0_51, &RecompInfo0_55);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_20, Verbose_36, (MR_String) "% Expanding equivalence types and insts...\n");
  libs__file_util__maybe_flush_output_4_p_0(ProgressStream_20, Verbose_36);
  parse_tree__equiv_type_parse_tree__expand_eqv_types_insts_9_p_0(AugCompUnit2_49, &AugCompUnit_56, EventSpecMap1_50, &EventSpecMap_57, &TypeEqvMap_58, &UsedEqvModules_59, RecompInfo0_55, &RecompInfo_60, &ExpandSpecs_61);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(ExpandSpecs_61, STATE_VARIABLE_MaybeWrittenSpecs_8_96, &STATE_VARIABLE_MaybeWrittenSpecs_9_104);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_21, Globals_22, Verbose_36, STATE_VARIABLE_MaybeWrittenSpecs_9_104, &STATE_VARIABLE_MaybeWrittenSpecs_10_105);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_20, Verbose_36, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_20, Stats_35);
  parse_tree__module_qual__mq_info__mq_info_set_recompilation_info_3_p_0(RecompInfo_60, MQInfo0_51, &MQInfo_62);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_21, Globals_22, Verbose_36, STATE_VARIABLE_MaybeWrittenSpecs_10_105, &STATE_VARIABLE_MaybeWrittenSpecs_11_110);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_20, Verbose_36, (MR_String) "% Converting parse tree to hlds...\n");
  parse_tree__file_names__module_name_to_cur_dir_file_name_3_p_0((MR_Integer) 4, ModuleName_38, &DumpBaseFileName_63);
  hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_13_p_0(ProgressStream_20, AugCompUnit_56, Globals_22, DumpBaseFileName_63, MQInfo_62, TypeEqvMap_58, UsedEqvModules_59, UnusedImports_52, QualInfo_28, &STATE_VARIABLE_HLDS_1_115, &InvalidTypeSpecs_64, &InvalidInstModeSpecs_65, &MakeSpecs_66);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(InvalidTypeSpecs_64, STATE_VARIABLE_MaybeWrittenSpecs_11_110, &STATE_VARIABLE_MaybeWrittenSpecs_12_116);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(InvalidInstModeSpecs_65, STATE_VARIABLE_MaybeWrittenSpecs_12_116, &STATE_VARIABLE_MaybeWrittenSpecs_13_117);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(MakeSpecs_66, STATE_VARIABLE_MaybeWrittenSpecs_13_117, &STATE_VARIABLE_MaybeWrittenSpecs_14_118);
  {
    EventSet_67 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, EventSet_67, 0) = ((MR_Box) (EventSetName_46));
    MR_hl_field(0, EventSet_67, 1) = ((MR_Box) (EventSpecMap_57));
  }
  hlds__hlds_module__module_info_set_event_set_3_p_0(EventSet_67, STATE_VARIABLE_HLDS_1_115, STATE_VARIABLE_HLDS_68);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    *Result_30 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (InvalidTypeSpecs_64));
    MR_hl_field(0, base, 1) = ((MR_Box) (InvalidInstModeSpecs_65));
    MR_hl_field(0, base, 2) = ((MR_Box) (OptBlockingSpecs_41));
    MR_hl_field(0, base, 3) = ((MR_Box) (ExpandSpecs_61));
    MR_hl_field(0, base, 4) = ((MR_Box) (EventSetSpecs_48));
  }
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_21, Globals_22, Verbose_36, STATE_VARIABLE_MaybeWrittenSpecs_14_118, STATE_VARIABLE_MaybeWrittenSpecs_74);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_20, Verbose_36, (MR_String) "% done.\n");
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_20, Stats_35);
  top_level__mercury_compile_make_hlds__maybe_write_definitions_6_p_0(ProgressStream_20, Verbose_36, Stats_35, *STATE_VARIABLE_HLDS_68);
  top_level__mercury_compile_make_hlds__maybe_write_definition_line_counts_6_p_0(ProgressStream_20, Verbose_36, Stats_35, *STATE_VARIABLE_HLDS_68);
  top_level__mercury_compile_make_hlds__maybe_write_definition_extents_6_p_0(ProgressStream_20, Verbose_36, Stats_35, *STATE_VARIABLE_HLDS_68);
  hlds__passes_aux__maybe_dump_hlds_8_p_0(ProgressStream_20, *STATE_VARIABLE_HLDS_68, (MR_Integer) 1, (MR_String) "initial", STATE_VARIABLE_DumpInfo_0_69, STATE_VARIABLE_DumpInfo_70);
  top_level__mercury_compile_make_hlds__maybe_write_d_file_9_p_0(ProgressStream_20, Globals_22, Baggage0_25, AugCompUnit_56, *STATE_VARIABLE_HLDS_68, WriteDFile_39, MaybeDFileTransOptDeps_40);
}
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_9, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/6", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[50])), ModuleName_10, &TransOptDateFileName_22, &_TransOptDateFileNameProposed_23);
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_54)
{
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_80, 1) = ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[57])));
                  }
                  {
                    Var_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_77, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[52])));
                    MR_hl_field(1, Var_77, 1) = ((MR_Box) (Var_80));
                  }
                  {
                    Pieces_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Pieces_38, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[51])));
  ...
  *BlockingSpecs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), PlainOptBlockingSpecs_32, TransOptBlockingSpecs_34);
}
...
top_level__mercury_compile_make_hlds__maybe_read_event_set_7_p_0(
  ...
  MR_Word * EventSetSpecs_12)
{
  MR_bool succeeded = (strcmp(EventSetFileName_9, (MR_String) "") == 0);

  if (succeeded)
  {
    *EventSetName_10 = (MR_String) "";
    *EventSpecMap_11 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0));
    *EventSetSpecs_12 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    MR_String EventSetName0_14;
    MR_Word EventSpecMap0_15;
    MR_Word Errors_16;

    parse_tree__prog_event__read_event_set_6_p_0(EventSetFileName_9, &EventSetName0_14, &EventSpecMap0_15, EventSetSpecs_12);
    Errors_16 = parse_tree__error_util__contains_errors_2_f_0(Globals_8, *EventSetSpecs_12);
    switch (Errors_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          *EventSetName_10 = EventSetName0_14;
          *EventSpecMap_11 = EventSpecMap0_15;
        }
        break;
      case (MR_Integer) 1:
        {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__251__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  void * cont_env_ptr)
{
  ...
  (env).top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
  {
    ...
    top_level__mercury_compile_make_hlds__IntroducedFrom__pred__maybe_warn_about_stdlib_shadowing__242__1_1_p_0(&(env).top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_2_env_0__conv0_LambdaHeadVar__1_62, top_level__mercury_compile_make_hlds__maybe_warn_about_stdlib_shadowing_4_p_0_1, &env);
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_30, 1) = ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[16])));
          }
          {
            Pieces0_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Pieces0_12, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[1])));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(1, Var_74, 1) = ((MR_Box) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[43])));
            }
            {
              Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_71, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[18])));
              MR_hl_field(1, Var_71, 1) = ((MR_Box) (Var_74));
            }
            {
              Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_68, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[15])));
            ...
            }
            {
              ...
              MR_hl_field(1, Pieces0_126, 0) = ((MR_Box) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[17])));
  ...
  switch (DocUndoc_4) {
    ...
    case (MR_Integer) 0:
      *Pieces_6 = Pieces0_5;
      break;
    case (MR_Integer) 1:
      *Pieces_6 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces0_5, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_1[49])));
      break;
  }
}
