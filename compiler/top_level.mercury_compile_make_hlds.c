  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_82)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 663, &InvokedByMMCMake_37);
  ...
  *MaybeTimestampMap_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage1_43, (MR_Integer) 4))));
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_20, (MR_Integer) 224, &EventSetFileName_45);
