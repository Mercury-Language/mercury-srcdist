    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_and_check_avail_module_sets_2_p_0(*HLDS0_29, &AvailModuleSets_75);
        ...
        parse_tree__write_deps_file__generate_and_write_d_file_hlds_7_p_0(ProgressStream_22, Globals_24, BurdenedAugCompUnit_74, AvailModuleSets_75, MaybeInclTransOptRule_79);
        libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 765, &OutputMMCMakeDeps_80);
  ...
  MR_Word HLDS_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 244, &Extents_15);
  switch (Extents_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 243, &LineCounts_15);
  ...
  MR_Word HLDS_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_12, &Globals_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 242, &ShowDefns_15);
  switch (ShowDefns_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 404, &IntermodOpt_27);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 405, &UseOptInt_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 407, &TransOpt_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 411, &IntermodAnalysis_30);
      ...
      switch (MR_unmkbody(OpModeAugment_19)) {
        ...
        case (MR_Integer) 1:
          if ((MaybeDFileTransOptDeps_21 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 192, &WarnNoTransOptDeps_36);
  ...
  MR_Word * MaybeDFileTransOptDeps_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 407, &TransOpt_14);
  switch (TransOpt_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 131, &Verbose_15);
