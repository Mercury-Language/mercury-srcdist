  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_91)
{
  ...
  *MaybeTimestampMap_33 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 4))));
  Var_183 = ((MR_Word) ((MR_hl_field(0, Baggage1_48, (MR_Integer) 6))));
  Var_101 = parse_tree__parse_error__get_read_module_specs_1_f_0(Var_183);
  ...
  if (succeeded)
  {
    TypeCtorInfo_196_196 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_196_196, MQUndefTypeClasses_63);
    if (succeeded)
    {
  ...
  if (succeeded)
  {
    TypeCtorInfo_198_198 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0);
    succeeded = mercury__set_tree234__is_empty_1_p_0(TypeCtorInfo_198_198, MQUndefModes_62);
    if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  parse_tree__file_names__module_name_to_file_name_return_dirs_6_p_0(Globals_22, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.make_hlds\'/19", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_make_hlds_scalar_common_1[57])), ModuleName_38, &DumpDirs_39, &DumpBaseFileName_40);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 499, &IntermodOpt_27);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 501, &UseOptInt_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 503, &TransOpt_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 504, &IntermodAnalysis_30);
  ...
  MR_Word * MaybeDFileTransOptDeps_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 503, &TransOpt_14);
  switch (TransOpt_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[0])), ModuleName_11, &TransOptDateFileName_19);
