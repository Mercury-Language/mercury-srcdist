...
static /* final */ const MR_Box top_level__mercury_compile_make_hlds_scalar_common_2[7][1];
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_make_hlds.maybe_read_d_file_for_trans_opt_deps\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_make_hlds_scalar_common_2[1])), (MR_Word) (MR_mkword(2, &top_level__mercury_compile_make_hlds_scalar_common_2[2])), ModuleName_11, &TransOptDateFileName_19);
