...
ifeq ($(TARGET_ASM),yes)
backend_libs.matching.mh backend_libs.matching.mih : backend_libs.matching.s
else
backend_libs.matching.mh backend_libs.matching.mih : backend_libs.matching.c
endif

ifeq ($(TARGET_ASM),yes)
backend_libs.matching.module_dep : backend_libs.matching.s
else
 ifeq ($(findstring il,$(GRADE)),il)
backend_libs.matching.module_dep : backend_libs.matching.il
  ifeq ($(findstring java,$(GRADE)),java)
backend_libs.matching.module_dep : mercury/backend_libs_/matching.java
  else
...
ifeq ($(TARGET_ASM),yes)
backend_libs.matching.s_date : matching.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only backend_libs.matching $(ERR_REDIRECT)
backend_libs.matching.pic_s_date : matching.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" backend_libs.matching $(ERR_REDIRECT)
endif # TARGET_ASM
