...
{
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_71, (MR_Integer) 1)));
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 0)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_13, (MR_Integer) 3)));
...
{
  {
    ...
    else
    {
      ...
      *ResumeVars_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Resume_11, (MR_Integer) 0))));
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_11, (MR_Integer) 1)));
