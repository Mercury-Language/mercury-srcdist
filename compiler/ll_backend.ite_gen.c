...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 323, &ReclaimHeapOnFailure_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 323, &ReclaimOption_30);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 306, &FixedSize_48);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 310, &ProtectSize_49);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 311, &SnapshotSize_50);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 303, &UseMinimalModelStackCopyPNeg_11);
