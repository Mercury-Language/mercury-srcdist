...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 331, &ReclaimHeapOnFailure_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 331, &ReclaimOption_30);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 314, &FixedSize_48);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 318, &ProtectSize_49);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 319, &SnapshotSize_50);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 311, &UseMinimalModelStackCopyPNeg_11);
