...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__ite_gen__Globals_21, (MR_Integer) 308, &ll_backend__ite_gen__ReclaimHeapOnFailure_22);
    }
                ...
                if (ll_backend__ite_gen__succeeded)
                  {
                    ...
                    ll_backend__ite_gen__V_46_46 = (MR_Integer) 455;
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__ite_gen__Globals_29, (MR_Integer) 308, &ll_backend__ite_gen__ReclaimOption_30);
    }
