...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 333, &ReclaimHeapOnFailure_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 333, &ReclaimOption_30);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 316, &FixedSize_48);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 320, &ProtectSize_49);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 321, &SnapshotSize_50);
