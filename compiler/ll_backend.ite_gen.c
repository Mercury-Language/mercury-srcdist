          ...
          else
            {
              ...
              if (ll_backend__ite_gen__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 293, &ll_backend__ite_gen__FixedSize_48);
                  }
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 297, &ll_backend__ite_gen__ProtectSize_49);
                  }
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 298, &ll_backend__ite_gen__SnapshotSize_50);
                  }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__ite_gen__Globals_6, (MR_Integer) 290, &ll_backend__ite_gen__UseMinimalModelStackCopyPNeg_11);
    }
...
{
  {
    ...
    {
      ll_backend__ite_gen__succeeded = ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__390__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__ite_gen__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__ite_gen__closure, (MR_Integer) 4))));
    }
    return ll_backend__ite_gen__succeeded;
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__ite_gen__Var_74, 0) = ((MR_Box) (&ll_backend__ite_gen_scalar_common_2[0]));
...
{
  {
    ...
    MR_Word ll_backend__ite_gen__Var_45;
    MR_Word ll_backend__ite_gen__Var_46;
        ...
        if (ll_backend__ite_gen__succeeded)
          {
            ...
            ll_backend__ite_gen__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__ite_gen__GoalExpr_15, (MR_Integer) 3)));
            ll_backend__ite_gen__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__ite_gen__GoalExpr_15, (MR_Integer) 4)));
            ll_backend__ite_gen__succeeded = ((((MR_tag((MR_Word) ll_backend__ite_gen__Var_45)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_45, (MR_Integer) 0)))) == (MR_Integer) 0)));
            if (ll_backend__ite_gen__succeeded)
              {
                ll_backend__ite_gen__L_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_45, (MR_Integer) 1)));
                ll_backend__ite_gen__R_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_45, (MR_Integer) 2)));
                {
                ...
                if (ll_backend__ite_gen__succeeded)
                  {
                    ...
                    ll_backend__ite_gen__Var_46 = (MR_Integer) 460;
                    ll_backend__ite_gen__Var_47 = (MR_Integer) 1;
                    {
                      ll_backend__ite_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ll_backend__ite_gen__Globals_28, ll_backend__ite_gen__Var_46, ll_backend__ite_gen__Var_47);
                    }
                  }
              }
          }
    ...
    if (ll_backend__ite_gen__succeeded)
      {
        ...
        MR_Word ll_backend__ite_gen__Var_56;
        MR_Word ll_backend__ite_gen__Var_59;
        MR_Word ll_backend__ite_gen__Var_52;

        {
          ll_backend__ite_gen__Var_48 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, ll_backend__ite_gen__ResumeVars_17);
        }
        {
          ll_backend__code_loc_dep__enter_simple_neg_5_p_0(ll_backend__ite_gen__Var_48, ll_backend__ite_gen__GoalInfo_19, &ll_backend__ite_gen__SimpleNeg_29, ll_backend__ite_gen__STATE_VARIABLE_CLD_0_39, &ll_backend__ite_gen__STATE_VARIABLE_CLD_49_49);
        }
        {
        ...
        if (ll_backend__ite_gen__succeeded)
          {
            ll_backend__ite_gen__Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(2), ll_backend__ite_gen__Type_34, (MR_Integer) 0)));
            ll_backend__ite_gen__succeeded = (ll_backend__ite_gen__Var_52 == (MR_Integer) 3);
          }
        if (ll_backend__ite_gen__succeeded)
            ...
            if (ll_backend__ite_gen__succeeded)
              {
                ...
                ll_backend__ite_gen__succeeded = (ll_backend__ite_gen__Var_53 == (MR_Integer) 2);
              }
            if (ll_backend__ite_gen__succeeded)
              ll_backend__ite_gen__Op_35 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 48));
            else
        ...
        {
          ll_backend__ite_gen__Var_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_56, 1) = ((MR_Box) (ll_backend__ite_gen__Op_35));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_56, 2) = ((MR_Box) (ll_backend__ite_gen__ValL_31));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_56, 3) = ((MR_Box) (ll_backend__ite_gen__ValR_33));
        }
        {
          ll_backend__ite_gen__Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_55, 1) = ((MR_Box) (ll_backend__ite_gen__Var_56));
          MR_hl_field(MR_mktag(3), ll_backend__ite_gen__Var_55, 2) = ((MR_Box) (ll_backend__ite_gen__CodeAddr_27));
        }
        {
          ll_backend__ite_gen__Var_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ll_backend__ite_gen__Var_54, 0) = ((MR_Box) (ll_backend__ite_gen__Var_55));
          MR_hl_field(MR_mktag(0), ll_backend__ite_gen__Var_54, 1) = ((MR_Box) ((MR_String) "test inequality"));
        }
        {
          ll_backend__ite_gen__TestCode_36 = mercury__cord__singleton_1_f_0(ll_backend__ite_gen__TypeCtorInfo_63_63, ((MR_Box) (ll_backend__ite_gen__Var_54)));
        }
        {
        ...
        {
          ll_backend__ite_gen__Var_59 = mercury__cord__f_43_43_2_f_0(ll_backend__ite_gen__TypeCtorInfo_63_63, ll_backend__ite_gen__CodeR_32, ll_backend__ite_gen__TestCode_36);
        }
        {
          *ll_backend__ite_gen__Code_12 = mercury__cord__f_43_43_2_f_0(ll_backend__ite_gen__TypeCtorInfo_63_63, ll_backend__ite_gen__CodeL_30, ll_backend__ite_gen__Var_59);
        }
