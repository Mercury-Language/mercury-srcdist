...
MR_decl_static(ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__392__1_2_0)
...
MR_def_label(ll_backend__ite_gen__generate_negation_general_8_0,16)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__392__1_2_0);
...
MR_BEGIN_MODULE(ll_backend__ite_gen_module10)
	MR_init_entry1(ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__392__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__392__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_negation_general__392__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__392__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
