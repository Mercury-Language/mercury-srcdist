...
static /* final */ const MR_Box ll_backend__ite_gen_scalar_common_1[7][2];
  ...
  MR_Word * STATE_VARIABLE_CLD_60)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 344, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_64_64, STATE_VARIABLE_CLD_62_62, &STATE_VARIABLE_CLD_65_65);
  ...
  MR_Word * STATE_VARIABLE_CLD_83)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 344, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_80, &STATE_VARIABLE_CI_88_88, STATE_VARIABLE_CLD_86_86, &STATE_VARIABLE_CLD_89_89);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          {
            Var_91 = (MR_Integer) 1;
            ll_backend__code_info__get_opt_trail_ops_2_p_0(STATE_VARIABLE_CI_88_88, &Var_219);
            succeeded = (Var_91 == Var_219);
          }
        }
        if (succeeded)
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        ll_backend__code_loc_dep__maybe_release_hp_5_p_0(MaybeHpSlot_30, STATE_VARIABLE_CI_111_111, &STATE_VARIABLE_CI_115_115, STATE_VARIABLE_CLD_114_114, &STATE_VARIABLE_CLD_116_116);
    ...
    case (MR_Integer) 2:
      {
        ...
        STATE_VARIABLE_CI_121_121 = STATE_VARIABLE_CI_111_111;
        STATE_VARIABLE_CLD_122_122 = STATE_VARIABLE_CLD_114_114;
      }
      break;
  }
  ...
  if (succeeded)
  {
    ...
    STATE_VARIABLE_CLD_127_127 = STATE_VARIABLE_CLD_122_122;
    STATE_VARIABLE_CI_126_126 = STATE_VARIABLE_CI_121_121;
  }
  else
  {
    ...
    ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(ThenGoal_13, IteGoalInfo_15, &ThenTraceCode_59, STATE_VARIABLE_CI_121_121, &STATE_VARIABLE_CI_124_124, STATE_VARIABLE_CLD_122_122, &STATE_VARIABLE_CLD_125_125);
  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 328, &FixedSize_47);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 331, &ProtectSize_48);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 332, &SnapshotSize_49);
  ...
  MR_Word * PNegElseCode_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 325, &UseMinimalModelStackCopyPNeg_11);
  ...
  if (succeeded)
  {
    ...
    Var_35 = mercury__string__append_list_1_f_0((MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__ite_gen_scalar_common_1[6])));
    {
