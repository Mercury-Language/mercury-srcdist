  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 769, &FixedSize_47);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 772, &ProtectSize_48);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 773, &SnapshotSize_49);
  ...
  MR_Word * PNegElseCode_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 767, &UseMinimalModelStackCopyPNeg_11);
