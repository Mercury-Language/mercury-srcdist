...
{
  {
    ...
    ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 340, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_64_64, STATE_VARIABLE_CLD_62_62, &STATE_VARIABLE_CLD_65_65);
...
{
  {
    ...
    ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 340, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_80, &STATE_VARIABLE_CI_88_88, STATE_VARIABLE_CLD_86_86, &STATE_VARIABLE_CLD_89_89);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 324, &FixedSize_47);
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 327, &ProtectSize_48);
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 328, &SnapshotSize_49);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 321, &UseMinimalModelStackCopyPNeg_11);
