...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_15, (MR_Integer) 3))));
        succeeded = ((((MR_tag((MR_Word) Var_47)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_47, (MR_Integer) 0)))) == (MR_Integer) 0)));
        if (succeeded)
        {
          L_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_47, (MR_Integer) 1))));
          R_25 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_47, (MR_Integer) 2))));
          ...
          if (succeeded)
          {
            ...
            Var_48 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_29, (MR_Integer) 1))) >> 8)) & (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        BuiltinType_36 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Type_35, (MR_Integer) 0))));
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              IntType_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_36, (MR_Integer) 0))) & (MR_Integer) 15);
              {
                Op_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Op_37, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                MR_hl_field(MR_mktag(3), Op_37, 1) = (MR_Box) ((MR_Unsigned) (IntType_38));
              }
            }
            else
              Op_37 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__ite_gen_scalar_common_1[4]));
          }
        }
      }
      else
        Op_37 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__ite_gen_scalar_common_1[4]));
      {
        ...
        MR_hl_field(MR_mktag(3), Var_57, 1) = ((MR_Box) (Op_37));
        MR_hl_field(MR_mktag(3), Var_57, 2) = ((MR_Box) (ValL_32));
        MR_hl_field(MR_mktag(3), Var_57, 3) = ((MR_Box) (ValR_34));
      }
      {
...
{
  {
    ...
    ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 335, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_64_64, STATE_VARIABLE_CLD_62_62, &STATE_VARIABLE_CLD_65_65);
...
{
  {
    ...
    ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 335, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_77, &STATE_VARIABLE_CI_85_85, STATE_VARIABLE_CLD_83_83, &STATE_VARIABLE_CLD_86_86);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 319, &FixedSize_47);
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 322, &ProtectSize_48);
        libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 323, &SnapshotSize_49);
        ...
        Var_113 = mercury__string__f_43_43_2_f_0((MR_String) "Initialize pointer to nonfixed part of", (MR_String) " embedded frame");
        {
          ...
          MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (Var_113));
        }
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 316, &UseMinimalModelStackCopyPNeg_11);
