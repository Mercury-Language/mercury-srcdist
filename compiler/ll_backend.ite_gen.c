...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 313, &ReclaimHeapOnFailure_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 313, &ReclaimOption_30);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 296, &FixedSize_48);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 300, &ProtectSize_49);
              libs__globals__lookup_int_option_3_p_0(Globals_47, (MR_Integer) 301, &SnapshotSize_50);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 293, &UseMinimalModelStackCopyPNeg_11);
    succeeded = (UseMinimalModelStackCopyPNeg_11 == (MR_Integer) 1);
    if (succeeded)
    {
      Var_21 = (MR_Integer) 18;
