  ...
  MR_Word * STATE_VARIABLE_CLD_60)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 383, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_1_64, STATE_VARIABLE_CLD_1_62, &STATE_VARIABLE_CLD_2_65);
  ...
  MR_Word * STATE_VARIABLE_CLD_83)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 383, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_80, &STATE_VARIABLE_CI_1_88, STATE_VARIABLE_CLD_1_86, &STATE_VARIABLE_CLD_2_89);
  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 368, &FixedSize_47);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 371, &ProtectSize_48);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 372, &SnapshotSize_49);
  ...
  MR_Word * PNegElseCode_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 365, &UseMinimalModelStackCopyPNeg_11);
