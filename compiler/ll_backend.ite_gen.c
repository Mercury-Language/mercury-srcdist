          ...
          else
            {
              ...
              if (ll_backend__ite_gen__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 284, &ll_backend__ite_gen__FixedSize_48);
                  }
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 288, &ll_backend__ite_gen__ProtectSize_49);
                  }
                  {
                    libs__globals__lookup_int_option_3_p_0(ll_backend__ite_gen__Globals_47, (MR_Integer) 289, &ll_backend__ite_gen__SnapshotSize_50);
                  }
