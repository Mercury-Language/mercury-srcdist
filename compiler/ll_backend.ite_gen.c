...
ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__398__1_2_p_0(
...
static /* final */ const MR_Box ll_backend__ite_gen_scalar_common_1[11][2];
...
static /* final */ const MR_Box ll_backend__ite_gen_scalar_common_1[11][2] = {
  ...
  {
    ((MR_Box) ((MR_String) "\t\tMR_save_transient_registers();\n")),
    ((MR_Box) (MR_mkword(1, &ll_backend__ite_gen_scalar_common_1[9])))
  },
};
  ...
  MR_Word * STATE_VARIABLE_CLD_43)
{
  ...
  GoalExpr_15 = ((MR_Word) ((MR_hl_field(0, Goal0_10, 0))));
  GoalInfo0_16 = ((MR_Word) ((MR_hl_field(0, Goal0_10, 1))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_47 = ((MR_Word) ((MR_hl_field(1, GoalExpr_15, 3))));
      succeeded = ((((MR_tag((MR_Word) Var_47)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_47, 0)))) == (MR_Integer) 0)));
      if (succeeded)
      {
        L_24 = ((MR_Word) ((MR_hl_field(3, Var_47, 1))));
        R_25 = ((MR_Word) ((MR_hl_field(3, Var_47, 2))));
        ...
        if (succeeded)
        {
          ...
          Var_48 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_29, 1))) >> 7)) & (MR_Integer) 1);
  ...
  if (succeeded)
  {
    ...
    ll_backend__code_loc_dep__enter_simple_neg_5_p_0(Var_49, GoalInfo_19, &SimpleNeg_30, STATE_VARIABLE_CLD_0_42, &STATE_VARIABLE_CLD_1_50);
    ll_backend__code_loc_dep__produce_variable_5_p_0(L_24, &CodeL_31, &ValL_32, STATE_VARIABLE_CLD_1_50, &STATE_VARIABLE_CLD_2_51);
    ll_backend__code_loc_dep__produce_variable_5_p_0(R_25, &CodeR_33, &ValR_34, STATE_VARIABLE_CLD_2_51, &STATE_VARIABLE_CLD_3_52);
    ...
    if (succeeded)
    {
      BuiltinType_36 = ((MR_Word) ((MR_hl_field(2, Type_35, 0))));
      ...
      else
      {
        ...
        if (succeeded)
          Op_37 = (MR_Word) (MR_mkword(3, &ll_backend__ite_gen_scalar_common_1[3]));
        else
        {
          MR_Word IntType_38;
          ...
          if (succeeded)
          {
            IntType_38 = ((MR_Unsigned) ((MR_hl_field(1, BuiltinType_36, 0))) & (MR_Integer) 15);
            {
              Op_37 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Op_37, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(3, Op_37, 1) = (MR_Box) (((((MR_Unsigned) (IntType_38) << 3)) | (MR_Unsigned) ((MR_Integer) 0)));
            }
          }
          else
            Op_37 = (MR_Word) (MR_mkword(3, &ll_backend__ite_gen_scalar_common_1[4]));
        }
      }
    }
    else
      Op_37 = (MR_Word) (MR_mkword(3, &ll_backend__ite_gen_scalar_common_1[4]));
    {
      ...
      MR_hl_field(3, Var_62, 1) = ((MR_Box) (Op_37));
      MR_hl_field(3, Var_62, 2) = ((MR_Box) (ValL_32));
      MR_hl_field(3, Var_62, 3) = ((MR_Box) (ValR_34));
    }
    {
      ...
      MR_hl_field(3, Var_61, 2) = ((MR_Box) (CodeAddr_27));
    }
    {
      Var_60 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_60, 0) = ((MR_Box) (Var_61));
      MR_hl_field(0, Var_60, 1) = ((MR_Box) ((MR_String) "test inequality"));
    }
    TestCode_39 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_60)));
    ll_backend__code_loc_dep__leave_simple_neg_5_p_0(GoalInfo_19, SimpleNeg_30, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CLD_3_52, STATE_VARIABLE_CLD_43);
    Var_65 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CodeR_33, TestCode_39);
    *Code_12 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CodeL_31, Var_65);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__398__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CLD_60)
{
  ...
  MR_Word STATE_VARIABLE_CI_3_68;
  MR_Word STATE_VARIABLE_CLD_4_69;
  MR_Word Var_70;
  MR_Word STATE_VARIABLE_CI_4_74;
  MR_Word STATE_VARIABLE_CLD_5_75;
  MR_Word STATE_VARIABLE_CI_5_76;
  MR_Word STATE_VARIABLE_CLD_6_77;
  MR_Word STATE_VARIABLE_CI_6_78;
  MR_Word STATE_VARIABLE_CLD_7_79;
  MR_Word STATE_VARIABLE_CI_7_81;
  MR_Word STATE_VARIABLE_CLD_8_82;
  MR_Word STATE_VARIABLE_CI_8_83;
  MR_Word STATE_VARIABLE_CLD_9_84;
  MR_Word STATE_VARIABLE_CLD_10_85;
  MR_Word STATE_VARIABLE_CLD_11_86;
  MR_Word STATE_VARIABLE_CI_11_93;
  MR_Word STATE_VARIABLE_CLD_15_95;
  MR_Word STATE_VARIABLE_CI_12_96;
  MR_Word STATE_VARIABLE_CLD_16_97;
  MR_Word STATE_VARIABLE_CLD_17_98;
  MR_Word STATE_VARIABLE_CI_13_99;
  MR_Word STATE_VARIABLE_CLD_18_100;
  MR_Word STATE_VARIABLE_CI_14_102;
  MR_Word STATE_VARIABLE_CLD_19_103;
  MR_Word STATE_VARIABLE_CI_15_105;
  MR_Word STATE_VARIABLE_CLD_20_106;
  MR_Word Var_110;
  MR_Word Var_111;
  MR_Word Var_112;
  MR_Word Var_113;
  ...
  ll_backend__code_loc_dep__produce_vars_5_p_0(Var_61, &ResumeMap_19, &FlushCode_20, STATE_VARIABLE_CLD_0_59, &STATE_VARIABLE_CLD_1_62);
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 784, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_1_64, STATE_VARIABLE_CLD_1_62, &STATE_VARIABLE_CLD_2_65);
  AddTrailOps_23 = ll_backend__code_info__should_add_trail_ops_2_f_0(STATE_VARIABLE_CI_1_64, NotGoalInfo_13);
  ll_backend__code_loc_dep__maybe_save_ticket_7_p_0(AddTrailOps_23, &SaveTicketCode_24, &MaybeTicketSlot_25, STATE_VARIABLE_CI_1_64, &STATE_VARIABLE_CI_2_66, STATE_VARIABLE_CLD_2_65, &STATE_VARIABLE_CLD_3_67);
  GoalInfo_27 = ((MR_Word) ((MR_hl_field(0, Goal_12, 1))));
  ll_backend__ite_gen__maybe_create_ite_region_frame_12_p_0(GoalInfo_27, Goal_12, (MR_Word) ((MR_Unsigned) 0U), &RegionCondCode_30, &RegionThenCode_31, &RegionElseCode_32, &RegionStackVars_33, &MaybeEmbeddedStackFrameId_34, STATE_VARIABLE_CI_2_66, &STATE_VARIABLE_CI_3_68, STATE_VARIABLE_CLD_3_67, &STATE_VARIABLE_CLD_4_69);
  {
  ...
  ll_backend__code_loc_dep__prepare_for_ite_hijack_8_p_0(CodeModel_11, MaybeEmbeddedStackFrameId_34, &HijackInfo_35, &PrepareHijackCode_36, STATE_VARIABLE_CI_3_68, &STATE_VARIABLE_CI_4_74, STATE_VARIABLE_CLD_4_69, &STATE_VARIABLE_CLD_5_75);
  ll_backend__code_loc_dep__make_resume_point_6_p_0(ResumeVars_14, ResumeLocs_15, ResumeMap_19, &ResumePoint_37, STATE_VARIABLE_CI_4_74, &STATE_VARIABLE_CI_5_76);
  ll_backend__code_loc_dep__effect_resume_point_5_p_0(ResumePoint_37, CodeModel_11, &EffectResumeCode_38, STATE_VARIABLE_CLD_5_75, &STATE_VARIABLE_CLD_6_77);
  ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(Goal_12, NotGoalInfo_13, &EnterTraceCode_39, STATE_VARIABLE_CI_5_76, &STATE_VARIABLE_CI_6_78, STATE_VARIABLE_CLD_6_77, &STATE_VARIABLE_CLD_7_79);
  ll_backend__code_gen__generate_goal_7_p_0((MR_Integer) 1, Goal_12, &GoalCode_40, STATE_VARIABLE_CI_6_78, &STATE_VARIABLE_CI_7_81, STATE_VARIABLE_CLD_7_79, &STATE_VARIABLE_CLD_8_82);
  ll_backend__code_loc_dep__ite_enter_then_8_p_0(HijackInfo_35, ResumePoint_37, &ThenNeckCode_41, &ElseNeckCode_42, STATE_VARIABLE_CI_7_81, &STATE_VARIABLE_CI_8_83, STATE_VARIABLE_CLD_8_82, &STATE_VARIABLE_CLD_9_84);
  ll_backend__code_loc_dep__pickup_zombies_3_p_0(&Zombies_43, STATE_VARIABLE_CLD_9_84, &STATE_VARIABLE_CLD_10_85);
  ll_backend__code_loc_dep__make_vars_forward_dead_3_p_0(Zombies_43, STATE_VARIABLE_CLD_10_85, &STATE_VARIABLE_CLD_11_86);
  ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_11_86, &LiveVars_44);
  switch (CodeModel_11) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        STATE_VARIABLE_CI_11_93 = STATE_VARIABLE_CI_8_83;
        STATE_VARIABLE_CLD_15_95 = STATE_VARIABLE_CLD_11_86;
      }
      break;
    case (MR_Integer) 2:
    case (MR_Integer) 1:
      {
        ...
        MR_Word STATE_VARIABLE_CI_9_87;
        MR_Word STATE_VARIABLE_CLD_12_88;
        MR_Word STATE_VARIABLE_CI_10_90;
        MR_Word STATE_VARIABLE_CLD_13_91;
        MR_Word STATE_VARIABLE_CLD_14_94;

        ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_11_86, &AfterNegatedGoal_48);
        ll_backend__code_loc_dep__maybe_release_hp_5_p_0(MaybeHpSlot_22, STATE_VARIABLE_CI_8_83, &STATE_VARIABLE_CI_9_87, STATE_VARIABLE_CLD_11_86, &STATE_VARIABLE_CLD_12_88);
        ll_backend__code_loc_dep__maybe_reset_prune_and_release_ticket_7_p_0(MaybeTicketSlot_25, (MR_Integer) 1, &PruneTicketCode_45, STATE_VARIABLE_CI_9_87, &STATE_VARIABLE_CI_10_90, STATE_VARIABLE_CLD_12_88, &STATE_VARIABLE_CLD_13_91);
        ll_backend__trace_gen__maybe_generate_negated_event_code_8_p_0(Goal_12, NotGoalInfo_13, (MR_Integer) 1, &FailTraceCode_46, STATE_VARIABLE_CI_10_90, &STATE_VARIABLE_CI_11_93, STATE_VARIABLE_CLD_13_91, &STATE_VARIABLE_CLD_14_94);
        ll_backend__code_loc_dep__generate_failure_3_p_0(&FailCode_47, STATE_VARIABLE_CI_11_93, STATE_VARIABLE_CLD_14_94);
        ll_backend__code_loc_dep__reset_to_position_3_p_0(AfterNegatedGoal_48, STATE_VARIABLE_CI_11_93, &STATE_VARIABLE_CLD_15_95);
      }
      break;
  }
  ll_backend__code_loc_dep__generate_resume_point_6_p_0(ResumePoint_37, &ResumeCode_49, STATE_VARIABLE_CI_11_93, &STATE_VARIABLE_CI_12_96, STATE_VARIABLE_CLD_15_95, &STATE_VARIABLE_CLD_16_97);
  ll_backend__code_loc_dep__set_forward_live_vars_3_p_0(LiveVars_44, STATE_VARIABLE_CLD_16_97, &STATE_VARIABLE_CLD_17_98);
  ll_backend__code_loc_dep__maybe_restore_and_release_hp_6_p_0(MaybeHpSlot_22, &RestoreHpCode_50, STATE_VARIABLE_CI_12_96, &STATE_VARIABLE_CI_13_99, STATE_VARIABLE_CLD_17_98, &STATE_VARIABLE_CLD_18_100);
  ll_backend__code_loc_dep__maybe_reset_discard_and_release_ticket_7_p_0(MaybeTicketSlot_25, (MR_Integer) 0, &RestoreTicketCode_51, STATE_VARIABLE_CI_13_99, &STATE_VARIABLE_CI_14_102, STATE_VARIABLE_CLD_18_100, &STATE_VARIABLE_CLD_19_103);
  ll_backend__code_loc_dep__release_several_temp_slots_6_p_0(RegionStackVars_33, (MR_Integer) 1, STATE_VARIABLE_CI_14_102, &STATE_VARIABLE_CI_15_105, STATE_VARIABLE_CLD_19_103, &STATE_VARIABLE_CLD_20_106);
  ll_backend__trace_gen__maybe_generate_negated_event_code_8_p_0(Goal_12, NotGoalInfo_13, (MR_Integer) 0, &SuccessTraceCode_52, STATE_VARIABLE_CI_15_105, STATE_VARIABLE_CI_58, STATE_VARIABLE_CLD_20_106, STATE_VARIABLE_CLD_60);
  ...
  Var_129 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SuccessTraceCode_52, PNegElseCode_56);
  Var_128 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionElseCode_32, Var_129);
  Var_127 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreHpCode_50, Var_128);
  Var_126 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreTicketCode_51, Var_127);
  Var_125 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ElseNeckCode_42, Var_126);
  Var_124 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ResumeCode_49, Var_125);
  Var_123 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FailCode_47, Var_124);
  Var_122 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PNegThenCode_55, Var_123);
  Var_121 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FailTraceCode_46, Var_122);
  Var_120 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionThenCode_31, Var_121);
  Var_119 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PruneTicketCode_45, Var_120);
  Var_118 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ThenNeckCode_41, Var_119);
  Var_117 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), GoalCode_40, Var_118);
  Var_116 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PNegCondCode_54, Var_117);
  Var_115 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), EnterTraceCode_39, Var_116);
  Var_114 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionCondCode_30, Var_115);
  Var_113 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveTicketCode_24, Var_114);
  Var_112 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveHpCode_21, Var_113);
  Var_111 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), EffectResumeCode_38, Var_112);
  Var_110 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PrepareHijackCode_36, Var_111);
  *Code_16 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FlushCode_20, Var_110);
}
...
{
  MR_bool succeeded;
  MR_Word CondExpr_19 = ((MR_Word) ((MR_hl_field(0, CondGoal0_12, 0))));
  MR_Word CondInfo0_20 = ((MR_Word) ((MR_hl_field(0, CondGoal0_12, 1))));
  ...
  MR_Word Var_85;
  MR_Word STATE_VARIABLE_CLD_1_86;
  MR_Word STATE_VARIABLE_CI_1_88;
  MR_Word STATE_VARIABLE_CLD_2_89;
  MR_Word STATE_VARIABLE_CI_2_92;
  MR_Word STATE_VARIABLE_CLD_3_93;
  MR_Word STATE_VARIABLE_CI_3_94;
  MR_Word STATE_VARIABLE_CLD_4_95;
  MR_Word STATE_VARIABLE_CI_4_96;
  MR_Word STATE_VARIABLE_CLD_5_97;
  MR_Word STATE_VARIABLE_CI_5_98;
  MR_Word STATE_VARIABLE_CLD_6_99;
  MR_Word STATE_VARIABLE_CI_6_106;
  MR_Word STATE_VARIABLE_CLD_7_107;
  MR_Word STATE_VARIABLE_CI_7_108;
  MR_Word STATE_VARIABLE_CLD_8_109;
  MR_Word STATE_VARIABLE_CI_8_110;
  MR_Word STATE_VARIABLE_CLD_9_111;
  MR_Word STATE_VARIABLE_CLD_10_112;
  MR_Word STATE_VARIABLE_CLD_11_113;
  MR_Word STATE_VARIABLE_CI_11_121;
  MR_Word STATE_VARIABLE_CLD_14_122;
  MR_Word STATE_VARIABLE_CI_13_125;
  MR_Word STATE_VARIABLE_CLD_16_126;
  MR_Word STATE_VARIABLE_CLD_17_128;
  MR_Word STATE_VARIABLE_CI_14_129;
  MR_Word STATE_VARIABLE_CLD_18_130;
  MR_Word STATE_VARIABLE_CI_15_138;
  MR_Word STATE_VARIABLE_CLD_19_139;
  MR_Word STATE_VARIABLE_CI_16_141;
  MR_Word STATE_VARIABLE_CLD_20_142;
  MR_Word STATE_VARIABLE_CI_17_143;
  MR_Word STATE_VARIABLE_CLD_21_144;
  MR_Word STATE_VARIABLE_CI_18_145;
  MR_Word STATE_VARIABLE_CLD_22_146;
  MR_Word Var_155;
  MR_Word Var_156;
  MR_Word Var_157;
  MR_Word Var_159;
  ...
  ll_backend__code_loc_dep__produce_vars_5_p_0(Var_85, &ResumeMap_27, &FlushCode_28, STATE_VARIABLE_CLD_0_82, &STATE_VARIABLE_CLD_1_86);
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 784, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_80, &STATE_VARIABLE_CI_1_88, STATE_VARIABLE_CLD_1_86, &STATE_VARIABLE_CLD_2_89);
  AddTrailOps_31 = ll_backend__code_info__should_add_trail_ops_2_f_0(STATE_VARIABLE_CI_1_88, IteGoalInfo_15);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          {
            Var_91 = (MR_Integer) 1;
            ll_backend__code_info__get_opt_trail_ops_2_p_0(STATE_VARIABLE_CI_1_88, &Var_209);
            succeeded = (Var_91 == Var_209);
          }
        }
        if (succeeded)
        {
          ...
          STATE_VARIABLE_CLD_3_93 = STATE_VARIABLE_CLD_2_89;
          STATE_VARIABLE_CI_2_92 = STATE_VARIABLE_CI_1_88;
        }
        else
        {
          MR_Word TicketSlot_34;

          ll_backend__code_loc_dep__save_ticket_6_p_0(&SaveTicketCode_32, &TicketSlot_34, STATE_VARIABLE_CI_1_88, &STATE_VARIABLE_CI_2_92, STATE_VARIABLE_CLD_2_89, &STATE_VARIABLE_CLD_3_93);
          {
  ...
  hlds__goal_list_util__goal_to_conj_list_2_p_0(ElseGoal_14, &ElseGoals_35);
  ll_backend__ite_gen__maybe_create_ite_region_frame_12_p_0(IteGoalInfo_15, CondGoal_26, ElseGoals_35, &RegionCondCode_36, &RegionThenCode_37, &RegionElseCode_38, &RegionStackVars_39, &MaybeEmbeddedStackFrameId_40, STATE_VARIABLE_CI_2_92, &STATE_VARIABLE_CI_3_94, STATE_VARIABLE_CLD_3_93, &STATE_VARIABLE_CLD_4_95);
  ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_4_95, &BranchStart_41);
  ll_backend__code_loc_dep__prepare_for_ite_hijack_8_p_0(CondCodeModel_21, MaybeEmbeddedStackFrameId_40, &HijackInfo_42, &PrepareHijackCode_43, STATE_VARIABLE_CI_3_94, &STATE_VARIABLE_CI_4_96, STATE_VARIABLE_CLD_4_95, &STATE_VARIABLE_CLD_5_97);
  ll_backend__code_loc_dep__make_resume_point_6_p_0(ResumeVars_23, ResumeLocs_24, ResumeMap_27, &ResumePoint_44, STATE_VARIABLE_CI_4_96, &STATE_VARIABLE_CI_5_98);
  ll_backend__code_loc_dep__effect_resume_point_5_p_0(ResumePoint_44, EffCodeModel_22, &EffectResumeCode_45, STATE_VARIABLE_CLD_5_97, &STATE_VARIABLE_CLD_6_99);
  ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(CondGoal_26, IteGoalInfo_15, &CondTraceCode_51, STATE_VARIABLE_CI_5_98, &STATE_VARIABLE_CI_6_106, STATE_VARIABLE_CLD_6_99, &STATE_VARIABLE_CLD_7_107);
  ll_backend__code_gen__generate_goal_7_p_0(CondCodeModel_21, CondGoal_26, &CondCode_52, STATE_VARIABLE_CI_6_106, &STATE_VARIABLE_CI_7_108, STATE_VARIABLE_CLD_7_107, &STATE_VARIABLE_CLD_8_109);
  ll_backend__code_loc_dep__ite_enter_then_8_p_0(HijackInfo_42, ResumePoint_44, &ThenNeckCode_53, &ElseNeckCode_54, STATE_VARIABLE_CI_7_108, &STATE_VARIABLE_CI_8_110, STATE_VARIABLE_CLD_8_109, &STATE_VARIABLE_CLD_9_111);
  ll_backend__code_loc_dep__pickup_zombies_3_p_0(&Zombies_55, STATE_VARIABLE_CLD_9_111, &STATE_VARIABLE_CLD_10_112);
  ll_backend__code_loc_dep__make_vars_forward_dead_3_p_0(Zombies_55, STATE_VARIABLE_CLD_10_112, &STATE_VARIABLE_CLD_11_113);
  switch (CondCodeModel_21) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      {
        MR_Word STATE_VARIABLE_CI_9_115;
        MR_Word STATE_VARIABLE_CLD_12_116;
        MR_Word STATE_VARIABLE_CI_10_118;
        MR_Word STATE_VARIABLE_CLD_13_119;

        ll_backend__code_loc_dep__maybe_release_hp_5_p_0(MaybeHpSlot_30, STATE_VARIABLE_CI_8_110, &STATE_VARIABLE_CI_9_115, STATE_VARIABLE_CLD_11_113, &STATE_VARIABLE_CLD_12_116);
        ll_backend__code_loc_dep__maybe_reset_prune_and_release_ticket_7_p_0(MaybeTicketSlot_33, (MR_Integer) 1, &ResetTicketCode_56, STATE_VARIABLE_CI_9_115, &STATE_VARIABLE_CI_10_118, STATE_VARIABLE_CLD_12_116, &STATE_VARIABLE_CLD_13_119);
        ll_backend__code_loc_dep__release_several_temp_slots_6_p_0(RegionStackVars_39, (MR_Integer) 1, STATE_VARIABLE_CI_10_118, &STATE_VARIABLE_CI_11_121, STATE_VARIABLE_CLD_13_119, &STATE_VARIABLE_CLD_14_122);
      }
      break;
    case (MR_Integer) 2:
      {
        ll_backend__code_loc_dep__maybe_reset_ticket_3_p_0(MaybeTicketSlot_33, (MR_Integer) 2, &ResetTicketCode_56);
        STATE_VARIABLE_CI_11_121 = STATE_VARIABLE_CI_8_110;
        STATE_VARIABLE_CLD_14_122 = STATE_VARIABLE_CLD_11_113;
      }
      break;
  }
  hlds__hlds_llds__goal_info_get_store_map_2_p_0(IteGoalInfo_15, &StoreMap_57);
  ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_14_122, &EndCondInstMap_58);
  ...
  if (succeeded)
  {
    ...
    STATE_VARIABLE_CLD_16_126 = STATE_VARIABLE_CLD_14_122;
    STATE_VARIABLE_CI_13_125 = STATE_VARIABLE_CI_11_121;
  }
  else
  {
    MR_Word STATE_VARIABLE_CI_12_123;
    MR_Word STATE_VARIABLE_CLD_15_124;

    ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(ThenGoal_13, IteGoalInfo_15, &ThenTraceCode_59, STATE_VARIABLE_CI_11_121, &STATE_VARIABLE_CI_12_123, STATE_VARIABLE_CLD_14_122, &STATE_VARIABLE_CLD_15_124);
    ll_backend__code_gen__generate_goal_7_p_0(CodeModel_11, ThenGoal_13, &ThenCode_60, STATE_VARIABLE_CI_12_123, &STATE_VARIABLE_CI_13_125, STATE_VARIABLE_CLD_15_124, &STATE_VARIABLE_CLD_16_126);
    BranchEndStoreMap_61 = StoreMap_57;
  }
  ll_backend__code_loc_dep__generate_branch_end_5_p_0(BranchEndStoreMap_61, (MR_Word) ((MR_Unsigned) 0U), &MaybeEnd0_62, &ThenSaveCode_63, STATE_VARIABLE_CLD_16_126);
  ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_41, STATE_VARIABLE_CI_13_125, &STATE_VARIABLE_CLD_17_128);
  ll_backend__code_loc_dep__generate_resume_point_6_p_0(ResumePoint_44, &ResumeCode_64, STATE_VARIABLE_CI_13_125, &STATE_VARIABLE_CI_14_129, STATE_VARIABLE_CLD_17_128, &STATE_VARIABLE_CLD_18_130);
  ll_backend__code_loc_dep__maybe_restore_and_release_hp_6_p_0(MaybeHpSlot_30, &RestoreHpCode_66, STATE_VARIABLE_CI_14_129, &STATE_VARIABLE_CI_15_138, STATE_VARIABLE_CLD_18_130, &STATE_VARIABLE_CLD_19_139);
  ll_backend__code_loc_dep__maybe_reset_discard_and_release_ticket_7_p_0(MaybeTicketSlot_33, (MR_Integer) 0, &RestoreTicketCode_67, STATE_VARIABLE_CI_15_138, &STATE_VARIABLE_CI_16_141, STATE_VARIABLE_CLD_19_139, &STATE_VARIABLE_CLD_20_142);
  ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(ElseGoal_14, IteGoalInfo_15, &ElseTraceCode_68, STATE_VARIABLE_CI_16_141, &STATE_VARIABLE_CI_17_143, STATE_VARIABLE_CLD_20_142, &STATE_VARIABLE_CLD_21_144);
  ll_backend__code_gen__generate_goal_7_p_0(CodeModel_11, ElseGoal_14, &ElseCode_69, STATE_VARIABLE_CI_17_143, &STATE_VARIABLE_CI_18_145, STATE_VARIABLE_CLD_21_144, &STATE_VARIABLE_CLD_22_146);
  ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_57, MaybeEnd0_62, &MaybeEnd_70, &ElseSaveCode_71, STATE_VARIABLE_CLD_22_146);
  ll_backend__code_info__get_next_label_3_p_0(&EndLabel_73, STATE_VARIABLE_CI_18_145, STATE_VARIABLE_CI_81);
  {
    Var_157 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_157, 0) = ((MR_Box) (EndLabel_73));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(0, Var_155, 1) = ((MR_Box) ((MR_String) "Jump to the end of if-then-else"));
  }
  JumpToEndCode_74 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_155)));
  {
    ...
    MR_hl_field(3, Var_160, 1) = ((MR_Box) (EndLabel_73));
  }
  {
    Var_159 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_159, 0) = ((MR_Box) (Var_160));
    MR_hl_field(0, Var_159, 1) = ((MR_Box) ((MR_String) "end of if-then-else"));
  }
  EndLabelCode_75 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_159)));
  ...
  Var_186 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ElseSaveCode_71, EndLabelCode_75);
  Var_185 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ElseCode_69, Var_186);
  Var_184 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PNegElseCode_79, Var_185);
  Var_183 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ElseTraceCode_68, Var_184);
  Var_182 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionElseCode_38, Var_183);
  Var_181 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreTicketCode_67, Var_182);
  Var_180 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreHpCode_66, Var_181);
  Var_179 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ElseNeckCode_54, Var_180);
  Var_178 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ResumeCode_64, Var_179);
  Var_177 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), JumpToEndCode_74, Var_178);
  Var_176 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ThenSaveCode_63, Var_177);
  Var_175 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ThenCode_60, Var_176);
  Var_174 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PNegThenCode_78, Var_175);
  Var_173 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ThenTraceCode_59, Var_174);
  Var_172 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionThenCode_37, Var_173);
  Var_171 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ResetTicketCode_56, Var_172);
  Var_170 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ThenNeckCode_53, Var_171);
  Var_169 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CondCode_52, Var_170);
  Var_168 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PNegCondCode_77, Var_169);
  Var_167 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), CondTraceCode_51, Var_168);
  Var_166 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), EffectResumeCode_45, Var_167);
  Var_165 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PrepareHijackCode_43, Var_166);
  Var_164 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RegionCondCode_36, Var_165);
  Var_163 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveTicketCode_32, Var_164);
  Var_162 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveHpCode_29, Var_163);
  *Code_16 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FlushCode_28, Var_162);
  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  CondGoalInfo_24 = ((MR_Word) ((MR_hl_field(0, CondGoal_12, 1))));
  ...
  {
    MR_Word RbmmInfo_26 = ((MR_Word) ((MR_hl_field(1, MaybeRbmmInfo_25, 0))));
    ...
    hlds__goal_list_util__goal_to_conj_list_2_p_0(CondGoal_12, &CondGoals_27);
    CondCreatedRegionVars_28 = ((MR_Word) ((MR_hl_field(0, RbmmInfo_26, 0))));
    CondRemovedRegionVars_29 = ((MR_Word) ((MR_hl_field(0, RbmmInfo_26, 1))));
    CondCarriedRegionVars_30 = ((MR_Word) ((MR_hl_field(0, RbmmInfo_26, 2))));
    CondAllocRegionVars_31 = ((MR_Word) ((MR_hl_field(0, RbmmInfo_26, 3))));
    ...
    else
    {
      ...
      MR_Word Var_111;
      MR_Word Var_112;
      MR_Word STATE_VARIABLE_CLD_5_117;
      MR_Word STATE_VARIABLE_CLD_6_118;
      MR_Word Var_119;
      MR_Word Var_120;
      MR_Word Var_121;
      MR_Word Var_123;
      ...
      MR_Word Var_127;
      MR_Word Var_129;
      MR_Word STATE_VARIABLE_CLD_7_132;
      MR_Word STATE_VARIABLE_CLD_8_133;
      MR_Word Var_137;
      MR_Word Var_138;
      MR_Word Var_139;
      MR_Word Var_140;
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 775, &FixedSize_47);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 778, &ProtectSize_48);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 779, &SnapshotSize_49);
      ...
      ll_backend__code_loc_dep__acquire_several_temp_slots_10_p_0(Items_51, (MR_Integer) 1, StackVars_17, &MainStackId_52, &FirstSlotNum_53, &LastSlotNum_54, STATE_VARIABLE_CI_0_66, STATE_VARIABLE_CI_67, STATE_VARIABLE_CLD_0_68, &STATE_VARIABLE_CLD_1_84);
      {
      ...
      ll_backend__code_loc_dep__acquire_reg_4_p_0((MR_Integer) 0, &ProtectNumRegLval_57, STATE_VARIABLE_CLD_1_84, &STATE_VARIABLE_CLD_2_86);
      ll_backend__code_loc_dep__acquire_reg_4_p_0((MR_Integer) 0, &SnapshotNumRegLval_58, STATE_VARIABLE_CLD_2_86, &STATE_VARIABLE_CLD_3_88);
      ll_backend__code_loc_dep__acquire_reg_4_p_0((MR_Integer) 0, &AddrRegLval_59, STATE_VARIABLE_CLD_3_88, &STATE_VARIABLE_CLD_4_90);
      {
      ...
      Var_99 = (MR_Word) (MR_mkword(3, &ll_backend__ite_gen_scalar_common_1[6]));
      {
      ...
      }
      {
        ...
        MR_hl_field(0, Var_111, 1) = ((MR_Box) ((MR_String) "Initialize pointer to nonfixed part of embedded frame"));
      }
      {
      ...
      ll_backend__ite_gen__ite_protect_regions_7_p_0(ProtectNumRegLval_57, AddrRegLval_59, EmbeddedStackFrameId_55, ProtectRegionVarList_42, &ProtectRegionCode_61, STATE_VARIABLE_CLD_4_90, &STATE_VARIABLE_CLD_5_117);
      ll_backend__ite_gen__ite_alloc_snapshot_regions_8_p_0(SnapshotNumRegLval_58, AddrRegLval_59, EmbeddedStackFrameId_55, RemovedAtStartOfElse_37, SnapshotRegionVarList_43, &SnapshotRegionCode_62, STATE_VARIABLE_CLD_5_117, &STATE_VARIABLE_CLD_6_118);
      {
      ...
      ll_backend__code_loc_dep__release_reg_3_p_0(ProtectNumRegLval_57, STATE_VARIABLE_CLD_6_118, &STATE_VARIABLE_CLD_7_132);
      ll_backend__code_loc_dep__release_reg_3_p_0(SnapshotNumRegLval_58, STATE_VARIABLE_CLD_7_132, &STATE_VARIABLE_CLD_8_133);
      ll_backend__code_loc_dep__release_reg_3_p_0(AddrRegLval_59, STATE_VARIABLE_CLD_8_133, STATE_VARIABLE_CLD_69);
  ...
  MR_Word * STATE_VARIABLE_CLD_8)
{
  ...
  {
    MR_Word RegionVar_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__5_5, 0))));
    MR_Word RegionVars_21 = ((MR_Word) ((MR_hl_field(1, HeadVar__5_5, 1))));
    MR_Word Code_22;
    MR_Word Codes_23;
    ...
    ll_backend__code_loc_dep__produce_variable_5_p_0(RegionVar_20, &ProduceVarCode_25, &RegionVarRval_26, STATE_VARIABLE_CLD_0_7, &STATE_VARIABLE_CLD_1_31);
    ...
    ll_backend__ite_gen__ite_alloc_snapshot_regions_8_p_0(NumLval_1, AddrLval_2, EmbeddedStackFrameId_3, RemovedVars_4, RegionVars_21, &Codes_23, STATE_VARIABLE_CLD_1_31, STATE_VARIABLE_CLD_8);
  ...
  MR_Word * STATE_VARIABLE_CLD_7)
{
  ...
  else
  {
    ...
    ll_backend__ite_gen__ite_protect_regions_7_p_0(NumLval_1, AddrLval_2, EmbeddedStackFrameId_3, RegionVars_18, &Codes_20, STATE_VARIABLE_CLD_1_27, STATE_VARIABLE_CLD_7);
  ...
  MR_Word * STATE_VARIABLE_Removed_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word GoalExpr_13 = ((MR_Word) ((MR_hl_field(0, Goal_9, 0))));
      ...
      if (succeeded)
      {
        PredId_15 = ((MR_Word) ((MR_hl_field(2, GoalExpr_13, 0))));
        Args_17 = ((MR_Word) ((MR_hl_field(2, GoalExpr_13, 2))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              RegionVar_22 = ((MR_Word) ((MR_hl_field(1, Args_17, 0))));
              Var_27 = ((MR_Word) ((MR_hl_field(1, Args_17, 1))));
      ...
      if (succeeded)
      {
        MR_Word STATE_VARIABLE_Removed_1_28;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_STATE_VARIABLE_Removed_0_3;

        mercury__set__insert_3_p_0((MR_Word) (&ll_backend__ite_gen_scalar_common_1[0]), ((MR_Box) (RegionVar_22)), STATE_VARIABLE_Removed_0_3, &STATE_VARIABLE_Removed_1_28);
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__1_1 = Goals_10;
        next_value_of_STATE_VARIABLE_Removed_0_3 = STATE_VARIABLE_Removed_1_28;
  ...
  MR_Word * PNegElseCode_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 773, &UseMinimalModelStackCopyPNeg_11);
  succeeded = (UseMinimalModelStackCopyPNeg_11 == (MR_Integer) 1);
  if (succeeded)
  {
    Var_22 = (MR_Integer) 20;
  ...
  if (succeeded)
  {
    ...
    {
      MR_String File_14 = ((MR_String) ((MR_hl_field(0, Context_12, 0))));
      MR_Integer Line_15 = ((MR_Integer) ((MR_hl_field(0, Context_12, 1))));
      MR_String Var_24;
      MR_String Var_25;
      MR_String Var_27;
      MR_String Var_28;
    ...
    Var_35 = mercury__string__append_list_1_f_0((MR_Word) (MR_mkword(1, &ll_backend__ite_gen_scalar_common_1[8])));
    {
    ...
    Var_43 = mercury__string__append_list_1_f_0((MR_Word) (MR_mkword(1, &ll_backend__ite_gen_scalar_common_1[10])));
    {
  ...
  MR_String Code_3)
{
...

  {
    ...
    MR_hl_field(1, Var_6, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__ite_gen_scalar_common_1[5])));
  }
  {
  ...
  MR_Word * CondInfo_10)
{
  ...
  {
    *ResumeVars_7 = ((MR_Word) ((MR_hl_field(1, Resume_11, 0))));
    *ResumeLocs_8 = ((MR_Unsigned) ((MR_hl_field(1, Resume_11, 1))) & (MR_Integer) 3);
