...
{
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_71, (MR_Integer) 1)));
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_54, (MR_Integer) 0)));
          }
          if (succeeded)
            {
              ...
              MR_hl_field(MR_mktag(3), Op_35, 1) = (MR_Box) (packed_args_1);
            }
          else
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_13, (MR_Integer) 3)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_35 = ll_backend__ite_gen__wrap_transient_1_f_0((MR_String) "\t\tMR_pneg_enter_cond();\n");
      {
        ...
        MR_hl_field(MR_mktag(3), Var_30, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 2)) | (MR_Unsigned) ((MR_Integer) 1)));
      ...
      Var_43 = ll_backend__ite_gen__wrap_transient_1_f_0((MR_String) "\t\tMR_pneg_enter_then();\n");
      {
        ...
        MR_hl_field(MR_mktag(3), Var_38, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 2)) | (MR_Unsigned) ((MR_Integer) 1)));
      ...
      Var_51 = ll_backend__ite_gen__wrap_transient_1_f_0(Var_52);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_46, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 2)) | (MR_Unsigned) ((MR_Integer) 1)));
      ...
      {
        Var_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 10 * sizeof(MR_Word)), NULL, NULL));
        ...
        MR_hl_field(MR_mktag(3), Var_58, 9) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)));
      }
      {
      ...
      *PNegCondCode_8 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_57)));
      {
        ...
        MR_hl_field(MR_mktag(3), Var_69, 9) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)));
      }
      {
      ...
      *PNegThenCode_9 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_68)));
      {
        Var_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 10 * sizeof(MR_Word)), NULL, NULL));
        ...
        MR_hl_field(MR_mktag(3), Var_80, 9) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)));
      }
      {
...
{
  {
    ...
    else
    {
      ...
      *ResumeVars_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Resume_11, (MR_Integer) 0))));
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_11, (MR_Integer) 1)));
