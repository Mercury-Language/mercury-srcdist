...
{
  {
    ...
    succeeded = ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__385__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    ll_backend__code_loc_dep__generate_branch_end_5_p_0(BranchEndStoreMap_58, (MR_Word) ((MR_Unsigned) 0U), &MaybeEnd0_59, &ThenSaveCode_60, STATE_VARIABLE_CLD_124_124);
    ...
    ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_54, MaybeEnd0_59, &MaybeEnd_67, &ElseSaveCode_68, STATE_VARIABLE_CLD_144_144);
