...
ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__395__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__ite_gen__IntroducedFrom__pred__generate_negation_general__395__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CLD_60)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 371, Goal_12, &SaveHpCode_21, &MaybeHpSlot_22, STATE_VARIABLE_CI_0_57, &STATE_VARIABLE_CI_64_64, STATE_VARIABLE_CLD_62_62, &STATE_VARIABLE_CLD_65_65);
  ...
  MR_Word * STATE_VARIABLE_CLD_83)
{
  ...
  ll_backend__code_loc_dep__ite_maybe_save_hp_8_p_0((MR_Integer) 371, CondGoal_26, &SaveHpCode_29, &MaybeHpSlot_30, STATE_VARIABLE_CI_0_80, &STATE_VARIABLE_CI_88_88, STATE_VARIABLE_CLD_86_86, &STATE_VARIABLE_CLD_89_89);
  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 356, &FixedSize_47);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 359, &ProtectSize_48);
      libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 360, &SnapshotSize_49);
  ...
  MR_Word * PNegElseCode_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 353, &UseMinimalModelStackCopyPNeg_11);
