...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file_stream__199__1_5_p_0(
  MR_Word Action0_11,
  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 676, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 677, &InstallNamePath0_8);
  succeeded = (strcmp(InstallNamePath0_8, (MR_String) "") == 0);
  if (succeeded)
  {
    MR_String GradeDir_9;

    libs__compute_grade__grade_directory_component_2_p_0(Globals_4, &GradeDir_9);
  ...
  MR_String * InstallNamePath_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 690, &InstallPrefix_7);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  libs__file_util__IntroducedFrom__pred__output_to_file_stream__199__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_41);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 86, &Stats_15);
  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 76, &Verbose_16);
  ...
  {
    MR_Word IOError_20 = ((MR_Word) ((MR_hl_field(1, OpenFileResult_18, (MR_Integer) 0))));
  ...
  {
    MR_Word FileStream_19 = ((MR_Word) ((MR_hl_field(0, OpenFileResult_18, (MR_Integer) 0))));
