...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file_stream__152__1_5_p_0(
  MR_Word Action0_11,
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  libs__file_util__IntroducedFrom__pred__output_to_file_stream__152__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_41);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 82, &Stats_15);
