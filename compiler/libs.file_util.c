...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file_stream__350__1_5_p_0(
  MR_Word Action0_9,
  MR_Word FileStream_15,
...
static void MR_CALL 
libs__file_util__output_to_file_stream_6_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
libs__file_util__output_to_file_stream_6_p_0_1(
  MR_Box closure_arg,
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static /* final */ const MR_Box libs__file_util_scalar_common_3[1][6];

static /* final */ const MR_Box libs__file_util_scalar_common_4[3][3];
...
static /* final */ const MR_Box libs__file_util_scalar_common_4[3][3] = {
  /* row 0 */
  {
    ((MR_Box) (&libs__file_util_scalar_common_3[0])),
    ((MR_Box) (libs__file_util__output_to_file_stream_6_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 1 */
  {
...
{
  {
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Action0_9, (MR_Integer) 1))));
    MR_Box conv2_LambdaHeadVar__1_45;
    MR_Box conv1_LambdaHeadVar__3_47;

    func_0(((MR_Box) (Action0_9)), ((MR_Box) (FileStream_15)), &conv2_LambdaHeadVar__1_45, ((MR_Box) ((MR_Integer) 0)), &conv1_LambdaHeadVar__3_47);
    *LambdaHeadVar__1_45 = ((MR_Word) (conv2_LambdaHeadVar__1_45));
  }
}
...
{
  {
    ...
    Var_13 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&libs__file_util_scalar_common_4[2]), Var_15);
...
{
  {
    ...
    Var_13 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&libs__file_util_scalar_common_4[1]), Var_15);
    Command_8 = mercury__string__join_list_2_f_0((MR_String) "   ", Var_13);
    return Command_8;
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_LambdaHeadVar__1_45;

    libs__file_util__IntroducedFrom__pred__output_to_file_stream__350__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_45);
    *wrapper_arg_1 = ((MR_Box) (conv0_LambdaHeadVar__1_45));
  }
}

void MR_CALL 
libs__file_util__output_to_file_stream_6_p_0(
  MR_Word Globals_7,
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 75, &Stats_13);
    switch (Verbose_12) {
    ...
    {
      MR_String ErrorMessage_26;
      MR_String Var_69;

      libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "\n");
      Var_69 = mercury__string__f_43_43_2_f_0(FileName_8, (MR_String) "\' for output.");
      ErrorMessage_26 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open file \140", Var_69);
      libs__file_util__report_error_3_p_0(ErrorMessage_26);
    ...
    else
    {
      ...
      MR_Word Action_16;
      MR_Word TryResult_20;

      {
        Action_16 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Action_16, 0) = ((MR_Box) (&libs__file_util_scalar_common_2[0]));
        MR_hl_field(MR_mktag(0), Action_16, 1) = ((MR_Box) (libs__file_util__output_to_file_stream_6_p_0_1));
        MR_hl_field(MR_mktag(0), Action_16, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Action_16, 3) = ((MR_Box) (Action0_9));
        MR_hl_field(MR_mktag(0), Action_16, 4) = ((MR_Box) (FileStream_15));
      }
      mercury__exception__try_io_4_p_0((MR_Word) (&libs__file_util_scalar_common_1[0]), Action_16, &TryResult_20);
      ...
      if (((MR_tag((MR_Word) TryResult_20)) == (MR_Integer) 2))
        {
          mercury__exception__rethrow_1_p_0((MR_Word) (&libs__file_util_scalar_common_1[0]), TryResult_20);
          return;
        }
      else
      {
        MR_Word Errors_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TryResult_20, (MR_Integer) 0))));

        if ((Errors_21 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        else
        {
          ...
          libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "\n");
          mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), (MR_Word) (&libs__file_util_scalar_common_4[0]), Errors_21, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_28);
          *Succeeded_10 = (MR_Integer) 0;
        }
      }
    }
