...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 621, &libs__file_util__InstallNameFlag_7);
    libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 622, &libs__file_util__InstallNamePath0_8);
    ...
    if (libs__file_util__succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 635, &libs__file_util__InstallPrefix_9);
