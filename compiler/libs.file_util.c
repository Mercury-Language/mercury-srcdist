...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 618, &libs__file_util__InstallNameFlag_7);
    }
    {
      libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 619, &libs__file_util__InstallNamePath0_8);
    }
    ...
    if (libs__file_util__succeeded)
      {
        ...
        {
          libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 632, &libs__file_util__InstallPrefix_9);
        }
        {
    ...
    if (((MR_tag((MR_Word) libs__file_util__Res_14)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), libs__file_util__Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__file_util_scalar_common_2[0])));
        }
        {
          libs__file_util__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
