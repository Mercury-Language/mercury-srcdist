...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file__276__1_4_p_0(
...
{
  {
    ...
    {
      libs__file_util__IntroducedFrom__pred__output_to_file__276__1_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__closure, (MR_Integer) 3))), &libs__file_util__conv0_LambdaHeadVar__1_19);
    }
