  ...
  MR_Word * MaybeCompare_8)
{
  ...
  if (succeeded)
  {
    TimeA_12 = ((MR_Word) ((MR_hl_field(0, TimeResultA_10, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) TimeResultB_11)) == (MR_Integer) 0);
    if (succeeded)
      TimeB_13 = ((MR_Word) ((MR_hl_field(0, TimeResultB_11, (MR_Integer) 0))));
  }
  if (succeeded)
  {
    MR_Word Compare_14;
  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 678, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 679, &InstallNamePath0_8);
  ...
  MR_String * InstallNamePath_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 692, &InstallPrefix_7);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  libs__file_util__IntroducedFrom__pred__output_to_file_stream__209__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_41);
  ...
  MR_Word * Succeeded_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 88, &Stats_15);
  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 78, &Verbose_16);
