...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file_stream__159__1_5_p_0(
  MR_Word Action0_11,
  ...
  MR_Word * Result_4)
{
  ...
  if (((MR_tag((MR_Word) TempFileResult_6)) == (MR_Integer) 1))
  {
    MR_String Var_31;
    MR_String Var_35;
    MR_Word Error_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TempFileResult_6, (MR_Integer) 0))));
  ...
  {
    MR_String TempFileName_15 = ((MR_String) ((MR_hl_field(MR_mktag(0), TempFileResult_6, (MR_Integer) 0))));
    ...
    {
      MR_Word Error_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_16, (MR_Integer) 0))));
      MR_String Var_23;
      MR_String Var_29;
      MR_String Var_39;
      MR_String Var_40;
      ...
      mercury__io__file__remove_file_4_p_0(TempFileName_15, &Var_19);
      Var_29 = mercury__io__error_message_1_f_0(Error_18);
      Var_39 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", Var_29);
      Var_40 = mercury__string__f_43_43_2_f_0(TempFileName_15, Var_39);
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (TempFileName_15));
        MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (Stream_17));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) TempFileResult_12)) == (MR_Integer) 1))
  {
    MR_String Var_37;
    MR_String Var_41;
    MR_Word Error_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TempFileResult_12, (MR_Integer) 0))));

    Var_41 = mercury__io__error_message_1_f_0(Error_43);
    Var_37 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", Var_41);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_10 = base;
  ...
  {
    MR_String TempFileName_21 = ((MR_String) ((MR_hl_field(MR_mktag(0), TempFileResult_12, (MR_Integer) 0))));
    MR_Word OpenResult_22;

    mercury__io__open_output_4_p_0(TempFileName_21, &OpenResult_22);
    if (((MR_tag((MR_Word) OpenResult_22)) == (MR_Integer) 1))
    {
      MR_Word Error_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_22, (MR_Integer) 0))));
      MR_String Var_29;
      MR_String Var_35;
      MR_String Var_45;
      MR_String Var_46;
      ...
      mercury__io__file__remove_file_4_p_0(TempFileName_21, &Var_25);
      Var_35 = mercury__io__error_message_1_f_0(Error_24);
      Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", Var_35);
      Var_46 = mercury__string__f_43_43_2_f_0(TempFileName_21, Var_45);
      Var_29 = mercury__string__f_43_43_2_f_0((MR_String) "could not open temporary file \140", Var_46);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_10 = base;
    ...
    {
      MR_Word Stream_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_22, (MR_Integer) 0))));
      MR_Tuple Var_27;

      {
        Var_27 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (TempFileName_21));
        MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (Stream_23));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 649, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 650, &InstallNamePath0_8);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 663, &InstallPrefix_9);
  ...
  MR_Word * Res_8)
{
  ...
  if (((MR_tag((MR_Word) MaybeFileType_11)) == (MR_Integer) 1))
  {
    ...
    Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_38);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Res_8 = base;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_21 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_74);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Res_8 = base;
    ...
    else
    {
      ...
      Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_86);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Res_8 = base;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  libs__file_util__IntroducedFrom__pred__output_to_file_stream__159__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_44);
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__get_error_output_stream_5_p_0(Globals_8, ModuleName_9, &ErrorStream_28);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&libs__file_util_scalar_common_3[0]));
