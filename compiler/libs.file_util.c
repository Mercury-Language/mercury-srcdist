...
{
  {
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), Action_9, (MR_Integer) 1)));
    MR_Box conv1_LambdaHeadVar__3_21;

    func_0(((MR_Box) Action_9), ((MR_Box) ((MR_Integer) 0)), &conv1_LambdaHeadVar__3_21);
    *LambdaHeadVar__1_19 = (MR_Integer) 0;
  }
}
    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        mercury__io____Compare____input_stream_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) ReadRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_Word Error_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), ReadRes_10, (MR_Integer) 1)));
      MR_String _Partial_12 = ((MR_String) (MR_hl_field(MR_mktag(1), ReadRes_10, (MR_Integer) 0)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) TempFileResult_8)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Var_20;
      MR_String Var_24;
    ...
    else
    {
      ...
      if ((PredResult_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) TempFileResult_6)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Var_21;
      MR_String Var_25;
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) OpenResult_17)) == (MR_mktag((MR_Integer) 1))))
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) TempFileResult_12)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Var_27;
      MR_String Var_31;
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) OpenResult_23)) == (MR_mktag((MR_Integer) 1))))
      {
      ...
      else
      {
        ...
        {
          Var_43 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if ((FileInstallCmd_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    Var_13 = mercury__list__map_2_f_0(TypeCtorInfo_20_20, TypeCtorInfo_20_20, (MR_Word) &libs__file_util_scalar_common_5[1], Var_15);
...
{
  {
    ...
    {
      MR_String _InstallCmdDirOpt_11;

      InstallCmd_10 = ((MR_String) (MR_hl_field(MR_mktag(1), FileInstallCmd_9, (MR_Integer) 0)));
      _InstallCmdDirOpt_11 = ((MR_String) (MR_hl_field(MR_mktag(1), FileInstallCmd_9, (MR_Integer) 1)));
    }
    ...
    Var_13 = mercury__list__map_2_f_0(TypeCtorInfo_19_19, TypeCtorInfo_19_19, (MR_Word) &libs__file_util_scalar_common_5[0], Var_15);
    Command_8 = mercury__string__join_list_2_f_0((MR_String) "   ", Var_13);
    return Command_8;
  }
}
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 627, &InstallNameFlag_7);
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 628, &InstallNamePath0_8);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 641, &InstallPrefix_9);
...
{
  {
    ...
    mercury__io__output_stream_3_p_0(&OutputStream_6);
    libs__file_util__write_include_file_contents_4_p_0(OutputStream_6, FileName_4);
  }
}
...
{
  {
    ...
    mercury__io__file_type_5_p_0((MR_Integer) 1, FileName_6, &MaybeType_9);
    if (((MR_tag((MR_Word) MaybeType_9)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_Word Error_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeType_9, (MR_Integer) 0)));
      MR_String Msg_12;
      MR_String Var_17;
      MR_Word Var_18;

      Var_17 = mercury__io__error_message_1_f_0(Error_11);
      Msg_12 = mercury__string__remove_prefix_if_present_2_f_0((MR_String) "can\'t find file type: ", Var_17);
      {
        Var_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (FileName_6));
        MR_hl_field(MR_mktag(0), Var_18, 1) = ((MR_Box) (Msg_12));
      }
      {
        mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (Var_18)));
        return;
      }
    }
    else
    {
      MR_Word Type_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeType_9, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        ...
        mercury__io__open_input_4_p_0(FileName_6, &OpenRes_29);
        if (((MR_tag((MR_Word) OpenRes_29)) == (MR_mktag((MR_Integer) 1))))
        {
          MR_Word Var_35;
          MR_String Var_36;
          MR_Word Error_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), OpenRes_29, (MR_Integer) 0)));

          Var_36 = mercury__io__error_message_1_f_0(Error_42);
          {
            Var_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (FileName_6));
            MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (Var_36));
          }
          {
            mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (Var_35)));
            return;
          }
        }
        else
        {
          MR_Word InputStream_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), OpenRes_29, (MR_Integer) 0)));
          MR_Word TryResult_31;
          MR_Word Var_37;

          {
            Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&libs__file_util_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (libs__file_util__write_include_file_contents_4_p_0_1));
            MR_hl_field(MR_mktag(0), Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (InputStream_30));
            MR_hl_field(MR_mktag(0), Var_37, 4) = ((MR_Box) (OutputStream_5));
          }
          mercury__exception__try_io_4_p_0((MR_Word) &mercury__io__io__type_ctor_info_res_0, Var_37, &TryResult_31);
          mercury__io__close_input_3_p_0(InputStream_30);
          if (((MR_tag((MR_Word) TryResult_31)) == (MR_mktag((MR_Integer) 2))))
          {
            {
              mercury__exception__rethrow_1_p_0((MR_Word) &mercury__io__io__type_ctor_info_res_0, TryResult_31);
              return;
            }
          }
          else
          {
            MR_Word Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), TryResult_31, (MR_Integer) 0)));

            if (!((Var_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
            {
              MR_Word Error_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_50, (MR_Integer) 0)));

              {
                mercury__exception__throw_1_p_0((MR_Word) &mercury__io__io__type_ctor_info_error_0, ((MR_Box) (Error_32)));
                return;
              }
            }
          }
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (FileName_6));
          MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) ((MR_String) "Not a regular file"));
        }
        {
          mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (Var_20)));
          return;
        }
      }
    }
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Integer conv0_LambdaHeadVar__1_19;

    libs__file_util__IntroducedFrom__pred__output_to_file__338__1_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), &conv0_LambdaHeadVar__1_19);
    *wrapper_arg_1 = ((MR_Box) (conv0_LambdaHeadVar__1_19));
  }
}
...
{
  {
    MR_Word ActionReturnDummy_12;
    MR_Word Result_13;

    {
      ActionReturnDummy_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ActionReturnDummy_12, 0) = ((MR_Box) (&libs__file_util_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), ActionReturnDummy_12, 1) = ((MR_Box) (libs__file_util__output_to_file_6_p_0_1));
      MR_hl_field(MR_mktag(0), ActionReturnDummy_12, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), ActionReturnDummy_12, 3) = ((MR_Box) (Action_9));
    }
    libs__file_util__output_to_file_return_result_6_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, Globals_7, FileName_8, ActionReturnDummy_12, &Result_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 69, &Stats_13);
    switch (Verbose_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    if (((MR_tag((MR_Word) Res_14)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "\n");
      {
        ...
        MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (FileName_8));
        MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__file_util_scalar_common_1[0])));
      }
      {
        Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) ((MR_String) "can\'t open file \140"));
        MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (Var_41));
      }
      mercury__string__append_list_2_p_0(Var_39, &ErrorMessage_62);
      libs__file_util__report_error_3_p_0(ErrorMessage_62);
    ...
    else
    {
      ...
      mercury__exception__try_io_4_p_0(TypeInfo_for_T_63, Action_9, &TryResult_17);
      ...
      if (((MR_tag((MR_Word) TryResult_17)) == (MR_mktag((MR_Integer) 2))))
      {
        MR_Word Univ_20 = ((MR_Word) (MR_hl_field(MR_mktag(2), TryResult_17, (MR_Integer) 0)));
        MR_Word IncludeError_21;
        MR_Box conv0_IncludeError_21;

        succeeded = mercury__univ__univ_to_type_2_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, Univ_20, &conv0_IncludeError_21);
        if (succeeded)
        {
          IncludeError_21 = ((MR_Word) conv0_IncludeError_21);
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          MR_String IncludeFileName_22 = ((MR_String) (MR_hl_field(MR_mktag(0), IncludeError_21, (MR_Integer) 0)));
          MR_String Detail_23 = ((MR_String) (MR_hl_field(MR_mktag(0), IncludeError_21, (MR_Integer) 1)));
          MR_String ErrorMessage_24;
          MR_String Var_66;
          MR_String Var_67;

          Var_66 = mercury__string__f_43_43_2_f_0((MR_String) "\' for input: ", Detail_23);
          Var_67 = mercury__string__f_43_43_2_f_0(IncludeFileName_22, Var_66);
          ErrorMessage_24 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_67);
          libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "\n");
          ...
          *Result_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          {
            mercury__exception__rethrow_1_p_0(TypeInfo_for_T_63, TryResult_17);
            return;
          }
      }
      else
      {
        MR_Box ActionResult_19 = (MR_hl_field(MR_mktag(1), TryResult_17, (MR_Integer) 0));

        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *Result_10 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ActionResult_19;
        }
      }
    }
  }
  ...
  MR_Word * MaybeModTime_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) MaybeHeadModTime_16)) == (MR_mktag((MR_Integer) 1))))
      {
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeDirPathNameAndStream_10)) == (MR_mktag((MR_Integer) 1))))
  ...
  MR_Word * MaybeDirNameAndStream_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) MaybeHeadStream_16)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word next_value_of_Dirs_8 = TailDirs_14;
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeFilePathNameAndStream_10)) == (MR_mktag((MR_Integer) 1))))
...
{
  {
    ...
    succeeded = libs__file_util____Unify____include_file_error_0_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__file_util____Compare____include_file_error_0_0(&conv0_HeadVar__1_1, ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3));
    *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
  }
}
