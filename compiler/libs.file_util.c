...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 639, &InstallNameFlag_7);
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 640, &InstallNamePath0_8);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 653, &InstallPrefix_9);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 71, &Stats_13);
    switch (Verbose_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
