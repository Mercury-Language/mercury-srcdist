...
libs__file_util__report_cannot_open_file_for_output_6_p_0(
  ...
  MR_Word IOError_10)
{
  MR_String IOErrorMsr_12;
  MR_String Msg_13;

  IOErrorMsr_12 = mercury__io__error_message_1_f_0(IOError_10);
  Msg_13 = libs__file_util__msg_for_cannot_open_file_for_output_3_f_0(Globals_8, FileName_9, IOErrorMsr_12);
  mercury__io__write_string_4_p_0(ProgressStream_7, Msg_13);
  ...
  MR_Word IOError_10)
{
  ...
  IOErrorMsr_12 = mercury__io__error_message_1_f_0(IOError_10);
  Msg_13 = libs__file_util__msg_for_cannot_open_file_for_input_3_f_0(Globals_8, FileName_9, IOErrorMsr_12);
  mercury__io__write_string_4_p_0(ProgressStream_7, Msg_13);
  mercury__io__write_string_4_p_0(ProgressStream_7, (MR_String) "\n");
  mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
}
  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 546, &InstallNamePath0_8);
  ...
  MR_String * InstallNamePath_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 572, &InstallPrefix_7);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) MaybeFileType_13)) == (MR_Integer) 1))
  {
    ...
    ErrorMsg_28 = mercury__string__remove_prefix_if_present_2_f_0((MR_String) "can\'t find file type: ", Var_26);
    Msg_29 = libs__file_util__msg_for_cannot_open_file_for_input_3_f_0(Globals_8, FileName_9, ErrorMsg_28);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_10 = base;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      mercury__io__open_input_4_p_0(FileName_9, &OpenRes_30);
      if (((MR_tag((MR_Word) OpenRes_30)) == (MR_Integer) 1))
      {
        MR_Word Error_36 = ((MR_Word) ((MR_hl_field(1, OpenRes_30, 0))));

        {
          CopyResult_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, CopyResult_15, 0) = ((MR_Box) (Error_36));
        }
      }
      else
      {
        MR_Word InputStream_31 = ((MR_Word) ((MR_hl_field(0, OpenRes_30, 0))));
        MR_Word TryResult_32;
        MR_Word Var_34;

        {
          Var_34 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_34, 0) = ((MR_Box) (&libs__file_util_scalar_common_2[1]));
          MR_hl_field(0, Var_34, 1) = ((MR_Box) (libs__file_util__write_include_file_contents_6_p_0_1));
          MR_hl_field(0, Var_34, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_34, 3) = ((MR_Box) (InputStream_31));
          MR_hl_field(0, Var_34, 4) = ((MR_Box) (OutputStream_7));
        }
        mercury__exception__try_io_4_p_0((MR_Word) (&mercury__io__io__type_ctor_info_res_0), Var_34, &TryResult_32);
        mercury__io__close_input_3_p_0(InputStream_31);
        if (((MR_tag((MR_Word) TryResult_32)) == (MR_Integer) 2))
          {
            mercury__exception__rethrow_1_p_0((MR_Word) (&mercury__io__io__type_ctor_info_res_0), TryResult_32);
            return;
          }
        else
        {
          MR_Word Var_39 = ((MR_Word) ((MR_hl_field(1, TryResult_32, 0))));

          if ((Var_39 == (MR_Word) ((MR_Unsigned) 0U)))
            CopyResult_15 = (MR_Word) ((MR_Unsigned) 0U);
          else
            CopyResult_15 = Var_39;
        }
      }
      ...
      else
      {
        ...
        Msg_18 = libs__file_util__msg_for_cannot_open_file_for_input_3_f_0(Globals_8, FileName_9, ErrorMsg_17);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Result_10 = base;
    ...
    else
    {
      ...
      Msg_27 = libs__file_util__msg_for_cannot_open_file_for_input_3_f_0(Globals_8, FileName_9, (MR_String) "Not a regular file");
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_10 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (Msg_27));
      }
    }
  }
}
...
MR_String MR_CALL 
libs__file_util__msg_for_cannot_open_file_for_input_3_f_0(
  MR_Word Globals_5,
  MR_String FileName_6,
  MR_String ErrorMsg_7)
{
  ...
  Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "\' for input: ", ErrorMsg_7);
  Var_18 = mercury__string__f_43_43_2_f_0(FileName_6, Var_17);
  Msg0_9 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_18);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 685, &Canon_20);
  switch (Canon_20) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      Msg_8 = Msg0_9;
    ...
    case (MR_Integer) 1:
      {
        MR_Word QuoteChunks0_21;
        MR_Word QuoteChunks_22;

        QuoteChunks0_21 = mercury__string__split_at_char_2_f_0((MR_Char) 39, Msg0_9);
        libs__file_util__canonicalize_quote_chunks_2_p_0(QuoteChunks0_21, &QuoteChunks_22);
        Msg_8 = mercury__string__join_list_2_f_0((MR_String) "\'", QuoteChunks_22);
      }
      break;
  }
  return Msg_8;
  ...
  MR_Word * Succeeded_12)
{
  ...
  if (((MR_tag((MR_Word) OpenResult_17)) == (MR_Integer) 1))
  {
    ...
    IOErrorMsr_91 = mercury__io__error_message_1_f_0(IOError_28);
    Msg_92 = libs__file_util__msg_for_cannot_open_file_for_output_3_f_0(Globals_9, FileName_10, IOErrorMsr_91);
    mercury__io__write_string_4_p_0(ProgressStream_8, Msg_92);
    mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "\n");
    mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_8, Verbose_14, (MR_String) "\n");
        {
  ...
  MR_Word * Succeeded_14)
{
  ...
  if (((MR_tag((MR_Word) OpenFileResult_18)) == (MR_Integer) 1))
  {
    ...
    IOErrorMsr_67 = mercury__io__error_message_1_f_0(IOError_20);
    Msg_68 = libs__file_util__msg_for_cannot_open_file_for_output_3_f_0(Globals_10, FileName_12, IOErrorMsr_67);
    mercury__io__write_string_4_p_0(ProgressStream_9, Msg_68);
...
MR_String MR_CALL 
libs__file_util__msg_for_cannot_open_file_for_output_3_f_0(
  MR_Word Globals_5,
  MR_String FileName_6,
  MR_String ErrorMsg_7)
{
  ...
  Var_17 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", ErrorMsg_7);
  Var_18 = mercury__string__f_43_43_2_f_0(FileName_6, Var_17);
  Msg0_9 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", Var_18);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 685, &Canon_20);
  switch (Canon_20) {
