  ...
  MR_Word IOError_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 687, &Canon_35);
  switch (Canon_35) {
  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 629, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 548, &InstallNamePath0_8);
  ...
  MR_String * InstallNamePath_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 574, &InstallPrefix_7);
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) MaybeFileType_13)) == (MR_Integer) 1))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 687, &Canon_43);
    switch (Canon_43) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Msg_32 = Msg0_31;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 687, &Canon_69);
        switch (Canon_69) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            Msg_19 = Msg0_18;
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 687, &Canon_85);
      switch (Canon_85) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Msg_29 = Msg0_28;
