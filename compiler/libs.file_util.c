  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 602, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 521, &InstallNamePath0_8);
  ...
  MR_String * InstallNamePath_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 547, &InstallPrefix_7);
