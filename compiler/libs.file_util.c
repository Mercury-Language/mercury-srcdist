...
static void MR_CALL 
libs__file_util__IntroducedFrom__pred__output_to_file_stream__364__1_5_p_0(
  MR_Word Action0_11,
...
{
  {
    ...
    libs__file_util__IntroducedFrom__pred__output_to_file_stream__364__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), &conv0_LambdaHeadVar__1_52);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 75, &Stats_15);
