...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 645, &InstallNamePath0_8);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 658, &InstallPrefix_9);
