...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(libs__file_util__Globals_7, (MR_Integer) 54, &libs__file_util__Verbose_12);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(libs__file_util__Globals_7, (MR_Integer) 64, &libs__file_util__Stats_13);
    }
