...
static /* final */ const MR_Box libs__file_util_scalar_common_2[1][7];
...
{
  {
    ...
    {
      MR_String libs__file_util__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 0)));
      MR_String libs__file_util__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word libs__file_util__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word libs__file_util__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word libs__file_util__Var_8;

      mercury__private_builtin__builtin_compare_string_3_p_0(&libs__file_util__Var_8, libs__file_util__ArgX1_4, libs__file_util__ArgY1_5);
      libs__file_util__succeeded = (libs__file_util__Var_8 == (MR_Integer) 0);
      libs__file_util__succeeded = !(libs__file_util__succeeded);
      if (libs__file_util__succeeded)
        *libs__file_util__HeadVar__1_1 = libs__file_util__Var_8;
      else
        mercury__io____Compare____input_stream_0_0(libs__file_util__HeadVar__1_1, libs__file_util__ArgX2_6, libs__file_util__ArgY2_7);
    }
  }
}
...
{
  {
    ...
    {
      MR_String libs__file_util__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__1_1, (MR_Integer) 0)));
      MR_String libs__file_util__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word libs__file_util__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word libs__file_util__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 1)));

      libs__file_util__succeeded = (strcmp(libs__file_util__ArgX1_3, libs__file_util__ArgY1_4) == 0);
      if (libs__file_util__succeeded)
        libs__file_util__succeeded = mercury__io____Unify____input_stream_0_0(libs__file_util__ArgX2_5, libs__file_util__ArgY2_6);
    }
...
{
  {
    ...
    else
    {
      MR_String libs__file_util__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 0)));
      MR_String libs__file_util__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__3_3, (MR_Integer) 0)));
      MR_String libs__file_util__ArgX2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 1)));
      MR_String libs__file_util__ArgY2_7 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word libs__file_util__Var_8;
      ...
      if (libs__file_util__succeeded)
        *libs__file_util__HeadVar__1_1 = libs__file_util__Var_8;
        ...
        mercury__private_builtin__builtin_compare_string_3_p_0(libs__file_util__HeadVar__1_1, libs__file_util__ArgX2_6, libs__file_util__ArgY2_7);
    }
  }
}
...
{
  {
    ...
    else
    {
      MR_String libs__file_util__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__1_1, (MR_Integer) 0)));
      MR_String libs__file_util__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 0)));
      MR_String libs__file_util__ArgX2_5 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__1_1, (MR_Integer) 1)));
      MR_String libs__file_util__ArgY2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__HeadVar__2_2, (MR_Integer) 1)));

      libs__file_util__succeeded = (strcmp(libs__file_util__ArgX1_3, libs__file_util__ArgY1_4) == 0);
      if (libs__file_util__succeeded)
        libs__file_util__succeeded = (strcmp(libs__file_util__ArgX2_5, libs__file_util__ArgY2_6) == 0);
    }
    return libs__file_util__succeeded;
  }
}
...
{
  {
    ...
    {
      MR_String libs__file_util__Var_20;
      MR_String libs__file_util__Var_24;
      MR_Word libs__file_util__Error_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__TempFileResult_8, (MR_Integer) 0)));

      libs__file_util__Var_24 = mercury__io__error_message_1_f_0(libs__file_util__Error_39);
      libs__file_util__Var_20 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", libs__file_util__Var_24);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        *libs__file_util__Result_5 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (libs__file_util__Var_20));
      }
    }
    else
    {
      ...
      if ((libs__file_util__PredResult_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if (((MR_tag((MR_Word) libs__file_util__OpenResult_11)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          MR_String libs__file_util__Var_29;
          MR_String libs__file_util__Var_35;
          MR_String libs__file_util__Var_41;
          MR_String libs__file_util__Var_42;
          MR_Word libs__file_util__Var_14;

          libs__file_util__Var_35 = mercury__io__error_message_1_f_0(libs__file_util__Error_13);
          libs__file_util__Var_41 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", libs__file_util__Var_35);
          libs__file_util__Var_42 = mercury__string__f_43_43_2_f_0(libs__file_util__TempFileName_9, libs__file_util__Var_41);
          libs__file_util__Var_29 = mercury__string__f_43_43_2_f_0((MR_String) "could not open \140", libs__file_util__Var_42);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *libs__file_util__Result_5 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (libs__file_util__Var_29));
          }
          mercury__io__remove_file_4_p_0(libs__file_util__TempFileName_9, &libs__file_util__Var_14);
        }
        else
        {
          MR_Word libs__file_util__Stream_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__OpenResult_11, (MR_Integer) 0)));
          MR_Tuple libs__file_util__Var_38;

          {
            libs__file_util__Var_38 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), libs__file_util__Var_38, 0) = ((MR_Box) (libs__file_util__TempFileName_9));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_38, 1) = ((MR_Box) (libs__file_util__Stream_12));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *libs__file_util__Result_5 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (libs__file_util__Var_38));
          }
        }
      }
      else
      {
        ...
        MR_Word libs__file_util__Var_16;

        mercury__io__remove_file_4_p_0(libs__file_util__TempFileName_9, &libs__file_util__Var_16);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *libs__file_util__Result_5 = base;
...
{
  {
    ...
    {
      MR_String libs__file_util__Var_21;
      MR_String libs__file_util__Var_25;
      MR_Word libs__file_util__Error_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__TempFileResult_6, (MR_Integer) 0)));

      libs__file_util__Var_25 = mercury__io__error_message_1_f_0(libs__file_util__Error_38);
      libs__file_util__Var_21 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", libs__file_util__Var_25);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        *libs__file_util__Result_4 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (libs__file_util__Var_21));
      }
    }
    else
    {
      ...
      if (((MR_tag((MR_Word) libs__file_util__OpenResult_17)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String libs__file_util__Var_29;
        MR_String libs__file_util__Var_35;
        MR_String libs__file_util__Var_40;
        MR_String libs__file_util__Var_41;
        MR_Word libs__file_util__Var_20;

        mercury__io__remove_file_4_p_0(libs__file_util__TempFileName_16, &libs__file_util__Var_20);
        libs__file_util__Var_35 = mercury__io__error_message_1_f_0(libs__file_util__Error_19);
        libs__file_util__Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", libs__file_util__Var_35);
        libs__file_util__Var_41 = mercury__string__f_43_43_2_f_0(libs__file_util__TempFileName_16, libs__file_util__Var_40);
        libs__file_util__Var_29 = mercury__string__f_43_43_2_f_0((MR_String) "could not open temporary file \140", libs__file_util__Var_41);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *libs__file_util__Result_4 = base;
      ...
      else
      {
        ...
        MR_Tuple libs__file_util__Var_37;

        {
          libs__file_util__Var_37 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 0) = ((MR_Box) (libs__file_util__TempFileName_16));
          MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 1) = ((MR_Box) (libs__file_util__Stream_18));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          *libs__file_util__Result_4 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (libs__file_util__Var_37));
        }
      }
    }
  }
...
{
  {
    ...
    {
      MR_String libs__file_util__Var_27;
      MR_String libs__file_util__Var_31;
      MR_Word libs__file_util__Error_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__TempFileResult_12, (MR_Integer) 0)));

      libs__file_util__Var_31 = mercury__io__error_message_1_f_0(libs__file_util__Error_44);
      libs__file_util__Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", libs__file_util__Var_31);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        *libs__file_util__Result_10 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (libs__file_util__Var_27));
      }
    }
    else
    {
      ...
      if (((MR_tag((MR_Word) libs__file_util__OpenResult_23)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String libs__file_util__Var_35;
        MR_String libs__file_util__Var_41;
        MR_String libs__file_util__Var_46;
        MR_String libs__file_util__Var_47;
        MR_Word libs__file_util__Var_26;

        mercury__io__remove_file_4_p_0(libs__file_util__TempFileName_22, &libs__file_util__Var_26);
        libs__file_util__Var_41 = mercury__io__error_message_1_f_0(libs__file_util__Error_25);
        libs__file_util__Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", libs__file_util__Var_41);
        libs__file_util__Var_47 = mercury__string__f_43_43_2_f_0(libs__file_util__TempFileName_22, libs__file_util__Var_46);
        libs__file_util__Var_35 = mercury__string__f_43_43_2_f_0((MR_String) "could not open temporary file \140", libs__file_util__Var_47);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          *libs__file_util__Result_10 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (libs__file_util__Var_35));
        }
      }
      else
      {
        MR_Word libs__file_util__Stream_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__OpenResult_23, (MR_Integer) 0)));
        MR_Tuple libs__file_util__Var_43;

        {
          libs__file_util__Var_43 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), libs__file_util__Var_43, 0) = ((MR_Box) (libs__file_util__TempFileName_22));
          MR_hl_field(MR_mktag(0), libs__file_util__Var_43, 1) = ((MR_Box) (libs__file_util__Stream_24));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          *libs__file_util__Result_10 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (libs__file_util__Var_43));
        }
      }
    }
  }
...
{
  {
    ...
    MR_Word libs__file_util__Var_13;
    MR_Word libs__file_util__Var_15;
    MR_Word libs__file_util__Var_16;
    MR_Word libs__file_util__Var_17;
    MR_Word libs__file_util__Var_18;
    ...
    {
      libs__file_util__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_18, 0) = ((MR_Box) (libs__file_util__InstallDir_7));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      libs__file_util__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_17, 0) = ((MR_Box) (libs__file_util__SourceDirName_6));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_17, 1) = ((MR_Box) (libs__file_util__Var_18));
    }
    {
      libs__file_util__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_16, 0) = ((MR_Box) (libs__file_util__InstallCmdDirOpt_11));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_16, 1) = ((MR_Box) (libs__file_util__Var_17));
    }
    {
      libs__file_util__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_15, 0) = ((MR_Box) (libs__file_util__InstallCmd_10));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_15, 1) = ((MR_Box) (libs__file_util__Var_16));
    }
    libs__file_util__Var_13 = mercury__list__map_2_f_0(libs__file_util__TypeCtorInfo_20_20, libs__file_util__TypeCtorInfo_20_20, (MR_Word) &libs__file_util_scalar_common_5[1], libs__file_util__Var_15);
    libs__file_util__Command_8 = mercury__string__join_list_2_f_0((MR_String) "   ", libs__file_util__Var_13);
...
{
  {
    ...
    {
      libs__file_util__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_17, 0) = ((MR_Box) (libs__file_util__InstallDir_7));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      libs__file_util__Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_16, 0) = ((MR_Box) (libs__file_util__FileName_6));
      MR_hl_field(MR_mktag(1), libs__file_util__Var_16, 1) = ((MR_Box) (libs__file_util__Var_17));
    }
    {
      libs__file_util__Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__file_util__Var_13 = mercury__list__map_2_f_0(libs__file_util__TypeCtorInfo_19_19, libs__file_util__TypeCtorInfo_19_19, (MR_Word) &libs__file_util_scalar_common_5[0], libs__file_util__Var_15);
    libs__file_util__Command_8 = mercury__string__join_list_2_f_0((MR_String) "   ", libs__file_util__Var_13);
    return libs__file_util__Command_8;
  }
}
...
{
  {
    ...
    MR_Word libs__file_util__Var_9;
    ...
    mercury__io__set_output_stream_4_p_0(libs__file_util__OldStream_8, &libs__file_util__Var_9);
  }
}
...
{
  {
    ...
    MR_String libs__file_util__Var_21;
    MR_String libs__file_util__Var_22;

    libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 620, &libs__file_util__InstallNameFlag_7);
    libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 621, &libs__file_util__InstallNamePath0_8);
    ...
    if (libs__file_util__succeeded)
    {
      ...
      MR_String libs__file_util__Var_15;
      MR_String libs__file_util__Var_16;
      MR_String libs__file_util__Var_17;

      libs__globals__lookup_string_option_3_p_0(libs__file_util__Globals_4, (MR_Integer) 634, &libs__file_util__InstallPrefix_9);
      libs__compute_grade__grade_directory_component_2_p_0(libs__file_util__Globals_4, &libs__file_util__GradeDir_10);
      libs__file_util__Var_17 = mercury__dir__f_slash_2_f_0(libs__file_util__InstallPrefix_9, (MR_String) "lib");
      libs__file_util__Var_16 = mercury__dir__f_slash_2_f_0(libs__file_util__Var_17, (MR_String) "mercury");
      libs__file_util__Var_15 = mercury__dir__f_slash_2_f_0(libs__file_util__Var_16, (MR_String) "lib");
      libs__file_util__InstallNamePath_11 = mercury__dir__f_slash_2_f_0(libs__file_util__Var_15, libs__file_util__GradeDir_10);
    }
    else
      libs__file_util__InstallNamePath_11 = libs__file_util__InstallNamePath0_8;
    libs__file_util__Var_22 = libs__options__quote_arg_1_f_0(libs__file_util__InstallNamePath_11);
    libs__file_util__Var_21 = mercury__dir__f_slash_2_f_0(libs__file_util__Var_22, libs__file_util__OutputFileName_5);
    *libs__file_util__InstallNameOpt_6 = mercury__string__f_43_43_2_f_0(libs__file_util__InstallNameFlag_7, libs__file_util__Var_21);
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) libs__file_util__MaybeType_9)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      libs__file_util__Var_17 = mercury__io__error_message_1_f_0(libs__file_util__Error_11);
      libs__file_util__Msg_12 = mercury__string__remove_prefix_if_present_2_f_0((MR_String) "can\'t find file type: ", libs__file_util__Var_17);
      {
        libs__file_util__Var_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), libs__file_util__Var_18, 0) = ((MR_Box) (libs__file_util__FileName_6));
        MR_hl_field(MR_mktag(0), libs__file_util__Var_18, 1) = ((MR_Box) (libs__file_util__Msg_12));
      }
      {
        mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (libs__file_util__Var_18)));
        return;
      }
    }
    else
    {
      ...
      if (libs__file_util__succeeded)
      {
        ...
        {
          MR_Word libs__file_util__Var_35;
          MR_String libs__file_util__Var_36;
          MR_Word libs__file_util__Error_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__OpenRes_29, (MR_Integer) 0)));

          libs__file_util__Var_36 = mercury__io__error_message_1_f_0(libs__file_util__Error_42);
          {
            libs__file_util__Var_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), libs__file_util__Var_35, 0) = ((MR_Box) (libs__file_util__FileName_6));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_35, 1) = ((MR_Box) (libs__file_util__Var_36));
          }
          {
            mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (libs__file_util__Var_35)));
            return;
          }
        }
        else
        {
          ...
          MR_Word libs__file_util__Var_37;

          {
            libs__file_util__Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 0) = ((MR_Box) (&libs__file_util_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 1) = ((MR_Box) (libs__file_util__write_include_file_contents_4_p_0_1));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 3) = ((MR_Box) (libs__file_util__InputStream_30));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_37, 4) = ((MR_Box) (libs__file_util__OutputStream_5));
          }
          mercury__exception__try_io_4_p_0((MR_Word) &mercury__io__io__type_ctor_info_res_0, libs__file_util__Var_37, &libs__file_util__TryResult_31);
          ...
          {
            MR_Word libs__file_util__Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__TryResult_31, (MR_Integer) 0)));

            if (!((libs__file_util__Var_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
            {
              MR_Word libs__file_util__Error_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__file_util__Var_50, (MR_Integer) 0)));
      ...
      else
      {
        ...
        {
          libs__file_util__Var_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), libs__file_util__Var_20, 0) = ((MR_Box) (libs__file_util__FileName_6));
          MR_hl_field(MR_mktag(0), libs__file_util__Var_20, 1) = ((MR_Box) ((MR_String) "Not a regular file"));
        }
        {
          mercury__exception__throw_1_p_0((MR_Word) &libs__file_util__libs__file_util__type_ctor_info_include_file_error_0, ((MR_Box) (libs__file_util__Var_20)));
          return;
        }
      }
    }
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), libs__file_util__ActionReturnDummy_12, 0) = ((MR_Box) (&libs__file_util_scalar_common_2[0]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(libs__file_util__Globals_7, (MR_Integer) 56, &libs__file_util__Verbose_12);
    libs__globals__lookup_bool_option_3_p_0(libs__file_util__Globals_7, (MR_Integer) 66, &libs__file_util__Stats_13);
    ...
    {
      MR_Word libs__file_util__Var_39;
      MR_Word libs__file_util__Var_41;
      ...
      {
        libs__file_util__Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), libs__file_util__Var_41, 0) = ((MR_Box) (libs__file_util__FileName_8));
        MR_hl_field(MR_mktag(1), libs__file_util__Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &libs__file_util_scalar_common_1[0])));
      }
      {
        libs__file_util__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 0) = ((MR_Box) ((MR_String) "can\'t open file \140"));
        MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 1) = ((MR_Box) (libs__file_util__Var_41));
      }
      mercury__string__append_list_2_p_0(libs__file_util__Var_39, &libs__file_util__ErrorMessage_62);
    ...
    else
    {
      ...
      mercury__io__set_output_stream_4_p_0(libs__file_util__OrigOutputStream_16, &libs__file_util__Var_18);
      ...
      if (((MR_tag((MR_Word) libs__file_util__TryResult_17)) == (MR_mktag((MR_Integer) 2))))
      {
        ...
        if (libs__file_util__succeeded)
        {
          ...
          MR_String libs__file_util__Var_66;
          MR_String libs__file_util__Var_67;

          libs__file_util__Var_66 = mercury__string__f_43_43_2_f_0((MR_String) "\' for input: ", libs__file_util__Detail_23);
          libs__file_util__Var_67 = mercury__string__f_43_43_2_f_0(libs__file_util__IncludeFileName_22, libs__file_util__Var_66);
          libs__file_util__ErrorMessage_24 = mercury__string__f_43_43_2_f_0((MR_String) "can\'t open \140", libs__file_util__Var_67);
          libs__file_util__maybe_write_string_4_p_0(libs__file_util__Verbose_12, (MR_String) "\n");
  ...
  MR_Word * libs__file_util__MaybeModTime_10)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      {
        MR_String libs__file_util__Msg_12;
        MR_String libs__file_util__Var_26;
        MR_String libs__file_util__Var_27;
        MR_String libs__file_util__Var_29;

        libs__file_util__Var_29 = mercury__string__join_list_2_f_0((MR_String) ", ", libs__file_util__AllDirs_7);
        libs__file_util__Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "\' in directories ", libs__file_util__Var_29);
        libs__file_util__Var_26 = mercury__string__f_43_43_2_f_0(libs__file_util__FileName_9, libs__file_util__Var_27);
        libs__file_util__Msg_12 = mercury__string__f_43_43_2_f_0((MR_String) "cannot find \140", libs__file_util__Var_26);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        mercury__dir__this_directory_1_p_0(&libs__file_util__Var_40);
        libs__file_util__succeeded = (strcmp(libs__file_util__HeadDir_13, libs__file_util__Var_40) == 0);
        if (libs__file_util__succeeded)
          libs__file_util__HeadFilePathNameNC_15 = libs__file_util__FileName_9;
        else
        {
          MR_String libs__file_util__Sep_34;
          MR_Char libs__file_util__Var_35;
          MR_Word libs__file_util__Var_36;
          MR_Word libs__file_util__Var_37;
          MR_Word libs__file_util__Var_38;

          libs__file_util__Var_35 = mercury__dir__directory_separator_0_f_0();
          libs__file_util__Sep_34 = mercury__string__from_char_1_f_0(libs__file_util__Var_35);
          {
            libs__file_util__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_38, 0) = ((MR_Box) (libs__file_util__FileName_9));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            libs__file_util__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_37, 0) = ((MR_Box) (libs__file_util__Sep_34));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_37, 1) = ((MR_Box) (libs__file_util__Var_38));
          }
          {
            libs__file_util__Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_36, 0) = ((MR_Box) (libs__file_util__HeadDir_13));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_36, 1) = ((MR_Box) (libs__file_util__Var_37));
          }
          libs__file_util__HeadFilePathNameNC_15 = mercury__string__append_list_1_f_0(libs__file_util__Var_36);
        }
        ...
        if (((MR_tag((MR_Word) libs__file_util__MaybeHeadModTime_16)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          {
            MR_Word libs__file_util__next_value_of_Dirs_8 = libs__file_util__TailDirs_14;

            libs__file_util__Dirs_8 = libs__file_util__next_value_of_Dirs_8;
          }
          continue;
        }
        else
...
{
  {
    ...
    else
    {
      ...
      MR_Word libs__file_util__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__MaybeDirPathNameAndStream_10, (MR_Integer) 0)));

      libs__file_util__DirPathName_11 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__Var_17, (MR_Integer) 0)));
      libs__file_util__Stream_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__Var_17, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if ((libs__file_util__Dirs_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_String libs__file_util__Msg_12;
        MR_String libs__file_util__Var_27;
        MR_String libs__file_util__Var_28;
        MR_String libs__file_util__Var_30;

        libs__file_util__Var_30 = mercury__string__join_list_2_f_0((MR_String) ", ", libs__file_util__AllDirs_7);
        libs__file_util__Var_28 = mercury__string__f_43_43_2_f_0((MR_String) "\' in directories ", libs__file_util__Var_30);
        libs__file_util__Var_27 = mercury__string__f_43_43_2_f_0(libs__file_util__FileName_9, libs__file_util__Var_28);
        libs__file_util__Msg_12 = mercury__string__f_43_43_2_f_0((MR_String) "cannot find \140", libs__file_util__Var_27);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        mercury__dir__this_directory_1_p_0(&libs__file_util__Var_41);
        libs__file_util__succeeded = (strcmp(libs__file_util__HeadDir_13, libs__file_util__Var_41) == 0);
        if (libs__file_util__succeeded)
          libs__file_util__HeadFilePathNameNC_15 = libs__file_util__FileName_9;
        else
        {
          MR_String libs__file_util__Sep_35;
          MR_Char libs__file_util__Var_36;
          MR_Word libs__file_util__Var_37;
          MR_Word libs__file_util__Var_38;
          MR_Word libs__file_util__Var_39;

          libs__file_util__Var_36 = mercury__dir__directory_separator_0_f_0();
          libs__file_util__Sep_35 = mercury__string__from_char_1_f_0(libs__file_util__Var_36);
          {
            libs__file_util__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 0) = ((MR_Box) (libs__file_util__FileName_9));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            libs__file_util__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_38, 0) = ((MR_Box) (libs__file_util__Sep_35));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_38, 1) = ((MR_Box) (libs__file_util__Var_39));
          }
          {
            libs__file_util__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_37, 0) = ((MR_Box) (libs__file_util__HeadDir_13));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_37, 1) = ((MR_Box) (libs__file_util__Var_38));
          }
          libs__file_util__HeadFilePathNameNC_15 = mercury__string__append_list_1_f_0(libs__file_util__Var_37);
        }
        ...
        else
        {
          ...
          MR_Word libs__file_util__Var_23;

          {
            libs__file_util__Var_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), libs__file_util__Var_23, 0) = ((MR_Box) (libs__file_util__HeadDir_13));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_23, 1) = ((MR_Box) (libs__file_util__HeadStream_17));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *libs__file_util__MaybeDirNameAndStream_10 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (libs__file_util__Var_23));
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      MR_Word libs__file_util__Stream_12;
      MR_Word libs__file_util__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__MaybeFilePathNameAndStream_10, (MR_Integer) 0)));

      libs__file_util__FilePathName_11 = ((MR_String) (MR_hl_field(MR_mktag(0), libs__file_util__Var_17, (MR_Integer) 0)));
      libs__file_util__Stream_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__file_util__Var_17, (MR_Integer) 1)));
      mercury__io__close_input_3_p_0(libs__file_util__Stream_12);
      {
        MR_Word base;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if ((libs__file_util__Dirs_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        MR_String libs__file_util__Var_29;
        MR_String libs__file_util__Var_30;
        MR_String libs__file_util__Var_32;

        libs__file_util__Var_32 = mercury__string__join_list_2_f_0((MR_String) ", ", libs__file_util__AllDirs_7);
        libs__file_util__Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "\' in directories ", libs__file_util__Var_32);
        libs__file_util__Var_29 = mercury__string__f_43_43_2_f_0(libs__file_util__FileName_9, libs__file_util__Var_30);
        libs__file_util__Msg_12 = mercury__string__f_43_43_2_f_0((MR_String) "cannot find \140", libs__file_util__Var_29);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        MR_String libs__file_util__HeadFilePathNameNC_15;
        MR_Word libs__file_util__MaybeHeadStream_16;
        MR_String libs__file_util__Var_43;

        mercury__dir__this_directory_1_p_0(&libs__file_util__Var_43);
        libs__file_util__succeeded = (strcmp(libs__file_util__HeadDir_13, libs__file_util__Var_43) == 0);
        if (libs__file_util__succeeded)
          libs__file_util__HeadFilePathNameNC_15 = libs__file_util__FileName_9;
        else
        {
          MR_String libs__file_util__Sep_37;
          MR_Char libs__file_util__Var_38;
          MR_Word libs__file_util__Var_39;
          MR_Word libs__file_util__Var_40;
          MR_Word libs__file_util__Var_41;

          libs__file_util__Var_38 = mercury__dir__directory_separator_0_f_0();
          libs__file_util__Sep_37 = mercury__string__from_char_1_f_0(libs__file_util__Var_38);
          {
            libs__file_util__Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_41, 0) = ((MR_Box) (libs__file_util__FileName_9));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            libs__file_util__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_40, 0) = ((MR_Box) (libs__file_util__Sep_37));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_40, 1) = ((MR_Box) (libs__file_util__Var_41));
          }
          {
            libs__file_util__Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 0) = ((MR_Box) (libs__file_util__HeadDir_13));
            MR_hl_field(MR_mktag(1), libs__file_util__Var_39, 1) = ((MR_Box) (libs__file_util__Var_40));
          }
          libs__file_util__HeadFilePathNameNC_15 = mercury__string__append_list_1_f_0(libs__file_util__Var_39);
        }
        mercury__io__open_input_4_p_0(libs__file_util__HeadFilePathNameNC_15, &libs__file_util__MaybeHeadStream_16);
        if (((MR_tag((MR_Word) libs__file_util__MaybeHeadStream_16)) == (MR_mktag((MR_Integer) 1))))
        {
        ...
        else
        {
          ...
          MR_Word libs__file_util__Var_24;
          MR_String libs__file_util__Var_25;

          mercury__dir__this_directory_1_p_0(&libs__file_util__Var_25);
          libs__file_util__succeeded = (strcmp(libs__file_util__HeadDir_13, libs__file_util__Var_25) == 0);
          if (libs__file_util__succeeded)
          ...
          {
            libs__file_util__Var_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), libs__file_util__Var_24, 0) = ((MR_Box) (libs__file_util__HeadFilePathName_18));
            MR_hl_field(MR_mktag(0), libs__file_util__Var_24, 1) = ((MR_Box) (libs__file_util__HeadStream_17));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *libs__file_util__MaybeFilePathNameAndStream_10 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (libs__file_util__Var_24));
          }
        }
      }
    }
