  ...
  MR_Word * Result_4)
{
  ...
  if (((MR_tag((MR_Word) TempFileResult_6)) == (MR_Integer) 1))
  {
    ...
    Var_36 = mercury__io__error_message_1_f_0(Error_38);
    Var_32 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", Var_36);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_4 = base;
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) OpenResult_17)) == (MR_Integer) 1))
    {
      ...
      Var_30 = mercury__io__error_message_1_f_0(Error_19);
      Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", Var_30);
      Var_41 = mercury__string__f_43_43_2_f_0(TempFileName_16, Var_40);
      Var_24 = mercury__string__f_43_43_2_f_0((MR_String) "could not open temporary file \140", Var_41);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_4 = base;
  ...
  MR_Word * Result_10)
{
  ...
  if (((MR_tag((MR_Word) TempFileResult_12)) == (MR_Integer) 1))
  {
    ...
    Var_42 = mercury__io__error_message_1_f_0(Error_44);
    Var_38 = mercury__string__f_43_43_2_f_0((MR_String) "could not create temporary file: ", Var_42);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_10 = base;
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) OpenResult_23)) == (MR_Integer) 1))
    {
      ...
      mercury__io__file__remove_file_4_p_0(TempFileName_22, &Var_26);
      Var_36 = mercury__io__error_message_1_f_0(Error_25);
      Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", Var_36);
      Var_47 = mercury__string__f_43_43_2_f_0(TempFileName_22, Var_46);
      Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "could not open temporary file \140", Var_47);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_10 = base;
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (TempFileName_22));
        MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (Stream_24));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
