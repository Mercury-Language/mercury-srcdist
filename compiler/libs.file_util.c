  ...
  MR_String * InstallNameOpt_6)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 670, &InstallNameFlag_7);
  libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 671, &InstallNamePath0_8);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_4, (MR_Integer) 684, &InstallPrefix_9);
