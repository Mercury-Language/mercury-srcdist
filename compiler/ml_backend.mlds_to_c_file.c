...
static /* final */ const MR_Box ml_backend__mlds_to_c_file_scalar_common_3[4][1];
  ...
  MR_Word * Errors_12)
{
...

  {
    ...
    MR_hl_field(0, Var_21, 6) = ((MR_Box) (MR_mkword(1, &ml_backend__mlds_to_c_file_scalar_common_3[3])));
  }
  ...
  MR_Word AllocSites_6)
{
  if (!((AllocSites_6 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_file_scalar_common_3[1]), NumAllocSites_10, &Var_22);
  ...
  MR_Word Import_10)
{
  ...
  switch (ImportType_12) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 0:
      HeaderExt_14 = (MR_Word) (MR_mkword(2, &ml_backend__mlds_to_c_file_scalar_common_3[0]));
      break;
  }
  ...
  MR_Word * Errors_14)
{
  ...
  mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), WriteAncestorInclude_25, AncestorFileNames_24, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_48_48);
  {
    ...
    MR_hl_field(0, Var_49, 6) = ((MR_Box) (MR_mkword(1, &ml_backend__mlds_to_c_file_scalar_common_3[2])));
  }
