...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__861__1_4_p_0(
  MR_Word Stream_10,
  MR_String LambdaHeadVar__1_38);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__379__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__379__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word Import_10)
{
  ...
  MR_String Var_45;
  MR_String _HeaderFileNameProposed_19;
  ...
  parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_17, (MR_String) "predicate \140ml_backend.mlds_to_c_file.mlds_output_src_import\'/6", HeaderExt_14, ModuleName_16, &HeaderFileName_18, &_HeaderFileNameProposed_19);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__861__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_49, (MR_Integer) 195, &LineNumbersForCHdrs_54);
        ...
        packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, Opts_18, (MR_Integer) 2)));
        {
          ...
          MR_hl_field(0, HdrOpts_55, 2) = (MR_Box) ((((packed_word_2 & (~((MR_Unsigned) 98304U)))) | (((((MR_Unsigned) (LineNumbersForCHdrs_54) << 15)) | (((MR_Unsigned) (LineNumbersForCHdrs_54) << 16))))));
        }
        {
