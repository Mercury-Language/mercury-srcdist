...
{
  {
    ...
    switch (Lang_12) {
      ...
      case (MR_Integer) 0:
        {
          if ((MaybeDesiredIsLocal_9 == (MR_Word) ((MR_Integer) 0)))
            succeeded = MR_TRUE;
          else
          {
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n{\n");
    if (!((TypeCtorInfoDefns_13 == (MR_Word) ((MR_Integer) 0))))
    {
    ...
    mercury__io__write_string_3_p_0((MR_String) "}\n");
    if (!((InitPreds_15 == (MR_Word) ((MR_Integer) 0))))
    {
      MR_String Call_150;
      MR_Word Calls_151;
      MR_String Var_155;
    ...
    if (!((FinalPreds_16 == (MR_Word) ((MR_Integer) 0))))
    {
      MR_String Call_164;
      MR_Word Calls_165;
      MR_String Var_169;
...
ml_backend__mlds_to_c_file__mlds_output_call_to_register_alloc_sites_3_p_0(
  MR_Word AllocSites_4)
{
  if (!((AllocSites_4 == (MR_Word) ((MR_Integer) 0))))
  {
    MR_Integer Length_8;
...
{
  {
    ...
    if (!((Exports_21 == (MR_Word) ((MR_Integer) 0))))
    {
      MR_Word Import_24;
      MR_Word Var_45;
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "init\n");
    if (!((UserInitPredCNames_8 == (MR_Word) ((MR_Integer) 0))))
    {
      mercury__io__write_string_3_p_0((MR_String) "REQUIRED_INIT ");
      backend_libs__name_mangle__output_init_name_3_p_0(ModuleName_7);
      mercury__io__write_string_3_p_0((MR_String) "required_init\n");
    }
    if (!((UserFinalPredCNames_9 == (MR_Word) ((MR_Integer) 0))))
    {
