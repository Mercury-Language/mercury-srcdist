  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__868__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
}
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_33, (MR_Integer) 462, &LineNumbersForCHdrs_38);
