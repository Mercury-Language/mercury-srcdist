...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__857__1_4_p_0(
  MR_Word Stream_10,
    ...
    case (MR_Integer) 1:
      {
        ...
        HeaderNewExt_15 = (MR_Word) (MR_mkword(3, &ml_backend__mlds_to_c_file_scalar_common_1[4]));
      }
      break;
    case (MR_Integer) 0:
      {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__857__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
