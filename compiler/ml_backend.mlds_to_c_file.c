...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__886__1_4_p_0(
  MR_Word Stream_10,
...
static /* final */ const MR_Box ml_backend__mlds_to_c_file_scalar_common_4[6][1];
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_21, 6) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_4[5])));
    }
  ...
  MR_Word AllocSites_6)
{
  if (!((AllocSites_6 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_file_scalar_common_4[4]), NumAllocSites_10, &Var_22);
...
{
  {
    ...
    ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__886__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), WriteAncestorInclude_25, AncestorFileNames_24, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_48_48);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_49, 6) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_4[3])));
    }
...
{
  {
    ...
    libs__file_util__output_to_file_stream_6_p_0(Globals_9, DumpFileName_18, Var_31, &_Succeeded_21);
  }
}
...
{
  {
    ...
    libs__file_util__output_to_file_stream_6_p_0(Globals_31, SourceFileName_33, Var_41, &Succeeded0_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 163, &LineNumbersForCHdrs_17);
    ...
    libs__file_util__output_to_file_stream_6_p_0(Globals_13, TmpHeaderFileName_16, Var_31, Succeeded_10);
    switch (*Succeeded_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
