  ...
  MR_Word * Res_12)
{
  {
    MR_bool succeeded;
    MR_Word Lang_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_11, (MR_Integer) 0))));
    MR_Word IsLocal_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_11, (MR_Integer) 1))));
    MR_Word LiteralOrInclude_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_11, (MR_Integer) 2))));
    MR_Word Context_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_11, (MR_Integer) 3))));
