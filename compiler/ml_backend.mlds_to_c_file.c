  ...
  MR_Word * Errors_14)
{
  ...
  mercury__io__write_string_4_p_0(Stream_10, (MR_String) "\n");
  {
    ...
    MR_hl_field(0, Var_29, 4) = ((MR_Box) (Stream_10));
    MR_hl_field(0, Var_29, 5) = ((MR_Box) (Indent_12));
    MR_hl_field(0, Var_29, 6) = ((MR_Box) (ModuleName_11));
  }
  mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_pragma_export_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_29, ExportDefns_19, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_22);
  ...
  MR_Word FinalFuncNames_18)
{
  ...
  if (succeeded)
  {
    ...
    QualFuncNameStr_136 = ml_backend__mlds_to_c_name__fully_qualified_function_name_to_string_for_c_1_f_0(QualFuncName_135);
  ...
  if (!((TypeCtorInfoDefns_15 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    QualGlobalVarNameStr_164 = ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(ModuleName_13, GlobalVarName_163);
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      QualGlobalVarNameStr_17 = ml_backend__mlds_to_c_name__maybe_qualified_global_var_name_to_string_for_c_2_f_0(MLDS_ModuleName_2, GlobalVarName_16);
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      QualFuncNameStr_18 = ml_backend__mlds_to_c_name__fully_qualified_function_name_to_string_for_c_1_f_0(QualFuncName_17);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_47, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_header_file_opts\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &ml_backend__mlds_to_c_file_scalar_common_3[2])), ModuleName_46, &MihFileName_48);
        ...
        libs__file_util__output_to_file_stream_7_p_0(Globals_47, ModuleName_46, TmpHeaderFileName_50, Var_60, &STATE_VARIABLE_Succeeded_33_61);
        switch (STATE_VARIABLE_Succeeded_33_61) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *Succeeded_12 = STATE_VARIABLE_Succeeded_33_61;
            break;
          case (MR_Integer) 1:
