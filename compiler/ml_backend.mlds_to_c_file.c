    ...
    case (MR_Integer) 1:
      {
        ...
        Var_76 = ((MR_Word) ((MR_hl_field(0, Opts_16, (MR_Integer) 0))));
        Var_77 = ((MR_String) ((MR_hl_field(0, Opts_16, (MR_Integer) 1))));
        packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, Opts_16, (MR_Integer) 2)));
        {
          ...
          MR_hl_field(0, HdrOpts_51, 0) = ((MR_Box) (Var_76));
          MR_hl_field(0, HdrOpts_51, 1) = ((MR_Box) (Var_77));
        ...
        switch (STATE_VARIABLE_Succeeded_31_59) {
          ...
          case (MR_Integer) 0:
            *Succeeded_12 = STATE_VARIABLE_Succeeded_31_59;
            break;
          case (MR_Integer) 1:
            parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(Globals_46, (MR_String) ".mih", ModuleName_45, HeaderFileName_48, Succeeded_12);
            break;
        }
      }
      break;
