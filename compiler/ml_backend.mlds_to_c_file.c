...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__868__1_4_p_0(
  MR_Word Stream_10,
  MR_String LambdaHeadVar__1_38);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__250__1_2_p_0(
  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Var_85 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
        MR_String Var_87 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 1))));
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          MR_Word Var_89 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
          MR_String Var_91 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 1))));

          if (((MR_tag((MR_Word) LiteralOrInclude_18)) == (MR_Integer) 1))
          {
            MR_String IncludeFileName_27 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_18, (MR_Integer) 0))));
            MR_String IncludePath_29;
            MR_Word Var_33;

            parse_tree__file_names__make_include_file_path_3_p_0(Var_91, IncludeFileName_27, &IncludePath_29);
            Var_33 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
          ...
          {
            MR_String Code_26 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_18, (MR_Integer) 0))));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__250__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__868__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
