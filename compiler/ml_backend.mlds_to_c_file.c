...
ml_backend__mlds_to_c_file__mlds_output_foreign_literal_or_include_7_p_0(
  ...
  MR_Word * Res_12)
{
  MR_Word Var_94 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, 2))) >> 15)) & (MR_Integer) 1);
  MR_String Var_96 = ((MR_String) ((MR_hl_field(0, Opts_8, 1))));
  ...
  if (((MR_tag((MR_Word) LiteralOrInclude_10)) == (MR_Integer) 1))
  {
    ...
    parse_tree__file_names__make_include_file_path_3_p_0(Var_96, IncludeFileName_15, &IncludePath_17);
    Var_24 = ((((MR_Unsigned) ((MR_hl_field(0, Opts_8, 2))) >> 15)) & (MR_Integer) 1);
  ...
  else
  {
    ...
    ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_94, Context_11);
