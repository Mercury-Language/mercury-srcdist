...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__851__1_4_p_0(
  MR_Word Stream_10,
  MR_String LambdaHeadVar__1_38);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__369__1_2_p_0(
  MR_Word EnumDefns_18,
  MR_Word HeadVar__2_57);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__368__1_2_p_0(
  MR_Word ClassDefns_17,
  MR_Word HeadVar__2_53);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__244__1_2_p_0(
  MR_Word EnumDefns_18,
  MR_Word HeadVar__2_50);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__243__1_2_p_0(
  MR_Word ClassDefns_17,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__369__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_src_file__368__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__244__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__243__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__851__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
  ...
  MR_Word DumpPredNames_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_9, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_dump_preds\'/7", (MR_Word) (&ml_backend__mlds_to_c_file_scalar_common_3[0]), ModuleName_14, &DumpBaseName_17);
  ...
  MR_Word * Succeeded_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_23, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_file_opts\'/6", (MR_Word) (MR_mkword(3, &ml_backend__mlds_to_c_file_scalar_common_1[3])), ModuleName_22, &SourceFileName0_24);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_46, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_header_file_opts\'/6", (MR_Word) (MR_mkword(3, &ml_backend__mlds_to_c_file_scalar_common_1[4])), ModuleName_45, &MihFileName_47);
