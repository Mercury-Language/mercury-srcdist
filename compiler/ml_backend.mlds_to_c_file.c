...
static void MR_CALL 
ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__929__1_3_p_0(
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_53, (MR_Integer) 1, (MR_String) ".m", ModuleName_12, &SourceFileName_54);
...
{
  {
    ...
    switch (ImportType_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        HeaderExt_12 = (MR_String) ".mih";
        break;
      case (MR_Integer) 0:
        HeaderExt_12 = (MR_String) ".mh";
        break;
    }
    succeeded = mdbcomp__sym_name__strip_outermost_qualifier_3_p_0(ModuleName0_11, &Var_42, &ModuleName1_13);
    if (succeeded)
    {
      succeeded = (strcmp((MR_String) "mercury", Var_42) == 0);
      if (succeeded)
    ...
    parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_15, HeaderExt_12, ModuleName_14, &HeaderFile_16);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) (HeaderFile_16));
      MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[4])));
    }
    {
      Var_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) ((MR_String) "#include \""));
...
{
  {
    ...
    ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__929__1_3_p_0(((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 159, &LineNumbersForCHdrs_16);
    ...
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2)));
    {
      ...
      MR_hl_field(MR_mktag(0), HdrOpts_17, 2) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 98304U)))) | (((((MR_Unsigned) (LineNumbersForCHdrs_16) << 15)) | (((MR_Unsigned) (LineNumbersForCHdrs_16) << 16))))));
    }
    {
