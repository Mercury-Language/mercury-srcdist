  ...
  MR_Word FinalFuncNames_18)
{
  ...
  if (succeeded)
  {
    MR_Word FuncDefn_134;
    MR_Word FuncDefns_135;
    MR_Word FuncName_137;
    MR_Word Var_142;

    mercury__io__write_strings_4_p_0(Stream_12, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[4])));
    FuncDefn_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_14, (MR_Integer) 0))));
    FuncDefns_135 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_14, (MR_Integer) 1))));
    FuncName_137 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncDefn_134, (MR_Integer) 0))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\tMR_init_entry(");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_142, 0) = ((MR_Box) (ModuleName_13));
      MR_hl_field(MR_mktag(0), Var_142, 1) = ((MR_Box) (FuncName_137));
    }
    ml_backend__mlds_to_c_name__mlds_output_fully_qualified_function_name_4_p_0(Stream_12, Var_142);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) ");\n");
    ml_backend__mlds_to_c_file__mlds_output_calls_to_init_entry_5_p_0(Stream_12, ModuleName_13, FuncDefns_135);
  ...
  if (!((TypeCtorInfoDefns_15 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_strings_4_p_0(Stream_12, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[4])));
    GlobalVarDefn_161 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorInfoDefns_15, (MR_Integer) 0))));
    GlobalVarDefns_162 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorInfoDefns_15, (MR_Integer) 1))));
    GlobalVarName_164 = ((MR_Word) ((MR_hl_field(MR_mktag(0), GlobalVarDefn_161, (MR_Integer) 0))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\tMR_register_type_ctor_info(&");
    ml_backend__mlds_to_c_name__mlds_output_maybe_qualified_global_var_name_5_p_0(Stream_12, ModuleName_13, GlobalVarName_164);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) ");\n");
  ...
  if (!((InitFuncNames_17 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    MR_String FuncName_183;
    MR_Word FuncNames_184;
    ...
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n{\n");
    FuncName_183 = ((MR_String) ((MR_hl_field(MR_mktag(1), InitFuncNames_17, (MR_Integer) 0))));
    FuncNames_184 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InitFuncNames_17, (MR_Integer) 1))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\t");
    mercury__io__write_string_4_p_0(Stream_12, FuncName_183);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "();\n");
    ml_backend__mlds_to_c_file__output_calls_to_void_funcs_4_p_0(Stream_12, FuncNames_184);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "}\n");
  }
  if (!((FinalFuncNames_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n{\n");
    FuncName_203 = ((MR_String) ((MR_hl_field(MR_mktag(1), FinalFuncNames_18, (MR_Integer) 0))));
    FuncNames_204 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FinalFuncNames_18, (MR_Integer) 1))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\t");
  ...
  MR_Word ModuleName_6)
{
  ...
  Var_45 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_6);
  ModuleNameString0_44 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(Var_45);
  succeeded = mercury__string__prefix_2_p_0(ModuleNameString0_44, (MR_String) "mercury__");
  if (succeeded)
    ModuleNameString_34 = ModuleNameString0_44;
  else
    ModuleNameString_34 = mercury__string__f_43_43_2_f_0((MR_String) "mercury__", ModuleNameString0_44);
  Var_40 = mercury__string__f_43_43_2_f_0(ModuleNameString_34, (MR_String) "__grade_check(void)");
  GradeCheckDecl_8 = mercury__string__f_43_43_2_f_0((MR_String) "const char *", Var_40);
  ...
  MR_Word EnvVarNames_18)
{
  ...
  Globals_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_11, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 172, &LineNumbersForCHdrs_17);
  ...
  packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2)));
  {
    ...
    MR_hl_field(MR_mktag(0), HdrOpts_18, 0) = ((MR_Box) (Var_51));
    MR_hl_field(MR_mktag(0), HdrOpts_18, 1) = ((MR_Box) (Var_52));
