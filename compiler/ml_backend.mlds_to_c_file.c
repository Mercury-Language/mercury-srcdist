...
static /* final */ const MR_Box ml_backend__mlds_to_c_file_scalar_common_1[5][2] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[3])))
  },
};
  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Var_84 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
        MR_String Var_86 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 1))));
        ...
        if (((MR_tag((MR_Word) LiteralOrInclude_15)) == (MR_Integer) 1))
        {
          ...
          parse_tree__file_names__make_include_file_path_3_p_0(Var_86, IncludeFileName_22, &IncludePath_24);
          Var_25 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
          ml_backend__mlds_to_c_util__c_output_file_line_6_p_0(Stream_9, Var_25, IncludePath_24, (MR_Integer) 1);
        ...
        else
        {
          ...
          ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_9, Var_84, Context_16);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          MR_Word Var_88 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
          MR_String Var_90 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 1))));

          if (((MR_tag((MR_Word) LiteralOrInclude_18)) == (MR_Integer) 1))
          {
            MR_String IncludeFileName_26 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_18, (MR_Integer) 0))));
            MR_String IncludePath_28;
            MR_Word Var_29;

            parse_tree__file_names__make_include_file_path_3_p_0(Var_90, IncludeFileName_26, &IncludePath_28);
            Var_29 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_9, (MR_Integer) 2))) >> 15)) & (MR_Integer) 1);
            ml_backend__mlds_to_c_util__c_output_file_line_6_p_0(Stream_10, Var_29, IncludePath_28, (MR_Integer) 1);
            libs__file_util__write_include_file_contents_5_p_0(Stream_10, IncludePath_28, Res_14);
          }
          else
          {
            MR_String Code_25 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_18, (MR_Integer) 0))));

            ml_backend__mlds_to_c_util__c_output_context_5_p_0(Stream_10, Var_88, Context_19);
            mercury__io__write_string_4_p_0(Stream_10, Code_25);
  ...
  MR_Word * Errors_12)
{
  ...
  MR_Word ClassDefns_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MLDS_10, (MR_Integer) 3))));
  ...
  mercury__io__nl_3_p_0(Stream_11);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_7[0]));
  ...
  MLDS_ModuleName_42 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_14);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_5[4]));
  ...
  MR_Word * Errors_12)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_8[0]));
  ...
  MR_Word FinalFuncNames_18)
{
  ...
  NeedToInit_23 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_11, (MR_Integer) 2))) >> 9)) & (MR_Integer) 1);
  ...
  if (succeeded)
  {
    ...
    mercury__io__write_strings_4_p_0(Stream_12, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[4])));
    FuncDefn_133 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_14, (MR_Integer) 0))));
    FuncDefns_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_14, (MR_Integer) 1))));
    FuncName_135 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncDefn_133, (MR_Integer) 0))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\tMR_init_entry(");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_140, 0) = ((MR_Box) (ModuleName_13));
      MR_hl_field(MR_mktag(0), Var_140, 1) = ((MR_Box) (FuncName_135));
    }
    ml_backend__mlds_to_c_name__mlds_output_fully_qualified_function_name_4_p_0(Stream_12, Var_140);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) ");\n");
  ...
  {
    MR_Word GlobalVarDefn_157;
    MR_Word GlobalVarDefns_158;
    MR_Word GlobalVarName_159;

    mercury__io__write_strings_4_p_0(Stream_12, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_1[4])));
    GlobalVarDefn_157 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorInfoDefns_15, (MR_Integer) 0))));
    GlobalVarDefns_158 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCtorInfoDefns_15, (MR_Integer) 1))));
    GlobalVarName_159 = ((MR_Word) ((MR_hl_field(MR_mktag(0), GlobalVarDefn_157, (MR_Integer) 0))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\tMR_register_type_ctor_info(&");
    ml_backend__mlds_to_c_name__mlds_output_maybe_qualified_global_var_name_5_p_0(Stream_12, ModuleName_13, GlobalVarName_159);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) ");\n");
    ml_backend__mlds_to_c_file__mlds_output_calls_to_register_tci_5_p_0(Stream_12, ModuleName_13, GlobalVarDefns_158);
  }
  mercury__io__write_string_4_p_0(Stream_12, (MR_String) "}\n\n");
  ...
  if (!((InitFuncNames_17 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    MR_String FuncName_176;
    MR_Word FuncNames_177;
    ...
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n{\n");
    FuncName_176 = ((MR_String) ((MR_hl_field(MR_mktag(1), InitFuncNames_17, (MR_Integer) 0))));
    FuncNames_177 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InitFuncNames_17, (MR_Integer) 1))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\t");
    mercury__io__write_string_4_p_0(Stream_12, FuncName_176);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "();\n");
    ml_backend__mlds_to_c_file__output_calls_to_void_funcs_4_p_0(Stream_12, FuncNames_177);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "}\n");
  }
  if (!((FinalFuncNames_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_String ReqFinalDecl_33;
    MR_String FuncName_193;
    MR_Word FuncNames_194;
    ...
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n{\n");
    FuncName_193 = ((MR_String) ((MR_hl_field(MR_mktag(1), FinalFuncNames_18, (MR_Integer) 0))));
    FuncNames_194 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FinalFuncNames_18, (MR_Integer) 1))));
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\t");
    mercury__io__write_string_4_p_0(Stream_12, FuncName_193);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "();\n");
    ml_backend__mlds_to_c_file__output_calls_to_void_funcs_4_p_0(Stream_12, FuncNames_194);
    mercury__io__write_string_4_p_0(Stream_12, (MR_String) "}\n");
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String FuncName_10 = ((MR_String) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word FuncNames_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
  ...
  MR_Word ModuleName_6)
{
  ...
  MR_String Var_38;
  MR_String ModuleNameString0_40;
  MR_Word Var_41;

  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "// Ensure everything is compiled with the same grade.\n");
  Var_41 = ml_backend__mlds__mlds_module_name_to_sym_name_1_f_0(ModuleName_6);
  ModuleNameString0_40 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(Var_41);
  succeeded = mercury__string__prefix_2_p_0(ModuleNameString0_40, (MR_String) "mercury__");
  if (succeeded)
    ModuleNameString_32 = ModuleNameString0_40;
  else
    ModuleNameString_32 = mercury__string__f_43_43_2_f_0((MR_String) "mercury__", ModuleNameString0_40);
  Var_38 = mercury__string__f_43_43_2_f_0(ModuleNameString_32, (MR_String) "__grade_check(void)");
  GradeCheckDecl_8 = mercury__string__f_43_43_2_f_0((MR_String) "const char *", Var_38);
  ...
  MR_Word EnvVarNames_18)
{
  ...
  Globals_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_11, (MR_Integer) 0))));
  parse_tree__file_names__module_name_to_source_file_name_4_p_0(ModuleName_14, &SourceFileName_56);
  backend_libs__c_util__output_c_file_intro_and_grade_7_p_0(Globals_55, Stream_12, SourceFileName_56, Version_53, Fullarch_54);
  ...
  backend_libs__c_util__output_init_c_comment_7_p_0(Stream_12, ModuleName_14, InitPreds_16, FinalPreds_17, EnvVarNames_18);
  {
    ...
    MR_hl_field(MR_mktag(0), CompilerImport_21, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), CompilerImport_21, 1) = ((MR_Box) (ModuleName_14));
  }
  ...
  Exports_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignCode_15, (MR_Integer) 3))));
  if (!((Exports_25 == (MR_Word) ((MR_Unsigned) 0U))))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), UserImport_28, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), UserImport_28, 1) = ((MR_Box) (ModuleName_14));
    }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_hdr_file__251__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * Errors_12)
{
  ...
  mercury__list__filter_4_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_class_defn_0), (MR_Word) (&ml_backend__mlds_to_c_file_scalar_common_2[3]), ClassDefns_17, &_PrivateClassDefns_30, &PublicClassDefns_31);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_6[3]));
    MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (ml_backend__mlds_to_c_file__mlds_output_hdr_file_7_p_0_2));
    MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_44, 3) = ((MR_Box) (PublicClassDefns_31));
  ...
  mercury__io__nl_3_p_0(Stream_11);
  mercury__io__nl_3_p_0(Stream_11);
  succeeded = mercury__map__search_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_foreign_code_0), AllForeignCode_22, ((MR_Box) ((MR_Integer) 0)), &conv0_ForeignCode0_90);
  if (succeeded)
  {
  ...
  if (succeeded)
    ForeignCode_38 = ForeignCode0_90;
  else
  ...
  mercury__io__nl_3_p_0(Stream_11);
  Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 0))));
  Var_69 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 1))));
  packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 2)));
  {
    ...
    MR_hl_field(MR_mktag(0), StdOpts_40, 0) = ((MR_Box) (Var_68));
    MR_hl_field(MR_mktag(0), StdOpts_40, 1) = ((MR_Box) (Var_69));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_c_file__IntroducedFrom__pred__mlds_output_c_hdr_decls__869__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
  ...
  MR_Word * Errors_14)
{
  ...
  mercury__list__map_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ml_backend__mlds_to_c_file_scalar_common_2[1]), AncestorModuleNames_23, &AncestorFileNames_24);
  {
    ...
    MR_hl_field(MR_mktag(0), WriteAncestorInclude_25, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_7[0]));
  ...
  mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), WriteAncestorInclude_25, AncestorFileNames_24, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_48_48);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_8[0]));
  ...
  MR_Word ModuleName_10)
{
  ...
  Globals_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 0))));
  parse_tree__file_names__module_name_to_source_file_name_4_p_0(ModuleName_10, &SourceFileName_81);
  backend_libs__c_util__output_c_file_intro_and_grade_7_p_0(Globals_80, Stream_8, SourceFileName_81, Version_78, Fullarch_79);
  mercury__io__nl_3_p_0(Stream_8);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
  ...
  mercury__io__write_string_4_p_0(Stream_8, MangledModuleNameStr_13);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n\n");
  Target_14 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_7, (MR_Integer) 2))) >> 7)) & (MR_Integer) 3);
  switch (Target_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word FuncDefn_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
      MR_Word FuncDefns_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
      MR_Word next_value_of_HeadVar__3_3;
  ...
  MR_Word FuncDefn_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo__26_26 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
      succeeded = mercury__list__member_2_p_0(TypeCtorInfo__26_26, ((MR_Box) (Name_14)), DumpPredNames_3);
    }
  }
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  ml_backend__mlds_to_c_file__output_c_dump_func_defns_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__5_5);
  ...
  MR_Word DumpPredNames_12)
{
  ...
  ProcDefns_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 5))));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_6[0]));
    MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (ml_backend__mlds_to_c_file__output_c_dump_preds_7_p_0_1));
    MR_hl_field(MR_mktag(0), Var_33, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_33, 3) = ((MR_Box) (DumpPredNames_12));
  }
  ...
  mercury__list__sort_2_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_function_defn_0), SelectedProcDefns_21, &SortedSelectedProcDefns_22);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_5[1]));
    MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (ml_backend__mlds_to_c_file__output_c_dump_preds_7_p_0_2));
    MR_hl_field(MR_mktag(0), Var_34, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_34, 3) = ((MR_Box) (Opts_16));
    MR_hl_field(MR_mktag(0), Var_34, 4) = ((MR_Box) (MLDS_ModuleName_19));
    MR_hl_field(MR_mktag(0), Var_34, 5) = ((MR_Box) (SortedSelectedProcDefns_22));
  }
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  ml_backend__mlds_to_c_file__mlds_output_hdr_file_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), &conv1_Errors_12);
  ...
  MR_Word * Succeeded_12)
{
  ...
  Globals_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_16, (MR_Integer) 0))));
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_23, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_file_opts\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_3[1])), ModuleName_22, &SourceFileName0_24);
  SourceFileName_25 = mercury__string__f_43_43_2_f_0(SourceFileName0_24, Suffix_11);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (ml_backend__mlds_to_c_file__output_c_mlds_7_p_0_1));
    MR_hl_field(MR_mktag(0), Var_33, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_33, 3) = ((MR_Box) (Opts_16));
    MR_hl_field(MR_mktag(0), Var_33, 4) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), Var_33, 5) = ((MR_Box) (MLDS_8));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        Globals_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_16, (MR_Integer) 0))));
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_49, (MR_String) "predicate \140ml_backend.mlds_to_c_file.output_c_header_file_opts\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_c_file_scalar_common_3[2])), ModuleName_48, &MihFileName_50);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_49, (MR_Integer) 172, &LineNumbersForCHdrs_53);
        Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Opts_16, (MR_Integer) 0))));
        Var_80 = ((MR_String) ((MR_hl_field(MR_mktag(0), Opts_16, (MR_Integer) 1))));
        packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_16, (MR_Integer) 2)));
        {
          HdrOpts_54 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), HdrOpts_54, 0) = ((MR_Box) (Var_79));
          MR_hl_field(MR_mktag(0), HdrOpts_54, 1) = ((MR_Box) (Var_80));
          MR_hl_field(MR_mktag(0), HdrOpts_54, 2) = (MR_Box) ((((packed_word_2 & (~((MR_Unsigned) 98304U)))) | (((((MR_Unsigned) (LineNumbersForCHdrs_53) << 15)) | (((MR_Unsigned) (LineNumbersForCHdrs_53) << 16))))));
        }
        {
          Var_62 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (&ml_backend__mlds_to_c_file_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (ml_backend__mlds_to_c_file__output_c_mlds_7_p_0_2));
          MR_hl_field(MR_mktag(0), Var_62, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), Var_62, 3) = ((MR_Box) (HdrOpts_54));
          MR_hl_field(MR_mktag(0), Var_62, 4) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Var_62, 5) = ((MR_Box) (MLDS_8));
        }
