    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          hlds__goal_util__goal_vars_2_p_0(LambdaGoal1_36, &GoalVars_76);
          {
            ...
            MR_hl_field(MR_mktag(0), IsTiOrTci_77, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_6[8]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv11_LambdaHeadVar__2_56 = check_hlds__polymorphism__IntroducedFrom__func__polymorphism_process_foreign_proc_args__1590__1_1_f_0(((MR_Word) (wrapper_arg_1)));
