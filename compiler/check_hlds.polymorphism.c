  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv10_LambdaHeadVar__2_56 = check_hlds__polymorphism__IntroducedFrom__func__polymorphism_process_foreign_proc_args__1652__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  succeeded = parse_tree__vartypes__vartypes_is_empty_1_p_0(VarTypes0_18);
  if (succeeded)
  ...
  else
  {
    ...
    parse_tree__vartypes__lookup_var_types_3_p_0(VarTypes0_18, HeadVarList_36, &ActualArgTypes_37);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  parse_tree__vartypes__init_vartypes_1_p_0(&TVarNameMap_76);
  {
