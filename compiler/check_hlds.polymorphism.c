  ...
  MR_Word * ExtraArgModes_11)
{
  ...
  switch (MR_tag((MR_Word) Origin_54)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word InstanceMethodConstraints_57 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_54, (MR_Integer) 1))));
