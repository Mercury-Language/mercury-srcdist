...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__pred_info_get_simple_call_id_2_p_0(PredInfo0_12, &SimpleCallId_34);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_57, 3) = ((MR_Box) (SimpleCallId_34));
      }
      {
