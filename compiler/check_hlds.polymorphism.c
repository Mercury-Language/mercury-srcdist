  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_21)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo2_35, &ProcMap0_37);
    {
      ...
      MR_hl_field(0, Var_42, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_5[1]));
      MR_hl_field(0, Var_42, 1) = ((MR_Box) (check_hlds__polymorphism__maybe_polymorphism_process_pred_7_p_0_1));
      MR_hl_field(0, Var_42, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_42, 3) = ((MR_Box) (ExtraArgModes_29));
    }
    ...
    {
      *STATE_VARIABLE_Specs_19 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), PredSpecs_36, STATE_VARIABLE_Specs_0_18);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__polymorphism__IntroducedFrom__pred__polymorphism_process_generated_pred__256__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__polymorphism__IntroducedFrom__pred__polymorphism_process_generated_pred__254__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_10)
{
  ...
  else
  {
    ...
    Specs_7 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), PredSpecs_42, (MR_Word) ((MR_Unsigned) 0U));
  }
  hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo2_41, &ProcMap0_43);
  {
    ...
    MR_hl_field(0, Var_48, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_5[1]));
    MR_hl_field(0, Var_48, 1) = ((MR_Box) (check_hlds__polymorphism__polymorphism_process_generated_pred_3_p_0_1));
    MR_hl_field(0, Var_48, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_48, 3) = ((MR_Box) (ExtraArgModes_35));
  }
  ...
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_4, PredInfo_45, STATE_VARIABLE_ModuleInfo_37_47, &STATE_VARIABLE_ModuleInfo_12_12);
  {
    ...
    MR_hl_field(0, Var_13, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_6[0]));
  ...
  mercury__require__expect_3_p_0(Var_13, (MR_String) "predicate \140check_hlds.polymorphism.polymorphism_process_generated_pred\'/3", (MR_String) "generated pred has errors");
  {
    ...
    MR_hl_field(0, Var_17, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_6[1]));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_40)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word Var_44 = ((MR_Word) ((MR_hl_field(1, MaybeFormatCall1_26, (MR_Integer) 0))));
      MR_Word Var_45;
      MR_Word Var_46;

      Context_27 = ((MR_Word) ((MR_hl_field(0, Var_44, (MR_Integer) 0))));
      OoMFormatStrsValues1_28 = ((MR_Word) ((MR_hl_field(0, Var_44, (MR_Integer) 1))));
      {
        Var_45 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_45, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_5[0]));
        MR_hl_field(0, Var_45, 1) = ((MR_Box) (check_hlds__polymorphism__polymorphism_update_arg_types_5_p_0_1));
        MR_hl_field(0, Var_45, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_45, 3) = ((MR_Box) (NumExtraHeadVars_19));
      }
      mercury__one_or_more__map_3_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_format_string_values_0), (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_format_string_values_0), Var_45, OoMFormatStrsValues1_28, &OoMFormatStrsValues2_29);
      {
        ...
        MR_hl_field(0, Var_46, 0) = ((MR_Box) (Context_27));
        MR_hl_field(0, Var_46, 1) = ((MR_Box) (OoMFormatStrsValues2_29));
      }
      {
        MaybeFormatCall2_30 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeFormatCall2_30, 0) = ((MR_Box) (Var_46));
      }
  ...
  if (succeeded)
  {
    hlds__hlds_pred__pred_info_set_existq_tvar_binding_3_p_0(Subn_34, PredInfo2_20, &PredInfo3_35);
    {
      ...
      *STATE_VARIABLE_ExistsCastPredIds_38 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (PredId_6));
      MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_ExistsCastPredIds_0_37));
    }
  }
  else
  {
