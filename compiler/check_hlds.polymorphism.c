  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_39)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__length_2_p_0((MR_Word) (&check_hlds__polymorphism_scalar_common_1[2]), ExtraHeadVarList_14, &NumExtraHeadVars_28);
      {
        Var_44 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&check_hlds__polymorphism_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (check_hlds__polymorphism__polymorphism_update_arg_types_5_p_0_1));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeInfo_51_51 = (MR_Word) (&check_hlds__polymorphism_scalar_common_1[3]);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__polymorphism__polymorphism_update_arg_types_5_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv7_STATE_VARIABLE_ExistsCastPredIds_37, ((MR_Word) (wrapper_arg_4)), &conv6_STATE_VARIABLE_ModuleInfo_39);
