  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_45)
{
  ...
  else
  {
    ...
    {
      MR_Word FormatCall1_30 = ((MR_Word) ((MR_hl_field(1, MaybeFormatCall1_29, (MR_Integer) 0))));
      MR_Word Context_31 = ((MR_Word) ((MR_hl_field(0, FormatCall1_30, (MR_Integer) 0))));
      MR_Word OoMFormatStrsValues1_32 = ((MR_Word) ((MR_hl_field(0, FormatCall1_30, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__polymorphism__polymorphism_update_arg_types_6_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv7_STATE_VARIABLE_ExistsCastPredIds_43, ((MR_Word) (wrapper_arg_4)), &conv6_STATE_VARIABLE_ModuleInfo_45);
