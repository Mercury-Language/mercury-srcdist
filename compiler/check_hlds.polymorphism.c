...
{
  {
    ...
    else
    {
      ...
      PredOrFunc_56 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_33);
      {
        ...
        MR_hl_field(MR_mktag(2), RHS_58, 0) = (MR_Box) (((((MR_Unsigned) (Purity_17) << (MR_Integer) 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) (PredOrFunc_56)))));
        ...
        MR_hl_field(MR_mktag(2), RHS_58, 5) = (MR_Box) ((MR_Unsigned) (LambdaDet_55));
