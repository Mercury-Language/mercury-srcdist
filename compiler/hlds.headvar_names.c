...
MR_decl_label3(hlds__headvar_names__find_headvar_names_in_clause_5_0, 2,5,6)
MR_decl_label8(hlds__headvar_names__find_headvar_names_in_goal_7_0, 4,7,11,10,15,9,20,23)
MR_decl_label6(hlds__headvar_names__find_headvar_names_in_goal_7_0, 25,22,28,30,19,2)
MR_decl_label6(hlds__headvar_names__goal_is_headvar_unification_4_0, 6,4,11,9,15,1)
MR_decl_label8(hlds__headvar_names__group_var_infos_8_0, 57,3,6,8,12,9,16,17)
MR_decl_label3(hlds__headvar_names__group_var_infos_8_0, 14,4,63)
MR_decl_label8(hlds__headvar_names__improve_single_clause_headvars_9_0, 99,3,5,12,16,23,25,26)
MR_decl_label8(hlds__headvar_names__improve_single_clause_headvars_9_0, 28,21,33,37,39,34,8,45)
MR_decl_label5(hlds__headvar_names__improve_single_clause_headvars_9_0, 44,49,51,48,4)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 2,5,6,7,8,43,10,13)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 15,16,17,18,19,20,21,22)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 23,26,27,12,33,34,35,36)
MR_decl_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0, 37,40)
...
MR_BEGIN_MODULE(hlds__headvar_names_module1)
	...
	MR_init_label8(hlds__headvar_names__improve_single_clause_headvars_9_0,99,3,5,12,16,23,25,26)
	MR_init_label8(hlds__headvar_names__improve_single_clause_headvars_9_0,28,21,33,37,39,34,8,45)
	MR_init_label5(hlds__headvar_names__improve_single_clause_headvars_9_0,44,49,51,48,4)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,39)
	...
	MR_np_call_localret_ent(svvarset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i51);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,34)
	...
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i99);
	}
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i48);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(svvarset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i51);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(7);
	MR_r3 = MR_sv(2);
...
MR_BEGIN_MODULE(hlds__headvar_names_module3)
	...
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,2,5,6,7,8,43,10,13)
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,15,16,17,18,19,20,21,22)
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,23,26,27,12,33,34,35,36)
	MR_init_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0,37,40)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,2)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__headvar_names__maybe_improve_headvar_names_3_0_i43);
	}
	MR_r1 = MR_sv(10);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,34)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_set_var_name_remap_3_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i35);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
...
MR_BEGIN_MODULE(hlds__headvar_names_module5)
	...
	MR_init_label3(hlds__headvar_names__find_headvar_names_in_clause_5_0,2,5,6)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__headvar_names_module6)
	...
	MR_init_label8(hlds__headvar_names__find_headvar_names_in_goal_7_0,4,7,11,10,15,9,20,23)
	MR_init_label6(hlds__headvar_names__find_headvar_names_in_goal_7_0,25,22,28,30,19,2)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,10)
	...
	MR_np_call_localret_ent(fn__set__init_0_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i15);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,20)
	...
	MR_r5 = MR_sv(2);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i23);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i22);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,22)
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i28);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(hlds__headvar_names_module7)
	...
	MR_init_label8(hlds__headvar_names__group_var_infos_8_0,57,3,6,8,12,9,16,17)
	MR_init_label3(hlds__headvar_names__group_var_infos_8_0,14,4,63)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,8)
	...
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i57);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,17)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		hlds__headvar_names__group_var_infos_8_0_i63);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,4)
	...
	MR_r4 = MR_sv(3);
	MR_r5 = MR_sv(4);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i57);
#ifdef MR_maybe_local_thread_engine_base
