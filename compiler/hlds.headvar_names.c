    ...
    if ((MaybeOtherVar_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        Var_31 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
        {
          ...
          MR_hl_field(MR_mktag(0), VarNameInfo_36, 1) = ((MR_Box) (Var_31));
        }
  ...
  else
  {
    ...
    else
    {
      ...
      if ((Var_77 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_46 = mercury__map__init_0_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&hlds__headvar_names_scalar_common_1[0]));
        hlds__headvar_names__improve_single_clause_headvars_9_p_0(Conj0_17, HeadVars0_10, (MR_Word) ((MR_Unsigned) 0U), VarSet0_11, &VarSet_18, Var_46, &Subst_19, (MR_Word) ((MR_Unsigned) 0U), &RevConj_20);
        ...
        Var_49 = mercury__list__reverse_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevConj_20);
        hlds__hlds_goal__conj_list_to_goal_3_p_0(Var_49, GoalInfo_23, &Goal_24);
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (SingleClause_27));
          MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_50, &ClausesRep_28);
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_3[0]));
          MR_hl_field(MR_mktag(0), Var_54, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_1));
          MR_hl_field(MR_mktag(0), Var_54, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_54, 3) = ((MR_Box) (VarSet0_11));
          MR_hl_field(MR_mktag(0), Var_54, 4) = ((MR_Box) (HeadVars0_10));
        }
        mercury__list__map2_4_p_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) (&hlds__headvar_names_scalar_common_2[0]), (MR_Word) (&hlds__headvar_names_scalar_common_1[1]), Var_54, Clauses0_12, &VarNameInfoMaps_34, &VarsInMapSets_35);
        ...
        hlds__hlds_pred__pred_info_set_var_name_remap_3_p_0(ConsensusMap_36, STATE_VARIABLE_PredInfo_0_40, &STATE_VARIABLE_PredInfo_55_55);
        ProcIds_37 = hlds__hlds_pred__pred_info_all_procids_1_f_0(STATE_VARIABLE_PredInfo_55_55);
        hlds__hlds_pred__pred_info_get_proc_table_2_p_0(STATE_VARIABLE_PredInfo_55_55, &ProcTable0_38);
        {
          Var_56 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_4[1]));
          MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_3));
          MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (ConsensusMap_36));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__headvar_names_scalar_common_2[1]), Var_56, ProcIds_37, ((MR_Box) (ProcTable0_38)), &conv5_ProcTable_39);
        ProcTable_39 = ((MR_Word) (conv5_ProcTable_39));
        hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_39, STATE_VARIABLE_PredInfo_55_55, STATE_VARIABLE_PredInfo_41);
      }
    }
  }
}
