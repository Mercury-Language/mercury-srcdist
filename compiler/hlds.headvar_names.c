...
{
  {
    ...
    hlds__headvar_names__group_var_infos_8_p_0(VarNameInfos_5, HeadVar_6, (MR_Word) ((MR_Integer) 0), &Inconsistents_18, (MR_Word) ((MR_Integer) 0), &Consistents_19, (MR_Word) ((MR_Integer) 0), &FunctorOnlys_20);
    if ((Inconsistents_18 == (MR_Word) ((MR_Integer) 0)))
      if ((Consistents_19 == (MR_Word) ((MR_Integer) 0)))
        *STATE_VARIABLE_ConsensusMap_11 = STATE_VARIABLE_ConsensusMap_0_10;
      else
      if ((FunctorOnlys_20 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) RHS_68)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          HeadVar_13 = LVar_67;
          MaybeOtherVar_14 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
      }
      else
    ...
    if (succeeded)
    {
      ...
      if ((MaybeOtherVar_14 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    else
    {
      ...
      if ((Clauses0_12 == (MR_Word) ((MR_Integer) 0)))
        *STATE_VARIABLE_PredInfo_41 = STATE_VARIABLE_PredInfo_0_40;
      else
      {
        ...
        if ((Var_77 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          hlds__headvar_names__improve_single_clause_headvars_9_p_0(Conj0_17, HeadVars0_10, (MR_Word) ((MR_Integer) 0), VarSet0_11, &VarSet_18, Var_51, &Subst_19, (MR_Word) ((MR_Integer) 0), &RevConj_20);
