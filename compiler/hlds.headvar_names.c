...
{
  {
    ...
    if (hlds__headvar_names__succeeded)
      *hlds__headvar_names__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word hlds__headvar_names__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__Var_8;
        MR_Integer hlds__headvar_names__Var_13 = (MR_Integer) hlds__headvar_names__Var_4;
        MR_Integer hlds__headvar_names__Var_14 = (MR_Integer) hlds__headvar_names__Var_6;
        ...
        if (hlds__headvar_names__succeeded)
          *hlds__headvar_names__HeadVar__1_1 = hlds__headvar_names__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &hlds__headvar_names_scalar_common_1[2], hlds__headvar_names__HeadVar__1_1, ((MR_Box) (hlds__headvar_names__Var_5)), ((MR_Box) (hlds__headvar_names__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (hlds__headvar_names__succeeded)
    ...
    else
      {
        ...
        MR_Word hlds__headvar_names__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 1)));

        hlds__headvar_names__succeeded = (hlds__headvar_names__Var_3 == hlds__headvar_names__Var_5);
        if (hlds__headvar_names__succeeded)
          {
            hlds__headvar_names__TypeInfo_9_9 = (MR_Word) &hlds__headvar_names_scalar_common_1[2];
            {
              hlds__headvar_names__succeeded = mercury__builtin__unify_2_p_0(hlds__headvar_names__TypeInfo_9_9, ((MR_Box) (hlds__headvar_names__Var_4)), ((MR_Box) (hlds__headvar_names__Var_6)));
            }
          }
      }
    return hlds__headvar_names__succeeded;
