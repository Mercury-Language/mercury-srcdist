  ...
  MR_Word * STATE_VARIABLE_FunctorOnlys_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_Inconsistents_0_3 = STATE_VARIABLE_Inconsistents_43_43;
...
{
  {
    MR_Word TypeCtorInfo_13_13 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
    MR_Word TypeCtorInfo_14_14 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
    MR_Word ProcInfo0_8;
    MR_Word ProcInfo_9;
    MR_Box conv0_ProcInfo0_8;

    mercury__map__lookup_3_p_0(TypeCtorInfo_13_13, TypeCtorInfo_14_14, STATE_VARIABLE_ProcTable_0_10, ((MR_Box) (ProcId_6)), &conv0_ProcInfo0_8);
    ...
    mercury__map__det_update_4_p_0(TypeCtorInfo_13_13, TypeCtorInfo_14_14, ((MR_Box) (ProcId_6)), ((MR_Box) (ProcInfo_9)), STATE_VARIABLE_ProcTable_0_10, STATE_VARIABLE_ProcTable_11);
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, (MR_Word) &hlds__headvar_names_scalar_common_2[1], Var_47, ProcIds_37, ((MR_Box) (ProcTable0_38)), &conv5_ProcTable_39);
