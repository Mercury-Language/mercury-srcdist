...
{
  {
    ...
    if (hlds__headvar_names__succeeded)
      *hlds__headvar_names__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word hlds__headvar_names__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__Var_8;
        MR_Integer hlds__headvar_names__Var_13 = (MR_Integer) hlds__headvar_names__ArgX1_4;
        MR_Integer hlds__headvar_names__Var_14 = (MR_Integer) hlds__headvar_names__ArgY1_5;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&hlds__headvar_names__Var_8, hlds__headvar_names__Var_13, hlds__headvar_names__Var_14);
        }
        hlds__headvar_names__succeeded = (hlds__headvar_names__Var_8 == (MR_Integer) 0);
        hlds__headvar_names__succeeded = !(hlds__headvar_names__succeeded);
        if (hlds__headvar_names__succeeded)
          *hlds__headvar_names__HeadVar__1_1 = hlds__headvar_names__Var_8;
        else
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &hlds__headvar_names_scalar_common_1[2], hlds__headvar_names__HeadVar__1_1, ((MR_Box) (hlds__headvar_names__ArgX2_6)), ((MR_Box) (hlds__headvar_names__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (hlds__headvar_names__succeeded)
    ...
    else
      {
        ...
        MR_Word hlds__headvar_names__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__headvar_names__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word hlds__headvar_names__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__HeadVar__2_2, (MR_Integer) 1)));

        hlds__headvar_names__succeeded = (hlds__headvar_names__ArgX1_3 == hlds__headvar_names__ArgY1_4);
        if (hlds__headvar_names__succeeded)
          {
            hlds__headvar_names__TypeInfo_9_9 = (MR_Word) &hlds__headvar_names_scalar_common_1[2];
            {
              hlds__headvar_names__succeeded = mercury__builtin__unify_2_p_0(hlds__headvar_names__TypeInfo_9_9, ((MR_Box) (hlds__headvar_names__ArgX2_5)), ((MR_Box) (hlds__headvar_names__ArgY2_6)));
            }
          }
      }
    return hlds__headvar_names__succeeded;
      ...
      if ((hlds__headvar_names__FunctorOnlys_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          MR_Word hlds__headvar_names__Var_32;
          ...
          if (hlds__headvar_names__succeeded)
            {
              ...
              hlds__headvar_names__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__SortedConsistents_25, (MR_Integer) 1)));
              hlds__headvar_names__succeeded = (hlds__headvar_names__Var_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
          if (hlds__headvar_names__succeeded)
            {
              {
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((hlds__headvar_names__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
                    ...
                    if (hlds__headvar_names__succeeded)
                      {
                        ...
                        MR_Word hlds__headvar_names__Var_38;
                        ...
                        if (hlds__headvar_names__succeeded)
                          {
                            ...
                            hlds__headvar_names__Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__VarNameList_29, (MR_Integer) 1)));
                            hlds__headvar_names__succeeded = (hlds__headvar_names__Var_38 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                        if (hlds__headvar_names__succeeded)
                          {
            ...
            {
              MR_Word hlds__headvar_names__next_value_of_HeadVar__1_1 = hlds__headvar_names__VarNameInfoMaps_20;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_Inconsistents_0_3 = hlds__headvar_names__STATE_VARIABLE_Inconsistents_43_43;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_Consistents_0_5 = hlds__headvar_names__STATE_VARIABLE_Consistents_39_39;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_FunctorOnlys_0_7 = hlds__headvar_names__STATE_VARIABLE_FunctorOnlys_37_37;

              hlds__headvar_names__STATE_VARIABLE_FunctorOnlys_0_7 = hlds__headvar_names__next_value_of_STATE_VARIABLE_FunctorOnlys_0_7;
              hlds__headvar_names__STATE_VARIABLE_Consistents_0_5 = hlds__headvar_names__next_value_of_STATE_VARIABLE_Consistents_0_5;
              hlds__headvar_names__STATE_VARIABLE_Inconsistents_0_3 = hlds__headvar_names__next_value_of_STATE_VARIABLE_Inconsistents_0_3;
              hlds__headvar_names__HeadVar__1_1 = hlds__headvar_names__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
...
{
  {
    ...
    MR_Word hlds__headvar_names__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Goal_10, (MR_Integer) 1)));
    MR_Word hlds__headvar_names__Var_69;
    MR_Word hlds__headvar_names__Var_70;
    MR_Word hlds__headvar_names__Var_71;
    ...
    if (hlds__headvar_names__succeeded)
      {
        ...
        hlds__headvar_names__Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_65, (MR_Integer) 2)));
        hlds__headvar_names__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_65, (MR_Integer) 3)));
        hlds__headvar_names__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_65, (MR_Integer) 4)));
        ...
        if ((hlds__headvar_names__MaybeOtherVar_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            if (hlds__headvar_names__succeeded)
              ...
              {
                MR_Word hlds__headvar_names__Var_34;
                MR_Word hlds__headvar_names__VarNameInfo_36;

                {
                  hlds__headvar_names__Var_34 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0);
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__VarNameInfo_36, 1) = ((MR_Box) (hlds__headvar_names__Var_34));
                }
                {
...
{
  {
    ...
    MR_Word hlds__headvar_names__Var_13;
    MR_Word hlds__headvar_names__Var_14;
    MR_Word hlds__headvar_names__Var_15;
    ...
    {
      hlds__headvar_names__Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_13, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_13, 1) = ((MR_Box) (hlds__headvar_names__find_headvar_names_in_clause_5_p_0_1));
      MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_13, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_13, 3) = ((MR_Box) (hlds__headvar_names__VarSet_6));
      MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_13, 4) = ((MR_Box) (hlds__headvar_names__HeadVars_7));
    }
    hlds__headvar_names__TypeInfo_21_21 = (MR_Word) &hlds__headvar_names_scalar_common_1[0];
    {
      hlds__headvar_names__Var_14 = mercury__map__init_0_f_0(hlds__headvar_names__TypeInfo_21_21, (MR_Word) &hlds__headvar_names__hlds__headvar_names__type_ctor_info_var_name_info_0);
    }
    {
      hlds__headvar_names__Var_15 = mercury__set__init_0_f_0(hlds__headvar_names__TypeInfo_21_21);
    }
    {
      mercury__list__foldl2_6_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &hlds__headvar_names_scalar_common_2[0], (MR_Word) &hlds__headvar_names_scalar_common_1[1], hlds__headvar_names__Var_13, hlds__headvar_names__Conj_12, ((MR_Box) (hlds__headvar_names__Var_14)), &hlds__headvar_names__conv3_VarNameInfoMap_9, ((MR_Box) (hlds__headvar_names__Var_15)), &hlds__headvar_names__conv2_VarsInMap_10);
    }
...
{
  {
    ...
    MR_Word hlds__headvar_names__Var_42;
    MR_Word hlds__headvar_names__Var_43;

    {
      libs__globals__get_op_mode_2_p_0(hlds__headvar_names__Globals_4, &hlds__headvar_names__OpMode_6);
    }
    hlds__headvar_names__succeeded = ((MR_tag((MR_Word) hlds__headvar_names__OpMode_6)) == (MR_mktag((MR_Integer) 3)));
    if (hlds__headvar_names__succeeded)
      {
        hlds__headvar_names__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__headvar_names__OpMode_6, (MR_Integer) 0)));
        hlds__headvar_names__succeeded = ((MR_tag((MR_Word) hlds__headvar_names__Var_42)) == (MR_mktag((MR_Integer) 1)));
        if (hlds__headvar_names__succeeded)
          {
            hlds__headvar_names__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_42, (MR_Integer) 0)));
            hlds__headvar_names__succeeded = (hlds__headvar_names__Var_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
      }
    if (hlds__headvar_names__succeeded)
    ...
    else
      {
        ...
        if ((hlds__headvar_names__Clauses0_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *hlds__headvar_names__STATE_VARIABLE_PredInfo_41 = hlds__headvar_names__STATE_VARIABLE_PredInfo_0_40;
          ...
          {
            MR_Word hlds__headvar_names__Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__Clauses0_12, (MR_Integer) 1)));
            MR_Word hlds__headvar_names__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__Clauses0_12, (MR_Integer) 0)));

            if ((hlds__headvar_names__Var_77 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                MR_Word hlds__headvar_names__Var_51;
                MR_Word hlds__headvar_names__Var_54;
                MR_Word hlds__headvar_names__Var_55;
                MR_Word hlds__headvar_names__Var_15;
                MR_Word hlds__headvar_names__Var_58;
                MR_Word hlds__headvar_names__Var_60;
                MR_Word hlds__headvar_names__Var_61;
                MR_Word hlds__headvar_names__Var_62;
                MR_Word hlds__headvar_names__Var_59;

                {
                  hlds__headvar_names__Goal0_14 = hlds__hlds_clauses__clause_body_1_f_0(hlds__headvar_names__Var_78);
                }
                hlds__headvar_names__Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Goal0_14, (MR_Integer) 0)));
                ...
                {
                  hlds__headvar_names__Var_51 = mercury__map__init_0_f_0(hlds__headvar_names__TypeInfo_63_63, hlds__headvar_names__TypeInfo_63_63);
                }
                {
                  hlds__headvar_names__improve_single_clause_headvars_9_p_0(hlds__headvar_names__Conj0_17, hlds__headvar_names__HeadVars0_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__headvar_names__VarSet0_11, &hlds__headvar_names__VarSet_18, hlds__headvar_names__Var_51, &hlds__headvar_names__Subst_19, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &hlds__headvar_names__RevConj_20);
                }
                {
                ...
                {
                  hlds__headvar_names__Var_54 = mercury__list__reverse_1_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, hlds__headvar_names__RevConj_20);
                }
                {
                  hlds__hlds_goal__conj_list_to_goal_3_p_0(hlds__headvar_names__Var_54, hlds__headvar_names__GoalInfo_23, &hlds__headvar_names__Goal_24);
                }
                {
                ...
                hlds__headvar_names__Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_78, (MR_Integer) 0)));
                hlds__headvar_names__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_78, (MR_Integer) 1)));
                hlds__headvar_names__Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_78, (MR_Integer) 2)));
                hlds__headvar_names__Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_78, (MR_Integer) 3)));
                hlds__headvar_names__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_78, (MR_Integer) 4)));
                {
                  hlds__headvar_names__SingleClause_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__SingleClause_27, 0) = ((MR_Box) (hlds__headvar_names__Var_58));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__SingleClause_27, 1) = ((MR_Box) (hlds__headvar_names__Goal_24));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__SingleClause_27, 2) = ((MR_Box) (hlds__headvar_names__Var_60));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__SingleClause_27, 3) = ((MR_Box) (hlds__headvar_names__Var_61));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__SingleClause_27, 4) = ((MR_Box) (hlds__headvar_names__Var_62));
                }
                {
                  hlds__headvar_names__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_55, 0) = ((MR_Box) (hlds__headvar_names__SingleClause_27));
                  MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  hlds__hlds_clauses__set_clause_list_2_p_0(hlds__headvar_names__Var_55, &hlds__headvar_names__ClausesRep_28);
                }
                {
            ...
            else
              {
                ...
                MR_Word hlds__headvar_names__Var_45;
                MR_Word hlds__headvar_names__STATE_VARIABLE_PredInfo_46_46;
                MR_Word hlds__headvar_names__Var_47;
                MR_Word hlds__headvar_names__VarsInMapSet_82;
                MR_Word hlds__headvar_names__VarsInMaps_83;
                MR_Word hlds__headvar_names__Var_84;
                MR_Word hlds__headvar_names__Var_85;
                MR_Box hlds__headvar_names__conv3_ConsensusMap_36;
                MR_Box hlds__headvar_names__conv5_ProcTable_39;

                {
                  hlds__headvar_names__Var_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_45, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_3[0]));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_45, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_1));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_45, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_45, 3) = ((MR_Box) (hlds__headvar_names__VarSet0_11));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_45, 4) = ((MR_Box) (hlds__headvar_names__HeadVars0_10));
                }
                {
                  mercury__list__map2_4_p_0((MR_Word) &hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0, (MR_Word) &hlds__headvar_names_scalar_common_2[0], (MR_Word) &hlds__headvar_names_scalar_common_1[1], hlds__headvar_names__Var_45, hlds__headvar_names__Clauses0_12, &hlds__headvar_names__VarNameInfoMaps_34, &hlds__headvar_names__VarsInMapSets_35);
                }
                ...
                {
                  hlds__headvar_names__Var_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_84, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_4[0]));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_84, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_2));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_84, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_84, 3) = ((MR_Box) (hlds__headvar_names__VarNameInfoMaps_34));
                }
                {
                  hlds__headvar_names__Var_85 = mercury__map__init_0_f_0(hlds__headvar_names__TypeInfo_11_86, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0);
                }
                {
                  mercury__list__foldl_4_p_0(hlds__headvar_names__TypeInfo_11_86, (MR_Word) &hlds__headvar_names_scalar_common_2[2], hlds__headvar_names__Var_84, hlds__headvar_names__VarsInMaps_83, ((MR_Box) (hlds__headvar_names__Var_85)), &hlds__headvar_names__conv3_ConsensusMap_36);
                }
                ...
                {
                  hlds__headvar_names__Var_47 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_47, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_4[1]));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_47, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_3));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_47, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(0), hlds__headvar_names__Var_47, 3) = ((MR_Box) (hlds__headvar_names__ConsensusMap_36));
                }
                {
                  mercury__list__foldl_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__headvar_names_scalar_common_2[1], hlds__headvar_names__Var_47, hlds__headvar_names__ProcIds_37, ((MR_Box) (hlds__headvar_names__ProcTable0_38)), &hlds__headvar_names__conv5_ProcTable_39);
                }
...
{
  {
    ...
    {
      MR_Word hlds__headvar_names__Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), (hlds__headvar_names__env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__OtherGoal_54, (MR_Integer) 0)));
    ...
    while (MR_TRUE)
      {
        ...
        if ((hlds__headvar_names__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word hlds__headvar_names__Var_44;
            MR_Word hlds__headvar_names__GoalExpr_75;
            MR_Word hlds__headvar_names__LVar_77;
            MR_Word hlds__headvar_names__RHS_78;
            MR_Word hlds__headvar_names__Var_76;
            MR_Word hlds__headvar_names__Var_79;
            MR_Word hlds__headvar_names__Var_80;
            MR_Word hlds__headvar_names__Var_81;
            ...
            hlds__headvar_names__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__headvar_names__Goal_21, (MR_Integer) 1)));
            ...
            if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
              {
                ...
                hlds__headvar_names__Var_79 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_75, (MR_Integer) 2)));
                hlds__headvar_names__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_75, (MR_Integer) 3)));
                hlds__headvar_names__Var_81 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__GoalExpr_75, (MR_Integer) 4)));
                    ...
                    if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                      {
                        ...
                        hlds__headvar_names__Var_44 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                    ...
                    if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                      {
                        (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28 = hlds__headvar_names__LVar_77;
                        {
                          hlds__headvar_names__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_44, 0) = ((MR_Box) (hlds__headvar_names__RVar_82));
                        }
                        (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = MR_TRUE;
                      }
                    else
                        ...
                        if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                          {
                            ...
                            {
                              hlds__headvar_names__Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_44, 0) = ((MR_Box) (hlds__headvar_names__LVar_77));
                            }
                            (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = MR_TRUE;
                          }
                      }
                ...
                if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                  {
                    (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) hlds__headvar_names__Var_44)) == (MR_mktag((MR_Integer) 1)));
                    if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                      hlds__headvar_names__OtherVar_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__headvar_names__Var_44, (MR_Integer) 0)));
                  }
              }
            if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
              {
                ...
                if ((hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
                  {
                    ...
                    MR_String hlds__headvar_names__Var_35;
            ...
            /* direct tailcall eliminated */
            {
              MR_Word hlds__headvar_names__next_value_of_HeadVar__1_1 = (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__Conj0_22;
              MR_Word hlds__headvar_names__next_value_of_SeenVars0_3 = hlds__headvar_names__SeenVars_34;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_VarSet_0_4 = hlds__headvar_names__STATE_VARIABLE_VarSet_46_46;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_Subst_0_6 = hlds__headvar_names__STATE_VARIABLE_Subst_45_45;
              MR_Word hlds__headvar_names__next_value_of_STATE_VARIABLE_RevConj_0_8 = hlds__headvar_names__STATE_VARIABLE_RevConj_47_47;

              (hlds__headvar_names__env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__STATE_VARIABLE_RevConj_0_8 = hlds__headvar_names__next_value_of_STATE_VARIABLE_RevConj_0_8;
              hlds__headvar_names__STATE_VARIABLE_Subst_0_6 = hlds__headvar_names__next_value_of_STATE_VARIABLE_Subst_0_6;
              hlds__headvar_names__STATE_VARIABLE_VarSet_0_4 = hlds__headvar_names__next_value_of_STATE_VARIABLE_VarSet_0_4;
              hlds__headvar_names__SeenVars0_3 = hlds__headvar_names__next_value_of_SeenVars0_3;
              hlds__headvar_names__HeadVar__1_1 = hlds__headvar_names__next_value_of_HeadVar__1_1;
            }
            continue;
          }
