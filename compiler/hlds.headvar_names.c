    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_77 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          Var_51 = mercury__map__init_0_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&hlds__headvar_names_scalar_common_1[0]));
          ...
          hlds__hlds_args__apply_renaming_to_proc_arg_vector_3_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), Subst_19, HeadVars0_10, &HeadVars_25);
        ...
        else
        {
          ...
          VarsInMapSet_82 = mercury__set__union_list_1_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSets_35);
          mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSet_82, &VarsInMaps_83);
          {
          ...
          Var_85 = mercury__map__init_0_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
          mercury__list__foldl_4_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&hlds__headvar_names_scalar_common_2[2]), Var_84, VarsInMaps_83, ((MR_Box) (Var_85)), &conv3_ConsensusMap_36);
