...
{
  {
    ...
    hlds__headvar_names__group_var_infos_8_p_0(VarNameInfos_5, HeadVar_6, (MR_Word) ((MR_Unsigned) 0U), &Inconsistents_18, (MR_Word) ((MR_Unsigned) 0U), &Consistents_19, (MR_Word) ((MR_Unsigned) 0U), &FunctorOnlys_20);
    if ((Inconsistents_18 == (MR_Word) ((MR_Unsigned) 0U)))
      if ((Consistents_19 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_ConsensusMap_11 = STATE_VARIABLE_ConsensusMap_0_10;
      else
      if ((FunctorOnlys_20 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        succeeded = ((MR_tag((MR_Word) SortedConsistents_25)) == (MR_Integer) 1);
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_FunctorOnlys_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word UnifiedFunctor_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarInfo_25, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word VarNameSet_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarInfo_25, (MR_Integer) 1))));
        MR_Integer NameCount_28;
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarInfo_25, (MR_Integer) 0)));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) VarNameList_29)) == (MR_Integer) 1);
            if (succeeded)
            {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) RHS_68)) == (MR_Integer) 1))
      {
      ...
      if (((MR_tag((MR_Word) RHS_68)) == (MR_Integer) 0))
      {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeOtherVar_14 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarNameInfo0_15, (MR_Integer) 0)));

          {
            VarNameInfo_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), VarNameInfo_18, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        ...
        else
        {
          ...
          Var_34 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
          {
            ...
            MR_hl_field(MR_mktag(0), VarNameInfo_36, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarNameInfo0_41, (MR_Integer) 0)));
            ...
            mercury__set__insert_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (OtherVarName_20)), VarNames0_22, &VarNames_37);
            {
              ...
              MR_hl_field(MR_mktag(0), VarNameInfo_38, 0) = (MR_Box) (packed_args_1);
          ...
          else
          {
            ...
            VarNames_39 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (OtherVarName_20)));
            {
              ...
              MR_hl_field(MR_mktag(0), VarNameInfo_40, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
...
{
  {
    ...
    else
    {
      ...
      if ((Clauses0_12 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_PredInfo_41 = STATE_VARIABLE_PredInfo_0_40;
      else
      {
        ...
        if ((Var_77 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          hlds__headvar_names__improve_single_clause_headvars_9_p_0(Conj0_17, HeadVars0_10, (MR_Word) ((MR_Unsigned) 0U), VarSet0_11, &VarSet_18, Var_51, &Subst_19, (MR_Word) ((MR_Unsigned) 0U), &RevConj_20);
...
{
  {
    ...
    while (MR_TRUE)
    {
      ...
      else
      {
        ...
        (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) GoalExpr_75)) == (MR_Integer) 1);
        if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
        {
          ...
          if (((MR_tag((MR_Word) RHS_78)) == (MR_Integer) 1))
          {
          ...
          if (((MR_tag((MR_Word) RHS_78)) == (MR_Integer) 0))
          {
          ...
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_44)) == (MR_Integer) 1);
            if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
