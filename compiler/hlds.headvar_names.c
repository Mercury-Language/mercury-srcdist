...
MR_decl_label3(hlds__headvar_names__find_headvar_names_in_clause_5_0, 2,3,4)
MR_decl_label8(hlds__headvar_names__find_headvar_names_in_goal_7_0, 4,6,10,9,13,8,17,20)
MR_decl_label6(hlds__headvar_names__find_headvar_names_in_goal_7_0, 22,19,24,25,16,2)
MR_decl_label6(hlds__headvar_names__goal_is_headvar_unification_4_0, 6,5,8,4,12,1)
MR_decl_label8(hlds__headvar_names__group_var_infos_8_0, 53,5,7,11,8,14,15,12)
MR_decl_label3(hlds__headvar_names__group_var_infos_8_0, 4,58,3)
MR_decl_label8(hlds__headvar_names__improve_single_clause_headvars_9_0, 92,5,11,14,21,23,24,25)
MR_decl_label8(hlds__headvar_names__improve_single_clause_headvars_9_0, 19,28,32,34,29,8,39,38)
MR_decl_label5(hlds__headvar_names__improve_single_clause_headvars_9_0, 43,45,42,4,3)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 2,5,6,7,8,34,10,13)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 14,15,16,17,18,19,20,21)
MR_decl_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0, 22,23,24,12,26,27,28,29)
MR_decl_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0, 30,31)
...
MR_decl_label3(fn__hlds__headvar_names__find_consensus_headvar_names_2_0, 2,3,4)
...
MR_BEGIN_MODULE(hlds__headvar_names_module0)
	...
	MR_init_label6(hlds__headvar_names__goal_is_headvar_unification_4_0,6,5,8,4,12,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__goal_is_headvar_unification_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__goal_is_headvar_unification_4_0_i5);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__headvar_names__goal_is_headvar_unification_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__goal_is_headvar_unification_4_0_i8);
MR_def_label(hlds__headvar_names__goal_is_headvar_unification_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__goal_is_headvar_unification_4_0_i1);
	}
...
MR_def_label(hlds__headvar_names__goal_is_headvar_unification_4_0,4)
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__goal_is_headvar_unification_4_0_i12);
MR_def_label(hlds__headvar_names__goal_is_headvar_unification_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__goal_is_headvar_unification_4_0_i1);
	}
...
MR_BEGIN_MODULE(hlds__headvar_names_module1)
	...
	MR_init_label8(hlds__headvar_names__improve_single_clause_headvars_9_0,92,5,11,14,21,23,24,25)
	MR_init_label8(hlds__headvar_names__improve_single_clause_headvars_9_0,19,28,32,34,29,8,39,38)
	MR_init_label5(hlds__headvar_names__improve_single_clause_headvars_9_0,43,45,42,4,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,5)
	...
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i11);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,14)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(hlds__headvar_names__improve_single_clause_headvars_9_0_i19);
	...
	MR_np_call_localret_ent(list__member_2_1,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i23);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,23)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i24);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,25)
	...
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i8);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(10);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(11);
	{
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,28)
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i32);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i29);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(8);
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i34);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,34)
	...
	MR_np_call_localret_ent(svvarset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i45);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_r5 = MR_r1;
	...
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i92);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i38);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r3 = MR_r2;
	MR_r2 = MR_sv(8);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i42);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r3 = MR_r2;
	MR_r2 = MR_sv(9);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,45)
	...
	MR_succip_word = MR_sv(15);
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i92);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(7);
	MR_r3 = MR_sv(2);
...
MR_BEGIN_MODULE(hlds__headvar_names_module2)
	...
	MR_init_label3(fn__hlds__headvar_names__find_consensus_headvar_names_2_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_static(fn__hlds__headvar_names__find_consensus_headvar_names_2_0)
	...
	MR_np_call_localret_ent(fn__set__union_list_1_0,
		fn__hlds__headvar_names__find_consensus_headvar_names_2_0_i2);
MR_def_label(fn__hlds__headvar_names__find_consensus_headvar_names_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__headvar_names_module3)
	...
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,2,5,6,7,8,34,10,13)
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,14,15,16,17,18,19,20,21)
	MR_init_label8(hlds__headvar_names__maybe_improve_headvar_names_3_0,22,23,24,12,26,27,28,29)
	MR_init_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0,30,31)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,2)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__headvar_names__maybe_improve_headvar_names_3_0_i34);
	}
	MR_r1 = MR_sv(10);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,8)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__maybe_improve_headvar_names_3_0_i10);
	}
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(10);
	MR_decr_sp_and_return(12);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__maybe_improve_headvar_names_3_0_i12);
	}
	MR_tempr1 = MR_tempr3;
	MR_sv(2) = MR_r1;
	...
	MR_sv(7) = MR_ctfield(0, MR_ctfield(0, MR_tempr2, 1), 1);
	MR_r1 = MR_ctfield(0, MR_tempr2, 1);
	}
	MR_np_call_localret_ent(hlds__hlds_goal__goal_to_conj_list_2_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i13);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__map2_4_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i26);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,30)
	...
	MR_np_call_localret_ent(list__foldl_4_1,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i31);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(12);
	MR_decr_sp(12);
...
MR_BEGIN_MODULE(hlds__headvar_names_module5)
	...
	MR_init_label3(hlds__headvar_names__find_headvar_names_in_clause_5_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_clause_5_0,3)
	...
	MR_np_call_localret_ent(fn__set__init_0_0,
		hlds__headvar_names__find_headvar_names_in_clause_5_0_i4);
MR_def_label(hlds__headvar_names__find_headvar_names_in_clause_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,4);
...
MR_BEGIN_MODULE(hlds__headvar_names_module6)
	...
	MR_init_label8(hlds__headvar_names__find_headvar_names_in_goal_7_0,4,6,10,9,13,8,17,20)
	MR_init_label6(hlds__headvar_names__find_headvar_names_in_goal_7_0,22,19,24,25,16,2)
MR_BEGIN_CODE
...
MR_def_static(hlds__headvar_names__find_headvar_names_in_goal_7_0)
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(hlds__headvar_names__goal_is_headvar_unification_4_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i4);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_np_call_localret_ent(f_115_118_115_101_116_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_105_110_115_101_114_116_95_95_91_84_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i6);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(3),0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i8);
	}
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i10);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i9);
	}
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(f_115_118_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i25);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i16);
	}
	MR_sv(1) = MR_r2;
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
	...
	MR_r5 = MR_sv(2);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i20);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i19);
	}
	MR_r3 = MR_sv(1);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,22)
	...
	MR_np_call_localret_ent(f_115_118_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i25);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i24);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(7);
...
MR_BEGIN_MODULE(hlds__headvar_names_module7)
	...
	MR_init_label8(hlds__headvar_names__group_var_infos_8_0,53,5,7,11,8,14,15,12)
	MR_init_label3(hlds__headvar_names__group_var_infos_8_0,4,58,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,7)
	...
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i53);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,8)
	...
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(set__to_sorted_list_2_0,
		hlds__headvar_names__group_var_infos_8_0_i14);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i15);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("headvar_names.m", 15);
	MR_r2 = (MR_Word) MR_string_const("group_var_infos: bad singleton set", 34);
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		hlds__headvar_names__group_var_infos_8_0_i58);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,4)
	...
	MR_r4 = MR_sv(3);
	MR_r5 = MR_sv(4);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i53);
...
void mercury__hlds__headvar_names__write_out_proc_statics(FILE *fp);
#endif
