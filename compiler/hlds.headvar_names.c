...
MR_decl_label10(hlds__headvar_names__improve_single_clause_headvars_9_0, 119,3,5,12,16,23,25,26,27,21)
MR_decl_label10(hlds__headvar_names__improve_single_clause_headvars_9_0, 32,37,39,33,8,45,44,49,51,48)
...
MR_BEGIN_MODULE(hlds__headvar_names_module1)
	...
	MR_init_label10(hlds__headvar_names__improve_single_clause_headvars_9_0,119,3,5,12,16,23,25,26,27,21)
	MR_init_label10(hlds__headvar_names__improve_single_clause_headvars_9_0,32,37,39,33,8,45,44,49,51,48)
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,26)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i27);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i33);
	}
	MR_r1 = MR_sv(8);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(2);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,33)
	...
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i119);
	}
