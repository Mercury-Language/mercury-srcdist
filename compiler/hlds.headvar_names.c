...
struct hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0_s {
  ...
  MR_Word hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__TypeCtorInfo__62_62;
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&hlds__headvar_names_scalar_common_1[2]);
...
{
  MR_bool succeeded;
  MR_Word Inconsistents_15;
  MR_Word Consistents_16;
  MR_Word FunctorOnlys_17;

  hlds__headvar_names__group_var_infos_8_p_0(VarNameInfos_5, HeadVar_6, (MR_Word) ((MR_Unsigned) 0U), &Inconsistents_15, (MR_Word) ((MR_Unsigned) 0U), &Consistents_16, (MR_Word) ((MR_Unsigned) 0U), &FunctorOnlys_17);
  if ((Inconsistents_15 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((Consistents_16 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_ConsensusMap_11 = STATE_VARIABLE_ConsensusMap_0_10;
    else
    if ((FunctorOnlys_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word SortedConsistents_22;
      MR_String ConsensusName_23;
      MR_Word Var_29;

      mercury__list__sort_and_remove_dups_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Consistents_16, &SortedConsistents_22);
      succeeded = (SortedConsistents_22 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ConsensusName_23 = ((MR_String) ((MR_hl_field(MR_mktag(1), SortedConsistents_22, (MR_Integer) 0))));
        Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SortedConsistents_22, (MR_Integer) 1))));
        succeeded = (Var_29 == (MR_Word) ((MR_Unsigned) 0U));
      }
      if (succeeded)
        mercury__map__det_insert_4_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (HeadVar_6)), ((MR_Box) (ConsensusName_23)), STATE_VARIABLE_ConsensusMap_0_10, STATE_VARIABLE_ConsensusMap_11);
      else
        *STATE_VARIABLE_ConsensusMap_11 = STATE_VARIABLE_ConsensusMap_0_10;
    }
    else
  ...
  MR_Word * STATE_VARIABLE_VarsInMap_26)
{
  ...
  MR_Word GoalExpr_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_10, (MR_Integer) 0))));
  MR_Word LVar_63;
  MR_Word RHS_64;

  succeeded = ((MR_tag((MR_Word) GoalExpr_61)) == (MR_Integer) 1);
  if (succeeded)
  {
    LVar_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_61, (MR_Integer) 0))));
    RHS_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_61, (MR_Integer) 1))));
    if (((MR_tag((MR_Word) RHS_64)) == (MR_Integer) 1))
    {
      succeeded = hlds__hlds_args__proc_arg_vector_member_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), HeadVars_9, ((MR_Box) (LVar_63)));
      if (succeeded)
      {
        HeadVar_13 = LVar_63;
    ...
    if (((MR_tag((MR_Word) RHS_64)) == (MR_Integer) 0))
    {
      MR_Word RVar_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RHS_64, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        HeadVar_13 = LVar_63;
        {
          ...
          MR_hl_field(MR_mktag(1), MaybeOtherVar_14, 0) = ((MR_Box) (RVar_68));
        }
        succeeded = MR_TRUE;
      }
      else
      {
        succeeded = hlds__hlds_args__proc_arg_vector_member_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), HeadVars_9, ((MR_Box) (RVar_68)));
        if (succeeded)
        {
          HeadVar_13 = RVar_68;
          {
            MaybeOtherVar_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeOtherVar_14, 0) = ((MR_Box) (LVar_63));
          }
          succeeded = MR_TRUE;
        }
      }
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        VarsInMapSet_79 = mercury__set__union_list_1_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSets_35);
        mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSet_79, &VarsInMaps_80);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_3_p_0_2));
          MR_hl_field(MR_mktag(0), Var_81, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_81, 3) = ((MR_Box) (VarNameInfoMaps_34));
        }
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&hlds__headvar_names_scalar_common_2[2]), Var_81, VarsInMaps_80, ((MR_Box) (Var_82)), &conv3_ConsensusMap_36);
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__TypeCtorInfo__62_62 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
    (env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = parse_tree__set_of_var__member_2_p_0((env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__TypeCtorInfo__62_62, (env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__OtherNonLocals_33, (env_ptr)->hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28);
  ...
  MR_Word * STATE_VARIABLE_RevConj_9)
{
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      GoalExpr_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_21, (MR_Integer) 0))));
      Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_21, (MR_Integer) 1))));
      (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) GoalExpr_71)) == (MR_Integer) 1);
      if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
      {
        LVar_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_71, (MR_Integer) 0))));
        RHS_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_71, (MR_Integer) 1))));
        Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_71, (MR_Integer) 2))));
        Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_71, (MR_Integer) 3))));
        Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_71, (MR_Integer) 4))));
        if (((MR_tag((MR_Word) RHS_74)) == (MR_Integer) 1))
        {
          (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = hlds__hlds_args__proc_arg_vector_member_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), HeadVars_2, ((MR_Box) (LVar_73)));
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28 = LVar_73;
            Var_44 = (MR_Word) ((MR_Unsigned) 0U);
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = MR_TRUE;
          }
        }
        else
        if (((MR_tag((MR_Word) RHS_74)) == (MR_Integer) 0))
        {
          MR_Word RVar_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RHS_74, (MR_Integer) 0))));
          ...
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28 = LVar_73;
            {
              ...
              MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (RVar_78));
            }
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = MR_TRUE;
          }
          else
          {
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = hlds__hlds_args__proc_arg_vector_member_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), HeadVars_2, ((MR_Box) (RVar_78)));
            if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
            {
              (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28 = RVar_78;
              {
                Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (LVar_73));
              }
              (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = MR_TRUE;
            }
          }
      ...
      if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
      {
        ...
        if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
        {
          TypeInfo__59_59 = (MR_Word) (&hlds__headvar_names_scalar_common_1[0]);
          (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = mercury__list__member_2_p_0(TypeInfo__59_59, ((MR_Box) (OtherVar_29)), SeenVars0_3);
          (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = !((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded);
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
        ...
        if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
            TypeCtorInfo__65_65 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
            (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo__65_65, STATE_VARIABLE_VarSet_0_4, (env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__HeadVar_28, &HeadVarName_36);
          }
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
