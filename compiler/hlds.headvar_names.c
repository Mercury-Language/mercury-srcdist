  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarInfo_25, (MR_Integer) 0)));
        ...
        if (succeeded)
        {
          switch (UnifiedFunctor_26) {
            ...
            case (MR_Integer) 1:
              {
                STATE_VARIABLE_FunctorOnlys_37_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              {
                STATE_VARIABLE_Consistents_39_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            {
              STATE_VARIABLE_Inconsistents_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) RHS_68)) == (MR_Integer) 0))
      {
        ...
        if (succeeded)
        {
          HeadVar_13 = LVar_67;
          {
            MaybeOtherVar_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      if ((MaybeOtherVar_14 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarNameInfo0_15, (MR_Integer) 0)));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            MR_Word UnifiedFunctor_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarNameInfo0_41, (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Word VarNames0_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarNameInfo0_41, (MR_Integer) 1))));
            MR_Word VarNames_37;
            MR_Word VarNameInfo_38;
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarNameInfo0_41, (MR_Integer) 0)));
            ...
            mercury__set__insert_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (OtherVarName_20)), VarNames0_22, &VarNames_37);
            {
              ...
              MR_hl_field(MR_mktag(0), VarNameInfo_38, 0) = (MR_Box) ((MR_Unsigned) (UnifiedFunctor_21));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_77 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            SingleClause_27 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).hlds__headvar_names__improve_single_clause_headvars_9_p_0_env_0__succeeded)
          {
            ...
            {
              SeenVars_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            {
              STATE_VARIABLE_RevConj_47_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
