...
MR_decl_label4(hlds__headvar_names__find_headvar_names_in_clause_5_0, 2,3,5,6)
MR_decl_label10(hlds__headvar_names__find_headvar_names_in_goal_7_0, 7,6,11,10,14,5,18,22,21,26)
MR_decl_label10(hlds__headvar_names__find_headvar_names_in_goal_7_0, 20,31,34,36,33,39,41,30,2,3)
MR_decl_label10(hlds__headvar_names__group_var_infos_8_0, 70,3,5,7,11,8,15,16,13,4)
MR_decl_label1(hlds__headvar_names__group_var_infos_8_0, 76)
MR_decl_label10(hlds__headvar_names__improve_single_clause_headvars_9_0, 155,3,8,14,13,17,20,21,25,28)
MR_decl_label10(hlds__headvar_names__improve_single_clause_headvars_9_0, 35,37,38,39,33,43,47,49,44,22)
MR_decl_label7(hlds__headvar_names__improve_single_clause_headvars_9_0, 55,54,59,61,58,4,5)
MR_decl_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0, 2,5,6,7,8,9,45,11,14,15)
MR_decl_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0, 16,17,18,19,20,21,22,23,24,27)
MR_decl_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0, 28,29,13,32,33,34,36,37,38,39)
MR_decl_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0, 40,42)
MR_decl_label2(hlds__headvar_names__set_var_name_remap_in_proc_4_0, 2,3)
MR_decl_label4(hlds__headvar_names__update_consensus_map_for_headvar_4_0, 2,16,6,9)
MR_decl_label2(__Unify___hlds__headvar_names__var_name_info_0_0, 6,1)
MR_decl_label4(__Compare___hlds__headvar_names__var_name_info_0_0, 3,2,5,27)
...
static const MR_UserClosureId
mercury_data__closure_layout__hlds__headvar_names__maybe_improve_headvar_names_3_0_3;
extern const MR_TypeCtorInfo_Struct mercury_data_builtin__type_ctor_info_int_0;
...
{
{
(MR_Word *) &mercury_data__closure_layout__hlds__headvar_names__maybe_improve_headvar_names_3_0_3,
(MR_Word *) (MR_Integer) 0
},
4,
{
...
MR_BEGIN_MODULE(hlds__headvar_names_module0)
	...
	MR_init_label10(hlds__headvar_names__improve_single_clause_headvars_9_0,155,3,8,14,13,17,20,21,25,28)
	MR_init_label10(hlds__headvar_names__improve_single_clause_headvars_9_0,35,37,38,39,33,43,47,49,44,22)
	MR_init_label7(hlds__headvar_names__improve_single_clause_headvars_9_0,55,54,59,61,58,4,5)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,155)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,3)
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i5);
	}
	...
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i4);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r8,0)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i5);
	}
	MR_sv(6) = MR_tfield(0, MR_r8, 0);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r7, 0);
	MR_sv(1) = MR_r2;
	MR_sv(7) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(8) = MR_r5;
	...
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i14);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i13);
	}
	{
	MR_Word MR_tempr1;
	...
	MR_r2 = MR_sv(1);
	MR_r1 = MR_tempr1;
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i20);
	}
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i17);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i21);
	}
	MR_sv(1) = MR_r2;
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i4);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i22);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(7);
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,28)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(hlds__headvar_names__improve_single_clause_headvars_9_0_i33);
	MR_sv(13) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(14) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(hlds__headvar_names__improve_single_clause_headvars_9_0_i35);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(list__member_2_1,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i37);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(list__member_2_1,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i37);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,38)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i39);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,33)
	...
	MR_np_call_localret_ent(map__det_insert_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i43);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(2);
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i47);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i44);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i49);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,49)
	...
	MR_np_call_localret_ent(varset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i61);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(1);
	{
	...
	MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i155);
	}
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
	{
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i55);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i54);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(varset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i61);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i59);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__improve_single_clause_headvars_9_0_i58);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(varset__name_var_4_0,
		hlds__headvar_names__improve_single_clause_headvars_9_0_i61);
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__headvar_names__improve_single_clause_headvars_9_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(4);
	MR_r3 = MR_sv(7);
...
MR_BEGIN_MODULE(hlds__headvar_names_module1)
	...
	MR_init_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0,2,5,6,7,8,9,45,11,14,15)
	MR_init_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0,16,17,18,19,20,21,22,23,24,27)
	MR_init_label10(hlds__headvar_names__maybe_improve_headvar_names_3_0,28,29,13,32,33,34,36,37,38,39)
	MR_init_label2(hlds__headvar_names__maybe_improve_headvar_names_3_0,40,42)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,2)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__headvar_names__maybe_improve_headvar_names_3_0_i45);
	}
	MR_r1 = MR_sv(7);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,15)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i16);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,24)
	...
	MR_np_call_localret_ent(hlds__hlds_clauses__set_clause_list_2_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i27);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_r3 = MR_sv(5);
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,13)
	...
	MR_np_call_localret_ent(list__map2_4_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i32);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_sv(8) = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(fn__set__union_list_1_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i33);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(set__to_sorted_list_2_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i34);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,40)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		hlds__headvar_names__maybe_improve_headvar_names_3_0_i42);
MR_def_label(hlds__headvar_names__maybe_improve_headvar_names_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_succip_word = MR_sv(11);
	MR_decr_sp(11);
...
MR_BEGIN_MODULE(hlds__headvar_names_module3)
	...
	MR_init_label4(hlds__headvar_names__find_headvar_names_in_clause_5_0,2,3,5,6)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_clause_5_0,3)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		hlds__headvar_names__find_headvar_names_in_clause_5_0_i5);
MR_def_label(hlds__headvar_names__find_headvar_names_in_clause_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_sv(3) = MR_r1;
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(hlds__headvar_names_module4)
	...
	MR_init_label10(hlds__headvar_names__find_headvar_names_in_goal_7_0,7,6,11,10,14,5,18,22,21,26)
	MR_init_label10(hlds__headvar_names__find_headvar_names_in_goal_7_0,20,31,34,36,33,39,41,30,2,3)
MR_BEGIN_CODE
...
MR_def_static(hlds__headvar_names__find_headvar_names_in_goal_7_0)
	...
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i7);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,6)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i11);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i10);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(hlds__hlds_args__proc_arg_vector_member_2_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i14);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i2);
	}
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,5)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i18);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i20);
	}
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__headvar_names, var_name_info);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i21);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,26)
	...
	MR_np_call_localret_ent(map__det_insert_4_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i41);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_call_localret_ent(varset__search_name_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i31);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i30);
	}
	MR_sv(2) = MR_r2;
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__headvar_names, var_name_info);
	...
	MR_r4 = MR_sv(1);
	MR_np_call_localret_ent(map__search_3_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i34);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__headvar_names__find_headvar_names_in_goal_7_0_i33);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(2);
...
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,36)
	...
	MR_np_call_localret_ent(map__det_update_4_0,
		hlds__headvar_names__find_headvar_names_in_goal_7_0_i41);
MR_def_label(hlds__headvar_names__find_headvar_names_in_goal_7_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = MR_sv(2);
...
MR_BEGIN_MODULE(hlds__headvar_names_module5)
	...
	MR_init_label10(hlds__headvar_names__group_var_infos_8_0,70,3,5,7,11,8,15,16,13,4)
	MR_init_label1(hlds__headvar_names__group_var_infos_8_0,76)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,3)
	...
	MR_np_call_localret_ent(map__search_3_0,
		hlds__headvar_names__group_var_infos_8_0_i5);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_np_call_localret_ent(set__count_2_0,
		hlds__headvar_names__group_var_infos_8_0_i7);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i8);
	}
	if (MR_INT_NE(MR_sv(7),0)) {
		MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i11);
	}
	MR_r2 = MR_sv(1);
	MR_r1 = MR_sv(5);
	MR_r5 = MR_sv(4);
	...
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i70);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,8)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i13);
	}
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(set__to_sorted_list_2_0,
		hlds__headvar_names__group_var_infos_8_0_i15);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i16);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,16)
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		hlds__headvar_names__group_var_infos_8_0_i76);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__headvar_names__group_var_infos_8_0,4)
	...
	MR_r4 = MR_sv(3);
	MR_r3 = MR_sv(2);
MR_def_label(hlds__headvar_names__group_var_infos_8_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__headvar_names__group_var_infos_8_0_i70);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__headvar_names_module6)
	...
	MR_init_label4(hlds__headvar_names__update_consensus_map_for_headvar_4_0,2,16,6,9)
MR_BEGIN_CODE
...
MR_def_label(hlds__headvar_names__update_consensus_map_for_headvar_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__update_consensus_map_for_headvar_4_0_i16);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__headvar_names__update_consensus_map_for_headvar_4_0_i6);
	}
MR_def_label(hlds__headvar_names__update_consensus_map_for_headvar_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
...
MR_BEGIN_MODULE(hlds__headvar_names_module8)
	...
	MR_init_label4(__Compare___hlds__headvar_names__var_name_info_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__headvar_names__var_name_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__headvar_names__var_name_info_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___hlds__headvar_names__var_name_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__hlds__headvar_names__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__headvar_names);
