...
static const MR_DuFunctorDesc hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_0;

static const MR_FA_TypeInfo_Struct1 hlds__headvar_names__list__ti_list_1builtin__type_ctor_info_string_0;

static const MR_PseudoTypeInfo hlds__headvar_names__hlds__headvar_names__field_types_maybe_look_for_unused_statevars_0_1[1];

static const MR_DuFunctorDesc hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_1;

static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_0[1];

static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_1[1];

static const MR_DuPtagLayout hlds__headvar_names__hlds__headvar_names__du_ptag_ordered_maybe_look_for_unused_statevars_0[2];

static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_name_ordered_maybe_look_for_unused_statevars_0[2];

static const MR_Integer hlds__headvar_names__hlds__headvar_names__functor_number_map_maybe_look_for_unused_statevars_0[2];
...
static MR_bool MR_CALL 
hlds__headvar_names____Unify____maybe_look_for_unused_statevars_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
hlds__headvar_names____Compare____maybe_look_for_unused_statevars_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static const MR_DuFunctorDesc hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_0 = {
  (MR_String) "do_not_look_for_unused_statevars",
  INT16_C(0),
  UINT16_C(0),
...
static const MR_PseudoTypeInfo hlds__headvar_names__hlds__headvar_names__field_types_maybe_look_for_unused_statevars_0_1[1] = { (MR_PseudoTypeInfo) (&hlds__headvar_names__list__ti_list_1builtin__type_ctor_info_string_0) };

static const MR_DuFunctorDesc hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_1 = {
  (MR_String) "look_for_unused_statevars",
  INT16_C(1),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(1),
  (MR_Integer) -1,
  INT32_C(1),
  hlds__headvar_names__hlds__headvar_names__field_types_maybe_look_for_unused_statevars_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_0[1] = { &hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_0 };

static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_1[1] = { &hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_1 };

static const MR_DuPtagLayout hlds__headvar_names__hlds__headvar_names__du_ptag_ordered_maybe_look_for_unused_statevars_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    hlds__headvar_names__hlds__headvar_names__du_stag_ordered_maybe_look_for_unused_statevars_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr hlds__headvar_names__hlds__headvar_names__du_name_ordered_maybe_look_for_unused_statevars_0[2] = {
  &hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_0,
  &hlds__headvar_names__hlds__headvar_names__du_functor_desc_maybe_look_for_unused_statevars_0_1
};
...
const MR_TypeCtorInfo_Struct hlds__headvar_names__hlds__headvar_names__type_ctor_info_maybe_look_for_unused_statevars_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (hlds__headvar_names____Unify____maybe_look_for_unused_statevars_0_0_10001)),
  ((MR_Box) (hlds__headvar_names____Compare____maybe_look_for_unused_statevars_0_0_10001)),
  (MR_String) "hlds.headvar_names",
  (MR_String) "maybe_look_for_unused_statevars",
  { hlds__headvar_names__hlds__headvar_names__du_name_ordered_maybe_look_for_unused_statevars_0 },
  { hlds__headvar_names__hlds__headvar_names__du_ptag_ordered_maybe_look_for_unused_statevars_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  hlds__headvar_names__hlds__headvar_names__functor_number_map_maybe_look_for_unused_statevars_0,
...
hlds__headvar_names__IntroducedFrom__pred__maybe_improve_headvar_names__107__1_3_p_0(
  ...
  MR_String * HeadVar__3_78)
{
  mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_21, HeadVar__2_77, HeadVar__3_78);
}
...
void MR_CALL 
hlds__headvar_names____Compare____maybe_look_for_unused_statevars_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
hlds__headvar_names____Unify____maybe_look_for_unused_statevars_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__headvar_names__IntroducedFrom__pred__maybe_improve_headvar_names__107__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_78);
  ...
  MR_Word * STATE_VARIABLE_PredInfo_47)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_97 = ((MR_Word) ((MR_hl_field(1, Clauses0_15, 1))));
      MR_Word Var_98 = ((MR_Word) ((MR_hl_field(1, Clauses0_15, 0))));
      ...
      if ((Var_97 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Goal0_17 = hlds__hlds_clauses__clause_body_1_f_0(Var_98);
        ...
        UnusedSVarArgMap_99 = ((MR_Word) ((MR_hl_field(0, Var_98, 5))));
        succeeded = mercury__map__is_empty_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_statevar_arg_desc_0), UnusedSVarArgMap_99);
        succeeded = !(succeeded);
        if (succeeded)
        {
          MR_Word HeadVars_30;
          ...
          *MaybeLookForUnusedSVars_6 = (MR_Word) ((MR_Unsigned) 0U);
        Var_68 = ((MR_Word) ((MR_hl_field(0, Var_98, 0))));
        Var_70 = ((MR_Word) ((MR_hl_field(0, Var_98, 2))));
        Var_71 = ((MR_Word) ((MR_hl_field(0, Var_98, 3))));
        Var_72 = ((MR_Word) ((MR_hl_field(0, Var_98, 4))));
        Var_73 = ((MR_Word) ((MR_hl_field(0, Var_98, 5))));
        {
          SingleClause_32 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        MR_Word Var_65;
        MR_Word VarsInMapSet_107;
        MR_Word VarsInMaps_108;
        MR_Word Var_109;
        MR_Word Var_110;
        ...
        VarsInMapSet_107 = mercury__set__union_list_1_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSets_40);
        mercury__set__to_sorted_list_2_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), VarsInMapSet_107, &VarsInMaps_108);
        {
          Var_109 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_109, 0) = ((MR_Box) (&hlds__headvar_names_scalar_common_5[0]));
          MR_hl_field(0, Var_109, 1) = ((MR_Box) (hlds__headvar_names__maybe_improve_headvar_names_4_p_0_3));
          MR_hl_field(0, Var_109, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_109, 3) = ((MR_Box) (VarNameInfoMaps_39));
        }
        Var_110 = mercury__map__init_0_f_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__headvar_names_scalar_common_1[0]), (MR_Word) (&hlds__headvar_names_scalar_common_2[2]), Var_109, VarsInMaps_108, ((MR_Box) (Var_110)), &conv4_ConsensusMap_41);
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = hlds__headvar_names____Unify____maybe_look_for_unused_statevars_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  hlds__headvar_names____Compare____maybe_look_for_unused_statevars_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
...
void mercury__hlds__headvar_names__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&hlds__headvar_names__hlds__headvar_names__type_ctor_info_maybe_look_for_unused_statevars_0);
