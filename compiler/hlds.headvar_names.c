  ...
  MR_Word * STATE_VARIABLE_FunctorOnlys_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word TypeCtorInfo_48_48 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        ...
        mercury__set__count_2_p_0(TypeCtorInfo_48_48, VarNameSet_27, &NameCount_28);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_48_48, VarNameSet_27, &VarNameList_29);
          ...
          {
            {
              STATE_VARIABLE_Inconsistents_42_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Inconsistents_42_42, 0) = ((MR_Box) (VarInfo_25));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Inconsistents_42_42, 1) = ((MR_Box) (STATE_VARIABLE_Inconsistents_0_3));
            }
            STATE_VARIABLE_Consistents_39_39 = STATE_VARIABLE_Consistents_0_5;
          }
          STATE_VARIABLE_FunctorOnlys_37_37 = STATE_VARIABLE_FunctorOnlys_0_7;
