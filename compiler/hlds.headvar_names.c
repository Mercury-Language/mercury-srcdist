  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__headvar_names__set_var_name_remap_in_proc_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_STATE_VARIABLE_ProcTable_11);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__headvar_names__update_consensus_map_for_headvar_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ConsensusMap_11);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__headvar_names__find_headvar_names_in_clause_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv1_VarNameInfoMap_9, &conv0_VarsInMap_10);
  ...
  MR_Word * STATE_VARIABLE_PredInfo_42)
{
  ...
  if (succeeded)
  {
    Var_43 = ((MR_Word) ((MR_hl_field(3, OpMode_6, 0))));
    succeeded = ((MR_tag((MR_Word) Var_43)) == (MR_Integer) 3);
    if (succeeded)
    {
      Var_44 = ((MR_Word) ((MR_hl_field(3, Var_43, 0))));
  ...
  else
  {
    ...
    {
      MR_Word Var_77 = ((MR_Word) ((MR_hl_field(1, Clauses0_13, 1))));
      MR_Word Var_78 = ((MR_Word) ((MR_hl_field(1, Clauses0_13, 0))));
      ...
      if ((Var_77 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        GoalInfo0_17 = ((MR_Word) ((MR_hl_field(0, Goal0_15, 1))));
        ...
        Var_58 = ((MR_Word) ((MR_hl_field(0, Var_78, 0))));
        Var_60 = ((MR_Word) ((MR_hl_field(0, Var_78, 2))));
        Var_61 = ((MR_Word) ((MR_hl_field(0, Var_78, 3))));
        Var_62 = ((MR_Word) ((MR_hl_field(0, Var_78, 4))));
        {
