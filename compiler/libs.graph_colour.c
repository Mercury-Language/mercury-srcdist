...
#endif
MR_decl_label8(libs__graph_colour__divide_constraints_6_0, 42,4,7,9,12,10,16,5)
MR_decl_label4(libs__graph_colour__find_all_colours_3_0, 18,4,5,6)
MR_decl_label5(libs__graph_colour__group_elements_2_0, 2,3,5,6,7)
MR_decl_label10(libs__graph_colour__next_colour_4_0, 4,3,7,5,10,11,14,13,18,20)
MR_decl_label4(libs__graph_colour__next_colour_4_0, 16,22,23,26)
...
MR_BEGIN_MODULE(libs__graph_colour_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__graph_colour__divide_constraints_6_0);
	MR_init_label8(libs__graph_colour__divide_constraints_6_0,42,4,7,9,12,10,16,5)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__divide_constraints_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__divide_constraints_6_0_i42);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = MR_r4;
	MR_proceed();
MR_def_label(libs__graph_colour__divide_constraints_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(libs__graph_colour_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__graph_colour__next_colour_4_0);
	MR_init_label10(libs__graph_colour__next_colour_4_0,4,3,7,5,10,11,14,13,18,20)
	MR_init_label4(libs__graph_colour__next_colour_4_0,16,22,23,26)
MR_BEGIN_CODE
...
MR_def_label(libs__graph_colour__next_colour_4_0,5)
	...
	MR_r3 = MR_sv(4);
	MR_r1 = MR_sv(5);
	MR_r1 = (MR_Word) MR_string_const("libs.graph_colour", 17);
	MR_r2 = (MR_Word) MR_string_const("predicate \140libs.graph_colour.choose_var\'/3", 42);
...
MR_BEGIN_MODULE(libs__graph_colour_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__graph_colour__find_all_colours_3_0);
	MR_init_label4(libs__graph_colour__find_all_colours_3_0,18,4,5,6)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__find_all_colours_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__find_all_colours_3_0_i18);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(libs__graph_colour__find_all_colours_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(libs__graph_colour_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__libs__graph_colour__group_elements_2_0);
	MR_init_label5(libs__graph_colour__group_elements_2_0,2,3,5,6,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'group_elements'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
void mercury__libs__graph_colour__init_threadscope_string_table(void);
#endif
...
void mercury__libs__graph_colour__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__libs__graph_colour);
