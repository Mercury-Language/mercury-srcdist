...
libs__graph_colour__find_all_colours_3_p_0(
  ...
  MR_Word * ColourList_6)
{
  if ((ConstraintList_4 == (MR_Word) ((MR_Integer) 0)))
    *ColourList_6 = (MR_Word) ((MR_Integer) 0);
  else
  {
...
{
  {
    ...
    if ((ConstraintList_6 == (MR_Word) ((MR_Integer) 0)))
    {
      *Remainder_7 = (MR_Word) ((MR_Integer) 0);
