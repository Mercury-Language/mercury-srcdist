...
#endif
MR_decl_label8(libs__graph_colour__divide_constraints_6_0, 31,4,7,9,12,10,15,5)
MR_decl_label4(libs__graph_colour__find_all_colours_3_0, 14,4,5,6)
...
MR_BEGIN_MODULE(libs__graph_colour_module0)
	...
	MR_init_label8(libs__graph_colour__divide_constraints_6_0,31,4,7,9,12,10,15,5)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__divide_constraints_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__divide_constraints_6_0_i31);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = MR_r4;
	MR_proceed();
MR_def_label(libs__graph_colour__divide_constraints_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(libs__graph_colour_module2)
	...
	MR_init_label4(libs__graph_colour__find_all_colours_3_0,14,4,5,6)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__find_all_colours_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__find_all_colours_3_0_i14);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(libs__graph_colour__find_all_colours_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
