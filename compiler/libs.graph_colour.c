  ...
  MR_Word * Colours_4)
{
  ...
  mercury__set__delete_3_p_0(TypeInfo_17_17, ((MR_Box) (EmptySet_6)), (MR_Word) (STATE_VARIABLE_Constraints_0_11), &conv0_STATE_VARIABLE_Constraints_12_12);
  STATE_VARIABLE_Constraints_12_12 = (MR_Word) (conv0_STATE_VARIABLE_Constraints_12_12);
  mercury__set__to_sorted_list_2_p_0(TypeInfo_17_17, (MR_Word) (STATE_VARIABLE_Constraints_12_12), &conv1_ConstraintList_7);
  ConstraintList_7 = (MR_Word) (conv1_ConstraintList_7);
  libs__graph_colour__find_all_colours_3_p_0(TypeInfo_for_T_15, ConstraintList_7, AllVars_5, &ColourList_8);
  ...
  MR_Word * STATE_VARIABLE_Vars_6)
{
  ...
  {
    MR_Word S_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
    MR_Word Ss_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
    MR_Word C0_17;
    MR_Word NC0_18;
    MR_Word STATE_VARIABLE_Vars_22_22;

    libs__graph_colour__divide_constraints_6_p_0(TypeInfo_for_T_23, HeadVar__1_1, Ss_13, &C0_17, &NC0_18, STATE_VARIABLE_Vars_0_5, &STATE_VARIABLE_Vars_22_22);
    ...
    if (succeeded)
    {
      ...
      *HeadVar__4_4 = NC0_18;
      mercury__set__difference_3_p_0(TypeInfo_for_T_23, STATE_VARIABLE_Vars_22_22, T_19, STATE_VARIABLE_Vars_6);
    }
    else
    {
      *HeadVar__3_3 = C0_17;
