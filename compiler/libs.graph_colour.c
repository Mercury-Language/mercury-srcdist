...
#endif
MR_decl_label8(libs__graph_colour__divide_constraints_6_0, 4,7,9,12,10,15,5,3)
MR_decl_label4(libs__graph_colour__find_all_colours_3_0, 4,5,6,3)
MR_decl_label5(libs__graph_colour__group_elements_2_0, 2,3,4,5,6)
MR_decl_label8(libs__graph_colour__next_colour_4_0, 4,3,7,5,10,11,14,13)
MR_decl_label6(libs__graph_colour__next_colour_4_0, 17,19,15,20,21,23)
...
MR_BEGIN_MODULE(libs__graph_colour_module0)
	...
	MR_init_label8(libs__graph_colour__divide_constraints_6_0,4,7,9,12,10,15,5,3)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__divide_constraints_6_0)
	...
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__divide_constraints_6_0_i3);
	}
	MR_incr_sp(7);
...
MR_def_label(libs__graph_colour__divide_constraints_6_0,12)
	...
	MR_np_call_localret_ent(set__difference_3_0,
		libs__graph_colour__divide_constraints_6_0_i15);
MR_def_label(libs__graph_colour__divide_constraints_6_0,10)
	...
	MR_np_call_localret_ent(set__difference_3_0,
		libs__graph_colour__divide_constraints_6_0_i15);
MR_def_label(libs__graph_colour__divide_constraints_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(libs__graph_colour__divide_constraints_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(libs__graph_colour_module1)
	...
	MR_init_label6(libs__graph_colour__next_colour_4_0,17,19,15,20,21,23)
MR_BEGIN_CODE
...
MR_def_label(libs__graph_colour__next_colour_4_0,13)
	...
	MR_np_call_localret_ent(set__empty_1_0,
		libs__graph_colour__next_colour_4_0_i17);
MR_def_label(libs__graph_colour__next_colour_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(libs__graph_colour__next_colour_4_0_i15);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(set__singleton_set_2_1,
		libs__graph_colour__next_colour_4_0_i19);
MR_def_label(libs__graph_colour__next_colour_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(list__append_3_1,
		libs__graph_colour__next_colour_4_0_i23);
MR_def_label(libs__graph_colour__next_colour_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(4);
...
MR_def_label(libs__graph_colour__next_colour_4_0,20)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		libs__graph_colour__next_colour_4_0_i21);
MR_def_label(libs__graph_colour__next_colour_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(libs__graph_colour_module2)
	...
	MR_init_label4(libs__graph_colour__find_all_colours_3_0,4,5,6,3)
MR_BEGIN_CODE
...
MR_def_static(libs__graph_colour__find_all_colours_3_0)
	...
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(libs__graph_colour__find_all_colours_3_0_i3);
	}
	MR_incr_sp(4);
...
MR_def_label(libs__graph_colour__find_all_colours_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(libs__graph_colour_module3)
	...
	MR_init_label5(libs__graph_colour__group_elements_2_0,2,3,4,5,6)
MR_BEGIN_CODE
...
MR_def_label(libs__graph_colour__group_elements_2_0,3)
	...
	MR_np_call_localret_ent(set__delete_3_0,
		libs__graph_colour__group_elements_2_0_i4);
MR_def_label(libs__graph_colour__group_elements_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
...
void mercury__libs__graph_colour__write_out_proc_statics(FILE *fp);
#endif
