...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,32)
	...
	MR_sv(4) = MR_tfield(1, MR_r2, 5);
	MR_sv(5) = MR_tfield(1, MR_r2, 6);
...
MR_def_static(hlds__assertion__equal_unification_4_0)
	...
	MR_sv(4) = MR_tfield(2, MR_r1, 7);
	MR_sv(5) = MR_tfield(2, MR_r1, 8);
	MR_sv(6) = MR_tfield(2, MR_r2, 4);
	MR_sv(7) = MR_tfield(2, MR_r2, 5);
	MR_sv(8) = MR_tfield(2, MR_r2, 8);
...
MR_def_label(hlds__assertion__update_5_0,40)
	...
	MR_tfield(0, MR_r1, 1) = MR_tfield(0, MR_fv(7), 1);
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
