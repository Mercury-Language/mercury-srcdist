...
MR_decl_label10(hlds__assertion__equal_goal_exprs_4_0, 5,3,9,15,13,21,29,31,19,34)
MR_decl_label10(hlds__assertion__equal_goal_exprs_4_0, 38,44,46,48,42,52,58,56,328,67)
MR_decl_label2(hlds__assertion__equal_goal_exprs_4_0, 319,1)
...
MR_decl_label10(hlds__assertion__normalise_goal_expr_2_0, 5,8,3,11,10,14,16,18,13,22)
MR_decl_label10(hlds__assertion__normalise_goal_expr_2_0, 21,26,25,32,33,31,37,38,36,41)
MR_decl_label3(hlds__assertion__normalise_goal_expr_2_0, 29,45,114)
...
MR_BEGIN_MODULE(hlds__assertion_module2)
	...
	MR_init_label10(hlds__assertion__normalise_goal_expr_2_0,5,8,3,11,10,14,16,18,13,22)
	MR_init_label10(hlds__assertion__normalise_goal_expr_2_0,21,26,25,32,33,31,37,38,36,41)
	MR_init_label3(hlds__assertion__normalise_goal_expr_2_0,29,45,114)
MR_BEGIN_CODE
...
MR_def_static(hlds__assertion__normalise_goal_expr_2_0)
	...
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i5);
	}
	MR_sv(1) = MR_r2;
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_np_call_localret_ent(hlds__assertion__normalise_goals_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i8);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_r1 = MR_tfield(3, MR_r1, 2);
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i10);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,11)
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(7);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,14)
	...
	MR_np_localcall_lab(hlds__assertion__normalise_goal_expr_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i16);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,16)
	...
	MR_np_localcall_lab(hlds__assertion__normalise_goal_expr_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i18);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = MR_sv(4);
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,13)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i21);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_r2 = MR_tfield(3, MR_r1, 1);
	...
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_np_localcall_lab(hlds__assertion__normalise_goal_expr_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i22);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = MR_sv(1);
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,21)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i25);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_np_localcall_lab(hlds__assertion__normalise_goal_expr_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i26);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,25)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i29);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_r2 = MR_tfield(3, MR_r1, 1);
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i31);
	}
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,31)
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i36);
	}
	MR_sv(1) = MR_tfield(0, MR_r2, 1);
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_np_call_localret_ent(hlds__assertion__normalise_goal_2_0,
...
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,36)
	...
	MR_np_call_localret_ent(hlds__assertion__normalise_goal_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i41);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tfield(3, MR_r1, 1) = MR_r2;
	MR_decr_sp_and_return(7);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goal_expr_2_0_i114);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(hlds__assertion__normalise_cases_2_0,
		hlds__assertion__normalise_goal_expr_2_0_i45);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(7);
MR_def_label(hlds__assertion__normalise_goal_expr_2_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__assertion_module13)
	...
	MR_init_label10(hlds__assertion__equal_goal_exprs_4_0,5,3,9,15,13,21,29,31,19,34)
	MR_init_label10(hlds__assertion__equal_goal_exprs_4_0,38,44,46,48,42,52,58,56,328,67)
	MR_init_label2(hlds__assertion__equal_goal_exprs_4_0,319,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,3)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i9);
	}
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i319);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,29)
	...
	MR_r4 = MR_sv(4);
	MR_np_call_localret_ent(fn__list__map_2_0,
		hlds__assertion__equal_goal_exprs_4_0_i31);
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i34);
	}
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i319);
	}
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i38);
	}
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i319);
	}
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i42);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(hlds__assertion__equal_vars_4_0,
		hlds__assertion__equal_goal_exprs_4_0_i44);
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i1);
	}
	...
	MR_np_call_localret_ent(hlds__assertion__equal_goals_4_0,
		hlds__assertion__equal_goal_exprs_4_0_i46);
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(hlds__assertion__equal_goal_exprs_4_0_i52);
	}
...
MR_def_label(hlds__assertion__equal_goal_exprs_4_0,319)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
