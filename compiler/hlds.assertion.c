      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Box conv2_SubstVA_49;

          succeeded = ((MR_tag((MR_Word) RhsB_6)) == (MR_Integer) 0);
          if (succeeded)
          {
            B_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RhsB_6, (MR_Integer) 0))));
            TypeInfo_12_51 = (MR_Word) (&hlds__assertion_scalar_common_1[0]);
            succeeded = mercury__map__search_3_p_0(TypeInfo_12_51, TypeInfo_12_51, STATE_VARIABLE_Subst_0_27, ((MR_Box) (A_8)), &conv2_SubstVA_49);
            if (succeeded)
            {
              SubstVA_49 = ((MR_Word) (conv2_SubstVA_49));
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
              succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__assertion_scalar_common_1[0]), ((MR_Box) (SubstVA_49)), ((MR_Box) (B_9)));
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_34_34 = (MR_Word) (&hlds__assertion_scalar_common_1[0]);
                      TypeCtorInfo_35_35 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0);
                      mercury__assoc_list__keys_2_p_0(TypeInfo_34_34, TypeCtorInfo_35_35, ArgVarsModesA_19, &ArgVarsA_25);
                      mercury__assoc_list__keys_2_p_0(TypeInfo_34_34, TypeCtorInfo_35_35, ArgVarsModesB_23, &ArgVarsB_26);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_28_28 = (MR_Word) (&hlds__assertion_scalar_common_1[7]);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_12_23 = (MR_Word) (&hlds__assertion_scalar_common_1[0]);
        succeeded = mercury__map__search_3_p_0(TypeInfo_12_23, TypeInfo_12_23, STATE_VARIABLE_Subst_0_3, ((MR_Box) (VA_8)), &conv0_SubstVA_21);
        if (succeeded)
        {
