...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_15, CalleePredIds_8, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_9)), &conv1_STATE_VARIABLE_ModuleInfo_10);
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_5)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_41 = (MR_Word) (MR_body((MR_Word) (GoalExpr0_5), (MR_Integer) 0));
          MR_Word SubGoal_69;

          hlds__assertion__normalise_goal_2_p_0(SubGoal0_41, &SubGoal_69);
          GoalExpr_30 = (MR_Word) (MR_mkword(MR_mktag(0), (MR_Word) (SubGoal_69)));
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
