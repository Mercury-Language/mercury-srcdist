          ...
          case (MR_Integer) 6:
            {
              ...
              hlds__assertion__succeeded = ((((MR_tag((MR_Word) hlds__assertion__HeadVar__2_2)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__assertion__HeadVar__2_2, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (hlds__assertion__succeeded)
                {
              ...
              if (hlds__assertion__succeeded)
                {
                  ...
                  {
                    hlds__assertion__succeeded = parse_tree__prog_data_foreign____Unify____pragma_foreign_proc_attributes_0_0(hlds__assertion__Attributes_55, hlds__assertion__V_108_108);
                  }
                  if (hlds__assertion__succeeded)
                    {
                      {
