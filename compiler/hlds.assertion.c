      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word HeadWarning_10 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ReasonA_5, (MR_Integer) 0))) & (MR_Integer) 1);
          ...
          if (succeeded)
          {
            Var_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ReasonB_6, (MR_Integer) 0))) & (MR_Integer) 1);
