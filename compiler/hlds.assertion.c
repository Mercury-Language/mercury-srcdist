...
{
  {
    ...
    hlds__assertion__record_use_in_assertion_4_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ModuleInfo_13);
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = ((MR_tag((MR_Word) SubGoals_33)) == (MR_Integer) 1);
              if (succeeded)
              {
