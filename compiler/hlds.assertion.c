...
MR_decl_label3(hlds__assertion__normalise_cases_2_0, 4,5,3)
MR_decl_label3(hlds__assertion__normalise_conj_2_0, 4,5,3)
...
MR_decl_label3(hlds__assertion__normalise_goals_2_0, 4,5,3)
...
MR_BEGIN_MODULE(hlds__assertion_module0)
	...
	MR_init_label3(hlds__assertion__normalise_conj_2_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(hlds__assertion__normalise_conj_2_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__assertion__normalise_conj_2_0_i3);
	}
	MR_incr_sp(2);
...
MR_def_label(hlds__assertion__normalise_conj_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__assertion_module4)
	...
	MR_init_label3(hlds__assertion__normalise_cases_2_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(hlds__assertion__normalise_cases_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__assertion__normalise_cases_2_0_i3);
	}
	MR_incr_sp(4);
...
MR_def_label(hlds__assertion__normalise_cases_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__assertion_module5)
	...
	MR_init_label3(hlds__assertion__normalise_goals_2_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(hlds__assertion__normalise_goals_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__assertion__normalise_goals_2_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
...
MR_def_label(hlds__assertion__normalise_goals_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(hlds__assertion__equal_unification_4_0,85)
	...
	MR_sv(4) = MR_ctfield(2, MR_r1, 6);
	MR_sv(5) = MR_ctfield(2, MR_r1, 7);
	MR_sv(6) = MR_ctfield(2, MR_tempr3, 3);
	MR_sv(7) = MR_ctfield(2, MR_tempr3, 4);
	MR_sv(8) = MR_ctfield(2, MR_tempr3, 7);
	MR_sv(9) = MR_ctfield(2, MR_tempr3, 6);
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__assertion__update_5_0,34)
	...
	MR_tfield(0, MR_r1, 1) = MR_ctfield(0, MR_fv(7), 1);
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
void mercury__hlds__assertion__write_out_proc_statics(FILE *fp);
#endif
