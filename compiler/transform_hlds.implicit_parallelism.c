...
MR_decl_label10(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0, 5,7,9,10,11,13,15,17,16,19)
MR_decl_label10(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0, 21,23,24,27,30,34,35,36,37,38)
MR_decl_label6(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0, 41,43,40,47,48,2)
...
MR_def_label(transform_hlds__implicit_parallelism__parallelize_calls_8_0,11)
	...
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_sv(1);
	MR_tfield(1, MR_tempr3, 1) = MR_tfield(3, MR_tempr1, 2);
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism_module25)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__index1_of_candidate_par_conjunct_4_0);
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism_module26)
	...
	MR_init_label10(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0,5,7,9,10,11,13,15,17,16,19)
	MR_init_label10(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0,21,23,24,27,30,34,35,36,37,38)
	MR_init_label6(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0,41,43,40,47,48,2)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__implicit_parallelism__maybe_parallelise_conj_4_0,48)
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = MR_tfield(0, MR_sv(3), 1);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
...
MR_BEGIN_MODULE(transform_hlds__implicit_parallelism_module42)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__implicit_parallelism__IntroducedFrom__pred__index1_of_candidate_par_conjunct__373__1_4_0);
