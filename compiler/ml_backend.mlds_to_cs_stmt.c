...
static /* final */ const MR_Box ml_backend__mlds_to_cs_stmt_scalar_common_2[2][8];

static /* final */ const MR_Box ml_backend__mlds_to_cs_stmt_scalar_common_3[1][9];

static /* final */ const MR_Box ml_backend__mlds_to_cs_stmt_scalar_common_4[2][10];
...
static /* final */ const MR_Box ml_backend__mlds_to_cs_stmt_scalar_common_7[1][11];
    ...
    case (MR_Integer) 1:
      {
        ...
        if (!((MaybeUserContext_11 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          MR_Word Var_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1))) & (MR_Integer) 1);

          ml_backend__mlds_to_cs_util__cs_output_context_5_p_0(Stream_7, Var_29, ProgContext_12);
        }
        mercury__io__write_string_4_p_0(Stream_7, CodeString_10);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "}\n");
        Var_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1))) & (MR_Integer) 1);
        ml_backend__mlds_to_cs_util__cs_output_default_context_4_p_0(Stream_7, Var_34);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_String CodeString_36 = ((MR_String) ((MR_hl_field(MR_mktag(2), TargetCode_8, (MR_Integer) 0))));

        mercury__io__write_string_4_p_0(Stream_7, CodeString_36);
      }
      break;
    case (MR_Integer) 3:
...
{
  {
    ...
    *HeadVar__6_6 = (MR_Integer) ((MR_Unsigned) Num_13 + (MR_Unsigned) 1);
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_stmt_scalar_common_8[0]), Num_13, &Var_30);
...
{
  {
    ...
    else
    {
      ...
      ml_backend__mlds_to_cs_stmt__output_case_cond_for_csharp_7_p_0(Info_1, Stream_2, Indent_3, Context_5, FirstCond_56);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_4[1]));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!((LocalVarDefns_85 == (MR_Word) ((MR_Unsigned) 0U))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_100, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_3[0]));
          ...
          if (!((FuncDefns_86 == (MR_Word) ((MR_Unsigned) 0U))))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_4[0]));
          ...
          case (MR_Integer) 4:
            {
              ...
              else
              {
                ...
                mercury__io__write_string_4_p_0(Stream_10, (MR_String) " = ");
                OutArgs_159 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0), (MR_Word) (&ml_backend__mlds_to_cs_stmt_scalar_common_6[0]), Lvals_161);
              }
              ...
              mercury__io__write_string_4_p_0(Stream_10, (MR_String) "(");
              {
                ...
                MR_hl_field(MR_mktag(0), Var_190, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_2[1]));
          ...
          case (MR_Integer) 5:
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_458, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_7[0]));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_119 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);

          ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_119, Context_12, Indent_10);
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_72 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_72, Context_12, Indent_10);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "{\n");
              Var_76 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              Var_77 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
              ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_76, Context_12, Var_77);
              ...
              else
              {
                ...
                mercury__io__write_string_4_p_0(Stream_9, Start_40);
                mercury__io__write_string_4_p_0(Stream_9, (MR_String) "\n");
                Var_93 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
                ml_backend__mlds_to_cs_stmt__output_init_args_for_csharp_7_p_0(Info_8, Stream_9, Var_93, HeadArgRvalType_42, TailArgRvalsTypes_43);
                Var_96 = (MR_Integer) ((MR_Unsigned) Indent_10 + (MR_Unsigned) 1);
                ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Var_96);
                mercury__io__write_string_4_p_0(Stream_9, End_41);
                mercury__io__write_string_4_p_0(Stream_9, (MR_String) ";\n");
              }
              Var_111 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
              ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_111, Context_12, Indent_10);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "}\n");
            }
            break;
          case (MR_Integer) 3:
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    ml_backend__mlds_to_cs_util__output_pragma_warning_restore_3_p_0(Stream_9);
                    {
                      Var_59 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_stmt_scalar_common_2[0]));
                      MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (ml_backend__mlds_to_cs_stmt__output_atomic_stmt_for_csharp_7_p_0_1));
                    ...
                    mercury__list__foldl_4_p_2((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_target_code_component_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_59, Components_47, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_60_60);
