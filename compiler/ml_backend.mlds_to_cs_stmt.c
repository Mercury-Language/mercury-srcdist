...
ml_backend__mlds_to_cs_stmt__IntroducedFrom__func__output_stmt_call_for_csharp__535__1_1_f_0(
  ...
  MR_Word LambdaHeadVar__1_44)
{
...

  {
    ...
    MR_hl_field(3, LambdaHeadVar__2_45, 0) = ((MR_Box) ((MR_Unsigned) 7U));
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_String FuncNameStr_17;

        FuncNameStr_17 = ml_backend__mlds_to_cs_name__maybe_qualified_function_name_to_ll_string_for_csharp_2_f_0(Info_6, FuncName_16);
        mercury__io__write_string_4_p_0(Stream_7, FuncNameStr_17);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        if (!((MaybeUserContext_11 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          MR_Word Var_24 = ((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 1))) & (MR_Integer) 1);

          ml_backend__mlds_to_cs_util__cs_output_context_5_p_0(Stream_7, Var_24, ProgContext_12);
        }
        mercury__io__write_string_4_p_0(Stream_7, CodeString_10);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "}\n");
        Var_29 = ((MR_Unsigned) ((MR_hl_field(0, Info_6, (MR_Integer) 1))) & (MR_Integer) 1);
        ml_backend__mlds_to_cs_util__cs_output_default_context_4_p_0(Stream_7, Var_29);
        ml_backend__mlds_to_cs_util__output_pragma_warning_disable_3_p_0(Stream_7);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_String CodeString_40 = ((MR_String) ((MR_hl_field(2, TargetCode_8, (MR_Integer) 0))));

        mercury__io__write_string_4_p_0(Stream_7, CodeString_40);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 2:
          {
            ...
            Var_35 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_6, Type_15);
  ...
  MR_Word LocalVarDefn_10)
{
  ...
  ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_7, Stream_8, Type_14);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_45 = ml_backend__mlds_to_cs_stmt__IntroducedFrom__func__output_stmt_call_for_csharp__535__1_1_f_0(((MR_Word) (wrapper_arg_1)));
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word OutArgs_129;
            MR_Word Var_134 = ((((MR_Unsigned) ((MR_hl_field(0, Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
            MR_Word Var_138;
            MR_Integer Var_139;
            MR_Word Var_153;
            MR_Word Var_155;
            ...
            ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_10, Var_134, Context_126, Indent_11);
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) "{\n");
            Var_138 = ((((MR_Unsigned) ((MR_hl_field(0, Info_9, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
            Var_139 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
            ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_10, Var_138, Context_126, Var_139);
            ...
            if (succeeded)
            {
              Var_146 = ((MR_Word) ((MR_hl_field(3, FuncRval_122, (MR_Integer) 1))));
            ...
            {
              MR_String TypeString_133;

              TypeString_133 = ml_backend__mlds_to_cs_type__method_ptr_type_to_string_3_f_0(Info_9, ArgTypes_127, RetTypes_128);
              mercury__io__write_string_4_p_0(Stream_10, (MR_String) "((");
              mercury__io__write_string_4_p_0(Stream_10, TypeString_133);
              mercury__io__write_string_4_p_0(Stream_10, (MR_String) ") ");
              ml_backend__mlds_to_cs_data__output_call_rval_for_csharp_5_p_0(Info_9, FuncRval_122, Stream_10);
              mercury__io__write_string_4_p_0(Stream_10, (MR_String) ")");
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              ml_backend__mlds_to_cs_type__output_type_for_csharp_6_p_0(Info_8, Stream_9, Type_23, &ArrayDims_34);
              ...
              ml_backend__mlds_to_cs_name__output_unqual_class_name_for_csharp_5_p_0(Stream_9, CtorName_38, CtorArity_39);
            }
            else
              ml_backend__mlds_to_cs_type__output_type_for_csharp_6_p_0(Info_8, Stream_9, Type_23, &ArrayDims_34);
