    ...
    else
      {
        ...
        if ((hlds__instmap__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *hlds__instmap__HeadVar__1_1 = (MR_Integer) 1;
          ...
          {
            MR_Word hlds__instmap__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__instmap__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__builtin__compare_3_p_0((MR_Word) &hlds__instmap_scalar_common_2[1], hlds__instmap__HeadVar__1_1, ((MR_Box) (hlds__instmap__Var_11)), ((MR_Box) (hlds__instmap__Var_5)));
            }
          }
      }
  }
...
{
  {
    ...
    if ((hlds__instmap__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word hlds__instmap__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__instmap__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__instmap__Var_4;

        hlds__instmap__succeeded = ((MR_tag((MR_Word) hlds__instmap__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (hlds__instmap__succeeded)
          {
            hlds__instmap__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__instmap__HeadVar__2_2, (MR_Integer) 0)));
            hlds__instmap__TypeInfo_9_9 = (MR_Word) &hlds__instmap_scalar_common_2[1];
            {
              hlds__instmap__succeeded = mercury__builtin__unify_2_p_0(hlds__instmap__TypeInfo_9_9, ((MR_Box) (hlds__instmap__Var_3)), ((MR_Box) (hlds__instmap__Var_4)));
            }
          }
      }
    return hlds__instmap__succeeded;
...
{
  {
    ...
    if (hlds__instmap__succeeded)
      *hlds__instmap__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word hlds__instmap__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__instmap__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word hlds__instmap__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word hlds__instmap__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__instmap__Var_8;

        {
          mercury__term____Compare____context_0_0(&hlds__instmap__Var_8, hlds__instmap__Var_4, hlds__instmap__Var_6);
        }
        ...
        if (hlds__instmap__succeeded)
          *hlds__instmap__HeadVar__1_1 = hlds__instmap__Var_8;
          ...
          {
            hlds__instmap____Compare____instmap_0_0(hlds__instmap__HeadVar__1_1, hlds__instmap__Var_5, hlds__instmap__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (hlds__instmap__succeeded)
      ...
      {
        MR_Word hlds__instmap__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__instmap__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word hlds__instmap__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__instmap__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__instmap__HeadVar__2_2, (MR_Integer) 1)));

        {
          hlds__instmap__succeeded = mercury__term____Unify____context_0_0(hlds__instmap__Var_3, hlds__instmap__Var_5);
        }
        if (hlds__instmap__succeeded)
          {
            hlds__instmap__succeeded = hlds__instmap____Unify____instmap_0_0(hlds__instmap__Var_4, hlds__instmap__Var_6);
          }
      }
    return hlds__instmap__succeeded;
  }
        ...
        else
          {
            ...
            if (hlds__instmap__succeeded)
            ...
            else
              {
                ...
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__instmap_scalar_common_7[1], hlds__instmap__VarInt_35, &hlds__instmap__Var_60);
                }
                {
    ...
    if ((hlds__instmap__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__instmap__Var_38, 0) = ((MR_Box) (&hlds__instmap_scalar_common_6[0]));
