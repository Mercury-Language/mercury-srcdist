  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__instmap__merge_instmapping_delta_vars_9_p_0(VarTypeSrc_9, ListOfVars_38, InstMapping0_16, InstMappingA_17, InstMappingB_18, Var_39, &InstMapping_19, STATE_VARIABLE_ModuleInfo_0_20, STATE_VARIABLE_ModuleInfo_21);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
