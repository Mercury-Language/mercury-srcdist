...
static void MR_CALL 
hlds__instmap__merge_instmap_deltas_pass_8_p_0(
  MR_Word InstMap_9,
...
#line 1480 "instmap.m"
void 
hlds__instmap__user_init_pred_247_0(void)
#line 1480 "instmap.m"
{
#line 1480 "instmap.m"
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_19)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    hlds__instmap__merge_instmap_deltas_pass_8_p_0(InstMap_8, NonLocals_9, VarTypes_10, Deltas_11, (MR_Word) ((MR_Unsigned) 0U), &MergedDeltas_14, STATE_VARIABLE_ModuleInfo_0_18, &STATE_VARIABLE_ModuleInfo_21_21);
    if ((MergedDeltas_14 == (MR_Word) ((MR_Unsigned) 0U)))
      {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_27)
{
  while (MR_TRUE)
  {
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((Deltas_12 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              STATE_VARIABLE_MergedDeltas_34_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
hlds__instmap__merge_instmap_delta_8_p_0(
  ...
  MR_Word NonLocals_10,
  MR_Word VarTypes_11,
  MR_Word MaybeInstMappingA_12,
  MR_Word MaybeInstMappingB_13,
  MR_Word * MaybeInstMapping_14,
  MR_Word STATE_VARIABLE_ModuleInfo_0_19,
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  if ((MaybeInstMappingA_12 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *MaybeInstMapping_14 = MaybeInstMappingB_13;
    *STATE_VARIABLE_ModuleInfo_20 = STATE_VARIABLE_ModuleInfo_0_19;
  }
  else
  {
    MR_Word InstMappingA_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeInstMappingA_12, (MR_Integer) 0))));

    if ((MaybeInstMappingB_13 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      *MaybeInstMapping_14 = MaybeInstMappingA_12;
      *STATE_VARIABLE_ModuleInfo_20 = STATE_VARIABLE_ModuleInfo_0_19;
    }
    else
    {
      MR_Word InstMappingB_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeInstMappingB_13, (MR_Integer) 0))));
      ...
      mercury__map__keys_2_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingA_16, &VarsInA_31);
      mercury__map__keys_2_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingB_17, &VarsInB_32);
      ...
      hlds__instmap__merge_instmapping_delta_vars_9_p_0(VarTypes_11, ListOfVars_37, InstMap_9, InstMappingA_16, InstMappingB_17, Var_38, &InstMapping_18, STATE_VARIABLE_ModuleInfo_0_19, STATE_VARIABLE_ModuleInfo_20);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *MaybeInstMapping_14 = base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word InstB_31;
      MR_Word VarType_32;
      MR_Word STATE_VARIABLE_InstMapping_42_42;
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingA_4, ((MR_Box) (Var_21)), &conv0_InstInA_28);
      if (succeeded)
      {
      ...
      if (succeeded)
        ...
        hlds__instmap__instmap_lookup_var_3_p_0(InstMap_3, Var_21, &InstA_29);
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingB_5, ((MR_Box) (Var_21)), &conv1_InstInB_30);
      if (succeeded)
      {
      ...
      if (succeeded)
        ...
        hlds__instmap__instmap_lookup_var_3_p_0(InstMap_3, Var_21, &InstB_31);
      hlds__vartypes__lookup_var_type_3_p_0(VarTypes_1, Var_21, &VarType_32);
      succeeded = check_hlds__inst_merge__inst_merge_6_p_0(VarType_32, InstA_29, InstB_31, &InstAB_33, STATE_VARIABLE_ModuleInfo_0_8, &STATE_VARIABLE_ModuleInfo_41_41);
      if (succeeded)
      {
        STATE_VARIABLE_ModuleInfo_48_48 = STATE_VARIABLE_ModuleInfo_41_41;
        mercury__map__det_insert_4_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Var_21)), ((MR_Box) (InstAB_33)), STATE_VARIABLE_InstMapping_0_6, &STATE_VARIABLE_InstMapping_42_42);
      }
      else
      {
        ...
        mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_21, &VarInt_35);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__instmap_scalar_common_3[0]), VarInt_35, &Var_58);
        Msg_36 = mercury__string__f_43_43_2_f_0((MR_String) "error merging var ", Var_58);
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.instmap.merge_instmapping_delta_vars\'/9", Msg_36);
          return;
        }
      }
      // direct tailcall eliminated
      ...
      next_value_of_STATE_VARIABLE_InstMapping_0_6 = STATE_VARIABLE_InstMapping_42_42;
      next_value_of_STATE_VARIABLE_ModuleInfo_0_8 = STATE_VARIABLE_ModuleInfo_48_48;
...
{
	hlds__instmap__user_init_pred_247_0();
}
