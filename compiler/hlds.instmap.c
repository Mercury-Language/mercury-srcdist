...
{
  if ((InstMap0_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
  ...
  {
    MR_Word InstMapping0_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InstMap0_8, (MR_Integer) 0))));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Var_53 == (MR_Word) ((MR_Unsigned) 0U)))
          hlds__instmap__merge_instmap_delta_8_p_0(InstMap0_8, NonLocals_9, VarTypes_10, Var_52, Var_54, MergedDelta_12, STATE_VARIABLE_ModuleInfo_0_30, STATE_VARIABLE_ModuleInfo_31);
        else
        {
          ...
          if ((Var_55 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            hlds__instmap__merge_instmap_delta_8_p_0(InstMap0_8, NonLocals_9, VarTypes_10, Var_52, Var_54, &Delta12_50, STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_39_39);
            hlds__instmap__merge_instmap_delta_8_p_0(InstMap0_8, NonLocals_9, VarTypes_10, Delta12_50, Var_56, MergedDelta_12, STATE_VARIABLE_ModuleInfo_39_39, STATE_VARIABLE_ModuleInfo_31);
          }
          else
          {
            ...
            hlds__instmap__pair_vars_with_their_types_3_p_0(VarTypes_10, ListOfVars_64, &VarsTypes_25);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingA_3, ((MR_Box) (Var_18)), &conv0_InstInA_46);
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMapping0_2, ((MR_Box) (Var_18)), &conv1_VarInst_80);
        if (succeeded)
        {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingB_4, ((MR_Box) (Var_18)), &conv2_InstInB_48);
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMapping0_2, ((MR_Box) (Var_18)), &conv3_VarInst_86);
        if (succeeded)
        {
      ...
      succeeded = check_hlds__inst_merge__inst_merge_6_p_0(Type_19, InstA_47, InstB_49, &InstAB_50, STATE_VARIABLE_ModuleInfo_0_7, &STATE_VARIABLE_ModuleInfo_29_54);
      if (succeeded)
      {
        STATE_VARIABLE_ModuleInfo_32_32 = STATE_VARIABLE_ModuleInfo_29_54;
        mercury__map__det_insert_4_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Var_18)), ((MR_Box) (InstAB_50)), STATE_VARIABLE_InstMapping_0_5, &STATE_VARIABLE_InstMapping_31_31);
      }
      else
      {
        ...
        mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_18, &VarInt_52);
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_1, Var_6, &Type_8);
    {
    ...
    hlds__instmap__pair_vars_with_their_types_3_p_0(VarTypes_1, Vars_7, &VarsTypes_9);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
...
{
  if ((InstMap0_9 == (MR_Word) ((MR_Unsigned) 0U)))
  {
  ...
  {
    MR_Word InstMapping0_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InstMap0_9, (MR_Integer) 0))));
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word VarsInA_32;
        MR_Word VarsInB_33;
        MR_Word SetOfVarsInA_34;
        MR_Word SetOfVarsInB_35;
        MR_Word SetOfVars0_36;
        MR_Word SetOfVars_37;
        MR_Word ListOfVars_38;
        MR_Word Var_39;

        mercury__map__keys_2_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingA_17, &VarsInA_32);
        mercury__map__keys_2_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingB_18, &VarsInB_33);
        parse_tree__set_of_var__sorted_list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarsInA_32, &SetOfVarsInA_34);
        parse_tree__set_of_var__sorted_list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarsInB_33, &SetOfVarsInB_35);
        parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), SetOfVarsInA_34, SetOfVarsInB_35, &SetOfVars0_36);
        parse_tree__set_of_var__intersect_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), SetOfVars0_36, NonLocals_10, &SetOfVars_37);
        parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), SetOfVars_37, &ListOfVars_38);
        Var_39 = mercury__map__init_0_f_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0));
        hlds__instmap__merge_instmapping_delta_vars_9_p_0(VarTypes_11, ListOfVars_38, InstMapping0_16, InstMappingA_17, InstMappingB_18, Var_39, &InstMapping_19, STATE_VARIABLE_ModuleInfo_0_20, STATE_VARIABLE_ModuleInfo_21);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word InstB_51;
      MR_Word InstInA_48;
      MR_Box conv0_InstInA_48;
      MR_Word InstInB_50;
      MR_Box conv2_InstInB_50;
      MR_Word InstAB_52;
      ...
      hlds__vartypes__lookup_var_type_3_p_0(VarTypes_1, Var_21, &VarType_28);
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingA_4, ((MR_Box) (Var_21)), &conv0_InstInA_48);
      if (succeeded)
      {
        InstInA_48 = ((MR_Word) (conv0_InstInA_48));
        succeeded = MR_TRUE;
      }
      if (succeeded)
        InstA_49 = InstInA_48;
      ...
      {
        MR_Word VarInst_82;
        MR_Box conv1_VarInst_82;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMap_3, ((MR_Box) (Var_21)), &conv1_VarInst_82);
        if (succeeded)
        {
          VarInst_82 = ((MR_Word) (conv1_VarInst_82));
          succeeded = MR_TRUE;
        }
        if (succeeded)
          InstA_49 = VarInst_82;
        else
          InstA_49 = (MR_Word) ((MR_Unsigned) 0U);
      }
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMappingB_5, ((MR_Box) (Var_21)), &conv2_InstInB_50);
      if (succeeded)
      {
        InstInB_50 = ((MR_Word) (conv2_InstInB_50));
        succeeded = MR_TRUE;
      }
      if (succeeded)
        InstB_51 = InstInB_50;
      ...
      {
        MR_Word VarInst_88;
        MR_Box conv3_VarInst_88;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstMap_3, ((MR_Box) (Var_21)), &conv3_VarInst_88);
        if (succeeded)
        {
          VarInst_88 = ((MR_Word) (conv3_VarInst_88));
          succeeded = MR_TRUE;
        }
        if (succeeded)
          InstB_51 = VarInst_88;
        else
          InstB_51 = (MR_Word) ((MR_Unsigned) 0U);
      }
      succeeded = check_hlds__inst_merge__inst_merge_6_p_0(VarType_28, InstA_49, InstB_51, &InstAB_52, STATE_VARIABLE_ModuleInfo_0_8, &STATE_VARIABLE_ModuleInfo_29_56);
      if (succeeded)
      {
        STATE_VARIABLE_ModuleInfo_34_34 = STATE_VARIABLE_ModuleInfo_29_56;
        mercury__map__det_insert_4_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Var_21)), ((MR_Box) (InstAB_52)), STATE_VARIABLE_InstMapping_0_6, &STATE_VARIABLE_InstMapping_33_33);
      }
      else
      {
        MR_Integer VarInt_54;
        MR_String Msg_55;
        MR_String Var_71;

        mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_21, &VarInt_54);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__instmap_scalar_common_3[0]), VarInt_54, &Var_71);
        Msg_55 = mercury__string__f_43_43_2_f_0((MR_String) "error merging var ", Var_71);
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.instmap.merge_instmapping_delta_var\'/9", Msg_55);
          return;
        }
      }
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  MR_Word ArgLives_48;
  MR_Word ArgInsts_49;
  MR_Word STATE_VARIABLE_Inst_23_55;
  MR_Word STATE_VARIABLE_ModuleInfo_24_56;
  MR_Word _Det_50;

  hlds__instmap__instmap_lookup_var_3_p_0(STATE_VARIABLE_InstMap_0_17, Var_9, &Inst0_15);
  Arity_47 = check_hlds__type_util__cons_id_adjusted_arity_3_f_0(STATE_VARIABLE_ModuleInfo_0_19, Type_10, MainConsId_11);
  mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_is_live_0), Arity_47, ((MR_Box) ((MR_Integer) 1)), &ArgLives_48);
  mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), Arity_47, ((MR_Box) ((MR_Unsigned) 0U)), &ArgInsts_49);
  succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0((MR_Integer) 1, Inst0_15, MainConsId_11, ArgInsts_49, ArgLives_48, (MR_Integer) 0, Type_10, &STATE_VARIABLE_Inst_23_55, &_Det_50, STATE_VARIABLE_ModuleInfo_0_19, &STATE_VARIABLE_ModuleInfo_24_56);
  if (succeeded)
  {
    STATE_VARIABLE_ModuleInfo_19_34 = STATE_VARIABLE_ModuleInfo_24_56;
    MainFinalInst_31 = STATE_VARIABLE_Inst_23_55;
  }
  else
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.instmap.bind_inst_to_functor\'/6", (MR_String) "mode error");
  ...
  check_hlds__inst_merge__insts_merge_6_p_0(Type_10, MainFinalInst_31, OtherFinalInsts_32, &MaybeMergedInst_33, STATE_VARIABLE_ModuleInfo_20_35, STATE_VARIABLE_ModuleInfo_20);
  if ((MaybeMergedInst_33 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.instmap.bind_inst_to_functors\'/7", (MR_String) "no MaybeMergedInst");
      return;
    }
  ...
  {
    MR_Word InstMapping0_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_InstMap_0_17, (MR_Integer) 0))));
    MR_Word InstMapping_68;

    mercury__map__set_4_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Var_9)), ((MR_Box) (Inst_16)), InstMapping0_67, &InstMapping_68);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_InstMap_18 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (InstMapping_68));
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  ...
  else
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), Arity_31, ((MR_Box) ((MR_Unsigned) 0U)), &ArgInsts_33);
    succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0((MR_Integer) 1, HeadVar__3_3, ConsId_13, ArgInsts_33, ArgLives_32, (MR_Integer) 0, HeadVar__1_1, &STATE_VARIABLE_Inst_23_39, &_Det_34, STATE_VARIABLE_ModuleInfo_0_5, &STATE_VARIABLE_ModuleInfo_24_40);
    if (succeeded)
    {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0((MR_Integer) 1, Inst0_13, ConsId_10, ArgInsts_31, ArgLives_30, (MR_Integer) 0, Type_9, &STATE_VARIABLE_Inst_23_37, &_Det_32, STATE_VARIABLE_ModuleInfo_0_17, &STATE_VARIABLE_ModuleInfo_24_38);
  if (succeeded)
  {
