  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__instmap__merge_instmapping_delta_vars_9_p_0(ListofVars_48, InstMap_1, VarTypes_3, Var_33, InstMappingB_27, Var_49, &InstMapping_28, STATE_VARIABLE_ModuleInfo_0_7, STATE_VARIABLE_ModuleInfo_8);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__6_6 = base;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        InstA_13 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      if (succeeded)
        ...
        InstB_14 = (MR_Word) ((MR_Unsigned) 0U);
