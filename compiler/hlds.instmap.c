...
MR_decl_label2(hlds__instmap__instmap_changed_vars_5_0, 16,4)
MR_decl_label7(hlds__instmap__instmap_changed_vars_2_6_0, 32,5,6,7,8,11,10)
...
MR_BEGIN_MODULE(hlds__instmap_module21)
	...
	MR_init_label7(hlds__instmap__instmap_changed_vars_2_6_0,32,5,6,7,8,11,10)
MR_BEGIN_CODE
...
MR_def_static(hlds__instmap__instmap_changed_vars_2_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__instmap__instmap_changed_vars_2_6_0_i32);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_np_tailcall_ent(parse_tree__set_of_var__init_1_0);
MR_def_label(hlds__instmap__instmap_changed_vars_2_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_BEGIN_MODULE(hlds__instmap_module22)
	...
	MR_init_label2(hlds__instmap__instmap_changed_vars_5_0,16,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__instmap__instmap_changed_vars_5_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__instmap__instmap_changed_vars_5_0_i16);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr1 = MR_r2;
...
MR_def_label(hlds__instmap__instmap_changed_vars_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	...
	MR_np_call_localret_ent(map__keys_2_0,
		hlds__instmap__instmap_changed_vars_5_0_i4);
MR_def_label(hlds__instmap__instmap_changed_vars_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
