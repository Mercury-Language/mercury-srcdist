...
{
  {
    ...
    {
      InstMapDelta_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Inst_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_13, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_17, 4) = ((MR_Box) ((MR_Unsigned) 4U));
      }
      {
...
{
  if ((InstMapB_7 == (MR_Word) ((MR_Unsigned) 0U)))
  {
