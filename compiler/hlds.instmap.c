...
hlds__instmap__IntroducedFrom__pred__instmapping_set_vars_corresponding__644__1_2_p_0(
  MR_Word Inst_10,
  MR_Word HeadVar__2_19);

static MR_bool MR_CALL 
hlds__instmap__IntroducedFrom__pred__instmapping_set_vars__633__1_2_p_0(
  MR_Word Inst_8,
  MR_Word HeadVar__2_17);

static MR_bool MR_CALL 
hlds__instmap__IntroducedFrom__pred__instmap_delta_set_vars_same__621__1_2_p_0(
  MR_Word Inst_5,
  MR_Word HeadVar__2_16);

static MR_bool MR_CALL 
hlds__instmap__IntroducedFrom__pred__instmap_set_vars_same__590__1_2_p_0(
  MR_Word Inst_5,
  MR_Word HeadVar__2_16);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_util__inst_merge_6_p_0(InstA_29, InstB_31, Var_41, &InstAB_33, STATE_VARIABLE_ModuleInfo_0_8, &STATE_VARIABLE_ModuleInfo_42_42);
      if (succeeded)
      {
...
{
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_util__abstractly_unify_inst_functor_11_p_0((MR_Integer) 1, NewInst1_20, MainConsId_12, ArgInsts_58, ArgLives_57, (MR_Integer) 0, Type_11, &STATE_VARIABLE_Inst_23_64, &_Det_59, STATE_VARIABLE_ModuleInfo_0_24, &STATE_VARIABLE_ModuleInfo_24_65);
      if (succeeded)
      {
...
{
  {
    ...
    succeeded = check_hlds__inst_util__abstractly_unify_inst_functor_11_p_0((MR_Integer) 1, Inst0_15, MainConsId_11, ArgInsts_50, ArgLives_49, (MR_Integer) 0, Type_10, &STATE_VARIABLE_Inst_23_56, &_Det_51, STATE_VARIABLE_ModuleInfo_0_19, &STATE_VARIABLE_ModuleInfo_24_57);
    if (succeeded)
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Var_64 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        succeeded = check_hlds__inst_util__inst_merge_6_p_0(Inst1_11, Var_65, MaybeType_10, &Inst12_17, STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_50_50);
        if (succeeded)
        {
      ...
      else
      {
        ...
        if ((Var_66 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = check_hlds__inst_util__inst_merge_6_p_0(Inst1_11, Var_65, MaybeType_10, &Inst12_55, STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_44_44);
          if (succeeded)
            succeeded = check_hlds__inst_util__inst_merge_6_p_0(Inst12_55, Var_67, MaybeType_10, &Inst123_19, STATE_VARIABLE_ModuleInfo_44_44, &STATE_VARIABLE_ModuleInfo_45_45);
          if (succeeded)
          {
        ...
        else
        {
          ...
          succeeded = check_hlds__inst_util__inst_merge_6_p_0(Inst1_11, Var_65, MaybeType_10, &Inst12_59, STATE_VARIABLE_ModuleInfo_0_30, &STATE_VARIABLE_ModuleInfo_34_34);
          if (succeeded)
          {
            succeeded = check_hlds__inst_util__inst_merge_6_p_0(Var_67, Inst4_20, MaybeType_10, &Inst34_22, STATE_VARIABLE_ModuleInfo_34_34, &STATE_VARIABLE_ModuleInfo_35_35);
            if (succeeded)
              succeeded = check_hlds__inst_util__inst_merge_6_p_0(Inst12_59, Inst34_22, MaybeType_10, &Inst1234_23, STATE_VARIABLE_ModuleInfo_35_35, &STATE_VARIABLE_ModuleInfo_36_36);
          }
          if (succeeded)
          {
...
{
  {
    ...
    succeeded = hlds__instmap__IntroducedFrom__pred__instmap_delta_set_vars_same__621__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__instmap__IntroducedFrom__pred__instmap_set_vars_same__590__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__instmap__IntroducedFrom__pred__instmapping_set_vars_corresponding__644__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__instmap__IntroducedFrom__pred__instmapping_set_vars__633__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
