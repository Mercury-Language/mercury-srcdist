  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((hlds__instmap__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word hlds__instmap__V_40_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__instmap__HeadVar__2_2, (MR_Integer) 1)));
            MR_Word hlds__instmap__V_41_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__instmap__HeadVar__2_2, (MR_Integer) 0)));
            ...
            if ((hlds__instmap__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                if (hlds__instmap__succeeded)
                  ...
                  {
                    hlds__instmap__instmap_delta_set_var_4_p_0(hlds__instmap__V_41_41, hlds__instmap__FinalInst_35, hlds__instmap__STATE_VARIABLE_InstMapDelta_0_4, &hlds__instmap__STATE_VARIABLE_InstMapDelta_38_38);
                  }
                /* direct tailcall eliminated */
                {
                  MR_Word hlds__instmap__HeadVar__2__tmp_copy_2 = hlds__instmap__V_40_40;
                  MR_Word hlds__instmap__HeadVar__3__tmp_copy_3 = hlds__instmap__FromToInsts_32;
                  MR_Word hlds__instmap__STATE_VARIABLE_InstMapDelta_0__tmp_copy_4 = hlds__instmap__STATE_VARIABLE_InstMapDelta_38_38;
        ...
        else
          {
            ...
            if ((hlds__instmap__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  MR_Word hlds__instmap__HeadVar__2__tmp_copy_2 = hlds__instmap__V_40_40;
                  MR_Word hlds__instmap__HeadVar__3__tmp_copy_3 = hlds__instmap__Modes_32;
                  MR_Word hlds__instmap__STATE_VARIABLE_InstMapDelta_0__tmp_copy_4 = hlds__instmap__STATE_VARIABLE_InstMapDelta_38_38;
