...
static /* final */ const MR_Box hlds__instmap_scalar_common_4[1][4];

static /* final */ const MR_Box hlds__instmap_scalar_common_5[2][8];
...
static /* final */ const MR_Box hlds__instmap_scalar_common_2[5][3] = {
  ...
  /* row 3 */
  {
    ((MR_Box) (&hlds__instmap_scalar_common_3[1])),
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__instmap_scalar_common_7[0]), VarInt_35, &Var_59);
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_3, Var_17, &VarType_24);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&hlds__instmap_scalar_common_6[0]));
...
{
  {
    ...
    if ((InstMap0_9 == (MR_Word) ((MR_Unsigned) 0U)))
      *InstMap_10 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word InstMappingDelta_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InstMap0_9, (MR_Integer) 0))));
      MR_Word InstMapping_24;

      mercury__map__overlay_3_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), Instmapping_17, InstMappingDelta_22, &InstMapping_24);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *InstMap_10 = base;
...
{
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_match__inst_matches_final_typed_4_p_0(InitialInst_20, FinalInst_21, Type_22, HeadVar__1_1);
      if (succeeded)
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Test_12, 0) = ((MR_Box) (&hlds__instmap_scalar_common_5[1]));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&hlds__instmap_scalar_common_5[0]));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&hlds__instmap_scalar_common_3[0]));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&hlds__instmap_scalar_common_4[0]));
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&hlds__instmap_scalar_common_3[0]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Inst_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_13, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&hlds__instmap_scalar_common_3[0]));
