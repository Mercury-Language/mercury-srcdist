  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_merge__inst_merge_6_p_0(Type_19, InstA_34, InstB_36, &InstAB_37, STATE_VARIABLE_ModuleInfo_0_7, &STATE_VARIABLE_ModuleInfo_1_41);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_merge__inst_merge_6_p_0(VarType_28, InstA_36, InstB_38, &InstAB_39, STATE_VARIABLE_ModuleInfo_0_8, &STATE_VARIABLE_ModuleInfo_1_43);
      if (succeeded)
      {
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    check_hlds__inst_merge__insts_merge_6_p_0(VarType_24, HeadVarInst_26, TailVarInsts_27, &MaybeInst_28, STATE_VARIABLE_ModuleInfo_1_38, STATE_VARIABLE_ModuleInfo_7);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  else
  {
    ...
    check_hlds__inst_merge__insts_merge_6_p_0(Type_11, MainFinalInst_29, OtherFinalInsts_30, &MaybeMergedInst_31, STATE_VARIABLE_ModuleInfo_2_33, STATE_VARIABLE_ModuleInfo_25);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  check_hlds__inst_merge__insts_merge_6_p_0(Type_10, MainFinalInst_21, OtherFinalInsts_22, &MaybeMergedInst_23, STATE_VARIABLE_ModuleInfo_2_25, STATE_VARIABLE_ModuleInfo_20);
