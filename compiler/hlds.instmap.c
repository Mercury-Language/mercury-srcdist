...
MR_decl_label4(hlds__instmap__var_is_bound_in_instmap_delta_4_0, 2,3,5,1)
...
MR_decl_label2(__Unify___hlds__instmap__instmap_0_0, 3,1)
MR_decl_label3(__Compare___hlds__instmap__instmap_0_0, 5,3,7)
...
MR_BEGIN_MODULE(hlds__instmap_module55)
	...
	MR_init_label4(hlds__instmap__var_is_bound_in_instmap_delta_4_0,2,3,5,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__instmap__var_is_bound_in_instmap_delta_4_0);
	...
	MR_np_call_localret_ent(hlds__instmap__lookup_var_3_0,
		hlds__instmap__var_is_bound_in_instmap_delta_4_0_i2);
MR_def_label(hlds__instmap__var_is_bound_in_instmap_delta_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(check_hlds__inst_match__inst_is_free_2_0,
		hlds__instmap__var_is_bound_in_instmap_delta_4_0_i3);
MR_def_label(hlds__instmap__var_is_bound_in_instmap_delta_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(hlds__instmap_module57)
	...
	MR_init_label2(__Unify___hlds__instmap__instmap_0_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__instmap__instmap_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Unify___hlds__instmap__instmap_0_0_i3);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___hlds__instmap__instmap_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_BEGIN_MODULE(hlds__instmap_module58)
	...
	MR_init_label3(__Compare___hlds__instmap__instmap_0_0,5,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___hlds__instmap__instmap_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Compare___hlds__instmap__instmap_0_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(__Compare___hlds__instmap__instmap_0_0,5)
	...
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___hlds__instmap__instmap_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
