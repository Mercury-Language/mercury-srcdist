  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&hlds__instmap_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ((MR_Box) (Var_20)), ((MR_Box) (InstAB_33)), STATE_VARIABLE_InstMapping_0_6, &STATE_VARIABLE_InstMapping_42_42);
      }
      else
      {
