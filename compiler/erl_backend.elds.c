      ...
      switch (MR_tag((MR_Word) erl_backend__elds__HeadVar__2_2)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__2_2, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Integer erl_backend__elds__V_290_290 = ((MR_Integer) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__2_2, (MR_Integer) 1)));
                ...
                switch (MR_tag((MR_Word) erl_backend__elds__HeadVar__3_3)) {
                  ...
                  case (MR_Integer) 3:
                    switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__3_3, (MR_Integer) 0)))) {
                      ...
                      case (MR_Integer) 0:
                        {
                          MR_Integer erl_backend__elds__V_55_55 = ((MR_Integer) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__3_3, (MR_Integer) 1)));

                          {
                            mercury__private_builtin__builtin_compare_int_3_p_0(erl_backend__elds__HeadVar__1_1, erl_backend__elds__V_290_290, erl_backend__elds__V_55_55);
                          }
                        }
                        break;
                      case (MR_Integer) 1:
      ...
      switch (MR_tag((MR_Word) erl_backend__elds__HeadVar__1_1)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__1_1, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Integer erl_backend__elds__V_7_7 = ((MR_Integer) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__1_1, (MR_Integer) 1)));
                MR_Integer erl_backend__elds__V_8_8;
                ...
                if (erl_backend__elds__succeeded)
                  {
                    erl_backend__elds__V_8_8 = ((MR_Integer) (MR_hl_field(MR_mktag(3), erl_backend__elds__HeadVar__2_2, (MR_Integer) 1)));
