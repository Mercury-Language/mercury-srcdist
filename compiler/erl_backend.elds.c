...
MR_decl_label10(__Unify___erl_backend__elds__elds_expr_0_0, 247,5,9,13,19,17,25,23,31,29)
...
MR_decl_label10(__Compare___erl_backend__elds__elds_expr_0_0, 276,3,2,4,5,6,7,10,13,16)
...
MR_decl_label3(__Compare___erl_backend__elds__elds_expr_0_0, 101,294,295)
...
MR_define_entry(mercury__fn__erl_backend__elds__var_eq_false_1_0);
	...
	MR_tfield(3, MR_r1, 1) = MR_tempr1;
	MR_tfield(3, MR_r1, 2) = (MR_Word) MR_TAG_COMMON(2,2,1);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__fn__erl_backend__elds__expr_or_void_1_0);
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(2,2,2);
	MR_proceed();
...
MR_BEGIN_MODULE(erl_backend__elds_module42)
	...
	MR_init_label10(__Unify___erl_backend__elds__elds_expr_0_0,247,5,9,13,19,17,25,23,31,29)
...
MR_define_entry(mercury____Unify___erl_backend__elds__elds_expr_0_0);
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(__Unify___erl_backend__elds__elds_expr_0_0,247)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Unify___erl_backend__elds__elds_expr_0_0,19)
	...
	MR_r2 = MR_sv(6);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(__Unify___erl_backend__elds__elds_expr_0_0_i247);
...
MR_BEGIN_MODULE(erl_backend__elds_module44)
	...
	MR_init_label10(__Compare___erl_backend__elds__elds_expr_0_0,276,3,2,4,5,6,7,10,13,16)
	...
	MR_init_label3(__Compare___erl_backend__elds__elds_expr_0_0,101,294,295)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___erl_backend__elds__elds_expr_0_0);
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,276)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,7)
	...
	if (MR_PTAG_TESTR(MR_sv(5),1)) {
		MR_GOTO_LAB(__Compare___erl_backend__elds__elds_expr_0_0_i294);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(erl_backend__elds, elds_expr);
...
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___erl_backend__elds__elds_expr_0_0_i295);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
...
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,26)
	...
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(__Compare___erl_backend__elds__elds_expr_0_0_i276);
...
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,101)
	...
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(__Compare___erl_backend__elds__elds_expr_0_0_i276);
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,294)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(private_builtin__compare_error_0_0);
MR_def_label(__Compare___erl_backend__elds__elds_expr_0_0,295)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
