...
MR_decl_label4(__Unify___erl_backend__elds__elds_call_target_0_0, 5,7,17,1)
...
MR_decl_label8(__Unify___erl_backend__elds__elds_expr_0_0, 200,11,55,27,29,80,5,7)
MR_decl_label8(__Unify___erl_backend__elds__elds_expr_0_0, 15,17,21,23,33,37,41,45)
MR_decl_label8(__Unify___erl_backend__elds__elds_expr_0_0, 49,51,59,63,65,67,69,73)
MR_decl_label2(__Unify___erl_backend__elds__elds_expr_0_0, 81,1)
...
MR_decl_label8(__Unify___erl_backend__elds__elds_term_0_0, 5,14,20,35,6,10,12,16)
MR_decl_label6(__Unify___erl_backend__elds__elds_term_0_0, 18,22,24,28,36,1)
MR_decl_label8(__Index___erl_backend__elds__elds_expr_0_0, 4,13,7,20,3,5,6,8)
MR_decl_label7(__Index___erl_backend__elds__elds_expr_0_0, 9,10,11,12,14,15,16)
...
MR_decl_label8(__Compare___erl_backend__elds__elds_call_target_0_0, 3,2,5,7,13,49,15,16)
...
MR_decl_label8(__Compare___erl_backend__elds__elds_expr_0_0, 229,3,2,4,5,6,7,23)
MR_decl_label8(__Compare___erl_backend__elds__elds_expr_0_0, 75,42,45,110,10,13,17,26)
MR_decl_label8(__Compare___erl_backend__elds__elds_expr_0_0, 29,34,37,50,53,58,61,64)
MR_decl_label8(__Compare___erl_backend__elds__elds_expr_0_0, 67,70,78,81,84,88,92,99)
MR_decl_label3(__Compare___erl_backend__elds__elds_expr_0_0, 102,247,248)
...
MR_decl_label8(__Compare___erl_backend__elds__elds_rtti_id_0_0, 3,37,48,53,26,29,28,5)
MR_decl_label5(__Compare___erl_backend__elds__elds_rtti_id_0_0, 19,7,9,13,96)
MR_decl_label8(__Compare___erl_backend__elds__elds_term_0_0, 5,7,21,76,130,139,205,22)
MR_decl_label8(__Compare___erl_backend__elds__elds_term_0_0, 39,25,40,57,58,75,94,112)
MR_decl_label8(__Compare___erl_backend__elds__elds_term_0_0, 129,148,165,158,166,183,177,184)
MR_decl_label4(__Compare___erl_backend__elds__elds_term_0_0, 201,191,195,196)
...
MR_BEGIN_MODULE(erl_backend__elds_module32)
	...
	MR_init_label4(__Unify___erl_backend__elds__elds_call_target_0_0,5,7,17,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module33)
	...
	MR_init_label8(__Compare___erl_backend__elds__elds_call_target_0_0,3,2,5,7,13,49,15,16)
MR_BEGIN_CODE
...
MR_def_label(__Compare___erl_backend__elds__elds_call_target_0_0,2)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___erl_backend__elds__elds_call_target_0_0_i15);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___erl_backend__elds__elds_call_target_0_0_i15);
	}
...
MR_def_label(__Compare___erl_backend__elds__elds_call_target_0_0,5)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___erl_backend__elds__elds_call_target_0_0_i7);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
	}
MR_def_label(__Compare___erl_backend__elds__elds_call_target_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(2, MR_sv(1), 0);
...
MR_def_label(__Compare___erl_backend__elds__elds_call_target_0_0,49)
	...
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___erl_backend__elds__elds_call_target_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_BEGIN_MODULE(erl_backend__elds_module42)
	...
	MR_init_label8(__Unify___erl_backend__elds__elds_expr_0_0,200,11,55,27,29,80,5,7)
	MR_init_label8(__Unify___erl_backend__elds__elds_expr_0_0,15,17,21,23,33,37,41,45)
	MR_init_label8(__Unify___erl_backend__elds__elds_expr_0_0,49,51,59,63,65,67,69,73)
	MR_init_label2(__Unify___erl_backend__elds__elds_expr_0_0,81,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module43)
	...
	MR_init_label8(__Index___erl_backend__elds__elds_expr_0_0,4,13,7,20,3,5,6,8)
	MR_init_label7(__Index___erl_backend__elds__elds_expr_0_0,9,10,11,12,14,15,16)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module44)
	...
	MR_init_label8(__Compare___erl_backend__elds__elds_expr_0_0,229,3,2,4,5,6,7,23)
	MR_init_label8(__Compare___erl_backend__elds__elds_expr_0_0,75,42,45,110,10,13,17,26)
	MR_init_label8(__Compare___erl_backend__elds__elds_expr_0_0,29,34,37,50,53,58,61,64)
	MR_init_label8(__Compare___erl_backend__elds__elds_expr_0_0,67,70,78,81,84,88,92,99)
	MR_init_label3(__Compare___erl_backend__elds__elds_expr_0_0,102,247,248)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module50)
	...
	MR_init_label8(__Compare___erl_backend__elds__elds_rtti_id_0_0,3,37,48,53,26,29,28,5)
	MR_init_label5(__Compare___erl_backend__elds__elds_rtti_id_0_0,19,7,9,13,96)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module51)
	...
	MR_init_label8(__Unify___erl_backend__elds__elds_term_0_0,5,14,20,35,6,10,12,16)
	MR_init_label6(__Unify___erl_backend__elds__elds_term_0_0,18,22,24,28,36,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(erl_backend__elds_module52)
	...
	MR_init_label8(__Compare___erl_backend__elds__elds_term_0_0,5,7,21,76,130,139,205,22)
	MR_init_label8(__Compare___erl_backend__elds__elds_term_0_0,39,25,40,57,58,75,94,112)
	MR_init_label8(__Compare___erl_backend__elds__elds_term_0_0,129,148,165,158,166,183,177,184)
	MR_init_label4(__Compare___erl_backend__elds__elds_term_0_0,201,191,195,196)
MR_BEGIN_CODE
...
MR_def_label(__Compare___erl_backend__elds__elds_term_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_ctfield(3, MR_sv(2), 0),7)) {
