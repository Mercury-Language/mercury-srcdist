...
MR_decl_label8(transform_hlds__trans_opt__read_trans_opt_files_7_0, 21,3,4,5,6,7,8,9)
MR_decl_label6(transform_hlds__trans_opt__read_trans_opt_files_7_0, 10,11,12,13,14,15)
...
MR_BEGIN_MODULE(transform_hlds__trans_opt_module1)
	...
	MR_init_label8(transform_hlds__trans_opt__read_trans_opt_files_7_0,21,3,4,5,6,7,8,9)
	MR_init_label6(transform_hlds__trans_opt__read_trans_opt_files_7_0,10,11,12,13,14,15)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__trans_opt__read_trans_opt_files_7_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__trans_opt__read_trans_opt_files_7_0,15)
	...
	MR_GOTO_LAB(transform_hlds__trans_opt__read_trans_opt_files_7_0_i21);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
