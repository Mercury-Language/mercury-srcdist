      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_4[4]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_5[1]));
    ...
    mercury__list__map_foldl_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0), (MR_Word) (&hlds__du_type_layout_scalar_common_3[4]), Var_94, Ctors_28, &CtorRepns_32, ((MR_Box) (Var_95)), &conv3_CtorRepnMap_33);
