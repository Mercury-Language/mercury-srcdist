...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), DirectArgMsg_26, 0) = ((MR_Box) (Var_57));
        MR_hl_field(MR_mktag(1), DirectArgMsg_26, 1) = ((MR_Box) (Var_58));
      }
      {
    ...
    else
    {
      ...
      {
        NonEnumArgMsg_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NonEnumArgMsg_30, 0) = ((MR_Box) (Var_85));
        MR_hl_field(MR_mktag(1), NonEnumArgMsg_30, 1) = ((MR_Box) (Var_86));
      }
      {
