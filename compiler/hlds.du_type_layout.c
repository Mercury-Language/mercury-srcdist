...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 229, &TermSizeWords_23);
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 230, &TermSizeCells_24);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 272, &HighLevelData_26);
