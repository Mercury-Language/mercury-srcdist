...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__du_type_layout__hlds__du_type_layout__type_ctor_info_component_type_kind_0), ((MR_Box) (TypeCtor_11)), ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__du_type_layout_scalar_common_9[0]))), STATE_VARIABLE_ComponentTypeMap_0_23, STATE_VARIABLE_ComponentTypeMap_24);
      else
    ...
    *STATE_VARIABLE_Specs_40 = ((MR_Word) (conv16_STATE_VARIABLE_Specs_40));
    ...
    if (!((MaybeShowTypeRepns_28 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (!(((MR_tag((MR_Word) FileResult_33)) == (MR_Integer) 1)))
      {
        ...
        MR_Word Var_59;
        MR_Box conv18_STATE_VARIABLE_IO_60_60;

        {
          Var_59 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_7[1]));
          ...
          MR_hl_field(MR_mktag(0), Var_59, 3) = ((MR_Box) (Stream_34));
          MR_hl_field(MR_mktag(0), Var_59, 4) = ((MR_Box) (MaybePrimaryTags_35));
          MR_hl_field(MR_mktag(0), Var_59, 5) = ((MR_Box) (ShowWhichTypes_29));
          MR_hl_field(MR_mktag(0), Var_59, 6) = ((MR_Box) (ForDevelopers_30));
        }
        mercury__list__foldl_4_p_2((MR_Word) (&hlds__du_type_layout_scalar_common_2[1]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_59, TypeCtorsTypeDefns_25, ((MR_Box) ((MR_Integer) 0)), &conv18_STATE_VARIABLE_IO_60_60);
