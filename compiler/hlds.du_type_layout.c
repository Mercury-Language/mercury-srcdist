...
{
  {
    ...
    *STATE_VARIABLE_Specs_40 = ((MR_Word) (conv16_STATE_VARIABLE_Specs_40));
    ...
    if (!((MaybeShowTypeRepns_28 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_15, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".type_repns"))), ModuleName_31, &FileName_32);
      ...
      if (!(((MR_tag((MR_Word) FileResult_33)) == (MR_Integer) 1)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_7[1]));
        ...
        mercury__list__foldl_4_p_2((MR_Word) (&hlds__du_type_layout_scalar_common_2[1]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_60, TypeCtorsTypeDefns_25, ((MR_Box) ((MR_Integer) 0)), &conv18_STATE_VARIABLE_IO_61_61);
