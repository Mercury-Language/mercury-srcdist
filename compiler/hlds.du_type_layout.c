...
hlds__du_type_layout__IntroducedFrom__pred__is_direct_arg_ctor__856__1_2_p_0(
...
static void MR_CALL 
hlds__du_type_layout__assign_constructor_tags_6_p_0(
  MR_Word Globals_7,
  MR_Word TypeCtor_8,
  MR_Word UserEqCmp_9,
  MR_Word Ctors_10,
...
static void MR_CALL 
hlds__du_type_layout__assign_unshared_tags_6_p_0(
  MR_Word TypeCtor_1,
  MR_Word HeadVar__2_2,
  MR_Integer Val_3,
  MR_Integer MaxTag_4,
...
static void MR_CALL 
hlds__du_type_layout__assign_shared_remote_tags_6_p_0(
  MR_Word TypeCtor_1,
  MR_Word HeadVar__2_2,
...
static /* final */ const MR_Box hlds__du_type_layout_scalar_common_1[13][2];

static /* final */ const MR_Box hlds__du_type_layout_scalar_common_2[11][3];
...
static /* final */ const MR_Box hlds__du_type_layout_scalar_common_5[4][5];
...
static /* final */ const MR_Box hlds__du_type_layout_scalar_common_2[11][3] = {
  ...
  /* row 10 */
  {
    ((MR_Box) (&hlds__du_type_layout_scalar_common_5[3])),
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &hlds__du_type_layout_scalar_common_1[3], ((MR_Box) (MaybeRepn0_17)), ((MR_Box) (HeadVar__2_46)));
    return succeeded;
  }
}
...
{
  {
    ...
    ArgRepns_19 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_arg_repn_0, (MR_Word) &hlds__du_type_layout_scalar_common_2[10], Args_14);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      *CtorRepn_10 = base;
...
{
  {
    ...
    succeeded = hlds__du_type_layout__IntroducedFrom__pred__is_direct_arg_ctor__856__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_54 = (MR_Integer) 1;
          Var_51 = (MR_String) "hlds.du_type_layout";
          Var_52 = (MR_String) "predicate \140hlds.du_type_layout.is_direct_arg_ctor\'/6";
          Var_53 = (MR_String) "ConsArity != 1";
          {
            Var_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_5[2]));
            MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (hlds__du_type_layout__is_direct_arg_ctor_6_p_0_1));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__du_type_layout__count_words_3_p_0(ArgRepns2_22, (MR_Integer) 0, &PackedLength_54);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_5[2]));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_58 = (MR_Word) &hlds__du_type_layout_scalar_common_2[9];
                Var_59 = (MR_Integer) 0;
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__map_foldl_5_p_0(TypeCtorInfo_78_78, TypeCtorInfo_78_78, (MR_Word) &hlds__du_type_layout_scalar_common_2[2], Var_45, CtorRepns0_22, &CtorRepns_23, ((MR_Box) (Var_46)), &conv2_CtorRepnMap_24);
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_5[1]));
            MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (hlds__du_type_layout__decide_unpacked_du_type_layout_7_p_0_1));
          ...
          mercury__require__expect_3_p_0(Var_43, (MR_String) "predicate \140hlds.du_type_layout.decide_unpacked_du_type_layout\'/7", (MR_String) "MaybeRepn0 != no");
          hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_8, &Globals_19);
          hlds__du_type_layout__assign_constructor_tags_6_p_0(Globals_19, TypeCtor_11, MaybeUserEqComp_16, Ctors_15, &ConsTagMap0_20, &DuKind0_21);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_4[3]));
            MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (hlds__du_type_layout__decide_unpacked_du_type_layout_7_p_0_2));
          ...
          Var_49 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &hlds__du_type_layout_scalar_common_1[4]);
          mercury__list__map_foldl_5_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0, (MR_Word) &hlds__du_type_layout_scalar_common_2[2], Var_48, Ctors_15, &CtorRepns_29, ((MR_Box) (Var_49)), &conv3_CtorRepnMap_30);
          ...
          if (succeeded)
          {
            ...
            MaybeCheaperTagTest_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          succeeded = mercury__map__search_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0, (MR_Word) &hlds__du_type_layout_scalar_common_1[5], DirectArgMap_9, ((MR_Box) (TypeCtor_11)), &conv4_DirectArgFunctors_32);
          if (succeeded)
          {
...
{
  {
    ...
    succeeded = hlds__du_type_layout__ctors_are_all_constants_1_p_0(Ctors_10);
    if (succeeded)
    {
      MR_Word Var_15;
      MR_Word Var_27;
      ...
      if (succeeded)
      {
        ...
        *DuTypeKind_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
        ...
        mercury__map__set_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ((MR_Box) (ConsId_71)), ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__du_type_layout_scalar_common_1[12]))), STATE_VARIABLE_CtorTags_26_26, STATE_VARIABLE_CtorTags_24);
      }
      else
      {
        *DuTypeKind_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        hlds__du_type_layout__assign_enum_constants_5_p_0(TypeCtor_8, (MR_Integer) 0, Ctors_10, STATE_VARIABLE_CtorTags_26_26, STATE_VARIABLE_CtorTags_24);
      }
    }
    else
    {
      ...
      else
      {
        *DuTypeKind_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
        ...
        if (succeeded)
        {
          hlds__du_type_layout__assign_unshared_tags_6_p_0(TypeCtor_8, Ctors_10, (MR_Integer) 0, (MR_Integer) 0, STATE_VARIABLE_CtorTags_26_26, STATE_VARIABLE_CtorTags_24);
        }
        else
        {
          ...
          hlds__du_type_layout__separate_out_constants_3_p_0(Ctors_10, &Constants_21, &Functors_22);
          ...
          else
          {
            ...
            mercury__map__set_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ((MR_Box) (ConsId_125)), ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__du_type_layout_scalar_common_2[8]))), STATE_VARIABLE_CtorTags_26_26, &STATE_VARIABLE_CtorTags_28_129);
            hlds__du_type_layout__assign_shared_local_tags_6_p_0(TypeCtor_8, Ctors_116, (MR_Integer) 0, ((MR_Integer) 0 + (MR_Integer) 1), STATE_VARIABLE_CtorTags_28_129, &STATE_VARIABLE_CtorTags_37_37);
          }
          hlds__du_type_layout__assign_unshared_tags_6_p_0(TypeCtor_8, Functors_22, NextTag_23, MaxTag_20, STATE_VARIABLE_CtorTags_37_37, STATE_VARIABLE_CtorTags_24);
        }
      }
    }
  }
...
{
  {
    ...
    hlds__du_type_layout__decide_unpacked_du_type_layout_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), ((MR_Word) wrapper_arg_3), &conv4_STATE_VARIABLE_TypeTable_42);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            hlds__du_type_layout__separate_out_constants_3_p_0(Ctors_20, &Constants_39, &Functors_40);
            {
              Var_66 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (hlds__du_type_layout__convert_direct_arg_functors_if_suitable_10_p_0_1));
            ...
            else
            {
              ...
              hlds__du_type_layout__assign_constant_tags_6_p_0(TypeCtor_15, Constants_39, (MR_Integer) 0, &STATE_VARIABLE_NextTag_69_69, STATE_VARIABLE_CtorTags_68_68, &STATE_VARIABLE_CtorTags_70_70);
              hlds__du_type_layout__assign_direct_arg_tags_9_p_0(TypeCtor_15, DirectArgFunctors_41, STATE_VARIABLE_NextTag_69_69, &STATE_VARIABLE_NextTag_71_71, MaxTag_14, NonDirectArgFunctors_42, &LeftOverDirectArgFunctors_47, STATE_VARIABLE_CtorTags_70_70, &STATE_VARIABLE_CtorTags_72_72);
              Var_73 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_89_89, LeftOverDirectArgFunctors_47, NonDirectArgFunctors_42);
              hlds__du_type_layout__assign_unshared_tags_6_p_0(TypeCtor_15, Var_73, STATE_VARIABLE_NextTag_71_71, MaxTag_14, STATE_VARIABLE_CtorTags_72_72, &DirectArgConsIdToTagMap_48);
              hlds__du_type_layout__compute_cheaper_tag_test_2_p_0(DirectArgConsIdToTagMap_48, &MaybeCheaperTagTest_49);
              DirectArgFunctorNames_50 = mercury__list__map_2_f_0(TypeCtorInfo_89_89, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_and_arity_0, (MR_Word) &hlds__du_type_layout_scalar_common_2[5], DirectArgFunctors_41);
              switch (DebugTypeRep_13) {
                ...
                case (MR_Integer) 0:
                  ...
                  break;
                case (MR_Integer) 1:
                  hlds__du_type_layout__output_direct_arg_functor_summary_5_p_0(ModuleName_12, TypeCtor_15, DirectArgFunctorNames_50);
                  break;
              }
              {
                Var_78 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&hlds__du_type_layout_scalar_common_4[1]));
                MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (hlds__du_type_layout__convert_direct_arg_functors_if_suitable_10_p_0_3));
              ...
              Var_79 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &hlds__du_type_layout_scalar_common_1[4]);
              TypeCtorInfo_101_101 = (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0;
              mercury__list__map_foldl_5_p_0(TypeCtorInfo_101_101, TypeCtorInfo_101_101, (MR_Word) &hlds__du_type_layout_scalar_common_2[2], Var_78, CtorRepns0_26, &CtorRepns_52, ((MR_Box) (Var_79)), &conv3_CtorRepnMap_53);
            ...
            hlds__du_type_layout__check_incorrect_direct_arg_assertions_4_p_0(AssertedDirectArgFunctors_38, NonDirectArgFunctors_42, STATE_VARIABLE_Specs_0_63, STATE_VARIABLE_Specs_64);
          }
          else
          {
            *STATE_VARIABLE_Specs_64 = STATE_VARIABLE_Specs_0_63;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__du_type_layout__assign_shared_remote_tags_6_p_0(TypeCtor_1, Ctors_56, MaxTag_4, ((MR_Integer) 0 + (MR_Integer) 1), STATE_VARIABLE_CtorTags_29_70, STATE_VARIABLE_CtorTags_6);
        }
        else
        {
          succeeded = (Val_3 <= MaxTag_4);
          ...
          {
            {
              mercury__require__unexpected_3_p_0((MR_String) "hlds.du_type_layout", (MR_String) "predicate \140hlds.du_type_layout.assign_unshared_tags\'/6", (MR_String) "exceeded max tag");
              return;
            }
          }
        }
