...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 168, &ShowAllTypeRepns_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 167, &ShowLocalTypeRepns_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 169, &ShowDeveloperTypeRepns_33);
