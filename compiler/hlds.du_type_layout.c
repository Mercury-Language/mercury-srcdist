  ...
  MR_Word * STATE_VARIABLE_CtorTagMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word Ctor_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0)));
        MR_Word Ctors_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1)));
        MR_Word SymName_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_49, (MR_Integer) 1)));
        MR_Integer Arity_55 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Ctor_49, (MR_Integer) 3)));
        MR_Word ConsId_57;
        MR_Word Tag_58;
        MR_Word STATE_VARIABLE_CtorTagMap_29_62;
        MR_Word _MaybeExistConstraints_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_49, (MR_Integer) 0)));
        MR_Word _Args_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_49, (MR_Integer) 2)));
        MR_Word _Context_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_49, (MR_Integer) 4)));

        {
          ConsId_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ConsId_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(3), ConsId_57, 1) = ((MR_Box) (SymName_53));
          MR_hl_field(MR_mktag(3), ConsId_57, 2) = ((MR_Box) (Arity_55));
          MR_hl_field(MR_mktag(3), ConsId_57, 3) = ((MR_Box) (TypeCtor_1));
        }
        {
          Tag_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Tag_58, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
          MR_hl_field(MR_mktag(3), Tag_58, 1) = ((MR_Box) (STATE_VARIABLE_CurPtag_0_3));
          MR_hl_field(MR_mktag(3), Tag_58, 2) = ((MR_Box) ((MR_Integer) 0));
        }
        mercury__map__det_insert_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ((MR_Box) (ConsId_57)), ((MR_Box) (Tag_58)), STATE_VARIABLE_CtorTagMap_0_5, &STATE_VARIABLE_CtorTagMap_29_62);
        hlds__du_type_layout__assign_shared_remote_tags_to_non_direct_arg_functors_6_p_0(TypeCtor_1, STATE_VARIABLE_CurPtag_0_3, ((MR_Integer) 0 + (MR_Integer) 1), Ctors_50, STATE_VARIABLE_CtorTagMap_29_62, STATE_VARIABLE_CtorTagMap_6);
      }
      else
      {
        MR_Word Tag_27;
        MR_Word STATE_VARIABLE_CtorTagMap_34_34;
        MR_Integer STATE_VARIABLE_CurPtag_35_35;
        ...
        STATE_VARIABLE_CurPtag_35_35 = (STATE_VARIABLE_CurPtag_0_3 + (MR_Integer) 1);
        // direct tailcall eliminated
        next_value_of_STATE_VARIABLE_CurPtag_0_3 = STATE_VARIABLE_CurPtag_35_35;
