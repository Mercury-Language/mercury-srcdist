...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) ConsArgs_18)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) ArgComponentKind_29)) == (MR_mktag((MR_Integer) 2)));
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) ArgTypeDefnBody_32)) == (MR_mktag((MR_Integer) 1)));
                        if (succeeded)
                        {
