...
MR_decl_label5(transform_hlds__term_util__horder_vars_2_0, 24,6,7,3,1)
...
MR_decl_label6(transform_hlds__term_util__remove_unused_args_4_0, 37,21,3,12,10,41)
...
MR_BEGIN_MODULE(transform_hlds__term_util_module4)
	...
	MR_init_label6(transform_hlds__term_util__remove_unused_args_4_0,37,21,3,12,10,41)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_util__remove_unused_args_4_0,37)
	...
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_util__remove_unused_args_4_0_i41);
	}
...
MR_def_label(transform_hlds__term_util__remove_unused_args_4_0,10)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__term_util__remove_unused_args_4_0_i37);
MR_def_label(transform_hlds__term_util__remove_unused_args_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_util_module9)
	...
	MR_init_label5(transform_hlds__term_util__horder_vars_2_0,24,6,7,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__term_util__horder_vars_2_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_util__horder_vars_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_util__horder_vars_2_0,7)
	...
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(transform_hlds__term_util__horder_vars_2_0_i24);
