...
{
  {
...

    {
      ...
      {
        transform_hlds__term_util__V_5_5 = parse_tree__prog_data_foreign__get_terminates_1_f_0(transform_hlds__term_util__Attributes_2);
      }
    ...
    if (!(transform_hlds__term_util__succeeded))
      {
        ...
        {
          transform_hlds__term_util__V_3_3 = parse_tree__prog_data_foreign__get_terminates_1_f_0(transform_hlds__term_util__Attributes_2);
        }
        transform_hlds__term_util__succeeded = (transform_hlds__term_util__V_3_3 == (MR_Integer) 2);
        if (transform_hlds__term_util__succeeded)
          {
            {
              transform_hlds__term_util__V_4_4 = parse_tree__prog_data_foreign__get_may_call_mercury_1_f_0(transform_hlds__term_util__Attributes_2);
            }
...
{
  {
    ...
    if ((transform_hlds__term_util__SCCProcs_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word transform_hlds__term_util__V_15_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_util__SCCProcs_7, (MR_Integer) 0)));
        MR_Word transform_hlds__term_util__V_10_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_util__SCCProcs_7, (MR_Integer) 1)));
        MR_Integer transform_hlds__term_util__V_9_9;

        transform_hlds__term_util__PredId_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__V_15_15, (MR_Integer) 0)));
        transform_hlds__term_util__V_9_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__V_15_15, (MR_Integer) 1)));
        {
...
{
  {
    ...
    if ((transform_hlds__term_util__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word transform_hlds__term_util__V_40_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word transform_hlds__term_util__V_41_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 0)));
        ...
        if ((transform_hlds__term_util__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            MR_Word transform_hlds__term_util__V_36_36;
            MR_Word transform_hlds__term_util__V_33_33;

            {
              transform_hlds__term_util__split_unification_vars_5_p_0(transform_hlds__term_util__ModuleInfo_1, transform_hlds__term_util__V_40_40, transform_hlds__term_util__ArgModes_28, &transform_hlds__term_util__InVars0_31, &transform_hlds__term_util__OutVars0_32);
            }
            transform_hlds__term_util__V_33_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__ArgMode_27, (MR_Integer) 0)));
            transform_hlds__term_util__V_36_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__ArgMode_27, (MR_Integer) 1)));
            transform_hlds__term_util__ArgInit_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__V_36_36, (MR_Integer) 0)));
            transform_hlds__term_util__ArgFinal_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__V_36_36, (MR_Integer) 1)));
            {
            ...
            if (transform_hlds__term_util__succeeded)
              {
                {
                  mercury__bag__insert_3_p_0((MR_Word) &transform_hlds__term_util_scalar_common_1[0], ((MR_Box) (transform_hlds__term_util__V_41_41)), transform_hlds__term_util__InVars0_31, transform_hlds__term_util__HeadVar__4_4);
                }
                ...
                if (transform_hlds__term_util__succeeded)
                  {
                    *transform_hlds__term_util__HeadVar__4_4 = transform_hlds__term_util__InVars0_31;
                    {
                      mercury__bag__insert_3_p_0((MR_Word) &transform_hlds__term_util_scalar_common_1[0], ((MR_Box) (transform_hlds__term_util__V_41_41)), transform_hlds__term_util__OutVars0_32, transform_hlds__term_util__HeadVar__5_5);
                    }
                  }
                else
                  {
