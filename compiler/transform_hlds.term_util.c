...
{
  {
    ...
    else
    {
      ...
      Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgMode_25, (MR_Integer) 0)));
        Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgMode_25, (MR_Integer) 1)));
        ArgInit_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_34, (MR_Integer) 0)));
        ArgFinal_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_34, (MR_Integer) 1)));
        succeeded = check_hlds__inst_test__inst_is_bound_2_p_0(ModuleInfo_1, ArgInit_32);
        if (succeeded)
        {
        ...
        {
          succeeded = check_hlds__inst_test__inst_is_free_2_p_0(ModuleInfo_1, ArgInit_32);
          if (succeeded)
            succeeded = check_hlds__inst_test__inst_is_bound_2_p_0(ModuleInfo_1, ArgFinal_33);
          if (succeeded)
          {
