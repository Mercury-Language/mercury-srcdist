  ...
  MR_Word * Believe_4)
{
  ...
  if (succeeded)
  {
    Var_8 = ((MR_Word) ((MR_hl_field(3, OpMode_6, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_8)) == (MR_Integer) 3);
    if (succeeded)
    {
      Var_9 = ((MR_Word) ((MR_hl_field(3, Var_8, (MR_Integer) 0))));
  ...
  MR_Word * Context_6)
{
  ...
  else
  {
    MR_Word PredId_8;
    MR_Word PredInfo_11;
    MR_Word Var_12 = ((MR_Word) ((MR_hl_field(1, SCCProcs_7, (MR_Integer) 0))));

    PredId_8 = ((MR_Word) ((MR_hl_field(0, Var_12, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_13, PredInfo_18, STATE_VARIABLE_ModuleInfo_0_3, &STATE_VARIABLE_ModuleInfo_22_22);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = PPIds_10;
      next_value_of_STATE_VARIABLE_ModuleInfo_0_3 = STATE_VARIABLE_ModuleInfo_22_22;
  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Mode_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
        MR_Word Modes_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
  ...
  MR_Word PPId_4)
{
  ...
  if (succeeded)
  {
    Var_9 = ((MR_Word) ((MR_hl_field(1, TerminationInfo_7, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      Vars_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    {
      MR_Word ArgMode_25 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
      MR_Word ArgModes_26 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
      MR_Word InVars0_29;
      MR_Word OutVars0_30;
      MR_Word ArgInit_33;
      MR_Word ArgFinal_34;
      ...
      ArgInit_33 = ((MR_Word) ((MR_hl_field(0, ArgMode_25, (MR_Integer) 2))));
      ArgFinal_34 = ((MR_Word) ((MR_hl_field(0, ArgMode_25, (MR_Integer) 3))));
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    {
      MR_Word Arg_24 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
      MR_Word Args_25 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
