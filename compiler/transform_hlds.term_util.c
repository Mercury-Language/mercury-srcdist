...
{
  {
    ...
    if (transform_hlds__term_util__succeeded)
      *transform_hlds__term_util__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__term_util__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer transform_hlds__term_util__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer transform_hlds__term_util__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word transform_hlds__term_util__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer transform_hlds__term_util__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__3_3, (MR_Integer) 1)));
        MR_Integer transform_hlds__term_util__Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word transform_hlds__term_util__Var_10;

        {
          transform_hlds__term_norm____Compare____functor_info_0_0(&transform_hlds__term_util__Var_10, transform_hlds__term_util__Var_4, transform_hlds__term_util__Var_7);
        }
        ...
        if (transform_hlds__term_util__succeeded)
          *transform_hlds__term_util__HeadVar__1_1 = transform_hlds__term_util__Var_10;
        else
          {
            ...
            {
              mercury__private_builtin__builtin_compare_int_3_p_0(&transform_hlds__term_util__Var_11, transform_hlds__term_util__Var_5, transform_hlds__term_util__Var_8);
            }
            ...
            if (transform_hlds__term_util__succeeded)
              *transform_hlds__term_util__HeadVar__1_1 = transform_hlds__term_util__Var_11;
              ...
              {
                mercury__private_builtin__builtin_compare_int_3_p_0(transform_hlds__term_util__HeadVar__1_1, transform_hlds__term_util__Var_6, transform_hlds__term_util__Var_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (transform_hlds__term_util__succeeded)
      ...
      {
        MR_Word transform_hlds__term_util__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer transform_hlds__term_util__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer transform_hlds__term_util__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word transform_hlds__term_util__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer transform_hlds__term_util__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer transform_hlds__term_util__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), transform_hlds__term_util__HeadVar__2_2, (MR_Integer) 2)));

        {
          transform_hlds__term_util__succeeded = transform_hlds__term_norm____Unify____functor_info_0_0(transform_hlds__term_util__Var_3, transform_hlds__term_util__Var_6);
        }
        if (transform_hlds__term_util__succeeded)
          {
            transform_hlds__term_util__succeeded = (transform_hlds__term_util__Var_4 == transform_hlds__term_util__Var_7);
            if (transform_hlds__term_util__succeeded)
              transform_hlds__term_util__succeeded = (transform_hlds__term_util__Var_5 == transform_hlds__term_util__Var_8);
          }
      }
    return transform_hlds__term_util__succeeded;
  }
...
{
  {
    ...
    if (transform_hlds__term_util__succeeded)
      transform_hlds__term_util__Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__term_util__Var_9, (MR_Integer) 0)));
    return transform_hlds__term_util__succeeded;
  }
}
