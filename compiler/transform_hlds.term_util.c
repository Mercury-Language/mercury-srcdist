...
static const MR_FA_TypeInfo_Struct2 transform_hlds__term_util__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0list__ti_list_1bool__type_ctor_info_bool_0;
...
const MR_TypeCtorInfo_Struct transform_hlds__term_util__transform_hlds__term_util__type_ctor_info_used_args_0 = {
  ...
  (MR_String) "used_args",
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__term_util__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0list__ti_list_1bool__type_ctor_info_bool_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
