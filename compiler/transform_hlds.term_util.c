  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Arg_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      Args_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_3, Arg_4, &Type_6);
      succeeded = parse_tree__prog_type__type_is_higher_order_1_p_0(Type_6);
      if (succeeded)
        succeeded = MR_TRUE;
      else
      {
        MR_Word next_value_of_HeadVar__2_2 = Args_5;
