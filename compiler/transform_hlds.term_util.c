...
MR_decl_label8(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0, 18,3,4,5,6,7,8,9)
MR_decl_label3(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0, 10,11,12)
MR_decl_label8(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0, 18,3,4,5,6,7,8,9)
MR_decl_label3(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0, 10,11,12)
MR_decl_label8(transform_hlds__term_util__split_unification_vars_5_0, 4,6,3,10,13,15,11,17)
MR_decl_label4(transform_hlds__term_util__split_unification_vars_5_0, 19,21,16,9)
...
MR_BEGIN_MODULE(transform_hlds__term_util_module2)
	...
	MR_init_label4(transform_hlds__term_util__split_unification_vars_5_0,19,21,16,9)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_util_module5)
	...
	MR_init_label8(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0,18,3,4,5,6,7,8,9)
	MR_init_label3(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0,10,11,12)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0,12)
	...
	MR_GOTO_LAB(transform_hlds__term_util__set_pred_proc_ids_arg_size_info_4_0_i18);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__term_util_module6)
	...
	MR_init_label8(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0,18,3,4,5,6,7,8,9)
	MR_init_label3(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0,10,11,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0);
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0,12)
	...
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(transform_hlds__term_util__set_pred_proc_ids_termination_info_4_0_i18);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
