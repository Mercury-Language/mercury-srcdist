...
MR_decl_label10(transform_hlds__term_util__split_unification_vars_5_0, 5,7,3,11,14,17,12,19,21,24)
MR_decl_label2(transform_hlds__term_util__split_unification_vars_5_0, 18,10)
...
MR_BEGIN_MODULE(transform_hlds__term_util_module2)
	...
	MR_init_label10(transform_hlds__term_util__split_unification_vars_5_0,5,7,3,11,14,17,12,19,21,24)
	MR_init_label2(transform_hlds__term_util__split_unification_vars_5_0,18,10)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_util__split_unification_vars_5_0,11)
	...
	MR_tempr2 = MR_sv(3);
	MR_sv(6) = MR_tfield(0, MR_tfield(0, MR_tempr2, 1), 1);
