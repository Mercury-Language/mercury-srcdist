  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__map__lookup_3_p_0(TypeCtorInfo_30_30, TypeCtorInfo_31_31, ProcTable0_17, ((MR_Box) (ProcId_14)), &conv1_ProcInfo0_18);
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_30_30, TypeCtorInfo_31_31, ((MR_Box) (ProcId_14)), ((MR_Box) (ProcInfo_19)), ProcTable0_17, &ProcTable_20);
