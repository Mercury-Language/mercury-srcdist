  ...
  MR_Word * Believe_4)
{
  ...
  if (succeeded)
  {
    Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(3), OpMode_6, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_7)) == (MR_Integer) 2);
    if (succeeded)
    {
      Var_8 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Var_7, (MR_Integer) 0))));
  ...
  MR_Word * Context_6)
{
  ...
  else
  {
    MR_Word PredId_8;
    MR_Word PredInfo_11;
    MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SCCProcs_7, (MR_Integer) 0))));

    PredId_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      Vars_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
