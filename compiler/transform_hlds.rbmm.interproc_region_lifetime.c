  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__rbmm__interproc_region_lifetime__compute_constantR_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv6_STATE_VARIABLE_ConstantRTable_21);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__rbmm__interproc_region_lifetime__run_with_dependency_9_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 7)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 8)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_STATE_VARIABLE_ProcRegionSetTable_19);
  ...
  MR_Word * STATE_VARIABLE_DeadRTable_26)
{
  ...
  mercury__list__reverse_2_p_0((MR_Word) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_1[1]), BottomUpSCCs_42, &TopDownSCCs_45);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (transform_hlds__rbmm__interproc_region_lifetime__compute_interproc_region_lifetime_12_p_0_2));
    MR_hl_field(MR_mktag(0), Var_46, 2) = ((MR_Box) ((MR_Integer) 6));
    MR_hl_field(MR_mktag(0), Var_46, 3) = ((MR_Box) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_2[5]));
    MR_hl_field(MR_mktag(0), Var_46, 4) = ((MR_Box) (ModuleInfo1_40));
    MR_hl_field(MR_mktag(0), Var_46, 5) = ((MR_Box) (RptaInfoTable_14));
    MR_hl_field(MR_mktag(0), Var_46, 6) = ((MR_Box) (ExecPathTable_15));
    MR_hl_field(MR_mktag(0), Var_46, 7) = ((MR_Box) (LRBeforeTable_16));
    MR_hl_field(MR_mktag(0), Var_46, 8) = ((MR_Box) (LRAfterTable_17));
  }
  ...
  *STATE_VARIABLE_BornRTable_24 = ((MR_Word) (conv2_STATE_VARIABLE_BornRTable_24));
  ...
  mercury__list__reverse_2_p_0((MR_Word) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_1[1]), BottomUpSCCs_53, &TopDownSCCs_56);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (transform_hlds__rbmm__interproc_region_lifetime__compute_interproc_region_lifetime_12_p_0_4));
    MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 6));
    MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (&transform_hlds__rbmm__interproc_region_lifetime_scalar_common_2[6]));
    MR_hl_field(MR_mktag(0), Var_57, 4) = ((MR_Box) (ModuleInfo1_51));
    MR_hl_field(MR_mktag(0), Var_57, 5) = ((MR_Box) (RptaInfoTable_14));
    MR_hl_field(MR_mktag(0), Var_57, 6) = ((MR_Box) (ExecPathTable_15));
    MR_hl_field(MR_mktag(0), Var_57, 7) = ((MR_Box) (LRBeforeTable_16));
    MR_hl_field(MR_mktag(0), Var_57, 8) = ((MR_Box) (LRAfterTable_17));
  }
  ...
  *STATE_VARIABLE_DeadRTable_26 = ((MR_Word) (conv5_STATE_VARIABLE_DeadRTable_26));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_29, 1) = ((MR_Box) (transform_hlds__rbmm__interproc_region_lifetime__compute_interproc_region_lifetime_12_p_0_5));
