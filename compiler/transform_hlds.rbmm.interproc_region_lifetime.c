...
MR_decl_label6(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0, 2,3,6,4,10,9)
...
MR_decl_entry(transform_hlds__rbmm__points_to_graph__rptg_node_content_get_node_type_2_0);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__interproc_region_lifetime_module20)
	...
	MR_init_label6(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0,2,3,6,4,10,9)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_node_content_get_node_type_2_0,
		transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0_i3);
MR_def_label(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__type_util__type_is_atomic_2_0,
		transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0_i6);
...
MR_def_label(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0_i9);
	}
	MR_r1 = MR_sv(4);
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__rbmm__interproc_region_lifetime__retain_non_primitive_regions_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(4);
