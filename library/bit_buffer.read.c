...
MR_decl_label10(bit_buffer__read__get_bitmap_8_0, 8,9,10,11,12,13,7,100,21,19)
...
MR_decl_label10(bit_buffer__read__recursively_get_bitmap_9_0, 83,2,4,5,6,7,8,12,16,19)
...
MR_BEGIN_MODULE(bit_buffer__read_module12)
	...
	MR_init_label10(bit_buffer__read__recursively_get_bitmap_9_0,83,2,4,5,6,7,8,12,16,19)
...
MR_def_label(bit_buffer__read__recursively_get_bitmap_9_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
...
MR_def_label(bit_buffer__read__recursively_get_bitmap_9_0,28)
	...
	MR_GOTO_LAB(bit_buffer__read__recursively_get_bitmap_9_0_i83);
...
MR_BEGIN_MODULE(bit_buffer__read_module13)
	...
	MR_init_label10(bit_buffer__read__get_bitmap_8_0,8,9,10,11,12,13,7,100,21,19)
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_LE(MR_r3,0)) {
		MR_GOTO_LAB(bit_buffer__read__get_bitmap_8_0_i100);
	}
...
MR_def_label(bit_buffer__read__get_bitmap_8_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r3,0)) {
