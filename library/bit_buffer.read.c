...
{
  {
    ...
    if (mercury__bit_buffer__read__succeeded)
      *mercury__bit_buffer__read__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mercury__bit_buffer__read__Var_4 = (MR_Box) mercury__bit_buffer__read__HeadVar__2_2;
        MR_Box mercury__bit_buffer__read__Var_5 = (MR_Box) mercury__bit_buffer__read__HeadVar__3_3;

        {
          mercury__bit_buffer____Compare____bit_buffer_3_0(mercury__bit_buffer__read__TypeInfo_for_Stream_8, mercury__bit_buffer__read__TypeInfo_for_State_9, mercury__bit_buffer__read__TypeInfo_for_Error_10, mercury__bit_buffer__read__HeadVar__1_1, mercury__bit_buffer__read__Var_4, mercury__bit_buffer__read__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__bit_buffer__read__succeeded)
      ...
      {
        MR_Box mercury__bit_buffer__read__Var_3 = (MR_Box) mercury__bit_buffer__read__HeadVar__1_1;
        MR_Box mercury__bit_buffer__read__Var_4 = (MR_Box) mercury__bit_buffer__read__HeadVar__2_2;

        {
          mercury__bit_buffer__read__succeeded = mercury__bit_buffer____Unify____bit_buffer_3_0(mercury__bit_buffer__read__TypeInfo_for_Stream_7, mercury__bit_buffer__read__TypeInfo_for_State_8, mercury__bit_buffer__read__TypeInfo_for_Error_9, mercury__bit_buffer__read__Var_3, mercury__bit_buffer__read__Var_4);
        }
      }
    return mercury__bit_buffer__read__succeeded;
  }
...
{
  {
    ...
    if (mercury__bit_buffer__read__succeeded)
      ...
      {
        MR_Box mercury__bit_buffer__read__Var_8 = (MR_Box) mercury__bit_buffer__read__Cast_HeadVar1_3;
        MR_Box mercury__bit_buffer__read__Var_9 = (MR_Box) mercury__bit_buffer__read__Cast_HeadVar2_4;

        {
          mercury__bit_buffer__read__succeeded = mercury__bit_buffer____Unify____bit_buffer_3_0(mercury__bit_buffer__read__TypeCtorInfo_5_5, mercury__bit_buffer__read__TypeCtorInfo_6_6, mercury__bit_buffer__read__TypeCtorInfo_7_7, mercury__bit_buffer__read__Var_8, mercury__bit_buffer__read__Var_9);
        }
      }
    return mercury__bit_buffer__read__succeeded;
  }
