...
MR_decl_label10(bit_buffer__read__get_bitmap_8_0, 8,9,10,11,7,5,18,16,14,3)
...
MR_def_label(bit_buffer__read__do_refill_read_buffer_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = ((MR_Integer) MR_sv(5) - (MR_Integer) MR_sv(2));
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(fn__int__bits_per_int_0_0,
...
MR_def_label(bit_buffer__read__do_refill_read_buffer_3_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = ((MR_Integer) MR_sv(5) - (MR_Integer) MR_r1);
	MR_np_call_localret_ent(fn__int__bits_per_int_0_0,
...
{
#line 146 "bit_buffer.opt"

    Buffer = Buffer0;
    Buffer->ML_bit_buffer_state = State;
;}
#line 2045 "bit_buffer.read.c"
...
MR_BEGIN_MODULE(bit_buffer__read_module13)
	...
	MR_init_label10(bit_buffer__read__get_bitmap_8_0,8,9,10,11,7,5,18,16,14,3)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_sv(2) = MR_r1;
	MR_r1 = MR_tempr1;
	MR_r5 = ((MR_Integer) MR_tempr2 + (MR_Integer) MR_sv(3));
	MR_r6 = MR_sv(4);
	}
...
MR_def_label(bit_buffer__read__get_bitmap_8_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(bit_buffer__read__get_bitmap_8_0_i14);
	}
	if (((MR_Integer) 0 > (MR_Integer) MR_r2)) {
...
MR_def_label(bit_buffer__read__get_bitmap_8_0,16)
	...
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(6);
MR_def_label(bit_buffer__read__get_bitmap_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	{
	MR_Word MR_tempr1, MR_tempr2;
