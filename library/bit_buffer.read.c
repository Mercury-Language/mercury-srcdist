...
#undef MR_PROC_LABEL
	State0_81  = (MR_Box) State;
          ...
          func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *, MR_Box *, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_bulk_reader_60, (MR_Integer) 0)), (MR_Integer) 5))));
