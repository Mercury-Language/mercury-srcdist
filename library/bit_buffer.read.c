...
{
#line 131 "bit_buffer.opt"

    ReadStatus = Buffer->ML_bit_buffer_read_status;
;}
#line 1048 "bit_buffer.read.c"
...
{
#line 147 "bit_buffer.opt"

    Buffer = Buffer0;
    Buffer->ML_bit_buffer_state = State;
;}
#line 1966 "bit_buffer.read.c"
...
#undef	MR_PROC_LABEL
	...
	MR_tempr2 = ((MR_Integer) MR_sv(2) + (MR_Integer) MR_sv(3));
	{
	MR_BitmapPtr	BM;
	MR_Integer	Pos;
	ML_BitBufferPtr	Buffer0;
