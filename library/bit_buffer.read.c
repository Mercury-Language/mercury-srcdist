...
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 2,3,4,5,7,9,10,11)
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 12,13,8,15,16,17,18,19)
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 20,21,22,23,24,25,26,27)
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 28,29,30,31,32,34,35,36)
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 37,38,39,40,41,42,43,44)
MR_decl_label8(bit_buffer__read__do_refill_read_buffer_3_0, 45,46,47,48,49,50,51,52)
MR_decl_label7(bit_buffer__read__do_refill_read_buffer_3_0, 53,54,55,56,57,65,59)
MR_decl_label1(bit_buffer__read__finalize_6_0, 2)
MR_decl_label4(bit_buffer__read__get_bit_3_0, 2,7,5,4)
MR_decl_label8(bit_buffer__read__get_bitmap_8_0, 8,9,10,11,12,13,7,78)
MR_decl_label5(bit_buffer__read__get_bitmap_8_0, 21,19,18,16,3)
MR_decl_label8(bit_buffer__read__get_bits_8_0, 6,8,10,9,12,15,14,4)
MR_decl_label2(bit_buffer__read__get_bits_8_0, 17,3)
MR_decl_label8(bit_buffer__read__recursively_get_bitmap_9_0, 67,2,4,5,6,7,8,12)
MR_decl_label8(bit_buffer__read__recursively_get_bitmap_9_0, 16,19,18,15,14,10,21,25)
MR_decl_label5(bit_buffer__read__recursively_get_bitmap_9_0, 26,27,28,24,23)
...
MR_BEGIN_MODULE(bit_buffer__read_module5)
	...
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,2,3,4,5,7,9,10,11)
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,12,13,8,15,16,17,18,19)
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,20,21,22,23,24,25,26,27)
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,28,29,30,31,32,34,35,36)
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,37,38,39,40,41,42,43,44)
	MR_init_label8(bit_buffer__read__do_refill_read_buffer_3_0,45,46,47,48,49,50,51,52)
	MR_init_label7(bit_buffer__read__do_refill_read_buffer_3_0,53,54,55,56,57,65,59)
MR_BEGIN_CODE
...
#line 89 "bit_buffer.opt"
BM = Buffer->ML_bit_buffer_bitmap;;}
#line 1358 "bit_buffer.read.c"
	MR_RELEASE_GLOBAL_LOCK("bitmap");
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_BitmapPtr, BM, MR_tempr2);
#undef	MR_PROC_LABEL
	}
	...
	ML_BitBufferPtr	Buffer;
#define	MR_PROC_LABEL	mercury__bit_buffer__read__do_get_bits_7_0
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_tempr2, BM);
	Pos = MR_tempr3;
...
MR_BEGIN_MODULE(bit_buffer__read_module8)
	...
	MR_init_label8(bit_buffer__read__get_bits_8_0,6,8,10,9,12,15,14,4)
	MR_init_label2(bit_buffer__read__get_bits_8_0,17,3)
MR_BEGIN_CODE
...
MR_def_label(bit_buffer__read__get_bit_3_0,4)
	...
	MR_tfield(2, MR_r1, 0) = MR_ctfield(1, MR_r3, 0);
	MR_r2 = MR_r4;
	MR_decr_sp_and_return(1);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(bit_buffer__read_module12)
	...
	MR_init_label8(bit_buffer__read__recursively_get_bitmap_9_0,67,2,4,5,6,7,8,12)
	MR_init_label8(bit_buffer__read__recursively_get_bitmap_9_0,16,19,18,15,14,10,21,25)
	MR_init_label5(bit_buffer__read__recursively_get_bitmap_9_0,26,27,28,24,23)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(bit_buffer__read_module13)
	...
	MR_init_label8(bit_buffer__read__get_bitmap_8_0,8,9,10,11,12,13,7,78)
	MR_init_label5(bit_buffer__read__get_bitmap_8_0,21,19,18,16,3)
MR_BEGIN_CODE
...
void mercury__bit_buffer__read__write_out_proc_statics(FILE *fp);
#endif
