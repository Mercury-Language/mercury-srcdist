...
int16_t MR_CALL 
mercury__int16__clamp_3_f_0(
  int16_t Min_5,
  int16_t Max_6,
  int16_t N_7)
{
  MR_bool succeeded = (Max_6 >= Min_5);
  int16_t HeadVar__4_4;
  ...
  else
  {
    ...
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int16_0), (MR_String) "function \140int16.clamp\'/3", (MR_String) "Max < Min");
    HeadVar__4_4 = ((int16_t) (MR_Word) conv0_HeadVar__4_4);
  }
  return HeadVar__4_4;
}
