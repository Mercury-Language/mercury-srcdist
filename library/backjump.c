...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Var_31, (MR_String) "error writing to output file: ", &Var_34);
    {
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Var_38, (MR_String) "error writing to output file: ", &Var_41);
    {
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Var_46, (MR_String) "error writing to output file: ", &Var_49);
    {
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Var_52, (MR_String) "error writing to output file: ", &Var_55);
    {
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Var_58, (MR_String) "error writing to output file: ", &Var_61);
    {
