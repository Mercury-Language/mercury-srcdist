  ...
  MR_Integer mercury__backjump__Id_4)
{
  {
    MR_bool mercury__backjump__succeeded;
    MR_Word mercury__backjump__StdErrStream_7;
    MR_String mercury__backjump__V_22_22;
    MR_Word mercury__backjump__V_28_28;
    MR_Box mercury__backjump__V_4_35;
    MR_Box mercury__backjump__V_6_36;
    MR_Box mercury__backjump__V_5_57;
    MR_Box mercury__backjump__V_8_58;
    MR_Word mercury__backjump__V_7_76;
    MR_Word mercury__backjump__V_8_77;
    MR_Box mercury__backjump__V_5_81;
    MR_Box mercury__backjump__V_8_82;
    MR_Word mercury__backjump__V_8_46;
    MR_String mercury__backjump__V_6_50;
    MR_Word mercury__backjump__V_8_68;
    MR_String mercury__backjump__V_6_72;
    MR_Word mercury__backjump__V_8_92;
    MR_String mercury__backjump__V_6_96;
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_4_35  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_4_35 ;
		{
    ...
    if (MR_FLUSH(*Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_6_36 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_6_36 , Error);
		{
...
mercury__backjump__succeeded  = SUCCESS_INDICATOR;
}
    if (mercury__backjump__succeeded)
      mercury__backjump__succeeded = MR_FALSE;
    else
      {
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_50  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_46 = (MR_Word) mercury__backjump__V_6_50;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_47 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_47, ((MR_Box) (mercury__backjump__V_8_46)));
          return;
        }
      }
    else
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = &mercury_stderr;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_5_57  = (MR_Box) Stream;
}
    mercury__backjump__StdErrStream_7 = (MR_Word) mercury__backjump__V_5_57;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_57 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_58 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_8_58 , Error);
		{
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_72  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_68 = (MR_Word) mercury__backjump__V_6_72;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_69 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_69, ((MR_Box) (mercury__backjump__V_8_68)));
          return;
        }
      }
    else
    ...
    mercury__backjump__V_28_28 = (MR_Word) &mercury__backjump_scalar_common_4[0];
    mercury__backjump__V_7_76 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__backjump__V_8_77 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      mercury__string__format__format_signed_int_component_5_p_0(mercury__backjump__V_28_28, mercury__backjump__V_7_76, mercury__backjump__V_8_77, mercury__backjump__Id_4, &mercury__backjump__V_22_22);
    }
    mercury__backjump__V_5_81 = (MR_Box) mercury__backjump__StdErrStream_7;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_81 ;
	Message =  mercury__backjump__V_22_22 ;
		{
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_82 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_8_82 , Error);
		{
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_96  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_92 = (MR_Word) mercury__backjump__V_6_96;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_93 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_93, ((MR_Box) (mercury__backjump__V_8_92)));
          return;
        }
      }
    else
    ...
    {
      mercury__io__write_string_4_p_0(mercury__backjump__StdErrStream_7, (MR_String) ")\n");
    }
    {
      mercury__io__flush_output_3_p_0(mercury__backjump__StdErrStream_7);
    }
  }
}
