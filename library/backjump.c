...
{
  {
    ...
    MR_String mercury__backjump__Var_22;
    MR_Word mercury__backjump__Var_28;
...
#undef MR_PROC_LABEL
    ...
    mercury__backjump__Var_28 = (MR_Word) &mercury__backjump_scalar_common_4[0];
    ...
    {
      mercury__string__format__format_signed_int_component_5_p_0(mercury__backjump__Var_28, mercury__backjump__V_7_76, mercury__backjump__V_8_77, mercury__backjump__Id_4, &mercury__backjump__Var_22);
    }
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Message =  mercury__backjump__Var_22 ;
		{
