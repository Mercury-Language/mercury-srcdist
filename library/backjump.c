...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, V_6_36 , Error);
		{
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      V_8_46 = (MR_Word) V_6_50;
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      MR_Word TypeCtorInfo_10_47 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

      {
        mercury__exception__throw_1_p_0(TypeCtorInfo_10_47, ((MR_Box) (V_8_46)));
        return;
      }
    }
    else
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = &mercury_stderr;
		...
		;}
#undef MR_PROC_LABEL
	 V_5_57  = (MR_Box) Stream;
}
    StdErrStream_7 = (MR_Word) V_5_57;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, V_8_58 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, V_8_58 , Error);
		{
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      V_8_68 = (MR_Word) V_6_72;
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      MR_Word TypeCtorInfo_10_69 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

      {
        mercury__exception__throw_1_p_0(TypeCtorInfo_10_69, ((MR_Box) (V_8_68)));
        return;
      }
    }
    else
    ...
    Var_28 = (MR_Word) &mercury__backjump_scalar_common_4[0];
    V_7_76 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    V_8_77 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__string__format__format_signed_int_component_5_p_0(Var_28, V_7_76, V_8_77, Id_4, &Var_22);
    V_5_81 = (MR_Box) StdErrStream_7;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, V_8_82 , Error);
		{
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      V_8_92 = (MR_Word) V_6_96;
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      MR_Word TypeCtorInfo_10_93 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

      {
        mercury__exception__throw_1_p_0(TypeCtorInfo_10_93, ((MR_Box) (V_8_92)));
        return;
      }
    }
    else
    ...
    mercury__io__write_string_4_p_0(StdErrStream_7, (MR_String) ")\n");
    mercury__io__flush_output_3_p_0(StdErrStream_7);
  }
}
