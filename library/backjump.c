...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    if (MR_FLUSH(*Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_31 );
}
  mercury__io__throw_on_error_4_p_0(Var_31, (MR_String) "error writing to output file: ");
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
