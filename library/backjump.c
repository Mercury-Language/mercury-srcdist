...
#undef MR_PROC_LABEL
    ...
    mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__backjump_scalar_common_4[0]), (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), Id_4, &Var_22);
