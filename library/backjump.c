...
{
  {
    ...
    MR_Box mercury__backjump__V_4_37;
    MR_Box mercury__backjump__V_6_38;
    MR_Box mercury__backjump__V_5_59;
    MR_Box mercury__backjump__V_8_60;
    MR_Word mercury__backjump__V_7_78;
    MR_Word mercury__backjump__V_8_79;
    MR_Box mercury__backjump__V_4_82;
    MR_Box mercury__backjump__V_6_83;
    MR_Word mercury__backjump__V_8_48;
    MR_String mercury__backjump__V_6_52;
    MR_Word mercury__backjump__V_8_70;
    MR_String mercury__backjump__V_6_74;
    MR_Word mercury__backjump__V_8_93;
    MR_String mercury__backjump__V_6_97;
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = mercury_current_text_output();
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_4_37  = (MR_Box) Stream;
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_4_37 ;
		{
    ...
    if (MR_FLUSH(*Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_6_38 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_6_38 , Error);
		{
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_52  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_48 = (MR_Word) mercury__backjump__V_6_52;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_49 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_49, ((MR_Box) (mercury__backjump__V_8_48)));
          return;
        }
      }
    else
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = &mercury_stderr;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_5_59  = (MR_Box) Stream;
}
    mercury__backjump__StdErr_6 = (MR_Word) mercury__backjump__V_5_59;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_59 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_60 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_8_60 , Error);
		{
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_74  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_70 = (MR_Word) mercury__backjump__V_6_74;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_71 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_71, ((MR_Box) (mercury__backjump__V_8_70)));
          return;
        }
      }
    else
    ...
    mercury__backjump__V_7_78 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__backjump__V_8_79 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      mercury__string__format__format_signed_int_component_5_p_0(mercury__backjump__V_26_26, mercury__backjump__V_7_78, mercury__backjump__V_8_79, mercury__backjump__Id_4, &mercury__backjump__V_20_20);
    }
    {
      mercury__io__write_string_4_p_0(mercury__backjump__StdErr_6, mercury__backjump__V_20_20);
    }
    {
      mercury__io__write_string_4_p_0(mercury__backjump__StdErr_6, (MR_String) ")\n");
    }
    mercury__backjump__V_4_82 = (MR_Box) mercury__backjump__StdErr_6;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_4_82 ;
		{
    ...
    if (MR_FLUSH(*Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_6_83 );
}
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, mercury__backjump__V_6_83 , Error);
		{
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    ML_make_err_msg(Error, Msg0, MR_ALLOC_ID, Msg);
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_6_97  = Msg;
}
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        mercury__backjump__V_8_93 = (MR_Word) mercury__backjump__V_6_97;
        mercury__backjump__succeeded = MR_TRUE;
      }
    if (mercury__backjump__succeeded)
      {
        MR_Word mercury__backjump__TypeCtorInfo_10_94 = (MR_Word) &mercury__io__io__type_ctor_info_error_0;

        {
          mercury__exception__throw_1_p_0(mercury__backjump__TypeCtorInfo_10_94, ((MR_Box) (mercury__backjump__V_8_93)));
          return;
        }
      }
    else
