...
MR_decl_label1(backjump__report_invalid_backjump_3_0, 4)
...
MR_BEGIN_MODULE(backjump_module3)
	...
	MR_init_label1(backjump__report_invalid_backjump_3_0,4)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_sv(1) = MR_tempr1;
	MR_r1 = (MR_Word) MR_string_const("Uncaught Mercury backjump (%d)\n", 31);
	}
