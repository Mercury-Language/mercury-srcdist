...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(V_6_36, (MR_String) "error writing to output file: ");
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
...
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, V_8_64 );
}
    mercury__io__throw_on_error_4_p_0(V_8_64, (MR_String) "error writing to output file: ");
    V_5_73 = (MR_Box) (StdErrStream_7);
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(V_8_74, (MR_String) "error writing to output file: ");
    V_4_82 = (MR_Box) (StdErrStream_7);
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(V_6_83, (MR_String) "error writing to output file: ");
  }
}
