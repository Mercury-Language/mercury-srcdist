...
{
  {
    ...
    MR_Box mercury__backjump__V_5_50;
    MR_Box mercury__backjump__V_8_51;
    MR_Word mercury__backjump__V_7_60;
    MR_Word mercury__backjump__V_8_61;
    MR_Box mercury__backjump__V_5_65;
    MR_Box mercury__backjump__V_8_66;
    MR_Box mercury__backjump__V_5_75;
    MR_Box mercury__backjump__V_8_76;
    MR_Box mercury__backjump__V_4_84;
    MR_Box mercury__backjump__V_6_85;
...
#undef MR_PROC_LABEL
    ...
    {
      mercury__io__throw_on_error_4_p_0(mercury__backjump__V_6_38, (MR_String) "error writing to output file: ");
    }
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
    ...
    Stream = &mercury_stderr;
		...
		;}
#undef MR_PROC_LABEL
	 mercury__backjump__V_5_50  = (MR_Box) Stream;
}
    mercury__backjump__StdErr_6 = (MR_Word) mercury__backjump__V_5_50;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_50 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_51 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__backjump__V_8_51, (MR_String) "error writing to output file: ");
    }
    mercury__backjump__V_26_26 = (MR_Word) &mercury__backjump_scalar_common_4[0];
    mercury__backjump__V_7_60 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__backjump__V_8_61 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    {
      mercury__string__format__format_signed_int_component_5_p_0(mercury__backjump__V_26_26, mercury__backjump__V_7_60, mercury__backjump__V_8_61, mercury__backjump__Id_4, &mercury__backjump__V_20_20);
    }
    mercury__backjump__V_5_65 = (MR_Box) mercury__backjump__StdErr_6;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_65 ;
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_66 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__backjump__V_8_66, (MR_String) "error writing to output file: ");
    }
    mercury__backjump__V_5_75 = (MR_Box) mercury__backjump__StdErr_6;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_5_75 ;
	Message =  (MR_String) ")\n" ;
		{
    ...
    if (ML_fprintf(Stream, "%s", s) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_8_76 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__backjump__V_8_76, (MR_String) "error writing to output file: ");
    }
    mercury__backjump__V_4_84 = (MR_Box) mercury__backjump__StdErr_6;
{
#define MR_PROC_LABEL mercury__backjump__report_invalid_backjump_3_p_0
	...
	Stream = (MercuryFilePtr) mercury__backjump__V_4_84 ;
		{
    ...
    if (MR_FLUSH(*Stream) < 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, mercury__backjump__V_6_85 );
}
    {
      mercury__io__throw_on_error_4_p_0(mercury__backjump__V_6_85, (MR_String) "error writing to output file: ");
    }
  }
}
