...
MR_decl_label7(fn__version_bitmap__new_2_0, 41,5,4,6,8,40,9)
MR_decl_label1(fn__version_bitmap__num_bits_1_0, 2)
MR_decl_label10(fn__version_bitmap__resize_3_0, 87,5,4,6,7,8,10,14,15,16)
MR_decl_label6(fn__version_bitmap__resize_3_0, 18,23,25,29,86,31)
...
MR_decl_label8(fn__version_bitmap__zip__ho10_4_0, 45,4,8,10,14,46,16,2)
...
MR_decl_label8(fn__version_bitmap__zip__ho9_4_0, 45,4,8,10,14,46,16,2)
...
MR_decl_static(fn__version_bitmap__zip__ho9_4_0)
MR_decl_static(fn__version_bitmap__zip__ho10_4_0)
...
MR_BEGIN_MODULE(version_bitmap_module2)
	...
	MR_init_label7(fn__version_bitmap__new_2_0,41,5,4,6,8,40,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__version_bitmap__new_2_0);
	...
	if (MR_INT_GE(MR_r1,0)) {
		MR_GOTO_LAB(fn__version_bitmap__new_2_0_i41);
	}
...
MR_def_label(fn__version_bitmap__new_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(fn__version_array__new_2_0,
		fn__version_bitmap__new_2_0_i8);
...
#line 175 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 541 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__new_2_0_i9);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r1);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
MR_def_label(fn__version_bitmap__new_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(fn__version_bitmap__clear_filler_bits_1_0);
MR_def_label(fn__version_bitmap__new_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_string_const("version_array.\'elem :=\': index out of range", 43);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__new_2_0_i40);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
#undef	MR_PROC_LABEL
	...
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(fn__version_bitmap__zip__ho10_4_0);
	}
...
#undef	MR_PROC_LABEL
	...
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(fn__version_bitmap__zip__ho9_4_0);
	}
...
MR_decl_entry(fn__version_array__resize_3_0);
...
MR_BEGIN_MODULE(version_bitmap_module20)
	...
	MR_init_label10(fn__version_bitmap__resize_3_0,87,5,4,6,7,8,10,14,15,16)
	MR_init_label6(fn__version_bitmap__resize_3_0,18,23,25,29,86,31)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__version_bitmap__resize_3_0);
	...
	if (MR_INT_GT(MR_r2,0)) {
		MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i87);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_np_tailcall_ent(fn__version_bitmap__new_2_0);
MR_def_label(fn__version_bitmap__resize_3_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
#line 237 "int.opt"
    ...
    Div = Int / ML_BITS_PER_INT;
;}
#line 2518 "version_bitmap.c"
	MR_r5 = Div;
#undef	MR_PROC_LABEL
	}
	MR_r3 = ((MR_Integer) 1 + ((MR_Integer) 1 + (MR_Integer) MR_r5));
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
...
MR_def_label(fn__version_bitmap__resize_3_0,7)
	...
	MR_sv(3) = MR_r4;
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(fn__version_array__resize_3_0,
...
#line 2554 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i10);
	MR_r2 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
...
MR_def_label(fn__version_bitmap__resize_3_0,10)
	...
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__resize_3_0_i14);
...
#undef	MR_PROC_LABEL
	...
	MR_tempr1 = ((MR_Integer) 1 << (MR_Integer) MR_r3);
	MR_r4 = MR_tempr1;
	MR_sv(4) = (~(((MR_Integer) MR_tempr1 | ((MR_Integer) MR_tempr1 - (MR_Integer) 1))) & (MR_Integer) MR_sv(3));
...
#undef	MR_PROC_LABEL
	...
	MR_sv(2) = MR_r3;
	MR_r1 = MR_r2;
	MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i23);
	}
MR_def_label(fn__version_bitmap__resize_3_0,18)
	...
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__resize_3_0_i23);
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2681 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i25);
	MR_r2 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_sv(1) = MR_r1;
	MR_r1 = (((MR_Integer) MR_r2 & (MR_Integer) MR_sv(3)) | (MR_Integer) MR_sv(4));
	MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i29);
MR_def_label(fn__version_bitmap__resize_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__resize_3_0_i29);
...
#line 175 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2719 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i31);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r1);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
MR_def_label(fn__version_bitmap__resize_3_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(fn__version_bitmap__clear_filler_bits_1_0);
MR_def_label(fn__version_bitmap__resize_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__resize_3_0_i86);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(version_bitmap_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__version_bitmap__get_2_0);
...
MR_BEGIN_MODULE(version_bitmap_module29)
	MR_init_entry1(fn__version_bitmap__zip__ho9_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__version_bitmap__zip__ho9_4_0);
	MR_init_label8(fn__version_bitmap__zip__ho9_4_0,45,4,8,10,14,46,16,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'zip__ho9'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__version_bitmap__zip__ho9_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(fn__version_bitmap__zip__ho9_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LE(MR_r1,0)) {
		MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i2);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_Integer	I;
	MR_Word	X;
#define	MR_PROC_LABEL	mercury__fn__version_bitmap__zip__ho9_4_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
	MR_MAYBE_UNBOX_FOREIGN_TYPE(struct ML_va *, MR_r3, VA);
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3291 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i4);
	MR_r5 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_r1 = MR_r4;
	MR_r3 = MR_r5;
	MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i8);
	}
MR_def_label(fn__version_bitmap__zip__ho9_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho9_4_0_i8);
MR_def_label(fn__version_bitmap__zip__ho9_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	struct ML_va *	VA;
	MR_Integer	I;
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3331 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i10);
	MR_r4 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_r3 = ((MR_Integer) MR_r3 & (MR_Integer) MR_r4);
	MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i14);
MR_def_label(fn__version_bitmap__zip__ho9_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho9_4_0_i14);
MR_def_label(fn__version_bitmap__zip__ho9_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	struct ML_va *	VA0;
	MR_Integer	I;
...
#line 175 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 3369 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i16);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r3);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
MR_def_label(fn__version_bitmap__zip__ho9_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(fn__version_bitmap__zip__ho9_4_0_i45);
MR_def_label(fn__version_bitmap__zip__ho9_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.\'elem :=\': index out of range", 43);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho9_4_0_i46);
MR_def_label(fn__version_bitmap__zip__ho9_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(version_bitmap_module30)
	MR_init_entry1(fn__version_bitmap__zip__ho10_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__version_bitmap__zip__ho10_4_0);
	MR_init_label8(fn__version_bitmap__zip__ho10_4_0,45,4,8,10,14,46,16,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'zip__ho10'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__version_bitmap__zip__ho10_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(fn__version_bitmap__zip__ho10_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LE(MR_r1,0)) {
		MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i2);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_Integer	I;
	MR_Word	X;
#define	MR_PROC_LABEL	mercury__fn__version_bitmap__zip__ho10_4_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
	MR_MAYBE_UNBOX_FOREIGN_TYPE(struct ML_va *, MR_r3, VA);
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3441 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i4);
	MR_r5 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_r1 = MR_r4;
	MR_r3 = MR_r5;
	MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i8);
	}
MR_def_label(fn__version_bitmap__zip__ho10_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho10_4_0_i8);
MR_def_label(fn__version_bitmap__zip__ho10_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	struct ML_va *	VA;
	MR_Integer	I;
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3481 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i10);
	MR_r4 = X;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_r3 = ((MR_Integer) MR_r3 | (MR_Integer) MR_r4);
	MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i14);
MR_def_label(fn__version_bitmap__zip__ho10_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.elem: index out of range", 38);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho10_4_0_i14);
MR_def_label(fn__version_bitmap__zip__ho10_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	struct ML_va *	VA0;
	MR_Integer	I;
...
#line 175 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 3519 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i16);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r3);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
MR_def_label(fn__version_bitmap__zip__ho10_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(fn__version_bitmap__zip__ho10_4_0_i45);
MR_def_label(fn__version_bitmap__zip__ho10_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_sv(2) = MR_r2;
	MR_r2 = (MR_Word) MR_string_const("version_array.\'elem :=\': index out of range", 43);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__zip__ho10_4_0_i46);
MR_def_label(fn__version_bitmap__zip__ho10_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
