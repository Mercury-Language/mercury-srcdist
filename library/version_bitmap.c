...
MR_decl_label8(fn__version_bitmap__resize_3_0, 86,5,4,6,7,8,10,14)
MR_decl_label8(fn__version_bitmap__resize_3_0, 15,16,18,23,25,29,85,30)
...
MR_BEGIN_MODULE(version_bitmap_module20)
	...
	MR_init_label8(fn__version_bitmap__resize_3_0,86,5,4,6,7,8,10,14)
	MR_init_label8(fn__version_bitmap__resize_3_0,15,16,18,23,25,29,85,30)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__version_bitmap__resize_3_0);
	...
	if (MR_INT_GT(MR_r2,0)) {
		MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i86);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2647 "version_bitmap.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_bitmap__resize_3_0_i30);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r1);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
...
MR_def_label(fn__version_bitmap__resize_3_0,85)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(fn__version_bitmap__clear_filler_bits_1_0);
MR_def_label(fn__version_bitmap__resize_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = (MR_Word) MR_string_const("version_array.\'elem :=\': index out of range", 43);
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_bitmap__resize_3_0_i85);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
