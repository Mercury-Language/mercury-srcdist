...
MR_decl_label1(__Unify___array2d__array2d_1_0, 1)
MR_decl_label7(__Compare___array2d__array2d_1_0, 4,5,7,12,13,15,20)
...
MR_BEGIN_MODULE(array2d_module13)
	...
	MR_init_label1(__Unify___array2d__array2d_1_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(array2d_module14)
	...
	MR_init_label7(__Compare___array2d__array2d_1_0,4,5,7,12,13,15,20)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___array2d__array2d_1_0);
	...
	if (((MR_Integer) MR_r3 >= (MR_Integer) MR_r4)) {
		MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i4);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i7);
	}
MR_def_label(__Compare___array2d__array2d_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r4)) {
		MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i5);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i7);
MR_def_label(__Compare___array2d__array2d_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___array2d__array2d_1_0,7)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i20);
	}
	MR_r1 = MR_sv(5);
	if (((MR_Integer) MR_sv(1) >= (MR_Integer) MR_sv(3))) {
		MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i12);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i15);
MR_def_label(__Compare___array2d__array2d_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(1) != MR_sv(3))) {
		MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i13);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___array2d__array2d_1_0_i15);
MR_def_label(__Compare___array2d__array2d_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 2;
...
MR_def_label(__Compare___array2d__array2d_1_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
