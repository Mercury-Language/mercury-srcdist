...
struct mercury__array2d__from_lists_2_f_0_env_0_s {
  ...
  MR_Word mercury__array2d__from_lists_2_f_0_env_0__TypeInfo__19_19;
...
{
  MR_Word Array_10;
  MR_Integer NumRows_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Array0_6, (MR_Integer) 0))));
  MR_Integer NumColumns_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Array0_6, (MR_Integer) 1))));
  MR_ArrayPtr A0_14 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), Array0_6, (MR_Integer) 2))));
  MR_ArrayPtr A_15;
  MR_Integer Var_16;
...
#undef MR_PROC_LABEL
...
}
  {
    ...
    MR_hl_field(MR_mktag(0), Array_10, 0) = ((MR_Box) (NumRows_12));
    MR_hl_field(MR_mktag(0), Array_10, 1) = ((MR_Box) (NumColumns_13));
    MR_hl_field(MR_mktag(0), Array_10, 2) = ((MR_Box) (A_15));
  }
  return Array_10;
}
  ...
  MR_Word * STATE_VARIABLE_Array_11)
{
  ...
  MR_Integer NumRows_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Array_0_10, (MR_Integer) 0))));
  MR_Integer NumColumns_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Array_0_10, (MR_Integer) 1))));
  MR_ArrayPtr _A_18 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Array_0_10, (MR_Integer) 2))));
  MR_Integer Var_20;
...
#undef MR_PROC_LABEL
...
}
    {
      ...
      *STATE_VARIABLE_Array_11 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (NumRows_16));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (NumColumns_17));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (A_24));
    }
  }
  else
    {
...
mercury__array2d__unsafe_lookup_4_p_0(
  ...
  MR_Box * Elem_8)
{
  MR_Integer NumColumns_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Array_5, (MR_Integer) 1))));
  MR_ArrayPtr A_12 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), Array_5, (MR_Integer) 2))));
  MR_Integer Var_13;
  ...
  MR_Integer C_7)
{
  MR_bool succeeded = ((MR_Integer) 0 <= R_6);
  MR_Box Elem_8;
  MR_Integer NumColumns_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Array_5, (MR_Integer) 1))));
  MR_ArrayPtr _A_14 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), Array_5, (MR_Integer) 2))));
  MR_Integer NumRows_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Array_5, (MR_Integer) 0))));
  MR_Integer Var_16;
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->mercury__array2d__from_lists_2_f_0_env_0__commit_0) == 0)
    {
      mercury__list__member_2_p_1((env_ptr)->mercury__array2d__from_lists_2_f_0_env_0__TypeInfo__19_19, &(env_ptr)->mercury__array2d__from_lists_2_f_0_env_0__conv0_Row_12, (MR_Word) ((env_ptr)->mercury__array2d__from_lists_2_f_0_env_0__HeadVar__1_1), mercury__array2d__from_lists_1_f_0_3, env_ptr);
...
#undef MR_PROC_LABEL
    ...
    else
    {
...

      {
        ...
        (env).mercury__array2d__from_lists_2_f_0_env_0__TypeInfo__19_19 = base;
      ...
      mercury__list__length_acc_3_p_0((env).mercury__array2d__from_lists_2_f_0_env_0__TypeInfo__19_19, (MR_Word) ((env).mercury__array2d__from_lists_2_f_0_env_0__HeadVar__1_1), (MR_Integer) 0, &NumRows_10);
      ...
      if ((env).mercury__array2d__from_lists_2_f_0_env_0__succeeded)
      {
        ...
        mercury__list__reverse_2_p_0((env).mercury__array2d__from_lists_2_f_0_env_0__TypeInfo__19_19, (MR_Word) ((env).mercury__array2d__from_lists_2_f_0_env_0__HeadVar__1_1), &conv1_Var_24);
  ...
  MR_Box Elem_7)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo__16_16, 0) = ((MR_Box) (&mercury__array2d__array2d__type_ctor_info_array2d_1));
      MR_hl_field(MR_mktag(0), TypeInfo__16_16, 1) = ((MR_Box) (TypeInfo_for_T_14));
    }
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0(TypeInfo__16_16, (MR_String) "function \140array2d.init\'/3", (MR_String) "bounds must be non-negative");
