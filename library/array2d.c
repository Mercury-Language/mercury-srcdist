...
MR_decl_label8(fn__array2d__array2d_1_0, 37,6,7,8,9,16,18,14)
MR_decl_label1(fn__array2d__array2d_1_0, 11)
...
MR_decl_label4(fn__array2d__lists_2_6_0, 21,4,3,2)
...
MR_BEGIN_MODULE(array2d_module0)
	...
	MR_init_label8(fn__array2d__array2d_1_0,37,6,7,8,9,16,18,14)
	MR_init_label1(fn__array2d__array2d_1_0,11)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(array2d_module11)
	...
	MR_init_label4(fn__array2d__lists_2_6_0,21,4,3,2)
MR_BEGIN_CODE
...
MR_def_label(fn__array2d__lists_2_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) 0 > (MR_Integer) MR_r2)) {
...
MR_def_label(fn__array2d__lists_2_6_0,4)
	...
	MR_GOTO_LAB(fn__array2d__lists_2_6_0_i21);
	}
