      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_11;
          ...
          mercury__array____Compare____array_1_0(TypeInfo_for_T_14, HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    MR_Integer Var_6;
    MR_Integer Var_7 = (M_3 * N_4);
    MR_Integer Var_9;
    MR_Word Var_11;
    MR_Word Var_12;

    Var_6 = (Var_7 - (MR_Integer) 1);
    Var_9 = (N_4 - (MR_Integer) 1);
    Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    HeadVar__2_2 = mercury__array2d__lists_2_6_f_0(TypeInfo_for_T_13, Var_6, Var_9, N_4, A_5, Var_11, Var_12);
    return HeadVar__2_2;
  }
}
  ...
  MR_Word Xss_13)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_16 = (IJ_8 - (MR_Integer) 1);
        MR_Integer Var_18 = (J_9 - (MR_Integer) 1);
        MR_Word Var_20;
        MR_Box Var_21;
        ...
        {
          MR_Integer next_value_of_IJ_8 = Var_16;
          MR_Integer next_value_of_J_9 = Var_18;
          MR_Word next_value_of_Xs_12 = Var_20;
      ...
      {
        MR_Integer Var_22 = (N_10 - (MR_Integer) 1);
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_J_9 = Var_22;
          MR_Word next_value_of_Xs_12 = Var_24;
          MR_Word next_value_of_Xss_13 = Var_25;
      ...
      {
        HeadVar__7_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
    ...
    {
      HeadVar__5_5 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Word TypeCtorInfo_12_12 = (MR_Word) &mercury__array2d__array2d__type_ctor_info_array2d_1;
...
{
  {
    ...
    MR_Integer Var_10;
    MR_Integer Var_11 = (I_8 * N_6);
    MR_Integer _M_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Integer Var_10;
    MR_ArrayPtr _A_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));
...
{
  {
    ...
    *N_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    _A_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));
  }
}
...
{
  {
...

    {
      ...
      (env_ptr)->mercury__array2d__array2d_2_f_0_env_0__succeeded = !((env_ptr)->mercury__array2d__array2d_2_f_0_env_0__succeeded);
...
{
  {
    ...
    (env).mercury__array2d__array2d_2_f_0_env_0__HeadVar__1_1 = HeadVar__1_1;
    {
      ...
      if (((env).mercury__array2d__array2d_2_f_0_env_0__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_ArrayPtr Var_5;
	...
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, Var_5 );
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TypeCtorInfo_17_17));
        ...
        V_6_38 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        mercury__list__condense_acc_3_p_0((env).mercury__array2d__array2d_2_f_0_env_0__TypeInfo_for_T_16, V_5_37, V_6_38, &Var_14);
        ...
        {
          MR_Word TypeCtorInfo_19_19 = (MR_Word) &mercury__array2d__array2d__type_ctor_info_array2d_1;
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_14_14 = (MR_Word) &mercury__array2d__array2d__type_ctor_info_array2d_1;
