...
#define MR_PROC_LABEL mercury__array2d__fill_3_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A0_9 , Array);
		{
...
#undef MR_PROC_LABEL
    ...
    mercury__array__do_fill_range_5_p_0(TypeInfo_for_T_11, Item_4, V_6_15, V_7_16, A0_9, &A_10);
    {
      MR_Word base;
...
#define MR_PROC_LABEL mercury__array2d__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_99_111_108_117_109_110_115_95_95_91_49_93_95_48_6_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A_10 , Array);
	Index = Var_16 ;
		{
...
#define MR_PROC_LABEL mercury__array2d__f_117_110_115_97_102_101_95_101_108_101_109_32_58_61_4_f_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A0_20 , Array0);
		{
    ...
    Array = Array0;
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, A_21 );
}
    {
...
#define MR_PROC_LABEL mercury__array2d__unsafe_set_5_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A0_12 , Array0);
		{
    ...
    Array = Array0;
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, A_13 );
}
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
#define MR_PROC_LABEL mercury__array2d__set_5_p_0
	...
	Index = Var_33 ;
	Item = (MR_Word) Value_8 ;
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, _A_20 , Array0);
		{
    ...
    Array = Array0;
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, A_32 );
}
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
#define MR_PROC_LABEL mercury__array2d__unsafe_elem_3_f_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A_15 , Array);
	Index = Var_16 ;
		{
...
#define MR_PROC_LABEL mercury__array2d__unsafe_lookup_4_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A_16 , Array);
	Index = Var_17 ;
		{
...
#define MR_PROC_LABEL mercury__array2d__unsafe_lookup_3_f_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, A_11 , Array);
	Index = Var_12 ;
		{
...
#define MR_PROC_LABEL mercury__array2d__lookup_3_f_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, _A_16 , Array);
	Index = Var_26 ;
		{
	...
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_ArrayPtr, Array, Var_5 );
      ...
      else
      {
        ...
        if ((env).mercury__array2d__from_lists_2_f_0_env_0__succeeded)
        {
          ...
          MR_Word Var_14;
          MR_Word V_5_41;
          MR_Word conv1_V_5_41;

          mercury__list__reverse_2_p_0((env).mercury__array2d__from_lists_2_f_0_env_0__TypeInfo_19_19, (MR_Word) ((env).mercury__array2d__from_lists_2_f_0_env_0__HeadVar__1_1), &conv1_V_5_41);
          V_5_41 = (MR_Word) (conv1_V_5_41);
          mercury__list__condense_acc_3_p_0((env).mercury__array2d__from_lists_2_f_0_env_0__TypeInfo_for_T_17, V_5_41, (MR_Word) ((MR_Unsigned) 0U), &Var_14);
