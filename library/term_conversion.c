  ...
  MR_Word * Term_4)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_6_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
    MR_Word Type_6;
    MR_Integer Var_7;
...
#undef MR_PROC_LABEL
	 ...
	 V_6_45  = TypeCtorArity;
      ...
      {
        MR_Word TypeInfo_6_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Univ_3, (MR_Integer) 0))));
