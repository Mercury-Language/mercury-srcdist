...
{
  {
    ...
    if ((TypeArgs_9 == (MR_Word) ((MR_Integer) 0)))
    {
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Arg1_12, 1) = ((MR_Box) ((MR_Integer) 0));
...
#undef MR_PROC_LABEL
    ...
    mercury__term_conversion__try_term_to_univ_2_4_p_0(TypeInfo_for_U_11, Term_3, Var_10, (MR_Word) ((MR_Integer) 0), &UnivResult_6);
...
{
  {
    ...
    else
    {
      ...
      succeeded = (Var_302 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) Var_311)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
