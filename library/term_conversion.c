...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    ...
    AddrTermArgs_52 = (MR_Word *) (&(MR_hl_field(MR_mktag(0), *Term_4, (MR_Integer) 1)));
    mercury__term_conversion__LCMC__pred__univ_list_to_term_list__1_2_p_0(TypeInfo_27_27, FunctorArgs_10, AddrTermArgs_52);
  }
  else
  {
