...
static /* final */ const MR_Box mercury__term_conversion_scalar_common_6[5][1];
            ...
            case (MR_Integer) 2:
              {
                ...
                ;
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_68 = (MR_Word) (&mercury__term_conversion_scalar_common_6[2]);
                    {
            ...
            case (MR_Integer) 3:
              {
                ...
                ;
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_58 = (MR_Word) (&mercury__term_conversion_scalar_common_6[1]);
                    Var_62 = (MR_Word) (&mercury__term_conversion_scalar_common_6[0]);
                    {
      ...
      if (succeeded)
      {
        if ((strcmp(ModuleName_7, (MR_String) "array") == 0))
        {
          ...
          if (succeeded)
          {
            ...
            Var_50 = (MR_Word) (&mercury__term_conversion_scalar_common_6[3]);
            {
        ...
        if ((strcmp(ModuleName_7, (MR_String) "version_array") == 0))
        {
          ...
          if (succeeded)
          {
            ...
            Var_43 = (MR_Word) (&mercury__term_conversion_scalar_common_6[4]);
            {
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      }
      {
        ...
        base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        *Term_6 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (&mercury__term_conversion_scalar_common_6[0]));
