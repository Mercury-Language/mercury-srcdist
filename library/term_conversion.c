...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__list__ulength_acc_3_p_0(TypeInfo_35_35, (MR_Word) (ArgTerms_12), Var_42, &Var_41);
{
#define MR_PROC_LABEL mercury__term_conversion__try_term_to_univ_2_4_p_0
...
succeeded  = SUCCESS_INDICATOR;
        ...
        if (succeeded)
        {
          succeeded = mercury__construct__find_functor_2_6_p_0(Type_6, FunctorName_19, Arity_20, Var_43, &FunctorNumber_21, &ArgTypes_22);
          if (succeeded)
          {
            Var_29 = (MR_Integer) 1;
