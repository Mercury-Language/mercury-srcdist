...
MR_decl_label6(bimap__delete_keys_3_0, 21,3,6,8,9,4)
MR_decl_label4(bimap__delete_value_3_0, 4,6,7,2)
MR_decl_label6(bimap__delete_values_3_0, 21,3,6,8,9,4)
MR_decl_label1(bimap__det_from_corresponding_lists_3_0, 2)
MR_decl_label2(bimap__det_insert_4_0, 2,3)
MR_decl_label4(bimap__det_insert_from_assoc_list_3_0, 11,3,4,5)
...
MR_decl_label3(bimap__map_keys_2_4_0, 10,3,4)
MR_decl_label3(bimap__map_keys_func_2_4_0, 10,3,4)
MR_decl_label2(bimap__map_values_3_0, 2,3)
MR_decl_label3(bimap__map_values_2_4_0, 10,3,4)
MR_decl_label3(bimap__map_values_func_2_4_0, 10,3,4)
...
MR_BEGIN_MODULE(bimap_module27)
	...
	MR_init_label4(bimap__det_insert_from_assoc_list_3_0,11,3,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bimap__det_insert_from_assoc_list_3_0);
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(bimap__det_insert_from_assoc_list_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
...
MR_def_label(bimap__det_insert_from_assoc_list_3_0,5)
	...
	MR_r3 = MR_sv(3);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(bimap__det_insert_from_assoc_list_3_0_i11);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(bimap_module39)
	...
	MR_init_label6(bimap__delete_keys_3_0,21,3,6,8,9,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(bimap_module41)
	...
	MR_init_label6(bimap__delete_values_3_0,21,3,6,8,9,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(bimap_module60)
	...
	MR_init_label3(bimap__map_keys_func_2_4_0,10,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bimap__map_keys_func_2_4_0);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(bimap__map_keys_func_2_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(bimap__map_keys_func_2_4_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(bimap__map_keys_func_2_4_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(bimap_module62)
	...
	MR_init_label3(bimap__map_keys_2_4_0,10,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bimap__map_keys_2_4_0);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(bimap__map_keys_2_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
...
MR_def_label(bimap__map_keys_2_4_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(bimap__map_keys_2_4_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(bimap_module64)
	...
	MR_init_label3(bimap__map_values_func_2_4_0,10,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bimap__map_values_func_2_4_0);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(bimap__map_values_func_2_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
...
MR_def_label(bimap__map_values_func_2_4_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(bimap__map_values_func_2_4_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(bimap_module66)
	...
	MR_init_label3(bimap__map_values_2_4_0,10,3,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bimap__map_values_2_4_0);
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(bimap__map_values_2_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
...
MR_def_label(bimap__map_values_2_4_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(bimap__map_values_2_4_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
