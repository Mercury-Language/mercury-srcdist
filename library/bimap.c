...
MR_decl_label3(bimap__search_insert_5_0, 2,5,4)
...
MR_def_extern_entry(bimap__search_insert_5_0)
...
MR_decl_static(bimap__IntroducedFrom__pred__foldl__190__1_8_0)
...
MR_BEGIN_MODULE(bimap_module24)
	MR_init_entry1(bimap__search_insert_5_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__bimap__search_insert_5_0);
	MR_init_label3(bimap__search_insert_5_0,2,5,4)
MR_BEGIN_CODE
...
/* code for 'search_insert'/5 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__bimap__search_insert_5_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	...
	MR_np_call_localret_ent(tree234__search_insert_5_0,
		bimap__search_insert_5_0_i2);
MR_def_label(bimap__search_insert_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(bimap__search_insert_5_0_i4);
	}
	{
	...
	MR_np_call_localret_ent(map__det_insert_4_0,
		bimap__search_insert_5_0_i5);
MR_def_label(bimap__search_insert_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_sv(3);
	MR_tfield(0, MR_r2, 1) = MR_r1;
...
MR_def_label(bimap__search_insert_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(bimap_module96)
	MR_init_entry1(bimap__IntroducedFrom__pred__foldl__190__1_8_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__bimap__IntroducedFrom__pred__foldl__190__1_8_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__foldl__190__1'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(bimap__IntroducedFrom__pred__foldl__190__1_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_r4 = MR_r7;
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(bimap__IntroducedFrom__pred__foldl__190__1_8_0));
...
MR_BEGIN_MODULE(bimap_module98)
...
MR_def_label(f_98_105_109_97_112_95_95_116_114_101_101_50_51_52_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_108_100_108_95_95_104_111_55_95_95_91_53_44_32_54_44_32_55_44_32_56_93_95_48_4_0,7)
	...
	MR_np_call_localret_ent(bimap__IntroducedFrom__pred__foldl__190__1_8_0,
...
void mercury__bimap__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__bimap);
