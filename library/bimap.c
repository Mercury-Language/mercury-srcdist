...
{
  {
    ...
    if (mercury__bimap__succeeded)
      *mercury__bimap__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mercury__bimap__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__bimap__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mercury__bimap__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mercury__bimap__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mercury__bimap__Var_8;

        {
          mercury__tree234____Compare____tree234_2_0(mercury__bimap__TypeInfo_for_K_11, mercury__bimap__TypeInfo_for_V_12, &mercury__bimap__Var_8, mercury__bimap__Var_4, mercury__bimap__Var_6);
        }
        ...
        if (mercury__bimap__succeeded)
          *mercury__bimap__HeadVar__1_1 = mercury__bimap__Var_8;
          ...
          {
            mercury__tree234____Compare____tree234_2_0(mercury__bimap__TypeInfo_for_V_12, mercury__bimap__TypeInfo_for_K_11, mercury__bimap__HeadVar__1_1, mercury__bimap__Var_5, mercury__bimap__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mercury__bimap__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__bimap__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__bimap__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__bimap__HeadVar__2_2, (MR_Integer) 1)));

        {
          mercury__bimap__succeeded = mercury__tree234____Unify____tree234_2_0(mercury__bimap__TypeInfo_for_K_9, mercury__bimap__TypeInfo_for_V_10, mercury__bimap__Var_3, mercury__bimap__Var_5);
        }
        if (mercury__bimap__succeeded)
          {
            mercury__bimap__succeeded = mercury__tree234____Unify____tree234_2_0(mercury__bimap__TypeInfo_for_V_10, mercury__bimap__TypeInfo_for_K_9, mercury__bimap__Var_4, mercury__bimap__Var_6);
          }
      }
    return mercury__bimap__succeeded;
  }
