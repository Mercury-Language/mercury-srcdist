  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_15, TypeInfo_for_V_14, Forward0_20, K_22, &Forward_23, &Var_35);
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_14, TypeInfo_for_K_15, Reverse0_21, Value_7, &Reverse_24, &Var_42);
        {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_14, TypeInfo_for_V_15, Forward0_20, Key_7, &Forward_23, &Var_35);
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_15, TypeInfo_for_K_14, Reverse0_21, V_22, &Reverse_24, &Var_42);
        {
          STATE_VARIABLE_BM_12_12 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_12_12, 0) = ((MR_Box) (Forward_23));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_12_12, 1) = ((MR_Box) (Reverse_24));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_15, TypeInfo_for_V_14, Forward0_6, K_8, &Forward_9, &Var_25);
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_14, TypeInfo_for_K_15, Reverse0_7, V_4, &Reverse_10, &Var_32);
      {
        MR_Word base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_9, TypeInfo_for_V_10, Forward0_15, K_17, &Forward_18, &Var_30);
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_10, TypeInfo_for_K_9, Reverse0_16, V_5, &Reverse_19, &Var_37);
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_14, TypeInfo_for_V_15, Forward0_6, K_4, &Forward_9, &Var_25);
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_15, TypeInfo_for_K_14, Reverse0_7, V_8, &Reverse_10, &Var_32);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_BM_12 = base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_9, TypeInfo_for_V_10, Forward0_15, K_5, &Forward_18, &Var_30);
      mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_10, TypeInfo_for_K_9, Reverse0_16, V_17, &Reverse_19, &Var_37);
      {
        STATE_VARIABLE_BM_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_7, 0) = ((MR_Box) (Forward_18));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_7, 1) = ((MR_Box) (Reverse_19));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Values_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
        MR_Word STATE_VARIABLE_BM_29_29;
        MR_Word Forward0_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_0_3, (MR_Integer) 0))));
        MR_Word Reverse0_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_0_3, (MR_Integer) 1))));
        MR_Word Forward_42;
        MR_Word Reverse_43;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_HeadVar__2_2;
        ...
        mercury__map__det_insert_4_p_0(TypeInfo_for_K_31, TypeInfo_for_V_32, Var_34, Value_24, Forward0_40, &Forward_42);
        mercury__map__det_insert_4_p_0(TypeInfo_for_V_32, TypeInfo_for_K_31, Value_24, Var_34, Reverse0_41, &Reverse_43);
        {
          STATE_VARIABLE_BM_29_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_29_29, 0) = ((MR_Box) (Forward_42));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_BM_29_29, 1) = ((MR_Box) (Reverse_43));
        }
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__1_1 = Var_33;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_V_22, TypeInfo_for_K_21, STATE_VARIABLE_Reverse_0_12, KVal_9, &STATE_VARIABLE_Reverse_16_16, &Var_32);
      }
    }
    else
    {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__tree234__delete_2_4_p_0(TypeInfo_for_K_21, TypeInfo_for_V_22, STATE_VARIABLE_Forward_15_15, VKey_10, &STATE_VARIABLE_Forward_13, &Var_42);
      }
    }
    else
    {
