...
MR_decl_label2(f_114_97_116_105_111_110_97_108_95_95_61_60_2_0, 2,3)
...
MR_decl_label8(fn__f_114_97_116_105_111_110_97_108_95_95_42_2_0, 2,3,4,5,6,7,8,9)
MR_decl_label4(fn__f_114_97_116_105_111_110_97_108_95_95_42_2_0, 10,11,12,13)
MR_decl_label8(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0, 3,2,6,5,8,9,10,11)
MR_decl_label8(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0, 12,13,15,16,17,18,19,20)
...
MR_decl_label6(fn__rational__cmp_2_0, 2,3,5,4,8,7)
MR_decl_label4(fn__rational__gcd_2_2_0, 12,3,2,5)
MR_decl_label1(fn__rational__rational_1_0, 2)
MR_decl_label2(fn__rational__rational_2_0, 2,3)
MR_decl_label8(fn__rational__rational_norm_2_0, 3,2,7,6,9,10,11,13)
MR_decl_label8(fn__rational__rational_norm_2_0, 12,16,18,15,21,22,23,24)
MR_decl_label8(fn__rational__reciprocal_1_0, 3,2,7,6,10,12,9,15)
MR_decl_label1(fn__rational__reciprocal_1_0, 16)
MR_decl_label2(__Unify___rational__rational_0_0, 2,1)
MR_decl_label2(__Compare___rational__rational_0_0, 3,7)
...
MR_BEGIN_MODULE(rational_module1)
	...
	MR_init_label4(fn__rational__gcd_2_2_0,12,3,2,5)
MR_BEGIN_CODE
...
MR_def_static(fn__rational__gcd_2_2_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(fn__rational__gcd_2_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__gcd_2_2_0_i3);
MR_def_label(fn__rational__gcd_2_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(fn__rational__gcd_2_2_0,2)
	...
	MR_np_call_localret_ent(integer__big_quot_rem_4_0,
		fn__rational__gcd_2_2_0_i5);
MR_def_label(fn__rational__gcd_2_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(fn__rational__gcd_2_2_0_i12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(rational_module2)
	...
	MR_init_label8(fn__rational__rational_norm_2_0,3,2,7,6,9,10,11,13)
	MR_init_label8(fn__rational__rational_norm_2_0,12,16,18,15,21,22,23,24)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__rational__rational_norm_2_0);
	...
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__rational_norm_2_0_i3);
MR_def_label(fn__rational__rational_norm_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(fn__rational__rational_norm_2_0,2)
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__rational_norm_2_0_i7);
MR_def_label(fn__rational__rational_norm_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__rational__rational_norm_2_0_i6);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_decr_sp_and_return(5);
MR_def_label(fn__rational__rational_norm_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
...
MR_def_label(fn__rational__rational_norm_2_0,9)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__integer__big_abs_1_0,
		fn__rational__rational_norm_2_0_i10);
MR_def_label(fn__rational__rational_norm_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__rational__gcd_2_2_0,
		fn__rational__rational_norm_2_0_i11);
MR_def_label(fn__rational__rational_norm_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__rational_norm_2_0_i13);
MR_def_label(fn__rational__rational_norm_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__rational__rational_norm_2_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__integer__big_mul_2_0,
		fn__rational__rational_norm_2_0_i21);
MR_def_label(fn__rational__rational_norm_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_def_label(fn__rational__rational_norm_2_0,16)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__rational__rational_norm_2_0_i15);
	}
	MR_sv(4) = (MR_Integer) -1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,1);
	MR_np_call_localret_ent(integer__neg_list_2_0,
		fn__rational__rational_norm_2_0_i18);
MR_def_label(fn__rational__rational_norm_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(fn__rational__rational_norm_2_0,21)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__integer__big_abs_1_0,
		fn__rational__rational_norm_2_0_i22);
MR_def_label(fn__rational__rational_norm_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__rational__rational_norm_2_0,23)
	...
	MR_np_call_localret_ent(integer__big_quot_rem_4_0,
		fn__rational__rational_norm_2_0_i24);
MR_def_label(fn__rational__rational_norm_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(rational_module3)
	...
	MR_init_label8(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,3,2,6,5,8,9,10,11)
	MR_init_label8(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,12,13,15,16,17,18,19,20)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0);
	...
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i3);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r2 = MR_sv(2);
	MR_r1 = MR_sv(5);
	MR_GOTO_LAB(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i15);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,2)
	...
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i6);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i5);
	}
	MR_r2 = MR_sv(2);
	MR_r1 = MR_sv(5);
	MR_GOTO_LAB(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i15);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__integer__big_abs_1_0,
...
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,8)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__integer__big_abs_1_0,
		fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i9);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__rational__gcd_2_2_0,
...
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,15)
	...
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(integer__big_quot_rem_4_0,
		fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i16);
MR_def_label(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(integer__big_quot_rem_4_0,
		fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0_i17);
...
MR_define_entry(mercury__fn__f_114_97_116_105_111_110_97_108_95_95_45_2_0);
	...
	MR_sv(3) = ((MR_Integer) 0 - (MR_Integer) MR_ctfield(0, MR_tempr1, 0));
	MR_r1 = MR_ctfield(0, MR_tempr1, 1);
	}
	MR_np_call_localret_ent(integer__neg_list_2_0,
...
MR_BEGIN_MODULE(rational_module5)
	...
	MR_init_label6(fn__rational__cmp_2_0,2,3,5,4,8,7)
MR_BEGIN_CODE
...
MR_def_label(fn__rational__cmp_2_0,2)
	...
	MR_np_call_localret_ent(fn__f_114_97_116_105_111_110_97_108_95_95_43_2_0,
		fn__rational__cmp_2_0_i3);
MR_def_label(fn__rational__cmp_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
...
MR_def_label(fn__rational__cmp_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__rational__cmp_2_0_i4);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
MR_def_label(fn__rational__cmp_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__rational__cmp_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__rational__cmp_2_0_i7);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(fn__rational__cmp_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(rational_module8)
	...
	MR_init_label2(f_114_97_116_105_111_110_97_108_95_95_61_60_2_0,2,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(rational_module15)
	...
	MR_init_label8(fn__f_114_97_116_105_111_110_97_108_95_95_42_2_0,2,3,4,5,6,7,8,9)
	MR_init_label4(fn__f_114_97_116_105_111_110_97_108_95_95_42_2_0,10,11,12,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(rational_module16)
	...
	MR_init_label8(fn__rational__reciprocal_1_0,3,2,7,6,10,12,9,15)
	MR_init_label1(fn__rational__reciprocal_1_0,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__rational__reciprocal_1_0);
	...
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__reciprocal_1_0_i3);
MR_def_label(fn__rational__reciprocal_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(fn__rational__reciprocal_1_0,2)
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		fn__rational__reciprocal_1_0_i7);
MR_def_label(fn__rational__reciprocal_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__rational__reciprocal_1_0_i6);
	}
	MR_r2 = MR_sv(2);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__integer__big_mul_2_0,
		fn__rational__reciprocal_1_0_i15);
MR_def_label(fn__rational__reciprocal_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(__Compare___integer__integer_0_0,
		fn__rational__reciprocal_1_0_i10);
MR_def_label(fn__rational__reciprocal_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__rational__reciprocal_1_0_i9);
	}
	MR_sv(3) = (MR_Integer) -1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,1);
	MR_np_call_localret_ent(integer__neg_list_2_0,
		fn__rational__reciprocal_1_0_i12);
MR_def_label(fn__rational__reciprocal_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(fn__rational__reciprocal_1_0,9)
	...
	MR_np_call_localret_ent(fn__integer__big_mul_2_0,
		fn__rational__reciprocal_1_0_i15);
MR_def_label(fn__rational__reciprocal_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(rational_module23)
	...
	MR_init_label2(__Unify___rational__rational_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___rational__rational_0_0);
	...
	MR_np_call_localret_ent(__Unify___integer__integer_0_0,
		__Unify___rational__rational_0_0_i2);
MR_def_label(__Unify___rational__rational_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(rational_module24)
	...
	MR_init_label2(__Compare___rational__rational_0_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___rational__rational_0_0);
	...
	MR_r2 = MR_ctfield(0, MR_r2, 0);
	MR_np_call_localret_ent(__Compare___integer__integer_0_0,
		__Compare___rational__rational_0_0_i3);
MR_def_label(__Compare___rational__rational_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___rational__rational_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___rational__rational_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__rational__write_out_proc_statics(FILE *fp);
#endif
