  ...
  MR_Word HeadVar__1_1)
{
  ...
  succeeded = mercury__integer__is_zero_1_p_0(Num_3);
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__integer____Compare____integer_0_0(&Var_17, Num_3, (MR_Word) (&mercury__rational_scalar_common_4[2]));
      succeeded = (Var_17 == (MR_Integer) 1);
      if (succeeded)
      {
        MR_Integer Var_23 = ((MR_Integer) ((MR_hl_field(0, (MR_Word) (&mercury__rational_scalar_common_4[1]), 0))));
        MR_Word Var_24 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&mercury__rational_scalar_common_4[1]), 1))));
        MR_Integer Var_25 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_23);
        MR_Word Var_26;

        mercury__integer__neg_list_2_p_0(Var_24, &Var_26);
        {
          Var_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_8, 0) = ((MR_Box) (Var_25));
          MR_hl_field(0, Var_8, 1) = ((MR_Box) (Var_26));
        }
      }
      else
  ...
  MR_Word R2_5)
{
  ...
  Num_16 = ((MR_Word) ((MR_hl_field(0, Diff_7, 0))));
  succeeded = mercury__integer__is_zero_1_p_0(Num_16);
  if (succeeded)
    Cmp_6 = (MR_Integer) 0;
  else
  {
    MR_Word Num_18 = ((MR_Word) ((MR_hl_field(0, Diff_7, 0))));
    MR_Word Var_23;

    mercury__integer____Compare____integer_0_0(&Var_23, Num_18, (MR_Word) (&mercury__rational_scalar_common_4[2]));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  succeeded = mercury__integer__is_zero_1_p_0(Ad_5);
  if (succeeded)
    M_9 = (MR_Word) (&mercury__rational_scalar_common_4[2]);
  else
  {
    succeeded = mercury__integer__is_zero_1_p_0(Bd_7);
    if (succeeded)
      M_9 = (MR_Word) (&mercury__rational_scalar_common_4[2]);
    else
    {
      ...
      Var_21 = mercury__integer__big_abs_1_f_0(Ad_5);
      Var_22 = mercury__integer__big_abs_1_f_0(Bd_7);
      Var_16 = mercury__rational__gcd_2_2_f_0(Var_21, Var_22);
      mercury__integer__big_quot_rem_4_p_0(Ad_5, Var_16, &Var_15, &Var_23);
      Var_14 = mercury__integer__big_mul_2_f_0(Var_15, Bd_7);
      M_9 = mercury__integer__big_abs_1_f_0(Var_14);
    }
  }
  mercury__integer__big_quot_rem_4_p_0(M_9, Ad_5, &CA_10, &Var_24);
  mercury__integer__big_quot_rem_4_p_0(M_9, Bd_7, &CB_11, &Var_25);
  ...
  MR_Word Den_5)
{
  ...
  succeeded = mercury__integer__is_zero_1_p_0(Den_5);
  if (succeeded)
    mercury__require__error_1_p_0((MR_String) "rational.rational_norm: division by zero");
  else
  {
    succeeded = mercury__integer__is_zero_1_p_0(Num_4);
    if (succeeded)
    ...
    else
    {
      ...
      Var_22 = mercury__integer__big_abs_1_f_0(Num_4);
      Var_23 = mercury__integer__big_abs_1_f_0(Den_5);
      G_7 = mercury__rational__gcd_2_2_f_0(Var_22, Var_23);
      succeeded = mercury__integer__is_zero_1_p_0(Den_5);
      if (succeeded)
      ...
      else
      {
        ...
        mercury__integer____Compare____integer_0_0(&Var_30, Den_5, (MR_Word) (&mercury__rational_scalar_common_4[2]));
        succeeded = (Var_30 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Integer Var_36 = ((MR_Integer) ((MR_hl_field(0, (MR_Word) (&mercury__rational_scalar_common_4[1]), 0))));
          MR_Word Var_37 = ((MR_Word) ((MR_hl_field(0, (MR_Word) (&mercury__rational_scalar_common_4[1]), 1))));
          MR_Integer Var_38 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_36);
          MR_Word Var_39;

          mercury__integer__neg_list_2_p_0(Var_37, &Var_39);
          {
            Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_13, 0) = ((MR_Box) (Var_38));
            MR_hl_field(0, Var_13, 1) = ((MR_Box) (Var_39));
          }
        }
        else
      ...
      mercury__integer__big_quot_rem_4_p_0(Num2_8, G_7, &Var_14, &Var_44);
      mercury__integer__big_quot_rem_4_p_0(Den2_9, G_7, &Var_15, &Var_45);
      {
  ...
  MR_Word B_5)
{
  while (MR_TRUE)
  {
    ...
    ;
    succeeded = mercury__integer__is_zero_1_p_0(B_5);
    if (succeeded)
      HeadVar__3_3 = A_4;
    else
    {
      ...
      mercury__integer__big_quot_rem_4_p_0(A_4, B_5, &Var_7, &Var_6);
