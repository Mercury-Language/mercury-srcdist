...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer____Compare____integer_0_0(&Var_28, Num_3, (MR_Word) (&mercury__rational_scalar_common_4[2]));
        succeeded = (Var_28 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Integer Var_40 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 0))));
          MR_Word Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 1))));
          MR_Integer Var_42 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_40);
          MR_Word Var_43;

          mercury__integer__neg_list_2_p_0(Var_41, &Var_43);
          {
            Var_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (Var_42));
            MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (Var_43));
          }
        }
        else
...
{
  {
    ...
    mercury__integer__big_quot_rem_4_p_0(An_4, G1_10, &Var_12, &Var_38);
    mercury__integer__big_quot_rem_4_p_0(Bn_6, G2_11, &Var_13, &Var_45);
    Numer_8 = mercury__integer__big_mul_2_f_0(Var_12, Var_13);
    mercury__integer__big_quot_rem_4_p_0(Ad_5, G2_11, &Var_14, &Var_55);
    mercury__integer__big_quot_rem_4_p_0(Bd_7, G1_10, &Var_15, &Var_62);
...
{
  {
    ...
    MR_Word Var_9;
    MR_Integer Var_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_7, (MR_Integer) 0))));
    MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_7, (MR_Integer) 1))));
    ...
    mercury__integer__neg_list_2_p_0(Var_13, &Var_15);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_9, 0) = ((MR_Box) (Var_14));
      MR_hl_field(MR_mktag(0), Var_9, 1) = ((MR_Box) (Var_15));
    }
    {
...
{
  {
    ...
    MR_Word Den_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1))));
    MR_Word Var_5;
    MR_Integer Var_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_3, (MR_Integer) 0))));
    MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_3, (MR_Integer) 1))));
    MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_8);
    MR_Word Var_11;

    mercury__integer__neg_list_2_p_0(Var_9, &Var_11);
    {
      Var_5 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_5, 0) = ((MR_Box) (Var_10));
      MR_hl_field(MR_mktag(0), Var_5, 1) = ((MR_Box) (Var_11));
    }
    {
      HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), HeadVar__2_2, 0) = ((MR_Box) (Var_5));
...
{
  {
    ...
    MR_Word Var_13;
    MR_Integer Var_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_11, (MR_Integer) 0))));
    MR_Word Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_11, (MR_Integer) 1))));
    MR_Integer Var_18 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_16);
    MR_Word Var_19;
    MR_Word Var_21;

    mercury__integer__neg_list_2_p_0(Var_17, &Var_19);
    {
      Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_18));
      MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (Var_19));
    }
    {
    ...
    succeeded = mercury__integer____Unify____integer_0_0(Var_21, (MR_Word) (&mercury__rational_scalar_common_4[2]));
    if (succeeded)
      Cmp_6 = (MR_Integer) 0;
    else
    {
      ...
      mercury__integer____Compare____integer_0_0(&Var_33, Num_26, (MR_Word) (&mercury__rational_scalar_common_4[2]));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer__big_quot_rem_4_p_0(Ad_5, Var_18, &Var_17, &Var_45);
        Var_16 = mercury__integer__big_mul_2_f_0(Var_17, Bd_7);
        M_9 = mercury__integer__big_abs_1_f_0(Var_16);
      }
    }
    mercury__integer__big_quot_rem_4_p_0(M_9, Ad_5, &CA_10, &Var_57);
    mercury__integer__big_quot_rem_4_p_0(M_9, Bd_7, &CB_11, &Var_64);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__integer____Compare____integer_0_0(&Var_52, Den_5, (MR_Word) (&mercury__rational_scalar_common_4[2]));
          succeeded = (Var_52 == (MR_Integer) 1);
          if (succeeded)
          {
            MR_Integer Var_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 0))));
            MR_Word Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 1))));
            MR_Integer Var_66 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Var_64);
            MR_Word Var_67;

            mercury__integer__neg_list_2_p_0(Var_65, &Var_67);
            {
              Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_66));
              MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (Var_67));
            }
          }
          else
        ...
        mercury__integer__big_quot_rem_4_p_0(Num2_8, G_7, &Var_14, &Var_84);
        mercury__integer__big_quot_rem_4_p_0(Den2_9, G_7, &Var_15, &Var_91);
        {
  ...
  MR_Word B_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__integer__big_quot_rem_4_p_0(A_4, B_5, &Var_17, &Var_6);
