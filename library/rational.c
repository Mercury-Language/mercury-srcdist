  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Integer Var_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 0))));
        MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 1))));
        ...
        mercury__integer__neg_list_2_p_0(Var_32, &Var_34);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (Var_33));
          MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (Var_34));
        }
      }
      else
  ...
  MR_Word R2_5)
{
  ...
  MR_Word Var_9;
  MR_Integer Var_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_7, (MR_Integer) 0))));
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_7, (MR_Integer) 1))));
  ...
  mercury__integer__neg_list_2_p_0(Var_11, &Var_13);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_9, 1) = ((MR_Box) (Var_13));
  }
  {
  ...
  MR_Word HeadVar__1_1)
{
  ...
  MR_Word Den_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1))));
  MR_Word Var_5;
  MR_Integer Var_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_3, (MR_Integer) 0))));
  MR_Word Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_3, (MR_Integer) 1))));
  ...
  mercury__integer__neg_list_2_p_0(Var_7, &Var_9);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_5, 0) = ((MR_Box) (Var_8));
    MR_hl_field(MR_mktag(0), Var_5, 1) = ((MR_Box) (Var_9));
  }
  {
    HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), HeadVar__2_2, 0) = ((MR_Box) (Var_5));
  ...
  MR_Word R2_5)
{
  ...
  MR_Word Diff_7;
  MR_Word Var_8;
  MR_Word Num_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), R2_5, (MR_Integer) 0))));
  MR_Word Den_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), R2_5, (MR_Integer) 1))));
  MR_Word Var_11;
  MR_Integer Var_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Num_9, (MR_Integer) 0))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Num_9, (MR_Integer) 1))));
  ...
  mercury__integer__neg_list_2_p_0(Var_13, &Var_15);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (Var_15));
  }
  {
    Var_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (Var_11));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (Den_10));
  }
  Diff_7 = mercury__rational__f_plus_2_f_0(R1_4, Var_8);
  Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Diff_7, (MR_Integer) 0))));
  succeeded = mercury__integer____Unify____integer_0_0(Var_17, (MR_Word) (&mercury__rational_scalar_common_4[2]));
  if (succeeded)
    Cmp_6 = (MR_Integer) 0;
  else
  {
    MR_Word Num_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Diff_7, (MR_Integer) 0))));
    MR_Word Var_27;
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer Var_48 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 0))));
          MR_Word Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (MR_Word) (&mercury__rational_scalar_common_4[1]), (MR_Integer) 1))));
          ...
          mercury__integer__neg_list_2_p_0(Var_49, &Var_51);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_50));
            MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (Var_51));
          }
        }
        else
