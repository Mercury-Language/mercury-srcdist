...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer____Compare____integer_0_0(&Var_28, Num_3, (MR_Word) (&mercury__rational_scalar_common_4[0]));
        succeeded = (Var_28 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Integer Var_42 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) 1);
          MR_Word Var_43;

          mercury__integer__neg_list_2_p_0((MR_Word) (MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1])), &Var_43);
          {
...
{
  {
    ...
    else
    {
      ...
      mercury__integer____Compare____integer_0_0(&Var_33, Num_26, (MR_Word) (&mercury__rational_scalar_common_4[0]));
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__integer____Compare____integer_0_0(&Var_52, Den_5, (MR_Word) (&mercury__rational_scalar_common_4[0]));
          succeeded = (Var_52 == (MR_Integer) 1);
          if (succeeded)
          {
            MR_Integer Var_66 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) 1);
            MR_Word Var_67;

            mercury__integer__neg_list_2_p_0((MR_Word) (MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1])), &Var_67);
            {
              Var_13 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
