...
{
  {
    ...
    if (mercury__rational__succeeded)
      *mercury__rational__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mercury__rational__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__rational__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mercury__rational__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mercury__rational__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mercury__rational__Var_8;

        {
          mercury__integer____Compare____integer_0_0(&mercury__rational__Var_8, mercury__rational__Var_4, mercury__rational__Var_6);
        }
        ...
        if (mercury__rational__succeeded)
          *mercury__rational__HeadVar__1_1 = mercury__rational__Var_8;
          ...
          {
            mercury__integer____Compare____integer_0_0(mercury__rational__HeadVar__1_1, mercury__rational__Var_5, mercury__rational__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mercury__rational__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__rational__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__rational__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__rational__HeadVar__2_2, (MR_Integer) 1)));

        {
          mercury__rational__succeeded = mercury__integer____Unify____integer_0_0(mercury__rational__Var_3, mercury__rational__Var_5);
        }
        if (mercury__rational__succeeded)
          {
            mercury__rational__succeeded = mercury__integer____Unify____integer_0_0(mercury__rational__Var_4, mercury__rational__Var_6);
          }
      }
    return mercury__rational__succeeded;
  }
