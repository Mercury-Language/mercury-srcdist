...
{
  {
    ...
    if (succeeded)
    {
      ...
      conv0_HeadVar__2_2 = mercury__require__func_error_1_f_0((MR_Word) (&mercury__rational__rational__type_ctor_info_rational_0), (MR_String) "rational.reciprocal: division by zero");
    ...
    else
    {
      ...
      succeeded = mercury__integer____Unify____integer_0_0(Num_3, (MR_Word) (&mercury__rational_scalar_common_4[0]));
      if (succeeded)
        Var_7 = (MR_Word) (&mercury__rational_scalar_common_4[0]);
      else
      {
        MR_Word V_3_24 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
        MR_Word V_5_27;

        mercury__integer____Compare____integer_0_0(&V_5_27, Num_3, (MR_Word) (&mercury__rational_scalar_common_4[0]));
        ...
        if (succeeded)
        {
          ...
          mercury__integer__neg_list_2_p_0((MR_Word) (MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1])), &V_5_42);
          {
