...
{
  {
    ...
    else
    {
      ...
      mercury__integer____Compare____integer_0_0(&Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      else
        mercury__integer____Compare____integer_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    MR_Word Num_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_Word Den_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    MR_Word Var_10 = (MR_Word) &mercury__rational_scalar_common_4[0];
    MR_Word V_3_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    succeeded = mercury__integer____Unify____integer_0_0(Num_3, Var_10);
    if (succeeded)
    {
      MR_Word TypeCtorInfo_9_9 = (MR_Word) &mercury__rational__rational__type_ctor_info_rational_0;
      MR_Box conv0_HeadVar__2_2;

      conv0_HeadVar__2_2 = mercury__require__func_error_1_f_0(TypeCtorInfo_9_9, (MR_String) "rational.reciprocal: division by zero");
    ...
    else
    {
      ...
      MR_Word Var_7;
      MR_Word Var_8;
      MR_Word Var_17 = (MR_Word) &mercury__rational_scalar_common_4[0];
      MR_Word V_3_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      succeeded = mercury__integer____Unify____integer_0_0(Num_3, Var_17);
      if (succeeded)
        Var_7 = Var_17;
      else
      {
        MR_Word Var_15 = (MR_Word) &mercury__rational_scalar_common_4[0];
        MR_Word V_3_24 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        MR_Word V_5_27;

        mercury__integer____Compare____integer_0_0(&V_5_27, Num_3, Var_15);
        succeeded = (V_5_27 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Word V_5_36 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          MR_Word V_4_40 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
          MR_Integer V_6_41 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) (MR_Integer) 1);
          MR_Word V_5_42;

          mercury__integer__neg_list_2_p_0(V_4_40, &V_5_42);
          {
            Var_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_7, 0) = ((MR_Box) (V_6_41));
            MR_hl_field(MR_mktag(0), Var_7, 1) = ((MR_Box) (V_5_42));
          }
        }
        else
        {
          MR_Word V_3_45 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
          MR_Word V_5_47 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

          Var_7 = (MR_Word) &mercury__rational_scalar_common_4[2];
        }
      }
      Var_6 = mercury__integer__big_mul_2_f_0(Var_7, Den_4);
      Var_8 = mercury__integer__big_abs_1_f_0(Num_3);
      {
        HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Integer V_6_14 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) V_3_12);
    MR_Word V_5_15;
...
{
  {
    ...
    MR_Integer V_6_10 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) V_3_8);
    MR_Word V_5_11;
  ...
  MR_Word Integer_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word Var_4 = (MR_Word) &mercury__rational_scalar_common_4[2];
    MR_Word V_3_7 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
    MR_Word V_5_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    HeadVar__2_2 = mercury__rational__rational_norm_2_f_0(Integer_3, Var_4);
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    V_3_10 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
    Var_5 = (MR_Word) &mercury__rational_scalar_common_4[2];
    HeadVar__2_2 = mercury__rational__rational_norm_2_f_0(Var_4, Var_5);
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    MR_Integer V_6_18 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) V_3_16);
    MR_Word V_5_19;
    MR_Word Var_21;
    MR_Word Var_22;
    MR_Word V_3_25;
    ...
    Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), Diff_7, (MR_Integer) 1)));
    V_3_25 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    Var_22 = (MR_Word) &mercury__rational_scalar_common_4[0];
    succeeded = mercury__integer____Unify____integer_0_0(Var_21, Var_22);
    if (succeeded)
      Cmp_6 = (MR_Integer) 0;
    else
    {
      MR_Word Num_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), Diff_7, (MR_Integer) 0)));
      MR_Word Var_28 = (MR_Word) &mercury__rational_scalar_common_4[0];
      MR_Word V_3_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      MR_Word V_5_33;
      MR_Word Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), Diff_7, (MR_Integer) 1)));

      mercury__integer____Compare____integer_0_0(&V_5_33, Num_26, Var_28);
...
{
  {
    ...
    MR_Word Var_12;
    MR_Word Var_13;
    MR_Word Var_19 = (MR_Word) &mercury__rational_scalar_common_4[0];
    MR_Word V_3_24 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Word V_7_57;
    MR_Word V_7_64;

    succeeded = mercury__integer____Unify____integer_0_0(Ad_5, Var_19);
    if (succeeded)
      M_9 = Var_19;
    else
    {
      MR_Word Var_20 = (MR_Word) &mercury__rational_scalar_common_4[0];
      MR_Word V_3_28 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      succeeded = mercury__integer____Unify____integer_0_0(Bd_7, Var_20);
      if (succeeded)
        M_9 = Var_20;
      else
      {
...
{
  {
    MR_bool succeeded;
    MR_Word Rat_6;
    MR_Word Var_16 = (MR_Word) &mercury__rational_scalar_common_4[0];
    MR_Word V_3_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    succeeded = mercury__integer____Unify____integer_0_0(Den_5, Var_16);
    if (succeeded)
    {
    ...
    {
      MR_Word Var_17 = (MR_Word) &mercury__rational_scalar_common_4[0];
      MR_Word V_3_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

      succeeded = mercury__integer____Unify____integer_0_0(Num_4, Var_17);
      if (succeeded)
      {
        MR_Word Var_12 = (MR_Word) &mercury__rational_scalar_common_4[2];
        MR_Word V_3_28 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
        MR_Word V_5_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      else
      {
        ...
        V_3_45 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        Var_42 = (MR_Word) &mercury__rational_scalar_common_4[0];
        succeeded = mercury__integer____Unify____integer_0_0(Den_5, Var_42);
        if (succeeded)
          Var_13 = Var_42;
        else
        {
          MR_Word Var_40 = (MR_Word) &mercury__rational_scalar_common_4[0];
          MR_Word V_3_49 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          MR_Word V_5_52;

          mercury__integer____Compare____integer_0_0(&V_5_52, Den_5, Var_40);
          succeeded = (V_5_52 == (MR_Integer) 1);
          if (succeeded)
          {
            MR_Word V_5_61 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            MR_Word V_4_65 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
            MR_Integer V_6_66 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) (MR_Integer) 1);
            MR_Word V_5_67;

            mercury__integer__neg_list_2_p_0(V_4_65, &V_5_67);
            {
              Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          {
            MR_Word V_3_70 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
            MR_Word V_5_72 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        ...
        {
          Rat_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word B_5)
{
  while (MR_TRUE)
  {
    MR_bool succeeded;
    MR_Word HeadVar__3_3;
    MR_Word Var_7 = (MR_Word) &mercury__rational_scalar_common_4[0];
    MR_Word V_3_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    // setup for model_det tailcalls optimized into a loop
    succeeded = mercury__integer____Unify____integer_0_0(B_5, Var_7);
    if (succeeded)
      HeadVar__3_3 = A_4;
    else
    {
...
{
  {
    MR_Word HeadVar__1_1 = (MR_Word) &mercury__rational_scalar_common_4[4];
    MR_Word Var_2 = (MR_Word) &mercury__rational_scalar_common_4[2];
    MR_Word V_5_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Word V_3_11 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
...
{
  {
    MR_Word HeadVar__1_1 = (MR_Word) &mercury__rational_scalar_common_4[3];
    MR_Word Var_2 = (MR_Word) &mercury__rational_scalar_common_4[0];
    MR_Word Var_3 = (MR_Word) &mercury__rational_scalar_common_4[2];
    MR_Word V_3_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Word V_3_8 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__rational_scalar_common_4[1]);
