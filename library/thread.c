...
{
  MR_Word Success_20;
  MR_String ThreadId_21;
  MR_String ErrorMsg_22;

  mercury__thread__spawn_native_2_7_p_0(Goal_5, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Success_20, &ThreadId_21, &ErrorMsg_22);
  switch (Success_20) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Res_6 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ErrorMsg_22));
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_24 = (MR_Word) (ThreadId_21);
  ...
  MR_Word Goal0_4)
{
  ...
  {
    MR_Word Success_31;
    MR_String ThreadId_32;

    mercury__thread__spawn_context_2_5_p_0(Goal_6, &Success_31, &ThreadId_32);
    switch (Success_31) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_34 = (MR_Word) (ThreadId_32);

          {
            Res_9 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Res_9, 0) = ((MR_Box) (Var_34));
          }
        }
        break;
    }
  ...
  {
    MR_Word Success_51;
    MR_String ThreadId_52;
    MR_String ErrorMsg_53;

    mercury__thread__spawn_native_2_7_p_0(Goal_6, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Success_51, &ThreadId_52, &ErrorMsg_53);
    switch (Success_51) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          Res_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Res_9, 0) = ((MR_Box) (ErrorMsg_53));
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word Var_55 = (MR_Word) (ThreadId_52);

          {
            Res_9 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Res_9, 0) = ((MR_Box) (Var_55));
          }
        }
        break;
    }
