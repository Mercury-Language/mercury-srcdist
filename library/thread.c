...
{
  {
    ...
    if (mercury__thread__succeeded)
      *mercury__thread__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mercury__thread__Var_4 = (MR_String) mercury__thread__HeadVar__2_2;
        MR_String mercury__thread__Var_5 = (MR_String) mercury__thread__HeadVar__3_3;
...
#define MR_PROC_LABEL mercury__thread____Compare____thread_0_0
	...
	S1 =  mercury__thread__Var_4 ;
	S2 =  mercury__thread__Var_5 ;
		{
...
{
  {
    ...
    if (mercury__thread__succeeded)
      ...
      {
        MR_String mercury__thread__Var_3 = (MR_String) mercury__thread__HeadVar__1_1;
        MR_String mercury__thread__Var_4 = (MR_String) mercury__thread__HeadVar__2_2;

        mercury__thread__succeeded = (strcmp(mercury__thread__Var_3, mercury__thread__Var_4) == 0);
      }
    return mercury__thread__succeeded;
  }
}
