  ...
  MR_Word * Res_6)
{
  ...
  switch (Success_8) {
    ...
    case (MR_Integer) 0:
      *Res_6 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__thread_scalar_common_4[0]));
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * Res_6)
{
  ...
  {
    MR_Word Success_15;
    MR_String ThreadId_16;

    mercury__thread__spawn_context_2_5_p_0(Goal_5, &Success_15, &ThreadId_16);
    switch (Success_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *Res_6 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__thread_scalar_common_4[0]));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_18 = (MR_Word) (ThreadId_16);
  ...
  MR_Word * Res_6)
{
  ...
  mercury__thread__spawn_native_2_7_p_0(Goal_5, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Success_19, &ThreadId_20, &ErrorMsg_21);
  switch (Success_19) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        ...
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Res_6 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ErrorMsg_21));
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_23 = (MR_Word) (ThreadId_20);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mercury__thread__IntroducedFrom__pred__spawn__241__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
}
  ...
  MR_Word Goal0_4)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Goal_6, 0) = ((MR_Box) (&mercury__thread_scalar_common_5[0]));
  ...
  {
    MR_Word Success_29;
    MR_String ThreadId_30;

    mercury__thread__spawn_context_2_5_p_0(Goal_6, &Success_29, &ThreadId_30);
    switch (Success_29) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Res_9 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__thread_scalar_common_4[0]));
        break;
      case (MR_Integer) 1:
        {
          MR_Word Var_32 = (MR_Word) (ThreadId_30);

          {
            Res_9 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Res_9, 0) = ((MR_Box) (Var_32));
          }
        }
        break;
    }
  ...
  {
    MR_Word Success_48;
    MR_String ThreadId_49;
    MR_String ErrorMsg_50;

    mercury__thread__spawn_native_2_7_p_0(Goal_6, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Success_48, &ThreadId_49, &ErrorMsg_50);
    switch (Success_48) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          Res_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Res_9, 0) = ((MR_Box) (ErrorMsg_50));
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word Var_52 = (MR_Word) (ThreadId_49);

          {
            Res_9 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Res_9, 0) = ((MR_Box) (Var_52));
          }
        }
        break;
    }
