...
{
  {
    ...
    {
      MR_Word Success_55;
      MR_String ThreadId_56;
      MR_String ErrorMsg_57;

      mercury__thread__spawn_native_2_7_p_0(Goal_6, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Success_55, &ThreadId_56, &ErrorMsg_57);
      switch (Success_55) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            Res_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Res_9, 0) = ((MR_Box) (ErrorMsg_57));
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word Var_59 = (MR_Word) (ThreadId_56);

            {
              Res_9 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Res_9, 0) = ((MR_Box) (Var_59));
            }
          }
          break;
      }
