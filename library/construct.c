  ...
  MR_Word Args_3)
{
  ...
  mercury__list__ulength_acc_3_p_0((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), Args_3, (MR_Unsigned) 0U, &Var_10);
{
#define MR_PROC_LABEL mercury__construct__construct_tuple_1_f_0
