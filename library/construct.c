...
{
  {
    ...
    if ((mercury__construct__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Box mercury__construct__Var_16;
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        MR_Integer mercury__construct__Var_16;
        MR_Word mercury__construct__ArgPseudoTypes_14;
        MR_String mercury__construct__Var_22;
        MR_Integer mercury__construct__Var_23;

        if (mercury__construct__succeeded)
          {
            mercury__construct__Var_16 = (MR_Integer) 1;
            mercury__construct__Num_13 = (mercury__construct__Num0_10 - mercury__construct__Var_16);
            {
              mercury__construct__succeeded = mercury__construct__get_functor_internal_5_p_0(mercury__construct__TypeInfo_7, mercury__construct__Num_13, &mercury__construct__Var_22, &mercury__construct__Var_23, &mercury__construct__ArgPseudoTypes_14);
            }
            if (mercury__construct__succeeded)
              {
                mercury__construct__succeeded = (strcmp(mercury__construct__Functor_8, mercury__construct__Var_22) == 0);
                if (mercury__construct__succeeded)
                  mercury__construct__succeeded = (mercury__construct__Arity_9 == mercury__construct__Var_23);
              }
            if (mercury__construct__succeeded)
              {
                {
            ...
            else
              {
                ...
                {
                  MR_Integer mercury__construct__next_value_of_Num0_10 = mercury__construct__Num_13;

                  mercury__construct__Num0_10 = mercury__construct__next_value_of_Num0_10;
                }
                continue;
              }
          }
...
{
  {
    ...
    MR_Word mercury__construct__Var_4;
    MR_Integer mercury__construct__Var_6;

    {
      mercury__construct__Var_4 = mercury__construct__map__ho2_2_f_in__list_0(mercury__construct__Args_3);
    }
    {
      mercury__list__length_acc_3_p_0(mercury__construct__TypeCtorInfo_7_7, mercury__construct__Args_3, (MR_Integer) 0, &mercury__construct__Var_6);
    }
    {
      mercury__construct__HeadVar__2_2 = mercury__construct__construct_tuple_2_3_f_0(mercury__construct__Args_3, mercury__construct__Var_4, mercury__construct__Var_6);
    }
    return mercury__construct__HeadVar__2_2;
  }
}
