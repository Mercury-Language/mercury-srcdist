  ...
  MR_Word Args_3)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word TypeCtorInfo_7_7 = (MR_Word) &mercury__univ__univ__type_ctor_info_univ_0;
    MR_Word Var_4;
    MR_Integer Var_6;

    Var_4 = mercury__construct__map__ho2_2_f_in__list_0(Args_3);
    mercury__list__length_acc_3_p_0(TypeCtorInfo_7_7, Args_3, (MR_Integer) 0, &Var_6);
...
{
  {
    ...
    else
    {
      ...
      V_4_14 = (MR_hl_field(MR_mktag(0), V_6_6, (MR_Integer) 1));
{
