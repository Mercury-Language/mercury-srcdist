  ...
  uint64_t * UInt64_4)
{
  ...
  if (succeeded)
  {
    Const_5 = ((MR_Word) ((MR_hl_field(0, Term_3, 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Integer_8 = ((MR_Word) ((MR_hl_field(1, Const_5, 1))));
        Var_10 = ((((MR_Unsigned) ((MR_hl_field(1, Const_5, 2))) >> 3)) & (MR_Integer) 1);
        Var_11 = ((MR_Unsigned) ((MR_hl_field(1, Const_5, 2))) & (MR_Integer) 7);
  ...
  MR_Integer * Int_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_9 = ((MR_Unsigned) ((MR_hl_field(1, Const_5, 0))) & (MR_Integer) 3);
        Integer_7 = ((MR_Word) ((MR_hl_field(1, Const_5, 1))));
        Var_10 = ((((MR_Unsigned) ((MR_hl_field(1, Const_5, 2))) >> 3)) & (MR_Integer) 1);
        Var_11 = ((MR_Unsigned) ((MR_hl_field(1, Const_5, 2))) & (MR_Integer) 7);
