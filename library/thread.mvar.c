...
MR_def_extern_entry(thread__mvar__try_put_5_0)
MR_def_extern_entry(thread__mvar__read_4_0)
...
MR_decl_entry(fn__thread__semaphore__init_1_0);
MR_decl_entry(mutvar__new_mutvar0_1_0);

MR_BEGIN_MODULE(thread__mvar_module0)
	MR_init_entry1(fn__thread__mvar__init_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__thread__mvar__init_0_0);
	MR_init_label3(fn__thread__mvar__init_0_0,2,3,4)
MR_BEGIN_CODE
...
#endif
MR_define_entry(mercury__fn__thread__mvar__init_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_np_call_localret_ent(fn__thread__semaphore__init_1_0,
		fn__thread__mvar__init_0_0_i2);
MR_def_label(fn__thread__mvar__init_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(fn__thread__semaphore__init_1_0,
		fn__thread__mvar__init_0_0_i3);
MR_def_label(fn__thread__mvar__init_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(mutvar__new_mutvar0_1_0,
		fn__thread__mvar__init_0_0_i4);
MR_def_label(fn__thread__mvar__init_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(thread__mvar_module1)
	...
	MR_init_label3(thread__mvar__init_3_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_label(thread__mvar__init_3_0,2)
	...
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(fn__thread__semaphore__init_1_0,
		thread__mvar__init_3_0_i3);
MR_def_label(thread__mvar__init_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(thread__mvar_module5)
	MR_init_entry1(thread__mvar__try_put_5_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__thread__mvar__try_put_5_0);
	MR_init_label4(thread__mvar__try_put_5_0,2,5,6,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'try_put'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__thread__mvar__try_put_5_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r2, 0);
	...
	MR_r1 = MR_tfield(0, MR_r2, 1);
	MR_np_call_localret_ent(thread__semaphore__try_wait_4_0,
		thread__mvar__try_put_5_0_i2);
MR_def_label(thread__mvar__try_put_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(thread__mvar__try_put_5_0_i3);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
	...
	MR_np_call_localret_ent(mutvar__set_mutvar_2_0,
		thread__mvar__try_put_5_0_i5);
MR_def_label(thread__mvar__try_put_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(thread__semaphore__signal_3_0,
		thread__mvar__try_put_5_0_i6);
MR_def_label(thread__mvar__try_put_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
MR_def_label(thread__mvar__try_put_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(thread__mvar_module6)
	MR_init_entry1(thread__mvar__read_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__thread__mvar__read_4_0);
	MR_init_label3(thread__mvar__read_4_0,2,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'read'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__thread__mvar__read_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(thread__semaphore__wait_3_0,
		thread__mvar__read_4_0_i2);
MR_def_label(thread__mvar__read_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(mutvar__get_mutvar_2_0,
		thread__mvar__read_4_0_i3);
MR_def_label(thread__mvar__read_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(thread__semaphore__signal_3_0,
		thread__mvar__read_4_0_i4);
MR_def_label(thread__mvar__read_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(thread__mvar_module7)
...
MR_BEGIN_MODULE(thread__mvar_module8)
...
MR_BEGIN_MODULE(thread__mvar_module9)
...
static void mercury__thread__mvar_maybe_bunch_0(void)
{
	...
	thread__mvar_module7();
	thread__mvar_module8();
	thread__mvar_module9();
}
...
void mercury__thread__mvar__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__thread__mvar);
