...
{
  {
    ...
    if (mercury__thread__mvar__succeeded)
      *mercury__thread__mvar__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mercury__thread__mvar__Var_4 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 0)));
        MR_Box mercury__thread__mvar__Var_5 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mercury__thread__mvar__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 2)));
        MR_Box mercury__thread__mvar__Var_7 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__3_3, (MR_Integer) 0)));
        MR_Box mercury__thread__mvar__Var_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mercury__thread__mvar__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mercury__thread__mvar__Var_10;

        {
          mercury__thread__semaphore____Compare____semaphore_0_0(&mercury__thread__mvar__Var_10, mercury__thread__mvar__Var_4, mercury__thread__mvar__Var_7);
        }
        ...
        if (mercury__thread__mvar__succeeded)
          *mercury__thread__mvar__HeadVar__1_1 = mercury__thread__mvar__Var_10;
        else
          {
            ...
            {
              mercury__thread__semaphore____Compare____semaphore_0_0(&mercury__thread__mvar__Var_11, mercury__thread__mvar__Var_5, mercury__thread__mvar__Var_8);
            }
            ...
            if (mercury__thread__mvar__succeeded)
              *mercury__thread__mvar__HeadVar__1_1 = mercury__thread__mvar__Var_11;
              ...
              {
                mercury__mutvar____Compare____mutvar_1_0(mercury__thread__mvar__TypeInfo_for_T_14, mercury__thread__mvar__HeadVar__1_1, mercury__thread__mvar__Var_6, mercury__thread__mvar__Var_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mercury__thread__mvar__succeeded)
      ...
      {
        MR_Box mercury__thread__mvar__Var_3 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__1_1, (MR_Integer) 0)));
        MR_Box mercury__thread__mvar__Var_4 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mercury__thread__mvar__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__1_1, (MR_Integer) 2)));
        MR_Box mercury__thread__mvar__Var_6 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 0)));
        MR_Box mercury__thread__mvar__Var_7 = ((MR_Box) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mercury__thread__mvar__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__mvar__HeadVar__2_2, (MR_Integer) 2)));

        {
          mercury__thread__mvar__succeeded = mercury__thread__semaphore____Unify____semaphore_0_0(mercury__thread__mvar__Var_3, mercury__thread__mvar__Var_6);
        }
        if (mercury__thread__mvar__succeeded)
          {
            {
              mercury__thread__mvar__succeeded = mercury__thread__semaphore____Unify____semaphore_0_0(mercury__thread__mvar__Var_4, mercury__thread__mvar__Var_7);
            }
            if (mercury__thread__mvar__succeeded)
              {
                mercury__thread__mvar__succeeded = mercury__mutvar____Unify____mutvar_1_0(mercury__thread__mvar__TypeInfo_for_T_11, mercury__thread__mvar__Var_5, mercury__thread__mvar__Var_8);
              }
          }
      }
    return mercury__thread__mvar__succeeded;
