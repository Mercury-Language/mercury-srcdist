...
MR_decl_label1(thread__mvar__init_3_0, 2)
...
MR_decl_label1(fn__thread__mvar__init_0_0, 2)
...
MR_BEGIN_MODULE(thread__mvar_module0)
	...
	MR_init_label1(fn__thread__mvar__init_0_0,2)
MR_BEGIN_CODE
...
#define	MR_PROC_LABEL	mercury__fn__thread__mvar__init_0_0
	Count = (MR_Integer) 0;
{
#line 60 "thread.semaphore.opt"
    ...
    */
    ...
    Semaphore = sem;
;}
#line 278 "thread.mvar.c"
	MR_r2 = (MR_Word) Semaphore;
#undef	MR_PROC_LABEL
	}
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(thread__mvar_module1)
	...
	MR_init_label1(thread__mvar__init_3_0,2)
MR_BEGIN_CODE
