...
#line 27 "thread.mvar.c"
#line 520 "io.int"
#include "io.mh"

#line 31 "thread.mvar.c"
#line 526 "io.int"
#include "string.mh"

#line 35 "thread.mvar.c"
#line 17 "thread.semaphore.int"
#include "thread.semaphore.mh"

#line 39 "thread.mvar.c"
#line 23 "bitmap.int2"
#include "bitmap.mh"

#line 43 "thread.mvar.c"
#line 26 "time.int2"
#include "time.mh"

#line 47 "thread.mvar.c"
#line 4 "builtin.opt"
#include "builtin.mh"

#line 51 "thread.mvar.c"
#line 26 "builtin.opt"
#include "array.mh"

#line 55 "thread.mvar.c"
#line 4 "int.opt"
#include "int.mh"

#line 59 "thread.mvar.c"
#line 4 "char.opt"
#include "char.mh"

#line 63 "thread.mvar.c"
#line 3 "construct.opt"
#include "construct.mh"

#line 67 "thread.mvar.c"
#line 6 "type_desc.opt"
#include "type_desc.mh"

#line 71 "thread.mvar.c"
#line 3 "float.opt"
#include "float.mh"

#line 75 "thread.mvar.c"
#line 14 "exception.opt"
#include "exception.mh"

#line 79 "thread.mvar.c"
#line 22 "store.opt"
#include "store.mh"

#line 83 "thread.mvar.c"
#line 3 "math.opt"
#include "math.mh"

#line 87 "thread.mvar.c"
...
MR_decl_label2(thread__mvar__init_3_0, 2,3)
MR_decl_label2(thread__mvar__put_4_0, 2,3)
MR_decl_label3(thread__mvar__take_4_0, 2,3,4)
MR_decl_label3(__Unify___thread__mvar__mvar_1_0, 2,4,1)
MR_decl_label3(__Compare___thread__mvar__mvar_1_0, 3,7,12)
...
MR_BEGIN_MODULE(thread__mvar_module0)
	...
	MR_init_label2(thread__mvar__init_3_0,2,3)
MR_BEGIN_CODE
...
#line 250 "thread.mvar.c"
	MR_MAYBE_BOX_FOREIGN_TYPE(ML_Semaphore *, Semaphore, MR_tempr1);
#undef	MR_PROC_LABEL
	}
	{
	ML_Semaphore *	Semaphore;
...
#line 28 "thread.semaphore.opt"
    ...
    */
    ...
    IO = IO0;
;}
#line 292 "thread.mvar.c"
	MR_MAYBE_BOX_FOREIGN_TYPE(ML_Semaphore *, Semaphore, MR_tempr2);
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = MR_tempr2;
...
MR_BEGIN_MODULE(thread__mvar_module3)
	...
	MR_init_label3(__Unify___thread__mvar__mvar_1_0,2,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___thread__mvar__mvar_1_0);
	...
	MR_np_call_localret_ent(__Unify___thread__semaphore__semaphore_0_0,
		__Unify___thread__mvar__mvar_1_0_i2);
MR_def_label(__Unify___thread__mvar__mvar_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(thread__mvar_module4)
	...
	MR_init_label3(__Compare___thread__mvar__mvar_1_0,3,7,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___thread__mvar__mvar_1_0);
	...
	MR_np_call_localret_ent(__Compare___thread__semaphore__semaphore_0_0,
		__Compare___thread__mvar__mvar_1_0_i3);
MR_def_label(__Compare___thread__mvar__mvar_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__mvar__mvar_1_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___thread__semaphore__semaphore_0_0,
		__Compare___thread__mvar__mvar_1_0_i7);
MR_def_label(__Compare___thread__mvar__mvar_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___thread__mvar__mvar_1_0_i12);
	}
...
MR_def_label(__Compare___thread__mvar__mvar_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__thread__mvar__write_out_proc_statics(FILE *fp);
#endif
