...
static /* final */ const MR_Box mercury__io__error_util_scalar_common_3[1][5];
...
#undef MR_PROC_LABEL
  ...
  switch (SysErrStyle_10) {
    ...
    case (MR_Integer) 2:
      {
        mercury__require__error_1_p_0((MR_String) "io.error_util.make_io_error_from_windows_error: inapplicable platform");
        return;
      }
      break;
    case (MR_Integer) 1:
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_maybe_win32_error_6_p_0(Error_7, IsWin32Error_8, Prefix_9, &IOError_12);
    {
      MR_Word base;
  ...
  MR_Word * IOError_10)
{
  switch (IsWin32Error_8) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word SysErrStyle_14;

{
#define MR_PROC_LABEL mercury__io__error_util__make_io_error_from_maybe_win32_error_6_p_0
    ...
    SysErrStyle = ML_SYSERR_ERRNO;
		...
		;}
#undef MR_PROC_LABEL
	SysErrStyle_14  = SysErrStyle;
}
        switch (SysErrStyle_14) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 2:
            {
...
#undef MR_PROC_LABEL
	Msg_15  = Msg;
}
              {
                ...
                base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *IOError_10 = base;
                MR_hl_field(2, base, 0) = ((MR_Box) (Msg_15));
                MR_hl_field(2, base, 1) = ((MR_Box) (Error_7));
              }
            }
            break;
        }
