  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer next_value_of_Lo_5 = Var_7;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Hi_12 = Var_25;
          MR_Box next_value_of_STATE_VARIABLE_A_0_16 = STATE_VARIABLE_A_22_22;
          MR_Box next_value_of_STATE_VARIABLE_B_0_18 = STATE_VARIABLE_B_23_23;
          MR_Box next_value_of_STATE_VARIABLE_C_0_20 = STATE_VARIABLE_C_24_24;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Hi_10 = Var_19;
          MR_Box next_value_of_STATE_VARIABLE_A_0_13 = STATE_VARIABLE_A_17_17;
          MR_Box next_value_of_STATE_VARIABLE_B_0_15 = STATE_VARIABLE_B_18_18;
  ...
  MR_Box * STATE_VARIABLE_A_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Hi_8 = Var_13;
        MR_Box next_value_of_STATE_VARIABLE_A_0_10 = STATE_VARIABLE_A_12_12;
  ...
  MR_Box A_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Hi_8 = Var_10;
        MR_Box next_value_of_A_9 = Var_12;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Lo_11 = Var_25;
          MR_Box next_value_of_STATE_VARIABLE_A_0_16 = STATE_VARIABLE_A_22_22;
          MR_Box next_value_of_STATE_VARIABLE_B_0_18 = STATE_VARIABLE_B_23_23;
          MR_Box next_value_of_STATE_VARIABLE_C_0_20 = STATE_VARIABLE_C_24_24;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Lo_9 = Var_19;
          MR_Box next_value_of_STATE_VARIABLE_A_0_13 = STATE_VARIABLE_A_17_17;
          MR_Box next_value_of_STATE_VARIABLE_B_0_15 = STATE_VARIABLE_B_18_18;
  ...
  MR_Box * STATE_VARIABLE_A_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Lo_7 = Var_13;
        MR_Box next_value_of_STATE_VARIABLE_A_0_10 = STATE_VARIABLE_A_12_12;
  ...
  MR_Box A_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Lo_7 = Var_10;
        MR_Box next_value_of_A_9 = Var_12;
  ...
  MR_Integer * CeilLogX_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_CurX_4 = NextX_7;
        MR_Integer next_value_of_CurLogXSoFar_5 = NextLogXSoFar_8;
  ...
  MR_Integer Exp_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Scale0_5 = Scale1_9;
        MR_Integer next_value_of_Base_6 = Var_10;
