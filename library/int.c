        ...
        if (mercury__int__succeeded)
          *mercury__int__CeilLogX_6 = mercury__int__CurLogXSoFar_5;
        else
          {
            ...
            MR_Integer mercury__int__V_9_9 = (mercury__int__CurX_4 + (MR_Integer) 1);

            mercury__int__NextX_7 = (mercury__int__V_9_9 / (MR_Integer) 2);
            mercury__int__NextLogXSoFar_8 = (mercury__int__CurLogXSoFar_5 + (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Integer mercury__int__CurX__tmp_copy_4 = mercury__int__NextX_7;
              MR_Integer mercury__int__CurLogXSoFar__tmp_copy_5 = mercury__int__NextLogXSoFar_8;

              mercury__int__CurLogXSoFar_5 = mercury__int__CurLogXSoFar__tmp_copy_5;
              mercury__int__CurX_4 = mercury__int__CurX__tmp_copy_4;
            }
            continue;
          }
      }
