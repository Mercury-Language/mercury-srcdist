...
MR_bool MR_CALL 
mercury__int__unsigned_lt_2_p_0(
  MR_Integer A_1,
  MR_Integer B_2)
{
  {
...
{
#define MR_PROC_LABEL mercury__int__unsigned_lt_2_p_0
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      *I_6 = Lo_4;
      cont(cont_env_ptr);
      {
        MR_Integer Var_7 = (MR_Integer) ((MR_Unsigned) Lo_4 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Box * STATE_VARIABLE_C_21)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_25 = (MR_Integer) ((MR_Unsigned) Hi_12 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
      next_value_of_Hi_12 = Var_25;
      next_value_of_STATE_VARIABLE_A_0_16 = STATE_VARIABLE_A_22_22;
  ...
  MR_Box * STATE_VARIABLE_B_16)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_19 = (MR_Integer) ((MR_Unsigned) Hi_10 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
      next_value_of_Hi_10 = Var_19;
      next_value_of_STATE_VARIABLE_A_0_13 = STATE_VARIABLE_A_17_17;
  ...
  MR_Box * STATE_VARIABLE_A_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) Hi_8 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
  ...
  MR_Box A_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) Hi_8 - (MR_Unsigned) (MR_Integer) 1);
      MR_Box Var_12;
  ...
  MR_Box * STATE_VARIABLE_C_21)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_25 = (MR_Integer) ((MR_Unsigned) Lo_11 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
      next_value_of_Lo_11 = Var_25;
      next_value_of_STATE_VARIABLE_A_0_16 = STATE_VARIABLE_A_22_22;
  ...
  MR_Box * STATE_VARIABLE_B_16)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_19 = (MR_Integer) ((MR_Unsigned) Lo_9 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
      next_value_of_Lo_9 = Var_19;
      next_value_of_STATE_VARIABLE_A_0_13 = STATE_VARIABLE_A_17_17;
  ...
  MR_Box * STATE_VARIABLE_A_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) Lo_7 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
  ...
  MR_Box A_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) Lo_7 + (MR_Unsigned) (MR_Integer) 1);
      MR_Box Var_12;
      MR_Box MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(MR_mktag(0), F_6, (MR_Integer) 1))));
      MR_Integer next_value_of_Lo_7;
      MR_Box next_value_of_A_9;
...
MR_Integer MR_CALL 
mercury__int__legacy_right_shift_2_f_0(
  MR_Integer X_4,
  MR_Integer Y_5)
{
  {
...
{
#define MR_PROC_LABEL mercury__int__legacy_right_shift_2_f_0
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) IntBits_7);
      ...
      {
        MR_Integer Var_11 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Y_5);
...
succeeded  = SUCCESS_INDICATOR;
    ...
    {
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int.(>>): second operand is out of range")))));
    }
    return Z_6;
  }
}
...
MR_Integer MR_CALL 
mercury__int__legacy_left_shift_2_f_0(
  MR_Integer X_4,
  MR_Integer Y_5)
{
  {
...
{
#define MR_PROC_LABEL mercury__int__legacy_left_shift_2_f_0
...
#undef MR_PROC_LABEL
    ...
    {
      MR_Integer Var_9 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) IntBits_7);
...
succeeded  = SUCCESS_INDICATOR;
    ...
    {
      {
        mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int.log2: taking logarithm of zero")))));
        return;
      }
    }
    else
  ...
  MR_Integer * CeilLogX_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer Var_9 = (MR_Integer) ((MR_Unsigned) CurX_4 + (MR_Unsigned) (MR_Integer) 1);
      MR_Integer next_value_of_CurX_4;
      MR_Integer next_value_of_CurLogXSoFar_5;

      NextX_7 = (Var_9 / (MR_Integer) 2);
      NextLogXSoFar_8 = (MR_Integer) ((MR_Unsigned) CurLogXSoFar_5 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    {
      {
        mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int.pow: zero base")))));
        return;
      }
    }
    else
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int.rem: division by zero")))));
    }
    else
      Rem_6 = (X_4 % Y_5);
    return Rem_6;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    {
      Div_6 = (MR_Integer) ((MR_Unsigned) Trunc_7 - (MR_Unsigned) (MR_Integer) 1);
    }
    return Div_6;
  }
}
...
{
  {
    MR_Integer HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) HeadVar__1_1);
...
{
  {
    ...
    if (succeeded)
      HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Num_3);
    else
      HeadVar__2_2 = Num_3;
    return HeadVar__2_2;
  }
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      if (succeeded)
      {
        *Abs_4 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Num_3);
      }
      else
        *Abs_4 = Num_3;
    }
