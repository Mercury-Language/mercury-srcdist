...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      MR_Word Var_9 = (MR_Word) ((MR_Box) ((MR_String) "int.(>>): second operand is out of range"));

      mercury__exception__throw_1_p_0(TypeCtorInfo_10_10, ((MR_Box) (Var_9)));
    }
    return Z_6;
  }
}
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_5 = (MR_Word) ((MR_Box) ((MR_String) "int.abs: abs(min_int) would overflow"));
