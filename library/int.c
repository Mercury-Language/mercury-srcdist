...
MR_decl_label4(int__fold_down2_7_4, 18,3,2,1)
MR_decl_label3(int__fold_down2_7_6, 3,2,5)
...
MR_decl_label4(int__fold_up2_7_4, 18,3,2,1)
MR_decl_label3(int__fold_up2_7_7, 3,2,5)
...
MR_def_label(fn__int__multiply_by_pow_3_0,19)
	...
	MR_sv(2) = ((MR_Integer) MR_r2 * (MR_Integer) MR_r2);
	MR_r2 = (MR_Integer) 2;
	}
...
MR_BEGIN_MODULE(int_module84)
	...
	MR_init_label4(int__fold_up2_7_4,18,3,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__int__fold_up2_7_4);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(int__fold_up2_7_4,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(int__fold_up2_7_4_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r3;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(int__fold_up2_7_4));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__int__fold_up2_7_4_i3);
MR_def_label(int__fold_up2_7_4,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(int__fold_up2_7_4_i1);
	}
	MR_r1 = MR_sv(4);
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_r7 = MR_tempr2;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(int__fold_up2_7_4_i18);
	}
MR_def_label(int__fold_up2_7_4,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r6;
	MR_r3 = MR_r7;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(6);
MR_def_label(int__fold_up2_7_4,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__int__fold_up2_7_5);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(int__fold_up2_7_4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(int_module87)
	...
	MR_init_label3(int__fold_up2_7_7,3,2,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__int__fold_up2_7_7);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred int.fold_up2/7-7", 5,
		MR_ENTRY(MR_do_fail));
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(int__fold_up2_7_7_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r3;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(int__fold_up2_7_7));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__int__fold_up2_7_7_i3);
MR_def_label(int__fold_up2_7_7,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	...
	MR_np_localcall_lab(int__fold_up2_7_7,
		int__fold_up2_7_7_i5);
MR_def_label(int__fold_up2_7_7,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r6;
	MR_r2 = MR_r7;
MR_def_label(int__fold_up2_7_7,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__int__fold_up2_7_8);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(int__fold_up2_7_7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(int_module93)
	...
	MR_init_label4(int__fold_down2_7_4,18,3,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__int__fold_down2_7_4);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(int__fold_down2_7_4,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(int__fold_down2_7_4_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r3;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(int__fold_down2_7_4));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__int__fold_down2_7_4_i3);
MR_def_label(int__fold_down2_7_4,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(int__fold_down2_7_4_i1);
	}
	MR_r1 = MR_sv(4);
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_r7 = MR_tempr2;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(int__fold_down2_7_4_i18);
	}
MR_def_label(int__fold_down2_7_4,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r6;
	MR_r3 = MR_r7;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(6);
MR_def_label(int__fold_down2_7_4,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__int__fold_down2_7_5);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(int__fold_down2_7_4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(int_module95)
	...
	MR_init_label3(int__fold_down2_7_6,3,2,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__int__fold_down2_7_6);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred int.fold_down2/7-6", 5,
		MR_ENTRY(MR_do_fail));
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(int__fold_down2_7_6_i2);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r3;
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(int__fold_down2_7_6));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__int__fold_down2_7_6_i3);
MR_def_label(int__fold_down2_7_6,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	...
	MR_np_localcall_lab(int__fold_down2_7_6,
		int__fold_down2_7_6_i5);
MR_def_label(int__fold_down2_7_6,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r6;
	MR_r2 = MR_r7;
MR_def_label(int__fold_down2_7_6,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__int__fold_down2_7_7);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(int__fold_down2_7_6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
