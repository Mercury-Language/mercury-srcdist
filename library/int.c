    ...
    if (mercury__int__succeeded)
    {
      *mercury__int__I_6 = mercury__int__Lo_4;
      mercury__int__cont(mercury__int__cont_env_ptr);
      {
        ...
        mercury__int__nondet_int_in_range_3_p_0(mercury__int__Var_7, mercury__int__Hi_5, mercury__int__I_6, mercury__int__cont, mercury__int__cont_env_ptr);
      }
    }
    else
    {
  ...
  MR_Box mercury__int__wrapper_arg_1)
{
  {
    MR_Box mercury__int__wrapper_arg_2;
    MR_Box mercury__int__closure = mercury__int__closure_arg;
