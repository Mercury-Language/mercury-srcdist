...
#line 122 "erlang_builtin.c"

#endif
#line 125 "erlang_builtin.c"
...
void mercury__erlang_builtin__init_threadscope_string_table(void);
#endif
...
void mercury__erlang_builtin__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__erlang_builtin);
