...
{
  {
    ...
    else
    {
      ...
      *Elem_4 = (MR_hl_field(MR_mktag(1), Var_11, (MR_Integer) 0));
      Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_11, (MR_Integer) 1)));
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_13, (MR_Integer) 1)));
    }
    return X_4;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      *Elem_3 = (MR_hl_field(MR_mktag(1), Var_5, (MR_Integer) 0));
      Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_5, (MR_Integer) 1)));
    }
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Stack_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = Elems_8;
        MR_Word next_value_of_STATE_VARIABLE_Stack_0_2 = STATE_VARIABLE_Stack_12_12;
...
{
  {
    MR_Word Stack_2 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
