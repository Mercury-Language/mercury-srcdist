  ...
  MR_Word * STATE_VARIABLE_Stack_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Elems_18 = (MR_Word) (STATE_VARIABLE_Stack_0_2);
      MR_Word Var_20;
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_20, 0) = Elem_7;
        MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Elems_18));
      }
      STATE_VARIABLE_Stack_12_12 = (MR_Word) (Var_20);
...
{
  MR_Word STATE_VARIABLE_Stack_7;
  MR_Word Elems_13 = (MR_Word) (STATE_VARIABLE_Stack_0_6);
  MR_Word Var_15;

  {
    Var_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_15, 0) = X_5;
    MR_hl_field(MR_mktag(1), Var_15, 1) = ((MR_Box) (Elems_13));
  }
  STATE_VARIABLE_Stack_7 = (MR_Word) (Var_15);
  return STATE_VARIABLE_Stack_7;
}
