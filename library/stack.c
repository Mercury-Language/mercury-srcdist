...
static /* final */ const MR_Box mercury__stack_scalar_common_3[1][5];
...
static const MR_Integer mercury__stack__stack__functor_number_map_stack_1[1] = { (MR_Integer) 0 };
...
MR_Word MR_CALL 
mercury__stack__to_list_1_f_0(
  MR_Word TypeInfo_for_T_4,
  MR_Word HeadVar__1_1)
{
  MR_Word Elems_3 = (MR_Word) (HeadVar__1_1);
  ...
  MR_Integer * Depth_4)
{
  ...
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_6, Elems_5, (MR_Unsigned) 0U, &Var_7);
{
#define MR_PROC_LABEL mercury__stack__depth_2_p_0
...
{
  MR_Integer Depth_4;
  MR_Word Elems_6 = (MR_Word) (Stack_3);
  MR_Unsigned Var_7;

  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_5, Elems_6, (MR_Unsigned) 0U, &Var_7);
{
#define MR_PROC_LABEL mercury__stack__depth_1_f_0
  ...
  MR_Word * STATE_VARIABLE_Stack_8)
{
  ...
  else
  {
    ...
    *Elem_4 = (MR_hl_field(1, Var_15, 0));
    Elems_6 = ((MR_Word) ((MR_hl_field(1, Var_15, 1))));
  ...
  MR_Word * STATE_VARIABLE_Stack_8)
{
  ...
  if (succeeded)
  {
    *Elem_4 = (MR_hl_field(1, Var_9, 0));
    Elems_6 = ((MR_Word) ((MR_hl_field(1, Var_9, 1))));
    *STATE_VARIABLE_Stack_8 = (MR_Word) (Elems_6);
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Word Xs_5)
{
  ...
  mercury__stack__push_list_3_p_0(TypeInfo_for_T_8, Xs_5, STATE_VARIABLE_Stack_0_6, &STATE_VARIABLE_Stack_7);
  ...
  MR_Word * STATE_VARIABLE_Stack_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Box Elem_7 = (MR_hl_field(1, HeadVar__1_1, 0));
      MR_Word Elems_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word STATE_VARIABLE_Stack_1_12;
      MR_Word Elems_14 = (MR_Word) (STATE_VARIABLE_Stack_0_2);
      MR_Word Var_15;
...

      {
        ...
        MR_hl_field(1, Var_15, 0) = Elem_7;
        MR_hl_field(1, Var_15, 1) = ((MR_Box) (Elems_14));
      }
      STATE_VARIABLE_Stack_1_12 = (MR_Word) (Var_15);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Elems_8;
      next_value_of_STATE_VARIABLE_Stack_0_2 = STATE_VARIABLE_Stack_1_12;
  ...
  MR_Word * STATE_VARIABLE_Stack_8)
{
...

  {
    ...
    MR_hl_field(1, Var_10, 0) = Elem_4;
    MR_hl_field(1, Var_10, 1) = ((MR_Box) (Elems_6));
  }
...
{
  MR_Word STATE_VARIABLE_Stack_7;
  MR_Word Elems_9 = (MR_Word) (STATE_VARIABLE_Stack_0_6);
  MR_Word Var_10;

  {
    Var_10 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_10, 0) = X_5;
    MR_hl_field(1, Var_10, 1) = ((MR_Box) (Elems_9));
  }
  STATE_VARIABLE_Stack_7 = (MR_Word) (Var_10);
  return STATE_VARIABLE_Stack_7;
}
