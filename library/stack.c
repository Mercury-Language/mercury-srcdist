...
{
  MR_Word Var_14 = (MR_Word) (STATE_VARIABLE_Stack_0_7);
  ...
  else
  {
    ...
    *Elem_4 = (MR_hl_field(MR_mktag(1), Var_14, (MR_Integer) 0));
    Elems_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_14, (MR_Integer) 1))));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_15, 0) = Elem_7;
        MR_hl_field(MR_mktag(1), Var_15, 1) = ((MR_Box) (Elems_14));
      }
  ...
  MR_Box X_5)
{
  ...
  {
    Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_10, 0) = X_5;
    MR_hl_field(MR_mktag(1), Var_10, 1) = ((MR_Box) (Elems_9));
  }
