...
MR_decl_label1(stack__pop_det_3_0, 3)
MR_decl_label2(stack__push_list_3_0, 5,2)
MR_decl_label1(stack__top_2_0, 1)
MR_decl_label1(stack__top_det_2_0, 3)
MR_decl_label1(fn__stack__det_top_1_0, 3)
MR_decl_label1(fn__stack__top_det_1_0, 3)
...
MR_def_extern_entry(stack__top_det_2_0)
MR_def_extern_entry(fn__stack__top_det_1_0)
MR_def_extern_entry(fn__stack__det_top_1_0)
MR_def_extern_entry(stack__pop_3_0)
MR_def_extern_entry(stack__pop_det_3_0)
...
MR_BEGIN_MODULE(stack_module9)
	MR_init_entry1(stack__top_det_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stack__top_det_2_0);
	MR_init_label1(stack__top_det_2_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'top_det'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__stack__top_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(stack__top_det_2_0_i3);
	}
	MR_r1 = MR_tfield(1, MR_r2, 0);
	MR_proceed();
MR_def_label(stack__top_det_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("stack.top_det: top of empty stack", 33);
...
MR_BEGIN_MODULE(stack_module10)
	MR_init_entry1(fn__stack__top_det_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__stack__top_det_1_0);
	MR_init_label1(fn__stack__top_det_1_0,3)
MR_BEGIN_CODE
...
/* code for 'top_det'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__stack__top_det_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__stack__top_det_1_0_i3);
	}
	MR_r1 = MR_tfield(1, MR_r2, 0);
	MR_proceed();
MR_def_label(fn__stack__top_det_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("stack.top_det: top of empty stack", 33);
	MR_np_tailcall_ent(require__error_1_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(stack_module13)
	MR_init_entry1(stack__pop_det_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__stack__pop_det_3_0);
	MR_init_label1(stack__pop_det_3_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'pop_det'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__stack__pop_det_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(stack__pop_det_3_0_i3);
	}
	MR_r1 = MR_tfield(1, MR_r2, 0);
	MR_r2 = MR_tfield(1, MR_r2, 1);
	MR_proceed();
MR_def_label(stack__pop_det_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("stack.pop_det: pop from empty stack", 35);
	MR_np_tailcall_ent(require__error_1_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(stack_module19)
...
MR_BEGIN_MODULE(stack_module20)
...
void mercury__stack__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__stack);
