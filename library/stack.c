...
{
  {
    ...
    if (mercury__stack__succeeded)
      *mercury__stack__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mercury__stack__ArgX1_4 = (MR_Word) mercury__stack__HeadVar__2_2;
        MR_Word mercury__stack__ArgY1_5 = (MR_Word) mercury__stack__HeadVar__3_3;

        {
          mercury__list____Compare____list_1_0(mercury__stack__TypeInfo_for_T_8, mercury__stack__HeadVar__1_1, mercury__stack__ArgX1_4, mercury__stack__ArgY1_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__stack__succeeded)
      ...
      {
        MR_Word mercury__stack__ArgX1_3 = (MR_Word) mercury__stack__HeadVar__1_1;
        MR_Word mercury__stack__ArgY1_4 = (MR_Word) mercury__stack__HeadVar__2_2;

        {
          mercury__stack__succeeded = mercury__list____Unify____list_1_0(mercury__stack__TypeInfo_for_T_7, mercury__stack__ArgX1_3, mercury__stack__ArgY1_4);
        }
      }
    return mercury__stack__succeeded;
  }
