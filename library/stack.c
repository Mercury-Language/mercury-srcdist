  ...
  MR_Word * STATE_VARIABLE_Stack_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Elems_15 = (MR_Word) (STATE_VARIABLE_Stack_0_2);
      MR_Word Var_16;
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_16, 0) = Elem_7;
        MR_hl_field(MR_mktag(1), Var_16, 1) = ((MR_Box) (Elems_15));
      }
      STATE_VARIABLE_Stack_12_12 = (MR_Word) (Var_16);
...
{
  MR_Word STATE_VARIABLE_Stack_7;
  MR_Word Elems_10 = (MR_Word) (STATE_VARIABLE_Stack_0_6);
  MR_Word Var_11;

  {
    Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_11, 0) = X_5;
    MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) (Elems_10));
  }
  STATE_VARIABLE_Stack_7 = (MR_Word) (Var_11);
  return STATE_VARIABLE_Stack_7;
}
