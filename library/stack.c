  ...
  MR_Word * STATE_VARIABLE_Stack_8)
{
  ...
  else
  {
    ...
    *Elem_4 = (MR_hl_field(1, Var_15, (MR_Integer) 0));
    Elems_6 = ((MR_Word) ((MR_hl_field(1, Var_15, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Stack_8)
{
  ...
  if (succeeded)
  {
    *Elem_4 = (MR_hl_field(1, Var_9, (MR_Integer) 0));
    Elems_6 = ((MR_Word) ((MR_hl_field(1, Var_9, (MR_Integer) 1))));
    *STATE_VARIABLE_Stack_8 = (MR_Word) (Elems_6);
    succeeded = MR_TRUE;
  }
  return succeeded;
  ...
  MR_Word Stack_3)
{
  ...
  if ((Var_11 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    X_4 = (MR_hl_field(1, Var_11, (MR_Integer) 0));
  return X_4;
}
  ...
  MR_Box * Elem_3)
{
  ...
  if (succeeded)
    *Elem_3 = (MR_hl_field(1, Var_5, (MR_Integer) 0));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Stack_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Box Elem_7 = (MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0));
      MR_Word Elems_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      ...
      STATE_VARIABLE_Stack_12_12 = (MR_Word) (Var_15);
