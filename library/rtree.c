...
MR_def_label(fn__rtree__choose_subtree_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_r1) - MR_word_to_float(MR_sv(3))));
	MR_r3 = MR_float_to_word((MR_word_to_float(MR_sv(4)) - MR_word_to_float(MR_sv(2))));
...
MR_def_label(fn__rtree__choose_subtree_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_sv(2)) > MR_word_to_float(MR_sv(3)))) {
...
MR_def_label(fn__rtree__choose_subtree_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_r1) - MR_word_to_float(MR_sv(4))));
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_float_to_word((MR_word_to_float(MR_sv(6)) - MR_word_to_float(MR_sv(3))));
	MR_r3 = MR_tempr1;
	MR_tempr2 = MR_float_to_word((MR_word_to_float(MR_sv(5)) - MR_word_to_float(MR_sv(2))));
	MR_r4 = MR_tempr2;
...
MR_def_label(fn__rtree__choose_subtree_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_sv(2)) > MR_word_to_float(MR_sv(4)))) {
...
MR_def_label(rtree__insert_tree_and_split_child3_11_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_float_to_word((MR_word_to_float(MR_r1) - MR_word_to_float(MR_sv(17))));
	MR_r6 = MR_float_to_word((MR_word_to_float(MR_sv(1)) - MR_word_to_float(MR_sv(16))));
	if ((MR_word_to_float(MR_r6) >= MR_word_to_float(MR_r5))) {
...
MR_def_label(rtree__insert_tree_and_split_child3_11_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_sv(16)) > MR_word_to_float(MR_sv(17)))) {
...
MR_def_label(rtree__insert_tree_and_split_child3_11_0,18)
	...
	MR_tfield(3, MR_r2, 5) = MR_sv(11);
	MR_tfield(3, MR_r2, 6) = MR_sv(12);
...
MR_def_label(rtree__insert_tree_and_split_child3_11_0,21)
	...
	MR_tfield(3, MR_tempr1, 6) = MR_sv(13);
