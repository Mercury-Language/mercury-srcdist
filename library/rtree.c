    ...
    if (succeeded)
    {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                {
                  STATE_VARIABLE_T_28_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_T_28_42, 0) = OrphanKey_18;
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_T_28_42, 1) = ((MR_Box) (OrphanTree_19));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_T_28_42, 2) = NextOrphanKey_21;
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_T_28_42, 3) = ((MR_Box) (NextOrphanTree_22));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__4_4 = base;
                  MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (STATE_VARIABLE_T_28_42));
                }
              }
              else
          ...
          else
          {
            ...
            mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_51, TypeClassInfo_for_region_50, Orphans0_17, (MR_Integer) 1, OrphanTree_19, &STATE_VARIABLE_T_28_45);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
              MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (STATE_VARIABLE_T_28_45));
            }
          }
        }
      }
      else
      {
        ...
        mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_51, TypeClassInfo_for_region_50, Orphans_15, Depth_14, STATE_VARIABLE_T_27_27, &STATE_VARIABLE_T_28_28);
        {
          ...
          base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__4_4 = base;
          MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (STATE_VARIABLE_T_28_28));
        }
      }
      succeeded = MR_TRUE;
    }
