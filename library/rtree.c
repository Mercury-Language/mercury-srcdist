      ...
      case (MR_Integer) 3:
        {
          ...
          switch (MR_tag((MR_Word) T0_35)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Box V_51 = (MR_hl_field(MR_mktag(0), T0_35, (MR_Integer) 0));
          ...
          if (succeeded)
          {
            switch (MR_tag((MR_Word) T1_37)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Box V_70 = (MR_hl_field(MR_mktag(0), T1_37, (MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_66 = (MR_hl_field(MR_mktag(0), T0_17, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_67 = (MR_hl_field(MR_mktag(0), T1_19, (MR_Integer) 0));
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_63 = (MR_hl_field(MR_mktag(0), T0_29, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_64 = (MR_hl_field(MR_mktag(0), T1_31, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_65 = (MR_hl_field(MR_mktag(0), T2_33, (MR_Integer) 0));
              {
      ...
      case (MR_Integer) 3:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_59 = (MR_hl_field(MR_mktag(0), T0_44, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_60 = (MR_hl_field(MR_mktag(0), T1_46, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_61 = (MR_hl_field(MR_mktag(0), T2_48, (MR_Integer) 0));
              {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              V_62 = (MR_hl_field(MR_mktag(0), T3_50, (MR_Integer) 0));
              {
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
  {
    ...
    MR_Box Var_52 = (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1));
    MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box);
    ...
    {
      *HeadVar__4_4 = (MR_Word) ((MR_Unsigned) 0U);
      func_0 = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_region_50, (MR_Integer) 0)), (MR_Integer) 6))));
  ...
  if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 2))
  {
    ...
    if (succeeded)
    {
      if (((MR_tag((MR_Word) Info_13)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_51, TypeClassInfo_for_region_50, Orphans0_17, (MR_Integer) 1, OrphanTree_19, &STATE_VARIABLE_T_40_45);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
      ...
      else
      {
        ...
        mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_51, TypeClassInfo_for_region_50, Orphans_15, Depth_14, STATE_VARIABLE_T_27_27, &STATE_VARIABLE_T_40_40);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__4_4 = base;
