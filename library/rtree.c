  ...
  if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 2))
  {
    ...
    if (succeeded)
    {
      if (((MR_tag((MR_Word) Info_13)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_52, TypeClassInfo_for_region_51, Orphans0_17, (MR_Integer) 1, OrphanTree_19, &STATE_VARIABLE_T_28_45);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__4_4 = base;
      ...
      else
      {
        ...
        mercury__rtree__reinsert_deleted_subtrees_4_p_0(TypeInfo_for_V_52, TypeClassInfo_for_region_51, Orphans_15, Depth_14, STATE_VARIABLE_T_27_27, &STATE_VARIABLE_T_28_28);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__4_4 = base;
