...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (!(succeeded))
  {
    ...
    mercury__io__make_io_error_from_system_error_5_p_0(Error_7, (MR_String) "error writing to output file: ", &Var_12);
    {
