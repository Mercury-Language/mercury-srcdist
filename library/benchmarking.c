...
#line 1021 "benchmarking.m"

#include "mercury_prof.h"
#include "mercury_heap_profile.h"

#line 105 "benchmarking.c"
#line 106 "benchmarking.c"
#ifndef BENCHMARKING_DECL_GUARD
#define BENCHMARKING_DECL_GUARD

#line 110 "benchmarking.c"
#line 132 "benchmarking.m"
...
MR_decl_label6(benchmarking__write_out_trace_counts_4_0, 46,4,8,12,16,17)
...
{
#line 146 "benchmarking.m"

    ML_report_stats();
;}
#line 246 "benchmarking.c"
...
{
#line 153 "benchmarking.m"

#ifdef  MR_MPROF_PROFILE_MEMORY
    ML_report_full_memory_stats();
#endif
;}
#line 278 "benchmarking.c"
...
{
#line 826 "benchmarking.m"

    Time = MR_get_user_cpu_milliseconds();
;}
#line 328 "benchmarking.c"
...
#define	MR_PROC_LABEL	mercury__benchmarking__benchmark_nondet_5_0
	X = MR_r1;
{
#line 872 "benchmarking.m"

    ML_benchmarking_dummy_word = (MR_Word) X;
;}
#line 876 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	{
	MR_Word	Ref;
...
{
#line 1027 "benchmarking.m"

#ifdef MR_MPROF_PROFILE_CALLS
    MR_prof_turn_off_call_profiling();
#endif
;}
#line 994 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1041 "benchmarking.m"

#ifdef MR_MPROF_PROFILE_TIME
    MR_prof_turn_off_time_profiling();
#endif
;}
#line 1024 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1055 "benchmarking.m"

    MR_prof_turn_off_heap_profiling();
;}
#line 1052 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1034 "benchmarking.m"

#ifdef MR_MPROF_PROFILE_CALLS
    MR_prof_turn_on_call_profiling();
#endif
;}
#line 1152 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
{
#line 1048 "benchmarking.m"

#ifdef MR_MPROF_PROFILE_TIME
    MR_prof_turn_on_time_profiling();
#endif
;}
#line 1182 "benchmarking.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(benchmarking_module30)
	...
	MR_init_label6(benchmarking__write_out_trace_counts_4_0,46,4,8,12,16,17)
MR_BEGIN_CODE
...
#endif
;}
#line 1490 "benchmarking.c"
	MR_RELEASE_GLOBAL_LOCK("dump_trace_counts_to");
	MR_r3 = Result;
#undef	MR_PROC_LABEL
	}
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(benchmarking__write_out_trace_counts_4_0_i46);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(benchmarking__write_out_trace_counts_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	...
	MR_np_call_localret_ent(string__append_3_2,
		benchmarking__write_out_trace_counts_4_0_i16);
MR_def_label(benchmarking__write_out_trace_counts_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,2)) {
		MR_GOTO_LAB(benchmarking__write_out_trace_counts_4_0_i8);
	}
	MR_r2 = (MR_Word) MR_string_const("\': trace counting not turned on", 31);
	MR_np_call_localret_ent(string__append_3_2,
		benchmarking__write_out_trace_counts_4_0_i16);
MR_def_label(benchmarking__write_out_trace_counts_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,3)) {
		MR_GOTO_LAB(benchmarking__write_out_trace_counts_4_0_i12);
	}
	MR_r2 = (MR_Word) MR_string_const("\': couldn\'t open file", 21);
	MR_np_call_localret_ent(string__append_3_2,
		benchmarking__write_out_trace_counts_4_0_i16);
MR_def_label(benchmarking__write_out_trace_counts_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("\'", 1);
	MR_np_call_localret_ent(string__append_3_2,
		benchmarking__write_out_trace_counts_4_0_i16);
MR_def_label(benchmarking__write_out_trace_counts_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("Couldn\'t dump trace counts to \140", 31);
	MR_np_call_localret_ent(string__append_3_2,
		benchmarking__write_out_trace_counts_4_0_i17);
MR_def_label(benchmarking__write_out_trace_counts_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
#endif
MR_END_MODULE
#line 863 "benchmarking.m"

    volatile        MR_Word ML_benchmarking_dummy_word;

#line 1893 "benchmarking.c"
...
void mercury__benchmarking__write_out_proc_statics(FILE *fp);
#endif
