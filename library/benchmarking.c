...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      *MaybeErrorMsg_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
...
#undef MR_PROC_LABEL
      ...
      mercury__mutvar__get_mutvar_2_p_0((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27, (env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__SolutionCounter_21, &conv1_Count_8);
      *((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Count_8) = ((MR_Integer) conv1_Count_8);
      ...
      (env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Var_25 = (*((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Count_8) + (env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Var_26);
      mercury__mutvar__set_mutvar_2_p_0((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27, (env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__SolutionCounter_21, ((MR_Box) ((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Var_25)));
...
{
  {
...

    {
      ...
      mercury__mutvar__set_mutvar_2_p_0((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27, (env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__SolutionCounter_21, ((MR_Box) ((env_ptr)->mercury__benchmarking__benchmark_nondet_5_p_0_env_0__Var_24)));
...
#undef MR_PROC_LABEL
	 StartTime_11  = Time;
      ...
      (env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
      mercury__mutvar__new_mutvar_2_p_1((env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27, ((MR_Box) ((MR_Integer) 0)), &(env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__SolutionCounter_21);
      mercury__benchmarking__benchmark_nondet_5_p_0_4(&env);
      if (!((env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__succeeded))
      {
      }
      mercury__mutvar__get_mutvar_2_p_0((env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__TypeCtorInfo_17_27, (env).mercury__benchmarking__benchmark_nondet_5_p_0_env_0__SolutionCounter_21, &conv2_Count_8);
...
#undef MR_PROC_LABEL
	 EndTime_12  = Time;
      ...
      Time0_13 = (EndTime_12 - StartTime_11);
{
#define MR_PROC_LABEL mercury__benchmarking__benchmark_nondet_5_p_0
...
{
  {
    ...
    if (succeeded)
    {
      cont(cont_env_ptr);
      {
        MR_Integer Var_4 = (N_2 - (MR_Integer) 1);

        mercury__benchmarking__repeat_1_p_0(Var_4, cont, cont_env_ptr);
      }
    }
  }
}
...
#undef MR_PROC_LABEL
    ...
    *Time_14 = (EndTime_16 - StartTime_15);
  }
}
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      MR_Integer Var_16 = (Repeats_12 - (MR_Integer) 1);
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      MR_Integer Var_11 = (Repeats_8 - (MR_Integer) 1);
