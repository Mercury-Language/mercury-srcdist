...
static MR_Word MR_CALL 
mercury__edit_seq__IntroducedFrom__func__find_diff_cord__335__1_2_f_0(
...
{
  {
    ...
    else
    {
      ...
      V_8_8 = mercury__edit_seq__IntroducedFrom__func__find_diff_cord__335__1_2_f_0(Var_14, V_6_6);
  ...
  MR_Word * STATE_VARIABLE_Table_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_25 = (MR_Integer) ((MR_Unsigned) HeadVar__4_4 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
