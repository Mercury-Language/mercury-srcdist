...
MR_decl_label10(eqvclass__add_equivalence_4_0, 3,4,6,7,8,9,10,11,5,13)
MR_decl_label3(eqvclass__add_equivalence_4_0, 14,15,16)
MR_decl_label3(eqvclass__change_partition_4_0, 10,3,4)
MR_decl_label4(eqvclass__divide_equivalence_classes_2_9_0, 4,5,6,3)
MR_decl_label10(eqvclass__divide_equivalence_classes_3_11_0, 2,4,6,8,10,11,12,13,14,15)
MR_decl_label8(eqvclass__divide_equivalence_classes_3_11_0, 3,17,19,21,22,23,24,25)
...
MR_def_extern_entry(eqvclass__remove_equivalent_elements_3_0)
...
MR_BEGIN_MODULE(eqvclass_module11)
	...
	MR_init_label10(eqvclass__add_equivalence_4_0,3,4,6,7,8,9,10,11,5,13)
	MR_init_label3(eqvclass__add_equivalence_4_0,14,15,16)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(eqvclass_module35)
	MR_init_entry1(eqvclass__remove_equivalent_elements_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__eqvclass__remove_equivalent_elements_3_0);
MR_BEGIN_CODE
...
/* code for 'remove_equivalent_elements'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__eqvclass__remove_equivalent_elements_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_BEGIN_MODULE(eqvclass_module38)
	...
	MR_init_label10(eqvclass__divide_equivalence_classes_3_11_0,2,4,6,8,10,11,12,13,14,15)
	MR_init_label8(eqvclass__divide_equivalence_classes_3_11_0,3,17,19,21,22,23,24,25)
MR_BEGIN_CODE
...
MR_def_label(eqvclass__divide_equivalence_classes_3_11_0,24)
	...
	MR_r5 = MR_sv(6);
	MR_np_call_localret_ent(map__det_update_4_0,
		eqvclass__divide_equivalence_classes_3_11_0_i25);
MR_def_label(eqvclass__divide_equivalence_classes_3_11_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(eqvclass_module44)
...
void mercury__eqvclass__init_threadscope_string_table(void);
#endif
...
void mercury__eqvclass__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__eqvclass);
