  ...
  MR_Word * HeadVar__10_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__2_2 = V_26_22;
        MR_Word next_value_of_HeadVar__3_3 = V_39_31;
        MR_Word next_value_of_HeadVar__5_5 = V_40_32;
        MR_Word next_value_of_HeadVar__7_7 = V_41_33;
        MR_Word next_value_of_HeadVar__9_9 = V_42_34;
  ...
  MR_Word * STATE_VARIABLE_ElementMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Elements_10;
        MR_Word next_value_of_STATE_VARIABLE_ElementMap_0_3 = STATE_VARIABLE_ElementMap_15_15;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__2_2 = Elements_8;
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_HeadVar__2_2 = T2_25;
          MR_Word next_value_of_STATE_VARIABLE_EqvClass_0_3 = STATE_VARIABLE_EqvClass_29_29;
