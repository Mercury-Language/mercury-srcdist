...
MR_decl_label1(eqvclass__divide_equivalence_classes_3_11_0, 21)
...
MR_decl_label2(eqvclass__new_equivalence_4_0, 26,27)
MR_decl_label1(eqvclass__partition_list_2_0, 2)
MR_decl_label5(eqvclass__partition_list_to_eqvclass_2_0, 19,4,7,8,18)
MR_decl_label5(eqvclass__partition_set_2_0, 2,3,4,5,7)
MR_decl_label5(eqvclass__partitions_3_0, 20,5,4,8,9)
...
MR_BEGIN_MODULE(eqvclass_module16)
	...
	MR_init_label2(eqvclass__new_equivalence_4_0,26,27)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(eqvclass_module21)
	...
	MR_init_label5(eqvclass__partitions_3_0,20,5,4,8,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__eqvclass__partitions_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(eqvclass__partitions_3_0_i20);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(eqvclass__partitions_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(eqvclass_module28)
	...
	MR_init_label5(eqvclass__partition_list_to_eqvclass_2_0,19,4,7,8,18)
MR_BEGIN_CODE
...
MR_define_entry(mercury__eqvclass__partition_list_to_eqvclass_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(eqvclass__partition_list_to_eqvclass_2_0_i19);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_proceed();
MR_def_label(eqvclass__partition_list_to_eqvclass_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(eqvclass_module37)
	...
	MR_init_label1(eqvclass__divide_equivalence_classes_3_11_0,21)
MR_BEGIN_CODE
