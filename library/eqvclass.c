  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Word Counter0_68 = ((MR_Word) ((MR_hl_field(0, EqvClass0_7, 0))));
        MR_Word PartitionMap0_69 = ((MR_Word) ((MR_hl_field(0, EqvClass0_7, 1))));
        MR_Word ElementMap0_70 = ((MR_Word) ((MR_hl_field(0, EqvClass0_7, 2))));
