...
MR_decl_label2(eqvclass__ensure_equivalence_4_0, 31,33)
...
MR_BEGIN_MODULE(eqvclass_module12)
	...
	MR_init_label2(eqvclass__ensure_equivalence_4_0,31,33)
MR_BEGIN_CODE
...
/*-------------------------------------------------------------------------*/
/* code for 'UnusedArgs__pred__foldl4__ho10__[1, 2, 3, 4, 9, 10, 11, 12, 13]_0'/10 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
