...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        {
          V_5_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), V_5_68, 0) = Item_14;
          MR_hl_field(MR_mktag(1), V_5_68, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
    ...
    else
    {
      ...
      MR_Word MainSet_43;
      MR_Word Set_44;
      MR_Integer V_5_77 = (MR_Integer) ((MR_Unsigned) NewId_25 + (MR_Unsigned) 1);
      MR_Word V_4_89;
      MR_Word V_5_90;
      MR_Word V_6_91;
      ...
      *STATE_VARIABLE_Counter_29 = (MR_Word) (V_5_77);
      ...
      {
        V_5_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_5_90, 0) = Item_14;
        MR_hl_field(MR_mktag(1), V_5_90, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
...
{
  {
    ...
    else
    {
      ...
      {
        V_4_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), V_4_33, 0) = X_7;
        MR_hl_field(MR_mktag(1), V_4_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
  ...
  MR_Word * EqvClass_2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Integer V_5_37 = (MR_Integer) ((MR_Unsigned) Id_17 + (MR_Unsigned) 1);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Integer V_5_95 = (MR_Integer) ((MR_Unsigned) Id_19 + (MR_Unsigned) 1);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Integer V_5_93 = (MR_Integer) ((MR_Unsigned) Id_19 + (MR_Unsigned) 1);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__tree234__delete_2_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), TypeInfo_27_27, PartitionMap0_10, ((MR_Box) (IdA_5)), &PartitionMap1_14, &V_7_52);
    ...
    else
    {
      ...
      mercury__tree234__delete_2_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), TypeInfo_27_27, PartitionMap0_10, ((MR_Box) (IdB_6)), &PartitionMap1_22, &V_7_73);
...
{
  {
    ...
    *Id_6 = (MR_Integer) (Counter0_8);
    V_5_23 = (MR_Integer) ((MR_Unsigned) *Id_6 + (MR_Unsigned) 1);
    ...
    {
      V_4_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), V_4_30, 0) = Element_5;
      MR_hl_field(MR_mktag(1), V_4_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
