  ...
  MR_Word * Result_6)
{
  ...
  {
    MR_Word Var_21 = ((MR_Word) ((MR_hl_field(0, Result0_8, 0))));

    if (((MR_tag((MR_Word) Var_21)) == (MR_Integer) 0))
    {
      MR_Integer Code_9 = ((MR_Integer) ((MR_hl_field(0, Var_21, 0))));
    ...
    {
      MR_Integer Signal_10 = ((MR_Integer) ((MR_hl_field(1, Var_21, 0))));
      MR_String SignalStr_11;
      MR_String ErrMsg_12;
      MR_Word Var_20;

      SignalStr_11 = mercury__string__int_to_string_1_f_0(Signal_10);
...
succeeded  = SUCCESS_INDICATOR;
  ...
  {
    MR_Word IOError_11 = ((MR_Word) ((MR_hl_field(1, MaybeIOError_10, 0))));
