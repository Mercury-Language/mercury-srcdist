...
#undef MR_PROC_LABEL
	SignalStr_11  = S;
      ...
      mercury__string__append_3_p_2((MR_String) "system command killed by signal number ", SignalStr_11, &ErrMsg_12);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (ErrMsg_12));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  switch (Exited_5) {
    ...
    case (MR_Integer) 0:
      switch (Signalled_7) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Status_4 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__io__call_system_scalar_common_4[1]));
          break;
        case (MR_Integer) 1:
          {
            MR_Word Var_11;
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_10, 0) = ((MR_Box) (ExitCode_6));
        }
        {
          Status_4 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
