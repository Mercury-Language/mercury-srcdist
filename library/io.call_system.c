...
{
  MR_Word Result0_8;
  MR_Integer Status_27;
  MR_Box Error_28;
  MR_Word MaybeIOError_29;
...
#undef MR_PROC_LABEL
  ...
  mercury__io__is_error_5_p_0(Error_28, (MR_String) "error invoking system command: ", &MaybeIOError_29);
  if ((MaybeIOError_29 == (MR_Word) ((MR_Unsigned) 0U)))
    Result0_8 = mercury__io__call_system__decode_system_command_exit_code_1_f_0(Status_27);
  else
  {
    MR_Word IOError_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_29, (MR_Integer) 0))));

    {
      Result0_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Result0_8, 0) = ((MR_Box) (IOError_30));
    }
  }
