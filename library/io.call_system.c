...
static /* final */ const MR_Box mercury__io__call_system_scalar_common_3[2][5];

static /* final */ const MR_Box mercury__io__call_system_scalar_common_4[1][1];
...
#undef MR_PROC_LABEL
  ...
  mercury__io__is_error_5_p_0(Error_9, (MR_String) "error invoking system command: ", &MaybeIOError_10);
...
{
  MR_Word Result0_8;
  MR_Integer Status_22;
  MR_Box Error_23;
  MR_Word MaybeIOError_24;
...
#undef MR_PROC_LABEL
  ...
  mercury__io__is_error_5_p_0(Error_23, (MR_String) "error invoking system command: ", &MaybeIOError_24);
  if ((MaybeIOError_24 == (MR_Word) ((MR_Unsigned) 0U)))
    Result0_8 = mercury__io__call_system__decode_system_command_exit_code_1_f_0(Status_22);
  else
  {
    MR_Word IOError_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_24, (MR_Integer) 0))));

    {
      Result0_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Result0_8, 0) = ((MR_Box) (IOError_25));
    }
  }
  ...
  switch (Exited_5) {
    ...
    case (MR_Integer) 0:
      switch (Signalled_7) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Status_4 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__io__call_system_scalar_common_4[0]));
          break;
        case (MR_Integer) 1:
          {
            MR_Word Var_10;

            {
              ...
              MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (Signal_8));
            }
            {
              Status_4 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Status_4, 0) = ((MR_Box) (Var_10));
            }
          }
          break;
      }
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_9, 0) = ((MR_Box) (ExitCode_6));
        }
        {
          Status_4 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Status_4, 0) = ((MR_Box) (Var_9));
        }
      }
      break;
  }
