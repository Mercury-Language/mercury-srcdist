...
#line 80 "float.opt"
	...
	FloatVal = IntVal;
;}
#line 529 "hash_table.c"
	MR_tempr1 = MR_float_to_word(FloatVal);
#undef	MR_PROC_LABEL
	}
	MR_tempr2 = MR_float_to_word((MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_sv(2))));
	{
	MR_Float	X;
	MR_Integer	Ceil;
#define	MR_PROC_LABEL	mercury__fn__hash_table__init_3_0
...
#define	MR_PROC_LABEL	mercury__fn__hash_table__set_3_0
	Index = MR_sv(6);
	Item = MR_r1;
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, MR_sv(7), Array0);
{
#line 238 "array.opt"
...
#undef	MR_PROC_LABEL
	...
	MR_sv(6) = MR_tempr2;
	MR_sv(7) = ((MR_Integer) MR_tempr3 + (MR_Integer) MR_tempr3);
	MR_sv(8) = ((MR_Integer) MR_tfield(0, MR_r1, 1) + (MR_Integer) MR_tfield(0, MR_r1, 1));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(7);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	}
...
#undef	MR_PROC_LABEL
	...
	MR_sv(6) = MR_tempr2;
	MR_sv(7) = ((MR_Integer) MR_tempr3 + (MR_Integer) MR_tempr3);
	MR_sv(8) = ((MR_Integer) MR_tfield(0, MR_tempr1, 1) + (MR_Integer) MR_tfield(0, MR_tempr1, 1));
	MR_r2 = MR_sv(7);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	}
	MR_np_call_localret_ent(array__init_3_0,
