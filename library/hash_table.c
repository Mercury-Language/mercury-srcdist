              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_44, 0) = K1_40;
                    MR_hl_field(MR_mktag(1), Var_44, 1) = V1_41;
                    MR_hl_field(MR_mktag(1), Var_44, 2) = ((MR_Box) (KVs_42));
                  }
                  {
                    HB_37 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), HB_37, 0) = K_26;
                    ...
                    MR_hl_field(MR_mktag(2), HB_37, 4) = ((MR_Box) (Var_44));
                  }
                }
                break;
            }
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_61, 0) = K1_57;
                    MR_hl_field(MR_mktag(1), Var_61, 1) = V1_58;
                    MR_hl_field(MR_mktag(1), Var_61, 2) = ((MR_Box) (KVs_59));
                  }
                  {
                    HB_54 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), HB_54, 0) = K0_28;
                    ...
                    MR_hl_field(MR_mktag(2), HB_54, 4) = ((MR_Box) (Var_61));
                  }
                }
                break;
            }
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_78, 0) = K1_74;
                    MR_hl_field(MR_mktag(1), Var_78, 1) = V1_75;
                    MR_hl_field(MR_mktag(1), Var_78, 2) = ((MR_Box) (KVs_76));
                  }
                  {
                    HB_71 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), HB_71, 0) = K1_30;
                    ...
                    MR_hl_field(MR_mktag(2), HB_71, 4) = ((MR_Box) (Var_78));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_27, 0) = K1_23;
              MR_hl_field(MR_mktag(1), Var_27, 1) = V1_24;
              MR_hl_field(MR_mktag(1), Var_27, 2) = ((MR_Box) (KVs_25));
            }
            {
              HB_20 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), HB_20, 0) = K_10;
              ...
              MR_hl_field(MR_mktag(2), HB_20, 4) = ((MR_Box) (Var_27));
            }
          }
          break;
      }
