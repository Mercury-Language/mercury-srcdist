...
MR_decl_label8(hash_table__generic_hash_2_0, 71,3,2,6,5,10,9,13)
MR_decl_label8(hash_table__generic_hash_2_0, 12,16,15,22,25,20,28,29)
MR_decl_label1(hash_table__generic_hash_2_0, 30)
...
MR_decl_label2(__Compare___hash_table__hash_table_2_0, 21,59)
...
MR_BEGIN_MODULE(hash_table_module8)
	...
	MR_init_label8(hash_table__generic_hash_2_0,71,3,2,6,5,10,9,13)
	MR_init_label8(hash_table__generic_hash_2_0,12,16,15,22,25,20,28,29)
	MR_init_label1(hash_table__generic_hash_2_0,30)
MR_BEGIN_CODE
...
MR_def_static(hash_table__increase_occupants_2_0)
	...
	MR_tempr8 = MR_r3;
	MR_tempr3 = MR_ctfield(0, MR_tempr8, 3);
	{
	MR_ArrayPtr	Array;
	MR_Integer	Max;
...
#undef	MR_PROC_LABEL
	...
	MR_sv(1) = MR_tempr6;
	MR_sv(2) = MR_tempr7;
	MR_sv(3) = MR_ctfield(0, MR_tempr8, 0);
	MR_sv(4) = MR_ctfield(0, MR_tempr8, 2);
	MR_sv(5) = MR_tempr3;
	MR_sv(6) = ((MR_Integer) MR_tempr4 + (MR_Integer) MR_tempr4);
	MR_sv(7) = ((MR_Integer) MR_ctfield(0, MR_tempr8, 1) + (MR_Integer) MR_ctfield(0, MR_tempr8, 1));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(6);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	}
...
MR_define_entry(mercury__fn__hash_table__to_assoc_list_1_0);
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_LIST_CTOR_ADDR;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_tempr3 = MR_ctfield(0, MR_r3, 3);
	MR_r4 = MR_tempr3;
	{
	MR_ArrayPtr	Array;
	MR_Integer	Min;
...
MR_define_entry(mercury__fn__hash_table__fold_3_0);
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_LIST_CTOR_ADDR;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_tempr3 = MR_ctfield(0, MR_r5, 3);
	{
	MR_ArrayPtr	Array;
	MR_Integer	Min;
...
MR_define_entry(mercury____Unify___hash_table__hash_table_2_0);
	...
	MR_sv(1) = MR_ctfield(0, MR_sv(1), 3);
...
MR_BEGIN_MODULE(hash_table_module43)
	...
	MR_init_label2(__Compare___hash_table__hash_table_2_0,21,59)
MR_BEGIN_CODE
