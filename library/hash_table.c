...
MR_def_static(hash_table__increase_occupants_2_0)
	...
	MR_tempr8 = MR_r3;
	MR_tempr3 = MR_tfield(0, MR_tempr8, 3);
	{
	MR_ArrayPtr	Array;
	MR_Integer	Max;
...
#undef	MR_PROC_LABEL
	...
	MR_sv(4) = MR_tfield(0, MR_tempr8, 2);
	MR_sv(5) = MR_tempr3;
	MR_sv(6) = ((MR_Integer) MR_tempr4 + (MR_Integer) MR_tempr4);
	MR_sv(7) = ((MR_Integer) MR_tfield(0, MR_tempr8, 1) + (MR_Integer) MR_tfield(0, MR_tempr8, 1));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(6);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	}
