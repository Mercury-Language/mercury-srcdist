...
{
  {
    ...
    Var_7 = mercury__hash_table__init_3_f_0(TypeInfo_for_K_8, TypeInfo_for_V_9, HashPred_4, (MR_Integer) 7, (MR_Float) 0.87500000000000000);
...
#undef MR_PROC_LABEL
    ...
    func_0(((MR_Box) (Var_33)), K_6, &conv1_Hash_51);
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      mercury__require__error_2_p_0((MR_String) "function \140hash_table.det_update\'/3", (MR_String) "key not found");
{
#define MR_PROC_LABEL mercury__hash_table__det_update_3_f_0
...
{
  {
    ...
    MR_Word Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HT0_5, (MR_Integer) 2))));
    MR_Integer Var_44;
    MR_ArrayPtr Var_47 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), HT0_5, (MR_Integer) 3))));
    MR_Integer Hash_61;
    MR_Integer Var_62;
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *);
    MR_Box conv1_Hash_61;
    MR_Box conv2_Item;
    MR_ArrayPtr conv3_Array;
...
#define MR_PROC_LABEL mercury__hash_table__det_insert_3_f_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_ArrayPtr, (MR_ArrayPtr) (Var_47) , Array);
		{
...
#undef MR_PROC_LABEL
    ...
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 1))));
    func_0(((MR_Box) (Var_43)), K_6, &conv1_Hash_61);
    Hash_61 = ((MR_Integer) (conv1_Hash_61));
    Var_62 = (MR_Integer) ((MR_Unsigned) Var_44 - (MR_Unsigned) 1);
    H_9 = (Hash_61 & Var_62);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = mercury__hash_table__alist_search_3_p_0(TypeInfo_for_K_27, TypeInfo_for_V_28, AL0_14, K_6, &Var_31);
          if (succeeded)
            mercury__require__error_2_p_0((MR_String) "function \140hash_table.det_insert\'/3", (MR_String) "key already present");
          else
            {
...
#undef MR_PROC_LABEL
	 MaxOccupants_10  = Ceil;
}
          {
            ...
            MR_hl_field(MR_mktag(0), TypeInfo_29_29, 0) = ((MR_Box) (&mercury__hash_table__hash_table__type_ctor_info_hash_table_alist_2));
