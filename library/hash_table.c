...
MR_def_label(fn__hash_table__init_3_0,42)
	...
	MR_sv(1) = MR_r3;
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_r5);
	MR_sv(5) = MR_r1;
	MR_sv(6) = MR_r2;
	MR_r1 = (MR_Integer) 1;
	MR_r2 = MR_r4;
...
#line 81 "float.opt"
	...
	FloatVal = IntVal;
;}
#line 528 "hash_table.c"
	MR_tempr1 = MR_float_to_word(FloatVal);
#undef	MR_PROC_LABEL
	}
	MR_tempr2 = MR_float_to_word((MR_word_to_float(MR_tempr1) * MR_float_from_dword_ptr(&MR_sv(3))));
	{
	MR_Float	X;
	MR_Integer	Ceil;
#define	MR_PROC_LABEL	mercury__fn__hash_table__init_3_0
