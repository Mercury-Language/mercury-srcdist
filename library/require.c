...
static /* final */ const MR_Box mercury__require_scalar_common_4[1][5];
...
#undef MR_PROC_LABEL
  ...
  func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&mercury__require_scalar_common_1[0]), 0)), 12))));
...
{
  MR_bool succeeded;
  MR_bool MR_CALL (* func_0)(MR_Box) = ((MR_bool MR_CALL (*)(MR_Box)) ((MR_hl_field(0, Goal_5, 1))));
...
{
  MR_bool succeeded;
  MR_bool MR_CALL (* func_0)(MR_Box) = ((MR_bool MR_CALL (*)(MR_Box)) ((MR_hl_field(0, Goal_4, 1))));
...
{
  MR_bool succeeded;
  MR_bool MR_CALL (* func_0)(MR_Box) = ((MR_bool MR_CALL (*)(MR_Box)) ((MR_hl_field(0, Goal_3, 1))));
