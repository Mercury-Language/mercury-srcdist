...
#endif
MR_decl_label5(require__report_lookup_error_2_0, 2,3,4,5,11)
MR_decl_label6(require__report_lookup_error_3_0, 2,3,4,5,6,14)
...
MR_BEGIN_MODULE(require_module3)
	...
	MR_init_label6(require__report_lookup_error_3_0,2,3,4,5,6,14)
MR_BEGIN_CODE
...
MR_def_label(require__report_lookup_error_3_0,6)
	...
	MR_np_call_localret_ent(fn__string__append_list_1_0,
		require__report_lookup_error_3_0_i14);
MR_def_label(require__report_lookup_error_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(require_module4)
	...
	MR_init_label5(require__report_lookup_error_2_0,2,3,4,5,11)
MR_BEGIN_CODE
...
MR_def_label(require__report_lookup_error_2_0,5)
	...
	MR_np_call_localret_ent(fn__string__append_list_1_0,
		require__report_lookup_error_2_0_i11);
MR_def_label(require__report_lookup_error_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
