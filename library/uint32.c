...
uint32_t MR_CALL 
mercury__uint32__clamp_3_f_0(
  uint32_t Min_5,
  uint32_t Max_6,
  uint32_t N_7)
{
  MR_bool succeeded = (Max_6 >= Min_5);
  uint32_t HeadVar__4_4;
  ...
  else
  {
    ...
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint32_0), (MR_String) "function \140uint32.clamp\'/3", (MR_String) "Max < Min");
    HeadVar__4_4 = ((uint32_t) (MR_Word) conv0_HeadVar__4_4);
  }
  return HeadVar__4_4;
}
...
MR_Integer MR_CALL 
mercury__uint32__det_to_int_1_f_0(
  uint32_t U32_3)
{
  MR_bool succeeded;
  MR_Integer I_4;
...
{
#define MR_PROC_LABEL mercury__uint32__det_to_int_1_f_0
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
    ...
    mercury__require__error_2_p_0((MR_String) "function \140uint32.det_to_int\'/1", (MR_String) "cannot convert uint32 to int");
  return I_4;
}

MR_bool MR_CALL 
mercury__uint32__to_int_2_p_0(
  uint32_t U32_1,
  MR_Integer * I_2)
{
  MR_bool succeeded;
...
{
#define MR_PROC_LABEL mercury__uint32__to_int_2_p_0
...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
    ...
    mercury__require__error_2_p_0((MR_String) "function \140uint32.det_from_uint\'/1", (MR_String) "cannot convert uint to uint32");
  return U32_4;
}
