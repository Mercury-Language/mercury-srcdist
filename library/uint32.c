...
#undef MR_PROC_LABEL
    ...
    {
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "uint32.(>>): second operand is out of range")))));
    }
    return Result_6;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "uint32.rem: division by zero")))));
    }
    else
      Rem_6 = (X_4 % Y_5);
    return Rem_6;
