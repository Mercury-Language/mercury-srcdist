...
static /* final */ const struct mercury__library__vector_common_type_4_0_s mercury__library_vector_common_4[137];
...
static /* final */ const struct mercury__library__vector_common_type_5_0_s mercury__library_vector_common_5[137];
              ...
              case (MR_Integer) 46:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  ...
                  case (MR_Integer) 112:
                    ...
                    break;
                  case (MR_Integer) 115:
                    if (MR_offset_streq(4, HeadVar__1_1, (MR_String) "io.stream_db"))
