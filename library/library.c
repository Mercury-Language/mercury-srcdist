...
static /* final */ const struct mercury__library__vector_common_type_4_0_s mercury__library_vector_common_4[148];
...
static /* final */ const struct mercury__library__vector_common_type_5_0_s mercury__library_vector_common_5[148];
    ...
    switch (MR_nth_code_unit(HeadVar__1_1, 0)) {
      case (MR_Integer) 97:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 114:
            if (MR_offset_strn_eq(2, 3, HeadVar__1_1, (MR_String) "array"))
            ...
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              ...
              case (MR_Integer) 116:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  case (MR_Integer) 95:
                    if (MR_offset_strn_eq(4, 6, HeadVar__1_1, (MR_String) "bit_buffer"))
      ...
      case (MR_Integer) 101:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 100:
            if (MR_offset_strn_eq(2, 3, HeadVar__1_1, (MR_String) "edit_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 5)) {
                case (MR_Integer) 100:
                  if (MR_offset_streq(6, HeadVar__1_1, (MR_String) "edit_distance"))
                    case_num_0 = (MR_Integer) 23;
                  break;
                case (MR_Integer) 115:
                  if (MR_offset_streq(6, HeadVar__1_1, (MR_String) "edit_seq"))
      ...
      case (MR_Integer) 103:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 99:
            ...
            break;
          case (MR_Integer) 101:
            if (MR_offset_strn_eq(2, 4, HeadVar__1_1, (MR_String) "getopt"))
              ...
              case (MR_Integer) 46:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  ...
                  case (MR_Integer) 102:
                    ...
                    break;
                  case (MR_Integer) 112:
                    if (MR_offset_strn_eq(4, 10, HeadVar__1_1, (MR_String) "io.primitives_"))
                    ...
                    break;
                  case (MR_Integer) 115:
                    if (MR_offset_strn_eq(4, 6, HeadVar__1_1, (MR_String) "io.stream_"))
                      switch (MR_nth_code_unit(HeadVar__1_1, 10)) {
                        case (MR_Integer) 100:
      ...
      case (MR_Integer) 109:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            ...
            break;
          case (MR_Integer) 101:
            if (MR_offset_strn_eq(2, 11, HeadVar__1_1, (MR_String) "mercury_term_"))
      ...
      case (MR_Integer) 111:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 110:
            if (MR_offset_strn_eq(2, 9, HeadVar__1_1, (MR_String) "one_or_more"))
              switch (MR_nth_code_unit(HeadVar__1_1, 11)) {
                case (MR_Integer) 0:
          ...
          case (MR_Integer) 97:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              ...
              case (MR_Integer) 110:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  case (MR_Integer) 100:
                    if (MR_offset_strn_eq(4, 2, HeadVar__1_1, (MR_String) "random"))
                      switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                        case (MR_Integer) 0:
          ...
          case (MR_Integer) 116:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              ...
              case (MR_Integer) 114:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  case (MR_Integer) 101:
                    if (MR_offset_strn_eq(4, 2, HeadVar__1_1, (MR_String) "stream"))
                      switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                        case (MR_Integer) 0:
                    ...
                    break;
                  case (MR_Integer) 105:
                    if (MR_offset_strn_eq(4, 2, HeadVar__1_1, (MR_String) "string"))
                      switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                        case (MR_Integer) 0:
                        ...
                        case (MR_Integer) 46:
                          switch (MR_nth_code_unit(HeadVar__1_1, 7)) {
                            ...
                            case (MR_Integer) 102:
                              ...
                              break;
                            case (MR_Integer) 112:
                              if (MR_offset_strn_eq(8, 5, HeadVar__1_1, (MR_String) "string.parse_"))
                                switch (MR_nth_code_unit(HeadVar__1_1, 13)) {
                                  case (MR_Integer) 114:
      ...
      case (MR_Integer) 116:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            if (MR_offset_strn_eq(2, 4, HeadVar__1_1, (MR_String) "table_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                case (MR_Integer) 98:
          ...
          case (MR_Integer) 101:
                  ...
                  case (MR_Integer) 109:
                    switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
                      ...
                      case (MR_Integer) 95:
                        switch (MR_nth_code_unit(HeadVar__1_1, 5)) {
                          case (MR_Integer) 99:
                            if (MR_offset_strn_eq(6, 2, HeadVar__1_1, (MR_String) "term_con"))
                              switch (MR_nth_code_unit(HeadVar__1_1, 8)) {
                                case (MR_Integer) 116:
            ...
            break;
          case (MR_Integer) 104:
            if (MR_offset_strn_eq(2, 4, HeadVar__1_1, (MR_String) "thread"))
              switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                case (MR_Integer) 0:
          ...
          case (MR_Integer) 105:
            ...
            break;
          case (MR_Integer) 114:
            if (MR_offset_strn_eq(2, 2, HeadVar__1_1, (MR_String) "tree"))
              switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
                case (MR_Integer) 50:
      ...
      case (MR_Integer) 117:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 105:
            if (MR_offset_strn_eq(2, 2, HeadVar__1_1, (MR_String) "uint"))
              switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
                case (MR_Integer) 0:
      ...
      case (MR_Integer) 118:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            ...
            break;
          case (MR_Integer) 101:
            if (MR_offset_strn_eq(2, 6, HeadVar__1_1, (MR_String) "version_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 8)) {
                case (MR_Integer) 97:
                  if (MR_offset_strn_eq(9, 4, HeadVar__1_1, (MR_String) "version_array"))
                    switch (MR_nth_code_unit(HeadVar__1_1, 13)) {
                      case (MR_Integer) 0:
...
MR_String MR_CALL 
mercury__library__package_version_0_f_0(void)
{
  MR_String Package_1;

{
#define MR_PROC_LABEL mercury__library__package_version_0_f_0
...
mercury__library__version_2_p_0(
  MR_String * Version_3,
  MR_String * Fullarch_4)
{
  *Version_3 = mercury__library__mercury_version_0_f_0();
  *Fullarch_4 = mercury__library__architecture_0_f_0();
}

MR_String MR_CALL 
mercury__library__architecture_0_f_0(void)
{
  MR_String Fullarch_1;

{
#define MR_PROC_LABEL mercury__library__architecture_0_f_0
...
MR_String MR_CALL 
mercury__library__mercury_version_0_f_0(void)
{
  MR_String Version_1;

{
#define MR_PROC_LABEL mercury__library__mercury_version_0_f_0
