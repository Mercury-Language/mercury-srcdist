...
#undef MR_PROC_LABEL
    ...
    if (((MR_tag((MR_Word) mercury__parser__LeftTerm0_39)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        {
          mercury__parser__parse_rest_9_p_0(mercury__parser__TypeInfo_for_T_21, mercury__parser__TypeClassInfo_for_op_table_20, mercury__parser__V_14_14, (MR_Integer) 0, mercury__parser__LeftPriority_38, mercury__parser__LeftTerm_40, mercury__parser__Term_6, mercury__parser__STATE_VARIABLE_TokensLeft_22_43, mercury__parser__STATE_VARIABLE_TokensLeft_11, mercury__parser__STATE_VARIABLE_PS_23_44, mercury__parser__STATE_VARIABLE_PS_13);
        }
      }
  }
}
...
#undef MR_PROC_LABEL
	 mercury__parser__V_9_23  = LineNum;
}
                  {
                    ...
                    MR_hl_field(MR_mktag(3), mercury__parser__V_8_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
...
#undef MR_PROC_LABEL
	 mercury__parser__V_9_23  = LineNum;
          ...
          {
            mercury__parser__V_8_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), mercury__parser__V_8_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
