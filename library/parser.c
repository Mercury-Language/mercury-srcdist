...
MR_decl_label2(__Unify___parser__parse_1_0, 3,1)
MR_decl_label4(__Unify___parser__state_2_0, 2,4,6,1)
MR_decl_label7(__Compare___parser__parse_1_0, 5,3,53,11,12,15,50)
MR_decl_label7(__Compare___parser__state_2_0, 4,5,8,12,16,20,27)
...
MR_BEGIN_MODULE(parser_module32)
	...
	MR_init_label2(__Unify___parser__parse_1_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___parser__parse_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Unify___parser__parse_1_0_i3);
	}
	if (MR_PTAG_TESTR(MR_r3,0)) {
...
MR_def_label(__Unify___parser__parse_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parser_module33)
	...
	MR_init_label7(__Compare___parser__parse_1_0,5,3,53,11,12,15,50)
MR_BEGIN_CODE
...
MR_def_label(__Compare___parser__parse_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___parser__parse_1_0_i53);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___parser__parse_1_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
#undef	MR_PROC_LABEL
	...
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___parser__parse_1_0_i15);
	}
MR_def_label(__Compare___parser__parse_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___parser__parse_1_0_i12);
	}
	MR_r1 = (MR_Integer) 0;
	MR_GOTO_LAB(__Compare___parser__parse_1_0_i15);
MR_def_label(__Compare___parser__parse_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___parser__parse_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parser__parse_1_0_i50);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___parser__parse_1_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parser_module34)
	...
	MR_init_label4(__Unify___parser__state_2_0,2,4,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___parser__state_2_0);
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___parser__state_2_0_i2);
MR_def_label(__Unify___parser__state_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___parser__state_2_0_i1);
	}
...
MR_BEGIN_MODULE(parser_module35)
	...
	MR_init_label7(__Compare___parser__state_2_0,4,5,8,12,16,20,27)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i4);
	}
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_sv(10) = MR_r2;
	MR_GOTO_LAB(__Compare___parser__state_2_0_i8);
	}
MR_def_label(__Compare___parser__state_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i5);
	}
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_sv(10) = MR_r2;
	MR_GOTO_LAB(__Compare___parser__state_2_0_i8);
MR_def_label(__Compare___parser__state_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	MR_sv(10) = MR_r2;
MR_def_label(__Compare___parser__state_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i27);
	}
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(10);
	MR_r2 = MR_sv(1);
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___parser__state_2_0_i12);
MR_def_label(__Compare___parser__state_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___parser__state_2_0_i16);
MR_def_label(__Compare___parser__state_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___lexer__token_list_0_0,
		__Compare___parser__state_2_0_i20);
MR_def_label(__Compare___parser__state_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parser__state_2_0_i27);
	}
...
MR_def_label(__Compare___parser__state_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__parser__write_out_proc_statics(FILE *fp);
#endif
