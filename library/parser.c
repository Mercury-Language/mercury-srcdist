...
MR_decl_label10(parser__could_start_term_2_0, 13,14,15,16,17,18,19,41,20,21)
MR_decl_label1(parser__could_start_term_2_0, 22)
MR_decl_label2(parser__max_int_plus_1_2_0, 3,1)
...
MR_decl_label10(parser__parse_left_term_6_0, 4,10,14,15,17,13,12,19,6,7)
MR_decl_label10(parser__parse_left_term_6_0, 27,30,23,24,38,40,37,42,43,45)
MR_decl_label10(parser__parse_left_term_6_0, 47,49,48,51,50,52,54,55,57,58)
MR_decl_label10(parser__parse_left_term_6_0, 34,35,68,70,67,72,73,75,77,79)
MR_decl_label8(parser__parse_left_term_6_0, 80,82,83,64,65,88,2,93)
...
MR_decl_label2(parser__read_term_from_string_4_0, 3,4)
...
MR_decl_static(parser__max_int_plus_1_2_0)
...
MR_BEGIN_MODULE(parser_module4)
	...
	MR_init_label10(parser__could_start_term_2_0,13,14,15,16,17,18,19,41,20,21)
	MR_init_label1(parser__could_start_term_2_0,22)
MR_BEGIN_CODE
...
MR_def_label(parser__could_start_term_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
...
MR_def_label(parser__could_start_term_2_0,21)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(parser__could_start_term_2_0_i22);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(parser__could_start_term_2_0,22)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(parser__could_start_term_2_0_i41);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parser_module5)
	MR_init_entry1(parser__max_int_plus_1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parser__max_int_plus_1_2_0);
	MR_init_label2(parser__max_int_plus_1_2_0,3,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'max_int_plus_1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parser__max_int_plus_1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,32)) {
		MR_GOTO_LAB(parser__max_int_plus_1_2_0_i3);
	}
	MR_r1 = (strcmp((char *) (MR_Word *) MR_r2, MR_string_const("2147483648", 10)) == 0);
	MR_proceed();
MR_def_label(parser__max_int_plus_1_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,64)) {
		MR_GOTO_LAB(parser__max_int_plus_1_2_0_i1);
	}
	MR_r1 = (strcmp((char *) (MR_Word *) MR_r2, MR_string_const("9223372036854775808", 19)) == 0);
	MR_proceed();
MR_def_label(parser__max_int_plus_1_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parser_module11)
	...
	MR_init_label10(parser__parse_left_term_6_0,4,10,14,15,17,13,12,19,6,7)
	MR_init_label10(parser__parse_left_term_6_0,27,30,23,24,38,40,37,42,43,45)
	MR_init_label10(parser__parse_left_term_6_0,47,49,48,51,50,52,54,55,57,58)
	MR_init_label10(parser__parse_left_term_6_0,34,35,68,70,67,72,73,75,77,79)
	MR_init_label8(parser__parse_left_term_6_0,80,82,83,64,65,88,2,93)
MR_BEGIN_CODE
...
MR_def_label(parser__parse_left_term_6_0,10)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i13);
	}
	MR_sv(7) = MR_tfield(3, MR_r2, 1);
	MR_sv(11) = MR_r4;
	MR_np_call_localret_ent(fn__int__bits_per_int_0_0,
		parser__parse_left_term_6_0_i14);
MR_def_label(parser__parse_left_term_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(parser__max_int_plus_1_2_0,
		parser__parse_left_term_6_0_i15);
MR_def_label(parser__parse_left_term_6_0,15)
	...
	MR_np_call_localret_ent(fn__int__min_int_0_0,
		parser__parse_left_term_6_0_i17);
MR_def_label(parser__parse_left_term_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(11);
	MR_GOTO_LAB(parser__parse_left_term_6_0_i12);
MR_def_label(parser__parse_left_term_6_0,13)
	...
	MR_tempr1 = MR_r2;
	MR_r2 = MR_sv(9);
	MR_r3 = ((MR_Integer) 0 - (MR_Integer) MR_tfield(3, MR_tempr1, 1));
	MR_r1 = MR_r4;
	}
MR_def_label(parser__parse_left_term_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(9) = MR_r1;
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_116_101_114_109_95_99_111_110_116_101_120_116_95_95_91_49_44_32_50_93_95_48_3_0,
		parser__parse_left_term_6_0_i19);
MR_def_label(parser__parse_left_term_6_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(parser__parse_left_term_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i24);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_tfield(1, MR_r2, 0);
	...
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_97_114_115_101_114_95_103_101_116_95_116_111_107_101_110_95_99_111_110_116_101_120_116_95_95_91_49_44_32_50_93_95_49_4_1,
		parser__parse_left_term_6_0_i27);
MR_def_label(parser__parse_left_term_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(parser__parse_left_term_6_0,30)
	...
	* (MR_Float *) &(MR_tfield(3, MR_tempr1, 1)) = ((MR_Float) 0.0000000000000000 - MR_tempf3);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tfield(0, MR_tempr2, 2) = MR_r1;
...
MR_def_label(parser__parse_left_term_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i35);
	}
	...
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_97_114_115_101_114_95_112_101_101_107_95_116_111_107_101_110_95_95_91_49_44_32_50_93_95_48_3_0,
		parser__parse_left_term_6_0_i38);
...
MR_def_label(parser__parse_left_term_6_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i34);
	}
MR_def_label(parser__parse_left_term_6_0,37)
	...
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_111_112_115_95_116_97_98_108_101_95_95_91_49_93_95_48_2_0,
		parser__parse_left_term_6_0_i42);
...
MR_def_label(parser__parse_left_term_6_0,43)
	...
	MR_r1 = MR_sv(10);
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_97_114_115_101_114_95_112_101_101_107_95_116_111_107_101_110_95_95_91_49_44_32_50_93_95_48_3_0,
		parser__parse_left_term_6_0_i45);
MR_def_label(parser__parse_left_term_6_0,45)
	...
	MR_np_call_localret_ent(parser__could_start_term_2_0,
		parser__parse_left_term_6_0_i47);
...
MR_def_label(parser__parse_left_term_6_0,48)
	...
	MR_sv(1) = MR_sv(11);
	MR_sv(8) = ((MR_Integer) MR_sv(1) - (MR_Integer) 1);
...
MR_def_label(parser__parse_left_term_6_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i54);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(parser__parse_left_term_6_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(6);
...
MR_def_label(parser__parse_left_term_6_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i57);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(parser__parse_left_term_6_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i67);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_np_call_localret_ent(__Unify___lexer__token_0_0,
...
MR_def_label(parser__parse_left_term_6_0,72)
	...
	MR_np_call_localret_ent(ops__lookup_prefix_op_4_0,
		parser__parse_left_term_6_0_i73);
...
MR_def_label(parser__parse_left_term_6_0,77)
	...
	if (MR_INT_NE(MR_sv(5),0)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i79);
	}
	MR_r4 = MR_sv(6);
	MR_r5 = MR_sv(11);
	...
	MR_r1 = MR_sv(14);
	MR_np_call_localret_ent(parser__parse_term_2_5_0,
		parser__parse_left_term_6_0_i80);
MR_def_label(parser__parse_left_term_6_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(6);
	MR_r5 = MR_sv(11);
	MR_r3 = MR_sv(7);
	...
	MR_np_call_localret_ent(parser__parse_term_2_5_0,
		parser__parse_left_term_6_0_i80);
MR_def_label(parser__parse_left_term_6_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(parser__parse_left_term_6_0_i82);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(parser__parse_left_term_6_0,82)
	...
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_116_101_114_109_95_99_111_110_116_101_120_116_95_95_91_49_44_32_50_93_95_48_3_0,
		parser__parse_left_term_6_0_i83);
MR_def_label(parser__parse_left_term_6_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
...
MR_def_label(parser__parse_left_term_6_0,65)
	...
	MR_np_call_localret_ent(parser__parse_simple_term_6_0,
		parser__parse_left_term_6_0_i88);
MR_def_label(parser__parse_left_term_6_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(parser__parse_left_term_6_0,2)
	...
	MR_np_call_localret_ent(fn__f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_109_97_107_101_95_101_114_114_111_114_95_95_91_49_44_32_50_44_32_51_93_95_48_2_0,
		parser__parse_left_term_6_0_i93);
MR_def_label(parser__parse_left_term_6_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(parser__parse_rest_7_0,41)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,5,1);
...
MR_def_label(parser__parse_simple_term_2_6_0,26)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,5,2);
...
MR_def_label(parser__parse_simple_term_2_6_0,67)
	...
	MR_sv(4) = MR_tempr1;
	MR_tempr2 = MR_r3;
	* (MR_Float *) &MR_sv(7) = MR_float_from_dword_ptr(&MR_tfield(3, MR_tempr2, 1));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_r4;
	}
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_116_101_114_109_95_99_111_110_116_101_120_116_95_95_91_49_44_32_50_93_95_48_3_0,
...
MR_def_label(parser__parse_simple_term_2_6_0,73)
	...
	* (MR_Float *) &(MR_tfield(3, MR_tempr1, 1)) = MR_tempf3;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tfield(0, MR_tempr2, 2) = MR_r1;
...
MR_def_label(parser__check_for_higher_order_term_5_0,10)
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(0,5,3);
...
MR_def_label(parser__parse_list_2_4_0,8)
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,5,4);
	MR_tfield(0, MR_tempr1, 1) = MR_tempr2;
...
MR_def_label(parser__parse_list_2_4_0,16)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,5,5);
	...
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(0,5,4);
	MR_tfield(0, MR_tempr2, 1) = MR_tempr3;
	MR_tfield(0, MR_tempr2, 2) = MR_r1;
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_tempr2;
...
MR_define_entry(mercury__parser__init_parser_state_4_0);
	...
	MR_tfield(0, MR_r1, 2) = (MR_Word) MR_TAG_COMMON(0,6,0);
...
MR_def_label(parser__parse_tokens_with_op_table_4_0,18)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Word) MR_TAG_COMMON(0,6,0);
	MR_tempr2 = MR_r5;
...
MR_BEGIN_MODULE(parser_module30)
	...
	MR_init_label2(parser__read_term_from_string_4_0,3,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parser_module50)
...
void mercury__parser__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parser);
