    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MR_Word Var_29;
          MR_Word Var_30 = (MR_Word) &mercury__parser_scalar_common_5[3];
          MR_Word Var_32;
          MR_Word Var_33;
      ...
      else
      {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              *STATE_VARIABLE_TokensLeft_22 = STATE_VARIABLE_TokensLeft_37_37;
              Var_40 = (MR_Word) &mercury__parser_scalar_common_5[3];
        ...
        else
        {
          ...
          if (succeeded)
          {
            MR_Word Var_47 = (MR_Word) &mercury__parser_scalar_common_5[4];
            ...
            Var_51 = (MR_Word) &mercury__parser_scalar_common_5[3];
...
#undef MR_PROC_LABEL
	 TypeInfo_36_36  = TypeInfo;
      ...
      else
      {
        ...
        MR_Word Var_26 = (MR_Word) &mercury__parser_scalar_common_5[2];
        MR_Word Var_28;
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_66 = (MR_Word) &mercury__parser_scalar_common_5[1];
                    {
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_LeftPriority_12 = OpPriority_24;
            MR_Word next_value_of_LeftTerm_13 = OpTerm_37;
            MR_Word next_value_of_STATE_VARIABLE_TokensLeft_0_41 = STATE_VARIABLE_TokensLeft_51_51;
            MR_Word next_value_of_STATE_VARIABLE_PS_0_43 = STATE_VARIABLE_PS_52_52;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_LeftPriority_12 = OpPriority_78;
            MR_Word next_value_of_LeftTerm_13 = OpTerm_75;
            MR_Word next_value_of_STATE_VARIABLE_TokensLeft_0_41 = STATE_VARIABLE_TokensLeft_64_64;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_OpInfo_6 = HeadOpInfo_15;
            MR_Word next_value_of_OtherOpInfos_7 = TailOpInfos_16;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_OpInfo_5 = HeadOpInfo_12;
            MR_Word next_value_of_OtherOpInfos_6 = TailOpInfos_13;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_MaybeQualifier0_10 = MaybeQualifier01_22;
          MR_Word next_value_of_OpCtxt0_12 = OpCtxt1_26;
          MR_String next_value_of_OpName0_13 = OpName1_19;
          MR_Word next_value_of_STATE_VARIABLE_TokensLeft_0_27 = STATE_VARIABLE_TokensLeft_33_33;
