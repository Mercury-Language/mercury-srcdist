...
{
  {
    ...
    if (mercury__parser__succeeded)
      *mercury__parser__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mercury__parser__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 0)));
        MR_String mercury__parser__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__3_3, (MR_Integer) 0)));
        MR_Box mercury__parser__ArgX2_6 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 1));
        MR_Box mercury__parser__ArgY2_7 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__3_3, (MR_Integer) 1));
        MR_Word mercury__parser__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mercury__parser__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mercury__parser__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 3)));
        MR_Word mercury__parser__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__3_3, (MR_Integer) 3)));
...
#define MR_PROC_LABEL mercury__parser____Compare____parser_state_2_0
	...
	S1 =  mercury__parser__ArgX1_4 ;
	S2 =  mercury__parser__ArgY1_5 ;
		{
        ...
        if (mercury__parser__succeeded)
          *mercury__parser__HeadVar__1_1 = mercury__parser__Var_12;
        else
          {
            ...
            {
              mercury__builtin__compare_3_p_0(mercury__parser__TypeInfo_for_Ops_17, &mercury__parser__Var_13, mercury__parser__ArgX2_6, mercury__parser__ArgY2_7);
            }
            ...
            if (mercury__parser__succeeded)
              *mercury__parser__HeadVar__1_1 = mercury__parser__Var_13;
            else
              {
                ...
                {
                  mercury__varset____Compare____varset_1_0(mercury__parser__TypeInfo_for_T_18, &mercury__parser__Var_14, mercury__parser__ArgX3_8, mercury__parser__ArgY3_9);
                }
                ...
                if (mercury__parser__succeeded)
                  *mercury__parser__HeadVar__1_1 = mercury__parser__Var_14;
                else
                  {
                    ...
                    {
                      mercury__tree234____Compare____tree234_2_0(mercury__parser__TypeCtorInfo_22_22, mercury__parser__TypeInfo_24_24, mercury__parser__HeadVar__1_1, (MR_Word) mercury__parser__ArgX4_10, (MR_Word) mercury__parser__ArgY4_11);
                    }
                  }
              }
          }
...
{
  {
    ...
    if (mercury__parser__succeeded)
    ...
    else
      {
        ...
        MR_String mercury__parser__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mercury__parser__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 0)));
        MR_Box mercury__parser__ArgX2_5 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__1_1, (MR_Integer) 1));
        MR_Box mercury__parser__ArgY2_6 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 1));
        MR_Word mercury__parser__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mercury__parser__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mercury__parser__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__1_1, (MR_Integer) 3)));
        MR_Word mercury__parser__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 3)));

        mercury__parser__succeeded = (strcmp(mercury__parser__ArgX1_3, mercury__parser__ArgY1_4) == 0);
        if (mercury__parser__succeeded)
          {
            {
              mercury__parser__succeeded = mercury__builtin__unify_2_p_0(mercury__parser__TypeInfo_for_Ops_13, mercury__parser__ArgX2_5, mercury__parser__ArgY2_6);
            }
            if (mercury__parser__succeeded)
              {
                {
                  mercury__parser__succeeded = mercury__varset____Unify____varset_1_0(mercury__parser__TypeInfo_for_T_14, mercury__parser__ArgX3_7, mercury__parser__ArgY3_8);
                }
                if (mercury__parser__succeeded)
                  {
                    ...
                    {
                      mercury__parser__succeeded = mercury__tree234____Unify____tree234_2_0(mercury__parser__TypeCtorInfo_17_17, mercury__parser__TypeInfo_19_19, (MR_Word) mercury__parser__ArgX4_9, (MR_Word) mercury__parser__ArgY4_10);
                    }
                  }
              }
          }
    ...
    if (((MR_tag((MR_Word) mercury__parser__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (((MR_tag((MR_Word) mercury__parser__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_String mercury__parser__ArgY1_13 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__3_3, (MR_Integer) 0)));
            MR_Word mercury__parser__ArgY2_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__3_3, (MR_Integer) 1)));
	 ...
	 mercury__parser__V_7_28  = Res;
            ...
            if (mercury__parser__succeeded)
              *mercury__parser__HeadVar__1_1 = mercury__parser__Var_16;
              ...
              {
                mercury__lexer____Compare____token_list_0_0(mercury__parser__HeadVar__1_1, mercury__parser__Var_22, mercury__parser__ArgY2_15);
              }
          }
        else
          *mercury__parser__HeadVar__1_1 = (MR_Integer) 2;
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) mercury__parser__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
          *mercury__parser__HeadVar__1_1 = (MR_Integer) 1;
          ...
          {
            MR_Box mercury__parser__ArgY1_5 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__3_3, (MR_Integer) 0));

            {
              mercury__builtin__compare_3_p_0(mercury__parser__TypeInfo_for_T_19, mercury__parser__HeadVar__1_1, mercury__parser__Var_24, mercury__parser__ArgY1_5);
            }
          }
      }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mercury__parser__HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String mercury__parser__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__1_1, (MR_Integer) 0)));
        MR_String mercury__parser__ArgY1_6;
        MR_Word mercury__parser__ArgX2_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mercury__parser__ArgY2_8;

        mercury__parser__succeeded = ((MR_tag((MR_Word) mercury__parser__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mercury__parser__succeeded)
          {
            mercury__parser__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__2_2, (MR_Integer) 0)));
            mercury__parser__ArgY2_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), mercury__parser__HeadVar__2_2, (MR_Integer) 1)));
            mercury__parser__succeeded = (strcmp(mercury__parser__ArgX1_5, mercury__parser__ArgY1_6) == 0);
            if (mercury__parser__succeeded)
              {
                mercury__parser__succeeded = mercury__lexer____Unify____token_list_0_0(mercury__parser__ArgX2_7, mercury__parser__ArgY2_8);
              }
          }
      }
    else
      {
        MR_Box mercury__parser__ArgX1_3 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__1_1, (MR_Integer) 0));
        MR_Box mercury__parser__ArgY1_4;

        mercury__parser__succeeded = ((MR_tag((MR_Word) mercury__parser__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (mercury__parser__succeeded)
          {
            mercury__parser__ArgY1_4 = (MR_hl_field(MR_mktag(0), mercury__parser__HeadVar__2_2, (MR_Integer) 0));
            {
              mercury__parser__succeeded = mercury__builtin__unify_2_p_0(mercury__parser__TypeInfo_for_T_11, mercury__parser__ArgX1_3, mercury__parser__ArgY1_4);
            }
          }
      }
    return mercury__parser__succeeded;
...
{
  {
    MR_Word mercury__parser__VarSet_7 = (MR_Word) &mercury__parser_scalar_common_2[1];
...
#undef MR_PROC_LABEL
    ...
    mercury__parser__StartPos_12 = (MR_Word) &mercury__parser_scalar_common_2[2];
    {
...
#undef MR_PROC_LABEL
    ...
    mercury__parser__StartPos_18 = (MR_Word) &mercury__parser_scalar_common_2[2];
    {
          ...
          case (MR_Integer) 0:
            {
              ...
              if ((((MR_Unsigned) (mercury__parser__V_13_38 - (MR_Integer) 9)) <= ((MR_Unsigned) (MR_Integer) 117)))
                if ((((mercury__parser_scalar_common_9[0])[(((mercury__parser__V_13_38 - (MR_Integer) 9)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((mercury__parser__V_13_38 - (MR_Integer) 9)) & (MR_Integer) 31))))))
                  {
                    mercury__parser__V_15_41 = ((&mercury__parser_vector_common_8[0 + (mercury__parser__V_13_38 - (MR_Integer) 9)]))->mercury__parser__vector_common_type_8_0__vct_8_f_0;
                    mercury__parser__succeeded = MR_TRUE;
                  }
                else
  ...
  if ((mercury__parser__Tokens_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    *mercury__parser__Result_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  else
    {
      ...
      MR_Word mercury__parser__VarSet_24 = (MR_Word) &mercury__parser_scalar_common_2[1];
            ...
            if (((MR_tag((MR_Word) mercury__parser__Tail0_14)) == (MR_mktag((MR_Integer) 1))))
              *mercury__parser__List_8 = mercury__parser__Tail0_14;
            else
              {
                ...
                MR_Word mercury__parser__Var_29;
                MR_Word mercury__parser__Var_30 = (MR_Word) &mercury__parser_scalar_common_5[3];
        ...
        else
          {
            ...
            if (mercury__parser__succeeded)
                    ...
                    if (mercury__parser__succeeded)
                      {
                        ...
                        *mercury__parser__STATE_VARIABLE_TokensLeft_22 = mercury__parser__STATE_VARIABLE_TokensLeft_37_37;
                        mercury__parser__Var_40 = (MR_Word) &mercury__parser_scalar_common_5[3];
            ...
            else
              {
                ...
                if (mercury__parser__succeeded)
                  {
                    MR_Word mercury__parser__Var_47 = (MR_Word) &mercury__parser_scalar_common_5[4];
                    ...
                    mercury__parser__Var_51 = (MR_Word) &mercury__parser_scalar_common_5[3];
	 ...
	 mercury__parser__TypeInfo_36_36  = TypeInfo;
        ...
        if (((MR_tag((MR_Word) mercury__parser__ArgsParse_14)) == (MR_mktag((MR_Integer) 1))))
        ...
        else
          {
            ...
            MR_Word mercury__parser__Var_26 = (MR_Word) &mercury__parser_scalar_common_5[2];
            MR_Word mercury__parser__Var_28;
                      ...
                      if (mercury__parser__succeeded)
                        {
                          ...
                          mercury__parser__Var_66 = (MR_Word) &mercury__parser_scalar_common_5[1];
                          {
            ...
            else
              {
                ...
                if ((mercury__parser__MaybeQualifier_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    MR_Word mercury__parser__Var_57 = (MR_Word) &mercury__parser_scalar_common_5[0];
...
{
  {
    MR_Word mercury__parser__HeadVar__2_2 = ((&mercury__parser_vector_common_7[0 + mercury__parser__HeadVar__1_1]))->mercury__parser__vector_common_type_7_0__vct_7_f_0;
...
{
  {
    MR_Word mercury__parser__HeadVar__2_2 = ((&mercury__parser_vector_common_6[0 + mercury__parser__HeadVar__1_1]))->mercury__parser__vector_common_type_6_0__vct_6_f_0;
        ...
        if (mercury__parser__succeeded)
          {
            ...
            if ((mercury__parser__MaybeQualifier0_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                mercury__parser__Var_37 = (MR_Word) &mercury__parser_scalar_common_5[0];
