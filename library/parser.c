...
MR_decl_label10(parser__parse_rest_7_0, 198,3,6,8,5,15,16,18,21,12)
MR_decl_label10(parser__parse_rest_7_0, 13,23,24,26,27,30,29,31,34,39)
MR_decl_label9(parser__parse_rest_7_0, 42,2,49,52,53,55,57,48,202)
MR_decl_label2(parser__parse_simple_term_6_0, 4,2)
MR_decl_label10(parser__parse_simple_term_2_6_0, 205,4,6,8,7,3,12,16,18,17)
MR_decl_label10(parser__parse_simple_term_2_6_0, 21,23,24,26,25,15,35,37,36,34)
MR_decl_label10(parser__parse_simple_term_2_6_0, 43,45,47,105,49,44,53,56,58,126)
...
MR_BEGIN_MODULE(parser_module11)
	...
	MR_init_label10(parser__parse_rest_7_0,198,3,6,8,5,15,16,18,21,12)
	MR_init_label10(parser__parse_rest_7_0,13,23,24,26,27,30,29,31,34,39)
	MR_init_label9(parser__parse_rest_7_0,42,2,49,52,53,55,57,48,202)
MR_BEGIN_CODE
...
MR_def_label(parser__parse_rest_7_0,198)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
...
MR_def_label(parser__parse_rest_7_0,21)
	...
	MR_r1 = MR_sv(7);
	MR_sv(7) = MR_r4;
	MR_GOTO_LAB(parser__parse_rest_7_0_i26);
...
MR_def_label(parser__parse_rest_7_0,27)
	...
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(parser__parse_rest_7_0_i30);
	}
	MR_r4 = MR_sv(2);
	MR_r3 = ((MR_Integer) MR_sv(6) - (MR_Integer) 1);
	MR_r5 = MR_sv(7);
...
MR_def_label(parser__parse_rest_7_0,29)
	...
	MR_sv(14) = MR_r1;
	MR_np_call_localret_ent(parser__parse_term_2_5_0,
		parser__parse_rest_7_0_i31);
MR_def_label(parser__parse_rest_7_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(parser__parse_rest_7_0_i202);
	}
	MR_sv(3) = MR_tfield(0, MR_r1, 0);
	{
	MR_Word MR_tempr1;
...
MR_def_label(parser__parse_rest_7_0,34)
	...
	MR_np_call_localret_ent(fn__list__append_2_0,
		parser__parse_rest_7_0_i39);
MR_def_label(parser__parse_rest_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_GOTO_LAB(parser__parse_rest_7_0_i198);
	}
...
MR_def_label(parser__parse_rest_7_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parser__parse_rest_7_0_i48);
	}
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(parser__parse_rest_7_0_i48);
	}
...
MR_def_label(parser__parse_rest_7_0,52)
	...
	MR_np_call_localret_ent(ops__lookup_postfix_op_4_0,
		parser__parse_rest_7_0_i53);
MR_def_label(parser__parse_rest_7_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parser__parse_rest_7_0_i48);
	}
...
MR_def_label(parser__parse_rest_7_0,55)
	...
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(f_112_97_114_115_101_114_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_116_101_114_109_95_99_111_110_116_101_120_116_95_95_91_49_44_32_50_93_95_48_3_0,
		parser__parse_rest_7_0_i57);
MR_def_label(parser__parse_rest_7_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
...
MR_def_label(parser__parse_rest_7_0,48)
	...
	MR_r2 = MR_sv(12);
MR_def_label(parser__parse_rest_7_0,202)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parser_module13)
	...
	MR_init_label10(parser__parse_simple_term_2_6_0,205,4,6,8,7,3,12,16,18,17)
	MR_init_label10(parser__parse_simple_term_2_6_0,21,23,24,26,25,15,35,37,36,34)
	MR_init_label10(parser__parse_simple_term_2_6_0,43,45,47,105,49,44,53,56,58,126)
...
MR_def_label(parser__parse_simple_term_2_6_0,205)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(parser__parse_simple_term_2_6_0,3)
	...
	MR_GOTO_LAB(parser__parse_simple_term_2_6_0_i205);
...
MR_def_label(parser__parse_simple_term_2_6_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parser__parse_simple_term_2_6_0_i126);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(5);
...
MR_def_label(parser__parse_simple_term_2_6_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
