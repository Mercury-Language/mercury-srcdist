  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__multi_map__add_4_p_0(TypeInfo_for_K_30, TypeInfo_for_V_31, Var_33, Value_24, STATE_VARIABLE_MultiMap_0_3, &STATE_VARIABLE_MultiMap_29_29);
        // direct tailcall eliminated
        ;
  ...
  MR_Word * STATE_VARIABLE_MultiMap_9)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__tree234__update_4_p_0(TypeInfo_for_K_12, TypeInfo_15_17, Key_5, ((MR_Box) (Values_15)), (MR_Word) (STATE_VARIABLE_MultiMap_0_8), &conv1_STATE_VARIABLE_MultiMap_10_10);
    if (succeeded)
    {
