...
MR_decl_label8(multi_map__assoc_list_merge_3_0, 3,34,6,9,10,8,12,11)
MR_decl_label1(multi_map__assoc_list_merge_3_0, 13)
...
MR_BEGIN_MODULE(multi_map_module53)
	...
	MR_init_label8(multi_map__assoc_list_merge_3_0,3,34,6,9,10,8,12,11)
	MR_init_label1(multi_map__assoc_list_merge_3_0,13)
MR_BEGIN_CODE
...
MR_def_label(multi_map__assoc_list_merge_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(multi_map__assoc_list_merge_3_0_i34);
	}
	MR_r1 = MR_r3;
	MR_proceed();
MR_def_label(multi_map__assoc_list_merge_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
