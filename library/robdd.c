...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    Var_69 = (MR_Box) (Stream_11);
    mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_69);
{
#define MR_PROC_LABEL mercury__robdd__robdd_to_dot_5_p_0
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(Var_71, (MR_String) "error closing file: ");
  }
}
