    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        Var_70 = (MR_Word) (Trues_9);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (Var_38));
          MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_70));
        }
        ...
        Var_72 = (MR_Word) (Falses_10);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (Var_42));
          MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_72));
        }
