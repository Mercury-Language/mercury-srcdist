  ...
  MR_Word LambdaHeadVar__1_24)
{
  ...
  succeeded = mercury__set_unordlist__member_2_p_0(TypeInfo_50_50, ((MR_Box) (LambdaHeadVar__1_24)), (MR_Word) (Trues_9));
  if (succeeded)
    C_15 = (MR_Char) 32;
  else
    C_15 = (MR_Char) 126;
  ...
  mercury__string__format__format_impl_3_p_0((MR_String) " %c%02d", Var_28, &Var_51);
