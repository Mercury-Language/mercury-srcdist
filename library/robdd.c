...
#undef MR_PROC_LABEL
	 V_6_85  = Msg;
      ...
      {
        {
          mercury__exception__throw_1_p_0((MR_Word) (&mercury__io__io__type_ctor_info_error_0), ((MR_Box) (V_8_81)));
          return;
        }
      }
      else
...
#undef MR_PROC_LABEL
	 Var_7  = N;
        ...
        mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__robdd_scalar_common_5[3]), V_7_31, V_8_32, Var_7, &Var_12);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        TypeInfo_34_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeInfo_34_34, 0) = ((MR_Box) (&mercury__term__term__type_ctor_info_var_1));
