  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_23 = mercury__robdd__node_name_1_f_0(Var_18, Var_9);
      {
        Var_22 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_22, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      ...
      mercury__string__format__format_impl_3_p_0((MR_String) "%s; ", Var_21, &Var_25);
      mercury__io__write_string_4_p_0(Var_19, Var_25);
      // direct tailcall eliminated
      ;
