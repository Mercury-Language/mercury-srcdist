  ...
  MR_Unsigned * Cost_10)
{
  ...
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_54, SeqA_7, (MR_Unsigned) 0U, &Var_65);
{
...
#undef MR_PROC_LABEL
  ...
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_54, SeqB_8, (MR_Unsigned) 0U, &Var_67);
{
#define MR_PROC_LABEL mercury__edit_distance__find_edit_distance_ceiling_5_p_0
