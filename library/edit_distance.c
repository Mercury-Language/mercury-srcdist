  ...
  MR_Unsigned * Cost_10)
{
  ...
  DeleteCost_20 = ((MR_Unsigned) ((MR_hl_field(0, Params_6, (MR_Integer) 0))));
  InsertCost_19 = ((MR_Unsigned) ((MR_hl_field(0, Params_6, (MR_Integer) 1))));
  ...
  MR_ArrayPtr * FinalRow_22)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Unsigned InsertCost_26 = ((MR_Unsigned) ((MR_hl_field(0, Params_12, (MR_Integer) 1))));
      ...
      if (succeeded)
      {
        Ceiling_34 = ((MR_Unsigned) ((MR_hl_field(1, MaybeCeiling_17, (MR_Integer) 0))));
  ...
  MR_Unsigned * STATE_VARIABLE_MinCostInRow_51)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_55;
      MR_Integer Var_109;
      MR_ArrayPtr STATE_VARIABLE_RowNext_110_110;
      MR_Unsigned STATE_VARIABLE_MinCostInRow_111_111;
      MR_Unsigned Var_112;
      MR_Box conv0_DiagCost_28;
      MR_ArrayPtr conv6_STATE_VARIABLE_RowNext_110_110;
      ...
      {
        MR_Word ReplacementCostFunc_35 = ((MR_Word) ((MR_hl_field(0, Params_16, (MR_Integer) 2))));
        ...
        MR_Unsigned Var_67;
        MR_Unsigned Var_68;
        MR_Box MR_CALL (* func_1)(MR_Box, MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(0, ReplacementCostFunc_35, (MR_Integer) 1))));
        MR_Box conv2_Var_63;
        ...
        Var_65 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, (MR_Integer) 0))));
        ...
        Var_67 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, (MR_Integer) 1))));
        ...
        if (succeeded)
        {
          ...
          Var_80 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, (MR_Integer) 3))));
      ...
      mercury__array__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), Var_109, ((MR_Box) (MinCost_32)), (MR_ArrayPtr) (STATE_VARIABLE_RowNext_0_48), &conv6_STATE_VARIABLE_RowNext_110_110);
      STATE_VARIABLE_RowNext_110_110 = (MR_ArrayPtr) (conv6_STATE_VARIABLE_RowNext_110_110);
      succeeded = (MinCost_32 < STATE_VARIABLE_MinCostInRow_0_50);
      if (succeeded)
        STATE_VARIABLE_MinCostInRow_111_111 = MinCost_32;
      else
        STATE_VARIABLE_MinCostInRow_111_111 = STATE_VARIABLE_MinCostInRow_0_50;
      Var_112 = (J_22 + (MR_Unsigned) 1U);
      // direct tailcall eliminated
      ;
      next_value_of_J_22 = Var_112;
      next_value_of_STATE_VARIABLE_RowNext_0_48 = STATE_VARIABLE_RowNext_110_110;
      next_value_of_STATE_VARIABLE_MinCostInRow_0_50 = STATE_VARIABLE_MinCostInRow_111_111;
