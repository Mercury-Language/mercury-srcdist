  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Var_30, 1) = ((MR_Box) (Var_31));
      }
      {
  ...
  MR_Word * RestTargetSeqs_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      mercury__edit_distance__find_edit_distance_up_to_ceiling_5_p_0(TypeInfo_for_T_18, Params_8, SourceSeq_9, HeadTargetSeq_10, Var_17, &HeadCost_16);
  ...
  MR_Word * TailBestSeqs_12)
{
  ...
  else
  {
    ...
    mercury__edit_distance__find_edit_distance_up_to_ceiling_5_p_0(TypeInfo_for_T_23, Params_7, SourceSeq_8, HeadTargetSeq_13, (MR_Word) ((MR_Unsigned) 0U), &HeadCost_15);
    {
  ...
  MR_Word * STATE_VARIABLE_CostSeqCord_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__edit_distance__find_edit_distance_up_to_ceiling_5_p_0(TypeInfo_for_T_33, Params_1, SourceSeq_2, HeadTargetSeq_18, Var_27, &HeadCost_22);
...
mercury__edit_distance__find_edit_distance_4_p_0(
  ...
  MR_Unsigned * Cost_8)
{
  mercury__edit_distance__find_edit_distance_up_to_ceiling_5_p_0(TypeInfo_for_T_10, Params_5, SeqA_6, SeqB_7, (MR_Word) ((MR_Unsigned) 0U), Cost_8);
}

void MR_CALL 
mercury__edit_distance__find_edit_distance_up_to_ceiling_5_p_0(
  ...
  MR_Unsigned * Cost_10)
{
  ...
  MR_Unsigned LenA_13;
  MR_Unsigned LenB_14;
  MR_Unsigned InsertCost_15;
  MR_Unsigned DeleteCost_16;

  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_49, SeqA_7, (MR_Unsigned) 0U, &LenA_13);
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_49, SeqB_8, (MR_Unsigned) 0U, &LenB_14);
  DeleteCost_16 = ((MR_Unsigned) ((MR_hl_field(0, Params_6, 0))));
  InsertCost_15 = ((MR_Unsigned) ((MR_hl_field(0, Params_6, 1))));
  succeeded = (LenA_13 == (MR_Unsigned) 0U);
  if (succeeded)
    *Cost_10 = (LenB_14 * InsertCost_15);
  else
  {
    succeeded = (LenB_14 == (MR_Unsigned) 0U);
    if (succeeded)
      *Cost_10 = (LenA_13 * DeleteCost_16);
    else
    {
      MR_ArrayPtr ItemMapA_17;
      MR_ArrayPtr ItemMapB_18;
      MR_ArrayPtr RowTwoAgo_19;
      MR_Word RowOneAgoList_20;
      MR_ArrayPtr RowOneAgo_21;
      MR_ArrayPtr RowSpare_22;
      MR_ArrayPtr FinalRow_23;
      MR_Unsigned Var_35;
      MR_Unsigned Var_39;
      MR_ArrayPtr conv0_RowTwoAgo_19;
      MR_ArrayPtr conv1_RowOneAgo_21;
      MR_ArrayPtr conv2_RowSpare_22;
      MR_Box conv3_Cost_10;

      mercury__array__from_list_2_p_0(TypeInfo_for_T_49, SeqA_7, &ItemMapA_17);
      mercury__array__from_list_2_p_0(TypeInfo_for_T_49, SeqB_8, &ItemMapB_18);
      Var_35 = (LenA_13 + (MR_Unsigned) 1U);
      mercury__array__uinit_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), Var_35, ((MR_Box) ((MR_Unsigned) 0U)), &conv0_RowTwoAgo_19);
      RowTwoAgo_19 = (MR_ArrayPtr) (conv0_RowTwoAgo_19);
      mercury__edit_distance__init_delete_cost_row_4_p_0(DeleteCost_16, (MR_Unsigned) 0U, LenA_13, &RowOneAgoList_20);
      mercury__array__from_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), RowOneAgoList_20, &conv1_RowOneAgo_21);
      RowOneAgo_21 = (MR_ArrayPtr) (conv1_RowOneAgo_21);
      Var_39 = (LenA_13 + (MR_Unsigned) 1U);
      mercury__array__uinit_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), Var_39, ((MR_Box) ((MR_Unsigned) 0U)), &conv2_RowSpare_22);
      RowSpare_22 = (MR_ArrayPtr) (conv2_RowSpare_22);
      mercury__edit_distance__build_rows_11_p_0(TypeInfo_for_T_49, Params_6, LenA_13, LenB_14, ItemMapA_17, ItemMapB_18, MaybeCeiling_9, (MR_Unsigned) 0U, RowTwoAgo_19, RowOneAgo_21, RowSpare_22, &FinalRow_23);
      mercury__array__ulookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_ArrayPtr) (FinalRow_23), LenA_13, &conv3_Cost_10);
  ...
  MR_Unsigned * STATE_VARIABLE_MinCostInRow_51)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_ArrayPtr STATE_VARIABLE_RowNext_1_101;
      MR_Unsigned STATE_VARIABLE_MinCostInRow_1_102;
      MR_Unsigned Var_103;
      MR_Box conv0_DiagCost_28;
      MR_ArrayPtr conv6_STATE_VARIABLE_RowNext_1_101;
      ...
      mercury__array__ulookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_ArrayPtr) (STATE_VARIABLE_RowOneAgo_0_46), J_22, &conv0_DiagCost_28);
      DiagCost_28 = ((MR_Unsigned) (conv0_DiagCost_28));
      mercury__array__ulookup_3_p_0(TypeInfo_for_T_128, ItemMapA_19, J_22, &CurAJ_30);
      mercury__array__ulookup_3_p_0(TypeInfo_for_T_128, ItemMapB_20, RowNum_21, &CurBI_31);
      ...
      else
      {
        ...
        conv2_Var_60 = func_1(((MR_Box) (ReplacementCostFunc_35)), CurAJ_30, CurBI_31);
        Var_60 = ((MR_Unsigned) (conv2_Var_60));
        ReplacementCost_36 = (DiagCost_28 + Var_60);
        mercury__array__ulookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_ArrayPtr) (STATE_VARIABLE_RowNext_0_48), J_22, &conv3_LeftCost_37);
        LeftCost_37 = ((MR_Unsigned) (conv3_LeftCost_37));
        Var_61 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, 0))));
        DeleteCost_38 = (LeftCost_37 + Var_61);
        mercury__array__ulookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_ArrayPtr) (STATE_VARIABLE_RowOneAgo_0_46), ColNum_27, &conv4_UpCost_39);
        UpCost_39 = ((MR_Unsigned) (conv4_UpCost_39));
        Var_62 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, 1))));
        InsertCost_40 = (UpCost_39 + Var_62);
        Var_63 = mercury__uint__min_2_f_0(DeleteCost_38, ReplacementCost_36);
        MinCost0_41 = mercury__uint__min_2_f_0(InsertCost_40, Var_63);
        succeeded = (RowNum_21 > (MR_Unsigned) 0U);
        if (succeeded)
        {
          Var_65 = (MR_Unsigned) 0U;
          succeeded = (J_22 > Var_65);
          if (succeeded)
          {
            Var_67 = (MR_Unsigned) 1U;
            Var_66 = (RowNum_21 - Var_67);
            mercury__array__ulookup_3_p_0(TypeInfo_for_T_128, ItemMapB_20, Var_66, &Var_130);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_for_T_128, CurAJ_30, Var_130);
            if (succeeded)
            {
              Var_69 = (MR_Unsigned) 1U;
              Var_68 = (J_22 - Var_69);
              mercury__array__ulookup_3_p_0(TypeInfo_for_T_128, ItemMapA_19, Var_68, &Var_131);
        ...
        if (succeeded)
        {
          ...
          MR_Unsigned Var_70 = (J_22 - (MR_Unsigned) 1U);
          MR_Unsigned Var_72;
          MR_Box conv5_TransDiagCost_42;

          mercury__array__ulookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), (MR_ArrayPtr) (STATE_VARIABLE_RowTwoAgo_0_44), Var_70, &conv5_TransDiagCost_42);
          TransDiagCost_42 = ((MR_Unsigned) (conv5_TransDiagCost_42));
          Var_72 = ((MR_Unsigned) ((MR_hl_field(0, Params_16, 3))));
          TransposeCost_43 = (TransDiagCost_42 + Var_72);
          MinCost_32 = mercury__uint__min_2_f_0(MinCost0_41, TransposeCost_43);
        }
        else
          MinCost_32 = MinCost0_41;
      }
      mercury__array__uset_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_uint_0), ColNum_27, ((MR_Box) (MinCost_32)), (MR_ArrayPtr) (STATE_VARIABLE_RowNext_0_48), &conv6_STATE_VARIABLE_RowNext_1_101);
      STATE_VARIABLE_RowNext_1_101 = (MR_ArrayPtr) (conv6_STATE_VARIABLE_RowNext_1_101);
      succeeded = (MinCost_32 < STATE_VARIABLE_MinCostInRow_0_50);
      if (succeeded)
        STATE_VARIABLE_MinCostInRow_1_102 = MinCost_32;
      else
        STATE_VARIABLE_MinCostInRow_1_102 = STATE_VARIABLE_MinCostInRow_0_50;
      Var_103 = (J_22 + (MR_Unsigned) 1U);
      // direct tailcall eliminated
      ;
      next_value_of_J_22 = Var_103;
      next_value_of_STATE_VARIABLE_RowNext_0_48 = STATE_VARIABLE_RowNext_1_101;
      next_value_of_STATE_VARIABLE_MinCostInRow_0_50 = STATE_VARIABLE_MinCostInRow_1_102;
