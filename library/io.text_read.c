...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(Var_59, (MR_String) "error getting file offset: ");
  ...
  MR_Word * Chars_10)
{
  ...
  mercury__io__primitives_read__read_char_code_2_6_p_0(Var_26, &Result0_12, &Error0_13, &Char_14);
  switch (Result0_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
    case (MR_Integer) 2:
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          AddrCharsTail_27 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *Chars_10, (MR_Integer) 1)));
          mercury__io__text_read__LCMC__pred__read_line_2__1_6_p_0(Stream_7, Result_8, Error_9, AddrCharsTail_27);
        }
      }
      break;
  }
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Chars_30, 0) = ((MR_Box) (MR_Word) (Char_14));
