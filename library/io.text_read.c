...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      mercury__io__primitives_read__read_char_code_2_6_p_0(Var_38, &ResultCode_16, &Error0_17, &Char_18);
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(Var_58, (MR_String) "error getting file offset: ");
