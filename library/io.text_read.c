...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      MR_Box Error0_17;
      MR_Char Char_18;
      MR_Box Var_33 = (MR_Box) (Stream_10);

      mercury__io__primitives_read__read_char_code_2_6_p_0(Var_33, &ResultCode_16, &Error0_17, &Char_18);
  ...
  MR_Word * Result_6)
{
  MR_bool succeeded;
  int64_t FileSize_8;
  MR_Box Stream_49 = (MR_Box) (Stream_5);
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(Var_51, (MR_String) "error getting file offset: ");
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          AddrCharsTail_21 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *Chars_10, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            *Result_8 = (MR_Integer) 0;
            {
              Chars_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Chars_23, 0) = ((MR_Box) (MR_Word) (Char_14));
              MR_hl_field(MR_mktag(1), Chars_23, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          ...
          else
          {
            ...
            {
              Chars_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Chars_24, 0) = ((MR_Box) (MR_Word) (Char_14));
              MR_hl_field(MR_mktag(1), Chars_24, 1) = NULL;
            }
            AddrCharsTail_21 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), Chars_24, (MR_Integer) 1)));
...
#define MR_PROC_LABEL mercury__io__text_read__read_word_2_4_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_Integer, Var_24 , Error);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_hl_field(MR_mktag(1), CharResult_8, 0) = ((MR_Box) (MR_Word) (Var_25));
      }
      break;
  }
