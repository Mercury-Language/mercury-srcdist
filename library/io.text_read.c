...
static /* final */ const MR_Box mercury__io__text_read_scalar_common_3[2][5];

static /* final */ const MR_Box mercury__io__text_read_scalar_common_4[1][1];
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      MR_Box Error0_17;
      MR_Char Char_18;
      MR_Box Var_35 = (MR_Box) (Stream_10);

      mercury__io__primitives_read__read_char_code_2_6_p_0(Var_35, &ResultCode_16, &Error0_17, &Char_18);
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(Var_56, (MR_String) "error getting file offset: ");
  ...
  MR_Word * Chars_10)
{
  ...
  mercury__io__primitives_read__read_char_code_2_6_p_0(Var_25, &Result0_12, &Error0_13, &Char_14);
  switch (Result0_12) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
    case (MR_Integer) 2:
    ...
    case (MR_Integer) 0:
      {
          ...
          *Result_8 = (MR_Integer) 0;
          {
            ...
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *Chars_10 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MR_Word) (Char_14));
        ...
        else
        {
          ...
          AddrCharsTail_26 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *Chars_10, (MR_Integer) 1)));
          mercury__io__text_read__LCMC__pred__read_line_2__1_6_p_0(Stream_7, Result_8, Error_9, AddrCharsTail_26);
        }
      }
      break;
  }
  ...
  while (MR_TRUE)
  {
    ...
    switch (Result0_12) {
      ...
      case (MR_Integer) 2:
        {
          *Result_8 = Result0_12;
          *AddrOfChars_27 = (MR_Word) ((MR_Unsigned) 0U);
          *Error_9 = Error0_13;
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            *Result_8 = (MR_Integer) 0;
            {
              Chars_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Chars_28, 0) = ((MR_Box) (MR_Word) (Char_14));
              MR_hl_field(MR_mktag(1), Chars_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            *AddrOfChars_27 = Chars_28;
            *Error_9 = Error0_13;
          }
          else
          {
            MR_Word * AddrCharsTail_26;
            MR_Word Chars_29;
            MR_Word * next_value_of_AddrOfChars_27;

            {
              Chars_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Chars_29, 0) = ((MR_Box) (MR_Word) (Char_14));
              MR_hl_field(MR_mktag(1), Chars_29, 1) = NULL;
            }
            AddrCharsTail_26 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), Chars_29, (MR_Integer) 1)));
            *AddrOfChars_27 = Chars_29;
            // direct tailcall eliminated
            ;
            next_value_of_AddrOfChars_27 = AddrCharsTail_26;
            AddrOfChars_27 = next_value_of_AddrOfChars_27;
            continue;
          }
        }
        break;
  ...
  MR_Word * Result_6)
{
  ...
  MR_Box Var_28;
  MR_Char Var_29;
  MR_Box Var_37 = (MR_Box) (Stream_5);

  mercury__io__primitives_read__read_char_code_2_6_p_0(Var_37, &Var_27, &Var_28, &Var_29);
  switch (Var_27) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
...
{
#define MR_PROC_LABEL mercury__io__text_read__read_word_2_4_p_0
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_hl_field(MR_mktag(1), CharResult_8, 0) = ((MR_Box) (MR_Word) (Var_29));
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          *Result_6 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__io__text_read_scalar_common_4[0]));
        }
        else
        {
          MR_Word Result0_11;
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Chars_12));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
