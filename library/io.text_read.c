...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (!(succeeded))
    {
      ...
      mercury__io__make_io_error_from_system_error_5_p_0(Var_49, (MR_String) "error getting file offset: ", &Var_52);
      {
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__io__make_io_error_from_system_error_5_p_0(Var_24, (MR_String) "read failed: ", &Var_30);
        {
          CharResult_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), CharResult_8, 0) = ((MR_Box) (Var_30));
        }
      }
      break;
    case (MR_Integer) 0:
