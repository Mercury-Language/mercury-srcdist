	...
	*Error_14  = (MR_Box) Error;
    ...
    else
    {
      ...
      switch (ResultCode_16) {
        ...
        case (MR_Integer) 0:
          {
            MR_ArrayPtr STATE_VARIABLE_Array_1_26;
            MR_Integer STATE_VARIABLE_Pos_1_27;
            MR_ArrayPtr conv0_STATE_VARIABLE_Array_1_26;
            MR_ArrayPtr next_value_of_STATE_VARIABLE_Array_0_19;
            MR_Integer next_value_of_STATE_VARIABLE_Pos_0_21;

            mercury__array__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), STATE_VARIABLE_Pos_0_21, ((MR_Box) (MR_Word) (Char_18)), (MR_ArrayPtr) (STATE_VARIABLE_Array_0_19), &conv0_STATE_VARIABLE_Array_1_26);
            STATE_VARIABLE_Array_1_26 = (MR_ArrayPtr) (conv0_STATE_VARIABLE_Array_1_26);
            STATE_VARIABLE_Pos_1_27 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_21 + (MR_Unsigned) 1);
            // direct tailcall eliminated
            ;
            next_value_of_STATE_VARIABLE_Array_0_19 = STATE_VARIABLE_Array_1_26;
            next_value_of_STATE_VARIABLE_Pos_0_21 = STATE_VARIABLE_Pos_1_27;
...
#undef MR_PROC_LABEL
	RemainingSize_11  = I;
      ...
      STATE_VARIABLE_BM_1_31 = mercury__bitmap__init_2_f_0(Var_32, (MR_Integer) 0);
      ...
      if (succeeded)
        {
          ...
          *Result_6 = base;
          MR_hl_field(0, base, 0) = ((MR_Box) (STATE_VARIABLE_BM_1_31));
        }
      else
      {
        MR_Integer BytesRead_13;
        MR_Word ReadResult_14;
        MR_Box STATE_VARIABLE_BM_2_35;

        mercury__bitmap__read_bitmap_range_9_p_0(Stream_5, (MR_Integer) 0, RemainingSize_11, STATE_VARIABLE_BM_1_31, &STATE_VARIABLE_BM_2_35, &BytesRead_13, &ReadResult_14);
          ...
          if (succeeded)
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              *Result_6 = base;
              MR_hl_field(0, base, 0) = ((MR_Box) (STATE_VARIABLE_BM_2_35));
            }
          else
        ...
        {
          MR_Word Msg_15 = ((MR_Word) ((MR_hl_field(1, ReadResult_14, 0))));
  ...
  else
  {
    ...
    {
      MR_Word Msg_45 = ((MR_Word) ((MR_hl_field(1, Res_17, 0))));
  ...
  MR_Word * STATE_VARIABLE_BMs_18)
{
  while (MR_TRUE)
  {
    ...
    MR_Word ReadRes_15;
    MR_Box STATE_VARIABLE_BM_1_21;
    MR_Integer Var_22 = (MR_Integer) ((MR_Unsigned) BufferSize_9 * (MR_Unsigned) 8);
    MR_Box STATE_VARIABLE_BM_2_25;

    // setup for model_det tailcalls optimized into a loop
    ;
    STATE_VARIABLE_BM_1_21 = mercury__bitmap__init_2_f_0(Var_22, (MR_Integer) 0);
    mercury__bitmap__read_bitmap_range_9_p_0(Stream_8, (MR_Integer) 0, BufferSize_9, STATE_VARIABLE_BM_1_21, &STATE_VARIABLE_BM_2_25, &NumBytesRead_14, &ReadRes_15);
    if ((ReadRes_15 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      succeeded = (NumBytesRead_14 < BufferSize_9);
      if (succeeded)
      {
        MR_Box STATE_VARIABLE_BM_3_27;
        MR_Integer Var_28 = (MR_Integer) ((MR_Unsigned) NumBytesRead_14 * (MR_Unsigned) 8);

        STATE_VARIABLE_BM_3_27 = mercury__bitmap__shrink_without_copying_2_f_0(STATE_VARIABLE_BM_2_25, Var_28);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_BMs_18 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (STATE_VARIABLE_BM_3_27));
      ...
      {
        MR_Word STATE_VARIABLE_BMs_2_31;
        MR_Integer Var_32;
        MR_Integer next_value_of_BufferSize_9;
        MR_Word next_value_of_STATE_VARIABLE_BMs_0_17;

        {
          STATE_VARIABLE_BMs_2_31 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_BMs_2_31, 0) = ((MR_Box) (STATE_VARIABLE_BM_2_25));
          MR_hl_field(1, STATE_VARIABLE_BMs_2_31, 1) = ((MR_Box) (STATE_VARIABLE_BMs_0_17));
        }
        Var_32 = (MR_Integer) ((MR_Unsigned) BufferSize_9 * (MR_Unsigned) 2);
        // direct tailcall eliminated
        ;
        next_value_of_BufferSize_9 = Var_32;
        next_value_of_STATE_VARIABLE_BMs_0_17 = STATE_VARIABLE_BMs_2_31;
  ...
  MR_Word * NullCharError_18)
{
  while (MR_TRUE)
  {
    ...
    MR_Box Error0_21;
    MR_Box STATE_VARIABLE_Buffer_1_29;
    MR_Integer STATE_VARIABLE_Pos_1_30;
...
#define MR_PROC_LABEL mercury__io__text_read__read_file_as_string_loop_10_p_0
    ...
    if (bytes_read < bytes_to_read && MR_FERROR(*Stream)) {
		...
		;}
#undef MR_PROC_LABEL
	STATE_VARIABLE_Buffer_1_29  = (MR_Box) Buffer;
	STATE_VARIABLE_Pos_1_30  = Pos;
	Error0_21  = (MR_Box) Error;
}
    succeeded = (STATE_VARIABLE_Pos_1_30 < BufferSize0_13);
    if (succeeded)
    {
...
#define MR_PROC_LABEL mercury__io__text_read__read_file_as_string_loop_10_p_0
	...
	Buffer = (char *) STATE_VARIABLE_Buffer_1_29 ;
	Pos = STATE_VARIABLE_Pos_1_30 ;
		{
{
    Str = Buffer;
    Str[Pos] = '\0';
...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Box STATE_VARIABLE_Buffer_2_33;
...
#define MR_PROC_LABEL mercury__io__text_read__read_file_as_string_loop_10_p_0
	...
	Buffer0 = (char *) STATE_VARIABLE_Buffer_1_29 ;
		{
{
    MR_CHECK_EXPR_TYPE(Buffer0, char *);
    MR_CHECK_EXPR_TYPE(Buffer, char *);
    ...
    if (Buffer0 + OldSize == (char *) MR_hp) {
		...
		;}
#undef MR_PROC_LABEL
	STATE_VARIABLE_Buffer_2_33  = (MR_Box) Buffer;
}
        // direct tailcall eliminated
        ;
        next_value_of_STATE_VARIABLE_Buffer_0_25 = STATE_VARIABLE_Buffer_2_33;
        next_value_of_BufferSize0_13 = BufferSize1_24;
        next_value_of_STATE_VARIABLE_Pos_0_26 = STATE_VARIABLE_Pos_1_30;
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          AddrCharsTail_21 = (MR_Word *) (&(MR_hl_field(1, *Chars_10, 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            AddrCharsTail_21 = (MR_Word *) (&(MR_hl_field(1, Chars_24, 1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          switch (MR_tag((MR_Word) Result0_11)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word Chars_12 = ((MR_Word) ((MR_hl_field(1, Result0_11, 0))));
                MR_Word Var_20;
