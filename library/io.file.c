...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        ...
        mercury__string__append_3_p_2((MR_String) "io.check_directory_accessibility_dotnet called ", (MR_String) "for non-.NET CLI backend", &Var_64);
        {
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              MR_Box Var_75 = (MR_Box) (InputStream_20);
              MR_Box Var_77;
	...
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_77 );
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MR_Box Var_85 = (MR_Box) (OutputStream_24);
          MR_Box Var_87;
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_54 = mercury__dir__make_dirname_ok_for_windows_1_f_0(FileName_5);
          mercury__dir__foldl2_process_dir_13_p_0((MR_Word) (&mercury__io__io__type_ctor_info_res_0), (MR_Word) (&mercury__io__file_scalar_common_4[0]), (MR_Word) (&mercury__io__file_scalar_common_1[1]), Var_54, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, &Var_59, (MR_Word) ((MR_Unsigned) 0U), &Var_60, ((MR_Box) ((MR_Unsigned) 0U)), &conv2_Var_61);
          Var_61 = ((MR_Word) (conv2_Var_61));
          mercury__list__reverse_2_p_0((MR_Word) (&mercury__dir__dir__type_ctor_info_file_error_0), Var_60, &Var_62);
          if ((Var_62 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              Res0_11 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Res0_11, 0) = ((MR_Box) (Var_61));
            }
          else
          {
            MR_Word Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 0))));
            MR_Word Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 2))));

            {
              Res0_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Res0_11, 0) = ((MR_Box) (Var_61));
              MR_hl_field(MR_mktag(1), Res0_11, 1) = ((MR_Box) (Var_68));
            }
          }
...
#define MR_PROC_LABEL mercury__io__file__remove_file_recursively_4_p_0
    ...
    if (rc == 0) {
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Error_76 );
}
              mercury__io__is_error_5_p_0(Error_76, (MR_String) "remove failed: ", &MaybeIOError_77);
              if ((MaybeIOError_77 == (MR_Word) ((MR_Unsigned) 0U)))
                *Res_6 = (MR_Word) ((MR_Unsigned) 0U);
              else
              {
                MR_Word IOError_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_77, (MR_Integer) 0))));
