...
succeeded  = SUCCESS_INDICATOR;
        ...
        if (succeeded)
        {
          ...
          mercury__string__append_3_p_2((MR_String) "io.check_directory_accessibility_dotnet called ", (MR_String) "for non-.NET CLI backend", &Var_69);
          {
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                MR_Box Var_72 = (MR_Box) (InputStream_37);
                MR_Box Var_74;
	...
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_74 );
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            MR_Box Var_77 = (MR_Box) (OutputStream_41);
            MR_Box Var_79;

            mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_77);
{
#define MR_PROC_LABEL mercury__io__file__check_file_accessibility_5_p_0
...
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_Integer, Error, Var_79 );
            ...
            mercury__io__throw_on_error_4_p_0(Var_79, (MR_String) "error closing file: ");
...
succeeded  = SUCCESS_INDICATOR;
          ...
          if (succeeded)
          {
            ...
            mercury__string__append_3_p_2((MR_String) "io.have_dotnet_exec_permission invoked ", (MR_String) "for non-.NET CLI backend", &Var_82);
            {
              mercury__require__error_1_p_0(Var_82);
              return;
            }
          }
          else
