...
static /* final */ const MR_Box mercury__io__file_scalar_common_3[1][5];
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_13, (MR_String) "error creating temporary directory: ", &Var_22);
    {
      MaybeIOError_14 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_14, 0) = ((MR_Box) (Var_22));
    }
  }
  if ((MaybeIOError_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      *Result_10 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (DirName_12));
    }
  else
  {
    MR_Word IOError_15 = ((MR_Word) ((MR_hl_field(1, MaybeIOError_14, (MR_Integer) 0))));

    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_10 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (IOError_15));
    }
  }
}
...
succeeded  = SUCCESS_INDICATOR;
    ...
    *Dir_4 = ((MR_String) ((MR_hl_field(1, Result_9, (MR_Integer) 0))));
}
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_13, (MR_String) "error creating temporary file: ", &Var_22);
    {
      MaybeIOError_14 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_14, 0) = ((MR_Box) (Var_22));
    }
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_9, (MR_String) "can\'t get file modification time: ", &Var_16);
    {
  ...
  if ((MaybeIOError_10 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      *Result_6 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (Time_8));
    }
  else
  {
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_13, (MR_String) "file not accessible: ", &Var_32);
    {
      MaybeIOError_14 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_14, 0) = ((MR_Box) (Var_32));
    }
  }
  if ((MaybeIOError_14 == (MR_Word) ((MR_Unsigned) 0U)))
...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_9, (MR_String) "io.read_symlink failed: ", &Var_19);
      {
        MaybeIOError_10 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeIOError_10, 0) = ((MR_Box) (Var_19));
      }
    }
    if ((MaybeIOError_10 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        *Result_6 = base;
        MR_hl_field(0, base, 0) = ((MR_Box) (TargetFileName_8));
      }
    else
    {
      MR_Word IOError_11 = ((MR_Word) ((MR_hl_field(1, MaybeIOError_10, (MR_Integer) 0))));
    ...
    *Result_6 = (MR_Word) (MR_mkword(1, &mercury__io__file_scalar_common_6[3]));
}
...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_10, (MR_String) "io.make_symlink failed: ", &Var_20);
      {
        MaybeIOError_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeIOError_11, 0) = ((MR_Box) (Var_20));
      }
    }
    ...
    *Result_8 = (MR_Word) (MR_mkword(1, &mercury__io__file_scalar_common_6[1]));
}
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_10, (MR_String) "rename failed: ", &Var_17);
    {
      MaybeIOError_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_11, 0) = ((MR_Box) (Var_17));
    }
  }
  if ((MaybeIOError_11 == (MR_Word) ((MR_Unsigned) 0U)))
    *Result_8 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  MR_Word * Res_6)
{
  ...
  {
    MR_Word Error_24 = ((MR_Word) ((MR_hl_field(1, ResFileType_9, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((Var_46 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              MR_hl_field(0, Res0_11, 0) = ((MR_Box) (Var_45));
            }
          else
          {
            MR_Word Var_47 = ((MR_Word) ((MR_hl_field(1, Var_46, (MR_Integer) 0))));
            MR_Word Var_51 = ((MR_Word) ((MR_hl_field(0, Var_47, (MR_Integer) 2))));

            {
              Res0_11 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Res0_11, 0) = ((MR_Box) (Var_45));
              MR_hl_field(1, Res0_11, 1) = ((MR_Box) (Var_51));
            }
          }
          if (((MR_tag((MR_Word) Res0_11)) == (MR_Integer) 1))
          {
            MR_Word Error_23 = ((MR_Word) ((MR_hl_field(1, Res0_11, (MR_Integer) 1))));
          ...
          {
            MR_Word MaybeError_12 = ((MR_Word) ((MR_hl_field(0, Res0_11, (MR_Integer) 0))));
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_12, (MR_String) "can\'t find file type: ", &Var_19);
    {
      MaybeIOError_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_13, 0) = ((MR_Box) (Var_19));
    }
  }
  if ((MaybeIOError_13 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      *Result_8 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (FileType_11));
    }
  else
  {
    MR_Word IOError_14 = ((MR_Word) ((MR_hl_field(1, MaybeIOError_13, (MR_Integer) 0))));

    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_8 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (IOError_14));
    }
  }
}
...
succeeded  = SUCCESS_INDICATOR;
  ...
  else
  {
    ...
    mercury__io__error_util__make_io_error_from_system_error_impl_5_p_0(Error_8, (MR_String) "remove failed: ", &Var_15);
    {
      MaybeIOError_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeIOError_9, 0) = ((MR_Box) (Var_15));
    }
  }
  ...
  {
    MR_Word IOError_10 = ((MR_Word) ((MR_hl_field(1, MaybeIOError_9, (MR_Integer) 0))));
