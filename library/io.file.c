...
succeeded  = SUCCESS_INDICATOR;
  ...
  if (succeeded)
  {
    MR_Word CheckRead0_27;
    MR_Word CheckWrite_28;
    MR_Word CheckExec_29;
    MR_Word CheckRead_30;
    MR_Word FileTypeRes_31;
    ...
    if (succeeded)
      CheckRead0_27 = (MR_Integer) 1;
    else
      CheckRead0_27 = (MR_Integer) 0;
    ...
    if (succeeded)
      CheckWrite_28 = (MR_Integer) 1;
    else
      CheckWrite_28 = (MR_Integer) 0;
    ...
    if (succeeded)
      CheckExec_29 = (MR_Integer) 1;
    else
      CheckExec_29 = (MR_Integer) 0;
    switch (CheckRead0_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        CheckRead_30 = CheckExec_29;
        break;
      case (MR_Integer) 1:
        CheckRead_30 = (MR_Integer) 1;
        break;
    }
    mercury__io__file__file_type_5_p_0((MR_Integer) 1, FileName_6, &FileTypeRes_31);
    if (((MR_tag((MR_Word) FileTypeRes_31)) == (MR_Integer) 1))
    {
      MR_Word FileTypeError_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FileTypeRes_31, (MR_Integer) 0))));

      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_8 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (FileTypeError_44));
      }
    }
    else
    {
      MR_Word FileType_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FileTypeRes_31, (MR_Integer) 0))));

      succeeded = (FileType_32 == (MR_Integer) 1);
      if (succeeded)
      {
        MR_Box Error_33;
        MR_Word MaybeIOError_34;
...
succeeded  = SUCCESS_INDICATOR;
        ...
        if (succeeded)
        {
          ...
          mercury__string__append_3_p_2((MR_String) "io.check_directory_accessibility_dotnet called ", (MR_String) "for non-.NET CLI backend", &Var_72);
          {
...
#define MR_PROC_LABEL mercury__io__file__check_file_accessibility_5_p_0
    ...
    Error = 0;
		...
		;}
#undef MR_PROC_LABEL
	Error_33  = (MR_Box) Error;
}
        }
        mercury__io__is_error_5_p_0(Error_33, (MR_String) "file not accessible: ", &MaybeIOError_34);
        if ((MaybeIOError_34 == (MR_Word) ((MR_Unsigned) 0U)))
          *Result_8 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word IOError_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_34, (MR_Integer) 0))));
      ...
      {
        MR_Word CheckReadRes_38;
        MR_Word CheckWriteRes_42;

        switch (CheckRead_30) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            CheckReadRes_38 = (MR_Word) ((MR_Unsigned) 0U);
            break;
          case (MR_Integer) 1:
            {
              MR_Word InputRes_36;

              mercury__io__open_input_4_p_0(FileName_6, &InputRes_36);
              if (((MR_tag((MR_Word) InputRes_36)) == (MR_Integer) 1))
              {
                MR_Word InputError_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InputRes_36, (MR_Integer) 0))));

                {
                  CheckReadRes_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), CheckReadRes_38, 0) = ((MR_Box) (InputError_39));
                }
              }
              else
              {
                MR_Word InputStream_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InputRes_36, (MR_Integer) 0))));
                MR_Box Var_75 = (MR_Box) (InputStream_37);
                MR_Box Var_77;

                mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_75);
{
#define MR_PROC_LABEL mercury__io__file__check_file_accessibility_5_p_0
...
#undef MR_PROC_LABEL
	Var_77  = (MR_Box) Error;
                ...
                mercury__io__throw_on_error_4_p_0(Var_77, (MR_String) "error closing file: ");
                CheckReadRes_38 = (MR_Word) ((MR_Unsigned) 0U);
              }
            }
            break;
        }
        succeeded = (CheckReadRes_38 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          succeeded = (CheckWrite_28 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Word OutputRes_40;

          mercury__io__open_append_4_p_0(FileName_6, &OutputRes_40);
          if (((MR_tag((MR_Word) OutputRes_40)) == (MR_Integer) 1))
          {
            MR_Word OutputError_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OutputRes_40, (MR_Integer) 0))));

            {
              CheckWriteRes_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CheckWriteRes_42, 0) = ((MR_Box) (OutputError_43));
            }
          }
          else
          {
            MR_Word OutputStream_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OutputRes_40, (MR_Integer) 0))));
            MR_Box Var_80 = (MR_Box) (OutputStream_41);
            MR_Box Var_82;

            mercury__io__stream_db__maybe_delete_stream_info_3_p_0(Var_80);
{
#define MR_PROC_LABEL mercury__io__file__check_file_accessibility_5_p_0
...
#undef MR_PROC_LABEL
	Var_82  = (MR_Box) Error;
            ...
            mercury__io__throw_on_error_4_p_0(Var_82, (MR_String) "error closing file: ");
            CheckWriteRes_42 = (MR_Word) ((MR_Unsigned) 0U);
          }
        }
        else
          CheckWriteRes_42 = CheckReadRes_38;
        succeeded = (CheckWriteRes_42 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          succeeded = (CheckExec_29 == (MR_Integer) 1);
        if (succeeded)
        {
          MR_Box Error_62;
          MR_Word MaybeIOError_63;
...
succeeded  = SUCCESS_INDICATOR;
          ...
          if (succeeded)
          {
            ...
            mercury__string__append_3_p_2((MR_String) "io.have_dotnet_exec_permission invoked ", (MR_String) "for non-.NET CLI backend", &Var_85);
            {
              mercury__require__error_1_p_0(Var_85);
              return;
            }
          }
          else
...
#define MR_PROC_LABEL mercury__io__file__check_file_accessibility_5_p_0
    ...
    Error = 0;
		...
		;}
#undef MR_PROC_LABEL
	Error_62  = (MR_Box) Error;
}
          }
          mercury__io__is_error_5_p_0(Error_62, (MR_String) "file not accessible: ", &MaybeIOError_63);
          if ((MaybeIOError_63 == (MR_Word) ((MR_Unsigned) 0U)))
            *Result_8 = (MR_Word) ((MR_Unsigned) 0U);
          else
          {
            MR_Word IOError_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_63, (MR_Integer) 0))));

            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *Result_8 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (IOError_61));
            }
          }
        }
        else
          *Result_8 = CheckWriteRes_42;
      }
    }
  }
  else
...
#undef MR_PROC_LABEL
	Error_34  = (MR_Box) Error;
          ...
          mercury__io__is_error_5_p_0(Error_34, (MR_String) "remove failed: ", &MaybeIOError_35);
          if ((MaybeIOError_35 == (MR_Word) ((MR_Unsigned) 0U)))
            *Res_6 = (MR_Word) ((MR_Unsigned) 0U);
          else
          {
            MR_Word IOError_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIOError_35, (MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_43 = mercury__dir__make_dirname_ok_for_windows_1_f_0(FileName_5);
          mercury__dir__foldl2_process_dir_13_p_0((MR_Word) (&mercury__io__io__type_ctor_info_res_0), (MR_Word) (&mercury__io__file_scalar_common_4[0]), (MR_Word) (&mercury__io__file_scalar_common_1[1]), Var_43, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, &Var_48, (MR_Word) ((MR_Unsigned) 0U), &Var_49, ((MR_Box) ((MR_Unsigned) 0U)), &conv2_Var_50);
          Var_50 = ((MR_Word) (conv2_Var_50));
          mercury__list__reverse_2_p_0((MR_Word) (&mercury__dir__dir__type_ctor_info_file_error_0), Var_49, &Var_51);
          if ((Var_51 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              Res0_11 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Res0_11, 0) = ((MR_Box) (Var_50));
            }
          else
          {
            MR_Word Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_51, (MR_Integer) 0))));
            MR_Word Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_52, (MR_Integer) 2))));

            {
              Res0_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Res0_11, 0) = ((MR_Box) (Var_50));
              MR_hl_field(MR_mktag(1), Res0_11, 1) = ((MR_Box) (Var_56));
            }
          }
...
#define MR_PROC_LABEL mercury__io__file__remove_file_recursively_4_p_0
    ...
    if (rc == 0) {
		...
		;}
#undef MR_PROC_LABEL
	Error_59  = (MR_Box) Error;
}
              mercury__io__is_error_5_p_0(Error_59, (MR_String) "remove failed: ", &MaybeIOError_60);
