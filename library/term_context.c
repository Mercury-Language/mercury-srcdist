...
static /* final */ const MR_Box mercury__term_context_scalar_common_3[1][5];
...
static const MR_DuFunctorDescPtr mercury__term_context__term_context__du_stag_ordered_term_context_0_0[1] = { &mercury__term_context__term_context__du_functor_desc_term_context_0_0 };
...
static const MR_DuFunctorDescPtr mercury__term_context__term_context__du_name_ordered_term_context_0[1] = { &mercury__term_context__term_context__du_functor_desc_term_context_0_0 };

static const MR_Integer mercury__term_context__term_context__functor_number_map_term_context_0[1] = { (MR_Integer) 0 };
