    ...
    if (mercury__set_ordlist__succeeded)
      *mercury__set_ordlist__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Word mercury__set_ordlist__Var_5 = (MR_Word) mercury__set_ordlist__HeadVar__3_3;

        {
          mercury__list____Compare____list_1_0(mercury__set_ordlist__TypeInfo_for_T_8, mercury__set_ordlist__HeadVar__1_1, mercury__set_ordlist__Var_4, mercury__set_ordlist__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__set_ordlist__succeeded)
      ...
      {
        MR_Word mercury__set_ordlist__Var_3 = (MR_Word) mercury__set_ordlist__HeadVar__1_1;
        MR_Word mercury__set_ordlist__Var_4 = (MR_Word) mercury__set_ordlist__HeadVar__2_2;

        {
          mercury__set_ordlist__succeeded = mercury__list____Unify____list_1_0(mercury__set_ordlist__TypeInfo_for_T_7, mercury__set_ordlist__Var_3, mercury__set_ordlist__Var_4);
        }
      }
    return mercury__set_ordlist__succeeded;
  }
