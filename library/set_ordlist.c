  ...
  MR_Word * STATE_VARIABLE_Set_8)
{
  ...
  {
    MR_Word Elem_13 = ((MR_Word) ((MR_hl_field(1, Intersection_20, 0))));
    MR_Word Elems_14 = ((MR_Word) ((MR_hl_field(1, Intersection_20, 1))));
  ...
  if (succeeded)
  {
    ...
    mercury__list__intersect_3_p_0(TypeInfo_for_T_9, (MR_Word) (Xs_18), (MR_Word) (Intersection_20), &conv1_Var_21);
    Var_21 = (MR_Word) (conv1_Var_21);
    succeeded = mercury__list____Unify____list_1_0(TypeInfo_for_T_9, (MR_Word) (Intersection_20), (MR_Word) (Var_21));
    if (succeeded)
    {
      Xs_24 = (MR_Word) (STATE_VARIABLE_Set_0_7);
      Ys_25 = (MR_Word) (ElemSet_6);
      mercury__set_ordlist__difference_loop_3_p_0(TypeInfo_for_T_9, (MR_Word) (Xs_24), (MR_Word) (Ys_25), &conv2_Diff_26);
      Diff_26 = (MR_Word) (conv2_Diff_26);
      *STATE_VARIABLE_Set_8 = (MR_Word) (Diff_26);
      succeeded = MR_TRUE;
    }
  }
  return succeeded;
  ...
  MR_Word * STATE_VARIABLE_Set_8)
{
  ...
  {
    MR_Box Elem_11 = (MR_hl_field(1, Intersection_18, 0));
    MR_Word Elems_12 = ((MR_Word) ((MR_hl_field(1, Intersection_18, 1))));
  ...
  {
    Xs_16 = (MR_Word) (STATE_VARIABLE_Set_0_7);
    mercury__list__intersect_3_p_0(TypeInfo_for_T_9, Xs_16, Intersection_18, &Var_19);
    succeeded = mercury__list____Unify____list_1_0(TypeInfo_for_T_9, Intersection_18, Var_19);
    if (succeeded)
    {
      Xs_22 = (MR_Word) (STATE_VARIABLE_Set_0_7);
      Ys_23 = (MR_Word) (ElemSet_6);
      mercury__set_ordlist__difference_loop_3_p_0(TypeInfo_for_T_9, Xs_22, Ys_23, &Diff_24);
...
{
  MR_Integer Var_11;
  MR_Word SortedListA_13;
  MR_Word SortedListB_14;
  MR_Word SortedListAB_15;

  mercury__list__length_acc_3_p_0(TypeInfo_for_T_10, List0_4, (MR_Integer) 0, &Var_11);
  mercury__list__merge_sort_and_remove_dups_3_p_0(TypeInfo_for_T_10, Var_11, List0_4, &SortedListA_13);
  SortedListB_14 = (MR_Word) (STATE_VARIABLE_Set_0_7);
  mercury__list__merge_and_remove_dups_3_p_0(TypeInfo_for_T_10, SortedListA_13, SortedListB_14, &SortedListAB_15);
  *STATE_VARIABLE_Set_8 = (MR_Word) (SortedListAB_15);
}
