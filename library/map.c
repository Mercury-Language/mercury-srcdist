  ...
  MR_Box * wrapper_arg_2)
{
  ...
  mercury__map__IntroducedFrom__pred__det_transform_value__1636__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), wrapper_arg_1, wrapper_arg_2);
}
