  ...
  MR_Word * STATE_VARIABLE_RevCommonList_23)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ListA_6, (MR_Integer) 1))));
      MR_Word Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ListA_6, (MR_Integer) 0))));
      ...
      {
        MR_Box KeyA_14 = (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 0));
        MR_Box ValueA_15 = (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 1));
        MR_Box KeyB_17;
        MR_Box ValueB_18;
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_for_K_30, &R_20, KeyA_14, KeyB_17);
        switch (R_20) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              MR_Word next_value_of_ListA_6 = Var_32;
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_29;
              MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Var_35, (MR_Integer) 1))));
              MR_Word next_value_of_ListA_6;
              MR_Word next_value_of_ListB_7;
              MR_Word next_value_of_STATE_VARIABLE_RevCommonList_0_22;

              succeeded = func_0(((MR_Box) (Var_35)), ValueA_15, ValueB_18, &Value_21);
              if (succeeded)
              {
                {
                  Var_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word STATE_VARIABLE_RevCommonList_28_28;
              MR_Word Var_29;
              MR_Box MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(MR_mktag(0), Var_35, (MR_Integer) 1))));
              MR_Word next_value_of_ListA_6;
              MR_Word next_value_of_ListB_7;
              MR_Word next_value_of_STATE_VARIABLE_RevCommonList_0_22;

              Value_21 = func_0(((MR_Box) (Var_35)), ValueA_15, ValueB_18);
              {
                Var_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_29, 0) = KeyA_14;
                MR_hl_field(MR_mktag(0), Var_29, 1) = Value_21;
  ...
  MR_Word * STATE_VARIABLE_RevCommonList_20)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ListA_5, (MR_Integer) 1))));
      MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ListA_5, (MR_Integer) 0))));

      if ((ListB_6 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_RevCommonList_20 = STATE_VARIABLE_RevCommonList_0_19;
      else
      {
        MR_Box KeyA_12 = (MR_hl_field(MR_mktag(0), Var_30, (MR_Integer) 0));
        MR_Box ValueA_13 = (MR_hl_field(MR_mktag(0), Var_30, (MR_Integer) 1));
        MR_Box KeyB_15;
        MR_Box ValueB_16;
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_for_K_27, &R_18, KeyA_12, KeyB_15);
        switch (R_18) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              MR_Word next_value_of_ListA_5 = Var_29;
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_for_V_28, ValueA_13, ValueB_16);
              if (succeeded)
                {
                  STATE_VARIABLE_RevCommonList_25_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevCommonList_25_25, 0) = ((MR_Box) (Var_30));
