  ...
  MR_Word * STATE_VARIABLE_RevMap_11)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__tree234__update_4_p_0(TypeInfo_for_V_16, TypeInfo_18_18, Value_6, ((MR_Box) (Keys_9)), (MR_Word) (STATE_VARIABLE_RevMap_0_10), &conv1_NewMap_25);
    if (succeeded)
    {
  ...
  else
  {
    ...
    succeeded = mercury__tree234__insert_4_p_0(TypeInfo_for_V_16, TypeInfo_22_22, Value_6, ((MR_Box) (Var_13)), (MR_Word) (STATE_VARIABLE_RevMap_0_10), &conv2_NewMap_30);
    if (succeeded)
    {
