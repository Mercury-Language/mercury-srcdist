...
{
  {
    ...
    if (succeeded)
    {
      ...
      conv0_HeadVar__7_7 = mercury__exception__throw_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), TypeInfo_22_22, ((MR_Box) ((MR_String) "bit_buffer: invalid buffer size")));
...
#define MR_PROC_LABEL mercury__bit_buffer__new_buffer_6_f_0
	...
	ReadStatus =  (MR_Word) ((MR_Integer) 0) ;
		{
{
    MR_incr_hp_type_msg(Buffer, ML_BitBuffer, MR_ALLOC_ID,
        "bit_buffer.bit_buffer/3");
