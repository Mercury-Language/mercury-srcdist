  ...
  MR_Box State_13)
{
  ...
  if (succeeded)
  {
    ...
    {
      TypeInfo__22_22 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TypeInfo__22_22, 0) = ((MR_Box) (&mercury__bit_buffer__bit_buffer__type_ctor_info_bit_buffer_3));
      MR_hl_field(MR_mktag(0), TypeInfo__22_22, 1) = ((MR_Box) (TypeInfo_for_Stream_18));
      MR_hl_field(MR_mktag(0), TypeInfo__22_22, 2) = ((MR_Box) (TypeInfo_for_State_19));
      MR_hl_field(MR_mktag(0), TypeInfo__22_22, 3) = ((MR_Box) (TypeInfo_for_Error_20));
    }
    conv0_HeadVar__7_7 = mercury__require__func_error_2_f_0(TypeInfo__22_22, (MR_String) "function \140bit_buffer.new_buffer\'/6", (MR_String) "invalid buffer size");
