...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), TypeInfo_22_22, 0) = ((MR_Box) (&mercury__bit_buffer__bit_buffer__type_ctor_info_bit_buffer_3));
        MR_hl_field(MR_mktag(0), TypeInfo_22_22, 1) = ((MR_Box) (TypeInfo_for_Stream_18));
        MR_hl_field(MR_mktag(0), TypeInfo_22_22, 2) = ((MR_Box) (TypeInfo_for_State_19));
        MR_hl_field(MR_mktag(0), TypeInfo_22_22, 3) = ((MR_Box) (TypeInfo_for_Error_20));
      }
