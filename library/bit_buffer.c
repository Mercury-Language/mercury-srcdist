...
{
  {
    ...
    if (mercury__bit_buffer__succeeded)
      ...
      {
        MR_Word mercury__bit_buffer__Var_16 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...
#define MR_PROC_LABEL mercury__bit_buffer__new_buffer_6_f_0
	...
	ReadStatus =  mercury__bit_buffer__Var_16 ;
		{
{
    MR_incr_hp_type_msg(Buffer, ML_BitBuffer, MR_ALLOC_ID,
        "bit_buffer.bit_buffer/3");
...
{
  {
    MR_Box mercury__bit_buffer__closure = mercury__bit_buffer__closure_arg;
