        ...
        if ((mercury__deconstruct__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mercury__deconstruct__HeadVar__1_1 = (MR_Integer) 1;
        else
          {
            ...
            {
              mercury__private_builtin__typed_compare_3_p_0(mercury__deconstruct__TypeInfo_12_15, mercury__deconstruct__TypeInfo_13_13, mercury__deconstruct__HeadVar__1_1, mercury__deconstruct__V_14_14, mercury__deconstruct__V_5_5);
            }
          }
      }
  }
