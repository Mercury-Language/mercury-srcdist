  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Word TypeInfo_8_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
    MR_Word TypeInfo_9_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
    MR_Box ArgX1_4 = (MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1));
