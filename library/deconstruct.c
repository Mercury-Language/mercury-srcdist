...
{
#define MR_PROC_LABEL mercury__deconstruct__local_univ_named_arg_4_p_2
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      mercury__private_builtin__sorry_1_p_0((MR_String) "local_univ_named_arg");
      succeeded = MR_TRUE;
    }
    else
      succeeded = mercury__rtti_implementation__univ_named_arg_4_p_2(TypeInfo_for_T_10, Term_5, NonCanon_6, Name_7, Argument_8);
    return succeeded;
  }
}
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_univ_named_arg_4_p_1
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__rtti_implementation__univ_named_arg_4_p_1(TypeInfo_for_T_10, Term_5, NonCanon_6, Name_7, Argument_8);
    return succeeded;
  }
}
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_univ_named_arg_4_p_0
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__rtti_implementation__univ_named_arg_4_p_0(TypeInfo_for_T_10, Term_5, NonCanon_6, Name_7, Argument_8);
    return succeeded;
  }
}
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_deconstruct_6_p_3
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_deconstruct_6_p_2
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_deconstruct_6_p_1
...
{
#define MR_PROC_LABEL mercury__deconstruct__local_deconstruct_6_p_0
