        ...
        if ((mercury__deconstruct__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mercury__deconstruct__HeadVar__1_1 = (MR_Integer) 1;
        else
          {
            ...
            MR_Box mercury__deconstruct__Var_5 = (MR_hl_field(MR_mktag(1), mercury__deconstruct__HeadVar__3_3, (MR_Integer) 1));

            {
              mercury__private_builtin__typed_compare_3_p_0(mercury__deconstruct__TypeInfo_12_15, mercury__deconstruct__TypeInfo_13_13, mercury__deconstruct__HeadVar__1_1, mercury__deconstruct__Var_14, mercury__deconstruct__Var_5);
            }
          }
      }
  }
...
{
  {
    ...
    if ((mercury__deconstruct__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Box mercury__deconstruct__Var_3 = (MR_hl_field(MR_mktag(1), mercury__deconstruct__HeadVar__1_1, (MR_Integer) 1));
        MR_Box mercury__deconstruct__Var_4;
        ...
        if (mercury__deconstruct__succeeded)
          {
            ...
            mercury__deconstruct__Var_4 = (MR_hl_field(MR_mktag(1), mercury__deconstruct__HeadVar__2_2, (MR_Integer) 1));
            {
              mercury__deconstruct__succeeded = mercury__private_builtin__typed_unify_2_p_0(mercury__deconstruct__TypeInfo_9_9, mercury__deconstruct__TypeInfo_10_10, mercury__deconstruct__Var_3, mercury__deconstruct__Var_4);
            }
          }
      }
    return mercury__deconstruct__succeeded;
