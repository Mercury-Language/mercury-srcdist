...
{
  MR_bool succeeded;
  MR_Word On0_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 0))));
  MR_Word Off0_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 1))));
  MR_Word On_7;
  MR_Word Off_8;
  ...
  if ((On0_5 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      Var_21 = (MR_hl_field(1, Off0_6, 0));
      Var_20 = ((MR_Word) ((MR_hl_field(1, Off0_6, 1))));
      ...
      else
      {
        ...
        mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_19, Off0_6, (MR_Unsigned) 0U, &Var_22);
{
#define MR_PROC_LABEL mercury__queue__get_from_back_3_p_0
...
#undef MR_PROC_LABEL
	N_12  = I;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            *Elem_4 = (MR_hl_field(1, Var_18, 0));
            On_7 = ((MR_Word) ((MR_hl_field(1, Var_18, 1))));
          }
        }
      }
    }
  ...
  {
    *Elem_4 = (MR_hl_field(1, On0_5, 0));
    On_7 = ((MR_Word) ((MR_hl_field(1, On0_5, 1))));
    Off_8 = Off0_6;
    succeeded = MR_TRUE;
  }
  if (succeeded)
...
mercury__queue__put_list_on_front_3_p_0(
  ...
  MR_Word * HeadVar__3_3)
{
  MR_Word On_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 0))));
  MR_Word Off_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 1))));
  MR_Word Var_7;
  ...
  MR_Word Elems_5)
{
  ...
  MR_Word On_9 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Queue_0_6, 0))));
  MR_Word Off_10 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Queue_0_6, 1))));
  MR_Word Var_11;
...
{
  MR_Word HeadVar__2_2;
  MR_Word On_3 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  MR_Word Off_4 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Word Var_5;
  ...
  MR_Word Q_3)
{
  ...
  mercury__queue__length_2_p_0(TypeInfo_for_T_5, Q_3, &N_4);
  return N_4;
}
  ...
  MR_Integer * Length_5)
{
  ...
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_8, On_3, (MR_Unsigned) 0U, &Var_9);
{
#define MR_PROC_LABEL mercury__queue__length_2_p_0
...
#undef MR_PROC_LABEL
  ...
  mercury__list__ulength_acc_3_p_0(TypeInfo_for_T_8, Off_4, (MR_Unsigned) 0U, &Var_11);
{
#define MR_PROC_LABEL mercury__queue__length_2_p_0
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  MR_Word On_7;
  MR_Word Off_8;
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 1))));

  succeeded = (Var_11 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    *Elem_4 = (MR_hl_field(1, Var_11, 0));
    Off0_6 = ((MR_Word) ((MR_hl_field(1, Var_11, 1))));
...
{
  MR_bool succeeded;
  MR_Word Var_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
...
{
  MR_Word STATE_VARIABLE_Q_7;
  MR_Word On0_9 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Q_0_6, 0))));
  MR_Word Off0_10 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Q_0_6, 1))));
  MR_Word On_11;
  MR_Word Off_12;
...
{
  MR_bool succeeded;
  MR_Word OnA_3 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  MR_Word OffA_4 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Word OnB_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 0))));
  MR_Word OffB_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__2_2, 1))));
  MR_Word QA_7;
  MR_Word QB_8;
  MR_Word Var_9;
  MR_Word Var_10;
