...
{
  {
    ...
    {
      MR_Word mercury__queue__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word mercury__queue__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word mercury__queue__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word mercury__queue__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word mercury__queue__Var_8;

      mercury__list____Compare____list_1_0(mercury__queue__TypeInfo_for_T_11, &mercury__queue__Var_8, mercury__queue__ArgX1_4, mercury__queue__ArgY1_5);
      ...
      if (mercury__queue__succeeded)
        *mercury__queue__HeadVar__1_1 = mercury__queue__Var_8;
        ...
        mercury__list____Compare____list_1_0(mercury__queue__TypeInfo_for_T_11, mercury__queue__HeadVar__1_1, mercury__queue__ArgX2_6, mercury__queue__ArgY2_7);
    }
  }
}
...
{
  {
    ...
    {
      MR_Word mercury__queue__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word mercury__queue__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word mercury__queue__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word mercury__queue__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__queue__HeadVar__2_2, (MR_Integer) 1)));

      mercury__queue__succeeded = mercury__list____Unify____list_1_0(mercury__queue__TypeInfo_for_T_9, mercury__queue__ArgX1_3, mercury__queue__ArgY1_4);
      if (mercury__queue__succeeded)
        mercury__queue__succeeded = mercury__list____Unify____list_1_0(mercury__queue__TypeInfo_for_T_9, mercury__queue__ArgX2_5, mercury__queue__ArgY2_6);
    }
