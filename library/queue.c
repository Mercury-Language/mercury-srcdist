...
{
  {
    ...
    else
    {
      ...
      mercury__list____Compare____list_1_0(TypeInfo_for_T_11, &Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      else
        mercury__list____Compare____list_1_0(TypeInfo_for_T_11, HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
  ...
  MR_Word * HeadVar__3_3)
{
  {
    MR_bool succeeded;
    MR_Word On0_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0)));
    MR_Word Off0_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1)));
    MR_Word On_7;
    MR_Word Off_8;

    if ((On0_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Var_20;
      MR_Box Var_21;

      succeeded = ((MR_tag((MR_Word) Off0_6)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Var_21 = (MR_hl_field(MR_mktag(1), Off0_6, (MR_Integer) 0));
        Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), Off0_6, (MR_Integer) 1)));
        if ((Var_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          *Elem_4 = Var_21;
          On_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          Off_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          succeeded = MR_TRUE;
        }
        else
        {
          ...
          Var_15 = (N_12 / (MR_Integer) 2);
          succeeded = mercury__list__split_list_4_p_0(TypeInfo_for_T_19, Var_15, Off0_6, &Off_8, &RevOn_13);
          if (succeeded)
          {
            mercury__list__reverse_2_p_0(TypeInfo_for_T_19, RevOn_13, &Var_17);
            succeeded = ((MR_tag((MR_Word) Var_17)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
              *Elem_4 = (MR_hl_field(MR_mktag(1), Var_17, (MR_Integer) 0));
              On_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_17, (MR_Integer) 1)));
            }
          }
        }
      }
    ...
    {
      *Elem_4 = (MR_hl_field(MR_mktag(1), On0_5, (MR_Integer) 0));
      On_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), On0_5, (MR_Integer) 1)));
      Off_8 = Off0_6;
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      {
        ...
        *HeadVar__3_3 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (On_7));
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Off_8));
      }
      succeeded = MR_TRUE;
    }
    return succeeded;
...
{
  {
    MR_Word On_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0)));
    MR_Word Off_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1)));
    MR_Word Var_7;
    ...
    mercury__list__append_3_p_1(TypeInfo_for_T_8, Elems_4, Off_6, &Var_7);
    {
      ...
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__3_3 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (On_5));
...
{
  {
    ...
    MR_Word On_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_0_6, (MR_Integer) 0)));
    MR_Word Off_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_0_6, (MR_Integer) 1)));
    MR_Word Var_13;

    mercury__list__append_3_p_1(TypeInfo_for_T_9, Elems_5, Off_12, &Var_13);
    {
      STATE_VARIABLE_Queue_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 0) = ((MR_Box) (On_11));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 1) = ((MR_Box) (Var_13));
    }
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_7, 0) = Elem_4;
      MR_hl_field(MR_mktag(1), Var_7, 1) = ((MR_Box) (Off_6));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_13, 0) = Elem_5;
      MR_hl_field(MR_mktag(1), Var_13, 1) = ((MR_Box) (Off_12));
    }
    {
      STATE_VARIABLE_Queue_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 0) = ((MR_Box) (On_11));
...
{
  {
    ...
    mercury__queue__delete_all_3_p_0(TypeInfo_for_T_9, T_5, STATE_VARIABLE_Q_0_6, &STATE_VARIABLE_Q_7);
...
{
  {
    ...
    if ((Off1_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
  ...
  MR_Word HeadVar__1_1)
{
  {
    MR_Word HeadVar__2_2;
    MR_Word On_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_Word Off_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    MR_Word Var_5;
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), HeadVar__2_2, 1) = ((MR_Box) (List_3));
    }
    return HeadVar__2_2;
  }
}
...
{
  {
...

    {
      ...
      *HeadVar__2_2 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (List_3));
    }
  }
}
...
{
  {
    ...
    {
      Q_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Q_4, 0) = ((MR_Box) (Var_7));
      MR_hl_field(MR_mktag(0), Q_4, 1) = ((MR_Box) (Xs_3));
    }
    return Q_4;
  }
}
  ...
  MR_Word Q_3)
{
  {
    MR_Integer N_4;
    MR_Word On_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), Q_3, (MR_Integer) 0)));
    MR_Word Off_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), Q_3, (MR_Integer) 1)));
    MR_Integer LengthOn_9;
    MR_Integer LengthOff_10;

    mercury__list__length_acc_3_p_0(TypeInfo_for_T_5, On_7, (MR_Integer) 0, &LengthOn_9);
    mercury__list__length_acc_3_p_0(TypeInfo_for_T_5, Off_8, (MR_Integer) 0, &LengthOff_10);
    N_4 = (MR_Integer) ((MR_Unsigned) LengthOn_9 + (MR_Unsigned) LengthOff_10);
    return N_4;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      *Elem_4 = (MR_hl_field(MR_mktag(1), Var_11, (MR_Integer) 0));
      Off0_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_11, (MR_Integer) 1)));
      if ((Off0_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
...
{
  {
    ...
    if (succeeded)
    {
      *Elem_4 = (MR_hl_field(MR_mktag(1), Var_6, (MR_Integer) 0));
      Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_6, (MR_Integer) 1)));
    }
    return succeeded;
  }
}
  ...
  MR_Word Xs_5)
{
  {
    MR_Word STATE_VARIABLE_Q_7;
    MR_Word On0_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_0_6, (MR_Integer) 0)));
    MR_Word Off0_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_0_6, (MR_Integer) 1)));
    MR_Word On_13;
    MR_Word Off_14;

    if ((Off0_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      On_13 = On0_11;
      Off_14 = Xs_5;
    }
    ...
    {
      Off_14 = Off0_12;
      mercury__queue__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_117_116_95_108_105_115_116_95_50_95_95_91_49_93_95_48_3_p_0(Xs_5, On0_11, &On_13);
    }
    {
      STATE_VARIABLE_Q_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_7, 0) = ((MR_Box) (On_13));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_7, 1) = ((MR_Box) (Off_14));
    }
    return STATE_VARIABLE_Q_7;
  }
}
...
{
  {
    ...
    mercury__queue__put_3_p_0(TypeInfo_for_T_9, T_5, STATE_VARIABLE_Q_0_6, &STATE_VARIABLE_Q_7);
    return STATE_VARIABLE_Q_7;
  }
}
...
{
  {
    ...
    if ((Off0_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        Off_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Off_8, 0) = Elem_4;
        MR_hl_field(MR_mktag(1), Off_8, 1) = ((MR_Box) (Var_11));
      }
    }
    else
    {
      {
        On_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), On_7, 0) = Elem_4;
        MR_hl_field(MR_mktag(1), On_7, 1) = ((MR_Box) (On0_5));
      }
      Off_8 = Off0_6;
    }
    {
  ...
  MR_Word HeadVar__2_2)
{
  {
    MR_bool succeeded;
    MR_Word OnA_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_Word OffA_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    MR_Word OnB_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0)));
    MR_Word OffB_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1)));
    MR_Word QA_7;
    MR_Word QB_8;
    MR_Word Var_9;
    MR_Word Var_10;
...
{
  {
    MR_Word Q_2 = (MR_Word) &mercury__queue_scalar_common_4[0];
    MR_Word Var_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
