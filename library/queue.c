  ...
  MR_Word Elems_5)
{
  ...
  MR_Word On_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_0_6, (MR_Integer) 0))));
  MR_Word Off_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_0_6, (MR_Integer) 1))));
  MR_Word Var_11;
  ...
  mercury__list__append_3_p_1(TypeInfo_for_T_8, Elems_5, Off_10, &Var_11);
  {
    ...
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 0) = ((MR_Box) (On_9));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 1) = ((MR_Box) (Var_11));
  }
  ...
  MR_Box Elem_5)
{
...

  {
    ...
    MR_hl_field(MR_mktag(1), Var_11, 0) = Elem_5;
    MR_hl_field(MR_mktag(1), Var_11, 1) = ((MR_Box) (Off_10));
  }
  {
    STATE_VARIABLE_Queue_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Queue_7, 0) = ((MR_Box) (On_9));
...
{
  MR_Word STATE_VARIABLE_Q_7;
  MR_Word On0_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_0_6, (MR_Integer) 0))));
  MR_Word Off0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_0_6, (MR_Integer) 1))));
  MR_Word On_11;
  MR_Word Off_12;
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_7, 0) = ((MR_Box) (On_11));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Q_7, 1) = ((MR_Box) (Off_12));
  }
  return STATE_VARIABLE_Q_7;
}
