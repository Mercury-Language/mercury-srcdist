...
MR_decl_label8(queue__get_from_back_3_0, 71,8,10,15,16,18,3,70)
...
MR_BEGIN_MODULE(queue_module23)
	...
	MR_init_label8(queue__get_from_back_3_0,71,8,10,15,16,18,3,70)
...
MR_define_entry(mercury__queue__get_from_back_3_0);
	...
	MR_r4 = MR_tempr1;
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(queue__get_from_back_3_0_i70);
	}
	MR_tempr2 = MR_ctfield(1, MR_tempr1, 1);
	if (MR_LTAGS_TESTR(MR_tempr2,0,0)) {
		MR_GOTO_LAB(queue__get_from_back_3_0_i71);
	}
...
MR_def_label(queue__get_from_back_3_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
;}
#line 1170 "queue.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(queue__get_from_back_3_0_i10);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	if (MR_INT_NE((MR_Integer) 2,0)) {
		MR_GOTO_LAB(queue__get_from_back_3_0_i10);
	}
...
MR_def_label(queue__get_from_back_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
...
MR_def_label(queue__get_from_back_3_0,15)
	...
	MR_np_call_localret_ent(list__split_list_4_0,
		queue__get_from_back_3_0_i16);
MR_def_label(queue__get_from_back_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(list__reverse_2_3_0,
		queue__get_from_back_3_0_i18);
MR_def_label(queue__get_from_back_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(queue__get_from_back_3_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
