...
MR_decl_label7(queue__get_from_back_3_0, 42,8,9,11,3,41,1)
...
MR_BEGIN_MODULE(queue_module23)
	...
	MR_init_label7(queue__get_from_back_3_0,42,8,9,11,3,41,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__queue__get_from_back_3_0);
	...
	MR_r4 = MR_tempr1;
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(queue__get_from_back_3_0_i41);
	}
	MR_tempr2 = MR_ctfield(1, MR_tempr1, 1);
	if (MR_LTAGS_TESTR(MR_tempr2,0,0)) {
		MR_GOTO_LAB(queue__get_from_back_3_0_i42);
	}
...
MR_def_label(queue__get_from_back_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(queue__get_from_back_3_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
