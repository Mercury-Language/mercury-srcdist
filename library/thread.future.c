  ...
  MR_Word Func_4)
{
  ...
  if (((MR_tag((MR_Word) TryResult_7)) == (MR_Integer) 2))
  {
    ...
    switch (Ready_41) {
      ...
      case (MR_Integer) 1:
        {
          mercury__mutvar__set_mutvar_2_p_0(TypeInfo_17_17, (MR_Word) (MValue_40), ((MR_Box) (Var_11)));
  ...
  else
  {
    ...
    switch (Ready_30) {
      ...
      case (MR_Integer) 1:
        {
          mercury__mutvar__set_mutvar_2_p_0(TypeInfo_14_14, (MR_Word) (MValue_29), ((MR_Box) (Var_10)));
...
#undef MR_PROC_LABEL
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&mercury__thread__future_scalar_common_8[0]));
    MR_hl_field(MR_mktag(0), Var_22, 1) = ((MR_Box) (mercury__thread__future__future_1_f_0_3));
    MR_hl_field(MR_mktag(0), Var_22, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_22, 3) = ((MR_Box) (Var_18));
  }
  ...
  if (succeeded)
  {
    ...
    mercury__thread__spawn_context_2_5_p_0(Var_22, &Var_41, &Var_42);
    switch (Var_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Var_29 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__thread__future_scalar_common_5[0]));
        break;
      case (MR_Integer) 1:
        {
          MR_Word Var_43 = (MR_Word) (Var_42);

          {
            Var_29 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (Var_43));
          }
        }
        break;
    }
  ...
  else
  {
    ...
    mercury__thread__spawn_native_2_7_p_0(Var_22, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Var_57, &Var_58, &Var_59);
    switch (Var_57) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (Var_59));
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          {
            Var_29 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (Var_60));
          }
        }
        break;
    }
  ...
  {
    MR_String Var_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_29, (MR_Integer) 0))));

    mercury__require__unexpected_2_p_0((MR_String) "predicate \140thread.spawn\'/3", Var_31);
  }
{
#define MR_PROC_LABEL mercury__thread__future__future_1_f_0
