  ...
  MR_Word Func_4)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_22_22, 1) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), TypeInfo_22_22, 2) = ((MR_Box) (TypeInfo_for_T_12));
  }
  ...
  if (((MR_tag((MR_Word) TryResult_7)) == (MR_Integer) 2))
  {
    ...
    switch (Ready_36) {
      ...
      case (MR_Integer) 1:
        {
          mercury__mutvar__set_mutvar_2_p_0(TypeInfo_17_17, (MR_Word) (MValue_35), ((MR_Box) (Var_9)));
  ...
  else
  {
    ...
    switch (Ready_29) {
      ...
      case (MR_Integer) 1:
        {
          mercury__mutvar__set_mutvar_2_p_0(TypeInfo_14_14, (MR_Word) (MValue_28), ((MR_Box) (Var_11)));
