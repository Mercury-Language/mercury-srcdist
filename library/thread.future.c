...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      mercury__thread__spawn_native_2_5_p_0(V_6_24, &V_8_58, &V_9_59);
      switch (V_8_58) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            V_9_31 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__thread__future_scalar_common_8[1]);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word V_14_60 = (MR_Word) V_9_59;

            {
              V_9_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), V_9_31, 0) = ((MR_Box) (V_14_60));
            }
          }
          break;
      }
