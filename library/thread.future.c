  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Word TypeInfo_15_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
    MR_Box Var_19 = (MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1));

    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      MR_Word TypeInfo_16_16 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
      MR_Box ArgY1_11 = (MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1));
  ...
  {
    MR_Box Var_21 = (MR_hl_field(0, HeadVar__2_2, (MR_Integer) 0));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mercury__thread__future__IntroducedFrom__pred__spawn__90__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
}
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_hl_field(1, Var_19, 0) = ((MR_Box) (Var_31));
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          {
            Var_19 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_19, 0) = ((MR_Box) (Var_32));
          }
        }
        break;
    }
