...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&mercury__thread__future_scalar_common_1[0]), &Var_10, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
...
{
  {
    ...
    mercury__mutvar__get_mutvar_2_p_0((MR_Word) (&mercury__thread__future__thread__future__type_ctor_info_ready_0), MReady_13, &conv0_Ready_16);
