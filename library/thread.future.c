...
#undef MR_PROC_LABEL
  ...
  else
  {
    ...
    mercury__thread__spawn_native_2_8_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_18, (MR_Unsigned) ((MR_Word) (((MR_Box) ((MR_Unsigned) 0U)))), &Var_30, &Var_31, &Var_32);
    switch (Var_30) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
