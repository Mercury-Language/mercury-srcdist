  ...
  MR_Box * wrapper_arg_1)
{
  ...
  mercury__thread__future__IntroducedFrom__pred__run_future__130__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), &conv0_OutputTuple_18);
