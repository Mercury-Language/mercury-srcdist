...
static /* final */ const MR_Box mercury__thread__future_scalar_common_8[1][1];
...
mercury__thread__future__IntroducedFrom__pred__spawn__70__1_4_p_0(
  ...
  MR_Word LambdaHeadVar__1_19)
{
  mercury__thread__future__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_73_110_116_114_111_100_117_99_101_100_70_114_111_109_95_95_112_114_101_100_95_95_115_112_97_119_110_95_95_55_48_95_95_49_95_95_91_50_93_95_48_4_p_0(V_4_4);
}
...
{
  {
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), V_4_4, (MR_Integer) 1)));
    MR_Box conv1_LambdaHeadVar__3_21;

    func_0(((MR_Box) V_4_4), ((MR_Box) ((MR_Integer) 0)), &conv1_LambdaHeadVar__3_21);
  }
}
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_9_9 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ok_or_exception_1;
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_10;
      MR_Word TypeInfo_15_15 = (MR_Word) &mercury__thread__future_scalar_common_1[0];

      mercury__builtin__compare_3_p_0(TypeInfo_15_15, &Var_10, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
...
{
  {
    ...
    {
      MR_Word TypeCtorInfo_8_8 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ok_or_exception_1;
...
{
  {
    ...
    {
      MR_Word TypeInfo_12_12 = (MR_Word) &mercury__thread__future_scalar_common_1[0];
...
{
  {
    MR_Word TypeCtorInfo_10_10 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    ...
    mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_10_10, MReady_5, &conv0_Ready_8);
...
{
  {
    ...
    mercury__thread__future__IntroducedFrom__pred__run_future__131__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), &conv0_OutputTuple_18);
...
{
  {
    ...
    {
      TryLambda_19 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TryLambda_19, 0) = ((MR_Box) (&mercury__thread__future_scalar_common_6[2]));
      MR_hl_field(MR_mktag(0), TryLambda_19, 1) = ((MR_Box) (mercury__thread__future__run_future_2_p_0_1));
      MR_hl_field(MR_mktag(0), TryLambda_19, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
    ...
    if (((MR_tag((MR_Word) TryResult_7)) == (MR_mktag((MR_Integer) 2))))
    {
      ...
      TypeCtorInfo_16_16 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ok_or_exception_1;
      {
      ...
      TypeCtorInfo_11_44 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
      mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_11_44, MReady_38, &conv2_Ready_41);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__mutvar__set_mutvar_2_p_0(TypeCtorInfo_11_44, MReady_38, ((MR_Box) ((MR_Integer) 0)));
          }
          break;
        case (MR_Integer) 0:
          {
    ...
    else
    {
      ...
      TypeCtorInfo_13_13 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ok_or_exception_1;
      {
      ...
      TypeCtorInfo_11_33 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
      mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_11_33, MReady_27, &conv3_Ready_30);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__mutvar__set_mutvar_2_p_0(TypeCtorInfo_11_33, MReady_27, ((MR_Box) ((MR_Integer) 0)));
          }
          break;
        case (MR_Integer) 0:
          {
...
{
  {
    MR_Word TypeCtorInfo_10_17 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    MR_Word MReady_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Future_5, (MR_Integer) 0)));
    MR_Box Wait_14 = ((MR_Box) (MR_hl_field(MR_mktag(0), Future_5, (MR_Integer) 1)));
    MR_Word MValue_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), Future_5, (MR_Integer) 2)));
    MR_Word Ready_16;
    MR_Box conv0_Ready_16;

    mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_10_17, MReady_13, &conv0_Ready_16);
    Ready_16 = ((MR_Word) conv0_Ready_16);
    switch (Ready_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          mercury__thread__semaphore__impure_wait_1_p_0(Wait_14);
          mercury__thread__semaphore__impure_signal_1_p_0(Wait_14);
        }
        break;
      case (MR_Integer) 0:
        {
    ...
    mercury__mutvar__get_mutvar_2_p_0(TypeInfo_for_T_10, MValue_15, Value_6);
  }
}
...
{
  {
    MR_Word TypeCtorInfo_11_18 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    ...
    mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_11_18, MReady_12, &conv0_Ready_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__mutvar__set_mutvar_2_p_0(TypeCtorInfo_11_18, MReady_12, ((MR_Box) ((MR_Integer) 0)));
        }
        break;
      case (MR_Integer) 0:
        {
...
{
  {
    MR_Word TypeCtorInfo_7_13 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    MR_Word Ready_9;
    MR_Box Wait_10;
    MR_Word Value_11;

    mercury__mutvar__new_mutvar_2_p_1(TypeCtorInfo_7_13, ((MR_Box) ((MR_Integer) 1)), &Ready_9);
...
{
  {
    ...
    MReady_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Future_3, (MR_Integer) 0)));
    Wait_14 = ((MR_Box) (MR_hl_field(MR_mktag(0), Future_3, (MR_Integer) 1)));
    MValue_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), Future_3, (MR_Integer) 2)));
    TypeCtorInfo_10_17 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    mercury__mutvar__get_mutvar_2_p_0(TypeCtorInfo_10_17, MReady_13, &conv0_Ready_16);
    Ready_16 = ((MR_Word) conv0_Ready_16);
    switch (Ready_16) {
      default: /*NOTREACHED*/ MR_assert(0);
    ...
    mercury__mutvar__get_mutvar_2_p_0(TypeInfo_9_9, (MR_Word) MValue_15, &conv1_Result_5);
    Result_5 = ((MR_Word) conv1_Result_5);
    if (((MR_tag((MR_Word) Result_5)) == (MR_mktag((MR_Integer) 1))))
    {
...
{
  {
    ...
    mercury__thread__future__IntroducedFrom__pred__spawn__70__1_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
  }
}
...
{
  {
    ...
    TypeCtorInfo_7_14 = (MR_Word) &mercury__thread__future__thread__future__type_ctor_info_ready_0;
    mercury__mutvar__new_mutvar_2_p_1(TypeCtorInfo_7_14, ((MR_Box) ((MR_Integer) 1)), &Ready_10);
    ...
    {
      FutureIO_5 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      Var_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_6, 0) = ((MR_Box) (&mercury__thread__future_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_6, 1) = ((MR_Box) (mercury__thread__future__future_1_f_0_1));
      MR_hl_field(MR_mktag(0), Var_6, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
...
#undef MR_PROC_LABEL
}
    {
      ...
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&mercury__thread__future_scalar_common_6[1]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), V_6_24, 0) = ((MR_Box) (&mercury__thread__future_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), V_6_24, 1) = ((MR_Box) (mercury__thread__future__future_1_f_0_3));
      MR_hl_field(MR_mktag(0), V_6_24, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), V_6_24, 3) = ((MR_Box) (Var_18));
    }
    ...
    if (succeeded)
    {
      ...
      mercury__thread__spawn_context_2_5_p_0(V_6_24, &V_8_50, &V_9_51);
      switch (V_8_50) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            V_9_31 = (MR_Word) MR_mkword(MR_mktag(1), &mercury__thread__future_scalar_common_8[0]);
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word V_14_52 = (MR_Word) V_9_51;

            {
              V_9_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), V_9_31, 0) = ((MR_Box) (V_14_52));
            }
          }
          break;
      }
    ...
    else
    {
      ...
      mercury__thread__spawn_native_2_6_p_0(V_6_24, &V_8_58, &V_9_59, &V_10_60);
      switch (V_8_58) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            V_9_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), V_9_31, 0) = ((MR_Box) (V_10_60));
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word V_14_61 = (MR_Word) V_9_59;

            {
              V_9_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), V_9_31, 0) = ((MR_Box) (V_14_61));
            }
          }
          break;
      }
    }
    if (((MR_tag((MR_Word) V_9_31)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String V_11_33 = ((MR_String) (MR_hl_field(MR_mktag(1), V_9_31, (MR_Integer) 0)));

      mercury__require__unexpected_3_p_0((MR_String) "thread", (MR_String) "predicate \140thread.spawn\'/3", V_11_33);
    }
    else
    {
    }
