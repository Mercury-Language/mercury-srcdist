...
#undef MR_PROC_LABEL
	 V_10_10  = SubString;
      ...
      else
      {
        ...
        mercury__string__format__words_loop__ho4_4_p_in__string_0(V_6_6, V_11_11, &V_12_13);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *V_8_8 = base;
...
#undef MR_PROC_LABEL
	 V_10_10  = SubString;
      ...
      else
      {
        ...
        mercury__string__format__words_loop__ho6_4_p_in__string_0(V_6_6, V_11_11, &V_12_13);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *V_8_8 = base;
