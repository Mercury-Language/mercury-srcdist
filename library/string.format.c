...
{
  {
    ...
    mercury__integer____Compare____integer_0_0(&Var_17, Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[1]));
    ...
    if (succeeded)
    {
      ...
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[7]), &Var_10, &Var_33);
      Var_9 = mercury__integer__det_to_int_1_f_0(Var_10);
      FrontDigitsStr_6 = mercury__string__format__abs_int_to_hex_uc_1_f_0(Var_9);
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[7]), &Var_40, &Var_12);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[3]), &Var_10, &Var_33);
      Var_9 = mercury__integer__det_to_int_1_f_0(Var_10);
      FrontDigitsStr_6 = mercury__string__format__abs_int_to_decimal_1_f_0(Var_9);
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[3]), &Var_40, &Var_12);
      Var_11 = mercury__integer__det_to_int_1_f_0(Var_12);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[5]), &Var_10, &Var_33);
      Var_9 = mercury__integer__det_to_int_1_f_0(Var_10);
      FrontDigitsStr_6 = mercury__string__format__abs_int_to_octal_1_f_0(Var_9);
      mercury__integer__big_quot_rem_4_p_0(Num_3, (MR_Word) (&mercury__string__format_scalar_common_4[5]), &Var_40, &Var_12);
      Var_11 = mercury__integer__det_to_int_1_f_0(Var_12);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer____Compare____integer_0_0(&Var_60, AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_4[1]));
        ...
        if (succeeded)
        {
          ...
          mercury__integer__big_quot_rem_4_p_0(AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_4[3]), &Var_53, &Var_76);
          ...
          mercury__integer__big_quot_rem_4_p_0(AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_4[3]), &Var_83, &Var_55);
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__string__split_by_codepoint_4_p_0(Str_9, NumChars_34, &PrecStr_35, &Var_42);
      }
