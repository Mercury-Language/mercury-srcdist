...
succeeded  = SUCCESS_INDICATOR;
      ...
      else
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 3:
            {
              ...
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
        ...
        else
        {
          ...
          MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          else
          {
            ...
            MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_9, (MR_Integer) 0)));
    ...
    else
    {
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_9, (MR_Integer) 0)));
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
      ...
      else
      {
        ...
        MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_5, (MR_Integer) 0)));
