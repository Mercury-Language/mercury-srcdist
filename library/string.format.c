...
mercury__string__format__sized_int_to_uint_1_f_0(
  MR_Word SizedInt_3);
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_String SpecChar_13 = ((&mercury__string__format_vector_common_5[37 + Base_10]))->mercury__string__format__vector_common_type_5_0__vct_5_f_0;
      MR_String FormatStr_14;
      MR_String Var_16;
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Flags_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 1))));
              MR_Word MaybeWidth_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 2))));
              MR_Word MaybePrec_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 3))));
              MR_Word SizedInt_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 5))));
              int64_t Int64_19;

              succeeded = ((((MR_tag((MR_Word) SizedInt_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SizedInt_23, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Int64_19 = MR_unbox_int64((MR_hl_field(MR_mktag(3), SizedInt_23, (MR_Integer) 1)));
                mercury__string__format__format_unsigned_int64_component_6_p_0(Flags_20, MaybeWidth_21, MaybePrec_22, Base_11, Int64_19, String_4);
              }
              else
              {
                MR_Unsigned UInt_12;

                UInt_12 = mercury__string__format__sized_int_to_uint_1_f_0(SizedInt_23);
                mercury__string__format__format_uint_component_6_p_0(Flags_20, MaybeWidth_21, MaybePrec_22, Base_11, UInt_12, String_4);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word SizedUInt_13 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 5))));
              ...
              succeeded = ((((MR_tag((MR_Word) SizedUInt_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SizedUInt_13, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                UInt64_14 = MR_unbox_uint64((MR_hl_field(MR_mktag(3), SizedUInt_13, (MR_Integer) 1)));
                mercury__string__format__format_uint64_component_6_p_0(Flags_27, MaybeWidth_28, MaybePrec_29, Base_30, UInt64_14, String_4);
              }
              else
              {
                MR_Unsigned UInt_25;

                switch (MR_tag((MR_Word) SizedUInt_13)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    UInt_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SizedUInt_13, (MR_Integer) 0))));
                    break;
                  case (MR_Integer) 1:
                    {
                      uint8_t UInt8_85 = ((uint8_t) (MR_Word) (MR_hl_field(MR_mktag(1), SizedUInt_13, (MR_Integer) 0)));
...
#undef MR_PROC_LABEL
	 UInt_25  = U;
                  ...
                  case (MR_Integer) 2:
                    {
                      uint16_t UInt16_86 = ((uint16_t) (MR_Word) (MR_hl_field(MR_mktag(2), SizedUInt_13, (MR_Integer) 0)));
...
#undef MR_PROC_LABEL
	 UInt_25  = U;
                    ...
                    break;
                  case (MR_Integer) 3:
                    switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SizedUInt_13, (MR_Integer) 0))))) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        {
                          uint32_t UInt32_87 = ((uint32_t) (MR_Word) (MR_hl_field(MR_mktag(3), SizedUInt_13, (MR_Integer) 1)));
...
#undef MR_PROC_LABEL
	 UInt_25  = U;
                ...
                mercury__string__format__format_uint_component_6_p_0(Flags_27, MaybeWidth_28, MaybePrec_29, Base_30, UInt_25, String_4);
              }
            }
            break;
          case (MR_Integer) 3:
...
{
  {
    ...
    switch (MR_tag((MR_Word) SizedInt_3)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Integer Int_5 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), SizedInt_3, (MR_Integer) 0))));

{
#define MR_PROC_LABEL mercury__string__format__sized_int_to_uint_1_f_0
...
#undef MR_PROC_LABEL
	 UInt_4  = U;
      ...
      case (MR_Integer) 1:
        {
          int8_t Int8_6 = ((int8_t) (MR_Word) (MR_hl_field(MR_mktag(1), SizedInt_3, (MR_Integer) 0)));
          uint8_t Var_23;
...
#undef MR_PROC_LABEL
	 UInt_4  = U;
      ...
      case (MR_Integer) 2:
        {
          int16_t Int16_7 = ((int16_t) (MR_Word) (MR_hl_field(MR_mktag(2), SizedInt_3, (MR_Integer) 0)));
          uint16_t Var_17;
	 ...
	 UInt_4  = U;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), SizedInt_3, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              int32_t Int32_8 = ((int32_t) (MR_Word) (MR_hl_field(MR_mktag(3), SizedInt_3, (MR_Integer) 1)));
              uint32_t Var_20;
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            DecimalPrime_86 = ((&mercury__string__format_vector_common_5[27 + Var_54]))->mercury__string__format__vector_common_type_5_0__vct_5_f_0;
            succeeded = MR_TRUE;
          }
          else
            succeeded = MR_FALSE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        DecimalPrime_26 = ((&mercury__string__format_vector_common_5[17 + Var_10]))->mercury__string__format__vector_common_type_5_0__vct_5_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
