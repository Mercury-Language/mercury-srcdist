...
succeeded  = SUCCESS_INDICATOR;
      ...
      else
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) MaybePrec_9)) == (MR_Integer) 1);
                if (succeeded)
                {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeWidth_8)) == (MR_Integer) 1);
        if (succeeded)
        {
  ...
  MR_Word CharNum_3)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) CharNum_3)) == (MR_Integer) 1);
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) CharNum_3)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybePrec_8)) == (MR_Integer) 1);
      if (succeeded)
      {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeWidth_7)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) MaybeWidth_6)) == (MR_Integer) 1);
