...
static /* final */ const MR_Box mercury__string__format_scalar_common_5[3][2];
...
static /* final */ const struct mercury__string__format__vector_common_type_4_0_s mercury__string__format_vector_common_4[42];
...
static /* final */ const MR_Box mercury__string__format_scalar_common_5[3][2] = {
  ...
  {
    ((MR_Box) ((MR_Integer) 1)),
    ((MR_Box) (MR_mkword(MR_mktag(1), &mercury__string__format_scalar_common_5[1])))
  },
};
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__integer____Compare____integer_0_0(&Var_60, AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_5[0]));
        ...
        if (succeeded)
        {
          ...
          mercury__integer__big_quot_rem_4_p_0(AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_5[2]), &Var_53, &Var_76);
          ...
          mercury__integer__big_quot_rem_4_p_0(AbsInteger_13, (MR_Word) (&mercury__string__format_scalar_common_5[2]), &Var_83, &Var_55);
          Var_54 = mercury__integer__det_to_int_1_f_0(Var_55);
          if ((((MR_Unsigned) Var_54) <= ((MR_Unsigned) 9)))
          {
            DecimalPrime_86 = ((&mercury__string__format_vector_common_4[32 + Var_54]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
            succeeded = MR_TRUE;
          }
          else
            succeeded = MR_FALSE;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        DecimalPrime_26 = ((&mercury__string__format_vector_common_4[22 + Var_10]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_String SpecChar_13 = ((&mercury__string__format_vector_common_4[16 + Kind_10]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
      MR_String FormatStr_14;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
      SignedStr_13 = ((&mercury__string__format_vector_common_4[10 + Kind_10]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
    else
    {
{
#define MR_PROC_LABEL mercury__string__format__format_float_5_f_0
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_String SpecChar_13 = ((&mercury__string__format_vector_common_4[5 + Base_10]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
      MR_String FormatStr_14;
      MR_String Var_15;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      MR_String SpecChar_13 = ((&mercury__string__format_vector_common_4[0 + Base_10]))->mercury__string__format__vector_common_type_4_0__vct_4_f_0;
      MR_String FormatStr_14;
      MR_String Var_16;
