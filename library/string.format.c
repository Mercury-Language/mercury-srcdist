...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      mercury__string__format__LCMC__pred__words_loop__ho4__1_4_p_0(HeadVar__2_6, Var_11, AddrSCCcallarg13_14);
    }
  }
}
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      AddrSCCcallarg13_14 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__4_8, (MR_Integer) 1)));
      mercury__string__format__LCMC__pred__words_loop__ho6__1_4_p_0(HeadVar__2_6, Var_11, AddrSCCcallarg13_14);
    }
  }
}
