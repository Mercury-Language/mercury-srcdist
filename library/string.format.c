          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 4)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Spec_3, (MR_Integer) 4)));
...
succeeded  = SUCCESS_INDICATOR;
      ...
      else
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 3:
            {
              ...
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
        ...
        else
        {
          ...
          MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
          ...
          else
          {
            ...
            MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_9, (MR_Integer) 0)));
    ...
    else
    {
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_9, (MR_Integer) 0)));
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
    ...
    else
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
      ...
      else
      {
        ...
        MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_6, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_5, (MR_Integer) 0)));
