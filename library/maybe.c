...
MR_decl_label6(__Compare___maybe__maybe_error_1_0, 5,26,10,21,11,22)
...
MR_BEGIN_MODULE(maybe_module18)
	...
	MR_init_label6(__Compare___maybe__maybe_error_1_0,5,26,10,21,11,22)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___maybe__maybe_error_1_0);
	...
	MR_sv(4) = (MR_Word) MR_succip;
	if ((MR_r2 == MR_r3)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i22);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r2;
...
MR_def_label(__Compare___maybe__maybe_error_1_0,5)
	...
	if (MR_PTAG_TESTR(MR_sv(2),0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i10);
	}
MR_def_label(__Compare___maybe__maybe_error_1_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___maybe__maybe_error_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_ctfield(1, MR_sv(1), 0);
	{
	MR_Word MR_tempr1;
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i11);
	}
	}
MR_def_label(__Compare___maybe__maybe_error_1_0,21)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(4);
MR_def_label(__Compare___maybe__maybe_error_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i26);
	}
MR_def_label(__Compare___maybe__maybe_error_1_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
