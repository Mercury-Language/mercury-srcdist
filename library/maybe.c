...
{
  {
    ...
    mercury__maybe____Compare____maybe_errors_2_0(TypeInfo_for_T_6, TypeCtorInfo_7_7, HeadVar__1_1, Cast_HeadVar1_4, Cast_HeadVar2_5);
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_for_E_20, &Var_16, Var_24, ArgY1_13);
        succeeded = (Var_16 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
          *HeadVar__1_1 = Var_16;
        else
          mercury__list____Compare____list_1_0(TypeInfo_for_E_20, HeadVar__1_1, Var_23, ArgY2_15);
      }
      else
...
{
  {
    ...
    succeeded = mercury__maybe____Unify____maybe_errors_2_0(TypeInfo_for_T_5, TypeCtorInfo_6_6, Cast_HeadVar1_3, Cast_HeadVar2_4);
    return succeeded;
  }
}
...
{
  {
    ...
    mercury__maybe____Compare____maybe_error_2_0(TypeInfo_for_T_6, TypeCtorInfo_7_7, HeadVar__1_1, Cast_HeadVar1_4, Cast_HeadVar2_5);
  }
}
...
{
  {
    ...
    succeeded = mercury__maybe____Unify____maybe_error_2_0(TypeInfo_for_T_5, TypeCtorInfo_6_6, Cast_HeadVar1_3, Cast_HeadVar2_4);
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
      {
        Result_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *((env).mercury__maybe__map_maybe_3_p_3_env_0__HeadVar__3_3) = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...
{
  {
    ...
    if ((HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *((env).mercury__maybe__map_maybe_3_p_2_env_0__HeadVar__3_3) = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
