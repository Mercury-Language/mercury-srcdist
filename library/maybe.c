...
MR_decl_label2(maybe__map_fold2_maybe_7_0, 12,4)
MR_decl_label2(maybe__map_fold_maybe_5_0, 12,4)
MR_decl_label2(maybe__map_maybe_3_0, 12,4)
MR_decl_label3(maybe__map_maybe_3_1, 17,4,1)
MR_decl_label2(maybe__map_maybe_3_2, 11,3)
MR_decl_label1(fn__maybe__fold_maybe_3_0, 3)
MR_decl_label2(fn__maybe__map_maybe_2_0, 12,4)
MR_decl_label2(__Unify___maybe__maybe_1_0, 3,1)
MR_decl_label2(__Unify___maybe__maybe_error_0_0, 3,1)
MR_decl_label2(__Unify___maybe__maybe_error_1_0, 3,1)
MR_decl_label3(__Compare___maybe__maybe_1_0, 5,3,7)
MR_decl_label5(__Compare___maybe__maybe_error_0_0, 3,15,7,16,8)
MR_decl_label5(__Compare___maybe__maybe_error_1_0, 3,21,8,17,9)
...
MR_BEGIN_MODULE(maybe_module0)
	...
	MR_init_label2(maybe__map_maybe_3_0,12,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__maybe__map_maybe_3_0);
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(maybe__map_maybe_3_0_i12);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(maybe__map_maybe_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
...
MR_BEGIN_MODULE(maybe_module1)
	...
	MR_init_label3(maybe__map_maybe_3_1,17,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__maybe__map_maybe_3_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(maybe__map_maybe_3_1_i17);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(maybe__map_maybe_3_1,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = MR_r3;
...
MR_BEGIN_MODULE(maybe_module2)
	...
	MR_init_label2(maybe__map_maybe_3_2,11,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__maybe__map_maybe_3_2);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(maybe__map_maybe_3_2_i11);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(maybe__map_maybe_3_2,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(maybe_module4)
	...
	MR_init_label2(fn__maybe__map_maybe_2_0,12,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__maybe__map_maybe_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(fn__maybe__map_maybe_2_0_i12);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__maybe__map_maybe_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = MR_r3;
...
MR_BEGIN_MODULE(maybe_module9)
	...
	MR_init_label2(maybe__map_fold_maybe_5_0,12,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__maybe__map_fold_maybe_5_0);
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(maybe__map_fold_maybe_5_0_i12);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(maybe__map_fold_maybe_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = MR_r4;
...
MR_BEGIN_MODULE(maybe_module11)
	...
	MR_init_label2(maybe__map_fold2_maybe_7_0,12,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__maybe__map_fold2_maybe_7_0);
	...
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(maybe__map_fold2_maybe_7_0_i12);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r7;
	MR_r3 = MR_r8;
	MR_proceed();
MR_def_label(maybe__map_fold2_maybe_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = MR_r5;
...
MR_BEGIN_MODULE(maybe_module13)
	...
	MR_init_label2(__Unify___maybe__maybe_1_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___maybe__maybe_1_0);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Unify___maybe__maybe_1_0_i3);
	}
	MR_r1 = (MR_r3 == MR_r2);
	MR_proceed();
MR_def_label(__Unify___maybe__maybe_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(maybe_module14)
	...
	MR_init_label3(__Compare___maybe__maybe_1_0,5,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___maybe__maybe_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_1_0_i3);
	}
...
MR_def_label(__Compare___maybe__maybe_1_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___maybe__maybe_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
...
MR_BEGIN_MODULE(maybe_module15)
	...
	MR_init_label2(__Unify___maybe__maybe_error_0_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___maybe__maybe_error_0_0);
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Unify___maybe__maybe_error_0_0_i3);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___maybe__maybe_error_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(maybe_module16)
	...
	MR_init_label5(__Compare___maybe__maybe_error_0_0,3,15,7,16,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___maybe__maybe_error_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_0_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_0_0_i16);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___maybe__maybe_error_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_0_0_i7);
	}
MR_def_label(__Compare___maybe__maybe_error_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___maybe__maybe_error_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_0_0_i8);
	}
	}
MR_def_label(__Compare___maybe__maybe_error_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___maybe__maybe_error_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_0_0_i15);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(maybe_module17)
	...
	MR_init_label2(__Unify___maybe__maybe_error_1_0,3,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___maybe__maybe_error_1_0);
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Unify___maybe__maybe_error_1_0_i3);
	}
	...
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___maybe__maybe_error_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(maybe_module18)
	...
	MR_init_label5(__Compare___maybe__maybe_error_1_0,3,21,8,17,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___maybe__maybe_error_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i3);
	}
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i17);
	}
	MR_r2 = MR_ctfield(0, MR_r2, 0);
	MR_r3 = MR_ctfield(0, MR_r3, 0);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___maybe__maybe_error_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i8);
	}
MR_def_label(__Compare___maybe__maybe_error_1_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_GE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i9);
	}
	}
MR_def_label(__Compare___maybe__maybe_error_1_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___maybe__maybe_error_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___maybe__maybe_error_1_0_i21);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__maybe__write_out_proc_statics(FILE *fp);
#endif
