...
#undef MR_PROC_LABEL
  ...
  mercury__bit_buffer__write__foldl2__ho1_6_p_in__list_0(Var_16, Index_7, &Var_8, STATE_VARIABLE_BM_14_14, &STATE_VARIABLE_BM_9);
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      mercury__bit_buffer__write__flush_chunk_to_stream_2_p_0(TypeClassInfo_for_writer_10, STATE_VARIABLE_Buffer_0_4, &STATE_VARIABLE_Buffer_9_9);
      // direct tailcall eliminated
      ;
...
#undef MR_PROC_LABEL
	STATE_VARIABLE_Buffer_19_19  = (MR_Box) Buffer;
      ...
      mercury__bit_buffer__write__maybe_make_room_2_p_0(TypeClassInfo_for_writer_23, STATE_VARIABLE_Buffer_19_19, &STATE_VARIABLE_Buffer_20_20);
...
#undef MR_PROC_LABEL
  ...
  mercury__bit_buffer__write__maybe_make_room_2_p_0(TypeClassInfo_for_writer_15, STATE_VARIABLE_Buffer_14_14, &STATE_VARIABLE_Buffer_13);
...
#undef MR_PROC_LABEL
    ...
    Var_19 = Var_22;
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_writer_27, (MR_Integer) 0)), (MR_Integer) 5))));
