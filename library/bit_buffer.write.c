...
{
{
MR_CTOR_ADDR(bit_buffer__write, write_buffer, 2),
...
void mercury__bit_buffer__write__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__bit_buffer__write);
