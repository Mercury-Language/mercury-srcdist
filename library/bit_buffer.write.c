...
MR_decl_label3(bit_buffer__write__list__foldl2__ho2_6_0, 11,4,3)
...
{
#line 90 "bit_buffer.opt"
Pos = Buffer->ML_bit_buffer_pos;;}
#line 486 "bit_buffer.write.c"
...
{
#line 89 "bit_buffer.opt"
BM = Buffer->ML_bit_buffer_bitmap;;}
#line 954 "bit_buffer.write.c"
	MR_RELEASE_GLOBAL_LOCK("bitmap");
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_BitmapPtr, BM, MR_tempr3);
#undef	MR_PROC_LABEL
	}
	{
	ML_BitBufferPtr	Buffer;
...
#line 89 "bit_buffer.opt"
BM = Buffer->ML_bit_buffer_bitmap;;}
#line 1312 "bit_buffer.write.c"
	MR_RELEASE_GLOBAL_LOCK("bitmap");
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_BitmapPtr, BM, MR_r7);
#undef	MR_PROC_LABEL
	}
	{
	ML_BitBufferPtr	Buffer;
...
MR_BEGIN_MODULE(bit_buffer__write_module22)
	...
	MR_init_label3(bit_buffer__write__list__foldl2__ho2_6_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(bit_buffer__write__list__foldl2__ho2_6_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(bit_buffer__write__list__foldl2__ho2_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(bit_buffer__write__list__foldl2__ho2_6_0,4)
	...
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(bit_buffer__write__list__foldl2__ho2_6_0_i11);
...
void mercury__bit_buffer__write__write_out_proc_statics(FILE *fp);
#endif
