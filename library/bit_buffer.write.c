...
#undef MR_PROC_LABEL
  ...
  STATE_VARIABLE_Buffer_0_15 = (MR_Box) (STATE_VARIABLE_Buffer_0_6);
  mercury__bit_buffer__write__put_bitmap_2_5_p_0(TypeClassInfo_for_writer_10, BM_4, (MR_Integer) 0, Var_9, STATE_VARIABLE_Buffer_0_15, &STATE_VARIABLE_Buffer_16);
  *STATE_VARIABLE_Buffer_7 = (MR_Word) (STATE_VARIABLE_Buffer_16);
}
...
#undef MR_PROC_LABEL
    ...
    Var_61 = (MR_Integer) ((MR_Unsigned) 0 * (MR_Unsigned) 8);
    Var_62 = (MR_Integer) ((MR_Unsigned) NumBytes_7 * (MR_Unsigned) 8);
    Var_18 = mercury__bitmap__slice_3_f_0(Var_20, Var_61, Var_62);
{
#define MR_PROC_LABEL mercury__bit_buffer__write__flush_chunk_to_stream_2_p_0
...
#undef MR_PROC_LABEL
	Var_24  = NumBits;
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) Var_24);
      // direct tailcall eliminated
      ;
