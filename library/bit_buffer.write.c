...
MR_decl_label6(bit_buffer__write__maybe_make_room_2_0, 6,7,8,9,26,3)
...
MR_decl_static(bit_buffer__write__maybe_make_room_2_0)
...
;}
#line 694 "bit_buffer.write.c"
	MR_RELEASE_GLOBAL_LOCK("bitmap");
	MR_tempr2 = (MR_Word) BM;
#undef	MR_PROC_LABEL
	}
	MR_tempr4 = MR_r1;
	MR_sv(2) = ((MR_Integer) MR_tempr4 * (MR_Integer) 8);
	MR_sv(3) = MR_tempr1;
	MR_tempr3 = MR_tempr4;
	MR_r1 = MR_tempr2;
	MR_r2 = (MR_Integer) 0;
...
MR_BEGIN_MODULE(bit_buffer__write_module5)
	...
	MR_init_label6(bit_buffer__write__maybe_make_room_2_0,6,7,8,9,26,3)
MR_BEGIN_CODE
...
/* code for 'maybe_make_room'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(bit_buffer__write__maybe_make_room_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	ML_BitBufferPtr	Buffer;
	MR_Integer	Pos;
...
;}
#line 945 "bit_buffer.write.c"
	MR_RELEASE_GLOBAL_LOCK("use_stream");
	MR_r3 = UseStream;
#undef	MR_PROC_LABEL
	}
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(bit_buffer__write__maybe_make_room_2_0_i26);
	}
	MR_incr_sp(8);
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(fn__bitmap__new_2_0,
		bit_buffer__write__maybe_make_room_2_0_i6);
MR_def_label(bit_buffer__write__maybe_make_room_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__bitmap__bits_3_0,
		bit_buffer__write__maybe_make_room_2_0_i7);
MR_def_label(bit_buffer__write__maybe_make_room_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_98_105_116_109_97_112_95_95_98_105_116_115_32_58_61_4_0,
		bit_buffer__write__maybe_make_room_2_0_i8);
MR_def_label(bit_buffer__write__maybe_make_room_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__bitmap__shrink_without_copying_2_0,
		bit_buffer__write__maybe_make_room_2_0_i9);
MR_def_label(bit_buffer__write__maybe_make_room_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	{
...
MR_def_label(bit_buffer__write__maybe_make_room_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(bit_buffer__write_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__bit_buffer__write__list__foldl2__ho8_6_0);
...
MR_BEGIN_MODULE(bit_buffer__write_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__bit_buffer__write__list__foldl__ho10_4_0);
	MR_init_label1(bit_buffer__write__list__foldl__ho10_4_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'foldl__ho10'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
