...
#undef MR_PROC_LABEL
    ...
    Var_19 = Var_22;
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_writer_27, (MR_Integer) 0)), (MR_Integer) 5))));
