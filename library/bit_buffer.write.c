...
#undef MR_PROC_LABEL
	 Var_20  = (MR_Box) BM;
      ...
      Var_62 = (MR_Integer) ((MR_Unsigned) 0 * (MR_Unsigned) 8);
      Var_63 = (MR_Integer) ((MR_Unsigned) NumBytes_7 * (MR_Unsigned) 8);
      Var_18 = mercury__bitmap__slice_3_f_0(Var_20, Var_62, Var_63);
{
#define MR_PROC_LABEL mercury__bit_buffer__write__flush_chunk_to_stream_2_p_0
...
#undef MR_PROC_LABEL
	 Var_52  = NumBits;
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) Var_52);
      // direct tailcall eliminated
      ;
