...
#undef	MR_PROC_LABEL
	...
	MR_sv(3) = MR_tempr3;
	MR_sv(4) = MR_tempr4;
	MR_sv(5) = ((MR_Integer) MR_tempr5 * (MR_Integer) 2);
	MR_sv(7) = MR_r2;
	MR_r1 = ((MR_Integer) MR_sv(5) + (MR_Integer) MR_tempr6);
	MR_r2 = (MR_Integer) 0;
	}
	MR_np_call_localret_ent(fn__bitmap__new_2_0,
...
MR_def_label(bit_buffer__write__store_full_buffer_2_0,2)
	...
	MR_sv(1) = MR_r1;
	MR_tempr2 = MR_sv(2);
	MR_sv(6) = ((MR_Integer) MR_tempr1 - (MR_Integer) MR_tempr2);
	MR_r1 = MR_tempr2;
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(3);
	}
...
{
#line 141 "bit_buffer.opt"

    Buffer = Buffer0;
    Buffer->ML_bit_buffer_bitmap = BM;
    Buffer->ML_bit_buffer_pos = Pos;
;}
#line 1300 "bit_buffer.write.c"
