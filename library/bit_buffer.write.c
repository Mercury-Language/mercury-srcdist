    ...
    if (mercury__bit_buffer__write__succeeded)
      *mercury__bit_buffer__write__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Box mercury__bit_buffer__write__Var_4 = (MR_Box) mercury__bit_buffer__write__HeadVar__2_2;
        MR_Box mercury__bit_buffer__write__Var_5 = (MR_Box) mercury__bit_buffer__write__HeadVar__3_3;

        {
          mercury__bit_buffer____Compare____bit_buffer_3_0(mercury__bit_buffer__write__TypeInfo_for_Stream_8, mercury__bit_buffer__write__TypeInfo_for_State_9, mercury__bit_buffer__write__TypeInfo_10_10, mercury__bit_buffer__write__HeadVar__1_1, mercury__bit_buffer__write__Var_4, mercury__bit_buffer__write__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (mercury__bit_buffer__write__succeeded)
    ...
    else
      {
        ...
        MR_Box mercury__bit_buffer__write__Var_3 = (MR_Box) mercury__bit_buffer__write__HeadVar__1_1;
        MR_Box mercury__bit_buffer__write__Var_4 = (MR_Box) mercury__bit_buffer__write__HeadVar__2_2;

        {
          mercury__bit_buffer__write__succeeded = mercury__bit_buffer____Unify____bit_buffer_3_0(mercury__bit_buffer__write__TypeInfo_for_Stream_7, mercury__bit_buffer__write__TypeInfo_for_State_8, mercury__bit_buffer__write__TypeInfo_9_9, mercury__bit_buffer__write__Var_3, mercury__bit_buffer__write__Var_4);
        }
      }
    return mercury__bit_buffer__write__succeeded;
  }
