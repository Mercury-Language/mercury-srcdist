...
static /* final */ const MR_Box mercury__term_vars_scalar_common_3[1][5];
  ...
  void * cont_env_ptr)
{
  ...
  {
    MR_Word ArgTerms_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));

    mercury__term_vars__terms_contain_var_2_p_1(TypeInfo_for_T_9, ArgTerms_6, Var_2, cont, cont_env_ptr);
  }
  else
  {
    *Var_2 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
    cont(cont_env_ptr);
  }
}
  ...
  void * cont_env_ptr)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      Var_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      if (((MR_tag((MR_Word) Var_11)) == (MR_Integer) 0))
      {
        MR_Word ArgTerms_15 = ((MR_Word) ((MR_hl_field(0, Var_11, 1))));

        mercury__term_vars__terms_contain_var_2_p_1(TypeInfo_for_T_9, ArgTerms_15, Var_2, cont, cont_env_ptr);
      }
      else
      {
        *Var_2 = ((MR_Word) ((MR_hl_field(1, Var_11, 0))));
        cont(cont_env_ptr);
      }
      {
  ...
  MR_Word * STATE_VARIABLE_Vars_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Term_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Terms_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word STATE_VARIABLE_Vars_1_12;

      mercury__term_vars__vars_in_terms_acc_3_p_0(TypeInfo_for_T_13, Terms_8, STATE_VARIABLE_Vars_0_2, &STATE_VARIABLE_Vars_1_12);
      if (((MR_tag((MR_Word) Term_7)) == (MR_Integer) 0))
      {
        MR_Word ArgTerms_17 = ((MR_Word) ((MR_hl_field(0, Term_7, 1))));
        MR_Word next_value_of_HeadVar__1_1 = ArgTerms_17;
        MR_Word next_value_of_STATE_VARIABLE_Vars_0_2 = STATE_VARIABLE_Vars_1_12;
      ...
      {
        MR_Word Var_14 = ((MR_Word) ((MR_hl_field(1, Term_7, 0))));

        {
          ...
          *STATE_VARIABLE_Vars_3 = base;
          ...
          MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_Vars_1_12));
        }
      }
    }
    break;
