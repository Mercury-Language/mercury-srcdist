  ...
  MR_Word * Vars_4)
{
  ...
  {
    MR_Word ArgTerms_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_3, (MR_Integer) 1))));

    mercury__term_vars__vars_in_terms_acc_3_p_0(TypeInfo_for_T_6, ArgTerms_10, (MR_Word) ((MR_Unsigned) 0U), Vars_4);
  }
  else
  {
    MR_Word Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term_3, (MR_Integer) 0))));
  ...
  MR_Word Term_3)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Vars_4, 0) = ((MR_Box) (Var_7));
  ...
  MR_Word * STATE_VARIABLE_Vars_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word ArgTerms_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_7, (MR_Integer) 1))));
      ...
      {
        MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term_7, (MR_Integer) 0))));
