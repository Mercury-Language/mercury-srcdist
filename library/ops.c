...
MR_decl_label5(__Unify___ops__class_0_0, 4,6,8,10,1)
MR_decl_label2(__Unify___ops__op_info_0_0, 2,1)
MR_decl_label2(__Compare___ops__assoc_0_0, 2,3)
MR_decl_label8(__Compare___ops__class_0_0, 4,9,10,12,15,23,27,28)
MR_decl_label8(__Compare___ops__class_0_0, 34,39,41,42,44,47,53,76)
MR_decl_label3(__Compare___ops__class_0_0, 60,61,2)
MR_decl_label4(__Compare___ops__op_info_0_0, 3,6,7,10)
...
MR_BEGIN_MODULE(ops_module23)
	...
	MR_init_label5(__Unify___ops__class_0_0,4,6,8,10,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ops__class_0_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Unify___ops__class_0_0_i4) MR_AND
		MR_LABEL_AP(__Unify___ops__class_0_0_i6) MR_AND
		MR_LABEL_AP(__Unify___ops__class_0_0_i8) MR_AND
		MR_LABEL_AP(__Unify___ops__class_0_0_i10));
MR_def_label(__Unify___ops__class_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ops_module24)
	...
	MR_init_label8(__Compare___ops__class_0_0,4,9,10,12,15,23,27,28)
	MR_init_label8(__Compare___ops__class_0_0,34,39,41,42,44,47,53,76)
	MR_init_label3(__Compare___ops__class_0_0,60,61,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___ops__class_0_0);
	...
	MR_incr_sp(2);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Compare___ops__class_0_0_i4) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i23) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i34) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i53));
MR_def_label(__Compare___ops__class_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i76);
	}
...
MR_def_label(__Compare___ops__class_0_0,12)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i2);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___ops__class_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r2)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i61);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___ops__class_0_0_i61) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i27) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i76) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i76));
...
MR_def_label(__Compare___ops__class_0_0,28)
	...
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___ops__class_0_0_i61) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i61) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i39) MR_AND
		MR_LABEL_AP(__Compare___ops__class_0_0_i76));
...
MR_def_label(__Compare___ops__class_0_0,44)
	...
	MR_r3 = MR_sv(2);
	if (((MR_Integer) MR_r3 >= (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i47);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r2)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i61);
	}
	...
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i60);
	}
MR_def_label(__Compare___ops__class_0_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
		MR_GOTO_LAB(__Compare___ops__class_0_0_i61);
	}
	...
	MR_decr_sp(2);
	MR_proceed();
MR_def_label(__Compare___ops__class_0_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___ops__class_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp(2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ops_module27)
	...
	MR_init_label2(__Unify___ops__op_info_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ops__op_info_0_0);
	...
	MR_np_call_localret_ent(__Unify___ops__class_0_0,
		__Unify___ops__op_info_0_0_i2);
MR_def_label(__Unify___ops__op_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(ops_module28)
	...
	MR_init_label4(__Compare___ops__op_info_0_0,3,6,7,10)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___ops__op_info_0_0);
	...
	MR_np_call_localret_ent(__Compare___ops__class_0_0,
		__Compare___ops__op_info_0_0_i3);
MR_def_label(__Compare___ops__op_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ops__op_info_0_0_i10);
	}
	if (((MR_Integer) MR_sv(1) >= (MR_Integer) MR_sv(2))) {
		MR_GOTO_LAB(__Compare___ops__op_info_0_0_i6);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___ops__op_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(1) != MR_sv(2))) {
		MR_GOTO_LAB(__Compare___ops__op_info_0_0_i7);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___ops__op_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___ops__op_info_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ops__write_out_proc_statics(FILE *fp);
#endif
