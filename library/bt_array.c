...
{
  {
    ...
    mercury__bt_array__reverse_from_ra_list_3_p_0(TypeInfo_for_T_5, RaList_9, (MR_Word) ((MR_Integer) 0), &Xs_4);
    return Xs_4;
  }
}
...
{
  {
    ...
    mercury__bt_array__reverse_from_ra_list_3_p_0(TypeInfo_for_T_8, RaList_5, (MR_Word) ((MR_Integer) 0), List_6);
  }
}
...
{
  {
    ...
    mercury__bt_array__reverse_into_ra_list_3_p_0(TypeInfo_for_T_12, List_5, (MR_Word) ((MR_Integer) 0), &RaList_7);
    {
      MR_Word base;
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_30, ElemsToAdd_55, Item_16, (MR_Word) ((MR_Integer) 0), &ListOut_53);
        {
...
{
  {
    ...
    else
    {
      ...
      mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_28, ElemsToAdd_40, Item_9, (MR_Word) ((MR_Integer) 0), &ListOut_38);
      {
        Array1_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_9, ElemsToAdd_15, T_7, (MR_Word) ((MR_Integer) 0), &ListOut_13);
    {
...
{
  {
    ...
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_13, ElemsToAdd_10, Item_7, (MR_Word) ((MR_Integer) 0), &ListOut_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__4_4 = base;
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), BTA_4, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    return BTA_4;
  }
}
