  ...
  MR_Word * Xs_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_29 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), RaList0_4, (MR_Integer) 0))));
      Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_4, (MR_Integer) 1))));
      Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_4, (MR_Integer) 2))));
      if (((MR_tag((MR_Word) Var_28)) == (MR_Integer) 0))
      {
        RaList1_8 = Var_27;
        X_7 = (MR_hl_field(MR_mktag(0), Var_28, (MR_Integer) 0));
      }
      else
      {
        MR_Word Var_21;
        ...
        X_7 = (MR_hl_field(MR_mktag(1), Var_28, (MR_Integer) 0));
        Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_28, (MR_Integer) 1))));
        Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_28, (MR_Integer) 2))));
        Var_24 = (Var_29 / (MR_Integer) 2);
        {
          Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (Var_24));
          MR_hl_field(MR_mktag(1), Var_26, 1) = ((MR_Box) (Var_22));
          MR_hl_field(MR_mktag(1), Var_26, 2) = ((MR_Box) (Var_27));
        }
        {
          RaList1_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_8, 0) = ((MR_Box) (Var_24));
          MR_hl_field(MR_mktag(1), RaList1_8, 1) = ((MR_Box) (Var_21));
          MR_hl_field(MR_mktag(1), RaList1_8, 2) = ((MR_Box) (Var_26));
        }
      }
      succeeded = MR_TRUE;
    }
  ...
  MR_Word * RaList_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
        Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
        Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 2))));
        succeeded = (Var_16 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Var_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_16, (MR_Integer) 0))));
          Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_16, (MR_Integer) 1))));
          Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_16, (MR_Integer) 2))));
          succeeded = (Var_14 == Var_18);
        }
      }
      if (succeeded)
      {
        MR_Integer Var_21;
        MR_Integer Var_22 = (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) Var_14);
        MR_Word Var_24;

        Var_21 = (MR_Integer) ((MR_Unsigned) Var_22 + (MR_Unsigned) Var_18);
        {
          Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_24, 0) = X_5;
          MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (Var_15));
          MR_hl_field(MR_mktag(1), Var_24, 2) = ((MR_Box) (Var_19));
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) (Var_21));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_24));
          MR_hl_field(MR_mktag(1), RaList1_9, 2) = ((MR_Box) (Var_20));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_26, 0) = X_5;
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * Array_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_11, (MR_Integer) 1))));
        if (((MR_tag((MR_Word) Var_40)) == (MR_Integer) 0))
          Item0_15 = (MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0));
        else
          Item0_15 = (MR_hl_field(MR_mktag(1), Var_40, (MR_Integer) 0));
        succeeded = MR_TRUE;
      }
      if (succeeded)
        Item_16 = Item0_15;
      ...
      Var_54 = (MR_Integer) ((MR_Unsigned) H_7 - (MR_Unsigned) L_6);
      ElemsToAdd_53 = (MR_Integer) ((MR_Unsigned) Var_54 + (MR_Unsigned) 1);
      mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, ElemsToAdd_53, Item_16, (MR_Word) ((MR_Unsigned) 0U), &List_51);
      {
        ...
        MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (List_51));
      }
  ...
  MR_Word * Array_10)
{
      ...
      if (succeeded)
      {
        ...
        mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_25, SizeDiff_23, Item_9, RaList0_13, &RaList_24);
        {
          ...
          *Array_10 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (L_7));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (H_8));
          MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (RaList_24));
        }
      }
      else
        *Array_10 = Array0_6;
  ...
  else
  {
    ...
    Var_38 = (MR_Integer) ((MR_Unsigned) H_8 - (MR_Unsigned) L_7);
    ElemsToAdd_37 = (MR_Integer) ((MR_Unsigned) Var_38 + (MR_Unsigned) 1);
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_25, ElemsToAdd_37, Item_9, (MR_Word) ((MR_Unsigned) 0U), &List_35);
    {
      Array1_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Array1_20, 0) = ((MR_Box) (L_7));
      MR_hl_field(MR_mktag(0), Array1_20, 1) = ((MR_Box) (H_8));
      MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (List_35));
    }
  ...
  MR_Word * Xs_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Var_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), RaList0_6, (MR_Integer) 0))));
      Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_6, (MR_Integer) 1))));
      Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_6, (MR_Integer) 2))));
      if (((MR_tag((MR_Word) Var_33)) == (MR_Integer) 0))
      {
        RaList1_10 = Var_32;
        X_9 = (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 0));
      }
      else
      {
        MR_Word Var_26;
        ...
        X_9 = (MR_hl_field(MR_mktag(1), Var_33, (MR_Integer) 0));
        Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_33, (MR_Integer) 1))));
        Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_33, (MR_Integer) 2))));
        Var_29 = (Var_34 / (MR_Integer) 2);
        {
          Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) (Var_27));
          MR_hl_field(MR_mktag(1), Var_31, 2) = ((MR_Box) (Var_32));
        }
        {
          RaList1_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_10, 0) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(1), RaList1_10, 1) = ((MR_Box) (Var_26));
          MR_hl_field(MR_mktag(1), RaList1_10, 2) = ((MR_Box) (Var_31));
        }
      }
      Var_12 = (MR_Integer) 0;
  ...
  MR_Word BTA_3)
{
  ...
  N_4 = (MR_Integer) ((MR_Unsigned) Var_10 + (MR_Unsigned) 1);
  return N_4;
}
...
{
  MR_bool succeeded;
  MR_Integer Low_9 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 0))));
  MR_Integer High_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 1))));
  MR_Word RaList0_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 2))));
  MR_Integer Pos_12;
  MR_Word RaList_13;
  MR_Integer Var_19 = (MR_Integer) ((MR_Unsigned) High_10 - (MR_Unsigned) Low_9);

  Pos_12 = (MR_Integer) ((MR_Unsigned) Var_19 - (MR_Unsigned) Index_6);
    ...
    {
      {
        ...
        base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        *BtArray_8 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Low_9));
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (High_10));
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (RaList_13));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  MR_Word * BtArray_8)
{
  MR_bool succeeded;
  MR_Word BtArray1_9;
  MR_Integer Low_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 0))));
  MR_Integer High_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 1))));
  MR_Word RaList0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 2))));
  MR_Integer Pos_20;
  MR_Word RaList_21;
  MR_Integer Var_26 = (MR_Integer) ((MR_Unsigned) High_18 - (MR_Unsigned) Low_17);

  Pos_20 = (MR_Integer) ((MR_Unsigned) Var_26 - (MR_Unsigned) Index_6);
  succeeded = (Pos_20 >= (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = mercury__ra_list__update_2_4_p_0(TypeInfo_for_T_12, Pos_20, Item_7, RaList0_19, &RaList_21);
    if (succeeded)
    {
      {
        BtArray1_9 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), BtArray1_9, 0) = ((MR_Box) (Low_17));
        MR_hl_field(MR_mktag(0), BtArray1_9, 1) = ((MR_Box) (High_18));
        MR_hl_field(MR_mktag(0), BtArray1_9, 2) = ((MR_Box) (RaList_21));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  MR_Box * Item_8)
{
  ...
  MR_Word RaList_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2))));
  MR_Integer Pos_9;
  MR_Integer Var_18 = (MR_Integer) ((MR_Unsigned) High_5 - (MR_Unsigned) Low_4);
  MR_Box Item0_10;

  Pos_9 = (MR_Integer) ((MR_Unsigned) Var_18 - (MR_Unsigned) Index_7);
  succeeded = (Pos_9 >= (MR_Integer) 0);
  if (succeeded)
...
{
  MR_Word BTA_4;
  MR_Integer High_7 = (MR_Integer) ((MR_Unsigned) N_3 - (MR_Unsigned) 1);
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_13, ElemsToAdd_10, Item_7, (MR_Word) ((MR_Unsigned) 0U), &List_8);
  {
    ...
    *HeadVar__4_4 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (High_6));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (List_8));
  }
}
  ...
  MR_Box T_7)
{
  ...
  ElemsToAdd_15 = (MR_Integer) ((MR_Unsigned) Var_16 + (MR_Unsigned) 1);
  mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_9, ElemsToAdd_15, T_7, (MR_Word) ((MR_Unsigned) 0U), &List_13);
  {
    ...
    MR_hl_field(MR_mktag(0), BTA_8, 2) = ((MR_Box) (List_13));
  }
  return BTA_8;
}
  ...
  MR_Word * RaList_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 0))));
        Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 1))));
        Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 2))));
        succeeded = (Var_19 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Var_21 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Var_19, (MR_Integer) 0))));
          Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_19, (MR_Integer) 1))));
          Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_19, (MR_Integer) 2))));
          succeeded = (Var_17 == Var_21);
        }
      }
      if (succeeded)
      {
        MR_Integer Var_24;
        MR_Integer Var_25 = (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) Var_17);
        MR_Word Var_27;

        Var_24 = (MR_Integer) ((MR_Unsigned) Var_25 + (MR_Unsigned) Var_21);
        {
          Var_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_27, 0) = Item_6;
          MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (Var_18));
          MR_hl_field(MR_mktag(1), Var_27, 2) = ((MR_Box) (Var_22));
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) (Var_24));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_27));
          MR_hl_field(MR_mktag(1), RaList1_9, 2) = ((MR_Box) (Var_23));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_29, 0) = Item_6;
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_29));
