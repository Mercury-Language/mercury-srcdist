  ...
  MR_Word * Array_10)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, SizeDiff_23, Item_9, RaList0_13, &RaList_24);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          *Array_10 = base;
  ...
  else
  {
    ...
    if (succeeded)
      ...
      H1_18 = H0_12;
    mercury__bt_array__fetch_items_4_p_0(TypeInfo_for_T_27, Array0_6, L1_17, H1_18, &Items_19);
    Var_31 = (MR_Integer) ((MR_Unsigned) H_8 - (MR_Unsigned) L_7);
    ElemsToAdd_30 = (MR_Integer) ((MR_Unsigned) Var_31 + (MR_Unsigned) 1);
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, ElemsToAdd_30, Item_9, (MR_Word) ((MR_Unsigned) 0U), &ListOut_28);
    {
      Array1_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Array1_20, 0) = ((MR_Box) (L_7));
      MR_hl_field(MR_mktag(0), Array1_20, 1) = ((MR_Box) (H_8));
      MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (ListOut_28));
    }
    mercury__bt_array__insert_items_4_p_0(TypeInfo_for_T_27, Array1_20, L1_17, Items_19, Array_10);
  }
}
