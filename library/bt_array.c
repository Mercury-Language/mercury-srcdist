...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) List0_5)) == (MR_Integer) 1);
    MR_Integer Size1_7;
    MR_Word T1_8;
    MR_Integer Size2_9;
    MR_Word T2_10;
  ...
  MR_Word * Xs_6)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) RaList0_4)) == (MR_Integer) 1);
    MR_Box X_7;
    MR_Word RaList1_8;
    MR_Word Var_25;
    MR_Word Var_26;
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) RaList0_11)) == (MR_Integer) 1);
        if (succeeded)
        {
  ...
  MR_Word * Bs_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) As_5)) == (MR_Integer) 1);
      if (succeeded)
      {
  ...
  MR_Word * Xs_8)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) RaList0_6)) == (MR_Integer) 1);
    MR_Box X_9;
    MR_Word RaList1_10;
    MR_Integer Var_12;
    MR_Word Var_30;
  ...
  MR_Word * RaList_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) RaList0_7)) == (MR_Integer) 1);
      if (succeeded)
      {
