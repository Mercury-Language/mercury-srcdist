  ...
  MR_Word * BtArray_8)
{
  MR_bool succeeded;
  MR_Word BtArray1_9;
  MR_Integer Low_15 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 0))));
  MR_Integer High_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 1))));
  MR_Word RaListIn_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 2))));
  MR_Word RaListOut_18;
  MR_Integer Pos_19;
  MR_Integer Var_24 = (MR_Integer) ((MR_Unsigned) High_16 - (MR_Unsigned) Low_15);

  Pos_19 = (MR_Integer) ((MR_Unsigned) Var_24 - (MR_Unsigned) Index_6);
  succeeded = (Pos_19 >= (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = mercury__bt_array__ra_list_update_2_4_p_0(TypeInfo_for_T_12, RaListIn_17, Pos_19, Item_7, &RaListOut_18);
    if (succeeded)
    {
      {
        BtArray1_9 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), BtArray1_9, 0) = ((MR_Box) (Low_15));
        MR_hl_field(MR_mktag(0), BtArray1_9, 1) = ((MR_Box) (High_16));
        MR_hl_field(MR_mktag(0), BtArray1_9, 2) = ((MR_Box) (RaListOut_18));
      }
      succeeded = MR_TRUE;
    }
  }
