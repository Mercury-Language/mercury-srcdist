  ...
  MR_Word * Array_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_53 = (MR_Integer) ((MR_Unsigned) H_7 - (MR_Unsigned) L_6);
      ElemsToAdd_52 = (MR_Integer) ((MR_Unsigned) Var_53 + (MR_Unsigned) 1);
      mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, ElemsToAdd_52, Item_16, (MR_Word) ((MR_Unsigned) 0U), &ListOut_50);
      {
        ...
        MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (ListOut_50));
      }
  ...
  MR_Word * Array_10)
{
  ...
  else
  {
    ...
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_25, ElemsToAdd_37, Item_9, (MR_Word) ((MR_Unsigned) 0U), &ListOut_35);
    {
      Array1_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Array1_20, 0) = ((MR_Box) (L_7));
      MR_hl_field(MR_mktag(0), Array1_20, 1) = ((MR_Box) (H_8));
      MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (ListOut_35));
    }
  ...
  MR_Word * BtArray_8)
{
  ...
  if (succeeded)
  {
    succeeded = mercury__bt_array__ra_list_update_2_4_p_0(TypeInfo_for_T_14, RaList0_11, Pos_12, Item_7, &RaList_13);
    if (succeeded)
    {
      {
        MR_Word base;
  ...
  MR_Word * BtArray_8)
{
  ...
  if (succeeded)
  {
    succeeded = mercury__bt_array__ra_list_update_2_4_p_0(TypeInfo_for_T_12, RaList0_19, Pos_20, Item_7, &RaList_21);
    if (succeeded)
    {
      {
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__bt_array__LCMC__pred__ra_list_bintree_update__1_5_p_0(TypeInfo_for_T_25, Size2_16, T1_11, NewI_17, X_4, AddrT0_32);
      }
      else
      {
        ...
        succeeded = mercury__bt_array__LCMC__pred__ra_list_bintree_update__1_5_p_0(TypeInfo_for_T_25, Size2_16, T2_12, NewI_23, X_4, AddrT0_33);
      }
    }
  }
  return succeeded;
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__5_35, 0) = X_4;
          MR_hl_field(MR_mktag(1), HeadVar__5_35, 1) = ((MR_Box) (T1_11));
          MR_hl_field(MR_mktag(1), HeadVar__5_35, 2) = ((MR_Box) (T2_12));
        }
      ...
      else
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), HeadVar__5_36, 2) = ((MR_Box) (T2_12));
          }
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), HeadVar__5_39, 0) = X0_10;
            MR_hl_field(MR_mktag(1), HeadVar__5_39, 1) = ((MR_Box) (T1_11));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Integer Var_24 = (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) Size1_17);
        MR_Word Var_26;
