      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_11;
          ...
          mercury__bt_array____Compare____ra_list_1_0(TypeInfo_for_T_14, HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__bt_array____Compare____ra_list_bintree_1_0(TypeInfo_for_T_20, &Var_17, Var_27, ArgY2_13);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_for_T_24, &Var_20, Var_32, ArgY1_15);
        ...
        else
        {
          ...
          mercury__bt_array____Compare____ra_list_bintree_1_0(TypeInfo_for_T_24, &Var_21, Var_31, ArgY2_17);
          ...
          else
          {
            /* direct tailcall eliminated */
            {
              ...
              MR_Word next_value_of_HeadVar__3_3 = ArgY3_19;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) Var_20)) == (MR_mktag((MR_Integer) 0))))
      {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) List0_5)) == (MR_mktag((MR_Integer) 1)));
    MR_Integer Size1_7;
    MR_Word T1_8;
    MR_Integer Size2_9;
    MR_Word T2_10;
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_14 = ((MR_Integer) 1 + Size1_7);
      MR_Word Var_16;

      NewSize_12 = (Var_14 + Size2_9);
      {
        Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), A_5, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Integer Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 0)));
    MR_Integer Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 1)));

    mercury__bt_array__reverse_from_ra_list_3_p_0(TypeInfo_for_T_5, RaList_9, Var_10, &Xs_4);
    return Xs_4;
  }
}
...
{
  {
    ...
    mercury__bt_array__reverse_from_ra_list_3_p_0(TypeInfo_for_T_8, RaList_5, Var_7, List_6);
  }
}
  ...
  MR_Word * Xs_6)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) RaList0_4)) == (MR_mktag((MR_Integer) 1)));
    MR_Box X_7;
    MR_Word RaList1_8;
    MR_Word Var_25;
    MR_Word Var_26;
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) Var_26)) == (MR_mktag((MR_Integer) 0))))
      {
      ...
      else
      {
        ...
        {
          Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          RaList1_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_RaList0_4 = RaList1_8;
        MR_Word next_value_of_Xs0_5 = Var_9;
...
{
  {
    ...
    Var_10 = (Low_4 + Len_8);
    High_6 = (Var_10 - (MR_Integer) 1);
    RaList0_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    mercury__bt_array__reverse_into_ra_list_3_p_0(TypeInfo_for_T_12, List_5, RaList0_9, &RaList_7);
    {
      MR_Word base;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Integer Var_21 = ((MR_Integer) 1 + Size1_14);
        MR_Word Var_23;

        NewSize_19 = (Var_21 + Size2_16);
        {
          Var_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_HeadVar__2_2 = RaList1_9;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Integer SizeDiff_12 = (H0_10 - H_7);
        MR_Word RaList_14;
        MR_Word RaList1_13;
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) RaList0_11)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          Var_43 = ((MR_Integer) (MR_hl_field(MR_mktag(1), RaList0_11, (MR_Integer) 0)));
          Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), RaList0_11, (MR_Integer) 1)));
          Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), RaList0_11, (MR_Integer) 2)));
          if (((MR_tag((MR_Word) Var_42)) == (MR_mktag((MR_Integer) 0))))
          ...
          else
          {
            ...
            Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_42, (MR_Integer) 1)));
            Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_42, (MR_Integer) 2)));
          }
          succeeded = MR_TRUE;
        }
        if (succeeded)
        ...
        ListIn_54 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        Var_56 = (H_7 - L_6);
        ElemsToAdd_55 = (Var_56 + (MR_Integer) 1);
        mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_30, ElemsToAdd_55, Item_16, ListIn_54, &ListOut_53);
        {
          Array1_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        MR_Integer SizeDiff_14 = (H0_12 - H_8);
        MR_Word RaList_16;
        MR_Word RaList1_15;
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer SizeDiff_24 = (H_8 - H0_12);
          MR_Word RaList_25;
    ...
    else
    {
      ...
      ListIn_39 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      Var_41 = (H_8 - L_7);
      ElemsToAdd_40 = (Var_41 + (MR_Integer) 1);
      mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_28, ElemsToAdd_40, Item_9, ListIn_39, &ListOut_38);
      {
        Array1_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * Array_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      N1_13 = (HeadVar__2_2 + (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Array1_12;
        MR_Integer next_value_of_HeadVar__2_2 = N1_13;
        MR_Word next_value_of_HeadVar__3_3 = Tail_10;
...
{
  {
    ...
    if (succeeded)
      *List_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word List0_14;
      MR_Integer Drop_11;
      ...
      MR_Integer Var_16;
      MR_Word Var_17;
      MR_Integer Var_23 = (AHigh_6 - ALow_5);

      Drop_11 = (Var_23 - High_9);
  ...
  MR_Word * Bs_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) As_5)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Size_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), As_5, (MR_Integer) 0)));
        Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), As_5, (MR_Integer) 1)));
        Cs_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), As_5, (MR_Integer) 2)));
        succeeded = (Size_7 < N_4);
        if (succeeded)
        {
          MR_Integer N1_10 = (N_4 - Size_7);
  ...
  MR_Word * Bs_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_Integer N1_7 = (N_4 - (MR_Integer) 1);
      MR_Word Cs_8;
      MR_Word Var_26;
      MR_Word Var_27;
      MR_Integer Var_28;
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) Var_27)) == (MR_mktag((MR_Integer) 0))))
          Cs_8 = Var_26;
        else
        {
          ...
          MR_Word Var_25;
          MR_Box Var_17 = (MR_hl_field(MR_mktag(1), Var_27, (MR_Integer) 0));

          {
            Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Cs_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_N_4 = N1_7;
          MR_Word next_value_of_As_5 = Cs_8;
  ...
  MR_Word * Xs_8)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((MR_tag((MR_Word) RaList0_6)) == (MR_mktag((MR_Integer) 1)));
    MR_Box X_9;
    MR_Word RaList1_10;
    MR_Integer Var_12;
    MR_Word Var_30;
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) Var_31)) == (MR_mktag((MR_Integer) 0))))
      {
      ...
      else
      {
        ...
        {
          RaList1_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      MR_Integer I1_11 = (I_5 - (MR_Integer) 1);
      MR_Word Var_14;
      ...
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_I_5 = I1_11;
        MR_Word next_value_of_RaList0_6 = RaList1_10;
        MR_Word next_value_of_Xs0_7 = Var_14;
...
{
  {
    ...
    MR_Integer Pos_11;
    MR_Integer Var_17 = (High_6 - Low_5);

    Pos_11 = (Var_17 - Index_8);
...
{
  {
    ...
    MR_Integer Pos_20;
    MR_Integer Var_25 = (High_17 - Low_16);

    Pos_20 = (Var_25 - Index_6);
    ...
    if (succeeded)
    {
      ...
      {
        {
          BtArray1_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer NewI_17 = (HeadVar__3_3 - (MR_Integer) 1);
          MR_Word T0_18;
        ...
        {
          MR_Integer Var_21 = (HeadVar__3_3 - (MR_Integer) 1);
          MR_Integer NewI_23 = (Var_21 - Size2_16);
          MR_Word T0_24;
...
{
  {
    ...
    MR_Integer Pos_9;
    MR_Integer Var_15 = (High_5 - Low_4);

    Pos_9 = (Var_15 - Index_7);
...
{
  {
    ...
    MR_Word RaList_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));
    MR_Integer Pos_9;
    MR_Integer Var_19 = (High_5 - Low_4);
    MR_Box Item0_10;

    Pos_9 = (Var_19 - Index_7);
    succeeded = (Pos_9 >= (MR_Integer) 0);
    if (succeeded)
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer NewI_14 = (HeadVar__3_3 - (MR_Integer) 1);
        ...
        {
          MR_Integer Var_17 = (HeadVar__3_3 - (MR_Integer) 1);
          MR_Integer NewI_19 = (Var_17 - Size2_13);
...
{
  {
    ...
    MR_Integer Var_10 = (High_8 - Low_7);
    MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 2)));

    N_4 = (Var_10 + (MR_Integer) 1);
    return N_4;
  }
}
...
{
  {
    MR_Integer Low_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_Integer High_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    MR_Integer Var_7 = (High_4 - Low_3);
    MR_Word Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));

    *Size_6 = (Var_7 + (MR_Integer) 1);
  }
}
...
{
  {
    ...
    MR_Integer Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 0)));
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Integer Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 1)));
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 2)));
...
{
  {
    MR_Word BTA_8;
    MR_Word ListOut_13;
    MR_Word ListIn_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Integer ElemsToAdd_15;
    MR_Integer Var_16 = (N2_6 - N1_5);

    ElemsToAdd_15 = (Var_16 + (MR_Integer) 1);
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_9, ElemsToAdd_15, T_7, ListIn_14, &ListOut_13);
    {
      BTA_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HeadVar__4_4)
{
  {
    MR_Word ListOut_8;
    MR_Word ListIn_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    MR_Integer ElemsToAdd_10;
    MR_Integer Var_11 = (High_6 - Low_5);

    ElemsToAdd_10 = (Var_11 + (MR_Integer) 1);
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_13, ElemsToAdd_10, Item_7, ListIn_9, &ListOut_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__4_4 = base;
  ...
  MR_Word * RaList_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) RaList0_7)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        MR_Integer Var_24 = ((MR_Integer) 1 + Size1_17);
        MR_Word Var_26;

        NewSize_22 = (Var_24 + Size2_19);
        {
      ...
      ElemsToAdd1_10 = (ElemsToAdd_5 - (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_ElemsToAdd_5 = ElemsToAdd1_10;
        MR_Word next_value_of_RaList0_7 = RaList1_9;
  ...
  MR_Integer N_3)
{
  {
    MR_Word BTA_4;
    MR_Integer High_7 = (N_3 - (MR_Integer) 1);
    MR_Word ListOut_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    {
      BTA_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), BTA_4, 0) = ((MR_Box) (N_3));
      MR_hl_field(MR_mktag(0), BTA_4, 1) = ((MR_Box) (High_7));
      MR_hl_field(MR_mktag(0), BTA_4, 2) = ((MR_Box) (ListOut_8));
    }
    return BTA_4;
  }
}
...
{
  {
    MR_Integer High_4 = (Low_3 - (MR_Integer) 1);
    MR_Word ListOut_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

    {
      ...
      *HeadVar__2_2 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (ListOut_5));
    }
  }
}
