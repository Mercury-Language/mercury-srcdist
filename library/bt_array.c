...
{
  MR_Word Xs_4;
  MR_Word RaList_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 2))));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_26, (MR_Integer) 1))));
        Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_26, (MR_Integer) 2))));
        Var_22 = (Var_27 / (MR_Integer) 2);
        {
          Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) (Var_22));
          MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (Var_21));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), RaList1_8, 0) = ((MR_Box) (Var_22));
          MR_hl_field(MR_mktag(1), RaList1_8, 1) = ((MR_Box) (Var_20));
  ...
  MR_Word * RaList_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
        Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
        Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
          ...
          Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_13, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
        ...
        {
          Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_20, 0) = X_5;
          MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Var_12));
          MR_hl_field(MR_mktag(1), Var_20, 2) = ((MR_Box) (Var_15));
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) (Var_17));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_20));
          MR_hl_field(MR_mktag(1), RaList1_9, 2) = ((MR_Box) (Var_16));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_22, 0) = X_5;
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_22));
  ...
  MR_Word * Array_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_11, (MR_Integer) 1))));
        if (((MR_tag((MR_Word) Var_39)) == (MR_Integer) 0))
          Item0_15 = (MR_hl_field(MR_mktag(0), Var_39, (MR_Integer) 0));
        else
          Item0_15 = (MR_hl_field(MR_mktag(1), Var_39, (MR_Integer) 0));
        succeeded = MR_TRUE;
      }
      if (succeeded)
        Item_16 = Item0_15;
      ...
      mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, ElemsToAdd_43, Item_16, (MR_Word) ((MR_Unsigned) 0U), &List_41);
      {
        ...
        MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (List_41));
      }
  ...
  MR_Word * Array_10)
{
  ...
  else
  {
    ...
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_25, ElemsToAdd_28, Item_9, (MR_Word) ((MR_Unsigned) 0U), &List_26);
    {
      ...
      MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (List_26));
    }
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_31, (MR_Integer) 1))));
        Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_31, (MR_Integer) 2))));
        Var_27 = (Var_32 / (MR_Integer) 2);
        {
          Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (Var_27));
          MR_hl_field(MR_mktag(1), Var_29, 1) = ((MR_Box) (Var_26));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), RaList1_10, 0) = ((MR_Box) (Var_27));
          MR_hl_field(MR_mktag(1), RaList1_10, 1) = ((MR_Box) (Var_25));
...
{
  MR_Integer N_4;
  MR_Integer Low_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 0))));
  MR_Integer High_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BTA_3, (MR_Integer) 1))));
  ...
  MR_Word * BtArray_8)
{
  MR_bool succeeded;
  MR_Word BtArray1_9;
  MR_Integer Low_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 0))));
  MR_Integer High_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 1))));
  MR_Word RaList0_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BtArray0_5, (MR_Integer) 2))));
  MR_Integer Pos_16;
  MR_Word RaList_17;
    ...
    {
      {
        ...
        MR_hl_field(MR_mktag(0), BtArray1_9, 0) = ((MR_Box) (Low_13));
        MR_hl_field(MR_mktag(0), BtArray1_9, 1) = ((MR_Box) (High_14));
        MR_hl_field(MR_mktag(0), BtArray1_9, 2) = ((MR_Box) (RaList_17));
      }
      succeeded = MR_TRUE;
    }
  }
  ...
  MR_Integer N_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), BTA_4, 1) = ((MR_Box) (High_6));
  ...
  MR_Box T_7)
{
  ...
  mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_9, ElemsToAdd_12, T_7, (MR_Word) ((MR_Unsigned) 0U), &List_10);
  {
    ...
    MR_hl_field(MR_mktag(0), BTA_8, 2) = ((MR_Box) (List_10));
  }
  return BTA_8;
}
  ...
  MR_Word * RaList_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 0))));
        Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 1))));
        Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RaList0_7, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
          ...
          Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_16, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
        ...
        Var_20 = (MR_Integer) ((MR_Unsigned) Var_21 + (MR_Unsigned) Var_17);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_23, 0) = Item_6;
          MR_hl_field(MR_mktag(1), Var_23, 1) = ((MR_Box) (Var_15));
          MR_hl_field(MR_mktag(1), Var_23, 2) = ((MR_Box) (Var_18));
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) (Var_20));
          MR_hl_field(MR_mktag(1), RaList1_9, 1) = ((MR_Box) (Var_23));
          MR_hl_field(MR_mktag(1), RaList1_9, 2) = ((MR_Box) (Var_19));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_25, 0) = Item_6;
        }
        {
          RaList1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RaList1_9, 0) = ((MR_Box) ((MR_Integer) 1));
