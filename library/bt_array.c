...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = mercury__bt_array__LCMCpr_ra_list_update_2_1_4_p_0(TypeInfo_for_T_14, Rest_7, NewI_12, X_9, AddrList0_15);
      }
    }
    return succeeded;
  }
...
MR_bool MR_CALL 
mercury__bt_array__LCMCpr_ra_list_update_2_1_4_p_0(
  MR_Word TypeInfo_for_T_14,
  MR_Word HeadVar__1_1,
  MR_Integer I_8,
  MR_Box X_9,
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = mercury__bt_array__LCMCpr_ra_list_bintree_update_1_5_p_0(TypeInfo_for_T_25, Size2_16, T1_11, NewI_17, X_4, AddrT0_32);
        }
        else
        {
          ...
          succeeded = mercury__bt_array__LCMCpr_ra_list_bintree_update_1_5_p_0(TypeInfo_for_T_25, Size2_16, T2_12, NewI_23, X_4, AddrT0_33);
        }
      }
    }
    return succeeded;
...
MR_bool MR_CALL 
mercury__bt_array__LCMCpr_ra_list_bintree_update_1_5_p_0(
  MR_Word TypeInfo_for_T_25,
  MR_Integer Size_1,
  MR_Word HeadVar__2_2,
  MR_Integer HeadVar__3_3,
