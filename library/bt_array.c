  ...
  MR_Word * Array_10)
{
  ...
  else
  {
    ...
    Var_40 = (MR_Integer) ((MR_Unsigned) H_8 - (MR_Unsigned) L_7);
    ElemsToAdd_39 = (MR_Integer) ((MR_Unsigned) Var_40 + (MR_Unsigned) 1);
    mercury__bt_array__add_elements_4_p_0(TypeInfo_for_T_27, ElemsToAdd_39, Item_9, (MR_Word) ((MR_Unsigned) 0U), &ListOut_37);
    {
      Array1_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Array1_20, 0) = ((MR_Box) (L_7));
      MR_hl_field(MR_mktag(0), Array1_20, 1) = ((MR_Box) (H_8));
      MR_hl_field(MR_mktag(0), Array1_20, 2) = ((MR_Box) (ListOut_37));
    }
