...
MR_decl_label6(__Unify___bintree__bintree_2_0, 35,3,5,7,9,1)
MR_decl_label8(__Compare___bintree__bintree_2_0, 49,5,3,7,9,13,17,54)
...
MR_BEGIN_MODULE(bintree_module42)
	...
	MR_init_label6(__Unify___bintree__bintree_2_0,35,3,5,7,9,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___bintree__bintree_2_0);
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(__Unify___bintree__bintree_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Unify___bintree__bintree_2_0_i3);
	}
	MR_r1 = (MR_r4 == MR_r3);
	MR_decr_sp_and_return(9);
MR_def_label(__Unify___bintree__bintree_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r4,0,0)) {
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___bintree__bintree_2_0_i5);
...
MR_def_label(__Unify___bintree__bintree_2_0,9)
	...
	MR_r4 = MR_sv(6);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(__Unify___bintree__bintree_2_0_i35);
...
MR_BEGIN_MODULE(bintree_module43)
	...
	MR_init_label8(__Compare___bintree__bintree_2_0,49,5,3,7,9,13,17,54)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___bintree__bintree_2_0);
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(__Compare___bintree__bintree_2_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Compare___bintree__bintree_2_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
...
MR_def_label(__Compare___bintree__bintree_2_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(9);
MR_def_label(__Compare___bintree__bintree_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
...
MR_def_label(__Compare___bintree__bintree_2_0,7)
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___bintree__bintree_2_0_i9);
MR_def_label(__Compare___bintree__bintree_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___bintree__bintree_2_0_i54);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(8);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___bintree__bintree_2_0_i13);
MR_def_label(__Compare___bintree__bintree_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___bintree__bintree_2_0_i54);
	}
	...
	MR_np_localcall_lab(__Compare___bintree__bintree_2_0,
		__Compare___bintree__bintree_2_0_i17);
MR_def_label(__Compare___bintree__bintree_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___bintree__bintree_2_0_i54);
	}
	...
	MR_r4 = MR_sv(3);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(__Compare___bintree__bintree_2_0_i49);
MR_def_label(__Compare___bintree__bintree_2_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
