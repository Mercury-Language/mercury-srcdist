...
MR_decl_label6(bintree__from_sorted_list_2_4_0, 47,5,10,11,14,13)
...
MR_BEGIN_MODULE(bintree_module26)
	...
	MR_init_label6(bintree__from_sorted_list_2_4_0,47,5,10,11,14,13)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree__from_sorted_list_2_4_0);
	...
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(bintree__from_sorted_list_2_4_0_i47);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r4;
	MR_proceed();
MR_def_label(bintree__from_sorted_list_2_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
