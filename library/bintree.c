...
MR_decl_label10(bintree__delete_3_0, 69,4,7,6,11,13,14,15,17,16)
...
MR_decl_label4(bintree__from_sorted_list_2_4_0, 28,4,7,6)
MR_decl_label6(bintree__insert_4_0, 51,5,8,7,12,1)
...
MR_decl_label6(bintree__set_4_0, 38,5,8,7,10,12)
MR_decl_label6(bintree__set_4_1, 38,5,8,7,10,12)
...
MR_BEGIN_MODULE(bintree_module1)
	...
	MR_init_label6(bintree__insert_4_0,51,5,8,7,12,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree__insert_4_0);
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(bintree__insert_4_0_i51);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(bintree__insert_4_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
...
MR_BEGIN_MODULE(bintree_module3)
	...
	MR_init_label6(bintree__set_4_0,38,5,8,7,10,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree__set_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(bintree__set_4_0_i38);
	}
	...
	MR_proceed();
MR_def_label(bintree__set_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(bintree_module4)
	...
	MR_init_label6(bintree__set_4_1,38,5,8,7,10,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree__set_4_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(bintree__set_4_1_i38);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 4);
	MR_tfield(1, MR_r1, 0) = MR_r4;
	MR_tfield(1, MR_r1, 1) = MR_r5;
	...
	MR_tfield(1, MR_r1, 3) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(bintree__set_4_1,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(bintree_module14)
	...
	MR_init_label10(bintree__delete_3_0,69,4,7,6,11,13,14,15,17,16)
...
MR_define_entry(mercury__bintree__delete_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(bintree__delete_3_0_i69);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(bintree__delete_3_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(bintree_module26)
	...
	MR_init_label4(bintree__from_sorted_list_2_4_0,28,4,7,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree__from_sorted_list_2_4_0);
	...
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(bintree__from_sorted_list_2_4_0_i28);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r4;
	MR_proceed();
MR_def_label(bintree__from_sorted_list_2_4_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
