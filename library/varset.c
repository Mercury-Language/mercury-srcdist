  ...
  MR_Word * STATE_VARIABLE_VarSet_11)
{
  ...
  Var_16 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_VarSet_0_10, (MR_Integer) 0))));
  Var_18 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_VarSet_0_10, (MR_Integer) 2))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_VarSet_7)
{
...

  {
    ...
    *STATE_VARIABLE_VarSet_7 = base;
    ...
    MR_hl_field(0, base, 2) = ((MR_Box) (Values_5));
  }
}
