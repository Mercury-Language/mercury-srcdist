...
MR_decl_label2(varset__delete_sorted_vars_3_0, 3,5)
MR_decl_label2(varset__delete_var_3_0, 3,5)
MR_decl_label2(varset__delete_vars_3_0, 3,5)
...
MR_def_extern_entry(varset__delete_sorted_vars_3_0)
MR_def_extern_entry(fn__varset__delete_sorted_vars_2_0)
...
MR_BEGIN_MODULE(varset_module11)
	...
	MR_init_label2(varset__delete_vars_3_0,3,5)
MR_BEGIN_CODE
...
MR_def_label(varset__delete_vars_3_0,3)
	...
	MR_np_call_localret_ent(map__delete_list_3_0,
		varset__delete_vars_3_0_i5);
MR_def_label(varset__delete_vars_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_r2, 0) = MR_sv(1);
	MR_tfield(0, MR_r2, 1) = MR_sv(3);
...
MR_decl_entry(map__delete_sorted_list_3_0);

MR_BEGIN_MODULE(varset_module13)
	MR_init_entry1(varset__delete_sorted_vars_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__varset__delete_sorted_vars_3_0);
	MR_init_label2(varset__delete_sorted_vars_3_0,3,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delete_sorted_vars'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__varset__delete_sorted_vars_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(map__delete_sorted_list_3_0,
		varset__delete_sorted_vars_3_0_i3);
MR_def_label(varset__delete_sorted_vars_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_CTOR1_ADDR(term, term);
	MR_tfield(0, MR_r2, 1) = MR_sv(4);
	...
	MR_np_call_localret_ent(map__delete_sorted_list_3_0,
		varset__delete_sorted_vars_3_0_i5);
MR_def_label(varset__delete_sorted_vars_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_r2, 0) = MR_sv(1);
	MR_tfield(0, MR_r2, 1) = MR_sv(3);
...
MR_BEGIN_MODULE(varset_module14)
	MR_init_entry1(fn__varset__delete_sorted_vars_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__varset__delete_sorted_vars_2_0);
MR_BEGIN_CODE
...
/* code for 'delete_sorted_vars'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__varset__delete_sorted_vars_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
	MR_r2 = MR_r3;
	MR_r3 = MR_tempr1;
	MR_np_tailcall_ent(varset__delete_sorted_vars_3_0);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(varset__merge_subst_2_9_0,7)
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(0,5,0);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_r3 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_CTOR1_ADDR(term, term);
	MR_tempr3 = MR_sv(9);
...
MR_def_label(varset__squash_4_0,10)
	...
	MR_np_call_localret_ent(tree234__assoc_list_to_tree234_acc_3_0,
...
MR_BEGIN_MODULE(varset_module67)
...
void mercury__varset__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__varset);
