...
{
  {
    ...
    mercury__varset__ensure_unique_names_loop_6_p_0(TypeInfo_for_T_20, AllVars_5, Suffix_6, ((MR_Box) ((MR_Unsigned) 0U)), VarNames0_8, (MR_Word) ((MR_Unsigned) 0U), &VarNames_9);
...
{
  {
    ...
    mercury__varset__merge_subst_without_names_loop_6_p_0(TypeInfo_for_T_18, ((MR_Box) ((MR_Integer) 0)), SupplyB_9, SupplyA_13, &Supply_17, (MR_Word) ((MR_Unsigned) 0U), Subst_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *VarSet_7 = base;
...
{
  {
    ...
    mercury__varset__merge_subst_loop_9_p_0(TypeInfo_for_T_19, ((MR_Box) ((MR_Integer) 0)), SupplyB_9, NamesB_10, SupplyA_13, &Supply_17, NamesA_14, &Names_18, (MR_Word) ((MR_Unsigned) 0U), Subst_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *VarSet_7 = base;
...
{
  {
    ...
    mercury__varset__merge_renaming_without_names_loop_6_p_0(TypeInfo_for_T_18, ((MR_Box) ((MR_Integer) 0)), SupplyB_9, SupplyA_13, &Supply_17, (MR_Word) ((MR_Unsigned) 0U), Renaming_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *VarSet_7 = base;
...
{
  {
    ...
    mercury__varset__merge_renaming_loop_9_p_0(TypeInfo_for_T_19, ((MR_Box) ((MR_Integer) 0)), SupplyB_9, NamesB_10, SupplyA_13, &Supply_17, NamesA_14, &Names_18, (MR_Word) ((MR_Unsigned) 0U), Renaming_8);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      *VarSet_7 = base;
...
{
  {
    ...
    mercury__varset__vars_loop_4_p_0(TypeInfo_for_T_11, ((MR_Box) ((MR_Integer) 0)), MaxId_5, (MR_Word) ((MR_Unsigned) 0U), &RevVars_7);
    {
