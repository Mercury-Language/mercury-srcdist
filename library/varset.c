...
MR_decl_label7(varset__merge_subst_2_9_0, 26,2,5,7,3,15,16)
MR_decl_label1(varset__merge_subst_without_names_4_0, 2)
MR_decl_label3(varset__merge_subst_without_names_2_6_0, 14,2,7)
...
MR_define_entry(mercury__varset__new_uniquely_named_var_4_0);
	...
	MR_sv(3) = MR_r3;
	MR_tempr1 = ((MR_Integer) MR_ctfield(0, MR_tempr2, 0) + (MR_Integer) 1);
	MR_sv(4) = MR_tempr1;
	MR_sv(5) = MR_tempr1;
	MR_sv(6) = MR_r1;
	MR_r1 = MR_tempr1;
...
MR_BEGIN_MODULE(varset_module33)
	...
	MR_init_label7(varset__merge_subst_2_9_0,26,2,5,7,3,15,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury__varset__merge_subst_2_9_0);
	...
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
MR_def_label(varset__merge_subst_2_9_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
...
MR_def_label(varset__merge_subst_2_9_0,16)
	...
	MR_r7 = MR_tempr1;
	MR_succip_word = MR_sv(11);
	MR_GOTO_LAB(varset__merge_subst_2_9_0_i26);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(varset_module38)
	...
	MR_init_label3(varset__merge_subst_without_names_2_6_0,14,2,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury__varset__merge_subst_without_names_2_6_0);
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(varset__merge_subst_without_names_2_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r2 != MR_r3)) {
...
MR_def_label(varset__merge_subst_without_names_2_6_0,7)
	...
	MR_r5 = MR_tempr1;
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(varset__merge_subst_without_names_2_6_0_i14);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
