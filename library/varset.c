  ...
  MR_Word * STATE_VARIABLE_VarNames_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_81 = (MR_Word) (STATE_VARIABLE_UsedNames_0_3);
      mercury__set_ordlist__insert_loop_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_81, ((MR_Box) (FinalName_22)), &Var_82);
      STATE_VARIABLE_UsedNames_31_31 = (MR_Word) (Var_82);
      {
