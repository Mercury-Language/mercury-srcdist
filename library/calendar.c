...
{
  {
    ...
    if (succeeded)
    {
      ...
      Rest_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_Chars_17_17, (MR_Integer) 1))));
      succeeded = (Var_51 == (MR_Char) 45);
    }
    if (succeeded)
    {
      STATE_VARIABLE_Chars_18_18 = Rest_50;
      Sign_6 = (MR_Integer) -1;
    }
    else
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_59 = (MR_Char) 89;
          Var_75 = (MR_Integer) 0;
          mercury__calendar__read_int_2_4_p_0(Var_75, &Int0_66, STATE_VARIABLE_Chars_20_20, &Chars1_67);
          succeeded = (Chars1_67 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Var_70 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Chars1_67, (MR_Integer) 0)));
            Rest_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Chars1_67, (MR_Integer) 1))));
            succeeded = (Var_59 == Var_70);
          }
          if (succeeded)
          {
            STATE_VARIABLE_Chars_21_21 = Rest_68;
            Years_7 = Int0_66;
          }
          else
          {
...
{
  {
    ...
    MR_Char Var_17;
    MR_Char Var_19;
    MR_Integer Fraction_33;
    MR_Integer FractionDigits_34;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_44 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Chars1_10, (MR_Integer) 0)));
        Chars1_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Chars1_10, (MR_Integer) 1))));
        succeeded = (Var_35 == Var_44);
        if (succeeded)
        {
          Var_52 = (MR_Integer) 0;
          Var_53 = (MR_Integer) 0;
          mercury__calendar__read_int_and_num_chars_2_6_p_0(Var_52, &Fraction_33, Var_53, &FractionDigits_34, Chars1_32, &STATE_VARIABLE_Chars_12_36);
          Var_37 = (MR_Integer) 0;
          succeeded = (FractionDigits_34 > Var_37);
          if (succeeded)
          {
            Var_38 = (MR_Integer) 7;
            succeeded = (FractionDigits_34 < Var_38);
          }
        }
      }
      if (succeeded)
      {
        ...
        Chars2_12 = STATE_VARIABLE_Chars_12_36;
        Var_41 = (MR_Integer) ((MR_Unsigned) 6 - (MR_Unsigned) FractionDigits_34);
        mercury__int__pow_3_p_0((MR_Integer) 10, Var_41, &Var_39);
        MicroSeconds0_11 = (MR_Integer) ((MR_Unsigned) Var_39 * (MR_Unsigned) Fraction_33);
      }
      else
      {
      ...
      if (succeeded)
      {
        Var_19 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Chars2_12, (MR_Integer) 0)));
        Chars3_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Chars2_12, (MR_Integer) 1))));
...
{
  {
    ...
    succeeded = (Chars1_16 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
