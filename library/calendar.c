...
#undef MR_PROC_LABEL
    ...
    Year_58 = (MR_Integer) ((MR_Unsigned) 1900 + (MR_Unsigned) TMYear_49);
    Month_59 = (MR_Integer) ((MR_Unsigned) TMMonth_50 + (MR_Unsigned) 1);
    {
...
{
  {
    ...
    {
      *HeadVar__2_2 = ((&mercury__calendar_vector_common_6[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 1)]))->mercury__calendar__vector_common_type_6_0__vct_6_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
