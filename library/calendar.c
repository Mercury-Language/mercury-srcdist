...
#undef MR_PROC_LABEL
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_65 = (MR_Char) 89;
      Var_81 = (MR_Integer) 0;
      mercury__calendar__read_int_2_4_p_0(Var_81, &Int0_72, STATE_VARIABLE_Chars_20_20, &Chars1_73);
      succeeded = (Chars1_73 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        Var_76 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Chars1_73, (MR_Integer) 0)));
        Rest_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Chars1_73, (MR_Integer) 1))));
        succeeded = (Var_65 == Var_76);
      }
      if (succeeded)
      {
        STATE_VARIABLE_Chars_21_21 = Rest_74;
        Years_7 = Int0_72;
      }
      else
      {
  ...
  MR_Word * STATE_VARIABLE_Chars_14)
{
  ...
  if (succeeded)
  {
    ...
    Var_37 = (MR_Integer) ((MR_Unsigned) 6 - (MR_Unsigned) FractionDigits_30);
...
#undef MR_PROC_LABEL
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      {
        Var_24 = (MR_Integer) 2;
        mercury__calendar__read_int_and_num_chars_4_p_0(&Month_10, &Var_54, STATE_VARIABLE_Chars_23_23, &STATE_VARIABLE_Chars_25_25);
