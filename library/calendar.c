...
{
  {
    ...
    Var_83 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (MR_Word) &mercury__calendar_scalar_common_5[1], (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_5_p_0((MR_Word) &mercury__calendar_scalar_common_9[1], (MR_Word) MR_mkword(MR_mktag(1), &mercury__calendar_scalar_common_9[2]), V_10_44, MicroSeconds_5, &Var_30);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_signed_int_component_5_p_0((MR_Word) &mercury__calendar_scalar_common_9[1], (MR_Word) MR_mkword(MR_mktag(1), &mercury__calendar_scalar_common_9[2]), V_10_29, MicroSeconds_3, &Var_15);
...
{
  {
    ...
    else
    {
      ...
      mercury__string__to_string__value_to_revstrings_prio_6_p_1((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Integer) 1, V_10_69, ((MR_Box) (M_7)), V_10_60, &V_9_61);
