...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        succeeded = (MicroSeconds_6 == (MR_Integer) 0);
      if (succeeded)
        TimePart_11 = (MR_Word) ((MR_Integer) 0);
      else
      {
        MR_Word Var_23;
        MR_String Var_24;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__calendar_scalar_common_9[1]), (MR_Word) (MR_mkword(MR_mktag(1), &mercury__calendar_scalar_common_9[2])), (MR_Word) ((MR_Integer) 0), MicroSeconds_5, &Var_30);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (STATE_VARIABLE_Chars_27_27 == (MR_Word) ((MR_Integer) 0));
            if (succeeded)
            {
        ...
        else
        {
          ...
          succeeded = (STATE_VARIABLE_Chars_23_23 == (MR_Word) ((MR_Integer) 0));
          if (succeeded)
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_signed_int_component_5_p_0((MR_Word) (&mercury__calendar_scalar_common_9[1]), (MR_Word) (MR_mkword(MR_mktag(1), &mercury__calendar_scalar_common_9[2])), (MR_Word) ((MR_Integer) 0), MicroSeconds_3, &Var_15);
                                                ...
                                                if (succeeded)
                                                {
                                                  ...
                                                  if (succeeded)
                                                  {
                                                    ...
                                                    if (succeeded)
                                                    {
                                                      ...
                                                      succeeded = (STATE_VARIABLE_Chars_51_51 == (MR_Word) ((MR_Integer) 0));
                                                      if (succeeded)
                                                      {
                                                        {
                                                          MR_Word base;
...
{
  {
    ...
    else
    {
      ...
      mercury__string__to_string__value_to_revstrings_prio_6_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Integer) 1, V_10_69, ((MR_Box) (M_7)), (MR_Word) ((MR_Integer) 0), &V_9_61);
