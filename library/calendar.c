  ...
  MR_Word * Date_16)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_21 = (MR_Integer) 24;
        succeeded = (Hour_12 < Var_21);
        if (succeeded)
        {
          Var_22 = (MR_Integer) 0;
          ...
          if (succeeded)
          {
            Var_23 = (MR_Integer) 60;
            succeeded = (Minute_13 < Var_23);
            if (succeeded)
            {
              Var_24 = (MR_Integer) 0;
              ...
              if (succeeded)
              {
                Var_25 = (MR_Integer) 62;
                succeeded = (Second_14 < Var_25);
                if (succeeded)
                {
                  Var_26 = (MR_Integer) 0;
                  ...
                  if (succeeded)
                  {
                    Var_27 = (MR_Integer) 1000000;
                    succeeded = (MicroSecond_15 < Var_27);
                    if (succeeded)
                    {
