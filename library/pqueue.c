  ...
  MR_Word * L_4)
{
  ...
  if (succeeded)
  {
    ...
    L0_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Q0_3, (MR_Integer) 3))));
    R0_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Q0_3, (MR_Integer) 4))));
  ...
  if (succeeded)
  {
    ...
    AddrL0_15 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *L_4, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_PQ_11)
{
  ...
  if (succeeded)
  {
    ...
    L0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_PQ_0_10, (MR_Integer) 3))));
    R0_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_PQ_0_10, (MR_Integer) 4))));
    mercury__pqueue__remove_2_3_p_0(TypeInfo_for_K_17, TypeInfo_for_V_18, L0_20, R0_21, &STATE_VARIABLE_PQ_12_12);
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        AddrPQ0_43 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 3)));
      ...
      else
      {
        ...
        AddrPQ1_44 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 3)));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            ...
            D_27 = D1_19;
          {
            HeadVar__3_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), HeadVar__3_48, 0) = ((MR_Box) (D_27));
            MR_hl_field(MR_mktag(1), HeadVar__3_48, 1) = Var_41;
            MR_hl_field(MR_mktag(1), HeadVar__3_48, 2) = Var_40;
            MR_hl_field(MR_mktag(1), HeadVar__3_48, 3) = NULL;
            MR_hl_field(MR_mktag(1), HeadVar__3_48, 4) = ((MR_Box) (HeadVar__2_2));
          }
          AddrPQ0_43 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_48, (MR_Integer) 3)));
        ...
        else
        {
          ...
          if (succeeded)
            ...
            D_35 = D1_19;
          {
            HeadVar__3_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), HeadVar__3_51, 0) = ((MR_Box) (D_35));
            MR_hl_field(MR_mktag(1), HeadVar__3_51, 1) = K1_20;
            MR_hl_field(MR_mktag(1), HeadVar__3_51, 2) = V1_21;
            MR_hl_field(MR_mktag(1), HeadVar__3_51, 3) = NULL;
            MR_hl_field(MR_mktag(1), HeadVar__3_51, 4) = ((MR_Box) (HeadVar__1_1));
          }
          AddrPQ1_44 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), HeadVar__3_51, (MR_Integer) 3)));
