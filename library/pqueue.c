          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_HeadVar__1_1 = ArgX5_13;
                  MR_Word next_value_of_HeadVar__2_2 = ArgY5_14;
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer D0M1_26 = (Var_42 - (MR_Integer) 1);
          MR_Integer D_27;
          MR_Word PQ0_28;
        ...
        {
          MR_Integer D1M1_29 = (Var_42 - (MR_Integer) 1);
          MR_Word PQ1_30;
          MR_Integer D_35;
...
{
  {
    ...
    else
    {
      ...
      MR_Integer D_18 = (D0_12 + (MR_Integer) 1);
      MR_Word CMP_19;
      MR_Box K1_20;
      MR_Box V1_21;
      MR_Word L_22;
