  ...
  MR_Word * STATE_VARIABLE_PQ_11)
{
  ...
  if (succeeded)
  {
    ...
    L0_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_PQ_0_10, (MR_Integer) 3))));
    R0_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_PQ_0_10, (MR_Integer) 4))));
    mercury__pqueue__remove_2_3_p_0(TypeInfo_for_K_16, TypeInfo_for_V_17, L0_22, R0_23, &STATE_VARIABLE_PQ_12_12);
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__pqueue__LCMC__pred__remove_2__1_3_p_0(TypeInfo_for_K_36, TypeInfo_for_V_37, Var_39, Var_38, AddrPQ0_49);
      }
      else
      {
        ...
        mercury__pqueue__LCMC__pred__remove_2__1_3_p_0(TypeInfo_for_K_36, TypeInfo_for_V_37, L1_22, R1_23, AddrPQ1_50);
      }
    }
  }
}
