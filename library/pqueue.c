...
MR_decl_label8(pqueue__remove_2_3_0, 5,3,51,8,11,13,9,14)
MR_decl_label1(pqueue__remove_2_3_0, 16)
...
MR_BEGIN_MODULE(pqueue_module5)
	...
	MR_init_label8(pqueue__remove_2_3_0,5,3,51,8,11,13,9,14)
	MR_init_label1(pqueue__remove_2_3_0,16)
MR_BEGIN_CODE
...
MR_def_label(pqueue__remove_2_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(pqueue__remove_2_3_0_i51);
	}
	MR_r1 = MR_r3;
	MR_proceed();
MR_def_label(pqueue__remove_2_3_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
