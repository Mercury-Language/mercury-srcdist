  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word ArgY4_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 3)));
        MR_Word ArgY5_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 4)));
        MR_Word Var_24;
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0(TypeInfo_for_K_30, &Var_25, Var_40, ArgY2_17);
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0(TypeInfo_for_V_31, &Var_26, Var_39, ArgY3_19);
            ...
            else
            {
              ...
              mercury__pqueue____Compare____pqueue_2_0(TypeInfo_for_K_30, TypeInfo_for_V_31, &Var_27, Var_38, ArgY4_21);
              ...
              else
              {
                ...
                MR_Word next_value_of_HeadVar__3_3 = ArgY5_23;
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 4)));

      HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) D_3 + (MR_Unsigned) (MR_Integer) 1);
    }
    return HeadVar__2_2;
  }
}
...
{
  if ((HeadVar__1_1 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
    *Q_2 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  else
  {
    MR_Box K_4;
    MR_Box V_5;
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Q0_3)) == (MR_mktag((MR_Integer) 1)));
    MR_Box K_5;
    MR_Box V_6;
    MR_Word Q1_7;
    MR_Word L0_16;
    ...
    if (succeeded)
    {
      Var_15 = ((MR_Integer) (MR_hl_field(MR_mktag(1), Q0_3, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      mercury__pqueue__to_assoc_list_2_p_0(TypeInfo_for_K_10, TypeInfo_for_V_11, Q1_7, &L0_8);
      {
      ...
      }
      {
        ...
        *L_4 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (L0_8));
      }
    }
    else
      *L_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
  }
}
...
{
  {
    ...
    if ((A_4 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      Var_7 = (MR_Integer) 0;
    else
    {
      MR_Integer D_11 = ((MR_Integer) (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 0)));
      MR_Box Var_12 = (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 1));
      MR_Box Var_13 = (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 2));
      MR_Word Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 3)));
      MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 4)));

      Var_7 = (MR_Integer) ((MR_Unsigned) D_11 + (MR_Unsigned) (MR_Integer) 1);
    }
    if ((B_5 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      Var_8 = (MR_Integer) 0;
    else
    {
      MR_Integer D_17 = ((MR_Integer) (MR_hl_field(MR_mktag(1), B_5, (MR_Integer) 0)));
      MR_Box Var_18 = (MR_hl_field(MR_mktag(1), B_5, (MR_Integer) 1));
      MR_Box Var_19 = (MR_hl_field(MR_mktag(1), B_5, (MR_Integer) 2));
      MR_Word Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), B_5, (MR_Integer) 3)));
      MR_Word Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), B_5, (MR_Integer) 4)));

      Var_8 = (MR_Integer) ((MR_Unsigned) D_17 + (MR_Unsigned) (MR_Integer) 1);
    }
  ...
  MR_Word * C_6)
{
  ...
  else
  {
    ...
    MR_Integer Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), A_4, (MR_Integer) 0)));
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_PQ_0_10)) == (MR_mktag((MR_Integer) 1)));
    MR_Box K0_8;
    MR_Box V0_9;
    ...
    if (succeeded)
    {
      Var_22 = ((MR_Integer) (MR_hl_field(MR_mktag(1), STATE_VARIABLE_PQ_0_10, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer D0M1_26 = (MR_Integer) ((MR_Unsigned) Var_42 - (MR_Unsigned) (MR_Integer) 1);
          MR_Integer D_27;
          MR_Word PQ0_28;
          ...
          if (succeeded)
            ...
            D_27 = D1_19;
          mercury__pqueue__remove_2_3_p_0(TypeInfo_for_K_36, TypeInfo_for_V_37, Var_39, Var_38, &PQ0_28);
          {
            MR_Word base;
            ...
            *HeadVar__3_3 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (PQ0_28));
            MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (HeadVar__2_2));
          }
        }
        else
        {
          MR_Integer D1M1_29 = (MR_Integer) ((MR_Unsigned) Var_42 - (MR_Unsigned) (MR_Integer) 1);
          MR_Word PQ1_30;
          MR_Integer D_35;
          ...
          if (succeeded)
            ...
            D_35 = D1_19;
          mercury__pqueue__remove_2_3_p_0(TypeInfo_for_K_36, TypeInfo_for_V_37, L1_22, R1_23, &PQ1_30);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__3_3 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (PQ1_30));
...
{
  {
      ...
      if ((HeadVar__4_4 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
      {
...

        {
          ...
          *HeadVar__5_5 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Var_10));
          MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (Var_11));
        }
        *HeadVar__6_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      }
      else
      {
        MR_Word Var_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...

        {
          ...
          *HeadVar__5_5 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (Var_31));
        }
    ...
    else
    {
      ...
      MR_Word Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 4)));
      MR_Word Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 3)));
      MR_Box Var_52 = (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 2));
        ...
        *HeadVar__5_5 = HeadVar__3_3;
        ...
        Var_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        {
          ...
          *HeadVar__6_6 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 1) = K_1;
          MR_hl_field(MR_mktag(1), base, 2) = V_2;
          MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Var_20));
          MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (Var_21));
        }
      }
      else
      {
        MR_Integer D1_39 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0)));
        MR_Box K1_40 = (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1));
        MR_Box V1_41 = (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 2));
        MR_Word L1_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 3)));
        MR_Word R1_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 4)));
    ...
    if ((HeadVar__3_3 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
    {
...

      {
        ...
        *HeadVar__4_4 = base;
        ...
        MR_hl_field(MR_mktag(1), base, 1) = K_1;
        MR_hl_field(MR_mktag(1), base, 2) = V_2;
        MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Var_8));
        MR_hl_field(MR_mktag(1), base, 4) = ((MR_Box) (Var_9));
      }
    }
    else
    {
      ...
      MR_Integer D_18 = (MR_Integer) ((MR_Unsigned) D0_12 + (MR_Unsigned) (MR_Integer) 1);
      MR_Word CMP_19;
      MR_Box K1_20;
      MR_Box V1_21;
      MR_Word L_22;
      ...
      if (succeeded)
      {
        K1_20 = K_1;
        V1_21 = V_2;
        if ((L0_15 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
          if ((R0_16 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
          {
            MR_Word Var_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            MR_Word Var_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

            {
              L_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), L_22, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(1), L_22, 1) = K0_13;
              MR_hl_field(MR_mktag(1), L_22, 2) = V0_14;
              MR_hl_field(MR_mktag(1), L_22, 3) = ((MR_Box) (Var_30));
              MR_hl_field(MR_mktag(1), L_22, 4) = ((MR_Box) (Var_31));
            }
            R_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          }
          else
          {
            MR_Word Var_50 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            MR_Word Var_51 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));

            {
              ...
              MR_hl_field(MR_mktag(1), L_22, 1) = K0_13;
              MR_hl_field(MR_mktag(1), L_22, 2) = V0_14;
              MR_hl_field(MR_mktag(1), L_22, 3) = ((MR_Box) (Var_50));
              MR_hl_field(MR_mktag(1), L_22, 4) = ((MR_Box) (Var_51));
            }
            R_23 = R0_16;
          }
        else
        {
          ...
          MR_Word Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), L0_15, (MR_Integer) 4)));
          MR_Word Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), L0_15, (MR_Integer) 3)));
          MR_Box Var_70 = (MR_hl_field(MR_mktag(1), L0_15, (MR_Integer) 2));
          MR_Box Var_71 = (MR_hl_field(MR_mktag(1), L0_15, (MR_Integer) 1));
          ...
          if ((R0_16 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
          {
            ...
            {
              R_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), R_23, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(1), R_23, 1) = K0_13;
              MR_hl_field(MR_mktag(1), R_23, 2) = V0_14;
              MR_hl_field(MR_mktag(1), R_23, 3) = ((MR_Box) (Var_40));
              MR_hl_field(MR_mktag(1), R_23, 4) = ((MR_Box) (Var_41));
            }
          }
          else
          {
            MR_Integer D1_59 = ((MR_Integer) (MR_hl_field(MR_mktag(1), R0_16, (MR_Integer) 0)));
            MR_Box K1_60 = (MR_hl_field(MR_mktag(1), R0_16, (MR_Integer) 1));
            MR_Box V1_61 = (MR_hl_field(MR_mktag(1), R0_16, (MR_Integer) 2));
            MR_Word L1_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), R0_16, (MR_Integer) 3)));
            MR_Word R1_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), R0_16, (MR_Integer) 4)));
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) PQ_4)) == (MR_mktag((MR_Integer) 1)));
    MR_Box KPrime_7;
    MR_Box VPrime_8;
    MR_Integer Var_16;
    MR_Word Var_17;
    ...
    if (succeeded)
    {
      Var_16 = ((MR_Integer) (MR_hl_field(MR_mktag(1), PQ_4, (MR_Integer) 0)));
      KPrime_7 = (MR_hl_field(MR_mktag(1), PQ_4, (MR_Integer) 1));
      VPrime_8 = (MR_hl_field(MR_mktag(1), PQ_4, (MR_Integer) 2));
      Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), PQ_4, (MR_Integer) 3)));
      Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), PQ_4, (MR_Integer) 4)));
      *K_5 = KPrime_7;
      *V_6 = VPrime_8;
    }
    else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *V_5 = (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 2));
      ...
      Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 4)));
    }
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      *K_5 = (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1));
      *V_6 = (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 2));
      Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 3)));
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 4)));
    }
    return succeeded;
  }
}
...
{
  {
    MR_Word PQ_2 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
