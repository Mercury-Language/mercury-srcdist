...
MR_decl_label2(pqueue__assoc_list_to_pqueue_2_0, 4,3)
MR_decl_label5(pqueue__insert_4_0, 21,4,7,5,8)
MR_decl_label6(pqueue__insert_2_6_0, 5,3,37,9,8,10)
MR_decl_label2(pqueue__remove_4_0, 3,1)
MR_decl_label8(pqueue__remove_2_3_0, 5,3,8,11,13,9,14,16)
MR_decl_label1(pqueue__remove_2_3_0, 7)
MR_decl_label3(pqueue__to_assoc_list_2_0, 4,5,2)
MR_decl_label6(__Unify___pqueue__pqueue_2_0, 39,3,5,7,9,1)
MR_decl_label8(__Compare___pqueue__pqueue_2_0, 70,5,3,7,10,11,13,17)
MR_decl_label3(__Compare___pqueue__pqueue_2_0, 21,25,75)
...
MR_BEGIN_MODULE(pqueue_module2)
	...
	MR_init_label5(pqueue__insert_4_0,21,4,7,5,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__pqueue__insert_4_0);
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(pqueue__insert_4_0_i21);
	}
	...
	MR_proceed();
MR_def_label(pqueue__insert_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		pqueue__insert_4_0_i4);
MR_def_label(pqueue__insert_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(pqueue__insert_4_0_i5);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(3);
	...
	MR_np_call_localret_ent(pqueue__insert_2_6_0,
		pqueue__insert_4_0_i7);
MR_def_label(pqueue__insert_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(pqueue_module3)
	...
	MR_init_label6(pqueue__insert_2_6_0,5,3,37,9,8,10)
MR_BEGIN_CODE
...
MR_def_label(pqueue__insert_2_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(pqueue__insert_2_6_0_i37);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 5);
...
MR_def_label(pqueue__insert_2_6_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	...
	if (((MR_Integer) MR_tempr1 <= (MR_Integer) MR_tempr2)) {
		MR_GOTO_LAB(pqueue__insert_2_6_0_i8);
	}
	MR_sv(1) = MR_tempr3;
	MR_r5 = MR_r4;
	MR_r4 = MR_r3;
	...
	MR_np_call_localret_ent(pqueue__insert_4_0,
		pqueue__insert_2_6_0_i9);
MR_def_label(pqueue__insert_2_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(2);
MR_def_label(pqueue__insert_2_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r6;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(pqueue__insert_4_0,
		pqueue__insert_2_6_0_i10);
MR_def_label(pqueue__insert_2_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_decr_sp_and_return(2);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(pqueue_module5)
	...
	MR_init_label8(pqueue__remove_2_3_0,5,3,8,11,13,9,14,16)
	MR_init_label1(pqueue__remove_2_3_0,7)
MR_BEGIN_CODE
...
MR_def_label(pqueue__remove_2_3_0,3)
	...
	if (MR_LTAGS_TEST(MR_r4,0,0)) {
		MR_GOTO_LAB(pqueue__remove_2_3_0_i7);
	}
	MR_incr_sp(15);
...
MR_def_label(pqueue__remove_2_3_0,9)
	...
	MR_tempr1 = ((MR_Integer) MR_sv(14) - (MR_Integer) 1);
	if (((MR_Integer) MR_tempr1 <= (MR_Integer) MR_sv(3))) {
		MR_GOTO_LAB(pqueue__remove_2_3_0_i14);
	}
	MR_r3 = MR_sv(6);
	MR_r4 = MR_sv(7);
	MR_sv(2) = MR_tempr1;
	...
	MR_np_localcall_lab(pqueue__remove_2_3_0,
		pqueue__remove_2_3_0_i16);
MR_def_label(pqueue__remove_2_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(6);
	MR_r4 = MR_sv(7);
	MR_sv(2) = MR_sv(3);
	...
	MR_np_localcall_lab(pqueue__remove_2_3_0,
		pqueue__remove_2_3_0_i16);
MR_def_label(pqueue__remove_2_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 5);
...
MR_def_label(pqueue__remove_2_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(pqueue_module9)
	...
	MR_init_label2(pqueue__assoc_list_to_pqueue_2_0,4,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__pqueue__assoc_list_to_pqueue_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(pqueue__assoc_list_to_pqueue_2_0_i3);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	{
...
MR_def_label(pqueue__assoc_list_to_pqueue_2_0,4)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(pqueue__insert_4_0);
MR_def_label(pqueue__assoc_list_to_pqueue_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(pqueue_module12)
	...
	MR_init_label6(__Unify___pqueue__pqueue_2_0,39,3,5,7,9,1)
MR_BEGIN_CODE
...
MR_def_label(__Unify___pqueue__pqueue_2_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Unify___pqueue__pqueue_2_0_i3);
	}
	MR_r1 = (MR_r4 == MR_r3);
	MR_decr_sp_and_return(9);
MR_def_label(__Unify___pqueue__pqueue_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r4,0,0)) {
	...
	MR_sv(5) = MR_ctfield(1, MR_tempr4, 3);
	MR_sv(6) = MR_ctfield(1, MR_tempr4, 4);
	MR_sv(7) = MR_r1;
	MR_sv(8) = MR_r2;
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___pqueue__pqueue_2_0_i5);
...
MR_def_label(__Unify___pqueue__pqueue_2_0,9)
	...
	MR_GOTO_LAB(__Unify___pqueue__pqueue_2_0_i39);
...
MR_BEGIN_MODULE(pqueue_module13)
	...
	MR_init_label8(__Compare___pqueue__pqueue_2_0,70,5,3,7,10,11,13,17)
	MR_init_label3(__Compare___pqueue__pqueue_2_0,21,25,75)
MR_BEGIN_CODE
...
MR_def_label(__Compare___pqueue__pqueue_2_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
...
MR_def_label(__Compare___pqueue__pqueue_2_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(11);
MR_def_label(__Compare___pqueue__pqueue_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
...
MR_def_label(__Compare___pqueue__pqueue_2_0,7)
	...
	if (((MR_Integer) MR_r5 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i10);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_sv(6) = MR_r2;
...
MR_def_label(__Compare___pqueue__pqueue_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r5 != MR_r3)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i11);
	}
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_sv(6) = MR_r2;
	MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i13);
MR_def_label(__Compare___pqueue__pqueue_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	MR_sv(6) = MR_r2;
MR_def_label(__Compare___pqueue__pqueue_2_0,13)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i75);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
	MR_r2 = MR_sv(10);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___pqueue__pqueue_2_0_i17);
MR_def_label(__Compare___pqueue__pqueue_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i75);
	}
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___pqueue__pqueue_2_0_i21);
MR_def_label(__Compare___pqueue__pqueue_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i75);
	}
	...
	MR_np_localcall_lab(__Compare___pqueue__pqueue_2_0,
		__Compare___pqueue__pqueue_2_0_i25);
MR_def_label(__Compare___pqueue__pqueue_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i75);
	}
	...
	MR_GOTO_LAB(__Compare___pqueue__pqueue_2_0_i70);
MR_def_label(__Compare___pqueue__pqueue_2_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__pqueue__write_out_proc_statics(FILE *fp);
#endif
