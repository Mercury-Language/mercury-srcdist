...
{
  {
    ...
    if (mercury__diet__succeeded)
    {
      ...
      mercury__diet__member_2_p_1(mercury__diet__TypeClassInfo_for_diet_element_13, mercury__diet__Elem_1, mercury__diet__Right_11, mercury__diet__cont, mercury__diet__cont_env_ptr);
    }
  }
}
    ...
    if (mercury__diet__succeeded)
    {
      *mercury__diet__Elem_6 = mercury__diet__Lo_4;
      mercury__diet__cont(mercury__diet__cont_env_ptr);
      {
        ...
        mercury__diet__member_in_range_3_p_0(mercury__diet__TypeClassInfo_for_diet_element_8, mercury__diet__Var_7, mercury__diet__Hi_5, mercury__diet__Elem_6, mercury__diet__cont, mercury__diet__cont_env_ptr);
      }
    }
    else
    {
