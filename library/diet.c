  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          TypeInfo_28_28 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeInfo_28_28, 0) = ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_tuple_0));
        ...
        mercury__builtin__compare_3_p_0(TypeInfo_28_28, &SubResult1_14, ((MR_Box) (Var_37)), ((MR_Box) (ArgY1_13)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          TypeInfo_18_18 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
...
#undef MR_PROC_LABEL
	TypeInfo_23_23  = TypeInfo;
        ...
        {
          TypeInfo_26_26 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
