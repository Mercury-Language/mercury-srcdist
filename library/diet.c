  ...
  MR_Word * STATE_VARIABLE_Acc_14)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_T_6 = L_11;
        MR_Word next_value_of_STATE_VARIABLE_Acc_0_13 = STATE_VARIABLE_Acc_17_17;
  ...
  MR_Word * STATE_VARIABLE_A_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Box next_value_of_Hi_8 = Var_13;
        MR_Word next_value_of_STATE_VARIABLE_A_0_10 = STATE_VARIABLE_A_12_12;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Set_4 = R_9;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_5 = Var_7;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word next_value_of_T_6 = L_11;
            MR_Box next_value_of_STATE_VARIABLE_Acc_0_13 = STATE_VARIABLE_Acc_17_17;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T_14 = R_24;
            MR_Box next_value_of_STATE_VARIABLE_A_0_25 = STATE_VARIABLE_A_41_41;
            MR_Box next_value_of_STATE_VARIABLE_B_0_27 = STATE_VARIABLE_B_42_42;
            MR_Box next_value_of_STATE_VARIABLE_C_0_29 = STATE_VARIABLE_C_43_43;
            MR_Box next_value_of_STATE_VARIABLE_D_0_31 = STATE_VARIABLE_D_44_44;
            MR_Box next_value_of_STATE_VARIABLE_E_0_33 = STATE_VARIABLE_E_45_45;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_15 = Var_37;
          MR_Box next_value_of_STATE_VARIABLE_A_0_22 = STATE_VARIABLE_A_32_32;
          MR_Box next_value_of_STATE_VARIABLE_B_0_24 = STATE_VARIABLE_B_33_33;
          MR_Box next_value_of_STATE_VARIABLE_C_0_26 = STATE_VARIABLE_C_34_34;
          MR_Box next_value_of_STATE_VARIABLE_D_0_28 = STATE_VARIABLE_D_35_35;
          MR_Box next_value_of_STATE_VARIABLE_E_0_30 = STATE_VARIABLE_E_36_36;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T_12 = R_21;
            MR_Box next_value_of_STATE_VARIABLE_A_0_22 = STATE_VARIABLE_A_35_35;
            MR_Box next_value_of_STATE_VARIABLE_B_0_24 = STATE_VARIABLE_B_36_36;
            MR_Box next_value_of_STATE_VARIABLE_C_0_26 = STATE_VARIABLE_C_37_37;
            MR_Box next_value_of_STATE_VARIABLE_D_0_28 = STATE_VARIABLE_D_38_38;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_13 = Var_31;
          MR_Box next_value_of_STATE_VARIABLE_A_0_19 = STATE_VARIABLE_A_27_27;
          MR_Box next_value_of_STATE_VARIABLE_B_0_21 = STATE_VARIABLE_B_28_28;
          MR_Box next_value_of_STATE_VARIABLE_C_0_23 = STATE_VARIABLE_C_29_29;
          MR_Box next_value_of_STATE_VARIABLE_D_0_25 = STATE_VARIABLE_D_30_30;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T_10 = R_18;
            MR_Box next_value_of_STATE_VARIABLE_Acc1_0_19 = STATE_VARIABLE_Acc1_29_29;
            MR_Box next_value_of_STATE_VARIABLE_Acc2_0_21 = STATE_VARIABLE_Acc2_30_30;
            MR_Box next_value_of_STATE_VARIABLE_Acc3_0_23 = STATE_VARIABLE_Acc3_31_31;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_11 = Var_25;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T_8 = R_15;
            MR_Box next_value_of_STATE_VARIABLE_Acc1_0_16 = STATE_VARIABLE_Acc1_23_23;
            MR_Box next_value_of_STATE_VARIABLE_Acc2_0_18 = STATE_VARIABLE_Acc2_24_24;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_9 = Var_19;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T_6 = R_12;
            MR_Box next_value_of_STATE_VARIABLE_Acc_0_13 = STATE_VARIABLE_Acc_17_17;
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Box next_value_of_Lo_7 = Var_13;
          MR_Box next_value_of_STATE_VARIABLE_Acc_0_10 = STATE_VARIABLE_Acc_12_12;
  ...
  MR_Integer * Acc_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_T_4 = R_11;
        MR_Integer next_value_of_Acc0_5 = Acc2_13;
  ...
  MR_Word * STATE_VARIABLE_Acc2_19)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_T_8 = R_15;
        MR_Word next_value_of_STATE_VARIABLE_Acc1_0_16 = STATE_VARIABLE_Acc1_23_23;
        MR_Word next_value_of_STATE_VARIABLE_Acc2_0_18 = STATE_VARIABLE_Acc2_24_24;
  ...
  MR_Word * STATE_VARIABLE_B_16)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Box next_value_of_Lo_9 = Var_19;
        MR_Word next_value_of_STATE_VARIABLE_A_0_13 = STATE_VARIABLE_A_17_17;
        MR_Word next_value_of_STATE_VARIABLE_B_0_15 = STATE_VARIABLE_B_18_18;
    ...
    else
    {
      ...
      if (succeeded)
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Head0_13 = Var_30;
            MR_Word next_value_of_Stream0_14 = Stream1_25;
	 ...
	 TypeInfo_28_77  = TypeInfo;
        ...
        else
        {
          ...
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Tuple next_value_of_HeadVar__1_1 = Var_37;
              MR_Word next_value_of_Left0_12 = Left1_27;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Left0_10 = Left1_22;
          MR_Word next_value_of_Head0_15 = Head1_23;
          MR_Word next_value_of_Stream0_16 = Stream1_24;
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Tuple next_value_of_HeadVar__2_2 = Var_33;
              MR_Word next_value_of_Head0_15 = Head1_43;
              MR_Word next_value_of_Stream0_16 = Stream1_44;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Head0_13 = Head1_20;
          MR_Word next_value_of_Stream0_14 = Stream1_21;
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Tuple next_value_of_HeadVar__1_1 = Var_29;
              MR_Word next_value_of_Left0_12 = Left1_23;
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Tuple next_value_of_HeadVar__1_1 = Var_30;
                MR_Word next_value_of_Head0_13 = Head1_33;
                MR_Word next_value_of_Stream0_14 = Stream1_34;
    ...
    else
    {
      ...
      if (succeeded)
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Tuple next_value_of_HeadVar__3_3 = Min2_17;
            MR_Word next_value_of_R2_11 = MinR2_18;
        ...
        switch (Upper_19) {
          ...
          case (MR_Integer) 1:
            ...
            else
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Tuple next_value_of_HeadVar__1_1 = Min1_24;
                MR_Word next_value_of_R1_8 = MinR1_25;
          ...
          case (MR_Integer) 0:
            ...
            else
            {
              ...
              /* direct tailcall eliminated */
              {
                MR_Tuple next_value_of_HeadVar__1_1 = Min1_42;
                MR_Word next_value_of_R1_8 = MinR1_43;
                MR_Tuple next_value_of_HeadVar__3_3 = Min2_40;
                MR_Word next_value_of_R2_11 = MinR2_41;
...
#undef MR_PROC_LABEL
	 TypeInfo_23_23  = TypeInfo;
        ...
        if (succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_T1_3 = R1_15;
            MR_Word next_value_of_T2_4 = R2_16;
  ...
  MR_Word * T_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_T0_4 = N1_16;
