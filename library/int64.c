...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int64.(>>): second operand is out of range")))));
    return Result_6;
  }
}
...
{
  {
    ...
    if (succeeded)
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int64.rem: division by zero")))));
    else
      Rem_6 = (X_4 % Y_5);
    return Rem_6;
  }
...
{
  {
    ...
    if (succeeded)
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__math__math__type_ctor_info_domain_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int64.\'//\': division by zero")))));
    else
...
{
  {
    ...
    if (succeeded)
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__exception__exception__type_ctor_info_software_error_0), ((MR_Box) (((MR_Box) ((MR_String) "int64.abs: abs(min_int64) would overflow")))));
    else
    {
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      mercury__require__error_1_p_0((MR_String) "int64.det_to_int: cannot convert int64 to int");
    return I_4;
  }
}
