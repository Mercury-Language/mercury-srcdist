...
int64_t MR_CALL 
mercury__int64__clamp_3_f_0(
  int64_t Min_5,
  int64_t Max_6,
  int64_t N_7)
{
  MR_bool succeeded = (Max_6 >= Min_5);
  int64_t HeadVar__4_4;
  ...
  else
  {
    ...
    conv0_HeadVar__4_4 = mercury__require__func_error_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int64_0), (MR_String) "function \140int64.clamp\'/3", (MR_String) "Max < Min");
    HeadVar__4_4 = MR_unbox_int64(conv0_HeadVar__4_4);
  }
  return HeadVar__4_4;
}
