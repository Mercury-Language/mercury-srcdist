...
MR_decl_label5(bitmap__throw_bounds_error_4_0, 3,2,8,9,10)
...
MR_BEGIN_MODULE(bitmap_module29)
	...
	MR_init_label5(bitmap__throw_bounds_error_4_0,3,2,8,9,10)
MR_BEGIN_CODE
...
MR_def_label(bitmap__throw_bounds_error_4_0,2)
	...
	MR_r2 = (MR_Integer) 10;
	MR_np_call_localret_ent(string__int_to_base_string_3_0,
		bitmap__throw_bounds_error_4_0_i8);
MR_def_label(bitmap__throw_bounds_error_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
