...
#undef MR_PROC_LABEL
  ...
  mercury__string__do_to_char_list_loop_4_p_0(Var_15, Var_32, (MR_Word) ((MR_Unsigned) 0U), &LenChars_7);
  {
...
#undef MR_PROC_LABEL
    ...
    mercury__bitmap__unsafe_set_byte_4_p_0(PartialDestStartByteIndex_30, StartByte_32, STATE_VARIABLE_DestBM_54_54, &STATE_VARIABLE_DestBM_65_65);
  }
