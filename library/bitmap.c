...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_19 = (SrcStartByte_10 + NumBytes_13);
          Var_20 = (MR_Integer) 1;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_23 = (DestStartByte_12 + NumBytes_13);
              Var_24 = (MR_Integer) 1;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_19 = (SrcStartBit_10 + NumBits_13);
          Var_36 = (MR_Integer) 0;
...
#undef MR_PROC_LABEL
	 Var_37  = NumBits;
            ...
            if (succeeded)
            {
              Var_20 = (DestStartBit_12 + NumBits_13);
              Var_43 = (MR_Integer) 0;
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        {
          MR_Integer Var_22;
          MR_Integer Var_23 = (SrcStartBit_10 + NumBits_13);
          MR_Integer Var_51;
...
#undef MR_PROC_LABEL
	 Var_51  = NumBits;
      ...
      else
      {
        ...
        {
          MR_Integer Var_28;
          MR_Integer Var_29 = (DestStartBit_12 + NumBits_13);
          MR_Integer Var_58;
