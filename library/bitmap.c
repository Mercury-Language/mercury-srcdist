...
MR_decl_label5(fn__bitmap__new_2_0, 27,5,4,6,8)
...
MR_decl_label10(fn__bitmap__unsafe_copy_bits_6_0, 3,2,6,10,12,13,14,15,16,17)
...
MR_decl_label9(fn__bitmap__unsafe_copy_unaligned_bits_6_0, 30,31,32,26,33,37,38,39,34)
...
MR_BEGIN_MODULE(bitmap_module13)
	...
	MR_init_label5(fn__bitmap__new_2_0,27,5,4,6,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__bitmap__new_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_GE(MR_r1,0)) {
		MR_GOTO_LAB(fn__bitmap__new_2_0_i27);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(bitmap, bitmap_error);
	MR_r2 = (MR_Word) MR_string_const("bitmap.new: negative size", 25);
	MR_np_tailcall_ent(exception__throw_1_0);
MR_def_label(fn__bitmap__new_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
...
MR_def_label(fn__bitmap__new_2_0,6)
	...
	MR_np_call_localret_ent(fn__bitmap__initialize_bitmap_bytes_4_0,
		fn__bitmap__new_2_0_i8);
MR_def_label(fn__bitmap__new_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	{
...
MR_BEGIN_MODULE(bitmap_module27)
	...
	MR_init_label9(fn__bitmap__unsafe_copy_unaligned_bits_6_0,30,31,32,26,33,37,38,39,34)
MR_BEGIN_CODE
...
MR_def_static(fn__bitmap__unsafe_copy_unaligned_bits_6_0)
	...
	MR_r2 = ((MR_Integer) MR_sv(6) % (MR_Integer) 8);
	MR_r5 = MR_r4;
	MR_sv(12) = MR_tempr3;
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,4)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(7);
	MR_sv(8) = ((MR_Integer) MR_r7 + (MR_Integer) MR_tempr1);
	MR_sv(9) = ((MR_Integer) MR_sv(4) + (MR_Integer) MR_tempr1);
	MR_r2 = ((MR_Integer) MR_sv(6) % (MR_Integer) 8);
	MR_r5 = MR_sv(11);
	MR_sv(12) = ((MR_Integer) MR_r8 - (MR_Integer) MR_tempr1);
	}
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,6)
	...
	MR_sv(10) = MR_tempr1;
	MR_sv(11) = MR_r5;
	MR_r1 = (((((MR_Integer) MR_sv(8) + (MR_Integer) MR_sv(12)) - (MR_Integer) 1) - (MR_Integer) MR_tempr1) + (MR_Integer) 1);
	MR_r2 = MR_tempr1;
	MR_r3 = MR_sv(2);
	}
	MR_np_call_localret_ent(fn__bitmap__unsafe_bits_3_0,
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,9)
	...
	MR_r2 = (MR_Integer) 1;
	MR_r8 = MR_r3;
	MR_r3 = ((MR_Integer) MR_sv(8) % (MR_Integer) 8);
	MR_r4 = MR_r8;
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = ((MR_Integer) MR_sv(8) / (MR_Integer) 8);
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,14)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r4;
	MR_r6 = (((MR_Integer) MR_sv(8) + (MR_Integer) MR_tempr1) - (MR_Integer) 1);
	if (MR_INT_GE(MR_r6,0)) {
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,25)
	...
	MR_np_call_localret_ent(fn__bitmap__byte_index_for_bit_1_0,
		fn__bitmap__unsafe_copy_unaligned_bits_6_0_i29);
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__bitmap__unsafe_byte_2_0,
		fn__bitmap__unsafe_copy_unaligned_bits_6_0_i30);
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,32)
	...
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_GOTO_LAB(fn__bitmap__unsafe_copy_unaligned_bits_6_0_i33);
...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,33)
	...
	MR_np_call_localret_ent(fn__bitmap__byte_index_for_bit_1_0,
		fn__bitmap__unsafe_copy_unaligned_bits_6_0_i37);
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__bitmap__unsafe_byte_2_0,
...
MR_BEGIN_MODULE(bitmap_module28)
	...
	MR_init_label10(fn__bitmap__unsafe_copy_bits_6_0,3,2,6,10,12,13,14,15,16,17)
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,14)
	...
	MR_np_call_localret_ent(fn__bitmap__extract_bits_from_byte_3_0,
		fn__bitmap__unsafe_copy_bits_6_0_i15);
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,16)
	...
	if (MR_INT_NE(MR_r7,1)) {
		MR_GOTO_LAB(fn__bitmap__unsafe_copy_bits_6_0_i17);
	}
	MR_sv(6) = MR_r3;
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,17)
	...
	MR_np_call_localret_ent(fn__bitmap__byte_index_for_bit_1_0,
		fn__bitmap__unsafe_copy_bits_6_0_i19);
