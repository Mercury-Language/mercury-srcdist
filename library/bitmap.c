...
#undef MR_PROC_LABEL
	Var_50  = NumBits;
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) Var_50);
      // direct tailcall eliminated
      ;
...
#undef MR_PROC_LABEL
	Var_26  = NumBits;
      ...
      mercury__bitmap__zip2__ho11_5_p_0(Var_24, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_27  = NumBits;
      ...
      mercury__bitmap__zip2__ho10_5_p_0(Var_25, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_22  = NumBits;
      ...
      mercury__bitmap__zip2__ho9_5_p_0(Var_20, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
