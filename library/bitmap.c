  ...
  MR_Word Slice_6)
{
  ...
  MR_Integer Var_11;
  MR_Integer Var_12;
  MR_Integer Var_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Slice_6, (MR_Integer) 1))));
  MR_Integer Var_20;

  Var_11 = mercury__bitmap__quotient_bits_per_byte_with_rem_zero_2_f_0((MR_String) "bitmap.slice_start_byte_index", Var_13);
  Var_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Slice_6, (MR_Integer) 2))));
...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (!(succeeded))
      {
        ...
        mercury__io__make_io_error_from_system_error_5_p_0(Error_13, (MR_String) "error writing to output file: ", &Var_28);
        {
...
#undef MR_PROC_LABEL
  ...
  Var_19 = (NumBits_18 % (MR_Integer) 8);
  succeeded = (Var_19 == (MR_Integer) 0);
  if (succeeded)
  {
    Var_21 = (MR_Integer) 8;
    NumBytes_8 = (NumBits_18 / Var_21);
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (!(succeeded))
    {
      ...
      mercury__io__make_io_error_from_system_error_5_p_0(Error_10, (MR_String) "error writing to output file: ", &Var_23);
      {
        mercury__exception__throw_1_p_0((MR_Word) (&mercury__io__io__type_ctor_info_error_0), ((MR_Box) (Var_23)));
        return;
      }
    }
  }
...
#undef MR_PROC_LABEL
  ...
  Var_24 = (NumBits_23 % (MR_Integer) 8);
  succeeded = (Var_24 == (MR_Integer) 0);
  if (succeeded)
  {
    Var_26 = (MR_Integer) 8;
    NumBytes_13 = (NumBits_23 / Var_26);
    succeeded = MR_TRUE;
  }
  if (succeeded)
...
succeeded  = SUCCESS_INDICATOR;
    ...
    else
    {
      ...
      mercury__io__make_io_error_from_system_error_5_p_0(Error_18, (MR_String) "read failed: ", &Var_39);
      {
        MaybeIOError_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeIOError_19, 0) = ((MR_Box) (Var_39));
      }
    }
...
#undef MR_PROC_LABEL
	Var_22  = NumBits;
      ...
      mercury__bitmap__zip2__ho10_5_p_0(Var_20, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_23  = NumBits;
      ...
      mercury__bitmap__zip2__ho9_5_p_0(Var_21, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_18  = NumBits;
      ...
      mercury__bitmap__zip2__ho8_5_p_0(Var_16, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_18  = NumBits;
      ...
      if (succeeded)
        ...
        Var_16 = (Var_17 / (MR_Integer) 8);
      mercury__bitmap__zip2__ho7_5_p_0(Var_16, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      Var_25 = (MR_Word) (Var_19);
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__bitmap__bitmap__type_ctor_info_bitmap_error_0), ((MR_Box) (Var_25)));
    }
    else
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      Var_21 = (MR_Word) (Var_15);
      mercury__exception__throw_1_p_0((MR_Word) (&mercury__bitmap__bitmap__type_ctor_info_bitmap_error_0), ((MR_Box) (Var_21)));
    }
    else
