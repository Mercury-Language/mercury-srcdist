...
MR_decl_label3(bitmap__list__foldl2__ho2_6_0, 11,4,3)
...
MR_def_label(bitmap__throw_bounds_error_4_0,5)
	...
	MR_Integer	NumBits;
#define	MR_PROC_LABEL	mercury__bitmap__throw_bounds_error_4_0
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_sv(1), BM);
{
#line 1669 "bitmap.m"
...
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_sv(1), BM1);
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_sv(2), BM2);
{
#line 1569 "bitmap.m"
...
#define SUCCESS_INDICATOR MercurySuccessIndicator
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_sv(1), BM1);
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_sv(4), BM2);
{
#line 1569 "bitmap.m"
...
MR_BEGIN_MODULE(bitmap_module120)
	...
	MR_init_label3(bitmap__list__foldl2__ho2_6_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_static(bitmap__list__foldl2__ho2_6_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(bitmap__list__foldl2__ho2_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#define	MR_PROC_LABEL	mercury__bitmap__list__foldl2__ho2_6_0
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_BitmapPtr, MR_tempr1, BM);
{
#line 1669 "bitmap.m"
...
#undef	MR_PROC_LABEL
	...
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(bitmap__list__foldl2__ho2_6_0_i11);
	}
