...
MR_def_label(fn__bitmap__unsafe_copy_unaligned_bits_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(4) / (MR_Integer) 8);
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,2)
	...
	MR_tempr1 = MR_r3;
	MR_tempr2 = MR_r6;
	MR_sv(7) = ((((MR_Integer) MR_tempr1 + (MR_Integer) MR_tempr2) - (MR_Integer) 1) % (MR_Integer) 8);
	MR_sv(6) = (((MR_Integer) MR_tempr1 + (MR_Integer) MR_tempr2) - (MR_Integer) 1);
	if (MR_INT_NE(MR_sv(5),0)) {
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,12)
	...
	MR_r2 = MR_sv(5);
	MR_r3 = MR_r7;
	MR_r1 = ((MR_Integer) MR_sv(3) / (MR_Integer) 8);
	MR_sv(9) = MR_r4;
	MR_sv(10) = MR_r6;
...
MR_def_label(fn__bitmap__unsafe_copy_bits_6_0,24)
	...
	MR_sv(2) = ((MR_Integer) MR_sv(9) + (MR_Integer) MR_sv(4));
	MR_sv(3) = MR_r2;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(fn__bitmap__unsafe_byte_2_0,
