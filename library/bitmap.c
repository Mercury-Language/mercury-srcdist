...
#undef MR_PROC_LABEL
	Var_22  = NumBits;
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) Var_22);
      // direct tailcall eliminated
      ;
...
#undef MR_PROC_LABEL
	Var_22  = NumBits;
      ...
      mercury__bitmap__zip2__ho11_5_p_0(Var_20, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_23  = NumBits;
      ...
      mercury__bitmap__zip2__ho10_5_p_0(Var_21, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
...
#undef MR_PROC_LABEL
	Var_18  = NumBits;
      ...
      mercury__bitmap__zip2__ho9_5_p_0(Var_16, BM_A_4, BM_B_5, &BM_6);
    }
  }
  else
