...
MR_decl_label3(__Unify___version_hash_table__bucket_2_0, 27,5,1)
MR_decl_label2(__Unify___version_hash_table__version_hash_table_2_0, 2,1)
MR_decl_label5(__Compare___version_hash_table__bucket_2_0, 5,3,39,9,36)
MR_decl_label8(__Compare___version_hash_table__version_hash_table_2_0, 4,5,7,12,13,15,20,21)
MR_decl_label3(__Compare___version_hash_table__version_hash_table_2_0, 23,27,34)
...
#line 1019 "version_hash_table.c"
	MR_r4 = TypeInfo;
#undef	MR_PROC_LABEL
	}
	{
...
;}
#line 1574 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("new");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1651 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
;}
#line 1733 "version_hash_table.c"
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 1794 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1934 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
;}
#line 1992 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("new");
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_tempr3);
#undef	MR_PROC_LABEL
	}
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2142 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2198 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 172 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2313 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2423 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2662 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2746 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2836 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
MR_BEGIN_MODULE(version_hash_table_module32)
	...
	MR_init_label3(__Unify___version_hash_table__bucket_2_0,27,5,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___version_hash_table__bucket_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Unify___version_hash_table__bucket_2_0_i27);
	}
	MR_r1 = (MR_r4 == MR_r3);
	MR_proceed();
MR_def_label(__Unify___version_hash_table__bucket_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___version_hash_table__bucket_2_0_i5);
...
MR_BEGIN_MODULE(version_hash_table_module33)
	...
	MR_init_label5(__Compare___version_hash_table__bucket_2_0,5,3,39,9,36)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___version_hash_table__bucket_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(__Compare___version_hash_table__bucket_2_0_i3);
	}
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
...
MR_def_label(__Compare___version_hash_table__bucket_2_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___version_hash_table__bucket_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(__Compare___version_hash_table__bucket_2_0_i39);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___version_hash_table__bucket_2_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___version_hash_table__bucket_2_0_i9);
MR_def_label(__Compare___version_hash_table__bucket_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___version_hash_table__bucket_2_0_i36);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___version_hash_table__bucket_2_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(version_hash_table_module40)
	...
	MR_init_label2(__Unify___version_hash_table__version_hash_table_2_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___version_hash_table__version_hash_table_2_0);
	...
	MR_np_call_localret_ent(f_118_101_114_115_105_111_110_95_104_97_115_104_95_116_97_98_108_101_95_95_112_114_105_118_97_116_101_95_98_117_105_108_116_105_110_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_117_105_108_116_105_110_95_117_110_105_102_121_95_112_114_101_100_95_95_91_49_44_32_50_93_95_48_2_0,
		__Unify___version_hash_table__version_hash_table_2_0_i2);
MR_def_label(__Unify___version_hash_table__version_hash_table_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___version_hash_table__version_hash_table_2_0_i1);
	}
...
MR_BEGIN_MODULE(version_hash_table_module41)
	...
	MR_init_label8(__Compare___version_hash_table__version_hash_table_2_0,4,5,7,12,13,15,20,21)
	MR_init_label3(__Compare___version_hash_table__version_hash_table_2_0,23,27,34)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___version_hash_table__version_hash_table_2_0);
	...
	if (((MR_Integer) MR_r4 >= (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i4);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_sv(8) = MR_r2;
...
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r4 != MR_r5)) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i5);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_sv(8) = MR_r2;
	MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i7);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	MR_sv(8) = MR_r2;
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i34);
	}
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(8);
	if (((MR_Integer) MR_sv(1) >= (MR_Integer) MR_sv(4))) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i12);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i15);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(1) != MR_sv(4))) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i13);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_sv(8) = MR_r2;
	MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i15);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 2;
	MR_sv(8) = MR_r2;
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,15)
	...
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(8);
	if (((MR_Integer) MR_sv(2) >= (MR_Integer) MR_sv(5))) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i20);
	}
	MR_r1 = (MR_Integer) 1;
	MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i23);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(2) != MR_sv(5))) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i21);
	}
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Integer) 0;
	MR_sv(8) = MR_r2;
...
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,23)
	...
	MR_np_call_localret_ent(f_118_101_114_115_105_111_110_95_104_97_115_104_95_116_97_98_108_101_95_95_112_114_105_118_97_116_101_95_98_117_105_108_116_105_110_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_117_105_108_116_105_110_95_99_111_109_112_97_114_101_95_112_114_101_100_95_95_91_50_44_32_51_93_95_48_3_0,
		__Compare___version_hash_table__version_hash_table_2_0_i27);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___version_hash_table__version_hash_table_2_0_i34);
	}
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(__Compare___version_array__version_array_1_0);
MR_def_label(__Compare___version_hash_table__version_hash_table_2_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#line 74 "array.opt"
    ...
    Min = 0;
;}
#line 3790 "version_hash_table.c"
	MR_r5 = Min;
#undef	MR_PROC_LABEL
	}
	{
...
#line 82 "array.opt"
    ...
    Max = Array->size - 1;
;}
#line 3804 "version_hash_table.c"
	MR_r6 = Max;
#undef	MR_PROC_LABEL
	}
