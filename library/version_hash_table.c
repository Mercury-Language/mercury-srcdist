...
MR_decl_label6(fn__version_hash_table__det_update_3_0, 2,4,8,12,16,10)
...
;}
#line 1596 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("new");
...
#line 179 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1673 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
;}
#line 1755 "version_hash_table.c"
...
#line 182 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 1820 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 179 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1964 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
;}
#line 2022 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("new");
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_tempr3);
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(version_hash_table_module19)
	...
	MR_init_label6(fn__version_hash_table__det_update_3_0,2,4,8,12,16,10)
MR_BEGIN_CODE
...
#line 179 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2172 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 182 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2222 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
if (!MercurySuccessIndicator) MR_GOTO_LAB(fn__version_hash_table__det_update_3_0_i12);
	MR_MAYBE_BOX_FOREIGN_TYPE(struct ML_va *, VA, MR_r2);
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	...
	MR_r1 = MR_r2;
	MR_GOTO_LAB(fn__version_hash_table__det_update_3_0_i16);
	}
MR_def_label(fn__version_hash_table__det_update_3_0,12)
	...
	MR_np_call_localret_ent(fn__require__func_error_1_0,
		fn__version_hash_table__det_update_3_0_i16);
...
#line 182 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2347 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 179 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2786 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 179 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2876 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 78 "builtin.opt"
    ...
    SUCCESS_INDICATOR = MR_TRUE;
;}
#line 3646 "version_hash_table.c"
...
#line 78 "builtin.opt"
    ...
    SUCCESS_INDICATOR = MR_TRUE;
;}
#line 3669 "version_hash_table.c"
...
#line 86 "array.opt"
    ...
    Min = 0;
;}
#line 3877 "version_hash_table.c"
	MR_r5 = Min;
#undef	MR_PROC_LABEL
	}
	{
...
#line 94 "array.opt"
    ...
    Max = Array->size - 1;
;}
#line 3891 "version_hash_table.c"
	MR_r6 = Max;
#undef	MR_PROC_LABEL
	}
