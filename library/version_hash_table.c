...
MR_decl_label7(fn__version_hash_table__new_2_4_0, 2,5,48,9,14,11,18)
...
MR_BEGIN_MODULE(version_hash_table_module0)
	...
	MR_init_label7(fn__version_hash_table__new_2_4_0,2,5,48,9,14,11,18)
MR_BEGIN_CODE
...
MR_def_label(fn__version_hash_table__new_2_4_0,5)
	...
	if ((MR_word_to_float(MR_r5) > (MR_Float) 0.0000000000000000)) {
		MR_GOTO_LAB(fn__version_hash_table__new_2_4_0_i48);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(exception, software_error);
	MR_r2 = (MR_Word) MR_string_const("version_hash_table.new: MaxOccupancy =< 0.0", 43);
	MR_np_tailcall_ent(exception__throw_1_0);
MR_def_label(fn__version_hash_table__new_2_4_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(fn__version_array__unsafe_new_2_0,
		fn__version_hash_table__new_2_4_0_i14);
MR_def_label(fn__version_hash_table__new_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__version_hash_table__new_2_4_0,11)
	...
	MR_np_call_localret_ent(fn__version_array__new_2_0,
		fn__version_hash_table__new_2_4_0_i18);
MR_def_label(fn__version_hash_table__new_2_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
#line 117 "version_array.opt"
    ...
    N = ML_va_size_dolock(VA);
;}
#line 1546 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_tempr1 = N;
#undef	MR_PROC_LABEL
	}
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 1586 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 117 "version_array.opt"
    ...
    N = ML_va_size_dolock(VA);
;}
#line 1684 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_tempr4 = N;
#undef	MR_PROC_LABEL
	}
...
#line 267 "version_hash_table.m"
    ...
    HashPred = HashPred0;
;}
#line 1700 "version_hash_table.c"
	MR_tempr5 = HashPred;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_r1;
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 1817 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 195 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set_dolock(VA0, I, X, &VA);
;}
#line 1903 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 2068 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 195 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set_dolock(VA0, I, X, &VA);
;}
#line 2144 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 2274 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 195 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set_dolock(VA0, I, X, &VA);
;}
#line 2344 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 2464 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 195 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set_dolock(VA0, I, X, &VA);
;}
#line 2517 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 2632 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 117 "version_array.opt"
    ...
    N = ML_va_size_dolock(VA);
;}
#line 2808 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r7 = N;
#undef	MR_PROC_LABEL
	}
...
#line 117 "version_array.opt"
    ...
    N = ML_va_size_dolock(VA);
;}
#line 3014 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r8 = N;
#undef	MR_PROC_LABEL
	}
...
#line 117 "version_array.opt"
    ...
    N = ML_va_size_dolock(VA);
;}
#line 3067 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r8 = N;
#undef	MR_PROC_LABEL
	}
...
#line 78 "builtin.opt"
    ...
    SUCCESS_INDICATOR = MR_TRUE;
;}
#line 3635 "version_hash_table.c"
...
#line 78 "builtin.opt"
    ...
    SUCCESS_INDICATOR = MR_TRUE;
;}
#line 3658 "version_hash_table.c"
...
#line 106 "array.opt"
    ...
    Max = Array->size - 1;
;}
#line 3741 "version_hash_table.c"
	MR_r6 = Max;
#undef	MR_PROC_LABEL
	}
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 3879 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 3978 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 4074 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 192 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get_dolock(VA, I, &X);
;}
#line 4170 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
