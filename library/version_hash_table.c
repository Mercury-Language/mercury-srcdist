...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Box next_value_of_STATE_VARIABLE_Buckets_0_13 = STATE_VARIABLE_Buckets_16_16;
      ...
      case (MR_Integer) 2:
        {
          ...
          /* direct tailcall eliminated */
          {
            ...
            MR_Box next_value_of_STATE_VARIABLE_Buckets_0_13 = STATE_VARIABLE_Buckets_15_15;
