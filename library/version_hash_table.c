...
MR_decl_label8(version_hash_table__generic_hash_2_0, 71,3,2,6,5,10,9,13)
MR_decl_label8(version_hash_table__generic_hash_2_0, 12,16,15,22,25,20,28,29)
MR_decl_label1(version_hash_table__generic_hash_2_0, 30)
...
MR_decl_label8(fn__version_hash_table__set_3_0, 2,6,10,13,11,19,21,26)
MR_decl_label1(fn__version_hash_table__set_3_0, 29)
...
MR_decl_label2(__Compare___version_hash_table__version_hash_table_2_0, 21,59)
...
MR_BEGIN_MODULE(version_hash_table_module7)
	...
	MR_init_label8(version_hash_table__generic_hash_2_0,71,3,2,6,5,10,9,13)
	MR_init_label8(version_hash_table__generic_hash_2_0,12,16,15,22,25,20,28,29)
	MR_init_label1(version_hash_table__generic_hash_2_0,30)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__version_hash_table__find_slot_2_0);
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_ctfield(0, MR_r3, 2);
	{
	MR_Word	HashPred0;
	MR_Word	HashPred;
...
MR_def_static(version_hash_table__increase_occupants_2_0)
	...
	MR_tempr6 = MR_r3;
	MR_r4 = MR_ctfield(0, MR_tempr6, 0);
	...
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_tempr7 = MR_r3;
	MR_tempr3 = MR_ctfield(0, MR_tempr7, 3);
	{
	struct ML_va *	VA;
	MR_Integer	N;
...
#line 94 "version_array.opt"
    ...
    N = ML_va_size(VA);
;}
#line 1539 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_tempr4 = N;
#undef	MR_PROC_LABEL
	}
	MR_tempr5 = MR_ctfield(0, MR_tempr7, 2);
	{
	MR_Word	HashPred0;
	MR_Word	HashPred;
#define	MR_PROC_LABEL	mercury__version_hash_table__increase_occupants_2_0
...
#line 231 "version_hash_table.m"
    ...
    HashPred = HashPred0;
;}
#line 1555 "version_hash_table.c"
	MR_tempr5 = HashPred;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_r1;
	...
	MR_sv(6) = ((MR_Integer) MR_ctfield(0, MR_tempr8, 1) + (MR_Integer) MR_ctfield(0, MR_tempr8, 1));
	MR_sv(7) = MR_tempr5;
	MR_r1 = MR_tempr2;
	MR_r2 = MR_sv(5);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
...
MR_BEGIN_MODULE(version_hash_table_module16)
	...
	MR_init_label8(fn__version_hash_table__set_3_0,2,6,10,13,11,19,21,26)
	MR_init_label1(fn__version_hash_table__set_3_0,29)
MR_BEGIN_CODE
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1674 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 1761 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 1922 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 1998 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2122 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2193 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
MR_def_label(fn__version_hash_table__delete_2_0,2)
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_LIST_CTOR_ADDR;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_tempr3 = MR_ctfield(0, MR_sv(1), 3);
	{
	struct ML_va *	VA;
	MR_Integer	I;
	MR_Word	X;
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2311 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 169 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_set(VA0, I, X, &VA);
;}
#line 2364 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("set_if_in_range");
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 2478 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 94 "version_array.opt"
    ...
    N = ML_va_size(VA);
;}
#line 2642 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r7 = N;
#undef	MR_PROC_LABEL
	}
...
#line 94 "version_array.opt"
    ...
    N = ML_va_size(VA);
;}
#line 2785 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r8 = N;
#undef	MR_PROC_LABEL
	}
...
#line 94 "version_array.opt"
    ...
    N = ML_va_size(VA);
;}
#line 2835 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r8 = N;
#undef	MR_PROC_LABEL
	}
...
#line 94 "version_array.opt"
    ...
    N = ML_va_size(VA);
;}
#line 2885 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("size");
	MR_r8 = N;
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(version_hash_table_module42)
	...
	MR_init_label2(__Compare___version_hash_table__version_hash_table_2_0,21,59)
MR_BEGIN_CODE
...
#line 94 "array.opt"
    ...
    Min = 0;
;}
#line 3513 "version_hash_table.c"
	MR_r5 = Min;
#undef	MR_PROC_LABEL
	}
	{
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3660 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3850 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
...
#line 166 "version_array.opt"
    ...
    SUCCESS_INDICATOR = ML_va_get(VA, I, &X);
;}
#line 3943 "version_hash_table.c"
	MR_RELEASE_GLOBAL_LOCK("get_if_in_range");
