  ...
  MR_Word B_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_21_43 = (MR_Word) (&mercury__version_hash_table__version_hash_table__type_ctor_info_hash_table_alist_2);
      Var_49 = (MR_Integer) 0;
      {
        TypeInfo_22_44 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeInfo_22_44, 0) = ((MR_Box) (TypeCtorInfo_21_43));
        MR_hl_field(MR_mktag(0), TypeInfo_22_44, 1) = ((MR_Box) (TypeInfo_for_K_10));
        MR_hl_field(MR_mktag(0), TypeInfo_22_44, 2) = ((MR_Box) (TypeInfo_for_V_11));
      }
{
#define MR_PROC_LABEL mercury__version_hash_table__equal_2_p_0
	...
	VA = (struct ML_va *)(MR_Box) (Buckets_34) ;
		{
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__version_array__set_4_p_0(TypeInfo_24_37, H_28, ((MR_Box) (AL_30)), (MR_Box) (STATE_VARIABLE_Buckets_0_13), &conv3_STATE_VARIABLE_Buckets_16_16);
