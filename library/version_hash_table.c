  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_33 = (MR_Integer) 0;
      {
        ...
        MR_hl_field(MR_mktag(0), TypeInfo_22_32, 0) = ((MR_Box) (TypeCtorInfo_21_31));
        MR_hl_field(MR_mktag(0), TypeInfo_22_32, 1) = ((MR_Box) (TypeInfo_for_K_10));
        MR_hl_field(MR_mktag(0), TypeInfo_22_32, 2) = ((MR_Box) (TypeInfo_for_V_11));
      }
{
  ...
  MR_Box * STATE_VARIABLE_A_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_22_22, 0) = ((MR_Box) (&mercury__version_hash_table__version_hash_table__type_ctor_info_hash_table_alist_2));
    MR_hl_field(MR_mktag(0), TypeInfo_22_22, 1) = ((MR_Box) (TypeInfo_for_K_15));
    MR_hl_field(MR_mktag(0), TypeInfo_22_22, 2) = ((MR_Box) (TypeInfo_for_V_16));
  }
{
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_11, 0) = K_7;
            MR_hl_field(MR_mktag(0), Var_11, 1) = V_8;
          }
          {
            MR_Word base;
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_12, 0) = K_13;
            MR_hl_field(MR_mktag(0), Var_12, 1) = V_14;
          }
          {
            AL1_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), AL1_10, 0) = ((MR_Box) (Var_12));
      ...
      case (MR_Integer) 1:
        {
          ...
          H_35 = (Hash_45 & Var_46);
          {
            ...
            MR_hl_field(MR_mktag(0), TypeInfo_24_44, 0) = ((MR_Box) (&mercury__version_hash_table__version_hash_table__type_ctor_info_hash_table_alist_2));
            MR_hl_field(MR_mktag(0), TypeInfo_24_44, 1) = ((MR_Box) (TypeInfo_for_K_20));
            MR_hl_field(MR_mktag(0), TypeInfo_24_44, 2) = ((MR_Box) (TypeInfo_for_V_21));
          }
      ...
      case (MR_Integer) 2:
        {
          ...
          H_22 = (Hash_32 & Var_33);
          {
            ...
            MR_hl_field(MR_mktag(0), TypeInfo_24_31, 0) = ((MR_Box) (&mercury__version_hash_table__version_hash_table__type_ctor_info_hash_table_alist_2));
            MR_hl_field(MR_mktag(0), TypeInfo_24_31, 1) = ((MR_Box) (TypeInfo_for_K_20));
            MR_hl_field(MR_mktag(0), TypeInfo_24_31, 2) = ((MR_Box) (TypeInfo_for_V_21));
          }
