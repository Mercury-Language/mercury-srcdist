...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
      ...
      V_13_44 = V_17_45;
    mercury__term_to_xml__foldl_between_2__ho33_6_p_in__string_0(Rest_9, (MR_Integer) 0, V_13_44, (MR_Word) ((MR_Unsigned) 0U), &ElementChrs_10);
...
succeeded  = SUCCESS_INDICATOR;
      ...
      V_9_9 = mercury__term_to_xml__map__ho1_2_f_in__list_0(V_7_7);
      {
        HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (V_8_8));
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 1) = ((MR_Box) (V_9_9));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        V_22_24 = mercury__term_to_xml__map_corresponding__ho19_3_f_in__list_0(Var_32, V_20_22);
        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__4_4, 1) = ((MR_Box) (V_22_24));
        }
      }
    }
    return HeadVar__4_4;
