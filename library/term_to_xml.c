...
mercury__term_to_xml__succeeded  = SUCCESS_INDICATOR;
    ...
    if (mercury__term_to_xml__succeeded)
      {
        {
          mercury__string__to_lower_2_p_0(mercury__term_to_xml__Head_5, &mercury__term_to_xml__V_18_18);
        }
...
#undef MR_PROC_LABEL
    ...
    {
      mercury__term_to_xml__foldl_between_2__ho33_6_p_in__string_0(mercury__term_to_xml__Rest_8, (MR_Integer) 0, mercury__term_to_xml__V_13_44, mercury__term_to_xml__V_12_12, &mercury__term_to_xml__ElementChrs_9);
    }
    {
