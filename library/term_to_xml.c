...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          V_5_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), V_5_39, 0) = ((MR_Box) (MR_Word) (Char_6));
          MR_hl_field(MR_mktag(1), V_5_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__string__to_char_list_2_p_1(PrimValue_4, V_5_39);
        succeeded = MR_TRUE;
      }
      else
      {
