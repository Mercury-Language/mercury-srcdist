...
#define SUCCESS_INDICATOR MercurySuccessIndicator
	S = (MR_String) MR_r1;
{
#line 310 "construct.opt"

    SUCCESS_INDICATOR = (S == NULL);
;}
#line 15271 "term_to_xml.c"
