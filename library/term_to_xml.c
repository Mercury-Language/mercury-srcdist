...
succeeded  = SUCCESS_INDICATOR;
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) ArgPseudoTypes_62)) == (MR_Integer) 1);
          if (succeeded)
          {
  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) V_6_6)) == (MR_Integer) 1);
      if (succeeded)
      {
...
succeeded  = SUCCESS_INDICATOR;
            ...
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) ArgPseudoTypes_58)) == (MR_Integer) 1);
              if (succeeded)
              {
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) ArgPseudoTypes_7)) == (MR_Integer) 1);
      if (succeeded)
      {
