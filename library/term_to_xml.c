...
MR_decl_label8(term_to_xml__write_dtd_from_type_6_0, 2,8,7,5,10,12,14,17)
MR_decl_label8(term_to_xml__write_dtd_from_type_6_0, 20,22,23,24,25,26,27,9)
...
MR_BEGIN_MODULE(term_to_xml_module46)
	...
	MR_init_label8(term_to_xml__write_dtd_from_type_6_0,2,8,7,5,10,12,14,17)
	MR_init_label8(term_to_xml__write_dtd_from_type_6_0,20,22,23,24,25,26,27,9)
...
MR_def_label(term_to_xml__write_dtd_from_type_6_0,22)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_3),
		mercury__term_to_xml__write_dtd_from_type_6_0_i23);
...
MR_def_label(term_to_xml__write_dtd_from_type_6_0,25)
	...
	MR_np_call_localret_ent(term_to_xml__write_dtd_types_6_0,
		term_to_xml__write_dtd_from_type_6_0_i26);
...
MR_define_entry(mercury____Unify___term_to_xml__doctype_0_0);
	...
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_r1 = (strcmp((char *)MR_tempr2, (char *)MR_r1) == 0);
	MR_decr_sp(2);
	MR_proceed();
	}
...
#define SUCCESS_INDICATOR MercurySuccessIndicator
	S = (MR_String) MR_r1;
{
#line 308 "construct.opt"

    SUCCESS_INDICATOR = (S == NULL);
;}
#line 15263 "term_to_xml.c"
