              ...
              switch (MR_tag((MR_Word) mercury__term_to_xml__ElementMapping_9)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(mercury__term_to_xml__ElementMapping_9)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      mercury__term_to_xml__MakeElement_12 = (MR_Word) &mercury__term_to_xml_scalar_common_3[15];
                      break;
                    case (MR_Integer) 1:
                      mercury__term_to_xml__MakeElement_12 = (MR_Word) &mercury__term_to_xml_scalar_common_3[16];
                      break;
                  }
                  break;
                case (MR_Integer) 1:
    ...
    switch (MR_tag((MR_Word) mercury__term_to_xml__ElementMapping_4)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(mercury__term_to_xml__ElementMapping_4)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            mercury__term_to_xml__MakeElement_7 = (MR_Word) &mercury__term_to_xml_scalar_common_3[13];
            break;
          case (MR_Integer) 1:
            mercury__term_to_xml__MakeElement_7 = (MR_Word) &mercury__term_to_xml_scalar_common_3[14];
            break;
        }
        break;
      case (MR_Integer) 1:
    ...
    switch (MR_tag((MR_Word) mercury__term_to_xml__ElementMapping_10)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(mercury__term_to_xml__ElementMapping_10)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            mercury__term_to_xml__MakeElement_15 = (MR_Word) &mercury__term_to_xml_scalar_common_3[7];
            break;
          case (MR_Integer) 1:
            mercury__term_to_xml__MakeElement_15 = (MR_Word) &mercury__term_to_xml_scalar_common_3[8];
            break;
        }
        break;
      case (MR_Integer) 1:
    ...
    switch (MR_tag((MR_Word) mercury__term_to_xml__ElementMapping_10)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(mercury__term_to_xml__ElementMapping_10)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            mercury__term_to_xml__MakeElement_15 = (MR_Word) &mercury__term_to_xml_scalar_common_3[5];
            break;
          case (MR_Integer) 1:
            mercury__term_to_xml__MakeElement_15 = (MR_Word) &mercury__term_to_xml_scalar_common_3[6];
            break;
        }
        break;
      case (MR_Integer) 1:
