...
static MR_Word MR_CALL 
mercury__term_to_xml__map__ho1_2_f_in__list_0(
  MR_Word HeadVar__2_2);

static void MR_CALL 
mercury__term_to_xml__LCMCfn_map__ho1_1_3_p_in__list_0(
  MR_Word HeadVar__2_2,
  ...
  MR_Word * MaybeFieldNames_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        FoundFieldNames_13 = mercury__term_to_xml__map__ho1_2_f_in__list_0(Var_22);
...
{
#define MR_PROC_LABEL mercury__term_to_xml__map__ho1_2_f_in__list_0
...
succeeded  = SUCCESS_INDICATOR;
      ...
      mercury__term_to_xml__LCMCfn_map__ho1_1_3_p_in__list_0(Var_7, AddrSCCcallarg9_14);
    }
    return HeadVar__3_3;
  }
}
...
{
#define MR_PROC_LABEL mercury__term_to_xml__LCMCfn_map__ho1_1_3_p_in__list_0
