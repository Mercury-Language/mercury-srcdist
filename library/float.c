...
MR_def_extern_entry(fn__float__float32_bits_string_1_0)
MR_def_extern_entry(fn__float__float64_bits_string_1_0)
...
MR_define_entry(mercury__fn__f_102_108_111_97_116_95_95_45_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_f(1) = ((MR_Float) 0.0000000000000000 - MR_f(1));
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__float__multiply_by_pow_3_0,19)
	...
	MR_tempf2 = MR_f(2);
	* (MR_Float *) &MR_sv(3) = (MR_f(1) * MR_tempf2);
	* (MR_Float *) &MR_sv(5) = (MR_tempf2 * MR_tempf2);
	MR_r2 = (MR_Integer) 2;
	}
...
MR_def_label(fn__float__multiply_by_pow_3_0,5)
	...
	* (MR_Float *) &MR_sv(3) = MR_f(1);
	...
	MR_Float MR_tempf1;
	MR_tempf1 = MR_f(2);
	* (MR_Float *) &MR_sv(5) = (MR_tempf1 * MR_tempf1);
	MR_r2 = (MR_Integer) 2;
	}
	MR_np_call_localret_ent(fn__int__div_2_0,
		fn__float__multiply_by_pow_3_0_i9);
MR_def_label(fn__float__multiply_by_pow_3_0,9)
	...
	MR_f(2) = MR_float_from_dword_ptr(&MR_sv(5));
...
MR_BEGIN_MODULE(float_module34)
	MR_init_entry1(fn__float__float32_bits_string_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__float__float32_bits_string_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'float32_bits_string'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__float__float32_bits_string_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Float	Flt;
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__fn__float__float32_bits_string_1_0
	Flt = MR_f(1);
{
#line 895 "float.m"
...
MR_BEGIN_MODULE(float_module35)
	MR_init_entry1(fn__float__float64_bits_string_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__float__float64_bits_string_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'float64_bits_string'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__float__float64_bits_string_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Float	Flt;
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__fn__float__float64_bits_string_1_0
	Flt = MR_f(1);
{
#line 936 "float.m"
...
MR_BEGIN_MODULE(float_module36)
...
void mercury__float__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__float);
