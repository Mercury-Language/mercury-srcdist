...
succeeded  = SUCCESS_INDICATOR;
      ...
      if (succeeded)
      {
        MR_Word TypeCtorInfo_15_15 = (MR_Word) &mercury__math__math__type_ctor_info_domain_error_0;
        MR_Word Var_9 = (MR_Word) ((MR_Box) ((MR_String) "float.pow: zero base"));

        mercury__exception__throw_1_p_0(TypeCtorInfo_15_15, ((MR_Box) (Var_9)));
      }
      else
      {
        MR_Float Var_12;
        MR_Integer Var_14 = ((MR_Integer) 0 - Exp_5);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Float Var_10;
        MR_Integer Var_12;
        MR_Integer V_3_15 = (Exp_7 & (MR_Integer) 1);

        succeeded = (V_3_15 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
        ...
        {
          MR_Float next_value_of_Scale0_5 = Scale1_9;
          MR_Float next_value_of_Base_6 = Var_10;
          MR_Integer next_value_of_Exp_7 = Var_12;
...
succeeded  = SUCCESS_INDICATOR;
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_7 = (MR_Word) ((MR_Box) ((MR_String) "float.\'/\': division by zero"));
