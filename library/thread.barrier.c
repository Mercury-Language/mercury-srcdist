...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&mercury__thread__barrier_scalar_common_1[0]), &Var_8, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (Var_8 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      else
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&mercury__thread__barrier_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    StillWaitingFor_8 = (MR_Integer) ((MR_Unsigned) N_7 - (MR_Unsigned) (MR_Integer) 1);
