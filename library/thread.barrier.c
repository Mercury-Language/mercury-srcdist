...
{
  {
    ...
    if (mercury__thread__barrier__succeeded)
      *mercury__thread__barrier__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mercury__thread__barrier__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__thread__barrier__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mercury__thread__barrier__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mercury__thread__barrier__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mercury__thread__barrier__Var_8;
        MR_Word mercury__thread__barrier__TypeInfo_11_11 = (MR_Word) &mercury__thread__barrier_scalar_common_1[0];

        {
          mercury__builtin__compare_3_p_0(mercury__thread__barrier__TypeInfo_11_11, &mercury__thread__barrier__Var_8, ((MR_Box) (mercury__thread__barrier__ArgX1_4)), ((MR_Box) (mercury__thread__barrier__ArgY1_5)));
        }
        mercury__thread__barrier__succeeded = (mercury__thread__barrier__Var_8 == (MR_Integer) 0);
        mercury__thread__barrier__succeeded = !(mercury__thread__barrier__succeeded);
        if (mercury__thread__barrier__succeeded)
          *mercury__thread__barrier__HeadVar__1_1 = mercury__thread__barrier__Var_8;
        else
          {
            MR_Word mercury__thread__barrier__TypeInfo_12_12 = (MR_Word) &mercury__thread__barrier_scalar_common_1[1];

            {
              mercury__builtin__compare_3_p_0(mercury__thread__barrier__TypeInfo_12_12, mercury__thread__barrier__HeadVar__1_1, ((MR_Box) (mercury__thread__barrier__ArgX2_6)), ((MR_Box) (mercury__thread__barrier__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (mercury__thread__barrier__succeeded)
    ...
    else
      {
        ...
        MR_Word mercury__thread__barrier__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mercury__thread__barrier__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mercury__thread__barrier__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mercury__thread__barrier__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mercury__thread__barrier__HeadVar__2_2, (MR_Integer) 1)));

        {
          mercury__thread__barrier__succeeded = mercury__builtin__unify_2_p_0(mercury__thread__barrier__TypeInfo_9_9, ((MR_Box) (mercury__thread__barrier__ArgX1_3)), ((MR_Box) (mercury__thread__barrier__ArgY1_4)));
        }
        if (mercury__thread__barrier__succeeded)
          {
            mercury__thread__barrier__TypeInfo_10_10 = (MR_Word) &mercury__thread__barrier_scalar_common_1[1];
            {
              mercury__thread__barrier__succeeded = mercury__builtin__unify_2_p_0(mercury__thread__barrier__TypeInfo_10_10, ((MR_Box) (mercury__thread__barrier__ArgX2_5)), ((MR_Box) (mercury__thread__barrier__ArgY2_6)));
            }
          }
      }
    return mercury__thread__barrier__succeeded;
