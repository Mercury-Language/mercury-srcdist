...
mercury__thread__barrier__release_3_p_0(
  MR_Word HeadVar__1_1)
{
  MR_Word WaitingOn_4 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  MR_Word Go_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Box conv0__N_7;
  ...
  else
  {
    ...
    else
    {
      ...
      switch (WhyGo_28) {
        ...
        case (MR_Integer) 0:
          {
            mercury__require__unexpected_3_p_0((MR_String) "thread.barrier.m", (MR_String) "predicate \140thread.barrier.wait\'/3", (MR_String) "Too many threads called wait/3 on this barrier.");
            return;
          }
          break;
        case (MR_Integer) 1:
