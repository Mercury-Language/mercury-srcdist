...
string.optdate string.trans_opt_date string.err string.c_date string.s_date string.pic_s_date string.java_date : string.m string.int0 \
	assoc_list.int \
	builtin.int \
	char.int \
	deconstruct.int \
...
string.trans_opt_date string.err string.c_date string.s_date string.pic_s_date string.java_date :  \
	string.opt \
	assoc_list.opt \
	builtin.opt \
	char.opt \
...
string.err string.c_date string.s_date string.pic_s_date string.java_date :  \
	string.trans_opt \
