...
MR_decl_label3(bintree_set__assoc_unit_2_0, 4,5,2)
MR_decl_label3(bintree_set__contains_list_2_0, 16,3,1)
MR_decl_label3(bintree_set__delete_list_3_0, 11,4,3)
MR_decl_label2(bintree_set__equal_2_0, 2,3)
MR_decl_label3(bintree_set__insert_list_3_0, 11,4,3)
MR_decl_label3(bintree_set__insert_list_3_1, 11,4,3)
MR_decl_label1(bintree_set__intersect_3_0, 2)
MR_decl_label7(bintree_set__list_to_set_2_0, 2,3,5,6,4,7,8)
...
MR_decl_label2(bintree_set__sorted_list_to_set_2_0, 2,3)
MR_decl_label1(bintree_set__subset_2_0, 2)
MR_decl_label1(bintree_set__superset_2_0, 2)
MR_decl_label4(bintree_set__union_3_0, 2,3,4,5)
MR_decl_label1(fn__bintree_set__intersect_2_0, 2)
MR_decl_label2(fn__bintree_set__sorted_list_to_set_1_0, 2,3)
...
MR_BEGIN_MODULE(bintree_set_module0)
	...
	MR_init_label3(bintree_set__assoc_unit_2_0,4,5,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree_set__assoc_unit_2_0);
	...
	MR_r3 = (MR_Word) MR_sp;
MR_def_label(bintree_set__assoc_unit_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	MR_incr_sp(1);
	MR_tag_alloc_heap(MR_sv(1), 0, (MR_Integer) 2);
	MR_tfield(0, MR_sv(1), 0) = MR_ctfield(1, MR_r2, 0);
	MR_r2 = MR_ctfield(1, MR_r2, 1);
	if (MR_LTAGS_TESTR(MR_r2,0,0))
		continue;
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	break; } /* end while */
MR_def_label(bintree_set__assoc_unit_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(bintree_set_module1)
	...
	MR_init_label2(bintree_set__sorted_list_to_set_2_0,2,3)
MR_BEGIN_CODE
...
MR_def_label(bintree_set__sorted_list_to_set_2_0,2)
	...
	MR_np_call_localret_ent(list__length_2_3_0,
		bintree_set__sorted_list_to_set_2_0_i3);
MR_def_label(bintree_set__sorted_list_to_set_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
...
MR_BEGIN_MODULE(bintree_set_module2)
	...
	MR_init_label7(bintree_set__list_to_set_2_0,2,3,5,6,4,7,8)
MR_BEGIN_CODE
...
MR_def_label(bintree_set__list_to_set_2_0,3)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(bintree_set__list_to_set_2_0_i5);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_sv(2);
	MR_GOTO_LAB(bintree_set__list_to_set_2_0_i4);
MR_def_label(bintree_set__list_to_set_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(bintree_set__list_to_set_2_0,4)
	...
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(bintree_set__assoc_unit_2_0,
		bintree_set__list_to_set_2_0_i7);
MR_def_label(bintree_set__list_to_set_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	...
	MR_np_call_localret_ent(list__length_2_3_0,
		bintree_set__list_to_set_2_0_i8);
MR_def_label(bintree_set__list_to_set_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(3);
...
MR_BEGIN_MODULE(bintree_set_module4)
	...
	MR_init_label2(fn__bintree_set__sorted_list_to_set_1_0,2,3)
MR_BEGIN_CODE
...
MR_def_label(fn__bintree_set__sorted_list_to_set_1_0,2)
	...
	MR_np_call_localret_ent(list__length_2_3_0,
		fn__bintree_set__sorted_list_to_set_1_0_i3);
MR_def_label(fn__bintree_set__sorted_list_to_set_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
...
MR_BEGIN_MODULE(bintree_set_module21)
	...
	MR_init_label3(bintree_set__insert_list_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree_set__insert_list_3_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(bintree_set__insert_list_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(bintree_set__insert_list_3_0,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(bintree_set__insert_list_3_0_i11);
...
MR_BEGIN_MODULE(bintree_set_module22)
	...
	MR_init_label3(bintree_set__insert_list_3_1,11,4,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree_set__insert_list_3_1);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(bintree_set__insert_list_3_1,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
...
MR_def_label(bintree_set__insert_list_3_1,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(bintree_set__insert_list_3_1_i11);
...
MR_BEGIN_MODULE(bintree_set_module28)
	...
	MR_init_label3(bintree_set__delete_list_3_0,11,4,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__bintree_set__delete_list_3_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(bintree_set__delete_list_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
...
MR_def_label(bintree_set__delete_list_3_0,4)
	...
	MR_r3 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(bintree_set__delete_list_3_0_i11);
...
MR_BEGIN_MODULE(bintree_set_module30)
	...
	MR_init_label4(bintree_set__union_3_0,2,3,4,5)
MR_BEGIN_CODE
...
MR_def_label(bintree_set__union_3_0,3)
	...
	MR_np_call_localret_ent(list__merge_3_0,
		bintree_set__union_3_0_i4);
MR_def_label(bintree_set__union_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_r2;
...
void mercury__bintree_set__write_out_proc_statics(FILE *fp);
#endif
