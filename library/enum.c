...
{
  {
    ...
    MR_Box X_4;
    MR_Box X0_5;
    MR_bool MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box *) = ((MR_bool MR_CALL (*)(MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_enum_9, (MR_Integer) 0)), (MR_Integer) 6)));

    succeeded = func_0(((MR_Box) TypeClassInfo_for_enum_9), ((MR_Box) (I_3)), &X0_5);
    if (succeeded)
      X_4 = X0_5;
    else
    {
