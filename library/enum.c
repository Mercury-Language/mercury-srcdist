...
{
  {
    ...
    {
      mercury__enum__succeeded = mercury__enum__func_0(((MR_Box) mercury__enum__TypeClassInfo_for_enum_3), ((MR_Box) (mercury__enum__HeadVar__1_1)), mercury__enum__HeadVar__2_2);
    }
