  ...
  void * cont_env_ptr)
{
  ...
  {
    MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_3, (MR_Integer) 1))));

    mercury__term_vars__terms_contain_var_2_p_1(TypeInfo_for_T_5, Var_9, Var_4, cont, cont_env_ptr);
  }
  else
  {
    *Var_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term_3, (MR_Integer) 0))));
    cont(cont_env_ptr);
  }
}
  ...
  MR_Word Var_4)
{
  ...
  {
    MR_Word Var_6 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term_3, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Var_7)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_10_11, 0) = ((MR_Box) (&mercury__term__term__type_ctor_info_var_1));
    MR_hl_field(MR_mktag(0), TypeInfo_10_11, 1) = ((MR_Box) (TypeInfo_for_T_8));
  }
  ...
  MR_Word Term_2)
{
  ...
  if (succeeded)
  {
    Var_5 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_2, (MR_Integer) 1))));
...
{
  *LineNumber_4 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Context_3, (MR_Integer) 1))));
}
...
mercury__term__context_line_1_f_0(
  MR_Word Context_3)
{
  MR_Integer LineNumber_4 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Context_3, (MR_Integer) 1))));
...
{
  *FileName_4 = ((MR_String) ((MR_hl_field(MR_mktag(0), Context_3, (MR_Integer) 0))));
}
...
mercury__term__context_file_1_f_0(
  MR_Word Context_3)
{
  MR_String FileName_4 = ((MR_String) ((MR_hl_field(MR_mktag(0), Context_3, (MR_Integer) 0))));
...
{
  {
    ...
    *Context_6 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FileName_4));
  ...
  MR_Integer LineNumber_5)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Context_6, 0) = ((MR_Box) (FileName_4));
    MR_hl_field(MR_mktag(0), Context_6, 1) = ((MR_Box) (LineNumber_5));
  }
  return Context_6;
}
