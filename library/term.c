  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    mercury__term__LCMCpr_var_list_to_term_list_1_2_p_0(TypeInfo_for_T_8, Vars_4, AddrTerms_11);
  }
}

void MR_CALL 
mercury__term__LCMCpr_var_list_to_term_list_1_2_p_0(
  MR_Word TypeInfo_for_T_8,
  MR_Word HeadVar__1_1,
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__term__LCMCpr_term_list_to_var_list_1_2_p_0(TypeInfo_for_T_8, Terms_5, AddrVars_9);
      }
    }
    return succeeded;
  }
...
MR_bool MR_CALL 
mercury__term__LCMCpr_term_list_to_var_list_1_2_p_0(
  MR_Word TypeInfo_for_T_8,
  MR_Word HeadVar__1_1,
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__term__LCMCpr_apply_rec_substitution_in_terms_1_3_p_0(TypeInfo_for_T_10, HeadVar__1_1, Terms0_7, AddrTerms_11);
  }
}
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    AddrTerms_11 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__3_3, (MR_Integer) 1)));
    mercury__term__LCMCpr_apply_substitution_in_terms_1_3_p_0(TypeInfo_for_T_10, HeadVar__1_1, Terms0_7, AddrTerms_11);
  }
}
...
void MR_CALL 
mercury__term__LCMCpr_apply_substitution_in_terms_1_3_p_0(
  MR_Word TypeInfo_for_T_10,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
...
{
  {
    ...
    if (((MR_tag((MR_Word) Term0_5)) == (MR_Integer) 0))
    {
      ...
      mercury__term__LCMCpr_apply_substitution_in_terms_1_3_p_0(TypeInfo_for_T_14, Subst_4, ArgTerms0_11, AddrArgTerms_23);
    }
    else
    {
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    mercury__term__LCMCpr_substitute_var_in_terms_1_4_p_0(TypeInfo_for_T_13, HeadVar__1_1, HeadVar__2_2, Terms0_10, AddrTerms_14);
  }
}

void MR_CALL 
mercury__term__LCMCpr_substitute_var_in_terms_1_4_p_0(
  MR_Word TypeInfo_for_T_13,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3,
...
{
  {
    ...
    if (((MR_tag((MR_Word) Term0_7)) == (MR_Integer) 0))
    {
      ...
      mercury__term__LCMCpr_substitute_var_in_terms_1_4_p_0(TypeInfo_for_T_15, Var_5, ReplacementTerm_6, ArgTerms0_12, AddrArgTerms_20);
    }
    else
    {
...
void MR_CALL 
mercury__term__LCMCpr_apply_renaming_in_terms_1_3_p_0(
  MR_Word TypeInfo_for_T_10,
  MR_Word Renaming_1,
  MR_Word HeadVar__2_2,
...
{
  {
    ...
    else
    {
      ...
      mercury__term__LCMCpr_apply_renaming_in_terms_1_3_p_0(TypeInfo_for_T_10, Renaming_1, Terms0_7, AddrTerms_31);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__term__LCMCpr_apply_renaming_in_vars_1_3_p_0(TypeInfo_for_T_10, HeadVar__1_1, Vars0_7, AddrVars_21);
    }
  }
}

void MR_CALL 
mercury__term__LCMCpr_apply_renaming_in_vars_1_3_p_0(
  MR_Word TypeInfo_for_T_10,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    AddrTerms_14 = (MR_Word *) (&(MR_hl_field(MR_mktag(1), *HeadVar__4_4, (MR_Integer) 1)));
    mercury__term__LCMCpr_rename_var_in_terms_1_4_p_0(TypeInfo_for_T_13, HeadVar__1_1, HeadVar__2_2, Terms0_10, AddrTerms_14);
  }
}

void MR_CALL 
mercury__term__LCMCpr_rename_var_in_terms_1_4_p_0(
  MR_Word TypeInfo_for_T_13,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3,
...
{
  {
    ...
    if (((MR_tag((MR_Word) Term0_7)) == (MR_Integer) 0))
    {
      ...
      AddrArgTerms_20 = (MR_Word *) (&(MR_hl_field(MR_mktag(0), *Term_8, (MR_Integer) 1)));
      mercury__term__LCMCpr_rename_var_in_terms_1_4_p_0(TypeInfo_for_T_15, Var_5, ReplacementVar_6, ArgTerms0_12, AddrArgTerms_20);
    }
    else
    {
      MR_Word Var0_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term0_7, (MR_Integer) 0))));
...
void MR_CALL 
mercury__term__LCMCpr_apply_rec_substitution_in_terms_1_3_p_0(
  MR_Word TypeInfo_for_T_10,
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word * AddrOfHeadVar__3_12)
  ...
  MR_Word * Term_6)
{
  while (MR_TRUE)
  {
    ...
    if (((MR_tag((MR_Word) Term0_5)) == (MR_Integer) 0))
    {
      ...
      AddrArgTerms_23 = (MR_Word *) (&(MR_hl_field(MR_mktag(0), *Term_6, (MR_Integer) 1)));
      mercury__term__LCMCpr_apply_rec_substitution_in_terms_1_3_p_0(TypeInfo_for_T_14, Subst_4, ArgTerms0_11, AddrArgTerms_23);
    }
    else
    {
      MR_Word Var_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Term0_5, (MR_Integer) 0))));
