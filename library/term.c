  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__from_int_2_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 1)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__2_2);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
    succeeded = MR_TRUE;
