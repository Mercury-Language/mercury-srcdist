...
static MR_bool MR_CALL 
mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__from_int_2_2_p_0_10001(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
const MR_BaseTypeclassInfo base_typeclass_info_enum__enum__arity1__term__var__arity1__[7] = {
  ...
  ((MR_Box) (mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__from_int_2_2_p_0_10001))
};
...
MR_bool MR_CALL 
mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__from_int_2_2_p_0(
  MR_Word TypeInfo_3_3,
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word ArgX3_12 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, 2))) >> 3)) & (MR_Integer) 1);
              MR_Word ArgY3_13 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, 2))) >> 3)) & (MR_Integer) 1);
              MR_Word ArgX4_15 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, 2))) & (MR_Integer) 7);
              MR_Word ArgY4_16 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, 2))) & (MR_Integer) 7);
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Float ArgX1_19 = MR_unbox_float((MR_hl_field(3, HeadVar__2_2, 1)));
                      MR_Float ArgY1_20 = MR_unbox_float((MR_hl_field(3, HeadVar__3_3, 1)));
            ...
            switch (MR_tag((MR_Word) HeadVar__3_3)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, 0))))) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_String ArgX1_21 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, 1))));
                      MR_String ArgY1_22 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, 1))));
                      MR_Integer Var_39;
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ArgY2_8;
          MR_Word ArgX3_9 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, 2))) >> 3)) & (MR_Integer) 1);
          MR_Word ArgY3_10;
          MR_Word ArgX4_11 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, 2))) & (MR_Integer) 7);
          MR_Word ArgY4_12;
          ...
          if (succeeded)
          {
            ...
            ArgY3_10 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, 2))) >> 3)) & (MR_Integer) 1);
            ArgY4_12 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, 2))) & (MR_Integer) 7);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Float ArgX1_15 = MR_unbox_float((MR_hl_field(3, HeadVar__1_1, 1)));
              MR_Float ArgY1_16;

              succeeded = ((((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                ArgY1_16 = MR_unbox_float((MR_hl_field(3, HeadVar__2_2, 1)));
...
void MR_CALL 
mercury__term__unsafe_int_to_var_2_p_0(
  MR_Word TypeInfo_for_T_4,
  MR_Integer VarNum_3,
  MR_Word * HeadVar__2_2)
{
  *HeadVar__2_2 = (MR_Word) (VarNum_3);
}
  ...
  MR_Word Var_4)
{
  ...
  {
    MR_Word Var_6 = ((MR_Word) ((MR_hl_field(1, Term_3, 0))));
  ...
  MR_Word Term_2)
{
  ...
  if (succeeded)
  {
    Var_5 = ((MR_Word) ((MR_hl_field(0, Term_2, 1))));
...
{
  *LineNumber_4 = ((MR_Integer) ((MR_hl_field(0, Context_3, 1))));
}
...
mercury__term__context_line_1_f_0(
  MR_Word Context_3)
{
  MR_Integer LineNumber_4 = ((MR_Integer) ((MR_hl_field(0, Context_3, 1))));
...
{
  *FileName_4 = ((MR_String) ((MR_hl_field(0, Context_3, 0))));
}
...
mercury__term__context_file_1_f_0(
  MR_Word Context_3)
{
  MR_String FileName_4 = ((MR_String) ((MR_hl_field(0, Context_3, 0))));
  ...
  MR_Word Term_3)
{
  ...
  if (((MR_tag((MR_Word) Term_3)) == (MR_Integer) 0))
    Context_4 = ((MR_Word) ((MR_hl_field(0, Term_3, 2))));
  else
    Context_4 = ((MR_Word) ((MR_hl_field(1, Term_3, 1))));
  return Context_4;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_2 = mercury__term__ClassMethod_for_enum__uenum____term__var__arity1______enum__to_uint_1_1_f_0(((MR_Word) ((MR_hl_field(0, closure, 1)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = mercury__term__ClassMethod_for_enum__uenum____term__var__arity1______enum__from_uint_2_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 1)))), ((MR_Unsigned) (wrapper_arg_1)), &conv0_HeadVar__2_2);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
    succeeded = MR_TRUE;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_2 = mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__to_int_1_1_f_0(((MR_Word) ((MR_hl_field(0, closure, 1)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
  return wrapper_arg_2;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = mercury__term__ClassMethod_for_enum__enum____term__var__arity1______enum__from_int_2_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 1)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__2_2);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
    succeeded = MR_TRUE;
