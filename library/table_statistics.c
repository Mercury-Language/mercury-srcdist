...
MR_decl_label8(fn__table_statistics__table_step_stats_diff_2_0, 3,9,11,14,13,18,19,8)
...
MR_decl_label4(__Compare___table_statistics__proc_table_statistics_0_0, 3,2,5,27)
MR_decl_label9(__Compare___table_statistics__table_stats_0_0, 3,2,6,7,9,14,15,17,70)
...
MR_CTOR0_ADDR(table_statistics, table_stats_curr_prev)
}
},
};
...
MR_BEGIN_MODULE(table_statistics_module1)
	...
	MR_init_label8(fn__table_statistics__table_step_stats_diff_2_0,3,9,11,14,13,18,19,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__table_statistics__table_step_stats_diff_2_0);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__table_statistics__table_step_stats_diff_2_0_i8);
	}
...
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,3)
	...
	MR_np_call_localret_ent(table_statistics__table_step_stats_detail_diff_3_0,
		fn__table_statistics__table_step_stats_diff_2_0_i14);
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,9)
	...
	MR_np_call_localret_ent(require__error_1_0,
		fn__table_statistics__table_step_stats_diff_2_0_i11);
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(table_statistics__table_step_stats_detail_diff_3_0,
		fn__table_statistics__table_step_stats_diff_2_0_i14);
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__table_statistics__table_step_stats_diff_2_0_i13);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("table_step_stats_diff: mismatches in details", 44);
	MR_np_call_localret_ent(require__error_1_0,
		fn__table_statistics__table_step_stats_diff_2_0_i18);
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_localcall_lab(fn__table_statistics__table_step_stats_diff_2_0,
		fn__table_statistics__table_step_stats_diff_2_0_i19);
...
MR_def_label(fn__table_statistics__table_step_stats_diff_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#undef	MR_PROC_LABEL
	...
	* (MR_Float *) &MR_sv(2) = (MR_tempf1 * MR_tempf2);
	{
#define	MR_PROC_LABEL	mercury__fn__table_statistics__percentage_str_2_0
...
#undef	MR_PROC_LABEL
	...
	if ((MR_f(3) != (MR_Float) 0.0000000000000000)) {
...
MR_def_label(fn__table_statistics__percentage_str_2_0,3)
	...
	MR_tempf3 = MR_f(3);
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 0)) = (MR_tempf2 / MR_tempf3);
...
MR_BEGIN_MODULE(table_statistics_module22)
	...
	MR_init_label4(__Compare___table_statistics__proc_table_statistics_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___table_statistics__proc_table_statistics_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___table_statistics__proc_table_statistics_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___table_statistics__proc_table_statistics_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(table_statistics_module24)
	...
	MR_init_label9(__Compare___table_statistics__table_stats_0_0,3,2,6,7,9,14,15,17,70)
MR_BEGIN_CODE
...
MR_def_label(__Compare___table_statistics__table_stats_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___table_statistics__table_stats_0_0_i70);
	}
	MR_r3 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___table_statistics__table_stats_0_0,17)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___table_statistics__table_stats_0_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__table_statistics__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__table_statistics);
