...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__table_statistics__LCMCfn_table_step_stats_diff_1_3_p_0(Var_35, StepsB_13, AddrStepDiffs_73);
      }
    }
    return HeadVar__3_3;
  }
...
void MR_CALL 
mercury__table_statistics__LCMCfn_table_step_stats_diff_1_3_p_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
