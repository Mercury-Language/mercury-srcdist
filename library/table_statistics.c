...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(V_8_62, (MR_String) "error writing to output file: ");
...
#undef MR_PROC_LABEL
    ...
    mercury__io__throw_on_error_4_p_0(V_8_78, (MR_String) "error writing to output file: ");
    V_5_87 = (MR_Box) (OutStream_6);
{
#define MR_PROC_LABEL mercury__table_statistics__write_table_step_stats_enum_5_p_0
