  ...
  MR_Word Stats_6)
{
  ...
  Var_119 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__table_statistics_scalar_common_5[2]));
  ...
  MR_Integer DuExistLookups_12)
{
  ...
  Var_101 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__table_statistics_scalar_common_5[2]));
  ...
  MR_Integer EnumNodeBytes_8)
{
  ...
  Var_54 = (MR_Word) (MR_mkword(MR_mktag(1), &mercury__table_statistics_scalar_common_5[2]));
